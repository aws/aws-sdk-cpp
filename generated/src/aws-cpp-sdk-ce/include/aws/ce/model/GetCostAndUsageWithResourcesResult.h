...
class GetCostAndUsageWithResourcesResult {
 public:
  ...
  AWS_COSTEXPLORER_API GetCostAndUsageWithResourcesResult& operator=(
  ...
  template <typename NextPageTokenT = Aws::String>
  GetCostAndUsageWithResourcesResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename GroupDefinitionsT = Aws::Vector<GroupDefinition>>
  GetCostAndUsageWithResourcesResult& WithGroupDefinitions(GroupDefinitionsT&& value) {
    SetGroupDefinitions(std::forward<GroupDefinitionsT>(value));
    return *this;
  }
  template <typename GroupDefinitionsT = GroupDefinition>
  GetCostAndUsageWithResourcesResult& AddGroupDefinitions(GroupDefinitionsT&& value) {
    m_groupDefinitionsHasBeenSet = true;
  ...
  template <typename ResultsByTimeT = Aws::Vector<ResultByTime>>
  GetCostAndUsageWithResourcesResult& WithResultsByTime(ResultsByTimeT&& value) {
    SetResultsByTime(std::forward<ResultsByTimeT>(value));
    return *this;
  }
  template <typename ResultsByTimeT = ResultByTime>
  GetCostAndUsageWithResourcesResult& AddResultsByTime(ResultsByTimeT&& value) {
    m_resultsByTimeHasBeenSet = true;
  ...
  template <typename DimensionValueAttributesT = Aws::Vector<DimensionValuesWithAttributes>>
  GetCostAndUsageWithResourcesResult& WithDimensionValueAttributes(DimensionValueAttributesT&& value) {
  ...
  GetCostAndUsageWithResourcesResult& AddDimensionValueAttributes(DimensionValueAttributesT&& value) {
    m_dimensionValueAttributesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetCostAndUsageWithResourcesResult& WithRequestId(RequestIdT&& value) {
