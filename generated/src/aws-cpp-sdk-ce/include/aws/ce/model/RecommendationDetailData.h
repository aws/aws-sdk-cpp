...
class RecommendationDetailData {
 public:
  ...
  inline RecommendationDetailData& WithAccountScope(AccountScope value) {
  ...
  inline RecommendationDetailData& WithLookbackPeriodInDays(LookbackPeriodInDays value) {
  ...
  inline RecommendationDetailData& WithSavingsPlansType(SupportedSavingsPlansType value) {
  ...
  inline RecommendationDetailData& WithTermInYears(TermInYears value) {
  ...
  inline RecommendationDetailData& WithPaymentOption(PaymentOption value) {
