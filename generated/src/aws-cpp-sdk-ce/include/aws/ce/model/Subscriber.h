...
class Subscriber {
 public:
  ...
  inline void SetType(SubscriberType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Subscriber& WithType(SubscriberType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(SubscriberStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Subscriber& WithStatus(SubscriberStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
