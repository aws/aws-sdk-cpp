...
class CostAllocationTagBackfillRequest {
 public:
  ...
  void SetBackfillFrom(BackfillFromT&& value) {
    m_backfillFromHasBeenSet = true;
    m_backfillFrom = std::forward<BackfillFromT>(value);
  }
  template <typename BackfillFromT = Aws::String>
  CostAllocationTagBackfillRequest& WithBackfillFrom(BackfillFromT&& value) {
    SetBackfillFrom(std::forward<BackfillFromT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestedAtT = Aws::String>
  CostAllocationTagBackfillRequest& WithRequestedAt(RequestedAtT&& value) {
  ...
  template <typename CompletedAtT = Aws::String>
  CostAllocationTagBackfillRequest& WithCompletedAt(CompletedAtT&& value) {
  ...
  inline void SetBackfillStatus(CostAllocationTagBackfillStatus value) {
    m_backfillStatusHasBeenSet = true;
    m_backfillStatus = value;
  }
  inline CostAllocationTagBackfillRequest& WithBackfillStatus(CostAllocationTagBackfillStatus value) {
  ...
  template <typename LastUpdatedAtT = Aws::String>
  CostAllocationTagBackfillRequest& WithLastUpdatedAt(LastUpdatedAtT&& value) {
