...
class ResultByTime {
 public:
  ...
  ResultByTime& AddTotal(TotalKeyT&& key, TotalValueT&& value) {
    m_totalHasBeenSet = true;
    m_total.emplace(std::forward<TotalKeyT>(key), std::forward<TotalValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEstimated(bool value) {
    m_estimatedHasBeenSet = true;
    m_estimated = value;
  }
  inline ResultByTime& WithEstimated(bool value) {
    SetEstimated(value);
    return *this;
  }
  ///@}
