...
class TargetInstance {
 public:
  ...
  void SetEstimatedMonthlyCost(EstimatedMonthlyCostT&& value) {
    ...
    m_estimatedMonthlyCost = std::forward<EstimatedMonthlyCostT>(value);
  }
  template <typename EstimatedMonthlyCostT = Aws::String>
  TargetInstance& WithEstimatedMonthlyCost(EstimatedMonthlyCostT&& value) {
    SetEstimatedMonthlyCost(std::forward<EstimatedMonthlyCostT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultTargetInstance(bool value) {
    m_defaultTargetInstanceHasBeenSet = true;
    m_defaultTargetInstance = value;
  }
  inline TargetInstance& WithDefaultTargetInstance(bool value) {
    SetDefaultTargetInstance(value);
    return *this;
  }
  ///@}
  ...
  void SetExpectedResourceUtilization(ExpectedResourceUtilizationT&& value) {
    ...
    m_expectedResourceUtilization = std::forward<ExpectedResourceUtilizationT>(value);
  }
  template <typename ExpectedResourceUtilizationT = ResourceUtilization>
  TargetInstance& WithExpectedResourceUtilization(ExpectedResourceUtilizationT&& value) {
    SetExpectedResourceUtilization(std::forward<ExpectedResourceUtilizationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlatformDifferences(PlatformDifferencesT&& value) {
    ...
    m_platformDifferences = std::forward<PlatformDifferencesT>(value);
  }
  template <typename PlatformDifferencesT = Aws::Vector<PlatformDifference>>
  TargetInstance& WithPlatformDifferences(PlatformDifferencesT&& value) {
    SetPlatformDifferences(std::forward<PlatformDifferencesT>(value));
    return *this;
  }
  inline TargetInstance& AddPlatformDifferences(PlatformDifference value) {
    m_platformDifferencesHasBeenSet = true;
    m_platformDifferences.push_back(value);
    return *this;
  }
  ///@}
 private:
