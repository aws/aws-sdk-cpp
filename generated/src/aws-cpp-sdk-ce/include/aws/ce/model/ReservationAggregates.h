...
class ReservationAggregates {
 public:
  ...
  void SetUtilizationPercentage(UtilizationPercentageT&& value) {
    ...
    m_utilizationPercentage = std::forward<UtilizationPercentageT>(value);
  }
  template <typename UtilizationPercentageT = Aws::String>
  ReservationAggregates& WithUtilizationPercentage(UtilizationPercentageT&& value) {
    SetUtilizationPercentage(std::forward<UtilizationPercentageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUtilizationPercentageInUnits(UtilizationPercentageInUnitsT&& value) {
    ...
    m_utilizationPercentageInUnits = std::forward<UtilizationPercentageInUnitsT>(value);
  }
  template <typename UtilizationPercentageInUnitsT = Aws::String>
  ReservationAggregates& WithUtilizationPercentageInUnits(UtilizationPercentageInUnitsT&& value) {
    SetUtilizationPercentageInUnits(std::forward<UtilizationPercentageInUnitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPurchasedHours(PurchasedHoursT&& value) {
    ...
    m_purchasedHours = std::forward<PurchasedHoursT>(value);
  }
  template <typename PurchasedHoursT = Aws::String>
  ReservationAggregates& WithPurchasedHours(PurchasedHoursT&& value) {
    SetPurchasedHours(std::forward<PurchasedHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPurchasedUnits(PurchasedUnitsT&& value) {
    ...
    m_purchasedUnits = std::forward<PurchasedUnitsT>(value);
  }
  template <typename PurchasedUnitsT = Aws::String>
  ReservationAggregates& WithPurchasedUnits(PurchasedUnitsT&& value) {
    SetPurchasedUnits(std::forward<PurchasedUnitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalActualHours(TotalActualHoursT&& value) {
    ...
    m_totalActualHours = std::forward<TotalActualHoursT>(value);
  }
  template <typename TotalActualHoursT = Aws::String>
  ReservationAggregates& WithTotalActualHours(TotalActualHoursT&& value) {
    SetTotalActualHours(std::forward<TotalActualHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalActualUnits(TotalActualUnitsT&& value) {
    ...
    m_totalActualUnits = std::forward<TotalActualUnitsT>(value);
  }
  template <typename TotalActualUnitsT = Aws::String>
  ReservationAggregates& WithTotalActualUnits(TotalActualUnitsT&& value) {
    SetTotalActualUnits(std::forward<TotalActualUnitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnusedHours(UnusedHoursT&& value) {
    ...
    m_unusedHours = std::forward<UnusedHoursT>(value);
  }
  template <typename UnusedHoursT = Aws::String>
  ReservationAggregates& WithUnusedHours(UnusedHoursT&& value) {
    SetUnusedHours(std::forward<UnusedHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnusedUnits(UnusedUnitsT&& value) {
    ...
    m_unusedUnits = std::forward<UnusedUnitsT>(value);
  }
  template <typename UnusedUnitsT = Aws::String>
  ReservationAggregates& WithUnusedUnits(UnusedUnitsT&& value) {
    SetUnusedUnits(std::forward<UnusedUnitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnDemandCostOfRIHoursUsed(OnDemandCostOfRIHoursUsedT&& value) {
    ...
    m_onDemandCostOfRIHoursUsed = std::forward<OnDemandCostOfRIHoursUsedT>(value);
  }
  template <typename OnDemandCostOfRIHoursUsedT = Aws::String>
  ReservationAggregates& WithOnDemandCostOfRIHoursUsed(OnDemandCostOfRIHoursUsedT&& value) {
    SetOnDemandCostOfRIHoursUsed(std::forward<OnDemandCostOfRIHoursUsedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetRISavings(NetRISavingsT&& value) {
    ...
    m_netRISavings = std::forward<NetRISavingsT>(value);
  }
  template <typename NetRISavingsT = Aws::String>
  ReservationAggregates& WithNetRISavings(NetRISavingsT&& value) {
    SetNetRISavings(std::forward<NetRISavingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalPotentialRISavings(TotalPotentialRISavingsT&& value) {
    ...
    m_totalPotentialRISavings = std::forward<TotalPotentialRISavingsT>(value);
  }
  template <typename TotalPotentialRISavingsT = Aws::String>
  ReservationAggregates& WithTotalPotentialRISavings(TotalPotentialRISavingsT&& value) {
    SetTotalPotentialRISavings(std::forward<TotalPotentialRISavingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmortizedUpfrontFee(AmortizedUpfrontFeeT&& value) {
    ...
    m_amortizedUpfrontFee = std::forward<AmortizedUpfrontFeeT>(value);
  }
  template <typename AmortizedUpfrontFeeT = Aws::String>
  ReservationAggregates& WithAmortizedUpfrontFee(AmortizedUpfrontFeeT&& value) {
    SetAmortizedUpfrontFee(std::forward<AmortizedUpfrontFeeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmortizedRecurringFee(AmortizedRecurringFeeT&& value) {
    ...
    m_amortizedRecurringFee = std::forward<AmortizedRecurringFeeT>(value);
  }
  template <typename AmortizedRecurringFeeT = Aws::String>
  ReservationAggregates& WithAmortizedRecurringFee(AmortizedRecurringFeeT&& value) {
    SetAmortizedRecurringFee(std::forward<AmortizedRecurringFeeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalAmortizedFee(TotalAmortizedFeeT&& value) {
    ...
    m_totalAmortizedFee = std::forward<TotalAmortizedFeeT>(value);
  }
  template <typename TotalAmortizedFeeT = Aws::String>
  ReservationAggregates& WithTotalAmortizedFee(TotalAmortizedFeeT&& value) {
    SetTotalAmortizedFee(std::forward<TotalAmortizedFeeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRICostForUnusedHours(RICostForUnusedHoursT&& value) {
    ...
    m_rICostForUnusedHours = std::forward<RICostForUnusedHoursT>(value);
  }
  template <typename RICostForUnusedHoursT = Aws::String>
  ReservationAggregates& WithRICostForUnusedHours(RICostForUnusedHoursT&& value) {
    SetRICostForUnusedHours(std::forward<RICostForUnusedHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRealizedSavings(RealizedSavingsT&& value) {
    ...
    m_realizedSavings = std::forward<RealizedSavingsT>(value);
  }
  template <typename RealizedSavingsT = Aws::String>
  ReservationAggregates& WithRealizedSavings(RealizedSavingsT&& value) {
    SetRealizedSavings(std::forward<RealizedSavingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnrealizedSavings(UnrealizedSavingsT&& value) {
    ...
    m_unrealizedSavings = std::forward<UnrealizedSavingsT>(value);
  }
  template <typename UnrealizedSavingsT = Aws::String>
  ReservationAggregates& WithUnrealizedSavings(UnrealizedSavingsT&& value) {
    SetUnrealizedSavings(std::forward<UnrealizedSavingsT>(value));
    return *this;
  }
  ///@}
 private:
