...
class SavingsPlansAmortizedCommitment {
 public:
  ...
  void SetAmortizedRecurringCommitment(AmortizedRecurringCommitmentT&& value) {
    ...
    m_amortizedRecurringCommitment = std::forward<AmortizedRecurringCommitmentT>(value);
  }
  template <typename AmortizedRecurringCommitmentT = Aws::String>
  SavingsPlansAmortizedCommitment& WithAmortizedRecurringCommitment(AmortizedRecurringCommitmentT&& value) {
    SetAmortizedRecurringCommitment(std::forward<AmortizedRecurringCommitmentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmortizedUpfrontCommitment(AmortizedUpfrontCommitmentT&& value) {
    ...
    m_amortizedUpfrontCommitment = std::forward<AmortizedUpfrontCommitmentT>(value);
  }
  template <typename AmortizedUpfrontCommitmentT = Aws::String>
  SavingsPlansAmortizedCommitment& WithAmortizedUpfrontCommitment(AmortizedUpfrontCommitmentT&& value) {
    SetAmortizedUpfrontCommitment(std::forward<AmortizedUpfrontCommitmentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalAmortizedCommitment(TotalAmortizedCommitmentT&& value) {
    ...
    m_totalAmortizedCommitment = std::forward<TotalAmortizedCommitmentT>(value);
  }
  template <typename TotalAmortizedCommitmentT = Aws::String>
  SavingsPlansAmortizedCommitment& WithTotalAmortizedCommitment(TotalAmortizedCommitmentT&& value) {
    SetTotalAmortizedCommitment(std::forward<TotalAmortizedCommitmentT>(value));
    return *this;
  }
  ///@}
 private:
