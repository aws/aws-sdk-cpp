...
class SavingsPlansSavings {
 public:
  ...
  void SetNetSavings(NetSavingsT&& value) {
    ...
    m_netSavings = std::forward<NetSavingsT>(value);
  }
  template <typename NetSavingsT = Aws::String>
  SavingsPlansSavings& WithNetSavings(NetSavingsT&& value) {
    SetNetSavings(std::forward<NetSavingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnDemandCostEquivalent(OnDemandCostEquivalentT&& value) {
    ...
    m_onDemandCostEquivalent = std::forward<OnDemandCostEquivalentT>(value);
  }
  template <typename OnDemandCostEquivalentT = Aws::String>
  SavingsPlansSavings& WithOnDemandCostEquivalent(OnDemandCostEquivalentT&& value) {
    SetOnDemandCostEquivalent(std::forward<OnDemandCostEquivalentT>(value));
    return *this;
  }
  ///@}
 private:
