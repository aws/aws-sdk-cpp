...
class ReservationPurchaseRecommendationMetadata {
 public:
  ...
  template <typename RecommendationIdT = Aws::String>
  ReservationPurchaseRecommendationMetadata& WithRecommendationId(RecommendationIdT&& value) {
  ...
  template <typename GenerationTimestampT = Aws::String>
  ReservationPurchaseRecommendationMetadata& WithGenerationTimestamp(GenerationTimestampT&& value) {
  ...
  template <typename AdditionalMetadataT = Aws::String>
  ReservationPurchaseRecommendationMetadata& WithAdditionalMetadata(AdditionalMetadataT&& value) {
