...
class GetApproximateUsageRecordsRequest : public CostExplorerRequest {
 public:
  ...
  inline GetApproximateUsageRecordsRequest& WithGranularity(Granularity value) {
  ...
  template <typename ServicesT = Aws::Vector<Aws::String>>
  GetApproximateUsageRecordsRequest& WithServices(ServicesT&& value) {
    SetServices(std::forward<ServicesT>(value));
    return *this;
  }
  template <typename ServicesT = Aws::String>
  GetApproximateUsageRecordsRequest& AddServices(ServicesT&& value) {
    m_servicesHasBeenSet = true;
  ...
  inline void SetApproximationDimension(ApproximationDimension value) {
    m_approximationDimensionHasBeenSet = true;
    m_approximationDimension = value;
  }
  inline GetApproximateUsageRecordsRequest& WithApproximationDimension(ApproximationDimension value) {
    SetApproximationDimension(value);
    return *this;
  }
  ///@}
 private:
