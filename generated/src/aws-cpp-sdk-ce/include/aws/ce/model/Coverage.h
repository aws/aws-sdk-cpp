...
class Coverage {
 public:
  ...
  void SetCoverageHours(CoverageHoursT&& value) {
    ...
    m_coverageHours = std::forward<CoverageHoursT>(value);
  }
  template <typename CoverageHoursT = CoverageHours>
  Coverage& WithCoverageHours(CoverageHoursT&& value) {
    SetCoverageHours(std::forward<CoverageHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCoverageNormalizedUnits(CoverageNormalizedUnitsT&& value) {
    ...
    m_coverageNormalizedUnits = std::forward<CoverageNormalizedUnitsT>(value);
  }
  template <typename CoverageNormalizedUnitsT = CoverageNormalizedUnits>
  Coverage& WithCoverageNormalizedUnits(CoverageNormalizedUnitsT&& value) {
    SetCoverageNormalizedUnits(std::forward<CoverageNormalizedUnitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCoverageCost(CoverageCostT&& value) {
    ...
    m_coverageCost = std::forward<CoverageCostT>(value);
  }
  template <typename CoverageCostT = CoverageCost>
  Coverage& WithCoverageCost(CoverageCostT&& value) {
    SetCoverageCost(std::forward<CoverageCostT>(value));
    return *this;
  }
  ///@}
 private:
