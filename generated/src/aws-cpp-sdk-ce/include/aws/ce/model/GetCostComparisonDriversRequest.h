...
namespace Model
{
  ...
  public:
    ...
    template<typename BillingViewArnT = Aws::String>
    GetCostComparisonDriversRequest& WithBillingViewArn(BillingViewArnT&& value) { SetBillingViewArn(std::forward<BillingViewArnT>(value)); return *this;}
    ///@}
    ...
    template<typename BaselineTimePeriodT = DateInterval>
    GetCostComparisonDriversRequest& WithBaselineTimePeriod(BaselineTimePeriodT&& value) { SetBaselineTimePeriod(std::forward<BaselineTimePeriodT>(value)); return *this;}
    ///@}
    ...
    template<typename ComparisonTimePeriodT = DateInterval>
    GetCostComparisonDriversRequest& WithComparisonTimePeriod(ComparisonTimePeriodT&& value) { SetComparisonTimePeriod(std::forward<ComparisonTimePeriodT>(value)); return *this;}
    ///@}
    ...
    template<typename MetricForComparisonT = Aws::String>
    GetCostComparisonDriversRequest& WithMetricForComparison(MetricForComparisonT&& value) { SetMetricForComparison(std::forward<MetricForComparisonT>(value)); return *this;}
    ///@}
    ...
    template<typename FilterT = Expression>
    GetCostComparisonDriversRequest& WithFilter(FilterT&& value) { SetFilter(std::forward<FilterT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupByT = Aws::Vector<GroupDefinition>>
    GetCostComparisonDriversRequest& WithGroupBy(GroupByT&& value) { SetGroupBy(std::forward<GroupByT>(value)); return *this;}
    template<typename GroupByT = GroupDefinition>
    GetCostComparisonDriversRequest& AddGroupBy(GroupByT&& value) { m_groupByHasBeenSet = true; m_groupBy.emplace_back(std::forward<GroupByT>(value)); return *this; }
    ///@}
    ...
    inline GetCostComparisonDriversRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
    ...
    template<typename NextPageTokenT = Aws::String>
    GetCostComparisonDriversRequest& WithNextPageToken(NextPageTokenT&& value) { SetNextPageToken(std::forward<NextPageTokenT>(value)); return *this;}
    ///@}
  private:
