...
class GetSavingsPlansUtilizationResult {
 public:
   ...
   */
  inline const Aws::Vector<SavingsPlansUtilizationByTime>& GetSavingsPlansUtilizationsByTime() const {
    return m_savingsPlansUtilizationsByTime;
  }
  template <typename SavingsPlansUtilizationsByTimeT = Aws::Vector<SavingsPlansUtilizationByTime>>
  void SetSavingsPlansUtilizationsByTime(SavingsPlansUtilizationsByTimeT&& value) {
    m_savingsPlansUtilizationsByTimeHasBeenSet = true;
    m_savingsPlansUtilizationsByTime = std::forward<SavingsPlansUtilizationsByTimeT>(value);
  }
  template <typename SavingsPlansUtilizationsByTimeT = Aws::Vector<SavingsPlansUtilizationByTime>>
  GetSavingsPlansUtilizationResult& WithSavingsPlansUtilizationsByTime(SavingsPlansUtilizationsByTimeT&& value) {
    SetSavingsPlansUtilizationsByTime(std::forward<SavingsPlansUtilizationsByTimeT>(value));
    return *this;
  }
  template <typename SavingsPlansUtilizationsByTimeT = SavingsPlansUtilizationByTime>
  GetSavingsPlansUtilizationResult& AddSavingsPlansUtilizationsByTime(SavingsPlansUtilizationsByTimeT&& value) {
    m_savingsPlansUtilizationsByTimeHasBeenSet = true;
    m_savingsPlansUtilizationsByTime.emplace_back(std::forward<SavingsPlansUtilizationsByTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TotalT = SavingsPlansUtilizationAggregates>
  GetSavingsPlansUtilizationResult& WithTotal(TotalT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSavingsPlansUtilizationResult& WithRequestId(RequestIdT&& value) {
