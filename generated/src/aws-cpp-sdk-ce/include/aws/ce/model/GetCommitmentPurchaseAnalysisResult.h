...
class GetCommitmentPurchaseAnalysisResult {
 public:
  ...
  AWS_COSTEXPLORER_API GetCommitmentPurchaseAnalysisResult& operator=(
  ...
  void SetAnalysisCompletionTime(AnalysisCompletionTimeT&& value) {
    ...
    m_analysisCompletionTime = std::forward<AnalysisCompletionTimeT>(value);
  }
  template <typename AnalysisCompletionTimeT = Aws::String>
  GetCommitmentPurchaseAnalysisResult& WithAnalysisCompletionTime(AnalysisCompletionTimeT&& value) {
    SetAnalysisCompletionTime(std::forward<AnalysisCompletionTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetCommitmentPurchaseAnalysisResult& WithAnalysisStatus(AnalysisStatus value) {
  ...
  inline GetCommitmentPurchaseAnalysisResult& WithErrorCode(ErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const CommitmentPurchaseAnalysisConfiguration& GetCommitmentPurchaseAnalysisConfiguration() const {
    return m_commitmentPurchaseAnalysisConfiguration;
  }
  ...
  void SetCommitmentPurchaseAnalysisConfiguration(CommitmentPurchaseAnalysisConfigurationT&& value) {
    ...
    m_commitmentPurchaseAnalysisConfiguration = std::forward<CommitmentPurchaseAnalysisConfigurationT>(value);
  }
  template <typename CommitmentPurchaseAnalysisConfigurationT = CommitmentPurchaseAnalysisConfiguration>
  GetCommitmentPurchaseAnalysisResult& WithCommitmentPurchaseAnalysisConfiguration(CommitmentPurchaseAnalysisConfigurationT&& value) {
    SetCommitmentPurchaseAnalysisConfiguration(std::forward<CommitmentPurchaseAnalysisConfigurationT>(value));
    return *this;
  }
  ///@}
