...
class TotalImpactFilter {
 public:
  ...
  inline void SetNumericOperator(NumericOperator value) {
    m_numericOperatorHasBeenSet = true;
    m_numericOperator = value;
  }
  inline TotalImpactFilter& WithNumericOperator(NumericOperator value) {
    SetNumericOperator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartValue(double value) {
    m_startValueHasBeenSet = true;
    m_startValue = value;
  }
  inline TotalImpactFilter& WithStartValue(double value) {
    SetStartValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEndValue(double value) {
    m_endValueHasBeenSet = true;
    m_endValue = value;
  }
  inline TotalImpactFilter& WithEndValue(double value) {
    SetEndValue(value);
    return *this;
  }
  ///@}
