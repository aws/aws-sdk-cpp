...
class EC2ResourceUtilization {
 public:
  ...
  void SetMaxCpuUtilizationPercentage(MaxCpuUtilizationPercentageT&& value) {
    m_maxCpuUtilizationPercentageHasBeenSet = true;
    m_maxCpuUtilizationPercentage = std::forward<MaxCpuUtilizationPercentageT>(value);
  }
  template <typename MaxCpuUtilizationPercentageT = Aws::String>
  EC2ResourceUtilization& WithMaxCpuUtilizationPercentage(MaxCpuUtilizationPercentageT&& value) {
    SetMaxCpuUtilizationPercentage(std::forward<MaxCpuUtilizationPercentageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaxMemoryUtilizationPercentage(MaxMemoryUtilizationPercentageT&& value) {
    m_maxMemoryUtilizationPercentageHasBeenSet = true;
    m_maxMemoryUtilizationPercentage = std::forward<MaxMemoryUtilizationPercentageT>(value);
  }
  template <typename MaxMemoryUtilizationPercentageT = Aws::String>
  EC2ResourceUtilization& WithMaxMemoryUtilizationPercentage(MaxMemoryUtilizationPercentageT&& value) {
    SetMaxMemoryUtilizationPercentage(std::forward<MaxMemoryUtilizationPercentageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaxStorageUtilizationPercentage(MaxStorageUtilizationPercentageT&& value) {
    m_maxStorageUtilizationPercentageHasBeenSet = true;
    m_maxStorageUtilizationPercentage = std::forward<MaxStorageUtilizationPercentageT>(value);
  }
  template <typename MaxStorageUtilizationPercentageT = Aws::String>
  EC2ResourceUtilization& WithMaxStorageUtilizationPercentage(MaxStorageUtilizationPercentageT&& value) {
    SetMaxStorageUtilizationPercentage(std::forward<MaxStorageUtilizationPercentageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEBSResourceUtilization(EBSResourceUtilizationT&& value) {
    m_eBSResourceUtilizationHasBeenSet = true;
    m_eBSResourceUtilization = std::forward<EBSResourceUtilizationT>(value);
  }
  template <typename EBSResourceUtilizationT = EBSResourceUtilization>
  EC2ResourceUtilization& WithEBSResourceUtilization(EBSResourceUtilizationT&& value) {
    SetEBSResourceUtilization(std::forward<EBSResourceUtilizationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDiskResourceUtilization(DiskResourceUtilizationT&& value) {
    m_diskResourceUtilizationHasBeenSet = true;
    m_diskResourceUtilization = std::forward<DiskResourceUtilizationT>(value);
  }
  template <typename DiskResourceUtilizationT = DiskResourceUtilization>
  EC2ResourceUtilization& WithDiskResourceUtilization(DiskResourceUtilizationT&& value) {
    SetDiskResourceUtilization(std::forward<DiskResourceUtilizationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkResourceUtilization(NetworkResourceUtilizationT&& value) {
    m_networkResourceUtilizationHasBeenSet = true;
    m_networkResourceUtilization = std::forward<NetworkResourceUtilizationT>(value);
  }
  template <typename NetworkResourceUtilizationT = NetworkResourceUtilization>
  EC2ResourceUtilization& WithNetworkResourceUtilization(NetworkResourceUtilizationT&& value) {
    SetNetworkResourceUtilization(std::forward<NetworkResourceUtilizationT>(value));
    return *this;
  }
  ///@}
 private:
