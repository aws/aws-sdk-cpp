...
class ListCostAllocationTagsRequest : public CostExplorerRequest {
 public:
  ...
  inline ListCostAllocationTagsRequest& WithStatus(CostAllocationTagStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagKeysT = Aws::Vector<Aws::String>>
  ListCostAllocationTagsRequest& WithTagKeys(TagKeysT&& value) {
    SetTagKeys(std::forward<TagKeysT>(value));
    return *this;
  }
  template <typename TagKeysT = Aws::String>
  ListCostAllocationTagsRequest& AddTagKeys(TagKeysT&& value) {
    m_tagKeysHasBeenSet = true;
  ...
  inline ListCostAllocationTagsRequest& WithType(CostAllocationTagType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCostAllocationTagsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCostAllocationTagsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
