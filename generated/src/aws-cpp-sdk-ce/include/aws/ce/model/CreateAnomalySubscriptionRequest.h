...
class CreateAnomalySubscriptionRequest : public CostExplorerRequest {
 public:
  ...
  void SetAnomalySubscription(AnomalySubscriptionT&& value) {
    m_anomalySubscriptionHasBeenSet = true;
    m_anomalySubscription = std::forward<AnomalySubscriptionT>(value);
  }
  template <typename AnomalySubscriptionT = AnomalySubscription>
  CreateAnomalySubscriptionRequest& WithAnomalySubscription(AnomalySubscriptionT&& value) {
    SetAnomalySubscription(std::forward<AnomalySubscriptionT>(value));
    return *this;
  }
  ///@}
