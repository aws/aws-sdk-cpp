...
class ComparisonMetricValue {
 public:
  ...
  void SetBaselineTimePeriodAmount(BaselineTimePeriodAmountT&& value) {
    ...
    m_baselineTimePeriodAmount = std::forward<BaselineTimePeriodAmountT>(value);
  }
  template <typename BaselineTimePeriodAmountT = Aws::String>
  ComparisonMetricValue& WithBaselineTimePeriodAmount(BaselineTimePeriodAmountT&& value) {
    SetBaselineTimePeriodAmount(std::forward<BaselineTimePeriodAmountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComparisonTimePeriodAmount(ComparisonTimePeriodAmountT&& value) {
    ...
    m_comparisonTimePeriodAmount = std::forward<ComparisonTimePeriodAmountT>(value);
  }
  template <typename ComparisonTimePeriodAmountT = Aws::String>
  ComparisonMetricValue& WithComparisonTimePeriodAmount(ComparisonTimePeriodAmountT&& value) {
    SetComparisonTimePeriodAmount(std::forward<ComparisonTimePeriodAmountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDifference(DifferenceT&& value) {
    m_differenceHasBeenSet = true;
    m_difference = std::forward<DifferenceT>(value);
  }
  template <typename DifferenceT = Aws::String>
  ComparisonMetricValue& WithDifference(DifferenceT&& value) {
    SetDifference(std::forward<DifferenceT>(value));
    return *this;
  }
  ///@}
