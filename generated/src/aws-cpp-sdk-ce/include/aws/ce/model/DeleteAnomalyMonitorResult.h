...
namespace Model
{
  ...
  {
  public:
    AWS_COSTEXPLORER_API DeleteAnomalyMonitorResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAnomalyMonitorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
