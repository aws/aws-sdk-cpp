...
class GetAnomaliesRequest : public CostExplorerRequest {
 public:
  ...
  void SetDateInterval(DateIntervalT&& value) {
    m_dateIntervalHasBeenSet = true;
    m_dateInterval = std::forward<DateIntervalT>(value);
  }
  template <typename DateIntervalT = AnomalyDateInterval>
  GetAnomaliesRequest& WithDateInterval(DateIntervalT&& value) {
    SetDateInterval(std::forward<DateIntervalT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetAnomaliesRequest& WithFeedback(AnomalyFeedbackType value) {
    SetFeedback(value);
    return *this;
  }
  ///@}
  ...
  void SetTotalImpact(TotalImpactT&& value) {
    m_totalImpactHasBeenSet = true;
    m_totalImpact = std::forward<TotalImpactT>(value);
  }
  template <typename TotalImpactT = TotalImpactFilter>
  GetAnomaliesRequest& WithTotalImpact(TotalImpactT&& value) {
    SetTotalImpact(std::forward<TotalImpactT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetAnomaliesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
