...
class SavingsPlansPurchaseRecommendationSummary {
 public:
  ...
  void SetEstimatedTotalCost(EstimatedTotalCostT&& value) {
    ...
    m_estimatedTotalCost = std::forward<EstimatedTotalCostT>(value);
  }
  template <typename EstimatedTotalCostT = Aws::String>
  SavingsPlansPurchaseRecommendationSummary& WithEstimatedTotalCost(EstimatedTotalCostT&& value) {
    SetEstimatedTotalCost(std::forward<EstimatedTotalCostT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDailyCommitmentToPurchase(DailyCommitmentToPurchaseT&& value) {
    ...
    m_dailyCommitmentToPurchase = std::forward<DailyCommitmentToPurchaseT>(value);
  }
  template <typename DailyCommitmentToPurchaseT = Aws::String>
  SavingsPlansPurchaseRecommendationSummary& WithDailyCommitmentToPurchase(DailyCommitmentToPurchaseT&& value) {
    SetDailyCommitmentToPurchase(std::forward<DailyCommitmentToPurchaseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EstimatedOnDemandCostWithCurrentCommitmentT = Aws::String>
  SavingsPlansPurchaseRecommendationSummary& WithEstimatedOnDemandCostWithCurrentCommitment(
