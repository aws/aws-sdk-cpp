...
class Impact {
 public:
  ...
  inline void SetMaxImpact(double value) {
    m_maxImpactHasBeenSet = true;
    m_maxImpact = value;
  }
  inline Impact& WithMaxImpact(double value) {
    SetMaxImpact(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalImpact(double value) {
    m_totalImpactHasBeenSet = true;
    m_totalImpact = value;
  }
  inline Impact& WithTotalImpact(double value) {
  ...
  inline void SetTotalActualSpend(double value) {
    m_totalActualSpendHasBeenSet = true;
    m_totalActualSpend = value;
  }
  inline Impact& WithTotalActualSpend(double value) {
    SetTotalActualSpend(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalExpectedSpend(double value) {
    m_totalExpectedSpendHasBeenSet = true;
    m_totalExpectedSpend = value;
  }
  inline Impact& WithTotalExpectedSpend(double value) {
    SetTotalExpectedSpend(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalImpactPercentage(double value) {
    m_totalImpactPercentageHasBeenSet = true;
    m_totalImpactPercentage = value;
  }
  inline Impact& WithTotalImpactPercentage(double value) {
    SetTotalImpactPercentage(value);
    return *this;
  }
  ///@}
 private:
