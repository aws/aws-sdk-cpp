...
class CoverageHours {
 public:
  ...
  void SetOnDemandHours(OnDemandHoursT&& value) {
    ...
    m_onDemandHours = std::forward<OnDemandHoursT>(value);
  }
  template <typename OnDemandHoursT = Aws::String>
  CoverageHours& WithOnDemandHours(OnDemandHoursT&& value) {
    SetOnDemandHours(std::forward<OnDemandHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReservedHours(ReservedHoursT&& value) {
    ...
    m_reservedHours = std::forward<ReservedHoursT>(value);
  }
  template <typename ReservedHoursT = Aws::String>
  CoverageHours& WithReservedHours(ReservedHoursT&& value) {
    SetReservedHours(std::forward<ReservedHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalRunningHours(TotalRunningHoursT&& value) {
    ...
    m_totalRunningHours = std::forward<TotalRunningHoursT>(value);
  }
  template <typename TotalRunningHoursT = Aws::String>
  CoverageHours& WithTotalRunningHours(TotalRunningHoursT&& value) {
    SetTotalRunningHours(std::forward<TotalRunningHoursT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCoverageHoursPercentage(CoverageHoursPercentageT&& value) {
    ...
    m_coverageHoursPercentage = std::forward<CoverageHoursPercentageT>(value);
  }
  template <typename CoverageHoursPercentageT = Aws::String>
  CoverageHours& WithCoverageHoursPercentage(CoverageHoursPercentageT&& value) {
    SetCoverageHoursPercentage(std::forward<CoverageHoursPercentageT>(value));
    return *this;
  }
  ///@}
 private:
