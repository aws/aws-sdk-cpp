...
class ESInstanceDetails {
 public:
  ...
  void SetInstanceClass(InstanceClassT&& value) {
    ...
    m_instanceClass = std::forward<InstanceClassT>(value);
  }
  template <typename InstanceClassT = Aws::String>
  ESInstanceDetails& WithInstanceClass(InstanceClassT&& value) {
    SetInstanceClass(std::forward<InstanceClassT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceSize(InstanceSizeT&& value) {
    m_instanceSizeHasBeenSet = true;
    m_instanceSize = std::forward<InstanceSizeT>(value);
  }
  template <typename InstanceSizeT = Aws::String>
  ESInstanceDetails& WithInstanceSize(InstanceSizeT&& value) {
    SetInstanceSize(std::forward<InstanceSizeT>(value));
    return *this;
  }
  ///@}
  ...
  inline ESInstanceDetails& WithCurrentGeneration(bool value) {
  ...
  inline ESInstanceDetails& WithSizeFlexEligible(bool value) {
