...
class ProvideAnomalyFeedbackResult {
 public:
  ...
  void SetAnomalyId(AnomalyIdT&& value) {
    ...
    m_anomalyId = std::forward<AnomalyIdT>(value);
  }
  template <typename AnomalyIdT = Aws::String>
  ProvideAnomalyFeedbackResult& WithAnomalyId(AnomalyIdT&& value) {
    SetAnomalyId(std::forward<AnomalyIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ProvideAnomalyFeedbackResult& WithRequestId(RequestIdT&& value) {
