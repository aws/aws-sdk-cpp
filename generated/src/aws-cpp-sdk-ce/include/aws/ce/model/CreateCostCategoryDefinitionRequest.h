...
class CreateCostCategoryDefinitionRequest : public CostExplorerRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateCostCategoryDefinitionRequest& WithName(NameT&& value) {
  ...
  template <typename EffectiveStartT = Aws::String>
  CreateCostCategoryDefinitionRequest& WithEffectiveStart(EffectiveStartT&& value) {
  ...
  inline void SetRuleVersion(CostCategoryRuleVersion value) {
    m_ruleVersionHasBeenSet = true;
    m_ruleVersion = value;
  }
  inline CreateCostCategoryDefinitionRequest& WithRuleVersion(CostCategoryRuleVersion value) {
  ...
  template <typename RulesT = Aws::Vector<CostCategoryRule>>
  CreateCostCategoryDefinitionRequest& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = CostCategoryRule>
  CreateCostCategoryDefinitionRequest& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
  ...
  template <typename DefaultValueT = Aws::String>
  CreateCostCategoryDefinitionRequest& WithDefaultValue(DefaultValueT&& value) {
  ...
  void SetSplitChargeRules(SplitChargeRulesT&& value) {
    ...
    m_splitChargeRules = std::forward<SplitChargeRulesT>(value);
  }
  template <typename SplitChargeRulesT = Aws::Vector<CostCategorySplitChargeRule>>
  CreateCostCategoryDefinitionRequest& WithSplitChargeRules(SplitChargeRulesT&& value) {
    SetSplitChargeRules(std::forward<SplitChargeRulesT>(value));
    return *this;
  }
  template <typename SplitChargeRulesT = CostCategorySplitChargeRule>
  CreateCostCategoryDefinitionRequest& AddSplitChargeRules(SplitChargeRulesT&& value) {
    m_splitChargeRulesHasBeenSet = true;
    m_splitChargeRules.emplace_back(std::forward<SplitChargeRulesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceTagsT = Aws::Vector<ResourceTag>>
  CreateCostCategoryDefinitionRequest& WithResourceTags(ResourceTagsT&& value) {
    SetResourceTags(std::forward<ResourceTagsT>(value));
    return *this;
  }
  template <typename ResourceTagsT = ResourceTag>
  CreateCostCategoryDefinitionRequest& AddResourceTags(ResourceTagsT&& value) {
    m_resourceTagsHasBeenSet = true;
