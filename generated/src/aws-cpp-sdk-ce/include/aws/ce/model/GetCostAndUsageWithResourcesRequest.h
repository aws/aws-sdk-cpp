...
class GetCostAndUsageWithResourcesRequest : public CostExplorerRequest {
 public:
  ...
  template <typename TimePeriodT = DateInterval>
  GetCostAndUsageWithResourcesRequest& WithTimePeriod(TimePeriodT&& value) {
  ...
  inline GetCostAndUsageWithResourcesRequest& WithGranularity(Granularity value) {
  ...
  template <typename FilterT = Expression>
  GetCostAndUsageWithResourcesRequest& WithFilter(FilterT&& value) {
  ...
  template <typename MetricsT = Aws::Vector<Aws::String>>
  GetCostAndUsageWithResourcesRequest& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  template <typename MetricsT = Aws::String>
  GetCostAndUsageWithResourcesRequest& AddMetrics(MetricsT&& value) {
    m_metricsHasBeenSet = true;
  ...
  template <typename GroupByT = Aws::Vector<GroupDefinition>>
  GetCostAndUsageWithResourcesRequest& WithGroupBy(GroupByT&& value) {
    SetGroupBy(std::forward<GroupByT>(value));
    return *this;
  }
  template <typename GroupByT = GroupDefinition>
  GetCostAndUsageWithResourcesRequest& AddGroupBy(GroupByT&& value) {
    m_groupByHasBeenSet = true;
  ...
  template <typename BillingViewArnT = Aws::String>
  GetCostAndUsageWithResourcesRequest& WithBillingViewArn(BillingViewArnT&& value) {
  ...
  template <typename NextPageTokenT = Aws::String>
  GetCostAndUsageWithResourcesRequest& WithNextPageToken(NextPageTokenT&& value) {
