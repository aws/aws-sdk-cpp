...
class NetworkResourceUtilization {
 public:
  ...
  void SetNetworkInBytesPerSecond(NetworkInBytesPerSecondT&& value) {
    ...
    m_networkInBytesPerSecond = std::forward<NetworkInBytesPerSecondT>(value);
  }
  template <typename NetworkInBytesPerSecondT = Aws::String>
  NetworkResourceUtilization& WithNetworkInBytesPerSecond(NetworkInBytesPerSecondT&& value) {
    SetNetworkInBytesPerSecond(std::forward<NetworkInBytesPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkOutBytesPerSecond(NetworkOutBytesPerSecondT&& value) {
    ...
    m_networkOutBytesPerSecond = std::forward<NetworkOutBytesPerSecondT>(value);
  }
  template <typename NetworkOutBytesPerSecondT = Aws::String>
  NetworkResourceUtilization& WithNetworkOutBytesPerSecond(NetworkOutBytesPerSecondT&& value) {
    SetNetworkOutBytesPerSecond(std::forward<NetworkOutBytesPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkPacketsInPerSecond(NetworkPacketsInPerSecondT&& value) {
    ...
    m_networkPacketsInPerSecond = std::forward<NetworkPacketsInPerSecondT>(value);
  }
  template <typename NetworkPacketsInPerSecondT = Aws::String>
  NetworkResourceUtilization& WithNetworkPacketsInPerSecond(NetworkPacketsInPerSecondT&& value) {
    SetNetworkPacketsInPerSecond(std::forward<NetworkPacketsInPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkPacketsOutPerSecond(NetworkPacketsOutPerSecondT&& value) {
    ...
    m_networkPacketsOutPerSecond = std::forward<NetworkPacketsOutPerSecondT>(value);
  }
  template <typename NetworkPacketsOutPerSecondT = Aws::String>
  NetworkResourceUtilization& WithNetworkPacketsOutPerSecond(NetworkPacketsOutPerSecondT&& value) {
    SetNetworkPacketsOutPerSecond(std::forward<NetworkPacketsOutPerSecondT>(value));
    return *this;
  }
  ///@}
 private:
