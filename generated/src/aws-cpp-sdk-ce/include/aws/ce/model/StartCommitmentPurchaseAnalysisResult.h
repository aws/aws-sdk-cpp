...
class StartCommitmentPurchaseAnalysisResult {
 public:
  ...
  AWS_COSTEXPLORER_API StartCommitmentPurchaseAnalysisResult& operator=(
  ...
  template <typename AnalysisIdT = Aws::String>
  StartCommitmentPurchaseAnalysisResult& WithAnalysisId(AnalysisIdT&& value) {
  ...
  void SetAnalysisStartedTime(AnalysisStartedTimeT&& value) {
    ...
    m_analysisStartedTime = std::forward<AnalysisStartedTimeT>(value);
  }
  template <typename AnalysisStartedTimeT = Aws::String>
  StartCommitmentPurchaseAnalysisResult& WithAnalysisStartedTime(AnalysisStartedTimeT&& value) {
    SetAnalysisStartedTime(std::forward<AnalysisStartedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EstimatedCompletionTimeT = Aws::String>
  StartCommitmentPurchaseAnalysisResult& WithEstimatedCompletionTime(EstimatedCompletionTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartCommitmentPurchaseAnalysisResult& WithRequestId(RequestIdT&& value) {
