...
class GetAnomalySubscriptionsRequest : public CostExplorerRequest {
 public:
  ...
  void SetSubscriptionArnList(SubscriptionArnListT&& value) {
    m_subscriptionArnListHasBeenSet = true;
    m_subscriptionArnList = std::forward<SubscriptionArnListT>(value);
  }
  template <typename SubscriptionArnListT = Aws::Vector<Aws::String>>
  GetAnomalySubscriptionsRequest& WithSubscriptionArnList(SubscriptionArnListT&& value) {
    SetSubscriptionArnList(std::forward<SubscriptionArnListT>(value));
    return *this;
  }
  ...
  GetAnomalySubscriptionsRequest& AddSubscriptionArnList(SubscriptionArnListT&& value) {
    m_subscriptionArnListHasBeenSet = true;
    m_subscriptionArnList.emplace_back(std::forward<SubscriptionArnListT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetAnomalySubscriptionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
