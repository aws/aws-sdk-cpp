...
class ListCostCategoryDefinitionsResult {
 public:
  ...
  void SetCostCategoryReferences(CostCategoryReferencesT&& value) {
    m_costCategoryReferencesHasBeenSet = true;
    m_costCategoryReferences = std::forward<CostCategoryReferencesT>(value);
  }
  template <typename CostCategoryReferencesT = Aws::Vector<CostCategoryReference>>
  ListCostCategoryDefinitionsResult& WithCostCategoryReferences(CostCategoryReferencesT&& value) {
    SetCostCategoryReferences(std::forward<CostCategoryReferencesT>(value));
    return *this;
  }
  template <typename CostCategoryReferencesT = CostCategoryReference>
  ListCostCategoryDefinitionsResult& AddCostCategoryReferences(CostCategoryReferencesT&& value) {
    m_costCategoryReferencesHasBeenSet = true;
    m_costCategoryReferences.emplace_back(std::forward<CostCategoryReferencesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCostCategoryDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCostCategoryDefinitionsResult& WithRequestId(RequestIdT&& value) {
