...
class SavingsPlansPurchaseRecommendationMetadata {
 public:
  ...
  template <typename RecommendationIdT = Aws::String>
  SavingsPlansPurchaseRecommendationMetadata& WithRecommendationId(RecommendationIdT&& value) {
  ...
  template <typename GenerationTimestampT = Aws::String>
  SavingsPlansPurchaseRecommendationMetadata& WithGenerationTimestamp(GenerationTimestampT&& value) {
  ...
  template <typename AdditionalMetadataT = Aws::String>
  SavingsPlansPurchaseRecommendationMetadata& WithAdditionalMetadata(AdditionalMetadataT&& value) {
