...
class CoverageNormalizedUnits {
 public:
  ...
  void SetOnDemandNormalizedUnits(OnDemandNormalizedUnitsT&& value) {
    m_onDemandNormalizedUnitsHasBeenSet = true;
    m_onDemandNormalizedUnits = std::forward<OnDemandNormalizedUnitsT>(value);
  }
  template <typename OnDemandNormalizedUnitsT = Aws::String>
  CoverageNormalizedUnits& WithOnDemandNormalizedUnits(OnDemandNormalizedUnitsT&& value) {
    SetOnDemandNormalizedUnits(std::forward<OnDemandNormalizedUnitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReservedNormalizedUnits(ReservedNormalizedUnitsT&& value) {
    m_reservedNormalizedUnitsHasBeenSet = true;
    m_reservedNormalizedUnits = std::forward<ReservedNormalizedUnitsT>(value);
  }
  template <typename ReservedNormalizedUnitsT = Aws::String>
  CoverageNormalizedUnits& WithReservedNormalizedUnits(ReservedNormalizedUnitsT&& value) {
    SetReservedNormalizedUnits(std::forward<ReservedNormalizedUnitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalRunningNormalizedUnits(TotalRunningNormalizedUnitsT&& value) {
    m_totalRunningNormalizedUnitsHasBeenSet = true;
    m_totalRunningNormalizedUnits = std::forward<TotalRunningNormalizedUnitsT>(value);
  }
  template <typename TotalRunningNormalizedUnitsT = Aws::String>
  CoverageNormalizedUnits& WithTotalRunningNormalizedUnits(TotalRunningNormalizedUnitsT&& value) {
    SetTotalRunningNormalizedUnits(std::forward<TotalRunningNormalizedUnitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCoverageNormalizedUnitsPercentage(CoverageNormalizedUnitsPercentageT&& value) {
    m_coverageNormalizedUnitsPercentageHasBeenSet = true;
    m_coverageNormalizedUnitsPercentage = std::forward<CoverageNormalizedUnitsPercentageT>(value);
  }
  template <typename CoverageNormalizedUnitsPercentageT = Aws::String>
  CoverageNormalizedUnits& WithCoverageNormalizedUnitsPercentage(CoverageNormalizedUnitsPercentageT&& value) {
    SetCoverageNormalizedUnitsPercentage(std::forward<CoverageNormalizedUnitsPercentageT>(value));
    return *this;
  }
  ///@}
 private:
