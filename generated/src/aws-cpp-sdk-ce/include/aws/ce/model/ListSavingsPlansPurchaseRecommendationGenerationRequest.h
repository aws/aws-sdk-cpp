...
class ListSavingsPlansPurchaseRecommendationGenerationRequest : public CostExplorerRequest {
 public:
  ...
  inline ListSavingsPlansPurchaseRecommendationGenerationRequest& WithGenerationStatus(GenerationStatus value) {
  ...
  template <typename RecommendationIdsT = Aws::Vector<Aws::String>>
  ListSavingsPlansPurchaseRecommendationGenerationRequest& WithRecommendationIds(RecommendationIdsT&& value) {
    SetRecommendationIds(std::forward<RecommendationIdsT>(value));
    return *this;
  }
  template <typename RecommendationIdsT = Aws::String>
  ListSavingsPlansPurchaseRecommendationGenerationRequest& AddRecommendationIds(RecommendationIdsT&& value) {
    m_recommendationIdsHasBeenSet = true;
  ...
  inline ListSavingsPlansPurchaseRecommendationGenerationRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListSavingsPlansPurchaseRecommendationGenerationRequest& WithNextPageToken(NextPageTokenT&& value) {
