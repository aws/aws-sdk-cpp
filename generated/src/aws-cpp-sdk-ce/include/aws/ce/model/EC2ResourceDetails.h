...
class EC2ResourceDetails {
 public:
  ...
  void SetHourlyOnDemandRate(HourlyOnDemandRateT&& value) {
    ...
    m_hourlyOnDemandRate = std::forward<HourlyOnDemandRateT>(value);
  }
  template <typename HourlyOnDemandRateT = Aws::String>
  EC2ResourceDetails& WithHourlyOnDemandRate(HourlyOnDemandRateT&& value) {
    SetHourlyOnDemandRate(std::forward<HourlyOnDemandRateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSku(SkuT&& value) {
    ...
    m_sku = std::forward<SkuT>(value);
  }
  template <typename SkuT = Aws::String>
  EC2ResourceDetails& WithSku(SkuT&& value) {
    SetSku(std::forward<SkuT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVcpu(VcpuT&& value) {
    ...
    m_vcpu = std::forward<VcpuT>(value);
  }
  template <typename VcpuT = Aws::String>
  EC2ResourceDetails& WithVcpu(VcpuT&& value) {
    SetVcpu(std::forward<VcpuT>(value));
    return *this;
  }
  ///@}
 private:
