...
class GetSavingsPlansCoverageResult {
 public:
  ...
  void SetSavingsPlansCoverages(SavingsPlansCoveragesT&& value) {
    m_savingsPlansCoveragesHasBeenSet = true;
    m_savingsPlansCoverages = std::forward<SavingsPlansCoveragesT>(value);
  }
  template <typename SavingsPlansCoveragesT = Aws::Vector<SavingsPlansCoverage>>
  GetSavingsPlansCoverageResult& WithSavingsPlansCoverages(SavingsPlansCoveragesT&& value) {
    SetSavingsPlansCoverages(std::forward<SavingsPlansCoveragesT>(value));
    return *this;
  }
  template <typename SavingsPlansCoveragesT = SavingsPlansCoverage>
  GetSavingsPlansCoverageResult& AddSavingsPlansCoverages(SavingsPlansCoveragesT&& value) {
    m_savingsPlansCoveragesHasBeenSet = true;
    m_savingsPlansCoverages.emplace_back(std::forward<SavingsPlansCoveragesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetSavingsPlansCoverageResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSavingsPlansCoverageResult& WithRequestId(RequestIdT&& value) {
