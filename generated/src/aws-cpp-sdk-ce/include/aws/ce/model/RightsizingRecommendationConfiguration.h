...
class RightsizingRecommendationConfiguration {
 public:
  ...
  inline void SetRecommendationTarget(RecommendationTarget value) {
    m_recommendationTargetHasBeenSet = true;
    m_recommendationTarget = value;
  }
  inline RightsizingRecommendationConfiguration& WithRecommendationTarget(RecommendationTarget value) {
    SetRecommendationTarget(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBenefitsConsidered(bool value) {
    m_benefitsConsideredHasBeenSet = true;
    m_benefitsConsidered = value;
  }
  inline RightsizingRecommendationConfiguration& WithBenefitsConsidered(bool value) {
    SetBenefitsConsidered(value);
    return *this;
  }
  ///@}
 private:
