...
class GetSavingsPlansUtilizationDetailsResult {
 public:
  ...
  AWS_COSTEXPLORER_API GetSavingsPlansUtilizationDetailsResult& operator=(
   ...
   */
  inline const Aws::Vector<SavingsPlansUtilizationDetail>& GetSavingsPlansUtilizationDetails() const {
    return m_savingsPlansUtilizationDetails;
  }
  template <typename SavingsPlansUtilizationDetailsT = Aws::Vector<SavingsPlansUtilizationDetail>>
  void SetSavingsPlansUtilizationDetails(SavingsPlansUtilizationDetailsT&& value) {
    m_savingsPlansUtilizationDetailsHasBeenSet = true;
    m_savingsPlansUtilizationDetails = std::forward<SavingsPlansUtilizationDetailsT>(value);
  }
  template <typename SavingsPlansUtilizationDetailsT = Aws::Vector<SavingsPlansUtilizationDetail>>
  GetSavingsPlansUtilizationDetailsResult& WithSavingsPlansUtilizationDetails(SavingsPlansUtilizationDetailsT&& value) {
    SetSavingsPlansUtilizationDetails(std::forward<SavingsPlansUtilizationDetailsT>(value));
    return *this;
  }
  template <typename SavingsPlansUtilizationDetailsT = SavingsPlansUtilizationDetail>
  GetSavingsPlansUtilizationDetailsResult& AddSavingsPlansUtilizationDetails(SavingsPlansUtilizationDetailsT&& value) {
    m_savingsPlansUtilizationDetailsHasBeenSet = true;
    m_savingsPlansUtilizationDetails.emplace_back(std::forward<SavingsPlansUtilizationDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TotalT = SavingsPlansUtilizationAggregates>
  GetSavingsPlansUtilizationDetailsResult& WithTotal(TotalT&& value) {
  ...
  template <typename TimePeriodT = DateInterval>
  GetSavingsPlansUtilizationDetailsResult& WithTimePeriod(TimePeriodT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetSavingsPlansUtilizationDetailsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSavingsPlansUtilizationDetailsResult& WithRequestId(RequestIdT&& value) {
