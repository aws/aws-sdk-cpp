...
class CostComparisonDriver {
 public:
  ...
  void SetCostSelector(CostSelectorT&& value) {
    m_costSelectorHasBeenSet = true;
    m_costSelector = std::forward<CostSelectorT>(value);
  }
  template <typename CostSelectorT = Expression>
  CostComparisonDriver& WithCostSelector(CostSelectorT&& value) {
    SetCostSelector(std::forward<CostSelectorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCostDrivers(CostDriversT&& value) {
    m_costDriversHasBeenSet = true;
    m_costDrivers = std::forward<CostDriversT>(value);
  }
  template <typename CostDriversT = Aws::Vector<CostDriver>>
  CostComparisonDriver& WithCostDrivers(CostDriversT&& value) {
    SetCostDrivers(std::forward<CostDriversT>(value));
    return *this;
  }
  template <typename CostDriversT = CostDriver>
  CostComparisonDriver& AddCostDrivers(CostDriversT&& value) {
    m_costDriversHasBeenSet = true;
    m_costDrivers.emplace_back(std::forward<CostDriversT>(value));
    return *this;
  }
  ///@}
 private:
