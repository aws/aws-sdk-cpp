...
class GetDimensionValuesRequest : public CostExplorerRequest {
 public:
  ...
  inline void SetContext(Context value) {
    m_contextHasBeenSet = true;
    m_context = value;
  }
  inline GetDimensionValuesRequest& WithContext(Context value) {
    SetContext(value);
    return *this;
  }
  ///@}
  ...
  inline GetDimensionValuesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
