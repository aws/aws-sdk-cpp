...
class GetReservationPurchaseRecommendationRequest : public CostExplorerRequest {
 public:
  ...
  inline GetReservationPurchaseRecommendationRequest& WithAccountScope(AccountScope value) {
  ...
  inline GetReservationPurchaseRecommendationRequest& WithLookbackPeriodInDays(LookbackPeriodInDays value) {
  ...
  inline GetReservationPurchaseRecommendationRequest& WithTermInYears(TermInYears value) {
  ...
  inline GetReservationPurchaseRecommendationRequest& WithPaymentOption(PaymentOption value) {
  ...
  inline GetReservationPurchaseRecommendationRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
