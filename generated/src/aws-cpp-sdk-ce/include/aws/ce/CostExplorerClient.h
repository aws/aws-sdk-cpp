...
class AWS_COSTEXPLORER_API CostExplorerClient : public Aws::Client::AWSJsonClient,
                                                ...
                                                public CostExplorerWaiter<CostExplorerClient> {
 public:
   ...
   */
  CostExplorerClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<CostExplorerEndpointProviderBase> endpointProvider = nullptr,
      const Aws::CostExplorer::CostExplorerClientConfiguration& clientConfiguration = Aws::CostExplorer::CostExplorerClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateAnomalyMonitor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAnomalyMonitor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAnomalyMonitorRequestT = Model::CreateAnomalyMonitorRequest>
  void CreateAnomalyMonitorAsync(const CreateAnomalyMonitorRequestT& request, const CreateAnomalyMonitorResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateAnomalySubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateAnomalySubscriptionRequestT = Model::CreateAnomalySubscriptionRequest>
  Model::CreateAnomalySubscriptionOutcomeCallable CreateAnomalySubscriptionCallable(
      const CreateAnomalySubscriptionRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::CreateAnomalySubscription, request);
  }

  /**
   * An Async wrapper for CreateAnomalySubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAnomalySubscriptionRequestT = Model::CreateAnomalySubscriptionRequest>
  void CreateAnomalySubscriptionAsync(const CreateAnomalySubscriptionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCostCategoryDefinitionOutcome CreateCostCategoryDefinition(
      const Model::CreateCostCategoryDefinitionRequest& request) const;

  /**
   * A Callable wrapper for CreateCostCategoryDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCostCategoryDefinitionRequestT = Model::CreateCostCategoryDefinitionRequest>
  Model::CreateCostCategoryDefinitionOutcomeCallable CreateCostCategoryDefinitionCallable(
      const CreateCostCategoryDefinitionRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::CreateCostCategoryDefinition, request);
  }

  /**
   * An Async wrapper for CreateCostCategoryDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCostCategoryDefinitionRequestT = Model::CreateCostCategoryDefinitionRequest>
  void CreateCostCategoryDefinitionAsync(const CreateCostCategoryDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteAnomalyMonitor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAnomalyMonitor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAnomalyMonitorRequestT = Model::DeleteAnomalyMonitorRequest>
  void DeleteAnomalyMonitorAsync(const DeleteAnomalyMonitorRequestT& request, const DeleteAnomalyMonitorResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAnomalySubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteAnomalySubscriptionRequestT = Model::DeleteAnomalySubscriptionRequest>
  Model::DeleteAnomalySubscriptionOutcomeCallable DeleteAnomalySubscriptionCallable(
      const DeleteAnomalySubscriptionRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::DeleteAnomalySubscription, request);
  }

  /**
   * An Async wrapper for DeleteAnomalySubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAnomalySubscriptionRequestT = Model::DeleteAnomalySubscriptionRequest>
  void DeleteAnomalySubscriptionAsync(const DeleteAnomalySubscriptionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCostCategoryDefinitionOutcome DeleteCostCategoryDefinition(
      const Model::DeleteCostCategoryDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DeleteCostCategoryDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCostCategoryDefinitionRequestT = Model::DeleteCostCategoryDefinitionRequest>
  Model::DeleteCostCategoryDefinitionOutcomeCallable DeleteCostCategoryDefinitionCallable(
      const DeleteCostCategoryDefinitionRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::DeleteCostCategoryDefinition, request);
  }

  /**
   * An Async wrapper for DeleteCostCategoryDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCostCategoryDefinitionRequestT = Model::DeleteCostCategoryDefinitionRequest>
  void DeleteCostCategoryDefinitionAsync(const DeleteCostCategoryDefinitionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCostCategoryDefinitionOutcome DescribeCostCategoryDefinition(
      const Model::DescribeCostCategoryDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DescribeCostCategoryDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCostCategoryDefinitionRequestT = Model::DescribeCostCategoryDefinitionRequest>
  Model::DescribeCostCategoryDefinitionOutcomeCallable DescribeCostCategoryDefinitionCallable(
      const DescribeCostCategoryDefinitionRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::DescribeCostCategoryDefinition, request);
  }

  /**
   * An Async wrapper for DescribeCostCategoryDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeCostCategoryDefinitionRequestT = Model::DescribeCostCategoryDefinitionRequest>
  void DescribeCostCategoryDefinitionAsync(const DescribeCostCategoryDefinitionRequestT& request,
  ...
  /**
   * An Async wrapper for GetAnomalies that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAnomaliesRequestT = Model::GetAnomaliesRequest>
  void GetAnomaliesAsync(const GetAnomaliesRequestT& request, const GetAnomaliesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAnomalyMonitors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAnomalyMonitors that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAnomalyMonitorsRequestT = Model::GetAnomalyMonitorsRequest>
  void GetAnomalyMonitorsAsync(const GetAnomalyMonitorsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetAnomalyMonitorsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetAnomalySubscriptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAnomalySubscriptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAnomalySubscriptionsRequestT = Model::GetAnomalySubscriptionsRequest>
  void GetAnomalySubscriptionsAsync(const GetAnomalySubscriptionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const GetAnomalySubscriptionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetApproximateUsageRecordsOutcome GetApproximateUsageRecords(
      const Model::GetApproximateUsageRecordsRequest& request) const;

  /**
   * A Callable wrapper for GetApproximateUsageRecords that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetApproximateUsageRecordsRequestT = Model::GetApproximateUsageRecordsRequest>
  Model::GetApproximateUsageRecordsOutcomeCallable GetApproximateUsageRecordsCallable(
      const GetApproximateUsageRecordsRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetApproximateUsageRecords, request);
  }

  /**
   * An Async wrapper for GetApproximateUsageRecords that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetApproximateUsageRecordsRequestT = Model::GetApproximateUsageRecordsRequest>
  void GetApproximateUsageRecordsAsync(const GetApproximateUsageRecordsRequestT& request,
                                       const GetApproximateUsageRecordsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCommitmentPurchaseAnalysisOutcome GetCommitmentPurchaseAnalysis(
      const Model::GetCommitmentPurchaseAnalysisRequest& request) const;

  /**
   * A Callable wrapper for GetCommitmentPurchaseAnalysis that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCommitmentPurchaseAnalysisRequestT = Model::GetCommitmentPurchaseAnalysisRequest>
  Model::GetCommitmentPurchaseAnalysisOutcomeCallable GetCommitmentPurchaseAnalysisCallable(
      const GetCommitmentPurchaseAnalysisRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetCommitmentPurchaseAnalysis, request);
  }

  /**
   * An Async wrapper for GetCommitmentPurchaseAnalysis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCommitmentPurchaseAnalysisRequestT = Model::GetCommitmentPurchaseAnalysisRequest>
  void GetCommitmentPurchaseAnalysisAsync(const GetCommitmentPurchaseAnalysisRequestT& request,
                                          const GetCommitmentPurchaseAnalysisResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCostAndUsage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCostAndUsageRequestT = Model::GetCostAndUsageRequest>
  void GetCostAndUsageAsync(const GetCostAndUsageRequestT& request, const GetCostAndUsageResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCostAndUsageComparisonsOutcome GetCostAndUsageComparisons(
      const Model::GetCostAndUsageComparisonsRequest& request) const;

  /**
   * A Callable wrapper for GetCostAndUsageComparisons that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCostAndUsageComparisonsRequestT = Model::GetCostAndUsageComparisonsRequest>
  Model::GetCostAndUsageComparisonsOutcomeCallable GetCostAndUsageComparisonsCallable(
      const GetCostAndUsageComparisonsRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetCostAndUsageComparisons, request);
  }

  /**
   * An Async wrapper for GetCostAndUsageComparisons that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCostAndUsageComparisonsRequestT = Model::GetCostAndUsageComparisonsRequest>
  void GetCostAndUsageComparisonsAsync(const GetCostAndUsageComparisonsRequestT& request,
                                       const GetCostAndUsageComparisonsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCostAndUsageWithResourcesOutcome GetCostAndUsageWithResources(
      const Model::GetCostAndUsageWithResourcesRequest& request) const;

  /**
   * A Callable wrapper for GetCostAndUsageWithResources that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCostAndUsageWithResourcesRequestT = Model::GetCostAndUsageWithResourcesRequest>
  Model::GetCostAndUsageWithResourcesOutcomeCallable GetCostAndUsageWithResourcesCallable(
      const GetCostAndUsageWithResourcesRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetCostAndUsageWithResources, request);
  }

  /**
   * An Async wrapper for GetCostAndUsageWithResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCostAndUsageWithResourcesRequestT = Model::GetCostAndUsageWithResourcesRequest>
  void GetCostAndUsageWithResourcesAsync(const GetCostAndUsageWithResourcesRequestT& request,
  ...
  /**
   * A Callable wrapper for GetCostCategories that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCostCategories that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCostCategoriesRequestT = Model::GetCostCategoriesRequest>
  void GetCostCategoriesAsync(const GetCostCategoriesRequestT& request, const GetCostCategoriesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCostComparisonDrivers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCostComparisonDrivers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCostComparisonDriversRequestT = Model::GetCostComparisonDriversRequest>
  void GetCostComparisonDriversAsync(const GetCostComparisonDriversRequestT& request,
                                     const GetCostComparisonDriversResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCostForecast that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCostForecastRequestT = Model::GetCostForecastRequest>
  void GetCostForecastAsync(const GetCostForecastRequestT& request, const GetCostForecastResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDimensionValues that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDimensionValues that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDimensionValuesRequestT = Model::GetDimensionValuesRequest>
  void GetDimensionValuesAsync(const GetDimensionValuesRequestT& request, const GetDimensionValuesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReservationCoverage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReservationCoverage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetReservationCoverageRequestT = Model::GetReservationCoverageRequest>
  void GetReservationCoverageAsync(const GetReservationCoverageRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetReservationPurchaseRecommendationOutcome GetReservationPurchaseRecommendation(
      const Model::GetReservationPurchaseRecommendationRequest& request) const;

  /**
   * A Callable wrapper for GetReservationPurchaseRecommendation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetReservationPurchaseRecommendationRequestT = Model::GetReservationPurchaseRecommendationRequest>
  Model::GetReservationPurchaseRecommendationOutcomeCallable GetReservationPurchaseRecommendationCallable(
      const GetReservationPurchaseRecommendationRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetReservationPurchaseRecommendation, request);
  }

  /**
   * An Async wrapper for GetReservationPurchaseRecommendation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetReservationPurchaseRecommendationRequestT = Model::GetReservationPurchaseRecommendationRequest>
  void GetReservationPurchaseRecommendationAsync(const GetReservationPurchaseRecommendationRequestT& request,
  ...
  /**
   * A Callable wrapper for GetReservationUtilization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetReservationUtilizationRequestT = Model::GetReservationUtilizationRequest>
  Model::GetReservationUtilizationOutcomeCallable GetReservationUtilizationCallable(
      const GetReservationUtilizationRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetReservationUtilization, request);
  }

  /**
   * An Async wrapper for GetReservationUtilization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetReservationUtilizationRequestT = Model::GetReservationUtilizationRequest>
  void GetReservationUtilizationAsync(const GetReservationUtilizationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRightsizingRecommendationOutcome GetRightsizingRecommendation(
      const Model::GetRightsizingRecommendationRequest& request) const;

  /**
   * A Callable wrapper for GetRightsizingRecommendation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRightsizingRecommendationRequestT = Model::GetRightsizingRecommendationRequest>
  Model::GetRightsizingRecommendationOutcomeCallable GetRightsizingRecommendationCallable(
      const GetRightsizingRecommendationRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetRightsizingRecommendation, request);
  }

  /**
   * An Async wrapper for GetRightsizingRecommendation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRightsizingRecommendationRequestT = Model::GetRightsizingRecommendationRequest>
  void GetRightsizingRecommendationAsync(const GetRightsizingRecommendationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSavingsPlanPurchaseRecommendationDetailsOutcome GetSavingsPlanPurchaseRecommendationDetails(
      const Model::GetSavingsPlanPurchaseRecommendationDetailsRequest& request) const;

  /**
   * A Callable wrapper for GetSavingsPlanPurchaseRecommendationDetails that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::GetSavingsPlanPurchaseRecommendationDetailsOutcomeCallable GetSavingsPlanPurchaseRecommendationDetailsCallable(
      const GetSavingsPlanPurchaseRecommendationDetailsRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetSavingsPlanPurchaseRecommendationDetails, request);
  }

  /**
   * An Async wrapper for GetSavingsPlanPurchaseRecommendationDetails that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetSavingsPlanPurchaseRecommendationDetailsRequestT = Model::GetSavingsPlanPurchaseRecommendationDetailsRequest>
  void GetSavingsPlanPurchaseRecommendationDetailsAsync(
      const GetSavingsPlanPurchaseRecommendationDetailsRequestT& request,
      const GetSavingsPlanPurchaseRecommendationDetailsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSavingsPlansCoverage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSavingsPlansCoverage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSavingsPlansCoverageRequestT = Model::GetSavingsPlansCoverageRequest>
  void GetSavingsPlansCoverageAsync(const GetSavingsPlansCoverageRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSavingsPlansPurchaseRecommendationOutcome GetSavingsPlansPurchaseRecommendation(
      const Model::GetSavingsPlansPurchaseRecommendationRequest& request) const;

  /**
   * A Callable wrapper for GetSavingsPlansPurchaseRecommendation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetSavingsPlansPurchaseRecommendationRequestT = Model::GetSavingsPlansPurchaseRecommendationRequest>
  Model::GetSavingsPlansPurchaseRecommendationOutcomeCallable GetSavingsPlansPurchaseRecommendationCallable(
      const GetSavingsPlansPurchaseRecommendationRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetSavingsPlansPurchaseRecommendation, request);
  }

  /**
   * An Async wrapper for GetSavingsPlansPurchaseRecommendation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetSavingsPlansPurchaseRecommendationRequestT = Model::GetSavingsPlansPurchaseRecommendationRequest>
  void GetSavingsPlansPurchaseRecommendationAsync(const GetSavingsPlansPurchaseRecommendationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSavingsPlansUtilizationOutcome GetSavingsPlansUtilization(
      const Model::GetSavingsPlansUtilizationRequest& request) const;

  /**
   * A Callable wrapper for GetSavingsPlansUtilization that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSavingsPlansUtilizationRequestT = Model::GetSavingsPlansUtilizationRequest>
  Model::GetSavingsPlansUtilizationOutcomeCallable GetSavingsPlansUtilizationCallable(
      const GetSavingsPlansUtilizationRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetSavingsPlansUtilization, request);
  }

  /**
   * An Async wrapper for GetSavingsPlansUtilization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSavingsPlansUtilizationRequestT = Model::GetSavingsPlansUtilizationRequest>
  void GetSavingsPlansUtilizationAsync(const GetSavingsPlansUtilizationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSavingsPlansUtilizationDetailsOutcome GetSavingsPlansUtilizationDetails(
      const Model::GetSavingsPlansUtilizationDetailsRequest& request) const;

  /**
   * A Callable wrapper for GetSavingsPlansUtilizationDetails that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetSavingsPlansUtilizationDetailsRequestT = Model::GetSavingsPlansUtilizationDetailsRequest>
  Model::GetSavingsPlansUtilizationDetailsOutcomeCallable GetSavingsPlansUtilizationDetailsCallable(
      const GetSavingsPlansUtilizationDetailsRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::GetSavingsPlansUtilizationDetails, request);
  }

  /**
   * An Async wrapper for GetSavingsPlansUtilizationDetails that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetSavingsPlansUtilizationDetailsRequestT = Model::GetSavingsPlansUtilizationDetailsRequest>
  void GetSavingsPlansUtilizationDetailsAsync(const GetSavingsPlansUtilizationDetailsRequestT& request,
  ...
  /**
   * A Callable wrapper for GetUsageForecast that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetUsageForecast that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetUsageForecastRequestT = Model::GetUsageForecastRequest>
  void GetUsageForecastAsync(const GetUsageForecastRequestT& request, const GetUsageForecastResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCommitmentPurchaseAnalysesOutcome ListCommitmentPurchaseAnalyses(
      const Model::ListCommitmentPurchaseAnalysesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCommitmentPurchaseAnalyses that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCommitmentPurchaseAnalysesRequestT = Model::ListCommitmentPurchaseAnalysesRequest>
  Model::ListCommitmentPurchaseAnalysesOutcomeCallable ListCommitmentPurchaseAnalysesCallable(
      const ListCommitmentPurchaseAnalysesRequestT& request = {}) const {
    return SubmitCallable(&CostExplorerClient::ListCommitmentPurchaseAnalyses, request);
  }

  /**
   * An Async wrapper for ListCommitmentPurchaseAnalyses that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCommitmentPurchaseAnalysesRequestT = Model::ListCommitmentPurchaseAnalysesRequest>
  void ListCommitmentPurchaseAnalysesAsync(const ListCommitmentPurchaseAnalysesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListCommitmentPurchaseAnalysesRequestT& request = {}) const {
  ...
  virtual Model::ListCostAllocationTagBackfillHistoryOutcome ListCostAllocationTagBackfillHistory(
      const Model::ListCostAllocationTagBackfillHistoryRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCostAllocationTagBackfillHistory that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListCostAllocationTagBackfillHistoryRequestT = Model::ListCostAllocationTagBackfillHistoryRequest>
  Model::ListCostAllocationTagBackfillHistoryOutcomeCallable ListCostAllocationTagBackfillHistoryCallable(
      const ListCostAllocationTagBackfillHistoryRequestT& request = {}) const {
    return SubmitCallable(&CostExplorerClient::ListCostAllocationTagBackfillHistory, request);
  }

  /**
   * An Async wrapper for ListCostAllocationTagBackfillHistory that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListCostAllocationTagBackfillHistoryRequestT = Model::ListCostAllocationTagBackfillHistoryRequest>
  void ListCostAllocationTagBackfillHistoryAsync(const ListCostAllocationTagBackfillHistoryResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const ListCostAllocationTagBackfillHistoryRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCostAllocationTags that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCostAllocationTags that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCostAllocationTagsRequestT = Model::ListCostAllocationTagsRequest>
  void ListCostAllocationTagsAsync(const ListCostAllocationTagsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListCostAllocationTagsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCostCategoryDefinitionsOutcome ListCostCategoryDefinitions(
      const Model::ListCostCategoryDefinitionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCostCategoryDefinitions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCostCategoryDefinitionsRequestT = Model::ListCostCategoryDefinitionsRequest>
  Model::ListCostCategoryDefinitionsOutcomeCallable ListCostCategoryDefinitionsCallable(
  ...
  /**
   * An Async wrapper for ListCostCategoryDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCostCategoryDefinitionsRequestT = Model::ListCostCategoryDefinitionsRequest>
  void ListCostCategoryDefinitionsAsync(const ListCostCategoryDefinitionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListCostCategoryDefinitionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSavingsPlansPurchaseRecommendationGenerationOutcome ListSavingsPlansPurchaseRecommendationGeneration(
      const Model::ListSavingsPlansPurchaseRecommendationGenerationRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSavingsPlansPurchaseRecommendationGeneration that returns a future to the operation so that it can be
  ...
  Model::ListSavingsPlansPurchaseRecommendationGenerationOutcomeCallable ListSavingsPlansPurchaseRecommendationGenerationCallable(
      const ListSavingsPlansPurchaseRecommendationGenerationRequestT& request = {}) const {
    return SubmitCallable(&CostExplorerClient::ListSavingsPlansPurchaseRecommendationGeneration, request);
  }

  /**
   * An Async wrapper for ListSavingsPlansPurchaseRecommendationGeneration that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <
      typename ListSavingsPlansPurchaseRecommendationGenerationRequestT = Model::ListSavingsPlansPurchaseRecommendationGenerationRequest>
  void ListSavingsPlansPurchaseRecommendationGenerationAsync(
      const ListSavingsPlansPurchaseRecommendationGenerationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
      const ListSavingsPlansPurchaseRecommendationGenerationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ProvideAnomalyFeedback that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ProvideAnomalyFeedback that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ProvideAnomalyFeedbackRequestT = Model::ProvideAnomalyFeedbackRequest>
  void ProvideAnomalyFeedbackAsync(const ProvideAnomalyFeedbackRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StartCommitmentPurchaseAnalysisOutcome StartCommitmentPurchaseAnalysis(
      const Model::StartCommitmentPurchaseAnalysisRequest& request) const;

  /**
   * A Callable wrapper for StartCommitmentPurchaseAnalysis that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartCommitmentPurchaseAnalysisRequestT = Model::StartCommitmentPurchaseAnalysisRequest>
  Model::StartCommitmentPurchaseAnalysisOutcomeCallable StartCommitmentPurchaseAnalysisCallable(
      const StartCommitmentPurchaseAnalysisRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::StartCommitmentPurchaseAnalysis, request);
  }

  /**
   * An Async wrapper for StartCommitmentPurchaseAnalysis that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartCommitmentPurchaseAnalysisRequestT = Model::StartCommitmentPurchaseAnalysisRequest>
  void StartCommitmentPurchaseAnalysisAsync(const StartCommitmentPurchaseAnalysisRequestT& request,
                                            const StartCommitmentPurchaseAnalysisResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartCostAllocationTagBackfillOutcome StartCostAllocationTagBackfill(
      const Model::StartCostAllocationTagBackfillRequest& request) const;

  /**
   * A Callable wrapper for StartCostAllocationTagBackfill that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartCostAllocationTagBackfillRequestT = Model::StartCostAllocationTagBackfillRequest>
  Model::StartCostAllocationTagBackfillOutcomeCallable StartCostAllocationTagBackfillCallable(
      const StartCostAllocationTagBackfillRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::StartCostAllocationTagBackfill, request);
  }

  /**
   * An Async wrapper for StartCostAllocationTagBackfill that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartCostAllocationTagBackfillRequestT = Model::StartCostAllocationTagBackfillRequest>
  void StartCostAllocationTagBackfillAsync(const StartCostAllocationTagBackfillRequestT& request,
                                           const StartCostAllocationTagBackfillResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartSavingsPlansPurchaseRecommendationGenerationOutcome StartSavingsPlansPurchaseRecommendationGeneration(
      const Model::StartSavingsPlansPurchaseRecommendationGenerationRequest& request = {}) const;

  /**
   * A Callable wrapper for StartSavingsPlansPurchaseRecommendationGeneration that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <
  ...
  Model::StartSavingsPlansPurchaseRecommendationGenerationOutcomeCallable StartSavingsPlansPurchaseRecommendationGenerationCallable(
      const StartSavingsPlansPurchaseRecommendationGenerationRequestT& request = {}) const {
    return SubmitCallable(&CostExplorerClient::StartSavingsPlansPurchaseRecommendationGeneration, request);
  }

  /**
   * An Async wrapper for StartSavingsPlansPurchaseRecommendationGeneration that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <
      typename StartSavingsPlansPurchaseRecommendationGenerationRequestT = Model::StartSavingsPlansPurchaseRecommendationGenerationRequest>
  void StartSavingsPlansPurchaseRecommendationGenerationAsync(
      const StartSavingsPlansPurchaseRecommendationGenerationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
      const StartSavingsPlansPurchaseRecommendationGenerationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateAnomalyMonitor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAnomalyMonitor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAnomalyMonitorRequestT = Model::UpdateAnomalyMonitorRequest>
  void UpdateAnomalyMonitorAsync(const UpdateAnomalyMonitorRequestT& request, const UpdateAnomalyMonitorResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAnomalySubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateAnomalySubscriptionRequestT = Model::UpdateAnomalySubscriptionRequest>
  Model::UpdateAnomalySubscriptionOutcomeCallable UpdateAnomalySubscriptionCallable(
      const UpdateAnomalySubscriptionRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::UpdateAnomalySubscription, request);
  }

  /**
   * An Async wrapper for UpdateAnomalySubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAnomalySubscriptionRequestT = Model::UpdateAnomalySubscriptionRequest>
  void UpdateAnomalySubscriptionAsync(const UpdateAnomalySubscriptionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCostAllocationTagsStatusOutcome UpdateCostAllocationTagsStatus(
      const Model::UpdateCostAllocationTagsStatusRequest& request) const;

  /**
   * A Callable wrapper for UpdateCostAllocationTagsStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCostAllocationTagsStatusRequestT = Model::UpdateCostAllocationTagsStatusRequest>
  Model::UpdateCostAllocationTagsStatusOutcomeCallable UpdateCostAllocationTagsStatusCallable(
      const UpdateCostAllocationTagsStatusRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::UpdateCostAllocationTagsStatus, request);
  }

  /**
   * An Async wrapper for UpdateCostAllocationTagsStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateCostAllocationTagsStatusRequestT = Model::UpdateCostAllocationTagsStatusRequest>
  void UpdateCostAllocationTagsStatusAsync(const UpdateCostAllocationTagsStatusRequestT& request,
                                           const UpdateCostAllocationTagsStatusResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCostCategoryDefinitionOutcome UpdateCostCategoryDefinition(
      const Model::UpdateCostCategoryDefinitionRequest& request) const;

  /**
   * A Callable wrapper for UpdateCostCategoryDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCostCategoryDefinitionRequestT = Model::UpdateCostCategoryDefinitionRequest>
  Model::UpdateCostCategoryDefinitionOutcomeCallable UpdateCostCategoryDefinitionCallable(
      const UpdateCostCategoryDefinitionRequestT& request) const {
    return SubmitCallable(&CostExplorerClient::UpdateCostCategoryDefinition, request);
  }

  /**
   * An Async wrapper for UpdateCostCategoryDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCostCategoryDefinitionRequestT = Model::UpdateCostCategoryDefinitionRequest>
  void UpdateCostCategoryDefinitionAsync(const UpdateCostCategoryDefinitionRequestT& request,
