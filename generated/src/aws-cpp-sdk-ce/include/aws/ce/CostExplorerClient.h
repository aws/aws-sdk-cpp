...
namespace CostExplorer
{
   ...
   */
  class AWS_COSTEXPLORER_API CostExplorerClient : Aws::Client::ClientWithAsyncTemplateMethods<CostExplorerClient>,
    smithy::client::AwsSmithyClientT<Aws::CostExplorer::SERVICE_NAME,
