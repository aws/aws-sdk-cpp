...
ClipFragmentSelector::ClipFragmentSelector(JsonView jsonValue) { *this = jsonValue; }
...
ClipFragmentSelector& ClipFragmentSelector::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("FragmentSelectorType")) {
    m_fragmentSelectorType =
        ClipFragmentSelectorTypeMapper::GetClipFragmentSelectorTypeForName(jsonValue.GetString("FragmentSelectorType"));
