...
DASHFragmentSelector::DASHFragmentSelector(JsonView jsonValue) { *this = jsonValue; }

DASHFragmentSelector& DASHFragmentSelector::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("FragmentSelectorType")) {
    m_fragmentSelectorType =
        DASHFragmentSelectorTypeMapper::GetDASHFragmentSelectorTypeForName(jsonValue.GetString("FragmentSelectorType"));
