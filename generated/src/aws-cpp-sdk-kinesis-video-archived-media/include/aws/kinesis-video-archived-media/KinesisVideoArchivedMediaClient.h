...
namespace KinesisVideoArchivedMedia
{
   ...
   * <p/>
   */
  class AWS_KINESISVIDEOARCHIVEDMEDIA_API KinesisVideoArchivedMediaClient : Aws::Client::ClientWithAsyncTemplateMethods<KinesisVideoArchivedMediaClient>,
    smithy::client::AwsSmithyClientT<Aws::KinesisVideoArchivedMedia::SERVICE_NAME,
