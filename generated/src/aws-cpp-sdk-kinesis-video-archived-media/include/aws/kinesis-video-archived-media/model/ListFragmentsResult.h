...
namespace Model
{
  ...
  public:
    ...
    inline ListFragmentsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListFragmentsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListFragmentsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
