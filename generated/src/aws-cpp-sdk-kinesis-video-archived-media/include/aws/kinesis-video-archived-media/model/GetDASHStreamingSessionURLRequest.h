...
class GetDASHStreamingSessionURLRequest : public KinesisVideoArchivedMediaRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  GetDASHStreamingSessionURLRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename StreamARNT = Aws::String>
  GetDASHStreamingSessionURLRequest& WithStreamARN(StreamARNT&& value) {
  ...
  inline void SetPlaybackMode(DASHPlaybackMode value) {
    m_playbackModeHasBeenSet = true;
    m_playbackMode = value;
  }
  inline GetDASHStreamingSessionURLRequest& WithPlaybackMode(DASHPlaybackMode value) {
  ...
  inline void SetDisplayFragmentTimestamp(DASHDisplayFragmentTimestamp value) {
    m_displayFragmentTimestampHasBeenSet = true;
    m_displayFragmentTimestamp = value;
  }
  inline GetDASHStreamingSessionURLRequest& WithDisplayFragmentTimestamp(DASHDisplayFragmentTimestamp value) {
  ...
  inline void SetDisplayFragmentNumber(DASHDisplayFragmentNumber value) {
    m_displayFragmentNumberHasBeenSet = true;
    m_displayFragmentNumber = value;
  }
  inline GetDASHStreamingSessionURLRequest& WithDisplayFragmentNumber(DASHDisplayFragmentNumber value) {
    SetDisplayFragmentNumber(value);
    return *this;
  }
  ///@}
  ...
  void SetDASHFragmentSelector(DASHFragmentSelectorT&& value) {
    m_dASHFragmentSelectorHasBeenSet = true;
    m_dASHFragmentSelector = std::forward<DASHFragmentSelectorT>(value);
  }
  template <typename DASHFragmentSelectorT = DASHFragmentSelector>
  GetDASHStreamingSessionURLRequest& WithDASHFragmentSelector(DASHFragmentSelectorT&& value) {
    SetDASHFragmentSelector(std::forward<DASHFragmentSelectorT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetDASHStreamingSessionURLRequest& WithExpires(int value) {
    SetExpires(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxManifestFragmentResults(long long value) {
    m_maxManifestFragmentResultsHasBeenSet = true;
    m_maxManifestFragmentResults = value;
  }
  inline GetDASHStreamingSessionURLRequest& WithMaxManifestFragmentResults(long long value) {
    SetMaxManifestFragmentResults(value);
    return *this;
  }
  ///@}
 private:
