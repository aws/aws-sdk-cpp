...
class GetMediaForFragmentListRequest : public KinesisVideoArchivedMediaRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  GetMediaForFragmentListRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename StreamARNT = Aws::String>
  GetMediaForFragmentListRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename FragmentsT = Aws::Vector<Aws::String>>
  GetMediaForFragmentListRequest& WithFragments(FragmentsT&& value) {
    SetFragments(std::forward<FragmentsT>(value));
    return *this;
  }
  template <typename FragmentsT = Aws::String>
  GetMediaForFragmentListRequest& AddFragments(FragmentsT&& value) {
    m_fragmentsHasBeenSet = true;
