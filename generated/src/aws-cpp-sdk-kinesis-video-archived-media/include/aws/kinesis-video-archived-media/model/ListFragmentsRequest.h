...
class ListFragmentsRequest : public KinesisVideoArchivedMediaRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  ListFragmentsRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename StreamARNT = Aws::String>
  ListFragmentsRequest& WithStreamARN(StreamARNT&& value) {
  ...
  inline ListFragmentsRequest& WithMaxResults(long long value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFragmentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FragmentSelectorT = FragmentSelector>
  ListFragmentsRequest& WithFragmentSelector(FragmentSelectorT&& value) {
