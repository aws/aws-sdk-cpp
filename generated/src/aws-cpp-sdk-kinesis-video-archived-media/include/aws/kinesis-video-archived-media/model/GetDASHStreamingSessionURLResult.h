...
class GetDASHStreamingSessionURLResult {
 public:
  ...
  AWS_KINESISVIDEOARCHIVEDMEDIA_API GetDASHStreamingSessionURLResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetDASHStreamingSessionURL(DASHStreamingSessionURLT&& value) {
    m_dASHStreamingSessionURLHasBeenSet = true;
    m_dASHStreamingSessionURL = std::forward<DASHStreamingSessionURLT>(value);
  }
  template <typename DASHStreamingSessionURLT = Aws::String>
  GetDASHStreamingSessionURLResult& WithDASHStreamingSessionURL(DASHStreamingSessionURLT&& value) {
    SetDASHStreamingSessionURL(std::forward<DASHStreamingSessionURLT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetDASHStreamingSessionURLResult& WithRequestId(RequestIdT&& value) {
