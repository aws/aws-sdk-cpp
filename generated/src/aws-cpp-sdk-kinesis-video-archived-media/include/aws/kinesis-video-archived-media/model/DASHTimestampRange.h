...
namespace Model
{
  ...
  public:
    ...
    template<typename StartTimestampT = Aws::Utils::DateTime>
    DASHTimestampRange& WithStartTimestamp(StartTimestampT&& value) { SetStartTimestamp(std::forward<StartTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename EndTimestampT = Aws::Utils::DateTime>
    DASHTimestampRange& WithEndTimestamp(EndTimestampT&& value) { SetEndTimestamp(std::forward<EndTimestampT>(value)); return *this;}
    ///@}
  private:
