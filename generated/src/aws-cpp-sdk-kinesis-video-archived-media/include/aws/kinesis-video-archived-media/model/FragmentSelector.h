...
class FragmentSelector {
 public:
  ...
  inline void SetFragmentSelectorType(FragmentSelectorType value) {
    m_fragmentSelectorTypeHasBeenSet = true;
    m_fragmentSelectorType = value;
  }
  inline FragmentSelector& WithFragmentSelectorType(FragmentSelectorType value) {
  ...
  template <typename TimestampRangeT = TimestampRange>
  FragmentSelector& WithTimestampRange(TimestampRangeT&& value) {
