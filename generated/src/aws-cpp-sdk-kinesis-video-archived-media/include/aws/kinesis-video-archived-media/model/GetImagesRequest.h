...
class GetImagesRequest : public KinesisVideoArchivedMediaRequest {
 public:
  ...
  inline GetImagesRequest& WithImageSelectorType(ImageSelectorType value) {
  ...
  inline GetImagesRequest& WithSamplingInterval(int value) {
  ...
  inline GetImagesRequest& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline GetImagesRequest& WithWidthPixels(int value) {
  ...
  inline GetImagesRequest& WithHeightPixels(int value) {
  ...
  inline void SetMaxResults(long long value) {
    m_maxResultsHasBeenSet = true;
    m_maxResults = value;
  }
  inline GetImagesRequest& WithMaxResults(long long value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
