...
class Fragment {
 public:
  ...
  inline void SetFragmentSizeInBytes(long long value) {
    m_fragmentSizeInBytesHasBeenSet = true;
    m_fragmentSizeInBytes = value;
  }
  inline Fragment& WithFragmentSizeInBytes(long long value) {
    SetFragmentSizeInBytes(value);
    return *this;
  }
  ///@}
  ...
  void SetProducerTimestamp(ProducerTimestampT&& value) {
    ...
    m_producerTimestamp = std::forward<ProducerTimestampT>(value);
  }
  template <typename ProducerTimestampT = Aws::Utils::DateTime>
  Fragment& WithProducerTimestamp(ProducerTimestampT&& value) {
    SetProducerTimestamp(std::forward<ProducerTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServerTimestamp(ServerTimestampT&& value) {
    ...
    m_serverTimestamp = std::forward<ServerTimestampT>(value);
  }
  template <typename ServerTimestampT = Aws::Utils::DateTime>
  Fragment& WithServerTimestamp(ServerTimestampT&& value) {
    SetServerTimestamp(std::forward<ServerTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFragmentLengthInMilliseconds(long long value) {
    m_fragmentLengthInMillisecondsHasBeenSet = true;
    m_fragmentLengthInMilliseconds = value;
  }
  inline Fragment& WithFragmentLengthInMilliseconds(long long value) {
    SetFragmentLengthInMilliseconds(value);
    return *this;
  }
  ///@}
 private:
