...
namespace MarketplaceCatalog
{
   ...
   */
  class AWS_MARKETPLACECATALOG_API MarketplaceCatalogClient : Aws::Client::ClientWithAsyncTemplateMethods<MarketplaceCatalogClient>,
    smithy::client::AwsSmithyClientT<Aws::MarketplaceCatalog::SERVICE_NAME,
