...
class SaaSProductSort {
 public:
  ...
  inline void SetSortBy(SaaSProductSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline SaaSProductSort& WithSortBy(SaaSProductSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline SaaSProductSort& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
