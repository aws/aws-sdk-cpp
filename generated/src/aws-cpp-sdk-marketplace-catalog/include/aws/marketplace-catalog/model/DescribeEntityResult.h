...
class DescribeEntityResult {
 public:
  ...
  template <typename EntityTypeT = Aws::String>
  DescribeEntityResult& WithEntityType(EntityTypeT&& value) {
  ...
  template <typename EntityIdentifierT = Aws::String>
  DescribeEntityResult& WithEntityIdentifier(EntityIdentifierT&& value) {
  ...
  template <typename EntityArnT = Aws::String>
  DescribeEntityResult& WithEntityArn(EntityArnT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::String>
  DescribeEntityResult& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename DetailsT = Aws::String>
  DescribeEntityResult& WithDetails(DetailsT&& value) {
  ...
  void SetDetailsDocument(DetailsDocumentT&& value) {
    m_detailsDocumentHasBeenSet = true;
    m_detailsDocument = std::forward<DetailsDocumentT>(value);
  }
  template <typename DetailsDocumentT = Aws::Utils::Document>
  DescribeEntityResult& WithDetailsDocument(DetailsDocumentT&& value) {
    SetDetailsDocument(std::forward<DetailsDocumentT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEntityResult& WithRequestId(RequestIdT&& value) {
