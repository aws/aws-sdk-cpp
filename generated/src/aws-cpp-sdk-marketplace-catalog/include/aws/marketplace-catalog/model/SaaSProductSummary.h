...
class SaaSProductSummary {
 public:
  ...
  template <typename ProductTitleT = Aws::String>
  SaaSProductSummary& WithProductTitle(ProductTitleT&& value) {
  ...
  inline void SetVisibility(SaaSProductVisibilityString value) {
    m_visibilityHasBeenSet = true;
    m_visibility = value;
  }
  inline SaaSProductSummary& WithVisibility(SaaSProductVisibilityString value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
