...
class ListEntitiesResult {
 public:
  ...
  void SetEntitySummaryList(EntitySummaryListT&& value) {
    m_entitySummaryListHasBeenSet = true;
    m_entitySummaryList = std::forward<EntitySummaryListT>(value);
  }
  template <typename EntitySummaryListT = Aws::Vector<EntitySummary>>
  ListEntitiesResult& WithEntitySummaryList(EntitySummaryListT&& value) {
    SetEntitySummaryList(std::forward<EntitySummaryListT>(value));
    return *this;
  }
  template <typename EntitySummaryListT = EntitySummary>
  ListEntitiesResult& AddEntitySummaryList(EntitySummaryListT&& value) {
    m_entitySummaryListHasBeenSet = true;
    m_entitySummaryList.emplace_back(std::forward<EntitySummaryListT>(value));
    return *this;
  }
  ///@}
