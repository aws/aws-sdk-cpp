 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/OfferSetReleaseDateFilterDateRange">AWS
 * API Reference</a></p>
 */
class OfferSetReleaseDateFilterDateRange {
 public:
  AWS_MARKETPLACECATALOG_API OfferSetReleaseDateFilterDateRange() = default;
  AWS_MARKETPLACECATALOG_API OfferSetReleaseDateFilterDateRange(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACECATALOG_API OfferSetReleaseDateFilterDateRange& operator=(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACECATALOG_API Aws::Utils::Json::JsonValue Jsonize() const;

  ///@{
  /**
   * <p>Allows filtering on the <code>ReleaseDate</code> of offer set after a
   * date.</p>
   */
  ...
  template <typename AfterValueT = Aws::String>
  OfferSetReleaseDateFilterDateRange& WithAfterValue(AfterValueT&& value) {
  ...
  ///@{
  /**
   * <p>Allows filtering on the <code>ReleaseDate</code> of offer set before a
   * date.</p>
   */
  ...
  template <typename BeforeValueT = Aws::String>
  OfferSetReleaseDateFilterDateRange& WithBeforeValue(BeforeValueT&& value) {
