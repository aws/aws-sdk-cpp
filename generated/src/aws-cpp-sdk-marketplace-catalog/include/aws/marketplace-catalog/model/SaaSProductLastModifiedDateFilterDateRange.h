...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/SaaSProductLastModifiedDateFilterDateRange">AWS
   * API Reference</a></p>
   */
  class SaaSProductLastModifiedDateFilterDateRange
  {
  public:
    AWS_MARKETPLACECATALOG_API SaaSProductLastModifiedDateFilterDateRange();
    AWS_MARKETPLACECATALOG_API SaaSProductLastModifiedDateFilterDateRange(Aws::Utils::Json::JsonView jsonValue);
    AWS_MARKETPLACECATALOG_API SaaSProductLastModifiedDateFilterDateRange& operator=(Aws::Utils::Json::JsonView jsonValue);
     ...
     * <p>Date after which the SaaS product was last modified.</p>
     */
    inline SaaSProductLastModifiedDateFilterDateRange& WithAfterValue(const Aws::String& value) { SetAfterValue(value); return *this;}

    /**
     * <p>Date after which the SaaS product was last modified.</p>
     */
    inline SaaSProductLastModifiedDateFilterDateRange& WithAfterValue(Aws::String&& value) { SetAfterValue(std::move(value)); return *this;}

    /**
     * <p>Date after which the SaaS product was last modified.</p>
     */
    inline SaaSProductLastModifiedDateFilterDateRange& WithAfterValue(const char* value) { SetAfterValue(value); return *this;}
     ...
     * <p>Date before which the SaaS product was last modified.</p>
     */
    inline SaaSProductLastModifiedDateFilterDateRange& WithBeforeValue(const Aws::String& value) { SetBeforeValue(value); return *this;}

    /**
     * <p>Date before which the SaaS product was last modified.</p>
     */
    inline SaaSProductLastModifiedDateFilterDateRange& WithBeforeValue(Aws::String&& value) { SetBeforeValue(std::move(value)); return *this;}

    /**
     * <p>Date before which the SaaS product was last modified.</p>
     */
    inline SaaSProductLastModifiedDateFilterDateRange& WithBeforeValue(const char* value) { SetBeforeValue(value); return *this;}
