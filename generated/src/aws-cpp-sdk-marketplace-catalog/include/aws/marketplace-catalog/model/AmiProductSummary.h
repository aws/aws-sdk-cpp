...
class AmiProductSummary {
 public:
  ...
  template <typename ProductTitleT = Aws::String>
  AmiProductSummary& WithProductTitle(ProductTitleT&& value) {
  ...
  inline void SetVisibility(AmiProductVisibilityString value) {
    m_visibilityHasBeenSet = true;
    m_visibility = value;
  }
  inline AmiProductSummary& WithVisibility(AmiProductVisibilityString value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
