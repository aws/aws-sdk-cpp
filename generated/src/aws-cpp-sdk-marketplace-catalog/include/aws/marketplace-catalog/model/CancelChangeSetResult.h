...
class CancelChangeSetResult {
 public:
  ...
  template <typename ChangeSetIdT = Aws::String>
  CancelChangeSetResult& WithChangeSetId(ChangeSetIdT&& value) {
  ...
  template <typename ChangeSetArnT = Aws::String>
  CancelChangeSetResult& WithChangeSetArn(ChangeSetArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CancelChangeSetResult& WithRequestId(RequestIdT&& value) {
