...
class AmiProductSort {
 public:
  ...
  inline void SetSortBy(AmiProductSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline AmiProductSort& WithSortBy(AmiProductSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline AmiProductSort& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
