...
class ContainerProductSort {
 public:
  ...
  inline void SetSortBy(ContainerProductSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ContainerProductSort& WithSortBy(ContainerProductSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerProductSort& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
