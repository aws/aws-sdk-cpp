...
class ListEntitiesRequest : public MarketplaceCatalogRequest {
 public:
  ...
  template <typename CatalogT = Aws::String>
  ListEntitiesRequest& WithCatalog(CatalogT&& value) {
  ...
  template <typename EntityTypeT = Aws::String>
  ListEntitiesRequest& WithEntityType(EntityTypeT&& value) {
  ...
  template <typename FilterListT = Aws::Vector<Filter>>
  ListEntitiesRequest& WithFilterList(FilterListT&& value) {
    SetFilterList(std::forward<FilterListT>(value));
    return *this;
  }
  template <typename FilterListT = Filter>
  ListEntitiesRequest& AddFilterList(FilterListT&& value) {
    m_filterListHasBeenSet = true;
  ...
  template <typename SortT = Sort>
  ListEntitiesRequest& WithSort(SortT&& value) {
  ...
  inline ListEntitiesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOwnershipType(OwnershipType value) {
    m_ownershipTypeHasBeenSet = true;
    m_ownershipType = value;
  }
  inline ListEntitiesRequest& WithOwnershipType(OwnershipType value) {
  ...
  template <typename EntityTypeFiltersT = EntityTypeFilters>
  ListEntitiesRequest& WithEntityTypeFilters(EntityTypeFiltersT&& value) {
  ...
  void SetEntityTypeSort(EntityTypeSortT&& value) {
    m_entityTypeSortHasBeenSet = true;
    m_entityTypeSort = std::forward<EntityTypeSortT>(value);
  }
  template <typename EntityTypeSortT = EntityTypeSort>
  ListEntitiesRequest& WithEntityTypeSort(EntityTypeSortT&& value) {
    SetEntityTypeSort(std::forward<EntityTypeSortT>(value));
    return *this;
  }
  ///@}
 private:
