...
class Change {
 public:
  ...
  template <typename ChangeTypeT = Aws::String>
  Change& WithChangeType(ChangeTypeT&& value) {
  ...
  template <typename EntityT = Entity>
  Change& WithEntity(EntityT&& value) {
  ...
  void SetEntityTags(EntityTagsT&& value) {
    m_entityTagsHasBeenSet = true;
    m_entityTags = std::forward<EntityTagsT>(value);
  }
  template <typename EntityTagsT = Aws::Vector<Tag>>
  Change& WithEntityTags(EntityTagsT&& value) {
    SetEntityTags(std::forward<EntityTagsT>(value));
    return *this;
  }
  template <typename EntityTagsT = Tag>
  Change& AddEntityTags(EntityTagsT&& value) {
    m_entityTagsHasBeenSet = true;
    m_entityTags.emplace_back(std::forward<EntityTagsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DetailsT = Aws::String>
  Change& WithDetails(DetailsT&& value) {
  ...
  template <typename DetailsDocumentT = Aws::Utils::Document>
  Change& WithDetailsDocument(DetailsDocumentT&& value) {
  ...
  void SetChangeName(ChangeNameT&& value) {
    m_changeNameHasBeenSet = true;
    m_changeName = std::forward<ChangeNameT>(value);
  }
  template <typename ChangeNameT = Aws::String>
  Change& WithChangeName(ChangeNameT&& value) {
    SetChangeName(std::forward<ChangeNameT>(value));
    return *this;
  }
  ///@}
 private:
