...
class DescribeChangeSetResult {
 public:
  ...
  void SetChangeSetArn(ChangeSetArnT&& value) {
    ...
    m_changeSetArn = std::forward<ChangeSetArnT>(value);
  }
  template <typename ChangeSetArnT = Aws::String>
  DescribeChangeSetResult& WithChangeSetArn(ChangeSetArnT&& value) {
    SetChangeSetArn(std::forward<ChangeSetArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeChangeSetResult& WithIntent(Intent value) {
    SetIntent(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartTimeT = Aws::String>
  DescribeChangeSetResult& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::String>
  DescribeChangeSetResult& WithEndTime(EndTimeT&& value) {
  ...
  inline void SetStatus(ChangeStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeChangeSetResult& WithStatus(ChangeStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailureCode(FailureCode value) {
    m_failureCodeHasBeenSet = true;
    m_failureCode = value;
  }
  inline DescribeChangeSetResult& WithFailureCode(FailureCode value) {
  ...
  void SetFailureDescription(FailureDescriptionT&& value) {
    ...
    m_failureDescription = std::forward<FailureDescriptionT>(value);
  }
  template <typename FailureDescriptionT = Aws::String>
  DescribeChangeSetResult& WithFailureDescription(FailureDescriptionT&& value) {
    SetFailureDescription(std::forward<FailureDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetChangeSet(ChangeSetT&& value) {
    m_changeSetHasBeenSet = true;
    m_changeSet = std::forward<ChangeSetT>(value);
  }
  template <typename ChangeSetT = Aws::Vector<ChangeSummary>>
  DescribeChangeSetResult& WithChangeSet(ChangeSetT&& value) {
    SetChangeSet(std::forward<ChangeSetT>(value));
    return *this;
  }
  template <typename ChangeSetT = ChangeSummary>
  DescribeChangeSetResult& AddChangeSet(ChangeSetT&& value) {
    m_changeSetHasBeenSet = true;
    m_changeSet.emplace_back(std::forward<ChangeSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeChangeSetResult& WithRequestId(RequestIdT&& value) {
