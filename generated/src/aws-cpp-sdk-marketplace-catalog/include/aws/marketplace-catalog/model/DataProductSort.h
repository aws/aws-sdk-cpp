...
class DataProductSort {
 public:
  ...
  inline void SetSortBy(DataProductSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline DataProductSort& WithSortBy(DataProductSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline DataProductSort& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
