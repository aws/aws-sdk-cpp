...
/**
 * <p>The details of the resource assessed under the AMI Security
 * framework.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/AMISecuritySummary">AWS
 * API Reference</a></p>
 */
class AMISecuritySummary {
 public:
  AWS_MARKETPLACECATALOG_API AMISecuritySummary() = default;
  AWS_MARKETPLACECATALOG_API AMISecuritySummary(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACECATALOG_API AMISecuritySummary& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename DeliveryOptionIdT = Aws::String>
  AMISecuritySummary& WithDeliveryOptionId(DeliveryOptionIdT&& value) {
