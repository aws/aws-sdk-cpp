...
/**
 * <p>Allows filtering on the <code>OfferSetId</code> of an offer.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/OfferSetIdFilter">AWS
 * API Reference</a></p>
 */
class OfferSetIdFilter {
 public:
  AWS_MARKETPLACECATALOG_API OfferSetIdFilter() = default;
  AWS_MARKETPLACECATALOG_API OfferSetIdFilter(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACECATALOG_API OfferSetIdFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ValueListT = Aws::Vector<Aws::String>>
  OfferSetIdFilter& WithValueList(ValueListT&& value) {
    SetValueList(std::forward<ValueListT>(value));
    return *this;
  }
  template <typename ValueListT = Aws::String>
  OfferSetIdFilter& AddValueList(ValueListT&& value) {
    m_valueListHasBeenSet = true;
