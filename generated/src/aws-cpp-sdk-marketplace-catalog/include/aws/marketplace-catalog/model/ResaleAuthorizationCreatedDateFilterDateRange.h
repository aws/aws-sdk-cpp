...
class ResaleAuthorizationCreatedDateFilterDateRange {
 public:
  ...
  template <typename AfterValueT = Aws::String>
  ResaleAuthorizationCreatedDateFilterDateRange& WithAfterValue(AfterValueT&& value) {
  ...
  template <typename BeforeValueT = Aws::String>
  ResaleAuthorizationCreatedDateFilterDateRange& WithBeforeValue(BeforeValueT&& value) {
