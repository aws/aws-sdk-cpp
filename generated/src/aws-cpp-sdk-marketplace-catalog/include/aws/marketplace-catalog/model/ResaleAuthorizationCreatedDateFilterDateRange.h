...
namespace Model
{
  ...
  {
  public:
    AWS_MARKETPLACECATALOG_API ResaleAuthorizationCreatedDateFilterDateRange() = default;
    ...
    template<typename AfterValueT = Aws::String>
    ResaleAuthorizationCreatedDateFilterDateRange& WithAfterValue(AfterValueT&& value) { SetAfterValue(std::forward<AfterValueT>(value)); return *this;}
    ///@}
    ...
    template<typename BeforeValueT = Aws::String>
    ResaleAuthorizationCreatedDateFilterDateRange& WithBeforeValue(BeforeValueT&& value) { SetBeforeValue(std::forward<BeforeValueT>(value)); return *this;}
    ///@}
  private:
