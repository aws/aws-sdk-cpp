...
class ResaleAuthorizationAvailabilityEndDateFilterDateRange {
 public:
  ...
  template <typename AfterValueT = Aws::String>
  ResaleAuthorizationAvailabilityEndDateFilterDateRange& WithAfterValue(AfterValueT&& value) {
  ...
  template <typename BeforeValueT = Aws::String>
  ResaleAuthorizationAvailabilityEndDateFilterDateRange& WithBeforeValue(BeforeValueT&& value) {
