...
namespace Model
{
  ...
  {
  public:
    AWS_MARKETPLACECATALOG_API ResaleAuthorizationAvailabilityEndDateFilterDateRange() = default;
    ...
    template<typename AfterValueT = Aws::String>
    ResaleAuthorizationAvailabilityEndDateFilterDateRange& WithAfterValue(AfterValueT&& value) { SetAfterValue(std::forward<AfterValueT>(value)); return *this;}
    ///@}
    ...
    template<typename BeforeValueT = Aws::String>
    ResaleAuthorizationAvailabilityEndDateFilterDateRange& WithBeforeValue(BeforeValueT&& value) { SetBeforeValue(std::forward<BeforeValueT>(value)); return *this;}
    ///@}
  private:
