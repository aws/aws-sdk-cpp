...
class ContainerProductSummary {
 public:
  ...
  template <typename ProductTitleT = Aws::String>
  ContainerProductSummary& WithProductTitle(ProductTitleT&& value) {
  ...
  inline void SetVisibility(ContainerProductVisibilityString value) {
    m_visibilityHasBeenSet = true;
    m_visibility = value;
  }
  inline ContainerProductSummary& WithVisibility(ContainerProductVisibilityString value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
