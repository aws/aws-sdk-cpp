...
class ResaleAuthorizationSort {
 public:
  ...
  inline void SetSortBy(ResaleAuthorizationSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ResaleAuthorizationSort& WithSortBy(ResaleAuthorizationSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ResaleAuthorizationSort& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
