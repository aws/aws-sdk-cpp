...
class ResaleAuthorizationStatusFilter {
 public:
  ...
  template <typename ValueListT = Aws::Vector<ResaleAuthorizationStatusString>>
  ResaleAuthorizationStatusFilter& WithValueList(ValueListT&& value) {
    SetValueList(std::forward<ValueListT>(value));
    return *this;
  }
  inline ResaleAuthorizationStatusFilter& AddValueList(ResaleAuthorizationStatusString value) {
    m_valueListHasBeenSet = true;
