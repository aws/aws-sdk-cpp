...
class ChangeSummary {
 public:
  ...
  template <typename ChangeTypeT = Aws::String>
  ChangeSummary& WithChangeType(ChangeTypeT&& value) {
  ...
  template <typename EntityT = Entity>
  ChangeSummary& WithEntity(EntityT&& value) {
  ...
  template <typename DetailsT = Aws::String>
  ChangeSummary& WithDetails(DetailsT&& value) {
  ...
  template <typename DetailsDocumentT = Aws::Utils::Document>
  ChangeSummary& WithDetailsDocument(DetailsDocumentT&& value) {
  ...
  template <typename ErrorDetailListT = Aws::Vector<ErrorDetail>>
  ChangeSummary& WithErrorDetailList(ErrorDetailListT&& value) {
    SetErrorDetailList(std::forward<ErrorDetailListT>(value));
    return *this;
  }
  template <typename ErrorDetailListT = ErrorDetail>
  ChangeSummary& AddErrorDetailList(ErrorDetailListT&& value) {
    m_errorDetailListHasBeenSet = true;
  ...
  template <typename ChangeNameT = Aws::String>
  ChangeSummary& WithChangeName(ChangeNameT&& value) {
