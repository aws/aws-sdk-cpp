...
class MachineLearningProductSummary {
 public:
  ...
  template <typename ProductTitleT = Aws::String>
  MachineLearningProductSummary& WithProductTitle(ProductTitleT&& value) {
  ...
  inline void SetVisibility(MachineLearningProductVisibilityString value) {
    m_visibilityHasBeenSet = true;
    m_visibility = value;
  }
  inline MachineLearningProductSummary& WithVisibility(MachineLearningProductVisibilityString value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
