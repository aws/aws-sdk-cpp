...
class EntitySummary {
 public:
  ...
  template <typename NameT = Aws::String>
  EntitySummary& WithName(NameT&& value) {
  ...
  template <typename EntityTypeT = Aws::String>
  EntitySummary& WithEntityType(EntityTypeT&& value) {
  ...
  template <typename EntityArnT = Aws::String>
  EntitySummary& WithEntityArn(EntityArnT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::String>
  EntitySummary& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename VisibilityT = Aws::String>
  EntitySummary& WithVisibility(VisibilityT&& value) {
  ...
  void SetAmiProductSummary(AmiProductSummaryT&& value) {
    m_amiProductSummaryHasBeenSet = true;
    m_amiProductSummary = std::forward<AmiProductSummaryT>(value);
  }
  template <typename AmiProductSummaryT = AmiProductSummary>
  EntitySummary& WithAmiProductSummary(AmiProductSummaryT&& value) {
    SetAmiProductSummary(std::forward<AmiProductSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContainerProductSummary(ContainerProductSummaryT&& value) {
    m_containerProductSummaryHasBeenSet = true;
    m_containerProductSummary = std::forward<ContainerProductSummaryT>(value);
  }
  template <typename ContainerProductSummaryT = ContainerProductSummary>
  EntitySummary& WithContainerProductSummary(ContainerProductSummaryT&& value) {
    SetContainerProductSummary(std::forward<ContainerProductSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataProductSummary(DataProductSummaryT&& value) {
    m_dataProductSummaryHasBeenSet = true;
    m_dataProductSummary = std::forward<DataProductSummaryT>(value);
  }
  template <typename DataProductSummaryT = DataProductSummary>
  EntitySummary& WithDataProductSummary(DataProductSummaryT&& value) {
    SetDataProductSummary(std::forward<DataProductSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSaaSProductSummary(SaaSProductSummaryT&& value) {
    m_saaSProductSummaryHasBeenSet = true;
    m_saaSProductSummary = std::forward<SaaSProductSummaryT>(value);
  }
  template <typename SaaSProductSummaryT = SaaSProductSummary>
  EntitySummary& WithSaaSProductSummary(SaaSProductSummaryT&& value) {
    SetSaaSProductSummary(std::forward<SaaSProductSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOfferSummary(OfferSummaryT&& value) {
    m_offerSummaryHasBeenSet = true;
    m_offerSummary = std::forward<OfferSummaryT>(value);
  }
  template <typename OfferSummaryT = OfferSummary>
  EntitySummary& WithOfferSummary(OfferSummaryT&& value) {
    SetOfferSummary(std::forward<OfferSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResaleAuthorizationSummary(ResaleAuthorizationSummaryT&& value) {
    m_resaleAuthorizationSummaryHasBeenSet = true;
    m_resaleAuthorizationSummary = std::forward<ResaleAuthorizationSummaryT>(value);
  }
  template <typename ResaleAuthorizationSummaryT = ResaleAuthorizationSummary>
  EntitySummary& WithResaleAuthorizationSummary(ResaleAuthorizationSummaryT&& value) {
    SetResaleAuthorizationSummary(std::forward<ResaleAuthorizationSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMachineLearningProductSummary(MachineLearningProductSummaryT&& value) {
    m_machineLearningProductSummaryHasBeenSet = true;
    m_machineLearningProductSummary = std::forward<MachineLearningProductSummaryT>(value);
  }
  template <typename MachineLearningProductSummaryT = MachineLearningProductSummary>
  EntitySummary& WithMachineLearningProductSummary(MachineLearningProductSummaryT&& value) {
    SetMachineLearningProductSummary(std::forward<MachineLearningProductSummaryT>(value));
    return *this;
  }
  ///@}
