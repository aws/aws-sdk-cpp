 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/OfferSetLastModifiedDateFilterDateRange">AWS
 * API Reference</a></p>
 */
class OfferSetLastModifiedDateFilterDateRange {
 public:
  AWS_MARKETPLACECATALOG_API OfferSetLastModifiedDateFilterDateRange() = default;
  AWS_MARKETPLACECATALOG_API OfferSetLastModifiedDateFilterDateRange(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACECATALOG_API OfferSetLastModifiedDateFilterDateRange& operator=(Aws::Utils::Json::JsonView jsonValue);
  AWS_MARKETPLACECATALOG_API Aws::Utils::Json::JsonValue Jsonize() const;

  ///@{
  /**
   * <p>Allows filtering on the <code>LastModifiedDate</code> of an offer set after a
   * date.</p>
   */
  ...
  template <typename AfterValueT = Aws::String>
  OfferSetLastModifiedDateFilterDateRange& WithAfterValue(AfterValueT&& value) {
  ...
  ///@{
  /**
   * <p>Allows filtering on the <code>LastModifiedDate</code> of an offer set before
   * a date.</p>
   */
  ...
  template <typename BeforeValueT = Aws::String>
  OfferSetLastModifiedDateFilterDateRange& WithBeforeValue(BeforeValueT&& value) {
