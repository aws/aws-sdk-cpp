...
namespace Model
{
  ...
  {
  public:
    AWS_MARKETPLACECATALOG_API OfferAvailabilityEndDateFilterDateRange() = default;
    ...
    template<typename AfterValueT = Aws::String>
    OfferAvailabilityEndDateFilterDateRange& WithAfterValue(AfterValueT&& value) { SetAfterValue(std::forward<AfterValueT>(value)); return *this;}
    ///@}
    ...
    template<typename BeforeValueT = Aws::String>
    OfferAvailabilityEndDateFilterDateRange& WithBeforeValue(BeforeValueT&& value) { SetBeforeValue(std::forward<BeforeValueT>(value)); return *this;}
    ///@}
  private:
