...
class OfferSummary {
 public:
  ...
  template <typename NameT = Aws::String>
  OfferSummary& WithName(NameT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  OfferSummary& WithProductId(ProductIdT&& value) {
  ...
  void SetResaleAuthorizationId(ResaleAuthorizationIdT&& value) {
    m_resaleAuthorizationIdHasBeenSet = true;
    m_resaleAuthorizationId = std::forward<ResaleAuthorizationIdT>(value);
  }
  template <typename ResaleAuthorizationIdT = Aws::String>
  OfferSummary& WithResaleAuthorizationId(ResaleAuthorizationIdT&& value) {
    SetResaleAuthorizationId(std::forward<ResaleAuthorizationIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ReleaseDateT = Aws::String>
  OfferSummary& WithReleaseDate(ReleaseDateT&& value) {
  ...
  template <typename AvailabilityEndDateT = Aws::String>
  OfferSummary& WithAvailabilityEndDate(AvailabilityEndDateT&& value) {
  ...
  void SetBuyerAccounts(BuyerAccountsT&& value) {
    m_buyerAccountsHasBeenSet = true;
    m_buyerAccounts = std::forward<BuyerAccountsT>(value);
  }
  template <typename BuyerAccountsT = Aws::Vector<Aws::String>>
  OfferSummary& WithBuyerAccounts(BuyerAccountsT&& value) {
    SetBuyerAccounts(std::forward<BuyerAccountsT>(value));
    return *this;
  }
  template <typename BuyerAccountsT = Aws::String>
  OfferSummary& AddBuyerAccounts(BuyerAccountsT&& value) {
    m_buyerAccountsHasBeenSet = true;
    m_buyerAccounts.emplace_back(std::forward<BuyerAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(OfferStateString value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline OfferSummary& WithState(OfferStateString value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetTargeting(TargetingT&& value) {
    m_targetingHasBeenSet = true;
    m_targeting = std::forward<TargetingT>(value);
  }
  template <typename TargetingT = Aws::Vector<OfferTargetingString>>
  OfferSummary& WithTargeting(TargetingT&& value) {
    SetTargeting(std::forward<TargetingT>(value));
    return *this;
  }
  inline OfferSummary& AddTargeting(OfferTargetingString value) {
    m_targetingHasBeenSet = true;
    m_targeting.push_back(value);
    return *this;
  }
  ///@}
 private:
