...
namespace Model
{
  ...
  {
  public:
    AWS_MARKETPLACECATALOG_API ResaleAuthorizationResellerLegalNameFilter();
     ...
     * with list input.</p>
     */
    inline ResaleAuthorizationResellerLegalNameFilter& WithValueList(const Aws::Vector<Aws::String>& value) { SetValueList(value); return *this;}

    /**
     * <p>Allows filtering on the ResellerLegalNameProductName of a ResaleAuthorization
     * with list input.</p>
     */
    inline ResaleAuthorizationResellerLegalNameFilter& WithValueList(Aws::Vector<Aws::String>&& value) { SetValueList(std::move(value)); return *this;}

    /**
     * <p>Allows filtering on the ResellerLegalNameProductName of a ResaleAuthorization
     * with list input.</p>
     */
    inline ResaleAuthorizationResellerLegalNameFilter& AddValueList(const Aws::String& value) { m_valueListHasBeenSet = true; m_valueList.push_back(value); return *this; }

    /**
     * <p>Allows filtering on the ResellerLegalNameProductName of a ResaleAuthorization
     * with list input.</p>
     */
    inline ResaleAuthorizationResellerLegalNameFilter& AddValueList(Aws::String&& value) { m_valueListHasBeenSet = true; m_valueList.push_back(std::move(value)); return *this; }

    /**
     * <p>Allows filtering on the ResellerLegalNameProductName of a ResaleAuthorization
     * with list input.</p>
     */
    inline ResaleAuthorizationResellerLegalNameFilter& AddValueList(const char* value) { m_valueListHasBeenSet = true; m_valueList.push_back(value); return *this; }
     ...
     * card input.</p>
     */
    inline ResaleAuthorizationResellerLegalNameFilter& WithWildCardValue(const Aws::String& value) { SetWildCardValue(value); return *this;}

    /**
     * <p>Allows filtering on the ResellerLegalName of a ResaleAuthorization with wild
     * card input.</p>
     */
    inline ResaleAuthorizationResellerLegalNameFilter& WithWildCardValue(Aws::String&& value) { SetWildCardValue(std::move(value)); return *this;}

    /**
     * <p>Allows filtering on the ResellerLegalName of a ResaleAuthorization with wild
     * card input.</p>
     */
    inline ResaleAuthorizationResellerLegalNameFilter& WithWildCardValue(const char* value) { SetWildCardValue(value); return *this;}
