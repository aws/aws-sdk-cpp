...
class ResaleAuthorizationResellerLegalNameFilter {
 public:
  ...
  template <typename ValueListT = Aws::Vector<Aws::String>>
  ResaleAuthorizationResellerLegalNameFilter& WithValueList(ValueListT&& value) {
    SetValueList(std::forward<ValueListT>(value));
    return *this;
  }
  template <typename ValueListT = Aws::String>
  ResaleAuthorizationResellerLegalNameFilter& AddValueList(ValueListT&& value) {
    m_valueListHasBeenSet = true;
  ...
  template <typename WildCardValueT = Aws::String>
  ResaleAuthorizationResellerLegalNameFilter& WithWildCardValue(WildCardValueT&& value) {
