...
class ResaleAuthorizationResellerAccountIDFilter {
 public:
  ...
  template <typename ValueListT = Aws::Vector<Aws::String>>
  ResaleAuthorizationResellerAccountIDFilter& WithValueList(ValueListT&& value) {
    SetValueList(std::forward<ValueListT>(value));
    return *this;
  }
  template <typename ValueListT = Aws::String>
  ResaleAuthorizationResellerAccountIDFilter& AddValueList(ValueListT&& value) {
    m_valueListHasBeenSet = true;
  ...
  template <typename WildCardValueT = Aws::String>
  ResaleAuthorizationResellerAccountIDFilter& WithWildCardValue(WildCardValueT&& value) {
