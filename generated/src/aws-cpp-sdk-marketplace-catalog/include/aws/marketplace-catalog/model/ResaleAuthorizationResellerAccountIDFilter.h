...
namespace Model
{
  ...
  {
  public:
    AWS_MARKETPLACECATALOG_API ResaleAuthorizationResellerAccountIDFilter() = default;
    ...
    template<typename ValueListT = Aws::Vector<Aws::String>>
    ResaleAuthorizationResellerAccountIDFilter& WithValueList(ValueListT&& value) { SetValueList(std::forward<ValueListT>(value)); return *this;}
    template<typename ValueListT = Aws::String>
    ResaleAuthorizationResellerAccountIDFilter& AddValueList(ValueListT&& value) { m_valueListHasBeenSet = true; m_valueList.emplace_back(std::forward<ValueListT>(value)); return *this; }
    ///@}
    ...
    template<typename WildCardValueT = Aws::String>
    ResaleAuthorizationResellerAccountIDFilter& WithWildCardValue(WildCardValueT&& value) { SetWildCardValue(std::forward<WildCardValueT>(value)); return *this;}
    ///@}
  private:
