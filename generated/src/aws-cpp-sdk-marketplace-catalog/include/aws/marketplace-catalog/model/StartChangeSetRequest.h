...
class StartChangeSetRequest : public MarketplaceCatalogRequest {
 public:
  ...
  template <typename CatalogT = Aws::String>
  StartChangeSetRequest& WithCatalog(CatalogT&& value) {
  ...
  template <typename ChangeSetT = Aws::Vector<Change>>
  StartChangeSetRequest& WithChangeSet(ChangeSetT&& value) {
    SetChangeSet(std::forward<ChangeSetT>(value));
    return *this;
  }
  template <typename ChangeSetT = Change>
  StartChangeSetRequest& AddChangeSet(ChangeSetT&& value) {
    m_changeSetHasBeenSet = true;
  ...
  template <typename ChangeSetNameT = Aws::String>
  StartChangeSetRequest& WithChangeSetName(ChangeSetNameT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartChangeSetRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  void SetChangeSetTags(ChangeSetTagsT&& value) {
    m_changeSetTagsHasBeenSet = true;
    m_changeSetTags = std::forward<ChangeSetTagsT>(value);
  }
  template <typename ChangeSetTagsT = Aws::Vector<Tag>>
  StartChangeSetRequest& WithChangeSetTags(ChangeSetTagsT&& value) {
    SetChangeSetTags(std::forward<ChangeSetTagsT>(value));
    return *this;
  }
  template <typename ChangeSetTagsT = Tag>
  StartChangeSetRequest& AddChangeSetTags(ChangeSetTagsT&& value) {
    m_changeSetTagsHasBeenSet = true;
    m_changeSetTags.emplace_back(std::forward<ChangeSetTagsT>(value));
    return *this;
  }
  ///@}
  ...
  inline StartChangeSetRequest& WithIntent(Intent value) {
    SetIntent(value);
    return *this;
  }
  ///@}
