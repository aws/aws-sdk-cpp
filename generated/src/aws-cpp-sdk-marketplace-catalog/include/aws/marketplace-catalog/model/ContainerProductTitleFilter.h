...
class ContainerProductTitleFilter {
 public:
  ...
  template <typename ValueListT = Aws::Vector<Aws::String>>
  ContainerProductTitleFilter& WithValueList(ValueListT&& value) {
    SetValueList(std::forward<ValueListT>(value));
    return *this;
  }
  template <typename ValueListT = Aws::String>
  ContainerProductTitleFilter& AddValueList(ValueListT&& value) {
    m_valueListHasBeenSet = true;
  ...
  template <typename WildCardValueT = Aws::String>
  ContainerProductTitleFilter& WithWildCardValue(WildCardValueT&& value) {
