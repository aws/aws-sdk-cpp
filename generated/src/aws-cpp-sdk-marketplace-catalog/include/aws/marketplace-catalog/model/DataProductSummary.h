...
class DataProductSummary {
 public:
  ...
  template <typename ProductTitleT = Aws::String>
  DataProductSummary& WithProductTitle(ProductTitleT&& value) {
  ...
  inline void SetVisibility(DataProductVisibilityString value) {
    m_visibilityHasBeenSet = true;
    m_visibility = value;
  }
  inline DataProductSummary& WithVisibility(DataProductVisibilityString value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
