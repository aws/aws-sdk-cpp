...
class ListChangeSetsRequest : public MarketplaceCatalogRequest {
 public:
  ...
  template <typename CatalogT = Aws::String>
  ListChangeSetsRequest& WithCatalog(CatalogT&& value) {
  ...
  void SetFilterList(FilterListT&& value) {
    m_filterListHasBeenSet = true;
    m_filterList = std::forward<FilterListT>(value);
  }
  template <typename FilterListT = Aws::Vector<Filter>>
  ListChangeSetsRequest& WithFilterList(FilterListT&& value) {
    SetFilterList(std::forward<FilterListT>(value));
    return *this;
  }
  template <typename FilterListT = Filter>
  ListChangeSetsRequest& AddFilterList(FilterListT&& value) {
    m_filterListHasBeenSet = true;
    m_filterList.emplace_back(std::forward<FilterListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SortT = Sort>
  ListChangeSetsRequest& WithSort(SortT&& value) {
  ...
  inline ListChangeSetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChangeSetsRequest& WithNextToken(NextTokenT&& value) {
