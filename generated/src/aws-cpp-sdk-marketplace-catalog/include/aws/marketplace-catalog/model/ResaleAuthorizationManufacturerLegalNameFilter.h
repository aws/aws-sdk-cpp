...
class ResaleAuthorizationManufacturerLegalNameFilter {
 public:
  ...
  template <typename ValueListT = Aws::Vector<Aws::String>>
  ResaleAuthorizationManufacturerLegalNameFilter& WithValueList(ValueListT&& value) {
    SetValueList(std::forward<ValueListT>(value));
    return *this;
  }
  template <typename ValueListT = Aws::String>
  ResaleAuthorizationManufacturerLegalNameFilter& AddValueList(ValueListT&& value) {
    m_valueListHasBeenSet = true;
  ...
  template <typename WildCardValueT = Aws::String>
  ResaleAuthorizationManufacturerLegalNameFilter& WithWildCardValue(WildCardValueT&& value) {
