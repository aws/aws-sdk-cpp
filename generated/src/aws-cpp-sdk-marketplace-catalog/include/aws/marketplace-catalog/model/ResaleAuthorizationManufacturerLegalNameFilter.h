...
namespace Model
{
  ...
  {
  public:
    AWS_MARKETPLACECATALOG_API ResaleAuthorizationManufacturerLegalNameFilter() = default;
    ...
    template<typename ValueListT = Aws::Vector<Aws::String>>
    ResaleAuthorizationManufacturerLegalNameFilter& WithValueList(ValueListT&& value) { SetValueList(std::forward<ValueListT>(value)); return *this;}
    template<typename ValueListT = Aws::String>
    ResaleAuthorizationManufacturerLegalNameFilter& AddValueList(ValueListT&& value) { m_valueListHasBeenSet = true; m_valueList.emplace_back(std::forward<ValueListT>(value)); return *this; }
    ///@}
    ...
    template<typename WildCardValueT = Aws::String>
    ResaleAuthorizationManufacturerLegalNameFilter& WithWildCardValue(WildCardValueT&& value) { SetWildCardValue(std::forward<WildCardValueT>(value)); return *this;}
    ///@}
  private:
