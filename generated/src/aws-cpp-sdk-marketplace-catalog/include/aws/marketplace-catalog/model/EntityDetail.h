...
class EntityDetail {
 public:
  ...
  template <typename EntityTypeT = Aws::String>
  EntityDetail& WithEntityType(EntityTypeT&& value) {
  ...
  template <typename EntityArnT = Aws::String>
  EntityDetail& WithEntityArn(EntityArnT&& value) {
  ...
  template <typename EntityIdentifierT = Aws::String>
  EntityDetail& WithEntityIdentifier(EntityIdentifierT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::String>
  EntityDetail& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename DetailsDocumentT = Aws::Utils::Document>
  EntityDetail& WithDetailsDocument(DetailsDocumentT&& value) {
