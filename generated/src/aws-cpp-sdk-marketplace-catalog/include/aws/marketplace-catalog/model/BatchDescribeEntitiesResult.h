...
class BatchDescribeEntitiesResult {
 public:
  ...
  void SetEntityDetails(EntityDetailsT&& value) {
    m_entityDetailsHasBeenSet = true;
    m_entityDetails = std::forward<EntityDetailsT>(value);
  }
  template <typename EntityDetailsT = Aws::Map<Aws::String, EntityDetail>>
  BatchDescribeEntitiesResult& WithEntityDetails(EntityDetailsT&& value) {
    SetEntityDetails(std::forward<EntityDetailsT>(value));
    return *this;
  }
  ...
  BatchDescribeEntitiesResult& AddEntityDetails(EntityDetailsKeyT&& key, EntityDetailsValueT&& value) {
    m_entityDetailsHasBeenSet = true;
    m_entityDetails.emplace(std::forward<EntityDetailsKeyT>(key), std::forward<EntityDetailsValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorsT = Aws::Map<Aws::String, BatchDescribeErrorDetail>>
  BatchDescribeEntitiesResult& WithErrors(ErrorsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  BatchDescribeEntitiesResult& WithRequestId(RequestIdT&& value) {
