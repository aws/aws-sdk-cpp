...
class MachineLearningProductVisibilityFilter {
 public:
  ...
  template <typename ValueListT = Aws::Vector<MachineLearningProductVisibilityString>>
  MachineLearningProductVisibilityFilter& WithValueList(ValueListT&& value) {
    SetValueList(std::forward<ValueListT>(value));
    return *this;
  }
  inline MachineLearningProductVisibilityFilter& AddValueList(MachineLearningProductVisibilityString value) {
    m_valueListHasBeenSet = true;
