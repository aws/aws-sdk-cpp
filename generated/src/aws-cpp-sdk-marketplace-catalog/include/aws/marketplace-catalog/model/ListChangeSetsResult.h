...
class ListChangeSetsResult {
 public:
  ...
  void SetChangeSetSummaryList(ChangeSetSummaryListT&& value) {
    m_changeSetSummaryListHasBeenSet = true;
    m_changeSetSummaryList = std::forward<ChangeSetSummaryListT>(value);
  }
  template <typename ChangeSetSummaryListT = Aws::Vector<ChangeSetSummaryListItem>>
  ListChangeSetsResult& WithChangeSetSummaryList(ChangeSetSummaryListT&& value) {
    SetChangeSetSummaryList(std::forward<ChangeSetSummaryListT>(value));
    return *this;
  }
  template <typename ChangeSetSummaryListT = ChangeSetSummaryListItem>
  ListChangeSetsResult& AddChangeSetSummaryList(ChangeSetSummaryListT&& value) {
    m_changeSetSummaryListHasBeenSet = true;
    m_changeSetSummaryList.emplace_back(std::forward<ChangeSetSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChangeSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListChangeSetsResult& WithRequestId(RequestIdT&& value) {
