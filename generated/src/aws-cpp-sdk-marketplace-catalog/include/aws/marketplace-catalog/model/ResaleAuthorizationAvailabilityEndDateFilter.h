...
class ResaleAuthorizationAvailabilityEndDateFilter {
 public:
  ...
  template <typename DateRangeT = ResaleAuthorizationAvailabilityEndDateFilterDateRange>
  ResaleAuthorizationAvailabilityEndDateFilter& WithDateRange(DateRangeT&& value) {
  ...
  template <typename ValueListT = Aws::Vector<Aws::String>>
  ResaleAuthorizationAvailabilityEndDateFilter& WithValueList(ValueListT&& value) {
    SetValueList(std::forward<ValueListT>(value));
    return *this;
  }
  template <typename ValueListT = Aws::String>
  ResaleAuthorizationAvailabilityEndDateFilter& AddValueList(ValueListT&& value) {
    m_valueListHasBeenSet = true;
