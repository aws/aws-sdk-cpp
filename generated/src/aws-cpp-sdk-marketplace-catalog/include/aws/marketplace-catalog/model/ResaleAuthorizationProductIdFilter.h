...
class ResaleAuthorizationProductIdFilter {
 public:
  ...
  template <typename ValueListT = Aws::Vector<Aws::String>>
  ResaleAuthorizationProductIdFilter& WithValueList(ValueListT&& value) {
    SetValueList(std::forward<ValueListT>(value));
    return *this;
  }
  template <typename ValueListT = Aws::String>
  ResaleAuthorizationProductIdFilter& AddValueList(ValueListT&& value) {
    m_valueListHasBeenSet = true;
  ...
  template <typename WildCardValueT = Aws::String>
  ResaleAuthorizationProductIdFilter& WithWildCardValue(WildCardValueT&& value) {
