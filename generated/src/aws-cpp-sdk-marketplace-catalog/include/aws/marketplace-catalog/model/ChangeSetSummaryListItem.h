...
class ChangeSetSummaryListItem {
 public:
  ...
  template <typename ChangeSetIdT = Aws::String>
  ChangeSetSummaryListItem& WithChangeSetId(ChangeSetIdT&& value) {
  ...
  template <typename ChangeSetArnT = Aws::String>
  ChangeSetSummaryListItem& WithChangeSetArn(ChangeSetArnT&& value) {
  ...
  template <typename ChangeSetNameT = Aws::String>
  ChangeSetSummaryListItem& WithChangeSetName(ChangeSetNameT&& value) {
  ...
  template <typename StartTimeT = Aws::String>
  ChangeSetSummaryListItem& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::String>
  ChangeSetSummaryListItem& WithEndTime(EndTimeT&& value) {
  ...
  inline ChangeSetSummaryListItem& WithStatus(ChangeStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetEntityIdList(EntityIdListT&& value) {
    m_entityIdListHasBeenSet = true;
    m_entityIdList = std::forward<EntityIdListT>(value);
  }
  template <typename EntityIdListT = Aws::Vector<Aws::String>>
  ChangeSetSummaryListItem& WithEntityIdList(EntityIdListT&& value) {
    SetEntityIdList(std::forward<EntityIdListT>(value));
    return *this;
  }
  template <typename EntityIdListT = Aws::String>
  ChangeSetSummaryListItem& AddEntityIdList(EntityIdListT&& value) {
    m_entityIdListHasBeenSet = true;
    m_entityIdList.emplace_back(std::forward<EntityIdListT>(value));
    return *this;
  }
  ///@}
  ...
  inline ChangeSetSummaryListItem& WithFailureCode(FailureCode value) {
