...
class DataProductLastModifiedDateFilterDateRange {
 public:
  AWS_MARKETPLACECATALOG_API DataProductLastModifiedDateFilterDateRange() = default;
  ...
  template <typename AfterValueT = Aws::String>
  DataProductLastModifiedDateFilterDateRange& WithAfterValue(AfterValueT&& value) {
  ...
  template <typename BeforeValueT = Aws::String>
  DataProductLastModifiedDateFilterDateRange& WithBeforeValue(BeforeValueT&& value) {
