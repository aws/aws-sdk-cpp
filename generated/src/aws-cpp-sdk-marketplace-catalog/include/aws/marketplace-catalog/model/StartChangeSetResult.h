...
class StartChangeSetResult {
 public:
  ...
  template <typename ChangeSetIdT = Aws::String>
  StartChangeSetResult& WithChangeSetId(ChangeSetIdT&& value) {
  ...
  template <typename ChangeSetArnT = Aws::String>
  StartChangeSetResult& WithChangeSetArn(ChangeSetArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartChangeSetResult& WithRequestId(RequestIdT&& value) {
