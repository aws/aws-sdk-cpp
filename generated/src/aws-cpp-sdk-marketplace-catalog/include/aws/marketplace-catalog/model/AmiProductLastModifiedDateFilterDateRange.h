...
class AmiProductLastModifiedDateFilterDateRange {
 public:
  ...
  template <typename AfterValueT = Aws::String>
  AmiProductLastModifiedDateFilterDateRange& WithAfterValue(AfterValueT&& value) {
  ...
  template <typename BeforeValueT = Aws::String>
  AmiProductLastModifiedDateFilterDateRange& WithBeforeValue(BeforeValueT&& value) {
