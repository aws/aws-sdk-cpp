...
class MachineLearningProductLastModifiedDateFilterDateRange {
 public:
  ...
  template <typename AfterValueT = Aws::String>
  MachineLearningProductLastModifiedDateFilterDateRange& WithAfterValue(AfterValueT&& value) {
  ...
  template <typename BeforeValueT = Aws::String>
  MachineLearningProductLastModifiedDateFilterDateRange& WithBeforeValue(BeforeValueT&& value) {
