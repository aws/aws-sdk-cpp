...
OfferSetNameFilter::OfferSetNameFilter(JsonView jsonValue) { *this = jsonValue; }

OfferSetNameFilter& OfferSetNameFilter::operator=(JsonView jsonValue) {
...
JsonValue OfferSetNameFilter::Jsonize() const {
  JsonValue payload;
