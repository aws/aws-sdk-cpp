...
OfferNameFilter::OfferNameFilter(JsonView jsonValue) { *this = jsonValue; }

OfferNameFilter& OfferNameFilter::operator=(JsonView jsonValue) {
...
JsonValue OfferNameFilter::Jsonize() const {
  JsonValue payload;
