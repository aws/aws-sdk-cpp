...
ContainerSecurityFilters::ContainerSecurityFilters(JsonView jsonValue) { *this = jsonValue; }

ContainerSecurityFilters& ContainerSecurityFilters::operator=(JsonView jsonValue) {
...
JsonValue ContainerSecurityFilters::Jsonize() const {
  JsonValue payload;
