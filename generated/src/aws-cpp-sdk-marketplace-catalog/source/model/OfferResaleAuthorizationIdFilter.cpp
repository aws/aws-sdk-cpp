...
OfferResaleAuthorizationIdFilter::OfferResaleAuthorizationIdFilter(JsonView jsonValue) { *this = jsonValue; }

OfferResaleAuthorizationIdFilter& OfferResaleAuthorizationIdFilter::operator=(JsonView jsonValue) {
...
JsonValue OfferResaleAuthorizationIdFilter::Jsonize() const {
  JsonValue payload;
