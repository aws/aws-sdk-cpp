...
MachineLearningProductSummary::MachineLearningProductSummary(JsonView jsonValue) { *this = jsonValue; }
...
MachineLearningProductSummary& MachineLearningProductSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Visibility")) {
    m_visibility =
        MachineLearningProductVisibilityStringMapper::GetMachineLearningProductVisibilityStringForName(jsonValue.GetString("Visibility"));
...
JsonValue MachineLearningProductSummary::Jsonize() const {
  ...
  if (m_visibilityHasBeenSet) {
    payload.WithString("Visibility",
                       MachineLearningProductVisibilityStringMapper::GetNameForMachineLearningProductVisibilityString(m_visibility));
  }
