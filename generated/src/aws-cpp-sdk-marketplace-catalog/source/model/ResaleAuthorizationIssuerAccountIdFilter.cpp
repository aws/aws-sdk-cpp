...
ResaleAuthorizationIssuerAccountIdFilter::ResaleAuthorizationIssuerAccountIdFilter(JsonView jsonValue) { *this = jsonValue; }

ResaleAuthorizationIssuerAccountIdFilter& ResaleAuthorizationIssuerAccountIdFilter::operator=(JsonView jsonValue) {
...
JsonValue ResaleAuthorizationIssuerAccountIdFilter::Jsonize() const {
  JsonValue payload;
