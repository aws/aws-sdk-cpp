...
AmiProductEntityIdFilter::AmiProductEntityIdFilter(JsonView jsonValue) { *this = jsonValue; }

AmiProductEntityIdFilter& AmiProductEntityIdFilter::operator=(JsonView jsonValue) {
...
JsonValue AmiProductEntityIdFilter::Jsonize() const {
  JsonValue payload;
