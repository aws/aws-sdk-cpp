...
ContainerProductEntityIdFilter::ContainerProductEntityIdFilter(JsonView jsonValue) { *this = jsonValue; }

ContainerProductEntityIdFilter& ContainerProductEntityIdFilter::operator=(JsonView jsonValue) {
...
JsonValue ContainerProductEntityIdFilter::Jsonize() const {
  JsonValue payload;
