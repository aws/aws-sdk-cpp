...
OfferSetIdFilter::OfferSetIdFilter(JsonView jsonValue) { *this = jsonValue; }

OfferSetIdFilter& OfferSetIdFilter::operator=(JsonView jsonValue) {
...
JsonValue OfferSetIdFilter::Jsonize() const {
  JsonValue payload;
