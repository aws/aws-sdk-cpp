...
OfferSetReleaseDateFilterDateRange::OfferSetReleaseDateFilterDateRange(JsonView jsonValue) { *this = jsonValue; }

OfferSetReleaseDateFilterDateRange& OfferSetReleaseDateFilterDateRange::operator=(JsonView jsonValue) {
...
JsonValue OfferSetReleaseDateFilterDateRange::Jsonize() const {
  JsonValue payload;
