...
ContainerProductTitleFilter::ContainerProductTitleFilter(JsonView jsonValue) { *this = jsonValue; }

ContainerProductTitleFilter& ContainerProductTitleFilter::operator=(JsonView jsonValue) {
...
JsonValue ContainerProductTitleFilter::Jsonize() const {
  JsonValue payload;
