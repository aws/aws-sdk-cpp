...
OfferProductIdFilter::OfferProductIdFilter(JsonView jsonValue) { *this = jsonValue; }

OfferProductIdFilter& OfferProductIdFilter::operator=(JsonView jsonValue) {
...
JsonValue OfferProductIdFilter::Jsonize() const {
  JsonValue payload;
