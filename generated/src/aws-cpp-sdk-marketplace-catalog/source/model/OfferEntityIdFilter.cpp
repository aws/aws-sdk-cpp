...
OfferEntityIdFilter::OfferEntityIdFilter(JsonView jsonValue) { *this = jsonValue; }

OfferEntityIdFilter& OfferEntityIdFilter::operator=(JsonView jsonValue) {
...
JsonValue OfferEntityIdFilter::Jsonize() const {
  JsonValue payload;
