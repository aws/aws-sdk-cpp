...
OfferSetSolutionIdFilter::OfferSetSolutionIdFilter(JsonView jsonValue) { *this = jsonValue; }

OfferSetSolutionIdFilter& OfferSetSolutionIdFilter::operator=(JsonView jsonValue) {
...
JsonValue OfferSetSolutionIdFilter::Jsonize() const {
  JsonValue payload;
