...
AmiProductTitleFilter::AmiProductTitleFilter(JsonView jsonValue) { *this = jsonValue; }

AmiProductTitleFilter& AmiProductTitleFilter::operator=(JsonView jsonValue) {
...
JsonValue AmiProductTitleFilter::Jsonize() const {
  JsonValue payload;
