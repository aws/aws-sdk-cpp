...
OfferTargetAgreementIdFilter::OfferTargetAgreementIdFilter(JsonView jsonValue) { *this = jsonValue; }

OfferTargetAgreementIdFilter& OfferTargetAgreementIdFilter::operator=(JsonView jsonValue) {
...
JsonValue OfferTargetAgreementIdFilter::Jsonize() const {
  JsonValue payload;
