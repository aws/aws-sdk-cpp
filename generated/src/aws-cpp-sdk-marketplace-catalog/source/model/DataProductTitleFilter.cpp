...
DataProductTitleFilter::DataProductTitleFilter(JsonView jsonValue) { *this = jsonValue; }

DataProductTitleFilter& DataProductTitleFilter::operator=(JsonView jsonValue) {
...
JsonValue DataProductTitleFilter::Jsonize() const {
  JsonValue payload;
