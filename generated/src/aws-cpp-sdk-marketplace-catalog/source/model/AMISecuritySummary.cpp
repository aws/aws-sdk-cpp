...
AMISecuritySummary::AMISecuritySummary(JsonView jsonValue) { *this = jsonValue; }

AMISecuritySummary& AMISecuritySummary::operator=(JsonView jsonValue) {
...
JsonValue AMISecuritySummary::Jsonize() const {
  JsonValue payload;
