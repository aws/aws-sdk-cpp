...
ResaleAuthorizationOfferExtendedStatusFilter::ResaleAuthorizationOfferExtendedStatusFilter(JsonView jsonValue) { *this = jsonValue; }

ResaleAuthorizationOfferExtendedStatusFilter& ResaleAuthorizationOfferExtendedStatusFilter::operator=(JsonView jsonValue) {
...
JsonValue ResaleAuthorizationOfferExtendedStatusFilter::Jsonize() const {
  JsonValue payload;
