...
ResaleAuthorizationProductIdFilter::ResaleAuthorizationProductIdFilter(JsonView jsonValue) { *this = jsonValue; }

ResaleAuthorizationProductIdFilter& ResaleAuthorizationProductIdFilter::operator=(JsonView jsonValue) {
...
JsonValue ResaleAuthorizationProductIdFilter::Jsonize() const {
  JsonValue payload;
