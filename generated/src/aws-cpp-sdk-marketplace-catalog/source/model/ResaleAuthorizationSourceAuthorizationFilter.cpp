...
ResaleAuthorizationSourceAuthorizationFilter::ResaleAuthorizationSourceAuthorizationFilter(JsonView jsonValue) { *this = jsonValue; }

ResaleAuthorizationSourceAuthorizationFilter& ResaleAuthorizationSourceAuthorizationFilter::operator=(JsonView jsonValue) {
...
JsonValue ResaleAuthorizationSourceAuthorizationFilter::Jsonize() const {
  JsonValue payload;
