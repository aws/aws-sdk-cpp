...
OfferSetAssociatedOfferIdsFilter::OfferSetAssociatedOfferIdsFilter(JsonView jsonValue) { *this = jsonValue; }

OfferSetAssociatedOfferIdsFilter& OfferSetAssociatedOfferIdsFilter::operator=(JsonView jsonValue) {
...
JsonValue OfferSetAssociatedOfferIdsFilter::Jsonize() const {
  JsonValue payload;
