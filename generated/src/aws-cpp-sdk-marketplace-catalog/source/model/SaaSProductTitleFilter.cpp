...
SaaSProductTitleFilter::SaaSProductTitleFilter(JsonView jsonValue) { *this = jsonValue; }

SaaSProductTitleFilter& SaaSProductTitleFilter::operator=(JsonView jsonValue) {
...
JsonValue SaaSProductTitleFilter::Jsonize() const {
  JsonValue payload;
