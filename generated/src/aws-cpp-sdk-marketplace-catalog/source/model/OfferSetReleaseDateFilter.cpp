...
OfferSetReleaseDateFilter::OfferSetReleaseDateFilter(JsonView jsonValue) { *this = jsonValue; }

OfferSetReleaseDateFilter& OfferSetReleaseDateFilter::operator=(JsonView jsonValue) {
...
JsonValue OfferSetReleaseDateFilter::Jsonize() const {
  JsonValue payload;
