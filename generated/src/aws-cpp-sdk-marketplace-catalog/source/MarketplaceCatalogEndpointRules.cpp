...
{
const size_t MarketplaceCatalogEndpointRules::RulesBlobStrLen = 3776;
const size_t MarketplaceCatalogEndpointRules::RulesBlobSize = 3777;
...
'k','e','t','p','l','a','c','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','c','a','t','a','l','o','g','.','m','a','r','k',
'e','t','p','l','a','c','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
's',':','/','/','c','a','t','a','l','o','g','.','m','a','r','k','e','t','p','l','a','c','e','.','{',
...
const char* MarketplaceCatalogEndpointRules::GetRulesBlob()
{
