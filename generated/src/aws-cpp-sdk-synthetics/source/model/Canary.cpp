...
Canary::Canary(JsonView jsonValue) { *this = jsonValue; }
...
Canary& Canary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ProvisionedResourceCleanup")) {
    m_provisionedResourceCleanup = ProvisionedResourceCleanupSettingMapper::GetProvisionedResourceCleanupSettingForName(
        jsonValue.GetString("ProvisionedResourceCleanup"));
