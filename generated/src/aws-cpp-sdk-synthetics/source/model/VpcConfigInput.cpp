...
VpcConfigInput::VpcConfigInput(JsonView jsonValue) { *this = jsonValue; }

VpcConfigInput& VpcConfigInput::operator=(JsonView jsonValue) {
...
JsonValue VpcConfigInput::Jsonize() const {
  JsonValue payload;
