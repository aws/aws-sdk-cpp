...
namespace Synthetics
{
   ...
   */
  class AWS_SYNTHETICS_API SyntheticsClient : Aws::Client::ClientWithAsyncTemplateMethods<SyntheticsClient>,
    smithy::client::AwsSmithyClientT<Aws::Synthetics::SERVICE_NAME,
