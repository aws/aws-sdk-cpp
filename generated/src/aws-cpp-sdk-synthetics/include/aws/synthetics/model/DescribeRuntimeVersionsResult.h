...
class DescribeRuntimeVersionsResult {
 public:
  ...
  void SetRuntimeVersions(RuntimeVersionsT&& value) {
    m_runtimeVersionsHasBeenSet = true;
    m_runtimeVersions = std::forward<RuntimeVersionsT>(value);
  }
  template <typename RuntimeVersionsT = Aws::Vector<RuntimeVersion>>
  DescribeRuntimeVersionsResult& WithRuntimeVersions(RuntimeVersionsT&& value) {
    SetRuntimeVersions(std::forward<RuntimeVersionsT>(value));
    return *this;
  }
  template <typename RuntimeVersionsT = RuntimeVersion>
  DescribeRuntimeVersionsResult& AddRuntimeVersions(RuntimeVersionsT&& value) {
    m_runtimeVersionsHasBeenSet = true;
    m_runtimeVersions.emplace_back(std::forward<RuntimeVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRuntimeVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRuntimeVersionsResult& WithRequestId(RequestIdT&& value) {
