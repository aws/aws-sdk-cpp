...
class ListAssociatedGroupsRequest : public SyntheticsRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociatedGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssociatedGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceArnT = Aws::String>
  ListAssociatedGroupsRequest& WithResourceArn(ResourceArnT&& value) {
