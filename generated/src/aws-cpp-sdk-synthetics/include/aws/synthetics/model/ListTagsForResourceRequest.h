...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public SyntheticsRequest
  {
  public:
    AWS_SYNTHETICS_API ListTagsForResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The ARN of the canary or group that you want to view tags for.</p> <p>The ARN
