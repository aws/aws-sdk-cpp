...
class CanaryRunConfigOutput {
 public:
  ...
  inline CanaryRunConfigOutput& WithTimeoutInSeconds(int value) {
  ...
  inline CanaryRunConfigOutput& WithMemoryInMB(int value) {
    SetMemoryInMB(value);
    return *this;
  }
  ///@}
  ...
  inline CanaryRunConfigOutput& WithActiveTracing(bool value) {
  ...
  inline CanaryRunConfigOutput& WithEphemeralStorage(int value) {
