...
class CanaryRunConfigInput {
 public:
  ...
  inline CanaryRunConfigInput& WithTimeoutInSeconds(int value) {
  ...
  inline void SetMemoryInMB(int value) {
    m_memoryInMBHasBeenSet = true;
    m_memoryInMB = value;
  }
  inline CanaryRunConfigInput& WithMemoryInMB(int value) {
    SetMemoryInMB(value);
    return *this;
  }
  ///@}
  ...
  inline void SetActiveTracing(bool value) {
    m_activeTracingHasBeenSet = true;
    m_activeTracing = value;
  }
  inline CanaryRunConfigInput& WithActiveTracing(bool value) {
    SetActiveTracing(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEphemeralStorage(int value) {
    m_ephemeralStorageHasBeenSet = true;
    m_ephemeralStorage = value;
  }
  inline CanaryRunConfigInput& WithEphemeralStorage(int value) {
    SetEphemeralStorage(value);
    return *this;
  }
  ///@}
 private:
