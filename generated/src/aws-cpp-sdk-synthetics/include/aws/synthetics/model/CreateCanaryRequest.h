...
class CreateCanaryRequest : public SyntheticsRequest {
 public:
  ...
  inline CreateCanaryRequest& WithSuccessRetentionPeriodInDays(int value) {
  ...
  inline CreateCanaryRequest& WithFailureRetentionPeriodInDays(int value) {
  ...
  void SetResourcesToReplicateTags(ResourcesToReplicateTagsT&& value) {
    m_resourcesToReplicateTagsHasBeenSet = true;
    m_resourcesToReplicateTags = std::forward<ResourcesToReplicateTagsT>(value);
  }
  template <typename ResourcesToReplicateTagsT = Aws::Vector<ResourceToTag>>
  CreateCanaryRequest& WithResourcesToReplicateTags(ResourcesToReplicateTagsT&& value) {
    SetResourcesToReplicateTags(std::forward<ResourcesToReplicateTagsT>(value));
    return *this;
  }
  inline CreateCanaryRequest& AddResourcesToReplicateTags(ResourceToTag value) {
    m_resourcesToReplicateTagsHasBeenSet = true;
    m_resourcesToReplicateTags.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline CreateCanaryRequest& WithProvisionedResourceCleanup(ProvisionedResourceCleanupSetting value) {
