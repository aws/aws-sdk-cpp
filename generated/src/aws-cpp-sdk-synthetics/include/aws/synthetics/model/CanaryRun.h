...
class CanaryRun {
 public:
  ...
  void SetScheduledRunId(ScheduledRunIdT&& value) {
    ...
    m_scheduledRunId = std::forward<ScheduledRunIdT>(value);
  }
  template <typename ScheduledRunIdT = Aws::String>
  CanaryRun& WithScheduledRunId(ScheduledRunIdT&& value) {
    SetScheduledRunId(std::forward<ScheduledRunIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline CanaryRun& WithRetryAttempt(int value) {
  ...
  inline CanaryRun& WithBrowserType(BrowserType value) {
