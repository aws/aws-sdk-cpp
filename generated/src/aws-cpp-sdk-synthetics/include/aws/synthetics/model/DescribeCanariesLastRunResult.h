...
class DescribeCanariesLastRunResult {
 public:
  ...
  void SetCanariesLastRun(CanariesLastRunT&& value) {
    m_canariesLastRunHasBeenSet = true;
    m_canariesLastRun = std::forward<CanariesLastRunT>(value);
  }
  template <typename CanariesLastRunT = Aws::Vector<CanaryLastRun>>
  DescribeCanariesLastRunResult& WithCanariesLastRun(CanariesLastRunT&& value) {
    SetCanariesLastRun(std::forward<CanariesLastRunT>(value));
    return *this;
  }
  template <typename CanariesLastRunT = CanaryLastRun>
  DescribeCanariesLastRunResult& AddCanariesLastRun(CanariesLastRunT&& value) {
    m_canariesLastRunHasBeenSet = true;
    m_canariesLastRun.emplace_back(std::forward<CanariesLastRunT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCanariesLastRunResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCanariesLastRunResult& WithRequestId(RequestIdT&& value) {
