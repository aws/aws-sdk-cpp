...
class DeleteCanaryRequest : public SyntheticsRequest {
 public:
  ...
  inline void SetDeleteLambda(bool value) {
    m_deleteLambdaHasBeenSet = true;
    m_deleteLambda = value;
  }
  inline DeleteCanaryRequest& WithDeleteLambda(bool value) {
    SetDeleteLambda(value);
    return *this;
  }
  ///@}
 private:
