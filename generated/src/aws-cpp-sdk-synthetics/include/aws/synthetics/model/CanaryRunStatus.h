...
class CanaryRunStatus {
 public:
  ...
  inline void SetState(CanaryRunState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline CanaryRunStatus& WithState(CanaryRunState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStateReasonCode(CanaryRunStateReasonCode value) {
    m_stateReasonCodeHasBeenSet = true;
    m_stateReasonCode = value;
  }
  inline CanaryRunStatus& WithStateReasonCode(CanaryRunStateReasonCode value) {
  ...
  inline void SetTestResult(CanaryRunTestResult value) {
    m_testResultHasBeenSet = true;
    m_testResult = value;
  }
  inline CanaryRunStatus& WithTestResult(CanaryRunTestResult value) {
    SetTestResult(value);
    return *this;
  }
  ///@}
