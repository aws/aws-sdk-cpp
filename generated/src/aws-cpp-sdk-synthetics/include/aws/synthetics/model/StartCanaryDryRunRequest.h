...
class StartCanaryDryRunRequest : public SyntheticsRequest {
 public:
  ...
  inline StartCanaryDryRunRequest& WithSuccessRetentionPeriodInDays(int value) {
  ...
  inline StartCanaryDryRunRequest& WithFailureRetentionPeriodInDays(int value) {
  ...
  inline StartCanaryDryRunRequest& WithProvisionedResourceCleanup(ProvisionedResourceCleanupSetting value) {
