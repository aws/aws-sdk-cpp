...
class ListAssociatedGroupsResult {
 public:
  AWS_SYNTHETICS_API ListAssociatedGroupsResult() = default;
  ...
  template <typename GroupsT = Aws::Vector<GroupSummary>>
  ListAssociatedGroupsResult& WithGroups(GroupsT&& value) {
    SetGroups(std::forward<GroupsT>(value));
    return *this;
  }
  template <typename GroupsT = GroupSummary>
  ListAssociatedGroupsResult& AddGroups(GroupsT&& value) {
    m_groupsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociatedGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssociatedGroupsResult& WithRequestId(RequestIdT&& value) {
