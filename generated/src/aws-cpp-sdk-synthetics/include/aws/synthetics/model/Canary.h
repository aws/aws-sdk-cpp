...
class Canary {
 public:
  ...
  void SetRunConfig(RunConfigT&& value) {
    ...
    m_runConfig = std::forward<RunConfigT>(value);
  }
  template <typename RunConfigT = CanaryRunConfigOutput>
  Canary& WithRunConfig(RunConfigT&& value) {
    SetRunConfig(std::forward<RunConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSuccessRetentionPeriodInDays(int value) {
    m_successRetentionPeriodInDaysHasBeenSet = true;
    m_successRetentionPeriodInDays = value;
  }
  inline Canary& WithSuccessRetentionPeriodInDays(int value) {
    SetSuccessRetentionPeriodInDays(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailureRetentionPeriodInDays(int value) {
    m_failureRetentionPeriodInDaysHasBeenSet = true;
    m_failureRetentionPeriodInDays = value;
  }
  inline Canary& WithFailureRetentionPeriodInDays(int value) {
    SetFailureRetentionPeriodInDays(value);
    return *this;
  }
  ///@}
  ...
  void SetTimeline(TimelineT&& value) {
    ...
    m_timeline = std::forward<TimelineT>(value);
  }
  template <typename TimelineT = CanaryTimeline>
  Canary& WithTimeline(TimelineT&& value) {
    SetTimeline(std::forward<TimelineT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArtifactS3Location(ArtifactS3LocationT&& value) {
    ...
    m_artifactS3Location = std::forward<ArtifactS3LocationT>(value);
  }
  template <typename ArtifactS3LocationT = Aws::String>
  Canary& WithArtifactS3Location(ArtifactS3LocationT&& value) {
    SetArtifactS3Location(std::forward<ArtifactS3LocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEngineArn(EngineArnT&& value) {
    ...
    m_engineArn = std::forward<EngineArnT>(value);
  }
  template <typename EngineArnT = Aws::String>
  Canary& WithEngineArn(EngineArnT&& value) {
    SetEngineArn(std::forward<EngineArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRuntimeVersion(RuntimeVersionT&& value) {
    ...
    m_runtimeVersion = std::forward<RuntimeVersionT>(value);
  }
  template <typename RuntimeVersionT = Aws::String>
  Canary& WithRuntimeVersion(RuntimeVersionT&& value) {
    SetRuntimeVersion(std::forward<RuntimeVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVisualReference(VisualReferenceT&& value) {
    ...
    m_visualReference = std::forward<VisualReferenceT>(value);
  }
  template <typename VisualReferenceT = VisualReferenceOutput>
  Canary& WithVisualReference(VisualReferenceT&& value) {
    SetVisualReference(std::forward<VisualReferenceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProvisionedResourceCleanup(ProvisionedResourceCleanupSetting value) {
    m_provisionedResourceCleanupHasBeenSet = true;
    m_provisionedResourceCleanup = value;
  }
  inline Canary& WithProvisionedResourceCleanup(ProvisionedResourceCleanupSetting value) {
    SetProvisionedResourceCleanup(value);
    return *this;
  }
  ///@}
  ...
  void SetBrowserConfigs(BrowserConfigsT&& value) {
    ...
    m_browserConfigs = std::forward<BrowserConfigsT>(value);
  }
  template <typename BrowserConfigsT = Aws::Vector<BrowserConfig>>
  Canary& WithBrowserConfigs(BrowserConfigsT&& value) {
    SetBrowserConfigs(std::forward<BrowserConfigsT>(value));
    return *this;
  }
  template <typename BrowserConfigsT = BrowserConfig>
  Canary& AddBrowserConfigs(BrowserConfigsT&& value) {
    m_browserConfigsHasBeenSet = true;
    m_browserConfigs.emplace_back(std::forward<BrowserConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEngineConfigs(EngineConfigsT&& value) {
    ...
    m_engineConfigs = std::forward<EngineConfigsT>(value);
  }
  template <typename EngineConfigsT = Aws::Vector<EngineConfig>>
  Canary& WithEngineConfigs(EngineConfigsT&& value) {
    SetEngineConfigs(std::forward<EngineConfigsT>(value));
    return *this;
  }
  template <typename EngineConfigsT = EngineConfig>
  Canary& AddEngineConfigs(EngineConfigsT&& value) {
    m_engineConfigsHasBeenSet = true;
    m_engineConfigs.emplace_back(std::forward<EngineConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVisualReferences(VisualReferencesT&& value) {
    ...
    m_visualReferences = std::forward<VisualReferencesT>(value);
  }
  template <typename VisualReferencesT = Aws::Vector<VisualReferenceOutput>>
  Canary& WithVisualReferences(VisualReferencesT&& value) {
    SetVisualReferences(std::forward<VisualReferencesT>(value));
    return *this;
  }
  template <typename VisualReferencesT = VisualReferenceOutput>
  Canary& AddVisualReferences(VisualReferencesT&& value) {
    m_visualReferencesHasBeenSet = true;
    m_visualReferences.emplace_back(std::forward<VisualReferencesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArtifactConfig(ArtifactConfigT&& value) {
    ...
    m_artifactConfig = std::forward<ArtifactConfigT>(value);
  }
  template <typename ArtifactConfigT = ArtifactConfigOutput>
  Canary& WithArtifactConfig(ArtifactConfigT&& value) {
    SetArtifactConfig(std::forward<ArtifactConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDryRunConfig(DryRunConfigT&& value) {
    ...
    m_dryRunConfig = std::forward<DryRunConfigT>(value);
  }
  template <typename DryRunConfigT = DryRunConfigOutput>
  Canary& WithDryRunConfig(DryRunConfigT&& value) {
    SetDryRunConfig(std::forward<DryRunConfigT>(value));
    return *this;
  }
  ///@}
 private:
