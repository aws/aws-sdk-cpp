...
class BaseScreenshot {
 public:
  ...
  void SetScreenshotName(ScreenshotNameT&& value) {
    ...
    m_screenshotName = std::forward<ScreenshotNameT>(value);
  }
  template <typename ScreenshotNameT = Aws::String>
  BaseScreenshot& WithScreenshotName(ScreenshotNameT&& value) {
    SetScreenshotName(std::forward<ScreenshotNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIgnoreCoordinates(IgnoreCoordinatesT&& value) {
    ...
    m_ignoreCoordinates = std::forward<IgnoreCoordinatesT>(value);
  }
  template <typename IgnoreCoordinatesT = Aws::Vector<Aws::String>>
  BaseScreenshot& WithIgnoreCoordinates(IgnoreCoordinatesT&& value) {
    SetIgnoreCoordinates(std::forward<IgnoreCoordinatesT>(value));
    return *this;
  }
  template <typename IgnoreCoordinatesT = Aws::String>
  BaseScreenshot& AddIgnoreCoordinates(IgnoreCoordinatesT&& value) {
    m_ignoreCoordinatesHasBeenSet = true;
    m_ignoreCoordinates.emplace_back(std::forward<IgnoreCoordinatesT>(value));
    return *this;
  }
  ///@}
 private:
