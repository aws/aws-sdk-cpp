...
namespace Model
{
  ...
  public:
    ...
    template<typename GroupIdentifierT = Aws::String>
    AssociateResourceRequest& WithGroupIdentifier(GroupIdentifierT&& value) { SetGroupIdentifier(std::forward<GroupIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceArnT = Aws::String>
    AssociateResourceRequest& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
  private:
