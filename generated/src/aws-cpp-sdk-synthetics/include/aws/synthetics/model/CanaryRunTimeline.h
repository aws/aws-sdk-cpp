...
class CanaryRunTimeline {
 public:
  ...
  void SetMetricTimestampForRunAndRetries(MetricTimestampForRunAndRetriesT&& value) {
    ...
    m_metricTimestampForRunAndRetries = std::forward<MetricTimestampForRunAndRetriesT>(value);
  }
  template <typename MetricTimestampForRunAndRetriesT = Aws::Utils::DateTime>
  CanaryRunTimeline& WithMetricTimestampForRunAndRetries(MetricTimestampForRunAndRetriesT&& value) {
    SetMetricTimestampForRunAndRetries(std::forward<MetricTimestampForRunAndRetriesT>(value));
    return *this;
  }
  ///@}
 private:
