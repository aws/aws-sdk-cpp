...
class CanaryTimeline {
 public:
  ...
  void SetLastStarted(LastStartedT&& value) {
    ...
    m_lastStarted = std::forward<LastStartedT>(value);
  }
  template <typename LastStartedT = Aws::Utils::DateTime>
  CanaryTimeline& WithLastStarted(LastStartedT&& value) {
    SetLastStarted(std::forward<LastStartedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastStopped(LastStoppedT&& value) {
    ...
    m_lastStopped = std::forward<LastStoppedT>(value);
  }
  template <typename LastStoppedT = Aws::Utils::DateTime>
  CanaryTimeline& WithLastStopped(LastStoppedT&& value) {
    SetLastStopped(std::forward<LastStoppedT>(value));
    return *this;
  }
  ///@}
 private:
