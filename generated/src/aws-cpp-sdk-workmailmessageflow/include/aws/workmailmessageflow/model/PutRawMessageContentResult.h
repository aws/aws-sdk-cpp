...
namespace Model
{
  ...
  public:
    ...
    inline PutRawMessageContentResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutRawMessageContentResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutRawMessageContentResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
