...
namespace WorkMailMessageFlow
{
   ...
   */
  class AWS_WORKMAILMESSAGEFLOW_API WorkMailMessageFlowClient : smithy::client::AwsSmithyClientT<Aws::WorkMailMessageFlow::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<WorkMailMessageFlowClient>
  {
    public:
      ...
      typedef WorkMailMessageFlowEndpointProvider EndpointProviderType;
        ...
        */
         ...
         */
        template<typename GetRawMessageContentRequestT = Model::GetRawMessageContentRequest>
        void GetRawMessageContentAsync(const GetRawMessageContentRequestT& request, const GetRawMessageContentResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
         ...
         */
        template<typename PutRawMessageContentRequestT = Model::PutRawMessageContentRequest>
        void PutRawMessageContentAsync(const PutRawMessageContentRequestT& request, const PutRawMessageContentResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
