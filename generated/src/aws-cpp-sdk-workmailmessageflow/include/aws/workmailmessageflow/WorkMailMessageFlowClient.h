...
class AWS_WORKMAILMESSAGEFLOW_API WorkMailMessageFlowClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  WorkMailMessageFlowClient(const Aws::WorkMailMessageFlow::WorkMailMessageFlowClientConfiguration& clientConfiguration =
  ...
  WorkMailMessageFlowClient(const Aws::Auth::AWSCredentials& credentials,
                            std::shared_ptr<WorkMailMessageFlowEndpointProviderBase> endpointProvider = nullptr,
                            const Aws::WorkMailMessageFlow::WorkMailMessageFlowClientConfiguration& clientConfiguration =
                                Aws::WorkMailMessageFlow::WorkMailMessageFlowClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  WorkMailMessageFlowClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for GetRawMessageContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetRawMessageContentRequestT = Model::GetRawMessageContentRequest>
  Model::GetRawMessageContentOutcomeCallable GetRawMessageContentCallable(const GetRawMessageContentRequestT& request) const {
    return SubmitCallable(&WorkMailMessageFlowClient::GetRawMessageContent, request);
  }

  /**
   * An Async wrapper for GetRawMessageContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRawMessageContentRequestT = Model::GetRawMessageContentRequest>
  void GetRawMessageContentAsync(const GetRawMessageContentRequestT& request, const GetRawMessageContentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WorkMailMessageFlowClient::GetRawMessageContent, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for PutRawMessageContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename PutRawMessageContentRequestT = Model::PutRawMessageContentRequest>
  Model::PutRawMessageContentOutcomeCallable PutRawMessageContentCallable(const PutRawMessageContentRequestT& request) const {
    return SubmitCallable(&WorkMailMessageFlowClient::PutRawMessageContent, request);
  }

  /**
   * An Async wrapper for PutRawMessageContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRawMessageContentRequestT = Model::PutRawMessageContentRequest>
  void PutRawMessageContentAsync(const PutRawMessageContentRequestT& request, const PutRawMessageContentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WorkMailMessageFlowClient::PutRawMessageContent, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<WorkMailMessageFlowEndpointProviderBase>& accessEndpointProvider();
