...
LookupDeveloperIdentityResult::LookupDeveloperIdentityResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
LookupDeveloperIdentityResult& LookupDeveloperIdentityResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("DeveloperUserIdentifierList")) {
    ...
    for (unsigned developerUserIdentifierListIndex = 0; developerUserIdentifierListIndex < developerUserIdentifierListJsonList.GetLength();
         ++developerUserIdentifierListIndex) {
