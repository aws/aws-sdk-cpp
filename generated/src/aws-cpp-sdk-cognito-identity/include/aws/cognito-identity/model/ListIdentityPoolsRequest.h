...
class ListIdentityPoolsRequest : public CognitoIdentityRequest {
 public:
  AWS_COGNITOIDENTITY_API ListIdentityPoolsRequest() = default;
  ...
  inline ListIdentityPoolsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIdentityPoolsRequest& WithNextToken(NextTokenT&& value) {
