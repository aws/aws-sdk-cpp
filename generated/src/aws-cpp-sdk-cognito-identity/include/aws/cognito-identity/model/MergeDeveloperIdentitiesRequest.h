...
class MergeDeveloperIdentitiesRequest : public CognitoIdentityRequest {
 public:
  ...
  void SetSourceUserIdentifier(SourceUserIdentifierT&& value) {
    m_sourceUserIdentifierHasBeenSet = true;
    m_sourceUserIdentifier = std::forward<SourceUserIdentifierT>(value);
  }
  template <typename SourceUserIdentifierT = Aws::String>
  MergeDeveloperIdentitiesRequest& WithSourceUserIdentifier(SourceUserIdentifierT&& value) {
    SetSourceUserIdentifier(std::forward<SourceUserIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationUserIdentifier(DestinationUserIdentifierT&& value) {
    m_destinationUserIdentifierHasBeenSet = true;
    m_destinationUserIdentifier = std::forward<DestinationUserIdentifierT>(value);
  }
  template <typename DestinationUserIdentifierT = Aws::String>
  MergeDeveloperIdentitiesRequest& WithDestinationUserIdentifier(DestinationUserIdentifierT&& value) {
    SetDestinationUserIdentifier(std::forward<DestinationUserIdentifierT>(value));
    return *this;
  }
  ///@}
