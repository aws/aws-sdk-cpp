...
class ListIdentitiesRequest : public CognitoIdentityRequest {
 public:
  ...
  inline ListIdentitiesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHideDisabled(bool value) {
    m_hideDisabledHasBeenSet = true;
    m_hideDisabled = value;
  }
  inline ListIdentitiesRequest& WithHideDisabled(bool value) {
