...
class GetOpenIdTokenForDeveloperIdentityResult {
 public:
  ...
  AWS_COGNITOIDENTITY_API GetOpenIdTokenForDeveloperIdentityResult& operator=(
  ...
  template <typename IdentityIdT = Aws::String>
  GetOpenIdTokenForDeveloperIdentityResult& WithIdentityId(IdentityIdT&& value) {
  ...
  template <typename TokenT = Aws::String>
  GetOpenIdTokenForDeveloperIdentityResult& WithToken(TokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOpenIdTokenForDeveloperIdentityResult& WithRequestId(RequestIdT&& value) {
