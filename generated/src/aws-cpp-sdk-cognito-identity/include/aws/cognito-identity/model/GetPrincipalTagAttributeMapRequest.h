...
class GetPrincipalTagAttributeMapRequest : public CognitoIdentityRequest {
 public:
  ...
  template <typename IdentityPoolIdT = Aws::String>
  GetPrincipalTagAttributeMapRequest& WithIdentityPoolId(IdentityPoolIdT&& value) {
  ...
  template <typename IdentityProviderNameT = Aws::String>
  GetPrincipalTagAttributeMapRequest& WithIdentityProviderName(IdentityProviderNameT&& value) {
