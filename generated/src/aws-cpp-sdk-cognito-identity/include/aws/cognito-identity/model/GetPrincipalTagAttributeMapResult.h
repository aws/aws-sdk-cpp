...
class GetPrincipalTagAttributeMapResult {
 public:
  ...
  AWS_COGNITOIDENTITY_API GetPrincipalTagAttributeMapResult& operator=(
  ...
  template <typename IdentityPoolIdT = Aws::String>
  GetPrincipalTagAttributeMapResult& WithIdentityPoolId(IdentityPoolIdT&& value) {
  ...
  template <typename IdentityProviderNameT = Aws::String>
  GetPrincipalTagAttributeMapResult& WithIdentityProviderName(IdentityProviderNameT&& value) {
  ...
  inline GetPrincipalTagAttributeMapResult& WithUseDefaults(bool value) {
  ...
  template <typename PrincipalTagsT = Aws::Map<Aws::String, Aws::String>>
  GetPrincipalTagAttributeMapResult& WithPrincipalTags(PrincipalTagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPrincipalTagAttributeMapResult& WithRequestId(RequestIdT&& value) {
