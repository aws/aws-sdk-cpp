...
class UnlinkDeveloperIdentityRequest : public CognitoIdentityRequest {
 public:
  ...
  template <typename IdentityIdT = Aws::String>
  UnlinkDeveloperIdentityRequest& WithIdentityId(IdentityIdT&& value) {
  ...
  template <typename IdentityPoolIdT = Aws::String>
  UnlinkDeveloperIdentityRequest& WithIdentityPoolId(IdentityPoolIdT&& value) {
  ...
  template <typename DeveloperProviderNameT = Aws::String>
  UnlinkDeveloperIdentityRequest& WithDeveloperProviderName(DeveloperProviderNameT&& value) {
  ...
  void SetDeveloperUserIdentifier(DeveloperUserIdentifierT&& value) {
    m_developerUserIdentifierHasBeenSet = true;
    m_developerUserIdentifier = std::forward<DeveloperUserIdentifierT>(value);
  }
  template <typename DeveloperUserIdentifierT = Aws::String>
  UnlinkDeveloperIdentityRequest& WithDeveloperUserIdentifier(DeveloperUserIdentifierT&& value) {
    SetDeveloperUserIdentifier(std::forward<DeveloperUserIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
