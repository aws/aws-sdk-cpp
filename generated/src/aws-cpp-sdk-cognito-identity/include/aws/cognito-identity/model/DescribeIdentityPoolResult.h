...
class DescribeIdentityPoolResult {
 public:
  AWS_COGNITOIDENTITY_API DescribeIdentityPoolResult() = default;
  ...
  template <typename IdentityPoolIdT = Aws::String>
  DescribeIdentityPoolResult& WithIdentityPoolId(IdentityPoolIdT&& value) {
  ...
  template <typename IdentityPoolNameT = Aws::String>
  DescribeIdentityPoolResult& WithIdentityPoolName(IdentityPoolNameT&& value) {
  ...
  inline void SetAllowUnauthenticatedIdentities(bool value) {
    m_allowUnauthenticatedIdentitiesHasBeenSet = true;
    m_allowUnauthenticatedIdentities = value;
  }
  inline DescribeIdentityPoolResult& WithAllowUnauthenticatedIdentities(bool value) {
    SetAllowUnauthenticatedIdentities(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllowClassicFlow(bool value) {
    m_allowClassicFlowHasBeenSet = true;
    m_allowClassicFlow = value;
  }
  inline DescribeIdentityPoolResult& WithAllowClassicFlow(bool value) {
    SetAllowClassicFlow(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedLoginProviders(SupportedLoginProvidersT&& value) {
    ...
    m_supportedLoginProviders = std::forward<SupportedLoginProvidersT>(value);
  }
  template <typename SupportedLoginProvidersT = Aws::Map<Aws::String, Aws::String>>
  DescribeIdentityPoolResult& WithSupportedLoginProviders(SupportedLoginProvidersT&& value) {
    SetSupportedLoginProviders(std::forward<SupportedLoginProvidersT>(value));
    return *this;
  }
  template <typename SupportedLoginProvidersKeyT = Aws::String, typename SupportedLoginProvidersValueT = Aws::String>
  DescribeIdentityPoolResult& AddSupportedLoginProviders(SupportedLoginProvidersKeyT&& key, SupportedLoginProvidersValueT&& value) {
    m_supportedLoginProvidersHasBeenSet = true;
    m_supportedLoginProviders.emplace(std::forward<SupportedLoginProvidersKeyT>(key), std::forward<SupportedLoginProvidersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeveloperProviderName(DeveloperProviderNameT&& value) {
    ...
    m_developerProviderName = std::forward<DeveloperProviderNameT>(value);
  }
  template <typename DeveloperProviderNameT = Aws::String>
  DescribeIdentityPoolResult& WithDeveloperProviderName(DeveloperProviderNameT&& value) {
    SetDeveloperProviderName(std::forward<DeveloperProviderNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOpenIdConnectProviderARNs(OpenIdConnectProviderARNsT&& value) {
    ...
    m_openIdConnectProviderARNs = std::forward<OpenIdConnectProviderARNsT>(value);
  }
  template <typename OpenIdConnectProviderARNsT = Aws::Vector<Aws::String>>
  DescribeIdentityPoolResult& WithOpenIdConnectProviderARNs(OpenIdConnectProviderARNsT&& value) {
    SetOpenIdConnectProviderARNs(std::forward<OpenIdConnectProviderARNsT>(value));
    return *this;
  }
  template <typename OpenIdConnectProviderARNsT = Aws::String>
  DescribeIdentityPoolResult& AddOpenIdConnectProviderARNs(OpenIdConnectProviderARNsT&& value) {
    m_openIdConnectProviderARNsHasBeenSet = true;
    m_openIdConnectProviderARNs.emplace_back(std::forward<OpenIdConnectProviderARNsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCognitoIdentityProviders(CognitoIdentityProvidersT&& value) {
    ...
    m_cognitoIdentityProviders = std::forward<CognitoIdentityProvidersT>(value);
  }
  template <typename CognitoIdentityProvidersT = Aws::Vector<CognitoIdentityProvider>>
  DescribeIdentityPoolResult& WithCognitoIdentityProviders(CognitoIdentityProvidersT&& value) {
    SetCognitoIdentityProviders(std::forward<CognitoIdentityProvidersT>(value));
    return *this;
  }
  template <typename CognitoIdentityProvidersT = CognitoIdentityProvider>
  DescribeIdentityPoolResult& AddCognitoIdentityProviders(CognitoIdentityProvidersT&& value) {
    m_cognitoIdentityProvidersHasBeenSet = true;
    m_cognitoIdentityProviders.emplace_back(std::forward<CognitoIdentityProvidersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSamlProviderARNs(SamlProviderARNsT&& value) {
    ...
    m_samlProviderARNs = std::forward<SamlProviderARNsT>(value);
  }
  template <typename SamlProviderARNsT = Aws::Vector<Aws::String>>
  DescribeIdentityPoolResult& WithSamlProviderARNs(SamlProviderARNsT&& value) {
    SetSamlProviderARNs(std::forward<SamlProviderARNsT>(value));
    return *this;
  }
  template <typename SamlProviderARNsT = Aws::String>
  DescribeIdentityPoolResult& AddSamlProviderARNs(SamlProviderARNsT&& value) {
    m_samlProviderARNsHasBeenSet = true;
    m_samlProviderARNs.emplace_back(std::forward<SamlProviderARNsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdentityPoolTags(IdentityPoolTagsT&& value) {
    ...
    m_identityPoolTags = std::forward<IdentityPoolTagsT>(value);
  }
  template <typename IdentityPoolTagsT = Aws::Map<Aws::String, Aws::String>>
  DescribeIdentityPoolResult& WithIdentityPoolTags(IdentityPoolTagsT&& value) {
    SetIdentityPoolTags(std::forward<IdentityPoolTagsT>(value));
    return *this;
  }
  template <typename IdentityPoolTagsKeyT = Aws::String, typename IdentityPoolTagsValueT = Aws::String>
  DescribeIdentityPoolResult& AddIdentityPoolTags(IdentityPoolTagsKeyT&& key, IdentityPoolTagsValueT&& value) {
    m_identityPoolTagsHasBeenSet = true;
    m_identityPoolTags.emplace(std::forward<IdentityPoolTagsKeyT>(key), std::forward<IdentityPoolTagsValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeIdentityPoolResult& WithRequestId(RequestIdT&& value) {
