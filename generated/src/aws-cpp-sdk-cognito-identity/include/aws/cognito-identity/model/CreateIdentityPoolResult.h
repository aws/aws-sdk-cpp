...
namespace Model
{
  ...
  public:
    ...
    template<typename IdentityPoolIdT = Aws::String>
    CreateIdentityPoolResult& WithIdentityPoolId(IdentityPoolIdT&& value) { SetIdentityPoolId(std::forward<IdentityPoolIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentityPoolNameT = Aws::String>
    CreateIdentityPoolResult& WithIdentityPoolName(IdentityPoolNameT&& value) { SetIdentityPoolName(std::forward<IdentityPoolNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SupportedLoginProvidersT = Aws::Map<Aws::String, Aws::String>>
    CreateIdentityPoolResult& WithSupportedLoginProviders(SupportedLoginProvidersT&& value) { SetSupportedLoginProviders(std::forward<SupportedLoginProvidersT>(value)); return *this;}
    ...
    template<typename DeveloperProviderNameT = Aws::String>
    CreateIdentityPoolResult& WithDeveloperProviderName(DeveloperProviderNameT&& value) { SetDeveloperProviderName(std::forward<DeveloperProviderNameT>(value)); return *this;}
    ///@}
    ...
    template<typename OpenIdConnectProviderARNsT = Aws::Vector<Aws::String>>
    CreateIdentityPoolResult& WithOpenIdConnectProviderARNs(OpenIdConnectProviderARNsT&& value) { SetOpenIdConnectProviderARNs(std::forward<OpenIdConnectProviderARNsT>(value)); return *this;}
    template<typename OpenIdConnectProviderARNsT = Aws::String>
    CreateIdentityPoolResult& AddOpenIdConnectProviderARNs(OpenIdConnectProviderARNsT&& value) { m_openIdConnectProviderARNsHasBeenSet = true; m_openIdConnectProviderARNs.emplace_back(std::forward<OpenIdConnectProviderARNsT>(value)); return *this; }
    ///@}
    ...
    template<typename CognitoIdentityProvidersT = Aws::Vector<CognitoIdentityProvider>>
    CreateIdentityPoolResult& WithCognitoIdentityProviders(CognitoIdentityProvidersT&& value) { SetCognitoIdentityProviders(std::forward<CognitoIdentityProvidersT>(value)); return *this;}
    template<typename CognitoIdentityProvidersT = CognitoIdentityProvider>
    CreateIdentityPoolResult& AddCognitoIdentityProviders(CognitoIdentityProvidersT&& value) { m_cognitoIdentityProvidersHasBeenSet = true; m_cognitoIdentityProviders.emplace_back(std::forward<CognitoIdentityProvidersT>(value)); return *this; }
    ///@}
    ...
    template<typename SamlProviderARNsT = Aws::Vector<Aws::String>>
    CreateIdentityPoolResult& WithSamlProviderARNs(SamlProviderARNsT&& value) { SetSamlProviderARNs(std::forward<SamlProviderARNsT>(value)); return *this;}
    template<typename SamlProviderARNsT = Aws::String>
    CreateIdentityPoolResult& AddSamlProviderARNs(SamlProviderARNsT&& value) { m_samlProviderARNsHasBeenSet = true; m_samlProviderARNs.emplace_back(std::forward<SamlProviderARNsT>(value)); return *this; }
    ///@}
    ...
    template<typename IdentityPoolTagsT = Aws::Map<Aws::String, Aws::String>>
    CreateIdentityPoolResult& WithIdentityPoolTags(IdentityPoolTagsT&& value) { SetIdentityPoolTags(std::forward<IdentityPoolTagsT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    CreateIdentityPoolResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
