...
class ListIdentityPoolsResult {
 public:
  ...
  void SetIdentityPools(IdentityPoolsT&& value) {
    ...
    m_identityPools = std::forward<IdentityPoolsT>(value);
  }
  template <typename IdentityPoolsT = Aws::Vector<IdentityPoolShortDescription>>
  ListIdentityPoolsResult& WithIdentityPools(IdentityPoolsT&& value) {
    SetIdentityPools(std::forward<IdentityPoolsT>(value));
    return *this;
  }
  ...
  ListIdentityPoolsResult& AddIdentityPools(IdentityPoolsT&& value) {
    m_identityPoolsHasBeenSet = true;
    m_identityPools.emplace_back(std::forward<IdentityPoolsT>(value));
    return *this;
  }
  ///@}
