...
class LookupDeveloperIdentityResult {
 public:
  ...
  void SetDeveloperUserIdentifierList(DeveloperUserIdentifierListT&& value) {
    ...
    m_developerUserIdentifierList = std::forward<DeveloperUserIdentifierListT>(value);
  }
  template <typename DeveloperUserIdentifierListT = Aws::Vector<Aws::String>>
  LookupDeveloperIdentityResult& WithDeveloperUserIdentifierList(DeveloperUserIdentifierListT&& value) {
    SetDeveloperUserIdentifierList(std::forward<DeveloperUserIdentifierListT>(value));
    return *this;
  }
  ...
  LookupDeveloperIdentityResult& AddDeveloperUserIdentifierList(DeveloperUserIdentifierListT&& value) {
    m_developerUserIdentifierListHasBeenSet = true;
    m_developerUserIdentifierList.emplace_back(std::forward<DeveloperUserIdentifierListT>(value));
    return *this;
  }
  ///@}
