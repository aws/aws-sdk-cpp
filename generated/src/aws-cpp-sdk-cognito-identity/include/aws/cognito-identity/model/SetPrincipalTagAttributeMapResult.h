...
class SetPrincipalTagAttributeMapResult {
 public:
  ...
  AWS_COGNITOIDENTITY_API SetPrincipalTagAttributeMapResult& operator=(
  ...
  template <typename IdentityPoolIdT = Aws::String>
  SetPrincipalTagAttributeMapResult& WithIdentityPoolId(IdentityPoolIdT&& value) {
  ...
  template <typename IdentityProviderNameT = Aws::String>
  SetPrincipalTagAttributeMapResult& WithIdentityProviderName(IdentityProviderNameT&& value) {
  ...
  inline void SetUseDefaults(bool value) {
    m_useDefaultsHasBeenSet = true;
    m_useDefaults = value;
  }
  inline SetPrincipalTagAttributeMapResult& WithUseDefaults(bool value) {
  ...
  template <typename PrincipalTagsT = Aws::Map<Aws::String, Aws::String>>
  SetPrincipalTagAttributeMapResult& WithPrincipalTags(PrincipalTagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SetPrincipalTagAttributeMapResult& WithRequestId(RequestIdT&& value) {
