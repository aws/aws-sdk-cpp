...
class AWS_COGNITOIDENTITY_API CognitoIdentityClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CognitoIdentityClient(const Aws::CognitoIdentity::CognitoIdentityClientConfiguration& clientConfiguration =
                            Aws::CognitoIdentity::CognitoIdentityClientConfiguration(),
  ...
  CognitoIdentityClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<CognitoIdentityEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::CognitoIdentity::CognitoIdentityClientConfiguration& clientConfiguration =
                            Aws::CognitoIdentity::CognitoIdentityClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateIdentityPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateIdentityPool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateIdentityPoolRequestT = Model::CreateIdentityPoolRequest>
  void CreateIdentityPoolAsync(const CreateIdentityPoolRequestT& request, const CreateIdentityPoolResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteIdentities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteIdentities that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteIdentitiesRequestT = Model::DeleteIdentitiesRequest>
  void DeleteIdentitiesAsync(const DeleteIdentitiesRequestT& request, const DeleteIdentitiesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteIdentityPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteIdentityPool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteIdentityPoolRequestT = Model::DeleteIdentityPoolRequest>
  void DeleteIdentityPoolAsync(const DeleteIdentityPoolRequestT& request, const DeleteIdentityPoolResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeIdentity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeIdentity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeIdentityRequestT = Model::DescribeIdentityRequest>
  void DescribeIdentityAsync(const DescribeIdentityRequestT& request, const DescribeIdentityResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeIdentityPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeIdentityPool that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeIdentityPoolRequestT = Model::DescribeIdentityPoolRequest>
  void DescribeIdentityPoolAsync(const DescribeIdentityPoolRequestT& request, const DescribeIdentityPoolResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCredentialsForIdentity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetCredentialsForIdentityRequestT = Model::GetCredentialsForIdentityRequest>
  Model::GetCredentialsForIdentityOutcomeCallable GetCredentialsForIdentityCallable(
      const GetCredentialsForIdentityRequestT& request) const {
    return SubmitCallable(&CognitoIdentityClient::GetCredentialsForIdentity, request);
  }

  /**
   * An Async wrapper for GetCredentialsForIdentity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCredentialsForIdentityRequestT = Model::GetCredentialsForIdentityRequest>
  void GetCredentialsForIdentityAsync(const GetCredentialsForIdentityRequestT& request,
   ...
   */
  template <typename GetIdRequestT = Model::GetIdRequest>
  void GetIdAsync(const GetIdRequestT& request, const GetIdResponseReceivedHandler& handler,
                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetIdentityPoolRoles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIdentityPoolRoles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIdentityPoolRolesRequestT = Model::GetIdentityPoolRolesRequest>
  void GetIdentityPoolRolesAsync(const GetIdentityPoolRolesRequestT& request, const GetIdentityPoolRolesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetOpenIdToken that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOpenIdTokenRequestT = Model::GetOpenIdTokenRequest>
  void GetOpenIdTokenAsync(const GetOpenIdTokenRequestT& request, const GetOpenIdTokenResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetOpenIdTokenForDeveloperIdentityOutcome GetOpenIdTokenForDeveloperIdentity(
      const Model::GetOpenIdTokenForDeveloperIdentityRequest& request) const;

  /**
   * A Callable wrapper for GetOpenIdTokenForDeveloperIdentity that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetOpenIdTokenForDeveloperIdentityRequestT = Model::GetOpenIdTokenForDeveloperIdentityRequest>
  Model::GetOpenIdTokenForDeveloperIdentityOutcomeCallable GetOpenIdTokenForDeveloperIdentityCallable(
      const GetOpenIdTokenForDeveloperIdentityRequestT& request) const {
    return SubmitCallable(&CognitoIdentityClient::GetOpenIdTokenForDeveloperIdentity, request);
  }

  /**
   * An Async wrapper for GetOpenIdTokenForDeveloperIdentity that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetOpenIdTokenForDeveloperIdentityRequestT = Model::GetOpenIdTokenForDeveloperIdentityRequest>
  void GetOpenIdTokenForDeveloperIdentityAsync(const GetOpenIdTokenForDeveloperIdentityRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetPrincipalTagAttributeMapOutcome GetPrincipalTagAttributeMap(
      const Model::GetPrincipalTagAttributeMapRequest& request) const;

  /**
   * A Callable wrapper for GetPrincipalTagAttributeMap that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPrincipalTagAttributeMapRequestT = Model::GetPrincipalTagAttributeMapRequest>
  Model::GetPrincipalTagAttributeMapOutcomeCallable GetPrincipalTagAttributeMapCallable(
      const GetPrincipalTagAttributeMapRequestT& request) const {
    return SubmitCallable(&CognitoIdentityClient::GetPrincipalTagAttributeMap, request);
  }

  /**
   * An Async wrapper for GetPrincipalTagAttributeMap that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPrincipalTagAttributeMapRequestT = Model::GetPrincipalTagAttributeMapRequest>
  void GetPrincipalTagAttributeMapAsync(const GetPrincipalTagAttributeMapRequestT& request,
                                        const GetPrincipalTagAttributeMapResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListIdentities that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListIdentitiesRequestT = Model::ListIdentitiesRequest>
  void ListIdentitiesAsync(const ListIdentitiesRequestT& request, const ListIdentitiesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListIdentityPools that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListIdentityPools that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListIdentityPoolsRequestT = Model::ListIdentityPoolsRequest>
  void ListIdentityPoolsAsync(const ListIdentityPoolsRequestT& request, const ListIdentityPoolsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for LookupDeveloperIdentity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for LookupDeveloperIdentity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename LookupDeveloperIdentityRequestT = Model::LookupDeveloperIdentityRequest>
  void LookupDeveloperIdentityAsync(const LookupDeveloperIdentityRequestT& request,
  ...
  /**
   * A Callable wrapper for MergeDeveloperIdentities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for MergeDeveloperIdentities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename MergeDeveloperIdentitiesRequestT = Model::MergeDeveloperIdentitiesRequest>
  void MergeDeveloperIdentitiesAsync(const MergeDeveloperIdentitiesRequestT& request,
  ...
  /**
   * A Callable wrapper for SetIdentityPoolRoles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetIdentityPoolRoles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetIdentityPoolRolesRequestT = Model::SetIdentityPoolRolesRequest>
  void SetIdentityPoolRolesAsync(const SetIdentityPoolRolesRequestT& request, const SetIdentityPoolRolesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SetPrincipalTagAttributeMapOutcome SetPrincipalTagAttributeMap(
      const Model::SetPrincipalTagAttributeMapRequest& request) const;

  /**
   * A Callable wrapper for SetPrincipalTagAttributeMap that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SetPrincipalTagAttributeMapRequestT = Model::SetPrincipalTagAttributeMapRequest>
  Model::SetPrincipalTagAttributeMapOutcomeCallable SetPrincipalTagAttributeMapCallable(
      const SetPrincipalTagAttributeMapRequestT& request) const {
    return SubmitCallable(&CognitoIdentityClient::SetPrincipalTagAttributeMap, request);
  }

  /**
   * An Async wrapper for SetPrincipalTagAttributeMap that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetPrincipalTagAttributeMapRequestT = Model::SetPrincipalTagAttributeMapRequest>
  void SetPrincipalTagAttributeMapAsync(const SetPrincipalTagAttributeMapRequestT& request,
                                        const SetPrincipalTagAttributeMapResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UnlinkDeveloperIdentity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UnlinkDeveloperIdentity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UnlinkDeveloperIdentityRequestT = Model::UnlinkDeveloperIdentityRequest>
  void UnlinkDeveloperIdentityAsync(const UnlinkDeveloperIdentityRequestT& request,
  ...
  /**
   * An Async wrapper for UnlinkIdentity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UnlinkIdentityRequestT = Model::UnlinkIdentityRequest>
  void UnlinkIdentityAsync(const UnlinkIdentityRequestT& request, const UnlinkIdentityResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateIdentityPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateIdentityPool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateIdentityPoolRequestT = Model::UpdateIdentityPoolRequest>
  void UpdateIdentityPoolAsync(const UpdateIdentityPoolRequestT& request, const UpdateIdentityPoolResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
