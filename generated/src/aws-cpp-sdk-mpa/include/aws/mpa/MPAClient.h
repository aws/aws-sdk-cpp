...
class AWS_MPA_API MPAClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  MPAClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<MPAEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for CancelSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelSessionRequestT = Model::CancelSessionRequest>
  void CancelSessionAsync(const CancelSessionRequestT& request, const CancelSessionResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateApprovalTeam that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateApprovalTeam that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateApprovalTeamRequestT = Model::CreateApprovalTeamRequest>
  void CreateApprovalTeamAsync(const CreateApprovalTeamRequestT& request, const CreateApprovalTeamResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateIdentitySource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateIdentitySource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateIdentitySourceRequestT = Model::CreateIdentitySourceRequest>
  void CreateIdentitySourceAsync(const CreateIdentitySourceRequestT& request, const CreateIdentitySourceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteIdentitySource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteIdentitySource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteIdentitySourceRequestT = Model::DeleteIdentitySourceRequest>
  void DeleteIdentitySourceAsync(const DeleteIdentitySourceRequestT& request, const DeleteIdentitySourceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteInactiveApprovalTeamVersionOutcome DeleteInactiveApprovalTeamVersion(
      const Model::DeleteInactiveApprovalTeamVersionRequest& request) const;

  /**
   * A Callable wrapper for DeleteInactiveApprovalTeamVersion that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteInactiveApprovalTeamVersionRequestT = Model::DeleteInactiveApprovalTeamVersionRequest>
  Model::DeleteInactiveApprovalTeamVersionOutcomeCallable DeleteInactiveApprovalTeamVersionCallable(
      const DeleteInactiveApprovalTeamVersionRequestT& request) const {
    return SubmitCallable(&MPAClient::DeleteInactiveApprovalTeamVersion, request);
  }

  /**
   * An Async wrapper for DeleteInactiveApprovalTeamVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteInactiveApprovalTeamVersionRequestT = Model::DeleteInactiveApprovalTeamVersionRequest>
  void DeleteInactiveApprovalTeamVersionAsync(const DeleteInactiveApprovalTeamVersionRequestT& request,
                                              const DeleteInactiveApprovalTeamVersionResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetApprovalTeam that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetApprovalTeamRequestT = Model::GetApprovalTeamRequest>
  void GetApprovalTeamAsync(const GetApprovalTeamRequestT& request, const GetApprovalTeamResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetIdentitySource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIdentitySource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetIdentitySourceRequestT = Model::GetIdentitySourceRequest>
  void GetIdentitySourceAsync(const GetIdentitySourceRequestT& request, const GetIdentitySourceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListApprovalTeams that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListApprovalTeams that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListApprovalTeamsRequestT = Model::ListApprovalTeamsRequest>
  void ListApprovalTeamsAsync(const ListApprovalTeamsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListApprovalTeamsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListIdentitySources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListIdentitySources that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListIdentitySourcesRequestT = Model::ListIdentitySourcesRequest>
  void ListIdentitySourcesAsync(const ListIdentitySourcesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListIdentitySourcesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartActiveApprovalTeamDeletionOutcome StartActiveApprovalTeamDeletion(
      const Model::StartActiveApprovalTeamDeletionRequest& request) const;

  /**
   * A Callable wrapper for StartActiveApprovalTeamDeletion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartActiveApprovalTeamDeletionRequestT = Model::StartActiveApprovalTeamDeletionRequest>
  Model::StartActiveApprovalTeamDeletionOutcomeCallable StartActiveApprovalTeamDeletionCallable(
      const StartActiveApprovalTeamDeletionRequestT& request) const {
    return SubmitCallable(&MPAClient::StartActiveApprovalTeamDeletion, request);
  }

  /**
   * An Async wrapper for StartActiveApprovalTeamDeletion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartActiveApprovalTeamDeletionRequestT = Model::StartActiveApprovalTeamDeletionRequest>
  void StartActiveApprovalTeamDeletionAsync(const StartActiveApprovalTeamDeletionRequestT& request,
                                            const StartActiveApprovalTeamDeletionResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateApprovalTeam that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateApprovalTeam that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateApprovalTeamRequestT = Model::UpdateApprovalTeamRequest>
  void UpdateApprovalTeamAsync(const UpdateApprovalTeamRequestT& request, const UpdateApprovalTeamResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
 ...
 private:
  ...
  typedef Aws::Utils::Outcome<Aws::AmazonWebServiceResult<RESPONSE>, MPAError> InvokeOperationOutcome;
