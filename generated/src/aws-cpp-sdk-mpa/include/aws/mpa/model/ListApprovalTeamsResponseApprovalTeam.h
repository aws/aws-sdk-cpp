...
class ListApprovalTeamsResponseApprovalTeam {
 public:
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ListApprovalTeamsResponseApprovalTeam& WithCreationTime(CreationTimeT&& value) {
  ...
  void SetApprovalStrategy(ApprovalStrategyT&& value) {
    ...
    m_approvalStrategy = std::forward<ApprovalStrategyT>(value);
  }
  template <typename ApprovalStrategyT = ApprovalStrategyResponse>
  ListApprovalTeamsResponseApprovalTeam& WithApprovalStrategy(ApprovalStrategyT&& value) {
    SetApprovalStrategy(std::forward<ApprovalStrategyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfApprovers(int value) {
    m_numberOfApproversHasBeenSet = true;
    m_numberOfApprovers = value;
  }
  inline ListApprovalTeamsResponseApprovalTeam& WithNumberOfApprovers(int value) {
  ...
  template <typename ArnT = Aws::String>
  ListApprovalTeamsResponseApprovalTeam& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListApprovalTeamsResponseApprovalTeam& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ListApprovalTeamsResponseApprovalTeam& WithDescription(DescriptionT&& value) {
  ...
  inline void SetStatus(ApprovalTeamStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListApprovalTeamsResponseApprovalTeam& WithStatus(ApprovalTeamStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusCode(ApprovalTeamStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline ListApprovalTeamsResponseApprovalTeam& WithStatusCode(ApprovalTeamStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  ListApprovalTeamsResponseApprovalTeam& WithStatusMessage(StatusMessageT&& value) {
