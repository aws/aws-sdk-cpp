...
class GetIdentitySourceResult {
 public:
  ...
  inline GetIdentitySourceResult& WithIdentitySourceType(IdentitySourceType value) {
  ...
  inline GetIdentitySourceResult& WithStatus(IdentitySourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetIdentitySourceResult& WithStatusCode(IdentitySourceStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
