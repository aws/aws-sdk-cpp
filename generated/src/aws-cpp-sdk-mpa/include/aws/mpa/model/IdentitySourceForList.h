...
class IdentitySourceForList {
 public:
  ...
  inline void SetIdentitySourceType(IdentitySourceType value) {
    m_identitySourceTypeHasBeenSet = true;
    m_identitySourceType = value;
  }
  inline IdentitySourceForList& WithIdentitySourceType(IdentitySourceType value) {
    SetIdentitySourceType(value);
    return *this;
  }
  ///@}
  ...
  void SetIdentitySourceParameters(IdentitySourceParametersT&& value) {
    ...
    m_identitySourceParameters = std::forward<IdentitySourceParametersT>(value);
  }
  template <typename IdentitySourceParametersT = IdentitySourceParametersForList>
  IdentitySourceForList& WithIdentitySourceParameters(IdentitySourceParametersT&& value) {
    SetIdentitySourceParameters(std::forward<IdentitySourceParametersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdentitySourceArnT = Aws::String>
  IdentitySourceForList& WithIdentitySourceArn(IdentitySourceArnT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  IdentitySourceForList& WithCreationTime(CreationTimeT&& value) {
  ...
  inline void SetStatus(IdentitySourceStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline IdentitySourceForList& WithStatus(IdentitySourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusCode(IdentitySourceStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline IdentitySourceForList& WithStatusCode(IdentitySourceStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  IdentitySourceForList& WithStatusMessage(StatusMessageT&& value) {
