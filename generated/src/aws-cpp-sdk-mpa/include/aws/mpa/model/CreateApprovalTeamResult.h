...
class CreateApprovalTeamResult {
 public:
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  CreateApprovalTeamResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateApprovalTeamResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateApprovalTeamResult& WithName(NameT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  CreateApprovalTeamResult& WithVersionId(VersionIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateApprovalTeamResult& WithRequestId(RequestIdT&& value) {
