...
class ListApprovalTeamsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListApprovalTeamsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetApprovalTeams(ApprovalTeamsT&& value) {
    m_approvalTeamsHasBeenSet = true;
    m_approvalTeams = std::forward<ApprovalTeamsT>(value);
  }
  template <typename ApprovalTeamsT = Aws::Vector<ListApprovalTeamsResponseApprovalTeam>>
  ListApprovalTeamsResult& WithApprovalTeams(ApprovalTeamsT&& value) {
    SetApprovalTeams(std::forward<ApprovalTeamsT>(value));
    return *this;
  }
  template <typename ApprovalTeamsT = ListApprovalTeamsResponseApprovalTeam>
  ListApprovalTeamsResult& AddApprovalTeams(ApprovalTeamsT&& value) {
    m_approvalTeamsHasBeenSet = true;
    m_approvalTeams.emplace_back(std::forward<ApprovalTeamsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListApprovalTeamsResult& WithRequestId(RequestIdT&& value) {
