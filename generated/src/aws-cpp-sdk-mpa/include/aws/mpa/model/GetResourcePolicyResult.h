...
class GetResourcePolicyResult {
 public:
  ...
  inline GetResourcePolicyResult& WithPolicyType(PolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  void SetPolicyVersionArn(PolicyVersionArnT&& value) {
    ...
    m_policyVersionArn = std::forward<PolicyVersionArnT>(value);
  }
  template <typename PolicyVersionArnT = Aws::String>
  GetResourcePolicyResult& WithPolicyVersionArn(PolicyVersionArnT&& value) {
    SetPolicyVersionArn(std::forward<PolicyVersionArnT>(value));
    return *this;
  }
  ///@}
