...
class StartActiveApprovalTeamDeletionRequest : public MPARequest {
 public:
  ...
  inline void SetPendingWindowDays(int value) {
    m_pendingWindowDaysHasBeenSet = true;
    m_pendingWindowDays = value;
  }
  inline StartActiveApprovalTeamDeletionRequest& WithPendingWindowDays(int value) {
    SetPendingWindowDays(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  StartActiveApprovalTeamDeletionRequest& WithArn(ArnT&& value) {
