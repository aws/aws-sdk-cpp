...
class ListResourcePoliciesResponseResourcePolicy {
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  ListResourcePoliciesResponseResourcePolicy& WithPolicyArn(PolicyArnT&& value) {
  ...
  inline ListResourcePoliciesResponseResourcePolicy& WithPolicyType(PolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PolicyNameT = Aws::String>
  ListResourcePoliciesResponseResourcePolicy& WithPolicyName(PolicyNameT&& value) {
