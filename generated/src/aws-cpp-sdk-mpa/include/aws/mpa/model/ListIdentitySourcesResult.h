...
class ListIdentitySourcesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListIdentitySourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetIdentitySources(IdentitySourcesT&& value) {
    m_identitySourcesHasBeenSet = true;
    m_identitySources = std::forward<IdentitySourcesT>(value);
  }
  template <typename IdentitySourcesT = Aws::Vector<IdentitySourceForList>>
  ListIdentitySourcesResult& WithIdentitySources(IdentitySourcesT&& value) {
    SetIdentitySources(std::forward<IdentitySourcesT>(value));
    return *this;
  }
  template <typename IdentitySourcesT = IdentitySourceForList>
  ListIdentitySourcesResult& AddIdentitySources(IdentitySourcesT&& value) {
    m_identitySourcesHasBeenSet = true;
    m_identitySources.emplace_back(std::forward<IdentitySourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListIdentitySourcesResult& WithRequestId(RequestIdT&& value) {
