...
class PendingUpdate {
 public:
  ...
  inline PendingUpdate& WithNumberOfApprovers(int value) {
  ...
  inline PendingUpdate& WithStatus(ApprovalTeamStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline PendingUpdate& WithStatusCode(ApprovalTeamStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  void SetUpdateInitiationTime(UpdateInitiationTimeT&& value) {
    ...
    m_updateInitiationTime = std::forward<UpdateInitiationTimeT>(value);
  }
  template <typename UpdateInitiationTimeT = Aws::Utils::DateTime>
  PendingUpdate& WithUpdateInitiationTime(UpdateInitiationTimeT&& value) {
    SetUpdateInitiationTime(std::forward<UpdateInitiationTimeT>(value));
    return *this;
  }
  ///@}
 private:
