...
/**
 */
class ListPolicyVersionsRequest : public MPARequest {
 public:
  AWS_MPA_API ListPolicyVersionsRequest() = default;
  ...
  inline ListPolicyVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPolicyVersionsRequest& WithNextToken(NextTokenT&& value) {
