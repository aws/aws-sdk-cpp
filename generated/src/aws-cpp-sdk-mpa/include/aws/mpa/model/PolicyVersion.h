...
class PolicyVersion {
 public:
  ...
  inline PolicyVersion& WithVersionId(int value) {
    SetVersionId(value);
    return *this;
  }
  ///@}
  ...
  inline PolicyVersion& WithPolicyType(PolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  inline PolicyVersion& WithIsDefault(bool value) {
    SetIsDefault(value);
    return *this;
  }
  ///@}
  ...
  inline PolicyVersion& WithStatus(PolicyStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
