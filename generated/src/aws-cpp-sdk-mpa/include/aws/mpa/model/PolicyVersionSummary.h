...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    PolicyVersionSummary& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename PolicyArnT = Aws::String>
    PolicyVersionSummary& WithPolicyArn(PolicyArnT&& value) { SetPolicyArn(std::forward<PolicyArnT>(value)); return *this;}
    ///@}
    ...
    inline PolicyVersionSummary& WithVersionId(int value) { SetVersionId(value); return *this;}
    ///@}
    ...
    inline PolicyVersionSummary& WithPolicyType(PolicyType value) { SetPolicyType(value); return *this;}
    ///@}
    ...
    inline PolicyVersionSummary& WithIsDefault(bool value) { SetIsDefault(value); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    PolicyVersionSummary& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline PolicyVersionSummary& WithStatus(PolicyStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename CreationTimeT = Aws::Utils::DateTime>
    PolicyVersionSummary& WithCreationTime(CreationTimeT&& value) { SetCreationTime(std::forward<CreationTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedTimeT = Aws::Utils::DateTime>
    PolicyVersionSummary& WithLastUpdatedTime(LastUpdatedTimeT&& value) { SetLastUpdatedTime(std::forward<LastUpdatedTimeT>(value)); return *this;}
    ///@}
  private:
