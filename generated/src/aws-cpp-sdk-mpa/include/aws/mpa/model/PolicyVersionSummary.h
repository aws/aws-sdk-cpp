...
class PolicyVersionSummary {
 public:
  ...
  inline PolicyVersionSummary& WithVersionId(int value) {
    SetVersionId(value);
    return *this;
  }
  ///@}
  ...
  inline PolicyVersionSummary& WithPolicyType(PolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  inline PolicyVersionSummary& WithIsDefault(bool value) {
    SetIsDefault(value);
    return *this;
  }
  ///@}
  ...
  inline PolicyVersionSummary& WithStatus(PolicyStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
