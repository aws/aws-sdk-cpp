...
class MofNApprovalStrategy {
 public:
  ...
  inline void SetMinApprovalsRequired(int value) {
    m_minApprovalsRequiredHasBeenSet = true;
    m_minApprovalsRequired = value;
  }
  inline MofNApprovalStrategy& WithMinApprovalsRequired(int value) {
    SetMinApprovalsRequired(value);
    return *this;
  }
  ///@}
 private:
