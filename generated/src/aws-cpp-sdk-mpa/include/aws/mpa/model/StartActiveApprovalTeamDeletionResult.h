...
class StartActiveApprovalTeamDeletionResult {
 public:
  ...
  void SetDeletionCompletionTime(DeletionCompletionTimeT&& value) {
    m_deletionCompletionTimeHasBeenSet = true;
    m_deletionCompletionTime = std::forward<DeletionCompletionTimeT>(value);
  }
  template <typename DeletionCompletionTimeT = Aws::Utils::DateTime>
  StartActiveApprovalTeamDeletionResult& WithDeletionCompletionTime(DeletionCompletionTimeT&& value) {
    SetDeletionCompletionTime(std::forward<DeletionCompletionTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeletionStartTime(DeletionStartTimeT&& value) {
    ...
    m_deletionStartTime = std::forward<DeletionStartTimeT>(value);
  }
  template <typename DeletionStartTimeT = Aws::Utils::DateTime>
  StartActiveApprovalTeamDeletionResult& WithDeletionStartTime(DeletionStartTimeT&& value) {
    SetDeletionStartTime(std::forward<DeletionStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartActiveApprovalTeamDeletionResult& WithRequestId(RequestIdT&& value) {
