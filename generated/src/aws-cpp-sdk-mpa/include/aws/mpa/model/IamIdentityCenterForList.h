...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/mpa-2022-07-26/IamIdentityCenterForList">AWS
   * API Reference</a></p>
   */
  class IamIdentityCenterForList
  {
  public:
    AWS_MPA_API IamIdentityCenterForList() = default;
    AWS_MPA_API IamIdentityCenterForList(Aws::Utils::Json::JsonView jsonValue);
    AWS_MPA_API IamIdentityCenterForList& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename InstanceArnT = Aws::String>
    IamIdentityCenterForList& WithInstanceArn(InstanceArnT&& value) { SetInstanceArn(std::forward<InstanceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ApprovalPortalUrlT = Aws::String>
    IamIdentityCenterForList& WithApprovalPortalUrl(ApprovalPortalUrlT&& value) { SetApprovalPortalUrl(std::forward<ApprovalPortalUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename RegionT = Aws::String>
    IamIdentityCenterForList& WithRegion(RegionT&& value) { SetRegion(std::forward<RegionT>(value)); return *this;}
    ///@}
  private:
