...
IamIdentityCenterForList::IamIdentityCenterForList(JsonView jsonValue)
{
  *this = jsonValue;
}

IamIdentityCenterForList& IamIdentityCenterForList::operator =(JsonView jsonValue)
{
...
JsonValue IamIdentityCenterForList::Jsonize() const
{
  JsonValue payload;
