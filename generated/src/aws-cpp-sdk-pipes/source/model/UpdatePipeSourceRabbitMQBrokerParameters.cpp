...
UpdatePipeSourceRabbitMQBrokerParameters::UpdatePipeSourceRabbitMQBrokerParameters(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue UpdatePipeSourceRabbitMQBrokerParameters::Jsonize() const {
  JsonValue payload;
