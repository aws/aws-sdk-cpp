...
PipeSourceDynamoDBStreamParameters::PipeSourceDynamoDBStreamParameters(JsonView jsonValue) { *this = jsonValue; }
...
PipeSourceDynamoDBStreamParameters& PipeSourceDynamoDBStreamParameters::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("OnPartialBatchItemFailure")) {
    m_onPartialBatchItemFailure = OnPartialBatchItemFailureStreamsMapper::GetOnPartialBatchItemFailureStreamsForName(
        jsonValue.GetString("OnPartialBatchItemFailure"));
...
JsonValue PipeSourceDynamoDBStreamParameters::Jsonize() const {
  ...
  if (m_onPartialBatchItemFailureHasBeenSet) {
    payload.WithString("OnPartialBatchItemFailure",
                       OnPartialBatchItemFailureStreamsMapper::GetNameForOnPartialBatchItemFailureStreams(m_onPartialBatchItemFailure));
  }
