...
PipeTargetTimestreamParameters::PipeTargetTimestreamParameters(JsonView jsonValue) { *this = jsonValue; }
...
PipeTargetTimestreamParameters& PipeTargetTimestreamParameters::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SingleMeasureMappings")) {
    ...
    for (unsigned singleMeasureMappingsIndex = 0; singleMeasureMappingsIndex < singleMeasureMappingsJsonList.GetLength();
         ++singleMeasureMappingsIndex) {
  ...
  if (jsonValue.ValueExists("MultiMeasureMappings")) {
    ...
    for (unsigned multiMeasureMappingsIndex = 0; multiMeasureMappingsIndex < multiMeasureMappingsJsonList.GetLength();
         ++multiMeasureMappingsIndex) {
