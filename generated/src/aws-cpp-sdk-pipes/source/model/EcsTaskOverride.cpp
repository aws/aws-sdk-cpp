...
EcsTaskOverride::EcsTaskOverride(JsonView jsonValue) { *this = jsonValue; }
...
EcsTaskOverride& EcsTaskOverride::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ContainerOverrides")) {
    ...
    for (unsigned containerOverridesIndex = 0; containerOverridesIndex < containerOverridesJsonList.GetLength();
         ++containerOverridesIndex) {
  ...
  if (jsonValue.ValueExists("InferenceAcceleratorOverrides")) {
    ...
    for (unsigned inferenceAcceleratorOverridesIndex = 0;
         inferenceAcceleratorOverridesIndex < inferenceAcceleratorOverridesJsonList.GetLength(); ++inferenceAcceleratorOverridesIndex) {
...
JsonValue EcsTaskOverride::Jsonize() const {
  ...
  if (m_inferenceAcceleratorOverridesHasBeenSet) {
    ...
    for (unsigned inferenceAcceleratorOverridesIndex = 0;
         inferenceAcceleratorOverridesIndex < inferenceAcceleratorOverridesJsonList.GetLength(); ++inferenceAcceleratorOverridesIndex) {
      inferenceAcceleratorOverridesJsonList[inferenceAcceleratorOverridesIndex].AsObject(
          m_inferenceAcceleratorOverrides[inferenceAcceleratorOverridesIndex].Jsonize());
    }
