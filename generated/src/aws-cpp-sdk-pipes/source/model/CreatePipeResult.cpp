...
CreatePipeResult::CreatePipeResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreatePipeResult& CreatePipeResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
