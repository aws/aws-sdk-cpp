...
class AWS_PIPES_API PipesClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  PipesClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<PipesEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for CreatePipe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreatePipeRequestT = Model::CreatePipeRequest>
  void CreatePipeAsync(const CreatePipeRequestT& request, const CreatePipeResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for DeletePipe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePipeRequestT = Model::DeletePipeRequest>
  void DeletePipeAsync(const DeletePipeRequestT& request, const DeletePipeResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribePipe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribePipeRequestT = Model::DescribePipeRequest>
  void DescribePipeAsync(const DescribePipeRequestT& request, const DescribePipeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListPipes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPipesRequestT = Model::ListPipesRequest>
  void ListPipesAsync(const ListPipesResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListPipesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for StartPipe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartPipeRequestT = Model::StartPipeRequest>
  void StartPipeAsync(const StartPipeRequestT& request, const StartPipeResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopPipe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopPipeRequestT = Model::StopPipeRequest>
  void StopPipeAsync(const StopPipeRequestT& request, const StopPipeResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdatePipe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdatePipeRequestT = Model::UpdatePipeRequest>
  void UpdatePipeAsync(const UpdatePipeRequestT& request, const UpdatePipeResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
