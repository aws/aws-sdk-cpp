...
class SelfManagedKafkaAccessConfigurationCredentials {
 public:
  ...
  void SetSaslScram512Auth(SaslScram512AuthT&& value) {
    ...
    m_saslScram512Auth = std::forward<SaslScram512AuthT>(value);
  }
  template <typename SaslScram512AuthT = Aws::String>
  SelfManagedKafkaAccessConfigurationCredentials& WithSaslScram512Auth(SaslScram512AuthT&& value) {
    SetSaslScram512Auth(std::forward<SaslScram512AuthT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSaslScram256Auth(SaslScram256AuthT&& value) {
    ...
    m_saslScram256Auth = std::forward<SaslScram256AuthT>(value);
  }
  template <typename SaslScram256AuthT = Aws::String>
  SelfManagedKafkaAccessConfigurationCredentials& WithSaslScram256Auth(SaslScram256AuthT&& value) {
    SetSaslScram256Auth(std::forward<SaslScram256AuthT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClientCertificateTlsAuth(ClientCertificateTlsAuthT&& value) {
    ...
    m_clientCertificateTlsAuth = std::forward<ClientCertificateTlsAuthT>(value);
  }
  template <typename ClientCertificateTlsAuthT = Aws::String>
  SelfManagedKafkaAccessConfigurationCredentials& WithClientCertificateTlsAuth(ClientCertificateTlsAuthT&& value) {
    SetClientCertificateTlsAuth(std::forward<ClientCertificateTlsAuthT>(value));
    return *this;
  }
  ///@}
 private:
