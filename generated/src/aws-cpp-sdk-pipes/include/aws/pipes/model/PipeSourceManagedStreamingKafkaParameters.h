...
class PipeSourceManagedStreamingKafkaParameters {
 public:
  ...
  inline void SetStartingPosition(MSKStartPosition value) {
    m_startingPositionHasBeenSet = true;
    m_startingPosition = value;
  }
  inline PipeSourceManagedStreamingKafkaParameters& WithStartingPosition(MSKStartPosition value) {
  ...
  inline PipeSourceManagedStreamingKafkaParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline PipeSourceManagedStreamingKafkaParameters& WithMaximumBatchingWindowInSeconds(int value) {
