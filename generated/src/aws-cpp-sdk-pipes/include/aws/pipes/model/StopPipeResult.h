...
class StopPipeResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  StopPipeResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  StopPipeResult& WithName(NameT&& value) {
  ...
  inline StopPipeResult& WithDesiredState(RequestedPipeState value) {
  ...
  inline StopPipeResult& WithCurrentState(PipeState value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  StopPipeResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  StopPipeResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopPipeResult& WithRequestId(RequestIdT&& value) {
