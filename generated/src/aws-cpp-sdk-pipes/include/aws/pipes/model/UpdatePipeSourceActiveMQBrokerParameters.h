...
class UpdatePipeSourceActiveMQBrokerParameters {
 public:
  ...
  template <typename CredentialsT = MQBrokerAccessCredentials>
  UpdatePipeSourceActiveMQBrokerParameters& WithCredentials(CredentialsT&& value) {
  ...
  inline UpdatePipeSourceActiveMQBrokerParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdatePipeSourceActiveMQBrokerParameters& WithMaximumBatchingWindowInSeconds(int value) {
