 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/BatchResourceRequirement">AWS
 * API Reference</a></p>
 */
class BatchResourceRequirement {
 public:
  ...
  inline void SetType(BatchResourceRequirementType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline BatchResourceRequirement& WithType(BatchResourceRequirementType value) {
    SetType(value);
    return *this;
  }
  ///@}
