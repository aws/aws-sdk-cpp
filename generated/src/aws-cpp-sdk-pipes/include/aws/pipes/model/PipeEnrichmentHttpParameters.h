...
class PipeEnrichmentHttpParameters {
 public:
  ...
  template <typename PathParameterValuesT = Aws::Vector<Aws::String>>
  PipeEnrichmentHttpParameters& WithPathParameterValues(PathParameterValuesT&& value) {
    SetPathParameterValues(std::forward<PathParameterValuesT>(value));
    return *this;
  }
  template <typename PathParameterValuesT = Aws::String>
  PipeEnrichmentHttpParameters& AddPathParameterValues(PathParameterValuesT&& value) {
    m_pathParameterValuesHasBeenSet = true;
  ...
  template <typename HeaderParametersT = Aws::Map<Aws::String, Aws::String>>
  PipeEnrichmentHttpParameters& WithHeaderParameters(HeaderParametersT&& value) {
  ...
  template <typename QueryStringParametersT = Aws::Map<Aws::String, Aws::String>>
  PipeEnrichmentHttpParameters& WithQueryStringParameters(QueryStringParametersT&& value) {
