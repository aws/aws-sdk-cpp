...
class PipeSourceActiveMQBrokerParameters {
 public:
  ...
  template <typename CredentialsT = MQBrokerAccessCredentials>
  PipeSourceActiveMQBrokerParameters& WithCredentials(CredentialsT&& value) {
  ...
  template <typename QueueNameT = Aws::String>
  PipeSourceActiveMQBrokerParameters& WithQueueName(QueueNameT&& value) {
  ...
  inline PipeSourceActiveMQBrokerParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline PipeSourceActiveMQBrokerParameters& WithMaximumBatchingWindowInSeconds(int value) {
