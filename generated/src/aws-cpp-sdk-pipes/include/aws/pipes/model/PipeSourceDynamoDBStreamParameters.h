...
class PipeSourceDynamoDBStreamParameters {
 public:
  AWS_PIPES_API PipeSourceDynamoDBStreamParameters() = default;
  ...
  inline PipeSourceDynamoDBStreamParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename DeadLetterConfigT = DeadLetterConfig>
  PipeSourceDynamoDBStreamParameters& WithDeadLetterConfig(DeadLetterConfigT&& value) {
  ...
  inline PipeSourceDynamoDBStreamParameters& WithOnPartialBatchItemFailure(OnPartialBatchItemFailureStreams value) {
  ...
  inline PipeSourceDynamoDBStreamParameters& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  inline PipeSourceDynamoDBStreamParameters& WithMaximumRecordAgeInSeconds(int value) {
  ...
  inline PipeSourceDynamoDBStreamParameters& WithMaximumRetryAttempts(int value) {
  ...
  inline PipeSourceDynamoDBStreamParameters& WithParallelizationFactor(int value) {
   ...
   */
  inline DynamoDBStreamStartPosition GetStartingPosition() const { return m_startingPosition; }
  inline bool StartingPositionHasBeenSet() const { return m_startingPositionHasBeenSet; }
  inline void SetStartingPosition(DynamoDBStreamStartPosition value) {
    m_startingPositionHasBeenSet = true;
    m_startingPosition = value;
  }
  inline PipeSourceDynamoDBStreamParameters& WithStartingPosition(DynamoDBStreamStartPosition value) {
