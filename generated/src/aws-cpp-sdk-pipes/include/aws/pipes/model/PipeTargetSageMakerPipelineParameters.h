...
class PipeTargetSageMakerPipelineParameters {
 public:
  ...
  template <typename PipelineParameterListT = Aws::Vector<SageMakerPipelineParameter>>
  PipeTargetSageMakerPipelineParameters& WithPipelineParameterList(PipelineParameterListT&& value) {
  ...
  PipeTargetSageMakerPipelineParameters& AddPipelineParameterList(PipelineParameterListT&& value) {
    m_pipelineParameterListHasBeenSet = true;
