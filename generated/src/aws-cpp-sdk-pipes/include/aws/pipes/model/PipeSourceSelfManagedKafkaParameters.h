...
class PipeSourceSelfManagedKafkaParameters {
 public:
  ...
  inline void SetStartingPosition(SelfManagedKafkaStartPosition value) {
    m_startingPositionHasBeenSet = true;
    m_startingPosition = value;
  }
  inline PipeSourceSelfManagedKafkaParameters& WithStartingPosition(SelfManagedKafkaStartPosition value) {
  ...
  void SetAdditionalBootstrapServers(AdditionalBootstrapServersT&& value) {
    ...
    m_additionalBootstrapServers = std::forward<AdditionalBootstrapServersT>(value);
  }
  template <typename AdditionalBootstrapServersT = Aws::Vector<Aws::String>>
  PipeSourceSelfManagedKafkaParameters& WithAdditionalBootstrapServers(AdditionalBootstrapServersT&& value) {
    SetAdditionalBootstrapServers(std::forward<AdditionalBootstrapServersT>(value));
    return *this;
  }
  ...
  PipeSourceSelfManagedKafkaParameters& AddAdditionalBootstrapServers(AdditionalBootstrapServersT&& value) {
    m_additionalBootstrapServersHasBeenSet = true;
    m_additionalBootstrapServers.emplace_back(std::forward<AdditionalBootstrapServersT>(value));
    return *this;
  }
  ///@}
  ...
  inline PipeSourceSelfManagedKafkaParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline PipeSourceSelfManagedKafkaParameters& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  void SetServerRootCaCertificate(ServerRootCaCertificateT&& value) {
    ...
    m_serverRootCaCertificate = std::forward<ServerRootCaCertificateT>(value);
  }
  template <typename ServerRootCaCertificateT = Aws::String>
  PipeSourceSelfManagedKafkaParameters& WithServerRootCaCertificate(ServerRootCaCertificateT&& value) {
    SetServerRootCaCertificate(std::forward<ServerRootCaCertificateT>(value));
    return *this;
  }
  ///@}
