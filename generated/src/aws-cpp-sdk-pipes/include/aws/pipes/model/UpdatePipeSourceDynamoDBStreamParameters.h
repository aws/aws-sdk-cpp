...
class UpdatePipeSourceDynamoDBStreamParameters {
 public:
  ...
  inline UpdatePipeSourceDynamoDBStreamParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename DeadLetterConfigT = DeadLetterConfig>
  UpdatePipeSourceDynamoDBStreamParameters& WithDeadLetterConfig(DeadLetterConfigT&& value) {
  ...
  inline void SetOnPartialBatchItemFailure(OnPartialBatchItemFailureStreams value) {
    m_onPartialBatchItemFailureHasBeenSet = true;
    m_onPartialBatchItemFailure = value;
  }
  inline UpdatePipeSourceDynamoDBStreamParameters& WithOnPartialBatchItemFailure(OnPartialBatchItemFailureStreams value) {
    SetOnPartialBatchItemFailure(value);
    return *this;
  }
  ///@}
  ...
  inline UpdatePipeSourceDynamoDBStreamParameters& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  inline UpdatePipeSourceDynamoDBStreamParameters& WithMaximumRecordAgeInSeconds(int value) {
  ...
  inline UpdatePipeSourceDynamoDBStreamParameters& WithMaximumRetryAttempts(int value) {
  ...
  inline UpdatePipeSourceDynamoDBStreamParameters& WithParallelizationFactor(int value) {
