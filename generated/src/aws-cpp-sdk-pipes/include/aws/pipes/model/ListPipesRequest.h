...
class ListPipesRequest : public PipesRequest {
 public:
  ...
  inline ListPipesRequest& WithDesiredState(RequestedPipeState value) {
  ...
  inline ListPipesRequest& WithCurrentState(PipeState value) {
  ...
  void SetSourcePrefix(SourcePrefixT&& value) {
    m_sourcePrefixHasBeenSet = true;
    m_sourcePrefix = std::forward<SourcePrefixT>(value);
  }
  template <typename SourcePrefixT = Aws::String>
  ListPipesRequest& WithSourcePrefix(SourcePrefixT&& value) {
    SetSourcePrefix(std::forward<SourcePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListPipesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
