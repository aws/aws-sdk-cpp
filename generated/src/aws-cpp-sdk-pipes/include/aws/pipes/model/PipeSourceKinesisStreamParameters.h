...
class PipeSourceKinesisStreamParameters {
 public:
  ...
  inline PipeSourceKinesisStreamParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline PipeSourceKinesisStreamParameters& WithOnPartialBatchItemFailure(OnPartialBatchItemFailureStreams value) {
  ...
  inline PipeSourceKinesisStreamParameters& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  inline PipeSourceKinesisStreamParameters& WithMaximumRecordAgeInSeconds(int value) {
  ...
  inline PipeSourceKinesisStreamParameters& WithMaximumRetryAttempts(int value) {
  ...
  inline PipeSourceKinesisStreamParameters& WithParallelizationFactor(int value) {
  ...
  inline void SetStartingPosition(KinesisStreamStartPosition value) {
    m_startingPositionHasBeenSet = true;
    m_startingPosition = value;
  }
  inline PipeSourceKinesisStreamParameters& WithStartingPosition(KinesisStreamStartPosition value) {
