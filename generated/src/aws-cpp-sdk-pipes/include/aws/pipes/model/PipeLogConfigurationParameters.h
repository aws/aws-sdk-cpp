...
class PipeLogConfigurationParameters {
 public:
  ...
  void SetS3LogDestination(S3LogDestinationT&& value) {
    ...
    m_s3LogDestination = std::forward<S3LogDestinationT>(value);
  }
  template <typename S3LogDestinationT = S3LogDestinationParameters>
  PipeLogConfigurationParameters& WithS3LogDestination(S3LogDestinationT&& value) {
    SetS3LogDestination(std::forward<S3LogDestinationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFirehoseLogDestination(FirehoseLogDestinationT&& value) {
    ...
    m_firehoseLogDestination = std::forward<FirehoseLogDestinationT>(value);
  }
  template <typename FirehoseLogDestinationT = FirehoseLogDestinationParameters>
  PipeLogConfigurationParameters& WithFirehoseLogDestination(FirehoseLogDestinationT&& value) {
    SetFirehoseLogDestination(std::forward<FirehoseLogDestinationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudwatchLogsLogDestination(CloudwatchLogsLogDestinationT&& value) {
    ...
    m_cloudwatchLogsLogDestination = std::forward<CloudwatchLogsLogDestinationT>(value);
  }
  template <typename CloudwatchLogsLogDestinationT = CloudwatchLogsLogDestinationParameters>
  PipeLogConfigurationParameters& WithCloudwatchLogsLogDestination(CloudwatchLogsLogDestinationT&& value) {
    SetCloudwatchLogsLogDestination(std::forward<CloudwatchLogsLogDestinationT>(value));
    return *this;
  }
  ///@}
  ...
  inline PipeLogConfigurationParameters& WithLevel(LogLevel value) {
    SetLevel(value);
    return *this;
  }
  ///@}
  ...
  void SetIncludeExecutionData(IncludeExecutionDataT&& value) {
    ...
    m_includeExecutionData = std::forward<IncludeExecutionDataT>(value);
  }
  template <typename IncludeExecutionDataT = Aws::Vector<IncludeExecutionDataOption>>
  PipeLogConfigurationParameters& WithIncludeExecutionData(IncludeExecutionDataT&& value) {
    SetIncludeExecutionData(std::forward<IncludeExecutionDataT>(value));
    return *this;
  }
  inline PipeLogConfigurationParameters& AddIncludeExecutionData(IncludeExecutionDataOption value) {
    m_includeExecutionDataHasBeenSet = true;
    m_includeExecutionData.push_back(value);
    return *this;
  }
  ///@}
 private:
