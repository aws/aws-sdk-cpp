...
class UpdatePipeSourceSqsQueueParameters {
 public:
  ...
  inline UpdatePipeSourceSqsQueueParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdatePipeSourceSqsQueueParameters& WithMaximumBatchingWindowInSeconds(int value) {
