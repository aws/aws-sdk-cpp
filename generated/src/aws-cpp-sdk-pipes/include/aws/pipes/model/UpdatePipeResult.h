...
class UpdatePipeResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdatePipeResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdatePipeResult& WithName(NameT&& value) {
  ...
  inline UpdatePipeResult& WithDesiredState(RequestedPipeState value) {
  ...
  inline UpdatePipeResult& WithCurrentState(PipeState value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  UpdatePipeResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  UpdatePipeResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePipeResult& WithRequestId(RequestIdT&& value) {
