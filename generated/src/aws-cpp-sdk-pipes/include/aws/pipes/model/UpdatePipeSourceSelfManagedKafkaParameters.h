...
class UpdatePipeSourceSelfManagedKafkaParameters {
 public:
  ...
  inline UpdatePipeSourceSelfManagedKafkaParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdatePipeSourceSelfManagedKafkaParameters& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  template <typename CredentialsT = SelfManagedKafkaAccessConfigurationCredentials>
  UpdatePipeSourceSelfManagedKafkaParameters& WithCredentials(CredentialsT&& value) {
  ...
  template <typename ServerRootCaCertificateT = Aws::String>
  UpdatePipeSourceSelfManagedKafkaParameters& WithServerRootCaCertificate(ServerRootCaCertificateT&& value) {
  ...
  template <typename VpcT = SelfManagedKafkaAccessConfigurationVpc>
  UpdatePipeSourceSelfManagedKafkaParameters& WithVpc(VpcT&& value) {
