...
class DimensionMapping {
 public:
  ...
  void SetDimensionValue(DimensionValueT&& value) {
    ...
    m_dimensionValue = std::forward<DimensionValueT>(value);
  }
  template <typename DimensionValueT = Aws::String>
  DimensionMapping& WithDimensionValue(DimensionValueT&& value) {
    SetDimensionValue(std::forward<DimensionValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDimensionValueType(DimensionValueType value) {
    m_dimensionValueTypeHasBeenSet = true;
    m_dimensionValueType = value;
  }
  inline DimensionMapping& WithDimensionValueType(DimensionValueType value) {
    SetDimensionValueType(value);
    return *this;
  }
  ///@}
  ...
  template <typename DimensionNameT = Aws::String>
  DimensionMapping& WithDimensionName(DimensionNameT&& value) {
