...
class PipeTargetTimestreamParameters {
 public:
  ...
  void SetTimeValue(TimeValueT&& value) {
    ...
    m_timeValue = std::forward<TimeValueT>(value);
  }
  template <typename TimeValueT = Aws::String>
  PipeTargetTimestreamParameters& WithTimeValue(TimeValueT&& value) {
    SetTimeValue(std::forward<TimeValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEpochTimeUnit(EpochTimeUnit value) {
    m_epochTimeUnitHasBeenSet = true;
    m_epochTimeUnit = value;
  }
  inline PipeTargetTimestreamParameters& WithEpochTimeUnit(EpochTimeUnit value) {
    SetEpochTimeUnit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimeFieldType(TimeFieldType value) {
    m_timeFieldTypeHasBeenSet = true;
    m_timeFieldType = value;
  }
  inline PipeTargetTimestreamParameters& WithTimeFieldType(TimeFieldType value) {
    SetTimeFieldType(value);
    return *this;
  }
  ///@}
  ...
  void SetVersionValue(VersionValueT&& value) {
    ...
    m_versionValue = std::forward<VersionValueT>(value);
  }
  template <typename VersionValueT = Aws::String>
  PipeTargetTimestreamParameters& WithVersionValue(VersionValueT&& value) {
    SetVersionValue(std::forward<VersionValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSingleMeasureMappings(SingleMeasureMappingsT&& value) {
    ...
    m_singleMeasureMappings = std::forward<SingleMeasureMappingsT>(value);
  }
  template <typename SingleMeasureMappingsT = Aws::Vector<SingleMeasureMapping>>
  PipeTargetTimestreamParameters& WithSingleMeasureMappings(SingleMeasureMappingsT&& value) {
    SetSingleMeasureMappings(std::forward<SingleMeasureMappingsT>(value));
    return *this;
  }
  ...
  PipeTargetTimestreamParameters& AddSingleMeasureMappings(SingleMeasureMappingsT&& value) {
    m_singleMeasureMappingsHasBeenSet = true;
    m_singleMeasureMappings.emplace_back(std::forward<SingleMeasureMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  PipeTargetTimestreamParameters& AddMultiMeasureMappings(MultiMeasureMappingsT&& value) {
    m_multiMeasureMappingsHasBeenSet = true;
    m_multiMeasureMappings.emplace_back(std::forward<MultiMeasureMappingsT>(value));
    return *this;
  }
  ///@}
 private:
