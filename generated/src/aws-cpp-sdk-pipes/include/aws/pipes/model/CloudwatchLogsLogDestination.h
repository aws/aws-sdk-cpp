...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/CloudwatchLogsLogDestination">AWS
   * API Reference</a></p>
   */
  ...
  public:
     ...
     * which EventBridge sends the log records.</p>
     */
    inline CloudwatchLogsLogDestination& WithLogGroupArn(const char* value) { SetLogGroupArn(value); return *this;}
