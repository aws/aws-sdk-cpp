...
class UpdatePipeSourceManagedStreamingKafkaParameters {
 public:
  ...
  inline UpdatePipeSourceManagedStreamingKafkaParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename CredentialsT = MSKAccessCredentials>
  UpdatePipeSourceManagedStreamingKafkaParameters& WithCredentials(CredentialsT&& value) {
  ...
  inline UpdatePipeSourceManagedStreamingKafkaParameters& WithMaximumBatchingWindowInSeconds(int value) {
