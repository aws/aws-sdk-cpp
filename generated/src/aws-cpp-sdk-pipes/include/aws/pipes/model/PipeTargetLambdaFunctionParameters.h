...
class PipeTargetLambdaFunctionParameters {
 public:
  AWS_PIPES_API PipeTargetLambdaFunctionParameters() = default;
  ...
  inline void SetInvocationType(PipeTargetInvocationType value) {
    m_invocationTypeHasBeenSet = true;
    m_invocationType = value;
  }
  inline PipeTargetLambdaFunctionParameters& WithInvocationType(PipeTargetInvocationType value) {
