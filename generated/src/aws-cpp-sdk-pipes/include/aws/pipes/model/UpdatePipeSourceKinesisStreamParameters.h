...
class UpdatePipeSourceKinesisStreamParameters {
 public:
  ...
  inline UpdatePipeSourceKinesisStreamParameters& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdatePipeSourceKinesisStreamParameters& WithOnPartialBatchItemFailure(OnPartialBatchItemFailureStreams value) {
  ...
  inline UpdatePipeSourceKinesisStreamParameters& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  inline UpdatePipeSourceKinesisStreamParameters& WithMaximumRecordAgeInSeconds(int value) {
  ...
  inline UpdatePipeSourceKinesisStreamParameters& WithMaximumRetryAttempts(int value) {
  ...
  inline UpdatePipeSourceKinesisStreamParameters& WithParallelizationFactor(int value) {
