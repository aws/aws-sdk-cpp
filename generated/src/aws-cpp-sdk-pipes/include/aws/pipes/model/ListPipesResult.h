...
class ListPipesResult {
 public:
  ...
  void SetPipes(PipesT&& value) {
    m_pipesHasBeenSet = true;
    m_pipes = std::forward<PipesT>(value);
  }
  template <typename PipesT = Aws::Vector<Pipe>>
  ListPipesResult& WithPipes(PipesT&& value) {
    SetPipes(std::forward<PipesT>(value));
    return *this;
  }
  template <typename PipesT = Pipe>
  ListPipesResult& AddPipes(PipesT&& value) {
    m_pipesHasBeenSet = true;
    m_pipes.emplace_back(std::forward<PipesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPipesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPipesResult& WithRequestId(RequestIdT&& value) {
