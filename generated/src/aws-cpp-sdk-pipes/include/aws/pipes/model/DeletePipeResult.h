...
class DeletePipeResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DeletePipeResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeletePipeResult& WithName(NameT&& value) {
  ...
  inline void SetDesiredState(RequestedPipeStateDescribeResponse value) {
    m_desiredStateHasBeenSet = true;
    m_desiredState = value;
  }
  inline DeletePipeResult& WithDesiredState(RequestedPipeStateDescribeResponse value) {
  ...
  inline DeletePipeResult& WithCurrentState(PipeState value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  DeletePipeResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  DeletePipeResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeletePipeResult& WithRequestId(RequestIdT&& value) {
