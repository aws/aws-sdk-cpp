...
class PipeTargetEcsTaskParameters {
 public:
  ...
  inline PipeTargetEcsTaskParameters& WithTaskCount(int value) {
    SetTaskCount(value);
    return *this;
  }
  ///@}
  ...
  inline PipeTargetEcsTaskParameters& WithLaunchType(LaunchType value) {
    SetLaunchType(value);
    return *this;
  }
  ///@}
  ...
  inline PipeTargetEcsTaskParameters& WithEnableECSManagedTags(bool value) {
  ...
  inline PipeTargetEcsTaskParameters& WithEnableExecuteCommand(bool value) {
  ...
  inline PipeTargetEcsTaskParameters& WithPropagateTags(PropagateTags value) {
