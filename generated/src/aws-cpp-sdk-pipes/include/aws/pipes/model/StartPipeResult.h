...
namespace Model
{
  class StartPipeResult
  {
  public:
    AWS_PIPES_API StartPipeResult();
     ...
     * <p>The ARN of the pipe.</p>
     */
    inline StartPipeResult& WithArn(const Aws::String& value) { SetArn(value); return *this;}

    /**
     * <p>The ARN of the pipe.</p>
     */
    inline StartPipeResult& WithArn(Aws::String&& value) { SetArn(std::move(value)); return *this;}

    /**
     * <p>The ARN of the pipe.</p>
     */
    inline StartPipeResult& WithArn(const char* value) { SetArn(value); return *this;}
     ...
     * <p>The state the pipe is in.</p>
     */
    inline StartPipeResult& WithCurrentState(const PipeState& value) { SetCurrentState(value); return *this;}

    /**
     * <p>The state the pipe is in.</p>
     */
    inline StartPipeResult& WithCurrentState(PipeState&& value) { SetCurrentState(std::move(value)); return *this;}
     ...
     * (YYYY-MM-DDThh:mm:ss.sTZD).</p>
     */
    inline StartPipeResult& WithLastModifiedTime(const Aws::Utils::DateTime& value) { SetLastModifiedTime(value); return *this;}
    ...
    inline StartPipeResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartPipeResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartPipeResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
