...
class UpdatePipeSourceParameters {
 public:
  ...
  void SetKinesisStreamParameters(KinesisStreamParametersT&& value) {
    ...
    m_kinesisStreamParameters = std::forward<KinesisStreamParametersT>(value);
  }
  template <typename KinesisStreamParametersT = UpdatePipeSourceKinesisStreamParameters>
  UpdatePipeSourceParameters& WithKinesisStreamParameters(KinesisStreamParametersT&& value) {
    SetKinesisStreamParameters(std::forward<KinesisStreamParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamoDBStreamParameters(DynamoDBStreamParametersT&& value) {
    ...
    m_dynamoDBStreamParameters = std::forward<DynamoDBStreamParametersT>(value);
  }
  template <typename DynamoDBStreamParametersT = UpdatePipeSourceDynamoDBStreamParameters>
  UpdatePipeSourceParameters& WithDynamoDBStreamParameters(DynamoDBStreamParametersT&& value) {
    SetDynamoDBStreamParameters(std::forward<DynamoDBStreamParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSqsQueueParameters(SqsQueueParametersT&& value) {
    ...
    m_sqsQueueParameters = std::forward<SqsQueueParametersT>(value);
  }
  template <typename SqsQueueParametersT = UpdatePipeSourceSqsQueueParameters>
  UpdatePipeSourceParameters& WithSqsQueueParameters(SqsQueueParametersT&& value) {
    SetSqsQueueParameters(std::forward<SqsQueueParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActiveMQBrokerParameters(ActiveMQBrokerParametersT&& value) {
    ...
    m_activeMQBrokerParameters = std::forward<ActiveMQBrokerParametersT>(value);
  }
  template <typename ActiveMQBrokerParametersT = UpdatePipeSourceActiveMQBrokerParameters>
  UpdatePipeSourceParameters& WithActiveMQBrokerParameters(ActiveMQBrokerParametersT&& value) {
    SetActiveMQBrokerParameters(std::forward<ActiveMQBrokerParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRabbitMQBrokerParameters(RabbitMQBrokerParametersT&& value) {
    ...
    m_rabbitMQBrokerParameters = std::forward<RabbitMQBrokerParametersT>(value);
  }
  template <typename RabbitMQBrokerParametersT = UpdatePipeSourceRabbitMQBrokerParameters>
  UpdatePipeSourceParameters& WithRabbitMQBrokerParameters(RabbitMQBrokerParametersT&& value) {
    SetRabbitMQBrokerParameters(std::forward<RabbitMQBrokerParametersT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const UpdatePipeSourceManagedStreamingKafkaParameters& GetManagedStreamingKafkaParameters() const {
    return m_managedStreamingKafkaParameters;
  }
  ...
  void SetManagedStreamingKafkaParameters(ManagedStreamingKafkaParametersT&& value) {
    ...
    m_managedStreamingKafkaParameters = std::forward<ManagedStreamingKafkaParametersT>(value);
  }
  template <typename ManagedStreamingKafkaParametersT = UpdatePipeSourceManagedStreamingKafkaParameters>
  UpdatePipeSourceParameters& WithManagedStreamingKafkaParameters(ManagedStreamingKafkaParametersT&& value) {
    SetManagedStreamingKafkaParameters(std::forward<ManagedStreamingKafkaParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelfManagedKafkaParameters(SelfManagedKafkaParametersT&& value) {
    ...
    m_selfManagedKafkaParameters = std::forward<SelfManagedKafkaParametersT>(value);
  }
  template <typename SelfManagedKafkaParametersT = UpdatePipeSourceSelfManagedKafkaParameters>
  UpdatePipeSourceParameters& WithSelfManagedKafkaParameters(SelfManagedKafkaParametersT&& value) {
    SetSelfManagedKafkaParameters(std::forward<SelfManagedKafkaParametersT>(value));
    return *this;
  }
  ///@}
 private:
