...
namespace Braket
{
const size_t BraketEndpointRules::RulesBlobStrLen = 3454;
const size_t BraketEndpointRules::RulesBlobSize = 3455;
...
'b','r','a','k','e','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','b','r','a','k',
'e','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s',
...
't','t','p','s',':','/','/','b','r','a','k','e','t','.','{','R','e','g','i','o','n','}','.','{','P',
...
const char* BraketEndpointRules::GetRulesBlob()
{
