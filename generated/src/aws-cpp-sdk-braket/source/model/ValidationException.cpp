...
ValidationException& ValidationException::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("programSetValidationFailures")) {
    ...
    for (unsigned programSetValidationFailuresIndex = 0;
         programSetValidationFailuresIndex < programSetValidationFailuresJsonList.GetLength(); ++programSetValidationFailuresIndex) {
...
JsonValue ValidationException::Jsonize() const {
  ...
  if (m_programSetValidationFailuresHasBeenSet) {
    ...
    for (unsigned programSetValidationFailuresIndex = 0;
         programSetValidationFailuresIndex < programSetValidationFailuresJsonList.GetLength(); ++programSetValidationFailuresIndex) {
      programSetValidationFailuresJsonList[programSetValidationFailuresIndex].AsObject(
          m_programSetValidationFailures[programSetValidationFailuresIndex].Jsonize());
    }
