...
class QuantumTaskQueueInfo {
 public:
  ...
  inline QuantumTaskQueueInfo& WithQueue(QueueName value) {
    SetQueue(value);
    return *this;
  }
  ///@}
  ...
  template <typename PositionT = Aws::String>
  QuantumTaskQueueInfo& WithPosition(PositionT&& value) {
  ...
  inline QuantumTaskQueueInfo& WithQueuePriority(QueuePriority value) {
  ...
  template <typename MessageT = Aws::String>
  QuantumTaskQueueInfo& WithMessage(MessageT&& value) {
