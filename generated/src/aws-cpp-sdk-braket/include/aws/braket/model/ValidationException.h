...
class ValidationException {
 public:
  ...
  void SetProgramSetValidationFailures(ProgramSetValidationFailuresT&& value) {
    m_programSetValidationFailuresHasBeenSet = true;
    m_programSetValidationFailures = std::forward<ProgramSetValidationFailuresT>(value);
  }
  template <typename ProgramSetValidationFailuresT = Aws::Vector<ProgramSetValidationFailure>>
  ValidationException& WithProgramSetValidationFailures(ProgramSetValidationFailuresT&& value) {
    SetProgramSetValidationFailures(std::forward<ProgramSetValidationFailuresT>(value));
    return *this;
  }
  template <typename ProgramSetValidationFailuresT = ProgramSetValidationFailure>
  ValidationException& AddProgramSetValidationFailures(ProgramSetValidationFailuresT&& value) {
    m_programSetValidationFailuresHasBeenSet = true;
    m_programSetValidationFailures.emplace_back(std::forward<ProgramSetValidationFailuresT>(value));
    return *this;
  }
  ///@}
 private:
