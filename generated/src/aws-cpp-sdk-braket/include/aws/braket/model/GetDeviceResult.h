...
class GetDeviceResult {
 public:
  ...
  inline void SetDeviceType(DeviceType value) {
    m_deviceTypeHasBeenSet = true;
    m_deviceType = value;
  }
  inline GetDeviceResult& WithDeviceType(DeviceType value) {
    SetDeviceType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeviceStatus(DeviceStatus value) {
    m_deviceStatusHasBeenSet = true;
    m_deviceStatus = value;
  }
  inline GetDeviceResult& WithDeviceStatus(DeviceStatus value) {
  ...
  void SetDeviceCapabilities(DeviceCapabilitiesT&& value) {
    ...
    m_deviceCapabilities = std::forward<DeviceCapabilitiesT>(value);
  }
  template <typename DeviceCapabilitiesT = Aws::String>
  GetDeviceResult& WithDeviceCapabilities(DeviceCapabilitiesT&& value) {
    SetDeviceCapabilities(std::forward<DeviceCapabilitiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceQueueInfo(DeviceQueueInfoT&& value) {
    ...
    m_deviceQueueInfo = std::forward<DeviceQueueInfoT>(value);
  }
  template <typename DeviceQueueInfoT = Aws::Vector<DeviceQueueInfo>>
  GetDeviceResult& WithDeviceQueueInfo(DeviceQueueInfoT&& value) {
    SetDeviceQueueInfo(std::forward<DeviceQueueInfoT>(value));
    return *this;
  }
  template <typename DeviceQueueInfoT = DeviceQueueInfo>
  GetDeviceResult& AddDeviceQueueInfo(DeviceQueueInfoT&& value) {
    m_deviceQueueInfoHasBeenSet = true;
    m_deviceQueueInfo.emplace_back(std::forward<DeviceQueueInfoT>(value));
    return *this;
  }
  ///@}
