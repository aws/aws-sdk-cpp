...
class ProgramSetValidationFailure {
 public:
  ...
  inline void SetProgramIndex(long long value) {
    m_programIndexHasBeenSet = true;
    m_programIndex = value;
  }
  inline ProgramSetValidationFailure& WithProgramIndex(long long value) {
  ...
  inline void SetInputsIndex(long long value) {
    m_inputsIndexHasBeenSet = true;
    m_inputsIndex = value;
  }
  inline ProgramSetValidationFailure& WithInputsIndex(long long value) {
    SetInputsIndex(value);
    return *this;
  }
  ///@}
