...
class SearchQuantumTasksResult {
 public:
  ...
  void SetQuantumTasks(QuantumTasksT&& value) {
    m_quantumTasksHasBeenSet = true;
    m_quantumTasks = std::forward<QuantumTasksT>(value);
  }
  template <typename QuantumTasksT = Aws::Vector<QuantumTaskSummary>>
  SearchQuantumTasksResult& WithQuantumTasks(QuantumTasksT&& value) {
    SetQuantumTasks(std::forward<QuantumTasksT>(value));
    return *this;
  }
  template <typename QuantumTasksT = QuantumTaskSummary>
  SearchQuantumTasksResult& AddQuantumTasks(QuantumTasksT&& value) {
    m_quantumTasksHasBeenSet = true;
    m_quantumTasks.emplace_back(std::forward<QuantumTasksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchQuantumTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchQuantumTasksResult& WithRequestId(RequestIdT&& value) {
