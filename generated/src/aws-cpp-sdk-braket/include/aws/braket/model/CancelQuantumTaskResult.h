...
class CancelQuantumTaskResult {
 public:
  ...
  template <typename QuantumTaskArnT = Aws::String>
  CancelQuantumTaskResult& WithQuantumTaskArn(QuantumTaskArnT&& value) {
  ...
  inline void SetCancellationStatus(CancellationStatus value) {
    m_cancellationStatusHasBeenSet = true;
    m_cancellationStatus = value;
  }
  inline CancelQuantumTaskResult& WithCancellationStatus(CancellationStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  CancelQuantumTaskResult& WithRequestId(RequestIdT&& value) {
