...
class GetJobRequest : public BraketRequest {
 public:
  ...
  template <typename JobArnT = Aws::String>
  GetJobRequest& WithJobArn(JobArnT&& value) {
  ...
  template <typename AdditionalAttributeNamesT = Aws::Vector<HybridJobAdditionalAttributeName>>
  GetJobRequest& WithAdditionalAttributeNames(AdditionalAttributeNamesT&& value) {
    SetAdditionalAttributeNames(std::forward<AdditionalAttributeNamesT>(value));
    return *this;
  }
  inline GetJobRequest& AddAdditionalAttributeNames(HybridJobAdditionalAttributeName value) {
    m_additionalAttributeNamesHasBeenSet = true;
