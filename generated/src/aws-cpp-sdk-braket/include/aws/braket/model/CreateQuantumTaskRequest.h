...
class CreateQuantumTaskRequest : public BraketRequest {
 public:
  ...
  inline CreateQuantumTaskRequest& WithShots(long long value) {
    SetShots(value);
    return *this;
  }
  ///@}
  ...
  void SetJobToken(JobTokenT&& value) {
    m_jobTokenHasBeenSet = true;
    m_jobToken = std::forward<JobTokenT>(value);
  }
  template <typename JobTokenT = Aws::String>
  CreateQuantumTaskRequest& WithJobToken(JobTokenT&& value) {
    SetJobToken(std::forward<JobTokenT>(value));
    return *this;
  }
  ///@}
