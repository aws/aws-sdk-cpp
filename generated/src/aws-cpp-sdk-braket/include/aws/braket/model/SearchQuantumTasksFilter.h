...
/**
 * <p>A filter used to search for quantum tasks.</p><p><h3>See Also:</h3>   <a
...
class SearchQuantumTasksFilter {
 public:
  ...
  ///@{
  /**
   * <p>The name of the quantum task parameter to filter based on. Filter name can be
   * either <code>quantumTaskArn</code>, <code>deviceArn</code>, <code>jobArn</code>,
   * <code>status</code> or <code>createdAt</code>.</p>
   */
  ...
  template <typename NameT = Aws::String>
  SearchQuantumTasksFilter& WithName(NameT&& value) {
  ...
  ///@{
  /**
   * <p>The values used to filter quantum tasks based on the filter name and
   * operator.</p>
   */
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  SearchQuantumTasksFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  SearchQuantumTasksFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(SearchQuantumTasksFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline SearchQuantumTasksFilter& WithOperator(SearchQuantumTasksFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
