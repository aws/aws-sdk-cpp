...
class InstanceConfig {
 public:
  ...
  inline InstanceConfig& WithInstanceType(InstanceType value) {
  ...
  inline InstanceConfig& WithVolumeSizeInGb(int value) {
  ...
  inline InstanceConfig& WithInstanceCount(int value) {
