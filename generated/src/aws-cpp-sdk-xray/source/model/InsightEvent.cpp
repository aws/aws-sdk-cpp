...
InsightEvent::InsightEvent(JsonView jsonValue) { *this = jsonValue; }
...
InsightEvent& InsightEvent::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TopAnomalousServices")) {
    ...
    for (unsigned topAnomalousServicesIndex = 0; topAnomalousServicesIndex < topAnomalousServicesJsonList.GetLength();
         ++topAnomalousServicesIndex) {
