...
Edge& Edge::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ReceivedEventAgeHistogram")) {
    ...
    for (unsigned receivedEventAgeHistogramIndex = 0; receivedEventAgeHistogramIndex < receivedEventAgeHistogramJsonList.GetLength();
         ++receivedEventAgeHistogramIndex) {
...
JsonValue Edge::Jsonize() const {
  ...
  if (m_receivedEventAgeHistogramHasBeenSet) {
    ...
    for (unsigned receivedEventAgeHistogramIndex = 0; receivedEventAgeHistogramIndex < receivedEventAgeHistogramJsonList.GetLength();
         ++receivedEventAgeHistogramIndex) {
      receivedEventAgeHistogramJsonList[receivedEventAgeHistogramIndex].AsObject(
          m_receivedEventAgeHistogram[receivedEventAgeHistogramIndex].Jsonize());
    }
