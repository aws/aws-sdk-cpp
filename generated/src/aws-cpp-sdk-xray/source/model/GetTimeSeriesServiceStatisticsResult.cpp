...
GetTimeSeriesServiceStatisticsResult& GetTimeSeriesServiceStatisticsResult::operator=(
  ...
  if (jsonValue.ValueExists("TimeSeriesServiceStatistics")) {
    ...
    for (unsigned timeSeriesServiceStatisticsIndex = 0; timeSeriesServiceStatisticsIndex < timeSeriesServiceStatisticsJsonList.GetLength();
         ++timeSeriesServiceStatisticsIndex) {
