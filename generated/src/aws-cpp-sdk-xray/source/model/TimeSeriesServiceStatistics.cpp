...
TimeSeriesServiceStatistics::TimeSeriesServiceStatistics(JsonView jsonValue) { *this = jsonValue; }
...
TimeSeriesServiceStatistics& TimeSeriesServiceStatistics::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ResponseTimeHistogram")) {
    ...
    for (unsigned responseTimeHistogramIndex = 0; responseTimeHistogramIndex < responseTimeHistogramJsonList.GetLength();
         ++responseTimeHistogramIndex) {
