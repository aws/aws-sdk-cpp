...
namespace XRay
{
const size_t XRayEndpointRules::RulesBlobStrLen = 3716;
const size_t XRayEndpointRules::RulesBlobSize = 3717;
...
'd','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','x',
'r','a','y','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'h','t','t','p','s',':','/','/','x','r','a','y','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'"','h','t','t','p','s',':','/','/','x','r','a','y','.','{','R','e','g','i','o','n','}','.','{','P',
