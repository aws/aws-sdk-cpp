...
':','"','h','t','t','p','s',':','/','/','x','r','a','y','-','f','i','p','s','.','{','R','e','g','i',
...
'/','/','x','r','a','y','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
const char* XRayEndpointRules::GetRulesBlob()
{
