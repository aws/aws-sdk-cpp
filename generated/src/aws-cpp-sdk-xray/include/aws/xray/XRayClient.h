...
class AWS_XRAY_API XRayClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  XRayClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<XRayEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for BatchGetTraces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetTracesRequestT = Model::BatchGetTracesRequest>
  void BatchGetTracesAsync(const BatchGetTracesRequestT& request, const BatchGetTracesResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CancelTraceRetrieval that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelTraceRetrieval that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelTraceRetrievalRequestT = Model::CancelTraceRetrievalRequest>
  void CancelTraceRetrievalAsync(const CancelTraceRetrievalRequestT& request, const CancelTraceRetrievalResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSamplingRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSamplingRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateSamplingRuleRequestT = Model::CreateSamplingRuleRequest>
  void CreateSamplingRuleAsync(const CreateSamplingRuleRequestT& request, const CreateSamplingRuleResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSamplingRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSamplingRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteSamplingRuleRequestT = Model::DeleteSamplingRuleRequest>
  void DeleteSamplingRuleAsync(const DeleteSamplingRuleResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DeleteSamplingRuleRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetEncryptionConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEncryptionConfig that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetEncryptionConfigRequestT = Model::GetEncryptionConfigRequest>
  void GetEncryptionConfigAsync(const GetEncryptionConfigResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetEncryptionConfigRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetGroups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGroupsRequestT = Model::GetGroupsRequest>
  void GetGroupsAsync(const GetGroupsResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const GetGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetIndexingRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIndexingRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetIndexingRulesRequestT = Model::GetIndexingRulesRequest>
  void GetIndexingRulesAsync(const GetIndexingRulesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetIndexingRulesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetInsight that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetInsightRequestT = Model::GetInsightRequest>
  void GetInsightAsync(const GetInsightRequestT& request, const GetInsightResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInsightEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInsightEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetInsightEventsRequestT = Model::GetInsightEventsRequest>
  void GetInsightEventsAsync(const GetInsightEventsRequestT& request, const GetInsightEventsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInsightImpactGraph that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInsightImpactGraph that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetInsightImpactGraphRequestT = Model::GetInsightImpactGraphRequest>
  void GetInsightImpactGraphAsync(const GetInsightImpactGraphRequestT& request, const GetInsightImpactGraphResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInsightSummaries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInsightSummaries that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetInsightSummariesRequestT = Model::GetInsightSummariesRequest>
  void GetInsightSummariesAsync(const GetInsightSummariesRequestT& request, const GetInsightSummariesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRetrievedTracesGraph that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRetrievedTracesGraph that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRetrievedTracesGraphRequestT = Model::GetRetrievedTracesGraphRequest>
  void GetRetrievedTracesGraphAsync(const GetRetrievedTracesGraphRequestT& request,
                                    const GetRetrievedTracesGraphResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSamplingRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSamplingRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSamplingRulesRequestT = Model::GetSamplingRulesRequest>
  void GetSamplingRulesAsync(const GetSamplingRulesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetSamplingRulesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSamplingStatisticSummariesOutcome GetSamplingStatisticSummaries(
      const Model::GetSamplingStatisticSummariesRequest& request = {}) const;

  /**
   * A Callable wrapper for GetSamplingStatisticSummaries that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSamplingStatisticSummariesRequestT = Model::GetSamplingStatisticSummariesRequest>
  Model::GetSamplingStatisticSummariesOutcomeCallable GetSamplingStatisticSummariesCallable(
      const GetSamplingStatisticSummariesRequestT& request = {}) const {
    return SubmitCallable(&XRayClient::GetSamplingStatisticSummaries, request);
  }

  /**
   * An Async wrapper for GetSamplingStatisticSummaries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSamplingStatisticSummariesRequestT = Model::GetSamplingStatisticSummariesRequest>
  void GetSamplingStatisticSummariesAsync(const GetSamplingStatisticSummariesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const GetSamplingStatisticSummariesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetSamplingTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSamplingTargets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSamplingTargetsRequestT = Model::GetSamplingTargetsRequest>
  void GetSamplingTargetsAsync(const GetSamplingTargetsRequestT& request, const GetSamplingTargetsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetServiceGraph that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetServiceGraphRequestT = Model::GetServiceGraphRequest>
  void GetServiceGraphAsync(const GetServiceGraphRequestT& request, const GetServiceGraphResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTimeSeriesServiceStatisticsOutcome GetTimeSeriesServiceStatistics(
      const Model::GetTimeSeriesServiceStatisticsRequest& request) const;

  /**
   * A Callable wrapper for GetTimeSeriesServiceStatistics that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetTimeSeriesServiceStatisticsRequestT = Model::GetTimeSeriesServiceStatisticsRequest>
  Model::GetTimeSeriesServiceStatisticsOutcomeCallable GetTimeSeriesServiceStatisticsCallable(
      const GetTimeSeriesServiceStatisticsRequestT& request) const {
    return SubmitCallable(&XRayClient::GetTimeSeriesServiceStatistics, request);
  }

  /**
   * An Async wrapper for GetTimeSeriesServiceStatistics that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetTimeSeriesServiceStatisticsRequestT = Model::GetTimeSeriesServiceStatisticsRequest>
  void GetTimeSeriesServiceStatisticsAsync(const GetTimeSeriesServiceStatisticsRequestT& request,
                                           const GetTimeSeriesServiceStatisticsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTraceGraph that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTraceGraphRequestT = Model::GetTraceGraphRequest>
  void GetTraceGraphAsync(const GetTraceGraphRequestT& request, const GetTraceGraphResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTraceSegmentDestinationOutcome GetTraceSegmentDestination(
      const Model::GetTraceSegmentDestinationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetTraceSegmentDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetTraceSegmentDestinationRequestT = Model::GetTraceSegmentDestinationRequest>
  Model::GetTraceSegmentDestinationOutcomeCallable GetTraceSegmentDestinationCallable(
      const GetTraceSegmentDestinationRequestT& request = {}) const {
    return SubmitCallable(&XRayClient::GetTraceSegmentDestination, request);
  }

  /**
   * An Async wrapper for GetTraceSegmentDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTraceSegmentDestinationRequestT = Model::GetTraceSegmentDestinationRequest>
  void GetTraceSegmentDestinationAsync(const GetTraceSegmentDestinationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const GetTraceSegmentDestinationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetTraceSummaries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTraceSummaries that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTraceSummariesRequestT = Model::GetTraceSummariesRequest>
  void GetTraceSummariesAsync(const GetTraceSummariesRequestT& request, const GetTraceSummariesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListResourcePoliciesRequestT = Model::ListResourcePoliciesRequest>
  void ListResourcePoliciesAsync(const ListResourcePoliciesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListResourcePoliciesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListRetrievedTraces that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRetrievedTraces that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRetrievedTracesRequestT = Model::ListRetrievedTracesRequest>
  void ListRetrievedTracesAsync(const ListRetrievedTracesRequestT& request, const ListRetrievedTracesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutEncryptionConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutEncryptionConfig that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutEncryptionConfigRequestT = Model::PutEncryptionConfigRequest>
  void PutEncryptionConfigAsync(const PutEncryptionConfigRequestT& request, const PutEncryptionConfigResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutTelemetryRecords that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutTelemetryRecords that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutTelemetryRecordsRequestT = Model::PutTelemetryRecordsRequest>
  void PutTelemetryRecordsAsync(const PutTelemetryRecordsRequestT& request, const PutTelemetryRecordsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutTraceSegments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutTraceSegments that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutTraceSegmentsRequestT = Model::PutTraceSegmentsRequest>
  void PutTraceSegmentsAsync(const PutTraceSegmentsRequestT& request, const PutTraceSegmentsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartTraceRetrieval that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartTraceRetrieval that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartTraceRetrievalRequestT = Model::StartTraceRetrievalRequest>
  void StartTraceRetrievalAsync(const StartTraceRetrievalRequestT& request, const StartTraceRetrievalResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateIndexingRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateIndexingRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateIndexingRuleRequestT = Model::UpdateIndexingRuleRequest>
  void UpdateIndexingRuleAsync(const UpdateIndexingRuleRequestT& request, const UpdateIndexingRuleResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSamplingRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSamplingRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateSamplingRuleRequestT = Model::UpdateSamplingRuleRequest>
  void UpdateSamplingRuleAsync(const UpdateSamplingRuleRequestT& request, const UpdateSamplingRuleResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateTraceSegmentDestinationOutcome UpdateTraceSegmentDestination(
      const Model::UpdateTraceSegmentDestinationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateTraceSegmentDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateTraceSegmentDestinationRequestT = Model::UpdateTraceSegmentDestinationRequest>
  Model::UpdateTraceSegmentDestinationOutcomeCallable UpdateTraceSegmentDestinationCallable(
      const UpdateTraceSegmentDestinationRequestT& request = {}) const {
    return SubmitCallable(&XRayClient::UpdateTraceSegmentDestination, request);
  }

  /**
   * An Async wrapper for UpdateTraceSegmentDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTraceSegmentDestinationRequestT = Model::UpdateTraceSegmentDestinationRequest>
  void UpdateTraceSegmentDestinationAsync(const UpdateTraceSegmentDestinationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const UpdateTraceSegmentDestinationRequestT& request = {}) const {
