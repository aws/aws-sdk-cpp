...
class BackendConnectionErrors {
 public:
  ...
  inline void SetTimeoutCount(int value) {
    m_timeoutCountHasBeenSet = true;
    m_timeoutCount = value;
  }
  inline BackendConnectionErrors& WithTimeoutCount(int value) {
  ...
  inline void SetConnectionRefusedCount(int value) {
    m_connectionRefusedCountHasBeenSet = true;
    m_connectionRefusedCount = value;
  }
  inline BackendConnectionErrors& WithConnectionRefusedCount(int value) {
    SetConnectionRefusedCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHTTPCode4XXCount(int value) {
    m_hTTPCode4XXCountHasBeenSet = true;
    m_hTTPCode4XXCount = value;
  }
  inline BackendConnectionErrors& WithHTTPCode4XXCount(int value) {
    SetHTTPCode4XXCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHTTPCode5XXCount(int value) {
    m_hTTPCode5XXCountHasBeenSet = true;
    m_hTTPCode5XXCount = value;
  }
  inline BackendConnectionErrors& WithHTTPCode5XXCount(int value) {
    SetHTTPCode5XXCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnknownHostCount(int value) {
    m_unknownHostCountHasBeenSet = true;
    m_unknownHostCount = value;
  }
  inline BackendConnectionErrors& WithUnknownHostCount(int value) {
    SetUnknownHostCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOtherCount(int value) {
    m_otherCountHasBeenSet = true;
    m_otherCount = value;
  }
  inline BackendConnectionErrors& WithOtherCount(int value) {
    SetOtherCount(value);
    return *this;
  }
  ///@}
