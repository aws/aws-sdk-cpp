...
namespace Model
{
  ...
  {
  public:
    AWS_XRAY_API CancelTraceRetrievalResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelTraceRetrievalResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
