...
class GetInsightImpactGraphResult {
 public:
  ...
  void SetServiceGraphStartTime(ServiceGraphStartTimeT&& value) {
    m_serviceGraphStartTimeHasBeenSet = true;
    m_serviceGraphStartTime = std::forward<ServiceGraphStartTimeT>(value);
  }
  template <typename ServiceGraphStartTimeT = Aws::Utils::DateTime>
  GetInsightImpactGraphResult& WithServiceGraphStartTime(ServiceGraphStartTimeT&& value) {
    SetServiceGraphStartTime(std::forward<ServiceGraphStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceGraphEndTime(ServiceGraphEndTimeT&& value) {
    m_serviceGraphEndTimeHasBeenSet = true;
    m_serviceGraphEndTime = std::forward<ServiceGraphEndTimeT>(value);
  }
  template <typename ServiceGraphEndTimeT = Aws::Utils::DateTime>
  GetInsightImpactGraphResult& WithServiceGraphEndTime(ServiceGraphEndTimeT&& value) {
    SetServiceGraphEndTime(std::forward<ServiceGraphEndTimeT>(value));
    return *this;
  }
  ///@}
