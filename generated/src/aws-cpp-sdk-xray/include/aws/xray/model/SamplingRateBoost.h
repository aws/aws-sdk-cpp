...
class SamplingRateBoost {
 public:
  ...
  inline void SetMaxRate(double value) {
    m_maxRateHasBeenSet = true;
    m_maxRate = value;
  }
  inline SamplingRateBoost& WithMaxRate(double value) {
    SetMaxRate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCooldownWindowMinutes(int value) {
    m_cooldownWindowMinutesHasBeenSet = true;
    m_cooldownWindowMinutes = value;
  }
  inline SamplingRateBoost& WithCooldownWindowMinutes(int value) {
    SetCooldownWindowMinutes(value);
    return *this;
  }
  ///@}
 private:
