...
class SamplingStatisticsDocument {
 public:
  ...
  inline SamplingStatisticsDocument& WithRequestCount(int value) {
  ...
  inline SamplingStatisticsDocument& WithSampledCount(int value) {
  ...
  inline SamplingStatisticsDocument& WithBorrowCount(int value) {
