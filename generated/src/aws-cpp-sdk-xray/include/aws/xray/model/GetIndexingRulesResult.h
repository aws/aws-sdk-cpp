...
class GetIndexingRulesResult {
 public:
  ...
  void SetIndexingRules(IndexingRulesT&& value) {
    m_indexingRulesHasBeenSet = true;
    m_indexingRules = std::forward<IndexingRulesT>(value);
  }
  template <typename IndexingRulesT = Aws::Vector<IndexingRule>>
  GetIndexingRulesResult& WithIndexingRules(IndexingRulesT&& value) {
    SetIndexingRules(std::forward<IndexingRulesT>(value));
    return *this;
  }
  template <typename IndexingRulesT = IndexingRule>
  GetIndexingRulesResult& AddIndexingRules(IndexingRulesT&& value) {
    m_indexingRulesHasBeenSet = true;
    m_indexingRules.emplace_back(std::forward<IndexingRulesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetIndexingRulesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetIndexingRulesResult& WithRequestId(RequestIdT&& value) {
