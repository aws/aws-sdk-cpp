...
class ForecastStatistics {
 public:
  ...
  inline void SetFaultCountHigh(long long value) {
    m_faultCountHighHasBeenSet = true;
    m_faultCountHigh = value;
  }
  inline ForecastStatistics& WithFaultCountHigh(long long value) {
    SetFaultCountHigh(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFaultCountLow(long long value) {
    m_faultCountLowHasBeenSet = true;
    m_faultCountLow = value;
  }
  inline ForecastStatistics& WithFaultCountLow(long long value) {
    SetFaultCountLow(value);
    return *this;
  }
  ///@}
 private:
