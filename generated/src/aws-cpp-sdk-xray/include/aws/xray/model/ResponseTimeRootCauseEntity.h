...
class ResponseTimeRootCauseEntity {
 public:
  ...
  inline void SetCoverage(double value) {
    m_coverageHasBeenSet = true;
    m_coverage = value;
  }
  inline ResponseTimeRootCauseEntity& WithCoverage(double value) {
    SetCoverage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRemote(bool value) {
    m_remoteHasBeenSet = true;
    m_remote = value;
  }
  inline ResponseTimeRootCauseEntity& WithRemote(bool value) {
    SetRemote(value);
    return *this;
  }
  ///@}
