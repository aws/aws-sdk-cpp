...
class ListTagsForResourceResult {
 public:
  AWS_XRAY_API ListTagsForResourceResult() = default;
  AWS_XRAY_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_XRAY_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
