...
class SamplingBoostStatisticsDocument {
 public:
  ...
  inline void SetAnomalyCount(int value) {
    m_anomalyCountHasBeenSet = true;
    m_anomalyCount = value;
  }
  inline SamplingBoostStatisticsDocument& WithAnomalyCount(int value) {
    SetAnomalyCount(value);
    return *this;
  }
  ///@}
  ...
  inline SamplingBoostStatisticsDocument& WithTotalCount(int value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSampledAnomalyCount(int value) {
    m_sampledAnomalyCountHasBeenSet = true;
    m_sampledAnomalyCount = value;
  }
  inline SamplingBoostStatisticsDocument& WithSampledAnomalyCount(int value) {
    SetSampledAnomalyCount(value);
    return *this;
  }
  ///@}
 private:
