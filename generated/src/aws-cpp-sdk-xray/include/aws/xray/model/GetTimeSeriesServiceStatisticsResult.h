...
class GetTimeSeriesServiceStatisticsResult {
 public:
  ...
  void SetTimeSeriesServiceStatistics(TimeSeriesServiceStatisticsT&& value) {
    m_timeSeriesServiceStatisticsHasBeenSet = true;
    m_timeSeriesServiceStatistics = std::forward<TimeSeriesServiceStatisticsT>(value);
  }
  template <typename TimeSeriesServiceStatisticsT = Aws::Vector<TimeSeriesServiceStatistics>>
  GetTimeSeriesServiceStatisticsResult& WithTimeSeriesServiceStatistics(TimeSeriesServiceStatisticsT&& value) {
    SetTimeSeriesServiceStatistics(std::forward<TimeSeriesServiceStatisticsT>(value));
    return *this;
  }
  template <typename TimeSeriesServiceStatisticsT = TimeSeriesServiceStatistics>
  GetTimeSeriesServiceStatisticsResult& AddTimeSeriesServiceStatistics(TimeSeriesServiceStatisticsT&& value) {
    m_timeSeriesServiceStatisticsHasBeenSet = true;
    m_timeSeriesServiceStatistics.emplace_back(std::forward<TimeSeriesServiceStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetContainsOldGroupVersions(bool value) {
    m_containsOldGroupVersionsHasBeenSet = true;
    m_containsOldGroupVersions = value;
  }
  inline GetTimeSeriesServiceStatisticsResult& WithContainsOldGroupVersions(bool value) {
    SetContainsOldGroupVersions(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetTimeSeriesServiceStatisticsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTimeSeriesServiceStatisticsResult& WithRequestId(RequestIdT&& value) {
