...
class InsightsConfiguration {
 public:
  ...
  inline void SetInsightsEnabled(bool value) {
    m_insightsEnabledHasBeenSet = true;
    m_insightsEnabled = value;
  }
  inline InsightsConfiguration& WithInsightsEnabled(bool value) {
  ...
  inline InsightsConfiguration& WithNotificationsEnabled(bool value) {
