...
class SamplingRule {
 public:
  ...
  inline SamplingRule& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline SamplingRule& WithFixedRate(double value) {
    SetFixedRate(value);
    return *this;
  }
  ///@}
  ...
  inline SamplingRule& WithReservoirSize(int value) {
  ...
  inline SamplingRule& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
