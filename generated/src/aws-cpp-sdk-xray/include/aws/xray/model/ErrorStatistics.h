...
class ErrorStatistics {
 public:
  ...
  inline void SetThrottleCount(long long value) {
    m_throttleCountHasBeenSet = true;
    m_throttleCount = value;
  }
  inline ErrorStatistics& WithThrottleCount(long long value) {
    SetThrottleCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOtherCount(long long value) {
    m_otherCountHasBeenSet = true;
    m_otherCount = value;
  }
  inline ErrorStatistics& WithOtherCount(long long value) {
    SetOtherCount(value);
    return *this;
  }
  ///@}
  ...
  inline ErrorStatistics& WithTotalCount(long long value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
