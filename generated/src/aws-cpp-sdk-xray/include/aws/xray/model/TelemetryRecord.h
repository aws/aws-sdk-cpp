...
class TelemetryRecord {
 public:
  ...
  inline void SetSegmentsReceivedCount(int value) {
    m_segmentsReceivedCountHasBeenSet = true;
    m_segmentsReceivedCount = value;
  }
  inline TelemetryRecord& WithSegmentsReceivedCount(int value) {
    SetSegmentsReceivedCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSegmentsSentCount(int value) {
    m_segmentsSentCountHasBeenSet = true;
    m_segmentsSentCount = value;
  }
  inline TelemetryRecord& WithSegmentsSentCount(int value) {
    SetSegmentsSentCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSegmentsSpilloverCount(int value) {
    m_segmentsSpilloverCountHasBeenSet = true;
    m_segmentsSpilloverCount = value;
  }
  inline TelemetryRecord& WithSegmentsSpilloverCount(int value) {
    SetSegmentsSpilloverCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSegmentsRejectedCount(int value) {
    m_segmentsRejectedCountHasBeenSet = true;
    m_segmentsRejectedCount = value;
  }
  inline TelemetryRecord& WithSegmentsRejectedCount(int value) {
    SetSegmentsRejectedCount(value);
    return *this;
  }
  ///@}
  ...
  void SetBackendConnectionErrors(BackendConnectionErrorsT&& value) {
    ...
    m_backendConnectionErrors = std::forward<BackendConnectionErrorsT>(value);
  }
  template <typename BackendConnectionErrorsT = BackendConnectionErrors>
  TelemetryRecord& WithBackendConnectionErrors(BackendConnectionErrorsT&& value) {
    SetBackendConnectionErrors(std::forward<BackendConnectionErrorsT>(value));
    return *this;
  }
  ///@}
 private:
