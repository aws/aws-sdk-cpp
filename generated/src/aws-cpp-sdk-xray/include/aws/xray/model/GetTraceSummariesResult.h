...
class GetTraceSummariesResult {
 public:
  ...
  void SetTraceSummaries(TraceSummariesT&& value) {
    m_traceSummariesHasBeenSet = true;
    m_traceSummaries = std::forward<TraceSummariesT>(value);
  }
  template <typename TraceSummariesT = Aws::Vector<TraceSummary>>
  GetTraceSummariesResult& WithTraceSummaries(TraceSummariesT&& value) {
    SetTraceSummaries(std::forward<TraceSummariesT>(value));
    return *this;
  }
  template <typename TraceSummariesT = TraceSummary>
  GetTraceSummariesResult& AddTraceSummaries(TraceSummariesT&& value) {
    m_traceSummariesHasBeenSet = true;
    m_traceSummaries.emplace_back(std::forward<TraceSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApproximateTime(ApproximateTimeT&& value) {
    ...
    m_approximateTime = std::forward<ApproximateTimeT>(value);
  }
  template <typename ApproximateTimeT = Aws::Utils::DateTime>
  GetTraceSummariesResult& WithApproximateTime(ApproximateTimeT&& value) {
    SetApproximateTime(std::forward<ApproximateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTracesProcessedCount(long long value) {
    m_tracesProcessedCountHasBeenSet = true;
    m_tracesProcessedCount = value;
  }
  inline GetTraceSummariesResult& WithTracesProcessedCount(long long value) {
    SetTracesProcessedCount(value);
    return *this;
  }
  ///@}
