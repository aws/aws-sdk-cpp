...
class GetSamplingTargetsResult {
 public:
  ...
  void SetSamplingTargetDocuments(SamplingTargetDocumentsT&& value) {
    ...
    m_samplingTargetDocuments = std::forward<SamplingTargetDocumentsT>(value);
  }
  template <typename SamplingTargetDocumentsT = Aws::Vector<SamplingTargetDocument>>
  GetSamplingTargetsResult& WithSamplingTargetDocuments(SamplingTargetDocumentsT&& value) {
    SetSamplingTargetDocuments(std::forward<SamplingTargetDocumentsT>(value));
    return *this;
  }
  ...
  GetSamplingTargetsResult& AddSamplingTargetDocuments(SamplingTargetDocumentsT&& value) {
    m_samplingTargetDocumentsHasBeenSet = true;
    m_samplingTargetDocuments.emplace_back(std::forward<SamplingTargetDocumentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastRuleModification(LastRuleModificationT&& value) {
    ...
    m_lastRuleModification = std::forward<LastRuleModificationT>(value);
  }
  template <typename LastRuleModificationT = Aws::Utils::DateTime>
  GetSamplingTargetsResult& WithLastRuleModification(LastRuleModificationT&& value) {
    SetLastRuleModification(std::forward<LastRuleModificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnprocessedStatistics(UnprocessedStatisticsT&& value) {
    ...
    m_unprocessedStatistics = std::forward<UnprocessedStatisticsT>(value);
  }
  template <typename UnprocessedStatisticsT = Aws::Vector<UnprocessedStatistics>>
  GetSamplingTargetsResult& WithUnprocessedStatistics(UnprocessedStatisticsT&& value) {
    SetUnprocessedStatistics(std::forward<UnprocessedStatisticsT>(value));
    return *this;
  }
  ...
  GetSamplingTargetsResult& AddUnprocessedStatistics(UnprocessedStatisticsT&& value) {
    m_unprocessedStatisticsHasBeenSet = true;
    m_unprocessedStatistics.emplace_back(std::forward<UnprocessedStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnprocessedBoostStatistics(UnprocessedBoostStatisticsT&& value) {
    ...
    m_unprocessedBoostStatistics = std::forward<UnprocessedBoostStatisticsT>(value);
  }
  template <typename UnprocessedBoostStatisticsT = Aws::Vector<UnprocessedStatistics>>
  GetSamplingTargetsResult& WithUnprocessedBoostStatistics(UnprocessedBoostStatisticsT&& value) {
    SetUnprocessedBoostStatistics(std::forward<UnprocessedBoostStatisticsT>(value));
    return *this;
  }
  ...
  GetSamplingTargetsResult& AddUnprocessedBoostStatistics(UnprocessedBoostStatisticsT&& value) {
    m_unprocessedBoostStatisticsHasBeenSet = true;
    m_unprocessedBoostStatistics.emplace_back(std::forward<UnprocessedBoostStatisticsT>(value));
    return *this;
  }
  ///@}
