...
class EdgeStatistics {
 public:
  ...
  inline EdgeStatistics& WithOkCount(long long value) {
    SetOkCount(value);
    return *this;
  }
  ///@}
  ...
  inline EdgeStatistics& WithTotalCount(long long value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
  ...
  inline EdgeStatistics& WithTotalResponseTime(double value) {
