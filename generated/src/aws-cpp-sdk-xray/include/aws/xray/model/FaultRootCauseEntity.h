...
class FaultRootCauseEntity {
 public:
  AWS_XRAY_API FaultRootCauseEntity() = default;
  ...
  template <typename NameT = Aws::String>
  FaultRootCauseEntity& WithName(NameT&& value) {
  ...
  template <typename ExceptionsT = Aws::Vector<RootCauseException>>
  FaultRootCauseEntity& WithExceptions(ExceptionsT&& value) {
    SetExceptions(std::forward<ExceptionsT>(value));
    return *this;
  }
  template <typename ExceptionsT = RootCauseException>
  FaultRootCauseEntity& AddExceptions(ExceptionsT&& value) {
    m_exceptionsHasBeenSet = true;
  ...
  inline FaultRootCauseEntity& WithRemote(bool value) {
    SetRemote(value);
    return *this;
  }
  ///@}
