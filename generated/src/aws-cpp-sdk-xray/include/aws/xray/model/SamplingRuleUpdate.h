...
class SamplingRuleUpdate {
 public:
  ...
  inline SamplingRuleUpdate& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFixedRate(double value) {
    m_fixedRateHasBeenSet = true;
    m_fixedRate = value;
  }
  inline SamplingRuleUpdate& WithFixedRate(double value) {
    SetFixedRate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReservoirSize(int value) {
    m_reservoirSizeHasBeenSet = true;
    m_reservoirSize = value;
  }
  inline SamplingRuleUpdate& WithReservoirSize(int value) {
    SetReservoirSize(value);
    return *this;
  }
  ///@}
  ...
  void SetServiceType(ServiceTypeT&& value) {
    ...
    m_serviceType = std::forward<ServiceTypeT>(value);
  }
  template <typename ServiceTypeT = Aws::String>
  SamplingRuleUpdate& WithServiceType(ServiceTypeT&& value) {
    SetServiceType(std::forward<ServiceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetURLPath(URLPathT&& value) {
    ...
    m_uRLPath = std::forward<URLPathT>(value);
  }
  template <typename URLPathT = Aws::String>
  SamplingRuleUpdate& WithURLPath(URLPathT&& value) {
    SetURLPath(std::forward<URLPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSamplingRateBoost(SamplingRateBoostT&& value) {
    ...
    m_samplingRateBoost = std::forward<SamplingRateBoostT>(value);
  }
  template <typename SamplingRateBoostT = SamplingRateBoost>
  SamplingRuleUpdate& WithSamplingRateBoost(SamplingRateBoostT&& value) {
    SetSamplingRateBoost(std::forward<SamplingRateBoostT>(value));
    return *this;
  }
  ///@}
 private:
