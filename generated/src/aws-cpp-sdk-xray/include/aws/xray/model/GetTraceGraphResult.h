...
class GetTraceGraphResult {
 public:
  ...
  template <typename ServicesT = Aws::Vector<Service>>
  GetTraceGraphResult& WithServices(ServicesT&& value) {
    SetServices(std::forward<ServicesT>(value));
    return *this;
  }
  template <typename ServicesT = Service>
  GetTraceGraphResult& AddServices(ServicesT&& value) {
    m_servicesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetTraceGraphResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTraceGraphResult& WithRequestId(RequestIdT&& value) {
