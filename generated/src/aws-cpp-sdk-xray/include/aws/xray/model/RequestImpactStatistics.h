...
class RequestImpactStatistics {
 public:
  ...
  inline void SetFaultCount(long long value) {
    m_faultCountHasBeenSet = true;
    m_faultCount = value;
  }
  inline RequestImpactStatistics& WithFaultCount(long long value) {
    SetFaultCount(value);
    return *this;
  }
  ///@}
  ...
  inline RequestImpactStatistics& WithOkCount(long long value) {
    SetOkCount(value);
    return *this;
  }
  ///@}
  ...
  inline RequestImpactStatistics& WithTotalCount(long long value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
