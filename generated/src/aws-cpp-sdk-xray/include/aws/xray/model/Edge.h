...
class Edge {
 public:
  ...
  inline Edge& WithReferenceId(int value) {
  ...
  void SetEdgeType(EdgeTypeT&& value) {
    ...
    m_edgeType = std::forward<EdgeTypeT>(value);
  }
  template <typename EdgeTypeT = Aws::String>
  Edge& WithEdgeType(EdgeTypeT&& value) {
    SetEdgeType(std::forward<EdgeTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReceivedEventAgeHistogram(ReceivedEventAgeHistogramT&& value) {
    ...
    m_receivedEventAgeHistogram = std::forward<ReceivedEventAgeHistogramT>(value);
  }
  template <typename ReceivedEventAgeHistogramT = Aws::Vector<HistogramEntry>>
  Edge& WithReceivedEventAgeHistogram(ReceivedEventAgeHistogramT&& value) {
    SetReceivedEventAgeHistogram(std::forward<ReceivedEventAgeHistogramT>(value));
    return *this;
  }
  ...
  Edge& AddReceivedEventAgeHistogram(ReceivedEventAgeHistogramT&& value) {
    m_receivedEventAgeHistogramHasBeenSet = true;
    m_receivedEventAgeHistogram.emplace_back(std::forward<ReceivedEventAgeHistogramT>(value));
    return *this;
  }
  ///@}
 private:
