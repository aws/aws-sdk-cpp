...
class GetTimeSeriesServiceStatisticsRequest : public XRayRequest {
 public:
  ...
  void SetEntitySelectorExpression(EntitySelectorExpressionT&& value) {
    m_entitySelectorExpressionHasBeenSet = true;
    m_entitySelectorExpression = std::forward<EntitySelectorExpressionT>(value);
  }
  template <typename EntitySelectorExpressionT = Aws::String>
  GetTimeSeriesServiceStatisticsRequest& WithEntitySelectorExpression(EntitySelectorExpressionT&& value) {
    SetEntitySelectorExpression(std::forward<EntitySelectorExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetTimeSeriesServiceStatisticsRequest& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline void SetForecastStatistics(bool value) {
    m_forecastStatisticsHasBeenSet = true;
    m_forecastStatistics = value;
  }
  inline GetTimeSeriesServiceStatisticsRequest& WithForecastStatistics(bool value) {
    SetForecastStatistics(value);
    return *this;
  }
  ///@}
