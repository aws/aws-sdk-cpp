...
class UpdateIndexingRuleResult {
 public:
  ...
  void SetIndexingRule(IndexingRuleT&& value) {
    m_indexingRuleHasBeenSet = true;
    m_indexingRule = std::forward<IndexingRuleT>(value);
  }
  template <typename IndexingRuleT = IndexingRule>
  UpdateIndexingRuleResult& WithIndexingRule(IndexingRuleT&& value) {
    SetIndexingRule(std::forward<IndexingRuleT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateIndexingRuleResult& WithRequestId(RequestIdT&& value) {
