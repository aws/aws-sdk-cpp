...
class PutTelemetryRecordsRequest : public XRayRequest {
 public:
  ...
  void SetTelemetryRecords(TelemetryRecordsT&& value) {
    m_telemetryRecordsHasBeenSet = true;
    m_telemetryRecords = std::forward<TelemetryRecordsT>(value);
  }
  template <typename TelemetryRecordsT = Aws::Vector<TelemetryRecord>>
  PutTelemetryRecordsRequest& WithTelemetryRecords(TelemetryRecordsT&& value) {
    SetTelemetryRecords(std::forward<TelemetryRecordsT>(value));
    return *this;
  }
  template <typename TelemetryRecordsT = TelemetryRecord>
  PutTelemetryRecordsRequest& AddTelemetryRecords(TelemetryRecordsT&& value) {
    m_telemetryRecordsHasBeenSet = true;
    m_telemetryRecords.emplace_back(std::forward<TelemetryRecordsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EC2InstanceIdT = Aws::String>
  PutTelemetryRecordsRequest& WithEC2InstanceId(EC2InstanceIdT&& value) {
  ...
  template <typename HostnameT = Aws::String>
  PutTelemetryRecordsRequest& WithHostname(HostnameT&& value) {
  ...
  template <typename ResourceARNT = Aws::String>
  PutTelemetryRecordsRequest& WithResourceARN(ResourceARNT&& value) {
