...
class GetInsightEventsResult {
 public:
  ...
  void SetInsightEvents(InsightEventsT&& value) {
    m_insightEventsHasBeenSet = true;
    m_insightEvents = std::forward<InsightEventsT>(value);
  }
  template <typename InsightEventsT = Aws::Vector<InsightEvent>>
  GetInsightEventsResult& WithInsightEvents(InsightEventsT&& value) {
    SetInsightEvents(std::forward<InsightEventsT>(value));
    return *this;
  }
  template <typename InsightEventsT = InsightEvent>
  GetInsightEventsResult& AddInsightEvents(InsightEventsT&& value) {
    m_insightEventsHasBeenSet = true;
    m_insightEvents.emplace_back(std::forward<InsightEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetInsightEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetInsightEventsResult& WithRequestId(RequestIdT&& value) {
