...
class UpdateTraceSegmentDestinationResult {
 public:
  ...
  inline void SetDestination(TraceSegmentDestination value) {
    m_destinationHasBeenSet = true;
    m_destination = value;
  }
  inline UpdateTraceSegmentDestinationResult& WithDestination(TraceSegmentDestination value) {
  ...
  inline void SetStatus(TraceSegmentDestinationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateTraceSegmentDestinationResult& WithStatus(TraceSegmentDestinationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
