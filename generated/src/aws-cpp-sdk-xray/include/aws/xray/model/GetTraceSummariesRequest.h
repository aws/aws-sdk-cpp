...
class GetTraceSummariesRequest : public XRayRequest {
 public:
  ...
  inline void SetTimeRangeType(TimeRangeType value) {
    m_timeRangeTypeHasBeenSet = true;
    m_timeRangeType = value;
  }
  inline GetTraceSummariesRequest& WithTimeRangeType(TimeRangeType value) {
  ...
  inline void SetSampling(bool value) {
    m_samplingHasBeenSet = true;
    m_sampling = value;
  }
  inline GetTraceSummariesRequest& WithSampling(bool value) {
    SetSampling(value);
    return *this;
  }
  ///@}
  ...
  void SetSamplingStrategy(SamplingStrategyT&& value) {
    m_samplingStrategyHasBeenSet = true;
    m_samplingStrategy = std::forward<SamplingStrategyT>(value);
  }
  template <typename SamplingStrategyT = SamplingStrategy>
  GetTraceSummariesRequest& WithSamplingStrategy(SamplingStrategyT&& value) {
    SetSamplingStrategy(std::forward<SamplingStrategyT>(value));
    return *this;
  }
  ///@}
