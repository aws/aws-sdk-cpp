...
class PutResourcePolicyRequest : public XRayRequest {
 public:
  ...
  inline void SetBypassPolicyLockoutCheck(bool value) {
    m_bypassPolicyLockoutCheckHasBeenSet = true;
    m_bypassPolicyLockoutCheck = value;
  }
  inline PutResourcePolicyRequest& WithBypassPolicyLockoutCheck(bool value) {
    SetBypassPolicyLockoutCheck(value);
    return *this;
  }
  ///@}
 private:
