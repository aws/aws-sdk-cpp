...
class InsightSummary {
 public:
  ...
  void SetRootCauseServiceId(RootCauseServiceIdT&& value) {
    ...
    m_rootCauseServiceId = std::forward<RootCauseServiceIdT>(value);
  }
  template <typename RootCauseServiceIdT = ServiceId>
  InsightSummary& WithRootCauseServiceId(RootCauseServiceIdT&& value) {
    SetRootCauseServiceId(std::forward<RootCauseServiceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline InsightSummary& AddCategories(InsightCategory value) {
    m_categoriesHasBeenSet = true;
  ...
  inline void SetState(InsightState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline InsightSummary& WithState(InsightState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetClientRequestImpactStatistics(ClientRequestImpactStatisticsT&& value) {
    ...
    m_clientRequestImpactStatistics = std::forward<ClientRequestImpactStatisticsT>(value);
  }
  template <typename ClientRequestImpactStatisticsT = RequestImpactStatistics>
  InsightSummary& WithClientRequestImpactStatistics(ClientRequestImpactStatisticsT&& value) {
    SetClientRequestImpactStatistics(std::forward<ClientRequestImpactStatisticsT>(value));
    return *this;
  }
  ///@}
   ...
   * </p>
   */
  inline const RequestImpactStatistics& GetRootCauseServiceRequestImpactStatistics() const {
    return m_rootCauseServiceRequestImpactStatistics;
  }
  ...
  void SetRootCauseServiceRequestImpactStatistics(RootCauseServiceRequestImpactStatisticsT&& value) {
    ...
    m_rootCauseServiceRequestImpactStatistics = std::forward<RootCauseServiceRequestImpactStatisticsT>(value);
  }
  template <typename RootCauseServiceRequestImpactStatisticsT = RequestImpactStatistics>
  InsightSummary& WithRootCauseServiceRequestImpactStatistics(RootCauseServiceRequestImpactStatisticsT&& value) {
    SetRootCauseServiceRequestImpactStatistics(std::forward<RootCauseServiceRequestImpactStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTopAnomalousServices(TopAnomalousServicesT&& value) {
    ...
    m_topAnomalousServices = std::forward<TopAnomalousServicesT>(value);
  }
  template <typename TopAnomalousServicesT = Aws::Vector<AnomalousService>>
  InsightSummary& WithTopAnomalousServices(TopAnomalousServicesT&& value) {
    SetTopAnomalousServices(std::forward<TopAnomalousServicesT>(value));
    return *this;
  }
  ...
  InsightSummary& AddTopAnomalousServices(TopAnomalousServicesT&& value) {
    m_topAnomalousServicesHasBeenSet = true;
    m_topAnomalousServices.emplace_back(std::forward<TopAnomalousServicesT>(value));
    return *this;
  }
  ///@}
