...
class UpdateSamplingRuleRequest : public XRayRequest {
 public:
  ...
  void SetSamplingRuleUpdate(SamplingRuleUpdateT&& value) {
    m_samplingRuleUpdateHasBeenSet = true;
    m_samplingRuleUpdate = std::forward<SamplingRuleUpdateT>(value);
  }
  template <typename SamplingRuleUpdateT = SamplingRuleUpdate>
  UpdateSamplingRuleRequest& WithSamplingRuleUpdate(SamplingRuleUpdateT&& value) {
    SetSamplingRuleUpdate(std::forward<SamplingRuleUpdateT>(value));
    return *this;
  }
  ///@}
 private:
