...
namespace Model
{
  ...
  public:
    ...
    template<typename GroupARNT = Aws::String>
    GroupSummary& WithGroupARN(GroupARNT&& value) { SetGroupARN(std::forward<GroupARNT>(value)); return *this;}
    ///@}
    ...
    template<typename FilterExpressionT = Aws::String>
    GroupSummary& WithFilterExpression(FilterExpressionT&& value) { SetFilterExpression(std::forward<FilterExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename InsightsConfigurationT = InsightsConfiguration>
    GroupSummary& WithInsightsConfiguration(InsightsConfigurationT&& value) { SetInsightsConfiguration(std::forward<InsightsConfigurationT>(value)); return *this;}
    ///@}
  private:
