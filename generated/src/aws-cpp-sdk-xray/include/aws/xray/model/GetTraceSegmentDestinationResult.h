...
class GetTraceSegmentDestinationResult {
 public:
  AWS_XRAY_API GetTraceSegmentDestinationResult() = default;
  ...
  inline GetTraceSegmentDestinationResult& WithDestination(TraceSegmentDestination value) {
  ...
  inline GetTraceSegmentDestinationResult& WithStatus(TraceSegmentDestinationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
