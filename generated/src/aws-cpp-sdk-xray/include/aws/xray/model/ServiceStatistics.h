...
class ServiceStatistics {
 public:
  ...
  inline ServiceStatistics& WithOkCount(long long value) {
    SetOkCount(value);
    return *this;
  }
  ///@}
  ...
  void SetErrorStatistics(ErrorStatisticsT&& value) {
    ...
    m_errorStatistics = std::forward<ErrorStatisticsT>(value);
  }
  template <typename ErrorStatisticsT = ErrorStatistics>
  ServiceStatistics& WithErrorStatistics(ErrorStatisticsT&& value) {
    SetErrorStatistics(std::forward<ErrorStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFaultStatistics(FaultStatisticsT&& value) {
    ...
    m_faultStatistics = std::forward<FaultStatisticsT>(value);
  }
  template <typename FaultStatisticsT = FaultStatistics>
  ServiceStatistics& WithFaultStatistics(FaultStatisticsT&& value) {
    SetFaultStatistics(std::forward<FaultStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ServiceStatistics& WithTotalCount(long long value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalResponseTime(double value) {
    m_totalResponseTimeHasBeenSet = true;
    m_totalResponseTime = value;
  }
  inline ServiceStatistics& WithTotalResponseTime(double value) {
    SetTotalResponseTime(value);
    return *this;
  }
  ///@}
 private:
