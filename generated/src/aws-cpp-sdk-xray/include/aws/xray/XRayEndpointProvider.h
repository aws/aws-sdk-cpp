 ...
 */
using XRayEndpointProviderBase = EndpointProviderBase<XRayClientConfiguration, XRayBuiltInParameters, XRayClientContextParameters>;

using XRayDefaultEpProviderBase = DefaultEndpointProvider<XRayClientConfiguration, XRayBuiltInParameters, XRayClientContextParameters>;
