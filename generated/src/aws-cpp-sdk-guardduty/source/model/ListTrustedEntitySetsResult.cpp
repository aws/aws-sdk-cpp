...
ListTrustedEntitySetsResult::ListTrustedEntitySetsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListTrustedEntitySetsResult& ListTrustedEntitySetsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("trustedEntitySetIds")) {
    ...
    for (unsigned trustedEntitySetIdsIndex = 0; trustedEntitySetIdsIndex < trustedEntitySetIdsJsonList.GetLength();
         ++trustedEntitySetIdsIndex) {
