...
DeletePublishingDestinationResult::DeletePublishingDestinationResult()
{
}

DeletePublishingDestinationResult::DeletePublishingDestinationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
