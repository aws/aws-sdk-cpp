...
CoverageStatistics::CoverageStatistics(JsonView jsonValue) { *this = jsonValue; }
...
CoverageStatistics& CoverageStatistics::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("countByResourceType")) {
    ...
    for (auto& countByResourceTypeItem : countByResourceTypeJsonMap) {
      m_countByResourceType[ResourceTypeMapper::GetResourceTypeForName(countByResourceTypeItem.first)] =
          countByResourceTypeItem.second.AsInt64();
    }
  ...
  if (jsonValue.ValueExists("countByCoverageStatus")) {
    ...
    for (auto& countByCoverageStatusItem : countByCoverageStatusJsonMap) {
      m_countByCoverageStatus[CoverageStatusMapper::GetCoverageStatusForName(countByCoverageStatusItem.first)] =
          countByCoverageStatusItem.second.AsInt64();
    }
...
JsonValue CoverageStatistics::Jsonize() const {
  ...
  if (m_countByResourceTypeHasBeenSet) {
    ...
    for (auto& countByResourceTypeItem : m_countByResourceType) {
      countByResourceTypeJsonMap.WithInt64(ResourceTypeMapper::GetNameForResourceType(countByResourceTypeItem.first),
                                           countByResourceTypeItem.second);
    }
  ...
  if (m_countByCoverageStatusHasBeenSet) {
    ...
    for (auto& countByCoverageStatusItem : m_countByCoverageStatus) {
      countByCoverageStatusJsonMap.WithInt64(CoverageStatusMapper::GetNameForCoverageStatus(countByCoverageStatusItem.first),
                                             countByCoverageStatusItem.second);
    }
