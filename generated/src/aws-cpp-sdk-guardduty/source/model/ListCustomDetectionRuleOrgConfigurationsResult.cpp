...
ListCustomDetectionRuleOrgConfigurationsResult::ListCustomDetectionRuleOrgConfigurationsResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListCustomDetectionRuleOrgConfigurationsResult& ListCustomDetectionRuleOrgConfigurationsResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
