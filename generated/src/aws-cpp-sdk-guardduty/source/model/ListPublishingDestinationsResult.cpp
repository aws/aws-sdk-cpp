...
ListPublishingDestinationsResult::ListPublishingDestinationsResult()
{
}

ListPublishingDestinationsResult::ListPublishingDestinationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
