...
Ec2Instance::Ec2Instance(JsonView jsonValue) { *this = jsonValue; }
...
Ec2Instance& Ec2Instance::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ec2NetworkInterfaceUids")) {
    ...
    for (unsigned ec2NetworkInterfaceUidsIndex = 0; ec2NetworkInterfaceUidsIndex < ec2NetworkInterfaceUidsJsonList.GetLength();
         ++ec2NetworkInterfaceUidsIndex) {
