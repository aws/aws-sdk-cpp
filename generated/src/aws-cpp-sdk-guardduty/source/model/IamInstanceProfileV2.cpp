...
IamInstanceProfileV2::IamInstanceProfileV2(JsonView jsonValue) { *this = jsonValue; }

IamInstanceProfileV2& IamInstanceProfileV2::operator=(JsonView jsonValue) {
...
JsonValue IamInstanceProfileV2::Jsonize() const {
  JsonValue payload;
