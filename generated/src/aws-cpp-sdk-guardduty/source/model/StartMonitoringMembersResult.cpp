...
StartMonitoringMembersResult::StartMonitoringMembersResult()
{
}

StartMonitoringMembersResult::StartMonitoringMembersResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

StartMonitoringMembersResult& StartMonitoringMembersResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
