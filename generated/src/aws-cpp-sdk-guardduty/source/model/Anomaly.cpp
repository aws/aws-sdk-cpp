  ...
  if (m_profilesHasBeenSet) {
    ...
    for (auto& profilesItem : m_profiles) {
      ...
      for (auto& anomalyProfileFeaturesItem : profilesItem.second) {
        ...
        for (unsigned anomalyProfileFeatureObjectsIndex = 0;
             anomalyProfileFeatureObjectsIndex < anomalyProfileFeatureObjectsJsonList.GetLength(); ++anomalyProfileFeatureObjectsIndex) {
          anomalyProfileFeatureObjectsJsonList[anomalyProfileFeatureObjectsIndex].AsObject(
              anomalyProfileFeaturesItem.second[anomalyProfileFeatureObjectsIndex].Jsonize());
        }
