...
PublicAccessConfiguration::PublicAccessConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
PublicAccessConfiguration& PublicAccessConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("publicAclIgnoreBehavior")) {
    m_publicAclIgnoreBehavior =
        PublicAclIgnoreBehaviorMapper::GetPublicAclIgnoreBehaviorForName(jsonValue.GetString("publicAclIgnoreBehavior"));
  ...
  if (jsonValue.ValueExists("publicBucketRestrictBehavior")) {
    m_publicBucketRestrictBehavior =
        PublicBucketRestrictBehaviorMapper::GetPublicBucketRestrictBehaviorForName(jsonValue.GetString("publicBucketRestrictBehavior"));
...
JsonValue PublicAccessConfiguration::Jsonize() const {
  ...
  if (m_publicAclIgnoreBehaviorHasBeenSet) {
    payload.WithString("publicAclIgnoreBehavior",
                       PublicAclIgnoreBehaviorMapper::GetNameForPublicAclIgnoreBehavior(m_publicAclIgnoreBehavior));
  }

  if (m_publicBucketRestrictBehaviorHasBeenSet) {
    payload.WithString("publicBucketRestrictBehavior",
                       PublicBucketRestrictBehaviorMapper::GetNameForPublicBucketRestrictBehavior(m_publicBucketRestrictBehavior));
  }
