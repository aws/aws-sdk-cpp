...
Aws::String CreateThreatEntitySetRequest::SerializePayload() const
{
  JsonValue payload;
  ...
  {
   payload.WithString("format", ThreatEntitySetFormatMapper::GetNameForThreatEntitySetFormat(m_format));
  }
