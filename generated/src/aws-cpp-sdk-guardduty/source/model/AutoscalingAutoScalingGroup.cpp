...
AutoscalingAutoScalingGroup::AutoscalingAutoScalingGroup(JsonView jsonValue) { *this = jsonValue; }

AutoscalingAutoScalingGroup& AutoscalingAutoScalingGroup::operator=(JsonView jsonValue) {
...
JsonValue AutoscalingAutoScalingGroup::Jsonize() const {
  JsonValue payload;
