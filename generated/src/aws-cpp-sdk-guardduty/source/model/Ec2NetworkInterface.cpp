...
Ec2NetworkInterface::Ec2NetworkInterface(JsonView jsonValue) { *this = jsonValue; }
...
Ec2NetworkInterface& Ec2NetworkInterface::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("privateIpAddresses")) {
    ...
    for (unsigned privateIpAddressesIndex = 0; privateIpAddressesIndex < privateIpAddressesJsonList.GetLength();
         ++privateIpAddressesIndex) {
