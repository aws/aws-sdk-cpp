...
Aws::String CreateTrustedEntitySetRequest::SerializePayload() const
{
  JsonValue payload;
  ...
  {
   payload.WithString("format", TrustedEntitySetFormatMapper::GetNameForTrustedEntitySetFormat(m_format));
  }
