...
ListThreatEntitySetsResult::ListThreatEntitySetsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListThreatEntitySetsResult& ListThreatEntitySetsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("threatEntitySetIds")) {
    ...
    for (unsigned threatEntitySetIdsIndex = 0; threatEntitySetIdsIndex < threatEntitySetIdsJsonList.GetLength();
         ++threatEntitySetIdsIndex) {
