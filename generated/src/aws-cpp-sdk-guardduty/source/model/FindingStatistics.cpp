...
FindingStatistics::FindingStatistics(JsonView jsonValue) { *this = jsonValue; }
...
FindingStatistics& FindingStatistics::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("groupedByFindingType")) {
    ...
    for (unsigned groupedByFindingTypeIndex = 0; groupedByFindingTypeIndex < groupedByFindingTypeJsonList.GetLength();
         ++groupedByFindingTypeIndex) {
