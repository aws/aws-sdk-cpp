...
namespace GuardDuty
{
const size_t GuardDutyEndpointRules::RulesBlobStrLen = 3965;
const size_t GuardDutyEndpointRules::RulesBlobSize = 3966;
...
':','/','/','g','u','a','r','d','d','u','t','y','.','{','R','e','g','i','o','n','}','.','{','P','a',
