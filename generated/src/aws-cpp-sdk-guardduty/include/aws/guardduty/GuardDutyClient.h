...
namespace GuardDuty
{
   ...
   */
  class AWS_GUARDDUTY_API GuardDutyClient : Aws::Client::ClientWithAsyncTemplateMethods<GuardDutyClient>,
    smithy::client::AwsSmithyClientT<Aws::GuardDuty::SERVICE_NAME,
