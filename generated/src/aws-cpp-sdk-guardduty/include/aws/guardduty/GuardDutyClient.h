...
class AWS_GUARDDUTY_API GuardDutyClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  GuardDutyClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<GuardDutyEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for ArchiveFindings that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ArchiveFindingsRequestT = Model::ArchiveFindingsRequest>
  void ArchiveFindingsAsync(const ArchiveFindingsRequestT& request, const ArchiveFindingsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateDetector that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateDetectorRequestT = Model::CreateDetectorRequest>
  void CreateDetectorAsync(const CreateDetectorRequestT& request, const CreateDetectorResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateMalwareProtectionPlanOutcome CreateMalwareProtectionPlan(
      const Model::CreateMalwareProtectionPlanRequest& request) const;

  /**
   * A Callable wrapper for CreateMalwareProtectionPlan that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateMalwareProtectionPlanRequestT = Model::CreateMalwareProtectionPlanRequest>
  Model::CreateMalwareProtectionPlanOutcomeCallable CreateMalwareProtectionPlanCallable(
      const CreateMalwareProtectionPlanRequestT& request) const {
    return SubmitCallable(&GuardDutyClient::CreateMalwareProtectionPlan, request);
  }

  /**
   * An Async wrapper for CreateMalwareProtectionPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMalwareProtectionPlanRequestT = Model::CreateMalwareProtectionPlanRequest>
  void CreateMalwareProtectionPlanAsync(const CreateMalwareProtectionPlanRequestT& request,
                                        const CreateMalwareProtectionPlanResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePublishingDestinationOutcome CreatePublishingDestination(
      const Model::CreatePublishingDestinationRequest& request) const;

  /**
   * A Callable wrapper for CreatePublishingDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePublishingDestinationRequestT = Model::CreatePublishingDestinationRequest>
  Model::CreatePublishingDestinationOutcomeCallable CreatePublishingDestinationCallable(
      const CreatePublishingDestinationRequestT& request) const {
    return SubmitCallable(&GuardDutyClient::CreatePublishingDestination, request);
  }

  /**
   * An Async wrapper for CreatePublishingDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePublishingDestinationRequestT = Model::CreatePublishingDestinationRequest>
  void CreatePublishingDestinationAsync(const CreatePublishingDestinationRequestT& request,
   ...
   */
  template <typename CreateSampleFindingsRequestT = Model::CreateSampleFindingsRequest>
  void CreateSampleFindingsAsync(const CreateSampleFindingsRequestT& request, const CreateSampleFindingsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateThreatEntitySet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateThreatEntitySet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateThreatEntitySetRequestT = Model::CreateThreatEntitySetRequest>
  void CreateThreatEntitySetAsync(const CreateThreatEntitySetRequestT& request, const CreateThreatEntitySetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateThreatIntelSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateThreatIntelSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateThreatIntelSetRequestT = Model::CreateThreatIntelSetRequest>
  void CreateThreatIntelSetAsync(const CreateThreatIntelSetRequestT& request, const CreateThreatIntelSetResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTrustedEntitySet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTrustedEntitySet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTrustedEntitySetRequestT = Model::CreateTrustedEntitySetRequest>
  void CreateTrustedEntitySetAsync(const CreateTrustedEntitySetRequestT& request,
                                   const CreateTrustedEntitySetResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteMalwareProtectionPlanOutcome DeleteMalwareProtectionPlan(
      const Model::DeleteMalwareProtectionPlanRequest& request) const;

  /**
   * A Callable wrapper for DeleteMalwareProtectionPlan that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteMalwareProtectionPlanRequestT = Model::DeleteMalwareProtectionPlanRequest>
  Model::DeleteMalwareProtectionPlanOutcomeCallable DeleteMalwareProtectionPlanCallable(
      const DeleteMalwareProtectionPlanRequestT& request) const {
    return SubmitCallable(&GuardDutyClient::DeleteMalwareProtectionPlan, request);
  }

  /**
   * An Async wrapper for DeleteMalwareProtectionPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMalwareProtectionPlanRequestT = Model::DeleteMalwareProtectionPlanRequest>
  void DeleteMalwareProtectionPlanAsync(const DeleteMalwareProtectionPlanRequestT& request,
                                        const DeleteMalwareProtectionPlanResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePublishingDestinationOutcome DeletePublishingDestination(
      const Model::DeletePublishingDestinationRequest& request) const;

  /**
   * A Callable wrapper for DeletePublishingDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePublishingDestinationRequestT = Model::DeletePublishingDestinationRequest>
  Model::DeletePublishingDestinationOutcomeCallable DeletePublishingDestinationCallable(
      const DeletePublishingDestinationRequestT& request) const {
    return SubmitCallable(&GuardDutyClient::DeletePublishingDestination, request);
  }

  /**
   * An Async wrapper for DeletePublishingDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePublishingDestinationRequestT = Model::DeletePublishingDestinationRequest>
  void DeletePublishingDestinationAsync(const DeletePublishingDestinationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteThreatEntitySet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteThreatEntitySet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteThreatEntitySetRequestT = Model::DeleteThreatEntitySetRequest>
  void DeleteThreatEntitySetAsync(const DeleteThreatEntitySetRequestT& request, const DeleteThreatEntitySetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteThreatIntelSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteThreatIntelSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteThreatIntelSetRequestT = Model::DeleteThreatIntelSetRequest>
  void DeleteThreatIntelSetAsync(const DeleteThreatIntelSetRequestT& request, const DeleteThreatIntelSetResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTrustedEntitySet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTrustedEntitySet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTrustedEntitySetRequestT = Model::DeleteTrustedEntitySetRequest>
  void DeleteTrustedEntitySetAsync(const DeleteTrustedEntitySetRequestT& request,
                                   const DeleteTrustedEntitySetResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeMalwareScans that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMalwareScans that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMalwareScansRequestT = Model::DescribeMalwareScansRequest>
  void DescribeMalwareScansAsync(const DescribeMalwareScansRequestT& request, const DescribeMalwareScansResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribePublishingDestinationOutcome DescribePublishingDestination(
      const Model::DescribePublishingDestinationRequest& request) const;

  /**
   * A Callable wrapper for DescribePublishingDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribePublishingDestinationRequestT = Model::DescribePublishingDestinationRequest>
  Model::DescribePublishingDestinationOutcomeCallable DescribePublishingDestinationCallable(
      const DescribePublishingDestinationRequestT& request) const {
    return SubmitCallable(&GuardDutyClient::DescribePublishingDestination, request);
  }

  /**
   * An Async wrapper for DescribePublishingDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePublishingDestinationRequestT = Model::DescribePublishingDestinationRequest>
  void DescribePublishingDestinationAsync(const DescribePublishingDestinationRequestT& request,
   ...
   */
  template <typename DisassociateFromAdministratorAccountRequestT = Model::DisassociateFromAdministratorAccountRequest>
  void DisassociateFromAdministratorAccountAsync(const DisassociateFromAdministratorAccountRequestT& request,
   ...
   */
  template <typename GetAdministratorAccountRequestT = Model::GetAdministratorAccountRequest>
  void GetAdministratorAccountAsync(const GetAdministratorAccountRequestT& request,
  ...
  /**
   * A Callable wrapper for GetCoverageStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCoverageStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCoverageStatisticsRequestT = Model::GetCoverageStatisticsRequest>
  ...
  /**
   * An Async wrapper for GetDetector that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDetectorRequestT = Model::GetDetectorRequest>
  void GetDetectorAsync(const GetDetectorRequestT& request, const GetDetectorResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetFilter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFilterRequestT = Model::GetFilterRequest>
  void GetFilterAsync(const GetFilterRequestT& request, const GetFilterResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMalwareProtectionPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMalwareProtectionPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMalwareProtectionPlanRequestT = Model::GetMalwareProtectionPlanRequest>
  void GetMalwareProtectionPlanAsync(const GetMalwareProtectionPlanRequestT& request,
                                     const GetMalwareProtectionPlanResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMalwareScanSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMalwareScanSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMalwareScanSettingsRequestT = Model::GetMalwareScanSettingsRequest>
  void GetMalwareScanSettingsAsync(const GetMalwareScanSettingsRequestT& request,
                                   const GetMalwareScanSettingsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMemberDetectors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMemberDetectors that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMemberDetectorsRequestT = Model::GetMemberDetectorsRequest>
  void GetMemberDetectorsAsync(const GetMemberDetectorsRequestT& request, const GetMemberDetectorsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetOrganizationStatisticsOutcome GetOrganizationStatistics(
      const Model::GetOrganizationStatisticsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetOrganizationStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetOrganizationStatisticsRequestT = Model::GetOrganizationStatisticsRequest>
  Model::GetOrganizationStatisticsOutcomeCallable GetOrganizationStatisticsCallable(
      const GetOrganizationStatisticsRequestT& request = {}) const {
    return SubmitCallable(&GuardDutyClient::GetOrganizationStatistics, request);
  }

  /**
   * An Async wrapper for GetOrganizationStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOrganizationStatisticsRequestT = Model::GetOrganizationStatisticsRequest>
  void GetOrganizationStatisticsAsync(const GetOrganizationStatisticsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const GetOrganizationStatisticsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetRemainingFreeTrialDays that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetRemainingFreeTrialDaysRequestT = Model::GetRemainingFreeTrialDaysRequest>
  Model::GetRemainingFreeTrialDaysOutcomeCallable GetRemainingFreeTrialDaysCallable(
      const GetRemainingFreeTrialDaysRequestT& request) const {
    return SubmitCallable(&GuardDutyClient::GetRemainingFreeTrialDays, request);
  }

  /**
   * An Async wrapper for GetRemainingFreeTrialDays that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRemainingFreeTrialDaysRequestT = Model::GetRemainingFreeTrialDaysRequest>
  void GetRemainingFreeTrialDaysAsync(const GetRemainingFreeTrialDaysRequestT& request,
                                      const GetRemainingFreeTrialDaysResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetThreatEntitySet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetThreatEntitySet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetThreatEntitySetRequestT = Model::GetThreatEntitySetRequest>
  void GetThreatEntitySetAsync(const GetThreatEntitySetRequestT& request, const GetThreatEntitySetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetThreatIntelSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetThreatIntelSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetThreatIntelSetRequestT = Model::GetThreatIntelSetRequest>
  void GetThreatIntelSetAsync(const GetThreatIntelSetRequestT& request, const GetThreatIntelSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTrustedEntitySet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTrustedEntitySet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTrustedEntitySetRequestT = Model::GetTrustedEntitySetRequest>
  void GetTrustedEntitySetAsync(const GetTrustedEntitySetRequestT& request, const GetTrustedEntitySetResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetUsageStatisticsRequestT = Model::GetUsageStatisticsRequest>
  void GetUsageStatisticsAsync(const GetUsageStatisticsRequestT& request, const GetUsageStatisticsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListDetectorsRequestT = Model::ListDetectorsRequest>
  void ListDetectorsAsync(const ListDetectorsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListDetectorsRequestT& request = {}) const {
   ...
   */
  template <typename ListFiltersRequestT = Model::ListFiltersRequest>
  void ListFiltersAsync(const ListFiltersRequestT& request, const ListFiltersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMalwareProtectionPlansOutcome ListMalwareProtectionPlans(
      const Model::ListMalwareProtectionPlansRequest& request = {}) const;

  /**
   * A Callable wrapper for ListMalwareProtectionPlans that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMalwareProtectionPlansRequestT = Model::ListMalwareProtectionPlansRequest>
  Model::ListMalwareProtectionPlansOutcomeCallable ListMalwareProtectionPlansCallable(
      const ListMalwareProtectionPlansRequestT& request = {}) const {
    return SubmitCallable(&GuardDutyClient::ListMalwareProtectionPlans, request);
  }

  /**
   * An Async wrapper for ListMalwareProtectionPlans that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMalwareProtectionPlansRequestT = Model::ListMalwareProtectionPlansRequest>
  void ListMalwareProtectionPlansAsync(const ListMalwareProtectionPlansResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListMalwareProtectionPlansRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPublishingDestinationsOutcome ListPublishingDestinations(
      const Model::ListPublishingDestinationsRequest& request) const;

  /**
   * A Callable wrapper for ListPublishingDestinations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPublishingDestinationsRequestT = Model::ListPublishingDestinationsRequest>
  Model::ListPublishingDestinationsOutcomeCallable ListPublishingDestinationsCallable(
      const ListPublishingDestinationsRequestT& request) const {
    return SubmitCallable(&GuardDutyClient::ListPublishingDestinations, request);
  }

  /**
   * An Async wrapper for ListPublishingDestinations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPublishingDestinationsRequestT = Model::ListPublishingDestinationsRequest>
  void ListPublishingDestinationsAsync(const ListPublishingDestinationsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListThreatEntitySets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListThreatEntitySets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListThreatEntitySetsRequestT = Model::ListThreatEntitySetsRequest>
  void ListThreatEntitySetsAsync(const ListThreatEntitySetsRequestT& request, const ListThreatEntitySetsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListThreatIntelSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListThreatIntelSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListThreatIntelSetsRequestT = Model::ListThreatIntelSetsRequest>
  void ListThreatIntelSetsAsync(const ListThreatIntelSetsRequestT& request, const ListThreatIntelSetsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTrustedEntitySets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTrustedEntitySets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTrustedEntitySetsRequestT = Model::ListTrustedEntitySetsRequest>
  void ListTrustedEntitySetsAsync(const ListTrustedEntitySetsRequestT& request, const ListTrustedEntitySetsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMalwareScan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMalwareScan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartMalwareScanRequestT = Model::StartMalwareScanRequest>
  void StartMalwareScanAsync(const StartMalwareScanRequestT& request, const StartMalwareScanResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMonitoringMembers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMonitoringMembers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMonitoringMembersRequestT = Model::StartMonitoringMembersRequest>
  void StartMonitoringMembersAsync(const StartMonitoringMembersRequestT& request,
  ...
  /**
   * A Callable wrapper for StopMonitoringMembers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopMonitoringMembers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopMonitoringMembersRequestT = Model::StopMonitoringMembersRequest>
  void StopMonitoringMembersAsync(const StopMonitoringMembersRequestT& request, const StopMonitoringMembersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UnarchiveFindings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UnarchiveFindings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UnarchiveFindingsRequestT = Model::UnarchiveFindingsRequest>
  void UnarchiveFindingsAsync(const UnarchiveFindingsRequestT& request, const UnarchiveFindingsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateDetector that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateDetectorRequestT = Model::UpdateDetectorRequest>
  void UpdateDetectorAsync(const UpdateDetectorRequestT& request, const UpdateDetectorResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateFindingsFeedback that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFindingsFeedback that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFindingsFeedbackRequestT = Model::UpdateFindingsFeedbackRequest>
  void UpdateFindingsFeedbackAsync(const UpdateFindingsFeedbackRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateMalwareProtectionPlanOutcome UpdateMalwareProtectionPlan(
      const Model::UpdateMalwareProtectionPlanRequest& request) const;

  /**
   * A Callable wrapper for UpdateMalwareProtectionPlan that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateMalwareProtectionPlanRequestT = Model::UpdateMalwareProtectionPlanRequest>
  Model::UpdateMalwareProtectionPlanOutcomeCallable UpdateMalwareProtectionPlanCallable(
      const UpdateMalwareProtectionPlanRequestT& request) const {
    return SubmitCallable(&GuardDutyClient::UpdateMalwareProtectionPlan, request);
  }

  /**
   * An Async wrapper for UpdateMalwareProtectionPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMalwareProtectionPlanRequestT = Model::UpdateMalwareProtectionPlanRequest>
  void UpdateMalwareProtectionPlanAsync(const UpdateMalwareProtectionPlanRequestT& request,
                                        const UpdateMalwareProtectionPlanResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMalwareScanSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateMalwareScanSettingsRequestT = Model::UpdateMalwareScanSettingsRequest>
  Model::UpdateMalwareScanSettingsOutcomeCallable UpdateMalwareScanSettingsCallable(
      const UpdateMalwareScanSettingsRequestT& request) const {
    return SubmitCallable(&GuardDutyClient::UpdateMalwareScanSettings, request);
  }

  /**
   * An Async wrapper for UpdateMalwareScanSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMalwareScanSettingsRequestT = Model::UpdateMalwareScanSettingsRequest>
  void UpdateMalwareScanSettingsAsync(const UpdateMalwareScanSettingsRequestT& request,
                                      const UpdateMalwareScanSettingsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMemberDetectors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMemberDetectors that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMemberDetectorsRequestT = Model::UpdateMemberDetectorsRequest>
  void UpdateMemberDetectorsAsync(const UpdateMemberDetectorsRequestT& request, const UpdateMemberDetectorsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdatePublishingDestinationOutcome UpdatePublishingDestination(
      const Model::UpdatePublishingDestinationRequest& request) const;

  /**
   * A Callable wrapper for UpdatePublishingDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdatePublishingDestinationRequestT = Model::UpdatePublishingDestinationRequest>
  Model::UpdatePublishingDestinationOutcomeCallable UpdatePublishingDestinationCallable(
      const UpdatePublishingDestinationRequestT& request) const {
    return SubmitCallable(&GuardDutyClient::UpdatePublishingDestination, request);
  }

  /**
   * An Async wrapper for UpdatePublishingDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePublishingDestinationRequestT = Model::UpdatePublishingDestinationRequest>
  void UpdatePublishingDestinationAsync(const UpdatePublishingDestinationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateThreatEntitySet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateThreatEntitySet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateThreatEntitySetRequestT = Model::UpdateThreatEntitySetRequest>
  void UpdateThreatEntitySetAsync(const UpdateThreatEntitySetRequestT& request, const UpdateThreatEntitySetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateThreatIntelSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateThreatIntelSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateThreatIntelSetRequestT = Model::UpdateThreatIntelSetRequest>
  void UpdateThreatIntelSetAsync(const UpdateThreatIntelSetRequestT& request, const UpdateThreatIntelSetResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateTrustedEntitySet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTrustedEntitySet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTrustedEntitySetRequestT = Model::UpdateTrustedEntitySetRequest>
  void UpdateTrustedEntitySetAsync(const UpdateTrustedEntitySetRequestT& request,
                                   const UpdateTrustedEntitySetResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
