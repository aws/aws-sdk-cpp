...
class ListIPSetsResult {
 public:
  ...
  void SetIpSetIds(IpSetIdsT&& value) {
    m_ipSetIdsHasBeenSet = true;
    m_ipSetIds = std::forward<IpSetIdsT>(value);
  }
  template <typename IpSetIdsT = Aws::Vector<Aws::String>>
  ListIPSetsResult& WithIpSetIds(IpSetIdsT&& value) {
    SetIpSetIds(std::forward<IpSetIdsT>(value));
    return *this;
  }
  template <typename IpSetIdsT = Aws::String>
  ListIPSetsResult& AddIpSetIds(IpSetIdsT&& value) {
    m_ipSetIdsHasBeenSet = true;
    m_ipSetIds.emplace_back(std::forward<IpSetIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIPSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIPSetsResult& WithRequestId(RequestIdT&& value) {
