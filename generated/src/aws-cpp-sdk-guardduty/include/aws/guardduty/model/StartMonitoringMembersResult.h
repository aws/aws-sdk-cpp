...
namespace Model
{
  ...
  {
  public:
    AWS_GUARDDUTY_API StartMonitoringMembersResult() = default;
    ...
    template<typename UnprocessedAccountsT = Aws::Vector<UnprocessedAccount>>
    StartMonitoringMembersResult& WithUnprocessedAccounts(UnprocessedAccountsT&& value) { SetUnprocessedAccounts(std::forward<UnprocessedAccountsT>(value)); return *this;}
    template<typename UnprocessedAccountsT = UnprocessedAccount>
    StartMonitoringMembersResult& AddUnprocessedAccounts(UnprocessedAccountsT&& value) { m_unprocessedAccountsHasBeenSet = true; m_unprocessedAccounts.emplace_back(std::forward<UnprocessedAccountsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartMonitoringMembersResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
