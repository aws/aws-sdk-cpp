...
class StartMonitoringMembersResult {
 public:
  ...
  template <typename UnprocessedAccountsT = Aws::Vector<UnprocessedAccount>>
  StartMonitoringMembersResult& WithUnprocessedAccounts(UnprocessedAccountsT&& value) {
    SetUnprocessedAccounts(std::forward<UnprocessedAccountsT>(value));
    return *this;
  }
  template <typename UnprocessedAccountsT = UnprocessedAccount>
  StartMonitoringMembersResult& AddUnprocessedAccounts(UnprocessedAccountsT&& value) {
    m_unprocessedAccountsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  StartMonitoringMembersResult& WithRequestId(RequestIdT&& value) {
