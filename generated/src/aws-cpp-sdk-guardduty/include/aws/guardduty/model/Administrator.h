...
class Administrator {
 public:
  ...
  template <typename InvitationIdT = Aws::String>
  Administrator& WithInvitationId(InvitationIdT&& value) {
  ...
  template <typename RelationshipStatusT = Aws::String>
  Administrator& WithRelationshipStatus(RelationshipStatusT&& value) {
  ...
  template <typename InvitedAtT = Aws::String>
  Administrator& WithInvitedAt(InvitedAtT&& value) {
