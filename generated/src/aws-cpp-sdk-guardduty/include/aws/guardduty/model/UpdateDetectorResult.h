...
namespace Model
{
  ...
  {
  public:
    AWS_GUARDDUTY_API UpdateDetectorResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDetectorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
