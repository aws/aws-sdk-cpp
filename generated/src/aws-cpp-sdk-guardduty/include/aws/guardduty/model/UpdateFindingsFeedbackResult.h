...
namespace Model
{
  ...
  public:
    ...
    inline UpdateFindingsFeedbackResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateFindingsFeedbackResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateFindingsFeedbackResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
