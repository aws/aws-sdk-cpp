...
namespace Model
{
  ...
  {
  public:
    AWS_GUARDDUTY_API UpdateFindingsFeedbackResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFindingsFeedbackResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
