...
class OrganizationFeatureStatistics {
 public:
  ...
  inline OrganizationFeatureStatistics& WithName(OrgFeature value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationFeatureStatistics& WithEnabledAccountsCount(int value) {
   ...
   */
  inline const Aws::Vector<OrganizationFeatureStatisticsAdditionalConfiguration>& GetAdditionalConfiguration() const {
