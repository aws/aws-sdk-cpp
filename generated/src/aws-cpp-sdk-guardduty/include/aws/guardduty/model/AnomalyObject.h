...
class AnomalyObject {
 public:
  ...
  inline AnomalyObject& WithProfileType(ProfileType value) {
  ...
  inline void SetProfileSubtype(ProfileSubtype value) {
    m_profileSubtypeHasBeenSet = true;
    m_profileSubtype = value;
  }
  inline AnomalyObject& WithProfileSubtype(ProfileSubtype value) {
    SetProfileSubtype(value);
    return *this;
  }
  ///@}
