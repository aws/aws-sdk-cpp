...
class ThreatIntelligenceDetail {
 public:
  ...
  void SetThreatListName(ThreatListNameT&& value) {
    ...
    m_threatListName = std::forward<ThreatListNameT>(value);
  }
  template <typename ThreatListNameT = Aws::String>
  ThreatIntelligenceDetail& WithThreatListName(ThreatListNameT&& value) {
    SetThreatListName(std::forward<ThreatListNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThreatFileSha256(ThreatFileSha256T&& value) {
    ...
    m_threatFileSha256 = std::forward<ThreatFileSha256T>(value);
  }
  template <typename ThreatFileSha256T = Aws::String>
  ThreatIntelligenceDetail& WithThreatFileSha256(ThreatFileSha256T&& value) {
    SetThreatFileSha256(std::forward<ThreatFileSha256T>(value));
    return *this;
  }
  ///@}
 private:
