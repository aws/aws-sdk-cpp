...
class GetUsageStatisticsRequest : public GuardDutyRequest {
 public:
  ...
  inline void SetUsageStatisticType(UsageStatisticType value) {
    m_usageStatisticTypeHasBeenSet = true;
    m_usageStatisticType = value;
  }
  inline GetUsageStatisticsRequest& WithUsageStatisticType(UsageStatisticType value) {
    SetUsageStatisticType(value);
    return *this;
  }
  ///@}
  ...
  void SetUsageCriteria(UsageCriteriaT&& value) {
    m_usageCriteriaHasBeenSet = true;
    m_usageCriteria = std::forward<UsageCriteriaT>(value);
  }
  template <typename UsageCriteriaT = UsageCriteria>
  GetUsageStatisticsRequest& WithUsageCriteria(UsageCriteriaT&& value) {
    SetUsageCriteria(std::forward<UsageCriteriaT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetUsageStatisticsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
