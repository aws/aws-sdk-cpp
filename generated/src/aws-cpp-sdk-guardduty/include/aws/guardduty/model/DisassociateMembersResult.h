...
class DisassociateMembersResult {
 public:
  AWS_GUARDDUTY_API DisassociateMembersResult() = default;
  ...
  template <typename UnprocessedAccountsT = Aws::Vector<UnprocessedAccount>>
  DisassociateMembersResult& WithUnprocessedAccounts(UnprocessedAccountsT&& value) {
    SetUnprocessedAccounts(std::forward<UnprocessedAccountsT>(value));
    return *this;
  }
  template <typename UnprocessedAccountsT = UnprocessedAccount>
  DisassociateMembersResult& AddUnprocessedAccounts(UnprocessedAccountsT&& value) {
    m_unprocessedAccountsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateMembersResult& WithRequestId(RequestIdT&& value) {
