...
class PublicAccessConfiguration {
 public:
  ...
  inline void SetPublicAclAccess(PublicAccessStatus value) {
    m_publicAclAccessHasBeenSet = true;
    m_publicAclAccess = value;
  }
  inline PublicAccessConfiguration& WithPublicAclAccess(PublicAccessStatus value) {
    SetPublicAclAccess(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPublicPolicyAccess(PublicAccessStatus value) {
    m_publicPolicyAccessHasBeenSet = true;
    m_publicPolicyAccess = value;
  }
  inline PublicAccessConfiguration& WithPublicPolicyAccess(PublicAccessStatus value) {
    SetPublicPolicyAccess(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPublicAclIgnoreBehavior(PublicAclIgnoreBehavior value) {
    m_publicAclIgnoreBehaviorHasBeenSet = true;
    m_publicAclIgnoreBehavior = value;
  }
  inline PublicAccessConfiguration& WithPublicAclIgnoreBehavior(PublicAclIgnoreBehavior value) {
    SetPublicAclIgnoreBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPublicBucketRestrictBehavior(PublicBucketRestrictBehavior value) {
    m_publicBucketRestrictBehaviorHasBeenSet = true;
    m_publicBucketRestrictBehavior = value;
  }
  inline PublicAccessConfiguration& WithPublicBucketRestrictBehavior(PublicBucketRestrictBehavior value) {
    SetPublicBucketRestrictBehavior(value);
    return *this;
  }
  ///@}
 private:
