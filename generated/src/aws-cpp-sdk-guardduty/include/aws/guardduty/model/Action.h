...
class Action {
 public:
  ...
  void SetAwsApiCallAction(AwsApiCallActionT&& value) {
    ...
    m_awsApiCallAction = std::forward<AwsApiCallActionT>(value);
  }
  template <typename AwsApiCallActionT = AwsApiCallAction>
  Action& WithAwsApiCallAction(AwsApiCallActionT&& value) {
    SetAwsApiCallAction(std::forward<AwsApiCallActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDnsRequestAction(DnsRequestActionT&& value) {
    ...
    m_dnsRequestAction = std::forward<DnsRequestActionT>(value);
  }
  template <typename DnsRequestActionT = DnsRequestAction>
  Action& WithDnsRequestAction(DnsRequestActionT&& value) {
    SetDnsRequestAction(std::forward<DnsRequestActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkConnectionAction(NetworkConnectionActionT&& value) {
    ...
    m_networkConnectionAction = std::forward<NetworkConnectionActionT>(value);
  }
  template <typename NetworkConnectionActionT = NetworkConnectionAction>
  Action& WithNetworkConnectionAction(NetworkConnectionActionT&& value) {
    SetNetworkConnectionAction(std::forward<NetworkConnectionActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPortProbeAction(PortProbeActionT&& value) {
    ...
    m_portProbeAction = std::forward<PortProbeActionT>(value);
  }
  template <typename PortProbeActionT = PortProbeAction>
  Action& WithPortProbeAction(PortProbeActionT&& value) {
    SetPortProbeAction(std::forward<PortProbeActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKubernetesApiCallAction(KubernetesApiCallActionT&& value) {
    ...
    m_kubernetesApiCallAction = std::forward<KubernetesApiCallActionT>(value);
  }
  template <typename KubernetesApiCallActionT = KubernetesApiCallAction>
  Action& WithKubernetesApiCallAction(KubernetesApiCallActionT&& value) {
    SetKubernetesApiCallAction(std::forward<KubernetesApiCallActionT>(value));
    return *this;
  }
  ///@}
   ...
   * API.</p>
   */
  inline const KubernetesPermissionCheckedDetails& GetKubernetesPermissionCheckedDetails() const {
    return m_kubernetesPermissionCheckedDetails;
  }
  ...
  void SetKubernetesPermissionCheckedDetails(KubernetesPermissionCheckedDetailsT&& value) {
    ...
    m_kubernetesPermissionCheckedDetails = std::forward<KubernetesPermissionCheckedDetailsT>(value);
  }
  template <typename KubernetesPermissionCheckedDetailsT = KubernetesPermissionCheckedDetails>
  Action& WithKubernetesPermissionCheckedDetails(KubernetesPermissionCheckedDetailsT&& value) {
    SetKubernetesPermissionCheckedDetails(std::forward<KubernetesPermissionCheckedDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKubernetesRoleBindingDetails(KubernetesRoleBindingDetailsT&& value) {
    ...
    m_kubernetesRoleBindingDetails = std::forward<KubernetesRoleBindingDetailsT>(value);
  }
  template <typename KubernetesRoleBindingDetailsT = KubernetesRoleBindingDetails>
  Action& WithKubernetesRoleBindingDetails(KubernetesRoleBindingDetailsT&& value) {
    SetKubernetesRoleBindingDetails(std::forward<KubernetesRoleBindingDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKubernetesRoleDetails(KubernetesRoleDetailsT&& value) {
    ...
    m_kubernetesRoleDetails = std::forward<KubernetesRoleDetailsT>(value);
  }
  template <typename KubernetesRoleDetailsT = KubernetesRoleDetails>
  Action& WithKubernetesRoleDetails(KubernetesRoleDetailsT&& value) {
    SetKubernetesRoleDetails(std::forward<KubernetesRoleDetailsT>(value));
    return *this;
  }
  ///@}
 private:
