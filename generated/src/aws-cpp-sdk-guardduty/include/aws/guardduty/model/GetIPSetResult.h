...
class GetIPSetResult {
 public:
  ...
  inline void SetFormat(IpSetFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline GetIPSetResult& WithFormat(IpSetFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(IpSetStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetIPSetResult& WithStatus(IpSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
   ...
   * was provided during IPSet creation or update.</p>
   */
