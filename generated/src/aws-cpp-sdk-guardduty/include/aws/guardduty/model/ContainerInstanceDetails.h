...
class ContainerInstanceDetails {
 public:
  ...
  inline void SetCoveredContainerInstances(long long value) {
    m_coveredContainerInstancesHasBeenSet = true;
    m_coveredContainerInstances = value;
  }
  inline ContainerInstanceDetails& WithCoveredContainerInstances(long long value) {
    SetCoveredContainerInstances(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCompatibleContainerInstances(long long value) {
    m_compatibleContainerInstancesHasBeenSet = true;
    m_compatibleContainerInstances = value;
  }
  inline ContainerInstanceDetails& WithCompatibleContainerInstances(long long value) {
    SetCompatibleContainerInstances(value);
    return *this;
  }
  ///@}
 private:
