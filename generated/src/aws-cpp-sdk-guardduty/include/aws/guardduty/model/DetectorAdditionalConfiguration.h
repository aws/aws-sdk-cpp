...
class DetectorAdditionalConfiguration {
 public:
  ...
  inline DetectorAdditionalConfiguration& WithName(FeatureAdditionalConfiguration value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline DetectorAdditionalConfiguration& WithStatus(FeatureStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
