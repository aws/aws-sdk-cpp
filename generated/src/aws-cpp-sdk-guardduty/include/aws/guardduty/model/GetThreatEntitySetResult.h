...
class GetThreatEntitySetResult {
 public:
  ...
  inline GetThreatEntitySetResult& WithFormat(ThreatEntitySetFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
   ...
   */
  inline ThreatEntitySetStatus GetStatus() const { return m_status; }
  inline void SetStatus(ThreatEntitySetStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetThreatEntitySetResult& WithStatus(ThreatEntitySetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
 ...
 private:
  ...
  ThreatEntitySetStatus m_status{ThreatEntitySetStatus::NOT_SET};
