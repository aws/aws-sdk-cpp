...
class DetectorFeatureConfigurationResult {
 public:
  ...
  inline void SetName(DetectorFeatureResult value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DetectorFeatureConfigurationResult& WithName(DetectorFeatureResult value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline DetectorFeatureConfigurationResult& WithStatus(FeatureStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
