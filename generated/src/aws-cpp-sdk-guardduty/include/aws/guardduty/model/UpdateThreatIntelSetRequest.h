...
class UpdateThreatIntelSetRequest : public GuardDutyRequest {
 public:
  ...
  void SetThreatIntelSetId(ThreatIntelSetIdT&& value) {
    ...
    m_threatIntelSetId = std::forward<ThreatIntelSetIdT>(value);
  }
  template <typename ThreatIntelSetIdT = Aws::String>
  UpdateThreatIntelSetRequest& WithThreatIntelSetId(ThreatIntelSetIdT&& value) {
    SetThreatIntelSetId(std::forward<ThreatIntelSetIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateThreatIntelSetRequest& WithActivate(bool value) {
    SetActivate(value);
    return *this;
  }
  ///@}
