...
class LineageObject {
 public:
  ...
  inline void SetNamespacePid(int value) {
    m_namespacePidHasBeenSet = true;
    m_namespacePid = value;
  }
  inline LineageObject& WithNamespacePid(int value) {
    SetNamespacePid(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUserId(int value) {
    m_userIdHasBeenSet = true;
    m_userId = value;
  }
  inline LineageObject& WithUserId(int value) {
    SetUserId(value);
    return *this;
  }
  ///@}
  ...
  inline LineageObject& WithPid(int value) {
    SetPid(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEuid(int value) {
    m_euidHasBeenSet = true;
    m_euid = value;
  }
  inline LineageObject& WithEuid(int value) {
    SetEuid(value);
    return *this;
  }
  ///@}
  ...
  void SetParentUuid(ParentUuidT&& value) {
    ...
    m_parentUuid = std::forward<ParentUuidT>(value);
  }
  template <typename ParentUuidT = Aws::String>
  LineageObject& WithParentUuid(ParentUuidT&& value) {
    SetParentUuid(std::forward<ParentUuidT>(value));
    return *this;
  }
  ///@}
 private:
