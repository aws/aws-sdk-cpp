...
class UpdateTrustedEntitySetRequest : public GuardDutyRequest {
 public:
  ...
  void SetTrustedEntitySetId(TrustedEntitySetIdT&& value) {
    ...
    m_trustedEntitySetId = std::forward<TrustedEntitySetIdT>(value);
  }
  template <typename TrustedEntitySetIdT = Aws::String>
  UpdateTrustedEntitySetRequest& WithTrustedEntitySetId(TrustedEntitySetIdT&& value) {
    SetTrustedEntitySetId(std::forward<TrustedEntitySetIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateTrustedEntitySetRequest& WithActivate(bool value) {
    SetActivate(value);
    return *this;
  }
  ///@}
