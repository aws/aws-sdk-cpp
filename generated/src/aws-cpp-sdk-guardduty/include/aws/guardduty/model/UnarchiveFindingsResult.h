...
namespace Model
{
  ...
  public:
    ...
    inline UnarchiveFindingsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UnarchiveFindingsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UnarchiveFindingsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
