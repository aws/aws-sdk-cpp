...
class ThreatDetectedByName {
 public:
  ...
  inline ThreatDetectedByName& WithItemCount(int value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUniqueThreatNameCount(int value) {
    m_uniqueThreatNameCountHasBeenSet = true;
    m_uniqueThreatNameCount = value;
  }
  inline ThreatDetectedByName& WithUniqueThreatNameCount(int value) {
    SetUniqueThreatNameCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShortened(bool value) {
    m_shortenedHasBeenSet = true;
    m_shortened = value;
  }
  inline ThreatDetectedByName& WithShortened(bool value) {
    SetShortened(value);
    return *this;
  }
  ///@}
