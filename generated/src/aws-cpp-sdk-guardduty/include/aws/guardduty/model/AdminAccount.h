...
class AdminAccount {
 public:
  ...
  template <typename AdminAccountIdT = Aws::String>
  AdminAccount& WithAdminAccountId(AdminAccountIdT&& value) {
  ...
  inline void SetAdminStatus(AdminStatus value) {
    m_adminStatusHasBeenSet = true;
    m_adminStatus = value;
  }
  inline AdminAccount& WithAdminStatus(AdminStatus value) {
