...
class StopMonitoringMembersResult {
 public:
  ...
  template <typename UnprocessedAccountsT = Aws::Vector<UnprocessedAccount>>
  StopMonitoringMembersResult& WithUnprocessedAccounts(UnprocessedAccountsT&& value) {
    SetUnprocessedAccounts(std::forward<UnprocessedAccountsT>(value));
    return *this;
  }
  template <typename UnprocessedAccountsT = UnprocessedAccount>
  StopMonitoringMembersResult& AddUnprocessedAccounts(UnprocessedAccountsT&& value) {
    m_unprocessedAccountsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  StopMonitoringMembersResult& WithRequestId(RequestIdT&& value) {
