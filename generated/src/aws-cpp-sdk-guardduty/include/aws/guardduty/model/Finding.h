...
class Finding {
 public:
  ...
  inline Finding& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSeverity(double value) {
    m_severityHasBeenSet = true;
    m_severity = value;
  }
  inline Finding& WithSeverity(double value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  void SetAssociatedAttackSequenceArn(AssociatedAttackSequenceArnT&& value) {
    ...
    m_associatedAttackSequenceArn = std::forward<AssociatedAttackSequenceArnT>(value);
  }
  template <typename AssociatedAttackSequenceArnT = Aws::String>
  Finding& WithAssociatedAttackSequenceArn(AssociatedAttackSequenceArnT&& value) {
    SetAssociatedAttackSequenceArn(std::forward<AssociatedAttackSequenceArnT>(value));
    return *this;
  }
  ///@}
 private:
