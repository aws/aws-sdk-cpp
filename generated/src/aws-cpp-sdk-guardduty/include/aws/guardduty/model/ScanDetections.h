...
class ScanDetections {
 public:
  ...
  void SetScannedItemCount(ScannedItemCountT&& value) {
    ...
    m_scannedItemCount = std::forward<ScannedItemCountT>(value);
  }
  template <typename ScannedItemCountT = ScannedItemCount>
  ScanDetections& WithScannedItemCount(ScannedItemCountT&& value) {
    SetScannedItemCount(std::forward<ScannedItemCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThreatsDetectedItemCount(ThreatsDetectedItemCountT&& value) {
    ...
    m_threatsDetectedItemCount = std::forward<ThreatsDetectedItemCountT>(value);
  }
  template <typename ThreatsDetectedItemCountT = ThreatsDetectedItemCount>
  ScanDetections& WithThreatsDetectedItemCount(ThreatsDetectedItemCountT&& value) {
    SetThreatsDetectedItemCount(std::forward<ThreatsDetectedItemCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHighestSeverityThreatDetails(HighestSeverityThreatDetailsT&& value) {
    ...
    m_highestSeverityThreatDetails = std::forward<HighestSeverityThreatDetailsT>(value);
  }
  template <typename HighestSeverityThreatDetailsT = HighestSeverityThreatDetails>
  ScanDetections& WithHighestSeverityThreatDetails(HighestSeverityThreatDetailsT&& value) {
    SetHighestSeverityThreatDetails(std::forward<HighestSeverityThreatDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThreatDetectedByName(ThreatDetectedByNameT&& value) {
    ...
    m_threatDetectedByName = std::forward<ThreatDetectedByNameT>(value);
  }
  template <typename ThreatDetectedByNameT = ThreatDetectedByName>
  ScanDetections& WithThreatDetectedByName(ThreatDetectedByNameT&& value) {
    SetThreatDetectedByName(std::forward<ThreatDetectedByNameT>(value));
    return *this;
  }
  ///@}
 private:
