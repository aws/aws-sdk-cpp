...
class NetworkConnectionAction {
 public:
  ...
  template <typename LocalIpDetailsT = LocalIpDetails>
  NetworkConnectionAction& WithLocalIpDetails(LocalIpDetailsT&& value) {
  ...
  void SetLocalNetworkInterface(LocalNetworkInterfaceT&& value) {
    m_localNetworkInterfaceHasBeenSet = true;
    m_localNetworkInterface = std::forward<LocalNetworkInterfaceT>(value);
  }
  template <typename LocalNetworkInterfaceT = Aws::String>
  NetworkConnectionAction& WithLocalNetworkInterface(LocalNetworkInterfaceT&& value) {
    SetLocalNetworkInterface(std::forward<LocalNetworkInterfaceT>(value));
    return *this;
  }
  ///@}
