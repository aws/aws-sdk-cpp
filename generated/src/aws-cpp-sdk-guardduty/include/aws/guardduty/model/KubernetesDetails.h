...
class KubernetesDetails {
 public:
  ...
  void SetKubernetesUserDetails(KubernetesUserDetailsT&& value) {
    ...
    m_kubernetesUserDetails = std::forward<KubernetesUserDetailsT>(value);
  }
  template <typename KubernetesUserDetailsT = KubernetesUserDetails>
  KubernetesDetails& WithKubernetesUserDetails(KubernetesUserDetailsT&& value) {
    SetKubernetesUserDetails(std::forward<KubernetesUserDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKubernetesWorkloadDetails(KubernetesWorkloadDetailsT&& value) {
    ...
    m_kubernetesWorkloadDetails = std::forward<KubernetesWorkloadDetailsT>(value);
  }
  template <typename KubernetesWorkloadDetailsT = KubernetesWorkloadDetails>
  KubernetesDetails& WithKubernetesWorkloadDetails(KubernetesWorkloadDetailsT&& value) {
    SetKubernetesWorkloadDetails(std::forward<KubernetesWorkloadDetailsT>(value));
    return *this;
  }
  ///@}
 private:
