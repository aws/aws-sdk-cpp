...
class MemberFeaturesConfigurationResult {
 public:
  ...
  inline MemberFeaturesConfigurationResult& WithName(OrgFeature value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline MemberFeaturesConfigurationResult& WithStatus(FeatureStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  MemberFeaturesConfigurationResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename AdditionalConfigurationT = Aws::Vector<MemberAdditionalConfigurationResult>>
  MemberFeaturesConfigurationResult& WithAdditionalConfiguration(AdditionalConfigurationT&& value) {
  ...
  MemberFeaturesConfigurationResult& AddAdditionalConfiguration(AdditionalConfigurationT&& value) {
    m_additionalConfigurationHasBeenSet = true;
