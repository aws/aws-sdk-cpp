...
/**
 * <p>Contains information about the CloudFormation stack involved in a GuardDuty
 * finding, including unique identifiers of the Amazon EC2 instances.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/CloudformationStack">AWS
 * API Reference</a></p>
 */
class CloudformationStack {
 public:
  AWS_GUARDDUTY_API CloudformationStack() = default;
  AWS_GUARDDUTY_API CloudformationStack(Aws::Utils::Json::JsonView jsonValue);
  AWS_GUARDDUTY_API CloudformationStack& operator=(Aws::Utils::Json::JsonView jsonValue);
  AWS_GUARDDUTY_API Aws::Utils::Json::JsonValue Jsonize() const;

  ///@{
  /**
   * <p>A list of unique identifiers for the compromised Amazon EC2 instances that
   * were created as part of the same CloudFormation stack.</p>
   */
  ...
  template <typename Ec2InstanceUidsT = Aws::Vector<Aws::String>>
  CloudformationStack& WithEc2InstanceUids(Ec2InstanceUidsT&& value) {
    SetEc2InstanceUids(std::forward<Ec2InstanceUidsT>(value));
    return *this;
  }
  template <typename Ec2InstanceUidsT = Aws::String>
  CloudformationStack& AddEc2InstanceUids(Ec2InstanceUidsT&& value) {
    m_ec2InstanceUidsHasBeenSet = true;
