...
class UsageStatistics {
 public:
  ...
  void SetTopAccountsByFeature(TopAccountsByFeatureT&& value) {
    ...
    m_topAccountsByFeature = std::forward<TopAccountsByFeatureT>(value);
  }
  template <typename TopAccountsByFeatureT = Aws::Vector<UsageTopAccountsResult>>
  UsageStatistics& WithTopAccountsByFeature(TopAccountsByFeatureT&& value) {
    SetTopAccountsByFeature(std::forward<TopAccountsByFeatureT>(value));
    return *this;
  }
  ...
  UsageStatistics& AddTopAccountsByFeature(TopAccountsByFeatureT&& value) {
    m_topAccountsByFeatureHasBeenSet = true;
    m_topAccountsByFeature.emplace_back(std::forward<TopAccountsByFeatureT>(value));
    return *this;
  }
  ///@}
