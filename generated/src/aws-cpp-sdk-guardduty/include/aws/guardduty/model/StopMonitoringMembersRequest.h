...
class StopMonitoringMembersRequest : public GuardDutyRequest {
 public:
  ...
  template <typename DetectorIdT = Aws::String>
  StopMonitoringMembersRequest& WithDetectorId(DetectorIdT&& value) {
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  StopMonitoringMembersRequest& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  StopMonitoringMembersRequest& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
