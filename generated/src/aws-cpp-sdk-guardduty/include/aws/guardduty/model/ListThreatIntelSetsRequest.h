...
class ListThreatIntelSetsRequest : public GuardDutyRequest {
 public:
  ...
  template <typename DetectorIdT = Aws::String>
  ListThreatIntelSetsRequest& WithDetectorId(DetectorIdT&& value) {
  ...
  inline ListThreatIntelSetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListThreatIntelSetsRequest& WithNextToken(NextTokenT&& value) {
