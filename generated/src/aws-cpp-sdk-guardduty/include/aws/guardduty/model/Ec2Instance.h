...
class Ec2Instance {
 public:
  ...
  void SetEc2NetworkInterfaceUids(Ec2NetworkInterfaceUidsT&& value) {
    ...
    m_ec2NetworkInterfaceUids = std::forward<Ec2NetworkInterfaceUidsT>(value);
  }
  template <typename Ec2NetworkInterfaceUidsT = Aws::Vector<Aws::String>>
  Ec2Instance& WithEc2NetworkInterfaceUids(Ec2NetworkInterfaceUidsT&& value) {
    SetEc2NetworkInterfaceUids(std::forward<Ec2NetworkInterfaceUidsT>(value));
    return *this;
  }
  ...
  Ec2Instance& AddEc2NetworkInterfaceUids(Ec2NetworkInterfaceUidsT&& value) {
    m_ec2NetworkInterfaceUidsHasBeenSet = true;
    m_ec2NetworkInterfaceUids.emplace_back(std::forward<Ec2NetworkInterfaceUidsT>(value));
    return *this;
  }
  ///@}
 private:
