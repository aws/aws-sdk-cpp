...
class MemberFeaturesConfiguration {
 public:
  ...
  inline MemberFeaturesConfiguration& WithName(OrgFeature value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline MemberFeaturesConfiguration& WithStatus(FeatureStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename AdditionalConfigurationT = Aws::Vector<MemberAdditionalConfiguration>>
  MemberFeaturesConfiguration& WithAdditionalConfiguration(AdditionalConfigurationT&& value) {
  ...
  MemberFeaturesConfiguration& AddAdditionalConfiguration(AdditionalConfigurationT&& value) {
    m_additionalConfigurationHasBeenSet = true;
