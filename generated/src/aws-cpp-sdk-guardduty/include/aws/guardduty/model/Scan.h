...
class Scan {
 public:
  ...
  inline void SetScanStatus(ScanStatus value) {
    m_scanStatusHasBeenSet = true;
    m_scanStatus = value;
  }
  inline Scan& WithScanStatus(ScanStatus value) {
    SetScanStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetScanStartTime(ScanStartTimeT&& value) {
    ...
    m_scanStartTime = std::forward<ScanStartTimeT>(value);
  }
  template <typename ScanStartTimeT = Aws::Utils::DateTime>
  Scan& WithScanStartTime(ScanStartTimeT&& value) {
    SetScanStartTime(std::forward<ScanStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScanEndTime(ScanEndTimeT&& value) {
    ...
    m_scanEndTime = std::forward<ScanEndTimeT>(value);
  }
  template <typename ScanEndTimeT = Aws::Utils::DateTime>
  Scan& WithScanEndTime(ScanEndTimeT&& value) {
    SetScanEndTime(std::forward<ScanEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline Scan& WithTotalBytes(long long value) {
    SetTotalBytes(value);
    return *this;
  }
  ///@}
  ...
  inline Scan& WithFileCount(long long value) {
    SetFileCount(value);
    return *this;
  }
  ///@}
  ...
  void SetAttachedVolumes(AttachedVolumesT&& value) {
    ...
    m_attachedVolumes = std::forward<AttachedVolumesT>(value);
  }
  template <typename AttachedVolumesT = Aws::Vector<VolumeDetail>>
  Scan& WithAttachedVolumes(AttachedVolumesT&& value) {
    SetAttachedVolumes(std::forward<AttachedVolumesT>(value));
    return *this;
  }
  template <typename AttachedVolumesT = VolumeDetail>
  Scan& AddAttachedVolumes(AttachedVolumesT&& value) {
    m_attachedVolumesHasBeenSet = true;
    m_attachedVolumes.emplace_back(std::forward<AttachedVolumesT>(value));
    return *this;
  }
  ///@}
  ...
  inline Scan& WithScanType(ScanType value) {
    SetScanType(value);
    return *this;
  }
  ///@}
