...
class EbsVolumeScanDetails {
 public:
  ...
  void SetTriggerFindingId(TriggerFindingIdT&& value) {
    ...
    m_triggerFindingId = std::forward<TriggerFindingIdT>(value);
  }
  template <typename TriggerFindingIdT = Aws::String>
  EbsVolumeScanDetails& WithTriggerFindingId(TriggerFindingIdT&& value) {
    SetTriggerFindingId(std::forward<TriggerFindingIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScanDetections(ScanDetectionsT&& value) {
    ...
    m_scanDetections = std::forward<ScanDetectionsT>(value);
  }
  template <typename ScanDetectionsT = ScanDetections>
  EbsVolumeScanDetails& WithScanDetections(ScanDetectionsT&& value) {
    SetScanDetections(std::forward<ScanDetectionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline EbsVolumeScanDetails& WithScanType(ScanType value) {
    SetScanType(value);
    return *this;
  }
  ///@}
