...
class OrganizationStatistics {
 public:
  ...
  inline void SetTotalAccountsCount(int value) {
    m_totalAccountsCountHasBeenSet = true;
    m_totalAccountsCount = value;
  }
  inline OrganizationStatistics& WithTotalAccountsCount(int value) {
    SetTotalAccountsCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMemberAccountsCount(int value) {
    m_memberAccountsCountHasBeenSet = true;
    m_memberAccountsCount = value;
  }
  inline OrganizationStatistics& WithMemberAccountsCount(int value) {
    SetMemberAccountsCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetActiveAccountsCount(int value) {
    m_activeAccountsCountHasBeenSet = true;
    m_activeAccountsCount = value;
  }
  inline OrganizationStatistics& WithActiveAccountsCount(int value) {
    SetActiveAccountsCount(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationStatistics& WithEnabledAccountsCount(int value) {
  ...
  void SetCountByFeature(CountByFeatureT&& value) {
    ...
    m_countByFeature = std::forward<CountByFeatureT>(value);
  }
  template <typename CountByFeatureT = Aws::Vector<OrganizationFeatureStatistics>>
  OrganizationStatistics& WithCountByFeature(CountByFeatureT&& value) {
    SetCountByFeature(std::forward<CountByFeatureT>(value));
    return *this;
  }
  ...
  OrganizationStatistics& AddCountByFeature(CountByFeatureT&& value) {
    m_countByFeatureHasBeenSet = true;
    m_countByFeature.emplace_back(std::forward<CountByFeatureT>(value));
    return *this;
  }
  ///@}
 private:
