...
class ListPublishingDestinationsResult {
 public:
  ...
  template <typename DestinationsT = Aws::Vector<Destination>>
  ListPublishingDestinationsResult& WithDestinations(DestinationsT&& value) {
    SetDestinations(std::forward<DestinationsT>(value));
    return *this;
  }
  template <typename DestinationsT = Destination>
  ListPublishingDestinationsResult& AddDestinations(DestinationsT&& value) {
    m_destinationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPublishingDestinationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPublishingDestinationsResult& WithRequestId(RequestIdT&& value) {
