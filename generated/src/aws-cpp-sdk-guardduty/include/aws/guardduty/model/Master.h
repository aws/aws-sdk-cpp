...
class Master {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  Master& WithAccountId(AccountIdT&& value) {
  ...
  template <typename InvitationIdT = Aws::String>
  Master& WithInvitationId(InvitationIdT&& value) {
  ...
  template <typename RelationshipStatusT = Aws::String>
  Master& WithRelationshipStatus(RelationshipStatusT&& value) {
  ...
  template <typename InvitedAtT = Aws::String>
  Master& WithInvitedAt(InvitedAtT&& value) {
