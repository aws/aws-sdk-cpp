...
namespace Model
{
  ...
  /**
   */
  class DeleteThreatEntitySetRequest : public GuardDutyRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteThreatEntitySet"; }
    ...
    ///@{
    /**
     * <p>The unique ID of the detector associated with the threat entity set
    ...
    template<typename DetectorIdT = Aws::String>
    DeleteThreatEntitySetRequest& WithDetectorId(DetectorIdT&& value) { SetDetectorId(std::forward<DetectorIdT>(value)); return *this;}
    ///@}

    ///@{
    /**
     * <p>The unique ID that helps GuardDuty identify which threat entity set needs to
     * be deleted.</p>
     */
    ...
    template<typename ThreatEntitySetIdT = Aws::String>
    DeleteThreatEntitySetRequest& WithThreatEntitySetId(ThreatEntitySetIdT&& value) { SetThreatEntitySetId(std::forward<ThreatEntitySetIdT>(value)); return *this;}
    ///@}
  private:
