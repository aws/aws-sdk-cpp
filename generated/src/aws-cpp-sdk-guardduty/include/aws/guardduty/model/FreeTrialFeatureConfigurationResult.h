...
class FreeTrialFeatureConfigurationResult {
 public:
  ...
  inline void SetName(FreeTrialFeatureResult value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline FreeTrialFeatureConfigurationResult& WithName(FreeTrialFeatureResult value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFreeTrialDaysRemaining(int value) {
    m_freeTrialDaysRemainingHasBeenSet = true;
    m_freeTrialDaysRemaining = value;
  }
  inline FreeTrialFeatureConfigurationResult& WithFreeTrialDaysRemaining(int value) {
    SetFreeTrialDaysRemaining(value);
    return *this;
  }
  ///@}
 private:
