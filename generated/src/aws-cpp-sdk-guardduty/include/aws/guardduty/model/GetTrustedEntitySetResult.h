...
namespace Model
{
  ...
  public:
    ...
    ///@{
    /**
     * <p>The name of the threat entity set associated with the specified
    ...
    template<typename NameT = Aws::String>
    GetTrustedEntitySetResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline void SetFormat(TrustedEntitySetFormat value) { m_formatHasBeenSet = true; m_format = value; }
    inline GetTrustedEntitySetResult& WithFormat(TrustedEntitySetFormat value) { SetFormat(value); return *this;}
    ///@}
    ...
    template<typename LocationT = Aws::String>
    GetTrustedEntitySetResult& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
    ...
    template<typename ExpectedBucketOwnerT = Aws::String>
    GetTrustedEntitySetResult& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) { SetExpectedBucketOwner(std::forward<ExpectedBucketOwnerT>(value)); return *this;}
    ///@}
     ...
     */
    inline TrustedEntitySetStatus GetStatus() const { return m_status; }
    inline void SetStatus(TrustedEntitySetStatus value) { m_statusHasBeenSet = true; m_status = value; }
    inline GetTrustedEntitySetResult& WithStatus(TrustedEntitySetStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    GetTrustedEntitySetResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetTrustedEntitySetResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdatedAtT = Aws::Utils::DateTime>
    GetTrustedEntitySetResult& WithUpdatedAt(UpdatedAtT&& value) { SetUpdatedAt(std::forward<UpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorDetailsT = Aws::String>
    GetTrustedEntitySetResult& WithErrorDetails(ErrorDetailsT&& value) { SetErrorDetails(std::forward<ErrorDetailsT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetTrustedEntitySetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
