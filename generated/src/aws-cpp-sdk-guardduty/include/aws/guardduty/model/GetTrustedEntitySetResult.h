...
class GetTrustedEntitySetResult {
 public:
  ...
  inline GetTrustedEntitySetResult& WithFormat(TrustedEntitySetFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(TrustedEntitySetStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetTrustedEntitySetResult& WithStatus(TrustedEntitySetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
