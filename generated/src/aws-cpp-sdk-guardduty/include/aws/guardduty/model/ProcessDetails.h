...
class ProcessDetails {
 public:
  ...
  void SetExecutableSha256(ExecutableSha256T&& value) {
    ...
    m_executableSha256 = std::forward<ExecutableSha256T>(value);
  }
  template <typename ExecutableSha256T = Aws::String>
  ProcessDetails& WithExecutableSha256(ExecutableSha256T&& value) {
    SetExecutableSha256(std::forward<ExecutableSha256T>(value));
    return *this;
  }
  ///@}
  ...
  inline ProcessDetails& WithNamespacePid(int value) {
  ...
  void SetPwd(PwdT&& value) {
    ...
    m_pwd = std::forward<PwdT>(value);
  }
  template <typename PwdT = Aws::String>
  ProcessDetails& WithPwd(PwdT&& value) {
    SetPwd(std::forward<PwdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ProcessDetails& WithUserId(int value) {
    SetUserId(value);
    return *this;
  }
  ///@}
  ...
  inline ProcessDetails& WithEuid(int value) {
    SetEuid(value);
    return *this;
  }
  ///@}
  ...
  ProcessDetails& AddLineage(LineageT&& value) {
    m_lineageHasBeenSet = true;
    m_lineage.emplace_back(std::forward<LineageT>(value));
    return *this;
  }
  ///@}
 private:
