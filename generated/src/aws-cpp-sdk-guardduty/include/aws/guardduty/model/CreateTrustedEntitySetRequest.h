...
namespace Model
{
  ...
  public:
    ...
    template<typename DetectorIdT = Aws::String>
    CreateTrustedEntitySetRequest& WithDetectorId(DetectorIdT&& value) { SetDetectorId(std::forward<DetectorIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateTrustedEntitySetRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline CreateTrustedEntitySetRequest& WithFormat(TrustedEntitySetFormat value) { SetFormat(value); return *this;}
    ///@}
    ...
    template<typename LocationT = Aws::String>
    CreateTrustedEntitySetRequest& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
    ...
    template<typename ExpectedBucketOwnerT = Aws::String>
    CreateTrustedEntitySetRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) { SetExpectedBucketOwner(std::forward<ExpectedBucketOwnerT>(value)); return *this;}
    ///@}
    ...
    inline CreateTrustedEntitySetRequest& WithActivate(bool value) { SetActivate(value); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    CreateTrustedEntitySetRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreateTrustedEntitySetRequest& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
