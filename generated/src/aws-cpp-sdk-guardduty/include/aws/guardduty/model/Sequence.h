...
class Sequence {
 public:
  ...
  void SetSequenceIndicators(SequenceIndicatorsT&& value) {
    ...
    m_sequenceIndicators = std::forward<SequenceIndicatorsT>(value);
  }
  template <typename SequenceIndicatorsT = Aws::Vector<Indicator>>
  Sequence& WithSequenceIndicators(SequenceIndicatorsT&& value) {
    SetSequenceIndicators(std::forward<SequenceIndicatorsT>(value));
    return *this;
  }
  template <typename SequenceIndicatorsT = Indicator>
  Sequence& AddSequenceIndicators(SequenceIndicatorsT&& value) {
    m_sequenceIndicatorsHasBeenSet = true;
    m_sequenceIndicators.emplace_back(std::forward<SequenceIndicatorsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdditionalSequenceTypes(AdditionalSequenceTypesT&& value) {
    ...
    m_additionalSequenceTypes = std::forward<AdditionalSequenceTypesT>(value);
  }
  template <typename AdditionalSequenceTypesT = Aws::Vector<Aws::String>>
  Sequence& WithAdditionalSequenceTypes(AdditionalSequenceTypesT&& value) {
    SetAdditionalSequenceTypes(std::forward<AdditionalSequenceTypesT>(value));
    return *this;
  }
  template <typename AdditionalSequenceTypesT = Aws::String>
  Sequence& AddAdditionalSequenceTypes(AdditionalSequenceTypesT&& value) {
    m_additionalSequenceTypesHasBeenSet = true;
    m_additionalSequenceTypes.emplace_back(std::forward<AdditionalSequenceTypesT>(value));
    return *this;
  }
  ///@}
 private:
