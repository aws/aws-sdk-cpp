...
class CoverageSortCriteria {
 public:
  ...
  inline void SetAttributeName(CoverageSortKey value) {
    m_attributeNameHasBeenSet = true;
    m_attributeName = value;
  }
  inline CoverageSortCriteria& WithAttributeName(CoverageSortKey value) {
  ...
  inline CoverageSortCriteria& WithOrderBy(OrderBy value) {
    SetOrderBy(value);
    return *this;
  }
  ///@}
