...
class KubernetesWorkload {
 public:
  ...
  inline void SetKubernetesResourcesTypes(KubernetesResourcesTypes value) {
    m_kubernetesResourcesTypesHasBeenSet = true;
    m_kubernetesResourcesTypes = value;
  }
  inline KubernetesWorkload& WithKubernetesResourcesTypes(KubernetesResourcesTypes value) {
    SetKubernetesResourcesTypes(value);
    return *this;
  }
  ///@}
 private:
