...
class KubernetesUserDetails {
 public:
  ...
  KubernetesUserDetails& AddSessionName(SessionNameT&& value) {
    m_sessionNameHasBeenSet = true;
    m_sessionName.emplace_back(std::forward<SessionNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpersonatedUser(ImpersonatedUserT&& value) {
    ...
    m_impersonatedUser = std::forward<ImpersonatedUserT>(value);
  }
  template <typename ImpersonatedUserT = ImpersonatedUser>
  KubernetesUserDetails& WithImpersonatedUser(ImpersonatedUserT&& value) {
    SetImpersonatedUser(std::forward<ImpersonatedUserT>(value));
    return *this;
  }
  ///@}
 private:
