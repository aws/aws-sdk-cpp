...
class LoginAttribute {
 public:
  ...
  inline void SetFailedLoginAttempts(int value) {
    m_failedLoginAttemptsHasBeenSet = true;
    m_failedLoginAttempts = value;
  }
  inline LoginAttribute& WithFailedLoginAttempts(int value) {
  ...
  inline void SetSuccessfulLoginAttempts(int value) {
    m_successfulLoginAttemptsHasBeenSet = true;
    m_successfulLoginAttempts = value;
  }
  inline LoginAttribute& WithSuccessfulLoginAttempts(int value) {
    SetSuccessfulLoginAttempts(value);
    return *this;
  }
  ///@}
 private:
