...
namespace Model
{
  ...
  {
  public:
    AWS_GUARDDUTY_API UpdateFilterResult() = default;
    ...
    template<typename NameT = Aws::String>
    UpdateFilterResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFilterResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
