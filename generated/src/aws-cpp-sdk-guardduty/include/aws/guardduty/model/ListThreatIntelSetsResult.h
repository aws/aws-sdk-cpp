...
class ListThreatIntelSetsResult {
 public:
  ...
  void SetThreatIntelSetIds(ThreatIntelSetIdsT&& value) {
    m_threatIntelSetIdsHasBeenSet = true;
    m_threatIntelSetIds = std::forward<ThreatIntelSetIdsT>(value);
  }
  template <typename ThreatIntelSetIdsT = Aws::Vector<Aws::String>>
  ListThreatIntelSetsResult& WithThreatIntelSetIds(ThreatIntelSetIdsT&& value) {
    SetThreatIntelSetIds(std::forward<ThreatIntelSetIdsT>(value));
    return *this;
  }
  template <typename ThreatIntelSetIdsT = Aws::String>
  ListThreatIntelSetsResult& AddThreatIntelSetIds(ThreatIntelSetIdsT&& value) {
    m_threatIntelSetIdsHasBeenSet = true;
    m_threatIntelSetIds.emplace_back(std::forward<ThreatIntelSetIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListThreatIntelSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListThreatIntelSetsResult& WithRequestId(RequestIdT&& value) {
