...
class FilterCondition {
 public:
  ...
  void SetEqualsValue(EqualsValueT&& value) {
    m_equalsValueHasBeenSet = true;
    m_equalsValue = std::forward<EqualsValueT>(value);
  }
  template <typename EqualsValueT = Aws::String>
  FilterCondition& WithEqualsValue(EqualsValueT&& value) {
    SetEqualsValue(std::forward<EqualsValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline FilterCondition& WithGreaterThan(long long value) {
  ...
  inline FilterCondition& WithLessThan(long long value) {
    SetLessThan(value);
    return *this;
  }
  ///@}
