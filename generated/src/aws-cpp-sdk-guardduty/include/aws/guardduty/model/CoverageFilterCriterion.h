...
class CoverageFilterCriterion {
 public:
  ...
  inline void SetCriterionKey(CoverageFilterCriterionKey value) {
    m_criterionKeyHasBeenSet = true;
    m_criterionKey = value;
  }
  inline CoverageFilterCriterion& WithCriterionKey(CoverageFilterCriterionKey value) {
    SetCriterionKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterConditionT = CoverageFilterCondition>
  CoverageFilterCriterion& WithFilterCondition(FilterConditionT&& value) {
