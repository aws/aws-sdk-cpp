...
/**
 * <p>Contains summary information about a custom detection rule.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/RuleSummary">AWS
 * API Reference</a></p>
 */
class RuleSummary {
 public:
  ...
  inline RuleSummary& WithSeverity(DetectionRuleSeverity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline RuleSummary& WithDataSource(DetectionRuleDataSource value) {
    SetDataSource(value);
    return *this;
  }
  ///@}
  ...
  inline RuleSummary& WithLanguage(RuleLanguage value) {
    SetLanguage(value);
    return *this;
  }
  ///@}
  ...
  inline RuleSummary& WithSchema(RuleSchema value) {
    SetSchema(value);
    return *this;
  }
  ///@}
