...
class AcceptAdministratorInvitationRequest : public GuardDutyRequest {
 public:
  ...
  template <typename DetectorIdT = Aws::String>
  AcceptAdministratorInvitationRequest& WithDetectorId(DetectorIdT&& value) {
  ...
  void SetAdministratorId(AdministratorIdT&& value) {
    ...
    m_administratorId = std::forward<AdministratorIdT>(value);
  }
  template <typename AdministratorIdT = Aws::String>
  AcceptAdministratorInvitationRequest& WithAdministratorId(AdministratorIdT&& value) {
    SetAdministratorId(std::forward<AdministratorIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename InvitationIdT = Aws::String>
  AcceptAdministratorInvitationRequest& WithInvitationId(InvitationIdT&& value) {
