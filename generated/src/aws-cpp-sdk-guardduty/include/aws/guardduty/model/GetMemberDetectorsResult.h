...
class GetMemberDetectorsResult {
 public:
   ...
   * account.</p>
   */
  inline const Aws::Vector<MemberDataSourceConfiguration>& GetMemberDataSourceConfigurations() const {
    return m_memberDataSourceConfigurations;
  }
  template <typename MemberDataSourceConfigurationsT = Aws::Vector<MemberDataSourceConfiguration>>
  void SetMemberDataSourceConfigurations(MemberDataSourceConfigurationsT&& value) {
    m_memberDataSourceConfigurationsHasBeenSet = true;
    m_memberDataSourceConfigurations = std::forward<MemberDataSourceConfigurationsT>(value);
  }
  template <typename MemberDataSourceConfigurationsT = Aws::Vector<MemberDataSourceConfiguration>>
  GetMemberDetectorsResult& WithMemberDataSourceConfigurations(MemberDataSourceConfigurationsT&& value) {
    SetMemberDataSourceConfigurations(std::forward<MemberDataSourceConfigurationsT>(value));
    return *this;
  }
  template <typename MemberDataSourceConfigurationsT = MemberDataSourceConfiguration>
  GetMemberDetectorsResult& AddMemberDataSourceConfigurations(MemberDataSourceConfigurationsT&& value) {
    m_memberDataSourceConfigurationsHasBeenSet = true;
    m_memberDataSourceConfigurations.emplace_back(std::forward<MemberDataSourceConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UnprocessedAccountsT = Aws::Vector<UnprocessedAccount>>
  GetMemberDetectorsResult& WithUnprocessedAccounts(UnprocessedAccountsT&& value) {
    SetUnprocessedAccounts(std::forward<UnprocessedAccountsT>(value));
    return *this;
  }
  template <typename UnprocessedAccountsT = UnprocessedAccount>
  GetMemberDetectorsResult& AddUnprocessedAccounts(UnprocessedAccountsT&& value) {
    m_unprocessedAccountsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetMemberDetectorsResult& WithRequestId(RequestIdT&& value) {
