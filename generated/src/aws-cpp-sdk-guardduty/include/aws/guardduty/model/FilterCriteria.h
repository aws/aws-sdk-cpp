...
class FilterCriteria {
 public:
  ...
  void SetFilterCriterion(FilterCriterionT&& value) {
    m_filterCriterionHasBeenSet = true;
    m_filterCriterion = std::forward<FilterCriterionT>(value);
  }
  template <typename FilterCriterionT = Aws::Vector<FilterCriterion>>
  FilterCriteria& WithFilterCriterion(FilterCriterionT&& value) {
    SetFilterCriterion(std::forward<FilterCriterionT>(value));
    return *this;
  }
  template <typename FilterCriterionT = FilterCriterion>
  FilterCriteria& AddFilterCriterion(FilterCriterionT&& value) {
    m_filterCriterionHasBeenSet = true;
    m_filterCriterion.emplace_back(std::forward<FilterCriterionT>(value));
    return *this;
  }
  ///@}
 private:
