...
class OrganizationFeatureConfigurationResult {
 public:
  ...
  inline void SetName(OrgFeature value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline OrganizationFeatureConfigurationResult& WithName(OrgFeature value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationFeatureConfigurationResult& WithAutoEnable(OrgFeatureStatus value) {
    SetAutoEnable(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<OrganizationAdditionalConfigurationResult>& GetAdditionalConfiguration() const {
  ...
  void SetAdditionalConfiguration(AdditionalConfigurationT&& value) {
    ...
    m_additionalConfiguration = std::forward<AdditionalConfigurationT>(value);
  }
  template <typename AdditionalConfigurationT = Aws::Vector<OrganizationAdditionalConfigurationResult>>
  OrganizationFeatureConfigurationResult& WithAdditionalConfiguration(AdditionalConfigurationT&& value) {
    SetAdditionalConfiguration(std::forward<AdditionalConfigurationT>(value));
    return *this;
  }
  ...
  OrganizationFeatureConfigurationResult& AddAdditionalConfiguration(AdditionalConfigurationT&& value) {
    m_additionalConfigurationHasBeenSet = true;
    m_additionalConfiguration.emplace_back(std::forward<AdditionalConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
