...
class FilterCriterion {
 public:
  ...
  inline void SetCriterionKey(CriterionKey value) {
    m_criterionKeyHasBeenSet = true;
    m_criterionKey = value;
  }
  inline FilterCriterion& WithCriterionKey(CriterionKey value) {
  ...
  template <typename FilterConditionT = FilterCondition>
  FilterCriterion& WithFilterCondition(FilterConditionT&& value) {
