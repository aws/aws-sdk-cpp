...
class FindingStatistics {
 public:
  ...
  void SetGroupedByAccount(GroupedByAccountT&& value) {
    ...
    m_groupedByAccount = std::forward<GroupedByAccountT>(value);
  }
  template <typename GroupedByAccountT = Aws::Vector<AccountStatistics>>
  FindingStatistics& WithGroupedByAccount(GroupedByAccountT&& value) {
    SetGroupedByAccount(std::forward<GroupedByAccountT>(value));
    return *this;
  }
  template <typename GroupedByAccountT = AccountStatistics>
  FindingStatistics& AddGroupedByAccount(GroupedByAccountT&& value) {
    m_groupedByAccountHasBeenSet = true;
    m_groupedByAccount.emplace_back(std::forward<GroupedByAccountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupedByDate(GroupedByDateT&& value) {
    ...
    m_groupedByDate = std::forward<GroupedByDateT>(value);
  }
  template <typename GroupedByDateT = Aws::Vector<DateStatistics>>
  FindingStatistics& WithGroupedByDate(GroupedByDateT&& value) {
    SetGroupedByDate(std::forward<GroupedByDateT>(value));
    return *this;
  }
  template <typename GroupedByDateT = DateStatistics>
  FindingStatistics& AddGroupedByDate(GroupedByDateT&& value) {
    m_groupedByDateHasBeenSet = true;
    m_groupedByDate.emplace_back(std::forward<GroupedByDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupedByFindingType(GroupedByFindingTypeT&& value) {
    ...
    m_groupedByFindingType = std::forward<GroupedByFindingTypeT>(value);
  }
  template <typename GroupedByFindingTypeT = Aws::Vector<FindingTypeStatistics>>
  FindingStatistics& WithGroupedByFindingType(GroupedByFindingTypeT&& value) {
    SetGroupedByFindingType(std::forward<GroupedByFindingTypeT>(value));
    return *this;
  }
  ...
  FindingStatistics& AddGroupedByFindingType(GroupedByFindingTypeT&& value) {
    m_groupedByFindingTypeHasBeenSet = true;
    m_groupedByFindingType.emplace_back(std::forward<GroupedByFindingTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupedByResource(GroupedByResourceT&& value) {
    ...
    m_groupedByResource = std::forward<GroupedByResourceT>(value);
  }
  template <typename GroupedByResourceT = Aws::Vector<ResourceStatistics>>
  FindingStatistics& WithGroupedByResource(GroupedByResourceT&& value) {
    SetGroupedByResource(std::forward<GroupedByResourceT>(value));
    return *this;
  }
  template <typename GroupedByResourceT = ResourceStatistics>
  FindingStatistics& AddGroupedByResource(GroupedByResourceT&& value) {
    m_groupedByResourceHasBeenSet = true;
    m_groupedByResource.emplace_back(std::forward<GroupedByResourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupedBySeverity(GroupedBySeverityT&& value) {
    ...
    m_groupedBySeverity = std::forward<GroupedBySeverityT>(value);
  }
  template <typename GroupedBySeverityT = Aws::Vector<SeverityStatistics>>
  FindingStatistics& WithGroupedBySeverity(GroupedBySeverityT&& value) {
    SetGroupedBySeverity(std::forward<GroupedBySeverityT>(value));
    return *this;
  }
  template <typename GroupedBySeverityT = SeverityStatistics>
  FindingStatistics& AddGroupedBySeverity(GroupedBySeverityT&& value) {
    m_groupedBySeverityHasBeenSet = true;
    m_groupedBySeverity.emplace_back(std::forward<GroupedBySeverityT>(value));
    return *this;
  }
  ///@}
 private:
