...
class UpdateFilterRequest : public GuardDutyRequest {
 public:
  ...
  template <typename DetectorIdT = Aws::String>
  UpdateFilterRequest& WithDetectorId(DetectorIdT&& value) {
  ...
  template <typename FilterNameT = Aws::String>
  UpdateFilterRequest& WithFilterName(FilterNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateFilterRequest& WithDescription(DescriptionT&& value) {
  ...
  inline UpdateFilterRequest& WithAction(FilterAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFilterRequest& WithRank(int value) {
    SetRank(value);
    return *this;
  }
  ///@}
  ...
  template <typename FindingCriteriaT = FindingCriteria>
  UpdateFilterRequest& WithFindingCriteria(FindingCriteriaT&& value) {
