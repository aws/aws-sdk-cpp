...
class PermissionConfiguration {
 public:
  ...
  template <typename BucketLevelPermissionsT = BucketLevelPermissions>
  PermissionConfiguration& WithBucketLevelPermissions(BucketLevelPermissionsT&& value) {
  ...
  template <typename AccountLevelPermissionsT = AccountLevelPermissions>
  PermissionConfiguration& WithAccountLevelPermissions(AccountLevelPermissionsT&& value) {
