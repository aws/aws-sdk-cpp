...
class CoverageStatistics {
 public:
  ...
  void SetCountByResourceType(CountByResourceTypeT&& value) {
    ...
    m_countByResourceType = std::forward<CountByResourceTypeT>(value);
  }
  template <typename CountByResourceTypeT = Aws::Map<ResourceType, long long>>
  CoverageStatistics& WithCountByResourceType(CountByResourceTypeT&& value) {
    SetCountByResourceType(std::forward<CountByResourceTypeT>(value));
    return *this;
  }
  inline CoverageStatistics& AddCountByResourceType(ResourceType key, long long value) {
    m_countByResourceTypeHasBeenSet = true;
    m_countByResourceType.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetCountByCoverageStatus(CountByCoverageStatusT&& value) {
    ...
    m_countByCoverageStatus = std::forward<CountByCoverageStatusT>(value);
  }
  template <typename CountByCoverageStatusT = Aws::Map<CoverageStatus, long long>>
  CoverageStatistics& WithCountByCoverageStatus(CountByCoverageStatusT&& value) {
    SetCountByCoverageStatus(std::forward<CountByCoverageStatusT>(value));
    return *this;
  }
  inline CoverageStatistics& AddCountByCoverageStatus(CoverageStatus key, long long value) {
    m_countByCoverageStatusHasBeenSet = true;
    m_countByCoverageStatus.emplace(key, value);
    return *this;
  }
  ///@}
 private:
