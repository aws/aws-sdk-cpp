...
class UnarchiveFindingsRequest : public GuardDutyRequest {
 public:
  ...
  template <typename DetectorIdT = Aws::String>
  UnarchiveFindingsRequest& WithDetectorId(DetectorIdT&& value) {
  ...
  template <typename FindingIdsT = Aws::Vector<Aws::String>>
  UnarchiveFindingsRequest& WithFindingIds(FindingIdsT&& value) {
    SetFindingIds(std::forward<FindingIdsT>(value));
    return *this;
  }
  template <typename FindingIdsT = Aws::String>
  UnarchiveFindingsRequest& AddFindingIds(FindingIdsT&& value) {
    m_findingIdsHasBeenSet = true;
