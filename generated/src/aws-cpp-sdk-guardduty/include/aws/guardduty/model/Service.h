...
class Service {
 public:
  ...
  inline void SetArchived(bool value) {
    m_archivedHasBeenSet = true;
    m_archived = value;
  }
  inline Service& WithArchived(bool value) {
    SetArchived(value);
    return *this;
  }
  ///@}
  ...
  inline Service& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  void SetEventFirstSeen(EventFirstSeenT&& value) {
    ...
    m_eventFirstSeen = std::forward<EventFirstSeenT>(value);
  }
  template <typename EventFirstSeenT = Aws::String>
  Service& WithEventFirstSeen(EventFirstSeenT&& value) {
    SetEventFirstSeen(std::forward<EventFirstSeenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventLastSeen(EventLastSeenT&& value) {
    ...
    m_eventLastSeen = std::forward<EventLastSeenT>(value);
  }
  template <typename EventLastSeenT = Aws::String>
  Service& WithEventLastSeen(EventLastSeenT&& value) {
    SetEventLastSeen(std::forward<EventLastSeenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceRole(ResourceRoleT&& value) {
    ...
    m_resourceRole = std::forward<ResourceRoleT>(value);
  }
  template <typename ResourceRoleT = Aws::String>
  Service& WithResourceRole(ResourceRoleT&& value) {
    SetResourceRole(std::forward<ResourceRoleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserFeedback(UserFeedbackT&& value) {
    ...
    m_userFeedback = std::forward<UserFeedbackT>(value);
  }
  template <typename UserFeedbackT = Aws::String>
  Service& WithUserFeedback(UserFeedbackT&& value) {
    SetUserFeedback(std::forward<UserFeedbackT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEbsVolumeScanDetails(EbsVolumeScanDetailsT&& value) {
    ...
    m_ebsVolumeScanDetails = std::forward<EbsVolumeScanDetailsT>(value);
  }
  template <typename EbsVolumeScanDetailsT = EbsVolumeScanDetails>
  Service& WithEbsVolumeScanDetails(EbsVolumeScanDetailsT&& value) {
    SetEbsVolumeScanDetails(std::forward<EbsVolumeScanDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRuntimeDetails(RuntimeDetailsT&& value) {
    ...
    m_runtimeDetails = std::forward<RuntimeDetailsT>(value);
  }
  template <typename RuntimeDetailsT = RuntimeDetails>
  Service& WithRuntimeDetails(RuntimeDetailsT&& value) {
    SetRuntimeDetails(std::forward<RuntimeDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMalwareScanDetails(MalwareScanDetailsT&& value) {
    ...
    m_malwareScanDetails = std::forward<MalwareScanDetailsT>(value);
  }
  template <typename MalwareScanDetailsT = MalwareScanDetails>
  Service& WithMalwareScanDetails(MalwareScanDetailsT&& value) {
    SetMalwareScanDetails(std::forward<MalwareScanDetailsT>(value));
    return *this;
  }
  ///@}
 private:
