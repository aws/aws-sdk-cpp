...
/**
 */
class ListInvestigationsRequest : public GuardDutyRequest {
 public:
  ...
  ///@{
  /**
   * <p>The unique ID of the GuardDuty detector whose investigations you want to
   * list.</p> <p>To find the <code>detectorId</code> in the current Region, see the
   ...
   */
  inline const InvestigationSortCriteria& GetSortCriteria() const { return m_sortCriteria; }
  inline bool SortCriteriaHasBeenSet() const { return m_sortCriteriaHasBeenSet; }
  template <typename SortCriteriaT = InvestigationSortCriteria>
 ...
 private:
  ...
  InvestigationSortCriteria m_sortCriteria;
