...
namespace Model
{
  ...
  {
  public:
    AWS_GUARDDUTY_API ArchiveFindingsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ArchiveFindingsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
