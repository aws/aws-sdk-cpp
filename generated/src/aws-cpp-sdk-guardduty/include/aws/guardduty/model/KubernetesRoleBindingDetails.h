...
class KubernetesRoleBindingDetails {
 public:
  ...
  void SetRoleRefName(RoleRefNameT&& value) {
    ...
    m_roleRefName = std::forward<RoleRefNameT>(value);
  }
  template <typename RoleRefNameT = Aws::String>
  KubernetesRoleBindingDetails& WithRoleRefName(RoleRefNameT&& value) {
    SetRoleRefName(std::forward<RoleRefNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRoleRefKind(RoleRefKindT&& value) {
    ...
    m_roleRefKind = std::forward<RoleRefKindT>(value);
  }
  template <typename RoleRefKindT = Aws::String>
  KubernetesRoleBindingDetails& WithRoleRefKind(RoleRefKindT&& value) {
    SetRoleRefKind(std::forward<RoleRefKindT>(value));
    return *this;
  }
  ///@}
 private:
