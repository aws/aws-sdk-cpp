...
namespace Model
{
  ...
  /**
   */
  class GetThreatEntitySetRequest : public GuardDutyRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetThreatEntitySet"; }
    ...
    template<typename DetectorIdT = Aws::String>
    GetThreatEntitySetRequest& WithDetectorId(DetectorIdT&& value) { SetDetectorId(std::forward<DetectorIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ThreatEntitySetIdT = Aws::String>
    GetThreatEntitySetRequest& WithThreatEntitySetId(ThreatEntitySetIdT&& value) { SetThreatEntitySetId(std::forward<ThreatEntitySetIdT>(value)); return *this;}
    ///@}
  private:
