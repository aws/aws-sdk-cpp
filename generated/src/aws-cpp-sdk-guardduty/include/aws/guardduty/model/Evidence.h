...
class Evidence {
 public:
  ...
  void SetThreatIntelligenceDetails(ThreatIntelligenceDetailsT&& value) {
    m_threatIntelligenceDetailsHasBeenSet = true;
    m_threatIntelligenceDetails = std::forward<ThreatIntelligenceDetailsT>(value);
  }
  template <typename ThreatIntelligenceDetailsT = Aws::Vector<ThreatIntelligenceDetail>>
  Evidence& WithThreatIntelligenceDetails(ThreatIntelligenceDetailsT&& value) {
    SetThreatIntelligenceDetails(std::forward<ThreatIntelligenceDetailsT>(value));
    return *this;
  }
  template <typename ThreatIntelligenceDetailsT = ThreatIntelligenceDetail>
  Evidence& AddThreatIntelligenceDetails(ThreatIntelligenceDetailsT&& value) {
    m_threatIntelligenceDetailsHasBeenSet = true;
    m_threatIntelligenceDetails.emplace_back(std::forward<ThreatIntelligenceDetailsT>(value));
    return *this;
  }
  ///@}
 private:
