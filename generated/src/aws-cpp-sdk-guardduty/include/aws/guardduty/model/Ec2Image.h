...
/**
 * <p>Contains information about the Amazon EC2 Image involved in a GuardDuty
 * finding, including unique identifiers of the Amazon EC2 instances.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/Ec2Image">AWS
 * API Reference</a></p>
 */
class Ec2Image {
 public:
   ...
   * were launched with the same Amazon Machine Image (AMI).</p>
   */
