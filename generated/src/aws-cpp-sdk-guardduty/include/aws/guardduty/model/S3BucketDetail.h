...
class S3BucketDetail {
 public:
  ...
  template <typename ArnT = Aws::String>
  S3BucketDetail& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  S3BucketDetail& WithName(NameT&& value) {
  ...
  template <typename TypeT = Aws::String>
  S3BucketDetail& WithType(TypeT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  S3BucketDetail& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename OwnerT = Owner>
  S3BucketDetail& WithOwner(OwnerT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  S3BucketDetail& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  S3BucketDetail& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  void SetDefaultServerSideEncryption(DefaultServerSideEncryptionT&& value) {
    ...
    m_defaultServerSideEncryption = std::forward<DefaultServerSideEncryptionT>(value);
  }
  template <typename DefaultServerSideEncryptionT = DefaultServerSideEncryption>
  S3BucketDetail& WithDefaultServerSideEncryption(DefaultServerSideEncryptionT&& value) {
    SetDefaultServerSideEncryption(std::forward<DefaultServerSideEncryptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PublicAccessT = PublicAccess>
  S3BucketDetail& WithPublicAccess(PublicAccessT&& value) {
  ...
  void SetS3ObjectDetails(S3ObjectDetailsT&& value) {
    m_s3ObjectDetailsHasBeenSet = true;
    m_s3ObjectDetails = std::forward<S3ObjectDetailsT>(value);
  }
  template <typename S3ObjectDetailsT = Aws::Vector<S3ObjectDetail>>
  S3BucketDetail& WithS3ObjectDetails(S3ObjectDetailsT&& value) {
    SetS3ObjectDetails(std::forward<S3ObjectDetailsT>(value));
    return *this;
  }
  template <typename S3ObjectDetailsT = S3ObjectDetail>
  S3BucketDetail& AddS3ObjectDetails(S3ObjectDetailsT&& value) {
    m_s3ObjectDetailsHasBeenSet = true;
    m_s3ObjectDetails.emplace_back(std::forward<S3ObjectDetailsT>(value));
    return *this;
  }
  ///@}
 private:
