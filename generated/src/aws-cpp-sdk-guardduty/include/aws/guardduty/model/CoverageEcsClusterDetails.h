...
class CoverageEcsClusterDetails {
 public:
  ...
  void SetFargateDetails(FargateDetailsT&& value) {
    ...
    m_fargateDetails = std::forward<FargateDetailsT>(value);
  }
  template <typename FargateDetailsT = FargateDetails>
  CoverageEcsClusterDetails& WithFargateDetails(FargateDetailsT&& value) {
    SetFargateDetails(std::forward<FargateDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContainerInstanceDetails(ContainerInstanceDetailsT&& value) {
    ...
    m_containerInstanceDetails = std::forward<ContainerInstanceDetailsT>(value);
  }
  template <typename ContainerInstanceDetailsT = ContainerInstanceDetails>
  CoverageEcsClusterDetails& WithContainerInstanceDetails(ContainerInstanceDetailsT&& value) {
    SetContainerInstanceDetails(std::forward<ContainerInstanceDetailsT>(value));
    return *this;
  }
  ///@}
 private:
