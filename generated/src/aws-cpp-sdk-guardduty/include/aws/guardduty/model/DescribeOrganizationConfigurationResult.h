...
class DescribeOrganizationConfigurationResult {
 public:
  ...
  AWS_GUARDDUTY_API DescribeOrganizationConfigurationResult& operator=(
  ...
  template <typename FeaturesT = Aws::Vector<OrganizationFeatureConfigurationResult>>
  DescribeOrganizationConfigurationResult& WithFeatures(FeaturesT&& value) {
    SetFeatures(std::forward<FeaturesT>(value));
    return *this;
  }
  template <typename FeaturesT = OrganizationFeatureConfigurationResult>
  DescribeOrganizationConfigurationResult& AddFeatures(FeaturesT&& value) {
    m_featuresHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeOrganizationConfigurationResult& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetAutoEnableOrganizationMembers(AutoEnableMembers value) {
    m_autoEnableOrganizationMembersHasBeenSet = true;
    m_autoEnableOrganizationMembers = value;
  }
  inline DescribeOrganizationConfigurationResult& WithAutoEnableOrganizationMembers(AutoEnableMembers value) {
