...
namespace Model
{
  ...
  /**
   * <p>Contains information about AWS Fargate details associated with an Amazon ECS
  ...
  public:
    ...
    /**
     * <p>Runtime coverage issues identified for the resource running on AWS
     * Fargate.</p>
     */
     ...
     * security agent updates for this resource.</p> </li> <li> <p>
     * <code>DISABLED</code> indicates that the deployment of the GuardDuty security
     * agent is disabled for this resource.</p> </li> </ul>
     */
