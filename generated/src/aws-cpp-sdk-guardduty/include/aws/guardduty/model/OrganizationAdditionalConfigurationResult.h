...
namespace Model
{
  ...
  {
  public:
    AWS_GUARDDUTY_API OrganizationAdditionalConfigurationResult() = default;
    ...
    inline OrganizationAdditionalConfigurationResult& WithName(OrgFeatureAdditionalConfiguration value) { SetName(value); return *this;}
    ///@}
    ...
    inline OrganizationAdditionalConfigurationResult& WithAutoEnable(OrgFeatureStatus value) { SetAutoEnable(value); return *this;}
    ///@}
  private:
