...
class OrganizationAdditionalConfigurationResult {
 public:
  ...
  inline OrganizationAdditionalConfigurationResult& WithName(OrgFeatureAdditionalConfiguration value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationAdditionalConfigurationResult& WithAutoEnable(OrgFeatureStatus value) {
    SetAutoEnable(value);
    return *this;
  }
  ///@}
