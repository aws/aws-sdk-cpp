...
namespace Model
{
  ...
  public:
    ...
    inline GetThreatIntelSetResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetThreatIntelSetResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetThreatIntelSetResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
