...
class OrganizationFeatureConfiguration {
 public:
  ...
  inline OrganizationFeatureConfiguration& WithName(OrgFeature value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationFeatureConfiguration& WithAutoEnable(OrgFeatureStatus value) {
    SetAutoEnable(value);
    return *this;
  }
  ///@}
  ...
  template <typename AdditionalConfigurationT = Aws::Vector<OrganizationAdditionalConfiguration>>
  OrganizationFeatureConfiguration& WithAdditionalConfiguration(AdditionalConfigurationT&& value) {
  ...
  OrganizationFeatureConfiguration& AddAdditionalConfiguration(AdditionalConfigurationT&& value) {
    m_additionalConfigurationHasBeenSet = true;
