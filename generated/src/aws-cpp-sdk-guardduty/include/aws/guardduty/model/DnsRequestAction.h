...
class DnsRequestAction {
 public:
  ...
  inline DnsRequestAction& WithBlocked(bool value) {
    SetBlocked(value);
    return *this;
  }
  ///@}
  ...
  void SetDomainWithSuffix(DomainWithSuffixT&& value) {
    ...
    m_domainWithSuffix = std::forward<DomainWithSuffixT>(value);
  }
  template <typename DomainWithSuffixT = Aws::String>
  DnsRequestAction& WithDomainWithSuffix(DomainWithSuffixT&& value) {
    SetDomainWithSuffix(std::forward<DomainWithSuffixT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVpcOwnerAccountId(VpcOwnerAccountIdT&& value) {
    ...
    m_vpcOwnerAccountId = std::forward<VpcOwnerAccountIdT>(value);
  }
  template <typename VpcOwnerAccountIdT = Aws::String>
  DnsRequestAction& WithVpcOwnerAccountId(VpcOwnerAccountIdT&& value) {
    SetVpcOwnerAccountId(std::forward<VpcOwnerAccountIdT>(value));
    return *this;
  }
  ///@}
 private:
