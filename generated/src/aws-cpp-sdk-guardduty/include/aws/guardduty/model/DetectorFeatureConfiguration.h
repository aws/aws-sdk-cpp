...
class DetectorFeatureConfiguration {
 public:
  ...
  inline void SetName(DetectorFeature value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DetectorFeatureConfiguration& WithName(DetectorFeature value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline DetectorFeatureConfiguration& WithStatus(FeatureStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
