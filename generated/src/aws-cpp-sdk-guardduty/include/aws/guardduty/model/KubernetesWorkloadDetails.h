...
class KubernetesWorkloadDetails {
 public:
  ...
  inline KubernetesWorkloadDetails& WithHostNetwork(bool value) {
  ...
  inline void SetHostIPC(bool value) {
    m_hostIPCHasBeenSet = true;
    m_hostIPC = value;
  }
  inline KubernetesWorkloadDetails& WithHostIPC(bool value) {
    SetHostIPC(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHostPID(bool value) {
    m_hostPIDHasBeenSet = true;
    m_hostPID = value;
  }
  inline KubernetesWorkloadDetails& WithHostPID(bool value) {
    SetHostPID(value);
    return *this;
  }
  ///@}
