...
/**
 */
class CreateCustomDetectionRuleOrgConfigurationRequest : public GuardDutyRequest {
 public:
  AWS_GUARDDUTY_API CreateCustomDetectionRuleOrgConfigurationRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "CreateCustomDetectionRuleOrgConfiguration"; }
  ...
  template <typename RuleIdT = Aws::String>
  CreateCustomDetectionRuleOrgConfigurationRequest& WithRuleId(RuleIdT&& value) {
  ...
  inline CreateCustomDetectionRuleOrgConfigurationRequest& WithMode(AssociationMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename IncludeAccountIdsT = Aws::Vector<Aws::String>>
  CreateCustomDetectionRuleOrgConfigurationRequest& WithIncludeAccountIds(IncludeAccountIdsT&& value) {
    SetIncludeAccountIds(std::forward<IncludeAccountIdsT>(value));
    return *this;
  }
  template <typename IncludeAccountIdsT = Aws::String>
  CreateCustomDetectionRuleOrgConfigurationRequest& AddIncludeAccountIds(IncludeAccountIdsT&& value) {
    m_includeAccountIdsHasBeenSet = true;
  ...
  template <typename ExcludeAccountIdsT = Aws::Vector<Aws::String>>
  CreateCustomDetectionRuleOrgConfigurationRequest& WithExcludeAccountIds(ExcludeAccountIdsT&& value) {
    SetExcludeAccountIds(std::forward<ExcludeAccountIdsT>(value));
    return *this;
  }
  template <typename ExcludeAccountIdsT = Aws::String>
  CreateCustomDetectionRuleOrgConfigurationRequest& AddExcludeAccountIds(ExcludeAccountIdsT&& value) {
    m_excludeAccountIdsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateCustomDetectionRuleOrgConfigurationRequest& WithClientToken(ClientTokenT&& value) {
