...
class Container {
 public:
  ...
  void SetContainerRuntime(ContainerRuntimeT&& value) {
    ...
    m_containerRuntime = std::forward<ContainerRuntimeT>(value);
  }
  template <typename ContainerRuntimeT = Aws::String>
  Container& WithContainerRuntime(ContainerRuntimeT&& value) {
    SetContainerRuntime(std::forward<ContainerRuntimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImagePrefix(ImagePrefixT&& value) {
    ...
    m_imagePrefix = std::forward<ImagePrefixT>(value);
  }
  template <typename ImagePrefixT = Aws::String>
  Container& WithImagePrefix(ImagePrefixT&& value) {
    SetImagePrefix(std::forward<ImagePrefixT>(value));
    return *this;
  }
  ///@}
