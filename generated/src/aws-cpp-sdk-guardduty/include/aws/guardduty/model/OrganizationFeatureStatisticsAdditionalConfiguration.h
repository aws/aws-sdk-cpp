...
class OrganizationFeatureStatisticsAdditionalConfiguration {
 public:
  ...
  inline OrganizationFeatureStatisticsAdditionalConfiguration& WithName(OrgFeatureAdditionalConfiguration value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnabledAccountsCount(int value) {
    m_enabledAccountsCountHasBeenSet = true;
    m_enabledAccountsCount = value;
  }
  inline OrganizationFeatureStatisticsAdditionalConfiguration& WithEnabledAccountsCount(int value) {
    SetEnabledAccountsCount(value);
    return *this;
  }
  ///@}
 private:
