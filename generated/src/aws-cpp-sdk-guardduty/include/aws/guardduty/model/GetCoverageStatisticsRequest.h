...
class GetCoverageStatisticsRequest : public GuardDutyRequest {
 public:
  ...
  void SetStatisticsType(StatisticsTypeT&& value) {
    m_statisticsTypeHasBeenSet = true;
    m_statisticsType = std::forward<StatisticsTypeT>(value);
  }
  template <typename StatisticsTypeT = Aws::Vector<CoverageStatisticsType>>
  GetCoverageStatisticsRequest& WithStatisticsType(StatisticsTypeT&& value) {
    SetStatisticsType(std::forward<StatisticsTypeT>(value));
    return *this;
  }
  inline GetCoverageStatisticsRequest& AddStatisticsType(CoverageStatisticsType value) {
    m_statisticsTypeHasBeenSet = true;
    m_statisticsType.push_back(value);
    return *this;
  }
  ///@}
 private:
