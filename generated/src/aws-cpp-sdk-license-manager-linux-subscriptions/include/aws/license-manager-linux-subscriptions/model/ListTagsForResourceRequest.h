...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public LicenseManagerLinuxSubscriptionsRequest
  {
  public:
    AWS_LICENSEMANAGERLINUXSUBSCRIPTIONS_API ListTagsForResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the resource for which to list metadata
     * tags.</p>
     */
