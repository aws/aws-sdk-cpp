...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public LicenseManagerLinuxSubscriptionsRequest
  {
  public:
    AWS_LICENSEMANAGERLINUXSUBSCRIPTIONS_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the Amazon Web Services resource to which
     * to add the specified metadata tags.</p>
     */
