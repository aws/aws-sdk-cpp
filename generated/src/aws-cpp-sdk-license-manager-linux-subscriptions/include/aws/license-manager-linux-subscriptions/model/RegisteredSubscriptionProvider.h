...
class RegisteredSubscriptionProvider {
 public:
  ...
  inline RegisteredSubscriptionProvider& WithSubscriptionProviderSource(SubscriptionProviderSource value) {
  ...
  inline RegisteredSubscriptionProvider& WithSubscriptionProviderStatus(SubscriptionProviderStatus value) {
