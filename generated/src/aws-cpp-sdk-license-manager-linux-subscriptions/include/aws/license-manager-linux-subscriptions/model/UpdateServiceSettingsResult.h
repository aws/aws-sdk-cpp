...
class UpdateServiceSettingsResult {
 public:
  ...
  AWS_LICENSEMANAGERLINUXSUBSCRIPTIONS_API UpdateServiceSettingsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetHomeRegions(HomeRegionsT&& value) {
    m_homeRegionsHasBeenSet = true;
    m_homeRegions = std::forward<HomeRegionsT>(value);
  }
  template <typename HomeRegionsT = Aws::Vector<Aws::String>>
  UpdateServiceSettingsResult& WithHomeRegions(HomeRegionsT&& value) {
    SetHomeRegions(std::forward<HomeRegionsT>(value));
    return *this;
  }
  template <typename HomeRegionsT = Aws::String>
  UpdateServiceSettingsResult& AddHomeRegions(HomeRegionsT&& value) {
    m_homeRegionsHasBeenSet = true;
    m_homeRegions.emplace_back(std::forward<HomeRegionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLinuxSubscriptionsDiscovery(LinuxSubscriptionsDiscovery value) {
    m_linuxSubscriptionsDiscoveryHasBeenSet = true;
    m_linuxSubscriptionsDiscovery = value;
  }
  inline UpdateServiceSettingsResult& WithLinuxSubscriptionsDiscovery(LinuxSubscriptionsDiscovery value) {
    SetLinuxSubscriptionsDiscovery(value);
    return *this;
  }
  ///@}
   ...
   * aggregated from.</p>
   */
  inline const LinuxSubscriptionsDiscoverySettings& GetLinuxSubscriptionsDiscoverySettings() const {
    return m_linuxSubscriptionsDiscoverySettings;
  }
  template <typename LinuxSubscriptionsDiscoverySettingsT = LinuxSubscriptionsDiscoverySettings>
  void SetLinuxSubscriptionsDiscoverySettings(LinuxSubscriptionsDiscoverySettingsT&& value) {
    m_linuxSubscriptionsDiscoverySettingsHasBeenSet = true;
    m_linuxSubscriptionsDiscoverySettings = std::forward<LinuxSubscriptionsDiscoverySettingsT>(value);
  }
  template <typename LinuxSubscriptionsDiscoverySettingsT = LinuxSubscriptionsDiscoverySettings>
  UpdateServiceSettingsResult& WithLinuxSubscriptionsDiscoverySettings(LinuxSubscriptionsDiscoverySettingsT&& value) {
    SetLinuxSubscriptionsDiscoverySettings(std::forward<LinuxSubscriptionsDiscoverySettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateServiceSettingsResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::Map<Aws::String, Aws::String>>
  UpdateServiceSettingsResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  UpdateServiceSettingsResult& AddStatusMessage(StatusMessageKeyT&& key, StatusMessageValueT&& value) {
    m_statusMessageHasBeenSet = true;
    m_statusMessage.emplace(std::forward<StatusMessageKeyT>(key), std::forward<StatusMessageValueT>(value));
    return *this;
  }
  ///@}
