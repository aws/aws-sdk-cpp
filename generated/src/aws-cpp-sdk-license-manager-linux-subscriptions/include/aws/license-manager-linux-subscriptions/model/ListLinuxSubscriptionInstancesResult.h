...
class ListLinuxSubscriptionInstancesResult {
 public:
  ...
  AWS_LICENSEMANAGERLINUXSUBSCRIPTIONS_API ListLinuxSubscriptionInstancesResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename InstancesT = Aws::Vector<Instance>>
  ListLinuxSubscriptionInstancesResult& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = Instance>
  ListLinuxSubscriptionInstancesResult& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLinuxSubscriptionInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLinuxSubscriptionInstancesResult& WithRequestId(RequestIdT&& value) {
