...
class ListRegisteredSubscriptionProvidersRequest : public LicenseManagerLinuxSubscriptionsRequest {
 public:
  ...
  inline ListRegisteredSubscriptionProvidersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRegisteredSubscriptionProvidersRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetSubscriptionProviderSources(SubscriptionProviderSourcesT&& value) {
    m_subscriptionProviderSourcesHasBeenSet = true;
    m_subscriptionProviderSources = std::forward<SubscriptionProviderSourcesT>(value);
  }
  template <typename SubscriptionProviderSourcesT = Aws::Vector<SubscriptionProviderSource>>
  ListRegisteredSubscriptionProvidersRequest& WithSubscriptionProviderSources(SubscriptionProviderSourcesT&& value) {
    SetSubscriptionProviderSources(std::forward<SubscriptionProviderSourcesT>(value));
    return *this;
  }
  inline ListRegisteredSubscriptionProvidersRequest& AddSubscriptionProviderSources(SubscriptionProviderSource value) {
    m_subscriptionProviderSourcesHasBeenSet = true;
    m_subscriptionProviderSources.push_back(value);
    return *this;
  }
  ///@}
 private:
