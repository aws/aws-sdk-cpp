...
class GetRegisteredSubscriptionProviderResult {
 public:
  ...
  AWS_LICENSEMANAGERLINUXSUBSCRIPTIONS_API GetRegisteredSubscriptionProviderResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetLastSuccessfulDataRetrievalTime(LastSuccessfulDataRetrievalTimeT&& value) {
    ...
    m_lastSuccessfulDataRetrievalTime = std::forward<LastSuccessfulDataRetrievalTimeT>(value);
  }
  template <typename LastSuccessfulDataRetrievalTimeT = Aws::String>
  GetRegisteredSubscriptionProviderResult& WithLastSuccessfulDataRetrievalTime(LastSuccessfulDataRetrievalTimeT&& value) {
    SetLastSuccessfulDataRetrievalTime(std::forward<LastSuccessfulDataRetrievalTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SecretArnT = Aws::String>
  GetRegisteredSubscriptionProviderResult& WithSecretArn(SecretArnT&& value) {
  ...
  void SetSubscriptionProviderArn(SubscriptionProviderArnT&& value) {
    ...
    m_subscriptionProviderArn = std::forward<SubscriptionProviderArnT>(value);
  }
  template <typename SubscriptionProviderArnT = Aws::String>
  GetRegisteredSubscriptionProviderResult& WithSubscriptionProviderArn(SubscriptionProviderArnT&& value) {
    SetSubscriptionProviderArn(std::forward<SubscriptionProviderArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetRegisteredSubscriptionProviderResult& WithSubscriptionProviderSource(SubscriptionProviderSource value) {
  ...
  inline void SetSubscriptionProviderStatus(SubscriptionProviderStatus value) {
    m_subscriptionProviderStatusHasBeenSet = true;
    m_subscriptionProviderStatus = value;
  }
  inline GetRegisteredSubscriptionProviderResult& WithSubscriptionProviderStatus(SubscriptionProviderStatus value) {
    SetSubscriptionProviderStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetSubscriptionProviderStatusMessage(SubscriptionProviderStatusMessageT&& value) {
    ...
    m_subscriptionProviderStatusMessage = std::forward<SubscriptionProviderStatusMessageT>(value);
  }
  template <typename SubscriptionProviderStatusMessageT = Aws::String>
  GetRegisteredSubscriptionProviderResult& WithSubscriptionProviderStatusMessage(SubscriptionProviderStatusMessageT&& value) {
    SetSubscriptionProviderStatusMessage(std::forward<SubscriptionProviderStatusMessageT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetRegisteredSubscriptionProviderResult& WithRequestId(RequestIdT&& value) {
