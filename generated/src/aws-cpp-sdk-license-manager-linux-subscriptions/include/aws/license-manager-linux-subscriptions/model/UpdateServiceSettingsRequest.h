...
class UpdateServiceSettingsRequest : public LicenseManagerLinuxSubscriptionsRequest {
 public:
  ...
  inline void SetAllowUpdate(bool value) {
    m_allowUpdateHasBeenSet = true;
    m_allowUpdate = value;
  }
  inline UpdateServiceSettingsRequest& WithAllowUpdate(bool value) {
  ...
  inline UpdateServiceSettingsRequest& WithLinuxSubscriptionsDiscovery(LinuxSubscriptionsDiscovery value) {
  ...
  template <typename LinuxSubscriptionsDiscoverySettingsT = LinuxSubscriptionsDiscoverySettings>
  UpdateServiceSettingsRequest& WithLinuxSubscriptionsDiscoverySettings(LinuxSubscriptionsDiscoverySettingsT&& value) {
