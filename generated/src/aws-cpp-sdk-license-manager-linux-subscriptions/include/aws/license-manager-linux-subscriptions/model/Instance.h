...
class Instance {
 public:
  ...
  void SetDualSubscription(DualSubscriptionT&& value) {
    ...
    m_dualSubscription = std::forward<DualSubscriptionT>(value);
  }
  template <typename DualSubscriptionT = Aws::String>
  Instance& WithDualSubscription(DualSubscriptionT&& value) {
    SetDualSubscription(std::forward<DualSubscriptionT>(value));
    return *this;
  }
  ///@}
  ...
  Instance& AddProductCode(ProductCodeT&& value) {
    m_productCodeHasBeenSet = true;
    m_productCode.emplace_back(std::forward<ProductCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegisteredWithSubscriptionProvider(RegisteredWithSubscriptionProviderT&& value) {
    ...
    m_registeredWithSubscriptionProvider = std::forward<RegisteredWithSubscriptionProviderT>(value);
  }
  template <typename RegisteredWithSubscriptionProviderT = Aws::String>
  Instance& WithRegisteredWithSubscriptionProvider(RegisteredWithSubscriptionProviderT&& value) {
    SetRegisteredWithSubscriptionProvider(std::forward<RegisteredWithSubscriptionProviderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubscriptionProviderCreateTime(SubscriptionProviderCreateTimeT&& value) {
    ...
    m_subscriptionProviderCreateTime = std::forward<SubscriptionProviderCreateTimeT>(value);
  }
  template <typename SubscriptionProviderCreateTimeT = Aws::String>
  Instance& WithSubscriptionProviderCreateTime(SubscriptionProviderCreateTimeT&& value) {
    SetSubscriptionProviderCreateTime(std::forward<SubscriptionProviderCreateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubscriptionProviderUpdateTime(SubscriptionProviderUpdateTimeT&& value) {
    ...
    m_subscriptionProviderUpdateTime = std::forward<SubscriptionProviderUpdateTimeT>(value);
  }
  template <typename SubscriptionProviderUpdateTimeT = Aws::String>
  Instance& WithSubscriptionProviderUpdateTime(SubscriptionProviderUpdateTimeT&& value) {
    SetSubscriptionProviderUpdateTime(std::forward<SubscriptionProviderUpdateTimeT>(value));
    return *this;
  }
  ///@}
