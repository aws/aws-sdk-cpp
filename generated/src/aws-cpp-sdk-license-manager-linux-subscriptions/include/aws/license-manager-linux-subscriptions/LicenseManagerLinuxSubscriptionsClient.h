...
class AWS_LICENSEMANAGERLINUXSUBSCRIPTIONS_API LicenseManagerLinuxSubscriptionsClient
 ...
 public:
  ...
  LicenseManagerLinuxSubscriptionsClient(
      const Aws::LicenseManagerLinuxSubscriptions::LicenseManagerLinuxSubscriptionsClientConfiguration& clientConfiguration =
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterSubscriptionProviderOutcome DeregisterSubscriptionProvider(
      const Model::DeregisterSubscriptionProviderRequest& request) const;

  /**
   * A Callable wrapper for DeregisterSubscriptionProvider that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeregisterSubscriptionProviderRequestT = Model::DeregisterSubscriptionProviderRequest>
  Model::DeregisterSubscriptionProviderOutcomeCallable DeregisterSubscriptionProviderCallable(
      const DeregisterSubscriptionProviderRequestT& request) const {
    return SubmitCallable(&LicenseManagerLinuxSubscriptionsClient::DeregisterSubscriptionProvider, request);
  }

  /**
   * An Async wrapper for DeregisterSubscriptionProvider that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeregisterSubscriptionProviderRequestT = Model::DeregisterSubscriptionProviderRequest>
  void DeregisterSubscriptionProviderAsync(const DeregisterSubscriptionProviderRequestT& request,
                                           const DeregisterSubscriptionProviderResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRegisteredSubscriptionProviderOutcome GetRegisteredSubscriptionProvider(
      const Model::GetRegisteredSubscriptionProviderRequest& request) const;

  /**
   * A Callable wrapper for GetRegisteredSubscriptionProvider that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetRegisteredSubscriptionProviderRequestT = Model::GetRegisteredSubscriptionProviderRequest>
  Model::GetRegisteredSubscriptionProviderOutcomeCallable GetRegisteredSubscriptionProviderCallable(
      const GetRegisteredSubscriptionProviderRequestT& request) const {
    return SubmitCallable(&LicenseManagerLinuxSubscriptionsClient::GetRegisteredSubscriptionProvider, request);
  }

  /**
   * An Async wrapper for GetRegisteredSubscriptionProvider that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRegisteredSubscriptionProviderRequestT = Model::GetRegisteredSubscriptionProviderRequest>
  void GetRegisteredSubscriptionProviderAsync(const GetRegisteredSubscriptionProviderRequestT& request,
                                              const GetRegisteredSubscriptionProviderResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetServiceSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetServiceSettings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetServiceSettingsRequestT = Model::GetServiceSettingsRequest>
  void GetServiceSettingsAsync(const GetServiceSettingsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetServiceSettingsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListLinuxSubscriptionInstancesOutcome ListLinuxSubscriptionInstances(
      const Model::ListLinuxSubscriptionInstancesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListLinuxSubscriptionInstances that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListLinuxSubscriptionInstancesRequestT = Model::ListLinuxSubscriptionInstancesRequest>
  Model::ListLinuxSubscriptionInstancesOutcomeCallable ListLinuxSubscriptionInstancesCallable(
      const ListLinuxSubscriptionInstancesRequestT& request = {}) const {
    return SubmitCallable(&LicenseManagerLinuxSubscriptionsClient::ListLinuxSubscriptionInstances, request);
  }

  /**
   * An Async wrapper for ListLinuxSubscriptionInstances that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListLinuxSubscriptionInstancesRequestT = Model::ListLinuxSubscriptionInstancesRequest>
  void ListLinuxSubscriptionInstancesAsync(const ListLinuxSubscriptionInstancesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListLinuxSubscriptionInstancesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListLinuxSubscriptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLinuxSubscriptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLinuxSubscriptionsRequestT = Model::ListLinuxSubscriptionsRequest>
  void ListLinuxSubscriptionsAsync(const ListLinuxSubscriptionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListLinuxSubscriptionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRegisteredSubscriptionProvidersOutcome ListRegisteredSubscriptionProviders(
      const Model::ListRegisteredSubscriptionProvidersRequest& request = {}) const;

  /**
   * A Callable wrapper for ListRegisteredSubscriptionProviders that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListRegisteredSubscriptionProvidersRequestT = Model::ListRegisteredSubscriptionProvidersRequest>
  Model::ListRegisteredSubscriptionProvidersOutcomeCallable ListRegisteredSubscriptionProvidersCallable(
      const ListRegisteredSubscriptionProvidersRequestT& request = {}) const {
    return SubmitCallable(&LicenseManagerLinuxSubscriptionsClient::ListRegisteredSubscriptionProviders, request);
  }

  /**
   * An Async wrapper for ListRegisteredSubscriptionProviders that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListRegisteredSubscriptionProvidersRequestT = Model::ListRegisteredSubscriptionProvidersRequest>
  void ListRegisteredSubscriptionProvidersAsync(const ListRegisteredSubscriptionProvidersResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const ListRegisteredSubscriptionProvidersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterSubscriptionProviderOutcome RegisterSubscriptionProvider(
      const Model::RegisterSubscriptionProviderRequest& request) const;

  /**
   * A Callable wrapper for RegisterSubscriptionProvider that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterSubscriptionProviderRequestT = Model::RegisterSubscriptionProviderRequest>
  Model::RegisterSubscriptionProviderOutcomeCallable RegisterSubscriptionProviderCallable(
      const RegisterSubscriptionProviderRequestT& request) const {
    return SubmitCallable(&LicenseManagerLinuxSubscriptionsClient::RegisterSubscriptionProvider, request);
  }

  /**
   * An Async wrapper for RegisterSubscriptionProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterSubscriptionProviderRequestT = Model::RegisterSubscriptionProviderRequest>
  void RegisterSubscriptionProviderAsync(const RegisterSubscriptionProviderRequestT& request,
                                         const RegisterSubscriptionProviderResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateServiceSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateServiceSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateServiceSettingsRequestT = Model::UpdateServiceSettingsRequest>
  void UpdateServiceSettingsAsync(const UpdateServiceSettingsRequestT& request, const UpdateServiceSettingsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&LicenseManagerLinuxSubscriptionsClient::UpdateServiceSettings, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<LicenseManagerLinuxSubscriptionsEndpointProviderBase>& accessEndpointProvider();
