...
namespace LicenseManagerLinuxSubscriptions
{
   ...
   */
  class AWS_LICENSEMANAGERLINUXSUBSCRIPTIONS_API LicenseManagerLinuxSubscriptionsClient : smithy::client::AwsSmithyClientT<Aws::LicenseManagerLinuxSubscriptions::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<LicenseManagerLinuxSubscriptionsClient>
  {
    public:
