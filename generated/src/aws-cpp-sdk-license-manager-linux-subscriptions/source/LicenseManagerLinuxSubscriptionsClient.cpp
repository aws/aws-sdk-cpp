...
void LicenseManagerLinuxSubscriptionsClient::init(const LicenseManagerLinuxSubscriptions::LicenseManagerLinuxSubscriptionsClientConfiguration& config)
{
  ...
  Aws::Config::EndpointResolver::EndpointSource("license-manager-linux-subscriptions", config.profileName, *m_endpointProvider);
}
...
DeregisterSubscriptionProviderOutcome LicenseManagerLinuxSubscriptionsClient::DeregisterSubscriptionProvider(const DeregisterSubscriptionProviderRequest& request) const
{
  ...
  AWS_OPERATION_CHECK_PTR(m_telemetryProvider, DeregisterSubscriptionProvider, CoreErrors, CoreErrors::NOT_INITIALIZED);
  ...
  return TracingUtils::MakeCallWithTiming<DeregisterSubscriptionProviderOutcome>(
    [&]()-> DeregisterSubscriptionProviderOutcome {
      ...
      AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, DeregisterSubscriptionProvider, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE, endpointResolutionOutcome.GetError().GetMessage());
      endpointResolutionOutcome.GetResult().AddPathSegments("/subscription/DeregisterSubscriptionProvider");
      return DeregisterSubscriptionProviderOutcome(MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER));
    },
...
GetRegisteredSubscriptionProviderOutcome LicenseManagerLinuxSubscriptionsClient::GetRegisteredSubscriptionProvider(const GetRegisteredSubscriptionProviderRequest& request) const
{
  ...
  AWS_OPERATION_CHECK_PTR(m_telemetryProvider, GetRegisteredSubscriptionProvider, CoreErrors, CoreErrors::NOT_INITIALIZED);
  auto tracer = m_telemetryProvider->getTracer(this->GetServiceClientName(), {});
  auto meter = m_telemetryProvider->getMeter(this->GetServiceClientName(), {});
  ...
  return TracingUtils::MakeCallWithTiming<GetRegisteredSubscriptionProviderOutcome>(
    [&]()-> GetRegisteredSubscriptionProviderOutcome {
      auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
          ...
          *meter,
          {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()}, {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
      AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, GetRegisteredSubscriptionProvider, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE, endpointResolutionOutcome.GetError().GetMessage());
      endpointResolutionOutcome.GetResult().AddPathSegments("/subscription/GetRegisteredSubscriptionProvider");
      return GetRegisteredSubscriptionProviderOutcome(MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER));
    },
    TracingUtils::SMITHY_CLIENT_DURATION_METRIC,
    *meter,
    {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()}, {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
...
ListRegisteredSubscriptionProvidersOutcome LicenseManagerLinuxSubscriptionsClient::ListRegisteredSubscriptionProviders(const ListRegisteredSubscriptionProvidersRequest& request) const
{
  ...
  AWS_OPERATION_CHECK_PTR(m_telemetryProvider, ListRegisteredSubscriptionProviders, CoreErrors, CoreErrors::NOT_INITIALIZED);
  auto tracer = m_telemetryProvider->getTracer(this->GetServiceClientName(), {});
  auto meter = m_telemetryProvider->getMeter(this->GetServiceClientName(), {});
  ...
  return TracingUtils::MakeCallWithTiming<ListRegisteredSubscriptionProvidersOutcome>(
    [&]()-> ListRegisteredSubscriptionProvidersOutcome {
      auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
          ...
          *meter,
          {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()}, {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
      AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, ListRegisteredSubscriptionProviders, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE, endpointResolutionOutcome.GetError().GetMessage());
      endpointResolutionOutcome.GetResult().AddPathSegments("/subscription/ListRegisteredSubscriptionProviders");
      return ListRegisteredSubscriptionProvidersOutcome(MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER));
    },
    TracingUtils::SMITHY_CLIENT_DURATION_METRIC,
    *meter,
    {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()}, {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
...
RegisterSubscriptionProviderOutcome LicenseManagerLinuxSubscriptionsClient::RegisterSubscriptionProvider(const RegisterSubscriptionProviderRequest& request) const
{
  ...
  AWS_OPERATION_CHECK_PTR(m_telemetryProvider, RegisterSubscriptionProvider, CoreErrors, CoreErrors::NOT_INITIALIZED);
  auto tracer = m_telemetryProvider->getTracer(this->GetServiceClientName(), {});
  auto meter = m_telemetryProvider->getMeter(this->GetServiceClientName(), {});
  ...
  return TracingUtils::MakeCallWithTiming<RegisterSubscriptionProviderOutcome>(
    [&]()-> RegisterSubscriptionProviderOutcome {
      auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
          ...
          *meter,
          {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()}, {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
      AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, RegisterSubscriptionProvider, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE, endpointResolutionOutcome.GetError().GetMessage());
      endpointResolutionOutcome.GetResult().AddPathSegments("/subscription/RegisterSubscriptionProvider");
      return RegisterSubscriptionProviderOutcome(MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER));
    },
    TracingUtils::SMITHY_CLIENT_DURATION_METRIC,
    *meter,
    {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()}, {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
