...
RegisteredSubscriptionProvider::RegisteredSubscriptionProvider(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue RegisteredSubscriptionProvider::Jsonize() const {
  ...
  if (m_subscriptionProviderStatusHasBeenSet) {
    payload.WithString("SubscriptionProviderStatus",
                       SubscriptionProviderStatusMapper::GetNameForSubscriptionProviderStatus(m_subscriptionProviderStatus));
  }
