...
LinuxSubscriptionsDiscoverySettings::LinuxSubscriptionsDiscoverySettings(JsonView jsonValue) { *this = jsonValue; }
...
LinuxSubscriptionsDiscoverySettings& LinuxSubscriptionsDiscoverySettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("OrganizationIntegration")) {
    m_organizationIntegration =
        OrganizationIntegrationMapper::GetOrganizationIntegrationForName(jsonValue.GetString("OrganizationIntegration"));
...
JsonValue LinuxSubscriptionsDiscoverySettings::Jsonize() const {
  ...
  if (m_organizationIntegrationHasBeenSet) {
    payload.WithString("OrganizationIntegration",
                       OrganizationIntegrationMapper::GetNameForOrganizationIntegration(m_organizationIntegration));
  }
