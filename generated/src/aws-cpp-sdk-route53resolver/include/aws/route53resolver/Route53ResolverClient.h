...
class AWS_ROUTE53RESOLVER_API Route53ResolverClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  Route53ResolverClient(const Aws::Route53Resolver::Route53ResolverClientConfiguration& clientConfiguration =
  ...
  Route53ResolverClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<Route53ResolverEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::Route53Resolver::Route53ResolverClientConfiguration& clientConfiguration =
                            Aws::Route53Resolver::Route53ResolverClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateFirewallRuleGroupOutcome AssociateFirewallRuleGroup(
      const Model::AssociateFirewallRuleGroupRequest& request) const;

  /**
   * A Callable wrapper for AssociateFirewallRuleGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateFirewallRuleGroupRequestT = Model::AssociateFirewallRuleGroupRequest>
  Model::AssociateFirewallRuleGroupOutcomeCallable AssociateFirewallRuleGroupCallable(
      const AssociateFirewallRuleGroupRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::AssociateFirewallRuleGroup, request);
  }

  /**
   * An Async wrapper for AssociateFirewallRuleGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateFirewallRuleGroupRequestT = Model::AssociateFirewallRuleGroupRequest>
  void AssociateFirewallRuleGroupAsync(const AssociateFirewallRuleGroupRequestT& request,
                                       const AssociateFirewallRuleGroupResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateResolverEndpointIpAddressOutcome AssociateResolverEndpointIpAddress(
      const Model::AssociateResolverEndpointIpAddressRequest& request) const;

  /**
   * A Callable wrapper for AssociateResolverEndpointIpAddress that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AssociateResolverEndpointIpAddressRequestT = Model::AssociateResolverEndpointIpAddressRequest>
  Model::AssociateResolverEndpointIpAddressOutcomeCallable AssociateResolverEndpointIpAddressCallable(
      const AssociateResolverEndpointIpAddressRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::AssociateResolverEndpointIpAddress, request);
  }

  /**
   * An Async wrapper for AssociateResolverEndpointIpAddress that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateResolverEndpointIpAddressRequestT = Model::AssociateResolverEndpointIpAddressRequest>
  void AssociateResolverEndpointIpAddressAsync(const AssociateResolverEndpointIpAddressRequestT& request,
                                               const AssociateResolverEndpointIpAddressResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateResolverQueryLogConfigOutcome AssociateResolverQueryLogConfig(
      const Model::AssociateResolverQueryLogConfigRequest& request) const;

  /**
   * A Callable wrapper for AssociateResolverQueryLogConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateResolverQueryLogConfigRequestT = Model::AssociateResolverQueryLogConfigRequest>
  Model::AssociateResolverQueryLogConfigOutcomeCallable AssociateResolverQueryLogConfigCallable(
      const AssociateResolverQueryLogConfigRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::AssociateResolverQueryLogConfig, request);
  }

  /**
   * An Async wrapper for AssociateResolverQueryLogConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateResolverQueryLogConfigRequestT = Model::AssociateResolverQueryLogConfigRequest>
  void AssociateResolverQueryLogConfigAsync(const AssociateResolverQueryLogConfigRequestT& request,
                                            const AssociateResolverQueryLogConfigResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateResolverRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateResolverRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateResolverRuleRequestT = Model::AssociateResolverRuleRequest>
  void AssociateResolverRuleAsync(const AssociateResolverRuleRequestT& request, const AssociateResolverRuleResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateFirewallRuleGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateFirewallRuleGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFirewallRuleGroupRequestT = Model::CreateFirewallRuleGroupRequest>
  void CreateFirewallRuleGroupAsync(const CreateFirewallRuleGroupRequestT& request,
                                    const CreateFirewallRuleGroupResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateOutpostResolver that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateOutpostResolver that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateOutpostResolverRequestT = Model::CreateOutpostResolverRequest>
  void CreateOutpostResolverAsync(const CreateOutpostResolverRequestT& request, const CreateOutpostResolverResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateResolverEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateResolverEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResolverEndpointRequestT = Model::CreateResolverEndpointRequest>
  void CreateResolverEndpointAsync(const CreateResolverEndpointRequestT& request,
                                   const CreateResolverEndpointResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateResolverQueryLogConfigOutcome CreateResolverQueryLogConfig(
      const Model::CreateResolverQueryLogConfigRequest& request) const;

  /**
   * A Callable wrapper for CreateResolverQueryLogConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateResolverQueryLogConfigRequestT = Model::CreateResolverQueryLogConfigRequest>
  Model::CreateResolverQueryLogConfigOutcomeCallable CreateResolverQueryLogConfigCallable(
      const CreateResolverQueryLogConfigRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::CreateResolverQueryLogConfig, request);
  }

  /**
   * An Async wrapper for CreateResolverQueryLogConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResolverQueryLogConfigRequestT = Model::CreateResolverQueryLogConfigRequest>
  void CreateResolverQueryLogConfigAsync(const CreateResolverQueryLogConfigRequestT& request,
                                         const CreateResolverQueryLogConfigResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateResolverRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateResolverRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateResolverRuleRequestT = Model::CreateResolverRuleRequest>
  void CreateResolverRuleAsync(const CreateResolverRuleRequestT& request, const CreateResolverRuleResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteFirewallRuleGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteFirewallRuleGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteFirewallRuleGroupRequestT = Model::DeleteFirewallRuleGroupRequest>
  void DeleteFirewallRuleGroupAsync(const DeleteFirewallRuleGroupRequestT& request,
                                    const DeleteFirewallRuleGroupResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteOutpostResolver that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteOutpostResolver that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteOutpostResolverRequestT = Model::DeleteOutpostResolverRequest>
  void DeleteOutpostResolverAsync(const DeleteOutpostResolverRequestT& request, const DeleteOutpostResolverResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteResolverEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteResolverEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResolverEndpointRequestT = Model::DeleteResolverEndpointRequest>
  void DeleteResolverEndpointAsync(const DeleteResolverEndpointRequestT& request,
                                   const DeleteResolverEndpointResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteResolverQueryLogConfigOutcome DeleteResolverQueryLogConfig(
      const Model::DeleteResolverQueryLogConfigRequest& request) const;

  /**
   * A Callable wrapper for DeleteResolverQueryLogConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteResolverQueryLogConfigRequestT = Model::DeleteResolverQueryLogConfigRequest>
  Model::DeleteResolverQueryLogConfigOutcomeCallable DeleteResolverQueryLogConfigCallable(
      const DeleteResolverQueryLogConfigRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::DeleteResolverQueryLogConfig, request);
  }

  /**
   * An Async wrapper for DeleteResolverQueryLogConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResolverQueryLogConfigRequestT = Model::DeleteResolverQueryLogConfigRequest>
  void DeleteResolverQueryLogConfigAsync(const DeleteResolverQueryLogConfigRequestT& request,
                                         const DeleteResolverQueryLogConfigResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteResolverRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteResolverRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteResolverRuleRequestT = Model::DeleteResolverRuleRequest>
  void DeleteResolverRuleAsync(const DeleteResolverRuleRequestT& request, const DeleteResolverRuleResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateFirewallRuleGroupOutcome DisassociateFirewallRuleGroup(
      const Model::DisassociateFirewallRuleGroupRequest& request) const;

  /**
   * A Callable wrapper for DisassociateFirewallRuleGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateFirewallRuleGroupRequestT = Model::DisassociateFirewallRuleGroupRequest>
  Model::DisassociateFirewallRuleGroupOutcomeCallable DisassociateFirewallRuleGroupCallable(
      const DisassociateFirewallRuleGroupRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::DisassociateFirewallRuleGroup, request);
  }

  /**
   * An Async wrapper for DisassociateFirewallRuleGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateFirewallRuleGroupRequestT = Model::DisassociateFirewallRuleGroupRequest>
  void DisassociateFirewallRuleGroupAsync(const DisassociateFirewallRuleGroupRequestT& request,
                                          const DisassociateFirewallRuleGroupResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateResolverEndpointIpAddressOutcome DisassociateResolverEndpointIpAddress(
      const Model::DisassociateResolverEndpointIpAddressRequest& request) const;

  /**
   * A Callable wrapper for DisassociateResolverEndpointIpAddress that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateResolverEndpointIpAddressRequestT = Model::DisassociateResolverEndpointIpAddressRequest>
  Model::DisassociateResolverEndpointIpAddressOutcomeCallable DisassociateResolverEndpointIpAddressCallable(
      const DisassociateResolverEndpointIpAddressRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::DisassociateResolverEndpointIpAddress, request);
  }

  /**
   * An Async wrapper for DisassociateResolverEndpointIpAddress that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateResolverEndpointIpAddressRequestT = Model::DisassociateResolverEndpointIpAddressRequest>
  void DisassociateResolverEndpointIpAddressAsync(const DisassociateResolverEndpointIpAddressRequestT& request,
                                                  const DisassociateResolverEndpointIpAddressResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisassociateResolverQueryLogConfigOutcome DisassociateResolverQueryLogConfig(
      const Model::DisassociateResolverQueryLogConfigRequest& request) const;

  /**
   * A Callable wrapper for DisassociateResolverQueryLogConfig that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateResolverQueryLogConfigRequestT = Model::DisassociateResolverQueryLogConfigRequest>
  Model::DisassociateResolverQueryLogConfigOutcomeCallable DisassociateResolverQueryLogConfigCallable(
      const DisassociateResolverQueryLogConfigRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::DisassociateResolverQueryLogConfig, request);
  }

  /**
   * An Async wrapper for DisassociateResolverQueryLogConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateResolverQueryLogConfigRequestT = Model::DisassociateResolverQueryLogConfigRequest>
  void DisassociateResolverQueryLogConfigAsync(const DisassociateResolverQueryLogConfigRequestT& request,
                                               const DisassociateResolverQueryLogConfigResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateResolverRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateResolverRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateResolverRuleRequestT = Model::DisassociateResolverRuleRequest>
  void DisassociateResolverRuleAsync(const DisassociateResolverRuleRequestT& request,
                                     const DisassociateResolverRuleResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFirewallConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFirewallConfig that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetFirewallConfigRequestT = Model::GetFirewallConfigRequest>
  void GetFirewallConfigAsync(const GetFirewallConfigRequestT& request, const GetFirewallConfigResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFirewallRuleGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFirewallRuleGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFirewallRuleGroupRequestT = Model::GetFirewallRuleGroupRequest>
  void GetFirewallRuleGroupAsync(const GetFirewallRuleGroupRequestT& request, const GetFirewallRuleGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetFirewallRuleGroupAssociationOutcome GetFirewallRuleGroupAssociation(
      const Model::GetFirewallRuleGroupAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetFirewallRuleGroupAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetFirewallRuleGroupAssociationRequestT = Model::GetFirewallRuleGroupAssociationRequest>
  Model::GetFirewallRuleGroupAssociationOutcomeCallable GetFirewallRuleGroupAssociationCallable(
      const GetFirewallRuleGroupAssociationRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::GetFirewallRuleGroupAssociation, request);
  }

  /**
   * An Async wrapper for GetFirewallRuleGroupAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetFirewallRuleGroupAssociationRequestT = Model::GetFirewallRuleGroupAssociationRequest>
  void GetFirewallRuleGroupAssociationAsync(const GetFirewallRuleGroupAssociationRequestT& request,
                                            const GetFirewallRuleGroupAssociationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetFirewallRuleGroupPolicyOutcome GetFirewallRuleGroupPolicy(
      const Model::GetFirewallRuleGroupPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetFirewallRuleGroupPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetFirewallRuleGroupPolicyRequestT = Model::GetFirewallRuleGroupPolicyRequest>
  Model::GetFirewallRuleGroupPolicyOutcomeCallable GetFirewallRuleGroupPolicyCallable(
      const GetFirewallRuleGroupPolicyRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::GetFirewallRuleGroupPolicy, request);
  }

  /**
   * An Async wrapper for GetFirewallRuleGroupPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFirewallRuleGroupPolicyRequestT = Model::GetFirewallRuleGroupPolicyRequest>
  void GetFirewallRuleGroupPolicyAsync(const GetFirewallRuleGroupPolicyRequestT& request,
                                       const GetFirewallRuleGroupPolicyResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetOutpostResolver that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOutpostResolver that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetOutpostResolverRequestT = Model::GetOutpostResolverRequest>
  void GetOutpostResolverAsync(const GetOutpostResolverRequestT& request, const GetOutpostResolverResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResolverConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResolverConfig that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetResolverConfigRequestT = Model::GetResolverConfigRequest>
  void GetResolverConfigAsync(const GetResolverConfigRequestT& request, const GetResolverConfigResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResolverDnssecConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResolverDnssecConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResolverDnssecConfigRequestT = Model::GetResolverDnssecConfigRequest>
  void GetResolverDnssecConfigAsync(const GetResolverDnssecConfigRequestT& request,
                                    const GetResolverDnssecConfigResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResolverEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResolverEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetResolverEndpointRequestT = Model::GetResolverEndpointRequest>
  void GetResolverEndpointAsync(const GetResolverEndpointRequestT& request, const GetResolverEndpointResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResolverQueryLogConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetResolverQueryLogConfigRequestT = Model::GetResolverQueryLogConfigRequest>
  Model::GetResolverQueryLogConfigOutcomeCallable GetResolverQueryLogConfigCallable(
      const GetResolverQueryLogConfigRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::GetResolverQueryLogConfig, request);
  }

  /**
   * An Async wrapper for GetResolverQueryLogConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResolverQueryLogConfigRequestT = Model::GetResolverQueryLogConfigRequest>
  void GetResolverQueryLogConfigAsync(const GetResolverQueryLogConfigRequestT& request,
                                      const GetResolverQueryLogConfigResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetResolverQueryLogConfigAssociationOutcome GetResolverQueryLogConfigAssociation(
      const Model::GetResolverQueryLogConfigAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetResolverQueryLogConfigAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetResolverQueryLogConfigAssociationRequestT = Model::GetResolverQueryLogConfigAssociationRequest>
  Model::GetResolverQueryLogConfigAssociationOutcomeCallable GetResolverQueryLogConfigAssociationCallable(
      const GetResolverQueryLogConfigAssociationRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::GetResolverQueryLogConfigAssociation, request);
  }

  /**
   * An Async wrapper for GetResolverQueryLogConfigAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetResolverQueryLogConfigAssociationRequestT = Model::GetResolverQueryLogConfigAssociationRequest>
  void GetResolverQueryLogConfigAssociationAsync(const GetResolverQueryLogConfigAssociationRequestT& request,
                                                 const GetResolverQueryLogConfigAssociationResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetResolverQueryLogConfigPolicyOutcome GetResolverQueryLogConfigPolicy(
      const Model::GetResolverQueryLogConfigPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetResolverQueryLogConfigPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetResolverQueryLogConfigPolicyRequestT = Model::GetResolverQueryLogConfigPolicyRequest>
  Model::GetResolverQueryLogConfigPolicyOutcomeCallable GetResolverQueryLogConfigPolicyCallable(
      const GetResolverQueryLogConfigPolicyRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::GetResolverQueryLogConfigPolicy, request);
  }

  /**
   * An Async wrapper for GetResolverQueryLogConfigPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetResolverQueryLogConfigPolicyRequestT = Model::GetResolverQueryLogConfigPolicyRequest>
  void GetResolverQueryLogConfigPolicyAsync(const GetResolverQueryLogConfigPolicyRequestT& request,
                                            const GetResolverQueryLogConfigPolicyResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetResolverRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetResolverRuleRequestT = Model::GetResolverRuleRequest>
  void GetResolverRuleAsync(const GetResolverRuleRequestT& request, const GetResolverRuleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetResolverRuleAssociationOutcome GetResolverRuleAssociation(
      const Model::GetResolverRuleAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetResolverRuleAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetResolverRuleAssociationRequestT = Model::GetResolverRuleAssociationRequest>
  Model::GetResolverRuleAssociationOutcomeCallable GetResolverRuleAssociationCallable(
      const GetResolverRuleAssociationRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::GetResolverRuleAssociation, request);
  }

  /**
   * An Async wrapper for GetResolverRuleAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResolverRuleAssociationRequestT = Model::GetResolverRuleAssociationRequest>
  void GetResolverRuleAssociationAsync(const GetResolverRuleAssociationRequestT& request,
                                       const GetResolverRuleAssociationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResolverRulePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResolverRulePolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResolverRulePolicyRequestT = Model::GetResolverRulePolicyRequest>
  void GetResolverRulePolicyAsync(const GetResolverRulePolicyRequestT& request, const GetResolverRulePolicyResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListFirewallConfigs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFirewallConfigs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFirewallConfigsRequestT = Model::ListFirewallConfigsRequest>
  void ListFirewallConfigsAsync(const ListFirewallConfigsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListFirewallConfigsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListFirewallRuleGroupAssociationsOutcome ListFirewallRuleGroupAssociations(
      const Model::ListFirewallRuleGroupAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListFirewallRuleGroupAssociations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListFirewallRuleGroupAssociationsRequestT = Model::ListFirewallRuleGroupAssociationsRequest>
  Model::ListFirewallRuleGroupAssociationsOutcomeCallable ListFirewallRuleGroupAssociationsCallable(
      const ListFirewallRuleGroupAssociationsRequestT& request = {}) const {
    return SubmitCallable(&Route53ResolverClient::ListFirewallRuleGroupAssociations, request);
  }

  /**
   * An Async wrapper for ListFirewallRuleGroupAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListFirewallRuleGroupAssociationsRequestT = Model::ListFirewallRuleGroupAssociationsRequest>
  void ListFirewallRuleGroupAssociationsAsync(const ListFirewallRuleGroupAssociationsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const ListFirewallRuleGroupAssociationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFirewallRuleGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFirewallRuleGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFirewallRuleGroupsRequestT = Model::ListFirewallRuleGroupsRequest>
  void ListFirewallRuleGroupsAsync(const ListFirewallRuleGroupsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
  ...
  /**
   * A Callable wrapper for ListOutpostResolvers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOutpostResolvers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOutpostResolversRequestT = Model::ListOutpostResolversRequest>
  void ListOutpostResolversAsync(const ListOutpostResolversResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListOutpostResolversRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListResolverConfigs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResolverConfigs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListResolverConfigsRequestT = Model::ListResolverConfigsRequest>
  void ListResolverConfigsAsync(const ListResolverConfigsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListResolverConfigsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResolverDnssecConfigsOutcome ListResolverDnssecConfigs(
      const Model::ListResolverDnssecConfigsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListResolverDnssecConfigs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListResolverDnssecConfigsRequestT = Model::ListResolverDnssecConfigsRequest>
  Model::ListResolverDnssecConfigsOutcomeCallable ListResolverDnssecConfigsCallable(
      const ListResolverDnssecConfigsRequestT& request = {}) const {
    return SubmitCallable(&Route53ResolverClient::ListResolverDnssecConfigs, request);
  }

  /**
   * An Async wrapper for ListResolverDnssecConfigs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResolverDnssecConfigsRequestT = Model::ListResolverDnssecConfigsRequest>
  void ListResolverDnssecConfigsAsync(const ListResolverDnssecConfigsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListResolverDnssecConfigsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResolverEndpointIpAddressesOutcome ListResolverEndpointIpAddresses(
      const Model::ListResolverEndpointIpAddressesRequest& request) const;

  /**
   * A Callable wrapper for ListResolverEndpointIpAddresses that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListResolverEndpointIpAddressesRequestT = Model::ListResolverEndpointIpAddressesRequest>
  Model::ListResolverEndpointIpAddressesOutcomeCallable ListResolverEndpointIpAddressesCallable(
      const ListResolverEndpointIpAddressesRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::ListResolverEndpointIpAddresses, request);
  }

  /**
   * An Async wrapper for ListResolverEndpointIpAddresses that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListResolverEndpointIpAddressesRequestT = Model::ListResolverEndpointIpAddressesRequest>
  void ListResolverEndpointIpAddressesAsync(const ListResolverEndpointIpAddressesRequestT& request,
                                            const ListResolverEndpointIpAddressesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListResolverEndpoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResolverEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResolverEndpointsRequestT = Model::ListResolverEndpointsRequest>
  void ListResolverEndpointsAsync(const ListResolverEndpointsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListResolverEndpointsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResolverQueryLogConfigAssociationsOutcome ListResolverQueryLogConfigAssociations(
      const Model::ListResolverQueryLogConfigAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListResolverQueryLogConfigAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListResolverQueryLogConfigAssociationsRequestT = Model::ListResolverQueryLogConfigAssociationsRequest>
  Model::ListResolverQueryLogConfigAssociationsOutcomeCallable ListResolverQueryLogConfigAssociationsCallable(
      const ListResolverQueryLogConfigAssociationsRequestT& request = {}) const {
    return SubmitCallable(&Route53ResolverClient::ListResolverQueryLogConfigAssociations, request);
  }

  /**
   * An Async wrapper for ListResolverQueryLogConfigAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListResolverQueryLogConfigAssociationsRequestT = Model::ListResolverQueryLogConfigAssociationsRequest>
  void ListResolverQueryLogConfigAssociationsAsync(const ListResolverQueryLogConfigAssociationsResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                   const ListResolverQueryLogConfigAssociationsRequestT& request = {}) const {
  ...
  virtual Model::ListResolverQueryLogConfigsOutcome ListResolverQueryLogConfigs(
      const Model::ListResolverQueryLogConfigsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListResolverQueryLogConfigs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListResolverQueryLogConfigsRequestT = Model::ListResolverQueryLogConfigsRequest>
  Model::ListResolverQueryLogConfigsOutcomeCallable ListResolverQueryLogConfigsCallable(
      const ListResolverQueryLogConfigsRequestT& request = {}) const {
    return SubmitCallable(&Route53ResolverClient::ListResolverQueryLogConfigs, request);
  }

  /**
   * An Async wrapper for ListResolverQueryLogConfigs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResolverQueryLogConfigsRequestT = Model::ListResolverQueryLogConfigsRequest>
  void ListResolverQueryLogConfigsAsync(const ListResolverQueryLogConfigsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListResolverQueryLogConfigsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResolverRuleAssociationsOutcome ListResolverRuleAssociations(
      const Model::ListResolverRuleAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListResolverRuleAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListResolverRuleAssociationsRequestT = Model::ListResolverRuleAssociationsRequest>
  Model::ListResolverRuleAssociationsOutcomeCallable ListResolverRuleAssociationsCallable(
      const ListResolverRuleAssociationsRequestT& request = {}) const {
    return SubmitCallable(&Route53ResolverClient::ListResolverRuleAssociations, request);
  }

  /**
   * An Async wrapper for ListResolverRuleAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResolverRuleAssociationsRequestT = Model::ListResolverRuleAssociationsRequest>
  void ListResolverRuleAssociationsAsync(const ListResolverRuleAssociationsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListResolverRuleAssociationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListResolverRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResolverRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListResolverRulesRequestT = Model::ListResolverRulesRequest>
  void ListResolverRulesAsync(const ListResolverRulesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListResolverRulesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutFirewallRuleGroupPolicyOutcome PutFirewallRuleGroupPolicy(
      const Model::PutFirewallRuleGroupPolicyRequest& request) const;

  /**
   * A Callable wrapper for PutFirewallRuleGroupPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutFirewallRuleGroupPolicyRequestT = Model::PutFirewallRuleGroupPolicyRequest>
  Model::PutFirewallRuleGroupPolicyOutcomeCallable PutFirewallRuleGroupPolicyCallable(
      const PutFirewallRuleGroupPolicyRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::PutFirewallRuleGroupPolicy, request);
  }

  /**
   * An Async wrapper for PutFirewallRuleGroupPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutFirewallRuleGroupPolicyRequestT = Model::PutFirewallRuleGroupPolicyRequest>
  void PutFirewallRuleGroupPolicyAsync(const PutFirewallRuleGroupPolicyRequestT& request,
                                       const PutFirewallRuleGroupPolicyResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutResolverQueryLogConfigPolicyOutcome PutResolverQueryLogConfigPolicy(
      const Model::PutResolverQueryLogConfigPolicyRequest& request) const;

  /**
   * A Callable wrapper for PutResolverQueryLogConfigPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutResolverQueryLogConfigPolicyRequestT = Model::PutResolverQueryLogConfigPolicyRequest>
  Model::PutResolverQueryLogConfigPolicyOutcomeCallable PutResolverQueryLogConfigPolicyCallable(
      const PutResolverQueryLogConfigPolicyRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::PutResolverQueryLogConfigPolicy, request);
  }

  /**
   * An Async wrapper for PutResolverQueryLogConfigPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutResolverQueryLogConfigPolicyRequestT = Model::PutResolverQueryLogConfigPolicyRequest>
  void PutResolverQueryLogConfigPolicyAsync(const PutResolverQueryLogConfigPolicyRequestT& request,
                                            const PutResolverQueryLogConfigPolicyResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutResolverRulePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutResolverRulePolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutResolverRulePolicyRequestT = Model::PutResolverRulePolicyRequest>
  void PutResolverRulePolicyAsync(const PutResolverRulePolicyRequestT& request, const PutResolverRulePolicyResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateFirewallConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFirewallConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFirewallConfigRequestT = Model::UpdateFirewallConfigRequest>
  void UpdateFirewallConfigAsync(const UpdateFirewallConfigRequestT& request, const UpdateFirewallConfigResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateFirewallRuleGroupAssociationOutcome UpdateFirewallRuleGroupAssociation(
      const Model::UpdateFirewallRuleGroupAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateFirewallRuleGroupAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateFirewallRuleGroupAssociationRequestT = Model::UpdateFirewallRuleGroupAssociationRequest>
  Model::UpdateFirewallRuleGroupAssociationOutcomeCallable UpdateFirewallRuleGroupAssociationCallable(
      const UpdateFirewallRuleGroupAssociationRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::UpdateFirewallRuleGroupAssociation, request);
  }

  /**
   * An Async wrapper for UpdateFirewallRuleGroupAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateFirewallRuleGroupAssociationRequestT = Model::UpdateFirewallRuleGroupAssociationRequest>
  void UpdateFirewallRuleGroupAssociationAsync(const UpdateFirewallRuleGroupAssociationRequestT& request,
                                               const UpdateFirewallRuleGroupAssociationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateOutpostResolver that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateOutpostResolver that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateOutpostResolverRequestT = Model::UpdateOutpostResolverRequest>
  void UpdateOutpostResolverAsync(const UpdateOutpostResolverRequestT& request, const UpdateOutpostResolverResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateResolverConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResolverConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResolverConfigRequestT = Model::UpdateResolverConfigRequest>
  void UpdateResolverConfigAsync(const UpdateResolverConfigRequestT& request, const UpdateResolverConfigResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateResolverDnssecConfigOutcome UpdateResolverDnssecConfig(
      const Model::UpdateResolverDnssecConfigRequest& request) const;

  /**
   * A Callable wrapper for UpdateResolverDnssecConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateResolverDnssecConfigRequestT = Model::UpdateResolverDnssecConfigRequest>
  Model::UpdateResolverDnssecConfigOutcomeCallable UpdateResolverDnssecConfigCallable(
      const UpdateResolverDnssecConfigRequestT& request) const {
    return SubmitCallable(&Route53ResolverClient::UpdateResolverDnssecConfig, request);
  }

  /**
   * An Async wrapper for UpdateResolverDnssecConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResolverDnssecConfigRequestT = Model::UpdateResolverDnssecConfigRequest>
  void UpdateResolverDnssecConfigAsync(const UpdateResolverDnssecConfigRequestT& request,
                                       const UpdateResolverDnssecConfigResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateResolverEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResolverEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResolverEndpointRequestT = Model::UpdateResolverEndpointRequest>
  void UpdateResolverEndpointAsync(const UpdateResolverEndpointRequestT& request,
                                   const UpdateResolverEndpointResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateResolverRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResolverRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateResolverRuleRequestT = Model::UpdateResolverRuleRequest>
  void UpdateResolverRuleAsync(const UpdateResolverRuleRequestT& request, const UpdateResolverRuleResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
