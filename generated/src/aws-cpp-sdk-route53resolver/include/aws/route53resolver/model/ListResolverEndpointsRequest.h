...
class ListResolverEndpointsRequest : public Route53ResolverRequest {
 public:
  ...
  inline ListResolverEndpointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverEndpointsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListResolverEndpointsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListResolverEndpointsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
