...
class ImportFirewallDomainsResult {
 public:
  ...
  inline void SetStatus(FirewallDomainListStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ImportFirewallDomainsResult& WithStatus(FirewallDomainListStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  ImportFirewallDomainsResult& WithStatusMessage(StatusMessageT&& value) {
