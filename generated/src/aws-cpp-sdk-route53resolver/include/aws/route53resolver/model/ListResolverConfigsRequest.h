...
class ListResolverConfigsRequest : public Route53ResolverRequest {
 public:
  AWS_ROUTE53RESOLVER_API ListResolverConfigsRequest() = default;
  ...
  inline ListResolverConfigsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverConfigsRequest& WithNextToken(NextTokenT&& value) {
