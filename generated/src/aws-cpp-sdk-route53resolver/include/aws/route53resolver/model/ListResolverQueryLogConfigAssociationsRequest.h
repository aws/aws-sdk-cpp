...
class ListResolverQueryLogConfigAssociationsRequest : public Route53ResolverRequest {
 public:
  ...
  inline ListResolverQueryLogConfigAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverQueryLogConfigAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListResolverQueryLogConfigAssociationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListResolverQueryLogConfigAssociationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename SortByT = Aws::String>
  ListResolverQueryLogConfigAssociationsRequest& WithSortBy(SortByT&& value) {
  ...
  inline ListResolverQueryLogConfigAssociationsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
