...
class UpdateFirewallRuleGroupAssociationRequest : public Route53ResolverRequest {
 public:
  ...
  void SetFirewallRuleGroupAssociationId(FirewallRuleGroupAssociationIdT&& value) {
    m_firewallRuleGroupAssociationIdHasBeenSet = true;
    m_firewallRuleGroupAssociationId = std::forward<FirewallRuleGroupAssociationIdT>(value);
  }
  template <typename FirewallRuleGroupAssociationIdT = Aws::String>
  UpdateFirewallRuleGroupAssociationRequest& WithFirewallRuleGroupAssociationId(FirewallRuleGroupAssociationIdT&& value) {
    SetFirewallRuleGroupAssociationId(std::forward<FirewallRuleGroupAssociationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateFirewallRuleGroupAssociationRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFirewallRuleGroupAssociationRequest& WithMutationProtection(MutationProtectionStatus value) {
