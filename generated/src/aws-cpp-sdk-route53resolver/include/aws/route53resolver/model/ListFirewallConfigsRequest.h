...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RESOLVER_API ListFirewallConfigsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListFirewallConfigsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
