...
namespace Model
{
  ...
  public:
    ...
    template<typename FirewallConfigT = FirewallConfig>
    UpdateFirewallConfigResult& WithFirewallConfig(FirewallConfigT&& value) { SetFirewallConfig(std::forward<FirewallConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFirewallConfigResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
