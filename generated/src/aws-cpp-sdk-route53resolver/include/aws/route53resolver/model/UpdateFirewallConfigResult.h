...
class UpdateFirewallConfigResult {
 public:
  AWS_ROUTE53RESOLVER_API UpdateFirewallConfigResult() = default;
  ...
  void SetFirewallConfig(FirewallConfigT&& value) {
    m_firewallConfigHasBeenSet = true;
    m_firewallConfig = std::forward<FirewallConfigT>(value);
  }
  template <typename FirewallConfigT = FirewallConfig>
  UpdateFirewallConfigResult& WithFirewallConfig(FirewallConfigT&& value) {
    SetFirewallConfig(std::forward<FirewallConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFirewallConfigResult& WithRequestId(RequestIdT&& value) {
