...
class ListFirewallRuleGroupAssociationsResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API ListFirewallRuleGroupAssociationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListFirewallRuleGroupAssociationsResult& WithNextToken(NextTokenT&& value) {
   ...
   */
  inline const Aws::Vector<FirewallRuleGroupAssociation>& GetFirewallRuleGroupAssociations() const {
    return m_firewallRuleGroupAssociations;
  }
  template <typename FirewallRuleGroupAssociationsT = Aws::Vector<FirewallRuleGroupAssociation>>
  void SetFirewallRuleGroupAssociations(FirewallRuleGroupAssociationsT&& value) {
    m_firewallRuleGroupAssociationsHasBeenSet = true;
    m_firewallRuleGroupAssociations = std::forward<FirewallRuleGroupAssociationsT>(value);
  }
  template <typename FirewallRuleGroupAssociationsT = Aws::Vector<FirewallRuleGroupAssociation>>
  ListFirewallRuleGroupAssociationsResult& WithFirewallRuleGroupAssociations(FirewallRuleGroupAssociationsT&& value) {
    SetFirewallRuleGroupAssociations(std::forward<FirewallRuleGroupAssociationsT>(value));
    return *this;
  }
  template <typename FirewallRuleGroupAssociationsT = FirewallRuleGroupAssociation>
  ListFirewallRuleGroupAssociationsResult& AddFirewallRuleGroupAssociations(FirewallRuleGroupAssociationsT&& value) {
    m_firewallRuleGroupAssociationsHasBeenSet = true;
    m_firewallRuleGroupAssociations.emplace_back(std::forward<FirewallRuleGroupAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListFirewallRuleGroupAssociationsResult& WithRequestId(RequestIdT&& value) {
