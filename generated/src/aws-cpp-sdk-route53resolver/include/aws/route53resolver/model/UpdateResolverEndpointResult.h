...
class UpdateResolverEndpointResult {
 public:
  AWS_ROUTE53RESOLVER_API UpdateResolverEndpointResult() = default;
  ...
  template <typename ResolverEndpointT = ResolverEndpoint>
  UpdateResolverEndpointResult& WithResolverEndpoint(ResolverEndpointT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateResolverEndpointResult& WithRequestId(RequestIdT&& value) {
