...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RESOLVER_API ListFirewallDomainListsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListFirewallDomainListsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
