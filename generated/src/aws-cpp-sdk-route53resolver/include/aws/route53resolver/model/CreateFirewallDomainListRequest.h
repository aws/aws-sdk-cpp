...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RESOLVER_API CreateFirewallDomainListRequest() = default;
    ...
    template<typename CreatorRequestIdT = Aws::String>
    CreateFirewallDomainListRequest& WithCreatorRequestId(CreatorRequestIdT&& value) { SetCreatorRequestId(std::forward<CreatorRequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateFirewallDomainListRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Vector<Tag>>
    CreateFirewallDomainListRequest& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsT = Tag>
    CreateFirewallDomainListRequest& AddTags(TagsT&& value) { m_tagsHasBeenSet = true; m_tags.emplace_back(std::forward<TagsT>(value)); return *this; }
    ///@}
  private:
