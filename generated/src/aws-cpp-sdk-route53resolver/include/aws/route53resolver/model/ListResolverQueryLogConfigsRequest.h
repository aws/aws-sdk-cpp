...
class ListResolverQueryLogConfigsRequest : public Route53ResolverRequest {
 public:
  ...
  inline ListResolverQueryLogConfigsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverQueryLogConfigsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListResolverQueryLogConfigsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListResolverQueryLogConfigsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename SortByT = Aws::String>
  ListResolverQueryLogConfigsRequest& WithSortBy(SortByT&& value) {
  ...
  inline ListResolverQueryLogConfigsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
