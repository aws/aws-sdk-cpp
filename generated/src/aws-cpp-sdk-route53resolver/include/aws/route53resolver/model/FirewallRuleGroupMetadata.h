...
class FirewallRuleGroupMetadata {
 public:
  ...
  template <typename IdT = Aws::String>
  FirewallRuleGroupMetadata& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  FirewallRuleGroupMetadata& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  FirewallRuleGroupMetadata& WithName(NameT&& value) {
  ...
  inline FirewallRuleGroupMetadata& WithShareStatus(ShareStatus value) {
