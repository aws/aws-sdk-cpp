...
class GetResolverQueryLogConfigResult {
 public:
  AWS_ROUTE53RESOLVER_API GetResolverQueryLogConfigResult() = default;
  AWS_ROUTE53RESOLVER_API GetResolverQueryLogConfigResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ROUTE53RESOLVER_API GetResolverQueryLogConfigResult& operator=(
  ...
  void SetResolverQueryLogConfig(ResolverQueryLogConfigT&& value) {
    m_resolverQueryLogConfigHasBeenSet = true;
    m_resolverQueryLogConfig = std::forward<ResolverQueryLogConfigT>(value);
  }
  template <typename ResolverQueryLogConfigT = ResolverQueryLogConfig>
  GetResolverQueryLogConfigResult& WithResolverQueryLogConfig(ResolverQueryLogConfigT&& value) {
    SetResolverQueryLogConfig(std::forward<ResolverQueryLogConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetResolverQueryLogConfigResult& WithRequestId(RequestIdT&& value) {
