...
class AssociateResolverEndpointIpAddressResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API AssociateResolverEndpointIpAddressResult& operator=(
  ...
  void SetResolverEndpoint(ResolverEndpointT&& value) {
    m_resolverEndpointHasBeenSet = true;
    m_resolverEndpoint = std::forward<ResolverEndpointT>(value);
  }
  template <typename ResolverEndpointT = ResolverEndpoint>
  AssociateResolverEndpointIpAddressResult& WithResolverEndpoint(ResolverEndpointT&& value) {
    SetResolverEndpoint(std::forward<ResolverEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AssociateResolverEndpointIpAddressResult& WithRequestId(RequestIdT&& value) {
