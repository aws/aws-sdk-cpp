...
class ListOutpostResolversResult {
 public:
  ...
  void SetOutpostResolvers(OutpostResolversT&& value) {
    m_outpostResolversHasBeenSet = true;
    m_outpostResolvers = std::forward<OutpostResolversT>(value);
  }
  template <typename OutpostResolversT = Aws::Vector<OutpostResolver>>
  ListOutpostResolversResult& WithOutpostResolvers(OutpostResolversT&& value) {
    SetOutpostResolvers(std::forward<OutpostResolversT>(value));
    return *this;
  }
  template <typename OutpostResolversT = OutpostResolver>
  ListOutpostResolversResult& AddOutpostResolvers(OutpostResolversT&& value) {
    m_outpostResolversHasBeenSet = true;
    m_outpostResolvers.emplace_back(std::forward<OutpostResolversT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOutpostResolversResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOutpostResolversResult& WithRequestId(RequestIdT&& value) {
