...
class PutResolverQueryLogConfigPolicyResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API PutResolverQueryLogConfigPolicyResult& operator=(
  ...
  inline PutResolverQueryLogConfigPolicyResult& WithReturnValue(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutResolverQueryLogConfigPolicyResult& WithRequestId(RequestIdT&& value) {
