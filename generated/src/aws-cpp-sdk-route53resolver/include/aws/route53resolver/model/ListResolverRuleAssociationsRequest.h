...
class ListResolverRuleAssociationsRequest : public Route53ResolverRequest {
 public:
  ...
  inline ListResolverRuleAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverRuleAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListResolverRuleAssociationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListResolverRuleAssociationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
