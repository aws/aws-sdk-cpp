...
class DeleteResolverQueryLogConfigResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API DeleteResolverQueryLogConfigResult& operator=(
  ...
  template <typename ResolverQueryLogConfigT = ResolverQueryLogConfig>
  DeleteResolverQueryLogConfigResult& WithResolverQueryLogConfig(ResolverQueryLogConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteResolverQueryLogConfigResult& WithRequestId(RequestIdT&& value) {
