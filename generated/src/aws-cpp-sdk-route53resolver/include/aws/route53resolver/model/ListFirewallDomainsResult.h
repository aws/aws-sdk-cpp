...
class ListFirewallDomainsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListFirewallDomainsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename DomainsT = Aws::Vector<Aws::String>>
  ListFirewallDomainsResult& WithDomains(DomainsT&& value) {
    SetDomains(std::forward<DomainsT>(value));
    return *this;
  }
  template <typename DomainsT = Aws::String>
  ListFirewallDomainsResult& AddDomains(DomainsT&& value) {
    m_domainsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListFirewallDomainsResult& WithRequestId(RequestIdT&& value) {
