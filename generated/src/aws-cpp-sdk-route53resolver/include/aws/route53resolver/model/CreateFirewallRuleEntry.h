...
/**
 * <p>The details for creating a single firewall rule in a batch
 * operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/CreateFirewallRuleEntry">AWS
 * API Reference</a></p>
 */
class CreateFirewallRuleEntry {
 public:
  ...
  ///@{
  /**
   * <p>The ID of the domain list that you want to use in the rule. This setting is
   * mutually exclusive with <code>DnsThreatProtection</code> and
  ...
  inline CreateFirewallRuleEntry& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFirewallRuleEntry& WithAction(Action value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFirewallRuleEntry& WithBlockResponse(BlockResponse value) {
  ...
  inline CreateFirewallRuleEntry& WithBlockOverrideDnsType(BlockOverrideDnsType value) {
  ...
  inline CreateFirewallRuleEntry& WithBlockOverrideTtl(int value) {
  ...
  inline CreateFirewallRuleEntry& WithFirewallDomainRedirectionAction(FirewallDomainRedirectionAction value) {
  ...
  inline CreateFirewallRuleEntry& WithDnsThreatProtection(DnsThreatProtection value) {
  ...
  inline CreateFirewallRuleEntry& WithConfidenceThreshold(ConfidenceThreshold value) {
