...
class ListResolverQueryLogConfigsResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API ListResolverQueryLogConfigsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverQueryLogConfigsResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResolverQueryLogConfigsResult& WithTotalCount(int value) {
    SetTotalCount(value);
    return *this;
  }
  ///@}
  ...
  inline ListResolverQueryLogConfigsResult& WithTotalFilteredCount(int value) {
  ...
  void SetResolverQueryLogConfigs(ResolverQueryLogConfigsT&& value) {
    m_resolverQueryLogConfigsHasBeenSet = true;
    m_resolverQueryLogConfigs = std::forward<ResolverQueryLogConfigsT>(value);
  }
  template <typename ResolverQueryLogConfigsT = Aws::Vector<ResolverQueryLogConfig>>
  ListResolverQueryLogConfigsResult& WithResolverQueryLogConfigs(ResolverQueryLogConfigsT&& value) {
    SetResolverQueryLogConfigs(std::forward<ResolverQueryLogConfigsT>(value));
    return *this;
  }
  template <typename ResolverQueryLogConfigsT = ResolverQueryLogConfig>
  ListResolverQueryLogConfigsResult& AddResolverQueryLogConfigs(ResolverQueryLogConfigsT&& value) {
    m_resolverQueryLogConfigsHasBeenSet = true;
    m_resolverQueryLogConfigs.emplace_back(std::forward<ResolverQueryLogConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListResolverQueryLogConfigsResult& WithRequestId(RequestIdT&& value) {
