...
class UpdateFirewallConfigRequest : public Route53ResolverRequest {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  UpdateFirewallConfigRequest& WithResourceId(ResourceIdT&& value) {
  ...
  inline void SetFirewallFailOpen(FirewallFailOpenStatus value) {
    m_firewallFailOpenHasBeenSet = true;
    m_firewallFailOpen = value;
  }
  inline UpdateFirewallConfigRequest& WithFirewallFailOpen(FirewallFailOpenStatus value) {
    SetFirewallFailOpen(value);
    return *this;
  }
  ///@}
 private:
