...
namespace Model
{
  ...
  public:
    ...
    template<typename FirewallRuleGroupAssociationT = FirewallRuleGroupAssociation>
    UpdateFirewallRuleGroupAssociationResult& WithFirewallRuleGroupAssociation(FirewallRuleGroupAssociationT&& value) { SetFirewallRuleGroupAssociation(std::forward<FirewallRuleGroupAssociationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFirewallRuleGroupAssociationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
