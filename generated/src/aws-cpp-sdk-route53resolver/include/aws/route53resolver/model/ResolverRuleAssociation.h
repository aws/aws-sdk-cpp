...
class ResolverRuleAssociation {
 public:
  ...
  template <typename IdT = Aws::String>
  ResolverRuleAssociation& WithId(IdT&& value) {
  ...
  inline void SetStatus(ResolverRuleAssociationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ResolverRuleAssociation& WithStatus(ResolverRuleAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
