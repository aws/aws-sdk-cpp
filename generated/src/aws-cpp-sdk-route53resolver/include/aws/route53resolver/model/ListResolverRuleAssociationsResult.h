...
class ListResolverRuleAssociationsResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API ListResolverRuleAssociationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverRuleAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResolverRuleAssociationsResult& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetResolverRuleAssociations(ResolverRuleAssociationsT&& value) {
    m_resolverRuleAssociationsHasBeenSet = true;
    m_resolverRuleAssociations = std::forward<ResolverRuleAssociationsT>(value);
  }
  template <typename ResolverRuleAssociationsT = Aws::Vector<ResolverRuleAssociation>>
  ListResolverRuleAssociationsResult& WithResolverRuleAssociations(ResolverRuleAssociationsT&& value) {
    SetResolverRuleAssociations(std::forward<ResolverRuleAssociationsT>(value));
    return *this;
  }
  template <typename ResolverRuleAssociationsT = ResolverRuleAssociation>
  ListResolverRuleAssociationsResult& AddResolverRuleAssociations(ResolverRuleAssociationsT&& value) {
    m_resolverRuleAssociationsHasBeenSet = true;
    m_resolverRuleAssociations.emplace_back(std::forward<ResolverRuleAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListResolverRuleAssociationsResult& WithRequestId(RequestIdT&& value) {
