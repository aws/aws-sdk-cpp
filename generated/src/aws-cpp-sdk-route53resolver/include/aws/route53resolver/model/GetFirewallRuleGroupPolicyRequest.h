...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RESOLVER_API GetFirewallRuleGroupPolicyRequest() = default;
    ...
    template<typename ArnT = Aws::String>
    GetFirewallRuleGroupPolicyRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
