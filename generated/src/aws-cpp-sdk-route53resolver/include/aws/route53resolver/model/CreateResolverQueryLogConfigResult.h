...
class CreateResolverQueryLogConfigResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API CreateResolverQueryLogConfigResult& operator=(
  ...
  template <typename ResolverQueryLogConfigT = ResolverQueryLogConfig>
  CreateResolverQueryLogConfigResult& WithResolverQueryLogConfig(ResolverQueryLogConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateResolverQueryLogConfigResult& WithRequestId(RequestIdT&& value) {
