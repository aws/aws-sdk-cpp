...
class FirewallConfig {
 public:
  ...
  template <typename IdT = Aws::String>
  FirewallConfig& WithId(IdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  FirewallConfig& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename OwnerIdT = Aws::String>
  FirewallConfig& WithOwnerId(OwnerIdT&& value) {
  ...
  inline FirewallConfig& WithFirewallFailOpen(FirewallFailOpenStatus value) {
