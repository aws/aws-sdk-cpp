...
class PutResolverQueryLogConfigPolicyRequest : public Route53ResolverRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  PutResolverQueryLogConfigPolicyRequest& WithArn(ArnT&& value) {
  ...
  template <typename ResolverQueryLogConfigPolicyT = Aws::String>
  PutResolverQueryLogConfigPolicyRequest& WithResolverQueryLogConfigPolicy(ResolverQueryLogConfigPolicyT&& value) {
