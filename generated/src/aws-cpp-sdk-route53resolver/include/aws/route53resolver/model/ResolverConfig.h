...
class ResolverConfig {
 public:
  ...
  template <typename IdT = Aws::String>
  ResolverConfig& WithId(IdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  ResolverConfig& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename OwnerIdT = Aws::String>
  ResolverConfig& WithOwnerId(OwnerIdT&& value) {
  ...
  inline void SetAutodefinedReverse(ResolverAutodefinedReverseStatus value) {
    m_autodefinedReverseHasBeenSet = true;
    m_autodefinedReverse = value;
  }
  inline ResolverConfig& WithAutodefinedReverse(ResolverAutodefinedReverseStatus value) {
    SetAutodefinedReverse(value);
    return *this;
  }
  ///@}
 private:
