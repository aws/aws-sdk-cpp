...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RESOLVER_API GetFirewallConfigRequest() = default;
    ...
    template<typename ResourceIdT = Aws::String>
    GetFirewallConfigRequest& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
  private:
