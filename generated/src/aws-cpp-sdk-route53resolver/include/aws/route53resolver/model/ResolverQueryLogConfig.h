...
class ResolverQueryLogConfig {
 public:
  ...
  inline void SetStatus(ResolverQueryLogConfigStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ResolverQueryLogConfig& WithStatus(ResolverQueryLogConfigStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ResolverQueryLogConfig& WithShareStatus(ShareStatus value) {
  ...
  inline void SetAssociationCount(int value) {
    m_associationCountHasBeenSet = true;
    m_associationCount = value;
  }
  inline ResolverQueryLogConfig& WithAssociationCount(int value) {
    SetAssociationCount(value);
    return *this;
  }
  ///@}
