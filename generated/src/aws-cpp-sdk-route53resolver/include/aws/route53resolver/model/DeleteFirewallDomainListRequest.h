...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RESOLVER_API DeleteFirewallDomainListRequest() = default;
    ...
    template<typename FirewallDomainListIdT = Aws::String>
    DeleteFirewallDomainListRequest& WithFirewallDomainListId(FirewallDomainListIdT&& value) { SetFirewallDomainListId(std::forward<FirewallDomainListIdT>(value)); return *this;}
    ///@}
  private:
