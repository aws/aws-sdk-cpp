...
class CreateResolverEndpointRequest : public Route53ResolverRequest {
 public:
  ...
  inline void SetDirection(ResolverEndpointDirection value) {
    m_directionHasBeenSet = true;
    m_direction = value;
  }
  inline CreateResolverEndpointRequest& WithDirection(ResolverEndpointDirection value) {
    SetDirection(value);
    return *this;
  }
  ///@}
  ...
  inline CreateResolverEndpointRequest& WithResolverEndpointType(ResolverEndpointType value) {
  ...
  inline CreateResolverEndpointRequest& AddProtocols(Protocol value) {
    m_protocolsHasBeenSet = true;
   ...
   * complete IPv6-to-IPv4 translation. Default is false.</p>
   */
  ...
  inline CreateResolverEndpointRequest& WithDns64Enabled(bool value) {
   ...
   * gateway. Default is false.</p>  <p>When you enable IPv6 internet
   * access, use network controls like security groups, NACLs, or egress-only
   * internet gateways to protect the endpoint ENIs from unsolicited ingress traffic.
   * Be aware that some network controls can affect DNS query throughput due to
   * connection tracking. For more information, see <a
  ...
  inline CreateResolverEndpointRequest& WithIpv6InternetAccessEnabled(bool value) {
