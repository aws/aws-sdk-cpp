...
class UpdateResolverRuleResult {
 public:
  AWS_ROUTE53RESOLVER_API UpdateResolverRuleResult() = default;
  ...
  template <typename ResolverRuleT = ResolverRule>
  UpdateResolverRuleResult& WithResolverRule(ResolverRuleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateResolverRuleResult& WithRequestId(RequestIdT&& value) {
