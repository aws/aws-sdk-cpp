...
class CreateOutpostResolverRequest : public Route53ResolverRequest {
 public:
  ...
  inline CreateOutpostResolverRequest& WithInstanceCount(int value) {
  ...
  void SetPreferredInstanceType(PreferredInstanceTypeT&& value) {
    ...
    m_preferredInstanceType = std::forward<PreferredInstanceTypeT>(value);
  }
  template <typename PreferredInstanceTypeT = Aws::String>
  CreateOutpostResolverRequest& WithPreferredInstanceType(PreferredInstanceTypeT&& value) {
    SetPreferredInstanceType(std::forward<PreferredInstanceTypeT>(value));
    return *this;
  }
  ///@}
