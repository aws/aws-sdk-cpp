...
class ListResolverEndpointIpAddressesRequest : public Route53ResolverRequest {
 public:
  ...
  template <typename ResolverEndpointIdT = Aws::String>
  ListResolverEndpointIpAddressesRequest& WithResolverEndpointId(ResolverEndpointIdT&& value) {
  ...
  inline ListResolverEndpointIpAddressesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverEndpointIpAddressesRequest& WithNextToken(NextTokenT&& value) {
