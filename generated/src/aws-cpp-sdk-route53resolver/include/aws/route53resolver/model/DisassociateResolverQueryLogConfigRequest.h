...
class DisassociateResolverQueryLogConfigRequest : public Route53ResolverRequest {
 public:
  ...
  template <typename ResolverQueryLogConfigIdT = Aws::String>
  DisassociateResolverQueryLogConfigRequest& WithResolverQueryLogConfigId(ResolverQueryLogConfigIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  DisassociateResolverQueryLogConfigRequest& WithResourceId(ResourceIdT&& value) {
