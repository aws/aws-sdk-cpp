...
class OutpostResolver {
 public:
  ...
  inline OutpostResolver& WithInstanceCount(int value) {
  ...
  inline void SetStatus(OutpostResolverStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline OutpostResolver& WithStatus(OutpostResolverStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
