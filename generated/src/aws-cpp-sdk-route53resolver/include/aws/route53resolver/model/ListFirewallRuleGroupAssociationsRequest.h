...
class ListFirewallRuleGroupAssociationsRequest : public Route53ResolverRequest {
 public:
  ...
  template <typename FirewallRuleGroupIdT = Aws::String>
  ListFirewallRuleGroupAssociationsRequest& WithFirewallRuleGroupId(FirewallRuleGroupIdT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  ListFirewallRuleGroupAssociationsRequest& WithVpcId(VpcIdT&& value) {
  ...
  inline ListFirewallRuleGroupAssociationsRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline ListFirewallRuleGroupAssociationsRequest& WithStatus(FirewallRuleGroupAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListFirewallRuleGroupAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFirewallRuleGroupAssociationsRequest& WithNextToken(NextTokenT&& value) {
