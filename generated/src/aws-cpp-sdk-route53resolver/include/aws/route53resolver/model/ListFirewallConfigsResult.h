...
class ListFirewallConfigsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListFirewallConfigsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetFirewallConfigs(FirewallConfigsT&& value) {
    m_firewallConfigsHasBeenSet = true;
    m_firewallConfigs = std::forward<FirewallConfigsT>(value);
  }
  template <typename FirewallConfigsT = Aws::Vector<FirewallConfig>>
  ListFirewallConfigsResult& WithFirewallConfigs(FirewallConfigsT&& value) {
    SetFirewallConfigs(std::forward<FirewallConfigsT>(value));
    return *this;
  }
  template <typename FirewallConfigsT = FirewallConfig>
  ListFirewallConfigsResult& AddFirewallConfigs(FirewallConfigsT&& value) {
    m_firewallConfigsHasBeenSet = true;
    m_firewallConfigs.emplace_back(std::forward<FirewallConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListFirewallConfigsResult& WithRequestId(RequestIdT&& value) {
