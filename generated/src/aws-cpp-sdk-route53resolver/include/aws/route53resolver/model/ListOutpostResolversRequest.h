...
class ListOutpostResolversRequest : public Route53ResolverRequest {
 public:
  AWS_ROUTE53RESOLVER_API ListOutpostResolversRequest() = default;
  ...
  template <typename OutpostArnT = Aws::String>
  ListOutpostResolversRequest& WithOutpostArn(OutpostArnT&& value) {
  ...
  inline ListOutpostResolversRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOutpostResolversRequest& WithNextToken(NextTokenT&& value) {
