...
namespace Model
{
  ...
  public:
    ...
    template<typename OutpostArnT = Aws::String>
    ListOutpostResolversRequest& WithOutpostArn(OutpostArnT&& value) { SetOutpostArn(std::forward<OutpostArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListOutpostResolversRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
