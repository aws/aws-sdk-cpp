...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RESOLVER_API DeleteResolverRuleResult() = default;
    ...
    template<typename ResolverRuleT = ResolverRule>
    DeleteResolverRuleResult& WithResolverRule(ResolverRuleT&& value) { SetResolverRule(std::forward<ResolverRuleT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteResolverRuleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
