...
class ListResolverConfigsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverConfigsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetResolverConfigs(ResolverConfigsT&& value) {
    m_resolverConfigsHasBeenSet = true;
    m_resolverConfigs = std::forward<ResolverConfigsT>(value);
  }
  template <typename ResolverConfigsT = Aws::Vector<ResolverConfig>>
  ListResolverConfigsResult& WithResolverConfigs(ResolverConfigsT&& value) {
    SetResolverConfigs(std::forward<ResolverConfigsT>(value));
    return *this;
  }
  template <typename ResolverConfigsT = ResolverConfig>
  ListResolverConfigsResult& AddResolverConfigs(ResolverConfigsT&& value) {
    m_resolverConfigsHasBeenSet = true;
    m_resolverConfigs.emplace_back(std::forward<ResolverConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListResolverConfigsResult& WithRequestId(RequestIdT&& value) {
