...
class DisassociateResolverEndpointIpAddressResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API DisassociateResolverEndpointIpAddressResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ResolverEndpointT = ResolverEndpoint>
  DisassociateResolverEndpointIpAddressResult& WithResolverEndpoint(ResolverEndpointT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateResolverEndpointIpAddressResult& WithRequestId(RequestIdT&& value) {
