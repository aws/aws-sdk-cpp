...
class FirewallRule {
 public:
  ...
  inline FirewallRule& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline FirewallRule& WithAction(Action value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline FirewallRule& WithBlockResponse(BlockResponse value) {
  ...
  inline FirewallRule& WithBlockOverrideDnsType(BlockOverrideDnsType value) {
  ...
  inline FirewallRule& WithBlockOverrideTtl(int value) {
  ...
  inline FirewallRule& WithFirewallDomainRedirectionAction(FirewallDomainRedirectionAction value) {
  ...
  inline FirewallRule& WithDnsThreatProtection(DnsThreatProtection value) {
  ...
  inline FirewallRule& WithConfidenceThreshold(ConfidenceThreshold value) {
