...
class PutFirewallRuleGroupPolicyResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API PutFirewallRuleGroupPolicyResult& operator=(
  ...
  inline PutFirewallRuleGroupPolicyResult& WithReturnValue(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutFirewallRuleGroupPolicyResult& WithRequestId(RequestIdT&& value) {
