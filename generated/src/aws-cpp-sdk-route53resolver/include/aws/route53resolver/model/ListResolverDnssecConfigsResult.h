...
class ListResolverDnssecConfigsResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API ListResolverDnssecConfigsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverDnssecConfigsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetResolverDnssecConfigs(ResolverDnssecConfigsT&& value) {
    m_resolverDnssecConfigsHasBeenSet = true;
    m_resolverDnssecConfigs = std::forward<ResolverDnssecConfigsT>(value);
  }
  template <typename ResolverDnssecConfigsT = Aws::Vector<ResolverDnssecConfig>>
  ListResolverDnssecConfigsResult& WithResolverDnssecConfigs(ResolverDnssecConfigsT&& value) {
    SetResolverDnssecConfigs(std::forward<ResolverDnssecConfigsT>(value));
    return *this;
  }
  template <typename ResolverDnssecConfigsT = ResolverDnssecConfig>
  ListResolverDnssecConfigsResult& AddResolverDnssecConfigs(ResolverDnssecConfigsT&& value) {
    m_resolverDnssecConfigsHasBeenSet = true;
    m_resolverDnssecConfigs.emplace_back(std::forward<ResolverDnssecConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListResolverDnssecConfigsResult& WithRequestId(RequestIdT&& value) {
