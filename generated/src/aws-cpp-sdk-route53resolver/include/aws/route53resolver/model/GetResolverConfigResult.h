...
class GetResolverConfigResult {
 public:
  ...
  void SetResolverConfig(ResolverConfigT&& value) {
    m_resolverConfigHasBeenSet = true;
    m_resolverConfig = std::forward<ResolverConfigT>(value);
  }
  template <typename ResolverConfigT = ResolverConfig>
  GetResolverConfigResult& WithResolverConfig(ResolverConfigT&& value) {
    SetResolverConfig(std::forward<ResolverConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetResolverConfigResult& WithRequestId(RequestIdT&& value) {
