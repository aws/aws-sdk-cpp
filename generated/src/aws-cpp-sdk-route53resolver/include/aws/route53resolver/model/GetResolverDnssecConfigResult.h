...
class GetResolverDnssecConfigResult {
 public:
  ...
  void SetResolverDNSSECConfig(ResolverDNSSECConfigT&& value) {
    m_resolverDNSSECConfigHasBeenSet = true;
    m_resolverDNSSECConfig = std::forward<ResolverDNSSECConfigT>(value);
  }
  template <typename ResolverDNSSECConfigT = ResolverDnssecConfig>
  GetResolverDnssecConfigResult& WithResolverDNSSECConfig(ResolverDNSSECConfigT&& value) {
    SetResolverDNSSECConfig(std::forward<ResolverDNSSECConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetResolverDnssecConfigResult& WithRequestId(RequestIdT&& value) {
