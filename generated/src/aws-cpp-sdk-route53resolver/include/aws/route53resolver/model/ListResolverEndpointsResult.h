...
class ListResolverEndpointsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResolverEndpointsResult& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetResolverEndpoints(ResolverEndpointsT&& value) {
    m_resolverEndpointsHasBeenSet = true;
    m_resolverEndpoints = std::forward<ResolverEndpointsT>(value);
  }
  template <typename ResolverEndpointsT = Aws::Vector<ResolverEndpoint>>
  ListResolverEndpointsResult& WithResolverEndpoints(ResolverEndpointsT&& value) {
    SetResolverEndpoints(std::forward<ResolverEndpointsT>(value));
    return *this;
  }
  template <typename ResolverEndpointsT = ResolverEndpoint>
  ListResolverEndpointsResult& AddResolverEndpoints(ResolverEndpointsT&& value) {
    m_resolverEndpointsHasBeenSet = true;
    m_resolverEndpoints.emplace_back(std::forward<ResolverEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListResolverEndpointsResult& WithRequestId(RequestIdT&& value) {
