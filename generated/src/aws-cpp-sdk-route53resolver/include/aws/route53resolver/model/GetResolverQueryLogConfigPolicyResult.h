...
class GetResolverQueryLogConfigPolicyResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API GetResolverQueryLogConfigPolicyResult& operator=(
  ...
  void SetResolverQueryLogConfigPolicy(ResolverQueryLogConfigPolicyT&& value) {
    m_resolverQueryLogConfigPolicyHasBeenSet = true;
    m_resolverQueryLogConfigPolicy = std::forward<ResolverQueryLogConfigPolicyT>(value);
  }
  template <typename ResolverQueryLogConfigPolicyT = Aws::String>
  GetResolverQueryLogConfigPolicyResult& WithResolverQueryLogConfigPolicy(ResolverQueryLogConfigPolicyT&& value) {
    SetResolverQueryLogConfigPolicy(std::forward<ResolverQueryLogConfigPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetResolverQueryLogConfigPolicyResult& WithRequestId(RequestIdT&& value) {
