...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RESOLVER_API ResourceUnavailableException() = default;
    ...
    template<typename ResourceTypeT = Aws::String>
    ResourceUnavailableException& WithResourceType(ResourceTypeT&& value) { SetResourceType(std::forward<ResourceTypeT>(value)); return *this;}
    ///@}
  private:
