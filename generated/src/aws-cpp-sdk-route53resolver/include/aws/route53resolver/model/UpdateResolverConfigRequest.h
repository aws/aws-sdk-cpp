...
class UpdateResolverConfigRequest : public Route53ResolverRequest {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  UpdateResolverConfigRequest& WithResourceId(ResourceIdT&& value) {
  ...
  inline void SetAutodefinedReverseFlag(AutodefinedReverseFlag value) {
    m_autodefinedReverseFlagHasBeenSet = true;
    m_autodefinedReverseFlag = value;
  }
  inline UpdateResolverConfigRequest& WithAutodefinedReverseFlag(AutodefinedReverseFlag value) {
    SetAutodefinedReverseFlag(value);
    return *this;
  }
  ///@}
 private:
