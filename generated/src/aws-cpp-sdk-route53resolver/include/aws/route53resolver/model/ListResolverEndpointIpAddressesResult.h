...
class ListResolverEndpointIpAddressesResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API ListResolverEndpointIpAddressesResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverEndpointIpAddressesResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResolverEndpointIpAddressesResult& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpAddressesT = Aws::Vector<IpAddressResponse>>
  ListResolverEndpointIpAddressesResult& WithIpAddresses(IpAddressesT&& value) {
    SetIpAddresses(std::forward<IpAddressesT>(value));
    return *this;
  }
  template <typename IpAddressesT = IpAddressResponse>
  ListResolverEndpointIpAddressesResult& AddIpAddresses(IpAddressesT&& value) {
    m_ipAddressesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListResolverEndpointIpAddressesResult& WithRequestId(RequestIdT&& value) {
