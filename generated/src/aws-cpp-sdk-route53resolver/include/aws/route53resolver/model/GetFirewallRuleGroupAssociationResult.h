...
class GetFirewallRuleGroupAssociationResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API GetFirewallRuleGroupAssociationResult& operator=(
  ...
  template <typename FirewallRuleGroupAssociationT = FirewallRuleGroupAssociation>
  GetFirewallRuleGroupAssociationResult& WithFirewallRuleGroupAssociation(FirewallRuleGroupAssociationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFirewallRuleGroupAssociationResult& WithRequestId(RequestIdT&& value) {
