...
class ListFirewallRuleGroupsRequest : public Route53ResolverRequest {
 public:
  AWS_ROUTE53RESOLVER_API ListFirewallRuleGroupsRequest() = default;
  ...
  inline ListFirewallRuleGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFirewallRuleGroupsRequest& WithNextToken(NextTokenT&& value) {
