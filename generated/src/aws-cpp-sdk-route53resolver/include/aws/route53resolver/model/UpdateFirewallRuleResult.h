...
namespace Model
{
  ...
  public:
    ...
    template<typename FirewallRuleT = FirewallRule>
    UpdateFirewallRuleResult& WithFirewallRule(FirewallRuleT&& value) { SetFirewallRule(std::forward<FirewallRuleT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFirewallRuleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
