...
class ListResolverRulesRequest : public Route53ResolverRequest {
 public:
  ...
  inline ListResolverRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverRulesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListResolverRulesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListResolverRulesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
