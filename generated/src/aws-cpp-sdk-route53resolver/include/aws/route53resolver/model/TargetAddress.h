...
class TargetAddress {
 public:
  ...
  inline TargetAddress& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline TargetAddress& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  void SetServerNameIndication(ServerNameIndicationT&& value) {
    ...
    m_serverNameIndication = std::forward<ServerNameIndicationT>(value);
  }
  template <typename ServerNameIndicationT = Aws::String>
  TargetAddress& WithServerNameIndication(ServerNameIndicationT&& value) {
    SetServerNameIndication(std::forward<ServerNameIndicationT>(value));
    return *this;
  }
  ///@}
 private:
