...
class ListResolverDnssecConfigsRequest : public Route53ResolverRequest {
 public:
  AWS_ROUTE53RESOLVER_API ListResolverDnssecConfigsRequest() = default;
  ...
  inline ListResolverDnssecConfigsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverDnssecConfigsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListResolverDnssecConfigsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListResolverDnssecConfigsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
