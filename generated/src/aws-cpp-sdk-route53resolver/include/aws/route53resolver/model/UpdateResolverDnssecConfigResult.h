...
class UpdateResolverDnssecConfigResult {
 public:
  ...
  AWS_ROUTE53RESOLVER_API UpdateResolverDnssecConfigResult& operator=(
  ...
  template <typename ResolverDNSSECConfigT = ResolverDnssecConfig>
  UpdateResolverDnssecConfigResult& WithResolverDNSSECConfig(ResolverDNSSECConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateResolverDnssecConfigResult& WithRequestId(RequestIdT&& value) {
