...
class ListResolverRulesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListResolverRulesResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResolverRulesResult& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetResolverRules(ResolverRulesT&& value) {
    m_resolverRulesHasBeenSet = true;
    m_resolverRules = std::forward<ResolverRulesT>(value);
  }
  template <typename ResolverRulesT = Aws::Vector<ResolverRule>>
  ListResolverRulesResult& WithResolverRules(ResolverRulesT&& value) {
    SetResolverRules(std::forward<ResolverRulesT>(value));
    return *this;
  }
  template <typename ResolverRulesT = ResolverRule>
  ListResolverRulesResult& AddResolverRules(ResolverRulesT&& value) {
    m_resolverRulesHasBeenSet = true;
    m_resolverRules.emplace_back(std::forward<ResolverRulesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListResolverRulesResult& WithRequestId(RequestIdT&& value) {
