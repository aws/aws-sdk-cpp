...
Aws::String CreateFirewallRuleRequest::SerializePayload() const {
  ...
  if (m_firewallDomainRedirectionActionHasBeenSet) {
    payload.WithString("FirewallDomainRedirectionAction",
                       FirewallDomainRedirectionActionMapper::GetNameForFirewallDomainRedirectionAction(m_firewallDomainRedirectionAction));
  }
