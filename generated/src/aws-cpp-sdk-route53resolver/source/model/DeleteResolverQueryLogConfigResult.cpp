...
DeleteResolverQueryLogConfigResult::DeleteResolverQueryLogConfigResult()
{
}

DeleteResolverQueryLogConfigResult::DeleteResolverQueryLogConfigResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
