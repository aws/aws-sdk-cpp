...
CreateFirewallRuleEntry::CreateFirewallRuleEntry(JsonView jsonValue) { *this = jsonValue; }

CreateFirewallRuleEntry& CreateFirewallRuleEntry::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("FirewallDomainRedirectionAction")) {
    m_firewallDomainRedirectionAction = FirewallDomainRedirectionActionMapper::GetFirewallDomainRedirectionActionForName(
        jsonValue.GetString("FirewallDomainRedirectionAction"));
...
JsonValue CreateFirewallRuleEntry::Jsonize() const {
  JsonValue payload;
