...
CreateResolverQueryLogConfigResult::CreateResolverQueryLogConfigResult()
{
}

CreateResolverQueryLogConfigResult::CreateResolverQueryLogConfigResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
