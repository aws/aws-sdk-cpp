...
UpdateFirewallRuleEntry::UpdateFirewallRuleEntry(JsonView jsonValue) { *this = jsonValue; }

UpdateFirewallRuleEntry& UpdateFirewallRuleEntry::operator=(JsonView jsonValue) {
...
JsonValue UpdateFirewallRuleEntry::Jsonize() const {
  JsonValue payload;
