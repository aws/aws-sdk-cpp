...
ListFirewallDomainListsResult::ListFirewallDomainListsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListFirewallDomainListsResult& ListFirewallDomainListsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("FirewallDomainLists")) {
    ...
    for (unsigned firewallDomainListsIndex = 0; firewallDomainListsIndex < firewallDomainListsJsonList.GetLength();
         ++firewallDomainListsIndex) {
