...
ResolverQueryLogConfigAssociation::ResolverQueryLogConfigAssociation(JsonView jsonValue) { *this = jsonValue; }
...
ResolverQueryLogConfigAssociation& ResolverQueryLogConfigAssociation::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Status")) {
    m_status =
        ResolverQueryLogConfigAssociationStatusMapper::GetResolverQueryLogConfigAssociationStatusForName(jsonValue.GetString("Status"));
...
JsonValue ResolverQueryLogConfigAssociation::Jsonize() const {
  ...
  if (m_statusHasBeenSet) {
    payload.WithString("Status",
                       ResolverQueryLogConfigAssociationStatusMapper::GetNameForResolverQueryLogConfigAssociationStatus(m_status));
  }
