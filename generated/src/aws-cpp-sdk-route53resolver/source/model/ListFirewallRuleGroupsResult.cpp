...
ListFirewallRuleGroupsResult::ListFirewallRuleGroupsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListFirewallRuleGroupsResult& ListFirewallRuleGroupsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("FirewallRuleGroups")) {
    ...
    for (unsigned firewallRuleGroupsIndex = 0; firewallRuleGroupsIndex < firewallRuleGroupsJsonList.GetLength();
         ++firewallRuleGroupsIndex) {
