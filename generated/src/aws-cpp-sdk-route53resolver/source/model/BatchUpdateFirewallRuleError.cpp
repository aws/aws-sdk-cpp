...
BatchUpdateFirewallRuleError::BatchUpdateFirewallRuleError(JsonView jsonValue) { *this = jsonValue; }

BatchUpdateFirewallRuleError& BatchUpdateFirewallRuleError::operator=(JsonView jsonValue) {
...
JsonValue BatchUpdateFirewallRuleError::Jsonize() const {
  JsonValue payload;
