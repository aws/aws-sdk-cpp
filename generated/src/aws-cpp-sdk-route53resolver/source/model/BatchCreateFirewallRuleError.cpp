...
BatchCreateFirewallRuleError::BatchCreateFirewallRuleError(JsonView jsonValue) { *this = jsonValue; }

BatchCreateFirewallRuleError& BatchCreateFirewallRuleError::operator=(JsonView jsonValue) {
...
JsonValue BatchCreateFirewallRuleError::Jsonize() const {
  JsonValue payload;
