...
UpdateResolverConfigResult::UpdateResolverConfigResult()
{
}

UpdateResolverConfigResult::UpdateResolverConfigResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
