...
class InputConfiguration {
 public:
  ...
  template <typename S3UriT = Aws::String>
  InputConfiguration& WithS3Uri(S3UriT&& value) {
  ...
  void SetAssetProcessingConfiguration(AssetProcessingConfigurationT&& value) {
    m_assetProcessingConfigurationHasBeenSet = true;
    m_assetProcessingConfiguration = std::forward<AssetProcessingConfigurationT>(value);
  }
  template <typename AssetProcessingConfigurationT = AssetProcessingConfiguration>
  InputConfiguration& WithAssetProcessingConfiguration(AssetProcessingConfigurationT&& value) {
    SetAssetProcessingConfiguration(std::forward<AssetProcessingConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
