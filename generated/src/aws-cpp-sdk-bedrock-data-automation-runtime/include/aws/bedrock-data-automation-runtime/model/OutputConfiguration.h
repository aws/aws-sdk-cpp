...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKDATAAUTOMATIONRUNTIME_API OutputConfiguration();
    ...
    inline OutputConfiguration& WithS3Uri(const Aws::String& value) { SetS3Uri(value); return *this;}
    inline OutputConfiguration& WithS3Uri(Aws::String&& value) { SetS3Uri(std::move(value)); return *this;}
    inline OutputConfiguration& WithS3Uri(const char* value) { SetS3Uri(value); return *this;}
    ///@}
  private:
