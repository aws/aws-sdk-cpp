...
class TimestampSegment {
 public:
  ...
  inline TimestampSegment& WithStartTimeMillis(long long value) {
  ...
  inline void SetEndTimeMillis(long long value) {
    m_endTimeMillisHasBeenSet = true;
    m_endTimeMillis = value;
  }
  inline TimestampSegment& WithEndTimeMillis(long long value) {
    SetEndTimeMillis(value);
    return *this;
  }
  ///@}
 private:
