...
namespace MWAA
{
const size_t MWAAEndpointRules::RulesBlobStrLen = 3728;
const size_t MWAAEndpointRules::RulesBlobSize = 3729;
...
'/','/','a','i','r','f','l','o','w','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','i','r','f','l','o','w','.','{','R','e',
