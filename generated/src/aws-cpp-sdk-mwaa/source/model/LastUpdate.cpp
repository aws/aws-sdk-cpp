...
LastUpdate::LastUpdate(JsonView jsonValue) { *this = jsonValue; }
...
LastUpdate& LastUpdate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("WorkerReplacementStrategy")) {
    m_workerReplacementStrategy =
        WorkerReplacementStrategyMapper::GetWorkerReplacementStrategyForName(jsonValue.GetString("WorkerReplacementStrategy"));
