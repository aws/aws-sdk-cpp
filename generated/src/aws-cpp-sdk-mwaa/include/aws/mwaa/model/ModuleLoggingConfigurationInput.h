...
class ModuleLoggingConfigurationInput {
 public:
  ...
  inline ModuleLoggingConfigurationInput& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLogLevel(LoggingLevel value) {
    m_logLevelHasBeenSet = true;
    m_logLevel = value;
  }
  inline ModuleLoggingConfigurationInput& WithLogLevel(LoggingLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
