...
class Environment {
 public:
   ...
   * <p> <code>CREATING</code> - The request to create the environment is in
   * progress.</p> </li> <li> <p> <code>CREATING_SNAPSHOT</code> - The request to
   * update environment details, or upgrade the environment version, is in progress
   * and Amazon MWAA is creating a storage volume snapshot of the Amazon RDS database
   * cluster associated with the environment. A database snapshot is a backup created
   * at a specific point in time. Amazon MWAA uses snapshots to recover environment
   * metadata if the process to update or upgrade an environment fails.</p> </li>
   * <li> <p> <code>CREATE_FAILED</code> - The request to create the environment
   * failed and the environment was not created.</p> </li> <li> <p>
   * <code>AVAILABLE</code> - The request was successful and the environment is ready
   * to use.</p> </li> <li> <p> <code>PENDING</code> - The request was successful,
   * but the process to create the environment is paused until you create the
   * required VPC endpoints in your VPC. After you create the VPC endpoints, the
   * process resumes.</p> </li> <li> <p> <code>UPDATING</code> - The request to
   * update the environment is in progress.</p> </li> <li> <p>
   * <code>ROLLING_BACK</code> - The request to update environment details or upgrade
   * the environment version failed and Amazon MWAA is restoring the environment
   * using the latest storage volume snapshot.</p> </li> <li> <p>
   * <code>DELETING</code> - The request to delete the environment is in
   * progress.</p> </li> <li> <p> <code>DELETED</code> - The request to delete the
   * environment is complete, and the environment has been deleted.</p> </li> <li>
   * <p> <code>UNAVAILABLE</code> - The request failed, but the environment did not
   * return to its previous state and is not stable.</p> </li> <li> <p>
   * <code>UPDATE_FAILED</code> - The request to update the environment failed and
   * the environment was restored to its previous state successfully and is ready to
   * use.</p> </li> <li> <p> <code>MAINTENANCE</code> - The environment is undergoing
   * maintenance. Depending on the type of work Amazon MWAA is performing, your
   * environment might be unavailable during this process. Note that as part of the
   ...
   * <code>workerReplacementStrategy</code> </a>.</p> </li> </ul> <p>You can review
   * our troubleshooting guide for a list of common errors and their solutions. For
  ...
  inline Environment& WithStatus(EnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetWebserverUrl(WebserverUrlT&& value) {
    ...
    m_webserverUrl = std::forward<WebserverUrlT>(value);
  }
  template <typename WebserverUrlT = Aws::String>
  Environment& WithWebserverUrl(WebserverUrlT&& value) {
    SetWebserverUrl(std::forward<WebserverUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAirflowVersion(AirflowVersionT&& value) {
    ...
    m_airflowVersion = std::forward<AirflowVersionT>(value);
  }
  template <typename AirflowVersionT = Aws::String>
  Environment& WithAirflowVersion(AirflowVersionT&& value) {
    SetAirflowVersion(std::forward<AirflowVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceBucketArn(SourceBucketArnT&& value) {
    ...
    m_sourceBucketArn = std::forward<SourceBucketArnT>(value);
  }
  template <typename SourceBucketArnT = Aws::String>
  Environment& WithSourceBucketArn(SourceBucketArnT&& value) {
    SetSourceBucketArn(std::forward<SourceBucketArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDagS3Path(DagS3PathT&& value) {
    ...
    m_dagS3Path = std::forward<DagS3PathT>(value);
  }
  template <typename DagS3PathT = Aws::String>
  Environment& WithDagS3Path(DagS3PathT&& value) {
    SetDagS3Path(std::forward<DagS3PathT>(value));
    return *this;
  }
  ///@}
   ...
   * <code>s3://mwaa-environment/plugins.zip</code>. For more information, refer to
   * <a
  ...
  void SetPluginsS3Path(PluginsS3PathT&& value) {
    ...
    m_pluginsS3Path = std::forward<PluginsS3PathT>(value);
  }
  template <typename PluginsS3PathT = Aws::String>
  Environment& WithPluginsS3Path(PluginsS3PathT&& value) {
    SetPluginsS3Path(std::forward<PluginsS3PathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPluginsS3ObjectVersion(PluginsS3ObjectVersionT&& value) {
    ...
    m_pluginsS3ObjectVersion = std::forward<PluginsS3ObjectVersionT>(value);
  }
  template <typename PluginsS3ObjectVersionT = Aws::String>
  Environment& WithPluginsS3ObjectVersion(PluginsS3ObjectVersionT&& value) {
    SetPluginsS3ObjectVersion(std::forward<PluginsS3ObjectVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequirementsS3Path(RequirementsS3PathT&& value) {
    ...
    m_requirementsS3Path = std::forward<RequirementsS3PathT>(value);
  }
  template <typename RequirementsS3PathT = Aws::String>
  Environment& WithRequirementsS3Path(RequirementsS3PathT&& value) {
    SetRequirementsS3Path(std::forward<RequirementsS3PathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequirementsS3ObjectVersion(RequirementsS3ObjectVersionT&& value) {
    ...
    m_requirementsS3ObjectVersion = std::forward<RequirementsS3ObjectVersionT>(value);
  }
  template <typename RequirementsS3ObjectVersionT = Aws::String>
  Environment& WithRequirementsS3ObjectVersion(RequirementsS3ObjectVersionT&& value) {
    SetRequirementsS3ObjectVersion(std::forward<RequirementsS3ObjectVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartupScriptS3Path(StartupScriptS3PathT&& value) {
    ...
    m_startupScriptS3Path = std::forward<StartupScriptS3PathT>(value);
  }
  template <typename StartupScriptS3PathT = Aws::String>
  Environment& WithStartupScriptS3Path(StartupScriptS3PathT&& value) {
    SetStartupScriptS3Path(std::forward<StartupScriptS3PathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartupScriptS3ObjectVersion(StartupScriptS3ObjectVersionT&& value) {
    ...
    m_startupScriptS3ObjectVersion = std::forward<StartupScriptS3ObjectVersionT>(value);
  }
  template <typename StartupScriptS3ObjectVersionT = Aws::String>
  Environment& WithStartupScriptS3ObjectVersion(StartupScriptS3ObjectVersionT&& value) {
    SetStartupScriptS3ObjectVersion(std::forward<StartupScriptS3ObjectVersionT>(value));
    return *this;
  }
  ///@}
   ...
   * attached to your environment. For more information, refer to <a
  ...
  void SetAirflowConfigurationOptions(AirflowConfigurationOptionsT&& value) {
    ...
    m_airflowConfigurationOptions = std::forward<AirflowConfigurationOptionsT>(value);
  }
  template <typename AirflowConfigurationOptionsT = Aws::Map<Aws::String, Aws::String>>
  Environment& WithAirflowConfigurationOptions(AirflowConfigurationOptionsT&& value) {
    SetAirflowConfigurationOptions(std::forward<AirflowConfigurationOptionsT>(value));
    return *this;
  }
  ...
  Environment& AddAirflowConfigurationOptions(AirflowConfigurationOptionsKeyT&& key, AirflowConfigurationOptionsValueT&& value) {
    m_airflowConfigurationOptionsHasBeenSet = true;
    m_airflowConfigurationOptions.emplace(std::forward<AirflowConfigurationOptionsKeyT>(key),
                                          std::forward<AirflowConfigurationOptionsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnvironmentClass(EnvironmentClassT&& value) {
    ...
    m_environmentClass = std::forward<EnvironmentClassT>(value);
  }
  template <typename EnvironmentClassT = Aws::String>
  Environment& WithEnvironmentClass(EnvironmentClassT&& value) {
    SetEnvironmentClass(std::forward<EnvironmentClassT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxWorkers(int value) {
    m_maxWorkersHasBeenSet = true;
    m_maxWorkers = value;
  }
  inline Environment& WithMaxWorkers(int value) {
    SetMaxWorkers(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWebserverAccessMode(WebserverAccessMode value) {
    m_webserverAccessModeHasBeenSet = true;
    m_webserverAccessMode = value;
  }
  inline Environment& WithWebserverAccessMode(WebserverAccessMode value) {
    SetWebserverAccessMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinWorkers(int value) {
    m_minWorkersHasBeenSet = true;
    m_minWorkers = value;
  }
  inline Environment& WithMinWorkers(int value) {
    SetMinWorkers(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSchedulers(int value) {
    m_schedulersHasBeenSet = true;
    m_schedulers = value;
  }
  inline Environment& WithSchedulers(int value) {
    SetSchedulers(value);
    return *this;
  }
  ///@}
  ...
  void SetWebserverVpcEndpointService(WebserverVpcEndpointServiceT&& value) {
    ...
    m_webserverVpcEndpointService = std::forward<WebserverVpcEndpointServiceT>(value);
  }
  template <typename WebserverVpcEndpointServiceT = Aws::String>
  Environment& WithWebserverVpcEndpointService(WebserverVpcEndpointServiceT&& value) {
    SetWebserverVpcEndpointService(std::forward<WebserverVpcEndpointServiceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatabaseVpcEndpointService(DatabaseVpcEndpointServiceT&& value) {
    ...
    m_databaseVpcEndpointService = std::forward<DatabaseVpcEndpointServiceT>(value);
  }
  template <typename DatabaseVpcEndpointServiceT = Aws::String>
  Environment& WithDatabaseVpcEndpointService(DatabaseVpcEndpointServiceT&& value) {
    SetDatabaseVpcEndpointService(std::forward<DatabaseVpcEndpointServiceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCeleryExecutorQueue(CeleryExecutorQueueT&& value) {
    ...
    m_celeryExecutorQueue = std::forward<CeleryExecutorQueueT>(value);
  }
  template <typename CeleryExecutorQueueT = Aws::String>
  Environment& WithCeleryExecutorQueue(CeleryExecutorQueueT&& value) {
    SetCeleryExecutorQueue(std::forward<CeleryExecutorQueueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEndpointManagement(EndpointManagement value) {
    m_endpointManagementHasBeenSet = true;
    m_endpointManagement = value;
  }
  inline Environment& WithEndpointManagement(EndpointManagement value) {
    SetEndpointManagement(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinWebservers(int value) {
    m_minWebserversHasBeenSet = true;
    m_minWebservers = value;
  }
  inline Environment& WithMinWebservers(int value) {
    SetMinWebservers(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxWebservers(int value) {
    m_maxWebserversHasBeenSet = true;
    m_maxWebservers = value;
  }
  inline Environment& WithMaxWebservers(int value) {
    SetMaxWebservers(value);
    return *this;
  }
  ///@}
 private:
