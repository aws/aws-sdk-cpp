...
class CreateCliTokenResult {
 public:
  ...
  void SetCliToken(CliTokenT&& value) {
    m_cliTokenHasBeenSet = true;
    m_cliToken = std::forward<CliTokenT>(value);
  }
  template <typename CliTokenT = Aws::String>
  CreateCliTokenResult& WithCliToken(CliTokenT&& value) {
    SetCliToken(std::forward<CliTokenT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WebServerHostnameT = Aws::String>
  CreateCliTokenResult& WithWebServerHostname(WebServerHostnameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCliTokenResult& WithRequestId(RequestIdT&& value) {
