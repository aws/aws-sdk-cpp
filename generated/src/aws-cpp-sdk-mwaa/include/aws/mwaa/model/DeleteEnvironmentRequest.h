...
namespace Model
{
  ...
  public:
    ...
    inline DeleteEnvironmentRequest& WithName(const Aws::String& value) { SetName(value); return *this;}
    inline DeleteEnvironmentRequest& WithName(Aws::String&& value) { SetName(std::move(value)); return *this;}
    inline DeleteEnvironmentRequest& WithName(const char* value) { SetName(value); return *this;}
    ///@}
  private:
