...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public MWAARequest
  {
  public:
    AWS_MWAA_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The key-value tag pair you want to remove. For example, <code>"Environment":
     * "Staging"</code>. </p>
     */
