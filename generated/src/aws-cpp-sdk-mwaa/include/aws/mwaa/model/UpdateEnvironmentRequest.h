...
class UpdateEnvironmentRequest : public MWAARequest {
 public:
  ...
  UpdateEnvironmentRequest& AddAirflowConfigurationOptions(AirflowConfigurationOptionsKeyT&& key,
                                                           AirflowConfigurationOptionsValueT&& value) {
    m_airflowConfigurationOptionsHasBeenSet = true;
  ...
  inline UpdateEnvironmentRequest& WithMaxWorkers(int value) {
    SetMaxWorkers(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateEnvironmentRequest& WithMinWorkers(int value) {
    SetMinWorkers(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateEnvironmentRequest& WithMaxWebservers(int value) {
  ...
  inline UpdateEnvironmentRequest& WithMinWebservers(int value) {
  ...
  inline void SetWorkerReplacementStrategy(WorkerReplacementStrategy value) {
    m_workerReplacementStrategyHasBeenSet = true;
    m_workerReplacementStrategy = value;
  }
  inline UpdateEnvironmentRequest& WithWorkerReplacementStrategy(WorkerReplacementStrategy value) {
    SetWorkerReplacementStrategy(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateEnvironmentRequest& WithSchedulers(int value) {
    SetSchedulers(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateEnvironmentRequest& WithWebserverAccessMode(WebserverAccessMode value) {
