...
namespace Model
{
  ...
  {
  public:
    AWS_MWAA_API RestApiServerException();
    ...
    inline RestApiServerException& WithRestApiResponse(const Aws::Utils::Document& value) { SetRestApiResponse(value); return *this;}
    inline RestApiServerException& WithRestApiResponse(Aws::Utils::Document&& value) { SetRestApiResponse(std::move(value)); return *this;}
    ///@}
  private:
