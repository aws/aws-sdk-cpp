...
class LoggingConfigurationInput {
 public:
  ...
  void SetDagProcessingLogs(DagProcessingLogsT&& value) {
    ...
    m_dagProcessingLogs = std::forward<DagProcessingLogsT>(value);
  }
  template <typename DagProcessingLogsT = ModuleLoggingConfigurationInput>
  LoggingConfigurationInput& WithDagProcessingLogs(DagProcessingLogsT&& value) {
    SetDagProcessingLogs(std::forward<DagProcessingLogsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSchedulerLogs(SchedulerLogsT&& value) {
    ...
    m_schedulerLogs = std::forward<SchedulerLogsT>(value);
  }
  template <typename SchedulerLogsT = ModuleLoggingConfigurationInput>
  LoggingConfigurationInput& WithSchedulerLogs(SchedulerLogsT&& value) {
    SetSchedulerLogs(std::forward<SchedulerLogsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWebserverLogs(WebserverLogsT&& value) {
    ...
    m_webserverLogs = std::forward<WebserverLogsT>(value);
  }
  template <typename WebserverLogsT = ModuleLoggingConfigurationInput>
  LoggingConfigurationInput& WithWebserverLogs(WebserverLogsT&& value) {
    SetWebserverLogs(std::forward<WebserverLogsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorkerLogs(WorkerLogsT&& value) {
    ...
    m_workerLogs = std::forward<WorkerLogsT>(value);
  }
  template <typename WorkerLogsT = ModuleLoggingConfigurationInput>
  LoggingConfigurationInput& WithWorkerLogs(WorkerLogsT&& value) {
    SetWorkerLogs(std::forward<WorkerLogsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTaskLogs(TaskLogsT&& value) {
    ...
    m_taskLogs = std::forward<TaskLogsT>(value);
  }
  template <typename TaskLogsT = ModuleLoggingConfigurationInput>
  LoggingConfigurationInput& WithTaskLogs(TaskLogsT&& value) {
    SetTaskLogs(std::forward<TaskLogsT>(value));
    return *this;
  }
  ///@}
 private:
