...
class CreateEnvironmentRequest : public MWAARequest {
 public:
  ...
  CreateEnvironmentRequest& AddAirflowConfigurationOptions(AirflowConfigurationOptionsKeyT&& key,
  ...
  inline CreateEnvironmentRequest& WithMaxWorkers(int value) {
    SetMaxWorkers(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEnvironmentRequest& WithWebserverAccessMode(WebserverAccessMode value) {
  ...
  inline CreateEnvironmentRequest& WithMinWorkers(int value) {
    SetMinWorkers(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEnvironmentRequest& WithSchedulers(int value) {
    SetSchedulers(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEnvironmentRequest& WithEndpointManagement(EndpointManagement value) {
  ...
  inline CreateEnvironmentRequest& WithMinWebservers(int value) {
  ...
  inline CreateEnvironmentRequest& WithMaxWebservers(int value) {
