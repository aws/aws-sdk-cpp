...
namespace Model
{
  ...
  /**
   */
  class CreateCliTokenRequest : public MWAARequest
  {
  public:
    AWS_MWAA_API CreateCliTokenRequest() = default;
    ...
    template<typename NameT = Aws::String>
    CreateCliTokenRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
