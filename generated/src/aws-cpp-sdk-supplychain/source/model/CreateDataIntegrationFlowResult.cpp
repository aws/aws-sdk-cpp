...
CreateDataIntegrationFlowResult::CreateDataIntegrationFlowResult()
{
}

CreateDataIntegrationFlowResult::CreateDataIntegrationFlowResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
