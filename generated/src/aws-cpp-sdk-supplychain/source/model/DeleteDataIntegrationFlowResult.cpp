...
DeleteDataIntegrationFlowResult::DeleteDataIntegrationFlowResult()
{
}

DeleteDataIntegrationFlowResult::DeleteDataIntegrationFlowResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
