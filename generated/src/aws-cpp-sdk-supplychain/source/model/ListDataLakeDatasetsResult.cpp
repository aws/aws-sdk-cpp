...
ListDataLakeDatasetsResult::ListDataLakeDatasetsResult()
{
}

ListDataLakeDatasetsResult::ListDataLakeDatasetsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListDataLakeDatasetsResult& ListDataLakeDatasetsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
