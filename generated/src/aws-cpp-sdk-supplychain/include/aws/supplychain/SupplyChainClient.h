...
namespace SupplyChain
{
   ...
   */
  class AWS_SUPPLYCHAIN_API SupplyChainClient : Aws::Client::ClientWithAsyncTemplateMethods<SupplyChainClient>,
    smithy::client::AwsSmithyClientT<Aws::SupplyChain::SERVICE_NAME,
