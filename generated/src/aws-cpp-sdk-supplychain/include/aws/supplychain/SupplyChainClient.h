...
class AWS_SUPPLYCHAIN_API SupplyChainClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SupplyChainClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SupplyChainEndpointProviderBase> endpointProvider = nullptr,
      const Aws::SupplyChain::SupplyChainClientConfiguration& clientConfiguration = Aws::SupplyChain::SupplyChainClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateBillOfMaterialsImportJobOutcome CreateBillOfMaterialsImportJob(
      const Model::CreateBillOfMaterialsImportJobRequest& request) const;

  /**
   * A Callable wrapper for CreateBillOfMaterialsImportJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateBillOfMaterialsImportJobRequestT = Model::CreateBillOfMaterialsImportJobRequest>
  Model::CreateBillOfMaterialsImportJobOutcomeCallable CreateBillOfMaterialsImportJobCallable(
      const CreateBillOfMaterialsImportJobRequestT& request) const {
    return SubmitCallable(&SupplyChainClient::CreateBillOfMaterialsImportJob, request);
  }

  /**
   * An Async wrapper for CreateBillOfMaterialsImportJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateBillOfMaterialsImportJobRequestT = Model::CreateBillOfMaterialsImportJobRequest>
  void CreateBillOfMaterialsImportJobAsync(const CreateBillOfMaterialsImportJobRequestT& request,
                                           const CreateBillOfMaterialsImportJobResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateDataIntegrationFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateDataIntegrationFlowRequestT = Model::CreateDataIntegrationFlowRequest>
  Model::CreateDataIntegrationFlowOutcomeCallable CreateDataIntegrationFlowCallable(
      const CreateDataIntegrationFlowRequestT& request) const {
    return SubmitCallable(&SupplyChainClient::CreateDataIntegrationFlow, request);
  }

  /**
   * An Async wrapper for CreateDataIntegrationFlow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataIntegrationFlowRequestT = Model::CreateDataIntegrationFlowRequest>
  void CreateDataIntegrationFlowAsync(const CreateDataIntegrationFlowRequestT& request,
                                      const CreateDataIntegrationFlowResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataLakeDataset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataLakeDataset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataLakeDatasetRequestT = Model::CreateDataLakeDatasetRequest>
  void CreateDataLakeDatasetAsync(const CreateDataLakeDatasetRequestT& request, const CreateDataLakeDatasetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataLakeNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataLakeNamespace that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataLakeNamespaceRequestT = Model::CreateDataLakeNamespaceRequest>
  void CreateDataLakeNamespaceAsync(const CreateDataLakeNamespaceRequestT& request,
                                    const CreateDataLakeNamespaceResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateInstance that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateInstanceRequestT = Model::CreateInstanceRequest>
  void CreateInstanceAsync(const CreateInstanceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const CreateInstanceRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteDataIntegrationFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteDataIntegrationFlowRequestT = Model::DeleteDataIntegrationFlowRequest>
  Model::DeleteDataIntegrationFlowOutcomeCallable DeleteDataIntegrationFlowCallable(
      const DeleteDataIntegrationFlowRequestT& request) const {
    return SubmitCallable(&SupplyChainClient::DeleteDataIntegrationFlow, request);
  }

  /**
   * An Async wrapper for DeleteDataIntegrationFlow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDataIntegrationFlowRequestT = Model::DeleteDataIntegrationFlowRequest>
  void DeleteDataIntegrationFlowAsync(const DeleteDataIntegrationFlowRequestT& request,
                                      const DeleteDataIntegrationFlowResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDataLakeDataset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDataLakeDataset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDataLakeDatasetRequestT = Model::DeleteDataLakeDatasetRequest>
  void DeleteDataLakeDatasetAsync(const DeleteDataLakeDatasetRequestT& request, const DeleteDataLakeDatasetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDataLakeNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDataLakeNamespace that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDataLakeNamespaceRequestT = Model::DeleteDataLakeNamespaceRequest>
  void DeleteDataLakeNamespaceAsync(const DeleteDataLakeNamespaceRequestT& request,
                                    const DeleteDataLakeNamespaceResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteInstance that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteInstanceRequestT = Model::DeleteInstanceRequest>
  void DeleteInstanceAsync(const DeleteInstanceRequestT& request, const DeleteInstanceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBillOfMaterialsImportJobOutcome GetBillOfMaterialsImportJob(
      const Model::GetBillOfMaterialsImportJobRequest& request) const;

  /**
   * A Callable wrapper for GetBillOfMaterialsImportJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetBillOfMaterialsImportJobRequestT = Model::GetBillOfMaterialsImportJobRequest>
  Model::GetBillOfMaterialsImportJobOutcomeCallable GetBillOfMaterialsImportJobCallable(
      const GetBillOfMaterialsImportJobRequestT& request) const {
    return SubmitCallable(&SupplyChainClient::GetBillOfMaterialsImportJob, request);
  }

  /**
   * An Async wrapper for GetBillOfMaterialsImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBillOfMaterialsImportJobRequestT = Model::GetBillOfMaterialsImportJobRequest>
  void GetBillOfMaterialsImportJobAsync(const GetBillOfMaterialsImportJobRequestT& request,
                                        const GetBillOfMaterialsImportJobResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataIntegrationEvent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataIntegrationEvent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDataIntegrationEventRequestT = Model::GetDataIntegrationEventRequest>
  void GetDataIntegrationEventAsync(const GetDataIntegrationEventRequestT& request,
                                    const GetDataIntegrationEventResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataIntegrationFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataIntegrationFlow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDataIntegrationFlowRequestT = Model::GetDataIntegrationFlowRequest>
  void GetDataIntegrationFlowAsync(const GetDataIntegrationFlowRequestT& request,
                                   const GetDataIntegrationFlowResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDataIntegrationFlowExecutionOutcome GetDataIntegrationFlowExecution(
      const Model::GetDataIntegrationFlowExecutionRequest& request) const;

  /**
   * A Callable wrapper for GetDataIntegrationFlowExecution that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDataIntegrationFlowExecutionRequestT = Model::GetDataIntegrationFlowExecutionRequest>
  Model::GetDataIntegrationFlowExecutionOutcomeCallable GetDataIntegrationFlowExecutionCallable(
      const GetDataIntegrationFlowExecutionRequestT& request) const {
    return SubmitCallable(&SupplyChainClient::GetDataIntegrationFlowExecution, request);
  }

  /**
   * An Async wrapper for GetDataIntegrationFlowExecution that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetDataIntegrationFlowExecutionRequestT = Model::GetDataIntegrationFlowExecutionRequest>
  void GetDataIntegrationFlowExecutionAsync(const GetDataIntegrationFlowExecutionRequestT& request,
                                            const GetDataIntegrationFlowExecutionResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataLakeDataset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataLakeDataset that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDataLakeDatasetRequestT = Model::GetDataLakeDatasetRequest>
  void GetDataLakeDatasetAsync(const GetDataLakeDatasetRequestT& request, const GetDataLakeDatasetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataLakeNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataLakeNamespace that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDataLakeNamespaceRequestT = Model::GetDataLakeNamespaceRequest>
  void GetDataLakeNamespaceAsync(const GetDataLakeNamespaceRequestT& request, const GetDataLakeNamespaceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetInstance that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetInstanceRequestT = Model::GetInstanceRequest>
  void GetInstanceAsync(const GetInstanceRequestT& request, const GetInstanceResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDataIntegrationEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListDataIntegrationEventsRequestT = Model::ListDataIntegrationEventsRequest>
  Model::ListDataIntegrationEventsOutcomeCallable ListDataIntegrationEventsCallable(
      const ListDataIntegrationEventsRequestT& request) const {
    return SubmitCallable(&SupplyChainClient::ListDataIntegrationEvents, request);
  }

  /**
   * An Async wrapper for ListDataIntegrationEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataIntegrationEventsRequestT = Model::ListDataIntegrationEventsRequest>
  void ListDataIntegrationEventsAsync(const ListDataIntegrationEventsRequestT& request,
                                      const ListDataIntegrationEventsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDataIntegrationFlowExecutionsOutcome ListDataIntegrationFlowExecutions(
      const Model::ListDataIntegrationFlowExecutionsRequest& request) const;

  /**
   * A Callable wrapper for ListDataIntegrationFlowExecutions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListDataIntegrationFlowExecutionsRequestT = Model::ListDataIntegrationFlowExecutionsRequest>
  Model::ListDataIntegrationFlowExecutionsOutcomeCallable ListDataIntegrationFlowExecutionsCallable(
      const ListDataIntegrationFlowExecutionsRequestT& request) const {
    return SubmitCallable(&SupplyChainClient::ListDataIntegrationFlowExecutions, request);
  }

  /**
   * An Async wrapper for ListDataIntegrationFlowExecutions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListDataIntegrationFlowExecutionsRequestT = Model::ListDataIntegrationFlowExecutionsRequest>
  void ListDataIntegrationFlowExecutionsAsync(const ListDataIntegrationFlowExecutionsRequestT& request,
                                              const ListDataIntegrationFlowExecutionsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDataIntegrationFlows that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataIntegrationFlows that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataIntegrationFlowsRequestT = Model::ListDataIntegrationFlowsRequest>
  void ListDataIntegrationFlowsAsync(const ListDataIntegrationFlowsRequestT& request,
                                     const ListDataIntegrationFlowsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDataLakeDatasets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataLakeDatasets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataLakeDatasetsRequestT = Model::ListDataLakeDatasetsRequest>
  void ListDataLakeDatasetsAsync(const ListDataLakeDatasetsRequestT& request, const ListDataLakeDatasetsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDataLakeNamespaces that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataLakeNamespaces that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataLakeNamespacesRequestT = Model::ListDataLakeNamespacesRequest>
  void ListDataLakeNamespacesAsync(const ListDataLakeNamespacesRequestT& request,
                                   const ListDataLakeNamespacesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListInstances that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListInstancesRequestT = Model::ListInstancesRequest>
  void ListInstancesAsync(const ListInstancesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListInstancesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for SendDataIntegrationEvent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendDataIntegrationEvent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendDataIntegrationEventRequestT = Model::SendDataIntegrationEventRequest>
  void SendDataIntegrationEventAsync(const SendDataIntegrationEventRequestT& request,
                                     const SendDataIntegrationEventResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDataIntegrationFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateDataIntegrationFlowRequestT = Model::UpdateDataIntegrationFlowRequest>
  Model::UpdateDataIntegrationFlowOutcomeCallable UpdateDataIntegrationFlowCallable(
      const UpdateDataIntegrationFlowRequestT& request) const {
    return SubmitCallable(&SupplyChainClient::UpdateDataIntegrationFlow, request);
  }

  /**
   * An Async wrapper for UpdateDataIntegrationFlow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDataIntegrationFlowRequestT = Model::UpdateDataIntegrationFlowRequest>
  void UpdateDataIntegrationFlowAsync(const UpdateDataIntegrationFlowRequestT& request,
                                      const UpdateDataIntegrationFlowResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDataLakeDataset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDataLakeDataset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDataLakeDatasetRequestT = Model::UpdateDataLakeDatasetRequest>
  void UpdateDataLakeDatasetAsync(const UpdateDataLakeDatasetRequestT& request, const UpdateDataLakeDatasetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDataLakeNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDataLakeNamespace that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDataLakeNamespaceRequestT = Model::UpdateDataLakeNamespaceRequest>
  void UpdateDataLakeNamespaceAsync(const UpdateDataLakeNamespaceRequestT& request,
                                    const UpdateDataLakeNamespaceResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateInstance that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateInstanceRequestT = Model::UpdateInstanceRequest>
  void UpdateInstanceAsync(const UpdateInstanceRequestT& request, const UpdateInstanceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
