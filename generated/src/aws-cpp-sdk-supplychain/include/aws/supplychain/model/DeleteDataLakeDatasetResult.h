...
class DeleteDataLakeDatasetResult {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DeleteDataLakeDatasetResult& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  DeleteDataLakeDatasetResult& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteDataLakeDatasetResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDataLakeDatasetResult& WithRequestId(RequestIdT&& value) {
