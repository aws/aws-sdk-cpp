...
namespace Model
{
  ...
  {
  public:
    AWS_SUPPLYCHAIN_API DeleteDataLakeDatasetResult() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DeleteDataLakeDatasetResult& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NamespaceT = Aws::String>
    DeleteDataLakeDatasetResult& WithNamespace(NamespaceT&& value) { SetNamespace(std::forward<NamespaceT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DeleteDataLakeDatasetResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDataLakeDatasetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
