...
class DataIntegrationFlowExecution {
 public:
  ...
  inline void SetStatus(DataIntegrationFlowExecutionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DataIntegrationFlowExecution& WithStatus(DataIntegrationFlowExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceInfo(SourceInfoT&& value) {
    ...
    m_sourceInfo = std::forward<SourceInfoT>(value);
  }
  template <typename SourceInfoT = DataIntegrationFlowExecutionSourceInfo>
  DataIntegrationFlowExecution& WithSourceInfo(SourceInfoT&& value) {
    SetSourceInfo(std::forward<SourceInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputMetadata(OutputMetadataT&& value) {
    ...
    m_outputMetadata = std::forward<OutputMetadataT>(value);
  }
  template <typename OutputMetadataT = DataIntegrationFlowExecutionOutputMetadata>
  DataIntegrationFlowExecution& WithOutputMetadata(OutputMetadataT&& value) {
    SetOutputMetadata(std::forward<OutputMetadataT>(value));
    return *this;
  }
  ///@}
 private:
