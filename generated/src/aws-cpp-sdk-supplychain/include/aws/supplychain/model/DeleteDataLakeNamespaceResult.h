...
class DeleteDataLakeNamespaceResult {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DeleteDataLakeNamespaceResult& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteDataLakeNamespaceResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDataLakeNamespaceResult& WithRequestId(RequestIdT&& value) {
