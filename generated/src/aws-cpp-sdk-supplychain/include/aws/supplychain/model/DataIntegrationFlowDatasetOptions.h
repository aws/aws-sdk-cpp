...
class DataIntegrationFlowDatasetOptions {
 public:
  ...
  inline void SetLoadType(DataIntegrationFlowLoadType value) {
    m_loadTypeHasBeenSet = true;
    m_loadType = value;
  }
  inline DataIntegrationFlowDatasetOptions& WithLoadType(DataIntegrationFlowLoadType value) {
    SetLoadType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDedupeRecords(bool value) {
    m_dedupeRecordsHasBeenSet = true;
    m_dedupeRecords = value;
  }
  inline DataIntegrationFlowDatasetOptions& WithDedupeRecords(bool value) {
    SetDedupeRecords(value);
    return *this;
  }
  ///@}
  ...
  void SetDedupeStrategy(DedupeStrategyT&& value) {
    ...
    m_dedupeStrategy = std::forward<DedupeStrategyT>(value);
  }
  template <typename DedupeStrategyT = DataIntegrationFlowDedupeStrategy>
  DataIntegrationFlowDatasetOptions& WithDedupeStrategy(DedupeStrategyT&& value) {
    SetDedupeStrategy(std::forward<DedupeStrategyT>(value));
    return *this;
  }
  ///@}
 private:
