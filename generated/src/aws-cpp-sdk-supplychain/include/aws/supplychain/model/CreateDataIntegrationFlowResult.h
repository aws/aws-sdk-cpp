...
class CreateDataIntegrationFlowResult {
 public:
  AWS_SUPPLYCHAIN_API CreateDataIntegrationFlowResult() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  CreateDataIntegrationFlowResult& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateDataIntegrationFlowResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDataIntegrationFlowResult& WithRequestId(RequestIdT&& value) {
