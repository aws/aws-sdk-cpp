...
class DataIntegrationFlowDatasetSourceConfiguration {
 public:
  ...
  template <typename DatasetIdentifierT = Aws::String>
  DataIntegrationFlowDatasetSourceConfiguration& WithDatasetIdentifier(DatasetIdentifierT&& value) {
  ...
  template <typename OptionsT = DataIntegrationFlowDatasetOptions>
  DataIntegrationFlowDatasetSourceConfiguration& WithOptions(OptionsT&& value) {
