...
/**
 * <p>The request parameters for CreateDataLakeNamespace.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/supplychain-2024-01-01/CreateDataLakeNamespaceRequest">AWS
 * API Reference</a></p>
 */
class CreateDataLakeNamespaceRequest : public SupplyChainRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "CreateDataLakeNamespace"; }
  ...
  ///@{
  /**
   * <p>The name of the namespace. Noted you cannot create namespace with name
