...
class CreateInstanceRequest : public SupplyChainRequest {
 public:
  ...
  template <typename InstanceNameT = Aws::String>
  CreateInstanceRequest& WithInstanceName(InstanceNameT&& value) {
  ...
  template <typename InstanceDescriptionT = Aws::String>
  CreateInstanceRequest& WithInstanceDescription(InstanceDescriptionT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  CreateInstanceRequest& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  template <typename WebAppDnsDomainT = Aws::String>
  CreateInstanceRequest& WithWebAppDnsDomain(WebAppDnsDomainT&& value) {
