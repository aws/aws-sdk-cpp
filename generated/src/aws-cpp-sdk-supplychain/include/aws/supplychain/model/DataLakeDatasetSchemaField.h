...
class DataLakeDatasetSchemaField {
 public:
  ...
  inline void SetType(DataLakeDatasetSchemaFieldType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DataLakeDatasetSchemaField& WithType(DataLakeDatasetSchemaFieldType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline DataLakeDatasetSchemaField& WithIsRequired(bool value) {
    SetIsRequired(value);
    return *this;
  }
  ///@}
