...
class DataIntegrationEventDatasetTargetDetails {
 public:
  ...
  inline void SetOperationType(DataIntegrationEventDatasetOperationType value) {
    m_operationTypeHasBeenSet = true;
    m_operationType = value;
  }
  inline DataIntegrationEventDatasetTargetDetails& WithOperationType(DataIntegrationEventDatasetOperationType value) {
  ...
  void SetDatasetLoadExecution(DatasetLoadExecutionT&& value) {
    m_datasetLoadExecutionHasBeenSet = true;
    m_datasetLoadExecution = std::forward<DatasetLoadExecutionT>(value);
  }
  template <typename DatasetLoadExecutionT = DataIntegrationEventDatasetLoadExecutionDetails>
  DataIntegrationEventDatasetTargetDetails& WithDatasetLoadExecution(DatasetLoadExecutionT&& value) {
    SetDatasetLoadExecution(std::forward<DatasetLoadExecutionT>(value));
    return *this;
  }
  ///@}
 private:
