...
class Instance {
 public:
  ...
  inline void SetState(InstanceState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline Instance& WithState(InstanceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetWebAppDnsDomain(WebAppDnsDomainT&& value) {
    ...
    m_webAppDnsDomain = std::forward<WebAppDnsDomainT>(value);
  }
  template <typename WebAppDnsDomainT = Aws::String>
  Instance& WithWebAppDnsDomain(WebAppDnsDomainT&& value) {
    SetWebAppDnsDomain(std::forward<WebAppDnsDomainT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVersionNumber(double value) {
    m_versionNumberHasBeenSet = true;
    m_versionNumber = value;
  }
  inline Instance& WithVersionNumber(double value) {
