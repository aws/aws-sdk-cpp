...
class GetDataLakeDatasetRequest : public SupplyChainRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  GetDataLakeDatasetRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  GetDataLakeDatasetRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetDataLakeDatasetRequest& WithName(NameT&& value) {
