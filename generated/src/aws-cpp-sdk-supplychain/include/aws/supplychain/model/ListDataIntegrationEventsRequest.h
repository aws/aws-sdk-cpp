...
class ListDataIntegrationEventsRequest : public SupplyChainRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListDataIntegrationEventsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline ListDataIntegrationEventsRequest& WithEventType(DataIntegrationEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataIntegrationEventsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDataIntegrationEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
