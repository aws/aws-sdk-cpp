...
namespace Model
{
  ...
  {
  public:
    AWS_SUPPLYCHAIN_API DeleteDataLakeDatasetRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DeleteDataLakeDatasetRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NamespaceT = Aws::String>
    DeleteDataLakeDatasetRequest& WithNamespace(NamespaceT&& value) { SetNamespace(std::forward<NamespaceT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DeleteDataLakeDatasetRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
