...
class DeleteDataLakeDatasetRequest : public SupplyChainRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DeleteDataLakeDatasetRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  DeleteDataLakeDatasetRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteDataLakeDatasetRequest& WithName(NameT&& value) {
