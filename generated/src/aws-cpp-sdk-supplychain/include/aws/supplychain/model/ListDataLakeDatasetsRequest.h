...
class ListDataLakeDatasetsRequest : public SupplyChainRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListDataLakeDatasetsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  ListDataLakeDatasetsRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDataLakeDatasetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDataLakeDatasetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
