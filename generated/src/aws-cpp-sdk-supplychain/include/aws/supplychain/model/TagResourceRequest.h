...
namespace Model
{
  ...
  /**
   * <p>The request parameters of TagResource.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/supplychain-2024-01-01/TagResourceRequest">AWS
   * API Reference</a></p>
   */
  class TagResourceRequest : public SupplyChainRequest
  {
  public:
    AWS_SUPPLYCHAIN_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Web Services Supply chain resource ARN that needs to be
     * tagged.</p>
     */
