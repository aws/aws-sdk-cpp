...
class DataIntegrationFlowExecutionOutputMetadata {
 public:
  ...
  void SetDiagnosticReportsRootS3URI(DiagnosticReportsRootS3URIT&& value) {
    m_diagnosticReportsRootS3URIHasBeenSet = true;
    m_diagnosticReportsRootS3URI = std::forward<DiagnosticReportsRootS3URIT>(value);
  }
  template <typename DiagnosticReportsRootS3URIT = Aws::String>
  DataIntegrationFlowExecutionOutputMetadata& WithDiagnosticReportsRootS3URI(DiagnosticReportsRootS3URIT&& value) {
    SetDiagnosticReportsRootS3URI(std::forward<DiagnosticReportsRootS3URIT>(value));
    return *this;
  }
  ///@}
 private:
