...
class ListDataLakeDatasetsResult {
 public:
  ...
  template <typename DatasetsT = Aws::Vector<DataLakeDataset>>
  ListDataLakeDatasetsResult& WithDatasets(DatasetsT&& value) {
    SetDatasets(std::forward<DatasetsT>(value));
    return *this;
  }
  template <typename DatasetsT = DataLakeDataset>
  ListDataLakeDatasetsResult& AddDatasets(DatasetsT&& value) {
    m_datasetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataLakeDatasetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataLakeDatasetsResult& WithRequestId(RequestIdT&& value) {
