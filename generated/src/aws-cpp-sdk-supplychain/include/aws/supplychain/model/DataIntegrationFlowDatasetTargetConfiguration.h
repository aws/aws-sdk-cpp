...
class DataIntegrationFlowDatasetTargetConfiguration {
 public:
  ...
  template <typename DatasetIdentifierT = Aws::String>
  DataIntegrationFlowDatasetTargetConfiguration& WithDatasetIdentifier(DatasetIdentifierT&& value) {
  ...
  template <typename OptionsT = DataIntegrationFlowDatasetOptions>
  DataIntegrationFlowDatasetTargetConfiguration& WithOptions(OptionsT&& value) {
