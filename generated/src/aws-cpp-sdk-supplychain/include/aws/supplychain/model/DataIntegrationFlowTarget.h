...
class DataIntegrationFlowTarget {
 public:
  ...
  inline void SetTargetType(DataIntegrationFlowTargetType value) {
    m_targetTypeHasBeenSet = true;
    m_targetType = value;
  }
  inline DataIntegrationFlowTarget& WithTargetType(DataIntegrationFlowTargetType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
  ...
  void SetS3Target(S3TargetT&& value) {
    ...
    m_s3Target = std::forward<S3TargetT>(value);
  }
  template <typename S3TargetT = DataIntegrationFlowS3TargetConfiguration>
  DataIntegrationFlowTarget& WithS3Target(S3TargetT&& value) {
    SetS3Target(std::forward<S3TargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatasetTarget(DatasetTargetT&& value) {
    ...
    m_datasetTarget = std::forward<DatasetTargetT>(value);
  }
  template <typename DatasetTargetT = DataIntegrationFlowDatasetTargetConfiguration>
  DataIntegrationFlowTarget& WithDatasetTarget(DatasetTargetT&& value) {
    SetDatasetTarget(std::forward<DatasetTargetT>(value));
    return *this;
  }
  ///@}
 private:
