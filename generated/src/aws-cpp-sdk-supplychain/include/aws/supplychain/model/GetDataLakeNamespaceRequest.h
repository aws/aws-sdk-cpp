...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    GetDataLakeNamespaceRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    GetDataLakeNamespaceRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
