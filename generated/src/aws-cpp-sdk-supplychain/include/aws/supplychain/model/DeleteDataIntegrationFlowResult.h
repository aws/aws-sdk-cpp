...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    DeleteDataIntegrationFlowResult& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DeleteDataIntegrationFlowResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDataIntegrationFlowResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
