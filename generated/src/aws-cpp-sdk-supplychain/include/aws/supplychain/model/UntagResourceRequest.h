...
namespace Model
{
  ...
  /**
   * <p>The request parameters of UntagResource.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/supplychain-2024-01-01/UntagResourceRequest">AWS
   * API Reference</a></p>
   */
  class UntagResourceRequest : public SupplyChainRequest
  {
  public:
    AWS_SUPPLYCHAIN_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The list of tag keys to be deleted for an Amazon Web Services Supply Chain
     * resource.</p>
     */
