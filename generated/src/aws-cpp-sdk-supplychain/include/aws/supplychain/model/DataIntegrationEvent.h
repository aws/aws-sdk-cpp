...
class DataIntegrationEvent {
 public:
  ...
  inline void SetEventType(DataIntegrationEventType value) {
    m_eventTypeHasBeenSet = true;
    m_eventType = value;
  }
  inline DataIntegrationEvent& WithEventType(DataIntegrationEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  void SetDatasetTargetDetails(DatasetTargetDetailsT&& value) {
    ...
    m_datasetTargetDetails = std::forward<DatasetTargetDetailsT>(value);
  }
  template <typename DatasetTargetDetailsT = DataIntegrationEventDatasetTargetDetails>
  DataIntegrationEvent& WithDatasetTargetDetails(DatasetTargetDetailsT&& value) {
    SetDatasetTargetDetails(std::forward<DatasetTargetDetailsT>(value));
    return *this;
  }
  ///@}
 private:
