...
class ListDataIntegrationFlowExecutionsResult {
 public:
  ...
  AWS_SUPPLYCHAIN_API ListDataIntegrationFlowExecutionsResult& operator=(
  ...
  void SetFlowExecutions(FlowExecutionsT&& value) {
    m_flowExecutionsHasBeenSet = true;
    m_flowExecutions = std::forward<FlowExecutionsT>(value);
  }
  template <typename FlowExecutionsT = Aws::Vector<DataIntegrationFlowExecution>>
  ListDataIntegrationFlowExecutionsResult& WithFlowExecutions(FlowExecutionsT&& value) {
    SetFlowExecutions(std::forward<FlowExecutionsT>(value));
    return *this;
  }
  template <typename FlowExecutionsT = DataIntegrationFlowExecution>
  ListDataIntegrationFlowExecutionsResult& AddFlowExecutions(FlowExecutionsT&& value) {
    m_flowExecutionsHasBeenSet = true;
    m_flowExecutions.emplace_back(std::forward<FlowExecutionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataIntegrationFlowExecutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataIntegrationFlowExecutionsResult& WithRequestId(RequestIdT&& value) {
