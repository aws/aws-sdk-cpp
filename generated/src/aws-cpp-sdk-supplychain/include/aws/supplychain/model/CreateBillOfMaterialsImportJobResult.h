...
class CreateBillOfMaterialsImportJobResult {
 public:
  AWS_SUPPLYCHAIN_API CreateBillOfMaterialsImportJobResult() = default;
  ...
  AWS_SUPPLYCHAIN_API CreateBillOfMaterialsImportJobResult& operator=(
  ...
  template <typename JobIdT = Aws::String>
  CreateBillOfMaterialsImportJobResult& WithJobId(JobIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateBillOfMaterialsImportJobResult& WithRequestId(RequestIdT&& value) {
