...
class DataIntegrationFlowFieldPriorityDedupeField {
 public:
  ...
  template <typename NameT = Aws::String>
  DataIntegrationFlowFieldPriorityDedupeField& WithName(NameT&& value) {
  ...
  inline void SetSortOrder(DataIntegrationFlowFieldPriorityDedupeSortOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline DataIntegrationFlowFieldPriorityDedupeField& WithSortOrder(DataIntegrationFlowFieldPriorityDedupeSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
