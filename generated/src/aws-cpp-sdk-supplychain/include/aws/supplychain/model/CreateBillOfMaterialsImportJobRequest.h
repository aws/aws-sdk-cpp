...
class CreateBillOfMaterialsImportJobRequest : public SupplyChainRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  CreateBillOfMaterialsImportJobRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename S3uriT = Aws::String>
  CreateBillOfMaterialsImportJobRequest& WithS3uri(S3uriT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateBillOfMaterialsImportJobRequest& WithClientToken(ClientTokenT&& value) {
