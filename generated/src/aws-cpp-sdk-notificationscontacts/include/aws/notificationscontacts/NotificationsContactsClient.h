...
class AWS_NOTIFICATIONSCONTACTS_API NotificationsContactsClient
 ...
 public:
   ...
   */
  NotificationsContactsClient(const Aws::NotificationsContacts::NotificationsContactsClientConfiguration& clientConfiguration =
  ...
  NotificationsContactsClient(const Aws::Auth::AWSCredentials& credentials,
                              std::shared_ptr<NotificationsContactsEndpointProviderBase> endpointProvider = nullptr,
                              const Aws::NotificationsContacts::NotificationsContactsClientConfiguration& clientConfiguration =
                                  Aws::NotificationsContacts::NotificationsContactsClientConfiguration());
  ...
  /**
   * A Callable wrapper for ActivateEmailContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ActivateEmailContact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ActivateEmailContactRequestT = Model::ActivateEmailContactRequest>
  void ActivateEmailContactAsync(const ActivateEmailContactRequestT& request, const ActivateEmailContactResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateEmailContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEmailContact that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateEmailContactRequestT = Model::CreateEmailContactRequest>
  void CreateEmailContactAsync(const CreateEmailContactRequestT& request, const CreateEmailContactResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEmailContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEmailContact that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteEmailContactRequestT = Model::DeleteEmailContactRequest>
  void DeleteEmailContactAsync(const DeleteEmailContactRequestT& request, const DeleteEmailContactResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetEmailContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetEmailContactRequestT = Model::GetEmailContactRequest>
  void GetEmailContactAsync(const GetEmailContactRequestT& request, const GetEmailContactResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEmailContacts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEmailContacts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEmailContactsRequestT = Model::ListEmailContactsRequest>
  void ListEmailContactsAsync(const ListEmailContactsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListEmailContactsRequestT& request = {}) const {
