...
namespace NotificationsContacts
{
   ...
   */
  class AWS_NOTIFICATIONSCONTACTS_API NotificationsContactsClient : Aws::Client::ClientWithAsyncTemplateMethods<NotificationsContactsClient>,
    smithy::client::AwsSmithyClientT<Aws::NotificationsContacts::SERVICE_NAME,
