...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/notificationscontacts-2018-05-10/ConflictException">AWS
   * API Reference</a></p>
   */
  class ConflictException
  {
  public:
    AWS_NOTIFICATIONSCONTACTS_API ConflictException() = default;
    AWS_NOTIFICATIONSCONTACTS_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_NOTIFICATIONSCONTACTS_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
