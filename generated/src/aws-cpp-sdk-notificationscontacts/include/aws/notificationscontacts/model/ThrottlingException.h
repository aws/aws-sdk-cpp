 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/notificationscontacts-2018-05-10/ThrottlingException">AWS
 * API Reference</a></p>
 */
class ThrottlingException {
 public:
  AWS_NOTIFICATIONSCONTACTS_API ThrottlingException() = default;
  AWS_NOTIFICATIONSCONTACTS_API ThrottlingException(Aws::Utils::Json::JsonView jsonValue);
  AWS_NOTIFICATIONSCONTACTS_API ThrottlingException& operator=(Aws::Utils::Json::JsonView jsonValue);
