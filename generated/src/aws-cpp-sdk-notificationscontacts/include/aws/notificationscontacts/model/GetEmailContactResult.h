...
class GetEmailContactResult {
 public:
  ...
  void SetEmailContact(EmailContactT&& value) {
    m_emailContactHasBeenSet = true;
    m_emailContact = std::forward<EmailContactT>(value);
  }
  template <typename EmailContactT = EmailContact>
  GetEmailContactResult& WithEmailContact(EmailContactT&& value) {
    SetEmailContact(std::forward<EmailContactT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetEmailContactResult& WithRequestId(RequestIdT&& value) {
