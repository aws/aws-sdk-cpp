...
class ListEmailContactsRequest : public NotificationsContactsRequest {
 public:
  AWS_NOTIFICATIONSCONTACTS_API ListEmailContactsRequest() = default;
  ...
  inline ListEmailContactsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEmailContactsRequest& WithNextToken(NextTokenT&& value) {
