...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/notificationscontacts-2018-05-10/ValidationException">AWS
   * API Reference</a></p>
   */
  class ValidationException
  {
  public:
    AWS_NOTIFICATIONSCONTACTS_API ValidationException() = default;
    AWS_NOTIFICATIONSCONTACTS_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
    AWS_NOTIFICATIONSCONTACTS_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
