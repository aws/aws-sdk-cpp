...
namespace Model
{
  ...
  {
  public:
    AWS_NOTIFICATIONSCONTACTS_API ListTagsForResourceResult() = default;
    AWS_NOTIFICATIONSCONTACTS_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_NOTIFICATIONSCONTACTS_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
