...
class EmailContact {
 public:
  ...
  template <typename ArnT = Aws::String>
  EmailContact& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  EmailContact& WithName(NameT&& value) {
  ...
  inline void SetStatus(EmailContactStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline EmailContact& WithStatus(EmailContactStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
