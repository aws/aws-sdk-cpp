...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/notificationscontacts-2018-05-10/ValidationExceptionField">AWS
   * API Reference</a></p>
   */
  class ValidationExceptionField
  {
  public:
    AWS_NOTIFICATIONSCONTACTS_API ValidationExceptionField() = default;
    AWS_NOTIFICATIONSCONTACTS_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_NOTIFICATIONSCONTACTS_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
