...
class ListEmailContactsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListEmailContactsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetEmailContacts(EmailContactsT&& value) {
    m_emailContactsHasBeenSet = true;
    m_emailContacts = std::forward<EmailContactsT>(value);
  }
  template <typename EmailContactsT = Aws::Vector<EmailContact>>
  ListEmailContactsResult& WithEmailContacts(EmailContactsT&& value) {
    SetEmailContacts(std::forward<EmailContactsT>(value));
    return *this;
  }
  template <typename EmailContactsT = EmailContact>
  ListEmailContactsResult& AddEmailContacts(EmailContactsT&& value) {
    m_emailContactsHasBeenSet = true;
    m_emailContacts.emplace_back(std::forward<EmailContactsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListEmailContactsResult& WithRequestId(RequestIdT&& value) {
