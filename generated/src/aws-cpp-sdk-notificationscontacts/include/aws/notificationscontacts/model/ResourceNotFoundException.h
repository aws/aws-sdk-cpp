...
namespace Model
{
  ...
  /**
   * <p>Your request references a resource which does not exist. </p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/notificationscontacts-2018-05-10/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_NOTIFICATIONSCONTACTS_API ResourceNotFoundException() = default;
    AWS_NOTIFICATIONSCONTACTS_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_NOTIFICATIONSCONTACTS_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
