...
class CreateEmailContactResult {
 public:
  AWS_NOTIFICATIONSCONTACTS_API CreateEmailContactResult() = default;
  ...
  template <typename ArnT = Aws::String>
  CreateEmailContactResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEmailContactResult& WithRequestId(RequestIdT&& value) {
