...
template <>
AWS_NOTIFICATIONSCONTACTS_API ConflictException NotificationsContactsError::GetModeledError() {
  assert(this->GetErrorType() == NotificationsContactsErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_NOTIFICATIONSCONTACTS_API ThrottlingException NotificationsContactsError::GetModeledError() {
  assert(this->GetErrorType() == NotificationsContactsErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_NOTIFICATIONSCONTACTS_API ServiceQuotaExceededException NotificationsContactsError::GetModeledError() {
  assert(this->GetErrorType() == NotificationsContactsErrors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_NOTIFICATIONSCONTACTS_API ResourceNotFoundException NotificationsContactsError::GetModeledError() {
  assert(this->GetErrorType() == NotificationsContactsErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_NOTIFICATIONSCONTACTS_API ValidationException NotificationsContactsError::GetModeledError() {
