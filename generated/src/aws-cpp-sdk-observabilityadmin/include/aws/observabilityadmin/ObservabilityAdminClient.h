...
namespace ObservabilityAdmin
{
   ...
   * Guide.</p>
   */
  class AWS_OBSERVABILITYADMIN_API ObservabilityAdminClient : smithy::client::AwsSmithyClientT<Aws::ObservabilityAdmin::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<ObservabilityAdminClient>
  {
    public:
