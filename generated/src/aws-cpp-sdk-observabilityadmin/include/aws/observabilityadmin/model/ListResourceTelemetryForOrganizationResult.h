...
class ListResourceTelemetryForOrganizationResult {
 public:
  ...
  AWS_OBSERVABILITYADMIN_API ListResourceTelemetryForOrganizationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetTelemetryConfigurations(TelemetryConfigurationsT&& value) {
    m_telemetryConfigurationsHasBeenSet = true;
    m_telemetryConfigurations = std::forward<TelemetryConfigurationsT>(value);
  }
  template <typename TelemetryConfigurationsT = Aws::Vector<TelemetryConfiguration>>
  ListResourceTelemetryForOrganizationResult& WithTelemetryConfigurations(TelemetryConfigurationsT&& value) {
    SetTelemetryConfigurations(std::forward<TelemetryConfigurationsT>(value));
    return *this;
  }
  template <typename TelemetryConfigurationsT = TelemetryConfiguration>
  ListResourceTelemetryForOrganizationResult& AddTelemetryConfigurations(TelemetryConfigurationsT&& value) {
    m_telemetryConfigurationsHasBeenSet = true;
    m_telemetryConfigurations.emplace_back(std::forward<TelemetryConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceTelemetryForOrganizationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceTelemetryForOrganizationResult& WithRequestId(RequestIdT&& value) {
