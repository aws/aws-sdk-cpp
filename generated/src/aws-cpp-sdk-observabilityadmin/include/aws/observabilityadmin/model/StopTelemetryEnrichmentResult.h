...
class StopTelemetryEnrichmentResult {
 public:
  ...
  AWS_OBSERVABILITYADMIN_API StopTelemetryEnrichmentResult& operator=(
  ...
  inline StopTelemetryEnrichmentResult& WithStatus(TelemetryEnrichmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopTelemetryEnrichmentResult& WithRequestId(RequestIdT&& value) {
