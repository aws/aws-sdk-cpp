...
/**
 */
class UntagResourceRequest : public ObservabilityAdminRequest {
 public:
  AWS_OBSERVABILITYADMIN_API UntagResourceRequest() = default;
  ...
  ///@{
  /**
   * <p> The Amazon Resource Name (ARN) of the telemetry rule resource to remove tags
   * from. </p>
   */
