...
class ListResourceTelemetryResult {
 public:
  ...
  template <typename TelemetryConfigurationsT = Aws::Vector<TelemetryConfiguration>>
  ListResourceTelemetryResult& WithTelemetryConfigurations(TelemetryConfigurationsT&& value) {
  ...
  ListResourceTelemetryResult& AddTelemetryConfigurations(TelemetryConfigurationsT&& value) {
    m_telemetryConfigurationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceTelemetryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceTelemetryResult& WithRequestId(RequestIdT&& value) {
