...
/**
 * <p>Contains detailed error information from pipeline test operations, providing
 * structured error responses for better debugging and troubleshooting
 * capabilities.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/observabilityadmin-2018-05-10/PipelineOutputError">AWS
 * API Reference</a></p>
 */
class PipelineOutputError {
 public:
  ...
  ///@{
  /**
   * <p>The detailed error message describing what went wrong during the pipeline
   * test operation for this record.</p>
   */
