...
class ListTelemetryRulesForOrganizationRequest : public ObservabilityAdminRequest {
 public:
  ...
  template <typename RuleNamePrefixT = Aws::String>
  ListTelemetryRulesForOrganizationRequest& WithRuleNamePrefix(RuleNamePrefixT&& value) {
  ...
  void SetSourceAccountIds(SourceAccountIdsT&& value) {
    m_sourceAccountIdsHasBeenSet = true;
    m_sourceAccountIds = std::forward<SourceAccountIdsT>(value);
  }
  template <typename SourceAccountIdsT = Aws::Vector<Aws::String>>
  ListTelemetryRulesForOrganizationRequest& WithSourceAccountIds(SourceAccountIdsT&& value) {
    SetSourceAccountIds(std::forward<SourceAccountIdsT>(value));
    return *this;
  }
  template <typename SourceAccountIdsT = Aws::String>
  ListTelemetryRulesForOrganizationRequest& AddSourceAccountIds(SourceAccountIdsT&& value) {
    m_sourceAccountIdsHasBeenSet = true;
    m_sourceAccountIds.emplace_back(std::forward<SourceAccountIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceOrganizationUnitIds(SourceOrganizationUnitIdsT&& value) {
    m_sourceOrganizationUnitIdsHasBeenSet = true;
    m_sourceOrganizationUnitIds = std::forward<SourceOrganizationUnitIdsT>(value);
  }
  template <typename SourceOrganizationUnitIdsT = Aws::Vector<Aws::String>>
  ListTelemetryRulesForOrganizationRequest& WithSourceOrganizationUnitIds(SourceOrganizationUnitIdsT&& value) {
    SetSourceOrganizationUnitIds(std::forward<SourceOrganizationUnitIdsT>(value));
    return *this;
  }
  template <typename SourceOrganizationUnitIdsT = Aws::String>
  ListTelemetryRulesForOrganizationRequest& AddSourceOrganizationUnitIds(SourceOrganizationUnitIdsT&& value) {
    m_sourceOrganizationUnitIdsHasBeenSet = true;
    m_sourceOrganizationUnitIds.emplace_back(std::forward<SourceOrganizationUnitIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListTelemetryRulesForOrganizationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTelemetryRulesForOrganizationRequest& WithNextToken(NextTokenT&& value) {
