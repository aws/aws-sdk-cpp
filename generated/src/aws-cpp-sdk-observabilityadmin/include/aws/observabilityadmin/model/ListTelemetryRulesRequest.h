...
class ListTelemetryRulesRequest : public ObservabilityAdminRequest {
 public:
  ...
  template <typename RuleNamePrefixT = Aws::String>
  ListTelemetryRulesRequest& WithRuleNamePrefix(RuleNamePrefixT&& value) {
  ...
  inline ListTelemetryRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTelemetryRulesRequest& WithNextToken(NextTokenT&& value) {
