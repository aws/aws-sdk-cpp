...
class TelemetryRuleSummary {
 public:
  ...
  inline TelemetryRuleSummary& WithCreatedTimeStamp(long long value) {
  ...
  inline TelemetryRuleSummary& WithLastUpdateTimeStamp(long long value) {
  ...
  inline TelemetryRuleSummary& WithResourceType(ResourceType value) {
  ...
  inline TelemetryRuleSummary& WithTelemetryType(TelemetryType value) {
