...
namespace Model
{
  ...
  public:
    ...
    AWS_OBSERVABILITYADMIN_API GetTelemetryEnrichmentStatusResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline GetTelemetryEnrichmentStatusResult& WithStatus(TelemetryEnrichmentStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    void SetAwsResourceExplorerManagedViewArn(AwsResourceExplorerManagedViewArnT&& value) { m_awsResourceExplorerManagedViewArnHasBeenSet = true; m_awsResourceExplorerManagedViewArn = std::forward<AwsResourceExplorerManagedViewArnT>(value); }
    template<typename AwsResourceExplorerManagedViewArnT = Aws::String>
    GetTelemetryEnrichmentStatusResult& WithAwsResourceExplorerManagedViewArn(AwsResourceExplorerManagedViewArnT&& value) { SetAwsResourceExplorerManagedViewArn(std::forward<AwsResourceExplorerManagedViewArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetTelemetryEnrichmentStatusResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
