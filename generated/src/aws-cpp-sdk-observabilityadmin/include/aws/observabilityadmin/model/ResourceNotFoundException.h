...
/**
 * <p> The specified resource (such as a telemetry rule) could not be found.
 * </p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/observabilityadmin-2018-05-10/ResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class ResourceNotFoundException {
 public:
  AWS_OBSERVABILITYADMIN_API ResourceNotFoundException() = default;
  AWS_OBSERVABILITYADMIN_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
  AWS_OBSERVABILITYADMIN_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
