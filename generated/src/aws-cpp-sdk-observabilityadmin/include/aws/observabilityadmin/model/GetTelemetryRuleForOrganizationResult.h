...
namespace Model
{
  ...
  public:
    ...
    AWS_OBSERVABILITYADMIN_API GetTelemetryRuleForOrganizationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename RuleNameT = Aws::String>
    GetTelemetryRuleForOrganizationResult& WithRuleName(RuleNameT&& value) { SetRuleName(std::forward<RuleNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RuleArnT = Aws::String>
    GetTelemetryRuleForOrganizationResult& WithRuleArn(RuleArnT&& value) { SetRuleArn(std::forward<RuleArnT>(value)); return *this;}
    ///@}
    ...
    inline GetTelemetryRuleForOrganizationResult& WithCreatedTimeStamp(long long value) { SetCreatedTimeStamp(value); return *this;}
    ///@}
    ...
    inline GetTelemetryRuleForOrganizationResult& WithLastUpdateTimeStamp(long long value) { SetLastUpdateTimeStamp(value); return *this;}
    ///@}
    ...
    template<typename TelemetryRuleT = TelemetryRule>
    GetTelemetryRuleForOrganizationResult& WithTelemetryRule(TelemetryRuleT&& value) { SetTelemetryRule(std::forward<TelemetryRuleT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetTelemetryRuleForOrganizationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
