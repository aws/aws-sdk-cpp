...
class ListTelemetryRulesResult {
 public:
  ...
  void SetTelemetryRuleSummaries(TelemetryRuleSummariesT&& value) {
    m_telemetryRuleSummariesHasBeenSet = true;
    m_telemetryRuleSummaries = std::forward<TelemetryRuleSummariesT>(value);
  }
  template <typename TelemetryRuleSummariesT = Aws::Vector<TelemetryRuleSummary>>
  ListTelemetryRulesResult& WithTelemetryRuleSummaries(TelemetryRuleSummariesT&& value) {
    SetTelemetryRuleSummaries(std::forward<TelemetryRuleSummariesT>(value));
    return *this;
  }
  template <typename TelemetryRuleSummariesT = TelemetryRuleSummary>
  ListTelemetryRulesResult& AddTelemetryRuleSummaries(TelemetryRuleSummariesT&& value) {
    m_telemetryRuleSummariesHasBeenSet = true;
    m_telemetryRuleSummaries.emplace_back(std::forward<TelemetryRuleSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTelemetryRulesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTelemetryRulesResult& WithRequestId(RequestIdT&& value) {
