...
namespace Model
{
  ...
  public:
    ...
    AWS_OBSERVABILITYADMIN_API StartTelemetryEnrichmentResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline StartTelemetryEnrichmentResult& WithStatus(TelemetryEnrichmentStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename AwsResourceExplorerManagedViewArnT = Aws::String>
    StartTelemetryEnrichmentResult& WithAwsResourceExplorerManagedViewArn(AwsResourceExplorerManagedViewArnT&& value) { SetAwsResourceExplorerManagedViewArn(std::forward<AwsResourceExplorerManagedViewArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartTelemetryEnrichmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
