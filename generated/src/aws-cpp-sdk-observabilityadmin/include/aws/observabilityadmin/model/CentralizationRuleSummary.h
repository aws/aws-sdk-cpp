...
class CentralizationRuleSummary {
 public:
  ...
  inline CentralizationRuleSummary& WithCreatedTimeStamp(long long value) {
  ...
  inline CentralizationRuleSummary& WithLastUpdateTimeStamp(long long value) {
  ...
  inline CentralizationRuleSummary& WithRuleHealth(RuleHealth value) {
    SetRuleHealth(value);
    return *this;
  }
  ///@}
  ...
  inline CentralizationRuleSummary& WithFailureReason(CentralizationFailureReason value) {
  ...
  void SetDestinationAccountId(DestinationAccountIdT&& value) {
    ...
    m_destinationAccountId = std::forward<DestinationAccountIdT>(value);
  }
  template <typename DestinationAccountIdT = Aws::String>
  CentralizationRuleSummary& WithDestinationAccountId(DestinationAccountIdT&& value) {
    SetDestinationAccountId(std::forward<DestinationAccountIdT>(value));
    return *this;
  }
  ///@}
