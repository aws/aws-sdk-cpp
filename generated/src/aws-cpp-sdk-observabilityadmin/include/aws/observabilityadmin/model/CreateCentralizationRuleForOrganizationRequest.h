...
class CreateCentralizationRuleForOrganizationRequest : public ObservabilityAdminRequest {
 public:
  ...
  template <typename RuleNameT = Aws::String>
  CreateCentralizationRuleForOrganizationRequest& WithRuleName(RuleNameT&& value) {
  ...
  template <typename RuleT = CentralizationRule>
  CreateCentralizationRuleForOrganizationRequest& WithRule(RuleT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateCentralizationRuleForOrganizationRequest& WithTags(TagsT&& value) {
