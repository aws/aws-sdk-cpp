...
class ListResourceTelemetryForOrganizationRequest : public ObservabilityAdminRequest {
 public:
  ...
  template <typename AccountIdentifiersT = Aws::Vector<Aws::String>>
  ListResourceTelemetryForOrganizationRequest& WithAccountIdentifiers(AccountIdentifiersT&& value) {
    SetAccountIdentifiers(std::forward<AccountIdentifiersT>(value));
    return *this;
  }
  template <typename AccountIdentifiersT = Aws::String>
  ListResourceTelemetryForOrganizationRequest& AddAccountIdentifiers(AccountIdentifiersT&& value) {
    m_accountIdentifiersHasBeenSet = true;
  ...
  template <typename ResourceIdentifierPrefixT = Aws::String>
  ListResourceTelemetryForOrganizationRequest& WithResourceIdentifierPrefix(ResourceIdentifierPrefixT&& value) {
  ...
  template <typename ResourceTypesT = Aws::Vector<ResourceType>>
  ListResourceTelemetryForOrganizationRequest& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  inline ListResourceTelemetryForOrganizationRequest& AddResourceTypes(ResourceType value) {
    m_resourceTypesHasBeenSet = true;
  ...
  template <typename TelemetryConfigurationStateT = Aws::Map<TelemetryType, TelemetryState>>
  ListResourceTelemetryForOrganizationRequest& WithTelemetryConfigurationState(TelemetryConfigurationStateT&& value) {
  ...
  template <typename ResourceTagsT = Aws::Map<Aws::String, Aws::String>>
  ListResourceTelemetryForOrganizationRequest& WithResourceTags(ResourceTagsT&& value) {
  ...
  inline ListResourceTelemetryForOrganizationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceTelemetryForOrganizationRequest& WithNextToken(NextTokenT&& value) {
