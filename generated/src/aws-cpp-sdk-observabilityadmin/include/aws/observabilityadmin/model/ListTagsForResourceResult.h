...
namespace Model
{
  ...
  {
  public:
    AWS_OBSERVABILITYADMIN_API ListTagsForResourceResult() = default;
    AWS_OBSERVABILITYADMIN_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_OBSERVABILITYADMIN_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
