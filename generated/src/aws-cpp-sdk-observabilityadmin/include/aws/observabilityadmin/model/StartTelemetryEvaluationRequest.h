...
/**
 */
class StartTelemetryEvaluationRequest : public ObservabilityAdminRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "StartTelemetryEvaluation"; }
  ...
  ///@{
  /**
   * <p> If set to <code>true</code>, telemetry evaluation starts in all Amazon Web
   * Services Regions where Amazon CloudWatch Observability Admin is available in the
  ...
  inline StartTelemetryEvaluationRequest& WithAllRegions(bool value) {
    SetAllRegions(value);
    return *this;
  }
  ///@}
