...
StartTelemetryEnrichmentResult::StartTelemetryEnrichmentResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartTelemetryEnrichmentResult& StartTelemetryEnrichmentResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
