...
ListResourceTelemetryForOrganizationResult::ListResourceTelemetryForOrganizationResult()
{
}

ListResourceTelemetryForOrganizationResult::ListResourceTelemetryForOrganizationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListResourceTelemetryForOrganizationResult& ListResourceTelemetryForOrganizationResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
