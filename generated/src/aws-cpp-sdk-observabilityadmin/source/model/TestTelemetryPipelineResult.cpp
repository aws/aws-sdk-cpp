...
TestTelemetryPipelineResult::TestTelemetryPipelineResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

TestTelemetryPipelineResult& TestTelemetryPipelineResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
