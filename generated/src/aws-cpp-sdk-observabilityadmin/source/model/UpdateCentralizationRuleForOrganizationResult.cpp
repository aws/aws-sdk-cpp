...
UpdateCentralizationRuleForOrganizationResult::UpdateCentralizationRuleForOrganizationResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdateCentralizationRuleForOrganizationResult& UpdateCentralizationRuleForOrganizationResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
