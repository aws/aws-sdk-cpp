...
ListCentralizationRulesForOrganizationResult::ListCentralizationRulesForOrganizationResult(
...
ListCentralizationRulesForOrganizationResult& ListCentralizationRulesForOrganizationResult::operator=(
  ...
  if (jsonValue.ValueExists("CentralizationRuleSummaries")) {
    ...
    for (unsigned centralizationRuleSummariesIndex = 0; centralizationRuleSummariesIndex < centralizationRuleSummariesJsonList.GetLength();
         ++centralizationRuleSummariesIndex) {
