...
DeleteEdgeConfigurationResult::DeleteEdgeConfigurationResult()
{
}

DeleteEdgeConfigurationResult::DeleteEdgeConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
