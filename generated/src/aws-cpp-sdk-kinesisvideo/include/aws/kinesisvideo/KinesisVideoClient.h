...
class AWS_KINESISVIDEO_API KinesisVideoClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  KinesisVideoClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<KinesisVideoEndpointProviderBase> endpointProvider = nullptr,
      const Aws::KinesisVideo::KinesisVideoClientConfiguration& clientConfiguration = Aws::KinesisVideo::KinesisVideoClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateSignalingChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSignalingChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSignalingChannelRequestT = Model::CreateSignalingChannelRequest>
  void CreateSignalingChannelAsync(const CreateSignalingChannelRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteEdgeConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEdgeConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEdgeConfigurationRequestT = Model::DeleteEdgeConfigurationRequest>
  void DeleteEdgeConfigurationAsync(const DeleteEdgeConfigurationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DeleteEdgeConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteSignalingChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSignalingChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSignalingChannelRequestT = Model::DeleteSignalingChannelRequest>
  void DeleteSignalingChannelAsync(const DeleteSignalingChannelRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEdgeConfigurationOutcome DescribeEdgeConfiguration(
      const Model::DescribeEdgeConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEdgeConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeEdgeConfigurationRequestT = Model::DescribeEdgeConfigurationRequest>
  Model::DescribeEdgeConfigurationOutcomeCallable DescribeEdgeConfigurationCallable(
      const DescribeEdgeConfigurationRequestT& request = {}) const {
    return SubmitCallable(&KinesisVideoClient::DescribeEdgeConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeEdgeConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEdgeConfigurationRequestT = Model::DescribeEdgeConfigurationRequest>
  void DescribeEdgeConfigurationAsync(const DescribeEdgeConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeEdgeConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeImageGenerationConfigurationOutcome DescribeImageGenerationConfiguration(
      const Model::DescribeImageGenerationConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeImageGenerationConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeImageGenerationConfigurationRequestT = Model::DescribeImageGenerationConfigurationRequest>
  Model::DescribeImageGenerationConfigurationOutcomeCallable DescribeImageGenerationConfigurationCallable(
      const DescribeImageGenerationConfigurationRequestT& request = {}) const {
    return SubmitCallable(&KinesisVideoClient::DescribeImageGenerationConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeImageGenerationConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeImageGenerationConfigurationRequestT = Model::DescribeImageGenerationConfigurationRequest>
  void DescribeImageGenerationConfigurationAsync(const DescribeImageGenerationConfigurationResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const DescribeImageGenerationConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMappedResourceConfigurationOutcome DescribeMappedResourceConfiguration(
      const Model::DescribeMappedResourceConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeMappedResourceConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeMappedResourceConfigurationRequestT = Model::DescribeMappedResourceConfigurationRequest>
  Model::DescribeMappedResourceConfigurationOutcomeCallable DescribeMappedResourceConfigurationCallable(
      const DescribeMappedResourceConfigurationRequestT& request = {}) const {
    return SubmitCallable(&KinesisVideoClient::DescribeMappedResourceConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeMappedResourceConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeMappedResourceConfigurationRequestT = Model::DescribeMappedResourceConfigurationRequest>
  void DescribeMappedResourceConfigurationAsync(const DescribeMappedResourceConfigurationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const DescribeMappedResourceConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMediaStorageConfigurationOutcome DescribeMediaStorageConfiguration(
      const Model::DescribeMediaStorageConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeMediaStorageConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeMediaStorageConfigurationRequestT = Model::DescribeMediaStorageConfigurationRequest>
  Model::DescribeMediaStorageConfigurationOutcomeCallable DescribeMediaStorageConfigurationCallable(
      const DescribeMediaStorageConfigurationRequestT& request = {}) const {
    return SubmitCallable(&KinesisVideoClient::DescribeMediaStorageConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeMediaStorageConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeMediaStorageConfigurationRequestT = Model::DescribeMediaStorageConfigurationRequest>
  void DescribeMediaStorageConfigurationAsync(const DescribeMediaStorageConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeMediaStorageConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeNotificationConfigurationOutcome DescribeNotificationConfiguration(
      const Model::DescribeNotificationConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeNotificationConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeNotificationConfigurationRequestT = Model::DescribeNotificationConfigurationRequest>
  Model::DescribeNotificationConfigurationOutcomeCallable DescribeNotificationConfigurationCallable(
      const DescribeNotificationConfigurationRequestT& request = {}) const {
    return SubmitCallable(&KinesisVideoClient::DescribeNotificationConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeNotificationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeNotificationConfigurationRequestT = Model::DescribeNotificationConfigurationRequest>
  void DescribeNotificationConfigurationAsync(const DescribeNotificationConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeNotificationConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeSignalingChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeSignalingChannelRequestT = Model::DescribeSignalingChannelRequest>
  Model::DescribeSignalingChannelOutcomeCallable DescribeSignalingChannelCallable(
      const DescribeSignalingChannelRequestT& request = {}) const {
    return SubmitCallable(&KinesisVideoClient::DescribeSignalingChannel, request);
  }

  /**
   * An Async wrapper for DescribeSignalingChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSignalingChannelRequestT = Model::DescribeSignalingChannelRequest>
  void DescribeSignalingChannelAsync(const DescribeSignalingChannelResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeSignalingChannelRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeStream that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeStreamRequestT = Model::DescribeStreamRequest>
  void DescribeStreamAsync(const DescribeStreamResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DescribeStreamRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetDataEndpoint that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDataEndpointRequestT = Model::GetDataEndpointRequest>
  void GetDataEndpointAsync(const GetDataEndpointRequestT& request, const GetDataEndpointResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSignalingChannelEndpointOutcome GetSignalingChannelEndpoint(
      const Model::GetSignalingChannelEndpointRequest& request) const;

  /**
   * A Callable wrapper for GetSignalingChannelEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSignalingChannelEndpointRequestT = Model::GetSignalingChannelEndpointRequest>
  Model::GetSignalingChannelEndpointOutcomeCallable GetSignalingChannelEndpointCallable(
      const GetSignalingChannelEndpointRequestT& request) const {
    return SubmitCallable(&KinesisVideoClient::GetSignalingChannelEndpoint, request);
  }

  /**
   * An Async wrapper for GetSignalingChannelEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSignalingChannelEndpointRequestT = Model::GetSignalingChannelEndpointRequest>
  void GetSignalingChannelEndpointAsync(const GetSignalingChannelEndpointRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEdgeAgentConfigurationsOutcome ListEdgeAgentConfigurations(
      const Model::ListEdgeAgentConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListEdgeAgentConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListEdgeAgentConfigurationsRequestT = Model::ListEdgeAgentConfigurationsRequest>
  Model::ListEdgeAgentConfigurationsOutcomeCallable ListEdgeAgentConfigurationsCallable(
      const ListEdgeAgentConfigurationsRequestT& request) const {
    return SubmitCallable(&KinesisVideoClient::ListEdgeAgentConfigurations, request);
  }

  /**
   * An Async wrapper for ListEdgeAgentConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEdgeAgentConfigurationsRequestT = Model::ListEdgeAgentConfigurationsRequest>
  void ListEdgeAgentConfigurationsAsync(const ListEdgeAgentConfigurationsRequestT& request,
                                        const ListEdgeAgentConfigurationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSignalingChannels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSignalingChannels that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSignalingChannelsRequestT = Model::ListSignalingChannelsRequest>
  void ListSignalingChannelsAsync(const ListSignalingChannelsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListSignalingChannelsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTagsForStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTagsForStream that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTagsForStreamRequestT = Model::ListTagsForStreamRequest>
  void ListTagsForStreamAsync(const ListTagsForStreamResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListTagsForStreamRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartEdgeConfigurationUpdateOutcome StartEdgeConfigurationUpdate(
      const Model::StartEdgeConfigurationUpdateRequest& request) const;

  /**
   * A Callable wrapper for StartEdgeConfigurationUpdate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartEdgeConfigurationUpdateRequestT = Model::StartEdgeConfigurationUpdateRequest>
  Model::StartEdgeConfigurationUpdateOutcomeCallable StartEdgeConfigurationUpdateCallable(
      const StartEdgeConfigurationUpdateRequestT& request) const {
    return SubmitCallable(&KinesisVideoClient::StartEdgeConfigurationUpdate, request);
  }

  /**
   * An Async wrapper for StartEdgeConfigurationUpdate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartEdgeConfigurationUpdateRequestT = Model::StartEdgeConfigurationUpdateRequest>
  void StartEdgeConfigurationUpdateAsync(const StartEdgeConfigurationUpdateRequestT& request,
                                         const StartEdgeConfigurationUpdateResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TagStream that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TagStreamRequestT = Model::TagStreamRequest>
  void TagStreamAsync(const TagStreamRequestT& request, const TagStreamResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UntagStream that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UntagStreamRequestT = Model::UntagStreamRequest>
  void UntagStreamAsync(const UntagStreamRequestT& request, const UntagStreamResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateImageGenerationConfigurationOutcome UpdateImageGenerationConfiguration(
      const Model::UpdateImageGenerationConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateImageGenerationConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateImageGenerationConfigurationRequestT = Model::UpdateImageGenerationConfigurationRequest>
  Model::UpdateImageGenerationConfigurationOutcomeCallable UpdateImageGenerationConfigurationCallable(
      const UpdateImageGenerationConfigurationRequestT& request = {}) const {
    return SubmitCallable(&KinesisVideoClient::UpdateImageGenerationConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateImageGenerationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateImageGenerationConfigurationRequestT = Model::UpdateImageGenerationConfigurationRequest>
  void UpdateImageGenerationConfigurationAsync(const UpdateImageGenerationConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const UpdateImageGenerationConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateMediaStorageConfigurationOutcome UpdateMediaStorageConfiguration(
      const Model::UpdateMediaStorageConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateMediaStorageConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateMediaStorageConfigurationRequestT = Model::UpdateMediaStorageConfigurationRequest>
  Model::UpdateMediaStorageConfigurationOutcomeCallable UpdateMediaStorageConfigurationCallable(
      const UpdateMediaStorageConfigurationRequestT& request) const {
    return SubmitCallable(&KinesisVideoClient::UpdateMediaStorageConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateMediaStorageConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateMediaStorageConfigurationRequestT = Model::UpdateMediaStorageConfigurationRequest>
  void UpdateMediaStorageConfigurationAsync(const UpdateMediaStorageConfigurationRequestT& request,
                                            const UpdateMediaStorageConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename UpdateNotificationConfigurationRequestT = Model::UpdateNotificationConfigurationRequest>
  void UpdateNotificationConfigurationAsync(const UpdateNotificationConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const UpdateNotificationConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateSignalingChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSignalingChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSignalingChannelRequestT = Model::UpdateSignalingChannelRequest>
  void UpdateSignalingChannelAsync(const UpdateSignalingChannelRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateStream that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateStreamRequestT = Model::UpdateStreamRequest>
