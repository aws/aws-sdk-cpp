...
namespace KinesisVideo
{
   ...
   * <p/>
   */
  class AWS_KINESISVIDEO_API KinesisVideoClient : Aws::Client::ClientWithAsyncTemplateMethods<KinesisVideoClient>,
    smithy::client::AwsSmithyClientT<Aws::KinesisVideo::SERVICE_NAME,
