...
class DescribeEdgeConfigurationResult {
 public:
  ...
  inline DescribeEdgeConfigurationResult& WithSyncStatus(SyncStatus value) {
    SetSyncStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetEdgeAgentStatus(EdgeAgentStatusT&& value) {
    ...
    m_edgeAgentStatus = std::forward<EdgeAgentStatusT>(value);
  }
  template <typename EdgeAgentStatusT = EdgeAgentStatus>
  DescribeEdgeConfigurationResult& WithEdgeAgentStatus(EdgeAgentStatusT&& value) {
    SetEdgeAgentStatus(std::forward<EdgeAgentStatusT>(value));
    return *this;
  }
  ///@}
