...
class ListSignalingChannelsRequest : public KinesisVideoRequest {
 public:
  ...
  inline ListSignalingChannelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSignalingChannelsRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetChannelNameCondition(ChannelNameConditionT&& value) {
    m_channelNameConditionHasBeenSet = true;
    m_channelNameCondition = std::forward<ChannelNameConditionT>(value);
  }
  template <typename ChannelNameConditionT = ChannelNameCondition>
  ListSignalingChannelsRequest& WithChannelNameCondition(ChannelNameConditionT&& value) {
    SetChannelNameCondition(std::forward<ChannelNameConditionT>(value));
    return *this;
  }
  ///@}
 private:
