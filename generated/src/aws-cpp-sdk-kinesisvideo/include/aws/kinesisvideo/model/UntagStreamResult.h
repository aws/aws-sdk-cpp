...
namespace Model
{
  ...
  public:
    ...
    inline UntagStreamResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UntagStreamResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UntagStreamResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
