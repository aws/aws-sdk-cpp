...
namespace Model
{
  ...
  {
  public:
    AWS_KINESISVIDEO_API UpdateSignalingChannelResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateSignalingChannelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
