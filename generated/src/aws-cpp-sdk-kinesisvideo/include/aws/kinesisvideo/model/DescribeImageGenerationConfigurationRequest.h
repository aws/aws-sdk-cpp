...
class DescribeImageGenerationConfigurationRequest : public KinesisVideoRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  DescribeImageGenerationConfigurationRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename StreamARNT = Aws::String>
  DescribeImageGenerationConfigurationRequest& WithStreamARN(StreamARNT&& value) {
