...
namespace Model
{
  ...
  {
  public:
    AWS_KINESISVIDEO_API DescribeImageGenerationConfigurationRequest() = default;
    ...
    template<typename StreamNameT = Aws::String>
    DescribeImageGenerationConfigurationRequest& WithStreamName(StreamNameT&& value) { SetStreamName(std::forward<StreamNameT>(value)); return *this;}
    ///@}
    ...
    template<typename StreamARNT = Aws::String>
    DescribeImageGenerationConfigurationRequest& WithStreamARN(StreamARNT&& value) { SetStreamARN(std::forward<StreamARNT>(value)); return *this;}
    ///@}
  private:
