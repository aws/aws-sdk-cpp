...
class DescribeEdgeConfigurationRequest : public KinesisVideoRequest {
 public:
  AWS_KINESISVIDEO_API DescribeEdgeConfigurationRequest() = default;
  ...
  template <typename StreamNameT = Aws::String>
  DescribeEdgeConfigurationRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename StreamARNT = Aws::String>
  DescribeEdgeConfigurationRequest& WithStreamARN(StreamARNT&& value) {
