...
class SingleMasterConfiguration {
 public:
  ...
  inline void SetMessageTtlSeconds(int value) {
    m_messageTtlSecondsHasBeenSet = true;
    m_messageTtlSeconds = value;
  }
  inline SingleMasterConfiguration& WithMessageTtlSeconds(int value) {
    SetMessageTtlSeconds(value);
    return *this;
  }
  ///@}
 private:
