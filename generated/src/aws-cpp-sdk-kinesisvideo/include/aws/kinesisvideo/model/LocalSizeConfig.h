...
class LocalSizeConfig {
 public:
  ...
  inline void SetMaxLocalMediaSizeInMB(int value) {
    m_maxLocalMediaSizeInMBHasBeenSet = true;
    m_maxLocalMediaSizeInMB = value;
  }
  inline LocalSizeConfig& WithMaxLocalMediaSizeInMB(int value) {
    SetMaxLocalMediaSizeInMB(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStrategyOnFullSize(StrategyOnFullSize value) {
    m_strategyOnFullSizeHasBeenSet = true;
    m_strategyOnFullSize = value;
  }
  inline LocalSizeConfig& WithStrategyOnFullSize(StrategyOnFullSize value) {
    SetStrategyOnFullSize(value);
    return *this;
  }
  ///@}
 private:
