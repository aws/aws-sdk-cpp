...
class StartEdgeConfigurationUpdateRequest : public KinesisVideoRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  StartEdgeConfigurationUpdateRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename StreamARNT = Aws::String>
  StartEdgeConfigurationUpdateRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename EdgeConfigT = EdgeConfig>
  StartEdgeConfigurationUpdateRequest& WithEdgeConfig(EdgeConfigT&& value) {
