...
class DescribeMediaStorageConfigurationResult {
 public:
  ...
  AWS_KINESISVIDEO_API DescribeMediaStorageConfigurationResult& operator=(
  ...
  template <typename MediaStorageConfigurationT = MediaStorageConfiguration>
  DescribeMediaStorageConfigurationResult& WithMediaStorageConfiguration(MediaStorageConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMediaStorageConfigurationResult& WithRequestId(RequestIdT&& value) {
