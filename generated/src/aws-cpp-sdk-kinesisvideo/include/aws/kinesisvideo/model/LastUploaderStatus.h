...
class LastUploaderStatus {
 public:
  ...
  void SetJobStatusDetails(JobStatusDetailsT&& value) {
    ...
    m_jobStatusDetails = std::forward<JobStatusDetailsT>(value);
  }
  template <typename JobStatusDetailsT = Aws::String>
  LastUploaderStatus& WithJobStatusDetails(JobStatusDetailsT&& value) {
    SetJobStatusDetails(std::forward<JobStatusDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastCollectedTime(LastCollectedTimeT&& value) {
    ...
    m_lastCollectedTime = std::forward<LastCollectedTimeT>(value);
  }
  template <typename LastCollectedTimeT = Aws::Utils::DateTime>
  LastUploaderStatus& WithLastCollectedTime(LastCollectedTimeT&& value) {
    SetLastCollectedTime(std::forward<LastCollectedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUploaderStatus(UploaderStatus value) {
    m_uploaderStatusHasBeenSet = true;
    m_uploaderStatus = value;
  }
  inline LastUploaderStatus& WithUploaderStatus(UploaderStatus value) {
    SetUploaderStatus(value);
    return *this;
  }
  ///@}
 private:
