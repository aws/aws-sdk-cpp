...
class GetDataEndpointResult {
 public:
  ...
  void SetDataEndpoint(DataEndpointT&& value) {
    m_dataEndpointHasBeenSet = true;
    m_dataEndpoint = std::forward<DataEndpointT>(value);
  }
  template <typename DataEndpointT = Aws::String>
  GetDataEndpointResult& WithDataEndpoint(DataEndpointT&& value) {
    SetDataEndpoint(std::forward<DataEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetDataEndpointResult& WithRequestId(RequestIdT&& value) {
