...
class ListStreamsRequest : public KinesisVideoRequest {
 public:
  ...
  void SetStreamNameCondition(StreamNameConditionT&& value) {
    m_streamNameConditionHasBeenSet = true;
    m_streamNameCondition = std::forward<StreamNameConditionT>(value);
  }
  template <typename StreamNameConditionT = StreamNameCondition>
  ListStreamsRequest& WithStreamNameCondition(StreamNameConditionT&& value) {
    SetStreamNameCondition(std::forward<StreamNameConditionT>(value));
    return *this;
  }
  ///@}
 private:
