...
namespace Model
{
  ...
  {
  public:
    AWS_KINESISVIDEO_API UpdateDataRetentionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDataRetentionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
