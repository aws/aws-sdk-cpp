...
{
const size_t ElasticTranscoderEndpointRules::RulesBlobStrLen = 3498;
const size_t ElasticTranscoderEndpointRules::RulesBlobSize = 3499;

using RulesBlobT = Aws::Array<const char, ElasticTranscoderEndpointRules::RulesBlobSize>;
...
'c','t','r','a','n','s','c','o','d','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}',
...
'"',':','"','h','t','t','p','s',':','/','/','e','l','a','s','t','i','c','t','r','a','n','s','c','o',
'd','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
't','r','a','n','s','c','o','d','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','l','a','s','t','i','c','t','r','a',
'n','s','c','o','d','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
'o','n','R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o',
'p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',
',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* ElasticTranscoderEndpointRules::GetRulesBlob()
{
