...
class JobOutput {
 public:
  ...
  inline JobOutput& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline JobOutput& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
  ...
  inline JobOutput& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline JobOutput& WithFileSize(long long value) {
    SetFileSize(value);
    return *this;
  }
  ///@}
  ...
  inline JobOutput& WithDurationMillis(long long value) {
  ...
  void SetAppliedColorSpaceConversion(AppliedColorSpaceConversionT&& value) {
    ...
    m_appliedColorSpaceConversion = std::forward<AppliedColorSpaceConversionT>(value);
  }
  template <typename AppliedColorSpaceConversionT = Aws::String>
  JobOutput& WithAppliedColorSpaceConversion(AppliedColorSpaceConversionT&& value) {
    SetAppliedColorSpaceConversion(std::forward<AppliedColorSpaceConversionT>(value));
    return *this;
  }
  ///@}
 private:
