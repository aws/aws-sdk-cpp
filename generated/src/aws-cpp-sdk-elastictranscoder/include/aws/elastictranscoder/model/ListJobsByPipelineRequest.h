...
class ListJobsByPipelineRequest : public ElasticTranscoderRequest {
 public:
  ...
  template <typename PipelineIdT = Aws::String>
  ListJobsByPipelineRequest& WithPipelineId(PipelineIdT&& value) {
  ...
  template <typename AscendingT = Aws::String>
  ListJobsByPipelineRequest& WithAscending(AscendingT&& value) {
  ...
  template <typename PageTokenT = Aws::String>
  ListJobsByPipelineRequest& WithPageToken(PageTokenT&& value) {
