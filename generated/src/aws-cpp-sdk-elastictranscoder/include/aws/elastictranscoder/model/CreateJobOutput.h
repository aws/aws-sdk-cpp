...
class CreateJobOutput {
 public:
  ...
  void SetThumbnailPattern(ThumbnailPatternT&& value) {
    ...
    m_thumbnailPattern = std::forward<ThumbnailPatternT>(value);
  }
  template <typename ThumbnailPatternT = Aws::String>
  CreateJobOutput& WithThumbnailPattern(ThumbnailPatternT&& value) {
    SetThumbnailPattern(std::forward<ThumbnailPatternT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThumbnailEncryption(ThumbnailEncryptionT&& value) {
    ...
    m_thumbnailEncryption = std::forward<ThumbnailEncryptionT>(value);
  }
  template <typename ThumbnailEncryptionT = Encryption>
  CreateJobOutput& WithThumbnailEncryption(ThumbnailEncryptionT&& value) {
    SetThumbnailEncryption(std::forward<ThumbnailEncryptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRotate(RotateT&& value) {
    ...
    m_rotate = std::forward<RotateT>(value);
  }
  template <typename RotateT = Aws::String>
  CreateJobOutput& WithRotate(RotateT&& value) {
    SetRotate(std::forward<RotateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPresetId(PresetIdT&& value) {
    ...
    m_presetId = std::forward<PresetIdT>(value);
  }
  template <typename PresetIdT = Aws::String>
  CreateJobOutput& WithPresetId(PresetIdT&& value) {
    SetPresetId(std::forward<PresetIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSegmentDuration(SegmentDurationT&& value) {
    ...
    m_segmentDuration = std::forward<SegmentDurationT>(value);
  }
  template <typename SegmentDurationT = Aws::String>
  CreateJobOutput& WithSegmentDuration(SegmentDurationT&& value) {
    SetSegmentDuration(std::forward<SegmentDurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAlbumArt(AlbumArtT&& value) {
    ...
    m_albumArt = std::forward<AlbumArtT>(value);
  }
  template <typename AlbumArtT = JobAlbumArt>
  CreateJobOutput& WithAlbumArt(AlbumArtT&& value) {
    SetAlbumArt(std::forward<AlbumArtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCaptions(CaptionsT&& value) {
    ...
    m_captions = std::forward<CaptionsT>(value);
  }
  template <typename CaptionsT = Captions>
  CreateJobOutput& WithCaptions(CaptionsT&& value) {
    SetCaptions(std::forward<CaptionsT>(value));
    return *this;
  }
  ///@}
