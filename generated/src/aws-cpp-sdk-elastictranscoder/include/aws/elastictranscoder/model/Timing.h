...
class Timing {
 public:
  ...
  inline void SetSubmitTimeMillis(long long value) {
    m_submitTimeMillisHasBeenSet = true;
    m_submitTimeMillis = value;
  }
  inline Timing& WithSubmitTimeMillis(long long value) {
    SetSubmitTimeMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartTimeMillis(long long value) {
    m_startTimeMillisHasBeenSet = true;
    m_startTimeMillis = value;
  }
  inline Timing& WithStartTimeMillis(long long value) {
  ...
  inline void SetFinishTimeMillis(long long value) {
    m_finishTimeMillisHasBeenSet = true;
    m_finishTimeMillis = value;
  }
  inline Timing& WithFinishTimeMillis(long long value) {
    SetFinishTimeMillis(value);
    return *this;
  }
  ///@}
 private:
