...
class ListJobsByStatusResult {
 public:
  ...
  template <typename JobsT = Aws::Vector<Job>>
  ListJobsByStatusResult& WithJobs(JobsT&& value) {
    SetJobs(std::forward<JobsT>(value));
    return *this;
  }
  template <typename JobsT = Job>
  ListJobsByStatusResult& AddJobs(JobsT&& value) {
    m_jobsHasBeenSet = true;
  ...
  template <typename NextPageTokenT = Aws::String>
  ListJobsByStatusResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListJobsByStatusResult& WithRequestId(RequestIdT&& value) {
