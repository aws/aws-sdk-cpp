...
class Notifications {
 public:
  ...
  void SetProgressing(ProgressingT&& value) {
    ...
    m_progressing = std::forward<ProgressingT>(value);
  }
  template <typename ProgressingT = Aws::String>
  Notifications& WithProgressing(ProgressingT&& value) {
    SetProgressing(std::forward<ProgressingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCompleted(CompletedT&& value) {
    ...
    m_completed = std::forward<CompletedT>(value);
  }
  template <typename CompletedT = Aws::String>
  Notifications& WithCompleted(CompletedT&& value) {
    SetCompleted(std::forward<CompletedT>(value));
    return *this;
  }
  ///@}
