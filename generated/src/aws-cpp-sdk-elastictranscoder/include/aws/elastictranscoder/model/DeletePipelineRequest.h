 ...
 * API Reference</a></p>
 */
class DeletePipelineRequest : public ElasticTranscoderRequest {
 public:
  AWS_ELASTICTRANSCODER_API DeletePipelineRequest() = default;
  ...
  template <typename IdT = Aws::String>
  DeletePipelineRequest& WithId(IdT&& value) {
