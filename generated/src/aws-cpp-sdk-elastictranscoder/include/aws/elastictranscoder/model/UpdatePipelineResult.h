...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICTRANSCODER_API UpdatePipelineResult() = default;
    ...
    template<typename WarningsT = Aws::Vector<Warning>>
    UpdatePipelineResult& WithWarnings(WarningsT&& value) { SetWarnings(std::forward<WarningsT>(value)); return *this;}
    template<typename WarningsT = Warning>
    UpdatePipelineResult& AddWarnings(WarningsT&& value) { m_warningsHasBeenSet = true; m_warnings.emplace_back(std::forward<WarningsT>(value)); return *this; }
    ///@}
