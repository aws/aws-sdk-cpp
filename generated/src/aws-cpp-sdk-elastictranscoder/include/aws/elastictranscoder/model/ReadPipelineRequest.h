...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class ReadPipelineRequest : public ElasticTranscoderRequest
  {
  public:
    AWS_ELASTICTRANSCODER_API ReadPipelineRequest() = default;
    ...
    template<typename IdT = Aws::String>
    ReadPipelineRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
