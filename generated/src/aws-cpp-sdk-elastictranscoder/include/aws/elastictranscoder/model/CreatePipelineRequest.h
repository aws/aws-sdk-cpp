...
class CreatePipelineRequest : public ElasticTranscoderRequest {
 public:
  ...
  void SetInputBucket(InputBucketT&& value) {
    ...
    m_inputBucket = std::forward<InputBucketT>(value);
  }
  template <typename InputBucketT = Aws::String>
  CreatePipelineRequest& WithInputBucket(InputBucketT&& value) {
    SetInputBucket(std::forward<InputBucketT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputBucket(OutputBucketT&& value) {
    ...
    m_outputBucket = std::forward<OutputBucketT>(value);
  }
  template <typename OutputBucketT = Aws::String>
  CreatePipelineRequest& WithOutputBucket(OutputBucketT&& value) {
    SetOutputBucket(std::forward<OutputBucketT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsKmsKeyArn(AwsKmsKeyArnT&& value) {
    ...
    m_awsKmsKeyArn = std::forward<AwsKmsKeyArnT>(value);
  }
  template <typename AwsKmsKeyArnT = Aws::String>
  CreatePipelineRequest& WithAwsKmsKeyArn(AwsKmsKeyArnT&& value) {
    SetAwsKmsKeyArn(std::forward<AwsKmsKeyArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContentConfig(ContentConfigT&& value) {
    ...
    m_contentConfig = std::forward<ContentConfigT>(value);
  }
  template <typename ContentConfigT = PipelineOutputConfig>
  CreatePipelineRequest& WithContentConfig(ContentConfigT&& value) {
    SetContentConfig(std::forward<ContentConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThumbnailConfig(ThumbnailConfigT&& value) {
    ...
    m_thumbnailConfig = std::forward<ThumbnailConfigT>(value);
  }
  template <typename ThumbnailConfigT = PipelineOutputConfig>
  CreatePipelineRequest& WithThumbnailConfig(ThumbnailConfigT&& value) {
    SetThumbnailConfig(std::forward<ThumbnailConfigT>(value));
    return *this;
  }
  ///@}
 private:
