...
class Captions {
 public:
  ...
  void SetCaptionFormats(CaptionFormatsT&& value) {
    ...
    m_captionFormats = std::forward<CaptionFormatsT>(value);
  }
  template <typename CaptionFormatsT = Aws::Vector<CaptionFormat>>
  Captions& WithCaptionFormats(CaptionFormatsT&& value) {
    SetCaptionFormats(std::forward<CaptionFormatsT>(value));
    return *this;
  }
  template <typename CaptionFormatsT = CaptionFormat>
  Captions& AddCaptionFormats(CaptionFormatsT&& value) {
    m_captionFormatsHasBeenSet = true;
    m_captionFormats.emplace_back(std::forward<CaptionFormatsT>(value));
    return *this;
  }
  ///@}
 private:
