...
class JobInput {
 public:
  ...
  void SetInterlaced(InterlacedT&& value) {
    ...
    m_interlaced = std::forward<InterlacedT>(value);
  }
  template <typename InterlacedT = Aws::String>
  JobInput& WithInterlaced(InterlacedT&& value) {
    SetInterlaced(std::forward<InterlacedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeSpan(TimeSpanT&& value) {
    ...
    m_timeSpan = std::forward<TimeSpanT>(value);
  }
  template <typename TimeSpanT = TimeSpan>
  JobInput& WithTimeSpan(TimeSpanT&& value) {
    SetTimeSpan(std::forward<TimeSpanT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputCaptions(InputCaptionsT&& value) {
    ...
    m_inputCaptions = std::forward<InputCaptionsT>(value);
  }
  template <typename InputCaptionsT = InputCaptions>
  JobInput& WithInputCaptions(InputCaptionsT&& value) {
    SetInputCaptions(std::forward<InputCaptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDetectedProperties(DetectedPropertiesT&& value) {
    ...
    m_detectedProperties = std::forward<DetectedPropertiesT>(value);
  }
  template <typename DetectedPropertiesT = DetectedProperties>
  JobInput& WithDetectedProperties(DetectedPropertiesT&& value) {
    SetDetectedProperties(std::forward<DetectedPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
