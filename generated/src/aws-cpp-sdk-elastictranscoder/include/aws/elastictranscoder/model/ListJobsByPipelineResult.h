...
class ListJobsByPipelineResult {
 public:
  ...
  template <typename JobsT = Aws::Vector<Job>>
  ListJobsByPipelineResult& WithJobs(JobsT&& value) {
    SetJobs(std::forward<JobsT>(value));
    return *this;
  }
  template <typename JobsT = Job>
  ListJobsByPipelineResult& AddJobs(JobsT&& value) {
    m_jobsHasBeenSet = true;
  ...
  template <typename NextPageTokenT = Aws::String>
  ListJobsByPipelineResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListJobsByPipelineResult& WithRequestId(RequestIdT&& value) {
