...
class AudioCodecOptions {
 public:
  ...
  void SetBitDepth(BitDepthT&& value) {
    ...
    m_bitDepth = std::forward<BitDepthT>(value);
  }
  template <typename BitDepthT = Aws::String>
  AudioCodecOptions& WithBitDepth(BitDepthT&& value) {
    SetBitDepth(std::forward<BitDepthT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBitOrder(BitOrderT&& value) {
    ...
    m_bitOrder = std::forward<BitOrderT>(value);
  }
  template <typename BitOrderT = Aws::String>
  AudioCodecOptions& WithBitOrder(BitOrderT&& value) {
    SetBitOrder(std::forward<BitOrderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSigned(SignedT&& value) {
    ...
    m_signed = std::forward<SignedT>(value);
  }
  template <typename SignedT = Aws::String>
  AudioCodecOptions& WithSigned(SignedT&& value) {
    SetSigned(std::forward<SignedT>(value));
    return *this;
  }
  ///@}
 private:
