...
class ReadPipelineResult {
 public:
  ...
  template <typename PipelineT = Pipeline>
  ReadPipelineResult& WithPipeline(PipelineT&& value) {
  ...
  template <typename WarningsT = Aws::Vector<Warning>>
  ReadPipelineResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = Warning>
  ReadPipelineResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ReadPipelineResult& WithRequestId(RequestIdT&& value) {
