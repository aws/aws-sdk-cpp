...
class VideoParameters {
 public:
  ...
  void SetCodecOptions(CodecOptionsT&& value) {
    ...
    m_codecOptions = std::forward<CodecOptionsT>(value);
  }
  template <typename CodecOptionsT = Aws::Map<Aws::String, Aws::String>>
  VideoParameters& WithCodecOptions(CodecOptionsT&& value) {
    SetCodecOptions(std::forward<CodecOptionsT>(value));
    return *this;
  }
  ...
  VideoParameters& AddCodecOptions(CodecOptionsKeyT&& key, CodecOptionsValueT&& value) {
    m_codecOptionsHasBeenSet = true;
    m_codecOptions.emplace(std::forward<CodecOptionsKeyT>(key), std::forward<CodecOptionsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKeyframesMaxDist(KeyframesMaxDistT&& value) {
    ...
    m_keyframesMaxDist = std::forward<KeyframesMaxDistT>(value);
  }
  template <typename KeyframesMaxDistT = Aws::String>
  VideoParameters& WithKeyframesMaxDist(KeyframesMaxDistT&& value) {
    SetKeyframesMaxDist(std::forward<KeyframesMaxDistT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFixedGOP(FixedGOPT&& value) {
    ...
    m_fixedGOP = std::forward<FixedGOPT>(value);
  }
  template <typename FixedGOPT = Aws::String>
  VideoParameters& WithFixedGOP(FixedGOPT&& value) {
    SetFixedGOP(std::forward<FixedGOPT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBitRate(BitRateT&& value) {
    ...
    m_bitRate = std::forward<BitRateT>(value);
  }
  template <typename BitRateT = Aws::String>
  VideoParameters& WithBitRate(BitRateT&& value) {
    SetBitRate(std::forward<BitRateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaxFrameRate(MaxFrameRateT&& value) {
    ...
    m_maxFrameRate = std::forward<MaxFrameRateT>(value);
  }
  template <typename MaxFrameRateT = Aws::String>
  VideoParameters& WithMaxFrameRate(MaxFrameRateT&& value) {
    SetMaxFrameRate(std::forward<MaxFrameRateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaxWidth(MaxWidthT&& value) {
    ...
    m_maxWidth = std::forward<MaxWidthT>(value);
  }
  template <typename MaxWidthT = Aws::String>
  VideoParameters& WithMaxWidth(MaxWidthT&& value) {
    SetMaxWidth(std::forward<MaxWidthT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaxHeight(MaxHeightT&& value) {
    ...
    m_maxHeight = std::forward<MaxHeightT>(value);
  }
  template <typename MaxHeightT = Aws::String>
  VideoParameters& WithMaxHeight(MaxHeightT&& value) {
    SetMaxHeight(std::forward<MaxHeightT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSizingPolicy(SizingPolicyT&& value) {
    ...
    m_sizingPolicy = std::forward<SizingPolicyT>(value);
  }
  template <typename SizingPolicyT = Aws::String>
  VideoParameters& WithSizingPolicy(SizingPolicyT&& value) {
    SetSizingPolicy(std::forward<SizingPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPaddingPolicy(PaddingPolicyT&& value) {
    ...
    m_paddingPolicy = std::forward<PaddingPolicyT>(value);
  }
  template <typename PaddingPolicyT = Aws::String>
  VideoParameters& WithPaddingPolicy(PaddingPolicyT&& value) {
    SetPaddingPolicy(std::forward<PaddingPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWatermarks(WatermarksT&& value) {
    ...
    m_watermarks = std::forward<WatermarksT>(value);
  }
  template <typename WatermarksT = Aws::Vector<PresetWatermark>>
  VideoParameters& WithWatermarks(WatermarksT&& value) {
    SetWatermarks(std::forward<WatermarksT>(value));
    return *this;
  }
  template <typename WatermarksT = PresetWatermark>
  VideoParameters& AddWatermarks(WatermarksT&& value) {
    m_watermarksHasBeenSet = true;
    m_watermarks.emplace_back(std::forward<WatermarksT>(value));
    return *this;
  }
  ///@}
 private:
