...
class HlsContentProtection {
 public:
  ...
  void SetKeyMd5(KeyMd5T&& value) {
    ...
    m_keyMd5 = std::forward<KeyMd5T>(value);
  }
  template <typename KeyMd5T = Aws::String>
  HlsContentProtection& WithKeyMd5(KeyMd5T&& value) {
    SetKeyMd5(std::forward<KeyMd5T>(value));
    return *this;
  }
  ///@}
  ...
  void SetLicenseAcquisitionUrl(LicenseAcquisitionUrlT&& value) {
    ...
    m_licenseAcquisitionUrl = std::forward<LicenseAcquisitionUrlT>(value);
  }
  template <typename LicenseAcquisitionUrlT = Aws::String>
  HlsContentProtection& WithLicenseAcquisitionUrl(LicenseAcquisitionUrlT&& value) {
    SetLicenseAcquisitionUrl(std::forward<LicenseAcquisitionUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKeyStoragePolicy(KeyStoragePolicyT&& value) {
    ...
    m_keyStoragePolicy = std::forward<KeyStoragePolicyT>(value);
  }
  template <typename KeyStoragePolicyT = Aws::String>
  HlsContentProtection& WithKeyStoragePolicy(KeyStoragePolicyT&& value) {
    SetKeyStoragePolicy(std::forward<KeyStoragePolicyT>(value));
    return *this;
  }
  ///@}
 private:
