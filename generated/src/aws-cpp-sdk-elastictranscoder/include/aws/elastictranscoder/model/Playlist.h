...
class Playlist {
 public:
  ...
  void SetOutputKeys(OutputKeysT&& value) {
    ...
    m_outputKeys = std::forward<OutputKeysT>(value);
  }
  template <typename OutputKeysT = Aws::Vector<Aws::String>>
  Playlist& WithOutputKeys(OutputKeysT&& value) {
    SetOutputKeys(std::forward<OutputKeysT>(value));
    return *this;
  }
  template <typename OutputKeysT = Aws::String>
  Playlist& AddOutputKeys(OutputKeysT&& value) {
    m_outputKeysHasBeenSet = true;
    m_outputKeys.emplace_back(std::forward<OutputKeysT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHlsContentProtection(HlsContentProtectionT&& value) {
    ...
    m_hlsContentProtection = std::forward<HlsContentProtectionT>(value);
  }
  template <typename HlsContentProtectionT = HlsContentProtection>
  Playlist& WithHlsContentProtection(HlsContentProtectionT&& value) {
    SetHlsContentProtection(std::forward<HlsContentProtectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlayReadyDrm(PlayReadyDrmT&& value) {
    ...
    m_playReadyDrm = std::forward<PlayReadyDrmT>(value);
  }
  template <typename PlayReadyDrmT = PlayReadyDrm>
  Playlist& WithPlayReadyDrm(PlayReadyDrmT&& value) {
    SetPlayReadyDrm(std::forward<PlayReadyDrmT>(value));
    return *this;
  }
  ///@}
