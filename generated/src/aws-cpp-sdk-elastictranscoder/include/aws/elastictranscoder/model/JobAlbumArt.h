...
class JobAlbumArt {
 public:
  ...
  void SetMergePolicy(MergePolicyT&& value) {
    ...
    m_mergePolicy = std::forward<MergePolicyT>(value);
  }
  template <typename MergePolicyT = Aws::String>
  JobAlbumArt& WithMergePolicy(MergePolicyT&& value) {
    SetMergePolicy(std::forward<MergePolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArtwork(ArtworkT&& value) {
    m_artworkHasBeenSet = true;
    m_artwork = std::forward<ArtworkT>(value);
  }
  template <typename ArtworkT = Aws::Vector<Artwork>>
  JobAlbumArt& WithArtwork(ArtworkT&& value) {
    SetArtwork(std::forward<ArtworkT>(value));
    return *this;
  }
  template <typename ArtworkT = Artwork>
  JobAlbumArt& AddArtwork(ArtworkT&& value) {
    m_artworkHasBeenSet = true;
    m_artwork.emplace_back(std::forward<ArtworkT>(value));
    return *this;
  }
  ///@}
 private:
