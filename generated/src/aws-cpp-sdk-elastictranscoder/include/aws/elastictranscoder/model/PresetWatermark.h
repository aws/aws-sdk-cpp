...
class PresetWatermark {
 public:
  ...
  void SetHorizontalAlign(HorizontalAlignT&& value) {
    ...
    m_horizontalAlign = std::forward<HorizontalAlignT>(value);
  }
  template <typename HorizontalAlignT = Aws::String>
  PresetWatermark& WithHorizontalAlign(HorizontalAlignT&& value) {
    SetHorizontalAlign(std::forward<HorizontalAlignT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHorizontalOffset(HorizontalOffsetT&& value) {
    ...
    m_horizontalOffset = std::forward<HorizontalOffsetT>(value);
  }
  template <typename HorizontalOffsetT = Aws::String>
  PresetWatermark& WithHorizontalOffset(HorizontalOffsetT&& value) {
    SetHorizontalOffset(std::forward<HorizontalOffsetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerticalAlign(VerticalAlignT&& value) {
    ...
    m_verticalAlign = std::forward<VerticalAlignT>(value);
  }
  template <typename VerticalAlignT = Aws::String>
  PresetWatermark& WithVerticalAlign(VerticalAlignT&& value) {
    SetVerticalAlign(std::forward<VerticalAlignT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerticalOffset(VerticalOffsetT&& value) {
    ...
    m_verticalOffset = std::forward<VerticalOffsetT>(value);
  }
  template <typename VerticalOffsetT = Aws::String>
  PresetWatermark& WithVerticalOffset(VerticalOffsetT&& value) {
    SetVerticalOffset(std::forward<VerticalOffsetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOpacity(OpacityT&& value) {
    ...
    m_opacity = std::forward<OpacityT>(value);
  }
  template <typename OpacityT = Aws::String>
  PresetWatermark& WithOpacity(OpacityT&& value) {
    SetOpacity(std::forward<OpacityT>(value));
    return *this;
  }
  ///@}
