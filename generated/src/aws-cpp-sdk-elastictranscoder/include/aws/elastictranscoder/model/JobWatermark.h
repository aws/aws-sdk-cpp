...
class JobWatermark {
 public:
  ...
  void SetPresetWatermarkId(PresetWatermarkIdT&& value) {
    m_presetWatermarkIdHasBeenSet = true;
    m_presetWatermarkId = std::forward<PresetWatermarkIdT>(value);
  }
  template <typename PresetWatermarkIdT = Aws::String>
  JobWatermark& WithPresetWatermarkId(PresetWatermarkIdT&& value) {
    SetPresetWatermarkId(std::forward<PresetWatermarkIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputKey(InputKeyT&& value) {
    ...
    m_inputKey = std::forward<InputKeyT>(value);
  }
  template <typename InputKeyT = Aws::String>
  JobWatermark& WithInputKey(InputKeyT&& value) {
    SetInputKey(std::forward<InputKeyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EncryptionT = Encryption>
  JobWatermark& WithEncryption(EncryptionT&& value) {
