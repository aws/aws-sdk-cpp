...
namespace ElasticTranscoder
{
   ...
   */
  class AWS_ELASTICTRANSCODER_API ElasticTranscoderClient : Aws::Client::ClientWithAsyncTemplateMethods<ElasticTranscoderClient>,
    smithy::client::AwsSmithyClientT<Aws::ElasticTranscoder::SERVICE_NAME,
