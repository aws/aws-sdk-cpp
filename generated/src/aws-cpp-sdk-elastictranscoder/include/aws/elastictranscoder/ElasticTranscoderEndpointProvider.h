 ...
 */
using ElasticTranscoderEndpointProviderBase = EndpointProviderBase<ElasticTranscoderClientConfiguration, ElasticTranscoderBuiltInParameters,
                                                                   ElasticTranscoderClientContextParameters>;

using ElasticTranscoderDefaultEpProviderBase =
    DefaultEndpointProvider<ElasticTranscoderClientConfiguration, ElasticTranscoderBuiltInParameters,
                            ElasticTranscoderClientContextParameters>;
