...
StartConfigurationSessionResult::StartConfigurationSessionResult()
{
}

StartConfigurationSessionResult::StartConfigurationSessionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
