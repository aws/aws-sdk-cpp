...
{
const size_t AppConfigDataEndpointRules::RulesBlobStrLen = 3733;
const size_t AppConfigDataEndpointRules::RulesBlobSize = 3734;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','c','o','n','f','i','g','d',
'a','t','a','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','c','o','n','f','i','g','d',
'a','t','a','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.','c','o',
'm','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e',
'r','s','"',':','{','}','}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"',
'}',',','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o',
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','c',
'o','n','f','i','g','d','a','t','a','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'c','o','n','f','i','g','d','a','t','a','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'i','g','d','a','t','a','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
const char* AppConfigDataEndpointRules::GetRulesBlob()
{
