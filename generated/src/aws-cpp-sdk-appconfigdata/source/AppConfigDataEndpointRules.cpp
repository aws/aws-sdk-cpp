...
{
const size_t AppConfigDataEndpointRules::RulesBlobStrLen = 3482;
const size_t AppConfigDataEndpointRules::RulesBlobSize = 3483;
...
't','t','p','s',':','/','/','a','p','p','c','o','n','f','i','g','d','a','t','a','-','f','i','p','s',
