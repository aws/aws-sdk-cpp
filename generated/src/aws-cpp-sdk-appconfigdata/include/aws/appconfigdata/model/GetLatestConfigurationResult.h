...
class GetLatestConfigurationResult {
 public:
  ...
  void SetNextPollConfigurationToken(NextPollConfigurationTokenT&& value) {
    ...
    m_nextPollConfigurationToken = std::forward<NextPollConfigurationTokenT>(value);
  }
  template <typename NextPollConfigurationTokenT = Aws::String>
  GetLatestConfigurationResult& WithNextPollConfigurationToken(NextPollConfigurationTokenT&& value) {
    SetNextPollConfigurationToken(std::forward<NextPollConfigurationTokenT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNextPollIntervalInSeconds(int value) {
    m_nextPollIntervalInSecondsHasBeenSet = true;
    m_nextPollIntervalInSeconds = value;
  }
  inline GetLatestConfigurationResult& WithNextPollIntervalInSeconds(int value) {
    SetNextPollIntervalInSeconds(value);
    return *this;
  }
  ///@}
