...
namespace AppConfigData
{
   ...
   */
  class AWS_APPCONFIGDATA_API AppConfigDataClient : Aws::Client::ClientWithAsyncTemplateMethods<AppConfigDataClient>,
    smithy::client::AwsSmithyClientT<Aws::AppConfigData::SERVICE_NAME,
