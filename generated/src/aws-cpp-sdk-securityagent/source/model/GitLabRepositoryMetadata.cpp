...
GitLabRepositoryMetadata::GitLabRepositoryMetadata(JsonView jsonValue) { *this = jsonValue; }

GitLabRepositoryMetadata& GitLabRepositoryMetadata::operator=(JsonView jsonValue) {
...
JsonValue GitLabRepositoryMetadata::Jsonize() const {
  JsonValue payload;
