...
UpdateThreatResult::UpdateThreatResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateThreatResult& UpdateThreatResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
