...
CreateAgentSpaceResult::CreateAgentSpaceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateAgentSpaceResult& CreateAgentSpaceResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
