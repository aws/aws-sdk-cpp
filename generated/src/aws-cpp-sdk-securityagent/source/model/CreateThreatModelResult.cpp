...
CreateThreatModelResult::CreateThreatModelResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateThreatModelResult& CreateThreatModelResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
