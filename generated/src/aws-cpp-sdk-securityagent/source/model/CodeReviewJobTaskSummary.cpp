...
CodeReviewJobTaskSummary::CodeReviewJobTaskSummary(JsonView jsonValue) { *this = jsonValue; }

CodeReviewJobTaskSummary& CodeReviewJobTaskSummary::operator=(JsonView jsonValue) {
...
JsonValue CodeReviewJobTaskSummary::Jsonize() const {
  JsonValue payload;
