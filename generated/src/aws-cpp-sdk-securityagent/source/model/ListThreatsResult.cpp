...
ListThreatsResult::ListThreatsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListThreatsResult& ListThreatsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
