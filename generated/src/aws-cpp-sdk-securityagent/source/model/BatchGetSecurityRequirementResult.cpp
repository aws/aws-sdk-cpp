...
BatchGetSecurityRequirementResult::BatchGetSecurityRequirementResult(JsonView jsonValue) { *this = jsonValue; }

BatchGetSecurityRequirementResult& BatchGetSecurityRequirementResult::operator=(JsonView jsonValue) {
...
JsonValue BatchGetSecurityRequirementResult::Jsonize() const {
  JsonValue payload;
