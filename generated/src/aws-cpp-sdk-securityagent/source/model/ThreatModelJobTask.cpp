...
ThreatModelJobTask::ThreatModelJobTask(JsonView jsonValue) { *this = jsonValue; }

ThreatModelJobTask& ThreatModelJobTask::operator=(JsonView jsonValue) {
...
JsonValue ThreatModelJobTask::Jsonize() const {
  JsonValue payload;
