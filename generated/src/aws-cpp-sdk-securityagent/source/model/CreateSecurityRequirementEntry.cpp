...
CreateSecurityRequirementEntry::CreateSecurityRequirementEntry(JsonView jsonValue) { *this = jsonValue; }

CreateSecurityRequirementEntry& CreateSecurityRequirementEntry::operator=(JsonView jsonValue) {
...
JsonValue CreateSecurityRequirementEntry::Jsonize() const {
  JsonValue payload;
