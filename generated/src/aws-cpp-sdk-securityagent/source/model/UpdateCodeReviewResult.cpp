...
UpdateCodeReviewResult::UpdateCodeReviewResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateCodeReviewResult& UpdateCodeReviewResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
