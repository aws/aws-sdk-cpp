...
BitbucketResourceCapabilities::BitbucketResourceCapabilities(JsonView jsonValue) { *this = jsonValue; }

BitbucketResourceCapabilities& BitbucketResourceCapabilities::operator=(JsonView jsonValue) {
...
JsonValue BitbucketResourceCapabilities::Jsonize() const {
  JsonValue payload;
