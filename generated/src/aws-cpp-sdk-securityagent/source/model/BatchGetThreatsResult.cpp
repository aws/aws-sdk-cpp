...
BatchGetThreatsResult::BatchGetThreatsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchGetThreatsResult& BatchGetThreatsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
