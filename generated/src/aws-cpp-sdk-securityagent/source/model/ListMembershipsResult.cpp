...
ListMembershipsResult::ListMembershipsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListMembershipsResult& ListMembershipsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("membershipSummaries")) {
    ...
    for (unsigned membershipSummariesIndex = 0; membershipSummariesIndex < membershipSummariesJsonList.GetLength();
         ++membershipSummariesIndex) {
