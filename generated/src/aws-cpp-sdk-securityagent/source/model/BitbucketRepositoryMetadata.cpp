...
BitbucketRepositoryMetadata::BitbucketRepositoryMetadata(JsonView jsonValue) { *this = jsonValue; }

BitbucketRepositoryMetadata& BitbucketRepositoryMetadata::operator=(JsonView jsonValue) {
...
JsonValue BitbucketRepositoryMetadata::Jsonize() const {
  JsonValue payload;
