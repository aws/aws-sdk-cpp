...
StartCodeReviewJobResult::StartCodeReviewJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartCodeReviewJobResult& StartCodeReviewJobResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
