...
ListActorMessagesResult::ListActorMessagesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListActorMessagesResult& ListActorMessagesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
