...
UpdateSecurityRequirementPackResult::UpdateSecurityRequirementPackResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdateSecurityRequirementPackResult& UpdateSecurityRequirementPackResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
