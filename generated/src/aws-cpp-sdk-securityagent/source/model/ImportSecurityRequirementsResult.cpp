...
ImportSecurityRequirementsResult::ImportSecurityRequirementsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ImportSecurityRequirementsResult& ImportSecurityRequirementsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
