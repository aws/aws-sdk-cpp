...
BatchDeleteThreatModelsResult::BatchDeleteThreatModelsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchDeleteThreatModelsResult& BatchDeleteThreatModelsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
