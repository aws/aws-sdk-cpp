...
CreateSecurityRequirementPackResult::CreateSecurityRequirementPackResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CreateSecurityRequirementPackResult& CreateSecurityRequirementPackResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
