...
/**
 * <p>Input for listing tasks associated with a code review job.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/securityagent-2025-09-06/ListCodeReviewJobTasksInput">AWS
 * API Reference</a></p>
 */
class ListCodeReviewJobTasksRequest : public SecurityAgentRequest {
 public:
  AWS_SECURITYAGENT_API ListCodeReviewJobTasksRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListCodeReviewJobTasks"; }
  ...
  template <typename AgentSpaceIdT = Aws::String>
  ListCodeReviewJobTasksRequest& WithAgentSpaceId(AgentSpaceIdT&& value) {
  ...
  inline ListCodeReviewJobTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename CodeReviewJobIdT = Aws::String>
  ListCodeReviewJobTasksRequest& WithCodeReviewJobId(CodeReviewJobIdT&& value) {
   ...
   */
  inline StepName GetStepName() const { return m_stepName; }
  inline bool StepNameHasBeenSet() const { return m_stepNameHasBeenSet; }
  inline void SetStepName(StepName value) {
    m_stepNameHasBeenSet = true;
    m_stepName = value;
  }
  inline ListCodeReviewJobTasksRequest& WithStepName(StepName value) {
    SetStepName(value);
    return *this;
  }
  ///@}
  ...
  template <typename CategoryNameT = Aws::String>
  ListCodeReviewJobTasksRequest& WithCategoryName(CategoryNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeReviewJobTasksRequest& WithNextToken(NextTokenT&& value) {
 ...
 private:
  ...
  StepName m_stepName{StepName::NOT_SET};
