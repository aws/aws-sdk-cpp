...
namespace Model {
/**
 * <p>Output for the UpdateThreatModel operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/securityagent-2025-09-06/UpdateThreatModelOutput">AWS
 * API Reference</a></p>
 */
class UpdateThreatModelResult {
 public:
  AWS_SECURITYAGENT_API UpdateThreatModelResult() = default;
  AWS_SECURITYAGENT_API UpdateThreatModelResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SECURITYAGENT_API UpdateThreatModelResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ThreatModelIdT = Aws::String>
  UpdateThreatModelResult& WithThreatModelId(ThreatModelIdT&& value) {
  ...
  template <typename TitleT = Aws::String>
  UpdateThreatModelResult& WithTitle(TitleT&& value) {
  ...
  template <typename AgentSpaceIdT = Aws::String>
  UpdateThreatModelResult& WithAgentSpaceId(AgentSpaceIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateThreatModelResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename AssetsT = Assets>
  UpdateThreatModelResult& WithAssets(AssetsT&& value) {
  ...
  template <typename ScopeDocsT = Aws::Vector<DocumentInfo>>
  UpdateThreatModelResult& WithScopeDocs(ScopeDocsT&& value) {
    SetScopeDocs(std::forward<ScopeDocsT>(value));
    return *this;
  }
  template <typename ScopeDocsT = DocumentInfo>
  UpdateThreatModelResult& AddScopeDocs(ScopeDocsT&& value) {
    m_scopeDocsHasBeenSet = true;
  ...
  template <typename ServiceRoleT = Aws::String>
  UpdateThreatModelResult& WithServiceRole(ServiceRoleT&& value) {
  ...
  template <typename LogConfigT = CloudWatchLog>
  UpdateThreatModelResult& WithLogConfig(LogConfigT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateThreatModelResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateThreatModelResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateThreatModelResult& WithRequestId(RequestIdT&& value) {
