...
/**
 */
class DeleteIntegrationRequest : public SecurityAgentRequest {
 public:
  AWS_SECURITYAGENT_API DeleteIntegrationRequest() = default;
  ...
  template <typename IntegrationIdT = Aws::String>
  DeleteIntegrationRequest& WithIntegrationId(IntegrationIdT&& value) {
