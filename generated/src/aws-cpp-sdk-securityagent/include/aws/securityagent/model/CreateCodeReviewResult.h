...
namespace Model {
/**
 * <p>Output for the CreateCodeReview operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/securityagent-2025-09-06/CreateCodeReviewOutput">AWS
 * API Reference</a></p>
 */
class CreateCodeReviewResult {
 public:
  ...
  inline CreateCodeReviewResult& WithCodeRemediationStrategy(CodeRemediationStrategy value) {
  ...
  inline CreateCodeReviewResult& WithValidationMode(ValidationMode value) {
  ...
  inline CreateCodeReviewResult& WithMaxTaskHours(double value) {
  ...
  template <typename ReportDestinationT = ReportDestination>
  CreateCodeReviewResult& WithReportDestination(ReportDestinationT&& value) {
  ...
  template <typename ReportFiltersT = ReportFilters>
  CreateCodeReviewResult& WithReportFilters(ReportFiltersT&& value) {
