...
namespace Model {
class DescribePrivateConnectionResult {
 public:
  AWS_SECURITYAGENT_API DescribePrivateConnectionResult() = default;
  AWS_SECURITYAGENT_API DescribePrivateConnectionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SECURITYAGENT_API DescribePrivateConnectionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline DescribePrivateConnectionResult& WithType(PrivateConnectionType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline DescribePrivateConnectionResult& WithStatus(PrivateConnectionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
