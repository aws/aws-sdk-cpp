...
class ListTagsForResourceResult {
 public:
  AWS_SECURITYAGENT_API ListTagsForResourceResult() = default;
  AWS_SECURITYAGENT_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SECURITYAGENT_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
