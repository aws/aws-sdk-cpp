...
class ValidationException {
 public:
  AWS_SECURITYAGENT_API ValidationException() = default;
  AWS_SECURITYAGENT_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
  AWS_SECURITYAGENT_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
