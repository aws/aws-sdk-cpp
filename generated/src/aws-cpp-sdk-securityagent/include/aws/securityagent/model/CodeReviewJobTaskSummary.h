...
/**
 * <p>Contains summary information about a code review job task.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/securityagent-2025-09-06/CodeReviewJobTaskSummary">AWS
 * API Reference</a></p>
 */
class CodeReviewJobTaskSummary {
 public:
  ...
  inline CodeReviewJobTaskSummary& WithRiskType(RiskType value) {
    SetRiskType(value);
    return *this;
  }
  ///@}
  ...
  inline CodeReviewJobTaskSummary& WithExecutionStatus(TaskExecutionStatus value) {
