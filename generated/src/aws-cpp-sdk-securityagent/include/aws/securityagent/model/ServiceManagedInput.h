...
/**
 * <p>The configuration for a service-managed private connection.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/securityagent-2025-09-06/ServiceManagedInput">AWS
 * API Reference</a></p>
 */
class ServiceManagedInput {
 public:
  ...
  ///@{
  /**
   * <p>The number of IPv4 addresses in each elastic network interface for the
   * service-managed resource gateway.</p>
   */
  ...
  ///@{
  /**
   * <p>The DNS resolution mode for the resource gateway. Defaults to PUBLIC when not
   * set.</p>
   */
