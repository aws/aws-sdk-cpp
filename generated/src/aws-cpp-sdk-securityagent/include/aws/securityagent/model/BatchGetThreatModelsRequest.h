...
/**
 * <p>Input for retrieving multiple threat models by their IDs.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/securityagent-2025-09-06/BatchGetThreatModelsInput">AWS
 * API Reference</a></p>
 */
class BatchGetThreatModelsRequest : public SecurityAgentRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "BatchGetThreatModels"; }
