...
class CreatePrivateConnectionResult {
 public:
  AWS_SECURITYAGENT_API CreatePrivateConnectionResult() = default;
  AWS_SECURITYAGENT_API CreatePrivateConnectionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SECURITYAGENT_API CreatePrivateConnectionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
