...
namespace Model {
/**
 * <p>Output for the UpdateThreat operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/securityagent-2025-09-06/UpdateThreatOutput">AWS
 * API Reference</a></p>
 */
class UpdateThreatResult {
 public:
  ...
  inline UpdateThreatResult& WithSeverity(ThreatSeverity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateThreatResult& WithStatus(ThreatStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateThreatResult& AddStride(StrideCategory value) {
    m_strideHasBeenSet = true;
  ...
  inline UpdateThreatResult& WithCreatedBy(ThreatActor value) {
    SetCreatedBy(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateThreatResult& WithUpdatedBy(ThreatActor value) {
    SetUpdatedBy(value);
    return *this;
  }
  ///@}
