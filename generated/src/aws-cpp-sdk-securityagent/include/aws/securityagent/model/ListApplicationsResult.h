...
class ListApplicationsResult {
 public:
  AWS_SECURITYAGENT_API ListApplicationsResult() = default;
  AWS_SECURITYAGENT_API ListApplicationsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SECURITYAGENT_API ListApplicationsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>List of application summaries</p>
   */
