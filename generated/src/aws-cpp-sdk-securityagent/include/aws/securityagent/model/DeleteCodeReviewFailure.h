...
/**
 * <p>Contains information about a code review that failed to delete.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/securityagent-2025-09-06/DeleteCodeReviewFailure">AWS
 * API Reference</a></p>
 */
class DeleteCodeReviewFailure {
 public:
  AWS_SECURITYAGENT_API DeleteCodeReviewFailure() = default;
  AWS_SECURITYAGENT_API DeleteCodeReviewFailure(Aws::Utils::Json::JsonView jsonValue);
  AWS_SECURITYAGENT_API DeleteCodeReviewFailure& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename CodeReviewIdT = Aws::String>
  DeleteCodeReviewFailure& WithCodeReviewId(CodeReviewIdT&& value) {
  ...
  template <typename ReasonT = Aws::String>
  DeleteCodeReviewFailure& WithReason(ReasonT&& value) {
