...
/**
 */
class GetSecurityRequirementPackRequest : public SecurityAgentRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetSecurityRequirementPack"; }
