...
class S3EncryptionConfiguration {
 public:
  ...
  inline void SetObjectEncryptionType(S3ObjectEncryptionType value) {
    m_objectEncryptionTypeHasBeenSet = true;
    m_objectEncryptionType = value;
  }
  inline S3EncryptionConfiguration& WithObjectEncryptionType(S3ObjectEncryptionType value) {
    SetObjectEncryptionType(value);
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyArnT = Aws::String>
  S3EncryptionConfiguration& WithKmsKeyArn(KmsKeyArnT&& value) {
