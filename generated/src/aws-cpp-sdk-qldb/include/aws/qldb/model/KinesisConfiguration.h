...
class KinesisConfiguration {
 public:
  ...
  template <typename StreamArnT = Aws::String>
  KinesisConfiguration& WithStreamArn(StreamArnT&& value) {
  ...
  inline void SetAggregationEnabled(bool value) {
    m_aggregationEnabledHasBeenSet = true;
    m_aggregationEnabled = value;
  }
  inline KinesisConfiguration& WithAggregationEnabled(bool value) {
    SetAggregationEnabled(value);
    return *this;
  }
  ///@}
 private:
