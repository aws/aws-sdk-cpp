...
class ListJournalKinesisStreamsForLedgerResult {
 public:
  ...
  template <typename StreamsT = Aws::Vector<JournalKinesisStreamDescription>>
  ListJournalKinesisStreamsForLedgerResult& WithStreams(StreamsT&& value) {
    SetStreams(std::forward<StreamsT>(value));
    return *this;
  }
  template <typename StreamsT = JournalKinesisStreamDescription>
  ListJournalKinesisStreamsForLedgerResult& AddStreams(StreamsT&& value) {
    m_streamsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListJournalKinesisStreamsForLedgerResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListJournalKinesisStreamsForLedgerResult& WithRequestId(RequestIdT&& value) {
