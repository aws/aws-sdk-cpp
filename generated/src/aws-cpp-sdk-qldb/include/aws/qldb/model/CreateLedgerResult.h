...
class CreateLedgerResult {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateLedgerResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateLedgerResult& WithArn(ArnT&& value) {
  ...
  inline void SetState(LedgerState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline CreateLedgerResult& WithState(LedgerState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  CreateLedgerResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  inline CreateLedgerResult& WithPermissionsMode(PermissionsMode value) {
  ...
  inline CreateLedgerResult& WithDeletionProtection(bool value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  CreateLedgerResult& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateLedgerResult& WithRequestId(RequestIdT&& value) {
