...
class GetRevisionRequest : public QLDBRequest {
 public:
  ...
  void SetBlockAddress(BlockAddressT&& value) {
    m_blockAddressHasBeenSet = true;
    m_blockAddress = std::forward<BlockAddressT>(value);
  }
  template <typename BlockAddressT = ValueHolder>
  GetRevisionRequest& WithBlockAddress(BlockAddressT&& value) {
    SetBlockAddress(std::forward<BlockAddressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDigestTipAddress(DigestTipAddressT&& value) {
    ...
    m_digestTipAddress = std::forward<DigestTipAddressT>(value);
  }
  template <typename DigestTipAddressT = ValueHolder>
  GetRevisionRequest& WithDigestTipAddress(DigestTipAddressT&& value) {
    SetDigestTipAddress(std::forward<DigestTipAddressT>(value));
    return *this;
  }
  ///@}
 private:
