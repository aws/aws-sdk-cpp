...
namespace Model
{
  ...
  {
  public:
    AWS_QLDB_API ListJournalS3ExportsRequest();
    ...
    inline ListJournalS3ExportsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
    inline ListJournalS3ExportsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
    inline ListJournalS3ExportsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ///@}
  private:
