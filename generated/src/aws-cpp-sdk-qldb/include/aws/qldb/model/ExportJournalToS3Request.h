...
class ExportJournalToS3Request : public QLDBRequest {
 public:
  ...
  void SetInclusiveStartTime(InclusiveStartTimeT&& value) {
    ...
    m_inclusiveStartTime = std::forward<InclusiveStartTimeT>(value);
  }
  template <typename InclusiveStartTimeT = Aws::Utils::DateTime>
  ExportJournalToS3Request& WithInclusiveStartTime(InclusiveStartTimeT&& value) {
    SetInclusiveStartTime(std::forward<InclusiveStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExclusiveEndTime(ExclusiveEndTimeT&& value) {
    ...
    m_exclusiveEndTime = std::forward<ExclusiveEndTimeT>(value);
  }
  template <typename ExclusiveEndTimeT = Aws::Utils::DateTime>
  ExportJournalToS3Request& WithExclusiveEndTime(ExclusiveEndTimeT&& value) {
    SetExclusiveEndTime(std::forward<ExclusiveEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline ExportJournalToS3Request& WithOutputFormat(OutputFormat value) {
