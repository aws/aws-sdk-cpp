...
class LedgerEncryptionDescription {
 public:
  ...
  inline void SetEncryptionStatus(EncryptionStatus value) {
    m_encryptionStatusHasBeenSet = true;
    m_encryptionStatus = value;
  }
  inline LedgerEncryptionDescription& WithEncryptionStatus(EncryptionStatus value) {
  ...
  void SetInaccessibleKmsKeyDateTime(InaccessibleKmsKeyDateTimeT&& value) {
    ...
    m_inaccessibleKmsKeyDateTime = std::forward<InaccessibleKmsKeyDateTimeT>(value);
  }
  template <typename InaccessibleKmsKeyDateTimeT = Aws::Utils::DateTime>
  LedgerEncryptionDescription& WithInaccessibleKmsKeyDateTime(InaccessibleKmsKeyDateTimeT&& value) {
    SetInaccessibleKmsKeyDateTime(std::forward<InaccessibleKmsKeyDateTimeT>(value));
    return *this;
  }
  ///@}
 private:
