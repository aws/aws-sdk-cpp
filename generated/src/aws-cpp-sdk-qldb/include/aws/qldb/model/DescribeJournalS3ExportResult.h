...
class DescribeJournalS3ExportResult {
 public:
  ...
  void SetExportDescription(ExportDescriptionT&& value) {
    m_exportDescriptionHasBeenSet = true;
    m_exportDescription = std::forward<ExportDescriptionT>(value);
  }
  template <typename ExportDescriptionT = JournalS3ExportDescription>
  DescribeJournalS3ExportResult& WithExportDescription(ExportDescriptionT&& value) {
    SetExportDescription(std::forward<ExportDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeJournalS3ExportResult& WithRequestId(RequestIdT&& value) {
