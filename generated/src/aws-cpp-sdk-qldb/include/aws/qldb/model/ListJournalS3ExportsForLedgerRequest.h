...
class ListJournalS3ExportsForLedgerRequest : public QLDBRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  ListJournalS3ExportsForLedgerRequest& WithName(NameT&& value) {
  ...
  inline ListJournalS3ExportsForLedgerRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListJournalS3ExportsForLedgerRequest& WithNextToken(NextTokenT&& value) {
