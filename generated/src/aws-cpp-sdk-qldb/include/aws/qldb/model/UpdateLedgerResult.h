...
class UpdateLedgerResult {
 public:
  ...
  inline UpdateLedgerResult& WithState(LedgerState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateLedgerResult& WithDeletionProtection(bool value) {
  ...
  void SetEncryptionDescription(EncryptionDescriptionT&& value) {
    ...
    m_encryptionDescription = std::forward<EncryptionDescriptionT>(value);
  }
  template <typename EncryptionDescriptionT = LedgerEncryptionDescription>
  UpdateLedgerResult& WithEncryptionDescription(EncryptionDescriptionT&& value) {
    SetEncryptionDescription(std::forward<EncryptionDescriptionT>(value));
    return *this;
  }
  ///@}
