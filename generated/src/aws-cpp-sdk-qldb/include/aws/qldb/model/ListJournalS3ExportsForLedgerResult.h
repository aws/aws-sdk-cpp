...
class ListJournalS3ExportsForLedgerResult {
 public:
  AWS_QLDB_API ListJournalS3ExportsForLedgerResult() = default;
  ...
  ///@{
  /**
   * <p>The journal export jobs that are currently associated with the specified
   * ledger.</p>
   */
  ...
  template <typename JournalS3ExportsT = Aws::Vector<JournalS3ExportDescription>>
  ListJournalS3ExportsForLedgerResult& WithJournalS3Exports(JournalS3ExportsT&& value) {
    SetJournalS3Exports(std::forward<JournalS3ExportsT>(value));
    return *this;
  }
  template <typename JournalS3ExportsT = JournalS3ExportDescription>
  ListJournalS3ExportsForLedgerResult& AddJournalS3Exports(JournalS3ExportsT&& value) {
    m_journalS3ExportsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListJournalS3ExportsForLedgerResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListJournalS3ExportsForLedgerResult& WithRequestId(RequestIdT&& value) {
