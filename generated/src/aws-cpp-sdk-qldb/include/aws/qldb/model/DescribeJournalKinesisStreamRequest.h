...
class DescribeJournalKinesisStreamRequest : public QLDBRequest {
 public:
  ...
  void SetLedgerName(LedgerNameT&& value) {
    ...
    m_ledgerName = std::forward<LedgerNameT>(value);
  }
  template <typename LedgerNameT = Aws::String>
  DescribeJournalKinesisStreamRequest& WithLedgerName(LedgerNameT&& value) {
    SetLedgerName(std::forward<LedgerNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StreamIdT = Aws::String>
  DescribeJournalKinesisStreamRequest& WithStreamId(StreamIdT&& value) {
