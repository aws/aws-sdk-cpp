...
namespace Model
{
  ...
  {
  public:
    AWS_QLDB_API ResourceAlreadyExistsException() = default;
    ...
    template<typename ResourceNameT = Aws::String>
    ResourceAlreadyExistsException& WithResourceName(ResourceNameT&& value) { SetResourceName(std::forward<ResourceNameT>(value)); return *this;}
    ///@}
  private:
