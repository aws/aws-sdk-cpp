...
class ResourcePreconditionNotMetException {
 public:
  ...
  template <typename MessageT = Aws::String>
  ResourcePreconditionNotMetException& WithMessage(MessageT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  ResourcePreconditionNotMetException& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  ResourcePreconditionNotMetException& WithResourceName(ResourceNameT&& value) {
