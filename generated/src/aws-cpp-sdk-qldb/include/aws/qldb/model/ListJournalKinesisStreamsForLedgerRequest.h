...
class ListJournalKinesisStreamsForLedgerRequest : public QLDBRequest {
 public:
  ...
  template <typename LedgerNameT = Aws::String>
  ListJournalKinesisStreamsForLedgerRequest& WithLedgerName(LedgerNameT&& value) {
  ...
  inline ListJournalKinesisStreamsForLedgerRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListJournalKinesisStreamsForLedgerRequest& WithNextToken(NextTokenT&& value) {
