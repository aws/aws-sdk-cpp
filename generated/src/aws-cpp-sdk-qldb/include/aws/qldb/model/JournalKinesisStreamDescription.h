...
class JournalKinesisStreamDescription {
 public:
  ...
  inline JournalKinesisStreamDescription& WithStatus(StreamStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetKinesisConfiguration(KinesisConfigurationT&& value) {
    ...
    m_kinesisConfiguration = std::forward<KinesisConfigurationT>(value);
  }
  template <typename KinesisConfigurationT = KinesisConfiguration>
  JournalKinesisStreamDescription& WithKinesisConfiguration(KinesisConfigurationT&& value) {
    SetKinesisConfiguration(std::forward<KinesisConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetErrorCause(ErrorCause value) {
    m_errorCauseHasBeenSet = true;
    m_errorCause = value;
  }
  inline JournalKinesisStreamDescription& WithErrorCause(ErrorCause value) {
    SetErrorCause(value);
    return *this;
  }
  ///@}
