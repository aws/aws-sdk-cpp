...
class JournalS3ExportDescription {
 public:
  ...
  void SetExportCreationTime(ExportCreationTimeT&& value) {
    ...
    m_exportCreationTime = std::forward<ExportCreationTimeT>(value);
  }
  template <typename ExportCreationTimeT = Aws::Utils::DateTime>
  JournalS3ExportDescription& WithExportCreationTime(ExportCreationTimeT&& value) {
    SetExportCreationTime(std::forward<ExportCreationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline JournalS3ExportDescription& WithStatus(ExportStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline JournalS3ExportDescription& WithOutputFormat(OutputFormat value) {
