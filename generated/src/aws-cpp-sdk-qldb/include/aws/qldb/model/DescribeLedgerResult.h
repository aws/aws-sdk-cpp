...
class DescribeLedgerResult {
 public:
  ...
  inline DescribeLedgerResult& WithState(LedgerState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeLedgerResult& WithPermissionsMode(PermissionsMode value) {
  ...
  inline DescribeLedgerResult& WithDeletionProtection(bool value) {
