...
class ListJournalS3ExportsResult {
 public:
  ...
  void SetJournalS3Exports(JournalS3ExportsT&& value) {
    m_journalS3ExportsHasBeenSet = true;
    m_journalS3Exports = std::forward<JournalS3ExportsT>(value);
  }
  template <typename JournalS3ExportsT = Aws::Vector<JournalS3ExportDescription>>
  ListJournalS3ExportsResult& WithJournalS3Exports(JournalS3ExportsT&& value) {
    SetJournalS3Exports(std::forward<JournalS3ExportsT>(value));
    return *this;
  }
  template <typename JournalS3ExportsT = JournalS3ExportDescription>
  ListJournalS3ExportsResult& AddJournalS3Exports(JournalS3ExportsT&& value) {
    m_journalS3ExportsHasBeenSet = true;
    m_journalS3Exports.emplace_back(std::forward<JournalS3ExportsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListJournalS3ExportsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListJournalS3ExportsResult& WithRequestId(RequestIdT&& value) {
