...
namespace Model
{
  ...
  /**
   */
  class DeleteLedgerRequest : public QLDBRequest
  {
  public:
    AWS_QLDB_API DeleteLedgerRequest() = default;
    ...
    template<typename NameT = Aws::String>
    DeleteLedgerRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
