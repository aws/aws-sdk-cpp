...
class UpdateLedgerPermissionsModeResult {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateLedgerPermissionsModeResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateLedgerPermissionsModeResult& WithArn(ArnT&& value) {
  ...
  inline void SetPermissionsMode(PermissionsMode value) {
    m_permissionsModeHasBeenSet = true;
    m_permissionsMode = value;
  }
  inline UpdateLedgerPermissionsModeResult& WithPermissionsMode(PermissionsMode value) {
    SetPermissionsMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateLedgerPermissionsModeResult& WithRequestId(RequestIdT&& value) {
