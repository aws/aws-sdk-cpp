 ...
 */
using QLDBEndpointProviderBase = EndpointProviderBase<QLDBClientConfiguration, QLDBBuiltInParameters, QLDBClientContextParameters>;

using QLDBDefaultEpProviderBase = DefaultEndpointProvider<QLDBClientConfiguration, QLDBBuiltInParameters, QLDBClientContextParameters>;
