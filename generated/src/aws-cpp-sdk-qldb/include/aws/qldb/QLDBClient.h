...
class AWS_QLDB_API QLDBClient : public Aws::Client::AWSJsonClient, public Aws::Client::ClientWithAsyncTemplateMethods<QLDBClient> {
 public:
   ...
   */
  QLDBClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<QLDBEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelJournalKinesisStreamOutcome CancelJournalKinesisStream(
      const Model::CancelJournalKinesisStreamRequest& request) const;

  /**
   * A Callable wrapper for CancelJournalKinesisStream that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CancelJournalKinesisStreamRequestT = Model::CancelJournalKinesisStreamRequest>
  Model::CancelJournalKinesisStreamOutcomeCallable CancelJournalKinesisStreamCallable(
      const CancelJournalKinesisStreamRequestT& request) const {
    return SubmitCallable(&QLDBClient::CancelJournalKinesisStream, request);
  }

  /**
   * An Async wrapper for CancelJournalKinesisStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelJournalKinesisStreamRequestT = Model::CancelJournalKinesisStreamRequest>
  void CancelJournalKinesisStreamAsync(const CancelJournalKinesisStreamRequestT& request,
                                       const CancelJournalKinesisStreamResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateLedger that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateLedgerRequestT = Model::CreateLedgerRequest>
  void CreateLedgerAsync(const CreateLedgerRequestT& request, const CreateLedgerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteLedger that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteLedgerRequestT = Model::DeleteLedgerRequest>
  void DeleteLedgerAsync(const DeleteLedgerRequestT& request, const DeleteLedgerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeJournalKinesisStreamOutcome DescribeJournalKinesisStream(
      const Model::DescribeJournalKinesisStreamRequest& request) const;

  /**
   * A Callable wrapper for DescribeJournalKinesisStream that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeJournalKinesisStreamRequestT = Model::DescribeJournalKinesisStreamRequest>
  Model::DescribeJournalKinesisStreamOutcomeCallable DescribeJournalKinesisStreamCallable(
      const DescribeJournalKinesisStreamRequestT& request) const {
    return SubmitCallable(&QLDBClient::DescribeJournalKinesisStream, request);
  }

  /**
   * An Async wrapper for DescribeJournalKinesisStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeJournalKinesisStreamRequestT = Model::DescribeJournalKinesisStreamRequest>
  void DescribeJournalKinesisStreamAsync(const DescribeJournalKinesisStreamRequestT& request,
                                         const DescribeJournalKinesisStreamResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeJournalS3Export that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeJournalS3Export that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeJournalS3ExportRequestT = Model::DescribeJournalS3ExportRequest>
  void DescribeJournalS3ExportAsync(const DescribeJournalS3ExportRequestT& request,
                                    const DescribeJournalS3ExportResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeLedger that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeLedgerRequestT = Model::DescribeLedgerRequest>
  void DescribeLedgerAsync(const DescribeLedgerRequestT& request, const DescribeLedgerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExportJournalToS3 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExportJournalToS3 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ExportJournalToS3RequestT = Model::ExportJournalToS3Request>
  void ExportJournalToS3Async(const ExportJournalToS3RequestT& request, const ExportJournalToS3ResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBlock that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBlockRequestT = Model::GetBlockRequest>
  void GetBlockAsync(const GetBlockRequestT& request, const GetBlockResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDigest that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDigestRequestT = Model::GetDigestRequest>
  void GetDigestAsync(const GetDigestRequestT& request, const GetDigestResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRevision that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRevisionRequestT = Model::GetRevisionRequest>
  void GetRevisionAsync(const GetRevisionRequestT& request, const GetRevisionResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListJournalKinesisStreamsForLedgerOutcome ListJournalKinesisStreamsForLedger(
      const Model::ListJournalKinesisStreamsForLedgerRequest& request) const;

  /**
   * A Callable wrapper for ListJournalKinesisStreamsForLedger that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListJournalKinesisStreamsForLedgerRequestT = Model::ListJournalKinesisStreamsForLedgerRequest>
  Model::ListJournalKinesisStreamsForLedgerOutcomeCallable ListJournalKinesisStreamsForLedgerCallable(
      const ListJournalKinesisStreamsForLedgerRequestT& request) const {
    return SubmitCallable(&QLDBClient::ListJournalKinesisStreamsForLedger, request);
  }

  /**
   * An Async wrapper for ListJournalKinesisStreamsForLedger that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListJournalKinesisStreamsForLedgerRequestT = Model::ListJournalKinesisStreamsForLedgerRequest>
  void ListJournalKinesisStreamsForLedgerAsync(const ListJournalKinesisStreamsForLedgerRequestT& request,
                                               const ListJournalKinesisStreamsForLedgerResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListJournalS3Exports that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListJournalS3Exports that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListJournalS3ExportsRequestT = Model::ListJournalS3ExportsRequest>
  void ListJournalS3ExportsAsync(const ListJournalS3ExportsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListJournalS3ExportsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListJournalS3ExportsForLedgerOutcome ListJournalS3ExportsForLedger(
      const Model::ListJournalS3ExportsForLedgerRequest& request) const;

  /**
   * A Callable wrapper for ListJournalS3ExportsForLedger that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListJournalS3ExportsForLedgerRequestT = Model::ListJournalS3ExportsForLedgerRequest>
  Model::ListJournalS3ExportsForLedgerOutcomeCallable ListJournalS3ExportsForLedgerCallable(
      const ListJournalS3ExportsForLedgerRequestT& request) const {
    return SubmitCallable(&QLDBClient::ListJournalS3ExportsForLedger, request);
  }

  /**
   * An Async wrapper for ListJournalS3ExportsForLedger that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListJournalS3ExportsForLedgerRequestT = Model::ListJournalS3ExportsForLedgerRequest>
  void ListJournalS3ExportsForLedgerAsync(const ListJournalS3ExportsForLedgerRequestT& request,
                                          const ListJournalS3ExportsForLedgerResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListLedgers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLedgersRequestT = Model::ListLedgersRequest>
  void ListLedgersAsync(const ListLedgersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListLedgersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for StreamJournalToKinesis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StreamJournalToKinesis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StreamJournalToKinesisRequestT = Model::StreamJournalToKinesisRequest>
  void StreamJournalToKinesisAsync(const StreamJournalToKinesisRequestT& request,
                                   const StreamJournalToKinesisResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateLedger that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateLedgerRequestT = Model::UpdateLedgerRequest>
  void UpdateLedgerAsync(const UpdateLedgerRequestT& request, const UpdateLedgerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateLedgerPermissionsModeOutcome UpdateLedgerPermissionsMode(
      const Model::UpdateLedgerPermissionsModeRequest& request) const;

  /**
   * A Callable wrapper for UpdateLedgerPermissionsMode that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateLedgerPermissionsModeRequestT = Model::UpdateLedgerPermissionsModeRequest>
  Model::UpdateLedgerPermissionsModeOutcomeCallable UpdateLedgerPermissionsModeCallable(
      const UpdateLedgerPermissionsModeRequestT& request) const {
    return SubmitCallable(&QLDBClient::UpdateLedgerPermissionsMode, request);
  }

  /**
   * An Async wrapper for UpdateLedgerPermissionsMode that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateLedgerPermissionsModeRequestT = Model::UpdateLedgerPermissionsModeRequest>
  void UpdateLedgerPermissionsModeAsync(const UpdateLedgerPermissionsModeRequestT& request,
                                        const UpdateLedgerPermissionsModeResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
