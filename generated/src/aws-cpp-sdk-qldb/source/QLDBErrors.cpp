...
namespace QLDB {
template <>
AWS_QLDB_API ResourceNotFoundException QLDBError::GetModeledError() {
  assert(this->GetErrorType() == QLDBErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_QLDB_API InvalidParameterException QLDBError::GetModeledError() {
  assert(this->GetErrorType() == QLDBErrors::INVALID_PARAMETER);
  return InvalidParameterException(this->GetJsonPayload().View());
}

template <>
AWS_QLDB_API ResourceAlreadyExistsException QLDBError::GetModeledError() {
...
template <>
AWS_QLDB_API LimitExceededException QLDBError::GetModeledError() {
  assert(this->GetErrorType() == QLDBErrors::LIMIT_EXCEEDED);
  return LimitExceededException(this->GetJsonPayload().View());
}

template <>
AWS_QLDB_API ResourcePreconditionNotMetException QLDBError::GetModeledError() {
...
template <>
AWS_QLDB_API ResourceInUseException QLDBError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == INVALID_PARAMETER_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(QLDBErrors::INVALID_PARAMETER), RetryableType::NOT_RETRYABLE);
  } else if (hashCode == RESOURCE_ALREADY_EXISTS_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(QLDBErrors::RESOURCE_ALREADY_EXISTS), RetryableType::NOT_RETRYABLE);
  } else if (hashCode == LIMIT_EXCEEDED_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(QLDBErrors::LIMIT_EXCEEDED), RetryableType::RETRYABLE);
  } else if (hashCode == RESOURCE_PRECONDITION_NOT_MET_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(QLDBErrors::RESOURCE_PRECONDITION_NOT_MET), RetryableType::NOT_RETRYABLE);
  } else if (hashCode == RESOURCE_IN_USE_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(QLDBErrors::RESOURCE_IN_USE), RetryableType::NOT_RETRYABLE);
  }
