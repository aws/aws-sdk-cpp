...
namespace QLDB
{
const size_t QLDBEndpointRules::RulesBlobStrLen = 3716;
const size_t QLDBEndpointRules::RulesBlobSize = 3717;

using RulesBlobT = Aws::Array<const char, QLDBEndpointRules::RulesBlobSize>;
...
'd','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','q',
'l','d','b','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'h','t','t','p','s',':','/','/','q','l','d','b','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'"','h','t','t','p','s',':','/','/','q','l','d','b','.','{','R','e','g','i','o','n','}','.','{','P',
...
const char* QLDBEndpointRules::GetRulesBlob()
{
