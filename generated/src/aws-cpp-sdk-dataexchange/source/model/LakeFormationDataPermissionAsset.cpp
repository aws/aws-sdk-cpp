...
LakeFormationDataPermissionAsset::LakeFormationDataPermissionAsset(JsonView jsonValue) { *this = jsonValue; }
...
LakeFormationDataPermissionAsset& LakeFormationDataPermissionAsset::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("LakeFormationDataPermissionType")) {
    m_lakeFormationDataPermissionType = LakeFormationDataPermissionTypeMapper::GetLakeFormationDataPermissionTypeForName(
        jsonValue.GetString("LakeFormationDataPermissionType"));
...
JsonValue LakeFormationDataPermissionAsset::Jsonize() const {
  ...
  if (m_lakeFormationDataPermissionTypeHasBeenSet) {
    payload.WithString("LakeFormationDataPermissionType",
                       LakeFormationDataPermissionTypeMapper::GetNameForLakeFormationDataPermissionType(m_lakeFormationDataPermissionType));
  }
