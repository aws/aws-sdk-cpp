...
ExportRevisionsToS3ResponseDetails::ExportRevisionsToS3ResponseDetails(JsonView jsonValue) { *this = jsonValue; }
...
ExportRevisionsToS3ResponseDetails& ExportRevisionsToS3ResponseDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("RevisionDestinations")) {
    ...
    for (unsigned revisionDestinationsIndex = 0; revisionDestinationsIndex < revisionDestinationsJsonList.GetLength();
         ++revisionDestinationsIndex) {
