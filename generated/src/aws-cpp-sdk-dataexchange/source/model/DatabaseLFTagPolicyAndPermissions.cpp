...
DatabaseLFTagPolicyAndPermissions::DatabaseLFTagPolicyAndPermissions(JsonView jsonValue) { *this = jsonValue; }
  ...
  if (jsonValue.ValueExists("Permissions")) {
    ...
    for (unsigned permissionsIndex = 0; permissionsIndex < permissionsJsonList.GetLength(); ++permissionsIndex) {
      m_permissions.push_back(
          DatabaseLFTagPolicyPermissionMapper::GetDatabaseLFTagPolicyPermissionForName(permissionsJsonList[permissionsIndex].AsString()));
    }
  ...
  if (m_permissionsHasBeenSet) {
    ...
    for (unsigned permissionsIndex = 0; permissionsIndex < permissionsJsonList.GetLength(); ++permissionsIndex) {
      permissionsJsonList[permissionsIndex].AsString(
          DatabaseLFTagPolicyPermissionMapper::GetNameForDatabaseLFTagPolicyPermission(m_permissions[permissionsIndex]));
    }
