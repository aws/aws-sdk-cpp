...
{
const size_t DataExchangeEndpointRules::RulesBlobStrLen = 3748;
const size_t DataExchangeEndpointRules::RulesBlobSize = 3749;
...
't','t','p','s',':','/','/','d','a','t','a','e','x','c','h','a','n','g','e','-','f','i','p','s','.',
