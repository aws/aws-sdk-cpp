...
class AWS_DATAEXCHANGE_API DataExchangeClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DataExchangeClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DataExchangeEndpointProviderBase> endpointProvider = nullptr,
      const Aws::DataExchange::DataExchangeClientConfiguration& clientConfiguration = Aws::DataExchange::DataExchangeClientConfiguration());
  ...
  /**
   * An Async wrapper for AcceptDataGrant that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AcceptDataGrantRequestT = Model::AcceptDataGrantRequest>
  void AcceptDataGrantAsync(const AcceptDataGrantRequestT& request, const AcceptDataGrantResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateDataGrant that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateDataGrantRequestT = Model::CreateDataGrantRequest>
  void CreateDataGrantAsync(const CreateDataGrantRequestT& request, const CreateDataGrantResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEventAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEventAction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateEventActionRequestT = Model::CreateEventActionRequest>
  void CreateEventActionAsync(const CreateEventActionRequestT& request, const CreateEventActionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateRevision that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateRevisionRequestT = Model::CreateRevisionRequest>
  void CreateRevisionAsync(const CreateRevisionRequestT& request, const CreateRevisionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteDataGrant that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteDataGrantRequestT = Model::DeleteDataGrantRequest>
  void DeleteDataGrantAsync(const DeleteDataGrantRequestT& request, const DeleteDataGrantResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEventAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEventAction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteEventActionRequestT = Model::DeleteEventActionRequest>
  void DeleteEventActionAsync(const DeleteEventActionRequestT& request, const DeleteEventActionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteRevision that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRevisionRequestT = Model::DeleteRevisionRequest>
  void DeleteRevisionAsync(const DeleteRevisionRequestT& request, const DeleteRevisionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDataGrant that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDataGrantRequestT = Model::GetDataGrantRequest>
  void GetDataGrantAsync(const GetDataGrantRequestT& request, const GetDataGrantResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetEventAction that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetEventActionRequestT = Model::GetEventActionRequest>
  void GetEventActionAsync(const GetEventActionRequestT& request, const GetEventActionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReceivedDataGrant that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReceivedDataGrant that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetReceivedDataGrantRequestT = Model::GetReceivedDataGrantRequest>
  void GetReceivedDataGrantAsync(const GetReceivedDataGrantRequestT& request, const GetReceivedDataGrantResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListDataGrants that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListDataGrantsRequestT = Model::ListDataGrantsRequest>
  void ListDataGrantsAsync(const ListDataGrantsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListDataGrantsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDataSetRevisions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataSetRevisions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataSetRevisionsRequestT = Model::ListDataSetRevisionsRequest>
  void ListDataSetRevisionsAsync(const ListDataSetRevisionsRequestT& request, const ListDataSetRevisionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEventActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEventActions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEventActionsRequestT = Model::ListEventActionsRequest>
  void ListEventActionsAsync(const ListEventActionsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListEventActionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListReceivedDataGrants that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReceivedDataGrants that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListReceivedDataGrantsRequestT = Model::ListReceivedDataGrantsRequest>
  void ListReceivedDataGrantsAsync(const ListReceivedDataGrantsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListReceivedDataGrantsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListRevisionAssets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRevisionAssets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRevisionAssetsRequestT = Model::ListRevisionAssetsRequest>
  void ListRevisionAssetsAsync(const ListRevisionAssetsRequestT& request, const ListRevisionAssetsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RevokeRevision that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RevokeRevisionRequestT = Model::RevokeRevisionRequest>
  void RevokeRevisionAsync(const RevokeRevisionRequestT& request, const RevokeRevisionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SendApiAsset that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendApiAssetRequestT = Model::SendApiAssetRequest>
  void SendApiAssetAsync(const SendApiAssetRequestT& request, const SendApiAssetResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendDataSetNotification that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendDataSetNotification that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendDataSetNotificationRequestT = Model::SendDataSetNotificationRequest>
  void SendDataSetNotificationAsync(const SendDataSetNotificationRequestT& request,
                                    const SendDataSetNotificationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEventAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEventAction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateEventActionRequestT = Model::UpdateEventActionRequest>
  void UpdateEventActionAsync(const UpdateEventActionRequestT& request, const UpdateEventActionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateRevision that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRevisionRequestT = Model::UpdateRevisionRequest>
  void UpdateRevisionAsync(const UpdateRevisionRequestT& request, const UpdateRevisionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
