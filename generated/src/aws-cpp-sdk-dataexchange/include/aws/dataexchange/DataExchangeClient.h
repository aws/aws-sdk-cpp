...
namespace DataExchange
{
   ...
   */
  class AWS_DATAEXCHANGE_API DataExchangeClient : Aws::Client::ClientWithAsyncTemplateMethods<DataExchangeClient>,
    smithy::client::AwsSmithyClientT<Aws::DataExchange::SERVICE_NAME,
