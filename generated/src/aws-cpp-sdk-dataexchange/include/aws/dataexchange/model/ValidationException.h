...
class ValidationException {
 public:
  ...
  inline void SetExceptionCause(ExceptionCause value) {
    m_exceptionCauseHasBeenSet = true;
    m_exceptionCause = value;
  }
  inline ValidationException& WithExceptionCause(ExceptionCause value) {
    SetExceptionCause(value);
    return *this;
  }
  ///@}
 private:
