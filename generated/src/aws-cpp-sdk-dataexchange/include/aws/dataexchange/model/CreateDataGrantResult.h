...
class CreateDataGrantResult {
 public:
  ...
  inline CreateDataGrantResult& WithAcceptanceState(DataGrantAcceptanceState value) {
  ...
  inline CreateDataGrantResult& WithGrantDistributionScope(GrantDistributionScope value) {
  ...
  template <typename IdT = Aws::String>
  CreateDataGrantResult& WithId(IdT&& value) {
