...
class JobError {
 public:
  ...
  inline void SetCode(Code value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline JobError& WithCode(Code value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLimitName(JobErrorLimitName value) {
    m_limitNameHasBeenSet = true;
    m_limitName = value;
  }
  inline JobError& WithLimitName(JobErrorLimitName value) {
    SetLimitName(value);
    return *this;
  }
  ///@}
  ...
  inline JobError& WithLimitValue(double value) {
    SetLimitValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResourceType(JobErrorResourceTypes value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline JobError& WithResourceType(JobErrorResourceTypes value) {
