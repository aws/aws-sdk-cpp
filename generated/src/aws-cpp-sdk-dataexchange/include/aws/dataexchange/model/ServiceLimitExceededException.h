...
class ServiceLimitExceededException {
 public:
  ...
  inline void SetLimitName(LimitName value) {
    m_limitNameHasBeenSet = true;
    m_limitName = value;
  }
  inline ServiceLimitExceededException& WithLimitName(LimitName value) {
    SetLimitName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLimitValue(double value) {
    m_limitValueHasBeenSet = true;
    m_limitValue = value;
  }
  inline ServiceLimitExceededException& WithLimitValue(double value) {
    SetLimitValue(value);
    return *this;
  }
  ///@}
