...
class ScopeDetails {
 public:
  ...
  void SetLakeFormationTagPolicies(LakeFormationTagPoliciesT&& value) {
    ...
    m_lakeFormationTagPolicies = std::forward<LakeFormationTagPoliciesT>(value);
  }
  template <typename LakeFormationTagPoliciesT = Aws::Vector<LakeFormationTagPolicyDetails>>
  ScopeDetails& WithLakeFormationTagPolicies(LakeFormationTagPoliciesT&& value) {
    SetLakeFormationTagPolicies(std::forward<LakeFormationTagPoliciesT>(value));
    return *this;
  }
  ...
  ScopeDetails& AddLakeFormationTagPolicies(LakeFormationTagPoliciesT&& value) {
    m_lakeFormationTagPoliciesHasBeenSet = true;
    m_lakeFormationTagPolicies.emplace_back(std::forward<LakeFormationTagPoliciesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftDataShares(RedshiftDataSharesT&& value) {
    ...
    m_redshiftDataShares = std::forward<RedshiftDataSharesT>(value);
  }
  template <typename RedshiftDataSharesT = Aws::Vector<RedshiftDataShareDetails>>
  ScopeDetails& WithRedshiftDataShares(RedshiftDataSharesT&& value) {
    SetRedshiftDataShares(std::forward<RedshiftDataSharesT>(value));
    return *this;
  }
  ...
  ScopeDetails& AddRedshiftDataShares(RedshiftDataSharesT&& value) {
    m_redshiftDataSharesHasBeenSet = true;
    m_redshiftDataShares.emplace_back(std::forward<RedshiftDataSharesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3DataAccesses(S3DataAccessesT&& value) {
    ...
    m_s3DataAccesses = std::forward<S3DataAccessesT>(value);
  }
  template <typename S3DataAccessesT = Aws::Vector<S3DataAccessDetails>>
  ScopeDetails& WithS3DataAccesses(S3DataAccessesT&& value) {
    SetS3DataAccesses(std::forward<S3DataAccessesT>(value));
    return *this;
  }
  template <typename S3DataAccessesT = S3DataAccessDetails>
  ScopeDetails& AddS3DataAccesses(S3DataAccessesT&& value) {
    m_s3DataAccessesHasBeenSet = true;
    m_s3DataAccesses.emplace_back(std::forward<S3DataAccessesT>(value));
    return *this;
  }
  ///@}
 private:
