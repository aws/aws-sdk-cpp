...
class CreateS3DataAccessFromS3BucketResponseDetails {
 public:
  ...
  void SetAssetSource(AssetSourceT&& value) {
    m_assetSourceHasBeenSet = true;
    m_assetSource = std::forward<AssetSourceT>(value);
  }
  template <typename AssetSourceT = S3DataAccessAssetSourceEntry>
  CreateS3DataAccessFromS3BucketResponseDetails& WithAssetSource(AssetSourceT&& value) {
    SetAssetSource(std::forward<AssetSourceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DataSetIdT = Aws::String>
  CreateS3DataAccessFromS3BucketResponseDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  CreateS3DataAccessFromS3BucketResponseDetails& WithRevisionId(RevisionIdT&& value) {
