...
class ImportAssetsFromS3ResponseDetails {
 public:
  ...
  template <typename AssetSourcesT = Aws::Vector<AssetSourceEntry>>
  ImportAssetsFromS3ResponseDetails& WithAssetSources(AssetSourcesT&& value) {
    SetAssetSources(std::forward<AssetSourcesT>(value));
    return *this;
  }
  template <typename AssetSourcesT = AssetSourceEntry>
  ImportAssetsFromS3ResponseDetails& AddAssetSources(AssetSourcesT&& value) {
    m_assetSourcesHasBeenSet = true;
  ...
  template <typename DataSetIdT = Aws::String>
  ImportAssetsFromS3ResponseDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ImportAssetsFromS3ResponseDetails& WithRevisionId(RevisionIdT&& value) {
