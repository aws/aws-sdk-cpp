...
class UpdateAssetResult {
 public:
  AWS_DATAEXCHANGE_API UpdateAssetResult() = default;
  ...
  template <typename ArnT = Aws::String>
  UpdateAssetResult& WithArn(ArnT&& value) {
  ...
  template <typename AssetDetailsT = AssetDetails>
  UpdateAssetResult& WithAssetDetails(AssetDetailsT&& value) {
  ...
  inline UpdateAssetResult& WithAssetType(AssetType value) {
    SetAssetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateAssetResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  UpdateAssetResult& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  UpdateAssetResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename SourceIdT = Aws::String>
  UpdateAssetResult& WithSourceId(SourceIdT&& value) {
