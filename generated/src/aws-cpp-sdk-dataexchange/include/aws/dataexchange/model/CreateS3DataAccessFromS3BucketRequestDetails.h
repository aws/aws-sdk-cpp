...
class CreateS3DataAccessFromS3BucketRequestDetails {
 public:
  ...
  template <typename AssetSourceT = S3DataAccessAssetSourceEntry>
  CreateS3DataAccessFromS3BucketRequestDetails& WithAssetSource(AssetSourceT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  CreateS3DataAccessFromS3BucketRequestDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  CreateS3DataAccessFromS3BucketRequestDetails& WithRevisionId(RevisionIdT&& value) {
