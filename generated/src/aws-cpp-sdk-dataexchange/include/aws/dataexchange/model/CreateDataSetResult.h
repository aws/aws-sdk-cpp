...
namespace Model
{
  ...
  public:
    ...
    inline CreateDataSetResult& WithAssetType(AssetType value) { SetAssetType(value); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    CreateDataSetResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CreateDataSetResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    CreateDataSetResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    inline CreateDataSetResult& WithOrigin(Origin value) { SetOrigin(value); return *this;}
    ///@}
    ...
    template<typename OriginDetailsT = OriginDetails>
    CreateDataSetResult& WithOriginDetails(OriginDetailsT&& value) { SetOriginDetails(std::forward<OriginDetailsT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceIdT = Aws::String>
    CreateDataSetResult& WithSourceId(SourceIdT&& value) { SetSourceId(std::forward<SourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreateDataSetResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename UpdatedAtT = Aws::Utils::DateTime>
    CreateDataSetResult& WithUpdatedAt(UpdatedAtT&& value) { SetUpdatedAt(std::forward<UpdatedAtT>(value)); return *this;}
    ///@}
