...
class GetReceivedDataGrantRequest : public DataExchangeRequest {
 public:
  ...
  void SetDataGrantArn(DataGrantArnT&& value) {
    m_dataGrantArnHasBeenSet = true;
    m_dataGrantArn = std::forward<DataGrantArnT>(value);
  }
  template <typename DataGrantArnT = Aws::String>
  GetReceivedDataGrantRequest& WithDataGrantArn(DataGrantArnT&& value) {
    SetDataGrantArn(std::forward<DataGrantArnT>(value));
    return *this;
  }
  ///@}
 private:
