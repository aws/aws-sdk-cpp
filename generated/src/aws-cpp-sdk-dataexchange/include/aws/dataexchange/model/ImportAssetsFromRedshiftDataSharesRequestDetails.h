...
class ImportAssetsFromRedshiftDataSharesRequestDetails {
 public:
  ...
  template <typename AssetSourcesT = Aws::Vector<RedshiftDataShareAssetSourceEntry>>
  ImportAssetsFromRedshiftDataSharesRequestDetails& WithAssetSources(AssetSourcesT&& value) {
    SetAssetSources(std::forward<AssetSourcesT>(value));
    return *this;
  }
  template <typename AssetSourcesT = RedshiftDataShareAssetSourceEntry>
  ImportAssetsFromRedshiftDataSharesRequestDetails& AddAssetSources(AssetSourcesT&& value) {
    m_assetSourcesHasBeenSet = true;
  ...
  template <typename DataSetIdT = Aws::String>
  ImportAssetsFromRedshiftDataSharesRequestDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ImportAssetsFromRedshiftDataSharesRequestDetails& WithRevisionId(RevisionIdT&& value) {
