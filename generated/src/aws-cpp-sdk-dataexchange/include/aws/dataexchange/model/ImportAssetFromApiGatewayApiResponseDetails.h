...
class ImportAssetFromApiGatewayApiResponseDetails {
 public:
  ...
  template <typename ApiDescriptionT = Aws::String>
  ImportAssetFromApiGatewayApiResponseDetails& WithApiDescription(ApiDescriptionT&& value) {
  ...
  template <typename ApiIdT = Aws::String>
  ImportAssetFromApiGatewayApiResponseDetails& WithApiId(ApiIdT&& value) {
  ...
  template <typename ApiKeyT = Aws::String>
  ImportAssetFromApiGatewayApiResponseDetails& WithApiKey(ApiKeyT&& value) {
  ...
  template <typename ApiNameT = Aws::String>
  ImportAssetFromApiGatewayApiResponseDetails& WithApiName(ApiNameT&& value) {
  ...
  template <typename ApiSpecificationMd5HashT = Aws::String>
  ImportAssetFromApiGatewayApiResponseDetails& WithApiSpecificationMd5Hash(ApiSpecificationMd5HashT&& value) {
  ...
  void SetApiSpecificationUploadUrl(ApiSpecificationUploadUrlT&& value) {
    m_apiSpecificationUploadUrlHasBeenSet = true;
    m_apiSpecificationUploadUrl = std::forward<ApiSpecificationUploadUrlT>(value);
  }
  template <typename ApiSpecificationUploadUrlT = Aws::String>
  ImportAssetFromApiGatewayApiResponseDetails& WithApiSpecificationUploadUrl(ApiSpecificationUploadUrlT&& value) {
    SetApiSpecificationUploadUrl(std::forward<ApiSpecificationUploadUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApiSpecificationUploadUrlExpiresAt(ApiSpecificationUploadUrlExpiresAtT&& value) {
    m_apiSpecificationUploadUrlExpiresAtHasBeenSet = true;
    m_apiSpecificationUploadUrlExpiresAt = std::forward<ApiSpecificationUploadUrlExpiresAtT>(value);
  }
  template <typename ApiSpecificationUploadUrlExpiresAtT = Aws::Utils::DateTime>
  ImportAssetFromApiGatewayApiResponseDetails& WithApiSpecificationUploadUrlExpiresAt(ApiSpecificationUploadUrlExpiresAtT&& value) {
    SetApiSpecificationUploadUrlExpiresAt(std::forward<ApiSpecificationUploadUrlExpiresAtT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DataSetIdT = Aws::String>
  ImportAssetFromApiGatewayApiResponseDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  inline ImportAssetFromApiGatewayApiResponseDetails& WithProtocolType(ProtocolType value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ImportAssetFromApiGatewayApiResponseDetails& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename StageT = Aws::String>
  ImportAssetFromApiGatewayApiResponseDetails& WithStage(StageT&& value) {
