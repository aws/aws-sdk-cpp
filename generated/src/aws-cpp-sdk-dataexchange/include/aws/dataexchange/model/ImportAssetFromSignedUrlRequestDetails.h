...
class ImportAssetFromSignedUrlRequestDetails {
 public:
  ...
  template <typename AssetNameT = Aws::String>
  ImportAssetFromSignedUrlRequestDetails& WithAssetName(AssetNameT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  ImportAssetFromSignedUrlRequestDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  void SetMd5Hash(Md5HashT&& value) {
    m_md5HashHasBeenSet = true;
    m_md5Hash = std::forward<Md5HashT>(value);
  }
  template <typename Md5HashT = Aws::String>
  ImportAssetFromSignedUrlRequestDetails& WithMd5Hash(Md5HashT&& value) {
    SetMd5Hash(std::forward<Md5HashT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RevisionIdT = Aws::String>
  ImportAssetFromSignedUrlRequestDetails& WithRevisionId(RevisionIdT&& value) {
