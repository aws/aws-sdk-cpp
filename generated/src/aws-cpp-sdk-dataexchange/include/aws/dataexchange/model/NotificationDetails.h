...
class NotificationDetails {
 public:
  ...
  void SetDataUpdate(DataUpdateT&& value) {
    ...
    m_dataUpdate = std::forward<DataUpdateT>(value);
  }
  template <typename DataUpdateT = DataUpdateRequestDetails>
  NotificationDetails& WithDataUpdate(DataUpdateT&& value) {
    SetDataUpdate(std::forward<DataUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeprecation(DeprecationT&& value) {
    ...
    m_deprecation = std::forward<DeprecationT>(value);
  }
  template <typename DeprecationT = DeprecationRequestDetails>
  NotificationDetails& WithDeprecation(DeprecationT&& value) {
    SetDeprecation(std::forward<DeprecationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSchemaChange(SchemaChangeT&& value) {
    ...
    m_schemaChange = std::forward<SchemaChangeT>(value);
  }
  template <typename SchemaChangeT = SchemaChangeRequestDetails>
  NotificationDetails& WithSchemaChange(SchemaChangeT&& value) {
    SetSchemaChange(std::forward<SchemaChangeT>(value));
    return *this;
  }
  ///@}
 private:
