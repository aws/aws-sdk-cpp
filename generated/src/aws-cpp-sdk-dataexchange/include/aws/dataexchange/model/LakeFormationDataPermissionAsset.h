...
class LakeFormationDataPermissionAsset {
 public:
   ...
   */
  inline const LakeFormationDataPermissionDetails& GetLakeFormationDataPermissionDetails() const {
    return m_lakeFormationDataPermissionDetails;
  }
  ...
  void SetLakeFormationDataPermissionDetails(LakeFormationDataPermissionDetailsT&& value) {
    m_lakeFormationDataPermissionDetailsHasBeenSet = true;
    m_lakeFormationDataPermissionDetails = std::forward<LakeFormationDataPermissionDetailsT>(value);
  }
  template <typename LakeFormationDataPermissionDetailsT = LakeFormationDataPermissionDetails>
  LakeFormationDataPermissionAsset& WithLakeFormationDataPermissionDetails(LakeFormationDataPermissionDetailsT&& value) {
    SetLakeFormationDataPermissionDetails(std::forward<LakeFormationDataPermissionDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLakeFormationDataPermissionType(LakeFormationDataPermissionType value) {
    m_lakeFormationDataPermissionTypeHasBeenSet = true;
    m_lakeFormationDataPermissionType = value;
  }
  inline LakeFormationDataPermissionAsset& WithLakeFormationDataPermissionType(LakeFormationDataPermissionType value) {
    SetLakeFormationDataPermissionType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PermissionsT = Aws::Vector<LFPermission>>
  LakeFormationDataPermissionAsset& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  inline LakeFormationDataPermissionAsset& AddPermissions(LFPermission value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RoleArnT = Aws::String>
  LakeFormationDataPermissionAsset& WithRoleArn(RoleArnT&& value) {
