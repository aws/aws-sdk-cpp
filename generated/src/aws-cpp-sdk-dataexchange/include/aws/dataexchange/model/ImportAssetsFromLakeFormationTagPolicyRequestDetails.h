...
class ImportAssetsFromLakeFormationTagPolicyRequestDetails {
 public:
  AWS_DATAEXCHANGE_API ImportAssetsFromLakeFormationTagPolicyRequestDetails() = default;
  ...
  template <typename CatalogIdT = Aws::String>
  ImportAssetsFromLakeFormationTagPolicyRequestDetails& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseT = DatabaseLFTagPolicyAndPermissions>
  ImportAssetsFromLakeFormationTagPolicyRequestDetails& WithDatabase(DatabaseT&& value) {
  ...
  template <typename TableT = TableLFTagPolicyAndPermissions>
  ImportAssetsFromLakeFormationTagPolicyRequestDetails& WithTable(TableT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  ImportAssetsFromLakeFormationTagPolicyRequestDetails& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  ImportAssetsFromLakeFormationTagPolicyRequestDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ImportAssetsFromLakeFormationTagPolicyRequestDetails& WithRevisionId(RevisionIdT&& value) {
