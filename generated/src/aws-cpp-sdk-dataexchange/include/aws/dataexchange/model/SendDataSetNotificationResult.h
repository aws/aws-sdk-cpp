...
namespace Model
{
  ...
  {
  public:
    AWS_DATAEXCHANGE_API SendDataSetNotificationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    SendDataSetNotificationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
