...
class ImportAssetFromSignedUrlResponseDetails {
 public:
  ...
  template <typename AssetNameT = Aws::String>
  ImportAssetFromSignedUrlResponseDetails& WithAssetName(AssetNameT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  ImportAssetFromSignedUrlResponseDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename Md5HashT = Aws::String>
  ImportAssetFromSignedUrlResponseDetails& WithMd5Hash(Md5HashT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ImportAssetFromSignedUrlResponseDetails& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename SignedUrlT = Aws::String>
  ImportAssetFromSignedUrlResponseDetails& WithSignedUrl(SignedUrlT&& value) {
  ...
  template <typename SignedUrlExpiresAtT = Aws::Utils::DateTime>
  ImportAssetFromSignedUrlResponseDetails& WithSignedUrlExpiresAt(SignedUrlExpiresAtT&& value) {
