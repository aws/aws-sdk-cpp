...
class ExportAssetToSignedUrlRequestDetails {
 public:
  AWS_DATAEXCHANGE_API ExportAssetToSignedUrlRequestDetails() = default;
  ...
  template <typename AssetIdT = Aws::String>
  ExportAssetToSignedUrlRequestDetails& WithAssetId(AssetIdT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  ExportAssetToSignedUrlRequestDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ExportAssetToSignedUrlRequestDetails& WithRevisionId(RevisionIdT&& value) {
