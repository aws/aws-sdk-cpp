...
class ExportAssetsToS3RequestDetails {
 public:
  ...
  template <typename AssetDestinationsT = Aws::Vector<AssetDestinationEntry>>
  ExportAssetsToS3RequestDetails& WithAssetDestinations(AssetDestinationsT&& value) {
    SetAssetDestinations(std::forward<AssetDestinationsT>(value));
    return *this;
  }
  template <typename AssetDestinationsT = AssetDestinationEntry>
  ExportAssetsToS3RequestDetails& AddAssetDestinations(AssetDestinationsT&& value) {
    m_assetDestinationsHasBeenSet = true;
  ...
  template <typename DataSetIdT = Aws::String>
  ExportAssetsToS3RequestDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename EncryptionT = ExportServerSideEncryption>
  ExportAssetsToS3RequestDetails& WithEncryption(EncryptionT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ExportAssetsToS3RequestDetails& WithRevisionId(RevisionIdT&& value) {
