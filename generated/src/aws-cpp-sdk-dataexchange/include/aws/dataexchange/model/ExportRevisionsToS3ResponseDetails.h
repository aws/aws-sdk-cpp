...
class ExportRevisionsToS3ResponseDetails {
 public:
  ...
  template <typename DataSetIdT = Aws::String>
  ExportRevisionsToS3ResponseDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename EncryptionT = ExportServerSideEncryption>
  ExportRevisionsToS3ResponseDetails& WithEncryption(EncryptionT&& value) {
  ...
  void SetRevisionDestinations(RevisionDestinationsT&& value) {
    m_revisionDestinationsHasBeenSet = true;
    m_revisionDestinations = std::forward<RevisionDestinationsT>(value);
  }
  template <typename RevisionDestinationsT = Aws::Vector<RevisionDestinationEntry>>
  ExportRevisionsToS3ResponseDetails& WithRevisionDestinations(RevisionDestinationsT&& value) {
    SetRevisionDestinations(std::forward<RevisionDestinationsT>(value));
    return *this;
  }
  template <typename RevisionDestinationsT = RevisionDestinationEntry>
  ExportRevisionsToS3ResponseDetails& AddRevisionDestinations(RevisionDestinationsT&& value) {
    m_revisionDestinationsHasBeenSet = true;
    m_revisionDestinations.emplace_back(std::forward<RevisionDestinationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventActionArn(EventActionArnT&& value) {
    m_eventActionArnHasBeenSet = true;
    m_eventActionArn = std::forward<EventActionArnT>(value);
  }
  template <typename EventActionArnT = Aws::String>
  ExportRevisionsToS3ResponseDetails& WithEventActionArn(EventActionArnT&& value) {
    SetEventActionArn(std::forward<EventActionArnT>(value));
    return *this;
  }
  ///@}
 private:
