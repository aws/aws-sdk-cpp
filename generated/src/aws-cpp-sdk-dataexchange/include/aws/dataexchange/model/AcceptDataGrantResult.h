...
class AcceptDataGrantResult {
 public:
  ...
  inline AcceptDataGrantResult& WithAcceptanceState(DataGrantAcceptanceState value) {
  ...
  inline AcceptDataGrantResult& WithGrantDistributionScope(GrantDistributionScope value) {
