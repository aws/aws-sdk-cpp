...
class ListReceivedDataGrantsRequest : public DataExchangeRequest {
 public:
  ...
  inline ListReceivedDataGrantsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReceivedDataGrantsRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetAcceptanceState(AcceptanceStateT&& value) {
    m_acceptanceStateHasBeenSet = true;
    m_acceptanceState = std::forward<AcceptanceStateT>(value);
  }
  template <typename AcceptanceStateT = Aws::Vector<AcceptanceStateFilterValue>>
  ListReceivedDataGrantsRequest& WithAcceptanceState(AcceptanceStateT&& value) {
    SetAcceptanceState(std::forward<AcceptanceStateT>(value));
    return *this;
  }
  inline ListReceivedDataGrantsRequest& AddAcceptanceState(AcceptanceStateFilterValue value) {
    m_acceptanceStateHasBeenSet = true;
    m_acceptanceState.push_back(value);
    return *this;
  }
  ///@}
 private:
