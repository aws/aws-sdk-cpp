...
class GetDataGrantResult {
 public:
  ...
  inline GetDataGrantResult& WithAcceptanceState(DataGrantAcceptanceState value) {
  ...
  inline GetDataGrantResult& WithGrantDistributionScope(GrantDistributionScope value) {
