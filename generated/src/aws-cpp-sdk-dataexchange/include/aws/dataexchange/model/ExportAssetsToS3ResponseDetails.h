...
namespace Model
{
  ...
  {
  public:
    AWS_DATAEXCHANGE_API ExportAssetsToS3ResponseDetails() = default;
    ...
    template<typename AssetDestinationsT = Aws::Vector<AssetDestinationEntry>>
    ExportAssetsToS3ResponseDetails& WithAssetDestinations(AssetDestinationsT&& value) { SetAssetDestinations(std::forward<AssetDestinationsT>(value)); return *this;}
    template<typename AssetDestinationsT = AssetDestinationEntry>
    ExportAssetsToS3ResponseDetails& AddAssetDestinations(AssetDestinationsT&& value) { m_assetDestinationsHasBeenSet = true; m_assetDestinations.emplace_back(std::forward<AssetDestinationsT>(value)); return *this; }
    ///@}
    ...
    template<typename DataSetIdT = Aws::String>
    ExportAssetsToS3ResponseDetails& WithDataSetId(DataSetIdT&& value) { SetDataSetId(std::forward<DataSetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EncryptionT = ExportServerSideEncryption>
    ExportAssetsToS3ResponseDetails& WithEncryption(EncryptionT&& value) { SetEncryption(std::forward<EncryptionT>(value)); return *this;}
    ///@}
    ...
    template<typename RevisionIdT = Aws::String>
    ExportAssetsToS3ResponseDetails& WithRevisionId(RevisionIdT&& value) { SetRevisionId(std::forward<RevisionIdT>(value)); return *this;}
    ///@}
  private:
