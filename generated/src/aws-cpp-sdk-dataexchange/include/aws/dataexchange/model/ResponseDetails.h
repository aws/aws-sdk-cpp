...
class ResponseDetails {
 public:
  ...
  void SetExportAssetToSignedUrl(ExportAssetToSignedUrlT&& value) {
    ...
    m_exportAssetToSignedUrl = std::forward<ExportAssetToSignedUrlT>(value);
  }
  template <typename ExportAssetToSignedUrlT = ExportAssetToSignedUrlResponseDetails>
  ResponseDetails& WithExportAssetToSignedUrl(ExportAssetToSignedUrlT&& value) {
    SetExportAssetToSignedUrl(std::forward<ExportAssetToSignedUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportAssetsToS3(ExportAssetsToS3T&& value) {
    ...
    m_exportAssetsToS3 = std::forward<ExportAssetsToS3T>(value);
  }
  template <typename ExportAssetsToS3T = ExportAssetsToS3ResponseDetails>
  ResponseDetails& WithExportAssetsToS3(ExportAssetsToS3T&& value) {
    SetExportAssetsToS3(std::forward<ExportAssetsToS3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportRevisionsToS3(ExportRevisionsToS3T&& value) {
    ...
    m_exportRevisionsToS3 = std::forward<ExportRevisionsToS3T>(value);
  }
  template <typename ExportRevisionsToS3T = ExportRevisionsToS3ResponseDetails>
  ResponseDetails& WithExportRevisionsToS3(ExportRevisionsToS3T&& value) {
    SetExportRevisionsToS3(std::forward<ExportRevisionsToS3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetImportAssetFromSignedUrl(ImportAssetFromSignedUrlT&& value) {
    ...
    m_importAssetFromSignedUrl = std::forward<ImportAssetFromSignedUrlT>(value);
  }
  template <typename ImportAssetFromSignedUrlT = ImportAssetFromSignedUrlResponseDetails>
  ResponseDetails& WithImportAssetFromSignedUrl(ImportAssetFromSignedUrlT&& value) {
    SetImportAssetFromSignedUrl(std::forward<ImportAssetFromSignedUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImportAssetsFromS3(ImportAssetsFromS3T&& value) {
    ...
    m_importAssetsFromS3 = std::forward<ImportAssetsFromS3T>(value);
  }
  template <typename ImportAssetsFromS3T = ImportAssetsFromS3ResponseDetails>
  ResponseDetails& WithImportAssetsFromS3(ImportAssetsFromS3T&& value) {
    SetImportAssetsFromS3(std::forward<ImportAssetsFromS3T>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ImportAssetsFromRedshiftDataSharesResponseDetails& GetImportAssetsFromRedshiftDataShares() const {
    return m_importAssetsFromRedshiftDataShares;
  }
  ...
  void SetImportAssetsFromRedshiftDataShares(ImportAssetsFromRedshiftDataSharesT&& value) {
    ...
    m_importAssetsFromRedshiftDataShares = std::forward<ImportAssetsFromRedshiftDataSharesT>(value);
  }
  template <typename ImportAssetsFromRedshiftDataSharesT = ImportAssetsFromRedshiftDataSharesResponseDetails>
  ResponseDetails& WithImportAssetsFromRedshiftDataShares(ImportAssetsFromRedshiftDataSharesT&& value) {
    SetImportAssetsFromRedshiftDataShares(std::forward<ImportAssetsFromRedshiftDataSharesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ImportAssetFromApiGatewayApiResponseDetails& GetImportAssetFromApiGatewayApi() const {
    return m_importAssetFromApiGatewayApi;
  }
  ...
  void SetImportAssetFromApiGatewayApi(ImportAssetFromApiGatewayApiT&& value) {
    ...
    m_importAssetFromApiGatewayApi = std::forward<ImportAssetFromApiGatewayApiT>(value);
  }
  template <typename ImportAssetFromApiGatewayApiT = ImportAssetFromApiGatewayApiResponseDetails>
  ResponseDetails& WithImportAssetFromApiGatewayApi(ImportAssetFromApiGatewayApiT&& value) {
    SetImportAssetFromApiGatewayApi(std::forward<ImportAssetFromApiGatewayApiT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const CreateS3DataAccessFromS3BucketResponseDetails& GetCreateS3DataAccessFromS3Bucket() const {
    return m_createS3DataAccessFromS3Bucket;
  }
  ...
  void SetCreateS3DataAccessFromS3Bucket(CreateS3DataAccessFromS3BucketT&& value) {
    ...
    m_createS3DataAccessFromS3Bucket = std::forward<CreateS3DataAccessFromS3BucketT>(value);
  }
  template <typename CreateS3DataAccessFromS3BucketT = CreateS3DataAccessFromS3BucketResponseDetails>
  ResponseDetails& WithCreateS3DataAccessFromS3Bucket(CreateS3DataAccessFromS3BucketT&& value) {
    SetCreateS3DataAccessFromS3Bucket(std::forward<CreateS3DataAccessFromS3BucketT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ImportAssetsFromLakeFormationTagPolicyResponseDetails& GetImportAssetsFromLakeFormationTagPolicy() const {
    return m_importAssetsFromLakeFormationTagPolicy;
  }
  ...
  void SetImportAssetsFromLakeFormationTagPolicy(ImportAssetsFromLakeFormationTagPolicyT&& value) {
    ...
    m_importAssetsFromLakeFormationTagPolicy = std::forward<ImportAssetsFromLakeFormationTagPolicyT>(value);
  }
  template <typename ImportAssetsFromLakeFormationTagPolicyT = ImportAssetsFromLakeFormationTagPolicyResponseDetails>
  ResponseDetails& WithImportAssetsFromLakeFormationTagPolicy(ImportAssetsFromLakeFormationTagPolicyT&& value) {
    SetImportAssetsFromLakeFormationTagPolicy(std::forward<ImportAssetsFromLakeFormationTagPolicyT>(value));
    return *this;
  }
  ///@}
 private:
