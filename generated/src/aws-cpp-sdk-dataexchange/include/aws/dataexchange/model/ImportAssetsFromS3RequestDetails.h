...
class ImportAssetsFromS3RequestDetails {
 public:
  ...
  template <typename AssetSourcesT = Aws::Vector<AssetSourceEntry>>
  ImportAssetsFromS3RequestDetails& WithAssetSources(AssetSourcesT&& value) {
    SetAssetSources(std::forward<AssetSourcesT>(value));
    return *this;
  }
  template <typename AssetSourcesT = AssetSourceEntry>
  ImportAssetsFromS3RequestDetails& AddAssetSources(AssetSourcesT&& value) {
    m_assetSourcesHasBeenSet = true;
  ...
  template <typename DataSetIdT = Aws::String>
  ImportAssetsFromS3RequestDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ImportAssetsFromS3RequestDetails& WithRevisionId(RevisionIdT&& value) {
