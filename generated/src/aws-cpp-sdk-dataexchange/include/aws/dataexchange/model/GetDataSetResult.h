...
class GetDataSetResult {
 public:
  ...
  inline void SetAssetType(AssetType value) {
    m_assetTypeHasBeenSet = true;
    m_assetType = value;
  }
  inline GetDataSetResult& WithAssetType(AssetType value) {
    SetAssetType(value);
    return *this;
  }
  ///@}
  ...
  inline GetDataSetResult& WithOrigin(Origin value) {
    SetOrigin(value);
    return *this;
  }
  ///@}
  ...
  void SetOriginDetails(OriginDetailsT&& value) {
    ...
    m_originDetails = std::forward<OriginDetailsT>(value);
  }
  template <typename OriginDetailsT = OriginDetails>
  GetDataSetResult& WithOriginDetails(OriginDetailsT&& value) {
    SetOriginDetails(std::forward<OriginDetailsT>(value));
    return *this;
  }
  ///@}
