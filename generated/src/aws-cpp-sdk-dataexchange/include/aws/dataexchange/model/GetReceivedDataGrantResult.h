...
class GetReceivedDataGrantResult {
 public:
  ...
  void SetSenderPrincipal(SenderPrincipalT&& value) {
    ...
    m_senderPrincipal = std::forward<SenderPrincipalT>(value);
  }
  template <typename SenderPrincipalT = Aws::String>
  GetReceivedDataGrantResult& WithSenderPrincipal(SenderPrincipalT&& value) {
    SetSenderPrincipal(std::forward<SenderPrincipalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReceiverPrincipal(ReceiverPrincipalT&& value) {
    ...
    m_receiverPrincipal = std::forward<ReceiverPrincipalT>(value);
  }
  template <typename ReceiverPrincipalT = Aws::String>
  GetReceivedDataGrantResult& WithReceiverPrincipal(ReceiverPrincipalT&& value) {
    SetReceiverPrincipal(std::forward<ReceiverPrincipalT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAcceptanceState(DataGrantAcceptanceState value) {
    m_acceptanceStateHasBeenSet = true;
    m_acceptanceState = value;
  }
  inline GetReceivedDataGrantResult& WithAcceptanceState(DataGrantAcceptanceState value) {
    SetAcceptanceState(value);
    return *this;
  }
  ///@}
  ...
  void SetAcceptedAt(AcceptedAtT&& value) {
    ...
    m_acceptedAt = std::forward<AcceptedAtT>(value);
  }
  template <typename AcceptedAtT = Aws::Utils::DateTime>
  GetReceivedDataGrantResult& WithAcceptedAt(AcceptedAtT&& value) {
    SetAcceptedAt(std::forward<AcceptedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndsAt(EndsAtT&& value) {
    ...
    m_endsAt = std::forward<EndsAtT>(value);
  }
  template <typename EndsAtT = Aws::Utils::DateTime>
  GetReceivedDataGrantResult& WithEndsAt(EndsAtT&& value) {
    SetEndsAt(std::forward<EndsAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetGrantDistributionScope(GrantDistributionScope value) {
    m_grantDistributionScopeHasBeenSet = true;
    m_grantDistributionScope = value;
  }
  inline GetReceivedDataGrantResult& WithGrantDistributionScope(GrantDistributionScope value) {
    SetGrantDistributionScope(value);
    return *this;
  }
  ///@}
