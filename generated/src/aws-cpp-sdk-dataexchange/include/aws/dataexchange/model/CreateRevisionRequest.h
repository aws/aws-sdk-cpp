...
namespace Model
{
  ...
  public:
    ...
    template<typename CommentT = Aws::String>
    CreateRevisionRequest& WithComment(CommentT&& value) { SetComment(std::forward<CommentT>(value)); return *this;}
    ///@}
    ...
    template<typename DataSetIdT = Aws::String>
    CreateRevisionRequest& WithDataSetId(DataSetIdT&& value) { SetDataSetId(std::forward<DataSetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreateRevisionRequest& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
