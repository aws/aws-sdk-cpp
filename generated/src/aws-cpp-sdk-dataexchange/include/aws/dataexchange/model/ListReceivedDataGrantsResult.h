...
class ListReceivedDataGrantsResult {
 public:
  ...
  template <typename DataGrantSummariesT = Aws::Vector<ReceivedDataGrantSummariesEntry>>
  ListReceivedDataGrantsResult& WithDataGrantSummaries(DataGrantSummariesT&& value) {
  ...
  ListReceivedDataGrantsResult& AddDataGrantSummaries(DataGrantSummariesT&& value) {
    m_dataGrantSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListReceivedDataGrantsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListReceivedDataGrantsResult& WithRequestId(RequestIdT&& value) {
