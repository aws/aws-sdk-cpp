...
class RevisionDestinationEntry {
 public:
  ...
  template <typename BucketT = Aws::String>
  RevisionDestinationEntry& WithBucket(BucketT&& value) {
  ...
  void SetKeyPattern(KeyPatternT&& value) {
    ...
    m_keyPattern = std::forward<KeyPatternT>(value);
  }
  template <typename KeyPatternT = Aws::String>
  RevisionDestinationEntry& WithKeyPattern(KeyPatternT&& value) {
    SetKeyPattern(std::forward<KeyPatternT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RevisionIdT = Aws::String>
  RevisionDestinationEntry& WithRevisionId(RevisionIdT&& value) {
