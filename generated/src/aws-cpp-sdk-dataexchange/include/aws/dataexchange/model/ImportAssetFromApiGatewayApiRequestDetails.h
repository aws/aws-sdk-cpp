...
class ImportAssetFromApiGatewayApiRequestDetails {
 public:
  ...
  void SetApiDescription(ApiDescriptionT&& value) {
    ...
    m_apiDescription = std::forward<ApiDescriptionT>(value);
  }
  template <typename ApiDescriptionT = Aws::String>
  ImportAssetFromApiGatewayApiRequestDetails& WithApiDescription(ApiDescriptionT&& value) {
    SetApiDescription(std::forward<ApiDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ApiIdT = Aws::String>
  ImportAssetFromApiGatewayApiRequestDetails& WithApiId(ApiIdT&& value) {
  ...
  template <typename ApiKeyT = Aws::String>
  ImportAssetFromApiGatewayApiRequestDetails& WithApiKey(ApiKeyT&& value) {
  ...
  void SetApiName(ApiNameT&& value) {
    ...
    m_apiName = std::forward<ApiNameT>(value);
  }
  template <typename ApiNameT = Aws::String>
  ImportAssetFromApiGatewayApiRequestDetails& WithApiName(ApiNameT&& value) {
    SetApiName(std::forward<ApiNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApiSpecificationMd5Hash(ApiSpecificationMd5HashT&& value) {
    m_apiSpecificationMd5HashHasBeenSet = true;
    m_apiSpecificationMd5Hash = std::forward<ApiSpecificationMd5HashT>(value);
  }
  template <typename ApiSpecificationMd5HashT = Aws::String>
  ImportAssetFromApiGatewayApiRequestDetails& WithApiSpecificationMd5Hash(ApiSpecificationMd5HashT&& value) {
    SetApiSpecificationMd5Hash(std::forward<ApiSpecificationMd5HashT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DataSetIdT = Aws::String>
  ImportAssetFromApiGatewayApiRequestDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  inline ImportAssetFromApiGatewayApiRequestDetails& WithProtocolType(ProtocolType value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ImportAssetFromApiGatewayApiRequestDetails& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename StageT = Aws::String>
  ImportAssetFromApiGatewayApiRequestDetails& WithStage(StageT&& value) {
