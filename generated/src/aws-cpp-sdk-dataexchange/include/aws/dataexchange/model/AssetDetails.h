...
class AssetDetails {
 public:
  ...
  void SetS3SnapshotAsset(S3SnapshotAssetT&& value) {
    ...
    m_s3SnapshotAsset = std::forward<S3SnapshotAssetT>(value);
  }
  template <typename S3SnapshotAssetT = S3SnapshotAsset>
  AssetDetails& WithS3SnapshotAsset(S3SnapshotAssetT&& value) {
    SetS3SnapshotAsset(std::forward<S3SnapshotAssetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftDataShareAsset(RedshiftDataShareAssetT&& value) {
    ...
    m_redshiftDataShareAsset = std::forward<RedshiftDataShareAssetT>(value);
  }
  template <typename RedshiftDataShareAssetT = RedshiftDataShareAsset>
  AssetDetails& WithRedshiftDataShareAsset(RedshiftDataShareAssetT&& value) {
    SetRedshiftDataShareAsset(std::forward<RedshiftDataShareAssetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApiGatewayApiAsset(ApiGatewayApiAssetT&& value) {
    ...
    m_apiGatewayApiAsset = std::forward<ApiGatewayApiAssetT>(value);
  }
  template <typename ApiGatewayApiAssetT = ApiGatewayApiAsset>
  AssetDetails& WithApiGatewayApiAsset(ApiGatewayApiAssetT&& value) {
    SetApiGatewayApiAsset(std::forward<ApiGatewayApiAssetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3DataAccessAsset(S3DataAccessAssetT&& value) {
    ...
    m_s3DataAccessAsset = std::forward<S3DataAccessAssetT>(value);
  }
  template <typename S3DataAccessAssetT = S3DataAccessAsset>
  AssetDetails& WithS3DataAccessAsset(S3DataAccessAssetT&& value) {
    SetS3DataAccessAsset(std::forward<S3DataAccessAssetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLakeFormationDataPermissionAsset(LakeFormationDataPermissionAssetT&& value) {
    ...
    m_lakeFormationDataPermissionAsset = std::forward<LakeFormationDataPermissionAssetT>(value);
  }
  template <typename LakeFormationDataPermissionAssetT = LakeFormationDataPermissionAsset>
  AssetDetails& WithLakeFormationDataPermissionAsset(LakeFormationDataPermissionAssetT&& value) {
    SetLakeFormationDataPermissionAsset(std::forward<LakeFormationDataPermissionAssetT>(value));
    return *this;
  }
  ///@}
 private:
