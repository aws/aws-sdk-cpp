...
class ApiGatewayApiAsset {
 public:
  ...
  void SetApiSpecificationDownloadUrl(ApiSpecificationDownloadUrlT&& value) {
    ...
    m_apiSpecificationDownloadUrl = std::forward<ApiSpecificationDownloadUrlT>(value);
  }
  template <typename ApiSpecificationDownloadUrlT = Aws::String>
  ApiGatewayApiAsset& WithApiSpecificationDownloadUrl(ApiSpecificationDownloadUrlT&& value) {
    SetApiSpecificationDownloadUrl(std::forward<ApiSpecificationDownloadUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApiSpecificationDownloadUrlExpiresAt(ApiSpecificationDownloadUrlExpiresAtT&& value) {
    ...
    m_apiSpecificationDownloadUrlExpiresAt = std::forward<ApiSpecificationDownloadUrlExpiresAtT>(value);
  }
  template <typename ApiSpecificationDownloadUrlExpiresAtT = Aws::Utils::DateTime>
  ApiGatewayApiAsset& WithApiSpecificationDownloadUrlExpiresAt(ApiSpecificationDownloadUrlExpiresAtT&& value) {
    SetApiSpecificationDownloadUrlExpiresAt(std::forward<ApiSpecificationDownloadUrlExpiresAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline ApiGatewayApiAsset& WithProtocolType(ProtocolType value) {
