...
class UpdateRevisionRequest : public DataExchangeRequest {
 public:
  ...
  template <typename CommentT = Aws::String>
  UpdateRevisionRequest& WithComment(CommentT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  UpdateRevisionRequest& WithDataSetId(DataSetIdT&& value) {
  ...
  inline UpdateRevisionRequest& WithFinalized(bool value) {
    SetFinalized(value);
    return *this;
  }
  ///@}
  ...
  template <typename RevisionIdT = Aws::String>
  UpdateRevisionRequest& WithRevisionId(RevisionIdT&& value) {
