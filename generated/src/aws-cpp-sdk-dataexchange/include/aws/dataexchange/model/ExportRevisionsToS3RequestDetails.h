...
class ExportRevisionsToS3RequestDetails {
 public:
  ...
  template <typename DataSetIdT = Aws::String>
  ExportRevisionsToS3RequestDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename EncryptionT = ExportServerSideEncryption>
  ExportRevisionsToS3RequestDetails& WithEncryption(EncryptionT&& value) {
  ...
  template <typename RevisionDestinationsT = Aws::Vector<RevisionDestinationEntry>>
  ExportRevisionsToS3RequestDetails& WithRevisionDestinations(RevisionDestinationsT&& value) {
  ...
  ExportRevisionsToS3RequestDetails& AddRevisionDestinations(RevisionDestinationsT&& value) {
    m_revisionDestinationsHasBeenSet = true;
