...
class ListRevisionAssetsResult {
 public:
  ...
  template <typename AssetsT = Aws::Vector<AssetEntry>>
  ListRevisionAssetsResult& WithAssets(AssetsT&& value) {
    SetAssets(std::forward<AssetsT>(value));
    return *this;
  }
  template <typename AssetsT = AssetEntry>
  ListRevisionAssetsResult& AddAssets(AssetsT&& value) {
    m_assetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRevisionAssetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRevisionAssetsResult& WithRequestId(RequestIdT&& value) {
