...
class ImportAssetsFromRedshiftDataSharesResponseDetails {
 public:
  ...
  void SetAssetSources(AssetSourcesT&& value) {
    m_assetSourcesHasBeenSet = true;
    m_assetSources = std::forward<AssetSourcesT>(value);
  }
  template <typename AssetSourcesT = Aws::Vector<RedshiftDataShareAssetSourceEntry>>
  ImportAssetsFromRedshiftDataSharesResponseDetails& WithAssetSources(AssetSourcesT&& value) {
    SetAssetSources(std::forward<AssetSourcesT>(value));
    return *this;
  }
  template <typename AssetSourcesT = RedshiftDataShareAssetSourceEntry>
  ImportAssetsFromRedshiftDataSharesResponseDetails& AddAssetSources(AssetSourcesT&& value) {
    m_assetSourcesHasBeenSet = true;
    m_assetSources.emplace_back(std::forward<AssetSourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DataSetIdT = Aws::String>
  ImportAssetsFromRedshiftDataSharesResponseDetails& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ImportAssetsFromRedshiftDataSharesResponseDetails& WithRevisionId(RevisionIdT&& value) {
