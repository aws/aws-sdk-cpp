...
class CreateRevisionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateRevisionResult& WithArn(ArnT&& value) {
  ...
  template <typename CommentT = Aws::String>
  CreateRevisionResult& WithComment(CommentT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateRevisionResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  CreateRevisionResult& WithDataSetId(DataSetIdT&& value) {
  ...
  inline void SetFinalized(bool value) {
    m_finalizedHasBeenSet = true;
    m_finalized = value;
  }
  inline CreateRevisionResult& WithFinalized(bool value) {
    SetFinalized(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  CreateRevisionResult& WithId(IdT&& value) {
  ...
  template <typename SourceIdT = Aws::String>
  CreateRevisionResult& WithSourceId(SourceIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRevisionResult& WithTags(TagsT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateRevisionResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RevocationCommentT = Aws::String>
  CreateRevisionResult& WithRevocationComment(RevocationCommentT&& value) {
  ...
  inline CreateRevisionResult& WithRevoked(bool value) {
    SetRevoked(value);
    return *this;
  }
  ///@}
  ...
  template <typename RevokedAtT = Aws::Utils::DateTime>
  CreateRevisionResult& WithRevokedAt(RevokedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRevisionResult& WithRequestId(RequestIdT&& value) {
