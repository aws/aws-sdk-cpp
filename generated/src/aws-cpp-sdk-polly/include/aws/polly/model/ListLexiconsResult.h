...
class ListLexiconsResult {
 public:
  ...
  void SetLexicons(LexiconsT&& value) {
    m_lexiconsHasBeenSet = true;
    m_lexicons = std::forward<LexiconsT>(value);
  }
  template <typename LexiconsT = Aws::Vector<LexiconDescription>>
  ListLexiconsResult& WithLexicons(LexiconsT&& value) {
    SetLexicons(std::forward<LexiconsT>(value));
    return *this;
  }
  template <typename LexiconsT = LexiconDescription>
  ListLexiconsResult& AddLexicons(LexiconsT&& value) {
    m_lexiconsHasBeenSet = true;
    m_lexicons.emplace_back(std::forward<LexiconsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLexiconsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLexiconsResult& WithRequestId(RequestIdT&& value) {
