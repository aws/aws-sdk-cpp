...
class StartSpeechSynthesisTaskRequest : public PollyRequest {
 public:
  ...
  inline StartSpeechSynthesisTaskRequest& WithEngine(Engine value) {
    SetEngine(value);
    return *this;
  }
  ///@}
  ...
  inline StartSpeechSynthesisTaskRequest& WithLanguageCode(LanguageCode value) {
  ...
  inline StartSpeechSynthesisTaskRequest& WithOutputFormat(OutputFormat value) {
  ...
  inline StartSpeechSynthesisTaskRequest& AddSpeechMarkTypes(SpeechMarkType value) {
    m_speechMarkTypesHasBeenSet = true;
  ...
  inline StartSpeechSynthesisTaskRequest& WithTextType(TextType value) {
    SetTextType(value);
    return *this;
  }
  ///@}
  ...
  inline StartSpeechSynthesisTaskRequest& WithVoiceId(VoiceId value) {
    SetVoiceId(value);
    return *this;
  }
  ///@}
