...
class GetLexiconResult {
 public:
  ...
  void SetLexicon(LexiconT&& value) {
    ...
    m_lexicon = std::forward<LexiconT>(value);
  }
  template <typename LexiconT = Lexicon>
  GetLexiconResult& WithLexicon(LexiconT&& value) {
    SetLexicon(std::forward<LexiconT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLexiconAttributes(LexiconAttributesT&& value) {
    ...
    m_lexiconAttributes = std::forward<LexiconAttributesT>(value);
  }
  template <typename LexiconAttributesT = LexiconAttributes>
  GetLexiconResult& WithLexiconAttributes(LexiconAttributesT&& value) {
    SetLexiconAttributes(std::forward<LexiconAttributesT>(value));
    return *this;
  }
  ///@}
