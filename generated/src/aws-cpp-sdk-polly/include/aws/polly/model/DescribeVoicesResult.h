...
class DescribeVoicesResult {
 public:
  ...
  void SetVoices(VoicesT&& value) {
    m_voicesHasBeenSet = true;
    m_voices = std::forward<VoicesT>(value);
  }
  template <typename VoicesT = Aws::Vector<Voice>>
  DescribeVoicesResult& WithVoices(VoicesT&& value) {
    SetVoices(std::forward<VoicesT>(value));
    return *this;
  }
  template <typename VoicesT = Voice>
  DescribeVoicesResult& AddVoices(VoicesT&& value) {
    m_voicesHasBeenSet = true;
    m_voices.emplace_back(std::forward<VoicesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVoicesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeVoicesResult& WithRequestId(RequestIdT&& value) {
