...
class ListSpeechSynthesisTasksRequest : public PollyRequest {
 public:
  ...
  inline ListSpeechSynthesisTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSpeechSynthesisTasksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSpeechSynthesisTasksRequest& WithStatus(TaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
