...
class ListSpeechSynthesisTasksResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListSpeechSynthesisTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetSynthesisTasks(SynthesisTasksT&& value) {
    m_synthesisTasksHasBeenSet = true;
    m_synthesisTasks = std::forward<SynthesisTasksT>(value);
  }
  template <typename SynthesisTasksT = Aws::Vector<SynthesisTask>>
  ListSpeechSynthesisTasksResult& WithSynthesisTasks(SynthesisTasksT&& value) {
    SetSynthesisTasks(std::forward<SynthesisTasksT>(value));
    return *this;
  }
  template <typename SynthesisTasksT = SynthesisTask>
  ListSpeechSynthesisTasksResult& AddSynthesisTasks(SynthesisTasksT&& value) {
    m_synthesisTasksHasBeenSet = true;
    m_synthesisTasks.emplace_back(std::forward<SynthesisTasksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListSpeechSynthesisTasksResult& WithRequestId(RequestIdT&& value) {
