...
class SynthesizeSpeechRequest : public PollyRequest {
 ...
 public:
  ...
  inline SynthesizeSpeechRequest& WithEngine(Engine value) {
    SetEngine(value);
    return *this;
  }
  ///@}
  ...
  inline SynthesizeSpeechRequest& WithLanguageCode(LanguageCode value) {
   ...
   * this will be json. </p> <p>When pcm is used, the content returned is audio/pcm
   * in a signed 16-bit, 1 channel (mono), little-endian format. </p>
   */
  ...
  inline SynthesizeSpeechRequest& WithOutputFormat(OutputFormat value) {
   ...
   * "8000" and "16000" The default value is "16000". </p> <p>Valid value for
   * ogg_opus is "48000". </p> <p>Valid value for mu-law and a-law is "8000". </p>
   */
  ...
  void SetSpeechMarkTypes(SpeechMarkTypesT&& value) {
    ...
    m_speechMarkTypes = std::forward<SpeechMarkTypesT>(value);
  }
  template <typename SpeechMarkTypesT = Aws::Vector<SpeechMarkType>>
  SynthesizeSpeechRequest& WithSpeechMarkTypes(SpeechMarkTypesT&& value) {
    SetSpeechMarkTypes(std::forward<SpeechMarkTypesT>(value));
    return *this;
  }
  inline SynthesizeSpeechRequest& AddSpeechMarkTypes(SpeechMarkType value) {
    m_speechMarkTypesHasBeenSet = true;
    m_speechMarkTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline SynthesizeSpeechRequest& WithTextType(TextType value) {
    SetTextType(value);
    return *this;
  }
  ///@}
  ...
  inline SynthesizeSpeechRequest& WithVoiceId(VoiceId value) {
    SetVoiceId(value);
    return *this;
  }
  ///@}
