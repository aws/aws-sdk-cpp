...
#include <aws/polly/model/ValidationExceptionField.h>
 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/polly-2016-06-10/ValidationException">AWS
 * API Reference</a></p>
 */
class ValidationException {
 public:
  AWS_POLLY_API ValidationException() = default;
  AWS_POLLY_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
  AWS_POLLY_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
