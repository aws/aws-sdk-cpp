...
class SynthesisTask {
 public:
  ...
  inline SynthesisTask& WithEngine(Engine value) {
    SetEngine(value);
    return *this;
  }
  ///@}
  ...
  inline SynthesisTask& WithTaskStatus(TaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTaskStatusReason(TaskStatusReasonT&& value) {
    ...
    m_taskStatusReason = std::forward<TaskStatusReasonT>(value);
  }
  template <typename TaskStatusReasonT = Aws::String>
  SynthesisTask& WithTaskStatusReason(TaskStatusReasonT&& value) {
    SetTaskStatusReason(std::forward<TaskStatusReasonT>(value));
    return *this;
  }
  ///@}
  ...
  inline SynthesisTask& WithRequestCharacters(int value) {
  ...
  inline SynthesisTask& WithOutputFormat(OutputFormat value) {
  ...
  inline SynthesisTask& AddSpeechMarkTypes(SpeechMarkType value) {
    m_speechMarkTypesHasBeenSet = true;
  ...
  inline SynthesisTask& WithTextType(TextType value) {
    SetTextType(value);
    return *this;
  }
  ///@}
  ...
  inline SynthesisTask& WithVoiceId(VoiceId value) {
    SetVoiceId(value);
    return *this;
  }
  ///@}
  ...
  inline SynthesisTask& WithLanguageCode(LanguageCode value) {
