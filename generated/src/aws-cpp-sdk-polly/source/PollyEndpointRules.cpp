...
namespace Polly
{
const size_t PollyEndpointRules::RulesBlobStrLen = 3720;
const size_t PollyEndpointRules::RulesBlobSize = 3721;
...
'p','o','l','l','y','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'l','"',':','"','h','t','t','p','s',':','/','/','p','o','l','l','y','.','{','R','e','g','i','o','n',
