...
GetSupportPermitResult::GetSupportPermitResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetSupportPermitResult& GetSupportPermitResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
