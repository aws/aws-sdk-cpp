...
CreateSupportPermitResult::CreateSupportPermitResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateSupportPermitResult& CreateSupportPermitResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
