...
/**
 */
class ListActionsRequest : public SupportAuthZRequest {
 public:
  AWS_SUPPORTAUTHZ_API ListActionsRequest() = default;
  ...
  inline ListActionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceT = Aws::String>
  ListActionsRequest& WithService(ServiceT&& value) {
