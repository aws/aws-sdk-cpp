...
class ListActionsResult {
 public:
  AWS_SUPPORTAUTHZ_API ListActionsResult() = default;
  AWS_SUPPORTAUTHZ_API ListActionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SUPPORTAUTHZ_API ListActionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ActionSummariesT = Aws::Vector<ActionSummary>>
  ListActionsResult& WithActionSummaries(ActionSummariesT&& value) {
    SetActionSummaries(std::forward<ActionSummariesT>(value));
    return *this;
  }
  template <typename ActionSummariesT = ActionSummary>
  ListActionsResult& AddActionSummaries(ActionSummariesT&& value) {
    m_actionSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListActionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListActionsResult& WithRequestId(RequestIdT&& value) {
