 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/supportauthz-2026-06-30/ConflictException">AWS
 * API Reference</a></p>
 */
class ConflictException {
 public:
  AWS_SUPPORTAUTHZ_API ConflictException() = default;
  AWS_SUPPORTAUTHZ_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
  AWS_SUPPORTAUTHZ_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
