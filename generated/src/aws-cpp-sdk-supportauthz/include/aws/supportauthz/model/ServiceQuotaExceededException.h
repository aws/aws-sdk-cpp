...
/**
 * <p>The request exceeds a service quota for your account.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/supportauthz-2026-06-30/ServiceQuotaExceededException">AWS
 * API Reference</a></p>
 */
class ServiceQuotaExceededException {
 public:
  AWS_SUPPORTAUTHZ_API ServiceQuotaExceededException() = default;
  AWS_SUPPORTAUTHZ_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
  AWS_SUPPORTAUTHZ_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
