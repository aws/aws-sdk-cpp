 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/supportauthz-2026-06-30/ValidationExceptionField">AWS
 * API Reference</a></p>
 */
class ValidationExceptionField {
 public:
  AWS_SUPPORTAUTHZ_API ValidationExceptionField() = default;
  AWS_SUPPORTAUTHZ_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
  AWS_SUPPORTAUTHZ_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
