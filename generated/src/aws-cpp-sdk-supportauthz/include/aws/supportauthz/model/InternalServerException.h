...
/**
 * <p>An internal service error occurred. Try again later.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/supportauthz-2026-06-30/InternalServerException">AWS
 * API Reference</a></p>
 */
class InternalServerException {
 public:
  AWS_SUPPORTAUTHZ_API InternalServerException() = default;
  AWS_SUPPORTAUTHZ_API InternalServerException(Aws::Utils::Json::JsonView jsonValue);
  AWS_SUPPORTAUTHZ_API InternalServerException& operator=(Aws::Utils::Json::JsonView jsonValue);
