 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/supportauthz-2026-06-30/ResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class ResourceNotFoundException {
 public:
  AWS_SUPPORTAUTHZ_API ResourceNotFoundException() = default;
  AWS_SUPPORTAUTHZ_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
  AWS_SUPPORTAUTHZ_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
