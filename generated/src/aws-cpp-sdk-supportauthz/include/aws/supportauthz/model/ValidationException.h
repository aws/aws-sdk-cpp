 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/supportauthz-2026-06-30/ValidationException">AWS
 * API Reference</a></p>
 */
class ValidationException {
 public:
  AWS_SUPPORTAUTHZ_API ValidationException() = default;
  AWS_SUPPORTAUTHZ_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
  AWS_SUPPORTAUTHZ_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  ///@{
  /**
   * <p>A list of fields that fail validation. Each entry identifies the field and
   * the reason for the constraint violation.</p>
   */
