...
namespace AppRunner
{
const size_t AppRunnerEndpointRules::RulesBlobStrLen = 3736;
const size_t AppRunnerEndpointRules::RulesBlobSize = 3737;
...
's',':','/','/','a','p','p','r','u','n','n','e','r','-','f','i','p','s','.','{','R','e','g','i','o',
...
'p','p','r','u','n','n','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
