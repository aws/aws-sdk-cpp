...
DescribeVpcConnectorResult::DescribeVpcConnectorResult()
{
}

DescribeVpcConnectorResult::DescribeVpcConnectorResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
