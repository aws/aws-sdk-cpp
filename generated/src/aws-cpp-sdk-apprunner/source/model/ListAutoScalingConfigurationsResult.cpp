...
ListAutoScalingConfigurationsResult& ListAutoScalingConfigurationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("AutoScalingConfigurationSummaryList")) {
    ...
    for (unsigned autoScalingConfigurationSummaryListIndex = 0;
         autoScalingConfigurationSummaryListIndex < autoScalingConfigurationSummaryListJsonList.GetLength();
         ++autoScalingConfigurationSummaryListIndex) {
      m_autoScalingConfigurationSummaryList.push_back(
          autoScalingConfigurationSummaryListJsonList[autoScalingConfigurationSummaryListIndex].AsObject());
    }
