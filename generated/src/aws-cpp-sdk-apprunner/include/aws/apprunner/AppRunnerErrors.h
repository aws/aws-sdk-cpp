...
public:
  ...
  AppRunnerError(const Aws::Client::AWSError<AppRunnerErrors>& rhs) : Aws::Client::AWSError<AppRunnerErrors>(rhs) {}
  AppRunnerError(Aws::Client::AWSError<AppRunnerErrors>&& rhs) : Aws::Client::AWSError<AppRunnerErrors>(rhs) {}
