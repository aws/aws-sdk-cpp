...
namespace Model
{
  ...
  public:
    ...
    template<typename ConnectionNameT = Aws::String>
    ConnectionSummary& WithConnectionName(ConnectionNameT&& value) { SetConnectionName(std::forward<ConnectionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ConnectionArnT = Aws::String>
    ConnectionSummary& WithConnectionArn(ConnectionArnT&& value) { SetConnectionArn(std::forward<ConnectionArnT>(value)); return *this;}
    ///@}
    ...
    inline ConnectionSummary& WithProviderType(ProviderType value) { SetProviderType(value); return *this;}
    ///@}
    ...
    inline ConnectionSummary& WithStatus(ConnectionStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    ConnectionSummary& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
  private:
