...
class CreateAutoScalingConfigurationRequest : public AppRunnerRequest {
 public:
  ...
  inline CreateAutoScalingConfigurationRequest& WithMaxConcurrency(int value) {
  ...
  inline CreateAutoScalingConfigurationRequest& WithMinSize(int value) {
    SetMinSize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateAutoScalingConfigurationRequest& WithMaxSize(int value) {
    SetMaxSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateAutoScalingConfigurationRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateAutoScalingConfigurationRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
