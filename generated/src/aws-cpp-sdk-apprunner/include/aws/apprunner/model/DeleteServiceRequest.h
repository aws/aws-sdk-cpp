...
namespace Model
{
  ...
  {
  public:
    AWS_APPRUNNER_API DeleteServiceRequest() = default;
    ...
    template<typename ServiceArnT = Aws::String>
    DeleteServiceRequest& WithServiceArn(ServiceArnT&& value) { SetServiceArn(std::forward<ServiceArnT>(value)); return *this;}
    ///@}
  private:
