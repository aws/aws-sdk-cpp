...
class DescribeObservabilityConfigurationResult {
 public:
  AWS_APPRUNNER_API DescribeObservabilityConfigurationResult() = default;
  ...
  AWS_APPRUNNER_API DescribeObservabilityConfigurationResult& operator=(
  ...
  template <typename ObservabilityConfigurationT = ObservabilityConfiguration>
  DescribeObservabilityConfigurationResult& WithObservabilityConfiguration(ObservabilityConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeObservabilityConfigurationResult& WithRequestId(RequestIdT&& value) {
