...
class ServiceObservabilityConfiguration {
 public:
  ...
  inline void SetObservabilityEnabled(bool value) {
    m_observabilityEnabledHasBeenSet = true;
    m_observabilityEnabled = value;
  }
  inline ServiceObservabilityConfiguration& WithObservabilityEnabled(bool value) {
    SetObservabilityEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename ObservabilityConfigurationArnT = Aws::String>
  ServiceObservabilityConfiguration& WithObservabilityConfigurationArn(ObservabilityConfigurationArnT&& value) {
