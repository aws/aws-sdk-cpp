...
class DeleteVpcConnectorResult {
 public:
  ...
  void SetVpcConnector(VpcConnectorT&& value) {
    ...
    m_vpcConnector = std::forward<VpcConnectorT>(value);
  }
  template <typename VpcConnectorT = VpcConnector>
  DeleteVpcConnectorResult& WithVpcConnector(VpcConnectorT&& value) {
    SetVpcConnector(std::forward<VpcConnectorT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteVpcConnectorResult& WithRequestId(RequestIdT&& value) {
