...
class IngressConfiguration {
 public:
  ...
  inline void SetIsPubliclyAccessible(bool value) {
    m_isPubliclyAccessibleHasBeenSet = true;
    m_isPubliclyAccessible = value;
  }
  inline IngressConfiguration& WithIsPubliclyAccessible(bool value) {
    SetIsPubliclyAccessible(value);
    return *this;
  }
  ///@}
 private:
