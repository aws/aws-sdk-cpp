...
class AutoScalingConfiguration {
 public:
  ...
  template <typename AutoScalingConfigurationArnT = Aws::String>
  AutoScalingConfiguration& WithAutoScalingConfigurationArn(AutoScalingConfigurationArnT&& value) {
  ...
  template <typename AutoScalingConfigurationNameT = Aws::String>
  AutoScalingConfiguration& WithAutoScalingConfigurationName(AutoScalingConfigurationNameT&& value) {
  ...
  inline AutoScalingConfiguration& WithAutoScalingConfigurationRevision(int value) {
  ...
  inline void SetLatest(bool value) {
    m_latestHasBeenSet = true;
    m_latest = value;
  }
  inline AutoScalingConfiguration& WithLatest(bool value) {
    SetLatest(value);
    return *this;
  }
  ///@}
  ...
  inline AutoScalingConfiguration& WithStatus(AutoScalingConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AutoScalingConfiguration& WithMaxConcurrency(int value) {
  ...
  inline AutoScalingConfiguration& WithMinSize(int value) {
    SetMinSize(value);
    return *this;
  }
  ///@}
  ...
  inline AutoScalingConfiguration& WithMaxSize(int value) {
    SetMaxSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  AutoScalingConfiguration& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DeletedAtT = Aws::Utils::DateTime>
  AutoScalingConfiguration& WithDeletedAt(DeletedAtT&& value) {
  ...
  inline AutoScalingConfiguration& WithHasAssociatedService(bool value) {
  ...
  inline AutoScalingConfiguration& WithIsDefault(bool value) {
    SetIsDefault(value);
    return *this;
  }
  ///@}
