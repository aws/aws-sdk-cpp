...
class NetworkConfiguration {
 public:
  ...
  void SetEgressConfiguration(EgressConfigurationT&& value) {
    ...
    m_egressConfiguration = std::forward<EgressConfigurationT>(value);
  }
  template <typename EgressConfigurationT = EgressConfiguration>
  NetworkConfiguration& WithEgressConfiguration(EgressConfigurationT&& value) {
    SetEgressConfiguration(std::forward<EgressConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIngressConfiguration(IngressConfigurationT&& value) {
    ...
    m_ingressConfiguration = std::forward<IngressConfigurationT>(value);
  }
  template <typename IngressConfigurationT = IngressConfiguration>
  NetworkConfiguration& WithIngressConfiguration(IngressConfigurationT&& value) {
    SetIngressConfiguration(std::forward<IngressConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline NetworkConfiguration& WithIpAddressType(IpAddressType value) {
