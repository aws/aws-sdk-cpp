...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public AppRunnerRequest
  {
  public:
    AWS_APPRUNNER_API UntagResourceRequest() = default;
     ...
     * from.</p> <p>It must be the ARN of an App Runner resource.</p>
     */
