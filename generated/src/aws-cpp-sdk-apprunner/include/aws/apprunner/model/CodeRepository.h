...
class CodeRepository {
 public:
  ...
  void SetSourceCodeVersion(SourceCodeVersionT&& value) {
    ...
    m_sourceCodeVersion = std::forward<SourceCodeVersionT>(value);
  }
  template <typename SourceCodeVersionT = SourceCodeVersion>
  CodeRepository& WithSourceCodeVersion(SourceCodeVersionT&& value) {
    SetSourceCodeVersion(std::forward<SourceCodeVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceDirectory(SourceDirectoryT&& value) {
    ...
    m_sourceDirectory = std::forward<SourceDirectoryT>(value);
  }
  template <typename SourceDirectoryT = Aws::String>
  CodeRepository& WithSourceDirectory(SourceDirectoryT&& value) {
    SetSourceDirectory(std::forward<SourceDirectoryT>(value));
    return *this;
  }
  ///@}
 private:
