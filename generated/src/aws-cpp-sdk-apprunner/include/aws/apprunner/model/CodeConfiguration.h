...
class CodeConfiguration {
 public:
  ...
  inline CodeConfiguration& WithConfigurationSource(ConfigurationSource value) {
  ...
  void SetCodeConfigurationValues(CodeConfigurationValuesT&& value) {
    ...
    m_codeConfigurationValues = std::forward<CodeConfigurationValuesT>(value);
  }
  template <typename CodeConfigurationValuesT = CodeConfigurationValues>
  CodeConfiguration& WithCodeConfigurationValues(CodeConfigurationValuesT&& value) {
    SetCodeConfigurationValues(std::forward<CodeConfigurationValuesT>(value));
    return *this;
  }
  ///@}
 private:
