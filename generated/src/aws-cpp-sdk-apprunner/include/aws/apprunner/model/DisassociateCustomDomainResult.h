...
class DisassociateCustomDomainResult {
 public:
  ...
  template <typename DNSTargetT = Aws::String>
  DisassociateCustomDomainResult& WithDNSTarget(DNSTargetT&& value) {
  ...
  template <typename ServiceArnT = Aws::String>
  DisassociateCustomDomainResult& WithServiceArn(ServiceArnT&& value) {
  ...
  template <typename CustomDomainT = CustomDomain>
  DisassociateCustomDomainResult& WithCustomDomain(CustomDomainT&& value) {
  ...
  template <typename VpcDNSTargetsT = Aws::Vector<VpcDNSTarget>>
  DisassociateCustomDomainResult& WithVpcDNSTargets(VpcDNSTargetsT&& value) {
    SetVpcDNSTargets(std::forward<VpcDNSTargetsT>(value));
    return *this;
  }
  template <typename VpcDNSTargetsT = VpcDNSTarget>
  DisassociateCustomDomainResult& AddVpcDNSTargets(VpcDNSTargetsT&& value) {
    m_vpcDNSTargetsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateCustomDomainResult& WithRequestId(RequestIdT&& value) {
