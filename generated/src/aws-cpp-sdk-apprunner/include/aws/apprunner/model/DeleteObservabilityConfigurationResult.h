...
class DeleteObservabilityConfigurationResult {
 public:
  ...
  AWS_APPRUNNER_API DeleteObservabilityConfigurationResult& operator=(
  ...
  template <typename ObservabilityConfigurationT = ObservabilityConfiguration>
  DeleteObservabilityConfigurationResult& WithObservabilityConfiguration(ObservabilityConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteObservabilityConfigurationResult& WithRequestId(RequestIdT&& value) {
