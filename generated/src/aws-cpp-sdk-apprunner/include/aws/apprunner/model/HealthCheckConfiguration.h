...
class HealthCheckConfiguration {
 public:
  ...
  inline void SetProtocol(HealthCheckProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline HealthCheckConfiguration& WithProtocol(HealthCheckProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckConfiguration& WithInterval(int value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckConfiguration& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckConfiguration& WithHealthyThreshold(int value) {
  ...
  inline HealthCheckConfiguration& WithUnhealthyThreshold(int value) {
