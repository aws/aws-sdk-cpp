...
class ListServicesForAutoScalingConfigurationResult {
 public:
  ...
  AWS_APPRUNNER_API ListServicesForAutoScalingConfigurationResult& operator=(
  ...
  void SetServiceArnList(ServiceArnListT&& value) {
    m_serviceArnListHasBeenSet = true;
    m_serviceArnList = std::forward<ServiceArnListT>(value);
  }
  template <typename ServiceArnListT = Aws::Vector<Aws::String>>
  ListServicesForAutoScalingConfigurationResult& WithServiceArnList(ServiceArnListT&& value) {
    SetServiceArnList(std::forward<ServiceArnListT>(value));
    return *this;
  }
  template <typename ServiceArnListT = Aws::String>
  ListServicesForAutoScalingConfigurationResult& AddServiceArnList(ServiceArnListT&& value) {
    m_serviceArnListHasBeenSet = true;
    m_serviceArnList.emplace_back(std::forward<ServiceArnListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServicesForAutoScalingConfigurationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServicesForAutoScalingConfigurationResult& WithRequestId(RequestIdT&& value) {
