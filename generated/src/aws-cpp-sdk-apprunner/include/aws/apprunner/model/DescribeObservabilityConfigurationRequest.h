...
namespace Model
{
  ...
  {
  public:
    AWS_APPRUNNER_API DescribeObservabilityConfigurationRequest() = default;
    ...
    template<typename ObservabilityConfigurationArnT = Aws::String>
    DescribeObservabilityConfigurationRequest& WithObservabilityConfigurationArn(ObservabilityConfigurationArnT&& value) { SetObservabilityConfigurationArn(std::forward<ObservabilityConfigurationArnT>(value)); return *this;}
    ///@}
  private:
