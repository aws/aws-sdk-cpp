...
class VpcConnector {
 public:
  ...
  void SetVpcConnectorName(VpcConnectorNameT&& value) {
    ...
    m_vpcConnectorName = std::forward<VpcConnectorNameT>(value);
  }
  template <typename VpcConnectorNameT = Aws::String>
  VpcConnector& WithVpcConnectorName(VpcConnectorNameT&& value) {
    SetVpcConnectorName(std::forward<VpcConnectorNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVpcConnectorArn(VpcConnectorArnT&& value) {
    ...
    m_vpcConnectorArn = std::forward<VpcConnectorArnT>(value);
  }
  template <typename VpcConnectorArnT = Aws::String>
  VpcConnector& WithVpcConnectorArn(VpcConnectorArnT&& value) {
    SetVpcConnectorArn(std::forward<VpcConnectorArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVpcConnectorRevision(int value) {
    m_vpcConnectorRevisionHasBeenSet = true;
    m_vpcConnectorRevision = value;
  }
  inline VpcConnector& WithVpcConnectorRevision(int value) {
    SetVpcConnectorRevision(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(VpcConnectorStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline VpcConnector& WithStatus(VpcConnectorStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
