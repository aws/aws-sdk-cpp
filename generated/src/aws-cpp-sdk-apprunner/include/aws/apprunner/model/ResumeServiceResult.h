...
class ResumeServiceResult {
 public:
  ...
  template <typename ServiceT = Service>
  ResumeServiceResult& WithService(ServiceT&& value) {
  ...
  template <typename OperationIdT = Aws::String>
  ResumeServiceResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ResumeServiceResult& WithRequestId(RequestIdT&& value) {
