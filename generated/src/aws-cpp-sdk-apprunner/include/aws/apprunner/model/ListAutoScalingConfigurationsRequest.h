...
class ListAutoScalingConfigurationsRequest : public AppRunnerRequest {
 public:
  ...
  template <typename AutoScalingConfigurationNameT = Aws::String>
  ListAutoScalingConfigurationsRequest& WithAutoScalingConfigurationName(AutoScalingConfigurationNameT&& value) {
  ...
  inline void SetLatestOnly(bool value) {
    m_latestOnlyHasBeenSet = true;
    m_latestOnly = value;
  }
  inline ListAutoScalingConfigurationsRequest& WithLatestOnly(bool value) {
    SetLatestOnly(value);
    return *this;
  }
  ///@}
  ...
  inline ListAutoScalingConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAutoScalingConfigurationsRequest& WithNextToken(NextTokenT&& value) {
