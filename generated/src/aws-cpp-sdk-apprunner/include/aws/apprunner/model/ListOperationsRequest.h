...
namespace Model
{
  ...
  {
  public:
    AWS_APPRUNNER_API ListOperationsRequest() = default;
    ...
    template<typename ServiceArnT = Aws::String>
    ListOperationsRequest& WithServiceArn(ServiceArnT&& value) { SetServiceArn(std::forward<ServiceArnT>(value)); return *this;}
    ///@}
