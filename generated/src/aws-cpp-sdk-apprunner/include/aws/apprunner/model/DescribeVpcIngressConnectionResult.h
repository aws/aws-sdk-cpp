...
class DescribeVpcIngressConnectionResult {
 public:
  ...
  template <typename VpcIngressConnectionT = VpcIngressConnection>
  DescribeVpcIngressConnectionResult& WithVpcIngressConnection(VpcIngressConnectionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeVpcIngressConnectionResult& WithRequestId(RequestIdT&& value) {
