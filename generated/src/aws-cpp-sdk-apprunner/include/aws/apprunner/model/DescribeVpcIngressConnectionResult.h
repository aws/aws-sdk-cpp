...
namespace Model
{
  ...
  {
  public:
    AWS_APPRUNNER_API DescribeVpcIngressConnectionResult() = default;
    ...
    template<typename VpcIngressConnectionT = VpcIngressConnection>
    DescribeVpcIngressConnectionResult& WithVpcIngressConnection(VpcIngressConnectionT&& value) { SetVpcIngressConnection(std::forward<VpcIngressConnectionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeVpcIngressConnectionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
