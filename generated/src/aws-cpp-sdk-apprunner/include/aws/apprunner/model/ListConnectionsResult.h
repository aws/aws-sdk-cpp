...
class ListConnectionsResult {
 public:
  ...
  void SetConnectionSummaryList(ConnectionSummaryListT&& value) {
    m_connectionSummaryListHasBeenSet = true;
    m_connectionSummaryList = std::forward<ConnectionSummaryListT>(value);
  }
  template <typename ConnectionSummaryListT = Aws::Vector<ConnectionSummary>>
  ListConnectionsResult& WithConnectionSummaryList(ConnectionSummaryListT&& value) {
    SetConnectionSummaryList(std::forward<ConnectionSummaryListT>(value));
    return *this;
  }
  ...
  ListConnectionsResult& AddConnectionSummaryList(ConnectionSummaryListT&& value) {
    m_connectionSummaryListHasBeenSet = true;
    m_connectionSummaryList.emplace_back(std::forward<ConnectionSummaryListT>(value));
    return *this;
  }
  ///@}
