...
class ListVpcConnectorsRequest : public AppRunnerRequest {
 public:
  AWS_APPRUNNER_API ListVpcConnectorsRequest() = default;
  ...
  inline ListVpcConnectorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVpcConnectorsRequest& WithNextToken(NextTokenT&& value) {
