...
class UpdateDefaultAutoScalingConfigurationResult {
 public:
  ...
  AWS_APPRUNNER_API UpdateDefaultAutoScalingConfigurationResult& operator=(
  ...
  template <typename AutoScalingConfigurationT = AutoScalingConfiguration>
  UpdateDefaultAutoScalingConfigurationResult& WithAutoScalingConfiguration(AutoScalingConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDefaultAutoScalingConfigurationResult& WithRequestId(RequestIdT&& value) {
