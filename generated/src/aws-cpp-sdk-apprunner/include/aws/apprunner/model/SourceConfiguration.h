...
class SourceConfiguration {
 public:
  ...
  void SetImageRepository(ImageRepositoryT&& value) {
    ...
    m_imageRepository = std::forward<ImageRepositoryT>(value);
  }
  template <typename ImageRepositoryT = ImageRepository>
  SourceConfiguration& WithImageRepository(ImageRepositoryT&& value) {
    SetImageRepository(std::forward<ImageRepositoryT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAutoDeploymentsEnabled(bool value) {
    m_autoDeploymentsEnabledHasBeenSet = true;
    m_autoDeploymentsEnabled = value;
  }
  inline SourceConfiguration& WithAutoDeploymentsEnabled(bool value) {
    SetAutoDeploymentsEnabled(value);
    return *this;
  }
  ///@}
