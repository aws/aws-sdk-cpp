...
namespace Model
{
  ...
  public:
    ...
    template<typename DNSTargetT = Aws::String>
    AssociateCustomDomainResult& WithDNSTarget(DNSTargetT&& value) { SetDNSTarget(std::forward<DNSTargetT>(value)); return *this;}
    ///@}
    ...
    template<typename ServiceArnT = Aws::String>
    AssociateCustomDomainResult& WithServiceArn(ServiceArnT&& value) { SetServiceArn(std::forward<ServiceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomDomainT = CustomDomain>
    AssociateCustomDomainResult& WithCustomDomain(CustomDomainT&& value) { SetCustomDomain(std::forward<CustomDomainT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcDNSTargetsT = Aws::Vector<VpcDNSTarget>>
    AssociateCustomDomainResult& WithVpcDNSTargets(VpcDNSTargetsT&& value) { SetVpcDNSTargets(std::forward<VpcDNSTargetsT>(value)); return *this;}
    template<typename VpcDNSTargetsT = VpcDNSTarget>
    AssociateCustomDomainResult& AddVpcDNSTargets(VpcDNSTargetsT&& value) { m_vpcDNSTargetsHasBeenSet = true; m_vpcDNSTargets.emplace_back(std::forward<VpcDNSTargetsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AssociateCustomDomainResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
