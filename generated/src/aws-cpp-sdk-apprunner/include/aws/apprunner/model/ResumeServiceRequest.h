...
namespace Model
{
  ...
  {
  public:
    AWS_APPRUNNER_API ResumeServiceRequest() = default;
    ...
    template<typename ServiceArnT = Aws::String>
    ResumeServiceRequest& WithServiceArn(ServiceArnT&& value) { SetServiceArn(std::forward<ServiceArnT>(value)); return *this;}
    ///@}
  private:
