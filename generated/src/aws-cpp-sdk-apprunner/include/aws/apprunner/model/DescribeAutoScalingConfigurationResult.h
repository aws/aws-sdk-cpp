...
class DescribeAutoScalingConfigurationResult {
 public:
  ...
  AWS_APPRUNNER_API DescribeAutoScalingConfigurationResult& operator=(
  ...
  template <typename AutoScalingConfigurationT = AutoScalingConfiguration>
  DescribeAutoScalingConfigurationResult& WithAutoScalingConfiguration(AutoScalingConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAutoScalingConfigurationResult& WithRequestId(RequestIdT&& value) {
