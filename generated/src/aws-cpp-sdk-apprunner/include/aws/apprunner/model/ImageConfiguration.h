...
class ImageConfiguration {
 public:
  ...
  void SetRuntimeEnvironmentVariables(RuntimeEnvironmentVariablesT&& value) {
    ...
    m_runtimeEnvironmentVariables = std::forward<RuntimeEnvironmentVariablesT>(value);
  }
  template <typename RuntimeEnvironmentVariablesT = Aws::Map<Aws::String, Aws::String>>
  ImageConfiguration& WithRuntimeEnvironmentVariables(RuntimeEnvironmentVariablesT&& value) {
    SetRuntimeEnvironmentVariables(std::forward<RuntimeEnvironmentVariablesT>(value));
    return *this;
  }
  ...
  ImageConfiguration& AddRuntimeEnvironmentVariables(RuntimeEnvironmentVariablesKeyT&& key, RuntimeEnvironmentVariablesValueT&& value) {
    m_runtimeEnvironmentVariablesHasBeenSet = true;
    m_runtimeEnvironmentVariables.emplace(std::forward<RuntimeEnvironmentVariablesKeyT>(key),
                                          std::forward<RuntimeEnvironmentVariablesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartCommand(StartCommandT&& value) {
    ...
    m_startCommand = std::forward<StartCommandT>(value);
  }
  template <typename StartCommandT = Aws::String>
  ImageConfiguration& WithStartCommand(StartCommandT&& value) {
    SetStartCommand(std::forward<StartCommandT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPort(PortT&& value) {
    ...
    m_port = std::forward<PortT>(value);
  }
  template <typename PortT = Aws::String>
  ImageConfiguration& WithPort(PortT&& value) {
    SetPort(std::forward<PortT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRuntimeEnvironmentSecrets(RuntimeEnvironmentSecretsT&& value) {
    ...
    m_runtimeEnvironmentSecrets = std::forward<RuntimeEnvironmentSecretsT>(value);
  }
  template <typename RuntimeEnvironmentSecretsT = Aws::Map<Aws::String, Aws::String>>
  ImageConfiguration& WithRuntimeEnvironmentSecrets(RuntimeEnvironmentSecretsT&& value) {
    SetRuntimeEnvironmentSecrets(std::forward<RuntimeEnvironmentSecretsT>(value));
    return *this;
  }
  ...
  ImageConfiguration& AddRuntimeEnvironmentSecrets(RuntimeEnvironmentSecretsKeyT&& key, RuntimeEnvironmentSecretsValueT&& value) {
    m_runtimeEnvironmentSecretsHasBeenSet = true;
    m_runtimeEnvironmentSecrets.emplace(std::forward<RuntimeEnvironmentSecretsKeyT>(key),
                                        std::forward<RuntimeEnvironmentSecretsValueT>(value));
    return *this;
  }
  ///@}
 private:
