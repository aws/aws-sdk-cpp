...
class Service {
 public:
  ...
  void SetServiceUrl(ServiceUrlT&& value) {
    ...
    m_serviceUrl = std::forward<ServiceUrlT>(value);
  }
  template <typename ServiceUrlT = Aws::String>
  Service& WithServiceUrl(ServiceUrlT&& value) {
    SetServiceUrl(std::forward<ServiceUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ServiceStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Service& WithStatus(ServiceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetHealthCheckConfiguration(HealthCheckConfigurationT&& value) {
    ...
    m_healthCheckConfiguration = std::forward<HealthCheckConfigurationT>(value);
  }
  template <typename HealthCheckConfigurationT = HealthCheckConfiguration>
  Service& WithHealthCheckConfiguration(HealthCheckConfigurationT&& value) {
    SetHealthCheckConfiguration(std::forward<HealthCheckConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAutoScalingConfigurationSummary(AutoScalingConfigurationSummaryT&& value) {
    ...
    m_autoScalingConfigurationSummary = std::forward<AutoScalingConfigurationSummaryT>(value);
  }
  template <typename AutoScalingConfigurationSummaryT = AutoScalingConfigurationSummary>
  Service& WithAutoScalingConfigurationSummary(AutoScalingConfigurationSummaryT&& value) {
    SetAutoScalingConfigurationSummary(std::forward<AutoScalingConfigurationSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetObservabilityConfiguration(ObservabilityConfigurationT&& value) {
    ...
    m_observabilityConfiguration = std::forward<ObservabilityConfigurationT>(value);
  }
  template <typename ObservabilityConfigurationT = ServiceObservabilityConfiguration>
  Service& WithObservabilityConfiguration(ObservabilityConfigurationT&& value) {
    SetObservabilityConfiguration(std::forward<ObservabilityConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
