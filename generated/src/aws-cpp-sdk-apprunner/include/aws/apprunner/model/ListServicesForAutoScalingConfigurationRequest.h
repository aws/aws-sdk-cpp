...
class ListServicesForAutoScalingConfigurationRequest : public AppRunnerRequest {
 public:
  ...
  template <typename AutoScalingConfigurationArnT = Aws::String>
  ListServicesForAutoScalingConfigurationRequest& WithAutoScalingConfigurationArn(AutoScalingConfigurationArnT&& value) {
  ...
  inline ListServicesForAutoScalingConfigurationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServicesForAutoScalingConfigurationRequest& WithNextToken(NextTokenT&& value) {
