...
namespace Model
{
  ...
  public:
    ...
    inline PauseServiceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PauseServiceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PauseServiceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
