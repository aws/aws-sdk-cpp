...
namespace Model
{
  ...
  public:
    ...
    template<typename ServiceT = Service>
    PauseServiceResult& WithService(ServiceT&& value) { SetService(std::forward<ServiceT>(value)); return *this;}
    ///@}
    ...
    template<typename OperationIdT = Aws::String>
    PauseServiceResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PauseServiceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
