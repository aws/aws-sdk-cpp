...
class CodeConfigurationValues {
 public:
  ...
  inline CodeConfigurationValues& WithRuntime(Runtime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  void SetBuildCommand(BuildCommandT&& value) {
    ...
    m_buildCommand = std::forward<BuildCommandT>(value);
  }
  template <typename BuildCommandT = Aws::String>
  CodeConfigurationValues& WithBuildCommand(BuildCommandT&& value) {
    SetBuildCommand(std::forward<BuildCommandT>(value));
    return *this;
  }
  ///@}
  ...
  CodeConfigurationValues& AddRuntimeEnvironmentVariables(RuntimeEnvironmentVariablesKeyT&& key,
                                                          RuntimeEnvironmentVariablesValueT&& value) {
    m_runtimeEnvironmentVariablesHasBeenSet = true;
