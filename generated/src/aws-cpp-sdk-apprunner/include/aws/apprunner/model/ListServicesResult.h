...
class ListServicesResult {
 public:
  AWS_APPRUNNER_API ListServicesResult() = default;
  ...
  void SetServiceSummaryList(ServiceSummaryListT&& value) {
    m_serviceSummaryListHasBeenSet = true;
    m_serviceSummaryList = std::forward<ServiceSummaryListT>(value);
  }
  template <typename ServiceSummaryListT = Aws::Vector<ServiceSummary>>
  ListServicesResult& WithServiceSummaryList(ServiceSummaryListT&& value) {
    SetServiceSummaryList(std::forward<ServiceSummaryListT>(value));
    return *this;
  }
  template <typename ServiceSummaryListT = ServiceSummary>
  ListServicesResult& AddServiceSummaryList(ServiceSummaryListT&& value) {
    m_serviceSummaryListHasBeenSet = true;
    m_serviceSummaryList.emplace_back(std::forward<ServiceSummaryListT>(value));
    return *this;
  }
  ///@}
