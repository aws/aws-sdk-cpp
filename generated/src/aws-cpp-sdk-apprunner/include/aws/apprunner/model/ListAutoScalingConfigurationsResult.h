...
class ListAutoScalingConfigurationsResult {
 public:
   ...
   * each call.</p>
   */
  inline const Aws::Vector<AutoScalingConfigurationSummary>& GetAutoScalingConfigurationSummaryList() const {
    return m_autoScalingConfigurationSummaryList;
  }
  template <typename AutoScalingConfigurationSummaryListT = Aws::Vector<AutoScalingConfigurationSummary>>
  void SetAutoScalingConfigurationSummaryList(AutoScalingConfigurationSummaryListT&& value) {
    m_autoScalingConfigurationSummaryListHasBeenSet = true;
    m_autoScalingConfigurationSummaryList = std::forward<AutoScalingConfigurationSummaryListT>(value);
  }
  template <typename AutoScalingConfigurationSummaryListT = Aws::Vector<AutoScalingConfigurationSummary>>
  ListAutoScalingConfigurationsResult& WithAutoScalingConfigurationSummaryList(AutoScalingConfigurationSummaryListT&& value) {
    SetAutoScalingConfigurationSummaryList(std::forward<AutoScalingConfigurationSummaryListT>(value));
    return *this;
  }
  template <typename AutoScalingConfigurationSummaryListT = AutoScalingConfigurationSummary>
  ListAutoScalingConfigurationsResult& AddAutoScalingConfigurationSummaryList(AutoScalingConfigurationSummaryListT&& value) {
    m_autoScalingConfigurationSummaryListHasBeenSet = true;
    m_autoScalingConfigurationSummaryList.emplace_back(std::forward<AutoScalingConfigurationSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAutoScalingConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAutoScalingConfigurationsResult& WithRequestId(RequestIdT&& value) {
