...
namespace Model
{
  ...
  {
  public:
    AWS_APPRUNNER_API CreateObservabilityConfigurationResult() = default;
    ...
    template<typename ObservabilityConfigurationT = ObservabilityConfiguration>
    CreateObservabilityConfigurationResult& WithObservabilityConfiguration(ObservabilityConfigurationT&& value) { SetObservabilityConfiguration(std::forward<ObservabilityConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateObservabilityConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
