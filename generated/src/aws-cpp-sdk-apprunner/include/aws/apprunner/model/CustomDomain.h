...
class CustomDomain {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  CustomDomain& WithDomainName(DomainNameT&& value) {
  ...
  inline CustomDomain& WithEnableWWWSubdomain(bool value) {
  ...
  void SetCertificateValidationRecords(CertificateValidationRecordsT&& value) {
    m_certificateValidationRecordsHasBeenSet = true;
    m_certificateValidationRecords = std::forward<CertificateValidationRecordsT>(value);
  }
  template <typename CertificateValidationRecordsT = Aws::Vector<CertificateValidationRecord>>
  CustomDomain& WithCertificateValidationRecords(CertificateValidationRecordsT&& value) {
    SetCertificateValidationRecords(std::forward<CertificateValidationRecordsT>(value));
    return *this;
  }
  template <typename CertificateValidationRecordsT = CertificateValidationRecord>
  CustomDomain& AddCertificateValidationRecords(CertificateValidationRecordsT&& value) {
    m_certificateValidationRecordsHasBeenSet = true;
    m_certificateValidationRecords.emplace_back(std::forward<CertificateValidationRecordsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(CustomDomainAssociationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CustomDomain& WithStatus(CustomDomainAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
