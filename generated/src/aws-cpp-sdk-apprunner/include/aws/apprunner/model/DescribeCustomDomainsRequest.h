...
class DescribeCustomDomainsRequest : public AppRunnerRequest {
 public:
  AWS_APPRUNNER_API DescribeCustomDomainsRequest() = default;
  ...
  template <typename ServiceArnT = Aws::String>
  DescribeCustomDomainsRequest& WithServiceArn(ServiceArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCustomDomainsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeCustomDomainsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
