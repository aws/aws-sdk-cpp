...
class ListVpcIngressConnectionsResult {
 public:
   ...
   * each call.</p>
   */
  inline const Aws::Vector<VpcIngressConnectionSummary>& GetVpcIngressConnectionSummaryList() const {
    return m_vpcIngressConnectionSummaryList;
  }
  template <typename VpcIngressConnectionSummaryListT = Aws::Vector<VpcIngressConnectionSummary>>
  void SetVpcIngressConnectionSummaryList(VpcIngressConnectionSummaryListT&& value) {
    m_vpcIngressConnectionSummaryListHasBeenSet = true;
    m_vpcIngressConnectionSummaryList = std::forward<VpcIngressConnectionSummaryListT>(value);
  }
  template <typename VpcIngressConnectionSummaryListT = Aws::Vector<VpcIngressConnectionSummary>>
  ListVpcIngressConnectionsResult& WithVpcIngressConnectionSummaryList(VpcIngressConnectionSummaryListT&& value) {
    SetVpcIngressConnectionSummaryList(std::forward<VpcIngressConnectionSummaryListT>(value));
    return *this;
  }
  template <typename VpcIngressConnectionSummaryListT = VpcIngressConnectionSummary>
  ListVpcIngressConnectionsResult& AddVpcIngressConnectionSummaryList(VpcIngressConnectionSummaryListT&& value) {
    m_vpcIngressConnectionSummaryListHasBeenSet = true;
    m_vpcIngressConnectionSummaryList.emplace_back(std::forward<VpcIngressConnectionSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVpcIngressConnectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVpcIngressConnectionsResult& WithRequestId(RequestIdT&& value) {
