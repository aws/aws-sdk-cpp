...
class AWS_APPRUNNER_API AppRunnerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  AppRunnerClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<AppRunnerEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AssociateCustomDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateCustomDomain that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateCustomDomainRequestT = Model::AssociateCustomDomainRequest>
  void AssociateCustomDomainAsync(const AssociateCustomDomainRequestT& request, const AssociateCustomDomainResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAutoScalingConfigurationOutcome CreateAutoScalingConfiguration(
      const Model::CreateAutoScalingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateAutoScalingConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAutoScalingConfigurationRequestT = Model::CreateAutoScalingConfigurationRequest>
  Model::CreateAutoScalingConfigurationOutcomeCallable CreateAutoScalingConfigurationCallable(
      const CreateAutoScalingConfigurationRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::CreateAutoScalingConfiguration, request);
  }

  /**
   * An Async wrapper for CreateAutoScalingConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateAutoScalingConfigurationRequestT = Model::CreateAutoScalingConfigurationRequest>
  void CreateAutoScalingConfigurationAsync(const CreateAutoScalingConfigurationRequestT& request,
                                           const CreateAutoScalingConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateObservabilityConfigurationOutcome CreateObservabilityConfiguration(
      const Model::CreateObservabilityConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateObservabilityConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateObservabilityConfigurationRequestT = Model::CreateObservabilityConfigurationRequest>
  Model::CreateObservabilityConfigurationOutcomeCallable CreateObservabilityConfigurationCallable(
      const CreateObservabilityConfigurationRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::CreateObservabilityConfiguration, request);
  }

  /**
   * An Async wrapper for CreateObservabilityConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateObservabilityConfigurationRequestT = Model::CreateObservabilityConfigurationRequest>
  void CreateObservabilityConfigurationAsync(const CreateObservabilityConfigurationRequestT& request,
                                             const CreateObservabilityConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateVpcConnector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateVpcConnector that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateVpcConnectorRequestT = Model::CreateVpcConnectorRequest>
  void CreateVpcConnectorAsync(const CreateVpcConnectorRequestT& request, const CreateVpcConnectorResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateVpcIngressConnectionOutcome CreateVpcIngressConnection(
      const Model::CreateVpcIngressConnectionRequest& request) const;

  /**
   * A Callable wrapper for CreateVpcIngressConnection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateVpcIngressConnectionRequestT = Model::CreateVpcIngressConnectionRequest>
  Model::CreateVpcIngressConnectionOutcomeCallable CreateVpcIngressConnectionCallable(
      const CreateVpcIngressConnectionRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::CreateVpcIngressConnection, request);
  }

  /**
   * An Async wrapper for CreateVpcIngressConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateVpcIngressConnectionRequestT = Model::CreateVpcIngressConnectionRequest>
  void CreateVpcIngressConnectionAsync(const CreateVpcIngressConnectionRequestT& request,
                                       const CreateVpcIngressConnectionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAutoScalingConfigurationOutcome DeleteAutoScalingConfiguration(
      const Model::DeleteAutoScalingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteAutoScalingConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAutoScalingConfigurationRequestT = Model::DeleteAutoScalingConfigurationRequest>
  Model::DeleteAutoScalingConfigurationOutcomeCallable DeleteAutoScalingConfigurationCallable(
      const DeleteAutoScalingConfigurationRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::DeleteAutoScalingConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteAutoScalingConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteAutoScalingConfigurationRequestT = Model::DeleteAutoScalingConfigurationRequest>
  void DeleteAutoScalingConfigurationAsync(const DeleteAutoScalingConfigurationRequestT& request,
                                           const DeleteAutoScalingConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteObservabilityConfigurationOutcome DeleteObservabilityConfiguration(
      const Model::DeleteObservabilityConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteObservabilityConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteObservabilityConfigurationRequestT = Model::DeleteObservabilityConfigurationRequest>
  Model::DeleteObservabilityConfigurationOutcomeCallable DeleteObservabilityConfigurationCallable(
      const DeleteObservabilityConfigurationRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::DeleteObservabilityConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteObservabilityConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteObservabilityConfigurationRequestT = Model::DeleteObservabilityConfigurationRequest>
  void DeleteObservabilityConfigurationAsync(const DeleteObservabilityConfigurationRequestT& request,
                                             const DeleteObservabilityConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteVpcConnector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteVpcConnector that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteVpcConnectorRequestT = Model::DeleteVpcConnectorRequest>
  void DeleteVpcConnectorAsync(const DeleteVpcConnectorRequestT& request, const DeleteVpcConnectorResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteVpcIngressConnectionOutcome DeleteVpcIngressConnection(
      const Model::DeleteVpcIngressConnectionRequest& request) const;

  /**
   * A Callable wrapper for DeleteVpcIngressConnection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteVpcIngressConnectionRequestT = Model::DeleteVpcIngressConnectionRequest>
  Model::DeleteVpcIngressConnectionOutcomeCallable DeleteVpcIngressConnectionCallable(
      const DeleteVpcIngressConnectionRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::DeleteVpcIngressConnection, request);
  }

  /**
   * An Async wrapper for DeleteVpcIngressConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteVpcIngressConnectionRequestT = Model::DeleteVpcIngressConnectionRequest>
  void DeleteVpcIngressConnectionAsync(const DeleteVpcIngressConnectionRequestT& request,
                                       const DeleteVpcIngressConnectionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAutoScalingConfigurationOutcome DescribeAutoScalingConfiguration(
      const Model::DescribeAutoScalingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeAutoScalingConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeAutoScalingConfigurationRequestT = Model::DescribeAutoScalingConfigurationRequest>
  Model::DescribeAutoScalingConfigurationOutcomeCallable DescribeAutoScalingConfigurationCallable(
      const DescribeAutoScalingConfigurationRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::DescribeAutoScalingConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeAutoScalingConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAutoScalingConfigurationRequestT = Model::DescribeAutoScalingConfigurationRequest>
  void DescribeAutoScalingConfigurationAsync(const DescribeAutoScalingConfigurationRequestT& request,
                                             const DescribeAutoScalingConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeCustomDomains that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCustomDomains that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCustomDomainsRequestT = Model::DescribeCustomDomainsRequest>
  void DescribeCustomDomainsAsync(const DescribeCustomDomainsRequestT& request, const DescribeCustomDomainsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeObservabilityConfigurationOutcome DescribeObservabilityConfiguration(
      const Model::DescribeObservabilityConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeObservabilityConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeObservabilityConfigurationRequestT = Model::DescribeObservabilityConfigurationRequest>
  Model::DescribeObservabilityConfigurationOutcomeCallable DescribeObservabilityConfigurationCallable(
      const DescribeObservabilityConfigurationRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::DescribeObservabilityConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeObservabilityConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeObservabilityConfigurationRequestT = Model::DescribeObservabilityConfigurationRequest>
  void DescribeObservabilityConfigurationAsync(const DescribeObservabilityConfigurationRequestT& request,
                                               const DescribeObservabilityConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeService that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeServiceRequestT = Model::DescribeServiceRequest>
  void DescribeServiceAsync(const DescribeServiceRequestT& request, const DescribeServiceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeVpcConnector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeVpcConnector that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeVpcConnectorRequestT = Model::DescribeVpcConnectorRequest>
  void DescribeVpcConnectorAsync(const DescribeVpcConnectorRequestT& request, const DescribeVpcConnectorResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeVpcIngressConnectionOutcome DescribeVpcIngressConnection(
      const Model::DescribeVpcIngressConnectionRequest& request) const;

  /**
   * A Callable wrapper for DescribeVpcIngressConnection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeVpcIngressConnectionRequestT = Model::DescribeVpcIngressConnectionRequest>
  Model::DescribeVpcIngressConnectionOutcomeCallable DescribeVpcIngressConnectionCallable(
      const DescribeVpcIngressConnectionRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::DescribeVpcIngressConnection, request);
  }

  /**
   * An Async wrapper for DescribeVpcIngressConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeVpcIngressConnectionRequestT = Model::DescribeVpcIngressConnectionRequest>
  void DescribeVpcIngressConnectionAsync(const DescribeVpcIngressConnectionRequestT& request,
                                         const DescribeVpcIngressConnectionResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateCustomDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateCustomDomain that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateCustomDomainRequestT = Model::DisassociateCustomDomainRequest>
  void DisassociateCustomDomainAsync(const DisassociateCustomDomainRequestT& request,
                                     const DisassociateCustomDomainResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAutoScalingConfigurationsOutcome ListAutoScalingConfigurations(
      const Model::ListAutoScalingConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAutoScalingConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAutoScalingConfigurationsRequestT = Model::ListAutoScalingConfigurationsRequest>
  Model::ListAutoScalingConfigurationsOutcomeCallable ListAutoScalingConfigurationsCallable(
      const ListAutoScalingConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&AppRunnerClient::ListAutoScalingConfigurations, request);
  }

  /**
   * An Async wrapper for ListAutoScalingConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAutoScalingConfigurationsRequestT = Model::ListAutoScalingConfigurationsRequest>
  void ListAutoScalingConfigurationsAsync(const ListAutoScalingConfigurationsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListObservabilityConfigurationsOutcome ListObservabilityConfigurations(
      const Model::ListObservabilityConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListObservabilityConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListObservabilityConfigurationsRequestT = Model::ListObservabilityConfigurationsRequest>
  Model::ListObservabilityConfigurationsOutcomeCallable ListObservabilityConfigurationsCallable(
      const ListObservabilityConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&AppRunnerClient::ListObservabilityConfigurations, request);
  }

  /**
   * An Async wrapper for ListObservabilityConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListObservabilityConfigurationsRequestT = Model::ListObservabilityConfigurationsRequest>
  void ListObservabilityConfigurationsAsync(const ListObservabilityConfigurationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListObservabilityConfigurationsRequestT& request = {}) const {
   ...
   */
  template <typename ListOperationsRequestT = Model::ListOperationsRequest>
  void ListOperationsAsync(const ListOperationsRequestT& request, const ListOperationsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListServicesForAutoScalingConfigurationOutcome ListServicesForAutoScalingConfiguration(
      const Model::ListServicesForAutoScalingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for ListServicesForAutoScalingConfiguration that returns a future to the operation so that it can be executed in
  ...
  Model::ListServicesForAutoScalingConfigurationOutcomeCallable ListServicesForAutoScalingConfigurationCallable(
      const ListServicesForAutoScalingConfigurationRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::ListServicesForAutoScalingConfiguration, request);
  }

  /**
   * An Async wrapper for ListServicesForAutoScalingConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListServicesForAutoScalingConfigurationRequestT = Model::ListServicesForAutoScalingConfigurationRequest>
  void ListServicesForAutoScalingConfigurationAsync(const ListServicesForAutoScalingConfigurationRequestT& request,
                                                    const ListServicesForAutoScalingConfigurationResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListVpcConnectors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListVpcConnectors that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListVpcConnectorsRequestT = Model::ListVpcConnectorsRequest>
  void ListVpcConnectorsAsync(const ListVpcConnectorsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListVpcConnectorsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListVpcIngressConnectionsOutcome ListVpcIngressConnections(
      const Model::ListVpcIngressConnectionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListVpcIngressConnections that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListVpcIngressConnectionsRequestT = Model::ListVpcIngressConnectionsRequest>
  Model::ListVpcIngressConnectionsOutcomeCallable ListVpcIngressConnectionsCallable(
      const ListVpcIngressConnectionsRequestT& request = {}) const {
    return SubmitCallable(&AppRunnerClient::ListVpcIngressConnections, request);
  }

  /**
   * An Async wrapper for ListVpcIngressConnections that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVpcIngressConnectionsRequestT = Model::ListVpcIngressConnectionsRequest>
  void ListVpcIngressConnectionsAsync(const ListVpcIngressConnectionsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListVpcIngressConnectionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for PauseService that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PauseServiceRequestT = Model::PauseServiceRequest>
  void PauseServiceAsync(const PauseServiceRequestT& request, const PauseServiceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ResumeService that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResumeServiceRequestT = Model::ResumeServiceRequest>
  void ResumeServiceAsync(const ResumeServiceRequestT& request, const ResumeServiceResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDefaultAutoScalingConfigurationOutcome UpdateDefaultAutoScalingConfiguration(
      const Model::UpdateDefaultAutoScalingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateDefaultAutoScalingConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateDefaultAutoScalingConfigurationRequestT = Model::UpdateDefaultAutoScalingConfigurationRequest>
  Model::UpdateDefaultAutoScalingConfigurationOutcomeCallable UpdateDefaultAutoScalingConfigurationCallable(
      const UpdateDefaultAutoScalingConfigurationRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::UpdateDefaultAutoScalingConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateDefaultAutoScalingConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateDefaultAutoScalingConfigurationRequestT = Model::UpdateDefaultAutoScalingConfigurationRequest>
  void UpdateDefaultAutoScalingConfigurationAsync(const UpdateDefaultAutoScalingConfigurationRequestT& request,
                                                  const UpdateDefaultAutoScalingConfigurationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateVpcIngressConnectionOutcome UpdateVpcIngressConnection(
      const Model::UpdateVpcIngressConnectionRequest& request) const;

  /**
   * A Callable wrapper for UpdateVpcIngressConnection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateVpcIngressConnectionRequestT = Model::UpdateVpcIngressConnectionRequest>
  Model::UpdateVpcIngressConnectionOutcomeCallable UpdateVpcIngressConnectionCallable(
      const UpdateVpcIngressConnectionRequestT& request) const {
    return SubmitCallable(&AppRunnerClient::UpdateVpcIngressConnection, request);
  }

  /**
   * An Async wrapper for UpdateVpcIngressConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateVpcIngressConnectionRequestT = Model::UpdateVpcIngressConnectionRequest>
  void UpdateVpcIngressConnectionAsync(const UpdateVpcIngressConnectionRequestT& request,
                                       const UpdateVpcIngressConnectionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
