...
namespace EKS
{
const size_t EKSEndpointRules::RulesBlobStrLen = 4156;
const size_t EKSEndpointRules::RulesBlobSize = 4157;
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','f','i','p','s','.','e','k',
's','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.','c','o','m','"',
',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s',
'"',':','{','}','}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',',',
