...
DisassociateAccessPolicyResult::DisassociateAccessPolicyResult()
{
}

DisassociateAccessPolicyResult::DisassociateAccessPolicyResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
