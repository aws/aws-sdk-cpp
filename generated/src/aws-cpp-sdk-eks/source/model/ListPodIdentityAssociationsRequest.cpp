...
Aws::String ListPodIdentityAssociationsRequest::SerializePayload() const
{
  return {};
}

void ListPodIdentityAssociationsRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
    ...
    {
      ss << m_serviceAccount;
      uri.AddQueryStringParameter("serviceAccount", ss.str());
      ss.str("");
    }
