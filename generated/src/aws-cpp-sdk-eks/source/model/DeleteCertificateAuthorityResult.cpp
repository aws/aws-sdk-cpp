...
DeleteCertificateAuthorityResult::DeleteCertificateAuthorityResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteCertificateAuthorityResult& DeleteCertificateAuthorityResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
