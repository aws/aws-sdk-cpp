...
ActivateCertificateAuthorityResult::ActivateCertificateAuthorityResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ActivateCertificateAuthorityResult& ActivateCertificateAuthorityResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
