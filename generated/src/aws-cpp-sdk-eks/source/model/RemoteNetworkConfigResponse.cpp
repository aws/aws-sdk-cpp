...
RemoteNetworkConfigResponse::RemoteNetworkConfigResponse(JsonView jsonValue) { *this = jsonValue; }

RemoteNetworkConfigResponse& RemoteNetworkConfigResponse::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("remoteNodeNetworks")) {
    ...
    for (unsigned remoteNodeNetworksIndex = 0; remoteNodeNetworksIndex < remoteNodeNetworksJsonList.GetLength();
         ++remoteNodeNetworksIndex) {
...
JsonValue RemoteNetworkConfigResponse::Jsonize() const {
  JsonValue payload;
