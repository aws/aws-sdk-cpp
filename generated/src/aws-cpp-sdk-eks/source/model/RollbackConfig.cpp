...
RollbackConfig::RollbackConfig(JsonView jsonValue) { *this = jsonValue; }

RollbackConfig& RollbackConfig::operator=(JsonView jsonValue) {
...
JsonValue RollbackConfig::Jsonize() const {
  JsonValue payload;
