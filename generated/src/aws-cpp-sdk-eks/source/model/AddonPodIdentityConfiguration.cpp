...
AddonPodIdentityConfiguration::AddonPodIdentityConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
AddonPodIdentityConfiguration& AddonPodIdentityConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("recommendedManagedPolicies")) {
    ...
    for (unsigned recommendedManagedPoliciesIndex = 0; recommendedManagedPoliciesIndex < recommendedManagedPoliciesJsonList.GetLength();
         ++recommendedManagedPoliciesIndex) {
...
JsonValue AddonPodIdentityConfiguration::Jsonize() const {
  ...
  if (m_recommendedManagedPoliciesHasBeenSet) {
    ...
    for (unsigned recommendedManagedPoliciesIndex = 0; recommendedManagedPoliciesIndex < recommendedManagedPoliciesJsonList.GetLength();
         ++recommendedManagedPoliciesIndex) {
      recommendedManagedPoliciesJsonList[recommendedManagedPoliciesIndex].AsString(
          m_recommendedManagedPolicies[recommendedManagedPoliciesIndex]);
    }
