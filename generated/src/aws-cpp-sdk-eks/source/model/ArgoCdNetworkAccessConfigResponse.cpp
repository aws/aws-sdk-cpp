...
ArgoCdNetworkAccessConfigResponse::ArgoCdNetworkAccessConfigResponse(JsonView jsonValue) { *this = jsonValue; }

ArgoCdNetworkAccessConfigResponse& ArgoCdNetworkAccessConfigResponse::operator=(JsonView jsonValue) {
...
JsonValue ArgoCdNetworkAccessConfigResponse::Jsonize() const {
  JsonValue payload;
