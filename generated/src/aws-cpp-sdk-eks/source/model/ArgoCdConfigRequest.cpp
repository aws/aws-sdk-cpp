...
ArgoCdConfigRequest::ArgoCdConfigRequest(JsonView jsonValue) { *this = jsonValue; }

ArgoCdConfigRequest& ArgoCdConfigRequest::operator=(JsonView jsonValue) {
...
JsonValue ArgoCdConfigRequest::Jsonize() const {
  JsonValue payload;
