...
class AWS_EKS_API EKSClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  EKSClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<EKSEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AssociateAccessPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateAccessPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateAccessPolicyRequestT = Model::AssociateAccessPolicyRequest>
  void AssociateAccessPolicyAsync(const AssociateAccessPolicyRequestT& request, const AssociateAccessPolicyResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssociateEncryptionConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AssociateEncryptionConfigRequestT = Model::AssociateEncryptionConfigRequest>
  Model::AssociateEncryptionConfigOutcomeCallable AssociateEncryptionConfigCallable(
      const AssociateEncryptionConfigRequestT& request) const {
    return SubmitCallable(&EKSClient::AssociateEncryptionConfig, request);
  }

  /**
   * An Async wrapper for AssociateEncryptionConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateEncryptionConfigRequestT = Model::AssociateEncryptionConfigRequest>
  void AssociateEncryptionConfigAsync(const AssociateEncryptionConfigRequestT& request,
                                      const AssociateEncryptionConfigResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateIdentityProviderConfigOutcome AssociateIdentityProviderConfig(
      const Model::AssociateIdentityProviderConfigRequest& request) const;

  /**
   * A Callable wrapper for AssociateIdentityProviderConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateIdentityProviderConfigRequestT = Model::AssociateIdentityProviderConfigRequest>
  Model::AssociateIdentityProviderConfigOutcomeCallable AssociateIdentityProviderConfigCallable(
      const AssociateIdentityProviderConfigRequestT& request) const {
    return SubmitCallable(&EKSClient::AssociateIdentityProviderConfig, request);
  }

  /**
   * An Async wrapper for AssociateIdentityProviderConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateIdentityProviderConfigRequestT = Model::AssociateIdentityProviderConfigRequest>
  void AssociateIdentityProviderConfigAsync(const AssociateIdentityProviderConfigRequestT& request,
                                            const AssociateIdentityProviderConfigResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAccessEntry that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAccessEntry that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAccessEntryRequestT = Model::CreateAccessEntryRequest>
  void CreateAccessEntryAsync(const CreateAccessEntryRequestT& request, const CreateAccessEntryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAddon that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAddonRequestT = Model::CreateAddonRequest>
  void CreateAddonAsync(const CreateAddonRequestT& request, const CreateAddonResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateEksAnywhereSubscriptionOutcome CreateEksAnywhereSubscription(
      const Model::CreateEksAnywhereSubscriptionRequest& request) const;

  /**
   * A Callable wrapper for CreateEksAnywhereSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateEksAnywhereSubscriptionRequestT = Model::CreateEksAnywhereSubscriptionRequest>
  Model::CreateEksAnywhereSubscriptionOutcomeCallable CreateEksAnywhereSubscriptionCallable(
      const CreateEksAnywhereSubscriptionRequestT& request) const {
    return SubmitCallable(&EKSClient::CreateEksAnywhereSubscription, request);
  }

  /**
   * An Async wrapper for CreateEksAnywhereSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEksAnywhereSubscriptionRequestT = Model::CreateEksAnywhereSubscriptionRequest>
  void CreateEksAnywhereSubscriptionAsync(const CreateEksAnywhereSubscriptionRequestT& request,
                                          const CreateEksAnywhereSubscriptionResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateFargateProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateFargateProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFargateProfileRequestT = Model::CreateFargateProfileRequest>
  void CreateFargateProfileAsync(const CreateFargateProfileRequestT& request, const CreateFargateProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * deploy a custom AMI using a launch template.</p> <p>For later updates, you will
   * only be able to update a node group using a launch template only if it was
   ...
   * the launch template version with necessary changes. For more information about
  ...
  /**
   * An Async wrapper for CreateNodegroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateNodegroupRequestT = Model::CreateNodegroupRequest>
  void CreateNodegroupAsync(const CreateNodegroupRequestT& request, const CreateNodegroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePodIdentityAssociationOutcome CreatePodIdentityAssociation(
      const Model::CreatePodIdentityAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreatePodIdentityAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePodIdentityAssociationRequestT = Model::CreatePodIdentityAssociationRequest>
  Model::CreatePodIdentityAssociationOutcomeCallable CreatePodIdentityAssociationCallable(
      const CreatePodIdentityAssociationRequestT& request) const {
    return SubmitCallable(&EKSClient::CreatePodIdentityAssociation, request);
  }

  /**
   * An Async wrapper for CreatePodIdentityAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePodIdentityAssociationRequestT = Model::CreatePodIdentityAssociationRequest>
  void CreatePodIdentityAssociationAsync(const CreatePodIdentityAssociationRequestT& request,
                                         const CreatePodIdentityAssociationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAccessEntry that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAccessEntry that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAccessEntryRequestT = Model::DeleteAccessEntryRequest>
  void DeleteAccessEntryAsync(const DeleteAccessEntryRequestT& request, const DeleteAccessEntryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAddon that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAddonRequestT = Model::DeleteAddonRequest>
  void DeleteAddonAsync(const DeleteAddonRequestT& request, const DeleteAddonResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteEksAnywhereSubscriptionOutcome DeleteEksAnywhereSubscription(
      const Model::DeleteEksAnywhereSubscriptionRequest& request) const;

  /**
   * A Callable wrapper for DeleteEksAnywhereSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteEksAnywhereSubscriptionRequestT = Model::DeleteEksAnywhereSubscriptionRequest>
  Model::DeleteEksAnywhereSubscriptionOutcomeCallable DeleteEksAnywhereSubscriptionCallable(
      const DeleteEksAnywhereSubscriptionRequestT& request) const {
    return SubmitCallable(&EKSClient::DeleteEksAnywhereSubscription, request);
  }

  /**
   * An Async wrapper for DeleteEksAnywhereSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEksAnywhereSubscriptionRequestT = Model::DeleteEksAnywhereSubscriptionRequest>
  void DeleteEksAnywhereSubscriptionAsync(const DeleteEksAnywhereSubscriptionRequestT& request,
                                          const DeleteEksAnywhereSubscriptionResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteFargateProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteFargateProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteFargateProfileRequestT = Model::DeleteFargateProfileRequest>
  void DeleteFargateProfileAsync(const DeleteFargateProfileRequestT& request, const DeleteFargateProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteNodegroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteNodegroupRequestT = Model::DeleteNodegroupRequest>
  void DeleteNodegroupAsync(const DeleteNodegroupRequestT& request, const DeleteNodegroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePodIdentityAssociationOutcome DeletePodIdentityAssociation(
      const Model::DeletePodIdentityAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeletePodIdentityAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePodIdentityAssociationRequestT = Model::DeletePodIdentityAssociationRequest>
  Model::DeletePodIdentityAssociationOutcomeCallable DeletePodIdentityAssociationCallable(
      const DeletePodIdentityAssociationRequestT& request) const {
    return SubmitCallable(&EKSClient::DeletePodIdentityAssociation, request);
  }

  /**
   * An Async wrapper for DeletePodIdentityAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePodIdentityAssociationRequestT = Model::DeletePodIdentityAssociationRequest>
  void DeletePodIdentityAssociationAsync(const DeletePodIdentityAssociationRequestT& request,
                                         const DeletePodIdentityAssociationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterCluster that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterCluster that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeregisterClusterRequestT = Model::DeregisterClusterRequest>
  void DeregisterClusterAsync(const DeregisterClusterRequestT& request, const DeregisterClusterResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAccessEntry that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAccessEntry that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAccessEntryRequestT = Model::DescribeAccessEntryRequest>
  void DescribeAccessEntryAsync(const DescribeAccessEntryRequestT& request, const DescribeAccessEntryResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeAddon that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeAddonRequestT = Model::DescribeAddonRequest>
  void DescribeAddonAsync(const DescribeAddonRequestT& request, const DescribeAddonResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAddonConfigurationOutcome DescribeAddonConfiguration(
      const Model::DescribeAddonConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeAddonConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAddonConfigurationRequestT = Model::DescribeAddonConfigurationRequest>
  Model::DescribeAddonConfigurationOutcomeCallable DescribeAddonConfigurationCallable(
      const DescribeAddonConfigurationRequestT& request) const {
    return SubmitCallable(&EKSClient::DescribeAddonConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeAddonConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAddonConfigurationRequestT = Model::DescribeAddonConfigurationRequest>
  void DescribeAddonConfigurationAsync(const DescribeAddonConfigurationRequestT& request,
                                       const DescribeAddonConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAddonVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAddonVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAddonVersionsRequestT = Model::DescribeAddonVersionsRequest>
  void DescribeAddonVersionsAsync(const DescribeAddonVersionsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEksAnywhereSubscriptionOutcome DescribeEksAnywhereSubscription(
      const Model::DescribeEksAnywhereSubscriptionRequest& request) const;

  /**
   * A Callable wrapper for DescribeEksAnywhereSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEksAnywhereSubscriptionRequestT = Model::DescribeEksAnywhereSubscriptionRequest>
  Model::DescribeEksAnywhereSubscriptionOutcomeCallable DescribeEksAnywhereSubscriptionCallable(
      const DescribeEksAnywhereSubscriptionRequestT& request) const {
    return SubmitCallable(&EKSClient::DescribeEksAnywhereSubscription, request);
  }

  /**
   * An Async wrapper for DescribeEksAnywhereSubscription that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeEksAnywhereSubscriptionRequestT = Model::DescribeEksAnywhereSubscriptionRequest>
  void DescribeEksAnywhereSubscriptionAsync(const DescribeEksAnywhereSubscriptionRequestT& request,
                                            const DescribeEksAnywhereSubscriptionResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeFargateProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFargateProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFargateProfileRequestT = Model::DescribeFargateProfileRequest>
  void DescribeFargateProfileAsync(const DescribeFargateProfileRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeIdentityProviderConfigOutcome DescribeIdentityProviderConfig(
      const Model::DescribeIdentityProviderConfigRequest& request) const;

  /**
   * A Callable wrapper for DescribeIdentityProviderConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeIdentityProviderConfigRequestT = Model::DescribeIdentityProviderConfigRequest>
  Model::DescribeIdentityProviderConfigOutcomeCallable DescribeIdentityProviderConfigCallable(
      const DescribeIdentityProviderConfigRequestT& request) const {
    return SubmitCallable(&EKSClient::DescribeIdentityProviderConfig, request);
  }

  /**
   * An Async wrapper for DescribeIdentityProviderConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeIdentityProviderConfigRequestT = Model::DescribeIdentityProviderConfigRequest>
  void DescribeIdentityProviderConfigAsync(const DescribeIdentityProviderConfigRequestT& request,
                                           const DescribeIdentityProviderConfigResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeInsightsRefresh that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeInsightsRefresh that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInsightsRefreshRequestT = Model::DescribeInsightsRefreshRequest>
  void DescribeInsightsRefreshAsync(const DescribeInsightsRefreshRequestT& request,
                                    const DescribeInsightsRefreshResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeNodegroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeNodegroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeNodegroupRequestT = Model::DescribeNodegroupRequest>
  void DescribeNodegroupAsync(const DescribeNodegroupRequestT& request, const DescribeNodegroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribePodIdentityAssociationOutcome DescribePodIdentityAssociation(
      const Model::DescribePodIdentityAssociationRequest& request) const;

  /**
   * A Callable wrapper for DescribePodIdentityAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribePodIdentityAssociationRequestT = Model::DescribePodIdentityAssociationRequest>
  Model::DescribePodIdentityAssociationOutcomeCallable DescribePodIdentityAssociationCallable(
      const DescribePodIdentityAssociationRequestT& request) const {
    return SubmitCallable(&EKSClient::DescribePodIdentityAssociation, request);
  }

  /**
   * An Async wrapper for DescribePodIdentityAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribePodIdentityAssociationRequestT = Model::DescribePodIdentityAssociationRequest>
  void DescribePodIdentityAssociationAsync(const DescribePodIdentityAssociationRequestT& request,
                                           const DescribePodIdentityAssociationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeUpdate that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeUpdateRequestT = Model::DescribeUpdateRequest>
  void DescribeUpdateAsync(const DescribeUpdateRequestT& request, const DescribeUpdateResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateAccessPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateAccessPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateAccessPolicyRequestT = Model::DisassociateAccessPolicyRequest>
  void DisassociateAccessPolicyAsync(const DisassociateAccessPolicyRequestT& request,
                                     const DisassociateAccessPolicyResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateIdentityProviderConfigOutcome DisassociateIdentityProviderConfig(
      const Model::DisassociateIdentityProviderConfigRequest& request) const;

  /**
   * A Callable wrapper for DisassociateIdentityProviderConfig that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateIdentityProviderConfigRequestT = Model::DisassociateIdentityProviderConfigRequest>
  Model::DisassociateIdentityProviderConfigOutcomeCallable DisassociateIdentityProviderConfigCallable(
      const DisassociateIdentityProviderConfigRequestT& request) const {
    return SubmitCallable(&EKSClient::DisassociateIdentityProviderConfig, request);
  }

  /**
   * An Async wrapper for DisassociateIdentityProviderConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateIdentityProviderConfigRequestT = Model::DisassociateIdentityProviderConfigRequest>
  void DisassociateIdentityProviderConfigAsync(const DisassociateIdentityProviderConfigRequestT& request,
                                               const DisassociateIdentityProviderConfigResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccessEntries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccessEntries that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAccessEntriesRequestT = Model::ListAccessEntriesRequest>
  void ListAccessEntriesAsync(const ListAccessEntriesRequestT& request, const ListAccessEntriesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAddons that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAddonsRequestT = Model::ListAddonsRequest>
  void ListAddonsAsync(const ListAddonsRequestT& request, const ListAddonsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAssociatedAccessPoliciesOutcome ListAssociatedAccessPolicies(
      const Model::ListAssociatedAccessPoliciesRequest& request) const;

  /**
   * A Callable wrapper for ListAssociatedAccessPolicies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAssociatedAccessPoliciesRequestT = Model::ListAssociatedAccessPoliciesRequest>
  Model::ListAssociatedAccessPoliciesOutcomeCallable ListAssociatedAccessPoliciesCallable(
      const ListAssociatedAccessPoliciesRequestT& request) const {
    return SubmitCallable(&EKSClient::ListAssociatedAccessPolicies, request);
  }

  /**
   * An Async wrapper for ListAssociatedAccessPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssociatedAccessPoliciesRequestT = Model::ListAssociatedAccessPoliciesRequest>
  void ListAssociatedAccessPoliciesAsync(const ListAssociatedAccessPoliciesRequestT& request,
                                         const ListAssociatedAccessPoliciesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEksAnywhereSubscriptionsOutcome ListEksAnywhereSubscriptions(
      const Model::ListEksAnywhereSubscriptionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListEksAnywhereSubscriptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListEksAnywhereSubscriptionsRequestT = Model::ListEksAnywhereSubscriptionsRequest>
  Model::ListEksAnywhereSubscriptionsOutcomeCallable ListEksAnywhereSubscriptionsCallable(
      const ListEksAnywhereSubscriptionsRequestT& request = {}) const {
    return SubmitCallable(&EKSClient::ListEksAnywhereSubscriptions, request);
  }

  /**
   * An Async wrapper for ListEksAnywhereSubscriptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEksAnywhereSubscriptionsRequestT = Model::ListEksAnywhereSubscriptionsRequest>
  void ListEksAnywhereSubscriptionsAsync(const ListEksAnywhereSubscriptionsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListEksAnywhereSubscriptionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFargateProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFargateProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFargateProfilesRequestT = Model::ListFargateProfilesRequest>
  void ListFargateProfilesAsync(const ListFargateProfilesRequestT& request, const ListFargateProfilesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListIdentityProviderConfigsOutcome ListIdentityProviderConfigs(
      const Model::ListIdentityProviderConfigsRequest& request) const;

  /**
   * A Callable wrapper for ListIdentityProviderConfigs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListIdentityProviderConfigsRequestT = Model::ListIdentityProviderConfigsRequest>
  Model::ListIdentityProviderConfigsOutcomeCallable ListIdentityProviderConfigsCallable(
      const ListIdentityProviderConfigsRequestT& request) const {
    return SubmitCallable(&EKSClient::ListIdentityProviderConfigs, request);
  }

  /**
   * An Async wrapper for ListIdentityProviderConfigs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIdentityProviderConfigsRequestT = Model::ListIdentityProviderConfigsRequest>
  void ListIdentityProviderConfigsAsync(const ListIdentityProviderConfigsRequestT& request,
                                        const ListIdentityProviderConfigsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListNodegroups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListNodegroupsRequestT = Model::ListNodegroupsRequest>
  void ListNodegroupsAsync(const ListNodegroupsRequestT& request, const ListNodegroupsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPodIdentityAssociationsOutcome ListPodIdentityAssociations(
      const Model::ListPodIdentityAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListPodIdentityAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPodIdentityAssociationsRequestT = Model::ListPodIdentityAssociationsRequest>
  Model::ListPodIdentityAssociationsOutcomeCallable ListPodIdentityAssociationsCallable(
      const ListPodIdentityAssociationsRequestT& request) const {
    return SubmitCallable(&EKSClient::ListPodIdentityAssociations, request);
  }

  /**
   * An Async wrapper for ListPodIdentityAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPodIdentityAssociationsRequestT = Model::ListPodIdentityAssociationsRequest>
  void ListPodIdentityAssociationsAsync(const ListPodIdentityAssociationsRequestT& request,
                                        const ListPodIdentityAssociationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListUpdates that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListUpdatesRequestT = Model::ListUpdatesRequest>
  void ListUpdatesAsync(const ListUpdatesRequestT& request, const ListUpdatesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RegisterCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RegisterClusterRequestT = Model::RegisterClusterRequest>
  void RegisterClusterAsync(const RegisterClusterRequestT& request, const RegisterClusterResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartInsightsRefresh that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartInsightsRefresh that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartInsightsRefreshRequestT = Model::StartInsightsRefreshRequest>
  void StartInsightsRefreshAsync(const StartInsightsRefreshRequestT& request, const StartInsightsRefreshResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAccessEntry that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAccessEntry that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAccessEntryRequestT = Model::UpdateAccessEntryRequest>
  void UpdateAccessEntryAsync(const UpdateAccessEntryRequestT& request, const UpdateAccessEntryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateAddon that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAddonRequestT = Model::UpdateAddonRequest>
   ...
   * <code>DescribeUpdate</code>.</p> <p>You can use this operation to do the
   * following actions:</p> <ul> <li> <p>You can use this API operation to enable or
   * disable exporting the Kubernetes control plane logs for your cluster to
   * CloudWatch Logs. By default, cluster control plane logs aren't exported to
   * CloudWatch Logs. For more information, see <a
   * href="https://docs.aws.amazon.com/eks/latest/userguide/control-plane-logs.html">Amazon
   ...
   * scanning rates apply to exported control plane logs. For more information, see
   * <a href="http://aws.amazon.com/cloudwatch/pricing/">CloudWatch Pricing</a>.</p>
   *  </li> <li> <p>You can also use this API operation to enable or disable
   ...
   * subnets are from, the subnets must be in the same VPC as the subnets that the
   * cluster was created with. For more information about the VPC requirements, see
   * <a
   ...
   * in the <i> <i>Amazon EKS User Guide</i> </i>.</p> </li> <li> <p>You can also use
   * this API operation to enable or disable ARC zonal shift. If zonal shift is
   * enabled, Amazon Web Services configures zonal autoshift for the cluster.</p>
   * </li> <li> <p>You can also use this API operation to add, change, or remove the
   ...
   * <code>"remoteNetworkConfig": { "remoteNodeNetworks": [], "remotePodNetworks": []
   * }</code>.</p> </li> </ul> <p>Cluster updates are asynchronous, and they should
  ...
  /**
   * A Callable wrapper for UpdateClusterConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateClusterConfig that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateClusterConfigRequestT = Model::UpdateClusterConfigRequest>
  void UpdateClusterConfigAsync(const UpdateClusterConfigRequestT& request, const UpdateClusterConfigResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateClusterVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateClusterVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateClusterVersionRequestT = Model::UpdateClusterVersionRequest>
  void UpdateClusterVersionAsync(const UpdateClusterVersionRequestT& request, const UpdateClusterVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEksAnywhereSubscriptionOutcome UpdateEksAnywhereSubscription(
      const Model::UpdateEksAnywhereSubscriptionRequest& request) const;

  /**
   * A Callable wrapper for UpdateEksAnywhereSubscription that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateEksAnywhereSubscriptionRequestT = Model::UpdateEksAnywhereSubscriptionRequest>
  Model::UpdateEksAnywhereSubscriptionOutcomeCallable UpdateEksAnywhereSubscriptionCallable(
      const UpdateEksAnywhereSubscriptionRequestT& request) const {
    return SubmitCallable(&EKSClient::UpdateEksAnywhereSubscription, request);
  }

  /**
   * An Async wrapper for UpdateEksAnywhereSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEksAnywhereSubscriptionRequestT = Model::UpdateEksAnywhereSubscriptionRequest>
  void UpdateEksAnywhereSubscriptionAsync(const UpdateEksAnywhereSubscriptionRequestT& request,
                                          const UpdateEksAnywhereSubscriptionResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateNodegroupConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateNodegroupConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateNodegroupConfigRequestT = Model::UpdateNodegroupConfigRequest>
  void UpdateNodegroupConfigAsync(const UpdateNodegroupConfigRequestT& request, const UpdateNodegroupConfigResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * node group was originally deployed with a launch template. Additionally, the
   * launch template ID or name must match what was used when the node group was
   * created. You can update the launch template version with necessary changes.</p>
   * <p>If you need to update a custom AMI in a node group that was deployed with a
   ...
   * version of the launch template.</p> <p>If you update without a launch template,
   * then you can update to the latest available AMI version of a node group's
   ...
   * request. For information about Linux versions, see <a
  ...
  /**
   * A Callable wrapper for UpdateNodegroupVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateNodegroupVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateNodegroupVersionRequestT = Model::UpdateNodegroupVersionRequest>
  void UpdateNodegroupVersionAsync(const UpdateNodegroupVersionRequestT& request,
  ...
  virtual Model::UpdatePodIdentityAssociationOutcome UpdatePodIdentityAssociation(
      const Model::UpdatePodIdentityAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdatePodIdentityAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdatePodIdentityAssociationRequestT = Model::UpdatePodIdentityAssociationRequest>
  Model::UpdatePodIdentityAssociationOutcomeCallable UpdatePodIdentityAssociationCallable(
      const UpdatePodIdentityAssociationRequestT& request) const {
    return SubmitCallable(&EKSClient::UpdatePodIdentityAssociation, request);
  }

  /**
   * An Async wrapper for UpdatePodIdentityAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePodIdentityAssociationRequestT = Model::UpdatePodIdentityAssociationRequest>
  void UpdatePodIdentityAssociationAsync(const UpdatePodIdentityAssociationRequestT& request,
                                         const UpdatePodIdentityAssociationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
