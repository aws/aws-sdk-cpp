...
class CreateAddonRequest : public EKSRequest {
 public:
  ...
  void SetAddonVersion(AddonVersionT&& value) {
    ...
    m_addonVersion = std::forward<AddonVersionT>(value);
  }
  template <typename AddonVersionT = Aws::String>
  CreateAddonRequest& WithAddonVersion(AddonVersionT&& value) {
    SetAddonVersion(std::forward<AddonVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceAccountRoleArn(ServiceAccountRoleArnT&& value) {
    ...
    m_serviceAccountRoleArn = std::forward<ServiceAccountRoleArnT>(value);
  }
  template <typename ServiceAccountRoleArnT = Aws::String>
  CreateAddonRequest& WithServiceAccountRoleArn(ServiceAccountRoleArnT&& value) {
    SetServiceAccountRoleArn(std::forward<ServiceAccountRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetResolveConflicts(ResolveConflicts value) {
    m_resolveConflictsHasBeenSet = true;
    m_resolveConflicts = value;
  }
  inline CreateAddonRequest& WithResolveConflicts(ResolveConflicts value) {
    SetResolveConflicts(value);
    return *this;
  }
  ///@}
  ...
  void SetConfigurationValues(ConfigurationValuesT&& value) {
    ...
    m_configurationValues = std::forward<ConfigurationValuesT>(value);
  }
  template <typename ConfigurationValuesT = Aws::String>
  CreateAddonRequest& WithConfigurationValues(ConfigurationValuesT&& value) {
    SetConfigurationValues(std::forward<ConfigurationValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPodIdentityAssociations(PodIdentityAssociationsT&& value) {
    ...
    m_podIdentityAssociations = std::forward<PodIdentityAssociationsT>(value);
  }
  template <typename PodIdentityAssociationsT = Aws::Vector<AddonPodIdentityAssociations>>
  CreateAddonRequest& WithPodIdentityAssociations(PodIdentityAssociationsT&& value) {
    SetPodIdentityAssociations(std::forward<PodIdentityAssociationsT>(value));
    return *this;
  }
  ...
  CreateAddonRequest& AddPodIdentityAssociations(PodIdentityAssociationsT&& value) {
    m_podIdentityAssociationsHasBeenSet = true;
    m_podIdentityAssociations.emplace_back(std::forward<PodIdentityAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNamespaceConfig(NamespaceConfigT&& value) {
    ...
    m_namespaceConfig = std::forward<NamespaceConfigT>(value);
  }
  template <typename NamespaceConfigT = AddonNamespaceConfigRequest>
  CreateAddonRequest& WithNamespaceConfig(NamespaceConfigT&& value) {
    SetNamespaceConfig(std::forward<NamespaceConfigT>(value));
    return *this;
  }
  ///@}
 private:
