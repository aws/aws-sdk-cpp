...
class KubernetesNetworkConfigResponse {
 public:
  ...
  void SetServiceIpv4Cidr(ServiceIpv4CidrT&& value) {
    ...
    m_serviceIpv4Cidr = std::forward<ServiceIpv4CidrT>(value);
  }
  template <typename ServiceIpv4CidrT = Aws::String>
  KubernetesNetworkConfigResponse& WithServiceIpv4Cidr(ServiceIpv4CidrT&& value) {
    SetServiceIpv4Cidr(std::forward<ServiceIpv4CidrT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceIpv6Cidr(ServiceIpv6CidrT&& value) {
    ...
    m_serviceIpv6Cidr = std::forward<ServiceIpv6CidrT>(value);
  }
  template <typename ServiceIpv6CidrT = Aws::String>
  KubernetesNetworkConfigResponse& WithServiceIpv6Cidr(ServiceIpv6CidrT&& value) {
    SetServiceIpv6Cidr(std::forward<ServiceIpv6CidrT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIpFamily(IpFamily value) {
    m_ipFamilyHasBeenSet = true;
    m_ipFamily = value;
  }
  inline KubernetesNetworkConfigResponse& WithIpFamily(IpFamily value) {
    SetIpFamily(value);
    return *this;
  }
  ///@}
  ...
  void SetElasticLoadBalancing(ElasticLoadBalancingT&& value) {
    ...
    m_elasticLoadBalancing = std::forward<ElasticLoadBalancingT>(value);
  }
  template <typename ElasticLoadBalancingT = ElasticLoadBalancing>
  KubernetesNetworkConfigResponse& WithElasticLoadBalancing(ElasticLoadBalancingT&& value) {
    SetElasticLoadBalancing(std::forward<ElasticLoadBalancingT>(value));
    return *this;
  }
  ///@}
 private:
