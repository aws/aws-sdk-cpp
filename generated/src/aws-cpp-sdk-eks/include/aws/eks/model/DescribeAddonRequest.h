...
namespace Model
{
  ...
  public:
    ...
    template<typename ClusterNameT = Aws::String>
    DescribeAddonRequest& WithClusterName(ClusterNameT&& value) { SetClusterName(std::forward<ClusterNameT>(value)); return *this;}
    ///@}
    ...
    template<typename AddonNameT = Aws::String>
    DescribeAddonRequest& WithAddonName(AddonNameT&& value) { SetAddonName(std::forward<AddonNameT>(value)); return *this;}
    ///@}
  private:
