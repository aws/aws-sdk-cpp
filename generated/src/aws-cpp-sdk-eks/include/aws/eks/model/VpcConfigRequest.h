...
class VpcConfigRequest {
 public:
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  VpcConfigRequest& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  VpcConfigRequest& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  VpcConfigRequest& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  VpcConfigRequest& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  inline VpcConfigRequest& WithEndpointPublicAccess(bool value) {
  ...
  inline VpcConfigRequest& WithEndpointPrivateAccess(bool value) {
  ...
  template <typename PublicAccessCidrsT = Aws::Vector<Aws::String>>
  VpcConfigRequest& WithPublicAccessCidrs(PublicAccessCidrsT&& value) {
    SetPublicAccessCidrs(std::forward<PublicAccessCidrsT>(value));
    return *this;
  }
  template <typename PublicAccessCidrsT = Aws::String>
  VpcConfigRequest& AddPublicAccessCidrs(PublicAccessCidrsT&& value) {
    m_publicAccessCidrsHasBeenSet = true;
