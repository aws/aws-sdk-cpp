...
class ListEksAnywhereSubscriptionsRequest : public EKSRequest {
 public:
  ...
  inline ListEksAnywhereSubscriptionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEksAnywhereSubscriptionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetIncludeStatus(IncludeStatusT&& value) {
    m_includeStatusHasBeenSet = true;
    m_includeStatus = std::forward<IncludeStatusT>(value);
  }
  template <typename IncludeStatusT = Aws::Vector<EksAnywhereSubscriptionStatus>>
  ListEksAnywhereSubscriptionsRequest& WithIncludeStatus(IncludeStatusT&& value) {
    SetIncludeStatus(std::forward<IncludeStatusT>(value));
    return *this;
  }
  inline ListEksAnywhereSubscriptionsRequest& AddIncludeStatus(EksAnywhereSubscriptionStatus value) {
    m_includeStatusHasBeenSet = true;
    m_includeStatus.push_back(value);
    return *this;
  }
  ///@}
 private:
