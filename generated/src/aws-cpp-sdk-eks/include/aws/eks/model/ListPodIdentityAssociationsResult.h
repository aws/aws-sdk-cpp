...
class ListPodIdentityAssociationsResult {
 public:
  ...
  template <typename AssociationsT = Aws::Vector<PodIdentityAssociationSummary>>
  ListPodIdentityAssociationsResult& WithAssociations(AssociationsT&& value) {
    SetAssociations(std::forward<AssociationsT>(value));
    return *this;
  }
  template <typename AssociationsT = PodIdentityAssociationSummary>
  ListPodIdentityAssociationsResult& AddAssociations(AssociationsT&& value) {
    m_associationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPodIdentityAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPodIdentityAssociationsResult& WithRequestId(RequestIdT&& value) {
