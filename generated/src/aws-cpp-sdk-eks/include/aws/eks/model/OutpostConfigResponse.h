...
class OutpostConfigResponse {
 public:
  ...
  template <typename OutpostArnsT = Aws::Vector<Aws::String>>
  OutpostConfigResponse& WithOutpostArns(OutpostArnsT&& value) {
    SetOutpostArns(std::forward<OutpostArnsT>(value));
    return *this;
  }
  template <typename OutpostArnsT = Aws::String>
  OutpostConfigResponse& AddOutpostArns(OutpostArnsT&& value) {
    m_outpostArnsHasBeenSet = true;
  ...
  template <typename ControlPlaneInstanceTypeT = Aws::String>
  OutpostConfigResponse& WithControlPlaneInstanceType(ControlPlaneInstanceTypeT&& value) {
  ...
  template <typename ControlPlanePlacementT = ControlPlanePlacementResponse>
  OutpostConfigResponse& WithControlPlanePlacement(ControlPlanePlacementT&& value) {
