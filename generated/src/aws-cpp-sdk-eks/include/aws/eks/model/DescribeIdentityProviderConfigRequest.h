...
class DescribeIdentityProviderConfigRequest : public EKSRequest {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  DescribeIdentityProviderConfigRequest& WithClusterName(ClusterNameT&& value) {
  ...
  template <typename IdentityProviderConfigT = IdentityProviderConfig>
  DescribeIdentityProviderConfigRequest& WithIdentityProviderConfig(IdentityProviderConfigT&& value) {
