...
namespace Model
{
  ...
  {
  public:
    AWS_EKS_API UpdateEksAnywhereSubscriptionResult() = default;
    ...
    template<typename SubscriptionT = EksAnywhereSubscription>
    UpdateEksAnywhereSubscriptionResult& WithSubscription(SubscriptionT&& value) { SetSubscription(std::forward<SubscriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateEksAnywhereSubscriptionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
