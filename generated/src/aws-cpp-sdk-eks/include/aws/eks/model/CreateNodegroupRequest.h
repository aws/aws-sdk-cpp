...
class CreateNodegroupRequest : public EKSRequest {
 public:
  ...
  inline void SetDiskSize(int value) {
    m_diskSizeHasBeenSet = true;
    m_diskSize = value;
  }
  inline CreateNodegroupRequest& WithDiskSize(int value) {
    SetDiskSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAmiType(AMITypes value) {
    m_amiTypeHasBeenSet = true;
    m_amiType = value;
  }
  inline CreateNodegroupRequest& WithAmiType(AMITypes value) {
    SetAmiType(value);
    return *this;
  }
  ///@}
  ...
  void SetRemoteAccess(RemoteAccessT&& value) {
    ...
    m_remoteAccess = std::forward<RemoteAccessT>(value);
  }
  template <typename RemoteAccessT = RemoteAccessConfig>
  CreateNodegroupRequest& WithRemoteAccess(RemoteAccessT&& value) {
    SetRemoteAccess(std::forward<RemoteAccessT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeRole(NodeRoleT&& value) {
    ...
    m_nodeRole = std::forward<NodeRoleT>(value);
  }
  template <typename NodeRoleT = Aws::String>
  CreateNodegroupRequest& WithNodeRole(NodeRoleT&& value) {
    SetNodeRole(std::forward<NodeRoleT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCapacityType(CapacityTypes value) {
    m_capacityTypeHasBeenSet = true;
    m_capacityType = value;
  }
  inline CreateNodegroupRequest& WithCapacityType(CapacityTypes value) {
