...
class UpdateTaintsPayload {
 public:
  ...
  void SetAddOrUpdateTaints(AddOrUpdateTaintsT&& value) {
    ...
    m_addOrUpdateTaints = std::forward<AddOrUpdateTaintsT>(value);
  }
  template <typename AddOrUpdateTaintsT = Aws::Vector<Taint>>
  UpdateTaintsPayload& WithAddOrUpdateTaints(AddOrUpdateTaintsT&& value) {
    SetAddOrUpdateTaints(std::forward<AddOrUpdateTaintsT>(value));
    return *this;
  }
  template <typename AddOrUpdateTaintsT = Taint>
  UpdateTaintsPayload& AddAddOrUpdateTaints(AddOrUpdateTaintsT&& value) {
    m_addOrUpdateTaintsHasBeenSet = true;
    m_addOrUpdateTaints.emplace_back(std::forward<AddOrUpdateTaintsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoveTaints(RemoveTaintsT&& value) {
    ...
    m_removeTaints = std::forward<RemoveTaintsT>(value);
  }
  template <typename RemoveTaintsT = Aws::Vector<Taint>>
  UpdateTaintsPayload& WithRemoveTaints(RemoveTaintsT&& value) {
    SetRemoveTaints(std::forward<RemoveTaintsT>(value));
    return *this;
  }
  template <typename RemoveTaintsT = Taint>
  UpdateTaintsPayload& AddRemoveTaints(RemoveTaintsT&& value) {
    m_removeTaintsHasBeenSet = true;
    m_removeTaints.emplace_back(std::forward<RemoveTaintsT>(value));
    return *this;
  }
  ///@}
 private:
