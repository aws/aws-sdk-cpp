...
class UpdateLabelsPayload {
 public:
  ...
  void SetAddOrUpdateLabels(AddOrUpdateLabelsT&& value) {
    m_addOrUpdateLabelsHasBeenSet = true;
    m_addOrUpdateLabels = std::forward<AddOrUpdateLabelsT>(value);
  }
  template <typename AddOrUpdateLabelsT = Aws::Map<Aws::String, Aws::String>>
  UpdateLabelsPayload& WithAddOrUpdateLabels(AddOrUpdateLabelsT&& value) {
    SetAddOrUpdateLabels(std::forward<AddOrUpdateLabelsT>(value));
    return *this;
  }
  ...
  UpdateLabelsPayload& AddAddOrUpdateLabels(AddOrUpdateLabelsKeyT&& key, AddOrUpdateLabelsValueT&& value) {
    m_addOrUpdateLabelsHasBeenSet = true;
    m_addOrUpdateLabels.emplace(std::forward<AddOrUpdateLabelsKeyT>(key), std::forward<AddOrUpdateLabelsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoveLabels(RemoveLabelsT&& value) {
    m_removeLabelsHasBeenSet = true;
    m_removeLabels = std::forward<RemoveLabelsT>(value);
  }
  template <typename RemoveLabelsT = Aws::Vector<Aws::String>>
  UpdateLabelsPayload& WithRemoveLabels(RemoveLabelsT&& value) {
    SetRemoveLabels(std::forward<RemoveLabelsT>(value));
    return *this;
  }
  template <typename RemoveLabelsT = Aws::String>
  UpdateLabelsPayload& AddRemoveLabels(RemoveLabelsT&& value) {
    m_removeLabelsHasBeenSet = true;
    m_removeLabels.emplace_back(std::forward<RemoveLabelsT>(value));
    return *this;
  }
  ///@}
 private:
