...
class ListUpdatesResult {
 public:
  ...
  void SetUpdateIds(UpdateIdsT&& value) {
    m_updateIdsHasBeenSet = true;
    m_updateIds = std::forward<UpdateIdsT>(value);
  }
  template <typename UpdateIdsT = Aws::Vector<Aws::String>>
  ListUpdatesResult& WithUpdateIds(UpdateIdsT&& value) {
    SetUpdateIds(std::forward<UpdateIdsT>(value));
    return *this;
  }
  template <typename UpdateIdsT = Aws::String>
  ListUpdatesResult& AddUpdateIds(UpdateIdsT&& value) {
    m_updateIdsHasBeenSet = true;
    m_updateIds.emplace_back(std::forward<UpdateIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUpdatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListUpdatesResult& WithRequestId(RequestIdT&& value) {
