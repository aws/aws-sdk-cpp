...
class ListAccessPoliciesResult {
 public:
  ...
  template <typename AccessPoliciesT = Aws::Vector<AccessPolicy>>
  ListAccessPoliciesResult& WithAccessPolicies(AccessPoliciesT&& value) {
    SetAccessPolicies(std::forward<AccessPoliciesT>(value));
    return *this;
  }
  template <typename AccessPoliciesT = AccessPolicy>
  ListAccessPoliciesResult& AddAccessPolicies(AccessPoliciesT&& value) {
    m_accessPoliciesHasBeenSet = true;
    m_accessPolicies.emplace_back(std::forward<AccessPoliciesT>(value));
    return *this;
  }
  ///@}
