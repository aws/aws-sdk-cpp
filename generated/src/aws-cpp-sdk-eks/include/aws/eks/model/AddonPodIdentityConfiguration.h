...
class AddonPodIdentityConfiguration {
 public:
  ...
  template <typename ServiceAccountT = Aws::String>
  AddonPodIdentityConfiguration& WithServiceAccount(ServiceAccountT&& value) {
  ...
  void SetRecommendedManagedPolicies(RecommendedManagedPoliciesT&& value) {
    m_recommendedManagedPoliciesHasBeenSet = true;
    m_recommendedManagedPolicies = std::forward<RecommendedManagedPoliciesT>(value);
  }
  template <typename RecommendedManagedPoliciesT = Aws::Vector<Aws::String>>
  AddonPodIdentityConfiguration& WithRecommendedManagedPolicies(RecommendedManagedPoliciesT&& value) {
    SetRecommendedManagedPolicies(std::forward<RecommendedManagedPoliciesT>(value));
    return *this;
  }
  template <typename RecommendedManagedPoliciesT = Aws::String>
  AddonPodIdentityConfiguration& AddRecommendedManagedPolicies(RecommendedManagedPoliciesT&& value) {
    m_recommendedManagedPoliciesHasBeenSet = true;
    m_recommendedManagedPolicies.emplace_back(std::forward<RecommendedManagedPoliciesT>(value));
    return *this;
  }
  ///@}
 private:
