...
class ListPodIdentityAssociationsRequest : public EKSRequest {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  ListPodIdentityAssociationsRequest& WithClusterName(ClusterNameT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  ListPodIdentityAssociationsRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename ServiceAccountT = Aws::String>
  ListPodIdentityAssociationsRequest& WithServiceAccount(ServiceAccountT&& value) {
  ...
  inline ListPodIdentityAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPodIdentityAssociationsRequest& WithNextToken(NextTokenT&& value) {
