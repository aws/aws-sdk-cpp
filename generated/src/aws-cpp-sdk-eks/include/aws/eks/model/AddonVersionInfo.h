...
class AddonVersionInfo {
 public:
  ...
  AddonVersionInfo& AddArchitecture(ArchitectureT&& value) {
    m_architectureHasBeenSet = true;
    m_architecture.emplace_back(std::forward<ArchitectureT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComputeTypes(ComputeTypesT&& value) {
    ...
    m_computeTypes = std::forward<ComputeTypesT>(value);
  }
  template <typename ComputeTypesT = Aws::Vector<Aws::String>>
  AddonVersionInfo& WithComputeTypes(ComputeTypesT&& value) {
    SetComputeTypes(std::forward<ComputeTypesT>(value));
    return *this;
  }
  template <typename ComputeTypesT = Aws::String>
  AddonVersionInfo& AddComputeTypes(ComputeTypesT&& value) {
    m_computeTypesHasBeenSet = true;
    m_computeTypes.emplace_back(std::forward<ComputeTypesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCompatibilities(CompatibilitiesT&& value) {
    ...
    m_compatibilities = std::forward<CompatibilitiesT>(value);
  }
  template <typename CompatibilitiesT = Aws::Vector<Compatibility>>
  AddonVersionInfo& WithCompatibilities(CompatibilitiesT&& value) {
    SetCompatibilities(std::forward<CompatibilitiesT>(value));
    return *this;
  }
  template <typename CompatibilitiesT = Compatibility>
  AddonVersionInfo& AddCompatibilities(CompatibilitiesT&& value) {
    m_compatibilitiesHasBeenSet = true;
    m_compatibilities.emplace_back(std::forward<CompatibilitiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRequiresConfiguration(bool value) {
    m_requiresConfigurationHasBeenSet = true;
    m_requiresConfiguration = value;
  }
  inline AddonVersionInfo& WithRequiresConfiguration(bool value) {
    SetRequiresConfiguration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequiresIamPermissions(bool value) {
    m_requiresIamPermissionsHasBeenSet = true;
    m_requiresIamPermissions = value;
  }
  inline AddonVersionInfo& WithRequiresIamPermissions(bool value) {
    SetRequiresIamPermissions(value);
    return *this;
  }
  ///@}
 private:
