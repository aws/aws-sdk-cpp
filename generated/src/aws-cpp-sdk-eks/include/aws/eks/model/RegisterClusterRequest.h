...
class RegisterClusterRequest : public EKSRequest {
 public:
  ...
  template <typename ConnectorConfigT = ConnectorConfigRequest>
  void SetConnectorConfig(ConnectorConfigT&& value) {
    m_connectorConfigHasBeenSet = true;
    m_connectorConfig = std::forward<ConnectorConfigT>(value);
  }
  template <typename ConnectorConfigT = ConnectorConfigRequest>
  RegisterClusterRequest& WithConnectorConfig(ConnectorConfigT&& value) {
    SetConnectorConfig(std::forward<ConnectorConfigT>(value));
    return *this;
  }
  ///@}
