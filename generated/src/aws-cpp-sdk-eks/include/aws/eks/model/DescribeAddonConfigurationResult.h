...
class DescribeAddonConfigurationResult {
 public:
  ...
  void SetPodIdentityConfiguration(PodIdentityConfigurationT&& value) {
    ...
    m_podIdentityConfiguration = std::forward<PodIdentityConfigurationT>(value);
  }
  template <typename PodIdentityConfigurationT = Aws::Vector<AddonPodIdentityConfiguration>>
  DescribeAddonConfigurationResult& WithPodIdentityConfiguration(PodIdentityConfigurationT&& value) {
    SetPodIdentityConfiguration(std::forward<PodIdentityConfigurationT>(value));
    return *this;
  }
  ...
  DescribeAddonConfigurationResult& AddPodIdentityConfiguration(PodIdentityConfigurationT&& value) {
    m_podIdentityConfigurationHasBeenSet = true;
    m_podIdentityConfiguration.emplace_back(std::forward<PodIdentityConfigurationT>(value));
    return *this;
  }
  ///@}
