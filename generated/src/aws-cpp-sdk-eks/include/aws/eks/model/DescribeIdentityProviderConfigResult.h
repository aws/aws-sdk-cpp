...
class DescribeIdentityProviderConfigResult {
 public:
  ...
  template <typename IdentityProviderConfigT = IdentityProviderConfigResponse>
  DescribeIdentityProviderConfigResult& WithIdentityProviderConfig(IdentityProviderConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeIdentityProviderConfigResult& WithRequestId(RequestIdT&& value) {
