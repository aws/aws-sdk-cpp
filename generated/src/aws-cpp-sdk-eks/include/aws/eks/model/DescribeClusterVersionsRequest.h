...
class DescribeClusterVersionsRequest : public EKSRequest {
 public:
  ...
  inline DescribeClusterVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeClusterVersionsRequest& WithDefaultOnly(bool value) {
  ...
  inline DescribeClusterVersionsRequest& WithIncludeAll(bool value) {
    SetIncludeAll(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeClusterVersionsRequest& WithVersionStatus(VersionStatus value) {
