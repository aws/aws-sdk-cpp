...
class Nodegroup {
 public:
  ...
  void SetNodegroupArn(NodegroupArnT&& value) {
    ...
    m_nodegroupArn = std::forward<NodegroupArnT>(value);
  }
  template <typename NodegroupArnT = Aws::String>
  Nodegroup& WithNodegroupArn(NodegroupArnT&& value) {
    SetNodegroupArn(std::forward<NodegroupArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(NodegroupStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Nodegroup& WithStatus(NodegroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline Nodegroup& WithCapacityType(CapacityTypes value) {
  ...
  inline Nodegroup& WithAmiType(AMITypes value) {
    SetAmiType(value);
    return *this;
  }
  ///@}
  ...
  inline Nodegroup& WithDiskSize(int value) {
    SetDiskSize(value);
    return *this;
  }
  ///@}
