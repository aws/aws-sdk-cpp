...
class ListAssociatedAccessPoliciesResult {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  ListAssociatedAccessPoliciesResult& WithClusterName(ClusterNameT&& value) {
  ...
  template <typename PrincipalArnT = Aws::String>
  ListAssociatedAccessPoliciesResult& WithPrincipalArn(PrincipalArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociatedAccessPoliciesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetAssociatedAccessPolicies(AssociatedAccessPoliciesT&& value) {
    m_associatedAccessPoliciesHasBeenSet = true;
    m_associatedAccessPolicies = std::forward<AssociatedAccessPoliciesT>(value);
  }
  template <typename AssociatedAccessPoliciesT = Aws::Vector<AssociatedAccessPolicy>>
  ListAssociatedAccessPoliciesResult& WithAssociatedAccessPolicies(AssociatedAccessPoliciesT&& value) {
    SetAssociatedAccessPolicies(std::forward<AssociatedAccessPoliciesT>(value));
    return *this;
  }
  template <typename AssociatedAccessPoliciesT = AssociatedAccessPolicy>
  ListAssociatedAccessPoliciesResult& AddAssociatedAccessPolicies(AssociatedAccessPoliciesT&& value) {
    m_associatedAccessPoliciesHasBeenSet = true;
    m_associatedAccessPolicies.emplace_back(std::forward<AssociatedAccessPoliciesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAssociatedAccessPoliciesResult& WithRequestId(RequestIdT&& value) {
