 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/PodGcControllerConfigRequest">AWS
 * API Reference</a></p>
 */
class PodGcControllerConfigRequest {
 public:
  AWS_EKS_API PodGcControllerConfigRequest() = default;
  AWS_EKS_API PodGcControllerConfigRequest(Aws::Utils::Json::JsonView jsonValue);
  AWS_EKS_API PodGcControllerConfigRequest& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline PodGcControllerConfigRequest& WithTerminatedPodGcThreshold(int value) {
