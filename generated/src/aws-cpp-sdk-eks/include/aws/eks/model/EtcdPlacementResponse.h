 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/EtcdPlacementResponse">AWS
 * API Reference</a></p>
 */
class EtcdPlacementResponse {
 public:
  AWS_EKS_API EtcdPlacementResponse() = default;
  AWS_EKS_API EtcdPlacementResponse(Aws::Utils::Json::JsonView jsonValue);
  AWS_EKS_API EtcdPlacementResponse& operator=(Aws::Utils::Json::JsonView jsonValue);
  AWS_EKS_API Aws::Utils::Json::JsonValue Jsonize() const;

  ///@{
  /**
   * <p>The spread level used with the placement group for etcd instances on your
   * local Amazon EKS cluster on Amazon Web Services Outposts.</p>
   */
  ...
  inline EtcdPlacementResponse& WithSpreadLevel(SpreadLevel value) {
