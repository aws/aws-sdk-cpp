...
class AddonIssue {
 public:
  ...
  inline void SetCode(AddonIssueCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline AddonIssue& WithCode(AddonIssueCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  AddonIssue& WithMessage(MessageT&& value) {
  ...
  template <typename ResourceIdsT = Aws::Vector<Aws::String>>
  AddonIssue& WithResourceIds(ResourceIdsT&& value) {
    SetResourceIds(std::forward<ResourceIdsT>(value));
    return *this;
  }
  template <typename ResourceIdsT = Aws::String>
  AddonIssue& AddResourceIds(ResourceIdsT&& value) {
    m_resourceIdsHasBeenSet = true;
