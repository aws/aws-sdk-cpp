...
class RemoteNetworkConfigResponse {
 public:
  ...
  void SetRemoteNodeNetworks(RemoteNodeNetworksT&& value) {
    m_remoteNodeNetworksHasBeenSet = true;
    m_remoteNodeNetworks = std::forward<RemoteNodeNetworksT>(value);
  }
  template <typename RemoteNodeNetworksT = Aws::Vector<RemoteNodeNetwork>>
  RemoteNetworkConfigResponse& WithRemoteNodeNetworks(RemoteNodeNetworksT&& value) {
    SetRemoteNodeNetworks(std::forward<RemoteNodeNetworksT>(value));
    return *this;
  }
  template <typename RemoteNodeNetworksT = RemoteNodeNetwork>
  RemoteNetworkConfigResponse& AddRemoteNodeNetworks(RemoteNodeNetworksT&& value) {
    m_remoteNodeNetworksHasBeenSet = true;
    m_remoteNodeNetworks.emplace_back(std::forward<RemoteNodeNetworksT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemotePodNetworks(RemotePodNetworksT&& value) {
    m_remotePodNetworksHasBeenSet = true;
    m_remotePodNetworks = std::forward<RemotePodNetworksT>(value);
  }
  template <typename RemotePodNetworksT = Aws::Vector<RemotePodNetwork>>
  RemoteNetworkConfigResponse& WithRemotePodNetworks(RemotePodNetworksT&& value) {
    SetRemotePodNetworks(std::forward<RemotePodNetworksT>(value));
    return *this;
  }
  template <typename RemotePodNetworksT = RemotePodNetwork>
  RemoteNetworkConfigResponse& AddRemotePodNetworks(RemotePodNetworksT&& value) {
    m_remotePodNetworksHasBeenSet = true;
    m_remotePodNetworks.emplace_back(std::forward<RemotePodNetworksT>(value));
    return *this;
  }
  ///@}
 private:
