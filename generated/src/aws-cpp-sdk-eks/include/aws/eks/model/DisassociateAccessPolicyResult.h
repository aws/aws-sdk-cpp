...
namespace Model
{
  ...
  {
  public:
    AWS_EKS_API DisassociateAccessPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateAccessPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
