...
class CreateClusterRequest : public EKSRequest {
 public:
  ...
  void SetOutpostConfig(OutpostConfigT&& value) {
    ...
    m_outpostConfig = std::forward<OutpostConfigT>(value);
  }
  template <typename OutpostConfigT = OutpostConfigRequest>
  CreateClusterRequest& WithOutpostConfig(OutpostConfigT&& value) {
    SetOutpostConfig(std::forward<OutpostConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBootstrapSelfManagedAddons(bool value) {
    m_bootstrapSelfManagedAddonsHasBeenSet = true;
    m_bootstrapSelfManagedAddons = value;
  }
  inline CreateClusterRequest& WithBootstrapSelfManagedAddons(bool value) {
    SetBootstrapSelfManagedAddons(value);
    return *this;
  }
  ///@}
  ...
  inline CreateClusterRequest& WithDeletionProtection(bool value) {
