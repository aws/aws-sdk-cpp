...
class EksAnywhereSubscriptionTerm {
 public:
  ...
  inline EksAnywhereSubscriptionTerm& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnit(EksAnywhereSubscriptionTermUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline EksAnywhereSubscriptionTerm& WithUnit(EksAnywhereSubscriptionTermUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
