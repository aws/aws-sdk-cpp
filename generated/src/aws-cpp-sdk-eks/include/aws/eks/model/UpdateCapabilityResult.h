...
class UpdateCapabilityResult {
 public:
  AWS_EKS_API UpdateCapabilityResult() = default;
  AWS_EKS_API UpdateCapabilityResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_EKS_API UpdateCapabilityResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename UpdateT = Update>
  UpdateCapabilityResult& WithUpdate(UpdateT&& value) {
