...
class ListEksAnywhereSubscriptionsResult {
 public:
  ...
  template <typename SubscriptionsT = Aws::Vector<EksAnywhereSubscription>>
  ListEksAnywhereSubscriptionsResult& WithSubscriptions(SubscriptionsT&& value) {
    SetSubscriptions(std::forward<SubscriptionsT>(value));
    return *this;
  }
  template <typename SubscriptionsT = EksAnywhereSubscription>
  ListEksAnywhereSubscriptionsResult& AddSubscriptions(SubscriptionsT&& value) {
    m_subscriptionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEksAnywhereSubscriptionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEksAnywhereSubscriptionsResult& WithRequestId(RequestIdT&& value) {
