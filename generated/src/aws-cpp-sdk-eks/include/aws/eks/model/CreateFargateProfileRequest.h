...
class CreateFargateProfileRequest : public EKSRequest {
 public:
  ...
  void SetFargateProfileName(FargateProfileNameT&& value) {
    ...
    m_fargateProfileName = std::forward<FargateProfileNameT>(value);
  }
  template <typename FargateProfileNameT = Aws::String>
  CreateFargateProfileRequest& WithFargateProfileName(FargateProfileNameT&& value) {
    SetFargateProfileName(std::forward<FargateProfileNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPodExecutionRoleArn(PodExecutionRoleArnT&& value) {
    ...
    m_podExecutionRoleArn = std::forward<PodExecutionRoleArnT>(value);
  }
  template <typename PodExecutionRoleArnT = Aws::String>
  CreateFargateProfileRequest& WithPodExecutionRoleArn(PodExecutionRoleArnT&& value) {
    SetPodExecutionRoleArn(std::forward<PodExecutionRoleArnT>(value));
    return *this;
  }
  ///@}
