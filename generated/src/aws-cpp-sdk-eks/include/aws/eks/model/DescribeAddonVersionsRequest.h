...
class DescribeAddonVersionsRequest : public EKSRequest {
 public:
  ...
  template <typename KubernetesVersionT = Aws::String>
  DescribeAddonVersionsRequest& WithKubernetesVersion(KubernetesVersionT&& value) {
  ...
  inline DescribeAddonVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAddonVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename AddonNameT = Aws::String>
  DescribeAddonVersionsRequest& WithAddonName(AddonNameT&& value) {
  ...
  template <typename TypesT = Aws::Vector<Aws::String>>
  DescribeAddonVersionsRequest& WithTypes(TypesT&& value) {
    SetTypes(std::forward<TypesT>(value));
    return *this;
  }
  template <typename TypesT = Aws::String>
  DescribeAddonVersionsRequest& AddTypes(TypesT&& value) {
    m_typesHasBeenSet = true;
  ...
  void SetPublishers(PublishersT&& value) {
    m_publishersHasBeenSet = true;
    m_publishers = std::forward<PublishersT>(value);
  }
  template <typename PublishersT = Aws::Vector<Aws::String>>
  DescribeAddonVersionsRequest& WithPublishers(PublishersT&& value) {
    SetPublishers(std::forward<PublishersT>(value));
    return *this;
  }
  template <typename PublishersT = Aws::String>
  DescribeAddonVersionsRequest& AddPublishers(PublishersT&& value) {
    m_publishersHasBeenSet = true;
    m_publishers.emplace_back(std::forward<PublishersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OwnersT = Aws::Vector<Aws::String>>
  DescribeAddonVersionsRequest& WithOwners(OwnersT&& value) {
    SetOwners(std::forward<OwnersT>(value));
    return *this;
  }
  template <typename OwnersT = Aws::String>
  DescribeAddonVersionsRequest& AddOwners(OwnersT&& value) {
    m_ownersHasBeenSet = true;
