...
class ComputeConfigRequest {
 public:
  ...
  inline ComputeConfigRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetNodeRoleArn(NodeRoleArnT&& value) {
    ...
    m_nodeRoleArn = std::forward<NodeRoleArnT>(value);
  }
  template <typename NodeRoleArnT = Aws::String>
  ComputeConfigRequest& WithNodeRoleArn(NodeRoleArnT&& value) {
    SetNodeRoleArn(std::forward<NodeRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
