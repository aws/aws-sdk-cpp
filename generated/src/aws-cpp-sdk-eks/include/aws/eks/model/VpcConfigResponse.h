...
class VpcConfigResponse {
 public:
  ...
  void SetClusterSecurityGroupId(ClusterSecurityGroupIdT&& value) {
    ...
    m_clusterSecurityGroupId = std::forward<ClusterSecurityGroupIdT>(value);
  }
  template <typename ClusterSecurityGroupIdT = Aws::String>
  VpcConfigResponse& WithClusterSecurityGroupId(ClusterSecurityGroupIdT&& value) {
    SetClusterSecurityGroupId(std::forward<ClusterSecurityGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEndpointPublicAccess(bool value) {
    m_endpointPublicAccessHasBeenSet = true;
    m_endpointPublicAccess = value;
  }
  inline VpcConfigResponse& WithEndpointPublicAccess(bool value) {
    SetEndpointPublicAccess(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEndpointPrivateAccess(bool value) {
    m_endpointPrivateAccessHasBeenSet = true;
    m_endpointPrivateAccess = value;
  }
  inline VpcConfigResponse& WithEndpointPrivateAccess(bool value) {
    SetEndpointPrivateAccess(value);
    return *this;
  }
  ///@}
  ...
  void SetPublicAccessCidrs(PublicAccessCidrsT&& value) {
    ...
    m_publicAccessCidrs = std::forward<PublicAccessCidrsT>(value);
  }
  template <typename PublicAccessCidrsT = Aws::Vector<Aws::String>>
  VpcConfigResponse& WithPublicAccessCidrs(PublicAccessCidrsT&& value) {
    SetPublicAccessCidrs(std::forward<PublicAccessCidrsT>(value));
    return *this;
  }
  template <typename PublicAccessCidrsT = Aws::String>
  VpcConfigResponse& AddPublicAccessCidrs(PublicAccessCidrsT&& value) {
    m_publicAccessCidrsHasBeenSet = true;
    m_publicAccessCidrs.emplace_back(std::forward<PublicAccessCidrsT>(value));
    return *this;
  }
  ///@}
 private:
