...
namespace Model
{
  ...
  {
  public:
    AWS_EKS_API DeleteAccessEntryResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAccessEntryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
