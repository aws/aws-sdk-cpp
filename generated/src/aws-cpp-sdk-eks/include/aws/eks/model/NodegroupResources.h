...
class NodegroupResources {
 public:
  ...
  template <typename AutoScalingGroupsT = Aws::Vector<AutoScalingGroup>>
  NodegroupResources& WithAutoScalingGroups(AutoScalingGroupsT&& value) {
    SetAutoScalingGroups(std::forward<AutoScalingGroupsT>(value));
    return *this;
  }
  template <typename AutoScalingGroupsT = AutoScalingGroup>
  NodegroupResources& AddAutoScalingGroups(AutoScalingGroupsT&& value) {
    m_autoScalingGroupsHasBeenSet = true;
  ...
  void SetRemoteAccessSecurityGroup(RemoteAccessSecurityGroupT&& value) {
    m_remoteAccessSecurityGroupHasBeenSet = true;
    m_remoteAccessSecurityGroup = std::forward<RemoteAccessSecurityGroupT>(value);
  }
  template <typename RemoteAccessSecurityGroupT = Aws::String>
  NodegroupResources& WithRemoteAccessSecurityGroup(RemoteAccessSecurityGroupT&& value) {
    SetRemoteAccessSecurityGroup(std::forward<RemoteAccessSecurityGroupT>(value));
    return *this;
  }
  ///@}
 private:
