...
class DisassociateIdentityProviderConfigRequest : public EKSRequest {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  DisassociateIdentityProviderConfigRequest& WithClusterName(ClusterNameT&& value) {
  ...
  void SetIdentityProviderConfig(IdentityProviderConfigT&& value) {
    m_identityProviderConfigHasBeenSet = true;
    m_identityProviderConfig = std::forward<IdentityProviderConfigT>(value);
  }
  template <typename IdentityProviderConfigT = IdentityProviderConfig>
  DisassociateIdentityProviderConfigRequest& WithIdentityProviderConfig(IdentityProviderConfigT&& value) {
    SetIdentityProviderConfig(std::forward<IdentityProviderConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientRequestTokenT = Aws::String>
  DisassociateIdentityProviderConfigRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
