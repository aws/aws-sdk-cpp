...
namespace Model
{
  ...
  /**
   * <p>These errors are usually caused by a server-side issue.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
    ...
    template<typename ClusterNameT = Aws::String>
    ServerException& WithClusterName(ClusterNameT&& value) { SetClusterName(std::forward<ClusterNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NodegroupNameT = Aws::String>
    ServerException& WithNodegroupName(NodegroupNameT&& value) { SetNodegroupName(std::forward<NodegroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename AddonNameT = Aws::String>
    ServerException& WithAddonName(AddonNameT&& value) { SetAddonName(std::forward<AddonNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SubscriptionIdT = Aws::String>
    ServerException& WithSubscriptionId(SubscriptionIdT&& value) { SetSubscriptionId(std::forward<SubscriptionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    ServerException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
