...
class DeprecationDetail {
 public:
  ...
  void SetReplacedWith(ReplacedWithT&& value) {
    ...
    m_replacedWith = std::forward<ReplacedWithT>(value);
  }
  template <typename ReplacedWithT = Aws::String>
  DeprecationDetail& WithReplacedWith(ReplacedWithT&& value) {
    SetReplacedWith(std::forward<ReplacedWithT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStopServingVersion(StopServingVersionT&& value) {
    ...
    m_stopServingVersion = std::forward<StopServingVersionT>(value);
  }
  template <typename StopServingVersionT = Aws::String>
  DeprecationDetail& WithStopServingVersion(StopServingVersionT&& value) {
    SetStopServingVersion(std::forward<StopServingVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartServingReplacementVersion(StartServingReplacementVersionT&& value) {
    ...
    m_startServingReplacementVersion = std::forward<StartServingReplacementVersionT>(value);
  }
  template <typename StartServingReplacementVersionT = Aws::String>
  DeprecationDetail& WithStartServingReplacementVersion(StartServingReplacementVersionT&& value) {
    SetStartServingReplacementVersion(std::forward<StartServingReplacementVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClientStats(ClientStatsT&& value) {
    ...
    m_clientStats = std::forward<ClientStatsT>(value);
  }
  template <typename ClientStatsT = Aws::Vector<ClientStat>>
  DeprecationDetail& WithClientStats(ClientStatsT&& value) {
    SetClientStats(std::forward<ClientStatsT>(value));
    return *this;
  }
  template <typename ClientStatsT = ClientStat>
  DeprecationDetail& AddClientStats(ClientStatsT&& value) {
    m_clientStatsHasBeenSet = true;
    m_clientStats.emplace_back(std::forward<ClientStatsT>(value));
    return *this;
  }
  ///@}
 private:
