...
class CreateAccessConfigRequest {
 public:
  ...
  inline void SetBootstrapClusterCreatorAdminPermissions(bool value) {
    m_bootstrapClusterCreatorAdminPermissionsHasBeenSet = true;
    m_bootstrapClusterCreatorAdminPermissions = value;
  }
  inline CreateAccessConfigRequest& WithBootstrapClusterCreatorAdminPermissions(bool value) {
    SetBootstrapClusterCreatorAdminPermissions(value);
    return *this;
  }
  ///@}
  ...
  inline CreateAccessConfigRequest& WithAuthenticationMode(AuthenticationMode value) {
