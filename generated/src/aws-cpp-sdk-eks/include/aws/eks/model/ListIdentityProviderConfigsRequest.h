...
class ListIdentityProviderConfigsRequest : public EKSRequest {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  ListIdentityProviderConfigsRequest& WithClusterName(ClusterNameT&& value) {
  ...
  inline ListIdentityProviderConfigsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIdentityProviderConfigsRequest& WithNextToken(NextTokenT&& value) {
