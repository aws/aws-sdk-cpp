...
namespace Model
{
  ...
  {
  public:
    AWS_EKS_API ListIdentityProviderConfigsRequest() = default;
    ...
    template<typename ClusterNameT = Aws::String>
    ListIdentityProviderConfigsRequest& WithClusterName(ClusterNameT&& value) { SetClusterName(std::forward<ClusterNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListIdentityProviderConfigsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
