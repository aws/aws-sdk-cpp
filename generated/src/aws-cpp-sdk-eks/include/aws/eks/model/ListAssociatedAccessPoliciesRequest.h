...
class ListAssociatedAccessPoliciesRequest : public EKSRequest {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  ListAssociatedAccessPoliciesRequest& WithClusterName(ClusterNameT&& value) {
  ...
  template <typename PrincipalArnT = Aws::String>
  ListAssociatedAccessPoliciesRequest& WithPrincipalArn(PrincipalArnT&& value) {
  ...
  inline ListAssociatedAccessPoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociatedAccessPoliciesRequest& WithNextToken(NextTokenT&& value) {
