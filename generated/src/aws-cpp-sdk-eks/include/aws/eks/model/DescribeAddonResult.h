...
namespace Model
{
  ...
  {
  public:
    AWS_EKS_API DescribeAddonResult() = default;
    ...
    template<typename AddonT = Addon>
    DescribeAddonResult& WithAddon(AddonT&& value) { SetAddon(std::forward<AddonT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeAddonResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
