...
class CreateNodegroupResult {
 public:
  ...
  void SetNodegroup(NodegroupT&& value) {
    m_nodegroupHasBeenSet = true;
    m_nodegroup = std::forward<NodegroupT>(value);
  }
  template <typename NodegroupT = Nodegroup>
  CreateNodegroupResult& WithNodegroup(NodegroupT&& value) {
    SetNodegroup(std::forward<NodegroupT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateNodegroupResult& WithRequestId(RequestIdT&& value) {
