...
namespace Model
{
  ...
  {
  public:
    AWS_EKS_API RegisterClusterResult() = default;
    ...
    template<typename ClusterT = Cluster>
    RegisterClusterResult& WithCluster(ClusterT&& value) { SetCluster(std::forward<ClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    RegisterClusterResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
