...
class AddonCompatibilityDetail {
 public:
  ...
  template <typename NameT = Aws::String>
  AddonCompatibilityDetail& WithName(NameT&& value) {
  ...
  void SetCompatibleVersions(CompatibleVersionsT&& value) {
    m_compatibleVersionsHasBeenSet = true;
    m_compatibleVersions = std::forward<CompatibleVersionsT>(value);
  }
  template <typename CompatibleVersionsT = Aws::Vector<Aws::String>>
  AddonCompatibilityDetail& WithCompatibleVersions(CompatibleVersionsT&& value) {
    SetCompatibleVersions(std::forward<CompatibleVersionsT>(value));
    return *this;
  }
  template <typename CompatibleVersionsT = Aws::String>
  AddonCompatibilityDetail& AddCompatibleVersions(CompatibleVersionsT&& value) {
    m_compatibleVersionsHasBeenSet = true;
    m_compatibleVersions.emplace_back(std::forward<CompatibleVersionsT>(value));
    return *this;
  }
  ///@}
 private:
