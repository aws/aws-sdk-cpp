...
/**
 * <p>An object representing the scaling configuration details for the Amazon EC2
 ...
 * group, you can specify any or none of the properties.</p><p><h3>See Also:</h3>
 * <a
...
class NodegroupScalingConfig {
 public:
  ...
  inline NodegroupScalingConfig& WithMinSize(int value) {
    SetMinSize(value);
    return *this;
  }
  ///@}
  ...
  inline NodegroupScalingConfig& WithMaxSize(int value) {
    SetMaxSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDesiredSize(int value) {
    m_desiredSizeHasBeenSet = true;
    m_desiredSize = value;
  }
  inline NodegroupScalingConfig& WithDesiredSize(int value) {
