...
namespace Model
{
  ...
  {
  public:
    AWS_EKS_API UpdateNodegroupVersionResult() = default;
    ...
    template<typename UpdateT = Update>
    UpdateNodegroupVersionResult& WithUpdate(UpdateT&& value) { SetUpdate(std::forward<UpdateT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateNodegroupVersionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
