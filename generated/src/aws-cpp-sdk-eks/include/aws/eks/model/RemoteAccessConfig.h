...
class RemoteAccessConfig {
 public:
  ...
  void SetEc2SshKey(Ec2SshKeyT&& value) {
    ...
    m_ec2SshKey = std::forward<Ec2SshKeyT>(value);
  }
  template <typename Ec2SshKeyT = Aws::String>
  RemoteAccessConfig& WithEc2SshKey(Ec2SshKeyT&& value) {
    SetEc2SshKey(std::forward<Ec2SshKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceSecurityGroups(SourceSecurityGroupsT&& value) {
    ...
    m_sourceSecurityGroups = std::forward<SourceSecurityGroupsT>(value);
  }
  template <typename SourceSecurityGroupsT = Aws::Vector<Aws::String>>
  RemoteAccessConfig& WithSourceSecurityGroups(SourceSecurityGroupsT&& value) {
    SetSourceSecurityGroups(std::forward<SourceSecurityGroupsT>(value));
    return *this;
  }
  template <typename SourceSecurityGroupsT = Aws::String>
  RemoteAccessConfig& AddSourceSecurityGroups(SourceSecurityGroupsT&& value) {
    m_sourceSecurityGroupsHasBeenSet = true;
    m_sourceSecurityGroups.emplace_back(std::forward<SourceSecurityGroupsT>(value));
    return *this;
  }
  ///@}
 private:
