...
/**
 */
class DeleteCertificateAuthorityRequest : public EKSRequest {
 public:
  AWS_EKS_API DeleteCertificateAuthorityRequest() = default;
  ...
  ///@{
  /**
   * <p>The ID of the certificate authority to delete. You can't delete the
   * certificate authority that's currently signing certificates for the cluster.</p>
   */
