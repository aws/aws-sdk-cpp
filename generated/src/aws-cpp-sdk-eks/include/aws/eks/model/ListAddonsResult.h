...
class ListAddonsResult {
 public:
  ...
  template <typename AddonsT = Aws::Vector<Aws::String>>
  ListAddonsResult& WithAddons(AddonsT&& value) {
    SetAddons(std::forward<AddonsT>(value));
    return *this;
  }
  template <typename AddonsT = Aws::String>
  ListAddonsResult& AddAddons(AddonsT&& value) {
    m_addonsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAddonsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAddonsResult& WithRequestId(RequestIdT&& value) {
