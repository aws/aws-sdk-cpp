...
class ListAccessEntriesResult {
 public:
  ...
  void SetAccessEntries(AccessEntriesT&& value) {
    m_accessEntriesHasBeenSet = true;
    m_accessEntries = std::forward<AccessEntriesT>(value);
  }
  template <typename AccessEntriesT = Aws::Vector<Aws::String>>
  ListAccessEntriesResult& WithAccessEntries(AccessEntriesT&& value) {
    SetAccessEntries(std::forward<AccessEntriesT>(value));
    return *this;
  }
  template <typename AccessEntriesT = Aws::String>
  ListAccessEntriesResult& AddAccessEntries(AccessEntriesT&& value) {
    m_accessEntriesHasBeenSet = true;
    m_accessEntries.emplace_back(std::forward<AccessEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessEntriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessEntriesResult& WithRequestId(RequestIdT&& value) {
