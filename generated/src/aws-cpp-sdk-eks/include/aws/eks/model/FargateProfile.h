...
class FargateProfile {
 public:
  ...
  void SetFargateProfileArn(FargateProfileArnT&& value) {
    ...
    m_fargateProfileArn = std::forward<FargateProfileArnT>(value);
  }
  template <typename FargateProfileArnT = Aws::String>
  FargateProfile& WithFargateProfileArn(FargateProfileArnT&& value) {
    SetFargateProfileArn(std::forward<FargateProfileArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(FargateProfileStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline FargateProfile& WithStatus(FargateProfileStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
