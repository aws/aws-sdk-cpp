...
class Compatibility {
 public:
  ...
  void SetPlatformVersions(PlatformVersionsT&& value) {
    ...
    m_platformVersions = std::forward<PlatformVersionsT>(value);
  }
  template <typename PlatformVersionsT = Aws::Vector<Aws::String>>
  Compatibility& WithPlatformVersions(PlatformVersionsT&& value) {
    SetPlatformVersions(std::forward<PlatformVersionsT>(value));
    return *this;
  }
  template <typename PlatformVersionsT = Aws::String>
  Compatibility& AddPlatformVersions(PlatformVersionsT&& value) {
    m_platformVersionsHasBeenSet = true;
    m_platformVersions.emplace_back(std::forward<PlatformVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Compatibility& WithDefaultVersion(bool value) {
