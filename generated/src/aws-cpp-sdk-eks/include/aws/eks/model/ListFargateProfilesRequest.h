...
class ListFargateProfilesRequest : public EKSRequest {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  ListFargateProfilesRequest& WithClusterName(ClusterNameT&& value) {
  ...
  inline ListFargateProfilesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFargateProfilesRequest& WithNextToken(NextTokenT&& value) {
