 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/HorizontalPodAutoscalerControllerConfigResponse">AWS
 * API Reference</a></p>
 */
class HorizontalPodAutoscalerControllerConfigResponse {
 public:
  AWS_EKS_API HorizontalPodAutoscalerControllerConfigResponse() = default;
  AWS_EKS_API HorizontalPodAutoscalerControllerConfigResponse(Aws::Utils::Json::JsonView jsonValue);
  AWS_EKS_API HorizontalPodAutoscalerControllerConfigResponse& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename HorizontalPodAutoscalerSyncPeriodT = Aws::String>
  HorizontalPodAutoscalerControllerConfigResponse& WithHorizontalPodAutoscalerSyncPeriod(HorizontalPodAutoscalerSyncPeriodT&& value) {
