...
class NodeRepairConfig {
 public:
  ...
  inline NodeRepairConfig& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxUnhealthyNodeThresholdCount(int value) {
    m_maxUnhealthyNodeThresholdCountHasBeenSet = true;
    m_maxUnhealthyNodeThresholdCount = value;
  }
  inline NodeRepairConfig& WithMaxUnhealthyNodeThresholdCount(int value) {
    SetMaxUnhealthyNodeThresholdCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxUnhealthyNodeThresholdPercentage(int value) {
    m_maxUnhealthyNodeThresholdPercentageHasBeenSet = true;
    m_maxUnhealthyNodeThresholdPercentage = value;
  }
  inline NodeRepairConfig& WithMaxUnhealthyNodeThresholdPercentage(int value) {
    SetMaxUnhealthyNodeThresholdPercentage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxParallelNodesRepairedCount(int value) {
    m_maxParallelNodesRepairedCountHasBeenSet = true;
    m_maxParallelNodesRepairedCount = value;
  }
  inline NodeRepairConfig& WithMaxParallelNodesRepairedCount(int value) {
    SetMaxParallelNodesRepairedCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxParallelNodesRepairedPercentage(int value) {
    m_maxParallelNodesRepairedPercentageHasBeenSet = true;
    m_maxParallelNodesRepairedPercentage = value;
  }
  inline NodeRepairConfig& WithMaxParallelNodesRepairedPercentage(int value) {
    SetMaxParallelNodesRepairedPercentage(value);
    return *this;
  }
  ///@}
  ...
  void SetNodeRepairConfigOverrides(NodeRepairConfigOverridesT&& value) {
    ...
    m_nodeRepairConfigOverrides = std::forward<NodeRepairConfigOverridesT>(value);
  }
  template <typename NodeRepairConfigOverridesT = Aws::Vector<NodeRepairConfigOverrides>>
  NodeRepairConfig& WithNodeRepairConfigOverrides(NodeRepairConfigOverridesT&& value) {
    SetNodeRepairConfigOverrides(std::forward<NodeRepairConfigOverridesT>(value));
    return *this;
  }
  ...
  NodeRepairConfig& AddNodeRepairConfigOverrides(NodeRepairConfigOverridesT&& value) {
    m_nodeRepairConfigOverridesHasBeenSet = true;
    m_nodeRepairConfigOverrides.emplace_back(std::forward<NodeRepairConfigOverridesT>(value));
    return *this;
  }
  ///@}
 private:
