...
class NodegroupUpdateConfig {
 public:
  ...
  inline void SetMaxUnavailable(int value) {
    m_maxUnavailableHasBeenSet = true;
    m_maxUnavailable = value;
  }
  inline NodegroupUpdateConfig& WithMaxUnavailable(int value) {
  ...
  inline void SetMaxUnavailablePercentage(int value) {
    m_maxUnavailablePercentageHasBeenSet = true;
    m_maxUnavailablePercentage = value;
  }
  inline NodegroupUpdateConfig& WithMaxUnavailablePercentage(int value) {
    SetMaxUnavailablePercentage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUpdateStrategy(NodegroupUpdateStrategies value) {
    m_updateStrategyHasBeenSet = true;
    m_updateStrategy = value;
  }
  inline NodegroupUpdateConfig& WithUpdateStrategy(NodegroupUpdateStrategies value) {
