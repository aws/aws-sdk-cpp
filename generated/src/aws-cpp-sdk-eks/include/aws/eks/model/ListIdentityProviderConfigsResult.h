...
class ListIdentityProviderConfigsResult {
 public:
  ...
  void SetIdentityProviderConfigs(IdentityProviderConfigsT&& value) {
    m_identityProviderConfigsHasBeenSet = true;
    m_identityProviderConfigs = std::forward<IdentityProviderConfigsT>(value);
  }
  template <typename IdentityProviderConfigsT = Aws::Vector<IdentityProviderConfig>>
  ListIdentityProviderConfigsResult& WithIdentityProviderConfigs(IdentityProviderConfigsT&& value) {
    SetIdentityProviderConfigs(std::forward<IdentityProviderConfigsT>(value));
    return *this;
  }
  template <typename IdentityProviderConfigsT = IdentityProviderConfig>
  ListIdentityProviderConfigsResult& AddIdentityProviderConfigs(IdentityProviderConfigsT&& value) {
    m_identityProviderConfigsHasBeenSet = true;
    m_identityProviderConfigs.emplace_back(std::forward<IdentityProviderConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIdentityProviderConfigsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIdentityProviderConfigsResult& WithRequestId(RequestIdT&& value) {
