...
namespace Model
{
  ...
  {
  public:
    AWS_EKS_API DescribeEksAnywhereSubscriptionRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DescribeEksAnywhereSubscriptionRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
