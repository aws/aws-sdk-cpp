...
namespace Model
{
  ...
  public:
    ...
    inline UpdateNodegroupConfigResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateNodegroupConfigResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateNodegroupConfigResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
