...
namespace Model
{
  ...
  {
  public:
    AWS_EKS_API UpdateNodegroupConfigResult() = default;
    ...
    template<typename UpdateT = Update>
    UpdateNodegroupConfigResult& WithUpdate(UpdateT&& value) { SetUpdate(std::forward<UpdateT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateNodegroupConfigResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
