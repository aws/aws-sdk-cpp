...
class ClientStat {
 public:
  ...
  inline void SetNumberOfRequestsLast30Days(int value) {
    m_numberOfRequestsLast30DaysHasBeenSet = true;
    m_numberOfRequestsLast30Days = value;
  }
  inline ClientStat& WithNumberOfRequestsLast30Days(int value) {
    SetNumberOfRequestsLast30Days(value);
    return *this;
  }
  ///@}
  ...
  void SetLastRequestTime(LastRequestTimeT&& value) {
    ...
    m_lastRequestTime = std::forward<LastRequestTimeT>(value);
  }
  template <typename LastRequestTimeT = Aws::Utils::DateTime>
  ClientStat& WithLastRequestTime(LastRequestTimeT&& value) {
    SetLastRequestTime(std::forward<LastRequestTimeT>(value));
    return *this;
  }
  ///@}
 private:
