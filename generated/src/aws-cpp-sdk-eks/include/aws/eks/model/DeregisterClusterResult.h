...
namespace Model
{
  ...
  public:
    ...
    template<typename ClusterT = Cluster>
    DeregisterClusterResult& WithCluster(ClusterT&& value) { SetCluster(std::forward<ClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeregisterClusterResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
