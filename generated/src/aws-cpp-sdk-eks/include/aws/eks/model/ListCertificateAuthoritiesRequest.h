...
/**
 */
class ListCertificateAuthoritiesRequest : public EKSRequest {
 public:
  AWS_EKS_API ListCertificateAuthoritiesRequest() = default;
  ...
  template <typename ClusterNameT = Aws::String>
  ListCertificateAuthoritiesRequest& WithClusterName(ClusterNameT&& value) {
