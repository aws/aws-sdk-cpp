...
class Issue {
 public:
  ...
  inline void SetCode(NodegroupIssueCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline Issue& WithCode(NodegroupIssueCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  Issue& WithMessage(MessageT&& value) {
