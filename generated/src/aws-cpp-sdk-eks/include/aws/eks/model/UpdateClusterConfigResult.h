...
namespace Model
{
  ...
  public:
    ...
    inline UpdateClusterConfigResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateClusterConfigResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateClusterConfigResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
