...
namespace Model
{
  ...
  {
  public:
    AWS_EKS_API UpdateClusterConfigResult() = default;
    ...
    template<typename UpdateT = Update>
    UpdateClusterConfigResult& WithUpdate(UpdateT&& value) { SetUpdate(std::forward<UpdateT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateClusterConfigResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
