...
class UpdateClusterConfigRequest : public EKSRequest {
 public:
  ...
  void SetResourcesVpcConfig(ResourcesVpcConfigT&& value) {
    ...
    m_resourcesVpcConfig = std::forward<ResourcesVpcConfigT>(value);
  }
  template <typename ResourcesVpcConfigT = VpcConfigRequest>
  UpdateClusterConfigRequest& WithResourcesVpcConfig(ResourcesVpcConfigT&& value) {
    SetResourcesVpcConfig(std::forward<ResourcesVpcConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccessConfig(AccessConfigT&& value) {
    ...
    m_accessConfig = std::forward<AccessConfigT>(value);
  }
  template <typename AccessConfigT = UpdateAccessConfigRequest>
  UpdateClusterConfigRequest& WithAccessConfig(AccessConfigT&& value) {
    SetAccessConfig(std::forward<AccessConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUpgradePolicy(UpgradePolicyT&& value) {
    ...
    m_upgradePolicy = std::forward<UpgradePolicyT>(value);
  }
  template <typename UpgradePolicyT = UpgradePolicyRequest>
  UpdateClusterConfigRequest& WithUpgradePolicy(UpgradePolicyT&& value) {
    SetUpgradePolicy(std::forward<UpgradePolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetZonalShiftConfig(ZonalShiftConfigT&& value) {
    ...
    m_zonalShiftConfig = std::forward<ZonalShiftConfigT>(value);
  }
  template <typename ZonalShiftConfigT = ZonalShiftConfigRequest>
  UpdateClusterConfigRequest& WithZonalShiftConfig(ZonalShiftConfigT&& value) {
    SetZonalShiftConfig(std::forward<ZonalShiftConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComputeConfig(ComputeConfigT&& value) {
    ...
    m_computeConfig = std::forward<ComputeConfigT>(value);
  }
  template <typename ComputeConfigT = ComputeConfigRequest>
  UpdateClusterConfigRequest& WithComputeConfig(ComputeConfigT&& value) {
    SetComputeConfig(std::forward<ComputeConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKubernetesNetworkConfig(KubernetesNetworkConfigT&& value) {
    ...
    m_kubernetesNetworkConfig = std::forward<KubernetesNetworkConfigT>(value);
  }
  template <typename KubernetesNetworkConfigT = KubernetesNetworkConfigRequest>
  UpdateClusterConfigRequest& WithKubernetesNetworkConfig(KubernetesNetworkConfigT&& value) {
    SetKubernetesNetworkConfig(std::forward<KubernetesNetworkConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteNetworkConfig(RemoteNetworkConfigT&& value) {
    ...
    m_remoteNetworkConfig = std::forward<RemoteNetworkConfigT>(value);
  }
  template <typename RemoteNetworkConfigT = RemoteNetworkConfigRequest>
  UpdateClusterConfigRequest& WithRemoteNetworkConfig(RemoteNetworkConfigT&& value) {
    SetRemoteNetworkConfig(std::forward<RemoteNetworkConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateClusterConfigRequest& WithDeletionProtection(bool value) {
