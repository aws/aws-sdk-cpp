...
class Addon {
 public:
  ...
  inline void SetStatus(AddonStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Addon& WithStatus(AddonStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAddonArn(AddonArnT&& value) {
    ...
    m_addonArn = std::forward<AddonArnT>(value);
  }
  template <typename AddonArnT = Aws::String>
  Addon& WithAddonArn(AddonArnT&& value) {
    SetAddonArn(std::forward<AddonArnT>(value));
    return *this;
  }
  ///@}
