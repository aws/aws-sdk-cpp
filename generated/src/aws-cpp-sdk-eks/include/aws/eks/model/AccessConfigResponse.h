...
class AccessConfigResponse {
 public:
  ...
  inline AccessConfigResponse& WithBootstrapClusterCreatorAdminPermissions(bool value) {
  ...
  inline AccessConfigResponse& WithAuthenticationMode(AuthenticationMode value) {
