...
class AWS_SSM_API SSMClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SSMClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SSMEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateOpsItemRelatedItemOutcome AssociateOpsItemRelatedItem(
      const Model::AssociateOpsItemRelatedItemRequest& request) const;

  /**
   * A Callable wrapper for AssociateOpsItemRelatedItem that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateOpsItemRelatedItemRequestT = Model::AssociateOpsItemRelatedItemRequest>
  Model::AssociateOpsItemRelatedItemOutcomeCallable AssociateOpsItemRelatedItemCallable(
      const AssociateOpsItemRelatedItemRequestT& request) const {
    return SubmitCallable(&SSMClient::AssociateOpsItemRelatedItem, request);
  }

  /**
   * An Async wrapper for AssociateOpsItemRelatedItem that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateOpsItemRelatedItemRequestT = Model::AssociateOpsItemRelatedItemRequest>
  void AssociateOpsItemRelatedItemAsync(const AssociateOpsItemRelatedItemRequestT& request,
                                        const AssociateOpsItemRelatedItemResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CancelCommand that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelCommandRequestT = Model::CancelCommandRequest>
  void CancelCommandAsync(const CancelCommandRequestT& request, const CancelCommandResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CancelMaintenanceWindowExecutionOutcome CancelMaintenanceWindowExecution(
      const Model::CancelMaintenanceWindowExecutionRequest& request) const;

  /**
   * A Callable wrapper for CancelMaintenanceWindowExecution that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CancelMaintenanceWindowExecutionRequestT = Model::CancelMaintenanceWindowExecutionRequest>
  Model::CancelMaintenanceWindowExecutionOutcomeCallable CancelMaintenanceWindowExecutionCallable(
      const CancelMaintenanceWindowExecutionRequestT& request) const {
    return SubmitCallable(&SSMClient::CancelMaintenanceWindowExecution, request);
  }

  /**
   * An Async wrapper for CancelMaintenanceWindowExecution that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CancelMaintenanceWindowExecutionRequestT = Model::CancelMaintenanceWindowExecutionRequest>
  void CancelMaintenanceWindowExecutionAsync(const CancelMaintenanceWindowExecutionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateActivation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateActivation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateActivationRequestT = Model::CreateActivationRequest>
  void CreateActivationAsync(const CreateActivationRequestT& request, const CreateActivationResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAssociation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAssociationRequestT = Model::CreateAssociationRequest>
  void CreateAssociationAsync(const CreateAssociationRequestT& request, const CreateAssociationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAssociationBatch that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAssociationBatch that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAssociationBatchRequestT = Model::CreateAssociationBatchRequest>
  void CreateAssociationBatchAsync(const CreateAssociationBatchRequestT& request,
  ...
  /**
   * An Async wrapper for CreateDocument that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateDocumentRequestT = Model::CreateDocumentRequest>
  void CreateDocumentAsync(const CreateDocumentRequestT& request, const CreateDocumentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMaintenanceWindow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMaintenanceWindow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMaintenanceWindowRequestT = Model::CreateMaintenanceWindowRequest>
  void CreateMaintenanceWindowAsync(const CreateMaintenanceWindowRequestT& request,
  ...
  /**
   * An Async wrapper for CreateOpsItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateOpsItemRequestT = Model::CreateOpsItemRequest>
  void CreateOpsItemAsync(const CreateOpsItemRequestT& request, const CreateOpsItemResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateOpsMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateOpsMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateOpsMetadataRequestT = Model::CreateOpsMetadataRequest>
  void CreateOpsMetadataAsync(const CreateOpsMetadataRequestT& request, const CreateOpsMetadataResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePatchBaseline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePatchBaseline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePatchBaselineRequestT = Model::CreatePatchBaselineRequest>
  void CreatePatchBaselineAsync(const CreatePatchBaselineRequestT& request, const CreatePatchBaselineResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateResourceDataSync that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateResourceDataSync that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResourceDataSyncRequestT = Model::CreateResourceDataSyncRequest>
  void CreateResourceDataSyncAsync(const CreateResourceDataSyncRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteActivation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteActivation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteActivationRequestT = Model::DeleteActivationRequest>
  void DeleteActivationAsync(const DeleteActivationRequestT& request, const DeleteActivationResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename DeleteAssociationRequestT = Model::DeleteAssociationRequest>
  void DeleteAssociationAsync(const DeleteAssociationResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for DeleteInventory that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteInventoryRequestT = Model::DeleteInventoryRequest>
  void DeleteInventoryAsync(const DeleteInventoryRequestT& request, const DeleteInventoryResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMaintenanceWindow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMaintenanceWindow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMaintenanceWindowRequestT = Model::DeleteMaintenanceWindowRequest>
  void DeleteMaintenanceWindowAsync(const DeleteMaintenanceWindowRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteOpsItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteOpsItemRequestT = Model::DeleteOpsItemRequest>
  void DeleteOpsItemAsync(const DeleteOpsItemRequestT& request, const DeleteOpsItemResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteOpsMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteOpsMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteOpsMetadataRequestT = Model::DeleteOpsMetadataRequest>
  void DeleteOpsMetadataAsync(const DeleteOpsMetadataRequestT& request, const DeleteOpsMetadataResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteParameter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteParameterRequestT = Model::DeleteParameterRequest>
  void DeleteParameterAsync(const DeleteParameterRequestT& request, const DeleteParameterResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteParameters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteParameters that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteParametersRequestT = Model::DeleteParametersRequest>
  void DeleteParametersAsync(const DeleteParametersRequestT& request, const DeleteParametersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePatchBaseline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePatchBaseline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeletePatchBaselineRequestT = Model::DeletePatchBaselineRequest>
  void DeletePatchBaselineAsync(const DeletePatchBaselineRequestT& request, const DeletePatchBaselineResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteResourceDataSync that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteResourceDataSync that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResourceDataSyncRequestT = Model::DeleteResourceDataSyncRequest>
  void DeleteResourceDataSyncAsync(const DeleteResourceDataSyncRequestT& request,
  ...
  /**
   * A Callable wrapper for DeregisterManagedInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeregisterManagedInstanceRequestT = Model::DeregisterManagedInstanceRequest>
  Model::DeregisterManagedInstanceOutcomeCallable DeregisterManagedInstanceCallable(
      const DeregisterManagedInstanceRequestT& request) const {
    return SubmitCallable(&SSMClient::DeregisterManagedInstance, request);
  }

  /**
   * An Async wrapper for DeregisterManagedInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterManagedInstanceRequestT = Model::DeregisterManagedInstanceRequest>
  void DeregisterManagedInstanceAsync(const DeregisterManagedInstanceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterPatchBaselineForPatchGroupOutcome DeregisterPatchBaselineForPatchGroup(
      const Model::DeregisterPatchBaselineForPatchGroupRequest& request) const;

  /**
   * A Callable wrapper for DeregisterPatchBaselineForPatchGroup that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeregisterPatchBaselineForPatchGroupRequestT = Model::DeregisterPatchBaselineForPatchGroupRequest>
  Model::DeregisterPatchBaselineForPatchGroupOutcomeCallable DeregisterPatchBaselineForPatchGroupCallable(
      const DeregisterPatchBaselineForPatchGroupRequestT& request) const {
    return SubmitCallable(&SSMClient::DeregisterPatchBaselineForPatchGroup, request);
  }

  /**
   * An Async wrapper for DeregisterPatchBaselineForPatchGroup that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeregisterPatchBaselineForPatchGroupRequestT = Model::DeregisterPatchBaselineForPatchGroupRequest>
  void DeregisterPatchBaselineForPatchGroupAsync(const DeregisterPatchBaselineForPatchGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterTargetFromMaintenanceWindowOutcome DeregisterTargetFromMaintenanceWindow(
      const Model::DeregisterTargetFromMaintenanceWindowRequest& request) const;

  /**
   * A Callable wrapper for DeregisterTargetFromMaintenanceWindow that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeregisterTargetFromMaintenanceWindowRequestT = Model::DeregisterTargetFromMaintenanceWindowRequest>
  Model::DeregisterTargetFromMaintenanceWindowOutcomeCallable DeregisterTargetFromMaintenanceWindowCallable(
      const DeregisterTargetFromMaintenanceWindowRequestT& request) const {
    return SubmitCallable(&SSMClient::DeregisterTargetFromMaintenanceWindow, request);
  }

  /**
   * An Async wrapper for DeregisterTargetFromMaintenanceWindow that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeregisterTargetFromMaintenanceWindowRequestT = Model::DeregisterTargetFromMaintenanceWindowRequest>
  void DeregisterTargetFromMaintenanceWindowAsync(const DeregisterTargetFromMaintenanceWindowRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterTaskFromMaintenanceWindowOutcome DeregisterTaskFromMaintenanceWindow(
      const Model::DeregisterTaskFromMaintenanceWindowRequest& request) const;

  /**
   * A Callable wrapper for DeregisterTaskFromMaintenanceWindow that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeregisterTaskFromMaintenanceWindowRequestT = Model::DeregisterTaskFromMaintenanceWindowRequest>
  Model::DeregisterTaskFromMaintenanceWindowOutcomeCallable DeregisterTaskFromMaintenanceWindowCallable(
      const DeregisterTaskFromMaintenanceWindowRequestT& request) const {
    return SubmitCallable(&SSMClient::DeregisterTaskFromMaintenanceWindow, request);
  }

  /**
   * An Async wrapper for DeregisterTaskFromMaintenanceWindow that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeregisterTaskFromMaintenanceWindowRequestT = Model::DeregisterTaskFromMaintenanceWindowRequest>
  void DeregisterTaskFromMaintenanceWindowAsync(const DeregisterTaskFromMaintenanceWindowRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeActivations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeActivations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeActivationsRequestT = Model::DescribeActivationsRequest>
  void DescribeActivationsAsync(const DescribeActivationsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeActivationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAssociation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAssociationRequestT = Model::DescribeAssociationRequest>
  void DescribeAssociationAsync(const DescribeAssociationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeAssociationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAssociationExecutionTargetsOutcome DescribeAssociationExecutionTargets(
      const Model::DescribeAssociationExecutionTargetsRequest& request) const;

  /**
   * A Callable wrapper for DescribeAssociationExecutionTargets that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeAssociationExecutionTargetsRequestT = Model::DescribeAssociationExecutionTargetsRequest>
  Model::DescribeAssociationExecutionTargetsOutcomeCallable DescribeAssociationExecutionTargetsCallable(
      const DescribeAssociationExecutionTargetsRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeAssociationExecutionTargets, request);
  }

  /**
   * An Async wrapper for DescribeAssociationExecutionTargets that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeAssociationExecutionTargetsRequestT = Model::DescribeAssociationExecutionTargetsRequest>
  void DescribeAssociationExecutionTargetsAsync(const DescribeAssociationExecutionTargetsRequestT& request,
  ...
  virtual Model::DescribeAssociationExecutionsOutcome DescribeAssociationExecutions(
      const Model::DescribeAssociationExecutionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeAssociationExecutions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAssociationExecutionsRequestT = Model::DescribeAssociationExecutionsRequest>
  Model::DescribeAssociationExecutionsOutcomeCallable DescribeAssociationExecutionsCallable(
      const DescribeAssociationExecutionsRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeAssociationExecutions, request);
  }

  /**
   * An Async wrapper for DescribeAssociationExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAssociationExecutionsRequestT = Model::DescribeAssociationExecutionsRequest>
  void DescribeAssociationExecutionsAsync(const DescribeAssociationExecutionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAutomationExecutionsOutcome DescribeAutomationExecutions(
      const Model::DescribeAutomationExecutionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAutomationExecutions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAutomationExecutionsRequestT = Model::DescribeAutomationExecutionsRequest>
  Model::DescribeAutomationExecutionsOutcomeCallable DescribeAutomationExecutionsCallable(
      const DescribeAutomationExecutionsRequestT& request = {}) const {
    return SubmitCallable(&SSMClient::DescribeAutomationExecutions, request);
  }

  /**
   * An Async wrapper for DescribeAutomationExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAutomationExecutionsRequestT = Model::DescribeAutomationExecutionsRequest>
  void DescribeAutomationExecutionsAsync(const DescribeAutomationExecutionsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeAutomationExecutionsRequestT& request = {}) const {
  ...
  virtual Model::DescribeAutomationStepExecutionsOutcome DescribeAutomationStepExecutions(
      const Model::DescribeAutomationStepExecutionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeAutomationStepExecutions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeAutomationStepExecutionsRequestT = Model::DescribeAutomationStepExecutionsRequest>
  Model::DescribeAutomationStepExecutionsOutcomeCallable DescribeAutomationStepExecutionsCallable(
      const DescribeAutomationStepExecutionsRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeAutomationStepExecutions, request);
  }

  /**
   * An Async wrapper for DescribeAutomationStepExecutions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAutomationStepExecutionsRequestT = Model::DescribeAutomationStepExecutionsRequest>
  void DescribeAutomationStepExecutionsAsync(const DescribeAutomationStepExecutionsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeAvailablePatches that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeAvailablePatchesRequestT = Model::DescribeAvailablePatchesRequest>
  Model::DescribeAvailablePatchesOutcomeCallable DescribeAvailablePatchesCallable(
      const DescribeAvailablePatchesRequestT& request = {}) const {
    return SubmitCallable(&SSMClient::DescribeAvailablePatches, request);
  }

  /**
   * An Async wrapper for DescribeAvailablePatches that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAvailablePatchesRequestT = Model::DescribeAvailablePatchesRequest>
  void DescribeAvailablePatchesAsync(const DescribeAvailablePatchesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeAvailablePatchesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDocument that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDocument that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDocumentRequestT = Model::DescribeDocumentRequest>
  void DescribeDocumentAsync(const DescribeDocumentRequestT& request, const DescribeDocumentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDocumentPermissionOutcome DescribeDocumentPermission(
      const Model::DescribeDocumentPermissionRequest& request) const;

  /**
   * A Callable wrapper for DescribeDocumentPermission that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDocumentPermissionRequestT = Model::DescribeDocumentPermissionRequest>
  Model::DescribeDocumentPermissionOutcomeCallable DescribeDocumentPermissionCallable(
      const DescribeDocumentPermissionRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeDocumentPermission, request);
  }

  /**
   * An Async wrapper for DescribeDocumentPermission that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDocumentPermissionRequestT = Model::DescribeDocumentPermissionRequest>
  void DescribeDocumentPermissionAsync(const DescribeDocumentPermissionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEffectiveInstanceAssociationsOutcome DescribeEffectiveInstanceAssociations(
      const Model::DescribeEffectiveInstanceAssociationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeEffectiveInstanceAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeEffectiveInstanceAssociationsRequestT = Model::DescribeEffectiveInstanceAssociationsRequest>
  Model::DescribeEffectiveInstanceAssociationsOutcomeCallable DescribeEffectiveInstanceAssociationsCallable(
      const DescribeEffectiveInstanceAssociationsRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeEffectiveInstanceAssociations, request);
  }

  /**
   * An Async wrapper for DescribeEffectiveInstanceAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeEffectiveInstanceAssociationsRequestT = Model::DescribeEffectiveInstanceAssociationsRequest>
  void DescribeEffectiveInstanceAssociationsAsync(const DescribeEffectiveInstanceAssociationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEffectivePatchesForPatchBaselineOutcome DescribeEffectivePatchesForPatchBaseline(
      const Model::DescribeEffectivePatchesForPatchBaselineRequest& request) const;

  /**
   * A Callable wrapper for DescribeEffectivePatchesForPatchBaseline that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeEffectivePatchesForPatchBaselineRequestT = Model::DescribeEffectivePatchesForPatchBaselineRequest>
  Model::DescribeEffectivePatchesForPatchBaselineOutcomeCallable DescribeEffectivePatchesForPatchBaselineCallable(
      const DescribeEffectivePatchesForPatchBaselineRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeEffectivePatchesForPatchBaseline, request);
  }

  /**
   * An Async wrapper for DescribeEffectivePatchesForPatchBaseline that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeEffectivePatchesForPatchBaselineRequestT = Model::DescribeEffectivePatchesForPatchBaselineRequest>
  void DescribeEffectivePatchesForPatchBaselineAsync(
      const DescribeEffectivePatchesForPatchBaselineRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInstanceAssociationsStatusOutcome DescribeInstanceAssociationsStatus(
      const Model::DescribeInstanceAssociationsStatusRequest& request) const;

  /**
   * A Callable wrapper for DescribeInstanceAssociationsStatus that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeInstanceAssociationsStatusRequestT = Model::DescribeInstanceAssociationsStatusRequest>
  Model::DescribeInstanceAssociationsStatusOutcomeCallable DescribeInstanceAssociationsStatusCallable(
      const DescribeInstanceAssociationsStatusRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeInstanceAssociationsStatus, request);
  }

  /**
   * An Async wrapper for DescribeInstanceAssociationsStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeInstanceAssociationsStatusRequestT = Model::DescribeInstanceAssociationsStatusRequest>
  void DescribeInstanceAssociationsStatusAsync(const DescribeInstanceAssociationsStatusRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInstanceInformationOutcome DescribeInstanceInformation(
      const Model::DescribeInstanceInformationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeInstanceInformation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInstanceInformationRequestT = Model::DescribeInstanceInformationRequest>
  Model::DescribeInstanceInformationOutcomeCallable DescribeInstanceInformationCallable(
      const DescribeInstanceInformationRequestT& request = {}) const {
    return SubmitCallable(&SSMClient::DescribeInstanceInformation, request);
  }

  /**
   * An Async wrapper for DescribeInstanceInformation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstanceInformationRequestT = Model::DescribeInstanceInformationRequest>
  void DescribeInstanceInformationAsync(const DescribeInstanceInformationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeInstanceInformationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInstancePatchStatesOutcome DescribeInstancePatchStates(
      const Model::DescribeInstancePatchStatesRequest& request) const;

  /**
   * A Callable wrapper for DescribeInstancePatchStates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInstancePatchStatesRequestT = Model::DescribeInstancePatchStatesRequest>
  Model::DescribeInstancePatchStatesOutcomeCallable DescribeInstancePatchStatesCallable(
      const DescribeInstancePatchStatesRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeInstancePatchStates, request);
  }

  /**
   * An Async wrapper for DescribeInstancePatchStates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstancePatchStatesRequestT = Model::DescribeInstancePatchStatesRequest>
  void DescribeInstancePatchStatesAsync(const DescribeInstancePatchStatesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInstancePatchStatesForPatchGroupOutcome DescribeInstancePatchStatesForPatchGroup(
      const Model::DescribeInstancePatchStatesForPatchGroupRequest& request) const;

  /**
   * A Callable wrapper for DescribeInstancePatchStatesForPatchGroup that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeInstancePatchStatesForPatchGroupRequestT = Model::DescribeInstancePatchStatesForPatchGroupRequest>
  Model::DescribeInstancePatchStatesForPatchGroupOutcomeCallable DescribeInstancePatchStatesForPatchGroupCallable(
      const DescribeInstancePatchStatesForPatchGroupRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeInstancePatchStatesForPatchGroup, request);
  }

  /**
   * An Async wrapper for DescribeInstancePatchStatesForPatchGroup that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeInstancePatchStatesForPatchGroupRequestT = Model::DescribeInstancePatchStatesForPatchGroupRequest>
  void DescribeInstancePatchStatesForPatchGroupAsync(
      const DescribeInstancePatchStatesForPatchGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeInstancePatches that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeInstancePatches that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstancePatchesRequestT = Model::DescribeInstancePatchesRequest>
  void DescribeInstancePatchesAsync(const DescribeInstancePatchesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInstancePropertiesOutcome DescribeInstanceProperties(
      const Model::DescribeInstancePropertiesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeInstanceProperties that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInstancePropertiesRequestT = Model::DescribeInstancePropertiesRequest>
  Model::DescribeInstancePropertiesOutcomeCallable DescribeInstancePropertiesCallable(
      const DescribeInstancePropertiesRequestT& request = {}) const {
    return SubmitCallable(&SSMClient::DescribeInstanceProperties, request);
  }

  /**
   * An Async wrapper for DescribeInstanceProperties that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstancePropertiesRequestT = Model::DescribeInstancePropertiesRequest>
  void DescribeInstancePropertiesAsync(const DescribeInstancePropertiesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeInstancePropertiesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInventoryDeletionsOutcome DescribeInventoryDeletions(
      const Model::DescribeInventoryDeletionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeInventoryDeletions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInventoryDeletionsRequestT = Model::DescribeInventoryDeletionsRequest>
  Model::DescribeInventoryDeletionsOutcomeCallable DescribeInventoryDeletionsCallable(
      const DescribeInventoryDeletionsRequestT& request = {}) const {
    return SubmitCallable(&SSMClient::DescribeInventoryDeletions, request);
  }

  /**
   * An Async wrapper for DescribeInventoryDeletions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInventoryDeletionsRequestT = Model::DescribeInventoryDeletionsRequest>
  void DescribeInventoryDeletionsAsync(const DescribeInventoryDeletionsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeInventoryDeletionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMaintenanceWindowExecutionTaskInvocationsOutcome DescribeMaintenanceWindowExecutionTaskInvocations(
      const Model::DescribeMaintenanceWindowExecutionTaskInvocationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeMaintenanceWindowExecutionTaskInvocations that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <
      typename DescribeMaintenanceWindowExecutionTaskInvocationsRequestT = Model::DescribeMaintenanceWindowExecutionTaskInvocationsRequest>
  Model::DescribeMaintenanceWindowExecutionTaskInvocationsOutcomeCallable DescribeMaintenanceWindowExecutionTaskInvocationsCallable(
      const DescribeMaintenanceWindowExecutionTaskInvocationsRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeMaintenanceWindowExecutionTaskInvocations, request);
  }

  /**
   * An Async wrapper for DescribeMaintenanceWindowExecutionTaskInvocations that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <
      typename DescribeMaintenanceWindowExecutionTaskInvocationsRequestT = Model::DescribeMaintenanceWindowExecutionTaskInvocationsRequest>
  void DescribeMaintenanceWindowExecutionTaskInvocationsAsync(
      const DescribeMaintenanceWindowExecutionTaskInvocationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMaintenanceWindowExecutionTasksOutcome DescribeMaintenanceWindowExecutionTasks(
      const Model::DescribeMaintenanceWindowExecutionTasksRequest& request) const;

  /**
   * A Callable wrapper for DescribeMaintenanceWindowExecutionTasks that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeMaintenanceWindowExecutionTasksRequestT = Model::DescribeMaintenanceWindowExecutionTasksRequest>
  Model::DescribeMaintenanceWindowExecutionTasksOutcomeCallable DescribeMaintenanceWindowExecutionTasksCallable(
      const DescribeMaintenanceWindowExecutionTasksRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeMaintenanceWindowExecutionTasks, request);
  }

  /**
   * An Async wrapper for DescribeMaintenanceWindowExecutionTasks that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeMaintenanceWindowExecutionTasksRequestT = Model::DescribeMaintenanceWindowExecutionTasksRequest>
  void DescribeMaintenanceWindowExecutionTasksAsync(const DescribeMaintenanceWindowExecutionTasksRequestT& request,
  ...
  virtual Model::DescribeMaintenanceWindowExecutionsOutcome DescribeMaintenanceWindowExecutions(
      const Model::DescribeMaintenanceWindowExecutionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeMaintenanceWindowExecutions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeMaintenanceWindowExecutionsRequestT = Model::DescribeMaintenanceWindowExecutionsRequest>
  Model::DescribeMaintenanceWindowExecutionsOutcomeCallable DescribeMaintenanceWindowExecutionsCallable(
      const DescribeMaintenanceWindowExecutionsRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeMaintenanceWindowExecutions, request);
  }

  /**
   * An Async wrapper for DescribeMaintenanceWindowExecutions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeMaintenanceWindowExecutionsRequestT = Model::DescribeMaintenanceWindowExecutionsRequest>
  void DescribeMaintenanceWindowExecutionsAsync(const DescribeMaintenanceWindowExecutionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMaintenanceWindowScheduleOutcome DescribeMaintenanceWindowSchedule(
      const Model::DescribeMaintenanceWindowScheduleRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeMaintenanceWindowSchedule that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeMaintenanceWindowScheduleRequestT = Model::DescribeMaintenanceWindowScheduleRequest>
  Model::DescribeMaintenanceWindowScheduleOutcomeCallable DescribeMaintenanceWindowScheduleCallable(
      const DescribeMaintenanceWindowScheduleRequestT& request = {}) const {
    return SubmitCallable(&SSMClient::DescribeMaintenanceWindowSchedule, request);
  }

  /**
   * An Async wrapper for DescribeMaintenanceWindowSchedule that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeMaintenanceWindowScheduleRequestT = Model::DescribeMaintenanceWindowScheduleRequest>
  void DescribeMaintenanceWindowScheduleAsync(const DescribeMaintenanceWindowScheduleResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeMaintenanceWindowScheduleRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMaintenanceWindowTargetsOutcome DescribeMaintenanceWindowTargets(
      const Model::DescribeMaintenanceWindowTargetsRequest& request) const;

  /**
   * A Callable wrapper for DescribeMaintenanceWindowTargets that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeMaintenanceWindowTargetsRequestT = Model::DescribeMaintenanceWindowTargetsRequest>
  Model::DescribeMaintenanceWindowTargetsOutcomeCallable DescribeMaintenanceWindowTargetsCallable(
      const DescribeMaintenanceWindowTargetsRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeMaintenanceWindowTargets, request);
  }

  /**
   * An Async wrapper for DescribeMaintenanceWindowTargets that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeMaintenanceWindowTargetsRequestT = Model::DescribeMaintenanceWindowTargetsRequest>
  void DescribeMaintenanceWindowTargetsAsync(const DescribeMaintenanceWindowTargetsRequestT& request,
  ...
  virtual Model::DescribeMaintenanceWindowTasksOutcome DescribeMaintenanceWindowTasks(
      const Model::DescribeMaintenanceWindowTasksRequest& request) const;

  /**
   * A Callable wrapper for DescribeMaintenanceWindowTasks that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeMaintenanceWindowTasksRequestT = Model::DescribeMaintenanceWindowTasksRequest>
  Model::DescribeMaintenanceWindowTasksOutcomeCallable DescribeMaintenanceWindowTasksCallable(
      const DescribeMaintenanceWindowTasksRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeMaintenanceWindowTasks, request);
  }

  /**
   * An Async wrapper for DescribeMaintenanceWindowTasks that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeMaintenanceWindowTasksRequestT = Model::DescribeMaintenanceWindowTasksRequest>
  void DescribeMaintenanceWindowTasksAsync(const DescribeMaintenanceWindowTasksRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMaintenanceWindowsOutcome DescribeMaintenanceWindows(
      const Model::DescribeMaintenanceWindowsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeMaintenanceWindows that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeMaintenanceWindowsRequestT = Model::DescribeMaintenanceWindowsRequest>
  Model::DescribeMaintenanceWindowsOutcomeCallable DescribeMaintenanceWindowsCallable(
      const DescribeMaintenanceWindowsRequestT& request = {}) const {
    return SubmitCallable(&SSMClient::DescribeMaintenanceWindows, request);
  }

  /**
   * An Async wrapper for DescribeMaintenanceWindows that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMaintenanceWindowsRequestT = Model::DescribeMaintenanceWindowsRequest>
  void DescribeMaintenanceWindowsAsync(const DescribeMaintenanceWindowsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeMaintenanceWindowsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMaintenanceWindowsForTargetOutcome DescribeMaintenanceWindowsForTarget(
      const Model::DescribeMaintenanceWindowsForTargetRequest& request) const;

  /**
   * A Callable wrapper for DescribeMaintenanceWindowsForTarget that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeMaintenanceWindowsForTargetRequestT = Model::DescribeMaintenanceWindowsForTargetRequest>
  Model::DescribeMaintenanceWindowsForTargetOutcomeCallable DescribeMaintenanceWindowsForTargetCallable(
      const DescribeMaintenanceWindowsForTargetRequestT& request) const {
    return SubmitCallable(&SSMClient::DescribeMaintenanceWindowsForTarget, request);
  }

  /**
   * An Async wrapper for DescribeMaintenanceWindowsForTarget that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeMaintenanceWindowsForTargetRequestT = Model::DescribeMaintenanceWindowsForTargetRequest>
  void DescribeMaintenanceWindowsForTargetAsync(const DescribeMaintenanceWindowsForTargetRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeOpsItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeOpsItems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeOpsItemsRequestT = Model::DescribeOpsItemsRequest>
  void DescribeOpsItemsAsync(const DescribeOpsItemsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DescribeOpsItemsRequestT& request = {}) const {
   ...
   */
  template <typename DescribeParametersRequestT = Model::DescribeParametersRequest>
  void DescribeParametersAsync(const DescribeParametersResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeParametersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribePatchBaselines that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePatchBaselines that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePatchBaselinesRequestT = Model::DescribePatchBaselinesRequest>
  void DescribePatchBaselinesAsync(const DescribePatchBaselinesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribePatchBaselinesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribePatchGroupState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePatchGroupState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePatchGroupStateRequestT = Model::DescribePatchGroupStateRequest>
  void DescribePatchGroupStateAsync(const DescribePatchGroupStateRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribePatchGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePatchGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePatchGroupsRequestT = Model::DescribePatchGroupsRequest>
  void DescribePatchGroupsAsync(const DescribePatchGroupsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribePatchGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribePatchProperties that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePatchProperties that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePatchPropertiesRequestT = Model::DescribePatchPropertiesRequest>
  void DescribePatchPropertiesAsync(const DescribePatchPropertiesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateOpsItemRelatedItemOutcome DisassociateOpsItemRelatedItem(
      const Model::DisassociateOpsItemRelatedItemRequest& request) const;

  /**
   * A Callable wrapper for DisassociateOpsItemRelatedItem that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateOpsItemRelatedItemRequestT = Model::DisassociateOpsItemRelatedItemRequest>
  Model::DisassociateOpsItemRelatedItemOutcomeCallable DisassociateOpsItemRelatedItemCallable(
      const DisassociateOpsItemRelatedItemRequestT& request) const {
    return SubmitCallable(&SSMClient::DisassociateOpsItemRelatedItem, request);
  }

  /**
   * An Async wrapper for DisassociateOpsItemRelatedItem that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateOpsItemRelatedItemRequestT = Model::DisassociateOpsItemRelatedItemRequest>
  void DisassociateOpsItemRelatedItemAsync(const DisassociateOpsItemRelatedItemRequestT& request,
                                           const DisassociateOpsItemRelatedItemResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAutomationExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAutomationExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAutomationExecutionRequestT = Model::GetAutomationExecutionRequest>
  void GetAutomationExecutionAsync(const GetAutomationExecutionRequestT& request,
  ...
  /**
   * A Callable wrapper for GetCalendarState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCalendarState that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCalendarStateRequestT = Model::GetCalendarStateRequest>
  void GetCalendarStateAsync(const GetCalendarStateRequestT& request, const GetCalendarStateResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCommandInvocation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCommandInvocation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCommandInvocationRequestT = Model::GetCommandInvocationRequest>
  void GetCommandInvocationAsync(const GetCommandInvocationRequestT& request, const GetCommandInvocationResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetConnectionStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetConnectionStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetConnectionStatusRequestT = Model::GetConnectionStatusRequest>
  void GetConnectionStatusAsync(const GetConnectionStatusRequestT& request, const GetConnectionStatusResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDefaultPatchBaseline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDefaultPatchBaseline that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDefaultPatchBaselineRequestT = Model::GetDefaultPatchBaselineRequest>
  void GetDefaultPatchBaselineAsync(const GetDefaultPatchBaselineResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const GetDefaultPatchBaselineRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDeployablePatchSnapshotForInstanceOutcome GetDeployablePatchSnapshotForInstance(
      const Model::GetDeployablePatchSnapshotForInstanceRequest& request) const;

  /**
   * A Callable wrapper for GetDeployablePatchSnapshotForInstance that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetDeployablePatchSnapshotForInstanceRequestT = Model::GetDeployablePatchSnapshotForInstanceRequest>
  Model::GetDeployablePatchSnapshotForInstanceOutcomeCallable GetDeployablePatchSnapshotForInstanceCallable(
      const GetDeployablePatchSnapshotForInstanceRequestT& request) const {
    return SubmitCallable(&SSMClient::GetDeployablePatchSnapshotForInstance, request);
  }

  /**
   * An Async wrapper for GetDeployablePatchSnapshotForInstance that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetDeployablePatchSnapshotForInstanceRequestT = Model::GetDeployablePatchSnapshotForInstanceRequest>
  void GetDeployablePatchSnapshotForInstanceAsync(const GetDeployablePatchSnapshotForInstanceRequestT& request,
  ...
  /**
   * A Callable wrapper for GetExecutionPreview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetExecutionPreview that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetExecutionPreviewRequestT = Model::GetExecutionPreviewRequest>
  void GetExecutionPreviewAsync(const GetExecutionPreviewRequestT& request, const GetExecutionPreviewResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetInventory that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetInventoryRequestT = Model::GetInventoryRequest>
  void GetInventoryAsync(const GetInventoryResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const GetInventoryRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetInventorySchema that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInventorySchema that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetInventorySchemaRequestT = Model::GetInventorySchemaRequest>
  void GetInventorySchemaAsync(const GetInventorySchemaResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetInventorySchemaRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetMaintenanceWindow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMaintenanceWindow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMaintenanceWindowRequestT = Model::GetMaintenanceWindowRequest>
  void GetMaintenanceWindowAsync(const GetMaintenanceWindowRequestT& request, const GetMaintenanceWindowResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMaintenanceWindowExecutionOutcome GetMaintenanceWindowExecution(
      const Model::GetMaintenanceWindowExecutionRequest& request) const;

  /**
   * A Callable wrapper for GetMaintenanceWindowExecution that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetMaintenanceWindowExecutionRequestT = Model::GetMaintenanceWindowExecutionRequest>
  Model::GetMaintenanceWindowExecutionOutcomeCallable GetMaintenanceWindowExecutionCallable(
      const GetMaintenanceWindowExecutionRequestT& request) const {
    return SubmitCallable(&SSMClient::GetMaintenanceWindowExecution, request);
  }

  /**
   * An Async wrapper for GetMaintenanceWindowExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMaintenanceWindowExecutionRequestT = Model::GetMaintenanceWindowExecutionRequest>
  void GetMaintenanceWindowExecutionAsync(const GetMaintenanceWindowExecutionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMaintenanceWindowExecutionTaskOutcome GetMaintenanceWindowExecutionTask(
      const Model::GetMaintenanceWindowExecutionTaskRequest& request) const;

  /**
   * A Callable wrapper for GetMaintenanceWindowExecutionTask that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetMaintenanceWindowExecutionTaskRequestT = Model::GetMaintenanceWindowExecutionTaskRequest>
  Model::GetMaintenanceWindowExecutionTaskOutcomeCallable GetMaintenanceWindowExecutionTaskCallable(
      const GetMaintenanceWindowExecutionTaskRequestT& request) const {
    return SubmitCallable(&SSMClient::GetMaintenanceWindowExecutionTask, request);
  }

  /**
   * An Async wrapper for GetMaintenanceWindowExecutionTask that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetMaintenanceWindowExecutionTaskRequestT = Model::GetMaintenanceWindowExecutionTaskRequest>
  void GetMaintenanceWindowExecutionTaskAsync(const GetMaintenanceWindowExecutionTaskRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMaintenanceWindowExecutionTaskInvocationOutcome GetMaintenanceWindowExecutionTaskInvocation(
      const Model::GetMaintenanceWindowExecutionTaskInvocationRequest& request) const;

  /**
   * A Callable wrapper for GetMaintenanceWindowExecutionTaskInvocation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::GetMaintenanceWindowExecutionTaskInvocationOutcomeCallable GetMaintenanceWindowExecutionTaskInvocationCallable(
      const GetMaintenanceWindowExecutionTaskInvocationRequestT& request) const {
    return SubmitCallable(&SSMClient::GetMaintenanceWindowExecutionTaskInvocation, request);
  }

  /**
   * An Async wrapper for GetMaintenanceWindowExecutionTaskInvocation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetMaintenanceWindowExecutionTaskInvocationRequestT = Model::GetMaintenanceWindowExecutionTaskInvocationRequest>
  void GetMaintenanceWindowExecutionTaskInvocationAsync(
      const GetMaintenanceWindowExecutionTaskInvocationRequestT& request,
  ...
  /**
   * A Callable wrapper for GetMaintenanceWindowTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMaintenanceWindowTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMaintenanceWindowTaskRequestT = Model::GetMaintenanceWindowTaskRequest>
  void GetMaintenanceWindowTaskAsync(const GetMaintenanceWindowTaskRequestT& request,
  ...
  /**
   * An Async wrapper for GetOpsItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOpsItemRequestT = Model::GetOpsItemRequest>
  void GetOpsItemAsync(const GetOpsItemRequestT& request, const GetOpsItemResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetOpsMetadata that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOpsMetadataRequestT = Model::GetOpsMetadataRequest>
  void GetOpsMetadataAsync(const GetOpsMetadataRequestT& request, const GetOpsMetadataResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetOpsSummary that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOpsSummaryRequestT = Model::GetOpsSummaryRequest>
  void GetOpsSummaryAsync(const GetOpsSummaryResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const GetOpsSummaryRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetParameter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetParameterRequestT = Model::GetParameterRequest>
  void GetParameterAsync(const GetParameterRequestT& request, const GetParameterResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetParameterHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetParameterHistory that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetParameterHistoryRequestT = Model::GetParameterHistoryRequest>
  void GetParameterHistoryAsync(const GetParameterHistoryRequestT& request, const GetParameterHistoryResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetParameters that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetParametersRequestT = Model::GetParametersRequest>
  void GetParametersAsync(const GetParametersRequestT& request, const GetParametersResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetParametersByPath that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetParametersByPath that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetParametersByPathRequestT = Model::GetParametersByPathRequest>
  void GetParametersByPathAsync(const GetParametersByPathRequestT& request, const GetParametersByPathResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPatchBaseline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPatchBaseline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPatchBaselineRequestT = Model::GetPatchBaselineRequest>
  void GetPatchBaselineAsync(const GetPatchBaselineRequestT& request, const GetPatchBaselineResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetPatchBaselineForPatchGroupOutcome GetPatchBaselineForPatchGroup(
      const Model::GetPatchBaselineForPatchGroupRequest& request) const;

  /**
   * A Callable wrapper for GetPatchBaselineForPatchGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPatchBaselineForPatchGroupRequestT = Model::GetPatchBaselineForPatchGroupRequest>
  Model::GetPatchBaselineForPatchGroupOutcomeCallable GetPatchBaselineForPatchGroupCallable(
      const GetPatchBaselineForPatchGroupRequestT& request) const {
    return SubmitCallable(&SSMClient::GetPatchBaselineForPatchGroup, request);
  }

  /**
   * An Async wrapper for GetPatchBaselineForPatchGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPatchBaselineForPatchGroupRequestT = Model::GetPatchBaselineForPatchGroupRequest>
  void GetPatchBaselineForPatchGroupAsync(const GetPatchBaselineForPatchGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for GetServiceSetting that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetServiceSetting that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetServiceSettingRequestT = Model::GetServiceSettingRequest>
  void GetServiceSettingAsync(const GetServiceSettingRequestT& request, const GetServiceSettingResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for LabelParameterVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for LabelParameterVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename LabelParameterVersionRequestT = Model::LabelParameterVersionRequest>
  void LabelParameterVersionAsync(const LabelParameterVersionRequestT& request, const LabelParameterVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAssociationVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssociationVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssociationVersionsRequestT = Model::ListAssociationVersionsRequest>
  void ListAssociationVersionsAsync(const ListAssociationVersionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListCommandInvocations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCommandInvocations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCommandInvocationsRequestT = Model::ListCommandInvocationsRequest>
  void ListCommandInvocationsAsync(const ListCommandInvocationsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListCommandInvocationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListCommands that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCommandsRequestT = Model::ListCommandsRequest>
  void ListCommandsAsync(const ListCommandsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListCommandsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListComplianceItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListComplianceItems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListComplianceItemsRequestT = Model::ListComplianceItemsRequest>
  void ListComplianceItemsAsync(const ListComplianceItemsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListComplianceItemsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListComplianceSummaries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListComplianceSummaries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListComplianceSummariesRequestT = Model::ListComplianceSummariesRequest>
  void ListComplianceSummariesAsync(const ListComplianceSummariesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListComplianceSummariesRequestT& request = {}) const {
  ...
  virtual Model::ListDocumentMetadataHistoryOutcome ListDocumentMetadataHistory(
      const Model::ListDocumentMetadataHistoryRequest& request) const;

  /**
   * A Callable wrapper for ListDocumentMetadataHistory that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDocumentMetadataHistoryRequestT = Model::ListDocumentMetadataHistoryRequest>
  Model::ListDocumentMetadataHistoryOutcomeCallable ListDocumentMetadataHistoryCallable(
      const ListDocumentMetadataHistoryRequestT& request) const {
    return SubmitCallable(&SSMClient::ListDocumentMetadataHistory, request);
  }

  /**
   * An Async wrapper for ListDocumentMetadataHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDocumentMetadataHistoryRequestT = Model::ListDocumentMetadataHistoryRequest>
  void ListDocumentMetadataHistoryAsync(const ListDocumentMetadataHistoryRequestT& request,
                                        const ListDocumentMetadataHistoryResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDocumentVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDocumentVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDocumentVersionsRequestT = Model::ListDocumentVersionsRequest>
  void ListDocumentVersionsAsync(const ListDocumentVersionsRequestT& request, const ListDocumentVersionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListDocumentsRequestT = Model::ListDocumentsRequest>
  void ListDocumentsAsync(const ListDocumentsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListDocumentsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListInventoryEntries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInventoryEntries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInventoryEntriesRequestT = Model::ListInventoryEntriesRequest>
  void ListInventoryEntriesAsync(const ListInventoryEntriesRequestT& request, const ListInventoryEntriesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListNodesSummary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListNodesSummary that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListNodesSummaryRequestT = Model::ListNodesSummaryRequest>
  void ListNodesSummaryAsync(const ListNodesSummaryRequestT& request, const ListNodesSummaryResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListOpsItemEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOpsItemEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListOpsItemEventsRequestT = Model::ListOpsItemEventsRequest>
  void ListOpsItemEventsAsync(const ListOpsItemEventsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListOpsItemEventsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListOpsItemRelatedItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOpsItemRelatedItems that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOpsItemRelatedItemsRequestT = Model::ListOpsItemRelatedItemsRequest>
  void ListOpsItemRelatedItemsAsync(const ListOpsItemRelatedItemsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListOpsItemRelatedItemsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListOpsMetadata that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListOpsMetadataRequestT = Model::ListOpsMetadataRequest>
  void ListOpsMetadataAsync(const ListOpsMetadataResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListOpsMetadataRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResourceComplianceSummariesOutcome ListResourceComplianceSummaries(
      const Model::ListResourceComplianceSummariesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListResourceComplianceSummaries that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListResourceComplianceSummariesRequestT = Model::ListResourceComplianceSummariesRequest>
  Model::ListResourceComplianceSummariesOutcomeCallable ListResourceComplianceSummariesCallable(
      const ListResourceComplianceSummariesRequestT& request = {}) const {
    return SubmitCallable(&SSMClient::ListResourceComplianceSummaries, request);
  }

  /**
   * An Async wrapper for ListResourceComplianceSummaries that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListResourceComplianceSummariesRequestT = Model::ListResourceComplianceSummariesRequest>
  void ListResourceComplianceSummariesAsync(const ListResourceComplianceSummariesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListResourceComplianceSummariesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListResourceDataSync that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceDataSync that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceDataSyncRequestT = Model::ListResourceDataSyncRequest>
  void ListResourceDataSyncAsync(const ListResourceDataSyncResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListResourceDataSyncRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ModifyDocumentPermission that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyDocumentPermission that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyDocumentPermissionRequestT = Model::ModifyDocumentPermissionRequest>
  void ModifyDocumentPermissionAsync(const ModifyDocumentPermissionRequestT& request,
  ...
  /**
   * A Callable wrapper for PutComplianceItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutComplianceItems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutComplianceItemsRequestT = Model::PutComplianceItemsRequest>
  void PutComplianceItemsAsync(const PutComplianceItemsRequestT& request, const PutComplianceItemsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutInventory that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutInventoryRequestT = Model::PutInventoryRequest>
  void PutInventoryAsync(const PutInventoryRequestT& request, const PutInventoryResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutParameter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutParameterRequestT = Model::PutParameterRequest>
  void PutParameterAsync(const PutParameterRequestT& request, const PutParameterResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterDefaultPatchBaselineOutcome RegisterDefaultPatchBaseline(
      const Model::RegisterDefaultPatchBaselineRequest& request) const;

  /**
   * A Callable wrapper for RegisterDefaultPatchBaseline that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterDefaultPatchBaselineRequestT = Model::RegisterDefaultPatchBaselineRequest>
  Model::RegisterDefaultPatchBaselineOutcomeCallable RegisterDefaultPatchBaselineCallable(
      const RegisterDefaultPatchBaselineRequestT& request) const {
    return SubmitCallable(&SSMClient::RegisterDefaultPatchBaseline, request);
  }

  /**
   * An Async wrapper for RegisterDefaultPatchBaseline that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterDefaultPatchBaselineRequestT = Model::RegisterDefaultPatchBaselineRequest>
  void RegisterDefaultPatchBaselineAsync(const RegisterDefaultPatchBaselineRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterPatchBaselineForPatchGroupOutcome RegisterPatchBaselineForPatchGroup(
      const Model::RegisterPatchBaselineForPatchGroupRequest& request) const;

  /**
   * A Callable wrapper for RegisterPatchBaselineForPatchGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename RegisterPatchBaselineForPatchGroupRequestT = Model::RegisterPatchBaselineForPatchGroupRequest>
  Model::RegisterPatchBaselineForPatchGroupOutcomeCallable RegisterPatchBaselineForPatchGroupCallable(
      const RegisterPatchBaselineForPatchGroupRequestT& request) const {
    return SubmitCallable(&SSMClient::RegisterPatchBaselineForPatchGroup, request);
  }

  /**
   * An Async wrapper for RegisterPatchBaselineForPatchGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RegisterPatchBaselineForPatchGroupRequestT = Model::RegisterPatchBaselineForPatchGroupRequest>
  void RegisterPatchBaselineForPatchGroupAsync(const RegisterPatchBaselineForPatchGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterTargetWithMaintenanceWindowOutcome RegisterTargetWithMaintenanceWindow(
      const Model::RegisterTargetWithMaintenanceWindowRequest& request) const;

  /**
   * A Callable wrapper for RegisterTargetWithMaintenanceWindow that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename RegisterTargetWithMaintenanceWindowRequestT = Model::RegisterTargetWithMaintenanceWindowRequest>
  Model::RegisterTargetWithMaintenanceWindowOutcomeCallable RegisterTargetWithMaintenanceWindowCallable(
      const RegisterTargetWithMaintenanceWindowRequestT& request) const {
    return SubmitCallable(&SSMClient::RegisterTargetWithMaintenanceWindow, request);
  }

  /**
   * An Async wrapper for RegisterTargetWithMaintenanceWindow that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename RegisterTargetWithMaintenanceWindowRequestT = Model::RegisterTargetWithMaintenanceWindowRequest>
  void RegisterTargetWithMaintenanceWindowAsync(const RegisterTargetWithMaintenanceWindowRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterTaskWithMaintenanceWindowOutcome RegisterTaskWithMaintenanceWindow(
      const Model::RegisterTaskWithMaintenanceWindowRequest& request) const;

  /**
   * A Callable wrapper for RegisterTaskWithMaintenanceWindow that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename RegisterTaskWithMaintenanceWindowRequestT = Model::RegisterTaskWithMaintenanceWindowRequest>
  Model::RegisterTaskWithMaintenanceWindowOutcomeCallable RegisterTaskWithMaintenanceWindowCallable(
      const RegisterTaskWithMaintenanceWindowRequestT& request) const {
    return SubmitCallable(&SSMClient::RegisterTaskWithMaintenanceWindow, request);
  }

  /**
   * An Async wrapper for RegisterTaskWithMaintenanceWindow that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RegisterTaskWithMaintenanceWindowRequestT = Model::RegisterTaskWithMaintenanceWindowRequest>
  void RegisterTaskWithMaintenanceWindowAsync(const RegisterTaskWithMaintenanceWindowRequestT& request,
  ...
  /**
   * A Callable wrapper for ResetServiceSetting that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetServiceSetting that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ResetServiceSettingRequestT = Model::ResetServiceSettingRequest>
  void ResetServiceSettingAsync(const ResetServiceSettingRequestT& request, const ResetServiceSettingResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ResumeSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResumeSessionRequestT = Model::ResumeSessionRequest>
  void ResumeSessionAsync(const ResumeSessionRequestT& request, const ResumeSessionResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendAutomationSignal that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendAutomationSignal that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendAutomationSignalRequestT = Model::SendAutomationSignalRequest>
  void SendAutomationSignalAsync(const SendAutomationSignalRequestT& request, const SendAutomationSignalResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SendCommand that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendCommandRequestT = Model::SendCommandRequest>
  void SendCommandAsync(const SendCommandRequestT& request, const SendCommandResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAccessRequest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAccessRequest that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartAccessRequestRequestT = Model::StartAccessRequestRequest>
  void StartAccessRequestAsync(const StartAccessRequestRequestT& request, const StartAccessRequestResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAssociationsOnce that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAssociationsOnce that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartAssociationsOnceRequestT = Model::StartAssociationsOnceRequest>
  void StartAssociationsOnceAsync(const StartAssociationsOnceRequestT& request, const StartAssociationsOnceResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAutomationExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAutomationExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartAutomationExecutionRequestT = Model::StartAutomationExecutionRequest>
  void StartAutomationExecutionAsync(const StartAutomationExecutionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StartChangeRequestExecutionOutcome StartChangeRequestExecution(
      const Model::StartChangeRequestExecutionRequest& request) const;

  /**
   * A Callable wrapper for StartChangeRequestExecution that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartChangeRequestExecutionRequestT = Model::StartChangeRequestExecutionRequest>
  Model::StartChangeRequestExecutionOutcomeCallable StartChangeRequestExecutionCallable(
      const StartChangeRequestExecutionRequestT& request) const {
    return SubmitCallable(&SSMClient::StartChangeRequestExecution, request);
  }

  /**
   * An Async wrapper for StartChangeRequestExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartChangeRequestExecutionRequestT = Model::StartChangeRequestExecutionRequest>
  void StartChangeRequestExecutionAsync(const StartChangeRequestExecutionRequestT& request,
                                        const StartChangeRequestExecutionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartExecutionPreview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartExecutionPreview that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartExecutionPreviewRequestT = Model::StartExecutionPreviewRequest>
  void StartExecutionPreviewAsync(const StartExecutionPreviewRequestT& request, const StartExecutionPreviewResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopAutomationExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopAutomationExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopAutomationExecutionRequestT = Model::StopAutomationExecutionRequest>
  void StopAutomationExecutionAsync(const StopAutomationExecutionRequestT& request,
  ...
  /**
   * A Callable wrapper for UnlabelParameterVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UnlabelParameterVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UnlabelParameterVersionRequestT = Model::UnlabelParameterVersionRequest>
  void UnlabelParameterVersionAsync(const UnlabelParameterVersionRequestT& request,
                                    const UnlabelParameterVersionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAssociationStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAssociationStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAssociationStatusRequestT = Model::UpdateAssociationStatusRequest>
  void UpdateAssociationStatusAsync(const UpdateAssociationStatusRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDocumentDefaultVersionOutcome UpdateDocumentDefaultVersion(
      const Model::UpdateDocumentDefaultVersionRequest& request) const;

  /**
   * A Callable wrapper for UpdateDocumentDefaultVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateDocumentDefaultVersionRequestT = Model::UpdateDocumentDefaultVersionRequest>
  Model::UpdateDocumentDefaultVersionOutcomeCallable UpdateDocumentDefaultVersionCallable(
      const UpdateDocumentDefaultVersionRequestT& request) const {
    return SubmitCallable(&SSMClient::UpdateDocumentDefaultVersion, request);
  }

  /**
   * An Async wrapper for UpdateDocumentDefaultVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDocumentDefaultVersionRequestT = Model::UpdateDocumentDefaultVersionRequest>
  void UpdateDocumentDefaultVersionAsync(const UpdateDocumentDefaultVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateDocumentMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDocumentMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDocumentMetadataRequestT = Model::UpdateDocumentMetadataRequest>
  void UpdateDocumentMetadataAsync(const UpdateDocumentMetadataRequestT& request,
                                   const UpdateDocumentMetadataResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMaintenanceWindow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMaintenanceWindow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMaintenanceWindowRequestT = Model::UpdateMaintenanceWindowRequest>
  void UpdateMaintenanceWindowAsync(const UpdateMaintenanceWindowRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateMaintenanceWindowTargetOutcome UpdateMaintenanceWindowTarget(
      const Model::UpdateMaintenanceWindowTargetRequest& request) const;

  /**
   * A Callable wrapper for UpdateMaintenanceWindowTarget that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateMaintenanceWindowTargetRequestT = Model::UpdateMaintenanceWindowTargetRequest>
  Model::UpdateMaintenanceWindowTargetOutcomeCallable UpdateMaintenanceWindowTargetCallable(
      const UpdateMaintenanceWindowTargetRequestT& request) const {
    return SubmitCallable(&SSMClient::UpdateMaintenanceWindowTarget, request);
  }

  /**
   * An Async wrapper for UpdateMaintenanceWindowTarget that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMaintenanceWindowTargetRequestT = Model::UpdateMaintenanceWindowTargetRequest>
  void UpdateMaintenanceWindowTargetAsync(const UpdateMaintenanceWindowTargetRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateMaintenanceWindowTaskOutcome UpdateMaintenanceWindowTask(
      const Model::UpdateMaintenanceWindowTaskRequest& request) const;

  /**
   * A Callable wrapper for UpdateMaintenanceWindowTask that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateMaintenanceWindowTaskRequestT = Model::UpdateMaintenanceWindowTaskRequest>
  Model::UpdateMaintenanceWindowTaskOutcomeCallable UpdateMaintenanceWindowTaskCallable(
      const UpdateMaintenanceWindowTaskRequestT& request) const {
    return SubmitCallable(&SSMClient::UpdateMaintenanceWindowTask, request);
  }

  /**
   * An Async wrapper for UpdateMaintenanceWindowTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMaintenanceWindowTaskRequestT = Model::UpdateMaintenanceWindowTaskRequest>
  void UpdateMaintenanceWindowTaskAsync(const UpdateMaintenanceWindowTaskRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateManagedInstanceRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateManagedInstanceRoleRequestT = Model::UpdateManagedInstanceRoleRequest>
  Model::UpdateManagedInstanceRoleOutcomeCallable UpdateManagedInstanceRoleCallable(
      const UpdateManagedInstanceRoleRequestT& request) const {
    return SubmitCallable(&SSMClient::UpdateManagedInstanceRole, request);
  }

  /**
   * An Async wrapper for UpdateManagedInstanceRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateManagedInstanceRoleRequestT = Model::UpdateManagedInstanceRoleRequest>
  void UpdateManagedInstanceRoleAsync(const UpdateManagedInstanceRoleRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateOpsItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateOpsItemRequestT = Model::UpdateOpsItemRequest>
  void UpdateOpsItemAsync(const UpdateOpsItemRequestT& request, const UpdateOpsItemResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateOpsMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateOpsMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateOpsMetadataRequestT = Model::UpdateOpsMetadataRequest>
  void UpdateOpsMetadataAsync(const UpdateOpsMetadataRequestT& request, const UpdateOpsMetadataResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePatchBaseline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePatchBaseline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdatePatchBaselineRequestT = Model::UpdatePatchBaselineRequest>
  void UpdatePatchBaselineAsync(const UpdatePatchBaselineRequestT& request, const UpdatePatchBaselineResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateResourceDataSync that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResourceDataSync that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResourceDataSyncRequestT = Model::UpdateResourceDataSyncRequest>
  void UpdateResourceDataSyncAsync(const UpdateResourceDataSyncRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateServiceSetting that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateServiceSetting that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateServiceSettingRequestT = Model::UpdateServiceSettingRequest>
