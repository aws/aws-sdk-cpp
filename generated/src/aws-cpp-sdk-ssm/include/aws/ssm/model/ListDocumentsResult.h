...
class ListDocumentsResult {
 public:
  ...
  void SetDocumentIdentifiers(DocumentIdentifiersT&& value) {
    m_documentIdentifiersHasBeenSet = true;
    m_documentIdentifiers = std::forward<DocumentIdentifiersT>(value);
  }
  template <typename DocumentIdentifiersT = Aws::Vector<DocumentIdentifier>>
  ListDocumentsResult& WithDocumentIdentifiers(DocumentIdentifiersT&& value) {
    SetDocumentIdentifiers(std::forward<DocumentIdentifiersT>(value));
    return *this;
  }
  template <typename DocumentIdentifiersT = DocumentIdentifier>
  ListDocumentsResult& AddDocumentIdentifiers(DocumentIdentifiersT&& value) {
    m_documentIdentifiersHasBeenSet = true;
    m_documentIdentifiers.emplace_back(std::forward<DocumentIdentifiersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDocumentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDocumentsResult& WithRequestId(RequestIdT&& value) {
