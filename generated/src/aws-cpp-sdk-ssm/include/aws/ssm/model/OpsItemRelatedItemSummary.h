...
class OpsItemRelatedItemSummary {
 public:
  ...
  template <typename OpsItemIdT = Aws::String>
  OpsItemRelatedItemSummary& WithOpsItemId(OpsItemIdT&& value) {
  ...
  template <typename AssociationIdT = Aws::String>
  OpsItemRelatedItemSummary& WithAssociationId(AssociationIdT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  OpsItemRelatedItemSummary& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename AssociationTypeT = Aws::String>
  OpsItemRelatedItemSummary& WithAssociationType(AssociationTypeT&& value) {
  ...
  void SetResourceUri(ResourceUriT&& value) {
    m_resourceUriHasBeenSet = true;
    m_resourceUri = std::forward<ResourceUriT>(value);
  }
  template <typename ResourceUriT = Aws::String>
  OpsItemRelatedItemSummary& WithResourceUri(ResourceUriT&& value) {
    SetResourceUri(std::forward<ResourceUriT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedByT = OpsItemIdentity>
  OpsItemRelatedItemSummary& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  OpsItemRelatedItemSummary& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename LastModifiedByT = OpsItemIdentity>
  OpsItemRelatedItemSummary& WithLastModifiedBy(LastModifiedByT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  OpsItemRelatedItemSummary& WithLastModifiedTime(LastModifiedTimeT&& value) {
