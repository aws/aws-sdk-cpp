...
class MaintenanceWindowIdentity {
 public:
  ...
  inline MaintenanceWindowIdentity& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline MaintenanceWindowIdentity& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline MaintenanceWindowIdentity& WithCutoff(int value) {
    SetCutoff(value);
    return *this;
  }
  ///@}
  ...
  inline MaintenanceWindowIdentity& WithScheduleOffset(int value) {
