...
class GetDefaultPatchBaselineResult {
 public:
  ...
  template <typename BaselineIdT = Aws::String>
  GetDefaultPatchBaselineResult& WithBaselineId(BaselineIdT&& value) {
  ...
  inline GetDefaultPatchBaselineResult& WithOperatingSystem(OperatingSystem value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDefaultPatchBaselineResult& WithRequestId(RequestIdT&& value) {
