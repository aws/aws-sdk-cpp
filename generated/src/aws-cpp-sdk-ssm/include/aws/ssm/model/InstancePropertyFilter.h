...
class InstancePropertyFilter {
 public:
  ...
  inline void SetKey(InstancePropertyFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline InstancePropertyFilter& WithKey(InstancePropertyFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  void SetValueSet(ValueSetT&& value) {
    m_valueSetHasBeenSet = true;
    m_valueSet = std::forward<ValueSetT>(value);
  }
  template <typename ValueSetT = Aws::Vector<Aws::String>>
  InstancePropertyFilter& WithValueSet(ValueSetT&& value) {
    SetValueSet(std::forward<ValueSetT>(value));
    return *this;
  }
  template <typename ValueSetT = Aws::String>
  InstancePropertyFilter& AddValueSet(ValueSetT&& value) {
    m_valueSetHasBeenSet = true;
    m_valueSet.emplace_back(std::forward<ValueSetT>(value));
    return *this;
  }
  ///@}
 private:
