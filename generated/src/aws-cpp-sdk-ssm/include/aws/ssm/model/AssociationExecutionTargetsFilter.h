...
class AssociationExecutionTargetsFilter {
 public:
  ...
  inline void SetKey(AssociationExecutionTargetsFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline AssociationExecutionTargetsFilter& WithKey(AssociationExecutionTargetsFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  AssociationExecutionTargetsFilter& WithValue(ValueT&& value) {
