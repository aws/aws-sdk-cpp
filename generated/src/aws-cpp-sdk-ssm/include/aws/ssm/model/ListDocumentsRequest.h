...
class ListDocumentsRequest : public SSMRequest {
 public:
  ...
  void SetDocumentFilterList(DocumentFilterListT&& value) {
    m_documentFilterListHasBeenSet = true;
    m_documentFilterList = std::forward<DocumentFilterListT>(value);
  }
  template <typename DocumentFilterListT = Aws::Vector<DocumentFilter>>
  ListDocumentsRequest& WithDocumentFilterList(DocumentFilterListT&& value) {
    SetDocumentFilterList(std::forward<DocumentFilterListT>(value));
    return *this;
  }
  template <typename DocumentFilterListT = DocumentFilter>
  ListDocumentsRequest& AddDocumentFilterList(DocumentFilterListT&& value) {
    m_documentFilterListHasBeenSet = true;
    m_documentFilterList.emplace_back(std::forward<DocumentFilterListT>(value));
    return *this;
  }
  ///@}
