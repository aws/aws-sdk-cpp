...
class PatchFilter {
 public:
  ...
  inline void SetKey(PatchFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline PatchFilter& WithKey(PatchFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  PatchFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  PatchFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
