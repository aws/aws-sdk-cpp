...
class PutParameterResult {
 public:
  ...
  inline PutParameterResult& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline PutParameterResult& WithTier(ParameterTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutParameterResult& WithRequestId(RequestIdT&& value) {
