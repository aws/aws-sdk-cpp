...
class DescribeInstancePatchStatesResult {
 public:
  ...
  template <typename InstancePatchStatesT = Aws::Vector<InstancePatchState>>
  DescribeInstancePatchStatesResult& WithInstancePatchStates(InstancePatchStatesT&& value) {
    SetInstancePatchStates(std::forward<InstancePatchStatesT>(value));
    return *this;
  }
  template <typename InstancePatchStatesT = InstancePatchState>
  DescribeInstancePatchStatesResult& AddInstancePatchStates(InstancePatchStatesT&& value) {
    m_instancePatchStatesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstancePatchStatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeInstancePatchStatesResult& WithRequestId(RequestIdT&& value) {
