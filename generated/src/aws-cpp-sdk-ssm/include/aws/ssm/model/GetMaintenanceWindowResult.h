...
class GetMaintenanceWindowResult {
 public:
  ...
  void SetScheduleTimezone(ScheduleTimezoneT&& value) {
    ...
    m_scheduleTimezone = std::forward<ScheduleTimezoneT>(value);
  }
  template <typename ScheduleTimezoneT = Aws::String>
  GetMaintenanceWindowResult& WithScheduleTimezone(ScheduleTimezoneT&& value) {
    SetScheduleTimezone(std::forward<ScheduleTimezoneT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetMaintenanceWindowResult& WithScheduleOffset(int value) {
  ...
  void SetNextExecutionTime(NextExecutionTimeT&& value) {
    ...
    m_nextExecutionTime = std::forward<NextExecutionTimeT>(value);
  }
  template <typename NextExecutionTimeT = Aws::String>
  GetMaintenanceWindowResult& WithNextExecutionTime(NextExecutionTimeT&& value) {
    SetNextExecutionTime(std::forward<NextExecutionTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetMaintenanceWindowResult& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCutoff(int value) {
    m_cutoffHasBeenSet = true;
    m_cutoff = value;
  }
  inline GetMaintenanceWindowResult& WithCutoff(int value) {
    SetCutoff(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllowUnassociatedTargets(bool value) {
    m_allowUnassociatedTargetsHasBeenSet = true;
    m_allowUnassociatedTargets = value;
  }
  inline GetMaintenanceWindowResult& WithAllowUnassociatedTargets(bool value) {
    SetAllowUnassociatedTargets(value);
    return *this;
  }
  ///@}
  ...
  inline GetMaintenanceWindowResult& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
