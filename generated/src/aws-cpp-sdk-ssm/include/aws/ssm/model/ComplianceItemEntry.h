...
class ComplianceItemEntry {
 public:
  ...
  inline void SetSeverity(ComplianceSeverity value) {
    m_severityHasBeenSet = true;
    m_severity = value;
  }
  inline ComplianceItemEntry& WithSeverity(ComplianceSeverity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline ComplianceItemEntry& WithStatus(ComplianceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  ComplianceItemEntry& AddDetails(DetailsKeyT&& key, DetailsValueT&& value) {
    m_detailsHasBeenSet = true;
    m_details.emplace(std::forward<DetailsKeyT>(key), std::forward<DetailsValueT>(value));
    return *this;
  }
  ///@}
 private:
