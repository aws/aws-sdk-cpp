...
class UpdatePatchBaselineResult {
 public:
  ...
  inline UpdatePatchBaselineResult& WithOperatingSystem(OperatingSystem value) {
  ...
  inline UpdatePatchBaselineResult& WithApprovedPatchesComplianceLevel(PatchComplianceLevel value) {
  ...
  inline UpdatePatchBaselineResult& WithApprovedPatchesEnableNonSecurity(bool value) {
  ...
  inline UpdatePatchBaselineResult& WithRejectedPatchesAction(PatchAction value) {
  ...
  inline UpdatePatchBaselineResult& WithAvailableSecurityUpdatesComplianceStatus(PatchComplianceStatus value) {
