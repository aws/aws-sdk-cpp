...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API SendAutomationSignalResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    SendAutomationSignalResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
