...
class AssociationOverview {
 public:
  ...
  template <typename StatusT = Aws::String>
  AssociationOverview& WithStatus(StatusT&& value) {
  ...
  template <typename DetailedStatusT = Aws::String>
  AssociationOverview& WithDetailedStatus(DetailedStatusT&& value) {
  ...
  void SetAssociationStatusAggregatedCount(AssociationStatusAggregatedCountT&& value) {
    m_associationStatusAggregatedCountHasBeenSet = true;
    m_associationStatusAggregatedCount = std::forward<AssociationStatusAggregatedCountT>(value);
  }
  template <typename AssociationStatusAggregatedCountT = Aws::Map<Aws::String, int>>
  AssociationOverview& WithAssociationStatusAggregatedCount(AssociationStatusAggregatedCountT&& value) {
    SetAssociationStatusAggregatedCount(std::forward<AssociationStatusAggregatedCountT>(value));
    return *this;
  }
  inline AssociationOverview& AddAssociationStatusAggregatedCount(Aws::String key, int value) {
    m_associationStatusAggregatedCountHasBeenSet = true;
    m_associationStatusAggregatedCount.emplace(key, value);
    return *this;
  }
  ///@}
 private:
