...
class TargetLocation {
 public:
  ...
  void SetTargetLocationMaxConcurrency(TargetLocationMaxConcurrencyT&& value) {
    ...
    m_targetLocationMaxConcurrency = std::forward<TargetLocationMaxConcurrencyT>(value);
  }
  template <typename TargetLocationMaxConcurrencyT = Aws::String>
  TargetLocation& WithTargetLocationMaxConcurrency(TargetLocationMaxConcurrencyT&& value) {
    SetTargetLocationMaxConcurrency(std::forward<TargetLocationMaxConcurrencyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetLocationMaxErrors(TargetLocationMaxErrorsT&& value) {
    ...
    m_targetLocationMaxErrors = std::forward<TargetLocationMaxErrorsT>(value);
  }
  template <typename TargetLocationMaxErrorsT = Aws::String>
  TargetLocation& WithTargetLocationMaxErrors(TargetLocationMaxErrorsT&& value) {
    SetTargetLocationMaxErrors(std::forward<TargetLocationMaxErrorsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetLocationAlarmConfiguration(TargetLocationAlarmConfigurationT&& value) {
    ...
    m_targetLocationAlarmConfiguration = std::forward<TargetLocationAlarmConfigurationT>(value);
  }
  template <typename TargetLocationAlarmConfigurationT = AlarmConfiguration>
  TargetLocation& WithTargetLocationAlarmConfiguration(TargetLocationAlarmConfigurationT&& value) {
    SetTargetLocationAlarmConfiguration(std::forward<TargetLocationAlarmConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeChildOrganizationUnits(bool value) {
    ...
    m_includeChildOrganizationUnits = value;
  }
  inline TargetLocation& WithIncludeChildOrganizationUnits(bool value) {
    SetIncludeChildOrganizationUnits(value);
    return *this;
  }
  ///@}
  ...
  void SetExcludeAccounts(ExcludeAccountsT&& value) {
    ...
    m_excludeAccounts = std::forward<ExcludeAccountsT>(value);
  }
  template <typename ExcludeAccountsT = Aws::Vector<Aws::String>>
  TargetLocation& WithExcludeAccounts(ExcludeAccountsT&& value) {
    SetExcludeAccounts(std::forward<ExcludeAccountsT>(value));
    return *this;
  }
  template <typename ExcludeAccountsT = Aws::String>
  TargetLocation& AddExcludeAccounts(ExcludeAccountsT&& value) {
    m_excludeAccountsHasBeenSet = true;
    m_excludeAccounts.emplace_back(std::forward<ExcludeAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetsMaxConcurrency(TargetsMaxConcurrencyT&& value) {
    ...
    m_targetsMaxConcurrency = std::forward<TargetsMaxConcurrencyT>(value);
  }
  template <typename TargetsMaxConcurrencyT = Aws::String>
  TargetLocation& WithTargetsMaxConcurrency(TargetsMaxConcurrencyT&& value) {
    SetTargetsMaxConcurrency(std::forward<TargetsMaxConcurrencyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetsMaxErrors(TargetsMaxErrorsT&& value) {
    ...
    m_targetsMaxErrors = std::forward<TargetsMaxErrorsT>(value);
  }
  template <typename TargetsMaxErrorsT = Aws::String>
  TargetLocation& WithTargetsMaxErrors(TargetsMaxErrorsT&& value) {
    SetTargetsMaxErrors(std::forward<TargetsMaxErrorsT>(value));
    return *this;
  }
  ///@}
 private:
