...
class OpsFilter {
 public:
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  OpsFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  OpsFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetType(OpsFilterOperatorType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline OpsFilter& WithType(OpsFilterOperatorType value) {
    SetType(value);
    return *this;
  }
  ///@}
