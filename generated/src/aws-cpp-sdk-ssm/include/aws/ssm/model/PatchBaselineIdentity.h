...
class PatchBaselineIdentity {
 public:
  ...
  void SetBaselineName(BaselineNameT&& value) {
    ...
    m_baselineName = std::forward<BaselineNameT>(value);
  }
  template <typename BaselineNameT = Aws::String>
  PatchBaselineIdentity& WithBaselineName(BaselineNameT&& value) {
    SetBaselineName(std::forward<BaselineNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline PatchBaselineIdentity& WithOperatingSystem(OperatingSystem value) {
  ...
  void SetBaselineDescription(BaselineDescriptionT&& value) {
    ...
    m_baselineDescription = std::forward<BaselineDescriptionT>(value);
  }
  template <typename BaselineDescriptionT = Aws::String>
  PatchBaselineIdentity& WithBaselineDescription(BaselineDescriptionT&& value) {
    SetBaselineDescription(std::forward<BaselineDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultBaseline(bool value) {
    m_defaultBaselineHasBeenSet = true;
    m_defaultBaseline = value;
  }
  inline PatchBaselineIdentity& WithDefaultBaseline(bool value) {
    SetDefaultBaseline(value);
    return *this;
  }
  ///@}
 private:
