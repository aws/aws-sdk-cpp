...
class OpsItemRelatedItemAlreadyExistsException {
 public:
  ...
  template <typename MessageT = Aws::String>
  OpsItemRelatedItemAlreadyExistsException& WithMessage(MessageT&& value) {
  ...
  template <typename ResourceUriT = Aws::String>
  OpsItemRelatedItemAlreadyExistsException& WithResourceUri(ResourceUriT&& value) {
  ...
  template <typename OpsItemIdT = Aws::String>
  OpsItemRelatedItemAlreadyExistsException& WithOpsItemId(OpsItemIdT&& value) {
