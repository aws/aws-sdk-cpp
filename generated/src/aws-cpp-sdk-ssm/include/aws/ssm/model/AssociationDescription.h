...
class AssociationDescription {
 public:
  ...
  void SetLastUpdateAssociationDate(LastUpdateAssociationDateT&& value) {
    ...
    m_lastUpdateAssociationDate = std::forward<LastUpdateAssociationDateT>(value);
  }
  template <typename LastUpdateAssociationDateT = Aws::Utils::DateTime>
  AssociationDescription& WithLastUpdateAssociationDate(LastUpdateAssociationDateT&& value) {
    SetLastUpdateAssociationDate(std::forward<LastUpdateAssociationDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline AssociationDescription& WithComplianceSeverity(AssociationComplianceSeverity value) {
  ...
  inline AssociationDescription& WithSyncCompliance(AssociationSyncCompliance value) {
  ...
  inline AssociationDescription& WithApplyOnlyAtCronInterval(bool value) {
  ...
  inline AssociationDescription& WithScheduleOffset(int value) {
  ...
  inline AssociationDescription& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  template <typename AssociationDispatchAssumeRoleT = Aws::String>
  AssociationDescription& WithAssociationDispatchAssumeRole(AssociationDispatchAssumeRoleT&& value) {
