...
class DescribeMaintenanceWindowExecutionTasksRequest : public SSMRequest {
 public:
  ...
  template <typename WindowExecutionIdT = Aws::String>
  DescribeMaintenanceWindowExecutionTasksRequest& WithWindowExecutionId(WindowExecutionIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<MaintenanceWindowFilter>>
  DescribeMaintenanceWindowExecutionTasksRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = MaintenanceWindowFilter>
  DescribeMaintenanceWindowExecutionTasksRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeMaintenanceWindowExecutionTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMaintenanceWindowExecutionTasksRequest& WithNextToken(NextTokenT&& value) {
