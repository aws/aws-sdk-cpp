...
class DescribeMaintenanceWindowScheduleResult {
 public:
  ...
  void SetScheduledWindowExecutions(ScheduledWindowExecutionsT&& value) {
    ...
    m_scheduledWindowExecutions = std::forward<ScheduledWindowExecutionsT>(value);
  }
  template <typename ScheduledWindowExecutionsT = Aws::Vector<ScheduledWindowExecution>>
  DescribeMaintenanceWindowScheduleResult& WithScheduledWindowExecutions(ScheduledWindowExecutionsT&& value) {
    SetScheduledWindowExecutions(std::forward<ScheduledWindowExecutionsT>(value));
    return *this;
  }
  ...
  DescribeMaintenanceWindowScheduleResult& AddScheduledWindowExecutions(ScheduledWindowExecutionsT&& value) {
    m_scheduledWindowExecutionsHasBeenSet = true;
    m_scheduledWindowExecutions.emplace_back(std::forward<ScheduledWindowExecutionsT>(value));
    return *this;
  }
  ///@}
