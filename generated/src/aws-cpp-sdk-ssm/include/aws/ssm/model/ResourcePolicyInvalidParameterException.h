...
class ResourcePolicyInvalidParameterException {
 public:
  ...
  template <typename ParameterNamesT = Aws::Vector<Aws::String>>
  ResourcePolicyInvalidParameterException& WithParameterNames(ParameterNamesT&& value) {
    SetParameterNames(std::forward<ParameterNamesT>(value));
    return *this;
  }
  template <typename ParameterNamesT = Aws::String>
  ResourcePolicyInvalidParameterException& AddParameterNames(ParameterNamesT&& value) {
    m_parameterNamesHasBeenSet = true;
  ...
  template <typename MessageT = Aws::String>
  ResourcePolicyInvalidParameterException& WithMessage(MessageT&& value) {
