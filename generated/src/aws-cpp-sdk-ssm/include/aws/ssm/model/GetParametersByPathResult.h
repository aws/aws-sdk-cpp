...
class GetParametersByPathResult {
 public:
  AWS_SSM_API GetParametersByPathResult() = default;
  ...
  template <typename ParametersT = Aws::Vector<Parameter>>
  GetParametersByPathResult& WithParameters(ParametersT&& value) {
    SetParameters(std::forward<ParametersT>(value));
    return *this;
  }
  template <typename ParametersT = Parameter>
  GetParametersByPathResult& AddParameters(ParametersT&& value) {
    m_parametersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetParametersByPathResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetParametersByPathResult& WithRequestId(RequestIdT&& value) {
