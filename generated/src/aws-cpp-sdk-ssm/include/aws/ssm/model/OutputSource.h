...
class OutputSource {
 public:
  ...
  void SetOutputSourceId(OutputSourceIdT&& value) {
    m_outputSourceIdHasBeenSet = true;
    m_outputSourceId = std::forward<OutputSourceIdT>(value);
  }
  template <typename OutputSourceIdT = Aws::String>
  OutputSource& WithOutputSourceId(OutputSourceIdT&& value) {
    SetOutputSourceId(std::forward<OutputSourceIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputSourceType(OutputSourceTypeT&& value) {
    m_outputSourceTypeHasBeenSet = true;
    m_outputSourceType = std::forward<OutputSourceTypeT>(value);
  }
  template <typename OutputSourceTypeT = Aws::String>
  OutputSource& WithOutputSourceType(OutputSourceTypeT&& value) {
    SetOutputSourceType(std::forward<OutputSourceTypeT>(value));
    return *this;
  }
  ///@}
 private:
