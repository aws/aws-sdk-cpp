...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API DeleteMaintenanceWindowRequest() = default;
    ...
    template<typename WindowIdT = Aws::String>
    DeleteMaintenanceWindowRequest& WithWindowId(WindowIdT&& value) { SetWindowId(std::forward<WindowIdT>(value)); return *this;}
    ///@}
  private:
