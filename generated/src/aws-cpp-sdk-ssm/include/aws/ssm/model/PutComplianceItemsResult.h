...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API PutComplianceItemsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutComplianceItemsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
