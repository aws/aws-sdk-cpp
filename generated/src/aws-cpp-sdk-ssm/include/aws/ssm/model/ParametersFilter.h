...
class ParametersFilter {
 public:
  ...
  inline void SetKey(ParametersFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline ParametersFilter& WithKey(ParametersFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ParametersFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ParametersFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
