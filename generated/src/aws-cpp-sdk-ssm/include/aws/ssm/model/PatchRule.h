...
class PatchRule {
 public:
  ...
  void SetPatchFilterGroup(PatchFilterGroupT&& value) {
    ...
    m_patchFilterGroup = std::forward<PatchFilterGroupT>(value);
  }
  template <typename PatchFilterGroupT = PatchFilterGroup>
  PatchRule& WithPatchFilterGroup(PatchFilterGroupT&& value) {
    SetPatchFilterGroup(std::forward<PatchFilterGroupT>(value));
    return *this;
  }
  ///@}
  ...
  inline PatchRule& WithComplianceLevel(PatchComplianceLevel value) {
  ...
  inline void SetApproveAfterDays(int value) {
    m_approveAfterDaysHasBeenSet = true;
    m_approveAfterDays = value;
  }
  inline PatchRule& WithApproveAfterDays(int value) {
    SetApproveAfterDays(value);
    return *this;
  }
  ///@}
  ...
  void SetApproveUntilDate(ApproveUntilDateT&& value) {
    ...
    m_approveUntilDate = std::forward<ApproveUntilDateT>(value);
  }
  template <typename ApproveUntilDateT = Aws::String>
  PatchRule& WithApproveUntilDate(ApproveUntilDateT&& value) {
    SetApproveUntilDate(std::forward<ApproveUntilDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEnableNonSecurity(bool value) {
    m_enableNonSecurityHasBeenSet = true;
    m_enableNonSecurity = value;
  }
  inline PatchRule& WithEnableNonSecurity(bool value) {
    SetEnableNonSecurity(value);
    return *this;
  }
  ///@}
 private:
