...
class DescribePatchBaselinesResult {
 public:
  ...
  void SetBaselineIdentities(BaselineIdentitiesT&& value) {
    m_baselineIdentitiesHasBeenSet = true;
    m_baselineIdentities = std::forward<BaselineIdentitiesT>(value);
  }
  template <typename BaselineIdentitiesT = Aws::Vector<PatchBaselineIdentity>>
  DescribePatchBaselinesResult& WithBaselineIdentities(BaselineIdentitiesT&& value) {
    SetBaselineIdentities(std::forward<BaselineIdentitiesT>(value));
    return *this;
  }
  template <typename BaselineIdentitiesT = PatchBaselineIdentity>
  DescribePatchBaselinesResult& AddBaselineIdentities(BaselineIdentitiesT&& value) {
    m_baselineIdentitiesHasBeenSet = true;
    m_baselineIdentities.emplace_back(std::forward<BaselineIdentitiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribePatchBaselinesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribePatchBaselinesResult& WithRequestId(RequestIdT&& value) {
