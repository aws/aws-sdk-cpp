...
class RegisterTargetWithMaintenanceWindowResult {
 public:
  ...
  template <typename WindowTargetIdT = Aws::String>
  RegisterTargetWithMaintenanceWindowResult& WithWindowTargetId(WindowTargetIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RegisterTargetWithMaintenanceWindowResult& WithRequestId(RequestIdT&& value) {
