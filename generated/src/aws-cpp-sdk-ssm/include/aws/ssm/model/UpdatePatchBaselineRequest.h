...
class UpdatePatchBaselineRequest : public SSMRequest {
 public:
  ...
  inline UpdatePatchBaselineRequest& WithApprovedPatchesComplianceLevel(PatchComplianceLevel value) {
  ...
  inline UpdatePatchBaselineRequest& WithApprovedPatchesEnableNonSecurity(bool value) {
  ...
  inline UpdatePatchBaselineRequest& WithRejectedPatchesAction(PatchAction value) {
  ...
  inline UpdatePatchBaselineRequest& WithAvailableSecurityUpdatesComplianceStatus(PatchComplianceStatus value) {
  ...
  inline UpdatePatchBaselineRequest& WithReplace(bool value) {
    SetReplace(value);
    return *this;
  }
  ///@}
