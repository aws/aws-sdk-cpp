...
class DescribeOpsItemsRequest : public SSMRequest {
 public:
  ...
  void SetOpsItemFilters(OpsItemFiltersT&& value) {
    m_opsItemFiltersHasBeenSet = true;
    m_opsItemFilters = std::forward<OpsItemFiltersT>(value);
  }
  template <typename OpsItemFiltersT = Aws::Vector<OpsItemFilter>>
  DescribeOpsItemsRequest& WithOpsItemFilters(OpsItemFiltersT&& value) {
    SetOpsItemFilters(std::forward<OpsItemFiltersT>(value));
    return *this;
  }
  template <typename OpsItemFiltersT = OpsItemFilter>
  DescribeOpsItemsRequest& AddOpsItemFilters(OpsItemFiltersT&& value) {
    m_opsItemFiltersHasBeenSet = true;
    m_opsItemFilters.emplace_back(std::forward<OpsItemFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeOpsItemsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
