...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API DeleteResourceDataSyncResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteResourceDataSyncResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
