...
class DeregisterPatchBaselineForPatchGroupRequest : public SSMRequest {
 public:
  ...
  template <typename BaselineIdT = Aws::String>
  DeregisterPatchBaselineForPatchGroupRequest& WithBaselineId(BaselineIdT&& value) {
  ...
  template <typename PatchGroupT = Aws::String>
  DeregisterPatchBaselineForPatchGroupRequest& WithPatchGroup(PatchGroupT&& value) {
