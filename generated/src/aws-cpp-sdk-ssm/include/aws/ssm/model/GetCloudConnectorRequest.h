...
/**
 */
class GetCloudConnectorRequest : public SSMRequest {
 public:
  AWS_SSM_API GetCloudConnectorRequest() = default;
  ...
  template <typename CloudConnectorIdT = Aws::String>
  GetCloudConnectorRequest& WithCloudConnectorId(CloudConnectorIdT&& value) {
