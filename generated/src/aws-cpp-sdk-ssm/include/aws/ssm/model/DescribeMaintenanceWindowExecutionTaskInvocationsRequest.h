...
class DescribeMaintenanceWindowExecutionTaskInvocationsRequest : public SSMRequest {
 public:
  ...
  template <typename WindowExecutionIdT = Aws::String>
  DescribeMaintenanceWindowExecutionTaskInvocationsRequest& WithWindowExecutionId(WindowExecutionIdT&& value) {
  ...
  template <typename TaskIdT = Aws::String>
  DescribeMaintenanceWindowExecutionTaskInvocationsRequest& WithTaskId(TaskIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<MaintenanceWindowFilter>>
  DescribeMaintenanceWindowExecutionTaskInvocationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = MaintenanceWindowFilter>
  DescribeMaintenanceWindowExecutionTaskInvocationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeMaintenanceWindowExecutionTaskInvocationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMaintenanceWindowExecutionTaskInvocationsRequest& WithNextToken(NextTokenT&& value) {
