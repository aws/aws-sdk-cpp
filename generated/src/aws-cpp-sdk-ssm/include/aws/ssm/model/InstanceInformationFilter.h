...
class InstanceInformationFilter {
 public:
  ...
  inline void SetKey(InstanceInformationFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline InstanceInformationFilter& WithKey(InstanceInformationFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueSetT = Aws::Vector<Aws::String>>
  InstanceInformationFilter& WithValueSet(ValueSetT&& value) {
    SetValueSet(std::forward<ValueSetT>(value));
    return *this;
  }
  template <typename ValueSetT = Aws::String>
  InstanceInformationFilter& AddValueSet(ValueSetT&& value) {
    m_valueSetHasBeenSet = true;
