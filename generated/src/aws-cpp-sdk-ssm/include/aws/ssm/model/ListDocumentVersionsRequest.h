...
class ListDocumentVersionsRequest : public SSMRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  ListDocumentVersionsRequest& WithName(NameT&& value) {
  ...
  inline ListDocumentVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDocumentVersionsRequest& WithNextToken(NextTokenT&& value) {
