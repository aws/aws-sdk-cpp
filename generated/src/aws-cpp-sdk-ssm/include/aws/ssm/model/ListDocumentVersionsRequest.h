...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API ListDocumentVersionsRequest() = default;
    ...
    template<typename NameT = Aws::String>
    ListDocumentVersionsRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListDocumentVersionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
