...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API UpdateManagedInstanceRoleResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateManagedInstanceRoleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
