...
class DescribeMaintenanceWindowScheduleRequest : public SSMRequest {
 public:
  ...
  template <typename WindowIdT = Aws::String>
  DescribeMaintenanceWindowScheduleRequest& WithWindowId(WindowIdT&& value) {
  ...
  template <typename TargetsT = Aws::Vector<Target>>
  DescribeMaintenanceWindowScheduleRequest& WithTargets(TargetsT&& value) {
    SetTargets(std::forward<TargetsT>(value));
    return *this;
  }
  template <typename TargetsT = Target>
  DescribeMaintenanceWindowScheduleRequest& AddTargets(TargetsT&& value) {
    m_targetsHasBeenSet = true;
  ...
  inline void SetResourceType(MaintenanceWindowResourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline DescribeMaintenanceWindowScheduleRequest& WithResourceType(MaintenanceWindowResourceType value) {
  ...
  template <typename FiltersT = Aws::Vector<PatchOrchestratorFilter>>
  DescribeMaintenanceWindowScheduleRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = PatchOrchestratorFilter>
  DescribeMaintenanceWindowScheduleRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeMaintenanceWindowScheduleRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMaintenanceWindowScheduleRequest& WithNextToken(NextTokenT&& value) {
