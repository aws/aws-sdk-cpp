...
class GetInventorySchemaRequest : public SSMRequest {
 public:
  ...
  inline GetInventorySchemaRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAggregator(bool value) {
    m_aggregatorHasBeenSet = true;
    m_aggregator = value;
  }
  inline GetInventorySchemaRequest& WithAggregator(bool value) {
    SetAggregator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSubType(bool value) {
    m_subTypeHasBeenSet = true;
    m_subType = value;
  }
  inline GetInventorySchemaRequest& WithSubType(bool value) {
    SetSubType(value);
    return *this;
  }
  ///@}
