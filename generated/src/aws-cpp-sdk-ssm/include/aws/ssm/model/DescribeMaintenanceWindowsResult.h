...
class DescribeMaintenanceWindowsResult {
 public:
  ...
  void SetWindowIdentities(WindowIdentitiesT&& value) {
    m_windowIdentitiesHasBeenSet = true;
    m_windowIdentities = std::forward<WindowIdentitiesT>(value);
  }
  template <typename WindowIdentitiesT = Aws::Vector<MaintenanceWindowIdentity>>
  DescribeMaintenanceWindowsResult& WithWindowIdentities(WindowIdentitiesT&& value) {
    SetWindowIdentities(std::forward<WindowIdentitiesT>(value));
    return *this;
  }
  template <typename WindowIdentitiesT = MaintenanceWindowIdentity>
  DescribeMaintenanceWindowsResult& AddWindowIdentities(WindowIdentitiesT&& value) {
    m_windowIdentitiesHasBeenSet = true;
    m_windowIdentities.emplace_back(std::forward<WindowIdentitiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMaintenanceWindowsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMaintenanceWindowsResult& WithRequestId(RequestIdT&& value) {
