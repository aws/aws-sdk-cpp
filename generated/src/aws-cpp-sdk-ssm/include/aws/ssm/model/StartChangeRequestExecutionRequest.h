...
class StartChangeRequestExecutionRequest : public SSMRequest {
 public:
  ...
  inline void SetAutoApprove(bool value) {
    m_autoApproveHasBeenSet = true;
    m_autoApprove = value;
  }
  inline StartChangeRequestExecutionRequest& WithAutoApprove(bool value) {
  ...
  void SetScheduledEndTime(ScheduledEndTimeT&& value) {
    m_scheduledEndTimeHasBeenSet = true;
    m_scheduledEndTime = std::forward<ScheduledEndTimeT>(value);
  }
  template <typename ScheduledEndTimeT = Aws::Utils::DateTime>
  StartChangeRequestExecutionRequest& WithScheduledEndTime(ScheduledEndTimeT&& value) {
    SetScheduledEndTime(std::forward<ScheduledEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetChangeDetails(ChangeDetailsT&& value) {
    m_changeDetailsHasBeenSet = true;
    m_changeDetails = std::forward<ChangeDetailsT>(value);
  }
  template <typename ChangeDetailsT = Aws::String>
  StartChangeRequestExecutionRequest& WithChangeDetails(ChangeDetailsT&& value) {
    SetChangeDetails(std::forward<ChangeDetailsT>(value));
    return *this;
  }
  ///@}
 private:
