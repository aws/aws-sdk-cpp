...
class DescribeInstanceInformationRequest : public SSMRequest {
 public:
  ...
  void SetInstanceInformationFilterList(InstanceInformationFilterListT&& value) {
    m_instanceInformationFilterListHasBeenSet = true;
    m_instanceInformationFilterList = std::forward<InstanceInformationFilterListT>(value);
  }
  template <typename InstanceInformationFilterListT = Aws::Vector<InstanceInformationFilter>>
  DescribeInstanceInformationRequest& WithInstanceInformationFilterList(InstanceInformationFilterListT&& value) {
    SetInstanceInformationFilterList(std::forward<InstanceInformationFilterListT>(value));
    return *this;
  }
  template <typename InstanceInformationFilterListT = InstanceInformationFilter>
  DescribeInstanceInformationRequest& AddInstanceInformationFilterList(InstanceInformationFilterListT&& value) {
    m_instanceInformationFilterListHasBeenSet = true;
    m_instanceInformationFilterList.emplace_back(std::forward<InstanceInformationFilterListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<InstanceInformationStringFilter>>
  DescribeInstanceInformationRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = InstanceInformationStringFilter>
  DescribeInstanceInformationRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeInstanceInformationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstanceInformationRequest& WithNextToken(NextTokenT&& value) {
