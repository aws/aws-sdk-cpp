...
class ParentStepDetails {
 public:
  ...
  inline void SetIteration(int value) {
    m_iterationHasBeenSet = true;
    m_iteration = value;
  }
  inline ParentStepDetails& WithIteration(int value) {
    SetIteration(value);
    return *this;
  }
  ///@}
  ...
  void SetIteratorValue(IteratorValueT&& value) {
    ...
    m_iteratorValue = std::forward<IteratorValueT>(value);
  }
  template <typename IteratorValueT = Aws::String>
  ParentStepDetails& WithIteratorValue(IteratorValueT&& value) {
    SetIteratorValue(std::forward<IteratorValueT>(value));
    return *this;
  }
  ///@}
 private:
