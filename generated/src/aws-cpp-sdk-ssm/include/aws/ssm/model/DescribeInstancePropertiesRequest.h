...
class DescribeInstancePropertiesRequest : public SSMRequest {
 public:
  ...
  void SetInstancePropertyFilterList(InstancePropertyFilterListT&& value) {
    m_instancePropertyFilterListHasBeenSet = true;
    m_instancePropertyFilterList = std::forward<InstancePropertyFilterListT>(value);
  }
  template <typename InstancePropertyFilterListT = Aws::Vector<InstancePropertyFilter>>
  DescribeInstancePropertiesRequest& WithInstancePropertyFilterList(InstancePropertyFilterListT&& value) {
    SetInstancePropertyFilterList(std::forward<InstancePropertyFilterListT>(value));
    return *this;
  }
  template <typename InstancePropertyFilterListT = InstancePropertyFilter>
  DescribeInstancePropertiesRequest& AddInstancePropertyFilterList(InstancePropertyFilterListT&& value) {
    m_instancePropertyFilterListHasBeenSet = true;
    m_instancePropertyFilterList.emplace_back(std::forward<InstancePropertyFilterListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFiltersWithOperator(FiltersWithOperatorT&& value) {
    m_filtersWithOperatorHasBeenSet = true;
    m_filtersWithOperator = std::forward<FiltersWithOperatorT>(value);
  }
  template <typename FiltersWithOperatorT = Aws::Vector<InstancePropertyStringFilter>>
  DescribeInstancePropertiesRequest& WithFiltersWithOperator(FiltersWithOperatorT&& value) {
    SetFiltersWithOperator(std::forward<FiltersWithOperatorT>(value));
    return *this;
  }
  template <typename FiltersWithOperatorT = InstancePropertyStringFilter>
  DescribeInstancePropertiesRequest& AddFiltersWithOperator(FiltersWithOperatorT&& value) {
    m_filtersWithOperatorHasBeenSet = true;
    m_filtersWithOperator.emplace_back(std::forward<FiltersWithOperatorT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeInstancePropertiesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstancePropertiesRequest& WithNextToken(NextTokenT&& value) {
