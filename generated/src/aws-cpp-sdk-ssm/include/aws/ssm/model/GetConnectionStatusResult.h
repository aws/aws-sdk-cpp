...
class GetConnectionStatusResult {
 public:
  ...
  template <typename TargetT = Aws::String>
  GetConnectionStatusResult& WithTarget(TargetT&& value) {
  ...
  inline GetConnectionStatusResult& WithStatus(ConnectionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetConnectionStatusResult& WithRequestId(RequestIdT&& value) {
