...
class DeleteInventoryRequest : public SSMRequest {
 public:
  ...
  inline void SetSchemaDeleteOption(InventorySchemaDeleteOption value) {
    m_schemaDeleteOptionHasBeenSet = true;
    m_schemaDeleteOption = value;
  }
  inline DeleteInventoryRequest& WithSchemaDeleteOption(InventorySchemaDeleteOption value) {
    SetSchemaDeleteOption(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteInventoryRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
