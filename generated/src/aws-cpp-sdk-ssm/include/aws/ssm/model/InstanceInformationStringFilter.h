...
class InstanceInformationStringFilter {
 public:
   ...
   * <code>PlatformTypes</code> filter key: Windows | Linux | MacOS</p> </li> <li>
   ...
   * Microsoft.Compute/virtualMachines</p> </li> <li> <p>Valid tag examples:
   * <code>Key=tag-key,Values=Purpose</code> |
  ...
  template <typename KeyT = Aws::String>
  InstanceInformationStringFilter& WithKey(KeyT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  InstanceInformationStringFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  InstanceInformationStringFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
