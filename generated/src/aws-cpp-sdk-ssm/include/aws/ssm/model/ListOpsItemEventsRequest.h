...
class ListOpsItemEventsRequest : public SSMRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<OpsItemEventFilter>>
  ListOpsItemEventsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = OpsItemEventFilter>
  ListOpsItemEventsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListOpsItemEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOpsItemEventsRequest& WithNextToken(NextTokenT&& value) {
