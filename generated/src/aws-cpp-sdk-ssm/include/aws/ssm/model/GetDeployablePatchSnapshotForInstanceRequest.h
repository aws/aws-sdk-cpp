...
class GetDeployablePatchSnapshotForInstanceRequest : public SSMRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  GetDeployablePatchSnapshotForInstanceRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename SnapshotIdT = Aws::String>
  GetDeployablePatchSnapshotForInstanceRequest& WithSnapshotId(SnapshotIdT&& value) {
  ...
  void SetBaselineOverride(BaselineOverrideT&& value) {
    m_baselineOverrideHasBeenSet = true;
    m_baselineOverride = std::forward<BaselineOverrideT>(value);
  }
  template <typename BaselineOverrideT = BaselineOverride>
  GetDeployablePatchSnapshotForInstanceRequest& WithBaselineOverride(BaselineOverrideT&& value) {
    SetBaselineOverride(std::forward<BaselineOverrideT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUseS3DualStackEndpoint(bool value) {
    m_useS3DualStackEndpointHasBeenSet = true;
    m_useS3DualStackEndpoint = value;
  }
  inline GetDeployablePatchSnapshotForInstanceRequest& WithUseS3DualStackEndpoint(bool value) {
    SetUseS3DualStackEndpoint(value);
    return *this;
  }
  ///@}
 private:
