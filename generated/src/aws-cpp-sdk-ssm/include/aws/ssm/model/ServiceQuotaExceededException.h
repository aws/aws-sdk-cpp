...
namespace Model
{
  ...
  /**
   * <p>The request exceeds the service quota. Service quotas, also referred to as
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/ssm-2014-11-06/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
