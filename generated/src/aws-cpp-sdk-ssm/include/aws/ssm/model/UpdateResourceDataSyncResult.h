...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API UpdateResourceDataSyncResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateResourceDataSyncResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
