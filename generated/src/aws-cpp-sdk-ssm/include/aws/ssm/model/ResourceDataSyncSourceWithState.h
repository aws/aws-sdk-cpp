...
class ResourceDataSyncSourceWithState {
 public:
  ...
  inline ResourceDataSyncSourceWithState& WithIncludeFutureRegions(bool value) {
  ...
  inline ResourceDataSyncSourceWithState& WithEnableAllOpsDataSources(bool value) {
