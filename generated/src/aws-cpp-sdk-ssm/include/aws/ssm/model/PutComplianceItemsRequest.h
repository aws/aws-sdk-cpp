...
class PutComplianceItemsRequest : public SSMRequest {
 public:
  ...
  void SetItemContentHash(ItemContentHashT&& value) {
    m_itemContentHashHasBeenSet = true;
    m_itemContentHash = std::forward<ItemContentHashT>(value);
  }
  template <typename ItemContentHashT = Aws::String>
  PutComplianceItemsRequest& WithItemContentHash(ItemContentHashT&& value) {
    SetItemContentHash(std::forward<ItemContentHashT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUploadType(ComplianceUploadType value) {
    m_uploadTypeHasBeenSet = true;
    m_uploadType = value;
  }
  inline PutComplianceItemsRequest& WithUploadType(ComplianceUploadType value) {
    SetUploadType(value);
    return *this;
  }
  ///@}
