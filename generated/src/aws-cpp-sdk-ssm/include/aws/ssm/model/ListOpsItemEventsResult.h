...
class ListOpsItemEventsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListOpsItemEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SummariesT = Aws::Vector<OpsItemEventSummary>>
  ListOpsItemEventsResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = OpsItemEventSummary>
  ListOpsItemEventsResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListOpsItemEventsResult& WithRequestId(RequestIdT&& value) {
