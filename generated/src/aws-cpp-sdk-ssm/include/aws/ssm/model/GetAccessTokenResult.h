...
class GetAccessTokenResult {
 public:
  ...
  template <typename CredentialsT = Credentials>
  GetAccessTokenResult& WithCredentials(CredentialsT&& value) {
  ...
  inline void SetAccessRequestStatus(AccessRequestStatus value) {
    m_accessRequestStatusHasBeenSet = true;
    m_accessRequestStatus = value;
  }
  inline GetAccessTokenResult& WithAccessRequestStatus(AccessRequestStatus value) {
    SetAccessRequestStatus(value);
    return *this;
  }
  ///@}
