...
class UpdateOpsItemRequest : public SSMRequest {
 public:
  ...
  void SetOperationalDataToDelete(OperationalDataToDeleteT&& value) {
    m_operationalDataToDeleteHasBeenSet = true;
    m_operationalDataToDelete = std::forward<OperationalDataToDeleteT>(value);
  }
  template <typename OperationalDataToDeleteT = Aws::Vector<Aws::String>>
  UpdateOpsItemRequest& WithOperationalDataToDelete(OperationalDataToDeleteT&& value) {
    SetOperationalDataToDelete(std::forward<OperationalDataToDeleteT>(value));
    return *this;
  }
  ...
  UpdateOpsItemRequest& AddOperationalDataToDelete(OperationalDataToDeleteT&& value) {
    m_operationalDataToDeleteHasBeenSet = true;
    m_operationalDataToDelete.emplace_back(std::forward<OperationalDataToDeleteT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateOpsItemRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateOpsItemRequest& WithStatus(OpsItemStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
