...
class DescribeMaintenanceWindowExecutionsResult {
 public:
  ...
  void SetWindowExecutions(WindowExecutionsT&& value) {
    ...
    m_windowExecutions = std::forward<WindowExecutionsT>(value);
  }
  template <typename WindowExecutionsT = Aws::Vector<MaintenanceWindowExecution>>
  DescribeMaintenanceWindowExecutionsResult& WithWindowExecutions(WindowExecutionsT&& value) {
    SetWindowExecutions(std::forward<WindowExecutionsT>(value));
    return *this;
  }
  ...
  DescribeMaintenanceWindowExecutionsResult& AddWindowExecutions(WindowExecutionsT&& value) {
    m_windowExecutionsHasBeenSet = true;
    m_windowExecutions.emplace_back(std::forward<WindowExecutionsT>(value));
    return *this;
  }
  ///@}
