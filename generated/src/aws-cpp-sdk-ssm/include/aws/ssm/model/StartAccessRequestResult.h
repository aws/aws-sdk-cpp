...
class StartAccessRequestResult {
 public:
  ...
  void SetAccessRequestId(AccessRequestIdT&& value) {
    m_accessRequestIdHasBeenSet = true;
    m_accessRequestId = std::forward<AccessRequestIdT>(value);
  }
  template <typename AccessRequestIdT = Aws::String>
  StartAccessRequestResult& WithAccessRequestId(AccessRequestIdT&& value) {
    SetAccessRequestId(std::forward<AccessRequestIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartAccessRequestResult& WithRequestId(RequestIdT&& value) {
