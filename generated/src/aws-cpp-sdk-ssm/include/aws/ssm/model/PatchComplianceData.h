...
class PatchComplianceData {
 public:
  ...
  void SetKBId(KBIdT&& value) {
    m_kBIdHasBeenSet = true;
    m_kBId = std::forward<KBIdT>(value);
  }
  template <typename KBIdT = Aws::String>
  PatchComplianceData& WithKBId(KBIdT&& value) {
    SetKBId(std::forward<KBIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(PatchComplianceDataState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline PatchComplianceData& WithState(PatchComplianceDataState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetInstalledTime(InstalledTimeT&& value) {
    ...
    m_installedTime = std::forward<InstalledTimeT>(value);
  }
  template <typename InstalledTimeT = Aws::Utils::DateTime>
  PatchComplianceData& WithInstalledTime(InstalledTimeT&& value) {
    SetInstalledTime(std::forward<InstalledTimeT>(value));
    return *this;
  }
  ///@}
