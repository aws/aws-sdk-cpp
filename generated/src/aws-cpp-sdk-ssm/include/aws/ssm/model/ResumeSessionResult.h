...
class ResumeSessionResult {
 public:
  ...
  template <typename SessionIdT = Aws::String>
  ResumeSessionResult& WithSessionId(SessionIdT&& value) {
  ...
  template <typename TokenValueT = Aws::String>
  ResumeSessionResult& WithTokenValue(TokenValueT&& value) {
  ...
  template <typename StreamUrlT = Aws::String>
  ResumeSessionResult& WithStreamUrl(StreamUrlT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ResumeSessionResult& WithRequestId(RequestIdT&& value) {
