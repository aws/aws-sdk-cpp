...
class DescribeDocumentPermissionResult {
 public:
  ...
  void SetAccountSharingInfoList(AccountSharingInfoListT&& value) {
    ...
    m_accountSharingInfoList = std::forward<AccountSharingInfoListT>(value);
  }
  template <typename AccountSharingInfoListT = Aws::Vector<AccountSharingInfo>>
  DescribeDocumentPermissionResult& WithAccountSharingInfoList(AccountSharingInfoListT&& value) {
    SetAccountSharingInfoList(std::forward<AccountSharingInfoListT>(value));
    return *this;
  }
  ...
  DescribeDocumentPermissionResult& AddAccountSharingInfoList(AccountSharingInfoListT&& value) {
    m_accountSharingInfoListHasBeenSet = true;
    m_accountSharingInfoList.emplace_back(std::forward<AccountSharingInfoListT>(value));
    return *this;
  }
  ///@}
