...
class PutParameterRequest : public SSMRequest {
 public:
  ...
  inline PutParameterRequest& WithType(ParameterType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline PutParameterRequest& WithOverwrite(bool value) {
    SetOverwrite(value);
    return *this;
  }
  ///@}
  ...
  inline PutParameterRequest& WithTier(ParameterTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
