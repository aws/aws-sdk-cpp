...
class DescribeParametersRequest : public SSMRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<ParametersFilter>>
  DescribeParametersRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ParametersFilter>
  DescribeParametersRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename ParameterFiltersT = Aws::Vector<ParameterStringFilter>>
  DescribeParametersRequest& WithParameterFilters(ParameterFiltersT&& value) {
    SetParameterFilters(std::forward<ParameterFiltersT>(value));
    return *this;
  }
  template <typename ParameterFiltersT = ParameterStringFilter>
  DescribeParametersRequest& AddParameterFilters(ParameterFiltersT&& value) {
    m_parameterFiltersHasBeenSet = true;
  ...
  inline DescribeParametersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeParametersRequest& WithShared(bool value) {
    SetShared(value);
    return *this;
  }
  ///@}
