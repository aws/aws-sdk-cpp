...
class DescribeMaintenanceWindowTargetsResult {
 public:
  AWS_SSM_API DescribeMaintenanceWindowTargetsResult() = default;
  ...
  template <typename TargetsT = Aws::Vector<MaintenanceWindowTarget>>
  void SetTargets(TargetsT&& value) {
    m_targetsHasBeenSet = true;
    m_targets = std::forward<TargetsT>(value);
  }
  template <typename TargetsT = Aws::Vector<MaintenanceWindowTarget>>
  DescribeMaintenanceWindowTargetsResult& WithTargets(TargetsT&& value) {
    SetTargets(std::forward<TargetsT>(value));
    return *this;
  }
  template <typename TargetsT = MaintenanceWindowTarget>
  DescribeMaintenanceWindowTargetsResult& AddTargets(TargetsT&& value) {
    m_targetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMaintenanceWindowTargetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMaintenanceWindowTargetsResult& WithRequestId(RequestIdT&& value) {
