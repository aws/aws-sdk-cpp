...
class DescribeMaintenanceWindowTasksRequest : public SSMRequest {
 public:
  ...
  template <typename WindowIdT = Aws::String>
  DescribeMaintenanceWindowTasksRequest& WithWindowId(WindowIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<MaintenanceWindowFilter>>
  DescribeMaintenanceWindowTasksRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = MaintenanceWindowFilter>
  DescribeMaintenanceWindowTasksRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeMaintenanceWindowTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMaintenanceWindowTasksRequest& WithNextToken(NextTokenT&& value) {
