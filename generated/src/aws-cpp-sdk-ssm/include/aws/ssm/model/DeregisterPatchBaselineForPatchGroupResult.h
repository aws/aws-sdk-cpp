...
class DeregisterPatchBaselineForPatchGroupResult {
 public:
  ...
  template <typename BaselineIdT = Aws::String>
  DeregisterPatchBaselineForPatchGroupResult& WithBaselineId(BaselineIdT&& value) {
  ...
  template <typename PatchGroupT = Aws::String>
  DeregisterPatchBaselineForPatchGroupResult& WithPatchGroup(PatchGroupT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeregisterPatchBaselineForPatchGroupResult& WithRequestId(RequestIdT&& value) {
