...
class Activation {
 public:
  ...
  void SetDefaultInstanceName(DefaultInstanceNameT&& value) {
    ...
    m_defaultInstanceName = std::forward<DefaultInstanceNameT>(value);
  }
  template <typename DefaultInstanceNameT = Aws::String>
  Activation& WithDefaultInstanceName(DefaultInstanceNameT&& value) {
    SetDefaultInstanceName(std::forward<DefaultInstanceNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRegistrationLimit(int value) {
    m_registrationLimitHasBeenSet = true;
    m_registrationLimit = value;
  }
  inline Activation& WithRegistrationLimit(int value) {
  ...
  inline void SetRegistrationsCount(int value) {
    m_registrationsCountHasBeenSet = true;
    m_registrationsCount = value;
  }
  inline Activation& WithRegistrationsCount(int value) {
    SetRegistrationsCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExpired(bool value) {
    m_expiredHasBeenSet = true;
    m_expired = value;
  }
  inline Activation& WithExpired(bool value) {
    SetExpired(value);
    return *this;
  }
  ///@}
