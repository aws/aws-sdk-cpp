...
class ListOpsMetadataRequest : public SSMRequest {
 public:
  AWS_SSM_API ListOpsMetadataRequest() = default;
  ...
  template <typename FiltersT = Aws::Vector<OpsMetadataFilter>>
  void SetFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
    m_filters = std::forward<FiltersT>(value);
  }
  template <typename FiltersT = Aws::Vector<OpsMetadataFilter>>
  ListOpsMetadataRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = OpsMetadataFilter>
  ListOpsMetadataRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListOpsMetadataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOpsMetadataRequest& WithNextToken(NextTokenT&& value) {
