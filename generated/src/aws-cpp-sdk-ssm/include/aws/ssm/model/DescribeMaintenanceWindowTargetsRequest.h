...
class DescribeMaintenanceWindowTargetsRequest : public SSMRequest {
 public:
  ...
  template <typename WindowIdT = Aws::String>
  DescribeMaintenanceWindowTargetsRequest& WithWindowId(WindowIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<MaintenanceWindowFilter>>
  DescribeMaintenanceWindowTargetsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = MaintenanceWindowFilter>
  DescribeMaintenanceWindowTargetsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeMaintenanceWindowTargetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMaintenanceWindowTargetsRequest& WithNextToken(NextTokenT&& value) {
