...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API DescribeInstanceAssociationsStatusRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeInstanceAssociationsStatusRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeInstanceAssociationsStatusRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
