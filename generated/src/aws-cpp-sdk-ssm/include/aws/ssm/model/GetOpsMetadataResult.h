...
class GetOpsMetadataResult {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  GetOpsMetadataResult& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename MetadataT = Aws::Map<Aws::String, MetadataValue>>
  GetOpsMetadataResult& WithMetadata(MetadataT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetOpsMetadataResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOpsMetadataResult& WithRequestId(RequestIdT&& value) {
