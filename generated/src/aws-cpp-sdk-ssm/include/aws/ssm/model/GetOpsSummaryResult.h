...
class GetOpsSummaryResult {
 public:
  ...
  template <typename EntitiesT = Aws::Vector<OpsEntity>>
  GetOpsSummaryResult& WithEntities(EntitiesT&& value) {
    SetEntities(std::forward<EntitiesT>(value));
    return *this;
  }
  template <typename EntitiesT = OpsEntity>
  GetOpsSummaryResult& AddEntities(EntitiesT&& value) {
    m_entitiesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetOpsSummaryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOpsSummaryResult& WithRequestId(RequestIdT&& value) {
