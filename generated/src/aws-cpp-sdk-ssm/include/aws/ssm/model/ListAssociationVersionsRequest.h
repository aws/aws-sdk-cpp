...
class ListAssociationVersionsRequest : public SSMRequest {
 public:
  ...
  template <typename AssociationIdT = Aws::String>
  ListAssociationVersionsRequest& WithAssociationId(AssociationIdT&& value) {
  ...
  inline ListAssociationVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociationVersionsRequest& WithNextToken(NextTokenT&& value) {
