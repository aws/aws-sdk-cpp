...
class InstanceAggregatedAssociationOverview {
 public:
  ...
  template <typename DetailedStatusT = Aws::String>
  InstanceAggregatedAssociationOverview& WithDetailedStatus(DetailedStatusT&& value) {
   ...
   */
  inline const Aws::Map<Aws::String, int>& GetInstanceAssociationStatusAggregatedCount() const {
    return m_instanceAssociationStatusAggregatedCount;
  }
  ...
  void SetInstanceAssociationStatusAggregatedCount(InstanceAssociationStatusAggregatedCountT&& value) {
    m_instanceAssociationStatusAggregatedCountHasBeenSet = true;
    m_instanceAssociationStatusAggregatedCount = std::forward<InstanceAssociationStatusAggregatedCountT>(value);
  }
  template <typename InstanceAssociationStatusAggregatedCountT = Aws::Map<Aws::String, int>>
  InstanceAggregatedAssociationOverview& WithInstanceAssociationStatusAggregatedCount(InstanceAssociationStatusAggregatedCountT&& value) {
    SetInstanceAssociationStatusAggregatedCount(std::forward<InstanceAssociationStatusAggregatedCountT>(value));
    return *this;
  }
  inline InstanceAggregatedAssociationOverview& AddInstanceAssociationStatusAggregatedCount(Aws::String key, int value) {
    m_instanceAssociationStatusAggregatedCountHasBeenSet = true;
    m_instanceAssociationStatusAggregatedCount.emplace(key, value);
    return *this;
  }
  ///@}
 private:
