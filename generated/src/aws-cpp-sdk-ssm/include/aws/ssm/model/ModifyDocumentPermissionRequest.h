...
class ModifyDocumentPermissionRequest : public SSMRequest {
 public:
  ...
  inline void SetPermissionType(DocumentPermissionType value) {
    m_permissionTypeHasBeenSet = true;
    m_permissionType = value;
  }
  inline ModifyDocumentPermissionRequest& WithPermissionType(DocumentPermissionType value) {
  ...
  void SetAccountIdsToAdd(AccountIdsToAddT&& value) {
    m_accountIdsToAddHasBeenSet = true;
    m_accountIdsToAdd = std::forward<AccountIdsToAddT>(value);
  }
  template <typename AccountIdsToAddT = Aws::Vector<Aws::String>>
  ModifyDocumentPermissionRequest& WithAccountIdsToAdd(AccountIdsToAddT&& value) {
    SetAccountIdsToAdd(std::forward<AccountIdsToAddT>(value));
    return *this;
  }
  template <typename AccountIdsToAddT = Aws::String>
  ModifyDocumentPermissionRequest& AddAccountIdsToAdd(AccountIdsToAddT&& value) {
    m_accountIdsToAddHasBeenSet = true;
    m_accountIdsToAdd.emplace_back(std::forward<AccountIdsToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccountIdsToRemove(AccountIdsToRemoveT&& value) {
    m_accountIdsToRemoveHasBeenSet = true;
    m_accountIdsToRemove = std::forward<AccountIdsToRemoveT>(value);
  }
  template <typename AccountIdsToRemoveT = Aws::Vector<Aws::String>>
  ModifyDocumentPermissionRequest& WithAccountIdsToRemove(AccountIdsToRemoveT&& value) {
    SetAccountIdsToRemove(std::forward<AccountIdsToRemoveT>(value));
    return *this;
  }
  ...
  ModifyDocumentPermissionRequest& AddAccountIdsToRemove(AccountIdsToRemoveT&& value) {
    m_accountIdsToRemoveHasBeenSet = true;
    m_accountIdsToRemove.emplace_back(std::forward<AccountIdsToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSharedDocumentVersion(SharedDocumentVersionT&& value) {
    ...
    m_sharedDocumentVersion = std::forward<SharedDocumentVersionT>(value);
  }
  template <typename SharedDocumentVersionT = Aws::String>
  ModifyDocumentPermissionRequest& WithSharedDocumentVersion(SharedDocumentVersionT&& value) {
    SetSharedDocumentVersion(std::forward<SharedDocumentVersionT>(value));
    return *this;
  }
  ///@}
 private:
