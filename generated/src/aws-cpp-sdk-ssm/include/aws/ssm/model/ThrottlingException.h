...
namespace Model
{
  ...
  /**
   * <p>The request or operation couldn't be performed because the service is
   * throttling requests.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ssm-2014-11-06/ThrottlingException">AWS
   * API Reference</a></p>
   */
