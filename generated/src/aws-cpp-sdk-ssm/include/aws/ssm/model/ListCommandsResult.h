...
class ListCommandsResult {
 public:
  ...
  template <typename CommandsT = Aws::Vector<Command>>
  ListCommandsResult& WithCommands(CommandsT&& value) {
    SetCommands(std::forward<CommandsT>(value));
    return *this;
  }
  template <typename CommandsT = Command>
  ListCommandsResult& AddCommands(CommandsT&& value) {
    m_commandsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCommandsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCommandsResult& WithRequestId(RequestIdT&& value) {
