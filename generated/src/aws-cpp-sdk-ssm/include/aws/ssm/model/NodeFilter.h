...
class NodeFilter {
 public:
  ...
  inline void SetKey(NodeFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline NodeFilter& WithKey(NodeFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  NodeFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  NodeFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetType(NodeFilterOperatorType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline NodeFilter& WithType(NodeFilterOperatorType value) {
    SetType(value);
    return *this;
  }
  ///@}
