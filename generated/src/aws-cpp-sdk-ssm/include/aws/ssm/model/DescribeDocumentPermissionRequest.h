...
class DescribeDocumentPermissionRequest : public SSMRequest {
 public:
  ...
  inline DescribeDocumentPermissionRequest& WithPermissionType(DocumentPermissionType value) {
  ...
  inline DescribeDocumentPermissionRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
