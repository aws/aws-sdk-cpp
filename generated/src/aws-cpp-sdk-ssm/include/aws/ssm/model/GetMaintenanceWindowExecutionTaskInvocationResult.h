...
class GetMaintenanceWindowExecutionTaskInvocationResult {
 public:
  ...
  AWS_SSM_API GetMaintenanceWindowExecutionTaskInvocationResult& operator=(
  ...
  template <typename WindowExecutionIdT = Aws::String>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithWindowExecutionId(WindowExecutionIdT&& value) {
  ...
  template <typename TaskExecutionIdT = Aws::String>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithTaskExecutionId(TaskExecutionIdT&& value) {
  ...
  template <typename InvocationIdT = Aws::String>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithInvocationId(InvocationIdT&& value) {
  ...
  template <typename ExecutionIdT = Aws::String>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithExecutionId(ExecutionIdT&& value) {
  ...
  inline GetMaintenanceWindowExecutionTaskInvocationResult& WithTaskType(MaintenanceWindowTaskType value) {
    SetTaskType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ParametersT = Aws::String>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithParameters(ParametersT&& value) {
  ...
  inline GetMaintenanceWindowExecutionTaskInvocationResult& WithStatus(MaintenanceWindowExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusDetailsT = Aws::String>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithStatusDetails(StatusDetailsT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithEndTime(EndTimeT&& value) {
  ...
  template <typename OwnerInformationT = Aws::String>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithOwnerInformation(OwnerInformationT&& value) {
  ...
  template <typename WindowTargetIdT = Aws::String>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithWindowTargetId(WindowTargetIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetMaintenanceWindowExecutionTaskInvocationResult& WithRequestId(RequestIdT&& value) {
