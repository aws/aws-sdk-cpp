...
class StepExecutionFilter {
 public:
  ...
  inline void SetKey(StepExecutionFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline StepExecutionFilter& WithKey(StepExecutionFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  StepExecutionFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  StepExecutionFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
