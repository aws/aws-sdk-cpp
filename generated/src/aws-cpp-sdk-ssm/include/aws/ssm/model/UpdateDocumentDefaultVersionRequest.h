...
class UpdateDocumentDefaultVersionRequest : public SSMRequest {
 public:
  AWS_SSM_API UpdateDocumentDefaultVersionRequest() = default;
  ...
  template <typename NameT = Aws::String>
  UpdateDocumentDefaultVersionRequest& WithName(NameT&& value) {
  ...
  template <typename DocumentVersionT = Aws::String>
  UpdateDocumentDefaultVersionRequest& WithDocumentVersion(DocumentVersionT&& value) {
