...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API DescribeAssociationExecutionTargetsRequest() = default;
    ...
    template<typename AssociationIdT = Aws::String>
    DescribeAssociationExecutionTargetsRequest& WithAssociationId(AssociationIdT&& value) { SetAssociationId(std::forward<AssociationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ExecutionIdT = Aws::String>
    DescribeAssociationExecutionTargetsRequest& WithExecutionId(ExecutionIdT&& value) { SetExecutionId(std::forward<ExecutionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<AssociationExecutionTargetsFilter>>
    void SetFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters = std::forward<FiltersT>(value); }
    template<typename FiltersT = Aws::Vector<AssociationExecutionTargetsFilter>>
    DescribeAssociationExecutionTargetsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = AssociationExecutionTargetsFilter>
    DescribeAssociationExecutionTargetsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeAssociationExecutionTargetsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
