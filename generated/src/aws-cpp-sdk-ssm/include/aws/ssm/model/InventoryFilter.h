...
class InventoryFilter {
 public:
  ...
  template <typename KeyT = Aws::String>
  InventoryFilter& WithKey(KeyT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  InventoryFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  InventoryFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetType(InventoryQueryOperatorType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline InventoryFilter& WithType(InventoryQueryOperatorType value) {
    SetType(value);
    return *this;
  }
  ///@}
