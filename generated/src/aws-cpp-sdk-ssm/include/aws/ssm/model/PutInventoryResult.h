...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API PutInventoryResult() = default;
    ...
    template<typename MessageT = Aws::String>
    PutInventoryResult& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutInventoryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
