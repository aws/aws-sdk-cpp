...
class DescribePatchPropertiesRequest : public SSMRequest {
 public:
  ...
  inline DescribePatchPropertiesRequest& WithOperatingSystem(OperatingSystem value) {
  ...
  inline void SetProperty(PatchProperty value) {
    m_propertyHasBeenSet = true;
    m_property = value;
  }
  inline DescribePatchPropertiesRequest& WithProperty(PatchProperty value) {
    SetProperty(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPatchSet(PatchSet value) {
    m_patchSetHasBeenSet = true;
    m_patchSet = value;
  }
  inline DescribePatchPropertiesRequest& WithPatchSet(PatchSet value) {
    SetPatchSet(value);
    return *this;
  }
  ///@}
  ...
  inline DescribePatchPropertiesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
