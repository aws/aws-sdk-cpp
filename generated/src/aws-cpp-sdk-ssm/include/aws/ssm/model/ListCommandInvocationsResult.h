...
class ListCommandInvocationsResult {
 public:
  ...
  void SetCommandInvocations(CommandInvocationsT&& value) {
    m_commandInvocationsHasBeenSet = true;
    m_commandInvocations = std::forward<CommandInvocationsT>(value);
  }
  template <typename CommandInvocationsT = Aws::Vector<CommandInvocation>>
  ListCommandInvocationsResult& WithCommandInvocations(CommandInvocationsT&& value) {
    SetCommandInvocations(std::forward<CommandInvocationsT>(value));
    return *this;
  }
  ...
  ListCommandInvocationsResult& AddCommandInvocations(CommandInvocationsT&& value) {
    m_commandInvocationsHasBeenSet = true;
    m_commandInvocations.emplace_back(std::forward<CommandInvocationsT>(value));
    return *this;
  }
  ///@}
