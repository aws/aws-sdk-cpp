...
class ParameterMetadata {
 public:
  ...
  inline ParameterMetadata& WithType(ParameterType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline ParameterMetadata& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline ParameterMetadata& WithTier(ParameterTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
