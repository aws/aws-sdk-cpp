...
class CommandInvocation {
 public:
  ...
  inline CommandInvocation& WithStatus(CommandInvocationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTraceOutput(TraceOutputT&& value) {
    ...
    m_traceOutput = std::forward<TraceOutputT>(value);
  }
  template <typename TraceOutputT = Aws::String>
  CommandInvocation& WithTraceOutput(TraceOutputT&& value) {
    SetTraceOutput(std::forward<TraceOutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCommandPlugins(CommandPluginsT&& value) {
    ...
    m_commandPlugins = std::forward<CommandPluginsT>(value);
  }
  template <typename CommandPluginsT = Aws::Vector<CommandPlugin>>
  CommandInvocation& WithCommandPlugins(CommandPluginsT&& value) {
    SetCommandPlugins(std::forward<CommandPluginsT>(value));
    return *this;
  }
  template <typename CommandPluginsT = CommandPlugin>
  CommandInvocation& AddCommandPlugins(CommandPluginsT&& value) {
    m_commandPluginsHasBeenSet = true;
    m_commandPlugins.emplace_back(std::forward<CommandPluginsT>(value));
    return *this;
  }
  ///@}
