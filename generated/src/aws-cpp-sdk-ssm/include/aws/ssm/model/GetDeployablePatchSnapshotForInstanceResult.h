...
class GetDeployablePatchSnapshotForInstanceResult {
 public:
  ...
  AWS_SSM_API GetDeployablePatchSnapshotForInstanceResult& operator=(
  ...
  template <typename InstanceIdT = Aws::String>
  GetDeployablePatchSnapshotForInstanceResult& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename SnapshotIdT = Aws::String>
  GetDeployablePatchSnapshotForInstanceResult& WithSnapshotId(SnapshotIdT&& value) {
  ...
  void SetSnapshotDownloadUrl(SnapshotDownloadUrlT&& value) {
    m_snapshotDownloadUrlHasBeenSet = true;
    m_snapshotDownloadUrl = std::forward<SnapshotDownloadUrlT>(value);
  }
  template <typename SnapshotDownloadUrlT = Aws::String>
  GetDeployablePatchSnapshotForInstanceResult& WithSnapshotDownloadUrl(SnapshotDownloadUrlT&& value) {
    SetSnapshotDownloadUrl(std::forward<SnapshotDownloadUrlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ProductT = Aws::String>
  GetDeployablePatchSnapshotForInstanceResult& WithProduct(ProductT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDeployablePatchSnapshotForInstanceResult& WithRequestId(RequestIdT&& value) {
