...
class ListDocumentMetadataHistoryResult {
 public:
  ...
  template <typename NameT = Aws::String>
  ListDocumentMetadataHistoryResult& WithName(NameT&& value) {
  ...
  template <typename DocumentVersionT = Aws::String>
  ListDocumentMetadataHistoryResult& WithDocumentVersion(DocumentVersionT&& value) {
  ...
  template <typename AuthorT = Aws::String>
  ListDocumentMetadataHistoryResult& WithAuthor(AuthorT&& value) {
  ...
  template <typename MetadataT = DocumentMetadataResponseInfo>
  ListDocumentMetadataHistoryResult& WithMetadata(MetadataT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDocumentMetadataHistoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDocumentMetadataHistoryResult& WithRequestId(RequestIdT&& value) {
