...
class DeletePatchBaselineResult {
 public:
  AWS_SSM_API DeletePatchBaselineResult() = default;
  ...
  template <typename BaselineIdT = Aws::String>
  DeletePatchBaselineResult& WithBaselineId(BaselineIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeletePatchBaselineResult& WithRequestId(RequestIdT&& value) {
