...
class GetParametersByPathRequest : public SSMRequest {
 public:
  ...
  inline void SetRecursive(bool value) {
    m_recursiveHasBeenSet = true;
    m_recursive = value;
  }
  inline GetParametersByPathRequest& WithRecursive(bool value) {
    SetRecursive(value);
    return *this;
  }
  ///@}
  ...
  void SetParameterFilters(ParameterFiltersT&& value) {
    m_parameterFiltersHasBeenSet = true;
    m_parameterFilters = std::forward<ParameterFiltersT>(value);
  }
  template <typename ParameterFiltersT = Aws::Vector<ParameterStringFilter>>
  GetParametersByPathRequest& WithParameterFilters(ParameterFiltersT&& value) {
    SetParameterFilters(std::forward<ParameterFiltersT>(value));
    return *this;
  }
  ...
  GetParametersByPathRequest& AddParameterFilters(ParameterFiltersT&& value) {
    m_parameterFiltersHasBeenSet = true;
    m_parameterFilters.emplace_back(std::forward<ParameterFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetParametersByPathRequest& WithWithDecryption(bool value) {
  ...
  inline GetParametersByPathRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
