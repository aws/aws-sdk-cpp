...
class UpdateServiceSettingRequest : public SSMRequest {
 public:
  ...
  template <typename SettingIdT = Aws::String>
  UpdateServiceSettingRequest& WithSettingId(SettingIdT&& value) {
  ...
  void SetSettingValue(SettingValueT&& value) {
    ...
    m_settingValue = std::forward<SettingValueT>(value);
  }
  template <typename SettingValueT = Aws::String>
  UpdateServiceSettingRequest& WithSettingValue(SettingValueT&& value) {
    SetSettingValue(std::forward<SettingValueT>(value));
    return *this;
  }
  ///@}
 private:
