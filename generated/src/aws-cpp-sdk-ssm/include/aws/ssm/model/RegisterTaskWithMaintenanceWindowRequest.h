...
class RegisterTaskWithMaintenanceWindowRequest : public SSMRequest {
 public:
  ...
  inline RegisterTaskWithMaintenanceWindowRequest& WithTaskType(MaintenanceWindowTaskType value) {
    SetTaskType(value);
    return *this;
  }
  ///@}
  ...
  inline RegisterTaskWithMaintenanceWindowRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline RegisterTaskWithMaintenanceWindowRequest& WithCutoffBehavior(MaintenanceWindowTaskCutoffBehavior value) {
