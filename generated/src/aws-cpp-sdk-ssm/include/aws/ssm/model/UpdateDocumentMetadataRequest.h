...
class UpdateDocumentMetadataRequest : public SSMRequest {
 public:
  ...
  void SetDocumentReviews(DocumentReviewsT&& value) {
    m_documentReviewsHasBeenSet = true;
    m_documentReviews = std::forward<DocumentReviewsT>(value);
  }
  template <typename DocumentReviewsT = DocumentReviews>
  UpdateDocumentMetadataRequest& WithDocumentReviews(DocumentReviewsT&& value) {
    SetDocumentReviews(std::forward<DocumentReviewsT>(value));
    return *this;
  }
  ///@}
 private:
