...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API ModifyDocumentPermissionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ModifyDocumentPermissionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
