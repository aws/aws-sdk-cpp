...
class CreateAssociationRequest : public SSMRequest {
 public:
  ...
  void SetAutomationTargetParameterName(AutomationTargetParameterNameT&& value) {
    ...
    m_automationTargetParameterName = std::forward<AutomationTargetParameterNameT>(value);
  }
  template <typename AutomationTargetParameterNameT = Aws::String>
  CreateAssociationRequest& WithAutomationTargetParameterName(AutomationTargetParameterNameT&& value) {
    SetAutomationTargetParameterName(std::forward<AutomationTargetParameterNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetComplianceSeverity(AssociationComplianceSeverity value) {
    m_complianceSeverityHasBeenSet = true;
    m_complianceSeverity = value;
  }
  inline CreateAssociationRequest& WithComplianceSeverity(AssociationComplianceSeverity value) {
    SetComplianceSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSyncCompliance(AssociationSyncCompliance value) {
    m_syncComplianceHasBeenSet = true;
    m_syncCompliance = value;
  }
  inline CreateAssociationRequest& WithSyncCompliance(AssociationSyncCompliance value) {
    SetSyncCompliance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetApplyOnlyAtCronInterval(bool value) {
    m_applyOnlyAtCronIntervalHasBeenSet = true;
    m_applyOnlyAtCronInterval = value;
  }
  inline CreateAssociationRequest& WithApplyOnlyAtCronInterval(bool value) {
    SetApplyOnlyAtCronInterval(value);
    return *this;
  }
  ///@}
   ...
   * <p>The <code>TargetLocationAlarmConfiguration</code> parameter is not supported
   * by State Manager.</p>
   */
  ...
  inline CreateAssociationRequest& WithScheduleOffset(int value) {
  ...
  inline CreateAssociationRequest& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  template <typename AssociationDispatchAssumeRoleT = Aws::String>
  CreateAssociationRequest& WithAssociationDispatchAssumeRole(AssociationDispatchAssumeRoleT&& value) {
