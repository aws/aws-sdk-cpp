...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API DisassociateOpsItemRelatedItemResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateOpsItemRelatedItemResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
