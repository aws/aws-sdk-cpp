...
class DeregisterTargetFromMaintenanceWindowResult {
 public:
  ...
  AWS_SSM_API DeregisterTargetFromMaintenanceWindowResult& operator=(
  ...
  template <typename WindowIdT = Aws::String>
  DeregisterTargetFromMaintenanceWindowResult& WithWindowId(WindowIdT&& value) {
  ...
  template <typename WindowTargetIdT = Aws::String>
  DeregisterTargetFromMaintenanceWindowResult& WithWindowTargetId(WindowTargetIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeregisterTargetFromMaintenanceWindowResult& WithRequestId(RequestIdT&& value) {
