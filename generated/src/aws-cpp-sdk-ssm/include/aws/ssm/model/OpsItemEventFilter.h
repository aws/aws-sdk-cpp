...
class OpsItemEventFilter {
 public:
  ...
  inline void SetKey(OpsItemEventFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline OpsItemEventFilter& WithKey(OpsItemEventFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  OpsItemEventFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  OpsItemEventFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(OpsItemEventFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline OpsItemEventFilter& WithOperator(OpsItemEventFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
