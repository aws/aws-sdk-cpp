...
class DescribeDocumentRequest : public SSMRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  DescribeDocumentRequest& WithName(NameT&& value) {
  ...
  template <typename DocumentVersionT = Aws::String>
  DescribeDocumentRequest& WithDocumentVersion(DocumentVersionT&& value) {
  ...
  template <typename VersionNameT = Aws::String>
  DescribeDocumentRequest& WithVersionName(VersionNameT&& value) {
