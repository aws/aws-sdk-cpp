...
class InstanceInformation {
 public:
  ...
  inline InstanceInformation& WithPingStatus(PingStatus value) {
    SetPingStatus(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceInformation& WithIsLatestVersion(bool value) {
  ...
  inline InstanceInformation& WithPlatformType(PlatformType value) {
  ...
  inline InstanceInformation& WithResourceType(ResourceType value) {
