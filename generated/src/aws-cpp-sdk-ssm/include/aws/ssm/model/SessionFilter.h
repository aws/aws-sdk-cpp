...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API SessionFilter() = default;
     ...
     */
    inline SessionFilterKey GetKey() const { return m_key; }
    inline bool KeyHasBeenSet() const { return m_keyHasBeenSet; }
    inline void SetKey(SessionFilterKey value) { m_keyHasBeenSet = true; m_key = value; }
    inline SessionFilter& WithKey(SessionFilterKey value) { SetKey(value); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    SessionFilter& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
