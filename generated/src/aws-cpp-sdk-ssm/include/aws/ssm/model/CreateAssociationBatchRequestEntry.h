...
class CreateAssociationBatchRequestEntry {
 public:
  ...
  inline CreateAssociationBatchRequestEntry& WithComplianceSeverity(AssociationComplianceSeverity value) {
  ...
  inline CreateAssociationBatchRequestEntry& WithSyncCompliance(AssociationSyncCompliance value) {
  ...
  inline CreateAssociationBatchRequestEntry& WithApplyOnlyAtCronInterval(bool value) {
  ...
  inline CreateAssociationBatchRequestEntry& WithScheduleOffset(int value) {
  ...
  inline CreateAssociationBatchRequestEntry& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
