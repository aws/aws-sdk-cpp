...
class GetCalendarStateResult {
 public:
  ...
  inline void SetState(CalendarState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline GetCalendarStateResult& WithState(CalendarState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetAtTime(AtTimeT&& value) {
    ...
    m_atTime = std::forward<AtTimeT>(value);
  }
  template <typename AtTimeT = Aws::String>
  GetCalendarStateResult& WithAtTime(AtTimeT&& value) {
    SetAtTime(std::forward<AtTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextTransitionTime(NextTransitionTimeT&& value) {
    ...
    m_nextTransitionTime = std::forward<NextTransitionTimeT>(value);
  }
  template <typename NextTransitionTimeT = Aws::String>
  GetCalendarStateResult& WithNextTransitionTime(NextTransitionTimeT&& value) {
    SetNextTransitionTime(std::forward<NextTransitionTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCalendarStateResult& WithRequestId(RequestIdT&& value) {
