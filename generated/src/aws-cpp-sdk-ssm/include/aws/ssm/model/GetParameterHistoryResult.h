...
class GetParameterHistoryResult {
 public:
  ...
  template <typename ParametersT = Aws::Vector<ParameterHistory>>
  GetParameterHistoryResult& WithParameters(ParametersT&& value) {
    SetParameters(std::forward<ParametersT>(value));
    return *this;
  }
  template <typename ParametersT = ParameterHistory>
  GetParameterHistoryResult& AddParameters(ParametersT&& value) {
    m_parametersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetParameterHistoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetParameterHistoryResult& WithRequestId(RequestIdT&& value) {
