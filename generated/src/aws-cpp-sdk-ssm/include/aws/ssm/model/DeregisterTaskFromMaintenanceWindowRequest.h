...
class DeregisterTaskFromMaintenanceWindowRequest : public SSMRequest {
 public:
  ...
  template <typename WindowIdT = Aws::String>
  DeregisterTaskFromMaintenanceWindowRequest& WithWindowId(WindowIdT&& value) {
  ...
  template <typename WindowTaskIdT = Aws::String>
  DeregisterTaskFromMaintenanceWindowRequest& WithWindowTaskId(WindowTaskIdT&& value) {
