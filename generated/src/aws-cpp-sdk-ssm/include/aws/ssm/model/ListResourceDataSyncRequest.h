...
class ListResourceDataSyncRequest : public SSMRequest {
 public:
  ...
  template <typename SyncTypeT = Aws::String>
  ListResourceDataSyncRequest& WithSyncType(SyncTypeT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceDataSyncRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResourceDataSyncRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
