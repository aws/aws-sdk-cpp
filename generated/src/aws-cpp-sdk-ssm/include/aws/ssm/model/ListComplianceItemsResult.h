...
class ListComplianceItemsResult {
 public:
  ...
  void SetComplianceItems(ComplianceItemsT&& value) {
    m_complianceItemsHasBeenSet = true;
    m_complianceItems = std::forward<ComplianceItemsT>(value);
  }
  template <typename ComplianceItemsT = Aws::Vector<ComplianceItem>>
  ListComplianceItemsResult& WithComplianceItems(ComplianceItemsT&& value) {
    SetComplianceItems(std::forward<ComplianceItemsT>(value));
    return *this;
  }
  template <typename ComplianceItemsT = ComplianceItem>
  ListComplianceItemsResult& AddComplianceItems(ComplianceItemsT&& value) {
    m_complianceItemsHasBeenSet = true;
    m_complianceItems.emplace_back(std::forward<ComplianceItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListComplianceItemsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListComplianceItemsResult& WithRequestId(RequestIdT&& value) {
