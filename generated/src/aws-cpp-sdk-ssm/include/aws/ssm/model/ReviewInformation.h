...
class ReviewInformation {
 public:
  ...
  void SetReviewedTime(ReviewedTimeT&& value) {
    m_reviewedTimeHasBeenSet = true;
    m_reviewedTime = std::forward<ReviewedTimeT>(value);
  }
  template <typename ReviewedTimeT = Aws::Utils::DateTime>
  ReviewInformation& WithReviewedTime(ReviewedTimeT&& value) {
    SetReviewedTime(std::forward<ReviewedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ReviewStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ReviewInformation& WithStatus(ReviewStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetReviewer(ReviewerT&& value) {
    ...
    m_reviewer = std::forward<ReviewerT>(value);
  }
  template <typename ReviewerT = Aws::String>
  ReviewInformation& WithReviewer(ReviewerT&& value) {
    SetReviewer(std::forward<ReviewerT>(value));
    return *this;
  }
  ///@}
 private:
