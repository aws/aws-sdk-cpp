...
class InstanceInfo {
 public:
  ...
  inline void SetManagedStatus(ManagedStatus value) {
    m_managedStatusHasBeenSet = true;
    m_managedStatus = value;
  }
  inline InstanceInfo& WithManagedStatus(ManagedStatus value) {
  ...
  inline void SetPlatformType(PlatformType value) {
    m_platformTypeHasBeenSet = true;
    m_platformType = value;
  }
  inline InstanceInfo& WithPlatformType(PlatformType value) {
  ...
  inline InstanceInfo& WithResourceType(ResourceType value) {
