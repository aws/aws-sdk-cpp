...
class CommandPlugin {
 public:
  ...
  inline void SetStatus(CommandPluginStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CommandPlugin& WithStatus(CommandPluginStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CommandPlugin& WithResponseCode(int value) {
  ...
  void SetResponseStartDateTime(ResponseStartDateTimeT&& value) {
    ...
    m_responseStartDateTime = std::forward<ResponseStartDateTimeT>(value);
  }
  template <typename ResponseStartDateTimeT = Aws::Utils::DateTime>
  CommandPlugin& WithResponseStartDateTime(ResponseStartDateTimeT&& value) {
    SetResponseStartDateTime(std::forward<ResponseStartDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResponseFinishDateTime(ResponseFinishDateTimeT&& value) {
    ...
    m_responseFinishDateTime = std::forward<ResponseFinishDateTimeT>(value);
  }
  template <typename ResponseFinishDateTimeT = Aws::Utils::DateTime>
  CommandPlugin& WithResponseFinishDateTime(ResponseFinishDateTimeT&& value) {
    SetResponseFinishDateTime(std::forward<ResponseFinishDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStandardOutputUrl(StandardOutputUrlT&& value) {
    ...
    m_standardOutputUrl = std::forward<StandardOutputUrlT>(value);
  }
  template <typename StandardOutputUrlT = Aws::String>
  CommandPlugin& WithStandardOutputUrl(StandardOutputUrlT&& value) {
    SetStandardOutputUrl(std::forward<StandardOutputUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStandardErrorUrl(StandardErrorUrlT&& value) {
    ...
    m_standardErrorUrl = std::forward<StandardErrorUrlT>(value);
  }
  template <typename StandardErrorUrlT = Aws::String>
  CommandPlugin& WithStandardErrorUrl(StandardErrorUrlT&& value) {
    SetStandardErrorUrl(std::forward<StandardErrorUrlT>(value));
    return *this;
  }
  ///@}
