...
class AutomationExecutionPreview {
 public:
  ...
  inline void SetTotalAccounts(int value) {
    m_totalAccountsHasBeenSet = true;
    m_totalAccounts = value;
  }
  inline AutomationExecutionPreview& WithTotalAccounts(int value) {
