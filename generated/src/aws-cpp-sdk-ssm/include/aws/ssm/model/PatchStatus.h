...
class PatchStatus {
 public:
  ...
  inline void SetDeploymentStatus(PatchDeploymentStatus value) {
    m_deploymentStatusHasBeenSet = true;
    m_deploymentStatus = value;
  }
  inline PatchStatus& WithDeploymentStatus(PatchDeploymentStatus value) {
  ...
  inline void SetComplianceLevel(PatchComplianceLevel value) {
    m_complianceLevelHasBeenSet = true;
    m_complianceLevel = value;
  }
  inline PatchStatus& WithComplianceLevel(PatchComplianceLevel value) {
  ...
  void SetApprovalDate(ApprovalDateT&& value) {
    ...
    m_approvalDate = std::forward<ApprovalDateT>(value);
  }
  template <typename ApprovalDateT = Aws::Utils::DateTime>
  PatchStatus& WithApprovalDate(ApprovalDateT&& value) {
    SetApprovalDate(std::forward<ApprovalDateT>(value));
    return *this;
  }
  ///@}
 private:
