...
class GetOpsMetadataRequest : public SSMRequest {
 public:
  ...
  template <typename OpsMetadataArnT = Aws::String>
  GetOpsMetadataRequest& WithOpsMetadataArn(OpsMetadataArnT&& value) {
  ...
  inline GetOpsMetadataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetOpsMetadataRequest& WithNextToken(NextTokenT&& value) {
