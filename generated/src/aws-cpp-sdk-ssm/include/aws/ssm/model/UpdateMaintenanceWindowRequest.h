...
class UpdateMaintenanceWindowRequest : public SSMRequest {
 public:
  ...
  inline UpdateMaintenanceWindowRequest& WithScheduleOffset(int value) {
  ...
  inline UpdateMaintenanceWindowRequest& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateMaintenanceWindowRequest& WithCutoff(int value) {
    SetCutoff(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateMaintenanceWindowRequest& WithAllowUnassociatedTargets(bool value) {
  ...
  inline UpdateMaintenanceWindowRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateMaintenanceWindowRequest& WithReplace(bool value) {
    SetReplace(value);
    return *this;
  }
  ///@}
