...
class CreateCloudConnectorResult {
 public:
  AWS_SSM_API CreateCloudConnectorResult() = default;
  AWS_SSM_API CreateCloudConnectorResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SSM_API CreateCloudConnectorResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename CloudConnectorIdT = Aws::String>
  CreateCloudConnectorResult& WithCloudConnectorId(CloudConnectorIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCloudConnectorResult& WithRequestId(RequestIdT&& value) {
