...
class ListCommandsRequest : public SSMRequest {
 public:
  ...
  template <typename CommandIdT = Aws::String>
  ListCommandsRequest& WithCommandId(CommandIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  ListCommandsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline ListCommandsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<CommandFilter>>
  ListCommandsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = CommandFilter>
  ListCommandsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
