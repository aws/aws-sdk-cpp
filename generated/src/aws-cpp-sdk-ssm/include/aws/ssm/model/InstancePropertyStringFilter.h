...
class InstancePropertyStringFilter {
 public:
  ...
  template <typename KeyT = Aws::String>
  InstancePropertyStringFilter& WithKey(KeyT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  InstancePropertyStringFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  InstancePropertyStringFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(InstancePropertyFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline InstancePropertyStringFilter& WithOperator(InstancePropertyFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
