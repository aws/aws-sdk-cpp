...
class NonCompliantSummary {
 public:
  ...
  inline void SetNonCompliantCount(int value) {
    m_nonCompliantCountHasBeenSet = true;
    m_nonCompliantCount = value;
  }
  inline NonCompliantSummary& WithNonCompliantCount(int value) {
    SetNonCompliantCount(value);
    return *this;
  }
  ///@}
  ...
  void SetSeveritySummary(SeveritySummaryT&& value) {
    ...
    m_severitySummary = std::forward<SeveritySummaryT>(value);
  }
  template <typename SeveritySummaryT = SeveritySummary>
  NonCompliantSummary& WithSeveritySummary(SeveritySummaryT&& value) {
    SetSeveritySummary(std::forward<SeveritySummaryT>(value));
    return *this;
  }
  ///@}
 private:
