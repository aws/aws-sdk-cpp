...
class ListOpsMetadataResult {
 public:
  ...
  void SetOpsMetadataList(OpsMetadataListT&& value) {
    m_opsMetadataListHasBeenSet = true;
    m_opsMetadataList = std::forward<OpsMetadataListT>(value);
  }
  template <typename OpsMetadataListT = Aws::Vector<OpsMetadata>>
  ListOpsMetadataResult& WithOpsMetadataList(OpsMetadataListT&& value) {
    SetOpsMetadataList(std::forward<OpsMetadataListT>(value));
    return *this;
  }
  template <typename OpsMetadataListT = OpsMetadata>
  ListOpsMetadataResult& AddOpsMetadataList(OpsMetadataListT&& value) {
    m_opsMetadataListHasBeenSet = true;
    m_opsMetadataList.emplace_back(std::forward<OpsMetadataListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOpsMetadataResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOpsMetadataResult& WithRequestId(RequestIdT&& value) {
