...
class UpdateOpsMetadataRequest : public SSMRequest {
 public:
  ...
  template <typename OpsMetadataArnT = Aws::String>
  UpdateOpsMetadataRequest& WithOpsMetadataArn(OpsMetadataArnT&& value) {
  ...
  void SetMetadataToUpdate(MetadataToUpdateT&& value) {
    m_metadataToUpdateHasBeenSet = true;
    m_metadataToUpdate = std::forward<MetadataToUpdateT>(value);
  }
  template <typename MetadataToUpdateT = Aws::Map<Aws::String, MetadataValue>>
  UpdateOpsMetadataRequest& WithMetadataToUpdate(MetadataToUpdateT&& value) {
    SetMetadataToUpdate(std::forward<MetadataToUpdateT>(value));
    return *this;
  }
  ...
  UpdateOpsMetadataRequest& AddMetadataToUpdate(MetadataToUpdateKeyT&& key, MetadataToUpdateValueT&& value) {
    m_metadataToUpdateHasBeenSet = true;
    m_metadataToUpdate.emplace(std::forward<MetadataToUpdateKeyT>(key), std::forward<MetadataToUpdateValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKeysToDelete(KeysToDeleteT&& value) {
    m_keysToDeleteHasBeenSet = true;
    m_keysToDelete = std::forward<KeysToDeleteT>(value);
  }
  template <typename KeysToDeleteT = Aws::Vector<Aws::String>>
  UpdateOpsMetadataRequest& WithKeysToDelete(KeysToDeleteT&& value) {
    SetKeysToDelete(std::forward<KeysToDeleteT>(value));
    return *this;
  }
  template <typename KeysToDeleteT = Aws::String>
  UpdateOpsMetadataRequest& AddKeysToDelete(KeysToDeleteT&& value) {
    m_keysToDeleteHasBeenSet = true;
    m_keysToDelete.emplace_back(std::forward<KeysToDeleteT>(value));
    return *this;
  }
  ///@}
 private:
