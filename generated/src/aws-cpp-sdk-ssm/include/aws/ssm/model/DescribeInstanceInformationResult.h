...
class DescribeInstanceInformationResult {
 public:
  ...
  void SetInstanceInformationList(InstanceInformationListT&& value) {
    m_instanceInformationListHasBeenSet = true;
    m_instanceInformationList = std::forward<InstanceInformationListT>(value);
  }
  template <typename InstanceInformationListT = Aws::Vector<InstanceInformation>>
  DescribeInstanceInformationResult& WithInstanceInformationList(InstanceInformationListT&& value) {
    SetInstanceInformationList(std::forward<InstanceInformationListT>(value));
    return *this;
  }
  template <typename InstanceInformationListT = InstanceInformation>
  DescribeInstanceInformationResult& AddInstanceInformationList(InstanceInformationListT&& value) {
    m_instanceInformationListHasBeenSet = true;
    m_instanceInformationList.emplace_back(std::forward<InstanceInformationListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstanceInformationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeInstanceInformationResult& WithRequestId(RequestIdT&& value) {
