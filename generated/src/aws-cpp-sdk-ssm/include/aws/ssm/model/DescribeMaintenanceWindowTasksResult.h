...
class DescribeMaintenanceWindowTasksResult {
 public:
  ...
  template <typename TasksT = Aws::Vector<MaintenanceWindowTask>>
  DescribeMaintenanceWindowTasksResult& WithTasks(TasksT&& value) {
    SetTasks(std::forward<TasksT>(value));
    return *this;
  }
  template <typename TasksT = MaintenanceWindowTask>
  DescribeMaintenanceWindowTasksResult& AddTasks(TasksT&& value) {
    m_tasksHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMaintenanceWindowTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMaintenanceWindowTasksResult& WithRequestId(RequestIdT&& value) {
