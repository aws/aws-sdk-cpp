...
class ResourceComplianceSummaryItem {
 public:
  ...
  inline ResourceComplianceSummaryItem& WithStatus(ComplianceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOverallSeverity(ComplianceSeverity value) {
    m_overallSeverityHasBeenSet = true;
    m_overallSeverity = value;
  }
  inline ResourceComplianceSummaryItem& WithOverallSeverity(ComplianceSeverity value) {
  ...
  void SetCompliantSummary(CompliantSummaryT&& value) {
    ...
    m_compliantSummary = std::forward<CompliantSummaryT>(value);
  }
  template <typename CompliantSummaryT = CompliantSummary>
  ResourceComplianceSummaryItem& WithCompliantSummary(CompliantSummaryT&& value) {
    SetCompliantSummary(std::forward<CompliantSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNonCompliantSummary(NonCompliantSummaryT&& value) {
    ...
    m_nonCompliantSummary = std::forward<NonCompliantSummaryT>(value);
  }
  template <typename NonCompliantSummaryT = NonCompliantSummary>
  ResourceComplianceSummaryItem& WithNonCompliantSummary(NonCompliantSummaryT&& value) {
    SetNonCompliantSummary(std::forward<NonCompliantSummaryT>(value));
    return *this;
  }
  ///@}
 private:
