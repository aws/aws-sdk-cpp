...
class AlarmStateInformation {
 public:
  ...
  template <typename NameT = Aws::String>
  AlarmStateInformation& WithName(NameT&& value) {
  ...
  inline void SetState(ExternalAlarmState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline AlarmStateInformation& WithState(ExternalAlarmState value) {
    SetState(value);
    return *this;
  }
  ///@}
