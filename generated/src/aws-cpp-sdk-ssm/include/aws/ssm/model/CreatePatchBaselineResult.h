...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API CreatePatchBaselineResult() = default;
    ...
    template<typename BaselineIdT = Aws::String>
    CreatePatchBaselineResult& WithBaselineId(BaselineIdT&& value) { SetBaselineId(std::forward<BaselineIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreatePatchBaselineResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
