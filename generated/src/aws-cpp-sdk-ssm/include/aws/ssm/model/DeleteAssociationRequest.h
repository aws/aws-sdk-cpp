...
class DeleteAssociationRequest : public SSMRequest {
 public:
  AWS_SSM_API DeleteAssociationRequest() = default;
  ...
  template <typename NameT = Aws::String>
  DeleteAssociationRequest& WithName(NameT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  DeleteAssociationRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename AssociationIdT = Aws::String>
  DeleteAssociationRequest& WithAssociationId(AssociationIdT&& value) {
