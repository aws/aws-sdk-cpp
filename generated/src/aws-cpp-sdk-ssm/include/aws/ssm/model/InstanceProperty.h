...
class InstanceProperty {
 public:
  ...
  inline void SetPingStatus(PingStatus value) {
    m_pingStatusHasBeenSet = true;
    m_pingStatus = value;
  }
  inline InstanceProperty& WithPingStatus(PingStatus value) {
    SetPingStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastPingDateTime(LastPingDateTimeT&& value) {
    ...
    m_lastPingDateTime = std::forward<LastPingDateTimeT>(value);
  }
  template <typename LastPingDateTimeT = Aws::Utils::DateTime>
  InstanceProperty& WithLastPingDateTime(LastPingDateTimeT&& value) {
    SetLastPingDateTime(std::forward<LastPingDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline InstanceProperty& WithPlatformType(PlatformType value) {
  ...
  void SetRegistrationDate(RegistrationDateT&& value) {
    ...
    m_registrationDate = std::forward<RegistrationDateT>(value);
  }
  template <typename RegistrationDateT = Aws::Utils::DateTime>
  InstanceProperty& WithRegistrationDate(RegistrationDateT&& value) {
    SetRegistrationDate(std::forward<RegistrationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastAssociationExecutionDate(LastAssociationExecutionDateT&& value) {
    ...
    m_lastAssociationExecutionDate = std::forward<LastAssociationExecutionDateT>(value);
  }
  template <typename LastAssociationExecutionDateT = Aws::Utils::DateTime>
  InstanceProperty& WithLastAssociationExecutionDate(LastAssociationExecutionDateT&& value) {
    SetLastAssociationExecutionDate(std::forward<LastAssociationExecutionDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSuccessfulAssociationExecutionDate(LastSuccessfulAssociationExecutionDateT&& value) {
    ...
    m_lastSuccessfulAssociationExecutionDate = std::forward<LastSuccessfulAssociationExecutionDateT>(value);
  }
  template <typename LastSuccessfulAssociationExecutionDateT = Aws::Utils::DateTime>
  InstanceProperty& WithLastSuccessfulAssociationExecutionDate(LastSuccessfulAssociationExecutionDateT&& value) {
    SetLastSuccessfulAssociationExecutionDate(std::forward<LastSuccessfulAssociationExecutionDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssociationOverview(AssociationOverviewT&& value) {
    ...
    m_associationOverview = std::forward<AssociationOverviewT>(value);
  }
  template <typename AssociationOverviewT = InstanceAggregatedAssociationOverview>
  InstanceProperty& WithAssociationOverview(AssociationOverviewT&& value) {
    SetAssociationOverview(std::forward<AssociationOverviewT>(value));
    return *this;
  }
  ///@}
