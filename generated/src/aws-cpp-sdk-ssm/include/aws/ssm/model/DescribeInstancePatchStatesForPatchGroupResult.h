...
namespace Model
{
  ...
  public:
    ...
    template<typename InstancePatchStatesT = Aws::Vector<InstancePatchState>>
    DescribeInstancePatchStatesForPatchGroupResult& WithInstancePatchStates(InstancePatchStatesT&& value) { SetInstancePatchStates(std::forward<InstancePatchStatesT>(value)); return *this;}
    template<typename InstancePatchStatesT = InstancePatchState>
    DescribeInstancePatchStatesForPatchGroupResult& AddInstancePatchStates(InstancePatchStatesT&& value) { m_instancePatchStatesHasBeenSet = true; m_instancePatchStates.emplace_back(std::forward<InstancePatchStatesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeInstancePatchStatesForPatchGroupResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeInstancePatchStatesForPatchGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
