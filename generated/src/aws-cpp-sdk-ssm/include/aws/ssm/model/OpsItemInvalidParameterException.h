...
class OpsItemInvalidParameterException {
 public:
  ...
  template <typename ParameterNamesT = Aws::Vector<Aws::String>>
  OpsItemInvalidParameterException& WithParameterNames(ParameterNamesT&& value) {
    SetParameterNames(std::forward<ParameterNamesT>(value));
    return *this;
  }
  template <typename ParameterNamesT = Aws::String>
  OpsItemInvalidParameterException& AddParameterNames(ParameterNamesT&& value) {
    m_parameterNamesHasBeenSet = true;
  ...
  template <typename MessageT = Aws::String>
  OpsItemInvalidParameterException& WithMessage(MessageT&& value) {
