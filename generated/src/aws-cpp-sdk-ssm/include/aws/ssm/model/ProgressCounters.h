...
class ProgressCounters {
 public:
  ...
  inline ProgressCounters& WithTotalSteps(int value) {
    SetTotalSteps(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSuccessSteps(int value) {
    m_successStepsHasBeenSet = true;
    m_successSteps = value;
  }
  inline ProgressCounters& WithSuccessSteps(int value) {
    SetSuccessSteps(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailedSteps(int value) {
    m_failedStepsHasBeenSet = true;
    m_failedSteps = value;
  }
  inline ProgressCounters& WithFailedSteps(int value) {
    SetFailedSteps(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCancelledSteps(int value) {
    m_cancelledStepsHasBeenSet = true;
    m_cancelledSteps = value;
  }
  inline ProgressCounters& WithCancelledSteps(int value) {
    SetCancelledSteps(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimedOutSteps(int value) {
    m_timedOutStepsHasBeenSet = true;
    m_timedOutSteps = value;
  }
  inline ProgressCounters& WithTimedOutSteps(int value) {
    SetTimedOutSteps(value);
    return *this;
  }
  ///@}
 private:
