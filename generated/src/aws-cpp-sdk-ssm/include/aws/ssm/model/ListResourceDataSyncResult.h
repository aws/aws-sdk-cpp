...
class ListResourceDataSyncResult {
 public:
  ...
  void SetResourceDataSyncItems(ResourceDataSyncItemsT&& value) {
    m_resourceDataSyncItemsHasBeenSet = true;
    m_resourceDataSyncItems = std::forward<ResourceDataSyncItemsT>(value);
  }
  template <typename ResourceDataSyncItemsT = Aws::Vector<ResourceDataSyncItem>>
  ListResourceDataSyncResult& WithResourceDataSyncItems(ResourceDataSyncItemsT&& value) {
    SetResourceDataSyncItems(std::forward<ResourceDataSyncItemsT>(value));
    return *this;
  }
  template <typename ResourceDataSyncItemsT = ResourceDataSyncItem>
  ListResourceDataSyncResult& AddResourceDataSyncItems(ResourceDataSyncItemsT&& value) {
    m_resourceDataSyncItemsHasBeenSet = true;
    m_resourceDataSyncItems.emplace_back(std::forward<ResourceDataSyncItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceDataSyncResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceDataSyncResult& WithRequestId(RequestIdT&& value) {
