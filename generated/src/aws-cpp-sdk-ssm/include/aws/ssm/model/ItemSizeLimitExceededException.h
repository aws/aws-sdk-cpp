...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API ItemSizeLimitExceededException() = default;
    ...
    template<typename TypeNameT = Aws::String>
    ItemSizeLimitExceededException& WithTypeName(TypeNameT&& value) { SetTypeName(std::forward<TypeNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    ItemSizeLimitExceededException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
