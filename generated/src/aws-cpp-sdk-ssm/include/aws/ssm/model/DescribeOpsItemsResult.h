...
class DescribeOpsItemsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeOpsItemsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetOpsItemSummaries(OpsItemSummariesT&& value) {
    m_opsItemSummariesHasBeenSet = true;
    m_opsItemSummaries = std::forward<OpsItemSummariesT>(value);
  }
  template <typename OpsItemSummariesT = Aws::Vector<OpsItemSummary>>
  DescribeOpsItemsResult& WithOpsItemSummaries(OpsItemSummariesT&& value) {
    SetOpsItemSummaries(std::forward<OpsItemSummariesT>(value));
    return *this;
  }
  template <typename OpsItemSummariesT = OpsItemSummary>
  DescribeOpsItemsResult& AddOpsItemSummaries(OpsItemSummariesT&& value) {
    m_opsItemSummariesHasBeenSet = true;
    m_opsItemSummaries.emplace_back(std::forward<OpsItemSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeOpsItemsResult& WithRequestId(RequestIdT&& value) {
