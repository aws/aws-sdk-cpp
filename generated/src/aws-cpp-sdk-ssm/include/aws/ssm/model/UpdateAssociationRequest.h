...
class UpdateAssociationRequest : public SSMRequest {
 public:
  ...
  inline UpdateAssociationRequest& WithComplianceSeverity(AssociationComplianceSeverity value) {
  ...
  inline UpdateAssociationRequest& WithSyncCompliance(AssociationSyncCompliance value) {
  ...
  inline UpdateAssociationRequest& WithApplyOnlyAtCronInterval(bool value) {
  ...
  inline UpdateAssociationRequest& WithScheduleOffset(int value) {
  ...
  inline UpdateAssociationRequest& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
