...
class OpsItemRelatedItemsFilter {
 public:
  ...
  inline void SetKey(OpsItemRelatedItemsFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline OpsItemRelatedItemsFilter& WithKey(OpsItemRelatedItemsFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  OpsItemRelatedItemsFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  OpsItemRelatedItemsFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(OpsItemRelatedItemsFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline OpsItemRelatedItemsFilter& WithOperator(OpsItemRelatedItemsFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
