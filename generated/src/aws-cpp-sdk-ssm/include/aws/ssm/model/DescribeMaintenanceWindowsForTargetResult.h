...
class DescribeMaintenanceWindowsForTargetResult {
 public:
  ...
  template <typename WindowIdentitiesT = Aws::Vector<MaintenanceWindowIdentityForTarget>>
  DescribeMaintenanceWindowsForTargetResult& WithWindowIdentities(WindowIdentitiesT&& value) {
  ...
  DescribeMaintenanceWindowsForTargetResult& AddWindowIdentities(WindowIdentitiesT&& value) {
    m_windowIdentitiesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMaintenanceWindowsForTargetResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMaintenanceWindowsForTargetResult& WithRequestId(RequestIdT&& value) {
