...
class ResourceDataSyncItem {
 public:
  ...
  void SetSyncName(SyncNameT&& value) {
    ...
    m_syncName = std::forward<SyncNameT>(value);
  }
  template <typename SyncNameT = Aws::String>
  ResourceDataSyncItem& WithSyncName(SyncNameT&& value) {
    SetSyncName(std::forward<SyncNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSyncType(SyncTypeT&& value) {
    ...
    m_syncType = std::forward<SyncTypeT>(value);
  }
  template <typename SyncTypeT = Aws::String>
  ResourceDataSyncItem& WithSyncType(SyncTypeT&& value) {
    SetSyncType(std::forward<SyncTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSyncTime(LastSyncTimeT&& value) {
    ...
    m_lastSyncTime = std::forward<LastSyncTimeT>(value);
  }
  template <typename LastSyncTimeT = Aws::Utils::DateTime>
  ResourceDataSyncItem& WithLastSyncTime(LastSyncTimeT&& value) {
    SetLastSyncTime(std::forward<LastSyncTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSuccessfulSyncTime(LastSuccessfulSyncTimeT&& value) {
    ...
    m_lastSuccessfulSyncTime = std::forward<LastSuccessfulSyncTimeT>(value);
  }
  template <typename LastSuccessfulSyncTimeT = Aws::Utils::DateTime>
  ResourceDataSyncItem& WithLastSuccessfulSyncTime(LastSuccessfulSyncTimeT&& value) {
    SetLastSuccessfulSyncTime(std::forward<LastSuccessfulSyncTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSyncLastModifiedTime(SyncLastModifiedTimeT&& value) {
    ...
    m_syncLastModifiedTime = std::forward<SyncLastModifiedTimeT>(value);
  }
  template <typename SyncLastModifiedTimeT = Aws::Utils::DateTime>
  ResourceDataSyncItem& WithSyncLastModifiedTime(SyncLastModifiedTimeT&& value) {
    SetSyncLastModifiedTime(std::forward<SyncLastModifiedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLastStatus(LastResourceDataSyncStatus value) {
    m_lastStatusHasBeenSet = true;
    m_lastStatus = value;
  }
  inline ResourceDataSyncItem& WithLastStatus(LastResourceDataSyncStatus value) {
    SetLastStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetSyncCreatedTime(SyncCreatedTimeT&& value) {
    ...
    m_syncCreatedTime = std::forward<SyncCreatedTimeT>(value);
  }
  template <typename SyncCreatedTimeT = Aws::Utils::DateTime>
  ResourceDataSyncItem& WithSyncCreatedTime(SyncCreatedTimeT&& value) {
    SetSyncCreatedTime(std::forward<SyncCreatedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSyncStatusMessage(LastSyncStatusMessageT&& value) {
    ...
    m_lastSyncStatusMessage = std::forward<LastSyncStatusMessageT>(value);
  }
  template <typename LastSyncStatusMessageT = Aws::String>
  ResourceDataSyncItem& WithLastSyncStatusMessage(LastSyncStatusMessageT&& value) {
    SetLastSyncStatusMessage(std::forward<LastSyncStatusMessageT>(value));
    return *this;
  }
  ///@}
 private:
