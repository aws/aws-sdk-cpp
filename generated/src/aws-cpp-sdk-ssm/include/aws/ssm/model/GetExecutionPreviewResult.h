...
class GetExecutionPreviewResult {
 public:
  ...
  inline void SetStatus(ExecutionPreviewStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetExecutionPreviewResult& WithStatus(ExecutionPreviewStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetExecutionPreview(ExecutionPreviewT&& value) {
    ...
    m_executionPreview = std::forward<ExecutionPreviewT>(value);
  }
  template <typename ExecutionPreviewT = ExecutionPreview>
  GetExecutionPreviewResult& WithExecutionPreview(ExecutionPreviewT&& value) {
    SetExecutionPreview(std::forward<ExecutionPreviewT>(value));
    return *this;
  }
  ///@}
