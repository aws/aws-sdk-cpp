...
class MaintenanceWindowTask {
 public:
  ...
  inline void SetType(MaintenanceWindowTaskType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline MaintenanceWindowTask& WithType(MaintenanceWindowTaskType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetTaskParameters(TaskParametersT&& value) {
    ...
    m_taskParameters = std::forward<TaskParametersT>(value);
  }
  template <typename TaskParametersT = Aws::Map<Aws::String, MaintenanceWindowTaskParameterValueExpression>>
  MaintenanceWindowTask& WithTaskParameters(TaskParametersT&& value) {
    SetTaskParameters(std::forward<TaskParametersT>(value));
    return *this;
  }
  ...
  MaintenanceWindowTask& AddTaskParameters(TaskParametersKeyT&& key, TaskParametersValueT&& value) {
    m_taskParametersHasBeenSet = true;
    m_taskParameters.emplace(std::forward<TaskParametersKeyT>(key), std::forward<TaskParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline MaintenanceWindowTask& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCutoffBehavior(MaintenanceWindowTaskCutoffBehavior value) {
    m_cutoffBehaviorHasBeenSet = true;
    m_cutoffBehavior = value;
  }
  inline MaintenanceWindowTask& WithCutoffBehavior(MaintenanceWindowTaskCutoffBehavior value) {
    SetCutoffBehavior(value);
    return *this;
  }
  ///@}
