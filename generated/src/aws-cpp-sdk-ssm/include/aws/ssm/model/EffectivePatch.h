...
class EffectivePatch {
 public:
  ...
  void SetPatch(PatchT&& value) {
    ...
    m_patch = std::forward<PatchT>(value);
  }
  template <typename PatchT = Patch>
  EffectivePatch& WithPatch(PatchT&& value) {
    SetPatch(std::forward<PatchT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPatchStatus(PatchStatusT&& value) {
    ...
    m_patchStatus = std::forward<PatchStatusT>(value);
  }
  template <typename PatchStatusT = PatchStatus>
  EffectivePatch& WithPatchStatus(PatchStatusT&& value) {
    SetPatchStatus(std::forward<PatchStatusT>(value));
    return *this;
  }
  ///@}
 private:
