...
class GetParametersResult {
 public:
  ...
  template <typename ParametersT = Aws::Vector<Parameter>>
  GetParametersResult& WithParameters(ParametersT&& value) {
    SetParameters(std::forward<ParametersT>(value));
    return *this;
  }
  template <typename ParametersT = Parameter>
  GetParametersResult& AddParameters(ParametersT&& value) {
    m_parametersHasBeenSet = true;
  ...
  void SetInvalidParameters(InvalidParametersT&& value) {
    m_invalidParametersHasBeenSet = true;
    m_invalidParameters = std::forward<InvalidParametersT>(value);
  }
  template <typename InvalidParametersT = Aws::Vector<Aws::String>>
  GetParametersResult& WithInvalidParameters(InvalidParametersT&& value) {
    SetInvalidParameters(std::forward<InvalidParametersT>(value));
    return *this;
  }
  template <typename InvalidParametersT = Aws::String>
  GetParametersResult& AddInvalidParameters(InvalidParametersT&& value) {
    m_invalidParametersHasBeenSet = true;
    m_invalidParameters.emplace_back(std::forward<InvalidParametersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetParametersResult& WithRequestId(RequestIdT&& value) {
