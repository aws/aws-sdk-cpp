...
class AssociationExecutionFilter {
 public:
  ...
  inline void SetKey(AssociationExecutionFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline AssociationExecutionFilter& WithKey(AssociationExecutionFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  AssociationExecutionFilter& WithValue(ValueT&& value) {
  ...
  inline void SetType(AssociationFilterOperatorType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline AssociationExecutionFilter& WithType(AssociationFilterOperatorType value) {
    SetType(value);
    return *this;
  }
  ///@}
