...
class CreatePatchBaselineRequest : public SSMRequest {
 public:
  ...
  inline CreatePatchBaselineRequest& WithOperatingSystem(OperatingSystem value) {
  ...
  inline CreatePatchBaselineRequest& WithApprovedPatchesComplianceLevel(PatchComplianceLevel value) {
  ...
  inline CreatePatchBaselineRequest& WithApprovedPatchesEnableNonSecurity(bool value) {
  ...
  inline CreatePatchBaselineRequest& WithRejectedPatchesAction(PatchAction value) {
  ...
  inline CreatePatchBaselineRequest& WithAvailableSecurityUpdatesComplianceStatus(PatchComplianceStatus value) {
