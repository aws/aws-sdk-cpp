...
class DescribeMaintenanceWindowsForTargetRequest : public SSMRequest {
 public:
  ...
  template <typename TargetsT = Aws::Vector<Target>>
  DescribeMaintenanceWindowsForTargetRequest& WithTargets(TargetsT&& value) {
    SetTargets(std::forward<TargetsT>(value));
    return *this;
  }
  template <typename TargetsT = Target>
  DescribeMaintenanceWindowsForTargetRequest& AddTargets(TargetsT&& value) {
    m_targetsHasBeenSet = true;
  ...
  inline DescribeMaintenanceWindowsForTargetRequest& WithResourceType(MaintenanceWindowResourceType value) {
  ...
  inline DescribeMaintenanceWindowsForTargetRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMaintenanceWindowsForTargetRequest& WithNextToken(NextTokenT&& value) {
