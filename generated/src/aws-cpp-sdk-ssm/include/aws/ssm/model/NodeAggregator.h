...
class NodeAggregator {
 public:
  ...
  inline void SetAggregatorType(NodeAggregatorType value) {
    m_aggregatorTypeHasBeenSet = true;
    m_aggregatorType = value;
  }
  inline NodeAggregator& WithAggregatorType(NodeAggregatorType value) {
    SetAggregatorType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTypeName(NodeTypeName value) {
    m_typeNameHasBeenSet = true;
    m_typeName = value;
  }
  inline NodeAggregator& WithTypeName(NodeTypeName value) {
    SetTypeName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAttributeName(NodeAttributeName value) {
    m_attributeNameHasBeenSet = true;
    m_attributeName = value;
  }
  inline NodeAggregator& WithAttributeName(NodeAttributeName value) {
  ...
  void SetAggregators(AggregatorsT&& value) {
    ...
    m_aggregators = std::forward<AggregatorsT>(value);
  }
  template <typename AggregatorsT = Aws::Vector<NodeAggregator>>
  NodeAggregator& WithAggregators(AggregatorsT&& value) {
    SetAggregators(std::forward<AggregatorsT>(value));
    return *this;
  }
  template <typename AggregatorsT = NodeAggregator>
  NodeAggregator& AddAggregators(AggregatorsT&& value) {
    m_aggregatorsHasBeenSet = true;
    m_aggregators.emplace_back(std::forward<AggregatorsT>(value));
    return *this;
  }
  ///@}
 private:
