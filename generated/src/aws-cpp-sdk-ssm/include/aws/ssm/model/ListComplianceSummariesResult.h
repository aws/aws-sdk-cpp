...
class ListComplianceSummariesResult {
 public:
  ...
  void SetComplianceSummaryItems(ComplianceSummaryItemsT&& value) {
    m_complianceSummaryItemsHasBeenSet = true;
    m_complianceSummaryItems = std::forward<ComplianceSummaryItemsT>(value);
  }
  template <typename ComplianceSummaryItemsT = Aws::Vector<ComplianceSummaryItem>>
  ListComplianceSummariesResult& WithComplianceSummaryItems(ComplianceSummaryItemsT&& value) {
    SetComplianceSummaryItems(std::forward<ComplianceSummaryItemsT>(value));
    return *this;
  }
  template <typename ComplianceSummaryItemsT = ComplianceSummaryItem>
  ListComplianceSummariesResult& AddComplianceSummaryItems(ComplianceSummaryItemsT&& value) {
    m_complianceSummaryItemsHasBeenSet = true;
    m_complianceSummaryItems.emplace_back(std::forward<ComplianceSummaryItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListComplianceSummariesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListComplianceSummariesResult& WithRequestId(RequestIdT&& value) {
