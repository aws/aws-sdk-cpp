...
class DescribeAssociationExecutionsResult {
 public:
  ...
  void SetAssociationExecutions(AssociationExecutionsT&& value) {
    m_associationExecutionsHasBeenSet = true;
    m_associationExecutions = std::forward<AssociationExecutionsT>(value);
  }
  template <typename AssociationExecutionsT = Aws::Vector<AssociationExecution>>
  DescribeAssociationExecutionsResult& WithAssociationExecutions(AssociationExecutionsT&& value) {
    SetAssociationExecutions(std::forward<AssociationExecutionsT>(value));
    return *this;
  }
  template <typename AssociationExecutionsT = AssociationExecution>
  DescribeAssociationExecutionsResult& AddAssociationExecutions(AssociationExecutionsT&& value) {
    m_associationExecutionsHasBeenSet = true;
    m_associationExecutions.emplace_back(std::forward<AssociationExecutionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAssociationExecutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAssociationExecutionsResult& WithRequestId(RequestIdT&& value) {
