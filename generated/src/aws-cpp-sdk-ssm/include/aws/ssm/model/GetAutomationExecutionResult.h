...
class GetAutomationExecutionResult {
 public:
  ...
  void SetAutomationExecution(AutomationExecutionT&& value) {
    m_automationExecutionHasBeenSet = true;
    m_automationExecution = std::forward<AutomationExecutionT>(value);
  }
  template <typename AutomationExecutionT = AutomationExecution>
  GetAutomationExecutionResult& WithAutomationExecution(AutomationExecutionT&& value) {
    SetAutomationExecution(std::forward<AutomationExecutionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAutomationExecutionResult& WithRequestId(RequestIdT&& value) {
