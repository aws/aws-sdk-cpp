...
class PatchFilterGroup {
 public:
  ...
  void SetPatchFilters(PatchFiltersT&& value) {
    m_patchFiltersHasBeenSet = true;
    m_patchFilters = std::forward<PatchFiltersT>(value);
  }
  template <typename PatchFiltersT = Aws::Vector<PatchFilter>>
  PatchFilterGroup& WithPatchFilters(PatchFiltersT&& value) {
    SetPatchFilters(std::forward<PatchFiltersT>(value));
    return *this;
  }
  template <typename PatchFiltersT = PatchFilter>
  PatchFilterGroup& AddPatchFilters(PatchFiltersT&& value) {
    m_patchFiltersHasBeenSet = true;
    m_patchFilters.emplace_back(std::forward<PatchFiltersT>(value));
    return *this;
  }
  ///@}
 private:
