...
class DescribeInventoryDeletionsRequest : public SSMRequest {
 public:
  ...
  void SetDeletionId(DeletionIdT&& value) {
    ...
    m_deletionId = std::forward<DeletionIdT>(value);
  }
  template <typename DeletionIdT = Aws::String>
  DescribeInventoryDeletionsRequest& WithDeletionId(DeletionIdT&& value) {
    SetDeletionId(std::forward<DeletionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInventoryDeletionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeInventoryDeletionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
