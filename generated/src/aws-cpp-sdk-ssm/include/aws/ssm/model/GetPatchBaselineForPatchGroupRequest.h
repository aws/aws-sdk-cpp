...
class GetPatchBaselineForPatchGroupRequest : public SSMRequest {
 public:
  ...
  template <typename PatchGroupT = Aws::String>
  GetPatchBaselineForPatchGroupRequest& WithPatchGroup(PatchGroupT&& value) {
  ...
  inline GetPatchBaselineForPatchGroupRequest& WithOperatingSystem(OperatingSystem value) {
