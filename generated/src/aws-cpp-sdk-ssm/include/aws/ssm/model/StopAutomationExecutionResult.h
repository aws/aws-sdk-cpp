...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API StopAutomationExecutionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StopAutomationExecutionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
