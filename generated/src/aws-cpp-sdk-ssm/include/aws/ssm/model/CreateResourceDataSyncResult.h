...
namespace Model
{
  ...
  {
  public:
    AWS_SSM_API CreateResourceDataSyncResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateResourceDataSyncResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
