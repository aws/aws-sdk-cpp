...
class ResourceDataSyncDestinationDataSharing {
 public:
  ...
  void SetDestinationDataSharingType(DestinationDataSharingTypeT&& value) {
    m_destinationDataSharingTypeHasBeenSet = true;
    m_destinationDataSharingType = std::forward<DestinationDataSharingTypeT>(value);
  }
  template <typename DestinationDataSharingTypeT = Aws::String>
  ResourceDataSyncDestinationDataSharing& WithDestinationDataSharingType(DestinationDataSharingTypeT&& value) {
    SetDestinationDataSharingType(std::forward<DestinationDataSharingTypeT>(value));
    return *this;
  }
  ///@}
 private:
