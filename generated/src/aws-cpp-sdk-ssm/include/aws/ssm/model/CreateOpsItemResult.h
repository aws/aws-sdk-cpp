...
class CreateOpsItemResult {
 public:
  ...
  template <typename OpsItemIdT = Aws::String>
  CreateOpsItemResult& WithOpsItemId(OpsItemIdT&& value) {
  ...
  template <typename OpsItemArnT = Aws::String>
  CreateOpsItemResult& WithOpsItemArn(OpsItemArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateOpsItemResult& WithRequestId(RequestIdT&& value) {
