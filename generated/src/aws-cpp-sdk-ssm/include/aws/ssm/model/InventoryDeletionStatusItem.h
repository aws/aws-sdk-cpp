...
class InventoryDeletionStatusItem {
 public:
  ...
  inline void SetLastStatus(InventoryDeletionStatus value) {
    m_lastStatusHasBeenSet = true;
    m_lastStatus = value;
  }
  inline InventoryDeletionStatusItem& WithLastStatus(InventoryDeletionStatus value) {
    SetLastStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastStatusMessage(LastStatusMessageT&& value) {
    ...
    m_lastStatusMessage = std::forward<LastStatusMessageT>(value);
  }
  template <typename LastStatusMessageT = Aws::String>
  InventoryDeletionStatusItem& WithLastStatusMessage(LastStatusMessageT&& value) {
    SetLastStatusMessage(std::forward<LastStatusMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeletionSummary(DeletionSummaryT&& value) {
    ...
    m_deletionSummary = std::forward<DeletionSummaryT>(value);
  }
  template <typename DeletionSummaryT = InventoryDeletionSummary>
  InventoryDeletionStatusItem& WithDeletionSummary(DeletionSummaryT&& value) {
    SetDeletionSummary(std::forward<DeletionSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastStatusUpdateTime(LastStatusUpdateTimeT&& value) {
    ...
    m_lastStatusUpdateTime = std::forward<LastStatusUpdateTimeT>(value);
  }
  template <typename LastStatusUpdateTimeT = Aws::Utils::DateTime>
  InventoryDeletionStatusItem& WithLastStatusUpdateTime(LastStatusUpdateTimeT&& value) {
    SetLastStatusUpdateTime(std::forward<LastStatusUpdateTimeT>(value));
    return *this;
  }
  ///@}
 private:
