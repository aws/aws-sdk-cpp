...
class StepExecution {
 public:
  ...
  inline StepExecution& WithTimeoutSeconds(long long value) {
  ...
  inline StepExecution& WithMaxAttempts(int value) {
  ...
  inline void SetStepStatus(AutomationExecutionStatus value) {
    m_stepStatusHasBeenSet = true;
    m_stepStatus = value;
  }
  inline StepExecution& WithStepStatus(AutomationExecutionStatus value) {
    SetStepStatus(value);
    return *this;
  }
  ///@}
  ...
  StepExecution& AddInputs(InputsKeyT&& key, InputsValueT&& value) {
    m_inputsHasBeenSet = true;
    m_inputs.emplace(std::forward<InputsKeyT>(key), std::forward<InputsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOverriddenParameters(OverriddenParametersT&& value) {
    ...
    m_overriddenParameters = std::forward<OverriddenParametersT>(value);
  }
  template <typename OverriddenParametersT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  StepExecution& WithOverriddenParameters(OverriddenParametersT&& value) {
    SetOverriddenParameters(std::forward<OverriddenParametersT>(value));
    return *this;
  }
  ...
  StepExecution& AddOverriddenParameters(OverriddenParametersKeyT&& key, OverriddenParametersValueT&& value) {
    m_overriddenParametersHasBeenSet = true;
    m_overriddenParameters.emplace(std::forward<OverriddenParametersKeyT>(key), std::forward<OverriddenParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsEnd(bool value) {
    m_isEndHasBeenSet = true;
    m_isEnd = value;
  }
  inline StepExecution& WithIsEnd(bool value) {
    SetIsEnd(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsCritical(bool value) {
    m_isCriticalHasBeenSet = true;
    m_isCritical = value;
  }
  inline StepExecution& WithIsCritical(bool value) {
    SetIsCritical(value);
    return *this;
  }
  ///@}
  ...
  void SetValidNextSteps(ValidNextStepsT&& value) {
    ...
    m_validNextSteps = std::forward<ValidNextStepsT>(value);
  }
  template <typename ValidNextStepsT = Aws::Vector<Aws::String>>
  StepExecution& WithValidNextSteps(ValidNextStepsT&& value) {
    SetValidNextSteps(std::forward<ValidNextStepsT>(value));
    return *this;
  }
  template <typename ValidNextStepsT = Aws::String>
  StepExecution& AddValidNextSteps(ValidNextStepsT&& value) {
    m_validNextStepsHasBeenSet = true;
    m_validNextSteps.emplace_back(std::forward<ValidNextStepsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetParentStepDetails(ParentStepDetailsT&& value) {
    ...
    m_parentStepDetails = std::forward<ParentStepDetailsT>(value);
  }
  template <typename ParentStepDetailsT = ParentStepDetails>
  StepExecution& WithParentStepDetails(ParentStepDetailsT&& value) {
    SetParentStepDetails(std::forward<ParentStepDetailsT>(value));
    return *this;
  }
  ///@}
 private:
