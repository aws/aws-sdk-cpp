...
class DescribeInstancePatchesResult {
 public:
  ...
  template <typename PatchesT = Aws::Vector<PatchComplianceData>>
  DescribeInstancePatchesResult& WithPatches(PatchesT&& value) {
    SetPatches(std::forward<PatchesT>(value));
    return *this;
  }
  template <typename PatchesT = PatchComplianceData>
  DescribeInstancePatchesResult& AddPatches(PatchesT&& value) {
    m_patchesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstancePatchesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeInstancePatchesResult& WithRequestId(RequestIdT&& value) {
