...
class DescribeAutomationExecutionsResult {
 public:
   ...
   */
  inline const Aws::Vector<AutomationExecutionMetadata>& GetAutomationExecutionMetadataList() const {
    return m_automationExecutionMetadataList;
  }
  ...
  void SetAutomationExecutionMetadataList(AutomationExecutionMetadataListT&& value) {
    ...
    m_automationExecutionMetadataList = std::forward<AutomationExecutionMetadataListT>(value);
  }
  template <typename AutomationExecutionMetadataListT = Aws::Vector<AutomationExecutionMetadata>>
  DescribeAutomationExecutionsResult& WithAutomationExecutionMetadataList(AutomationExecutionMetadataListT&& value) {
    SetAutomationExecutionMetadataList(std::forward<AutomationExecutionMetadataListT>(value));
    return *this;
  }
  ...
  DescribeAutomationExecutionsResult& AddAutomationExecutionMetadataList(AutomationExecutionMetadataListT&& value) {
    m_automationExecutionMetadataListHasBeenSet = true;
    m_automationExecutionMetadataList.emplace_back(std::forward<AutomationExecutionMetadataListT>(value));
    return *this;
  }
  ///@}
