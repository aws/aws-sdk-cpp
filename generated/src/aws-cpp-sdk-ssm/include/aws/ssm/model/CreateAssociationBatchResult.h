...
class CreateAssociationBatchResult {
 public:
  ...
  template <typename SuccessfulT = Aws::Vector<AssociationDescription>>
  CreateAssociationBatchResult& WithSuccessful(SuccessfulT&& value) {
    SetSuccessful(std::forward<SuccessfulT>(value));
    return *this;
  }
  template <typename SuccessfulT = AssociationDescription>
  CreateAssociationBatchResult& AddSuccessful(SuccessfulT&& value) {
    m_successfulHasBeenSet = true;
  ...
  template <typename FailedT = Aws::Vector<FailedCreateAssociation>>
  CreateAssociationBatchResult& WithFailed(FailedT&& value) {
    SetFailed(std::forward<FailedT>(value));
    return *this;
  }
  template <typename FailedT = FailedCreateAssociation>
  CreateAssociationBatchResult& AddFailed(FailedT&& value) {
    m_failedHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateAssociationBatchResult& WithRequestId(RequestIdT&& value) {
