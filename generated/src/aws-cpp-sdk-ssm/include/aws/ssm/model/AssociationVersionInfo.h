...
class AssociationVersionInfo {
 public:
  ...
  inline AssociationVersionInfo& WithComplianceSeverity(AssociationComplianceSeverity value) {
  ...
  inline AssociationVersionInfo& WithSyncCompliance(AssociationSyncCompliance value) {
  ...
  inline AssociationVersionInfo& WithApplyOnlyAtCronInterval(bool value) {
  ...
  inline AssociationVersionInfo& WithScheduleOffset(int value) {
  ...
  inline AssociationVersionInfo& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
