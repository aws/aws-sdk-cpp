...
namespace Model
{
  ...
  public:
    ...
    template<typename AssociationIdT = Aws::String>
    AssociationVersionInfo& WithAssociationId(AssociationIdT&& value) { SetAssociationId(std::forward<AssociationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AssociationVersionT = Aws::String>
    AssociationVersionInfo& WithAssociationVersion(AssociationVersionT&& value) { SetAssociationVersion(std::forward<AssociationVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedDateT = Aws::Utils::DateTime>
    AssociationVersionInfo& WithCreatedDate(CreatedDateT&& value) { SetCreatedDate(std::forward<CreatedDateT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    AssociationVersionInfo& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DocumentVersionT = Aws::String>
    AssociationVersionInfo& WithDocumentVersion(DocumentVersionT&& value) { SetDocumentVersion(std::forward<DocumentVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename ParametersT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    AssociationVersionInfo& WithParameters(ParametersT&& value) { SetParameters(std::forward<ParametersT>(value)); return *this;}
    ...
    template<typename TargetsT = Aws::Vector<Target>>
    AssociationVersionInfo& WithTargets(TargetsT&& value) { SetTargets(std::forward<TargetsT>(value)); return *this;}
    template<typename TargetsT = Target>
    AssociationVersionInfo& AddTargets(TargetsT&& value) { m_targetsHasBeenSet = true; m_targets.emplace_back(std::forward<TargetsT>(value)); return *this; }
    ///@}
    ...
    template<typename ScheduleExpressionT = Aws::String>
    AssociationVersionInfo& WithScheduleExpression(ScheduleExpressionT&& value) { SetScheduleExpression(std::forward<ScheduleExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename OutputLocationT = InstanceAssociationOutputLocation>
    AssociationVersionInfo& WithOutputLocation(OutputLocationT&& value) { SetOutputLocation(std::forward<OutputLocationT>(value)); return *this;}
    ///@}
    ...
    template<typename AssociationNameT = Aws::String>
    AssociationVersionInfo& WithAssociationName(AssociationNameT&& value) { SetAssociationName(std::forward<AssociationNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MaxErrorsT = Aws::String>
    AssociationVersionInfo& WithMaxErrors(MaxErrorsT&& value) { SetMaxErrors(std::forward<MaxErrorsT>(value)); return *this;}
    ///@}
    ...
    template<typename MaxConcurrencyT = Aws::String>
    AssociationVersionInfo& WithMaxConcurrency(MaxConcurrencyT&& value) { SetMaxConcurrency(std::forward<MaxConcurrencyT>(value)); return *this;}
    ///@}
    ...
    inline AssociationVersionInfo& WithComplianceSeverity(AssociationComplianceSeverity value) { SetComplianceSeverity(value); return *this;}
    ///@}
    ...
    inline AssociationVersionInfo& WithSyncCompliance(AssociationSyncCompliance value) { SetSyncCompliance(value); return *this;}
    ///@}
    ...
    template<typename CalendarNamesT = Aws::Vector<Aws::String>>
    AssociationVersionInfo& WithCalendarNames(CalendarNamesT&& value) { SetCalendarNames(std::forward<CalendarNamesT>(value)); return *this;}
    template<typename CalendarNamesT = Aws::String>
    AssociationVersionInfo& AddCalendarNames(CalendarNamesT&& value) { m_calendarNamesHasBeenSet = true; m_calendarNames.emplace_back(std::forward<CalendarNamesT>(value)); return *this; }
    ///@}
    ...
    template<typename TargetLocationsT = Aws::Vector<TargetLocation>>
    AssociationVersionInfo& WithTargetLocations(TargetLocationsT&& value) { SetTargetLocations(std::forward<TargetLocationsT>(value)); return *this;}
    template<typename TargetLocationsT = TargetLocation>
    AssociationVersionInfo& AddTargetLocations(TargetLocationsT&& value) { m_targetLocationsHasBeenSet = true; m_targetLocations.emplace_back(std::forward<TargetLocationsT>(value)); return *this; }
    ///@}
    ...
    template<typename TargetMapsT = Aws::Vector<Aws::Map<Aws::String, Aws::Vector<Aws::String>>>>
    AssociationVersionInfo& WithTargetMaps(TargetMapsT&& value) { SetTargetMaps(std::forward<TargetMapsT>(value)); return *this;}
    template<typename TargetMapsT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
    AssociationVersionInfo& AddTargetMaps(TargetMapsT&& value) { m_targetMapsHasBeenSet = true; m_targetMaps.emplace_back(std::forward<TargetMapsT>(value)); return *this; }
    ///@}
  private:
