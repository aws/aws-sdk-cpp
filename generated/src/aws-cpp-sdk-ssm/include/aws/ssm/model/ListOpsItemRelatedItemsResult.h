...
class ListOpsItemRelatedItemsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListOpsItemRelatedItemsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SummariesT = Aws::Vector<OpsItemRelatedItemSummary>>
  ListOpsItemRelatedItemsResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = OpsItemRelatedItemSummary>
  ListOpsItemRelatedItemsResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListOpsItemRelatedItemsResult& WithRequestId(RequestIdT&& value) {
