...
class DescribeActivationsFilter {
 public:
  ...
  inline void SetFilterKey(DescribeActivationsFilterKeys value) {
    m_filterKeyHasBeenSet = true;
    m_filterKey = value;
  }
  inline DescribeActivationsFilter& WithFilterKey(DescribeActivationsFilterKeys value) {
    SetFilterKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterValuesT = Aws::Vector<Aws::String>>
  DescribeActivationsFilter& WithFilterValues(FilterValuesT&& value) {
    SetFilterValues(std::forward<FilterValuesT>(value));
    return *this;
  }
  template <typename FilterValuesT = Aws::String>
  DescribeActivationsFilter& AddFilterValues(FilterValuesT&& value) {
    m_filterValuesHasBeenSet = true;
