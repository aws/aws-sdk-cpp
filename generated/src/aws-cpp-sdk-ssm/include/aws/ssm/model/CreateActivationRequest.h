...
class CreateActivationRequest : public SSMRequest {
 public:
  ...
  inline CreateActivationRequest& WithRegistrationLimit(int value) {
  ...
  void SetRegistrationMetadata(RegistrationMetadataT&& value) {
    m_registrationMetadataHasBeenSet = true;
    m_registrationMetadata = std::forward<RegistrationMetadataT>(value);
  }
  template <typename RegistrationMetadataT = Aws::Vector<RegistrationMetadataItem>>
  CreateActivationRequest& WithRegistrationMetadata(RegistrationMetadataT&& value) {
    SetRegistrationMetadata(std::forward<RegistrationMetadataT>(value));
    return *this;
  }
  ...
  CreateActivationRequest& AddRegistrationMetadata(RegistrationMetadataT&& value) {
    m_registrationMetadataHasBeenSet = true;
    m_registrationMetadata.emplace_back(std::forward<RegistrationMetadataT>(value));
    return *this;
  }
  ///@}
 private:
