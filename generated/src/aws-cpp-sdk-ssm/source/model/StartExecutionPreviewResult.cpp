...
StartExecutionPreviewResult::StartExecutionPreviewResult()
{
}

StartExecutionPreviewResult::StartExecutionPreviewResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
