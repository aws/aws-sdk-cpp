...
UpdatePatchBaselineResult::UpdatePatchBaselineResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
UpdatePatchBaselineResult& UpdatePatchBaselineResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ApprovedPatchesComplianceLevel")) {
    m_approvedPatchesComplianceLevel =
        PatchComplianceLevelMapper::GetPatchComplianceLevelForName(jsonValue.GetString("ApprovedPatchesComplianceLevel"));
  ...
  if (jsonValue.ValueExists("AvailableSecurityUpdatesComplianceStatus")) {
    m_availableSecurityUpdatesComplianceStatus =
        PatchComplianceStatusMapper::GetPatchComplianceStatusForName(jsonValue.GetString("AvailableSecurityUpdatesComplianceStatus"));
