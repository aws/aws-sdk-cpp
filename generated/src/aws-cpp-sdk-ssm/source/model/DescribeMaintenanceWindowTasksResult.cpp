...
DescribeMaintenanceWindowTasksResult::DescribeMaintenanceWindowTasksResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeMaintenanceWindowTasksResult& DescribeMaintenanceWindowTasksResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
