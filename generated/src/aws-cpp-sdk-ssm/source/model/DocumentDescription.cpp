...
DocumentDescription::DocumentDescription(JsonView jsonValue) { *this = jsonValue; }
...
DocumentDescription& DocumentDescription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AttachmentsInformation")) {
    ...
    for (unsigned attachmentsInformationIndex = 0; attachmentsInformationIndex < attachmentsInformationJsonList.GetLength();
         ++attachmentsInformationIndex) {
