...
Aws::String DescribeMaintenanceWindowExecutionTasksRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection DescribeMaintenanceWindowExecutionTasksRequest::GetRequestSpecificHeaders() const
{
  ...
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AmazonSSM.DescribeMaintenanceWindowExecutionTasks"));
  return headers;
