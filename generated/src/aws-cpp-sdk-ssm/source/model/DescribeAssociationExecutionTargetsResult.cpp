...
DescribeAssociationExecutionTargetsResult& DescribeAssociationExecutionTargetsResult::operator=(
  ...
  if (jsonValue.ValueExists("AssociationExecutionTargets")) {
    ...
    for (unsigned associationExecutionTargetsIndex = 0; associationExecutionTargetsIndex < associationExecutionTargetsJsonList.GetLength();
         ++associationExecutionTargetsIndex) {
