...
Aws::String DescribeInstancePropertiesRequest::SerializePayload() const {
  ...
  if (m_instancePropertyFilterListHasBeenSet) {
    ...
    for (unsigned instancePropertyFilterListIndex = 0; instancePropertyFilterListIndex < instancePropertyFilterListJsonList.GetLength();
         ++instancePropertyFilterListIndex) {
      instancePropertyFilterListJsonList[instancePropertyFilterListIndex].AsObject(
          m_instancePropertyFilterList[instancePropertyFilterListIndex].Jsonize());
    }
  ...
  if (m_filtersWithOperatorHasBeenSet) {
    ...
    for (unsigned filtersWithOperatorIndex = 0; filtersWithOperatorIndex < filtersWithOperatorJsonList.GetLength();
         ++filtersWithOperatorIndex) {
