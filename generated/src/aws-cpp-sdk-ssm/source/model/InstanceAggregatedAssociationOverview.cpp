...
InstanceAggregatedAssociationOverview::InstanceAggregatedAssociationOverview(JsonView jsonValue) { *this = jsonValue; }
...
InstanceAggregatedAssociationOverview& InstanceAggregatedAssociationOverview::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("InstanceAssociationStatusAggregatedCount")) {
    Aws::Map<Aws::String, JsonView> instanceAssociationStatusAggregatedCountJsonMap =
        jsonValue.GetObject("InstanceAssociationStatusAggregatedCount").GetAllObjects();
    for (auto& instanceAssociationStatusAggregatedCountItem : instanceAssociationStatusAggregatedCountJsonMap) {
      m_instanceAssociationStatusAggregatedCount[instanceAssociationStatusAggregatedCountItem.first] =
          instanceAssociationStatusAggregatedCountItem.second.AsInteger();
    }
...
JsonValue InstanceAggregatedAssociationOverview::Jsonize() const {
  ...
  if (m_instanceAssociationStatusAggregatedCountHasBeenSet) {
    ...
    for (auto& instanceAssociationStatusAggregatedCountItem : m_instanceAssociationStatusAggregatedCount) {
      instanceAssociationStatusAggregatedCountJsonMap.WithInteger(instanceAssociationStatusAggregatedCountItem.first,
                                                                  instanceAssociationStatusAggregatedCountItem.second);
    }
