...
Aws::String DescribeInstanceInformationRequest::SerializePayload() const {
  ...
  if (m_instanceInformationFilterListHasBeenSet) {
    ...
    for (unsigned instanceInformationFilterListIndex = 0;
         instanceInformationFilterListIndex < instanceInformationFilterListJsonList.GetLength(); ++instanceInformationFilterListIndex) {
      instanceInformationFilterListJsonList[instanceInformationFilterListIndex].AsObject(
          m_instanceInformationFilterList[instanceInformationFilterListIndex].Jsonize());
    }
