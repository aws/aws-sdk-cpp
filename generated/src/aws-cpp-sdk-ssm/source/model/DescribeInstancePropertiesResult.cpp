...
DescribeInstancePropertiesResult::DescribeInstancePropertiesResult()
{
}

DescribeInstancePropertiesResult::DescribeInstancePropertiesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeInstancePropertiesResult& DescribeInstancePropertiesResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
