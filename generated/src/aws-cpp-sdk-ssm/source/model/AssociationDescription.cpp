...
AssociationDescription::AssociationDescription(JsonView jsonValue) { *this = jsonValue; }
...
AssociationDescription& AssociationDescription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ComplianceSeverity")) {
    m_complianceSeverity =
        AssociationComplianceSeverityMapper::GetAssociationComplianceSeverityForName(jsonValue.GetString("ComplianceSeverity"));
...
JsonValue AssociationDescription::Jsonize() const {
  ...
  if (m_complianceSeverityHasBeenSet) {
    payload.WithString("ComplianceSeverity",
                       AssociationComplianceSeverityMapper::GetNameForAssociationComplianceSeverity(m_complianceSeverity));
  }
