...
DescribeMaintenanceWindowScheduleResult& DescribeMaintenanceWindowScheduleResult::operator=(
  ...
  if (jsonValue.ValueExists("ScheduledWindowExecutions")) {
    ...
    for (unsigned scheduledWindowExecutionsIndex = 0; scheduledWindowExecutionsIndex < scheduledWindowExecutionsJsonList.GetLength();
         ++scheduledWindowExecutionsIndex) {
      m_scheduledWindowExecutions.push_back(scheduledWindowExecutionsJsonList[scheduledWindowExecutionsIndex].AsObject());
    }
    m_scheduledWindowExecutionsHasBeenSet = true;
  }
