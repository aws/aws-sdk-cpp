...
Aws::String UpdatePatchBaselineRequest::SerializePayload() const {
  ...
  if (m_approvedPatchesComplianceLevelHasBeenSet) {
    payload.WithString("ApprovedPatchesComplianceLevel",
                       PatchComplianceLevelMapper::GetNameForPatchComplianceLevel(m_approvedPatchesComplianceLevel));
  }
  ...
  if (m_availableSecurityUpdatesComplianceStatusHasBeenSet) {
    payload.WithString("AvailableSecurityUpdatesComplianceStatus",
                       PatchComplianceStatusMapper::GetNameForPatchComplianceStatus(m_availableSecurityUpdatesComplianceStatus));
  }
