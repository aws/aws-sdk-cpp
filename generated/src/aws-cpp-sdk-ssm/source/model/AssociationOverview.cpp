...
AssociationOverview::AssociationOverview(JsonView jsonValue) { *this = jsonValue; }
...
AssociationOverview& AssociationOverview::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AssociationStatusAggregatedCount")) {
    Aws::Map<Aws::String, JsonView> associationStatusAggregatedCountJsonMap =
        jsonValue.GetObject("AssociationStatusAggregatedCount").GetAllObjects();
    for (auto& associationStatusAggregatedCountItem : associationStatusAggregatedCountJsonMap) {
      m_associationStatusAggregatedCount[associationStatusAggregatedCountItem.first] =
          associationStatusAggregatedCountItem.second.AsInteger();
    }
...
JsonValue AssociationOverview::Jsonize() const {
  ...
  if (m_associationStatusAggregatedCountHasBeenSet) {
    ...
    for (auto& associationStatusAggregatedCountItem : m_associationStatusAggregatedCount) {
      associationStatusAggregatedCountJsonMap.WithInteger(associationStatusAggregatedCountItem.first,
                                                          associationStatusAggregatedCountItem.second);
    }
