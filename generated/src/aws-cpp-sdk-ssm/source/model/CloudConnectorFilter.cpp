...
CloudConnectorFilter::CloudConnectorFilter(JsonView jsonValue) { *this = jsonValue; }

CloudConnectorFilter& CloudConnectorFilter::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("FilterKey")) {
    m_filterKey = CloudConnectorFilterKeyMapper::GetCloudConnectorFilterKeyForName(jsonValue.GetString("FilterKey"));
...
JsonValue CloudConnectorFilter::Jsonize() const {
  JsonValue payload;

  if (m_filterKeyHasBeenSet) {
    payload.WithString("FilterKey", CloudConnectorFilterKeyMapper::GetNameForCloudConnectorFilterKey(m_filterKey));
  }
