...
namespace SSM
{
const size_t SSMEndpointRules::RulesBlobStrLen = 3935;
const size_t SSMEndpointRules::RulesBlobSize = 3936;
...
's','s','m','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.','c','o',
...
's',':','/','/','s','s','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
