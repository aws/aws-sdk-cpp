...
namespace SSM {
template <>
AWS_SSM_API ServiceQuotaExceededException SSMError::GetModeledError() {
  assert(this->GetErrorType() == SSMErrors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_SSM_API OpsItemRelatedItemAlreadyExistsException SSMError::GetModeledError() {
...
template <>
AWS_SSM_API ResourcePolicyLimitExceededException SSMError::GetModeledError() {
...
template <>
AWS_SSM_API ResourceDataSyncNotFoundException SSMError::GetModeledError() {
...
template <>
AWS_SSM_API OpsItemAlreadyExistsException SSMError::GetModeledError() {
  assert(this->GetErrorType() == SSMErrors::OPS_ITEM_ALREADY_EXISTS);
  return OpsItemAlreadyExistsException(this->GetJsonPayload().View());
}

template <>
AWS_SSM_API ResourcePolicyInvalidParameterException SSMError::GetModeledError() {
...
template <>
AWS_SSM_API ItemSizeLimitExceededException SSMError::GetModeledError() {
...
template <>
AWS_SSM_API ThrottlingException SSMError::GetModeledError() {
  assert(this->GetErrorType() == SSMErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_SSM_API UnsupportedInventoryItemContextException SSMError::GetModeledError() {
...
template <>
AWS_SSM_API ValidationException SSMError::GetModeledError() {
  assert(this->GetErrorType() == SSMErrors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_SSM_API ResourceDataSyncAlreadyExistsException SSMError::GetModeledError() {
...
static const int OPS_ITEM_RELATED_ITEM_ASSOCIATION_NOT_FOUND_HASH =
    HashingUtils::HashString("OpsItemRelatedItemAssociationNotFoundException");
...
static bool GetErrorForNameHelper0(int hashCode, AWSError<CoreErrors>& error) {
  if (hashCode == INVALID_OUTPUT_LOCATION_HASH) {
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(SSMErrors::OPS_ITEM_RELATED_ITEM_ASSOCIATION_NOT_FOUND), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(SSMErrors::INVALID_INSTANCE_INFORMATION_FILTER_VALUE), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(SSMErrors::RESOURCE_DATA_SYNC_INVALID_CONFIGURATION), RetryableType::NOT_RETRYABLE);
    return true;
