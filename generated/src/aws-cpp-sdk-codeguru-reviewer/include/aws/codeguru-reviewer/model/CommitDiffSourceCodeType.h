...
class CommitDiffSourceCodeType {
 public:
  ...
  template <typename SourceCommitT = Aws::String>
  CommitDiffSourceCodeType& WithSourceCommit(SourceCommitT&& value) {
  ...
  template <typename DestinationCommitT = Aws::String>
  CommitDiffSourceCodeType& WithDestinationCommit(DestinationCommitT&& value) {
  ...
  void SetMergeBaseCommit(MergeBaseCommitT&& value) {
    m_mergeBaseCommitHasBeenSet = true;
    m_mergeBaseCommit = std::forward<MergeBaseCommitT>(value);
  }
  template <typename MergeBaseCommitT = Aws::String>
  CommitDiffSourceCodeType& WithMergeBaseCommit(MergeBaseCommitT&& value) {
    SetMergeBaseCommit(std::forward<MergeBaseCommitT>(value));
    return *this;
  }
  ///@}
 private:
