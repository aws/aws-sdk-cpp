...
class ListRepositoryAssociationsRequest : public CodeGuruReviewerRequest {
 public:
  ...
  template <typename ProviderTypesT = Aws::Vector<ProviderType>>
  ListRepositoryAssociationsRequest& WithProviderTypes(ProviderTypesT&& value) {
    SetProviderTypes(std::forward<ProviderTypesT>(value));
    return *this;
  }
  inline ListRepositoryAssociationsRequest& AddProviderTypes(ProviderType value) {
    m_providerTypesHasBeenSet = true;
    m_providerTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatesT = Aws::Vector<RepositoryAssociationState>>
  ListRepositoryAssociationsRequest& WithStates(StatesT&& value) {
    SetStates(std::forward<StatesT>(value));
    return *this;
  }
  inline ListRepositoryAssociationsRequest& AddStates(RepositoryAssociationState value) {
    m_statesHasBeenSet = true;
  ...
  template <typename NamesT = Aws::Vector<Aws::String>>
  ListRepositoryAssociationsRequest& WithNames(NamesT&& value) {
    SetNames(std::forward<NamesT>(value));
    return *this;
  }
  template <typename NamesT = Aws::String>
  ListRepositoryAssociationsRequest& AddNames(NamesT&& value) {
    m_namesHasBeenSet = true;
  ...
  template <typename OwnersT = Aws::Vector<Aws::String>>
  ListRepositoryAssociationsRequest& WithOwners(OwnersT&& value) {
    SetOwners(std::forward<OwnersT>(value));
    return *this;
  }
  template <typename OwnersT = Aws::String>
  ListRepositoryAssociationsRequest& AddOwners(OwnersT&& value) {
    m_ownersHasBeenSet = true;
  ...
  inline ListRepositoryAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRepositoryAssociationsRequest& WithNextToken(NextTokenT&& value) {
