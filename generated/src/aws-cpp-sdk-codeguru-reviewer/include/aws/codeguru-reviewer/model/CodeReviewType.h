...
class CodeReviewType {
 public:
  ...
  void SetRepositoryAnalysis(RepositoryAnalysisT&& value) {
    m_repositoryAnalysisHasBeenSet = true;
    m_repositoryAnalysis = std::forward<RepositoryAnalysisT>(value);
  }
  template <typename RepositoryAnalysisT = RepositoryAnalysis>
  CodeReviewType& WithRepositoryAnalysis(RepositoryAnalysisT&& value) {
    SetRepositoryAnalysis(std::forward<RepositoryAnalysisT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AnalysisTypesT = Aws::Vector<AnalysisType>>
  CodeReviewType& WithAnalysisTypes(AnalysisTypesT&& value) {
    SetAnalysisTypes(std::forward<AnalysisTypesT>(value));
    return *this;
  }
  inline CodeReviewType& AddAnalysisTypes(AnalysisType value) {
    m_analysisTypesHasBeenSet = true;
