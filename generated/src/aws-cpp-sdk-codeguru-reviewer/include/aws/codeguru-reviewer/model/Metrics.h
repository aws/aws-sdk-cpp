...
class Metrics {
 public:
  ...
  inline Metrics& WithMeteredLinesOfCodeCount(long long value) {
  ...
  inline Metrics& WithSuppressedLinesOfCodeCount(long long value) {
  ...
  inline Metrics& WithFindingsCount(long long value) {
