...
class ListCodeReviewsRequest : public CodeGuruReviewerRequest {
 public:
  ...
  inline ListCodeReviewsRequest& AddProviderTypes(ProviderType value) {
    m_providerTypesHasBeenSet = true;
  ...
  inline ListCodeReviewsRequest& AddStates(JobState value) {
    m_statesHasBeenSet = true;
  ...
  inline ListCodeReviewsRequest& WithType(Type value) {
    SetType(value);
    return *this;
  }
  ///@}
