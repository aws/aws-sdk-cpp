...
class MetricsSummary {
 public:
  ...
  inline void SetMeteredLinesOfCodeCount(long long value) {
    m_meteredLinesOfCodeCountHasBeenSet = true;
    m_meteredLinesOfCodeCount = value;
  }
  inline MetricsSummary& WithMeteredLinesOfCodeCount(long long value) {
    SetMeteredLinesOfCodeCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSuppressedLinesOfCodeCount(long long value) {
    m_suppressedLinesOfCodeCountHasBeenSet = true;
    m_suppressedLinesOfCodeCount = value;
  }
  inline MetricsSummary& WithSuppressedLinesOfCodeCount(long long value) {
    SetSuppressedLinesOfCodeCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFindingsCount(long long value) {
    m_findingsCountHasBeenSet = true;
    m_findingsCount = value;
  }
  inline MetricsSummary& WithFindingsCount(long long value) {
    SetFindingsCount(value);
    return *this;
  }
  ///@}
 private:
