...
class DescribeRecommendationFeedbackRequest : public CodeGuruReviewerRequest {
 public:
  ...
  template <typename CodeReviewArnT = Aws::String>
  DescribeRecommendationFeedbackRequest& WithCodeReviewArn(CodeReviewArnT&& value) {
  ...
  template <typename RecommendationIdT = Aws::String>
  DescribeRecommendationFeedbackRequest& WithRecommendationId(RecommendationIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  DescribeRecommendationFeedbackRequest& WithUserId(UserIdT&& value) {
