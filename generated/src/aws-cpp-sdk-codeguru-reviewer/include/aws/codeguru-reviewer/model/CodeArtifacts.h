...
class CodeArtifacts {
 public:
  ...
  void SetSourceCodeArtifactsObjectKey(SourceCodeArtifactsObjectKeyT&& value) {
    ...
    m_sourceCodeArtifactsObjectKey = std::forward<SourceCodeArtifactsObjectKeyT>(value);
  }
  template <typename SourceCodeArtifactsObjectKeyT = Aws::String>
  CodeArtifacts& WithSourceCodeArtifactsObjectKey(SourceCodeArtifactsObjectKeyT&& value) {
    SetSourceCodeArtifactsObjectKey(std::forward<SourceCodeArtifactsObjectKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBuildArtifactsObjectKey(BuildArtifactsObjectKeyT&& value) {
    ...
    m_buildArtifactsObjectKey = std::forward<BuildArtifactsObjectKeyT>(value);
  }
  template <typename BuildArtifactsObjectKeyT = Aws::String>
  CodeArtifacts& WithBuildArtifactsObjectKey(BuildArtifactsObjectKeyT&& value) {
    SetBuildArtifactsObjectKey(std::forward<BuildArtifactsObjectKeyT>(value));
    return *this;
  }
  ///@}
 private:
