...
namespace Model
{
  ...
  public:
    ...
    template<typename RepositoryAssociationT = RepositoryAssociation>
    AssociateRepositoryResult& WithRepositoryAssociation(RepositoryAssociationT&& value) { SetRepositoryAssociation(std::forward<RepositoryAssociationT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    AssociateRepositoryResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    AssociateRepositoryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
