...
class DescribeRecommendationFeedbackResult {
 public:
  ...
  AWS_CODEGURUREVIEWER_API DescribeRecommendationFeedbackResult& operator=(
  ...
  void SetRecommendationFeedback(RecommendationFeedbackT&& value) {
    m_recommendationFeedbackHasBeenSet = true;
    m_recommendationFeedback = std::forward<RecommendationFeedbackT>(value);
  }
  template <typename RecommendationFeedbackT = RecommendationFeedback>
  DescribeRecommendationFeedbackResult& WithRecommendationFeedback(RecommendationFeedbackT&& value) {
    SetRecommendationFeedback(std::forward<RecommendationFeedbackT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRecommendationFeedbackResult& WithRequestId(RequestIdT&& value) {
