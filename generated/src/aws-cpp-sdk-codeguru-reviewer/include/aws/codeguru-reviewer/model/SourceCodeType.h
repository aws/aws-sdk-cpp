...
class SourceCodeType {
 public:
  ...
  void SetCommitDiff(CommitDiffT&& value) {
    m_commitDiffHasBeenSet = true;
    m_commitDiff = std::forward<CommitDiffT>(value);
  }
  template <typename CommitDiffT = CommitDiffSourceCodeType>
  SourceCodeType& WithCommitDiff(CommitDiffT&& value) {
    SetCommitDiff(std::forward<CommitDiffT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RepositoryHeadT = RepositoryHeadSourceCodeType>
  SourceCodeType& WithRepositoryHead(RepositoryHeadT&& value) {
  ...
  void SetBranchDiff(BranchDiffT&& value) {
    m_branchDiffHasBeenSet = true;
    m_branchDiff = std::forward<BranchDiffT>(value);
  }
  template <typename BranchDiffT = BranchDiffSourceCodeType>
  SourceCodeType& WithBranchDiff(BranchDiffT&& value) {
    SetBranchDiff(std::forward<BranchDiffT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3BucketRepository(S3BucketRepositoryT&& value) {
    m_s3BucketRepositoryHasBeenSet = true;
    m_s3BucketRepository = std::forward<S3BucketRepositoryT>(value);
  }
  template <typename S3BucketRepositoryT = S3BucketRepository>
  SourceCodeType& WithS3BucketRepository(S3BucketRepositoryT&& value) {
    SetS3BucketRepository(std::forward<S3BucketRepositoryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestMetadataT = RequestMetadata>
  SourceCodeType& WithRequestMetadata(RequestMetadataT&& value) {
