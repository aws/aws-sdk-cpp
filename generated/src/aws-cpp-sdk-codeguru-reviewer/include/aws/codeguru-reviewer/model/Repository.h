...
class Repository {
 public:
  ...
  void SetCodeCommit(CodeCommitT&& value) {
    ...
    m_codeCommit = std::forward<CodeCommitT>(value);
  }
  template <typename CodeCommitT = CodeCommitRepository>
  Repository& WithCodeCommit(CodeCommitT&& value) {
    SetCodeCommit(std::forward<CodeCommitT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGitHubEnterpriseServer(GitHubEnterpriseServerT&& value) {
    ...
    m_gitHubEnterpriseServer = std::forward<GitHubEnterpriseServerT>(value);
  }
  template <typename GitHubEnterpriseServerT = ThirdPartySourceRepository>
  Repository& WithGitHubEnterpriseServer(GitHubEnterpriseServerT&& value) {
    SetGitHubEnterpriseServer(std::forward<GitHubEnterpriseServerT>(value));
    return *this;
  }
  ///@}
