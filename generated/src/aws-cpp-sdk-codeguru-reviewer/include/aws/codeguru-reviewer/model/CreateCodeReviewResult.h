...
class CreateCodeReviewResult {
 public:
  AWS_CODEGURUREVIEWER_API CreateCodeReviewResult() = default;
  ...
  void SetCodeReview(CodeReviewT&& value) {
    m_codeReviewHasBeenSet = true;
    m_codeReview = std::forward<CodeReviewT>(value);
  }
  template <typename CodeReviewT = CodeReview>
  CreateCodeReviewResult& WithCodeReview(CodeReviewT&& value) {
    SetCodeReview(std::forward<CodeReviewT>(value));
    return *this;
  }
  ///@}
