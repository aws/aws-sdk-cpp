...
class ListRecommendationFeedbackRequest : public CodeGuruReviewerRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListRecommendationFeedbackRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRecommendationFeedbackRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename CodeReviewArnT = Aws::String>
  ListRecommendationFeedbackRequest& WithCodeReviewArn(CodeReviewArnT&& value) {
  ...
  template <typename UserIdsT = Aws::Vector<Aws::String>>
  ListRecommendationFeedbackRequest& WithUserIds(UserIdsT&& value) {
    SetUserIds(std::forward<UserIdsT>(value));
    return *this;
  }
  template <typename UserIdsT = Aws::String>
  ListRecommendationFeedbackRequest& AddUserIds(UserIdsT&& value) {
    m_userIdsHasBeenSet = true;
  ...
  template <typename RecommendationIdsT = Aws::Vector<Aws::String>>
  ListRecommendationFeedbackRequest& WithRecommendationIds(RecommendationIdsT&& value) {
    SetRecommendationIds(std::forward<RecommendationIdsT>(value));
    return *this;
  }
  template <typename RecommendationIdsT = Aws::String>
  ListRecommendationFeedbackRequest& AddRecommendationIds(RecommendationIdsT&& value) {
    m_recommendationIdsHasBeenSet = true;
