...
namespace CodeGuruReviewer
{
   ...
   */
  class AWS_CODEGURUREVIEWER_API CodeGuruReviewerClient : Aws::Client::ClientWithAsyncTemplateMethods<CodeGuruReviewerClient>,
    smithy::client::AwsSmithyClientT<Aws::CodeGuruReviewer::SERVICE_NAME,
