...
class AWS_CODEGURUREVIEWER_API CodeGuruReviewerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CodeGuruReviewerClient(const Aws::CodeGuruReviewer::CodeGuruReviewerClientConfiguration& clientConfiguration =
  ...
  CodeGuruReviewerClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<CodeGuruReviewerEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::CodeGuruReviewer::CodeGuruReviewerClientConfiguration& clientConfiguration =
                             Aws::CodeGuruReviewer::CodeGuruReviewerClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateRepository that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateRepository that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociateRepositoryRequestT = Model::AssociateRepositoryRequest>
  void AssociateRepositoryAsync(const AssociateRepositoryRequestT& request, const AssociateRepositoryResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeCodeReview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCodeReview that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeCodeReviewRequestT = Model::DescribeCodeReviewRequest>
  void DescribeCodeReviewAsync(const DescribeCodeReviewRequestT& request, const DescribeCodeReviewResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeRecommendationFeedbackOutcome DescribeRecommendationFeedback(
      const Model::DescribeRecommendationFeedbackRequest& request) const;

  /**
   * A Callable wrapper for DescribeRecommendationFeedback that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRecommendationFeedbackRequestT = Model::DescribeRecommendationFeedbackRequest>
  Model::DescribeRecommendationFeedbackOutcomeCallable DescribeRecommendationFeedbackCallable(
      const DescribeRecommendationFeedbackRequestT& request) const {
    return SubmitCallable(&CodeGuruReviewerClient::DescribeRecommendationFeedback, request);
  }

  /**
   * An Async wrapper for DescribeRecommendationFeedback that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeRecommendationFeedbackRequestT = Model::DescribeRecommendationFeedbackRequest>
  void DescribeRecommendationFeedbackAsync(const DescribeRecommendationFeedbackRequestT& request,
  ...
  virtual Model::DescribeRepositoryAssociationOutcome DescribeRepositoryAssociation(
      const Model::DescribeRepositoryAssociationRequest& request) const;

  /**
   * A Callable wrapper for DescribeRepositoryAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRepositoryAssociationRequestT = Model::DescribeRepositoryAssociationRequest>
  Model::DescribeRepositoryAssociationOutcomeCallable DescribeRepositoryAssociationCallable(
      const DescribeRepositoryAssociationRequestT& request) const {
    return SubmitCallable(&CodeGuruReviewerClient::DescribeRepositoryAssociation, request);
  }

  /**
   * An Async wrapper for DescribeRepositoryAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRepositoryAssociationRequestT = Model::DescribeRepositoryAssociationRequest>
  void DescribeRepositoryAssociationAsync(const DescribeRepositoryAssociationRequestT& request,
  ...
  /**
   * A Callable wrapper for DisassociateRepository that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateRepository that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateRepositoryRequestT = Model::DisassociateRepositoryRequest>
  void DisassociateRepositoryAsync(const DisassociateRepositoryRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRecommendationFeedbackOutcome ListRecommendationFeedback(
      const Model::ListRecommendationFeedbackRequest& request) const;

  /**
   * A Callable wrapper for ListRecommendationFeedback that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRecommendationFeedbackRequestT = Model::ListRecommendationFeedbackRequest>
  Model::ListRecommendationFeedbackOutcomeCallable ListRecommendationFeedbackCallable(
      const ListRecommendationFeedbackRequestT& request) const {
    return SubmitCallable(&CodeGuruReviewerClient::ListRecommendationFeedback, request);
  }

  /**
   * An Async wrapper for ListRecommendationFeedback that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRecommendationFeedbackRequestT = Model::ListRecommendationFeedbackRequest>
  void ListRecommendationFeedbackAsync(const ListRecommendationFeedbackRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRepositoryAssociationsOutcome ListRepositoryAssociations(
      const Model::ListRepositoryAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListRepositoryAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRepositoryAssociationsRequestT = Model::ListRepositoryAssociationsRequest>
  Model::ListRepositoryAssociationsOutcomeCallable ListRepositoryAssociationsCallable(
      const ListRepositoryAssociationsRequestT& request = {}) const {
    return SubmitCallable(&CodeGuruReviewerClient::ListRepositoryAssociations, request);
  }

  /**
   * An Async wrapper for ListRepositoryAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRepositoryAssociationsRequestT = Model::ListRepositoryAssociationsRequest>
  void ListRepositoryAssociationsAsync(const ListRepositoryAssociationsResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for PutRecommendationFeedback that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename PutRecommendationFeedbackRequestT = Model::PutRecommendationFeedbackRequest>
  Model::PutRecommendationFeedbackOutcomeCallable PutRecommendationFeedbackCallable(
      const PutRecommendationFeedbackRequestT& request) const {
    return SubmitCallable(&CodeGuruReviewerClient::PutRecommendationFeedback, request);
  }

  /**
   * An Async wrapper for PutRecommendationFeedback that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRecommendationFeedbackRequestT = Model::PutRecommendationFeedbackRequest>
  void PutRecommendationFeedbackAsync(const PutRecommendationFeedbackRequestT& request,
