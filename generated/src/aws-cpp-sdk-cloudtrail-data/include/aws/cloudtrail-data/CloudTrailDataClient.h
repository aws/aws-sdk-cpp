...
namespace CloudTrailData
{
   ...
   */
  class AWS_CLOUDTRAILDATA_API CloudTrailDataClient : Aws::Client::ClientWithAsyncTemplateMethods<CloudTrailDataClient>,
    smithy::client::AwsSmithyClientT<Aws::CloudTrailData::SERVICE_NAME,
