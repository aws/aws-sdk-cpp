...
class AWS_CLOUDTRAILDATA_API CloudTrailDataClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CloudTrailDataClient(const Aws::CloudTrailData::CloudTrailDataClientConfiguration& clientConfiguration =
  ...
  CloudTrailDataClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<CloudTrailDataEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::CloudTrailData::CloudTrailDataClientConfiguration& clientConfiguration =
                           Aws::CloudTrailData::CloudTrailDataClientConfiguration());
  ...
  /**
   * An Async wrapper for PutAuditEvents that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutAuditEventsRequestT = Model::PutAuditEventsRequest>
  void PutAuditEventsAsync(const PutAuditEventsRequestT& request, const PutAuditEventsResponseReceivedHandler& handler,
