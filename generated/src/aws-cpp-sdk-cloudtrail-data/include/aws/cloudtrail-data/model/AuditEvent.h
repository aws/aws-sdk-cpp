...
class AuditEvent {
 public:
  ...
  template <typename EventDataT = Aws::String>
  AuditEvent& WithEventData(EventDataT&& value) {
  ...
  void SetEventDataChecksum(EventDataChecksumT&& value) {
    m_eventDataChecksumHasBeenSet = true;
    m_eventDataChecksum = std::forward<EventDataChecksumT>(value);
  }
  template <typename EventDataChecksumT = Aws::String>
  AuditEvent& WithEventDataChecksum(EventDataChecksumT&& value) {
    SetEventDataChecksum(std::forward<EventDataChecksumT>(value));
    return *this;
  }
  ///@}
