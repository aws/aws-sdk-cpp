...
typedef std::function<void(const CloudTrailDataClient*, const Model::PutAuditEventsRequest&, const Model::PutAuditEventsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutAuditEventsResponseReceivedHandler;
