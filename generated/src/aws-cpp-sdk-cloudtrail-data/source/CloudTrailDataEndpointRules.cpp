...
{
const size_t CloudTrailDataEndpointRules::RulesBlobStrLen = 3554;
const size_t CloudTrailDataEndpointRules::RulesBlobSize = 3555;
...
'u','d','t','r','a','i','l','-','d','a','t','a','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','l','o','u','d','t','r','a','i','l','-',
'd','a','t','a','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'"','h','t','t','p','s',':','/','/','c','l','o','u','d','t','r','a','i','l','-','d','a','t','a','.',
...
'd','t','r','a','i','l','-','d','a','t','a','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
const char* CloudTrailDataEndpointRules::GetRulesBlob()
{
