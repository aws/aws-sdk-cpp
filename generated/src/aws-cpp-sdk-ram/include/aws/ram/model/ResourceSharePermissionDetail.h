...
class ResourceSharePermissionDetail {
 public:
  ...
  inline ResourceSharePermissionDetail& WithDefaultVersion(bool value) {
  ...
  inline void SetIsResourceTypeDefault(bool value) {
    m_isResourceTypeDefaultHasBeenSet = true;
    m_isResourceTypeDefault = value;
  }
  inline ResourceSharePermissionDetail& WithIsResourceTypeDefault(bool value) {
    SetIsResourceTypeDefault(value);
    return *this;
  }
  ///@}
  ...
  inline ResourceSharePermissionDetail& WithPermissionType(PermissionType value) {
  ...
  inline void SetFeatureSet(PermissionFeatureSet value) {
    m_featureSetHasBeenSet = true;
    m_featureSet = value;
  }
  inline ResourceSharePermissionDetail& WithFeatureSet(PermissionFeatureSet value) {
    SetFeatureSet(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(PermissionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ResourceSharePermissionDetail& WithStatus(PermissionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
