...
class ListPermissionVersionsResult {
 public:
  ...
  template <typename PermissionsT = Aws::Vector<ResourceSharePermissionSummary>>
  ListPermissionVersionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourceSharePermissionSummary>
  ListPermissionVersionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPermissionVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPermissionVersionsResult& WithRequestId(RequestIdT&& value) {
