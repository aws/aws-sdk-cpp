...
class SetDefaultPermissionVersionResult {
 public:
  ...
  inline SetDefaultPermissionVersionResult& WithReturnValue(bool value) {
  ...
  template <typename ClientTokenT = Aws::String>
  SetDefaultPermissionVersionResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SetDefaultPermissionVersionResult& WithRequestId(RequestIdT&& value) {
