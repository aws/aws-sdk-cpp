...
namespace Model
{
  ...
  {
  public:
    AWS_RAM_API SetDefaultPermissionVersionResult() = default;
    ...
    template<typename ClientTokenT = Aws::String>
    SetDefaultPermissionVersionResult& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SetDefaultPermissionVersionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
