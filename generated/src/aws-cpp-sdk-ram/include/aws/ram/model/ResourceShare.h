...
class ResourceShare {
 public:
  ...
  inline ResourceShare& WithAllowExternalPrincipals(bool value) {
  ...
  inline void SetStatus(ResourceShareStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ResourceShare& WithStatus(ResourceShareStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFeatureSet(ResourceShareFeatureSet value) {
    m_featureSetHasBeenSet = true;
    m_featureSet = value;
  }
  inline ResourceShare& WithFeatureSet(ResourceShareFeatureSet value) {
    SetFeatureSet(value);
    return *this;
  }
  ///@}
