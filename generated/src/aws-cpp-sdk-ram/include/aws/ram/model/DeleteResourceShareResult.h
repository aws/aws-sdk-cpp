...
class DeleteResourceShareResult {
 public:
  ...
  inline DeleteResourceShareResult& WithReturnValue(bool value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteResourceShareResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteResourceShareResult& WithRequestId(RequestIdT&& value) {
