...
class ListPendingInvitationResourcesRequest : public RAMRequest {
 public:
  ...
  template <typename ResourceShareInvitationArnT = Aws::String>
  ListPendingInvitationResourcesRequest& WithResourceShareInvitationArn(ResourceShareInvitationArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPendingInvitationResourcesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPendingInvitationResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListPendingInvitationResourcesRequest& WithResourceRegionScope(ResourceRegionScopeFilter value) {
