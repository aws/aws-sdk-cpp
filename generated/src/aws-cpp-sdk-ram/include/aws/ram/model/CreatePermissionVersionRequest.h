...
class CreatePermissionVersionRequest : public RAMRequest {
 public:
  ...
  template <typename PermissionArnT = Aws::String>
  CreatePermissionVersionRequest& WithPermissionArn(PermissionArnT&& value) {
  ...
  template <typename PolicyTemplateT = Aws::String>
  CreatePermissionVersionRequest& WithPolicyTemplate(PolicyTemplateT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreatePermissionVersionRequest& WithClientToken(ClientTokenT&& value) {
