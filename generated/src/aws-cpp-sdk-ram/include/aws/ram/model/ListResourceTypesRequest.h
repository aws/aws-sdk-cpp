...
class ListResourceTypesRequest : public RAMRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResourceTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListResourceTypesRequest& WithResourceRegionScope(ResourceRegionScopeFilter value) {
