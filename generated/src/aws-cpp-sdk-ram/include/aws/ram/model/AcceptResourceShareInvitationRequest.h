...
class AcceptResourceShareInvitationRequest : public RAMRequest {
 public:
  ...
  template <typename ResourceShareInvitationArnT = Aws::String>
  AcceptResourceShareInvitationRequest& WithResourceShareInvitationArn(ResourceShareInvitationArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  AcceptResourceShareInvitationRequest& WithClientToken(ClientTokenT&& value) {
