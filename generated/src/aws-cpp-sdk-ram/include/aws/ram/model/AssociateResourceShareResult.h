...
class AssociateResourceShareResult {
 public:
  ...
  template <typename ResourceShareAssociationsT = Aws::Vector<ResourceShareAssociation>>
  AssociateResourceShareResult& WithResourceShareAssociations(ResourceShareAssociationsT&& value) {
  ...
  AssociateResourceShareResult& AddResourceShareAssociations(ResourceShareAssociationsT&& value) {
    m_resourceShareAssociationsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  AssociateResourceShareResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateResourceShareResult& WithRequestId(RequestIdT&& value) {
