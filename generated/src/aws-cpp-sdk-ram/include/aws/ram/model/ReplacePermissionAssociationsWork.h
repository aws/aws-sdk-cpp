...
class ReplacePermissionAssociationsWork {
 public:
  ...
  void SetFromPermissionVersion(FromPermissionVersionT&& value) {
    ...
    m_fromPermissionVersion = std::forward<FromPermissionVersionT>(value);
  }
  template <typename FromPermissionVersionT = Aws::String>
  ReplacePermissionAssociationsWork& WithFromPermissionVersion(FromPermissionVersionT&& value) {
    SetFromPermissionVersion(std::forward<FromPermissionVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetToPermissionVersion(ToPermissionVersionT&& value) {
    ...
    m_toPermissionVersion = std::forward<ToPermissionVersionT>(value);
  }
  template <typename ToPermissionVersionT = Aws::String>
  ReplacePermissionAssociationsWork& WithToPermissionVersion(ToPermissionVersionT&& value) {
    SetToPermissionVersion(std::forward<ToPermissionVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReplacePermissionAssociationsWork& WithStatus(ReplacePermissionAssociationsWorkStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
