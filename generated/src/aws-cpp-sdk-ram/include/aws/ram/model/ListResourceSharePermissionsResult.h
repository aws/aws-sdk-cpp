...
class ListResourceSharePermissionsResult {
 public:
  ...
  template <typename PermissionsT = Aws::Vector<ResourceSharePermissionSummary>>
  ListResourceSharePermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourceSharePermissionSummary>
  ListResourceSharePermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceSharePermissionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceSharePermissionsResult& WithRequestId(RequestIdT&& value) {
