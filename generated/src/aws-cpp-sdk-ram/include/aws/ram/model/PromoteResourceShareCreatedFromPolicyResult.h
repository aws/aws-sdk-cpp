...
class PromoteResourceShareCreatedFromPolicyResult {
 public:
  ...
  AWS_RAM_API PromoteResourceShareCreatedFromPolicyResult& operator=(
  ...
  inline PromoteResourceShareCreatedFromPolicyResult& WithReturnValue(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  PromoteResourceShareCreatedFromPolicyResult& WithRequestId(RequestIdT&& value) {
