...
class GetResourceSharesRequest : public RAMRequest {
 public:
  ...
  template <typename ResourceShareArnsT = Aws::Vector<Aws::String>>
  GetResourceSharesRequest& WithResourceShareArns(ResourceShareArnsT&& value) {
    SetResourceShareArns(std::forward<ResourceShareArnsT>(value));
    return *this;
  }
  template <typename ResourceShareArnsT = Aws::String>
  GetResourceSharesRequest& AddResourceShareArns(ResourceShareArnsT&& value) {
    m_resourceShareArnsHasBeenSet = true;
  ...
  inline void SetResourceShareStatus(ResourceShareStatus value) {
    m_resourceShareStatusHasBeenSet = true;
    m_resourceShareStatus = value;
  }
  inline GetResourceSharesRequest& WithResourceShareStatus(ResourceShareStatus value) {
    SetResourceShareStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetResourceSharesRequest& WithResourceOwner(ResourceOwner value) {
  ...
  template <typename NameT = Aws::String>
  GetResourceSharesRequest& WithName(NameT&& value) {
  ...
  template <typename TagFiltersT = Aws::Vector<TagFilter>>
  GetResourceSharesRequest& WithTagFilters(TagFiltersT&& value) {
    SetTagFilters(std::forward<TagFiltersT>(value));
    return *this;
  }
  template <typename TagFiltersT = TagFilter>
  GetResourceSharesRequest& AddTagFilters(TagFiltersT&& value) {
    m_tagFiltersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetResourceSharesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetResourceSharesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename PermissionArnT = Aws::String>
  GetResourceSharesRequest& WithPermissionArn(PermissionArnT&& value) {
  ...
  inline GetResourceSharesRequest& WithPermissionVersion(int value) {
