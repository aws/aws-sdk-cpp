...
class ListResourceSharePermissionsRequest : public RAMRequest {
 public:
  ...
  template <typename ResourceShareArnT = Aws::String>
  ListResourceSharePermissionsRequest& WithResourceShareArn(ResourceShareArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceSharePermissionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResourceSharePermissionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
