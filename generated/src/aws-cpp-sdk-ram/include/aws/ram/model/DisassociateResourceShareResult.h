...
namespace Model
{
  ...
  {
  public:
    AWS_RAM_API DisassociateResourceShareResult();
    ...
    inline DisassociateResourceShareResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateResourceShareResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateResourceShareResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
