...
class DisassociateResourceShareResult {
 public:
  ...
  template <typename ResourceShareAssociationsT = Aws::Vector<ResourceShareAssociation>>
  DisassociateResourceShareResult& WithResourceShareAssociations(ResourceShareAssociationsT&& value) {
  ...
  DisassociateResourceShareResult& AddResourceShareAssociations(ResourceShareAssociationsT&& value) {
    m_resourceShareAssociationsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  DisassociateResourceShareResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateResourceShareResult& WithRequestId(RequestIdT&& value) {
