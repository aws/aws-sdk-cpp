...
class ListPermissionVersionsRequest : public RAMRequest {
 public:
  AWS_RAM_API ListPermissionVersionsRequest() = default;
  ...
  template <typename PermissionArnT = Aws::String>
  ListPermissionVersionsRequest& WithPermissionArn(PermissionArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPermissionVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPermissionVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
