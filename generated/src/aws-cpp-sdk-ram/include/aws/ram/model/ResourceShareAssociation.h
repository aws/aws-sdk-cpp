...
class ResourceShareAssociation {
 public:
  ...
  void SetAssociatedEntity(AssociatedEntityT&& value) {
    ...
    m_associatedEntity = std::forward<AssociatedEntityT>(value);
  }
  template <typename AssociatedEntityT = Aws::String>
  ResourceShareAssociation& WithAssociatedEntity(AssociatedEntityT&& value) {
    SetAssociatedEntity(std::forward<AssociatedEntityT>(value));
    return *this;
  }
  ///@}
  ...
  inline ResourceShareAssociation& WithAssociationType(ResourceShareAssociationType value) {
  ...
  inline void SetStatus(ResourceShareAssociationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ResourceShareAssociation& WithStatus(ResourceShareAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ResourceShareAssociation& WithExternal(bool value) {
    SetExternal(value);
    return *this;
  }
  ///@}
