...
class PromotePermissionCreatedFromPolicyRequest : public RAMRequest {
 public:
  ...
  template <typename PermissionArnT = Aws::String>
  PromotePermissionCreatedFromPolicyRequest& WithPermissionArn(PermissionArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  PromotePermissionCreatedFromPolicyRequest& WithName(NameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  PromotePermissionCreatedFromPolicyRequest& WithClientToken(ClientTokenT&& value) {
