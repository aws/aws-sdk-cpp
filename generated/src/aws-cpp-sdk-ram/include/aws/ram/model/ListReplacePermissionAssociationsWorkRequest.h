...
class ListReplacePermissionAssociationsWorkRequest : public RAMRequest {
 public:
  ...
  void SetWorkIds(WorkIdsT&& value) {
    m_workIdsHasBeenSet = true;
    m_workIds = std::forward<WorkIdsT>(value);
  }
  template <typename WorkIdsT = Aws::Vector<Aws::String>>
  ListReplacePermissionAssociationsWorkRequest& WithWorkIds(WorkIdsT&& value) {
    SetWorkIds(std::forward<WorkIdsT>(value));
    return *this;
  }
  template <typename WorkIdsT = Aws::String>
  ListReplacePermissionAssociationsWorkRequest& AddWorkIds(WorkIdsT&& value) {
    m_workIdsHasBeenSet = true;
    m_workIds.emplace_back(std::forward<WorkIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ReplacePermissionAssociationsWorkStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListReplacePermissionAssociationsWorkRequest& WithStatus(ReplacePermissionAssociationsWorkStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReplacePermissionAssociationsWorkRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListReplacePermissionAssociationsWorkRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
