...
class ListResourcesRequest : public RAMRequest {
 public:
  ...
  inline ListResourcesRequest& WithResourceOwner(ResourceOwner value) {
  ...
  inline void SetResourceRegionScope(ResourceRegionScopeFilter value) {
    m_resourceRegionScopeHasBeenSet = true;
    m_resourceRegionScope = value;
  }
  inline ListResourcesRequest& WithResourceRegionScope(ResourceRegionScopeFilter value) {
