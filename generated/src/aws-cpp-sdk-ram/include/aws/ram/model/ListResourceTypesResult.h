...
class ListResourceTypesResult {
 public:
  ...
  template <typename ResourceTypesT = Aws::Vector<ServiceNameAndResourceType>>
  ListResourceTypesResult& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  template <typename ResourceTypesT = ServiceNameAndResourceType>
  ListResourceTypesResult& AddResourceTypes(ResourceTypesT&& value) {
    m_resourceTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceTypesResult& WithRequestId(RequestIdT&& value) {
