...
class DisassociateResourceShareRequest : public RAMRequest {
 public:
  ...
  template <typename ResourceShareArnT = Aws::String>
  DisassociateResourceShareRequest& WithResourceShareArn(ResourceShareArnT&& value) {
  ...
  template <typename ResourceArnsT = Aws::Vector<Aws::String>>
  DisassociateResourceShareRequest& WithResourceArns(ResourceArnsT&& value) {
    SetResourceArns(std::forward<ResourceArnsT>(value));
    return *this;
  }
  template <typename ResourceArnsT = Aws::String>
  DisassociateResourceShareRequest& AddResourceArns(ResourceArnsT&& value) {
    m_resourceArnsHasBeenSet = true;
  ...
  template <typename PrincipalsT = Aws::Vector<Aws::String>>
  DisassociateResourceShareRequest& WithPrincipals(PrincipalsT&& value) {
    SetPrincipals(std::forward<PrincipalsT>(value));
    return *this;
  }
  template <typename PrincipalsT = Aws::String>
  DisassociateResourceShareRequest& AddPrincipals(PrincipalsT&& value) {
    m_principalsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  DisassociateResourceShareRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename SourcesT = Aws::Vector<Aws::String>>
  DisassociateResourceShareRequest& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = Aws::String>
  DisassociateResourceShareRequest& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
