...
class GetResourceShareInvitationsResult {
 public:
  ...
  void SetResourceShareInvitations(ResourceShareInvitationsT&& value) {
    m_resourceShareInvitationsHasBeenSet = true;
    m_resourceShareInvitations = std::forward<ResourceShareInvitationsT>(value);
  }
  template <typename ResourceShareInvitationsT = Aws::Vector<ResourceShareInvitation>>
  GetResourceShareInvitationsResult& WithResourceShareInvitations(ResourceShareInvitationsT&& value) {
    SetResourceShareInvitations(std::forward<ResourceShareInvitationsT>(value));
    return *this;
  }
  template <typename ResourceShareInvitationsT = ResourceShareInvitation>
  GetResourceShareInvitationsResult& AddResourceShareInvitations(ResourceShareInvitationsT&& value) {
    m_resourceShareInvitationsHasBeenSet = true;
    m_resourceShareInvitations.emplace_back(std::forward<ResourceShareInvitationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetResourceShareInvitationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetResourceShareInvitationsResult& WithRequestId(RequestIdT&& value) {
