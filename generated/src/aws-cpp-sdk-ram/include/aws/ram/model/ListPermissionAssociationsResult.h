...
class ListPermissionAssociationsResult {
 public:
  ...
  template <typename PermissionsT = Aws::Vector<AssociatedPermission>>
  ListPermissionAssociationsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = AssociatedPermission>
  ListPermissionAssociationsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPermissionAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPermissionAssociationsResult& WithRequestId(RequestIdT&& value) {
