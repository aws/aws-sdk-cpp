...
class ServiceNameAndResourceType {
 public:
  ...
  template <typename ResourceTypeT = Aws::String>
  ServiceNameAndResourceType& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ServiceNameT = Aws::String>
  ServiceNameAndResourceType& WithServiceName(ServiceNameT&& value) {
  ...
  inline ServiceNameAndResourceType& WithResourceRegionScope(ResourceRegionScope value) {
