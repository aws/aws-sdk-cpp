...
class ReplacePermissionAssociationsResult {
 public:
   ...
   */
  inline const ReplacePermissionAssociationsWork& GetReplacePermissionAssociationsWork() const {
    return m_replacePermissionAssociationsWork;
  }
  ...
  void SetReplacePermissionAssociationsWork(ReplacePermissionAssociationsWorkT&& value) {
    ...
    m_replacePermissionAssociationsWork = std::forward<ReplacePermissionAssociationsWorkT>(value);
  }
  template <typename ReplacePermissionAssociationsWorkT = ReplacePermissionAssociationsWork>
  ReplacePermissionAssociationsResult& WithReplacePermissionAssociationsWork(ReplacePermissionAssociationsWorkT&& value) {
    SetReplacePermissionAssociationsWork(std::forward<ReplacePermissionAssociationsWorkT>(value));
    return *this;
  }
  ///@}
