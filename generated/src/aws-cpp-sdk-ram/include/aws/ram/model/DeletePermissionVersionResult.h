...
class DeletePermissionVersionResult {
 public:
  ...
  inline DeletePermissionVersionResult& WithReturnValue(bool value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeletePermissionVersionResult& WithClientToken(ClientTokenT&& value) {
  ...
  inline DeletePermissionVersionResult& WithPermissionStatus(PermissionStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeletePermissionVersionResult& WithRequestId(RequestIdT&& value) {
