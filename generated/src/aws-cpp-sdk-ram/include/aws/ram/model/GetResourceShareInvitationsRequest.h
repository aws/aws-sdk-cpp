...
class GetResourceShareInvitationsRequest : public RAMRequest {
 public:
  ...
  void SetResourceShareInvitationArns(ResourceShareInvitationArnsT&& value) {
    m_resourceShareInvitationArnsHasBeenSet = true;
    m_resourceShareInvitationArns = std::forward<ResourceShareInvitationArnsT>(value);
  }
  template <typename ResourceShareInvitationArnsT = Aws::Vector<Aws::String>>
  GetResourceShareInvitationsRequest& WithResourceShareInvitationArns(ResourceShareInvitationArnsT&& value) {
    SetResourceShareInvitationArns(std::forward<ResourceShareInvitationArnsT>(value));
    return *this;
  }
  ...
  GetResourceShareInvitationsRequest& AddResourceShareInvitationArns(ResourceShareInvitationArnsT&& value) {
    m_resourceShareInvitationArnsHasBeenSet = true;
    m_resourceShareInvitationArns.emplace_back(std::forward<ResourceShareInvitationArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetResourceShareInvitationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
