...
class ResourceSharePermissionSummary {
 public:
  ...
  inline ResourceSharePermissionSummary& WithDefaultVersion(bool value) {
  ...
  inline ResourceSharePermissionSummary& WithIsResourceTypeDefault(bool value) {
  ...
  inline ResourceSharePermissionSummary& WithPermissionType(PermissionType value) {
  ...
  inline ResourceSharePermissionSummary& WithFeatureSet(PermissionFeatureSet value) {
    SetFeatureSet(value);
    return *this;
  }
  ///@}
