...
class DeletePermissionVersionRequest : public RAMRequest {
 public:
  ...
  template <typename PermissionArnT = Aws::String>
  DeletePermissionVersionRequest& WithPermissionArn(PermissionArnT&& value) {
  ...
  inline DeletePermissionVersionRequest& WithPermissionVersion(int value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeletePermissionVersionRequest& WithClientToken(ClientTokenT&& value) {
