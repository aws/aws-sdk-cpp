...
class AssociatedPermission {
 public:
  ...
  void SetPermissionVersion(PermissionVersionT&& value) {
    ...
    m_permissionVersion = std::forward<PermissionVersionT>(value);
  }
  template <typename PermissionVersionT = Aws::String>
  AssociatedPermission& WithPermissionVersion(PermissionVersionT&& value) {
    SetPermissionVersion(std::forward<PermissionVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline AssociatedPermission& WithDefaultVersion(bool value) {
  ...
  inline AssociatedPermission& WithFeatureSet(PermissionFeatureSet value) {
    SetFeatureSet(value);
    return *this;
  }
  ///@}
