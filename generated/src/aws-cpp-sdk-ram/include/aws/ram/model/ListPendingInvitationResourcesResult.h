...
class ListPendingInvitationResourcesResult {
 public:
  ...
  template <typename ResourcesT = Aws::Vector<Resource>>
  ListPendingInvitationResourcesResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Resource>
  ListPendingInvitationResourcesResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPendingInvitationResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPendingInvitationResourcesResult& WithRequestId(RequestIdT&& value) {
