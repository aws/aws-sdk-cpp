...
namespace RAM
{
const size_t RAMEndpointRules::RulesBlobStrLen = 3935;
const size_t RAMEndpointRules::RulesBlobSize = 3936;
...
'r','a','m','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.','c','o',
...
's',':','/','/','r','a','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
