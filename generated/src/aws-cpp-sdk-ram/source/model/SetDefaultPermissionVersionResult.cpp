...
SetDefaultPermissionVersionResult::SetDefaultPermissionVersionResult() : 
    m_returnValue(false)
{
}
...
SetDefaultPermissionVersionResult& SetDefaultPermissionVersionResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
