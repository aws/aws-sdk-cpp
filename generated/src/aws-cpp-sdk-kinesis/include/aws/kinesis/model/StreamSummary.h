...
class StreamSummary {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  StreamSummary& WithStreamName(StreamNameT&& value) {
  ...
  inline StreamSummary& WithStreamStatus(StreamStatus value) {
  ...
  template <typename StreamModeDetailsT = StreamModeDetails>
  StreamSummary& WithStreamModeDetails(StreamModeDetailsT&& value) {
  ...
  template <typename StreamCreationTimestampT = Aws::Utils::DateTime>
  StreamSummary& WithStreamCreationTimestamp(StreamCreationTimestampT&& value) {
