...
class UpdateShardCountResult {
 public:
  ...
  inline void SetCurrentShardCount(int value) {
    m_currentShardCountHasBeenSet = true;
    m_currentShardCount = value;
  }
  inline UpdateShardCountResult& WithCurrentShardCount(int value) {
    SetCurrentShardCount(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateShardCountResult& WithTargetShardCount(int value) {
