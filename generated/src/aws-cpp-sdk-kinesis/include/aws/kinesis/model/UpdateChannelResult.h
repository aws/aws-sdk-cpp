...
class UpdateChannelResult {
 public:
  AWS_KINESIS_API UpdateChannelResult() = default;
  AWS_KINESIS_API UpdateChannelResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_KINESIS_API UpdateChannelResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ChannelDescriptionT = ChannelDescription>
  UpdateChannelResult& WithChannelDescription(ChannelDescriptionT&& value) {
