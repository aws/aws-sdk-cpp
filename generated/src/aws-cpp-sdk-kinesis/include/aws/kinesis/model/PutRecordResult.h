...
class PutRecordResult {
 public:
  ...
  template <typename ShardIdT = Aws::String>
  PutRecordResult& WithShardId(ShardIdT&& value) {
  ...
  template <typename SequenceNumberT = Aws::String>
  PutRecordResult& WithSequenceNumber(SequenceNumberT&& value) {
  ...
  inline PutRecordResult& WithEncryptionType(EncryptionType value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutRecordResult& WithRequestId(RequestIdT&& value) {
