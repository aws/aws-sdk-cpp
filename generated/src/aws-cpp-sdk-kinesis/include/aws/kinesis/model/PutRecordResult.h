...
namespace Model
{
  ...
  public:
    ...
    void SetShardId(ShardIdT&& value) { m_shardId = std::forward<ShardIdT>(value); }
    template<typename ShardIdT = Aws::String>
    ...
    void SetSequenceNumber(SequenceNumberT&& value) { m_sequenceNumber = std::forward<SequenceNumberT>(value); }
    template<typename SequenceNumberT = Aws::String>
    ...
    inline void SetEncryptionType(EncryptionType value) { m_encryptionType = value; }
