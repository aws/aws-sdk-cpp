...
namespace Model
{
  ...
  public:
    ...
    void SetShards(ShardsT&& value) { m_shards = std::forward<ShardsT>(value); }
    template<typename ShardsT = Aws::Vector<Shard>>
    ListShardsResult& WithShards(ShardsT&& value) { SetShards(std::forward<ShardsT>(value)); return *this;}
    template<typename ShardsT = Shard>
    ListShardsResult& AddShards(ShardsT&& value) { m_shards.emplace_back(std::forward<ShardsT>(value)); return *this; }
    ///@}
