...
namespace Model
{
  ...
  {
  public:
    AWS_KINESIS_API EnableEnhancedMonitoringResult() = default;
    ...
    template<typename StreamNameT = Aws::String>
    EnableEnhancedMonitoringResult& WithStreamName(StreamNameT&& value) { SetStreamName(std::forward<StreamNameT>(value)); return *this;}
    ///@}
    ...
    template<typename CurrentShardLevelMetricsT = Aws::Vector<MetricsName>>
    EnableEnhancedMonitoringResult& WithCurrentShardLevelMetrics(CurrentShardLevelMetricsT&& value) { SetCurrentShardLevelMetrics(std::forward<CurrentShardLevelMetricsT>(value)); return *this;}
    inline EnableEnhancedMonitoringResult& AddCurrentShardLevelMetrics(MetricsName value) { m_currentShardLevelMetricsHasBeenSet = true; m_currentShardLevelMetrics.push_back(value); return *this; }
    ///@}
    ...
    template<typename DesiredShardLevelMetricsT = Aws::Vector<MetricsName>>
    EnableEnhancedMonitoringResult& WithDesiredShardLevelMetrics(DesiredShardLevelMetricsT&& value) { SetDesiredShardLevelMetrics(std::forward<DesiredShardLevelMetricsT>(value)); return *this;}
    inline EnableEnhancedMonitoringResult& AddDesiredShardLevelMetrics(MetricsName value) { m_desiredShardLevelMetricsHasBeenSet = true; m_desiredShardLevelMetrics.push_back(value); return *this; }
    ///@}
    ...
    template<typename StreamARNT = Aws::String>
    EnableEnhancedMonitoringResult& WithStreamARN(StreamARNT&& value) { SetStreamARN(std::forward<StreamARNT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    EnableEnhancedMonitoringResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
