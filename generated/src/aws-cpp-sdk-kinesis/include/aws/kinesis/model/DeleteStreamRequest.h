...
class DeleteStreamRequest : public KinesisRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  DeleteStreamRequest& WithStreamName(StreamNameT&& value) {
  ...
  inline void SetEnforceConsumerDeletion(bool value) {
    m_enforceConsumerDeletionHasBeenSet = true;
    m_enforceConsumerDeletion = value;
  }
  inline DeleteStreamRequest& WithEnforceConsumerDeletion(bool value) {
    SetEnforceConsumerDeletion(value);
    return *this;
  }
  ///@}
  ...
  template <typename StreamARNT = Aws::String>
  DeleteStreamRequest& WithStreamARN(StreamARNT&& value) {
