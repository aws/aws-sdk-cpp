...
class ListTagsForStreamRequest : public KinesisRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  ListTagsForStreamRequest& WithStreamName(StreamNameT&& value) {
  ...
  void SetExclusiveStartTagKey(ExclusiveStartTagKeyT&& value) {
    m_exclusiveStartTagKeyHasBeenSet = true;
    m_exclusiveStartTagKey = std::forward<ExclusiveStartTagKeyT>(value);
  }
  template <typename ExclusiveStartTagKeyT = Aws::String>
  ListTagsForStreamRequest& WithExclusiveStartTagKey(ExclusiveStartTagKeyT&& value) {
    SetExclusiveStartTagKey(std::forward<ExclusiveStartTagKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListTagsForStreamRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename StreamARNT = Aws::String>
  ListTagsForStreamRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename StreamIdT = Aws::String>
  ListTagsForStreamRequest& WithStreamId(StreamIdT&& value) {
