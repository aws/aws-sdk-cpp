...
class DeregisterStreamConsumerRequest : public KinesisRequest {
 public:
  ...
  template <typename StreamARNT = Aws::String>
  DeregisterStreamConsumerRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename ConsumerNameT = Aws::String>
  DeregisterStreamConsumerRequest& WithConsumerName(ConsumerNameT&& value) {
  ...
  template <typename ConsumerARNT = Aws::String>
  DeregisterStreamConsumerRequest& WithConsumerARN(ConsumerARNT&& value) {
  ...
  template <typename StreamIdT = Aws::String>
  DeregisterStreamConsumerRequest& WithStreamId(StreamIdT&& value) {
