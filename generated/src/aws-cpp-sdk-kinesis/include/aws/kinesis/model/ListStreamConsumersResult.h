...
namespace Model
{
  ...
  public:
    ...
    void SetConsumers(ConsumersT&& value) { m_consumers = std::forward<ConsumersT>(value); }
    template<typename ConsumersT = Aws::Vector<Consumer>>
    ...
    ListStreamConsumersResult& AddConsumers(ConsumersT&& value) { m_consumers.emplace_back(std::forward<ConsumersT>(value)); return *this; }
    ///@}
