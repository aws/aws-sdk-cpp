...
class PutRecordRequest : public KinesisRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  PutRecordRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename DataT = Aws::Utils::ByteBuffer>
  PutRecordRequest& WithData(DataT&& value) {
   ...
   * partition key is required. If the stream uses the <code>AUTO</code> record
   * distribution strategy, the partition key is optional and any value you provide
   * is ignored, along with any <code>ExplicitHashKey</code> you provide. In that
   * case, Amazon Kinesis Data Streams distributes the record across shards using
  ...
  template <typename PartitionKeyT = Aws::String>
  PutRecordRequest& WithPartitionKey(PartitionKeyT&& value) {
  ...
  template <typename ExplicitHashKeyT = Aws::String>
  PutRecordRequest& WithExplicitHashKey(ExplicitHashKeyT&& value) {
  ...
  void SetSequenceNumberForOrdering(SequenceNumberForOrderingT&& value) {
    m_sequenceNumberForOrderingHasBeenSet = true;
    m_sequenceNumberForOrdering = std::forward<SequenceNumberForOrderingT>(value);
  }
  template <typename SequenceNumberForOrderingT = Aws::String>
  PutRecordRequest& WithSequenceNumberForOrdering(SequenceNumberForOrderingT&& value) {
    SetSequenceNumberForOrdering(std::forward<SequenceNumberForOrderingT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StreamARNT = Aws::String>
  PutRecordRequest& WithStreamARN(StreamARNT&& value) {
