...
class RegisterStreamConsumerResult {
 public:
  ...
  void SetConsumer(ConsumerT&& value) {
    m_consumerHasBeenSet = true;
    m_consumer = std::forward<ConsumerT>(value);
  }
  template <typename ConsumerT = Consumer>
  RegisterStreamConsumerResult& WithConsumer(ConsumerT&& value) {
    SetConsumer(std::forward<ConsumerT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  RegisterStreamConsumerResult& WithRequestId(RequestIdT&& value) {
