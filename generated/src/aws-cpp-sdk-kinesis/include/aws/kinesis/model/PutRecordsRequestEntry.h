...
class PutRecordsRequestEntry {
 public:
  ...
  template <typename DataT = Aws::Utils::ByteBuffer>
  PutRecordsRequestEntry& WithData(DataT&& value) {
  ...
  template <typename ExplicitHashKeyT = Aws::String>
  PutRecordsRequestEntry& WithExplicitHashKey(ExplicitHashKeyT&& value) {
  ...
  template <typename PartitionKeyT = Aws::String>
  PutRecordsRequestEntry& WithPartitionKey(PartitionKeyT&& value) {
