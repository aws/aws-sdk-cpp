...
/**
 * <p>The updated configuration for a general purpose Amazon S3 destination. Used
 * in <a>UpdateChannel</a>. Only <code>DataFreshnessInSeconds</code> can be
 * updated.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/S3DestinationUpdateInput">AWS
 * API Reference</a></p>
 */
class S3DestinationUpdateInput {
 public:
  ...
  inline S3DestinationUpdateInput& WithDataFreshnessInSeconds(int value) {
