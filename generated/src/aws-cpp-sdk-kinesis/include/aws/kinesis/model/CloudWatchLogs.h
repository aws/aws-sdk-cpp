...
/**
 * <p>The Amazon CloudWatch Logs settings for channel logging.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/CloudWatchLogs">AWS
 * API Reference</a></p>
 */
class CloudWatchLogs {
 public:
  ...
  inline CloudWatchLogs& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The name of the Amazon CloudWatch Logs log group. Defaults to
   * <code>/aws/kinesis/{channelName}/{channelId}</code>.</p>
   */
  ...
  ///@{
  /**
   * <p>The name of the Amazon CloudWatch Logs log stream. Defaults to
   * <code>DestinationDelivery</code>.</p>
   */
