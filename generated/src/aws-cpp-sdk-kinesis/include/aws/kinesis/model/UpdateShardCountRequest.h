...
class UpdateShardCountRequest : public KinesisRequest {
 public:
  ...
  inline void SetTargetShardCount(int value) {
    m_targetShardCountHasBeenSet = true;
    m_targetShardCount = value;
  }
  inline UpdateShardCountRequest& WithTargetShardCount(int value) {
    SetTargetShardCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScalingType(ScalingType value) {
    m_scalingTypeHasBeenSet = true;
    m_scalingType = value;
  }
  inline UpdateShardCountRequest& WithScalingType(ScalingType value) {
