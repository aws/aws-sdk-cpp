...
class DescribeStreamSummaryRequest : public KinesisRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  DescribeStreamSummaryRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename StreamARNT = Aws::String>
  DescribeStreamSummaryRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename StreamIdT = Aws::String>
  DescribeStreamSummaryRequest& WithStreamId(StreamIdT&& value) {
