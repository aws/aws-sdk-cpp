...
class IncreaseStreamRetentionPeriodRequest : public KinesisRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  IncreaseStreamRetentionPeriodRequest& WithStreamName(StreamNameT&& value) {
  ...
  inline IncreaseStreamRetentionPeriodRequest& WithRetentionPeriodHours(int value) {
  ...
  template <typename StreamARNT = Aws::String>
  IncreaseStreamRetentionPeriodRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename StreamIdT = Aws::String>
  IncreaseStreamRetentionPeriodRequest& WithStreamId(StreamIdT&& value) {
