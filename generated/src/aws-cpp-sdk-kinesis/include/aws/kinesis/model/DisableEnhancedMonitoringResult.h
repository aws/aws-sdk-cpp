...
namespace Model
{
  ...
  public:
    ...
    void SetStreamName(StreamNameT&& value) { m_streamName = std::forward<StreamNameT>(value); }
    template<typename StreamNameT = Aws::String>
    ...
    void SetCurrentShardLevelMetrics(CurrentShardLevelMetricsT&& value) { m_currentShardLevelMetrics = std::forward<CurrentShardLevelMetricsT>(value); }
    template<typename CurrentShardLevelMetricsT = Aws::Vector<MetricsName>>
    ...
    void SetDesiredShardLevelMetrics(DesiredShardLevelMetricsT&& value) { m_desiredShardLevelMetrics = std::forward<DesiredShardLevelMetricsT>(value); }
    template<typename DesiredShardLevelMetricsT = Aws::Vector<MetricsName>>
    ...
    void SetStreamARN(StreamARNT&& value) { m_streamARN = std::forward<StreamARNT>(value); }
    template<typename StreamARNT = Aws::String>
