...
namespace Model
{
  ...
  public:
    ...
    template<typename StreamNameT = Aws::String>
    DecreaseStreamRetentionPeriodRequest& WithStreamName(StreamNameT&& value) { SetStreamName(std::forward<StreamNameT>(value)); return *this;}
    ///@}
    ...
    template<typename StreamARNT = Aws::String>
    DecreaseStreamRetentionPeriodRequest& WithStreamARN(StreamARNT&& value) { SetStreamARN(std::forward<StreamARNT>(value)); return *this;}
    ///@}
  private:
