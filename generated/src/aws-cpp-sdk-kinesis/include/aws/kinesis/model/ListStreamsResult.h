...
namespace Model
{
  ...
  public:
    ...
    void SetStreamNames(StreamNamesT&& value) { m_streamNames = std::forward<StreamNamesT>(value); }
    template<typename StreamNamesT = Aws::Vector<Aws::String>>
    ...
    ListStreamsResult& AddStreamNames(StreamNamesT&& value) { m_streamNames.emplace_back(std::forward<StreamNamesT>(value)); return *this; }
    ///@}
    ...
    void SetStreamSummaries(StreamSummariesT&& value) { m_streamSummaries = std::forward<StreamSummariesT>(value); }
    template<typename StreamSummariesT = Aws::Vector<StreamSummary>>
    ...
    ListStreamsResult& AddStreamSummaries(StreamSummariesT&& value) { m_streamSummaries.emplace_back(std::forward<StreamSummariesT>(value)); return *this; }
    ///@}
