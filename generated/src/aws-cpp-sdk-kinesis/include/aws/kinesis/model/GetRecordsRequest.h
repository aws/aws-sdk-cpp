...
class GetRecordsRequest : public KinesisRequest {
 public:
  ...
  void SetShardIterator(ShardIteratorT&& value) {
    m_shardIteratorHasBeenSet = true;
    m_shardIterator = std::forward<ShardIteratorT>(value);
  }
  template <typename ShardIteratorT = Aws::String>
  GetRecordsRequest& WithShardIterator(ShardIteratorT&& value) {
    SetShardIterator(std::forward<ShardIteratorT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetRecordsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename StreamARNT = Aws::String>
  GetRecordsRequest& WithStreamARN(StreamARNT&& value) {
  ...
  inline GetRecordsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
