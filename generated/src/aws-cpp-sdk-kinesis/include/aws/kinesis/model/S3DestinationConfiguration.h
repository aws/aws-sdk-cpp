...
/**
 * <p>The configuration for delivery to a general purpose Amazon S3 bucket. Used in
 * <a>CreateChannel</a>.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/S3DestinationConfiguration">AWS
 * API Reference</a></p>
 */
class S3DestinationConfiguration {
 public:
  AWS_KINESIS_API S3DestinationConfiguration() = default;
  AWS_KINESIS_API S3DestinationConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_KINESIS_API S3DestinationConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
   ...
   * defaults to the destination bucket with an error prefix.</p>
   */
  ...
  template <typename DeadLetterQueueS3ConfigurationT = DeadLetterQueueS3Configuration>
  S3DestinationConfiguration& WithDeadLetterQueueS3Configuration(DeadLetterQueueS3ConfigurationT&& value) {
  ...
  template <typename StorageConfigurationT = S3StorageConfiguration>
  S3DestinationConfiguration& WithStorageConfiguration(StorageConfigurationT&& value) {
