...
class MergeShardsRequest : public KinesisRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  MergeShardsRequest& WithStreamName(StreamNameT&& value) {
  ...
  void SetShardToMerge(ShardToMergeT&& value) {
    m_shardToMergeHasBeenSet = true;
    m_shardToMerge = std::forward<ShardToMergeT>(value);
  }
  template <typename ShardToMergeT = Aws::String>
  MergeShardsRequest& WithShardToMerge(ShardToMergeT&& value) {
    SetShardToMerge(std::forward<ShardToMergeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdjacentShardToMerge(AdjacentShardToMergeT&& value) {
    m_adjacentShardToMergeHasBeenSet = true;
    m_adjacentShardToMerge = std::forward<AdjacentShardToMergeT>(value);
  }
  template <typename AdjacentShardToMergeT = Aws::String>
  MergeShardsRequest& WithAdjacentShardToMerge(AdjacentShardToMergeT&& value) {
    SetAdjacentShardToMerge(std::forward<AdjacentShardToMergeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StreamARNT = Aws::String>
  MergeShardsRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename StreamIdT = Aws::String>
  MergeShardsRequest& WithStreamId(StreamIdT&& value) {
