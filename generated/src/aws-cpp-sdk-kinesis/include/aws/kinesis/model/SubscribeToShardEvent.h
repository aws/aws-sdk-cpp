...
class SubscribeToShardEvent {
 public:
  ...
  void SetContinuationSequenceNumber(ContinuationSequenceNumberT&& value) {
    ...
    m_continuationSequenceNumber = std::forward<ContinuationSequenceNumberT>(value);
  }
  template <typename ContinuationSequenceNumberT = Aws::String>
  SubscribeToShardEvent& WithContinuationSequenceNumber(ContinuationSequenceNumberT&& value) {
    SetContinuationSequenceNumber(std::forward<ContinuationSequenceNumberT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMillisBehindLatest(long long value) {
    m_millisBehindLatestHasBeenSet = true;
    m_millisBehindLatest = value;
  }
  inline SubscribeToShardEvent& WithMillisBehindLatest(long long value) {
    SetMillisBehindLatest(value);
    return *this;
  }
  ///@}
