...
class DescribeStreamConsumerResult {
 public:
  ...
  void SetConsumerDescription(ConsumerDescriptionT&& value) {
    m_consumerDescriptionHasBeenSet = true;
    m_consumerDescription = std::forward<ConsumerDescriptionT>(value);
  }
  template <typename ConsumerDescriptionT = ConsumerDescription>
  DescribeStreamConsumerResult& WithConsumerDescription(ConsumerDescriptionT&& value) {
    SetConsumerDescription(std::forward<ConsumerDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeStreamConsumerResult& WithRequestId(RequestIdT&& value) {
