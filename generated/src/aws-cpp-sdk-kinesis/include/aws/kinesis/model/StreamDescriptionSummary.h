...
class StreamDescriptionSummary {
 public:
  ...
  inline void SetStreamStatus(StreamStatus value) {
    m_streamStatusHasBeenSet = true;
    m_streamStatus = value;
  }
  inline StreamDescriptionSummary& WithStreamStatus(StreamStatus value) {
  ...
  void SetStreamModeDetails(StreamModeDetailsT&& value) {
    ...
    m_streamModeDetails = std::forward<StreamModeDetailsT>(value);
  }
  template <typename StreamModeDetailsT = StreamModeDetails>
  StreamDescriptionSummary& WithStreamModeDetails(StreamModeDetailsT&& value) {
    SetStreamModeDetails(std::forward<StreamModeDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRetentionPeriodHours(int value) {
    m_retentionPeriodHoursHasBeenSet = true;
    m_retentionPeriodHours = value;
  }
  inline StreamDescriptionSummary& WithRetentionPeriodHours(int value) {
    SetRetentionPeriodHours(value);
    return *this;
  }
  ///@}
  ...
  void SetEnhancedMonitoring(EnhancedMonitoringT&& value) {
    ...
    m_enhancedMonitoring = std::forward<EnhancedMonitoringT>(value);
  }
  template <typename EnhancedMonitoringT = Aws::Vector<EnhancedMetrics>>
  StreamDescriptionSummary& WithEnhancedMonitoring(EnhancedMonitoringT&& value) {
    SetEnhancedMonitoring(std::forward<EnhancedMonitoringT>(value));
    return *this;
  }
  ...
  StreamDescriptionSummary& AddEnhancedMonitoring(EnhancedMonitoringT&& value) {
    m_enhancedMonitoringHasBeenSet = true;
    m_enhancedMonitoring.emplace_back(std::forward<EnhancedMonitoringT>(value));
    return *this;
  }
  ///@}
  ...
  inline StreamDescriptionSummary& WithEncryptionType(EncryptionType value) {
  ...
  inline void SetOpenShardCount(int value) {
    m_openShardCountHasBeenSet = true;
    m_openShardCount = value;
  }
  inline StreamDescriptionSummary& WithOpenShardCount(int value) {
    SetOpenShardCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConsumerCount(int value) {
    m_consumerCountHasBeenSet = true;
    m_consumerCount = value;
  }
  inline StreamDescriptionSummary& WithConsumerCount(int value) {
