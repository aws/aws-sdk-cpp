...
class Consumer {
 public:
  ...
  void SetConsumerName(ConsumerNameT&& value) {
    ...
    m_consumerName = std::forward<ConsumerNameT>(value);
  }
  template <typename ConsumerNameT = Aws::String>
  Consumer& WithConsumerName(ConsumerNameT&& value) {
    SetConsumerName(std::forward<ConsumerNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetConsumerStatus(ConsumerStatus value) {
    m_consumerStatusHasBeenSet = true;
    m_consumerStatus = value;
  }
  inline Consumer& WithConsumerStatus(ConsumerStatus value) {
  ...
  void SetConsumerCreationTimestamp(ConsumerCreationTimestampT&& value) {
    ...
    m_consumerCreationTimestamp = std::forward<ConsumerCreationTimestampT>(value);
  }
  template <typename ConsumerCreationTimestampT = Aws::Utils::DateTime>
  Consumer& WithConsumerCreationTimestamp(ConsumerCreationTimestampT&& value) {
    SetConsumerCreationTimestamp(std::forward<ConsumerCreationTimestampT>(value));
    return *this;
  }
  ///@}
 private:
