...
class EnableEnhancedMonitoringRequest : public KinesisRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  EnableEnhancedMonitoringRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename ShardLevelMetricsT = Aws::Vector<MetricsName>>
  EnableEnhancedMonitoringRequest& WithShardLevelMetrics(ShardLevelMetricsT&& value) {
    SetShardLevelMetrics(std::forward<ShardLevelMetricsT>(value));
    return *this;
  }
  inline EnableEnhancedMonitoringRequest& AddShardLevelMetrics(MetricsName value) {
    m_shardLevelMetricsHasBeenSet = true;
  ...
  template <typename StreamARNT = Aws::String>
  EnableEnhancedMonitoringRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename StreamIdT = Aws::String>
  EnableEnhancedMonitoringRequest& WithStreamId(StreamIdT&& value) {
