...
class CreateChannelResult {
 public:
  AWS_KINESIS_API CreateChannelResult() = default;
  AWS_KINESIS_API CreateChannelResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_KINESIS_API CreateChannelResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ChannelDescriptionT = ChannelDescription>
  CreateChannelResult& WithChannelDescription(ChannelDescriptionT&& value) {
