...
class PutRecordsRequest : public KinesisRequest {
 public:
  ...
  template <typename RecordsT = Aws::Vector<PutRecordsRequestEntry>>
  PutRecordsRequest& WithRecords(RecordsT&& value) {
    SetRecords(std::forward<RecordsT>(value));
    return *this;
  }
  template <typename RecordsT = PutRecordsRequestEntry>
  PutRecordsRequest& AddRecords(RecordsT&& value) {
    m_recordsHasBeenSet = true;
  ...
  template <typename StreamNameT = Aws::String>
  PutRecordsRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename StreamARNT = Aws::String>
  PutRecordsRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename StreamIdT = Aws::String>
  PutRecordsRequest& WithStreamId(StreamIdT&& value) {
