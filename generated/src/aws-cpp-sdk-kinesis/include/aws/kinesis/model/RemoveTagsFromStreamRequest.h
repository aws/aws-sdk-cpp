...
class RemoveTagsFromStreamRequest : public KinesisRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  RemoveTagsFromStreamRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename TagKeysT = Aws::Vector<Aws::String>>
  RemoveTagsFromStreamRequest& WithTagKeys(TagKeysT&& value) {
    SetTagKeys(std::forward<TagKeysT>(value));
    return *this;
  }
  template <typename TagKeysT = Aws::String>
  RemoveTagsFromStreamRequest& AddTagKeys(TagKeysT&& value) {
    m_tagKeysHasBeenSet = true;
  ...
  template <typename StreamARNT = Aws::String>
  RemoveTagsFromStreamRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename StreamIdT = Aws::String>
  RemoveTagsFromStreamRequest& WithStreamId(StreamIdT&& value) {
