...
namespace Model
{
  ...
  public:
    ...
    void SetRecords(RecordsT&& value) { m_records = std::forward<RecordsT>(value); }
    template<typename RecordsT = Aws::Vector<Record>>
    ...
    GetRecordsResult& AddRecords(RecordsT&& value) { m_records.emplace_back(std::forward<RecordsT>(value)); return *this; }
    ///@}
    ...
    void SetNextShardIterator(NextShardIteratorT&& value) { m_nextShardIterator = std::forward<NextShardIteratorT>(value); }
    template<typename NextShardIteratorT = Aws::String>
    ...
    void SetChildShards(ChildShardsT&& value) { m_childShards = std::forward<ChildShardsT>(value); }
    template<typename ChildShardsT = Aws::Vector<ChildShard>>
    ...
    GetRecordsResult& AddChildShards(ChildShardsT&& value) { m_childShards.emplace_back(std::forward<ChildShardsT>(value)); return *this; }
    ///@}
