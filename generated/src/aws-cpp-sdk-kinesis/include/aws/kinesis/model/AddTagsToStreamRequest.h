...
class AddTagsToStreamRequest : public KinesisRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  AddTagsToStreamRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  AddTagsToStreamRequest& WithTags(TagsT&& value) {
  ...
  template <typename StreamARNT = Aws::String>
  AddTagsToStreamRequest& WithStreamARN(StreamARNT&& value) {
  ...
  template <typename StreamIdT = Aws::String>
  AddTagsToStreamRequest& WithStreamId(StreamIdT&& value) {
