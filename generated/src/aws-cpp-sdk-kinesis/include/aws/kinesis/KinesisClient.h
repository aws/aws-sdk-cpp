...
class AWS_KINESIS_API KinesisClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  KinesisClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<KinesisEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for AddTagsToStream that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddTagsToStreamRequestT = Model::AddTagsToStreamRequest>
  void AddTagsToStreamAsync(const AddTagsToStreamRequestT& request, const AddTagsToStreamResponseReceivedHandler& handler,
  ...
  virtual Model::DecreaseStreamRetentionPeriodOutcome DecreaseStreamRetentionPeriod(
      const Model::DecreaseStreamRetentionPeriodRequest& request) const;

  /**
   * A Callable wrapper for DecreaseStreamRetentionPeriod that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DecreaseStreamRetentionPeriodRequestT = Model::DecreaseStreamRetentionPeriodRequest>
  Model::DecreaseStreamRetentionPeriodOutcomeCallable DecreaseStreamRetentionPeriodCallable(
      const DecreaseStreamRetentionPeriodRequestT& request) const {
    return SubmitCallable(&KinesisClient::DecreaseStreamRetentionPeriod, request);
  }

  /**
   * An Async wrapper for DecreaseStreamRetentionPeriod that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DecreaseStreamRetentionPeriodRequestT = Model::DecreaseStreamRetentionPeriodRequest>
  void DecreaseStreamRetentionPeriodAsync(const DecreaseStreamRetentionPeriodRequestT& request,
   ...
   */
  template <typename DeleteStreamRequestT = Model::DeleteStreamRequest>
  void DeleteStreamAsync(const DeleteStreamResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const DeleteStreamRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeregisterStreamConsumer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeregisterStreamConsumerRequestT = Model::DeregisterStreamConsumerRequest>
  Model::DeregisterStreamConsumerOutcomeCallable DeregisterStreamConsumerCallable(
      const DeregisterStreamConsumerRequestT& request = {}) const {
    return SubmitCallable(&KinesisClient::DeregisterStreamConsumer, request);
  }

  /**
   * An Async wrapper for DeregisterStreamConsumer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterStreamConsumerRequestT = Model::DeregisterStreamConsumerRequest>
  void DeregisterStreamConsumerAsync(const DeregisterStreamConsumerResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DeregisterStreamConsumerRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeLimits that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeLimitsRequestT = Model::DescribeLimitsRequest>
  void DescribeLimitsAsync(const DescribeLimitsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DescribeLimitsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeStreamConsumer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeStreamConsumer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStreamConsumerRequestT = Model::DescribeStreamConsumerRequest>
  void DescribeStreamConsumerAsync(const DescribeStreamConsumerResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribeStreamConsumerRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeStreamSummary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeStreamSummary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStreamSummaryRequestT = Model::DescribeStreamSummaryRequest>
  void DescribeStreamSummaryAsync(const DescribeStreamSummaryResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeStreamSummaryRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisableEnhancedMonitoring that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DisableEnhancedMonitoringRequestT = Model::DisableEnhancedMonitoringRequest>
  Model::DisableEnhancedMonitoringOutcomeCallable DisableEnhancedMonitoringCallable(
      const DisableEnhancedMonitoringRequestT& request) const {
    return SubmitCallable(&KinesisClient::DisableEnhancedMonitoring, request);
  }

  /**
   * An Async wrapper for DisableEnhancedMonitoring that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableEnhancedMonitoringRequestT = Model::DisableEnhancedMonitoringRequest>
  void DisableEnhancedMonitoringAsync(const DisableEnhancedMonitoringRequestT& request,
  ...
  /**
   * A Callable wrapper for EnableEnhancedMonitoring that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableEnhancedMonitoring that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableEnhancedMonitoringRequestT = Model::EnableEnhancedMonitoringRequest>
  void EnableEnhancedMonitoringAsync(const EnableEnhancedMonitoringRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::IncreaseStreamRetentionPeriodOutcome IncreaseStreamRetentionPeriod(
      const Model::IncreaseStreamRetentionPeriodRequest& request) const;

  /**
   * A Callable wrapper for IncreaseStreamRetentionPeriod that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename IncreaseStreamRetentionPeriodRequestT = Model::IncreaseStreamRetentionPeriodRequest>
  Model::IncreaseStreamRetentionPeriodOutcomeCallable IncreaseStreamRetentionPeriodCallable(
      const IncreaseStreamRetentionPeriodRequestT& request) const {
    return SubmitCallable(&KinesisClient::IncreaseStreamRetentionPeriod, request);
  }

  /**
   * An Async wrapper for IncreaseStreamRetentionPeriod that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename IncreaseStreamRetentionPeriodRequestT = Model::IncreaseStreamRetentionPeriodRequest>
  void IncreaseStreamRetentionPeriodAsync(const IncreaseStreamRetentionPeriodRequestT& request,
  ...
  /**
   * An Async wrapper for ListShards that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListShardsRequestT = Model::ListShardsRequest>
  void ListShardsAsync(const ListShardsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListShardsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListStreamConsumers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStreamConsumers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStreamConsumersRequestT = Model::ListStreamConsumersRequest>
  void ListStreamConsumersAsync(const ListStreamConsumersRequestT& request, const ListStreamConsumersResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for MergeShards that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename MergeShardsRequestT = Model::MergeShardsRequest>
  void MergeShardsAsync(const MergeShardsRequestT& request, const MergeShardsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutRecords that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutRecordsRequestT = Model::PutRecordsRequest>
  void PutRecordsAsync(const PutRecordsRequestT& request, const PutRecordsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterStreamConsumer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterStreamConsumer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterStreamConsumerRequestT = Model::RegisterStreamConsumerRequest>
  void RegisterStreamConsumerAsync(const RegisterStreamConsumerRequestT& request,
                                   const RegisterStreamConsumerResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RemoveTagsFromStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveTagsFromStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveTagsFromStreamRequestT = Model::RemoveTagsFromStreamRequest>
  void RemoveTagsFromStreamAsync(const RemoveTagsFromStreamRequestT& request, const RemoveTagsFromStreamResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SplitShard that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SplitShardRequestT = Model::SplitShardRequest>
  void SplitShardAsync(const SplitShardRequestT& request, const SplitShardResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartStreamEncryption that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartStreamEncryption that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartStreamEncryptionRequestT = Model::StartStreamEncryptionRequest>
  void StartStreamEncryptionAsync(const StartStreamEncryptionRequestT& request, const StartStreamEncryptionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopStreamEncryption that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopStreamEncryption that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopStreamEncryptionRequestT = Model::StopStreamEncryptionRequest>
  void StopStreamEncryptionAsync(const StopStreamEncryptionRequestT& request, const StopStreamEncryptionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SubscribeToShard that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SubscribeToShard that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SubscribeToShardRequestT = Model::SubscribeToShardRequest>
  void SubscribeToShardAsync(SubscribeToShardRequestT& request, const SubscribeToShardResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateShardCount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateShardCount that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateShardCountRequestT = Model::UpdateShardCountRequest>
  void UpdateShardCountAsync(const UpdateShardCountRequestT& request, const UpdateShardCountResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateStreamMode that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateStreamMode that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateStreamModeRequestT = Model::UpdateStreamModeRequest>
