...
StreamDescription::StreamDescription(JsonView jsonValue) { *this = jsonValue; }
...
StreamDescription& StreamDescription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("EnhancedMonitoring")) {
    ...
    for (unsigned enhancedMonitoringIndex = 0; enhancedMonitoringIndex < enhancedMonitoringJsonList.GetLength();
         ++enhancedMonitoringIndex) {
