...
S3TablesDestinationDescription::S3TablesDestinationDescription(JsonView jsonValue) { *this = jsonValue; }

S3TablesDestinationDescription& S3TablesDestinationDescription::operator=(JsonView jsonValue) {
...
JsonValue S3TablesDestinationDescription::Jsonize() const {
  JsonValue payload;
