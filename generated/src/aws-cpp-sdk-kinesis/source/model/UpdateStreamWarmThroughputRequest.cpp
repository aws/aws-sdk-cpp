...
Aws::String UpdateStreamWarmThroughputRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection UpdateStreamWarmThroughputRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "Kinesis_20131202.UpdateStreamWarmThroughput"));
  return headers;
}

UpdateStreamWarmThroughputRequest::EndpointParameters UpdateStreamWarmThroughputRequest::GetEndpointContextParams() const {
