...
namespace SecurityIR
{
   ...
   */
  class AWS_SECURITYIR_API SecurityIRClient : smithy::client::AwsSmithyClientT<Aws::SecurityIR::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<SecurityIRClient>
  {
    public:
