...
public:
  ...
  SecurityIRError(const Aws::Client::AWSError<SecurityIRErrors>& rhs) : Aws::Client::AWSError<SecurityIRErrors>(rhs) {}
  SecurityIRError(Aws::Client::AWSError<SecurityIRErrors>&& rhs) : Aws::Client::AWSError<SecurityIRErrors>(rhs) {}
