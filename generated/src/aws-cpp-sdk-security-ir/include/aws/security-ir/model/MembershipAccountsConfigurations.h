...
class MembershipAccountsConfigurations {
 public:
  ...
  inline MembershipAccountsConfigurations& WithCoverEntireOrganization(bool value) {
  ...
  template <typename OrganizationalUnitsT = Aws::Vector<Aws::String>>
  MembershipAccountsConfigurations& WithOrganizationalUnits(OrganizationalUnitsT&& value) {
    SetOrganizationalUnits(std::forward<OrganizationalUnitsT>(value));
    return *this;
  }
  template <typename OrganizationalUnitsT = Aws::String>
  MembershipAccountsConfigurations& AddOrganizationalUnits(OrganizationalUnitsT&& value) {
    m_organizationalUnitsHasBeenSet = true;
