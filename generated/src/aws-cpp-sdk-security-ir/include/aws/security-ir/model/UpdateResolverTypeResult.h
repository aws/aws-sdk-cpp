...
class UpdateResolverTypeResult {
 public:
  ...
  template <typename CaseIdT = Aws::String>
  UpdateResolverTypeResult& WithCaseId(CaseIdT&& value) {
  ...
  inline UpdateResolverTypeResult& WithCaseStatus(CaseStatus value) {
    SetCaseStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateResolverTypeResult& WithResolverType(ResolverType value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateResolverTypeResult& WithRequestId(RequestIdT&& value) {
