...
class CreateCaseRequest : public SecurityIRRequest {
 public:
  ...
  inline void SetResolverType(ResolverType value) {
    m_resolverTypeHasBeenSet = true;
    m_resolverType = value;
  }
  inline CreateCaseRequest& WithResolverType(ResolverType value) {
  ...
  inline void SetEngagementType(EngagementType value) {
    m_engagementTypeHasBeenSet = true;
    m_engagementType = value;
  }
  inline CreateCaseRequest& WithEngagementType(EngagementType value) {
  ...
  void SetReportedIncidentStartDate(ReportedIncidentStartDateT&& value) {
    ...
    m_reportedIncidentStartDate = std::forward<ReportedIncidentStartDateT>(value);
  }
  template <typename ReportedIncidentStartDateT = Aws::Utils::DateTime>
  CreateCaseRequest& WithReportedIncidentStartDate(ReportedIncidentStartDateT&& value) {
    SetReportedIncidentStartDate(std::forward<ReportedIncidentStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpactedAccounts(ImpactedAccountsT&& value) {
    ...
    m_impactedAccounts = std::forward<ImpactedAccountsT>(value);
  }
  template <typename ImpactedAccountsT = Aws::Vector<Aws::String>>
  CreateCaseRequest& WithImpactedAccounts(ImpactedAccountsT&& value) {
    SetImpactedAccounts(std::forward<ImpactedAccountsT>(value));
    return *this;
  }
  template <typename ImpactedAccountsT = Aws::String>
  CreateCaseRequest& AddImpactedAccounts(ImpactedAccountsT&& value) {
    m_impactedAccountsHasBeenSet = true;
    m_impactedAccounts.emplace_back(std::forward<ImpactedAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWatchers(WatchersT&& value) {
    ...
    m_watchers = std::forward<WatchersT>(value);
  }
  template <typename WatchersT = Aws::Vector<Watcher>>
  CreateCaseRequest& WithWatchers(WatchersT&& value) {
    SetWatchers(std::forward<WatchersT>(value));
    return *this;
  }
  template <typename WatchersT = Watcher>
  CreateCaseRequest& AddWatchers(WatchersT&& value) {
    m_watchersHasBeenSet = true;
    m_watchers.emplace_back(std::forward<WatchersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThreatActorIpAddresses(ThreatActorIpAddressesT&& value) {
    ...
    m_threatActorIpAddresses = std::forward<ThreatActorIpAddressesT>(value);
  }
  template <typename ThreatActorIpAddressesT = Aws::Vector<ThreatActorIp>>
  CreateCaseRequest& WithThreatActorIpAddresses(ThreatActorIpAddressesT&& value) {
    SetThreatActorIpAddresses(std::forward<ThreatActorIpAddressesT>(value));
    return *this;
  }
  ...
  CreateCaseRequest& AddThreatActorIpAddresses(ThreatActorIpAddressesT&& value) {
    m_threatActorIpAddressesHasBeenSet = true;
    m_threatActorIpAddresses.emplace_back(std::forward<ThreatActorIpAddressesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpactedServices(ImpactedServicesT&& value) {
    ...
    m_impactedServices = std::forward<ImpactedServicesT>(value);
  }
  template <typename ImpactedServicesT = Aws::Vector<Aws::String>>
  CreateCaseRequest& WithImpactedServices(ImpactedServicesT&& value) {
    SetImpactedServices(std::forward<ImpactedServicesT>(value));
    return *this;
  }
  template <typename ImpactedServicesT = Aws::String>
  CreateCaseRequest& AddImpactedServices(ImpactedServicesT&& value) {
    m_impactedServicesHasBeenSet = true;
    m_impactedServices.emplace_back(std::forward<ImpactedServicesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpactedAwsRegions(ImpactedAwsRegionsT&& value) {
    ...
    m_impactedAwsRegions = std::forward<ImpactedAwsRegionsT>(value);
  }
  template <typename ImpactedAwsRegionsT = Aws::Vector<ImpactedAwsRegion>>
  CreateCaseRequest& WithImpactedAwsRegions(ImpactedAwsRegionsT&& value) {
    SetImpactedAwsRegions(std::forward<ImpactedAwsRegionsT>(value));
    return *this;
  }
  template <typename ImpactedAwsRegionsT = ImpactedAwsRegion>
  CreateCaseRequest& AddImpactedAwsRegions(ImpactedAwsRegionsT&& value) {
    m_impactedAwsRegionsHasBeenSet = true;
    m_impactedAwsRegions.emplace_back(std::forward<ImpactedAwsRegionsT>(value));
    return *this;
  }
  ///@}
