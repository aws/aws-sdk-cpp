...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public SecurityIRRequest
  {
  public:
    AWS_SECURITYIR_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>Required element for TagResource to identify the ARN for the resource to add
     * a tag to.</p>
     */
    ...
    ///@{
    /**
     * <p>Required element for ListTagsForResource to provide the content for a
     * tag.</p>
     */
