...
namespace Model
{
  ...
  public:
    ...
    template<typename AttachmentPresignedUrlT = Aws::String>
    GetCaseAttachmentDownloadUrlResult& WithAttachmentPresignedUrl(AttachmentPresignedUrlT&& value) { SetAttachmentPresignedUrl(std::forward<AttachmentPresignedUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetCaseAttachmentDownloadUrlResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
