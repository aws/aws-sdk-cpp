...
class UpdateCaseRequest : public SecurityIRRequest {
 public:
  ...
  void SetActualIncidentStartDate(ActualIncidentStartDateT&& value) {
    ...
    m_actualIncidentStartDate = std::forward<ActualIncidentStartDateT>(value);
  }
  template <typename ActualIncidentStartDateT = Aws::Utils::DateTime>
  UpdateCaseRequest& WithActualIncidentStartDate(ActualIncidentStartDateT&& value) {
    SetActualIncidentStartDate(std::forward<ActualIncidentStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateCaseRequest& WithEngagementType(EngagementType value) {
  ...
  void SetWatchersToAdd(WatchersToAddT&& value) {
    m_watchersToAddHasBeenSet = true;
    m_watchersToAdd = std::forward<WatchersToAddT>(value);
  }
  template <typename WatchersToAddT = Aws::Vector<Watcher>>
  UpdateCaseRequest& WithWatchersToAdd(WatchersToAddT&& value) {
    SetWatchersToAdd(std::forward<WatchersToAddT>(value));
    return *this;
  }
  template <typename WatchersToAddT = Watcher>
  UpdateCaseRequest& AddWatchersToAdd(WatchersToAddT&& value) {
    m_watchersToAddHasBeenSet = true;
    m_watchersToAdd.emplace_back(std::forward<WatchersToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWatchersToDelete(WatchersToDeleteT&& value) {
    m_watchersToDeleteHasBeenSet = true;
    m_watchersToDelete = std::forward<WatchersToDeleteT>(value);
  }
  template <typename WatchersToDeleteT = Aws::Vector<Watcher>>
  UpdateCaseRequest& WithWatchersToDelete(WatchersToDeleteT&& value) {
    SetWatchersToDelete(std::forward<WatchersToDeleteT>(value));
    return *this;
  }
  template <typename WatchersToDeleteT = Watcher>
  UpdateCaseRequest& AddWatchersToDelete(WatchersToDeleteT&& value) {
    m_watchersToDeleteHasBeenSet = true;
    m_watchersToDelete.emplace_back(std::forward<WatchersToDeleteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThreatActorIpAddressesToAdd(ThreatActorIpAddressesToAddT&& value) {
    m_threatActorIpAddressesToAddHasBeenSet = true;
    m_threatActorIpAddressesToAdd = std::forward<ThreatActorIpAddressesToAddT>(value);
  }
  template <typename ThreatActorIpAddressesToAddT = Aws::Vector<ThreatActorIp>>
  UpdateCaseRequest& WithThreatActorIpAddressesToAdd(ThreatActorIpAddressesToAddT&& value) {
    SetThreatActorIpAddressesToAdd(std::forward<ThreatActorIpAddressesToAddT>(value));
    return *this;
  }
  ...
  UpdateCaseRequest& AddThreatActorIpAddressesToAdd(ThreatActorIpAddressesToAddT&& value) {
    m_threatActorIpAddressesToAddHasBeenSet = true;
    m_threatActorIpAddressesToAdd.emplace_back(std::forward<ThreatActorIpAddressesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThreatActorIpAddressesToDelete(ThreatActorIpAddressesToDeleteT&& value) {
    m_threatActorIpAddressesToDeleteHasBeenSet = true;
    m_threatActorIpAddressesToDelete = std::forward<ThreatActorIpAddressesToDeleteT>(value);
  }
  template <typename ThreatActorIpAddressesToDeleteT = Aws::Vector<ThreatActorIp>>
  UpdateCaseRequest& WithThreatActorIpAddressesToDelete(ThreatActorIpAddressesToDeleteT&& value) {
    SetThreatActorIpAddressesToDelete(std::forward<ThreatActorIpAddressesToDeleteT>(value));
    return *this;
  }
  ...
  UpdateCaseRequest& AddThreatActorIpAddressesToDelete(ThreatActorIpAddressesToDeleteT&& value) {
    m_threatActorIpAddressesToDeleteHasBeenSet = true;
    m_threatActorIpAddressesToDelete.emplace_back(std::forward<ThreatActorIpAddressesToDeleteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpactedServicesToAdd(ImpactedServicesToAddT&& value) {
    m_impactedServicesToAddHasBeenSet = true;
    m_impactedServicesToAdd = std::forward<ImpactedServicesToAddT>(value);
  }
  template <typename ImpactedServicesToAddT = Aws::Vector<Aws::String>>
  UpdateCaseRequest& WithImpactedServicesToAdd(ImpactedServicesToAddT&& value) {
    SetImpactedServicesToAdd(std::forward<ImpactedServicesToAddT>(value));
    return *this;
  }
  ...
  UpdateCaseRequest& AddImpactedServicesToAdd(ImpactedServicesToAddT&& value) {
    m_impactedServicesToAddHasBeenSet = true;
    m_impactedServicesToAdd.emplace_back(std::forward<ImpactedServicesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpactedServicesToDelete(ImpactedServicesToDeleteT&& value) {
    m_impactedServicesToDeleteHasBeenSet = true;
    m_impactedServicesToDelete = std::forward<ImpactedServicesToDeleteT>(value);
  }
  template <typename ImpactedServicesToDeleteT = Aws::Vector<Aws::String>>
  UpdateCaseRequest& WithImpactedServicesToDelete(ImpactedServicesToDeleteT&& value) {
    SetImpactedServicesToDelete(std::forward<ImpactedServicesToDeleteT>(value));
    return *this;
  }
  ...
  UpdateCaseRequest& AddImpactedServicesToDelete(ImpactedServicesToDeleteT&& value) {
    m_impactedServicesToDeleteHasBeenSet = true;
    m_impactedServicesToDelete.emplace_back(std::forward<ImpactedServicesToDeleteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpactedAwsRegionsToAdd(ImpactedAwsRegionsToAddT&& value) {
    m_impactedAwsRegionsToAddHasBeenSet = true;
    m_impactedAwsRegionsToAdd = std::forward<ImpactedAwsRegionsToAddT>(value);
  }
  template <typename ImpactedAwsRegionsToAddT = Aws::Vector<ImpactedAwsRegion>>
  UpdateCaseRequest& WithImpactedAwsRegionsToAdd(ImpactedAwsRegionsToAddT&& value) {
    SetImpactedAwsRegionsToAdd(std::forward<ImpactedAwsRegionsToAddT>(value));
    return *this;
  }
  ...
  UpdateCaseRequest& AddImpactedAwsRegionsToAdd(ImpactedAwsRegionsToAddT&& value) {
    m_impactedAwsRegionsToAddHasBeenSet = true;
    m_impactedAwsRegionsToAdd.emplace_back(std::forward<ImpactedAwsRegionsToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpactedAwsRegionsToDelete(ImpactedAwsRegionsToDeleteT&& value) {
    m_impactedAwsRegionsToDeleteHasBeenSet = true;
    m_impactedAwsRegionsToDelete = std::forward<ImpactedAwsRegionsToDeleteT>(value);
  }
  template <typename ImpactedAwsRegionsToDeleteT = Aws::Vector<ImpactedAwsRegion>>
  UpdateCaseRequest& WithImpactedAwsRegionsToDelete(ImpactedAwsRegionsToDeleteT&& value) {
    SetImpactedAwsRegionsToDelete(std::forward<ImpactedAwsRegionsToDeleteT>(value));
    return *this;
  }
  ...
  UpdateCaseRequest& AddImpactedAwsRegionsToDelete(ImpactedAwsRegionsToDeleteT&& value) {
    m_impactedAwsRegionsToDeleteHasBeenSet = true;
    m_impactedAwsRegionsToDelete.emplace_back(std::forward<ImpactedAwsRegionsToDeleteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpactedAccountsToAdd(ImpactedAccountsToAddT&& value) {
    m_impactedAccountsToAddHasBeenSet = true;
    m_impactedAccountsToAdd = std::forward<ImpactedAccountsToAddT>(value);
  }
  template <typename ImpactedAccountsToAddT = Aws::Vector<Aws::String>>
  UpdateCaseRequest& WithImpactedAccountsToAdd(ImpactedAccountsToAddT&& value) {
    SetImpactedAccountsToAdd(std::forward<ImpactedAccountsToAddT>(value));
    return *this;
  }
  ...
  UpdateCaseRequest& AddImpactedAccountsToAdd(ImpactedAccountsToAddT&& value) {
    m_impactedAccountsToAddHasBeenSet = true;
    m_impactedAccountsToAdd.emplace_back(std::forward<ImpactedAccountsToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpactedAccountsToDelete(ImpactedAccountsToDeleteT&& value) {
    m_impactedAccountsToDeleteHasBeenSet = true;
    m_impactedAccountsToDelete = std::forward<ImpactedAccountsToDeleteT>(value);
  }
  template <typename ImpactedAccountsToDeleteT = Aws::Vector<Aws::String>>
  UpdateCaseRequest& WithImpactedAccountsToDelete(ImpactedAccountsToDeleteT&& value) {
    SetImpactedAccountsToDelete(std::forward<ImpactedAccountsToDeleteT>(value));
    return *this;
  }
  ...
  UpdateCaseRequest& AddImpactedAccountsToDelete(ImpactedAccountsToDeleteT&& value) {
    m_impactedAccountsToDeleteHasBeenSet = true;
    m_impactedAccountsToDelete.emplace_back(std::forward<ImpactedAccountsToDeleteT>(value));
    return *this;
  }
  ///@}
