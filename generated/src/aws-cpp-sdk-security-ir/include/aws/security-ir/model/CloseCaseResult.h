...
class CloseCaseResult {
 public:
  ...
  inline void SetCaseStatus(CaseStatus value) {
    m_caseStatusHasBeenSet = true;
    m_caseStatus = value;
  }
  inline CloseCaseResult& WithCaseStatus(CaseStatus value) {
    SetCaseStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetClosedDate(ClosedDateT&& value) {
    ...
    m_closedDate = std::forward<ClosedDateT>(value);
  }
  template <typename ClosedDateT = Aws::Utils::DateTime>
  CloseCaseResult& WithClosedDate(ClosedDateT&& value) {
    SetClosedDate(std::forward<ClosedDateT>(value));
    return *this;
  }
  ///@}
