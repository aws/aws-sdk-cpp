...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/security-ir-2018-05-10/ValidationExceptionField">AWS
   * API Reference</a></p>
   */
  class ValidationExceptionField
  {
  public:
    AWS_SECURITYIR_API ValidationExceptionField() = default;
    AWS_SECURITYIR_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
