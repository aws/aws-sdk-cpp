...
class UpdateMembershipRequest : public SecurityIRRequest {
 public:
   ...
   */
  inline const MembershipAccountsConfigurationsUpdate& GetMembershipAccountsConfigurationsUpdate() const {
    return m_membershipAccountsConfigurationsUpdate;
  }
  ...
  void SetMembershipAccountsConfigurationsUpdate(MembershipAccountsConfigurationsUpdateT&& value) {
    m_membershipAccountsConfigurationsUpdateHasBeenSet = true;
    m_membershipAccountsConfigurationsUpdate = std::forward<MembershipAccountsConfigurationsUpdateT>(value);
  }
  template <typename MembershipAccountsConfigurationsUpdateT = MembershipAccountsConfigurationsUpdate>
  UpdateMembershipRequest& WithMembershipAccountsConfigurationsUpdate(MembershipAccountsConfigurationsUpdateT&& value) {
    SetMembershipAccountsConfigurationsUpdate(std::forward<MembershipAccountsConfigurationsUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUndoMembershipCancellation(bool value) {
    m_undoMembershipCancellationHasBeenSet = true;
    m_undoMembershipCancellation = value;
  }
  inline UpdateMembershipRequest& WithUndoMembershipCancellation(bool value) {
    SetUndoMembershipCancellation(value);
    return *this;
  }
  ///@}
 private:
