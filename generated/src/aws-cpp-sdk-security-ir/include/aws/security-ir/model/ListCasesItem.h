...
class ListCasesItem {
 public:
  ...
  inline ListCasesItem& WithEngagementType(EngagementType value) {
  ...
  inline ListCasesItem& WithCaseStatus(CaseStatus value) {
    SetCaseStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListCasesItem& WithResolverType(ResolverType value) {
  ...
  inline void SetPendingAction(PendingAction value) {
    m_pendingActionHasBeenSet = true;
    m_pendingAction = value;
  }
  inline ListCasesItem& WithPendingAction(PendingAction value) {
