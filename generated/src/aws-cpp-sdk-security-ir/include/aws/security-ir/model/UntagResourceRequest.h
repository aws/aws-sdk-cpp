...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public SecurityIRRequest
  {
  public:
    AWS_SECURITYIR_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>Required element for UnTagResource to identify the ARN for the resource to
     * remove a tag from.</p>
     */
