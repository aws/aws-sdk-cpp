...
class MembershipAccountsConfigurationsUpdate {
 public:
  ...
  inline void SetCoverEntireOrganization(bool value) {
    m_coverEntireOrganizationHasBeenSet = true;
    m_coverEntireOrganization = value;
  }
  inline MembershipAccountsConfigurationsUpdate& WithCoverEntireOrganization(bool value) {
    SetCoverEntireOrganization(value);
    return *this;
  }
  ///@}
  ...
  void SetOrganizationalUnitsToAdd(OrganizationalUnitsToAddT&& value) {
    m_organizationalUnitsToAddHasBeenSet = true;
    m_organizationalUnitsToAdd = std::forward<OrganizationalUnitsToAddT>(value);
  }
  template <typename OrganizationalUnitsToAddT = Aws::Vector<Aws::String>>
  MembershipAccountsConfigurationsUpdate& WithOrganizationalUnitsToAdd(OrganizationalUnitsToAddT&& value) {
    SetOrganizationalUnitsToAdd(std::forward<OrganizationalUnitsToAddT>(value));
    return *this;
  }
  ...
  MembershipAccountsConfigurationsUpdate& AddOrganizationalUnitsToAdd(OrganizationalUnitsToAddT&& value) {
    m_organizationalUnitsToAddHasBeenSet = true;
    m_organizationalUnitsToAdd.emplace_back(std::forward<OrganizationalUnitsToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOrganizationalUnitsToRemove(OrganizationalUnitsToRemoveT&& value) {
    m_organizationalUnitsToRemoveHasBeenSet = true;
    m_organizationalUnitsToRemove = std::forward<OrganizationalUnitsToRemoveT>(value);
  }
  template <typename OrganizationalUnitsToRemoveT = Aws::Vector<Aws::String>>
  MembershipAccountsConfigurationsUpdate& WithOrganizationalUnitsToRemove(OrganizationalUnitsToRemoveT&& value) {
    SetOrganizationalUnitsToRemove(std::forward<OrganizationalUnitsToRemoveT>(value));
    return *this;
  }
  ...
  MembershipAccountsConfigurationsUpdate& AddOrganizationalUnitsToRemove(OrganizationalUnitsToRemoveT&& value) {
    m_organizationalUnitsToRemoveHasBeenSet = true;
    m_organizationalUnitsToRemove.emplace_back(std::forward<OrganizationalUnitsToRemoveT>(value));
    return *this;
  }
  ///@}
 private:
