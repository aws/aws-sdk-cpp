...
class OptInFeature {
 public:
  ...
  inline void SetFeatureName(OptInFeatureName value) {
    m_featureNameHasBeenSet = true;
    m_featureName = value;
  }
  inline OptInFeature& WithFeatureName(OptInFeatureName value) {
  ...
  inline OptInFeature& WithIsEnabled(bool value) {
    SetIsEnabled(value);
    return *this;
  }
  ///@}
