...
class GetCaseResult {
 public:
  ...
  inline GetCaseResult& WithCaseStatus(CaseStatus value) {
    SetCaseStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetCaseResult& WithEngagementType(EngagementType value) {
  ...
  inline GetCaseResult& WithPendingAction(PendingAction value) {
  ...
  inline void SetClosureCode(ClosureCode value) {
    m_closureCodeHasBeenSet = true;
    m_closureCode = value;
  }
  inline GetCaseResult& WithClosureCode(ClosureCode value) {
    SetClosureCode(value);
    return *this;
  }
  ///@}
  ...
  inline GetCaseResult& WithResolverType(ResolverType value) {
  ...
  void SetCaseAttachments(CaseAttachmentsT&& value) {
    ...
    m_caseAttachments = std::forward<CaseAttachmentsT>(value);
  }
  template <typename CaseAttachmentsT = Aws::Vector<CaseAttachmentAttributes>>
  GetCaseResult& WithCaseAttachments(CaseAttachmentsT&& value) {
    SetCaseAttachments(std::forward<CaseAttachmentsT>(value));
    return *this;
  }
  template <typename CaseAttachmentsT = CaseAttachmentAttributes>
  GetCaseResult& AddCaseAttachments(CaseAttachmentsT&& value) {
    m_caseAttachmentsHasBeenSet = true;
    m_caseAttachments.emplace_back(std::forward<CaseAttachmentsT>(value));
    return *this;
  }
  ///@}
