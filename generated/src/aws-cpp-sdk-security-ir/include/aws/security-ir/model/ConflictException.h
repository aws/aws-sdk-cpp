 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/security-ir-2018-05-10/ConflictException">AWS
 * API Reference</a></p>
 */
class ConflictException {
 public:
  AWS_SECURITYIR_API ConflictException() = default;
  AWS_SECURITYIR_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
