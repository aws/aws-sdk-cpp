...
class ListCaseEditsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCaseEditsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<CaseEditItem>>
  ListCaseEditsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = CaseEditItem>
  ListCaseEditsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  inline ListCaseEditsResult& WithTotal(int value) {
    SetTotal(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCaseEditsResult& WithRequestId(RequestIdT&& value) {
