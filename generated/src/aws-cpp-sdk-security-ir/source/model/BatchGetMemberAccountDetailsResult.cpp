...
BatchGetMemberAccountDetailsResult::BatchGetMemberAccountDetailsResult()
{
}

BatchGetMemberAccountDetailsResult::BatchGetMemberAccountDetailsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
