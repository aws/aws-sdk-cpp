...
MembershipAccountsConfigurationsUpdate::MembershipAccountsConfigurationsUpdate(JsonView jsonValue) { *this = jsonValue; }
...
MembershipAccountsConfigurationsUpdate& MembershipAccountsConfigurationsUpdate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("organizationalUnitsToAdd")) {
    ...
    for (unsigned organizationalUnitsToAddIndex = 0; organizationalUnitsToAddIndex < organizationalUnitsToAddJsonList.GetLength();
         ++organizationalUnitsToAddIndex) {
  ...
  if (jsonValue.ValueExists("organizationalUnitsToRemove")) {
    ...
    for (unsigned organizationalUnitsToRemoveIndex = 0; organizationalUnitsToRemoveIndex < organizationalUnitsToRemoveJsonList.GetLength();
         ++organizationalUnitsToRemoveIndex) {
...
JsonValue MembershipAccountsConfigurationsUpdate::Jsonize() const {
  ...
  if (m_organizationalUnitsToRemoveHasBeenSet) {
    ...
    for (unsigned organizationalUnitsToRemoveIndex = 0; organizationalUnitsToRemoveIndex < organizationalUnitsToRemoveJsonList.GetLength();
         ++organizationalUnitsToRemoveIndex) {
      organizationalUnitsToRemoveJsonList[organizationalUnitsToRemoveIndex].AsString(
          m_organizationalUnitsToRemove[organizationalUnitsToRemoveIndex]);
    }
