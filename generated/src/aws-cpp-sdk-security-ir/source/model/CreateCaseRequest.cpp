...
Aws::String CreateCaseRequest::SerializePayload() const {
  ...
  if (m_threatActorIpAddressesHasBeenSet) {
    ...
    for (unsigned threatActorIpAddressesIndex = 0; threatActorIpAddressesIndex < threatActorIpAddressesJsonList.GetLength();
         ++threatActorIpAddressesIndex) {
  ...
  if (m_impactedAwsRegionsHasBeenSet) {
    ...
    for (unsigned impactedAwsRegionsIndex = 0; impactedAwsRegionsIndex < impactedAwsRegionsJsonList.GetLength();
