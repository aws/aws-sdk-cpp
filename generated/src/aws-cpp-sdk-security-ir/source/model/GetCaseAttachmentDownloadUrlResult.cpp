...
GetCaseAttachmentDownloadUrlResult::GetCaseAttachmentDownloadUrlResult()
{
}

GetCaseAttachmentDownloadUrlResult::GetCaseAttachmentDownloadUrlResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
