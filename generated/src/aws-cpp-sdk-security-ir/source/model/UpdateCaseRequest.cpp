...
Aws::String UpdateCaseRequest::SerializePayload() const {
  ...
  if (m_threatActorIpAddressesToAddHasBeenSet) {
    ...
    for (unsigned threatActorIpAddressesToAddIndex = 0; threatActorIpAddressesToAddIndex < threatActorIpAddressesToAddJsonList.GetLength();
         ++threatActorIpAddressesToAddIndex) {
      threatActorIpAddressesToAddJsonList[threatActorIpAddressesToAddIndex].AsObject(
          m_threatActorIpAddressesToAdd[threatActorIpAddressesToAddIndex].Jsonize());
    }
  ...
  if (m_threatActorIpAddressesToDeleteHasBeenSet) {
    ...
    for (unsigned threatActorIpAddressesToDeleteIndex = 0;
         threatActorIpAddressesToDeleteIndex < threatActorIpAddressesToDeleteJsonList.GetLength(); ++threatActorIpAddressesToDeleteIndex) {
      threatActorIpAddressesToDeleteJsonList[threatActorIpAddressesToDeleteIndex].AsObject(
          m_threatActorIpAddressesToDelete[threatActorIpAddressesToDeleteIndex].Jsonize());
    }
  ...
  if (m_impactedServicesToAddHasBeenSet) {
    ...
    for (unsigned impactedServicesToAddIndex = 0; impactedServicesToAddIndex < impactedServicesToAddJsonList.GetLength();
  ...
  if (m_impactedServicesToDeleteHasBeenSet) {
    ...
    for (unsigned impactedServicesToDeleteIndex = 0; impactedServicesToDeleteIndex < impactedServicesToDeleteJsonList.GetLength();
         ++impactedServicesToDeleteIndex) {
  ...
  if (m_impactedAwsRegionsToAddHasBeenSet) {
    ...
    for (unsigned impactedAwsRegionsToAddIndex = 0; impactedAwsRegionsToAddIndex < impactedAwsRegionsToAddJsonList.GetLength();
         ++impactedAwsRegionsToAddIndex) {
      impactedAwsRegionsToAddJsonList[impactedAwsRegionsToAddIndex].AsObject(
          m_impactedAwsRegionsToAdd[impactedAwsRegionsToAddIndex].Jsonize());
    }
  ...
  if (m_impactedAwsRegionsToDeleteHasBeenSet) {
    ...
    for (unsigned impactedAwsRegionsToDeleteIndex = 0; impactedAwsRegionsToDeleteIndex < impactedAwsRegionsToDeleteJsonList.GetLength();
         ++impactedAwsRegionsToDeleteIndex) {
      impactedAwsRegionsToDeleteJsonList[impactedAwsRegionsToDeleteIndex].AsObject(
          m_impactedAwsRegionsToDelete[impactedAwsRegionsToDeleteIndex].Jsonize());
    }
  ...
  if (m_impactedAccountsToAddHasBeenSet) {
    ...
    for (unsigned impactedAccountsToAddIndex = 0; impactedAccountsToAddIndex < impactedAccountsToAddJsonList.GetLength();
         ++impactedAccountsToAddIndex) {
  ...
  if (m_impactedAccountsToDeleteHasBeenSet) {
    ...
    for (unsigned impactedAccountsToDeleteIndex = 0; impactedAccountsToDeleteIndex < impactedAccountsToDeleteJsonList.GetLength();
         ++impactedAccountsToDeleteIndex) {
