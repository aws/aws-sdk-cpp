...
#ifdef AWS_TIMESTREAMQUERY_EXPORTS
#define AWS_TIMESTREAMQUERY_API __declspec(dllexport)
#else
...
#define AWS_TIMESTREAMQUERY_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_TIMESTREAMQUERY_API
#define AWS_TIMESTREAMQUERY_EXTERN extern
#if __GNUC__ >= 4
#define AWS_TIMESTREAMQUERY_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_TIMESTREAMQUERY_LOCAL
#endif
