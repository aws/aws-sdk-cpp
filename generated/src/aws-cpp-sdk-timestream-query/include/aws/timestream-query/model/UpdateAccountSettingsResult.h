...
class UpdateAccountSettingsResult {
 public:
  ...
  inline UpdateAccountSettingsResult& WithMaxQueryTCU(int value) {
  ...
  inline UpdateAccountSettingsResult& WithQueryPricingModel(QueryPricingModel value) {
  ...
  template <typename QueryComputeT = QueryComputeResponse>
  UpdateAccountSettingsResult& WithQueryCompute(QueryComputeT&& value) {
