...
class ScheduledQueryInsightsResponse {
 public:
  ...
  inline ScheduledQueryInsightsResponse& WithQueryTableCount(long long value) {
  ...
  inline ScheduledQueryInsightsResponse& WithOutputRows(long long value) {
    SetOutputRows(value);
    return *this;
  }
  ///@}
  ...
  inline ScheduledQueryInsightsResponse& WithOutputBytes(long long value) {
