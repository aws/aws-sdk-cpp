...
class DescribeAccountSettingsResult {
 public:
  ...
  inline void SetMaxQueryTCU(int value) {
    m_maxQueryTCUHasBeenSet = true;
    m_maxQueryTCU = value;
  }
  inline DescribeAccountSettingsResult& WithMaxQueryTCU(int value) {
    SetMaxQueryTCU(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQueryPricingModel(QueryPricingModel value) {
    m_queryPricingModelHasBeenSet = true;
    m_queryPricingModel = value;
  }
  inline DescribeAccountSettingsResult& WithQueryPricingModel(QueryPricingModel value) {
    SetQueryPricingModel(value);
    return *this;
  }
  ///@}
  ...
  template <typename QueryComputeT = QueryComputeResponse>
  DescribeAccountSettingsResult& WithQueryCompute(QueryComputeT&& value) {
