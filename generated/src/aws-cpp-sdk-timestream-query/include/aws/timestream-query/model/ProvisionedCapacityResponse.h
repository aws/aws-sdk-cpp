...
class ProvisionedCapacityResponse {
 public:
  ...
  inline void SetActiveQueryTCU(int value) {
    m_activeQueryTCUHasBeenSet = true;
    m_activeQueryTCU = value;
  }
  inline ProvisionedCapacityResponse& WithActiveQueryTCU(int value) {
    SetActiveQueryTCU(value);
    return *this;
  }
  ///@}
  ...
  void SetLastUpdate(LastUpdateT&& value) {
    ...
    m_lastUpdate = std::forward<LastUpdateT>(value);
  }
  template <typename LastUpdateT = LastUpdate>
  ProvisionedCapacityResponse& WithLastUpdate(LastUpdateT&& value) {
    SetLastUpdate(std::forward<LastUpdateT>(value));
    return *this;
  }
  ///@}
 private:
