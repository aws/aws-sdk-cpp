...
class TimestreamConfiguration {
 public:
  ...
  void SetTimeColumn(TimeColumnT&& value) {
    ...
    m_timeColumn = std::forward<TimeColumnT>(value);
  }
  template <typename TimeColumnT = Aws::String>
  TimestreamConfiguration& WithTimeColumn(TimeColumnT&& value) {
    SetTimeColumn(std::forward<TimeColumnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDimensionMappings(DimensionMappingsT&& value) {
    ...
    m_dimensionMappings = std::forward<DimensionMappingsT>(value);
  }
  template <typename DimensionMappingsT = Aws::Vector<DimensionMapping>>
  TimestreamConfiguration& WithDimensionMappings(DimensionMappingsT&& value) {
    SetDimensionMappings(std::forward<DimensionMappingsT>(value));
    return *this;
  }
  ...
  TimestreamConfiguration& AddDimensionMappings(DimensionMappingsT&& value) {
    m_dimensionMappingsHasBeenSet = true;
    m_dimensionMappings.emplace_back(std::forward<DimensionMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMultiMeasureMappings(MultiMeasureMappingsT&& value) {
    ...
    m_multiMeasureMappings = std::forward<MultiMeasureMappingsT>(value);
  }
  template <typename MultiMeasureMappingsT = MultiMeasureMappings>
  TimestreamConfiguration& WithMultiMeasureMappings(MultiMeasureMappingsT&& value) {
    SetMultiMeasureMappings(std::forward<MultiMeasureMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMixedMeasureMappings(MixedMeasureMappingsT&& value) {
    ...
    m_mixedMeasureMappings = std::forward<MixedMeasureMappingsT>(value);
  }
  template <typename MixedMeasureMappingsT = Aws::Vector<MixedMeasureMapping>>
  TimestreamConfiguration& WithMixedMeasureMappings(MixedMeasureMappingsT&& value) {
    SetMixedMeasureMappings(std::forward<MixedMeasureMappingsT>(value));
    return *this;
  }
  ...
  TimestreamConfiguration& AddMixedMeasureMappings(MixedMeasureMappingsT&& value) {
    m_mixedMeasureMappingsHasBeenSet = true;
    m_mixedMeasureMappings.emplace_back(std::forward<MixedMeasureMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMeasureNameColumn(MeasureNameColumnT&& value) {
    ...
    m_measureNameColumn = std::forward<MeasureNameColumnT>(value);
  }
  template <typename MeasureNameColumnT = Aws::String>
  TimestreamConfiguration& WithMeasureNameColumn(MeasureNameColumnT&& value) {
    SetMeasureNameColumn(std::forward<MeasureNameColumnT>(value));
    return *this;
  }
  ///@}
 private:
