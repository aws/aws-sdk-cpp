...
class CreateScheduledQueryRequest : public TimestreamQueryRequest {
 public:
  ...
  void SetScheduledQueryExecutionRoleArn(ScheduledQueryExecutionRoleArnT&& value) {
    ...
    m_scheduledQueryExecutionRoleArn = std::forward<ScheduledQueryExecutionRoleArnT>(value);
  }
  template <typename ScheduledQueryExecutionRoleArnT = Aws::String>
  CreateScheduledQueryRequest& WithScheduledQueryExecutionRoleArn(ScheduledQueryExecutionRoleArnT&& value) {
    SetScheduledQueryExecutionRoleArn(std::forward<ScheduledQueryExecutionRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetErrorReportConfiguration(ErrorReportConfigurationT&& value) {
    ...
    m_errorReportConfiguration = std::forward<ErrorReportConfigurationT>(value);
  }
  template <typename ErrorReportConfigurationT = ErrorReportConfiguration>
  CreateScheduledQueryRequest& WithErrorReportConfiguration(ErrorReportConfigurationT&& value) {
    SetErrorReportConfiguration(std::forward<ErrorReportConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
