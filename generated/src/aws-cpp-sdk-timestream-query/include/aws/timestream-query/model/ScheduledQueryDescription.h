...
class ScheduledQueryDescription {
 public:
  ...
  inline ScheduledQueryDescription& WithState(ScheduledQueryState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetPreviousInvocationTime(PreviousInvocationTimeT&& value) {
    ...
    m_previousInvocationTime = std::forward<PreviousInvocationTimeT>(value);
  }
  template <typename PreviousInvocationTimeT = Aws::Utils::DateTime>
  ScheduledQueryDescription& WithPreviousInvocationTime(PreviousInvocationTimeT&& value) {
    SetPreviousInvocationTime(std::forward<PreviousInvocationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextInvocationTime(NextInvocationTimeT&& value) {
    ...
    m_nextInvocationTime = std::forward<NextInvocationTimeT>(value);
  }
  template <typename NextInvocationTimeT = Aws::Utils::DateTime>
  ScheduledQueryDescription& WithNextInvocationTime(NextInvocationTimeT&& value) {
    SetNextInvocationTime(std::forward<NextInvocationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastRunSummary(LastRunSummaryT&& value) {
    ...
    m_lastRunSummary = std::forward<LastRunSummaryT>(value);
  }
  template <typename LastRunSummaryT = ScheduledQueryRunSummary>
  ScheduledQueryDescription& WithLastRunSummary(LastRunSummaryT&& value) {
    SetLastRunSummary(std::forward<LastRunSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecentlyFailedRuns(RecentlyFailedRunsT&& value) {
    ...
    m_recentlyFailedRuns = std::forward<RecentlyFailedRunsT>(value);
  }
  template <typename RecentlyFailedRunsT = Aws::Vector<ScheduledQueryRunSummary>>
  ScheduledQueryDescription& WithRecentlyFailedRuns(RecentlyFailedRunsT&& value) {
    SetRecentlyFailedRuns(std::forward<RecentlyFailedRunsT>(value));
    return *this;
  }
  ...
  ScheduledQueryDescription& AddRecentlyFailedRuns(RecentlyFailedRunsT&& value) {
    m_recentlyFailedRunsHasBeenSet = true;
    m_recentlyFailedRuns.emplace_back(std::forward<RecentlyFailedRunsT>(value));
    return *this;
  }
  ///@}
 private:
