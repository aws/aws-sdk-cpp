...
class QueryResult {
 public:
  ...
  void SetQueryStatus(QueryStatusT&& value) {
    ...
    m_queryStatus = std::forward<QueryStatusT>(value);
  }
  template <typename QueryStatusT = QueryStatus>
  QueryResult& WithQueryStatus(QueryStatusT&& value) {
    SetQueryStatus(std::forward<QueryStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueryInsightsResponse(QueryInsightsResponseT&& value) {
    ...
    m_queryInsightsResponse = std::forward<QueryInsightsResponseT>(value);
  }
  template <typename QueryInsightsResponseT = QueryInsightsResponse>
  QueryResult& WithQueryInsightsResponse(QueryInsightsResponseT&& value) {
    SetQueryInsightsResponse(std::forward<QueryInsightsResponseT>(value));
    return *this;
  }
  ///@}
