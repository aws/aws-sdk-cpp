...
class LastUpdate {
 public:
  ...
  inline void SetTargetQueryTCU(int value) {
    m_targetQueryTCUHasBeenSet = true;
    m_targetQueryTCU = value;
  }
  inline LastUpdate& WithTargetQueryTCU(int value) {
    SetTargetQueryTCU(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(LastUpdateStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline LastUpdate& WithStatus(LastUpdateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
