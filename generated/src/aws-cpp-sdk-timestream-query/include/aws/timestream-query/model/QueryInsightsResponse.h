...
class QueryInsightsResponse {
 public:
  ...
  void SetQuerySpatialCoverage(QuerySpatialCoverageT&& value) {
    ...
    m_querySpatialCoverage = std::forward<QuerySpatialCoverageT>(value);
  }
  template <typename QuerySpatialCoverageT = QuerySpatialCoverage>
  QueryInsightsResponse& WithQuerySpatialCoverage(QuerySpatialCoverageT&& value) {
    SetQuerySpatialCoverage(std::forward<QuerySpatialCoverageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueryTemporalRange(QueryTemporalRangeT&& value) {
    ...
    m_queryTemporalRange = std::forward<QueryTemporalRangeT>(value);
  }
  template <typename QueryTemporalRangeT = QueryTemporalRange>
  QueryInsightsResponse& WithQueryTemporalRange(QueryTemporalRangeT&& value) {
    SetQueryTemporalRange(std::forward<QueryTemporalRangeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetQueryTableCount(long long value) {
    m_queryTableCountHasBeenSet = true;
    m_queryTableCount = value;
  }
  inline QueryInsightsResponse& WithQueryTableCount(long long value) {
    SetQueryTableCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutputRows(long long value) {
    m_outputRowsHasBeenSet = true;
    m_outputRows = value;
  }
  inline QueryInsightsResponse& WithOutputRows(long long value) {
    SetOutputRows(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutputBytes(long long value) {
    m_outputBytesHasBeenSet = true;
    m_outputBytes = value;
  }
  inline QueryInsightsResponse& WithOutputBytes(long long value) {
    SetOutputBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnloadPartitionCount(long long value) {
    m_unloadPartitionCountHasBeenSet = true;
    m_unloadPartitionCount = value;
  }
  inline QueryInsightsResponse& WithUnloadPartitionCount(long long value) {
    SetUnloadPartitionCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnloadWrittenRows(long long value) {
    m_unloadWrittenRowsHasBeenSet = true;
    m_unloadWrittenRows = value;
  }
  inline QueryInsightsResponse& WithUnloadWrittenRows(long long value) {
    SetUnloadWrittenRows(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnloadWrittenBytes(long long value) {
    m_unloadWrittenBytesHasBeenSet = true;
    m_unloadWrittenBytes = value;
  }
  inline QueryInsightsResponse& WithUnloadWrittenBytes(long long value) {
    SetUnloadWrittenBytes(value);
    return *this;
  }
  ///@}
 private:
