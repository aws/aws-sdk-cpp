...
namespace Model
{
  ...
  {
  public:
    AWS_TIMESTREAMQUERY_API QueryInsightsResponse();
    ...
    inline QueryInsightsResponse& WithQuerySpatialCoverage(const QuerySpatialCoverage& value) { SetQuerySpatialCoverage(value); return *this;}
    inline QueryInsightsResponse& WithQuerySpatialCoverage(QuerySpatialCoverage&& value) { SetQuerySpatialCoverage(std::move(value)); return *this;}
    ///@}
    ...
    inline QueryInsightsResponse& WithQueryTemporalRange(const QueryTemporalRange& value) { SetQueryTemporalRange(value); return *this;}
    inline QueryInsightsResponse& WithQueryTemporalRange(QueryTemporalRange&& value) { SetQueryTemporalRange(std::move(value)); return *this;}
    ///@}
  ...
  private:
    ...
    long long m_unloadPartitionCount;
    bool m_unloadPartitionCountHasBeenSet = false;

    long long m_unloadWrittenRows;
    bool m_unloadWrittenRowsHasBeenSet = false;

    long long m_unloadWrittenBytes;
