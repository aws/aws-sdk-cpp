...
class ScheduledQueryRunSummary {
 public:
  ...
  void SetInvocationTime(InvocationTimeT&& value) {
    ...
    m_invocationTime = std::forward<InvocationTimeT>(value);
  }
  template <typename InvocationTimeT = Aws::Utils::DateTime>
  ScheduledQueryRunSummary& WithInvocationTime(InvocationTimeT&& value) {
    SetInvocationTime(std::forward<InvocationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTriggerTime(TriggerTimeT&& value) {
    ...
    m_triggerTime = std::forward<TriggerTimeT>(value);
  }
  template <typename TriggerTimeT = Aws::Utils::DateTime>
  ScheduledQueryRunSummary& WithTriggerTime(TriggerTimeT&& value) {
    SetTriggerTime(std::forward<TriggerTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRunStatus(ScheduledQueryRunStatus value) {
    m_runStatusHasBeenSet = true;
    m_runStatus = value;
  }
  inline ScheduledQueryRunSummary& WithRunStatus(ScheduledQueryRunStatus value) {
    SetRunStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetExecutionStats(ExecutionStatsT&& value) {
    ...
    m_executionStats = std::forward<ExecutionStatsT>(value);
  }
  template <typename ExecutionStatsT = ExecutionStats>
  ScheduledQueryRunSummary& WithExecutionStats(ExecutionStatsT&& value) {
    SetExecutionStats(std::forward<ExecutionStatsT>(value));
    return *this;
  }
  ///@}
