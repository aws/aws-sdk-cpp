...
class ExecutionStats {
 public:
  ...
  inline ExecutionStats& WithExecutionTimeInMillis(long long value) {
  ...
  inline void SetDataWrites(long long value) {
    m_dataWritesHasBeenSet = true;
    m_dataWrites = value;
  }
  inline ExecutionStats& WithDataWrites(long long value) {
    SetDataWrites(value);
    return *this;
  }
  ///@}
  ...
  inline ExecutionStats& WithBytesMetered(long long value) {
  ...
  inline ExecutionStats& WithCumulativeBytesScanned(long long value) {
  ...
  inline ExecutionStats& WithRecordsIngested(long long value) {
  ...
  inline void SetQueryResultRows(long long value) {
    m_queryResultRowsHasBeenSet = true;
    m_queryResultRows = value;
  }
  inline ExecutionStats& WithQueryResultRows(long long value) {
    SetQueryResultRows(value);
    return *this;
  }
  ///@}
 private:
