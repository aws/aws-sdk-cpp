...
class AWS_TIMESTREAMQUERY_API TimestreamQueryClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  TimestreamQueryClient(const Aws::TimestreamQuery::TimestreamQueryClientConfiguration& clientConfiguration =
  ...
  TimestreamQueryClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<TimestreamQueryEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::TimestreamQuery::TimestreamQueryClientConfiguration& clientConfiguration =
                            Aws::TimestreamQuery::TimestreamQueryClientConfiguration());
  ...
  /**
   * A Callable wrapper for DescribeScheduledQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeScheduledQuery that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeScheduledQueryRequestT = Model::DescribeScheduledQueryRequest>
  void DescribeScheduledQueryAsync(const DescribeScheduledQueryRequestT& request,
  ...
  /**
   * A Callable wrapper for ExecuteScheduledQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExecuteScheduledQuery that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExecuteScheduledQueryRequestT = Model::ExecuteScheduledQueryRequest>
  void ExecuteScheduledQueryAsync(const ExecuteScheduledQueryRequestT& request, const ExecuteScheduledQueryResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PrepareQuery that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PrepareQueryRequestT = Model::PrepareQueryRequest>
  void PrepareQueryAsync(const PrepareQueryRequestT& request, const PrepareQueryResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * timeout in the SDK to support a timeout of 60 seconds. See the <a
