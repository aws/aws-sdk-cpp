...
class StartSelector {
 public:
  ...
  inline void SetStartSelectorType(StartSelectorType value) {
    m_startSelectorTypeHasBeenSet = true;
    m_startSelectorType = value;
  }
  inline StartSelector& WithStartSelectorType(StartSelectorType value) {
    SetStartSelectorType(value);
    return *this;
  }
  ///@}
  ...
  void SetAfterFragmentNumber(AfterFragmentNumberT&& value) {
    ...
    m_afterFragmentNumber = std::forward<AfterFragmentNumberT>(value);
  }
  template <typename AfterFragmentNumberT = Aws::String>
  StartSelector& WithAfterFragmentNumber(AfterFragmentNumberT&& value) {
    SetAfterFragmentNumber(std::forward<AfterFragmentNumberT>(value));
    return *this;
  }
  ///@}
