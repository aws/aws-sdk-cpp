...
class GetMediaRequest : public KinesisVideoMediaRequest {
 public:
  ...
  template <typename StreamNameT = Aws::String>
  GetMediaRequest& WithStreamName(StreamNameT&& value) {
  ...
  template <typename StreamARNT = Aws::String>
  GetMediaRequest& WithStreamARN(StreamARNT&& value) {
  ...
  void SetStartSelector(StartSelectorT&& value) {
    m_startSelectorHasBeenSet = true;
    m_startSelector = std::forward<StartSelectorT>(value);
  }
  template <typename StartSelectorT = StartSelector>
  GetMediaRequest& WithStartSelector(StartSelectorT&& value) {
    SetStartSelector(std::forward<StartSelectorT>(value));
    return *this;
  }
  ///@}
 private:
