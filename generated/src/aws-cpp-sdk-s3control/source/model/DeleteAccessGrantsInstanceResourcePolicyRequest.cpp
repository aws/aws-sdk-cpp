...
Aws::String DeleteAccessGrantsInstanceResourcePolicyRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection DeleteAccessGrantsInstanceResourcePolicyRequest::GetRequestSpecificHeaders() const {
...
DeleteAccessGrantsInstanceResourcePolicyRequest::EndpointParameters
DeleteAccessGrantsInstanceResourcePolicyRequest::GetEndpointContextParams() const {
