...
JobProgressSummary::JobProgressSummary(const XmlNode& xmlNode) { *this = xmlNode; }
...
JobProgressSummary& JobProgressSummary::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!totalNumberOfTasksNode.IsNull()) {
      m_totalNumberOfTasks = StringUtils::ConvertToInt64(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(totalNumberOfTasksNode.GetText()).c_str()).c_str());
    ...
    if (!numberOfTasksSucceededNode.IsNull()) {
      m_numberOfTasksSucceeded = StringUtils::ConvertToInt64(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(numberOfTasksSucceededNode.GetText()).c_str()).c_str());
    ...
    if (!numberOfTasksFailedNode.IsNull()) {
      m_numberOfTasksFailed = StringUtils::ConvertToInt64(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(numberOfTasksFailedNode.GetText()).c_str()).c_str());
