...
Aws::String UpdateJobPriorityRequest::SerializePayload() const { return {}; }
...
UpdateJobPriorityRequest::EndpointParameters UpdateJobPriorityRequest::GetEndpointContextParams() const {
