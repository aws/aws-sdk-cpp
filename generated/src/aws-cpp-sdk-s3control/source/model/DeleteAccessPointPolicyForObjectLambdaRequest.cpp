...
Aws::String DeleteAccessPointPolicyForObjectLambdaRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection DeleteAccessPointPolicyForObjectLambdaRequest::GetRequestSpecificHeaders() const {
...
DeleteAccessPointPolicyForObjectLambdaRequest::EndpointParameters DeleteAccessPointPolicyForObjectLambdaRequest::GetEndpointContextParams()
    const {
