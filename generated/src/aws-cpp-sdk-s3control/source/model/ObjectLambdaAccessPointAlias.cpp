...
ObjectLambdaAccessPointAlias::ObjectLambdaAccessPointAlias(const XmlNode& xmlNode) { *this = xmlNode; }
...
ObjectLambdaAccessPointAlias& ObjectLambdaAccessPointAlias::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!statusNode.IsNull()) {
      m_status = ObjectLambdaAccessPointAliasStatusMapper::GetObjectLambdaAccessPointAliasStatusForName(
