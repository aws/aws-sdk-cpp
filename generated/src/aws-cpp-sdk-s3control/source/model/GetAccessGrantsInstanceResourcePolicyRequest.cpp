...
Aws::String GetAccessGrantsInstanceResourcePolicyRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection GetAccessGrantsInstanceResourcePolicyRequest::GetRequestSpecificHeaders() const {
...
GetAccessGrantsInstanceResourcePolicyRequest::EndpointParameters GetAccessGrantsInstanceResourcePolicyRequest::GetEndpointContextParams()
    const {
