...
S3ObjectLockEventHoldDuration::S3ObjectLockEventHoldDuration(const XmlNode& xmlNode) { *this = xmlNode; }

S3ObjectLockEventHoldDuration& S3ObjectLockEventHoldDuration::operator=(const XmlNode& xmlNode) {
...
void S3ObjectLockEventHoldDuration::AddToNode(XmlNode& parentNode) const {
  Aws::StringStream ss;
  if (m_daysHasBeenSet) {
