...
Aws::String DeleteStorageLensGroupRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection DeleteStorageLensGroupRequest::GetRequestSpecificHeaders() const {
...
DeleteStorageLensGroupRequest::EndpointParameters DeleteStorageLensGroupRequest::GetEndpointContextParams() const {
