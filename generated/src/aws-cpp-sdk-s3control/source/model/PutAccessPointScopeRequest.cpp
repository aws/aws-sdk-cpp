...
Aws::String PutAccessPointScopeRequest::SerializePayload() const {
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("PutAccessPointScopeRequest");
...
PutAccessPointScopeRequest::EndpointParameters PutAccessPointScopeRequest::GetEndpointContextParams() const {
