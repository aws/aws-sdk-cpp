...
AdvancedPerformanceMetrics::AdvancedPerformanceMetrics(const XmlNode& xmlNode) { *this = xmlNode; }

AdvancedPerformanceMetrics& AdvancedPerformanceMetrics::operator=(const XmlNode& xmlNode) {
...
void AdvancedPerformanceMetrics::AddToNode(XmlNode& parentNode) const {
  Aws::StringStream ss;
