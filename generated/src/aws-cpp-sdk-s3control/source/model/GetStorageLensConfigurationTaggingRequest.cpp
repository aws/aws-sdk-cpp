...
Aws::String GetStorageLensConfigurationTaggingRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection GetStorageLensConfigurationTaggingRequest::GetRequestSpecificHeaders() const {
...
GetStorageLensConfigurationTaggingRequest::EndpointParameters GetStorageLensConfigurationTaggingRequest::GetEndpointContextParams() const {
