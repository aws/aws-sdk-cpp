...
Aws::String GetStorageLensConfigurationRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection GetStorageLensConfigurationRequest::GetRequestSpecificHeaders() const {
...
GetStorageLensConfigurationRequest::EndpointParameters GetStorageLensConfigurationRequest::GetEndpointContextParams() const {
