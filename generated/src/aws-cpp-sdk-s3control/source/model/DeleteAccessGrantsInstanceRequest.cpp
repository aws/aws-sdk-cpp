...
Aws::String DeleteAccessGrantsInstanceRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection DeleteAccessGrantsInstanceRequest::GetRequestSpecificHeaders() const {
...
DeleteAccessGrantsInstanceRequest::EndpointParameters DeleteAccessGrantsInstanceRequest::GetEndpointContextParams() const {
