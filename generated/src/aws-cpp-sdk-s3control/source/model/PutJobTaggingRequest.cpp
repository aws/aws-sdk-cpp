...
Aws::String PutJobTaggingRequest::SerializePayload() const
{
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("PutJobTaggingRequest");
...
PutJobTaggingRequest::EndpointParameters PutJobTaggingRequest::GetEndpointContextParams() const
{
