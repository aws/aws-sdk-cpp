...
GeneratedManifestEncryption::GeneratedManifestEncryption(const XmlNode& xmlNode) { *this = xmlNode; }

GeneratedManifestEncryption& GeneratedManifestEncryption::operator=(const XmlNode& xmlNode) {
...
void GeneratedManifestEncryption::AddToNode(XmlNode& parentNode) const {
  Aws::StringStream ss;
