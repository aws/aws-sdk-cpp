...
Aws::String GetMultiRegionAccessPointRoutesRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection GetMultiRegionAccessPointRoutesRequest::GetRequestSpecificHeaders() const {
...
GetMultiRegionAccessPointRoutesRequest::EndpointParameters GetMultiRegionAccessPointRoutesRequest::GetEndpointContextParams() const {
