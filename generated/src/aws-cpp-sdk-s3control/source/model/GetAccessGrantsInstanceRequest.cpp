...
Aws::String GetAccessGrantsInstanceRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection GetAccessGrantsInstanceRequest::GetRequestSpecificHeaders() const {
...
GetAccessGrantsInstanceRequest::EndpointParameters GetAccessGrantsInstanceRequest::GetEndpointContextParams() const {
