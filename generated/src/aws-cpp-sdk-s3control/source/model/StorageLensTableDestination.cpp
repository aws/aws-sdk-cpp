...
StorageLensTableDestination::StorageLensTableDestination(const XmlNode& xmlNode) { *this = xmlNode; }

StorageLensTableDestination& StorageLensTableDestination::operator=(const XmlNode& xmlNode) {
...
void StorageLensTableDestination::AddToNode(XmlNode& parentNode) const {
  Aws::StringStream ss;
