...
Aws::String DeleteBucketLifecycleConfigurationRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection DeleteBucketLifecycleConfigurationRequest::GetRequestSpecificHeaders() const {
