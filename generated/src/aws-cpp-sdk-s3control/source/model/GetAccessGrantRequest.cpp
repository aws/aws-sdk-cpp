...
Aws::String GetAccessGrantRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection GetAccessGrantRequest::GetRequestSpecificHeaders() const {
...
GetAccessGrantRequest::EndpointParameters GetAccessGrantRequest::GetEndpointContextParams() const {
