...
ListAccessPointsForDirectoryBucketsResult::ListAccessPointsForDirectoryBucketsResult(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  *this = result;
}

ListAccessPointsForDirectoryBucketsResult& ListAccessPointsForDirectoryBucketsResult::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
