...
StorageLensExpandedPrefixesDataExport::StorageLensExpandedPrefixesDataExport(const XmlNode& xmlNode) { *this = xmlNode; }

StorageLensExpandedPrefixesDataExport& StorageLensExpandedPrefixesDataExport::operator=(const XmlNode& xmlNode) {
...
void StorageLensExpandedPrefixesDataExport::AddToNode(XmlNode& parentNode) const {
  Aws::StringStream ss;
