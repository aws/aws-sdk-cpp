...
Aws::String GetAccessGrantsLocationRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection GetAccessGrantsLocationRequest::GetRequestSpecificHeaders() const {
...
GetAccessGrantsLocationRequest::EndpointParameters GetAccessGrantsLocationRequest::GetEndpointContextParams() const {
