...
Aws::String UpdateStorageLensGroupRequest::SerializePayload() const
{
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("UpdateStorageLensGroupRequest");
...
UpdateStorageLensGroupRequest::EndpointParameters UpdateStorageLensGroupRequest::GetEndpointContextParams() const
{
