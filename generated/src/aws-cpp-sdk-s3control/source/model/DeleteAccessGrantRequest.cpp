...
Aws::String DeleteAccessGrantRequest::SerializePayload() const { return {}; }
...
DeleteAccessGrantRequest::EndpointParameters DeleteAccessGrantRequest::GetEndpointContextParams() const {
