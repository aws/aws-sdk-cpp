...
Aws::String GetAccessPointPolicyForObjectLambdaRequest::SerializePayload() const { return {}; }
...
GetAccessPointPolicyForObjectLambdaRequest::EndpointParameters GetAccessPointPolicyForObjectLambdaRequest::GetEndpointContextParams()
    const {
