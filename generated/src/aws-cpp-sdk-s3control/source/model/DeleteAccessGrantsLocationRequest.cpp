...
Aws::String DeleteAccessGrantsLocationRequest::SerializePayload() const { return {}; }

Aws::Http::HeaderValueCollection DeleteAccessGrantsLocationRequest::GetRequestSpecificHeaders() const {
...
DeleteAccessGrantsLocationRequest::EndpointParameters DeleteAccessGrantsLocationRequest::GetEndpointContextParams() const {
