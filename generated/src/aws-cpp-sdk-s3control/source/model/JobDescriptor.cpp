...
JobDescriptor::JobDescriptor(const XmlNode& xmlNode) { *this = xmlNode; }
...
JobDescriptor& JobDescriptor::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!confirmationRequiredNode.IsNull()) {
      m_confirmationRequired = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(confirmationRequiredNode.GetText()).c_str()).c_str());
    ...
    if (!statusNode.IsNull()) {
      m_status =
          JobStatusMapper::GetJobStatusForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(statusNode.GetText()).c_str()));
    ...
    if (!terminationDateNode.IsNull()) {
      m_terminationDate = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(terminationDateNode.GetText()).c_str()).c_str(),
                                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!suspendedDateNode.IsNull()) {
      m_suspendedDate = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(suspendedDateNode.GetText()).c_str()).c_str(),
                                 Aws::Utils::DateFormat::ISO_8601);
