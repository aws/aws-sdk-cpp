...
class ListAccessGrantsLocationsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessGrantsLocationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetAccessGrantsLocationsList(AccessGrantsLocationsListT&& value) {
    m_accessGrantsLocationsListHasBeenSet = true;
    m_accessGrantsLocationsList = std::forward<AccessGrantsLocationsListT>(value);
  }
  template <typename AccessGrantsLocationsListT = Aws::Vector<ListAccessGrantsLocationsEntry>>
  ListAccessGrantsLocationsResult& WithAccessGrantsLocationsList(AccessGrantsLocationsListT&& value) {
    SetAccessGrantsLocationsList(std::forward<AccessGrantsLocationsListT>(value));
    return *this;
  }
  template <typename AccessGrantsLocationsListT = ListAccessGrantsLocationsEntry>
  ListAccessGrantsLocationsResult& AddAccessGrantsLocationsList(AccessGrantsLocationsListT&& value) {
    m_accessGrantsLocationsListHasBeenSet = true;
    m_accessGrantsLocationsList.emplace_back(std::forward<AccessGrantsLocationsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessGrantsLocationsResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  ListAccessGrantsLocationsResult& WithHostId(HostIdT&& value) {
