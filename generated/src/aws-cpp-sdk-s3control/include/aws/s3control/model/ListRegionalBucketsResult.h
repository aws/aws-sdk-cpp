...
namespace Model
{
  ...
  public:
    ...
    inline ListRegionalBucketsResult& WithHostId(const Aws::String& value) { SetHostId(value); return *this;}
    inline ListRegionalBucketsResult& WithHostId(Aws::String&& value) { SetHostId(std::move(value)); return *this;}
    inline ListRegionalBucketsResult& WithHostId(const char* value) { SetHostId(value); return *this;}
    ///@}
  private:
