...
namespace Model
{
  ...
  {
  public:
    AWS_S3CONTROL_API GetBucketLifecycleConfigurationRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    GetBucketLifecycleConfigurationRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
