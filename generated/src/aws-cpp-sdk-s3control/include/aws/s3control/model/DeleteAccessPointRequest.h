...
namespace Model
{
  ...
  /**
   */
  class DeleteAccessPointRequest : public S3ControlRequest
  {
  public:
    ...
    template<typename AccountIdT = Aws::String>
    DeleteAccessPointRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}

    ///@{
    /**
     * <p>The name of the access point you want to delete.</p> <p>For using this
    ...
    template<typename NameT = Aws::String>
    DeleteAccessPointRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
