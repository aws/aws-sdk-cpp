...
class DeleteAccessGrantsLocationRequest : public S3ControlRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  DeleteAccessGrantsLocationRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename AccessGrantsLocationIdT = Aws::String>
  DeleteAccessGrantsLocationRequest& WithAccessGrantsLocationId(AccessGrantsLocationIdT&& value) {
