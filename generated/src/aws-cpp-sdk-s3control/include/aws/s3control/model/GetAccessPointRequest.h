...
class GetAccessPointRequest : public S3ControlRequest {
 public:
  AWS_S3CONTROL_API GetAccessPointRequest() = default;
  ...
  template <typename AccountIdT = Aws::String>
  GetAccessPointRequest& WithAccountId(AccountIdT&& value) {
  ...
  ///@{
  /**
   * <p>The name of the access point whose configuration information you want to
   * retrieve.</p> <p>For using this parameter with Amazon S3 on Outposts with the
   * REST API, you must specify the name and the x-amz-outpost-id as well.</p> <p>For
  ...
  template <typename NameT = Aws::String>
  GetAccessPointRequest& WithName(NameT&& value) {
