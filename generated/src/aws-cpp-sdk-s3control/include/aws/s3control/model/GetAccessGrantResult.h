...
namespace Model
{
  ...
  public:
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetAccessGrantResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessGrantIdT = Aws::String>
    GetAccessGrantResult& WithAccessGrantId(AccessGrantIdT&& value) { SetAccessGrantId(std::forward<AccessGrantIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessGrantArnT = Aws::String>
    GetAccessGrantResult& WithAccessGrantArn(AccessGrantArnT&& value) { SetAccessGrantArn(std::forward<AccessGrantArnT>(value)); return *this;}
    ///@}
    ...
    template<typename GranteeT = Grantee>
    GetAccessGrantResult& WithGrantee(GranteeT&& value) { SetGrantee(std::forward<GranteeT>(value)); return *this;}
    ///@}
    ...
    inline GetAccessGrantResult& WithPermission(Permission value) { SetPermission(value); return *this;}
    ///@}
    ...
    template<typename AccessGrantsLocationIdT = Aws::String>
    GetAccessGrantResult& WithAccessGrantsLocationId(AccessGrantsLocationIdT&& value) { SetAccessGrantsLocationId(std::forward<AccessGrantsLocationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessGrantsLocationConfigurationT = AccessGrantsLocationConfiguration>
    GetAccessGrantResult& WithAccessGrantsLocationConfiguration(AccessGrantsLocationConfigurationT&& value) { SetAccessGrantsLocationConfiguration(std::forward<AccessGrantsLocationConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename GrantScopeT = Aws::String>
    GetAccessGrantResult& WithGrantScope(GrantScopeT&& value) { SetGrantScope(std::forward<GrantScopeT>(value)); return *this;}
    ///@}
    ...
    template<typename ApplicationArnT = Aws::String>
    GetAccessGrantResult& WithApplicationArn(ApplicationArnT&& value) { SetApplicationArn(std::forward<ApplicationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetAccessGrantResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HostIdT = Aws::String>
    GetAccessGrantResult& WithHostId(HostIdT&& value) { SetHostId(std::forward<HostIdT>(value)); return *this;}
    ///@}
  private:
