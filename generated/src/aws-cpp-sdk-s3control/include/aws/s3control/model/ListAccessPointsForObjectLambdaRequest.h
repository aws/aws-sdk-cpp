...
class ListAccessPointsForObjectLambdaRequest : public S3ControlRequest {
 public:
  AWS_S3CONTROL_API ListAccessPointsForObjectLambdaRequest() = default;
  ...
  template <typename AccountIdT = Aws::String>
  ListAccessPointsForObjectLambdaRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessPointsForObjectLambdaRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccessPointsForObjectLambdaRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
