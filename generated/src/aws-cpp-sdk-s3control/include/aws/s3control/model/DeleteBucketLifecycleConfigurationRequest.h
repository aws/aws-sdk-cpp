...
namespace Model
{
  ...
  /**
   */
  class DeleteBucketLifecycleConfigurationRequest : public S3ControlRequest
  {
  public:
    AWS_S3CONTROL_API DeleteBucketLifecycleConfigurationRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    DeleteBucketLifecycleConfigurationRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BucketT = Aws::String>
    DeleteBucketLifecycleConfigurationRequest& WithBucket(BucketT&& value) { SetBucket(std::forward<BucketT>(value)); return *this;}
    ///@}
  private:
