...
class GetAccessPointPolicyStatusResult {
 public:
  ...
  template <typename PolicyStatusT = PolicyStatus>
  GetAccessPointPolicyStatusResult& WithPolicyStatus(PolicyStatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAccessPointPolicyStatusResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  GetAccessPointPolicyStatusResult& WithHostId(HostIdT&& value) {
