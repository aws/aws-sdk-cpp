...
class ListAccessGrantsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessGrantsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetAccessGrantsList(AccessGrantsListT&& value) {
    m_accessGrantsListHasBeenSet = true;
    m_accessGrantsList = std::forward<AccessGrantsListT>(value);
  }
  template <typename AccessGrantsListT = Aws::Vector<ListAccessGrantEntry>>
  ListAccessGrantsResult& WithAccessGrantsList(AccessGrantsListT&& value) {
    SetAccessGrantsList(std::forward<AccessGrantsListT>(value));
    return *this;
  }
  template <typename AccessGrantsListT = ListAccessGrantEntry>
  ListAccessGrantsResult& AddAccessGrantsList(AccessGrantsListT&& value) {
    m_accessGrantsListHasBeenSet = true;
    m_accessGrantsList.emplace_back(std::forward<AccessGrantsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessGrantsResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  ListAccessGrantsResult& WithHostId(HostIdT&& value) {
