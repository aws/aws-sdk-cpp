...
class ListStorageLensConfigurationsRequest : public S3ControlRequest {
 public:
  AWS_S3CONTROL_API ListStorageLensConfigurationsRequest() = default;
  ...
  template <typename AccountIdT = Aws::String>
  ListStorageLensConfigurationsRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStorageLensConfigurationsRequest& WithNextToken(NextTokenT&& value) {
