...
class GetStorageLensConfigurationResult {
 public:
  ...
  void SetStorageLensConfiguration(StorageLensConfigurationT&& value) {
    m_storageLensConfigurationHasBeenSet = true;
    m_storageLensConfiguration = std::forward<StorageLensConfigurationT>(value);
  }
  template <typename StorageLensConfigurationT = StorageLensConfiguration>
  GetStorageLensConfigurationResult& WithStorageLensConfiguration(StorageLensConfigurationT&& value) {
    SetStorageLensConfiguration(std::forward<StorageLensConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetStorageLensConfigurationResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  GetStorageLensConfigurationResult& WithHostId(HostIdT&& value) {
