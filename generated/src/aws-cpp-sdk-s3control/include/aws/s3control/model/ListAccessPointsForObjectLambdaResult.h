...
class ListAccessPointsForObjectLambdaResult {
 public:
  ...
  AWS_S3CONTROL_API ListAccessPointsForObjectLambdaResult& operator=(
  ...
  void SetObjectLambdaAccessPointList(ObjectLambdaAccessPointListT&& value) {
    m_objectLambdaAccessPointListHasBeenSet = true;
    m_objectLambdaAccessPointList = std::forward<ObjectLambdaAccessPointListT>(value);
  }
  template <typename ObjectLambdaAccessPointListT = Aws::Vector<ObjectLambdaAccessPoint>>
  ListAccessPointsForObjectLambdaResult& WithObjectLambdaAccessPointList(ObjectLambdaAccessPointListT&& value) {
    SetObjectLambdaAccessPointList(std::forward<ObjectLambdaAccessPointListT>(value));
    return *this;
  }
  template <typename ObjectLambdaAccessPointListT = ObjectLambdaAccessPoint>
  ListAccessPointsForObjectLambdaResult& AddObjectLambdaAccessPointList(ObjectLambdaAccessPointListT&& value) {
    m_objectLambdaAccessPointListHasBeenSet = true;
    m_objectLambdaAccessPointList.emplace_back(std::forward<ObjectLambdaAccessPointListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessPointsForObjectLambdaResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessPointsForObjectLambdaResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  ListAccessPointsForObjectLambdaResult& WithHostId(HostIdT&& value) {
