...
namespace Model
{
  ...
  {
  public:
    AWS_S3CONTROL_API GetBucketReplicationRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    GetBucketReplicationRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
