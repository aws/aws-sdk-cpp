...
namespace Model
{
  ...
  /**
   */
  class GetBucketReplicationRequest : public S3ControlRequest
  {
  public:
    AWS_S3CONTROL_API GetBucketReplicationRequest();
     ...
     * <p>The Amazon Web Services account ID of the Outposts bucket.</p>
     */
    inline GetBucketReplicationRequest& WithAccountId(const Aws::String& value) { SetAccountId(value); return *this;}

    /**
     * <p>The Amazon Web Services account ID of the Outposts bucket.</p>
     */
    inline GetBucketReplicationRequest& WithAccountId(Aws::String&& value) { SetAccountId(std::move(value)); return *this;}

    /**
     * <p>The Amazon Web Services account ID of the Outposts bucket.</p>
     */
    inline GetBucketReplicationRequest& WithAccountId(const char* value) { SetAccountId(value); return *this;}


    /**
     * <p>Specifies the bucket to get the replication information for.</p> <p>For using
     * this parameter with Amazon S3 on Outposts with the REST API, you must specify
     * the name and the x-amz-outpost-id as well.</p> <p>For using this parameter with
