...
class GetAccessPointResult {
 public:
  ...
  inline void SetNetworkOrigin(NetworkOrigin value) {
    m_networkOriginHasBeenSet = true;
    m_networkOrigin = value;
  }
  inline GetAccessPointResult& WithNetworkOrigin(NetworkOrigin value) {
    SetNetworkOrigin(value);
    return *this;
  }
  ///@}
