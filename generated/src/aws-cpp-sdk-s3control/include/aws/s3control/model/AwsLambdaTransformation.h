...
class AwsLambdaTransformation {
 public:
  ...
  template <typename FunctionArnT = Aws::String>
  AwsLambdaTransformation& WithFunctionArn(FunctionArnT&& value) {
  ...
  void SetFunctionPayload(FunctionPayloadT&& value) {
    m_functionPayloadHasBeenSet = true;
    m_functionPayload = std::forward<FunctionPayloadT>(value);
  }
  template <typename FunctionPayloadT = Aws::String>
  AwsLambdaTransformation& WithFunctionPayload(FunctionPayloadT&& value) {
    SetFunctionPayload(std::forward<FunctionPayloadT>(value));
    return *this;
  }
  ///@}
 private:
