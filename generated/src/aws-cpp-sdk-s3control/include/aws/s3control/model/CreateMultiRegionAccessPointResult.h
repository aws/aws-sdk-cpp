...
class CreateMultiRegionAccessPointResult {
 public:
  ...
  void SetRequestTokenARN(RequestTokenARNT&& value) {
    ...
    m_requestTokenARN = std::forward<RequestTokenARNT>(value);
  }
  template <typename RequestTokenARNT = Aws::String>
  CreateMultiRegionAccessPointResult& WithRequestTokenARN(RequestTokenARNT&& value) {
    SetRequestTokenARN(std::forward<RequestTokenARNT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateMultiRegionAccessPointResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  CreateMultiRegionAccessPointResult& WithHostId(HostIdT&& value) {
