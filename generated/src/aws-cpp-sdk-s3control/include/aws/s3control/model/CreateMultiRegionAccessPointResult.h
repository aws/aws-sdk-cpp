...
namespace Model
{
  ...
  {
  public:
    AWS_S3CONTROL_API CreateMultiRegionAccessPointResult() = default;
    ...
    template<typename RequestTokenARNT = Aws::String>
    CreateMultiRegionAccessPointResult& WithRequestTokenARN(RequestTokenARNT&& value) { SetRequestTokenARN(std::forward<RequestTokenARNT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateMultiRegionAccessPointResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HostIdT = Aws::String>
    CreateMultiRegionAccessPointResult& WithHostId(HostIdT&& value) { SetHostId(std::forward<HostIdT>(value)); return *this;}
    ///@}
  private:
