...
/**
 */
class PutAccessPointScopeRequest : public S3ControlRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "PutAccessPointScope"; }
  ...
  ///@{
  /**
   * <p> The Amazon Web Services account ID that owns the access point with scope
   * that you want to create or replace. </p>
   */
  ...
  ///@{
  /**
   * <p>The name of the access point with the scope that you want to create or
   * replace.</p>
   */
