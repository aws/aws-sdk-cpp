...
class PutMultiRegionAccessPointPolicyResult {
 public:
  ...
  AWS_S3CONTROL_API PutMultiRegionAccessPointPolicyResult& operator=(
  ...
  template <typename RequestTokenARNT = Aws::String>
  PutMultiRegionAccessPointPolicyResult& WithRequestTokenARN(RequestTokenARNT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutMultiRegionAccessPointPolicyResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  PutMultiRegionAccessPointPolicyResult& WithHostId(HostIdT&& value) {
