...
class S3BucketDestination {
 public:
  ...
  inline S3BucketDestination& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutputSchemaVersion(OutputSchemaVersion value) {
    m_outputSchemaVersionHasBeenSet = true;
    m_outputSchemaVersion = value;
  }
  inline S3BucketDestination& WithOutputSchemaVersion(OutputSchemaVersion value) {
    SetOutputSchemaVersion(value);
    return *this;
  }
  ///@}
