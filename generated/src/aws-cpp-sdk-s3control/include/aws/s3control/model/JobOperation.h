...
class JobOperation {
 public:
  ...
  void SetLambdaInvoke(LambdaInvokeT&& value) {
    ...
    m_lambdaInvoke = std::forward<LambdaInvokeT>(value);
  }
  template <typename LambdaInvokeT = LambdaInvokeOperation>
  JobOperation& WithLambdaInvoke(LambdaInvokeT&& value) {
    SetLambdaInvoke(std::forward<LambdaInvokeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3PutObjectCopy(S3PutObjectCopyT&& value) {
    ...
    m_s3PutObjectCopy = std::forward<S3PutObjectCopyT>(value);
  }
  template <typename S3PutObjectCopyT = S3CopyObjectOperation>
  JobOperation& WithS3PutObjectCopy(S3PutObjectCopyT&& value) {
    SetS3PutObjectCopy(std::forward<S3PutObjectCopyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3PutObjectAcl(S3PutObjectAclT&& value) {
    ...
    m_s3PutObjectAcl = std::forward<S3PutObjectAclT>(value);
  }
  template <typename S3PutObjectAclT = S3SetObjectAclOperation>
  JobOperation& WithS3PutObjectAcl(S3PutObjectAclT&& value) {
    SetS3PutObjectAcl(std::forward<S3PutObjectAclT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3PutObjectTagging(S3PutObjectTaggingT&& value) {
    ...
    m_s3PutObjectTagging = std::forward<S3PutObjectTaggingT>(value);
  }
  template <typename S3PutObjectTaggingT = S3SetObjectTaggingOperation>
  JobOperation& WithS3PutObjectTagging(S3PutObjectTaggingT&& value) {
    SetS3PutObjectTagging(std::forward<S3PutObjectTaggingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3DeleteObjectTagging(S3DeleteObjectTaggingT&& value) {
    ...
    m_s3DeleteObjectTagging = std::forward<S3DeleteObjectTaggingT>(value);
  }
  template <typename S3DeleteObjectTaggingT = S3DeleteObjectTaggingOperation>
  JobOperation& WithS3DeleteObjectTagging(S3DeleteObjectTaggingT&& value) {
    SetS3DeleteObjectTagging(std::forward<S3DeleteObjectTaggingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3InitiateRestoreObject(S3InitiateRestoreObjectT&& value) {
    ...
    m_s3InitiateRestoreObject = std::forward<S3InitiateRestoreObjectT>(value);
  }
  template <typename S3InitiateRestoreObjectT = S3InitiateRestoreObjectOperation>
  JobOperation& WithS3InitiateRestoreObject(S3InitiateRestoreObjectT&& value) {
    SetS3InitiateRestoreObject(std::forward<S3InitiateRestoreObjectT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3PutObjectLegalHold(S3PutObjectLegalHoldT&& value) {
    ...
    m_s3PutObjectLegalHold = std::forward<S3PutObjectLegalHoldT>(value);
  }
  template <typename S3PutObjectLegalHoldT = S3SetObjectLegalHoldOperation>
  JobOperation& WithS3PutObjectLegalHold(S3PutObjectLegalHoldT&& value) {
    SetS3PutObjectLegalHold(std::forward<S3PutObjectLegalHoldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3PutObjectRetention(S3PutObjectRetentionT&& value) {
    ...
    m_s3PutObjectRetention = std::forward<S3PutObjectRetentionT>(value);
  }
  template <typename S3PutObjectRetentionT = S3SetObjectRetentionOperation>
  JobOperation& WithS3PutObjectRetention(S3PutObjectRetentionT&& value) {
    SetS3PutObjectRetention(std::forward<S3PutObjectRetentionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3ReplicateObject(S3ReplicateObjectT&& value) {
    ...
    m_s3ReplicateObject = std::forward<S3ReplicateObjectT>(value);
  }
  template <typename S3ReplicateObjectT = S3ReplicateObjectOperation>
  JobOperation& WithS3ReplicateObject(S3ReplicateObjectT&& value) {
    SetS3ReplicateObject(std::forward<S3ReplicateObjectT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3ComputeObjectChecksum(S3ComputeObjectChecksumT&& value) {
    ...
    m_s3ComputeObjectChecksum = std::forward<S3ComputeObjectChecksumT>(value);
  }
  template <typename S3ComputeObjectChecksumT = S3ComputeObjectChecksumOperation>
  JobOperation& WithS3ComputeObjectChecksum(S3ComputeObjectChecksumT&& value) {
    SetS3ComputeObjectChecksum(std::forward<S3ComputeObjectChecksumT>(value));
    return *this;
  }
  ///@}
 private:
