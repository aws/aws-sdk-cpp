...
class ListAccessGrantsLocationsRequest : public S3ControlRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  ListAccessGrantsLocationsRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessGrantsLocationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccessGrantsLocationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetLocationScope(LocationScopeT&& value) {
    ...
    m_locationScope = std::forward<LocationScopeT>(value);
  }
  template <typename LocationScopeT = Aws::String>
  ListAccessGrantsLocationsRequest& WithLocationScope(LocationScopeT&& value) {
    SetLocationScope(std::forward<LocationScopeT>(value));
    return *this;
  }
  ///@}
 private:
