...
class SourceSelectionCriteria {
 public:
  ...
  void SetSseKmsEncryptedObjects(SseKmsEncryptedObjectsT&& value) {
    ...
    m_sseKmsEncryptedObjects = std::forward<SseKmsEncryptedObjectsT>(value);
  }
  template <typename SseKmsEncryptedObjectsT = SseKmsEncryptedObjects>
  SourceSelectionCriteria& WithSseKmsEncryptedObjects(SseKmsEncryptedObjectsT&& value) {
    SetSseKmsEncryptedObjects(std::forward<SseKmsEncryptedObjectsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicaModifications(ReplicaModificationsT&& value) {
    ...
    m_replicaModifications = std::forward<ReplicaModificationsT>(value);
  }
  template <typename ReplicaModificationsT = ReplicaModifications>
  SourceSelectionCriteria& WithReplicaModifications(ReplicaModificationsT&& value) {
    SetReplicaModifications(std::forward<ReplicaModificationsT>(value));
    return *this;
  }
  ///@}
 private:
