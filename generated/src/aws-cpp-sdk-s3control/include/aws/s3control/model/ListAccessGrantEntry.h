...
class ListAccessGrantEntry {
 public:
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ListAccessGrantEntry& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename AccessGrantIdT = Aws::String>
  ListAccessGrantEntry& WithAccessGrantId(AccessGrantIdT&& value) {
  ...
  void SetAccessGrantArn(AccessGrantArnT&& value) {
    ...
    m_accessGrantArn = std::forward<AccessGrantArnT>(value);
  }
  template <typename AccessGrantArnT = Aws::String>
  ListAccessGrantEntry& WithAccessGrantArn(AccessGrantArnT&& value) {
    SetAccessGrantArn(std::forward<AccessGrantArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGrantee(GranteeT&& value) {
    ...
    m_grantee = std::forward<GranteeT>(value);
  }
  template <typename GranteeT = Grantee>
  ListAccessGrantEntry& WithGrantee(GranteeT&& value) {
    SetGrantee(std::forward<GranteeT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListAccessGrantEntry& WithPermission(Permission value) {
    SetPermission(value);
    return *this;
  }
  ///@}
  ...
  void SetAccessGrantsLocationId(AccessGrantsLocationIdT&& value) {
    ...
    m_accessGrantsLocationId = std::forward<AccessGrantsLocationIdT>(value);
  }
  template <typename AccessGrantsLocationIdT = Aws::String>
  ListAccessGrantEntry& WithAccessGrantsLocationId(AccessGrantsLocationIdT&& value) {
    SetAccessGrantsLocationId(std::forward<AccessGrantsLocationIdT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AccessGrantsLocationConfiguration& GetAccessGrantsLocationConfiguration() const {
    return m_accessGrantsLocationConfiguration;
  }
  ...
  void SetAccessGrantsLocationConfiguration(AccessGrantsLocationConfigurationT&& value) {
    ...
    m_accessGrantsLocationConfiguration = std::forward<AccessGrantsLocationConfigurationT>(value);
  }
  template <typename AccessGrantsLocationConfigurationT = AccessGrantsLocationConfiguration>
  ListAccessGrantEntry& WithAccessGrantsLocationConfiguration(AccessGrantsLocationConfigurationT&& value) {
    SetAccessGrantsLocationConfiguration(std::forward<AccessGrantsLocationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGrantScope(GrantScopeT&& value) {
    ...
    m_grantScope = std::forward<GrantScopeT>(value);
  }
  template <typename GrantScopeT = Aws::String>
  ListAccessGrantEntry& WithGrantScope(GrantScopeT&& value) {
    SetGrantScope(std::forward<GrantScopeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ApplicationArnT = Aws::String>
  ListAccessGrantEntry& WithApplicationArn(ApplicationArnT&& value) {
