...
namespace Model
{
  ...
  {
  public:
    AWS_S3CONTROL_API DeleteStorageLensConfigurationRequest() = default;
    ...
    template<typename ConfigIdT = Aws::String>
    DeleteStorageLensConfigurationRequest& WithConfigId(ConfigIdT&& value) { SetConfigId(std::forward<ConfigIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AccountIdT = Aws::String>
    DeleteStorageLensConfigurationRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
  private:
