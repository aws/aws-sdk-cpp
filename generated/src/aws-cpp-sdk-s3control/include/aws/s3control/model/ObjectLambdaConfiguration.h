...
class ObjectLambdaConfiguration {
 public:
  ...
  void SetSupportingAccessPoint(SupportingAccessPointT&& value) {
    ...
    m_supportingAccessPoint = std::forward<SupportingAccessPointT>(value);
  }
  template <typename SupportingAccessPointT = Aws::String>
  ObjectLambdaConfiguration& WithSupportingAccessPoint(SupportingAccessPointT&& value) {
    SetSupportingAccessPoint(std::forward<SupportingAccessPointT>(value));
    return *this;
  }
  ///@}
  ...
  inline ObjectLambdaConfiguration& WithCloudWatchMetricsEnabled(bool value) {
  ...
  void SetAllowedFeatures(AllowedFeaturesT&& value) {
    ...
    m_allowedFeatures = std::forward<AllowedFeaturesT>(value);
  }
  template <typename AllowedFeaturesT = Aws::Vector<ObjectLambdaAllowedFeature>>
  ObjectLambdaConfiguration& WithAllowedFeatures(AllowedFeaturesT&& value) {
    SetAllowedFeatures(std::forward<AllowedFeaturesT>(value));
    return *this;
  }
  inline ObjectLambdaConfiguration& AddAllowedFeatures(ObjectLambdaAllowedFeature value) {
    m_allowedFeaturesHasBeenSet = true;
    m_allowedFeatures.push_back(value);
    return *this;
  }
  ///@}
   ...
   * Point.</p>
   */
  inline const Aws::Vector<ObjectLambdaTransformationConfiguration>& GetTransformationConfigurations() const {
    return m_transformationConfigurations;
  }
  ...
  void SetTransformationConfigurations(TransformationConfigurationsT&& value) {
    ...
    m_transformationConfigurations = std::forward<TransformationConfigurationsT>(value);
  }
  template <typename TransformationConfigurationsT = Aws::Vector<ObjectLambdaTransformationConfiguration>>
  ObjectLambdaConfiguration& WithTransformationConfigurations(TransformationConfigurationsT&& value) {
    SetTransformationConfigurations(std::forward<TransformationConfigurationsT>(value));
    return *this;
  }
  ...
  ObjectLambdaConfiguration& AddTransformationConfigurations(TransformationConfigurationsT&& value) {
    m_transformationConfigurationsHasBeenSet = true;
    m_transformationConfigurations.emplace_back(std::forward<TransformationConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
