...
class AsyncResponseDetails {
 public:
  ...
  void SetMultiRegionAccessPointDetails(MultiRegionAccessPointDetailsT&& value) {
    m_multiRegionAccessPointDetailsHasBeenSet = true;
    m_multiRegionAccessPointDetails = std::forward<MultiRegionAccessPointDetailsT>(value);
  }
  template <typename MultiRegionAccessPointDetailsT = MultiRegionAccessPointsAsyncResponse>
  AsyncResponseDetails& WithMultiRegionAccessPointDetails(MultiRegionAccessPointDetailsT&& value) {
    SetMultiRegionAccessPointDetails(std::forward<MultiRegionAccessPointDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorDetailsT = AsyncErrorDetails>
  AsyncResponseDetails& WithErrorDetails(ErrorDetailsT&& value) {
