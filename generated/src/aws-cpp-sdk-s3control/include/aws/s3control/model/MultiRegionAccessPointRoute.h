...
class MultiRegionAccessPointRoute {
 public:
  ...
  template <typename BucketT = Aws::String>
  MultiRegionAccessPointRoute& WithBucket(BucketT&& value) {
  ...
  template <typename RegionT = Aws::String>
  MultiRegionAccessPointRoute& WithRegion(RegionT&& value) {
  ...
  inline void SetTrafficDialPercentage(int value) {
    m_trafficDialPercentageHasBeenSet = true;
    m_trafficDialPercentage = value;
  }
  inline MultiRegionAccessPointRoute& WithTrafficDialPercentage(int value) {
