...
class GetAccessPointScopeResult {
 public:
  ...
  template <typename ScopeT = Scope>
  GetAccessPointScopeResult& WithScope(ScopeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAccessPointScopeResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  GetAccessPointScopeResult& WithHostId(HostIdT&& value) {
