...
class ObjectEncryptionFilter {
 public:
  ...
  template <typename SSES3T = SSES3Filter>
  ObjectEncryptionFilter& WithSSES3(SSES3T&& value) {
  ...
  template <typename SSEKMST = SSEKMSFilter>
  ObjectEncryptionFilter& WithSSEKMS(SSEKMST&& value) {
  ...
  void SetDSSEKMS(DSSEKMST&& value) {
    m_dSSEKMSHasBeenSet = true;
    m_dSSEKMS = std::forward<DSSEKMST>(value);
  }
  template <typename DSSEKMST = DSSEKMSFilter>
  ObjectEncryptionFilter& WithDSSEKMS(DSSEKMST&& value) {
    SetDSSEKMS(std::forward<DSSEKMST>(value));
    return *this;
  }
  ///@}
  ...
  void SetSSEC(SSECT&& value) {
    m_sSECHasBeenSet = true;
    m_sSEC = std::forward<SSECT>(value);
  }
  template <typename SSECT = SSECFilter>
  ObjectEncryptionFilter& WithSSEC(SSECT&& value) {
    SetSSEC(std::forward<SSECT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNOTSSE(NOTSSET&& value) {
    m_nOTSSEHasBeenSet = true;
    m_nOTSSE = std::forward<NOTSSET>(value);
  }
  template <typename NOTSSET = NotSSEFilter>
  ObjectEncryptionFilter& WithNOTSSE(NOTSSET&& value) {
    SetNOTSSE(std::forward<NOTSSET>(value));
    return *this;
  }
  ///@}
 private:
