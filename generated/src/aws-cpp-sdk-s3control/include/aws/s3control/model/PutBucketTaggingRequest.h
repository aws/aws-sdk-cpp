...
namespace Model
{
  ...
  {
  public:
    AWS_S3CONTROL_API PutBucketTaggingRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    PutBucketTaggingRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
