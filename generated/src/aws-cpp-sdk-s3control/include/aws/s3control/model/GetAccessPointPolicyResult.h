...
class GetAccessPointPolicyResult {
 public:
  AWS_S3CONTROL_API GetAccessPointPolicyResult() = default;
  ...
  template <typename PolicyT = Aws::String>
  GetAccessPointPolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAccessPointPolicyResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  GetAccessPointPolicyResult& WithHostId(HostIdT&& value) {
