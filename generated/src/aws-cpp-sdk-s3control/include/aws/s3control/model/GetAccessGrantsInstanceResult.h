...
class GetAccessGrantsInstanceResult {
 public:
  ...
  template <typename AccessGrantsInstanceArnT = Aws::String>
  GetAccessGrantsInstanceResult& WithAccessGrantsInstanceArn(AccessGrantsInstanceArnT&& value) {
  ...
  template <typename AccessGrantsInstanceIdT = Aws::String>
  GetAccessGrantsInstanceResult& WithAccessGrantsInstanceId(AccessGrantsInstanceIdT&& value) {
  ...
  template <typename IdentityCenterInstanceArnT = Aws::String>
  GetAccessGrantsInstanceResult& WithIdentityCenterInstanceArn(IdentityCenterInstanceArnT&& value) {
  ...
  template <typename IdentityCenterApplicationArnT = Aws::String>
  GetAccessGrantsInstanceResult& WithIdentityCenterApplicationArn(IdentityCenterApplicationArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetAccessGrantsInstanceResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAccessGrantsInstanceResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  GetAccessGrantsInstanceResult& WithHostId(HostIdT&& value) {
