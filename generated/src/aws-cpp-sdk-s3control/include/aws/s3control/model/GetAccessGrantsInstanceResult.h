...
namespace Model
{
  ...
  {
  public:
    AWS_S3CONTROL_API GetAccessGrantsInstanceResult() = default;
    ...
    template<typename AccessGrantsInstanceArnT = Aws::String>
    GetAccessGrantsInstanceResult& WithAccessGrantsInstanceArn(AccessGrantsInstanceArnT&& value) { SetAccessGrantsInstanceArn(std::forward<AccessGrantsInstanceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessGrantsInstanceIdT = Aws::String>
    GetAccessGrantsInstanceResult& WithAccessGrantsInstanceId(AccessGrantsInstanceIdT&& value) { SetAccessGrantsInstanceId(std::forward<AccessGrantsInstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentityCenterInstanceArnT = Aws::String>
    GetAccessGrantsInstanceResult& WithIdentityCenterInstanceArn(IdentityCenterInstanceArnT&& value) { SetIdentityCenterInstanceArn(std::forward<IdentityCenterInstanceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentityCenterApplicationArnT = Aws::String>
    GetAccessGrantsInstanceResult& WithIdentityCenterApplicationArn(IdentityCenterApplicationArnT&& value) { SetIdentityCenterApplicationArn(std::forward<IdentityCenterApplicationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetAccessGrantsInstanceResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetAccessGrantsInstanceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HostIdT = Aws::String>
    GetAccessGrantsInstanceResult& WithHostId(HostIdT&& value) { SetHostId(std::forward<HostIdT>(value)); return *this;}
    ///@}
  private:
