...
class ListStorageLensConfigurationsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListStorageLensConfigurationsResult& WithNextToken(NextTokenT&& value) {
   ...
   */
  inline const Aws::Vector<ListStorageLensConfigurationEntry>& GetStorageLensConfigurationList() const {
    return m_storageLensConfigurationList;
  }
  template <typename StorageLensConfigurationListT = Aws::Vector<ListStorageLensConfigurationEntry>>
  void SetStorageLensConfigurationList(StorageLensConfigurationListT&& value) {
    m_storageLensConfigurationListHasBeenSet = true;
    m_storageLensConfigurationList = std::forward<StorageLensConfigurationListT>(value);
  }
  template <typename StorageLensConfigurationListT = Aws::Vector<ListStorageLensConfigurationEntry>>
  ListStorageLensConfigurationsResult& WithStorageLensConfigurationList(StorageLensConfigurationListT&& value) {
    SetStorageLensConfigurationList(std::forward<StorageLensConfigurationListT>(value));
    return *this;
  }
  template <typename StorageLensConfigurationListT = ListStorageLensConfigurationEntry>
  ListStorageLensConfigurationsResult& AddStorageLensConfigurationList(StorageLensConfigurationListT&& value) {
    m_storageLensConfigurationListHasBeenSet = true;
    m_storageLensConfigurationList.emplace_back(std::forward<StorageLensConfigurationListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListStorageLensConfigurationsResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  ListStorageLensConfigurationsResult& WithHostId(HostIdT&& value) {
