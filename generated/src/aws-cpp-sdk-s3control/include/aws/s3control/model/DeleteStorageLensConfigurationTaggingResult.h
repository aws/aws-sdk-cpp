...
namespace Model
{
  ...
  public:
    ...
    inline DeleteStorageLensConfigurationTaggingResult& WithHostId(const Aws::String& value) { SetHostId(value); return *this;}
    inline DeleteStorageLensConfigurationTaggingResult& WithHostId(Aws::String&& value) { SetHostId(std::move(value)); return *this;}
    inline DeleteStorageLensConfigurationTaggingResult& WithHostId(const char* value) { SetHostId(value); return *this;}
    ///@}
  private:
