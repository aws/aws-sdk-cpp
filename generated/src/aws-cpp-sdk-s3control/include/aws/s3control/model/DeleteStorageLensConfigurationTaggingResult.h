...
class DeleteStorageLensConfigurationTaggingResult {
 public:
  ...
  AWS_S3CONTROL_API DeleteStorageLensConfigurationTaggingResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  DeleteStorageLensConfigurationTaggingResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  DeleteStorageLensConfigurationTaggingResult& WithHostId(HostIdT&& value) {
