...
class CreateMultiRegionAccessPointInput {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateMultiRegionAccessPointInput& WithName(NameT&& value) {
  ...
  template <typename PublicAccessBlockT = PublicAccessBlockConfiguration>
  CreateMultiRegionAccessPointInput& WithPublicAccessBlock(PublicAccessBlockT&& value) {
  ...
  template <typename RegionsT = Aws::Vector<Region>>
  CreateMultiRegionAccessPointInput& WithRegions(RegionsT&& value) {
    SetRegions(std::forward<RegionsT>(value));
    return *this;
  }
  template <typename RegionsT = Region>
  CreateMultiRegionAccessPointInput& AddRegions(RegionsT&& value) {
    m_regionsHasBeenSet = true;
