 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/s3control-2018-08-20/S3ObjectLockRetentionEventHoldDuration">AWS
 * API Reference</a></p>
 */
class S3ObjectLockRetentionEventHoldDuration {
 public:
  AWS_S3CONTROL_API S3ObjectLockRetentionEventHoldDuration() = default;
  AWS_S3CONTROL_API S3ObjectLockRetentionEventHoldDuration(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_S3CONTROL_API S3ObjectLockRetentionEventHoldDuration& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  inline S3ObjectLockRetentionEventHoldDuration& WithDays(int value) {
    SetDays(value);
    return *this;
  }
  ///@}
  ...
  inline S3ObjectLockRetentionEventHoldDuration& WithYears(int value) {
    SetYears(value);
    return *this;
  }
  ///@}
