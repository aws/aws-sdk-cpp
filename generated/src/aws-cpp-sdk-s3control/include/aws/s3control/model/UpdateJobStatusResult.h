...
class UpdateJobStatusResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  UpdateJobStatusResult& WithJobId(JobIdT&& value) {
  ...
  inline UpdateJobStatusResult& WithStatus(JobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusUpdateReasonT = Aws::String>
  UpdateJobStatusResult& WithStatusUpdateReason(StatusUpdateReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateJobStatusResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  UpdateJobStatusResult& WithHostId(HostIdT&& value) {
