...
class GetStorageLensConfigurationTaggingResult {
 public:
  ...
  AWS_S3CONTROL_API GetStorageLensConfigurationTaggingResult& operator=(
  ...
  template <typename TagsT = Aws::Vector<StorageLensTag>>
  GetStorageLensConfigurationTaggingResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = StorageLensTag>
  GetStorageLensConfigurationTaggingResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetStorageLensConfigurationTaggingResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  GetStorageLensConfigurationTaggingResult& WithHostId(HostIdT&& value) {
