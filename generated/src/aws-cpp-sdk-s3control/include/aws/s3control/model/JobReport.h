...
class JobReport {
 public:
  ...
  inline void SetFormat(JobReportFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline JobReport& WithFormat(JobReportFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline JobReport& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReportScope(JobReportScope value) {
    m_reportScopeHasBeenSet = true;
    m_reportScope = value;
  }
  inline JobReport& WithReportScope(JobReportScope value) {
