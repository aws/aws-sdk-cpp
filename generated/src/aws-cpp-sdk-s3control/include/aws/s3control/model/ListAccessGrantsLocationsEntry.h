...
class ListAccessGrantsLocationsEntry {
 public:
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ListAccessGrantsLocationsEntry& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename AccessGrantsLocationIdT = Aws::String>
  ListAccessGrantsLocationsEntry& WithAccessGrantsLocationId(AccessGrantsLocationIdT&& value) {
  ...
  void SetAccessGrantsLocationArn(AccessGrantsLocationArnT&& value) {
    ...
    m_accessGrantsLocationArn = std::forward<AccessGrantsLocationArnT>(value);
  }
  template <typename AccessGrantsLocationArnT = Aws::String>
  ListAccessGrantsLocationsEntry& WithAccessGrantsLocationArn(AccessGrantsLocationArnT&& value) {
    SetAccessGrantsLocationArn(std::forward<AccessGrantsLocationArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocationScopeT = Aws::String>
  ListAccessGrantsLocationsEntry& WithLocationScope(LocationScopeT&& value) {
  ...
  template <typename IAMRoleArnT = Aws::String>
  ListAccessGrantsLocationsEntry& WithIAMRoleArn(IAMRoleArnT&& value) {
