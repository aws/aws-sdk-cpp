...
class ListCallerAccessGrantsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCallerAccessGrantsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetCallerAccessGrantsList(CallerAccessGrantsListT&& value) {
    m_callerAccessGrantsListHasBeenSet = true;
    m_callerAccessGrantsList = std::forward<CallerAccessGrantsListT>(value);
  }
  template <typename CallerAccessGrantsListT = Aws::Vector<ListCallerAccessGrantsEntry>>
  ListCallerAccessGrantsResult& WithCallerAccessGrantsList(CallerAccessGrantsListT&& value) {
    SetCallerAccessGrantsList(std::forward<CallerAccessGrantsListT>(value));
    return *this;
  }
  template <typename CallerAccessGrantsListT = ListCallerAccessGrantsEntry>
  ListCallerAccessGrantsResult& AddCallerAccessGrantsList(CallerAccessGrantsListT&& value) {
    m_callerAccessGrantsListHasBeenSet = true;
    m_callerAccessGrantsList.emplace_back(std::forward<CallerAccessGrantsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCallerAccessGrantsResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  ListCallerAccessGrantsResult& WithHostId(HostIdT&& value) {
