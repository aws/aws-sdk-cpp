...
namespace Model
{
  ...
  public:
    ...
    template<typename PolicyT = Aws::String>
    GetBucketPolicyResult& WithPolicy(PolicyT&& value) { SetPolicy(std::forward<PolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename HostIdT = Aws::String>
    GetBucketPolicyResult& WithHostId(HostIdT&& value) { SetHostId(std::forward<HostIdT>(value)); return *this;}
    ///@}
  private:
