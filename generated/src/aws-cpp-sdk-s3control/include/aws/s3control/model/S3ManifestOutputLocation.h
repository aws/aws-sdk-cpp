...
class S3ManifestOutputLocation {
 public:
  ...
  void SetExpectedManifestBucketOwner(ExpectedManifestBucketOwnerT&& value) {
    ...
    m_expectedManifestBucketOwner = std::forward<ExpectedManifestBucketOwnerT>(value);
  }
  template <typename ExpectedManifestBucketOwnerT = Aws::String>
  S3ManifestOutputLocation& WithExpectedManifestBucketOwner(ExpectedManifestBucketOwnerT&& value) {
    SetExpectedManifestBucketOwner(std::forward<ExpectedManifestBucketOwnerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetManifestPrefix(ManifestPrefixT&& value) {
    ...
    m_manifestPrefix = std::forward<ManifestPrefixT>(value);
  }
  template <typename ManifestPrefixT = Aws::String>
  S3ManifestOutputLocation& WithManifestPrefix(ManifestPrefixT&& value) {
    SetManifestPrefix(std::forward<ManifestPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  void SetManifestEncryption(ManifestEncryptionT&& value) {
    ...
    m_manifestEncryption = std::forward<ManifestEncryptionT>(value);
  }
  template <typename ManifestEncryptionT = GeneratedManifestEncryption>
  S3ManifestOutputLocation& WithManifestEncryption(ManifestEncryptionT&& value) {
    SetManifestEncryption(std::forward<ManifestEncryptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetManifestFormat(GeneratedManifestFormat value) {
    m_manifestFormatHasBeenSet = true;
    m_manifestFormat = value;
  }
  inline S3ManifestOutputLocation& WithManifestFormat(GeneratedManifestFormat value) {
    SetManifestFormat(value);
    return *this;
  }
  ///@}
 private:
