...
class DescribeMultiRegionAccessPointOperationRequest : public S3ControlRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  DescribeMultiRegionAccessPointOperationRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename RequestTokenARNT = Aws::String>
  DescribeMultiRegionAccessPointOperationRequest& WithRequestTokenARN(RequestTokenARNT&& value) {
