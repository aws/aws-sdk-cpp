...
class KeyNameConstraint {
 public:
  ...
  void SetMatchAnySubstring(MatchAnySubstringT&& value) {
    ...
    m_matchAnySubstring = std::forward<MatchAnySubstringT>(value);
  }
  template <typename MatchAnySubstringT = Aws::Vector<Aws::String>>
  KeyNameConstraint& WithMatchAnySubstring(MatchAnySubstringT&& value) {
    SetMatchAnySubstring(std::forward<MatchAnySubstringT>(value));
    return *this;
  }
  template <typename MatchAnySubstringT = Aws::String>
  KeyNameConstraint& AddMatchAnySubstring(MatchAnySubstringT&& value) {
    m_matchAnySubstringHasBeenSet = true;
    m_matchAnySubstring.emplace_back(std::forward<MatchAnySubstringT>(value));
    return *this;
  }
  ///@}
 private:
