...
class StorageLensGroupLevelSelectionCriteria {
 public:
  ...
  template <typename IncludeT = Aws::Vector<Aws::String>>
  StorageLensGroupLevelSelectionCriteria& WithInclude(IncludeT&& value) {
    SetInclude(std::forward<IncludeT>(value));
    return *this;
  }
  template <typename IncludeT = Aws::String>
  StorageLensGroupLevelSelectionCriteria& AddInclude(IncludeT&& value) {
    m_includeHasBeenSet = true;
  ...
  template <typename ExcludeT = Aws::Vector<Aws::String>>
  StorageLensGroupLevelSelectionCriteria& WithExclude(ExcludeT&& value) {
    SetExclude(std::forward<ExcludeT>(value));
    return *this;
  }
  template <typename ExcludeT = Aws::String>
  StorageLensGroupLevelSelectionCriteria& AddExclude(ExcludeT&& value) {
    m_excludeHasBeenSet = true;
