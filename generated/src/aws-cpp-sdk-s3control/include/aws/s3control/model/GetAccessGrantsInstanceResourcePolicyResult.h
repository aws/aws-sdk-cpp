...
namespace Model
{
  ...
  {
  public:
    AWS_S3CONTROL_API GetAccessGrantsInstanceResourcePolicyResult() = default;
    ...
    template<typename PolicyT = Aws::String>
    GetAccessGrantsInstanceResourcePolicyResult& WithPolicy(PolicyT&& value) { SetPolicy(std::forward<PolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename OrganizationT = Aws::String>
    GetAccessGrantsInstanceResourcePolicyResult& WithOrganization(OrganizationT&& value) { SetOrganization(std::forward<OrganizationT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetAccessGrantsInstanceResourcePolicyResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetAccessGrantsInstanceResourcePolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HostIdT = Aws::String>
    GetAccessGrantsInstanceResourcePolicyResult& WithHostId(HostIdT&& value) { SetHostId(std::forward<HostIdT>(value)); return *this;}
    ///@}
  private:
