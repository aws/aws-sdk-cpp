...
class GetAccessGrantsInstanceResourcePolicyResult {
 public:
  ...
  AWS_S3CONTROL_API GetAccessGrantsInstanceResourcePolicyResult& operator=(
  ...
  template <typename PolicyT = Aws::String>
  GetAccessGrantsInstanceResourcePolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename OrganizationT = Aws::String>
  GetAccessGrantsInstanceResourcePolicyResult& WithOrganization(OrganizationT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetAccessGrantsInstanceResourcePolicyResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAccessGrantsInstanceResourcePolicyResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  GetAccessGrantsInstanceResourcePolicyResult& WithHostId(HostIdT&& value) {
