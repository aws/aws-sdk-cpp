...
class GetMultiRegionAccessPointRequest : public S3ControlRequest {
 public:
  AWS_S3CONTROL_API GetMultiRegionAccessPointRequest() = default;
  ...
  template <typename AccountIdT = Aws::String>
  GetMultiRegionAccessPointRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetMultiRegionAccessPointRequest& WithName(NameT&& value) {
