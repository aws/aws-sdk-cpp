...
class ListAccessPointsForDirectoryBucketsResult {
 public:
  ...
  AWS_S3CONTROL_API ListAccessPointsForDirectoryBucketsResult& operator=(
  ...
  template <typename AccessPointListT = Aws::Vector<AccessPoint>>
  ListAccessPointsForDirectoryBucketsResult& WithAccessPointList(AccessPointListT&& value) {
    SetAccessPointList(std::forward<AccessPointListT>(value));
    return *this;
  }
  template <typename AccessPointListT = AccessPoint>
  ListAccessPointsForDirectoryBucketsResult& AddAccessPointList(AccessPointListT&& value) {
    m_accessPointListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessPointsForDirectoryBucketsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessPointsForDirectoryBucketsResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  ListAccessPointsForDirectoryBucketsResult& WithHostId(HostIdT&& value) {
