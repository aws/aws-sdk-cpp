...
class GetAccessPointPolicyStatusForObjectLambdaResult {
 public:
  ...
  AWS_S3CONTROL_API GetAccessPointPolicyStatusForObjectLambdaResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename PolicyStatusT = PolicyStatus>
  GetAccessPointPolicyStatusForObjectLambdaResult& WithPolicyStatus(PolicyStatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAccessPointPolicyStatusForObjectLambdaResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  GetAccessPointPolicyStatusForObjectLambdaResult& WithHostId(HostIdT&& value) {
