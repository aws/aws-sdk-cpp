...
class CreateAccessGrantRequest : public S3ControlRequest {
 public:
  ...
  inline CreateAccessGrantRequest& WithPermission(Permission value) {
    SetPermission(value);
    return *this;
  }
  ///@}
  ...
  inline void SetS3PrefixType(S3PrefixType value) {
    m_s3PrefixTypeHasBeenSet = true;
    m_s3PrefixType = value;
  }
  inline CreateAccessGrantRequest& WithS3PrefixType(S3PrefixType value) {
    SetS3PrefixType(value);
    return *this;
  }
  ///@}
