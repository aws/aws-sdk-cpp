...
class ReplicationRule {
 public:
  ...
  inline ReplicationRule& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ReplicationRuleStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ReplicationRule& WithStatus(ReplicationRuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceSelectionCriteria(SourceSelectionCriteriaT&& value) {
    ...
    m_sourceSelectionCriteria = std::forward<SourceSelectionCriteriaT>(value);
  }
  template <typename SourceSelectionCriteriaT = SourceSelectionCriteria>
  ReplicationRule& WithSourceSelectionCriteria(SourceSelectionCriteriaT&& value) {
    SetSourceSelectionCriteria(std::forward<SourceSelectionCriteriaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExistingObjectReplication(ExistingObjectReplicationT&& value) {
    ...
    m_existingObjectReplication = std::forward<ExistingObjectReplicationT>(value);
  }
  template <typename ExistingObjectReplicationT = ExistingObjectReplication>
  ReplicationRule& WithExistingObjectReplication(ExistingObjectReplicationT&& value) {
    SetExistingObjectReplication(std::forward<ExistingObjectReplicationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeleteMarkerReplication(DeleteMarkerReplicationT&& value) {
    ...
    m_deleteMarkerReplication = std::forward<DeleteMarkerReplicationT>(value);
  }
  template <typename DeleteMarkerReplicationT = DeleteMarkerReplication>
  ReplicationRule& WithDeleteMarkerReplication(DeleteMarkerReplicationT&& value) {
    SetDeleteMarkerReplication(std::forward<DeleteMarkerReplicationT>(value));
    return *this;
  }
  ///@}
