...
class JobManifestGeneratorFilter {
 public:
  ...
  inline void SetEligibleForReplication(bool value) {
    m_eligibleForReplicationHasBeenSet = true;
    m_eligibleForReplication = value;
  }
  inline JobManifestGeneratorFilter& WithEligibleForReplication(bool value) {
    SetEligibleForReplication(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  JobManifestGeneratorFilter& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  JobManifestGeneratorFilter& WithCreatedBefore(CreatedBeforeT&& value) {
  ...
  void SetObjectReplicationStatuses(ObjectReplicationStatusesT&& value) {
    m_objectReplicationStatusesHasBeenSet = true;
    m_objectReplicationStatuses = std::forward<ObjectReplicationStatusesT>(value);
  }
  template <typename ObjectReplicationStatusesT = Aws::Vector<ReplicationStatus>>
  JobManifestGeneratorFilter& WithObjectReplicationStatuses(ObjectReplicationStatusesT&& value) {
    SetObjectReplicationStatuses(std::forward<ObjectReplicationStatusesT>(value));
    return *this;
  }
  inline JobManifestGeneratorFilter& AddObjectReplicationStatuses(ReplicationStatus value) {
    m_objectReplicationStatusesHasBeenSet = true;
    m_objectReplicationStatuses.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetKeyNameConstraint(KeyNameConstraintT&& value) {
    m_keyNameConstraintHasBeenSet = true;
    m_keyNameConstraint = std::forward<KeyNameConstraintT>(value);
  }
  template <typename KeyNameConstraintT = KeyNameConstraint>
  JobManifestGeneratorFilter& WithKeyNameConstraint(KeyNameConstraintT&& value) {
    SetKeyNameConstraint(std::forward<KeyNameConstraintT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetObjectSizeGreaterThanBytes(long long value) {
    m_objectSizeGreaterThanBytesHasBeenSet = true;
    m_objectSizeGreaterThanBytes = value;
  }
  inline JobManifestGeneratorFilter& WithObjectSizeGreaterThanBytes(long long value) {
    SetObjectSizeGreaterThanBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetObjectSizeLessThanBytes(long long value) {
    m_objectSizeLessThanBytesHasBeenSet = true;
    m_objectSizeLessThanBytes = value;
  }
  inline JobManifestGeneratorFilter& WithObjectSizeLessThanBytes(long long value) {
    SetObjectSizeLessThanBytes(value);
    return *this;
  }
  ///@}
  ...
  void SetMatchAnyStorageClass(MatchAnyStorageClassT&& value) {
    m_matchAnyStorageClassHasBeenSet = true;
    m_matchAnyStorageClass = std::forward<MatchAnyStorageClassT>(value);
  }
  template <typename MatchAnyStorageClassT = Aws::Vector<S3StorageClass>>
  JobManifestGeneratorFilter& WithMatchAnyStorageClass(MatchAnyStorageClassT&& value) {
    SetMatchAnyStorageClass(std::forward<MatchAnyStorageClassT>(value));
    return *this;
  }
  inline JobManifestGeneratorFilter& AddMatchAnyStorageClass(S3StorageClass value) {
    m_matchAnyStorageClassHasBeenSet = true;
    m_matchAnyStorageClass.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetMatchAnyObjectEncryption(MatchAnyObjectEncryptionT&& value) {
    m_matchAnyObjectEncryptionHasBeenSet = true;
    m_matchAnyObjectEncryption = std::forward<MatchAnyObjectEncryptionT>(value);
  }
  template <typename MatchAnyObjectEncryptionT = Aws::Vector<ObjectEncryptionFilter>>
  JobManifestGeneratorFilter& WithMatchAnyObjectEncryption(MatchAnyObjectEncryptionT&& value) {
    SetMatchAnyObjectEncryption(std::forward<MatchAnyObjectEncryptionT>(value));
    return *this;
  }
  template <typename MatchAnyObjectEncryptionT = ObjectEncryptionFilter>
  JobManifestGeneratorFilter& AddMatchAnyObjectEncryption(MatchAnyObjectEncryptionT&& value) {
    m_matchAnyObjectEncryptionHasBeenSet = true;
    m_matchAnyObjectEncryption.emplace_back(std::forward<MatchAnyObjectEncryptionT>(value));
    return *this;
  }
  ///@}
 private:
