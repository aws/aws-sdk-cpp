...
class ListAccessPointsForDirectoryBucketsRequest : public S3ControlRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  ListAccessPointsForDirectoryBucketsRequest& WithAccountId(AccountIdT&& value) {
  ...
  void SetDirectoryBucket(DirectoryBucketT&& value) {
    m_directoryBucketHasBeenSet = true;
    m_directoryBucket = std::forward<DirectoryBucketT>(value);
  }
  template <typename DirectoryBucketT = Aws::String>
  ListAccessPointsForDirectoryBucketsRequest& WithDirectoryBucket(DirectoryBucketT&& value) {
    SetDirectoryBucket(std::forward<DirectoryBucketT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessPointsForDirectoryBucketsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccessPointsForDirectoryBucketsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
