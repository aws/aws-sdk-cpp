...
class GetDataAccessRequest : public S3ControlRequest {
 public:
  ...
  inline GetDataAccessRequest& WithPermission(Permission value) {
    SetPermission(value);
    return *this;
  }
  ///@}
  ...
  inline GetDataAccessRequest& WithDurationSeconds(int value) {
  ...
  inline void SetPrivilege(Privilege value) {
    m_privilegeHasBeenSet = true;
    m_privilege = value;
  }
  inline GetDataAccessRequest& WithPrivilege(Privilege value) {
    SetPrivilege(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetType(S3PrefixType value) {
    m_targetTypeHasBeenSet = true;
    m_targetType = value;
  }
  inline GetDataAccessRequest& WithTargetType(S3PrefixType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
