...
class CreateMultiRegionAccessPointRequest : public S3ControlRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  CreateMultiRegionAccessPointRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateMultiRegionAccessPointRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DetailsT = CreateMultiRegionAccessPointInput>
  CreateMultiRegionAccessPointRequest& WithDetails(DetailsT&& value) {
