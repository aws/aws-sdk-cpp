...
class S3CopyObjectOperation {
 public:
  ...
  inline S3CopyObjectOperation& WithCannedAccessControlList(S3CannedAccessControlList value) {
  ...
  void SetAccessControlGrants(AccessControlGrantsT&& value) {
    ...
    m_accessControlGrants = std::forward<AccessControlGrantsT>(value);
  }
  template <typename AccessControlGrantsT = Aws::Vector<S3Grant>>
  S3CopyObjectOperation& WithAccessControlGrants(AccessControlGrantsT&& value) {
    SetAccessControlGrants(std::forward<AccessControlGrantsT>(value));
    return *this;
  }
  template <typename AccessControlGrantsT = S3Grant>
  S3CopyObjectOperation& AddAccessControlGrants(AccessControlGrantsT&& value) {
    m_accessControlGrantsHasBeenSet = true;
    m_accessControlGrants.emplace_back(std::forward<AccessControlGrantsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMetadataDirective(S3MetadataDirective value) {
  ...
  void SetModifiedSinceConstraint(ModifiedSinceConstraintT&& value) {
    ...
    m_modifiedSinceConstraint = std::forward<ModifiedSinceConstraintT>(value);
  }
  template <typename ModifiedSinceConstraintT = Aws::Utils::DateTime>
  S3CopyObjectOperation& WithModifiedSinceConstraint(ModifiedSinceConstraintT&& value) {
    SetModifiedSinceConstraint(std::forward<ModifiedSinceConstraintT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewObjectMetadata(NewObjectMetadataT&& value) {
    ...
    m_newObjectMetadata = std::forward<NewObjectMetadataT>(value);
  }
  template <typename NewObjectMetadataT = S3ObjectMetadata>
  S3CopyObjectOperation& WithNewObjectMetadata(NewObjectMetadataT&& value) {
    SetNewObjectMetadata(std::forward<NewObjectMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewObjectTagging(NewObjectTaggingT&& value) {
    ...
    m_newObjectTagging = std::forward<NewObjectTaggingT>(value);
  }
  template <typename NewObjectTaggingT = Aws::Vector<S3Tag>>
  S3CopyObjectOperation& WithNewObjectTagging(NewObjectTaggingT&& value) {
    SetNewObjectTagging(std::forward<NewObjectTaggingT>(value));
    return *this;
  }
  template <typename NewObjectTaggingT = S3Tag>
  S3CopyObjectOperation& AddNewObjectTagging(NewObjectTaggingT&& value) {
    m_newObjectTaggingHasBeenSet = true;
    m_newObjectTagging.emplace_back(std::forward<NewObjectTaggingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedirectLocation(RedirectLocationT&& value) {
    ...
    m_redirectLocation = std::forward<RedirectLocationT>(value);
  }
  template <typename RedirectLocationT = Aws::String>
  S3CopyObjectOperation& WithRedirectLocation(RedirectLocationT&& value) {
    SetRedirectLocation(std::forward<RedirectLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline S3CopyObjectOperation& WithRequesterPays(bool value) {
  ...
  inline S3CopyObjectOperation& WithStorageClass(S3StorageClass value) {
  ...
  void SetUnModifiedSinceConstraint(UnModifiedSinceConstraintT&& value) {
    ...
    m_unModifiedSinceConstraint = std::forward<UnModifiedSinceConstraintT>(value);
  }
  template <typename UnModifiedSinceConstraintT = Aws::Utils::DateTime>
  S3CopyObjectOperation& WithUnModifiedSinceConstraint(UnModifiedSinceConstraintT&& value) {
    SetUnModifiedSinceConstraint(std::forward<UnModifiedSinceConstraintT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSSEAwsKmsKeyId(SSEAwsKmsKeyIdT&& value) {
    ...
    m_sSEAwsKmsKeyId = std::forward<SSEAwsKmsKeyIdT>(value);
  }
  template <typename SSEAwsKmsKeyIdT = Aws::String>
  S3CopyObjectOperation& WithSSEAwsKmsKeyId(SSEAwsKmsKeyIdT&& value) {
    SetSSEAwsKmsKeyId(std::forward<SSEAwsKmsKeyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetKeyPrefix(TargetKeyPrefixT&& value) {
    ...
    m_targetKeyPrefix = std::forward<TargetKeyPrefixT>(value);
  }
  template <typename TargetKeyPrefixT = Aws::String>
  S3CopyObjectOperation& WithTargetKeyPrefix(TargetKeyPrefixT&& value) {
    SetTargetKeyPrefix(std::forward<TargetKeyPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetObjectLockLegalHoldStatus(S3ObjectLockLegalHoldStatus value) {
    m_objectLockLegalHoldStatusHasBeenSet = true;
    m_objectLockLegalHoldStatus = value;
  }
  inline S3CopyObjectOperation& WithObjectLockLegalHoldStatus(S3ObjectLockLegalHoldStatus value) {
  ...
  inline void SetObjectLockMode(S3ObjectLockMode value) {
    m_objectLockModeHasBeenSet = true;
    m_objectLockMode = value;
  }
  inline S3CopyObjectOperation& WithObjectLockMode(S3ObjectLockMode value) {
  ...
  inline S3CopyObjectOperation& WithBucketKeyEnabled(bool value) {
  ...
  inline void SetChecksumAlgorithm(S3ChecksumAlgorithm value) {
    m_checksumAlgorithmHasBeenSet = true;
    m_checksumAlgorithm = value;
  }
  inline S3CopyObjectOperation& WithChecksumAlgorithm(S3ChecksumAlgorithm value) {
