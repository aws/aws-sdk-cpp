...
namespace Model
{
  ...
  {
  public:
    AWS_S3CONTROL_API GetPublicAccessBlockRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    GetPublicAccessBlockRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
  private:
