...
class MultiRegionAccessPointRegionalResponse {
 public:
  ...
  template <typename NameT = Aws::String>
  MultiRegionAccessPointRegionalResponse& WithName(NameT&& value) {
  ...
  void SetRequestStatus(RequestStatusT&& value) {
    ...
    m_requestStatus = std::forward<RequestStatusT>(value);
  }
  template <typename RequestStatusT = Aws::String>
  MultiRegionAccessPointRegionalResponse& WithRequestStatus(RequestStatusT&& value) {
    SetRequestStatus(std::forward<RequestStatusT>(value));
    return *this;
  }
  ///@}
 private:
