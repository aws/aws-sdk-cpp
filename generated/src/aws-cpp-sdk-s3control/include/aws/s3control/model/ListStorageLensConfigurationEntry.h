...
class ListStorageLensConfigurationEntry {
 public:
  ...
  template <typename IdT = Aws::String>
  ListStorageLensConfigurationEntry& WithId(IdT&& value) {
  ...
  template <typename StorageLensArnT = Aws::String>
  ListStorageLensConfigurationEntry& WithStorageLensArn(StorageLensArnT&& value) {
  ...
  template <typename HomeRegionT = Aws::String>
  ListStorageLensConfigurationEntry& WithHomeRegion(HomeRegionT&& value) {
  ...
  inline ListStorageLensConfigurationEntry& WithIsEnabled(bool value) {
    SetIsEnabled(value);
    return *this;
  }
  ///@}
