...
class DeleteMultiRegionAccessPointResult {
 public:
  ...
  template <typename RequestTokenARNT = Aws::String>
  DeleteMultiRegionAccessPointResult& WithRequestTokenARN(RequestTokenARNT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteMultiRegionAccessPointResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  DeleteMultiRegionAccessPointResult& WithHostId(HostIdT&& value) {
