...
class CreateAccessPointForObjectLambdaRequest : public S3ControlRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  CreateAccessPointForObjectLambdaRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateAccessPointForObjectLambdaRequest& WithName(NameT&& value) {
  ...
  template <typename ConfigurationT = ObjectLambdaConfiguration>
  CreateAccessPointForObjectLambdaRequest& WithConfiguration(ConfigurationT&& value) {
