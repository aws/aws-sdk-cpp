...
namespace Model
{
  ...
  {
  public:
    AWS_S3CONTROL_API DeleteBucketPolicyRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    DeleteBucketPolicyRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
