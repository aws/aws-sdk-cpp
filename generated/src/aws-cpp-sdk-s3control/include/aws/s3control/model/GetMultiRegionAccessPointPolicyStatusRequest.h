...
namespace Model
{
  ...
  /**
   */
  class GetMultiRegionAccessPointPolicyStatusRequest : public S3ControlRequest
  {
  public:
    AWS_S3CONTROL_API GetMultiRegionAccessPointPolicyStatusRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    GetMultiRegionAccessPointPolicyStatusRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    GetMultiRegionAccessPointPolicyStatusRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
