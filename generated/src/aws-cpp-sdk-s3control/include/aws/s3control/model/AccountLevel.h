...
class AccountLevel {
 public:
  ...
  void SetActivityMetrics(ActivityMetricsT&& value) {
    ...
    m_activityMetrics = std::forward<ActivityMetricsT>(value);
  }
  template <typename ActivityMetricsT = ActivityMetrics>
  AccountLevel& WithActivityMetrics(ActivityMetricsT&& value) {
    SetActivityMetrics(std::forward<ActivityMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBucketLevel(BucketLevelT&& value) {
    ...
    m_bucketLevel = std::forward<BucketLevelT>(value);
  }
  template <typename BucketLevelT = BucketLevel>
  AccountLevel& WithBucketLevel(BucketLevelT&& value) {
    SetBucketLevel(std::forward<BucketLevelT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdvancedCostOptimizationMetrics(AdvancedCostOptimizationMetricsT&& value) {
    ...
    m_advancedCostOptimizationMetrics = std::forward<AdvancedCostOptimizationMetricsT>(value);
  }
  template <typename AdvancedCostOptimizationMetricsT = AdvancedCostOptimizationMetrics>
  AccountLevel& WithAdvancedCostOptimizationMetrics(AdvancedCostOptimizationMetricsT&& value) {
    SetAdvancedCostOptimizationMetrics(std::forward<AdvancedCostOptimizationMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdvancedDataProtectionMetrics(AdvancedDataProtectionMetricsT&& value) {
    ...
    m_advancedDataProtectionMetrics = std::forward<AdvancedDataProtectionMetricsT>(value);
  }
  template <typename AdvancedDataProtectionMetricsT = AdvancedDataProtectionMetrics>
  AccountLevel& WithAdvancedDataProtectionMetrics(AdvancedDataProtectionMetricsT&& value) {
    SetAdvancedDataProtectionMetrics(std::forward<AdvancedDataProtectionMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDetailedStatusCodesMetrics(DetailedStatusCodesMetricsT&& value) {
    ...
    m_detailedStatusCodesMetrics = std::forward<DetailedStatusCodesMetricsT>(value);
  }
  template <typename DetailedStatusCodesMetricsT = DetailedStatusCodesMetrics>
  AccountLevel& WithDetailedStatusCodesMetrics(DetailedStatusCodesMetricsT&& value) {
    SetDetailedStatusCodesMetrics(std::forward<DetailedStatusCodesMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStorageLensGroupLevel(StorageLensGroupLevelT&& value) {
    ...
    m_storageLensGroupLevel = std::forward<StorageLensGroupLevelT>(value);
  }
  template <typename StorageLensGroupLevelT = StorageLensGroupLevel>
  AccountLevel& WithStorageLensGroupLevel(StorageLensGroupLevelT&& value) {
    SetStorageLensGroupLevel(std::forward<StorageLensGroupLevelT>(value));
    return *this;
  }
  ///@}
 private:
