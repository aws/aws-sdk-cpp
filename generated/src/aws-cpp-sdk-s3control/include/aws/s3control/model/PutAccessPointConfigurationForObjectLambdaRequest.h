...
class PutAccessPointConfigurationForObjectLambdaRequest : public S3ControlRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  PutAccessPointConfigurationForObjectLambdaRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  PutAccessPointConfigurationForObjectLambdaRequest& WithName(NameT&& value) {
  ...
  template <typename ConfigurationT = ObjectLambdaConfiguration>
  PutAccessPointConfigurationForObjectLambdaRequest& WithConfiguration(ConfigurationT&& value) {
