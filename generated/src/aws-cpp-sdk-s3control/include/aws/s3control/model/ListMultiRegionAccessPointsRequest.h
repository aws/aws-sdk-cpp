...
class ListMultiRegionAccessPointsRequest : public S3ControlRequest {
 public:
  AWS_S3CONTROL_API ListMultiRegionAccessPointsRequest() = default;
  ...
  template <typename AccountIdT = Aws::String>
  ListMultiRegionAccessPointsRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMultiRegionAccessPointsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMultiRegionAccessPointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
