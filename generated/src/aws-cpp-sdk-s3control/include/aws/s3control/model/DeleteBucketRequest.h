...
namespace Model
{
  ...
  /**
   */
  class DeleteBucketRequest : public S3ControlRequest
  {
  public:
    ...
    template<typename AccountIdT = Aws::String>
    DeleteBucketRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BucketT = Aws::String>
    DeleteBucketRequest& WithBucket(BucketT&& value) { SetBucket(std::forward<BucketT>(value)); return *this;}
    ///@}
  private:
