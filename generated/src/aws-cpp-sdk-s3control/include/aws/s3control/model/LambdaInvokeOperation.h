...
class LambdaInvokeOperation {
 public:
  ...
  void SetInvocationSchemaVersion(InvocationSchemaVersionT&& value) {
    ...
    m_invocationSchemaVersion = std::forward<InvocationSchemaVersionT>(value);
  }
  template <typename InvocationSchemaVersionT = Aws::String>
  LambdaInvokeOperation& WithInvocationSchemaVersion(InvocationSchemaVersionT&& value) {
    SetInvocationSchemaVersion(std::forward<InvocationSchemaVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserArguments(UserArgumentsT&& value) {
    ...
    m_userArguments = std::forward<UserArgumentsT>(value);
  }
  template <typename UserArgumentsT = Aws::Map<Aws::String, Aws::String>>
  LambdaInvokeOperation& WithUserArguments(UserArgumentsT&& value) {
    SetUserArguments(std::forward<UserArgumentsT>(value));
    return *this;
  }
  ...
  LambdaInvokeOperation& AddUserArguments(UserArgumentsKeyT&& key, UserArgumentsValueT&& value) {
    m_userArgumentsHasBeenSet = true;
    m_userArguments.emplace(std::forward<UserArgumentsKeyT>(key), std::forward<UserArgumentsValueT>(value));
    return *this;
  }
  ///@}
 private:
