...
namespace Model
{
  ...
  {
  public:
    AWS_S3CONTROL_API ListAccessGrantsInstancesRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    ListAccessGrantsInstancesRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAccessGrantsInstancesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
