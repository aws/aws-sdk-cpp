...
class ListAccessGrantsInstancesRequest : public S3ControlRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  ListAccessGrantsInstancesRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessGrantsInstancesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccessGrantsInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
