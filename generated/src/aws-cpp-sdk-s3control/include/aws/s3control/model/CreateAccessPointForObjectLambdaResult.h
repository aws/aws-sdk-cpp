...
class CreateAccessPointForObjectLambdaResult {
 public:
  ...
  AWS_S3CONTROL_API CreateAccessPointForObjectLambdaResult& operator=(
  ...
  void SetObjectLambdaAccessPointArn(ObjectLambdaAccessPointArnT&& value) {
    m_objectLambdaAccessPointArnHasBeenSet = true;
    m_objectLambdaAccessPointArn = std::forward<ObjectLambdaAccessPointArnT>(value);
  }
  template <typename ObjectLambdaAccessPointArnT = Aws::String>
  CreateAccessPointForObjectLambdaResult& WithObjectLambdaAccessPointArn(ObjectLambdaAccessPointArnT&& value) {
    SetObjectLambdaAccessPointArn(std::forward<ObjectLambdaAccessPointArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AliasT = ObjectLambdaAccessPointAlias>
  CreateAccessPointForObjectLambdaResult& WithAlias(AliasT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAccessPointForObjectLambdaResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename HostIdT = Aws::String>
  CreateAccessPointForObjectLambdaResult& WithHostId(HostIdT&& value) {
