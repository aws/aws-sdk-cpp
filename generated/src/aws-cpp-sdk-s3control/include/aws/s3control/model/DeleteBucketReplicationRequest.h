...
namespace Model
{
  ...
  /**
   */
  class DeleteBucketReplicationRequest : public S3ControlRequest
  {
  public:
    AWS_S3CONTROL_API DeleteBucketReplicationRequest();
    ...
    /**
     * <p>The Amazon Web Services account ID of the Outposts bucket to delete the
     ...
     * replication configuration for.</p>
     */
    inline DeleteBucketReplicationRequest& WithAccountId(const Aws::String& value) { SetAccountId(value); return *this;}

    /**
     * <p>The Amazon Web Services account ID of the Outposts bucket to delete the
     * replication configuration for.</p>
     */
    inline DeleteBucketReplicationRequest& WithAccountId(Aws::String&& value) { SetAccountId(std::move(value)); return *this;}

    /**
     * <p>The Amazon Web Services account ID of the Outposts bucket to delete the
     * replication configuration for.</p>
     */
    inline DeleteBucketReplicationRequest& WithAccountId(const char* value) { SetAccountId(value); return *this;}


    /**
     * <p>Specifies the S3 on Outposts bucket to delete the replication configuration
     * for.</p> <p>For using this parameter with Amazon S3 on Outposts with the REST
