...
class ListCallerAccessGrantsEntry {
 public:
  ...
  inline ListCallerAccessGrantsEntry& WithPermission(Permission value) {
    SetPermission(value);
    return *this;
  }
  ///@}
  ...
  template <typename GrantScopeT = Aws::String>
  ListCallerAccessGrantsEntry& WithGrantScope(GrantScopeT&& value) {
  ...
  template <typename ApplicationArnT = Aws::String>
  ListCallerAccessGrantsEntry& WithApplicationArn(ApplicationArnT&& value) {
