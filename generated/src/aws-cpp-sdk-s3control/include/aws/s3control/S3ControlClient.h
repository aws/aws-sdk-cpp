...
class AWS_S3CONTROL_API S3ControlClient : public Aws::Client::AWSXMLClient,
                                          public Aws::Client::ClientWithAsyncTemplateMethods<S3ControlClient> {
 public:
   ...
   */
  S3ControlClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<S3ControlEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateAccessGrantsIdentityCenterOutcome AssociateAccessGrantsIdentityCenter(
      const Model::AssociateAccessGrantsIdentityCenterRequest& request) const;

  /**
   * A Callable wrapper for AssociateAccessGrantsIdentityCenter that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename AssociateAccessGrantsIdentityCenterRequestT = Model::AssociateAccessGrantsIdentityCenterRequest>
  Model::AssociateAccessGrantsIdentityCenterOutcomeCallable AssociateAccessGrantsIdentityCenterCallable(
      const AssociateAccessGrantsIdentityCenterRequestT& request) const {
    return SubmitCallable(&S3ControlClient::AssociateAccessGrantsIdentityCenter, request);
  }

  /**
   * An Async wrapper for AssociateAccessGrantsIdentityCenter that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateAccessGrantsIdentityCenterRequestT = Model::AssociateAccessGrantsIdentityCenterRequest>
  void AssociateAccessGrantsIdentityCenterAsync(const AssociateAccessGrantsIdentityCenterRequestT& request,
                                                const AssociateAccessGrantsIdentityCenterResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAccessGrantsInstanceOutcome CreateAccessGrantsInstance(
      const Model::CreateAccessGrantsInstanceRequest& request) const;

  /**
   * A Callable wrapper for CreateAccessGrantsInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAccessGrantsInstanceRequestT = Model::CreateAccessGrantsInstanceRequest>
  Model::CreateAccessGrantsInstanceOutcomeCallable CreateAccessGrantsInstanceCallable(
      const CreateAccessGrantsInstanceRequestT& request) const {
    return SubmitCallable(&S3ControlClient::CreateAccessGrantsInstance, request);
  }

  /**
   * An Async wrapper for CreateAccessGrantsInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAccessGrantsInstanceRequestT = Model::CreateAccessGrantsInstanceRequest>
  void CreateAccessGrantsInstanceAsync(const CreateAccessGrantsInstanceRequestT& request,
                                       const CreateAccessGrantsInstanceResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAccessGrantsLocationOutcome CreateAccessGrantsLocation(
      const Model::CreateAccessGrantsLocationRequest& request) const;

  /**
   * A Callable wrapper for CreateAccessGrantsLocation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAccessGrantsLocationRequestT = Model::CreateAccessGrantsLocationRequest>
  Model::CreateAccessGrantsLocationOutcomeCallable CreateAccessGrantsLocationCallable(
      const CreateAccessGrantsLocationRequestT& request) const {
    return SubmitCallable(&S3ControlClient::CreateAccessGrantsLocation, request);
  }

  /**
   * An Async wrapper for CreateAccessGrantsLocation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAccessGrantsLocationRequestT = Model::CreateAccessGrantsLocationRequest>
  void CreateAccessGrantsLocationAsync(const CreateAccessGrantsLocationRequestT& request,
                                       const CreateAccessGrantsLocationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CreateAccessPointForObjectLambdaOutcome CreateAccessPointForObjectLambda(
      const Model::CreateAccessPointForObjectLambdaRequest& request) const;

  /**
   * A Callable wrapper for CreateAccessPointForObjectLambda that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateAccessPointForObjectLambdaRequestT = Model::CreateAccessPointForObjectLambdaRequest>
  Model::CreateAccessPointForObjectLambdaOutcomeCallable CreateAccessPointForObjectLambdaCallable(
      const CreateAccessPointForObjectLambdaRequestT& request) const {
    return SubmitCallable(&S3ControlClient::CreateAccessPointForObjectLambda, request);
  }

  /**
   * An Async wrapper for CreateAccessPointForObjectLambda that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateAccessPointForObjectLambdaRequestT = Model::CreateAccessPointForObjectLambdaRequest>
  void CreateAccessPointForObjectLambdaAsync(const CreateAccessPointForObjectLambdaRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateMultiRegionAccessPointOutcome CreateMultiRegionAccessPoint(
      const Model::CreateMultiRegionAccessPointRequest& request) const;

  /**
   * A Callable wrapper for CreateMultiRegionAccessPoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateMultiRegionAccessPointRequestT = Model::CreateMultiRegionAccessPointRequest>
  Model::CreateMultiRegionAccessPointOutcomeCallable CreateMultiRegionAccessPointCallable(
      const CreateMultiRegionAccessPointRequestT& request) const {
    return SubmitCallable(&S3ControlClient::CreateMultiRegionAccessPoint, request);
  }

  /**
   * An Async wrapper for CreateMultiRegionAccessPoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMultiRegionAccessPointRequestT = Model::CreateMultiRegionAccessPointRequest>
  void CreateMultiRegionAccessPointAsync(const CreateMultiRegionAccessPointRequestT& request,
                                         const CreateMultiRegionAccessPointResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateStorageLensGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStorageLensGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStorageLensGroupRequestT = Model::CreateStorageLensGroupRequest>
  void CreateStorageLensGroupAsync(const CreateStorageLensGroupRequestT& request,
                                   const CreateStorageLensGroupResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAccessGrantsInstanceOutcome DeleteAccessGrantsInstance(
      const Model::DeleteAccessGrantsInstanceRequest& request) const;

  /**
   * A Callable wrapper for DeleteAccessGrantsInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAccessGrantsInstanceRequestT = Model::DeleteAccessGrantsInstanceRequest>
  Model::DeleteAccessGrantsInstanceOutcomeCallable DeleteAccessGrantsInstanceCallable(
      const DeleteAccessGrantsInstanceRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DeleteAccessGrantsInstance, request);
  }

  /**
   * An Async wrapper for DeleteAccessGrantsInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAccessGrantsInstanceRequestT = Model::DeleteAccessGrantsInstanceRequest>
  void DeleteAccessGrantsInstanceAsync(const DeleteAccessGrantsInstanceRequestT& request,
                                       const DeleteAccessGrantsInstanceResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteAccessGrantsInstanceResourcePolicyOutcome DeleteAccessGrantsInstanceResourcePolicy(
      const Model::DeleteAccessGrantsInstanceResourcePolicyRequest& request) const;

  /**
   * A Callable wrapper for DeleteAccessGrantsInstanceResourcePolicy that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteAccessGrantsInstanceResourcePolicyRequestT = Model::DeleteAccessGrantsInstanceResourcePolicyRequest>
  Model::DeleteAccessGrantsInstanceResourcePolicyOutcomeCallable DeleteAccessGrantsInstanceResourcePolicyCallable(
      const DeleteAccessGrantsInstanceResourcePolicyRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DeleteAccessGrantsInstanceResourcePolicy, request);
  }

  /**
   * An Async wrapper for DeleteAccessGrantsInstanceResourcePolicy that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteAccessGrantsInstanceResourcePolicyRequestT = Model::DeleteAccessGrantsInstanceResourcePolicyRequest>
  void DeleteAccessGrantsInstanceResourcePolicyAsync(
      const DeleteAccessGrantsInstanceResourcePolicyRequestT& request,
      const DeleteAccessGrantsInstanceResourcePolicyResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAccessGrantsLocationOutcome DeleteAccessGrantsLocation(
      const Model::DeleteAccessGrantsLocationRequest& request) const;

  /**
   * A Callable wrapper for DeleteAccessGrantsLocation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAccessGrantsLocationRequestT = Model::DeleteAccessGrantsLocationRequest>
  Model::DeleteAccessGrantsLocationOutcomeCallable DeleteAccessGrantsLocationCallable(
      const DeleteAccessGrantsLocationRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DeleteAccessGrantsLocation, request);
  }

  /**
   * An Async wrapper for DeleteAccessGrantsLocation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAccessGrantsLocationRequestT = Model::DeleteAccessGrantsLocationRequest>
  void DeleteAccessGrantsLocationAsync(const DeleteAccessGrantsLocationRequestT& request,
                                       const DeleteAccessGrantsLocationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteAccessPointForObjectLambdaOutcome DeleteAccessPointForObjectLambda(
      const Model::DeleteAccessPointForObjectLambdaRequest& request) const;

  /**
   * A Callable wrapper for DeleteAccessPointForObjectLambda that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteAccessPointForObjectLambdaRequestT = Model::DeleteAccessPointForObjectLambdaRequest>
  Model::DeleteAccessPointForObjectLambdaOutcomeCallable DeleteAccessPointForObjectLambdaCallable(
      const DeleteAccessPointForObjectLambdaRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DeleteAccessPointForObjectLambda, request);
  }

  /**
   * An Async wrapper for DeleteAccessPointForObjectLambda that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteAccessPointForObjectLambdaRequestT = Model::DeleteAccessPointForObjectLambdaRequest>
  void DeleteAccessPointForObjectLambdaAsync(const DeleteAccessPointForObjectLambdaRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteAccessPointPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAccessPointPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAccessPointPolicyRequestT = Model::DeleteAccessPointPolicyRequest>
  void DeleteAccessPointPolicyAsync(const DeleteAccessPointPolicyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAccessPointPolicyForObjectLambdaOutcome DeleteAccessPointPolicyForObjectLambda(
      const Model::DeleteAccessPointPolicyForObjectLambdaRequest& request) const;

  /**
   * A Callable wrapper for DeleteAccessPointPolicyForObjectLambda that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteAccessPointPolicyForObjectLambdaRequestT = Model::DeleteAccessPointPolicyForObjectLambdaRequest>
  Model::DeleteAccessPointPolicyForObjectLambdaOutcomeCallable DeleteAccessPointPolicyForObjectLambdaCallable(
      const DeleteAccessPointPolicyForObjectLambdaRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DeleteAccessPointPolicyForObjectLambda, request);
  }

  /**
   * An Async wrapper for DeleteAccessPointPolicyForObjectLambda that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteAccessPointPolicyForObjectLambdaRequestT = Model::DeleteAccessPointPolicyForObjectLambdaRequest>
  void DeleteAccessPointPolicyForObjectLambdaAsync(const DeleteAccessPointPolicyForObjectLambdaRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteAccessPointScope that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAccessPointScope that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAccessPointScopeRequestT = Model::DeleteAccessPointScopeRequest>
  void DeleteAccessPointScopeAsync(const DeleteAccessPointScopeRequestT& request,
                                   const DeleteAccessPointScopeResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBucketLifecycleConfigurationOutcome DeleteBucketLifecycleConfiguration(
      const Model::DeleteBucketLifecycleConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteBucketLifecycleConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteBucketLifecycleConfigurationRequestT = Model::DeleteBucketLifecycleConfigurationRequest>
  Model::DeleteBucketLifecycleConfigurationOutcomeCallable DeleteBucketLifecycleConfigurationCallable(
      const DeleteBucketLifecycleConfigurationRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DeleteBucketLifecycleConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteBucketLifecycleConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteBucketLifecycleConfigurationRequestT = Model::DeleteBucketLifecycleConfigurationRequest>
  void DeleteBucketLifecycleConfigurationAsync(const DeleteBucketLifecycleConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteJobTagging that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteJobTagging that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteJobTaggingRequestT = Model::DeleteJobTaggingRequest>
  void DeleteJobTaggingAsync(const DeleteJobTaggingRequestT& request, const DeleteJobTaggingResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteMultiRegionAccessPointOutcome DeleteMultiRegionAccessPoint(
      const Model::DeleteMultiRegionAccessPointRequest& request) const;

  /**
   * A Callable wrapper for DeleteMultiRegionAccessPoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteMultiRegionAccessPointRequestT = Model::DeleteMultiRegionAccessPointRequest>
  Model::DeleteMultiRegionAccessPointOutcomeCallable DeleteMultiRegionAccessPointCallable(
      const DeleteMultiRegionAccessPointRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DeleteMultiRegionAccessPoint, request);
  }

  /**
   * An Async wrapper for DeleteMultiRegionAccessPoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMultiRegionAccessPointRequestT = Model::DeleteMultiRegionAccessPointRequest>
  void DeleteMultiRegionAccessPointAsync(const DeleteMultiRegionAccessPointRequestT& request,
                                         const DeleteMultiRegionAccessPointResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Services account. This operation might be restricted when the account is managed
   * by organization-level Block Public Access policies. You’ll get an Access Denied
   ...
   * preventing direct account-level modifications. For more information, see <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteStorageLensConfigurationOutcome DeleteStorageLensConfiguration(
      const Model::DeleteStorageLensConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteStorageLensConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteStorageLensConfigurationRequestT = Model::DeleteStorageLensConfigurationRequest>
  Model::DeleteStorageLensConfigurationOutcomeCallable DeleteStorageLensConfigurationCallable(
      const DeleteStorageLensConfigurationRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DeleteStorageLensConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteStorageLensConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteStorageLensConfigurationRequestT = Model::DeleteStorageLensConfigurationRequest>
  void DeleteStorageLensConfigurationAsync(const DeleteStorageLensConfigurationRequestT& request,
  ...
  virtual Model::DeleteStorageLensConfigurationTaggingOutcome DeleteStorageLensConfigurationTagging(
      const Model::DeleteStorageLensConfigurationTaggingRequest& request) const;

  /**
   * A Callable wrapper for DeleteStorageLensConfigurationTagging that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteStorageLensConfigurationTaggingRequestT = Model::DeleteStorageLensConfigurationTaggingRequest>
  Model::DeleteStorageLensConfigurationTaggingOutcomeCallable DeleteStorageLensConfigurationTaggingCallable(
      const DeleteStorageLensConfigurationTaggingRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DeleteStorageLensConfigurationTagging, request);
  }

  /**
   * An Async wrapper for DeleteStorageLensConfigurationTagging that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteStorageLensConfigurationTaggingRequestT = Model::DeleteStorageLensConfigurationTaggingRequest>
  void DeleteStorageLensConfigurationTaggingAsync(const DeleteStorageLensConfigurationTaggingRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteStorageLensGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteStorageLensGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteStorageLensGroupRequestT = Model::DeleteStorageLensGroupRequest>
  void DeleteStorageLensGroupAsync(const DeleteStorageLensGroupRequestT& request,
                                   const DeleteStorageLensGroupResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeMultiRegionAccessPointOperationOutcome DescribeMultiRegionAccessPointOperation(
      const Model::DescribeMultiRegionAccessPointOperationRequest& request) const;

  /**
   * A Callable wrapper for DescribeMultiRegionAccessPointOperation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeMultiRegionAccessPointOperationRequestT = Model::DescribeMultiRegionAccessPointOperationRequest>
  Model::DescribeMultiRegionAccessPointOperationOutcomeCallable DescribeMultiRegionAccessPointOperationCallable(
      const DescribeMultiRegionAccessPointOperationRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DescribeMultiRegionAccessPointOperation, request);
  }

  /**
   * An Async wrapper for DescribeMultiRegionAccessPointOperation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeMultiRegionAccessPointOperationRequestT = Model::DescribeMultiRegionAccessPointOperationRequest>
  void DescribeMultiRegionAccessPointOperationAsync(const DescribeMultiRegionAccessPointOperationRequestT& request,
                                                    const DescribeMultiRegionAccessPointOperationResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DissociateAccessGrantsIdentityCenterOutcome DissociateAccessGrantsIdentityCenter(
      const Model::DissociateAccessGrantsIdentityCenterRequest& request) const;

  /**
   * A Callable wrapper for DissociateAccessGrantsIdentityCenter that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DissociateAccessGrantsIdentityCenterRequestT = Model::DissociateAccessGrantsIdentityCenterRequest>
  Model::DissociateAccessGrantsIdentityCenterOutcomeCallable DissociateAccessGrantsIdentityCenterCallable(
      const DissociateAccessGrantsIdentityCenterRequestT& request) const {
    return SubmitCallable(&S3ControlClient::DissociateAccessGrantsIdentityCenter, request);
  }

  /**
   * An Async wrapper for DissociateAccessGrantsIdentityCenter that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DissociateAccessGrantsIdentityCenterRequestT = Model::DissociateAccessGrantsIdentityCenterRequest>
  void DissociateAccessGrantsIdentityCenterAsync(const DissociateAccessGrantsIdentityCenterRequestT& request,
                                                 const DissociateAccessGrantsIdentityCenterResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAccessGrantsInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccessGrantsInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccessGrantsInstanceRequestT = Model::GetAccessGrantsInstanceRequest>
  void GetAccessGrantsInstanceAsync(const GetAccessGrantsInstanceRequestT& request,
                                    const GetAccessGrantsInstanceResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetAccessGrantsInstanceForPrefixOutcome GetAccessGrantsInstanceForPrefix(
      const Model::GetAccessGrantsInstanceForPrefixRequest& request) const;

  /**
   * A Callable wrapper for GetAccessGrantsInstanceForPrefix that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetAccessGrantsInstanceForPrefixRequestT = Model::GetAccessGrantsInstanceForPrefixRequest>
  Model::GetAccessGrantsInstanceForPrefixOutcomeCallable GetAccessGrantsInstanceForPrefixCallable(
      const GetAccessGrantsInstanceForPrefixRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetAccessGrantsInstanceForPrefix, request);
  }

  /**
   * An Async wrapper for GetAccessGrantsInstanceForPrefix that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetAccessGrantsInstanceForPrefixRequestT = Model::GetAccessGrantsInstanceForPrefixRequest>
  void GetAccessGrantsInstanceForPrefixAsync(const GetAccessGrantsInstanceForPrefixRequestT& request,
                                             const GetAccessGrantsInstanceForPrefixResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAccessGrantsInstanceResourcePolicyOutcome GetAccessGrantsInstanceResourcePolicy(
      const Model::GetAccessGrantsInstanceResourcePolicyRequest& request) const;

  /**
   * A Callable wrapper for GetAccessGrantsInstanceResourcePolicy that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetAccessGrantsInstanceResourcePolicyRequestT = Model::GetAccessGrantsInstanceResourcePolicyRequest>
  Model::GetAccessGrantsInstanceResourcePolicyOutcomeCallable GetAccessGrantsInstanceResourcePolicyCallable(
      const GetAccessGrantsInstanceResourcePolicyRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetAccessGrantsInstanceResourcePolicy, request);
  }

  /**
   * An Async wrapper for GetAccessGrantsInstanceResourcePolicy that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAccessGrantsInstanceResourcePolicyRequestT = Model::GetAccessGrantsInstanceResourcePolicyRequest>
  void GetAccessGrantsInstanceResourcePolicyAsync(const GetAccessGrantsInstanceResourcePolicyRequestT& request,
                                                  const GetAccessGrantsInstanceResourcePolicyResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAccessGrantsLocation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccessGrantsLocation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccessGrantsLocationRequestT = Model::GetAccessGrantsLocationRequest>
  void GetAccessGrantsLocationAsync(const GetAccessGrantsLocationRequestT& request,
                                    const GetAccessGrantsLocationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAccessPointConfigurationForObjectLambdaOutcome GetAccessPointConfigurationForObjectLambda(
      const Model::GetAccessPointConfigurationForObjectLambdaRequest& request) const;

  /**
   * A Callable wrapper for GetAccessPointConfigurationForObjectLambda that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::GetAccessPointConfigurationForObjectLambdaOutcomeCallable GetAccessPointConfigurationForObjectLambdaCallable(
      const GetAccessPointConfigurationForObjectLambdaRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetAccessPointConfigurationForObjectLambda, request);
  }

  /**
   * An Async wrapper for GetAccessPointConfigurationForObjectLambda that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAccessPointConfigurationForObjectLambdaRequestT = Model::GetAccessPointConfigurationForObjectLambdaRequest>
  void GetAccessPointConfigurationForObjectLambdaAsync(
      const GetAccessPointConfigurationForObjectLambdaRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAccessPointForObjectLambdaOutcome GetAccessPointForObjectLambda(
      const Model::GetAccessPointForObjectLambdaRequest& request) const;

  /**
   * A Callable wrapper for GetAccessPointForObjectLambda that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetAccessPointForObjectLambdaRequestT = Model::GetAccessPointForObjectLambdaRequest>
  Model::GetAccessPointForObjectLambdaOutcomeCallable GetAccessPointForObjectLambdaCallable(
      const GetAccessPointForObjectLambdaRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetAccessPointForObjectLambda, request);
  }

  /**
   * An Async wrapper for GetAccessPointForObjectLambda that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccessPointForObjectLambdaRequestT = Model::GetAccessPointForObjectLambdaRequest>
  void GetAccessPointForObjectLambdaAsync(const GetAccessPointForObjectLambdaRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAccessPointPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccessPointPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccessPointPolicyRequestT = Model::GetAccessPointPolicyRequest>
  void GetAccessPointPolicyAsync(const GetAccessPointPolicyRequestT& request, const GetAccessPointPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetAccessPointPolicyForObjectLambdaOutcome GetAccessPointPolicyForObjectLambda(
      const Model::GetAccessPointPolicyForObjectLambdaRequest& request) const;

  /**
   * A Callable wrapper for GetAccessPointPolicyForObjectLambda that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetAccessPointPolicyForObjectLambdaRequestT = Model::GetAccessPointPolicyForObjectLambdaRequest>
  Model::GetAccessPointPolicyForObjectLambdaOutcomeCallable GetAccessPointPolicyForObjectLambdaCallable(
      const GetAccessPointPolicyForObjectLambdaRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetAccessPointPolicyForObjectLambda, request);
  }

  /**
   * An Async wrapper for GetAccessPointPolicyForObjectLambda that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAccessPointPolicyForObjectLambdaRequestT = Model::GetAccessPointPolicyForObjectLambdaRequest>
  void GetAccessPointPolicyForObjectLambdaAsync(const GetAccessPointPolicyForObjectLambdaRequestT& request,
  ...
  virtual Model::GetAccessPointPolicyStatusOutcome GetAccessPointPolicyStatus(
      const Model::GetAccessPointPolicyStatusRequest& request) const;

  /**
   * A Callable wrapper for GetAccessPointPolicyStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetAccessPointPolicyStatusRequestT = Model::GetAccessPointPolicyStatusRequest>
  Model::GetAccessPointPolicyStatusOutcomeCallable GetAccessPointPolicyStatusCallable(
      const GetAccessPointPolicyStatusRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetAccessPointPolicyStatus, request);
  }

  /**
   * An Async wrapper for GetAccessPointPolicyStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccessPointPolicyStatusRequestT = Model::GetAccessPointPolicyStatusRequest>
  void GetAccessPointPolicyStatusAsync(const GetAccessPointPolicyStatusRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAccessPointPolicyStatusForObjectLambdaOutcome GetAccessPointPolicyStatusForObjectLambda(
      const Model::GetAccessPointPolicyStatusForObjectLambdaRequest& request) const;

  /**
   * A Callable wrapper for GetAccessPointPolicyStatusForObjectLambda that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::GetAccessPointPolicyStatusForObjectLambdaOutcomeCallable GetAccessPointPolicyStatusForObjectLambdaCallable(
      const GetAccessPointPolicyStatusForObjectLambdaRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetAccessPointPolicyStatusForObjectLambda, request);
  }

  /**
   * An Async wrapper for GetAccessPointPolicyStatusForObjectLambda that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAccessPointPolicyStatusForObjectLambdaRequestT = Model::GetAccessPointPolicyStatusForObjectLambdaRequest>
  void GetAccessPointPolicyStatusForObjectLambdaAsync(
      const GetAccessPointPolicyStatusForObjectLambdaRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAccessPointScope that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccessPointScope that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAccessPointScopeRequestT = Model::GetAccessPointScopeRequest>
  void GetAccessPointScopeAsync(const GetAccessPointScopeRequestT& request, const GetAccessPointScopeResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBucket that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBucketRequestT = Model::GetBucketRequest>
  void GetBucketAsync(const GetBucketRequestT& request, const GetBucketResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDataAccess that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDataAccessRequestT = Model::GetDataAccessRequest>
  void GetDataAccessAsync(const GetDataAccessRequestT& request, const GetDataAccessResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetJobTagging that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetJobTaggingRequestT = Model::GetJobTaggingRequest>
  void GetJobTaggingAsync(const GetJobTaggingRequestT& request, const GetJobTaggingResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMultiRegionAccessPoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetMultiRegionAccessPointRequestT = Model::GetMultiRegionAccessPointRequest>
  Model::GetMultiRegionAccessPointOutcomeCallable GetMultiRegionAccessPointCallable(
      const GetMultiRegionAccessPointRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetMultiRegionAccessPoint, request);
  }

  /**
   * An Async wrapper for GetMultiRegionAccessPoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMultiRegionAccessPointRequestT = Model::GetMultiRegionAccessPointRequest>
  void GetMultiRegionAccessPointAsync(const GetMultiRegionAccessPointRequestT& request,
                                      const GetMultiRegionAccessPointResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMultiRegionAccessPointPolicyOutcome GetMultiRegionAccessPointPolicy(
      const Model::GetMultiRegionAccessPointPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetMultiRegionAccessPointPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetMultiRegionAccessPointPolicyRequestT = Model::GetMultiRegionAccessPointPolicyRequest>
  Model::GetMultiRegionAccessPointPolicyOutcomeCallable GetMultiRegionAccessPointPolicyCallable(
      const GetMultiRegionAccessPointPolicyRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetMultiRegionAccessPointPolicy, request);
  }

  /**
   * An Async wrapper for GetMultiRegionAccessPointPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetMultiRegionAccessPointPolicyRequestT = Model::GetMultiRegionAccessPointPolicyRequest>
  void GetMultiRegionAccessPointPolicyAsync(const GetMultiRegionAccessPointPolicyRequestT& request,
                                            const GetMultiRegionAccessPointPolicyResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMultiRegionAccessPointPolicyStatusOutcome GetMultiRegionAccessPointPolicyStatus(
      const Model::GetMultiRegionAccessPointPolicyStatusRequest& request) const;

  /**
   * A Callable wrapper for GetMultiRegionAccessPointPolicyStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetMultiRegionAccessPointPolicyStatusRequestT = Model::GetMultiRegionAccessPointPolicyStatusRequest>
  Model::GetMultiRegionAccessPointPolicyStatusOutcomeCallable GetMultiRegionAccessPointPolicyStatusCallable(
      const GetMultiRegionAccessPointPolicyStatusRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetMultiRegionAccessPointPolicyStatus, request);
  }

  /**
   * An Async wrapper for GetMultiRegionAccessPointPolicyStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetMultiRegionAccessPointPolicyStatusRequestT = Model::GetMultiRegionAccessPointPolicyStatusRequest>
  void GetMultiRegionAccessPointPolicyStatusAsync(const GetMultiRegionAccessPointPolicyStatusRequestT& request,
                                                  const GetMultiRegionAccessPointPolicyStatusResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMultiRegionAccessPointRoutesOutcome GetMultiRegionAccessPointRoutes(
      const Model::GetMultiRegionAccessPointRoutesRequest& request) const;

  /**
   * A Callable wrapper for GetMultiRegionAccessPointRoutes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetMultiRegionAccessPointRoutesRequestT = Model::GetMultiRegionAccessPointRoutesRequest>
  Model::GetMultiRegionAccessPointRoutesOutcomeCallable GetMultiRegionAccessPointRoutesCallable(
      const GetMultiRegionAccessPointRoutesRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetMultiRegionAccessPointRoutes, request);
  }

  /**
   * An Async wrapper for GetMultiRegionAccessPointRoutes that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetMultiRegionAccessPointRoutesRequestT = Model::GetMultiRegionAccessPointRoutesRequest>
  void GetMultiRegionAccessPointRoutesAsync(const GetMultiRegionAccessPointRoutesRequestT& request,
                                            const GetMultiRegionAccessPointRoutesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * configuration, which may inherit from organization-level policies. For more
   * information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html">
   * Using Amazon S3 block public access</a>.</p> <p>Related actions include:</p>
   * <ul> <li> <p> <a
   ...
   * API Reference</a></p>
   */
  virtual Model::GetStorageLensConfigurationOutcome GetStorageLensConfiguration(
      const Model::GetStorageLensConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetStorageLensConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetStorageLensConfigurationRequestT = Model::GetStorageLensConfigurationRequest>
  Model::GetStorageLensConfigurationOutcomeCallable GetStorageLensConfigurationCallable(
      const GetStorageLensConfigurationRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetStorageLensConfiguration, request);
  }

  /**
   * An Async wrapper for GetStorageLensConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetStorageLensConfigurationRequestT = Model::GetStorageLensConfigurationRequest>
  void GetStorageLensConfigurationAsync(const GetStorageLensConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetStorageLensConfigurationTaggingOutcome GetStorageLensConfigurationTagging(
      const Model::GetStorageLensConfigurationTaggingRequest& request) const;

  /**
   * A Callable wrapper for GetStorageLensConfigurationTagging that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetStorageLensConfigurationTaggingRequestT = Model::GetStorageLensConfigurationTaggingRequest>
  Model::GetStorageLensConfigurationTaggingOutcomeCallable GetStorageLensConfigurationTaggingCallable(
      const GetStorageLensConfigurationTaggingRequestT& request) const {
    return SubmitCallable(&S3ControlClient::GetStorageLensConfigurationTagging, request);
  }

  /**
   * An Async wrapper for GetStorageLensConfigurationTagging that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetStorageLensConfigurationTaggingRequestT = Model::GetStorageLensConfigurationTaggingRequest>
  void GetStorageLensConfigurationTaggingAsync(const GetStorageLensConfigurationTaggingRequestT& request,
  ...
  /**
   * A Callable wrapper for GetStorageLensGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetStorageLensGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetStorageLensGroupRequestT = Model::GetStorageLensGroupRequest>
  void GetStorageLensGroupAsync(const GetStorageLensGroupRequestT& request, const GetStorageLensGroupResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListAccessGrantsRequestT = Model::ListAccessGrantsRequest>
  void ListAccessGrantsAsync(const ListAccessGrantsRequestT& request, const ListAccessGrantsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccessGrantsInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListAccessGrantsInstancesRequestT = Model::ListAccessGrantsInstancesRequest>
  Model::ListAccessGrantsInstancesOutcomeCallable ListAccessGrantsInstancesCallable(
      const ListAccessGrantsInstancesRequestT& request) const {
    return SubmitCallable(&S3ControlClient::ListAccessGrantsInstances, request);
  }

  /**
   * An Async wrapper for ListAccessGrantsInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAccessGrantsInstancesRequestT = Model::ListAccessGrantsInstancesRequest>
  void ListAccessGrantsInstancesAsync(const ListAccessGrantsInstancesRequestT& request,
                                      const ListAccessGrantsInstancesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccessGrantsLocations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListAccessGrantsLocationsRequestT = Model::ListAccessGrantsLocationsRequest>
  Model::ListAccessGrantsLocationsOutcomeCallable ListAccessGrantsLocationsCallable(
      const ListAccessGrantsLocationsRequestT& request) const {
    return SubmitCallable(&S3ControlClient::ListAccessGrantsLocations, request);
  }

  /**
   * An Async wrapper for ListAccessGrantsLocations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAccessGrantsLocationsRequestT = Model::ListAccessGrantsLocationsRequest>
  void ListAccessGrantsLocationsAsync(const ListAccessGrantsLocationsRequestT& request,
                                      const ListAccessGrantsLocationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAccessPointsForDirectoryBucketsOutcome ListAccessPointsForDirectoryBuckets(
      const Model::ListAccessPointsForDirectoryBucketsRequest& request) const;

  /**
   * A Callable wrapper for ListAccessPointsForDirectoryBuckets that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListAccessPointsForDirectoryBucketsRequestT = Model::ListAccessPointsForDirectoryBucketsRequest>
  Model::ListAccessPointsForDirectoryBucketsOutcomeCallable ListAccessPointsForDirectoryBucketsCallable(
      const ListAccessPointsForDirectoryBucketsRequestT& request) const {
    return SubmitCallable(&S3ControlClient::ListAccessPointsForDirectoryBuckets, request);
  }

  /**
   * An Async wrapper for ListAccessPointsForDirectoryBuckets that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListAccessPointsForDirectoryBucketsRequestT = Model::ListAccessPointsForDirectoryBucketsRequest>
  void ListAccessPointsForDirectoryBucketsAsync(const ListAccessPointsForDirectoryBucketsRequestT& request,
                                                const ListAccessPointsForDirectoryBucketsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAccessPointsForObjectLambdaOutcome ListAccessPointsForObjectLambda(
      const Model::ListAccessPointsForObjectLambdaRequest& request) const;

  /**
   * A Callable wrapper for ListAccessPointsForObjectLambda that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAccessPointsForObjectLambdaRequestT = Model::ListAccessPointsForObjectLambdaRequest>
  Model::ListAccessPointsForObjectLambdaOutcomeCallable ListAccessPointsForObjectLambdaCallable(
      const ListAccessPointsForObjectLambdaRequestT& request) const {
    return SubmitCallable(&S3ControlClient::ListAccessPointsForObjectLambda, request);
  }

  /**
   * An Async wrapper for ListAccessPointsForObjectLambda that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAccessPointsForObjectLambdaRequestT = Model::ListAccessPointsForObjectLambdaRequest>
  void ListAccessPointsForObjectLambdaAsync(const ListAccessPointsForObjectLambdaRequestT& request,
  ...
  /**
   * A Callable wrapper for ListCallerAccessGrants that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCallerAccessGrants that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCallerAccessGrantsRequestT = Model::ListCallerAccessGrantsRequest>
  void ListCallerAccessGrantsAsync(const ListCallerAccessGrantsRequestT& request,
                                   const ListCallerAccessGrantsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMultiRegionAccessPointsOutcome ListMultiRegionAccessPoints(
      const Model::ListMultiRegionAccessPointsRequest& request) const;

  /**
   * A Callable wrapper for ListMultiRegionAccessPoints that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMultiRegionAccessPointsRequestT = Model::ListMultiRegionAccessPointsRequest>
  Model::ListMultiRegionAccessPointsOutcomeCallable ListMultiRegionAccessPointsCallable(
      const ListMultiRegionAccessPointsRequestT& request) const {
    return SubmitCallable(&S3ControlClient::ListMultiRegionAccessPoints, request);
  }

  /**
   * An Async wrapper for ListMultiRegionAccessPoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMultiRegionAccessPointsRequestT = Model::ListMultiRegionAccessPointsRequest>
  void ListMultiRegionAccessPointsAsync(const ListMultiRegionAccessPointsRequestT& request,
                                        const ListMultiRegionAccessPointsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRegionalBuckets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRegionalBuckets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRegionalBucketsRequestT = Model::ListRegionalBucketsRequest>
  void ListRegionalBucketsAsync(const ListRegionalBucketsRequestT& request, const ListRegionalBucketsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListStorageLensConfigurationsOutcome ListStorageLensConfigurations(
      const Model::ListStorageLensConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListStorageLensConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListStorageLensConfigurationsRequestT = Model::ListStorageLensConfigurationsRequest>
  Model::ListStorageLensConfigurationsOutcomeCallable ListStorageLensConfigurationsCallable(
      const ListStorageLensConfigurationsRequestT& request) const {
    return SubmitCallable(&S3ControlClient::ListStorageLensConfigurations, request);
  }

  /**
   * An Async wrapper for ListStorageLensConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStorageLensConfigurationsRequestT = Model::ListStorageLensConfigurationsRequest>
  void ListStorageLensConfigurationsAsync(const ListStorageLensConfigurationsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListStorageLensGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStorageLensGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStorageLensGroupsRequestT = Model::ListStorageLensGroupsRequest>
  void ListStorageLensGroupsAsync(const ListStorageLensGroupsRequestT& request, const ListStorageLensGroupsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   *  <dl> <dt>Permissions</dt> <dd> <p>For general purpose buckets, access
   * points for general purpose buckets, Storage Lens groups, and S3 Access Grants,
   * you must have the <code>s3:ListTagsForResource</code> permission to use this
   * operation. </p> </dd> <dt>Directory bucket permissions</dt> <dd> <p>For
   ...
   * API Reference</a></p>
   */
  virtual Model::PutAccessGrantsInstanceResourcePolicyOutcome PutAccessGrantsInstanceResourcePolicy(
      const Model::PutAccessGrantsInstanceResourcePolicyRequest& request) const;

  /**
   * A Callable wrapper for PutAccessGrantsInstanceResourcePolicy that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutAccessGrantsInstanceResourcePolicyRequestT = Model::PutAccessGrantsInstanceResourcePolicyRequest>
  Model::PutAccessGrantsInstanceResourcePolicyOutcomeCallable PutAccessGrantsInstanceResourcePolicyCallable(
      const PutAccessGrantsInstanceResourcePolicyRequestT& request) const {
    return SubmitCallable(&S3ControlClient::PutAccessGrantsInstanceResourcePolicy, request);
  }

  /**
   * An Async wrapper for PutAccessGrantsInstanceResourcePolicy that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutAccessGrantsInstanceResourcePolicyRequestT = Model::PutAccessGrantsInstanceResourcePolicyRequest>
  void PutAccessGrantsInstanceResourcePolicyAsync(const PutAccessGrantsInstanceResourcePolicyRequestT& request,
                                                  const PutAccessGrantsInstanceResourcePolicyResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutAccessPointConfigurationForObjectLambdaOutcome PutAccessPointConfigurationForObjectLambda(
      const Model::PutAccessPointConfigurationForObjectLambdaRequest& request) const;

  /**
   * A Callable wrapper for PutAccessPointConfigurationForObjectLambda that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::PutAccessPointConfigurationForObjectLambdaOutcomeCallable PutAccessPointConfigurationForObjectLambdaCallable(
      const PutAccessPointConfigurationForObjectLambdaRequestT& request) const {
    return SubmitCallable(&S3ControlClient::PutAccessPointConfigurationForObjectLambda, request);
  }

  /**
   * An Async wrapper for PutAccessPointConfigurationForObjectLambda that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutAccessPointConfigurationForObjectLambdaRequestT = Model::PutAccessPointConfigurationForObjectLambdaRequest>
  void PutAccessPointConfigurationForObjectLambdaAsync(
      const PutAccessPointConfigurationForObjectLambdaRequestT& request,
  ...
  /**
   * A Callable wrapper for PutAccessPointPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutAccessPointPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutAccessPointPolicyRequestT = Model::PutAccessPointPolicyRequest>
  void PutAccessPointPolicyAsync(const PutAccessPointPolicyRequestT& request, const PutAccessPointPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutAccessPointPolicyForObjectLambdaOutcome PutAccessPointPolicyForObjectLambda(
      const Model::PutAccessPointPolicyForObjectLambdaRequest& request) const;

  /**
   * A Callable wrapper for PutAccessPointPolicyForObjectLambda that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutAccessPointPolicyForObjectLambdaRequestT = Model::PutAccessPointPolicyForObjectLambdaRequest>
  Model::PutAccessPointPolicyForObjectLambdaOutcomeCallable PutAccessPointPolicyForObjectLambdaCallable(
      const PutAccessPointPolicyForObjectLambdaRequestT& request) const {
    return SubmitCallable(&S3ControlClient::PutAccessPointPolicyForObjectLambda, request);
  }

  /**
   * An Async wrapper for PutAccessPointPolicyForObjectLambda that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutAccessPointPolicyForObjectLambdaRequestT = Model::PutAccessPointPolicyForObjectLambdaRequest>
  void PutAccessPointPolicyForObjectLambdaAsync(const PutAccessPointPolicyForObjectLambdaRequestT& request,
  ...
  /**
   * A Callable wrapper for PutAccessPointScope that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutAccessPointScope that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutAccessPointScopeRequestT = Model::PutAccessPointScopeRequest>
  void PutAccessPointScopeAsync(const PutAccessPointScopeRequestT& request, const PutAccessPointScopeResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutJobTagging that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutJobTaggingRequestT = Model::PutJobTaggingRequest>
  void PutJobTaggingAsync(const PutJobTaggingRequestT& request, const PutJobTaggingResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutMultiRegionAccessPointPolicyOutcome PutMultiRegionAccessPointPolicy(
      const Model::PutMultiRegionAccessPointPolicyRequest& request) const;

  /**
   * A Callable wrapper for PutMultiRegionAccessPointPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutMultiRegionAccessPointPolicyRequestT = Model::PutMultiRegionAccessPointPolicyRequest>
  Model::PutMultiRegionAccessPointPolicyOutcomeCallable PutMultiRegionAccessPointPolicyCallable(
      const PutMultiRegionAccessPointPolicyRequestT& request) const {
    return SubmitCallable(&S3ControlClient::PutMultiRegionAccessPointPolicy, request);
  }

  /**
   * An Async wrapper for PutMultiRegionAccessPointPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutMultiRegionAccessPointPolicyRequestT = Model::PutMultiRegionAccessPointPolicyRequest>
  void PutMultiRegionAccessPointPolicyAsync(const PutMultiRegionAccessPointPolicyRequestT& request,
                                            const PutMultiRegionAccessPointPolicyResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * is managed by organization-level Block Public Access policies. You might get an
   * Access Denied (403) error when the account is managed by organization-level
   * Block Public Access policies. Organization-level policies override account-level
   * settings, preventing direct account-level modifications. For this operation,
   * users must have the <code>s3:PutAccountPublicAccessBlock</code> permission. For
   * more information, see <a
   * href="https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html">
   * Using Amazon S3 block public access</a>.</p> <p>Related actions include:</p>
   * <ul> <li> <p> <a
   ...
   * API Reference</a></p>
   */
  virtual Model::PutStorageLensConfigurationOutcome PutStorageLensConfiguration(
      const Model::PutStorageLensConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutStorageLensConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutStorageLensConfigurationRequestT = Model::PutStorageLensConfigurationRequest>
  Model::PutStorageLensConfigurationOutcomeCallable PutStorageLensConfigurationCallable(
      const PutStorageLensConfigurationRequestT& request) const {
    return SubmitCallable(&S3ControlClient::PutStorageLensConfiguration, request);
  }

  /**
   * An Async wrapper for PutStorageLensConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutStorageLensConfigurationRequestT = Model::PutStorageLensConfigurationRequest>
  void PutStorageLensConfigurationAsync(const PutStorageLensConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutStorageLensConfigurationTaggingOutcome PutStorageLensConfigurationTagging(
      const Model::PutStorageLensConfigurationTaggingRequest& request) const;

  /**
   * A Callable wrapper for PutStorageLensConfigurationTagging that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PutStorageLensConfigurationTaggingRequestT = Model::PutStorageLensConfigurationTaggingRequest>
  Model::PutStorageLensConfigurationTaggingOutcomeCallable PutStorageLensConfigurationTaggingCallable(
      const PutStorageLensConfigurationTaggingRequestT& request) const {
    return SubmitCallable(&S3ControlClient::PutStorageLensConfigurationTagging, request);
  }

  /**
   * An Async wrapper for PutStorageLensConfigurationTagging that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutStorageLensConfigurationTaggingRequestT = Model::PutStorageLensConfigurationTaggingRequest>
  void PutStorageLensConfigurationTaggingAsync(const PutStorageLensConfigurationTaggingRequestT& request,
  ...
  virtual Model::SubmitMultiRegionAccessPointRoutesOutcome SubmitMultiRegionAccessPointRoutes(
      const Model::SubmitMultiRegionAccessPointRoutesRequest& request) const;

  /**
   * A Callable wrapper for SubmitMultiRegionAccessPointRoutes that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename SubmitMultiRegionAccessPointRoutesRequestT = Model::SubmitMultiRegionAccessPointRoutesRequest>
  Model::SubmitMultiRegionAccessPointRoutesOutcomeCallable SubmitMultiRegionAccessPointRoutesCallable(
      const SubmitMultiRegionAccessPointRoutesRequestT& request) const {
    return SubmitCallable(&S3ControlClient::SubmitMultiRegionAccessPointRoutes, request);
  }

  /**
   * An Async wrapper for SubmitMultiRegionAccessPointRoutes that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SubmitMultiRegionAccessPointRoutesRequestT = Model::SubmitMultiRegionAccessPointRoutesRequest>
  void SubmitMultiRegionAccessPointRoutesAsync(const SubmitMultiRegionAccessPointRoutesRequestT& request,
                                               const SubmitMultiRegionAccessPointRoutesResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * </p> </dd> <dt>Directory bucket permissions</dt> <dd> <p>For directory buckets,
   * you must have the <code>s3express:TagResource</code> permission to use this
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAccessGrantsLocationOutcome UpdateAccessGrantsLocation(
      const Model::UpdateAccessGrantsLocationRequest& request) const;

  /**
   * A Callable wrapper for UpdateAccessGrantsLocation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAccessGrantsLocationRequestT = Model::UpdateAccessGrantsLocationRequest>
  Model::UpdateAccessGrantsLocationOutcomeCallable UpdateAccessGrantsLocationCallable(
      const UpdateAccessGrantsLocationRequestT& request) const {
    return SubmitCallable(&S3ControlClient::UpdateAccessGrantsLocation, request);
  }

  /**
   * An Async wrapper for UpdateAccessGrantsLocation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAccessGrantsLocationRequestT = Model::UpdateAccessGrantsLocationRequest>
  void UpdateAccessGrantsLocationAsync(const UpdateAccessGrantsLocationRequestT& request,
                                       const UpdateAccessGrantsLocationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateJobPriority that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateJobPriority that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateJobPriorityRequestT = Model::UpdateJobPriorityRequest>
  void UpdateJobPriorityAsync(const UpdateJobPriorityRequestT& request, const UpdateJobPriorityResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateJobStatus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateJobStatusRequestT = Model::UpdateJobStatusRequest>
  void UpdateJobStatusAsync(const UpdateJobStatusRequestT& request, const UpdateJobStatusResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateStorageLensGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateStorageLensGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateStorageLensGroupRequestT = Model::UpdateStorageLensGroupRequest>
  void UpdateStorageLensGroupAsync(const UpdateStorageLensGroupRequestT& request,
                                   const UpdateStorageLensGroupResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
