...
{
const size_t AutoScalingPlansEndpointRules::RulesBlobStrLen = 3516;
const size_t AutoScalingPlansEndpointRules::RulesBlobSize = 3517;
...
's','c','a','l','i','n','g','-','p','l','a','n','s','-','f','i','p','s','.','{','R','e','g','i','o',
