...
namespace AutoScalingPlans
{
   ...
   */
  class AWS_AUTOSCALINGPLANS_API AutoScalingPlansClient : Aws::Client::ClientWithAsyncTemplateMethods<AutoScalingPlansClient>,
    smithy::client::AwsSmithyClientT<Aws::AutoScalingPlans::SERVICE_NAME,
