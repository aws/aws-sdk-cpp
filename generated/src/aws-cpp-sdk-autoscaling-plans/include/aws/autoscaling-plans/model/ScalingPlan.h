...
class ScalingPlan {
 public:
  ...
  inline ScalingPlan& WithScalingPlanVersion(long long value) {
  ...
  void SetApplicationSource(ApplicationSourceT&& value) {
    ...
    m_applicationSource = std::forward<ApplicationSourceT>(value);
  }
  template <typename ApplicationSourceT = ApplicationSource>
  ScalingPlan& WithApplicationSource(ApplicationSourceT&& value) {
    SetApplicationSource(std::forward<ApplicationSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScalingInstructions(ScalingInstructionsT&& value) {
    ...
    m_scalingInstructions = std::forward<ScalingInstructionsT>(value);
  }
  template <typename ScalingInstructionsT = Aws::Vector<ScalingInstruction>>
  ScalingPlan& WithScalingInstructions(ScalingInstructionsT&& value) {
    SetScalingInstructions(std::forward<ScalingInstructionsT>(value));
    return *this;
  }
  template <typename ScalingInstructionsT = ScalingInstruction>
  ScalingPlan& AddScalingInstructions(ScalingInstructionsT&& value) {
    m_scalingInstructionsHasBeenSet = true;
    m_scalingInstructions.emplace_back(std::forward<ScalingInstructionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatusCode(ScalingPlanStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline ScalingPlan& WithStatusCode(ScalingPlanStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  void SetStatusStartTime(StatusStartTimeT&& value) {
    ...
    m_statusStartTime = std::forward<StatusStartTimeT>(value);
  }
  template <typename StatusStartTimeT = Aws::Utils::DateTime>
  ScalingPlan& WithStatusStartTime(StatusStartTimeT&& value) {
    SetStatusStartTime(std::forward<StatusStartTimeT>(value));
    return *this;
  }
  ///@}
