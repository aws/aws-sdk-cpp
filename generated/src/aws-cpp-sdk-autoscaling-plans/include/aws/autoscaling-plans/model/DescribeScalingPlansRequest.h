...
class DescribeScalingPlansRequest : public AutoScalingPlansRequest {
 public:
  ...
  void SetScalingPlanNames(ScalingPlanNamesT&& value) {
    m_scalingPlanNamesHasBeenSet = true;
    m_scalingPlanNames = std::forward<ScalingPlanNamesT>(value);
  }
  template <typename ScalingPlanNamesT = Aws::Vector<Aws::String>>
  DescribeScalingPlansRequest& WithScalingPlanNames(ScalingPlanNamesT&& value) {
    SetScalingPlanNames(std::forward<ScalingPlanNamesT>(value));
    return *this;
  }
  template <typename ScalingPlanNamesT = Aws::String>
  DescribeScalingPlansRequest& AddScalingPlanNames(ScalingPlanNamesT&& value) {
    m_scalingPlanNamesHasBeenSet = true;
    m_scalingPlanNames.emplace_back(std::forward<ScalingPlanNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeScalingPlansRequest& WithScalingPlanVersion(long long value) {
  ...
  void SetApplicationSources(ApplicationSourcesT&& value) {
    m_applicationSourcesHasBeenSet = true;
    m_applicationSources = std::forward<ApplicationSourcesT>(value);
  }
  template <typename ApplicationSourcesT = Aws::Vector<ApplicationSource>>
  DescribeScalingPlansRequest& WithApplicationSources(ApplicationSourcesT&& value) {
    SetApplicationSources(std::forward<ApplicationSourcesT>(value));
    return *this;
  }
  ...
  DescribeScalingPlansRequest& AddApplicationSources(ApplicationSourcesT&& value) {
    m_applicationSourcesHasBeenSet = true;
    m_applicationSources.emplace_back(std::forward<ApplicationSourcesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeScalingPlansRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
