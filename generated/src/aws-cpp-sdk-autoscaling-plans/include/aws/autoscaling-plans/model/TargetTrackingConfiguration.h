...
class TargetTrackingConfiguration {
 public:
   ...
   * customized metric.</p>
   */
  inline const PredefinedScalingMetricSpecification& GetPredefinedScalingMetricSpecification() const {
   ...
   * customized metric. </p>
   */
  inline const CustomizedScalingMetricSpecification& GetCustomizedScalingMetricSpecification() const {
  ...
  inline TargetTrackingConfiguration& WithScaleOutCooldown(int value) {
  ...
  inline TargetTrackingConfiguration& WithScaleInCooldown(int value) {
  ...
  inline TargetTrackingConfiguration& WithEstimatedInstanceWarmup(int value) {
