...
class PredefinedScalingMetricSpecification {
 public:
  ...
  inline void SetPredefinedScalingMetricType(ScalingMetricType value) {
    m_predefinedScalingMetricTypeHasBeenSet = true;
    m_predefinedScalingMetricType = value;
  }
  inline PredefinedScalingMetricSpecification& WithPredefinedScalingMetricType(ScalingMetricType value) {
    SetPredefinedScalingMetricType(value);
    return *this;
  }
  ///@}
