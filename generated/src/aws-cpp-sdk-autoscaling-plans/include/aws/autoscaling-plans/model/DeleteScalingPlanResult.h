...
namespace Model
{
  ...
  {
  public:
    AWS_AUTOSCALINGPLANS_API DeleteScalingPlanResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteScalingPlanResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
