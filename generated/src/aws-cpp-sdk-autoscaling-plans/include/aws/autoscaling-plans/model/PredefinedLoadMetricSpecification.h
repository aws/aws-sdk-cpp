...
class PredefinedLoadMetricSpecification {
 public:
  ...
  inline void SetPredefinedLoadMetricType(LoadMetricType value) {
    m_predefinedLoadMetricTypeHasBeenSet = true;
    m_predefinedLoadMetricType = value;
  }
  inline PredefinedLoadMetricSpecification& WithPredefinedLoadMetricType(LoadMetricType value) {
    SetPredefinedLoadMetricType(value);
    return *this;
  }
  ///@}
