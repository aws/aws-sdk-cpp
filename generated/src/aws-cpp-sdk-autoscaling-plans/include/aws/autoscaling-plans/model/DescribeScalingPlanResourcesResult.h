...
class DescribeScalingPlanResourcesResult {
 public:
  ...
  AWS_AUTOSCALINGPLANS_API DescribeScalingPlanResourcesResult& operator=(
  ...
  void SetScalingPlanResources(ScalingPlanResourcesT&& value) {
    m_scalingPlanResourcesHasBeenSet = true;
    m_scalingPlanResources = std::forward<ScalingPlanResourcesT>(value);
  }
  template <typename ScalingPlanResourcesT = Aws::Vector<ScalingPlanResource>>
  DescribeScalingPlanResourcesResult& WithScalingPlanResources(ScalingPlanResourcesT&& value) {
    SetScalingPlanResources(std::forward<ScalingPlanResourcesT>(value));
    return *this;
  }
  template <typename ScalingPlanResourcesT = ScalingPlanResource>
  DescribeScalingPlanResourcesResult& AddScalingPlanResources(ScalingPlanResourcesT&& value) {
    m_scalingPlanResourcesHasBeenSet = true;
    m_scalingPlanResources.emplace_back(std::forward<ScalingPlanResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeScalingPlanResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeScalingPlanResourcesResult& WithRequestId(RequestIdT&& value) {
