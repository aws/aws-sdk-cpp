...
class Capacity {
 public:
  ...
  inline void SetAvailable(long long value) {
    m_availableHasBeenSet = true;
    m_available = value;
  }
  inline Capacity& WithAvailable(long long value) {
    SetAvailable(value);
    return *this;
  }
  ///@}
  ...
  inline Capacity& WithTotal(long long value) {
    SetTotal(value);
    return *this;
  }
  ///@}
  ...
  inline Capacity& WithUsed(long long value) {
    SetUsed(value);
    return *this;
  }
  ///@}
