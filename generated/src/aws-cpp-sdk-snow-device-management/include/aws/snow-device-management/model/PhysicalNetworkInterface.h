...
class PhysicalNetworkInterface {
 public:
  ...
  inline void SetIpAddressAssignment(IpAddressAssignment value) {
    m_ipAddressAssignmentHasBeenSet = true;
    m_ipAddressAssignment = value;
  }
  inline PhysicalNetworkInterface& WithIpAddressAssignment(IpAddressAssignment value) {
    SetIpAddressAssignment(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPhysicalConnectorType(PhysicalConnectorType value) {
    m_physicalConnectorTypeHasBeenSet = true;
    m_physicalConnectorType = value;
  }
  inline PhysicalNetworkInterface& WithPhysicalConnectorType(PhysicalConnectorType value) {
    SetPhysicalConnectorType(value);
    return *this;
  }
  ///@}
  ...
  void SetPhysicalNetworkInterfaceId(PhysicalNetworkInterfaceIdT&& value) {
    ...
    m_physicalNetworkInterfaceId = std::forward<PhysicalNetworkInterfaceIdT>(value);
  }
  template <typename PhysicalNetworkInterfaceIdT = Aws::String>
  PhysicalNetworkInterface& WithPhysicalNetworkInterfaceId(PhysicalNetworkInterfaceIdT&& value) {
    SetPhysicalNetworkInterfaceId(std::forward<PhysicalNetworkInterfaceIdT>(value));
    return *this;
  }
  ///@}
 private:
