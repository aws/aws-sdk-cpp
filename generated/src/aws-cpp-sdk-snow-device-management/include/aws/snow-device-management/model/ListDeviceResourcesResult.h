...
class ListDeviceResourcesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListDeviceResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<ResourceSummary>>
  ListDeviceResourcesResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = ResourceSummary>
  ListDeviceResourcesResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListDeviceResourcesResult& WithRequestId(RequestIdT&& value) {
