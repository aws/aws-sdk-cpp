...
class ListDeviceResourcesRequest : public SnowDeviceManagementRequest {
 public:
  ...
  template <typename ManagedDeviceIdT = Aws::String>
  ListDeviceResourcesRequest& WithManagedDeviceId(ManagedDeviceIdT&& value) {
  ...
  inline ListDeviceResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDeviceResourcesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TypeT = Aws::String>
  ListDeviceResourcesRequest& WithType(TypeT&& value) {
