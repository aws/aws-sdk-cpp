...
class DescribeDeviceResult {
 public:
  ...
  void SetAssociatedWithJob(AssociatedWithJobT&& value) {
    ...
    m_associatedWithJob = std::forward<AssociatedWithJobT>(value);
  }
  template <typename AssociatedWithJobT = Aws::String>
  DescribeDeviceResult& WithAssociatedWithJob(AssociatedWithJobT&& value) {
    SetAssociatedWithJob(std::forward<AssociatedWithJobT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceCapacities(DeviceCapacitiesT&& value) {
    ...
    m_deviceCapacities = std::forward<DeviceCapacitiesT>(value);
  }
  template <typename DeviceCapacitiesT = Aws::Vector<Capacity>>
  DescribeDeviceResult& WithDeviceCapacities(DeviceCapacitiesT&& value) {
    SetDeviceCapacities(std::forward<DeviceCapacitiesT>(value));
    return *this;
  }
  template <typename DeviceCapacitiesT = Capacity>
  DescribeDeviceResult& AddDeviceCapacities(DeviceCapacitiesT&& value) {
    m_deviceCapacitiesHasBeenSet = true;
    m_deviceCapacities.emplace_back(std::forward<DeviceCapacitiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDeviceState(UnlockState value) {
    m_deviceStateHasBeenSet = true;
    m_deviceState = value;
  }
  inline DescribeDeviceResult& WithDeviceState(UnlockState value) {
  ...
  void SetLastReachedOutAt(LastReachedOutAtT&& value) {
    ...
    m_lastReachedOutAt = std::forward<LastReachedOutAtT>(value);
  }
  template <typename LastReachedOutAtT = Aws::Utils::DateTime>
  DescribeDeviceResult& WithLastReachedOutAt(LastReachedOutAtT&& value) {
    SetLastReachedOutAt(std::forward<LastReachedOutAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetManagedDeviceArn(ManagedDeviceArnT&& value) {
    ...
    m_managedDeviceArn = std::forward<ManagedDeviceArnT>(value);
  }
  template <typename ManagedDeviceArnT = Aws::String>
  DescribeDeviceResult& WithManagedDeviceArn(ManagedDeviceArnT&& value) {
    SetManagedDeviceArn(std::forward<ManagedDeviceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPhysicalNetworkInterfaces(PhysicalNetworkInterfacesT&& value) {
    ...
    m_physicalNetworkInterfaces = std::forward<PhysicalNetworkInterfacesT>(value);
  }
  template <typename PhysicalNetworkInterfacesT = Aws::Vector<PhysicalNetworkInterface>>
  DescribeDeviceResult& WithPhysicalNetworkInterfaces(PhysicalNetworkInterfacesT&& value) {
    SetPhysicalNetworkInterfaces(std::forward<PhysicalNetworkInterfacesT>(value));
    return *this;
  }
  ...
  DescribeDeviceResult& AddPhysicalNetworkInterfaces(PhysicalNetworkInterfacesT&& value) {
    m_physicalNetworkInterfacesHasBeenSet = true;
    m_physicalNetworkInterfaces.emplace_back(std::forward<PhysicalNetworkInterfacesT>(value));
    return *this;
  }
  ///@}
