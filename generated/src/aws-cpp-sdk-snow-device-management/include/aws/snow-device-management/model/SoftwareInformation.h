...
class SoftwareInformation {
 public:
  ...
  void SetInstallState(InstallStateT&& value) {
    m_installStateHasBeenSet = true;
    m_installState = std::forward<InstallStateT>(value);
  }
  template <typename InstallStateT = Aws::String>
  SoftwareInformation& WithInstallState(InstallStateT&& value) {
    SetInstallState(std::forward<InstallStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstalledVersion(InstalledVersionT&& value) {
    m_installedVersionHasBeenSet = true;
    m_installedVersion = std::forward<InstalledVersionT>(value);
  }
  template <typename InstalledVersionT = Aws::String>
  SoftwareInformation& WithInstalledVersion(InstalledVersionT&& value) {
    SetInstalledVersion(std::forward<InstalledVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstallingVersion(InstallingVersionT&& value) {
    m_installingVersionHasBeenSet = true;
    m_installingVersion = std::forward<InstallingVersionT>(value);
  }
  template <typename InstallingVersionT = Aws::String>
  SoftwareInformation& WithInstallingVersion(InstallingVersionT&& value) {
    SetInstallingVersion(std::forward<InstallingVersionT>(value));
    return *this;
  }
  ///@}
 private:
