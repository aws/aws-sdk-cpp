...
GrpcMetadataMatchMethod::GrpcMetadataMatchMethod(JsonView jsonValue) { *this = jsonValue; }

GrpcMetadataMatchMethod& GrpcMetadataMatchMethod::operator=(JsonView jsonValue) {
...
JsonValue GrpcMetadataMatchMethod::Jsonize() const {
  JsonValue payload;
