...
HttpGatewayRouteHeader::HttpGatewayRouteHeader(JsonView jsonValue) { *this = jsonValue; }

HttpGatewayRouteHeader& HttpGatewayRouteHeader::operator=(JsonView jsonValue) {
...
JsonValue HttpGatewayRouteHeader::Jsonize() const {
  JsonValue payload;
