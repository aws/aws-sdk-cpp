...
DescribeVirtualServiceResult::DescribeVirtualServiceResult()
{
}

DescribeVirtualServiceResult::DescribeVirtualServiceResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
