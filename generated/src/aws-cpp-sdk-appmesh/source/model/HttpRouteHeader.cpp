...
HttpRouteHeader::HttpRouteHeader(JsonView jsonValue) { *this = jsonValue; }

HttpRouteHeader& HttpRouteHeader::operator=(JsonView jsonValue) {
...
JsonValue HttpRouteHeader::Jsonize() const {
  JsonValue payload;
