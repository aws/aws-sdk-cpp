...
namespace Model
{
  ...
  {
  public:
    AWS_APPMESH_API CreateVirtualGatewayResult() = default;
    ...
    template<typename VirtualGatewayT = VirtualGatewayData>
    CreateVirtualGatewayResult& WithVirtualGateway(VirtualGatewayT&& value) { SetVirtualGateway(std::forward<VirtualGatewayT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateVirtualGatewayResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
