...
class GrpcRetryPolicy {
 public:
  ...
  void SetGrpcRetryEvents(GrpcRetryEventsT&& value) {
    ...
    m_grpcRetryEvents = std::forward<GrpcRetryEventsT>(value);
  }
  template <typename GrpcRetryEventsT = Aws::Vector<GrpcRetryPolicyEvent>>
  GrpcRetryPolicy& WithGrpcRetryEvents(GrpcRetryEventsT&& value) {
    SetGrpcRetryEvents(std::forward<GrpcRetryEventsT>(value));
    return *this;
  }
  inline GrpcRetryPolicy& AddGrpcRetryEvents(GrpcRetryPolicyEvent value) {
    m_grpcRetryEventsHasBeenSet = true;
    m_grpcRetryEvents.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetHttpRetryEvents(HttpRetryEventsT&& value) {
    ...
    m_httpRetryEvents = std::forward<HttpRetryEventsT>(value);
  }
  template <typename HttpRetryEventsT = Aws::Vector<Aws::String>>
  GrpcRetryPolicy& WithHttpRetryEvents(HttpRetryEventsT&& value) {
    SetHttpRetryEvents(std::forward<HttpRetryEventsT>(value));
    return *this;
  }
  template <typename HttpRetryEventsT = Aws::String>
  GrpcRetryPolicy& AddHttpRetryEvents(HttpRetryEventsT&& value) {
    m_httpRetryEventsHasBeenSet = true;
    m_httpRetryEvents.emplace_back(std::forward<HttpRetryEventsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxRetries(long long value) {
    m_maxRetriesHasBeenSet = true;
    m_maxRetries = value;
  }
  inline GrpcRetryPolicy& WithMaxRetries(long long value) {
    SetMaxRetries(value);
    return *this;
  }
  ///@}
  ...
  void SetPerRetryTimeout(PerRetryTimeoutT&& value) {
    ...
    m_perRetryTimeout = std::forward<PerRetryTimeoutT>(value);
  }
  template <typename PerRetryTimeoutT = Duration>
  GrpcRetryPolicy& WithPerRetryTimeout(PerRetryTimeoutT&& value) {
    SetPerRetryTimeout(std::forward<PerRetryTimeoutT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTcpRetryEvents(TcpRetryEventsT&& value) {
    ...
    m_tcpRetryEvents = std::forward<TcpRetryEventsT>(value);
  }
  template <typename TcpRetryEventsT = Aws::Vector<TcpRetryPolicyEvent>>
  GrpcRetryPolicy& WithTcpRetryEvents(TcpRetryEventsT&& value) {
    SetTcpRetryEvents(std::forward<TcpRetryEventsT>(value));
    return *this;
  }
  inline GrpcRetryPolicy& AddTcpRetryEvents(TcpRetryPolicyEvent value) {
    m_tcpRetryEventsHasBeenSet = true;
    m_tcpRetryEvents.push_back(value);
    return *this;
  }
  ///@}
 private:
