...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/UntagResourceInput">AWS
   * API Reference</a></p>
   */
  class UntagResourceRequest : public AppMeshRequest
  {
  public:
    AWS_APPMESH_API UntagResourceRequest() = default;
