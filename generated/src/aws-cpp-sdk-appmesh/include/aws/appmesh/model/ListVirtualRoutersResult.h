...
class ListVirtualRoutersResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListVirtualRoutersResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetVirtualRouters(VirtualRoutersT&& value) {
    m_virtualRoutersHasBeenSet = true;
    m_virtualRouters = std::forward<VirtualRoutersT>(value);
  }
  template <typename VirtualRoutersT = Aws::Vector<VirtualRouterRef>>
  ListVirtualRoutersResult& WithVirtualRouters(VirtualRoutersT&& value) {
    SetVirtualRouters(std::forward<VirtualRoutersT>(value));
    return *this;
  }
  template <typename VirtualRoutersT = VirtualRouterRef>
  ListVirtualRoutersResult& AddVirtualRouters(VirtualRoutersT&& value) {
    m_virtualRoutersHasBeenSet = true;
    m_virtualRouters.emplace_back(std::forward<VirtualRoutersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListVirtualRoutersResult& WithRequestId(RequestIdT&& value) {
