...
class DnsServiceDiscovery {
 public:
  ...
  inline void SetIpPreference(IpPreference value) {
    m_ipPreferenceHasBeenSet = true;
    m_ipPreference = value;
  }
  inline DnsServiceDiscovery& WithIpPreference(IpPreference value) {
    SetIpPreference(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResponseType(DnsResponseType value) {
    m_responseTypeHasBeenSet = true;
    m_responseType = value;
  }
  inline DnsServiceDiscovery& WithResponseType(DnsResponseType value) {
