...
class DescribeGatewayRouteRequest : public AppMeshRequest {
 public:
  ...
  template <typename GatewayRouteNameT = Aws::String>
  DescribeGatewayRouteRequest& WithGatewayRouteName(GatewayRouteNameT&& value) {
  ...
  template <typename MeshNameT = Aws::String>
  DescribeGatewayRouteRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  DescribeGatewayRouteRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename VirtualGatewayNameT = Aws::String>
  DescribeGatewayRouteRequest& WithVirtualGatewayName(VirtualGatewayNameT&& value) {
