...
namespace Model
{
  ...
  {
  public:
    AWS_APPMESH_API DescribeGatewayRouteRequest() = default;
    ...
    template<typename GatewayRouteNameT = Aws::String>
    DescribeGatewayRouteRequest& WithGatewayRouteName(GatewayRouteNameT&& value) { SetGatewayRouteName(std::forward<GatewayRouteNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MeshNameT = Aws::String>
    DescribeGatewayRouteRequest& WithMeshName(MeshNameT&& value) { SetMeshName(std::forward<MeshNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MeshOwnerT = Aws::String>
    DescribeGatewayRouteRequest& WithMeshOwner(MeshOwnerT&& value) { SetMeshOwner(std::forward<MeshOwnerT>(value)); return *this;}
    ///@}
    ...
    template<typename VirtualGatewayNameT = Aws::String>
    DescribeGatewayRouteRequest& WithVirtualGatewayName(VirtualGatewayNameT&& value) { SetVirtualGatewayName(std::forward<VirtualGatewayNameT>(value)); return *this;}
    ///@}
  private:
