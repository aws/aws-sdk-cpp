...
namespace Model
{
  ...
  {
  public:
    AWS_APPMESH_API CreateVirtualServiceResult() = default;
    ...
    template<typename VirtualServiceT = VirtualServiceData>
    CreateVirtualServiceResult& WithVirtualService(VirtualServiceT&& value) { SetVirtualService(std::forward<VirtualServiceT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateVirtualServiceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
