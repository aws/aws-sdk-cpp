...
namespace Model
{
  ...
  public:
    ...
    template<typename RewriteT = GrpcGatewayRouteRewrite>
    void SetRewrite(RewriteT&& value) { m_rewriteHasBeenSet = true; m_rewrite = std::forward<RewriteT>(value); }
    template<typename RewriteT = GrpcGatewayRouteRewrite>
    GrpcGatewayRouteAction& WithRewrite(RewriteT&& value) { SetRewrite(std::forward<RewriteT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetT = GatewayRouteTarget>
    GrpcGatewayRouteAction& WithTarget(TargetT&& value) { SetTarget(std::forward<TargetT>(value)); return *this;}
    ///@}
  private:
