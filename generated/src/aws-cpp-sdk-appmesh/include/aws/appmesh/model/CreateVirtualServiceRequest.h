...
class CreateVirtualServiceRequest : public AppMeshRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateVirtualServiceRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename MeshNameT = Aws::String>
  CreateVirtualServiceRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  CreateVirtualServiceRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename SpecT = VirtualServiceSpec>
  CreateVirtualServiceRequest& WithSpec(SpecT&& value) {
  ...
  template <typename TagsT = Aws::Vector<TagRef>>
  CreateVirtualServiceRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = TagRef>
  CreateVirtualServiceRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename VirtualServiceNameT = Aws::String>
  CreateVirtualServiceRequest& WithVirtualServiceName(VirtualServiceNameT&& value) {
