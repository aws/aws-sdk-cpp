...
class DeleteGatewayRouteRequest : public AppMeshRequest {
 public:
  ...
  template <typename GatewayRouteNameT = Aws::String>
  DeleteGatewayRouteRequest& WithGatewayRouteName(GatewayRouteNameT&& value) {
  ...
  template <typename MeshNameT = Aws::String>
  DeleteGatewayRouteRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  DeleteGatewayRouteRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename VirtualGatewayNameT = Aws::String>
  DeleteGatewayRouteRequest& WithVirtualGatewayName(VirtualGatewayNameT&& value) {
