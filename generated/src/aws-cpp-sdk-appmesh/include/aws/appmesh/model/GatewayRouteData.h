...
class GatewayRouteData {
 public:
  ...
  void SetGatewayRouteName(GatewayRouteNameT&& value) {
    m_gatewayRouteNameHasBeenSet = true;
    m_gatewayRouteName = std::forward<GatewayRouteNameT>(value);
  }
  template <typename GatewayRouteNameT = Aws::String>
  GatewayRouteData& WithGatewayRouteName(GatewayRouteNameT&& value) {
    SetGatewayRouteName(std::forward<GatewayRouteNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MeshNameT = Aws::String>
  GatewayRouteData& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MetadataT = ResourceMetadata>
  GatewayRouteData& WithMetadata(MetadataT&& value) {
  ...
  template <typename SpecT = GatewayRouteSpec>
  GatewayRouteData& WithSpec(SpecT&& value) {
  ...
  template <typename StatusT = GatewayRouteStatus>
  GatewayRouteData& WithStatus(StatusT&& value) {
  ...
  template <typename VirtualGatewayNameT = Aws::String>
  GatewayRouteData& WithVirtualGatewayName(VirtualGatewayNameT&& value) {
