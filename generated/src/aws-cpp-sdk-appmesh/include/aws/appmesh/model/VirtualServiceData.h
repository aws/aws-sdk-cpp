...
class VirtualServiceData {
 public:
  ...
  template <typename MeshNameT = Aws::String>
  VirtualServiceData& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MetadataT = ResourceMetadata>
  VirtualServiceData& WithMetadata(MetadataT&& value) {
  ...
  template <typename SpecT = VirtualServiceSpec>
  VirtualServiceData& WithSpec(SpecT&& value) {
  ...
  template <typename StatusT = VirtualServiceStatus>
  VirtualServiceData& WithStatus(StatusT&& value) {
  ...
  void SetVirtualServiceName(VirtualServiceNameT&& value) {
    ...
    m_virtualServiceName = std::forward<VirtualServiceNameT>(value);
  }
  template <typename VirtualServiceNameT = Aws::String>
  VirtualServiceData& WithVirtualServiceName(VirtualServiceNameT&& value) {
    SetVirtualServiceName(std::forward<VirtualServiceNameT>(value));
    return *this;
  }
  ///@}
 private:
