...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientTokenT = Aws::String>
    UpdateRouteRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename MeshNameT = Aws::String>
    UpdateRouteRequest& WithMeshName(MeshNameT&& value) { SetMeshName(std::forward<MeshNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MeshOwnerT = Aws::String>
    UpdateRouteRequest& WithMeshOwner(MeshOwnerT&& value) { SetMeshOwner(std::forward<MeshOwnerT>(value)); return *this;}
    ///@}
    ...
    template<typename RouteNameT = Aws::String>
    UpdateRouteRequest& WithRouteName(RouteNameT&& value) { SetRouteName(std::forward<RouteNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SpecT = RouteSpec>
    UpdateRouteRequest& WithSpec(SpecT&& value) { SetSpec(std::forward<SpecT>(value)); return *this;}
    ///@}
    ...
    template<typename VirtualRouterNameT = Aws::String>
    UpdateRouteRequest& WithVirtualRouterName(VirtualRouterNameT&& value) { SetVirtualRouterName(std::forward<VirtualRouterNameT>(value)); return *this;}
    ///@}
  private:
