...
class VirtualGatewayRef {
 public:
  ...
  template <typename ArnT = Aws::String>
  VirtualGatewayRef& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  VirtualGatewayRef& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  VirtualGatewayRef& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename MeshNameT = Aws::String>
  VirtualGatewayRef& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  VirtualGatewayRef& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename ResourceOwnerT = Aws::String>
  VirtualGatewayRef& WithResourceOwner(ResourceOwnerT&& value) {
  ...
  inline VirtualGatewayRef& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  template <typename VirtualGatewayNameT = Aws::String>
  VirtualGatewayRef& WithVirtualGatewayName(VirtualGatewayNameT&& value) {
