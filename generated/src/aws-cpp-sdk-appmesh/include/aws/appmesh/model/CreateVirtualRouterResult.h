...
namespace Model
{
  ...
  {
  public:
    AWS_APPMESH_API CreateVirtualRouterResult() = default;
    ...
    template<typename VirtualRouterT = VirtualRouterData>
    CreateVirtualRouterResult& WithVirtualRouter(VirtualRouterT&& value) { SetVirtualRouter(std::forward<VirtualRouterT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateVirtualRouterResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
