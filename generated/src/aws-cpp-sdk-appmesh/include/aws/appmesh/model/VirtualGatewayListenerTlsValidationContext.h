...
class VirtualGatewayListenerTlsValidationContext {
 public:
  ...
  template <typename SubjectAlternativeNamesT = SubjectAlternativeNames>
  VirtualGatewayListenerTlsValidationContext& WithSubjectAlternativeNames(SubjectAlternativeNamesT&& value) {
  ...
  void SetTrust(TrustT&& value) {
    ...
    m_trust = std::forward<TrustT>(value);
  }
  template <typename TrustT = VirtualGatewayListenerTlsValidationContextTrust>
  VirtualGatewayListenerTlsValidationContext& WithTrust(TrustT&& value) {
    SetTrust(std::forward<TrustT>(value));
    return *this;
  }
  ///@}
 private:
