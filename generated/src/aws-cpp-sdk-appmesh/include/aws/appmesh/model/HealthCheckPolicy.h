...
class HealthCheckPolicy {
 public:
  ...
  inline HealthCheckPolicy& WithHealthyThreshold(int value) {
  ...
  inline HealthCheckPolicy& WithIntervalMillis(long long value) {
  ...
  inline HealthCheckPolicy& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckPolicy& WithProtocol(PortProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckPolicy& WithTimeoutMillis(long long value) {
  ...
  inline HealthCheckPolicy& WithUnhealthyThreshold(int value) {
