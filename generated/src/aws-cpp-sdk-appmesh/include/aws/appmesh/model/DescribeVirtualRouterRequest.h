 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/DescribeVirtualRouterInput">AWS
 * API Reference</a></p>
 */
class DescribeVirtualRouterRequest : public AppMeshRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DescribeVirtualRouter"; }
  ...
  template <typename MeshNameT = Aws::String>
  DescribeVirtualRouterRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  DescribeVirtualRouterRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename VirtualRouterNameT = Aws::String>
  DescribeVirtualRouterRequest& WithVirtualRouterName(VirtualRouterNameT&& value) {
