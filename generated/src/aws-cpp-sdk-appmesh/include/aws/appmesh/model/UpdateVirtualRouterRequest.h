...
class UpdateVirtualRouterRequest : public AppMeshRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateVirtualRouterRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename MeshNameT = Aws::String>
  UpdateVirtualRouterRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  UpdateVirtualRouterRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename SpecT = VirtualRouterSpec>
  UpdateVirtualRouterRequest& WithSpec(SpecT&& value) {
  ...
  template <typename VirtualRouterNameT = Aws::String>
  UpdateVirtualRouterRequest& WithVirtualRouterName(VirtualRouterNameT&& value) {
