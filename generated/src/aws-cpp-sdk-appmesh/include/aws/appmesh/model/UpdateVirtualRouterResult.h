...
class UpdateVirtualRouterResult {
 public:
  AWS_APPMESH_API UpdateVirtualRouterResult() = default;
  ...
  template <typename VirtualRouterT = VirtualRouterData>
  UpdateVirtualRouterResult& WithVirtualRouter(VirtualRouterT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateVirtualRouterResult& WithRequestId(RequestIdT&& value) {
