...
class VirtualGatewayHealthCheckPolicy {
 public:
  ...
  inline void SetHealthyThreshold(int value) {
    m_healthyThresholdHasBeenSet = true;
    m_healthyThreshold = value;
  }
  inline VirtualGatewayHealthCheckPolicy& WithHealthyThreshold(int value) {
    SetHealthyThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIntervalMillis(long long value) {
    m_intervalMillisHasBeenSet = true;
    m_intervalMillis = value;
  }
  inline VirtualGatewayHealthCheckPolicy& WithIntervalMillis(long long value) {
    SetIntervalMillis(value);
    return *this;
  }
  ///@}
  ...
  inline VirtualGatewayHealthCheckPolicy& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProtocol(VirtualGatewayPortProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline VirtualGatewayHealthCheckPolicy& WithProtocol(VirtualGatewayPortProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimeoutMillis(long long value) {
    m_timeoutMillisHasBeenSet = true;
    m_timeoutMillis = value;
  }
  inline VirtualGatewayHealthCheckPolicy& WithTimeoutMillis(long long value) {
  ...
  inline void SetUnhealthyThreshold(int value) {
    m_unhealthyThresholdHasBeenSet = true;
    m_unhealthyThreshold = value;
  }
  inline VirtualGatewayHealthCheckPolicy& WithUnhealthyThreshold(int value) {
    SetUnhealthyThreshold(value);
    return *this;
  }
  ///@}
 private:
