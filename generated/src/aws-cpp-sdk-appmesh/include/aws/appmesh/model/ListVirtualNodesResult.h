...
class ListVirtualNodesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListVirtualNodesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetVirtualNodes(VirtualNodesT&& value) {
    m_virtualNodesHasBeenSet = true;
    m_virtualNodes = std::forward<VirtualNodesT>(value);
  }
  template <typename VirtualNodesT = Aws::Vector<VirtualNodeRef>>
  ListVirtualNodesResult& WithVirtualNodes(VirtualNodesT&& value) {
    SetVirtualNodes(std::forward<VirtualNodesT>(value));
    return *this;
  }
  template <typename VirtualNodesT = VirtualNodeRef>
  ListVirtualNodesResult& AddVirtualNodes(VirtualNodesT&& value) {
    m_virtualNodesHasBeenSet = true;
    m_virtualNodes.emplace_back(std::forward<VirtualNodesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListVirtualNodesResult& WithRequestId(RequestIdT&& value) {
