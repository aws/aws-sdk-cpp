...
class ListenerTlsCertificate {
 public:
  ...
  void SetAcm(AcmT&& value) {
    ...
    m_acm = std::forward<AcmT>(value);
  }
  template <typename AcmT = ListenerTlsAcmCertificate>
  ListenerTlsCertificate& WithAcm(AcmT&& value) {
    SetAcm(std::forward<AcmT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FileT = ListenerTlsFileCertificate>
  ListenerTlsCertificate& WithFile(FileT&& value) {
  ...
  template <typename SdsT = ListenerTlsSdsCertificate>
  ListenerTlsCertificate& WithSds(SdsT&& value) {
