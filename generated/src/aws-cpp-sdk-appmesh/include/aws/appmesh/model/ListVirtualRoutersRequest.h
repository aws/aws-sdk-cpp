...
namespace Model
{
  ...
  {
  public:
    AWS_APPMESH_API ListVirtualRoutersRequest() = default;
    ...
    template<typename MeshNameT = Aws::String>
    ListVirtualRoutersRequest& WithMeshName(MeshNameT&& value) { SetMeshName(std::forward<MeshNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MeshOwnerT = Aws::String>
    ListVirtualRoutersRequest& WithMeshOwner(MeshOwnerT&& value) { SetMeshOwner(std::forward<MeshOwnerT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListVirtualRoutersRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
