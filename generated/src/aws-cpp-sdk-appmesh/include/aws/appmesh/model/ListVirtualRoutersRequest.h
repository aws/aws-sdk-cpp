...
class ListVirtualRoutersRequest : public AppMeshRequest {
 public:
  ...
  inline ListVirtualRoutersRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename MeshNameT = Aws::String>
  ListVirtualRoutersRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  ListVirtualRoutersRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListVirtualRoutersRequest& WithNextToken(NextTokenT&& value) {
