...
class DeleteVirtualNodeRequest : public AppMeshRequest {
 public:
  ...
  template <typename MeshNameT = Aws::String>
  DeleteVirtualNodeRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  DeleteVirtualNodeRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename VirtualNodeNameT = Aws::String>
  DeleteVirtualNodeRequest& WithVirtualNodeName(VirtualNodeNameT&& value) {
