...
class HttpRouteMatch {
 public:
  ...
  inline void SetMethod(HttpMethod value) {
    m_methodHasBeenSet = true;
    m_method = value;
  }
  inline HttpRouteMatch& WithMethod(HttpMethod value) {
    SetMethod(value);
    return *this;
  }
  ///@}
  ...
  inline HttpRouteMatch& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  void SetQueryParameters(QueryParametersT&& value) {
    ...
    m_queryParameters = std::forward<QueryParametersT>(value);
  }
  template <typename QueryParametersT = Aws::Vector<HttpQueryParameter>>
  HttpRouteMatch& WithQueryParameters(QueryParametersT&& value) {
    SetQueryParameters(std::forward<QueryParametersT>(value));
    return *this;
  }
  template <typename QueryParametersT = HttpQueryParameter>
  HttpRouteMatch& AddQueryParameters(QueryParametersT&& value) {
    m_queryParametersHasBeenSet = true;
    m_queryParameters.emplace_back(std::forward<QueryParametersT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetScheme(HttpScheme value) {
    m_schemeHasBeenSet = true;
    m_scheme = value;
  }
  inline HttpRouteMatch& WithScheme(HttpScheme value) {
    SetScheme(value);
    return *this;
  }
  ///@}
