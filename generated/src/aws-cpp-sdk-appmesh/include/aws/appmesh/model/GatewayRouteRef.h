...
class GatewayRouteRef {
 public:
  ...
  template <typename ArnT = Aws::String>
  GatewayRouteRef& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GatewayRouteRef& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename GatewayRouteNameT = Aws::String>
  GatewayRouteRef& WithGatewayRouteName(GatewayRouteNameT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  GatewayRouteRef& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename MeshNameT = Aws::String>
  GatewayRouteRef& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  GatewayRouteRef& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename ResourceOwnerT = Aws::String>
  GatewayRouteRef& WithResourceOwner(ResourceOwnerT&& value) {
  ...
  inline GatewayRouteRef& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  template <typename VirtualGatewayNameT = Aws::String>
  GatewayRouteRef& WithVirtualGatewayName(VirtualGatewayNameT&& value) {
