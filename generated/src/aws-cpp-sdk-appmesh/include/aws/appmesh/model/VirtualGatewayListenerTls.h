...
class VirtualGatewayListenerTls {
 public:
  ...
  template <typename CertificateT = VirtualGatewayListenerTlsCertificate>
  VirtualGatewayListenerTls& WithCertificate(CertificateT&& value) {
  ...
  inline void SetMode(VirtualGatewayListenerTlsMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline VirtualGatewayListenerTls& WithMode(VirtualGatewayListenerTlsMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValidationT = VirtualGatewayListenerTlsValidationContext>
  VirtualGatewayListenerTls& WithValidation(ValidationT&& value) {
