...
class ListRoutesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListRoutesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RoutesT = Aws::Vector<RouteRef>>
  ListRoutesResult& WithRoutes(RoutesT&& value) {
    SetRoutes(std::forward<RoutesT>(value));
    return *this;
  }
  template <typename RoutesT = RouteRef>
  ListRoutesResult& AddRoutes(RoutesT&& value) {
    m_routesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListRoutesResult& WithRequestId(RequestIdT&& value) {
