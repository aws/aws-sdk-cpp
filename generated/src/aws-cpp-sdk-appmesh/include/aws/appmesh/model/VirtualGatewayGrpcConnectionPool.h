...
class VirtualGatewayGrpcConnectionPool {
 public:
  AWS_APPMESH_API VirtualGatewayGrpcConnectionPool() = default;
  ...
  inline void SetMaxRequests(int value) {
    m_maxRequestsHasBeenSet = true;
    m_maxRequests = value;
  }
  inline VirtualGatewayGrpcConnectionPool& WithMaxRequests(int value) {
