...
namespace Model
{
  ...
  {
  public:
    AWS_APPMESH_API DescribeGatewayRouteResult() = default;
    ...
    template<typename GatewayRouteT = GatewayRouteData>
    DescribeGatewayRouteResult& WithGatewayRoute(GatewayRouteT&& value) { SetGatewayRoute(std::forward<GatewayRouteT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeGatewayRouteResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
