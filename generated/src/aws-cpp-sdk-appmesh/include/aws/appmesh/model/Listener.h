...
class Listener {
 public:
  ...
  void SetConnectionPool(ConnectionPoolT&& value) {
    m_connectionPoolHasBeenSet = true;
    m_connectionPool = std::forward<ConnectionPoolT>(value);
  }
  template <typename ConnectionPoolT = VirtualNodeConnectionPool>
  Listener& WithConnectionPool(ConnectionPoolT&& value) {
    SetConnectionPool(std::forward<ConnectionPoolT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename HealthCheckT = HealthCheckPolicy>
  Listener& WithHealthCheck(HealthCheckT&& value) {
  ...
  void SetOutlierDetection(OutlierDetectionT&& value) {
    m_outlierDetectionHasBeenSet = true;
    m_outlierDetection = std::forward<OutlierDetectionT>(value);
  }
  template <typename OutlierDetectionT = OutlierDetection>
  Listener& WithOutlierDetection(OutlierDetectionT&& value) {
    SetOutlierDetection(std::forward<OutlierDetectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPortMapping(PortMappingT&& value) {
    m_portMappingHasBeenSet = true;
    m_portMapping = std::forward<PortMappingT>(value);
  }
  template <typename PortMappingT = PortMapping>
  Listener& WithPortMapping(PortMappingT&& value) {
    SetPortMapping(std::forward<PortMappingT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TimeoutT = ListenerTimeout>
  Listener& WithTimeout(TimeoutT&& value) {
