...
class DeleteVirtualGatewayRequest : public AppMeshRequest {
 public:
  AWS_APPMESH_API DeleteVirtualGatewayRequest() = default;
  ...
  template <typename MeshNameT = Aws::String>
  DeleteVirtualGatewayRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  DeleteVirtualGatewayRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename VirtualGatewayNameT = Aws::String>
  DeleteVirtualGatewayRequest& WithVirtualGatewayName(VirtualGatewayNameT&& value) {
