...
class ResourceMetadata {
 public:
  ...
  template <typename ArnT = Aws::String>
  ResourceMetadata& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ResourceMetadata& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  ResourceMetadata& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  ResourceMetadata& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename ResourceOwnerT = Aws::String>
  ResourceMetadata& WithResourceOwner(ResourceOwnerT&& value) {
  ...
  template <typename UidT = Aws::String>
  ResourceMetadata& WithUid(UidT&& value) {
  ...
  inline ResourceMetadata& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
