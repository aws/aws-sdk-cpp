...
class TlsValidationContextAcmTrust {
 public:
  ...
  void SetCertificateAuthorityArns(CertificateAuthorityArnsT&& value) {
    ...
    m_certificateAuthorityArns = std::forward<CertificateAuthorityArnsT>(value);
  }
  template <typename CertificateAuthorityArnsT = Aws::Vector<Aws::String>>
  TlsValidationContextAcmTrust& WithCertificateAuthorityArns(CertificateAuthorityArnsT&& value) {
    SetCertificateAuthorityArns(std::forward<CertificateAuthorityArnsT>(value));
    return *this;
  }
  ...
  TlsValidationContextAcmTrust& AddCertificateAuthorityArns(CertificateAuthorityArnsT&& value) {
    m_certificateAuthorityArnsHasBeenSet = true;
    m_certificateAuthorityArns.emplace_back(std::forward<CertificateAuthorityArnsT>(value));
    return *this;
  }
  ///@}
 private:
