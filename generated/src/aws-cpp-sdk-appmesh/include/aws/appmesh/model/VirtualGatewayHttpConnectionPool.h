...
class VirtualGatewayHttpConnectionPool {
 public:
  ...
  inline void SetMaxConnections(int value) {
    m_maxConnectionsHasBeenSet = true;
    m_maxConnections = value;
  }
  inline VirtualGatewayHttpConnectionPool& WithMaxConnections(int value) {
  ...
  inline void SetMaxPendingRequests(int value) {
    m_maxPendingRequestsHasBeenSet = true;
    m_maxPendingRequests = value;
  }
  inline VirtualGatewayHttpConnectionPool& WithMaxPendingRequests(int value) {
    SetMaxPendingRequests(value);
    return *this;
  }
  ///@}
 private:
