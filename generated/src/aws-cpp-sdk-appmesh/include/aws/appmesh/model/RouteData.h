...
class RouteData {
 public:
  ...
  template <typename MeshNameT = Aws::String>
  RouteData& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MetadataT = ResourceMetadata>
  RouteData& WithMetadata(MetadataT&& value) {
  ...
  template <typename RouteNameT = Aws::String>
  RouteData& WithRouteName(RouteNameT&& value) {
  ...
  template <typename SpecT = RouteSpec>
  RouteData& WithSpec(SpecT&& value) {
  ...
  template <typename StatusT = RouteStatus>
  RouteData& WithStatus(StatusT&& value) {
  ...
  template <typename VirtualRouterNameT = Aws::String>
  RouteData& WithVirtualRouterName(VirtualRouterNameT&& value) {
