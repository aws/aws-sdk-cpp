...
class DeleteVirtualRouterRequest : public AppMeshRequest {
 public:
  ...
  template <typename MeshNameT = Aws::String>
  DeleteVirtualRouterRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  DeleteVirtualRouterRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename VirtualRouterNameT = Aws::String>
  DeleteVirtualRouterRequest& WithVirtualRouterName(VirtualRouterNameT&& value) {
