...
class GatewayRouteHostnameRewrite {
 public:
  ...
  inline void SetDefaultTargetHostname(DefaultGatewayRouteRewrite value) {
    m_defaultTargetHostnameHasBeenSet = true;
    m_defaultTargetHostname = value;
  }
  inline GatewayRouteHostnameRewrite& WithDefaultTargetHostname(DefaultGatewayRouteRewrite value) {
    SetDefaultTargetHostname(value);
    return *this;
  }
  ///@}
 private:
