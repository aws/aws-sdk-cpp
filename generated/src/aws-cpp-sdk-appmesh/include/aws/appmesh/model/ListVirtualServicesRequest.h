...
class ListVirtualServicesRequest : public AppMeshRequest {
 public:
  ...
  inline ListVirtualServicesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename MeshNameT = Aws::String>
  ListVirtualServicesRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  ListVirtualServicesRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListVirtualServicesRequest& WithNextToken(NextTokenT&& value) {
