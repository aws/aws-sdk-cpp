...
class VirtualGatewayListenerTlsFileCertificate {
 public:
  ...
  template <typename CertificateChainT = Aws::String>
  VirtualGatewayListenerTlsFileCertificate& WithCertificateChain(CertificateChainT&& value) {
  ...
  template <typename PrivateKeyT = Aws::String>
  VirtualGatewayListenerTlsFileCertificate& WithPrivateKey(PrivateKeyT&& value) {
