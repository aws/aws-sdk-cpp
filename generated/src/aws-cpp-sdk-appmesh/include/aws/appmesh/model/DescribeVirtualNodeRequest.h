...
class DescribeVirtualNodeRequest : public AppMeshRequest {
 public:
  ...
  template <typename MeshNameT = Aws::String>
  DescribeVirtualNodeRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  DescribeVirtualNodeRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  void SetVirtualNodeName(VirtualNodeNameT&& value) {
    ...
    m_virtualNodeName = std::forward<VirtualNodeNameT>(value);
  }
  template <typename VirtualNodeNameT = Aws::String>
  DescribeVirtualNodeRequest& WithVirtualNodeName(VirtualNodeNameT&& value) {
    SetVirtualNodeName(std::forward<VirtualNodeNameT>(value));
    return *this;
  }
  ///@}
 private:
