...
class UpdateVirtualServiceRequest : public AppMeshRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateVirtualServiceRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename MeshNameT = Aws::String>
  UpdateVirtualServiceRequest& WithMeshName(MeshNameT&& value) {
  ...
  template <typename MeshOwnerT = Aws::String>
  UpdateVirtualServiceRequest& WithMeshOwner(MeshOwnerT&& value) {
  ...
  template <typename SpecT = VirtualServiceSpec>
  UpdateVirtualServiceRequest& WithSpec(SpecT&& value) {
  ...
  template <typename VirtualServiceNameT = Aws::String>
  UpdateVirtualServiceRequest& WithVirtualServiceName(VirtualServiceNameT&& value) {
