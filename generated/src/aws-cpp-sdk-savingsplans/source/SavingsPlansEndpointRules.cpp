...
{
const size_t SavingsPlansEndpointRules::RulesBlobStrLen = 4170;
const size_t SavingsPlansEndpointRules::RulesBlobSize = 4171;
...
'"','h','t','t','p','s',':','/','/','s','a','v','i','n','g','s','p','l','a','n','s','.','a','m','a',
