...
class SavingsPlanOfferingFilterElement {
 public:
  ...
  inline void SetName(SavingsPlanOfferingFilterAttribute value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SavingsPlanOfferingFilterElement& WithName(SavingsPlanOfferingFilterAttribute value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  SavingsPlanOfferingFilterElement& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  SavingsPlanOfferingFilterElement& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
