...
class SavingsPlanOfferingRate {
 public:
  ...
  void SetSavingsPlanOffering(SavingsPlanOfferingT&& value) {
    ...
    m_savingsPlanOffering = std::forward<SavingsPlanOfferingT>(value);
  }
  template <typename SavingsPlanOfferingT = ParentSavingsPlanOffering>
  SavingsPlanOfferingRate& WithSavingsPlanOffering(SavingsPlanOfferingT&& value) {
    SetSavingsPlanOffering(std::forward<SavingsPlanOfferingT>(value));
    return *this;
  }
  ///@}
  ...
  inline SavingsPlanOfferingRate& WithUnit(SavingsPlanRateUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline SavingsPlanOfferingRate& WithProductType(SavingsPlanProductType value) {
  ...
  inline SavingsPlanOfferingRate& WithServiceCode(SavingsPlanRateServiceCode value) {
