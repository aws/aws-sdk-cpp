...
class SavingsPlanFilter {
 public:
  ...
  inline void SetName(SavingsPlansFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SavingsPlanFilter& WithName(SavingsPlansFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  SavingsPlanFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  SavingsPlanFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
