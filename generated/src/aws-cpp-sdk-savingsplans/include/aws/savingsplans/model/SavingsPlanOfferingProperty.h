...
namespace Model
{
  ...
  public:
    ...
    inline void SetName(SavingsPlanOfferingPropertyKey value) { m_nameHasBeenSet = true; m_name = value; }
    inline SavingsPlanOfferingProperty& WithName(SavingsPlanOfferingPropertyKey value) { SetName(value); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    SavingsPlanOfferingProperty& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
