...
class DescribeSavingsPlansResult {
 public:
  ...
  void SetSavingsPlans(SavingsPlansT&& value) {
    m_savingsPlansHasBeenSet = true;
    m_savingsPlans = std::forward<SavingsPlansT>(value);
  }
  template <typename SavingsPlansT = Aws::Vector<SavingsPlan>>
  DescribeSavingsPlansResult& WithSavingsPlans(SavingsPlansT&& value) {
    SetSavingsPlans(std::forward<SavingsPlansT>(value));
    return *this;
  }
  template <typename SavingsPlansT = SavingsPlan>
  DescribeSavingsPlansResult& AddSavingsPlans(SavingsPlansT&& value) {
    m_savingsPlansHasBeenSet = true;
    m_savingsPlans.emplace_back(std::forward<SavingsPlansT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSavingsPlansResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSavingsPlansResult& WithRequestId(RequestIdT&& value) {
