...
class ParentSavingsPlanOffering {
 public:
  ...
  inline ParentSavingsPlanOffering& WithPaymentOption(SavingsPlanPaymentOption value) {
  ...
  inline void SetPlanType(SavingsPlanType value) {
    m_planTypeHasBeenSet = true;
    m_planType = value;
  }
  inline ParentSavingsPlanOffering& WithPlanType(SavingsPlanType value) {
    SetPlanType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDurationSeconds(long long value) {
    m_durationSecondsHasBeenSet = true;
    m_durationSeconds = value;
  }
  inline ParentSavingsPlanOffering& WithDurationSeconds(long long value) {
  ...
  inline ParentSavingsPlanOffering& WithCurrency(CurrencyCode value) {
    SetCurrency(value);
    return *this;
  }
  ///@}
  ...
  void SetPlanDescription(PlanDescriptionT&& value) {
    ...
    m_planDescription = std::forward<PlanDescriptionT>(value);
  }
  template <typename PlanDescriptionT = Aws::String>
  ParentSavingsPlanOffering& WithPlanDescription(PlanDescriptionT&& value) {
    SetPlanDescription(std::forward<PlanDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
