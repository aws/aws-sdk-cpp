...
namespace Model
{
  ...
  {
  public:
    AWS_SAVINGSPLANS_API DeleteQueuedSavingsPlanResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteQueuedSavingsPlanResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
