...
class DescribeSavingsPlansRequest : public SavingsPlansRequest {
 public:
  ...
  void SetSavingsPlanIds(SavingsPlanIdsT&& value) {
    m_savingsPlanIdsHasBeenSet = true;
    m_savingsPlanIds = std::forward<SavingsPlanIdsT>(value);
  }
  template <typename SavingsPlanIdsT = Aws::Vector<Aws::String>>
  DescribeSavingsPlansRequest& WithSavingsPlanIds(SavingsPlanIdsT&& value) {
    SetSavingsPlanIds(std::forward<SavingsPlanIdsT>(value));
    return *this;
  }
  template <typename SavingsPlanIdsT = Aws::String>
  DescribeSavingsPlansRequest& AddSavingsPlanIds(SavingsPlanIdsT&& value) {
    m_savingsPlanIdsHasBeenSet = true;
    m_savingsPlanIds.emplace_back(std::forward<SavingsPlanIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeSavingsPlansRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeSavingsPlansRequest& AddStates(SavingsPlanState value) {
    m_statesHasBeenSet = true;
