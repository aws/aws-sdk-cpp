...
class SavingsPlanRateFilter {
 public:
  ...
  inline void SetName(SavingsPlanRateFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SavingsPlanRateFilter& WithName(SavingsPlanRateFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  SavingsPlanRateFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  SavingsPlanRateFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
