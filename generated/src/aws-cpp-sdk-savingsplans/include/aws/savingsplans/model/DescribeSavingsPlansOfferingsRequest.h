...
class DescribeSavingsPlansOfferingsRequest : public SavingsPlansRequest {
 public:
  ...
  void SetPaymentOptions(PaymentOptionsT&& value) {
    m_paymentOptionsHasBeenSet = true;
    m_paymentOptions = std::forward<PaymentOptionsT>(value);
  }
  template <typename PaymentOptionsT = Aws::Vector<SavingsPlanPaymentOption>>
  DescribeSavingsPlansOfferingsRequest& WithPaymentOptions(PaymentOptionsT&& value) {
    SetPaymentOptions(std::forward<PaymentOptionsT>(value));
    return *this;
  }
  inline DescribeSavingsPlansOfferingsRequest& AddPaymentOptions(SavingsPlanPaymentOption value) {
    m_paymentOptionsHasBeenSet = true;
    m_paymentOptions.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeSavingsPlansOfferingsRequest& WithProductType(SavingsPlanProductType value) {
  ...
  void SetPlanTypes(PlanTypesT&& value) {
    m_planTypesHasBeenSet = true;
    m_planTypes = std::forward<PlanTypesT>(value);
  }
  template <typename PlanTypesT = Aws::Vector<SavingsPlanType>>
  DescribeSavingsPlansOfferingsRequest& WithPlanTypes(PlanTypesT&& value) {
    SetPlanTypes(std::forward<PlanTypesT>(value));
    return *this;
  }
  inline DescribeSavingsPlansOfferingsRequest& AddPlanTypes(SavingsPlanType value) {
    m_planTypesHasBeenSet = true;
    m_planTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetDurations(DurationsT&& value) {
    m_durationsHasBeenSet = true;
    m_durations = std::forward<DurationsT>(value);
  }
  template <typename DurationsT = Aws::Vector<long long>>
  DescribeSavingsPlansOfferingsRequest& WithDurations(DurationsT&& value) {
    SetDurations(std::forward<DurationsT>(value));
    return *this;
  }
  inline DescribeSavingsPlansOfferingsRequest& AddDurations(long long value) {
    m_durationsHasBeenSet = true;
    m_durations.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetCurrencies(CurrenciesT&& value) {
    m_currenciesHasBeenSet = true;
    m_currencies = std::forward<CurrenciesT>(value);
  }
  template <typename CurrenciesT = Aws::Vector<CurrencyCode>>
  DescribeSavingsPlansOfferingsRequest& WithCurrencies(CurrenciesT&& value) {
    SetCurrencies(std::forward<CurrenciesT>(value));
    return *this;
  }
  inline DescribeSavingsPlansOfferingsRequest& AddCurrencies(CurrencyCode value) {
    m_currenciesHasBeenSet = true;
    m_currencies.push_back(value);
    return *this;
  }
  ///@}
  ...
  DescribeSavingsPlansOfferingsRequest& AddServiceCodes(ServiceCodesT&& value) {
    m_serviceCodesHasBeenSet = true;
    m_serviceCodes.emplace_back(std::forward<ServiceCodesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeSavingsPlansOfferingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
