...
class DescribeSavingsPlansOfferingRatesRequest : public SavingsPlansRequest {
 public:
  ...
  void SetSavingsPlanOfferingIds(SavingsPlanOfferingIdsT&& value) {
    m_savingsPlanOfferingIdsHasBeenSet = true;
    m_savingsPlanOfferingIds = std::forward<SavingsPlanOfferingIdsT>(value);
  }
  template <typename SavingsPlanOfferingIdsT = Aws::Vector<Aws::String>>
  DescribeSavingsPlansOfferingRatesRequest& WithSavingsPlanOfferingIds(SavingsPlanOfferingIdsT&& value) {
    SetSavingsPlanOfferingIds(std::forward<SavingsPlanOfferingIdsT>(value));
    return *this;
  }
  template <typename SavingsPlanOfferingIdsT = Aws::String>
  DescribeSavingsPlansOfferingRatesRequest& AddSavingsPlanOfferingIds(SavingsPlanOfferingIdsT&& value) {
    m_savingsPlanOfferingIdsHasBeenSet = true;
    m_savingsPlanOfferingIds.emplace_back(std::forward<SavingsPlanOfferingIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSavingsPlanPaymentOptions(SavingsPlanPaymentOptionsT&& value) {
    m_savingsPlanPaymentOptionsHasBeenSet = true;
    m_savingsPlanPaymentOptions = std::forward<SavingsPlanPaymentOptionsT>(value);
  }
  template <typename SavingsPlanPaymentOptionsT = Aws::Vector<SavingsPlanPaymentOption>>
  DescribeSavingsPlansOfferingRatesRequest& WithSavingsPlanPaymentOptions(SavingsPlanPaymentOptionsT&& value) {
    SetSavingsPlanPaymentOptions(std::forward<SavingsPlanPaymentOptionsT>(value));
    return *this;
  }
  inline DescribeSavingsPlansOfferingRatesRequest& AddSavingsPlanPaymentOptions(SavingsPlanPaymentOption value) {
    m_savingsPlanPaymentOptionsHasBeenSet = true;
    m_savingsPlanPaymentOptions.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSavingsPlanTypes(SavingsPlanTypesT&& value) {
    m_savingsPlanTypesHasBeenSet = true;
    m_savingsPlanTypes = std::forward<SavingsPlanTypesT>(value);
  }
  template <typename SavingsPlanTypesT = Aws::Vector<SavingsPlanType>>
  DescribeSavingsPlansOfferingRatesRequest& WithSavingsPlanTypes(SavingsPlanTypesT&& value) {
    SetSavingsPlanTypes(std::forward<SavingsPlanTypesT>(value));
    return *this;
  }
  inline DescribeSavingsPlansOfferingRatesRequest& AddSavingsPlanTypes(SavingsPlanType value) {
    m_savingsPlanTypesHasBeenSet = true;
    m_savingsPlanTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProductsT = Aws::Vector<SavingsPlanProductType>>
  DescribeSavingsPlansOfferingRatesRequest& WithProducts(ProductsT&& value) {
    SetProducts(std::forward<ProductsT>(value));
    return *this;
  }
  inline DescribeSavingsPlansOfferingRatesRequest& AddProducts(SavingsPlanProductType value) {
    m_productsHasBeenSet = true;
  ...
  void SetServiceCodes(ServiceCodesT&& value) {
    m_serviceCodesHasBeenSet = true;
    m_serviceCodes = std::forward<ServiceCodesT>(value);
  }
  template <typename ServiceCodesT = Aws::Vector<SavingsPlanRateServiceCode>>
  DescribeSavingsPlansOfferingRatesRequest& WithServiceCodes(ServiceCodesT&& value) {
    SetServiceCodes(std::forward<ServiceCodesT>(value));
    return *this;
  }
  inline DescribeSavingsPlansOfferingRatesRequest& AddServiceCodes(SavingsPlanRateServiceCode value) {
    m_serviceCodesHasBeenSet = true;
    m_serviceCodes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetUsageTypes(UsageTypesT&& value) {
    m_usageTypesHasBeenSet = true;
    m_usageTypes = std::forward<UsageTypesT>(value);
  }
  template <typename UsageTypesT = Aws::Vector<Aws::String>>
  DescribeSavingsPlansOfferingRatesRequest& WithUsageTypes(UsageTypesT&& value) {
    SetUsageTypes(std::forward<UsageTypesT>(value));
    return *this;
  }
  template <typename UsageTypesT = Aws::String>
  DescribeSavingsPlansOfferingRatesRequest& AddUsageTypes(UsageTypesT&& value) {
    m_usageTypesHasBeenSet = true;
    m_usageTypes.emplace_back(std::forward<UsageTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OperationsT = Aws::Vector<Aws::String>>
  DescribeSavingsPlansOfferingRatesRequest& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Aws::String>
  DescribeSavingsPlansOfferingRatesRequest& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<SavingsPlanOfferingRateFilterElement>>
  DescribeSavingsPlansOfferingRatesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = SavingsPlanOfferingRateFilterElement>
  DescribeSavingsPlansOfferingRatesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSavingsPlansOfferingRatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeSavingsPlansOfferingRatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
