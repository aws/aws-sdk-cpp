...
class SavingsPlanOfferingRateFilterElement {
 public:
  ...
  inline void SetName(SavingsPlanRateFilterAttribute value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SavingsPlanOfferingRateFilterElement& WithName(SavingsPlanRateFilterAttribute value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  SavingsPlanOfferingRateFilterElement& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  SavingsPlanOfferingRateFilterElement& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
