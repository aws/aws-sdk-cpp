...
class DeleteConnectionRequest : public IoTDataPlaneRequest {
 public:
  ...
  inline DeleteConnectionRequest& WithCleanSession(bool value) {
  ...
  inline void SetPreventWillMessage(bool value) {
    m_preventWillMessageHasBeenSet = true;
    m_preventWillMessage = value;
  }
  inline DeleteConnectionRequest& WithPreventWillMessage(bool value) {
    SetPreventWillMessage(value);
    return *this;
  }
  ///@}
 private:
