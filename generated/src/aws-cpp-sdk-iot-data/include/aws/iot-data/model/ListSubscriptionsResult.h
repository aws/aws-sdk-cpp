...
class ListSubscriptionsResult {
 public:
  AWS_IOTDATAPLANE_API ListSubscriptionsResult() = default;
  AWS_IOTDATAPLANE_API ListSubscriptionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_IOTDATAPLANE_API ListSubscriptionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>A list of topic filters and their associated Quality of Service (QoS) levels
   * that the client is subscribed to.</p>
   */
  inline const Aws::Vector<SubscriptionSummary>& GetSubscriptions() const { return m_subscriptions; }
  template <typename SubscriptionsT = Aws::Vector<SubscriptionSummary>>
  ...
  template <typename SubscriptionsT = SubscriptionSummary>
 ...
 private:
  Aws::Vector<SubscriptionSummary> m_subscriptions;
