...
class PublishRequest : public StreamingIoTDataPlaneRequest {
 public:
  ...
  inline PublishRequest& WithQos(int value) {
    SetQos(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRetain(bool value) {
    m_retainHasBeenSet = true;
    m_retain = value;
  }
  inline PublishRequest& WithRetain(bool value) {
    SetRetain(value);
    return *this;
  }
  ///@}
  ...
  inline PublishRequest& WithPayloadFormatIndicator(PayloadFormatIndicator value) {
  ...
  inline void SetMessageExpiry(long long value) {
    m_messageExpiryHasBeenSet = true;
    m_messageExpiry = value;
  }
  inline PublishRequest& WithMessageExpiry(long long value) {
    SetMessageExpiry(value);
    return *this;
  }
  ///@}
 private:
