...
/**
 */
class ListNamedShadowsForThingRequest : public IoTDataPlaneRequest {
 public:
  AWS_IOTDATAPLANE_API ListNamedShadowsForThingRequest() = default;
  ...
  template <typename ThingNameT = Aws::String>
  ListNamedShadowsForThingRequest& WithThingName(ThingNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListNamedShadowsForThingRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListNamedShadowsForThingRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
