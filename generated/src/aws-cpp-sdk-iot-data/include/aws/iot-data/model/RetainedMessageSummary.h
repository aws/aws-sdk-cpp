...
class RetainedMessageSummary {
 public:
  ...
  inline void SetPayloadSize(long long value) {
    m_payloadSizeHasBeenSet = true;
    m_payloadSize = value;
  }
  inline RetainedMessageSummary& WithPayloadSize(long long value) {
  ...
  inline RetainedMessageSummary& WithQos(int value) {
    SetQos(value);
    return *this;
  }
  ///@}
  ...
  inline RetainedMessageSummary& WithLastModifiedTime(long long value) {
