...
class ListRetainedMessagesResult {
 public:
  ...
  void SetRetainedTopics(RetainedTopicsT&& value) {
    m_retainedTopicsHasBeenSet = true;
    m_retainedTopics = std::forward<RetainedTopicsT>(value);
  }
  template <typename RetainedTopicsT = Aws::Vector<RetainedMessageSummary>>
  ListRetainedMessagesResult& WithRetainedTopics(RetainedTopicsT&& value) {
    SetRetainedTopics(std::forward<RetainedTopicsT>(value));
    return *this;
  }
  template <typename RetainedTopicsT = RetainedMessageSummary>
  ListRetainedMessagesResult& AddRetainedTopics(RetainedTopicsT&& value) {
    m_retainedTopicsHasBeenSet = true;
    m_retainedTopics.emplace_back(std::forward<RetainedTopicsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRetainedMessagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRetainedMessagesResult& WithRequestId(RequestIdT&& value) {
