...
class ListRetainedMessagesRequest : public IoTDataPlaneRequest {
 public:
  AWS_IOTDATAPLANE_API ListRetainedMessagesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListRetainedMessagesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRetainedMessagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
