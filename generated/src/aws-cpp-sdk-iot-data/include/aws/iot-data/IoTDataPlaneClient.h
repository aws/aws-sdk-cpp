...
class AWS_IOTDATAPLANE_API IoTDataPlaneClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IoTDataPlaneClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<IoTDataPlaneEndpointProviderBase> endpointProvider = nullptr,
      const Aws::IoTDataPlane::IoTDataPlaneClientConfiguration& clientConfiguration = Aws::IoTDataPlane::IoTDataPlaneClientConfiguration());
  ...
  /**
   * A Callable wrapper for DeleteThingShadow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteThingShadowRequestT = Model::DeleteThingShadowRequest>
  Model::DeleteThingShadowOutcomeCallable DeleteThingShadowCallable(const DeleteThingShadowRequestT& request) const {
    return SubmitCallable(&IoTDataPlaneClient::DeleteThingShadow, request);
  }

  /**
   * An Async wrapper for DeleteThingShadow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteThingShadowRequestT = Model::DeleteThingShadowRequest>
  ...
  /**
   * A Callable wrapper for GetRetainedMessage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetRetainedMessageRequestT = Model::GetRetainedMessageRequest>
  Model::GetRetainedMessageOutcomeCallable GetRetainedMessageCallable(const GetRetainedMessageRequestT& request) const {
    return SubmitCallable(&IoTDataPlaneClient::GetRetainedMessage, request);
  }

  /**
   * An Async wrapper for GetRetainedMessage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetRetainedMessageRequestT = Model::GetRetainedMessageRequest>
  void GetRetainedMessageAsync(const GetRetainedMessageRequestT& request, const GetRetainedMessageResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&IoTDataPlaneClient::GetRetainedMessage, request, handler, context);
  }
   ...
   */
  template <typename GetThingShadowRequestT = Model::GetThingShadowRequest>
  Model::GetThingShadowOutcomeCallable GetThingShadowCallable(const GetThingShadowRequestT& request) const {
    return SubmitCallable(&IoTDataPlaneClient::GetThingShadow, request);
  }

  /**
   * An Async wrapper for GetThingShadow that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetThingShadowRequestT = Model::GetThingShadowRequest>
  void GetThingShadowAsync(const GetThingShadowRequestT& request, const GetThingShadowResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&IoTDataPlaneClient::GetThingShadow, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListNamedShadowsForThing that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListNamedShadowsForThingRequestT = Model::ListNamedShadowsForThingRequest>
  Model::ListNamedShadowsForThingOutcomeCallable ListNamedShadowsForThingCallable(const ListNamedShadowsForThingRequestT& request) const {
    return SubmitCallable(&IoTDataPlaneClient::ListNamedShadowsForThing, request);
  }

  /**
   * An Async wrapper for ListNamedShadowsForThing that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListNamedShadowsForThingRequestT = Model::ListNamedShadowsForThingRequest>
  void ListNamedShadowsForThingAsync(const ListNamedShadowsForThingRequestT& request,
                                     const ListNamedShadowsForThingResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&IoTDataPlaneClient::ListNamedShadowsForThing, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListRetainedMessages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRetainedMessages that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRetainedMessagesRequestT = Model::ListRetainedMessagesRequest>
  void ListRetainedMessagesAsync(const ListRetainedMessagesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListRetainedMessagesRequestT& request = {}) const {
  ...
  Model::PublishOutcomeCallable PublishCallable(const PublishRequestT& request) const {
    return SubmitCallable(&IoTDataPlaneClient::Publish, request);
  }
  ...
  /**
   * A Callable wrapper for UpdateThingShadow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateThingShadowRequestT = Model::UpdateThingShadowRequest>
  Model::UpdateThingShadowOutcomeCallable UpdateThingShadowCallable(const UpdateThingShadowRequestT& request) const {
    return SubmitCallable(&IoTDataPlaneClient::UpdateThingShadow, request);
  }

  /**
   * An Async wrapper for UpdateThingShadow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateThingShadowRequestT = Model::UpdateThingShadowRequest>
  void UpdateThingShadowAsync(const UpdateThingShadowRequestT& request, const UpdateThingShadowResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
