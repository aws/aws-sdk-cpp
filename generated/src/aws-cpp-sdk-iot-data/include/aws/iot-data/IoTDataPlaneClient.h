...
namespace IoTDataPlane
{
   ...
   */
  class AWS_IOTDATAPLANE_API IoTDataPlaneClient : Aws::Client::ClientWithAsyncTemplateMethods<IoTDataPlaneClient>,
    smithy::client::AwsSmithyClientT<Aws::IoTDataPlane::SERVICE_NAME,
