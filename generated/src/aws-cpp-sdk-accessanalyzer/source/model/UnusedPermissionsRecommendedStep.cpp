...
UnusedPermissionsRecommendedStep::UnusedPermissionsRecommendedStep(JsonView jsonValue) { *this = jsonValue; }
...
UnusedPermissionsRecommendedStep& UnusedPermissionsRecommendedStep::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("recommendedAction")) {
    m_recommendedAction =
        RecommendedRemediationActionMapper::GetRecommendedRemediationActionForName(jsonValue.GetString("recommendedAction"));
...
JsonValue UnusedPermissionsRecommendedStep::Jsonize() const {
  ...
  if (m_recommendedActionHasBeenSet) {
    payload.WithString("recommendedAction",
                       RecommendedRemediationActionMapper::GetNameForRecommendedRemediationAction(m_recommendedAction));
  }
