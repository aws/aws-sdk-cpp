...
InternalAccessDetails::InternalAccessDetails(JsonView jsonValue) { *this = jsonValue; }
...
InternalAccessDetails& InternalAccessDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("resourceControlPolicyRestriction")) {
    m_resourceControlPolicyRestriction = ResourceControlPolicyRestrictionMapper::GetResourceControlPolicyRestrictionForName(
        jsonValue.GetString("resourceControlPolicyRestriction"));
  ...
  if (jsonValue.ValueExists("serviceControlPolicyRestriction")) {
    m_serviceControlPolicyRestriction = ServiceControlPolicyRestrictionMapper::GetServiceControlPolicyRestrictionForName(
        jsonValue.GetString("serviceControlPolicyRestriction"));
...
JsonValue InternalAccessDetails::Jsonize() const {
  ...
  if (m_resourceControlPolicyRestrictionHasBeenSet) {
    payload.WithString(
        ...
        ResourceControlPolicyRestrictionMapper::GetNameForResourceControlPolicyRestriction(m_resourceControlPolicyRestriction));
  }

  if (m_serviceControlPolicyRestrictionHasBeenSet) {
    payload.WithString("serviceControlPolicyRestriction",
                       ServiceControlPolicyRestrictionMapper::GetNameForServiceControlPolicyRestriction(m_serviceControlPolicyRestriction));
  }
