...
UnusedAccessFindingsStatistics::UnusedAccessFindingsStatistics(JsonView jsonValue) { *this = jsonValue; }
...
UnusedAccessFindingsStatistics& UnusedAccessFindingsStatistics::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("unusedAccessTypeStatistics")) {
    ...
    for (unsigned unusedAccessTypeStatisticsIndex = 0; unusedAccessTypeStatisticsIndex < unusedAccessTypeStatisticsJsonList.GetLength();
         ++unusedAccessTypeStatisticsIndex) {
...
JsonValue UnusedAccessFindingsStatistics::Jsonize() const {
  ...
  if (m_unusedAccessTypeStatisticsHasBeenSet) {
    ...
    for (unsigned unusedAccessTypeStatisticsIndex = 0; unusedAccessTypeStatisticsIndex < unusedAccessTypeStatisticsJsonList.GetLength();
         ++unusedAccessTypeStatisticsIndex) {
      unusedAccessTypeStatisticsJsonList[unusedAccessTypeStatisticsIndex].AsObject(
          m_unusedAccessTypeStatistics[unusedAccessTypeStatisticsIndex].Jsonize());
    }
