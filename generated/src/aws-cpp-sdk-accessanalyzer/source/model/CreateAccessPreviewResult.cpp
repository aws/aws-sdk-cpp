...
CreateAccessPreviewResult::CreateAccessPreviewResult()
{
}

CreateAccessPreviewResult::CreateAccessPreviewResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
