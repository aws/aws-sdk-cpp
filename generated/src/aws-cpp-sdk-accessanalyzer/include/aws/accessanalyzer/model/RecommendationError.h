...
namespace Model
{
  ...
  {
  public:
    AWS_ACCESSANALYZER_API RecommendationError() = default;
    ...
    template<typename CodeT = Aws::String>
    RecommendationError& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    RecommendationError& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
