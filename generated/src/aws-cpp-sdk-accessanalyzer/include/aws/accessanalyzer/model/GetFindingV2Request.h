...
class GetFindingV2Request : public AccessAnalyzerRequest {
 public:
  ...
  template <typename AnalyzerArnT = Aws::String>
  GetFindingV2Request& WithAnalyzerArn(AnalyzerArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetFindingV2Request& WithId(IdT&& value) {
  ...
  inline GetFindingV2Request& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetFindingV2Request& WithNextToken(NextTokenT&& value) {
