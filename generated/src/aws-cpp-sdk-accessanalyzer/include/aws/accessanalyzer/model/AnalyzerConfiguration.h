...
class AnalyzerConfiguration {
 public:
  ...
  void SetUnusedAccess(UnusedAccessT&& value) {
    m_unusedAccessHasBeenSet = true;
    m_unusedAccess = std::forward<UnusedAccessT>(value);
  }
  template <typename UnusedAccessT = UnusedAccessConfiguration>
  AnalyzerConfiguration& WithUnusedAccess(UnusedAccessT&& value) {
    SetUnusedAccess(std::forward<UnusedAccessT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInternalAccess(InternalAccessT&& value) {
    m_internalAccessHasBeenSet = true;
    m_internalAccess = std::forward<InternalAccessT>(value);
  }
  template <typename InternalAccessT = InternalAccessConfiguration>
  AnalyzerConfiguration& WithInternalAccess(InternalAccessT&& value) {
    SetInternalAccess(std::forward<InternalAccessT>(value));
    return *this;
  }
  ///@}
 private:
