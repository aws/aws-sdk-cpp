...
class ListAccessPreviewFindingsResult {
 public:
  ...
  template <typename FindingsT = Aws::Vector<AccessPreviewFinding>>
  ListAccessPreviewFindingsResult& WithFindings(FindingsT&& value) {
    SetFindings(std::forward<FindingsT>(value));
    return *this;
  }
  template <typename FindingsT = AccessPreviewFinding>
  ListAccessPreviewFindingsResult& AddFindings(FindingsT&& value) {
    m_findingsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessPreviewFindingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessPreviewFindingsResult& WithRequestId(RequestIdT&& value) {
