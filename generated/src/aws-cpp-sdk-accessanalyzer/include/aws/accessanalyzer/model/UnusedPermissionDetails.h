...
class UnusedPermissionDetails {
 public:
  ...
  template <typename ActionsT = Aws::Vector<UnusedAction>>
  UnusedPermissionDetails& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = UnusedAction>
  UnusedPermissionDetails& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename ServiceNamespaceT = Aws::String>
  UnusedPermissionDetails& WithServiceNamespace(ServiceNamespaceT&& value) {
  ...
  template <typename LastAccessedT = Aws::Utils::DateTime>
  UnusedPermissionDetails& WithLastAccessed(LastAccessedT&& value) {
