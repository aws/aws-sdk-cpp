...
class UnusedIamUserAccessKeyDetails {
 public:
  ...
  template <typename AccessKeyIdT = Aws::String>
  UnusedIamUserAccessKeyDetails& WithAccessKeyId(AccessKeyIdT&& value) {
  ...
  void SetLastAccessed(LastAccessedT&& value) {
    ...
    m_lastAccessed = std::forward<LastAccessedT>(value);
  }
  template <typename LastAccessedT = Aws::Utils::DateTime>
  UnusedIamUserAccessKeyDetails& WithLastAccessed(LastAccessedT&& value) {
    SetLastAccessed(std::forward<LastAccessedT>(value));
    return *this;
  }
  ///@}
 private:
