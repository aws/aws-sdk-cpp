...
class ListArchiveRulesResult {
 public:
  ...
  template <typename ArchiveRulesT = Aws::Vector<ArchiveRuleSummary>>
  ListArchiveRulesResult& WithArchiveRules(ArchiveRulesT&& value) {
    SetArchiveRules(std::forward<ArchiveRulesT>(value));
    return *this;
  }
  template <typename ArchiveRulesT = ArchiveRuleSummary>
  ListArchiveRulesResult& AddArchiveRules(ArchiveRulesT&& value) {
    m_archiveRulesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListArchiveRulesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListArchiveRulesResult& WithRequestId(RequestIdT&& value) {
