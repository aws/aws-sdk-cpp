...
class GetFindingRecommendationResult {
 public:
  ...
  template <typename ErrorT = RecommendationError>
  GetFindingRecommendationResult& WithError(ErrorT&& value) {
  ...
  void SetRecommendedSteps(RecommendedStepsT&& value) {
    m_recommendedStepsHasBeenSet = true;
    m_recommendedSteps = std::forward<RecommendedStepsT>(value);
  }
  template <typename RecommendedStepsT = Aws::Vector<RecommendedStep>>
  GetFindingRecommendationResult& WithRecommendedSteps(RecommendedStepsT&& value) {
    SetRecommendedSteps(std::forward<RecommendedStepsT>(value));
    return *this;
  }
  ...
  GetFindingRecommendationResult& AddRecommendedSteps(RecommendedStepsT&& value) {
    m_recommendedStepsHasBeenSet = true;
    m_recommendedSteps.emplace_back(std::forward<RecommendedStepsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetFindingRecommendationResult& WithRecommendationType(RecommendationType value) {
  ...
  inline GetFindingRecommendationResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
