...
class ListAnalyzedResourcesResult {
 public:
  ...
  void SetAnalyzedResources(AnalyzedResourcesT&& value) {
    m_analyzedResourcesHasBeenSet = true;
    m_analyzedResources = std::forward<AnalyzedResourcesT>(value);
  }
  template <typename AnalyzedResourcesT = Aws::Vector<AnalyzedResourceSummary>>
  ListAnalyzedResourcesResult& WithAnalyzedResources(AnalyzedResourcesT&& value) {
    SetAnalyzedResources(std::forward<AnalyzedResourcesT>(value));
    return *this;
  }
  template <typename AnalyzedResourcesT = AnalyzedResourceSummary>
  ListAnalyzedResourcesResult& AddAnalyzedResources(AnalyzedResourcesT&& value) {
    m_analyzedResourcesHasBeenSet = true;
    m_analyzedResources.emplace_back(std::forward<AnalyzedResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnalyzedResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnalyzedResourcesResult& WithRequestId(RequestIdT&& value) {
