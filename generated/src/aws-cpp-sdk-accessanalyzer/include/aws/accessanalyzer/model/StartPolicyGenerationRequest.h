...
class StartPolicyGenerationRequest : public AccessAnalyzerRequest {
 public:
  ...
  void SetPolicyGenerationDetails(PolicyGenerationDetailsT&& value) {
    m_policyGenerationDetailsHasBeenSet = true;
    m_policyGenerationDetails = std::forward<PolicyGenerationDetailsT>(value);
  }
  template <typename PolicyGenerationDetailsT = PolicyGenerationDetails>
  StartPolicyGenerationRequest& WithPolicyGenerationDetails(PolicyGenerationDetailsT&& value) {
    SetPolicyGenerationDetails(std::forward<PolicyGenerationDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudTrailDetails(CloudTrailDetailsT&& value) {
    m_cloudTrailDetailsHasBeenSet = true;
    m_cloudTrailDetails = std::forward<CloudTrailDetailsT>(value);
  }
  template <typename CloudTrailDetailsT = CloudTrailDetails>
  StartPolicyGenerationRequest& WithCloudTrailDetails(CloudTrailDetailsT&& value) {
    SetCloudTrailDetails(std::forward<CloudTrailDetailsT>(value));
    return *this;
  }
  ///@}
