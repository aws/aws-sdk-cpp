...
class CheckNoNewAccessSdkResult {
 public:
  ...
  inline void SetResult(CheckNoNewAccessResult value) {
    m_resultHasBeenSet = true;
    m_result = value;
  }
  inline CheckNoNewAccessSdkResult& WithResult(CheckNoNewAccessResult value) {
    SetResult(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  CheckNoNewAccessSdkResult& WithMessage(MessageT&& value) {
  ...
  template <typename ReasonsT = Aws::Vector<ReasonSummary>>
  CheckNoNewAccessSdkResult& WithReasons(ReasonsT&& value) {
    SetReasons(std::forward<ReasonsT>(value));
    return *this;
  }
  template <typename ReasonsT = ReasonSummary>
  CheckNoNewAccessSdkResult& AddReasons(ReasonsT&& value) {
    m_reasonsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CheckNoNewAccessSdkResult& WithRequestId(RequestIdT&& value) {
