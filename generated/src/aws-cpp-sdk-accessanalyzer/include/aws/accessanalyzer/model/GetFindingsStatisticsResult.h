...
class GetFindingsStatisticsResult {
 public:
  ...
  void SetFindingsStatistics(FindingsStatisticsT&& value) {
    ...
    m_findingsStatistics = std::forward<FindingsStatisticsT>(value);
  }
  template <typename FindingsStatisticsT = Aws::Vector<FindingsStatistics>>
  GetFindingsStatisticsResult& WithFindingsStatistics(FindingsStatisticsT&& value) {
    SetFindingsStatistics(std::forward<FindingsStatisticsT>(value));
    return *this;
  }
  ...
  GetFindingsStatisticsResult& AddFindingsStatistics(FindingsStatisticsT&& value) {
    m_findingsStatisticsHasBeenSet = true;
    m_findingsStatistics.emplace_back(std::forward<FindingsStatisticsT>(value));
    return *this;
  }
  ///@}
