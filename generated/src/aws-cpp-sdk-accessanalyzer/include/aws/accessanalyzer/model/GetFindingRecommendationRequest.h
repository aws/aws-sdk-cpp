...
class GetFindingRecommendationRequest : public AccessAnalyzerRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetFindingRecommendation"; }
  ...
  template <typename AnalyzerArnT = Aws::String>
  GetFindingRecommendationRequest& WithAnalyzerArn(AnalyzerArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetFindingRecommendationRequest& WithId(IdT&& value) {
  ...
  inline GetFindingRecommendationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetFindingRecommendationRequest& WithNextToken(NextTokenT&& value) {
