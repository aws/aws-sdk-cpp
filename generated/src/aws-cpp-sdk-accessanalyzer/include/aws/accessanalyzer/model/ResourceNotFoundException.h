...
namespace Model
{
  ...
  {
  public:
    AWS_ACCESSANALYZER_API ResourceNotFoundException() = default;
    AWS_ACCESSANALYZER_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_ACCESSANALYZER_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
