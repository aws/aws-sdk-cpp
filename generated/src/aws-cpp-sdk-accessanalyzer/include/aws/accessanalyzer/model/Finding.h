...
class Finding {
 public:
  ...
  inline Finding& WithIsPublic(bool value) {
    SetIsPublic(value);
    return *this;
  }
  ///@}
  ...
  inline Finding& WithResourceType(ResourceType value) {
  ...
  inline Finding& WithResourceControlPolicyRestriction(ResourceControlPolicyRestriction value) {
