...
class ListAnalyzersResult {
 public:
  ...
  void SetAnalyzers(AnalyzersT&& value) {
    m_analyzersHasBeenSet = true;
    m_analyzers = std::forward<AnalyzersT>(value);
  }
  template <typename AnalyzersT = Aws::Vector<AnalyzerSummary>>
  ListAnalyzersResult& WithAnalyzers(AnalyzersT&& value) {
    SetAnalyzers(std::forward<AnalyzersT>(value));
    return *this;
  }
  template <typename AnalyzersT = AnalyzerSummary>
  ListAnalyzersResult& AddAnalyzers(AnalyzersT&& value) {
    m_analyzersHasBeenSet = true;
    m_analyzers.emplace_back(std::forward<AnalyzersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnalyzersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnalyzersResult& WithRequestId(RequestIdT&& value) {
