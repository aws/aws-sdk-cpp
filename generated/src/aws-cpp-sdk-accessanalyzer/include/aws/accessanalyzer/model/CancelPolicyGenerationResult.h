...
namespace Model
{
  ...
  public:
    ...
    inline CancelPolicyGenerationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CancelPolicyGenerationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CancelPolicyGenerationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
