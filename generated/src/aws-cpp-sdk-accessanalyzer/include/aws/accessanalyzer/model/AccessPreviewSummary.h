...
class AccessPreviewSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  AccessPreviewSummary& WithId(IdT&& value) {
  ...
  template <typename AnalyzerArnT = Aws::String>
  AccessPreviewSummary& WithAnalyzerArn(AnalyzerArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  AccessPreviewSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline AccessPreviewSummary& WithStatus(AccessPreviewStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = AccessPreviewStatusReason>
  AccessPreviewSummary& WithStatusReason(StatusReasonT&& value) {
