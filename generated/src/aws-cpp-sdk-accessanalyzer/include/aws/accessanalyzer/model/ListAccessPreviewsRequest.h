...
class ListAccessPreviewsRequest : public AccessAnalyzerRequest {
 public:
  ...
  template <typename AnalyzerArnT = Aws::String>
  ListAccessPreviewsRequest& WithAnalyzerArn(AnalyzerArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessPreviewsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccessPreviewsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
