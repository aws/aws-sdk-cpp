...
class S3BucketConfiguration {
 public:
  ...
  void SetBucketPolicy(BucketPolicyT&& value) {
    ...
    m_bucketPolicy = std::forward<BucketPolicyT>(value);
  }
  template <typename BucketPolicyT = Aws::String>
  S3BucketConfiguration& WithBucketPolicy(BucketPolicyT&& value) {
    SetBucketPolicy(std::forward<BucketPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBucketAclGrants(BucketAclGrantsT&& value) {
    m_bucketAclGrantsHasBeenSet = true;
    m_bucketAclGrants = std::forward<BucketAclGrantsT>(value);
  }
  template <typename BucketAclGrantsT = Aws::Vector<S3BucketAclGrantConfiguration>>
  S3BucketConfiguration& WithBucketAclGrants(BucketAclGrantsT&& value) {
    SetBucketAclGrants(std::forward<BucketAclGrantsT>(value));
    return *this;
  }
  template <typename BucketAclGrantsT = S3BucketAclGrantConfiguration>
  S3BucketConfiguration& AddBucketAclGrants(BucketAclGrantsT&& value) {
    m_bucketAclGrantsHasBeenSet = true;
    m_bucketAclGrants.emplace_back(std::forward<BucketAclGrantsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBucketPublicAccessBlock(BucketPublicAccessBlockT&& value) {
    m_bucketPublicAccessBlockHasBeenSet = true;
    m_bucketPublicAccessBlock = std::forward<BucketPublicAccessBlockT>(value);
  }
  template <typename BucketPublicAccessBlockT = S3PublicAccessBlockConfiguration>
  S3BucketConfiguration& WithBucketPublicAccessBlock(BucketPublicAccessBlockT&& value) {
    SetBucketPublicAccessBlock(std::forward<BucketPublicAccessBlockT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AccessPointsT = Aws::Map<Aws::String, S3AccessPointConfiguration>>
  S3BucketConfiguration& WithAccessPoints(AccessPointsT&& value) {
  ...
  S3BucketConfiguration& AddAccessPoints(AccessPointsKeyT&& key, AccessPointsValueT&& value) {
    m_accessPointsHasBeenSet = true;
    m_accessPoints.emplace(std::forward<AccessPointsKeyT>(key), std::forward<AccessPointsValueT>(value));
    return *this;
  }
  ///@}
 private:
