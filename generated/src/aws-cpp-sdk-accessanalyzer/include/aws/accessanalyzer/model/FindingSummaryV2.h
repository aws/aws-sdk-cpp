...
class FindingSummaryV2 {
 public:
  ...
  inline FindingSummaryV2& WithResourceType(ResourceType value) {
  ...
  inline FindingSummaryV2& WithStatus(FindingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFindingType(FindingType value) {
    m_findingTypeHasBeenSet = true;
    m_findingType = value;
  }
  inline FindingSummaryV2& WithFindingType(FindingType value) {
