...
class FindingAggregationAccountDetails {
 public:
  ...
  inline void SetNumberOfActiveFindings(int value) {
    m_numberOfActiveFindingsHasBeenSet = true;
    m_numberOfActiveFindings = value;
  }
  inline FindingAggregationAccountDetails& WithNumberOfActiveFindings(int value) {
    SetNumberOfActiveFindings(value);
    return *this;
  }
  ///@}
