...
class S3ExpressDirectoryAccessPointConfiguration {
 public:
  ...
  template <typename AccessPointPolicyT = Aws::String>
  S3ExpressDirectoryAccessPointConfiguration& WithAccessPointPolicy(AccessPointPolicyT&& value) {
  ...
  template <typename NetworkOriginT = NetworkOriginConfiguration>
  S3ExpressDirectoryAccessPointConfiguration& WithNetworkOrigin(NetworkOriginT&& value) {
