...
class GetFindingV2Result {
 public:
  ...
  inline GetFindingV2Result& WithResourceType(ResourceType value) {
  ...
  inline GetFindingV2Result& WithStatus(FindingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetFindingV2Result& WithFindingType(FindingType value) {
