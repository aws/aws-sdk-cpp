...
namespace Model
{
  ...
  {
  public:
    AWS_ACCESSANALYZER_API GenerateFindingRecommendationRequest();
    ...
    inline GenerateFindingRecommendationRequest& WithAnalyzerArn(const Aws::String& value) { SetAnalyzerArn(value); return *this;}
    inline GenerateFindingRecommendationRequest& WithAnalyzerArn(Aws::String&& value) { SetAnalyzerArn(std::move(value)); return *this;}
    inline GenerateFindingRecommendationRequest& WithAnalyzerArn(const char* value) { SetAnalyzerArn(value); return *this;}
    ///@}
    ...
    inline GenerateFindingRecommendationRequest& WithId(const Aws::String& value) { SetId(value); return *this;}
    inline GenerateFindingRecommendationRequest& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}
    inline GenerateFindingRecommendationRequest& WithId(const char* value) { SetId(value); return *this;}
    ///@}
  private:
