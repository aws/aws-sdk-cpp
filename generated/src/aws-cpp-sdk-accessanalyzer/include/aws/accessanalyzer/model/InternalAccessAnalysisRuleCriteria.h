...
class InternalAccessAnalysisRuleCriteria {
 public:
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  InternalAccessAnalysisRuleCriteria& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  InternalAccessAnalysisRuleCriteria& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  template <typename ResourceTypesT = Aws::Vector<ResourceType>>
  InternalAccessAnalysisRuleCriteria& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  inline InternalAccessAnalysisRuleCriteria& AddResourceTypes(ResourceType value) {
    m_resourceTypesHasBeenSet = true;
  ...
  template <typename ResourceArnsT = Aws::Vector<Aws::String>>
  InternalAccessAnalysisRuleCriteria& WithResourceArns(ResourceArnsT&& value) {
    SetResourceArns(std::forward<ResourceArnsT>(value));
    return *this;
  }
  template <typename ResourceArnsT = Aws::String>
  InternalAccessAnalysisRuleCriteria& AddResourceArns(ResourceArnsT&& value) {
    m_resourceArnsHasBeenSet = true;
