...
class UnusedAccessFindingsStatistics {
 public:
  ...
  void SetUnusedAccessTypeStatistics(UnusedAccessTypeStatisticsT&& value) {
    ...
    m_unusedAccessTypeStatistics = std::forward<UnusedAccessTypeStatisticsT>(value);
  }
  template <typename UnusedAccessTypeStatisticsT = Aws::Vector<UnusedAccessTypeStatistics>>
  UnusedAccessFindingsStatistics& WithUnusedAccessTypeStatistics(UnusedAccessTypeStatisticsT&& value) {
    SetUnusedAccessTypeStatistics(std::forward<UnusedAccessTypeStatisticsT>(value));
    return *this;
  }
  ...
  UnusedAccessFindingsStatistics& AddUnusedAccessTypeStatistics(UnusedAccessTypeStatisticsT&& value) {
    m_unusedAccessTypeStatisticsHasBeenSet = true;
    m_unusedAccessTypeStatistics.emplace_back(std::forward<UnusedAccessTypeStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTopAccounts(TopAccountsT&& value) {
    ...
    m_topAccounts = std::forward<TopAccountsT>(value);
  }
  template <typename TopAccountsT = Aws::Vector<FindingAggregationAccountDetails>>
  UnusedAccessFindingsStatistics& WithTopAccounts(TopAccountsT&& value) {
    SetTopAccounts(std::forward<TopAccountsT>(value));
    return *this;
  }
  ...
  UnusedAccessFindingsStatistics& AddTopAccounts(TopAccountsT&& value) {
    m_topAccountsHasBeenSet = true;
    m_topAccounts.emplace_back(std::forward<TopAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalActiveFindings(int value) {
    m_totalActiveFindingsHasBeenSet = true;
    m_totalActiveFindings = value;
  }
  inline UnusedAccessFindingsStatistics& WithTotalActiveFindings(int value) {
    SetTotalActiveFindings(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalArchivedFindings(int value) {
    m_totalArchivedFindingsHasBeenSet = true;
    m_totalArchivedFindings = value;
  }
  inline UnusedAccessFindingsStatistics& WithTotalArchivedFindings(int value) {
    SetTotalArchivedFindings(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalResolvedFindings(int value) {
    m_totalResolvedFindingsHasBeenSet = true;
    m_totalResolvedFindings = value;
  }
  inline UnusedAccessFindingsStatistics& WithTotalResolvedFindings(int value) {
    SetTotalResolvedFindings(value);
    return *this;
  }
  ///@}
 private:
