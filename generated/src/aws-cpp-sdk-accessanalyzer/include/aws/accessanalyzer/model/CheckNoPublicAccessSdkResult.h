...
class CheckNoPublicAccessSdkResult {
 public:
  ...
  inline void SetResult(CheckNoPublicAccessResult value) {
    m_resultHasBeenSet = true;
    m_result = value;
  }
  inline CheckNoPublicAccessSdkResult& WithResult(CheckNoPublicAccessResult value) {
    SetResult(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  CheckNoPublicAccessSdkResult& WithMessage(MessageT&& value) {
  ...
  template <typename ReasonsT = Aws::Vector<ReasonSummary>>
  CheckNoPublicAccessSdkResult& WithReasons(ReasonsT&& value) {
    SetReasons(std::forward<ReasonsT>(value));
    return *this;
  }
  template <typename ReasonsT = ReasonSummary>
  CheckNoPublicAccessSdkResult& AddReasons(ReasonsT&& value) {
    m_reasonsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CheckNoPublicAccessSdkResult& WithRequestId(RequestIdT&& value) {
