...
class UpdateFindingsRequest : public AccessAnalyzerRequest {
 public:
  ...
  inline void SetStatus(FindingStatusUpdate value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateFindingsRequest& WithStatus(FindingStatusUpdate value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  UpdateFindingsRequest& AddIds(IdsT&& value) {
    m_idsHasBeenSet = true;
