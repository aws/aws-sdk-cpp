...
class KmsKeyConfiguration {
 public:
  ...
  void SetKeyPolicies(KeyPoliciesT&& value) {
    ...
    m_keyPolicies = std::forward<KeyPoliciesT>(value);
  }
  template <typename KeyPoliciesT = Aws::Map<Aws::String, Aws::String>>
  KmsKeyConfiguration& WithKeyPolicies(KeyPoliciesT&& value) {
    SetKeyPolicies(std::forward<KeyPoliciesT>(value));
    return *this;
  }
  ...
  KmsKeyConfiguration& AddKeyPolicies(KeyPoliciesKeyT&& key, KeyPoliciesValueT&& value) {
    m_keyPoliciesHasBeenSet = true;
    m_keyPolicies.emplace(std::forward<KeyPoliciesKeyT>(key), std::forward<KeyPoliciesValueT>(value));
    return *this;
  }
  ///@}
