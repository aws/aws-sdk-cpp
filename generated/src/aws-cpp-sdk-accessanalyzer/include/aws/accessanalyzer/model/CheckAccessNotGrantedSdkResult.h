...
class CheckAccessNotGrantedSdkResult {
 public:
  ...
  inline void SetResult(CheckAccessNotGrantedResult value) {
    m_resultHasBeenSet = true;
    m_result = value;
  }
  inline CheckAccessNotGrantedSdkResult& WithResult(CheckAccessNotGrantedResult value) {
    SetResult(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  CheckAccessNotGrantedSdkResult& WithMessage(MessageT&& value) {
  ...
  template <typename ReasonsT = Aws::Vector<ReasonSummary>>
  CheckAccessNotGrantedSdkResult& WithReasons(ReasonsT&& value) {
    SetReasons(std::forward<ReasonsT>(value));
    return *this;
  }
  template <typename ReasonsT = ReasonSummary>
  CheckAccessNotGrantedSdkResult& AddReasons(ReasonsT&& value) {
    m_reasonsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CheckAccessNotGrantedSdkResult& WithRequestId(RequestIdT&& value) {
