...
class GeneratedPolicyProperties {
 public:
  ...
  inline GeneratedPolicyProperties& WithIsComplete(bool value) {
    SetIsComplete(value);
    return *this;
  }
  ///@}
  ...
  template <typename PrincipalArnT = Aws::String>
  GeneratedPolicyProperties& WithPrincipalArn(PrincipalArnT&& value) {
  ...
  void SetCloudTrailProperties(CloudTrailPropertiesT&& value) {
    m_cloudTrailPropertiesHasBeenSet = true;
    m_cloudTrailProperties = std::forward<CloudTrailPropertiesT>(value);
  }
  template <typename CloudTrailPropertiesT = CloudTrailProperties>
  GeneratedPolicyProperties& WithCloudTrailProperties(CloudTrailPropertiesT&& value) {
    SetCloudTrailProperties(std::forward<CloudTrailPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
