...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/TagResourceRequest">AWS
   * API Reference</a></p>
   */
  class TagResourceRequest : public AccessAnalyzerRequest
  {
  public:
    AWS_ACCESSANALYZER_API TagResourceRequest() = default;
