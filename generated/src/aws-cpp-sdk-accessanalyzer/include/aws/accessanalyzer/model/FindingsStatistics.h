...
class FindingsStatistics {
 public:
  ...
  void SetExternalAccessFindingsStatistics(ExternalAccessFindingsStatisticsT&& value) {
    ...
    m_externalAccessFindingsStatistics = std::forward<ExternalAccessFindingsStatisticsT>(value);
  }
  template <typename ExternalAccessFindingsStatisticsT = ExternalAccessFindingsStatistics>
  FindingsStatistics& WithExternalAccessFindingsStatistics(ExternalAccessFindingsStatisticsT&& value) {
    SetExternalAccessFindingsStatistics(std::forward<ExternalAccessFindingsStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInternalAccessFindingsStatistics(InternalAccessFindingsStatisticsT&& value) {
    ...
    m_internalAccessFindingsStatistics = std::forward<InternalAccessFindingsStatisticsT>(value);
  }
  template <typename InternalAccessFindingsStatisticsT = InternalAccessFindingsStatistics>
  FindingsStatistics& WithInternalAccessFindingsStatistics(InternalAccessFindingsStatisticsT&& value) {
    SetInternalAccessFindingsStatistics(std::forward<InternalAccessFindingsStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnusedAccessFindingsStatistics(UnusedAccessFindingsStatisticsT&& value) {
    ...
    m_unusedAccessFindingsStatistics = std::forward<UnusedAccessFindingsStatisticsT>(value);
  }
  template <typename UnusedAccessFindingsStatisticsT = UnusedAccessFindingsStatistics>
  FindingsStatistics& WithUnusedAccessFindingsStatistics(UnusedAccessFindingsStatisticsT&& value) {
    SetUnusedAccessFindingsStatistics(std::forward<UnusedAccessFindingsStatisticsT>(value));
    return *this;
  }
  ///@}
 private:
