...
class GetAccessPreviewResult {
 public:
  ...
  void SetAccessPreview(AccessPreviewT&& value) {
    m_accessPreviewHasBeenSet = true;
    m_accessPreview = std::forward<AccessPreviewT>(value);
  }
  template <typename AccessPreviewT = AccessPreview>
  GetAccessPreviewResult& WithAccessPreview(AccessPreviewT&& value) {
    SetAccessPreview(std::forward<AccessPreviewT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAccessPreviewResult& WithRequestId(RequestIdT&& value) {
