...
class GetAccessPreviewRequest : public AccessAnalyzerRequest {
 public:
  ...
  void SetAccessPreviewId(AccessPreviewIdT&& value) {
    m_accessPreviewIdHasBeenSet = true;
    m_accessPreviewId = std::forward<AccessPreviewIdT>(value);
  }
  template <typename AccessPreviewIdT = Aws::String>
  GetAccessPreviewRequest& WithAccessPreviewId(AccessPreviewIdT&& value) {
    SetAccessPreviewId(std::forward<AccessPreviewIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AnalyzerArnT = Aws::String>
  GetAccessPreviewRequest& WithAnalyzerArn(AnalyzerArnT&& value) {
