...
class ListAccessPreviewFindingsRequest : public AccessAnalyzerRequest {
 public:
  ...
  template <typename AccessPreviewIdT = Aws::String>
  ListAccessPreviewFindingsRequest& WithAccessPreviewId(AccessPreviewIdT&& value) {
  ...
  template <typename AnalyzerArnT = Aws::String>
  ListAccessPreviewFindingsRequest& WithAnalyzerArn(AnalyzerArnT&& value) {
  ...
  template <typename FilterT = Aws::Map<Aws::String, Criterion>>
  ListAccessPreviewFindingsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessPreviewFindingsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccessPreviewFindingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
