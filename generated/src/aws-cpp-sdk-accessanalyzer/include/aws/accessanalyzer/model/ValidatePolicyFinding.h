...
class ValidatePolicyFinding {
 public:
  ...
  void SetFindingDetails(FindingDetailsT&& value) {
    ...
    m_findingDetails = std::forward<FindingDetailsT>(value);
  }
  template <typename FindingDetailsT = Aws::String>
  ValidatePolicyFinding& WithFindingDetails(FindingDetailsT&& value) {
    SetFindingDetails(std::forward<FindingDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFindingType(ValidatePolicyFindingType value) {
    m_findingTypeHasBeenSet = true;
    m_findingType = value;
  }
  inline ValidatePolicyFinding& WithFindingType(ValidatePolicyFindingType value) {
  ...
  void SetLearnMoreLink(LearnMoreLinkT&& value) {
    ...
    m_learnMoreLink = std::forward<LearnMoreLinkT>(value);
  }
  template <typename LearnMoreLinkT = Aws::String>
  ValidatePolicyFinding& WithLearnMoreLink(LearnMoreLinkT&& value) {
    SetLearnMoreLink(std::forward<LearnMoreLinkT>(value));
    return *this;
  }
  ///@}
