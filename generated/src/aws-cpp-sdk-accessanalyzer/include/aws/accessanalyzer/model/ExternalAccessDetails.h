...
class ExternalAccessDetails {
 public:
  ...
  inline ExternalAccessDetails& WithIsPublic(bool value) {
    SetIsPublic(value);
    return *this;
  }
  ///@}
  ...
  inline ExternalAccessDetails& WithResourceControlPolicyRestriction(ResourceControlPolicyRestriction value) {
