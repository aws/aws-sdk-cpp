...
class AWS_ACCESSANALYZER_API AccessAnalyzerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  AccessAnalyzerClient(const Aws::AccessAnalyzer::AccessAnalyzerClientConfiguration& clientConfiguration =
  ...
  AccessAnalyzerClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<AccessAnalyzerEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::AccessAnalyzer::AccessAnalyzerClientConfiguration& clientConfiguration =
                           Aws::AccessAnalyzer::AccessAnalyzerClientConfiguration());
  ...
  /**
   * A Callable wrapper for ApplyArchiveRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ApplyArchiveRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ApplyArchiveRuleRequestT = Model::ApplyArchiveRuleRequest>
  void ApplyArchiveRuleAsync(const ApplyArchiveRuleRequestT& request, const ApplyArchiveRuleResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CancelPolicyGeneration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelPolicyGeneration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelPolicyGenerationRequestT = Model::CancelPolicyGenerationRequest>
  void CancelPolicyGenerationAsync(const CancelPolicyGenerationRequestT& request,
  ...
  /**
   * <p>Cancels an in-progress policy preview job. Jobs that are already completed,
   * failed, or canceled cannot be canceled.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/CancelPolicyPreviewJob">AWS
   * API Reference</a></p>
   */
  virtual Model::CancelPolicyPreviewJobOutcome CancelPolicyPreviewJob(const Model::CancelPolicyPreviewJobRequest& request) const;

  /**
   * A Callable wrapper for CancelPolicyPreviewJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CancelPolicyPreviewJobRequestT = Model::CancelPolicyPreviewJobRequest>
  Model::CancelPolicyPreviewJobOutcomeCallable CancelPolicyPreviewJobCallable(const CancelPolicyPreviewJobRequestT& request) const {
    return SubmitCallable(&AccessAnalyzerClient::CancelPolicyPreviewJob, request);
  }

  /**
   * An Async wrapper for CancelPolicyPreviewJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelPolicyPreviewJobRequestT = Model::CancelPolicyPreviewJobRequest>
  void CancelPolicyPreviewJobAsync(const CancelPolicyPreviewJobRequestT& request,
                                   const CancelPolicyPreviewJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&AccessAnalyzerClient::CancelPolicyPreviewJob, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CheckAccessNotGranted that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CheckAccessNotGranted that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CheckAccessNotGrantedRequestT = Model::CheckAccessNotGrantedRequest>
  void CheckAccessNotGrantedAsync(const CheckAccessNotGrantedRequestT& request, const CheckAccessNotGrantedResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CheckNoNewAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CheckNoNewAccess that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CheckNoNewAccessRequestT = Model::CheckNoNewAccessRequest>
  void CheckNoNewAccessAsync(const CheckNoNewAccessRequestT& request, const CheckNoNewAccessResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CheckNoPublicAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CheckNoPublicAccess that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CheckNoPublicAccessRequestT = Model::CheckNoPublicAccessRequest>
  void CheckNoPublicAccessAsync(const CheckNoPublicAccessRequestT& request, const CheckNoPublicAccessResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAccessPreview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAccessPreview that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAccessPreviewRequestT = Model::CreateAccessPreviewRequest>
  void CreateAccessPreviewAsync(const CreateAccessPreviewRequestT& request, const CreateAccessPreviewResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAnalyzer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAnalyzerRequestT = Model::CreateAnalyzerRequest>
  void CreateAnalyzerAsync(const CreateAnalyzerRequestT& request, const CreateAnalyzerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateArchiveRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateArchiveRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateArchiveRuleRequestT = Model::CreateArchiveRuleRequest>
  void CreateArchiveRuleAsync(const CreateArchiveRuleRequestT& request, const CreateArchiveRuleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&AccessAnalyzerClient::CreateArchiveRule, request, handler, context);
  }

  /**
   * <p>Creates a policy preview configuration for your account. The configuration
   * enables IAM Access Analyzer to collect and store CloudTrail authorization events
   * needed for policy preview analysis.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/CreatePolicyPreviewConfiguration">AWS
   * API Reference</a></p>
   */
  virtual Model::CreatePolicyPreviewConfigurationOutcome CreatePolicyPreviewConfiguration(
      const Model::CreatePolicyPreviewConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for CreatePolicyPreviewConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreatePolicyPreviewConfigurationRequestT = Model::CreatePolicyPreviewConfigurationRequest>
  Model::CreatePolicyPreviewConfigurationOutcomeCallable CreatePolicyPreviewConfigurationCallable(
      const CreatePolicyPreviewConfigurationRequestT& request = {}) const {
    return SubmitCallable(&AccessAnalyzerClient::CreatePolicyPreviewConfiguration, request);
  }

  /**
   * An Async wrapper for CreatePolicyPreviewConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreatePolicyPreviewConfigurationRequestT = Model::CreatePolicyPreviewConfigurationRequest>
  void CreatePolicyPreviewConfigurationAsync(const CreatePolicyPreviewConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const CreatePolicyPreviewConfigurationRequestT& request = {}) const {
    return SubmitAsync(&AccessAnalyzerClient::CreatePolicyPreviewConfiguration, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for DeleteAnalyzer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAnalyzerRequestT = Model::DeleteAnalyzerRequest>
  void DeleteAnalyzerAsync(const DeleteAnalyzerRequestT& request, const DeleteAnalyzerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteArchiveRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteArchiveRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteArchiveRuleRequestT = Model::DeleteArchiveRuleRequest>
  void DeleteArchiveRuleAsync(const DeleteArchiveRuleRequestT& request, const DeleteArchiveRuleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&AccessAnalyzerClient::DeleteArchiveRule, request, handler, context);
  }

  /**
   * <p>Deletes the policy preview configuration for your account. After deletion,
   * IAM Access Analyzer will stop collecting CloudTrail authorization events for
   * policy preview analysis.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/DeletePolicyPreviewConfiguration">AWS
   * API Reference</a></p>
   */
  virtual Model::DeletePolicyPreviewConfigurationOutcome DeletePolicyPreviewConfiguration(
      const Model::DeletePolicyPreviewConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DeletePolicyPreviewConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeletePolicyPreviewConfigurationRequestT = Model::DeletePolicyPreviewConfigurationRequest>
  Model::DeletePolicyPreviewConfigurationOutcomeCallable DeletePolicyPreviewConfigurationCallable(
      const DeletePolicyPreviewConfigurationRequestT& request = {}) const {
    return SubmitCallable(&AccessAnalyzerClient::DeletePolicyPreviewConfiguration, request);
  }

  /**
   * An Async wrapper for DeletePolicyPreviewConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeletePolicyPreviewConfigurationRequestT = Model::DeletePolicyPreviewConfigurationRequest>
  void DeletePolicyPreviewConfigurationAsync(const DeletePolicyPreviewConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const DeletePolicyPreviewConfigurationRequestT& request = {}) const {
    return SubmitAsync(&AccessAnalyzerClient::DeletePolicyPreviewConfiguration, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::GenerateFindingRecommendationOutcome GenerateFindingRecommendation(
      const Model::GenerateFindingRecommendationRequest& request) const;

  /**
   * A Callable wrapper for GenerateFindingRecommendation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GenerateFindingRecommendationRequestT = Model::GenerateFindingRecommendationRequest>
  Model::GenerateFindingRecommendationOutcomeCallable GenerateFindingRecommendationCallable(
      const GenerateFindingRecommendationRequestT& request) const {
    return SubmitCallable(&AccessAnalyzerClient::GenerateFindingRecommendation, request);
  }

  /**
   * An Async wrapper for GenerateFindingRecommendation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GenerateFindingRecommendationRequestT = Model::GenerateFindingRecommendationRequest>
  void GenerateFindingRecommendationAsync(const GenerateFindingRecommendationRequestT& request,
                                          const GenerateFindingRecommendationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAccessPreview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccessPreview that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAccessPreviewRequestT = Model::GetAccessPreviewRequest>
  void GetAccessPreviewAsync(const GetAccessPreviewRequestT& request, const GetAccessPreviewResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAnalyzedResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAnalyzedResource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAnalyzedResourceRequestT = Model::GetAnalyzedResourceRequest>
  void GetAnalyzedResourceAsync(const GetAnalyzedResourceRequestT& request, const GetAnalyzedResourceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAnalyzer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAnalyzerRequestT = Model::GetAnalyzerRequest>
  void GetAnalyzerAsync(const GetAnalyzerRequestT& request, const GetAnalyzerResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetArchiveRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetArchiveRuleRequestT = Model::GetArchiveRuleRequest>
  void GetArchiveRuleAsync(const GetArchiveRuleRequestT& request, const GetArchiveRuleResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetFinding that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFindingRequestT = Model::GetFindingRequest>
  void GetFindingAsync(const GetFindingRequestT& request, const GetFindingResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFindingRecommendation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFindingRecommendation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFindingRecommendationRequestT = Model::GetFindingRecommendationRequest>
  void GetFindingRecommendationAsync(const GetFindingRecommendationRequestT& request,
                                     const GetFindingRecommendationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetFindingV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFindingV2RequestT = Model::GetFindingV2Request>
  void GetFindingV2Async(const GetFindingV2RequestT& request, const GetFindingV2ResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFindingsStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFindingsStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFindingsStatisticsRequestT = Model::GetFindingsStatisticsRequest>
  void GetFindingsStatisticsAsync(const GetFindingsStatisticsRequestT& request, const GetFindingsStatisticsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetGeneratedPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetGeneratedPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetGeneratedPolicyRequestT = Model::GetGeneratedPolicyRequest>
  void GetGeneratedPolicyAsync(const GetGeneratedPolicyRequestT& request, const GetGeneratedPolicyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&AccessAnalyzerClient::GetGeneratedPolicy, request, handler, context);
  }

  /**
   * <p>Retrieves the policy preview configuration for your account.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/GetPolicyPreviewConfiguration">AWS
   * API Reference</a></p>
   */
  virtual Model::GetPolicyPreviewConfigurationOutcome GetPolicyPreviewConfiguration(
      const Model::GetPolicyPreviewConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetPolicyPreviewConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPolicyPreviewConfigurationRequestT = Model::GetPolicyPreviewConfigurationRequest>
  Model::GetPolicyPreviewConfigurationOutcomeCallable GetPolicyPreviewConfigurationCallable(
      const GetPolicyPreviewConfigurationRequestT& request = {}) const {
    return SubmitCallable(&AccessAnalyzerClient::GetPolicyPreviewConfiguration, request);
  }

  /**
   * An Async wrapper for GetPolicyPreviewConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPolicyPreviewConfigurationRequestT = Model::GetPolicyPreviewConfigurationRequest>
  void GetPolicyPreviewConfigurationAsync(const GetPolicyPreviewConfigurationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const GetPolicyPreviewConfigurationRequestT& request = {}) const {
    return SubmitAsync(&AccessAnalyzerClient::GetPolicyPreviewConfiguration, request, handler, context);
  }

  /**
   * <p>Retrieves the metadata, parameters, and status for a policy preview job. Use
   * this operation to monitor job progress and retrieve the Amazon S3 location of
   * the completed analysis report.</p>  <p>Job data has a time-to-live (TTL)
   * of 14 days and will be deleted after expiration.</p> <p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/GetPolicyPreviewJob">AWS
   * API Reference</a></p>
   */
  virtual Model::GetPolicyPreviewJobOutcome GetPolicyPreviewJob(const Model::GetPolicyPreviewJobRequest& request) const;

  /**
   * A Callable wrapper for GetPolicyPreviewJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetPolicyPreviewJobRequestT = Model::GetPolicyPreviewJobRequest>
  Model::GetPolicyPreviewJobOutcomeCallable GetPolicyPreviewJobCallable(const GetPolicyPreviewJobRequestT& request) const {
    return SubmitCallable(&AccessAnalyzerClient::GetPolicyPreviewJob, request);
  }

  /**
   * An Async wrapper for GetPolicyPreviewJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPolicyPreviewJobRequestT = Model::GetPolicyPreviewJobRequest>
  void GetPolicyPreviewJobAsync(const GetPolicyPreviewJobRequestT& request, const GetPolicyPreviewJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&AccessAnalyzerClient::GetPolicyPreviewJob, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListAccessPreviewFindings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListAccessPreviewFindingsRequestT = Model::ListAccessPreviewFindingsRequest>
  Model::ListAccessPreviewFindingsOutcomeCallable ListAccessPreviewFindingsCallable(
      const ListAccessPreviewFindingsRequestT& request) const {
    return SubmitCallable(&AccessAnalyzerClient::ListAccessPreviewFindings, request);
  }

  /**
   * An Async wrapper for ListAccessPreviewFindings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAccessPreviewFindingsRequestT = Model::ListAccessPreviewFindingsRequest>
  void ListAccessPreviewFindingsAsync(const ListAccessPreviewFindingsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListAccessPreviews that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccessPreviews that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAccessPreviewsRequestT = Model::ListAccessPreviewsRequest>
  void ListAccessPreviewsAsync(const ListAccessPreviewsRequestT& request, const ListAccessPreviewsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAnalyzedResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAnalyzedResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnalyzedResourcesRequestT = Model::ListAnalyzedResourcesRequest>
  void ListAnalyzedResourcesAsync(const ListAnalyzedResourcesRequestT& request, const ListAnalyzedResourcesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAnalyzers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAnalyzersRequestT = Model::ListAnalyzersRequest>
  void ListAnalyzersAsync(const ListAnalyzersResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListAnalyzersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListArchiveRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListArchiveRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListArchiveRulesRequestT = Model::ListArchiveRulesRequest>
  void ListArchiveRulesAsync(const ListArchiveRulesRequestT& request, const ListArchiveRulesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListFindingsV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFindingsV2RequestT = Model::ListFindingsV2Request>
  void ListFindingsV2Async(const ListFindingsV2RequestT& request, const ListFindingsV2ResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListPolicyGenerationsRequestT = Model::ListPolicyGenerationsRequest>
  void ListPolicyGenerationsAsync(const ListPolicyGenerationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListPolicyGenerationsRequestT& request = {}) const {
    return SubmitAsync(&AccessAnalyzerClient::ListPolicyGenerations, request, handler, context);
  }

  /**
   * <p>Lists all policy preview jobs with optional filtering by job status or target
   * ID. Results are paginated for efficient retrieval of large result
   * sets.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/ListPolicyPreviewJobs">AWS
   * API Reference</a></p>
   */
  virtual Model::ListPolicyPreviewJobsOutcome ListPolicyPreviewJobs(const Model::ListPolicyPreviewJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListPolicyPreviewJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListPolicyPreviewJobsRequestT = Model::ListPolicyPreviewJobsRequest>
  Model::ListPolicyPreviewJobsOutcomeCallable ListPolicyPreviewJobsCallable(const ListPolicyPreviewJobsRequestT& request = {}) const {
    return SubmitCallable(&AccessAnalyzerClient::ListPolicyPreviewJobs, request);
  }

  /**
   * An Async wrapper for ListPolicyPreviewJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPolicyPreviewJobsRequestT = Model::ListPolicyPreviewJobsRequest>
  void ListPolicyPreviewJobsAsync(const ListPolicyPreviewJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListPolicyPreviewJobsRequestT& request = {}) const {
    return SubmitAsync(&AccessAnalyzerClient::ListPolicyPreviewJobs, request, handler, context);
  }
  ...
  /**
   * <p>Creates a policy preview analysis job to evaluate the impact of Service
   * Control Policies (SCPs) before deployment. The analysis uses historical
   * CloudTrail authorization events to identify potential access denials, helping
   * you prevent service disruptions.</p> <p>The job analyzes CloudTrail events
   * within a specified time window and generates a report identifying which events
   * would be denied by the proposed policy. The report is stored in the specified
   * Amazon S3 location.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/StartPolicyPreviewJob">AWS
   * API Reference</a></p>
   */
  virtual Model::StartPolicyPreviewJobOutcome StartPolicyPreviewJob(const Model::StartPolicyPreviewJobRequest& request) const;

  /**
   * A Callable wrapper for StartPolicyPreviewJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartPolicyPreviewJobRequestT = Model::StartPolicyPreviewJobRequest>
  Model::StartPolicyPreviewJobOutcomeCallable StartPolicyPreviewJobCallable(const StartPolicyPreviewJobRequestT& request) const {
    return SubmitCallable(&AccessAnalyzerClient::StartPolicyPreviewJob, request);
  }

  /**
   * An Async wrapper for StartPolicyPreviewJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartPolicyPreviewJobRequestT = Model::StartPolicyPreviewJobRequest>
  void StartPolicyPreviewJobAsync(const StartPolicyPreviewJobRequestT& request, const StartPolicyPreviewJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&AccessAnalyzerClient::StartPolicyPreviewJob, request, handler, context);
  }
   ...
   */
  template <typename StartResourceScanRequestT = Model::StartResourceScanRequest>
  void StartResourceScanAsync(const StartResourceScanRequestT& request, const StartResourceScanResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateAnalyzer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAnalyzerRequestT = Model::UpdateAnalyzerRequest>
  void UpdateAnalyzerAsync(const UpdateAnalyzerRequestT& request, const UpdateAnalyzerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateArchiveRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateArchiveRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateArchiveRuleRequestT = Model::UpdateArchiveRuleRequest>
  void UpdateArchiveRuleAsync(const UpdateArchiveRuleRequestT& request, const UpdateArchiveRuleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ValidatePolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ValidatePolicyRequestT = Model::ValidatePolicyRequest>
  void ValidatePolicyAsync(const ValidatePolicyRequestT& request, const ValidatePolicyResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
