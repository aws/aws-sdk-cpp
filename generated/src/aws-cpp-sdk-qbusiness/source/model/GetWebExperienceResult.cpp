...
GetWebExperienceResult::GetWebExperienceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetWebExperienceResult& GetWebExperienceResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("samplePromptsControlMode")) {
    m_samplePromptsControlMode = WebExperienceSamplePromptsControlModeMapper::GetWebExperienceSamplePromptsControlModeForName(
        jsonValue.GetString("samplePromptsControlMode"));
