...
StringAttributeBoostingConfiguration::StringAttributeBoostingConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
StringAttributeBoostingConfiguration& StringAttributeBoostingConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("attributeValueBoosting")) {
    ...
    for (auto& attributeValueBoostingItem : attributeValueBoostingJsonMap) {
      m_attributeValueBoosting[attributeValueBoostingItem.first] =
          StringAttributeValueBoostingLevelMapper::GetStringAttributeValueBoostingLevelForName(
              attributeValueBoostingItem.second.AsString());
    }
...
JsonValue StringAttributeBoostingConfiguration::Jsonize() const {
  ...
  if (m_attributeValueBoostingHasBeenSet) {
    ...
    for (auto& attributeValueBoostingItem : m_attributeValueBoosting) {
      attributeValueBoostingJsonMap.WithString(
          attributeValueBoostingItem.first,
          StringAttributeValueBoostingLevelMapper::GetNameForStringAttributeValueBoostingLevel(attributeValueBoostingItem.second));
    }
