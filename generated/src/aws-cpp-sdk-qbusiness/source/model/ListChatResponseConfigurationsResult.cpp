...
ListChatResponseConfigurationsResult& ListChatResponseConfigurationsResult::operator=(
  ...
  if (jsonValue.ValueExists("chatResponseConfigurations")) {
    ...
    for (unsigned chatResponseConfigurationsIndex = 0; chatResponseConfigurationsIndex < chatResponseConfigurationsJsonList.GetLength();
         ++chatResponseConfigurationsIndex) {
