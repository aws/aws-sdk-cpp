...
AppliedAttachmentsConfiguration::AppliedAttachmentsConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
AppliedAttachmentsConfiguration& AppliedAttachmentsConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("attachmentsControlMode")) {
    m_attachmentsControlMode =
        AttachmentsControlModeMapper::GetAttachmentsControlModeForName(jsonValue.GetString("attachmentsControlMode"));
