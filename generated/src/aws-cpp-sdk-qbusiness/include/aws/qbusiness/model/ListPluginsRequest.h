...
namespace Model
{
  ...
  /**
   */
  class ListPluginsRequest : public QBusinessRequest
  {
  public:
    AWS_QBUSINESS_API ListPluginsRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    ListPluginsRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
