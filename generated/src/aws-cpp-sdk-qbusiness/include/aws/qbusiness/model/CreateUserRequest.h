...
class CreateUserRequest : public QBusinessRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateUserRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename UserAliasesT = Aws::Vector<UserAlias>>
  CreateUserRequest& WithUserAliases(UserAliasesT&& value) {
    SetUserAliases(std::forward<UserAliasesT>(value));
    return *this;
  }
  template <typename UserAliasesT = UserAlias>
  CreateUserRequest& AddUserAliases(UserAliasesT&& value) {
    m_userAliasesHasBeenSet = true;
