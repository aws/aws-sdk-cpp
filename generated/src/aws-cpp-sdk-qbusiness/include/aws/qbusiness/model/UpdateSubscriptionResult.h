...
class UpdateSubscriptionResult {
 public:
  ...
  template <typename SubscriptionArnT = Aws::String>
  UpdateSubscriptionResult& WithSubscriptionArn(SubscriptionArnT&& value) {
  ...
  template <typename CurrentSubscriptionT = SubscriptionDetails>
  UpdateSubscriptionResult& WithCurrentSubscription(CurrentSubscriptionT&& value) {
  ...
  template <typename NextSubscriptionT = SubscriptionDetails>
  UpdateSubscriptionResult& WithNextSubscription(NextSubscriptionT&& value) {
