...
class AudioSourceDetails {
 public:
  ...
  inline AudioSourceDetails& WithStartTimeMilliseconds(long long value) {
  ...
  inline AudioSourceDetails& WithEndTimeMilliseconds(long long value) {
  ...
  inline void SetAudioExtractionType(AudioExtractionType value) {
    m_audioExtractionTypeHasBeenSet = true;
    m_audioExtractionType = value;
  }
  inline AudioSourceDetails& WithAudioExtractionType(AudioExtractionType value) {
    SetAudioExtractionType(value);
    return *this;
  }
  ///@}
 private:
