...
class DocumentEnrichmentConfiguration {
 public:
  ...
  void SetInlineConfigurations(InlineConfigurationsT&& value) {
    ...
    m_inlineConfigurations = std::forward<InlineConfigurationsT>(value);
  }
  template <typename InlineConfigurationsT = Aws::Vector<InlineDocumentEnrichmentConfiguration>>
  DocumentEnrichmentConfiguration& WithInlineConfigurations(InlineConfigurationsT&& value) {
    SetInlineConfigurations(std::forward<InlineConfigurationsT>(value));
    return *this;
  }
  ...
  DocumentEnrichmentConfiguration& AddInlineConfigurations(InlineConfigurationsT&& value) {
    m_inlineConfigurationsHasBeenSet = true;
    m_inlineConfigurations.emplace_back(std::forward<InlineConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreExtractionHookConfiguration(PreExtractionHookConfigurationT&& value) {
    ...
    m_preExtractionHookConfiguration = std::forward<PreExtractionHookConfigurationT>(value);
  }
  template <typename PreExtractionHookConfigurationT = HookConfiguration>
  DocumentEnrichmentConfiguration& WithPreExtractionHookConfiguration(PreExtractionHookConfigurationT&& value) {
    SetPreExtractionHookConfiguration(std::forward<PreExtractionHookConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostExtractionHookConfiguration(PostExtractionHookConfigurationT&& value) {
    ...
    m_postExtractionHookConfiguration = std::forward<PostExtractionHookConfigurationT>(value);
  }
  template <typename PostExtractionHookConfigurationT = HookConfiguration>
  DocumentEnrichmentConfiguration& WithPostExtractionHookConfiguration(PostExtractionHookConfigurationT&& value) {
    SetPostExtractionHookConfiguration(std::forward<PostExtractionHookConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
