...
namespace Model
{
  ...
  {
  public:
    AWS_QBUSINESS_API UpdateRetrieverResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateRetrieverResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
