...
class CreateWebExperienceResult {
 public:
  ...
  template <typename WebExperienceIdT = Aws::String>
  CreateWebExperienceResult& WithWebExperienceId(WebExperienceIdT&& value) {
  ...
  template <typename WebExperienceArnT = Aws::String>
  CreateWebExperienceResult& WithWebExperienceArn(WebExperienceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateWebExperienceResult& WithRequestId(RequestIdT&& value) {
