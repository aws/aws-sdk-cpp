...
class CreateSubscriptionRequest : public QBusinessRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateSubscriptionRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename PrincipalT = SubscriptionPrincipal>
  CreateSubscriptionRequest& WithPrincipal(PrincipalT&& value) {
  ...
  inline void SetType(SubscriptionType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CreateSubscriptionRequest& WithType(SubscriptionType value) {
    SetType(value);
    return *this;
  }
  ///@}
