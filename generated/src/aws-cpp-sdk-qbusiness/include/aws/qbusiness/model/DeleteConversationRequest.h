...
class DeleteConversationRequest : public QBusinessRequest {
 public:
  ...
  template <typename ConversationIdT = Aws::String>
  DeleteConversationRequest& WithConversationId(ConversationIdT&& value) {
  ...
  template <typename ApplicationIdT = Aws::String>
  DeleteConversationRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  DeleteConversationRequest& WithUserId(UserIdT&& value) {
