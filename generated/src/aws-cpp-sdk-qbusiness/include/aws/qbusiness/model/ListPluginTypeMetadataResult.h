...
class ListPluginTypeMetadataResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPluginTypeMetadataResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<PluginTypeMetadataSummary>>
  ListPluginTypeMetadataResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = PluginTypeMetadataSummary>
  ListPluginTypeMetadataResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListPluginTypeMetadataResult& WithRequestId(RequestIdT&& value) {
