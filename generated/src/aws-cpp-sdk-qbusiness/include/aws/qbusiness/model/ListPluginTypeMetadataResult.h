...
namespace Model
{
  ...
  {
  public:
    AWS_QBUSINESS_API ListPluginTypeMetadataResult() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListPluginTypeMetadataResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ItemsT = Aws::Vector<PluginTypeMetadataSummary>>
    void SetItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<PluginTypeMetadataSummary>>
    ListPluginTypeMetadataResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = PluginTypeMetadataSummary>
    ListPluginTypeMetadataResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListPluginTypeMetadataResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
