...
namespace Model
{
  ...
  {
  public:
    AWS_QBUSINESS_API ListTagsForResourceResult() = default;
    AWS_QBUSINESS_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_QBUSINESS_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);


    ///@{
    /**
     * <p>A list of tags associated with the Amazon Q Business application or data
     * source.</p>
     */
