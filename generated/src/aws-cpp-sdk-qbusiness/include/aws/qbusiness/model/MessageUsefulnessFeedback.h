...
class MessageUsefulnessFeedback {
 public:
  ...
  inline void SetUsefulness(MessageUsefulness value) {
    m_usefulnessHasBeenSet = true;
    m_usefulness = value;
  }
  inline MessageUsefulnessFeedback& WithUsefulness(MessageUsefulness value) {
    SetUsefulness(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReason(MessageUsefulnessReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline MessageUsefulnessFeedback& WithReason(MessageUsefulnessReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
