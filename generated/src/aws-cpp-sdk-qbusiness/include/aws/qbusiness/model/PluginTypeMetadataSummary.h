...
class PluginTypeMetadataSummary {
 public:
  ...
  inline PluginTypeMetadataSummary& WithType(PluginType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCategory(PluginTypeCategory value) {
    m_categoryHasBeenSet = true;
    m_category = value;
  }
  inline PluginTypeMetadataSummary& WithCategory(PluginTypeCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  PluginTypeMetadataSummary& WithDescription(DescriptionT&& value) {
