...
class SamlConfiguration {
 public:
  ...
  void SetMetadataXML(MetadataXMLT&& value) {
    ...
    m_metadataXML = std::forward<MetadataXMLT>(value);
  }
  template <typename MetadataXMLT = Aws::String>
  SamlConfiguration& WithMetadataXML(MetadataXMLT&& value) {
    SetMetadataXML(std::forward<MetadataXMLT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserIdAttribute(UserIdAttributeT&& value) {
    ...
    m_userIdAttribute = std::forward<UserIdAttributeT>(value);
  }
  template <typename UserIdAttributeT = Aws::String>
  SamlConfiguration& WithUserIdAttribute(UserIdAttributeT&& value) {
    SetUserIdAttribute(std::forward<UserIdAttributeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserGroupAttribute(UserGroupAttributeT&& value) {
    ...
    m_userGroupAttribute = std::forward<UserGroupAttributeT>(value);
  }
  template <typename UserGroupAttributeT = Aws::String>
  SamlConfiguration& WithUserGroupAttribute(UserGroupAttributeT&& value) {
    SetUserGroupAttribute(std::forward<UserGroupAttributeT>(value));
    return *this;
  }
  ///@}
 private:
