...
class StringAttributeBoostingConfiguration {
 public:
  ...
  inline StringAttributeBoostingConfiguration& WithBoostingLevel(DocumentAttributeBoostingLevel value) {
   ...
   */
  inline const Aws::Map<Aws::String, StringAttributeValueBoostingLevel>& GetAttributeValueBoosting() const {
    return m_attributeValueBoosting;
  }
  ...
  void SetAttributeValueBoosting(AttributeValueBoostingT&& value) {
    ...
    m_attributeValueBoosting = std::forward<AttributeValueBoostingT>(value);
  }
  template <typename AttributeValueBoostingT = Aws::Map<Aws::String, StringAttributeValueBoostingLevel>>
  StringAttributeBoostingConfiguration& WithAttributeValueBoosting(AttributeValueBoostingT&& value) {
    SetAttributeValueBoosting(std::forward<AttributeValueBoostingT>(value));
    return *this;
  }
  inline StringAttributeBoostingConfiguration& AddAttributeValueBoosting(Aws::String key, StringAttributeValueBoostingLevel value) {
    m_attributeValueBoostingHasBeenSet = true;
    m_attributeValueBoosting.emplace(key, value);
    return *this;
  }
  ///@}
 private:
