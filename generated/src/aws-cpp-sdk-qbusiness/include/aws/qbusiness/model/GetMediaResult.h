...
class GetMediaResult {
 public:
  ...
  void SetMediaBytes(MediaBytesT&& value) {
    m_mediaBytesHasBeenSet = true;
    m_mediaBytes = std::forward<MediaBytesT>(value);
  }
  template <typename MediaBytesT = Aws::Utils::ByteBuffer>
  GetMediaResult& WithMediaBytes(MediaBytesT&& value) {
    SetMediaBytes(std::forward<MediaBytesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MediaMimeTypeT = Aws::String>
  GetMediaResult& WithMediaMimeType(MediaMimeTypeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetMediaResult& WithRequestId(RequestIdT&& value) {
