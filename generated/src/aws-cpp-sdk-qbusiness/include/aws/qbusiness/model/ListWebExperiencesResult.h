...
class ListWebExperiencesResult {
 public:
  ...
  void SetWebExperiences(WebExperiencesT&& value) {
    m_webExperiencesHasBeenSet = true;
    m_webExperiences = std::forward<WebExperiencesT>(value);
  }
  template <typename WebExperiencesT = Aws::Vector<WebExperience>>
  ListWebExperiencesResult& WithWebExperiences(WebExperiencesT&& value) {
    SetWebExperiences(std::forward<WebExperiencesT>(value));
    return *this;
  }
  template <typename WebExperiencesT = WebExperience>
  ListWebExperiencesResult& AddWebExperiences(WebExperiencesT&& value) {
    m_webExperiencesHasBeenSet = true;
    m_webExperiences.emplace_back(std::forward<WebExperiencesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWebExperiencesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWebExperiencesResult& WithRequestId(RequestIdT&& value) {
