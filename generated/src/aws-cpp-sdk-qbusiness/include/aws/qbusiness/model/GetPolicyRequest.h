...
namespace Model
{
  ...
  {
  public:
    AWS_QBUSINESS_API GetPolicyRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    GetPolicyRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
  private:
