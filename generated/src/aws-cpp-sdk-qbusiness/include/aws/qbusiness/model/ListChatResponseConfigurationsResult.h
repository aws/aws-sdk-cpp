...
class ListChatResponseConfigurationsResult {
 public:
  ...
  void SetChatResponseConfigurations(ChatResponseConfigurationsT&& value) {
    m_chatResponseConfigurationsHasBeenSet = true;
    m_chatResponseConfigurations = std::forward<ChatResponseConfigurationsT>(value);
  }
  template <typename ChatResponseConfigurationsT = Aws::Vector<ChatResponseConfiguration>>
  ListChatResponseConfigurationsResult& WithChatResponseConfigurations(ChatResponseConfigurationsT&& value) {
    SetChatResponseConfigurations(std::forward<ChatResponseConfigurationsT>(value));
    return *this;
  }
  template <typename ChatResponseConfigurationsT = ChatResponseConfiguration>
  ListChatResponseConfigurationsResult& AddChatResponseConfigurations(ChatResponseConfigurationsT&& value) {
    m_chatResponseConfigurationsHasBeenSet = true;
    m_chatResponseConfigurations.emplace_back(std::forward<ChatResponseConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChatResponseConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListChatResponseConfigurationsResult& WithRequestId(RequestIdT&& value) {
