...
class ActionSummary {
 public:
  ...
  template <typename ActionIdentifierT = Aws::String>
  ActionSummary& WithActionIdentifier(ActionIdentifierT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  ActionSummary& WithDisplayName(DisplayNameT&& value) {
  ...
  void SetInstructionExample(InstructionExampleT&& value) {
    m_instructionExampleHasBeenSet = true;
    m_instructionExample = std::forward<InstructionExampleT>(value);
  }
  template <typename InstructionExampleT = Aws::String>
  ActionSummary& WithInstructionExample(InstructionExampleT&& value) {
    SetInstructionExample(std::forward<InstructionExampleT>(value));
    return *this;
  }
  ///@}
