...
class DocumentAttributeConfiguration {
 public:
  ...
  inline void SetType(AttributeType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DocumentAttributeConfiguration& WithType(AttributeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSearch(Status value) {
    m_searchHasBeenSet = true;
    m_search = value;
  }
  inline DocumentAttributeConfiguration& WithSearch(Status value) {
    SetSearch(value);
    return *this;
  }
  ///@}
