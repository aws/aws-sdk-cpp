...
class CreateAnonymousWebExperienceUrlRequest : public QBusinessRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateAnonymousWebExperienceUrlRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename WebExperienceIdT = Aws::String>
  CreateAnonymousWebExperienceUrlRequest& WithWebExperienceId(WebExperienceIdT&& value) {
  ...
  inline void SetSessionDurationInMinutes(int value) {
    m_sessionDurationInMinutesHasBeenSet = true;
    m_sessionDurationInMinutes = value;
  }
  inline CreateAnonymousWebExperienceUrlRequest& WithSessionDurationInMinutes(int value) {
    SetSessionDurationInMinutes(value);
    return *this;
  }
  ///@}
 private:
