...
namespace Model
{
  ...
  {
  public:
    AWS_QBUSINESS_API ListSubscriptionsRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    ListSubscriptionsRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
