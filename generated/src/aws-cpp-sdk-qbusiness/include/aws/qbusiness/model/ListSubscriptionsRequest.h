...
namespace Model
{
  ...
  /**
   */
  class ListSubscriptionsRequest : public QBusinessRequest
  {
  public:
    AWS_QBUSINESS_API ListSubscriptionsRequest();
    ...
    ///@{
    /**
     * <p>The identifier of the Amazon Q Business application linked to the
     * subscription.</p>
     */
    ...
    inline ListSubscriptionsRequest& WithApplicationId(const Aws::String& value) { SetApplicationId(value); return *this;}
    inline ListSubscriptionsRequest& WithApplicationId(Aws::String&& value) { SetApplicationId(std::move(value)); return *this;}
    inline ListSubscriptionsRequest& WithApplicationId(const char* value) { SetApplicationId(value); return *this;}
    ///@}
