...
class Rule {
 public:
  ...
  void SetIncludedUsersAndGroups(IncludedUsersAndGroupsT&& value) {
    ...
    m_includedUsersAndGroups = std::forward<IncludedUsersAndGroupsT>(value);
  }
  template <typename IncludedUsersAndGroupsT = UsersAndGroups>
  Rule& WithIncludedUsersAndGroups(IncludedUsersAndGroupsT&& value) {
    SetIncludedUsersAndGroups(std::forward<IncludedUsersAndGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludedUsersAndGroups(ExcludedUsersAndGroupsT&& value) {
    ...
    m_excludedUsersAndGroups = std::forward<ExcludedUsersAndGroupsT>(value);
  }
  template <typename ExcludedUsersAndGroupsT = UsersAndGroups>
  Rule& WithExcludedUsersAndGroups(ExcludedUsersAndGroupsT&& value) {
    SetExcludedUsersAndGroups(std::forward<ExcludedUsersAndGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Rule& WithRuleType(RuleType value) {
    SetRuleType(value);
    return *this;
  }
  ///@}
  ...
  void SetRuleConfiguration(RuleConfigurationT&& value) {
    ...
    m_ruleConfiguration = std::forward<RuleConfigurationT>(value);
  }
  template <typename RuleConfigurationT = RuleConfiguration>
  Rule& WithRuleConfiguration(RuleConfigurationT&& value) {
    SetRuleConfiguration(std::forward<RuleConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
