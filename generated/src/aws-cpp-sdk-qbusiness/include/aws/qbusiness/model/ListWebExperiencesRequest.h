...
class ListWebExperiencesRequest : public QBusinessRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  ListWebExperiencesRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListWebExperiencesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWebExperiencesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
