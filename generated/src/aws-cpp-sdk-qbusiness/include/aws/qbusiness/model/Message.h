...
class Message {
 public:
  ...
  inline Message& WithType(MessageType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceAttribution(SourceAttributionT&& value) {
    ...
    m_sourceAttribution = std::forward<SourceAttributionT>(value);
  }
  template <typename SourceAttributionT = Aws::Vector<SourceAttribution>>
  Message& WithSourceAttribution(SourceAttributionT&& value) {
    SetSourceAttribution(std::forward<SourceAttributionT>(value));
    return *this;
  }
  template <typename SourceAttributionT = SourceAttribution>
  Message& AddSourceAttribution(SourceAttributionT&& value) {
    m_sourceAttributionHasBeenSet = true;
    m_sourceAttribution.emplace_back(std::forward<SourceAttributionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActionReview(ActionReviewT&& value) {
    ...
    m_actionReview = std::forward<ActionReviewT>(value);
  }
  template <typename ActionReviewT = ActionReview>
  Message& WithActionReview(ActionReviewT&& value) {
    SetActionReview(std::forward<ActionReviewT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActionExecution(ActionExecutionT&& value) {
    ...
    m_actionExecution = std::forward<ActionExecutionT>(value);
  }
  template <typename ActionExecutionT = ActionExecution>
  Message& WithActionExecution(ActionExecutionT&& value) {
    SetActionExecution(std::forward<ActionExecutionT>(value));
    return *this;
  }
  ///@}
 private:
