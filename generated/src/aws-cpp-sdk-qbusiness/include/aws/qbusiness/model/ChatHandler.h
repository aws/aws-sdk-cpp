...
class ChatHandler : public Aws::Utils::Event::EventStreamHandler {
 ...
 public:
  ...
  inline void SetInitialResponseCallback(const ChatInitialResponseCallback& noArgCallback) {
    m_onInitialResponse = [noArgCallback](const ChatInitialResponse& rs, const Utils::Event::InitialResponseType) {
  ...
  inline void SetAuthChallengeRequestEventCallback(const AuthChallengeRequestEventCallback& callback) {
    m_onAuthChallengeRequestEvent = callback;
  }
