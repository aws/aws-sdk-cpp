...
class CreateSubscriptionResult {
 public:
  ...
  template <typename SubscriptionArnT = Aws::String>
  CreateSubscriptionResult& WithSubscriptionArn(SubscriptionArnT&& value) {
  ...
  template <typename CurrentSubscriptionT = SubscriptionDetails>
  CreateSubscriptionResult& WithCurrentSubscription(CurrentSubscriptionT&& value) {
  ...
  template <typename NextSubscriptionT = SubscriptionDetails>
  CreateSubscriptionResult& WithNextSubscription(NextSubscriptionT&& value) {
