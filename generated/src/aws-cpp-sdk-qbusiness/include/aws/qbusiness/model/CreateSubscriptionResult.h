...
namespace Model
{
  ...
  {
  public:
    AWS_QBUSINESS_API CreateSubscriptionResult() = default;
    ...
    template<typename SubscriptionIdT = Aws::String>
    CreateSubscriptionResult& WithSubscriptionId(SubscriptionIdT&& value) { SetSubscriptionId(std::forward<SubscriptionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SubscriptionArnT = Aws::String>
    CreateSubscriptionResult& WithSubscriptionArn(SubscriptionArnT&& value) { SetSubscriptionArn(std::forward<SubscriptionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CurrentSubscriptionT = SubscriptionDetails>
    CreateSubscriptionResult& WithCurrentSubscription(CurrentSubscriptionT&& value) { SetCurrentSubscription(std::forward<CurrentSubscriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename NextSubscriptionT = SubscriptionDetails>
    CreateSubscriptionResult& WithNextSubscription(NextSubscriptionT&& value) { SetNextSubscription(std::forward<NextSubscriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateSubscriptionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
