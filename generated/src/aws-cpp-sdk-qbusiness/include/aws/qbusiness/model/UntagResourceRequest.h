...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public QBusinessRequest
  {
  public:
    AWS_QBUSINESS_API UntagResourceRequest() = default;
     ...
     * source to remove the tag from.</p>
     */
    ...
    ///@{
    /**
     * <p>A list of tag keys to remove from the Amazon Q Business application or data
     * source. If a tag key does not exist on the resource, it is ignored.</p>
     */
