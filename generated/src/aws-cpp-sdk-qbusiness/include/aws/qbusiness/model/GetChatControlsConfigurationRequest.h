...
namespace Model
{
  ...
  {
  public:
    AWS_QBUSINESS_API GetChatControlsConfigurationRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    GetChatControlsConfigurationRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetChatControlsConfigurationRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
