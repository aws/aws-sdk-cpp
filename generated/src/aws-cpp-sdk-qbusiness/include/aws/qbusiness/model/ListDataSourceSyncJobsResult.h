...
class ListDataSourceSyncJobsResult {
 public:
  ...
  template <typename HistoryT = Aws::Vector<DataSourceSyncJob>>
  ListDataSourceSyncJobsResult& WithHistory(HistoryT&& value) {
    SetHistory(std::forward<HistoryT>(value));
    return *this;
  }
  template <typename HistoryT = DataSourceSyncJob>
  ListDataSourceSyncJobsResult& AddHistory(HistoryT&& value) {
    m_historyHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataSourceSyncJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataSourceSyncJobsResult& WithRequestId(RequestIdT&& value) {
