...
class DocumentAttributeBoostingConfiguration {
 public:
  ...
  void SetNumberConfiguration(NumberConfigurationT&& value) {
    ...
    m_numberConfiguration = std::forward<NumberConfigurationT>(value);
  }
  template <typename NumberConfigurationT = NumberAttributeBoostingConfiguration>
  DocumentAttributeBoostingConfiguration& WithNumberConfiguration(NumberConfigurationT&& value) {
    SetNumberConfiguration(std::forward<NumberConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStringConfiguration(StringConfigurationT&& value) {
    ...
    m_stringConfiguration = std::forward<StringConfigurationT>(value);
  }
  template <typename StringConfigurationT = StringAttributeBoostingConfiguration>
  DocumentAttributeBoostingConfiguration& WithStringConfiguration(StringConfigurationT&& value) {
    SetStringConfiguration(std::forward<StringConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateConfiguration(DateConfigurationT&& value) {
    ...
    m_dateConfiguration = std::forward<DateConfigurationT>(value);
  }
  template <typename DateConfigurationT = DateAttributeBoostingConfiguration>
  DocumentAttributeBoostingConfiguration& WithDateConfiguration(DateConfigurationT&& value) {
    SetDateConfiguration(std::forward<DateConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStringListConfiguration(StringListConfigurationT&& value) {
    ...
    m_stringListConfiguration = std::forward<StringListConfigurationT>(value);
  }
  template <typename StringListConfigurationT = StringListAttributeBoostingConfiguration>
  DocumentAttributeBoostingConfiguration& WithStringListConfiguration(StringListConfigurationT&& value) {
    SetStringListConfiguration(std::forward<StringListConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
