...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/qbusiness-2023-11-27/Tag">AWS API
   * Reference</a></p>
   */
  class Tag
  {
  public:
    AWS_QBUSINESS_API Tag() = default;
    AWS_QBUSINESS_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_QBUSINESS_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
