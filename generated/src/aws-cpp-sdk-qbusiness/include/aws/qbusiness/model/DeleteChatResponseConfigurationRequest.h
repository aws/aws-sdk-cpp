...
/**
 */
class DeleteChatResponseConfigurationRequest : public QBusinessRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DeleteChatResponseConfiguration"; }

  AWS_QBUSINESS_API Aws::String SerializePayload() const override;

  ///@{
  /**
   * <p>The unique identifier of theAmazon Q Business application from which to
   * delete the chat response configuration.</p>
   */
  ...
  ///@{
  /**
   * <p>The unique identifier of the chat response configuration to delete from the
