...
class RuleConfiguration {
 public:
  ...
  void SetContentBlockerRule(ContentBlockerRuleT&& value) {
    ...
    m_contentBlockerRule = std::forward<ContentBlockerRuleT>(value);
  }
  template <typename ContentBlockerRuleT = ContentBlockerRule>
  RuleConfiguration& WithContentBlockerRule(ContentBlockerRuleT&& value) {
    SetContentBlockerRule(std::forward<ContentBlockerRuleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContentRetrievalRule(ContentRetrievalRuleT&& value) {
    ...
    m_contentRetrievalRule = std::forward<ContentRetrievalRuleT>(value);
  }
  template <typename ContentRetrievalRuleT = ContentRetrievalRule>
  RuleConfiguration& WithContentRetrievalRule(ContentRetrievalRuleT&& value) {
    SetContentRetrievalRule(std::forward<ContentRetrievalRuleT>(value));
    return *this;
  }
  ///@}
 private:
