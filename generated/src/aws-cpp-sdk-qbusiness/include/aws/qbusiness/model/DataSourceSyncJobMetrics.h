...
class DataSourceSyncJobMetrics {
 public:
  ...
  void SetDocumentsAdded(DocumentsAddedT&& value) {
    m_documentsAddedHasBeenSet = true;
    m_documentsAdded = std::forward<DocumentsAddedT>(value);
  }
  template <typename DocumentsAddedT = Aws::String>
  DataSourceSyncJobMetrics& WithDocumentsAdded(DocumentsAddedT&& value) {
    SetDocumentsAdded(std::forward<DocumentsAddedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDocumentsModified(DocumentsModifiedT&& value) {
    m_documentsModifiedHasBeenSet = true;
    m_documentsModified = std::forward<DocumentsModifiedT>(value);
  }
  template <typename DocumentsModifiedT = Aws::String>
  DataSourceSyncJobMetrics& WithDocumentsModified(DocumentsModifiedT&& value) {
    SetDocumentsModified(std::forward<DocumentsModifiedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDocumentsDeleted(DocumentsDeletedT&& value) {
    m_documentsDeletedHasBeenSet = true;
    m_documentsDeleted = std::forward<DocumentsDeletedT>(value);
  }
  template <typename DocumentsDeletedT = Aws::String>
  DataSourceSyncJobMetrics& WithDocumentsDeleted(DocumentsDeletedT&& value) {
    SetDocumentsDeleted(std::forward<DocumentsDeletedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDocumentsFailed(DocumentsFailedT&& value) {
    m_documentsFailedHasBeenSet = true;
    m_documentsFailed = std::forward<DocumentsFailedT>(value);
  }
  template <typename DocumentsFailedT = Aws::String>
  DataSourceSyncJobMetrics& WithDocumentsFailed(DocumentsFailedT&& value) {
    SetDocumentsFailed(std::forward<DocumentsFailedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDocumentsScanned(DocumentsScannedT&& value) {
    m_documentsScannedHasBeenSet = true;
    m_documentsScanned = std::forward<DocumentsScannedT>(value);
  }
  template <typename DocumentsScannedT = Aws::String>
  DataSourceSyncJobMetrics& WithDocumentsScanned(DocumentsScannedT&& value) {
    SetDocumentsScanned(std::forward<DocumentsScannedT>(value));
    return *this;
  }
  ///@}
 private:
