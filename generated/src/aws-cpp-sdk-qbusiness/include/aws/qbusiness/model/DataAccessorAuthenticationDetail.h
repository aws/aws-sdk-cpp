...
class DataAccessorAuthenticationDetail {
 public:
  ...
  inline void SetAuthenticationType(DataAccessorAuthenticationType value) {
    m_authenticationTypeHasBeenSet = true;
    m_authenticationType = value;
  }
  inline DataAccessorAuthenticationDetail& WithAuthenticationType(DataAccessorAuthenticationType value) {
