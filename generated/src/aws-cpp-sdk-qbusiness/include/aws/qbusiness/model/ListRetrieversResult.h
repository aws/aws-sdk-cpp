...
class ListRetrieversResult {
 public:
  ...
  template <typename RetrieversT = Aws::Vector<Retriever>>
  ListRetrieversResult& WithRetrievers(RetrieversT&& value) {
    SetRetrievers(std::forward<RetrieversT>(value));
    return *this;
  }
  template <typename RetrieversT = Retriever>
  ListRetrieversResult& AddRetrievers(RetrieversT&& value) {
    m_retrieversHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRetrieversResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRetrieversResult& WithRequestId(RequestIdT&& value) {
