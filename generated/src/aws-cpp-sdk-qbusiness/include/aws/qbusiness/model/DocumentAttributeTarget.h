...
class DocumentAttributeTarget {
 public:
  ...
  inline void SetAttributeValueOperator(AttributeValueOperator value) {
    m_attributeValueOperatorHasBeenSet = true;
    m_attributeValueOperator = value;
  }
  inline DocumentAttributeTarget& WithAttributeValueOperator(AttributeValueOperator value) {
    SetAttributeValueOperator(value);
    return *this;
  }
  ///@}
 private:
