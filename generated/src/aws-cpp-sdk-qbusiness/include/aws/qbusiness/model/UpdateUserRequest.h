...
class UpdateUserRequest : public QBusinessRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  UpdateUserRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetUserAliasesToUpdate(UserAliasesToUpdateT&& value) {
    m_userAliasesToUpdateHasBeenSet = true;
    m_userAliasesToUpdate = std::forward<UserAliasesToUpdateT>(value);
  }
  template <typename UserAliasesToUpdateT = Aws::Vector<UserAlias>>
  UpdateUserRequest& WithUserAliasesToUpdate(UserAliasesToUpdateT&& value) {
    SetUserAliasesToUpdate(std::forward<UserAliasesToUpdateT>(value));
    return *this;
  }
  template <typename UserAliasesToUpdateT = UserAlias>
  UpdateUserRequest& AddUserAliasesToUpdate(UserAliasesToUpdateT&& value) {
    m_userAliasesToUpdateHasBeenSet = true;
    m_userAliasesToUpdate.emplace_back(std::forward<UserAliasesToUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserAliasesToDelete(UserAliasesToDeleteT&& value) {
    m_userAliasesToDeleteHasBeenSet = true;
    m_userAliasesToDelete = std::forward<UserAliasesToDeleteT>(value);
  }
  template <typename UserAliasesToDeleteT = Aws::Vector<UserAlias>>
  UpdateUserRequest& WithUserAliasesToDelete(UserAliasesToDeleteT&& value) {
    SetUserAliasesToDelete(std::forward<UserAliasesToDeleteT>(value));
    return *this;
  }
  template <typename UserAliasesToDeleteT = UserAlias>
  UpdateUserRequest& AddUserAliasesToDelete(UserAliasesToDeleteT&& value) {
    m_userAliasesToDeleteHasBeenSet = true;
    m_userAliasesToDelete.emplace_back(std::forward<UserAliasesToDeleteT>(value));
    return *this;
  }
  ///@}
 private:
