...
class ScoreAttributes {
 public:
  ...
  inline void SetScoreConfidence(ScoreConfidence value) {
    m_scoreConfidenceHasBeenSet = true;
    m_scoreConfidence = value;
  }
  inline ScoreAttributes& WithScoreConfidence(ScoreConfidence value) {
    SetScoreConfidence(value);
    return *this;
  }
  ///@}
 private:
