...
class UpdateChatControlsConfigurationRequest : public QBusinessRequest {
 public:
  ...
  inline void SetResponseScope(ResponseScope value) {
    m_responseScopeHasBeenSet = true;
    m_responseScope = value;
  }
  inline UpdateChatControlsConfigurationRequest& WithResponseScope(ResponseScope value) {
    SetResponseScope(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const BlockedPhrasesConfigurationUpdate& GetBlockedPhrasesConfigurationUpdate() const {
    return m_blockedPhrasesConfigurationUpdate;
  }
  ...
  void SetBlockedPhrasesConfigurationUpdate(BlockedPhrasesConfigurationUpdateT&& value) {
    m_blockedPhrasesConfigurationUpdateHasBeenSet = true;
    m_blockedPhrasesConfigurationUpdate = std::forward<BlockedPhrasesConfigurationUpdateT>(value);
  }
  template <typename BlockedPhrasesConfigurationUpdateT = BlockedPhrasesConfigurationUpdate>
  UpdateChatControlsConfigurationRequest& WithBlockedPhrasesConfigurationUpdate(BlockedPhrasesConfigurationUpdateT&& value) {
    SetBlockedPhrasesConfigurationUpdate(std::forward<BlockedPhrasesConfigurationUpdateT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<TopicConfiguration>& GetTopicConfigurationsToCreateOrUpdate() const {
    return m_topicConfigurationsToCreateOrUpdate;
  }
  ...
  void SetTopicConfigurationsToCreateOrUpdate(TopicConfigurationsToCreateOrUpdateT&& value) {
    m_topicConfigurationsToCreateOrUpdateHasBeenSet = true;
    m_topicConfigurationsToCreateOrUpdate = std::forward<TopicConfigurationsToCreateOrUpdateT>(value);
  }
  template <typename TopicConfigurationsToCreateOrUpdateT = Aws::Vector<TopicConfiguration>>
  UpdateChatControlsConfigurationRequest& WithTopicConfigurationsToCreateOrUpdate(TopicConfigurationsToCreateOrUpdateT&& value) {
    SetTopicConfigurationsToCreateOrUpdate(std::forward<TopicConfigurationsToCreateOrUpdateT>(value));
    return *this;
  }
  ...
  UpdateChatControlsConfigurationRequest& AddTopicConfigurationsToCreateOrUpdate(TopicConfigurationsToCreateOrUpdateT&& value) {
    m_topicConfigurationsToCreateOrUpdateHasBeenSet = true;
    m_topicConfigurationsToCreateOrUpdate.emplace_back(std::forward<TopicConfigurationsToCreateOrUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTopicConfigurationsToDelete(TopicConfigurationsToDeleteT&& value) {
    m_topicConfigurationsToDeleteHasBeenSet = true;
    m_topicConfigurationsToDelete = std::forward<TopicConfigurationsToDeleteT>(value);
  }
  template <typename TopicConfigurationsToDeleteT = Aws::Vector<TopicConfiguration>>
  UpdateChatControlsConfigurationRequest& WithTopicConfigurationsToDelete(TopicConfigurationsToDeleteT&& value) {
    SetTopicConfigurationsToDelete(std::forward<TopicConfigurationsToDeleteT>(value));
    return *this;
  }
  ...
  UpdateChatControlsConfigurationRequest& AddTopicConfigurationsToDelete(TopicConfigurationsToDeleteT&& value) {
    m_topicConfigurationsToDeleteHasBeenSet = true;
    m_topicConfigurationsToDelete.emplace_back(std::forward<TopicConfigurationsToDeleteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreatorModeConfiguration(CreatorModeConfigurationT&& value) {
    ...
    m_creatorModeConfiguration = std::forward<CreatorModeConfigurationT>(value);
  }
  template <typename CreatorModeConfigurationT = CreatorModeConfiguration>
  UpdateChatControlsConfigurationRequest& WithCreatorModeConfiguration(CreatorModeConfigurationT&& value) {
    SetCreatorModeConfiguration(std::forward<CreatorModeConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const HallucinationReductionConfiguration& GetHallucinationReductionConfiguration() const {
    return m_hallucinationReductionConfiguration;
  }
  ...
  void SetHallucinationReductionConfiguration(HallucinationReductionConfigurationT&& value) {
    ...
    m_hallucinationReductionConfiguration = std::forward<HallucinationReductionConfigurationT>(value);
  }
  template <typename HallucinationReductionConfigurationT = HallucinationReductionConfiguration>
  UpdateChatControlsConfigurationRequest& WithHallucinationReductionConfiguration(HallucinationReductionConfigurationT&& value) {
    SetHallucinationReductionConfiguration(std::forward<HallucinationReductionConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
