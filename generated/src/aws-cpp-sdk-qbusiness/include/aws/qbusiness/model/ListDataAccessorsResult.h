...
class ListDataAccessorsResult {
 public:
  ...
  void SetDataAccessors(DataAccessorsT&& value) {
    m_dataAccessorsHasBeenSet = true;
    m_dataAccessors = std::forward<DataAccessorsT>(value);
  }
  template <typename DataAccessorsT = Aws::Vector<DataAccessor>>
  ListDataAccessorsResult& WithDataAccessors(DataAccessorsT&& value) {
    SetDataAccessors(std::forward<DataAccessorsT>(value));
    return *this;
  }
  template <typename DataAccessorsT = DataAccessor>
  ListDataAccessorsResult& AddDataAccessors(DataAccessorsT&& value) {
    m_dataAccessorsHasBeenSet = true;
    m_dataAccessors.emplace_back(std::forward<DataAccessorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataAccessorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataAccessorsResult& WithRequestId(RequestIdT&& value) {
