...
class InlineDocumentEnrichmentConfiguration {
 public:
  ...
  inline void SetDocumentContentOperator(DocumentContentOperator value) {
    m_documentContentOperatorHasBeenSet = true;
    m_documentContentOperator = value;
  }
  inline InlineDocumentEnrichmentConfiguration& WithDocumentContentOperator(DocumentContentOperator value) {
    SetDocumentContentOperator(value);
    return *this;
  }
  ///@}
 private:
