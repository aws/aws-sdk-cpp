...
class UpdateUserResult {
 public:
  ...
  void SetUserAliasesAdded(UserAliasesAddedT&& value) {
    m_userAliasesAddedHasBeenSet = true;
    m_userAliasesAdded = std::forward<UserAliasesAddedT>(value);
  }
  template <typename UserAliasesAddedT = Aws::Vector<UserAlias>>
  UpdateUserResult& WithUserAliasesAdded(UserAliasesAddedT&& value) {
    SetUserAliasesAdded(std::forward<UserAliasesAddedT>(value));
    return *this;
  }
  template <typename UserAliasesAddedT = UserAlias>
  UpdateUserResult& AddUserAliasesAdded(UserAliasesAddedT&& value) {
    m_userAliasesAddedHasBeenSet = true;
    m_userAliasesAdded.emplace_back(std::forward<UserAliasesAddedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserAliasesUpdated(UserAliasesUpdatedT&& value) {
    m_userAliasesUpdatedHasBeenSet = true;
    m_userAliasesUpdated = std::forward<UserAliasesUpdatedT>(value);
  }
  template <typename UserAliasesUpdatedT = Aws::Vector<UserAlias>>
  UpdateUserResult& WithUserAliasesUpdated(UserAliasesUpdatedT&& value) {
    SetUserAliasesUpdated(std::forward<UserAliasesUpdatedT>(value));
    return *this;
  }
  template <typename UserAliasesUpdatedT = UserAlias>
  UpdateUserResult& AddUserAliasesUpdated(UserAliasesUpdatedT&& value) {
    m_userAliasesUpdatedHasBeenSet = true;
    m_userAliasesUpdated.emplace_back(std::forward<UserAliasesUpdatedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserAliasesDeleted(UserAliasesDeletedT&& value) {
    m_userAliasesDeletedHasBeenSet = true;
    m_userAliasesDeleted = std::forward<UserAliasesDeletedT>(value);
  }
  template <typename UserAliasesDeletedT = Aws::Vector<UserAlias>>
  UpdateUserResult& WithUserAliasesDeleted(UserAliasesDeletedT&& value) {
    SetUserAliasesDeleted(std::forward<UserAliasesDeletedT>(value));
    return *this;
  }
  template <typename UserAliasesDeletedT = UserAlias>
  UpdateUserResult& AddUserAliasesDeleted(UserAliasesDeletedT&& value) {
    m_userAliasesDeletedHasBeenSet = true;
    m_userAliasesDeleted.emplace_back(std::forward<UserAliasesDeletedT>(value));
    return *this;
  }
  ///@}
