...
class ChatSyncResult {
 public:
  ...
  void SetAuthChallengeRequest(AuthChallengeRequestT&& value) {
    ...
    m_authChallengeRequest = std::forward<AuthChallengeRequestT>(value);
  }
  template <typename AuthChallengeRequestT = AuthChallengeRequest>
  ChatSyncResult& WithAuthChallengeRequest(AuthChallengeRequestT&& value) {
    SetAuthChallengeRequest(std::forward<AuthChallengeRequestT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailedAttachments(FailedAttachmentsT&& value) {
    ...
    m_failedAttachments = std::forward<FailedAttachmentsT>(value);
  }
  template <typename FailedAttachmentsT = Aws::Vector<AttachmentOutput>>
  ChatSyncResult& WithFailedAttachments(FailedAttachmentsT&& value) {
    SetFailedAttachments(std::forward<FailedAttachmentsT>(value));
    return *this;
  }
  template <typename FailedAttachmentsT = AttachmentOutput>
  ChatSyncResult& AddFailedAttachments(FailedAttachmentsT&& value) {
    m_failedAttachmentsHasBeenSet = true;
    m_failedAttachments.emplace_back(std::forward<FailedAttachmentsT>(value));
    return *this;
  }
  ///@}
