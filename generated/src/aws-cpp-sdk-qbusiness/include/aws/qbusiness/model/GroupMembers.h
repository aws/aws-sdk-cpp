...
class GroupMembers {
 public:
  ...
  void SetMemberGroups(MemberGroupsT&& value) {
    ...
    m_memberGroups = std::forward<MemberGroupsT>(value);
  }
  template <typename MemberGroupsT = Aws::Vector<MemberGroup>>
  GroupMembers& WithMemberGroups(MemberGroupsT&& value) {
    SetMemberGroups(std::forward<MemberGroupsT>(value));
    return *this;
  }
  template <typename MemberGroupsT = MemberGroup>
  GroupMembers& AddMemberGroups(MemberGroupsT&& value) {
    m_memberGroupsHasBeenSet = true;
    m_memberGroups.emplace_back(std::forward<MemberGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMemberUsers(MemberUsersT&& value) {
    ...
    m_memberUsers = std::forward<MemberUsersT>(value);
  }
  template <typename MemberUsersT = Aws::Vector<MemberUser>>
  GroupMembers& WithMemberUsers(MemberUsersT&& value) {
    SetMemberUsers(std::forward<MemberUsersT>(value));
    return *this;
  }
  template <typename MemberUsersT = MemberUser>
  GroupMembers& AddMemberUsers(MemberUsersT&& value) {
    m_memberUsersHasBeenSet = true;
    m_memberUsers.emplace_back(std::forward<MemberUsersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3PathForGroupMembers(S3PathForGroupMembersT&& value) {
    ...
    m_s3PathForGroupMembers = std::forward<S3PathForGroupMembersT>(value);
  }
  template <typename S3PathForGroupMembersT = S3>
  GroupMembers& WithS3PathForGroupMembers(S3PathForGroupMembersT&& value) {
    SetS3PathForGroupMembers(std::forward<S3PathForGroupMembersT>(value));
    return *this;
  }
  ///@}
 private:
