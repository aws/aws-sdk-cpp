...
class ListGroupsRequest : public QBusinessRequest {
 public:
  ...
  void SetUpdatedEarlierThan(UpdatedEarlierThanT&& value) {
    m_updatedEarlierThanHasBeenSet = true;
    m_updatedEarlierThan = std::forward<UpdatedEarlierThanT>(value);
  }
  template <typename UpdatedEarlierThanT = Aws::Utils::DateTime>
  ListGroupsRequest& WithUpdatedEarlierThan(UpdatedEarlierThanT&& value) {
    SetUpdatedEarlierThan(std::forward<UpdatedEarlierThanT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
