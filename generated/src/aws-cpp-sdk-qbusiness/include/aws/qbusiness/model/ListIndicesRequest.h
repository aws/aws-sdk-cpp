...
namespace Model
{
  ...
  {
  public:
    AWS_QBUSINESS_API ListIndicesRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    ListIndicesRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
