...
class NativeIndexConfiguration {
 public:
  ...
  inline NativeIndexConfiguration& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetBoostingOverride(BoostingOverrideT&& value) {
    ...
    m_boostingOverride = std::forward<BoostingOverrideT>(value);
  }
  template <typename BoostingOverrideT = Aws::Map<Aws::String, DocumentAttributeBoostingConfiguration>>
  NativeIndexConfiguration& WithBoostingOverride(BoostingOverrideT&& value) {
    SetBoostingOverride(std::forward<BoostingOverrideT>(value));
    return *this;
  }
  ...
  NativeIndexConfiguration& AddBoostingOverride(BoostingOverrideKeyT&& key, BoostingOverrideValueT&& value) {
    m_boostingOverrideHasBeenSet = true;
    m_boostingOverride.emplace(std::forward<BoostingOverrideKeyT>(key), std::forward<BoostingOverrideValueT>(value));
    return *this;
  }
  ///@}
 private:
