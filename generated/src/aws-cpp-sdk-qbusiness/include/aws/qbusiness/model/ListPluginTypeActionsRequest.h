...
class ListPluginTypeActionsRequest : public QBusinessRequest {
 public:
  ...
  inline ListPluginTypeActionsRequest& WithPluginType(PluginType value) {
    SetPluginType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPluginTypeActionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPluginTypeActionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
