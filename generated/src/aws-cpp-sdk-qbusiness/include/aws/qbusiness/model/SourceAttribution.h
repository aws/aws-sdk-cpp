...
class SourceAttribution {
 public:
  ...
  void SetSnippet(SnippetT&& value) {
    ...
    m_snippet = std::forward<SnippetT>(value);
  }
  template <typename SnippetT = Aws::String>
  SourceAttribution& WithSnippet(SnippetT&& value) {
    SetSnippet(std::forward<SnippetT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCitationNumber(int value) {
    m_citationNumberHasBeenSet = true;
    m_citationNumber = value;
  }
  inline SourceAttribution& WithCitationNumber(int value) {
  ...
  void SetTextMessageSegments(TextMessageSegmentsT&& value) {
    ...
    m_textMessageSegments = std::forward<TextMessageSegmentsT>(value);
  }
  template <typename TextMessageSegmentsT = Aws::Vector<TextSegment>>
  SourceAttribution& WithTextMessageSegments(TextMessageSegmentsT&& value) {
    SetTextMessageSegments(std::forward<TextMessageSegmentsT>(value));
    return *this;
  }
  template <typename TextMessageSegmentsT = TextSegment>
  SourceAttribution& AddTextMessageSegments(TextMessageSegmentsT&& value) {
    m_textMessageSegmentsHasBeenSet = true;
    m_textMessageSegments.emplace_back(std::forward<TextMessageSegmentsT>(value));
    return *this;
  }
  ///@}
