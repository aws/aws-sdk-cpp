...
class ContentRetrievalRule {
 public:
  ...
  void SetEligibleDataSources(EligibleDataSourcesT&& value) {
    ...
    m_eligibleDataSources = std::forward<EligibleDataSourcesT>(value);
  }
  template <typename EligibleDataSourcesT = Aws::Vector<EligibleDataSource>>
  ContentRetrievalRule& WithEligibleDataSources(EligibleDataSourcesT&& value) {
    SetEligibleDataSources(std::forward<EligibleDataSourcesT>(value));
    return *this;
  }
  ...
  ContentRetrievalRule& AddEligibleDataSources(EligibleDataSourcesT&& value) {
    m_eligibleDataSourcesHasBeenSet = true;
    m_eligibleDataSources.emplace_back(std::forward<EligibleDataSourcesT>(value));
    return *this;
  }
  ///@}
 private:
