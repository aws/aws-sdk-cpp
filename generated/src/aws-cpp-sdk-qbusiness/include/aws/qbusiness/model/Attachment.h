...
class Attachment {
 public:
  ...
  void SetFileType(FileTypeT&& value) {
    ...
    m_fileType = std::forward<FileTypeT>(value);
  }
  template <typename FileTypeT = Aws::String>
  Attachment& WithFileType(FileTypeT&& value) {
    SetFileType(std::forward<FileTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFileSize(int value) {
    m_fileSizeHasBeenSet = true;
    m_fileSize = value;
  }
  inline Attachment& WithFileSize(int value) {
    SetFileSize(value);
    return *this;
  }
  ///@}
  ...
  void SetMd5chksum(Md5chksumT&& value) {
    ...
    m_md5chksum = std::forward<Md5chksumT>(value);
  }
  template <typename Md5chksumT = Aws::String>
  Attachment& WithMd5chksum(Md5chksumT&& value) {
    SetMd5chksum(std::forward<Md5chksumT>(value));
    return *this;
  }
  ///@}
