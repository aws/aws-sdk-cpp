...
class PutFeedbackRequest : public QBusinessRequest {
 public:
  ...
  void SetMessageCopiedAt(MessageCopiedAtT&& value) {
    m_messageCopiedAtHasBeenSet = true;
    m_messageCopiedAt = std::forward<MessageCopiedAtT>(value);
  }
  template <typename MessageCopiedAtT = Aws::Utils::DateTime>
  PutFeedbackRequest& WithMessageCopiedAt(MessageCopiedAtT&& value) {
    SetMessageCopiedAt(std::forward<MessageCopiedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMessageUsefulness(MessageUsefulnessT&& value) {
    m_messageUsefulnessHasBeenSet = true;
    m_messageUsefulness = std::forward<MessageUsefulnessT>(value);
  }
  template <typename MessageUsefulnessT = MessageUsefulnessFeedback>
  PutFeedbackRequest& WithMessageUsefulness(MessageUsefulnessT&& value) {
    SetMessageUsefulness(std::forward<MessageUsefulnessT>(value));
    return *this;
  }
  ///@}
 private:
