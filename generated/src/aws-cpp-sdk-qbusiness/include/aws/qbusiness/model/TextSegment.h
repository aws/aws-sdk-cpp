...
class TextSegment {
 public:
  ...
  inline TextSegment& WithBeginOffset(int value) {
  ...
  inline TextSegment& WithEndOffset(int value) {
    SetEndOffset(value);
    return *this;
  }
  ///@}
  ...
  void SetSnippetExcerpt(SnippetExcerptT&& value) {
    ...
    m_snippetExcerpt = std::forward<SnippetExcerptT>(value);
  }
  template <typename SnippetExcerptT = SnippetExcerpt>
  TextSegment& WithSnippetExcerpt(SnippetExcerptT&& value) {
    SetSnippetExcerpt(std::forward<SnippetExcerptT>(value));
    return *this;
  }
  ///@}
