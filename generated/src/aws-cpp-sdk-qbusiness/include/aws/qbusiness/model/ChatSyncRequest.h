...
class ChatSyncRequest : public QBusinessRequest {
 public:
  ...
  void SetAuthChallengeResponse(AuthChallengeResponseT&& value) {
    m_authChallengeResponseHasBeenSet = true;
    m_authChallengeResponse = std::forward<AuthChallengeResponseT>(value);
  }
  template <typename AuthChallengeResponseT = AuthChallengeResponse>
  ChatSyncRequest& WithAuthChallengeResponse(AuthChallengeResponseT&& value) {
    SetAuthChallengeResponse(std::forward<AuthChallengeResponseT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetChatMode(ChatMode value) {
    m_chatModeHasBeenSet = true;
    m_chatMode = value;
  }
  inline ChatSyncRequest& WithChatMode(ChatMode value) {
    SetChatMode(value);
    return *this;
  }
  ///@}
  ...
  void SetChatModeConfiguration(ChatModeConfigurationT&& value) {
    ...
    m_chatModeConfiguration = std::forward<ChatModeConfigurationT>(value);
  }
  template <typename ChatModeConfigurationT = ChatModeConfiguration>
  ChatSyncRequest& WithChatModeConfiguration(ChatModeConfigurationT&& value) {
    SetChatModeConfiguration(std::forward<ChatModeConfigurationT>(value));
    return *this;
  }
  ///@}
