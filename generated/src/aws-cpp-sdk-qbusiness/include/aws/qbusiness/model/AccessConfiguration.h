...
class AccessConfiguration {
 public:
  ...
  void SetAccessControls(AccessControlsT&& value) {
    m_accessControlsHasBeenSet = true;
    m_accessControls = std::forward<AccessControlsT>(value);
  }
  template <typename AccessControlsT = Aws::Vector<AccessControl>>
  AccessConfiguration& WithAccessControls(AccessControlsT&& value) {
    SetAccessControls(std::forward<AccessControlsT>(value));
    return *this;
  }
  template <typename AccessControlsT = AccessControl>
  AccessConfiguration& AddAccessControls(AccessControlsT&& value) {
    m_accessControlsHasBeenSet = true;
    m_accessControls.emplace_back(std::forward<AccessControlsT>(value));
    return *this;
  }
  ///@}
  ...
  inline AccessConfiguration& WithMemberRelation(MemberRelation value) {
