...
class SourceDetails {
 public:
  ...
  void SetImageSourceDetails(ImageSourceDetailsT&& value) {
    ...
    m_imageSourceDetails = std::forward<ImageSourceDetailsT>(value);
  }
  template <typename ImageSourceDetailsT = ImageSourceDetails>
  SourceDetails& WithImageSourceDetails(ImageSourceDetailsT&& value) {
    SetImageSourceDetails(std::forward<ImageSourceDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAudioSourceDetails(AudioSourceDetailsT&& value) {
    ...
    m_audioSourceDetails = std::forward<AudioSourceDetailsT>(value);
  }
  template <typename AudioSourceDetailsT = AudioSourceDetails>
  SourceDetails& WithAudioSourceDetails(AudioSourceDetailsT&& value) {
    SetAudioSourceDetails(std::forward<AudioSourceDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVideoSourceDetails(VideoSourceDetailsT&& value) {
    ...
    m_videoSourceDetails = std::forward<VideoSourceDetailsT>(value);
  }
  template <typename VideoSourceDetailsT = VideoSourceDetails>
  SourceDetails& WithVideoSourceDetails(VideoSourceDetailsT&& value) {
    SetVideoSourceDetails(std::forward<VideoSourceDetailsT>(value));
    return *this;
  }
  ///@}
 private:
