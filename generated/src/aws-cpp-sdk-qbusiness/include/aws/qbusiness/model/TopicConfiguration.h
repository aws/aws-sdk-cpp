...
class TopicConfiguration {
 public:
  ...
  void SetExampleChatMessages(ExampleChatMessagesT&& value) {
    ...
    m_exampleChatMessages = std::forward<ExampleChatMessagesT>(value);
  }
  template <typename ExampleChatMessagesT = Aws::Vector<Aws::String>>
  TopicConfiguration& WithExampleChatMessages(ExampleChatMessagesT&& value) {
    SetExampleChatMessages(std::forward<ExampleChatMessagesT>(value));
    return *this;
  }
  template <typename ExampleChatMessagesT = Aws::String>
  TopicConfiguration& AddExampleChatMessages(ExampleChatMessagesT&& value) {
    m_exampleChatMessagesHasBeenSet = true;
    m_exampleChatMessages.emplace_back(std::forward<ExampleChatMessagesT>(value));
    return *this;
  }
  ///@}
