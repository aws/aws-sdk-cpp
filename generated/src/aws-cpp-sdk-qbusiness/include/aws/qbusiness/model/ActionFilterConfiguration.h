...
class ActionFilterConfiguration {
 public:
  ...
  void SetDocumentAttributeFilter(DocumentAttributeFilterT&& value) {
    m_documentAttributeFilterHasBeenSet = true;
    m_documentAttributeFilter = std::forward<DocumentAttributeFilterT>(value);
  }
  template <typename DocumentAttributeFilterT = AttributeFilter>
  ActionFilterConfiguration& WithDocumentAttributeFilter(DocumentAttributeFilterT&& value) {
    SetDocumentAttributeFilter(std::forward<DocumentAttributeFilterT>(value));
    return *this;
  }
  ///@}
 private:
