...
class NumberAttributeBoostingConfiguration {
 public:
  ...
  inline NumberAttributeBoostingConfiguration& WithBoostingLevel(DocumentAttributeBoostingLevel value) {
  ...
  inline void SetBoostingType(NumberAttributeBoostingType value) {
    m_boostingTypeHasBeenSet = true;
    m_boostingType = value;
  }
  inline NumberAttributeBoostingConfiguration& WithBoostingType(NumberAttributeBoostingType value) {
