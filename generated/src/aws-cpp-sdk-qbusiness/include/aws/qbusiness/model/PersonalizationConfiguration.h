...
class PersonalizationConfiguration {
 public:
  ...
  inline void SetPersonalizationControlMode(PersonalizationControlMode value) {
    m_personalizationControlModeHasBeenSet = true;
    m_personalizationControlMode = value;
  }
  inline PersonalizationConfiguration& WithPersonalizationControlMode(PersonalizationControlMode value) {
    SetPersonalizationControlMode(value);
    return *this;
  }
  ///@}
 private:
