...
class CustomPluginConfiguration {
 public:
  ...
  inline void SetApiSchemaType(APISchemaType value) {
    m_apiSchemaTypeHasBeenSet = true;
    m_apiSchemaType = value;
  }
  inline CustomPluginConfiguration& WithApiSchemaType(APISchemaType value) {
    SetApiSchemaType(value);
    return *this;
  }
  ///@}
