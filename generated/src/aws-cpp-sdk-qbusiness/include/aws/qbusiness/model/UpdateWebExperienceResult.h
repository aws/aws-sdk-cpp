...
namespace Model
{
  ...
  {
  public:
    AWS_QBUSINESS_API UpdateWebExperienceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateWebExperienceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
