...
class BatchDeleteDocumentResult {
 public:
  ...
  void SetFailedDocuments(FailedDocumentsT&& value) {
    ...
    m_failedDocuments = std::forward<FailedDocumentsT>(value);
  }
  template <typename FailedDocumentsT = Aws::Vector<FailedDocument>>
  BatchDeleteDocumentResult& WithFailedDocuments(FailedDocumentsT&& value) {
    SetFailedDocuments(std::forward<FailedDocumentsT>(value));
    return *this;
  }
  template <typename FailedDocumentsT = FailedDocument>
  BatchDeleteDocumentResult& AddFailedDocuments(FailedDocumentsT&& value) {
    m_failedDocumentsHasBeenSet = true;
    m_failedDocuments.emplace_back(std::forward<FailedDocumentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteDocumentResult& WithRequestId(RequestIdT&& value) {
