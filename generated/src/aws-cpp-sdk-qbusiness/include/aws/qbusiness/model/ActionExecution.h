...
class ActionExecution {
 public:
  ...
  template <typename PluginIdT = Aws::String>
  ActionExecution& WithPluginId(PluginIdT&& value) {
  ...
  template <typename PayloadT = Aws::Map<Aws::String, ActionExecutionPayloadField>>
  ActionExecution& WithPayload(PayloadT&& value) {
  ...
  template <typename PayloadFieldNameSeparatorT = Aws::String>
  ActionExecution& WithPayloadFieldNameSeparator(PayloadFieldNameSeparatorT&& value) {
