...
class OpenIDConnectProviderConfiguration {
 public:
  ...
  void SetSecretsArn(SecretsArnT&& value) {
    m_secretsArnHasBeenSet = true;
    m_secretsArn = std::forward<SecretsArnT>(value);
  }
  template <typename SecretsArnT = Aws::String>
  OpenIDConnectProviderConfiguration& WithSecretsArn(SecretsArnT&& value) {
    SetSecretsArn(std::forward<SecretsArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecretsRole(SecretsRoleT&& value) {
    m_secretsRoleHasBeenSet = true;
    m_secretsRole = std::forward<SecretsRoleT>(value);
  }
  template <typename SecretsRoleT = Aws::String>
  OpenIDConnectProviderConfiguration& WithSecretsRole(SecretsRoleT&& value) {
    SetSecretsRole(std::forward<SecretsRoleT>(value));
    return *this;
  }
  ///@}
 private:
