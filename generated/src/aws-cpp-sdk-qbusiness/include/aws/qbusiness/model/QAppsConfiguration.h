...
class QAppsConfiguration {
 public:
  ...
  inline void SetQAppsControlMode(QAppsControlMode value) {
    m_qAppsControlModeHasBeenSet = true;
    m_qAppsControlMode = value;
  }
  inline QAppsConfiguration& WithQAppsControlMode(QAppsControlMode value) {
    SetQAppsControlMode(value);
    return *this;
  }
  ///@}
 private:
