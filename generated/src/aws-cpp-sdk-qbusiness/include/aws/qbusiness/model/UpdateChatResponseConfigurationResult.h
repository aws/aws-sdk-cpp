...
namespace Model
{
  class UpdateChatResponseConfigurationResult
  {
  public:
    AWS_QBUSINESS_API UpdateChatResponseConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateChatResponseConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
