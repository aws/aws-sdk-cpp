...
class GetMediaRequest : public QBusinessRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  GetMediaRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ConversationIdT = Aws::String>
  GetMediaRequest& WithConversationId(ConversationIdT&& value) {
  ...
  template <typename MessageIdT = Aws::String>
  GetMediaRequest& WithMessageId(MessageIdT&& value) {
  ...
  template <typename MediaIdT = Aws::String>
  GetMediaRequest& WithMediaId(MediaIdT&& value) {
