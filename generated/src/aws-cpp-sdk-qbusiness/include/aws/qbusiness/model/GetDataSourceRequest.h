...
class GetDataSourceRequest : public QBusinessRequest {
 public:
  AWS_QBUSINESS_API GetDataSourceRequest() = default;
  ...
  template <typename ApplicationIdT = Aws::String>
  GetDataSourceRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename IndexIdT = Aws::String>
  GetDataSourceRequest& WithIndexId(IndexIdT&& value) {
