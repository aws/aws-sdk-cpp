...
class TextOutputEvent {
 public:
  ...
  inline void SetSystemMessageType(SystemMessageType value) {
    m_systemMessageTypeHasBeenSet = true;
    m_systemMessageType = value;
  }
  inline TextOutputEvent& WithSystemMessageType(SystemMessageType value) {
    SetSystemMessageType(value);
    return *this;
  }
  ///@}
  ...
  void SetSystemMessage(SystemMessageT&& value) {
    ...
    m_systemMessage = std::forward<SystemMessageT>(value);
  }
  template <typename SystemMessageT = Aws::String>
  TextOutputEvent& WithSystemMessage(SystemMessageT&& value) {
    SetSystemMessage(std::forward<SystemMessageT>(value));
    return *this;
  }
  ///@}
 private:
