...
class AutoSubscriptionConfiguration {
 public:
  ...
  inline void SetAutoSubscribe(AutoSubscriptionStatus value) {
    m_autoSubscribeHasBeenSet = true;
    m_autoSubscribe = value;
  }
  inline AutoSubscriptionConfiguration& WithAutoSubscribe(AutoSubscriptionStatus value) {
  ...
  inline void SetDefaultSubscriptionType(SubscriptionType value) {
    m_defaultSubscriptionTypeHasBeenSet = true;
    m_defaultSubscriptionType = value;
  }
  inline AutoSubscriptionConfiguration& WithDefaultSubscriptionType(SubscriptionType value) {
    SetDefaultSubscriptionType(value);
    return *this;
  }
  ///@}
 private:
