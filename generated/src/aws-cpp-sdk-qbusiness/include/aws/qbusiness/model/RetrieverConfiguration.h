...
class RetrieverConfiguration {
 public:
  ...
  void SetNativeIndexConfiguration(NativeIndexConfigurationT&& value) {
    ...
    m_nativeIndexConfiguration = std::forward<NativeIndexConfigurationT>(value);
  }
  template <typename NativeIndexConfigurationT = NativeIndexConfiguration>
  RetrieverConfiguration& WithNativeIndexConfiguration(NativeIndexConfigurationT&& value) {
    SetNativeIndexConfiguration(std::forward<NativeIndexConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKendraIndexConfiguration(KendraIndexConfigurationT&& value) {
    ...
    m_kendraIndexConfiguration = std::forward<KendraIndexConfigurationT>(value);
  }
  template <typename KendraIndexConfigurationT = KendraIndexConfiguration>
  RetrieverConfiguration& WithKendraIndexConfiguration(KendraIndexConfigurationT&& value) {
    SetKendraIndexConfiguration(std::forward<KendraIndexConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
