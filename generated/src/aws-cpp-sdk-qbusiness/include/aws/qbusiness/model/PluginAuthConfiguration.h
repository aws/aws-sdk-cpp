...
class PluginAuthConfiguration {
 public:
  ...
  void SetBasicAuthConfiguration(BasicAuthConfigurationT&& value) {
    ...
    m_basicAuthConfiguration = std::forward<BasicAuthConfigurationT>(value);
  }
  template <typename BasicAuthConfigurationT = BasicAuthConfiguration>
  PluginAuthConfiguration& WithBasicAuthConfiguration(BasicAuthConfigurationT&& value) {
    SetBasicAuthConfiguration(std::forward<BasicAuthConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const OAuth2ClientCredentialConfiguration& GetOAuth2ClientCredentialConfiguration() const {
    return m_oAuth2ClientCredentialConfiguration;
  }
  ...
  void SetOAuth2ClientCredentialConfiguration(OAuth2ClientCredentialConfigurationT&& value) {
    ...
    m_oAuth2ClientCredentialConfiguration = std::forward<OAuth2ClientCredentialConfigurationT>(value);
  }
  template <typename OAuth2ClientCredentialConfigurationT = OAuth2ClientCredentialConfiguration>
  PluginAuthConfiguration& WithOAuth2ClientCredentialConfiguration(OAuth2ClientCredentialConfigurationT&& value) {
    SetOAuth2ClientCredentialConfiguration(std::forward<OAuth2ClientCredentialConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNoAuthConfiguration(NoAuthConfigurationT&& value) {
    ...
    m_noAuthConfiguration = std::forward<NoAuthConfigurationT>(value);
  }
  template <typename NoAuthConfigurationT = NoAuthConfiguration>
  PluginAuthConfiguration& WithNoAuthConfiguration(NoAuthConfigurationT&& value) {
    SetNoAuthConfiguration(std::forward<NoAuthConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdcAuthConfiguration(IdcAuthConfigurationT&& value) {
    ...
    m_idcAuthConfiguration = std::forward<IdcAuthConfigurationT>(value);
  }
  template <typename IdcAuthConfigurationT = IdcAuthConfiguration>
  PluginAuthConfiguration& WithIdcAuthConfiguration(IdcAuthConfigurationT&& value) {
    SetIdcAuthConfiguration(std::forward<IdcAuthConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
