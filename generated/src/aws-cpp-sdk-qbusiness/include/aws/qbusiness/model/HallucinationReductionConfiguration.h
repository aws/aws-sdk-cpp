...
class HallucinationReductionConfiguration {
 public:
  ...
  inline void SetHallucinationReductionControl(HallucinationReductionControl value) {
    m_hallucinationReductionControlHasBeenSet = true;
    m_hallucinationReductionControl = value;
  }
  inline HallucinationReductionConfiguration& WithHallucinationReductionControl(HallucinationReductionControl value) {
    SetHallucinationReductionControl(value);
    return *this;
  }
  ///@}
 private:
