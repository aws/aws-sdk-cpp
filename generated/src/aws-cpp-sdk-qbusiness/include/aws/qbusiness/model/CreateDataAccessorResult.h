...
class CreateDataAccessorResult {
 public:
  ...
  template <typename DataAccessorIdT = Aws::String>
  CreateDataAccessorResult& WithDataAccessorId(DataAccessorIdT&& value) {
  ...
  template <typename IdcApplicationArnT = Aws::String>
  CreateDataAccessorResult& WithIdcApplicationArn(IdcApplicationArnT&& value) {
  ...
  void SetDataAccessorArn(DataAccessorArnT&& value) {
    ...
    m_dataAccessorArn = std::forward<DataAccessorArnT>(value);
  }
  template <typename DataAccessorArnT = Aws::String>
  CreateDataAccessorResult& WithDataAccessorArn(DataAccessorArnT&& value) {
    SetDataAccessorArn(std::forward<DataAccessorArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateDataAccessorResult& WithRequestId(RequestIdT&& value) {
