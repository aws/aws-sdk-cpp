...
namespace QBusiness
{
  class AWS_QBUSINESS_API QBusinessRequest : public Aws::AmazonSerializableWebServiceRequest
  {
  public:
    using EndpointParameter = Aws::Endpoint::EndpointParameter;
    using EndpointParameters = Aws::Endpoint::EndpointParameters;

    virtual ~QBusinessRequest () {}
  ...
  typedef Aws::AmazonStreamingWebServiceRequest StreamingQBusinessRequest;
