...
class AWS_QBUSINESS_API QBusinessClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  QBusinessClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<QBusinessEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AssociatePermission that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociatePermission that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociatePermissionRequestT = Model::AssociatePermissionRequest>
  void AssociatePermissionAsync(const AssociatePermissionRequestT& request, const AssociatePermissionResponseReceivedHandler& handler,
   ...
   */
  virtual void ChatAsync(Model::ChatRequest& request, const ChatStreamReadyHandler& streamReadyHandler,
  ...
  /**
   * An Async wrapper for ChatSync that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ChatSyncRequestT = Model::ChatSyncRequest>
  void ChatSyncAsync(const ChatSyncRequestT& request, const ChatSyncResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CheckDocumentAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CheckDocumentAccess that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CheckDocumentAccessRequestT = Model::CheckDocumentAccessRequest>
  void CheckDocumentAccessAsync(const CheckDocumentAccessRequestT& request, const CheckDocumentAccessResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAnonymousWebExperienceUrlOutcome CreateAnonymousWebExperienceUrl(
      const Model::CreateAnonymousWebExperienceUrlRequest& request) const;

  /**
   * A Callable wrapper for CreateAnonymousWebExperienceUrl that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAnonymousWebExperienceUrlRequestT = Model::CreateAnonymousWebExperienceUrlRequest>
  Model::CreateAnonymousWebExperienceUrlOutcomeCallable CreateAnonymousWebExperienceUrlCallable(
      const CreateAnonymousWebExperienceUrlRequestT& request) const {
    return SubmitCallable(&QBusinessClient::CreateAnonymousWebExperienceUrl, request);
  }

  /**
   * An Async wrapper for CreateAnonymousWebExperienceUrl that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateAnonymousWebExperienceUrlRequestT = Model::CreateAnonymousWebExperienceUrlRequest>
  void CreateAnonymousWebExperienceUrlAsync(const CreateAnonymousWebExperienceUrlRequestT& request,
                                            const CreateAnonymousWebExperienceUrlResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateChatResponseConfigurationOutcome CreateChatResponseConfiguration(
      const Model::CreateChatResponseConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateChatResponseConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateChatResponseConfigurationRequestT = Model::CreateChatResponseConfigurationRequest>
  Model::CreateChatResponseConfigurationOutcomeCallable CreateChatResponseConfigurationCallable(
      const CreateChatResponseConfigurationRequestT& request) const {
    return SubmitCallable(&QBusinessClient::CreateChatResponseConfiguration, request);
  }

  /**
   * An Async wrapper for CreateChatResponseConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateChatResponseConfigurationRequestT = Model::CreateChatResponseConfigurationRequest>
  void CreateChatResponseConfigurationAsync(const CreateChatResponseConfigurationRequestT& request,
                                            const CreateChatResponseConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataAccessor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataAccessor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDataAccessorRequestT = Model::CreateDataAccessorRequest>
  void CreateDataAccessorAsync(const CreateDataAccessorRequestT& request, const CreateDataAccessorResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreatePlugin that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreatePluginRequestT = Model::CreatePluginRequest>
  void CreatePluginAsync(const CreatePluginRequestT& request, const CreatePluginResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateRetriever that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateRetrieverRequestT = Model::CreateRetrieverRequest>
  void CreateRetrieverAsync(const CreateRetrieverRequestT& request, const CreateRetrieverResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWebExperience that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWebExperience that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateWebExperienceRequestT = Model::CreateWebExperienceRequest>
  void CreateWebExperienceAsync(const CreateWebExperienceRequestT& request, const CreateWebExperienceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteChatControlsConfigurationOutcome DeleteChatControlsConfiguration(
      const Model::DeleteChatControlsConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteChatControlsConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteChatControlsConfigurationRequestT = Model::DeleteChatControlsConfigurationRequest>
  Model::DeleteChatControlsConfigurationOutcomeCallable DeleteChatControlsConfigurationCallable(
      const DeleteChatControlsConfigurationRequestT& request) const {
    return SubmitCallable(&QBusinessClient::DeleteChatControlsConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteChatControlsConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteChatControlsConfigurationRequestT = Model::DeleteChatControlsConfigurationRequest>
  void DeleteChatControlsConfigurationAsync(const DeleteChatControlsConfigurationRequestT& request,
                                            const DeleteChatControlsConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteChatResponseConfigurationOutcome DeleteChatResponseConfiguration(
      const Model::DeleteChatResponseConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteChatResponseConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteChatResponseConfigurationRequestT = Model::DeleteChatResponseConfigurationRequest>
  Model::DeleteChatResponseConfigurationOutcomeCallable DeleteChatResponseConfigurationCallable(
      const DeleteChatResponseConfigurationRequestT& request) const {
    return SubmitCallable(&QBusinessClient::DeleteChatResponseConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteChatResponseConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteChatResponseConfigurationRequestT = Model::DeleteChatResponseConfigurationRequest>
  void DeleteChatResponseConfigurationAsync(const DeleteChatResponseConfigurationRequestT& request,
                                            const DeleteChatResponseConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteConversation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteConversation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteConversationRequestT = Model::DeleteConversationRequest>
  void DeleteConversationAsync(const DeleteConversationRequestT& request, const DeleteConversationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDataAccessor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDataAccessor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDataAccessorRequestT = Model::DeleteDataAccessorRequest>
  void DeleteDataAccessorAsync(const DeleteDataAccessorRequestT& request, const DeleteDataAccessorResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteGroupRequestT = Model::DeleteGroupRequest>
  void DeleteGroupAsync(const DeleteGroupRequestT& request, const DeleteGroupResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeletePlugin that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePluginRequestT = Model::DeletePluginRequest>
  void DeletePluginAsync(const DeletePluginRequestT& request, const DeletePluginResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteRetriever that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRetrieverRequestT = Model::DeleteRetrieverRequest>
  void DeleteRetrieverAsync(const DeleteRetrieverRequestT& request, const DeleteRetrieverResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWebExperience that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWebExperience that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteWebExperienceRequestT = Model::DeleteWebExperienceRequest>
  void DeleteWebExperienceAsync(const DeleteWebExperienceRequestT& request, const DeleteWebExperienceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociatePermission that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociatePermission that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociatePermissionRequestT = Model::DisassociatePermissionRequest>
  void DisassociatePermissionAsync(const DisassociatePermissionRequestT& request,
                                   const DisassociatePermissionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetChatControlsConfigurationOutcome GetChatControlsConfiguration(
      const Model::GetChatControlsConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetChatControlsConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetChatControlsConfigurationRequestT = Model::GetChatControlsConfigurationRequest>
  Model::GetChatControlsConfigurationOutcomeCallable GetChatControlsConfigurationCallable(
      const GetChatControlsConfigurationRequestT& request) const {
    return SubmitCallable(&QBusinessClient::GetChatControlsConfiguration, request);
  }

  /**
   * An Async wrapper for GetChatControlsConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetChatControlsConfigurationRequestT = Model::GetChatControlsConfigurationRequest>
  void GetChatControlsConfigurationAsync(const GetChatControlsConfigurationRequestT& request,
                                         const GetChatControlsConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetChatResponseConfigurationOutcome GetChatResponseConfiguration(
      const Model::GetChatResponseConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetChatResponseConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetChatResponseConfigurationRequestT = Model::GetChatResponseConfigurationRequest>
  Model::GetChatResponseConfigurationOutcomeCallable GetChatResponseConfigurationCallable(
      const GetChatResponseConfigurationRequestT& request) const {
    return SubmitCallable(&QBusinessClient::GetChatResponseConfiguration, request);
  }

  /**
   * An Async wrapper for GetChatResponseConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetChatResponseConfigurationRequestT = Model::GetChatResponseConfigurationRequest>
  void GetChatResponseConfigurationAsync(const GetChatResponseConfigurationRequestT& request,
                                         const GetChatResponseConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDataAccessor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDataAccessorRequestT = Model::GetDataAccessorRequest>
  void GetDataAccessorAsync(const GetDataAccessorRequestT& request, const GetDataAccessorResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGroupRequestT = Model::GetGroupRequest>
  void GetGroupAsync(const GetGroupRequestT& request, const GetGroupResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMedia that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMediaRequestT = Model::GetMediaRequest>
  void GetMediaAsync(const GetMediaRequestT& request, const GetMediaResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetPlugin that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPluginRequestT = Model::GetPluginRequest>
  void GetPluginAsync(const GetPluginRequestT& request, const GetPluginResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRetriever that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRetrieverRequestT = Model::GetRetrieverRequest>
  void GetRetrieverAsync(const GetRetrieverRequestT& request, const GetRetrieverResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWebExperience that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWebExperience that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetWebExperienceRequestT = Model::GetWebExperienceRequest>
  void GetWebExperienceAsync(const GetWebExperienceRequestT& request, const GetWebExperienceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAttachments that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAttachmentsRequestT = Model::ListAttachmentsRequest>
  void ListAttachmentsAsync(const ListAttachmentsRequestT& request, const ListAttachmentsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListChatResponseConfigurationsOutcome ListChatResponseConfigurations(
      const Model::ListChatResponseConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListChatResponseConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListChatResponseConfigurationsRequestT = Model::ListChatResponseConfigurationsRequest>
  Model::ListChatResponseConfigurationsOutcomeCallable ListChatResponseConfigurationsCallable(
      const ListChatResponseConfigurationsRequestT& request) const {
    return SubmitCallable(&QBusinessClient::ListChatResponseConfigurations, request);
  }

  /**
   * An Async wrapper for ListChatResponseConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListChatResponseConfigurationsRequestT = Model::ListChatResponseConfigurationsRequest>
  void ListChatResponseConfigurationsAsync(const ListChatResponseConfigurationsRequestT& request,
                                           const ListChatResponseConfigurationsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListConversations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListConversations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListConversationsRequestT = Model::ListConversationsRequest>
  void ListConversationsAsync(const ListConversationsRequestT& request, const ListConversationsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDataAccessors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataAccessors that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDataAccessorsRequestT = Model::ListDataAccessorsRequest>
  void ListDataAccessorsAsync(const ListDataAccessorsRequestT& request, const ListDataAccessorsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListDocuments that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListDocumentsRequestT = Model::ListDocumentsRequest>
  void ListDocumentsAsync(const ListDocumentsRequestT& request, const ListDocumentsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListGroups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListGroupsRequestT = Model::ListGroupsRequest>
  void ListGroupsAsync(const ListGroupsRequestT& request, const ListGroupsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListIndicesRequestT = Model::ListIndicesRequest>
  void ListIndicesAsync(const ListIndicesRequestT& request, const ListIndicesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListMessages that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMessagesRequestT = Model::ListMessagesRequest>
  void ListMessagesAsync(const ListMessagesRequestT& request, const ListMessagesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPluginActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPluginActions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPluginActionsRequestT = Model::ListPluginActionsRequest>
  void ListPluginActionsAsync(const ListPluginActionsRequestT& request, const ListPluginActionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPluginTypeActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPluginTypeActions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPluginTypeActionsRequestT = Model::ListPluginTypeActionsRequest>
  void ListPluginTypeActionsAsync(const ListPluginTypeActionsRequestT& request, const ListPluginTypeActionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPluginTypeMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPluginTypeMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPluginTypeMetadataRequestT = Model::ListPluginTypeMetadataRequest>
  void ListPluginTypeMetadataAsync(const ListPluginTypeMetadataResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListPluginTypeMetadataRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListPlugins that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPluginsRequestT = Model::ListPluginsRequest>
  void ListPluginsAsync(const ListPluginsRequestT& request, const ListPluginsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListRetrievers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRetrieversRequestT = Model::ListRetrieversRequest>
  void ListRetrieversAsync(const ListRetrieversRequestT& request, const ListRetrieversResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListWebExperiences that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWebExperiences that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListWebExperiencesRequestT = Model::ListWebExperiencesRequest>
  void ListWebExperiencesAsync(const ListWebExperiencesRequestT& request, const ListWebExperiencesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutFeedback that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutFeedbackRequestT = Model::PutFeedbackRequest>
  void PutFeedbackAsync(const PutFeedbackRequestT& request, const PutFeedbackResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutGroupRequestT = Model::PutGroupRequest>
  void PutGroupAsync(const PutGroupRequestT& request, const PutGroupResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchRelevantContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchRelevantContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchRelevantContentRequestT = Model::SearchRelevantContentRequest>
  void SearchRelevantContentAsync(const SearchRelevantContentRequestT& request, const SearchRelevantContentResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateChatControlsConfigurationOutcome UpdateChatControlsConfiguration(
      const Model::UpdateChatControlsConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateChatControlsConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateChatControlsConfigurationRequestT = Model::UpdateChatControlsConfigurationRequest>
  Model::UpdateChatControlsConfigurationOutcomeCallable UpdateChatControlsConfigurationCallable(
      const UpdateChatControlsConfigurationRequestT& request) const {
    return SubmitCallable(&QBusinessClient::UpdateChatControlsConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateChatControlsConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateChatControlsConfigurationRequestT = Model::UpdateChatControlsConfigurationRequest>
  void UpdateChatControlsConfigurationAsync(const UpdateChatControlsConfigurationRequestT& request,
                                            const UpdateChatControlsConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateChatResponseConfigurationOutcome UpdateChatResponseConfiguration(
      const Model::UpdateChatResponseConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateChatResponseConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateChatResponseConfigurationRequestT = Model::UpdateChatResponseConfigurationRequest>
  Model::UpdateChatResponseConfigurationOutcomeCallable UpdateChatResponseConfigurationCallable(
      const UpdateChatResponseConfigurationRequestT& request) const {
    return SubmitCallable(&QBusinessClient::UpdateChatResponseConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateChatResponseConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateChatResponseConfigurationRequestT = Model::UpdateChatResponseConfigurationRequest>
  void UpdateChatResponseConfigurationAsync(const UpdateChatResponseConfigurationRequestT& request,
                                            const UpdateChatResponseConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDataAccessor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDataAccessor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDataAccessorRequestT = Model::UpdateDataAccessorRequest>
  void UpdateDataAccessorAsync(const UpdateDataAccessorRequestT& request, const UpdateDataAccessorResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdatePlugin that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdatePluginRequestT = Model::UpdatePluginRequest>
  void UpdatePluginAsync(const UpdatePluginRequestT& request, const UpdatePluginResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateRetriever that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRetrieverRequestT = Model::UpdateRetrieverRequest>
  void UpdateRetrieverAsync(const UpdateRetrieverRequestT& request, const UpdateRetrieverResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateWebExperience that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateWebExperience that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateWebExperienceRequestT = Model::UpdateWebExperienceRequest>
  void UpdateWebExperienceAsync(const UpdateWebExperienceRequestT& request, const UpdateWebExperienceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
