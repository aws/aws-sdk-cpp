...
class UpdateSecurityResult {
 public:
  ...
  template <typename ClusterArnT = Aws::String>
  UpdateSecurityResult& WithClusterArn(ClusterArnT&& value) {
  ...
  template <typename ClusterOperationArnT = Aws::String>
  UpdateSecurityResult& WithClusterOperationArn(ClusterOperationArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSecurityResult& WithRequestId(RequestIdT&& value) {
