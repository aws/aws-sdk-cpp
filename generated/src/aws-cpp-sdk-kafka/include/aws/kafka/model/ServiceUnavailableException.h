...
namespace Model
{
   ...
   * 
         ...
         <p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/kafka-2018-11-14/ServiceUnavailableException">AWS
   * API Reference</a></p>
   */
  class ServiceUnavailableException
  {
  public:
    AWS_KAFKA_API ServiceUnavailableException();
    AWS_KAFKA_API ServiceUnavailableException(Aws::Utils::Json::JsonView jsonValue);
    AWS_KAFKA_API ServiceUnavailableException& operator=(Aws::Utils::Json::JsonView jsonValue);
     ...
     */
    inline ServiceUnavailableException& WithInvalidParameter(const Aws::String& value) { SetInvalidParameter(value); return *this;}
     ...
     */
    inline ServiceUnavailableException& WithInvalidParameter(Aws::String&& value) { SetInvalidParameter(std::move(value)); return *this;}
     ...
     */
    inline ServiceUnavailableException& WithInvalidParameter(const char* value) { SetInvalidParameter(value); return *this;}
