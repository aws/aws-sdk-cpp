...
class ConsumerGroupReplication {
 public:
  ...
  inline ConsumerGroupReplication& WithDetectAndCopyNewConsumerGroups(bool value) {
  ...
  inline ConsumerGroupReplication& WithSynchroniseConsumerGroupOffsets(bool value) {
