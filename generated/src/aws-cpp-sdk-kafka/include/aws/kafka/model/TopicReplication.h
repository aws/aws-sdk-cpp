...
class TopicReplication {
 public:
  ...
  inline void SetCopyAccessControlListsForTopics(bool value) {
    m_copyAccessControlListsForTopicsHasBeenSet = true;
    m_copyAccessControlListsForTopics = value;
  }
  inline TopicReplication& WithCopyAccessControlListsForTopics(bool value) {
    SetCopyAccessControlListsForTopics(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCopyTopicConfigurations(bool value) {
    m_copyTopicConfigurationsHasBeenSet = true;
    m_copyTopicConfigurations = value;
  }
  inline TopicReplication& WithCopyTopicConfigurations(bool value) {
    SetCopyTopicConfigurations(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDetectAndCopyNewTopics(bool value) {
    m_detectAndCopyNewTopicsHasBeenSet = true;
    m_detectAndCopyNewTopics = value;
  }
  inline TopicReplication& WithDetectAndCopyNewTopics(bool value) {
    SetDetectAndCopyNewTopics(value);
    return *this;
  }
  ///@}
  ...
  void SetTopicNameConfiguration(TopicNameConfigurationT&& value) {
    ...
    m_topicNameConfiguration = std::forward<TopicNameConfigurationT>(value);
  }
  template <typename TopicNameConfigurationT = ReplicationTopicNameConfiguration>
  TopicReplication& WithTopicNameConfiguration(TopicNameConfigurationT&& value) {
    SetTopicNameConfiguration(std::forward<TopicNameConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTopicsToExclude(TopicsToExcludeT&& value) {
    ...
    m_topicsToExclude = std::forward<TopicsToExcludeT>(value);
  }
  template <typename TopicsToExcludeT = Aws::Vector<Aws::String>>
  TopicReplication& WithTopicsToExclude(TopicsToExcludeT&& value) {
    SetTopicsToExclude(std::forward<TopicsToExcludeT>(value));
    return *this;
  }
  template <typename TopicsToExcludeT = Aws::String>
  TopicReplication& AddTopicsToExclude(TopicsToExcludeT&& value) {
    m_topicsToExcludeHasBeenSet = true;
    m_topicsToExclude.emplace_back(std::forward<TopicsToExcludeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTopicsToReplicate(TopicsToReplicateT&& value) {
    ...
    m_topicsToReplicate = std::forward<TopicsToReplicateT>(value);
  }
  template <typename TopicsToReplicateT = Aws::Vector<Aws::String>>
  TopicReplication& WithTopicsToReplicate(TopicsToReplicateT&& value) {
    SetTopicsToReplicate(std::forward<TopicsToReplicateT>(value));
    return *this;
  }
  template <typename TopicsToReplicateT = Aws::String>
  TopicReplication& AddTopicsToReplicate(TopicsToReplicateT&& value) {
    m_topicsToReplicateHasBeenSet = true;
    m_topicsToReplicate.emplace_back(std::forward<TopicsToReplicateT>(value));
    return *this;
  }
  ///@}
 private:
