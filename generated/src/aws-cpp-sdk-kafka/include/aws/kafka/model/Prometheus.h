...
class Prometheus {
 public:
  ...
  void SetJmxExporter(JmxExporterT&& value) {
    ...
    m_jmxExporter = std::forward<JmxExporterT>(value);
  }
  template <typename JmxExporterT = JmxExporter>
  Prometheus& WithJmxExporter(JmxExporterT&& value) {
    SetJmxExporter(std::forward<JmxExporterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeExporter(NodeExporterT&& value) {
    ...
    m_nodeExporter = std::forward<NodeExporterT>(value);
  }
  template <typename NodeExporterT = NodeExporter>
  Prometheus& WithNodeExporter(NodeExporterT&& value) {
    SetNodeExporter(std::forward<NodeExporterT>(value));
    return *this;
  }
  ///@}
 private:
