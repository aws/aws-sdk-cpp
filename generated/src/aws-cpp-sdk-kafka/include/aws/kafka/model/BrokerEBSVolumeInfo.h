...
class BrokerEBSVolumeInfo {
 public:
  ...
  void SetKafkaBrokerNodeId(KafkaBrokerNodeIdT&& value) {
    ...
    m_kafkaBrokerNodeId = std::forward<KafkaBrokerNodeIdT>(value);
  }
  template <typename KafkaBrokerNodeIdT = Aws::String>
  BrokerEBSVolumeInfo& WithKafkaBrokerNodeId(KafkaBrokerNodeIdT&& value) {
    SetKafkaBrokerNodeId(std::forward<KafkaBrokerNodeIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline BrokerEBSVolumeInfo& WithVolumeSizeGB(int value) {
