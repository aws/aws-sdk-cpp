...
class ListClientVpcConnectionsResult {
 public:
  ...
  void SetClientVpcConnections(ClientVpcConnectionsT&& value) {
    m_clientVpcConnectionsHasBeenSet = true;
    m_clientVpcConnections = std::forward<ClientVpcConnectionsT>(value);
  }
  template <typename ClientVpcConnectionsT = Aws::Vector<ClientVpcConnection>>
  ListClientVpcConnectionsResult& WithClientVpcConnections(ClientVpcConnectionsT&& value) {
    SetClientVpcConnections(std::forward<ClientVpcConnectionsT>(value));
    return *this;
  }
  template <typename ClientVpcConnectionsT = ClientVpcConnection>
  ListClientVpcConnectionsResult& AddClientVpcConnections(ClientVpcConnectionsT&& value) {
    m_clientVpcConnectionsHasBeenSet = true;
    m_clientVpcConnections.emplace_back(std::forward<ClientVpcConnectionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListClientVpcConnectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListClientVpcConnectionsResult& WithRequestId(RequestIdT&& value) {
