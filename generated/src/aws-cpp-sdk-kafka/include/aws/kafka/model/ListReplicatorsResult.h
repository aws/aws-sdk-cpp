...
class ListReplicatorsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListReplicatorsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetReplicators(ReplicatorsT&& value) {
    m_replicatorsHasBeenSet = true;
    m_replicators = std::forward<ReplicatorsT>(value);
  }
  template <typename ReplicatorsT = Aws::Vector<ReplicatorSummary>>
  ListReplicatorsResult& WithReplicators(ReplicatorsT&& value) {
    SetReplicators(std::forward<ReplicatorsT>(value));
    return *this;
  }
  template <typename ReplicatorsT = ReplicatorSummary>
  ListReplicatorsResult& AddReplicators(ReplicatorsT&& value) {
    m_replicatorsHasBeenSet = true;
    m_replicators.emplace_back(std::forward<ReplicatorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListReplicatorsResult& WithRequestId(RequestIdT&& value) {
