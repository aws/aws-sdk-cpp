...
class ListClustersV2Request : public KafkaRequest {
 public:
  ...
  template <typename ClusterNameFilterT = Aws::String>
  ListClustersV2Request& WithClusterNameFilter(ClusterNameFilterT&& value) {
  ...
  void SetClusterTypeFilter(ClusterTypeFilterT&& value) {
    m_clusterTypeFilterHasBeenSet = true;
    m_clusterTypeFilter = std::forward<ClusterTypeFilterT>(value);
  }
  template <typename ClusterTypeFilterT = Aws::String>
  ListClustersV2Request& WithClusterTypeFilter(ClusterTypeFilterT&& value) {
    SetClusterTypeFilter(std::forward<ClusterTypeFilterT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListClustersV2Request& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListClustersV2Request& WithNextToken(NextTokenT&& value) {
