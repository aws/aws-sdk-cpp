 ...
 * asynchronous create.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/kafka-2018-11-14/CreateChannelResponse">AWS
 * API Reference</a></p>
 */
class CreateChannelResult {
 public:
  AWS_KAFKA_API CreateChannelResult() = default;
  AWS_KAFKA_API CreateChannelResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_KAFKA_API CreateChannelResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ClusterOperationArnT = Aws::String>
  CreateChannelResult& WithClusterOperationArn(ClusterOperationArnT&& value) {
