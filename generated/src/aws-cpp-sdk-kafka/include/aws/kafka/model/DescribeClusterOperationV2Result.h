...
class DescribeClusterOperationV2Result {
 public:
  ...
  void SetClusterOperationInfo(ClusterOperationInfoT&& value) {
    m_clusterOperationInfoHasBeenSet = true;
    m_clusterOperationInfo = std::forward<ClusterOperationInfoT>(value);
  }
  template <typename ClusterOperationInfoT = ClusterOperationV2>
  DescribeClusterOperationV2Result& WithClusterOperationInfo(ClusterOperationInfoT&& value) {
    SetClusterOperationInfo(std::forward<ClusterOperationInfoT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeClusterOperationV2Result& WithRequestId(RequestIdT&& value) {
