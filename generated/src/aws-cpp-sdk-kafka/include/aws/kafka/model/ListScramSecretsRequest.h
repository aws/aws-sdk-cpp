...
class ListScramSecretsRequest : public KafkaRequest {
 public:
  AWS_KAFKA_API ListScramSecretsRequest() = default;
  ...
  template <typename ClusterArnT = Aws::String>
  ListScramSecretsRequest& WithClusterArn(ClusterArnT&& value) {
  ...
  inline ListScramSecretsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListScramSecretsRequest& WithNextToken(NextTokenT&& value) {
