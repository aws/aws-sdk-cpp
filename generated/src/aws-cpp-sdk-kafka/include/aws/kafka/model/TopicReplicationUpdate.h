...
class TopicReplicationUpdate {
 public:
  ...
  inline TopicReplicationUpdate& WithCopyAccessControlListsForTopics(bool value) {
  ...
  inline TopicReplicationUpdate& WithCopyTopicConfigurations(bool value) {
  ...
  inline TopicReplicationUpdate& WithDetectAndCopyNewTopics(bool value) {
