...
class ListClusterOperationsV2Request : public KafkaRequest {
 public:
  ...
  template <typename ClusterArnT = Aws::String>
  ListClusterOperationsV2Request& WithClusterArn(ClusterArnT&& value) {
  ...
  inline ListClusterOperationsV2Request& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListClusterOperationsV2Request& WithNextToken(NextTokenT&& value) {
