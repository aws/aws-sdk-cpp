...
class ListKafkaVersionsResult {
 public:
  ...
  template <typename KafkaVersionsT = Aws::Vector<KafkaVersion>>
  ListKafkaVersionsResult& WithKafkaVersions(KafkaVersionsT&& value) {
    SetKafkaVersions(std::forward<KafkaVersionsT>(value));
    return *this;
  }
  template <typename KafkaVersionsT = KafkaVersion>
  ListKafkaVersionsResult& AddKafkaVersions(KafkaVersionsT&& value) {
    m_kafkaVersionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListKafkaVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKafkaVersionsResult& WithRequestId(RequestIdT&& value) {
