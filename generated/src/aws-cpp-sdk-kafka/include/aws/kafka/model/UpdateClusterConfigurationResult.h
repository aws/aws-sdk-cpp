...
namespace Model
{
  ...
  {
  public:
    AWS_KAFKA_API UpdateClusterConfigurationResult() = default;
    ...
    template<typename ClusterArnT = Aws::String>
    UpdateClusterConfigurationResult& WithClusterArn(ClusterArnT&& value) { SetClusterArn(std::forward<ClusterArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ClusterOperationArnT = Aws::String>
    UpdateClusterConfigurationResult& WithClusterOperationArn(ClusterOperationArnT&& value) { SetClusterOperationArn(std::forward<ClusterOperationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateClusterConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
