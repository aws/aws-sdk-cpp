...
class EncryptionAtRest {
 public:
  ...
  void SetDataVolumeKMSKeyId(DataVolumeKMSKeyIdT&& value) {
    m_dataVolumeKMSKeyIdHasBeenSet = true;
    m_dataVolumeKMSKeyId = std::forward<DataVolumeKMSKeyIdT>(value);
  }
  template <typename DataVolumeKMSKeyIdT = Aws::String>
  EncryptionAtRest& WithDataVolumeKMSKeyId(DataVolumeKMSKeyIdT&& value) {
    SetDataVolumeKMSKeyId(std::forward<DataVolumeKMSKeyIdT>(value));
    return *this;
  }
  ///@}
 private:
