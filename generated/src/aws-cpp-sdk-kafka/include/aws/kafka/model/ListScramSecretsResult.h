...
class ListScramSecretsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListScramSecretsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SecretArnListT = Aws::Vector<Aws::String>>
  ListScramSecretsResult& WithSecretArnList(SecretArnListT&& value) {
    SetSecretArnList(std::forward<SecretArnListT>(value));
    return *this;
  }
  template <typename SecretArnListT = Aws::String>
  ListScramSecretsResult& AddSecretArnList(SecretArnListT&& value) {
    m_secretArnListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListScramSecretsResult& WithRequestId(RequestIdT&& value) {
