...
class UpdateClusterKafkaVersionRequest : public KafkaRequest {
 public:
  ...
  void SetTargetKafkaVersion(TargetKafkaVersionT&& value) {
    m_targetKafkaVersionHasBeenSet = true;
    m_targetKafkaVersion = std::forward<TargetKafkaVersionT>(value);
  }
  template <typename TargetKafkaVersionT = Aws::String>
  UpdateClusterKafkaVersionRequest& WithTargetKafkaVersion(TargetKafkaVersionT&& value) {
    SetTargetKafkaVersion(std::forward<TargetKafkaVersionT>(value));
    return *this;
  }
  ///@}
 private:
