...
class UpdateClusterKafkaVersionResult {
 public:
  ...
  template <typename ClusterArnT = Aws::String>
  UpdateClusterKafkaVersionResult& WithClusterArn(ClusterArnT&& value) {
  ...
  template <typename ClusterOperationArnT = Aws::String>
  UpdateClusterKafkaVersionResult& WithClusterOperationArn(ClusterOperationArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateClusterKafkaVersionResult& WithRequestId(RequestIdT&& value) {
