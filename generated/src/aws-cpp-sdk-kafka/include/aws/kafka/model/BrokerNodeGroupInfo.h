...
class BrokerNodeGroupInfo {
 public:
  ...
  inline void SetBrokerAZDistribution(BrokerAZDistribution value) {
    m_brokerAZDistributionHasBeenSet = true;
    m_brokerAZDistribution = value;
  }
  inline BrokerNodeGroupInfo& WithBrokerAZDistribution(BrokerAZDistribution value) {
    SetBrokerAZDistribution(value);
    return *this;
  }
  ///@}
  ...
  void SetClientSubnets(ClientSubnetsT&& value) {
    ...
    m_clientSubnets = std::forward<ClientSubnetsT>(value);
  }
  template <typename ClientSubnetsT = Aws::Vector<Aws::String>>
  BrokerNodeGroupInfo& WithClientSubnets(ClientSubnetsT&& value) {
    SetClientSubnets(std::forward<ClientSubnetsT>(value));
    return *this;
  }
  template <typename ClientSubnetsT = Aws::String>
  BrokerNodeGroupInfo& AddClientSubnets(ClientSubnetsT&& value) {
    m_clientSubnetsHasBeenSet = true;
    m_clientSubnets.emplace_back(std::forward<ClientSubnetsT>(value));
    return *this;
  }
  ///@}
...
kafka.m5.4xlarge, kafka.m5.12xlarge, and
  ...
  void SetStorageInfo(StorageInfoT&& value) {
    ...
    m_storageInfo = std::forward<StorageInfoT>(value);
  }
  template <typename StorageInfoT = StorageInfo>
  BrokerNodeGroupInfo& WithStorageInfo(StorageInfoT&& value) {
    SetStorageInfo(std::forward<StorageInfoT>(value));
    return *this;
  }
  ///@}
