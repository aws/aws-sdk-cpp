 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/kafka-2018-11-14/KafkaClusterOAuthClientCredentialsAssertion">AWS
 * API Reference</a></p>
 */
class KafkaClusterOAuthClientCredentialsAssertion {
 public:
  AWS_KAFKA_API KafkaClusterOAuthClientCredentialsAssertion() = default;
  AWS_KAFKA_API KafkaClusterOAuthClientCredentialsAssertion(Aws::Utils::Json::JsonView jsonValue);
  AWS_KAFKA_API KafkaClusterOAuthClientCredentialsAssertion& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AudienceT = Aws::String>
  KafkaClusterOAuthClientCredentialsAssertion& WithAudience(AudienceT&& value) {
  ...
  inline KafkaClusterOAuthClientCredentialsAssertion& WithSigningAlgorithm(JwtSigningAlgorithm value) {
  ...
  template <typename TokenRequestSecretArnT = Aws::String>
  KafkaClusterOAuthClientCredentialsAssertion& WithTokenRequestSecretArn(TokenRequestSecretArnT&& value) {
