...
class ListReplicatorsRequest : public KafkaRequest {
 public:
  ...
  inline ListReplicatorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReplicatorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetReplicatorNameFilter(ReplicatorNameFilterT&& value) {
    m_replicatorNameFilterHasBeenSet = true;
    m_replicatorNameFilter = std::forward<ReplicatorNameFilterT>(value);
  }
  template <typename ReplicatorNameFilterT = Aws::String>
  ListReplicatorsRequest& WithReplicatorNameFilter(ReplicatorNameFilterT&& value) {
    SetReplicatorNameFilter(std::forward<ReplicatorNameFilterT>(value));
    return *this;
  }
  ///@}
 private:
