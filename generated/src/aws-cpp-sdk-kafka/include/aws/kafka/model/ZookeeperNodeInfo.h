...
class ZookeeperNodeInfo {
 public:
  ...
  inline void SetZookeeperId(double value) {
    m_zookeeperIdHasBeenSet = true;
    m_zookeeperId = value;
  }
  inline ZookeeperNodeInfo& WithZookeeperId(double value) {
    SetZookeeperId(value);
    return *this;
  }
  ///@}
  ...
  void SetZookeeperVersion(ZookeeperVersionT&& value) {
    ...
    m_zookeeperVersion = std::forward<ZookeeperVersionT>(value);
  }
  template <typename ZookeeperVersionT = Aws::String>
  ZookeeperNodeInfo& WithZookeeperVersion(ZookeeperVersionT&& value) {
    SetZookeeperVersion(std::forward<ZookeeperVersionT>(value));
    return *this;
  }
  ///@}
 private:
