...
class ReplicationInfoDescription {
 public:
  ...
  template <typename ConsumerGroupReplicationT = ConsumerGroupReplication>
  ReplicationInfoDescription& WithConsumerGroupReplication(ConsumerGroupReplicationT&& value) {
  ...
  template <typename SourceKafkaClusterAliasT = Aws::String>
  ReplicationInfoDescription& WithSourceKafkaClusterAlias(SourceKafkaClusterAliasT&& value) {
  ...
  inline ReplicationInfoDescription& WithTargetCompressionType(TargetCompressionType value) {
  ...
  template <typename TargetKafkaClusterAliasT = Aws::String>
  ReplicationInfoDescription& WithTargetKafkaClusterAlias(TargetKafkaClusterAliasT&& value) {
  ...
  template <typename TopicReplicationT = TopicReplication>
  ReplicationInfoDescription& WithTopicReplication(TopicReplicationT&& value) {
