 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/kafka-2018-11-14/ConsumerGroupReplicationUpdate">AWS
 * API Reference</a></p>
 */
class ConsumerGroupReplicationUpdate {
 public:
  ...
  void SetConsumerGroupsToExclude(ConsumerGroupsToExcludeT&& value) {
    ...
    m_consumerGroupsToExclude = std::forward<ConsumerGroupsToExcludeT>(value);
  }
  template <typename ConsumerGroupsToExcludeT = Aws::Vector<Aws::String>>
  ConsumerGroupReplicationUpdate& WithConsumerGroupsToExclude(ConsumerGroupsToExcludeT&& value) {
    SetConsumerGroupsToExclude(std::forward<ConsumerGroupsToExcludeT>(value));
    return *this;
  }
  template <typename ConsumerGroupsToExcludeT = Aws::String>
  ConsumerGroupReplicationUpdate& AddConsumerGroupsToExclude(ConsumerGroupsToExcludeT&& value) {
    m_consumerGroupsToExcludeHasBeenSet = true;
    m_consumerGroupsToExclude.emplace_back(std::forward<ConsumerGroupsToExcludeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConsumerGroupsToReplicate(ConsumerGroupsToReplicateT&& value) {
    ...
    m_consumerGroupsToReplicate = std::forward<ConsumerGroupsToReplicateT>(value);
  }
  template <typename ConsumerGroupsToReplicateT = Aws::Vector<Aws::String>>
  ConsumerGroupReplicationUpdate& WithConsumerGroupsToReplicate(ConsumerGroupsToReplicateT&& value) {
    SetConsumerGroupsToReplicate(std::forward<ConsumerGroupsToReplicateT>(value));
    return *this;
  }
  template <typename ConsumerGroupsToReplicateT = Aws::String>
  ConsumerGroupReplicationUpdate& AddConsumerGroupsToReplicate(ConsumerGroupsToReplicateT&& value) {
    m_consumerGroupsToReplicateHasBeenSet = true;
    m_consumerGroupsToReplicate.emplace_back(std::forward<ConsumerGroupsToReplicateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDetectAndCopyNewConsumerGroups(bool value) {
    m_detectAndCopyNewConsumerGroupsHasBeenSet = true;
    m_detectAndCopyNewConsumerGroups = value;
  }
  inline ConsumerGroupReplicationUpdate& WithDetectAndCopyNewConsumerGroups(bool value) {
    SetDetectAndCopyNewConsumerGroups(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSynchroniseConsumerGroupOffsets(bool value) {
    m_synchroniseConsumerGroupOffsetsHasBeenSet = true;
    m_synchroniseConsumerGroupOffsets = value;
  }
  inline ConsumerGroupReplicationUpdate& WithSynchroniseConsumerGroupOffsets(bool value) {
    SetSynchroniseConsumerGroupOffsets(value);
    return *this;
  }
  ///@}
 private:
