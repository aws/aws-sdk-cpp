...
class ReplicationTopicNameConfiguration {
 public:
  ...
  inline void SetType(ReplicationTopicNameConfigurationType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ReplicationTopicNameConfiguration& WithType(ReplicationTopicNameConfigurationType value) {
    SetType(value);
    return *this;
  }
  ///@}
