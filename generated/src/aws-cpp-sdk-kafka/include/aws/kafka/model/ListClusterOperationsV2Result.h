...
class ListClusterOperationsV2Result {
 public:
  ...
  template <typename ClusterOperationInfoListT = Aws::Vector<ClusterOperationV2Summary>>
  ListClusterOperationsV2Result& WithClusterOperationInfoList(ClusterOperationInfoListT&& value) {
  ...
  ListClusterOperationsV2Result& AddClusterOperationInfoList(ClusterOperationInfoListT&& value) {
    m_clusterOperationInfoListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListClusterOperationsV2Result& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListClusterOperationsV2Result& WithRequestId(RequestIdT&& value) {
