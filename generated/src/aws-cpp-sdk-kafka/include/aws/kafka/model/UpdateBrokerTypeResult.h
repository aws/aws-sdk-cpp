...
namespace Model
{
  ...
  {
  public:
    AWS_KAFKA_API UpdateBrokerTypeResult() = default;
    ...
    template<typename ClusterArnT = Aws::String>
    UpdateBrokerTypeResult& WithClusterArn(ClusterArnT&& value) { SetClusterArn(std::forward<ClusterArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ClusterOperationArnT = Aws::String>
    UpdateBrokerTypeResult& WithClusterOperationArn(ClusterOperationArnT&& value) { SetClusterOperationArn(std::forward<ClusterOperationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateBrokerTypeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
