...
class UpdateBrokerTypeResult {
 public:
  ...
  template <typename ClusterArnT = Aws::String>
  UpdateBrokerTypeResult& WithClusterArn(ClusterArnT&& value) {
  ...
  template <typename ClusterOperationArnT = Aws::String>
  UpdateBrokerTypeResult& WithClusterOperationArn(ClusterOperationArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateBrokerTypeResult& WithRequestId(RequestIdT&& value) {
