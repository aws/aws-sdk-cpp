...
namespace Model
{
  ...
  /**
   */
  class ListNodesRequest : public KafkaRequest
  {
  public:
    AWS_KAFKA_API ListNodesRequest() = default;
    ...
    template<typename ClusterArnT = Aws::String>
    ListNodesRequest& WithClusterArn(ClusterArnT&& value) { SetClusterArn(std::forward<ClusterArnT>(value)); return *this;}
    ///@}
