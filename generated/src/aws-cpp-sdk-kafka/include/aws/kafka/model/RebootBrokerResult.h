...
namespace Model
{
  ...
  {
  public:
    AWS_KAFKA_API RebootBrokerResult() = default;
    ...
    template<typename ClusterArnT = Aws::String>
    RebootBrokerResult& WithClusterArn(ClusterArnT&& value) { SetClusterArn(std::forward<ClusterArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ClusterOperationArnT = Aws::String>
    RebootBrokerResult& WithClusterOperationArn(ClusterOperationArnT&& value) { SetClusterOperationArn(std::forward<ClusterOperationArnT>(value)); return *this;}
    ///@}
