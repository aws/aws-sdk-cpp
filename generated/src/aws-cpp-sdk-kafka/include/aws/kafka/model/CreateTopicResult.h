...
class CreateTopicResult {
 public:
  AWS_KAFKA_API CreateTopicResult() = default;
  AWS_KAFKA_API CreateTopicResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_KAFKA_API CreateTopicResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename TopicArnT = Aws::String>
  CreateTopicResult& WithTopicArn(TopicArnT&& value) {
  ...
  template <typename TopicNameT = Aws::String>
  CreateTopicResult& WithTopicName(TopicNameT&& value) {
  ...
  inline CreateTopicResult& WithStatus(TopicState value) {
    SetStatus(value);
    return *this;
  }
  ///@}
