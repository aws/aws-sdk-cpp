...
class ListClusterOperationsResult {
 public:
  ...
  void SetClusterOperationInfoList(ClusterOperationInfoListT&& value) {
    ...
    m_clusterOperationInfoList = std::forward<ClusterOperationInfoListT>(value);
  }
  template <typename ClusterOperationInfoListT = Aws::Vector<ClusterOperationInfo>>
  ListClusterOperationsResult& WithClusterOperationInfoList(ClusterOperationInfoListT&& value) {
    SetClusterOperationInfoList(std::forward<ClusterOperationInfoListT>(value));
    return *this;
  }
  ...
  ListClusterOperationsResult& AddClusterOperationInfoList(ClusterOperationInfoListT&& value) {
    m_clusterOperationInfoListHasBeenSet = true;
    m_clusterOperationInfoList.emplace_back(std::forward<ClusterOperationInfoListT>(value));
    return *this;
  }
  ///@}
