...
/**
 */
class GetBootstrapBrokersRequest : public KafkaRequest {
 public:
  AWS_KAFKA_API GetBootstrapBrokersRequest() = default;
  ...
  template <typename ClusterArnT = Aws::String>
  GetBootstrapBrokersRequest& WithClusterArn(ClusterArnT&& value) {
