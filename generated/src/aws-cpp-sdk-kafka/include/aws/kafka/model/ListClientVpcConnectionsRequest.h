...
class ListClientVpcConnectionsRequest : public KafkaRequest {
 public:
  ...
  template <typename ClusterArnT = Aws::String>
  ListClientVpcConnectionsRequest& WithClusterArn(ClusterArnT&& value) {
  ...
  inline ListClientVpcConnectionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListClientVpcConnectionsRequest& WithNextToken(NextTokenT&& value) {
