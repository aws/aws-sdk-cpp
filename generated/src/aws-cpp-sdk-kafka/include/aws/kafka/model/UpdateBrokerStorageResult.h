...
class UpdateBrokerStorageResult {
 public:
  ...
  template <typename ClusterArnT = Aws::String>
  UpdateBrokerStorageResult& WithClusterArn(ClusterArnT&& value) {
  ...
  template <typename ClusterOperationArnT = Aws::String>
  UpdateBrokerStorageResult& WithClusterOperationArn(ClusterOperationArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateBrokerStorageResult& WithRequestId(RequestIdT&& value) {
