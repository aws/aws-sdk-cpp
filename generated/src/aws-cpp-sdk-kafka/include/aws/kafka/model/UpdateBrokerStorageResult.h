...
namespace Model
{
  ...
  {
  public:
    AWS_KAFKA_API UpdateBrokerStorageResult();
    ...
    inline UpdateBrokerStorageResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateBrokerStorageResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateBrokerStorageResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
