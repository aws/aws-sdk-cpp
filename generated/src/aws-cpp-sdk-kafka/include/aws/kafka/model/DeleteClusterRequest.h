...
class DeleteClusterRequest : public KafkaRequest {
 public:
  AWS_KAFKA_API DeleteClusterRequest() = default;
  ...
  template <typename ClusterArnT = Aws::String>
  DeleteClusterRequest& WithClusterArn(ClusterArnT&& value) {
  ...
  template <typename CurrentVersionT = Aws::String>
  DeleteClusterRequest& WithCurrentVersion(CurrentVersionT&& value) {
