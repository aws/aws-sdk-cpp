...
namespace Model
{
  ...
  public:
     ...
     */
    inline InternalServerErrorException& WithInvalidParameter(const Aws::String& value) { SetInvalidParameter(value); return *this;}
     ...
     */
    inline InternalServerErrorException& WithInvalidParameter(Aws::String&& value) { SetInvalidParameter(std::move(value)); return *this;}
     ...
     */
    inline InternalServerErrorException& WithInvalidParameter(const char* value) { SetInvalidParameter(value); return *this;}
