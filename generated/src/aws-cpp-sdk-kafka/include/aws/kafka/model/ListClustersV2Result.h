...
class ListClustersV2Result {
 public:
  ...
  void SetClusterInfoList(ClusterInfoListT&& value) {
    m_clusterInfoListHasBeenSet = true;
    m_clusterInfoList = std::forward<ClusterInfoListT>(value);
  }
  template <typename ClusterInfoListT = Aws::Vector<Cluster>>
  ListClustersV2Result& WithClusterInfoList(ClusterInfoListT&& value) {
    SetClusterInfoList(std::forward<ClusterInfoListT>(value));
    return *this;
  }
  template <typename ClusterInfoListT = Cluster>
  ListClustersV2Result& AddClusterInfoList(ClusterInfoListT&& value) {
    m_clusterInfoListHasBeenSet = true;
    m_clusterInfoList.emplace_back(std::forward<ClusterInfoListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListClustersV2Result& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListClustersV2Result& WithRequestId(RequestIdT&& value) {
