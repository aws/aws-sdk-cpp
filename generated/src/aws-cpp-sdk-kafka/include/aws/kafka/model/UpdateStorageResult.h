...
namespace Model
{
  ...
  {
  public:
    AWS_KAFKA_API UpdateStorageResult() = default;
    ...
    template<typename ClusterArnT = Aws::String>
    UpdateStorageResult& WithClusterArn(ClusterArnT&& value) { SetClusterArn(std::forward<ClusterArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ClusterOperationArnT = Aws::String>
    UpdateStorageResult& WithClusterOperationArn(ClusterOperationArnT&& value) { SetClusterOperationArn(std::forward<ClusterOperationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateStorageResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
