...
class BatchAssociateScramSecretResult {
 public:
  ...
  template <typename ClusterArnT = Aws::String>
  BatchAssociateScramSecretResult& WithClusterArn(ClusterArnT&& value) {
  ...
  template <typename UnprocessedScramSecretsT = Aws::Vector<UnprocessedScramSecret>>
  BatchAssociateScramSecretResult& WithUnprocessedScramSecrets(UnprocessedScramSecretsT&& value) {
  ...
  BatchAssociateScramSecretResult& AddUnprocessedScramSecrets(UnprocessedScramSecretsT&& value) {
    m_unprocessedScramSecretsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchAssociateScramSecretResult& WithRequestId(RequestIdT&& value) {
