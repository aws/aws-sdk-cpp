...
class ReplicationInfoSummary {
 public:
  ...
  void SetSourceKafkaClusterAlias(SourceKafkaClusterAliasT&& value) {
    m_sourceKafkaClusterAliasHasBeenSet = true;
    m_sourceKafkaClusterAlias = std::forward<SourceKafkaClusterAliasT>(value);
  }
  template <typename SourceKafkaClusterAliasT = Aws::String>
  ReplicationInfoSummary& WithSourceKafkaClusterAlias(SourceKafkaClusterAliasT&& value) {
    SetSourceKafkaClusterAlias(std::forward<SourceKafkaClusterAliasT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetKafkaClusterAlias(TargetKafkaClusterAliasT&& value) {
    m_targetKafkaClusterAliasHasBeenSet = true;
    m_targetKafkaClusterAlias = std::forward<TargetKafkaClusterAliasT>(value);
  }
  template <typename TargetKafkaClusterAliasT = Aws::String>
  ReplicationInfoSummary& WithTargetKafkaClusterAlias(TargetKafkaClusterAliasT&& value) {
    SetTargetKafkaClusterAlias(std::forward<TargetKafkaClusterAliasT>(value));
    return *this;
  }
  ///@}
 private:
