...
class NodeInfo {
 public:
  ...
  void SetAddedToClusterTime(AddedToClusterTimeT&& value) {
    ...
    m_addedToClusterTime = std::forward<AddedToClusterTimeT>(value);
  }
  template <typename AddedToClusterTimeT = Aws::String>
  NodeInfo& WithAddedToClusterTime(AddedToClusterTimeT&& value) {
    SetAddedToClusterTime(std::forward<AddedToClusterTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBrokerNodeInfo(BrokerNodeInfoT&& value) {
    ...
    m_brokerNodeInfo = std::forward<BrokerNodeInfoT>(value);
  }
  template <typename BrokerNodeInfoT = BrokerNodeInfo>
  NodeInfo& WithBrokerNodeInfo(BrokerNodeInfoT&& value) {
    SetBrokerNodeInfo(std::forward<BrokerNodeInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetControllerNodeInfo(ControllerNodeInfoT&& value) {
    ...
    m_controllerNodeInfo = std::forward<ControllerNodeInfoT>(value);
  }
  template <typename ControllerNodeInfoT = ControllerNodeInfo>
  NodeInfo& WithControllerNodeInfo(ControllerNodeInfoT&& value) {
    SetControllerNodeInfo(std::forward<ControllerNodeInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeARN(NodeARNT&& value) {
    ...
    m_nodeARN = std::forward<NodeARNT>(value);
  }
  template <typename NodeARNT = Aws::String>
  NodeInfo& WithNodeARN(NodeARNT&& value) {
    SetNodeARN(std::forward<NodeARNT>(value));
    return *this;
  }
  ///@}
  ...
  inline NodeInfo& WithNodeType(NodeType value) {
    SetNodeType(value);
    return *this;
  }
  ///@}
  ...
  void SetZookeeperNodeInfo(ZookeeperNodeInfoT&& value) {
    ...
    m_zookeeperNodeInfo = std::forward<ZookeeperNodeInfoT>(value);
  }
  template <typename ZookeeperNodeInfoT = ZookeeperNodeInfo>
  NodeInfo& WithZookeeperNodeInfo(ZookeeperNodeInfoT&& value) {
    SetZookeeperNodeInfo(std::forward<ZookeeperNodeInfoT>(value));
    return *this;
  }
  ///@}
 private:
