...
class UpdateConnectivityResult {
 public:
  ...
  template <typename ClusterArnT = Aws::String>
  UpdateConnectivityResult& WithClusterArn(ClusterArnT&& value) {
  ...
  template <typename ClusterOperationArnT = Aws::String>
  UpdateConnectivityResult& WithClusterOperationArn(ClusterOperationArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConnectivityResult& WithRequestId(RequestIdT&& value) {
