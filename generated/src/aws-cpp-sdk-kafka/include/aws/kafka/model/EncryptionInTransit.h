...
class EncryptionInTransit {
 public:
  ...
  inline void SetClientBroker(ClientBroker value) {
    m_clientBrokerHasBeenSet = true;
    m_clientBroker = value;
  }
  inline EncryptionInTransit& WithClientBroker(ClientBroker value) {
    SetClientBroker(value);
    return *this;
  }
  ///@}
  ...
  inline EncryptionInTransit& WithInCluster(bool value) {
    SetInCluster(value);
    return *this;
  }
  ///@}
