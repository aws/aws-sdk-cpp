...
class ReplicatorSummary {
 public:
  ...
  inline void SetIsReplicatorReference(bool value) {
    m_isReplicatorReferenceHasBeenSet = true;
    m_isReplicatorReference = value;
  }
  inline ReplicatorSummary& WithIsReplicatorReference(bool value) {
    SetIsReplicatorReference(value);
    return *this;
  }
  ///@}
  ...
  void SetKafkaClustersSummary(KafkaClustersSummaryT&& value) {
    ...
    m_kafkaClustersSummary = std::forward<KafkaClustersSummaryT>(value);
  }
  template <typename KafkaClustersSummaryT = Aws::Vector<KafkaClusterSummary>>
  ReplicatorSummary& WithKafkaClustersSummary(KafkaClustersSummaryT&& value) {
    SetKafkaClustersSummary(std::forward<KafkaClustersSummaryT>(value));
    return *this;
  }
  ...
  ReplicatorSummary& AddKafkaClustersSummary(KafkaClustersSummaryT&& value) {
    m_kafkaClustersSummaryHasBeenSet = true;
    m_kafkaClustersSummary.emplace_back(std::forward<KafkaClustersSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicationInfoSummaryList(ReplicationInfoSummaryListT&& value) {
    ...
    m_replicationInfoSummaryList = std::forward<ReplicationInfoSummaryListT>(value);
  }
  template <typename ReplicationInfoSummaryListT = Aws::Vector<ReplicationInfoSummary>>
  ReplicatorSummary& WithReplicationInfoSummaryList(ReplicationInfoSummaryListT&& value) {
    SetReplicationInfoSummaryList(std::forward<ReplicationInfoSummaryListT>(value));
    return *this;
  }
  ...
  ReplicatorSummary& AddReplicationInfoSummaryList(ReplicationInfoSummaryListT&& value) {
    m_replicationInfoSummaryListHasBeenSet = true;
    m_replicationInfoSummaryList.emplace_back(std::forward<ReplicationInfoSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicatorResourceArn(ReplicatorResourceArnT&& value) {
    ...
    m_replicatorResourceArn = std::forward<ReplicatorResourceArnT>(value);
  }
  template <typename ReplicatorResourceArnT = Aws::String>
  ReplicatorSummary& WithReplicatorResourceArn(ReplicatorResourceArnT&& value) {
    SetReplicatorResourceArn(std::forward<ReplicatorResourceArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReplicatorSummary& WithReplicatorState(ReplicatorState value) {
