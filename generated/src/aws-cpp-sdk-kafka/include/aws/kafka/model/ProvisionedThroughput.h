...
class ProvisionedThroughput {
 public:
  ...
  inline ProvisionedThroughput& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVolumeThroughput(int value) {
    m_volumeThroughputHasBeenSet = true;
    m_volumeThroughput = value;
  }
  inline ProvisionedThroughput& WithVolumeThroughput(int value) {
    SetVolumeThroughput(value);
    return *this;
  }
  ///@}
 private:
