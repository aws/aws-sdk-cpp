...
class AWS_KAFKA_API KafkaClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  KafkaClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<KafkaEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for BatchAssociateScramSecret that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchAssociateScramSecretRequestT = Model::BatchAssociateScramSecretRequest>
  Model::BatchAssociateScramSecretOutcomeCallable BatchAssociateScramSecretCallable(
      const BatchAssociateScramSecretRequestT& request) const {
    return SubmitCallable(&KafkaClient::BatchAssociateScramSecret, request);
  }

  /**
   * An Async wrapper for BatchAssociateScramSecret that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchAssociateScramSecretRequestT = Model::BatchAssociateScramSecretRequest>
  void BatchAssociateScramSecretAsync(const BatchAssociateScramSecretRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDisassociateScramSecretOutcome BatchDisassociateScramSecret(
      const Model::BatchDisassociateScramSecretRequest& request) const;

  /**
   * A Callable wrapper for BatchDisassociateScramSecret that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDisassociateScramSecretRequestT = Model::BatchDisassociateScramSecretRequest>
  Model::BatchDisassociateScramSecretOutcomeCallable BatchDisassociateScramSecretCallable(
      const BatchDisassociateScramSecretRequestT& request) const {
    return SubmitCallable(&KafkaClient::BatchDisassociateScramSecret, request);
  }

  /**
   * An Async wrapper for BatchDisassociateScramSecret that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDisassociateScramSecretRequestT = Model::BatchDisassociateScramSecretRequest>
  void BatchDisassociateScramSecretAsync(const BatchDisassociateScramSecretRequestT& request,
  ...
  /**
   * An Async wrapper for CreateClusterV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateClusterV2RequestT = Model::CreateClusterV2Request>
  void CreateClusterV2Async(const CreateClusterV2RequestT& request, const CreateClusterV2ResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateReplicator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateReplicator that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateReplicatorRequestT = Model::CreateReplicatorRequest>
  void CreateReplicatorAsync(const CreateReplicatorRequestT& request, const CreateReplicatorResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReplicator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReplicator that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteReplicatorRequestT = Model::DeleteReplicatorRequest>
  ...
  /**
   * A Callable wrapper for DescribeClusterOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeClusterOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClusterOperationRequestT = Model::DescribeClusterOperationRequest>
  void DescribeClusterOperationAsync(const DescribeClusterOperationRequestT& request,
...
<p><h3>See Also:</h3>   <a
  ...
  virtual Model::DescribeClusterOperationV2Outcome DescribeClusterOperationV2(
      const Model::DescribeClusterOperationV2Request& request) const;

  /**
   * A Callable wrapper for DescribeClusterOperationV2 that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeClusterOperationV2RequestT = Model::DescribeClusterOperationV2Request>
  Model::DescribeClusterOperationV2OutcomeCallable DescribeClusterOperationV2Callable(
      const DescribeClusterOperationV2RequestT& request) const {
    return SubmitCallable(&KafkaClient::DescribeClusterOperationV2, request);
  }

  /**
   * An Async wrapper for DescribeClusterOperationV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClusterOperationV2RequestT = Model::DescribeClusterOperationV2Request>
  void DescribeClusterOperationV2Async(const DescribeClusterOperationV2RequestT& request,
                                       const DescribeClusterOperationV2ResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeClusterV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeClusterV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeClusterV2RequestT = Model::DescribeClusterV2Request>
  void DescribeClusterV2Async(const DescribeClusterV2RequestT& request, const DescribeClusterV2ResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeReplicator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeReplicator that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeReplicatorRequestT = Model::DescribeReplicatorRequest>
  void DescribeReplicatorAsync(const DescribeReplicatorRequestT& request, const DescribeReplicatorResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBootstrapBrokers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBootstrapBrokers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBootstrapBrokersRequestT = Model::GetBootstrapBrokersRequest>
  void GetBootstrapBrokersAsync(const GetBootstrapBrokersRequestT& request, const GetBootstrapBrokersResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetCompatibleKafkaVersionsOutcome GetCompatibleKafkaVersions(
      const Model::GetCompatibleKafkaVersionsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetCompatibleKafkaVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCompatibleKafkaVersionsRequestT = Model::GetCompatibleKafkaVersionsRequest>
  Model::GetCompatibleKafkaVersionsOutcomeCallable GetCompatibleKafkaVersionsCallable(
  ...
  /**
   * An Async wrapper for GetCompatibleKafkaVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCompatibleKafkaVersionsRequestT = Model::GetCompatibleKafkaVersionsRequest>
  void GetCompatibleKafkaVersionsAsync(const GetCompatibleKafkaVersionsResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for ListClientVpcConnections that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListClientVpcConnections that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListClientVpcConnectionsRequestT = Model::ListClientVpcConnectionsRequest>
  void ListClientVpcConnectionsAsync(const ListClientVpcConnectionsRequestT& request,
                                     const ListClientVpcConnectionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListClusterOperations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListClusterOperations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListClusterOperationsRequestT = Model::ListClusterOperationsRequest>
  void ListClusterOperationsAsync(const ListClusterOperationsRequestT& request, const ListClusterOperationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListClusterOperationsV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListClusterOperationsV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListClusterOperationsV2RequestT = Model::ListClusterOperationsV2Request>
  void ListClusterOperationsV2Async(const ListClusterOperationsV2RequestT& request,
                                    const ListClusterOperationsV2ResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListClustersV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListClustersV2RequestT = Model::ListClustersV2Request>
  void ListClustersV2Async(const ListClustersV2ResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListClustersV2RequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListKafkaVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListKafkaVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListKafkaVersionsRequestT = Model::ListKafkaVersionsRequest>
  void ListKafkaVersionsAsync(const ListKafkaVersionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListKafkaVersionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListReplicators that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListReplicatorsRequestT = Model::ListReplicatorsRequest>
  void ListReplicatorsAsync(const ListReplicatorsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListReplicatorsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListScramSecrets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListScramSecrets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListScramSecretsRequestT = Model::ListScramSecretsRequest>
  void ListScramSecretsAsync(const ListScramSecretsRequestT& request, const ListScramSecretsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListVpcConnectionsRequestT = Model::ListVpcConnectionsRequest>
  void ListVpcConnectionsAsync(const ListVpcConnectionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListVpcConnectionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RejectClientVpcConnection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RejectClientVpcConnectionRequestT = Model::RejectClientVpcConnectionRequest>
  Model::RejectClientVpcConnectionOutcomeCallable RejectClientVpcConnectionCallable(
      const RejectClientVpcConnectionRequestT& request) const {
    return SubmitCallable(&KafkaClient::RejectClientVpcConnection, request);
  }

  /**
   * An Async wrapper for RejectClientVpcConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RejectClientVpcConnectionRequestT = Model::RejectClientVpcConnectionRequest>
  void RejectClientVpcConnectionAsync(const RejectClientVpcConnectionRequestT& request,
                                      const RejectClientVpcConnectionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateBrokerCount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBrokerCount that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateBrokerCountRequestT = Model::UpdateBrokerCountRequest>
  void UpdateBrokerCountAsync(const UpdateBrokerCountRequestT& request, const UpdateBrokerCountResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateBrokerStorage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBrokerStorage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateBrokerStorageRequestT = Model::UpdateBrokerStorageRequest>
  void UpdateBrokerStorageAsync(const UpdateBrokerStorageRequestT& request, const UpdateBrokerStorageResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateBrokerType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBrokerType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateBrokerTypeRequestT = Model::UpdateBrokerTypeRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateClusterConfigurationOutcome UpdateClusterConfiguration(
      const Model::UpdateClusterConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateClusterConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateClusterConfigurationRequestT = Model::UpdateClusterConfigurationRequest>
  Model::UpdateClusterConfigurationOutcomeCallable UpdateClusterConfigurationCallable(
      const UpdateClusterConfigurationRequestT& request) const {
    return SubmitCallable(&KafkaClient::UpdateClusterConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateClusterConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateClusterConfigurationRequestT = Model::UpdateClusterConfigurationRequest>
  void UpdateClusterConfigurationAsync(const UpdateClusterConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateClusterKafkaVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateClusterKafkaVersionRequestT = Model::UpdateClusterKafkaVersionRequest>
  Model::UpdateClusterKafkaVersionOutcomeCallable UpdateClusterKafkaVersionCallable(
      const UpdateClusterKafkaVersionRequestT& request) const {
    return SubmitCallable(&KafkaClient::UpdateClusterKafkaVersion, request);
  }

  /**
   * An Async wrapper for UpdateClusterKafkaVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateClusterKafkaVersionRequestT = Model::UpdateClusterKafkaVersionRequest>
  void UpdateClusterKafkaVersionAsync(const UpdateClusterKafkaVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateConnectivity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateConnectivity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateConnectivityRequestT = Model::UpdateConnectivityRequest>
  void UpdateConnectivityAsync(const UpdateConnectivityRequestT& request, const UpdateConnectivityResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMonitoring that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMonitoring that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateMonitoringRequestT = Model::UpdateMonitoringRequest>
  void UpdateMonitoringAsync(const UpdateMonitoringRequestT& request, const UpdateMonitoringResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateReplicationInfo that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateReplicationInfo that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateReplicationInfoRequestT = Model::UpdateReplicationInfoRequest>
  void UpdateReplicationInfoAsync(const UpdateReplicationInfoRequestT& request, const UpdateReplicationInfoResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateSecurity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSecurityRequestT = Model::UpdateSecurityRequest>
  void UpdateSecurityAsync(const UpdateSecurityRequestT& request, const UpdateSecurityResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateStorage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateStorageRequestT = Model::UpdateStorageRequest>
