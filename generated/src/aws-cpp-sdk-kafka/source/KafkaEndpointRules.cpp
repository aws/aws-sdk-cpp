...
namespace Kafka
{
const size_t KafkaEndpointRules::RulesBlobStrLen = 3739;
const size_t KafkaEndpointRules::RulesBlobSize = 3740;
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','k','a','f',
'k','a','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','k','a','f','k','a','.','{','R','e','g','i',
