...
GroupSubscribedToTopicException::GroupSubscribedToTopicException(JsonView jsonValue) { *this = jsonValue; }

GroupSubscribedToTopicException& GroupSubscribedToTopicException::operator=(JsonView jsonValue) {
...
JsonValue GroupSubscribedToTopicException::Jsonize() const {
  JsonValue payload;
