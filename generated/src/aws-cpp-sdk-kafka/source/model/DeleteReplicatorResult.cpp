...
DeleteReplicatorResult::DeleteReplicatorResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteReplicatorResult& DeleteReplicatorResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
