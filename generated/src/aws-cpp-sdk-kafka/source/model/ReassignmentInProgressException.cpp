...
ReassignmentInProgressException::ReassignmentInProgressException(JsonView jsonValue) { *this = jsonValue; }

ReassignmentInProgressException& ReassignmentInProgressException::operator=(JsonView jsonValue) {
...
JsonValue ReassignmentInProgressException::Jsonize() const {
  JsonValue payload;
