...
TopicExistsException::TopicExistsException(JsonView jsonValue) { *this = jsonValue; }

TopicExistsException& TopicExistsException::operator=(JsonView jsonValue) {
...
JsonValue TopicExistsException::Jsonize() const {
  JsonValue payload;
