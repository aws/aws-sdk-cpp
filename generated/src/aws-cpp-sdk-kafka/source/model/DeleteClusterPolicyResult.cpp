...
DeleteClusterPolicyResult::DeleteClusterPolicyResult()
{
}

DeleteClusterPolicyResult::DeleteClusterPolicyResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
