...
NotControllerException::NotControllerException(JsonView jsonValue) { *this = jsonValue; }

NotControllerException& NotControllerException::operator=(JsonView jsonValue) {
...
JsonValue NotControllerException::Jsonize() const {
  JsonValue payload;
