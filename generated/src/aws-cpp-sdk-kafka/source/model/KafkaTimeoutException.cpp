...
KafkaTimeoutException::KafkaTimeoutException(JsonView jsonValue) { *this = jsonValue; }

KafkaTimeoutException& KafkaTimeoutException::operator=(JsonView jsonValue) {
...
JsonValue KafkaTimeoutException::Jsonize() const {
  JsonValue payload;
