...
AuthorizerLogs::AuthorizerLogs(JsonView jsonValue) { *this = jsonValue; }

AuthorizerLogs& AuthorizerLogs::operator=(JsonView jsonValue) {
...
JsonValue AuthorizerLogs::Jsonize() const {
  JsonValue payload;
