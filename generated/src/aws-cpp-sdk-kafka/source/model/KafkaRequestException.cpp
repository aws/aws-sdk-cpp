...
KafkaRequestException::KafkaRequestException(JsonView jsonValue) { *this = jsonValue; }

KafkaRequestException& KafkaRequestException::operator=(JsonView jsonValue) {
...
JsonValue KafkaRequestException::Jsonize() const {
  JsonValue payload;
