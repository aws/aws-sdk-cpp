...
ChannelLoggingInfo::ChannelLoggingInfo(JsonView jsonValue) { *this = jsonValue; }

ChannelLoggingInfo& ChannelLoggingInfo::operator=(JsonView jsonValue) {
...
JsonValue ChannelLoggingInfo::Jsonize() const {
  JsonValue payload;
