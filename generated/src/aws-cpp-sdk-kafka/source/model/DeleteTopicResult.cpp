...
DeleteTopicResult::DeleteTopicResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteTopicResult& DeleteTopicResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
