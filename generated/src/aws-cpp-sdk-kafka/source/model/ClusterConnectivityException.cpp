...
ClusterConnectivityException::ClusterConnectivityException(JsonView jsonValue) { *this = jsonValue; }

ClusterConnectivityException& ClusterConnectivityException::operator=(JsonView jsonValue) {
...
JsonValue ClusterConnectivityException::Jsonize() const {
  JsonValue payload;
