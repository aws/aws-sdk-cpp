...
ListClusterOperationsV2Result::ListClusterOperationsV2Result()
{
}

ListClusterOperationsV2Result::ListClusterOperationsV2Result(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
