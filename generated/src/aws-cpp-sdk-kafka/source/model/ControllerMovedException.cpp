...
ControllerMovedException::ControllerMovedException(JsonView jsonValue) { *this = jsonValue; }

ControllerMovedException& ControllerMovedException::operator=(JsonView jsonValue) {
...
JsonValue ControllerMovedException::Jsonize() const {
  JsonValue payload;
