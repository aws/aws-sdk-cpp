...
UnknownTopicOrPartitionException::UnknownTopicOrPartitionException(JsonView jsonValue) { *this = jsonValue; }

UnknownTopicOrPartitionException& UnknownTopicOrPartitionException::operator=(JsonView jsonValue) {
...
JsonValue UnknownTopicOrPartitionException::Jsonize() const {
  JsonValue payload;
