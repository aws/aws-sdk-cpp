...
RejectClientVpcConnectionResult::RejectClientVpcConnectionResult()
{
}

RejectClientVpcConnectionResult::RejectClientVpcConnectionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
