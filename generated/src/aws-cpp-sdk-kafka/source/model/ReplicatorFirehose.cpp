...
ReplicatorFirehose::ReplicatorFirehose(JsonView jsonValue) { *this = jsonValue; }

ReplicatorFirehose& ReplicatorFirehose::operator=(JsonView jsonValue) {
...
JsonValue ReplicatorFirehose::Jsonize() const {
  JsonValue payload;
