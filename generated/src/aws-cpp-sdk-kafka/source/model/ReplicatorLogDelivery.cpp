...
ReplicatorLogDelivery::ReplicatorLogDelivery(JsonView jsonValue) { *this = jsonValue; }

ReplicatorLogDelivery& ReplicatorLogDelivery::operator=(JsonView jsonValue) {
...
JsonValue ReplicatorLogDelivery::Jsonize() const {
  JsonValue payload;
