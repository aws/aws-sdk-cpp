...
ReplicatorCloudWatchLogs::ReplicatorCloudWatchLogs(JsonView jsonValue) { *this = jsonValue; }

ReplicatorCloudWatchLogs& ReplicatorCloudWatchLogs::operator=(JsonView jsonValue) {
...
JsonValue ReplicatorCloudWatchLogs::Jsonize() const {
  JsonValue payload;
