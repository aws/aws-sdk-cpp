...
class AWS_KENDRA_API KendraClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  KendraClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<KendraEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateEntitiesToExperienceOutcome AssociateEntitiesToExperience(
      const Model::AssociateEntitiesToExperienceRequest& request) const;

  /**
   * A Callable wrapper for AssociateEntitiesToExperience that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateEntitiesToExperienceRequestT = Model::AssociateEntitiesToExperienceRequest>
  Model::AssociateEntitiesToExperienceOutcomeCallable AssociateEntitiesToExperienceCallable(
      const AssociateEntitiesToExperienceRequestT& request) const {
    return SubmitCallable(&KendraClient::AssociateEntitiesToExperience, request);
  }

  /**
   * An Async wrapper for AssociateEntitiesToExperience that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateEntitiesToExperienceRequestT = Model::AssociateEntitiesToExperienceRequest>
  void AssociateEntitiesToExperienceAsync(const AssociateEntitiesToExperienceRequestT& request,
                                          const AssociateEntitiesToExperienceResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociatePersonasToEntitiesOutcome AssociatePersonasToEntities(
      const Model::AssociatePersonasToEntitiesRequest& request) const;

  /**
   * A Callable wrapper for AssociatePersonasToEntities that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociatePersonasToEntitiesRequestT = Model::AssociatePersonasToEntitiesRequest>
  Model::AssociatePersonasToEntitiesOutcomeCallable AssociatePersonasToEntitiesCallable(
      const AssociatePersonasToEntitiesRequestT& request) const {
    return SubmitCallable(&KendraClient::AssociatePersonasToEntities, request);
  }

  /**
   * An Async wrapper for AssociatePersonasToEntities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociatePersonasToEntitiesRequestT = Model::AssociatePersonasToEntitiesRequest>
  void AssociatePersonasToEntitiesAsync(const AssociatePersonasToEntitiesRequestT& request,
                                        const AssociatePersonasToEntitiesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDeleteDocument that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteDocument that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchDeleteDocumentRequestT = Model::BatchDeleteDocumentRequest>
  void BatchDeleteDocumentAsync(const BatchDeleteDocumentRequestT& request, const BatchDeleteDocumentResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDeleteFeaturedResultsSetOutcome BatchDeleteFeaturedResultsSet(
      const Model::BatchDeleteFeaturedResultsSetRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteFeaturedResultsSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDeleteFeaturedResultsSetRequestT = Model::BatchDeleteFeaturedResultsSetRequest>
  Model::BatchDeleteFeaturedResultsSetOutcomeCallable BatchDeleteFeaturedResultsSetCallable(
      const BatchDeleteFeaturedResultsSetRequestT& request) const {
    return SubmitCallable(&KendraClient::BatchDeleteFeaturedResultsSet, request);
  }

  /**
   * An Async wrapper for BatchDeleteFeaturedResultsSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeleteFeaturedResultsSetRequestT = Model::BatchDeleteFeaturedResultsSetRequest>
  void BatchDeleteFeaturedResultsSetAsync(const BatchDeleteFeaturedResultsSetRequestT& request,
                                          const BatchDeleteFeaturedResultsSetResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetDocumentStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetDocumentStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetDocumentStatusRequestT = Model::BatchGetDocumentStatusRequest>
  void BatchGetDocumentStatusAsync(const BatchGetDocumentStatusRequestT& request,
                                   const BatchGetDocumentStatusResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchPutDocument that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchPutDocument that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchPutDocumentRequestT = Model::BatchPutDocumentRequest>
  void BatchPutDocumentAsync(const BatchPutDocumentRequestT& request, const BatchPutDocumentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ClearQuerySuggestions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ClearQuerySuggestions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ClearQuerySuggestionsRequestT = Model::ClearQuerySuggestionsRequest>
  void ClearQuerySuggestionsAsync(const ClearQuerySuggestionsRequestT& request, const ClearQuerySuggestionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAccessControlConfigurationOutcome CreateAccessControlConfiguration(
      const Model::CreateAccessControlConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateAccessControlConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateAccessControlConfigurationRequestT = Model::CreateAccessControlConfigurationRequest>
  Model::CreateAccessControlConfigurationOutcomeCallable CreateAccessControlConfigurationCallable(
      const CreateAccessControlConfigurationRequestT& request) const {
    return SubmitCallable(&KendraClient::CreateAccessControlConfiguration, request);
  }

  /**
   * An Async wrapper for CreateAccessControlConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateAccessControlConfigurationRequestT = Model::CreateAccessControlConfigurationRequest>
  void CreateAccessControlConfigurationAsync(const CreateAccessControlConfigurationRequestT& request,
                                             const CreateAccessControlConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataSource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataSource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDataSourceRequestT = Model::CreateDataSourceRequest>
  ...
  /**
   * A Callable wrapper for CreateExperience that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateExperience that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateExperienceRequestT = Model::CreateExperienceRequest>
  void CreateExperienceAsync(const CreateExperienceRequestT& request, const CreateExperienceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateFaq that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFaqRequestT = Model::CreateFaqRequest>
  void CreateFaqAsync(const CreateFaqRequestT& request, const CreateFaqResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateFeaturedResultsSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateFeaturedResultsSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFeaturedResultsSetRequestT = Model::CreateFeaturedResultsSetRequest>
  void CreateFeaturedResultsSetAsync(const CreateFeaturedResultsSetRequestT& request,
                                     const CreateFeaturedResultsSetResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateQuerySuggestionsBlockListOutcome CreateQuerySuggestionsBlockList(
      const Model::CreateQuerySuggestionsBlockListRequest& request) const;

  /**
   * A Callable wrapper for CreateQuerySuggestionsBlockList that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateQuerySuggestionsBlockListRequestT = Model::CreateQuerySuggestionsBlockListRequest>
  Model::CreateQuerySuggestionsBlockListOutcomeCallable CreateQuerySuggestionsBlockListCallable(
      const CreateQuerySuggestionsBlockListRequestT& request) const {
    return SubmitCallable(&KendraClient::CreateQuerySuggestionsBlockList, request);
  }

  /**
   * An Async wrapper for CreateQuerySuggestionsBlockList that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateQuerySuggestionsBlockListRequestT = Model::CreateQuerySuggestionsBlockListRequest>
  void CreateQuerySuggestionsBlockListAsync(const CreateQuerySuggestionsBlockListRequestT& request,
                                            const CreateQuerySuggestionsBlockListResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateThesaurus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateThesaurusRequestT = Model::CreateThesaurusRequest>
  void CreateThesaurusAsync(const CreateThesaurusRequestT& request, const CreateThesaurusResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAccessControlConfigurationOutcome DeleteAccessControlConfiguration(
      const Model::DeleteAccessControlConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteAccessControlConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteAccessControlConfigurationRequestT = Model::DeleteAccessControlConfigurationRequest>
  Model::DeleteAccessControlConfigurationOutcomeCallable DeleteAccessControlConfigurationCallable(
      const DeleteAccessControlConfigurationRequestT& request) const {
    return SubmitCallable(&KendraClient::DeleteAccessControlConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteAccessControlConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteAccessControlConfigurationRequestT = Model::DeleteAccessControlConfigurationRequest>
  void DeleteAccessControlConfigurationAsync(const DeleteAccessControlConfigurationRequestT& request,
                                             const DeleteAccessControlConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDataSource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDataSource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDataSourceRequestT = Model::DeleteDataSourceRequest>
  void DeleteDataSourceAsync(const DeleteDataSourceRequestT& request, const DeleteDataSourceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteExperience that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteExperience that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteExperienceRequestT = Model::DeleteExperienceRequest>
  void DeleteExperienceAsync(const DeleteExperienceRequestT& request, const DeleteExperienceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFaq that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFaqRequestT = Model::DeleteFaqRequest>
  void DeleteFaqAsync(const DeleteFaqRequestT& request, const DeleteFaqResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePrincipalMapping that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePrincipalMapping that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePrincipalMappingRequestT = Model::DeletePrincipalMappingRequest>
  void DeletePrincipalMappingAsync(const DeletePrincipalMappingRequestT& request,
                                   const DeletePrincipalMappingResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteQuerySuggestionsBlockListOutcome DeleteQuerySuggestionsBlockList(
      const Model::DeleteQuerySuggestionsBlockListRequest& request) const;

  /**
   * A Callable wrapper for DeleteQuerySuggestionsBlockList that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteQuerySuggestionsBlockListRequestT = Model::DeleteQuerySuggestionsBlockListRequest>
  Model::DeleteQuerySuggestionsBlockListOutcomeCallable DeleteQuerySuggestionsBlockListCallable(
      const DeleteQuerySuggestionsBlockListRequestT& request) const {
    return SubmitCallable(&KendraClient::DeleteQuerySuggestionsBlockList, request);
  }

  /**
   * An Async wrapper for DeleteQuerySuggestionsBlockList that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteQuerySuggestionsBlockListRequestT = Model::DeleteQuerySuggestionsBlockListRequest>
  void DeleteQuerySuggestionsBlockListAsync(const DeleteQuerySuggestionsBlockListRequestT& request,
                                            const DeleteQuerySuggestionsBlockListResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteThesaurus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteThesaurusRequestT = Model::DeleteThesaurusRequest>
  void DeleteThesaurusAsync(const DeleteThesaurusRequestT& request, const DeleteThesaurusResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAccessControlConfigurationOutcome DescribeAccessControlConfiguration(
      const Model::DescribeAccessControlConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeAccessControlConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeAccessControlConfigurationRequestT = Model::DescribeAccessControlConfigurationRequest>
  Model::DescribeAccessControlConfigurationOutcomeCallable DescribeAccessControlConfigurationCallable(
      const DescribeAccessControlConfigurationRequestT& request) const {
    return SubmitCallable(&KendraClient::DescribeAccessControlConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeAccessControlConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAccessControlConfigurationRequestT = Model::DescribeAccessControlConfigurationRequest>
  void DescribeAccessControlConfigurationAsync(const DescribeAccessControlConfigurationRequestT& request,
                                               const DescribeAccessControlConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDataSource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDataSource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDataSourceRequestT = Model::DescribeDataSourceRequest>
  void DescribeDataSourceAsync(const DescribeDataSourceRequestT& request, const DescribeDataSourceResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeExperience that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeExperience that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeExperienceRequestT = Model::DescribeExperienceRequest>
  void DescribeExperienceAsync(const DescribeExperienceRequestT& request, const DescribeExperienceResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeFaq that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeFaqRequestT = Model::DescribeFaqRequest>
  void DescribeFaqAsync(const DescribeFaqRequestT& request, const DescribeFaqResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeFeaturedResultsSetOutcome DescribeFeaturedResultsSet(
      const Model::DescribeFeaturedResultsSetRequest& request) const;

  /**
   * A Callable wrapper for DescribeFeaturedResultsSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeFeaturedResultsSetRequestT = Model::DescribeFeaturedResultsSetRequest>
  Model::DescribeFeaturedResultsSetOutcomeCallable DescribeFeaturedResultsSetCallable(
      const DescribeFeaturedResultsSetRequestT& request) const {
    return SubmitCallable(&KendraClient::DescribeFeaturedResultsSet, request);
  }

  /**
   * An Async wrapper for DescribeFeaturedResultsSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFeaturedResultsSetRequestT = Model::DescribeFeaturedResultsSetRequest>
  void DescribeFeaturedResultsSetAsync(const DescribeFeaturedResultsSetRequestT& request,
                                       const DescribeFeaturedResultsSetResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeIndex that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeIndexRequestT = Model::DescribeIndexRequest>
  void DescribeIndexAsync(const DescribeIndexRequestT& request, const DescribeIndexResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePrincipalMapping that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePrincipalMapping that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePrincipalMappingRequestT = Model::DescribePrincipalMappingRequest>
  void DescribePrincipalMappingAsync(const DescribePrincipalMappingRequestT& request,
                                     const DescribePrincipalMappingResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeQuerySuggestionsBlockListOutcome DescribeQuerySuggestionsBlockList(
      const Model::DescribeQuerySuggestionsBlockListRequest& request) const;

  /**
   * A Callable wrapper for DescribeQuerySuggestionsBlockList that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeQuerySuggestionsBlockListRequestT = Model::DescribeQuerySuggestionsBlockListRequest>
  Model::DescribeQuerySuggestionsBlockListOutcomeCallable DescribeQuerySuggestionsBlockListCallable(
      const DescribeQuerySuggestionsBlockListRequestT& request) const {
    return SubmitCallable(&KendraClient::DescribeQuerySuggestionsBlockList, request);
  }

  /**
   * An Async wrapper for DescribeQuerySuggestionsBlockList that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeQuerySuggestionsBlockListRequestT = Model::DescribeQuerySuggestionsBlockListRequest>
  void DescribeQuerySuggestionsBlockListAsync(const DescribeQuerySuggestionsBlockListRequestT& request,
                                              const DescribeQuerySuggestionsBlockListResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeQuerySuggestionsConfigOutcome DescribeQuerySuggestionsConfig(
      const Model::DescribeQuerySuggestionsConfigRequest& request) const;

  /**
   * A Callable wrapper for DescribeQuerySuggestionsConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeQuerySuggestionsConfigRequestT = Model::DescribeQuerySuggestionsConfigRequest>
  Model::DescribeQuerySuggestionsConfigOutcomeCallable DescribeQuerySuggestionsConfigCallable(
      const DescribeQuerySuggestionsConfigRequestT& request) const {
    return SubmitCallable(&KendraClient::DescribeQuerySuggestionsConfig, request);
  }

  /**
   * An Async wrapper for DescribeQuerySuggestionsConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeQuerySuggestionsConfigRequestT = Model::DescribeQuerySuggestionsConfigRequest>
  void DescribeQuerySuggestionsConfigAsync(const DescribeQuerySuggestionsConfigRequestT& request,
                                           const DescribeQuerySuggestionsConfigResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeThesaurus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeThesaurus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeThesaurusRequestT = Model::DescribeThesaurusRequest>
  void DescribeThesaurusAsync(const DescribeThesaurusRequestT& request, const DescribeThesaurusResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateEntitiesFromExperienceOutcome DisassociateEntitiesFromExperience(
      const Model::DisassociateEntitiesFromExperienceRequest& request) const;

  /**
   * A Callable wrapper for DisassociateEntitiesFromExperience that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateEntitiesFromExperienceRequestT = Model::DisassociateEntitiesFromExperienceRequest>
  Model::DisassociateEntitiesFromExperienceOutcomeCallable DisassociateEntitiesFromExperienceCallable(
      const DisassociateEntitiesFromExperienceRequestT& request) const {
    return SubmitCallable(&KendraClient::DisassociateEntitiesFromExperience, request);
  }

  /**
   * An Async wrapper for DisassociateEntitiesFromExperience that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateEntitiesFromExperienceRequestT = Model::DisassociateEntitiesFromExperienceRequest>
  void DisassociateEntitiesFromExperienceAsync(const DisassociateEntitiesFromExperienceRequestT& request,
                                               const DisassociateEntitiesFromExperienceResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociatePersonasFromEntitiesOutcome DisassociatePersonasFromEntities(
      const Model::DisassociatePersonasFromEntitiesRequest& request) const;

  /**
   * A Callable wrapper for DisassociatePersonasFromEntities that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociatePersonasFromEntitiesRequestT = Model::DisassociatePersonasFromEntitiesRequest>
  Model::DisassociatePersonasFromEntitiesOutcomeCallable DisassociatePersonasFromEntitiesCallable(
      const DisassociatePersonasFromEntitiesRequestT& request) const {
    return SubmitCallable(&KendraClient::DisassociatePersonasFromEntities, request);
  }

  /**
   * An Async wrapper for DisassociatePersonasFromEntities that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociatePersonasFromEntitiesRequestT = Model::DisassociatePersonasFromEntitiesRequest>
  void DisassociatePersonasFromEntitiesAsync(const DisassociatePersonasFromEntitiesRequestT& request,
                                             const DisassociatePersonasFromEntitiesResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetQuerySuggestions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetQuerySuggestions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetQuerySuggestionsRequestT = Model::GetQuerySuggestionsRequest>
  void GetQuerySuggestionsAsync(const GetQuerySuggestionsRequestT& request, const GetQuerySuggestionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSnapshots that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSnapshotsRequestT = Model::GetSnapshotsRequest>
  void GetSnapshotsAsync(const GetSnapshotsRequestT& request, const GetSnapshotsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAccessControlConfigurationsOutcome ListAccessControlConfigurations(
      const Model::ListAccessControlConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListAccessControlConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAccessControlConfigurationsRequestT = Model::ListAccessControlConfigurationsRequest>
  Model::ListAccessControlConfigurationsOutcomeCallable ListAccessControlConfigurationsCallable(
      const ListAccessControlConfigurationsRequestT& request) const {
    return SubmitCallable(&KendraClient::ListAccessControlConfigurations, request);
  }

  /**
   * An Async wrapper for ListAccessControlConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAccessControlConfigurationsRequestT = Model::ListAccessControlConfigurationsRequest>
  void ListAccessControlConfigurationsAsync(const ListAccessControlConfigurationsRequestT& request,
                                            const ListAccessControlConfigurationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDataSourceSyncJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataSourceSyncJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataSourceSyncJobsRequestT = Model::ListDataSourceSyncJobsRequest>
  void ListDataSourceSyncJobsAsync(const ListDataSourceSyncJobsRequestT& request,
                                   const ListDataSourceSyncJobsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListDataSources that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListDataSourcesRequestT = Model::ListDataSourcesRequest>
  ...
  /**
   * A Callable wrapper for ListEntityPersonas that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEntityPersonas that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEntityPersonasRequestT = Model::ListEntityPersonasRequest>
  void ListEntityPersonasAsync(const ListEntityPersonasRequestT& request, const ListEntityPersonasResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListExperienceEntities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListExperienceEntities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListExperienceEntitiesRequestT = Model::ListExperienceEntitiesRequest>
  void ListExperienceEntitiesAsync(const ListExperienceEntitiesRequestT& request,
                                   const ListExperienceEntitiesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListExperiences that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListExperiencesRequestT = Model::ListExperiencesRequest>
  void ListExperiencesAsync(const ListExperiencesRequestT& request, const ListExperiencesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListFaqs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFaqsRequestT = Model::ListFaqsRequest>
  void ListFaqsAsync(const ListFaqsRequestT& request, const ListFaqsResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListFeaturedResultsSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFeaturedResultsSets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFeaturedResultsSetsRequestT = Model::ListFeaturedResultsSetsRequest>
  void ListFeaturedResultsSetsAsync(const ListFeaturedResultsSetsRequestT& request,
                                    const ListFeaturedResultsSetsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListGroupsOlderThanOrderingIdOutcome ListGroupsOlderThanOrderingId(
      const Model::ListGroupsOlderThanOrderingIdRequest& request) const;

  /**
   * A Callable wrapper for ListGroupsOlderThanOrderingId that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListGroupsOlderThanOrderingIdRequestT = Model::ListGroupsOlderThanOrderingIdRequest>
  Model::ListGroupsOlderThanOrderingIdOutcomeCallable ListGroupsOlderThanOrderingIdCallable(
      const ListGroupsOlderThanOrderingIdRequestT& request) const {
    return SubmitCallable(&KendraClient::ListGroupsOlderThanOrderingId, request);
  }

  /**
   * An Async wrapper for ListGroupsOlderThanOrderingId that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListGroupsOlderThanOrderingIdRequestT = Model::ListGroupsOlderThanOrderingIdRequest>
  void ListGroupsOlderThanOrderingIdAsync(const ListGroupsOlderThanOrderingIdRequestT& request,
                                          const ListGroupsOlderThanOrderingIdResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListIndices that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListIndicesRequestT = Model::ListIndicesRequest>
  void ListIndicesAsync(const ListIndicesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListIndicesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListQuerySuggestionsBlockListsOutcome ListQuerySuggestionsBlockLists(
      const Model::ListQuerySuggestionsBlockListsRequest& request) const;

  /**
   * A Callable wrapper for ListQuerySuggestionsBlockLists that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListQuerySuggestionsBlockListsRequestT = Model::ListQuerySuggestionsBlockListsRequest>
  Model::ListQuerySuggestionsBlockListsOutcomeCallable ListQuerySuggestionsBlockListsCallable(
      const ListQuerySuggestionsBlockListsRequestT& request) const {
    return SubmitCallable(&KendraClient::ListQuerySuggestionsBlockLists, request);
  }

  /**
   * An Async wrapper for ListQuerySuggestionsBlockLists that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListQuerySuggestionsBlockListsRequestT = Model::ListQuerySuggestionsBlockListsRequest>
  void ListQuerySuggestionsBlockListsAsync(const ListQuerySuggestionsBlockListsRequestT& request,
                                           const ListQuerySuggestionsBlockListsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListThesauri that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListThesauriRequestT = Model::ListThesauriRequest>
  void ListThesauriAsync(const ListThesauriRequestT& request, const ListThesauriResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutPrincipalMapping that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutPrincipalMapping that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutPrincipalMappingRequestT = Model::PutPrincipalMappingRequest>
  void PutPrincipalMappingAsync(const PutPrincipalMappingRequestT& request, const PutPrincipalMappingResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename QueryRequestT = Model::QueryRequest>
  void QueryAsync(const QueryRequestT& request, const QueryResponseReceivedHandler& handler,
                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartDataSourceSyncJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartDataSourceSyncJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartDataSourceSyncJobRequestT = Model::StartDataSourceSyncJobRequest>
  void StartDataSourceSyncJobAsync(const StartDataSourceSyncJobRequestT& request,
                                   const StartDataSourceSyncJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopDataSourceSyncJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopDataSourceSyncJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopDataSourceSyncJobRequestT = Model::StopDataSourceSyncJobRequest>
  void StopDataSourceSyncJobAsync(const StopDataSourceSyncJobRequestT& request, const StopDataSourceSyncJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SubmitFeedback that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SubmitFeedbackRequestT = Model::SubmitFeedbackRequest>
  void SubmitFeedbackAsync(const SubmitFeedbackRequestT& request, const SubmitFeedbackResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAccessControlConfigurationOutcome UpdateAccessControlConfiguration(
      const Model::UpdateAccessControlConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateAccessControlConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateAccessControlConfigurationRequestT = Model::UpdateAccessControlConfigurationRequest>
  Model::UpdateAccessControlConfigurationOutcomeCallable UpdateAccessControlConfigurationCallable(
      const UpdateAccessControlConfigurationRequestT& request) const {
    return SubmitCallable(&KendraClient::UpdateAccessControlConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateAccessControlConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateAccessControlConfigurationRequestT = Model::UpdateAccessControlConfigurationRequest>
  void UpdateAccessControlConfigurationAsync(const UpdateAccessControlConfigurationRequestT& request,
                                             const UpdateAccessControlConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDataSource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDataSource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDataSourceRequestT = Model::UpdateDataSourceRequest>
  void UpdateDataSourceAsync(const UpdateDataSourceRequestT& request, const UpdateDataSourceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateExperience that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateExperience that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateExperienceRequestT = Model::UpdateExperienceRequest>
  void UpdateExperienceAsync(const UpdateExperienceRequestT& request, const UpdateExperienceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateFeaturedResultsSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFeaturedResultsSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFeaturedResultsSetRequestT = Model::UpdateFeaturedResultsSetRequest>
  void UpdateFeaturedResultsSetAsync(const UpdateFeaturedResultsSetRequestT& request,
                                     const UpdateFeaturedResultsSetResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateQuerySuggestionsBlockListOutcome UpdateQuerySuggestionsBlockList(
      const Model::UpdateQuerySuggestionsBlockListRequest& request) const;

  /**
   * A Callable wrapper for UpdateQuerySuggestionsBlockList that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateQuerySuggestionsBlockListRequestT = Model::UpdateQuerySuggestionsBlockListRequest>
  Model::UpdateQuerySuggestionsBlockListOutcomeCallable UpdateQuerySuggestionsBlockListCallable(
      const UpdateQuerySuggestionsBlockListRequestT& request) const {
    return SubmitCallable(&KendraClient::UpdateQuerySuggestionsBlockList, request);
  }

  /**
   * An Async wrapper for UpdateQuerySuggestionsBlockList that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateQuerySuggestionsBlockListRequestT = Model::UpdateQuerySuggestionsBlockListRequest>
  void UpdateQuerySuggestionsBlockListAsync(const UpdateQuerySuggestionsBlockListRequestT& request,
                                            const UpdateQuerySuggestionsBlockListResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateQuerySuggestionsConfigOutcome UpdateQuerySuggestionsConfig(
      const Model::UpdateQuerySuggestionsConfigRequest& request) const;

  /**
   * A Callable wrapper for UpdateQuerySuggestionsConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateQuerySuggestionsConfigRequestT = Model::UpdateQuerySuggestionsConfigRequest>
  Model::UpdateQuerySuggestionsConfigOutcomeCallable UpdateQuerySuggestionsConfigCallable(
      const UpdateQuerySuggestionsConfigRequestT& request) const {
    return SubmitCallable(&KendraClient::UpdateQuerySuggestionsConfig, request);
  }

  /**
   * An Async wrapper for UpdateQuerySuggestionsConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQuerySuggestionsConfigRequestT = Model::UpdateQuerySuggestionsConfigRequest>
  void UpdateQuerySuggestionsConfigAsync(const UpdateQuerySuggestionsConfigRequestT& request,
                                         const UpdateQuerySuggestionsConfigResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateThesaurus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateThesaurusRequestT = Model::UpdateThesaurusRequest>
  void UpdateThesaurusAsync(const UpdateThesaurusRequestT& request, const UpdateThesaurusResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
