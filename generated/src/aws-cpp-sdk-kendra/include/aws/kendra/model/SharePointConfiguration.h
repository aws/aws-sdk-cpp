...
class SharePointConfiguration {
 public:
  ...
  inline void SetSharePointVersion(SharePointVersion value) {
    m_sharePointVersionHasBeenSet = true;
    m_sharePointVersion = value;
  }
  inline SharePointConfiguration& WithSharePointVersion(SharePointVersion value) {
    SetSharePointVersion(value);
    return *this;
  }
  ///@}
  ...
  inline SharePointConfiguration& WithCrawlAttachments(bool value) {
  ...
  inline SharePointConfiguration& WithUseChangeLog(bool value) {
  ...
  inline SharePointConfiguration& WithDisableLocalGroups(bool value) {
  ...
  inline void SetAuthenticationType(SharePointOnlineAuthenticationType value) {
    m_authenticationTypeHasBeenSet = true;
    m_authenticationType = value;
  }
  inline SharePointConfiguration& WithAuthenticationType(SharePointOnlineAuthenticationType value) {
