...
class ListExperienceEntitiesResult {
 public:
  ...
  template <typename SummaryItemsT = Aws::Vector<ExperienceEntitiesSummary>>
  ListExperienceEntitiesResult& WithSummaryItems(SummaryItemsT&& value) {
    SetSummaryItems(std::forward<SummaryItemsT>(value));
    return *this;
  }
  template <typename SummaryItemsT = ExperienceEntitiesSummary>
  ListExperienceEntitiesResult& AddSummaryItems(SummaryItemsT&& value) {
    m_summaryItemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListExperienceEntitiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExperienceEntitiesResult& WithRequestId(RequestIdT&& value) {
