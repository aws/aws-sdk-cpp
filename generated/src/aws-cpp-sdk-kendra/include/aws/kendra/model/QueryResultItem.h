...
class QueryResultItem {
 public:
  ...
  inline void SetType(QueryResultType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline QueryResultItem& WithType(QueryResultType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFormat(QueryResultFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline QueryResultItem& WithFormat(QueryResultFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  void SetDocumentTitle(DocumentTitleT&& value) {
    ...
    m_documentTitle = std::forward<DocumentTitleT>(value);
  }
  template <typename DocumentTitleT = TextWithHighlights>
  QueryResultItem& WithDocumentTitle(DocumentTitleT&& value) {
    SetDocumentTitle(std::forward<DocumentTitleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDocumentExcerpt(DocumentExcerptT&& value) {
    ...
    m_documentExcerpt = std::forward<DocumentExcerptT>(value);
  }
  template <typename DocumentExcerptT = TextWithHighlights>
  QueryResultItem& WithDocumentExcerpt(DocumentExcerptT&& value) {
    SetDocumentExcerpt(std::forward<DocumentExcerptT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDocumentURI(DocumentURIT&& value) {
    ...
    m_documentURI = std::forward<DocumentURIT>(value);
  }
  template <typename DocumentURIT = Aws::String>
  QueryResultItem& WithDocumentURI(DocumentURIT&& value) {
    SetDocumentURI(std::forward<DocumentURIT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDocumentAttributes(DocumentAttributesT&& value) {
    ...
    m_documentAttributes = std::forward<DocumentAttributesT>(value);
  }
  template <typename DocumentAttributesT = Aws::Vector<DocumentAttribute>>
  QueryResultItem& WithDocumentAttributes(DocumentAttributesT&& value) {
    SetDocumentAttributes(std::forward<DocumentAttributesT>(value));
    return *this;
  }
  template <typename DocumentAttributesT = DocumentAttribute>
  QueryResultItem& AddDocumentAttributes(DocumentAttributesT&& value) {
    m_documentAttributesHasBeenSet = true;
    m_documentAttributes.emplace_back(std::forward<DocumentAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScoreAttributes(ScoreAttributesT&& value) {
    ...
    m_scoreAttributes = std::forward<ScoreAttributesT>(value);
  }
  template <typename ScoreAttributesT = ScoreAttributes>
  QueryResultItem& WithScoreAttributes(ScoreAttributesT&& value) {
    SetScoreAttributes(std::forward<ScoreAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFeedbackToken(FeedbackTokenT&& value) {
    ...
    m_feedbackToken = std::forward<FeedbackTokenT>(value);
  }
  template <typename FeedbackTokenT = Aws::String>
  QueryResultItem& WithFeedbackToken(FeedbackTokenT&& value) {
    SetFeedbackToken(std::forward<FeedbackTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTableExcerpt(TableExcerptT&& value) {
    ...
    m_tableExcerpt = std::forward<TableExcerptT>(value);
  }
  template <typename TableExcerptT = TableExcerpt>
  QueryResultItem& WithTableExcerpt(TableExcerptT&& value) {
    SetTableExcerpt(std::forward<TableExcerptT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCollapsedResultDetail(CollapsedResultDetailT&& value) {
    ...
    m_collapsedResultDetail = std::forward<CollapsedResultDetailT>(value);
  }
  template <typename CollapsedResultDetailT = CollapsedResultDetail>
  QueryResultItem& WithCollapsedResultDetail(CollapsedResultDetailT&& value) {
    SetCollapsedResultDetail(std::forward<CollapsedResultDetailT>(value));
    return *this;
  }
  ///@}
 private:
