...
class UserContext {
 public:
  ...
  void SetDataSourceGroups(DataSourceGroupsT&& value) {
    ...
    m_dataSourceGroups = std::forward<DataSourceGroupsT>(value);
  }
  template <typename DataSourceGroupsT = Aws::Vector<DataSourceGroup>>
  UserContext& WithDataSourceGroups(DataSourceGroupsT&& value) {
    SetDataSourceGroups(std::forward<DataSourceGroupsT>(value));
    return *this;
  }
  template <typename DataSourceGroupsT = DataSourceGroup>
  UserContext& AddDataSourceGroups(DataSourceGroupsT&& value) {
    m_dataSourceGroupsHasBeenSet = true;
    m_dataSourceGroups.emplace_back(std::forward<DataSourceGroupsT>(value));
    return *this;
  }
  ///@}
 private:
