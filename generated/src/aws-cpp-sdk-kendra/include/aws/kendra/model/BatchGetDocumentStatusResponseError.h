...
class BatchGetDocumentStatusResponseError {
 public:
  ...
  template <typename DocumentIdT = Aws::String>
  BatchGetDocumentStatusResponseError& WithDocumentId(DocumentIdT&& value) {
  ...
  template <typename DataSourceIdT = Aws::String>
  BatchGetDocumentStatusResponseError& WithDataSourceId(DataSourceIdT&& value) {
  ...
  inline BatchGetDocumentStatusResponseError& WithErrorCode(ErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchGetDocumentStatusResponseError& WithErrorMessage(ErrorMessageT&& value) {
