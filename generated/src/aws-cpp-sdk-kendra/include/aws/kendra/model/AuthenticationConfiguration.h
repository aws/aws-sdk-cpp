...
class AuthenticationConfiguration {
 public:
  ...
  void SetBasicAuthentication(BasicAuthenticationT&& value) {
    m_basicAuthenticationHasBeenSet = true;
    m_basicAuthentication = std::forward<BasicAuthenticationT>(value);
  }
  template <typename BasicAuthenticationT = Aws::Vector<BasicAuthenticationConfiguration>>
  AuthenticationConfiguration& WithBasicAuthentication(BasicAuthenticationT&& value) {
    SetBasicAuthentication(std::forward<BasicAuthenticationT>(value));
    return *this;
  }
  ...
  AuthenticationConfiguration& AddBasicAuthentication(BasicAuthenticationT&& value) {
    m_basicAuthenticationHasBeenSet = true;
    m_basicAuthentication.emplace_back(std::forward<BasicAuthenticationT>(value));
    return *this;
  }
  ///@}
 private:
