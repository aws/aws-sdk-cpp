...
class Search {
 public:
  ...
  inline void SetFacetable(bool value) {
    m_facetableHasBeenSet = true;
    m_facetable = value;
  }
  inline Search& WithFacetable(bool value) {
    SetFacetable(value);
    return *this;
  }
  ///@}
  ...
  inline Search& WithSearchable(bool value) {
    SetSearchable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDisplayable(bool value) {
    m_displayableHasBeenSet = true;
    m_displayable = value;
  }
  inline Search& WithDisplayable(bool value) {
  ...
  inline void SetSortable(bool value) {
    m_sortableHasBeenSet = true;
    m_sortable = value;
  }
  inline Search& WithSortable(bool value) {
    SetSortable(value);
    return *this;
  }
  ///@}
