...
class DescribePrincipalMappingResult {
 public:
  ...
  template <typename IndexIdT = Aws::String>
  DescribePrincipalMappingResult& WithIndexId(IndexIdT&& value) {
  ...
  template <typename DataSourceIdT = Aws::String>
  DescribePrincipalMappingResult& WithDataSourceId(DataSourceIdT&& value) {
  ...
  template <typename GroupIdT = Aws::String>
  DescribePrincipalMappingResult& WithGroupId(GroupIdT&& value) {
  ...
  void SetGroupOrderingIdSummaries(GroupOrderingIdSummariesT&& value) {
    m_groupOrderingIdSummariesHasBeenSet = true;
    m_groupOrderingIdSummaries = std::forward<GroupOrderingIdSummariesT>(value);
  }
  template <typename GroupOrderingIdSummariesT = Aws::Vector<GroupOrderingIdSummary>>
  DescribePrincipalMappingResult& WithGroupOrderingIdSummaries(GroupOrderingIdSummariesT&& value) {
    SetGroupOrderingIdSummaries(std::forward<GroupOrderingIdSummariesT>(value));
    return *this;
  }
  template <typename GroupOrderingIdSummariesT = GroupOrderingIdSummary>
  DescribePrincipalMappingResult& AddGroupOrderingIdSummaries(GroupOrderingIdSummariesT&& value) {
    m_groupOrderingIdSummariesHasBeenSet = true;
    m_groupOrderingIdSummaries.emplace_back(std::forward<GroupOrderingIdSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribePrincipalMappingResult& WithRequestId(RequestIdT&& value) {
