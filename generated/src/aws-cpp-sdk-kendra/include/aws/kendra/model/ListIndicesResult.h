...
class ListIndicesResult {
 public:
   ...
   * indexes.</p>
   */
  inline const Aws::Vector<IndexConfigurationSummary>& GetIndexConfigurationSummaryItems() const {
    return m_indexConfigurationSummaryItems;
  }
  template <typename IndexConfigurationSummaryItemsT = Aws::Vector<IndexConfigurationSummary>>
  void SetIndexConfigurationSummaryItems(IndexConfigurationSummaryItemsT&& value) {
    m_indexConfigurationSummaryItemsHasBeenSet = true;
    m_indexConfigurationSummaryItems = std::forward<IndexConfigurationSummaryItemsT>(value);
  }
  template <typename IndexConfigurationSummaryItemsT = Aws::Vector<IndexConfigurationSummary>>
  ListIndicesResult& WithIndexConfigurationSummaryItems(IndexConfigurationSummaryItemsT&& value) {
    SetIndexConfigurationSummaryItems(std::forward<IndexConfigurationSummaryItemsT>(value));
    return *this;
  }
  template <typename IndexConfigurationSummaryItemsT = IndexConfigurationSummary>
  ListIndicesResult& AddIndexConfigurationSummaryItems(IndexConfigurationSummaryItemsT&& value) {
    m_indexConfigurationSummaryItemsHasBeenSet = true;
    m_indexConfigurationSummaryItems.emplace_back(std::forward<IndexConfigurationSummaryItemsT>(value));
    return *this;
  }
  ///@}
