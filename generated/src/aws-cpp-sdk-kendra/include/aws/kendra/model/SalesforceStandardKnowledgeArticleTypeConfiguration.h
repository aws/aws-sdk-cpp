...
class SalesforceStandardKnowledgeArticleTypeConfiguration {
 public:
  ...
  template <typename DocumentDataFieldNameT = Aws::String>
  SalesforceStandardKnowledgeArticleTypeConfiguration& WithDocumentDataFieldName(DocumentDataFieldNameT&& value) {
  ...
  template <typename DocumentTitleFieldNameT = Aws::String>
  SalesforceStandardKnowledgeArticleTypeConfiguration& WithDocumentTitleFieldName(DocumentTitleFieldNameT&& value) {
  ...
  template <typename FieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  SalesforceStandardKnowledgeArticleTypeConfiguration& WithFieldMappings(FieldMappingsT&& value) {
    SetFieldMappings(std::forward<FieldMappingsT>(value));
    return *this;
  }
  template <typename FieldMappingsT = DataSourceToIndexFieldMapping>
  SalesforceStandardKnowledgeArticleTypeConfiguration& AddFieldMappings(FieldMappingsT&& value) {
    m_fieldMappingsHasBeenSet = true;
