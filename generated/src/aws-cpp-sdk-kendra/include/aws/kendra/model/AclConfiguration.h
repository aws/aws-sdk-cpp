...
class AclConfiguration {
 public:
  ...
  void SetAllowedGroupsColumnName(AllowedGroupsColumnNameT&& value) {
    m_allowedGroupsColumnNameHasBeenSet = true;
    m_allowedGroupsColumnName = std::forward<AllowedGroupsColumnNameT>(value);
  }
  template <typename AllowedGroupsColumnNameT = Aws::String>
  AclConfiguration& WithAllowedGroupsColumnName(AllowedGroupsColumnNameT&& value) {
    SetAllowedGroupsColumnName(std::forward<AllowedGroupsColumnNameT>(value));
    return *this;
  }
  ///@}
 private:
