...
class CollapseConfiguration {
 public:
  ...
  inline void SetMissingAttributeKeyStrategy(MissingAttributeKeyStrategy value) {
    m_missingAttributeKeyStrategyHasBeenSet = true;
    m_missingAttributeKeyStrategy = value;
  }
  inline CollapseConfiguration& WithMissingAttributeKeyStrategy(MissingAttributeKeyStrategy value) {
    SetMissingAttributeKeyStrategy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExpand(bool value) {
    m_expandHasBeenSet = true;
    m_expand = value;
  }
  inline CollapseConfiguration& WithExpand(bool value) {
    SetExpand(value);
    return *this;
  }
  ///@}
  ...
  void SetExpandConfiguration(ExpandConfigurationT&& value) {
    ...
    m_expandConfiguration = std::forward<ExpandConfigurationT>(value);
  }
  template <typename ExpandConfigurationT = ExpandConfiguration>
  CollapseConfiguration& WithExpandConfiguration(ExpandConfigurationT&& value) {
    SetExpandConfiguration(std::forward<ExpandConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
