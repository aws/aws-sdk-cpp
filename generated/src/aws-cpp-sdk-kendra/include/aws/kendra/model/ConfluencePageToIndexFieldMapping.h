...
class ConfluencePageToIndexFieldMapping {
 public:
  ...
  inline void SetDataSourceFieldName(ConfluencePageFieldName value) {
    m_dataSourceFieldNameHasBeenSet = true;
    m_dataSourceFieldName = value;
  }
  inline ConfluencePageToIndexFieldMapping& WithDataSourceFieldName(ConfluencePageFieldName value) {
