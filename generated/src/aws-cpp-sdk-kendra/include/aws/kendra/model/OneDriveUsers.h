...
class OneDriveUsers {
 public:
  ...
  void SetOneDriveUserList(OneDriveUserListT&& value) {
    ...
    m_oneDriveUserList = std::forward<OneDriveUserListT>(value);
  }
  template <typename OneDriveUserListT = Aws::Vector<Aws::String>>
  OneDriveUsers& WithOneDriveUserList(OneDriveUserListT&& value) {
    SetOneDriveUserList(std::forward<OneDriveUserListT>(value));
    return *this;
  }
  template <typename OneDriveUserListT = Aws::String>
  OneDriveUsers& AddOneDriveUserList(OneDriveUserListT&& value) {
    m_oneDriveUserListHasBeenSet = true;
    m_oneDriveUserList.emplace_back(std::forward<OneDriveUserListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOneDriveUserS3Path(OneDriveUserS3PathT&& value) {
    ...
    m_oneDriveUserS3Path = std::forward<OneDriveUserS3PathT>(value);
  }
  template <typename OneDriveUserS3PathT = S3Path>
  OneDriveUsers& WithOneDriveUserS3Path(OneDriveUserS3PathT&& value) {
    SetOneDriveUserS3Path(std::forward<OneDriveUserS3PathT>(value));
    return *this;
  }
  ///@}
 private:
