...
class OneDriveConfiguration {
 public:
  ...
  void SetTenantDomain(TenantDomainT&& value) {
    ...
    m_tenantDomain = std::forward<TenantDomainT>(value);
  }
  template <typename TenantDomainT = Aws::String>
  OneDriveConfiguration& WithTenantDomain(TenantDomainT&& value) {
    SetTenantDomain(std::forward<TenantDomainT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOneDriveUsers(OneDriveUsersT&& value) {
    ...
    m_oneDriveUsers = std::forward<OneDriveUsersT>(value);
  }
  template <typename OneDriveUsersT = OneDriveUsers>
  OneDriveConfiguration& WithOneDriveUsers(OneDriveUsersT&& value) {
    SetOneDriveUsers(std::forward<OneDriveUsersT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDisableLocalGroups(bool value) {
    m_disableLocalGroupsHasBeenSet = true;
    m_disableLocalGroups = value;
  }
  inline OneDriveConfiguration& WithDisableLocalGroups(bool value) {
    SetDisableLocalGroups(value);
    return *this;
  }
  ///@}
 private:
