...
class GetSnapshotsResult {
 public:
  ...
  void SetSnapShotTimeFilter(SnapShotTimeFilterT&& value) {
    m_snapShotTimeFilterHasBeenSet = true;
    m_snapShotTimeFilter = std::forward<SnapShotTimeFilterT>(value);
  }
  template <typename SnapShotTimeFilterT = TimeRange>
  GetSnapshotsResult& WithSnapShotTimeFilter(SnapShotTimeFilterT&& value) {
    SetSnapShotTimeFilter(std::forward<SnapShotTimeFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnapshotsDataHeader(SnapshotsDataHeaderT&& value) {
    m_snapshotsDataHeaderHasBeenSet = true;
    m_snapshotsDataHeader = std::forward<SnapshotsDataHeaderT>(value);
  }
  template <typename SnapshotsDataHeaderT = Aws::Vector<Aws::String>>
  GetSnapshotsResult& WithSnapshotsDataHeader(SnapshotsDataHeaderT&& value) {
    SetSnapshotsDataHeader(std::forward<SnapshotsDataHeaderT>(value));
    return *this;
  }
  template <typename SnapshotsDataHeaderT = Aws::String>
  GetSnapshotsResult& AddSnapshotsDataHeader(SnapshotsDataHeaderT&& value) {
    m_snapshotsDataHeaderHasBeenSet = true;
    m_snapshotsDataHeader.emplace_back(std::forward<SnapshotsDataHeaderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnapshotsData(SnapshotsDataT&& value) {
    m_snapshotsDataHasBeenSet = true;
    m_snapshotsData = std::forward<SnapshotsDataT>(value);
  }
  template <typename SnapshotsDataT = Aws::Vector<Aws::Vector<Aws::String>>>
  GetSnapshotsResult& WithSnapshotsData(SnapshotsDataT&& value) {
    SetSnapshotsData(std::forward<SnapshotsDataT>(value));
    return *this;
  }
  template <typename SnapshotsDataT = Aws::Vector<Aws::String>>
  GetSnapshotsResult& AddSnapshotsData(SnapshotsDataT&& value) {
    m_snapshotsDataHasBeenSet = true;
    m_snapshotsData.emplace_back(std::forward<SnapshotsDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetSnapshotsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSnapshotsResult& WithRequestId(RequestIdT&& value) {
