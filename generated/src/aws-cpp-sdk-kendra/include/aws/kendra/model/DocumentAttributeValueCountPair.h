...
class DocumentAttributeValueCountPair {
 public:
  ...
  void SetDocumentAttributeValue(DocumentAttributeValueT&& value) {
    m_documentAttributeValueHasBeenSet = true;
    m_documentAttributeValue = std::forward<DocumentAttributeValueT>(value);
  }
  template <typename DocumentAttributeValueT = DocumentAttributeValue>
  DocumentAttributeValueCountPair& WithDocumentAttributeValue(DocumentAttributeValueT&& value) {
    SetDocumentAttributeValue(std::forward<DocumentAttributeValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline DocumentAttributeValueCountPair& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename FacetResultsT = Aws::Vector<FacetResult>>
  DocumentAttributeValueCountPair& WithFacetResults(FacetResultsT&& value) {
    SetFacetResults(std::forward<FacetResultsT>(value));
    return *this;
  }
  template <typename FacetResultsT = FacetResult>
  DocumentAttributeValueCountPair& AddFacetResults(FacetResultsT&& value) {
    m_facetResultsHasBeenSet = true;
