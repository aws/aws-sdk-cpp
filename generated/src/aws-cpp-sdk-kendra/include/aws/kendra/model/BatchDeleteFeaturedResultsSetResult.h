...
class BatchDeleteFeaturedResultsSetResult {
 public:
  ...
  template <typename ErrorsT = Aws::Vector<BatchDeleteFeaturedResultsSetError>>
  BatchDeleteFeaturedResultsSetResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchDeleteFeaturedResultsSetError>
  BatchDeleteFeaturedResultsSetResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteFeaturedResultsSetResult& WithRequestId(RequestIdT&& value) {
