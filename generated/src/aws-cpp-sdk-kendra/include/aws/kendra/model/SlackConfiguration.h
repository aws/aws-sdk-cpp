...
class SlackConfiguration {
 public:
  ...
  void SetSlackEntityList(SlackEntityListT&& value) {
    ...
    m_slackEntityList = std::forward<SlackEntityListT>(value);
  }
  template <typename SlackEntityListT = Aws::Vector<SlackEntity>>
  SlackConfiguration& WithSlackEntityList(SlackEntityListT&& value) {
    SetSlackEntityList(std::forward<SlackEntityListT>(value));
    return *this;
  }
  inline SlackConfiguration& AddSlackEntityList(SlackEntity value) {
    m_slackEntityListHasBeenSet = true;
    m_slackEntityList.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline SlackConfiguration& WithUseChangeLog(bool value) {
  ...
  inline void SetCrawlBotMessage(bool value) {
    m_crawlBotMessageHasBeenSet = true;
    m_crawlBotMessage = value;
  }
  inline SlackConfiguration& WithCrawlBotMessage(bool value) {
    SetCrawlBotMessage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExcludeArchived(bool value) {
    m_excludeArchivedHasBeenSet = true;
    m_excludeArchived = value;
  }
  inline SlackConfiguration& WithExcludeArchived(bool value) {
    SetExcludeArchived(value);
    return *this;
  }
  ///@}
  ...
  void SetSinceCrawlDate(SinceCrawlDateT&& value) {
    ...
    m_sinceCrawlDate = std::forward<SinceCrawlDateT>(value);
  }
  template <typename SinceCrawlDateT = Aws::String>
  SlackConfiguration& WithSinceCrawlDate(SinceCrawlDateT&& value) {
    SetSinceCrawlDate(std::forward<SinceCrawlDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLookBackPeriod(int value) {
    m_lookBackPeriodHasBeenSet = true;
    m_lookBackPeriod = value;
  }
  inline SlackConfiguration& WithLookBackPeriod(int value) {
  ...
  void SetPrivateChannelFilter(PrivateChannelFilterT&& value) {
    ...
    m_privateChannelFilter = std::forward<PrivateChannelFilterT>(value);
  }
  template <typename PrivateChannelFilterT = Aws::Vector<Aws::String>>
  SlackConfiguration& WithPrivateChannelFilter(PrivateChannelFilterT&& value) {
    SetPrivateChannelFilter(std::forward<PrivateChannelFilterT>(value));
    return *this;
  }
  template <typename PrivateChannelFilterT = Aws::String>
  SlackConfiguration& AddPrivateChannelFilter(PrivateChannelFilterT&& value) {
    m_privateChannelFilterHasBeenSet = true;
    m_privateChannelFilter.emplace_back(std::forward<PrivateChannelFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPublicChannelFilter(PublicChannelFilterT&& value) {
    ...
    m_publicChannelFilter = std::forward<PublicChannelFilterT>(value);
  }
  template <typename PublicChannelFilterT = Aws::Vector<Aws::String>>
  SlackConfiguration& WithPublicChannelFilter(PublicChannelFilterT&& value) {
    SetPublicChannelFilter(std::forward<PublicChannelFilterT>(value));
    return *this;
  }
  template <typename PublicChannelFilterT = Aws::String>
  SlackConfiguration& AddPublicChannelFilter(PublicChannelFilterT&& value) {
    m_publicChannelFilterHasBeenSet = true;
    m_publicChannelFilter.emplace_back(std::forward<PublicChannelFilterT>(value));
    return *this;
  }
  ///@}
