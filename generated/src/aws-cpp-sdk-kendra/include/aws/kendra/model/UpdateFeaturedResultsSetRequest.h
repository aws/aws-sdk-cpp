...
class UpdateFeaturedResultsSetRequest : public KendraRequest {
 public:
  ...
  template <typename IndexIdT = Aws::String>
  UpdateFeaturedResultsSetRequest& WithIndexId(IndexIdT&& value) {
  ...
  template <typename FeaturedResultsSetIdT = Aws::String>
  UpdateFeaturedResultsSetRequest& WithFeaturedResultsSetId(FeaturedResultsSetIdT&& value) {
  ...
  template <typename FeaturedResultsSetNameT = Aws::String>
  UpdateFeaturedResultsSetRequest& WithFeaturedResultsSetName(FeaturedResultsSetNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateFeaturedResultsSetRequest& WithDescription(DescriptionT&& value) {
  ...
  inline UpdateFeaturedResultsSetRequest& WithStatus(FeaturedResultsSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename QueryTextsT = Aws::Vector<Aws::String>>
  UpdateFeaturedResultsSetRequest& WithQueryTexts(QueryTextsT&& value) {
    SetQueryTexts(std::forward<QueryTextsT>(value));
    return *this;
  }
  template <typename QueryTextsT = Aws::String>
  UpdateFeaturedResultsSetRequest& AddQueryTexts(QueryTextsT&& value) {
    m_queryTextsHasBeenSet = true;
  ...
  template <typename FeaturedDocumentsT = Aws::Vector<FeaturedDocument>>
  UpdateFeaturedResultsSetRequest& WithFeaturedDocuments(FeaturedDocumentsT&& value) {
    SetFeaturedDocuments(std::forward<FeaturedDocumentsT>(value));
    return *this;
  }
  template <typename FeaturedDocumentsT = FeaturedDocument>
  UpdateFeaturedResultsSetRequest& AddFeaturedDocuments(FeaturedDocumentsT&& value) {
    m_featuredDocumentsHasBeenSet = true;
