...
class FeaturedResultsSetSummary {
 public:
  ...
  inline FeaturedResultsSetSummary& WithStatus(FeaturedResultsSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline FeaturedResultsSetSummary& WithLastUpdatedTimestamp(long long value) {
  ...
  inline FeaturedResultsSetSummary& WithCreationTimestamp(long long value) {
