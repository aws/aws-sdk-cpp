...
class FeaturedResultsConflictException {
 public:
  ...
  void SetConflictingItems(ConflictingItemsT&& value) {
    ...
    m_conflictingItems = std::forward<ConflictingItemsT>(value);
  }
  template <typename ConflictingItemsT = Aws::Vector<ConflictingItem>>
  FeaturedResultsConflictException& WithConflictingItems(ConflictingItemsT&& value) {
    SetConflictingItems(std::forward<ConflictingItemsT>(value));
    return *this;
  }
  ...
  FeaturedResultsConflictException& AddConflictingItems(ConflictingItemsT&& value) {
    m_conflictingItemsHasBeenSet = true;
    m_conflictingItems.emplace_back(std::forward<ConflictingItemsT>(value));
    return *this;
  }
  ///@}
 private:
