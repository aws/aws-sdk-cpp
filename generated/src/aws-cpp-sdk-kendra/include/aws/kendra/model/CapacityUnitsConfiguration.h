...
class CapacityUnitsConfiguration {
 public:
  ...
  inline void SetStorageCapacityUnits(int value) {
    m_storageCapacityUnitsHasBeenSet = true;
    m_storageCapacityUnits = value;
  }
  inline CapacityUnitsConfiguration& WithStorageCapacityUnits(int value) {
    SetStorageCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQueryCapacityUnits(int value) {
    m_queryCapacityUnitsHasBeenSet = true;
    m_queryCapacityUnits = value;
  }
  inline CapacityUnitsConfiguration& WithQueryCapacityUnits(int value) {
    SetQueryCapacityUnits(value);
    return *this;
  }
  ///@}
 private:
