...
class SortingConfiguration {
 public:
  ...
  void SetDocumentAttributeKey(DocumentAttributeKeyT&& value) {
    ...
    m_documentAttributeKey = std::forward<DocumentAttributeKeyT>(value);
  }
  template <typename DocumentAttributeKeyT = Aws::String>
  SortingConfiguration& WithDocumentAttributeKey(DocumentAttributeKeyT&& value) {
    SetDocumentAttributeKey(std::forward<DocumentAttributeKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline SortingConfiguration& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
