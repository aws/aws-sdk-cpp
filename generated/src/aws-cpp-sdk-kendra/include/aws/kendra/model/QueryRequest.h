...
class QueryRequest : public KendraRequest {
 public:
  ...
  QueryRequest& AddFacets(FacetsT&& value) {
    m_facetsHasBeenSet = true;
    m_facets.emplace_back(std::forward<FacetsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetQueryResultTypeFilter(QueryResultType value) {
    m_queryResultTypeFilterHasBeenSet = true;
    m_queryResultTypeFilter = value;
  }
  inline QueryRequest& WithQueryResultTypeFilter(QueryResultType value) {
    SetQueryResultTypeFilter(value);
    return *this;
  }
  ///@}
  ...
  inline QueryRequest& WithPageNumber(int value) {
    SetPageNumber(value);
    return *this;
  }
  ///@}
  ...
  inline QueryRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  void SetSortingConfiguration(SortingConfigurationT&& value) {
    m_sortingConfigurationHasBeenSet = true;
    m_sortingConfiguration = std::forward<SortingConfigurationT>(value);
  }
  template <typename SortingConfigurationT = SortingConfiguration>
  QueryRequest& WithSortingConfiguration(SortingConfigurationT&& value) {
    SetSortingConfiguration(std::forward<SortingConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSortingConfigurations(SortingConfigurationsT&& value) {
    ...
    m_sortingConfigurations = std::forward<SortingConfigurationsT>(value);
  }
  template <typename SortingConfigurationsT = Aws::Vector<SortingConfiguration>>
  QueryRequest& WithSortingConfigurations(SortingConfigurationsT&& value) {
    SetSortingConfigurations(std::forward<SortingConfigurationsT>(value));
    return *this;
  }
  ...
  QueryRequest& AddSortingConfigurations(SortingConfigurationsT&& value) {
    m_sortingConfigurationsHasBeenSet = true;
    m_sortingConfigurations.emplace_back(std::forward<SortingConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVisitorId(VisitorIdT&& value) {
    ...
    m_visitorId = std::forward<VisitorIdT>(value);
  }
  template <typename VisitorIdT = Aws::String>
  QueryRequest& WithVisitorId(VisitorIdT&& value) {
    SetVisitorId(std::forward<VisitorIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpellCorrectionConfiguration(SpellCorrectionConfigurationT&& value) {
    m_spellCorrectionConfigurationHasBeenSet = true;
    m_spellCorrectionConfiguration = std::forward<SpellCorrectionConfigurationT>(value);
  }
  template <typename SpellCorrectionConfigurationT = SpellCorrectionConfiguration>
  QueryRequest& WithSpellCorrectionConfiguration(SpellCorrectionConfigurationT&& value) {
    SetSpellCorrectionConfiguration(std::forward<SpellCorrectionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCollapseConfiguration(CollapseConfigurationT&& value) {
    m_collapseConfigurationHasBeenSet = true;
    m_collapseConfiguration = std::forward<CollapseConfigurationT>(value);
  }
  template <typename CollapseConfigurationT = CollapseConfiguration>
  QueryRequest& WithCollapseConfiguration(CollapseConfigurationT&& value) {
    SetCollapseConfiguration(std::forward<CollapseConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
