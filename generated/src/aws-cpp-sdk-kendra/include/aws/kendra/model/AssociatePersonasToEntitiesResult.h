...
class AssociatePersonasToEntitiesResult {
 public:
  ...
  template <typename FailedEntityListT = Aws::Vector<FailedEntity>>
  AssociatePersonasToEntitiesResult& WithFailedEntityList(FailedEntityListT&& value) {
    SetFailedEntityList(std::forward<FailedEntityListT>(value));
    return *this;
  }
  template <typename FailedEntityListT = FailedEntity>
  AssociatePersonasToEntitiesResult& AddFailedEntityList(FailedEntityListT&& value) {
    m_failedEntityListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AssociatePersonasToEntitiesResult& WithRequestId(RequestIdT&& value) {
