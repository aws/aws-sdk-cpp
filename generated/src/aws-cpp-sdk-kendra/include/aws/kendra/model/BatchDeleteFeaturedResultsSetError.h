...
class BatchDeleteFeaturedResultsSetError {
 public:
  ...
  template <typename IdT = Aws::String>
  BatchDeleteFeaturedResultsSetError& WithId(IdT&& value) {
  ...
  inline BatchDeleteFeaturedResultsSetError& WithErrorCode(ErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchDeleteFeaturedResultsSetError& WithErrorMessage(ErrorMessageT&& value) {
