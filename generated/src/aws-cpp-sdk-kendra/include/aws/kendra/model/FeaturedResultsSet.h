...
class FeaturedResultsSet {
 public:
  ...
  inline FeaturedResultsSet& WithStatus(FeaturedResultsSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetFeaturedDocuments(FeaturedDocumentsT&& value) {
    ...
    m_featuredDocuments = std::forward<FeaturedDocumentsT>(value);
  }
  template <typename FeaturedDocumentsT = Aws::Vector<FeaturedDocument>>
  FeaturedResultsSet& WithFeaturedDocuments(FeaturedDocumentsT&& value) {
    SetFeaturedDocuments(std::forward<FeaturedDocumentsT>(value));
    return *this;
  }
  template <typename FeaturedDocumentsT = FeaturedDocument>
  FeaturedResultsSet& AddFeaturedDocuments(FeaturedDocumentsT&& value) {
    m_featuredDocumentsHasBeenSet = true;
    m_featuredDocuments.emplace_back(std::forward<FeaturedDocumentsT>(value));
    return *this;
  }
  ///@}
  ...
  inline FeaturedResultsSet& WithLastUpdatedTimestamp(long long value) {
  ...
  inline FeaturedResultsSet& WithCreationTimestamp(long long value) {
