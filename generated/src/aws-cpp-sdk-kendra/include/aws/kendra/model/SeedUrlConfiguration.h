...
class SeedUrlConfiguration {
 public:
  ...
  void SetSeedUrls(SeedUrlsT&& value) {
    m_seedUrlsHasBeenSet = true;
    m_seedUrls = std::forward<SeedUrlsT>(value);
  }
  template <typename SeedUrlsT = Aws::Vector<Aws::String>>
  SeedUrlConfiguration& WithSeedUrls(SeedUrlsT&& value) {
    SetSeedUrls(std::forward<SeedUrlsT>(value));
    return *this;
  }
  template <typename SeedUrlsT = Aws::String>
  SeedUrlConfiguration& AddSeedUrls(SeedUrlsT&& value) {
    m_seedUrlsHasBeenSet = true;
    m_seedUrls.emplace_back(std::forward<SeedUrlsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetWebCrawlerMode(WebCrawlerMode value) {
    m_webCrawlerModeHasBeenSet = true;
    m_webCrawlerMode = value;
  }
  inline SeedUrlConfiguration& WithWebCrawlerMode(WebCrawlerMode value) {
    SetWebCrawlerMode(value);
    return *this;
  }
  ///@}
 private:
