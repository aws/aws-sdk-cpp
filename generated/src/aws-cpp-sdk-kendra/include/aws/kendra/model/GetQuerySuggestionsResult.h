...
class GetQuerySuggestionsResult {
 public:
  ...
  void SetQuerySuggestionsId(QuerySuggestionsIdT&& value) {
    m_querySuggestionsIdHasBeenSet = true;
    m_querySuggestionsId = std::forward<QuerySuggestionsIdT>(value);
  }
  template <typename QuerySuggestionsIdT = Aws::String>
  GetQuerySuggestionsResult& WithQuerySuggestionsId(QuerySuggestionsIdT&& value) {
    SetQuerySuggestionsId(std::forward<QuerySuggestionsIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SuggestionsT = Aws::Vector<Suggestion>>
  GetQuerySuggestionsResult& WithSuggestions(SuggestionsT&& value) {
    SetSuggestions(std::forward<SuggestionsT>(value));
    return *this;
  }
  template <typename SuggestionsT = Suggestion>
  GetQuerySuggestionsResult& AddSuggestions(SuggestionsT&& value) {
    m_suggestionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetQuerySuggestionsResult& WithRequestId(RequestIdT&& value) {
