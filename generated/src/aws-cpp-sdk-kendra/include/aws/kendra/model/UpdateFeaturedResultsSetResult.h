...
class UpdateFeaturedResultsSetResult {
 public:
  AWS_KENDRA_API UpdateFeaturedResultsSetResult() = default;
  ...
  void SetFeaturedResultsSet(FeaturedResultsSetT&& value) {
    m_featuredResultsSetHasBeenSet = true;
    m_featuredResultsSet = std::forward<FeaturedResultsSetT>(value);
  }
  template <typename FeaturedResultsSetT = FeaturedResultsSet>
  UpdateFeaturedResultsSetResult& WithFeaturedResultsSet(FeaturedResultsSetT&& value) {
    SetFeaturedResultsSet(std::forward<FeaturedResultsSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFeaturedResultsSetResult& WithRequestId(RequestIdT&& value) {
