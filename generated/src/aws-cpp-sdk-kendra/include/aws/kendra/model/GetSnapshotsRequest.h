...
class GetSnapshotsRequest : public KendraRequest {
 public:
  ...
  inline void SetInterval(Interval value) {
    m_intervalHasBeenSet = true;
    m_interval = value;
  }
  inline GetSnapshotsRequest& WithInterval(Interval value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  inline GetSnapshotsRequest& WithMetricType(MetricType value) {
    SetMetricType(value);
    return *this;
  }
  ///@}
  ...
  inline GetSnapshotsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
