...
class IndexStatistics {
 public:
  ...
  void SetFaqStatistics(FaqStatisticsT&& value) {
    ...
    m_faqStatistics = std::forward<FaqStatisticsT>(value);
  }
  template <typename FaqStatisticsT = FaqStatistics>
  IndexStatistics& WithFaqStatistics(FaqStatisticsT&& value) {
    SetFaqStatistics(std::forward<FaqStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextDocumentStatistics(TextDocumentStatisticsT&& value) {
    ...
    m_textDocumentStatistics = std::forward<TextDocumentStatisticsT>(value);
  }
  template <typename TextDocumentStatisticsT = TextDocumentStatistics>
  IndexStatistics& WithTextDocumentStatistics(TextDocumentStatisticsT&& value) {
    SetTextDocumentStatistics(std::forward<TextDocumentStatisticsT>(value));
    return *this;
  }
  ///@}
 private:
