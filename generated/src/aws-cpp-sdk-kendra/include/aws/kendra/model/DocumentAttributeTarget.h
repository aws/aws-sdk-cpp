...
class DocumentAttributeTarget {
 public:
  ...
  void SetTargetDocumentAttributeKey(TargetDocumentAttributeKeyT&& value) {
    ...
    m_targetDocumentAttributeKey = std::forward<TargetDocumentAttributeKeyT>(value);
  }
  template <typename TargetDocumentAttributeKeyT = Aws::String>
  DocumentAttributeTarget& WithTargetDocumentAttributeKey(TargetDocumentAttributeKeyT&& value) {
    SetTargetDocumentAttributeKey(std::forward<TargetDocumentAttributeKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTargetDocumentAttributeValueDeletion(bool value) {
    m_targetDocumentAttributeValueDeletionHasBeenSet = true;
    m_targetDocumentAttributeValueDeletion = value;
  }
  inline DocumentAttributeTarget& WithTargetDocumentAttributeValueDeletion(bool value) {
    SetTargetDocumentAttributeValueDeletion(value);
    return *this;
  }
  ///@}
  ...
  void SetTargetDocumentAttributeValue(TargetDocumentAttributeValueT&& value) {
    ...
    m_targetDocumentAttributeValue = std::forward<TargetDocumentAttributeValueT>(value);
  }
  template <typename TargetDocumentAttributeValueT = DocumentAttributeValue>
  DocumentAttributeTarget& WithTargetDocumentAttributeValue(TargetDocumentAttributeValueT&& value) {
    SetTargetDocumentAttributeValue(std::forward<TargetDocumentAttributeValueT>(value));
    return *this;
  }
  ///@}
 private:
