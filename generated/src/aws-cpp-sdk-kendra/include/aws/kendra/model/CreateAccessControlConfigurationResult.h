...
class CreateAccessControlConfigurationResult {
 public:
  AWS_KENDRA_API CreateAccessControlConfigurationResult() = default;
  ...
  template <typename IdT = Aws::String>
  CreateAccessControlConfigurationResult& WithId(IdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAccessControlConfigurationResult& WithRequestId(RequestIdT&& value) {
