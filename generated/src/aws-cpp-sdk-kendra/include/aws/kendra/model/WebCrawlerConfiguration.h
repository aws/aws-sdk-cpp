...
class WebCrawlerConfiguration {
 public:
  ...
  inline void SetCrawlDepth(int value) {
    m_crawlDepthHasBeenSet = true;
    m_crawlDepth = value;
  }
  inline WebCrawlerConfiguration& WithCrawlDepth(int value) {
    SetCrawlDepth(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxLinksPerPage(int value) {
    m_maxLinksPerPageHasBeenSet = true;
    m_maxLinksPerPage = value;
  }
  inline WebCrawlerConfiguration& WithMaxLinksPerPage(int value) {
    SetMaxLinksPerPage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxContentSizePerPageInMegaBytes(double value) {
    m_maxContentSizePerPageInMegaBytesHasBeenSet = true;
    m_maxContentSizePerPageInMegaBytes = value;
  }
  inline WebCrawlerConfiguration& WithMaxContentSizePerPageInMegaBytes(double value) {
    SetMaxContentSizePerPageInMegaBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxUrlsPerMinuteCrawlRate(int value) {
    m_maxUrlsPerMinuteCrawlRateHasBeenSet = true;
    m_maxUrlsPerMinuteCrawlRate = value;
  }
  inline WebCrawlerConfiguration& WithMaxUrlsPerMinuteCrawlRate(int value) {
    SetMaxUrlsPerMinuteCrawlRate(value);
    return *this;
  }
  ///@}
  ...
  void SetUrlInclusionPatterns(UrlInclusionPatternsT&& value) {
    ...
    m_urlInclusionPatterns = std::forward<UrlInclusionPatternsT>(value);
  }
  template <typename UrlInclusionPatternsT = Aws::Vector<Aws::String>>
  WebCrawlerConfiguration& WithUrlInclusionPatterns(UrlInclusionPatternsT&& value) {
    SetUrlInclusionPatterns(std::forward<UrlInclusionPatternsT>(value));
    return *this;
  }
  ...
  WebCrawlerConfiguration& AddUrlInclusionPatterns(UrlInclusionPatternsT&& value) {
    m_urlInclusionPatternsHasBeenSet = true;
    m_urlInclusionPatterns.emplace_back(std::forward<UrlInclusionPatternsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUrlExclusionPatterns(UrlExclusionPatternsT&& value) {
    ...
    m_urlExclusionPatterns = std::forward<UrlExclusionPatternsT>(value);
  }
  template <typename UrlExclusionPatternsT = Aws::Vector<Aws::String>>
  WebCrawlerConfiguration& WithUrlExclusionPatterns(UrlExclusionPatternsT&& value) {
    SetUrlExclusionPatterns(std::forward<UrlExclusionPatternsT>(value));
    return *this;
  }
  ...
  WebCrawlerConfiguration& AddUrlExclusionPatterns(UrlExclusionPatternsT&& value) {
    m_urlExclusionPatternsHasBeenSet = true;
    m_urlExclusionPatterns.emplace_back(std::forward<UrlExclusionPatternsT>(value));
    return *this;
  }
  ///@}
