...
class SalesforceCustomKnowledgeArticleTypeConfiguration {
 public:
  ...
  template <typename NameT = Aws::String>
  SalesforceCustomKnowledgeArticleTypeConfiguration& WithName(NameT&& value) {
  ...
  template <typename DocumentDataFieldNameT = Aws::String>
  SalesforceCustomKnowledgeArticleTypeConfiguration& WithDocumentDataFieldName(DocumentDataFieldNameT&& value) {
  ...
  template <typename DocumentTitleFieldNameT = Aws::String>
  SalesforceCustomKnowledgeArticleTypeConfiguration& WithDocumentTitleFieldName(DocumentTitleFieldNameT&& value) {
  ...
  template <typename FieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  SalesforceCustomKnowledgeArticleTypeConfiguration& WithFieldMappings(FieldMappingsT&& value) {
    SetFieldMappings(std::forward<FieldMappingsT>(value));
    return *this;
  }
  template <typename FieldMappingsT = DataSourceToIndexFieldMapping>
  SalesforceCustomKnowledgeArticleTypeConfiguration& AddFieldMappings(FieldMappingsT&& value) {
    m_fieldMappingsHasBeenSet = true;
