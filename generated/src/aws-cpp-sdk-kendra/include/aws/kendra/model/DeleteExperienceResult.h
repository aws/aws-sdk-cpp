...
namespace Model
{
  ...
  {
  public:
    AWS_KENDRA_API DeleteExperienceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteExperienceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
