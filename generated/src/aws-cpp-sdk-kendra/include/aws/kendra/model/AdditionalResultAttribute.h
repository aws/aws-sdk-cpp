...
class AdditionalResultAttribute {
 public:
  ...
  template <typename KeyT = Aws::String>
  AdditionalResultAttribute& WithKey(KeyT&& value) {
  ...
  inline void SetValueType(AdditionalResultAttributeValueType value) {
    m_valueTypeHasBeenSet = true;
    m_valueType = value;
  }
  inline AdditionalResultAttribute& WithValueType(AdditionalResultAttributeValueType value) {
    SetValueType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = AdditionalResultAttributeValue>
  AdditionalResultAttribute& WithValue(ValueT&& value) {
