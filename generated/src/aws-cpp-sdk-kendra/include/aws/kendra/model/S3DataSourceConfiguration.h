...
class S3DataSourceConfiguration {
 public:
  ...
  void SetDocumentsMetadataConfiguration(DocumentsMetadataConfigurationT&& value) {
    ...
    m_documentsMetadataConfiguration = std::forward<DocumentsMetadataConfigurationT>(value);
  }
  template <typename DocumentsMetadataConfigurationT = DocumentsMetadataConfiguration>
  S3DataSourceConfiguration& WithDocumentsMetadataConfiguration(DocumentsMetadataConfigurationT&& value) {
    SetDocumentsMetadataConfiguration(std::forward<DocumentsMetadataConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccessControlListConfiguration(AccessControlListConfigurationT&& value) {
    ...
    m_accessControlListConfiguration = std::forward<AccessControlListConfigurationT>(value);
  }
  template <typename AccessControlListConfigurationT = AccessControlListConfiguration>
  S3DataSourceConfiguration& WithAccessControlListConfiguration(AccessControlListConfigurationT&& value) {
    SetAccessControlListConfiguration(std::forward<AccessControlListConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
