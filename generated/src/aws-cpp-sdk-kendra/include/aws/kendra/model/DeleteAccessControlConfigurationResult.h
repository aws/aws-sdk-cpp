...
namespace Model
{
  ...
  {
  public:
    AWS_KENDRA_API DeleteAccessControlConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAccessControlConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
