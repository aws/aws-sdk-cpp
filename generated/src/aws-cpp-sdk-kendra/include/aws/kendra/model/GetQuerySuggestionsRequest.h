...
class GetQuerySuggestionsRequest : public KendraRequest {
 public:
  ...
  inline void SetMaxSuggestionsCount(int value) {
    m_maxSuggestionsCountHasBeenSet = true;
    m_maxSuggestionsCount = value;
  }
  inline GetQuerySuggestionsRequest& WithMaxSuggestionsCount(int value) {
    SetMaxSuggestionsCount(value);
    return *this;
  }
  ///@}
  ...
  void SetSuggestionTypes(SuggestionTypesT&& value) {
    m_suggestionTypesHasBeenSet = true;
    m_suggestionTypes = std::forward<SuggestionTypesT>(value);
  }
  template <typename SuggestionTypesT = Aws::Vector<SuggestionType>>
  GetQuerySuggestionsRequest& WithSuggestionTypes(SuggestionTypesT&& value) {
    SetSuggestionTypes(std::forward<SuggestionTypesT>(value));
    return *this;
  }
  inline GetQuerySuggestionsRequest& AddSuggestionTypes(SuggestionType value) {
    m_suggestionTypesHasBeenSet = true;
    m_suggestionTypes.push_back(value);
    return *this;
  }
  ///@}
