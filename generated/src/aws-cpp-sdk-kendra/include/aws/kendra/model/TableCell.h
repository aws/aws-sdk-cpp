...
class TableCell {
 public:
  ...
  inline void SetTopAnswer(bool value) {
    m_topAnswerHasBeenSet = true;
    m_topAnswer = value;
  }
  inline TableCell& WithTopAnswer(bool value) {
    SetTopAnswer(value);
    return *this;
  }
  ///@}
  ...
  inline TableCell& WithHighlighted(bool value) {
  ...
  inline void SetHeader(bool value) {
    m_headerHasBeenSet = true;
    m_header = value;
  }
  inline TableCell& WithHeader(bool value) {
    SetHeader(value);
    return *this;
  }
  ///@}
