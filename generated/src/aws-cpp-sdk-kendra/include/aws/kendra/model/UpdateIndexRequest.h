...
class UpdateIndexRequest : public KendraRequest {
 public:
   ...
   */
  inline const Aws::Vector<DocumentMetadataConfiguration>& GetDocumentMetadataConfigurationUpdates() const {
    return m_documentMetadataConfigurationUpdates;
  }
  ...
  void SetDocumentMetadataConfigurationUpdates(DocumentMetadataConfigurationUpdatesT&& value) {
    m_documentMetadataConfigurationUpdatesHasBeenSet = true;
    m_documentMetadataConfigurationUpdates = std::forward<DocumentMetadataConfigurationUpdatesT>(value);
  }
  template <typename DocumentMetadataConfigurationUpdatesT = Aws::Vector<DocumentMetadataConfiguration>>
  UpdateIndexRequest& WithDocumentMetadataConfigurationUpdates(DocumentMetadataConfigurationUpdatesT&& value) {
    SetDocumentMetadataConfigurationUpdates(std::forward<DocumentMetadataConfigurationUpdatesT>(value));
    return *this;
  }
  ...
  UpdateIndexRequest& AddDocumentMetadataConfigurationUpdates(DocumentMetadataConfigurationUpdatesT&& value) {
    m_documentMetadataConfigurationUpdatesHasBeenSet = true;
    m_documentMetadataConfigurationUpdates.emplace_back(std::forward<DocumentMetadataConfigurationUpdatesT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateIndexRequest& WithUserContextPolicy(UserContextPolicy value) {
