...
class ListEntityPersonasResult {
 public:
  ...
  template <typename SummaryItemsT = Aws::Vector<PersonasSummary>>
  ListEntityPersonasResult& WithSummaryItems(SummaryItemsT&& value) {
    SetSummaryItems(std::forward<SummaryItemsT>(value));
    return *this;
  }
  template <typename SummaryItemsT = PersonasSummary>
  ListEntityPersonasResult& AddSummaryItems(SummaryItemsT&& value) {
    m_summaryItemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEntityPersonasResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEntityPersonasResult& WithRequestId(RequestIdT&& value) {
