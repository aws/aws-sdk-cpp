...
class UpdateQuerySuggestionsConfigRequest : public KendraRequest {
 public:
  ...
  inline UpdateQuerySuggestionsConfigRequest& WithMode(Mode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQueryLogLookBackWindowInDays(int value) {
    m_queryLogLookBackWindowInDaysHasBeenSet = true;
    m_queryLogLookBackWindowInDays = value;
  }
  inline UpdateQuerySuggestionsConfigRequest& WithQueryLogLookBackWindowInDays(int value) {
    SetQueryLogLookBackWindowInDays(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeQueriesWithoutUserInformation(bool value) {
    m_includeQueriesWithoutUserInformationHasBeenSet = true;
    m_includeQueriesWithoutUserInformation = value;
  }
  inline UpdateQuerySuggestionsConfigRequest& WithIncludeQueriesWithoutUserInformation(bool value) {
    SetIncludeQueriesWithoutUserInformation(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumNumberOfQueryingUsers(int value) {
    m_minimumNumberOfQueryingUsersHasBeenSet = true;
    m_minimumNumberOfQueryingUsers = value;
  }
  inline UpdateQuerySuggestionsConfigRequest& WithMinimumNumberOfQueryingUsers(int value) {
    SetMinimumNumberOfQueryingUsers(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumQueryCount(int value) {
    m_minimumQueryCountHasBeenSet = true;
    m_minimumQueryCount = value;
  }
  inline UpdateQuerySuggestionsConfigRequest& WithMinimumQueryCount(int value) {
    SetMinimumQueryCount(value);
    return *this;
  }
  ///@}
  ...
  void SetAttributeSuggestionsConfig(AttributeSuggestionsConfigT&& value) {
    ...
    m_attributeSuggestionsConfig = std::forward<AttributeSuggestionsConfigT>(value);
  }
  template <typename AttributeSuggestionsConfigT = AttributeSuggestionsUpdateConfig>
  UpdateQuerySuggestionsConfigRequest& WithAttributeSuggestionsConfig(AttributeSuggestionsConfigT&& value) {
    SetAttributeSuggestionsConfig(std::forward<AttributeSuggestionsConfigT>(value));
    return *this;
  }
  ///@}
 private:
