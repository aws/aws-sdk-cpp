...
namespace Model
{
  ...
  {
  public:
    AWS_KENDRA_API ListFeaturedResultsSetsRequest() = default;
    ...
    template<typename IndexIdT = Aws::String>
    ListFeaturedResultsSetsRequest& WithIndexId(IndexIdT&& value) { SetIndexId(std::forward<IndexIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListFeaturedResultsSetsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
