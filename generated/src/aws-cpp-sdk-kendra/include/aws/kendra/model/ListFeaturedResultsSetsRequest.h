...
class ListFeaturedResultsSetsRequest : public KendraRequest {
 public:
  ...
  template <typename IndexIdT = Aws::String>
  ListFeaturedResultsSetsRequest& WithIndexId(IndexIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListFeaturedResultsSetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFeaturedResultsSetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
