...
class ListFeaturedResultsSetsResult {
 public:
   ...
   */
  inline const Aws::Vector<FeaturedResultsSetSummary>& GetFeaturedResultsSetSummaryItems() const {
    return m_featuredResultsSetSummaryItems;
  }
  template <typename FeaturedResultsSetSummaryItemsT = Aws::Vector<FeaturedResultsSetSummary>>
  void SetFeaturedResultsSetSummaryItems(FeaturedResultsSetSummaryItemsT&& value) {
    m_featuredResultsSetSummaryItemsHasBeenSet = true;
    m_featuredResultsSetSummaryItems = std::forward<FeaturedResultsSetSummaryItemsT>(value);
  }
  template <typename FeaturedResultsSetSummaryItemsT = Aws::Vector<FeaturedResultsSetSummary>>
  ListFeaturedResultsSetsResult& WithFeaturedResultsSetSummaryItems(FeaturedResultsSetSummaryItemsT&& value) {
    SetFeaturedResultsSetSummaryItems(std::forward<FeaturedResultsSetSummaryItemsT>(value));
    return *this;
  }
  template <typename FeaturedResultsSetSummaryItemsT = FeaturedResultsSetSummary>
  ListFeaturedResultsSetsResult& AddFeaturedResultsSetSummaryItems(FeaturedResultsSetSummaryItemsT&& value) {
    m_featuredResultsSetSummaryItemsHasBeenSet = true;
    m_featuredResultsSetSummaryItems.emplace_back(std::forward<FeaturedResultsSetSummaryItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFeaturedResultsSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFeaturedResultsSetsResult& WithRequestId(RequestIdT&& value) {
