...
class ConfluenceBlogConfiguration {
 public:
  ...
  void SetBlogFieldMappings(BlogFieldMappingsT&& value) {
    m_blogFieldMappingsHasBeenSet = true;
    m_blogFieldMappings = std::forward<BlogFieldMappingsT>(value);
  }
  template <typename BlogFieldMappingsT = Aws::Vector<ConfluenceBlogToIndexFieldMapping>>
  ConfluenceBlogConfiguration& WithBlogFieldMappings(BlogFieldMappingsT&& value) {
    SetBlogFieldMappings(std::forward<BlogFieldMappingsT>(value));
    return *this;
  }
  ...
  ConfluenceBlogConfiguration& AddBlogFieldMappings(BlogFieldMappingsT&& value) {
    m_blogFieldMappingsHasBeenSet = true;
    m_blogFieldMappings.emplace_back(std::forward<BlogFieldMappingsT>(value));
    return *this;
  }
  ///@}
 private:
