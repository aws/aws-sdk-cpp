...
/**
 * <p>Provides the configuration information to get users and groups from an IAM
...
class UserGroupResolutionConfiguration {
 public:
  ...
  inline void SetUserGroupResolutionMode(UserGroupResolutionMode value) {
    m_userGroupResolutionModeHasBeenSet = true;
    m_userGroupResolutionMode = value;
  }
  inline UserGroupResolutionConfiguration& WithUserGroupResolutionMode(UserGroupResolutionMode value) {
    SetUserGroupResolutionMode(value);
    return *this;
  }
  ///@}
 private:
