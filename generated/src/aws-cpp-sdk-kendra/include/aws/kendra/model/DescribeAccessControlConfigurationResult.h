...
class DescribeAccessControlConfigurationResult {
 public:
  ...
  AWS_KENDRA_API DescribeAccessControlConfigurationResult& operator=(
  ...
  template <typename NameT = Aws::String>
  DescribeAccessControlConfigurationResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  DescribeAccessControlConfigurationResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  DescribeAccessControlConfigurationResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename AccessControlListT = Aws::Vector<Principal>>
  DescribeAccessControlConfigurationResult& WithAccessControlList(AccessControlListT&& value) {
    SetAccessControlList(std::forward<AccessControlListT>(value));
    return *this;
  }
  template <typename AccessControlListT = Principal>
  DescribeAccessControlConfigurationResult& AddAccessControlList(AccessControlListT&& value) {
    m_accessControlListHasBeenSet = true;
  ...
  void SetHierarchicalAccessControlList(HierarchicalAccessControlListT&& value) {
    ...
    m_hierarchicalAccessControlList = std::forward<HierarchicalAccessControlListT>(value);
  }
  template <typename HierarchicalAccessControlListT = Aws::Vector<HierarchicalPrincipal>>
  DescribeAccessControlConfigurationResult& WithHierarchicalAccessControlList(HierarchicalAccessControlListT&& value) {
    SetHierarchicalAccessControlList(std::forward<HierarchicalAccessControlListT>(value));
    return *this;
  }
  template <typename HierarchicalAccessControlListT = HierarchicalPrincipal>
  DescribeAccessControlConfigurationResult& AddHierarchicalAccessControlList(HierarchicalAccessControlListT&& value) {
    m_hierarchicalAccessControlListHasBeenSet = true;
    m_hierarchicalAccessControlList.emplace_back(std::forward<HierarchicalAccessControlListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAccessControlConfigurationResult& WithRequestId(RequestIdT&& value) {
