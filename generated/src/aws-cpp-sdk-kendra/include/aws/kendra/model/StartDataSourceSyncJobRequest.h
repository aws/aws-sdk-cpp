...
class StartDataSourceSyncJobRequest : public KendraRequest {
 public:
  AWS_KENDRA_API StartDataSourceSyncJobRequest() = default;
  ...
  template <typename IdT = Aws::String>
  StartDataSourceSyncJobRequest& WithId(IdT&& value) {
  ...
  template <typename IndexIdT = Aws::String>
  StartDataSourceSyncJobRequest& WithIndexId(IndexIdT&& value) {
