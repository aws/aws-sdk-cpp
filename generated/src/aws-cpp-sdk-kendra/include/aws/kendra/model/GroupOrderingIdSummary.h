...
class GroupOrderingIdSummary {
 public:
  ...
  inline void SetStatus(PrincipalMappingStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GroupOrderingIdSummary& WithStatus(PrincipalMappingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GroupOrderingIdSummary& WithOrderingId(long long value) {
    SetOrderingId(value);
    return *this;
  }
  ///@}
