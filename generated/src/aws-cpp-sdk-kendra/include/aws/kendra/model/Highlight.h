...
class Highlight {
 public:
  ...
  inline Highlight& WithBeginOffset(int value) {
  ...
  inline Highlight& WithEndOffset(int value) {
    SetEndOffset(value);
    return *this;
  }
  ///@}
  ...
  inline Highlight& WithTopAnswer(bool value) {
    SetTopAnswer(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(HighlightType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Highlight& WithType(HighlightType value) {
    SetType(value);
    return *this;
  }
  ///@}
