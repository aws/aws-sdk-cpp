...
class ConflictingItem {
 public:
  ...
  void SetSetName(SetNameT&& value) {
    m_setNameHasBeenSet = true;
    m_setName = std::forward<SetNameT>(value);
  }
  template <typename SetNameT = Aws::String>
  ConflictingItem& WithSetName(SetNameT&& value) {
    SetSetName(std::forward<SetNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSetId(SetIdT&& value) {
    m_setIdHasBeenSet = true;
    m_setId = std::forward<SetIdT>(value);
  }
  template <typename SetIdT = Aws::String>
  ConflictingItem& WithSetId(SetIdT&& value) {
    SetSetId(std::forward<SetIdT>(value));
    return *this;
  }
  ///@}
 private:
