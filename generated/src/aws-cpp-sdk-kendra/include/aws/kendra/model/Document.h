...
class Document {
 public:
  ...
  void SetAccessControlConfigurationId(AccessControlConfigurationIdT&& value) {
    ...
    m_accessControlConfigurationId = std::forward<AccessControlConfigurationIdT>(value);
  }
  template <typename AccessControlConfigurationIdT = Aws::String>
  Document& WithAccessControlConfigurationId(AccessControlConfigurationIdT&& value) {
    SetAccessControlConfigurationId(std::forward<AccessControlConfigurationIdT>(value));
    return *this;
  }
  ///@}
 private:
