...
namespace Model
{
  ...
  {
  public:
    AWS_KENDRA_API DescribeAccessControlConfigurationRequest() = default;
    ...
    template<typename IndexIdT = Aws::String>
    DescribeAccessControlConfigurationRequest& WithIndexId(IndexIdT&& value) { SetIndexId(std::forward<IndexIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    DescribeAccessControlConfigurationRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
