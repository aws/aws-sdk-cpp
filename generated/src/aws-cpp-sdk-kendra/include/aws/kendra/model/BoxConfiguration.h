...
class BoxConfiguration {
 public:
  ...
  void SetEnterpriseId(EnterpriseIdT&& value) {
    ...
    m_enterpriseId = std::forward<EnterpriseIdT>(value);
  }
  template <typename EnterpriseIdT = Aws::String>
  BoxConfiguration& WithEnterpriseId(EnterpriseIdT&& value) {
    SetEnterpriseId(std::forward<EnterpriseIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUseChangeLog(bool value) {
    m_useChangeLogHasBeenSet = true;
    m_useChangeLog = value;
  }
  inline BoxConfiguration& WithUseChangeLog(bool value) {
    SetUseChangeLog(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCrawlComments(bool value) {
    m_crawlCommentsHasBeenSet = true;
    m_crawlComments = value;
  }
  inline BoxConfiguration& WithCrawlComments(bool value) {
    SetCrawlComments(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCrawlTasks(bool value) {
    m_crawlTasksHasBeenSet = true;
    m_crawlTasks = value;
  }
  inline BoxConfiguration& WithCrawlTasks(bool value) {
    SetCrawlTasks(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCrawlWebLinks(bool value) {
    m_crawlWebLinksHasBeenSet = true;
    m_crawlWebLinks = value;
  }
  inline BoxConfiguration& WithCrawlWebLinks(bool value) {
    SetCrawlWebLinks(value);
    return *this;
  }
  ///@}
  ...
  void SetFileFieldMappings(FileFieldMappingsT&& value) {
    ...
    m_fileFieldMappings = std::forward<FileFieldMappingsT>(value);
  }
  template <typename FileFieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  BoxConfiguration& WithFileFieldMappings(FileFieldMappingsT&& value) {
    SetFileFieldMappings(std::forward<FileFieldMappingsT>(value));
    return *this;
  }
  ...
  BoxConfiguration& AddFileFieldMappings(FileFieldMappingsT&& value) {
    m_fileFieldMappingsHasBeenSet = true;
    m_fileFieldMappings.emplace_back(std::forward<FileFieldMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTaskFieldMappings(TaskFieldMappingsT&& value) {
    ...
    m_taskFieldMappings = std::forward<TaskFieldMappingsT>(value);
  }
  template <typename TaskFieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  BoxConfiguration& WithTaskFieldMappings(TaskFieldMappingsT&& value) {
    SetTaskFieldMappings(std::forward<TaskFieldMappingsT>(value));
    return *this;
  }
  ...
  BoxConfiguration& AddTaskFieldMappings(TaskFieldMappingsT&& value) {
    m_taskFieldMappingsHasBeenSet = true;
    m_taskFieldMappings.emplace_back(std::forward<TaskFieldMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCommentFieldMappings(CommentFieldMappingsT&& value) {
    ...
    m_commentFieldMappings = std::forward<CommentFieldMappingsT>(value);
  }
  template <typename CommentFieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  BoxConfiguration& WithCommentFieldMappings(CommentFieldMappingsT&& value) {
    SetCommentFieldMappings(std::forward<CommentFieldMappingsT>(value));
    return *this;
  }
  ...
  BoxConfiguration& AddCommentFieldMappings(CommentFieldMappingsT&& value) {
    m_commentFieldMappingsHasBeenSet = true;
    m_commentFieldMappings.emplace_back(std::forward<CommentFieldMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWebLinkFieldMappings(WebLinkFieldMappingsT&& value) {
    ...
    m_webLinkFieldMappings = std::forward<WebLinkFieldMappingsT>(value);
  }
  template <typename WebLinkFieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  BoxConfiguration& WithWebLinkFieldMappings(WebLinkFieldMappingsT&& value) {
    SetWebLinkFieldMappings(std::forward<WebLinkFieldMappingsT>(value));
    return *this;
  }
  ...
  BoxConfiguration& AddWebLinkFieldMappings(WebLinkFieldMappingsT&& value) {
    m_webLinkFieldMappingsHasBeenSet = true;
    m_webLinkFieldMappings.emplace_back(std::forward<WebLinkFieldMappingsT>(value));
    return *this;
  }
  ///@}
