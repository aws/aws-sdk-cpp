...
class DisassociatePersonasFromEntitiesResult {
 public:
  AWS_KENDRA_API DisassociatePersonasFromEntitiesResult() = default;
  ...
  template <typename FailedEntityListT = Aws::Vector<FailedEntity>>
  DisassociatePersonasFromEntitiesResult& WithFailedEntityList(FailedEntityListT&& value) {
    SetFailedEntityList(std::forward<FailedEntityListT>(value));
    return *this;
  }
  template <typename FailedEntityListT = FailedEntity>
  DisassociatePersonasFromEntitiesResult& AddFailedEntityList(FailedEntityListT&& value) {
    m_failedEntityListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DisassociatePersonasFromEntitiesResult& WithRequestId(RequestIdT&& value) {
