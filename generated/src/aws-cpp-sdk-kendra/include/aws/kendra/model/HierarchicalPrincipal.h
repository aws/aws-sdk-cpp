...
class HierarchicalPrincipal {
 public:
  ...
  void SetPrincipalList(PrincipalListT&& value) {
    m_principalListHasBeenSet = true;
    m_principalList = std::forward<PrincipalListT>(value);
  }
  template <typename PrincipalListT = Aws::Vector<Principal>>
  HierarchicalPrincipal& WithPrincipalList(PrincipalListT&& value) {
    SetPrincipalList(std::forward<PrincipalListT>(value));
    return *this;
  }
  template <typename PrincipalListT = Principal>
  HierarchicalPrincipal& AddPrincipalList(PrincipalListT&& value) {
    m_principalListHasBeenSet = true;
    m_principalList.emplace_back(std::forward<PrincipalListT>(value));
    return *this;
  }
  ///@}
 private:
