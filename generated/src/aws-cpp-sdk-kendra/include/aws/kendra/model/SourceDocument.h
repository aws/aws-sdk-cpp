...
class SourceDocument {
 public:
  ...
  template <typename DocumentIdT = Aws::String>
  SourceDocument& WithDocumentId(DocumentIdT&& value) {
  ...
  void SetSuggestionAttributes(SuggestionAttributesT&& value) {
    ...
    m_suggestionAttributes = std::forward<SuggestionAttributesT>(value);
  }
  template <typename SuggestionAttributesT = Aws::Vector<Aws::String>>
  SourceDocument& WithSuggestionAttributes(SuggestionAttributesT&& value) {
    SetSuggestionAttributes(std::forward<SuggestionAttributesT>(value));
    return *this;
  }
  template <typename SuggestionAttributesT = Aws::String>
  SourceDocument& AddSuggestionAttributes(SuggestionAttributesT&& value) {
    m_suggestionAttributesHasBeenSet = true;
    m_suggestionAttributes.emplace_back(std::forward<SuggestionAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AdditionalAttributesT = Aws::Vector<DocumentAttribute>>
  SourceDocument& WithAdditionalAttributes(AdditionalAttributesT&& value) {
    SetAdditionalAttributes(std::forward<AdditionalAttributesT>(value));
    return *this;
  }
  template <typename AdditionalAttributesT = DocumentAttribute>
  SourceDocument& AddAdditionalAttributes(AdditionalAttributesT&& value) {
    m_additionalAttributesHasBeenSet = true;
    m_additionalAttributes.emplace_back(std::forward<AdditionalAttributesT>(value));
    return *this;
  }
  ///@}
 private:
