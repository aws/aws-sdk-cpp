...
class ExperienceConfiguration {
 public:
  ...
  void SetContentSourceConfiguration(ContentSourceConfigurationT&& value) {
    ...
    m_contentSourceConfiguration = std::forward<ContentSourceConfigurationT>(value);
  }
  template <typename ContentSourceConfigurationT = ContentSourceConfiguration>
  ExperienceConfiguration& WithContentSourceConfiguration(ContentSourceConfigurationT&& value) {
    SetContentSourceConfiguration(std::forward<ContentSourceConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserIdentityConfiguration(UserIdentityConfigurationT&& value) {
    ...
    m_userIdentityConfiguration = std::forward<UserIdentityConfigurationT>(value);
  }
  template <typename UserIdentityConfigurationT = UserIdentityConfiguration>
  ExperienceConfiguration& WithUserIdentityConfiguration(UserIdentityConfigurationT&& value) {
    SetUserIdentityConfiguration(std::forward<UserIdentityConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
