...
class RelevanceFeedback {
 public:
  ...
  template <typename ResultIdT = Aws::String>
  RelevanceFeedback& WithResultId(ResultIdT&& value) {
  ...
  inline void SetRelevanceValue(RelevanceType value) {
    m_relevanceValueHasBeenSet = true;
    m_relevanceValue = value;
  }
  inline RelevanceFeedback& WithRelevanceValue(RelevanceType value) {
