...
class ListGroupsOlderThanOrderingIdResult {
 public:
  ...
  void SetGroupsSummaries(GroupsSummariesT&& value) {
    m_groupsSummariesHasBeenSet = true;
    m_groupsSummaries = std::forward<GroupsSummariesT>(value);
  }
  template <typename GroupsSummariesT = Aws::Vector<GroupSummary>>
  ListGroupsOlderThanOrderingIdResult& WithGroupsSummaries(GroupsSummariesT&& value) {
    SetGroupsSummaries(std::forward<GroupsSummariesT>(value));
    return *this;
  }
  template <typename GroupsSummariesT = GroupSummary>
  ListGroupsOlderThanOrderingIdResult& AddGroupsSummaries(GroupsSummariesT&& value) {
    m_groupsSummariesHasBeenSet = true;
    m_groupsSummaries.emplace_back(std::forward<GroupsSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListGroupsOlderThanOrderingIdResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListGroupsOlderThanOrderingIdResult& WithRequestId(RequestIdT&& value) {
