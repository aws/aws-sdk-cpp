...
class ContentSourceConfiguration {
 public:
  ...
  inline void SetDirectPutContent(bool value) {
    m_directPutContentHasBeenSet = true;
    m_directPutContent = value;
  }
  inline ContentSourceConfiguration& WithDirectPutContent(bool value) {
    SetDirectPutContent(value);
    return *this;
  }
  ///@}
 private:
