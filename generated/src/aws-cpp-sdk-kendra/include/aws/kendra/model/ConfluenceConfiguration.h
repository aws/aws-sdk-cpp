...
class ConfluenceConfiguration {
 public:
  ...
  inline void SetVersion(ConfluenceVersion value) {
    m_versionHasBeenSet = true;
    m_version = value;
  }
  inline ConfluenceConfiguration& WithVersion(ConfluenceVersion value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetSpaceConfiguration(SpaceConfigurationT&& value) {
    ...
    m_spaceConfiguration = std::forward<SpaceConfigurationT>(value);
  }
  template <typename SpaceConfigurationT = ConfluenceSpaceConfiguration>
  ConfluenceConfiguration& WithSpaceConfiguration(SpaceConfigurationT&& value) {
    SetSpaceConfiguration(std::forward<SpaceConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPageConfiguration(PageConfigurationT&& value) {
    ...
    m_pageConfiguration = std::forward<PageConfigurationT>(value);
  }
  template <typename PageConfigurationT = ConfluencePageConfiguration>
  ConfluenceConfiguration& WithPageConfiguration(PageConfigurationT&& value) {
    SetPageConfiguration(std::forward<PageConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBlogConfiguration(BlogConfigurationT&& value) {
    ...
    m_blogConfiguration = std::forward<BlogConfigurationT>(value);
  }
  template <typename BlogConfigurationT = ConfluenceBlogConfiguration>
  ConfluenceConfiguration& WithBlogConfiguration(BlogConfigurationT&& value) {
    SetBlogConfiguration(std::forward<BlogConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAttachmentConfiguration(AttachmentConfigurationT&& value) {
    ...
    m_attachmentConfiguration = std::forward<AttachmentConfigurationT>(value);
  }
  template <typename AttachmentConfigurationT = ConfluenceAttachmentConfiguration>
  ConfluenceConfiguration& WithAttachmentConfiguration(AttachmentConfigurationT&& value) {
    SetAttachmentConfiguration(std::forward<AttachmentConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAuthenticationType(ConfluenceAuthenticationType value) {
    m_authenticationTypeHasBeenSet = true;
    m_authenticationType = value;
  }
  inline ConfluenceConfiguration& WithAuthenticationType(ConfluenceAuthenticationType value) {
