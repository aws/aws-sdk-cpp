...
class SpellCorrectedQuery {
 public:
  ...
  void SetSuggestedQueryText(SuggestedQueryTextT&& value) {
    ...
    m_suggestedQueryText = std::forward<SuggestedQueryTextT>(value);
  }
  template <typename SuggestedQueryTextT = Aws::String>
  SpellCorrectedQuery& WithSuggestedQueryText(SuggestedQueryTextT&& value) {
    SetSuggestedQueryText(std::forward<SuggestedQueryTextT>(value));
    return *this;
  }
  ///@}
