...
class ListExperiencesResult {
 public:
  ...
  template <typename SummaryItemsT = Aws::Vector<ExperiencesSummary>>
  ListExperiencesResult& WithSummaryItems(SummaryItemsT&& value) {
    SetSummaryItems(std::forward<SummaryItemsT>(value));
    return *this;
  }
  template <typename SummaryItemsT = ExperiencesSummary>
  ListExperiencesResult& AddSummaryItems(SummaryItemsT&& value) {
    m_summaryItemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListExperiencesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExperiencesResult& WithRequestId(RequestIdT&& value) {
