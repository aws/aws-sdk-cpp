...
class BatchDeleteDocumentRequest : public KendraRequest {
 public:
  ...
  void SetDocumentIdList(DocumentIdListT&& value) {
    m_documentIdListHasBeenSet = true;
    m_documentIdList = std::forward<DocumentIdListT>(value);
  }
  template <typename DocumentIdListT = Aws::Vector<Aws::String>>
  BatchDeleteDocumentRequest& WithDocumentIdList(DocumentIdListT&& value) {
    SetDocumentIdList(std::forward<DocumentIdListT>(value));
    return *this;
  }
  template <typename DocumentIdListT = Aws::String>
  BatchDeleteDocumentRequest& AddDocumentIdList(DocumentIdListT&& value) {
    m_documentIdListHasBeenSet = true;
    m_documentIdList.emplace_back(std::forward<DocumentIdListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataSourceSyncJobMetricTarget(DataSourceSyncJobMetricTargetT&& value) {
    m_dataSourceSyncJobMetricTargetHasBeenSet = true;
    m_dataSourceSyncJobMetricTarget = std::forward<DataSourceSyncJobMetricTargetT>(value);
  }
  template <typename DataSourceSyncJobMetricTargetT = DataSourceSyncJobMetricTarget>
  BatchDeleteDocumentRequest& WithDataSourceSyncJobMetricTarget(DataSourceSyncJobMetricTargetT&& value) {
    SetDataSourceSyncJobMetricTarget(std::forward<DataSourceSyncJobMetricTargetT>(value));
    return *this;
  }
  ///@}
 private:
