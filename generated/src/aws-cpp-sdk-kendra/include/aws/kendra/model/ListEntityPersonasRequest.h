...
class ListEntityPersonasRequest : public KendraRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  ListEntityPersonasRequest& WithId(IdT&& value) {
  ...
  template <typename IndexIdT = Aws::String>
  ListEntityPersonasRequest& WithIndexId(IndexIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListEntityPersonasRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEntityPersonasRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
