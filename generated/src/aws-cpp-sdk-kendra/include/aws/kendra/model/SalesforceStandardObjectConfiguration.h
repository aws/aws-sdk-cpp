...
class SalesforceStandardObjectConfiguration {
 public:
  AWS_KENDRA_API SalesforceStandardObjectConfiguration() = default;
   ...
   */
  inline SalesforceStandardObjectName GetName() const { return m_name; }
  inline bool NameHasBeenSet() const { return m_nameHasBeenSet; }
  inline void SetName(SalesforceStandardObjectName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SalesforceStandardObjectConfiguration& WithName(SalesforceStandardObjectName value) {
    SetName(value);
    return *this;
  }
  ///@}
