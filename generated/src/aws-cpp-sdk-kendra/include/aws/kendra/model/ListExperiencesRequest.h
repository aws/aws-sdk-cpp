...
class ListExperiencesRequest : public KendraRequest {
 public:
  ...
  template <typename IndexIdT = Aws::String>
  ListExperiencesRequest& WithIndexId(IndexIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListExperiencesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListExperiencesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
