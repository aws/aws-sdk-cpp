...
namespace Model
{
  ...
  {
  public:
    AWS_KENDRA_API ListExperiencesRequest() = default;
    ...
    template<typename IndexIdT = Aws::String>
    ListExperiencesRequest& WithIndexId(IndexIdT&& value) { SetIndexId(std::forward<IndexIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListExperiencesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
