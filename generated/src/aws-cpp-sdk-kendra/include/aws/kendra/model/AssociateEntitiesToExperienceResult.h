...
class AssociateEntitiesToExperienceResult {
 public:
  ...
  void SetFailedEntityList(FailedEntityListT&& value) {
    m_failedEntityListHasBeenSet = true;
    m_failedEntityList = std::forward<FailedEntityListT>(value);
  }
  template <typename FailedEntityListT = Aws::Vector<FailedEntity>>
  AssociateEntitiesToExperienceResult& WithFailedEntityList(FailedEntityListT&& value) {
    SetFailedEntityList(std::forward<FailedEntityListT>(value));
    return *this;
  }
  template <typename FailedEntityListT = FailedEntity>
  AssociateEntitiesToExperienceResult& AddFailedEntityList(FailedEntityListT&& value) {
    m_failedEntityListHasBeenSet = true;
    m_failedEntityList.emplace_back(std::forward<FailedEntityListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AssociateEntitiesToExperienceResult& WithRequestId(RequestIdT&& value) {
