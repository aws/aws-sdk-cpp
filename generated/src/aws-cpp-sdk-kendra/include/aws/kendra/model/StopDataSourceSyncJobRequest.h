...
namespace Model
{
  ...
  /**
   */
  class StopDataSourceSyncJobRequest : public KendraRequest
  {
  public:
    AWS_KENDRA_API StopDataSourceSyncJobRequest() = default;
    ...
    template<typename IdT = Aws::String>
    StopDataSourceSyncJobRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
