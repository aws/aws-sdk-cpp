...
class ListAccessControlConfigurationsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessControlConfigurationsResult& WithNextToken(NextTokenT&& value) {
   ...
   */
  inline const Aws::Vector<AccessControlConfigurationSummary>& GetAccessControlConfigurations() const {
    return m_accessControlConfigurations;
  }
  template <typename AccessControlConfigurationsT = Aws::Vector<AccessControlConfigurationSummary>>
  void SetAccessControlConfigurations(AccessControlConfigurationsT&& value) {
    m_accessControlConfigurationsHasBeenSet = true;
    m_accessControlConfigurations = std::forward<AccessControlConfigurationsT>(value);
  }
  template <typename AccessControlConfigurationsT = Aws::Vector<AccessControlConfigurationSummary>>
  ListAccessControlConfigurationsResult& WithAccessControlConfigurations(AccessControlConfigurationsT&& value) {
    SetAccessControlConfigurations(std::forward<AccessControlConfigurationsT>(value));
    return *this;
  }
  template <typename AccessControlConfigurationsT = AccessControlConfigurationSummary>
  ListAccessControlConfigurationsResult& AddAccessControlConfigurations(AccessControlConfigurationsT&& value) {
    m_accessControlConfigurationsHasBeenSet = true;
    m_accessControlConfigurations.emplace_back(std::forward<AccessControlConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessControlConfigurationsResult& WithRequestId(RequestIdT&& value) {
