...
class ConfluenceSpaceConfiguration {
 public:
  ...
  inline void SetCrawlPersonalSpaces(bool value) {
    m_crawlPersonalSpacesHasBeenSet = true;
    m_crawlPersonalSpaces = value;
  }
  inline ConfluenceSpaceConfiguration& WithCrawlPersonalSpaces(bool value) {
    SetCrawlPersonalSpaces(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCrawlArchivedSpaces(bool value) {
    m_crawlArchivedSpacesHasBeenSet = true;
    m_crawlArchivedSpaces = value;
  }
  inline ConfluenceSpaceConfiguration& WithCrawlArchivedSpaces(bool value) {
    SetCrawlArchivedSpaces(value);
    return *this;
  }
  ///@}
  ...
  void SetSpaceFieldMappings(SpaceFieldMappingsT&& value) {
    ...
    m_spaceFieldMappings = std::forward<SpaceFieldMappingsT>(value);
  }
  template <typename SpaceFieldMappingsT = Aws::Vector<ConfluenceSpaceToIndexFieldMapping>>
  ConfluenceSpaceConfiguration& WithSpaceFieldMappings(SpaceFieldMappingsT&& value) {
    SetSpaceFieldMappings(std::forward<SpaceFieldMappingsT>(value));
    return *this;
  }
  ...
  ConfluenceSpaceConfiguration& AddSpaceFieldMappings(SpaceFieldMappingsT&& value) {
    m_spaceFieldMappingsHasBeenSet = true;
    m_spaceFieldMappings.emplace_back(std::forward<SpaceFieldMappingsT>(value));
    return *this;
  }
  ///@}
 private:
