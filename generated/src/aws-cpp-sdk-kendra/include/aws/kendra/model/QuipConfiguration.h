...
class QuipConfiguration {
 public:
  ...
  inline void SetCrawlFileComments(bool value) {
    m_crawlFileCommentsHasBeenSet = true;
    m_crawlFileComments = value;
  }
  inline QuipConfiguration& WithCrawlFileComments(bool value) {
    SetCrawlFileComments(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCrawlChatRooms(bool value) {
    m_crawlChatRoomsHasBeenSet = true;
    m_crawlChatRooms = value;
  }
  inline QuipConfiguration& WithCrawlChatRooms(bool value) {
    SetCrawlChatRooms(value);
    return *this;
  }
  ///@}
  ...
  inline QuipConfiguration& WithCrawlAttachments(bool value) {
  ...
  void SetFolderIds(FolderIdsT&& value) {
    ...
    m_folderIds = std::forward<FolderIdsT>(value);
  }
  template <typename FolderIdsT = Aws::Vector<Aws::String>>
  QuipConfiguration& WithFolderIds(FolderIdsT&& value) {
    SetFolderIds(std::forward<FolderIdsT>(value));
    return *this;
  }
  template <typename FolderIdsT = Aws::String>
  QuipConfiguration& AddFolderIds(FolderIdsT&& value) {
    m_folderIdsHasBeenSet = true;
    m_folderIds.emplace_back(std::forward<FolderIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThreadFieldMappings(ThreadFieldMappingsT&& value) {
    ...
    m_threadFieldMappings = std::forward<ThreadFieldMappingsT>(value);
  }
  template <typename ThreadFieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  QuipConfiguration& WithThreadFieldMappings(ThreadFieldMappingsT&& value) {
    SetThreadFieldMappings(std::forward<ThreadFieldMappingsT>(value));
    return *this;
  }
  ...
  QuipConfiguration& AddThreadFieldMappings(ThreadFieldMappingsT&& value) {
    m_threadFieldMappingsHasBeenSet = true;
    m_threadFieldMappings.emplace_back(std::forward<ThreadFieldMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMessageFieldMappings(MessageFieldMappingsT&& value) {
    ...
    m_messageFieldMappings = std::forward<MessageFieldMappingsT>(value);
  }
  template <typename MessageFieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  QuipConfiguration& WithMessageFieldMappings(MessageFieldMappingsT&& value) {
    SetMessageFieldMappings(std::forward<MessageFieldMappingsT>(value));
    return *this;
  }
  ...
  QuipConfiguration& AddMessageFieldMappings(MessageFieldMappingsT&& value) {
    m_messageFieldMappingsHasBeenSet = true;
    m_messageFieldMappings.emplace_back(std::forward<MessageFieldMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAttachmentFieldMappings(AttachmentFieldMappingsT&& value) {
    ...
    m_attachmentFieldMappings = std::forward<AttachmentFieldMappingsT>(value);
  }
  template <typename AttachmentFieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  QuipConfiguration& WithAttachmentFieldMappings(AttachmentFieldMappingsT&& value) {
    SetAttachmentFieldMappings(std::forward<AttachmentFieldMappingsT>(value));
    return *this;
  }
  ...
  QuipConfiguration& AddAttachmentFieldMappings(AttachmentFieldMappingsT&& value) {
    m_attachmentFieldMappingsHasBeenSet = true;
    m_attachmentFieldMappings.emplace_back(std::forward<AttachmentFieldMappingsT>(value));
    return *this;
  }
  ///@}
