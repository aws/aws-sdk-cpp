...
class BatchGetDocumentStatusRequest : public KendraRequest {
 public:
  ...
  void SetDocumentInfoList(DocumentInfoListT&& value) {
    m_documentInfoListHasBeenSet = true;
    m_documentInfoList = std::forward<DocumentInfoListT>(value);
  }
  template <typename DocumentInfoListT = Aws::Vector<DocumentInfo>>
  BatchGetDocumentStatusRequest& WithDocumentInfoList(DocumentInfoListT&& value) {
    SetDocumentInfoList(std::forward<DocumentInfoListT>(value));
    return *this;
  }
  ...
  BatchGetDocumentStatusRequest& AddDocumentInfoList(DocumentInfoListT&& value) {
    m_documentInfoListHasBeenSet = true;
    m_documentInfoList.emplace_back(std::forward<DocumentInfoListT>(value));
    return *this;
  }
  ///@}
 private:
