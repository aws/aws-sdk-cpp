...
class JiraConfiguration {
 public:
  ...
  void SetJiraAccountUrl(JiraAccountUrlT&& value) {
    ...
    m_jiraAccountUrl = std::forward<JiraAccountUrlT>(value);
  }
  template <typename JiraAccountUrlT = Aws::String>
  JiraConfiguration& WithJiraAccountUrl(JiraAccountUrlT&& value) {
    SetJiraAccountUrl(std::forward<JiraAccountUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline JiraConfiguration& WithUseChangeLog(bool value) {
  ...
  JiraConfiguration& AddProject(ProjectT&& value) {
    m_projectHasBeenSet = true;
    m_project.emplace_back(std::forward<ProjectT>(value));
    return *this;
  }
  ///@}
  ...
  JiraConfiguration& AddIssueType(IssueTypeT&& value) {
    m_issueTypeHasBeenSet = true;
    m_issueType.emplace_back(std::forward<IssueTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIssueSubEntityFilter(IssueSubEntityFilterT&& value) {
    ...
    m_issueSubEntityFilter = std::forward<IssueSubEntityFilterT>(value);
  }
  template <typename IssueSubEntityFilterT = Aws::Vector<IssueSubEntity>>
  JiraConfiguration& WithIssueSubEntityFilter(IssueSubEntityFilterT&& value) {
    SetIssueSubEntityFilter(std::forward<IssueSubEntityFilterT>(value));
    return *this;
  }
  inline JiraConfiguration& AddIssueSubEntityFilter(IssueSubEntity value) {
    m_issueSubEntityFilterHasBeenSet = true;
    m_issueSubEntityFilter.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetIssueFieldMappings(IssueFieldMappingsT&& value) {
    ...
    m_issueFieldMappings = std::forward<IssueFieldMappingsT>(value);
  }
  template <typename IssueFieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  JiraConfiguration& WithIssueFieldMappings(IssueFieldMappingsT&& value) {
    SetIssueFieldMappings(std::forward<IssueFieldMappingsT>(value));
    return *this;
  }
  ...
  JiraConfiguration& AddIssueFieldMappings(IssueFieldMappingsT&& value) {
    m_issueFieldMappingsHasBeenSet = true;
    m_issueFieldMappings.emplace_back(std::forward<IssueFieldMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProjectFieldMappings(ProjectFieldMappingsT&& value) {
    ...
    m_projectFieldMappings = std::forward<ProjectFieldMappingsT>(value);
  }
  template <typename ProjectFieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  JiraConfiguration& WithProjectFieldMappings(ProjectFieldMappingsT&& value) {
    SetProjectFieldMappings(std::forward<ProjectFieldMappingsT>(value));
    return *this;
  }
  ...
  JiraConfiguration& AddProjectFieldMappings(ProjectFieldMappingsT&& value) {
    m_projectFieldMappingsHasBeenSet = true;
    m_projectFieldMappings.emplace_back(std::forward<ProjectFieldMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorkLogFieldMappings(WorkLogFieldMappingsT&& value) {
    ...
    m_workLogFieldMappings = std::forward<WorkLogFieldMappingsT>(value);
  }
  template <typename WorkLogFieldMappingsT = Aws::Vector<DataSourceToIndexFieldMapping>>
  JiraConfiguration& WithWorkLogFieldMappings(WorkLogFieldMappingsT&& value) {
    SetWorkLogFieldMappings(std::forward<WorkLogFieldMappingsT>(value));
    return *this;
  }
  ...
  JiraConfiguration& AddWorkLogFieldMappings(WorkLogFieldMappingsT&& value) {
    m_workLogFieldMappingsHasBeenSet = true;
    m_workLogFieldMappings.emplace_back(std::forward<WorkLogFieldMappingsT>(value));
    return *this;
  }
  ///@}
