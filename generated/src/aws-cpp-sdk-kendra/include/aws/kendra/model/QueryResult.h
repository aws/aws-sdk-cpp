...
class QueryResult {
 public:
  ...
  void SetFacetResults(FacetResultsT&& value) {
    ...
    m_facetResults = std::forward<FacetResultsT>(value);
  }
  template <typename FacetResultsT = Aws::Vector<FacetResult>>
  QueryResult& WithFacetResults(FacetResultsT&& value) {
    SetFacetResults(std::forward<FacetResultsT>(value));
    return *this;
  }
  template <typename FacetResultsT = FacetResult>
  QueryResult& AddFacetResults(FacetResultsT&& value) {
    m_facetResultsHasBeenSet = true;
    m_facetResults.emplace_back(std::forward<FacetResultsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalNumberOfResults(int value) {
    m_totalNumberOfResultsHasBeenSet = true;
    m_totalNumberOfResults = value;
  }
  inline QueryResult& WithTotalNumberOfResults(int value) {
    SetTotalNumberOfResults(value);
    return *this;
  }
  ///@}
  ...
  void SetSpellCorrectedQueries(SpellCorrectedQueriesT&& value) {
    ...
    m_spellCorrectedQueries = std::forward<SpellCorrectedQueriesT>(value);
  }
  template <typename SpellCorrectedQueriesT = Aws::Vector<SpellCorrectedQuery>>
  QueryResult& WithSpellCorrectedQueries(SpellCorrectedQueriesT&& value) {
    SetSpellCorrectedQueries(std::forward<SpellCorrectedQueriesT>(value));
    return *this;
  }
  ...
  QueryResult& AddSpellCorrectedQueries(SpellCorrectedQueriesT&& value) {
    m_spellCorrectedQueriesHasBeenSet = true;
    m_spellCorrectedQueries.emplace_back(std::forward<SpellCorrectedQueriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFeaturedResultsItems(FeaturedResultsItemsT&& value) {
    ...
    m_featuredResultsItems = std::forward<FeaturedResultsItemsT>(value);
  }
  template <typename FeaturedResultsItemsT = Aws::Vector<FeaturedResultsItem>>
  QueryResult& WithFeaturedResultsItems(FeaturedResultsItemsT&& value) {
    SetFeaturedResultsItems(std::forward<FeaturedResultsItemsT>(value));
    return *this;
  }
  ...
  QueryResult& AddFeaturedResultsItems(FeaturedResultsItemsT&& value) {
    m_featuredResultsItemsHasBeenSet = true;
    m_featuredResultsItems.emplace_back(std::forward<FeaturedResultsItemsT>(value));
    return *this;
  }
  ///@}
