...
class JsonTokenTypeConfiguration {
 public:
  ...
  void SetUserNameAttributeField(UserNameAttributeFieldT&& value) {
    m_userNameAttributeFieldHasBeenSet = true;
    m_userNameAttributeField = std::forward<UserNameAttributeFieldT>(value);
  }
  template <typename UserNameAttributeFieldT = Aws::String>
  JsonTokenTypeConfiguration& WithUserNameAttributeField(UserNameAttributeFieldT&& value) {
    SetUserNameAttributeField(std::forward<UserNameAttributeFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupAttributeField(GroupAttributeFieldT&& value) {
    m_groupAttributeFieldHasBeenSet = true;
    m_groupAttributeField = std::forward<GroupAttributeFieldT>(value);
  }
  template <typename GroupAttributeFieldT = Aws::String>
  JsonTokenTypeConfiguration& WithGroupAttributeField(GroupAttributeFieldT&& value) {
    SetGroupAttributeField(std::forward<GroupAttributeFieldT>(value));
    return *this;
  }
  ///@}
 private:
