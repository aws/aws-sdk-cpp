...
namespace Model
{
  ...
  {
  public:
    AWS_KENDRA_API CreateFaqResult() = default;
    ...
    template<typename IdT = Aws::String>
    CreateFaqResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateFaqResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
