...
class ConfluenceBlogToIndexFieldMapping {
 public:
  ...
  inline void SetDataSourceFieldName(ConfluenceBlogFieldName value) {
    m_dataSourceFieldNameHasBeenSet = true;
    m_dataSourceFieldName = value;
  }
  inline ConfluenceBlogToIndexFieldMapping& WithDataSourceFieldName(ConfluenceBlogFieldName value) {
