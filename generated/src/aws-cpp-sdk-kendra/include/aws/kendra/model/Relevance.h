...
namespace Model
{
  ...
  public:
    ...
    template<typename DurationT = Aws::String>
    Relevance& WithDuration(DurationT&& value) { SetDuration(std::forward<DurationT>(value)); return *this;}
    ///@}
     ...
     */
    inline Order GetRankOrder() const { return m_rankOrder; }
    inline bool RankOrderHasBeenSet() const { return m_rankOrderHasBeenSet; }
    inline void SetRankOrder(Order value) { m_rankOrderHasBeenSet = true; m_rankOrder = value; }
    inline Relevance& WithRankOrder(Order value) { SetRankOrder(value); return *this;}
    ///@}
    ...
    template<typename ValueImportanceMapT = Aws::Map<Aws::String, int>>
    void SetValueImportanceMap(ValueImportanceMapT&& value) { m_valueImportanceMapHasBeenSet = true; m_valueImportanceMap = std::forward<ValueImportanceMapT>(value); }
    template<typename ValueImportanceMapT = Aws::Map<Aws::String, int>>
    Relevance& WithValueImportanceMap(ValueImportanceMapT&& value) { SetValueImportanceMap(std::forward<ValueImportanceMapT>(value)); return *this;}
    inline Relevance& AddValueImportanceMap(Aws::String key, int value) {
      m_valueImportanceMapHasBeenSet = true; m_valueImportanceMap.emplace(key, value); return *this;
    }
    ///@}
  private:
