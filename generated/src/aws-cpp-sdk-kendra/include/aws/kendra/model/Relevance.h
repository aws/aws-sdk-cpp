...
class Relevance {
 public:
  ...
  inline void SetFreshness(bool value) {
    m_freshnessHasBeenSet = true;
    m_freshness = value;
  }
  inline Relevance& WithFreshness(bool value) {
    SetFreshness(value);
    return *this;
  }
  ///@}
  ...
  inline void SetImportance(int value) {
    m_importanceHasBeenSet = true;
    m_importance = value;
  }
  inline Relevance& WithImportance(int value) {
    SetImportance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRankOrder(Order value) {
    m_rankOrderHasBeenSet = true;
    m_rankOrder = value;
  }
  inline Relevance& WithRankOrder(Order value) {
    SetRankOrder(value);
    return *this;
  }
  ///@}
  ...
  void SetValueImportanceMap(ValueImportanceMapT&& value) {
    ...
    m_valueImportanceMap = std::forward<ValueImportanceMapT>(value);
  }
  template <typename ValueImportanceMapT = Aws::Map<Aws::String, int>>
  Relevance& WithValueImportanceMap(ValueImportanceMapT&& value) {
    SetValueImportanceMap(std::forward<ValueImportanceMapT>(value));
    return *this;
  }
  inline Relevance& AddValueImportanceMap(Aws::String key, int value) {
    m_valueImportanceMapHasBeenSet = true;
    m_valueImportanceMap.emplace(key, value);
    return *this;
  }
  ///@}
 private:
