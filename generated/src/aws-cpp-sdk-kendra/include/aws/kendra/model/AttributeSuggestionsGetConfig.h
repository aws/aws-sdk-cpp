...
class AttributeSuggestionsGetConfig {
 public:
  ...
  void SetAdditionalResponseAttributes(AdditionalResponseAttributesT&& value) {
    ...
    m_additionalResponseAttributes = std::forward<AdditionalResponseAttributesT>(value);
  }
  template <typename AdditionalResponseAttributesT = Aws::Vector<Aws::String>>
  AttributeSuggestionsGetConfig& WithAdditionalResponseAttributes(AdditionalResponseAttributesT&& value) {
    SetAdditionalResponseAttributes(std::forward<AdditionalResponseAttributesT>(value));
    return *this;
  }
  ...
  AttributeSuggestionsGetConfig& AddAdditionalResponseAttributes(AdditionalResponseAttributesT&& value) {
    m_additionalResponseAttributesHasBeenSet = true;
    m_additionalResponseAttributes.emplace_back(std::forward<AdditionalResponseAttributesT>(value));
    return *this;
  }
  ///@}
