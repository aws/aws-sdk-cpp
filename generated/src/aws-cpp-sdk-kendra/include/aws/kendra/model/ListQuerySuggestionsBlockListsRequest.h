...
class ListQuerySuggestionsBlockListsRequest : public KendraRequest {
 public:
  ...
  template <typename IndexIdT = Aws::String>
  ListQuerySuggestionsBlockListsRequest& WithIndexId(IndexIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListQuerySuggestionsBlockListsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListQuerySuggestionsBlockListsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
