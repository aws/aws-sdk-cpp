...
namespace Model
{
  ...
  /**
   */
  class ListQuerySuggestionsBlockListsRequest : public KendraRequest
  {
  public:
    AWS_KENDRA_API ListQuerySuggestionsBlockListsRequest() = default;
    ...
    template<typename IndexIdT = Aws::String>
    ListQuerySuggestionsBlockListsRequest& WithIndexId(IndexIdT&& value) { SetIndexId(std::forward<IndexIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListQuerySuggestionsBlockListsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
