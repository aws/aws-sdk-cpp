...
class RetrieveRequest : public KendraRequest {
 public:
  ...
  void SetRequestedDocumentAttributes(RequestedDocumentAttributesT&& value) {
    m_requestedDocumentAttributesHasBeenSet = true;
    m_requestedDocumentAttributes = std::forward<RequestedDocumentAttributesT>(value);
  }
  template <typename RequestedDocumentAttributesT = Aws::Vector<Aws::String>>
  RetrieveRequest& WithRequestedDocumentAttributes(RequestedDocumentAttributesT&& value) {
    SetRequestedDocumentAttributes(std::forward<RequestedDocumentAttributesT>(value));
    return *this;
  }
  ...
  RetrieveRequest& AddRequestedDocumentAttributes(RequestedDocumentAttributesT&& value) {
    m_requestedDocumentAttributesHasBeenSet = true;
    m_requestedDocumentAttributes.emplace_back(std::forward<RequestedDocumentAttributesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<DocumentRelevanceConfiguration>& GetDocumentRelevanceOverrideConfigurations() const {
    return m_documentRelevanceOverrideConfigurations;
  }
  ...
  void SetDocumentRelevanceOverrideConfigurations(DocumentRelevanceOverrideConfigurationsT&& value) {
    m_documentRelevanceOverrideConfigurationsHasBeenSet = true;
    m_documentRelevanceOverrideConfigurations = std::forward<DocumentRelevanceOverrideConfigurationsT>(value);
  }
  template <typename DocumentRelevanceOverrideConfigurationsT = Aws::Vector<DocumentRelevanceConfiguration>>
  RetrieveRequest& WithDocumentRelevanceOverrideConfigurations(DocumentRelevanceOverrideConfigurationsT&& value) {
    SetDocumentRelevanceOverrideConfigurations(std::forward<DocumentRelevanceOverrideConfigurationsT>(value));
    return *this;
  }
  ...
  RetrieveRequest& AddDocumentRelevanceOverrideConfigurations(DocumentRelevanceOverrideConfigurationsT&& value) {
    m_documentRelevanceOverrideConfigurationsHasBeenSet = true;
    m_documentRelevanceOverrideConfigurations.emplace_back(std::forward<DocumentRelevanceOverrideConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline RetrieveRequest& WithPageNumber(int value) {
    SetPageNumber(value);
    return *this;
  }
  ///@}
  ...
  inline RetrieveRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
