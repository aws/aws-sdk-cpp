...
class ConfluenceSpaceToIndexFieldMapping {
 public:
  ...
  inline void SetDataSourceFieldName(ConfluenceSpaceFieldName value) {
    m_dataSourceFieldNameHasBeenSet = true;
    m_dataSourceFieldName = value;
  }
  inline ConfluenceSpaceToIndexFieldMapping& WithDataSourceFieldName(ConfluenceSpaceFieldName value) {
