...
class FacetResult {
 public:
  ...
  inline void SetDocumentAttributeValueType(DocumentAttributeValueType value) {
    m_documentAttributeValueTypeHasBeenSet = true;
    m_documentAttributeValueType = value;
  }
  inline FacetResult& WithDocumentAttributeValueType(DocumentAttributeValueType value) {
    SetDocumentAttributeValueType(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<DocumentAttributeValueCountPair>& GetDocumentAttributeValueCountPairs() const {
    return m_documentAttributeValueCountPairs;
  }
  ...
  void SetDocumentAttributeValueCountPairs(DocumentAttributeValueCountPairsT&& value) {
    ...
    m_documentAttributeValueCountPairs = std::forward<DocumentAttributeValueCountPairsT>(value);
  }
  template <typename DocumentAttributeValueCountPairsT = Aws::Vector<DocumentAttributeValueCountPair>>
  FacetResult& WithDocumentAttributeValueCountPairs(DocumentAttributeValueCountPairsT&& value) {
    SetDocumentAttributeValueCountPairs(std::forward<DocumentAttributeValueCountPairsT>(value));
    return *this;
  }
  ...
  FacetResult& AddDocumentAttributeValueCountPairs(DocumentAttributeValueCountPairsT&& value) {
    m_documentAttributeValueCountPairsHasBeenSet = true;
    m_documentAttributeValueCountPairs.emplace_back(std::forward<DocumentAttributeValueCountPairsT>(value));
    return *this;
  }
  ///@}
 private:
