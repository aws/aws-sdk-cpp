...
class ListThesauriResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListThesauriResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetThesaurusSummaryItems(ThesaurusSummaryItemsT&& value) {
    m_thesaurusSummaryItemsHasBeenSet = true;
    m_thesaurusSummaryItems = std::forward<ThesaurusSummaryItemsT>(value);
  }
  template <typename ThesaurusSummaryItemsT = Aws::Vector<ThesaurusSummary>>
  ListThesauriResult& WithThesaurusSummaryItems(ThesaurusSummaryItemsT&& value) {
    SetThesaurusSummaryItems(std::forward<ThesaurusSummaryItemsT>(value));
    return *this;
  }
  template <typename ThesaurusSummaryItemsT = ThesaurusSummary>
  ListThesauriResult& AddThesaurusSummaryItems(ThesaurusSummaryItemsT&& value) {
    m_thesaurusSummaryItemsHasBeenSet = true;
    m_thesaurusSummaryItems.emplace_back(std::forward<ThesaurusSummaryItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListThesauriResult& WithRequestId(RequestIdT&& value) {
