...
class DescribeQuerySuggestionsConfigResult {
 public:
  ...
  inline DescribeQuerySuggestionsConfigResult& WithMode(Mode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(QuerySuggestionsStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeQuerySuggestionsConfigResult& WithStatus(QuerySuggestionsStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeQuerySuggestionsConfigResult& WithQueryLogLookBackWindowInDays(int value) {
  ...
  inline DescribeQuerySuggestionsConfigResult& WithIncludeQueriesWithoutUserInformation(bool value) {
  ...
  inline DescribeQuerySuggestionsConfigResult& WithMinimumNumberOfQueryingUsers(int value) {
  ...
  inline DescribeQuerySuggestionsConfigResult& WithMinimumQueryCount(int value) {
  ...
  void SetLastSuggestionsBuildTime(LastSuggestionsBuildTimeT&& value) {
    ...
    m_lastSuggestionsBuildTime = std::forward<LastSuggestionsBuildTimeT>(value);
  }
  template <typename LastSuggestionsBuildTimeT = Aws::Utils::DateTime>
  DescribeQuerySuggestionsConfigResult& WithLastSuggestionsBuildTime(LastSuggestionsBuildTimeT&& value) {
    SetLastSuggestionsBuildTime(std::forward<LastSuggestionsBuildTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastClearTime(LastClearTimeT&& value) {
    ...
    m_lastClearTime = std::forward<LastClearTimeT>(value);
  }
  template <typename LastClearTimeT = Aws::Utils::DateTime>
  DescribeQuerySuggestionsConfigResult& WithLastClearTime(LastClearTimeT&& value) {
    SetLastClearTime(std::forward<LastClearTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalSuggestionsCount(int value) {
    m_totalSuggestionsCountHasBeenSet = true;
    m_totalSuggestionsCount = value;
  }
  inline DescribeQuerySuggestionsConfigResult& WithTotalSuggestionsCount(int value) {
    SetTotalSuggestionsCount(value);
    return *this;
  }
  ///@}
