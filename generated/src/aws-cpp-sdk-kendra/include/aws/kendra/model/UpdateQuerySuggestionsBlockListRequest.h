...
class UpdateQuerySuggestionsBlockListRequest : public KendraRequest {
 public:
  ...
  template <typename IndexIdT = Aws::String>
  UpdateQuerySuggestionsBlockListRequest& WithIndexId(IndexIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateQuerySuggestionsBlockListRequest& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateQuerySuggestionsBlockListRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateQuerySuggestionsBlockListRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename SourceS3PathT = S3Path>
  UpdateQuerySuggestionsBlockListRequest& WithSourceS3Path(SourceS3PathT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  UpdateQuerySuggestionsBlockListRequest& WithRoleArn(RoleArnT&& value) {
