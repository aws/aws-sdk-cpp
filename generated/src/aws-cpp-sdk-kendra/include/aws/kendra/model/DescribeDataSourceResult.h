...
class DescribeDataSourceResult {
 public:
  ...
  inline void SetType(DataSourceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DescribeDataSourceResult& WithType(DataSourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeDataSourceResult& WithStatus(DataSourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
