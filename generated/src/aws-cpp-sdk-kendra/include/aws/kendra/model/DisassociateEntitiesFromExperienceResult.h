...
class DisassociateEntitiesFromExperienceResult {
 public:
  ...
  AWS_KENDRA_API DisassociateEntitiesFromExperienceResult& operator=(
  ...
  template <typename FailedEntityListT = Aws::Vector<FailedEntity>>
  DisassociateEntitiesFromExperienceResult& WithFailedEntityList(FailedEntityListT&& value) {
    SetFailedEntityList(std::forward<FailedEntityListT>(value));
    return *this;
  }
  template <typename FailedEntityListT = FailedEntity>
  DisassociateEntitiesFromExperienceResult& AddFailedEntityList(FailedEntityListT&& value) {
    m_failedEntityListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateEntitiesFromExperienceResult& WithRequestId(RequestIdT&& value) {
