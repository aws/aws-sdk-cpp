...
class BatchDeleteFeaturedResultsSetRequest : public KendraRequest {
 public:
  ...
  template <typename IndexIdT = Aws::String>
  BatchDeleteFeaturedResultsSetRequest& WithIndexId(IndexIdT&& value) {
  ...
  void SetFeaturedResultsSetIds(FeaturedResultsSetIdsT&& value) {
    m_featuredResultsSetIdsHasBeenSet = true;
    m_featuredResultsSetIds = std::forward<FeaturedResultsSetIdsT>(value);
  }
  template <typename FeaturedResultsSetIdsT = Aws::Vector<Aws::String>>
  BatchDeleteFeaturedResultsSetRequest& WithFeaturedResultsSetIds(FeaturedResultsSetIdsT&& value) {
    SetFeaturedResultsSetIds(std::forward<FeaturedResultsSetIdsT>(value));
    return *this;
  }
  template <typename FeaturedResultsSetIdsT = Aws::String>
  BatchDeleteFeaturedResultsSetRequest& AddFeaturedResultsSetIds(FeaturedResultsSetIdsT&& value) {
    m_featuredResultsSetIdsHasBeenSet = true;
    m_featuredResultsSetIds.emplace_back(std::forward<FeaturedResultsSetIdsT>(value));
    return *this;
  }
  ///@}
 private:
