...
class SqlConfiguration {
 public:
  ...
  inline void SetQueryIdentifiersEnclosingOption(QueryIdentifiersEnclosingOption value) {
    m_queryIdentifiersEnclosingOptionHasBeenSet = true;
    m_queryIdentifiersEnclosingOption = value;
  }
  inline SqlConfiguration& WithQueryIdentifiersEnclosingOption(QueryIdentifiersEnclosingOption value) {
    SetQueryIdentifiersEnclosingOption(value);
    return *this;
  }
  ///@}
 private:
