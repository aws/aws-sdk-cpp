...
class CreateQuerySuggestionsBlockListRequest : public KendraRequest {
 public:
  ...
  template <typename IndexIdT = Aws::String>
  CreateQuerySuggestionsBlockListRequest& WithIndexId(IndexIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateQuerySuggestionsBlockListRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateQuerySuggestionsBlockListRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename SourceS3PathT = S3Path>
  CreateQuerySuggestionsBlockListRequest& WithSourceS3Path(SourceS3PathT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateQuerySuggestionsBlockListRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  CreateQuerySuggestionsBlockListRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateQuerySuggestionsBlockListRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateQuerySuggestionsBlockListRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
