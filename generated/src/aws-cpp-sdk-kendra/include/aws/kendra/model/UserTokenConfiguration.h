...
class UserTokenConfiguration {
 public:
  ...
  void SetJwtTokenTypeConfiguration(JwtTokenTypeConfigurationT&& value) {
    ...
    m_jwtTokenTypeConfiguration = std::forward<JwtTokenTypeConfigurationT>(value);
  }
  template <typename JwtTokenTypeConfigurationT = JwtTokenTypeConfiguration>
  UserTokenConfiguration& WithJwtTokenTypeConfiguration(JwtTokenTypeConfigurationT&& value) {
    SetJwtTokenTypeConfiguration(std::forward<JwtTokenTypeConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJsonTokenTypeConfiguration(JsonTokenTypeConfigurationT&& value) {
    ...
    m_jsonTokenTypeConfiguration = std::forward<JsonTokenTypeConfigurationT>(value);
  }
  template <typename JsonTokenTypeConfigurationT = JsonTokenTypeConfiguration>
  UserTokenConfiguration& WithJsonTokenTypeConfiguration(JsonTokenTypeConfigurationT&& value) {
    SetJsonTokenTypeConfiguration(std::forward<JsonTokenTypeConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
