...
namespace Model
{
  ...
  {
  public:
    AWS_KENDRA_API DeleteFaqRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DeleteFaqRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename IndexIdT = Aws::String>
    DeleteFaqRequest& WithIndexId(IndexIdT&& value) { SetIndexId(std::forward<IndexIdT>(value)); return *this;}
    ///@}
  private:
