...
namespace Model
{
  ...
  /**
   */
  class ListAccessControlConfigurationsRequest : public KendraRequest
  {
  public:
    AWS_KENDRA_API ListAccessControlConfigurationsRequest() = default;
    ...
    template<typename IndexIdT = Aws::String>
    ListAccessControlConfigurationsRequest& WithIndexId(IndexIdT&& value) { SetIndexId(std::forward<IndexIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAccessControlConfigurationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
