...
class ListAccessControlConfigurationsRequest : public KendraRequest {
 public:
  ...
  template <typename IndexIdT = Aws::String>
  ListAccessControlConfigurationsRequest& WithIndexId(IndexIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessControlConfigurationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccessControlConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
