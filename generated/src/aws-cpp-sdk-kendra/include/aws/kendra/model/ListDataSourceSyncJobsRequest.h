...
class ListDataSourceSyncJobsRequest : public KendraRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  ListDataSourceSyncJobsRequest& WithId(IdT&& value) {
  ...
  template <typename IndexIdT = Aws::String>
  ListDataSourceSyncJobsRequest& WithIndexId(IndexIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDataSourceSyncJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDataSourceSyncJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartTimeFilterT = TimeRange>
  ListDataSourceSyncJobsRequest& WithStartTimeFilter(StartTimeFilterT&& value) {
  ...
  inline void SetStatusFilter(DataSourceSyncJobStatus value) {
    m_statusFilterHasBeenSet = true;
    m_statusFilter = value;
  }
  inline ListDataSourceSyncJobsRequest& WithStatusFilter(DataSourceSyncJobStatus value) {
