...
class ConfluencePageConfiguration {
 public:
  ...
  void SetPageFieldMappings(PageFieldMappingsT&& value) {
    m_pageFieldMappingsHasBeenSet = true;
    m_pageFieldMappings = std::forward<PageFieldMappingsT>(value);
  }
  template <typename PageFieldMappingsT = Aws::Vector<ConfluencePageToIndexFieldMapping>>
  ConfluencePageConfiguration& WithPageFieldMappings(PageFieldMappingsT&& value) {
    SetPageFieldMappings(std::forward<PageFieldMappingsT>(value));
    return *this;
  }
  template <typename PageFieldMappingsT = ConfluencePageToIndexFieldMapping>
  ConfluencePageConfiguration& AddPageFieldMappings(PageFieldMappingsT&& value) {
    m_pageFieldMappingsHasBeenSet = true;
    m_pageFieldMappings.emplace_back(std::forward<PageFieldMappingsT>(value));
    return *this;
  }
  ///@}
 private:
