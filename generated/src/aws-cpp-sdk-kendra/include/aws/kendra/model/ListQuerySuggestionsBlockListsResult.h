...
class ListQuerySuggestionsBlockListsResult {
 public:
  ...
  void SetBlockListSummaryItems(BlockListSummaryItemsT&& value) {
    m_blockListSummaryItemsHasBeenSet = true;
    m_blockListSummaryItems = std::forward<BlockListSummaryItemsT>(value);
  }
  template <typename BlockListSummaryItemsT = Aws::Vector<QuerySuggestionsBlockListSummary>>
  ListQuerySuggestionsBlockListsResult& WithBlockListSummaryItems(BlockListSummaryItemsT&& value) {
    SetBlockListSummaryItems(std::forward<BlockListSummaryItemsT>(value));
    return *this;
  }
  template <typename BlockListSummaryItemsT = QuerySuggestionsBlockListSummary>
  ListQuerySuggestionsBlockListsResult& AddBlockListSummaryItems(BlockListSummaryItemsT&& value) {
    m_blockListSummaryItemsHasBeenSet = true;
    m_blockListSummaryItems.emplace_back(std::forward<BlockListSummaryItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListQuerySuggestionsBlockListsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListQuerySuggestionsBlockListsResult& WithRequestId(RequestIdT&& value) {
