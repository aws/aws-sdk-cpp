...
class CollapsedResultDetail {
 public:
  ...
  void SetDocumentAttribute(DocumentAttributeT&& value) {
    m_documentAttributeHasBeenSet = true;
    m_documentAttribute = std::forward<DocumentAttributeT>(value);
  }
  template <typename DocumentAttributeT = DocumentAttribute>
  CollapsedResultDetail& WithDocumentAttribute(DocumentAttributeT&& value) {
    SetDocumentAttribute(std::forward<DocumentAttributeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExpandedResults(ExpandedResultsT&& value) {
    m_expandedResultsHasBeenSet = true;
    m_expandedResults = std::forward<ExpandedResultsT>(value);
  }
  template <typename ExpandedResultsT = Aws::Vector<ExpandedResultItem>>
  CollapsedResultDetail& WithExpandedResults(ExpandedResultsT&& value) {
    SetExpandedResults(std::forward<ExpandedResultsT>(value));
    return *this;
  }
  template <typename ExpandedResultsT = ExpandedResultItem>
  CollapsedResultDetail& AddExpandedResults(ExpandedResultsT&& value) {
    m_expandedResultsHasBeenSet = true;
    m_expandedResults.emplace_back(std::forward<ExpandedResultsT>(value));
    return *this;
  }
  ///@}
 private:
