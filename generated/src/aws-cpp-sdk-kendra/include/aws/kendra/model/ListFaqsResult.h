...
class ListFaqsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListFaqsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetFaqSummaryItems(FaqSummaryItemsT&& value) {
    m_faqSummaryItemsHasBeenSet = true;
    m_faqSummaryItems = std::forward<FaqSummaryItemsT>(value);
  }
  template <typename FaqSummaryItemsT = Aws::Vector<FaqSummary>>
  ListFaqsResult& WithFaqSummaryItems(FaqSummaryItemsT&& value) {
    SetFaqSummaryItems(std::forward<FaqSummaryItemsT>(value));
    return *this;
  }
  template <typename FaqSummaryItemsT = FaqSummary>
  ListFaqsResult& AddFaqSummaryItems(FaqSummaryItemsT&& value) {
    m_faqSummaryItemsHasBeenSet = true;
    m_faqSummaryItems.emplace_back(std::forward<FaqSummaryItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListFaqsResult& WithRequestId(RequestIdT&& value) {
