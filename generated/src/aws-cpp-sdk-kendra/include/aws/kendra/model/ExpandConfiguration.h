...
class ExpandConfiguration {
 public:
  ...
  inline void SetMaxResultItemsToExpand(int value) {
    m_maxResultItemsToExpandHasBeenSet = true;
    m_maxResultItemsToExpand = value;
  }
  inline ExpandConfiguration& WithMaxResultItemsToExpand(int value) {
    SetMaxResultItemsToExpand(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxExpandedResultsPerItem(int value) {
    m_maxExpandedResultsPerItemHasBeenSet = true;
    m_maxExpandedResultsPerItem = value;
  }
  inline ExpandConfiguration& WithMaxExpandedResultsPerItem(int value) {
    SetMaxExpandedResultsPerItem(value);
    return *this;
  }
  ///@}
 private:
