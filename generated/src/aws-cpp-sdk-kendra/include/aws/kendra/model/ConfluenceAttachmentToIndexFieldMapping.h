...
class ConfluenceAttachmentToIndexFieldMapping {
 public:
  ...
  inline void SetDataSourceFieldName(ConfluenceAttachmentFieldName value) {
    m_dataSourceFieldNameHasBeenSet = true;
    m_dataSourceFieldName = value;
  }
  inline ConfluenceAttachmentToIndexFieldMapping& WithDataSourceFieldName(ConfluenceAttachmentFieldName value) {
    SetDataSourceFieldName(value);
    return *this;
  }
  ///@}
  ...
  void SetDateFieldFormat(DateFieldFormatT&& value) {
    ...
    m_dateFieldFormat = std::forward<DateFieldFormatT>(value);
  }
  template <typename DateFieldFormatT = Aws::String>
  ConfluenceAttachmentToIndexFieldMapping& WithDateFieldFormat(DateFieldFormatT&& value) {
    SetDateFieldFormat(std::forward<DateFieldFormatT>(value));
    return *this;
  }
  ///@}
