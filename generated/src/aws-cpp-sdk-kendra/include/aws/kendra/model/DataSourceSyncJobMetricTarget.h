...
class DataSourceSyncJobMetricTarget {
 public:
  ...
  template <typename DataSourceIdT = Aws::String>
  DataSourceSyncJobMetricTarget& WithDataSourceId(DataSourceIdT&& value) {
  ...
  void SetDataSourceSyncJobId(DataSourceSyncJobIdT&& value) {
    m_dataSourceSyncJobIdHasBeenSet = true;
    m_dataSourceSyncJobId = std::forward<DataSourceSyncJobIdT>(value);
  }
  template <typename DataSourceSyncJobIdT = Aws::String>
  DataSourceSyncJobMetricTarget& WithDataSourceSyncJobId(DataSourceSyncJobIdT&& value) {
    SetDataSourceSyncJobId(std::forward<DataSourceSyncJobIdT>(value));
    return *this;
  }
  ///@}
 private:
