...
class RetrieveResultItem {
 public:
  ...
  template <typename IdT = Aws::String>
  RetrieveResultItem& WithId(IdT&& value) {
  ...
  template <typename DocumentIdT = Aws::String>
  RetrieveResultItem& WithDocumentId(DocumentIdT&& value) {
  ...
  template <typename DocumentTitleT = Aws::String>
  RetrieveResultItem& WithDocumentTitle(DocumentTitleT&& value) {
  ...
  template <typename ContentT = Aws::String>
  RetrieveResultItem& WithContent(ContentT&& value) {
  ...
  template <typename DocumentURIT = Aws::String>
  RetrieveResultItem& WithDocumentURI(DocumentURIT&& value) {
  ...
  template <typename DocumentAttributesT = Aws::Vector<DocumentAttribute>>
  RetrieveResultItem& WithDocumentAttributes(DocumentAttributesT&& value) {
    SetDocumentAttributes(std::forward<DocumentAttributesT>(value));
    return *this;
  }
  template <typename DocumentAttributesT = DocumentAttribute>
  RetrieveResultItem& AddDocumentAttributes(DocumentAttributesT&& value) {
    m_documentAttributesHasBeenSet = true;
  ...
  template <typename ScoreAttributesT = ScoreAttributes>
  RetrieveResultItem& WithScoreAttributes(ScoreAttributesT&& value) {
