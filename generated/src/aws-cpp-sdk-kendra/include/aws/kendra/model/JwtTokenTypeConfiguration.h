...
class JwtTokenTypeConfiguration {
 public:
  ...
  inline void SetKeyLocation(KeyLocation value) {
    m_keyLocationHasBeenSet = true;
    m_keyLocation = value;
  }
  inline JwtTokenTypeConfiguration& WithKeyLocation(KeyLocation value) {
  ...
  template <typename URLT = Aws::String>
  JwtTokenTypeConfiguration& WithURL(URLT&& value) {
  ...
  template <typename SecretManagerArnT = Aws::String>
  JwtTokenTypeConfiguration& WithSecretManagerArn(SecretManagerArnT&& value) {
  ...
  template <typename UserNameAttributeFieldT = Aws::String>
  JwtTokenTypeConfiguration& WithUserNameAttributeField(UserNameAttributeFieldT&& value) {
  ...
  template <typename GroupAttributeFieldT = Aws::String>
  JwtTokenTypeConfiguration& WithGroupAttributeField(GroupAttributeFieldT&& value) {
  ...
  template <typename IssuerT = Aws::String>
  JwtTokenTypeConfiguration& WithIssuer(IssuerT&& value) {
  ...
  void SetClaimRegex(ClaimRegexT&& value) {
    m_claimRegexHasBeenSet = true;
    m_claimRegex = std::forward<ClaimRegexT>(value);
  }
  template <typename ClaimRegexT = Aws::String>
  JwtTokenTypeConfiguration& WithClaimRegex(ClaimRegexT&& value) {
    SetClaimRegex(std::forward<ClaimRegexT>(value));
    return *this;
  }
  ///@}
 private:
