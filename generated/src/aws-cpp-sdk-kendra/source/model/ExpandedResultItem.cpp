...
ExpandedResultItem::ExpandedResultItem(JsonView jsonValue) { *this = jsonValue; }
...
ExpandedResultItem& ExpandedResultItem::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DocumentAttributes")) {
    ...
    for (unsigned documentAttributesIndex = 0; documentAttributesIndex < documentAttributesJsonList.GetLength();
         ++documentAttributesIndex) {
