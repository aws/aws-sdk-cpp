...
ConfluenceSpaceConfiguration::ConfluenceSpaceConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ConfluenceSpaceConfiguration& ConfluenceSpaceConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SpaceFieldMappings")) {
    ...
    for (unsigned spaceFieldMappingsIndex = 0; spaceFieldMappingsIndex < spaceFieldMappingsJsonList.GetLength();
         ++spaceFieldMappingsIndex) {
