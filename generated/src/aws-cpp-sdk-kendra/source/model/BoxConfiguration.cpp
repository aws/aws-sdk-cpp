...
BoxConfiguration::BoxConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
BoxConfiguration& BoxConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("WebLinkFieldMappings")) {
    ...
    for (unsigned webLinkFieldMappingsIndex = 0; webLinkFieldMappingsIndex < webLinkFieldMappingsJsonList.GetLength();
         ++webLinkFieldMappingsIndex) {
