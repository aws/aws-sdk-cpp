...
ColumnConfiguration::ColumnConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ColumnConfiguration& ColumnConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ChangeDetectingColumns")) {
    ...
    for (unsigned changeDetectingColumnsIndex = 0; changeDetectingColumnsIndex < changeDetectingColumnsJsonList.GetLength();
         ++changeDetectingColumnsIndex) {
