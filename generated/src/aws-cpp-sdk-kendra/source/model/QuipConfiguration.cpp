...
QuipConfiguration::QuipConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
QuipConfiguration& QuipConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ThreadFieldMappings")) {
    ...
    for (unsigned threadFieldMappingsIndex = 0; threadFieldMappingsIndex < threadFieldMappingsJsonList.GetLength();
         ++threadFieldMappingsIndex) {
  ...
  if (jsonValue.ValueExists("MessageFieldMappings")) {
    ...
    for (unsigned messageFieldMappingsIndex = 0; messageFieldMappingsIndex < messageFieldMappingsJsonList.GetLength();
         ++messageFieldMappingsIndex) {
