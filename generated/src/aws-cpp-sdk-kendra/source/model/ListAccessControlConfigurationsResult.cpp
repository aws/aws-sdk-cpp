...
ListAccessControlConfigurationsResult& ListAccessControlConfigurationsResult::operator=(
  ...
  if (jsonValue.ValueExists("AccessControlConfigurations")) {
    ...
    for (unsigned accessControlConfigurationsIndex = 0; accessControlConfigurationsIndex < accessControlConfigurationsJsonList.GetLength();
         ++accessControlConfigurationsIndex) {
