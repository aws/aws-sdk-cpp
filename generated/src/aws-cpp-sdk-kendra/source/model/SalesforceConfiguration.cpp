...
SalesforceConfiguration::SalesforceConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
SalesforceConfiguration& SalesforceConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("StandardObjectConfigurations")) {
    ...
    for (unsigned standardObjectConfigurationsIndex = 0;
         standardObjectConfigurationsIndex < standardObjectConfigurationsJsonList.GetLength(); ++standardObjectConfigurationsIndex) {
  ...
  if (jsonValue.ValueExists("IncludeAttachmentFilePatterns")) {
    ...
    for (unsigned includeAttachmentFilePatternsIndex = 0;
         includeAttachmentFilePatternsIndex < includeAttachmentFilePatternsJsonList.GetLength(); ++includeAttachmentFilePatternsIndex) {
  ...
  if (jsonValue.ValueExists("ExcludeAttachmentFilePatterns")) {
    ...
    for (unsigned excludeAttachmentFilePatternsIndex = 0;
         excludeAttachmentFilePatternsIndex < excludeAttachmentFilePatternsJsonList.GetLength(); ++excludeAttachmentFilePatternsIndex) {
...
JsonValue SalesforceConfiguration::Jsonize() const {
  ...
  if (m_standardObjectConfigurationsHasBeenSet) {
    ...
    for (unsigned standardObjectConfigurationsIndex = 0;
         standardObjectConfigurationsIndex < standardObjectConfigurationsJsonList.GetLength(); ++standardObjectConfigurationsIndex) {
      standardObjectConfigurationsJsonList[standardObjectConfigurationsIndex].AsObject(
          m_standardObjectConfigurations[standardObjectConfigurationsIndex].Jsonize());
    }
  ...
  if (m_includeAttachmentFilePatternsHasBeenSet) {
    ...
    for (unsigned includeAttachmentFilePatternsIndex = 0;
         includeAttachmentFilePatternsIndex < includeAttachmentFilePatternsJsonList.GetLength(); ++includeAttachmentFilePatternsIndex) {
      includeAttachmentFilePatternsJsonList[includeAttachmentFilePatternsIndex].AsString(
          m_includeAttachmentFilePatterns[includeAttachmentFilePatternsIndex]);
    }
  ...
  if (m_excludeAttachmentFilePatternsHasBeenSet) {
    ...
    for (unsigned excludeAttachmentFilePatternsIndex = 0;
         excludeAttachmentFilePatternsIndex < excludeAttachmentFilePatternsJsonList.GetLength(); ++excludeAttachmentFilePatternsIndex) {
      excludeAttachmentFilePatternsJsonList[excludeAttachmentFilePatternsIndex].AsString(
          m_excludeAttachmentFilePatterns[excludeAttachmentFilePatternsIndex]);
    }
