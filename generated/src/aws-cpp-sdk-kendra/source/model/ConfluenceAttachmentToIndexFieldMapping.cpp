...
ConfluenceAttachmentToIndexFieldMapping::ConfluenceAttachmentToIndexFieldMapping(JsonView jsonValue) { *this = jsonValue; }
...
ConfluenceAttachmentToIndexFieldMapping& ConfluenceAttachmentToIndexFieldMapping::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("DataSourceFieldName")) {
    m_dataSourceFieldName =
        ConfluenceAttachmentFieldNameMapper::GetConfluenceAttachmentFieldNameForName(jsonValue.GetString("DataSourceFieldName"));
...
JsonValue ConfluenceAttachmentToIndexFieldMapping::Jsonize() const {
  ...
  if (m_dataSourceFieldNameHasBeenSet) {
    payload.WithString("DataSourceFieldName",
                       ConfluenceAttachmentFieldNameMapper::GetNameForConfluenceAttachmentFieldName(m_dataSourceFieldName));
  }
