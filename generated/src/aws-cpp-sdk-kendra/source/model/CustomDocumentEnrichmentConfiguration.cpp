...
CustomDocumentEnrichmentConfiguration::CustomDocumentEnrichmentConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
CustomDocumentEnrichmentConfiguration& CustomDocumentEnrichmentConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("InlineConfigurations")) {
    ...
    for (unsigned inlineConfigurationsIndex = 0; inlineConfigurationsIndex < inlineConfigurationsJsonList.GetLength();
         ++inlineConfigurationsIndex) {
