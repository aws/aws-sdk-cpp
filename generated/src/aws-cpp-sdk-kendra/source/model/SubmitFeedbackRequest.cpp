...
Aws::String SubmitFeedbackRequest::SerializePayload() const {
  ...
  if (m_clickFeedbackItemsHasBeenSet) {
    ...
    for (unsigned clickFeedbackItemsIndex = 0; clickFeedbackItemsIndex < clickFeedbackItemsJsonList.GetLength();
         ++clickFeedbackItemsIndex) {
  ...
  if (m_relevanceFeedbackItemsHasBeenSet) {
    ...
    for (unsigned relevanceFeedbackItemsIndex = 0; relevanceFeedbackItemsIndex < relevanceFeedbackItemsJsonList.GetLength();
         ++relevanceFeedbackItemsIndex) {
