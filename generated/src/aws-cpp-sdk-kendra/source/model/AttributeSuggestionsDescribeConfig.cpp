...
AttributeSuggestionsDescribeConfig::AttributeSuggestionsDescribeConfig(JsonView jsonValue) { *this = jsonValue; }
...
AttributeSuggestionsDescribeConfig& AttributeSuggestionsDescribeConfig::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("SuggestableConfigList")) {
    ...
    for (unsigned suggestableConfigListIndex = 0; suggestableConfigListIndex < suggestableConfigListJsonList.GetLength();
         ++suggestableConfigListIndex) {
  ...
  if (jsonValue.ValueExists("AttributeSuggestionsMode")) {
    m_attributeSuggestionsMode =
        AttributeSuggestionsModeMapper::GetAttributeSuggestionsModeForName(jsonValue.GetString("AttributeSuggestionsMode"));
...
JsonValue AttributeSuggestionsDescribeConfig::Jsonize() const {
  ...
  if (m_attributeSuggestionsModeHasBeenSet) {
    payload.WithString("AttributeSuggestionsMode",
                       AttributeSuggestionsModeMapper::GetNameForAttributeSuggestionsMode(m_attributeSuggestionsMode));
  }
