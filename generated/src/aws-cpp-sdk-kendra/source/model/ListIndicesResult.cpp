...
ListIndicesResult& ListIndicesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("IndexConfigurationSummaryItems")) {
    ...
    for (unsigned indexConfigurationSummaryItemsIndex = 0;
         indexConfigurationSummaryItemsIndex < indexConfigurationSummaryItemsJsonList.GetLength(); ++indexConfigurationSummaryItemsIndex) {
