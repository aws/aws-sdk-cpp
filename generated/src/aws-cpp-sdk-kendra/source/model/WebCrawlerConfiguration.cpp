...
WebCrawlerConfiguration::WebCrawlerConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
WebCrawlerConfiguration& WebCrawlerConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("UrlInclusionPatterns")) {
    ...
    for (unsigned urlInclusionPatternsIndex = 0; urlInclusionPatternsIndex < urlInclusionPatternsJsonList.GetLength();
         ++urlInclusionPatternsIndex) {
  ...
  if (jsonValue.ValueExists("UrlExclusionPatterns")) {
    ...
    for (unsigned urlExclusionPatternsIndex = 0; urlExclusionPatternsIndex < urlExclusionPatternsJsonList.GetLength();
         ++urlExclusionPatternsIndex) {
