...
ConfluenceConfiguration::ConfluenceConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ConfluenceConfiguration& ConfluenceConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AuthenticationType")) {
    m_authenticationType =
        ConfluenceAuthenticationTypeMapper::GetConfluenceAuthenticationTypeForName(jsonValue.GetString("AuthenticationType"));
...
JsonValue ConfluenceConfiguration::Jsonize() const {
  ...
  if (m_authenticationTypeHasBeenSet) {
    payload.WithString("AuthenticationType",
                       ConfluenceAuthenticationTypeMapper::GetNameForConfluenceAuthenticationType(m_authenticationType));
  }
