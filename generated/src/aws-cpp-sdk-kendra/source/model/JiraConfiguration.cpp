...
JiraConfiguration::JiraConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
JiraConfiguration& JiraConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("IssueSubEntityFilter")) {
    ...
    for (unsigned issueSubEntityFilterIndex = 0; issueSubEntityFilterIndex < issueSubEntityFilterJsonList.GetLength();
         ++issueSubEntityFilterIndex) {
      m_issueSubEntityFilter.push_back(
          IssueSubEntityMapper::GetIssueSubEntityForName(issueSubEntityFilterJsonList[issueSubEntityFilterIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("AttachmentFieldMappings")) {
    ...
    for (unsigned attachmentFieldMappingsIndex = 0; attachmentFieldMappingsIndex < attachmentFieldMappingsJsonList.GetLength();
         ++attachmentFieldMappingsIndex) {
  ...
  if (jsonValue.ValueExists("CommentFieldMappings")) {
    ...
    for (unsigned commentFieldMappingsIndex = 0; commentFieldMappingsIndex < commentFieldMappingsJsonList.GetLength();
         ++commentFieldMappingsIndex) {
  ...
  if (jsonValue.ValueExists("IssueFieldMappings")) {
    ...
    for (unsigned issueFieldMappingsIndex = 0; issueFieldMappingsIndex < issueFieldMappingsJsonList.GetLength();
         ++issueFieldMappingsIndex) {
  ...
  if (jsonValue.ValueExists("ProjectFieldMappings")) {
    ...
    for (unsigned projectFieldMappingsIndex = 0; projectFieldMappingsIndex < projectFieldMappingsJsonList.GetLength();
         ++projectFieldMappingsIndex) {
  ...
  if (jsonValue.ValueExists("WorkLogFieldMappings")) {
    ...
    for (unsigned workLogFieldMappingsIndex = 0; workLogFieldMappingsIndex < workLogFieldMappingsJsonList.GetLength();
         ++workLogFieldMappingsIndex) {
...
JsonValue JiraConfiguration::Jsonize() const {
  ...
  if (m_issueSubEntityFilterHasBeenSet) {
    ...
    for (unsigned issueSubEntityFilterIndex = 0; issueSubEntityFilterIndex < issueSubEntityFilterJsonList.GetLength();
         ++issueSubEntityFilterIndex) {
      issueSubEntityFilterJsonList[issueSubEntityFilterIndex].AsString(
          IssueSubEntityMapper::GetNameForIssueSubEntity(m_issueSubEntityFilter[issueSubEntityFilterIndex]));
    }
  ...
  if (m_attachmentFieldMappingsHasBeenSet) {
    ...
    for (unsigned attachmentFieldMappingsIndex = 0; attachmentFieldMappingsIndex < attachmentFieldMappingsJsonList.GetLength();
         ++attachmentFieldMappingsIndex) {
      attachmentFieldMappingsJsonList[attachmentFieldMappingsIndex].AsObject(
          m_attachmentFieldMappings[attachmentFieldMappingsIndex].Jsonize());
    }
