...
DescribeFeaturedResultsSetResult::DescribeFeaturedResultsSetResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeFeaturedResultsSetResult& DescribeFeaturedResultsSetResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("FeaturedDocumentsWithMetadata")) {
    ...
    for (unsigned featuredDocumentsWithMetadataIndex = 0;
         featuredDocumentsWithMetadataIndex < featuredDocumentsWithMetadataJsonList.GetLength(); ++featuredDocumentsWithMetadataIndex) {
  ...
  if (jsonValue.ValueExists("FeaturedDocumentsMissing")) {
    ...
    for (unsigned featuredDocumentsMissingIndex = 0; featuredDocumentsMissingIndex < featuredDocumentsMissingJsonList.GetLength();
         ++featuredDocumentsMissingIndex) {
