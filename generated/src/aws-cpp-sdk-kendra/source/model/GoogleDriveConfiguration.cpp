...
GoogleDriveConfiguration::GoogleDriveConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
GoogleDriveConfiguration& GoogleDriveConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ExcludeUserAccounts")) {
    ...
    for (unsigned excludeUserAccountsIndex = 0; excludeUserAccountsIndex < excludeUserAccountsJsonList.GetLength();
         ++excludeUserAccountsIndex) {
  ...
  if (jsonValue.ValueExists("ExcludeSharedDrives")) {
    ...
    for (unsigned excludeSharedDrivesIndex = 0; excludeSharedDrivesIndex < excludeSharedDrivesJsonList.GetLength();
         ++excludeSharedDrivesIndex) {
