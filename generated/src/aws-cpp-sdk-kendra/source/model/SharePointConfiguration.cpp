...
SharePointConfiguration::SharePointConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
SharePointConfiguration& SharePointConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AuthenticationType")) {
    m_authenticationType =
        SharePointOnlineAuthenticationTypeMapper::GetSharePointOnlineAuthenticationTypeForName(jsonValue.GetString("AuthenticationType"));
...
JsonValue SharePointConfiguration::Jsonize() const {
  ...
  if (m_authenticationTypeHasBeenSet) {
    payload.WithString("AuthenticationType",
                       SharePointOnlineAuthenticationTypeMapper::GetNameForSharePointOnlineAuthenticationType(m_authenticationType));
  }
