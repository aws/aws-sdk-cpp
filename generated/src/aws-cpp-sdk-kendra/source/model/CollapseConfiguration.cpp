...
CollapseConfiguration::CollapseConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
CollapseConfiguration& CollapseConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("MissingAttributeKeyStrategy")) {
    m_missingAttributeKeyStrategy =
        MissingAttributeKeyStrategyMapper::GetMissingAttributeKeyStrategyForName(jsonValue.GetString("MissingAttributeKeyStrategy"));
...
JsonValue CollapseConfiguration::Jsonize() const {
  ...
  if (m_missingAttributeKeyStrategyHasBeenSet) {
    payload.WithString("MissingAttributeKeyStrategy",
                       MissingAttributeKeyStrategyMapper::GetNameForMissingAttributeKeyStrategy(m_missingAttributeKeyStrategy));
  }
