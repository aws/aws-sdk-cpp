...
namespace kendra
{
const size_t KendraEndpointRules::RulesBlobStrLen = 3392;
const size_t KendraEndpointRules::RulesBlobSize = 3393;
...
't','t','p','s',':','/','/','k','e','n','d','r','a','-','f','i','p','s','.','{','R','e','g','i','o',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','k','e','n','d','r','a','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','k','e','n','d','r','a','.','{','R','e','g','i','o','n','}','.',
