...
{
const size_t MigrationHubRefactorSpacesEndpointRules::RulesBlobStrLen = 3386;
const size_t MigrationHubRefactorSpacesEndpointRules::RulesBlobSize = 3387;
...
't','t','p','s',':','/','/','r','e','f','a','c','t','o','r','-','s','p','a','c','e','s','-','f','i',
...
':','"','h','t','t','p','s',':','/','/','r','e','f','a','c','t','o','r','-','s','p','a','c','e','s',
...
'p','s',':','/','/','r','e','f','a','c','t','o','r','-','s','p','a','c','e','s','.','{','R','e','g',
