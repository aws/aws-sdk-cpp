...
namespace MigrationHubRefactorSpaces
{
   ...
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API MigrationHubRefactorSpacesClient : Aws::Client::ClientWithAsyncTemplateMethods<MigrationHubRefactorSpacesClient>,
    smithy::client::AwsSmithyClientT<Aws::MigrationHubRefactorSpaces::SERVICE_NAME,
