...
class ListEnvironmentVpcsRequest : public MigrationHubRefactorSpacesRequest {
 public:
  ...
  template <typename EnvironmentIdentifierT = Aws::String>
  ListEnvironmentVpcsRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) {
  ...
  inline ListEnvironmentVpcsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentVpcsRequest& WithNextToken(NextTokenT&& value) {
