...
class UpdateRouteResult {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  UpdateRouteResult& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateRouteResult& WithArn(ArnT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  UpdateRouteResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename RouteIdT = Aws::String>
  UpdateRouteResult& WithRouteId(RouteIdT&& value) {
  ...
  template <typename ServiceIdT = Aws::String>
  UpdateRouteResult& WithServiceId(ServiceIdT&& value) {
  ...
  inline UpdateRouteResult& WithState(RouteState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRouteResult& WithRequestId(RequestIdT&& value) {
