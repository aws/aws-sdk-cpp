...
class CreateEnvironmentResult {
 public:
  ...
  AWS_MIGRATIONHUBREFACTORSPACES_API CreateEnvironmentResult& operator=(
  ...
  template <typename ArnT = Aws::String>
  CreateEnvironmentResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  CreateEnvironmentResult& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  CreateEnvironmentResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  inline void SetNetworkFabricType(NetworkFabricType value) {
    m_networkFabricTypeHasBeenSet = true;
    m_networkFabricType = value;
  }
  inline CreateEnvironmentResult& WithNetworkFabricType(NetworkFabricType value) {
    SetNetworkFabricType(value);
    return *this;
  }
  ///@}
  ...
  template <typename OwnerAccountIdT = Aws::String>
  CreateEnvironmentResult& WithOwnerAccountId(OwnerAccountIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateEnvironmentResult& WithTags(TagsT&& value) {
