...
namespace Model
{
  ...
  /**
   */
  class ListApplicationsRequest : public MigrationHubRefactorSpacesRequest
  {
  public:
    AWS_MIGRATIONHUBREFACTORSPACES_API ListApplicationsRequest() = default;
    ...
    template<typename EnvironmentIdentifierT = Aws::String>
    ListApplicationsRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) { SetEnvironmentIdentifier(std::forward<EnvironmentIdentifierT>(value)); return *this;}
    ///@}
