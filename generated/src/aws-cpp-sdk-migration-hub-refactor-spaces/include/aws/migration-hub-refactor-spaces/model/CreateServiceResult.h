...
class CreateServiceResult {
 public:
  AWS_MIGRATIONHUBREFACTORSPACES_API CreateServiceResult() = default;
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateServiceResult& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename CreatedByAccountIdT = Aws::String>
  CreateServiceResult& WithCreatedByAccountId(CreatedByAccountIdT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  CreateServiceResult& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateServiceResult& WithDescription(DescriptionT&& value) {
  ...
  inline CreateServiceResult& WithEndpointType(ServiceEndpointType value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  CreateServiceResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename LambdaEndpointT = LambdaEndpointInput>
  CreateServiceResult& WithLambdaEndpoint(LambdaEndpointT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  CreateServiceResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename OwnerAccountIdT = Aws::String>
  CreateServiceResult& WithOwnerAccountId(OwnerAccountIdT&& value) {
  ...
  template <typename ServiceIdT = Aws::String>
  CreateServiceResult& WithServiceId(ServiceIdT&& value) {
  ...
  inline CreateServiceResult& WithState(ServiceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateServiceResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateServiceResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename UrlEndpointT = UrlEndpointInput>
  CreateServiceResult& WithUrlEndpoint(UrlEndpointT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  CreateServiceResult& WithVpcId(VpcIdT&& value) {
