...
class CreateApplicationResult {
 public:
  ...
  AWS_MIGRATIONHUBREFACTORSPACES_API CreateApplicationResult& operator=(
  ...
  template <typename ApiGatewayProxyT = ApiGatewayProxyInput>
  CreateApplicationResult& WithApiGatewayProxy(ApiGatewayProxyT&& value) {
  ...
  template <typename CreatedByAccountIdT = Aws::String>
  CreateApplicationResult& WithCreatedByAccountId(CreatedByAccountIdT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  CreateApplicationResult& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  CreateApplicationResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  CreateApplicationResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename OwnerAccountIdT = Aws::String>
  CreateApplicationResult& WithOwnerAccountId(OwnerAccountIdT&& value) {
  ...
  inline CreateApplicationResult& WithProxyType(ProxyType value) {
    SetProxyType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateApplicationResult& WithState(ApplicationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename VpcIdT = Aws::String>
  CreateApplicationResult& WithVpcId(VpcIdT&& value) {
