...
class ServiceSummary {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  ServiceSummary& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename CreatedByAccountIdT = Aws::String>
  ServiceSummary& WithCreatedByAccountId(CreatedByAccountIdT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  ServiceSummary& WithCreatedTime(CreatedTimeT&& value) {
  ...
  inline ServiceSummary& WithEndpointType(ServiceEndpointType value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  ServiceSummary& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename ErrorT = ErrorResponse>
  ServiceSummary& WithError(ErrorT&& value) {
  ...
  template <typename LambdaEndpointT = LambdaEndpointSummary>
  ServiceSummary& WithLambdaEndpoint(LambdaEndpointT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  ServiceSummary& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename OwnerAccountIdT = Aws::String>
  ServiceSummary& WithOwnerAccountId(OwnerAccountIdT&& value) {
  ...
  inline ServiceSummary& WithState(ServiceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ServiceSummary& WithTags(TagsT&& value) {
  ...
  template <typename UrlEndpointT = UrlEndpointSummary>
  ServiceSummary& WithUrlEndpoint(UrlEndpointT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  ServiceSummary& WithVpcId(VpcIdT&& value) {
