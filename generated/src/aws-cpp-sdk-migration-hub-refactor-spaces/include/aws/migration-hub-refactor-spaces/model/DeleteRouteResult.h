...
class DeleteRouteResult {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  DeleteRouteResult& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteRouteResult& WithArn(ArnT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  DeleteRouteResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename RouteIdT = Aws::String>
  DeleteRouteResult& WithRouteId(RouteIdT&& value) {
  ...
  template <typename ServiceIdT = Aws::String>
  DeleteRouteResult& WithServiceId(ServiceIdT&& value) {
  ...
  inline DeleteRouteResult& WithState(RouteState value) {
    SetState(value);
    return *this;
  }
  ///@}
