...
class ListEnvironmentVpcsResult {
 public:
  ...
  AWS_MIGRATIONHUBREFACTORSPACES_API ListEnvironmentVpcsResult& operator=(
  ...
  void SetEnvironmentVpcList(EnvironmentVpcListT&& value) {
    m_environmentVpcListHasBeenSet = true;
    m_environmentVpcList = std::forward<EnvironmentVpcListT>(value);
  }
  template <typename EnvironmentVpcListT = Aws::Vector<EnvironmentVpc>>
  ListEnvironmentVpcsResult& WithEnvironmentVpcList(EnvironmentVpcListT&& value) {
    SetEnvironmentVpcList(std::forward<EnvironmentVpcListT>(value));
    return *this;
  }
  template <typename EnvironmentVpcListT = EnvironmentVpc>
  ListEnvironmentVpcsResult& AddEnvironmentVpcList(EnvironmentVpcListT&& value) {
    m_environmentVpcListHasBeenSet = true;
    m_environmentVpcList.emplace_back(std::forward<EnvironmentVpcListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentVpcsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEnvironmentVpcsResult& WithRequestId(RequestIdT&& value) {
