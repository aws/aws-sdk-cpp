...
class RouteSummary {
 public:
  ...
  inline RouteSummary& WithAppendSourcePath(bool value) {
  ...
  template <typename ApplicationIdT = Aws::String>
  RouteSummary& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  RouteSummary& WithArn(ArnT&& value) {
  ...
  template <typename CreatedByAccountIdT = Aws::String>
  RouteSummary& WithCreatedByAccountId(CreatedByAccountIdT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  RouteSummary& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  RouteSummary& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename ErrorT = ErrorResponse>
  RouteSummary& WithError(ErrorT&& value) {
  ...
  inline RouteSummary& WithIncludeChildPaths(bool value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  RouteSummary& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename MethodsT = Aws::Vector<HttpMethod>>
  RouteSummary& WithMethods(MethodsT&& value) {
    SetMethods(std::forward<MethodsT>(value));
    return *this;
  }
  inline RouteSummary& AddMethods(HttpMethod value) {
    m_methodsHasBeenSet = true;
  ...
  template <typename OwnerAccountIdT = Aws::String>
  RouteSummary& WithOwnerAccountId(OwnerAccountIdT&& value) {
  ...
  template <typename PathResourceToIdT = Aws::Map<Aws::String, Aws::String>>
  RouteSummary& WithPathResourceToId(PathResourceToIdT&& value) {
  ...
  template <typename RouteIdT = Aws::String>
  RouteSummary& WithRouteId(RouteIdT&& value) {
  ...
  inline RouteSummary& WithRouteType(RouteType value) {
    SetRouteType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceIdT = Aws::String>
  RouteSummary& WithServiceId(ServiceIdT&& value) {
  ...
  template <typename SourcePathT = Aws::String>
  RouteSummary& WithSourcePath(SourcePathT&& value) {
  ...
  inline RouteSummary& WithState(RouteState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  RouteSummary& WithTags(TagsT&& value) {
