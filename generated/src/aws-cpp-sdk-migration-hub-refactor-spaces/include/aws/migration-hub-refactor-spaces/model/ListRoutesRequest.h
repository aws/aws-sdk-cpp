...
class ListRoutesRequest : public MigrationHubRefactorSpacesRequest {
 public:
  ...
  template <typename ApplicationIdentifierT = Aws::String>
  ListRoutesRequest& WithApplicationIdentifier(ApplicationIdentifierT&& value) {
  ...
  template <typename EnvironmentIdentifierT = Aws::String>
  ListRoutesRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) {
  ...
  inline ListRoutesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
