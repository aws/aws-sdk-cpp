...
class ApplicationSummary {
 public:
  ...
  template <typename ApiGatewayProxyT = ApiGatewayProxySummary>
  ApplicationSummary& WithApiGatewayProxy(ApiGatewayProxyT&& value) {
  ...
  template <typename CreatedByAccountIdT = Aws::String>
  ApplicationSummary& WithCreatedByAccountId(CreatedByAccountIdT&& value) {
  ...
  template <typename ErrorT = ErrorResponse>
  ApplicationSummary& WithError(ErrorT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  ApplicationSummary& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename OwnerAccountIdT = Aws::String>
  ApplicationSummary& WithOwnerAccountId(OwnerAccountIdT&& value) {
  ...
  inline ApplicationSummary& WithProxyType(ProxyType value) {
    SetProxyType(value);
    return *this;
  }
  ///@}
  ...
  template <typename VpcIdT = Aws::String>
  ApplicationSummary& WithVpcId(VpcIdT&& value) {
