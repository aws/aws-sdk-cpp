...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUBREFACTORSPACES_API DeleteApplicationRequest();
     ...
     * <p>The ID of the application.</p>
     */
    inline DeleteApplicationRequest& WithApplicationIdentifier(const Aws::String& value) { SetApplicationIdentifier(value); return *this;}

    /**
     * <p>The ID of the application.</p>
     */
    inline DeleteApplicationRequest& WithApplicationIdentifier(Aws::String&& value) { SetApplicationIdentifier(std::move(value)); return *this;}

    /**
     * <p>The ID of the application.</p>
     */
    inline DeleteApplicationRequest& WithApplicationIdentifier(const char* value) { SetApplicationIdentifier(value); return *this;}
     ...
     * <p>The ID of the environment. </p>
     */
    inline DeleteApplicationRequest& WithEnvironmentIdentifier(const Aws::String& value) { SetEnvironmentIdentifier(value); return *this;}

    /**
     * <p>The ID of the environment. </p>
     */
    inline DeleteApplicationRequest& WithEnvironmentIdentifier(Aws::String&& value) { SetEnvironmentIdentifier(std::move(value)); return *this;}

    /**
     * <p>The ID of the environment. </p>
     */
    inline DeleteApplicationRequest& WithEnvironmentIdentifier(const char* value) { SetEnvironmentIdentifier(value); return *this;}
