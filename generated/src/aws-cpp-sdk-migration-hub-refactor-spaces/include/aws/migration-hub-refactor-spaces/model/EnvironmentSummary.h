...
class EnvironmentSummary {
 public:
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  EnvironmentSummary& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename ErrorT = ErrorResponse>
  EnvironmentSummary& WithError(ErrorT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  EnvironmentSummary& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  inline EnvironmentSummary& WithNetworkFabricType(NetworkFabricType value) {
  ...
  template <typename OwnerAccountIdT = Aws::String>
  EnvironmentSummary& WithOwnerAccountId(OwnerAccountIdT&& value) {
  ...
  inline EnvironmentSummary& WithState(EnvironmentState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  EnvironmentSummary& WithTags(TagsT&& value) {
  ...
  template <typename TransitGatewayIdT = Aws::String>
  EnvironmentSummary& WithTransitGatewayId(TransitGatewayIdT&& value) {
