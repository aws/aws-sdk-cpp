...
class DeleteEnvironmentResult {
 public:
  ...
  AWS_MIGRATIONHUBREFACTORSPACES_API DeleteEnvironmentResult& operator=(
  ...
  template <typename ArnT = Aws::String>
  DeleteEnvironmentResult& WithArn(ArnT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  DeleteEnvironmentResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  DeleteEnvironmentResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteEnvironmentResult& WithName(NameT&& value) {
  ...
  inline DeleteEnvironmentResult& WithState(EnvironmentState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteEnvironmentResult& WithRequestId(RequestIdT&& value) {
