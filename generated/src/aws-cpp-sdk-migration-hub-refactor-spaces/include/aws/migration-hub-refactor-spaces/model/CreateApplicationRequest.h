...
class CreateApplicationRequest : public MigrationHubRefactorSpacesRequest {
 public:
  ...
  template <typename ApiGatewayProxyT = ApiGatewayProxyInput>
  CreateApplicationRequest& WithApiGatewayProxy(ApiGatewayProxyT&& value) {
  ...
  template <typename EnvironmentIdentifierT = Aws::String>
  CreateApplicationRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) {
  ...
  inline CreateApplicationRequest& WithProxyType(ProxyType value) {
    SetProxyType(value);
    return *this;
  }
  ///@}
  ...
  template <typename VpcIdT = Aws::String>
  CreateApplicationRequest& WithVpcId(VpcIdT&& value) {
