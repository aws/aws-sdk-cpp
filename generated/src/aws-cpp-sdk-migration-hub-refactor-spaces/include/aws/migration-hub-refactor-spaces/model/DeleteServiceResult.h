...
class DeleteServiceResult {
 public:
  AWS_MIGRATIONHUBREFACTORSPACES_API DeleteServiceResult() = default;
  ...
  template <typename ApplicationIdT = Aws::String>
  DeleteServiceResult& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  DeleteServiceResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  DeleteServiceResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename ServiceIdT = Aws::String>
  DeleteServiceResult& WithServiceId(ServiceIdT&& value) {
  ...
  inline DeleteServiceResult& WithState(ServiceState value) {
    SetState(value);
    return *this;
  }
  ///@}
