...
namespace Model
{
  ...
  public:
    ...
    template<typename ApplicationIdT = Aws::String>
    DeleteServiceResult& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentIdT = Aws::String>
    DeleteServiceResult& WithEnvironmentId(EnvironmentIdT&& value) { SetEnvironmentId(std::forward<EnvironmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedTimeT = Aws::Utils::DateTime>
    DeleteServiceResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) { SetLastUpdatedTime(std::forward<LastUpdatedTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename ServiceIdT = Aws::String>
    DeleteServiceResult& WithServiceId(ServiceIdT&& value) { SetServiceId(std::forward<ServiceIdT>(value)); return *this;}
    ///@}
    ...
    inline DeleteServiceResult& WithState(ServiceState value) { SetState(value); return *this;}
    ///@}
