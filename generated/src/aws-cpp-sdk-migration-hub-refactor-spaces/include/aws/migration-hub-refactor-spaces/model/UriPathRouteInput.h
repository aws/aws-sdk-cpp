...
class UriPathRouteInput {
 public:
  ...
  inline UriPathRouteInput& WithActivationState(RouteActivationState value) {
  ...
  inline UriPathRouteInput& WithAppendSourcePath(bool value) {
  ...
  inline UriPathRouteInput& WithIncludeChildPaths(bool value) {
  ...
  template <typename MethodsT = Aws::Vector<HttpMethod>>
  UriPathRouteInput& WithMethods(MethodsT&& value) {
    SetMethods(std::forward<MethodsT>(value));
    return *this;
  }
  inline UriPathRouteInput& AddMethods(HttpMethod value) {
    m_methodsHasBeenSet = true;
  ...
  template <typename SourcePathT = Aws::String>
  UriPathRouteInput& WithSourcePath(SourcePathT&& value) {
