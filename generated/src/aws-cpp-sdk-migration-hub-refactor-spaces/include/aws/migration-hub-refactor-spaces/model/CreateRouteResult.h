...
class CreateRouteResult {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateRouteResult& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateRouteResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedByAccountIdT = Aws::String>
  CreateRouteResult& WithCreatedByAccountId(CreatedByAccountIdT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  CreateRouteResult& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  CreateRouteResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename OwnerAccountIdT = Aws::String>
  CreateRouteResult& WithOwnerAccountId(OwnerAccountIdT&& value) {
  ...
  inline CreateRouteResult& WithRouteType(RouteType value) {
    SetRouteType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceIdT = Aws::String>
  CreateRouteResult& WithServiceId(ServiceIdT&& value) {
  ...
  inline CreateRouteResult& WithState(RouteState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRouteResult& WithTags(TagsT&& value) {
  ...
  template <typename UriPathRouteT = UriPathRouteInput>
  CreateRouteResult& WithUriPathRoute(UriPathRouteT&& value) {
