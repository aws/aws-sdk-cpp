...
class EnvironmentVpc {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  EnvironmentVpc& WithAccountId(AccountIdT&& value) {
  ...
  void SetCidrBlocks(CidrBlocksT&& value) {
    m_cidrBlocksHasBeenSet = true;
    m_cidrBlocks = std::forward<CidrBlocksT>(value);
  }
  template <typename CidrBlocksT = Aws::Vector<Aws::String>>
  EnvironmentVpc& WithCidrBlocks(CidrBlocksT&& value) {
    SetCidrBlocks(std::forward<CidrBlocksT>(value));
    return *this;
  }
  template <typename CidrBlocksT = Aws::String>
  EnvironmentVpc& AddCidrBlocks(CidrBlocksT&& value) {
    m_cidrBlocksHasBeenSet = true;
    m_cidrBlocks.emplace_back(std::forward<CidrBlocksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  EnvironmentVpc& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  EnvironmentVpc& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  EnvironmentVpc& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  EnvironmentVpc& WithVpcId(VpcIdT&& value) {
  ...
  void SetVpcName(VpcNameT&& value) {
    m_vpcNameHasBeenSet = true;
    m_vpcName = std::forward<VpcNameT>(value);
  }
  template <typename VpcNameT = Aws::String>
  EnvironmentVpc& WithVpcName(VpcNameT&& value) {
    SetVpcName(std::forward<VpcNameT>(value));
    return *this;
  }
  ///@}
 private:
