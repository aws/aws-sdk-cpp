...
class DeleteRouteRequest : public MigrationHubRefactorSpacesRequest {
 public:
  ...
  template <typename ApplicationIdentifierT = Aws::String>
  DeleteRouteRequest& WithApplicationIdentifier(ApplicationIdentifierT&& value) {
  ...
  template <typename EnvironmentIdentifierT = Aws::String>
  DeleteRouteRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) {
  ...
  template <typename RouteIdentifierT = Aws::String>
  DeleteRouteRequest& WithRouteIdentifier(RouteIdentifierT&& value) {
