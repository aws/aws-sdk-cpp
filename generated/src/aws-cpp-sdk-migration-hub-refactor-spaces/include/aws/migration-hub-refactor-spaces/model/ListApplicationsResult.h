...
class ListApplicationsResult {
 public:
  ...
  AWS_MIGRATIONHUBREFACTORSPACES_API ListApplicationsResult& operator=(
  ...
  void SetApplicationSummaryList(ApplicationSummaryListT&& value) {
    m_applicationSummaryListHasBeenSet = true;
    m_applicationSummaryList = std::forward<ApplicationSummaryListT>(value);
  }
  template <typename ApplicationSummaryListT = Aws::Vector<ApplicationSummary>>
  ListApplicationsResult& WithApplicationSummaryList(ApplicationSummaryListT&& value) {
    SetApplicationSummaryList(std::forward<ApplicationSummaryListT>(value));
    return *this;
  }
  template <typename ApplicationSummaryListT = ApplicationSummary>
  ListApplicationsResult& AddApplicationSummaryList(ApplicationSummaryListT&& value) {
    m_applicationSummaryListHasBeenSet = true;
    m_applicationSummaryList.emplace_back(std::forward<ApplicationSummaryListT>(value));
    return *this;
  }
  ///@}
