...
class ListEnvironmentsResult {
 public:
  ...
  AWS_MIGRATIONHUBREFACTORSPACES_API ListEnvironmentsResult& operator=(
  ...
  void SetEnvironmentSummaryList(EnvironmentSummaryListT&& value) {
    m_environmentSummaryListHasBeenSet = true;
    m_environmentSummaryList = std::forward<EnvironmentSummaryListT>(value);
  }
  template <typename EnvironmentSummaryListT = Aws::Vector<EnvironmentSummary>>
  ListEnvironmentsResult& WithEnvironmentSummaryList(EnvironmentSummaryListT&& value) {
    SetEnvironmentSummaryList(std::forward<EnvironmentSummaryListT>(value));
    return *this;
  }
  template <typename EnvironmentSummaryListT = EnvironmentSummary>
  ListEnvironmentsResult& AddEnvironmentSummaryList(EnvironmentSummaryListT&& value) {
    m_environmentSummaryListHasBeenSet = true;
    m_environmentSummaryList.emplace_back(std::forward<EnvironmentSummaryListT>(value));
    return *this;
  }
  ///@}
