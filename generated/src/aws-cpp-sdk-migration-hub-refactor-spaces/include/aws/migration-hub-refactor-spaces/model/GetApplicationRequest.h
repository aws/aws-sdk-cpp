...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUBREFACTORSPACES_API GetApplicationRequest() = default;
    ...
    template<typename ApplicationIdentifierT = Aws::String>
    GetApplicationRequest& WithApplicationIdentifier(ApplicationIdentifierT&& value) { SetApplicationIdentifier(std::forward<ApplicationIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentIdentifierT = Aws::String>
    GetApplicationRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) { SetEnvironmentIdentifier(std::forward<EnvironmentIdentifierT>(value)); return *this;}
    ///@}
  private:
