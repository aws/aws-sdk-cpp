...
class ApiGatewayProxyInput {
 public:
  ...
  inline void SetEndpointType(ApiGatewayEndpointType value) {
    m_endpointTypeHasBeenSet = true;
    m_endpointType = value;
  }
  inline ApiGatewayProxyInput& WithEndpointType(ApiGatewayEndpointType value) {
  ...
  template <typename StageNameT = Aws::String>
  ApiGatewayProxyInput& WithStageName(StageNameT&& value) {
