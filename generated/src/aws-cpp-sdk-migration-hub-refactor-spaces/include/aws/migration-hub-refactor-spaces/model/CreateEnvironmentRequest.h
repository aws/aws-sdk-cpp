...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUBREFACTORSPACES_API CreateEnvironmentRequest() = default;
    ...
    inline CreateEnvironmentRequest& WithNetworkFabricType(NetworkFabricType value) { SetNetworkFabricType(value); return *this;}
    ///@}
