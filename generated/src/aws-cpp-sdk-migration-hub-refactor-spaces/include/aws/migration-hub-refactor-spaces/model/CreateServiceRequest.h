...
class CreateServiceRequest : public MigrationHubRefactorSpacesRequest {
 public:
  ...
  template <typename ApplicationIdentifierT = Aws::String>
  CreateServiceRequest& WithApplicationIdentifier(ApplicationIdentifierT&& value) {
  ...
  inline CreateServiceRequest& WithEndpointType(ServiceEndpointType value) {
  ...
  template <typename EnvironmentIdentifierT = Aws::String>
  CreateServiceRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) {
  ...
  template <typename LambdaEndpointT = LambdaEndpointInput>
  CreateServiceRequest& WithLambdaEndpoint(LambdaEndpointT&& value) {
  ...
  template <typename UrlEndpointT = UrlEndpointInput>
  CreateServiceRequest& WithUrlEndpoint(UrlEndpointT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  CreateServiceRequest& WithVpcId(VpcIdT&& value) {
