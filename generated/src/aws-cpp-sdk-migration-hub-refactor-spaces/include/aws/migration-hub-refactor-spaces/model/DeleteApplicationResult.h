...
namespace Model
{
  ...
  public:
    ...
    template<typename ApplicationIdT = Aws::String>
    DeleteApplicationResult& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    DeleteApplicationResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentIdT = Aws::String>
    DeleteApplicationResult& WithEnvironmentId(EnvironmentIdT&& value) { SetEnvironmentId(std::forward<EnvironmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedTimeT = Aws::Utils::DateTime>
    DeleteApplicationResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) { SetLastUpdatedTime(std::forward<LastUpdatedTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DeleteApplicationResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline DeleteApplicationResult& WithState(ApplicationState value) { SetState(value); return *this;}
    ///@}
