...
class DeleteApplicationResult {
 public:
  AWS_MIGRATIONHUBREFACTORSPACES_API DeleteApplicationResult() = default;
  ...
  AWS_MIGRATIONHUBREFACTORSPACES_API DeleteApplicationResult& operator=(
  ...
  template <typename ApplicationIdT = Aws::String>
  DeleteApplicationResult& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteApplicationResult& WithArn(ArnT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  DeleteApplicationResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  DeleteApplicationResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteApplicationResult& WithName(NameT&& value) {
  ...
  inline DeleteApplicationResult& WithState(ApplicationState value) {
    SetState(value);
    return *this;
  }
  ///@}
