...
class DescribeUploadBufferResult {
 public:
  ...
  inline void SetUploadBufferUsedInBytes(long long value) {
    m_uploadBufferUsedInBytesHasBeenSet = true;
    m_uploadBufferUsedInBytes = value;
  }
  inline DescribeUploadBufferResult& WithUploadBufferUsedInBytes(long long value) {
    SetUploadBufferUsedInBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUploadBufferAllocatedInBytes(long long value) {
    m_uploadBufferAllocatedInBytesHasBeenSet = true;
    m_uploadBufferAllocatedInBytes = value;
  }
  inline DescribeUploadBufferResult& WithUploadBufferAllocatedInBytes(long long value) {
    SetUploadBufferAllocatedInBytes(value);
    return *this;
  }
  ///@}
