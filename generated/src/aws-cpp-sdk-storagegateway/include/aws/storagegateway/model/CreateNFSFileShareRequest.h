...
class CreateNFSFileShareRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateNFSFileShareRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename NFSFileShareDefaultsT = NFSFileShareDefaults>
  CreateNFSFileShareRequest& WithNFSFileShareDefaults(NFSFileShareDefaultsT&& value) {
  ...
  template <typename GatewayARNT = Aws::String>
  CreateNFSFileShareRequest& WithGatewayARN(GatewayARNT&& value) {
  ...
  inline CreateNFSFileShareRequest& WithEncryptionType(EncryptionType value) {
  ...
  template <typename KMSKeyT = Aws::String>
  CreateNFSFileShareRequest& WithKMSKey(KMSKeyT&& value) {
  ...
  template <typename RoleT = Aws::String>
  CreateNFSFileShareRequest& WithRole(RoleT&& value) {
  ...
  template <typename LocationARNT = Aws::String>
  CreateNFSFileShareRequest& WithLocationARN(LocationARNT&& value) {
  ...
  template <typename DefaultStorageClassT = Aws::String>
  CreateNFSFileShareRequest& WithDefaultStorageClass(DefaultStorageClassT&& value) {
  ...
  inline CreateNFSFileShareRequest& WithObjectACL(ObjectACL value) {
    SetObjectACL(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientListT = Aws::Vector<Aws::String>>
  CreateNFSFileShareRequest& WithClientList(ClientListT&& value) {
    SetClientList(std::forward<ClientListT>(value));
    return *this;
  }
  template <typename ClientListT = Aws::String>
  CreateNFSFileShareRequest& AddClientList(ClientListT&& value) {
    m_clientListHasBeenSet = true;
  ...
  template <typename SquashT = Aws::String>
  CreateNFSFileShareRequest& WithSquash(SquashT&& value) {
  ...
  inline CreateNFSFileShareRequest& WithReadOnly(bool value) {
    SetReadOnly(value);
    return *this;
  }
  ///@}
  ...
  inline CreateNFSFileShareRequest& WithGuessMIMETypeEnabled(bool value) {
  ...
  inline CreateNFSFileShareRequest& WithRequesterPays(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateNFSFileShareRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateNFSFileShareRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename FileShareNameT = Aws::String>
  CreateNFSFileShareRequest& WithFileShareName(FileShareNameT&& value) {
  ...
  template <typename CacheAttributesT = CacheAttributes>
  CreateNFSFileShareRequest& WithCacheAttributes(CacheAttributesT&& value) {
  ...
  template <typename NotificationPolicyT = Aws::String>
  CreateNFSFileShareRequest& WithNotificationPolicy(NotificationPolicyT&& value) {
  ...
  template <typename VPCEndpointDNSNameT = Aws::String>
  CreateNFSFileShareRequest& WithVPCEndpointDNSName(VPCEndpointDNSNameT&& value) {
  ...
  template <typename BucketRegionT = Aws::String>
  CreateNFSFileShareRequest& WithBucketRegion(BucketRegionT&& value) {
  ...
  template <typename AuditDestinationARNT = Aws::String>
  CreateNFSFileShareRequest& WithAuditDestinationARN(AuditDestinationARNT&& value) {
