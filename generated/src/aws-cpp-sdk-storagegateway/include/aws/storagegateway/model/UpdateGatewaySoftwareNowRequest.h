...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class UpdateGatewaySoftwareNowRequest : public StorageGatewayRequest
  {
  public:
    AWS_STORAGEGATEWAY_API UpdateGatewaySoftwareNowRequest() = default;
    ...
    template<typename GatewayARNT = Aws::String>
    UpdateGatewaySoftwareNowRequest& WithGatewayARN(GatewayARNT&& value) { SetGatewayARN(std::forward<GatewayARNT>(value)); return *this;}
    ///@}
  private:
