...
class CreateSMBFileShareRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateSMBFileShareRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename GatewayARNT = Aws::String>
  CreateSMBFileShareRequest& WithGatewayARN(GatewayARNT&& value) {
  ...
  inline CreateSMBFileShareRequest& WithEncryptionType(EncryptionType value) {
  ...
  template <typename KMSKeyT = Aws::String>
  CreateSMBFileShareRequest& WithKMSKey(KMSKeyT&& value) {
  ...
  template <typename RoleT = Aws::String>
  CreateSMBFileShareRequest& WithRole(RoleT&& value) {
  ...
  template <typename LocationARNT = Aws::String>
  CreateSMBFileShareRequest& WithLocationARN(LocationARNT&& value) {
  ...
  template <typename DefaultStorageClassT = Aws::String>
  CreateSMBFileShareRequest& WithDefaultStorageClass(DefaultStorageClassT&& value) {
  ...
  inline CreateSMBFileShareRequest& WithObjectACL(ObjectACL value) {
    SetObjectACL(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSMBFileShareRequest& WithReadOnly(bool value) {
    SetReadOnly(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSMBFileShareRequest& WithGuessMIMETypeEnabled(bool value) {
  ...
  inline CreateSMBFileShareRequest& WithRequesterPays(bool value) {
  ...
  inline CreateSMBFileShareRequest& WithSMBACLEnabled(bool value) {
  ...
  inline CreateSMBFileShareRequest& WithAccessBasedEnumeration(bool value) {
  ...
  template <typename AdminUserListT = Aws::Vector<Aws::String>>
  CreateSMBFileShareRequest& WithAdminUserList(AdminUserListT&& value) {
    SetAdminUserList(std::forward<AdminUserListT>(value));
    return *this;
  }
  template <typename AdminUserListT = Aws::String>
  CreateSMBFileShareRequest& AddAdminUserList(AdminUserListT&& value) {
    m_adminUserListHasBeenSet = true;
  ...
  template <typename ValidUserListT = Aws::Vector<Aws::String>>
  CreateSMBFileShareRequest& WithValidUserList(ValidUserListT&& value) {
    SetValidUserList(std::forward<ValidUserListT>(value));
    return *this;
  }
  template <typename ValidUserListT = Aws::String>
  CreateSMBFileShareRequest& AddValidUserList(ValidUserListT&& value) {
    m_validUserListHasBeenSet = true;
  ...
  template <typename InvalidUserListT = Aws::Vector<Aws::String>>
  CreateSMBFileShareRequest& WithInvalidUserList(InvalidUserListT&& value) {
    SetInvalidUserList(std::forward<InvalidUserListT>(value));
    return *this;
  }
  template <typename InvalidUserListT = Aws::String>
  CreateSMBFileShareRequest& AddInvalidUserList(InvalidUserListT&& value) {
    m_invalidUserListHasBeenSet = true;
  ...
  template <typename AuditDestinationARNT = Aws::String>
  CreateSMBFileShareRequest& WithAuditDestinationARN(AuditDestinationARNT&& value) {
  ...
  template <typename AuthenticationT = Aws::String>
  CreateSMBFileShareRequest& WithAuthentication(AuthenticationT&& value) {
  ...
  inline CreateSMBFileShareRequest& WithCaseSensitivity(CaseSensitivity value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateSMBFileShareRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateSMBFileShareRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename FileShareNameT = Aws::String>
  CreateSMBFileShareRequest& WithFileShareName(FileShareNameT&& value) {
  ...
  template <typename CacheAttributesT = CacheAttributes>
  CreateSMBFileShareRequest& WithCacheAttributes(CacheAttributesT&& value) {
  ...
  template <typename NotificationPolicyT = Aws::String>
  CreateSMBFileShareRequest& WithNotificationPolicy(NotificationPolicyT&& value) {
  ...
  template <typename VPCEndpointDNSNameT = Aws::String>
  CreateSMBFileShareRequest& WithVPCEndpointDNSName(VPCEndpointDNSNameT&& value) {
  ...
  template <typename BucketRegionT = Aws::String>
  CreateSMBFileShareRequest& WithBucketRegion(BucketRegionT&& value) {
  ...
  inline CreateSMBFileShareRequest& WithOplocksEnabled(bool value) {
