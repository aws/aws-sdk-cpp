...
class CreateSnapshotFromVolumeRecoveryPointRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename VolumeARNT = Aws::String>
  CreateSnapshotFromVolumeRecoveryPointRequest& WithVolumeARN(VolumeARNT&& value) {
  ...
  void SetSnapshotDescription(SnapshotDescriptionT&& value) {
    m_snapshotDescriptionHasBeenSet = true;
    m_snapshotDescription = std::forward<SnapshotDescriptionT>(value);
  }
  template <typename SnapshotDescriptionT = Aws::String>
  CreateSnapshotFromVolumeRecoveryPointRequest& WithSnapshotDescription(SnapshotDescriptionT&& value) {
    SetSnapshotDescription(std::forward<SnapshotDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateSnapshotFromVolumeRecoveryPointRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateSnapshotFromVolumeRecoveryPointRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
