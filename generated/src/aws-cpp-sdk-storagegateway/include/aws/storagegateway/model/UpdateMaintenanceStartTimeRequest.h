...
class UpdateMaintenanceStartTimeRequest : public StorageGatewayRequest {
 public:
  ...
  inline UpdateMaintenanceStartTimeRequest& WithHourOfDay(int value) {
    SetHourOfDay(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateMaintenanceStartTimeRequest& WithMinuteOfHour(int value) {
  ...
  inline UpdateMaintenanceStartTimeRequest& WithDayOfWeek(int value) {
    SetDayOfWeek(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateMaintenanceStartTimeRequest& WithDayOfMonth(int value) {
    SetDayOfMonth(value);
    return *this;
  }
  ///@}
  ...
  void SetSoftwareUpdatePreferences(SoftwareUpdatePreferencesT&& value) {
    m_softwareUpdatePreferencesHasBeenSet = true;
    m_softwareUpdatePreferences = std::forward<SoftwareUpdatePreferencesT>(value);
  }
  template <typename SoftwareUpdatePreferencesT = SoftwareUpdatePreferences>
  UpdateMaintenanceStartTimeRequest& WithSoftwareUpdatePreferences(SoftwareUpdatePreferencesT&& value) {
    SetSoftwareUpdatePreferences(std::forward<SoftwareUpdatePreferencesT>(value));
    return *this;
  }
  ///@}
 private:
