...
class DescribeCachediSCSIVolumesRequest : public StorageGatewayRequest {
 public:
  ...
  void SetVolumeARNs(VolumeARNsT&& value) {
    m_volumeARNsHasBeenSet = true;
    m_volumeARNs = std::forward<VolumeARNsT>(value);
  }
  template <typename VolumeARNsT = Aws::Vector<Aws::String>>
  DescribeCachediSCSIVolumesRequest& WithVolumeARNs(VolumeARNsT&& value) {
    SetVolumeARNs(std::forward<VolumeARNsT>(value));
    return *this;
  }
  template <typename VolumeARNsT = Aws::String>
  DescribeCachediSCSIVolumesRequest& AddVolumeARNs(VolumeARNsT&& value) {
    m_volumeARNsHasBeenSet = true;
    m_volumeARNs.emplace_back(std::forward<VolumeARNsT>(value));
    return *this;
  }
  ///@}
 private:
