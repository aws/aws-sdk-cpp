...
class ListVolumesResult {
 public:
  ...
  template <typename GatewayARNT = Aws::String>
  ListVolumesResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListVolumesResult& WithMarker(MarkerT&& value) {
  ...
  void SetVolumeInfos(VolumeInfosT&& value) {
    m_volumeInfosHasBeenSet = true;
    m_volumeInfos = std::forward<VolumeInfosT>(value);
  }
  template <typename VolumeInfosT = Aws::Vector<VolumeInfo>>
  ListVolumesResult& WithVolumeInfos(VolumeInfosT&& value) {
    SetVolumeInfos(std::forward<VolumeInfosT>(value));
    return *this;
  }
  template <typename VolumeInfosT = VolumeInfo>
  ListVolumesResult& AddVolumeInfos(VolumeInfosT&& value) {
    m_volumeInfosHasBeenSet = true;
    m_volumeInfos.emplace_back(std::forward<VolumeInfosT>(value));
    return *this;
  }
  ///@}
