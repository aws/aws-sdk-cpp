...
namespace Model
{
  ...
  {
  public:
    AWS_STORAGEGATEWAY_API UpdateNFSFileShareResult() = default;
    ...
    template<typename FileShareARNT = Aws::String>
    UpdateNFSFileShareResult& WithFileShareARN(FileShareARNT&& value) { SetFileShareARN(std::forward<FileShareARNT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateNFSFileShareResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
