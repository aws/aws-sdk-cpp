...
class UpdateSMBFileShareRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename FileShareARNT = Aws::String>
  UpdateSMBFileShareRequest& WithFileShareARN(FileShareARNT&& value) {
  ...
  inline UpdateSMBFileShareRequest& WithEncryptionType(EncryptionType value) {
  ...
  template <typename KMSKeyT = Aws::String>
  UpdateSMBFileShareRequest& WithKMSKey(KMSKeyT&& value) {
  ...
  template <typename DefaultStorageClassT = Aws::String>
  UpdateSMBFileShareRequest& WithDefaultStorageClass(DefaultStorageClassT&& value) {
  ...
  inline UpdateSMBFileShareRequest& WithObjectACL(ObjectACL value) {
    SetObjectACL(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateSMBFileShareRequest& WithReadOnly(bool value) {
    SetReadOnly(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateSMBFileShareRequest& WithGuessMIMETypeEnabled(bool value) {
  ...
  inline UpdateSMBFileShareRequest& WithRequesterPays(bool value) {
  ...
  inline void SetSMBACLEnabled(bool value) {
    m_sMBACLEnabledHasBeenSet = true;
    m_sMBACLEnabled = value;
  }
  inline UpdateSMBFileShareRequest& WithSMBACLEnabled(bool value) {
    SetSMBACLEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAccessBasedEnumeration(bool value) {
    m_accessBasedEnumerationHasBeenSet = true;
    m_accessBasedEnumeration = value;
  }
  inline UpdateSMBFileShareRequest& WithAccessBasedEnumeration(bool value) {
    SetAccessBasedEnumeration(value);
    return *this;
  }
  ///@}
  ...
  void SetAdminUserList(AdminUserListT&& value) {
    m_adminUserListHasBeenSet = true;
    m_adminUserList = std::forward<AdminUserListT>(value);
  }
  template <typename AdminUserListT = Aws::Vector<Aws::String>>
  UpdateSMBFileShareRequest& WithAdminUserList(AdminUserListT&& value) {
    SetAdminUserList(std::forward<AdminUserListT>(value));
    return *this;
  }
  template <typename AdminUserListT = Aws::String>
  UpdateSMBFileShareRequest& AddAdminUserList(AdminUserListT&& value) {
    m_adminUserListHasBeenSet = true;
    m_adminUserList.emplace_back(std::forward<AdminUserListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetValidUserList(ValidUserListT&& value) {
    m_validUserListHasBeenSet = true;
    m_validUserList = std::forward<ValidUserListT>(value);
  }
  template <typename ValidUserListT = Aws::Vector<Aws::String>>
  UpdateSMBFileShareRequest& WithValidUserList(ValidUserListT&& value) {
    SetValidUserList(std::forward<ValidUserListT>(value));
    return *this;
  }
  template <typename ValidUserListT = Aws::String>
  UpdateSMBFileShareRequest& AddValidUserList(ValidUserListT&& value) {
    m_validUserListHasBeenSet = true;
    m_validUserList.emplace_back(std::forward<ValidUserListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvalidUserList(InvalidUserListT&& value) {
    m_invalidUserListHasBeenSet = true;
    m_invalidUserList = std::forward<InvalidUserListT>(value);
  }
  template <typename InvalidUserListT = Aws::Vector<Aws::String>>
  UpdateSMBFileShareRequest& WithInvalidUserList(InvalidUserListT&& value) {
    SetInvalidUserList(std::forward<InvalidUserListT>(value));
    return *this;
  }
  template <typename InvalidUserListT = Aws::String>
  UpdateSMBFileShareRequest& AddInvalidUserList(InvalidUserListT&& value) {
    m_invalidUserListHasBeenSet = true;
    m_invalidUserList.emplace_back(std::forward<InvalidUserListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AuditDestinationARNT = Aws::String>
  UpdateSMBFileShareRequest& WithAuditDestinationARN(AuditDestinationARNT&& value) {
  ...
  inline void SetCaseSensitivity(CaseSensitivity value) {
    m_caseSensitivityHasBeenSet = true;
    m_caseSensitivity = value;
  }
  inline UpdateSMBFileShareRequest& WithCaseSensitivity(CaseSensitivity value) {
  ...
  template <typename FileShareNameT = Aws::String>
  UpdateSMBFileShareRequest& WithFileShareName(FileShareNameT&& value) {
  ...
  template <typename CacheAttributesT = CacheAttributes>
  UpdateSMBFileShareRequest& WithCacheAttributes(CacheAttributesT&& value) {
  ...
  template <typename NotificationPolicyT = Aws::String>
  UpdateSMBFileShareRequest& WithNotificationPolicy(NotificationPolicyT&& value) {
  ...
  inline void SetOplocksEnabled(bool value) {
    m_oplocksEnabledHasBeenSet = true;
    m_oplocksEnabled = value;
  }
  inline UpdateSMBFileShareRequest& WithOplocksEnabled(bool value) {
