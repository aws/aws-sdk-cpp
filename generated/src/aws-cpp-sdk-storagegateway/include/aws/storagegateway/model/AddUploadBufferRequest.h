...
namespace Model
{
  ...
  /**
   */
  class AddUploadBufferRequest : public StorageGatewayRequest
  {
  public:
    ...
    template<typename GatewayARNT = Aws::String>
    AddUploadBufferRequest& WithGatewayARN(GatewayARNT&& value) { SetGatewayARN(std::forward<GatewayARNT>(value)); return *this;}
    ///@}
    ...
    template<typename DiskIdsT = Aws::Vector<Aws::String>>
    AddUploadBufferRequest& WithDiskIds(DiskIdsT&& value) { SetDiskIds(std::forward<DiskIdsT>(value)); return *this;}
    template<typename DiskIdsT = Aws::String>
    AddUploadBufferRequest& AddDiskIds(DiskIdsT&& value) { m_diskIdsHasBeenSet = true; m_diskIds.emplace_back(std::forward<DiskIdsT>(value)); return *this; }
    ///@}
  private:
