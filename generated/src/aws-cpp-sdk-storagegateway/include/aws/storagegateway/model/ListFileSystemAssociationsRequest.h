...
class ListFileSystemAssociationsRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename GatewayARNT = Aws::String>
  ListFileSystemAssociationsRequest& WithGatewayARN(GatewayARNT&& value) {
  ...
  inline ListFileSystemAssociationsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListFileSystemAssociationsRequest& WithMarker(MarkerT&& value) {
