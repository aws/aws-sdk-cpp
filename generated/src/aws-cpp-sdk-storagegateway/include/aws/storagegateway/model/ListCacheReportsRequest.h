...
namespace Model
{
  ...
  {
  public:
    AWS_STORAGEGATEWAY_API ListCacheReportsRequest() = default;
    ...
    template<typename MarkerT = Aws::String>
    ListCacheReportsRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
  private:
