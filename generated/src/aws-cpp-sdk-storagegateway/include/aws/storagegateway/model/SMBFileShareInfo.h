...
class SMBFileShareInfo {
 public:
  ...
  template <typename FileShareARNT = Aws::String>
  SMBFileShareInfo& WithFileShareARN(FileShareARNT&& value) {
  ...
  template <typename FileShareIdT = Aws::String>
  SMBFileShareInfo& WithFileShareId(FileShareIdT&& value) {
  ...
  template <typename FileShareStatusT = Aws::String>
  SMBFileShareInfo& WithFileShareStatus(FileShareStatusT&& value) {
  ...
  template <typename GatewayARNT = Aws::String>
  SMBFileShareInfo& WithGatewayARN(GatewayARNT&& value) {
  ...
  inline SMBFileShareInfo& WithEncryptionType(EncryptionType value) {
  ...
  template <typename KMSKeyT = Aws::String>
  SMBFileShareInfo& WithKMSKey(KMSKeyT&& value) {
  ...
  template <typename PathT = Aws::String>
  SMBFileShareInfo& WithPath(PathT&& value) {
  ...
  template <typename RoleT = Aws::String>
  SMBFileShareInfo& WithRole(RoleT&& value) {
  ...
  template <typename LocationARNT = Aws::String>
  SMBFileShareInfo& WithLocationARN(LocationARNT&& value) {
  ...
  template <typename DefaultStorageClassT = Aws::String>
  SMBFileShareInfo& WithDefaultStorageClass(DefaultStorageClassT&& value) {
  ...
  inline SMBFileShareInfo& WithObjectACL(ObjectACL value) {
    SetObjectACL(value);
    return *this;
  }
  ///@}
  ...
  inline SMBFileShareInfo& WithReadOnly(bool value) {
    SetReadOnly(value);
    return *this;
  }
  ///@}
  ...
  inline SMBFileShareInfo& WithGuessMIMETypeEnabled(bool value) {
  ...
  inline SMBFileShareInfo& WithRequesterPays(bool value) {
  ...
  inline SMBFileShareInfo& WithSMBACLEnabled(bool value) {
  ...
  inline SMBFileShareInfo& WithAccessBasedEnumeration(bool value) {
  ...
  template <typename AdminUserListT = Aws::Vector<Aws::String>>
  SMBFileShareInfo& WithAdminUserList(AdminUserListT&& value) {
    SetAdminUserList(std::forward<AdminUserListT>(value));
    return *this;
  }
  template <typename AdminUserListT = Aws::String>
  SMBFileShareInfo& AddAdminUserList(AdminUserListT&& value) {
    m_adminUserListHasBeenSet = true;
  ...
  template <typename ValidUserListT = Aws::Vector<Aws::String>>
  SMBFileShareInfo& WithValidUserList(ValidUserListT&& value) {
    SetValidUserList(std::forward<ValidUserListT>(value));
    return *this;
  }
  template <typename ValidUserListT = Aws::String>
  SMBFileShareInfo& AddValidUserList(ValidUserListT&& value) {
    m_validUserListHasBeenSet = true;
  ...
  template <typename InvalidUserListT = Aws::Vector<Aws::String>>
  SMBFileShareInfo& WithInvalidUserList(InvalidUserListT&& value) {
    SetInvalidUserList(std::forward<InvalidUserListT>(value));
    return *this;
  }
  template <typename InvalidUserListT = Aws::String>
  SMBFileShareInfo& AddInvalidUserList(InvalidUserListT&& value) {
    m_invalidUserListHasBeenSet = true;
  ...
  template <typename AuditDestinationARNT = Aws::String>
  SMBFileShareInfo& WithAuditDestinationARN(AuditDestinationARNT&& value) {
  ...
  template <typename AuthenticationT = Aws::String>
  SMBFileShareInfo& WithAuthentication(AuthenticationT&& value) {
  ...
  inline SMBFileShareInfo& WithCaseSensitivity(CaseSensitivity value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  SMBFileShareInfo& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  SMBFileShareInfo& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename FileShareNameT = Aws::String>
  SMBFileShareInfo& WithFileShareName(FileShareNameT&& value) {
  ...
  template <typename CacheAttributesT = CacheAttributes>
  SMBFileShareInfo& WithCacheAttributes(CacheAttributesT&& value) {
  ...
  template <typename NotificationPolicyT = Aws::String>
  SMBFileShareInfo& WithNotificationPolicy(NotificationPolicyT&& value) {
  ...
  template <typename VPCEndpointDNSNameT = Aws::String>
  SMBFileShareInfo& WithVPCEndpointDNSName(VPCEndpointDNSNameT&& value) {
  ...
  template <typename BucketRegionT = Aws::String>
  SMBFileShareInfo& WithBucketRegion(BucketRegionT&& value) {
  ...
  inline SMBFileShareInfo& WithOplocksEnabled(bool value) {
