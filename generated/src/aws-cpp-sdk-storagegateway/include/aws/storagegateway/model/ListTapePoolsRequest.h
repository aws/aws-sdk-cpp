...
class ListTapePoolsRequest : public StorageGatewayRequest {
 public:
  ...
  void SetPoolARNs(PoolARNsT&& value) {
    m_poolARNsHasBeenSet = true;
    m_poolARNs = std::forward<PoolARNsT>(value);
  }
  template <typename PoolARNsT = Aws::Vector<Aws::String>>
  ListTapePoolsRequest& WithPoolARNs(PoolARNsT&& value) {
    SetPoolARNs(std::forward<PoolARNsT>(value));
    return *this;
  }
  template <typename PoolARNsT = Aws::String>
  ListTapePoolsRequest& AddPoolARNs(PoolARNsT&& value) {
    m_poolARNsHasBeenSet = true;
    m_poolARNs.emplace_back(std::forward<PoolARNsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListTapePoolsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListTapePoolsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
