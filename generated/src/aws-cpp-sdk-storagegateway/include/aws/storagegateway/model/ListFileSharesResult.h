...
class ListFileSharesResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListFileSharesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename NextMarkerT = Aws::String>
  ListFileSharesResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetFileShareInfoList(FileShareInfoListT&& value) {
    m_fileShareInfoListHasBeenSet = true;
    m_fileShareInfoList = std::forward<FileShareInfoListT>(value);
  }
  template <typename FileShareInfoListT = Aws::Vector<FileShareInfo>>
  ListFileSharesResult& WithFileShareInfoList(FileShareInfoListT&& value) {
    SetFileShareInfoList(std::forward<FileShareInfoListT>(value));
    return *this;
  }
  template <typename FileShareInfoListT = FileShareInfo>
  ListFileSharesResult& AddFileShareInfoList(FileShareInfoListT&& value) {
    m_fileShareInfoListHasBeenSet = true;
    m_fileShareInfoList.emplace_back(std::forward<FileShareInfoListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListFileSharesResult& WithRequestId(RequestIdT&& value) {
