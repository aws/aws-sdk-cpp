...
class DeleteChapCredentialsResult {
 public:
  ...
  template <typename TargetARNT = Aws::String>
  DeleteChapCredentialsResult& WithTargetARN(TargetARNT&& value) {
  ...
  template <typename InitiatorNameT = Aws::String>
  DeleteChapCredentialsResult& WithInitiatorName(InitiatorNameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteChapCredentialsResult& WithRequestId(RequestIdT&& value) {
