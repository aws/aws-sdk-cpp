...
class DescribeSMBSettingsResult {
 public:
  ...
  template <typename GatewayARNT = Aws::String>
  DescribeSMBSettingsResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  DescribeSMBSettingsResult& WithDomainName(DomainNameT&& value) {
  ...
  inline DescribeSMBSettingsResult& WithActiveDirectoryStatus(ActiveDirectoryStatus value) {
  ...
  inline void SetSMBGuestPasswordSet(bool value) {
    m_sMBGuestPasswordSetHasBeenSet = true;
    m_sMBGuestPasswordSet = value;
  }
  inline DescribeSMBSettingsResult& WithSMBGuestPasswordSet(bool value) {
    SetSMBGuestPasswordSet(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeSMBSettingsResult& WithSMBSecurityStrategy(SMBSecurityStrategy value) {
  ...
  inline DescribeSMBSettingsResult& WithFileSharesVisible(bool value) {
  ...
  template <typename SMBLocalGroupsT = SMBLocalGroups>
  DescribeSMBSettingsResult& WithSMBLocalGroups(SMBLocalGroupsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSMBSettingsResult& WithRequestId(RequestIdT&& value) {
