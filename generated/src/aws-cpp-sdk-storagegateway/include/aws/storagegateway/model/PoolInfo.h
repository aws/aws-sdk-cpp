...
class PoolInfo {
 public:
  ...
  inline void SetStorageClass(TapeStorageClass value) {
    m_storageClassHasBeenSet = true;
    m_storageClass = value;
  }
  inline PoolInfo& WithStorageClass(TapeStorageClass value) {
  ...
  inline void SetRetentionLockType(RetentionLockType value) {
    m_retentionLockTypeHasBeenSet = true;
    m_retentionLockType = value;
  }
  inline PoolInfo& WithRetentionLockType(RetentionLockType value) {
    SetRetentionLockType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRetentionLockTimeInDays(int value) {
    m_retentionLockTimeInDaysHasBeenSet = true;
    m_retentionLockTimeInDays = value;
  }
  inline PoolInfo& WithRetentionLockTimeInDays(int value) {
    SetRetentionLockTimeInDays(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPoolStatus(PoolStatus value) {
    m_poolStatusHasBeenSet = true;
    m_poolStatus = value;
  }
  inline PoolInfo& WithPoolStatus(PoolStatus value) {
    SetPoolStatus(value);
    return *this;
  }
  ///@}
