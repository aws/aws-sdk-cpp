...
class CacheReportFilter {
 public:
  ...
  inline void SetName(CacheReportFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline CacheReportFilter& WithName(CacheReportFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  CacheReportFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  CacheReportFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
