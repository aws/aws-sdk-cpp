...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DescribeBandwidthRateLimitRequest : public StorageGatewayRequest
  {
  public:
    AWS_STORAGEGATEWAY_API DescribeBandwidthRateLimitRequest() = default;
    ...
    template<typename GatewayARNT = Aws::String>
    DescribeBandwidthRateLimitRequest& WithGatewayARN(GatewayARNT&& value) { SetGatewayARN(std::forward<GatewayARNT>(value)); return *this;}
    ///@}
  private:
