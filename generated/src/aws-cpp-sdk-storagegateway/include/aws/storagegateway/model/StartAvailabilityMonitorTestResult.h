...
class StartAvailabilityMonitorTestResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API StartAvailabilityMonitorTestResult& operator=(
  ...
  template <typename GatewayARNT = Aws::String>
  StartAvailabilityMonitorTestResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartAvailabilityMonitorTestResult& WithRequestId(RequestIdT&& value) {
