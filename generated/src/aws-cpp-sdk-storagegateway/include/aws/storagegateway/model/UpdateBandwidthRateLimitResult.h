...
namespace Model
{
  ...
  public:
    ...
    inline UpdateBandwidthRateLimitResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateBandwidthRateLimitResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateBandwidthRateLimitResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
