...
class DeviceiSCSIAttributes {
 public:
  ...
  template <typename TargetARNT = Aws::String>
  DeviceiSCSIAttributes& WithTargetARN(TargetARNT&& value) {
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  DeviceiSCSIAttributes& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  inline void SetNetworkInterfacePort(int value) {
    m_networkInterfacePortHasBeenSet = true;
    m_networkInterfacePort = value;
  }
  inline DeviceiSCSIAttributes& WithNetworkInterfacePort(int value) {
    SetNetworkInterfacePort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetChapEnabled(bool value) {
    m_chapEnabledHasBeenSet = true;
    m_chapEnabled = value;
  }
  inline DeviceiSCSIAttributes& WithChapEnabled(bool value) {
    SetChapEnabled(value);
    return *this;
  }
  ///@}
 private:
