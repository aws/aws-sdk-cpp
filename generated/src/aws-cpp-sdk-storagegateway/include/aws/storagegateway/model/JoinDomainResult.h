...
class JoinDomainResult {
 public:
  ...
  inline void SetActiveDirectoryStatus(ActiveDirectoryStatus value) {
    m_activeDirectoryStatusHasBeenSet = true;
    m_activeDirectoryStatus = value;
  }
  inline JoinDomainResult& WithActiveDirectoryStatus(ActiveDirectoryStatus value) {
    SetActiveDirectoryStatus(value);
    return *this;
  }
  ///@}
