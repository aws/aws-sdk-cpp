...
class DeleteTapeRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename GatewayARNT = Aws::String>
  DeleteTapeRequest& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename TapeARNT = Aws::String>
  DeleteTapeRequest& WithTapeARN(TapeARNT&& value) {
  ...
  inline DeleteTapeRequest& WithBypassGovernanceRetention(bool value) {
