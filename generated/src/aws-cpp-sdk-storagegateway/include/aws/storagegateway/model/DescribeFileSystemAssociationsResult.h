...
class DescribeFileSystemAssociationsResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API DescribeFileSystemAssociationsResult& operator=(
  ...
  void SetFileSystemAssociationInfoList(FileSystemAssociationInfoListT&& value) {
    ...
    m_fileSystemAssociationInfoList = std::forward<FileSystemAssociationInfoListT>(value);
  }
  template <typename FileSystemAssociationInfoListT = Aws::Vector<FileSystemAssociationInfo>>
  DescribeFileSystemAssociationsResult& WithFileSystemAssociationInfoList(FileSystemAssociationInfoListT&& value) {
    SetFileSystemAssociationInfoList(std::forward<FileSystemAssociationInfoListT>(value));
    return *this;
  }
  ...
  DescribeFileSystemAssociationsResult& AddFileSystemAssociationInfoList(FileSystemAssociationInfoListT&& value) {
    m_fileSystemAssociationInfoListHasBeenSet = true;
    m_fileSystemAssociationInfoList.emplace_back(std::forward<FileSystemAssociationInfoListT>(value));
    return *this;
  }
  ///@}
