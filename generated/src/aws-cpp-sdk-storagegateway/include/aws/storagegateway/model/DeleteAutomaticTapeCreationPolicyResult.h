...
class DeleteAutomaticTapeCreationPolicyResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API DeleteAutomaticTapeCreationPolicyResult& operator=(
  ...
  template <typename GatewayARNT = Aws::String>
  DeleteAutomaticTapeCreationPolicyResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteAutomaticTapeCreationPolicyResult& WithRequestId(RequestIdT&& value) {
