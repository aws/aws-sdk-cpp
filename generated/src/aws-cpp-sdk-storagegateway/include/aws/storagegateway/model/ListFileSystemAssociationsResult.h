...
class ListFileSystemAssociationsResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API ListFileSystemAssociationsResult& operator=(
  ...
  template <typename MarkerT = Aws::String>
  ListFileSystemAssociationsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename NextMarkerT = Aws::String>
  ListFileSystemAssociationsResult& WithNextMarker(NextMarkerT&& value) {
   ...
   * associations.</p>
   */
  inline const Aws::Vector<FileSystemAssociationSummary>& GetFileSystemAssociationSummaryList() const {
    return m_fileSystemAssociationSummaryList;
  }
  template <typename FileSystemAssociationSummaryListT = Aws::Vector<FileSystemAssociationSummary>>
  void SetFileSystemAssociationSummaryList(FileSystemAssociationSummaryListT&& value) {
    m_fileSystemAssociationSummaryListHasBeenSet = true;
    m_fileSystemAssociationSummaryList = std::forward<FileSystemAssociationSummaryListT>(value);
  }
  template <typename FileSystemAssociationSummaryListT = Aws::Vector<FileSystemAssociationSummary>>
  ListFileSystemAssociationsResult& WithFileSystemAssociationSummaryList(FileSystemAssociationSummaryListT&& value) {
    SetFileSystemAssociationSummaryList(std::forward<FileSystemAssociationSummaryListT>(value));
    return *this;
  }
  template <typename FileSystemAssociationSummaryListT = FileSystemAssociationSummary>
  ListFileSystemAssociationsResult& AddFileSystemAssociationSummaryList(FileSystemAssociationSummaryListT&& value) {
    m_fileSystemAssociationSummaryListHasBeenSet = true;
    m_fileSystemAssociationSummaryList.emplace_back(std::forward<FileSystemAssociationSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListFileSystemAssociationsResult& WithRequestId(RequestIdT&& value) {
