...
class SMBLocalGroups {
 public:
  ...
  void SetGatewayAdmins(GatewayAdminsT&& value) {
    m_gatewayAdminsHasBeenSet = true;
    m_gatewayAdmins = std::forward<GatewayAdminsT>(value);
  }
  template <typename GatewayAdminsT = Aws::Vector<Aws::String>>
  SMBLocalGroups& WithGatewayAdmins(GatewayAdminsT&& value) {
    SetGatewayAdmins(std::forward<GatewayAdminsT>(value));
    return *this;
  }
  template <typename GatewayAdminsT = Aws::String>
  SMBLocalGroups& AddGatewayAdmins(GatewayAdminsT&& value) {
    m_gatewayAdminsHasBeenSet = true;
    m_gatewayAdmins.emplace_back(std::forward<GatewayAdminsT>(value));
    return *this;
  }
  ///@}
 private:
