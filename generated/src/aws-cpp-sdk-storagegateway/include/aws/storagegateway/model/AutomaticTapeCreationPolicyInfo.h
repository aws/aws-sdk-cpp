...
class AutomaticTapeCreationPolicyInfo {
 public:
  ...
  void SetAutomaticTapeCreationRules(AutomaticTapeCreationRulesT&& value) {
    m_automaticTapeCreationRulesHasBeenSet = true;
    m_automaticTapeCreationRules = std::forward<AutomaticTapeCreationRulesT>(value);
  }
  template <typename AutomaticTapeCreationRulesT = Aws::Vector<AutomaticTapeCreationRule>>
  AutomaticTapeCreationPolicyInfo& WithAutomaticTapeCreationRules(AutomaticTapeCreationRulesT&& value) {
    SetAutomaticTapeCreationRules(std::forward<AutomaticTapeCreationRulesT>(value));
    return *this;
  }
  template <typename AutomaticTapeCreationRulesT = AutomaticTapeCreationRule>
  AutomaticTapeCreationPolicyInfo& AddAutomaticTapeCreationRules(AutomaticTapeCreationRulesT&& value) {
    m_automaticTapeCreationRulesHasBeenSet = true;
    m_automaticTapeCreationRules.emplace_back(std::forward<AutomaticTapeCreationRulesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename GatewayARNT = Aws::String>
  AutomaticTapeCreationPolicyInfo& WithGatewayARN(GatewayARNT&& value) {
