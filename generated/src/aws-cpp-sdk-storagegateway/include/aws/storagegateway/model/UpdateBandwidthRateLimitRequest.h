...
class UpdateBandwidthRateLimitRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename GatewayARNT = Aws::String>
  UpdateBandwidthRateLimitRequest& WithGatewayARN(GatewayARNT&& value) {
  ...
  inline UpdateBandwidthRateLimitRequest& WithAverageUploadRateLimitInBitsPerSec(long long value) {
  ...
  inline UpdateBandwidthRateLimitRequest& WithAverageDownloadRateLimitInBitsPerSec(long long value) {
