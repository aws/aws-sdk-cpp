...
class DescribeVTLDevicesRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename GatewayARNT = Aws::String>
  DescribeVTLDevicesRequest& WithGatewayARN(GatewayARNT&& value) {
  ...
  void SetVTLDeviceARNs(VTLDeviceARNsT&& value) {
    m_vTLDeviceARNsHasBeenSet = true;
    m_vTLDeviceARNs = std::forward<VTLDeviceARNsT>(value);
  }
  template <typename VTLDeviceARNsT = Aws::Vector<Aws::String>>
  DescribeVTLDevicesRequest& WithVTLDeviceARNs(VTLDeviceARNsT&& value) {
    SetVTLDeviceARNs(std::forward<VTLDeviceARNsT>(value));
    return *this;
  }
  template <typename VTLDeviceARNsT = Aws::String>
  DescribeVTLDevicesRequest& AddVTLDeviceARNs(VTLDeviceARNsT&& value) {
    m_vTLDeviceARNsHasBeenSet = true;
    m_vTLDeviceARNs.emplace_back(std::forward<VTLDeviceARNsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeVTLDevicesRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeVTLDevicesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
