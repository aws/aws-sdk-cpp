...
class CreateCachediSCSIVolumeResult {
 public:
  ...
  template <typename VolumeARNT = Aws::String>
  CreateCachediSCSIVolumeResult& WithVolumeARN(VolumeARNT&& value) {
  ...
  template <typename TargetARNT = Aws::String>
  CreateCachediSCSIVolumeResult& WithTargetARN(TargetARNT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCachediSCSIVolumeResult& WithRequestId(RequestIdT&& value) {
