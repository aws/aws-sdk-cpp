...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DescribeMaintenanceStartTimeRequest : public StorageGatewayRequest
  {
  public:
    AWS_STORAGEGATEWAY_API DescribeMaintenanceStartTimeRequest() = default;
    ...
    template<typename GatewayARNT = Aws::String>
    DescribeMaintenanceStartTimeRequest& WithGatewayARN(GatewayARNT&& value) { SetGatewayARN(std::forward<GatewayARNT>(value)); return *this;}
    ///@}
  private:
