...
class UpdateSMBSecurityStrategyRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename GatewayARNT = Aws::String>
  UpdateSMBSecurityStrategyRequest& WithGatewayARN(GatewayARNT&& value) {
  ...
  inline void SetSMBSecurityStrategy(SMBSecurityStrategy value) {
    m_sMBSecurityStrategyHasBeenSet = true;
    m_sMBSecurityStrategy = value;
  }
  inline UpdateSMBSecurityStrategyRequest& WithSMBSecurityStrategy(SMBSecurityStrategy value) {
    SetSMBSecurityStrategy(value);
    return *this;
  }
  ///@}
 private:
