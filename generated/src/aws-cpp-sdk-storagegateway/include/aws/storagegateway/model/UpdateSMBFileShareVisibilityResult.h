...
class UpdateSMBFileShareVisibilityResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API UpdateSMBFileShareVisibilityResult& operator=(
  ...
  template <typename GatewayARNT = Aws::String>
  UpdateSMBFileShareVisibilityResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSMBFileShareVisibilityResult& WithRequestId(RequestIdT&& value) {
