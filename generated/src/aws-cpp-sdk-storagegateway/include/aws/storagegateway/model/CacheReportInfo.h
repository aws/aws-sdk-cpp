...
class CacheReportInfo {
 public:
  ...
  inline void SetCacheReportStatus(CacheReportStatus value) {
    m_cacheReportStatusHasBeenSet = true;
    m_cacheReportStatus = value;
  }
  inline CacheReportInfo& WithCacheReportStatus(CacheReportStatus value) {
    SetCacheReportStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReportCompletionPercent(int value) {
    m_reportCompletionPercentHasBeenSet = true;
    m_reportCompletionPercent = value;
  }
  inline CacheReportInfo& WithReportCompletionPercent(int value) {
    SetReportCompletionPercent(value);
    return *this;
  }
  ///@}
