...
/**
 * <p>An exception occurred because an invalid gateway request was issued to the
 * service. For more information, see the error and message fields.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/storagegateway-2013-06-30/InvalidGatewayRequestException">AWS
 * API Reference</a></p>
 */
class InvalidGatewayRequestException {
 public:
  ...
  template <typename MessageT = Aws::String>
  InvalidGatewayRequestException& WithMessage(MessageT&& value) {
  ...
  template <typename ErrorT = StorageGatewayError>
  InvalidGatewayRequestException& WithError(ErrorT&& value) {
