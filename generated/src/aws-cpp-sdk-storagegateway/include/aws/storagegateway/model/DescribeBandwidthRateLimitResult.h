...
class DescribeBandwidthRateLimitResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API DescribeBandwidthRateLimitResult& operator=(
  ...
  template <typename GatewayARNT = Aws::String>
  DescribeBandwidthRateLimitResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  inline DescribeBandwidthRateLimitResult& WithAverageUploadRateLimitInBitsPerSec(long long value) {
  ...
  inline DescribeBandwidthRateLimitResult& WithAverageDownloadRateLimitInBitsPerSec(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBandwidthRateLimitResult& WithRequestId(RequestIdT&& value) {
