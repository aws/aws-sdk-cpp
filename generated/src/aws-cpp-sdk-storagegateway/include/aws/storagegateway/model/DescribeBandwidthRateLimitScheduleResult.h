...
class DescribeBandwidthRateLimitScheduleResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API DescribeBandwidthRateLimitScheduleResult& operator=(
  ...
  template <typename GatewayARNT = Aws::String>
  DescribeBandwidthRateLimitScheduleResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename BandwidthRateLimitIntervalsT = Aws::Vector<BandwidthRateLimitInterval>>
  DescribeBandwidthRateLimitScheduleResult& WithBandwidthRateLimitIntervals(BandwidthRateLimitIntervalsT&& value) {
  ...
  DescribeBandwidthRateLimitScheduleResult& AddBandwidthRateLimitIntervals(BandwidthRateLimitIntervalsT&& value) {
    m_bandwidthRateLimitIntervalsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBandwidthRateLimitScheduleResult& WithRequestId(RequestIdT&& value) {
