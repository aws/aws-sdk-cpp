...
class StorediSCSIVolume {
 public:
  ...
  template <typename VolumeARNT = Aws::String>
  StorediSCSIVolume& WithVolumeARN(VolumeARNT&& value) {
  ...
  template <typename VolumeIdT = Aws::String>
  StorediSCSIVolume& WithVolumeId(VolumeIdT&& value) {
  ...
  template <typename VolumeTypeT = Aws::String>
  StorediSCSIVolume& WithVolumeType(VolumeTypeT&& value) {
  ...
  void SetVolumeStatus(VolumeStatusT&& value) {
    m_volumeStatusHasBeenSet = true;
    m_volumeStatus = std::forward<VolumeStatusT>(value);
  }
  template <typename VolumeStatusT = Aws::String>
  StorediSCSIVolume& WithVolumeStatus(VolumeStatusT&& value) {
    SetVolumeStatus(std::forward<VolumeStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVolumeAttachmentStatus(VolumeAttachmentStatusT&& value) {
    ...
    m_volumeAttachmentStatus = std::forward<VolumeAttachmentStatusT>(value);
  }
  template <typename VolumeAttachmentStatusT = Aws::String>
  StorediSCSIVolume& WithVolumeAttachmentStatus(VolumeAttachmentStatusT&& value) {
    SetVolumeAttachmentStatus(std::forward<VolumeAttachmentStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline StorediSCSIVolume& WithVolumeSizeInBytes(long long value) {
  ...
  inline void SetVolumeProgress(double value) {
    m_volumeProgressHasBeenSet = true;
    m_volumeProgress = value;
  }
  inline StorediSCSIVolume& WithVolumeProgress(double value) {
  ...
  void SetVolumeDiskId(VolumeDiskIdT&& value) {
    m_volumeDiskIdHasBeenSet = true;
    m_volumeDiskId = std::forward<VolumeDiskIdT>(value);
  }
  template <typename VolumeDiskIdT = Aws::String>
  StorediSCSIVolume& WithVolumeDiskId(VolumeDiskIdT&& value) {
    SetVolumeDiskId(std::forward<VolumeDiskIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SourceSnapshotIdT = Aws::String>
  StorediSCSIVolume& WithSourceSnapshotId(SourceSnapshotIdT&& value) {
  ...
  inline void SetPreservedExistingData(bool value) {
    m_preservedExistingDataHasBeenSet = true;
    m_preservedExistingData = value;
  }
  inline StorediSCSIVolume& WithPreservedExistingData(bool value) {
    SetPreservedExistingData(value);
    return *this;
  }
  ///@}
  ...
  void SetVolumeiSCSIAttributes(VolumeiSCSIAttributesT&& value) {
    m_volumeiSCSIAttributesHasBeenSet = true;
    m_volumeiSCSIAttributes = std::forward<VolumeiSCSIAttributesT>(value);
  }
  template <typename VolumeiSCSIAttributesT = VolumeiSCSIAttributes>
  StorediSCSIVolume& WithVolumeiSCSIAttributes(VolumeiSCSIAttributesT&& value) {
    SetVolumeiSCSIAttributes(std::forward<VolumeiSCSIAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  StorediSCSIVolume& WithCreatedDate(CreatedDateT&& value) {
  ...
  inline void SetVolumeUsedInBytes(long long value) {
    m_volumeUsedInBytesHasBeenSet = true;
    m_volumeUsedInBytes = value;
  }
  inline StorediSCSIVolume& WithVolumeUsedInBytes(long long value) {
    SetVolumeUsedInBytes(value);
    return *this;
  }
  ///@}
  ...
  template <typename KMSKeyT = Aws::String>
  StorediSCSIVolume& WithKMSKey(KMSKeyT&& value) {
  ...
  template <typename TargetNameT = Aws::String>
  StorediSCSIVolume& WithTargetName(TargetNameT&& value) {
