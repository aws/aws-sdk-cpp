...
class DescribeSMBFileSharesRequest : public StorageGatewayRequest {
 public:
  ...
  void SetFileShareARNList(FileShareARNListT&& value) {
    m_fileShareARNListHasBeenSet = true;
    m_fileShareARNList = std::forward<FileShareARNListT>(value);
  }
  template <typename FileShareARNListT = Aws::Vector<Aws::String>>
  DescribeSMBFileSharesRequest& WithFileShareARNList(FileShareARNListT&& value) {
    SetFileShareARNList(std::forward<FileShareARNListT>(value));
    return *this;
  }
  template <typename FileShareARNListT = Aws::String>
  DescribeSMBFileSharesRequest& AddFileShareARNList(FileShareARNListT&& value) {
    m_fileShareARNListHasBeenSet = true;
    m_fileShareARNList.emplace_back(std::forward<FileShareARNListT>(value));
    return *this;
  }
  ///@}
 private:
