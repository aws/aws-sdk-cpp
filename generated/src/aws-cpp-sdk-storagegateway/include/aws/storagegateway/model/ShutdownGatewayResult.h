...
namespace Model
{
  ...
  public:
    ...
    inline ShutdownGatewayResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ShutdownGatewayResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ShutdownGatewayResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
