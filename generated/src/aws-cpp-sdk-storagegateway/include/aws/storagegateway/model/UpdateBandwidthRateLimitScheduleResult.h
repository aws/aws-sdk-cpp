...
class UpdateBandwidthRateLimitScheduleResult {
 public:
  AWS_STORAGEGATEWAY_API UpdateBandwidthRateLimitScheduleResult() = default;
  ...
  AWS_STORAGEGATEWAY_API UpdateBandwidthRateLimitScheduleResult& operator=(
  ...
  template <typename GatewayARNT = Aws::String>
  UpdateBandwidthRateLimitScheduleResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateBandwidthRateLimitScheduleResult& WithRequestId(RequestIdT&& value) {
