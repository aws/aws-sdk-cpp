...
class UpdateChapCredentialsRequest : public StorageGatewayRequest {
 public:
  ...
  void SetSecretToAuthenticateInitiator(SecretToAuthenticateInitiatorT&& value) {
    ...
    m_secretToAuthenticateInitiator = std::forward<SecretToAuthenticateInitiatorT>(value);
  }
  template <typename SecretToAuthenticateInitiatorT = Aws::String>
  UpdateChapCredentialsRequest& WithSecretToAuthenticateInitiator(SecretToAuthenticateInitiatorT&& value) {
    SetSecretToAuthenticateInitiator(std::forward<SecretToAuthenticateInitiatorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInitiatorName(InitiatorNameT&& value) {
    ...
    m_initiatorName = std::forward<InitiatorNameT>(value);
  }
  template <typename InitiatorNameT = Aws::String>
  UpdateChapCredentialsRequest& WithInitiatorName(InitiatorNameT&& value) {
    SetInitiatorName(std::forward<InitiatorNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecretToAuthenticateTarget(SecretToAuthenticateTargetT&& value) {
    ...
    m_secretToAuthenticateTarget = std::forward<SecretToAuthenticateTargetT>(value);
  }
  template <typename SecretToAuthenticateTargetT = Aws::String>
  UpdateChapCredentialsRequest& WithSecretToAuthenticateTarget(SecretToAuthenticateTargetT&& value) {
    SetSecretToAuthenticateTarget(std::forward<SecretToAuthenticateTargetT>(value));
    return *this;
  }
  ///@}
 private:
