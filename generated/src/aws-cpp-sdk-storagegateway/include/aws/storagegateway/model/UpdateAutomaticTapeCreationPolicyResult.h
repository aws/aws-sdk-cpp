...
class UpdateAutomaticTapeCreationPolicyResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API UpdateAutomaticTapeCreationPolicyResult& operator=(
  ...
  template <typename GatewayARNT = Aws::String>
  UpdateAutomaticTapeCreationPolicyResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAutomaticTapeCreationPolicyResult& WithRequestId(RequestIdT&& value) {
