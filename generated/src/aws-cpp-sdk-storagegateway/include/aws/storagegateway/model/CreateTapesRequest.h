...
class CreateTapesRequest : public StorageGatewayRequest {
 public:
  AWS_STORAGEGATEWAY_API CreateTapesRequest() = default;
  ...
  template <typename GatewayARNT = Aws::String>
  CreateTapesRequest& WithGatewayARN(GatewayARNT&& value) {
  ...
  inline CreateTapesRequest& WithTapeSizeInBytes(long long value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTapesRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline void SetNumTapesToCreate(int value) {
    m_numTapesToCreateHasBeenSet = true;
    m_numTapesToCreate = value;
  }
  inline CreateTapesRequest& WithNumTapesToCreate(int value) {
    SetNumTapesToCreate(value);
    return *this;
  }
  ///@}
  ...
  void SetTapeBarcodePrefix(TapeBarcodePrefixT&& value) {
    ...
    m_tapeBarcodePrefix = std::forward<TapeBarcodePrefixT>(value);
  }
  template <typename TapeBarcodePrefixT = Aws::String>
  CreateTapesRequest& WithTapeBarcodePrefix(TapeBarcodePrefixT&& value) {
    SetTapeBarcodePrefix(std::forward<TapeBarcodePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateTapesRequest& WithKMSEncrypted(bool value) {
  ...
  template <typename KMSKeyT = Aws::String>
  CreateTapesRequest& WithKMSKey(KMSKeyT&& value) {
  ...
  template <typename PoolIdT = Aws::String>
  CreateTapesRequest& WithPoolId(PoolIdT&& value) {
  ...
  inline CreateTapesRequest& WithWorm(bool value) {
    SetWorm(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateTapesRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateTapesRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
