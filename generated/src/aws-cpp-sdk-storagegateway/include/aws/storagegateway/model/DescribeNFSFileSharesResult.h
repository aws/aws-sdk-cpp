...
class DescribeNFSFileSharesResult {
 public:
  ...
  void SetNFSFileShareInfoList(NFSFileShareInfoListT&& value) {
    m_nFSFileShareInfoListHasBeenSet = true;
    m_nFSFileShareInfoList = std::forward<NFSFileShareInfoListT>(value);
  }
  template <typename NFSFileShareInfoListT = Aws::Vector<NFSFileShareInfo>>
  DescribeNFSFileSharesResult& WithNFSFileShareInfoList(NFSFileShareInfoListT&& value) {
    SetNFSFileShareInfoList(std::forward<NFSFileShareInfoListT>(value));
    return *this;
  }
  template <typename NFSFileShareInfoListT = NFSFileShareInfo>
  DescribeNFSFileSharesResult& AddNFSFileShareInfoList(NFSFileShareInfoListT&& value) {
    m_nFSFileShareInfoListHasBeenSet = true;
    m_nFSFileShareInfoList.emplace_back(std::forward<NFSFileShareInfoListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeNFSFileSharesResult& WithRequestId(RequestIdT&& value) {
