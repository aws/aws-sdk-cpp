...
class DescribeTapeArchivesResult {
 public:
  ...
  void SetTapeArchives(TapeArchivesT&& value) {
    m_tapeArchivesHasBeenSet = true;
    m_tapeArchives = std::forward<TapeArchivesT>(value);
  }
  template <typename TapeArchivesT = Aws::Vector<TapeArchive>>
  DescribeTapeArchivesResult& WithTapeArchives(TapeArchivesT&& value) {
    SetTapeArchives(std::forward<TapeArchivesT>(value));
    return *this;
  }
  template <typename TapeArchivesT = TapeArchive>
  DescribeTapeArchivesResult& AddTapeArchives(TapeArchivesT&& value) {
    m_tapeArchivesHasBeenSet = true;
    m_tapeArchives.emplace_back(std::forward<TapeArchivesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeTapeArchivesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTapeArchivesResult& WithRequestId(RequestIdT&& value) {
