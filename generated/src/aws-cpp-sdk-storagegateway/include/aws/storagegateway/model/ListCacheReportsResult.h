...
class ListCacheReportsResult {
 public:
  ...
  void SetCacheReportList(CacheReportListT&& value) {
    m_cacheReportListHasBeenSet = true;
    m_cacheReportList = std::forward<CacheReportListT>(value);
  }
  template <typename CacheReportListT = Aws::Vector<CacheReportInfo>>
  ListCacheReportsResult& WithCacheReportList(CacheReportListT&& value) {
    SetCacheReportList(std::forward<CacheReportListT>(value));
    return *this;
  }
  template <typename CacheReportListT = CacheReportInfo>
  ListCacheReportsResult& AddCacheReportList(CacheReportListT&& value) {
    m_cacheReportListHasBeenSet = true;
    m_cacheReportList.emplace_back(std::forward<CacheReportListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListCacheReportsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCacheReportsResult& WithRequestId(RequestIdT&& value) {
