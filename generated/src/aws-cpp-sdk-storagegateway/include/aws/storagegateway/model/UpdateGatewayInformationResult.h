...
class UpdateGatewayInformationResult {
 public:
  AWS_STORAGEGATEWAY_API UpdateGatewayInformationResult() = default;
  ...
  template <typename GatewayARNT = Aws::String>
  UpdateGatewayInformationResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename GatewayNameT = Aws::String>
  UpdateGatewayInformationResult& WithGatewayName(GatewayNameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateGatewayInformationResult& WithRequestId(RequestIdT&& value) {
