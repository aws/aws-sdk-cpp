...
class UpdateAutomaticTapeCreationPolicyRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename AutomaticTapeCreationRulesT = Aws::Vector<AutomaticTapeCreationRule>>
  UpdateAutomaticTapeCreationPolicyRequest& WithAutomaticTapeCreationRules(AutomaticTapeCreationRulesT&& value) {
  ...
  UpdateAutomaticTapeCreationPolicyRequest& AddAutomaticTapeCreationRules(AutomaticTapeCreationRulesT&& value) {
    m_automaticTapeCreationRulesHasBeenSet = true;
  ...
  template <typename GatewayARNT = Aws::String>
  UpdateAutomaticTapeCreationPolicyRequest& WithGatewayARN(GatewayARNT&& value) {
