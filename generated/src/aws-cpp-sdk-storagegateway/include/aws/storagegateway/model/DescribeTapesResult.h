...
class DescribeTapesResult {
 public:
  ...
  void SetTapes(TapesT&& value) {
    m_tapesHasBeenSet = true;
    m_tapes = std::forward<TapesT>(value);
  }
  template <typename TapesT = Aws::Vector<Tape>>
  DescribeTapesResult& WithTapes(TapesT&& value) {
    SetTapes(std::forward<TapesT>(value));
    return *this;
  }
  template <typename TapesT = Tape>
  DescribeTapesResult& AddTapes(TapesT&& value) {
    m_tapesHasBeenSet = true;
    m_tapes.emplace_back(std::forward<TapesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeTapesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTapesResult& WithRequestId(RequestIdT&& value) {
