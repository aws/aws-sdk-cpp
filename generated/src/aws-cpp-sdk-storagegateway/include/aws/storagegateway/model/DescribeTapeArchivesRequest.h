...
class DescribeTapeArchivesRequest : public StorageGatewayRequest {
 public:
  ...
  void SetTapeARNs(TapeARNsT&& value) {
    m_tapeARNsHasBeenSet = true;
    m_tapeARNs = std::forward<TapeARNsT>(value);
  }
  template <typename TapeARNsT = Aws::Vector<Aws::String>>
  DescribeTapeArchivesRequest& WithTapeARNs(TapeARNsT&& value) {
    SetTapeARNs(std::forward<TapeARNsT>(value));
    return *this;
  }
  template <typename TapeARNsT = Aws::String>
  DescribeTapeArchivesRequest& AddTapeARNs(TapeARNsT&& value) {
    m_tapeARNsHasBeenSet = true;
    m_tapeARNs.emplace_back(std::forward<TapeARNsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeTapeArchivesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
