...
class DescribeAvailabilityMonitorTestResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API DescribeAvailabilityMonitorTestResult& operator=(
  ...
  template <typename GatewayARNT = Aws::String>
  DescribeAvailabilityMonitorTestResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  inline void SetStatus(AvailabilityMonitorTestStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeAvailabilityMonitorTestResult& WithStatus(AvailabilityMonitorTestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  DescribeAvailabilityMonitorTestResult& WithStartTime(StartTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAvailabilityMonitorTestResult& WithRequestId(RequestIdT&& value) {
