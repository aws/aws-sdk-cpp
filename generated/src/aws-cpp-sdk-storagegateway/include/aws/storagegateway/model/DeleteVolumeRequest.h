...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DeleteVolumeRequest : public StorageGatewayRequest
  {
  public:
    AWS_STORAGEGATEWAY_API DeleteVolumeRequest() = default;
    ...
    template<typename VolumeARNT = Aws::String>
    DeleteVolumeRequest& WithVolumeARN(VolumeARNT&& value) { SetVolumeARN(std::forward<VolumeARNT>(value)); return *this;}
    ///@}
  private:
