...
class DescribeCachediSCSIVolumesResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API DescribeCachediSCSIVolumesResult& operator=(
  ...
  void SetCachediSCSIVolumes(CachediSCSIVolumesT&& value) {
    m_cachediSCSIVolumesHasBeenSet = true;
    m_cachediSCSIVolumes = std::forward<CachediSCSIVolumesT>(value);
  }
  template <typename CachediSCSIVolumesT = Aws::Vector<CachediSCSIVolume>>
  DescribeCachediSCSIVolumesResult& WithCachediSCSIVolumes(CachediSCSIVolumesT&& value) {
    SetCachediSCSIVolumes(std::forward<CachediSCSIVolumesT>(value));
    return *this;
  }
  template <typename CachediSCSIVolumesT = CachediSCSIVolume>
  DescribeCachediSCSIVolumesResult& AddCachediSCSIVolumes(CachediSCSIVolumesT&& value) {
    m_cachediSCSIVolumesHasBeenSet = true;
    m_cachediSCSIVolumes.emplace_back(std::forward<CachediSCSIVolumesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCachediSCSIVolumesResult& WithRequestId(RequestIdT&& value) {
