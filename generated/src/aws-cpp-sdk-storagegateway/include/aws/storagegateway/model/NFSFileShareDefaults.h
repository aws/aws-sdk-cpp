...
class NFSFileShareDefaults {
 public:
  ...
  void SetFileMode(FileModeT&& value) {
    m_fileModeHasBeenSet = true;
    m_fileMode = std::forward<FileModeT>(value);
  }
  template <typename FileModeT = Aws::String>
  NFSFileShareDefaults& WithFileMode(FileModeT&& value) {
    SetFileMode(std::forward<FileModeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDirectoryMode(DirectoryModeT&& value) {
    m_directoryModeHasBeenSet = true;
    m_directoryMode = std::forward<DirectoryModeT>(value);
  }
  template <typename DirectoryModeT = Aws::String>
  NFSFileShareDefaults& WithDirectoryMode(DirectoryModeT&& value) {
    SetDirectoryMode(std::forward<DirectoryModeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetGroupId(long long value) {
    m_groupIdHasBeenSet = true;
    m_groupId = value;
  }
  inline NFSFileShareDefaults& WithGroupId(long long value) {
    SetGroupId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOwnerId(long long value) {
    m_ownerIdHasBeenSet = true;
    m_ownerId = value;
  }
  inline NFSFileShareDefaults& WithOwnerId(long long value) {
    SetOwnerId(value);
    return *this;
  }
  ///@}
