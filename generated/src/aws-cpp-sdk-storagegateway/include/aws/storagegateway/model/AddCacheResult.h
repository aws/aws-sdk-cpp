...
namespace Model
{
  ...
  public:
    ...
    template<typename GatewayARNT = Aws::String>
    AddCacheResult& WithGatewayARN(GatewayARNT&& value) { SetGatewayARN(std::forward<GatewayARNT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AddCacheResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
