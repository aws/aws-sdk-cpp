...
namespace Model
{
  ...
  public:
    ...
    inline AddCacheResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AddCacheResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AddCacheResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
