...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DescribeGatewayInformationRequest : public StorageGatewayRequest
  {
  public:
    AWS_STORAGEGATEWAY_API DescribeGatewayInformationRequest() = default;
    ...
    template<typename GatewayARNT = Aws::String>
    DescribeGatewayInformationRequest& WithGatewayARN(GatewayARNT&& value) { SetGatewayARN(std::forward<GatewayARNT>(value)); return *this;}
    ///@}
  private:
