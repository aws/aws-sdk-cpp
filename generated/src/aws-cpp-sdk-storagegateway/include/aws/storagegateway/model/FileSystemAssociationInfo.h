...
class FileSystemAssociationInfo {
 public:
  ...
  void SetFileSystemAssociationStatus(FileSystemAssociationStatusT&& value) {
    ...
    m_fileSystemAssociationStatus = std::forward<FileSystemAssociationStatusT>(value);
  }
  template <typename FileSystemAssociationStatusT = Aws::String>
  FileSystemAssociationInfo& WithFileSystemAssociationStatus(FileSystemAssociationStatusT&& value) {
    SetFileSystemAssociationStatus(std::forward<FileSystemAssociationStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndpointNetworkConfiguration(EndpointNetworkConfigurationT&& value) {
    ...
    m_endpointNetworkConfiguration = std::forward<EndpointNetworkConfigurationT>(value);
  }
  template <typename EndpointNetworkConfigurationT = EndpointNetworkConfiguration>
  FileSystemAssociationInfo& WithEndpointNetworkConfiguration(EndpointNetworkConfigurationT&& value) {
    SetEndpointNetworkConfiguration(std::forward<EndpointNetworkConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<FileSystemAssociationStatusDetail>& GetFileSystemAssociationStatusDetails() const {
    return m_fileSystemAssociationStatusDetails;
  }
  ...
  void SetFileSystemAssociationStatusDetails(FileSystemAssociationStatusDetailsT&& value) {
    ...
    m_fileSystemAssociationStatusDetails = std::forward<FileSystemAssociationStatusDetailsT>(value);
  }
  template <typename FileSystemAssociationStatusDetailsT = Aws::Vector<FileSystemAssociationStatusDetail>>
  FileSystemAssociationInfo& WithFileSystemAssociationStatusDetails(FileSystemAssociationStatusDetailsT&& value) {
    SetFileSystemAssociationStatusDetails(std::forward<FileSystemAssociationStatusDetailsT>(value));
    return *this;
  }
  ...
  FileSystemAssociationInfo& AddFileSystemAssociationStatusDetails(FileSystemAssociationStatusDetailsT&& value) {
    m_fileSystemAssociationStatusDetailsHasBeenSet = true;
    m_fileSystemAssociationStatusDetails.emplace_back(std::forward<FileSystemAssociationStatusDetailsT>(value));
    return *this;
  }
  ///@}
 private:
