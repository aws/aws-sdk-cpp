...
class UpdateSMBLocalGroupsRequest : public StorageGatewayRequest {
 public:
  ...
  template <typename GatewayARNT = Aws::String>
  UpdateSMBLocalGroupsRequest& WithGatewayARN(GatewayARNT&& value) {
  ...
  void SetSMBLocalGroups(SMBLocalGroupsT&& value) {
    m_sMBLocalGroupsHasBeenSet = true;
    m_sMBLocalGroups = std::forward<SMBLocalGroupsT>(value);
  }
  template <typename SMBLocalGroupsT = SMBLocalGroups>
  UpdateSMBLocalGroupsRequest& WithSMBLocalGroups(SMBLocalGroupsT&& value) {
    SetSMBLocalGroups(std::forward<SMBLocalGroupsT>(value));
    return *this;
  }
  ///@}
 private:
