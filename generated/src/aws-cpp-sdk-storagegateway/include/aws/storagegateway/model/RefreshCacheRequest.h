...
class RefreshCacheRequest : public StorageGatewayRequest {
 public:
  ...
  inline RefreshCacheRequest& WithRecursive(bool value) {
    SetRecursive(value);
    return *this;
  }
  ///@}
