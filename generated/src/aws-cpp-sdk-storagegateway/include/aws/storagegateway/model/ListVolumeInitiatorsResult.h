...
class ListVolumeInitiatorsResult {
 public:
  ...
  void SetInitiators(InitiatorsT&& value) {
    m_initiatorsHasBeenSet = true;
    m_initiators = std::forward<InitiatorsT>(value);
  }
  template <typename InitiatorsT = Aws::Vector<Aws::String>>
  ListVolumeInitiatorsResult& WithInitiators(InitiatorsT&& value) {
    SetInitiators(std::forward<InitiatorsT>(value));
    return *this;
  }
  template <typename InitiatorsT = Aws::String>
  ListVolumeInitiatorsResult& AddInitiators(InitiatorsT&& value) {
    m_initiatorsHasBeenSet = true;
    m_initiators.emplace_back(std::forward<InitiatorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListVolumeInitiatorsResult& WithRequestId(RequestIdT&& value) {
