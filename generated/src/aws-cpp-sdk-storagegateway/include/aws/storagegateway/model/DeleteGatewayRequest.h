 ...
 * API Reference</a></p>
 */
class DeleteGatewayRequest : public StorageGatewayRequest {
 public:
  AWS_STORAGEGATEWAY_API DeleteGatewayRequest() = default;
  ...
  template <typename GatewayARNT = Aws::String>
  DeleteGatewayRequest& WithGatewayARN(GatewayARNT&& value) {
