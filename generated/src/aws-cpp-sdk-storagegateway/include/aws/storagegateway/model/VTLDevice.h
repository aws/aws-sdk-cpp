...
class VTLDevice {
 public:
  ...
  void SetVTLDeviceARN(VTLDeviceARNT&& value) {
    ...
    m_vTLDeviceARN = std::forward<VTLDeviceARNT>(value);
  }
  template <typename VTLDeviceARNT = Aws::String>
  VTLDevice& WithVTLDeviceARN(VTLDeviceARNT&& value) {
    SetVTLDeviceARN(std::forward<VTLDeviceARNT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVTLDeviceType(VTLDeviceTypeT&& value) {
    ...
    m_vTLDeviceType = std::forward<VTLDeviceTypeT>(value);
  }
  template <typename VTLDeviceTypeT = Aws::String>
  VTLDevice& WithVTLDeviceType(VTLDeviceTypeT&& value) {
    SetVTLDeviceType(std::forward<VTLDeviceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVTLDeviceVendor(VTLDeviceVendorT&& value) {
    ...
    m_vTLDeviceVendor = std::forward<VTLDeviceVendorT>(value);
  }
  template <typename VTLDeviceVendorT = Aws::String>
  VTLDevice& WithVTLDeviceVendor(VTLDeviceVendorT&& value) {
    SetVTLDeviceVendor(std::forward<VTLDeviceVendorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVTLDeviceProductIdentifier(VTLDeviceProductIdentifierT&& value) {
    ...
    m_vTLDeviceProductIdentifier = std::forward<VTLDeviceProductIdentifierT>(value);
  }
  template <typename VTLDeviceProductIdentifierT = Aws::String>
  VTLDevice& WithVTLDeviceProductIdentifier(VTLDeviceProductIdentifierT&& value) {
    SetVTLDeviceProductIdentifier(std::forward<VTLDeviceProductIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceiSCSIAttributes(DeviceiSCSIAttributesT&& value) {
    ...
    m_deviceiSCSIAttributes = std::forward<DeviceiSCSIAttributesT>(value);
  }
  template <typename DeviceiSCSIAttributesT = DeviceiSCSIAttributes>
  VTLDevice& WithDeviceiSCSIAttributes(DeviceiSCSIAttributesT&& value) {
    SetDeviceiSCSIAttributes(std::forward<DeviceiSCSIAttributesT>(value));
    return *this;
  }
  ///@}
 private:
