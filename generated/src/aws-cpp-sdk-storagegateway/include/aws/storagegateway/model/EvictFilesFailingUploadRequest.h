...
namespace Model
{
  ...
  {
  public:
    AWS_STORAGEGATEWAY_API EvictFilesFailingUploadRequest();
    ...
    inline EvictFilesFailingUploadRequest& WithFileShareARN(const Aws::String& value) { SetFileShareARN(value); return *this;}
    inline EvictFilesFailingUploadRequest& WithFileShareARN(Aws::String&& value) { SetFileShareARN(std::move(value)); return *this;}
    inline EvictFilesFailingUploadRequest& WithFileShareARN(const char* value) { SetFileShareARN(value); return *this;}
    ///@}
