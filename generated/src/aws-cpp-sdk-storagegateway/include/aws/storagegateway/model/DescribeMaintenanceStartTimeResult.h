...
class DescribeMaintenanceStartTimeResult {
 public:
  ...
  AWS_STORAGEGATEWAY_API DescribeMaintenanceStartTimeResult& operator=(
  ...
  inline DescribeMaintenanceStartTimeResult& WithHourOfDay(int value) {
    SetHourOfDay(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeMaintenanceStartTimeResult& WithMinuteOfHour(int value) {
  ...
  inline DescribeMaintenanceStartTimeResult& WithDayOfWeek(int value) {
    SetDayOfWeek(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeMaintenanceStartTimeResult& WithDayOfMonth(int value) {
    SetDayOfMonth(value);
    return *this;
  }
  ///@}
