...
class ListTapePoolsResult {
 public:
  ...
  void SetPoolInfos(PoolInfosT&& value) {
    m_poolInfosHasBeenSet = true;
    m_poolInfos = std::forward<PoolInfosT>(value);
  }
  template <typename PoolInfosT = Aws::Vector<PoolInfo>>
  ListTapePoolsResult& WithPoolInfos(PoolInfosT&& value) {
    SetPoolInfos(std::forward<PoolInfosT>(value));
    return *this;
  }
  template <typename PoolInfosT = PoolInfo>
  ListTapePoolsResult& AddPoolInfos(PoolInfosT&& value) {
    m_poolInfosHasBeenSet = true;
    m_poolInfos.emplace_back(std::forward<PoolInfosT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListTapePoolsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTapePoolsResult& WithRequestId(RequestIdT&& value) {
