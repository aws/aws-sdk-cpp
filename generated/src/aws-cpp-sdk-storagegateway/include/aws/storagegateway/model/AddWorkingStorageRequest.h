...
namespace Model
{
  ...
  {
  public:
    AWS_STORAGEGATEWAY_API AddWorkingStorageRequest() = default;
    ...
    template<typename GatewayARNT = Aws::String>
    AddWorkingStorageRequest& WithGatewayARN(GatewayARNT&& value) { SetGatewayARN(std::forward<GatewayARNT>(value)); return *this;}
    ///@}
    ...
    template<typename DiskIdsT = Aws::Vector<Aws::String>>
    AddWorkingStorageRequest& WithDiskIds(DiskIdsT&& value) { SetDiskIds(std::forward<DiskIdsT>(value)); return *this;}
    template<typename DiskIdsT = Aws::String>
    AddWorkingStorageRequest& AddDiskIds(DiskIdsT&& value) { m_diskIdsHasBeenSet = true; m_diskIds.emplace_back(std::forward<DiskIdsT>(value)); return *this; }
    ///@}
  private:
