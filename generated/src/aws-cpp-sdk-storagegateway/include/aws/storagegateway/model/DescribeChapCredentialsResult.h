...
class DescribeChapCredentialsResult {
 public:
  ...
  void SetChapCredentials(ChapCredentialsT&& value) {
    m_chapCredentialsHasBeenSet = true;
    m_chapCredentials = std::forward<ChapCredentialsT>(value);
  }
  template <typename ChapCredentialsT = Aws::Vector<ChapInfo>>
  DescribeChapCredentialsResult& WithChapCredentials(ChapCredentialsT&& value) {
    SetChapCredentials(std::forward<ChapCredentialsT>(value));
    return *this;
  }
  template <typename ChapCredentialsT = ChapInfo>
  DescribeChapCredentialsResult& AddChapCredentials(ChapCredentialsT&& value) {
    m_chapCredentialsHasBeenSet = true;
    m_chapCredentials.emplace_back(std::forward<ChapCredentialsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeChapCredentialsResult& WithRequestId(RequestIdT&& value) {
