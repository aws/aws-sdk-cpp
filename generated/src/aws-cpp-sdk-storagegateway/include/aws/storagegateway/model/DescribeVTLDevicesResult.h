...
class DescribeVTLDevicesResult {
 public:
  ...
  template <typename GatewayARNT = Aws::String>
  DescribeVTLDevicesResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  void SetVTLDevices(VTLDevicesT&& value) {
    m_vTLDevicesHasBeenSet = true;
    m_vTLDevices = std::forward<VTLDevicesT>(value);
  }
  template <typename VTLDevicesT = Aws::Vector<VTLDevice>>
  DescribeVTLDevicesResult& WithVTLDevices(VTLDevicesT&& value) {
    SetVTLDevices(std::forward<VTLDevicesT>(value));
    return *this;
  }
  template <typename VTLDevicesT = VTLDevice>
  DescribeVTLDevicesResult& AddVTLDevices(VTLDevicesT&& value) {
    m_vTLDevicesHasBeenSet = true;
    m_vTLDevices.emplace_back(std::forward<VTLDevicesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeVTLDevicesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeVTLDevicesResult& WithRequestId(RequestIdT&& value) {
