...
class DescribeSMBFileSharesResult {
 public:
  ...
  void SetSMBFileShareInfoList(SMBFileShareInfoListT&& value) {
    m_sMBFileShareInfoListHasBeenSet = true;
    m_sMBFileShareInfoList = std::forward<SMBFileShareInfoListT>(value);
  }
  template <typename SMBFileShareInfoListT = Aws::Vector<SMBFileShareInfo>>
  DescribeSMBFileSharesResult& WithSMBFileShareInfoList(SMBFileShareInfoListT&& value) {
    SetSMBFileShareInfoList(std::forward<SMBFileShareInfoListT>(value));
    return *this;
  }
  template <typename SMBFileShareInfoListT = SMBFileShareInfo>
  DescribeSMBFileSharesResult& AddSMBFileShareInfoList(SMBFileShareInfoListT&& value) {
    m_sMBFileShareInfoListHasBeenSet = true;
    m_sMBFileShareInfoList.emplace_back(std::forward<SMBFileShareInfoListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSMBFileSharesResult& WithRequestId(RequestIdT&& value) {
