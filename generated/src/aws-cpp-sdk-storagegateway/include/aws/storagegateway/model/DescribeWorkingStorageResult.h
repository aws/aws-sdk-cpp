...
class DescribeWorkingStorageResult {
 public:
  ...
  template <typename GatewayARNT = Aws::String>
  DescribeWorkingStorageResult& WithGatewayARN(GatewayARNT&& value) {
  ...
  template <typename DiskIdsT = Aws::Vector<Aws::String>>
  DescribeWorkingStorageResult& WithDiskIds(DiskIdsT&& value) {
    SetDiskIds(std::forward<DiskIdsT>(value));
    return *this;
  }
  template <typename DiskIdsT = Aws::String>
  DescribeWorkingStorageResult& AddDiskIds(DiskIdsT&& value) {
    m_diskIdsHasBeenSet = true;
  ...
  inline void SetWorkingStorageUsedInBytes(long long value) {
    m_workingStorageUsedInBytesHasBeenSet = true;
    m_workingStorageUsedInBytes = value;
  }
  inline DescribeWorkingStorageResult& WithWorkingStorageUsedInBytes(long long value) {
    SetWorkingStorageUsedInBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWorkingStorageAllocatedInBytes(long long value) {
    m_workingStorageAllocatedInBytesHasBeenSet = true;
    m_workingStorageAllocatedInBytes = value;
  }
  inline DescribeWorkingStorageResult& WithWorkingStorageAllocatedInBytes(long long value) {
    SetWorkingStorageAllocatedInBytes(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWorkingStorageResult& WithRequestId(RequestIdT&& value) {
