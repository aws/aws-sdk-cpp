...
class AWS_STORAGEGATEWAY_API StorageGatewayClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  StorageGatewayClient(const Aws::StorageGateway::StorageGatewayClientConfiguration& clientConfiguration =
  ...
  StorageGatewayClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<StorageGatewayEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::StorageGateway::StorageGatewayClientConfiguration& clientConfiguration =
                           Aws::StorageGateway::StorageGatewayClientConfiguration());
  ...
  /**
   * An Async wrapper for ActivateGateway that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ActivateGatewayRequestT = Model::ActivateGatewayRequest>
  void ActivateGatewayAsync(const ActivateGatewayRequestT& request, const ActivateGatewayResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for AddCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddCacheRequestT = Model::AddCacheRequest>
  void AddCacheAsync(const AddCacheRequestT& request, const AddCacheResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AddUploadBuffer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddUploadBufferRequestT = Model::AddUploadBufferRequest>
  void AddUploadBufferAsync(const AddUploadBufferRequestT& request, const AddUploadBufferResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AddWorkingStorage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddWorkingStorage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AddWorkingStorageRequestT = Model::AddWorkingStorageRequest>
  void AddWorkingStorageAsync(const AddWorkingStorageRequestT& request, const AddWorkingStorageResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AssignTapePool that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssignTapePoolRequestT = Model::AssignTapePoolRequest>
  void AssignTapePoolAsync(const AssignTapePoolRequestT& request, const AssignTapePoolResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateFileSystem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateFileSystem that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociateFileSystemRequestT = Model::AssociateFileSystemRequest>
  void AssociateFileSystemAsync(const AssociateFileSystemRequestT& request, const AssociateFileSystemResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AttachVolume that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AttachVolumeRequestT = Model::AttachVolumeRequest>
  void AttachVolumeAsync(const AttachVolumeRequestT& request, const AttachVolumeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CancelArchival that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelArchivalRequestT = Model::CancelArchivalRequest>
  void CancelArchivalAsync(const CancelArchivalRequestT& request, const CancelArchivalResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelCacheReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelCacheReport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelCacheReportRequestT = Model::CancelCacheReportRequest>
  void CancelCacheReportAsync(const CancelCacheReportRequestT& request, const CancelCacheReportResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CancelRetrieval that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelRetrievalRequestT = Model::CancelRetrievalRequest>
  void CancelRetrievalAsync(const CancelRetrievalRequestT& request, const CancelRetrievalResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCachediSCSIVolume that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCachediSCSIVolume that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCachediSCSIVolumeRequestT = Model::CreateCachediSCSIVolumeRequest>
  void CreateCachediSCSIVolumeAsync(const CreateCachediSCSIVolumeRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateNFSFileShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateNFSFileShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateNFSFileShareRequestT = Model::CreateNFSFileShareRequest>
  void CreateNFSFileShareAsync(const CreateNFSFileShareRequestT& request, const CreateNFSFileShareResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSMBFileShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSMBFileShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateSMBFileShareRequestT = Model::CreateSMBFileShareRequest>
  void CreateSMBFileShareAsync(const CreateSMBFileShareRequestT& request, const CreateSMBFileShareResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CreateSnapshotFromVolumeRecoveryPointOutcome CreateSnapshotFromVolumeRecoveryPoint(
      const Model::CreateSnapshotFromVolumeRecoveryPointRequest& request) const;

  /**
   * A Callable wrapper for CreateSnapshotFromVolumeRecoveryPoint that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateSnapshotFromVolumeRecoveryPointRequestT = Model::CreateSnapshotFromVolumeRecoveryPointRequest>
  Model::CreateSnapshotFromVolumeRecoveryPointOutcomeCallable CreateSnapshotFromVolumeRecoveryPointCallable(
      const CreateSnapshotFromVolumeRecoveryPointRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::CreateSnapshotFromVolumeRecoveryPoint, request);
  }

  /**
   * An Async wrapper for CreateSnapshotFromVolumeRecoveryPoint that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateSnapshotFromVolumeRecoveryPointRequestT = Model::CreateSnapshotFromVolumeRecoveryPointRequest>
  void CreateSnapshotFromVolumeRecoveryPointAsync(const CreateSnapshotFromVolumeRecoveryPointRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateStorediSCSIVolume that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStorediSCSIVolume that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStorediSCSIVolumeRequestT = Model::CreateStorediSCSIVolumeRequest>
  void CreateStorediSCSIVolumeAsync(const CreateStorediSCSIVolumeRequestT& request,
  ...
  /**
   * An Async wrapper for CreateTapePool that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateTapePoolRequestT = Model::CreateTapePoolRequest>
  void CreateTapePoolAsync(const CreateTapePoolRequestT& request, const CreateTapePoolResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTapeWithBarcode that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTapeWithBarcode that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTapeWithBarcodeRequestT = Model::CreateTapeWithBarcodeRequest>
  void CreateTapeWithBarcodeAsync(const CreateTapeWithBarcodeRequestT& request, const CreateTapeWithBarcodeResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateTapes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateTapesRequestT = Model::CreateTapesRequest>
  void CreateTapesAsync(const CreateTapesRequestT& request, const CreateTapesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteAutomaticTapeCreationPolicyOutcome DeleteAutomaticTapeCreationPolicy(
      const Model::DeleteAutomaticTapeCreationPolicyRequest& request) const;

  /**
   * A Callable wrapper for DeleteAutomaticTapeCreationPolicy that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteAutomaticTapeCreationPolicyRequestT = Model::DeleteAutomaticTapeCreationPolicyRequest>
  Model::DeleteAutomaticTapeCreationPolicyOutcomeCallable DeleteAutomaticTapeCreationPolicyCallable(
      const DeleteAutomaticTapeCreationPolicyRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::DeleteAutomaticTapeCreationPolicy, request);
  }

  /**
   * An Async wrapper for DeleteAutomaticTapeCreationPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteAutomaticTapeCreationPolicyRequestT = Model::DeleteAutomaticTapeCreationPolicyRequest>
  void DeleteAutomaticTapeCreationPolicyAsync(const DeleteAutomaticTapeCreationPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteBandwidthRateLimit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBandwidthRateLimit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBandwidthRateLimitRequestT = Model::DeleteBandwidthRateLimitRequest>
  void DeleteBandwidthRateLimitAsync(const DeleteBandwidthRateLimitRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteCacheReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCacheReport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteCacheReportRequestT = Model::DeleteCacheReportRequest>
  void DeleteCacheReportAsync(const DeleteCacheReportRequestT& request, const DeleteCacheReportResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteChapCredentials that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteChapCredentials that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteChapCredentialsRequestT = Model::DeleteChapCredentialsRequest>
  void DeleteChapCredentialsAsync(const DeleteChapCredentialsRequestT& request, const DeleteChapCredentialsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFileShare that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFileShareRequestT = Model::DeleteFileShareRequest>
  void DeleteFileShareAsync(const DeleteFileShareRequestT& request, const DeleteFileShareResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteTape that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTapeRequestT = Model::DeleteTapeRequest>
  void DeleteTapeAsync(const DeleteTapeRequestT& request, const DeleteTapeResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTapeArchive that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTapeArchive that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteTapeArchiveRequestT = Model::DeleteTapeArchiveRequest>
  void DeleteTapeArchiveAsync(const DeleteTapeArchiveRequestT& request, const DeleteTapeArchiveResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteTapePool that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTapePoolRequestT = Model::DeleteTapePoolRequest>
  void DeleteTapePoolAsync(const DeleteTapePoolRequestT& request, const DeleteTapePoolResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAvailabilityMonitorTestOutcome DescribeAvailabilityMonitorTest(
      const Model::DescribeAvailabilityMonitorTestRequest& request) const;

  /**
   * A Callable wrapper for DescribeAvailabilityMonitorTest that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAvailabilityMonitorTestRequestT = Model::DescribeAvailabilityMonitorTestRequest>
  Model::DescribeAvailabilityMonitorTestOutcomeCallable DescribeAvailabilityMonitorTestCallable(
      const DescribeAvailabilityMonitorTestRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::DescribeAvailabilityMonitorTest, request);
  }

  /**
   * An Async wrapper for DescribeAvailabilityMonitorTest that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAvailabilityMonitorTestRequestT = Model::DescribeAvailabilityMonitorTestRequest>
  void DescribeAvailabilityMonitorTestAsync(const DescribeAvailabilityMonitorTestRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeBandwidthRateLimitOutcome DescribeBandwidthRateLimit(
      const Model::DescribeBandwidthRateLimitRequest& request) const;

  /**
   * A Callable wrapper for DescribeBandwidthRateLimit that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeBandwidthRateLimitRequestT = Model::DescribeBandwidthRateLimitRequest>
  Model::DescribeBandwidthRateLimitOutcomeCallable DescribeBandwidthRateLimitCallable(
      const DescribeBandwidthRateLimitRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::DescribeBandwidthRateLimit, request);
  }

  /**
   * An Async wrapper for DescribeBandwidthRateLimit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBandwidthRateLimitRequestT = Model::DescribeBandwidthRateLimitRequest>
  void DescribeBandwidthRateLimitAsync(const DescribeBandwidthRateLimitRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeBandwidthRateLimitScheduleOutcome DescribeBandwidthRateLimitSchedule(
      const Model::DescribeBandwidthRateLimitScheduleRequest& request) const;

  /**
   * A Callable wrapper for DescribeBandwidthRateLimitSchedule that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeBandwidthRateLimitScheduleRequestT = Model::DescribeBandwidthRateLimitScheduleRequest>
  Model::DescribeBandwidthRateLimitScheduleOutcomeCallable DescribeBandwidthRateLimitScheduleCallable(
      const DescribeBandwidthRateLimitScheduleRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::DescribeBandwidthRateLimitSchedule, request);
  }

  /**
   * An Async wrapper for DescribeBandwidthRateLimitSchedule that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeBandwidthRateLimitScheduleRequestT = Model::DescribeBandwidthRateLimitScheduleRequest>
  void DescribeBandwidthRateLimitScheduleAsync(const DescribeBandwidthRateLimitScheduleRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeCacheRequestT = Model::DescribeCacheRequest>
  void DescribeCacheAsync(const DescribeCacheRequestT& request, const DescribeCacheResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeCacheReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCacheReport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeCacheReportRequestT = Model::DescribeCacheReportRequest>
  void DescribeCacheReportAsync(const DescribeCacheReportRequestT& request, const DescribeCacheReportResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeCachediSCSIVolumesOutcome DescribeCachediSCSIVolumes(
      const Model::DescribeCachediSCSIVolumesRequest& request) const;

  /**
   * A Callable wrapper for DescribeCachediSCSIVolumes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCachediSCSIVolumesRequestT = Model::DescribeCachediSCSIVolumesRequest>
  Model::DescribeCachediSCSIVolumesOutcomeCallable DescribeCachediSCSIVolumesCallable(
      const DescribeCachediSCSIVolumesRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::DescribeCachediSCSIVolumes, request);
  }

  /**
   * An Async wrapper for DescribeCachediSCSIVolumes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCachediSCSIVolumesRequestT = Model::DescribeCachediSCSIVolumesRequest>
  void DescribeCachediSCSIVolumesAsync(const DescribeCachediSCSIVolumesRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeChapCredentials that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeChapCredentials that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeChapCredentialsRequestT = Model::DescribeChapCredentialsRequest>
  void DescribeChapCredentialsAsync(const DescribeChapCredentialsRequestT& request,
  ...
  virtual Model::DescribeFileSystemAssociationsOutcome DescribeFileSystemAssociations(
      const Model::DescribeFileSystemAssociationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeFileSystemAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeFileSystemAssociationsRequestT = Model::DescribeFileSystemAssociationsRequest>
  Model::DescribeFileSystemAssociationsOutcomeCallable DescribeFileSystemAssociationsCallable(
      const DescribeFileSystemAssociationsRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::DescribeFileSystemAssociations, request);
  }

  /**
   * An Async wrapper for DescribeFileSystemAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeFileSystemAssociationsRequestT = Model::DescribeFileSystemAssociationsRequest>
  void DescribeFileSystemAssociationsAsync(const DescribeFileSystemAssociationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeGatewayInformationOutcome DescribeGatewayInformation(
      const Model::DescribeGatewayInformationRequest& request) const;

  /**
   * A Callable wrapper for DescribeGatewayInformation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeGatewayInformationRequestT = Model::DescribeGatewayInformationRequest>
  Model::DescribeGatewayInformationOutcomeCallable DescribeGatewayInformationCallable(
      const DescribeGatewayInformationRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::DescribeGatewayInformation, request);
  }

  /**
   * An Async wrapper for DescribeGatewayInformation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeGatewayInformationRequestT = Model::DescribeGatewayInformationRequest>
  void DescribeGatewayInformationAsync(const DescribeGatewayInformationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMaintenanceStartTimeOutcome DescribeMaintenanceStartTime(
      const Model::DescribeMaintenanceStartTimeRequest& request) const;

  /**
   * A Callable wrapper for DescribeMaintenanceStartTime that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeMaintenanceStartTimeRequestT = Model::DescribeMaintenanceStartTimeRequest>
  Model::DescribeMaintenanceStartTimeOutcomeCallable DescribeMaintenanceStartTimeCallable(
      const DescribeMaintenanceStartTimeRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::DescribeMaintenanceStartTime, request);
  }

  /**
   * An Async wrapper for DescribeMaintenanceStartTime that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMaintenanceStartTimeRequestT = Model::DescribeMaintenanceStartTimeRequest>
  void DescribeMaintenanceStartTimeAsync(const DescribeMaintenanceStartTimeRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeNFSFileShares that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeNFSFileShares that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeNFSFileSharesRequestT = Model::DescribeNFSFileSharesRequest>
  void DescribeNFSFileSharesAsync(const DescribeNFSFileSharesRequestT& request, const DescribeNFSFileSharesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSMBFileShares that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSMBFileShares that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSMBFileSharesRequestT = Model::DescribeSMBFileSharesRequest>
  void DescribeSMBFileSharesAsync(const DescribeSMBFileSharesRequestT& request, const DescribeSMBFileSharesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSMBSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSMBSettings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSMBSettingsRequestT = Model::DescribeSMBSettingsRequest>
  void DescribeSMBSettingsAsync(const DescribeSMBSettingsRequestT& request, const DescribeSMBSettingsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSnapshotSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSnapshotSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSnapshotScheduleRequestT = Model::DescribeSnapshotScheduleRequest>
  void DescribeSnapshotScheduleAsync(const DescribeSnapshotScheduleRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeStorediSCSIVolumesOutcome DescribeStorediSCSIVolumes(
      const Model::DescribeStorediSCSIVolumesRequest& request) const;

  /**
   * A Callable wrapper for DescribeStorediSCSIVolumes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeStorediSCSIVolumesRequestT = Model::DescribeStorediSCSIVolumesRequest>
  Model::DescribeStorediSCSIVolumesOutcomeCallable DescribeStorediSCSIVolumesCallable(
      const DescribeStorediSCSIVolumesRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::DescribeStorediSCSIVolumes, request);
  }

  /**
   * An Async wrapper for DescribeStorediSCSIVolumes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStorediSCSIVolumesRequestT = Model::DescribeStorediSCSIVolumesRequest>
  void DescribeStorediSCSIVolumesAsync(const DescribeStorediSCSIVolumesRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeTapeArchives that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTapeArchives that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTapeArchivesRequestT = Model::DescribeTapeArchivesRequest>
  void DescribeTapeArchivesAsync(const DescribeTapeArchivesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeTapeArchivesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTapeRecoveryPointsOutcome DescribeTapeRecoveryPoints(
      const Model::DescribeTapeRecoveryPointsRequest& request) const;

  /**
   * A Callable wrapper for DescribeTapeRecoveryPoints that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeTapeRecoveryPointsRequestT = Model::DescribeTapeRecoveryPointsRequest>
  Model::DescribeTapeRecoveryPointsOutcomeCallable DescribeTapeRecoveryPointsCallable(
      const DescribeTapeRecoveryPointsRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::DescribeTapeRecoveryPoints, request);
  }

  /**
   * An Async wrapper for DescribeTapeRecoveryPoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTapeRecoveryPointsRequestT = Model::DescribeTapeRecoveryPointsRequest>
  void DescribeTapeRecoveryPointsAsync(const DescribeTapeRecoveryPointsRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeTapes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeTapesRequestT = Model::DescribeTapesRequest>
  void DescribeTapesAsync(const DescribeTapesRequestT& request, const DescribeTapesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeUploadBuffer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeUploadBuffer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeUploadBufferRequestT = Model::DescribeUploadBufferRequest>
  void DescribeUploadBufferAsync(const DescribeUploadBufferRequestT& request, const DescribeUploadBufferResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeVTLDevices that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeVTLDevices that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeVTLDevicesRequestT = Model::DescribeVTLDevicesRequest>
  void DescribeVTLDevicesAsync(const DescribeVTLDevicesRequestT& request, const DescribeVTLDevicesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWorkingStorage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWorkingStorage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorkingStorageRequestT = Model::DescribeWorkingStorageRequest>
  void DescribeWorkingStorageAsync(const DescribeWorkingStorageRequestT& request,
  ...
  /**
   * An Async wrapper for DetachVolume that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetachVolumeRequestT = Model::DetachVolumeRequest>
  void DetachVolumeAsync(const DetachVolumeRequestT& request, const DetachVolumeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DisableGateway that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableGatewayRequestT = Model::DisableGatewayRequest>
  void DisableGatewayAsync(const DisableGatewayRequestT& request, const DisableGatewayResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateFileSystem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateFileSystem that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateFileSystemRequestT = Model::DisassociateFileSystemRequest>
  void DisassociateFileSystemAsync(const DisassociateFileSystemRequestT& request,
  ...
  /**
   * A Callable wrapper for EvictFilesFailingUpload that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EvictFilesFailingUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EvictFilesFailingUploadRequestT = Model::EvictFilesFailingUploadRequest>
  void EvictFilesFailingUploadAsync(const EvictFilesFailingUploadRequestT& request,
                                    const EvictFilesFailingUploadResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for JoinDomain that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename JoinDomainRequestT = Model::JoinDomainRequest>
  void JoinDomainAsync(const JoinDomainRequestT& request, const JoinDomainResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAutomaticTapeCreationPoliciesOutcome ListAutomaticTapeCreationPolicies(
      const Model::ListAutomaticTapeCreationPoliciesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAutomaticTapeCreationPolicies that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListAutomaticTapeCreationPoliciesRequestT = Model::ListAutomaticTapeCreationPoliciesRequest>
  Model::ListAutomaticTapeCreationPoliciesOutcomeCallable ListAutomaticTapeCreationPoliciesCallable(
      const ListAutomaticTapeCreationPoliciesRequestT& request = {}) const {
    return SubmitCallable(&StorageGatewayClient::ListAutomaticTapeCreationPolicies, request);
  }

  /**
   * An Async wrapper for ListAutomaticTapeCreationPolicies that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAutomaticTapeCreationPoliciesRequestT = Model::ListAutomaticTapeCreationPoliciesRequest>
  void ListAutomaticTapeCreationPoliciesAsync(const ListAutomaticTapeCreationPoliciesResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const ListAutomaticTapeCreationPoliciesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCacheReports that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCacheReports that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCacheReportsRequestT = Model::ListCacheReportsRequest>
  void ListCacheReportsAsync(const ListCacheReportsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListCacheReportsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListFileShares that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFileSharesRequestT = Model::ListFileSharesRequest>
  void ListFileSharesAsync(const ListFileSharesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListFileSharesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListFileSystemAssociationsOutcome ListFileSystemAssociations(
      const Model::ListFileSystemAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListFileSystemAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListFileSystemAssociationsRequestT = Model::ListFileSystemAssociationsRequest>
  Model::ListFileSystemAssociationsOutcomeCallable ListFileSystemAssociationsCallable(
      const ListFileSystemAssociationsRequestT& request = {}) const {
    return SubmitCallable(&StorageGatewayClient::ListFileSystemAssociations, request);
  }

  /**
   * An Async wrapper for ListFileSystemAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFileSystemAssociationsRequestT = Model::ListFileSystemAssociationsRequest>
  void ListFileSystemAssociationsAsync(const ListFileSystemAssociationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListFileSystemAssociationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListLocalDisks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLocalDisksRequestT = Model::ListLocalDisksRequest>
  void ListLocalDisksAsync(const ListLocalDisksRequestT& request, const ListLocalDisksResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListTapePools that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListTapePoolsRequestT = Model::ListTapePoolsRequest>
  void ListTapePoolsAsync(const ListTapePoolsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListTapePoolsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListTapes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListTapesRequestT = Model::ListTapesRequest>
  void ListTapesAsync(const ListTapesResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListTapesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListVolumeInitiators that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListVolumeInitiators that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVolumeInitiatorsRequestT = Model::ListVolumeInitiatorsRequest>
  void ListVolumeInitiatorsAsync(const ListVolumeInitiatorsRequestT& request, const ListVolumeInitiatorsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListVolumeRecoveryPoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListVolumeRecoveryPoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVolumeRecoveryPointsRequestT = Model::ListVolumeRecoveryPointsRequest>
  void ListVolumeRecoveryPointsAsync(const ListVolumeRecoveryPointsRequestT& request,
   ...
   */
  template <typename ListVolumesRequestT = Model::ListVolumesRequest>
  void ListVolumesAsync(const ListVolumesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListVolumesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for NotifyWhenUploaded that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for NotifyWhenUploaded that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename NotifyWhenUploadedRequestT = Model::NotifyWhenUploadedRequest>
  void NotifyWhenUploadedAsync(const NotifyWhenUploadedRequestT& request, const NotifyWhenUploadedResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RefreshCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RefreshCacheRequestT = Model::RefreshCacheRequest>
  void RefreshCacheAsync(const RefreshCacheRequestT& request, const RefreshCacheResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ResetCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResetCacheRequestT = Model::ResetCacheRequest>
  void ResetCacheAsync(const ResetCacheRequestT& request, const ResetCacheResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RetrieveTapeArchive that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RetrieveTapeArchive that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RetrieveTapeArchiveRequestT = Model::RetrieveTapeArchiveRequest>
  void RetrieveTapeArchiveAsync(const RetrieveTapeArchiveRequestT& request, const RetrieveTapeArchiveResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RetrieveTapeRecoveryPoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RetrieveTapeRecoveryPointRequestT = Model::RetrieveTapeRecoveryPointRequest>
  Model::RetrieveTapeRecoveryPointOutcomeCallable RetrieveTapeRecoveryPointCallable(
      const RetrieveTapeRecoveryPointRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::RetrieveTapeRecoveryPoint, request);
  }

  /**
   * An Async wrapper for RetrieveTapeRecoveryPoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RetrieveTapeRecoveryPointRequestT = Model::RetrieveTapeRecoveryPointRequest>
  void RetrieveTapeRecoveryPointAsync(const RetrieveTapeRecoveryPointRequestT& request,
  ...
  /**
   * A Callable wrapper for SetLocalConsolePassword that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetLocalConsolePassword that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetLocalConsolePasswordRequestT = Model::SetLocalConsolePasswordRequest>
  void SetLocalConsolePasswordAsync(const SetLocalConsolePasswordRequestT& request,
  ...
  /**
   * A Callable wrapper for SetSMBGuestPassword that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetSMBGuestPassword that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetSMBGuestPasswordRequestT = Model::SetSMBGuestPasswordRequest>
  void SetSMBGuestPasswordAsync(const SetSMBGuestPasswordRequestT& request, const SetSMBGuestPasswordResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ShutdownGateway that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ShutdownGatewayRequestT = Model::ShutdownGatewayRequest>
  void ShutdownGatewayAsync(const ShutdownGatewayRequestT& request, const ShutdownGatewayResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartAvailabilityMonitorTestOutcome StartAvailabilityMonitorTest(
      const Model::StartAvailabilityMonitorTestRequest& request) const;

  /**
   * A Callable wrapper for StartAvailabilityMonitorTest that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartAvailabilityMonitorTestRequestT = Model::StartAvailabilityMonitorTestRequest>
  Model::StartAvailabilityMonitorTestOutcomeCallable StartAvailabilityMonitorTestCallable(
      const StartAvailabilityMonitorTestRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::StartAvailabilityMonitorTest, request);
  }

  /**
   * An Async wrapper for StartAvailabilityMonitorTest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartAvailabilityMonitorTestRequestT = Model::StartAvailabilityMonitorTestRequest>
  void StartAvailabilityMonitorTestAsync(const StartAvailabilityMonitorTestRequestT& request,
  ...
  /**
   * A Callable wrapper for StartCacheReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartCacheReport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartCacheReportRequestT = Model::StartCacheReportRequest>
  void StartCacheReportAsync(const StartCacheReportRequestT& request, const StartCacheReportResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartGateway that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartGatewayRequestT = Model::StartGatewayRequest>
  void StartGatewayAsync(const StartGatewayRequestT& request, const StartGatewayResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAutomaticTapeCreationPolicyOutcome UpdateAutomaticTapeCreationPolicy(
      const Model::UpdateAutomaticTapeCreationPolicyRequest& request) const;

  /**
   * A Callable wrapper for UpdateAutomaticTapeCreationPolicy that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateAutomaticTapeCreationPolicyRequestT = Model::UpdateAutomaticTapeCreationPolicyRequest>
  Model::UpdateAutomaticTapeCreationPolicyOutcomeCallable UpdateAutomaticTapeCreationPolicyCallable(
      const UpdateAutomaticTapeCreationPolicyRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::UpdateAutomaticTapeCreationPolicy, request);
  }

  /**
   * An Async wrapper for UpdateAutomaticTapeCreationPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateAutomaticTapeCreationPolicyRequestT = Model::UpdateAutomaticTapeCreationPolicyRequest>
  void UpdateAutomaticTapeCreationPolicyAsync(const UpdateAutomaticTapeCreationPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateBandwidthRateLimit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBandwidthRateLimit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateBandwidthRateLimitRequestT = Model::UpdateBandwidthRateLimitRequest>
  void UpdateBandwidthRateLimitAsync(const UpdateBandwidthRateLimitRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateBandwidthRateLimitScheduleOutcome UpdateBandwidthRateLimitSchedule(
      const Model::UpdateBandwidthRateLimitScheduleRequest& request) const;

  /**
   * A Callable wrapper for UpdateBandwidthRateLimitSchedule that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateBandwidthRateLimitScheduleRequestT = Model::UpdateBandwidthRateLimitScheduleRequest>
  Model::UpdateBandwidthRateLimitScheduleOutcomeCallable UpdateBandwidthRateLimitScheduleCallable(
      const UpdateBandwidthRateLimitScheduleRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::UpdateBandwidthRateLimitSchedule, request);
  }

  /**
   * An Async wrapper for UpdateBandwidthRateLimitSchedule that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateBandwidthRateLimitScheduleRequestT = Model::UpdateBandwidthRateLimitScheduleRequest>
  void UpdateBandwidthRateLimitScheduleAsync(const UpdateBandwidthRateLimitScheduleRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateChapCredentials that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateChapCredentials that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateChapCredentialsRequestT = Model::UpdateChapCredentialsRequest>
  void UpdateChapCredentialsAsync(const UpdateChapCredentialsRequestT& request, const UpdateChapCredentialsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateFileSystemAssociationOutcome UpdateFileSystemAssociation(
      const Model::UpdateFileSystemAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateFileSystemAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateFileSystemAssociationRequestT = Model::UpdateFileSystemAssociationRequest>
  Model::UpdateFileSystemAssociationOutcomeCallable UpdateFileSystemAssociationCallable(
      const UpdateFileSystemAssociationRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::UpdateFileSystemAssociation, request);
  }

  /**
   * An Async wrapper for UpdateFileSystemAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFileSystemAssociationRequestT = Model::UpdateFileSystemAssociationRequest>
  void UpdateFileSystemAssociationAsync(const UpdateFileSystemAssociationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateMaintenanceStartTimeOutcome UpdateMaintenanceStartTime(
      const Model::UpdateMaintenanceStartTimeRequest& request) const;

  /**
   * A Callable wrapper for UpdateMaintenanceStartTime that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateMaintenanceStartTimeRequestT = Model::UpdateMaintenanceStartTimeRequest>
  Model::UpdateMaintenanceStartTimeOutcomeCallable UpdateMaintenanceStartTimeCallable(
      const UpdateMaintenanceStartTimeRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::UpdateMaintenanceStartTime, request);
  }

  /**
   * An Async wrapper for UpdateMaintenanceStartTime that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMaintenanceStartTimeRequestT = Model::UpdateMaintenanceStartTimeRequest>
  void UpdateMaintenanceStartTimeAsync(const UpdateMaintenanceStartTimeRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateNFSFileShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateNFSFileShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateNFSFileShareRequestT = Model::UpdateNFSFileShareRequest>
  void UpdateNFSFileShareAsync(const UpdateNFSFileShareRequestT& request, const UpdateNFSFileShareResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSMBFileShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSMBFileShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateSMBFileShareRequestT = Model::UpdateSMBFileShareRequest>
  void UpdateSMBFileShareAsync(const UpdateSMBFileShareRequestT& request, const UpdateSMBFileShareResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateSMBFileShareVisibilityOutcome UpdateSMBFileShareVisibility(
      const Model::UpdateSMBFileShareVisibilityRequest& request) const;

  /**
   * A Callable wrapper for UpdateSMBFileShareVisibility that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateSMBFileShareVisibilityRequestT = Model::UpdateSMBFileShareVisibilityRequest>
  Model::UpdateSMBFileShareVisibilityOutcomeCallable UpdateSMBFileShareVisibilityCallable(
      const UpdateSMBFileShareVisibilityRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::UpdateSMBFileShareVisibility, request);
  }

  /**
   * An Async wrapper for UpdateSMBFileShareVisibility that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSMBFileShareVisibilityRequestT = Model::UpdateSMBFileShareVisibilityRequest>
  void UpdateSMBFileShareVisibilityAsync(const UpdateSMBFileShareVisibilityRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateSMBLocalGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSMBLocalGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSMBLocalGroupsRequestT = Model::UpdateSMBLocalGroupsRequest>
  void UpdateSMBLocalGroupsAsync(const UpdateSMBLocalGroupsRequestT& request, const UpdateSMBLocalGroupsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSMBSecurityStrategy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateSMBSecurityStrategyRequestT = Model::UpdateSMBSecurityStrategyRequest>
  Model::UpdateSMBSecurityStrategyOutcomeCallable UpdateSMBSecurityStrategyCallable(
      const UpdateSMBSecurityStrategyRequestT& request) const {
    return SubmitCallable(&StorageGatewayClient::UpdateSMBSecurityStrategy, request);
  }

  /**
   * An Async wrapper for UpdateSMBSecurityStrategy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSMBSecurityStrategyRequestT = Model::UpdateSMBSecurityStrategyRequest>
  void UpdateSMBSecurityStrategyAsync(const UpdateSMBSecurityStrategyRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateSnapshotSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSnapshotSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSnapshotScheduleRequestT = Model::UpdateSnapshotScheduleRequest>
  void UpdateSnapshotScheduleAsync(const UpdateSnapshotScheduleRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateVTLDeviceType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateVTLDeviceType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateVTLDeviceTypeRequestT = Model::UpdateVTLDeviceTypeRequest>
  void UpdateVTLDeviceTypeAsync(const UpdateVTLDeviceTypeRequestT& request, const UpdateVTLDeviceTypeResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
