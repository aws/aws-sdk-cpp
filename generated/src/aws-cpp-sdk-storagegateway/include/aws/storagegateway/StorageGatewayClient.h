...
namespace StorageGateway
{
   ...
   * 
   */
  class AWS_STORAGEGATEWAY_API StorageGatewayClient : Aws::Client::ClientWithAsyncTemplateMethods<StorageGatewayClient>,
    smithy::client::AwsSmithyClientT<Aws::StorageGateway::SERVICE_NAME,
