...
Aws::String DescribeFileSystemAssociationsRequest::SerializePayload() const {
  ...
  if (m_fileSystemAssociationARNListHasBeenSet) {
    ...
    for (unsigned fileSystemAssociationARNListIndex = 0;
         fileSystemAssociationARNListIndex < fileSystemAssociationARNListJsonList.GetLength(); ++fileSystemAssociationARNListIndex) {
      fileSystemAssociationARNListJsonList[fileSystemAssociationARNListIndex].AsString(
          m_fileSystemAssociationARNList[fileSystemAssociationARNListIndex]);
    }
