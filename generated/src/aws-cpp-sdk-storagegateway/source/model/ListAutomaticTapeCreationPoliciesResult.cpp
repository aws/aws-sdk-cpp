...
ListAutomaticTapeCreationPoliciesResult& ListAutomaticTapeCreationPoliciesResult::operator=(
  ...
  if (jsonValue.ValueExists("AutomaticTapeCreationPolicyInfos")) {
    ...
    for (unsigned automaticTapeCreationPolicyInfosIndex = 0;
         automaticTapeCreationPolicyInfosIndex < automaticTapeCreationPolicyInfosJsonList.GetLength();
         ++automaticTapeCreationPolicyInfosIndex) {
      m_automaticTapeCreationPolicyInfos.push_back(
          automaticTapeCreationPolicyInfosJsonList[automaticTapeCreationPolicyInfosIndex].AsObject());
    }
