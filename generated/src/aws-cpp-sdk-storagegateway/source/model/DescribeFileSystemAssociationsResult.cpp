...
DescribeFileSystemAssociationsResult& DescribeFileSystemAssociationsResult::operator=(
  ...
  if (jsonValue.ValueExists("FileSystemAssociationInfoList")) {
    ...
    for (unsigned fileSystemAssociationInfoListIndex = 0;
         fileSystemAssociationInfoListIndex < fileSystemAssociationInfoListJsonList.GetLength(); ++fileSystemAssociationInfoListIndex) {
