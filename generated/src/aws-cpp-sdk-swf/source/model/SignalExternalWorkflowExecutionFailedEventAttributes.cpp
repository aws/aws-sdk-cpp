...
SignalExternalWorkflowExecutionFailedEventAttributes& SignalExternalWorkflowExecutionFailedEventAttributes::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("cause")) {
    m_cause = SignalExternalWorkflowExecutionFailedCauseMapper::GetSignalExternalWorkflowExecutionFailedCauseForName(
...
JsonValue SignalExternalWorkflowExecutionFailedEventAttributes::Jsonize() const {
  JsonValue payload;
  ...
  if (m_causeHasBeenSet) {
    payload.WithString("cause",
                       SignalExternalWorkflowExecutionFailedCauseMapper::GetNameForSignalExternalWorkflowExecutionFailedCause(m_cause));
  }
