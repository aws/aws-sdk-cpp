...
Decision::Decision(JsonView jsonValue) { *this = jsonValue; }
...
Decision& Decision::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("requestCancelExternalWorkflowExecutionDecisionAttributes")) {
    m_requestCancelExternalWorkflowExecutionDecisionAttributes =
        jsonValue.GetObject("requestCancelExternalWorkflowExecutionDecisionAttributes");
...
JsonValue Decision::Jsonize() const {
  ...
  if (m_requestCancelExternalWorkflowExecutionDecisionAttributesHasBeenSet) {
    payload.WithObject("requestCancelExternalWorkflowExecutionDecisionAttributes",
                       m_requestCancelExternalWorkflowExecutionDecisionAttributes.Jsonize());
  }
