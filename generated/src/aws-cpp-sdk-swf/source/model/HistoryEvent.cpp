...
HistoryEvent::HistoryEvent(JsonView jsonValue) { *this = jsonValue; }
...
HistoryEvent& HistoryEvent::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("signalExternalWorkflowExecutionInitiatedEventAttributes")) {
    m_signalExternalWorkflowExecutionInitiatedEventAttributes =
        jsonValue.GetObject("signalExternalWorkflowExecutionInitiatedEventAttributes");
  ...
  if (jsonValue.ValueExists("externalWorkflowExecutionCancelRequestedEventAttributes")) {
    m_externalWorkflowExecutionCancelRequestedEventAttributes =
        jsonValue.GetObject("externalWorkflowExecutionCancelRequestedEventAttributes");
  ...
  if (jsonValue.ValueExists("requestCancelExternalWorkflowExecutionInitiatedEventAttributes")) {
    m_requestCancelExternalWorkflowExecutionInitiatedEventAttributes =
        jsonValue.GetObject("requestCancelExternalWorkflowExecutionInitiatedEventAttributes");
  ...
  if (jsonValue.ValueExists("requestCancelExternalWorkflowExecutionFailedEventAttributes")) {
    m_requestCancelExternalWorkflowExecutionFailedEventAttributes =
        jsonValue.GetObject("requestCancelExternalWorkflowExecutionFailedEventAttributes");
...
JsonValue HistoryEvent::Jsonize() const {
  ...
  if (m_continueAsNewWorkflowExecutionFailedEventAttributesHasBeenSet) {
    payload.WithObject("continueAsNewWorkflowExecutionFailedEventAttributes",
                       m_continueAsNewWorkflowExecutionFailedEventAttributes.Jsonize());
  }
  ...
  if (m_startChildWorkflowExecutionInitiatedEventAttributesHasBeenSet) {
    payload.WithObject("startChildWorkflowExecutionInitiatedEventAttributes",
                       m_startChildWorkflowExecutionInitiatedEventAttributes.Jsonize());
  }
  ...
  if (m_signalExternalWorkflowExecutionInitiatedEventAttributesHasBeenSet) {
    payload.WithObject("signalExternalWorkflowExecutionInitiatedEventAttributes",
                       m_signalExternalWorkflowExecutionInitiatedEventAttributes.Jsonize());
  }
  ...
  if (m_signalExternalWorkflowExecutionFailedEventAttributesHasBeenSet) {
    payload.WithObject("signalExternalWorkflowExecutionFailedEventAttributes",
                       m_signalExternalWorkflowExecutionFailedEventAttributes.Jsonize());
  }

  if (m_externalWorkflowExecutionCancelRequestedEventAttributesHasBeenSet) {
    payload.WithObject("externalWorkflowExecutionCancelRequestedEventAttributes",
                       m_externalWorkflowExecutionCancelRequestedEventAttributes.Jsonize());
  }

  if (m_requestCancelExternalWorkflowExecutionInitiatedEventAttributesHasBeenSet) {
    payload.WithObject("requestCancelExternalWorkflowExecutionInitiatedEventAttributes",
                       m_requestCancelExternalWorkflowExecutionInitiatedEventAttributes.Jsonize());
  }

  if (m_requestCancelExternalWorkflowExecutionFailedEventAttributesHasBeenSet) {
    payload.WithObject("requestCancelExternalWorkflowExecutionFailedEventAttributes",
                       m_requestCancelExternalWorkflowExecutionFailedEventAttributes.Jsonize());
  }
