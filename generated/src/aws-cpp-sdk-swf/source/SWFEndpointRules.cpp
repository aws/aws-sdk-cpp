...
namespace SWF
{
const size_t SWFEndpointRules::RulesBlobStrLen = 3683;
const size_t SWFEndpointRules::RulesBlobSize = 3684;
...
't','p','s',':','/','/','s','w','f','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
