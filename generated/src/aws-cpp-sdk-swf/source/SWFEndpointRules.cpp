...
namespace SWF
{
const size_t SWFEndpointRules::RulesBlobStrLen = 3935;
const size_t SWFEndpointRules::RulesBlobSize = 3936;
...
's','w','f','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.','c','o',
...
's',':','/','/','s','w','f','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
