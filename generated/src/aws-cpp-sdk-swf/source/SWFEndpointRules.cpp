...
namespace SWF
{
const size_t SWFEndpointRules::RulesBlobStrLen = 4107;
const size_t SWFEndpointRules::RulesBlobSize = 4108;
...
':','"','h','t','t','p','s',':','/','/','s','w','f','.','u','s','-','g','o','v','-','w','e','s','t',
