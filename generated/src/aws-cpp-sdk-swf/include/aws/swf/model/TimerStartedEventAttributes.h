...
class TimerStartedEventAttributes {
 public:
  ...
  void SetStartToFireTimeout(StartToFireTimeoutT&& value) {
    ...
    m_startToFireTimeout = std::forward<StartToFireTimeoutT>(value);
  }
  template <typename StartToFireTimeoutT = Aws::String>
  TimerStartedEventAttributes& WithStartToFireTimeout(StartToFireTimeoutT&& value) {
    SetStartToFireTimeout(std::forward<StartToFireTimeoutT>(value));
    return *this;
  }
  ///@}
  ...
  inline TimerStartedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
