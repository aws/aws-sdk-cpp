...
class DecisionTaskTimedOutEventAttributes {
 public:
  ...
  inline void SetTimeoutType(DecisionTaskTimeoutType value) {
    m_timeoutTypeHasBeenSet = true;
    m_timeoutType = value;
  }
  inline DecisionTaskTimedOutEventAttributes& WithTimeoutType(DecisionTaskTimeoutType value) {
  ...
  inline DecisionTaskTimedOutEventAttributes& WithScheduledEventId(long long value) {
  ...
  inline DecisionTaskTimedOutEventAttributes& WithStartedEventId(long long value) {
