...
class DomainInfo {
 public:
  ...
  template <typename NameT = Aws::String>
  DomainInfo& WithName(NameT&& value) {
  ...
  inline void SetStatus(RegistrationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DomainInfo& WithStatus(RegistrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  DomainInfo& WithDescription(DescriptionT&& value) {
