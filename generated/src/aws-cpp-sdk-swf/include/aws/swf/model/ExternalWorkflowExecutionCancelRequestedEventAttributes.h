...
class ExternalWorkflowExecutionCancelRequestedEventAttributes {
 public:
  AWS_SWF_API ExternalWorkflowExecutionCancelRequestedEventAttributes() = default;
  ...
  template <typename WorkflowExecutionT = WorkflowExecution>
  ExternalWorkflowExecutionCancelRequestedEventAttributes& WithWorkflowExecution(WorkflowExecutionT&& value) {
  ...
  inline ExternalWorkflowExecutionCancelRequestedEventAttributes& WithInitiatedEventId(long long value) {
