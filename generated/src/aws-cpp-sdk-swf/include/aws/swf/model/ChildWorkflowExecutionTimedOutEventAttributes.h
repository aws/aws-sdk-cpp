...
class ChildWorkflowExecutionTimedOutEventAttributes {
 public:
  ...
  void SetWorkflowExecution(WorkflowExecutionT&& value) {
    ...
    m_workflowExecution = std::forward<WorkflowExecutionT>(value);
  }
  template <typename WorkflowExecutionT = WorkflowExecution>
  ChildWorkflowExecutionTimedOutEventAttributes& WithWorkflowExecution(WorkflowExecutionT&& value) {
    SetWorkflowExecution(std::forward<WorkflowExecutionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WorkflowTypeT = WorkflowType>
  ChildWorkflowExecutionTimedOutEventAttributes& WithWorkflowType(WorkflowTypeT&& value) {
  ...
  inline void SetTimeoutType(WorkflowExecutionTimeoutType value) {
    m_timeoutTypeHasBeenSet = true;
    m_timeoutType = value;
  }
  inline ChildWorkflowExecutionTimedOutEventAttributes& WithTimeoutType(WorkflowExecutionTimeoutType value) {
  ...
  inline ChildWorkflowExecutionTimedOutEventAttributes& WithInitiatedEventId(long long value) {
  ...
  inline ChildWorkflowExecutionTimedOutEventAttributes& WithStartedEventId(long long value) {
