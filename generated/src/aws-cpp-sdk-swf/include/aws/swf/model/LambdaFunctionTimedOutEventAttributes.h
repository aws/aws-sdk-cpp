...
class LambdaFunctionTimedOutEventAttributes {
 public:
  ...
  inline LambdaFunctionTimedOutEventAttributes& WithScheduledEventId(long long value) {
  ...
  inline LambdaFunctionTimedOutEventAttributes& WithStartedEventId(long long value) {
  ...
  inline void SetTimeoutType(LambdaFunctionTimeoutType value) {
    m_timeoutTypeHasBeenSet = true;
    m_timeoutType = value;
  }
  inline LambdaFunctionTimedOutEventAttributes& WithTimeoutType(LambdaFunctionTimeoutType value) {
