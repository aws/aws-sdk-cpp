...
class ListOpenWorkflowExecutionsRequest : public SWFRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  ListOpenWorkflowExecutionsRequest& WithDomain(DomainT&& value) {
  ...
  template <typename StartTimeFilterT = ExecutionTimeFilter>
  ListOpenWorkflowExecutionsRequest& WithStartTimeFilter(StartTimeFilterT&& value) {
  ...
  template <typename TypeFilterT = WorkflowTypeFilter>
  ListOpenWorkflowExecutionsRequest& WithTypeFilter(TypeFilterT&& value) {
  ...
  template <typename TagFilterT = TagFilter>
  ListOpenWorkflowExecutionsRequest& WithTagFilter(TagFilterT&& value) {
  ...
  template <typename NextPageTokenT = Aws::String>
  ListOpenWorkflowExecutionsRequest& WithNextPageToken(NextPageTokenT&& value) {
  ...
  inline ListOpenWorkflowExecutionsRequest& WithMaximumPageSize(int value) {
  ...
  inline ListOpenWorkflowExecutionsRequest& WithReverseOrder(bool value) {
  ...
  template <typename ExecutionFilterT = WorkflowExecutionFilter>
  ListOpenWorkflowExecutionsRequest& WithExecutionFilter(ExecutionFilterT&& value) {
