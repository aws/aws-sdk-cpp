...
class ListActivityTypesResult {
 public:
  ...
  template <typename TypeInfosT = Aws::Vector<ActivityTypeInfo>>
  ListActivityTypesResult& WithTypeInfos(TypeInfosT&& value) {
    SetTypeInfos(std::forward<TypeInfosT>(value));
    return *this;
  }
  template <typename TypeInfosT = ActivityTypeInfo>
  ListActivityTypesResult& AddTypeInfos(TypeInfosT&& value) {
    m_typeInfosHasBeenSet = true;
  ...
  template <typename NextPageTokenT = Aws::String>
  ListActivityTypesResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListActivityTypesResult& WithRequestId(RequestIdT&& value) {
