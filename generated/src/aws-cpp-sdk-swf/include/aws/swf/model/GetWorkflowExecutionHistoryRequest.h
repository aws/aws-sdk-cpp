...
class GetWorkflowExecutionHistoryRequest : public SWFRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  GetWorkflowExecutionHistoryRequest& WithDomain(DomainT&& value) {
  ...
  template <typename ExecutionT = WorkflowExecution>
  GetWorkflowExecutionHistoryRequest& WithExecution(ExecutionT&& value) {
  ...
  template <typename NextPageTokenT = Aws::String>
  GetWorkflowExecutionHistoryRequest& WithNextPageToken(NextPageTokenT&& value) {
  ...
  inline GetWorkflowExecutionHistoryRequest& WithMaximumPageSize(int value) {
  ...
  inline GetWorkflowExecutionHistoryRequest& WithReverseOrder(bool value) {
