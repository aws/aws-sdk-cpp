...
class ListClosedWorkflowExecutionsResult {
 public:
  ...
  void SetExecutionInfos(ExecutionInfosT&& value) {
    m_executionInfosHasBeenSet = true;
    m_executionInfos = std::forward<ExecutionInfosT>(value);
  }
  template <typename ExecutionInfosT = Aws::Vector<WorkflowExecutionInfo>>
  ListClosedWorkflowExecutionsResult& WithExecutionInfos(ExecutionInfosT&& value) {
    SetExecutionInfos(std::forward<ExecutionInfosT>(value));
    return *this;
  }
  template <typename ExecutionInfosT = WorkflowExecutionInfo>
  ListClosedWorkflowExecutionsResult& AddExecutionInfos(ExecutionInfosT&& value) {
    m_executionInfosHasBeenSet = true;
    m_executionInfos.emplace_back(std::forward<ExecutionInfosT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListClosedWorkflowExecutionsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListClosedWorkflowExecutionsResult& WithRequestId(RequestIdT&& value) {
