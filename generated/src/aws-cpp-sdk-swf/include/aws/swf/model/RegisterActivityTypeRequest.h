...
class RegisterActivityTypeRequest : public SWFRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  RegisterActivityTypeRequest& WithDomain(DomainT&& value) {
  ...
  template <typename NameT = Aws::String>
  RegisterActivityTypeRequest& WithName(NameT&& value) {
  ...
  template <typename VersionT = Aws::String>
  RegisterActivityTypeRequest& WithVersion(VersionT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  RegisterActivityTypeRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename DefaultTaskStartToCloseTimeoutT = Aws::String>
  RegisterActivityTypeRequest& WithDefaultTaskStartToCloseTimeout(DefaultTaskStartToCloseTimeoutT&& value) {
  ...
  template <typename DefaultTaskHeartbeatTimeoutT = Aws::String>
  RegisterActivityTypeRequest& WithDefaultTaskHeartbeatTimeout(DefaultTaskHeartbeatTimeoutT&& value) {
  ...
  template <typename DefaultTaskListT = TaskList>
  RegisterActivityTypeRequest& WithDefaultTaskList(DefaultTaskListT&& value) {
  ...
  template <typename DefaultTaskPriorityT = Aws::String>
  RegisterActivityTypeRequest& WithDefaultTaskPriority(DefaultTaskPriorityT&& value) {
  ...
  template <typename DefaultTaskScheduleToStartTimeoutT = Aws::String>
  RegisterActivityTypeRequest& WithDefaultTaskScheduleToStartTimeout(DefaultTaskScheduleToStartTimeoutT&& value) {
  ...
  template <typename DefaultTaskScheduleToCloseTimeoutT = Aws::String>
  RegisterActivityTypeRequest& WithDefaultTaskScheduleToCloseTimeout(DefaultTaskScheduleToCloseTimeoutT&& value) {
