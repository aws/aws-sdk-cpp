...
class ScheduleLambdaFunctionFailedEventAttributes {
 public:
  ...
  inline void SetCause(ScheduleLambdaFunctionFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline ScheduleLambdaFunctionFailedEventAttributes& WithCause(ScheduleLambdaFunctionFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
  ...
  inline ScheduleLambdaFunctionFailedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
