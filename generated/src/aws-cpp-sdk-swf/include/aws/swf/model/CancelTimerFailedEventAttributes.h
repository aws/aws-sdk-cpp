...
class CancelTimerFailedEventAttributes {
 public:
   ...
   * Guide</i>.</p>
   */
  inline CancelTimerFailedCause GetCause() const { return m_cause; }
  inline bool CauseHasBeenSet() const { return m_causeHasBeenSet; }
  inline void SetCause(CancelTimerFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline CancelTimerFailedEventAttributes& WithCause(CancelTimerFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
  ...
  inline CancelTimerFailedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
