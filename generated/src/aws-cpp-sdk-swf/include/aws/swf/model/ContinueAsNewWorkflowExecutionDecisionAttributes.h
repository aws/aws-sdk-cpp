...
class ContinueAsNewWorkflowExecutionDecisionAttributes {
 public:
  ...
  template <typename InputT = Aws::String>
  ContinueAsNewWorkflowExecutionDecisionAttributes& WithInput(InputT&& value) {
  ...
  template <typename ExecutionStartToCloseTimeoutT = Aws::String>
  ContinueAsNewWorkflowExecutionDecisionAttributes& WithExecutionStartToCloseTimeout(ExecutionStartToCloseTimeoutT&& value) {
  ...
  template <typename TaskListT = TaskList>
  ContinueAsNewWorkflowExecutionDecisionAttributes& WithTaskList(TaskListT&& value) {
  ...
  template <typename TaskPriorityT = Aws::String>
  ContinueAsNewWorkflowExecutionDecisionAttributes& WithTaskPriority(TaskPriorityT&& value) {
  ...
  template <typename TaskStartToCloseTimeoutT = Aws::String>
  ContinueAsNewWorkflowExecutionDecisionAttributes& WithTaskStartToCloseTimeout(TaskStartToCloseTimeoutT&& value) {
  ...
  inline ContinueAsNewWorkflowExecutionDecisionAttributes& WithChildPolicy(ChildPolicy value) {
  ...
  template <typename TagListT = Aws::Vector<Aws::String>>
  ContinueAsNewWorkflowExecutionDecisionAttributes& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Aws::String>
  ContinueAsNewWorkflowExecutionDecisionAttributes& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
  ...
  void SetWorkflowTypeVersion(WorkflowTypeVersionT&& value) {
    m_workflowTypeVersionHasBeenSet = true;
    m_workflowTypeVersion = std::forward<WorkflowTypeVersionT>(value);
  }
  template <typename WorkflowTypeVersionT = Aws::String>
  ContinueAsNewWorkflowExecutionDecisionAttributes& WithWorkflowTypeVersion(WorkflowTypeVersionT&& value) {
    SetWorkflowTypeVersion(std::forward<WorkflowTypeVersionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LambdaRoleT = Aws::String>
  ContinueAsNewWorkflowExecutionDecisionAttributes& WithLambdaRole(LambdaRoleT&& value) {
