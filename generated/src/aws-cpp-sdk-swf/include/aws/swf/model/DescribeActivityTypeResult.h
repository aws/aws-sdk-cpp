...
class DescribeActivityTypeResult {
 public:
  ...
  template <typename TypeInfoT = ActivityTypeInfo>
  DescribeActivityTypeResult& WithTypeInfo(TypeInfoT&& value) {
  ...
  template <typename ConfigurationT = ActivityTypeConfiguration>
  DescribeActivityTypeResult& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeActivityTypeResult& WithRequestId(RequestIdT&& value) {
