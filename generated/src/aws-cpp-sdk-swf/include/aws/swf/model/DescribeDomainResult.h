...
class DescribeDomainResult {
 public:
  ...
  void SetDomainInfo(DomainInfoT&& value) {
    m_domainInfoHasBeenSet = true;
    m_domainInfo = std::forward<DomainInfoT>(value);
  }
  template <typename DomainInfoT = DomainInfo>
  DescribeDomainResult& WithDomainInfo(DomainInfoT&& value) {
    SetDomainInfo(std::forward<DomainInfoT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ConfigurationT = DomainConfiguration>
  DescribeDomainResult& WithConfiguration(ConfigurationT&& value) {
