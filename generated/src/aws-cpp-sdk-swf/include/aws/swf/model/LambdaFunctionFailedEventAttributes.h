...
class LambdaFunctionFailedEventAttributes {
 public:
  ...
  inline LambdaFunctionFailedEventAttributes& WithScheduledEventId(long long value) {
  ...
  inline LambdaFunctionFailedEventAttributes& WithStartedEventId(long long value) {
