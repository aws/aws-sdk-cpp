...
class DecisionTaskCompletedEventAttributes {
 public:
  ...
  inline DecisionTaskCompletedEventAttributes& WithScheduledEventId(long long value) {
  ...
  inline DecisionTaskCompletedEventAttributes& WithStartedEventId(long long value) {
