...
class FailWorkflowExecutionFailedEventAttributes {
 public:
  ...
  inline void SetCause(FailWorkflowExecutionFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline FailWorkflowExecutionFailedEventAttributes& WithCause(FailWorkflowExecutionFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
  ...
  inline FailWorkflowExecutionFailedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
