...
class ChildWorkflowExecutionTerminatedEventAttributes {
 public:
  ...
  template <typename WorkflowExecutionT = WorkflowExecution>
  ChildWorkflowExecutionTerminatedEventAttributes& WithWorkflowExecution(WorkflowExecutionT&& value) {
  ...
  template <typename WorkflowTypeT = WorkflowType>
  ChildWorkflowExecutionTerminatedEventAttributes& WithWorkflowType(WorkflowTypeT&& value) {
  ...
  inline ChildWorkflowExecutionTerminatedEventAttributes& WithInitiatedEventId(long long value) {
  ...
  inline ChildWorkflowExecutionTerminatedEventAttributes& WithStartedEventId(long long value) {
