...
class PollForDecisionTaskRequest : public SWFRequest {
 public:
  ...
  inline PollForDecisionTaskRequest& WithMaximumPageSize(int value) {
  ...
  inline PollForDecisionTaskRequest& WithReverseOrder(bool value) {
  ...
  inline void SetStartAtPreviousStartedEvent(bool value) {
    m_startAtPreviousStartedEventHasBeenSet = true;
    m_startAtPreviousStartedEvent = value;
  }
  inline PollForDecisionTaskRequest& WithStartAtPreviousStartedEvent(bool value) {
    SetStartAtPreviousStartedEvent(value);
    return *this;
  }
  ///@}
 private:
