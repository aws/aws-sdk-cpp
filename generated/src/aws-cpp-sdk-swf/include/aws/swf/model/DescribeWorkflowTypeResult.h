...
class DescribeWorkflowTypeResult {
 public:
  ...
  void SetTypeInfo(TypeInfoT&& value) {
    m_typeInfoHasBeenSet = true;
    m_typeInfo = std::forward<TypeInfoT>(value);
  }
  template <typename TypeInfoT = WorkflowTypeInfo>
  DescribeWorkflowTypeResult& WithTypeInfo(TypeInfoT&& value) {
    SetTypeInfo(std::forward<TypeInfoT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ConfigurationT = WorkflowTypeConfiguration>
  DescribeWorkflowTypeResult& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWorkflowTypeResult& WithRequestId(RequestIdT&& value) {
