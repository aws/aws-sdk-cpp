...
class StartTimerFailedEventAttributes {
 public:
  ...
  inline void SetCause(StartTimerFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline StartTimerFailedEventAttributes& WithCause(StartTimerFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
  ...
  inline StartTimerFailedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
