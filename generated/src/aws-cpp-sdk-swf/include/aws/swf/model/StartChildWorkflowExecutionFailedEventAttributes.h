...
class StartChildWorkflowExecutionFailedEventAttributes {
 public:
  ...
  void SetWorkflowType(WorkflowTypeT&& value) {
    ...
    m_workflowType = std::forward<WorkflowTypeT>(value);
  }
  template <typename WorkflowTypeT = WorkflowType>
  StartChildWorkflowExecutionFailedEventAttributes& WithWorkflowType(WorkflowTypeT&& value) {
    SetWorkflowType(std::forward<WorkflowTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCause(StartChildWorkflowExecutionFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline StartChildWorkflowExecutionFailedEventAttributes& WithCause(StartChildWorkflowExecutionFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
  ...
  template <typename WorkflowIdT = Aws::String>
  StartChildWorkflowExecutionFailedEventAttributes& WithWorkflowId(WorkflowIdT&& value) {
  ...
  inline StartChildWorkflowExecutionFailedEventAttributes& WithInitiatedEventId(long long value) {
  ...
  inline StartChildWorkflowExecutionFailedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
  ...
  template <typename ControlT = Aws::String>
  StartChildWorkflowExecutionFailedEventAttributes& WithControl(ControlT&& value) {
