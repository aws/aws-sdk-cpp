...
class RecordMarkerFailedEventAttributes {
 public:
  ...
  void SetMarkerName(MarkerNameT&& value) {
    m_markerNameHasBeenSet = true;
    m_markerName = std::forward<MarkerNameT>(value);
  }
  template <typename MarkerNameT = Aws::String>
  RecordMarkerFailedEventAttributes& WithMarkerName(MarkerNameT&& value) {
    SetMarkerName(std::forward<MarkerNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCause(RecordMarkerFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline RecordMarkerFailedEventAttributes& WithCause(RecordMarkerFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
  ...
  inline RecordMarkerFailedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
