...
class StartLambdaFunctionFailedEventAttributes {
 public:
  ...
  inline StartLambdaFunctionFailedEventAttributes& WithScheduledEventId(long long value) {
  ...
  inline void SetCause(StartLambdaFunctionFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline StartLambdaFunctionFailedEventAttributes& WithCause(StartLambdaFunctionFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
