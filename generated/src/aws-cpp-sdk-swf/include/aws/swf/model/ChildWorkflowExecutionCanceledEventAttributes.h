...
class ChildWorkflowExecutionCanceledEventAttributes {
 public:
  ...
  template <typename WorkflowExecutionT = WorkflowExecution>
  ChildWorkflowExecutionCanceledEventAttributes& WithWorkflowExecution(WorkflowExecutionT&& value) {
  ...
  template <typename WorkflowTypeT = WorkflowType>
  ChildWorkflowExecutionCanceledEventAttributes& WithWorkflowType(WorkflowTypeT&& value) {
  ...
  template <typename DetailsT = Aws::String>
  ChildWorkflowExecutionCanceledEventAttributes& WithDetails(DetailsT&& value) {
  ...
  inline ChildWorkflowExecutionCanceledEventAttributes& WithInitiatedEventId(long long value) {
  ...
  inline ChildWorkflowExecutionCanceledEventAttributes& WithStartedEventId(long long value) {
