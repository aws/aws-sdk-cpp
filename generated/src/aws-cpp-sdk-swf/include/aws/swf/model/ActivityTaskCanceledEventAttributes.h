...
class ActivityTaskCanceledEventAttributes {
 public:
  ...
  inline ActivityTaskCanceledEventAttributes& WithScheduledEventId(long long value) {
  ...
  inline ActivityTaskCanceledEventAttributes& WithStartedEventId(long long value) {
  ...
  inline void SetLatestCancelRequestedEventId(long long value) {
    m_latestCancelRequestedEventIdHasBeenSet = true;
    m_latestCancelRequestedEventId = value;
  }
  inline ActivityTaskCanceledEventAttributes& WithLatestCancelRequestedEventId(long long value) {
    SetLatestCancelRequestedEventId(value);
    return *this;
  }
  ///@}
 private:
