...
class RequestCancelExternalWorkflowExecutionInitiatedEventAttributes {
 public:
  ...
  template <typename WorkflowIdT = Aws::String>
  RequestCancelExternalWorkflowExecutionInitiatedEventAttributes& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename RunIdT = Aws::String>
  RequestCancelExternalWorkflowExecutionInitiatedEventAttributes& WithRunId(RunIdT&& value) {
  ...
  inline RequestCancelExternalWorkflowExecutionInitiatedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
  ...
  template <typename ControlT = Aws::String>
  RequestCancelExternalWorkflowExecutionInitiatedEventAttributes& WithControl(ControlT&& value) {
