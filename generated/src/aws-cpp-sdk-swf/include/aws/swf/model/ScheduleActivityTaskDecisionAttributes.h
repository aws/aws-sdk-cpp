...
class ScheduleActivityTaskDecisionAttributes {
 public:
  ...
  void SetActivityType(ActivityTypeT&& value) {
    ...
    m_activityType = std::forward<ActivityTypeT>(value);
  }
  template <typename ActivityTypeT = ActivityType>
  ScheduleActivityTaskDecisionAttributes& WithActivityType(ActivityTypeT&& value) {
    SetActivityType(std::forward<ActivityTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScheduleToCloseTimeout(ScheduleToCloseTimeoutT&& value) {
    ...
    m_scheduleToCloseTimeout = std::forward<ScheduleToCloseTimeoutT>(value);
  }
  template <typename ScheduleToCloseTimeoutT = Aws::String>
  ScheduleActivityTaskDecisionAttributes& WithScheduleToCloseTimeout(ScheduleToCloseTimeoutT&& value) {
    SetScheduleToCloseTimeout(std::forward<ScheduleToCloseTimeoutT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTaskPriority(TaskPriorityT&& value) {
    ...
    m_taskPriority = std::forward<TaskPriorityT>(value);
  }
  template <typename TaskPriorityT = Aws::String>
  ScheduleActivityTaskDecisionAttributes& WithTaskPriority(TaskPriorityT&& value) {
    SetTaskPriority(std::forward<TaskPriorityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScheduleToStartTimeout(ScheduleToStartTimeoutT&& value) {
    ...
    m_scheduleToStartTimeout = std::forward<ScheduleToStartTimeoutT>(value);
  }
  template <typename ScheduleToStartTimeoutT = Aws::String>
  ScheduleActivityTaskDecisionAttributes& WithScheduleToStartTimeout(ScheduleToStartTimeoutT&& value) {
    SetScheduleToStartTimeout(std::forward<ScheduleToStartTimeoutT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHeartbeatTimeout(HeartbeatTimeoutT&& value) {
    ...
    m_heartbeatTimeout = std::forward<HeartbeatTimeoutT>(value);
  }
  template <typename HeartbeatTimeoutT = Aws::String>
  ScheduleActivityTaskDecisionAttributes& WithHeartbeatTimeout(HeartbeatTimeoutT&& value) {
    SetHeartbeatTimeout(std::forward<HeartbeatTimeoutT>(value));
    return *this;
  }
  ///@}
 private:
