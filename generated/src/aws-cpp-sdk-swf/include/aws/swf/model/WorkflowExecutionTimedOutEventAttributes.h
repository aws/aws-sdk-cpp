...
class WorkflowExecutionTimedOutEventAttributes {
 public:
  ...
  inline WorkflowExecutionTimedOutEventAttributes& WithTimeoutType(WorkflowExecutionTimeoutType value) {
  ...
  inline WorkflowExecutionTimedOutEventAttributes& WithChildPolicy(ChildPolicy value) {
