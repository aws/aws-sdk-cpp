...
class ScheduleActivityTaskFailedEventAttributes {
 public:
  ...
  inline void SetCause(ScheduleActivityTaskFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline ScheduleActivityTaskFailedEventAttributes& WithCause(ScheduleActivityTaskFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
  ...
  inline ScheduleActivityTaskFailedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
