...
class ListDomainsRequest : public SWFRequest {
 public:
  ...
  inline ListDomainsRequest& WithRegistrationStatus(RegistrationStatus value) {
  ...
  inline ListDomainsRequest& WithMaximumPageSize(int value) {
  ...
  inline ListDomainsRequest& WithReverseOrder(bool value) {
