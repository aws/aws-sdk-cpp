...
class ContinueAsNewWorkflowExecutionFailedEventAttributes {
 public:
  AWS_SWF_API ContinueAsNewWorkflowExecutionFailedEventAttributes() = default;
   ...
   * Guide</i>.</p>
   */
  inline ContinueAsNewWorkflowExecutionFailedCause GetCause() const { return m_cause; }
  inline bool CauseHasBeenSet() const { return m_causeHasBeenSet; }
  inline void SetCause(ContinueAsNewWorkflowExecutionFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline ContinueAsNewWorkflowExecutionFailedEventAttributes& WithCause(ContinueAsNewWorkflowExecutionFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
  ...
  inline ContinueAsNewWorkflowExecutionFailedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
