...
class ChildWorkflowExecutionCompletedEventAttributes {
 public:
  ...
  template <typename WorkflowExecutionT = WorkflowExecution>
  ChildWorkflowExecutionCompletedEventAttributes& WithWorkflowExecution(WorkflowExecutionT&& value) {
  ...
  template <typename WorkflowTypeT = WorkflowType>
  ChildWorkflowExecutionCompletedEventAttributes& WithWorkflowType(WorkflowTypeT&& value) {
  ...
  template <typename ResultT = Aws::String>
  ChildWorkflowExecutionCompletedEventAttributes& WithResult(ResultT&& value) {
  ...
  inline ChildWorkflowExecutionCompletedEventAttributes& WithInitiatedEventId(long long value) {
  ...
  inline ChildWorkflowExecutionCompletedEventAttributes& WithStartedEventId(long long value) {
