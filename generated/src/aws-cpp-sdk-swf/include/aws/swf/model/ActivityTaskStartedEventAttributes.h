...
namespace Model
{
  ...
  {
  public:
    AWS_SWF_API ActivityTaskStartedEventAttributes() = default;
    ...
    template<typename IdentityT = Aws::String>
    ActivityTaskStartedEventAttributes& WithIdentity(IdentityT&& value) { SetIdentity(std::forward<IdentityT>(value)); return *this;}
    ///@}
