...
class ListOpenWorkflowExecutionsResult {
 public:
  ...
  template <typename ExecutionInfosT = Aws::Vector<WorkflowExecutionInfo>>
  ListOpenWorkflowExecutionsResult& WithExecutionInfos(ExecutionInfosT&& value) {
    SetExecutionInfos(std::forward<ExecutionInfosT>(value));
    return *this;
  }
  template <typename ExecutionInfosT = WorkflowExecutionInfo>
  ListOpenWorkflowExecutionsResult& AddExecutionInfos(ExecutionInfosT&& value) {
    m_executionInfosHasBeenSet = true;
  ...
  template <typename NextPageTokenT = Aws::String>
  ListOpenWorkflowExecutionsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOpenWorkflowExecutionsResult& WithRequestId(RequestIdT&& value) {
