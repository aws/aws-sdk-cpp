...
class RequestCancelActivityTaskFailedEventAttributes {
 public:
  ...
  template <typename ActivityIdT = Aws::String>
  RequestCancelActivityTaskFailedEventAttributes& WithActivityId(ActivityIdT&& value) {
  ...
  inline void SetCause(RequestCancelActivityTaskFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline RequestCancelActivityTaskFailedEventAttributes& WithCause(RequestCancelActivityTaskFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
  ...
  inline RequestCancelActivityTaskFailedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
