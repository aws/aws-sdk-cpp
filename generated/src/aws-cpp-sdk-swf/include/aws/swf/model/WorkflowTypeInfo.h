...
class WorkflowTypeInfo {
 public:
  ...
  template <typename WorkflowTypeT = WorkflowType>
  WorkflowTypeInfo& WithWorkflowType(WorkflowTypeT&& value) {
  ...
  inline WorkflowTypeInfo& WithStatus(RegistrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  WorkflowTypeInfo& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  WorkflowTypeInfo& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename DeprecationDateT = Aws::Utils::DateTime>
  WorkflowTypeInfo& WithDeprecationDate(DeprecationDateT&& value) {
