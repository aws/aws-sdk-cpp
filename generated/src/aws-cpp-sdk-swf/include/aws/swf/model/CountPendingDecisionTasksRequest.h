...
namespace Model
{
  ...
  {
  public:
    AWS_SWF_API CountPendingDecisionTasksRequest() = default;
    ...
    template<typename DomainT = Aws::String>
    CountPendingDecisionTasksRequest& WithDomain(DomainT&& value) { SetDomain(std::forward<DomainT>(value)); return *this;}
    ///@}
    ...
    template<typename TaskListT = TaskList>
    CountPendingDecisionTasksRequest& WithTaskList(TaskListT&& value) { SetTaskList(std::forward<TaskListT>(value)); return *this;}
    ///@}
  private:
