...
class ExecutionTimeFilter {
 public:
  ...
  void SetOldestDate(OldestDateT&& value) {
    m_oldestDateHasBeenSet = true;
    m_oldestDate = std::forward<OldestDateT>(value);
  }
  template <typename OldestDateT = Aws::Utils::DateTime>
  ExecutionTimeFilter& WithOldestDate(OldestDateT&& value) {
    SetOldestDate(std::forward<OldestDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLatestDate(LatestDateT&& value) {
    m_latestDateHasBeenSet = true;
    m_latestDate = std::forward<LatestDateT>(value);
  }
  template <typename LatestDateT = Aws::Utils::DateTime>
  ExecutionTimeFilter& WithLatestDate(LatestDateT&& value) {
    SetLatestDate(std::forward<LatestDateT>(value));
    return *this;
  }
  ///@}
 private:
