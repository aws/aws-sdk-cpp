...
class PollForActivityTaskRequest : public SWFRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  PollForActivityTaskRequest& WithDomain(DomainT&& value) {
  ...
  template <typename TaskListT = TaskList>
  PollForActivityTaskRequest& WithTaskList(TaskListT&& value) {
  ...
  template <typename IdentityT = Aws::String>
  PollForActivityTaskRequest& WithIdentity(IdentityT&& value) {
