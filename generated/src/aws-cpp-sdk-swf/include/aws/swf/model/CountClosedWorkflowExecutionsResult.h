...
class CountClosedWorkflowExecutionsResult {
 public:
  ...
  inline CountClosedWorkflowExecutionsResult& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline CountClosedWorkflowExecutionsResult& WithTruncated(bool value) {
    SetTruncated(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CountClosedWorkflowExecutionsResult& WithRequestId(RequestIdT&& value) {
