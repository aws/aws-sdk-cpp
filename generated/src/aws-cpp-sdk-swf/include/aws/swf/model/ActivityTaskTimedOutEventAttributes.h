...
class ActivityTaskTimedOutEventAttributes {
 public:
  ...
  inline void SetTimeoutType(ActivityTaskTimeoutType value) {
    m_timeoutTypeHasBeenSet = true;
    m_timeoutType = value;
  }
  inline ActivityTaskTimedOutEventAttributes& WithTimeoutType(ActivityTaskTimeoutType value) {
  ...
  inline ActivityTaskTimedOutEventAttributes& WithScheduledEventId(long long value) {
  ...
  inline ActivityTaskTimedOutEventAttributes& WithStartedEventId(long long value) {
