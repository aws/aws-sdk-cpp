...
class TimerCanceledEventAttributes {
 public:
  ...
  inline TimerCanceledEventAttributes& WithStartedEventId(long long value) {
  ...
  inline TimerCanceledEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
