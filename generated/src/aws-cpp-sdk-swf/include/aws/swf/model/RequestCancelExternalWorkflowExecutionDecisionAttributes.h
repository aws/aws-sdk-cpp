...
class RequestCancelExternalWorkflowExecutionDecisionAttributes {
 public:
  ...
  template <typename WorkflowIdT = Aws::String>
  RequestCancelExternalWorkflowExecutionDecisionAttributes& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename RunIdT = Aws::String>
  RequestCancelExternalWorkflowExecutionDecisionAttributes& WithRunId(RunIdT&& value) {
  ...
  template <typename ControlT = Aws::String>
  RequestCancelExternalWorkflowExecutionDecisionAttributes& WithControl(ControlT&& value) {
