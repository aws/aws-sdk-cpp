...
class SignalExternalWorkflowExecutionInitiatedEventAttributes {
 public:
  ...
  template <typename WorkflowIdT = Aws::String>
  SignalExternalWorkflowExecutionInitiatedEventAttributes& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename RunIdT = Aws::String>
  SignalExternalWorkflowExecutionInitiatedEventAttributes& WithRunId(RunIdT&& value) {
  ...
  template <typename SignalNameT = Aws::String>
  SignalExternalWorkflowExecutionInitiatedEventAttributes& WithSignalName(SignalNameT&& value) {
  ...
  template <typename InputT = Aws::String>
  SignalExternalWorkflowExecutionInitiatedEventAttributes& WithInput(InputT&& value) {
  ...
  inline SignalExternalWorkflowExecutionInitiatedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
  ...
  template <typename ControlT = Aws::String>
  SignalExternalWorkflowExecutionInitiatedEventAttributes& WithControl(ControlT&& value) {
