...
class ChildWorkflowExecutionFailedEventAttributes {
 public:
  ...
  template <typename WorkflowExecutionT = WorkflowExecution>
  ChildWorkflowExecutionFailedEventAttributes& WithWorkflowExecution(WorkflowExecutionT&& value) {
  ...
  template <typename WorkflowTypeT = WorkflowType>
  ChildWorkflowExecutionFailedEventAttributes& WithWorkflowType(WorkflowTypeT&& value) {
  ...
  template <typename ReasonT = Aws::String>
  ChildWorkflowExecutionFailedEventAttributes& WithReason(ReasonT&& value) {
  ...
  template <typename DetailsT = Aws::String>
  ChildWorkflowExecutionFailedEventAttributes& WithDetails(DetailsT&& value) {
  ...
  inline ChildWorkflowExecutionFailedEventAttributes& WithInitiatedEventId(long long value) {
  ...
  inline ChildWorkflowExecutionFailedEventAttributes& WithStartedEventId(long long value) {
