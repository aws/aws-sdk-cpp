...
class CompleteWorkflowExecutionFailedEventAttributes {
 public:
  AWS_SWF_API CompleteWorkflowExecutionFailedEventAttributes() = default;
  AWS_SWF_API CompleteWorkflowExecutionFailedEventAttributes(Aws::Utils::Json::JsonView jsonValue);
  AWS_SWF_API CompleteWorkflowExecutionFailedEventAttributes& operator=(Aws::Utils::Json::JsonView jsonValue);
   ...
   * Guide</i>.</p>
   */
  inline CompleteWorkflowExecutionFailedCause GetCause() const { return m_cause; }
  inline bool CauseHasBeenSet() const { return m_causeHasBeenSet; }
  inline void SetCause(CompleteWorkflowExecutionFailedCause value) {
    m_causeHasBeenSet = true;
    m_cause = value;
  }
  inline CompleteWorkflowExecutionFailedEventAttributes& WithCause(CompleteWorkflowExecutionFailedCause value) {
    SetCause(value);
    return *this;
  }
  ///@}
  ...
  inline CompleteWorkflowExecutionFailedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
    SetDecisionTaskCompletedEventId(value);
    return *this;
  }
  ///@}
 private:
  CompleteWorkflowExecutionFailedCause m_cause{CompleteWorkflowExecutionFailedCause::NOT_SET};
