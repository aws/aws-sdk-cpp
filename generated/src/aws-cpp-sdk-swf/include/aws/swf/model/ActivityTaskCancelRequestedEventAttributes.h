...
class ActivityTaskCancelRequestedEventAttributes {
 public:
  ...
  inline ActivityTaskCancelRequestedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
  ...
  template <typename ActivityIdT = Aws::String>
  ActivityTaskCancelRequestedEventAttributes& WithActivityId(ActivityIdT&& value) {
