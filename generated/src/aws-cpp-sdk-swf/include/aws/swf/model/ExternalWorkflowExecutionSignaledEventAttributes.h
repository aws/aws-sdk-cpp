...
class ExternalWorkflowExecutionSignaledEventAttributes {
 public:
  ...
  template <typename WorkflowExecutionT = WorkflowExecution>
  ExternalWorkflowExecutionSignaledEventAttributes& WithWorkflowExecution(WorkflowExecutionT&& value) {
  ...
  inline ExternalWorkflowExecutionSignaledEventAttributes& WithInitiatedEventId(long long value) {
