...
class ActivityTypeConfiguration {
 public:
  ...
  void SetDefaultTaskStartToCloseTimeout(DefaultTaskStartToCloseTimeoutT&& value) {
    m_defaultTaskStartToCloseTimeoutHasBeenSet = true;
    m_defaultTaskStartToCloseTimeout = std::forward<DefaultTaskStartToCloseTimeoutT>(value);
  }
  template <typename DefaultTaskStartToCloseTimeoutT = Aws::String>
  ActivityTypeConfiguration& WithDefaultTaskStartToCloseTimeout(DefaultTaskStartToCloseTimeoutT&& value) {
    SetDefaultTaskStartToCloseTimeout(std::forward<DefaultTaskStartToCloseTimeoutT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultTaskHeartbeatTimeout(DefaultTaskHeartbeatTimeoutT&& value) {
    m_defaultTaskHeartbeatTimeoutHasBeenSet = true;
    m_defaultTaskHeartbeatTimeout = std::forward<DefaultTaskHeartbeatTimeoutT>(value);
  }
  template <typename DefaultTaskHeartbeatTimeoutT = Aws::String>
  ActivityTypeConfiguration& WithDefaultTaskHeartbeatTimeout(DefaultTaskHeartbeatTimeoutT&& value) {
    SetDefaultTaskHeartbeatTimeout(std::forward<DefaultTaskHeartbeatTimeoutT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultTaskList(DefaultTaskListT&& value) {
    m_defaultTaskListHasBeenSet = true;
    m_defaultTaskList = std::forward<DefaultTaskListT>(value);
  }
  template <typename DefaultTaskListT = TaskList>
  ActivityTypeConfiguration& WithDefaultTaskList(DefaultTaskListT&& value) {
    SetDefaultTaskList(std::forward<DefaultTaskListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultTaskPriority(DefaultTaskPriorityT&& value) {
    m_defaultTaskPriorityHasBeenSet = true;
    m_defaultTaskPriority = std::forward<DefaultTaskPriorityT>(value);
  }
  template <typename DefaultTaskPriorityT = Aws::String>
  ActivityTypeConfiguration& WithDefaultTaskPriority(DefaultTaskPriorityT&& value) {
    SetDefaultTaskPriority(std::forward<DefaultTaskPriorityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultTaskScheduleToStartTimeout(DefaultTaskScheduleToStartTimeoutT&& value) {
    m_defaultTaskScheduleToStartTimeoutHasBeenSet = true;
    m_defaultTaskScheduleToStartTimeout = std::forward<DefaultTaskScheduleToStartTimeoutT>(value);
  }
  template <typename DefaultTaskScheduleToStartTimeoutT = Aws::String>
  ActivityTypeConfiguration& WithDefaultTaskScheduleToStartTimeout(DefaultTaskScheduleToStartTimeoutT&& value) {
    SetDefaultTaskScheduleToStartTimeout(std::forward<DefaultTaskScheduleToStartTimeoutT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultTaskScheduleToCloseTimeout(DefaultTaskScheduleToCloseTimeoutT&& value) {
    m_defaultTaskScheduleToCloseTimeoutHasBeenSet = true;
    m_defaultTaskScheduleToCloseTimeout = std::forward<DefaultTaskScheduleToCloseTimeoutT>(value);
  }
  template <typename DefaultTaskScheduleToCloseTimeoutT = Aws::String>
  ActivityTypeConfiguration& WithDefaultTaskScheduleToCloseTimeout(DefaultTaskScheduleToCloseTimeoutT&& value) {
    SetDefaultTaskScheduleToCloseTimeout(std::forward<DefaultTaskScheduleToCloseTimeoutT>(value));
    return *this;
  }
  ///@}
 private:
