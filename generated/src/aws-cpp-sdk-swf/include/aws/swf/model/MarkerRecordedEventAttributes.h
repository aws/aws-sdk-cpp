...
class MarkerRecordedEventAttributes {
 public:
  ...
  template <typename MarkerNameT = Aws::String>
  MarkerRecordedEventAttributes& WithMarkerName(MarkerNameT&& value) {
  ...
  template <typename DetailsT = Aws::String>
  MarkerRecordedEventAttributes& WithDetails(DetailsT&& value) {
  ...
  inline MarkerRecordedEventAttributes& WithDecisionTaskCompletedEventId(long long value) {
