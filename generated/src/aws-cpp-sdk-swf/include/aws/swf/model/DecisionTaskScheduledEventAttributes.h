...
class DecisionTaskScheduledEventAttributes {
 public:
  ...
  template <typename TaskListT = TaskList>
  DecisionTaskScheduledEventAttributes& WithTaskList(TaskListT&& value) {
  ...
  template <typename TaskPriorityT = Aws::String>
  DecisionTaskScheduledEventAttributes& WithTaskPriority(TaskPriorityT&& value) {
  ...
  template <typename StartToCloseTimeoutT = Aws::String>
  DecisionTaskScheduledEventAttributes& WithStartToCloseTimeout(StartToCloseTimeoutT&& value) {
  ...
  template <typename ScheduleToStartTimeoutT = Aws::String>
  DecisionTaskScheduledEventAttributes& WithScheduleToStartTimeout(ScheduleToStartTimeoutT&& value) {
