...
class ListActivityTypesRequest : public SWFRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  ListActivityTypesRequest& WithDomain(DomainT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListActivityTypesRequest& WithName(NameT&& value) {
  ...
  inline ListActivityTypesRequest& WithRegistrationStatus(RegistrationStatus value) {
  ...
  template <typename NextPageTokenT = Aws::String>
  ListActivityTypesRequest& WithNextPageToken(NextPageTokenT&& value) {
  ...
  inline ListActivityTypesRequest& WithMaximumPageSize(int value) {
  ...
  inline ListActivityTypesRequest& WithReverseOrder(bool value) {
