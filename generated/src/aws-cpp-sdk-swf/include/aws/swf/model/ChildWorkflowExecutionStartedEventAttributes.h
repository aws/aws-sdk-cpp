...
class ChildWorkflowExecutionStartedEventAttributes {
 public:
  ...
  template <typename WorkflowExecutionT = WorkflowExecution>
  ChildWorkflowExecutionStartedEventAttributes& WithWorkflowExecution(WorkflowExecutionT&& value) {
  ...
  template <typename WorkflowTypeT = WorkflowType>
  ChildWorkflowExecutionStartedEventAttributes& WithWorkflowType(WorkflowTypeT&& value) {
  ...
  inline ChildWorkflowExecutionStartedEventAttributes& WithInitiatedEventId(long long value) {
