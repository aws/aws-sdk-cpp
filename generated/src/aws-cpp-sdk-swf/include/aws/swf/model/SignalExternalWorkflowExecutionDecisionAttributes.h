...
class SignalExternalWorkflowExecutionDecisionAttributes {
 public:
  ...
  template <typename WorkflowIdT = Aws::String>
  SignalExternalWorkflowExecutionDecisionAttributes& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename RunIdT = Aws::String>
  SignalExternalWorkflowExecutionDecisionAttributes& WithRunId(RunIdT&& value) {
  ...
  template <typename SignalNameT = Aws::String>
  SignalExternalWorkflowExecutionDecisionAttributes& WithSignalName(SignalNameT&& value) {
  ...
  template <typename InputT = Aws::String>
  SignalExternalWorkflowExecutionDecisionAttributes& WithInput(InputT&& value) {
  ...
  template <typename ControlT = Aws::String>
  SignalExternalWorkflowExecutionDecisionAttributes& WithControl(ControlT&& value) {
