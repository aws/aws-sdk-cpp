...
class RespondActivityTaskFailedRequest : public SWFRequest {
 public:
  ...
  template <typename TaskTokenT = Aws::String>
  RespondActivityTaskFailedRequest& WithTaskToken(TaskTokenT&& value) {
  ...
  template <typename ReasonT = Aws::String>
  RespondActivityTaskFailedRequest& WithReason(ReasonT&& value) {
  ...
  template <typename DetailsT = Aws::String>
  RespondActivityTaskFailedRequest& WithDetails(DetailsT&& value) {
