...
class ActivityTypeInfo {
 public:
  ...
  template <typename ActivityTypeT = ActivityType>
  ActivityTypeInfo& WithActivityType(ActivityTypeT&& value) {
  ...
  inline ActivityTypeInfo& WithStatus(RegistrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  ActivityTypeInfo& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  ActivityTypeInfo& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename DeprecationDateT = Aws::Utils::DateTime>
  ActivityTypeInfo& WithDeprecationDate(DeprecationDateT&& value) {
