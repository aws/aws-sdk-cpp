...
class AWS_SWF_API SWFClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SWFClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SWFEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::CountClosedWorkflowExecutionsOutcome CountClosedWorkflowExecutions(
      const Model::CountClosedWorkflowExecutionsRequest& request) const;

  /**
   * A Callable wrapper for CountClosedWorkflowExecutions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CountClosedWorkflowExecutionsRequestT = Model::CountClosedWorkflowExecutionsRequest>
  Model::CountClosedWorkflowExecutionsOutcomeCallable CountClosedWorkflowExecutionsCallable(
      const CountClosedWorkflowExecutionsRequestT& request) const {
    return SubmitCallable(&SWFClient::CountClosedWorkflowExecutions, request);
  }

  /**
   * An Async wrapper for CountClosedWorkflowExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CountClosedWorkflowExecutionsRequestT = Model::CountClosedWorkflowExecutionsRequest>
  void CountClosedWorkflowExecutionsAsync(const CountClosedWorkflowExecutionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CountOpenWorkflowExecutionsOutcome CountOpenWorkflowExecutions(
      const Model::CountOpenWorkflowExecutionsRequest& request) const;

  /**
   * A Callable wrapper for CountOpenWorkflowExecutions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CountOpenWorkflowExecutionsRequestT = Model::CountOpenWorkflowExecutionsRequest>
  Model::CountOpenWorkflowExecutionsOutcomeCallable CountOpenWorkflowExecutionsCallable(
      const CountOpenWorkflowExecutionsRequestT& request) const {
    return SubmitCallable(&SWFClient::CountOpenWorkflowExecutions, request);
  }

  /**
   * An Async wrapper for CountOpenWorkflowExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CountOpenWorkflowExecutionsRequestT = Model::CountOpenWorkflowExecutionsRequest>
  void CountOpenWorkflowExecutionsAsync(const CountOpenWorkflowExecutionsRequestT& request,
  ...
  /**
   * A Callable wrapper for CountPendingActivityTasks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CountPendingActivityTasksRequestT = Model::CountPendingActivityTasksRequest>
  Model::CountPendingActivityTasksOutcomeCallable CountPendingActivityTasksCallable(
      const CountPendingActivityTasksRequestT& request) const {
    return SubmitCallable(&SWFClient::CountPendingActivityTasks, request);
  }

  /**
   * An Async wrapper for CountPendingActivityTasks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CountPendingActivityTasksRequestT = Model::CountPendingActivityTasksRequest>
  void CountPendingActivityTasksAsync(const CountPendingActivityTasksRequestT& request,
  ...
  /**
   * A Callable wrapper for CountPendingDecisionTasks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CountPendingDecisionTasksRequestT = Model::CountPendingDecisionTasksRequest>
  Model::CountPendingDecisionTasksOutcomeCallable CountPendingDecisionTasksCallable(
      const CountPendingDecisionTasksRequestT& request) const {
    return SubmitCallable(&SWFClient::CountPendingDecisionTasks, request);
  }

  /**
   * An Async wrapper for CountPendingDecisionTasks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CountPendingDecisionTasksRequestT = Model::CountPendingDecisionTasksRequest>
  void CountPendingDecisionTasksAsync(const CountPendingDecisionTasksRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteActivityType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteActivityType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteActivityTypeRequestT = Model::DeleteActivityTypeRequest>
  void DeleteActivityTypeAsync(const DeleteActivityTypeRequestT& request, const DeleteActivityTypeResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWorkflowType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWorkflowType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteWorkflowTypeRequestT = Model::DeleteWorkflowTypeRequest>
  void DeleteWorkflowTypeAsync(const DeleteWorkflowTypeRequestT& request, const DeleteWorkflowTypeResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeprecateActivityType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeprecateActivityType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeprecateActivityTypeRequestT = Model::DeprecateActivityTypeRequest>
  void DeprecateActivityTypeAsync(const DeprecateActivityTypeRequestT& request, const DeprecateActivityTypeResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeprecateDomain that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeprecateDomainRequestT = Model::DeprecateDomainRequest>
  void DeprecateDomainAsync(const DeprecateDomainRequestT& request, const DeprecateDomainResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeprecateWorkflowType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeprecateWorkflowType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeprecateWorkflowTypeRequestT = Model::DeprecateWorkflowTypeRequest>
  void DeprecateWorkflowTypeAsync(const DeprecateWorkflowTypeRequestT& request, const DeprecateWorkflowTypeResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeActivityType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeActivityType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeActivityTypeRequestT = Model::DescribeActivityTypeRequest>
  void DescribeActivityTypeAsync(const DescribeActivityTypeRequestT& request, const DescribeActivityTypeResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWorkflowExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeWorkflowExecutionRequestT = Model::DescribeWorkflowExecutionRequest>
  Model::DescribeWorkflowExecutionOutcomeCallable DescribeWorkflowExecutionCallable(
      const DescribeWorkflowExecutionRequestT& request) const {
    return SubmitCallable(&SWFClient::DescribeWorkflowExecution, request);
  }

  /**
   * An Async wrapper for DescribeWorkflowExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorkflowExecutionRequestT = Model::DescribeWorkflowExecutionRequest>
  void DescribeWorkflowExecutionAsync(const DescribeWorkflowExecutionRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeWorkflowType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWorkflowType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorkflowTypeRequestT = Model::DescribeWorkflowTypeRequest>
  void DescribeWorkflowTypeAsync(const DescribeWorkflowTypeRequestT& request, const DescribeWorkflowTypeResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetWorkflowExecutionHistoryOutcome GetWorkflowExecutionHistory(
      const Model::GetWorkflowExecutionHistoryRequest& request) const;

  /**
   * A Callable wrapper for GetWorkflowExecutionHistory that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetWorkflowExecutionHistoryRequestT = Model::GetWorkflowExecutionHistoryRequest>
  Model::GetWorkflowExecutionHistoryOutcomeCallable GetWorkflowExecutionHistoryCallable(
      const GetWorkflowExecutionHistoryRequestT& request) const {
    return SubmitCallable(&SWFClient::GetWorkflowExecutionHistory, request);
  }

  /**
   * An Async wrapper for GetWorkflowExecutionHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWorkflowExecutionHistoryRequestT = Model::GetWorkflowExecutionHistoryRequest>
  void GetWorkflowExecutionHistoryAsync(const GetWorkflowExecutionHistoryRequestT& request,
  ...
  /**
   * A Callable wrapper for ListActivityTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListActivityTypes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListActivityTypesRequestT = Model::ListActivityTypesRequest>
  void ListActivityTypesAsync(const ListActivityTypesRequestT& request, const ListActivityTypesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListClosedWorkflowExecutionsOutcome ListClosedWorkflowExecutions(
      const Model::ListClosedWorkflowExecutionsRequest& request) const;

  /**
   * A Callable wrapper for ListClosedWorkflowExecutions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListClosedWorkflowExecutionsRequestT = Model::ListClosedWorkflowExecutionsRequest>
  Model::ListClosedWorkflowExecutionsOutcomeCallable ListClosedWorkflowExecutionsCallable(
      const ListClosedWorkflowExecutionsRequestT& request) const {
    return SubmitCallable(&SWFClient::ListClosedWorkflowExecutions, request);
  }

  /**
   * An Async wrapper for ListClosedWorkflowExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListClosedWorkflowExecutionsRequestT = Model::ListClosedWorkflowExecutionsRequest>
  void ListClosedWorkflowExecutionsAsync(const ListClosedWorkflowExecutionsRequestT& request,
   ...
   */
  template <typename ListDomainsRequestT = Model::ListDomainsRequest>
  void ListDomainsAsync(const ListDomainsRequestT& request, const ListDomainsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListOpenWorkflowExecutionsOutcome ListOpenWorkflowExecutions(
      const Model::ListOpenWorkflowExecutionsRequest& request) const;

  /**
   * A Callable wrapper for ListOpenWorkflowExecutions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListOpenWorkflowExecutionsRequestT = Model::ListOpenWorkflowExecutionsRequest>
  Model::ListOpenWorkflowExecutionsOutcomeCallable ListOpenWorkflowExecutionsCallable(
      const ListOpenWorkflowExecutionsRequestT& request) const {
    return SubmitCallable(&SWFClient::ListOpenWorkflowExecutions, request);
  }

  /**
   * An Async wrapper for ListOpenWorkflowExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOpenWorkflowExecutionsRequestT = Model::ListOpenWorkflowExecutionsRequest>
  void ListOpenWorkflowExecutionsAsync(const ListOpenWorkflowExecutionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListWorkflowTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWorkflowTypes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListWorkflowTypesRequestT = Model::ListWorkflowTypesRequest>
  void ListWorkflowTypesAsync(const ListWorkflowTypesRequestT& request, const ListWorkflowTypesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PollForActivityTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PollForActivityTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PollForActivityTaskRequestT = Model::PollForActivityTaskRequest>
  void PollForActivityTaskAsync(const PollForActivityTaskRequestT& request, const PollForActivityTaskResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PollForDecisionTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PollForDecisionTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PollForDecisionTaskRequestT = Model::PollForDecisionTaskRequest>
  void PollForDecisionTaskAsync(const PollForDecisionTaskRequestT& request, const PollForDecisionTaskResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RecordActivityTaskHeartbeatOutcome RecordActivityTaskHeartbeat(
      const Model::RecordActivityTaskHeartbeatRequest& request) const;

  /**
   * A Callable wrapper for RecordActivityTaskHeartbeat that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RecordActivityTaskHeartbeatRequestT = Model::RecordActivityTaskHeartbeatRequest>
  Model::RecordActivityTaskHeartbeatOutcomeCallable RecordActivityTaskHeartbeatCallable(
      const RecordActivityTaskHeartbeatRequestT& request) const {
    return SubmitCallable(&SWFClient::RecordActivityTaskHeartbeat, request);
  }

  /**
   * An Async wrapper for RecordActivityTaskHeartbeat that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RecordActivityTaskHeartbeatRequestT = Model::RecordActivityTaskHeartbeatRequest>
  void RecordActivityTaskHeartbeatAsync(const RecordActivityTaskHeartbeatRequestT& request,
  ...
  /**
   * A Callable wrapper for RegisterActivityType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterActivityType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterActivityTypeRequestT = Model::RegisterActivityTypeRequest>
  void RegisterActivityTypeAsync(const RegisterActivityTypeRequestT& request, const RegisterActivityTypeResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterWorkflowType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterWorkflowType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterWorkflowTypeRequestT = Model::RegisterWorkflowTypeRequest>
  void RegisterWorkflowTypeAsync(const RegisterWorkflowTypeRequestT& request, const RegisterWorkflowTypeResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RequestCancelWorkflowExecutionOutcome RequestCancelWorkflowExecution(
      const Model::RequestCancelWorkflowExecutionRequest& request) const;

  /**
   * A Callable wrapper for RequestCancelWorkflowExecution that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RequestCancelWorkflowExecutionRequestT = Model::RequestCancelWorkflowExecutionRequest>
  Model::RequestCancelWorkflowExecutionOutcomeCallable RequestCancelWorkflowExecutionCallable(
      const RequestCancelWorkflowExecutionRequestT& request) const {
    return SubmitCallable(&SWFClient::RequestCancelWorkflowExecution, request);
  }

  /**
   * An Async wrapper for RequestCancelWorkflowExecution that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RequestCancelWorkflowExecutionRequestT = Model::RequestCancelWorkflowExecutionRequest>
  void RequestCancelWorkflowExecutionAsync(const RequestCancelWorkflowExecutionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RespondActivityTaskCanceledOutcome RespondActivityTaskCanceled(
      const Model::RespondActivityTaskCanceledRequest& request) const;

  /**
   * A Callable wrapper for RespondActivityTaskCanceled that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RespondActivityTaskCanceledRequestT = Model::RespondActivityTaskCanceledRequest>
  Model::RespondActivityTaskCanceledOutcomeCallable RespondActivityTaskCanceledCallable(
      const RespondActivityTaskCanceledRequestT& request) const {
    return SubmitCallable(&SWFClient::RespondActivityTaskCanceled, request);
  }

  /**
   * An Async wrapper for RespondActivityTaskCanceled that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RespondActivityTaskCanceledRequestT = Model::RespondActivityTaskCanceledRequest>
  void RespondActivityTaskCanceledAsync(const RespondActivityTaskCanceledRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RespondActivityTaskCompletedOutcome RespondActivityTaskCompleted(
      const Model::RespondActivityTaskCompletedRequest& request) const;

  /**
   * A Callable wrapper for RespondActivityTaskCompleted that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RespondActivityTaskCompletedRequestT = Model::RespondActivityTaskCompletedRequest>
  Model::RespondActivityTaskCompletedOutcomeCallable RespondActivityTaskCompletedCallable(
      const RespondActivityTaskCompletedRequestT& request) const {
    return SubmitCallable(&SWFClient::RespondActivityTaskCompleted, request);
  }

  /**
   * An Async wrapper for RespondActivityTaskCompleted that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RespondActivityTaskCompletedRequestT = Model::RespondActivityTaskCompletedRequest>
  void RespondActivityTaskCompletedAsync(const RespondActivityTaskCompletedRequestT& request,
  ...
  /**
   * A Callable wrapper for RespondActivityTaskFailed that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RespondActivityTaskFailedRequestT = Model::RespondActivityTaskFailedRequest>
  Model::RespondActivityTaskFailedOutcomeCallable RespondActivityTaskFailedCallable(
      const RespondActivityTaskFailedRequestT& request) const {
    return SubmitCallable(&SWFClient::RespondActivityTaskFailed, request);
  }

  /**
   * An Async wrapper for RespondActivityTaskFailed that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RespondActivityTaskFailedRequestT = Model::RespondActivityTaskFailedRequest>
  void RespondActivityTaskFailedAsync(const RespondActivityTaskFailedRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RespondDecisionTaskCompletedOutcome RespondDecisionTaskCompleted(
      const Model::RespondDecisionTaskCompletedRequest& request) const;

  /**
   * A Callable wrapper for RespondDecisionTaskCompleted that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RespondDecisionTaskCompletedRequestT = Model::RespondDecisionTaskCompletedRequest>
  Model::RespondDecisionTaskCompletedOutcomeCallable RespondDecisionTaskCompletedCallable(
      const RespondDecisionTaskCompletedRequestT& request) const {
    return SubmitCallable(&SWFClient::RespondDecisionTaskCompleted, request);
  }

  /**
   * An Async wrapper for RespondDecisionTaskCompleted that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RespondDecisionTaskCompletedRequestT = Model::RespondDecisionTaskCompletedRequest>
  void RespondDecisionTaskCompletedAsync(const RespondDecisionTaskCompletedRequestT& request,
  ...
  /**
   * A Callable wrapper for SignalWorkflowExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SignalWorkflowExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SignalWorkflowExecutionRequestT = Model::SignalWorkflowExecutionRequest>
  void SignalWorkflowExecutionAsync(const SignalWorkflowExecutionRequestT& request,
  ...
  /**
   * A Callable wrapper for StartWorkflowExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartWorkflowExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartWorkflowExecutionRequestT = Model::StartWorkflowExecutionRequest>
  void StartWorkflowExecutionAsync(const StartWorkflowExecutionRequestT& request,
  ...
  virtual Model::TerminateWorkflowExecutionOutcome TerminateWorkflowExecution(
      const Model::TerminateWorkflowExecutionRequest& request) const;

  /**
   * A Callable wrapper for TerminateWorkflowExecution that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename TerminateWorkflowExecutionRequestT = Model::TerminateWorkflowExecutionRequest>
  Model::TerminateWorkflowExecutionOutcomeCallable TerminateWorkflowExecutionCallable(
      const TerminateWorkflowExecutionRequestT& request) const {
    return SubmitCallable(&SWFClient::TerminateWorkflowExecution, request);
  }

  /**
   * An Async wrapper for TerminateWorkflowExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TerminateWorkflowExecutionRequestT = Model::TerminateWorkflowExecutionRequest>
  void TerminateWorkflowExecutionAsync(const TerminateWorkflowExecutionRequestT& request,
  ...
  /**
   * A Callable wrapper for UndeprecateActivityType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UndeprecateActivityType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UndeprecateActivityTypeRequestT = Model::UndeprecateActivityTypeRequest>
  void UndeprecateActivityTypeAsync(const UndeprecateActivityTypeRequestT& request,
  ...
  /**
   * A Callable wrapper for UndeprecateDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UndeprecateDomain that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UndeprecateDomainRequestT = Model::UndeprecateDomainRequest>
  void UndeprecateDomainAsync(const UndeprecateDomainRequestT& request, const UndeprecateDomainResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UndeprecateWorkflowType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UndeprecateWorkflowType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UndeprecateWorkflowTypeRequestT = Model::UndeprecateWorkflowTypeRequest>
  void UndeprecateWorkflowTypeAsync(const UndeprecateWorkflowTypeRequestT& request,
