...
class AWS_LAUNCHWIZARD_API LaunchWizardClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  LaunchWizardClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<LaunchWizardEndpointProviderBase> endpointProvider = nullptr,
      const Aws::LaunchWizard::LaunchWizardClientConfiguration& clientConfiguration = Aws::LaunchWizard::LaunchWizardClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::GetWorkloadDeploymentPatternOutcome GetWorkloadDeploymentPattern(
      const Model::GetWorkloadDeploymentPatternRequest& request) const;

  /**
   * A Callable wrapper for GetWorkloadDeploymentPattern that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetWorkloadDeploymentPatternRequestT = Model::GetWorkloadDeploymentPatternRequest>
  Model::GetWorkloadDeploymentPatternOutcomeCallable GetWorkloadDeploymentPatternCallable(
      const GetWorkloadDeploymentPatternRequestT& request) const {
    return SubmitCallable(&LaunchWizardClient::GetWorkloadDeploymentPattern, request);
  }

  /**
   * An Async wrapper for GetWorkloadDeploymentPattern that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWorkloadDeploymentPatternRequestT = Model::GetWorkloadDeploymentPatternRequest>
  void GetWorkloadDeploymentPatternAsync(const GetWorkloadDeploymentPatternRequestT& request,
                                         const GetWorkloadDeploymentPatternResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDeploymentEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDeploymentEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDeploymentEventsRequestT = Model::ListDeploymentEventsRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::ListWorkloadDeploymentPatternsOutcome ListWorkloadDeploymentPatterns(
      const Model::ListWorkloadDeploymentPatternsRequest& request) const;

  /**
   * A Callable wrapper for ListWorkloadDeploymentPatterns that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListWorkloadDeploymentPatternsRequestT = Model::ListWorkloadDeploymentPatternsRequest>
  Model::ListWorkloadDeploymentPatternsOutcomeCallable ListWorkloadDeploymentPatternsCallable(
      const ListWorkloadDeploymentPatternsRequestT& request) const {
    return SubmitCallable(&LaunchWizardClient::ListWorkloadDeploymentPatterns, request);
  }

  /**
   * An Async wrapper for ListWorkloadDeploymentPatterns that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListWorkloadDeploymentPatternsRequestT = Model::ListWorkloadDeploymentPatternsRequest>
  void ListWorkloadDeploymentPatternsAsync(const ListWorkloadDeploymentPatternsRequestT& request,
                                           const ListWorkloadDeploymentPatternsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
