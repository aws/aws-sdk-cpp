...
namespace LaunchWizard
{
   ...
   */
  class AWS_LAUNCHWIZARD_API LaunchWizardClient : Aws::Client::ClientWithAsyncTemplateMethods<LaunchWizardClient>,
    smithy::client::AwsSmithyClientT<Aws::LaunchWizard::SERVICE_NAME,
