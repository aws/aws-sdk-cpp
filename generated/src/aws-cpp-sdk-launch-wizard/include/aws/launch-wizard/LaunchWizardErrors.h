...
public:
  ...
  LaunchWizardError(const Aws::Client::AWSError<LaunchWizardErrors>& rhs) : Aws::Client::AWSError<LaunchWizardErrors>(rhs) {}
  LaunchWizardError(Aws::Client::AWSError<LaunchWizardErrors>&& rhs) : Aws::Client::AWSError<LaunchWizardErrors>(rhs) {}
