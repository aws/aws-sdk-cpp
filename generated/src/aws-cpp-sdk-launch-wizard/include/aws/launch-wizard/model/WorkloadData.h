...
class WorkloadData {
 public:
  ...
  template <typename AccountConstraintsT = Aws::Vector<AccountConstraint>>
  WorkloadData& WithAccountConstraints(AccountConstraintsT&& value) {
    SetAccountConstraints(std::forward<AccountConstraintsT>(value));
    return *this;
  }
  template <typename AccountConstraintsT = AccountConstraint>
  WorkloadData& AddAccountConstraints(AccountConstraintsT&& value) {
    m_accountConstraintsHasBeenSet = true;
  ...
  void SetIconUrl(IconUrlT&& value) {
    ...
    m_iconUrl = std::forward<IconUrlT>(value);
  }
  template <typename IconUrlT = Aws::String>
  WorkloadData& WithIconUrl(IconUrlT&& value) {
    SetIconUrl(std::forward<IconUrlT>(value));
    return *this;
  }
  ///@}
