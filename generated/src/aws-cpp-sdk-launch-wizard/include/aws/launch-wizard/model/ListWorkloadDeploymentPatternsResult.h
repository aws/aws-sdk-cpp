...
class ListWorkloadDeploymentPatternsResult {
 public:
  ...
  AWS_LAUNCHWIZARD_API ListWorkloadDeploymentPatternsResult& operator=(
  ...
  inline const Aws::Vector<WorkloadDeploymentPatternDataSummary>& GetWorkloadDeploymentPatterns() const {
    return m_workloadDeploymentPatterns;
  }
  template <typename WorkloadDeploymentPatternsT = Aws::Vector<WorkloadDeploymentPatternDataSummary>>
  void SetWorkloadDeploymentPatterns(WorkloadDeploymentPatternsT&& value) {
    m_workloadDeploymentPatternsHasBeenSet = true;
    m_workloadDeploymentPatterns = std::forward<WorkloadDeploymentPatternsT>(value);
  }
  template <typename WorkloadDeploymentPatternsT = Aws::Vector<WorkloadDeploymentPatternDataSummary>>
  ListWorkloadDeploymentPatternsResult& WithWorkloadDeploymentPatterns(WorkloadDeploymentPatternsT&& value) {
    SetWorkloadDeploymentPatterns(std::forward<WorkloadDeploymentPatternsT>(value));
    return *this;
  }
  template <typename WorkloadDeploymentPatternsT = WorkloadDeploymentPatternDataSummary>
  ListWorkloadDeploymentPatternsResult& AddWorkloadDeploymentPatterns(WorkloadDeploymentPatternsT&& value) {
    m_workloadDeploymentPatternsHasBeenSet = true;
    m_workloadDeploymentPatterns.emplace_back(std::forward<WorkloadDeploymentPatternsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkloadDeploymentPatternsResult& WithRequestId(RequestIdT&& value) {
