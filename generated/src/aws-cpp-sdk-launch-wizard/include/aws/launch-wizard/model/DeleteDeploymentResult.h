...
class DeleteDeploymentResult {
 public:
  ...
  inline DeleteDeploymentResult& WithStatus(DeploymentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  DeleteDeploymentResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDeploymentResult& WithRequestId(RequestIdT&& value) {
