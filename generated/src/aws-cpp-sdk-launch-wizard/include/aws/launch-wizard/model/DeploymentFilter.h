...
class DeploymentFilter {
 public:
  ...
  inline void SetName(DeploymentFilterKey value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DeploymentFilter& WithName(DeploymentFilterKey value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  DeploymentFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  DeploymentFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
