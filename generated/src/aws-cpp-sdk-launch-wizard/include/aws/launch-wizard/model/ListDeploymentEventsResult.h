...
class ListDeploymentEventsResult {
 public:
  ...
  void SetDeploymentEvents(DeploymentEventsT&& value) {
    m_deploymentEventsHasBeenSet = true;
    m_deploymentEvents = std::forward<DeploymentEventsT>(value);
  }
  template <typename DeploymentEventsT = Aws::Vector<DeploymentEventDataSummary>>
  ListDeploymentEventsResult& WithDeploymentEvents(DeploymentEventsT&& value) {
    SetDeploymentEvents(std::forward<DeploymentEventsT>(value));
    return *this;
  }
  template <typename DeploymentEventsT = DeploymentEventDataSummary>
  ListDeploymentEventsResult& AddDeploymentEvents(DeploymentEventsT&& value) {
    m_deploymentEventsHasBeenSet = true;
    m_deploymentEvents.emplace_back(std::forward<DeploymentEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDeploymentEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDeploymentEventsResult& WithRequestId(RequestIdT&& value) {
