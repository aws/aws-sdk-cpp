...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public LaunchWizardRequest
  {
  public:
    AWS_LAUNCHWIZARD_API UntagResourceRequest() = default;
    ...
    AWS_LAUNCHWIZARD_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
