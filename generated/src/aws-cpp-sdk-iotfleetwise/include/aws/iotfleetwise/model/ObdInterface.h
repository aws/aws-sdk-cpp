...
class ObdInterface {
 public:
  ...
  inline void SetRequestMessageId(int value) {
    m_requestMessageIdHasBeenSet = true;
    m_requestMessageId = value;
  }
  inline ObdInterface& WithRequestMessageId(int value) {
    SetRequestMessageId(value);
    return *this;
  }
  ///@}
  ...
  void SetObdStandard(ObdStandardT&& value) {
    ...
    m_obdStandard = std::forward<ObdStandardT>(value);
  }
  template <typename ObdStandardT = Aws::String>
  ObdInterface& WithObdStandard(ObdStandardT&& value) {
    SetObdStandard(std::forward<ObdStandardT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPidRequestIntervalSeconds(int value) {
    m_pidRequestIntervalSecondsHasBeenSet = true;
    m_pidRequestIntervalSeconds = value;
  }
  inline ObdInterface& WithPidRequestIntervalSeconds(int value) {
    SetPidRequestIntervalSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDtcRequestIntervalSeconds(int value) {
    m_dtcRequestIntervalSecondsHasBeenSet = true;
    m_dtcRequestIntervalSeconds = value;
  }
  inline ObdInterface& WithDtcRequestIntervalSeconds(int value) {
    SetDtcRequestIntervalSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUseExtendedIds(bool value) {
    m_useExtendedIdsHasBeenSet = true;
    m_useExtendedIds = value;
  }
  inline ObdInterface& WithUseExtendedIds(bool value) {
    SetUseExtendedIds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHasTransmissionEcu(bool value) {
    m_hasTransmissionEcuHasBeenSet = true;
    m_hasTransmissionEcu = value;
  }
  inline ObdInterface& WithHasTransmissionEcu(bool value) {
    SetHasTransmissionEcu(value);
    return *this;
  }
  ///@}
 private:
