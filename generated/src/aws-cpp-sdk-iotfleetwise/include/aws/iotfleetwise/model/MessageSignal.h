...
class MessageSignal {
 public:
  ...
  template <typename TopicNameT = Aws::String>
  MessageSignal& WithTopicName(TopicNameT&& value) {
  ...
  void SetStructuredMessage(StructuredMessageT&& value) {
    m_structuredMessageHasBeenSet = true;
    m_structuredMessage = std::forward<StructuredMessageT>(value);
  }
  template <typename StructuredMessageT = StructuredMessage>
  MessageSignal& WithStructuredMessage(StructuredMessageT&& value) {
    SetStructuredMessage(std::forward<StructuredMessageT>(value));
    return *this;
  }
  ///@}
 private:
