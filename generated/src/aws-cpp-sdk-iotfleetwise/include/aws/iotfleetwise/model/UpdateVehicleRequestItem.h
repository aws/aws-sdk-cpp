...
class UpdateVehicleRequestItem {
 public:
  ...
  inline void SetAttributeUpdateMode(UpdateMode value) {
    m_attributeUpdateModeHasBeenSet = true;
    m_attributeUpdateMode = value;
  }
  inline UpdateVehicleRequestItem& WithAttributeUpdateMode(UpdateMode value) {
    SetAttributeUpdateMode(value);
    return *this;
  }
  ///@}
  ...
  void SetStateTemplatesToAdd(StateTemplatesToAddT&& value) {
    ...
    m_stateTemplatesToAdd = std::forward<StateTemplatesToAddT>(value);
  }
  template <typename StateTemplatesToAddT = Aws::Vector<StateTemplateAssociation>>
  UpdateVehicleRequestItem& WithStateTemplatesToAdd(StateTemplatesToAddT&& value) {
    SetStateTemplatesToAdd(std::forward<StateTemplatesToAddT>(value));
    return *this;
  }
  ...
  UpdateVehicleRequestItem& AddStateTemplatesToAdd(StateTemplatesToAddT&& value) {
    m_stateTemplatesToAddHasBeenSet = true;
    m_stateTemplatesToAdd.emplace_back(std::forward<StateTemplatesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStateTemplatesToRemove(StateTemplatesToRemoveT&& value) {
    ...
    m_stateTemplatesToRemove = std::forward<StateTemplatesToRemoveT>(value);
  }
  template <typename StateTemplatesToRemoveT = Aws::Vector<Aws::String>>
  UpdateVehicleRequestItem& WithStateTemplatesToRemove(StateTemplatesToRemoveT&& value) {
    SetStateTemplatesToRemove(std::forward<StateTemplatesToRemoveT>(value));
    return *this;
  }
  ...
  UpdateVehicleRequestItem& AddStateTemplatesToRemove(StateTemplatesToRemoveT&& value) {
    m_stateTemplatesToRemoveHasBeenSet = true;
    m_stateTemplatesToRemove.emplace_back(std::forward<StateTemplatesToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStateTemplatesToUpdate(StateTemplatesToUpdateT&& value) {
    ...
    m_stateTemplatesToUpdate = std::forward<StateTemplatesToUpdateT>(value);
  }
  template <typename StateTemplatesToUpdateT = Aws::Vector<StateTemplateAssociation>>
  UpdateVehicleRequestItem& WithStateTemplatesToUpdate(StateTemplatesToUpdateT&& value) {
    SetStateTemplatesToUpdate(std::forward<StateTemplatesToUpdateT>(value));
    return *this;
  }
  ...
  UpdateVehicleRequestItem& AddStateTemplatesToUpdate(StateTemplatesToUpdateT&& value) {
    m_stateTemplatesToUpdateHasBeenSet = true;
    m_stateTemplatesToUpdate.emplace_back(std::forward<StateTemplatesToUpdateT>(value));
    return *this;
  }
  ///@}
 private:
