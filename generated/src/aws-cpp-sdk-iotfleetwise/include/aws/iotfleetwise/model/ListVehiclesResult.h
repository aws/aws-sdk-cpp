...
class ListVehiclesResult {
 public:
  ...
  void SetVehicleSummaries(VehicleSummariesT&& value) {
    m_vehicleSummariesHasBeenSet = true;
    m_vehicleSummaries = std::forward<VehicleSummariesT>(value);
  }
  template <typename VehicleSummariesT = Aws::Vector<VehicleSummary>>
  ListVehiclesResult& WithVehicleSummaries(VehicleSummariesT&& value) {
    SetVehicleSummaries(std::forward<VehicleSummariesT>(value));
    return *this;
  }
  template <typename VehicleSummariesT = VehicleSummary>
  ListVehiclesResult& AddVehicleSummaries(VehicleSummariesT&& value) {
    m_vehicleSummariesHasBeenSet = true;
    m_vehicleSummaries.emplace_back(std::forward<VehicleSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVehiclesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVehiclesResult& WithRequestId(RequestIdT&& value) {
