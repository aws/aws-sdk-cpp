...
class SignalFetchInformation {
 public:
  ...
  void SetSignalFetchConfig(SignalFetchConfigT&& value) {
    m_signalFetchConfigHasBeenSet = true;
    m_signalFetchConfig = std::forward<SignalFetchConfigT>(value);
  }
  template <typename SignalFetchConfigT = SignalFetchConfig>
  SignalFetchInformation& WithSignalFetchConfig(SignalFetchConfigT&& value) {
    SetSignalFetchConfig(std::forward<SignalFetchConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline SignalFetchInformation& WithConditionLanguageVersion(int value) {
