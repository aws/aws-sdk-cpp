...
class ModelManifestSummary {
 public:
  ...
  template <typename NameT = Aws::String>
  ModelManifestSummary& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ModelManifestSummary& WithArn(ArnT&& value) {
  ...
  template <typename SignalCatalogArnT = Aws::String>
  ModelManifestSummary& WithSignalCatalogArn(SignalCatalogArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ModelManifestSummary& WithDescription(DescriptionT&& value) {
  ...
  inline ModelManifestSummary& WithStatus(ManifestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ModelManifestSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModificationTimeT = Aws::Utils::DateTime>
  ModelManifestSummary& WithLastModificationTime(LastModificationTimeT&& value) {
