...
class CreateStateTemplateResult {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateStateTemplateResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateStateTemplateResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateStateTemplateResult& WithId(IdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateStateTemplateResult& WithRequestId(RequestIdT&& value) {
