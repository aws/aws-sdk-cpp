...
class ListModelManifestsRequest : public IoTFleetWiseRequest {
 public:
  ...
  template <typename SignalCatalogArnT = Aws::String>
  ListModelManifestsRequest& WithSignalCatalogArn(SignalCatalogArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListModelManifestsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListModelManifestsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelManifestsRequest& WithListResponseScope(ListResponseScope value) {
