...
class ListVehiclesInFleetRequest : public IoTFleetWiseRequest {
 public:
  ...
  template <typename FleetIdT = Aws::String>
  ListVehiclesInFleetRequest& WithFleetId(FleetIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListVehiclesInFleetRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListVehiclesInFleetRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
