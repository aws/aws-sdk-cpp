...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETWISE_API ListVehiclesInFleetRequest() = default;
    ...
    template<typename FleetIdT = Aws::String>
    ListVehiclesInFleetRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListVehiclesInFleetRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
