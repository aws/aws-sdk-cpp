...
class CustomProperty {
 public:
  ...
  inline CustomProperty& WithDataType(NodeDataType value) {
    SetDataType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDataEncoding(NodeDataEncoding value) {
    m_dataEncodingHasBeenSet = true;
    m_dataEncoding = value;
  }
  inline CustomProperty& WithDataEncoding(NodeDataEncoding value) {
    SetDataEncoding(value);
    return *this;
  }
  ///@}
