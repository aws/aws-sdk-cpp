...
class StorageMinimumTimeToLive {
 public:
  ...
  inline void SetUnit(StorageMinimumTimeToLiveUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline StorageMinimumTimeToLive& WithUnit(StorageMinimumTimeToLiveUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline StorageMinimumTimeToLive& WithValue(int value) {
    SetValue(value);
    return *this;
  }
  ///@}
