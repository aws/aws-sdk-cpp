...
class ListSignalCatalogNodesResult {
 public:
  ...
  template <typename NodesT = Aws::Vector<Node>>
  ListSignalCatalogNodesResult& WithNodes(NodesT&& value) {
    SetNodes(std::forward<NodesT>(value));
    return *this;
  }
  template <typename NodesT = Node>
  ListSignalCatalogNodesResult& AddNodes(NodesT&& value) {
    m_nodesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSignalCatalogNodesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSignalCatalogNodesResult& WithRequestId(RequestIdT&& value) {
