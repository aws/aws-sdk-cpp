...
class DecoderManifestValidationException {
 public:
  ...
  void SetInvalidSignals(InvalidSignalsT&& value) {
    m_invalidSignalsHasBeenSet = true;
    m_invalidSignals = std::forward<InvalidSignalsT>(value);
  }
  template <typename InvalidSignalsT = Aws::Vector<InvalidSignalDecoder>>
  DecoderManifestValidationException& WithInvalidSignals(InvalidSignalsT&& value) {
    SetInvalidSignals(std::forward<InvalidSignalsT>(value));
    return *this;
  }
  template <typename InvalidSignalsT = InvalidSignalDecoder>
  DecoderManifestValidationException& AddInvalidSignals(InvalidSignalsT&& value) {
    m_invalidSignalsHasBeenSet = true;
    m_invalidSignals.emplace_back(std::forward<InvalidSignalsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvalidNetworkInterfaces(InvalidNetworkInterfacesT&& value) {
    m_invalidNetworkInterfacesHasBeenSet = true;
    m_invalidNetworkInterfaces = std::forward<InvalidNetworkInterfacesT>(value);
  }
  template <typename InvalidNetworkInterfacesT = Aws::Vector<InvalidNetworkInterface>>
  DecoderManifestValidationException& WithInvalidNetworkInterfaces(InvalidNetworkInterfacesT&& value) {
    SetInvalidNetworkInterfaces(std::forward<InvalidNetworkInterfacesT>(value));
    return *this;
  }
  template <typename InvalidNetworkInterfacesT = InvalidNetworkInterface>
  DecoderManifestValidationException& AddInvalidNetworkInterfaces(InvalidNetworkInterfacesT&& value) {
    m_invalidNetworkInterfacesHasBeenSet = true;
    m_invalidNetworkInterfaces.emplace_back(std::forward<InvalidNetworkInterfacesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  DecoderManifestValidationException& WithMessage(MessageT&& value) {
