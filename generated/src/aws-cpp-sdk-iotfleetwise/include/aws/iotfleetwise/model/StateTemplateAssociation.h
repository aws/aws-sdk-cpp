...
class StateTemplateAssociation {
 public:
  ...
  void SetStateTemplateUpdateStrategy(StateTemplateUpdateStrategyT&& value) {
    ...
    m_stateTemplateUpdateStrategy = std::forward<StateTemplateUpdateStrategyT>(value);
  }
  template <typename StateTemplateUpdateStrategyT = StateTemplateUpdateStrategy>
  StateTemplateAssociation& WithStateTemplateUpdateStrategy(StateTemplateUpdateStrategyT&& value) {
    SetStateTemplateUpdateStrategy(std::forward<StateTemplateUpdateStrategyT>(value));
    return *this;
  }
  ///@}
 private:
