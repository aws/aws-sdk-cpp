...
class SignalInformation {
 public:
  ...
  template <typename NameT = Aws::String>
  SignalInformation& WithName(NameT&& value) {
  ...
  inline void SetMaxSampleCount(long long value) {
    m_maxSampleCountHasBeenSet = true;
    m_maxSampleCount = value;
  }
  inline SignalInformation& WithMaxSampleCount(long long value) {
    SetMaxSampleCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumSamplingIntervalMs(long long value) {
    m_minimumSamplingIntervalMsHasBeenSet = true;
    m_minimumSamplingIntervalMs = value;
  }
  inline SignalInformation& WithMinimumSamplingIntervalMs(long long value) {
    SetMinimumSamplingIntervalMs(value);
    return *this;
  }
  ///@}
  ...
  void SetDataPartitionId(DataPartitionIdT&& value) {
    m_dataPartitionIdHasBeenSet = true;
    m_dataPartitionId = std::forward<DataPartitionIdT>(value);
  }
  template <typename DataPartitionIdT = Aws::String>
  SignalInformation& WithDataPartitionId(DataPartitionIdT&& value) {
    SetDataPartitionId(std::forward<DataPartitionIdT>(value));
    return *this;
  }
  ///@}
 private:
