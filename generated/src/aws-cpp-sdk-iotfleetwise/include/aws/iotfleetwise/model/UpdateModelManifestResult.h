...
namespace Model
{
  class UpdateModelManifestResult
  {
  public:
    AWS_IOTFLEETWISE_API UpdateModelManifestResult();
    AWS_IOTFLEETWISE_API UpdateModelManifestResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_IOTFLEETWISE_API UpdateModelManifestResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline UpdateModelManifestResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateModelManifestResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateModelManifestResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
