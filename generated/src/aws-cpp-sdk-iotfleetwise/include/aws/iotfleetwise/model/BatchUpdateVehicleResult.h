...
class BatchUpdateVehicleResult {
 public:
  ...
  template <typename VehiclesT = Aws::Vector<UpdateVehicleResponseItem>>
  BatchUpdateVehicleResult& WithVehicles(VehiclesT&& value) {
    SetVehicles(std::forward<VehiclesT>(value));
    return *this;
  }
  template <typename VehiclesT = UpdateVehicleResponseItem>
  BatchUpdateVehicleResult& AddVehicles(VehiclesT&& value) {
    m_vehiclesHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<UpdateVehicleError>>
  BatchUpdateVehicleResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = UpdateVehicleError>
  BatchUpdateVehicleResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchUpdateVehicleResult& WithRequestId(RequestIdT&& value) {
