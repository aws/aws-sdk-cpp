...
class PeriodicStateTemplateUpdateStrategy {
 public:
  ...
  void SetStateTemplateUpdateRate(StateTemplateUpdateRateT&& value) {
    m_stateTemplateUpdateRateHasBeenSet = true;
    m_stateTemplateUpdateRate = std::forward<StateTemplateUpdateRateT>(value);
  }
  template <typename StateTemplateUpdateRateT = TimePeriod>
  PeriodicStateTemplateUpdateStrategy& WithStateTemplateUpdateRate(StateTemplateUpdateRateT&& value) {
    SetStateTemplateUpdateRate(std::forward<StateTemplateUpdateRateT>(value));
    return *this;
  }
  ///@}
 private:
