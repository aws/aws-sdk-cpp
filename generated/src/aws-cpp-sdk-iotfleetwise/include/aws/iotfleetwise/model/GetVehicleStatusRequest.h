...
class GetVehicleStatusRequest : public IoTFleetWiseRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  GetVehicleStatusRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetVehicleStatusRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename VehicleNameT = Aws::String>
  GetVehicleStatusRequest& WithVehicleName(VehicleNameT&& value) {
