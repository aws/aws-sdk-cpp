...
class ListFleetsForVehicleResult {
 public:
  ...
  template <typename FleetsT = Aws::Vector<Aws::String>>
  ListFleetsForVehicleResult& WithFleets(FleetsT&& value) {
    SetFleets(std::forward<FleetsT>(value));
    return *this;
  }
  template <typename FleetsT = Aws::String>
  ListFleetsForVehicleResult& AddFleets(FleetsT&& value) {
    m_fleetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListFleetsForVehicleResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFleetsForVehicleResult& WithRequestId(RequestIdT&& value) {
