...
class ImportDecoderManifestResult {
 public:
  ...
  template <typename NameT = Aws::String>
  ImportDecoderManifestResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ImportDecoderManifestResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ImportDecoderManifestResult& WithRequestId(RequestIdT&& value) {
