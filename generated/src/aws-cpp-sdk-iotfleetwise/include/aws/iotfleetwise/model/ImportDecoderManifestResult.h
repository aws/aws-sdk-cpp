...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETWISE_API ImportDecoderManifestResult() = default;
    ...
    template<typename NameT = Aws::String>
    ImportDecoderManifestResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    ImportDecoderManifestResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ImportDecoderManifestResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
