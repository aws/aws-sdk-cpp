...
namespace Model
{
  ...
  public:
    ...
    inline ImportDecoderManifestResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ImportDecoderManifestResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ImportDecoderManifestResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
