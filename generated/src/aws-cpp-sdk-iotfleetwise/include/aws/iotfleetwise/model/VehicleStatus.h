...
class VehicleStatus {
 public:
  ...
  template <typename CampaignNameT = Aws::String>
  VehicleStatus& WithCampaignName(CampaignNameT&& value) {
  ...
  template <typename VehicleNameT = Aws::String>
  VehicleStatus& WithVehicleName(VehicleNameT&& value) {
  ...
  inline void SetStatus(VehicleState value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline VehicleStatus& WithStatus(VehicleState value) {
    SetStatus(value);
    return *this;
  }
  ///@}
