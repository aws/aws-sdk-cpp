...
class DeleteStateTemplateResult {
 public:
  ...
  template <typename NameT = Aws::String>
  DeleteStateTemplateResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteStateTemplateResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  DeleteStateTemplateResult& WithId(IdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteStateTemplateResult& WithRequestId(RequestIdT&& value) {
