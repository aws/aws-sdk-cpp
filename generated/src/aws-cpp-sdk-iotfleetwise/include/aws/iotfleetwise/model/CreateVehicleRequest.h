...
class CreateVehicleRequest : public IoTFleetWiseRequest {
 public:
  ...
  template <typename VehicleNameT = Aws::String>
  CreateVehicleRequest& WithVehicleName(VehicleNameT&& value) {
  ...
  template <typename ModelManifestArnT = Aws::String>
  CreateVehicleRequest& WithModelManifestArn(ModelManifestArnT&& value) {
  ...
  template <typename DecoderManifestArnT = Aws::String>
  CreateVehicleRequest& WithDecoderManifestArn(DecoderManifestArnT&& value) {
  ...
  template <typename AttributesT = Aws::Map<Aws::String, Aws::String>>
  CreateVehicleRequest& WithAttributes(AttributesT&& value) {
  ...
  inline CreateVehicleRequest& WithAssociationBehavior(VehicleAssociationBehavior value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateVehicleRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateVehicleRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename StateTemplatesT = Aws::Vector<StateTemplateAssociation>>
  CreateVehicleRequest& WithStateTemplates(StateTemplatesT&& value) {
    SetStateTemplates(std::forward<StateTemplatesT>(value));
    return *this;
  }
  template <typename StateTemplatesT = StateTemplateAssociation>
  CreateVehicleRequest& AddStateTemplates(StateTemplatesT&& value) {
    m_stateTemplatesHasBeenSet = true;
