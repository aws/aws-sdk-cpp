...
class InvalidNetworkInterface {
 public:
  ...
  template <typename InterfaceIdT = Aws::String>
  InvalidNetworkInterface& WithInterfaceId(InterfaceIdT&& value) {
  ...
  inline void SetReason(NetworkInterfaceFailureReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline InvalidNetworkInterface& WithReason(NetworkInterfaceFailureReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
