...
class InvalidSignalDecoder {
 public:
  ...
  template <typename NameT = Aws::String>
  InvalidSignalDecoder& WithName(NameT&& value) {
  ...
  inline void SetReason(SignalDecoderFailureReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline InvalidSignalDecoder& WithReason(SignalDecoderFailureReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
  ...
  void SetHint(HintT&& value) {
    m_hintHasBeenSet = true;
    m_hint = std::forward<HintT>(value);
  }
  template <typename HintT = Aws::String>
  InvalidSignalDecoder& WithHint(HintT&& value) {
    SetHint(std::forward<HintT>(value));
    return *this;
  }
  ///@}
 private:
