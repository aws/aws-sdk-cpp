...
class GetRegisterAccountStatusResult {
 public:
  ...
  void SetCustomerAccountId(CustomerAccountIdT&& value) {
    m_customerAccountIdHasBeenSet = true;
    m_customerAccountId = std::forward<CustomerAccountIdT>(value);
  }
  template <typename CustomerAccountIdT = Aws::String>
  GetRegisterAccountStatusResult& WithCustomerAccountId(CustomerAccountIdT&& value) {
    SetCustomerAccountId(std::forward<CustomerAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAccountStatus(RegistrationStatus value) {
    m_accountStatusHasBeenSet = true;
    m_accountStatus = value;
  }
  inline GetRegisterAccountStatusResult& WithAccountStatus(RegistrationStatus value) {
  ...
  void SetTimestreamRegistrationResponse(TimestreamRegistrationResponseT&& value) {
    m_timestreamRegistrationResponseHasBeenSet = true;
    m_timestreamRegistrationResponse = std::forward<TimestreamRegistrationResponseT>(value);
  }
  template <typename TimestreamRegistrationResponseT = TimestreamRegistrationResponse>
  GetRegisterAccountStatusResult& WithTimestreamRegistrationResponse(TimestreamRegistrationResponseT&& value) {
    SetTimestreamRegistrationResponse(std::forward<TimestreamRegistrationResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIamRegistrationResponse(IamRegistrationResponseT&& value) {
    m_iamRegistrationResponseHasBeenSet = true;
    m_iamRegistrationResponse = std::forward<IamRegistrationResponseT>(value);
  }
  template <typename IamRegistrationResponseT = IamRegistrationResponse>
  GetRegisterAccountStatusResult& WithIamRegistrationResponse(IamRegistrationResponseT&& value) {
    SetIamRegistrationResponse(std::forward<IamRegistrationResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetRegisterAccountStatusResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModificationTimeT = Aws::Utils::DateTime>
  GetRegisterAccountStatusResult& WithLastModificationTime(LastModificationTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRegisterAccountStatusResult& WithRequestId(RequestIdT&& value) {
