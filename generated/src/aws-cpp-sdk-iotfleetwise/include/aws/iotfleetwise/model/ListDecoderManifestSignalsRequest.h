...
class ListDecoderManifestSignalsRequest : public IoTFleetWiseRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  ListDecoderManifestSignalsRequest& WithName(NameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDecoderManifestSignalsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDecoderManifestSignalsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
