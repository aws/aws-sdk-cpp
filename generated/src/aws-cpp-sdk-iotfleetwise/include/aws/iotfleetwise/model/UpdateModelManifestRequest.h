...
class UpdateModelManifestRequest : public IoTFleetWiseRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateModelManifestRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateModelManifestRequest& WithDescription(DescriptionT&& value) {
  ...
  void SetNodesToAdd(NodesToAddT&& value) {
    m_nodesToAddHasBeenSet = true;
    m_nodesToAdd = std::forward<NodesToAddT>(value);
  }
  template <typename NodesToAddT = Aws::Vector<Aws::String>>
  UpdateModelManifestRequest& WithNodesToAdd(NodesToAddT&& value) {
    SetNodesToAdd(std::forward<NodesToAddT>(value));
    return *this;
  }
  template <typename NodesToAddT = Aws::String>
  UpdateModelManifestRequest& AddNodesToAdd(NodesToAddT&& value) {
    m_nodesToAddHasBeenSet = true;
    m_nodesToAdd.emplace_back(std::forward<NodesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodesToRemove(NodesToRemoveT&& value) {
    m_nodesToRemoveHasBeenSet = true;
    m_nodesToRemove = std::forward<NodesToRemoveT>(value);
  }
  template <typename NodesToRemoveT = Aws::Vector<Aws::String>>
  UpdateModelManifestRequest& WithNodesToRemove(NodesToRemoveT&& value) {
    SetNodesToRemove(std::forward<NodesToRemoveT>(value));
    return *this;
  }
  template <typename NodesToRemoveT = Aws::String>
  UpdateModelManifestRequest& AddNodesToRemove(NodesToRemoveT&& value) {
    m_nodesToRemoveHasBeenSet = true;
    m_nodesToRemove.emplace_back(std::forward<NodesToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateModelManifestRequest& WithStatus(ManifestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
