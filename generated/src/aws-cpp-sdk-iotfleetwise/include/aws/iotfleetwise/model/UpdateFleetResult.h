...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETWISE_API UpdateFleetResult() = default;
    ...
    template<typename IdT = Aws::String>
    UpdateFleetResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    UpdateFleetResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
