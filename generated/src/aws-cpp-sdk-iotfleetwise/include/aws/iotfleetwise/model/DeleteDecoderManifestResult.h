...
class DeleteDecoderManifestResult {
 public:
  ...
  template <typename NameT = Aws::String>
  DeleteDecoderManifestResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteDecoderManifestResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDecoderManifestResult& WithRequestId(RequestIdT&& value) {
