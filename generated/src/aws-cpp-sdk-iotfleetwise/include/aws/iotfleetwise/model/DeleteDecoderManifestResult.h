...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETWISE_API DeleteDecoderManifestResult() = default;
    ...
    template<typename NameT = Aws::String>
    DeleteDecoderManifestResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    DeleteDecoderManifestResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDecoderManifestResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
