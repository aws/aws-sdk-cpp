...
class ImportDecoderManifestRequest : public IoTFleetWiseRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  ImportDecoderManifestRequest& WithName(NameT&& value) {
  ...
  void SetNetworkFileDefinitions(NetworkFileDefinitionsT&& value) {
    m_networkFileDefinitionsHasBeenSet = true;
    m_networkFileDefinitions = std::forward<NetworkFileDefinitionsT>(value);
  }
  template <typename NetworkFileDefinitionsT = Aws::Vector<NetworkFileDefinition>>
  ImportDecoderManifestRequest& WithNetworkFileDefinitions(NetworkFileDefinitionsT&& value) {
    SetNetworkFileDefinitions(std::forward<NetworkFileDefinitionsT>(value));
    return *this;
  }
  template <typename NetworkFileDefinitionsT = NetworkFileDefinition>
  ImportDecoderManifestRequest& AddNetworkFileDefinitions(NetworkFileDefinitionsT&& value) {
    m_networkFileDefinitionsHasBeenSet = true;
    m_networkFileDefinitions.emplace_back(std::forward<NetworkFileDefinitionsT>(value));
    return *this;
  }
  ///@}
 private:
