...
class ListFleetsForVehicleRequest : public IoTFleetWiseRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListFleetsForVehicle"; }
  ...
  template <typename VehicleNameT = Aws::String>
  ListFleetsForVehicleRequest& WithVehicleName(VehicleNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListFleetsForVehicleRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFleetsForVehicleRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
