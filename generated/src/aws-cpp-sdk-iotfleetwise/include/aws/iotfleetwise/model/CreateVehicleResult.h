...
class CreateVehicleResult {
 public:
  ...
  template <typename VehicleNameT = Aws::String>
  CreateVehicleResult& WithVehicleName(VehicleNameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateVehicleResult& WithArn(ArnT&& value) {
  ...
  template <typename ThingArnT = Aws::String>
  CreateVehicleResult& WithThingArn(ThingArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateVehicleResult& WithRequestId(RequestIdT&& value) {
