...
class GetEncryptionConfigurationResult {
 public:
  ...
  inline GetEncryptionConfigurationResult& WithEncryptionStatus(EncryptionStatus value) {
  ...
  inline GetEncryptionConfigurationResult& WithEncryptionType(EncryptionType value) {
