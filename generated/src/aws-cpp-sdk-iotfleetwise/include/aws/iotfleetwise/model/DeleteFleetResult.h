...
class DeleteFleetResult {
 public:
  AWS_IOTFLEETWISE_API DeleteFleetResult() = default;
  ...
  template <typename IdT = Aws::String>
  DeleteFleetResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteFleetResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteFleetResult& WithRequestId(RequestIdT&& value) {
