...
class CampaignSummary {
 public:
  AWS_IOTFLEETWISE_API CampaignSummary() = default;
  ...
  template <typename DescriptionT = Aws::String>
  CampaignSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename SignalCatalogArnT = Aws::String>
  CampaignSummary& WithSignalCatalogArn(SignalCatalogArnT&& value) {
  ...
  template <typename TargetArnT = Aws::String>
  CampaignSummary& WithTargetArn(TargetArnT&& value) {
  ...
  inline CampaignSummary& WithStatus(CampaignStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  CampaignSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModificationTimeT = Aws::Utils::DateTime>
  CampaignSummary& WithLastModificationTime(LastModificationTimeT&& value) {
