...
class UpdateStateTemplateResult {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateStateTemplateResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateStateTemplateResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateStateTemplateResult& WithId(IdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateStateTemplateResult& WithRequestId(RequestIdT&& value) {
