...
class RegisterAccountResult {
 public:
  ...
  inline void SetRegisterAccountStatus(RegistrationStatus value) {
    m_registerAccountStatusHasBeenSet = true;
    m_registerAccountStatus = value;
  }
  inline RegisterAccountResult& WithRegisterAccountStatus(RegistrationStatus value) {
    SetRegisterAccountStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTimestreamResources(TimestreamResourcesT&& value) {
    ...
    m_timestreamResources = std::forward<TimestreamResourcesT>(value);
  }
  template <typename TimestreamResourcesT = TimestreamResources>
  RegisterAccountResult& WithTimestreamResources(TimestreamResourcesT&& value) {
    SetTimestreamResources(std::forward<TimestreamResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIamResources(IamResourcesT&& value) {
    m_iamResourcesHasBeenSet = true;
    m_iamResources = std::forward<IamResourcesT>(value);
  }
  template <typename IamResourcesT = IamResources>
  RegisterAccountResult& WithIamResources(IamResourcesT&& value) {
    SetIamResources(std::forward<IamResourcesT>(value));
    return *this;
  }
  ///@}
