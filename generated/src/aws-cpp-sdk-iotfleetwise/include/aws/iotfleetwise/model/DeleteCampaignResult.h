...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETWISE_API DeleteCampaignResult() = default;
    ...
    template<typename NameT = Aws::String>
    DeleteCampaignResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    DeleteCampaignResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
