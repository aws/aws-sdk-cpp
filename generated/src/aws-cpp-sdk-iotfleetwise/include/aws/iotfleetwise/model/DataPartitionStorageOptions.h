...
class DataPartitionStorageOptions {
 public:
  ...
  void SetMaximumSize(MaximumSizeT&& value) {
    ...
    m_maximumSize = std::forward<MaximumSizeT>(value);
  }
  template <typename MaximumSizeT = StorageMaximumSize>
  DataPartitionStorageOptions& WithMaximumSize(MaximumSizeT&& value) {
    SetMaximumSize(std::forward<MaximumSizeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMinimumTimeToLive(MinimumTimeToLiveT&& value) {
    ...
    m_minimumTimeToLive = std::forward<MinimumTimeToLiveT>(value);
  }
  template <typename MinimumTimeToLiveT = StorageMinimumTimeToLive>
  DataPartitionStorageOptions& WithMinimumTimeToLive(MinimumTimeToLiveT&& value) {
    SetMinimumTimeToLive(std::forward<MinimumTimeToLiveT>(value));
    return *this;
  }
  ///@}
 private:
