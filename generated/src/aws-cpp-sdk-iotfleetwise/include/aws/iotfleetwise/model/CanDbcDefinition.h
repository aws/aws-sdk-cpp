...
class CanDbcDefinition {
 public:
  ...
  void SetCanDbcFiles(CanDbcFilesT&& value) {
    m_canDbcFilesHasBeenSet = true;
    m_canDbcFiles = std::forward<CanDbcFilesT>(value);
  }
  template <typename CanDbcFilesT = Aws::Vector<Aws::Utils::ByteBuffer>>
  CanDbcDefinition& WithCanDbcFiles(CanDbcFilesT&& value) {
    SetCanDbcFiles(std::forward<CanDbcFilesT>(value));
    return *this;
  }
  template <typename CanDbcFilesT = Aws::Utils::ByteBuffer>
  CanDbcDefinition& AddCanDbcFiles(CanDbcFilesT&& value) {
    m_canDbcFilesHasBeenSet = true;
    m_canDbcFiles.emplace_back(std::forward<CanDbcFilesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSignalsMap(SignalsMapT&& value) {
    m_signalsMapHasBeenSet = true;
    m_signalsMap = std::forward<SignalsMapT>(value);
  }
  template <typename SignalsMapT = Aws::Map<Aws::String, Aws::String>>
  CanDbcDefinition& WithSignalsMap(SignalsMapT&& value) {
    SetSignalsMap(std::forward<SignalsMapT>(value));
    return *this;
  }
  ...
  CanDbcDefinition& AddSignalsMap(SignalsMapKeyT&& key, SignalsMapValueT&& value) {
    m_signalsMapHasBeenSet = true;
    m_signalsMap.emplace(std::forward<SignalsMapKeyT>(key), std::forward<SignalsMapValueT>(value));
    return *this;
  }
  ///@}
 private:
