...
class ListModelManifestNodesResult {
 public:
  ...
  template <typename NodesT = Aws::Vector<Node>>
  ListModelManifestNodesResult& WithNodes(NodesT&& value) {
    SetNodes(std::forward<NodesT>(value));
    return *this;
  }
  template <typename NodesT = Node>
  ListModelManifestNodesResult& AddNodes(NodesT&& value) {
    m_nodesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListModelManifestNodesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelManifestNodesResult& WithRequestId(RequestIdT&& value) {
