...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETWISE_API AssociateVehicleFleetRequest() = default;
    ...
    template<typename VehicleNameT = Aws::String>
    AssociateVehicleFleetRequest& WithVehicleName(VehicleNameT&& value) { SetVehicleName(std::forward<VehicleNameT>(value)); return *this;}
    ///@}
    ...
    template<typename FleetIdT = Aws::String>
    AssociateVehicleFleetRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
  private:
