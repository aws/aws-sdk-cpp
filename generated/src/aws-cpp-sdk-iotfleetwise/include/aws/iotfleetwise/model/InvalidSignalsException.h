...
class InvalidSignalsException {
 public:
  ...
  template <typename MessageT = Aws::String>
  InvalidSignalsException& WithMessage(MessageT&& value) {
  ...
  template <typename InvalidSignalsT = Aws::Vector<InvalidSignal>>
  InvalidSignalsException& WithInvalidSignals(InvalidSignalsT&& value) {
    SetInvalidSignals(std::forward<InvalidSignalsT>(value));
    return *this;
  }
  template <typename InvalidSignalsT = InvalidSignal>
  InvalidSignalsException& AddInvalidSignals(InvalidSignalsT&& value) {
    m_invalidSignalsHasBeenSet = true;
