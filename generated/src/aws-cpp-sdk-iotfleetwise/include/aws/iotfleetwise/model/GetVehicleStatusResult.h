...
class GetVehicleStatusResult {
 public:
  ...
  void SetCampaigns(CampaignsT&& value) {
    m_campaignsHasBeenSet = true;
    m_campaigns = std::forward<CampaignsT>(value);
  }
  template <typename CampaignsT = Aws::Vector<VehicleStatus>>
  GetVehicleStatusResult& WithCampaigns(CampaignsT&& value) {
    SetCampaigns(std::forward<CampaignsT>(value));
    return *this;
  }
  template <typename CampaignsT = VehicleStatus>
  GetVehicleStatusResult& AddCampaigns(CampaignsT&& value) {
    m_campaignsHasBeenSet = true;
    m_campaigns.emplace_back(std::forward<CampaignsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetVehicleStatusResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetVehicleStatusResult& WithRequestId(RequestIdT&& value) {
