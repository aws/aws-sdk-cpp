...
class TimeBasedSignalFetchConfig {
 public:
  ...
  inline void SetExecutionFrequencyMs(long long value) {
    m_executionFrequencyMsHasBeenSet = true;
    m_executionFrequencyMs = value;
  }
  inline TimeBasedSignalFetchConfig& WithExecutionFrequencyMs(long long value) {
    SetExecutionFrequencyMs(value);
    return *this;
  }
  ///@}
 private:
