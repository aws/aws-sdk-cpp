...
class SignalDecoder {
 public:
  ...
  inline void SetType(SignalDecoderType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline SignalDecoder& WithType(SignalDecoderType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetCanSignal(CanSignalT&& value) {
    ...
    m_canSignal = std::forward<CanSignalT>(value);
  }
  template <typename CanSignalT = CanSignal>
  SignalDecoder& WithCanSignal(CanSignalT&& value) {
    SetCanSignal(std::forward<CanSignalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetObdSignal(ObdSignalT&& value) {
    ...
    m_obdSignal = std::forward<ObdSignalT>(value);
  }
  template <typename ObdSignalT = ObdSignal>
  SignalDecoder& WithObdSignal(ObdSignalT&& value) {
    SetObdSignal(std::forward<ObdSignalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMessageSignal(MessageSignalT&& value) {
    ...
    m_messageSignal = std::forward<MessageSignalT>(value);
  }
  template <typename MessageSignalT = MessageSignal>
  SignalDecoder& WithMessageSignal(MessageSignalT&& value) {
    SetMessageSignal(std::forward<MessageSignalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomDecodingSignal(CustomDecodingSignalT&& value) {
    ...
    m_customDecodingSignal = std::forward<CustomDecodingSignalT>(value);
  }
  template <typename CustomDecodingSignalT = CustomDecodingSignal>
  SignalDecoder& WithCustomDecodingSignal(CustomDecodingSignalT&& value) {
    SetCustomDecodingSignal(std::forward<CustomDecodingSignalT>(value));
    return *this;
  }
  ///@}
 private:
