...
class StructuredMessageFieldNameAndDataTypePair {
 public:
  ...
  template <typename FieldNameT = Aws::String>
  StructuredMessageFieldNameAndDataTypePair& WithFieldName(FieldNameT&& value) {
   ...
   * <p>The data type. </p>
   */
  inline const StructuredMessage& GetDataType() const { return *m_dataType; }
  ...
  template <typename DataTypeT = StructuredMessage>
  StructuredMessageFieldNameAndDataTypePair& WithDataType(DataTypeT&& value) {
