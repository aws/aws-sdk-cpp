...
class TimestreamRegistrationResponse {
 public:
  ...
  void SetTimestreamDatabaseArn(TimestreamDatabaseArnT&& value) {
    m_timestreamDatabaseArnHasBeenSet = true;
    m_timestreamDatabaseArn = std::forward<TimestreamDatabaseArnT>(value);
  }
  template <typename TimestreamDatabaseArnT = Aws::String>
  TimestreamRegistrationResponse& WithTimestreamDatabaseArn(TimestreamDatabaseArnT&& value) {
    SetTimestreamDatabaseArn(std::forward<TimestreamDatabaseArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline TimestreamRegistrationResponse& WithRegistrationStatus(RegistrationStatus value) {
