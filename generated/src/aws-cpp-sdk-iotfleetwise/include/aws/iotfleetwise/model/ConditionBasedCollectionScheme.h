...
class ConditionBasedCollectionScheme {
 public:
  ...
  template <typename ExpressionT = Aws::String>
  ConditionBasedCollectionScheme& WithExpression(ExpressionT&& value) {
  ...
  inline void SetMinimumTriggerIntervalMs(long long value) {
    m_minimumTriggerIntervalMsHasBeenSet = true;
    m_minimumTriggerIntervalMs = value;
  }
  inline ConditionBasedCollectionScheme& WithMinimumTriggerIntervalMs(long long value) {
    SetMinimumTriggerIntervalMs(value);
    return *this;
  }
  ///@}
  ...
  inline ConditionBasedCollectionScheme& WithTriggerMode(TriggerMode value) {
  ...
  inline ConditionBasedCollectionScheme& WithConditionLanguageVersion(int value) {
