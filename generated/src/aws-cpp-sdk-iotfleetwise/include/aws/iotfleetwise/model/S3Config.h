...
class S3Config {
 public:
  ...
  inline S3Config& WithDataFormat(DataFormat value) {
    SetDataFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStorageCompressionFormat(StorageCompressionFormat value) {
    m_storageCompressionFormatHasBeenSet = true;
    m_storageCompressionFormat = value;
  }
  inline S3Config& WithStorageCompressionFormat(StorageCompressionFormat value) {
    SetStorageCompressionFormat(value);
    return *this;
  }
  ///@}
