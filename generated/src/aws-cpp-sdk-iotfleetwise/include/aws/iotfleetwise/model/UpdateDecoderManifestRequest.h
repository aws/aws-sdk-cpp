...
class UpdateDecoderManifestRequest : public IoTFleetWiseRequest {
 public:
  ...
  void SetSignalDecodersToAdd(SignalDecodersToAddT&& value) {
    m_signalDecodersToAddHasBeenSet = true;
    m_signalDecodersToAdd = std::forward<SignalDecodersToAddT>(value);
  }
  template <typename SignalDecodersToAddT = Aws::Vector<SignalDecoder>>
  UpdateDecoderManifestRequest& WithSignalDecodersToAdd(SignalDecodersToAddT&& value) {
    SetSignalDecodersToAdd(std::forward<SignalDecodersToAddT>(value));
    return *this;
  }
  ...
  UpdateDecoderManifestRequest& AddSignalDecodersToAdd(SignalDecodersToAddT&& value) {
    m_signalDecodersToAddHasBeenSet = true;
    m_signalDecodersToAdd.emplace_back(std::forward<SignalDecodersToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSignalDecodersToUpdate(SignalDecodersToUpdateT&& value) {
    m_signalDecodersToUpdateHasBeenSet = true;
    m_signalDecodersToUpdate = std::forward<SignalDecodersToUpdateT>(value);
  }
  template <typename SignalDecodersToUpdateT = Aws::Vector<SignalDecoder>>
  UpdateDecoderManifestRequest& WithSignalDecodersToUpdate(SignalDecodersToUpdateT&& value) {
    SetSignalDecodersToUpdate(std::forward<SignalDecodersToUpdateT>(value));
    return *this;
  }
  ...
  UpdateDecoderManifestRequest& AddSignalDecodersToUpdate(SignalDecodersToUpdateT&& value) {
    m_signalDecodersToUpdateHasBeenSet = true;
    m_signalDecodersToUpdate.emplace_back(std::forward<SignalDecodersToUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSignalDecodersToRemove(SignalDecodersToRemoveT&& value) {
    m_signalDecodersToRemoveHasBeenSet = true;
    m_signalDecodersToRemove = std::forward<SignalDecodersToRemoveT>(value);
  }
  template <typename SignalDecodersToRemoveT = Aws::Vector<Aws::String>>
  UpdateDecoderManifestRequest& WithSignalDecodersToRemove(SignalDecodersToRemoveT&& value) {
    SetSignalDecodersToRemove(std::forward<SignalDecodersToRemoveT>(value));
    return *this;
  }
  ...
  UpdateDecoderManifestRequest& AddSignalDecodersToRemove(SignalDecodersToRemoveT&& value) {
    m_signalDecodersToRemoveHasBeenSet = true;
    m_signalDecodersToRemove.emplace_back(std::forward<SignalDecodersToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkInterfacesToAdd(NetworkInterfacesToAddT&& value) {
    m_networkInterfacesToAddHasBeenSet = true;
    m_networkInterfacesToAdd = std::forward<NetworkInterfacesToAddT>(value);
  }
  template <typename NetworkInterfacesToAddT = Aws::Vector<NetworkInterface>>
  UpdateDecoderManifestRequest& WithNetworkInterfacesToAdd(NetworkInterfacesToAddT&& value) {
    SetNetworkInterfacesToAdd(std::forward<NetworkInterfacesToAddT>(value));
    return *this;
  }
  ...
  UpdateDecoderManifestRequest& AddNetworkInterfacesToAdd(NetworkInterfacesToAddT&& value) {
    m_networkInterfacesToAddHasBeenSet = true;
    m_networkInterfacesToAdd.emplace_back(std::forward<NetworkInterfacesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkInterfacesToUpdate(NetworkInterfacesToUpdateT&& value) {
    m_networkInterfacesToUpdateHasBeenSet = true;
    m_networkInterfacesToUpdate = std::forward<NetworkInterfacesToUpdateT>(value);
  }
  template <typename NetworkInterfacesToUpdateT = Aws::Vector<NetworkInterface>>
  UpdateDecoderManifestRequest& WithNetworkInterfacesToUpdate(NetworkInterfacesToUpdateT&& value) {
    SetNetworkInterfacesToUpdate(std::forward<NetworkInterfacesToUpdateT>(value));
    return *this;
  }
  ...
  UpdateDecoderManifestRequest& AddNetworkInterfacesToUpdate(NetworkInterfacesToUpdateT&& value) {
    m_networkInterfacesToUpdateHasBeenSet = true;
    m_networkInterfacesToUpdate.emplace_back(std::forward<NetworkInterfacesToUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkInterfacesToRemove(NetworkInterfacesToRemoveT&& value) {
    m_networkInterfacesToRemoveHasBeenSet = true;
    m_networkInterfacesToRemove = std::forward<NetworkInterfacesToRemoveT>(value);
  }
  template <typename NetworkInterfacesToRemoveT = Aws::Vector<Aws::String>>
  UpdateDecoderManifestRequest& WithNetworkInterfacesToRemove(NetworkInterfacesToRemoveT&& value) {
    SetNetworkInterfacesToRemove(std::forward<NetworkInterfacesToRemoveT>(value));
    return *this;
  }
  ...
  UpdateDecoderManifestRequest& AddNetworkInterfacesToRemove(NetworkInterfacesToRemoveT&& value) {
    m_networkInterfacesToRemoveHasBeenSet = true;
    m_networkInterfacesToRemove.emplace_back(std::forward<NetworkInterfacesToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateDecoderManifestRequest& WithStatus(ManifestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultForUnmappedSignals(DefaultForUnmappedSignalsType value) {
    m_defaultForUnmappedSignalsHasBeenSet = true;
    m_defaultForUnmappedSignals = value;
  }
  inline UpdateDecoderManifestRequest& WithDefaultForUnmappedSignals(DefaultForUnmappedSignalsType value) {
    SetDefaultForUnmappedSignals(value);
    return *this;
  }
  ///@}
 private:
