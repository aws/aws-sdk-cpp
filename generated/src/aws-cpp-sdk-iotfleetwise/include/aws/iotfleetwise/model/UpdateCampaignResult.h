...
class UpdateCampaignResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateCampaignResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateCampaignResult& WithName(NameT&& value) {
  ...
  inline void SetStatus(CampaignStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateCampaignResult& WithStatus(CampaignStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
