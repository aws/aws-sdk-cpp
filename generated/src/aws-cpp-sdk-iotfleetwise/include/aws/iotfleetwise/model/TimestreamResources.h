...
class TimestreamResources {
 public:
  ...
  void SetTimestreamDatabaseName(TimestreamDatabaseNameT&& value) {
    ...
    m_timestreamDatabaseName = std::forward<TimestreamDatabaseNameT>(value);
  }
  template <typename TimestreamDatabaseNameT = Aws::String>
  TimestreamResources& WithTimestreamDatabaseName(TimestreamDatabaseNameT&& value) {
    SetTimestreamDatabaseName(std::forward<TimestreamDatabaseNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimestreamTableName(TimestreamTableNameT&& value) {
    ...
    m_timestreamTableName = std::forward<TimestreamTableNameT>(value);
  }
  template <typename TimestreamTableNameT = Aws::String>
  TimestreamResources& WithTimestreamTableName(TimestreamTableNameT&& value) {
    SetTimestreamTableName(std::forward<TimestreamTableNameT>(value));
    return *this;
  }
  ///@}
 private:
