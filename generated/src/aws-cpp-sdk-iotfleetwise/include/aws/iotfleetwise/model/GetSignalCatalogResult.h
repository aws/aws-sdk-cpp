...
class GetSignalCatalogResult {
 public:
  ...
  template <typename NodeCountsT = NodeCounts>
  void SetNodeCounts(NodeCountsT&& value) {
    m_nodeCountsHasBeenSet = true;
    m_nodeCounts = std::forward<NodeCountsT>(value);
  }
  template <typename NodeCountsT = NodeCounts>
  GetSignalCatalogResult& WithNodeCounts(NodeCountsT&& value) {
    SetNodeCounts(std::forward<NodeCountsT>(value));
    return *this;
  }
  ///@}
 ...
 private:
  ...
  bool m_nodeCountsHasBeenSet = false;
