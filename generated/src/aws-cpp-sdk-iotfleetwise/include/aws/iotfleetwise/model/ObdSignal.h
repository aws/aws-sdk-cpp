...
class ObdSignal {
 public:
  ...
  inline void SetPidResponseLength(int value) {
    m_pidResponseLengthHasBeenSet = true;
    m_pidResponseLength = value;
  }
  inline ObdSignal& WithPidResponseLength(int value) {
    SetPidResponseLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetServiceMode(int value) {
    m_serviceModeHasBeenSet = true;
    m_serviceMode = value;
  }
  inline ObdSignal& WithServiceMode(int value) {
  ...
  inline ObdSignal& WithPid(int value) {
    SetPid(value);
    return *this;
  }
  ///@}
  ...
  inline ObdSignal& WithScaling(double value) {
    SetScaling(value);
    return *this;
  }
  ///@}
  ...
  inline ObdSignal& WithOffset(double value) {
    SetOffset(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartByte(int value) {
    m_startByteHasBeenSet = true;
    m_startByte = value;
  }
  inline ObdSignal& WithStartByte(int value) {
    SetStartByte(value);
    return *this;
  }
  ///@}
  ...
  inline void SetByteLength(int value) {
    m_byteLengthHasBeenSet = true;
    m_byteLength = value;
  }
  inline ObdSignal& WithByteLength(int value) {
    SetByteLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBitRightShift(int value) {
    m_bitRightShiftHasBeenSet = true;
    m_bitRightShift = value;
  }
  inline ObdSignal& WithBitRightShift(int value) {
    SetBitRightShift(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBitMaskLength(int value) {
    m_bitMaskLengthHasBeenSet = true;
    m_bitMaskLength = value;
  }
  inline ObdSignal& WithBitMaskLength(int value) {
    SetBitMaskLength(value);
    return *this;
  }
  ///@}
  ...
  inline ObdSignal& WithIsSigned(bool value) {
    SetIsSigned(value);
    return *this;
  }
  ///@}
  ...
  inline ObdSignal& WithSignalValueType(SignalValueType value) {
