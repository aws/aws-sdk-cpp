...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETWISE_API ImportSignalCatalogResult() = default;
    ...
    template<typename NameT = Aws::String>
    ImportSignalCatalogResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    ImportSignalCatalogResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ImportSignalCatalogResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
