...
class ListSignalCatalogsResult {
 public:
  ...
  template <typename SummariesT = Aws::Vector<SignalCatalogSummary>>
  ListSignalCatalogsResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = SignalCatalogSummary>
  ListSignalCatalogsResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSignalCatalogsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSignalCatalogsResult& WithRequestId(RequestIdT&& value) {
