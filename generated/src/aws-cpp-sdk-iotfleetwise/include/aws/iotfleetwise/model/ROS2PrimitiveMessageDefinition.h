...
class ROS2PrimitiveMessageDefinition {
 public:
  ...
  inline void SetPrimitiveType(ROS2PrimitiveType value) {
    m_primitiveTypeHasBeenSet = true;
    m_primitiveType = value;
  }
  inline ROS2PrimitiveMessageDefinition& WithPrimitiveType(ROS2PrimitiveType value) {
  ...
  inline ROS2PrimitiveMessageDefinition& WithOffset(double value) {
    SetOffset(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScaling(double value) {
    m_scalingHasBeenSet = true;
    m_scaling = value;
  }
  inline ROS2PrimitiveMessageDefinition& WithScaling(double value) {
    SetScaling(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUpperBound(long long value) {
    m_upperBoundHasBeenSet = true;
    m_upperBound = value;
  }
  inline ROS2PrimitiveMessageDefinition& WithUpperBound(long long value) {
    SetUpperBound(value);
    return *this;
  }
  ///@}
