...
class ListModelManifestNodesRequest : public IoTFleetWiseRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  ListModelManifestNodesRequest& WithName(NameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListModelManifestNodesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListModelManifestNodesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
