...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETWISE_API ListTagsForResourceResult() = default;
    AWS_IOTFLEETWISE_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_IOTFLEETWISE_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
