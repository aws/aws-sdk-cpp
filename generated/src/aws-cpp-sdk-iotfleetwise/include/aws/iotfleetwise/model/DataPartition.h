...
class DataPartition {
 public:
  ...
  template <typename IdT = Aws::String>
  DataPartition& WithId(IdT&& value) {
  ...
  void SetStorageOptions(StorageOptionsT&& value) {
    m_storageOptionsHasBeenSet = true;
    m_storageOptions = std::forward<StorageOptionsT>(value);
  }
  template <typename StorageOptionsT = DataPartitionStorageOptions>
  DataPartition& WithStorageOptions(StorageOptionsT&& value) {
    SetStorageOptions(std::forward<StorageOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUploadOptions(UploadOptionsT&& value) {
    m_uploadOptionsHasBeenSet = true;
    m_uploadOptions = std::forward<UploadOptionsT>(value);
  }
  template <typename UploadOptionsT = DataPartitionUploadOptions>
  DataPartition& WithUploadOptions(UploadOptionsT&& value) {
    SetUploadOptions(std::forward<UploadOptionsT>(value));
    return *this;
  }
  ///@}
 private:
