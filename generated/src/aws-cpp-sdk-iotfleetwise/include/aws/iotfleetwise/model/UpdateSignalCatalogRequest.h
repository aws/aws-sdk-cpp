...
class UpdateSignalCatalogRequest : public IoTFleetWiseRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateSignalCatalogRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateSignalCatalogRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename NodesToAddT = Aws::Vector<Node>>
  UpdateSignalCatalogRequest& WithNodesToAdd(NodesToAddT&& value) {
    SetNodesToAdd(std::forward<NodesToAddT>(value));
    return *this;
  }
  template <typename NodesToAddT = Node>
  UpdateSignalCatalogRequest& AddNodesToAdd(NodesToAddT&& value) {
    m_nodesToAddHasBeenSet = true;
  ...
  void SetNodesToUpdate(NodesToUpdateT&& value) {
    m_nodesToUpdateHasBeenSet = true;
    m_nodesToUpdate = std::forward<NodesToUpdateT>(value);
  }
  template <typename NodesToUpdateT = Aws::Vector<Node>>
  UpdateSignalCatalogRequest& WithNodesToUpdate(NodesToUpdateT&& value) {
    SetNodesToUpdate(std::forward<NodesToUpdateT>(value));
    return *this;
  }
  template <typename NodesToUpdateT = Node>
  UpdateSignalCatalogRequest& AddNodesToUpdate(NodesToUpdateT&& value) {
    m_nodesToUpdateHasBeenSet = true;
    m_nodesToUpdate.emplace_back(std::forward<NodesToUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NodesToRemoveT = Aws::Vector<Aws::String>>
  UpdateSignalCatalogRequest& WithNodesToRemove(NodesToRemoveT&& value) {
    SetNodesToRemove(std::forward<NodesToRemoveT>(value));
    return *this;
  }
  template <typename NodesToRemoveT = Aws::String>
  UpdateSignalCatalogRequest& AddNodesToRemove(NodesToRemoveT&& value) {
    m_nodesToRemoveHasBeenSet = true;
