...
class ListModelManifestsResult {
 public:
  ...
  template <typename SummariesT = Aws::Vector<ModelManifestSummary>>
  ListModelManifestsResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = ModelManifestSummary>
  ListModelManifestsResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListModelManifestsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelManifestsResult& WithRequestId(RequestIdT&& value) {
