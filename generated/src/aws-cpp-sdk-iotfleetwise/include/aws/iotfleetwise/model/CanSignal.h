...
class CanSignal {
 public:
  ...
  inline CanSignal& WithMessageId(int value) {
    SetMessageId(value);
    return *this;
  }
  ///@}
  ...
  inline CanSignal& WithIsBigEndian(bool value) {
    SetIsBigEndian(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsSigned(bool value) {
    m_isSignedHasBeenSet = true;
    m_isSigned = value;
  }
  inline CanSignal& WithIsSigned(bool value) {
    SetIsSigned(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartBit(int value) {
    m_startBitHasBeenSet = true;
    m_startBit = value;
  }
  inline CanSignal& WithStartBit(int value) {
    SetStartBit(value);
    return *this;
  }
  ///@}
  ...
  inline CanSignal& WithOffset(double value) {
    SetOffset(value);
    return *this;
  }
  ///@}
  ...
  inline CanSignal& WithFactor(double value) {
    SetFactor(value);
    return *this;
  }
  ///@}
  ...
  inline CanSignal& WithLength(int value) {
    SetLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSignalValueType(SignalValueType value) {
    m_signalValueTypeHasBeenSet = true;
    m_signalValueType = value;
  }
  inline CanSignal& WithSignalValueType(SignalValueType value) {
    SetSignalValueType(value);
    return *this;
  }
  ///@}
 private:
