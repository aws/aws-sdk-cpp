...
class UpdateStateTemplateRequest : public IoTFleetWiseRequest {
 public:
  ...
  void SetStateTemplatePropertiesToAdd(StateTemplatePropertiesToAddT&& value) {
    m_stateTemplatePropertiesToAddHasBeenSet = true;
    m_stateTemplatePropertiesToAdd = std::forward<StateTemplatePropertiesToAddT>(value);
  }
  template <typename StateTemplatePropertiesToAddT = Aws::Vector<Aws::String>>
  UpdateStateTemplateRequest& WithStateTemplatePropertiesToAdd(StateTemplatePropertiesToAddT&& value) {
    SetStateTemplatePropertiesToAdd(std::forward<StateTemplatePropertiesToAddT>(value));
    return *this;
  }
  ...
  UpdateStateTemplateRequest& AddStateTemplatePropertiesToAdd(StateTemplatePropertiesToAddT&& value) {
    m_stateTemplatePropertiesToAddHasBeenSet = true;
    m_stateTemplatePropertiesToAdd.emplace_back(std::forward<StateTemplatePropertiesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStateTemplatePropertiesToRemove(StateTemplatePropertiesToRemoveT&& value) {
    m_stateTemplatePropertiesToRemoveHasBeenSet = true;
    m_stateTemplatePropertiesToRemove = std::forward<StateTemplatePropertiesToRemoveT>(value);
  }
  template <typename StateTemplatePropertiesToRemoveT = Aws::Vector<Aws::String>>
  UpdateStateTemplateRequest& WithStateTemplatePropertiesToRemove(StateTemplatePropertiesToRemoveT&& value) {
    SetStateTemplatePropertiesToRemove(std::forward<StateTemplatePropertiesToRemoveT>(value));
    return *this;
  }
  ...
  UpdateStateTemplateRequest& AddStateTemplatePropertiesToRemove(StateTemplatePropertiesToRemoveT&& value) {
    m_stateTemplatePropertiesToRemoveHasBeenSet = true;
    m_stateTemplatePropertiesToRemove.emplace_back(std::forward<StateTemplatePropertiesToRemoveT>(value));
    return *this;
  }
  ///@}
