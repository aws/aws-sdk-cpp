...
class ListSignalCatalogNodesRequest : public IoTFleetWiseRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  ListSignalCatalogNodesRequest& WithName(NameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSignalCatalogNodesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSignalCatalogNodesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSignalNodeType(SignalNodeType value) {
    m_signalNodeTypeHasBeenSet = true;
    m_signalNodeType = value;
  }
  inline ListSignalCatalogNodesRequest& WithSignalNodeType(SignalNodeType value) {
    SetSignalNodeType(value);
    return *this;
  }
  ///@}
 private:
