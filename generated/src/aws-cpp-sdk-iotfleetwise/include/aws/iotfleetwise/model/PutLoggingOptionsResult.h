...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETWISE_API PutLoggingOptionsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutLoggingOptionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
