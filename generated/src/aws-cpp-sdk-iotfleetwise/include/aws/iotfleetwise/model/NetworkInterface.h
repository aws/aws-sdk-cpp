...
class NetworkInterface {
 public:
  ...
  void SetInterfaceId(InterfaceIdT&& value) {
    ...
    m_interfaceId = std::forward<InterfaceIdT>(value);
  }
  template <typename InterfaceIdT = Aws::String>
  NetworkInterface& WithInterfaceId(InterfaceIdT&& value) {
    SetInterfaceId(std::forward<InterfaceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(NetworkInterfaceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline NetworkInterface& WithType(NetworkInterfaceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetCanInterface(CanInterfaceT&& value) {
    ...
    m_canInterface = std::forward<CanInterfaceT>(value);
  }
  template <typename CanInterfaceT = CanInterface>
  NetworkInterface& WithCanInterface(CanInterfaceT&& value) {
    SetCanInterface(std::forward<CanInterfaceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetObdInterface(ObdInterfaceT&& value) {
    ...
    m_obdInterface = std::forward<ObdInterfaceT>(value);
  }
  template <typename ObdInterfaceT = ObdInterface>
  NetworkInterface& WithObdInterface(ObdInterfaceT&& value) {
    SetObdInterface(std::forward<ObdInterfaceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVehicleMiddleware(VehicleMiddlewareT&& value) {
    ...
    m_vehicleMiddleware = std::forward<VehicleMiddlewareT>(value);
  }
  template <typename VehicleMiddlewareT = VehicleMiddleware>
  NetworkInterface& WithVehicleMiddleware(VehicleMiddlewareT&& value) {
    SetVehicleMiddleware(std::forward<VehicleMiddlewareT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomDecodingInterface(CustomDecodingInterfaceT&& value) {
    ...
    m_customDecodingInterface = std::forward<CustomDecodingInterfaceT>(value);
  }
  template <typename CustomDecodingInterfaceT = CustomDecodingInterface>
  NetworkInterface& WithCustomDecodingInterface(CustomDecodingInterfaceT&& value) {
    SetCustomDecodingInterface(std::forward<CustomDecodingInterfaceT>(value));
    return *this;
  }
  ///@}
 private:
