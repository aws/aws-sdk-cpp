...
namespace Model
{
  ...
  /**
   */
  class ListFleetsRequest : public IoTFleetWiseRequest
  {
  public:
    AWS_IOTFLEETWISE_API ListFleetsRequest() = default;
    ...
    inline ListFleetsRequest& WithListResponseScope(ListResponseScope value) { SetListResponseScope(value); return *this;}
    ///@}
  private:
