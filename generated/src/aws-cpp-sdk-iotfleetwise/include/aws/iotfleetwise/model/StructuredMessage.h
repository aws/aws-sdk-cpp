...
class StructuredMessage {
 public:
  ...
  void SetPrimitiveMessageDefinition(PrimitiveMessageDefinitionT&& value) {
    ...
    m_primitiveMessageDefinition = std::forward<PrimitiveMessageDefinitionT>(value);
  }
  template <typename PrimitiveMessageDefinitionT = PrimitiveMessageDefinition>
  StructuredMessage& WithPrimitiveMessageDefinition(PrimitiveMessageDefinitionT&& value) {
    SetPrimitiveMessageDefinition(std::forward<PrimitiveMessageDefinitionT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const StructuredMessageListDefinition& GetStructuredMessageListDefinition() const { return *m_structuredMessageListDefinition; }
  ...
  void SetStructuredMessageListDefinition(StructuredMessageListDefinitionT&& value) {
    ...
    m_structuredMessageListDefinition =
        Aws::MakeShared<StructuredMessageListDefinition>("StructuredMessage", std::forward<StructuredMessageListDefinitionT>(value));
  }
  template <typename StructuredMessageListDefinitionT = StructuredMessageListDefinition>
  StructuredMessage& WithStructuredMessageListDefinition(StructuredMessageListDefinitionT&& value) {
    SetStructuredMessageListDefinition(std::forward<StructuredMessageListDefinitionT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<StructuredMessageFieldNameAndDataTypePair>& GetStructuredMessageDefinition() const {
    return m_structuredMessageDefinition;
  }
  ...
  void SetStructuredMessageDefinition(StructuredMessageDefinitionT&& value) {
    ...
    m_structuredMessageDefinition = std::forward<StructuredMessageDefinitionT>(value);
  }
  template <typename StructuredMessageDefinitionT = Aws::Vector<StructuredMessageFieldNameAndDataTypePair>>
  StructuredMessage& WithStructuredMessageDefinition(StructuredMessageDefinitionT&& value) {
    SetStructuredMessageDefinition(std::forward<StructuredMessageDefinitionT>(value));
    return *this;
  }
  ...
  StructuredMessage& AddStructuredMessageDefinition(StructuredMessageDefinitionT&& value) {
    m_structuredMessageDefinitionHasBeenSet = true;
    m_structuredMessageDefinition.emplace_back(std::forward<StructuredMessageDefinitionT>(value));
    return *this;
  }
  ///@}
 private:
