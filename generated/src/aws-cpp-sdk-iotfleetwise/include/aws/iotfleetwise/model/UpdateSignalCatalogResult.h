...
class UpdateSignalCatalogResult {
 public:
  AWS_IOTFLEETWISE_API UpdateSignalCatalogResult() = default;
  ...
  template <typename NameT = Aws::String>
  UpdateSignalCatalogResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateSignalCatalogResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSignalCatalogResult& WithRequestId(RequestIdT&& value) {
