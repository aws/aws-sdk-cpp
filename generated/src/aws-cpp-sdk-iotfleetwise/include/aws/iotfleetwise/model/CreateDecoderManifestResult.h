...
class CreateDecoderManifestResult {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateDecoderManifestResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateDecoderManifestResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDecoderManifestResult& WithRequestId(RequestIdT&& value) {
