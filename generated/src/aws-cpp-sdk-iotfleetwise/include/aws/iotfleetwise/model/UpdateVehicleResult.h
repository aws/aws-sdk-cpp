...
class UpdateVehicleResult {
 public:
  AWS_IOTFLEETWISE_API UpdateVehicleResult() = default;
  ...
  template <typename VehicleNameT = Aws::String>
  UpdateVehicleResult& WithVehicleName(VehicleNameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateVehicleResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateVehicleResult& WithRequestId(RequestIdT&& value) {
