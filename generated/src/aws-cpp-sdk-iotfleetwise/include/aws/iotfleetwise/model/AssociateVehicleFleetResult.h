...
namespace Model
{
  ...
  {
  public:
    AWS_IOTFLEETWISE_API AssociateVehicleFleetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateVehicleFleetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
