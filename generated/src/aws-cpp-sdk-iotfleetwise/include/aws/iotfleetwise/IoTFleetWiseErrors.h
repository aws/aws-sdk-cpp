...
class AWS_IOTFLEETWISE_API IoTFleetWiseError : public Aws::Client::AWSError<IoTFleetWiseErrors> {
 public:
  ...
  IoTFleetWiseError(const Aws::Client::AWSError<IoTFleetWiseErrors>& rhs) : Aws::Client::AWSError<IoTFleetWiseErrors>(rhs) {}
  IoTFleetWiseError(Aws::Client::AWSError<IoTFleetWiseErrors>&& rhs) : Aws::Client::AWSError<IoTFleetWiseErrors>(rhs) {}
