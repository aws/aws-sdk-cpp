...
class AWS_IOTFLEETWISE_API IoTFleetWiseClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IoTFleetWiseClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<IoTFleetWiseEndpointProviderBase> endpointProvider = nullptr,
      const Aws::IoTFleetWise::IoTFleetWiseClientConfiguration& clientConfiguration = Aws::IoTFleetWise::IoTFleetWiseClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateVehicleFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateVehicleFleet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateVehicleFleetRequestT = Model::AssociateVehicleFleetRequest>
  void AssociateVehicleFleetAsync(const AssociateVehicleFleetRequestT& request, const AssociateVehicleFleetResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for BatchCreateVehicle that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchCreateVehicle that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchCreateVehicleRequestT = Model::BatchCreateVehicleRequest>
  void BatchCreateVehicleAsync(const BatchCreateVehicleRequestT& request, const BatchCreateVehicleResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchUpdateVehicle that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchUpdateVehicle that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchUpdateVehicleRequestT = Model::BatchUpdateVehicleRequest>
  void BatchUpdateVehicleAsync(const BatchUpdateVehicleRequestT& request, const BatchUpdateVehicleResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDecoderManifest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDecoderManifest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDecoderManifestRequestT = Model::CreateDecoderManifestRequest>
  void CreateDecoderManifestAsync(const CreateDecoderManifestRequestT& request, const CreateDecoderManifestResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateModelManifest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateModelManifest that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateModelManifestRequestT = Model::CreateModelManifestRequest>
  void CreateModelManifestAsync(const CreateModelManifestRequestT& request, const CreateModelManifestResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSignalCatalog that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSignalCatalog that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateSignalCatalogRequestT = Model::CreateSignalCatalogRequest>
  void CreateSignalCatalogAsync(const CreateSignalCatalogRequestT& request, const CreateSignalCatalogResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateStateTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStateTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateStateTemplateRequestT = Model::CreateStateTemplateRequest>
  void CreateStateTemplateAsync(const CreateStateTemplateRequestT& request, const CreateStateTemplateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateVehicle that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateVehicleRequestT = Model::CreateVehicleRequest>
  void CreateVehicleAsync(const CreateVehicleRequestT& request, const CreateVehicleResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDecoderManifest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDecoderManifest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDecoderManifestRequestT = Model::DeleteDecoderManifestRequest>
  void DeleteDecoderManifestAsync(const DeleteDecoderManifestRequestT& request, const DeleteDecoderManifestResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteModelManifest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteModelManifest that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteModelManifestRequestT = Model::DeleteModelManifestRequest>
  void DeleteModelManifestAsync(const DeleteModelManifestRequestT& request, const DeleteModelManifestResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSignalCatalog that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSignalCatalog that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteSignalCatalogRequestT = Model::DeleteSignalCatalogRequest>
  void DeleteSignalCatalogAsync(const DeleteSignalCatalogRequestT& request, const DeleteSignalCatalogResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteStateTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteStateTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteStateTemplateRequestT = Model::DeleteStateTemplateRequest>
  void DeleteStateTemplateAsync(const DeleteStateTemplateRequestT& request, const DeleteStateTemplateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteVehicle that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteVehicleRequestT = Model::DeleteVehicleRequest>
  void DeleteVehicleAsync(const DeleteVehicleRequestT& request, const DeleteVehicleResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateVehicleFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateVehicleFleet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateVehicleFleetRequestT = Model::DisassociateVehicleFleetRequest>
  void DisassociateVehicleFleetAsync(const DisassociateVehicleFleetRequestT& request,
                                     const DisassociateVehicleFleetResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDecoderManifest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDecoderManifest that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDecoderManifestRequestT = Model::GetDecoderManifestRequest>
  void GetDecoderManifestAsync(const GetDecoderManifestRequestT& request, const GetDecoderManifestResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEncryptionConfigurationOutcome GetEncryptionConfiguration(
      const Model::GetEncryptionConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetEncryptionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetEncryptionConfigurationRequestT = Model::GetEncryptionConfigurationRequest>
  Model::GetEncryptionConfigurationOutcomeCallable GetEncryptionConfigurationCallable(
      const GetEncryptionConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTFleetWiseClient::GetEncryptionConfiguration, request);
  }

  /**
   * An Async wrapper for GetEncryptionConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEncryptionConfigurationRequestT = Model::GetEncryptionConfigurationRequest>
  void GetEncryptionConfigurationAsync(const GetEncryptionConfigurationResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for GetFleet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFleetRequestT = Model::GetFleetRequest>
  void GetFleetAsync(const GetFleetRequestT& request, const GetFleetResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLoggingOptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLoggingOptions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetLoggingOptionsRequestT = Model::GetLoggingOptionsRequest>
  void GetLoggingOptionsAsync(const GetLoggingOptionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetLoggingOptionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetModelManifest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetModelManifest that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetModelManifestRequestT = Model::GetModelManifestRequest>
  void GetModelManifestAsync(const GetModelManifestRequestT& request, const GetModelManifestResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRegisterAccountStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetRegisterAccountStatusRequestT = Model::GetRegisterAccountStatusRequest>
  Model::GetRegisterAccountStatusOutcomeCallable GetRegisterAccountStatusCallable(
      const GetRegisterAccountStatusRequestT& request = {}) const {
    return SubmitCallable(&IoTFleetWiseClient::GetRegisterAccountStatus, request);
  }

  /**
   * An Async wrapper for GetRegisterAccountStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRegisterAccountStatusRequestT = Model::GetRegisterAccountStatusRequest>
  void GetRegisterAccountStatusAsync(const GetRegisterAccountStatusResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const GetRegisterAccountStatusRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetSignalCatalog that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSignalCatalog that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSignalCatalogRequestT = Model::GetSignalCatalogRequest>
  void GetSignalCatalogAsync(const GetSignalCatalogRequestT& request, const GetSignalCatalogResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetStateTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetStateTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetStateTemplateRequestT = Model::GetStateTemplateRequest>
  void GetStateTemplateAsync(const GetStateTemplateRequestT& request, const GetStateTemplateResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetVehicle that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetVehicleRequestT = Model::GetVehicleRequest>
  void GetVehicleAsync(const GetVehicleRequestT& request, const GetVehicleResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetVehicleStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetVehicleStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetVehicleStatusRequestT = Model::GetVehicleStatusRequest>
  void GetVehicleStatusAsync(const GetVehicleStatusRequestT& request, const GetVehicleStatusResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ImportDecoderManifest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportDecoderManifest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ImportDecoderManifestRequestT = Model::ImportDecoderManifestRequest>
  void ImportDecoderManifestAsync(const ImportDecoderManifestRequestT& request, const ImportDecoderManifestResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ImportSignalCatalog that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportSignalCatalog that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ImportSignalCatalogRequestT = Model::ImportSignalCatalogRequest>
  void ImportSignalCatalogAsync(const ImportSignalCatalogRequestT& request, const ImportSignalCatalogResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListCampaigns that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCampaignsRequestT = Model::ListCampaignsRequest>
  void ListCampaignsAsync(const ListCampaignsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListCampaignsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDecoderManifestNetworkInterfacesOutcome ListDecoderManifestNetworkInterfaces(
      const Model::ListDecoderManifestNetworkInterfacesRequest& request) const;

  /**
   * A Callable wrapper for ListDecoderManifestNetworkInterfaces that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListDecoderManifestNetworkInterfacesRequestT = Model::ListDecoderManifestNetworkInterfacesRequest>
  Model::ListDecoderManifestNetworkInterfacesOutcomeCallable ListDecoderManifestNetworkInterfacesCallable(
      const ListDecoderManifestNetworkInterfacesRequestT& request) const {
    return SubmitCallable(&IoTFleetWiseClient::ListDecoderManifestNetworkInterfaces, request);
  }

  /**
   * An Async wrapper for ListDecoderManifestNetworkInterfaces that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListDecoderManifestNetworkInterfacesRequestT = Model::ListDecoderManifestNetworkInterfacesRequest>
  void ListDecoderManifestNetworkInterfacesAsync(const ListDecoderManifestNetworkInterfacesRequestT& request,
                                                 const ListDecoderManifestNetworkInterfacesResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDecoderManifestSignalsOutcome ListDecoderManifestSignals(
      const Model::ListDecoderManifestSignalsRequest& request) const;

  /**
   * A Callable wrapper for ListDecoderManifestSignals that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDecoderManifestSignalsRequestT = Model::ListDecoderManifestSignalsRequest>
  Model::ListDecoderManifestSignalsOutcomeCallable ListDecoderManifestSignalsCallable(
      const ListDecoderManifestSignalsRequestT& request) const {
    return SubmitCallable(&IoTFleetWiseClient::ListDecoderManifestSignals, request);
  }

  /**
   * An Async wrapper for ListDecoderManifestSignals that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDecoderManifestSignalsRequestT = Model::ListDecoderManifestSignalsRequest>
  void ListDecoderManifestSignalsAsync(const ListDecoderManifestSignalsRequestT& request,
                                       const ListDecoderManifestSignalsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDecoderManifests that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDecoderManifests that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDecoderManifestsRequestT = Model::ListDecoderManifestsRequest>
  void ListDecoderManifestsAsync(const ListDecoderManifestsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListDecoderManifestsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListFleets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFleetsRequestT = Model::ListFleetsRequest>
  void ListFleetsAsync(const ListFleetsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListFleetsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFleetsForVehicle that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFleetsForVehicle that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFleetsForVehicleRequestT = Model::ListFleetsForVehicleRequest>
  void ListFleetsForVehicleAsync(const ListFleetsForVehicleRequestT& request, const ListFleetsForVehicleResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListModelManifestNodes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelManifestNodes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListModelManifestNodesRequestT = Model::ListModelManifestNodesRequest>
  void ListModelManifestNodesAsync(const ListModelManifestNodesRequestT& request,
                                   const ListModelManifestNodesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListModelManifests that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelManifests that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListModelManifestsRequestT = Model::ListModelManifestsRequest>
  void ListModelManifestsAsync(const ListModelManifestsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListModelManifestsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSignalCatalogNodes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSignalCatalogNodes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSignalCatalogNodesRequestT = Model::ListSignalCatalogNodesRequest>
  void ListSignalCatalogNodesAsync(const ListSignalCatalogNodesRequestT& request,
                                   const ListSignalCatalogNodesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSignalCatalogs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSignalCatalogs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSignalCatalogsRequestT = Model::ListSignalCatalogsRequest>
  void ListSignalCatalogsAsync(const ListSignalCatalogsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListSignalCatalogsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListStateTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStateTemplates that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStateTemplatesRequestT = Model::ListStateTemplatesRequest>
  void ListStateTemplatesAsync(const ListStateTemplatesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListStateTemplatesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListVehicles that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListVehiclesRequestT = Model::ListVehiclesRequest>
  void ListVehiclesAsync(const ListVehiclesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListVehiclesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListVehiclesInFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListVehiclesInFleet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListVehiclesInFleetRequestT = Model::ListVehiclesInFleetRequest>
  void ListVehiclesInFleetAsync(const ListVehiclesInFleetRequestT& request, const ListVehiclesInFleetResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutEncryptionConfigurationOutcome PutEncryptionConfiguration(
      const Model::PutEncryptionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutEncryptionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutEncryptionConfigurationRequestT = Model::PutEncryptionConfigurationRequest>
  Model::PutEncryptionConfigurationOutcomeCallable PutEncryptionConfigurationCallable(
      const PutEncryptionConfigurationRequestT& request) const {
    return SubmitCallable(&IoTFleetWiseClient::PutEncryptionConfiguration, request);
  }

  /**
   * An Async wrapper for PutEncryptionConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutEncryptionConfigurationRequestT = Model::PutEncryptionConfigurationRequest>
  void PutEncryptionConfigurationAsync(const PutEncryptionConfigurationRequestT& request,
                                       const PutEncryptionConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RegisterAccount that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RegisterAccountRequestT = Model::RegisterAccountRequest>
  void RegisterAccountAsync(const RegisterAccountResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const RegisterAccountRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateDecoderManifest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDecoderManifest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDecoderManifestRequestT = Model::UpdateDecoderManifestRequest>
  void UpdateDecoderManifestAsync(const UpdateDecoderManifestRequestT& request, const UpdateDecoderManifestResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename UpdateFleetRequestT = Model::UpdateFleetRequest>
  void UpdateFleetAsync(const UpdateFleetRequestT& request, const UpdateFleetResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateModelManifest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateModelManifest that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateModelManifestRequestT = Model::UpdateModelManifestRequest>
  void UpdateModelManifestAsync(const UpdateModelManifestRequestT& request, const UpdateModelManifestResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSignalCatalog that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSignalCatalog that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateSignalCatalogRequestT = Model::UpdateSignalCatalogRequest>
  void UpdateSignalCatalogAsync(const UpdateSignalCatalogRequestT& request, const UpdateSignalCatalogResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateStateTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateStateTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateStateTemplateRequestT = Model::UpdateStateTemplateRequest>
  void UpdateStateTemplateAsync(const UpdateStateTemplateRequestT& request, const UpdateStateTemplateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateVehicle that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateVehicleRequestT = Model::UpdateVehicleRequest>
  void UpdateVehicleAsync(const UpdateVehicleRequestT& request, const UpdateVehicleResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
