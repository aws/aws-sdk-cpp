...
template <>
AWS_IOTFLEETWISE_API ConflictException IoTFleetWiseError::GetModeledError() {
  assert(this->GetErrorType() == IoTFleetWiseErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_IOTFLEETWISE_API ThrottlingException IoTFleetWiseError::GetModeledError() {
  assert(this->GetErrorType() == IoTFleetWiseErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_IOTFLEETWISE_API InternalServerException IoTFleetWiseError::GetModeledError() {
  assert(this->GetErrorType() == IoTFleetWiseErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_IOTFLEETWISE_API ResourceNotFoundException IoTFleetWiseError::GetModeledError() {
  assert(this->GetErrorType() == IoTFleetWiseErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_IOTFLEETWISE_API ValidationException IoTFleetWiseError::GetModeledError() {
  assert(this->GetErrorType() == IoTFleetWiseErrors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_IOTFLEETWISE_API DecoderManifestValidationException IoTFleetWiseError::GetModeledError() {
...
template <>
AWS_IOTFLEETWISE_API LimitExceededException IoTFleetWiseError::GetModeledError() {
  assert(this->GetErrorType() == IoTFleetWiseErrors::LIMIT_EXCEEDED);
  return LimitExceededException(this->GetJsonPayload().View());
}

template <>
AWS_IOTFLEETWISE_API InvalidNodeException IoTFleetWiseError::GetModeledError() {
  assert(this->GetErrorType() == IoTFleetWiseErrors::INVALID_NODE);
  return InvalidNodeException(this->GetJsonPayload().View());
}

template <>
AWS_IOTFLEETWISE_API InvalidSignalsException IoTFleetWiseError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(IoTFleetWiseErrors::LIMIT_EXCEEDED), RetryableType::RETRYABLE_THROTTLING);
