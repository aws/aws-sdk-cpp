...
Aws::String UpdateStateTemplateRequest::SerializePayload() const {
  ...
  if (m_stateTemplatePropertiesToAddHasBeenSet) {
    ...
    for (unsigned stateTemplatePropertiesToAddIndex = 0;
         stateTemplatePropertiesToAddIndex < stateTemplatePropertiesToAddJsonList.GetLength(); ++stateTemplatePropertiesToAddIndex) {
      stateTemplatePropertiesToAddJsonList[stateTemplatePropertiesToAddIndex].AsString(
          m_stateTemplatePropertiesToAdd[stateTemplatePropertiesToAddIndex]);
    }
  ...
  if (m_stateTemplatePropertiesToRemoveHasBeenSet) {
    ...
    for (unsigned stateTemplatePropertiesToRemoveIndex = 0;
         stateTemplatePropertiesToRemoveIndex < stateTemplatePropertiesToRemoveJsonList.GetLength();
         ++stateTemplatePropertiesToRemoveIndex) {
      stateTemplatePropertiesToRemoveJsonList[stateTemplatePropertiesToRemoveIndex].AsString(
          m_stateTemplatePropertiesToRemove[stateTemplatePropertiesToRemoveIndex]);
    }
