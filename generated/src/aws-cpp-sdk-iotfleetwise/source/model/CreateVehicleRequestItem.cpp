...
CreateVehicleRequestItem::CreateVehicleRequestItem(JsonView jsonValue) { *this = jsonValue; }
...
CreateVehicleRequestItem& CreateVehicleRequestItem::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("associationBehavior")) {
    m_associationBehavior =
        VehicleAssociationBehaviorMapper::GetVehicleAssociationBehaviorForName(jsonValue.GetString("associationBehavior"));
...
JsonValue CreateVehicleRequestItem::Jsonize() const {
  ...
  if (m_associationBehaviorHasBeenSet) {
    payload.WithString("associationBehavior",
                       VehicleAssociationBehaviorMapper::GetNameForVehicleAssociationBehavior(m_associationBehavior));
  }
