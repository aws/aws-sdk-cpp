...
ListDecoderManifestsResult::ListDecoderManifestsResult()
{
}

ListDecoderManifestsResult::ListDecoderManifestsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListDecoderManifestsResult& ListDecoderManifestsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
