...
Aws::String CreateStateTemplateRequest::SerializePayload() const {
  ...
  if (m_stateTemplatePropertiesHasBeenSet) {
    ...
    for (unsigned stateTemplatePropertiesIndex = 0; stateTemplatePropertiesIndex < stateTemplatePropertiesJsonList.GetLength();
         ++stateTemplatePropertiesIndex) {
  ...
  if (m_dataExtraDimensionsHasBeenSet) {
    ...
    for (unsigned dataExtraDimensionsIndex = 0; dataExtraDimensionsIndex < dataExtraDimensionsJsonList.GetLength();
         ++dataExtraDimensionsIndex) {
  ...
  if (m_metadataExtraDimensionsHasBeenSet) {
    ...
    for (unsigned metadataExtraDimensionsIndex = 0; metadataExtraDimensionsIndex < metadataExtraDimensionsJsonList.GetLength();
         ++metadataExtraDimensionsIndex) {
