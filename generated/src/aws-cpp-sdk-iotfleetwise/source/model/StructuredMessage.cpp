...
StructuredMessage::StructuredMessage(JsonView jsonValue) { *this = jsonValue; }
...
StructuredMessage& StructuredMessage::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("structuredMessageListDefinition")) {
    m_structuredMessageListDefinition =
        Aws::MakeShared<StructuredMessageListDefinition>("StructuredMessage", jsonValue.GetObject("structuredMessageListDefinition"));
  ...
  if (jsonValue.ValueExists("structuredMessageDefinition")) {
    ...
    for (unsigned structuredMessageDefinitionIndex = 0; structuredMessageDefinitionIndex < structuredMessageDefinitionJsonList.GetLength();
...
JsonValue StructuredMessage::Jsonize() const {
  ...
  if (m_structuredMessageDefinitionHasBeenSet) {
    ...
    for (unsigned structuredMessageDefinitionIndex = 0; structuredMessageDefinitionIndex < structuredMessageDefinitionJsonList.GetLength();
         ++structuredMessageDefinitionIndex) {
      structuredMessageDefinitionJsonList[structuredMessageDefinitionIndex].AsObject(
          m_structuredMessageDefinition[structuredMessageDefinitionIndex].Jsonize());
    }
