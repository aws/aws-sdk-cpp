...
S3Config& S3Config::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("storageCompressionFormat")) {
    m_storageCompressionFormat =
        StorageCompressionFormatMapper::GetStorageCompressionFormatForName(jsonValue.GetString("storageCompressionFormat"));
...
JsonValue S3Config::Jsonize() const {
  ...
  if (m_storageCompressionFormatHasBeenSet) {
    payload.WithString("storageCompressionFormat",
                       StorageCompressionFormatMapper::GetNameForStorageCompressionFormat(m_storageCompressionFormat));
  }
