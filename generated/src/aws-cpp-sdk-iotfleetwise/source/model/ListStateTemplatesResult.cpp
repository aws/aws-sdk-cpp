...
ListStateTemplatesResult::ListStateTemplatesResult()
{
}

ListStateTemplatesResult::ListStateTemplatesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListStateTemplatesResult& ListStateTemplatesResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
