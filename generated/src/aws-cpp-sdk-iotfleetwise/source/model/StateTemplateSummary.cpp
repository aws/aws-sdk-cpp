...
StateTemplateSummary::StateTemplateSummary(JsonView jsonValue) { *this = jsonValue; }

StateTemplateSummary& StateTemplateSummary::operator=(JsonView jsonValue) {
...
JsonValue StateTemplateSummary::Jsonize() const {
  JsonValue payload;
