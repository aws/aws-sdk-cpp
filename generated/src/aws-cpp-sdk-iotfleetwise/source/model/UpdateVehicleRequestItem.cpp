...
UpdateVehicleRequestItem::UpdateVehicleRequestItem(JsonView jsonValue) { *this = jsonValue; }
...
UpdateVehicleRequestItem& UpdateVehicleRequestItem::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("stateTemplatesToAdd")) {
    ...
    for (unsigned stateTemplatesToAddIndex = 0; stateTemplatesToAddIndex < stateTemplatesToAddJsonList.GetLength();
         ++stateTemplatesToAddIndex) {
  ...
  if (jsonValue.ValueExists("stateTemplatesToRemove")) {
    ...
    for (unsigned stateTemplatesToRemoveIndex = 0; stateTemplatesToRemoveIndex < stateTemplatesToRemoveJsonList.GetLength();
         ++stateTemplatesToRemoveIndex) {
  ...
  if (jsonValue.ValueExists("stateTemplatesToUpdate")) {
    ...
    for (unsigned stateTemplatesToUpdateIndex = 0; stateTemplatesToUpdateIndex < stateTemplatesToUpdateJsonList.GetLength();
         ++stateTemplatesToUpdateIndex) {
