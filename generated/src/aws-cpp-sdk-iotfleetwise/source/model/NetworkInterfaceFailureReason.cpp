...
static const int NETWORK_INTERFACE_TO_REMOVE_ASSOCIATED_WITH_SIGNALS_HASH =
    HashingUtils::HashString("NETWORK_INTERFACE_TO_REMOVE_ASSOCIATED_WITH_SIGNALS");
static const int VEHICLE_MIDDLEWARE_NETWORK_INTERFACE_INFO_IS_NULL_HASH =
    HashingUtils::HashString("VEHICLE_MIDDLEWARE_NETWORK_INTERFACE_INFO_IS_NULL");
static const int CUSTOM_DECODING_SIGNAL_NETWORK_INTERFACE_INFO_IS_NULL_HASH =
    HashingUtils::HashString("CUSTOM_DECODING_SIGNAL_NETWORK_INTERFACE_INFO_IS_NULL");
...
NetworkInterfaceFailureReason GetNetworkInterfaceFailureReasonForName(const Aws::String& name) {
  ...
  } else if (hashCode == VEHICLE_MIDDLEWARE_NETWORK_INTERFACE_INFO_IS_NULL_HASH) {
