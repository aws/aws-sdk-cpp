...
DecoderManifestValidationException::DecoderManifestValidationException(JsonView jsonValue) { *this = jsonValue; }
...
DecoderManifestValidationException& DecoderManifestValidationException::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("invalidNetworkInterfaces")) {
    ...
    for (unsigned invalidNetworkInterfacesIndex = 0; invalidNetworkInterfacesIndex < invalidNetworkInterfacesJsonList.GetLength();
         ++invalidNetworkInterfacesIndex) {
...
JsonValue DecoderManifestValidationException::Jsonize() const {
  ...
  if (m_invalidNetworkInterfacesHasBeenSet) {
    ...
    for (unsigned invalidNetworkInterfacesIndex = 0; invalidNetworkInterfacesIndex < invalidNetworkInterfacesJsonList.GetLength();
         ++invalidNetworkInterfacesIndex) {
      invalidNetworkInterfacesJsonList[invalidNetworkInterfacesIndex].AsObject(
          m_invalidNetworkInterfaces[invalidNetworkInterfacesIndex].Jsonize());
    }
