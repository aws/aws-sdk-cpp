...
class EventDestinationDefinition {
 public:
  ...
  template <typename CloudWatchLogsDestinationT = CloudWatchLogsDestination>
  EventDestinationDefinition& WithCloudWatchLogsDestination(CloudWatchLogsDestinationT&& value) {
  ...
  inline EventDestinationDefinition& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline EventDestinationDefinition& AddMatchingEventTypes(EventType value) {
    m_matchingEventTypesHasBeenSet = true;
