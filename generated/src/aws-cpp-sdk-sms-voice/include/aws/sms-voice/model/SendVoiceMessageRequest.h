...
class SendVoiceMessageRequest : public PinpointSMSVoiceRequest {
 public:
  ...
  void SetCallerId(CallerIdT&& value) {
    m_callerIdHasBeenSet = true;
    m_callerId = std::forward<CallerIdT>(value);
  }
  template <typename CallerIdT = Aws::String>
  SendVoiceMessageRequest& WithCallerId(CallerIdT&& value) {
    SetCallerId(std::forward<CallerIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ContentT = VoiceMessageContent>
  SendVoiceMessageRequest& WithContent(ContentT&& value) {
  ...
  void SetOriginationPhoneNumber(OriginationPhoneNumberT&& value) {
    m_originationPhoneNumberHasBeenSet = true;
    m_originationPhoneNumber = std::forward<OriginationPhoneNumberT>(value);
  }
  template <typename OriginationPhoneNumberT = Aws::String>
  SendVoiceMessageRequest& WithOriginationPhoneNumber(OriginationPhoneNumberT&& value) {
    SetOriginationPhoneNumber(std::forward<OriginationPhoneNumberT>(value));
    return *this;
  }
  ///@}
 private:
