...
class DeleteConfigurationSetEventDestinationResult {
 public:
  AWS_PINPOINTSMSVOICE_API DeleteConfigurationSetEventDestinationResult() = default;
  AWS_PINPOINTSMSVOICE_API DeleteConfigurationSetEventDestinationResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PINPOINTSMSVOICE_API DeleteConfigurationSetEventDestinationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
