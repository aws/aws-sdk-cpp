...
class UpdateConfigurationSetEventDestinationResult {
 public:
  AWS_PINPOINTSMSVOICE_API UpdateConfigurationSetEventDestinationResult() = default;
  AWS_PINPOINTSMSVOICE_API UpdateConfigurationSetEventDestinationResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PINPOINTSMSVOICE_API UpdateConfigurationSetEventDestinationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConfigurationSetEventDestinationResult& WithRequestId(RequestIdT&& value) {
