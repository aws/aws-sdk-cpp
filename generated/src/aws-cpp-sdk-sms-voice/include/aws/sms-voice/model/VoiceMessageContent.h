...
class VoiceMessageContent {
 public:
  ...
  void SetCallInstructionsMessage(CallInstructionsMessageT&& value) {
    m_callInstructionsMessageHasBeenSet = true;
    m_callInstructionsMessage = std::forward<CallInstructionsMessageT>(value);
  }
  template <typename CallInstructionsMessageT = CallInstructionsMessageType>
  VoiceMessageContent& WithCallInstructionsMessage(CallInstructionsMessageT&& value) {
    SetCallInstructionsMessage(std::forward<CallInstructionsMessageT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PlainTextMessageT = PlainTextMessageType>
  VoiceMessageContent& WithPlainTextMessage(PlainTextMessageT&& value) {
  ...
  template <typename SSMLMessageT = SSMLMessageType>
  VoiceMessageContent& WithSSMLMessage(SSMLMessageT&& value) {
