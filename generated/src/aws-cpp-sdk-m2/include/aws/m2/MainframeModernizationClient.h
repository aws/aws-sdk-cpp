...
namespace MainframeModernization
{
   ...
   */
  class AWS_MAINFRAMEMODERNIZATION_API MainframeModernizationClient : Aws::Client::ClientWithAsyncTemplateMethods<MainframeModernizationClient>,
    smithy::client::AwsSmithyClientT<Aws::MainframeModernization::SERVICE_NAME,
