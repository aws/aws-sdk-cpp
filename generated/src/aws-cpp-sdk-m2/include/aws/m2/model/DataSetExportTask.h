...
class DataSetExportTask {
 public:
  ...
  inline void SetStatus(DataSetTaskLifecycle value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DataSetExportTask& WithStatus(DataSetTaskLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  DataSetExportTask& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename SummaryT = DataSetExportSummary>
  DataSetExportTask& WithSummary(SummaryT&& value) {
  ...
  template <typename TaskIdT = Aws::String>
  DataSetExportTask& WithTaskId(TaskIdT&& value) {
