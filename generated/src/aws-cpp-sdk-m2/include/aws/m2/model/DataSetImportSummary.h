...
class DataSetImportSummary {
 public:
  AWS_MAINFRAMEMODERNIZATION_API DataSetImportSummary() = default;
  ...
  inline DataSetImportSummary& WithFailed(int value) {
    SetFailed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInProgress(int value) {
    m_inProgressHasBeenSet = true;
    m_inProgress = value;
  }
  inline DataSetImportSummary& WithInProgress(int value) {
    SetInProgress(value);
    return *this;
  }
  ///@}
  ...
  inline DataSetImportSummary& WithPending(int value) {
    SetPending(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSucceeded(int value) {
    m_succeededHasBeenSet = true;
    m_succeeded = value;
  }
  inline DataSetImportSummary& WithSucceeded(int value) {
    SetSucceeded(value);
    return *this;
  }
  ///@}
  ...
  inline DataSetImportSummary& WithTotal(int value) {
    SetTotal(value);
    return *this;
  }
  ///@}
