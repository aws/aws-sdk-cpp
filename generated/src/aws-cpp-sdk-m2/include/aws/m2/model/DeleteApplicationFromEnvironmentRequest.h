...
class DeleteApplicationFromEnvironmentRequest : public MainframeModernizationRequest {
 public:
  AWS_MAINFRAMEMODERNIZATION_API DeleteApplicationFromEnvironmentRequest() = default;
  ...
  template <typename ApplicationIdT = Aws::String>
  DeleteApplicationFromEnvironmentRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  DeleteApplicationFromEnvironmentRequest& WithEnvironmentId(EnvironmentIdT&& value) {
