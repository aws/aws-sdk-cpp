...
class GetBatchJobExecutionResult {
 public:
  ...
  AWS_MAINFRAMEMODERNIZATION_API GetBatchJobExecutionResult& operator=(
  ...
  void SetJobStepRestartMarker(JobStepRestartMarkerT&& value) {
    ...
    m_jobStepRestartMarker = std::forward<JobStepRestartMarkerT>(value);
  }
  template <typename JobStepRestartMarkerT = JobStepRestartMarker>
  GetBatchJobExecutionResult& WithJobStepRestartMarker(JobStepRestartMarkerT&& value) {
    SetJobStepRestartMarker(std::forward<JobStepRestartMarkerT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetJobType(BatchJobType value) {
    m_jobTypeHasBeenSet = true;
    m_jobType = value;
  }
  inline GetBatchJobExecutionResult& WithJobType(BatchJobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  void SetJobUser(JobUserT&& value) {
    ...
    m_jobUser = std::forward<JobUserT>(value);
  }
  template <typename JobUserT = Aws::String>
  GetBatchJobExecutionResult& WithJobUser(JobUserT&& value) {
    SetJobUser(std::forward<JobUserT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReturnCode(ReturnCodeT&& value) {
    ...
    m_returnCode = std::forward<ReturnCodeT>(value);
  }
  template <typename ReturnCodeT = Aws::String>
  GetBatchJobExecutionResult& WithReturnCode(ReturnCodeT&& value) {
    SetReturnCode(std::forward<ReturnCodeT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetBatchJobExecutionResult& WithStatus(BatchJobExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
