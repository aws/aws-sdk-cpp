...
class BatchJobDefinition {
 public:
  ...
  void SetFileBatchJobDefinition(FileBatchJobDefinitionT&& value) {
    ...
    m_fileBatchJobDefinition = std::forward<FileBatchJobDefinitionT>(value);
  }
  template <typename FileBatchJobDefinitionT = FileBatchJobDefinition>
  BatchJobDefinition& WithFileBatchJobDefinition(FileBatchJobDefinitionT&& value) {
    SetFileBatchJobDefinition(std::forward<FileBatchJobDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScriptBatchJobDefinition(ScriptBatchJobDefinitionT&& value) {
    ...
    m_scriptBatchJobDefinition = std::forward<ScriptBatchJobDefinitionT>(value);
  }
  template <typename ScriptBatchJobDefinitionT = ScriptBatchJobDefinition>
  BatchJobDefinition& WithScriptBatchJobDefinition(ScriptBatchJobDefinitionT&& value) {
    SetScriptBatchJobDefinition(std::forward<ScriptBatchJobDefinitionT>(value));
    return *this;
  }
  ///@}
 private:
