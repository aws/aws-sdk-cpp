...
class ListDataSetExportHistoryResult {
 public:
  ...
  AWS_MAINFRAMEMODERNIZATION_API ListDataSetExportHistoryResult& operator=(
  ...
  void SetDataSetExportTasks(DataSetExportTasksT&& value) {
    m_dataSetExportTasksHasBeenSet = true;
    m_dataSetExportTasks = std::forward<DataSetExportTasksT>(value);
  }
  template <typename DataSetExportTasksT = Aws::Vector<DataSetExportTask>>
  ListDataSetExportHistoryResult& WithDataSetExportTasks(DataSetExportTasksT&& value) {
    SetDataSetExportTasks(std::forward<DataSetExportTasksT>(value));
    return *this;
  }
  template <typename DataSetExportTasksT = DataSetExportTask>
  ListDataSetExportHistoryResult& AddDataSetExportTasks(DataSetExportTasksT&& value) {
    m_dataSetExportTasksHasBeenSet = true;
    m_dataSetExportTasks.emplace_back(std::forward<DataSetExportTasksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataSetExportHistoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataSetExportHistoryResult& WithRequestId(RequestIdT&& value) {
