...
class EngineVersionsSummary {
 public:
  ...
  void SetEngineType(EngineTypeT&& value) {
    ...
    m_engineType = std::forward<EngineTypeT>(value);
  }
  template <typename EngineTypeT = Aws::String>
  EngineVersionsSummary& WithEngineType(EngineTypeT&& value) {
    SetEngineType(std::forward<EngineTypeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EngineVersionT = Aws::String>
  EngineVersionsSummary& WithEngineVersion(EngineVersionT&& value) {
