...
class ListDataSetImportHistoryRequest : public MainframeModernizationRequest {
 public:
  AWS_MAINFRAMEMODERNIZATION_API ListDataSetImportHistoryRequest() = default;
  ...
  template <typename ApplicationIdT = Aws::String>
  ListDataSetImportHistoryRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline ListDataSetImportHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataSetImportHistoryRequest& WithNextToken(NextTokenT&& value) {
