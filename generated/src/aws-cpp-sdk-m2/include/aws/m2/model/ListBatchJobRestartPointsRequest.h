...
class ListBatchJobRestartPointsRequest : public MainframeModernizationRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  ListBatchJobRestartPointsRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename AuthSecretsManagerArnT = Aws::String>
  ListBatchJobRestartPointsRequest& WithAuthSecretsManagerArn(AuthSecretsManagerArnT&& value) {
  ...
  template <typename ExecutionIdT = Aws::String>
  ListBatchJobRestartPointsRequest& WithExecutionId(ExecutionIdT&& value) {
