...
class DataSetExportSummary {
 public:
  ...
  inline DataSetExportSummary& WithFailed(int value) {
    SetFailed(value);
    return *this;
  }
  ///@}
  ...
  inline DataSetExportSummary& WithInProgress(int value) {
    SetInProgress(value);
    return *this;
  }
  ///@}
  ...
  inline DataSetExportSummary& WithPending(int value) {
    SetPending(value);
    return *this;
  }
  ///@}
  ...
  inline DataSetExportSummary& WithSucceeded(int value) {
    SetSucceeded(value);
    return *this;
  }
  ///@}
  ...
  inline DataSetExportSummary& WithTotal(int value) {
    SetTotal(value);
    return *this;
  }
  ///@}
