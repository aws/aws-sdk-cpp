...
class ListBatchJobDefinitionsResult {
 public:
  ...
  AWS_MAINFRAMEMODERNIZATION_API ListBatchJobDefinitionsResult& operator=(
  ...
  void SetBatchJobDefinitions(BatchJobDefinitionsT&& value) {
    m_batchJobDefinitionsHasBeenSet = true;
    m_batchJobDefinitions = std::forward<BatchJobDefinitionsT>(value);
  }
  template <typename BatchJobDefinitionsT = Aws::Vector<BatchJobDefinition>>
  ListBatchJobDefinitionsResult& WithBatchJobDefinitions(BatchJobDefinitionsT&& value) {
    SetBatchJobDefinitions(std::forward<BatchJobDefinitionsT>(value));
    return *this;
  }
  template <typename BatchJobDefinitionsT = BatchJobDefinition>
  ListBatchJobDefinitionsResult& AddBatchJobDefinitions(BatchJobDefinitionsT&& value) {
    m_batchJobDefinitionsHasBeenSet = true;
    m_batchJobDefinitions.emplace_back(std::forward<BatchJobDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBatchJobDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBatchJobDefinitionsResult& WithRequestId(RequestIdT&& value) {
