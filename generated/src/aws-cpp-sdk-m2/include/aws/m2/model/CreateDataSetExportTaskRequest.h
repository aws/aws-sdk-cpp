...
class CreateDataSetExportTaskRequest : public MainframeModernizationRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateDataSetExportTaskRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateDataSetExportTaskRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ExportConfigT = DataSetExportConfig>
  CreateDataSetExportTaskRequest& WithExportConfig(ExportConfigT&& value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  CreateDataSetExportTaskRequest& WithKmsKeyId(KmsKeyIdT&& value) {
