...
class CreateDeploymentRequest : public MainframeModernizationRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateDeploymentRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline CreateDeploymentRequest& WithApplicationVersion(int value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  CreateDeploymentRequest& WithEnvironmentId(EnvironmentIdT&& value) {
