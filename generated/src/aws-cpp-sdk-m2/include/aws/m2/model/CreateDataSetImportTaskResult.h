...
class CreateDataSetImportTaskResult {
 public:
  ...
  AWS_MAINFRAMEMODERNIZATION_API CreateDataSetImportTaskResult& operator=(
  ...
  template <typename TaskIdT = Aws::String>
  CreateDataSetImportTaskResult& WithTaskId(TaskIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDataSetImportTaskResult& WithRequestId(RequestIdT&& value) {
