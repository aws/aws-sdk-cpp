...
class CreateDataSetImportTaskRequest : public MainframeModernizationRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateDataSetImportTaskRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateDataSetImportTaskRequest& WithClientToken(ClientTokenT&& value) {
  ...
  void SetImportConfig(ImportConfigT&& value) {
    m_importConfigHasBeenSet = true;
    m_importConfig = std::forward<ImportConfigT>(value);
  }
  template <typename ImportConfigT = DataSetImportConfig>
  CreateDataSetImportTaskRequest& WithImportConfig(ImportConfigT&& value) {
    SetImportConfig(std::forward<ImportConfigT>(value));
    return *this;
  }
  ///@}
 private:
