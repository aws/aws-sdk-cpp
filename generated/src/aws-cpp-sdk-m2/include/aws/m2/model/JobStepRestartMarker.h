...
class JobStepRestartMarker {
 public:
  ...
  void SetFromProcStep(FromProcStepT&& value) {
    ...
    m_fromProcStep = std::forward<FromProcStepT>(value);
  }
  template <typename FromProcStepT = Aws::String>
  JobStepRestartMarker& WithFromProcStep(FromProcStepT&& value) {
    SetFromProcStep(std::forward<FromProcStepT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromStep(FromStepT&& value) {
    ...
    m_fromStep = std::forward<FromStepT>(value);
  }
  template <typename FromStepT = Aws::String>
  JobStepRestartMarker& WithFromStep(FromStepT&& value) {
    SetFromStep(std::forward<FromStepT>(value));
    return *this;
  }
  ///@}
  ...
  inline JobStepRestartMarker& WithSkip(bool value) {
    SetSkip(value);
    return *this;
  }
  ///@}
  ...
  inline JobStepRestartMarker& WithStepCheckpoint(int value) {
  ...
  void SetToProcStep(ToProcStepT&& value) {
    ...
    m_toProcStep = std::forward<ToProcStepT>(value);
  }
  template <typename ToProcStepT = Aws::String>
  JobStepRestartMarker& WithToProcStep(ToProcStepT&& value) {
    SetToProcStep(std::forward<ToProcStepT>(value));
    return *this;
  }
  ///@}
  ...
  void SetToStep(ToStepT&& value) {
    ...
    m_toStep = std::forward<ToStepT>(value);
  }
  template <typename ToStepT = Aws::String>
  JobStepRestartMarker& WithToStep(ToStepT&& value) {
    SetToStep(std::forward<ToStepT>(value));
    return *this;
  }
  ///@}
 private:
