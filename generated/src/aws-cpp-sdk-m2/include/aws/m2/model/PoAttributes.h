...
class PoAttributes {
 public:
  ...
  template <typename EncodingT = Aws::String>
  PoAttributes& WithEncoding(EncodingT&& value) {
  ...
  template <typename FormatT = Aws::String>
  PoAttributes& WithFormat(FormatT&& value) {
  ...
  void SetMemberFileExtensions(MemberFileExtensionsT&& value) {
    m_memberFileExtensionsHasBeenSet = true;
    m_memberFileExtensions = std::forward<MemberFileExtensionsT>(value);
  }
  template <typename MemberFileExtensionsT = Aws::Vector<Aws::String>>
  PoAttributes& WithMemberFileExtensions(MemberFileExtensionsT&& value) {
    SetMemberFileExtensions(std::forward<MemberFileExtensionsT>(value));
    return *this;
  }
  template <typename MemberFileExtensionsT = Aws::String>
  PoAttributes& AddMemberFileExtensions(MemberFileExtensionsT&& value) {
    m_memberFileExtensionsHasBeenSet = true;
    m_memberFileExtensions.emplace_back(std::forward<MemberFileExtensionsT>(value));
    return *this;
  }
  ///@}
 private:
