...
class VsamAttributes {
 public:
  ...
  void SetAlternateKeys(AlternateKeysT&& value) {
    ...
    m_alternateKeys = std::forward<AlternateKeysT>(value);
  }
  template <typename AlternateKeysT = Aws::Vector<AlternateKey>>
  VsamAttributes& WithAlternateKeys(AlternateKeysT&& value) {
    SetAlternateKeys(std::forward<AlternateKeysT>(value));
    return *this;
  }
  template <typename AlternateKeysT = AlternateKey>
  VsamAttributes& AddAlternateKeys(AlternateKeysT&& value) {
    m_alternateKeysHasBeenSet = true;
    m_alternateKeys.emplace_back(std::forward<AlternateKeysT>(value));
    return *this;
  }
  ///@}
  ...
  inline VsamAttributes& WithCompressed(bool value) {
    SetCompressed(value);
    return *this;
  }
  ///@}
