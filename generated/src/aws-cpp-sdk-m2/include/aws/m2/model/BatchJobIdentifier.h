...
class BatchJobIdentifier {
 public:
  ...
  void SetFileBatchJobIdentifier(FileBatchJobIdentifierT&& value) {
    ...
    m_fileBatchJobIdentifier = std::forward<FileBatchJobIdentifierT>(value);
  }
  template <typename FileBatchJobIdentifierT = FileBatchJobIdentifier>
  BatchJobIdentifier& WithFileBatchJobIdentifier(FileBatchJobIdentifierT&& value) {
    SetFileBatchJobIdentifier(std::forward<FileBatchJobIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRestartBatchJobIdentifier(RestartBatchJobIdentifierT&& value) {
    ...
    m_restartBatchJobIdentifier = std::forward<RestartBatchJobIdentifierT>(value);
  }
  template <typename RestartBatchJobIdentifierT = RestartBatchJobIdentifier>
  BatchJobIdentifier& WithRestartBatchJobIdentifier(RestartBatchJobIdentifierT&& value) {
    SetRestartBatchJobIdentifier(std::forward<RestartBatchJobIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3BatchJobIdentifier(S3BatchJobIdentifierT&& value) {
    ...
    m_s3BatchJobIdentifier = std::forward<S3BatchJobIdentifierT>(value);
  }
  template <typename S3BatchJobIdentifierT = S3BatchJobIdentifier>
  BatchJobIdentifier& WithS3BatchJobIdentifier(S3BatchJobIdentifierT&& value) {
    SetS3BatchJobIdentifier(std::forward<S3BatchJobIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScriptBatchJobIdentifier(ScriptBatchJobIdentifierT&& value) {
    ...
    m_scriptBatchJobIdentifier = std::forward<ScriptBatchJobIdentifierT>(value);
  }
  template <typename ScriptBatchJobIdentifierT = ScriptBatchJobIdentifier>
  BatchJobIdentifier& WithScriptBatchJobIdentifier(ScriptBatchJobIdentifierT&& value) {
    SetScriptBatchJobIdentifier(std::forward<ScriptBatchJobIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
