...
class ListBatchJobDefinitionsRequest : public MainframeModernizationRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  ListBatchJobDefinitionsRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline ListBatchJobDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBatchJobDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename PrefixT = Aws::String>
  ListBatchJobDefinitionsRequest& WithPrefix(PrefixT&& value) {
