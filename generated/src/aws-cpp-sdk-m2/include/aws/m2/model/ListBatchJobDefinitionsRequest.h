...
namespace Model
{
  ...
  {
  public:
    AWS_MAINFRAMEMODERNIZATION_API ListBatchJobDefinitionsRequest() = default;
    ...
    template<typename ApplicationIdT = Aws::String>
    ListBatchJobDefinitionsRequest& WithApplicationId(ApplicationIdT&& value) { SetApplicationId(std::forward<ApplicationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListBatchJobDefinitionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename PrefixT = Aws::String>
    ListBatchJobDefinitionsRequest& WithPrefix(PrefixT&& value) { SetPrefix(std::forward<PrefixT>(value)); return *this;}
    ///@}
  private:
