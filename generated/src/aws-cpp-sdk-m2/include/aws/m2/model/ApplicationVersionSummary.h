...
class ApplicationVersionSummary {
 public:
  ...
  inline ApplicationVersionSummary& WithApplicationVersion(int value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ApplicationVersionSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  inline ApplicationVersionSummary& WithStatus(ApplicationVersionLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  ApplicationVersionSummary& WithStatusReason(StatusReasonT&& value) {
