...
class JobStep {
 public:
  ...
  void SetProcStepName(ProcStepNameT&& value) {
    ...
    m_procStepName = std::forward<ProcStepNameT>(value);
  }
  template <typename ProcStepNameT = Aws::String>
  JobStep& WithProcStepName(ProcStepNameT&& value) {
    SetProcStepName(std::forward<ProcStepNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProcStepNumber(int value) {
    m_procStepNumberHasBeenSet = true;
    m_procStepNumber = value;
  }
  inline JobStep& WithProcStepNumber(int value) {
    SetProcStepNumber(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStepCheckpoint(int value) {
    m_stepCheckpointHasBeenSet = true;
    m_stepCheckpoint = value;
  }
  inline JobStep& WithStepCheckpoint(int value) {
    SetStepCheckpoint(value);
    return *this;
  }
  ///@}
  ...
  void SetStepCheckpointStatus(StepCheckpointStatusT&& value) {
    ...
    m_stepCheckpointStatus = std::forward<StepCheckpointStatusT>(value);
  }
  template <typename StepCheckpointStatusT = Aws::String>
  JobStep& WithStepCheckpointStatus(StepCheckpointStatusT&& value) {
    SetStepCheckpointStatus(std::forward<StepCheckpointStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStepCheckpointTime(StepCheckpointTimeT&& value) {
    ...
    m_stepCheckpointTime = std::forward<StepCheckpointTimeT>(value);
  }
  template <typename StepCheckpointTimeT = Aws::Utils::DateTime>
  JobStep& WithStepCheckpointTime(StepCheckpointTimeT&& value) {
    SetStepCheckpointTime(std::forward<StepCheckpointTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStepCondCode(StepCondCodeT&& value) {
    ...
    m_stepCondCode = std::forward<StepCondCodeT>(value);
  }
  template <typename StepCondCodeT = Aws::String>
  JobStep& WithStepCondCode(StepCondCodeT&& value) {
    SetStepCondCode(std::forward<StepCondCodeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStepNumber(int value) {
    m_stepNumberHasBeenSet = true;
    m_stepNumber = value;
  }
  inline JobStep& WithStepNumber(int value) {
    SetStepNumber(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStepRestartable(bool value) {
    m_stepRestartableHasBeenSet = true;
    m_stepRestartable = value;
  }
  inline JobStep& WithStepRestartable(bool value) {
    SetStepRestartable(value);
    return *this;
  }
  ///@}
 private:
