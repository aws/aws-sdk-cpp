...
class ListBatchJobExecutionsRequest : public MainframeModernizationRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  ListBatchJobExecutionsRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  void SetExecutionIds(ExecutionIdsT&& value) {
    ...
    m_executionIds = std::forward<ExecutionIdsT>(value);
  }
  template <typename ExecutionIdsT = Aws::Vector<Aws::String>>
  ListBatchJobExecutionsRequest& WithExecutionIds(ExecutionIdsT&& value) {
    SetExecutionIds(std::forward<ExecutionIdsT>(value));
    return *this;
  }
  template <typename ExecutionIdsT = Aws::String>
  ListBatchJobExecutionsRequest& AddExecutionIds(ExecutionIdsT&& value) {
    m_executionIdsHasBeenSet = true;
    m_executionIds.emplace_back(std::forward<ExecutionIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename JobNameT = Aws::String>
  ListBatchJobExecutionsRequest& WithJobName(JobNameT&& value) {
  ...
  inline ListBatchJobExecutionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBatchJobExecutionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename StartedAfterT = Aws::Utils::DateTime>
  ListBatchJobExecutionsRequest& WithStartedAfter(StartedAfterT&& value) {
  ...
  template <typename StartedBeforeT = Aws::Utils::DateTime>
  ListBatchJobExecutionsRequest& WithStartedBefore(StartedBeforeT&& value) {
  ...
  inline void SetStatus(BatchJobExecutionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListBatchJobExecutionsRequest& WithStatus(BatchJobExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
