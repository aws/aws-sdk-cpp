...
class GetDataSetExportTaskResult {
 public:
  ...
  AWS_MAINFRAMEMODERNIZATION_API GetDataSetExportTaskResult& operator=(
  ...
  template <typename KmsKeyArnT = Aws::String>
  GetDataSetExportTaskResult& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  inline GetDataSetExportTaskResult& WithStatus(DataSetTaskLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  GetDataSetExportTaskResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename SummaryT = DataSetExportSummary>
  GetDataSetExportTaskResult& WithSummary(SummaryT&& value) {
  ...
  template <typename TaskIdT = Aws::String>
  GetDataSetExportTaskResult& WithTaskId(TaskIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDataSetExportTaskResult& WithRequestId(RequestIdT&& value) {
