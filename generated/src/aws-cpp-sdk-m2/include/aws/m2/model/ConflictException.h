...
namespace Model
{
  ...
  {
  public:
    AWS_MAINFRAMEMODERNIZATION_API ConflictException() = default;
    AWS_MAINFRAMEMODERNIZATION_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_MAINFRAMEMODERNIZATION_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
