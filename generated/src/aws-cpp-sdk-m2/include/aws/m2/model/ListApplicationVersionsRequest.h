...
/**
 */
class ListApplicationVersionsRequest : public MainframeModernizationRequest {
 public:
  AWS_MAINFRAMEMODERNIZATION_API ListApplicationVersionsRequest() = default;
  ...
  inline ListApplicationVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
