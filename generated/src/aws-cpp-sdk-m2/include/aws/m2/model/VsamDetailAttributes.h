...
class VsamDetailAttributes {
 public:
  ...
  inline void SetCacheAtStartup(bool value) {
    m_cacheAtStartupHasBeenSet = true;
    m_cacheAtStartup = value;
  }
  inline VsamDetailAttributes& WithCacheAtStartup(bool value) {
    SetCacheAtStartup(value);
    return *this;
  }
  ///@}
  ...
  inline VsamDetailAttributes& WithCompressed(bool value) {
    SetCompressed(value);
    return *this;
  }
  ///@}
  ...
  void SetRecordFormat(RecordFormatT&& value) {
    ...
    m_recordFormat = std::forward<RecordFormatT>(value);
  }
  template <typename RecordFormatT = Aws::String>
  VsamDetailAttributes& WithRecordFormat(RecordFormatT&& value) {
    SetRecordFormat(std::forward<RecordFormatT>(value));
    return *this;
  }
  ///@}
 private:
