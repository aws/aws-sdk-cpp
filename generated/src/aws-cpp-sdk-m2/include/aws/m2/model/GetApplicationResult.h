...
class GetApplicationResult {
 public:
  ...
  void SetDeployedVersion(DeployedVersionT&& value) {
    ...
    m_deployedVersion = std::forward<DeployedVersionT>(value);
  }
  template <typename DeployedVersionT = DeployedVersionSummary>
  GetApplicationResult& WithDeployedVersion(DeployedVersionT&& value) {
    SetDeployedVersion(std::forward<DeployedVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetApplicationResult& WithEngineType(EngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
  ...
  void SetListenerPorts(ListenerPortsT&& value) {
    ...
    m_listenerPorts = std::forward<ListenerPortsT>(value);
  }
  template <typename ListenerPortsT = Aws::Vector<int>>
  GetApplicationResult& WithListenerPorts(ListenerPortsT&& value) {
    SetListenerPorts(std::forward<ListenerPortsT>(value));
    return *this;
  }
  inline GetApplicationResult& AddListenerPorts(int value) {
    m_listenerPortsHasBeenSet = true;
    m_listenerPorts.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetLoadBalancerDnsName(LoadBalancerDnsNameT&& value) {
    ...
    m_loadBalancerDnsName = std::forward<LoadBalancerDnsNameT>(value);
  }
  template <typename LoadBalancerDnsNameT = Aws::String>
  GetApplicationResult& WithLoadBalancerDnsName(LoadBalancerDnsNameT&& value) {
    SetLoadBalancerDnsName(std::forward<LoadBalancerDnsNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetApplicationResult& WithStatus(ApplicationLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
