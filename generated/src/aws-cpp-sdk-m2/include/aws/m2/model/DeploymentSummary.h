...
class DeploymentSummary {
 public:
  ...
  inline DeploymentSummary& WithApplicationVersion(int value) {
  ...
  inline void SetStatus(DeploymentLifecycle value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DeploymentSummary& WithStatus(DeploymentLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
