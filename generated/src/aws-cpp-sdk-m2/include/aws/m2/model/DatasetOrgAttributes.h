...
class DatasetOrgAttributes {
 public:
  ...
  void SetGdg(GdgT&& value) {
    ...
    m_gdg = std::forward<GdgT>(value);
  }
  template <typename GdgT = GdgAttributes>
  DatasetOrgAttributes& WithGdg(GdgT&& value) {
    SetGdg(std::forward<GdgT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPo(PoT&& value) {
    m_poHasBeenSet = true;
    m_po = std::forward<PoT>(value);
  }
  template <typename PoT = PoAttributes>
  DatasetOrgAttributes& WithPo(PoT&& value) {
    SetPo(std::forward<PoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPs(PsT&& value) {
    m_psHasBeenSet = true;
    m_ps = std::forward<PsT>(value);
  }
  template <typename PsT = PsAttributes>
  DatasetOrgAttributes& WithPs(PsT&& value) {
    SetPs(std::forward<PsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVsam(VsamT&& value) {
    ...
    m_vsam = std::forward<VsamT>(value);
  }
  template <typename VsamT = VsamAttributes>
  DatasetOrgAttributes& WithVsam(VsamT&& value) {
    SetVsam(std::forward<VsamT>(value));
    return *this;
  }
  ///@}
 private:
