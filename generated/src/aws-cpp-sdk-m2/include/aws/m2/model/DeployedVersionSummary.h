...
class DeployedVersionSummary {
 public:
  ...
  inline DeployedVersionSummary& WithApplicationVersion(int value) {
  ...
  inline DeployedVersionSummary& WithStatus(DeploymentLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  DeployedVersionSummary& WithStatusReason(StatusReasonT&& value) {
