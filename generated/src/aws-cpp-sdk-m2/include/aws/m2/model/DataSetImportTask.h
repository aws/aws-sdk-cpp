...
class DataSetImportTask {
 public:
  ...
  inline DataSetImportTask& WithStatus(DataSetTaskLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  DataSetImportTask& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename SummaryT = DataSetImportSummary>
  DataSetImportTask& WithSummary(SummaryT&& value) {
  ...
  template <typename TaskIdT = Aws::String>
  DataSetImportTask& WithTaskId(TaskIdT&& value) {
