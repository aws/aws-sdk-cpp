...
class UpdateEnvironmentRequest : public MainframeModernizationRequest {
 public:
  ...
  inline void SetApplyDuringMaintenanceWindow(bool value) {
    m_applyDuringMaintenanceWindowHasBeenSet = true;
    m_applyDuringMaintenanceWindow = value;
  }
  inline UpdateEnvironmentRequest& WithApplyDuringMaintenanceWindow(bool value) {
    SetApplyDuringMaintenanceWindow(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateEnvironmentRequest& WithDesiredCapacity(int value) {
  ...
  inline UpdateEnvironmentRequest& WithForceUpdate(bool value) {
