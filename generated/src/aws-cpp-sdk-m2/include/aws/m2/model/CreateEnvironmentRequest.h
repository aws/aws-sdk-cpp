...
class CreateEnvironmentRequest : public MainframeModernizationRequest {
 public:
  ...
  inline CreateEnvironmentRequest& WithEngineType(EngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEnvironmentRequest& WithNetworkType(NetworkType value) {
  ...
  inline CreateEnvironmentRequest& WithPubliclyAccessible(bool value) {
