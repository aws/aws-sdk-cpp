...
class ListBatchJobRestartPointsResult {
 public:
  ...
  AWS_MAINFRAMEMODERNIZATION_API ListBatchJobRestartPointsResult& operator=(
  ...
  void SetBatchJobSteps(BatchJobStepsT&& value) {
    m_batchJobStepsHasBeenSet = true;
    m_batchJobSteps = std::forward<BatchJobStepsT>(value);
  }
  template <typename BatchJobStepsT = Aws::Vector<JobStep>>
  ListBatchJobRestartPointsResult& WithBatchJobSteps(BatchJobStepsT&& value) {
    SetBatchJobSteps(std::forward<BatchJobStepsT>(value));
    return *this;
  }
  template <typename BatchJobStepsT = JobStep>
  ListBatchJobRestartPointsResult& AddBatchJobSteps(BatchJobStepsT&& value) {
    m_batchJobStepsHasBeenSet = true;
    m_batchJobSteps.emplace_back(std::forward<BatchJobStepsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBatchJobRestartPointsResult& WithRequestId(RequestIdT&& value) {
