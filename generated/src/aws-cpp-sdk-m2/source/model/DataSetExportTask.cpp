...
DataSetExportTask::DataSetExportTask(JsonView jsonValue) { *this = jsonValue; }

DataSetExportTask& DataSetExportTask::operator=(JsonView jsonValue) {
...
JsonValue DataSetExportTask::Jsonize() const {
  JsonValue payload;
