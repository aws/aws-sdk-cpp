...
DataSetExportConfig::DataSetExportConfig(JsonView jsonValue) { *this = jsonValue; }

DataSetExportConfig& DataSetExportConfig::operator=(JsonView jsonValue) {
...
JsonValue DataSetExportConfig::Jsonize() const {
  JsonValue payload;
