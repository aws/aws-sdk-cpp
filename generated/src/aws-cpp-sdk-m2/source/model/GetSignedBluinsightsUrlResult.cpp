...
GetSignedBluinsightsUrlResult::GetSignedBluinsightsUrlResult()
{
}

GetSignedBluinsightsUrlResult::GetSignedBluinsightsUrlResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
