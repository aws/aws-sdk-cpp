...
{
const size_t MainframeModernizationEndpointRules::RulesBlobStrLen = 3502;
const size_t MainframeModernizationEndpointRules::RulesBlobSize = 3503;
...
'/','m','2','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
't','t','p','s',':','/','/','m','2','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
