...
namespace Model
{
  ...
  public:
    ...
    template<typename PublicKeyT = PublicKey>
    GetPublicKey2020_05_31Result& WithPublicKey(PublicKeyT&& value) { SetPublicKey(std::forward<PublicKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    GetPublicKey2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetPublicKey2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
