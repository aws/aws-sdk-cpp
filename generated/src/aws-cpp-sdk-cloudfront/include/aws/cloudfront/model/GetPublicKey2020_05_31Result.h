...
namespace Model
{
  class GetPublicKey2020_05_31Result
  {
  public:
    AWS_CLOUDFRONT_API GetPublicKey2020_05_31Result();
    ...
    inline GetPublicKey2020_05_31Result& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetPublicKey2020_05_31Result& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetPublicKey2020_05_31Result& WithRequestId(const char* value) { SetRequestId(value); return *this;}
