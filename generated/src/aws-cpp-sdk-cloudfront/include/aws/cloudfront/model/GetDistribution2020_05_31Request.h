...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetDistribution2020_05_31Request : public CloudFrontRequest
  {
  public:
    AWS_CLOUDFRONT_API GetDistribution2020_05_31Request() = default;
    ...
    template<typename IdT = Aws::String>
    GetDistribution2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
