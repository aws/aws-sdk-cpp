...
class UpdateCloudFrontOriginAccessIdentity2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API UpdateCloudFrontOriginAccessIdentity2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename CloudFrontOriginAccessIdentityT = CloudFrontOriginAccessIdentity>
  UpdateCloudFrontOriginAccessIdentity2020_05_31Result& WithCloudFrontOriginAccessIdentity(CloudFrontOriginAccessIdentityT&& value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateCloudFrontOriginAccessIdentity2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateCloudFrontOriginAccessIdentity2020_05_31Result& WithRequestId(RequestIdT&& value) {
