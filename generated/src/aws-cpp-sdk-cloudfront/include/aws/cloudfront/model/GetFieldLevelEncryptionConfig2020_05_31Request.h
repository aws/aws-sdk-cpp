...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API GetFieldLevelEncryptionConfig2020_05_31Request() = default;
    ...
    template<typename IdT = Aws::String>
    GetFieldLevelEncryptionConfig2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
