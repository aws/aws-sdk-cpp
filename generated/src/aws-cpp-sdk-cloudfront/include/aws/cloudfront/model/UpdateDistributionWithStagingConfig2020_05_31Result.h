...
class UpdateDistributionWithStagingConfig2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API UpdateDistributionWithStagingConfig2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename DistributionT = Distribution>
  UpdateDistributionWithStagingConfig2020_05_31Result& WithDistribution(DistributionT&& value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateDistributionWithStagingConfig2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDistributionWithStagingConfig2020_05_31Result& WithRequestId(RequestIdT&& value) {
