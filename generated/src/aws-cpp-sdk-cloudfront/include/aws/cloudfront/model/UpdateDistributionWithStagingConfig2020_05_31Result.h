...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API UpdateDistributionWithStagingConfig2020_05_31Result() = default;
    ...
    template<typename DistributionT = Distribution>
    UpdateDistributionWithStagingConfig2020_05_31Result& WithDistribution(DistributionT&& value) { SetDistribution(std::forward<DistributionT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    UpdateDistributionWithStagingConfig2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDistributionWithStagingConfig2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
