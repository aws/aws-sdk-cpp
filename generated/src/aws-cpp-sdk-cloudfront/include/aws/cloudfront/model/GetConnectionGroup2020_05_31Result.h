...
namespace Model
{
  class GetConnectionGroup2020_05_31Result
  {
  public:
    ...
    template<typename ConnectionGroupT = ConnectionGroup>
    GetConnectionGroup2020_05_31Result& WithConnectionGroup(ConnectionGroupT&& value) { SetConnectionGroup(std::forward<ConnectionGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    GetConnectionGroup2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetConnectionGroup2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
