...
class CreateRealtimeLogConfig2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename EndPointsT = Aws::Vector<EndPoint>>
  CreateRealtimeLogConfig2020_05_31Request& WithEndPoints(EndPointsT&& value) {
    SetEndPoints(std::forward<EndPointsT>(value));
    return *this;
  }
  template <typename EndPointsT = EndPoint>
  CreateRealtimeLogConfig2020_05_31Request& AddEndPoints(EndPointsT&& value) {
    m_endPointsHasBeenSet = true;
  ...
  template <typename FieldsT = Aws::Vector<Aws::String>>
  CreateRealtimeLogConfig2020_05_31Request& WithFields(FieldsT&& value) {
    SetFields(std::forward<FieldsT>(value));
    return *this;
  }
  template <typename FieldsT = Aws::String>
  CreateRealtimeLogConfig2020_05_31Request& AddFields(FieldsT&& value) {
    m_fieldsHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  CreateRealtimeLogConfig2020_05_31Request& WithName(NameT&& value) {
  ...
  inline CreateRealtimeLogConfig2020_05_31Request& WithSamplingRate(long long value) {
