...
class FunctionConfig {
 public:
  ...
  inline void SetRuntime(FunctionRuntime value) {
    m_runtimeHasBeenSet = true;
    m_runtime = value;
  }
  inline FunctionConfig& WithRuntime(FunctionRuntime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  void SetKeyValueStoreAssociations(KeyValueStoreAssociationsT&& value) {
    ...
    m_keyValueStoreAssociations = std::forward<KeyValueStoreAssociationsT>(value);
  }
  template <typename KeyValueStoreAssociationsT = KeyValueStoreAssociations>
  FunctionConfig& WithKeyValueStoreAssociations(KeyValueStoreAssociationsT&& value) {
    SetKeyValueStoreAssociations(std::forward<KeyValueStoreAssociationsT>(value));
    return *this;
  }
  ///@}
 private:
