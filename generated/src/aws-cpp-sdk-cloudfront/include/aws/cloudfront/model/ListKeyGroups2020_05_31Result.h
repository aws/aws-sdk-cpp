...
class ListKeyGroups2020_05_31Result {
 public:
  ...
  void SetKeyGroupList(KeyGroupListT&& value) {
    m_keyGroupListHasBeenSet = true;
    m_keyGroupList = std::forward<KeyGroupListT>(value);
  }
  template <typename KeyGroupListT = KeyGroupList>
  ListKeyGroups2020_05_31Result& WithKeyGroupList(KeyGroupListT&& value) {
    SetKeyGroupList(std::forward<KeyGroupListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListKeyGroups2020_05_31Result& WithRequestId(RequestIdT&& value) {
