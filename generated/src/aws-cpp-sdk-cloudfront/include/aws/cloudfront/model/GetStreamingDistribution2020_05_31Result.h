...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API GetStreamingDistribution2020_05_31Result() = default;
    ...
    template<typename StreamingDistributionT = StreamingDistribution>
    GetStreamingDistribution2020_05_31Result& WithStreamingDistribution(StreamingDistributionT&& value) { SetStreamingDistribution(std::forward<StreamingDistributionT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    GetStreamingDistribution2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetStreamingDistribution2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
