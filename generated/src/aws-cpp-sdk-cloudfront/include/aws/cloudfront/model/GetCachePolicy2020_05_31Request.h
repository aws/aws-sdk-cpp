...
namespace Model
{
  ...
  /**
   */
  class GetCachePolicy2020_05_31Request : public CloudFrontRequest
  {
  public:
    AWS_CLOUDFRONT_API GetCachePolicy2020_05_31Request() = default;
    ...
    template<typename IdT = Aws::String>
    GetCachePolicy2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
