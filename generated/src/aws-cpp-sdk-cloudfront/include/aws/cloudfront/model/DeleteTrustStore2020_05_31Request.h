...
/**
 */
class DeleteTrustStore2020_05_31Request : public CloudFrontRequest {
 public:
  AWS_CLOUDFRONT_API DeleteTrustStore2020_05_31Request() = default;
  ...
  template <typename IdT = Aws::String>
  DeleteTrustStore2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  DeleteTrustStore2020_05_31Request& WithIfMatch(IfMatchT&& value) {
