...
class ListResponseHeadersPolicies2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  inline void SetType(ResponseHeadersPolicyType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ListResponseHeadersPolicies2020_05_31Request& WithType(ResponseHeadersPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListResponseHeadersPolicies2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListResponseHeadersPolicies2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
