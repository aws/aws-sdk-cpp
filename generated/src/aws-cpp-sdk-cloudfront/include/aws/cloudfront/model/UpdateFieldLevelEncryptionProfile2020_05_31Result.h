...
class UpdateFieldLevelEncryptionProfile2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API UpdateFieldLevelEncryptionProfile2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename FieldLevelEncryptionProfileT = FieldLevelEncryptionProfile>
  UpdateFieldLevelEncryptionProfile2020_05_31Result& WithFieldLevelEncryptionProfile(FieldLevelEncryptionProfileT&& value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateFieldLevelEncryptionProfile2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFieldLevelEncryptionProfile2020_05_31Result& WithRequestId(RequestIdT&& value) {
