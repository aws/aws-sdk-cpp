...
class CreatePublicKey2020_05_31Result {
 public:
  ...
  template <typename PublicKeyT = PublicKey>
  CreatePublicKey2020_05_31Result& WithPublicKey(PublicKeyT&& value) {
  ...
  template <typename LocationT = Aws::String>
  CreatePublicKey2020_05_31Result& WithLocation(LocationT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CreatePublicKey2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePublicKey2020_05_31Result& WithRequestId(RequestIdT&& value) {
