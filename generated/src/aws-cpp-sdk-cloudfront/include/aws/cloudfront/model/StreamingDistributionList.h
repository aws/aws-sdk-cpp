...
class StreamingDistributionList {
 public:
  ...
  inline StreamingDistributionList& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  inline StreamingDistributionList& WithIsTruncated(bool value) {
  ...
  inline StreamingDistributionList& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
