...
class StreamingDistributionSummary {
 public:
  ...
  void SetS3Origin(S3OriginT&& value) {
    ...
    m_s3Origin = std::forward<S3OriginT>(value);
  }
  template <typename S3OriginT = S3Origin>
  StreamingDistributionSummary& WithS3Origin(S3OriginT&& value) {
    SetS3Origin(std::forward<S3OriginT>(value));
    return *this;
  }
  ///@}
  ...
  inline StreamingDistributionSummary& WithPriceClass(PriceClass value) {
    SetPriceClass(value);
    return *this;
  }
  ///@}
  ...
  inline StreamingDistributionSummary& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
