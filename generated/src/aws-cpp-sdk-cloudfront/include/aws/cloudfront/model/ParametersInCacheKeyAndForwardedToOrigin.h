...
class ParametersInCacheKeyAndForwardedToOrigin {
 public:
  ...
  inline void SetEnableAcceptEncodingGzip(bool value) {
    m_enableAcceptEncodingGzipHasBeenSet = true;
    m_enableAcceptEncodingGzip = value;
  }
  inline ParametersInCacheKeyAndForwardedToOrigin& WithEnableAcceptEncodingGzip(bool value) {
    SetEnableAcceptEncodingGzip(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnableAcceptEncodingBrotli(bool value) {
    m_enableAcceptEncodingBrotliHasBeenSet = true;
    m_enableAcceptEncodingBrotli = value;
  }
  inline ParametersInCacheKeyAndForwardedToOrigin& WithEnableAcceptEncodingBrotli(bool value) {
    SetEnableAcceptEncodingBrotli(value);
    return *this;
  }
  ///@}
  ...
  void SetHeadersConfig(HeadersConfigT&& value) {
    ...
    m_headersConfig = std::forward<HeadersConfigT>(value);
  }
  template <typename HeadersConfigT = CachePolicyHeadersConfig>
  ParametersInCacheKeyAndForwardedToOrigin& WithHeadersConfig(HeadersConfigT&& value) {
    SetHeadersConfig(std::forward<HeadersConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCookiesConfig(CookiesConfigT&& value) {
    ...
    m_cookiesConfig = std::forward<CookiesConfigT>(value);
  }
  template <typename CookiesConfigT = CachePolicyCookiesConfig>
  ParametersInCacheKeyAndForwardedToOrigin& WithCookiesConfig(CookiesConfigT&& value) {
    SetCookiesConfig(std::forward<CookiesConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueryStringsConfig(QueryStringsConfigT&& value) {
    ...
    m_queryStringsConfig = std::forward<QueryStringsConfigT>(value);
  }
  template <typename QueryStringsConfigT = CachePolicyQueryStringsConfig>
  ParametersInCacheKeyAndForwardedToOrigin& WithQueryStringsConfig(QueryStringsConfigT&& value) {
    SetQueryStringsConfig(std::forward<QueryStringsConfigT>(value));
    return *this;
  }
  ///@}
 private:
