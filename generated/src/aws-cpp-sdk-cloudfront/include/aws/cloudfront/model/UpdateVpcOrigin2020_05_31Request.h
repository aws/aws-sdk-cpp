...
class UpdateVpcOrigin2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename VpcOriginEndpointConfigT = VpcOriginEndpointConfig>
  UpdateVpcOrigin2020_05_31Request& WithVpcOriginEndpointConfig(VpcOriginEndpointConfigT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateVpcOrigin2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  UpdateVpcOrigin2020_05_31Request& WithIfMatch(IfMatchT&& value) {
