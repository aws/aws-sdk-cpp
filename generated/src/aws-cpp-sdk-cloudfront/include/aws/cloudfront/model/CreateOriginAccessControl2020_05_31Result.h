...
class CreateOriginAccessControl2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API CreateOriginAccessControl2020_05_31Result& operator=(
  ...
  template <typename OriginAccessControlT = OriginAccessControl>
  CreateOriginAccessControl2020_05_31Result& WithOriginAccessControl(OriginAccessControlT&& value) {
  ...
  template <typename LocationT = Aws::String>
  CreateOriginAccessControl2020_05_31Result& WithLocation(LocationT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CreateOriginAccessControl2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateOriginAccessControl2020_05_31Result& WithRequestId(RequestIdT&& value) {
