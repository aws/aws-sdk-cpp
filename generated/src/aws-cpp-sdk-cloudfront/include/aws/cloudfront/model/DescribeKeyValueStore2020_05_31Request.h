...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API DescribeKeyValueStore2020_05_31Request() = default;
    ...
    template<typename NameT = Aws::String>
    DescribeKeyValueStore2020_05_31Request& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
