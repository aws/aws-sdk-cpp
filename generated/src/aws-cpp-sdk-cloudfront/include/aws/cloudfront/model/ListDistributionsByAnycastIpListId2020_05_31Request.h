...
class ListDistributionsByAnycastIpListId2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListDistributionsByAnycastIpListId2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListDistributionsByAnycastIpListId2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename AnycastIpListIdT = Aws::String>
  ListDistributionsByAnycastIpListId2020_05_31Request& WithAnycastIpListId(AnycastIpListIdT&& value) {
