...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API ListDistributionsByAnycastIpListId2020_05_31Request() = default;
    ...
    template<typename MarkerT = Aws::String>
    ListDistributionsByAnycastIpListId2020_05_31Request& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename MaxItemsT = Aws::String>
    ListDistributionsByAnycastIpListId2020_05_31Request& WithMaxItems(MaxItemsT&& value) { SetMaxItems(std::forward<MaxItemsT>(value)); return *this;}
    ///@}
    ...
    template<typename AnycastIpListIdT = Aws::String>
    ListDistributionsByAnycastIpListId2020_05_31Request& WithAnycastIpListId(AnycastIpListIdT&& value) { SetAnycastIpListId(std::forward<AnycastIpListIdT>(value)); return *this;}
    ///@}
  private:
