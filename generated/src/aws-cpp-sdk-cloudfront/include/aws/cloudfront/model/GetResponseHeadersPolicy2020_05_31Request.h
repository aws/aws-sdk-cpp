...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API GetResponseHeadersPolicy2020_05_31Request() = default;
    ...
    template<typename IdT = Aws::String>
    GetResponseHeadersPolicy2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
