...
class ListDistributionsByResponseHeadersPolicyId2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListDistributionsByResponseHeadersPolicyId2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListDistributionsByResponseHeadersPolicyId2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
  ...
  void SetResponseHeadersPolicyId(ResponseHeadersPolicyIdT&& value) {
    ...
    m_responseHeadersPolicyId = std::forward<ResponseHeadersPolicyIdT>(value);
  }
  template <typename ResponseHeadersPolicyIdT = Aws::String>
  ListDistributionsByResponseHeadersPolicyId2020_05_31Request& WithResponseHeadersPolicyId(ResponseHeadersPolicyIdT&& value) {
    SetResponseHeadersPolicyId(std::forward<ResponseHeadersPolicyIdT>(value));
    return *this;
  }
  ///@}
 private:
