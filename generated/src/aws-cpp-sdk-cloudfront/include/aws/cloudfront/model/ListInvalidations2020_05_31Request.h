...
class ListInvalidations2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename DistributionIdT = Aws::String>
  ListInvalidations2020_05_31Request& WithDistributionId(DistributionIdT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListInvalidations2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListInvalidations2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
