...
class GetDistributionTenantByDomain2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetDistributionTenantByDomain2020_05_31Result& operator=(
  ...
  template <typename DistributionTenantT = DistributionTenant>
  GetDistributionTenantByDomain2020_05_31Result& WithDistributionTenant(DistributionTenantT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetDistributionTenantByDomain2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDistributionTenantByDomain2020_05_31Result& WithRequestId(RequestIdT&& value) {
