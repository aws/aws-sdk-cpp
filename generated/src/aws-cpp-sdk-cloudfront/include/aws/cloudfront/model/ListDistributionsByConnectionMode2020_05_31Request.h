...
class ListDistributionsByConnectionMode2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListDistributionsByConnectionMode2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  inline ListDistributionsByConnectionMode2020_05_31Request& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  inline ListDistributionsByConnectionMode2020_05_31Request& WithConnectionMode(ConnectionMode value) {
