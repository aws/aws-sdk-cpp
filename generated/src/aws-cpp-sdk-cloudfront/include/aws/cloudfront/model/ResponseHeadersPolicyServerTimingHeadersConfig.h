...
class ResponseHeadersPolicyServerTimingHeadersConfig {
 public:
  ...
  inline ResponseHeadersPolicyServerTimingHeadersConfig& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline ResponseHeadersPolicyServerTimingHeadersConfig& WithSamplingRate(double value) {
