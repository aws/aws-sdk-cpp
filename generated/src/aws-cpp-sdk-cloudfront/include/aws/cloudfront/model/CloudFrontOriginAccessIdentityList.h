...
class CloudFrontOriginAccessIdentityList {
 public:
  ...
  template <typename MarkerT = Aws::String>
  CloudFrontOriginAccessIdentityList& WithMarker(MarkerT&& value) {
  ...
  template <typename NextMarkerT = Aws::String>
  CloudFrontOriginAccessIdentityList& WithNextMarker(NextMarkerT&& value) {
  ...
  inline CloudFrontOriginAccessIdentityList& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  inline CloudFrontOriginAccessIdentityList& WithIsTruncated(bool value) {
  ...
  inline CloudFrontOriginAccessIdentityList& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  template <typename ItemsT = Aws::Vector<CloudFrontOriginAccessIdentitySummary>>
  CloudFrontOriginAccessIdentityList& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = CloudFrontOriginAccessIdentitySummary>
  CloudFrontOriginAccessIdentityList& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
