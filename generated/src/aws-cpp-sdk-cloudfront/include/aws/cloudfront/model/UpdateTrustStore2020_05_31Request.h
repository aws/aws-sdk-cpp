...
/**
 */
class UpdateTrustStore2020_05_31Request : public CloudFrontRequest {
 public:
  AWS_CLOUDFRONT_API UpdateTrustStore2020_05_31Request() = default;
  ...
  template <typename IdT = Aws::String>
  UpdateTrustStore2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename CaCertificatesBundleSourceT = CaCertificatesBundleSource>
  UpdateTrustStore2020_05_31Request& WithCaCertificatesBundleSource(CaCertificatesBundleSourceT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  UpdateTrustStore2020_05_31Request& WithIfMatch(IfMatchT&& value) {
