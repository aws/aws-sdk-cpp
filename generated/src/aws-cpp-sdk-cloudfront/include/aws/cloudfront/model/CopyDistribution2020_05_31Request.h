...
class CopyDistribution2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  void SetPrimaryDistributionId(PrimaryDistributionIdT&& value) {
    m_primaryDistributionIdHasBeenSet = true;
    m_primaryDistributionId = std::forward<PrimaryDistributionIdT>(value);
  }
  template <typename PrimaryDistributionIdT = Aws::String>
  CopyDistribution2020_05_31Request& WithPrimaryDistributionId(PrimaryDistributionIdT&& value) {
    SetPrimaryDistributionId(std::forward<PrimaryDistributionIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline CopyDistribution2020_05_31Request& WithStaging(bool value) {
    SetStaging(value);
    return *this;
  }
  ///@}
  ...
  inline CopyDistribution2020_05_31Request& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
