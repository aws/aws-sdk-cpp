...
class ListDistributionsByVpcOriginId2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListDistributionsByVpcOriginId2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListDistributionsByVpcOriginId2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename VpcOriginIdT = Aws::String>
  ListDistributionsByVpcOriginId2020_05_31Request& WithVpcOriginId(VpcOriginIdT&& value) {
