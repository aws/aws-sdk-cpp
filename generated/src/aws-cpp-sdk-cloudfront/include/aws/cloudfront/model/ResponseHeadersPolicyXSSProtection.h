...
class ResponseHeadersPolicyXSSProtection {
 public:
  ...
  inline ResponseHeadersPolicyXSSProtection& WithOverride(bool value) {
    SetOverride(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProtection(bool value) {
    m_protectionHasBeenSet = true;
    m_protection = value;
  }
  inline ResponseHeadersPolicyXSSProtection& WithProtection(bool value) {
    SetProtection(value);
    return *this;
  }
  ///@}
  ...
  inline void SetModeBlock(bool value) {
    m_modeBlockHasBeenSet = true;
    m_modeBlock = value;
  }
  inline ResponseHeadersPolicyXSSProtection& WithModeBlock(bool value) {
    SetModeBlock(value);
    return *this;
  }
  ///@}
  ...
  void SetReportUri(ReportUriT&& value) {
    m_reportUriHasBeenSet = true;
    m_reportUri = std::forward<ReportUriT>(value);
  }
  template <typename ReportUriT = Aws::String>
  ResponseHeadersPolicyXSSProtection& WithReportUri(ReportUriT&& value) {
    SetReportUri(std::forward<ReportUriT>(value));
    return *this;
  }
  ///@}
 private:
