...
class GetOriginRequestPolicy2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetOriginRequestPolicy2020_05_31Result& operator=(
  ...
  template <typename OriginRequestPolicyT = OriginRequestPolicy>
  GetOriginRequestPolicy2020_05_31Result& WithOriginRequestPolicy(OriginRequestPolicyT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetOriginRequestPolicy2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOriginRequestPolicy2020_05_31Result& WithRequestId(RequestIdT&& value) {
