...
class TestResult {
 public:
  ...
  void SetFunctionExecutionLogs(FunctionExecutionLogsT&& value) {
    ...
    m_functionExecutionLogs = std::forward<FunctionExecutionLogsT>(value);
  }
  template <typename FunctionExecutionLogsT = Aws::Vector<Aws::String>>
  TestResult& WithFunctionExecutionLogs(FunctionExecutionLogsT&& value) {
    SetFunctionExecutionLogs(std::forward<FunctionExecutionLogsT>(value));
    return *this;
  }
  template <typename FunctionExecutionLogsT = Aws::String>
  TestResult& AddFunctionExecutionLogs(FunctionExecutionLogsT&& value) {
    m_functionExecutionLogsHasBeenSet = true;
    m_functionExecutionLogs.emplace_back(std::forward<FunctionExecutionLogsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFunctionErrorMessage(FunctionErrorMessageT&& value) {
    ...
    m_functionErrorMessage = std::forward<FunctionErrorMessageT>(value);
  }
  template <typename FunctionErrorMessageT = Aws::String>
  TestResult& WithFunctionErrorMessage(FunctionErrorMessageT&& value) {
    SetFunctionErrorMessage(std::forward<FunctionErrorMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFunctionOutput(FunctionOutputT&& value) {
    ...
    m_functionOutput = std::forward<FunctionOutputT>(value);
  }
  template <typename FunctionOutputT = Aws::String>
  TestResult& WithFunctionOutput(FunctionOutputT&& value) {
    SetFunctionOutput(std::forward<FunctionOutputT>(value));
    return *this;
  }
  ///@}
 private:
