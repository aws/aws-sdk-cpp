...
class UpdateOriginAccessControl2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename OriginAccessControlConfigT = OriginAccessControlConfig>
  UpdateOriginAccessControl2020_05_31Request& WithOriginAccessControlConfig(OriginAccessControlConfigT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateOriginAccessControl2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  UpdateOriginAccessControl2020_05_31Request& WithIfMatch(IfMatchT&& value) {
