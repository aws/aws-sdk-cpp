...
class DistributionResourceId {
 public:
  ...
  template <typename DistributionIdT = Aws::String>
  DistributionResourceId& WithDistributionId(DistributionIdT&& value) {
  ...
  void SetDistributionTenantId(DistributionTenantIdT&& value) {
    m_distributionTenantIdHasBeenSet = true;
    m_distributionTenantId = std::forward<DistributionTenantIdT>(value);
  }
  template <typename DistributionTenantIdT = Aws::String>
  DistributionResourceId& WithDistributionTenantId(DistributionTenantIdT&& value) {
    SetDistributionTenantId(std::forward<DistributionTenantIdT>(value));
    return *this;
  }
  ///@}
 private:
