...
class GetRealtimeLogConfig2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetRealtimeLogConfig2020_05_31Result& operator=(
  ...
  template <typename RealtimeLogConfigT = RealtimeLogConfig>
  GetRealtimeLogConfig2020_05_31Result& WithRealtimeLogConfig(RealtimeLogConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRealtimeLogConfig2020_05_31Result& WithRequestId(RequestIdT&& value) {
