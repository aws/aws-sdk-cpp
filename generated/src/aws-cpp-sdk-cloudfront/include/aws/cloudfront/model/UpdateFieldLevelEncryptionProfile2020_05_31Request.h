...
class UpdateFieldLevelEncryptionProfile2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename FieldLevelEncryptionProfileConfigT = FieldLevelEncryptionProfileConfig>
  UpdateFieldLevelEncryptionProfile2020_05_31Request& WithFieldLevelEncryptionProfileConfig(FieldLevelEncryptionProfileConfigT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateFieldLevelEncryptionProfile2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  UpdateFieldLevelEncryptionProfile2020_05_31Request& WithIfMatch(IfMatchT&& value) {
