...
class ResponseHeadersPolicyCustomHeadersConfig {
 public:
  ...
  inline ResponseHeadersPolicyCustomHeadersConfig& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  template <typename ItemsT = Aws::Vector<ResponseHeadersPolicyCustomHeader>>
  ResponseHeadersPolicyCustomHeadersConfig& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ResponseHeadersPolicyCustomHeader>
  ResponseHeadersPolicyCustomHeadersConfig& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
