...
class OriginRequestPolicyCookiesConfig {
 public:
  ...
  inline void SetCookieBehavior(OriginRequestPolicyCookieBehavior value) {
    m_cookieBehaviorHasBeenSet = true;
    m_cookieBehavior = value;
  }
  inline OriginRequestPolicyCookiesConfig& WithCookieBehavior(OriginRequestPolicyCookieBehavior value) {
    SetCookieBehavior(value);
    return *this;
  }
  ///@}
  ...
  void SetCookies(CookiesT&& value) {
    ...
    m_cookies = std::forward<CookiesT>(value);
  }
  template <typename CookiesT = CookieNames>
  OriginRequestPolicyCookiesConfig& WithCookies(CookiesT&& value) {
    SetCookies(std::forward<CookiesT>(value));
    return *this;
  }
  ///@}
 private:
