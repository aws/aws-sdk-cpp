...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetDistributionConfig2020_05_31Request : public CloudFrontRequest
  {
  public:
    AWS_CLOUDFRONT_API GetDistributionConfig2020_05_31Request() = default;
    ...
    template<typename IdT = Aws::String>
    GetDistributionConfig2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
