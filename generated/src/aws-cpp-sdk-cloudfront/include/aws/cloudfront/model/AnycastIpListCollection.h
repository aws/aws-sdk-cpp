...
class AnycastIpListCollection {
 public:
  ...
  inline AnycastIpListCollection& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  inline AnycastIpListCollection& WithIsTruncated(bool value) {
  ...
  inline AnycastIpListCollection& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
