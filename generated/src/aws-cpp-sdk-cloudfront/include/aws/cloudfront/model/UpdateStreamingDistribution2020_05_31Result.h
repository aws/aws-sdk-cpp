...
class UpdateStreamingDistribution2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API UpdateStreamingDistribution2020_05_31Result& operator=(
  ...
  template <typename StreamingDistributionT = StreamingDistribution>
  UpdateStreamingDistribution2020_05_31Result& WithStreamingDistribution(StreamingDistributionT&& value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateStreamingDistribution2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateStreamingDistribution2020_05_31Result& WithRequestId(RequestIdT&& value) {
