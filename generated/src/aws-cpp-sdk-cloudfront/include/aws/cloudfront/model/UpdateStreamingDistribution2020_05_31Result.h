...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API UpdateStreamingDistribution2020_05_31Result() = default;
    ...
    void SetStreamingDistribution(StreamingDistributionT&& value) { m_streamingDistributionHasBeenSet = true; m_streamingDistribution = std::forward<StreamingDistributionT>(value); }
    template<typename StreamingDistributionT = StreamingDistribution>
    UpdateStreamingDistribution2020_05_31Result& WithStreamingDistribution(StreamingDistributionT&& value) { SetStreamingDistribution(std::forward<StreamingDistributionT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    UpdateStreamingDistribution2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateStreamingDistribution2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
