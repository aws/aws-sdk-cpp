...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API ListDistributionsByOriginRequestPolicyId2020_05_31Result() = default;
    ...
    template<typename DistributionIdListT = DistributionIdList>
    ListDistributionsByOriginRequestPolicyId2020_05_31Result& WithDistributionIdList(DistributionIdListT&& value) { SetDistributionIdList(std::forward<DistributionIdListT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListDistributionsByOriginRequestPolicyId2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
