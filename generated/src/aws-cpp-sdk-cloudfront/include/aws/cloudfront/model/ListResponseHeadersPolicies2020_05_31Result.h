...
class ListResponseHeadersPolicies2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API ListResponseHeadersPolicies2020_05_31Result& operator=(
  ...
  void SetResponseHeadersPolicyList(ResponseHeadersPolicyListT&& value) {
    m_responseHeadersPolicyListHasBeenSet = true;
    m_responseHeadersPolicyList = std::forward<ResponseHeadersPolicyListT>(value);
  }
  template <typename ResponseHeadersPolicyListT = ResponseHeadersPolicyList>
  ListResponseHeadersPolicies2020_05_31Result& WithResponseHeadersPolicyList(ResponseHeadersPolicyListT&& value) {
    SetResponseHeadersPolicyList(std::forward<ResponseHeadersPolicyListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListResponseHeadersPolicies2020_05_31Result& WithRequestId(RequestIdT&& value) {
