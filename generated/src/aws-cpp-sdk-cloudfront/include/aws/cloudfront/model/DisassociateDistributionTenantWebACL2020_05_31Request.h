...
class DisassociateDistributionTenantWebACL2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  DisassociateDistributionTenantWebACL2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  DisassociateDistributionTenantWebACL2020_05_31Request& WithIfMatch(IfMatchT&& value) {
