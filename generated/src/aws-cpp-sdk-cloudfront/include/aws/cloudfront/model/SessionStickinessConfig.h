...
class SessionStickinessConfig {
 public:
  ...
  inline void SetIdleTTL(int value) {
    m_idleTTLHasBeenSet = true;
    m_idleTTL = value;
  }
  inline SessionStickinessConfig& WithIdleTTL(int value) {
    SetIdleTTL(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumTTL(int value) {
    m_maximumTTLHasBeenSet = true;
    m_maximumTTL = value;
  }
  inline SessionStickinessConfig& WithMaximumTTL(int value) {
    SetMaximumTTL(value);
    return *this;
  }
  ///@}
