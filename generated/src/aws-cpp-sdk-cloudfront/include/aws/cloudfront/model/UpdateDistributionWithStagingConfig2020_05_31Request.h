...
class UpdateDistributionWithStagingConfig2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateDistributionWithStagingConfig2020_05_31Request& WithId(IdT&& value) {
  ...
  void SetStagingDistributionId(StagingDistributionIdT&& value) {
    m_stagingDistributionIdHasBeenSet = true;
    m_stagingDistributionId = std::forward<StagingDistributionIdT>(value);
  }
  template <typename StagingDistributionIdT = Aws::String>
  UpdateDistributionWithStagingConfig2020_05_31Request& WithStagingDistributionId(StagingDistributionIdT&& value) {
    SetStagingDistributionId(std::forward<StagingDistributionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IfMatchT = Aws::String>
  UpdateDistributionWithStagingConfig2020_05_31Request& WithIfMatch(IfMatchT&& value) {
