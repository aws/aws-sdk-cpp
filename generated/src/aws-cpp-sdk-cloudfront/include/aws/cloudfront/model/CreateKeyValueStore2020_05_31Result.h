...
class CreateKeyValueStore2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API CreateKeyValueStore2020_05_31Result& operator=(
  ...
  template <typename KeyValueStoreT = KeyValueStore>
  CreateKeyValueStore2020_05_31Result& WithKeyValueStore(KeyValueStoreT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CreateKeyValueStore2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename LocationT = Aws::String>
  CreateKeyValueStore2020_05_31Result& WithLocation(LocationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateKeyValueStore2020_05_31Result& WithRequestId(RequestIdT&& value) {
