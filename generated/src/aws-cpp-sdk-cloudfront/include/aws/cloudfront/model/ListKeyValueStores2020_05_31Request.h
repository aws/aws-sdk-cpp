...
class ListKeyValueStores2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListKeyValueStores2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListKeyValueStores2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename StatusT = Aws::String>
  ListKeyValueStores2020_05_31Request& WithStatus(StatusT&& value) {
