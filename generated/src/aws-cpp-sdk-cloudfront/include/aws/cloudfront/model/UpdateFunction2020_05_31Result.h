...
class UpdateFunction2020_05_31Result {
 public:
  ...
  template <typename FunctionSummaryT = FunctionSummary>
  UpdateFunction2020_05_31Result& WithFunctionSummary(FunctionSummaryT&& value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateFunction2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFunction2020_05_31Result& WithRequestId(RequestIdT&& value) {
