...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API DeleteMonitoringSubscription2020_05_31Request() = default;
    ...
    template<typename DistributionIdT = Aws::String>
    DeleteMonitoringSubscription2020_05_31Request& WithDistributionId(DistributionIdT&& value) { SetDistributionId(std::forward<DistributionIdT>(value)); return *this;}
    ///@}
  private:
