...
class ListDistributionTenants2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename AssociationFilterT = DistributionTenantAssociationFilter>
  ListDistributionTenants2020_05_31Request& WithAssociationFilter(AssociationFilterT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListDistributionTenants2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  inline ListDistributionTenants2020_05_31Request& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
