...
class ListDistributionTenantsByCustomization2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API ListDistributionTenantsByCustomization2020_05_31Result(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_CLOUDFRONT_API ListDistributionTenantsByCustomization2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename NextMarkerT = Aws::String>
  ListDistributionTenantsByCustomization2020_05_31Result& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename DistributionTenantListT = Aws::Vector<DistributionTenantSummary>>
  ListDistributionTenantsByCustomization2020_05_31Result& WithDistributionTenantList(DistributionTenantListT&& value) {
  ...
  ListDistributionTenantsByCustomization2020_05_31Result& AddDistributionTenantList(DistributionTenantListT&& value) {
    m_distributionTenantListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListDistributionTenantsByCustomization2020_05_31Result& WithRequestId(RequestIdT&& value) {
