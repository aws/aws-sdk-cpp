...
class ListDistributionsByResponseHeadersPolicyId2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API ListDistributionsByResponseHeadersPolicyId2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename DistributionIdListT = DistributionIdList>
  ListDistributionsByResponseHeadersPolicyId2020_05_31Result& WithDistributionIdList(DistributionIdListT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDistributionsByResponseHeadersPolicyId2020_05_31Result& WithRequestId(RequestIdT&& value) {
