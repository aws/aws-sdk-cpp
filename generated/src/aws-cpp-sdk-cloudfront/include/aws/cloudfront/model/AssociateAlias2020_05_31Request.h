...
class AssociateAlias2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  void SetTargetDistributionId(TargetDistributionIdT&& value) {
    m_targetDistributionIdHasBeenSet = true;
    m_targetDistributionId = std::forward<TargetDistributionIdT>(value);
  }
  template <typename TargetDistributionIdT = Aws::String>
  AssociateAlias2020_05_31Request& WithTargetDistributionId(TargetDistributionIdT&& value) {
    SetTargetDistributionId(std::forward<TargetDistributionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AliasT = Aws::String>
  AssociateAlias2020_05_31Request& WithAlias(AliasT&& value) {
