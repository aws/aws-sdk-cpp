...
class ResponseHeadersPolicyAccessControlAllowOrigins {
 public:
  ...
  inline ResponseHeadersPolicyAccessControlAllowOrigins& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  template <typename ItemsT = Aws::Vector<Aws::String>>
  ResponseHeadersPolicyAccessControlAllowOrigins& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = Aws::String>
  ResponseHeadersPolicyAccessControlAllowOrigins& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
