...
class CreateResponseHeadersPolicy2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API CreateResponseHeadersPolicy2020_05_31Result& operator=(
  ...
  template <typename ResponseHeadersPolicyT = ResponseHeadersPolicy>
  CreateResponseHeadersPolicy2020_05_31Result& WithResponseHeadersPolicy(ResponseHeadersPolicyT&& value) {
  ...
  template <typename LocationT = Aws::String>
  CreateResponseHeadersPolicy2020_05_31Result& WithLocation(LocationT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CreateResponseHeadersPolicy2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateResponseHeadersPolicy2020_05_31Result& WithRequestId(RequestIdT&& value) {
