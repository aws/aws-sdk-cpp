...
class FieldLevelEncryptionProfileList {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  FieldLevelEncryptionProfileList& WithNextMarker(NextMarkerT&& value) {
  ...
  inline FieldLevelEncryptionProfileList& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  inline FieldLevelEncryptionProfileList& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  template <typename ItemsT = Aws::Vector<FieldLevelEncryptionProfileSummary>>
  FieldLevelEncryptionProfileList& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = FieldLevelEncryptionProfileSummary>
  FieldLevelEncryptionProfileList& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
