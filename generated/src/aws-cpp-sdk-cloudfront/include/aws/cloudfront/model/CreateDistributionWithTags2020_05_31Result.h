...
namespace Model
{
  ...
  public:
     ...
     * <p>The fully qualified URI of the new distribution resource just created.</p>
     */
    inline CreateDistributionWithTags2020_05_31Result& WithLocation(const Aws::String& value) { SetLocation(value); return *this;}

    /**
     * <p>The fully qualified URI of the new distribution resource just created.</p>
     */
    inline CreateDistributionWithTags2020_05_31Result& WithLocation(Aws::String&& value) { SetLocation(std::move(value)); return *this;}

    /**
     * <p>The fully qualified URI of the new distribution resource just created.</p>
     */
    inline CreateDistributionWithTags2020_05_31Result& WithLocation(const char* value) { SetLocation(value); return *this;}
     ...
     * <p>The current version of the distribution created.</p>
     */
    inline CreateDistributionWithTags2020_05_31Result& WithETag(const Aws::String& value) { SetETag(value); return *this;}

    /**
     * <p>The current version of the distribution created.</p>
     */
    inline CreateDistributionWithTags2020_05_31Result& WithETag(Aws::String&& value) { SetETag(std::move(value)); return *this;}

    /**
     * <p>The current version of the distribution created.</p>
     */
    inline CreateDistributionWithTags2020_05_31Result& WithETag(const char* value) { SetETag(value); return *this;}
    ...
    inline CreateDistributionWithTags2020_05_31Result& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateDistributionWithTags2020_05_31Result& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateDistributionWithTags2020_05_31Result& WithRequestId(const char* value) { SetRequestId(value); return *this;}
