...
class CreateDistributionWithTags2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API CreateDistributionWithTags2020_05_31Result& operator=(
  ...
  void SetDistribution(DistributionT&& value) {
    ...
    m_distribution = std::forward<DistributionT>(value);
  }
  template <typename DistributionT = Distribution>
  CreateDistributionWithTags2020_05_31Result& WithDistribution(DistributionT&& value) {
    SetDistribution(std::forward<DistributionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocationT = Aws::String>
  CreateDistributionWithTags2020_05_31Result& WithLocation(LocationT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CreateDistributionWithTags2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDistributionWithTags2020_05_31Result& WithRequestId(RequestIdT&& value) {
