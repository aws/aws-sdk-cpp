...
class ListFieldLevelEncryptionProfiles2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API ListFieldLevelEncryptionProfiles2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  void SetFieldLevelEncryptionProfileList(FieldLevelEncryptionProfileListT&& value) {
    m_fieldLevelEncryptionProfileListHasBeenSet = true;
    m_fieldLevelEncryptionProfileList = std::forward<FieldLevelEncryptionProfileListT>(value);
  }
  template <typename FieldLevelEncryptionProfileListT = FieldLevelEncryptionProfileList>
  ListFieldLevelEncryptionProfiles2020_05_31Result& WithFieldLevelEncryptionProfileList(FieldLevelEncryptionProfileListT&& value) {
    SetFieldLevelEncryptionProfileList(std::forward<FieldLevelEncryptionProfileListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListFieldLevelEncryptionProfiles2020_05_31Result& WithRequestId(RequestIdT&& value) {
