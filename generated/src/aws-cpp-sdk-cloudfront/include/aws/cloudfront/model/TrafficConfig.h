...
class TrafficConfig {
 public:
  ...
  void SetSingleWeightConfig(SingleWeightConfigT&& value) {
    ...
    m_singleWeightConfig = std::forward<SingleWeightConfigT>(value);
  }
  template <typename SingleWeightConfigT = ContinuousDeploymentSingleWeightConfig>
  TrafficConfig& WithSingleWeightConfig(SingleWeightConfigT&& value) {
    SetSingleWeightConfig(std::forward<SingleWeightConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSingleHeaderConfig(SingleHeaderConfigT&& value) {
    ...
    m_singleHeaderConfig = std::forward<SingleHeaderConfigT>(value);
  }
  template <typename SingleHeaderConfigT = ContinuousDeploymentSingleHeaderConfig>
  TrafficConfig& WithSingleHeaderConfig(SingleHeaderConfigT&& value) {
    SetSingleHeaderConfig(std::forward<SingleHeaderConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(ContinuousDeploymentPolicyType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TrafficConfig& WithType(ContinuousDeploymentPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
