...
class CreateContinuousDeploymentPolicy2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API CreateContinuousDeploymentPolicy2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename ContinuousDeploymentPolicyT = ContinuousDeploymentPolicy>
  CreateContinuousDeploymentPolicy2020_05_31Result& WithContinuousDeploymentPolicy(ContinuousDeploymentPolicyT&& value) {
  ...
  template <typename LocationT = Aws::String>
  CreateContinuousDeploymentPolicy2020_05_31Result& WithLocation(LocationT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CreateContinuousDeploymentPolicy2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateContinuousDeploymentPolicy2020_05_31Result& WithRequestId(RequestIdT&& value) {
