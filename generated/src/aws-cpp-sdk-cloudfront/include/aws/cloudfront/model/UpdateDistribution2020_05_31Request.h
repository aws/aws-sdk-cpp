...
namespace Model
{
  ...
  public:
    ...
    template<typename DistributionConfigT = DistributionConfig>
    UpdateDistribution2020_05_31Request& WithDistributionConfig(DistributionConfigT&& value) { SetDistributionConfig(std::forward<DistributionConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    UpdateDistribution2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename IfMatchT = Aws::String>
    UpdateDistribution2020_05_31Request& WithIfMatch(IfMatchT&& value) { SetIfMatch(std::forward<IfMatchT>(value)); return *this;}
    ///@}
  private:
