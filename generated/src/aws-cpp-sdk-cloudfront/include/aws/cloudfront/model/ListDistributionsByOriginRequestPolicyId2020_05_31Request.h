...
class ListDistributionsByOriginRequestPolicyId2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListDistributionsByOriginRequestPolicyId2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListDistributionsByOriginRequestPolicyId2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename OriginRequestPolicyIdT = Aws::String>
  ListDistributionsByOriginRequestPolicyId2020_05_31Request& WithOriginRequestPolicyId(OriginRequestPolicyIdT&& value) {
