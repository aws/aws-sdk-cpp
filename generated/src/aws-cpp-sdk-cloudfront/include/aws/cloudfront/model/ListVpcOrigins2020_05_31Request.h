...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API ListVpcOrigins2020_05_31Request() = default;
    ...
    template<typename MarkerT = Aws::String>
    ListVpcOrigins2020_05_31Request& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename MaxItemsT = Aws::String>
    ListVpcOrigins2020_05_31Request& WithMaxItems(MaxItemsT&& value) { SetMaxItems(std::forward<MaxItemsT>(value)); return *this;}
    ///@}
  private:
