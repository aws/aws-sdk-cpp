...
class ListConflictingAliases2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API ListConflictingAliases2020_05_31Result& operator=(
  ...
  void SetConflictingAliasesList(ConflictingAliasesListT&& value) {
    m_conflictingAliasesListHasBeenSet = true;
    m_conflictingAliasesList = std::forward<ConflictingAliasesListT>(value);
  }
  template <typename ConflictingAliasesListT = ConflictingAliasesList>
  ListConflictingAliases2020_05_31Result& WithConflictingAliasesList(ConflictingAliasesListT&& value) {
    SetConflictingAliasesList(std::forward<ConflictingAliasesListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListConflictingAliases2020_05_31Result& WithRequestId(RequestIdT&& value) {
