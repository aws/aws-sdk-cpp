...
class CreateKeyGroup2020_05_31Result {
 public:
  ...
  template <typename KeyGroupT = KeyGroup>
  CreateKeyGroup2020_05_31Result& WithKeyGroup(KeyGroupT&& value) {
  ...
  template <typename LocationT = Aws::String>
  CreateKeyGroup2020_05_31Result& WithLocation(LocationT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CreateKeyGroup2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateKeyGroup2020_05_31Result& WithRequestId(RequestIdT&& value) {
