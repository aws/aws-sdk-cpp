...
class Origin {
 public:
  ...
  void SetVpcOriginConfig(VpcOriginConfigT&& value) {
    ...
    m_vpcOriginConfig = std::forward<VpcOriginConfigT>(value);
  }
  template <typename VpcOriginConfigT = VpcOriginConfig>
  Origin& WithVpcOriginConfig(VpcOriginConfigT&& value) {
    SetVpcOriginConfig(std::forward<VpcOriginConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetConnectionAttempts(int value) {
    m_connectionAttemptsHasBeenSet = true;
    m_connectionAttempts = value;
  }
  inline Origin& WithConnectionAttempts(int value) {
    SetConnectionAttempts(value);
    return *this;
  }
  ///@}
  ...
  inline Origin& WithConnectionTimeout(int value) {
  ...
  inline void SetResponseCompletionTimeout(int value) {
    m_responseCompletionTimeoutHasBeenSet = true;
    m_responseCompletionTimeout = value;
  }
  inline Origin& WithResponseCompletionTimeout(int value) {
    SetResponseCompletionTimeout(value);
    return *this;
  }
  ///@}
  ...
  void SetOriginShield(OriginShieldT&& value) {
    ...
    m_originShield = std::forward<OriginShieldT>(value);
  }
  template <typename OriginShieldT = OriginShield>
  Origin& WithOriginShield(OriginShieldT&& value) {
    SetOriginShield(std::forward<OriginShieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOriginAccessControlId(OriginAccessControlIdT&& value) {
    ...
    m_originAccessControlId = std::forward<OriginAccessControlIdT>(value);
  }
  template <typename OriginAccessControlIdT = Aws::String>
  Origin& WithOriginAccessControlId(OriginAccessControlIdT&& value) {
    SetOriginAccessControlId(std::forward<OriginAccessControlIdT>(value));
    return *this;
  }
  ///@}
 private:
