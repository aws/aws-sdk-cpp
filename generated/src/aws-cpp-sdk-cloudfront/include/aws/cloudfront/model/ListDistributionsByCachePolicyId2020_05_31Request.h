...
class ListDistributionsByCachePolicyId2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListDistributionsByCachePolicyId2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListDistributionsByCachePolicyId2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename CachePolicyIdT = Aws::String>
  ListDistributionsByCachePolicyId2020_05_31Request& WithCachePolicyId(CachePolicyIdT&& value) {
