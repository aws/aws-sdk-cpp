...
class ListOriginRequestPolicies2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API ListOriginRequestPolicies2020_05_31Result& operator=(
  ...
  void SetOriginRequestPolicyList(OriginRequestPolicyListT&& value) {
    m_originRequestPolicyListHasBeenSet = true;
    m_originRequestPolicyList = std::forward<OriginRequestPolicyListT>(value);
  }
  template <typename OriginRequestPolicyListT = OriginRequestPolicyList>
  ListOriginRequestPolicies2020_05_31Result& WithOriginRequestPolicyList(OriginRequestPolicyListT&& value) {
    SetOriginRequestPolicyList(std::forward<OriginRequestPolicyListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListOriginRequestPolicies2020_05_31Result& WithRequestId(RequestIdT&& value) {
