...
namespace Model
{
  ...
  public:
    ...
    template<typename KeyValueStoreT = KeyValueStore>
    DescribeKeyValueStore2020_05_31Result& WithKeyValueStore(KeyValueStoreT&& value) { SetKeyValueStore(std::forward<KeyValueStoreT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    DescribeKeyValueStore2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeKeyValueStore2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
