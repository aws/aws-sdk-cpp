...
class CreateInvalidationForDistributionTenant2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API CreateInvalidationForDistributionTenant2020_05_31Result(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_CLOUDFRONT_API CreateInvalidationForDistributionTenant2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename LocationT = Aws::String>
  CreateInvalidationForDistributionTenant2020_05_31Result& WithLocation(LocationT&& value) {
  ...
  template <typename InvalidationT = Invalidation>
  CreateInvalidationForDistributionTenant2020_05_31Result& WithInvalidation(InvalidationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateInvalidationForDistributionTenant2020_05_31Result& WithRequestId(RequestIdT&& value) {
