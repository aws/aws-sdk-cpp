...
class GetOriginAccessControl2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetOriginAccessControl2020_05_31Result& operator=(
  ...
  template <typename OriginAccessControlT = OriginAccessControl>
  GetOriginAccessControl2020_05_31Result& WithOriginAccessControl(OriginAccessControlT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetOriginAccessControl2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOriginAccessControl2020_05_31Result& WithRequestId(RequestIdT&& value) {
