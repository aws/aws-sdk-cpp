...
class ResponseHeadersPolicyReferrerPolicy {
 public:
  ...
  inline ResponseHeadersPolicyReferrerPolicy& WithOverride(bool value) {
    SetOverride(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReferrerPolicy(ReferrerPolicyList value) {
    m_referrerPolicyHasBeenSet = true;
    m_referrerPolicy = value;
  }
  inline ResponseHeadersPolicyReferrerPolicy& WithReferrerPolicy(ReferrerPolicyList value) {
