...
class CreateInvalidationForDistributionTenant2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateInvalidationForDistributionTenant2020_05_31Request& WithId(IdT&& value) {
  ...
  void SetInvalidationBatch(InvalidationBatchT&& value) {
    ...
    m_invalidationBatch = std::forward<InvalidationBatchT>(value);
  }
  template <typename InvalidationBatchT = InvalidationBatch>
  CreateInvalidationForDistributionTenant2020_05_31Request& WithInvalidationBatch(InvalidationBatchT&& value) {
    SetInvalidationBatch(std::forward<InvalidationBatchT>(value));
    return *this;
  }
  ///@}
 private:
