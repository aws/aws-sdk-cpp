...
class ListDistributionsByKeyGroup2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListDistributionsByKeyGroup2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListDistributionsByKeyGroup2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename KeyGroupIdT = Aws::String>
  ListDistributionsByKeyGroup2020_05_31Request& WithKeyGroupId(KeyGroupIdT&& value) {
