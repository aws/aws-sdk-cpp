...
struct ListConnectionFunctionsPaginationTraits {
  using RequestType = Model::ListConnectionFunctions2020_05_31Request;
  using ResultType = Model::ListConnectionFunctions2020_05_31Result;
  using OutcomeType = Model::ListConnectionFunctions2020_05_31Outcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListConnectionFunctions2020_05_31(request); }
