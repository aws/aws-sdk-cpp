...
class DefaultCacheBehavior {
 public:
  ...
  inline DefaultCacheBehavior& WithViewerProtocolPolicy(ViewerProtocolPolicy value) {
  ...
  inline DefaultCacheBehavior& WithSmoothStreaming(bool value) {
  ...
  inline DefaultCacheBehavior& WithCompress(bool value) {
    SetCompress(value);
    return *this;
  }
  ///@}
