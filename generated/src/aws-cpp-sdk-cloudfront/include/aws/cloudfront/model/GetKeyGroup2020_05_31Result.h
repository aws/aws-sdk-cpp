...
class GetKeyGroup2020_05_31Result {
 public:
  ...
  template <typename KeyGroupT = KeyGroup>
  GetKeyGroup2020_05_31Result& WithKeyGroup(KeyGroupT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetKeyGroup2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetKeyGroup2020_05_31Result& WithRequestId(RequestIdT&& value) {
