...
class UpdatePublicKey2020_05_31Result {
 public:
  ...
  template <typename PublicKeyT = PublicKey>
  UpdatePublicKey2020_05_31Result& WithPublicKey(PublicKeyT&& value) {
  ...
  template <typename ETagT = Aws::String>
  UpdatePublicKey2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePublicKey2020_05_31Result& WithRequestId(RequestIdT&& value) {
