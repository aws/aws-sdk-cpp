...
class CachePolicyHeadersConfig {
 public:
  ...
  inline void SetHeaderBehavior(CachePolicyHeaderBehavior value) {
    m_headerBehaviorHasBeenSet = true;
    m_headerBehavior = value;
  }
  inline CachePolicyHeadersConfig& WithHeaderBehavior(CachePolicyHeaderBehavior value) {
  ...
  template <typename HeadersT = Headers>
  CachePolicyHeadersConfig& WithHeaders(HeadersT&& value) {
