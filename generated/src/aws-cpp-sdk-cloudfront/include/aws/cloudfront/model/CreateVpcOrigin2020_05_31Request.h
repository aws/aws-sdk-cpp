...
class CreateVpcOrigin2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  void SetVpcOriginEndpointConfig(VpcOriginEndpointConfigT&& value) {
    ...
    m_vpcOriginEndpointConfig = std::forward<VpcOriginEndpointConfigT>(value);
  }
  template <typename VpcOriginEndpointConfigT = VpcOriginEndpointConfig>
  CreateVpcOrigin2020_05_31Request& WithVpcOriginEndpointConfig(VpcOriginEndpointConfigT&& value) {
    SetVpcOriginEndpointConfig(std::forward<VpcOriginEndpointConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Tags>
  CreateVpcOrigin2020_05_31Request& WithTags(TagsT&& value) {
