...
namespace Model
{
  ...
  /**
   */
  class DeletePublicKey2020_05_31Request : public CloudFrontRequest
  {
  public:
    AWS_CLOUDFRONT_API DeletePublicKey2020_05_31Request() = default;
    ...
    template<typename IdT = Aws::String>
    DeletePublicKey2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename IfMatchT = Aws::String>
    DeletePublicKey2020_05_31Request& WithIfMatch(IfMatchT&& value) { SetIfMatch(std::forward<IfMatchT>(value)); return *this;}
    ///@}
  private:
