...
namespace Model
{
  ...
  public:
    ...
    template<typename DistributionT = Distribution>
    GetDistribution2020_05_31Result& WithDistribution(DistributionT&& value) { SetDistribution(std::forward<DistributionT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    GetDistribution2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetDistribution2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
