...
class StreamingDistributionConfigWithTags {
 public:
  ...
  template <typename StreamingDistributionConfigT = StreamingDistributionConfig>
  StreamingDistributionConfigWithTags& WithStreamingDistributionConfig(StreamingDistributionConfigT&& value) {
  ...
  template <typename TagsT = Tags>
  StreamingDistributionConfigWithTags& WithTags(TagsT&& value) {
