...
class ResponseHeadersPolicyAccessControlAllowHeaders {
 public:
  ...
  inline ResponseHeadersPolicyAccessControlAllowHeaders& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  template <typename ItemsT = Aws::Vector<Aws::String>>
  ResponseHeadersPolicyAccessControlAllowHeaders& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = Aws::String>
  ResponseHeadersPolicyAccessControlAllowHeaders& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
