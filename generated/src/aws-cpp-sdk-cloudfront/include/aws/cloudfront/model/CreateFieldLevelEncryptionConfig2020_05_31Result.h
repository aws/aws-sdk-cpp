...
class CreateFieldLevelEncryptionConfig2020_05_31Result {
 public:
  AWS_CLOUDFRONT_API CreateFieldLevelEncryptionConfig2020_05_31Result() = default;
  AWS_CLOUDFRONT_API CreateFieldLevelEncryptionConfig2020_05_31Result(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_CLOUDFRONT_API CreateFieldLevelEncryptionConfig2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  void SetFieldLevelEncryption(FieldLevelEncryptionT&& value) {
    m_fieldLevelEncryptionHasBeenSet = true;
    m_fieldLevelEncryption = std::forward<FieldLevelEncryptionT>(value);
  }
  template <typename FieldLevelEncryptionT = FieldLevelEncryption>
  CreateFieldLevelEncryptionConfig2020_05_31Result& WithFieldLevelEncryption(FieldLevelEncryptionT&& value) {
    SetFieldLevelEncryption(std::forward<FieldLevelEncryptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocationT = Aws::String>
  CreateFieldLevelEncryptionConfig2020_05_31Result& WithLocation(LocationT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CreateFieldLevelEncryptionConfig2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateFieldLevelEncryptionConfig2020_05_31Result& WithRequestId(RequestIdT&& value) {
