...
struct ListTrustStoresPaginationTraits {
  using RequestType = Model::ListTrustStores2020_05_31Request;
  using ResultType = Model::ListTrustStores2020_05_31Result;
  using OutcomeType = Model::ListTrustStores2020_05_31Outcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListTrustStores2020_05_31(request); }
