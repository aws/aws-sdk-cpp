...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API ListDistributionsByCachePolicyId2020_05_31Result() = default;
    ...
    template<typename DistributionIdListT = DistributionIdList>
    ListDistributionsByCachePolicyId2020_05_31Result& WithDistributionIdList(DistributionIdListT&& value) { SetDistributionIdList(std::forward<DistributionIdListT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListDistributionsByCachePolicyId2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
