...
class OriginAccessControlSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  OriginAccessControlSummary& WithId(IdT&& value) {
   ...
   * are <code>sigv4</code> and <code>sigv4a</code>.</p>
   */
  ...
  inline OriginAccessControlSummary& WithSigningProtocol(OriginAccessControlSigningProtocols value) {
  ...
  inline OriginAccessControlSummary& WithSigningBehavior(OriginAccessControlSigningBehaviors value) {
  ...
  inline OriginAccessControlSummary& WithOriginAccessControlOriginType(OriginAccessControlOriginTypes value) {
