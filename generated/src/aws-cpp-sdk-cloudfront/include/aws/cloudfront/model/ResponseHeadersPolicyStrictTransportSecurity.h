...
class ResponseHeadersPolicyStrictTransportSecurity {
 public:
  ...
  inline ResponseHeadersPolicyStrictTransportSecurity& WithOverride(bool value) {
    SetOverride(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeSubdomains(bool value) {
    m_includeSubdomainsHasBeenSet = true;
    m_includeSubdomains = value;
  }
  inline ResponseHeadersPolicyStrictTransportSecurity& WithIncludeSubdomains(bool value) {
    SetIncludeSubdomains(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreload(bool value) {
    m_preloadHasBeenSet = true;
    m_preload = value;
  }
  inline ResponseHeadersPolicyStrictTransportSecurity& WithPreload(bool value) {
    SetPreload(value);
    return *this;
  }
  ///@}
  ...
  inline ResponseHeadersPolicyStrictTransportSecurity& WithAccessControlMaxAgeSec(int value) {
