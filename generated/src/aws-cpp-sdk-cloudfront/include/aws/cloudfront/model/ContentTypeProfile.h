...
class ContentTypeProfile {
 public:
  ...
  inline ContentTypeProfile& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProfileIdT = Aws::String>
  ContentTypeProfile& WithProfileId(ProfileIdT&& value) {
  ...
  template <typename ContentTypeT = Aws::String>
  ContentTypeProfile& WithContentType(ContentTypeT&& value) {
