...
class AllowedMethods {
 public:
  ...
  inline AllowedMethods& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  inline AllowedMethods& AddItems(Method value) {
    m_itemsHasBeenSet = true;
  ...
  void SetCachedMethods(CachedMethodsT&& value) {
    ...
    m_cachedMethods = std::forward<CachedMethodsT>(value);
  }
  template <typename CachedMethodsT = CachedMethods>
  AllowedMethods& WithCachedMethods(CachedMethodsT&& value) {
    SetCachedMethods(std::forward<CachedMethodsT>(value));
    return *this;
  }
  ///@}
 private:
