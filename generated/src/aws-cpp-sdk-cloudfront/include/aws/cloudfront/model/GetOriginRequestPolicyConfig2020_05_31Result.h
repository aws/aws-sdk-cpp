...
class GetOriginRequestPolicyConfig2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetOriginRequestPolicyConfig2020_05_31Result& operator=(
  ...
  template <typename OriginRequestPolicyConfigT = OriginRequestPolicyConfig>
  GetOriginRequestPolicyConfig2020_05_31Result& WithOriginRequestPolicyConfig(OriginRequestPolicyConfigT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetOriginRequestPolicyConfig2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOriginRequestPolicyConfig2020_05_31Result& WithRequestId(RequestIdT&& value) {
