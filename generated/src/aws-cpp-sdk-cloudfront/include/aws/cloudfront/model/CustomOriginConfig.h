...
class CustomOriginConfig {
 public:
  ...
  inline void SetHTTPPort(int value) {
    m_hTTPPortHasBeenSet = true;
    m_hTTPPort = value;
  }
  inline CustomOriginConfig& WithHTTPPort(int value) {
    SetHTTPPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHTTPSPort(int value) {
    m_hTTPSPortHasBeenSet = true;
    m_hTTPSPort = value;
  }
  inline CustomOriginConfig& WithHTTPSPort(int value) {
    SetHTTPSPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOriginProtocolPolicy(OriginProtocolPolicy value) {
    m_originProtocolPolicyHasBeenSet = true;
    m_originProtocolPolicy = value;
  }
  inline CustomOriginConfig& WithOriginProtocolPolicy(OriginProtocolPolicy value) {
    SetOriginProtocolPolicy(value);
    return *this;
  }
  ///@}
  ...
  void SetOriginSslProtocols(OriginSslProtocolsT&& value) {
    ...
    m_originSslProtocols = std::forward<OriginSslProtocolsT>(value);
  }
  template <typename OriginSslProtocolsT = OriginSslProtocols>
  CustomOriginConfig& WithOriginSslProtocols(OriginSslProtocolsT&& value) {
    SetOriginSslProtocols(std::forward<OriginSslProtocolsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOriginReadTimeout(int value) {
    m_originReadTimeoutHasBeenSet = true;
    m_originReadTimeout = value;
  }
  inline CustomOriginConfig& WithOriginReadTimeout(int value) {
    SetOriginReadTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOriginKeepaliveTimeout(int value) {
    m_originKeepaliveTimeoutHasBeenSet = true;
    m_originKeepaliveTimeout = value;
  }
  inline CustomOriginConfig& WithOriginKeepaliveTimeout(int value) {
    SetOriginKeepaliveTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline CustomOriginConfig& WithIpAddressType(IpAddressType value) {
