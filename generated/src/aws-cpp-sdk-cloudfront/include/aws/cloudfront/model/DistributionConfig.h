...
class DistributionConfig {
 public:
  ...
  void SetOriginGroups(OriginGroupsT&& value) {
    ...
    m_originGroups = std::forward<OriginGroupsT>(value);
  }
  template <typename OriginGroupsT = OriginGroups>
  DistributionConfig& WithOriginGroups(OriginGroupsT&& value) {
    SetOriginGroups(std::forward<OriginGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPriceClass(PriceClass value) {
    m_priceClassHasBeenSet = true;
    m_priceClass = value;
  }
  inline DistributionConfig& WithPriceClass(PriceClass value) {
    SetPriceClass(value);
    return *this;
  }
  ///@}
  ...
  inline DistributionConfig& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetViewerCertificate(ViewerCertificateT&& value) {
    ...
    m_viewerCertificate = std::forward<ViewerCertificateT>(value);
  }
  template <typename ViewerCertificateT = ViewerCertificate>
  DistributionConfig& WithViewerCertificate(ViewerCertificateT&& value) {
    SetViewerCertificate(std::forward<ViewerCertificateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHttpVersion(HttpVersion value) {
    m_httpVersionHasBeenSet = true;
    m_httpVersion = value;
  }
  inline DistributionConfig& WithHttpVersion(HttpVersion value) {
  ...
  inline void SetIsIPV6Enabled(bool value) {
    m_isIPV6EnabledHasBeenSet = true;
    m_isIPV6Enabled = value;
  }
  inline DistributionConfig& WithIsIPV6Enabled(bool value) {
    SetIsIPV6Enabled(value);
    return *this;
  }
  ///@}
  ...
  void SetContinuousDeploymentPolicyId(ContinuousDeploymentPolicyIdT&& value) {
    ...
    m_continuousDeploymentPolicyId = std::forward<ContinuousDeploymentPolicyIdT>(value);
  }
  template <typename ContinuousDeploymentPolicyIdT = Aws::String>
  DistributionConfig& WithContinuousDeploymentPolicyId(ContinuousDeploymentPolicyIdT&& value) {
    SetContinuousDeploymentPolicyId(std::forward<ContinuousDeploymentPolicyIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStaging(bool value) {
    m_stagingHasBeenSet = true;
    m_staging = value;
  }
  inline DistributionConfig& WithStaging(bool value) {
    SetStaging(value);
    return *this;
  }
  ///@}
  ...
  void SetTenantConfig(TenantConfigT&& value) {
    ...
    m_tenantConfig = std::forward<TenantConfigT>(value);
  }
  template <typename TenantConfigT = TenantConfig>
  DistributionConfig& WithTenantConfig(TenantConfigT&& value) {
    SetTenantConfig(std::forward<TenantConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline DistributionConfig& WithConnectionMode(ConnectionMode value) {
