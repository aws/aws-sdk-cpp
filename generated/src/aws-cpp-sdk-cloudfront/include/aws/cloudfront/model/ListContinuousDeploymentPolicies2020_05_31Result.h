...
class ListContinuousDeploymentPolicies2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API ListContinuousDeploymentPolicies2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  void SetContinuousDeploymentPolicyList(ContinuousDeploymentPolicyListT&& value) {
    m_continuousDeploymentPolicyListHasBeenSet = true;
    m_continuousDeploymentPolicyList = std::forward<ContinuousDeploymentPolicyListT>(value);
  }
  template <typename ContinuousDeploymentPolicyListT = ContinuousDeploymentPolicyList>
  ListContinuousDeploymentPolicies2020_05_31Result& WithContinuousDeploymentPolicyList(ContinuousDeploymentPolicyListT&& value) {
    SetContinuousDeploymentPolicyList(std::forward<ContinuousDeploymentPolicyListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListContinuousDeploymentPolicies2020_05_31Result& WithRequestId(RequestIdT&& value) {
