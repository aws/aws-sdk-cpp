...
class GetDistributionConfig2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetDistributionConfig2020_05_31Result& operator=(
  ...
  template <typename DistributionConfigT = DistributionConfig>
  GetDistributionConfig2020_05_31Result& WithDistributionConfig(DistributionConfigT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetDistributionConfig2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDistributionConfig2020_05_31Result& WithRequestId(RequestIdT&& value) {
