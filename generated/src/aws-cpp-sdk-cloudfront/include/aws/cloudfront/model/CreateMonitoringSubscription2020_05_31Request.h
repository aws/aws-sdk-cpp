...
class CreateMonitoringSubscription2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename DistributionIdT = Aws::String>
  CreateMonitoringSubscription2020_05_31Request& WithDistributionId(DistributionIdT&& value) {
  ...
  template <typename MonitoringSubscriptionT = MonitoringSubscription>
  CreateMonitoringSubscription2020_05_31Request& WithMonitoringSubscription(MonitoringSubscriptionT&& value) {
