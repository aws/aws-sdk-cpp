...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API DescribeFunction2020_05_31Result() = default;
    ...
    template<typename FunctionSummaryT = FunctionSummary>
    DescribeFunction2020_05_31Result& WithFunctionSummary(FunctionSummaryT&& value) { SetFunctionSummary(std::forward<FunctionSummaryT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    DescribeFunction2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeFunction2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
