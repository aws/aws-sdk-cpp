...
class DescribeFunction2020_05_31Result {
 public:
  ...
  template <typename FunctionSummaryT = FunctionSummary>
  DescribeFunction2020_05_31Result& WithFunctionSummary(FunctionSummaryT&& value) {
  ...
  template <typename ETagT = Aws::String>
  DescribeFunction2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFunction2020_05_31Result& WithRequestId(RequestIdT&& value) {
