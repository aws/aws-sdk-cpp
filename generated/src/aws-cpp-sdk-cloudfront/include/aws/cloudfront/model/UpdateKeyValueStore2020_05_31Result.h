...
class UpdateKeyValueStore2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API UpdateKeyValueStore2020_05_31Result& operator=(
  ...
  template <typename KeyValueStoreT = KeyValueStore>
  UpdateKeyValueStore2020_05_31Result& WithKeyValueStore(KeyValueStoreT&& value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateKeyValueStore2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateKeyValueStore2020_05_31Result& WithRequestId(RequestIdT&& value) {
