...
class DeleteVpcOrigin2020_05_31Result {
 public:
  ...
  template <typename VpcOriginT = VpcOrigin>
  DeleteVpcOrigin2020_05_31Result& WithVpcOrigin(VpcOriginT&& value) {
  ...
  template <typename ETagT = Aws::String>
  DeleteVpcOrigin2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteVpcOrigin2020_05_31Result& WithRequestId(RequestIdT&& value) {
