...
class EncryptionEntity {
 public:
  ...
  void SetPublicKeyId(PublicKeyIdT&& value) {
    ...
    m_publicKeyId = std::forward<PublicKeyIdT>(value);
  }
  template <typename PublicKeyIdT = Aws::String>
  EncryptionEntity& WithPublicKeyId(PublicKeyIdT&& value) {
    SetPublicKeyId(std::forward<PublicKeyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFieldPatterns(FieldPatternsT&& value) {
    ...
    m_fieldPatterns = std::forward<FieldPatternsT>(value);
  }
  template <typename FieldPatternsT = FieldPatterns>
  EncryptionEntity& WithFieldPatterns(FieldPatternsT&& value) {
    SetFieldPatterns(std::forward<FieldPatternsT>(value));
    return *this;
  }
  ///@}
 private:
