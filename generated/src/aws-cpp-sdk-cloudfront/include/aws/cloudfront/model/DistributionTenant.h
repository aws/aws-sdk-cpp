...
class DistributionTenant {
 public:
  ...
  void SetCustomizations(CustomizationsT&& value) {
    ...
    m_customizations = std::forward<CustomizationsT>(value);
  }
  template <typename CustomizationsT = Customizations>
  DistributionTenant& WithCustomizations(CustomizationsT&& value) {
    SetCustomizations(std::forward<CustomizationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectionGroupId(ConnectionGroupIdT&& value) {
    ...
    m_connectionGroupId = std::forward<ConnectionGroupIdT>(value);
  }
  template <typename ConnectionGroupIdT = Aws::String>
  DistributionTenant& WithConnectionGroupId(ConnectionGroupIdT&& value) {
    SetConnectionGroupId(std::forward<ConnectionGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DistributionTenant& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
