...
class ListAnycastIpLists2020_05_31Result {
 public:
  ...
  void SetAnycastIpLists(AnycastIpListsT&& value) {
    m_anycastIpListsHasBeenSet = true;
    m_anycastIpLists = std::forward<AnycastIpListsT>(value);
  }
  template <typename AnycastIpListsT = AnycastIpListCollection>
  ListAnycastIpLists2020_05_31Result& WithAnycastIpLists(AnycastIpListsT&& value) {
    SetAnycastIpLists(std::forward<AnycastIpListsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAnycastIpLists2020_05_31Result& WithRequestId(RequestIdT&& value) {
