...
namespace Model
{
  ...
  public:
     ...
     * (which is also the ID of the last identity on that page).</p>
     */
    inline ListCloudFrontOriginAccessIdentities2020_05_31Request& WithMarker(const Aws::String& value) { SetMarker(value); return *this;}
     ...
     * (which is also the ID of the last identity on that page).</p>
     */
    inline ListCloudFrontOriginAccessIdentities2020_05_31Request& WithMarker(Aws::String&& value) { SetMarker(std::move(value)); return *this;}
     ...
     * (which is also the ID of the last identity on that page).</p>
     */
    inline ListCloudFrontOriginAccessIdentities2020_05_31Request& WithMarker(const char* value) { SetMarker(value); return *this;}
