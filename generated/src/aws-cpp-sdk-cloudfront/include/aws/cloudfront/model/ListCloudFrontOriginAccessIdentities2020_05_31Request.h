...
class ListCloudFrontOriginAccessIdentities2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListCloudFrontOriginAccessIdentities2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListCloudFrontOriginAccessIdentities2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
