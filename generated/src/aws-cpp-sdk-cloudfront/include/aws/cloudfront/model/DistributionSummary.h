...
class DistributionSummary {
 public:
  ...
  inline DistributionSummary& WithPriceClass(PriceClass value) {
    SetPriceClass(value);
    return *this;
  }
  ///@}
  ...
  inline DistributionSummary& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline DistributionSummary& WithHttpVersion(HttpVersion value) {
  ...
  inline DistributionSummary& WithIsIPV6Enabled(bool value) {
  ...
  inline DistributionSummary& WithStaging(bool value) {
    SetStaging(value);
    return *this;
  }
  ///@}
  ...
  inline DistributionSummary& WithConnectionMode(ConnectionMode value) {
