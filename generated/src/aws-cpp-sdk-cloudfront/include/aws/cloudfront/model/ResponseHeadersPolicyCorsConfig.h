...
class ResponseHeadersPolicyCorsConfig {
 public:
  ...
  void SetAccessControlAllowOrigins(AccessControlAllowOriginsT&& value) {
    m_accessControlAllowOriginsHasBeenSet = true;
    m_accessControlAllowOrigins = std::forward<AccessControlAllowOriginsT>(value);
  }
  template <typename AccessControlAllowOriginsT = ResponseHeadersPolicyAccessControlAllowOrigins>
  ResponseHeadersPolicyCorsConfig& WithAccessControlAllowOrigins(AccessControlAllowOriginsT&& value) {
    SetAccessControlAllowOrigins(std::forward<AccessControlAllowOriginsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccessControlAllowHeaders(AccessControlAllowHeadersT&& value) {
    m_accessControlAllowHeadersHasBeenSet = true;
    m_accessControlAllowHeaders = std::forward<AccessControlAllowHeadersT>(value);
  }
  template <typename AccessControlAllowHeadersT = ResponseHeadersPolicyAccessControlAllowHeaders>
  ResponseHeadersPolicyCorsConfig& WithAccessControlAllowHeaders(AccessControlAllowHeadersT&& value) {
    SetAccessControlAllowHeaders(std::forward<AccessControlAllowHeadersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccessControlAllowMethods(AccessControlAllowMethodsT&& value) {
    m_accessControlAllowMethodsHasBeenSet = true;
    m_accessControlAllowMethods = std::forward<AccessControlAllowMethodsT>(value);
  }
  template <typename AccessControlAllowMethodsT = ResponseHeadersPolicyAccessControlAllowMethods>
  ResponseHeadersPolicyCorsConfig& WithAccessControlAllowMethods(AccessControlAllowMethodsT&& value) {
    SetAccessControlAllowMethods(std::forward<AccessControlAllowMethodsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAccessControlAllowCredentials(bool value) {
    m_accessControlAllowCredentialsHasBeenSet = true;
    m_accessControlAllowCredentials = value;
  }
  inline ResponseHeadersPolicyCorsConfig& WithAccessControlAllowCredentials(bool value) {
    SetAccessControlAllowCredentials(value);
    return *this;
  }
  ///@}
   ...
   * in the MDN Web Docs.</p>
   */
  inline const ResponseHeadersPolicyAccessControlExposeHeaders& GetAccessControlExposeHeaders() const {
  ...
  template <typename AccessControlExposeHeadersT = ResponseHeadersPolicyAccessControlExposeHeaders>
  ResponseHeadersPolicyCorsConfig& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) {
  ...
  inline void SetAccessControlMaxAgeSec(int value) {
    m_accessControlMaxAgeSecHasBeenSet = true;
    m_accessControlMaxAgeSec = value;
  }
  inline ResponseHeadersPolicyCorsConfig& WithAccessControlMaxAgeSec(int value) {
    SetAccessControlMaxAgeSec(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOriginOverride(bool value) {
    m_originOverrideHasBeenSet = true;
    m_originOverride = value;
  }
  inline ResponseHeadersPolicyCorsConfig& WithOriginOverride(bool value) {
