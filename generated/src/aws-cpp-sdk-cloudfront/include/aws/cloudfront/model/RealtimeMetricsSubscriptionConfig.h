...
class RealtimeMetricsSubscriptionConfig {
 public:
  ...
  inline void SetRealtimeMetricsSubscriptionStatus(RealtimeMetricsSubscriptionStatus value) {
    m_realtimeMetricsSubscriptionStatusHasBeenSet = true;
    m_realtimeMetricsSubscriptionStatus = value;
  }
  inline RealtimeMetricsSubscriptionConfig& WithRealtimeMetricsSubscriptionStatus(RealtimeMetricsSubscriptionStatus value) {
    SetRealtimeMetricsSubscriptionStatus(value);
    return *this;
  }
  ///@}
 private:
