...
class GetInvalidationForDistributionTenant2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetInvalidationForDistributionTenant2020_05_31Result(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_CLOUDFRONT_API GetInvalidationForDistributionTenant2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename InvalidationT = Invalidation>
  GetInvalidationForDistributionTenant2020_05_31Result& WithInvalidation(InvalidationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetInvalidationForDistributionTenant2020_05_31Result& WithRequestId(RequestIdT&& value) {
