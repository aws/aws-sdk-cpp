...
class OriginRequestPolicyList {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  OriginRequestPolicyList& WithNextMarker(NextMarkerT&& value) {
  ...
  inline OriginRequestPolicyList& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  inline OriginRequestPolicyList& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  template <typename ItemsT = Aws::Vector<OriginRequestPolicySummary>>
  OriginRequestPolicyList& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = OriginRequestPolicySummary>
  OriginRequestPolicyList& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
