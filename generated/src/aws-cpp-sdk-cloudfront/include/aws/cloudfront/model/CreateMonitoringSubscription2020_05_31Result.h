...
class CreateMonitoringSubscription2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API CreateMonitoringSubscription2020_05_31Result& operator=(
  ...
  template <typename MonitoringSubscriptionT = MonitoringSubscription>
  CreateMonitoringSubscription2020_05_31Result& WithMonitoringSubscription(MonitoringSubscriptionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateMonitoringSubscription2020_05_31Result& WithRequestId(RequestIdT&& value) {
