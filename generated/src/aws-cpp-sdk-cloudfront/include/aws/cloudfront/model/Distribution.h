...
class Distribution {
 public:
  ...
  template <typename ARNT = Aws::String>
  Distribution& WithARN(ARNT&& value) {
  ...
  template <typename StatusT = Aws::String>
  Distribution& WithStatus(StatusT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  Distribution& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  inline void SetInProgressInvalidationBatches(int value) {
    m_inProgressInvalidationBatchesHasBeenSet = true;
    m_inProgressInvalidationBatches = value;
  }
  inline Distribution& WithInProgressInvalidationBatches(int value) {
    SetInProgressInvalidationBatches(value);
    return *this;
  }
  ///@}
  ...
  template <typename DomainNameT = Aws::String>
  Distribution& WithDomainName(DomainNameT&& value) {
  ...
  template <typename ActiveTrustedSignersT = ActiveTrustedSigners>
  Distribution& WithActiveTrustedSigners(ActiveTrustedSignersT&& value) {
  ...
  void SetActiveTrustedKeyGroups(ActiveTrustedKeyGroupsT&& value) {
    m_activeTrustedKeyGroupsHasBeenSet = true;
    m_activeTrustedKeyGroups = std::forward<ActiveTrustedKeyGroupsT>(value);
  }
  template <typename ActiveTrustedKeyGroupsT = ActiveTrustedKeyGroups>
  Distribution& WithActiveTrustedKeyGroups(ActiveTrustedKeyGroupsT&& value) {
    SetActiveTrustedKeyGroups(std::forward<ActiveTrustedKeyGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DistributionConfigT = DistributionConfig>
  Distribution& WithDistributionConfig(DistributionConfigT&& value) {
  ...
  template <typename AliasICPRecordalsT = Aws::Vector<AliasICPRecordal>>
  Distribution& WithAliasICPRecordals(AliasICPRecordalsT&& value) {
    SetAliasICPRecordals(std::forward<AliasICPRecordalsT>(value));
    return *this;
  }
  template <typename AliasICPRecordalsT = AliasICPRecordal>
  Distribution& AddAliasICPRecordals(AliasICPRecordalsT&& value) {
    m_aliasICPRecordalsHasBeenSet = true;
