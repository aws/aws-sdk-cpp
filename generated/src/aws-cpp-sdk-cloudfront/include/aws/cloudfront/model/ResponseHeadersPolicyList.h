...
class ResponseHeadersPolicyList {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ResponseHeadersPolicyList& WithNextMarker(NextMarkerT&& value) {
  ...
  inline ResponseHeadersPolicyList& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  inline ResponseHeadersPolicyList& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  template <typename ItemsT = Aws::Vector<ResponseHeadersPolicySummary>>
  ResponseHeadersPolicyList& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ResponseHeadersPolicySummary>
  ResponseHeadersPolicyList& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
