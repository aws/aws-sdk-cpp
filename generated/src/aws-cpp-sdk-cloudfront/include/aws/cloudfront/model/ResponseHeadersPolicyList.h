...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API ResponseHeadersPolicyList() = default;
    AWS_CLOUDFRONT_API ResponseHeadersPolicyList(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_CLOUDFRONT_API ResponseHeadersPolicyList& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
    ...
    template<typename NextMarkerT = Aws::String>
    ResponseHeadersPolicyList& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename ItemsT = Aws::Vector<ResponseHeadersPolicySummary>>
    void SetItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<ResponseHeadersPolicySummary>>
    ResponseHeadersPolicyList& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = ResponseHeadersPolicySummary>
    ResponseHeadersPolicyList& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
  private:
