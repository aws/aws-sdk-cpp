...
class AnycastIpList {
 public:
  ...
  void SetAnycastIps(AnycastIpsT&& value) {
    ...
    m_anycastIps = std::forward<AnycastIpsT>(value);
  }
  template <typename AnycastIpsT = Aws::Vector<Aws::String>>
  AnycastIpList& WithAnycastIps(AnycastIpsT&& value) {
    SetAnycastIps(std::forward<AnycastIpsT>(value));
    return *this;
  }
  template <typename AnycastIpsT = Aws::String>
  AnycastIpList& AddAnycastIps(AnycastIpsT&& value) {
    m_anycastIpsHasBeenSet = true;
    m_anycastIps.emplace_back(std::forward<AnycastIpsT>(value));
    return *this;
  }
  ///@}
  ...
  inline AnycastIpList& WithIpCount(int value) {
    SetIpCount(value);
    return *this;
  }
  ///@}
