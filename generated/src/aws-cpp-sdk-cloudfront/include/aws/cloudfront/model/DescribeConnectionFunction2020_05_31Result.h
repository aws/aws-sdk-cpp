...
namespace Model {
class DescribeConnectionFunction2020_05_31Result {
 public:
  AWS_CLOUDFRONT_API DescribeConnectionFunction2020_05_31Result() = default;
  AWS_CLOUDFRONT_API DescribeConnectionFunction2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_CLOUDFRONT_API DescribeConnectionFunction2020_05_31Result& operator=(
  ...
  template <typename ConnectionFunctionSummaryT = ConnectionFunctionSummary>
  DescribeConnectionFunction2020_05_31Result& WithConnectionFunctionSummary(ConnectionFunctionSummaryT&& value) {
  ...
  template <typename ETagT = Aws::String>
  DescribeConnectionFunction2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeConnectionFunction2020_05_31Result& WithRequestId(RequestIdT&& value) {
