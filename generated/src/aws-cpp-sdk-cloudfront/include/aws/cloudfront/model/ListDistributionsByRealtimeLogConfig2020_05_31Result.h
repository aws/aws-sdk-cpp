...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API ListDistributionsByRealtimeLogConfig2020_05_31Result() = default;
    ...
    template<typename DistributionListT = DistributionList>
    ListDistributionsByRealtimeLogConfig2020_05_31Result& WithDistributionList(DistributionListT&& value) { SetDistributionList(std::forward<DistributionListT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListDistributionsByRealtimeLogConfig2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
