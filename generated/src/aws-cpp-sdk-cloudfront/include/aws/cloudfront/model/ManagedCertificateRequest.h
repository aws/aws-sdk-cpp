...
class ManagedCertificateRequest {
 public:
  ...
  inline ManagedCertificateRequest& WithValidationTokenHost(ValidationTokenHost value) {
  ...
  void SetPrimaryDomainName(PrimaryDomainNameT&& value) {
    ...
    m_primaryDomainName = std::forward<PrimaryDomainNameT>(value);
  }
  template <typename PrimaryDomainNameT = Aws::String>
  ManagedCertificateRequest& WithPrimaryDomainName(PrimaryDomainNameT&& value) {
    SetPrimaryDomainName(std::forward<PrimaryDomainNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline ManagedCertificateRequest& WithCertificateTransparencyLoggingPreference(CertificateTransparencyLoggingPreference value) {
