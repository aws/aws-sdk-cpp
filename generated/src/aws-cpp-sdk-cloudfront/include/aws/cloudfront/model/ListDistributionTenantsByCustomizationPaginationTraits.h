...
struct ListDistributionTenantsByCustomizationPaginationTraits {
  using RequestType = Model::ListDistributionTenantsByCustomization2020_05_31Request;
  using ResultType = Model::ListDistributionTenantsByCustomization2020_05_31Result;
  using OutcomeType = Model::ListDistributionTenantsByCustomization2020_05_31Outcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) {
    return client->ListDistributionTenantsByCustomization2020_05_31(request);
  }
