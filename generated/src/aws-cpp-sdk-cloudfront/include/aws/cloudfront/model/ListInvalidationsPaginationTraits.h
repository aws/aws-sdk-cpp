...
struct ListInvalidationsPaginationTraits {
  using RequestType = Model::ListInvalidations2020_05_31Request;
  using ResultType = Model::ListInvalidations2020_05_31Result;
  using OutcomeType = Model::ListInvalidations2020_05_31Outcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListInvalidations2020_05_31(request); }
