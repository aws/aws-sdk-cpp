...
class CreateOriginRequestPolicy2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API CreateOriginRequestPolicy2020_05_31Result& operator=(
  ...
  void SetOriginRequestPolicy(OriginRequestPolicyT&& value) {
    m_originRequestPolicyHasBeenSet = true;
    m_originRequestPolicy = std::forward<OriginRequestPolicyT>(value);
  }
  template <typename OriginRequestPolicyT = OriginRequestPolicy>
  CreateOriginRequestPolicy2020_05_31Result& WithOriginRequestPolicy(OriginRequestPolicyT&& value) {
    SetOriginRequestPolicy(std::forward<OriginRequestPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocationT = Aws::String>
  CreateOriginRequestPolicy2020_05_31Result& WithLocation(LocationT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CreateOriginRequestPolicy2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateOriginRequestPolicy2020_05_31Result& WithRequestId(RequestIdT&& value) {
