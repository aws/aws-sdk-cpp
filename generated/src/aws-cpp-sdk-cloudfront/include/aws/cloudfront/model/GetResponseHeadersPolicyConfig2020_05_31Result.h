...
class GetResponseHeadersPolicyConfig2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetResponseHeadersPolicyConfig2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename ResponseHeadersPolicyConfigT = ResponseHeadersPolicyConfig>
  GetResponseHeadersPolicyConfig2020_05_31Result& WithResponseHeadersPolicyConfig(ResponseHeadersPolicyConfigT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetResponseHeadersPolicyConfig2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetResponseHeadersPolicyConfig2020_05_31Result& WithRequestId(RequestIdT&& value) {
