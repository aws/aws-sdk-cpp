...
struct ListConnectionGroupsPaginationTraits {
  using RequestType = Model::ListConnectionGroups2020_05_31Request;
  using ResultType = Model::ListConnectionGroups2020_05_31Result;
  using OutcomeType = Model::ListConnectionGroups2020_05_31Outcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListConnectionGroups2020_05_31(request); }
