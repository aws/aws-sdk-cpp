...
class ResponseHeadersPolicyAccessControlExposeHeaders {
 public:
  ...
  inline ResponseHeadersPolicyAccessControlExposeHeaders& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  template <typename ItemsT = Aws::Vector<Aws::String>>
  ResponseHeadersPolicyAccessControlExposeHeaders& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = Aws::String>
  ResponseHeadersPolicyAccessControlExposeHeaders& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
