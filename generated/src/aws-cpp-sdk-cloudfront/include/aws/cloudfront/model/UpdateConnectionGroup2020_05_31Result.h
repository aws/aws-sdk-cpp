...
class UpdateConnectionGroup2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API UpdateConnectionGroup2020_05_31Result& operator=(
  ...
  template <typename ConnectionGroupT = ConnectionGroup>
  UpdateConnectionGroup2020_05_31Result& WithConnectionGroup(ConnectionGroupT&& value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateConnectionGroup2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConnectionGroup2020_05_31Result& WithRequestId(RequestIdT&& value) {
