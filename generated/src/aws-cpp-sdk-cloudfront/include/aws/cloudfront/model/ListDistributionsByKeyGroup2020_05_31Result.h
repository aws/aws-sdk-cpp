...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API ListDistributionsByKeyGroup2020_05_31Result() = default;
    ...
    template<typename DistributionIdListT = DistributionIdList>
    ListDistributionsByKeyGroup2020_05_31Result& WithDistributionIdList(DistributionIdListT&& value) { SetDistributionIdList(std::forward<DistributionIdListT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListDistributionsByKeyGroup2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
