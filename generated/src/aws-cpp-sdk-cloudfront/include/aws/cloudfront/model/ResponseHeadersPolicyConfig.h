...
class ResponseHeadersPolicyConfig {
 public:
  ...
  void SetCorsConfig(CorsConfigT&& value) {
    m_corsConfigHasBeenSet = true;
    m_corsConfig = std::forward<CorsConfigT>(value);
  }
  template <typename CorsConfigT = ResponseHeadersPolicyCorsConfig>
  ResponseHeadersPolicyConfig& WithCorsConfig(CorsConfigT&& value) {
    SetCorsConfig(std::forward<CorsConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecurityHeadersConfig(SecurityHeadersConfigT&& value) {
    m_securityHeadersConfigHasBeenSet = true;
    m_securityHeadersConfig = std::forward<SecurityHeadersConfigT>(value);
  }
  template <typename SecurityHeadersConfigT = ResponseHeadersPolicySecurityHeadersConfig>
  ResponseHeadersPolicyConfig& WithSecurityHeadersConfig(SecurityHeadersConfigT&& value) {
    SetSecurityHeadersConfig(std::forward<SecurityHeadersConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServerTimingHeadersConfig(ServerTimingHeadersConfigT&& value) {
    ...
    m_serverTimingHeadersConfig = std::forward<ServerTimingHeadersConfigT>(value);
  }
  template <typename ServerTimingHeadersConfigT = ResponseHeadersPolicyServerTimingHeadersConfig>
  ResponseHeadersPolicyConfig& WithServerTimingHeadersConfig(ServerTimingHeadersConfigT&& value) {
    SetServerTimingHeadersConfig(std::forward<ServerTimingHeadersConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomHeadersConfig(CustomHeadersConfigT&& value) {
    m_customHeadersConfigHasBeenSet = true;
    m_customHeadersConfig = std::forward<CustomHeadersConfigT>(value);
  }
  template <typename CustomHeadersConfigT = ResponseHeadersPolicyCustomHeadersConfig>
  ResponseHeadersPolicyConfig& WithCustomHeadersConfig(CustomHeadersConfigT&& value) {
    SetCustomHeadersConfig(std::forward<CustomHeadersConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoveHeadersConfig(RemoveHeadersConfigT&& value) {
    m_removeHeadersConfigHasBeenSet = true;
    m_removeHeadersConfig = std::forward<RemoveHeadersConfigT>(value);
  }
  template <typename RemoveHeadersConfigT = ResponseHeadersPolicyRemoveHeadersConfig>
  ResponseHeadersPolicyConfig& WithRemoveHeadersConfig(RemoveHeadersConfigT&& value) {
    SetRemoveHeadersConfig(std::forward<RemoveHeadersConfigT>(value));
    return *this;
  }
  ///@}
 private:
