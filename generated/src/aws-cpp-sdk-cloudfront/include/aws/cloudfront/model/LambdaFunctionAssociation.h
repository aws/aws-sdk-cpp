...
class LambdaFunctionAssociation {
 public:
  ...
  inline LambdaFunctionAssociation& WithEventType(EventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeBody(bool value) {
    m_includeBodyHasBeenSet = true;
    m_includeBody = value;
  }
  inline LambdaFunctionAssociation& WithIncludeBody(bool value) {
    SetIncludeBody(value);
    return *this;
  }
  ///@}
 private:
