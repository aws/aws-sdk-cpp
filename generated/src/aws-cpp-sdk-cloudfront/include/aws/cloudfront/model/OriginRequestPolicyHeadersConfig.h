...
class OriginRequestPolicyHeadersConfig {
 public:
  ...
  inline void SetHeaderBehavior(OriginRequestPolicyHeaderBehavior value) {
    m_headerBehaviorHasBeenSet = true;
    m_headerBehavior = value;
  }
  inline OriginRequestPolicyHeadersConfig& WithHeaderBehavior(OriginRequestPolicyHeaderBehavior value) {
    SetHeaderBehavior(value);
    return *this;
  }
  ///@}
  ...
  template <typename HeadersT = Headers>
  OriginRequestPolicyHeadersConfig& WithHeaders(HeadersT&& value) {
