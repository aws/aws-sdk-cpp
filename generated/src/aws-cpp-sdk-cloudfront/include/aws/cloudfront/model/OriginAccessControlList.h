...
class OriginAccessControlList {
 public:
  ...
  template <typename MarkerT = Aws::String>
  OriginAccessControlList& WithMarker(MarkerT&& value) {
  ...
  template <typename NextMarkerT = Aws::String>
  OriginAccessControlList& WithNextMarker(NextMarkerT&& value) {
  ...
  inline OriginAccessControlList& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  inline OriginAccessControlList& WithIsTruncated(bool value) {
  ...
  inline OriginAccessControlList& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  template <typename ItemsT = Aws::Vector<OriginAccessControlSummary>>
  OriginAccessControlList& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = OriginAccessControlSummary>
  OriginAccessControlList& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
