...
class TestFunction2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  inline TestFunction2020_05_31Request& WithStage(FunctionStage value) {
    SetStage(value);
    return *this;
  }
  ///@}
  ...
  void SetEventObject(EventObjectT&& value) {
    m_eventObjectHasBeenSet = true;
    m_eventObject = std::forward<EventObjectT>(value);
  }
  template <typename EventObjectT = Aws::Utils::CryptoBuffer>
  TestFunction2020_05_31Request& WithEventObject(EventObjectT&& value) {
    SetEventObject(std::forward<EventObjectT>(value));
    return *this;
  }
  ///@}
 private:
