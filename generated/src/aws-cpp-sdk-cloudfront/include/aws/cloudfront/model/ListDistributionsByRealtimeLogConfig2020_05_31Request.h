...
class ListDistributionsByRealtimeLogConfig2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListDistributionsByRealtimeLogConfig2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListDistributionsByRealtimeLogConfig2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
  ...
  void SetRealtimeLogConfigName(RealtimeLogConfigNameT&& value) {
    m_realtimeLogConfigNameHasBeenSet = true;
    m_realtimeLogConfigName = std::forward<RealtimeLogConfigNameT>(value);
  }
  template <typename RealtimeLogConfigNameT = Aws::String>
  ListDistributionsByRealtimeLogConfig2020_05_31Request& WithRealtimeLogConfigName(RealtimeLogConfigNameT&& value) {
    SetRealtimeLogConfigName(std::forward<RealtimeLogConfigNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RealtimeLogConfigArnT = Aws::String>
  ListDistributionsByRealtimeLogConfig2020_05_31Request& WithRealtimeLogConfigArn(RealtimeLogConfigArnT&& value) {
