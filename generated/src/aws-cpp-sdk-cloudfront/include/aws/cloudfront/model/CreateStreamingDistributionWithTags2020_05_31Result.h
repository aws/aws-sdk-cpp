...
namespace Model
{
  ...
  public:
    ...
    template<typename StreamingDistributionT = StreamingDistribution>
    CreateStreamingDistributionWithTags2020_05_31Result& WithStreamingDistribution(StreamingDistributionT&& value) { SetStreamingDistribution(std::forward<StreamingDistributionT>(value)); return *this;}
    ///@}
    ...
    template<typename LocationT = Aws::String>
    CreateStreamingDistributionWithTags2020_05_31Result& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    CreateStreamingDistributionWithTags2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateStreamingDistributionWithTags2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
