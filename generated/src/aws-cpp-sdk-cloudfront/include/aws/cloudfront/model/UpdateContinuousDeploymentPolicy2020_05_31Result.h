...
namespace Model
{
  ...
  public:
    ...
    template<typename ContinuousDeploymentPolicyT = ContinuousDeploymentPolicy>
    UpdateContinuousDeploymentPolicy2020_05_31Result& WithContinuousDeploymentPolicy(ContinuousDeploymentPolicyT&& value) { SetContinuousDeploymentPolicy(std::forward<ContinuousDeploymentPolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    UpdateContinuousDeploymentPolicy2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateContinuousDeploymentPolicy2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
