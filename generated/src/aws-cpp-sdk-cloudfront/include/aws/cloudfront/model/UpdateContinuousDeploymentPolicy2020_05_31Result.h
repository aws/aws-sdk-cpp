...
class UpdateContinuousDeploymentPolicy2020_05_31Result {
 public:
  AWS_CLOUDFRONT_API UpdateContinuousDeploymentPolicy2020_05_31Result() = default;
  AWS_CLOUDFRONT_API UpdateContinuousDeploymentPolicy2020_05_31Result(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_CLOUDFRONT_API UpdateContinuousDeploymentPolicy2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  void SetContinuousDeploymentPolicy(ContinuousDeploymentPolicyT&& value) {
    m_continuousDeploymentPolicyHasBeenSet = true;
    m_continuousDeploymentPolicy = std::forward<ContinuousDeploymentPolicyT>(value);
  }
  template <typename ContinuousDeploymentPolicyT = ContinuousDeploymentPolicy>
  UpdateContinuousDeploymentPolicy2020_05_31Result& WithContinuousDeploymentPolicy(ContinuousDeploymentPolicyT&& value) {
    SetContinuousDeploymentPolicy(std::forward<ContinuousDeploymentPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ETagT = Aws::String>
  UpdateContinuousDeploymentPolicy2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateContinuousDeploymentPolicy2020_05_31Result& WithRequestId(RequestIdT&& value) {
