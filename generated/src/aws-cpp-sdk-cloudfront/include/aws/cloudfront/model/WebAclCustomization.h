...
class WebAclCustomization {
 public:
  ...
  inline void SetAction(CustomizationActionType value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline WebAclCustomization& WithAction(CustomizationActionType value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  WebAclCustomization& WithArn(ArnT&& value) {
