...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API GetVpcOrigin2020_05_31Result() = default;
    ...
    template<typename VpcOriginT = VpcOrigin>
    GetVpcOrigin2020_05_31Result& WithVpcOrigin(VpcOriginT&& value) { SetVpcOrigin(std::forward<VpcOriginT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    GetVpcOrigin2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetVpcOrigin2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
