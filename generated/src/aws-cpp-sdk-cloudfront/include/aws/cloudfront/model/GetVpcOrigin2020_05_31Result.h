...
class GetVpcOrigin2020_05_31Result {
 public:
  ...
  template <typename VpcOriginT = VpcOrigin>
  GetVpcOrigin2020_05_31Result& WithVpcOrigin(VpcOriginT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetVpcOrigin2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetVpcOrigin2020_05_31Result& WithRequestId(RequestIdT&& value) {
