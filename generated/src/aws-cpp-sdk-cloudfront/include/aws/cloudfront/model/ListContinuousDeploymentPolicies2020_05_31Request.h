...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API ListContinuousDeploymentPolicies2020_05_31Request() = default;
    ...
    template<typename MarkerT = Aws::String>
    ListContinuousDeploymentPolicies2020_05_31Request& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename MaxItemsT = Aws::String>
    ListContinuousDeploymentPolicies2020_05_31Request& WithMaxItems(MaxItemsT&& value) { SetMaxItems(std::forward<MaxItemsT>(value)); return *this;}
    ///@}
  private:
