...
class DistributionTenantAssociationFilter {
 public:
  ...
  template <typename DistributionIdT = Aws::String>
  DistributionTenantAssociationFilter& WithDistributionId(DistributionIdT&& value) {
  ...
  template <typename ConnectionGroupIdT = Aws::String>
  DistributionTenantAssociationFilter& WithConnectionGroupId(ConnectionGroupIdT&& value) {
