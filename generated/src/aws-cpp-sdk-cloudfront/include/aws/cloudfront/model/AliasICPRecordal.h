...
class AliasICPRecordal {
 public:
  ...
  template <typename CNAMET = Aws::String>
  AliasICPRecordal& WithCNAME(CNAMET&& value) {
  ...
  inline void SetICPRecordalStatus(ICPRecordalStatus value) {
    m_iCPRecordalStatusHasBeenSet = true;
    m_iCPRecordalStatus = value;
  }
  inline AliasICPRecordal& WithICPRecordalStatus(ICPRecordalStatus value) {
    SetICPRecordalStatus(value);
    return *this;
  }
  ///@}
 private:
