...
class ListStreamingDistributions2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API ListStreamingDistributions2020_05_31Result& operator=(
  ...
  void SetStreamingDistributionList(StreamingDistributionListT&& value) {
    m_streamingDistributionListHasBeenSet = true;
    m_streamingDistributionList = std::forward<StreamingDistributionListT>(value);
  }
  template <typename StreamingDistributionListT = StreamingDistributionList>
  ListStreamingDistributions2020_05_31Result& WithStreamingDistributionList(StreamingDistributionListT&& value) {
    SetStreamingDistributionList(std::forward<StreamingDistributionListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListStreamingDistributions2020_05_31Result& WithRequestId(RequestIdT&& value) {
