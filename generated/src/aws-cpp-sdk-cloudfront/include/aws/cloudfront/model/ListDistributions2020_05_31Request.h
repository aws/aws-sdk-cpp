...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class ListDistributions2020_05_31Request : public CloudFrontRequest
  {
  public:
    AWS_CLOUDFRONT_API ListDistributions2020_05_31Request() = default;
    ...
    template<typename MarkerT = Aws::String>
    ListDistributions2020_05_31Request& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename MaxItemsT = Aws::String>
    ListDistributions2020_05_31Request& WithMaxItems(MaxItemsT&& value) { SetMaxItems(std::forward<MaxItemsT>(value)); return *this;}
    ///@}
  private:
