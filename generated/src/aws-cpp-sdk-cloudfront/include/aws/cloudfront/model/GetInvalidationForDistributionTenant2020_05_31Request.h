...
class GetInvalidationForDistributionTenant2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename DistributionTenantIdT = Aws::String>
  GetInvalidationForDistributionTenant2020_05_31Request& WithDistributionTenantId(DistributionTenantIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetInvalidationForDistributionTenant2020_05_31Request& WithId(IdT&& value) {
