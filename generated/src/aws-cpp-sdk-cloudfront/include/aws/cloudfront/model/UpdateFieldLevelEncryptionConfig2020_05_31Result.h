...
namespace Model
{
  ...
  public:
    ...
    template<typename FieldLevelEncryptionT = FieldLevelEncryption>
    UpdateFieldLevelEncryptionConfig2020_05_31Result& WithFieldLevelEncryption(FieldLevelEncryptionT&& value) { SetFieldLevelEncryption(std::forward<FieldLevelEncryptionT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    UpdateFieldLevelEncryptionConfig2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFieldLevelEncryptionConfig2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
