...
class UpdateFieldLevelEncryptionConfig2020_05_31Result {
 public:
  AWS_CLOUDFRONT_API UpdateFieldLevelEncryptionConfig2020_05_31Result() = default;
  AWS_CLOUDFRONT_API UpdateFieldLevelEncryptionConfig2020_05_31Result(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_CLOUDFRONT_API UpdateFieldLevelEncryptionConfig2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename FieldLevelEncryptionT = FieldLevelEncryption>
  UpdateFieldLevelEncryptionConfig2020_05_31Result& WithFieldLevelEncryption(FieldLevelEncryptionT&& value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateFieldLevelEncryptionConfig2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFieldLevelEncryptionConfig2020_05_31Result& WithRequestId(RequestIdT&& value) {
