...
class GetFieldLevelEncryptionProfile2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetFieldLevelEncryptionProfile2020_05_31Result& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename FieldLevelEncryptionProfileT = FieldLevelEncryptionProfile>
  GetFieldLevelEncryptionProfile2020_05_31Result& WithFieldLevelEncryptionProfile(FieldLevelEncryptionProfileT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetFieldLevelEncryptionProfile2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFieldLevelEncryptionProfile2020_05_31Result& WithRequestId(RequestIdT&& value) {
