...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API DeleteContinuousDeploymentPolicy2020_05_31Request() = default;
    ...
    template<typename IdT = Aws::String>
    DeleteContinuousDeploymentPolicy2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename IfMatchT = Aws::String>
    DeleteContinuousDeploymentPolicy2020_05_31Request& WithIfMatch(IfMatchT&& value) { SetIfMatch(std::forward<IfMatchT>(value)); return *this;}
    ///@}
  private:
