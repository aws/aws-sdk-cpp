...
class GetFieldLevelEncryption2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetFieldLevelEncryption2020_05_31Result& operator=(
  ...
  template <typename FieldLevelEncryptionT = FieldLevelEncryption>
  GetFieldLevelEncryption2020_05_31Result& WithFieldLevelEncryption(FieldLevelEncryptionT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetFieldLevelEncryption2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFieldLevelEncryption2020_05_31Result& WithRequestId(RequestIdT&& value) {
