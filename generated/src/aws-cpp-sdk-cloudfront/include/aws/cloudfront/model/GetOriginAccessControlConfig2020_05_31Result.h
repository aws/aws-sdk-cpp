...
class GetOriginAccessControlConfig2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetOriginAccessControlConfig2020_05_31Result& operator=(
  ...
  void SetOriginAccessControlConfig(OriginAccessControlConfigT&& value) {
    m_originAccessControlConfigHasBeenSet = true;
    m_originAccessControlConfig = std::forward<OriginAccessControlConfigT>(value);
  }
  template <typename OriginAccessControlConfigT = OriginAccessControlConfig>
  GetOriginAccessControlConfig2020_05_31Result& WithOriginAccessControlConfig(OriginAccessControlConfigT&& value) {
    SetOriginAccessControlConfig(std::forward<OriginAccessControlConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ETagT = Aws::String>
  GetOriginAccessControlConfig2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOriginAccessControlConfig2020_05_31Result& WithRequestId(RequestIdT&& value) {
