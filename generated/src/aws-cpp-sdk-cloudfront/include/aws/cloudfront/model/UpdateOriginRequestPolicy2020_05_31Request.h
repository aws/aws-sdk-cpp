...
class UpdateOriginRequestPolicy2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename OriginRequestPolicyConfigT = OriginRequestPolicyConfig>
  UpdateOriginRequestPolicy2020_05_31Request& WithOriginRequestPolicyConfig(OriginRequestPolicyConfigT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateOriginRequestPolicy2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  UpdateOriginRequestPolicy2020_05_31Request& WithIfMatch(IfMatchT&& value) {
