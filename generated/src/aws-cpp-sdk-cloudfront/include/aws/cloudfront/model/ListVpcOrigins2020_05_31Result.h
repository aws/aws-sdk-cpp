...
class ListVpcOrigins2020_05_31Result {
 public:
  ...
  void SetVpcOriginList(VpcOriginListT&& value) {
    m_vpcOriginListHasBeenSet = true;
    m_vpcOriginList = std::forward<VpcOriginListT>(value);
  }
  template <typename VpcOriginListT = VpcOriginList>
  ListVpcOrigins2020_05_31Result& WithVpcOriginList(VpcOriginListT&& value) {
    SetVpcOriginList(std::forward<VpcOriginListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListVpcOrigins2020_05_31Result& WithRequestId(RequestIdT&& value) {
