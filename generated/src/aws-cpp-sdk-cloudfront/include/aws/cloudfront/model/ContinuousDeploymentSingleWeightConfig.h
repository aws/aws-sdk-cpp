...
class ContinuousDeploymentSingleWeightConfig {
 public:
  ...
  inline ContinuousDeploymentSingleWeightConfig& WithWeight(double value) {
    SetWeight(value);
    return *this;
  }
  ///@}
  ...
  void SetSessionStickinessConfig(SessionStickinessConfigT&& value) {
    ...
    m_sessionStickinessConfig = std::forward<SessionStickinessConfigT>(value);
  }
  template <typename SessionStickinessConfigT = SessionStickinessConfig>
  ContinuousDeploymentSingleWeightConfig& WithSessionStickinessConfig(SessionStickinessConfigT&& value) {
    SetSessionStickinessConfig(std::forward<SessionStickinessConfigT>(value));
    return *this;
  }
  ///@}
 private:
