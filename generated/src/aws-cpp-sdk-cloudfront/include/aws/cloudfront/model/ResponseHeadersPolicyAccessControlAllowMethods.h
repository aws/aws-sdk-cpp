...
class ResponseHeadersPolicyAccessControlAllowMethods {
 public:
  ...
  inline ResponseHeadersPolicyAccessControlAllowMethods& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  template <typename ItemsT = Aws::Vector<ResponseHeadersPolicyAccessControlAllowMethodsValues>>
  ResponseHeadersPolicyAccessControlAllowMethods& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  inline ResponseHeadersPolicyAccessControlAllowMethods& AddItems(ResponseHeadersPolicyAccessControlAllowMethodsValues value) {
    m_itemsHasBeenSet = true;
