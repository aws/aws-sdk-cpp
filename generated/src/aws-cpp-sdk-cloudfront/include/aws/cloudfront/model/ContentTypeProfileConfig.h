...
class ContentTypeProfileConfig {
 public:
  ...
  inline void SetForwardWhenContentTypeIsUnknown(bool value) {
    m_forwardWhenContentTypeIsUnknownHasBeenSet = true;
    m_forwardWhenContentTypeIsUnknown = value;
  }
  inline ContentTypeProfileConfig& WithForwardWhenContentTypeIsUnknown(bool value) {
    SetForwardWhenContentTypeIsUnknown(value);
    return *this;
  }
  ///@}
  ...
  void SetContentTypeProfiles(ContentTypeProfilesT&& value) {
    m_contentTypeProfilesHasBeenSet = true;
    m_contentTypeProfiles = std::forward<ContentTypeProfilesT>(value);
  }
  template <typename ContentTypeProfilesT = ContentTypeProfiles>
  ContentTypeProfileConfig& WithContentTypeProfiles(ContentTypeProfilesT&& value) {
    SetContentTypeProfiles(std::forward<ContentTypeProfilesT>(value));
    return *this;
  }
  ///@}
 private:
