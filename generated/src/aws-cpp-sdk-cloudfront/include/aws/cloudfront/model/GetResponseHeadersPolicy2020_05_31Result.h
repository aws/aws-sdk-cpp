...
class GetResponseHeadersPolicy2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetResponseHeadersPolicy2020_05_31Result& operator=(
  ...
  template <typename ResponseHeadersPolicyT = ResponseHeadersPolicy>
  GetResponseHeadersPolicy2020_05_31Result& WithResponseHeadersPolicy(ResponseHeadersPolicyT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetResponseHeadersPolicy2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetResponseHeadersPolicy2020_05_31Result& WithRequestId(RequestIdT&& value) {
