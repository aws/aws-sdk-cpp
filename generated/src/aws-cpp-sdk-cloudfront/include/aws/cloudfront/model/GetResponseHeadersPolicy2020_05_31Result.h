...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API GetResponseHeadersPolicy2020_05_31Result() = default;
    ...
    template<typename ResponseHeadersPolicyT = ResponseHeadersPolicy>
    GetResponseHeadersPolicy2020_05_31Result& WithResponseHeadersPolicy(ResponseHeadersPolicyT&& value) { SetResponseHeadersPolicy(std::forward<ResponseHeadersPolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    GetResponseHeadersPolicy2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetResponseHeadersPolicy2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
