...
class UpdateOriginAccessControl2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API UpdateOriginAccessControl2020_05_31Result& operator=(
  ...
  void SetOriginAccessControl(OriginAccessControlT&& value) {
    m_originAccessControlHasBeenSet = true;
    m_originAccessControl = std::forward<OriginAccessControlT>(value);
  }
  template <typename OriginAccessControlT = OriginAccessControl>
  UpdateOriginAccessControl2020_05_31Result& WithOriginAccessControl(OriginAccessControlT&& value) {
    SetOriginAccessControl(std::forward<OriginAccessControlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ETagT = Aws::String>
  UpdateOriginAccessControl2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateOriginAccessControl2020_05_31Result& WithRequestId(RequestIdT&& value) {
