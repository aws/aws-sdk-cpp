...
struct ListDistributionsByTrustStorePaginationTraits {
  using RequestType = Model::ListDistributionsByTrustStore2020_05_31Request;
  using ResultType = Model::ListDistributionsByTrustStore2020_05_31Result;
  using OutcomeType = Model::ListDistributionsByTrustStore2020_05_31Outcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListDistributionsByTrustStore2020_05_31(request); }
