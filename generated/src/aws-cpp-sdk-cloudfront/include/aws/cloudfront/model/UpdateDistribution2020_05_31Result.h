...
class UpdateDistribution2020_05_31Result {
 public:
  ...
  template <typename DistributionT = Distribution>
  UpdateDistribution2020_05_31Result& WithDistribution(DistributionT&& value) {
  ...
  template <typename ETagT = Aws::String>
  UpdateDistribution2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDistribution2020_05_31Result& WithRequestId(RequestIdT&& value) {
