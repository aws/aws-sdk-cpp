...
class ManagedCertificateDetails {
 public:
  ...
  inline void SetCertificateStatus(ManagedCertificateStatus value) {
    m_certificateStatusHasBeenSet = true;
    m_certificateStatus = value;
  }
  inline ManagedCertificateDetails& WithCertificateStatus(ManagedCertificateStatus value) {
  ...
  inline void SetValidationTokenHost(ValidationTokenHost value) {
    m_validationTokenHostHasBeenSet = true;
    m_validationTokenHost = value;
  }
  inline ManagedCertificateDetails& WithValidationTokenHost(ValidationTokenHost value) {
    SetValidationTokenHost(value);
    return *this;
  }
  ///@}
  ...
  void SetValidationTokenDetails(ValidationTokenDetailsT&& value) {
    ...
    m_validationTokenDetails = std::forward<ValidationTokenDetailsT>(value);
  }
  template <typename ValidationTokenDetailsT = Aws::Vector<ValidationTokenDetail>>
  ManagedCertificateDetails& WithValidationTokenDetails(ValidationTokenDetailsT&& value) {
    SetValidationTokenDetails(std::forward<ValidationTokenDetailsT>(value));
    return *this;
  }
  ...
  ManagedCertificateDetails& AddValidationTokenDetails(ValidationTokenDetailsT&& value) {
    m_validationTokenDetailsHasBeenSet = true;
    m_validationTokenDetails.emplace_back(std::forward<ValidationTokenDetailsT>(value));
    return *this;
  }
  ///@}
 private:
