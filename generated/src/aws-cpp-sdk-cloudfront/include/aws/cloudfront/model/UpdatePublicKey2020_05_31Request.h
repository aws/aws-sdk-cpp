...
namespace Model
{
  ...
  public:
    ...
    template<typename PublicKeyConfigT = PublicKeyConfig>
    UpdatePublicKey2020_05_31Request& WithPublicKeyConfig(PublicKeyConfigT&& value) { SetPublicKeyConfig(std::forward<PublicKeyConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    UpdatePublicKey2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename IfMatchT = Aws::String>
    UpdatePublicKey2020_05_31Request& WithIfMatch(IfMatchT&& value) { SetIfMatch(std::forward<IfMatchT>(value)); return *this;}
    ///@}
  private:
