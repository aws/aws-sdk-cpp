...
class UpdateKeyValueStore2020_05_31Request : public CloudFrontRequest {
 public:
  AWS_CLOUDFRONT_API UpdateKeyValueStore2020_05_31Request() = default;
  ...
  template <typename NameT = Aws::String>
  UpdateKeyValueStore2020_05_31Request& WithName(NameT&& value) {
  ...
  template <typename CommentT = Aws::String>
  UpdateKeyValueStore2020_05_31Request& WithComment(CommentT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  UpdateKeyValueStore2020_05_31Request& WithIfMatch(IfMatchT&& value) {
