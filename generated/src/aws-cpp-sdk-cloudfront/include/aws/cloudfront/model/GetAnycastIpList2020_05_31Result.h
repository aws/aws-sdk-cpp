...
class GetAnycastIpList2020_05_31Result {
 public:
  ...
  template <typename AnycastIpListT = AnycastIpList>
  GetAnycastIpList2020_05_31Result& WithAnycastIpList(AnycastIpListT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetAnycastIpList2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAnycastIpList2020_05_31Result& WithRequestId(RequestIdT&& value) {
