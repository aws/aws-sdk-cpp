...
class CreateAnycastIpList2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API CreateAnycastIpList2020_05_31Result& operator=(
  ...
  template <typename AnycastIpListT = AnycastIpList>
  CreateAnycastIpList2020_05_31Result& WithAnycastIpList(AnycastIpListT&& value) {
  ...
  template <typename ETagT = Aws::String>
  CreateAnycastIpList2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAnycastIpList2020_05_31Result& WithRequestId(RequestIdT&& value) {
