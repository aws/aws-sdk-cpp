...
class ListDistributionsByWebACLId2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListDistributionsByWebACLId2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListDistributionsByWebACLId2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename WebACLIdT = Aws::String>
  ListDistributionsByWebACLId2020_05_31Request& WithWebACLId(WebACLIdT&& value) {
