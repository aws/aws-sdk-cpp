...
class PublishFunction2020_05_31Result {
 public:
  ...
  void SetFunctionSummary(FunctionSummaryT&& value) {
    ...
    m_functionSummary = std::forward<FunctionSummaryT>(value);
  }
  template <typename FunctionSummaryT = FunctionSummary>
  PublishFunction2020_05_31Result& WithFunctionSummary(FunctionSummaryT&& value) {
    SetFunctionSummary(std::forward<FunctionSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PublishFunction2020_05_31Result& WithRequestId(RequestIdT&& value) {
