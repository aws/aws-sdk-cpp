...
class OriginRequestPolicyQueryStringsConfig {
 public:
  ...
  inline void SetQueryStringBehavior(OriginRequestPolicyQueryStringBehavior value) {
    m_queryStringBehaviorHasBeenSet = true;
    m_queryStringBehavior = value;
  }
  inline OriginRequestPolicyQueryStringsConfig& WithQueryStringBehavior(OriginRequestPolicyQueryStringBehavior value) {
  ...
  template <typename QueryStringsT = QueryStringNames>
  OriginRequestPolicyQueryStringsConfig& WithQueryStrings(QueryStringsT&& value) {
