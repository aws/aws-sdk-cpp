...
namespace Model
{
  ...
  public:
    ...
    template<typename DistributionT = Distribution>
    CopyDistribution2020_05_31Result& WithDistribution(DistributionT&& value) { SetDistribution(std::forward<DistributionT>(value)); return *this;}
    ///@}
    ...
    template<typename LocationT = Aws::String>
    CopyDistribution2020_05_31Result& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    CopyDistribution2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CopyDistribution2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
