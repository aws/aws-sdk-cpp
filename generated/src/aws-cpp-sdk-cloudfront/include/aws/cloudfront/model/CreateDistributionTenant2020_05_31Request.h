...
class CreateDistributionTenant2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  void SetManagedCertificateRequest(ManagedCertificateRequestT&& value) {
    m_managedCertificateRequestHasBeenSet = true;
    m_managedCertificateRequest = std::forward<ManagedCertificateRequestT>(value);
  }
  template <typename ManagedCertificateRequestT = ManagedCertificateRequest>
  CreateDistributionTenant2020_05_31Request& WithManagedCertificateRequest(ManagedCertificateRequestT&& value) {
    SetManagedCertificateRequest(std::forward<ManagedCertificateRequestT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateDistributionTenant2020_05_31Request& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
