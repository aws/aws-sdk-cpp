...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DeleteCloudFrontOriginAccessIdentity2020_05_31Request : public CloudFrontRequest
  {
  public:
    AWS_CLOUDFRONT_API DeleteCloudFrontOriginAccessIdentity2020_05_31Request() = default;
    ...
    template<typename IdT = Aws::String>
    DeleteCloudFrontOriginAccessIdentity2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename IfMatchT = Aws::String>
    DeleteCloudFrontOriginAccessIdentity2020_05_31Request& WithIfMatch(IfMatchT&& value) { SetIfMatch(std::forward<IfMatchT>(value)); return *this;}
    ///@}
  private:
