...
class ListCachePolicies2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  inline void SetType(CachePolicyType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ListCachePolicies2020_05_31Request& WithType(CachePolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListCachePolicies2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListCachePolicies2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
