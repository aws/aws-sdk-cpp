...
class ListTagsForResource2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API ListTagsForResource2020_05_31Result& operator=(
  ...
  template <typename TagsT = Tags>
  ListTagsForResource2020_05_31Result& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTagsForResource2020_05_31Result& WithRequestId(RequestIdT&& value) {
