...
class ListDomainConflicts2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  ListDomainConflicts2020_05_31Request& WithDomain(DomainT&& value) {
  ...
  void SetDomainControlValidationResource(DomainControlValidationResourceT&& value) {
    m_domainControlValidationResourceHasBeenSet = true;
    m_domainControlValidationResource = std::forward<DomainControlValidationResourceT>(value);
  }
  template <typename DomainControlValidationResourceT = DistributionResourceId>
  ListDomainConflicts2020_05_31Request& WithDomainControlValidationResource(DomainControlValidationResourceT&& value) {
    SetDomainControlValidationResource(std::forward<DomainControlValidationResourceT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListDomainConflicts2020_05_31Request& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListDomainConflicts2020_05_31Request& WithMarker(MarkerT&& value) {
