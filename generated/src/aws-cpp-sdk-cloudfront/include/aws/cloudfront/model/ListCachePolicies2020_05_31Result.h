...
class ListCachePolicies2020_05_31Result {
 public:
  ...
  void SetCachePolicyList(CachePolicyListT&& value) {
    m_cachePolicyListHasBeenSet = true;
    m_cachePolicyList = std::forward<CachePolicyListT>(value);
  }
  template <typename CachePolicyListT = CachePolicyList>
  ListCachePolicies2020_05_31Result& WithCachePolicyList(CachePolicyListT&& value) {
    SetCachePolicyList(std::forward<CachePolicyListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCachePolicies2020_05_31Result& WithRequestId(RequestIdT&& value) {
