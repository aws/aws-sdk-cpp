...
class AssociateDistributionTenantWebACL2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  AssociateDistributionTenantWebACL2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename WebACLArnT = Aws::String>
  AssociateDistributionTenantWebACL2020_05_31Request& WithWebACLArn(WebACLArnT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  AssociateDistributionTenantWebACL2020_05_31Request& WithIfMatch(IfMatchT&& value) {
