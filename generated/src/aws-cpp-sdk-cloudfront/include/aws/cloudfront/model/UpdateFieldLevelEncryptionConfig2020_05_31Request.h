...
class UpdateFieldLevelEncryptionConfig2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename FieldLevelEncryptionConfigT = FieldLevelEncryptionConfig>
  UpdateFieldLevelEncryptionConfig2020_05_31Request& WithFieldLevelEncryptionConfig(FieldLevelEncryptionConfigT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateFieldLevelEncryptionConfig2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  UpdateFieldLevelEncryptionConfig2020_05_31Request& WithIfMatch(IfMatchT&& value) {
