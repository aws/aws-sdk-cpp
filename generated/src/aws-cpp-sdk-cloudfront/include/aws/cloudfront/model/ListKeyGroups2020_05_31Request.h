...
namespace Model
{
  ...
  /**
   */
  class ListKeyGroups2020_05_31Request : public CloudFrontRequest
  {
  public:
    AWS_CLOUDFRONT_API ListKeyGroups2020_05_31Request() = default;
    ...
    template<typename MarkerT = Aws::String>
    ListKeyGroups2020_05_31Request& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename MaxItemsT = Aws::String>
    ListKeyGroups2020_05_31Request& WithMaxItems(MaxItemsT&& value) { SetMaxItems(std::forward<MaxItemsT>(value)); return *this;}
    ///@}
  private:
