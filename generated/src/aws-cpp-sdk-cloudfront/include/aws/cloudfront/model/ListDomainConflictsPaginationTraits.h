...
struct ListDomainConflictsPaginationTraits {
  using RequestType = Model::ListDomainConflicts2020_05_31Request;
  using ResultType = Model::ListDomainConflicts2020_05_31Result;
  using OutcomeType = Model::ListDomainConflicts2020_05_31Outcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListDomainConflicts2020_05_31(request); }
