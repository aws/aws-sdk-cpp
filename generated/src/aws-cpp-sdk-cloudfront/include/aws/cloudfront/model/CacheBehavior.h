...
class CacheBehavior {
 public:
  ...
  void SetPathPattern(PathPatternT&& value) {
    ...
    m_pathPattern = std::forward<PathPatternT>(value);
  }
  template <typename PathPatternT = Aws::String>
  CacheBehavior& WithPathPattern(PathPatternT&& value) {
    SetPathPattern(std::forward<PathPatternT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetOriginId(TargetOriginIdT&& value) {
    ...
    m_targetOriginId = std::forward<TargetOriginIdT>(value);
  }
  template <typename TargetOriginIdT = Aws::String>
  CacheBehavior& WithTargetOriginId(TargetOriginIdT&& value) {
    SetTargetOriginId(std::forward<TargetOriginIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrustedSigners(TrustedSignersT&& value) {
    ...
    m_trustedSigners = std::forward<TrustedSignersT>(value);
  }
  template <typename TrustedSignersT = TrustedSigners>
  CacheBehavior& WithTrustedSigners(TrustedSignersT&& value) {
    SetTrustedSigners(std::forward<TrustedSignersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrustedKeyGroups(TrustedKeyGroupsT&& value) {
    ...
    m_trustedKeyGroups = std::forward<TrustedKeyGroupsT>(value);
  }
  template <typename TrustedKeyGroupsT = TrustedKeyGroups>
  CacheBehavior& WithTrustedKeyGroups(TrustedKeyGroupsT&& value) {
    SetTrustedKeyGroups(std::forward<TrustedKeyGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetViewerProtocolPolicy(ViewerProtocolPolicy value) {
    m_viewerProtocolPolicyHasBeenSet = true;
    m_viewerProtocolPolicy = value;
  }
  inline CacheBehavior& WithViewerProtocolPolicy(ViewerProtocolPolicy value) {
    SetViewerProtocolPolicy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSmoothStreaming(bool value) {
    m_smoothStreamingHasBeenSet = true;
    m_smoothStreaming = value;
  }
  inline CacheBehavior& WithSmoothStreaming(bool value) {
  ...
  inline void SetCompress(bool value) {
    m_compressHasBeenSet = true;
    m_compress = value;
  }
  inline CacheBehavior& WithCompress(bool value) {
    SetCompress(value);
    return *this;
  }
  ///@}
  ...
  void SetLambdaFunctionAssociations(LambdaFunctionAssociationsT&& value) {
    ...
    m_lambdaFunctionAssociations = std::forward<LambdaFunctionAssociationsT>(value);
  }
  template <typename LambdaFunctionAssociationsT = LambdaFunctionAssociations>
  CacheBehavior& WithLambdaFunctionAssociations(LambdaFunctionAssociationsT&& value) {
    SetLambdaFunctionAssociations(std::forward<LambdaFunctionAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFunctionAssociations(FunctionAssociationsT&& value) {
    ...
    m_functionAssociations = std::forward<FunctionAssociationsT>(value);
  }
  template <typename FunctionAssociationsT = FunctionAssociations>
  CacheBehavior& WithFunctionAssociations(FunctionAssociationsT&& value) {
    SetFunctionAssociations(std::forward<FunctionAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFieldLevelEncryptionId(FieldLevelEncryptionIdT&& value) {
    ...
    m_fieldLevelEncryptionId = std::forward<FieldLevelEncryptionIdT>(value);
  }
  template <typename FieldLevelEncryptionIdT = Aws::String>
  CacheBehavior& WithFieldLevelEncryptionId(FieldLevelEncryptionIdT&& value) {
    SetFieldLevelEncryptionId(std::forward<FieldLevelEncryptionIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRealtimeLogConfigArn(RealtimeLogConfigArnT&& value) {
    ...
    m_realtimeLogConfigArn = std::forward<RealtimeLogConfigArnT>(value);
  }
  template <typename RealtimeLogConfigArnT = Aws::String>
  CacheBehavior& WithRealtimeLogConfigArn(RealtimeLogConfigArnT&& value) {
    SetRealtimeLogConfigArn(std::forward<RealtimeLogConfigArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCachePolicyId(CachePolicyIdT&& value) {
    ...
    m_cachePolicyId = std::forward<CachePolicyIdT>(value);
  }
  template <typename CachePolicyIdT = Aws::String>
  CacheBehavior& WithCachePolicyId(CachePolicyIdT&& value) {
    SetCachePolicyId(std::forward<CachePolicyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOriginRequestPolicyId(OriginRequestPolicyIdT&& value) {
    ...
    m_originRequestPolicyId = std::forward<OriginRequestPolicyIdT>(value);
  }
  template <typename OriginRequestPolicyIdT = Aws::String>
  CacheBehavior& WithOriginRequestPolicyId(OriginRequestPolicyIdT&& value) {
    SetOriginRequestPolicyId(std::forward<OriginRequestPolicyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGrpcConfig(GrpcConfigT&& value) {
    ...
    m_grpcConfig = std::forward<GrpcConfigT>(value);
  }
  template <typename GrpcConfigT = GrpcConfig>
  CacheBehavior& WithGrpcConfig(GrpcConfigT&& value) {
    SetGrpcConfig(std::forward<GrpcConfigT>(value));
    return *this;
  }
  ///@}
 private:
