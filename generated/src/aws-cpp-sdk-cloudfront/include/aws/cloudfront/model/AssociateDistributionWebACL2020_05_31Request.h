...
class AssociateDistributionWebACL2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  AssociateDistributionWebACL2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename WebACLArnT = Aws::String>
  AssociateDistributionWebACL2020_05_31Request& WithWebACLArn(WebACLArnT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  AssociateDistributionWebACL2020_05_31Request& WithIfMatch(IfMatchT&& value) {
