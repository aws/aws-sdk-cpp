...
class ListOriginRequestPolicies2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  inline void SetType(OriginRequestPolicyType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ListOriginRequestPolicies2020_05_31Request& WithType(OriginRequestPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListOriginRequestPolicies2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListOriginRequestPolicies2020_05_31Request& WithMaxItems(MaxItemsT&& value) {
