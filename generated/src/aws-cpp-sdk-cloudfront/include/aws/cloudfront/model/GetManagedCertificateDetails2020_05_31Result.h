...
class GetManagedCertificateDetails2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetManagedCertificateDetails2020_05_31Result& operator=(
  ...
  void SetManagedCertificateDetails(ManagedCertificateDetailsT&& value) {
    m_managedCertificateDetailsHasBeenSet = true;
    m_managedCertificateDetails = std::forward<ManagedCertificateDetailsT>(value);
  }
  template <typename ManagedCertificateDetailsT = ManagedCertificateDetails>
  GetManagedCertificateDetails2020_05_31Result& WithManagedCertificateDetails(ManagedCertificateDetailsT&& value) {
    SetManagedCertificateDetails(std::forward<ManagedCertificateDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetManagedCertificateDetails2020_05_31Result& WithRequestId(RequestIdT&& value) {
