...
class CloudFrontOriginAccessIdentity {
 public:
  ...
  template <typename IdT = Aws::String>
  CloudFrontOriginAccessIdentity& WithId(IdT&& value) {
  ...
  template <typename S3CanonicalUserIdT = Aws::String>
  CloudFrontOriginAccessIdentity& WithS3CanonicalUserId(S3CanonicalUserIdT&& value) {
  ...
  template <typename CloudFrontOriginAccessIdentityConfigT = CloudFrontOriginAccessIdentityConfig>
  CloudFrontOriginAccessIdentity& WithCloudFrontOriginAccessIdentityConfig(CloudFrontOriginAccessIdentityConfigT&& value) {
