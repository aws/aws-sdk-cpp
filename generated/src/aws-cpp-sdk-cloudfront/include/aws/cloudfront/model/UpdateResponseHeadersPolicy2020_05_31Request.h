...
class UpdateResponseHeadersPolicy2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  template <typename ResponseHeadersPolicyConfigT = ResponseHeadersPolicyConfig>
  UpdateResponseHeadersPolicy2020_05_31Request& WithResponseHeadersPolicyConfig(ResponseHeadersPolicyConfigT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateResponseHeadersPolicy2020_05_31Request& WithId(IdT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  UpdateResponseHeadersPolicy2020_05_31Request& WithIfMatch(IfMatchT&& value) {
