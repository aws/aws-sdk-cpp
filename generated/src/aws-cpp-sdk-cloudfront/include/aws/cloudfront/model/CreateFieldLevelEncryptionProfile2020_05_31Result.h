...
namespace Model
{
  ...
  public:
    ...
    template<typename FieldLevelEncryptionProfileT = FieldLevelEncryptionProfile>
    CreateFieldLevelEncryptionProfile2020_05_31Result& WithFieldLevelEncryptionProfile(FieldLevelEncryptionProfileT&& value) { SetFieldLevelEncryptionProfile(std::forward<FieldLevelEncryptionProfileT>(value)); return *this;}
    ///@}
    ...
    template<typename LocationT = Aws::String>
    CreateFieldLevelEncryptionProfile2020_05_31Result& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
    ...
    template<typename ETagT = Aws::String>
    CreateFieldLevelEncryptionProfile2020_05_31Result& WithETag(ETagT&& value) { SetETag(std::forward<ETagT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateFieldLevelEncryptionProfile2020_05_31Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
