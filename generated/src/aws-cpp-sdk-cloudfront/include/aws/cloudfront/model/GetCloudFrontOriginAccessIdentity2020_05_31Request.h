...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFRONT_API GetCloudFrontOriginAccessIdentity2020_05_31Request() = default;
    ...
    template<typename IdT = Aws::String>
    GetCloudFrontOriginAccessIdentity2020_05_31Request& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
