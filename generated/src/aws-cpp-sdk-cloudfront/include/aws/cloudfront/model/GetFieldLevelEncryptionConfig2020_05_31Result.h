...
class GetFieldLevelEncryptionConfig2020_05_31Result {
 public:
  ...
  AWS_CLOUDFRONT_API GetFieldLevelEncryptionConfig2020_05_31Result& operator=(
  ...
  template <typename FieldLevelEncryptionConfigT = FieldLevelEncryptionConfig>
  GetFieldLevelEncryptionConfig2020_05_31Result& WithFieldLevelEncryptionConfig(FieldLevelEncryptionConfigT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetFieldLevelEncryptionConfig2020_05_31Result& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFieldLevelEncryptionConfig2020_05_31Result& WithRequestId(RequestIdT&& value) {
