...
class QueryArgProfileConfig {
 public:
  ...
  inline void SetForwardWhenQueryArgProfileIsUnknown(bool value) {
    m_forwardWhenQueryArgProfileIsUnknownHasBeenSet = true;
    m_forwardWhenQueryArgProfileIsUnknown = value;
  }
  inline QueryArgProfileConfig& WithForwardWhenQueryArgProfileIsUnknown(bool value) {
    SetForwardWhenQueryArgProfileIsUnknown(value);
    return *this;
  }
  ///@}
  ...
  void SetQueryArgProfiles(QueryArgProfilesT&& value) {
    ...
    m_queryArgProfiles = std::forward<QueryArgProfilesT>(value);
  }
  template <typename QueryArgProfilesT = QueryArgProfiles>
  QueryArgProfileConfig& WithQueryArgProfiles(QueryArgProfilesT&& value) {
    SetQueryArgProfiles(std::forward<QueryArgProfilesT>(value));
    return *this;
  }
  ///@}
 private:
