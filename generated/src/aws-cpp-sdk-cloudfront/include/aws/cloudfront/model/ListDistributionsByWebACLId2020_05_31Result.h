...
class ListDistributionsByWebACLId2020_05_31Result {
 public:
  AWS_CLOUDFRONT_API ListDistributionsByWebACLId2020_05_31Result() = default;
  ...
  AWS_CLOUDFRONT_API ListDistributionsByWebACLId2020_05_31Result& operator=(
  ...
  template <typename DistributionListT = DistributionList>
  ListDistributionsByWebACLId2020_05_31Result& WithDistributionList(DistributionListT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDistributionsByWebACLId2020_05_31Result& WithRequestId(RequestIdT&& value) {
