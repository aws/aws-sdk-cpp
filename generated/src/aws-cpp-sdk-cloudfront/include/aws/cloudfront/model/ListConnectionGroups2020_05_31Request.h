...
class ListConnectionGroups2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  void SetAssociationFilter(AssociationFilterT&& value) {
    m_associationFilterHasBeenSet = true;
    m_associationFilter = std::forward<AssociationFilterT>(value);
  }
  template <typename AssociationFilterT = ConnectionGroupAssociationFilter>
  ListConnectionGroups2020_05_31Request& WithAssociationFilter(AssociationFilterT&& value) {
    SetAssociationFilter(std::forward<AssociationFilterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListConnectionGroups2020_05_31Request& WithMarker(MarkerT&& value) {
  ...
  inline ListConnectionGroups2020_05_31Request& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
