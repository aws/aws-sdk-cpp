...
static const int TOO_MANY_DISTRIBUTIONS_WITH_FUNCTION_ASSOCIATIONS_HASH =
    HashingUtils::HashString("TooManyDistributionsWithFunctionAssociations");
...
static const int TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_ORIGIN_ACCESS_CONTROL_HASH =
...
static const int TOO_MANY_FIELD_LEVEL_ENCRYPTION_QUERY_ARG_PROFILES_HASH =
    HashingUtils::HashString("TooManyFieldLevelEncryptionQueryArgProfiles");
...
static const int TOO_MANY_DISTRIBUTIONS_WITH_LAMBDA_ASSOCIATIONS_HASH =
    HashingUtils::HashString("TooManyDistributionsWithLambdaAssociations");
...
static const int TOO_MANY_QUERY_STRINGS_IN_ORIGIN_REQUEST_POLICY_HASH =
    HashingUtils::HashString("TooManyQueryStringsInOriginRequestPolicy");
...
static const int TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_ORIGIN_REQUEST_POLICY_HASH =
    HashingUtils::HashString("TooManyDistributionsAssociatedToOriginRequestPolicy");
...
static const int CLOUD_FRONT_ORIGIN_ACCESS_IDENTITY_ALREADY_EXISTS_HASH =
    HashingUtils::HashString("CloudFrontOriginAccessIdentityAlreadyExists");
...
static const int TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_CACHE_POLICY_HASH =
    HashingUtils::HashString("TooManyDistributionsAssociatedToCachePolicy");
...
static const int TOO_MANY_FIELD_LEVEL_ENCRYPTION_CONTENT_TYPE_PROFILES_HASH =
    HashingUtils::HashString("TooManyFieldLevelEncryptionContentTypeProfiles");
static const int TOO_MANY_FIELD_LEVEL_ENCRYPTION_ENCRYPTION_ENTITIES_HASH =
    HashingUtils::HashString("TooManyFieldLevelEncryptionEncryptionEntities");
...
static const int TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_RESPONSE_HEADERS_POLICY_HASH =
    HashingUtils::HashString("TooManyDistributionsAssociatedToResponseHeadersPolicy");
...
static const int TOO_MANY_DISTRIBUTIONS_WITH_SINGLE_FUNCTION_A_R_N_HASH =
...
static const int TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_FIELD_LEVEL_ENCRYPTION_CONFIG_HASH =
    HashingUtils::HashString("TooManyDistributionsAssociatedToFieldLevelEncryptionConfig");
...
static const int TOO_MANY_REMOVE_HEADERS_IN_RESPONSE_HEADERS_POLICY_HASH =
...
static const int TOO_MANY_CUSTOM_HEADERS_IN_RESPONSE_HEADERS_POLICY_HASH =
    HashingUtils::HashString("TooManyCustomHeadersInResponseHeadersPolicy");
...
static bool GetErrorForNameHelper0(int hashCode, AWSError<CoreErrors>& error) {
  if (hashCode == RESOURCE_IN_USE_HASH) {
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_STREAMING_DISTRIBUTION_C_N_A_M_ES),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == ORIGIN_REQUEST_POLICY_ALREADY_EXISTS_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::ORIGIN_REQUEST_POLICY_ALREADY_EXISTS), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::FIELD_LEVEL_ENCRYPTION_CONFIG_ALREADY_EXISTS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_HEADERS_IN_FORWARDED_VALUES), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_COOKIES_IN_ORIGIN_REQUEST_POLICY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::REALTIME_LOG_CONFIG_OWNER_MISMATCH), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::MONITORING_SUBSCRIPTION_ALREADY_EXISTS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == REALTIME_LOG_CONFIG_ALREADY_EXISTS_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::REALTIME_LOG_CONFIG_ALREADY_EXISTS), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_DISTRIBUTIONS_WITH_FUNCTION_ASSOCIATIONS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_ORIGIN_ACCESS_CONTROL),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::NO_SUCH_FIELD_LEVEL_ENCRYPTION_PROFILE),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_CLOUD_FRONT_ORIGIN_ACCESS_IDENTITIES),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::FIELD_LEVEL_ENCRYPTION_PROFILE_ALREADY_EXISTS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_HEADERS_IN_ORIGIN_REQUEST_POLICY_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_HEADERS_IN_ORIGIN_REQUEST_POLICY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == CONTINUOUS_DEPLOYMENT_POLICY_IN_USE_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::CONTINUOUS_DEPLOYMENT_POLICY_IN_USE), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == CONTINUOUS_DEPLOYMENT_POLICY_ALREADY_EXISTS_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::CONTINUOUS_DEPLOYMENT_POLICY_ALREADY_EXISTS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_KEY_GROUPS_ASSOCIATED_TO_DISTRIBUTION_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_KEY_GROUPS_ASSOCIATED_TO_DISTRIBUTION),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::INVALID_GEO_RESTRICTION_PARAMETER), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_FIELD_LEVEL_ENCRYPTION_PROFILES),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == RESPONSE_HEADERS_POLICY_ALREADY_EXISTS_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::RESPONSE_HEADERS_POLICY_ALREADY_EXISTS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_FIELD_LEVEL_ENCRYPTION_FIELD_PATTERNS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_FIELD_LEVEL_ENCRYPTION_QUERY_ARG_PROFILES),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_RESPONSE_HEADERS_POLICIES), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_DISTRIBUTIONS_WITH_LAMBDA_ASSOCIATIONS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_LAMBDA_FUNCTION_ASSOCIATIONS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_QUERY_STRINGS_IN_ORIGIN_REQUEST_POLICY_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_QUERY_STRINGS_IN_ORIGIN_REQUEST_POLICY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_CONTINUOUS_DEPLOYMENT_POLICIES),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(
        static_cast<CoreErrors>(CloudFrontErrors::ILLEGAL_FIELD_LEVEL_ENCRYPTION_CONFIG_ASSOCIATION_WITH_CACHE_BEHAVIOR),
        RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_LONG_C_S_P_IN_RESPONSE_HEADERS_POLICY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_FIELD_LEVEL_ENCRYPTION_CONFIGS_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_FIELD_LEVEL_ENCRYPTION_CONFIGS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::NO_SUCH_CONTINUOUS_DEPLOYMENT_POLICY), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_QUERY_STRINGS_IN_CACHE_POLICY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::FIELD_LEVEL_ENCRYPTION_PROFILE_SIZE_EXCEEDED),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_ORIGIN_GROUPS_PER_DISTRIBUTION),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::FIELD_LEVEL_ENCRYPTION_CONFIG_IN_USE), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_ORIGIN_REQUEST_POLICY_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_ORIGIN_REQUEST_POLICY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == FIELD_LEVEL_ENCRYPTION_PROFILE_IN_USE_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::FIELD_LEVEL_ENCRYPTION_PROFILE_IN_USE),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_INVALIDATIONS_IN_PROGRESS_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_INVALIDATIONS_IN_PROGRESS), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_PUBLIC_KEYS_IN_KEY_GROUP), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::ORIGIN_ACCESS_CONTROL_ALREADY_EXISTS), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == NO_SUCH_FIELD_LEVEL_ENCRYPTION_CONFIG_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::NO_SUCH_FIELD_LEVEL_ENCRYPTION_CONFIG),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::STREAMING_DISTRIBUTION_NOT_DISABLED), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::NO_SUCH_CLOUD_FRONT_ORIGIN_ACCESS_IDENTITY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == CLOUD_FRONT_ORIGIN_ACCESS_IDENTITY_ALREADY_EXISTS_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::CLOUD_FRONT_ORIGIN_ACCESS_IDENTITY_ALREADY_EXISTS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::ILLEGAL_ORIGIN_ACCESS_CONFIGURATION), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_CACHE_POLICY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_COOKIE_NAMES_IN_WHITE_LIST), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::INVALID_DOMAIN_NAME_FOR_ORIGIN_ACCESS_CONTROL),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == INVALID_LAMBDA_FUNCTION_ASSOCIATION_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::INVALID_LAMBDA_FUNCTION_ASSOCIATION), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_FIELD_LEVEL_ENCRYPTION_CONTENT_TYPE_PROFILES_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_FIELD_LEVEL_ENCRYPTION_CONTENT_TYPE_PROFILES),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_FIELD_LEVEL_ENCRYPTION_ENCRYPTION_ENTITIES_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_FIELD_LEVEL_ENCRYPTION_ENCRYPTION_ENTITIES),
                                 RetryableType::NOT_RETRYABLE);
    return true;
...
static bool GetErrorForNameHelper1(int hashCode, AWSError<CoreErrors>& error) {
  if (hashCode == INVALID_PROTOCOL_SETTINGS_HASH) {
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::CANNOT_DELETE_ENTITY_WHILE_IN_USE), RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_RESPONSE_HEADERS_POLICY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_KEY_GROUP_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_KEY_GROUP),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == STREAMING_DISTRIBUTION_ALREADY_EXISTS_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::STREAMING_DISTRIBUTION_ALREADY_EXISTS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_DISTRIBUTIONS_WITH_SINGLE_FUNCTION_A_R_N),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::CANNOT_CHANGE_IMMUTABLE_PUBLIC_KEY_FIELDS),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_FIELD_LEVEL_ENCRYPTION_CONFIG_HASH) {
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_DISTRIBUTIONS_ASSOCIATED_TO_FIELD_LEVEL_ENCRYPTION_CONFIG),
                             RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_REMOVE_HEADERS_IN_RESPONSE_HEADERS_POLICY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
    ...
    error =
        AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::CANNOT_UPDATE_ENTITY_WHILE_IN_USE), RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == CLOUD_FRONT_ORIGIN_ACCESS_IDENTITY_IN_USE_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::CLOUD_FRONT_ORIGIN_ACCESS_IDENTITY_IN_USE),
                                 RetryableType::NOT_RETRYABLE);
    return true;
  } else if (hashCode == TOO_MANY_CUSTOM_HEADERS_IN_RESPONSE_HEADERS_POLICY_HASH) {
    error = AWSError<CoreErrors>(static_cast<CoreErrors>(CloudFrontErrors::TOO_MANY_CUSTOM_HEADERS_IN_RESPONSE_HEADERS_POLICY),
                                 RetryableType::NOT_RETRYABLE);
    return true;
