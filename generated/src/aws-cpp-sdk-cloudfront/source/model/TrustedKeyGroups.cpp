...
TrustedKeyGroups::TrustedKeyGroups(const XmlNode& xmlNode) { *this = xmlNode; }

TrustedKeyGroups& TrustedKeyGroups::operator=(const XmlNode& xmlNode) {
...
void TrustedKeyGroups::AddToNode(XmlNode& parentNode) const {
  Aws::StringStream ss;
