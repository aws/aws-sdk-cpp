...
ManagedCertificateDetails::ManagedCertificateDetails(const XmlNode& xmlNode) { *this = xmlNode; }
...
ManagedCertificateDetails& ManagedCertificateDetails::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!certificateStatusNode.IsNull()) {
      m_certificateStatus = ManagedCertificateStatusMapper::GetManagedCertificateStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(certificateStatusNode.GetText()).c_str()));
    ...
    if (!validationTokenHostNode.IsNull()) {
      m_validationTokenHost = ValidationTokenHostMapper::GetValidationTokenHostForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(validationTokenHostNode.GetText()).c_str()));
