...
ConnectionGroupSummary::ConnectionGroupSummary(const XmlNode& xmlNode)
{
  *this = xmlNode;
}

ConnectionGroupSummary& ConnectionGroupSummary::operator =(const XmlNode& xmlNode)
{
...
void ConnectionGroupSummary::AddToNode(XmlNode& parentNode) const
{
  Aws::StringStream ss;
  if(m_idHasBeenSet)
  {
