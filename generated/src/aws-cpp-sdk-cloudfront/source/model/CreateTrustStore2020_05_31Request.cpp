...
Aws::String CreateTrustStore2020_05_31Request::SerializePayload() const {
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("CreateTrustStoreRequest");
  ...
  if (m_caCertificatesBundleSourceHasBeenSet) {
    XmlNode caCertificatesBundleSourceNode = parentNode.CreateChildElement("CaCertificatesBundleSource");
