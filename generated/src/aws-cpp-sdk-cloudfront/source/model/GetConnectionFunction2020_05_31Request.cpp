...
Aws::String GetConnectionFunction2020_05_31Request::SerializePayload() const { return {}; }

void GetConnectionFunction2020_05_31Request::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
