...
Origin::Origin(const XmlNode& xmlNode) { *this = xmlNode; }
...
Origin& Origin::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!connectionAttemptsNode.IsNull()) {
      m_connectionAttempts = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(connectionAttemptsNode.GetText()).c_str()).c_str());
    ...
    if (!connectionTimeoutNode.IsNull()) {
      m_connectionTimeout = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(connectionTimeoutNode.GetText()).c_str()).c_str());
    ...
    if (!responseCompletionTimeoutNode.IsNull()) {
      m_responseCompletionTimeout = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(responseCompletionTimeoutNode.GetText()).c_str()).c_str());
