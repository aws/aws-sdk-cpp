...
ResponseHeadersPolicySummary::ResponseHeadersPolicySummary(const XmlNode& xmlNode) { *this = xmlNode; }
...
ResponseHeadersPolicySummary& ResponseHeadersPolicySummary::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!typeNode.IsNull()) {
      m_type = ResponseHeadersPolicyTypeMapper::GetResponseHeadersPolicyTypeForName(
