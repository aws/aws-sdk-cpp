...
ResponseHeadersPolicyCorsConfig::ResponseHeadersPolicyCorsConfig(const XmlNode& xmlNode) { *this = xmlNode; }
...
ResponseHeadersPolicyCorsConfig& ResponseHeadersPolicyCorsConfig::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!accessControlAllowCredentialsNode.IsNull()) {
      m_accessControlAllowCredentials = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(accessControlAllowCredentialsNode.GetText()).c_str()).c_str());
    ...
    if (!accessControlMaxAgeSecNode.IsNull()) {
      m_accessControlMaxAgeSec = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(accessControlMaxAgeSecNode.GetText()).c_str()).c_str());
    ...
    if (!originOverrideNode.IsNull()) {
      m_originOverride = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(originOverrideNode.GetText()).c_str()).c_str());
