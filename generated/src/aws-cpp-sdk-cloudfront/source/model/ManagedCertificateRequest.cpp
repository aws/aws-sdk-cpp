...
ManagedCertificateRequest::ManagedCertificateRequest(const XmlNode& xmlNode) { *this = xmlNode; }
    ...
    if (!certificateTransparencyLoggingPreferenceNode.IsNull()) {
      m_certificateTransparencyLoggingPreference =
          CertificateTransparencyLoggingPreferenceMapper::GetCertificateTransparencyLoggingPreferenceForName(
              StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(certificateTransparencyLoggingPreferenceNode.GetText()).c_str()));
...
void ManagedCertificateRequest::AddToNode(XmlNode& parentNode) const {
  ...
  if (m_certificateTransparencyLoggingPreferenceHasBeenSet) {
    ...
    certificateTransparencyLoggingPreferenceNode.SetText(
