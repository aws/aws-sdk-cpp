...
Aws::String ListDistributionTenants2020_05_31Request::SerializePayload() const
{
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("ListDistributionTenantsRequest");
