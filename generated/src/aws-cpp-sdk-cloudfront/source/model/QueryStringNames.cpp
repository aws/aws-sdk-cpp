...
QueryStringNames::QueryStringNames(const XmlNode& xmlNode) { *this = xmlNode; }

QueryStringNames& QueryStringNames::operator=(const XmlNode& xmlNode) {
...
void QueryStringNames::AddToNode(XmlNode& parentNode) const {
  Aws::StringStream ss;
