...
Aws::String AssociateDistributionTenantWebACL2020_05_31Request::SerializePayload() const
{
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("AssociateDistributionTenantWebACLRequest");
