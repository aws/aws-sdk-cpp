...
Aws::String TestConnectionFunction2020_05_31Request::SerializePayload() const {
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("TestConnectionFunctionRequest");
  ...
  if (m_connectionObjectHasBeenSet) {
    XmlNode connectionObjectNode = parentNode.CreateChildElement("ConnectionObject");
