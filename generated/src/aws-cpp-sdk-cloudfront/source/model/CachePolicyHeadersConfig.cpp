...
CachePolicyHeadersConfig::CachePolicyHeadersConfig(const XmlNode& xmlNode) { *this = xmlNode; }
...
CachePolicyHeadersConfig& CachePolicyHeadersConfig::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!headerBehaviorNode.IsNull()) {
      m_headerBehavior = CachePolicyHeaderBehaviorMapper::GetCachePolicyHeaderBehaviorForName(
