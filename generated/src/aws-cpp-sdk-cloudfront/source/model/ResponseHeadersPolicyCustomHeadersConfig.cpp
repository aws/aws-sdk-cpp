...
ResponseHeadersPolicyCustomHeadersConfig::ResponseHeadersPolicyCustomHeadersConfig(const XmlNode& xmlNode) { *this = xmlNode; }

ResponseHeadersPolicyCustomHeadersConfig& ResponseHeadersPolicyCustomHeadersConfig::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!itemsNode.IsNull()) {
      ...
      while (!itemsMember.IsNull()) {
        ...
        itemsMember = itemsMember.NextNode("ResponseHeadersPolicyCustomHeader");
      }
...
void ResponseHeadersPolicyCustomHeadersConfig::AddToNode(XmlNode& parentNode) const {
  Aws::StringStream ss;
  ...
  if (m_itemsHasBeenSet) {
    ...
    for (const auto& item : m_items) {
      XmlNode itemsNode = itemsParentNode.CreateChildElement("ResponseHeadersPolicyCustomHeader");
