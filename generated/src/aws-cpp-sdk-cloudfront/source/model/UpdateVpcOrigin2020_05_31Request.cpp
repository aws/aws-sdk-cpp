...
{
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("VpcOriginEndpointConfig");
...
Aws::Http::HeaderValueCollection UpdateVpcOrigin2020_05_31Request::GetRequestSpecificHeaders() const
{
