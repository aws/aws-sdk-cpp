...
KeyPairIds::KeyPairIds(const XmlNode& xmlNode) { *this = xmlNode; }

KeyPairIds& KeyPairIds::operator=(const XmlNode& xmlNode) {
...
void KeyPairIds::AddToNode(XmlNode& parentNode) const {
  Aws::StringStream ss;
  ...
  if (m_itemsHasBeenSet) {
    ...
    for (const auto& item : m_items) {
      XmlNode itemsNode = itemsParentNode.CreateChildElement("KeyPairId");
