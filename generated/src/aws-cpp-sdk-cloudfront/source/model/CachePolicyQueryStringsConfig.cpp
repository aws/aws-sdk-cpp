...
CachePolicyQueryStringsConfig::CachePolicyQueryStringsConfig(const XmlNode& xmlNode) { *this = xmlNode; }
...
CachePolicyQueryStringsConfig& CachePolicyQueryStringsConfig::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!queryStringBehaviorNode.IsNull()) {
      m_queryStringBehavior = CachePolicyQueryStringBehaviorMapper::GetCachePolicyQueryStringBehaviorForName(
