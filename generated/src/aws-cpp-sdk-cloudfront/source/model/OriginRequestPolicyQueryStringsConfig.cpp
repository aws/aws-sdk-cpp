...
OriginRequestPolicyQueryStringsConfig::OriginRequestPolicyQueryStringsConfig(const XmlNode& xmlNode) { *this = xmlNode; }
...
OriginRequestPolicyQueryStringsConfig& OriginRequestPolicyQueryStringsConfig::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!queryStringBehaviorNode.IsNull()) {
      m_queryStringBehavior = OriginRequestPolicyQueryStringBehaviorMapper::GetOriginRequestPolicyQueryStringBehaviorForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(queryStringBehaviorNode.GetText()).c_str()));
...
void OriginRequestPolicyQueryStringsConfig::AddToNode(XmlNode& parentNode) const {
  ...
  if (m_queryStringBehaviorHasBeenSet) {
    ...
    queryStringBehaviorNode.SetText(
        OriginRequestPolicyQueryStringBehaviorMapper::GetNameForOriginRequestPolicyQueryStringBehavior(m_queryStringBehavior));
  }
