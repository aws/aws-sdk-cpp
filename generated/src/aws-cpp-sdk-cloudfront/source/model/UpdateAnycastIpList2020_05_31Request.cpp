...
Aws::String UpdateAnycastIpList2020_05_31Request::SerializePayload() const {
  XmlDocument payloadDoc = XmlDocument::CreateWithRootNode("UpdateAnycastIpListRequest");
