...
AssociateConnectionsToResiliencyGroupResult::AssociateConnectionsToResiliencyGroupResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

AssociateConnectionsToResiliencyGroupResult& AssociateConnectionsToResiliencyGroupResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
