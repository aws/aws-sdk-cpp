...
AcceptDirectConnectGatewayAssociationProposalResult::AcceptDirectConnectGatewayAssociationProposalResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

AcceptDirectConnectGatewayAssociationProposalResult& AcceptDirectConnectGatewayAssociationProposalResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
