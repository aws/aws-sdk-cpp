...
Location& Location::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("availableProviders")) {
    ...
    for (unsigned availableProvidersIndex = 0; availableProvidersIndex < availableProvidersJsonList.GetLength();
  ...
  if (jsonValue.ValueExists("availableMacSecPortSpeeds")) {
    ...
    for (unsigned availableMacSecPortSpeedsIndex = 0; availableMacSecPortSpeedsIndex < availableMacSecPortSpeedsJsonList.GetLength();
         ++availableMacSecPortSpeedsIndex) {
...
JsonValue Location::Jsonize() const {
  ...
  if (m_availableMacSecPortSpeedsHasBeenSet) {
    ...
    for (unsigned availableMacSecPortSpeedsIndex = 0; availableMacSecPortSpeedsIndex < availableMacSecPortSpeedsJsonList.GetLength();
         ++availableMacSecPortSpeedsIndex) {
      availableMacSecPortSpeedsJsonList[availableMacSecPortSpeedsIndex].AsString(
