...
NewPrivateVirtualInterface::NewPrivateVirtualInterface(JsonView jsonValue) { *this = jsonValue; }

NewPrivateVirtualInterface& NewPrivateVirtualInterface::operator=(JsonView jsonValue) {
