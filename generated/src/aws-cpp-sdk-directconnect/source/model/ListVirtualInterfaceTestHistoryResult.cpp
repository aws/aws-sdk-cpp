...
ListVirtualInterfaceTestHistoryResult& ListVirtualInterfaceTestHistoryResult::operator=(
  ...
  if (jsonValue.ValueExists("virtualInterfaceTestHistory")) {
    ...
    for (unsigned virtualInterfaceTestHistoryIndex = 0; virtualInterfaceTestHistoryIndex < virtualInterfaceTestHistoryJsonList.GetLength();
         ++virtualInterfaceTestHistoryIndex) {
