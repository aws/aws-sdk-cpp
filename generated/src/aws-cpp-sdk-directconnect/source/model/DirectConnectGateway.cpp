...
DirectConnectGateway::DirectConnectGateway(JsonView jsonValue) { *this = jsonValue; }
...
DirectConnectGateway& DirectConnectGateway::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("directConnectGatewayState")) {
    m_directConnectGatewayState =
        DirectConnectGatewayStateMapper::GetDirectConnectGatewayStateForName(jsonValue.GetString("directConnectGatewayState"));
...
JsonValue DirectConnectGateway::Jsonize() const {
  ...
  if (m_directConnectGatewayStateHasBeenSet) {
    payload.WithString("directConnectGatewayState",
                       DirectConnectGatewayStateMapper::GetNameForDirectConnectGatewayState(m_directConnectGatewayState));
  }
