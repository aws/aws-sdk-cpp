...
Aws::String AcceptDirectConnectGatewayAssociationProposalRequest::SerializePayload() const {
  ...
  if (m_overrideAllowedPrefixesToDirectConnectGatewayHasBeenSet) {
    Aws::Utils::Array<JsonValue> overrideAllowedPrefixesToDirectConnectGatewayJsonList(
        m_overrideAllowedPrefixesToDirectConnectGateway.size());
    for (unsigned overrideAllowedPrefixesToDirectConnectGatewayIndex = 0;
         overrideAllowedPrefixesToDirectConnectGatewayIndex < overrideAllowedPrefixesToDirectConnectGatewayJsonList.GetLength();
         ++overrideAllowedPrefixesToDirectConnectGatewayIndex) {
      overrideAllowedPrefixesToDirectConnectGatewayJsonList[overrideAllowedPrefixesToDirectConnectGatewayIndex].AsObject(
          m_overrideAllowedPrefixesToDirectConnectGateway[overrideAllowedPrefixesToDirectConnectGatewayIndex].Jsonize());
    }
