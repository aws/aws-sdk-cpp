...
{
const size_t DirectConnectEndpointRules::RulesBlobStrLen = 3482;
const size_t DirectConnectEndpointRules::RulesBlobSize = 3483;
...
't','t','p','s',':','/','/','d','i','r','e','c','t','c','o','n','n','e','c','t','-','f','i','p','s',
