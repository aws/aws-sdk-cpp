...
{
const size_t DirectConnectEndpointRules::RulesBlobStrLen = 4150;
const size_t DirectConnectEndpointRules::RulesBlobSize = 4151;
...
'h','t','t','p','s',':','/','/','d','i','r','e','c','t','c','o','n','n','e','c','t','-','f','i','p',
...
'/','d','i','r','e','c','t','c','o','n','n','e','c','t','.','{','R','e','g','i','o','n','}','.','{',
...
'i','r','e','c','t','c','o','n','n','e','c','t','.','u','s','-','g','o','v','-','e','a','s','t','-',
...
const char* DirectConnectEndpointRules::GetRulesBlob()
{
