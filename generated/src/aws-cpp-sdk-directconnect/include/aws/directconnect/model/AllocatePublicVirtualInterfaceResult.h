...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTCONNECT_API AllocatePublicVirtualInterfaceResult();
    ...
    inline AllocatePublicVirtualInterfaceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AllocatePublicVirtualInterfaceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AllocatePublicVirtualInterfaceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
