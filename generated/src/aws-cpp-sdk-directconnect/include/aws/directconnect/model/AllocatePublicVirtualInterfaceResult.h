...
class AllocatePublicVirtualInterfaceResult {
 public:
  ...
  AWS_DIRECTCONNECT_API AllocatePublicVirtualInterfaceResult& operator=(
  ...
  inline AllocatePublicVirtualInterfaceResult& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline AllocatePublicVirtualInterfaceResult& WithAsn(int value) {
    SetAsn(value);
    return *this;
  }
  ///@}
  ...
  inline AllocatePublicVirtualInterfaceResult& WithAsnLong(long long value) {
    SetAsnLong(value);
    return *this;
  }
  ///@}
  ...
  inline AllocatePublicVirtualInterfaceResult& WithAmazonSideAsn(long long value) {
  ...
  inline AllocatePublicVirtualInterfaceResult& WithAddressFamily(AddressFamily value) {
  ...
  inline AllocatePublicVirtualInterfaceResult& WithVirtualInterfaceState(VirtualInterfaceState value) {
  ...
  inline AllocatePublicVirtualInterfaceResult& WithMtu(int value) {
    SetMtu(value);
    return *this;
  }
  ///@}
  ...
  inline AllocatePublicVirtualInterfaceResult& WithJumboFrameCapable(bool value) {
  ...
  inline AllocatePublicVirtualInterfaceResult& WithSiteLinkEnabled(bool value) {
  ...
  inline AllocatePublicVirtualInterfaceResult& WithPrefixPoolAllocatedCountIpv4(int value) {
  ...
  inline AllocatePublicVirtualInterfaceResult& WithPrefixPoolAllocatedCountIpv6(int value) {
