...
/**
 */
class DescribeDirectConnectGatewayAssociationProposalsRequest : public DirectConnectRequest {
 public:
  AWS_DIRECTCONNECT_API DescribeDirectConnectGatewayAssociationProposalsRequest() = default;
  ...
  template <typename DirectConnectGatewayIdT = Aws::String>
  DescribeDirectConnectGatewayAssociationProposalsRequest& WithDirectConnectGatewayId(DirectConnectGatewayIdT&& value) {
  ...
  template <typename ProposalIdT = Aws::String>
  DescribeDirectConnectGatewayAssociationProposalsRequest& WithProposalId(ProposalIdT&& value) {
  ...
  void SetAssociatedGatewayId(AssociatedGatewayIdT&& value) {
    m_associatedGatewayIdHasBeenSet = true;
    m_associatedGatewayId = std::forward<AssociatedGatewayIdT>(value);
  }
  template <typename AssociatedGatewayIdT = Aws::String>
  DescribeDirectConnectGatewayAssociationProposalsRequest& WithAssociatedGatewayId(AssociatedGatewayIdT&& value) {
    SetAssociatedGatewayId(std::forward<AssociatedGatewayIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeDirectConnectGatewayAssociationProposalsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDirectConnectGatewayAssociationProposalsRequest& WithNextToken(NextTokenT&& value) {
