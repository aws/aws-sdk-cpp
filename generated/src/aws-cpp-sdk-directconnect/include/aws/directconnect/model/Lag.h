...
class Lag {
 public:
  ...
  inline Lag& WithNumberOfConnections(int value) {
  ...
  inline Lag& WithLagState(LagState value) {
    SetLagState(value);
    return *this;
  }
  ///@}
  ...
  inline Lag& WithMinimumLinks(int value) {
  ...
  inline Lag& WithAllowsHostedConnections(bool value) {
  ...
  inline Lag& WithJumboFrameCapable(bool value) {
  ...
  inline Lag& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  inline Lag& WithMacSecCapable(bool value) {
  ...
  inline Lag& WithPrefixPoolSizeIpv4(int value) {
  ...
  inline Lag& WithPrefixPoolSizeIpv6(int value) {
  ...
  inline Lag& WithPrefixPoolUnallocatedCountIpv4(int value) {
  ...
  inline Lag& WithPrefixPoolUnallocatedCountIpv6(int value) {
