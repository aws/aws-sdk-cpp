...
class UpdateDirectConnectGatewayRequest : public DirectConnectRequest {
 public:
  ...
  template <typename DirectConnectGatewayIdT = Aws::String>
  UpdateDirectConnectGatewayRequest& WithDirectConnectGatewayId(DirectConnectGatewayIdT&& value) {
  ...
  void SetNewDirectConnectGatewayName(NewDirectConnectGatewayNameT&& value) {
    m_newDirectConnectGatewayNameHasBeenSet = true;
    m_newDirectConnectGatewayName = std::forward<NewDirectConnectGatewayNameT>(value);
  }
  template <typename NewDirectConnectGatewayNameT = Aws::String>
  UpdateDirectConnectGatewayRequest& WithNewDirectConnectGatewayName(NewDirectConnectGatewayNameT&& value) {
    SetNewDirectConnectGatewayName(std::forward<NewDirectConnectGatewayNameT>(value));
    return *this;
  }
  ///@}
 private:
