...
class AllocatePrivateVirtualInterfaceRequest : public DirectConnectRequest {
 public:
   ...
   */
  inline const NewPrivateVirtualInterfaceAllocation& GetNewPrivateVirtualInterfaceAllocation() const {
    return m_newPrivateVirtualInterfaceAllocation;
  }
  ...
  void SetNewPrivateVirtualInterfaceAllocation(NewPrivateVirtualInterfaceAllocationT&& value) {
    m_newPrivateVirtualInterfaceAllocationHasBeenSet = true;
    m_newPrivateVirtualInterfaceAllocation = std::forward<NewPrivateVirtualInterfaceAllocationT>(value);
  }
  template <typename NewPrivateVirtualInterfaceAllocationT = NewPrivateVirtualInterfaceAllocation>
  AllocatePrivateVirtualInterfaceRequest& WithNewPrivateVirtualInterfaceAllocation(NewPrivateVirtualInterfaceAllocationT&& value) {
    SetNewPrivateVirtualInterfaceAllocation(std::forward<NewPrivateVirtualInterfaceAllocationT>(value));
    return *this;
  }
  ///@}
 private:
