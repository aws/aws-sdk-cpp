...
class DisassociateMacSecKeyResult {
 public:
  ...
  template <typename ConnectionIdT = Aws::String>
  DisassociateMacSecKeyResult& WithConnectionId(ConnectionIdT&& value) {
  ...
  template <typename MacSecKeysT = Aws::Vector<MacSecKey>>
  DisassociateMacSecKeyResult& WithMacSecKeys(MacSecKeysT&& value) {
    SetMacSecKeys(std::forward<MacSecKeysT>(value));
    return *this;
  }
  template <typename MacSecKeysT = MacSecKey>
  DisassociateMacSecKeyResult& AddMacSecKeys(MacSecKeysT&& value) {
    m_macSecKeysHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateMacSecKeyResult& WithRequestId(RequestIdT&& value) {
