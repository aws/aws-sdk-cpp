...
class AllocateTransitVirtualInterfaceRequest : public DirectConnectRequest {
 public:
   ...
   */
  inline const NewTransitVirtualInterfaceAllocation& GetNewTransitVirtualInterfaceAllocation() const {
    return m_newTransitVirtualInterfaceAllocation;
  }
  ...
  void SetNewTransitVirtualInterfaceAllocation(NewTransitVirtualInterfaceAllocationT&& value) {
    m_newTransitVirtualInterfaceAllocationHasBeenSet = true;
    m_newTransitVirtualInterfaceAllocation = std::forward<NewTransitVirtualInterfaceAllocationT>(value);
  }
  template <typename NewTransitVirtualInterfaceAllocationT = NewTransitVirtualInterfaceAllocation>
  AllocateTransitVirtualInterfaceRequest& WithNewTransitVirtualInterfaceAllocation(NewTransitVirtualInterfaceAllocationT&& value) {
    SetNewTransitVirtualInterfaceAllocation(std::forward<NewTransitVirtualInterfaceAllocationT>(value));
    return *this;
  }
  ///@}
 private:
