...
class DeleteDirectConnectGatewayAssociationResult {
 public:
  ...
  AWS_DIRECTCONNECT_API DeleteDirectConnectGatewayAssociationResult& operator=(
  ...
  template <typename DirectConnectGatewayAssociationT = DirectConnectGatewayAssociation>
  DeleteDirectConnectGatewayAssociationResult& WithDirectConnectGatewayAssociation(DirectConnectGatewayAssociationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDirectConnectGatewayAssociationResult& WithRequestId(RequestIdT&& value) {
