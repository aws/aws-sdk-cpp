...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTCONNECT_API ConfirmConnectionRequest() = default;
    ...
    template<typename ConnectionIdT = Aws::String>
    ConfirmConnectionRequest& WithConnectionId(ConnectionIdT&& value) { SetConnectionId(std::forward<ConnectionIdT>(value)); return *this;}
    ///@}
  private:
