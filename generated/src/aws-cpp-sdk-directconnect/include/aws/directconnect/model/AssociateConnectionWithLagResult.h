...
class AssociateConnectionWithLagResult {
 public:
  ...
  template <typename OwnerAccountT = Aws::String>
  AssociateConnectionWithLagResult& WithOwnerAccount(OwnerAccountT&& value) {
  ...
  template <typename ConnectionIdT = Aws::String>
  AssociateConnectionWithLagResult& WithConnectionId(ConnectionIdT&& value) {
  ...
  template <typename ConnectionNameT = Aws::String>
  AssociateConnectionWithLagResult& WithConnectionName(ConnectionNameT&& value) {
  ...
  inline AssociateConnectionWithLagResult& WithConnectionState(ConnectionState value) {
  ...
  template <typename RegionT = Aws::String>
  AssociateConnectionWithLagResult& WithRegion(RegionT&& value) {
  ...
  template <typename LocationT = Aws::String>
  AssociateConnectionWithLagResult& WithLocation(LocationT&& value) {
  ...
  template <typename BandwidthT = Aws::String>
  AssociateConnectionWithLagResult& WithBandwidth(BandwidthT&& value) {
  ...
  inline AssociateConnectionWithLagResult& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  template <typename PartnerNameT = Aws::String>
  AssociateConnectionWithLagResult& WithPartnerName(PartnerNameT&& value) {
  ...
  template <typename LoaIssueTimeT = Aws::Utils::DateTime>
  AssociateConnectionWithLagResult& WithLoaIssueTime(LoaIssueTimeT&& value) {
  ...
  template <typename LagIdT = Aws::String>
  AssociateConnectionWithLagResult& WithLagId(LagIdT&& value) {
  ...
  template <typename AwsDeviceT = Aws::String>
  AssociateConnectionWithLagResult& WithAwsDevice(AwsDeviceT&& value) {
  ...
  inline AssociateConnectionWithLagResult& WithJumboFrameCapable(bool value) {
  ...
  template <typename AwsDeviceV2T = Aws::String>
  AssociateConnectionWithLagResult& WithAwsDeviceV2(AwsDeviceV2T&& value) {
  ...
  template <typename AwsLogicalDeviceIdT = Aws::String>
  AssociateConnectionWithLagResult& WithAwsLogicalDeviceId(AwsLogicalDeviceIdT&& value) {
  ...
  inline AssociateConnectionWithLagResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AssociateConnectionWithLagResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AssociateConnectionWithLagResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ProviderNameT = Aws::String>
  AssociateConnectionWithLagResult& WithProviderName(ProviderNameT&& value) {
  ...
  inline AssociateConnectionWithLagResult& WithMacSecCapable(bool value) {
  ...
  template <typename PortEncryptionStatusT = Aws::String>
  AssociateConnectionWithLagResult& WithPortEncryptionStatus(PortEncryptionStatusT&& value) {
  ...
  template <typename EncryptionModeT = Aws::String>
  AssociateConnectionWithLagResult& WithEncryptionMode(EncryptionModeT&& value) {
  ...
  template <typename MacSecKeysT = Aws::Vector<MacSecKey>>
  AssociateConnectionWithLagResult& WithMacSecKeys(MacSecKeysT&& value) {
    SetMacSecKeys(std::forward<MacSecKeysT>(value));
    return *this;
  }
  template <typename MacSecKeysT = MacSecKey>
  AssociateConnectionWithLagResult& AddMacSecKeys(MacSecKeysT&& value) {
    m_macSecKeysHasBeenSet = true;
  ...
  template <typename RateLimiterStatusT = RateLimiterStatus>
  AssociateConnectionWithLagResult& WithRateLimiterStatus(RateLimiterStatusT&& value) {
  ...
  inline AssociateConnectionWithLagResult& WithPartnerInterconnectMacSecCapable(bool value) {
  ...
  inline AssociateConnectionWithLagResult& WithPrefixPoolSizeIpv4(int value) {
  ...
  inline AssociateConnectionWithLagResult& WithPrefixPoolSizeIpv6(int value) {
  ...
  inline AssociateConnectionWithLagResult& WithPrefixPoolUnallocatedCountIpv4(int value) {
  ...
  inline AssociateConnectionWithLagResult& WithPrefixPoolUnallocatedCountIpv6(int value) {
  ...
  inline AssociateConnectionWithLagResult& WithBillingMode(BillingMode value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateConnectionWithLagResult& WithRequestId(RequestIdT&& value) {
