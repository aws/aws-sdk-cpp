...
class CreateInterconnectResult {
 public:
  ...
  void SetInterconnectId(InterconnectIdT&& value) {
    ...
    m_interconnectId = std::forward<InterconnectIdT>(value);
  }
  template <typename InterconnectIdT = Aws::String>
  CreateInterconnectResult& WithInterconnectId(InterconnectIdT&& value) {
    SetInterconnectId(std::forward<InterconnectIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInterconnectState(InterconnectState value) {
    m_interconnectStateHasBeenSet = true;
    m_interconnectState = value;
  }
  inline CreateInterconnectResult& WithInterconnectState(InterconnectState value) {
    SetInterconnectState(value);
    return *this;
  }
  ///@}
  ...
  inline CreateInterconnectResult& WithJumboFrameCapable(bool value) {
  ...
  inline CreateInterconnectResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  inline CreateInterconnectResult& WithMacSecCapable(bool value) {
