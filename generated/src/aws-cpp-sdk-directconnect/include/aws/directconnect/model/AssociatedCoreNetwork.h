...
class AssociatedCoreNetwork {
 public:
  ...
  template <typename IdT = Aws::String>
  AssociatedCoreNetwork& WithId(IdT&& value) {
  ...
  template <typename OwnerAccountT = Aws::String>
  AssociatedCoreNetwork& WithOwnerAccount(OwnerAccountT&& value) {
  ...
  template <typename AttachmentIdT = Aws::String>
  AssociatedCoreNetwork& WithAttachmentId(AttachmentIdT&& value) {
