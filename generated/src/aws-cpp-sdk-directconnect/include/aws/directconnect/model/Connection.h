...
class Connection {
 public:
  ...
  inline Connection& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline Connection& WithJumboFrameCapable(bool value) {
  ...
  inline Connection& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  inline Connection& WithMacSecCapable(bool value) {
  ...
  inline bool PartnerInterconnectMacSecCapableHasBeenSet() const { return m_partnerInterconnectMacSecCapableHasBeenSet; }
  ...
  inline Connection& WithPartnerInterconnectMacSecCapable(bool value) {
