...
class DirectConnectGateway {
 public:
  ...
  void SetDirectConnectGatewayName(DirectConnectGatewayNameT&& value) {
    ...
    m_directConnectGatewayName = std::forward<DirectConnectGatewayNameT>(value);
  }
  template <typename DirectConnectGatewayNameT = Aws::String>
  DirectConnectGateway& WithDirectConnectGatewayName(DirectConnectGatewayNameT&& value) {
    SetDirectConnectGatewayName(std::forward<DirectConnectGatewayNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline DirectConnectGateway& WithAmazonSideAsn(long long value) {
  ...
  inline void SetDirectConnectGatewayState(DirectConnectGatewayState value) {
    m_directConnectGatewayStateHasBeenSet = true;
    m_directConnectGatewayState = value;
  }
  inline DirectConnectGateway& WithDirectConnectGatewayState(DirectConnectGatewayState value) {
    SetDirectConnectGatewayState(value);
    return *this;
  }
  ///@}
