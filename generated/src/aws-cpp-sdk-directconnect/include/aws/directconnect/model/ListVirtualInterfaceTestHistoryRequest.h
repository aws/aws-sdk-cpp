...
class ListVirtualInterfaceTestHistoryRequest : public DirectConnectRequest {
 public:
  ...
  template <typename TestIdT = Aws::String>
  ListVirtualInterfaceTestHistoryRequest& WithTestId(TestIdT&& value) {
  ...
  template <typename VirtualInterfaceIdT = Aws::String>
  ListVirtualInterfaceTestHistoryRequest& WithVirtualInterfaceId(VirtualInterfaceIdT&& value) {
  ...
  template <typename BgpPeersT = Aws::Vector<Aws::String>>
  ListVirtualInterfaceTestHistoryRequest& WithBgpPeers(BgpPeersT&& value) {
    SetBgpPeers(std::forward<BgpPeersT>(value));
    return *this;
  }
  template <typename BgpPeersT = Aws::String>
  ListVirtualInterfaceTestHistoryRequest& AddBgpPeers(BgpPeersT&& value) {
    m_bgpPeersHasBeenSet = true;
  ...
  template <typename StatusT = Aws::String>
  ListVirtualInterfaceTestHistoryRequest& WithStatus(StatusT&& value) {
  ...
  inline ListVirtualInterfaceTestHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVirtualInterfaceTestHistoryRequest& WithNextToken(NextTokenT&& value) {
