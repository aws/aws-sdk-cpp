...
namespace Model
{
  ...
  public:
    ...
    template<typename VirtualInterfaceNameT = Aws::String>
    NewPrivateVirtualInterfaceAllocation& WithVirtualInterfaceName(VirtualInterfaceNameT&& value) { SetVirtualInterfaceName(std::forward<VirtualInterfaceNameT>(value)); return *this;}
    ///@}
    ...
    inline NewPrivateVirtualInterfaceAllocation& WithAsnLong(long long value) { SetAsnLong(value); return *this;}
    ///@}
    ...
    template<typename AuthKeyT = Aws::String>
    NewPrivateVirtualInterfaceAllocation& WithAuthKey(AuthKeyT&& value) { SetAuthKey(std::forward<AuthKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename AmazonAddressT = Aws::String>
    NewPrivateVirtualInterfaceAllocation& WithAmazonAddress(AmazonAddressT&& value) { SetAmazonAddress(std::forward<AmazonAddressT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomerAddressT = Aws::String>
    NewPrivateVirtualInterfaceAllocation& WithCustomerAddress(CustomerAddressT&& value) { SetCustomerAddress(std::forward<CustomerAddressT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Vector<Tag>>
    NewPrivateVirtualInterfaceAllocation& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsT = Tag>
    NewPrivateVirtualInterfaceAllocation& AddTags(TagsT&& value) { m_tagsHasBeenSet = true; m_tags.emplace_back(std::forward<TagsT>(value)); return *this; }
    ///@}
  private:
