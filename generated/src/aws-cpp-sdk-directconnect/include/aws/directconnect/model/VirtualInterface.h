...
class VirtualInterface {
 public:
  ...
  inline VirtualInterface& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline VirtualInterface& WithAsn(int value) {
    SetAsn(value);
    return *this;
  }
  ///@}
  ...
  inline VirtualInterface& WithAsnLong(long long value) {
    SetAsnLong(value);
    return *this;
  }
  ///@}
  ...
  inline VirtualInterface& WithAmazonSideAsn(long long value) {
  ...
  inline VirtualInterface& WithAddressFamily(AddressFamily value) {
  ...
  inline VirtualInterface& WithVirtualInterfaceState(VirtualInterfaceState value) {
  ...
  inline VirtualInterface& WithMtu(int value) {
    SetMtu(value);
    return *this;
  }
  ///@}
  ...
  inline VirtualInterface& WithJumboFrameCapable(bool value) {
  ...
  inline VirtualInterface& WithSiteLinkEnabled(bool value) {
