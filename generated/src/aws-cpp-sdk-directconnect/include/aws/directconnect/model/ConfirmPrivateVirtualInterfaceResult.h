...
class ConfirmPrivateVirtualInterfaceResult {
 public:
  ...
  AWS_DIRECTCONNECT_API ConfirmPrivateVirtualInterfaceResult& operator=(
  ...
  inline ConfirmPrivateVirtualInterfaceResult& WithVirtualInterfaceState(VirtualInterfaceState value) {
  ...
  template <typename RequestIdT = Aws::String>
  ConfirmPrivateVirtualInterfaceResult& WithRequestId(RequestIdT&& value) {
