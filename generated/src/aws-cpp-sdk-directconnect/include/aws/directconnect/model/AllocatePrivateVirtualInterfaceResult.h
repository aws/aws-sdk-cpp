...
class AllocatePrivateVirtualInterfaceResult {
 public:
  ...
  inline AllocatePrivateVirtualInterfaceResult& WithPrefixPoolAllocatedCountIpv4(int value) {
  ...
  inline AllocatePrivateVirtualInterfaceResult& WithPrefixPoolAllocatedCountIpv6(int value) {
