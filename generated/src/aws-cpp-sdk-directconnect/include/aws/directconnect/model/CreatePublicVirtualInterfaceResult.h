...
class CreatePublicVirtualInterfaceResult {
 public:
  ...
  AWS_DIRECTCONNECT_API CreatePublicVirtualInterfaceResult& operator=(
  ...
  inline CreatePublicVirtualInterfaceResult& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePublicVirtualInterfaceResult& WithAsn(int value) {
    SetAsn(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePublicVirtualInterfaceResult& WithAsnLong(long long value) {
    SetAsnLong(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePublicVirtualInterfaceResult& WithAmazonSideAsn(long long value) {
  ...
  inline CreatePublicVirtualInterfaceResult& WithAddressFamily(AddressFamily value) {
  ...
  inline CreatePublicVirtualInterfaceResult& WithVirtualInterfaceState(VirtualInterfaceState value) {
  ...
  inline CreatePublicVirtualInterfaceResult& WithMtu(int value) {
    SetMtu(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePublicVirtualInterfaceResult& WithJumboFrameCapable(bool value) {
  ...
  template <typename RegionT = Aws::String>
  CreatePublicVirtualInterfaceResult& WithRegion(RegionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreatePublicVirtualInterfaceResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreatePublicVirtualInterfaceResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline CreatePublicVirtualInterfaceResult& WithSiteLinkEnabled(bool value) {
  ...
  inline CreatePublicVirtualInterfaceResult& WithPrefixPoolAllocatedCountIpv4(int value) {
  ...
  inline CreatePublicVirtualInterfaceResult& WithPrefixPoolAllocatedCountIpv6(int value) {
  ...
  template <typename RateLimitT = Aws::String>
  CreatePublicVirtualInterfaceResult& WithRateLimit(RateLimitT&& value) {
