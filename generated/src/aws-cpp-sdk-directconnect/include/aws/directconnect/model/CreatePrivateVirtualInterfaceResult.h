...
class CreatePrivateVirtualInterfaceResult {
 public:
  ...
  AWS_DIRECTCONNECT_API CreatePrivateVirtualInterfaceResult& operator=(
  ...
  inline CreatePrivateVirtualInterfaceResult& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePrivateVirtualInterfaceResult& WithAsn(int value) {
    SetAsn(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePrivateVirtualInterfaceResult& WithAsnLong(long long value) {
    SetAsnLong(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePrivateVirtualInterfaceResult& WithAmazonSideAsn(long long value) {
  ...
  inline CreatePrivateVirtualInterfaceResult& WithAddressFamily(AddressFamily value) {
  ...
  inline CreatePrivateVirtualInterfaceResult& WithVirtualInterfaceState(VirtualInterfaceState value) {
  ...
  inline CreatePrivateVirtualInterfaceResult& WithMtu(int value) {
    SetMtu(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePrivateVirtualInterfaceResult& WithJumboFrameCapable(bool value) {
  ...
  inline CreatePrivateVirtualInterfaceResult& WithSiteLinkEnabled(bool value) {
  ...
  inline CreatePrivateVirtualInterfaceResult& WithPrefixPoolAllocatedCountIpv4(int value) {
  ...
  inline CreatePrivateVirtualInterfaceResult& WithPrefixPoolAllocatedCountIpv6(int value) {
