...
namespace Model
{
  ...
  public:
    ...
    inline DeleteLagResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteLagResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteLagResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
