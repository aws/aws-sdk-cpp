...
class DeleteLagResult {
 public:
  ...
  inline DeleteLagResult& WithNumberOfConnections(int value) {
  ...
  inline DeleteLagResult& WithLagState(LagState value) {
    SetLagState(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteLagResult& WithMinimumLinks(int value) {
  ...
  inline DeleteLagResult& WithAllowsHostedConnections(bool value) {
  ...
  inline DeleteLagResult& WithJumboFrameCapable(bool value) {
  ...
  inline DeleteLagResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  inline DeleteLagResult& WithMacSecCapable(bool value) {
  ...
  inline DeleteLagResult& WithBillingMode(BillingMode value) {
