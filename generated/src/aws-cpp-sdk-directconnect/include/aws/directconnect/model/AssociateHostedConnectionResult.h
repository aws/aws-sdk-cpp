...
namespace Model
{
  ...
  public:
    ...
    inline AssociateHostedConnectionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateHostedConnectionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateHostedConnectionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
