...
class AssociateHostedConnectionResult {
 public:
  ...
  inline AssociateHostedConnectionResult& WithConnectionState(ConnectionState value) {
  ...
  inline AssociateHostedConnectionResult& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline AssociateHostedConnectionResult& WithJumboFrameCapable(bool value) {
  ...
  inline AssociateHostedConnectionResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  inline AssociateHostedConnectionResult& WithMacSecCapable(bool value) {
  ...
  template <typename RateLimiterStatusT = RateLimiterStatus>
  AssociateHostedConnectionResult& WithRateLimiterStatus(RateLimiterStatusT&& value) {
  ...
  inline AssociateHostedConnectionResult& WithPartnerInterconnectMacSecCapable(bool value) {
  ...
  inline AssociateHostedConnectionResult& WithPrefixPoolSizeIpv4(int value) {
  ...
  inline AssociateHostedConnectionResult& WithPrefixPoolSizeIpv6(int value) {
  ...
  inline AssociateHostedConnectionResult& WithPrefixPoolUnallocatedCountIpv4(int value) {
  ...
  inline AssociateHostedConnectionResult& WithPrefixPoolUnallocatedCountIpv6(int value) {
  ...
  inline AssociateHostedConnectionResult& WithBillingMode(BillingMode value) {
