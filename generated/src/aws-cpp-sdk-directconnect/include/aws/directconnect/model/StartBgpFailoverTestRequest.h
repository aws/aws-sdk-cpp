...
class StartBgpFailoverTestRequest : public DirectConnectRequest {
 public:
  ...
  inline void SetTestDurationInMinutes(int value) {
    m_testDurationInMinutesHasBeenSet = true;
    m_testDurationInMinutes = value;
  }
  inline StartBgpFailoverTestRequest& WithTestDurationInMinutes(int value) {
    SetTestDurationInMinutes(value);
    return *this;
  }
  ///@}
 private:
