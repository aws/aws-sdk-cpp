...
class StopBgpFailoverTestResult {
 public:
  AWS_DIRECTCONNECT_API StopBgpFailoverTestResult() = default;
  ...
  void SetVirtualInterfaceTest(VirtualInterfaceTestT&& value) {
    m_virtualInterfaceTestHasBeenSet = true;
    m_virtualInterfaceTest = std::forward<VirtualInterfaceTestT>(value);
  }
  template <typename VirtualInterfaceTestT = VirtualInterfaceTestHistory>
  StopBgpFailoverTestResult& WithVirtualInterfaceTest(VirtualInterfaceTestT&& value) {
    SetVirtualInterfaceTest(std::forward<VirtualInterfaceTestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopBgpFailoverTestResult& WithRequestId(RequestIdT&& value) {
