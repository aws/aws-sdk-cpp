...
namespace Model {
class CreateResiliencyGroupResult {
 public:
  AWS_DIRECTCONNECT_API CreateResiliencyGroupResult() = default;
  AWS_DIRECTCONNECT_API CreateResiliencyGroupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_DIRECTCONNECT_API CreateResiliencyGroupResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ResiliencyGroupT = ResiliencyGroup>
  CreateResiliencyGroupResult& WithResiliencyGroup(ResiliencyGroupT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateResiliencyGroupResult& WithRequestId(RequestIdT&& value) {
