...
class DescribeVirtualInterfacesResult {
 public:
  ...
  void SetVirtualInterfaces(VirtualInterfacesT&& value) {
    m_virtualInterfacesHasBeenSet = true;
    m_virtualInterfaces = std::forward<VirtualInterfacesT>(value);
  }
  template <typename VirtualInterfacesT = Aws::Vector<VirtualInterface>>
  DescribeVirtualInterfacesResult& WithVirtualInterfaces(VirtualInterfacesT&& value) {
    SetVirtualInterfaces(std::forward<VirtualInterfacesT>(value));
    return *this;
  }
  template <typename VirtualInterfacesT = VirtualInterface>
  DescribeVirtualInterfacesResult& AddVirtualInterfaces(VirtualInterfacesT&& value) {
    m_virtualInterfacesHasBeenSet = true;
    m_virtualInterfaces.emplace_back(std::forward<VirtualInterfacesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVirtualInterfacesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeVirtualInterfacesResult& WithRequestId(RequestIdT&& value) {
