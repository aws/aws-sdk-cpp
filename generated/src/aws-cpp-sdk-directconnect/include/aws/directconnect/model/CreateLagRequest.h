...
class CreateLagRequest : public DirectConnectRequest {
 public:
  ...
  inline CreateLagRequest& WithNumberOfConnections(int value) {
  ...
  void SetChildConnectionTags(ChildConnectionTagsT&& value) {
    m_childConnectionTagsHasBeenSet = true;
    m_childConnectionTags = std::forward<ChildConnectionTagsT>(value);
  }
  template <typename ChildConnectionTagsT = Aws::Vector<Tag>>
  CreateLagRequest& WithChildConnectionTags(ChildConnectionTagsT&& value) {
    SetChildConnectionTags(std::forward<ChildConnectionTagsT>(value));
    return *this;
  }
  template <typename ChildConnectionTagsT = Tag>
  CreateLagRequest& AddChildConnectionTags(ChildConnectionTagsT&& value) {
    m_childConnectionTagsHasBeenSet = true;
    m_childConnectionTags.emplace_back(std::forward<ChildConnectionTagsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateLagRequest& WithRequestMACSec(bool value) {
