...
class DescribeVirtualGatewaysResult {
 public:
  ...
  template <typename VirtualGatewaysT = Aws::Vector<VirtualGateway>>
  DescribeVirtualGatewaysResult& WithVirtualGateways(VirtualGatewaysT&& value) {
    SetVirtualGateways(std::forward<VirtualGatewaysT>(value));
    return *this;
  }
  template <typename VirtualGatewaysT = VirtualGateway>
  DescribeVirtualGatewaysResult& AddVirtualGateways(VirtualGatewaysT&& value) {
    m_virtualGatewaysHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeVirtualGatewaysResult& WithRequestId(RequestIdT&& value) {
