...
class CreatePublicVirtualInterfaceRequest : public DirectConnectRequest {
 public:
  ...
  template <typename ConnectionIdT = Aws::String>
  CreatePublicVirtualInterfaceRequest& WithConnectionId(ConnectionIdT&& value) {
  ...
  void SetNewPublicVirtualInterface(NewPublicVirtualInterfaceT&& value) {
    m_newPublicVirtualInterfaceHasBeenSet = true;
    m_newPublicVirtualInterface = std::forward<NewPublicVirtualInterfaceT>(value);
  }
  template <typename NewPublicVirtualInterfaceT = NewPublicVirtualInterface>
  CreatePublicVirtualInterfaceRequest& WithNewPublicVirtualInterface(NewPublicVirtualInterfaceT&& value) {
    SetNewPublicVirtualInterface(std::forward<NewPublicVirtualInterfaceT>(value));
    return *this;
  }
  ///@}
 private:
