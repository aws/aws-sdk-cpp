...
class CreateLagResult {
 public:
  ...
  inline CreateLagResult& WithNumberOfConnections(int value) {
  ...
  inline CreateLagResult& WithLagState(LagState value) {
    SetLagState(value);
    return *this;
  }
  ///@}
  ...
  inline CreateLagResult& WithMinimumLinks(int value) {
  ...
  inline CreateLagResult& WithAllowsHostedConnections(bool value) {
  ...
  inline CreateLagResult& WithJumboFrameCapable(bool value) {
  ...
  inline CreateLagResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  inline CreateLagResult& WithMacSecCapable(bool value) {
  ...
  inline CreateLagResult& WithPrefixPoolSizeIpv4(int value) {
  ...
  inline CreateLagResult& WithPrefixPoolSizeIpv6(int value) {
  ...
  inline CreateLagResult& WithPrefixPoolUnallocatedCountIpv4(int value) {
  ...
  inline CreateLagResult& WithPrefixPoolUnallocatedCountIpv6(int value) {
  ...
  inline CreateLagResult& WithBillingMode(BillingMode value) {
