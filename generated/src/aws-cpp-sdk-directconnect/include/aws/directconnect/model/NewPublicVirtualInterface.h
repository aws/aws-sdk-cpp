...
class NewPublicVirtualInterface {
 public:
  ...
  inline NewPublicVirtualInterface& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline NewPublicVirtualInterface& WithAsn(int value) {
    SetAsn(value);
    return *this;
  }
  ///@}
  ...
  inline NewPublicVirtualInterface& WithAsnLong(long long value) {
    SetAsnLong(value);
    return *this;
  }
  ///@}
  ...
  inline NewPublicVirtualInterface& WithAddressFamily(AddressFamily value) {
