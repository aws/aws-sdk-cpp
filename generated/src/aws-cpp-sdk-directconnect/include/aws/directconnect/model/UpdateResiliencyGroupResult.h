...
namespace Model {
class UpdateResiliencyGroupResult {
 public:
  AWS_DIRECTCONNECT_API UpdateResiliencyGroupResult() = default;
  AWS_DIRECTCONNECT_API UpdateResiliencyGroupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_DIRECTCONNECT_API UpdateResiliencyGroupResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ResiliencyGroupT = ResiliencyGroup>
  UpdateResiliencyGroupResult& WithResiliencyGroup(ResiliencyGroupT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateResiliencyGroupResult& WithRequestId(RequestIdT&& value) {
