...
class CreateTransitVirtualInterfaceRequest : public DirectConnectRequest {
 public:
  ...
  template <typename ConnectionIdT = Aws::String>
  CreateTransitVirtualInterfaceRequest& WithConnectionId(ConnectionIdT&& value) {
  ...
  void SetNewTransitVirtualInterface(NewTransitVirtualInterfaceT&& value) {
    m_newTransitVirtualInterfaceHasBeenSet = true;
    m_newTransitVirtualInterface = std::forward<NewTransitVirtualInterfaceT>(value);
  }
  template <typename NewTransitVirtualInterfaceT = NewTransitVirtualInterface>
  CreateTransitVirtualInterfaceRequest& WithNewTransitVirtualInterface(NewTransitVirtualInterfaceT&& value) {
    SetNewTransitVirtualInterface(std::forward<NewTransitVirtualInterfaceT>(value));
    return *this;
  }
  ///@}
 private:
