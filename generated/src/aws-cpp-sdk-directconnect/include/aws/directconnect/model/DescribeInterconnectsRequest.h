...
class DescribeInterconnectsRequest : public DirectConnectRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DescribeInterconnects"; }
  ...
  template <typename InterconnectIdT = Aws::String>
  DescribeInterconnectsRequest& WithInterconnectId(InterconnectIdT&& value) {
  ...
  inline DescribeInterconnectsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInterconnectsRequest& WithNextToken(NextTokenT&& value) {
