...
/**
 */
class DisassociateConnectionsFromResiliencyGroupRequest : public DirectConnectRequest {
 public:
  AWS_DIRECTCONNECT_API DisassociateConnectionsFromResiliencyGroupRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "DisassociateConnectionsFromResiliencyGroup"; }
  ...
  ///@{
  /**
   * <p>The IDs or ARNs of the connections to disassociate from the resiliency
   * group.</p>
   */
  ...
  template <typename ConnectionIdentifiersT = Aws::Vector<Aws::String>>
  DisassociateConnectionsFromResiliencyGroupRequest& WithConnectionIdentifiers(ConnectionIdentifiersT&& value) {
    SetConnectionIdentifiers(std::forward<ConnectionIdentifiersT>(value));
    return *this;
  }
  template <typename ConnectionIdentifiersT = Aws::String>
  DisassociateConnectionsFromResiliencyGroupRequest& AddConnectionIdentifiers(ConnectionIdentifiersT&& value) {
    m_connectionIdentifiersHasBeenSet = true;
  ...
  template <typename ResiliencyGroupIdT = Aws::String>
  DisassociateConnectionsFromResiliencyGroupRequest& WithResiliencyGroupId(ResiliencyGroupIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DisassociateConnectionsFromResiliencyGroupRequest& WithClientToken(ClientTokenT&& value) {
