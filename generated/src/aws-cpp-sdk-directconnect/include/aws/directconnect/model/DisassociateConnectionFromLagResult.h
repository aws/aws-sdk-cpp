...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateConnectionFromLagResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateConnectionFromLagResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateConnectionFromLagResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
