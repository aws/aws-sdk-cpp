...
namespace Model
{
  ...
  public:
    ...
    template<typename OwnerAccountT = Aws::String>
    DisassociateConnectionFromLagResult& WithOwnerAccount(OwnerAccountT&& value) { SetOwnerAccount(std::forward<OwnerAccountT>(value)); return *this;}
    ///@}
    ...
    template<typename ConnectionIdT = Aws::String>
    DisassociateConnectionFromLagResult& WithConnectionId(ConnectionIdT&& value) { SetConnectionId(std::forward<ConnectionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ConnectionNameT = Aws::String>
    DisassociateConnectionFromLagResult& WithConnectionName(ConnectionNameT&& value) { SetConnectionName(std::forward<ConnectionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RegionT = Aws::String>
    DisassociateConnectionFromLagResult& WithRegion(RegionT&& value) { SetRegion(std::forward<RegionT>(value)); return *this;}
    ///@}
    ...
    template<typename LocationT = Aws::String>
    DisassociateConnectionFromLagResult& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
    ...
    template<typename BandwidthT = Aws::String>
    DisassociateConnectionFromLagResult& WithBandwidth(BandwidthT&& value) { SetBandwidth(std::forward<BandwidthT>(value)); return *this;}
    ///@}
    ...
    template<typename PartnerNameT = Aws::String>
    DisassociateConnectionFromLagResult& WithPartnerName(PartnerNameT&& value) { SetPartnerName(std::forward<PartnerNameT>(value)); return *this;}
    ///@}
    ...
    template<typename LoaIssueTimeT = Aws::Utils::DateTime>
    DisassociateConnectionFromLagResult& WithLoaIssueTime(LoaIssueTimeT&& value) { SetLoaIssueTime(std::forward<LoaIssueTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename LagIdT = Aws::String>
    DisassociateConnectionFromLagResult& WithLagId(LagIdT&& value) { SetLagId(std::forward<LagIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsDeviceT = Aws::String>
    DisassociateConnectionFromLagResult& WithAwsDevice(AwsDeviceT&& value) { SetAwsDevice(std::forward<AwsDeviceT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsDeviceV2T = Aws::String>
    DisassociateConnectionFromLagResult& WithAwsDeviceV2(AwsDeviceV2T&& value) { SetAwsDeviceV2(std::forward<AwsDeviceV2T>(value)); return *this;}
    ///@}
    ...
    template<typename AwsLogicalDeviceIdT = Aws::String>
    DisassociateConnectionFromLagResult& WithAwsLogicalDeviceId(AwsLogicalDeviceIdT&& value) { SetAwsLogicalDeviceId(std::forward<AwsLogicalDeviceIdT>(value)); return *this;}
    ///@}
    ...
    inline DisassociateConnectionFromLagResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) { SetHasLogicalRedundancy(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Vector<Tag>>
    DisassociateConnectionFromLagResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsT = Tag>
    DisassociateConnectionFromLagResult& AddTags(TagsT&& value) { m_tagsHasBeenSet = true; m_tags.emplace_back(std::forward<TagsT>(value)); return *this; }
    ///@}
    ...
    template<typename ProviderNameT = Aws::String>
    DisassociateConnectionFromLagResult& WithProviderName(ProviderNameT&& value) { SetProviderName(std::forward<ProviderNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PortEncryptionStatusT = Aws::String>
    DisassociateConnectionFromLagResult& WithPortEncryptionStatus(PortEncryptionStatusT&& value) { SetPortEncryptionStatus(std::forward<PortEncryptionStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename EncryptionModeT = Aws::String>
    DisassociateConnectionFromLagResult& WithEncryptionMode(EncryptionModeT&& value) { SetEncryptionMode(std::forward<EncryptionModeT>(value)); return *this;}
    ///@}
    ...
    template<typename MacSecKeysT = Aws::Vector<MacSecKey>>
    DisassociateConnectionFromLagResult& WithMacSecKeys(MacSecKeysT&& value) { SetMacSecKeys(std::forward<MacSecKeysT>(value)); return *this;}
    template<typename MacSecKeysT = MacSecKey>
    DisassociateConnectionFromLagResult& AddMacSecKeys(MacSecKeysT&& value) { m_macSecKeysHasBeenSet = true; m_macSecKeys.emplace_back(std::forward<MacSecKeysT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateConnectionFromLagResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
