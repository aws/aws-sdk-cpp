...
class DescribeHostedConnectionsRequest : public DirectConnectRequest {
 public:
  ...
  template <typename ConnectionIdT = Aws::String>
  DescribeHostedConnectionsRequest& WithConnectionId(ConnectionIdT&& value) {
  ...
  inline DescribeHostedConnectionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeHostedConnectionsRequest& WithNextToken(NextTokenT&& value) {
