...
class NewTransitVirtualInterfaceAllocation {
 public:
  ...
  inline NewTransitVirtualInterfaceAllocation& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline NewTransitVirtualInterfaceAllocation& WithAsn(int value) {
    SetAsn(value);
    return *this;
  }
  ///@}
  ...
  inline NewTransitVirtualInterfaceAllocation& WithAsnLong(long long value) {
    SetAsnLong(value);
    return *this;
  }
  ///@}
  ...
  inline NewTransitVirtualInterfaceAllocation& WithMtu(int value) {
    SetMtu(value);
    return *this;
  }
  ///@}
  ...
  inline NewTransitVirtualInterfaceAllocation& WithAddressFamily(AddressFamily value) {
  ...
  template <typename RateLimitT = Aws::String>
  NewTransitVirtualInterfaceAllocation& WithRateLimit(RateLimitT&& value) {
