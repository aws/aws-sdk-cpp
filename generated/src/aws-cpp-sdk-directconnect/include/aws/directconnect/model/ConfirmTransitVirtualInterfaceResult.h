...
class ConfirmTransitVirtualInterfaceResult {
 public:
  ...
  AWS_DIRECTCONNECT_API ConfirmTransitVirtualInterfaceResult& operator=(
  ...
  inline ConfirmTransitVirtualInterfaceResult& WithVirtualInterfaceState(VirtualInterfaceState value) {
  ...
  template <typename RequestIdT = Aws::String>
  ConfirmTransitVirtualInterfaceResult& WithRequestId(RequestIdT&& value) {
