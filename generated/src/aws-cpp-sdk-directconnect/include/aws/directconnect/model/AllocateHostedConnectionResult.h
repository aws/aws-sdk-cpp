...
class AllocateHostedConnectionResult {
 public:
  ...
  inline AllocateHostedConnectionResult& WithConnectionState(ConnectionState value) {
  ...
  inline AllocateHostedConnectionResult& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  template <typename LagIdT = Aws::String>
  AllocateHostedConnectionResult& WithLagId(LagIdT&& value) {
  ...
  inline AllocateHostedConnectionResult& WithJumboFrameCapable(bool value) {
  ...
  inline AllocateHostedConnectionResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AllocateHostedConnectionResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AllocateHostedConnectionResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline AllocateHostedConnectionResult& WithMacSecCapable(bool value) {
  ...
  inline AllocateHostedConnectionResult& WithPartnerInterconnectMacSecCapable(bool value) {
  ...
  inline AllocateHostedConnectionResult& WithPrefixPoolSizeIpv4(int value) {
  ...
  inline AllocateHostedConnectionResult& WithPrefixPoolSizeIpv6(int value) {
  ...
  inline AllocateHostedConnectionResult& WithPrefixPoolUnallocatedCountIpv4(int value) {
  ...
  inline AllocateHostedConnectionResult& WithPrefixPoolUnallocatedCountIpv6(int value) {
  ...
  inline AllocateHostedConnectionResult& WithBillingMode(BillingMode value) {
