...
class CreatePrivateVirtualInterfaceRequest : public DirectConnectRequest {
 public:
  ...
  template <typename ConnectionIdT = Aws::String>
  CreatePrivateVirtualInterfaceRequest& WithConnectionId(ConnectionIdT&& value) {
  ...
  void SetNewPrivateVirtualInterface(NewPrivateVirtualInterfaceT&& value) {
    m_newPrivateVirtualInterfaceHasBeenSet = true;
    m_newPrivateVirtualInterface = std::forward<NewPrivateVirtualInterfaceT>(value);
  }
  template <typename NewPrivateVirtualInterfaceT = NewPrivateVirtualInterface>
  CreatePrivateVirtualInterfaceRequest& WithNewPrivateVirtualInterface(NewPrivateVirtualInterfaceT&& value) {
    SetNewPrivateVirtualInterface(std::forward<NewPrivateVirtualInterfaceT>(value));
    return *this;
  }
  ///@}
 private:
