...
class ConfirmPrivateVirtualInterfaceRequest : public DirectConnectRequest {
 public:
  ...
  template <typename VirtualInterfaceIdT = Aws::String>
  ConfirmPrivateVirtualInterfaceRequest& WithVirtualInterfaceId(VirtualInterfaceIdT&& value) {
  ...
  template <typename VirtualGatewayIdT = Aws::String>
  ConfirmPrivateVirtualInterfaceRequest& WithVirtualGatewayId(VirtualGatewayIdT&& value) {
  ...
  template <typename DirectConnectGatewayIdT = Aws::String>
  ConfirmPrivateVirtualInterfaceRequest& WithDirectConnectGatewayId(DirectConnectGatewayIdT&& value) {
