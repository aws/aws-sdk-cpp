...
class UpdateLagResult {
 public:
  ...
  void SetConnectionsBandwidth(ConnectionsBandwidthT&& value) {
    ...
    m_connectionsBandwidth = std::forward<ConnectionsBandwidthT>(value);
  }
  template <typename ConnectionsBandwidthT = Aws::String>
  UpdateLagResult& WithConnectionsBandwidth(ConnectionsBandwidthT&& value) {
    SetConnectionsBandwidth(std::forward<ConnectionsBandwidthT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfConnections(int value) {
    m_numberOfConnectionsHasBeenSet = true;
    m_numberOfConnections = value;
  }
  inline UpdateLagResult& WithNumberOfConnections(int value) {
  ...
  void SetLagName(LagNameT&& value) {
    ...
    m_lagName = std::forward<LagNameT>(value);
  }
  template <typename LagNameT = Aws::String>
  UpdateLagResult& WithLagName(LagNameT&& value) {
    SetLagName(std::forward<LagNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLagState(LagState value) {
    m_lagStateHasBeenSet = true;
    m_lagState = value;
  }
  inline UpdateLagResult& WithLagState(LagState value) {
    SetLagState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumLinks(int value) {
    m_minimumLinksHasBeenSet = true;
    m_minimumLinks = value;
  }
  inline UpdateLagResult& WithMinimumLinks(int value) {
    SetMinimumLinks(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllowsHostedConnections(bool value) {
    m_allowsHostedConnectionsHasBeenSet = true;
    m_allowsHostedConnections = value;
  }
  inline UpdateLagResult& WithAllowsHostedConnections(bool value) {
    SetAllowsHostedConnections(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateLagResult& WithJumboFrameCapable(bool value) {
  ...
  inline UpdateLagResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  inline UpdateLagResult& WithMacSecCapable(bool value) {
  ...
  inline UpdateLagResult& WithPrefixPoolSizeIpv4(int value) {
  ...
  inline UpdateLagResult& WithPrefixPoolSizeIpv6(int value) {
  ...
  inline UpdateLagResult& WithPrefixPoolUnallocatedCountIpv4(int value) {
  ...
  inline UpdateLagResult& WithPrefixPoolUnallocatedCountIpv6(int value) {
  ...
  template <typename RateLimiterStatusT = RateLimiterStatus>
  UpdateLagResult& WithRateLimiterStatus(RateLimiterStatusT&& value) {
  ...
  inline UpdateLagResult& WithBillingMode(BillingMode value) {
