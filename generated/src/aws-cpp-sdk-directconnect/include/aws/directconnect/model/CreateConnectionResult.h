...
class CreateConnectionResult {
 public:
  ...
  inline CreateConnectionResult& WithConnectionState(ConnectionState value) {
  ...
  inline CreateConnectionResult& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline CreateConnectionResult& WithJumboFrameCapable(bool value) {
  ...
  inline CreateConnectionResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  inline CreateConnectionResult& WithMacSecCapable(bool value) {
  ...
  inline CreateConnectionResult& WithPartnerInterconnectMacSecCapable(bool value) {
  ...
  inline CreateConnectionResult& WithPrefixPoolSizeIpv4(int value) {
  ...
  inline CreateConnectionResult& WithPrefixPoolSizeIpv6(int value) {
  ...
  inline CreateConnectionResult& WithPrefixPoolUnallocatedCountIpv4(int value) {
  ...
  inline CreateConnectionResult& WithPrefixPoolUnallocatedCountIpv6(int value) {
  ...
  inline CreateConnectionResult& WithBillingMode(BillingMode value) {
