...
namespace Model
{
  ...
  public:
    ...
    template<typename OwnerAccountT = Aws::String>
    CreateConnectionResult& WithOwnerAccount(OwnerAccountT&& value) { SetOwnerAccount(std::forward<OwnerAccountT>(value)); return *this;}
    ///@}
    ...
    template<typename ConnectionNameT = Aws::String>
    CreateConnectionResult& WithConnectionName(ConnectionNameT&& value) { SetConnectionName(std::forward<ConnectionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RegionT = Aws::String>
    CreateConnectionResult& WithRegion(RegionT&& value) { SetRegion(std::forward<RegionT>(value)); return *this;}
    ///@}
    ...
    template<typename LocationT = Aws::String>
    CreateConnectionResult& WithLocation(LocationT&& value) { SetLocation(std::forward<LocationT>(value)); return *this;}
    ///@}
    ...
    template<typename BandwidthT = Aws::String>
    CreateConnectionResult& WithBandwidth(BandwidthT&& value) { SetBandwidth(std::forward<BandwidthT>(value)); return *this;}
    ///@}
    ...
    template<typename PartnerNameT = Aws::String>
    CreateConnectionResult& WithPartnerName(PartnerNameT&& value) { SetPartnerName(std::forward<PartnerNameT>(value)); return *this;}
    ///@}
    ...
    template<typename LoaIssueTimeT = Aws::Utils::DateTime>
    CreateConnectionResult& WithLoaIssueTime(LoaIssueTimeT&& value) { SetLoaIssueTime(std::forward<LoaIssueTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename LagIdT = Aws::String>
    CreateConnectionResult& WithLagId(LagIdT&& value) { SetLagId(std::forward<LagIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsDeviceT = Aws::String>
    CreateConnectionResult& WithAwsDevice(AwsDeviceT&& value) { SetAwsDevice(std::forward<AwsDeviceT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsDeviceV2T = Aws::String>
    CreateConnectionResult& WithAwsDeviceV2(AwsDeviceV2T&& value) { SetAwsDeviceV2(std::forward<AwsDeviceV2T>(value)); return *this;}
    ///@}
    ...
    template<typename AwsLogicalDeviceIdT = Aws::String>
    CreateConnectionResult& WithAwsLogicalDeviceId(AwsLogicalDeviceIdT&& value) { SetAwsLogicalDeviceId(std::forward<AwsLogicalDeviceIdT>(value)); return *this;}
    ///@}
    ...
    inline CreateConnectionResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) { SetHasLogicalRedundancy(value); return *this;}
    ///@}
    ...
    template<typename ProviderNameT = Aws::String>
    CreateConnectionResult& WithProviderName(ProviderNameT&& value) { SetProviderName(std::forward<ProviderNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PortEncryptionStatusT = Aws::String>
    CreateConnectionResult& WithPortEncryptionStatus(PortEncryptionStatusT&& value) { SetPortEncryptionStatus(std::forward<PortEncryptionStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename EncryptionModeT = Aws::String>
    CreateConnectionResult& WithEncryptionMode(EncryptionModeT&& value) { SetEncryptionMode(std::forward<EncryptionModeT>(value)); return *this;}
    ///@}
    ...
    template<typename MacSecKeysT = Aws::Vector<MacSecKey>>
    CreateConnectionResult& WithMacSecKeys(MacSecKeysT&& value) { SetMacSecKeys(std::forward<MacSecKeysT>(value)); return *this;}
    template<typename MacSecKeysT = MacSecKey>
    CreateConnectionResult& AddMacSecKeys(MacSecKeysT&& value) { m_macSecKeysHasBeenSet = true; m_macSecKeys.emplace_back(std::forward<MacSecKeysT>(value)); return *this; }
    ///@}
    ...
    inline CreateConnectionResult& WithPartnerInterconnectMacSecCapable(bool value) { SetPartnerInterconnectMacSecCapable(value); return *this;}
    ///@}
