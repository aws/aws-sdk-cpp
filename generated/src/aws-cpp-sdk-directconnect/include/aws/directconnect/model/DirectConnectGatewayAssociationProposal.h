...
class DirectConnectGatewayAssociationProposal {
 public:
  ...
  void SetDirectConnectGatewayOwnerAccount(DirectConnectGatewayOwnerAccountT&& value) {
    ...
    m_directConnectGatewayOwnerAccount = std::forward<DirectConnectGatewayOwnerAccountT>(value);
  }
  template <typename DirectConnectGatewayOwnerAccountT = Aws::String>
  DirectConnectGatewayAssociationProposal& WithDirectConnectGatewayOwnerAccount(DirectConnectGatewayOwnerAccountT&& value) {
    SetDirectConnectGatewayOwnerAccount(std::forward<DirectConnectGatewayOwnerAccountT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProposalState(DirectConnectGatewayAssociationProposalState value) {
    m_proposalStateHasBeenSet = true;
    m_proposalState = value;
  }
  inline DirectConnectGatewayAssociationProposal& WithProposalState(DirectConnectGatewayAssociationProposalState value) {
    SetProposalState(value);
    return *this;
  }
  ///@}
  ...
  void SetAssociatedGateway(AssociatedGatewayT&& value) {
    ...
    m_associatedGateway = std::forward<AssociatedGatewayT>(value);
  }
  template <typename AssociatedGatewayT = AssociatedGateway>
  DirectConnectGatewayAssociationProposal& WithAssociatedGateway(AssociatedGatewayT&& value) {
    SetAssociatedGateway(std::forward<AssociatedGatewayT>(value));
    return *this;
  }
  ///@}
   ...
   * gateway.</p>
   */
  inline const Aws::Vector<RouteFilterPrefix>& GetExistingAllowedPrefixesToDirectConnectGateway() const {
    return m_existingAllowedPrefixesToDirectConnectGateway;
  }
  inline bool ExistingAllowedPrefixesToDirectConnectGatewayHasBeenSet() const {
    return m_existingAllowedPrefixesToDirectConnectGatewayHasBeenSet;
  }
  ...
  void SetExistingAllowedPrefixesToDirectConnectGateway(ExistingAllowedPrefixesToDirectConnectGatewayT&& value) {
    ...
    m_existingAllowedPrefixesToDirectConnectGateway = std::forward<ExistingAllowedPrefixesToDirectConnectGatewayT>(value);
  }
  template <typename ExistingAllowedPrefixesToDirectConnectGatewayT = Aws::Vector<RouteFilterPrefix>>
  DirectConnectGatewayAssociationProposal& WithExistingAllowedPrefixesToDirectConnectGateway(
      ExistingAllowedPrefixesToDirectConnectGatewayT&& value) {
    SetExistingAllowedPrefixesToDirectConnectGateway(std::forward<ExistingAllowedPrefixesToDirectConnectGatewayT>(value));
    return *this;
  }
  template <typename ExistingAllowedPrefixesToDirectConnectGatewayT = RouteFilterPrefix>
  DirectConnectGatewayAssociationProposal& AddExistingAllowedPrefixesToDirectConnectGateway(
      ExistingAllowedPrefixesToDirectConnectGatewayT&& value) {
    m_existingAllowedPrefixesToDirectConnectGatewayHasBeenSet = true;
    m_existingAllowedPrefixesToDirectConnectGateway.emplace_back(std::forward<ExistingAllowedPrefixesToDirectConnectGatewayT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<RouteFilterPrefix>& GetRequestedAllowedPrefixesToDirectConnectGateway() const {
    return m_requestedAllowedPrefixesToDirectConnectGateway;
  }
  inline bool RequestedAllowedPrefixesToDirectConnectGatewayHasBeenSet() const {
    return m_requestedAllowedPrefixesToDirectConnectGatewayHasBeenSet;
  }
  ...
  void SetRequestedAllowedPrefixesToDirectConnectGateway(RequestedAllowedPrefixesToDirectConnectGatewayT&& value) {
    ...
    m_requestedAllowedPrefixesToDirectConnectGateway = std::forward<RequestedAllowedPrefixesToDirectConnectGatewayT>(value);
  }
  template <typename RequestedAllowedPrefixesToDirectConnectGatewayT = Aws::Vector<RouteFilterPrefix>>
  DirectConnectGatewayAssociationProposal& WithRequestedAllowedPrefixesToDirectConnectGateway(
      RequestedAllowedPrefixesToDirectConnectGatewayT&& value) {
    SetRequestedAllowedPrefixesToDirectConnectGateway(std::forward<RequestedAllowedPrefixesToDirectConnectGatewayT>(value));
    return *this;
  }
  template <typename RequestedAllowedPrefixesToDirectConnectGatewayT = RouteFilterPrefix>
  DirectConnectGatewayAssociationProposal& AddRequestedAllowedPrefixesToDirectConnectGateway(
      RequestedAllowedPrefixesToDirectConnectGatewayT&& value) {
    m_requestedAllowedPrefixesToDirectConnectGatewayHasBeenSet = true;
    m_requestedAllowedPrefixesToDirectConnectGateway.emplace_back(std::forward<RequestedAllowedPrefixesToDirectConnectGatewayT>(value));
    return *this;
  }
  ///@}
 private:
