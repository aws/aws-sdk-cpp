...
class UpdateVirtualInterfaceAttributesResult {
 public:
  ...
  AWS_DIRECTCONNECT_API UpdateVirtualInterfaceAttributesResult& operator=(
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithAsn(int value) {
    SetAsn(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithAsnLong(long long value) {
    SetAsnLong(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithAmazonSideAsn(long long value) {
  ...
  template <typename AuthKeyT = Aws::String>
  UpdateVirtualInterfaceAttributesResult& WithAuthKey(AuthKeyT&& value) {
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithAddressFamily(AddressFamily value) {
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithVirtualInterfaceState(VirtualInterfaceState value) {
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithMtu(int value) {
    SetMtu(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithJumboFrameCapable(bool value) {
  ...
  template <typename RegionT = Aws::String>
  UpdateVirtualInterfaceAttributesResult& WithRegion(RegionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  UpdateVirtualInterfaceAttributesResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  UpdateVirtualInterfaceAttributesResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithSiteLinkEnabled(bool value) {
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithPrefixPoolAllocatedCountIpv4(int value) {
  ...
  inline UpdateVirtualInterfaceAttributesResult& WithPrefixPoolAllocatedCountIpv6(int value) {
  ...
  template <typename RateLimitT = Aws::String>
  UpdateVirtualInterfaceAttributesResult& WithRateLimit(RateLimitT&& value) {
