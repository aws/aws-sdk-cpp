...
namespace Model {
class DisassociateConnectionsFromResiliencyGroupResult {
 public:
  AWS_DIRECTCONNECT_API DisassociateConnectionsFromResiliencyGroupResult() = default;
  AWS_DIRECTCONNECT_API DisassociateConnectionsFromResiliencyGroupResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_DIRECTCONNECT_API DisassociateConnectionsFromResiliencyGroupResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ResiliencyGroupAssociationsT = Aws::Vector<ResiliencyGroupAssociation>>
  DisassociateConnectionsFromResiliencyGroupResult& WithResiliencyGroupAssociations(ResiliencyGroupAssociationsT&& value) {
  ...
  DisassociateConnectionsFromResiliencyGroupResult& AddResiliencyGroupAssociations(ResiliencyGroupAssociationsT&& value) {
    m_resiliencyGroupAssociationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateConnectionsFromResiliencyGroupResult& WithRequestId(RequestIdT&& value) {
