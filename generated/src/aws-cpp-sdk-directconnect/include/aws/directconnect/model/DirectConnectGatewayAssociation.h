...
class DirectConnectGatewayAssociation {
 public:
  ...
  inline void SetAssociationState(DirectConnectGatewayAssociationState value) {
    m_associationStateHasBeenSet = true;
    m_associationState = value;
  }
  inline DirectConnectGatewayAssociation& WithAssociationState(DirectConnectGatewayAssociationState value) {
   ...
   */
  inline const Aws::Vector<RouteFilterPrefix>& GetAllowedPrefixesToDirectConnectGateway() const {
    return m_allowedPrefixesToDirectConnectGateway;
  }
  ...
  void SetAllowedPrefixesToDirectConnectGateway(AllowedPrefixesToDirectConnectGatewayT&& value) {
    ...
    m_allowedPrefixesToDirectConnectGateway = std::forward<AllowedPrefixesToDirectConnectGatewayT>(value);
  }
  template <typename AllowedPrefixesToDirectConnectGatewayT = Aws::Vector<RouteFilterPrefix>>
  DirectConnectGatewayAssociation& WithAllowedPrefixesToDirectConnectGateway(AllowedPrefixesToDirectConnectGatewayT&& value) {
    SetAllowedPrefixesToDirectConnectGateway(std::forward<AllowedPrefixesToDirectConnectGatewayT>(value));
    return *this;
  }
  ...
  DirectConnectGatewayAssociation& AddAllowedPrefixesToDirectConnectGateway(AllowedPrefixesToDirectConnectGatewayT&& value) {
    m_allowedPrefixesToDirectConnectGatewayHasBeenSet = true;
    m_allowedPrefixesToDirectConnectGateway.emplace_back(std::forward<AllowedPrefixesToDirectConnectGatewayT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssociatedCoreNetwork(AssociatedCoreNetworkT&& value) {
    ...
    m_associatedCoreNetwork = std::forward<AssociatedCoreNetworkT>(value);
  }
  template <typename AssociatedCoreNetworkT = AssociatedCoreNetwork>
  DirectConnectGatewayAssociation& WithAssociatedCoreNetwork(AssociatedCoreNetworkT&& value) {
    SetAssociatedCoreNetwork(std::forward<AssociatedCoreNetworkT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVirtualGatewayRegion(VirtualGatewayRegionT&& value) {
    ...
    m_virtualGatewayRegion = std::forward<VirtualGatewayRegionT>(value);
  }
  template <typename VirtualGatewayRegionT = Aws::String>
  DirectConnectGatewayAssociation& WithVirtualGatewayRegion(VirtualGatewayRegionT&& value) {
    SetVirtualGatewayRegion(std::forward<VirtualGatewayRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVirtualGatewayOwnerAccount(VirtualGatewayOwnerAccountT&& value) {
    ...
    m_virtualGatewayOwnerAccount = std::forward<VirtualGatewayOwnerAccountT>(value);
  }
  template <typename VirtualGatewayOwnerAccountT = Aws::String>
  DirectConnectGatewayAssociation& WithVirtualGatewayOwnerAccount(VirtualGatewayOwnerAccountT&& value) {
    SetVirtualGatewayOwnerAccount(std::forward<VirtualGatewayOwnerAccountT>(value));
    return *this;
  }
  ///@}
 private:
