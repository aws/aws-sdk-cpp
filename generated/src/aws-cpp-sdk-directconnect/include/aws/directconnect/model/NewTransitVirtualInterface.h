...
namespace Model
{
  ...
  public:
    ...
    template<typename VirtualInterfaceNameT = Aws::String>
    NewTransitVirtualInterface& WithVirtualInterfaceName(VirtualInterfaceNameT&& value) { SetVirtualInterfaceName(std::forward<VirtualInterfaceNameT>(value)); return *this;}
    ///@}
    ...
    ///@{
    /**
     * <p>The long ASN for a new transit virtual interface.The valid range is from 1 to
    ...
    inline NewTransitVirtualInterface& WithAsnLong(long long value) { SetAsnLong(value); return *this;}
    ///@}
    ...
    template<typename AuthKeyT = Aws::String>
    NewTransitVirtualInterface& WithAuthKey(AuthKeyT&& value) { SetAuthKey(std::forward<AuthKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename AmazonAddressT = Aws::String>
    NewTransitVirtualInterface& WithAmazonAddress(AmazonAddressT&& value) { SetAmazonAddress(std::forward<AmazonAddressT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomerAddressT = Aws::String>
    NewTransitVirtualInterface& WithCustomerAddress(CustomerAddressT&& value) { SetCustomerAddress(std::forward<CustomerAddressT>(value)); return *this;}
    ///@}
    ...
    inline NewTransitVirtualInterface& WithAddressFamily(AddressFamily value) { SetAddressFamily(value); return *this;}
    ///@}
    ...
    template<typename DirectConnectGatewayIdT = Aws::String>
    NewTransitVirtualInterface& WithDirectConnectGatewayId(DirectConnectGatewayIdT&& value) { SetDirectConnectGatewayId(std::forward<DirectConnectGatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Vector<Tag>>
    NewTransitVirtualInterface& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsT = Tag>
    NewTransitVirtualInterface& AddTags(TagsT&& value) { m_tagsHasBeenSet = true; m_tags.emplace_back(std::forward<TagsT>(value)); return *this; }
    ///@}
