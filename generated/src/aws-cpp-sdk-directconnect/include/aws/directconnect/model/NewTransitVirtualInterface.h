...
class NewTransitVirtualInterface {
 public:
  ...
  inline NewTransitVirtualInterface& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline NewTransitVirtualInterface& WithAsn(int value) {
    SetAsn(value);
    return *this;
  }
  ///@}
  ...
  inline NewTransitVirtualInterface& WithAsnLong(long long value) {
    SetAsnLong(value);
    return *this;
  }
  ///@}
  ...
  inline NewTransitVirtualInterface& WithMtu(int value) {
    SetMtu(value);
    return *this;
  }
  ///@}
  ...
  inline NewTransitVirtualInterface& WithAddressFamily(AddressFamily value) {
  ...
  inline NewTransitVirtualInterface& WithEnableSiteLink(bool value) {
