...
class DescribeHostedConnectionsResult {
 public:
  ...
  template <typename ConnectionsT = Aws::Vector<Connection>>
  DescribeHostedConnectionsResult& WithConnections(ConnectionsT&& value) {
    SetConnections(std::forward<ConnectionsT>(value));
    return *this;
  }
  template <typename ConnectionsT = Connection>
  DescribeHostedConnectionsResult& AddConnections(ConnectionsT&& value) {
    m_connectionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeHostedConnectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeHostedConnectionsResult& WithRequestId(RequestIdT&& value) {
