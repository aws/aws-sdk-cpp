...
class BGPPeer {
 public:
  ...
  void SetBgpPeerId(BgpPeerIdT&& value) {
    ...
    m_bgpPeerId = std::forward<BgpPeerIdT>(value);
  }
  template <typename BgpPeerIdT = Aws::String>
  BGPPeer& WithBgpPeerId(BgpPeerIdT&& value) {
    SetBgpPeerId(std::forward<BgpPeerIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline BGPPeer& WithAsn(int value) {
    SetAsn(value);
    return *this;
  }
  ///@}
   ...
   * BGP configuration. </p> <p>Note the following limitations when using
   * <code>asnLong</code>:</p> <ul> <li> <p>You can use <code>asnLong</code> or
  ...
  inline BGPPeer& WithAsnLong(long long value) {
    SetAsnLong(value);
    return *this;
  }
  ///@}
  ...
  inline BGPPeer& WithAddressFamily(AddressFamily value) {
  ...
  inline void SetBgpPeerState(BGPPeerState value) {
    m_bgpPeerStateHasBeenSet = true;
    m_bgpPeerState = value;
  }
  inline BGPPeer& WithBgpPeerState(BGPPeerState value) {
    SetBgpPeerState(value);
    return *this;
  }
  ///@}
  ...
  inline BGPPeer& WithBgpStatus(BGPStatus value) {
    SetBgpStatus(value);
    return *this;
  }
  ///@}
