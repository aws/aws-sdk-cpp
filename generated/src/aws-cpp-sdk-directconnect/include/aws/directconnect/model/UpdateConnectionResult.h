...
class UpdateConnectionResult {
 public:
  ...
  inline UpdateConnectionResult& WithConnectionState(ConnectionState value) {
  ...
  inline UpdateConnectionResult& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateConnectionResult& WithJumboFrameCapable(bool value) {
  ...
  inline UpdateConnectionResult& WithHasLogicalRedundancy(HasLogicalRedundancy value) {
  ...
  inline UpdateConnectionResult& WithMacSecCapable(bool value) {
  ...
  template <typename RateLimiterStatusT = RateLimiterStatus>
  UpdateConnectionResult& WithRateLimiterStatus(RateLimiterStatusT&& value) {
  ...
  inline UpdateConnectionResult& WithPartnerInterconnectMacSecCapable(bool value) {
  ...
  inline UpdateConnectionResult& WithPrefixPoolSizeIpv4(int value) {
  ...
  inline UpdateConnectionResult& WithPrefixPoolSizeIpv6(int value) {
  ...
  inline UpdateConnectionResult& WithPrefixPoolUnallocatedCountIpv4(int value) {
  ...
  inline UpdateConnectionResult& WithPrefixPoolUnallocatedCountIpv6(int value) {
  ...
  inline UpdateConnectionResult& WithBillingMode(BillingMode value) {
