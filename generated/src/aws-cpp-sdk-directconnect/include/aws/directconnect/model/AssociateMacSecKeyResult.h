...
class AssociateMacSecKeyResult {
 public:
  ...
  template <typename ConnectionIdT = Aws::String>
  AssociateMacSecKeyResult& WithConnectionId(ConnectionIdT&& value) {
  ...
  template <typename MacSecKeysT = Aws::Vector<MacSecKey>>
  AssociateMacSecKeyResult& WithMacSecKeys(MacSecKeysT&& value) {
    SetMacSecKeys(std::forward<MacSecKeysT>(value));
    return *this;
  }
  template <typename MacSecKeysT = MacSecKey>
  AssociateMacSecKeyResult& AddMacSecKeys(MacSecKeysT&& value) {
    m_macSecKeysHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AssociateMacSecKeyResult& WithRequestId(RequestIdT&& value) {
