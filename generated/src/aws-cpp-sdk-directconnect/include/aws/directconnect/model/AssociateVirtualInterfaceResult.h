...
class AssociateVirtualInterfaceResult {
 public:
  ...
  inline AssociateVirtualInterfaceResult& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline AssociateVirtualInterfaceResult& WithAsn(int value) {
    SetAsn(value);
    return *this;
  }
  ///@}
  ...
  inline AssociateVirtualInterfaceResult& WithAsnLong(long long value) {
    SetAsnLong(value);
    return *this;
  }
  ///@}
  ...
  inline AssociateVirtualInterfaceResult& WithAmazonSideAsn(long long value) {
  ...
  inline AssociateVirtualInterfaceResult& WithAddressFamily(AddressFamily value) {
  ...
  inline AssociateVirtualInterfaceResult& WithVirtualInterfaceState(VirtualInterfaceState value) {
  ...
  inline AssociateVirtualInterfaceResult& WithMtu(int value) {
    SetMtu(value);
    return *this;
  }
  ///@}
  ...
  inline AssociateVirtualInterfaceResult& WithJumboFrameCapable(bool value) {
  ...
  inline AssociateVirtualInterfaceResult& WithSiteLinkEnabled(bool value) {
  ...
  inline AssociateVirtualInterfaceResult& WithPrefixPoolAllocatedCountIpv4(int value) {
  ...
  inline AssociateVirtualInterfaceResult& WithPrefixPoolAllocatedCountIpv6(int value) {
