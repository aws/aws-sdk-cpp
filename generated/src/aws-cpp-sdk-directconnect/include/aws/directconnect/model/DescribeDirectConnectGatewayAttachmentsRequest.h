...
class DescribeDirectConnectGatewayAttachmentsRequest : public DirectConnectRequest {
 public:
  ...
  template <typename DirectConnectGatewayIdT = Aws::String>
  DescribeDirectConnectGatewayAttachmentsRequest& WithDirectConnectGatewayId(DirectConnectGatewayIdT&& value) {
  ...
  template <typename VirtualInterfaceIdT = Aws::String>
  DescribeDirectConnectGatewayAttachmentsRequest& WithVirtualInterfaceId(VirtualInterfaceIdT&& value) {
  ...
  inline DescribeDirectConnectGatewayAttachmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDirectConnectGatewayAttachmentsRequest& WithNextToken(NextTokenT&& value) {
