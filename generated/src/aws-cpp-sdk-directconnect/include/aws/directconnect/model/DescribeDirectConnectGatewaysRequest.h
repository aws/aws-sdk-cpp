...
class DescribeDirectConnectGatewaysRequest : public DirectConnectRequest {
 public:
  AWS_DIRECTCONNECT_API DescribeDirectConnectGatewaysRequest() = default;
  ...
  template <typename DirectConnectGatewayIdT = Aws::String>
  DescribeDirectConnectGatewaysRequest& WithDirectConnectGatewayId(DirectConnectGatewayIdT&& value) {
  ...
  inline DescribeDirectConnectGatewaysRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDirectConnectGatewaysRequest& WithNextToken(NextTokenT&& value) {
