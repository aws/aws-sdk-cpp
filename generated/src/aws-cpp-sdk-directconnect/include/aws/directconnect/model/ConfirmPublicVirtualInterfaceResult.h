...
class ConfirmPublicVirtualInterfaceResult {
 public:
  AWS_DIRECTCONNECT_API ConfirmPublicVirtualInterfaceResult() = default;
  ...
  AWS_DIRECTCONNECT_API ConfirmPublicVirtualInterfaceResult& operator=(
  ...
  inline ConfirmPublicVirtualInterfaceResult& WithVirtualInterfaceState(VirtualInterfaceState value) {
  ...
  template <typename RequestIdT = Aws::String>
  ConfirmPublicVirtualInterfaceResult& WithRequestId(RequestIdT&& value) {
