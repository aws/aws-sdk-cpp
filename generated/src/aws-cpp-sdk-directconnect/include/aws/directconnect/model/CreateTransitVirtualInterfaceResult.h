...
class CreateTransitVirtualInterfaceResult {
 public:
  ...
  AWS_DIRECTCONNECT_API CreateTransitVirtualInterfaceResult& operator=(
  ...
  template <typename VirtualInterfaceT = VirtualInterface>
  CreateTransitVirtualInterfaceResult& WithVirtualInterface(VirtualInterfaceT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTransitVirtualInterfaceResult& WithRequestId(RequestIdT&& value) {
