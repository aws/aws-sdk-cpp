...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTCONNECT_API CreateTransitVirtualInterfaceResult() = default;
    ...
    template<typename VirtualInterfaceT = VirtualInterface>
    CreateTransitVirtualInterfaceResult& WithVirtualInterface(VirtualInterfaceT&& value) { SetVirtualInterface(std::forward<VirtualInterfaceT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateTransitVirtualInterfaceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
