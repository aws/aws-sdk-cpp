...
class ListVirtualInterfaceTestHistoryResult {
 public:
  ...
  AWS_DIRECTCONNECT_API ListVirtualInterfaceTestHistoryResult& operator=(
  ...
  void SetVirtualInterfaceTestHistory(VirtualInterfaceTestHistoryT&& value) {
    m_virtualInterfaceTestHistoryHasBeenSet = true;
    m_virtualInterfaceTestHistory = std::forward<VirtualInterfaceTestHistoryT>(value);
  }
  template <typename VirtualInterfaceTestHistoryT = Aws::Vector<VirtualInterfaceTestHistory>>
  ListVirtualInterfaceTestHistoryResult& WithVirtualInterfaceTestHistory(VirtualInterfaceTestHistoryT&& value) {
    SetVirtualInterfaceTestHistory(std::forward<VirtualInterfaceTestHistoryT>(value));
    return *this;
  }
  template <typename VirtualInterfaceTestHistoryT = VirtualInterfaceTestHistory>
  ListVirtualInterfaceTestHistoryResult& AddVirtualInterfaceTestHistory(VirtualInterfaceTestHistoryT&& value) {
    m_virtualInterfaceTestHistoryHasBeenSet = true;
    m_virtualInterfaceTestHistory.emplace_back(std::forward<VirtualInterfaceTestHistoryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVirtualInterfaceTestHistoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVirtualInterfaceTestHistoryResult& WithRequestId(RequestIdT&& value) {
