...
class AWS_DIRECTCONNECT_API DirectConnectClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DirectConnectClient(const Aws::DirectConnect::DirectConnectClientConfiguration& clientConfiguration =
  ...
  DirectConnectClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<DirectConnectEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::DirectConnect::DirectConnectClientConfiguration& clientConfiguration =
                          Aws::DirectConnect::DirectConnectClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AcceptDirectConnectGatewayAssociationProposalOutcome AcceptDirectConnectGatewayAssociationProposal(
      const Model::AcceptDirectConnectGatewayAssociationProposalRequest& request) const;

  /**
   * A Callable wrapper for AcceptDirectConnectGatewayAssociationProposal that returns a future to the operation so that it can be executed
  ...
  Model::AcceptDirectConnectGatewayAssociationProposalOutcomeCallable AcceptDirectConnectGatewayAssociationProposalCallable(
      const AcceptDirectConnectGatewayAssociationProposalRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::AcceptDirectConnectGatewayAssociationProposal, request);
  }

  /**
   * An Async wrapper for AcceptDirectConnectGatewayAssociationProposal that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename AcceptDirectConnectGatewayAssociationProposalRequestT = Model::AcceptDirectConnectGatewayAssociationProposalRequest>
  void AcceptDirectConnectGatewayAssociationProposalAsync(
      const AcceptDirectConnectGatewayAssociationProposalRequestT& request,
  ...
  /**
   * A Callable wrapper for AllocateHostedConnection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AllocateHostedConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AllocateHostedConnectionRequestT = Model::AllocateHostedConnectionRequest>
  void AllocateHostedConnectionAsync(const AllocateHostedConnectionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::AllocatePrivateVirtualInterfaceOutcome AllocatePrivateVirtualInterface(
      const Model::AllocatePrivateVirtualInterfaceRequest& request) const;

  /**
   * A Callable wrapper for AllocatePrivateVirtualInterface that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AllocatePrivateVirtualInterfaceRequestT = Model::AllocatePrivateVirtualInterfaceRequest>
  Model::AllocatePrivateVirtualInterfaceOutcomeCallable AllocatePrivateVirtualInterfaceCallable(
      const AllocatePrivateVirtualInterfaceRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::AllocatePrivateVirtualInterface, request);
  }

  /**
   * An Async wrapper for AllocatePrivateVirtualInterface that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AllocatePrivateVirtualInterfaceRequestT = Model::AllocatePrivateVirtualInterfaceRequest>
  void AllocatePrivateVirtualInterfaceAsync(const AllocatePrivateVirtualInterfaceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::AllocatePublicVirtualInterfaceOutcome AllocatePublicVirtualInterface(
      const Model::AllocatePublicVirtualInterfaceRequest& request) const;

  /**
   * A Callable wrapper for AllocatePublicVirtualInterface that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AllocatePublicVirtualInterfaceRequestT = Model::AllocatePublicVirtualInterfaceRequest>
  Model::AllocatePublicVirtualInterfaceOutcomeCallable AllocatePublicVirtualInterfaceCallable(
      const AllocatePublicVirtualInterfaceRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::AllocatePublicVirtualInterface, request);
  }

  /**
   * An Async wrapper for AllocatePublicVirtualInterface that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AllocatePublicVirtualInterfaceRequestT = Model::AllocatePublicVirtualInterfaceRequest>
  void AllocatePublicVirtualInterfaceAsync(const AllocatePublicVirtualInterfaceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::AllocateTransitVirtualInterfaceOutcome AllocateTransitVirtualInterface(
      const Model::AllocateTransitVirtualInterfaceRequest& request) const;

  /**
   * A Callable wrapper for AllocateTransitVirtualInterface that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AllocateTransitVirtualInterfaceRequestT = Model::AllocateTransitVirtualInterfaceRequest>
  Model::AllocateTransitVirtualInterfaceOutcomeCallable AllocateTransitVirtualInterfaceCallable(
      const AllocateTransitVirtualInterfaceRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::AllocateTransitVirtualInterface, request);
  }

  /**
   * An Async wrapper for AllocateTransitVirtualInterface that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AllocateTransitVirtualInterfaceRequestT = Model::AllocateTransitVirtualInterfaceRequest>
  void AllocateTransitVirtualInterfaceAsync(const AllocateTransitVirtualInterfaceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateConnectionWithLagOutcome AssociateConnectionWithLag(
      const Model::AssociateConnectionWithLagRequest& request) const;

  /**
   * A Callable wrapper for AssociateConnectionWithLag that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateConnectionWithLagRequestT = Model::AssociateConnectionWithLagRequest>
  Model::AssociateConnectionWithLagOutcomeCallable AssociateConnectionWithLagCallable(
      const AssociateConnectionWithLagRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::AssociateConnectionWithLag, request);
  }

  /**
   * An Async wrapper for AssociateConnectionWithLag that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateConnectionWithLagRequestT = Model::AssociateConnectionWithLagRequest>
  void AssociateConnectionWithLagAsync(const AssociateConnectionWithLagRequestT& request,
  ...
  /**
   * A Callable wrapper for AssociateHostedConnection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AssociateHostedConnectionRequestT = Model::AssociateHostedConnectionRequest>
  Model::AssociateHostedConnectionOutcomeCallable AssociateHostedConnectionCallable(
      const AssociateHostedConnectionRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::AssociateHostedConnection, request);
  }

  /**
   * An Async wrapper for AssociateHostedConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateHostedConnectionRequestT = Model::AssociateHostedConnectionRequest>
  void AssociateHostedConnectionAsync(const AssociateHostedConnectionRequestT& request,
  ...
  /**
   * A Callable wrapper for AssociateMacSecKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateMacSecKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociateMacSecKeyRequestT = Model::AssociateMacSecKeyRequest>
  void AssociateMacSecKeyAsync(const AssociateMacSecKeyRequestT& request, const AssociateMacSecKeyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateVirtualInterface that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AssociateVirtualInterfaceRequestT = Model::AssociateVirtualInterfaceRequest>
  Model::AssociateVirtualInterfaceOutcomeCallable AssociateVirtualInterfaceCallable(
      const AssociateVirtualInterfaceRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::AssociateVirtualInterface, request);
  }

  /**
   * An Async wrapper for AssociateVirtualInterface that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateVirtualInterfaceRequestT = Model::AssociateVirtualInterfaceRequest>
  void AssociateVirtualInterfaceAsync(const AssociateVirtualInterfaceRequestT& request,
  ...
  /**
   * A Callable wrapper for ConfirmConnection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ConfirmConnection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ConfirmConnectionRequestT = Model::ConfirmConnectionRequest>
  void ConfirmConnectionAsync(const ConfirmConnectionRequestT& request, const ConfirmConnectionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ConfirmCustomerAgreement that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ConfirmCustomerAgreementRequestT = Model::ConfirmCustomerAgreementRequest>
  Model::ConfirmCustomerAgreementOutcomeCallable ConfirmCustomerAgreementCallable(
      const ConfirmCustomerAgreementRequestT& request = {}) const {
    return SubmitCallable(&DirectConnectClient::ConfirmCustomerAgreement, request);
  }

  /**
   * An Async wrapper for ConfirmCustomerAgreement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ConfirmCustomerAgreementRequestT = Model::ConfirmCustomerAgreementRequest>
  void ConfirmCustomerAgreementAsync(const ConfirmCustomerAgreementResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::ConfirmPrivateVirtualInterfaceOutcome ConfirmPrivateVirtualInterface(
      const Model::ConfirmPrivateVirtualInterfaceRequest& request) const;

  /**
   * A Callable wrapper for ConfirmPrivateVirtualInterface that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ConfirmPrivateVirtualInterfaceRequestT = Model::ConfirmPrivateVirtualInterfaceRequest>
  Model::ConfirmPrivateVirtualInterfaceOutcomeCallable ConfirmPrivateVirtualInterfaceCallable(
      const ConfirmPrivateVirtualInterfaceRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::ConfirmPrivateVirtualInterface, request);
  }

  /**
   * An Async wrapper for ConfirmPrivateVirtualInterface that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ConfirmPrivateVirtualInterfaceRequestT = Model::ConfirmPrivateVirtualInterfaceRequest>
  void ConfirmPrivateVirtualInterfaceAsync(const ConfirmPrivateVirtualInterfaceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ConfirmPublicVirtualInterfaceOutcome ConfirmPublicVirtualInterface(
      const Model::ConfirmPublicVirtualInterfaceRequest& request) const;

  /**
   * A Callable wrapper for ConfirmPublicVirtualInterface that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ConfirmPublicVirtualInterfaceRequestT = Model::ConfirmPublicVirtualInterfaceRequest>
  Model::ConfirmPublicVirtualInterfaceOutcomeCallable ConfirmPublicVirtualInterfaceCallable(
      const ConfirmPublicVirtualInterfaceRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::ConfirmPublicVirtualInterface, request);
  }

  /**
   * An Async wrapper for ConfirmPublicVirtualInterface that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ConfirmPublicVirtualInterfaceRequestT = Model::ConfirmPublicVirtualInterfaceRequest>
  void ConfirmPublicVirtualInterfaceAsync(const ConfirmPublicVirtualInterfaceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ConfirmTransitVirtualInterfaceOutcome ConfirmTransitVirtualInterface(
      const Model::ConfirmTransitVirtualInterfaceRequest& request) const;

  /**
   * A Callable wrapper for ConfirmTransitVirtualInterface that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ConfirmTransitVirtualInterfaceRequestT = Model::ConfirmTransitVirtualInterfaceRequest>
  Model::ConfirmTransitVirtualInterfaceOutcomeCallable ConfirmTransitVirtualInterfaceCallable(
      const ConfirmTransitVirtualInterfaceRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::ConfirmTransitVirtualInterface, request);
  }

  /**
   * An Async wrapper for ConfirmTransitVirtualInterface that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ConfirmTransitVirtualInterfaceRequestT = Model::ConfirmTransitVirtualInterfaceRequest>
  void ConfirmTransitVirtualInterfaceAsync(const ConfirmTransitVirtualInterfaceRequestT& request,
  ...
  /**
   * An Async wrapper for CreateBGPPeer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateBGPPeerRequestT = Model::CreateBGPPeerRequest>
  void CreateBGPPeerAsync(const CreateBGPPeerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const CreateBGPPeerRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDirectConnectGatewayOutcome CreateDirectConnectGateway(
      const Model::CreateDirectConnectGatewayRequest& request) const;

  /**
   * A Callable wrapper for CreateDirectConnectGateway that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateDirectConnectGatewayRequestT = Model::CreateDirectConnectGatewayRequest>
  Model::CreateDirectConnectGatewayOutcomeCallable CreateDirectConnectGatewayCallable(
      const CreateDirectConnectGatewayRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::CreateDirectConnectGateway, request);
  }

  /**
   * An Async wrapper for CreateDirectConnectGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDirectConnectGatewayRequestT = Model::CreateDirectConnectGatewayRequest>
  void CreateDirectConnectGatewayAsync(const CreateDirectConnectGatewayRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDirectConnectGatewayAssociationOutcome CreateDirectConnectGatewayAssociation(
      const Model::CreateDirectConnectGatewayAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateDirectConnectGatewayAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateDirectConnectGatewayAssociationRequestT = Model::CreateDirectConnectGatewayAssociationRequest>
  Model::CreateDirectConnectGatewayAssociationOutcomeCallable CreateDirectConnectGatewayAssociationCallable(
      const CreateDirectConnectGatewayAssociationRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::CreateDirectConnectGatewayAssociation, request);
  }

  /**
   * An Async wrapper for CreateDirectConnectGatewayAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateDirectConnectGatewayAssociationRequestT = Model::CreateDirectConnectGatewayAssociationRequest>
  void CreateDirectConnectGatewayAssociationAsync(const CreateDirectConnectGatewayAssociationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDirectConnectGatewayAssociationProposalOutcome CreateDirectConnectGatewayAssociationProposal(
      const Model::CreateDirectConnectGatewayAssociationProposalRequest& request) const;

  /**
   * A Callable wrapper for CreateDirectConnectGatewayAssociationProposal that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::CreateDirectConnectGatewayAssociationProposalOutcomeCallable CreateDirectConnectGatewayAssociationProposalCallable(
      const CreateDirectConnectGatewayAssociationProposalRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::CreateDirectConnectGatewayAssociationProposal, request);
  }

  /**
   * An Async wrapper for CreateDirectConnectGatewayAssociationProposal that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename CreateDirectConnectGatewayAssociationProposalRequestT = Model::CreateDirectConnectGatewayAssociationProposalRequest>
  void CreateDirectConnectGatewayAssociationProposalAsync(
      const CreateDirectConnectGatewayAssociationProposalRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateInterconnect that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateInterconnect that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateInterconnectRequestT = Model::CreateInterconnectRequest>
  void CreateInterconnectAsync(const CreateInterconnectRequestT& request, const CreateInterconnectResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateLag that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateLagRequestT = Model::CreateLagRequest>
  void CreateLagAsync(const CreateLagRequestT& request, const CreateLagResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePrivateVirtualInterfaceOutcome CreatePrivateVirtualInterface(
      const Model::CreatePrivateVirtualInterfaceRequest& request) const;

  /**
   * A Callable wrapper for CreatePrivateVirtualInterface that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePrivateVirtualInterfaceRequestT = Model::CreatePrivateVirtualInterfaceRequest>
  Model::CreatePrivateVirtualInterfaceOutcomeCallable CreatePrivateVirtualInterfaceCallable(
      const CreatePrivateVirtualInterfaceRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::CreatePrivateVirtualInterface, request);
  }

  /**
   * An Async wrapper for CreatePrivateVirtualInterface that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePrivateVirtualInterfaceRequestT = Model::CreatePrivateVirtualInterfaceRequest>
  void CreatePrivateVirtualInterfaceAsync(const CreatePrivateVirtualInterfaceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePublicVirtualInterfaceOutcome CreatePublicVirtualInterface(
      const Model::CreatePublicVirtualInterfaceRequest& request) const;

  /**
   * A Callable wrapper for CreatePublicVirtualInterface that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePublicVirtualInterfaceRequestT = Model::CreatePublicVirtualInterfaceRequest>
  Model::CreatePublicVirtualInterfaceOutcomeCallable CreatePublicVirtualInterfaceCallable(
      const CreatePublicVirtualInterfaceRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::CreatePublicVirtualInterface, request);
  }

  /**
   * An Async wrapper for CreatePublicVirtualInterface that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePublicVirtualInterfaceRequestT = Model::CreatePublicVirtualInterfaceRequest>
  void CreatePublicVirtualInterfaceAsync(const CreatePublicVirtualInterfaceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateTransitVirtualInterfaceOutcome CreateTransitVirtualInterface(
      const Model::CreateTransitVirtualInterfaceRequest& request) const;

  /**
   * A Callable wrapper for CreateTransitVirtualInterface that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateTransitVirtualInterfaceRequestT = Model::CreateTransitVirtualInterfaceRequest>
  Model::CreateTransitVirtualInterfaceOutcomeCallable CreateTransitVirtualInterfaceCallable(
      const CreateTransitVirtualInterfaceRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::CreateTransitVirtualInterface, request);
  }

  /**
   * An Async wrapper for CreateTransitVirtualInterface that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTransitVirtualInterfaceRequestT = Model::CreateTransitVirtualInterfaceRequest>
  void CreateTransitVirtualInterfaceAsync(const CreateTransitVirtualInterfaceRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteBGPPeer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteBGPPeerRequestT = Model::DeleteBGPPeerRequest>
  void DeleteBGPPeerAsync(const DeleteBGPPeerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const DeleteBGPPeerRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDirectConnectGatewayOutcome DeleteDirectConnectGateway(
      const Model::DeleteDirectConnectGatewayRequest& request) const;

  /**
   * A Callable wrapper for DeleteDirectConnectGateway that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDirectConnectGatewayRequestT = Model::DeleteDirectConnectGatewayRequest>
  Model::DeleteDirectConnectGatewayOutcomeCallable DeleteDirectConnectGatewayCallable(
      const DeleteDirectConnectGatewayRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::DeleteDirectConnectGateway, request);
  }

  /**
   * An Async wrapper for DeleteDirectConnectGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDirectConnectGatewayRequestT = Model::DeleteDirectConnectGatewayRequest>
  void DeleteDirectConnectGatewayAsync(const DeleteDirectConnectGatewayRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDirectConnectGatewayAssociationOutcome DeleteDirectConnectGatewayAssociation(
      const Model::DeleteDirectConnectGatewayAssociationRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteDirectConnectGatewayAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteDirectConnectGatewayAssociationRequestT = Model::DeleteDirectConnectGatewayAssociationRequest>
  Model::DeleteDirectConnectGatewayAssociationOutcomeCallable DeleteDirectConnectGatewayAssociationCallable(
      const DeleteDirectConnectGatewayAssociationRequestT& request = {}) const {
    return SubmitCallable(&DirectConnectClient::DeleteDirectConnectGatewayAssociation, request);
  }

  /**
   * An Async wrapper for DeleteDirectConnectGatewayAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteDirectConnectGatewayAssociationRequestT = Model::DeleteDirectConnectGatewayAssociationRequest>
  void DeleteDirectConnectGatewayAssociationAsync(const DeleteDirectConnectGatewayAssociationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const DeleteDirectConnectGatewayAssociationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDirectConnectGatewayAssociationProposalOutcome DeleteDirectConnectGatewayAssociationProposal(
      const Model::DeleteDirectConnectGatewayAssociationProposalRequest& request) const;

  /**
   * A Callable wrapper for DeleteDirectConnectGatewayAssociationProposal that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::DeleteDirectConnectGatewayAssociationProposalOutcomeCallable DeleteDirectConnectGatewayAssociationProposalCallable(
      const DeleteDirectConnectGatewayAssociationProposalRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::DeleteDirectConnectGatewayAssociationProposal, request);
  }

  /**
   * An Async wrapper for DeleteDirectConnectGatewayAssociationProposal that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DeleteDirectConnectGatewayAssociationProposalRequestT = Model::DeleteDirectConnectGatewayAssociationProposalRequest>
  void DeleteDirectConnectGatewayAssociationProposalAsync(
      const DeleteDirectConnectGatewayAssociationProposalRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteInterconnect that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInterconnect that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteInterconnectRequestT = Model::DeleteInterconnectRequest>
  void DeleteInterconnectAsync(const DeleteInterconnectRequestT& request, const DeleteInterconnectResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteLag that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteLagRequestT = Model::DeleteLagRequest>
  ...
  /**
   * A Callable wrapper for DeleteVirtualInterface that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteVirtualInterface that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteVirtualInterfaceRequestT = Model::DeleteVirtualInterfaceRequest>
  void DeleteVirtualInterfaceAsync(const DeleteVirtualInterfaceRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeConnections that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeConnections that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeConnectionsRequestT = Model::DescribeConnectionsRequest>
  void DescribeConnectionsAsync(const DescribeConnectionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeConnectionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeCustomerMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeCustomerMetadataRequestT = Model::DescribeCustomerMetadataRequest>
  Model::DescribeCustomerMetadataOutcomeCallable DescribeCustomerMetadataCallable(
      const DescribeCustomerMetadataRequestT& request = {}) const {
    return SubmitCallable(&DirectConnectClient::DescribeCustomerMetadata, request);
  }

  /**
   * An Async wrapper for DescribeCustomerMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCustomerMetadataRequestT = Model::DescribeCustomerMetadataRequest>
  void DescribeCustomerMetadataAsync(const DescribeCustomerMetadataResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeCustomerMetadataRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDirectConnectGatewayAssociationProposalsOutcome DescribeDirectConnectGatewayAssociationProposals(
      const Model::DescribeDirectConnectGatewayAssociationProposalsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDirectConnectGatewayAssociationProposals that returns a future to the operation so that it can be
  ...
  Model::DescribeDirectConnectGatewayAssociationProposalsOutcomeCallable DescribeDirectConnectGatewayAssociationProposalsCallable(
      const DescribeDirectConnectGatewayAssociationProposalsRequestT& request = {}) const {
    return SubmitCallable(&DirectConnectClient::DescribeDirectConnectGatewayAssociationProposals, request);
  }

  /**
   * An Async wrapper for DescribeDirectConnectGatewayAssociationProposals that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <
      typename DescribeDirectConnectGatewayAssociationProposalsRequestT = Model::DescribeDirectConnectGatewayAssociationProposalsRequest>
  void DescribeDirectConnectGatewayAssociationProposalsAsync(
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDirectConnectGatewayAssociationsOutcome DescribeDirectConnectGatewayAssociations(
      const Model::DescribeDirectConnectGatewayAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDirectConnectGatewayAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeDirectConnectGatewayAssociationsRequestT = Model::DescribeDirectConnectGatewayAssociationsRequest>
  Model::DescribeDirectConnectGatewayAssociationsOutcomeCallable DescribeDirectConnectGatewayAssociationsCallable(
      const DescribeDirectConnectGatewayAssociationsRequestT& request = {}) const {
    return SubmitCallable(&DirectConnectClient::DescribeDirectConnectGatewayAssociations, request);
  }

  /**
   * An Async wrapper for DescribeDirectConnectGatewayAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeDirectConnectGatewayAssociationsRequestT = Model::DescribeDirectConnectGatewayAssociationsRequest>
  void DescribeDirectConnectGatewayAssociationsAsync(const DescribeDirectConnectGatewayAssociationsResponseReceivedHandler& handler,
                                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                     const DescribeDirectConnectGatewayAssociationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDirectConnectGatewayAttachmentsOutcome DescribeDirectConnectGatewayAttachments(
      const Model::DescribeDirectConnectGatewayAttachmentsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDirectConnectGatewayAttachments that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeDirectConnectGatewayAttachmentsRequestT = Model::DescribeDirectConnectGatewayAttachmentsRequest>
  Model::DescribeDirectConnectGatewayAttachmentsOutcomeCallable DescribeDirectConnectGatewayAttachmentsCallable(
      const DescribeDirectConnectGatewayAttachmentsRequestT& request = {}) const {
    return SubmitCallable(&DirectConnectClient::DescribeDirectConnectGatewayAttachments, request);
  }

  /**
   * An Async wrapper for DescribeDirectConnectGatewayAttachments that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeDirectConnectGatewayAttachmentsRequestT = Model::DescribeDirectConnectGatewayAttachmentsRequest>
  void DescribeDirectConnectGatewayAttachmentsAsync(const DescribeDirectConnectGatewayAttachmentsResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                    const DescribeDirectConnectGatewayAttachmentsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDirectConnectGatewaysOutcome DescribeDirectConnectGateways(
      const Model::DescribeDirectConnectGatewaysRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDirectConnectGateways that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDirectConnectGatewaysRequestT = Model::DescribeDirectConnectGatewaysRequest>
  Model::DescribeDirectConnectGatewaysOutcomeCallable DescribeDirectConnectGatewaysCallable(
      const DescribeDirectConnectGatewaysRequestT& request = {}) const {
    return SubmitCallable(&DirectConnectClient::DescribeDirectConnectGateways, request);
  }

  /**
   * An Async wrapper for DescribeDirectConnectGateways that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDirectConnectGatewaysRequestT = Model::DescribeDirectConnectGatewaysRequest>
  void DescribeDirectConnectGatewaysAsync(const DescribeDirectConnectGatewaysResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeDirectConnectGatewaysRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeHostedConnections that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeHostedConnectionsRequestT = Model::DescribeHostedConnectionsRequest>
  Model::DescribeHostedConnectionsOutcomeCallable DescribeHostedConnectionsCallable(
      const DescribeHostedConnectionsRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::DescribeHostedConnections, request);
  }

  /**
   * An Async wrapper for DescribeHostedConnections that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeHostedConnectionsRequestT = Model::DescribeHostedConnectionsRequest>
  void DescribeHostedConnectionsAsync(const DescribeHostedConnectionsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeInterconnects that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeInterconnects that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInterconnectsRequestT = Model::DescribeInterconnectsRequest>
  void DescribeInterconnectsAsync(const DescribeInterconnectsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeInterconnectsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeLags that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeLagsRequestT = Model::DescribeLagsRequest>
  void DescribeLagsAsync(const DescribeLagsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const DescribeLagsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeLoa that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeLoaRequestT = Model::DescribeLoaRequest>
  void DescribeLoaAsync(const DescribeLoaRequestT& request, const DescribeLoaResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeLocations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeLocations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeLocationsRequestT = Model::DescribeLocationsRequest>
  void DescribeLocationsAsync(const DescribeLocationsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeLocationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRouterConfigurationOutcome DescribeRouterConfiguration(
      const Model::DescribeRouterConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeRouterConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRouterConfigurationRequestT = Model::DescribeRouterConfigurationRequest>
  Model::DescribeRouterConfigurationOutcomeCallable DescribeRouterConfigurationCallable(
      const DescribeRouterConfigurationRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::DescribeRouterConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeRouterConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRouterConfigurationRequestT = Model::DescribeRouterConfigurationRequest>
  void DescribeRouterConfigurationAsync(const DescribeRouterConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeTags that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeTagsRequestT = Model::DescribeTagsRequest>
  void DescribeTagsAsync(const DescribeTagsRequestT& request, const DescribeTagsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeVirtualGateways that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeVirtualGateways that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeVirtualGatewaysRequestT = Model::DescribeVirtualGatewaysRequest>
  void DescribeVirtualGatewaysAsync(const DescribeVirtualGatewaysResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DescribeVirtualGatewaysRequestT& request = {}) const {
   ...
   * includes the ASN value in both the <code>asn</code> and <code>asnLong</code>
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeVirtualInterfacesOutcome DescribeVirtualInterfaces(
      const Model::DescribeVirtualInterfacesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeVirtualInterfaces that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeVirtualInterfacesRequestT = Model::DescribeVirtualInterfacesRequest>
  Model::DescribeVirtualInterfacesOutcomeCallable DescribeVirtualInterfacesCallable(
      const DescribeVirtualInterfacesRequestT& request = {}) const {
    return SubmitCallable(&DirectConnectClient::DescribeVirtualInterfaces, request);
  }

  /**
   * An Async wrapper for DescribeVirtualInterfaces that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeVirtualInterfacesRequestT = Model::DescribeVirtualInterfacesRequest>
  void DescribeVirtualInterfacesAsync(const DescribeVirtualInterfacesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeVirtualInterfacesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateConnectionFromLagOutcome DisassociateConnectionFromLag(
      const Model::DisassociateConnectionFromLagRequest& request) const;

  /**
   * A Callable wrapper for DisassociateConnectionFromLag that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateConnectionFromLagRequestT = Model::DisassociateConnectionFromLagRequest>
  Model::DisassociateConnectionFromLagOutcomeCallable DisassociateConnectionFromLagCallable(
      const DisassociateConnectionFromLagRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::DisassociateConnectionFromLag, request);
  }

  /**
   * An Async wrapper for DisassociateConnectionFromLag that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateConnectionFromLagRequestT = Model::DisassociateConnectionFromLagRequest>
  void DisassociateConnectionFromLagAsync(const DisassociateConnectionFromLagRequestT& request,
  ...
  /**
   * A Callable wrapper for DisassociateMacSecKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateMacSecKey that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateMacSecKeyRequestT = Model::DisassociateMacSecKeyRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::ListVirtualInterfaceTestHistoryOutcome ListVirtualInterfaceTestHistory(
      const Model::ListVirtualInterfaceTestHistoryRequest& request = {}) const;

  /**
   * A Callable wrapper for ListVirtualInterfaceTestHistory that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListVirtualInterfaceTestHistoryRequestT = Model::ListVirtualInterfaceTestHistoryRequest>
  Model::ListVirtualInterfaceTestHistoryOutcomeCallable ListVirtualInterfaceTestHistoryCallable(
      const ListVirtualInterfaceTestHistoryRequestT& request = {}) const {
    return SubmitCallable(&DirectConnectClient::ListVirtualInterfaceTestHistory, request);
  }

  /**
   * An Async wrapper for ListVirtualInterfaceTestHistory that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListVirtualInterfaceTestHistoryRequestT = Model::ListVirtualInterfaceTestHistoryRequest>
  void ListVirtualInterfaceTestHistoryAsync(const ListVirtualInterfaceTestHistoryResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListVirtualInterfaceTestHistoryRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for StartBgpFailoverTest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartBgpFailoverTest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartBgpFailoverTestRequestT = Model::StartBgpFailoverTestRequest>
  void StartBgpFailoverTestAsync(const StartBgpFailoverTestRequestT& request, const StartBgpFailoverTestResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopBgpFailoverTest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopBgpFailoverTest that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopBgpFailoverTestRequestT = Model::StopBgpFailoverTestRequest>
  void StopBgpFailoverTestAsync(const StopBgpFailoverTestRequestT& request, const StopBgpFailoverTestResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDirectConnectGatewayOutcome UpdateDirectConnectGateway(
      const Model::UpdateDirectConnectGatewayRequest& request) const;

  /**
   * A Callable wrapper for UpdateDirectConnectGateway that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateDirectConnectGatewayRequestT = Model::UpdateDirectConnectGatewayRequest>
  Model::UpdateDirectConnectGatewayOutcomeCallable UpdateDirectConnectGatewayCallable(
      const UpdateDirectConnectGatewayRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::UpdateDirectConnectGateway, request);
  }

  /**
   * An Async wrapper for UpdateDirectConnectGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDirectConnectGatewayRequestT = Model::UpdateDirectConnectGatewayRequest>
  void UpdateDirectConnectGatewayAsync(const UpdateDirectConnectGatewayRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDirectConnectGatewayAssociationOutcome UpdateDirectConnectGatewayAssociation(
      const Model::UpdateDirectConnectGatewayAssociationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateDirectConnectGatewayAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateDirectConnectGatewayAssociationRequestT = Model::UpdateDirectConnectGatewayAssociationRequest>
  Model::UpdateDirectConnectGatewayAssociationOutcomeCallable UpdateDirectConnectGatewayAssociationCallable(
      const UpdateDirectConnectGatewayAssociationRequestT& request = {}) const {
    return SubmitCallable(&DirectConnectClient::UpdateDirectConnectGatewayAssociation, request);
  }

  /**
   * An Async wrapper for UpdateDirectConnectGatewayAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateDirectConnectGatewayAssociationRequestT = Model::UpdateDirectConnectGatewayAssociationRequest>
  void UpdateDirectConnectGatewayAssociationAsync(const UpdateDirectConnectGatewayAssociationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const UpdateDirectConnectGatewayAssociationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for UpdateLag that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateLagRequestT = Model::UpdateLagRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateVirtualInterfaceAttributesOutcome UpdateVirtualInterfaceAttributes(
      const Model::UpdateVirtualInterfaceAttributesRequest& request) const;

  /**
   * A Callable wrapper for UpdateVirtualInterfaceAttributes that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateVirtualInterfaceAttributesRequestT = Model::UpdateVirtualInterfaceAttributesRequest>
  Model::UpdateVirtualInterfaceAttributesOutcomeCallable UpdateVirtualInterfaceAttributesCallable(
      const UpdateVirtualInterfaceAttributesRequestT& request) const {
    return SubmitCallable(&DirectConnectClient::UpdateVirtualInterfaceAttributes, request);
  }

  /**
   * An Async wrapper for UpdateVirtualInterfaceAttributes that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateVirtualInterfaceAttributesRequestT = Model::UpdateVirtualInterfaceAttributesRequest>
  void UpdateVirtualInterfaceAttributesAsync(const UpdateVirtualInterfaceAttributesRequestT& request,
