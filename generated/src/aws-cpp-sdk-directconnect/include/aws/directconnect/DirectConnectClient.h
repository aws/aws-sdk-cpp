...
namespace DirectConnect
{
   ...
   */
  class AWS_DIRECTCONNECT_API DirectConnectClient : Aws::Client::ClientWithAsyncTemplateMethods<DirectConnectClient>,
    smithy::client::AwsSmithyClientT<Aws::DirectConnect::SERVICE_NAME,
