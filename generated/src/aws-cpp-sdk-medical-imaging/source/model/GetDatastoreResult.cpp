...
GetDatastoreResult::GetDatastoreResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetDatastoreResult& GetDatastoreResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
