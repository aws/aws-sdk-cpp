...
CopyDestinationImageSetProperties::CopyDestinationImageSetProperties(JsonView jsonValue) { *this = jsonValue; }

CopyDestinationImageSetProperties& CopyDestinationImageSetProperties::operator=(JsonView jsonValue) {
...
JsonValue CopyDestinationImageSetProperties::Jsonize() const {
  JsonValue payload;
