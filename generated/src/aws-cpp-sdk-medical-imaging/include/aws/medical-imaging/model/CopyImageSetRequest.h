...
class CopyImageSetRequest : public MedicalImagingRequest {
 public:
  ...
  void SetSourceImageSetId(SourceImageSetIdT&& value) {
    m_sourceImageSetIdHasBeenSet = true;
    m_sourceImageSetId = std::forward<SourceImageSetIdT>(value);
  }
  template <typename SourceImageSetIdT = Aws::String>
  CopyImageSetRequest& WithSourceImageSetId(SourceImageSetIdT&& value) {
    SetSourceImageSetId(std::forward<SourceImageSetIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopyImageSetInformation(CopyImageSetInformationT&& value) {
    m_copyImageSetInformationHasBeenSet = true;
    m_copyImageSetInformation = std::forward<CopyImageSetInformationT>(value);
  }
  template <typename CopyImageSetInformationT = CopyImageSetInformation>
  CopyImageSetRequest& WithCopyImageSetInformation(CopyImageSetInformationT&& value) {
    SetCopyImageSetInformation(std::forward<CopyImageSetInformationT>(value));
    return *this;
  }
  ///@}
  ...
  inline CopyImageSetRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPromoteToPrimary(bool value) {
    m_promoteToPrimaryHasBeenSet = true;
    m_promoteToPrimary = value;
  }
  inline CopyImageSetRequest& WithPromoteToPrimary(bool value) {
    SetPromoteToPrimary(value);
    return *this;
  }
  ///@}
 private:
