...
class StartDICOMImportJobResult {
 public:
  ...
  template <typename DatastoreIdT = Aws::String>
  StartDICOMImportJobResult& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  StartDICOMImportJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StartDICOMImportJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubmittedAtT = Aws::Utils::DateTime>
  StartDICOMImportJobResult& WithSubmittedAt(SubmittedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartDICOMImportJobResult& WithRequestId(RequestIdT&& value) {
