...
class DeleteImageSetResult {
 public:
  ...
  template <typename DatastoreIdT = Aws::String>
  DeleteImageSetResult& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename ImageSetIdT = Aws::String>
  DeleteImageSetResult& WithImageSetId(ImageSetIdT&& value) {
  ...
  inline DeleteImageSetResult& WithImageSetState(ImageSetState value) {
  ...
  inline DeleteImageSetResult& WithImageSetWorkflowStatus(ImageSetWorkflowStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteImageSetResult& WithRequestId(RequestIdT&& value) {
