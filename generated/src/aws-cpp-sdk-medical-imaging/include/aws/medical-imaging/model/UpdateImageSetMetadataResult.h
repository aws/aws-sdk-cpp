...
class UpdateImageSetMetadataResult {
 public:
  ...
  template <typename DatastoreIdT = Aws::String>
  UpdateImageSetMetadataResult& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename ImageSetIdT = Aws::String>
  UpdateImageSetMetadataResult& WithImageSetId(ImageSetIdT&& value) {
  ...
  template <typename LatestVersionIdT = Aws::String>
  UpdateImageSetMetadataResult& WithLatestVersionId(LatestVersionIdT&& value) {
  ...
  inline UpdateImageSetMetadataResult& WithImageSetState(ImageSetState value) {
  ...
  inline UpdateImageSetMetadataResult& WithImageSetWorkflowStatus(ImageSetWorkflowStatus value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateImageSetMetadataResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateImageSetMetadataResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename MessageT = Aws::String>
  UpdateImageSetMetadataResult& WithMessage(MessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateImageSetMetadataResult& WithRequestId(RequestIdT&& value) {
