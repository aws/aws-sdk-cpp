...
class ImageFrameInformation {
 public:
  ...
  void SetImageFrameId(ImageFrameIdT&& value) {
    m_imageFrameIdHasBeenSet = true;
    m_imageFrameId = std::forward<ImageFrameIdT>(value);
  }
  template <typename ImageFrameIdT = Aws::String>
  ImageFrameInformation& WithImageFrameId(ImageFrameIdT&& value) {
    SetImageFrameId(std::forward<ImageFrameIdT>(value));
    return *this;
  }
  ///@}
 private:
