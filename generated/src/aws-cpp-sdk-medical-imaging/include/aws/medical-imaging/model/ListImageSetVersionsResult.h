...
class ListImageSetVersionsResult {
 public:
  ...
  void SetImageSetPropertiesList(ImageSetPropertiesListT&& value) {
    m_imageSetPropertiesListHasBeenSet = true;
    m_imageSetPropertiesList = std::forward<ImageSetPropertiesListT>(value);
  }
  template <typename ImageSetPropertiesListT = Aws::Vector<ImageSetProperties>>
  ListImageSetVersionsResult& WithImageSetPropertiesList(ImageSetPropertiesListT&& value) {
    SetImageSetPropertiesList(std::forward<ImageSetPropertiesListT>(value));
    return *this;
  }
  template <typename ImageSetPropertiesListT = ImageSetProperties>
  ListImageSetVersionsResult& AddImageSetPropertiesList(ImageSetPropertiesListT&& value) {
    m_imageSetPropertiesListHasBeenSet = true;
    m_imageSetPropertiesList.emplace_back(std::forward<ImageSetPropertiesListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImageSetVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListImageSetVersionsResult& WithRequestId(RequestIdT&& value) {
