...
class UpdateImageSetMetadataRequest : public MedicalImagingRequest {
 public:
  ...
  template <typename DatastoreIdT = Aws::String>
  UpdateImageSetMetadataRequest& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename ImageSetIdT = Aws::String>
  UpdateImageSetMetadataRequest& WithImageSetId(ImageSetIdT&& value) {
  ...
  void SetLatestVersionId(LatestVersionIdT&& value) {
    ...
    m_latestVersionId = std::forward<LatestVersionIdT>(value);
  }
  template <typename LatestVersionIdT = Aws::String>
  UpdateImageSetMetadataRequest& WithLatestVersionId(LatestVersionIdT&& value) {
    SetLatestVersionId(std::forward<LatestVersionIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateImageSetMetadataRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
  ...
  void SetUpdateImageSetMetadataUpdates(UpdateImageSetMetadataUpdatesT&& value) {
    m_updateImageSetMetadataUpdatesHasBeenSet = true;
    m_updateImageSetMetadataUpdates = std::forward<UpdateImageSetMetadataUpdatesT>(value);
  }
  template <typename UpdateImageSetMetadataUpdatesT = MetadataUpdates>
  UpdateImageSetMetadataRequest& WithUpdateImageSetMetadataUpdates(UpdateImageSetMetadataUpdatesT&& value) {
    SetUpdateImageSetMetadataUpdates(std::forward<UpdateImageSetMetadataUpdatesT>(value));
    return *this;
  }
  ///@}
 private:
