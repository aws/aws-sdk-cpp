...
class CopyImageSetInformation {
 public:
  ...
  void SetSourceImageSet(SourceImageSetT&& value) {
    m_sourceImageSetHasBeenSet = true;
    m_sourceImageSet = std::forward<SourceImageSetT>(value);
  }
  template <typename SourceImageSetT = CopySourceImageSetInformation>
  CopyImageSetInformation& WithSourceImageSet(SourceImageSetT&& value) {
    SetSourceImageSet(std::forward<SourceImageSetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationImageSet(DestinationImageSetT&& value) {
    m_destinationImageSetHasBeenSet = true;
    m_destinationImageSet = std::forward<DestinationImageSetT>(value);
  }
  template <typename DestinationImageSetT = CopyDestinationImageSet>
  CopyImageSetInformation& WithDestinationImageSet(DestinationImageSetT&& value) {
    SetDestinationImageSet(std::forward<DestinationImageSetT>(value));
    return *this;
  }
  ///@}
 private:
