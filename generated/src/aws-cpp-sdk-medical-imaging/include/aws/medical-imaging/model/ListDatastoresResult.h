...
class ListDatastoresResult {
 public:
  ...
  void SetDatastoreSummaries(DatastoreSummariesT&& value) {
    m_datastoreSummariesHasBeenSet = true;
    m_datastoreSummaries = std::forward<DatastoreSummariesT>(value);
  }
  template <typename DatastoreSummariesT = Aws::Vector<DatastoreSummary>>
  ListDatastoresResult& WithDatastoreSummaries(DatastoreSummariesT&& value) {
    SetDatastoreSummaries(std::forward<DatastoreSummariesT>(value));
    return *this;
  }
  template <typename DatastoreSummariesT = DatastoreSummary>
  ListDatastoresResult& AddDatastoreSummaries(DatastoreSummariesT&& value) {
    m_datastoreSummariesHasBeenSet = true;
    m_datastoreSummaries.emplace_back(std::forward<DatastoreSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDatastoresResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDatastoresResult& WithRequestId(RequestIdT&& value) {
