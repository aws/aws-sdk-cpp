...
class ListDatastoresRequest : public MedicalImagingRequest {
 public:
  ...
  inline ListDatastoresRequest& WithDatastoreStatus(DatastoreStatus value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDatastoresRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDatastoresRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
