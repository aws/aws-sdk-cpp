...
class StartDICOMImportJobRequest : public MedicalImagingRequest {
 public:
  ...
  template <typename JobNameT = Aws::String>
  StartDICOMImportJobRequest& WithJobName(JobNameT&& value) {
  ...
  template <typename DataAccessRoleArnT = Aws::String>
  StartDICOMImportJobRequest& WithDataAccessRoleArn(DataAccessRoleArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StartDICOMImportJobRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DatastoreIdT = Aws::String>
  StartDICOMImportJobRequest& WithDatastoreId(DatastoreIdT&& value) {
  ...
  void SetInputS3Uri(InputS3UriT&& value) {
    m_inputS3UriHasBeenSet = true;
    m_inputS3Uri = std::forward<InputS3UriT>(value);
  }
  template <typename InputS3UriT = Aws::String>
  StartDICOMImportJobRequest& WithInputS3Uri(InputS3UriT&& value) {
    SetInputS3Uri(std::forward<InputS3UriT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OutputS3UriT = Aws::String>
  StartDICOMImportJobRequest& WithOutputS3Uri(OutputS3UriT&& value) {
  ...
  void SetInputOwnerAccountId(InputOwnerAccountIdT&& value) {
    m_inputOwnerAccountIdHasBeenSet = true;
    m_inputOwnerAccountId = std::forward<InputOwnerAccountIdT>(value);
  }
  template <typename InputOwnerAccountIdT = Aws::String>
  StartDICOMImportJobRequest& WithInputOwnerAccountId(InputOwnerAccountIdT&& value) {
    SetInputOwnerAccountId(std::forward<InputOwnerAccountIdT>(value));
    return *this;
  }
  ///@}
 private:
