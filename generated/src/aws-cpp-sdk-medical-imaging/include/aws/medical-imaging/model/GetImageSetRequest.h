...
class GetImageSetRequest : public MedicalImagingRequest {
 public:
  AWS_MEDICALIMAGING_API GetImageSetRequest() = default;
  ...
  template <typename DatastoreIdT = Aws::String>
  GetImageSetRequest& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename ImageSetIdT = Aws::String>
  GetImageSetRequest& WithImageSetId(ImageSetIdT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  GetImageSetRequest& WithVersionId(VersionIdT&& value) {
