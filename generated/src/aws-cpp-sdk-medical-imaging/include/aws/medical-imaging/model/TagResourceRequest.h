...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public MedicalImagingRequest
  {
  public:
    AWS_MEDICALIMAGING_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the medical imaging resource that tags are
     * being added to.</p>
     */
    ...
    ///@{
    /**
     * <p>The user-specified key and value tag pairs added to a medical imaging
     * resource.</p>
     */
