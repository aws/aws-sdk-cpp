...
class ListImageSetVersionsRequest : public MedicalImagingRequest {
 public:
  ...
  template <typename DatastoreIdT = Aws::String>
  ListImageSetVersionsRequest& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename ImageSetIdT = Aws::String>
  ListImageSetVersionsRequest& WithImageSetId(ImageSetIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListImageSetVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListImageSetVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
