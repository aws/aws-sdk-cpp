...
class DICOMImportJobSummary {
 public:
  ...
  template <typename JobIdT = Aws::String>
  DICOMImportJobSummary& WithJobId(JobIdT&& value) {
  ...
  template <typename JobNameT = Aws::String>
  DICOMImportJobSummary& WithJobName(JobNameT&& value) {
  ...
  inline DICOMImportJobSummary& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DatastoreIdT = Aws::String>
  DICOMImportJobSummary& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename DataAccessRoleArnT = Aws::String>
  DICOMImportJobSummary& WithDataAccessRoleArn(DataAccessRoleArnT&& value) {
  ...
  template <typename EndedAtT = Aws::Utils::DateTime>
  DICOMImportJobSummary& WithEndedAt(EndedAtT&& value) {
  ...
  template <typename SubmittedAtT = Aws::Utils::DateTime>
  DICOMImportJobSummary& WithSubmittedAt(SubmittedAtT&& value) {
  ...
  template <typename MessageT = Aws::String>
  DICOMImportJobSummary& WithMessage(MessageT&& value) {
