...
class GetImageSetMetadataRequest : public MedicalImagingRequest {
 public:
  ...
  template <typename DatastoreIdT = Aws::String>
  GetImageSetMetadataRequest& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename ImageSetIdT = Aws::String>
  GetImageSetMetadataRequest& WithImageSetId(ImageSetIdT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  GetImageSetMetadataRequest& WithVersionId(VersionIdT&& value) {
