...
class CopySourceImageSetProperties {
 public:
  ...
  template <typename ImageSetIdT = Aws::String>
  CopySourceImageSetProperties& WithImageSetId(ImageSetIdT&& value) {
  ...
  template <typename LatestVersionIdT = Aws::String>
  CopySourceImageSetProperties& WithLatestVersionId(LatestVersionIdT&& value) {
  ...
  inline CopySourceImageSetProperties& WithImageSetState(ImageSetState value) {
  ...
  inline CopySourceImageSetProperties& WithImageSetWorkflowStatus(ImageSetWorkflowStatus value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CopySourceImageSetProperties& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CopySourceImageSetProperties& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  void SetImageSetArn(ImageSetArnT&& value) {
    ...
    m_imageSetArn = std::forward<ImageSetArnT>(value);
  }
  template <typename ImageSetArnT = Aws::String>
  CopySourceImageSetProperties& WithImageSetArn(ImageSetArnT&& value) {
    SetImageSetArn(std::forward<ImageSetArnT>(value));
    return *this;
  }
  ///@}
 private:
