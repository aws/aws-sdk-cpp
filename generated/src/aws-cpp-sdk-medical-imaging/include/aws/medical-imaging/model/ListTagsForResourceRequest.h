...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public MedicalImagingRequest
  {
  public:
    AWS_MEDICALIMAGING_API ListTagsForResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the medical imaging resource to list tags
     * for.</p>
     */
