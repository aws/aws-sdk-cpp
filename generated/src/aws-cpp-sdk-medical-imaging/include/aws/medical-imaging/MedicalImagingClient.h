...
namespace MedicalImaging
{
   ...
   */
  class AWS_MEDICALIMAGING_API MedicalImagingClient : Aws::Client::ClientWithAsyncTemplateMethods<MedicalImagingClient>,
    smithy::client::AwsSmithyClientT<Aws::MedicalImaging::SERVICE_NAME,
