...
class AWS_MEDICALIMAGING_API MedicalImagingClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  MedicalImagingClient(const Aws::MedicalImaging::MedicalImagingClientConfiguration& clientConfiguration =
  ...
  MedicalImagingClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<MedicalImagingEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::MedicalImaging::MedicalImagingClientConfiguration& clientConfiguration =
                           Aws::MedicalImaging::MedicalImagingClientConfiguration());
  ...
  /**
   * An Async wrapper for CopyImageSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CopyImageSetRequestT = Model::CopyImageSetRequest>
  void CopyImageSetAsync(const CopyImageSetRequestT& request, const CopyImageSetResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for DeleteImageSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteImageSetRequestT = Model::DeleteImageSetRequest>
  void DeleteImageSetAsync(const DeleteImageSetRequestT& request, const DeleteImageSetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDICOMImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDICOMImportJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDICOMImportJobRequestT = Model::GetDICOMImportJobRequest>
  void GetDICOMImportJobAsync(const GetDICOMImportJobRequestT& request, const GetDICOMImportJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDatastore that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDatastoreRequestT = Model::GetDatastoreRequest>
  void GetDatastoreAsync(const GetDatastoreRequestT& request, const GetDatastoreResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetImageFrame that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetImageFrameRequestT = Model::GetImageFrameRequest>
  void GetImageFrameAsync(const GetImageFrameRequestT& request, const GetImageFrameResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetImageSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetImageSetRequestT = Model::GetImageSetRequest>
  void GetImageSetAsync(const GetImageSetRequestT& request, const GetImageSetResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetImageSetMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetImageSetMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetImageSetMetadataRequestT = Model::GetImageSetMetadataRequest>
  void GetImageSetMetadataAsync(const GetImageSetMetadataRequestT& request, const GetImageSetMetadataResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDICOMImportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDICOMImportJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDICOMImportJobsRequestT = Model::ListDICOMImportJobsRequest>
  void ListDICOMImportJobsAsync(const ListDICOMImportJobsRequestT& request, const ListDICOMImportJobsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListImageSetVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListImageSetVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListImageSetVersionsRequestT = Model::ListImageSetVersionsRequest>
  void ListImageSetVersionsAsync(const ListImageSetVersionsRequestT& request, const ListImageSetVersionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchImageSets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchImageSetsRequestT = Model::SearchImageSetsRequest>
  void SearchImageSetsAsync(const SearchImageSetsRequestT& request, const SearchImageSetsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartDICOMImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartDICOMImportJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartDICOMImportJobRequestT = Model::StartDICOMImportJobRequest>
  void StartDICOMImportJobAsync(const StartDICOMImportJobRequestT& request, const StartDICOMImportJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateImageSetMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateImageSetMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateImageSetMetadataRequestT = Model::UpdateImageSetMetadataRequest>
  void UpdateImageSetMetadataAsync(const UpdateImageSetMetadataRequestT& request,
                                   const UpdateImageSetMetadataResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
