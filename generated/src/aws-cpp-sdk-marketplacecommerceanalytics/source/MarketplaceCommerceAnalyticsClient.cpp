...
MarketplaceCommerceAnalyticsClient::MarketplaceCommerceAnalyticsClient(
    const AWSCredentials& credentials, std::shared_ptr<MarketplaceCommerceAnalyticsEndpointProviderBase> endpointProvider,
    const MarketplaceCommerceAnalytics::MarketplaceCommerceAnalyticsClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
...
MarketplaceCommerceAnalyticsClient::MarketplaceCommerceAnalyticsClient(const Aws::Client::ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<AWSAuthV4Signer>(
                    ALLOCATION_TAG,
                    Aws::MakeShared<DefaultAWSCredentialsProviderChain>(ALLOCATION_TAG, clientConfiguration.credentialProviderConfig),
...
MarketplaceCommerceAnalyticsClient::~MarketplaceCommerceAnalyticsClient() { ShutdownSdkClient(this, -1); }
...
void MarketplaceCommerceAnalyticsClient::init(const MarketplaceCommerceAnalytics::MarketplaceCommerceAnalyticsClientConfiguration& config) {
  ...
  m_endpointProvider->InitBuiltInParameters(config, "marketplacecommerceanalytics");
}
...
MarketplaceCommerceAnalyticsClient::InvokeOperationOutcome MarketplaceCommerceAnalyticsClient::InvokeServiceOperation(
  ...
  return TracingUtils::MakeCallWithTiming<InvokeOperationOutcome>(
      [&]() -> InvokeOperationOutcome {
        ...
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, GenerateDataSet, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        auto result =
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER);
        return result.IsSuccess() ? GenerateDataSetOutcome(GenerateDataSetResult(result.GetResultWithOwnership()))
                                  : GenerateDataSetOutcome(result.GetError());
      },
