...
class AWS_MARKETPLACECOMMERCEANALYTICS_API MarketplaceCommerceAnalyticsClient
 ...
 public:
  ...
  MarketplaceCommerceAnalyticsClient(
      const Aws::MarketplaceCommerceAnalytics::MarketplaceCommerceAnalyticsClientConfiguration& clientConfiguration =
  ...
  /**
   * An Async wrapper for GenerateDataSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GenerateDataSetRequestT = Model::GenerateDataSetRequest>
  void GenerateDataSetAsync(const GenerateDataSetRequestT& request, const GenerateDataSetResponseReceivedHandler& handler,
 ...
 private:
  ...
  typedef Aws::Utils::Outcome<Aws::AmazonWebServiceResult<RESPONSE>, MarketplaceCommerceAnalyticsError> InvokeOperationOutcome;
