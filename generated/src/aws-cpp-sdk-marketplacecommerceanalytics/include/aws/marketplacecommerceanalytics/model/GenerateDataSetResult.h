...
class GenerateDataSetResult {
 public:
  ...
  AWS_MARKETPLACECOMMERCEANALYTICS_API GenerateDataSetResult& operator=(
  ...
  void SetDataSetRequestId(DataSetRequestIdT&& value) {
    m_dataSetRequestIdHasBeenSet = true;
    m_dataSetRequestId = std::forward<DataSetRequestIdT>(value);
  }
  template <typename DataSetRequestIdT = Aws::String>
  GenerateDataSetResult& WithDataSetRequestId(DataSetRequestIdT&& value) {
    SetDataSetRequestId(std::forward<DataSetRequestIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GenerateDataSetResult& WithRequestId(RequestIdT&& value) {
