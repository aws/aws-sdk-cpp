...
/**
 * <p>The set of HTTP descriptor fields that can be individually
 * updated.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/UpdatedHttpDescriptorFields">AWS
 * API Reference</a></p>
 */
