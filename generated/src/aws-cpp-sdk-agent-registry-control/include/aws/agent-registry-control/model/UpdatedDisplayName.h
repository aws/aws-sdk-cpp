...
/**
 * <p>Leaf patch wrapper for a registry record's display name. Omit to leave
 * unchanged; supply an empty object to unset; supply optionalValue to
 * set.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/UpdatedDisplayName">AWS
 * API Reference</a></p>
 */
class UpdatedDisplayName {
 public:
  AWS_AGENTREGISTRYCONTROL_API UpdatedDisplayName() = default;
  AWS_AGENTREGISTRYCONTROL_API UpdatedDisplayName(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRYCONTROL_API UpdatedDisplayName& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename OptionalValueT = Aws::String>
  UpdatedDisplayName& WithOptionalValue(OptionalValueT&& value) {
