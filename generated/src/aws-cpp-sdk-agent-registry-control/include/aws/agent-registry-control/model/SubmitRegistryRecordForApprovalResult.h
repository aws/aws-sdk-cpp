...
namespace Model {
/**
 * <p>Response structure for submitting a registry record for
 * approval</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/SubmitRegistryRecordForApprovalResponse">AWS
 * API Reference</a></p>
 */
class SubmitRegistryRecordForApprovalResult {
 public:
  AWS_AGENTREGISTRYCONTROL_API SubmitRegistryRecordForApprovalResult() = default;
  AWS_AGENTREGISTRYCONTROL_API SubmitRegistryRecordForApprovalResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_AGENTREGISTRYCONTROL_API SubmitRegistryRecordForApprovalResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
