...
/**
 * <p>The request failed validation of one or more input fields.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/ValidationException">AWS
 * API Reference</a></p>
 */
class ValidationException {
 public:
  AWS_AGENTREGISTRYCONTROL_API ValidationException() = default;
  AWS_AGENTREGISTRYCONTROL_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRYCONTROL_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
