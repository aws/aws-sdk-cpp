...
/**
 * <p>The source configuration that defines where descriptor content is retrieved
 * from.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/DescriptorSource">AWS
 * API Reference</a></p>
 */
class DescriptorSource {
 public:
  ...
  ///@{
  /**
   * <p>URL-based descriptor source, populated when descriptor content is
