...
namespace Model {
/**
 * <p>Response structure for updating a registry record</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/UpdateRegistryRecordResponse">AWS
 * API Reference</a></p>
 */
class UpdateRegistryRecordResult {
 public:
  AWS_AGENTREGISTRYCONTROL_API UpdateRegistryRecordResult() = default;
  AWS_AGENTREGISTRYCONTROL_API UpdateRegistryRecordResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_AGENTREGISTRYCONTROL_API UpdateRegistryRecordResult& operator=(
  ...
  template <typename RegistryArnT = Aws::String>
  UpdateRegistryRecordResult& WithRegistryArn(RegistryArnT&& value) {
  ...
  template <typename RecordArnT = Aws::String>
  UpdateRegistryRecordResult& WithRecordArn(RecordArnT&& value) {
  ...
  template <typename RecordIdT = Aws::String>
  UpdateRegistryRecordResult& WithRecordId(RecordIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateRegistryRecordResult& WithName(NameT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  UpdateRegistryRecordResult& WithDisplayName(DisplayNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateRegistryRecordResult& WithDescription(DescriptionT&& value) {
  ...
  inline UpdateRegistryRecordResult& WithRecordType(RecordType value) {
    SetRecordType(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptorsT = Descriptors>
  UpdateRegistryRecordResult& WithDescriptors(DescriptorsT&& value) {
  ...
  template <typename RecordVersionT = Aws::String>
  UpdateRegistryRecordResult& WithRecordVersion(RecordVersionT&& value) {
  ...
  inline UpdateRegistryRecordResult& WithStatus(RegistryRecordStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateRegistryRecordResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateRegistryRecordResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename StatusReasonT = Aws::String>
  UpdateRegistryRecordResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename ProvenanceT = Aws::Vector<Provenance>>
  UpdateRegistryRecordResult& WithProvenance(ProvenanceT&& value) {
    SetProvenance(std::forward<ProvenanceT>(value));
    return *this;
  }
  template <typename ProvenanceT = Provenance>
  UpdateRegistryRecordResult& AddProvenance(ProvenanceT&& value) {
    m_provenanceHasBeenSet = true;
  ...
  inline UpdateRegistryRecordResult& WithCreatedByAutoDetection(bool value) {
  ...
  template <typename CreatedByT = Aws::String>
  UpdateRegistryRecordResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRegistryRecordResult& WithRequestId(RequestIdT&& value) {
