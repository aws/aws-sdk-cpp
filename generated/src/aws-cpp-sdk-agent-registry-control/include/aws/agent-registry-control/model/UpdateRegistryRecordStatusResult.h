...
namespace Model {
/**
 * <p>Response structure for updating a registry record status</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/UpdateRegistryRecordStatusResponse">AWS
 * API Reference</a></p>
 */
class UpdateRegistryRecordStatusResult {
 public:
  AWS_AGENTREGISTRYCONTROL_API UpdateRegistryRecordStatusResult() = default;
  AWS_AGENTREGISTRYCONTROL_API UpdateRegistryRecordStatusResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_AGENTREGISTRYCONTROL_API UpdateRegistryRecordStatusResult& operator=(
