...
/**
 * <p>Request structure for deleting a registry</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/DeleteRegistryRequest">AWS
 * API Reference</a></p>
 */
class DeleteRegistryRequest : public AgentRegistryControlRequest {
 public:
  AWS_AGENTREGISTRYCONTROL_API DeleteRegistryRequest() = default;
