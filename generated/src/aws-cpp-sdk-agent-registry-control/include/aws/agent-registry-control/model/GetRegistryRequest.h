...
/**
 * <p>Request structure for getting a registry</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/GetRegistryRequest">AWS
 * API Reference</a></p>
 */
class GetRegistryRequest : public AgentRegistryControlRequest {
 public:
  AWS_AGENTREGISTRYCONTROL_API GetRegistryRequest() = default;
