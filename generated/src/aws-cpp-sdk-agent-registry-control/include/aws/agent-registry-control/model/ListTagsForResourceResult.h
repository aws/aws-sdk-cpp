...
class ListTagsForResourceResult {
 public:
  AWS_AGENTREGISTRYCONTROL_API ListTagsForResourceResult() = default;
  AWS_AGENTREGISTRYCONTROL_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
