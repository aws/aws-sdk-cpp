...
/**
 * <p>A summary of a registry record returned by list operations. Contains
 * identifying and lifecycle fields but omits descriptor content.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/RegistryRecordSummary">AWS
 * API Reference</a></p>
 */
class RegistryRecordSummary {
 public:
  AWS_AGENTREGISTRYCONTROL_API RegistryRecordSummary() = default;
  AWS_AGENTREGISTRYCONTROL_API RegistryRecordSummary(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRYCONTROL_API RegistryRecordSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
