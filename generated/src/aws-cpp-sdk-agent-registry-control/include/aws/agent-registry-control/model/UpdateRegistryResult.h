...
namespace Model {
/**
 * <p>Response structure for updating a registry</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/UpdateRegistryResponse">AWS
 * API Reference</a></p>
 */
