...
/**
 * <p>The set of agent skills markdown descriptor fields that can be individually
 * updated.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/UpdatedAgentSkillsMdDescriptorFields">AWS
 * API Reference</a></p>
 */
class UpdatedAgentSkillsMdDescriptorFields {
 public:
  AWS_AGENTREGISTRYCONTROL_API UpdatedAgentSkillsMdDescriptorFields() = default;
  AWS_AGENTREGISTRYCONTROL_API UpdatedAgentSkillsMdDescriptorFields(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRYCONTROL_API UpdatedAgentSkillsMdDescriptorFields& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename DataT = UpdatedDescriptorData>
  UpdatedAgentSkillsMdDescriptorFields& WithData(DataT&& value) {
  ...
  template <typename DataSchemaVersionT = UpdatedDataSchemaVersion>
  UpdatedAgentSkillsMdDescriptorFields& WithDataSchemaVersion(DataSchemaVersionT&& value) {
  ...
  template <typename SourceT = UpdatedDescriptorSource>
  UpdatedAgentSkillsMdDescriptorFields& WithSource(SourceT&& value) {
