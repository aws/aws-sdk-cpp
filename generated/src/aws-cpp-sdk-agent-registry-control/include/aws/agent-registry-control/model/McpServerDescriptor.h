...
/**
 * <p>Descriptor that defines the content of an MCP (Model Context Protocol) server
 * registry record, including the server definition and its tool definitions. The
 * content is validated against the MCP protocol schema.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/McpServerDescriptor">AWS
 * API Reference</a></p>
 */
class McpServerDescriptor {
 public:
  ...
  ///@{
  /**
   * <p>The optional source configuration used to synchronize the MCP server
