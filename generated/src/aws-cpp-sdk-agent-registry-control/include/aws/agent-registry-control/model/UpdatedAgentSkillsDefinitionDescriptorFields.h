...
/**
 * <p>The set of agent skills definition descriptor fields that can be individually
 * updated.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/UpdatedAgentSkillsDefinitionDescriptorFields">AWS
 * API Reference</a></p>
 */
class UpdatedAgentSkillsDefinitionDescriptorFields {
 public:
  AWS_AGENTREGISTRYCONTROL_API UpdatedAgentSkillsDefinitionDescriptorFields() = default;
  AWS_AGENTREGISTRYCONTROL_API UpdatedAgentSkillsDefinitionDescriptorFields(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRYCONTROL_API UpdatedAgentSkillsDefinitionDescriptorFields& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename DataT = UpdatedDescriptorData>
  UpdatedAgentSkillsDefinitionDescriptorFields& WithData(DataT&& value) {
  ...
  template <typename DataSchemaVersionT = UpdatedDataSchemaVersion>
  UpdatedAgentSkillsDefinitionDescriptorFields& WithDataSchemaVersion(DataSchemaVersionT&& value) {
   ...
   */
  inline const UpdatedAgentSkillsAdditionalData& GetAdditionalData() const { return m_additionalData; }
  inline bool AdditionalDataHasBeenSet() const { return m_additionalDataHasBeenSet; }
  template <typename AdditionalDataT = UpdatedAgentSkillsAdditionalData>
  ...
  template <typename AdditionalDataT = UpdatedAgentSkillsAdditionalData>
  UpdatedAgentSkillsDefinitionDescriptorFields& WithAdditionalData(AdditionalDataT&& value) {
 ...
 private:
  ...
  UpdatedAgentSkillsAdditionalData m_additionalData;
