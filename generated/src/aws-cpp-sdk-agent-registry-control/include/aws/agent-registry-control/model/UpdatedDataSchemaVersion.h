...
/**
 * <p>Leaf patch wrapper for a descriptor's data schema version. Omit to leave
 * unchanged; supply an empty object to unset; supply optionalValue to
 * set.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-control-2025-12-01/UpdatedDataSchemaVersion">AWS
 * API Reference</a></p>
 */
class UpdatedDataSchemaVersion {
 public:
