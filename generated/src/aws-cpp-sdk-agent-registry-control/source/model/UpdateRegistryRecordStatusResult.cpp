...
UpdateRegistryRecordStatusResult::UpdateRegistryRecordStatusResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateRegistryRecordStatusResult& UpdateRegistryRecordStatusResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
