...
CreateRegistryRecordResult::CreateRegistryRecordResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateRegistryRecordResult& CreateRegistryRecordResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
