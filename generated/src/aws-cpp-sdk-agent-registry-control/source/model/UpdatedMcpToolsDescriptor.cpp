...
UpdatedMcpToolsDescriptor::UpdatedMcpToolsDescriptor(JsonView jsonValue) { *this = jsonValue; }

UpdatedMcpToolsDescriptor& UpdatedMcpToolsDescriptor::operator=(JsonView jsonValue) {
...
JsonValue UpdatedMcpToolsDescriptor::Jsonize() const {
  JsonValue payload;
