...
UpdatedAgentSkillsAdditionalData::UpdatedAgentSkillsAdditionalData(JsonView jsonValue) { *this = jsonValue; }

UpdatedAgentSkillsAdditionalData& UpdatedAgentSkillsAdditionalData::operator=(JsonView jsonValue) {
...
JsonValue UpdatedAgentSkillsAdditionalData::Jsonize() const {
  JsonValue payload;
