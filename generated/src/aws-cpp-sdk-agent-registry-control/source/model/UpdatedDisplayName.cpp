...
UpdatedDisplayName::UpdatedDisplayName(JsonView jsonValue) { *this = jsonValue; }

UpdatedDisplayName& UpdatedDisplayName::operator=(JsonView jsonValue) {
...
JsonValue UpdatedDisplayName::Jsonize() const {
  JsonValue payload;
