...
UpdatedAgentSkillsMdDescriptor::UpdatedAgentSkillsMdDescriptor(JsonView jsonValue) { *this = jsonValue; }

UpdatedAgentSkillsMdDescriptor& UpdatedAgentSkillsMdDescriptor::operator=(JsonView jsonValue) {
...
JsonValue UpdatedAgentSkillsMdDescriptor::Jsonize() const {
  JsonValue payload;
