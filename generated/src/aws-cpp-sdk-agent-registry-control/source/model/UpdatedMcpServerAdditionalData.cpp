...
UpdatedMcpServerAdditionalData::UpdatedMcpServerAdditionalData(JsonView jsonValue) { *this = jsonValue; }

UpdatedMcpServerAdditionalData& UpdatedMcpServerAdditionalData::operator=(JsonView jsonValue) {
...
JsonValue UpdatedMcpServerAdditionalData::Jsonize() const {
  JsonValue payload;
