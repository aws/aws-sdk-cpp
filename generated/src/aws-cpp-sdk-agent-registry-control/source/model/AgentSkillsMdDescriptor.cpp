...
AgentSkillsMdDescriptor::AgentSkillsMdDescriptor(JsonView jsonValue) { *this = jsonValue; }

AgentSkillsMdDescriptor& AgentSkillsMdDescriptor::operator=(JsonView jsonValue) {
...
JsonValue AgentSkillsMdDescriptor::Jsonize() const {
  JsonValue payload;
