...
UpdatedMcpServerDescriptor::UpdatedMcpServerDescriptor(JsonView jsonValue) { *this = jsonValue; }

UpdatedMcpServerDescriptor& UpdatedMcpServerDescriptor::operator=(JsonView jsonValue) {
...
JsonValue UpdatedMcpServerDescriptor::Jsonize() const {
  JsonValue payload;
