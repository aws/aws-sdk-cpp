...
UpdatedDescriptorData::UpdatedDescriptorData(JsonView jsonValue) { *this = jsonValue; }

UpdatedDescriptorData& UpdatedDescriptorData::operator=(JsonView jsonValue) {
...
JsonValue UpdatedDescriptorData::Jsonize() const {
  JsonValue payload;
