...
UpdatedDescriptorsFields::UpdatedDescriptorsFields(JsonView jsonValue) { *this = jsonValue; }

UpdatedDescriptorsFields& UpdatedDescriptorsFields::operator=(JsonView jsonValue) {
...
JsonValue UpdatedDescriptorsFields::Jsonize() const {
  JsonValue payload;
