...
UpdatedDescriptors::UpdatedDescriptors(JsonView jsonValue) { *this = jsonValue; }

UpdatedDescriptors& UpdatedDescriptors::operator=(JsonView jsonValue) {
...
JsonValue UpdatedDescriptors::Jsonize() const {
  JsonValue payload;
