...
ListRegistryRecordsResult::ListRegistryRecordsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListRegistryRecordsResult& ListRegistryRecordsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
