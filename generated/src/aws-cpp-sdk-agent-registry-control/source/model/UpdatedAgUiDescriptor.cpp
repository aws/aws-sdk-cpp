...
UpdatedAgUiDescriptor::UpdatedAgUiDescriptor(JsonView jsonValue) { *this = jsonValue; }

UpdatedAgUiDescriptor& UpdatedAgUiDescriptor::operator=(JsonView jsonValue) {
...
JsonValue UpdatedAgUiDescriptor::Jsonize() const {
  JsonValue payload;
