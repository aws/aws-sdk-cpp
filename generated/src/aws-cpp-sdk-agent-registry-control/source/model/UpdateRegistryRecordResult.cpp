...
UpdateRegistryRecordResult::UpdateRegistryRecordResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateRegistryRecordResult& UpdateRegistryRecordResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
