...
UpdatedA2aAgentCardDescriptorFields::UpdatedA2aAgentCardDescriptorFields(JsonView jsonValue) { *this = jsonValue; }

UpdatedA2aAgentCardDescriptorFields& UpdatedA2aAgentCardDescriptorFields::operator=(JsonView jsonValue) {
...
JsonValue UpdatedA2aAgentCardDescriptorFields::Jsonize() const {
  JsonValue payload;
