...
UpdatedDataSchemaVersion::UpdatedDataSchemaVersion(JsonView jsonValue) { *this = jsonValue; }

UpdatedDataSchemaVersion& UpdatedDataSchemaVersion::operator=(JsonView jsonValue) {
...
JsonValue UpdatedDataSchemaVersion::Jsonize() const {
  JsonValue payload;
