...
UpdatedHttpDescriptor::UpdatedHttpDescriptor(JsonView jsonValue) { *this = jsonValue; }

UpdatedHttpDescriptor& UpdatedHttpDescriptor::operator=(JsonView jsonValue) {
...
JsonValue UpdatedHttpDescriptor::Jsonize() const {
  JsonValue payload;
