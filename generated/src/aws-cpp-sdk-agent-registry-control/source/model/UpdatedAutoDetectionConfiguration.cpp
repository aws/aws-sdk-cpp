...
UpdatedAutoDetectionConfiguration::UpdatedAutoDetectionConfiguration(JsonView jsonValue) { *this = jsonValue; }

UpdatedAutoDetectionConfiguration& UpdatedAutoDetectionConfiguration::operator=(JsonView jsonValue) {
...
JsonValue UpdatedAutoDetectionConfiguration::Jsonize() const {
  JsonValue payload;
