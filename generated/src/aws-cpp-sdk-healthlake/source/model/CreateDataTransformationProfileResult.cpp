...
CreateDataTransformationProfileResult::CreateDataTransformationProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CreateDataTransformationProfileResult& CreateDataTransformationProfileResult::operator=(
