...
PublishDataTransformationProfileResult::PublishDataTransformationProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

PublishDataTransformationProfileResult& PublishDataTransformationProfileResult::operator=(
