...
DataTransformationProfileVersionSummary::DataTransformationProfileVersionSummary(JsonView jsonValue) { *this = jsonValue; }

DataTransformationProfileVersionSummary& DataTransformationProfileVersionSummary::operator=(JsonView jsonValue) {
...
JsonValue DataTransformationProfileVersionSummary::Jsonize() const {
  JsonValue payload;
