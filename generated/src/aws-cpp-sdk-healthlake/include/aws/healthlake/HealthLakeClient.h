...
namespace HealthLake
{
   ...
   * in the cloud.</p>
   */
  class AWS_HEALTHLAKE_API HealthLakeClient : Aws::Client::ClientWithAsyncTemplateMethods<HealthLakeClient>,
    smithy::client::AwsSmithyClientT<Aws::HealthLake::SERVICE_NAME,
