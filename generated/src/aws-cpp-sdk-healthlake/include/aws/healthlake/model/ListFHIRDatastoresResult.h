...
class ListFHIRDatastoresResult {
 public:
  ...
  void SetDatastorePropertiesList(DatastorePropertiesListT&& value) {
    m_datastorePropertiesListHasBeenSet = true;
    m_datastorePropertiesList = std::forward<DatastorePropertiesListT>(value);
  }
  template <typename DatastorePropertiesListT = Aws::Vector<DatastoreProperties>>
  ListFHIRDatastoresResult& WithDatastorePropertiesList(DatastorePropertiesListT&& value) {
    SetDatastorePropertiesList(std::forward<DatastorePropertiesListT>(value));
    return *this;
  }
  template <typename DatastorePropertiesListT = DatastoreProperties>
  ListFHIRDatastoresResult& AddDatastorePropertiesList(DatastorePropertiesListT&& value) {
    m_datastorePropertiesListHasBeenSet = true;
    m_datastorePropertiesList.emplace_back(std::forward<DatastorePropertiesListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFHIRDatastoresResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFHIRDatastoresResult& WithRequestId(RequestIdT&& value) {
