...
namespace Model {
class UpdateFHIRDatastoreResult {
 public:
  AWS_HEALTHLAKE_API UpdateFHIRDatastoreResult() = default;
  AWS_HEALTHLAKE_API UpdateFHIRDatastoreResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_HEALTHLAKE_API UpdateFHIRDatastoreResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DatastorePropertiesT = DatastoreProperties>
  UpdateFHIRDatastoreResult& WithDatastoreProperties(DatastorePropertiesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFHIRDatastoreResult& WithRequestId(RequestIdT&& value) {
