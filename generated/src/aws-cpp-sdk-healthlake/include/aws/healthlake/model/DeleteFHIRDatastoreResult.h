...
class DeleteFHIRDatastoreResult {
 public:
  ...
  template <typename DatastoreIdT = Aws::String>
  DeleteFHIRDatastoreResult& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename DatastoreArnT = Aws::String>
  DeleteFHIRDatastoreResult& WithDatastoreArn(DatastoreArnT&& value) {
  ...
  inline DeleteFHIRDatastoreResult& WithDatastoreStatus(DatastoreStatus value) {
  ...
  template <typename DatastoreEndpointT = Aws::String>
  DeleteFHIRDatastoreResult& WithDatastoreEndpoint(DatastoreEndpointT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteFHIRDatastoreResult& WithRequestId(RequestIdT&& value) {
