...
class DatastoreFilter {
 public:
  ...
  template <typename DatastoreNameT = Aws::String>
  DatastoreFilter& WithDatastoreName(DatastoreNameT&& value) {
  ...
  inline DatastoreFilter& WithDatastoreStatus(DatastoreStatus value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  DatastoreFilter& WithCreatedBefore(CreatedBeforeT&& value) {
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  DatastoreFilter& WithCreatedAfter(CreatedAfterT&& value) {
