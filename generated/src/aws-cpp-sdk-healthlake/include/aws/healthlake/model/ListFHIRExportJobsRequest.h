...
class ListFHIRExportJobsRequest : public HealthLakeRequest {
 public:
  ...
  template <typename DatastoreIdT = Aws::String>
  ListFHIRExportJobsRequest& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListFHIRExportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFHIRExportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename JobNameT = Aws::String>
  ListFHIRExportJobsRequest& WithJobName(JobNameT&& value) {
  ...
  inline ListFHIRExportJobsRequest& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubmittedBeforeT = Aws::Utils::DateTime>
  ListFHIRExportJobsRequest& WithSubmittedBefore(SubmittedBeforeT&& value) {
  ...
  template <typename SubmittedAfterT = Aws::Utils::DateTime>
  ListFHIRExportJobsRequest& WithSubmittedAfter(SubmittedAfterT&& value) {
