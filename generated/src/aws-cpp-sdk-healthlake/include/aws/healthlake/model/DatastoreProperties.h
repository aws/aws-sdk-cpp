...
class DatastoreProperties {
 public:
  ...
  inline DatastoreProperties& WithDatastoreTypeVersion(FHIRVersion value) {
  ...
  void SetErrorCause(ErrorCauseT&& value) {
    ...
    m_errorCause = std::forward<ErrorCauseT>(value);
  }
  template <typename ErrorCauseT = ErrorCause>
  DatastoreProperties& WithErrorCause(ErrorCauseT&& value) {
    SetErrorCause(std::forward<ErrorCauseT>(value));
    return *this;
  }
  ///@}
 private:
