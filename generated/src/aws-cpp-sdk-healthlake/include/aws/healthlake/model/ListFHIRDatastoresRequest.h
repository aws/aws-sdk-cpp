...
class ListFHIRDatastoresRequest : public HealthLakeRequest {
 public:
  ...
  template <typename FilterT = DatastoreFilter>
  ListFHIRDatastoresRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListFHIRDatastoresRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFHIRDatastoresRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
