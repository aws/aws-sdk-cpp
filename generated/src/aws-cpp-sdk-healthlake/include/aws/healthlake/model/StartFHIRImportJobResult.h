...
class StartFHIRImportJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  StartFHIRImportJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StartFHIRImportJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DatastoreIdT = Aws::String>
  StartFHIRImportJobResult& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartFHIRImportJobResult& WithRequestId(RequestIdT&& value) {
