...
class PreloadDataConfig {
 public:
  ...
  inline void SetPreloadDataType(PreloadDataType value) {
    m_preloadDataTypeHasBeenSet = true;
    m_preloadDataType = value;
  }
  inline PreloadDataConfig& WithPreloadDataType(PreloadDataType value) {
    SetPreloadDataType(value);
    return *this;
  }
  ///@}
 private:
