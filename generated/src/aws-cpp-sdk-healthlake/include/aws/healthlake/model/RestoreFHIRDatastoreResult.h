...
namespace Model {
class RestoreFHIRDatastoreResult {
 public:
  AWS_HEALTHLAKE_API RestoreFHIRDatastoreResult() = default;
  AWS_HEALTHLAKE_API RestoreFHIRDatastoreResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_HEALTHLAKE_API RestoreFHIRDatastoreResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>The restored data store identifier.</p>
   */
  ...
  template <typename DatastoreIdT = Aws::String>
  RestoreFHIRDatastoreResult& WithDatastoreId(DatastoreIdT&& value) {
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) for the restored data store.</p>
   */
  ...
  template <typename DatastoreArnT = Aws::String>
  RestoreFHIRDatastoreResult& WithDatastoreArn(DatastoreArnT&& value) {
  ...
  ///@{
  /**
   * <p>The restored data store status.</p>
   */
  ...
  inline RestoreFHIRDatastoreResult& WithDatastoreStatus(DatastoreStatus value) {
  ...
  ///@{
  /**
   * <p>The AWS endpoint for the restored data store.</p>
   */
  ...
  template <typename DatastoreEndpointT = Aws::String>
  RestoreFHIRDatastoreResult& WithDatastoreEndpoint(DatastoreEndpointT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RestoreFHIRDatastoreResult& WithRequestId(RequestIdT&& value) {
