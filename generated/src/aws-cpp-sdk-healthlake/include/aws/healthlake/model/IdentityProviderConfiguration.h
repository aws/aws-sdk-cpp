...
class IdentityProviderConfiguration {
 public:
  ...
  inline void SetAuthorizationStrategy(AuthorizationStrategy value) {
    m_authorizationStrategyHasBeenSet = true;
    m_authorizationStrategy = value;
  }
  inline IdentityProviderConfiguration& WithAuthorizationStrategy(AuthorizationStrategy value) {
    SetAuthorizationStrategy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFineGrainedAuthorizationEnabled(bool value) {
    m_fineGrainedAuthorizationEnabledHasBeenSet = true;
    m_fineGrainedAuthorizationEnabled = value;
  }
  inline IdentityProviderConfiguration& WithFineGrainedAuthorizationEnabled(bool value) {
    SetFineGrainedAuthorizationEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetIdpLambdaArn(IdpLambdaArnT&& value) {
    ...
    m_idpLambdaArn = std::forward<IdpLambdaArnT>(value);
  }
  template <typename IdpLambdaArnT = Aws::String>
  IdentityProviderConfiguration& WithIdpLambdaArn(IdpLambdaArnT&& value) {
    SetIdpLambdaArn(std::forward<IdpLambdaArnT>(value));
    return *this;
  }
  ///@}
 private:
