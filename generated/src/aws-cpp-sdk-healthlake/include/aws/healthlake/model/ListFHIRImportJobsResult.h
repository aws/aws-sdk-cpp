...
class ListFHIRImportJobsResult {
 public:
  ...
  void SetImportJobPropertiesList(ImportJobPropertiesListT&& value) {
    m_importJobPropertiesListHasBeenSet = true;
    m_importJobPropertiesList = std::forward<ImportJobPropertiesListT>(value);
  }
  template <typename ImportJobPropertiesListT = Aws::Vector<ImportJobProperties>>
  ListFHIRImportJobsResult& WithImportJobPropertiesList(ImportJobPropertiesListT&& value) {
    SetImportJobPropertiesList(std::forward<ImportJobPropertiesListT>(value));
    return *this;
  }
  template <typename ImportJobPropertiesListT = ImportJobProperties>
  ListFHIRImportJobsResult& AddImportJobPropertiesList(ImportJobPropertiesListT&& value) {
    m_importJobPropertiesListHasBeenSet = true;
    m_importJobPropertiesList.emplace_back(std::forward<ImportJobPropertiesListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFHIRImportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFHIRImportJobsResult& WithRequestId(RequestIdT&& value) {
