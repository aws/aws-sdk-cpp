...
class ListFHIRImportJobsRequest : public HealthLakeRequest {
 public:
  ...
  template <typename DatastoreIdT = Aws::String>
  ListFHIRImportJobsRequest& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListFHIRImportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFHIRImportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename JobNameT = Aws::String>
  ListFHIRImportJobsRequest& WithJobName(JobNameT&& value) {
  ...
  inline ListFHIRImportJobsRequest& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubmittedBeforeT = Aws::Utils::DateTime>
  ListFHIRImportJobsRequest& WithSubmittedBefore(SubmittedBeforeT&& value) {
  ...
  template <typename SubmittedAfterT = Aws::Utils::DateTime>
  ListFHIRImportJobsRequest& WithSubmittedAfter(SubmittedAfterT&& value) {
