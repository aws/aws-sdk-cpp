...
class StartFHIRExportJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  StartFHIRExportJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StartFHIRExportJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DatastoreIdT = Aws::String>
  StartFHIRExportJobResult& WithDatastoreId(DatastoreIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartFHIRExportJobResult& WithRequestId(RequestIdT&& value) {
