...
class AWS_IOTANALYTICS_API IoTAnalyticsClient : public Aws::Client::AWSJsonClient,
                                                public Aws::Client::ClientWithAsyncTemplateMethods<IoTAnalyticsClient> {
 public:
   ...
   */
  IoTAnalyticsClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<IoTAnalyticsEndpointProviderBase> endpointProvider = nullptr,
      const Aws::IoTAnalytics::IoTAnalyticsClientConfiguration& clientConfiguration = Aws::IoTAnalytics::IoTAnalyticsClientConfiguration());
  ...
  /**
   * An Async wrapper for BatchPutMessage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchPutMessageRequestT = Model::BatchPutMessageRequest>
  void BatchPutMessageAsync(const BatchPutMessageRequestT& request, const BatchPutMessageResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelPipelineReprocessingOutcome CancelPipelineReprocessing(
      const Model::CancelPipelineReprocessingRequest& request) const;

  /**
   * A Callable wrapper for CancelPipelineReprocessing that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CancelPipelineReprocessingRequestT = Model::CancelPipelineReprocessingRequest>
  Model::CancelPipelineReprocessingOutcomeCallable CancelPipelineReprocessingCallable(
      const CancelPipelineReprocessingRequestT& request) const {
    return SubmitCallable(&IoTAnalyticsClient::CancelPipelineReprocessing, request);
  }

  /**
   * An Async wrapper for CancelPipelineReprocessing that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelPipelineReprocessingRequestT = Model::CancelPipelineReprocessingRequest>
  void CancelPipelineReprocessingAsync(const CancelPipelineReprocessingRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateDatasetContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDatasetContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDatasetContentRequestT = Model::CreateDatasetContentRequest>
  void CreateDatasetContentAsync(const CreateDatasetContentRequestT& request, const CreateDatasetContentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateDatastore that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateDatastoreRequestT = Model::CreateDatastoreRequest>
  void CreateDatastoreAsync(const CreateDatastoreRequestT& request, const CreateDatastoreResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDatasetContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDatasetContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDatasetContentRequestT = Model::DeleteDatasetContentRequest>
  void DeleteDatasetContentAsync(const DeleteDatasetContentRequestT& request, const DeleteDatasetContentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteDatastore that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteDatastoreRequestT = Model::DeleteDatastoreRequest>
  void DeleteDatastoreAsync(const DeleteDatastoreRequestT& request, const DeleteDatastoreResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDatastore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDatastore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDatastoreRequestT = Model::DescribeDatastoreRequest>
  void DescribeDatastoreAsync(const DescribeDatastoreRequestT& request, const DescribeDatastoreResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDatasetContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDatasetContent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDatasetContentRequestT = Model::GetDatasetContentRequest>
  void GetDatasetContentAsync(const GetDatasetContentRequestT& request, const GetDatasetContentResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDatasetContents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDatasetContents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDatasetContentsRequestT = Model::ListDatasetContentsRequest>
  void ListDatasetContentsAsync(const ListDatasetContentsRequestT& request, const ListDatasetContentsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListDatastores that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListDatastoresRequestT = Model::ListDatastoresRequest>
  void ListDatastoresAsync(const ListDatastoresResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListDatastoresRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RunPipelineActivity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RunPipelineActivity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RunPipelineActivityRequestT = Model::RunPipelineActivityRequest>
  void RunPipelineActivityAsync(const RunPipelineActivityRequestT& request, const RunPipelineActivityResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SampleChannelData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SampleChannelData that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SampleChannelDataRequestT = Model::SampleChannelDataRequest>
  void SampleChannelDataAsync(const SampleChannelDataRequestT& request, const SampleChannelDataResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartPipelineReprocessing that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartPipelineReprocessingRequestT = Model::StartPipelineReprocessingRequest>
  Model::StartPipelineReprocessingOutcomeCallable StartPipelineReprocessingCallable(
      const StartPipelineReprocessingRequestT& request) const {
    return SubmitCallable(&IoTAnalyticsClient::StartPipelineReprocessing, request);
  }

  /**
   * An Async wrapper for StartPipelineReprocessing that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartPipelineReprocessingRequestT = Model::StartPipelineReprocessingRequest>
  void StartPipelineReprocessingAsync(const StartPipelineReprocessingRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateDatastore that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateDatastoreRequestT = Model::UpdateDatastoreRequest>
  void UpdateDatastoreAsync(const UpdateDatastoreRequestT& request, const UpdateDatastoreResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
