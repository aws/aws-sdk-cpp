...
namespace IoTAnalytics
{
   ...
   * devices.</p>
   */
  class AWS_IOTANALYTICS_API IoTAnalyticsClient : Aws::Client::ClientWithAsyncTemplateMethods<IoTAnalyticsClient>,
    smithy::client::AwsSmithyClientT<Aws::IoTAnalytics::SERVICE_NAME,
