...
class CustomerManagedDatastoreS3Storage {
 public:
  ...
  template <typename BucketT = Aws::String>
  CustomerManagedDatastoreS3Storage& WithBucket(BucketT&& value) {
  ...
  template <typename KeyPrefixT = Aws::String>
  CustomerManagedDatastoreS3Storage& WithKeyPrefix(KeyPrefixT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  CustomerManagedDatastoreS3Storage& WithRoleArn(RoleArnT&& value) {
