...
class SampleChannelDataRequest : public IoTAnalyticsRequest {
 public:
  ...
  template <typename ChannelNameT = Aws::String>
  SampleChannelDataRequest& WithChannelName(ChannelNameT&& value) {
  ...
  inline void SetMaxMessages(int value) {
    m_maxMessagesHasBeenSet = true;
    m_maxMessages = value;
  }
  inline SampleChannelDataRequest& WithMaxMessages(int value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  SampleChannelDataRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  SampleChannelDataRequest& WithEndTime(EndTimeT&& value) {
