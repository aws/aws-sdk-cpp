...
class Pipeline {
 public:
  ...
  template <typename ReprocessingSummariesT = Aws::Vector<ReprocessingSummary>>
  Pipeline& WithReprocessingSummaries(ReprocessingSummariesT&& value) {
  ...
  Pipeline& AddReprocessingSummaries(ReprocessingSummariesT&& value) {
    m_reprocessingSummariesHasBeenSet = true;
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  Pipeline& WithLastUpdateTime(LastUpdateTimeT&& value) {
