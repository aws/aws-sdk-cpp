...
class LateDataRuleConfiguration {
 public:
   ...
   */
  inline const DeltaTimeSessionWindowConfiguration& GetDeltaTimeSessionWindowConfiguration() const {
    return m_deltaTimeSessionWindowConfiguration;
  }
  ...
  void SetDeltaTimeSessionWindowConfiguration(DeltaTimeSessionWindowConfigurationT&& value) {
    ...
    m_deltaTimeSessionWindowConfiguration = std::forward<DeltaTimeSessionWindowConfigurationT>(value);
  }
  template <typename DeltaTimeSessionWindowConfigurationT = DeltaTimeSessionWindowConfiguration>
  LateDataRuleConfiguration& WithDeltaTimeSessionWindowConfiguration(DeltaTimeSessionWindowConfigurationT&& value) {
    SetDeltaTimeSessionWindowConfiguration(std::forward<DeltaTimeSessionWindowConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
