...
class EstimatedResourceSize {
 public:
  ...
  inline void SetEstimatedSizeInBytes(double value) {
    m_estimatedSizeInBytesHasBeenSet = true;
    m_estimatedSizeInBytes = value;
  }
  inline EstimatedResourceSize& WithEstimatedSizeInBytes(double value) {
    SetEstimatedSizeInBytes(value);
    return *this;
  }
  ///@}
  ...
  void SetEstimatedOn(EstimatedOnT&& value) {
    ...
    m_estimatedOn = std::forward<EstimatedOnT>(value);
  }
  template <typename EstimatedOnT = Aws::Utils::DateTime>
  EstimatedResourceSize& WithEstimatedOn(EstimatedOnT&& value) {
    SetEstimatedOn(std::forward<EstimatedOnT>(value));
    return *this;
  }
  ///@}
 private:
