...
class CancelPipelineReprocessingRequest : public IoTAnalyticsRequest {
 public:
  ...
  template <typename PipelineNameT = Aws::String>
  CancelPipelineReprocessingRequest& WithPipelineName(PipelineNameT&& value) {
  ...
  void SetReprocessingId(ReprocessingIdT&& value) {
    m_reprocessingIdHasBeenSet = true;
    m_reprocessingId = std::forward<ReprocessingIdT>(value);
  }
  template <typename ReprocessingIdT = Aws::String>
  CancelPipelineReprocessingRequest& WithReprocessingId(ReprocessingIdT&& value) {
    SetReprocessingId(std::forward<ReprocessingIdT>(value));
    return *this;
  }
  ///@}
 private:
