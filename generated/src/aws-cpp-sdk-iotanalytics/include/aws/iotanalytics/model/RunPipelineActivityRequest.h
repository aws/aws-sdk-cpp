...
class RunPipelineActivityRequest : public IoTAnalyticsRequest {
 public:
  ...
  void SetPipelineActivity(PipelineActivityT&& value) {
    m_pipelineActivityHasBeenSet = true;
    m_pipelineActivity = std::forward<PipelineActivityT>(value);
  }
  template <typename PipelineActivityT = PipelineActivity>
  RunPipelineActivityRequest& WithPipelineActivity(PipelineActivityT&& value) {
    SetPipelineActivity(std::forward<PipelineActivityT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PayloadsT = Aws::Vector<Aws::Utils::ByteBuffer>>
  RunPipelineActivityRequest& WithPayloads(PayloadsT&& value) {
    SetPayloads(std::forward<PayloadsT>(value));
    return *this;
  }
  template <typename PayloadsT = Aws::Utils::ByteBuffer>
  RunPipelineActivityRequest& AddPayloads(PayloadsT&& value) {
    m_payloadsHasBeenSet = true;
