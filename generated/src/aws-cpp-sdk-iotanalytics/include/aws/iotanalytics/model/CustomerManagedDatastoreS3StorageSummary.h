...
namespace Model
{
  ...
  {
  public:
    AWS_IOTANALYTICS_API CustomerManagedDatastoreS3StorageSummary() = default;
    ...
    template<typename BucketT = Aws::String>
    CustomerManagedDatastoreS3StorageSummary& WithBucket(BucketT&& value) { SetBucket(std::forward<BucketT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyPrefixT = Aws::String>
    CustomerManagedDatastoreS3StorageSummary& WithKeyPrefix(KeyPrefixT&& value) { SetKeyPrefix(std::forward<KeyPrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    CustomerManagedDatastoreS3StorageSummary& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
  private:
