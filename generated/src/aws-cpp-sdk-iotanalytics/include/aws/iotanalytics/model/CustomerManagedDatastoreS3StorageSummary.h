...
class CustomerManagedDatastoreS3StorageSummary {
 public:
  ...
  template <typename BucketT = Aws::String>
  CustomerManagedDatastoreS3StorageSummary& WithBucket(BucketT&& value) {
  ...
  template <typename KeyPrefixT = Aws::String>
  CustomerManagedDatastoreS3StorageSummary& WithKeyPrefix(KeyPrefixT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  CustomerManagedDatastoreS3StorageSummary& WithRoleArn(RoleArnT&& value) {
