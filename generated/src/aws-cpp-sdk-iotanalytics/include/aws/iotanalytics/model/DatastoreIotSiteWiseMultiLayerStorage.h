...
class DatastoreIotSiteWiseMultiLayerStorage {
 public:
  ...
  void SetCustomerManagedS3Storage(CustomerManagedS3StorageT&& value) {
    ...
    m_customerManagedS3Storage = std::forward<CustomerManagedS3StorageT>(value);
  }
  template <typename CustomerManagedS3StorageT = IotSiteWiseCustomerManagedDatastoreS3Storage>
  DatastoreIotSiteWiseMultiLayerStorage& WithCustomerManagedS3Storage(CustomerManagedS3StorageT&& value) {
    SetCustomerManagedS3Storage(std::forward<CustomerManagedS3StorageT>(value));
    return *this;
  }
  ///@}
 private:
