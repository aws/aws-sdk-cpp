...
class CreateDatasetRequest : public IoTAnalyticsRequest {
 public:
  ...
  void SetContentDeliveryRules(ContentDeliveryRulesT&& value) {
    ...
    m_contentDeliveryRules = std::forward<ContentDeliveryRulesT>(value);
  }
  template <typename ContentDeliveryRulesT = Aws::Vector<DatasetContentDeliveryRule>>
  CreateDatasetRequest& WithContentDeliveryRules(ContentDeliveryRulesT&& value) {
    SetContentDeliveryRules(std::forward<ContentDeliveryRulesT>(value));
    return *this;
  }
  ...
  CreateDatasetRequest& AddContentDeliveryRules(ContentDeliveryRulesT&& value) {
    m_contentDeliveryRulesHasBeenSet = true;
    m_contentDeliveryRules.emplace_back(std::forward<ContentDeliveryRulesT>(value));
    return *this;
  }
  ///@}
