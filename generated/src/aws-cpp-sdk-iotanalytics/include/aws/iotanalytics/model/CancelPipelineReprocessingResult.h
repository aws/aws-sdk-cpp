...
namespace Model
{
  ...
  {
  public:
    AWS_IOTANALYTICS_API CancelPipelineReprocessingResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelPipelineReprocessingResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
