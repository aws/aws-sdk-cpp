...
class DatasetActionSummary {
 public:
  ...
  template <typename ActionNameT = Aws::String>
  DatasetActionSummary& WithActionName(ActionNameT&& value) {
  ...
  inline void SetActionType(DatasetActionType value) {
    m_actionTypeHasBeenSet = true;
    m_actionType = value;
  }
  inline DatasetActionSummary& WithActionType(DatasetActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
