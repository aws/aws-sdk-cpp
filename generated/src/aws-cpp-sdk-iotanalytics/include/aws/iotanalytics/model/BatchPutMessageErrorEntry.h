...
class BatchPutMessageErrorEntry {
 public:
  AWS_IOTANALYTICS_API BatchPutMessageErrorEntry() = default;
  ...
  template <typename MessageIdT = Aws::String>
  BatchPutMessageErrorEntry& WithMessageId(MessageIdT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  BatchPutMessageErrorEntry& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchPutMessageErrorEntry& WithErrorMessage(ErrorMessageT&& value) {
