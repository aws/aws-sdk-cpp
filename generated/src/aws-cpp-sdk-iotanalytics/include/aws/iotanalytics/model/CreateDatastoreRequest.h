...
class CreateDatastoreRequest : public IoTAnalyticsRequest {
 public:
  ...
  void SetDatastoreStorage(DatastoreStorageT&& value) {
    ...
    m_datastoreStorage = std::forward<DatastoreStorageT>(value);
  }
  template <typename DatastoreStorageT = DatastoreStorage>
  CreateDatastoreRequest& WithDatastoreStorage(DatastoreStorageT&& value) {
    SetDatastoreStorage(std::forward<DatastoreStorageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFileFormatConfiguration(FileFormatConfigurationT&& value) {
    ...
    m_fileFormatConfiguration = std::forward<FileFormatConfigurationT>(value);
  }
  template <typename FileFormatConfigurationT = FileFormatConfiguration>
  CreateDatastoreRequest& WithFileFormatConfiguration(FileFormatConfigurationT&& value) {
    SetFileFormatConfiguration(std::forward<FileFormatConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatastorePartitions(DatastorePartitionsT&& value) {
    ...
    m_datastorePartitions = std::forward<DatastorePartitionsT>(value);
  }
  template <typename DatastorePartitionsT = DatastorePartitions>
  CreateDatastoreRequest& WithDatastorePartitions(DatastorePartitionsT&& value) {
    SetDatastorePartitions(std::forward<DatastorePartitionsT>(value));
    return *this;
  }
  ///@}
 private:
