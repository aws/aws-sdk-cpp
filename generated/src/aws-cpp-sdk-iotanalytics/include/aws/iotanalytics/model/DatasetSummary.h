...
class DatasetSummary {
 public:
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  DatasetSummary& WithLastUpdateTime(LastUpdateTimeT&& value) {
  ...
  template <typename TriggersT = Aws::Vector<DatasetTrigger>>
  DatasetSummary& WithTriggers(TriggersT&& value) {
    SetTriggers(std::forward<TriggersT>(value));
    return *this;
  }
  template <typename TriggersT = DatasetTrigger>
  DatasetSummary& AddTriggers(TriggersT&& value) {
    m_triggersHasBeenSet = true;
