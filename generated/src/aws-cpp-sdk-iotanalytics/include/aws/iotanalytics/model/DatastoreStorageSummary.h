...
class DatastoreStorageSummary {
 public:
  ...
  void SetServiceManagedS3(ServiceManagedS3T&& value) {
    ...
    m_serviceManagedS3 = std::forward<ServiceManagedS3T>(value);
  }
  template <typename ServiceManagedS3T = ServiceManagedDatastoreS3StorageSummary>
  DatastoreStorageSummary& WithServiceManagedS3(ServiceManagedS3T&& value) {
    SetServiceManagedS3(std::forward<ServiceManagedS3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomerManagedS3(CustomerManagedS3T&& value) {
    ...
    m_customerManagedS3 = std::forward<CustomerManagedS3T>(value);
  }
  template <typename CustomerManagedS3T = CustomerManagedDatastoreS3StorageSummary>
  DatastoreStorageSummary& WithCustomerManagedS3(CustomerManagedS3T&& value) {
    SetCustomerManagedS3(std::forward<CustomerManagedS3T>(value));
    return *this;
  }
  ///@}
   ...
   * manage. </p>
   */
  inline const DatastoreIotSiteWiseMultiLayerStorageSummary& GetIotSiteWiseMultiLayerStorage() const {
    return m_iotSiteWiseMultiLayerStorage;
  }
  ...
  void SetIotSiteWiseMultiLayerStorage(IotSiteWiseMultiLayerStorageT&& value) {
    ...
    m_iotSiteWiseMultiLayerStorage = std::forward<IotSiteWiseMultiLayerStorageT>(value);
  }
  template <typename IotSiteWiseMultiLayerStorageT = DatastoreIotSiteWiseMultiLayerStorageSummary>
  DatastoreStorageSummary& WithIotSiteWiseMultiLayerStorage(IotSiteWiseMultiLayerStorageT&& value) {
    SetIotSiteWiseMultiLayerStorage(std::forward<IotSiteWiseMultiLayerStorageT>(value));
    return *this;
  }
  ///@}
 private:
