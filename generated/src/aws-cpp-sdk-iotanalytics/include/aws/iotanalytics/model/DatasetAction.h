...
class DatasetAction {
 public:
  ...
  void SetQueryAction(QueryActionT&& value) {
    ...
    m_queryAction = std::forward<QueryActionT>(value);
  }
  template <typename QueryActionT = SqlQueryDatasetAction>
  DatasetAction& WithQueryAction(QueryActionT&& value) {
    SetQueryAction(std::forward<QueryActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContainerAction(ContainerActionT&& value) {
    ...
    m_containerAction = std::forward<ContainerActionT>(value);
  }
  template <typename ContainerActionT = ContainerDatasetAction>
  DatasetAction& WithContainerAction(ContainerActionT&& value) {
    SetContainerAction(std::forward<ContainerActionT>(value));
    return *this;
  }
  ///@}
 private:
