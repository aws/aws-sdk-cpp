...
class Variable {
 public:
  ...
  inline Variable& WithDoubleValue(double value) {
  ...
  void SetDatasetContentVersionValue(DatasetContentVersionValueT&& value) {
    ...
    m_datasetContentVersionValue = std::forward<DatasetContentVersionValueT>(value);
  }
  template <typename DatasetContentVersionValueT = DatasetContentVersionValue>
  Variable& WithDatasetContentVersionValue(DatasetContentVersionValueT&& value) {
    SetDatasetContentVersionValue(std::forward<DatasetContentVersionValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputFileUriValue(OutputFileUriValueT&& value) {
    ...
    m_outputFileUriValue = std::forward<OutputFileUriValueT>(value);
  }
  template <typename OutputFileUriValueT = OutputFileUriValue>
  Variable& WithOutputFileUriValue(OutputFileUriValueT&& value) {
    SetOutputFileUriValue(std::forward<OutputFileUriValueT>(value));
    return *this;
  }
  ///@}
 private:
