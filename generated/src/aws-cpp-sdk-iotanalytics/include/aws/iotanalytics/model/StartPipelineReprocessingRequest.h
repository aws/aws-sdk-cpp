...
class StartPipelineReprocessingRequest : public IoTAnalyticsRequest {
 public:
  ...
  template <typename PipelineNameT = Aws::String>
  StartPipelineReprocessingRequest& WithPipelineName(PipelineNameT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  StartPipelineReprocessingRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  StartPipelineReprocessingRequest& WithEndTime(EndTimeT&& value) {
  ...
  void SetChannelMessages(ChannelMessagesT&& value) {
    m_channelMessagesHasBeenSet = true;
    m_channelMessages = std::forward<ChannelMessagesT>(value);
  }
  template <typename ChannelMessagesT = ChannelMessages>
  StartPipelineReprocessingRequest& WithChannelMessages(ChannelMessagesT&& value) {
    SetChannelMessages(std::forward<ChannelMessagesT>(value));
    return *this;
  }
  ///@}
 private:
