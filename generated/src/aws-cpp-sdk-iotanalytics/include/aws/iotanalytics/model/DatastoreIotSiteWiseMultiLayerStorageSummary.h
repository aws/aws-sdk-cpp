...
class DatastoreIotSiteWiseMultiLayerStorageSummary {
 public:
   ...
   * manage.</p>
   */
  inline const IotSiteWiseCustomerManagedDatastoreS3StorageSummary& GetCustomerManagedS3Storage() const {
    return m_customerManagedS3Storage;
  }
  ...
  template <typename CustomerManagedS3StorageT = IotSiteWiseCustomerManagedDatastoreS3StorageSummary>
  DatastoreIotSiteWiseMultiLayerStorageSummary& WithCustomerManagedS3Storage(CustomerManagedS3StorageT&& value) {
