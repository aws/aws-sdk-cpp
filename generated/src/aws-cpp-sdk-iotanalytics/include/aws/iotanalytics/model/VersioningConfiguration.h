...
class VersioningConfiguration {
 public:
  ...
  inline VersioningConfiguration& WithUnlimited(bool value) {
    SetUnlimited(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxVersions(int value) {
    m_maxVersionsHasBeenSet = true;
    m_maxVersions = value;
  }
  inline VersioningConfiguration& WithMaxVersions(int value) {
    SetMaxVersions(value);
    return *this;
  }
  ///@}
 private:
