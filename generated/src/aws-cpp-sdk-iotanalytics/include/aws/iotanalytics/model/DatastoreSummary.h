...
class DatastoreSummary {
 public:
  ...
  inline DatastoreSummary& WithStatus(DatastoreStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFileFormatType(FileFormatType value) {
    m_fileFormatTypeHasBeenSet = true;
    m_fileFormatType = value;
  }
  inline DatastoreSummary& WithFileFormatType(FileFormatType value) {
