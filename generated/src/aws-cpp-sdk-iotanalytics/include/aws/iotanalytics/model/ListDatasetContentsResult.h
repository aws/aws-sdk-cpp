...
class ListDatasetContentsResult {
 public:
  ...
  void SetDatasetContentSummaries(DatasetContentSummariesT&& value) {
    m_datasetContentSummariesHasBeenSet = true;
    m_datasetContentSummaries = std::forward<DatasetContentSummariesT>(value);
  }
  template <typename DatasetContentSummariesT = Aws::Vector<DatasetContentSummary>>
  ListDatasetContentsResult& WithDatasetContentSummaries(DatasetContentSummariesT&& value) {
    SetDatasetContentSummaries(std::forward<DatasetContentSummariesT>(value));
    return *this;
  }
  template <typename DatasetContentSummariesT = DatasetContentSummary>
  ListDatasetContentsResult& AddDatasetContentSummaries(DatasetContentSummariesT&& value) {
    m_datasetContentSummariesHasBeenSet = true;
    m_datasetContentSummaries.emplace_back(std::forward<DatasetContentSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDatasetContentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDatasetContentsResult& WithRequestId(RequestIdT&& value) {
