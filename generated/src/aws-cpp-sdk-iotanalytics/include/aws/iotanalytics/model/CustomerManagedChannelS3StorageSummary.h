...
class CustomerManagedChannelS3StorageSummary {
 public:
  ...
  template <typename BucketT = Aws::String>
  CustomerManagedChannelS3StorageSummary& WithBucket(BucketT&& value) {
  ...
  template <typename KeyPrefixT = Aws::String>
  CustomerManagedChannelS3StorageSummary& WithKeyPrefix(KeyPrefixT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  CustomerManagedChannelS3StorageSummary& WithRoleArn(RoleArnT&& value) {
