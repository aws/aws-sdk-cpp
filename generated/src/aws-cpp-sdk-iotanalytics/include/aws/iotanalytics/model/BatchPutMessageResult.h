...
class BatchPutMessageResult {
 public:
  ...
  void SetBatchPutMessageErrorEntries(BatchPutMessageErrorEntriesT&& value) {
    m_batchPutMessageErrorEntriesHasBeenSet = true;
    m_batchPutMessageErrorEntries = std::forward<BatchPutMessageErrorEntriesT>(value);
  }
  template <typename BatchPutMessageErrorEntriesT = Aws::Vector<BatchPutMessageErrorEntry>>
  BatchPutMessageResult& WithBatchPutMessageErrorEntries(BatchPutMessageErrorEntriesT&& value) {
    SetBatchPutMessageErrorEntries(std::forward<BatchPutMessageErrorEntriesT>(value));
    return *this;
  }
  template <typename BatchPutMessageErrorEntriesT = BatchPutMessageErrorEntry>
  BatchPutMessageResult& AddBatchPutMessageErrorEntries(BatchPutMessageErrorEntriesT&& value) {
    m_batchPutMessageErrorEntriesHasBeenSet = true;
    m_batchPutMessageErrorEntries.emplace_back(std::forward<BatchPutMessageErrorEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchPutMessageResult& WithRequestId(RequestIdT&& value) {
