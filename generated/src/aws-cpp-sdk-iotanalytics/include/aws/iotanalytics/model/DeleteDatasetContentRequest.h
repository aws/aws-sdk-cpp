...
/**
 */
class DeleteDatasetContentRequest : public IoTAnalyticsRequest {
 public:
  AWS_IOTANALYTICS_API DeleteDatasetContentRequest() = default;
  ...
  template <typename DatasetNameT = Aws::String>
  DeleteDatasetContentRequest& WithDatasetName(DatasetNameT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  DeleteDatasetContentRequest& WithVersionId(VersionIdT&& value) {
