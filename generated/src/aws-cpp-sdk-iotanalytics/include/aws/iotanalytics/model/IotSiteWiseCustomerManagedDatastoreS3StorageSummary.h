...
class IotSiteWiseCustomerManagedDatastoreS3StorageSummary {
 public:
  ...
  template <typename BucketT = Aws::String>
  IotSiteWiseCustomerManagedDatastoreS3StorageSummary& WithBucket(BucketT&& value) {
  ...
  template <typename KeyPrefixT = Aws::String>
  IotSiteWiseCustomerManagedDatastoreS3StorageSummary& WithKeyPrefix(KeyPrefixT&& value) {
