...
class UpdatePipelineRequest : public IoTAnalyticsRequest {
 public:
  ...
  void SetPipelineActivities(PipelineActivitiesT&& value) {
    m_pipelineActivitiesHasBeenSet = true;
    m_pipelineActivities = std::forward<PipelineActivitiesT>(value);
  }
  template <typename PipelineActivitiesT = Aws::Vector<PipelineActivity>>
  UpdatePipelineRequest& WithPipelineActivities(PipelineActivitiesT&& value) {
    SetPipelineActivities(std::forward<PipelineActivitiesT>(value));
    return *this;
  }
  template <typename PipelineActivitiesT = PipelineActivity>
  UpdatePipelineRequest& AddPipelineActivities(PipelineActivitiesT&& value) {
    m_pipelineActivitiesHasBeenSet = true;
    m_pipelineActivities.emplace_back(std::forward<PipelineActivitiesT>(value));
    return *this;
  }
  ///@}
 private:
