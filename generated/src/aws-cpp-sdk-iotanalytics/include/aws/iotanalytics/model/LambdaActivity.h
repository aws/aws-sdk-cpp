...
class LambdaActivity {
 public:
  ...
  template <typename NameT = Aws::String>
  LambdaActivity& WithName(NameT&& value) {
  ...
  void SetLambdaName(LambdaNameT&& value) {
    m_lambdaNameHasBeenSet = true;
    m_lambdaName = std::forward<LambdaNameT>(value);
  }
  template <typename LambdaNameT = Aws::String>
  LambdaActivity& WithLambdaName(LambdaNameT&& value) {
    SetLambdaName(std::forward<LambdaNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline LambdaActivity& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextT = Aws::String>
  LambdaActivity& WithNext(NextT&& value) {
