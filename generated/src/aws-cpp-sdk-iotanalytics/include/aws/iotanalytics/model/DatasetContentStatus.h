...
class DatasetContentStatus {
 public:
  ...
  inline void SetState(DatasetContentState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline DatasetContentStatus& WithState(DatasetContentState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonT = Aws::String>
  DatasetContentStatus& WithReason(ReasonT&& value) {
