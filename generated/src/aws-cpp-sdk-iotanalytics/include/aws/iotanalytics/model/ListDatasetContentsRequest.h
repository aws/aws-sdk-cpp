...
class ListDatasetContentsRequest : public IoTAnalyticsRequest {
 public:
  ...
  inline ListDatasetContentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetScheduledOnOrAfter(ScheduledOnOrAfterT&& value) {
    m_scheduledOnOrAfterHasBeenSet = true;
    m_scheduledOnOrAfter = std::forward<ScheduledOnOrAfterT>(value);
  }
  template <typename ScheduledOnOrAfterT = Aws::Utils::DateTime>
  ListDatasetContentsRequest& WithScheduledOnOrAfter(ScheduledOnOrAfterT&& value) {
    SetScheduledOnOrAfter(std::forward<ScheduledOnOrAfterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScheduledBefore(ScheduledBeforeT&& value) {
    m_scheduledBeforeHasBeenSet = true;
    m_scheduledBefore = std::forward<ScheduledBeforeT>(value);
  }
  template <typename ScheduledBeforeT = Aws::Utils::DateTime>
  ListDatasetContentsRequest& WithScheduledBefore(ScheduledBeforeT&& value) {
    SetScheduledBefore(std::forward<ScheduledBeforeT>(value));
    return *this;
  }
  ///@}
 private:
