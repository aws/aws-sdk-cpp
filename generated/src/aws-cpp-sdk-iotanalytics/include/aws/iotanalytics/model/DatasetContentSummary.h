...
class DatasetContentSummary {
 public:
  ...
  template <typename VersionT = Aws::String>
  DatasetContentSummary& WithVersion(VersionT&& value) {
  ...
  template <typename StatusT = DatasetContentStatus>
  DatasetContentSummary& WithStatus(StatusT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  DatasetContentSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  void SetScheduleTime(ScheduleTimeT&& value) {
    m_scheduleTimeHasBeenSet = true;
    m_scheduleTime = std::forward<ScheduleTimeT>(value);
  }
  template <typename ScheduleTimeT = Aws::Utils::DateTime>
  DatasetContentSummary& WithScheduleTime(ScheduleTimeT&& value) {
    SetScheduleTime(std::forward<ScheduleTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CompletionTimeT = Aws::Utils::DateTime>
  DatasetContentSummary& WithCompletionTime(CompletionTimeT&& value) {
