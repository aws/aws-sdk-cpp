...
class RunPipelineActivityResult {
 public:
  ...
  template <typename PayloadsT = Aws::Vector<Aws::Utils::ByteBuffer>>
  RunPipelineActivityResult& WithPayloads(PayloadsT&& value) {
    SetPayloads(std::forward<PayloadsT>(value));
    return *this;
  }
  template <typename PayloadsT = Aws::Utils::ByteBuffer>
  RunPipelineActivityResult& AddPayloads(PayloadsT&& value) {
    m_payloadsHasBeenSet = true;
  ...
  void SetLogResult(LogResultT&& value) {
    ...
    m_logResult = std::forward<LogResultT>(value);
  }
  template <typename LogResultT = Aws::String>
  RunPipelineActivityResult& WithLogResult(LogResultT&& value) {
    SetLogResult(std::forward<LogResultT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  RunPipelineActivityResult& WithRequestId(RequestIdT&& value) {
