...
class DatasetContentDeliveryDestination {
 public:
   ...
   */
  inline const IotEventsDestinationConfiguration& GetIotEventsDestinationConfiguration() const {
    return m_iotEventsDestinationConfiguration;
  }
  ...
  void SetIotEventsDestinationConfiguration(IotEventsDestinationConfigurationT&& value) {
    ...
    m_iotEventsDestinationConfiguration = std::forward<IotEventsDestinationConfigurationT>(value);
  }
  template <typename IotEventsDestinationConfigurationT = IotEventsDestinationConfiguration>
  DatasetContentDeliveryDestination& WithIotEventsDestinationConfiguration(IotEventsDestinationConfigurationT&& value) {
    SetIotEventsDestinationConfiguration(std::forward<IotEventsDestinationConfigurationT>(value));
    return *this;
  }
  ///@}
