...
namespace ApiGatewayManagementApi
{
   ...
   * applicable.</p>
   */
  class AWS_APIGATEWAYMANAGEMENTAPI_API ApiGatewayManagementApiClient : Aws::Client::ClientWithAsyncTemplateMethods<ApiGatewayManagementApiClient>,
    smithy::client::AwsSmithyClientT<Aws::ApiGatewayManagementApi::SERVICE_NAME,
