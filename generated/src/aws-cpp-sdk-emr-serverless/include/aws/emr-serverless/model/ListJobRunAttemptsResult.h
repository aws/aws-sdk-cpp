...
class ListJobRunAttemptsResult {
 public:
  ...
  void SetJobRunAttempts(JobRunAttemptsT&& value) {
    m_jobRunAttemptsHasBeenSet = true;
    m_jobRunAttempts = std::forward<JobRunAttemptsT>(value);
  }
  template <typename JobRunAttemptsT = Aws::Vector<JobRunAttemptSummary>>
  ListJobRunAttemptsResult& WithJobRunAttempts(JobRunAttemptsT&& value) {
    SetJobRunAttempts(std::forward<JobRunAttemptsT>(value));
    return *this;
  }
  template <typename JobRunAttemptsT = JobRunAttemptSummary>
  ListJobRunAttemptsResult& AddJobRunAttempts(JobRunAttemptsT&& value) {
    m_jobRunAttemptsHasBeenSet = true;
    m_jobRunAttempts.emplace_back(std::forward<JobRunAttemptsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListJobRunAttemptsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListJobRunAttemptsResult& WithRequestId(RequestIdT&& value) {
