...
class TotalResourceUtilization {
 public:
  ...
  inline void SetVCPUHour(double value) {
    m_vCPUHourHasBeenSet = true;
    m_vCPUHour = value;
  }
  inline TotalResourceUtilization& WithVCPUHour(double value) {
    SetVCPUHour(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMemoryGBHour(double value) {
    m_memoryGBHourHasBeenSet = true;
    m_memoryGBHour = value;
  }
  inline TotalResourceUtilization& WithMemoryGBHour(double value) {
    SetMemoryGBHour(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStorageGBHour(double value) {
    m_storageGBHourHasBeenSet = true;
    m_storageGBHour = value;
  }
  inline TotalResourceUtilization& WithStorageGBHour(double value) {
    SetStorageGBHour(value);
    return *this;
  }
  ///@}
 private:
