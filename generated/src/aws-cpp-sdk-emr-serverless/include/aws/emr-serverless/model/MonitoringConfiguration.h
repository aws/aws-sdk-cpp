...
class MonitoringConfiguration {
 public:
   ...
   */
  inline const ManagedPersistenceMonitoringConfiguration& GetManagedPersistenceMonitoringConfiguration() const {
    return m_managedPersistenceMonitoringConfiguration;
  }
  ...
  void SetManagedPersistenceMonitoringConfiguration(ManagedPersistenceMonitoringConfigurationT&& value) {
    ...
    m_managedPersistenceMonitoringConfiguration = std::forward<ManagedPersistenceMonitoringConfigurationT>(value);
  }
  template <typename ManagedPersistenceMonitoringConfigurationT = ManagedPersistenceMonitoringConfiguration>
  MonitoringConfiguration& WithManagedPersistenceMonitoringConfiguration(ManagedPersistenceMonitoringConfigurationT&& value) {
    SetManagedPersistenceMonitoringConfiguration(std::forward<ManagedPersistenceMonitoringConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const PrometheusMonitoringConfiguration& GetPrometheusMonitoringConfiguration() const {
    return m_prometheusMonitoringConfiguration;
  }
  ...
  void SetPrometheusMonitoringConfiguration(PrometheusMonitoringConfigurationT&& value) {
    ...
    m_prometheusMonitoringConfiguration = std::forward<PrometheusMonitoringConfigurationT>(value);
  }
  template <typename PrometheusMonitoringConfigurationT = PrometheusMonitoringConfiguration>
  MonitoringConfiguration& WithPrometheusMonitoringConfiguration(PrometheusMonitoringConfigurationT&& value) {
    SetPrometheusMonitoringConfiguration(std::forward<PrometheusMonitoringConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
