...
/**
 */
class GetSessionRequest : public EMRServerlessRequest {
 public:
  AWS_EMRSERVERLESS_API GetSessionRequest() = default;
  ...
  template <typename ApplicationIdT = Aws::String>
  GetSessionRequest& WithApplicationId(ApplicationIdT&& value) {
