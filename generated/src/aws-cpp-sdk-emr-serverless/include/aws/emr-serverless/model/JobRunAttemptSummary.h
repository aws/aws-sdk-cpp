...
class JobRunAttemptSummary {
 public:
  ...
  inline JobRunAttemptSummary& WithMode(JobRunMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  void SetJobCreatedAt(JobCreatedAtT&& value) {
    ...
    m_jobCreatedAt = std::forward<JobCreatedAtT>(value);
  }
  template <typename JobCreatedAtT = Aws::Utils::DateTime>
  JobRunAttemptSummary& WithJobCreatedAt(JobCreatedAtT&& value) {
    SetJobCreatedAt(std::forward<JobCreatedAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline JobRunAttemptSummary& WithState(JobRunState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline JobRunAttemptSummary& WithAttempt(int value) {
    SetAttempt(value);
    return *this;
  }
  ///@}
