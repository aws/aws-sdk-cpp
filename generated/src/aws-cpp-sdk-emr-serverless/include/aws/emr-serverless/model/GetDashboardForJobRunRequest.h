...
class GetDashboardForJobRunRequest : public EMRServerlessRequest {
 public:
  AWS_EMRSERVERLESS_API GetDashboardForJobRunRequest() = default;
  ...
  template <typename ApplicationIdT = Aws::String>
  GetDashboardForJobRunRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename JobRunIdT = Aws::String>
  GetDashboardForJobRunRequest& WithJobRunId(JobRunIdT&& value) {
  ...
  inline GetDashboardForJobRunRequest& WithAttempt(int value) {
    SetAttempt(value);
    return *this;
  }
  ///@}
  ...
  inline GetDashboardForJobRunRequest& WithAccessSystemProfileLogs(bool value) {
