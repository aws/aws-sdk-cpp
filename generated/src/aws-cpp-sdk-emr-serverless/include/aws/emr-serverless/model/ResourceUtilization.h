...
class ResourceUtilization {
 public:
  ...
  inline ResourceUtilization& WithVCPUHour(double value) {
    SetVCPUHour(value);
    return *this;
  }
  ///@}
  ...
  inline ResourceUtilization& WithMemoryGBHour(double value) {
  ...
  inline ResourceUtilization& WithStorageGBHour(double value) {
