...
class CancelJobRunRequest : public EMRServerlessRequest {
 public:
  ...
  inline void SetShutdownGracePeriodInSeconds(int value) {
    m_shutdownGracePeriodInSecondsHasBeenSet = true;
    m_shutdownGracePeriodInSeconds = value;
  }
  inline CancelJobRunRequest& WithShutdownGracePeriodInSeconds(int value) {
    SetShutdownGracePeriodInSeconds(value);
    return *this;
  }
  ///@}
 private:
