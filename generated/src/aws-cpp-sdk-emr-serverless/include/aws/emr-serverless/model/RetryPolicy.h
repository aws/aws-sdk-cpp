...
class RetryPolicy {
 public:
  ...
  inline RetryPolicy& WithMaxAttempts(int value) {
  ...
  inline void SetMaxFailedAttemptsPerHour(int value) {
    m_maxFailedAttemptsPerHourHasBeenSet = true;
    m_maxFailedAttemptsPerHour = value;
  }
  inline RetryPolicy& WithMaxFailedAttemptsPerHour(int value) {
    SetMaxFailedAttemptsPerHour(value);
    return *this;
  }
  ///@}
 private:
