...
class ApplicationSummary {
 public:
  ...
  inline void SetState(ApplicationState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ApplicationSummary& WithState(ApplicationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline ApplicationSummary& WithArchitecture(Architecture value) {
