...
class JobRun {
 public:
  ...
  void SetExecutionIamPolicy(ExecutionIamPolicyT&& value) {
    ...
    m_executionIamPolicy = std::forward<ExecutionIamPolicyT>(value);
  }
  template <typename ExecutionIamPolicyT = JobRunExecutionIamPolicy>
  JobRun& WithExecutionIamPolicy(ExecutionIamPolicyT&& value) {
    SetExecutionIamPolicy(std::forward<ExecutionIamPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalExecutionDurationSeconds(int value) {
    m_totalExecutionDurationSecondsHasBeenSet = true;
    m_totalExecutionDurationSeconds = value;
  }
  inline JobRun& WithTotalExecutionDurationSeconds(int value) {
  ...
  inline void SetExecutionTimeoutMinutes(long long value) {
    m_executionTimeoutMinutesHasBeenSet = true;
    m_executionTimeoutMinutes = value;
  }
  inline JobRun& WithExecutionTimeoutMinutes(long long value) {
    SetExecutionTimeoutMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline JobRun& WithMode(JobRunMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQueuedDurationMilliseconds(long long value) {
    m_queuedDurationMillisecondsHasBeenSet = true;
    m_queuedDurationMilliseconds = value;
  }
  inline JobRun& WithQueuedDurationMilliseconds(long long value) {
    SetQueuedDurationMilliseconds(value);
    return *this;
  }
  ///@}
 private:
