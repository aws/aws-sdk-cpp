...
class SchedulerConfiguration {
 public:
  ...
  inline void SetQueueTimeoutMinutes(int value) {
    m_queueTimeoutMinutesHasBeenSet = true;
    m_queueTimeoutMinutes = value;
  }
  inline SchedulerConfiguration& WithQueueTimeoutMinutes(int value) {
    SetQueueTimeoutMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline SchedulerConfiguration& WithMaxConcurrentRuns(int value) {
