...
class InteractiveConfiguration {
 public:
  ...
  inline void SetStudioEnabled(bool value) {
    m_studioEnabledHasBeenSet = true;
    m_studioEnabled = value;
  }
  inline InteractiveConfiguration& WithStudioEnabled(bool value) {
    SetStudioEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLivyEndpointEnabled(bool value) {
    m_livyEndpointEnabledHasBeenSet = true;
    m_livyEndpointEnabled = value;
  }
  inline InteractiveConfiguration& WithLivyEndpointEnabled(bool value) {
    SetLivyEndpointEnabled(value);
    return *this;
  }
  ///@}
 private:
