...
class AWS_EMRSERVERLESS_API EMRServerlessClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  EMRServerlessClient(const Aws::EMRServerless::EMRServerlessClientConfiguration& clientConfiguration =
  ...
  EMRServerlessClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<EMRServerlessEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::EMRServerless::EMRServerlessClientConfiguration& clientConfiguration =
                          Aws::EMRServerless::EMRServerlessClientConfiguration());
  ...
  /**
   * An Async wrapper for CancelJobRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelJobRunRequestT = Model::CancelJobRunRequest>
  void CancelJobRunAsync(const CancelJobRunRequestT& request, const CancelJobRunResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for GetDashboardForJobRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDashboardForJobRun that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDashboardForJobRunRequestT = Model::GetDashboardForJobRunRequest>
  void GetDashboardForJobRunAsync(const GetDashboardForJobRunRequestT& request, const GetDashboardForJobRunResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListJobRunAttempts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListJobRunAttempts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListJobRunAttemptsRequestT = Model::ListJobRunAttemptsRequest>
  void ListJobRunAttemptsAsync(const ListJobRunAttemptsRequestT& request, const ListJobRunAttemptsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
