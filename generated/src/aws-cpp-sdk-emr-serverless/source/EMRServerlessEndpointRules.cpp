...
{
const size_t EMRServerlessEndpointRules::RulesBlobStrLen = 3756;
const size_t EMRServerlessEndpointRules::RulesBlobSize = 3757;
...
'"','h','t','t','p','s',':','/','/','e','m','r','-','s','e','r','v','e','r','l','e','s','s','-','f',
...
':','/','/','e','m','r','-','s','e','r','v','e','r','l','e','s','s','.','{','R','e','g','i','o','n',
