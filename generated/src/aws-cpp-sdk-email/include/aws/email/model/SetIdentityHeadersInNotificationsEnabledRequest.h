...
class SetIdentityHeadersInNotificationsEnabledRequest : public SESRequest {
 ...
 public:
  ...
  template <typename IdentityT = Aws::String>
  SetIdentityHeadersInNotificationsEnabledRequest& WithIdentity(IdentityT&& value) {
  ...
  inline SetIdentityHeadersInNotificationsEnabledRequest& WithNotificationType(NotificationType value) {
  ...
  inline SetIdentityHeadersInNotificationsEnabledRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
