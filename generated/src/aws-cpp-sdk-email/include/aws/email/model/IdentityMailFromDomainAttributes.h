...
class IdentityMailFromDomainAttributes {
 public:
  ...
  inline void SetMailFromDomainStatus(CustomMailFromStatus value) {
    m_mailFromDomainStatusHasBeenSet = true;
    m_mailFromDomainStatus = value;
  }
  inline IdentityMailFromDomainAttributes& WithMailFromDomainStatus(CustomMailFromStatus value) {
  ...
  inline IdentityMailFromDomainAttributes& WithBehaviorOnMXFailure(BehaviorOnMXFailure value) {
