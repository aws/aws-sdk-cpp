...
class DescribeReceiptRuleSetResult {
 public:
  ...
  template <typename MetadataT = ReceiptRuleSetMetadata>
  DescribeReceiptRuleSetResult& WithMetadata(MetadataT&& value) {
  ...
  template <typename RulesT = Aws::Vector<ReceiptRule>>
  DescribeReceiptRuleSetResult& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = ReceiptRule>
  DescribeReceiptRuleSetResult& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReceiptRuleSetResult& WithResponseMetadata(ResponseMetadataT&& value) {
