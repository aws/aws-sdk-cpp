...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API CreateConfigurationSetResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateConfigurationSetResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
