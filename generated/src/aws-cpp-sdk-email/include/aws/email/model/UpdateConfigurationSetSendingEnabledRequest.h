...
class UpdateConfigurationSetSendingEnabledRequest : public SESRequest {
 ...
 public:
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  UpdateConfigurationSetSendingEnabledRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  inline UpdateConfigurationSetSendingEnabledRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
