...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API SendBounceResult() = default;
    ...
    template<typename MessageIdT = Aws::String>
    SendBounceResult& WithMessageId(MessageIdT&& value) { SetMessageId(std::forward<MessageIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    SendBounceResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
