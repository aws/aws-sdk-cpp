...
class GetIdentityVerificationAttributesResult {
 public:
  ...
  template <typename VerificationAttributesT = Aws::Map<Aws::String, IdentityVerificationAttributes>>
  GetIdentityVerificationAttributesResult& WithVerificationAttributes(VerificationAttributesT&& value) {
  ...
  GetIdentityVerificationAttributesResult& AddVerificationAttributes(VerificationAttributesKeyT&& key,
                                                                     VerificationAttributesValueT&& value) {
    m_verificationAttributesHasBeenSet = true;
    m_verificationAttributes.emplace(std::forward<VerificationAttributesKeyT>(key), std::forward<VerificationAttributesValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetIdentityVerificationAttributesResult& WithResponseMetadata(ResponseMetadataT&& value) {
