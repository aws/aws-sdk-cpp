...
class CreateCustomVerificationEmailTemplateRequest : public SESRequest {
 ...
 public:
  ...
  template <typename TemplateNameT = Aws::String>
  CreateCustomVerificationEmailTemplateRequest& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename FromEmailAddressT = Aws::String>
  CreateCustomVerificationEmailTemplateRequest& WithFromEmailAddress(FromEmailAddressT&& value) {
  ...
  template <typename TemplateSubjectT = Aws::String>
  CreateCustomVerificationEmailTemplateRequest& WithTemplateSubject(TemplateSubjectT&& value) {
  ...
  template <typename TemplateContentT = Aws::String>
  CreateCustomVerificationEmailTemplateRequest& WithTemplateContent(TemplateContentT&& value) {
  ...
  template <typename SuccessRedirectionURLT = Aws::String>
  CreateCustomVerificationEmailTemplateRequest& WithSuccessRedirectionURL(SuccessRedirectionURLT&& value) {
  ...
  template <typename FailureRedirectionURLT = Aws::String>
  CreateCustomVerificationEmailTemplateRequest& WithFailureRedirectionURL(FailureRedirectionURLT&& value) {
