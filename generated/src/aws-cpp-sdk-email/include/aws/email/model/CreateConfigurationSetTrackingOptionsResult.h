...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API CreateConfigurationSetTrackingOptionsResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateConfigurationSetTrackingOptionsResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
