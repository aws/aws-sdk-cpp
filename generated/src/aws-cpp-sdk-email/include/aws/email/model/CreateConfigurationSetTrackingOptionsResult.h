...
class CreateConfigurationSetTrackingOptionsResult {
 public:
  ...
  AWS_SES_API CreateConfigurationSetTrackingOptionsResult& operator=(
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateConfigurationSetTrackingOptionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
