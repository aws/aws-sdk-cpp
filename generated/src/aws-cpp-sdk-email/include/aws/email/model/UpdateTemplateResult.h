...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API UpdateTemplateResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    UpdateTemplateResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
