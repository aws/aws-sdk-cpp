...
class SetIdentityFeedbackForwardingEnabledResult {
 public:
  ...
  AWS_SES_API SetIdentityFeedbackForwardingEnabledResult& operator=(
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SetIdentityFeedbackForwardingEnabledResult& WithResponseMetadata(ResponseMetadataT&& value) {
