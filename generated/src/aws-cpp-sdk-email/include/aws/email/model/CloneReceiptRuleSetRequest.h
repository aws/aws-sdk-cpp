...
class CloneReceiptRuleSetRequest : public SESRequest {
 ...
 public:
  ...
  void SetOriginalRuleSetName(OriginalRuleSetNameT&& value) {
    m_originalRuleSetNameHasBeenSet = true;
    m_originalRuleSetName = std::forward<OriginalRuleSetNameT>(value);
  }
  template <typename OriginalRuleSetNameT = Aws::String>
  CloneReceiptRuleSetRequest& WithOriginalRuleSetName(OriginalRuleSetNameT&& value) {
    SetOriginalRuleSetName(std::forward<OriginalRuleSetNameT>(value));
    return *this;
  }
  ///@}
 private:
