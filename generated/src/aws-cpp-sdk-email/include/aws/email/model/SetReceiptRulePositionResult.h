...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API SetReceiptRulePositionResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    SetReceiptRulePositionResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
