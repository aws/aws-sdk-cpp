...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API DeleteConfigurationSetTrackingOptionsResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteConfigurationSetTrackingOptionsResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
