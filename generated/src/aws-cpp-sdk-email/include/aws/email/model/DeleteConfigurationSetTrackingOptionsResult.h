...
class DeleteConfigurationSetTrackingOptionsResult {
 public:
  ...
  AWS_SES_API DeleteConfigurationSetTrackingOptionsResult& operator=(
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteConfigurationSetTrackingOptionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
