...
class CreateConfigurationSetEventDestinationResult {
 public:
  ...
  AWS_SES_API CreateConfigurationSetEventDestinationResult& operator=(
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateConfigurationSetEventDestinationResult& WithResponseMetadata(ResponseMetadataT&& value) {
