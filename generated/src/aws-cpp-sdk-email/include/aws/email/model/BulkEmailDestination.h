...
class BulkEmailDestination {
 public:
  ...
  template <typename DestinationT = Destination>
  BulkEmailDestination& WithDestination(DestinationT&& value) {
  ...
  template <typename ReplacementTagsT = Aws::Vector<MessageTag>>
  BulkEmailDestination& WithReplacementTags(ReplacementTagsT&& value) {
    SetReplacementTags(std::forward<ReplacementTagsT>(value));
    return *this;
  }
  template <typename ReplacementTagsT = MessageTag>
  BulkEmailDestination& AddReplacementTags(ReplacementTagsT&& value) {
    m_replacementTagsHasBeenSet = true;
  ...
  void SetReplacementTemplateData(ReplacementTemplateDataT&& value) {
    m_replacementTemplateDataHasBeenSet = true;
    m_replacementTemplateData = std::forward<ReplacementTemplateDataT>(value);
  }
  template <typename ReplacementTemplateDataT = Aws::String>
  BulkEmailDestination& WithReplacementTemplateData(ReplacementTemplateDataT&& value) {
    SetReplacementTemplateData(std::forward<ReplacementTemplateDataT>(value));
    return *this;
  }
  ///@}
 private:
