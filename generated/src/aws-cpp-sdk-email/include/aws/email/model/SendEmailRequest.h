...
class SendEmailRequest : public SESRequest {
 ...
 public:
  ...
  void SetReturnPath(ReturnPathT&& value) {
    ...
    m_returnPath = std::forward<ReturnPathT>(value);
  }
  template <typename ReturnPathT = Aws::String>
  SendEmailRequest& WithReturnPath(ReturnPathT&& value) {
    SetReturnPath(std::forward<ReturnPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReturnPathArn(ReturnPathArnT&& value) {
    m_returnPathArnHasBeenSet = true;
    m_returnPathArn = std::forward<ReturnPathArnT>(value);
  }
  template <typename ReturnPathArnT = Aws::String>
  SendEmailRequest& WithReturnPathArn(ReturnPathArnT&& value) {
    SetReturnPathArn(std::forward<ReturnPathArnT>(value));
    return *this;
  }
  ///@}
