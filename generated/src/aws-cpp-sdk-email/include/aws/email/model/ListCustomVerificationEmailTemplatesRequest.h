...
class ListCustomVerificationEmailTemplatesRequest : public SESRequest {
 public:
  AWS_SES_API ListCustomVerificationEmailTemplatesRequest() = default;
 ...
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomVerificationEmailTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCustomVerificationEmailTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
