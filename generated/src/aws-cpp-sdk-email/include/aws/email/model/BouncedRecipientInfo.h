...
class BouncedRecipientInfo {
 public:
  ...
  void SetRecipientArn(RecipientArnT&& value) {
    ...
    m_recipientArn = std::forward<RecipientArnT>(value);
  }
  template <typename RecipientArnT = Aws::String>
  BouncedRecipientInfo& WithRecipientArn(RecipientArnT&& value) {
    SetRecipientArn(std::forward<RecipientArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBounceType(BounceType value) {
    m_bounceTypeHasBeenSet = true;
    m_bounceType = value;
  }
  inline BouncedRecipientInfo& WithBounceType(BounceType value) {
    SetBounceType(value);
    return *this;
  }
  ///@}
  ...
  void SetRecipientDsnFields(RecipientDsnFieldsT&& value) {
    ...
    m_recipientDsnFields = std::forward<RecipientDsnFieldsT>(value);
  }
  template <typename RecipientDsnFieldsT = RecipientDsnFields>
  BouncedRecipientInfo& WithRecipientDsnFields(RecipientDsnFieldsT&& value) {
    SetRecipientDsnFields(std::forward<RecipientDsnFieldsT>(value));
    return *this;
  }
  ///@}
 private:
