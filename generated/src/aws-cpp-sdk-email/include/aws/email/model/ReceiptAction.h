...
class ReceiptAction {
 public:
  ...
  void SetS3Action(S3ActionT&& value) {
    ...
    m_s3Action = std::forward<S3ActionT>(value);
  }
  template <typename S3ActionT = S3Action>
  ReceiptAction& WithS3Action(S3ActionT&& value) {
    SetS3Action(std::forward<S3ActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBounceAction(BounceActionT&& value) {
    ...
    m_bounceAction = std::forward<BounceActionT>(value);
  }
  template <typename BounceActionT = BounceAction>
  ReceiptAction& WithBounceAction(BounceActionT&& value) {
    SetBounceAction(std::forward<BounceActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorkmailAction(WorkmailActionT&& value) {
    ...
    m_workmailAction = std::forward<WorkmailActionT>(value);
  }
  template <typename WorkmailActionT = WorkmailAction>
  ReceiptAction& WithWorkmailAction(WorkmailActionT&& value) {
    SetWorkmailAction(std::forward<WorkmailActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStopAction(StopActionT&& value) {
    ...
    m_stopAction = std::forward<StopActionT>(value);
  }
  template <typename StopActionT = StopAction>
  ReceiptAction& WithStopAction(StopActionT&& value) {
    SetStopAction(std::forward<StopActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAddHeaderAction(AddHeaderActionT&& value) {
    ...
    m_addHeaderAction = std::forward<AddHeaderActionT>(value);
  }
  template <typename AddHeaderActionT = AddHeaderAction>
  ReceiptAction& WithAddHeaderAction(AddHeaderActionT&& value) {
    SetAddHeaderAction(std::forward<AddHeaderActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSNSAction(SNSActionT&& value) {
    ...
    m_sNSAction = std::forward<SNSActionT>(value);
  }
  template <typename SNSActionT = SNSAction>
  ReceiptAction& WithSNSAction(SNSActionT&& value) {
    SetSNSAction(std::forward<SNSActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectAction(ConnectActionT&& value) {
    ...
    m_connectAction = std::forward<ConnectActionT>(value);
  }
  template <typename ConnectActionT = ConnectAction>
  ReceiptAction& WithConnectAction(ConnectActionT&& value) {
    SetConnectAction(std::forward<ConnectActionT>(value));
    return *this;
  }
  ///@}
 private:
