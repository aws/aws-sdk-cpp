...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API VerifyEmailIdentityResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    VerifyEmailIdentityResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
