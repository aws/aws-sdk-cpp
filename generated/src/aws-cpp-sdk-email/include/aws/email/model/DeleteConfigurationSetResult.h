...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API DeleteConfigurationSetResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteConfigurationSetResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
