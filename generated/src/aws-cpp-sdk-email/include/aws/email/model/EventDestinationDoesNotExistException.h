...
class EventDestinationDoesNotExistException {
 public:
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  EventDestinationDoesNotExistException& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename EventDestinationNameT = Aws::String>
  EventDestinationDoesNotExistException& WithEventDestinationName(EventDestinationNameT&& value) {
