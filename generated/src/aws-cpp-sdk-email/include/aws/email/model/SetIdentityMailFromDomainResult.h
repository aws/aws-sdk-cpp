...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API SetIdentityMailFromDomainResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    SetIdentityMailFromDomainResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
