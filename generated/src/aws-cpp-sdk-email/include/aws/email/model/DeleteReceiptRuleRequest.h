...
namespace Model
{
  ...
  public:
    ...
    template<typename RuleSetNameT = Aws::String>
    DeleteReceiptRuleRequest& WithRuleSetName(RuleSetNameT&& value) { SetRuleSetName(std::forward<RuleSetNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RuleNameT = Aws::String>
    DeleteReceiptRuleRequest& WithRuleName(RuleNameT&& value) { SetRuleName(std::forward<RuleNameT>(value)); return *this;}
    ///@}
  private:
