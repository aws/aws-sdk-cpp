...
class ListReceiptFiltersResult {
 public:
  ...
  template <typename FiltersT = Aws::Vector<ReceiptFilter>>
  ListReceiptFiltersResult& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ReceiptFilter>
  ListReceiptFiltersResult& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListReceiptFiltersResult& WithResponseMetadata(ResponseMetadataT&& value) {
