 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/UpdateCustomVerificationEmailTemplateRequest">AWS
 * API Reference</a></p>
 */
class UpdateCustomVerificationEmailTemplateRequest : public SESRequest {
 public:
  AWS_SES_API UpdateCustomVerificationEmailTemplateRequest() = default;
 ...
 public:
  ...
  template <typename TemplateNameT = Aws::String>
  UpdateCustomVerificationEmailTemplateRequest& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename FromEmailAddressT = Aws::String>
  UpdateCustomVerificationEmailTemplateRequest& WithFromEmailAddress(FromEmailAddressT&& value) {
  ...
  template <typename TemplateSubjectT = Aws::String>
  UpdateCustomVerificationEmailTemplateRequest& WithTemplateSubject(TemplateSubjectT&& value) {
  ...
  template <typename TemplateContentT = Aws::String>
  UpdateCustomVerificationEmailTemplateRequest& WithTemplateContent(TemplateContentT&& value) {
  ...
  template <typename SuccessRedirectionURLT = Aws::String>
  UpdateCustomVerificationEmailTemplateRequest& WithSuccessRedirectionURL(SuccessRedirectionURLT&& value) {
  ...
  template <typename FailureRedirectionURLT = Aws::String>
  UpdateCustomVerificationEmailTemplateRequest& WithFailureRedirectionURL(FailureRedirectionURLT&& value) {
