...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API VerifyEmailAddressRequest() = default;
  ...
  public:
    ...
    template<typename EmailAddressT = Aws::String>
    VerifyEmailAddressRequest& WithEmailAddress(EmailAddressT&& value) { SetEmailAddress(std::forward<EmailAddressT>(value)); return *this;}
    ///@}
  private:
