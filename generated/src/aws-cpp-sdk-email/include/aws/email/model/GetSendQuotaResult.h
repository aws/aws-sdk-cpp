...
class GetSendQuotaResult {
 public:
  ...
  inline GetSendQuotaResult& WithMax24HourSend(double value) {
  ...
  inline GetSendQuotaResult& WithMaxSendRate(double value) {
  ...
  inline GetSendQuotaResult& WithSentLast24Hours(double value) {
