...
class SendDataPoint {
 public:
  ...
  inline void SetDeliveryAttempts(long long value) {
    m_deliveryAttemptsHasBeenSet = true;
    m_deliveryAttempts = value;
  }
  inline SendDataPoint& WithDeliveryAttempts(long long value) {
  ...
  inline void SetBounces(long long value) {
    m_bouncesHasBeenSet = true;
    m_bounces = value;
  }
  inline SendDataPoint& WithBounces(long long value) {
    SetBounces(value);
    return *this;
  }
  ///@}
  ...
  inline void SetComplaints(long long value) {
    m_complaintsHasBeenSet = true;
    m_complaints = value;
  }
  inline SendDataPoint& WithComplaints(long long value) {
    SetComplaints(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRejects(long long value) {
    m_rejectsHasBeenSet = true;
    m_rejects = value;
  }
  inline SendDataPoint& WithRejects(long long value) {
    SetRejects(value);
    return *this;
  }
  ///@}
