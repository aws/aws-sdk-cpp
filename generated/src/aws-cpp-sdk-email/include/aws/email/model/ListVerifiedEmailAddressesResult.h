...
class ListVerifiedEmailAddressesResult {
 public:
  ...
  void SetVerifiedEmailAddresses(VerifiedEmailAddressesT&& value) {
    m_verifiedEmailAddressesHasBeenSet = true;
    m_verifiedEmailAddresses = std::forward<VerifiedEmailAddressesT>(value);
  }
  template <typename VerifiedEmailAddressesT = Aws::Vector<Aws::String>>
  ListVerifiedEmailAddressesResult& WithVerifiedEmailAddresses(VerifiedEmailAddressesT&& value) {
    SetVerifiedEmailAddresses(std::forward<VerifiedEmailAddressesT>(value));
    return *this;
  }
  template <typename VerifiedEmailAddressesT = Aws::String>
  ListVerifiedEmailAddressesResult& AddVerifiedEmailAddresses(VerifiedEmailAddressesT&& value) {
    m_verifiedEmailAddressesHasBeenSet = true;
    m_verifiedEmailAddresses.emplace_back(std::forward<VerifiedEmailAddressesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListVerifiedEmailAddressesResult& WithResponseMetadata(ResponseMetadataT&& value) {
