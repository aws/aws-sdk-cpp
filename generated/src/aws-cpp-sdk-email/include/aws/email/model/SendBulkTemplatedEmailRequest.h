...
class SendBulkTemplatedEmailRequest : public SESRequest {
 ...
 public:
  ...
  void SetDefaultTemplateData(DefaultTemplateDataT&& value) {
    m_defaultTemplateDataHasBeenSet = true;
    m_defaultTemplateData = std::forward<DefaultTemplateDataT>(value);
  }
  template <typename DefaultTemplateDataT = Aws::String>
  SendBulkTemplatedEmailRequest& WithDefaultTemplateData(DefaultTemplateDataT&& value) {
    SetDefaultTemplateData(std::forward<DefaultTemplateDataT>(value));
    return *this;
  }
  ///@}
