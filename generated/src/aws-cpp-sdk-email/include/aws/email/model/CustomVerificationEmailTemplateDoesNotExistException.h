...
class CustomVerificationEmailTemplateDoesNotExistException {
 public:
  ...
  void SetCustomVerificationEmailTemplateName(CustomVerificationEmailTemplateNameT&& value) {
    m_customVerificationEmailTemplateNameHasBeenSet = true;
    m_customVerificationEmailTemplateName = std::forward<CustomVerificationEmailTemplateNameT>(value);
  }
  template <typename CustomVerificationEmailTemplateNameT = Aws::String>
  CustomVerificationEmailTemplateDoesNotExistException& WithCustomVerificationEmailTemplateName(
      CustomVerificationEmailTemplateNameT&& value) {
    SetCustomVerificationEmailTemplateName(std::forward<CustomVerificationEmailTemplateNameT>(value));
    return *this;
  }
  ///@}
 private:
