...
class VerifyDomainDkimResult {
 public:
  ...
  template <typename DkimTokensT = Aws::Vector<Aws::String>>
  VerifyDomainDkimResult& WithDkimTokens(DkimTokensT&& value) {
    SetDkimTokens(std::forward<DkimTokensT>(value));
    return *this;
  }
  template <typename DkimTokensT = Aws::String>
  VerifyDomainDkimResult& AddDkimTokens(DkimTokensT&& value) {
    m_dkimTokensHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  VerifyDomainDkimResult& WithResponseMetadata(ResponseMetadataT&& value) {
