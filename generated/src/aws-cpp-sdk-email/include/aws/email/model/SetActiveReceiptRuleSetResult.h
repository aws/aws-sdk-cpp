...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API SetActiveReceiptRuleSetResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    SetActiveReceiptRuleSetResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
