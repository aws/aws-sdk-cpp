...
class RecipientDsnFields {
 public:
  ...
  void SetFinalRecipient(FinalRecipientT&& value) {
    ...
    m_finalRecipient = std::forward<FinalRecipientT>(value);
  }
  template <typename FinalRecipientT = Aws::String>
  RecipientDsnFields& WithFinalRecipient(FinalRecipientT&& value) {
    SetFinalRecipient(std::forward<FinalRecipientT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAction(DsnAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline RecipientDsnFields& WithAction(DsnAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetRemoteMta(RemoteMtaT&& value) {
    ...
    m_remoteMta = std::forward<RemoteMtaT>(value);
  }
  template <typename RemoteMtaT = Aws::String>
  RecipientDsnFields& WithRemoteMta(RemoteMtaT&& value) {
    SetRemoteMta(std::forward<RemoteMtaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDiagnosticCode(DiagnosticCodeT&& value) {
    ...
    m_diagnosticCode = std::forward<DiagnosticCodeT>(value);
  }
  template <typename DiagnosticCodeT = Aws::String>
  RecipientDsnFields& WithDiagnosticCode(DiagnosticCodeT&& value) {
    SetDiagnosticCode(std::forward<DiagnosticCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastAttemptDate(LastAttemptDateT&& value) {
    ...
    m_lastAttemptDate = std::forward<LastAttemptDateT>(value);
  }
  template <typename LastAttemptDateT = Aws::Utils::DateTime>
  RecipientDsnFields& WithLastAttemptDate(LastAttemptDateT&& value) {
    SetLastAttemptDate(std::forward<LastAttemptDateT>(value));
    return *this;
  }
  ///@}
