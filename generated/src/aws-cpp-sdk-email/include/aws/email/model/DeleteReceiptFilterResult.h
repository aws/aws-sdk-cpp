...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API DeleteReceiptFilterResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteReceiptFilterResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
