...
class IdentityVerificationAttributes {
 public:
  ...
  inline IdentityVerificationAttributes& WithVerificationStatus(VerificationStatus value) {
  ...
  void SetVerificationToken(VerificationTokenT&& value) {
    ...
    m_verificationToken = std::forward<VerificationTokenT>(value);
  }
  template <typename VerificationTokenT = Aws::String>
  IdentityVerificationAttributes& WithVerificationToken(VerificationTokenT&& value) {
    SetVerificationToken(std::forward<VerificationTokenT>(value));
    return *this;
  }
  ///@}
 private:
