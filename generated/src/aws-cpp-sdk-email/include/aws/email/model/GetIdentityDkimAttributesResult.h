...
class GetIdentityDkimAttributesResult {
 public:
  ...
  template <typename DkimAttributesT = Aws::Map<Aws::String, IdentityDkimAttributes>>
  GetIdentityDkimAttributesResult& WithDkimAttributes(DkimAttributesT&& value) {
  ...
  GetIdentityDkimAttributesResult& AddDkimAttributes(DkimAttributesKeyT&& key, DkimAttributesValueT&& value) {
    m_dkimAttributesHasBeenSet = true;
    m_dkimAttributes.emplace(std::forward<DkimAttributesKeyT>(key), std::forward<DkimAttributesValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetIdentityDkimAttributesResult& WithResponseMetadata(ResponseMetadataT&& value) {
