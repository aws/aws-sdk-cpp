...
class InvalidCloudWatchDestinationException {
 public:
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  InvalidCloudWatchDestinationException& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename EventDestinationNameT = Aws::String>
  InvalidCloudWatchDestinationException& WithEventDestinationName(EventDestinationNameT&& value) {
