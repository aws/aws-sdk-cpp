...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API CreateReceiptFilterResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateReceiptFilterResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
