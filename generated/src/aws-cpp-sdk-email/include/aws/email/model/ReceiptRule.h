...
class ReceiptRule {
 public:
  ...
  inline ReceiptRule& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline ReceiptRule& WithTlsPolicy(TlsPolicy value) {
    SetTlsPolicy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScanEnabled(bool value) {
    m_scanEnabledHasBeenSet = true;
    m_scanEnabled = value;
  }
  inline ReceiptRule& WithScanEnabled(bool value) {
