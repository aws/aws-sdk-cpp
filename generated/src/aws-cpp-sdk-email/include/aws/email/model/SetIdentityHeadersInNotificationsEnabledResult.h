...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API SetIdentityHeadersInNotificationsEnabledResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    SetIdentityHeadersInNotificationsEnabledResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
