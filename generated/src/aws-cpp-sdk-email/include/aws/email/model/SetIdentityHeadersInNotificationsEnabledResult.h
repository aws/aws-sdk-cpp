...
class SetIdentityHeadersInNotificationsEnabledResult {
 public:
  ...
  AWS_SES_API SetIdentityHeadersInNotificationsEnabledResult& operator=(
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SetIdentityHeadersInNotificationsEnabledResult& WithResponseMetadata(ResponseMetadataT&& value) {
