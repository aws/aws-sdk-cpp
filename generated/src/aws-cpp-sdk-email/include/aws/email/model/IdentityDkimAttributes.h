...
class IdentityDkimAttributes {
 public:
  ...
  inline void SetDkimEnabled(bool value) {
    m_dkimEnabledHasBeenSet = true;
    m_dkimEnabled = value;
  }
  inline IdentityDkimAttributes& WithDkimEnabled(bool value) {
    SetDkimEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDkimVerificationStatus(VerificationStatus value) {
    m_dkimVerificationStatusHasBeenSet = true;
    m_dkimVerificationStatus = value;
  }
  inline IdentityDkimAttributes& WithDkimVerificationStatus(VerificationStatus value) {
  ...
  template <typename DkimTokensT = Aws::Vector<Aws::String>>
  IdentityDkimAttributes& WithDkimTokens(DkimTokensT&& value) {
    SetDkimTokens(std::forward<DkimTokensT>(value));
    return *this;
  }
  template <typename DkimTokensT = Aws::String>
  IdentityDkimAttributes& AddDkimTokens(DkimTokensT&& value) {
    m_dkimTokensHasBeenSet = true;
