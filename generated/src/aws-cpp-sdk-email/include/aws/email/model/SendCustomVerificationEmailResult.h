...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API SendCustomVerificationEmailResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    SendCustomVerificationEmailResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
