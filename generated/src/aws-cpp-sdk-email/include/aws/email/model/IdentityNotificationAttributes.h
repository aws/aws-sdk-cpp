...
class IdentityNotificationAttributes {
 public:
  ...
  void SetBounceTopic(BounceTopicT&& value) {
    ...
    m_bounceTopic = std::forward<BounceTopicT>(value);
  }
  template <typename BounceTopicT = Aws::String>
  IdentityNotificationAttributes& WithBounceTopic(BounceTopicT&& value) {
    SetBounceTopic(std::forward<BounceTopicT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComplaintTopic(ComplaintTopicT&& value) {
    ...
    m_complaintTopic = std::forward<ComplaintTopicT>(value);
  }
  template <typename ComplaintTopicT = Aws::String>
  IdentityNotificationAttributes& WithComplaintTopic(ComplaintTopicT&& value) {
    SetComplaintTopic(std::forward<ComplaintTopicT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeliveryTopic(DeliveryTopicT&& value) {
    ...
    m_deliveryTopic = std::forward<DeliveryTopicT>(value);
  }
  template <typename DeliveryTopicT = Aws::String>
  IdentityNotificationAttributes& WithDeliveryTopic(DeliveryTopicT&& value) {
    SetDeliveryTopic(std::forward<DeliveryTopicT>(value));
    return *this;
  }
  ///@}
  ...
  inline IdentityNotificationAttributes& WithForwardingEnabled(bool value) {
  ...
  inline void SetHeadersInBounceNotificationsEnabled(bool value) {
    m_headersInBounceNotificationsEnabledHasBeenSet = true;
    m_headersInBounceNotificationsEnabled = value;
  }
  inline IdentityNotificationAttributes& WithHeadersInBounceNotificationsEnabled(bool value) {
    SetHeadersInBounceNotificationsEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHeadersInComplaintNotificationsEnabled(bool value) {
    m_headersInComplaintNotificationsEnabledHasBeenSet = true;
    m_headersInComplaintNotificationsEnabled = value;
  }
  inline IdentityNotificationAttributes& WithHeadersInComplaintNotificationsEnabled(bool value) {
    SetHeadersInComplaintNotificationsEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHeadersInDeliveryNotificationsEnabled(bool value) {
    m_headersInDeliveryNotificationsEnabledHasBeenSet = true;
    m_headersInDeliveryNotificationsEnabled = value;
  }
  inline IdentityNotificationAttributes& WithHeadersInDeliveryNotificationsEnabled(bool value) {
    SetHeadersInDeliveryNotificationsEnabled(value);
    return *this;
  }
  ///@}
 private:
