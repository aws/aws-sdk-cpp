...
class DescribeConfigurationSetRequest : public SESRequest {
 ...
 public:
   ...
   */
  inline const Aws::Vector<ConfigurationSetAttribute>& GetConfigurationSetAttributeNames() const {
    return m_configurationSetAttributeNames;
  }
  ...
  void SetConfigurationSetAttributeNames(ConfigurationSetAttributeNamesT&& value) {
    m_configurationSetAttributeNamesHasBeenSet = true;
    m_configurationSetAttributeNames = std::forward<ConfigurationSetAttributeNamesT>(value);
  }
  template <typename ConfigurationSetAttributeNamesT = Aws::Vector<ConfigurationSetAttribute>>
  DescribeConfigurationSetRequest& WithConfigurationSetAttributeNames(ConfigurationSetAttributeNamesT&& value) {
    SetConfigurationSetAttributeNames(std::forward<ConfigurationSetAttributeNamesT>(value));
    return *this;
  }
  inline DescribeConfigurationSetRequest& AddConfigurationSetAttributeNames(ConfigurationSetAttribute value) {
    m_configurationSetAttributeNamesHasBeenSet = true;
    m_configurationSetAttributeNames.push_back(value);
    return *this;
  }
  ///@}
 private:
