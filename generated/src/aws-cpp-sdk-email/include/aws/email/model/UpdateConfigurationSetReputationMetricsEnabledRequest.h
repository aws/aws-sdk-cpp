...
class UpdateConfigurationSetReputationMetricsEnabledRequest : public SESRequest {
 ...
 public:
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  UpdateConfigurationSetReputationMetricsEnabledRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  inline UpdateConfigurationSetReputationMetricsEnabledRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
