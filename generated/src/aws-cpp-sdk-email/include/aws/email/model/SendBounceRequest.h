...
class SendBounceRequest : public SESRequest {
 ...
 public:
  ...
  void SetOriginalMessageId(OriginalMessageIdT&& value) {
    m_originalMessageIdHasBeenSet = true;
    m_originalMessageId = std::forward<OriginalMessageIdT>(value);
  }
  template <typename OriginalMessageIdT = Aws::String>
  SendBounceRequest& WithOriginalMessageId(OriginalMessageIdT&& value) {
    SetOriginalMessageId(std::forward<OriginalMessageIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBounceSender(BounceSenderT&& value) {
    m_bounceSenderHasBeenSet = true;
    m_bounceSender = std::forward<BounceSenderT>(value);
  }
  template <typename BounceSenderT = Aws::String>
  SendBounceRequest& WithBounceSender(BounceSenderT&& value) {
    SetBounceSender(std::forward<BounceSenderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMessageDsn(MessageDsnT&& value) {
    m_messageDsnHasBeenSet = true;
    m_messageDsn = std::forward<MessageDsnT>(value);
  }
  template <typename MessageDsnT = MessageDsn>
  SendBounceRequest& WithMessageDsn(MessageDsnT&& value) {
    SetMessageDsn(std::forward<MessageDsnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBouncedRecipientInfoList(BouncedRecipientInfoListT&& value) {
    m_bouncedRecipientInfoListHasBeenSet = true;
    m_bouncedRecipientInfoList = std::forward<BouncedRecipientInfoListT>(value);
  }
  template <typename BouncedRecipientInfoListT = Aws::Vector<BouncedRecipientInfo>>
  SendBounceRequest& WithBouncedRecipientInfoList(BouncedRecipientInfoListT&& value) {
    SetBouncedRecipientInfoList(std::forward<BouncedRecipientInfoListT>(value));
    return *this;
  }
  ...
  SendBounceRequest& AddBouncedRecipientInfoList(BouncedRecipientInfoListT&& value) {
    m_bouncedRecipientInfoListHasBeenSet = true;
    m_bouncedRecipientInfoList.emplace_back(std::forward<BouncedRecipientInfoListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBounceSenderArn(BounceSenderArnT&& value) {
    m_bounceSenderArnHasBeenSet = true;
    m_bounceSenderArn = std::forward<BounceSenderArnT>(value);
  }
  template <typename BounceSenderArnT = Aws::String>
  SendBounceRequest& WithBounceSenderArn(BounceSenderArnT&& value) {
    SetBounceSenderArn(std::forward<BounceSenderArnT>(value));
    return *this;
  }
  ///@}
 private:
