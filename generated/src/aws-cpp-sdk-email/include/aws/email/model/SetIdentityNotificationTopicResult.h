...
namespace Model
{
  ...
  {
  public:
    AWS_SES_API SetIdentityNotificationTopicResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    SetIdentityNotificationTopicResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
