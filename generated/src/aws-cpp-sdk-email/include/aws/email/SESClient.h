...
class AWS_SES_API SESClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  SESClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SESEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CloneReceiptRuleSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CloneReceiptRuleSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CloneReceiptRuleSetRequestT = Model::CloneReceiptRuleSetRequest>
  void CloneReceiptRuleSetAsync(const CloneReceiptRuleSetRequestT& request, const CloneReceiptRuleSetResponseReceivedHandler& handler,
  ...
  virtual Model::CreateConfigurationSetTrackingOptionsOutcome CreateConfigurationSetTrackingOptions(
      const Model::CreateConfigurationSetTrackingOptionsRequest& request) const;

  /**
   * A Callable wrapper for CreateConfigurationSetTrackingOptions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateConfigurationSetTrackingOptionsRequestT = Model::CreateConfigurationSetTrackingOptionsRequest>
  Model::CreateConfigurationSetTrackingOptionsOutcomeCallable CreateConfigurationSetTrackingOptionsCallable(
      const CreateConfigurationSetTrackingOptionsRequestT& request) const {
    return SubmitCallable(&SESClient::CreateConfigurationSetTrackingOptions, request);
  }

  /**
   * An Async wrapper for CreateConfigurationSetTrackingOptions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateConfigurationSetTrackingOptionsRequestT = Model::CreateConfigurationSetTrackingOptionsRequest>
  void CreateConfigurationSetTrackingOptionsAsync(const CreateConfigurationSetTrackingOptionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCustomVerificationEmailTemplateOutcome CreateCustomVerificationEmailTemplate(
      const Model::CreateCustomVerificationEmailTemplateRequest& request) const;

  /**
   * A Callable wrapper for CreateCustomVerificationEmailTemplate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateCustomVerificationEmailTemplateRequestT = Model::CreateCustomVerificationEmailTemplateRequest>
  Model::CreateCustomVerificationEmailTemplateOutcomeCallable CreateCustomVerificationEmailTemplateCallable(
      const CreateCustomVerificationEmailTemplateRequestT& request) const {
    return SubmitCallable(&SESClient::CreateCustomVerificationEmailTemplate, request);
  }

  /**
   * An Async wrapper for CreateCustomVerificationEmailTemplate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateCustomVerificationEmailTemplateRequestT = Model::CreateCustomVerificationEmailTemplateRequest>
  void CreateCustomVerificationEmailTemplateAsync(const CreateCustomVerificationEmailTemplateRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateReceiptFilter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateReceiptFilter that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateReceiptFilterRequestT = Model::CreateReceiptFilterRequest>
  void CreateReceiptFilterAsync(const CreateReceiptFilterRequestT& request, const CreateReceiptFilterResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateReceiptRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateReceiptRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateReceiptRuleRequestT = Model::CreateReceiptRuleRequest>
  void CreateReceiptRuleAsync(const CreateReceiptRuleRequestT& request, const CreateReceiptRuleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateReceiptRuleSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateReceiptRuleSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateReceiptRuleSetRequestT = Model::CreateReceiptRuleSetRequest>
  void CreateReceiptRuleSetAsync(const CreateReceiptRuleSetRequestT& request, const CreateReceiptRuleSetResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfigurationSetTrackingOptionsOutcome DeleteConfigurationSetTrackingOptions(
      const Model::DeleteConfigurationSetTrackingOptionsRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfigurationSetTrackingOptions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteConfigurationSetTrackingOptionsRequestT = Model::DeleteConfigurationSetTrackingOptionsRequest>
  Model::DeleteConfigurationSetTrackingOptionsOutcomeCallable DeleteConfigurationSetTrackingOptionsCallable(
      const DeleteConfigurationSetTrackingOptionsRequestT& request) const {
    return SubmitCallable(&SESClient::DeleteConfigurationSetTrackingOptions, request);
  }

  /**
   * An Async wrapper for DeleteConfigurationSetTrackingOptions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteConfigurationSetTrackingOptionsRequestT = Model::DeleteConfigurationSetTrackingOptionsRequest>
  void DeleteConfigurationSetTrackingOptionsAsync(const DeleteConfigurationSetTrackingOptionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCustomVerificationEmailTemplateOutcome DeleteCustomVerificationEmailTemplate(
      const Model::DeleteCustomVerificationEmailTemplateRequest& request) const;

  /**
   * A Callable wrapper for DeleteCustomVerificationEmailTemplate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteCustomVerificationEmailTemplateRequestT = Model::DeleteCustomVerificationEmailTemplateRequest>
  Model::DeleteCustomVerificationEmailTemplateOutcomeCallable DeleteCustomVerificationEmailTemplateCallable(
      const DeleteCustomVerificationEmailTemplateRequestT& request) const {
    return SubmitCallable(&SESClient::DeleteCustomVerificationEmailTemplate, request);
  }

  /**
   * An Async wrapper for DeleteCustomVerificationEmailTemplate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteCustomVerificationEmailTemplateRequestT = Model::DeleteCustomVerificationEmailTemplateRequest>
  void DeleteCustomVerificationEmailTemplateAsync(const DeleteCustomVerificationEmailTemplateRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteIdentity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteIdentityRequestT = Model::DeleteIdentityRequest>
  void DeleteIdentityAsync(const DeleteIdentityRequestT& request, const DeleteIdentityResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteIdentityPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteIdentityPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteIdentityPolicyRequestT = Model::DeleteIdentityPolicyRequest>
  void DeleteIdentityPolicyAsync(const DeleteIdentityPolicyRequestT& request, const DeleteIdentityPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReceiptFilter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReceiptFilter that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteReceiptFilterRequestT = Model::DeleteReceiptFilterRequest>
  void DeleteReceiptFilterAsync(const DeleteReceiptFilterRequestT& request, const DeleteReceiptFilterResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReceiptRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReceiptRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteReceiptRuleRequestT = Model::DeleteReceiptRuleRequest>
  void DeleteReceiptRuleAsync(const DeleteReceiptRuleRequestT& request, const DeleteReceiptRuleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReceiptRuleSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReceiptRuleSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteReceiptRuleSetRequestT = Model::DeleteReceiptRuleSetRequest>
  void DeleteReceiptRuleSetAsync(const DeleteReceiptRuleSetRequestT& request, const DeleteReceiptRuleSetResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteVerifiedEmailAddressOutcome DeleteVerifiedEmailAddress(
      const Model::DeleteVerifiedEmailAddressRequest& request) const;

  /**
   * A Callable wrapper for DeleteVerifiedEmailAddress that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteVerifiedEmailAddressRequestT = Model::DeleteVerifiedEmailAddressRequest>
  Model::DeleteVerifiedEmailAddressOutcomeCallable DeleteVerifiedEmailAddressCallable(
      const DeleteVerifiedEmailAddressRequestT& request) const {
    return SubmitCallable(&SESClient::DeleteVerifiedEmailAddress, request);
  }

  /**
   * An Async wrapper for DeleteVerifiedEmailAddress that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteVerifiedEmailAddressRequestT = Model::DeleteVerifiedEmailAddressRequest>
  void DeleteVerifiedEmailAddressAsync(const DeleteVerifiedEmailAddressRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeActiveReceiptRuleSetOutcome DescribeActiveReceiptRuleSet(
      const Model::DescribeActiveReceiptRuleSetRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeActiveReceiptRuleSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeActiveReceiptRuleSetRequestT = Model::DescribeActiveReceiptRuleSetRequest>
  Model::DescribeActiveReceiptRuleSetOutcomeCallable DescribeActiveReceiptRuleSetCallable(
      const DescribeActiveReceiptRuleSetRequestT& request = {}) const {
    return SubmitCallable(&SESClient::DescribeActiveReceiptRuleSet, request);
  }

  /**
   * An Async wrapper for DescribeActiveReceiptRuleSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeActiveReceiptRuleSetRequestT = Model::DescribeActiveReceiptRuleSetRequest>
  void DescribeActiveReceiptRuleSetAsync(const DescribeActiveReceiptRuleSetResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeConfigurationSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeConfigurationSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConfigurationSetRequestT = Model::DescribeConfigurationSetRequest>
  void DescribeConfigurationSetAsync(const DescribeConfigurationSetRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeReceiptRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeReceiptRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeReceiptRuleRequestT = Model::DescribeReceiptRuleRequest>
  void DescribeReceiptRuleAsync(const DescribeReceiptRuleRequestT& request, const DescribeReceiptRuleResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeReceiptRuleSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeReceiptRuleSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReceiptRuleSetRequestT = Model::DescribeReceiptRuleSetRequest>
  void DescribeReceiptRuleSetAsync(const DescribeReceiptRuleSetRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAccountSendingEnabled that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetAccountSendingEnabledRequestT = Model::GetAccountSendingEnabledRequest>
  Model::GetAccountSendingEnabledOutcomeCallable GetAccountSendingEnabledCallable(
      const GetAccountSendingEnabledRequestT& request = {}) const {
    return SubmitCallable(&SESClient::GetAccountSendingEnabled, request);
  }

  /**
   * An Async wrapper for GetAccountSendingEnabled that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccountSendingEnabledRequestT = Model::GetAccountSendingEnabledRequest>
  void GetAccountSendingEnabledAsync(const GetAccountSendingEnabledResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const GetAccountSendingEnabledRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCustomVerificationEmailTemplateOutcome GetCustomVerificationEmailTemplate(
      const Model::GetCustomVerificationEmailTemplateRequest& request) const;

  /**
   * A Callable wrapper for GetCustomVerificationEmailTemplate that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetCustomVerificationEmailTemplateRequestT = Model::GetCustomVerificationEmailTemplateRequest>
  Model::GetCustomVerificationEmailTemplateOutcomeCallable GetCustomVerificationEmailTemplateCallable(
      const GetCustomVerificationEmailTemplateRequestT& request) const {
    return SubmitCallable(&SESClient::GetCustomVerificationEmailTemplate, request);
  }

  /**
   * An Async wrapper for GetCustomVerificationEmailTemplate that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetCustomVerificationEmailTemplateRequestT = Model::GetCustomVerificationEmailTemplateRequest>
  void GetCustomVerificationEmailTemplateAsync(const GetCustomVerificationEmailTemplateRequestT& request,
  ...
  /**
   * A Callable wrapper for GetIdentityDkimAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetIdentityDkimAttributesRequestT = Model::GetIdentityDkimAttributesRequest>
  Model::GetIdentityDkimAttributesOutcomeCallable GetIdentityDkimAttributesCallable(
      const GetIdentityDkimAttributesRequestT& request) const {
    return SubmitCallable(&SESClient::GetIdentityDkimAttributes, request);
  }

  /**
   * An Async wrapper for GetIdentityDkimAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIdentityDkimAttributesRequestT = Model::GetIdentityDkimAttributesRequest>
  void GetIdentityDkimAttributesAsync(const GetIdentityDkimAttributesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetIdentityMailFromDomainAttributesOutcome GetIdentityMailFromDomainAttributes(
      const Model::GetIdentityMailFromDomainAttributesRequest& request) const;

  /**
   * A Callable wrapper for GetIdentityMailFromDomainAttributes that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetIdentityMailFromDomainAttributesRequestT = Model::GetIdentityMailFromDomainAttributesRequest>
  Model::GetIdentityMailFromDomainAttributesOutcomeCallable GetIdentityMailFromDomainAttributesCallable(
      const GetIdentityMailFromDomainAttributesRequestT& request) const {
    return SubmitCallable(&SESClient::GetIdentityMailFromDomainAttributes, request);
  }

  /**
   * An Async wrapper for GetIdentityMailFromDomainAttributes that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetIdentityMailFromDomainAttributesRequestT = Model::GetIdentityMailFromDomainAttributesRequest>
  void GetIdentityMailFromDomainAttributesAsync(const GetIdentityMailFromDomainAttributesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetIdentityNotificationAttributesOutcome GetIdentityNotificationAttributes(
      const Model::GetIdentityNotificationAttributesRequest& request) const;

  /**
   * A Callable wrapper for GetIdentityNotificationAttributes that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetIdentityNotificationAttributesRequestT = Model::GetIdentityNotificationAttributesRequest>
  Model::GetIdentityNotificationAttributesOutcomeCallable GetIdentityNotificationAttributesCallable(
      const GetIdentityNotificationAttributesRequestT& request) const {
    return SubmitCallable(&SESClient::GetIdentityNotificationAttributes, request);
  }

  /**
   * An Async wrapper for GetIdentityNotificationAttributes that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetIdentityNotificationAttributesRequestT = Model::GetIdentityNotificationAttributesRequest>
  void GetIdentityNotificationAttributesAsync(const GetIdentityNotificationAttributesRequestT& request,
  ...
  /**
   * A Callable wrapper for GetIdentityPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIdentityPolicies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetIdentityPoliciesRequestT = Model::GetIdentityPoliciesRequest>
  void GetIdentityPoliciesAsync(const GetIdentityPoliciesRequestT& request, const GetIdentityPoliciesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetIdentityVerificationAttributesOutcome GetIdentityVerificationAttributes(
      const Model::GetIdentityVerificationAttributesRequest& request) const;

  /**
   * A Callable wrapper for GetIdentityVerificationAttributes that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetIdentityVerificationAttributesRequestT = Model::GetIdentityVerificationAttributesRequest>
  Model::GetIdentityVerificationAttributesOutcomeCallable GetIdentityVerificationAttributesCallable(
      const GetIdentityVerificationAttributesRequestT& request) const {
    return SubmitCallable(&SESClient::GetIdentityVerificationAttributes, request);
  }

  /**
   * An Async wrapper for GetIdentityVerificationAttributes that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetIdentityVerificationAttributesRequestT = Model::GetIdentityVerificationAttributesRequest>
  void GetIdentityVerificationAttributesAsync(const GetIdentityVerificationAttributesRequestT& request,
  ...
  /**
   * An Async wrapper for GetSendQuota that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSendQuotaRequestT = Model::GetSendQuotaRequest>
  void GetSendQuotaAsync(const GetSendQuotaResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const GetSendQuotaRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetSendStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSendStatistics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSendStatisticsRequestT = Model::GetSendStatisticsRequest>
  void GetSendStatisticsAsync(const GetSendStatisticsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetSendStatisticsRequestT& request = {}) const {
  ...
  virtual Model::ListCustomVerificationEmailTemplatesOutcome ListCustomVerificationEmailTemplates(
      const Model::ListCustomVerificationEmailTemplatesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCustomVerificationEmailTemplates that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListCustomVerificationEmailTemplatesRequestT = Model::ListCustomVerificationEmailTemplatesRequest>
  Model::ListCustomVerificationEmailTemplatesOutcomeCallable ListCustomVerificationEmailTemplatesCallable(
      const ListCustomVerificationEmailTemplatesRequestT& request = {}) const {
    return SubmitCallable(&SESClient::ListCustomVerificationEmailTemplates, request);
  }

  /**
   * An Async wrapper for ListCustomVerificationEmailTemplates that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListCustomVerificationEmailTemplatesRequestT = Model::ListCustomVerificationEmailTemplatesRequest>
  void ListCustomVerificationEmailTemplatesAsync(const ListCustomVerificationEmailTemplatesResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const ListCustomVerificationEmailTemplatesRequestT& request = {}) const {
   ...
   */
  template <typename ListIdentitiesRequestT = Model::ListIdentitiesRequest>
  void ListIdentitiesAsync(const ListIdentitiesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListIdentitiesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListIdentityPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListIdentityPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIdentityPoliciesRequestT = Model::ListIdentityPoliciesRequest>
  void ListIdentityPoliciesAsync(const ListIdentityPoliciesRequestT& request, const ListIdentityPoliciesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListReceiptFilters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReceiptFilters that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListReceiptFiltersRequestT = Model::ListReceiptFiltersRequest>
  void ListReceiptFiltersAsync(const ListReceiptFiltersResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListReceiptFiltersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListReceiptRuleSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReceiptRuleSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListReceiptRuleSetsRequestT = Model::ListReceiptRuleSetsRequest>
  void ListReceiptRuleSetsAsync(const ListReceiptRuleSetsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListReceiptRuleSetsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListVerifiedEmailAddressesOutcome ListVerifiedEmailAddresses(
      const Model::ListVerifiedEmailAddressesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListVerifiedEmailAddresses that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListVerifiedEmailAddressesRequestT = Model::ListVerifiedEmailAddressesRequest>
  Model::ListVerifiedEmailAddressesOutcomeCallable ListVerifiedEmailAddressesCallable(
      const ListVerifiedEmailAddressesRequestT& request = {}) const {
    return SubmitCallable(&SESClient::ListVerifiedEmailAddresses, request);
  }

  /**
   * An Async wrapper for ListVerifiedEmailAddresses that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVerifiedEmailAddressesRequestT = Model::ListVerifiedEmailAddressesRequest>
  void ListVerifiedEmailAddressesAsync(const ListVerifiedEmailAddressesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListVerifiedEmailAddressesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutConfigurationSetDeliveryOptionsOutcome PutConfigurationSetDeliveryOptions(
      const Model::PutConfigurationSetDeliveryOptionsRequest& request) const;

  /**
   * A Callable wrapper for PutConfigurationSetDeliveryOptions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PutConfigurationSetDeliveryOptionsRequestT = Model::PutConfigurationSetDeliveryOptionsRequest>
  Model::PutConfigurationSetDeliveryOptionsOutcomeCallable PutConfigurationSetDeliveryOptionsCallable(
      const PutConfigurationSetDeliveryOptionsRequestT& request) const {
    return SubmitCallable(&SESClient::PutConfigurationSetDeliveryOptions, request);
  }

  /**
   * An Async wrapper for PutConfigurationSetDeliveryOptions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutConfigurationSetDeliveryOptionsRequestT = Model::PutConfigurationSetDeliveryOptionsRequest>
  void PutConfigurationSetDeliveryOptionsAsync(const PutConfigurationSetDeliveryOptionsRequestT& request,
  ...
  /**
   * A Callable wrapper for PutIdentityPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutIdentityPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutIdentityPolicyRequestT = Model::PutIdentityPolicyRequest>
  void PutIdentityPolicyAsync(const PutIdentityPolicyRequestT& request, const PutIdentityPolicyResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ReorderReceiptRuleSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ReorderReceiptRuleSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ReorderReceiptRuleSetRequestT = Model::ReorderReceiptRuleSetRequest>
  void ReorderReceiptRuleSetAsync(const ReorderReceiptRuleSetRequestT& request, const ReorderReceiptRuleSetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SendBounce that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendBounceRequestT = Model::SendBounceRequest>
  void SendBounceAsync(const SendBounceRequestT& request, const SendBounceResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendBulkTemplatedEmail that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendBulkTemplatedEmail that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendBulkTemplatedEmailRequestT = Model::SendBulkTemplatedEmailRequest>
  void SendBulkTemplatedEmailAsync(const SendBulkTemplatedEmailRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SendCustomVerificationEmailOutcome SendCustomVerificationEmail(
      const Model::SendCustomVerificationEmailRequest& request) const;

  /**
   * A Callable wrapper for SendCustomVerificationEmail that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SendCustomVerificationEmailRequestT = Model::SendCustomVerificationEmailRequest>
  Model::SendCustomVerificationEmailOutcomeCallable SendCustomVerificationEmailCallable(
      const SendCustomVerificationEmailRequestT& request) const {
    return SubmitCallable(&SESClient::SendCustomVerificationEmail, request);
  }

  /**
   * An Async wrapper for SendCustomVerificationEmail that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendCustomVerificationEmailRequestT = Model::SendCustomVerificationEmailRequest>
  void SendCustomVerificationEmailAsync(const SendCustomVerificationEmailRequestT& request,
  ...
  /**
   * An Async wrapper for SendEmail that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendEmailRequestT = Model::SendEmailRequest>
  void SendEmailAsync(const SendEmailRequestT& request, const SendEmailResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SendRawEmail that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendRawEmailRequestT = Model::SendRawEmailRequest>
  void SendRawEmailAsync(const SendRawEmailRequestT& request, const SendRawEmailResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendTemplatedEmail that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendTemplatedEmail that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SendTemplatedEmailRequestT = Model::SendTemplatedEmailRequest>
  void SendTemplatedEmailAsync(const SendTemplatedEmailRequestT& request, const SendTemplatedEmailResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetActiveReceiptRuleSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetActiveReceiptRuleSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetActiveReceiptRuleSetRequestT = Model::SetActiveReceiptRuleSetRequest>
  void SetActiveReceiptRuleSetAsync(const SetActiveReceiptRuleSetResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const SetActiveReceiptRuleSetRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for SetIdentityDkimEnabled that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetIdentityDkimEnabled that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetIdentityDkimEnabledRequestT = Model::SetIdentityDkimEnabledRequest>
  void SetIdentityDkimEnabledAsync(const SetIdentityDkimEnabledRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SetIdentityFeedbackForwardingEnabledOutcome SetIdentityFeedbackForwardingEnabled(
      const Model::SetIdentityFeedbackForwardingEnabledRequest& request) const;

  /**
   * A Callable wrapper for SetIdentityFeedbackForwardingEnabled that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename SetIdentityFeedbackForwardingEnabledRequestT = Model::SetIdentityFeedbackForwardingEnabledRequest>
  Model::SetIdentityFeedbackForwardingEnabledOutcomeCallable SetIdentityFeedbackForwardingEnabledCallable(
      const SetIdentityFeedbackForwardingEnabledRequestT& request) const {
    return SubmitCallable(&SESClient::SetIdentityFeedbackForwardingEnabled, request);
  }

  /**
   * An Async wrapper for SetIdentityFeedbackForwardingEnabled that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename SetIdentityFeedbackForwardingEnabledRequestT = Model::SetIdentityFeedbackForwardingEnabledRequest>
  void SetIdentityFeedbackForwardingEnabledAsync(const SetIdentityFeedbackForwardingEnabledRequestT& request,
  ...
  virtual Model::SetIdentityHeadersInNotificationsEnabledOutcome SetIdentityHeadersInNotificationsEnabled(
      const Model::SetIdentityHeadersInNotificationsEnabledRequest& request) const;

  /**
   * A Callable wrapper for SetIdentityHeadersInNotificationsEnabled that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename SetIdentityHeadersInNotificationsEnabledRequestT = Model::SetIdentityHeadersInNotificationsEnabledRequest>
  Model::SetIdentityHeadersInNotificationsEnabledOutcomeCallable SetIdentityHeadersInNotificationsEnabledCallable(
      const SetIdentityHeadersInNotificationsEnabledRequestT& request) const {
    return SubmitCallable(&SESClient::SetIdentityHeadersInNotificationsEnabled, request);
  }

  /**
   * An Async wrapper for SetIdentityHeadersInNotificationsEnabled that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename SetIdentityHeadersInNotificationsEnabledRequestT = Model::SetIdentityHeadersInNotificationsEnabledRequest>
  void SetIdentityHeadersInNotificationsEnabledAsync(
      const SetIdentityHeadersInNotificationsEnabledRequestT& request,
  ...
  /**
   * A Callable wrapper for SetIdentityMailFromDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SetIdentityMailFromDomainRequestT = Model::SetIdentityMailFromDomainRequest>
  Model::SetIdentityMailFromDomainOutcomeCallable SetIdentityMailFromDomainCallable(
      const SetIdentityMailFromDomainRequestT& request) const {
    return SubmitCallable(&SESClient::SetIdentityMailFromDomain, request);
  }

  /**
   * An Async wrapper for SetIdentityMailFromDomain that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetIdentityMailFromDomainRequestT = Model::SetIdentityMailFromDomainRequest>
  void SetIdentityMailFromDomainAsync(const SetIdentityMailFromDomainRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SetIdentityNotificationTopicOutcome SetIdentityNotificationTopic(
      const Model::SetIdentityNotificationTopicRequest& request) const;

  /**
   * A Callable wrapper for SetIdentityNotificationTopic that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SetIdentityNotificationTopicRequestT = Model::SetIdentityNotificationTopicRequest>
  Model::SetIdentityNotificationTopicOutcomeCallable SetIdentityNotificationTopicCallable(
      const SetIdentityNotificationTopicRequestT& request) const {
    return SubmitCallable(&SESClient::SetIdentityNotificationTopic, request);
  }

  /**
   * An Async wrapper for SetIdentityNotificationTopic that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetIdentityNotificationTopicRequestT = Model::SetIdentityNotificationTopicRequest>
  void SetIdentityNotificationTopicAsync(const SetIdentityNotificationTopicRequestT& request,
  ...
  /**
   * A Callable wrapper for SetReceiptRulePosition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetReceiptRulePosition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetReceiptRulePositionRequestT = Model::SetReceiptRulePositionRequest>
  void SetReceiptRulePositionAsync(const SetReceiptRulePositionRequestT& request,
  ...
  /**
   * A Callable wrapper for TestRenderTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TestRenderTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TestRenderTemplateRequestT = Model::TestRenderTemplateRequest>
  void TestRenderTemplateAsync(const TestRenderTemplateRequestT& request, const TestRenderTemplateResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAccountSendingEnabledOutcome UpdateAccountSendingEnabled(
      const Model::UpdateAccountSendingEnabledRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateAccountSendingEnabled that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAccountSendingEnabledRequestT = Model::UpdateAccountSendingEnabledRequest>
  Model::UpdateAccountSendingEnabledOutcomeCallable UpdateAccountSendingEnabledCallable(
      const UpdateAccountSendingEnabledRequestT& request = {}) const {
    return SubmitCallable(&SESClient::UpdateAccountSendingEnabled, request);
  }

  /**
   * An Async wrapper for UpdateAccountSendingEnabled that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAccountSendingEnabledRequestT = Model::UpdateAccountSendingEnabledRequest>
  void UpdateAccountSendingEnabledAsync(const UpdateAccountSendingEnabledResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const UpdateAccountSendingEnabledRequestT& request = {}) const {
  ...
  virtual Model::UpdateConfigurationSetReputationMetricsEnabledOutcome UpdateConfigurationSetReputationMetricsEnabled(
      const Model::UpdateConfigurationSetReputationMetricsEnabledRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfigurationSetReputationMetricsEnabled that returns a future to the operation so that it can be executed
  ...
  Model::UpdateConfigurationSetReputationMetricsEnabledOutcomeCallable UpdateConfigurationSetReputationMetricsEnabledCallable(
      const UpdateConfigurationSetReputationMetricsEnabledRequestT& request) const {
    return SubmitCallable(&SESClient::UpdateConfigurationSetReputationMetricsEnabled, request);
  }

  /**
   * An Async wrapper for UpdateConfigurationSetReputationMetricsEnabled that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename UpdateConfigurationSetReputationMetricsEnabledRequestT = Model::UpdateConfigurationSetReputationMetricsEnabledRequest>
  void UpdateConfigurationSetReputationMetricsEnabledAsync(
      const UpdateConfigurationSetReputationMetricsEnabledRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConfigurationSetSendingEnabledOutcome UpdateConfigurationSetSendingEnabled(
      const Model::UpdateConfigurationSetSendingEnabledRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfigurationSetSendingEnabled that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateConfigurationSetSendingEnabledRequestT = Model::UpdateConfigurationSetSendingEnabledRequest>
  Model::UpdateConfigurationSetSendingEnabledOutcomeCallable UpdateConfigurationSetSendingEnabledCallable(
      const UpdateConfigurationSetSendingEnabledRequestT& request) const {
    return SubmitCallable(&SESClient::UpdateConfigurationSetSendingEnabled, request);
  }

  /**
   * An Async wrapper for UpdateConfigurationSetSendingEnabled that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateConfigurationSetSendingEnabledRequestT = Model::UpdateConfigurationSetSendingEnabledRequest>
  void UpdateConfigurationSetSendingEnabledAsync(const UpdateConfigurationSetSendingEnabledRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConfigurationSetTrackingOptionsOutcome UpdateConfigurationSetTrackingOptions(
      const Model::UpdateConfigurationSetTrackingOptionsRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfigurationSetTrackingOptions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateConfigurationSetTrackingOptionsRequestT = Model::UpdateConfigurationSetTrackingOptionsRequest>
  Model::UpdateConfigurationSetTrackingOptionsOutcomeCallable UpdateConfigurationSetTrackingOptionsCallable(
      const UpdateConfigurationSetTrackingOptionsRequestT& request) const {
    return SubmitCallable(&SESClient::UpdateConfigurationSetTrackingOptions, request);
  }

  /**
   * An Async wrapper for UpdateConfigurationSetTrackingOptions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateConfigurationSetTrackingOptionsRequestT = Model::UpdateConfigurationSetTrackingOptionsRequest>
  void UpdateConfigurationSetTrackingOptionsAsync(const UpdateConfigurationSetTrackingOptionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCustomVerificationEmailTemplateOutcome UpdateCustomVerificationEmailTemplate(
      const Model::UpdateCustomVerificationEmailTemplateRequest& request) const;

  /**
   * A Callable wrapper for UpdateCustomVerificationEmailTemplate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateCustomVerificationEmailTemplateRequestT = Model::UpdateCustomVerificationEmailTemplateRequest>
  Model::UpdateCustomVerificationEmailTemplateOutcomeCallable UpdateCustomVerificationEmailTemplateCallable(
      const UpdateCustomVerificationEmailTemplateRequestT& request) const {
    return SubmitCallable(&SESClient::UpdateCustomVerificationEmailTemplate, request);
  }

  /**
   * An Async wrapper for UpdateCustomVerificationEmailTemplate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateCustomVerificationEmailTemplateRequestT = Model::UpdateCustomVerificationEmailTemplateRequest>
  void UpdateCustomVerificationEmailTemplateAsync(const UpdateCustomVerificationEmailTemplateRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateReceiptRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateReceiptRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateReceiptRuleRequestT = Model::UpdateReceiptRuleRequest>
  void UpdateReceiptRuleAsync(const UpdateReceiptRuleRequestT& request, const UpdateReceiptRuleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for VerifyDomainDkim that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for VerifyDomainDkim that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename VerifyDomainDkimRequestT = Model::VerifyDomainDkimRequest>
  void VerifyDomainDkimAsync(const VerifyDomainDkimRequestT& request, const VerifyDomainDkimResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for VerifyDomainIdentity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for VerifyDomainIdentity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename VerifyDomainIdentityRequestT = Model::VerifyDomainIdentityRequest>
  void VerifyDomainIdentityAsync(const VerifyDomainIdentityRequestT& request, const VerifyDomainIdentityResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for VerifyEmailAddress that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for VerifyEmailAddress that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename VerifyEmailAddressRequestT = Model::VerifyEmailAddressRequest>
  void VerifyEmailAddressAsync(const VerifyEmailAddressRequestT& request, const VerifyEmailAddressResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for VerifyEmailIdentity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for VerifyEmailIdentity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename VerifyEmailIdentityRequestT = Model::VerifyEmailIdentityRequest>
  void VerifyEmailIdentityAsync(const VerifyEmailIdentityRequestT& request, const VerifyEmailIdentityResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
