...
namespace SES {
template <>
AWS_SES_API ConfigurationSetDoesNotExistException SESError::GetModeledError() {
...
template <>
AWS_SES_API InvalidFirehoseDestinationException SESError::GetModeledError() {
...
template <>
AWS_SES_API InvalidSnsTopicException SESError::GetModeledError() {
  assert(this->GetErrorType() == SESErrors::INVALID_SNS_TOPIC);
  return InvalidSnsTopicException(this->GetXmlPayload().GetRootElement());
}

template <>
AWS_SES_API TrackingOptionsDoesNotExistException SESError::GetModeledError() {
...
template <>
AWS_SES_API ConfigurationSetSendingPausedException SESError::GetModeledError() {
...
template <>
AWS_SES_API InvalidS3ConfigurationException SESError::GetModeledError() {
...
template <>
AWS_SES_API EventDestinationDoesNotExistException SESError::GetModeledError() {
...
template <>
AWS_SES_API TemplateDoesNotExistException SESError::GetModeledError() {
...
template <>
AWS_SES_API MissingRenderingAttributeException SESError::GetModeledError() {
...
template <>
AWS_SES_API ConfigurationSetAlreadyExistsException SESError::GetModeledError() {
...
template <>
AWS_SES_API EventDestinationAlreadyExistsException SESError::GetModeledError() {
...
template <>
AWS_SES_API CustomVerificationEmailTemplateDoesNotExistException SESError::GetModeledError() {
...
template <>
AWS_SES_API InvalidLambdaFunctionException SESError::GetModeledError() {
...
template <>
AWS_SES_API InvalidCloudWatchDestinationException SESError::GetModeledError() {
...
template <>
AWS_SES_API InvalidRenderingParameterException SESError::GetModeledError() {
...
template <>
AWS_SES_API InvalidSNSDestinationException SESError::GetModeledError() {
...
template <>
AWS_SES_API AlreadyExistsException SESError::GetModeledError() {
  assert(this->GetErrorType() == SESErrors::ALREADY_EXISTS);
  return AlreadyExistsException(this->GetXmlPayload().GetRootElement());
}

template <>
AWS_SES_API TrackingOptionsAlreadyExistsException SESError::GetModeledError() {
...
template <>
AWS_SES_API InvalidTemplateException SESError::GetModeledError() {
  assert(this->GetErrorType() == SESErrors::INVALID_TEMPLATE);
  return InvalidTemplateException(this->GetXmlPayload().GetRootElement());
}

template <>
AWS_SES_API FromEmailAddressNotVerifiedException SESError::GetModeledError() {
...
template <>
AWS_SES_API CannotDeleteException SESError::GetModeledError() {
  assert(this->GetErrorType() == SESErrors::CANNOT_DELETE);
  return CannotDeleteException(this->GetXmlPayload().GetRootElement());
}

template <>
AWS_SES_API RuleSetDoesNotExistException SESError::GetModeledError() {
...
template <>
AWS_SES_API CustomVerificationEmailTemplateAlreadyExistsException SESError::GetModeledError() {
...
template <>
AWS_SES_API RuleDoesNotExistException SESError::GetModeledError() {
...
static const int CUSTOM_VERIFICATION_EMAIL_TEMPLATE_DOES_NOT_EXIST_HASH =
    HashingUtils::HashString("CustomVerificationEmailTemplateDoesNotExist");
...
static const int CUSTOM_VERIFICATION_EMAIL_TEMPLATE_ALREADY_EXISTS_HASH =
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFIGURATION_SET_DOES_NOT_EXIST_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(SESErrors::CUSTOM_VERIFICATION_EMAIL_TEMPLATE_DOES_NOT_EXIST),
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(SESErrors::CUSTOM_VERIFICATION_EMAIL_INVALID_CONTENT),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(SESErrors::CUSTOM_VERIFICATION_EMAIL_TEMPLATE_ALREADY_EXISTS),
                                RetryableType::NOT_RETRYABLE);
