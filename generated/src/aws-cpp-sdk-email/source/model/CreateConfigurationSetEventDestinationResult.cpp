...
CreateConfigurationSetEventDestinationResult& CreateConfigurationSetEventDestinationResult::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::SES::Model::CreateConfigurationSetEventDestinationResult",
