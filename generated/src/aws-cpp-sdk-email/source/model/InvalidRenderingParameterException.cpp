...
InvalidRenderingParameterException::InvalidRenderingParameterException(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InvalidRenderingParameterException::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
