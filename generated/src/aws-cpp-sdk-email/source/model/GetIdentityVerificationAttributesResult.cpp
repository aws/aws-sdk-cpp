...
GetIdentityVerificationAttributesResult& GetIdentityVerificationAttributesResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!verificationAttributesNode.IsNull()) {
      ...
      while (!verificationAttributesEntry.IsNull()) {
        ...
        m_verificationAttributes[keyNode.GetText()] = valueNode;
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::SES::Model::GetIdentityVerificationAttributesResult",
