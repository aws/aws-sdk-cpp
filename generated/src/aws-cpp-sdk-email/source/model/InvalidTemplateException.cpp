...
InvalidTemplateException::InvalidTemplateException(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InvalidTemplateException::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
