...
CustomVerificationEmailTemplate::CustomVerificationEmailTemplate(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CustomVerificationEmailTemplate::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
