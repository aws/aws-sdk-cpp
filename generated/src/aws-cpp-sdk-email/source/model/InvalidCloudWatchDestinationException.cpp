...
InvalidCloudWatchDestinationException::InvalidCloudWatchDestinationException(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InvalidCloudWatchDestinationException::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
