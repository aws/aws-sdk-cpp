...
InvalidFirehoseDestinationException::InvalidFirehoseDestinationException(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InvalidFirehoseDestinationException::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
