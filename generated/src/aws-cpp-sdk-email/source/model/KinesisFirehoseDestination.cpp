...
KinesisFirehoseDestination::KinesisFirehoseDestination(const XmlNode& xmlNode) { *this = xmlNode; }
...
void KinesisFirehoseDestination::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
