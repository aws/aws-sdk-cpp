...
ListCustomVerificationEmailTemplatesResult& ListCustomVerificationEmailTemplatesResult::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!customVerificationEmailTemplatesNode.IsNull()) {
      ...
      m_customVerificationEmailTemplatesHasBeenSet = !customVerificationEmailTemplatesMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::SES::Model::ListCustomVerificationEmailTemplatesResult",
