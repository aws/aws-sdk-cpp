...
TemplateDoesNotExistException::TemplateDoesNotExistException(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TemplateDoesNotExistException::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
