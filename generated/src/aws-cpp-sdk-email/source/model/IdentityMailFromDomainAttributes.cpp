...
IdentityMailFromDomainAttributes::IdentityMailFromDomainAttributes(const XmlNode& xmlNode) { *this = xmlNode; }
...
IdentityMailFromDomainAttributes& IdentityMailFromDomainAttributes::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!mailFromDomainStatusNode.IsNull()) {
      m_mailFromDomainStatus = CustomMailFromStatusMapper::GetCustomMailFromStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(mailFromDomainStatusNode.GetText()).c_str()));
    ...
    if (!behaviorOnMXFailureNode.IsNull()) {
      m_behaviorOnMXFailure = BehaviorOnMXFailureMapper::GetBehaviorOnMXFailureForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(behaviorOnMXFailureNode.GetText()).c_str()));
...
void IdentityMailFromDomainAttributes::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_mailFromDomainStatusHasBeenSet) {
    oStream << location << index << locationValue << ".MailFromDomainStatus="
            << StringUtils::URLEncode(CustomMailFromStatusMapper::GetNameForCustomMailFromStatus(m_mailFromDomainStatus)) << "&";
  }

  if (m_behaviorOnMXFailureHasBeenSet) {
    oStream << location << index << locationValue << ".BehaviorOnMXFailure="
            << StringUtils::URLEncode(BehaviorOnMXFailureMapper::GetNameForBehaviorOnMXFailure(m_behaviorOnMXFailure)) << "&";
  }
}
...
void IdentityMailFromDomainAttributes::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_mailFromDomainStatusHasBeenSet) {
    oStream << location << ".MailFromDomainStatus="
            << StringUtils::URLEncode(CustomMailFromStatusMapper::GetNameForCustomMailFromStatus(m_mailFromDomainStatus)) << "&";
  }
  if (m_behaviorOnMXFailureHasBeenSet) {
    oStream << location << ".BehaviorOnMXFailure="
            << StringUtils::URLEncode(BehaviorOnMXFailureMapper::GetNameForBehaviorOnMXFailure(m_behaviorOnMXFailure)) << "&";
  }
}
