...
GetIdentityNotificationAttributesResult& GetIdentityNotificationAttributesResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!notificationAttributesNode.IsNull()) {
      ...
      while (!notificationAttributesEntry.IsNull()) {
        ...
        m_notificationAttributes[keyNode.GetText()] = valueNode;
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::SES::Model::GetIdentityNotificationAttributesResult",
