...
EventDestinationAlreadyExistsException::EventDestinationAlreadyExistsException(const XmlNode& xmlNode) { *this = xmlNode; }

EventDestinationAlreadyExistsException& EventDestinationAlreadyExistsException::operator=(const XmlNode& xmlNode) {
...
void EventDestinationAlreadyExistsException::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void EventDestinationAlreadyExistsException::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_configurationSetNameHasBeenSet) {
