...
MissingRenderingAttributeException::MissingRenderingAttributeException(const XmlNode& xmlNode) { *this = xmlNode; }
...
void MissingRenderingAttributeException::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
