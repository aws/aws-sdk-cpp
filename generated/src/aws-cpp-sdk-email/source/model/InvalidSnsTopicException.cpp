...
InvalidSnsTopicException::InvalidSnsTopicException(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InvalidSnsTopicException::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
