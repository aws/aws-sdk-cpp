...
InvalidSNSDestinationException::InvalidSNSDestinationException(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InvalidSNSDestinationException::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
