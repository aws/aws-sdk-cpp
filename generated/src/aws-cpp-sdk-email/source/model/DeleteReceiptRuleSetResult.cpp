...
DeleteReceiptRuleSetResult::DeleteReceiptRuleSetResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }

DeleteReceiptRuleSetResult& DeleteReceiptRuleSetResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
