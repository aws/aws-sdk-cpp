...
CreateDbBackupResult::CreateDbBackupResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateDbBackupResult& CreateDbBackupResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
