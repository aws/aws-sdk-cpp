...
RebootDbInstanceResult::RebootDbInstanceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

RebootDbInstanceResult& RebootDbInstanceResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
