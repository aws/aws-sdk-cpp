...
GetDbInstanceResult::GetDbInstanceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetDbInstanceResult& GetDbInstanceResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
