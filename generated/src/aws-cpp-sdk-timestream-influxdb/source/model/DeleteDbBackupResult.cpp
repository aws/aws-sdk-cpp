...
DeleteDbBackupResult::DeleteDbBackupResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteDbBackupResult& DeleteDbBackupResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
