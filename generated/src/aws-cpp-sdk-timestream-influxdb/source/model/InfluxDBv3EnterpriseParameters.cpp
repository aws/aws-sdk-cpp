...
InfluxDBv3EnterpriseParameters::InfluxDBv3EnterpriseParameters(JsonView jsonValue) { *this = jsonValue; }

InfluxDBv3EnterpriseParameters& InfluxDBv3EnterpriseParameters::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("compactionRowLimit")) {
    m_compactionRowLimit = jsonValue.GetInteger("compactionRowLimit");
    m_compactionRowLimitHasBeenSet = true;
  }
  if (jsonValue.ValueExists("compactionMaxNumFilesPerPlan")) {
    m_compactionMaxNumFilesPerPlan = jsonValue.GetInteger("compactionMaxNumFilesPerPlan");
    m_compactionMaxNumFilesPerPlanHasBeenSet = true;
  }
  if (jsonValue.ValueExists("compactionGen2Duration")) {
    m_compactionGen2Duration = jsonValue.GetObject("compactionGen2Duration");
    m_compactionGen2DurationHasBeenSet = true;
  }
  if (jsonValue.ValueExists("compactionMultipliers")) {
    m_compactionMultipliers = jsonValue.GetString("compactionMultipliers");
    m_compactionMultipliersHasBeenSet = true;
  }
  if (jsonValue.ValueExists("compactionCleanupWait")) {
    m_compactionCleanupWait = jsonValue.GetObject("compactionCleanupWait");
    m_compactionCleanupWaitHasBeenSet = true;
  }
  if (jsonValue.ValueExists("compactionCheckInterval")) {
    m_compactionCheckInterval = jsonValue.GetObject("compactionCheckInterval");
    m_compactionCheckIntervalHasBeenSet = true;
  }
  if (jsonValue.ValueExists("lastValueCacheDisableFromHistory")) {
    m_lastValueCacheDisableFromHistory = jsonValue.GetBool("lastValueCacheDisableFromHistory");
    m_lastValueCacheDisableFromHistoryHasBeenSet = true;
  }
  if (jsonValue.ValueExists("distinctValueCacheDisableFromHistory")) {
    m_distinctValueCacheDisableFromHistory = jsonValue.GetBool("distinctValueCacheDisableFromHistory");
    m_distinctValueCacheDisableFromHistoryHasBeenSet = true;
  }
  if (jsonValue.ValueExists("replicationInterval")) {
    m_replicationInterval = jsonValue.GetObject("replicationInterval");
    m_replicationIntervalHasBeenSet = true;
  }
  if (jsonValue.ValueExists("catalogSyncInterval")) {
    m_catalogSyncInterval = jsonValue.GetObject("catalogSyncInterval");
    m_catalogSyncIntervalHasBeenSet = true;
  }
  return *this;
}

JsonValue InfluxDBv3EnterpriseParameters::Jsonize() const {
  JsonValue payload;
  ...
  if (m_compactionRowLimitHasBeenSet) {
    payload.WithInteger("compactionRowLimit", m_compactionRowLimit);
  }

  if (m_compactionMaxNumFilesPerPlanHasBeenSet) {
    payload.WithInteger("compactionMaxNumFilesPerPlan", m_compactionMaxNumFilesPerPlan);
  }

  if (m_compactionGen2DurationHasBeenSet) {
    payload.WithObject("compactionGen2Duration", m_compactionGen2Duration.Jsonize());
  }

  if (m_compactionMultipliersHasBeenSet) {
    payload.WithString("compactionMultipliers", m_compactionMultipliers);
  }

  if (m_compactionCleanupWaitHasBeenSet) {
    payload.WithObject("compactionCleanupWait", m_compactionCleanupWait.Jsonize());
  }

  if (m_compactionCheckIntervalHasBeenSet) {
    payload.WithObject("compactionCheckInterval", m_compactionCheckInterval.Jsonize());
  }

  if (m_lastValueCacheDisableFromHistoryHasBeenSet) {
    payload.WithBool("lastValueCacheDisableFromHistory", m_lastValueCacheDisableFromHistory);
  }

  if (m_distinctValueCacheDisableFromHistoryHasBeenSet) {
    payload.WithBool("distinctValueCacheDisableFromHistory", m_distinctValueCacheDisableFromHistory);
  }

  if (m_replicationIntervalHasBeenSet) {
    payload.WithObject("replicationInterval", m_replicationInterval.Jsonize());
  }

  if (m_catalogSyncIntervalHasBeenSet) {
    payload.WithObject("catalogSyncInterval", m_catalogSyncInterval.Jsonize());
  }
