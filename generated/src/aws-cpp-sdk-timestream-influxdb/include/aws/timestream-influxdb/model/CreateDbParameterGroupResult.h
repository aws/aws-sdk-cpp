...
class CreateDbParameterGroupResult {
 public:
  AWS_TIMESTREAMINFLUXDB_API CreateDbParameterGroupResult() = default;
  AWS_TIMESTREAMINFLUXDB_API CreateDbParameterGroupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_TIMESTREAMINFLUXDB_API CreateDbParameterGroupResult& operator=(
  ...
  template <typename IdT = Aws::String>
  CreateDbParameterGroupResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateDbParameterGroupResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateDbParameterGroupResult& WithArn(ArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateDbParameterGroupResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ParametersT = Parameters>
  CreateDbParameterGroupResult& WithParameters(ParametersT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDbParameterGroupResult& WithRequestId(RequestIdT&& value) {
