...
class ListDbInstancesForClusterResult {
 public:
  ...
  AWS_TIMESTREAMINFLUXDB_API ListDbInstancesForClusterResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<DbInstanceForClusterSummary>>
  ListDbInstancesForClusterResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DbInstanceForClusterSummary>
  ListDbInstancesForClusterResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDbInstancesForClusterResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDbInstancesForClusterResult& WithRequestId(RequestIdT&& value) {
