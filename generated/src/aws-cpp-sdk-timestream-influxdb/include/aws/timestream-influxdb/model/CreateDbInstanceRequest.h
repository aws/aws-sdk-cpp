...
class CreateDbInstanceRequest : public TimestreamInfluxDBRequest {
 public:
  ...
  inline CreateDbInstanceRequest& WithDbInstanceType(DbInstanceType value) {
  ...
  inline CreateDbInstanceRequest& WithDbStorageType(DbStorageType value) {
  ...
  inline CreateDbInstanceRequest& WithDeploymentType(DeploymentType value) {
  ...
  template <typename MaintenanceScheduleT = MaintenanceSchedule>
  CreateDbInstanceRequest& WithMaintenanceSchedule(MaintenanceScheduleT&& value) {
  ...
  inline CreateDbInstanceRequest& WithNetworkType(NetworkType value) {
