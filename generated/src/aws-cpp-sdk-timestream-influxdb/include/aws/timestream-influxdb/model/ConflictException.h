...
namespace Model
{
  ...
  /**
   * <p>The request conflicts with an existing resource in Timestream for
   * InfluxDB.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/timestream-influxdb-2023-01-27/ConflictException">AWS
   * API Reference</a></p>
   */
  class ConflictException
  {
  public:
    AWS_TIMESTREAMINFLUXDB_API ConflictException() = default;
    AWS_TIMESTREAMINFLUXDB_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_TIMESTREAMINFLUXDB_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
