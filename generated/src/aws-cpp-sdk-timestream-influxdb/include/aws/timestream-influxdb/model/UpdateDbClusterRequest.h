...
namespace Model
{
  ...
  {
  public:
    AWS_TIMESTREAMINFLUXDB_API UpdateDbClusterRequest();
    ...
    inline UpdateDbClusterRequest& WithDbClusterId(const Aws::String& value) { SetDbClusterId(value); return *this;}
    inline UpdateDbClusterRequest& WithDbClusterId(Aws::String&& value) { SetDbClusterId(std::move(value)); return *this;}
    inline UpdateDbClusterRequest& WithDbClusterId(const char* value) { SetDbClusterId(value); return *this;}
    ///@}
    ...
    inline UpdateDbClusterRequest& WithLogDeliveryConfiguration(const LogDeliveryConfiguration& value) { SetLogDeliveryConfiguration(value); return *this;}
    inline UpdateDbClusterRequest& WithLogDeliveryConfiguration(LogDeliveryConfiguration&& value) { SetLogDeliveryConfiguration(std::move(value)); return *this;}
    ///@}
    ...
    inline UpdateDbClusterRequest& WithDbParameterGroupIdentifier(const Aws::String& value) { SetDbParameterGroupIdentifier(value); return *this;}
    inline UpdateDbClusterRequest& WithDbParameterGroupIdentifier(Aws::String&& value) { SetDbParameterGroupIdentifier(std::move(value)); return *this;}
    inline UpdateDbClusterRequest& WithDbParameterGroupIdentifier(const char* value) { SetDbParameterGroupIdentifier(value); return *this;}
    ///@}
    ...
    inline UpdateDbClusterRequest& WithDbInstanceType(const DbInstanceType& value) { SetDbInstanceType(value); return *this;}
    inline UpdateDbClusterRequest& WithDbInstanceType(DbInstanceType&& value) { SetDbInstanceType(std::move(value)); return *this;}
    ///@}
    ...
    inline UpdateDbClusterRequest& WithFailoverMode(const FailoverMode& value) { SetFailoverMode(value); return *this;}
    inline UpdateDbClusterRequest& WithFailoverMode(FailoverMode&& value) { SetFailoverMode(std::move(value)); return *this;}
    ///@}
  private:
