...
class UpdateDbClusterRequest : public TimestreamInfluxDBRequest {
 public:
  ...
  inline UpdateDbClusterRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateDbClusterRequest& WithDbInstanceType(DbInstanceType value) {
  ...
  inline UpdateDbClusterRequest& WithFailoverMode(FailoverMode value) {
  ...
  template <typename DbBackupConfigurationsT = Aws::Vector<DbBackupConfiguration>>
  UpdateDbClusterRequest& WithDbBackupConfigurations(DbBackupConfigurationsT&& value) {
  ...
  UpdateDbClusterRequest& AddDbBackupConfigurations(DbBackupConfigurationsT&& value) {
    m_dbBackupConfigurationsHasBeenSet = true;
