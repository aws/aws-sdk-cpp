...
namespace Model {
class GetDbBackupResult {
 public:
  AWS_TIMESTREAMINFLUXDB_API GetDbBackupResult() = default;
  AWS_TIMESTREAMINFLUXDB_API GetDbBackupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_TIMESTREAMINFLUXDB_API GetDbBackupResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename IdT = Aws::String>
  GetDbBackupResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetDbBackupResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetDbBackupResult& WithArn(ArnT&& value) {
  ...
  inline GetDbBackupResult& WithStatus(DbBackupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetDbBackupResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ExpiresAfterT = Aws::String>
  GetDbBackupResult& WithExpiresAfter(ExpiresAfterT&& value) {
  ...
  template <typename DbResourceIdT = Aws::String>
  GetDbBackupResult& WithDbResourceId(DbResourceIdT&& value) {
  ...
  inline GetDbBackupResult& WithType(DbBackupType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline GetDbBackupResult& WithEngineType(EngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
  ...
  inline GetDbBackupResult& WithDeploymentType(ResourceDeploymentType value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  GetDbBackupResult& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  template <typename ClusterConfigurationT = ClusterConfiguration>
  GetDbBackupResult& WithClusterConfiguration(ClusterConfigurationT&& value) {
  ...
  template <typename DbParameterGroupIdT = Aws::String>
  GetDbBackupResult& WithDbParameterGroupId(DbParameterGroupIdT&& value) {
  ...
  inline GetDbBackupResult& WithDbInstanceType(DbInstanceType value) {
  ...
  template <typename LogDeliveryConfigurationT = LogDeliveryConfiguration>
  GetDbBackupResult& WithLogDeliveryConfiguration(LogDeliveryConfigurationT&& value) {
  ...
  inline GetDbBackupResult& WithFailoverMode(FailoverMode value) {
  ...
  inline GetDbBackupResult& WithDbStorageType(DbStorageType value) {
  ...
  inline GetDbBackupResult& WithAllocatedStorage(int value) {
  ...
  template <typename VpcSubnetIdsT = Aws::Vector<Aws::String>>
  GetDbBackupResult& WithVpcSubnetIds(VpcSubnetIdsT&& value) {
    SetVpcSubnetIds(std::forward<VpcSubnetIdsT>(value));
    return *this;
  }
  template <typename VpcSubnetIdsT = Aws::String>
  GetDbBackupResult& AddVpcSubnetIds(VpcSubnetIdsT&& value) {
    m_vpcSubnetIdsHasBeenSet = true;
  ...
  template <typename VpcSecurityGroupIdsT = Aws::Vector<Aws::String>>
  GetDbBackupResult& WithVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    SetVpcSecurityGroupIds(std::forward<VpcSecurityGroupIdsT>(value));
    return *this;
  }
  template <typename VpcSecurityGroupIdsT = Aws::String>
  GetDbBackupResult& AddVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    m_vpcSecurityGroupIdsHasBeenSet = true;
  ...
  inline GetDbBackupResult& WithPubliclyAccessible(bool value) {
  ...
  inline GetDbBackupResult& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline GetDbBackupResult& WithNetworkType(NetworkType value) {
  ...
  template <typename InfluxAuthParametersSecretArnT = Aws::String>
  GetDbBackupResult& WithInfluxAuthParametersSecretArn(InfluxAuthParametersSecretArnT&& value) {
  ...
  template <typename MaintenanceScheduleT = MaintenanceSchedule>
  GetDbBackupResult& WithMaintenanceSchedule(MaintenanceScheduleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDbBackupResult& WithRequestId(RequestIdT&& value) {
