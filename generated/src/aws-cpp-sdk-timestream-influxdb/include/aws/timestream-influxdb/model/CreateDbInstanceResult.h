...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    CreateDbInstanceResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateDbInstanceResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    CreateDbInstanceResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    inline CreateDbInstanceResult& WithStatus(Status value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename EndpointT = Aws::String>
    CreateDbInstanceResult& WithEndpoint(EndpointT&& value) { SetEndpoint(std::forward<EndpointT>(value)); return *this;}
    ///@}
    ...
    inline CreateDbInstanceResult& WithNetworkType(NetworkType value) { SetNetworkType(value); return *this;}
    ///@}
    ...
    inline CreateDbInstanceResult& WithDbInstanceType(DbInstanceType value) { SetDbInstanceType(value); return *this;}
    ///@}
    ...
    inline CreateDbInstanceResult& WithDbStorageType(DbStorageType value) { SetDbStorageType(value); return *this;}
    ///@}
    ...
    inline CreateDbInstanceResult& WithDeploymentType(DeploymentType value) { SetDeploymentType(value); return *this;}
    ///@}
    ...
    template<typename VpcSubnetIdsT = Aws::Vector<Aws::String>>
    CreateDbInstanceResult& WithVpcSubnetIds(VpcSubnetIdsT&& value) { SetVpcSubnetIds(std::forward<VpcSubnetIdsT>(value)); return *this;}
    template<typename VpcSubnetIdsT = Aws::String>
    CreateDbInstanceResult& AddVpcSubnetIds(VpcSubnetIdsT&& value) { m_vpcSubnetIdsHasBeenSet = true; m_vpcSubnetIds.emplace_back(std::forward<VpcSubnetIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename VpcSecurityGroupIdsT = Aws::Vector<Aws::String>>
    CreateDbInstanceResult& WithVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) { SetVpcSecurityGroupIds(std::forward<VpcSecurityGroupIdsT>(value)); return *this;}
    template<typename VpcSecurityGroupIdsT = Aws::String>
    CreateDbInstanceResult& AddVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) { m_vpcSecurityGroupIdsHasBeenSet = true; m_vpcSecurityGroupIds.emplace_back(std::forward<VpcSecurityGroupIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename DbParameterGroupIdentifierT = Aws::String>
    CreateDbInstanceResult& WithDbParameterGroupIdentifier(DbParameterGroupIdentifierT&& value) { SetDbParameterGroupIdentifier(std::forward<DbParameterGroupIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename AvailabilityZoneT = Aws::String>
    CreateDbInstanceResult& WithAvailabilityZone(AvailabilityZoneT&& value) { SetAvailabilityZone(std::forward<AvailabilityZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename SecondaryAvailabilityZoneT = Aws::String>
    CreateDbInstanceResult& WithSecondaryAvailabilityZone(SecondaryAvailabilityZoneT&& value) { SetSecondaryAvailabilityZone(std::forward<SecondaryAvailabilityZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename LogDeliveryConfigurationT = LogDeliveryConfiguration>
    CreateDbInstanceResult& WithLogDeliveryConfiguration(LogDeliveryConfigurationT&& value) { SetLogDeliveryConfiguration(std::forward<LogDeliveryConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename InfluxAuthParametersSecretArnT = Aws::String>
    CreateDbInstanceResult& WithInfluxAuthParametersSecretArn(InfluxAuthParametersSecretArnT&& value) { SetInfluxAuthParametersSecretArn(std::forward<InfluxAuthParametersSecretArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DbClusterIdT = Aws::String>
    CreateDbInstanceResult& WithDbClusterId(DbClusterIdT&& value) { SetDbClusterId(std::forward<DbClusterIdT>(value)); return *this;}
    ///@}
    ...
    inline CreateDbInstanceResult& WithInstanceMode(InstanceMode value) { SetInstanceMode(value); return *this;}
    ///@}
    ...
    template<typename InstanceModesT = Aws::Vector<InstanceMode>>
    CreateDbInstanceResult& WithInstanceModes(InstanceModesT&& value) { SetInstanceModes(std::forward<InstanceModesT>(value)); return *this;}
    inline CreateDbInstanceResult& AddInstanceModes(InstanceMode value) { m_instanceModesHasBeenSet = true; m_instanceModes.push_back(value); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateDbInstanceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
