...
namespace Model
{
  ...
  public:
    ...
    inline CreateDbInstanceResult& WithDbClusterId(const Aws::String& value) { SetDbClusterId(value); return *this;}
    inline CreateDbInstanceResult& WithDbClusterId(Aws::String&& value) { SetDbClusterId(std::move(value)); return *this;}
    inline CreateDbInstanceResult& WithDbClusterId(const char* value) { SetDbClusterId(value); return *this;}
    ///@}
    ...
    inline CreateDbInstanceResult& WithInstanceMode(const InstanceMode& value) { SetInstanceMode(value); return *this;}
    inline CreateDbInstanceResult& WithInstanceMode(InstanceMode&& value) { SetInstanceMode(std::move(value)); return *this;}
    ///@}
