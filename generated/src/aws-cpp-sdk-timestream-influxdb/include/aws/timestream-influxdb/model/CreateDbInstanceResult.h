...
class CreateDbInstanceResult {
 public:
  ...
  inline CreateDbInstanceResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDbInstanceResult& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDbInstanceResult& WithNetworkType(NetworkType value) {
  ...
  inline CreateDbInstanceResult& WithDbInstanceType(DbInstanceType value) {
  ...
  inline CreateDbInstanceResult& WithDbStorageType(DbStorageType value) {
  ...
  inline CreateDbInstanceResult& WithAllocatedStorage(int value) {
  ...
  inline CreateDbInstanceResult& WithDeploymentType(DeploymentType value) {
  ...
  inline CreateDbInstanceResult& WithPubliclyAccessible(bool value) {
  ...
  inline CreateDbInstanceResult& WithInstanceMode(InstanceMode value) {
  ...
  template <typename InstanceModesT = Aws::Vector<InstanceMode>>
  CreateDbInstanceResult& WithInstanceModes(InstanceModesT&& value) {
    SetInstanceModes(std::forward<InstanceModesT>(value));
    return *this;
  }
  inline CreateDbInstanceResult& AddInstanceModes(InstanceMode value) {
    m_instanceModesHasBeenSet = true;
  ...
  template <typename MaintenanceScheduleT = MaintenanceSchedule>
  CreateDbInstanceResult& WithMaintenanceSchedule(MaintenanceScheduleT&& value) {
  ...
  template <typename LastMaintenanceTimeT = Aws::Utils::DateTime>
  CreateDbInstanceResult& WithLastMaintenanceTime(LastMaintenanceTimeT&& value) {
  ...
  template <typename NextMaintenanceTimeT = Aws::Utils::DateTime>
  CreateDbInstanceResult& WithNextMaintenanceTime(NextMaintenanceTimeT&& value) {
  ...
  template <typename DbBackupConfigurationsT = Aws::Vector<DbBackupConfigurationOutput>>
  CreateDbInstanceResult& WithDbBackupConfigurations(DbBackupConfigurationsT&& value) {
  ...
  CreateDbInstanceResult& AddDbBackupConfigurations(DbBackupConfigurationsT&& value) {
    m_dbBackupConfigurationsHasBeenSet = true;
  ...
  template <typename KmsKeyIdT = Aws::String>
  CreateDbInstanceResult& WithKmsKeyId(KmsKeyIdT&& value) {
