...
class DeleteDbInstanceResult {
 public:
  ...
  inline DeleteDbInstanceResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteDbInstanceResult& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteDbInstanceResult& WithNetworkType(NetworkType value) {
  ...
  inline DeleteDbInstanceResult& WithDbInstanceType(DbInstanceType value) {
  ...
  inline DeleteDbInstanceResult& WithDbStorageType(DbStorageType value) {
  ...
  inline DeleteDbInstanceResult& WithAllocatedStorage(int value) {
  ...
  inline DeleteDbInstanceResult& WithDeploymentType(DeploymentType value) {
  ...
  inline DeleteDbInstanceResult& WithPubliclyAccessible(bool value) {
  ...
  inline DeleteDbInstanceResult& WithInstanceMode(InstanceMode value) {
  ...
  template <typename InstanceModesT = Aws::Vector<InstanceMode>>
  DeleteDbInstanceResult& WithInstanceModes(InstanceModesT&& value) {
    SetInstanceModes(std::forward<InstanceModesT>(value));
    return *this;
  }
  inline DeleteDbInstanceResult& AddInstanceModes(InstanceMode value) {
    m_instanceModesHasBeenSet = true;
  ...
  template <typename MaintenanceScheduleT = MaintenanceSchedule>
  DeleteDbInstanceResult& WithMaintenanceSchedule(MaintenanceScheduleT&& value) {
  ...
  template <typename LastMaintenanceTimeT = Aws::Utils::DateTime>
  DeleteDbInstanceResult& WithLastMaintenanceTime(LastMaintenanceTimeT&& value) {
  ...
  template <typename NextMaintenanceTimeT = Aws::Utils::DateTime>
  DeleteDbInstanceResult& WithNextMaintenanceTime(NextMaintenanceTimeT&& value) {
  ...
  ///@{
  /**
   * <p>The backup configurations that were associated with the deleted DB
   * instance.</p>
   */
  ...
  template <typename DbBackupConfigurationsT = Aws::Vector<DbBackupConfigurationOutput>>
  DeleteDbInstanceResult& WithDbBackupConfigurations(DbBackupConfigurationsT&& value) {
  ...
  DeleteDbInstanceResult& AddDbBackupConfigurations(DbBackupConfigurationsT&& value) {
    m_dbBackupConfigurationsHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>The Amazon Web Services KMS key ARN that was used for encryption of the
   * deleted DB instance.</p>
   */
  ...
  template <typename KmsKeyIdT = Aws::String>
  DeleteDbInstanceResult& WithKmsKeyId(KmsKeyIdT&& value) {
