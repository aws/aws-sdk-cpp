...
class DbInstanceForClusterSummary {
 public:
  ...
  inline DbInstanceForClusterSummary& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DbInstanceForClusterSummary& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline DbInstanceForClusterSummary& WithNetworkType(NetworkType value) {
  ...
  inline DbInstanceForClusterSummary& WithDbInstanceType(DbInstanceType value) {
  ...
  inline DbInstanceForClusterSummary& WithDbStorageType(DbStorageType value) {
  ...
  inline DbInstanceForClusterSummary& WithAllocatedStorage(int value) {
  ...
  inline DbInstanceForClusterSummary& WithDeploymentType(DeploymentType value) {
  ...
  inline DbInstanceForClusterSummary& WithInstanceMode(InstanceMode value) {
  ...
  template <typename InstanceModesT = Aws::Vector<InstanceMode>>
  DbInstanceForClusterSummary& WithInstanceModes(InstanceModesT&& value) {
    SetInstanceModes(std::forward<InstanceModesT>(value));
    return *this;
  }
  inline DbInstanceForClusterSummary& AddInstanceModes(InstanceMode value) {
    m_instanceModesHasBeenSet = true;
