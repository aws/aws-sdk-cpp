...
namespace Model {
class DeleteDbBackupResult {
 public:
  AWS_TIMESTREAMINFLUXDB_API DeleteDbBackupResult() = default;
  AWS_TIMESTREAMINFLUXDB_API DeleteDbBackupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_TIMESTREAMINFLUXDB_API DeleteDbBackupResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename IdT = Aws::String>
  DeleteDbBackupResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteDbBackupResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteDbBackupResult& WithArn(ArnT&& value) {
  ...
  inline DeleteDbBackupResult& WithStatus(DbBackupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  DeleteDbBackupResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ExpiresAfterT = Aws::String>
  DeleteDbBackupResult& WithExpiresAfter(ExpiresAfterT&& value) {
  ...
  template <typename DbResourceIdT = Aws::String>
  DeleteDbBackupResult& WithDbResourceId(DbResourceIdT&& value) {
  ...
  inline DeleteDbBackupResult& WithType(DbBackupType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteDbBackupResult& WithEngineType(EngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteDbBackupResult& WithDeploymentType(ResourceDeploymentType value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  DeleteDbBackupResult& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  template <typename ClusterConfigurationT = ClusterConfiguration>
  DeleteDbBackupResult& WithClusterConfiguration(ClusterConfigurationT&& value) {
  ...
  template <typename DbParameterGroupIdT = Aws::String>
  DeleteDbBackupResult& WithDbParameterGroupId(DbParameterGroupIdT&& value) {
  ...
  inline DeleteDbBackupResult& WithDbInstanceType(DbInstanceType value) {
  ...
  template <typename LogDeliveryConfigurationT = LogDeliveryConfiguration>
  DeleteDbBackupResult& WithLogDeliveryConfiguration(LogDeliveryConfigurationT&& value) {
  ...
  inline DeleteDbBackupResult& WithFailoverMode(FailoverMode value) {
  ...
  inline DeleteDbBackupResult& WithDbStorageType(DbStorageType value) {
  ...
  inline DeleteDbBackupResult& WithAllocatedStorage(int value) {
  ...
  template <typename VpcSubnetIdsT = Aws::Vector<Aws::String>>
  DeleteDbBackupResult& WithVpcSubnetIds(VpcSubnetIdsT&& value) {
    SetVpcSubnetIds(std::forward<VpcSubnetIdsT>(value));
    return *this;
  }
  template <typename VpcSubnetIdsT = Aws::String>
  DeleteDbBackupResult& AddVpcSubnetIds(VpcSubnetIdsT&& value) {
    m_vpcSubnetIdsHasBeenSet = true;
  ...
  template <typename VpcSecurityGroupIdsT = Aws::Vector<Aws::String>>
  DeleteDbBackupResult& WithVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    SetVpcSecurityGroupIds(std::forward<VpcSecurityGroupIdsT>(value));
    return *this;
  }
  template <typename VpcSecurityGroupIdsT = Aws::String>
  DeleteDbBackupResult& AddVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    m_vpcSecurityGroupIdsHasBeenSet = true;
  ...
  inline DeleteDbBackupResult& WithPubliclyAccessible(bool value) {
  ...
  inline DeleteDbBackupResult& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteDbBackupResult& WithNetworkType(NetworkType value) {
  ...
  template <typename InfluxAuthParametersSecretArnT = Aws::String>
  DeleteDbBackupResult& WithInfluxAuthParametersSecretArn(InfluxAuthParametersSecretArnT&& value) {
  ...
  template <typename MaintenanceScheduleT = MaintenanceSchedule>
  DeleteDbBackupResult& WithMaintenanceSchedule(MaintenanceScheduleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDbBackupResult& WithRequestId(RequestIdT&& value) {
