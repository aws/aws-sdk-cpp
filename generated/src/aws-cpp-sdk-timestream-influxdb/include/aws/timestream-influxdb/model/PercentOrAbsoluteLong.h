...
class PercentOrAbsoluteLong {
 public:
  ...
  void SetPercent(PercentT&& value) {
    m_percentHasBeenSet = true;
    m_percent = std::forward<PercentT>(value);
  }
  template <typename PercentT = Aws::String>
  PercentOrAbsoluteLong& WithPercent(PercentT&& value) {
    SetPercent(std::forward<PercentT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAbsolute(long long value) {
    m_absoluteHasBeenSet = true;
    m_absolute = value;
  }
  inline PercentOrAbsoluteLong& WithAbsolute(long long value) {
    SetAbsolute(value);
    return *this;
  }
  ///@}
