...
class DbInstanceSummary {
 public:
  ...
  inline DbInstanceSummary& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DbInstanceSummary& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline DbInstanceSummary& WithNetworkType(NetworkType value) {
  ...
  inline DbInstanceSummary& WithDbInstanceType(DbInstanceType value) {
  ...
  inline DbInstanceSummary& WithDbStorageType(DbStorageType value) {
  ...
  inline DbInstanceSummary& WithAllocatedStorage(int value) {
  ...
  inline DbInstanceSummary& WithDeploymentType(DeploymentType value) {
