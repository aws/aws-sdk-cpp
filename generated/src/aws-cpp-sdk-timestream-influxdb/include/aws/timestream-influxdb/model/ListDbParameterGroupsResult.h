...
class ListDbParameterGroupsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<DbParameterGroupSummary>>
  ListDbParameterGroupsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DbParameterGroupSummary>
  ListDbParameterGroupsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDbParameterGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDbParameterGroupsResult& WithRequestId(RequestIdT&& value) {
