...
namespace Model
{
  ...
  {
  public:
    AWS_TIMESTREAMINFLUXDB_API UpdateDbInstanceResult() = default;
    ...
    template<typename IdT = Aws::String>
    UpdateDbInstanceResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateDbInstanceResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    UpdateDbInstanceResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    inline UpdateDbInstanceResult& WithStatus(Status value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename EndpointT = Aws::String>
    UpdateDbInstanceResult& WithEndpoint(EndpointT&& value) { SetEndpoint(std::forward<EndpointT>(value)); return *this;}
    ///@}
    ...
    inline UpdateDbInstanceResult& WithNetworkType(NetworkType value) { SetNetworkType(value); return *this;}
    ///@}
    ...
    inline UpdateDbInstanceResult& WithDbInstanceType(DbInstanceType value) { SetDbInstanceType(value); return *this;}
    ///@}
    ...
    inline UpdateDbInstanceResult& WithDbStorageType(DbStorageType value) { SetDbStorageType(value); return *this;}
    ///@}
    ...
    inline UpdateDbInstanceResult& WithDeploymentType(DeploymentType value) { SetDeploymentType(value); return *this;}
    ///@}
    ...
    template<typename VpcSubnetIdsT = Aws::Vector<Aws::String>>
    UpdateDbInstanceResult& WithVpcSubnetIds(VpcSubnetIdsT&& value) { SetVpcSubnetIds(std::forward<VpcSubnetIdsT>(value)); return *this;}
    template<typename VpcSubnetIdsT = Aws::String>
    UpdateDbInstanceResult& AddVpcSubnetIds(VpcSubnetIdsT&& value) { m_vpcSubnetIdsHasBeenSet = true; m_vpcSubnetIds.emplace_back(std::forward<VpcSubnetIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename VpcSecurityGroupIdsT = Aws::Vector<Aws::String>>
    UpdateDbInstanceResult& WithVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) { SetVpcSecurityGroupIds(std::forward<VpcSecurityGroupIdsT>(value)); return *this;}
    template<typename VpcSecurityGroupIdsT = Aws::String>
    UpdateDbInstanceResult& AddVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) { m_vpcSecurityGroupIdsHasBeenSet = true; m_vpcSecurityGroupIds.emplace_back(std::forward<VpcSecurityGroupIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename DbParameterGroupIdentifierT = Aws::String>
    UpdateDbInstanceResult& WithDbParameterGroupIdentifier(DbParameterGroupIdentifierT&& value) { SetDbParameterGroupIdentifier(std::forward<DbParameterGroupIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename AvailabilityZoneT = Aws::String>
    UpdateDbInstanceResult& WithAvailabilityZone(AvailabilityZoneT&& value) { SetAvailabilityZone(std::forward<AvailabilityZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename SecondaryAvailabilityZoneT = Aws::String>
    UpdateDbInstanceResult& WithSecondaryAvailabilityZone(SecondaryAvailabilityZoneT&& value) { SetSecondaryAvailabilityZone(std::forward<SecondaryAvailabilityZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename LogDeliveryConfigurationT = LogDeliveryConfiguration>
    UpdateDbInstanceResult& WithLogDeliveryConfiguration(LogDeliveryConfigurationT&& value) { SetLogDeliveryConfiguration(std::forward<LogDeliveryConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename InfluxAuthParametersSecretArnT = Aws::String>
    UpdateDbInstanceResult& WithInfluxAuthParametersSecretArn(InfluxAuthParametersSecretArnT&& value) { SetInfluxAuthParametersSecretArn(std::forward<InfluxAuthParametersSecretArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DbClusterIdT = Aws::String>
    UpdateDbInstanceResult& WithDbClusterId(DbClusterIdT&& value) { SetDbClusterId(std::forward<DbClusterIdT>(value)); return *this;}
    ///@}
    ...
    inline UpdateDbInstanceResult& WithInstanceMode(InstanceMode value) { SetInstanceMode(value); return *this;}
    ///@}
    ...
    template<typename InstanceModesT = Aws::Vector<InstanceMode>>
    UpdateDbInstanceResult& WithInstanceModes(InstanceModesT&& value) { SetInstanceModes(std::forward<InstanceModesT>(value)); return *this;}
    inline UpdateDbInstanceResult& AddInstanceModes(InstanceMode value) { m_instanceModesHasBeenSet = true; m_instanceModes.push_back(value); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDbInstanceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
