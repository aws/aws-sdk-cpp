...
class GetDbParameterGroupResult {
 public:
  AWS_TIMESTREAMINFLUXDB_API GetDbParameterGroupResult() = default;
  ...
  template <typename IdT = Aws::String>
  GetDbParameterGroupResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetDbParameterGroupResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetDbParameterGroupResult& WithArn(ArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetDbParameterGroupResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ParametersT = Parameters>
  GetDbParameterGroupResult& WithParameters(ParametersT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDbParameterGroupResult& WithRequestId(RequestIdT&& value) {
