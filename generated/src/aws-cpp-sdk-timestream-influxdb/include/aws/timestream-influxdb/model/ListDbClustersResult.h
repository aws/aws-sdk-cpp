...
class ListDbClustersResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<DbClusterSummary>>
  ListDbClustersResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DbClusterSummary>
  ListDbClustersResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDbClustersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDbClustersResult& WithRequestId(RequestIdT&& value) {
