...
class ListDbInstancesForClusterRequest : public TimestreamInfluxDBRequest {
 public:
  ...
  template <typename DbClusterIdT = Aws::String>
  ListDbInstancesForClusterRequest& WithDbClusterId(DbClusterIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDbInstancesForClusterRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDbInstancesForClusterRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
