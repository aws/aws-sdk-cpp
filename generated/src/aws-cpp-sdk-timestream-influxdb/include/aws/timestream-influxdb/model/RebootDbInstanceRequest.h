...
/**
 */
class RebootDbInstanceRequest : public TimestreamInfluxDBRequest {
 public:
  AWS_TIMESTREAMINFLUXDB_API RebootDbInstanceRequest() = default;
  ...
  template <typename IdentifierT = Aws::String>
  RebootDbInstanceRequest& WithIdentifier(IdentifierT&& value) {
