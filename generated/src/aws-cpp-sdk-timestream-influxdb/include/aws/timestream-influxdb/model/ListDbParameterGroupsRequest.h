...
namespace Model
{
  ...
  {
  public:
    AWS_TIMESTREAMINFLUXDB_API ListDbParameterGroupsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListDbParameterGroupsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
