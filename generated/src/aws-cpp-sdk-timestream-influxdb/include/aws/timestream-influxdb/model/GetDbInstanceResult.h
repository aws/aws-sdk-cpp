...
namespace Model
{
  ...
  {
  public:
    AWS_TIMESTREAMINFLUXDB_API GetDbInstanceResult() = default;
    ...
    template<typename IdT = Aws::String>
    GetDbInstanceResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    GetDbInstanceResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    GetDbInstanceResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    inline GetDbInstanceResult& WithStatus(Status value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename EndpointT = Aws::String>
    GetDbInstanceResult& WithEndpoint(EndpointT&& value) { SetEndpoint(std::forward<EndpointT>(value)); return *this;}
    ///@}
    ...
    inline GetDbInstanceResult& WithNetworkType(NetworkType value) { SetNetworkType(value); return *this;}
    ///@}
    ...
    inline GetDbInstanceResult& WithDbInstanceType(DbInstanceType value) { SetDbInstanceType(value); return *this;}
    ///@}
    ...
    inline GetDbInstanceResult& WithDbStorageType(DbStorageType value) { SetDbStorageType(value); return *this;}
    ///@}
    ...
    inline GetDbInstanceResult& WithDeploymentType(DeploymentType value) { SetDeploymentType(value); return *this;}
    ///@}
    ...
    template<typename VpcSubnetIdsT = Aws::Vector<Aws::String>>
    GetDbInstanceResult& WithVpcSubnetIds(VpcSubnetIdsT&& value) { SetVpcSubnetIds(std::forward<VpcSubnetIdsT>(value)); return *this;}
    template<typename VpcSubnetIdsT = Aws::String>
    GetDbInstanceResult& AddVpcSubnetIds(VpcSubnetIdsT&& value) { m_vpcSubnetIdsHasBeenSet = true; m_vpcSubnetIds.emplace_back(std::forward<VpcSubnetIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename VpcSecurityGroupIdsT = Aws::Vector<Aws::String>>
    GetDbInstanceResult& WithVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) { SetVpcSecurityGroupIds(std::forward<VpcSecurityGroupIdsT>(value)); return *this;}
    template<typename VpcSecurityGroupIdsT = Aws::String>
    GetDbInstanceResult& AddVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) { m_vpcSecurityGroupIdsHasBeenSet = true; m_vpcSecurityGroupIds.emplace_back(std::forward<VpcSecurityGroupIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename DbParameterGroupIdentifierT = Aws::String>
    GetDbInstanceResult& WithDbParameterGroupIdentifier(DbParameterGroupIdentifierT&& value) { SetDbParameterGroupIdentifier(std::forward<DbParameterGroupIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename AvailabilityZoneT = Aws::String>
    GetDbInstanceResult& WithAvailabilityZone(AvailabilityZoneT&& value) { SetAvailabilityZone(std::forward<AvailabilityZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename SecondaryAvailabilityZoneT = Aws::String>
    GetDbInstanceResult& WithSecondaryAvailabilityZone(SecondaryAvailabilityZoneT&& value) { SetSecondaryAvailabilityZone(std::forward<SecondaryAvailabilityZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename LogDeliveryConfigurationT = LogDeliveryConfiguration>
    GetDbInstanceResult& WithLogDeliveryConfiguration(LogDeliveryConfigurationT&& value) { SetLogDeliveryConfiguration(std::forward<LogDeliveryConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename InfluxAuthParametersSecretArnT = Aws::String>
    GetDbInstanceResult& WithInfluxAuthParametersSecretArn(InfluxAuthParametersSecretArnT&& value) { SetInfluxAuthParametersSecretArn(std::forward<InfluxAuthParametersSecretArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DbClusterIdT = Aws::String>
    GetDbInstanceResult& WithDbClusterId(DbClusterIdT&& value) { SetDbClusterId(std::forward<DbClusterIdT>(value)); return *this;}
    ///@}
    ...
    inline GetDbInstanceResult& WithInstanceMode(InstanceMode value) { SetInstanceMode(value); return *this;}
    ///@}
    ...
    template<typename InstanceModesT = Aws::Vector<InstanceMode>>
    GetDbInstanceResult& WithInstanceModes(InstanceModesT&& value) { SetInstanceModes(std::forward<InstanceModesT>(value)); return *this;}
    inline GetDbInstanceResult& AddInstanceModes(InstanceMode value) { m_instanceModesHasBeenSet = true; m_instanceModes.push_back(value); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetDbInstanceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
