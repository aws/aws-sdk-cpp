...
typedef std::function<void(const TimestreamInfluxDBClient*, const Model::CreateDbInstanceRequest&, const Model::CreateDbInstanceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
...
typedef std::function<void(const TimestreamInfluxDBClient*, const Model::GetDbInstanceRequest&, const Model::GetDbInstanceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetDbInstanceResponseReceivedHandler;
...
typedef std::function<void(const TimestreamInfluxDBClient*, const Model::ListDbInstancesRequest&, const Model::ListDbInstancesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListDbInstancesResponseReceivedHandler;
typedef std::function<void(const TimestreamInfluxDBClient*, const Model::ListDbInstancesForClusterRequest&,
                           const Model::ListDbInstancesForClusterOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListDbInstancesForClusterResponseReceivedHandler;
typedef std::function<void(const TimestreamInfluxDBClient*, const Model::ListDbParameterGroupsRequest&,
                           const Model::ListDbParameterGroupsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListDbParameterGroupsResponseReceivedHandler;
typedef std::function<void(const TimestreamInfluxDBClient*, const Model::ListTagsForResourceRequest&,
                           const Model::ListTagsForResourceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const TimestreamInfluxDBClient*, const Model::RebootDbClusterRequest&, const Model::RebootDbClusterOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    RebootDbClusterResponseReceivedHandler;
...
typedef std::function<void(const TimestreamInfluxDBClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const TimestreamInfluxDBClient*, const Model::UpdateDbClusterRequest&, const Model::UpdateDbClusterOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateDbClusterResponseReceivedHandler;
typedef std::function<void(const TimestreamInfluxDBClient*, const Model::UpdateDbInstanceRequest&, const Model::UpdateDbInstanceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateDbInstanceResponseReceivedHandler;
