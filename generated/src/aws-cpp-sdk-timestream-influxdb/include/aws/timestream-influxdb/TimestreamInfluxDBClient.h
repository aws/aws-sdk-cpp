...
namespace TimestreamInfluxDB
{
   ...
   */
  class AWS_TIMESTREAMINFLUXDB_API TimestreamInfluxDBClient : Aws::Client::ClientWithAsyncTemplateMethods<TimestreamInfluxDBClient>,
    smithy::client::AwsSmithyClientT<Aws::TimestreamInfluxDB::SERVICE_NAME,
