...
class AWS_IOTMANAGEDINTEGRATIONS_API IoTManagedIntegrationsClient
 ...
 public:
   ...
   */
  IoTManagedIntegrationsClient(const Aws::IoTManagedIntegrations::IoTManagedIntegrationsClientConfiguration& clientConfiguration =
  ...
  IoTManagedIntegrationsClient(const Aws::Auth::AWSCredentials& credentials,
                               std::shared_ptr<IoTManagedIntegrationsEndpointProviderBase> endpointProvider = nullptr,
                               const Aws::IoTManagedIntegrations::IoTManagedIntegrationsClientConfiguration& clientConfiguration =
                                   Aws::IoTManagedIntegrations::IoTManagedIntegrationsClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateAccountAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAccountAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAccountAssociationRequestT = Model::CreateAccountAssociationRequest>
  void CreateAccountAssociationAsync(const CreateAccountAssociationRequestT& request,
                                     const CreateAccountAssociationResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConnectorDestinationOutcome CreateConnectorDestination(
      const Model::CreateConnectorDestinationRequest& request) const;

  /**
   * A Callable wrapper for CreateConnectorDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateConnectorDestinationRequestT = Model::CreateConnectorDestinationRequest>
  Model::CreateConnectorDestinationOutcomeCallable CreateConnectorDestinationCallable(
      const CreateConnectorDestinationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::CreateConnectorDestination, request);
  }

  /**
   * An Async wrapper for CreateConnectorDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConnectorDestinationRequestT = Model::CreateConnectorDestinationRequest>
  void CreateConnectorDestinationAsync(const CreateConnectorDestinationRequestT& request,
                                       const CreateConnectorDestinationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCredentialLocker that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCredentialLocker that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCredentialLockerRequestT = Model::CreateCredentialLockerRequest>
  void CreateCredentialLockerAsync(const CreateCredentialLockerResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const CreateCredentialLockerRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateDestination that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDestination that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDestinationRequestT = Model::CreateDestinationRequest>
  void CreateDestinationAsync(const CreateDestinationRequestT& request, const CreateDestinationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateEventLogConfigurationOutcome CreateEventLogConfiguration(
      const Model::CreateEventLogConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateEventLogConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateEventLogConfigurationRequestT = Model::CreateEventLogConfigurationRequest>
  Model::CreateEventLogConfigurationOutcomeCallable CreateEventLogConfigurationCallable(
      const CreateEventLogConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::CreateEventLogConfiguration, request);
  }

  /**
   * An Async wrapper for CreateEventLogConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEventLogConfigurationRequestT = Model::CreateEventLogConfigurationRequest>
  void CreateEventLogConfigurationAsync(const CreateEventLogConfigurationRequestT& request,
                                        const CreateEventLogConfigurationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateManagedThing that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateManagedThing that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateManagedThingRequestT = Model::CreateManagedThingRequest>
  void CreateManagedThingAsync(const CreateManagedThingRequestT& request, const CreateManagedThingResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateNotificationConfigurationOutcome CreateNotificationConfiguration(
      const Model::CreateNotificationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateNotificationConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateNotificationConfigurationRequestT = Model::CreateNotificationConfigurationRequest>
  Model::CreateNotificationConfigurationOutcomeCallable CreateNotificationConfigurationCallable(
      const CreateNotificationConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::CreateNotificationConfiguration, request);
  }

  /**
   * An Async wrapper for CreateNotificationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateNotificationConfigurationRequestT = Model::CreateNotificationConfigurationRequest>
  void CreateNotificationConfigurationAsync(const CreateNotificationConfigurationRequestT& request,
                                            const CreateNotificationConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateOtaTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateOtaTaskRequestT = Model::CreateOtaTaskRequest>
  void CreateOtaTaskAsync(const CreateOtaTaskRequestT& request, const CreateOtaTaskResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateOtaTaskConfigurationOutcome CreateOtaTaskConfiguration(
      const Model::CreateOtaTaskConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for CreateOtaTaskConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateOtaTaskConfigurationRequestT = Model::CreateOtaTaskConfigurationRequest>
  Model::CreateOtaTaskConfigurationOutcomeCallable CreateOtaTaskConfigurationCallable(
      const CreateOtaTaskConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::CreateOtaTaskConfiguration, request);
  }

  /**
   * An Async wrapper for CreateOtaTaskConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateOtaTaskConfigurationRequestT = Model::CreateOtaTaskConfigurationRequest>
  void CreateOtaTaskConfigurationAsync(const CreateOtaTaskConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const CreateOtaTaskConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateProvisioningProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateProvisioningProfileRequestT = Model::CreateProvisioningProfileRequest>
  Model::CreateProvisioningProfileOutcomeCallable CreateProvisioningProfileCallable(
      const CreateProvisioningProfileRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::CreateProvisioningProfile, request);
  }

  /**
   * An Async wrapper for CreateProvisioningProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProvisioningProfileRequestT = Model::CreateProvisioningProfileRequest>
  void CreateProvisioningProfileAsync(const CreateProvisioningProfileRequestT& request,
                                      const CreateProvisioningProfileResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAccountAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAccountAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAccountAssociationRequestT = Model::DeleteAccountAssociationRequest>
  void DeleteAccountAssociationAsync(const DeleteAccountAssociationRequestT& request,
                                     const DeleteAccountAssociationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConnectorDestinationOutcome DeleteConnectorDestination(
      const Model::DeleteConnectorDestinationRequest& request) const;

  /**
   * A Callable wrapper for DeleteConnectorDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteConnectorDestinationRequestT = Model::DeleteConnectorDestinationRequest>
  Model::DeleteConnectorDestinationOutcomeCallable DeleteConnectorDestinationCallable(
      const DeleteConnectorDestinationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::DeleteConnectorDestination, request);
  }

  /**
   * An Async wrapper for DeleteConnectorDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConnectorDestinationRequestT = Model::DeleteConnectorDestinationRequest>
  void DeleteConnectorDestinationAsync(const DeleteConnectorDestinationRequestT& request,
                                       const DeleteConnectorDestinationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCredentialLocker that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCredentialLocker that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCredentialLockerRequestT = Model::DeleteCredentialLockerRequest>
  void DeleteCredentialLockerAsync(const DeleteCredentialLockerRequestT& request,
                                   const DeleteCredentialLockerResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDestination that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDestination that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDestinationRequestT = Model::DeleteDestinationRequest>
  void DeleteDestinationAsync(const DeleteDestinationRequestT& request, const DeleteDestinationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteEventLogConfigurationOutcome DeleteEventLogConfiguration(
      const Model::DeleteEventLogConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteEventLogConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteEventLogConfigurationRequestT = Model::DeleteEventLogConfigurationRequest>
  Model::DeleteEventLogConfigurationOutcomeCallable DeleteEventLogConfigurationCallable(
      const DeleteEventLogConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::DeleteEventLogConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteEventLogConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEventLogConfigurationRequestT = Model::DeleteEventLogConfigurationRequest>
  void DeleteEventLogConfigurationAsync(const DeleteEventLogConfigurationRequestT& request,
                                        const DeleteEventLogConfigurationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteManagedThing that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteManagedThing that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteManagedThingRequestT = Model::DeleteManagedThingRequest>
  void DeleteManagedThingAsync(const DeleteManagedThingRequestT& request, const DeleteManagedThingResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteNotificationConfigurationOutcome DeleteNotificationConfiguration(
      const Model::DeleteNotificationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteNotificationConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteNotificationConfigurationRequestT = Model::DeleteNotificationConfigurationRequest>
  Model::DeleteNotificationConfigurationOutcomeCallable DeleteNotificationConfigurationCallable(
      const DeleteNotificationConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::DeleteNotificationConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteNotificationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteNotificationConfigurationRequestT = Model::DeleteNotificationConfigurationRequest>
  void DeleteNotificationConfigurationAsync(const DeleteNotificationConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteOtaTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteOtaTaskRequestT = Model::DeleteOtaTaskRequest>
  void DeleteOtaTaskAsync(const DeleteOtaTaskRequestT& request, const DeleteOtaTaskResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteOtaTaskConfigurationOutcome DeleteOtaTaskConfiguration(
      const Model::DeleteOtaTaskConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteOtaTaskConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteOtaTaskConfigurationRequestT = Model::DeleteOtaTaskConfigurationRequest>
  Model::DeleteOtaTaskConfigurationOutcomeCallable DeleteOtaTaskConfigurationCallable(
      const DeleteOtaTaskConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::DeleteOtaTaskConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteOtaTaskConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteOtaTaskConfigurationRequestT = Model::DeleteOtaTaskConfigurationRequest>
  void DeleteOtaTaskConfigurationAsync(const DeleteOtaTaskConfigurationRequestT& request,
                                       const DeleteOtaTaskConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteProvisioningProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteProvisioningProfileRequestT = Model::DeleteProvisioningProfileRequest>
  Model::DeleteProvisioningProfileOutcomeCallable DeleteProvisioningProfileCallable(
      const DeleteProvisioningProfileRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::DeleteProvisioningProfile, request);
  }

  /**
   * An Async wrapper for DeleteProvisioningProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProvisioningProfileRequestT = Model::DeleteProvisioningProfileRequest>
  void DeleteProvisioningProfileAsync(const DeleteProvisioningProfileRequestT& request,
                                      const DeleteProvisioningProfileResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterAccountAssociationOutcome DeregisterAccountAssociation(
      const Model::DeregisterAccountAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeregisterAccountAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeregisterAccountAssociationRequestT = Model::DeregisterAccountAssociationRequest>
  Model::DeregisterAccountAssociationOutcomeCallable DeregisterAccountAssociationCallable(
      const DeregisterAccountAssociationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::DeregisterAccountAssociation, request);
  }

  /**
   * An Async wrapper for DeregisterAccountAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterAccountAssociationRequestT = Model::DeregisterAccountAssociationRequest>
  void DeregisterAccountAssociationAsync(const DeregisterAccountAssociationRequestT& request,
                                         const DeregisterAccountAssociationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAccountAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccountAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccountAssociationRequestT = Model::GetAccountAssociationRequest>
  void GetAccountAssociationAsync(const GetAccountAssociationRequestT& request, const GetAccountAssociationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetConnectorDestination that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetConnectorDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConnectorDestinationRequestT = Model::GetConnectorDestinationRequest>
  void GetConnectorDestinationAsync(const GetConnectorDestinationRequestT& request,
                                    const GetConnectorDestinationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCredentialLocker that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCredentialLocker that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCredentialLockerRequestT = Model::GetCredentialLockerRequest>
  void GetCredentialLockerAsync(const GetCredentialLockerRequestT& request, const GetCredentialLockerResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCustomEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCustomEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCustomEndpointRequestT = Model::GetCustomEndpointRequest>
  void GetCustomEndpointAsync(const GetCustomEndpointResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetCustomEndpointRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDefaultEncryptionConfigurationOutcome GetDefaultEncryptionConfiguration(
      const Model::GetDefaultEncryptionConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetDefaultEncryptionConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetDefaultEncryptionConfigurationRequestT = Model::GetDefaultEncryptionConfigurationRequest>
  Model::GetDefaultEncryptionConfigurationOutcomeCallable GetDefaultEncryptionConfigurationCallable(
      const GetDefaultEncryptionConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::GetDefaultEncryptionConfiguration, request);
  }

  /**
   * An Async wrapper for GetDefaultEncryptionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetDefaultEncryptionConfigurationRequestT = Model::GetDefaultEncryptionConfigurationRequest>
  void GetDefaultEncryptionConfigurationAsync(const GetDefaultEncryptionConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const GetDefaultEncryptionConfigurationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetDestination that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDestinationRequestT = Model::GetDestinationRequest>
  void GetDestinationAsync(const GetDestinationRequestT& request, const GetDestinationResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDeviceDiscovery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDeviceDiscovery that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDeviceDiscoveryRequestT = Model::GetDeviceDiscoveryRequest>
  void GetDeviceDiscoveryAsync(const GetDeviceDiscoveryRequestT& request, const GetDeviceDiscoveryResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEventLogConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEventLogConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEventLogConfigurationRequestT = Model::GetEventLogConfigurationRequest>
  void GetEventLogConfigurationAsync(const GetEventLogConfigurationRequestT& request,
                                     const GetEventLogConfigurationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetHubConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetHubConfiguration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetHubConfigurationRequestT = Model::GetHubConfigurationRequest>
  void GetHubConfigurationAsync(const GetHubConfigurationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetHubConfigurationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetManagedThing that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetManagedThingRequestT = Model::GetManagedThingRequest>
  void GetManagedThingAsync(const GetManagedThingRequestT& request, const GetManagedThingResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetManagedThingCapabilitiesOutcome GetManagedThingCapabilities(
      const Model::GetManagedThingCapabilitiesRequest& request) const;

  /**
   * A Callable wrapper for GetManagedThingCapabilities that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetManagedThingCapabilitiesRequestT = Model::GetManagedThingCapabilitiesRequest>
  Model::GetManagedThingCapabilitiesOutcomeCallable GetManagedThingCapabilitiesCallable(
      const GetManagedThingCapabilitiesRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::GetManagedThingCapabilities, request);
  }

  /**
   * An Async wrapper for GetManagedThingCapabilities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetManagedThingCapabilitiesRequestT = Model::GetManagedThingCapabilitiesRequest>
  void GetManagedThingCapabilitiesAsync(const GetManagedThingCapabilitiesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetManagedThingConnectivityDataOutcome GetManagedThingConnectivityData(
      const Model::GetManagedThingConnectivityDataRequest& request) const;

  /**
   * A Callable wrapper for GetManagedThingConnectivityData that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetManagedThingConnectivityDataRequestT = Model::GetManagedThingConnectivityDataRequest>
  Model::GetManagedThingConnectivityDataOutcomeCallable GetManagedThingConnectivityDataCallable(
      const GetManagedThingConnectivityDataRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::GetManagedThingConnectivityData, request);
  }

  /**
   * An Async wrapper for GetManagedThingConnectivityData that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetManagedThingConnectivityDataRequestT = Model::GetManagedThingConnectivityDataRequest>
  void GetManagedThingConnectivityDataAsync(const GetManagedThingConnectivityDataRequestT& request,
                                            const GetManagedThingConnectivityDataResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetManagedThingMetaData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetManagedThingMetaData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetManagedThingMetaDataRequestT = Model::GetManagedThingMetaDataRequest>
  void GetManagedThingMetaDataAsync(const GetManagedThingMetaDataRequestT& request,
                                    const GetManagedThingMetaDataResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetManagedThingState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetManagedThingState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetManagedThingStateRequestT = Model::GetManagedThingStateRequest>
  void GetManagedThingStateAsync(const GetManagedThingStateRequestT& request, const GetManagedThingStateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetNotificationConfigurationOutcome GetNotificationConfiguration(
      const Model::GetNotificationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetNotificationConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetNotificationConfigurationRequestT = Model::GetNotificationConfigurationRequest>
  Model::GetNotificationConfigurationOutcomeCallable GetNotificationConfigurationCallable(
      const GetNotificationConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::GetNotificationConfiguration, request);
  }

  /**
   * An Async wrapper for GetNotificationConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetNotificationConfigurationRequestT = Model::GetNotificationConfigurationRequest>
  void GetNotificationConfigurationAsync(const GetNotificationConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for GetOtaTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOtaTaskRequestT = Model::GetOtaTaskRequest>
  void GetOtaTaskAsync(const GetOtaTaskRequestT& request, const GetOtaTaskResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetOtaTaskConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOtaTaskConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOtaTaskConfigurationRequestT = Model::GetOtaTaskConfigurationRequest>
  void GetOtaTaskConfigurationAsync(const GetOtaTaskConfigurationRequestT& request,
                                    const GetOtaTaskConfigurationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetProvisioningProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetProvisioningProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetProvisioningProfileRequestT = Model::GetProvisioningProfileRequest>
  void GetProvisioningProfileAsync(const GetProvisioningProfileRequestT& request,
                                   const GetProvisioningProfileResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRuntimeLogConfigurationOutcome GetRuntimeLogConfiguration(
      const Model::GetRuntimeLogConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetRuntimeLogConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRuntimeLogConfigurationRequestT = Model::GetRuntimeLogConfigurationRequest>
  Model::GetRuntimeLogConfigurationOutcomeCallable GetRuntimeLogConfigurationCallable(
      const GetRuntimeLogConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::GetRuntimeLogConfiguration, request);
  }

  /**
   * An Async wrapper for GetRuntimeLogConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRuntimeLogConfigurationRequestT = Model::GetRuntimeLogConfigurationRequest>
  void GetRuntimeLogConfigurationAsync(const GetRuntimeLogConfigurationRequestT& request,
                                       const GetRuntimeLogConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetSchemaVersionRequestT = Model::GetSchemaVersionRequest>
  void GetSchemaVersionAsync(const GetSchemaVersionRequestT& request, const GetSchemaVersionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccountAssociations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccountAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAccountAssociationsRequestT = Model::ListAccountAssociationsRequest>
  void ListAccountAssociationsAsync(const ListAccountAssociationsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListAccountAssociationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConnectorDestinationsOutcome ListConnectorDestinations(
      const Model::ListConnectorDestinationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListConnectorDestinations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListConnectorDestinationsRequestT = Model::ListConnectorDestinationsRequest>
  Model::ListConnectorDestinationsOutcomeCallable ListConnectorDestinationsCallable(
      const ListConnectorDestinationsRequestT& request = {}) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::ListConnectorDestinations, request);
  }

  /**
   * An Async wrapper for ListConnectorDestinations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConnectorDestinationsRequestT = Model::ListConnectorDestinationsRequest>
  void ListConnectorDestinationsAsync(const ListConnectorDestinationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListConnectorDestinationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCredentialLockers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCredentialLockers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCredentialLockersRequestT = Model::ListCredentialLockersRequest>
  void ListCredentialLockersAsync(const ListCredentialLockersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListCredentialLockersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDestinations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDestinations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDestinationsRequestT = Model::ListDestinationsRequest>
  void ListDestinationsAsync(const ListDestinationsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListDestinationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDeviceDiscoveries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDeviceDiscoveries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDeviceDiscoveriesRequestT = Model::ListDeviceDiscoveriesRequest>
  void ListDeviceDiscoveriesAsync(const ListDeviceDiscoveriesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListDeviceDiscoveriesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDiscoveredDevices that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDiscoveredDevices that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDiscoveredDevicesRequestT = Model::ListDiscoveredDevicesRequest>
  void ListDiscoveredDevicesAsync(const ListDiscoveredDevicesRequestT& request, const ListDiscoveredDevicesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEventLogConfigurationsOutcome ListEventLogConfigurations(
      const Model::ListEventLogConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListEventLogConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListEventLogConfigurationsRequestT = Model::ListEventLogConfigurationsRequest>
  Model::ListEventLogConfigurationsOutcomeCallable ListEventLogConfigurationsCallable(
      const ListEventLogConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::ListEventLogConfigurations, request);
  }

  /**
   * An Async wrapper for ListEventLogConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEventLogConfigurationsRequestT = Model::ListEventLogConfigurationsRequest>
  void ListEventLogConfigurationsAsync(const ListEventLogConfigurationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListEventLogConfigurationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListManagedThingAccountAssociationsOutcome ListManagedThingAccountAssociations(
      const Model::ListManagedThingAccountAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListManagedThingAccountAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListManagedThingAccountAssociationsRequestT = Model::ListManagedThingAccountAssociationsRequest>
  Model::ListManagedThingAccountAssociationsOutcomeCallable ListManagedThingAccountAssociationsCallable(
      const ListManagedThingAccountAssociationsRequestT& request = {}) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::ListManagedThingAccountAssociations, request);
  }

  /**
   * An Async wrapper for ListManagedThingAccountAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListManagedThingAccountAssociationsRequestT = Model::ListManagedThingAccountAssociationsRequest>
  void ListManagedThingAccountAssociationsAsync(const ListManagedThingAccountAssociationsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const ListManagedThingAccountAssociationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListManagedThingSchemas that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListManagedThingSchemas that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListManagedThingSchemasRequestT = Model::ListManagedThingSchemasRequest>
  void ListManagedThingSchemasAsync(const ListManagedThingSchemasRequestT& request,
                                    const ListManagedThingSchemasResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListManagedThings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListManagedThings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListManagedThingsRequestT = Model::ListManagedThingsRequest>
  void ListManagedThingsAsync(const ListManagedThingsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListManagedThingsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListNotificationConfigurationsOutcome ListNotificationConfigurations(
      const Model::ListNotificationConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListNotificationConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListNotificationConfigurationsRequestT = Model::ListNotificationConfigurationsRequest>
  Model::ListNotificationConfigurationsOutcomeCallable ListNotificationConfigurationsCallable(
      const ListNotificationConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::ListNotificationConfigurations, request);
  }

  /**
   * An Async wrapper for ListNotificationConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListNotificationConfigurationsRequestT = Model::ListNotificationConfigurationsRequest>
  void ListNotificationConfigurationsAsync(const ListNotificationConfigurationsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListNotificationConfigurationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListOtaTaskConfigurationsOutcome ListOtaTaskConfigurations(
      const Model::ListOtaTaskConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListOtaTaskConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListOtaTaskConfigurationsRequestT = Model::ListOtaTaskConfigurationsRequest>
  Model::ListOtaTaskConfigurationsOutcomeCallable ListOtaTaskConfigurationsCallable(
      const ListOtaTaskConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::ListOtaTaskConfigurations, request);
  }

  /**
   * An Async wrapper for ListOtaTaskConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOtaTaskConfigurationsRequestT = Model::ListOtaTaskConfigurationsRequest>
  void ListOtaTaskConfigurationsAsync(const ListOtaTaskConfigurationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListOtaTaskConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListOtaTaskExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOtaTaskExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOtaTaskExecutionsRequestT = Model::ListOtaTaskExecutionsRequest>
  void ListOtaTaskExecutionsAsync(const ListOtaTaskExecutionsRequestT& request, const ListOtaTaskExecutionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListOtaTasks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListOtaTasksRequestT = Model::ListOtaTasksRequest>
  void ListOtaTasksAsync(const ListOtaTasksResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListOtaTasksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProvisioningProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListProvisioningProfilesRequestT = Model::ListProvisioningProfilesRequest>
  Model::ListProvisioningProfilesOutcomeCallable ListProvisioningProfilesCallable(
      const ListProvisioningProfilesRequestT& request = {}) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::ListProvisioningProfiles, request);
  }

  /**
   * An Async wrapper for ListProvisioningProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProvisioningProfilesRequestT = Model::ListProvisioningProfilesRequest>
  void ListProvisioningProfilesAsync(const ListProvisioningProfilesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListProvisioningProfilesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutHubConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutHubConfiguration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutHubConfigurationRequestT = Model::PutHubConfigurationRequest>
  void PutHubConfigurationAsync(const PutHubConfigurationRequestT& request, const PutHubConfigurationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutRuntimeLogConfigurationOutcome PutRuntimeLogConfiguration(
      const Model::PutRuntimeLogConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutRuntimeLogConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutRuntimeLogConfigurationRequestT = Model::PutRuntimeLogConfigurationRequest>
  Model::PutRuntimeLogConfigurationOutcomeCallable PutRuntimeLogConfigurationCallable(
      const PutRuntimeLogConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::PutRuntimeLogConfiguration, request);
  }

  /**
   * An Async wrapper for PutRuntimeLogConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRuntimeLogConfigurationRequestT = Model::PutRuntimeLogConfigurationRequest>
  void PutRuntimeLogConfigurationAsync(const PutRuntimeLogConfigurationRequestT& request,
                                       const PutRuntimeLogConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterAccountAssociationOutcome RegisterAccountAssociation(
      const Model::RegisterAccountAssociationRequest& request) const;

  /**
   * A Callable wrapper for RegisterAccountAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterAccountAssociationRequestT = Model::RegisterAccountAssociationRequest>
  Model::RegisterAccountAssociationOutcomeCallable RegisterAccountAssociationCallable(
      const RegisterAccountAssociationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::RegisterAccountAssociation, request);
  }

  /**
   * An Async wrapper for RegisterAccountAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterAccountAssociationRequestT = Model::RegisterAccountAssociationRequest>
  void RegisterAccountAssociationAsync(const RegisterAccountAssociationRequestT& request,
                                       const RegisterAccountAssociationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterCustomEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterCustomEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterCustomEndpointRequestT = Model::RegisterCustomEndpointRequest>
  void RegisterCustomEndpointAsync(const RegisterCustomEndpointResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const RegisterCustomEndpointRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ResetRuntimeLogConfigurationOutcome ResetRuntimeLogConfiguration(
      const Model::ResetRuntimeLogConfigurationRequest& request) const;

  /**
   * A Callable wrapper for ResetRuntimeLogConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ResetRuntimeLogConfigurationRequestT = Model::ResetRuntimeLogConfigurationRequest>
  Model::ResetRuntimeLogConfigurationOutcomeCallable ResetRuntimeLogConfigurationCallable(
      const ResetRuntimeLogConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::ResetRuntimeLogConfiguration, request);
  }

  /**
   * An Async wrapper for ResetRuntimeLogConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResetRuntimeLogConfigurationRequestT = Model::ResetRuntimeLogConfigurationRequest>
  void ResetRuntimeLogConfigurationAsync(const ResetRuntimeLogConfigurationRequestT& request,
                                         const ResetRuntimeLogConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendConnectorEvent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendConnectorEvent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SendConnectorEventRequestT = Model::SendConnectorEventRequest>
  void SendConnectorEventAsync(const SendConnectorEventRequestT& request, const SendConnectorEventResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendManagedThingCommand that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendManagedThingCommand that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendManagedThingCommandRequestT = Model::SendManagedThingCommandRequest>
  void SendManagedThingCommandAsync(const SendManagedThingCommandRequestT& request,
                                    const SendManagedThingCommandResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartAccountAssociationRefreshOutcome StartAccountAssociationRefresh(
      const Model::StartAccountAssociationRefreshRequest& request) const;

  /**
   * A Callable wrapper for StartAccountAssociationRefresh that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartAccountAssociationRefreshRequestT = Model::StartAccountAssociationRefreshRequest>
  Model::StartAccountAssociationRefreshOutcomeCallable StartAccountAssociationRefreshCallable(
      const StartAccountAssociationRefreshRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::StartAccountAssociationRefresh, request);
  }

  /**
   * An Async wrapper for StartAccountAssociationRefresh that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartAccountAssociationRefreshRequestT = Model::StartAccountAssociationRefreshRequest>
  void StartAccountAssociationRefreshAsync(const StartAccountAssociationRefreshRequestT& request,
                                           const StartAccountAssociationRefreshResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartDeviceDiscovery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartDeviceDiscovery that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartDeviceDiscoveryRequestT = Model::StartDeviceDiscoveryRequest>
  void StartDeviceDiscoveryAsync(const StartDeviceDiscoveryRequestT& request, const StartDeviceDiscoveryResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAccountAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAccountAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAccountAssociationRequestT = Model::UpdateAccountAssociationRequest>
  void UpdateAccountAssociationAsync(const UpdateAccountAssociationRequestT& request,
                                     const UpdateAccountAssociationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConnectorDestinationOutcome UpdateConnectorDestination(
      const Model::UpdateConnectorDestinationRequest& request) const;

  /**
   * A Callable wrapper for UpdateConnectorDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateConnectorDestinationRequestT = Model::UpdateConnectorDestinationRequest>
  Model::UpdateConnectorDestinationOutcomeCallable UpdateConnectorDestinationCallable(
      const UpdateConnectorDestinationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::UpdateConnectorDestination, request);
  }

  /**
   * An Async wrapper for UpdateConnectorDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConnectorDestinationRequestT = Model::UpdateConnectorDestinationRequest>
  void UpdateConnectorDestinationAsync(const UpdateConnectorDestinationRequestT& request,
                                       const UpdateConnectorDestinationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDestination that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDestination that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDestinationRequestT = Model::UpdateDestinationRequest>
  void UpdateDestinationAsync(const UpdateDestinationRequestT& request, const UpdateDestinationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEventLogConfigurationOutcome UpdateEventLogConfiguration(
      const Model::UpdateEventLogConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateEventLogConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateEventLogConfigurationRequestT = Model::UpdateEventLogConfigurationRequest>
  Model::UpdateEventLogConfigurationOutcomeCallable UpdateEventLogConfigurationCallable(
      const UpdateEventLogConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::UpdateEventLogConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateEventLogConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEventLogConfigurationRequestT = Model::UpdateEventLogConfigurationRequest>
  void UpdateEventLogConfigurationAsync(const UpdateEventLogConfigurationRequestT& request,
                                        const UpdateEventLogConfigurationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateManagedThing that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateManagedThing that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateManagedThingRequestT = Model::UpdateManagedThingRequest>
  void UpdateManagedThingAsync(const UpdateManagedThingRequestT& request, const UpdateManagedThingResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateNotificationConfigurationOutcome UpdateNotificationConfiguration(
      const Model::UpdateNotificationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateNotificationConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateNotificationConfigurationRequestT = Model::UpdateNotificationConfigurationRequest>
  Model::UpdateNotificationConfigurationOutcomeCallable UpdateNotificationConfigurationCallable(
      const UpdateNotificationConfigurationRequestT& request) const {
    return SubmitCallable(&IoTManagedIntegrationsClient::UpdateNotificationConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateNotificationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateNotificationConfigurationRequestT = Model::UpdateNotificationConfigurationRequest>
  void UpdateNotificationConfigurationAsync(const UpdateNotificationConfigurationRequestT& request,
                                            const UpdateNotificationConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateOtaTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateOtaTaskRequestT = Model::UpdateOtaTaskRequest>
  void UpdateOtaTaskAsync(const UpdateOtaTaskRequestT& request, const UpdateOtaTaskResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&IoTManagedIntegrationsClient::UpdateOtaTask, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<IoTManagedIntegrationsEndpointProviderBase>& accessEndpointProvider();
