...
class ListOtaTaskConfigurationsResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListOtaTaskConfigurationsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<OtaTaskConfigurationSummary>>
  ListOtaTaskConfigurationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = OtaTaskConfigurationSummary>
  ListOtaTaskConfigurationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListOtaTaskConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOtaTaskConfigurationsResult& WithRequestId(RequestIdT&& value) {
