...
class OAuthUpdate {
 public:
  ...
  void SetOAuthCompleteRedirectUrl(OAuthCompleteRedirectUrlT&& value) {
    ...
    m_oAuthCompleteRedirectUrl = std::forward<OAuthCompleteRedirectUrlT>(value);
  }
  template <typename OAuthCompleteRedirectUrlT = Aws::String>
  OAuthUpdate& WithOAuthCompleteRedirectUrl(OAuthCompleteRedirectUrlT&& value) {
    SetOAuthCompleteRedirectUrl(std::forward<OAuthCompleteRedirectUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProactiveRefreshTokenRenewal(ProactiveRefreshTokenRenewalT&& value) {
    ...
    m_proactiveRefreshTokenRenewal = std::forward<ProactiveRefreshTokenRenewalT>(value);
  }
  template <typename ProactiveRefreshTokenRenewalT = ProactiveRefreshTokenRenewal>
  OAuthUpdate& WithProactiveRefreshTokenRenewal(ProactiveRefreshTokenRenewalT&& value) {
    SetProactiveRefreshTokenRenewal(std::forward<ProactiveRefreshTokenRenewalT>(value));
    return *this;
  }
  ///@}
 private:
