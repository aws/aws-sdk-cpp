...
class ListNotificationConfigurationsResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListNotificationConfigurationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
   ...
   */
  inline const Aws::Vector<NotificationConfigurationSummary>& GetNotificationConfigurationList() const {
    return m_notificationConfigurationList;
  }
  ...
  void SetNotificationConfigurationList(NotificationConfigurationListT&& value) {
    m_notificationConfigurationListHasBeenSet = true;
    m_notificationConfigurationList = std::forward<NotificationConfigurationListT>(value);
  }
  template <typename NotificationConfigurationListT = Aws::Vector<NotificationConfigurationSummary>>
  ListNotificationConfigurationsResult& WithNotificationConfigurationList(NotificationConfigurationListT&& value) {
    SetNotificationConfigurationList(std::forward<NotificationConfigurationListT>(value));
    return *this;
  }
  ...
  ListNotificationConfigurationsResult& AddNotificationConfigurationList(NotificationConfigurationListT&& value) {
    m_notificationConfigurationListHasBeenSet = true;
    m_notificationConfigurationList.emplace_back(std::forward<NotificationConfigurationListT>(value));
    return *this;
  }
  ///@}
