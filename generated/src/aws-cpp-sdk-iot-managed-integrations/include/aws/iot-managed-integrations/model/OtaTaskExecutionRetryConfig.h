...
class OtaTaskExecutionRetryConfig {
 public:
  ...
  void SetRetryConfigCriteria(RetryConfigCriteriaT&& value) {
    m_retryConfigCriteriaHasBeenSet = true;
    m_retryConfigCriteria = std::forward<RetryConfigCriteriaT>(value);
  }
  template <typename RetryConfigCriteriaT = Aws::Vector<RetryConfigCriteria>>
  OtaTaskExecutionRetryConfig& WithRetryConfigCriteria(RetryConfigCriteriaT&& value) {
    SetRetryConfigCriteria(std::forward<RetryConfigCriteriaT>(value));
    return *this;
  }
  template <typename RetryConfigCriteriaT = RetryConfigCriteria>
  OtaTaskExecutionRetryConfig& AddRetryConfigCriteria(RetryConfigCriteriaT&& value) {
    m_retryConfigCriteriaHasBeenSet = true;
    m_retryConfigCriteria.emplace_back(std::forward<RetryConfigCriteriaT>(value));
    return *this;
  }
  ///@}
 private:
