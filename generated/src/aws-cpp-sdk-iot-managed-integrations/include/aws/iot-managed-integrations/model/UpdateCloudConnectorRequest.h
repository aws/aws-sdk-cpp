...
/**
 */
class UpdateCloudConnectorRequest : public IoTManagedIntegrationsRequest {
 public:
  AWS_IOTMANAGEDINTEGRATIONS_API UpdateCloudConnectorRequest() = default;
  ...
  template <typename IdentifierT = Aws::String>
  UpdateCloudConnectorRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateCloudConnectorRequest& WithName(NameT&& value) {
