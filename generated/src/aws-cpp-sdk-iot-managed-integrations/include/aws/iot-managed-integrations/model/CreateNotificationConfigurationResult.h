...
class CreateNotificationConfigurationResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API CreateNotificationConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline CreateNotificationConfigurationResult& WithEventType(EventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateNotificationConfigurationResult& WithRequestId(RequestIdT&& value) {
