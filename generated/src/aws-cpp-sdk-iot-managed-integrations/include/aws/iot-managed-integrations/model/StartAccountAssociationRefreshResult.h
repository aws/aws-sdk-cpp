...
class StartAccountAssociationRefreshResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API StartAccountAssociationRefreshResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_IOTMANAGEDINTEGRATIONS_API StartAccountAssociationRefreshResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename OAuthAuthorizationUrlT = Aws::String>
  StartAccountAssociationRefreshResult& WithOAuthAuthorizationUrl(OAuthAuthorizationUrlT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartAccountAssociationRefreshResult& WithRequestId(RequestIdT&& value) {
