...
class ListDeviceDiscoveriesResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListDeviceDiscoveriesResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<DeviceDiscoverySummary>>
  ListDeviceDiscoveriesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DeviceDiscoverySummary>
  ListDeviceDiscoveriesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDeviceDiscoveriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDeviceDiscoveriesResult& WithRequestId(RequestIdT&& value) {
