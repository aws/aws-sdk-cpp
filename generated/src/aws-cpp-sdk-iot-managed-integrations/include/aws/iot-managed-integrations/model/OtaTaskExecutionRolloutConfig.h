...
class OtaTaskExecutionRolloutConfig {
 public:
  ...
  void SetExponentialRolloutRate(ExponentialRolloutRateT&& value) {
    ...
    m_exponentialRolloutRate = std::forward<ExponentialRolloutRateT>(value);
  }
  template <typename ExponentialRolloutRateT = ExponentialRolloutRate>
  OtaTaskExecutionRolloutConfig& WithExponentialRolloutRate(ExponentialRolloutRateT&& value) {
    SetExponentialRolloutRate(std::forward<ExponentialRolloutRateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumPerMinute(int value) {
    m_maximumPerMinuteHasBeenSet = true;
    m_maximumPerMinute = value;
  }
  inline OtaTaskExecutionRolloutConfig& WithMaximumPerMinute(int value) {
    SetMaximumPerMinute(value);
    return *this;
  }
  ///@}
 private:
