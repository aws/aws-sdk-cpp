...
class ListCredentialLockersResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListCredentialLockersResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<CredentialLockerSummary>>
  ListCredentialLockersResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = CredentialLockerSummary>
  ListCredentialLockersResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCredentialLockersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCredentialLockersResult& WithRequestId(RequestIdT&& value) {
