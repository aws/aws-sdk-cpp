...
class AccountAssociationItem {
 public:
  ...
  template <typename AccountAssociationIdT = Aws::String>
  AccountAssociationItem& WithAccountAssociationId(AccountAssociationIdT&& value) {
  ...
  inline AccountAssociationItem& WithAssociationState(AssociationState value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  AccountAssociationItem& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename ConnectorDestinationIdT = Aws::String>
  AccountAssociationItem& WithConnectorDestinationId(ConnectorDestinationIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  AccountAssociationItem& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AccountAssociationItem& WithDescription(DescriptionT&& value) {
  ...
  template <typename ArnT = Aws::String>
  AccountAssociationItem& WithArn(ArnT&& value) {
