...
class CreateCredentialLockerRequest : public IoTManagedIntegrationsRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateCredentialLockerRequest& WithName(NameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateCredentialLockerRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateCredentialLockerRequest& WithTags(TagsT&& value) {
