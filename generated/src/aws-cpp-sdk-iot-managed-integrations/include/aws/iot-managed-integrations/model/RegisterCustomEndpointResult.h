...
class RegisterCustomEndpointResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API RegisterCustomEndpointResult& operator=(
  ...
  template <typename EndpointAddressT = Aws::String>
  RegisterCustomEndpointResult& WithEndpointAddress(EndpointAddressT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RegisterCustomEndpointResult& WithRequestId(RequestIdT&& value) {
