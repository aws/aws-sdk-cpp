...
class AbortConfigCriteria {
 public:
  ...
  inline void SetAction(AbortCriteriaAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline AbortConfigCriteria& WithAction(AbortCriteriaAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailureType(AbortCriteriaFailureType value) {
    m_failureTypeHasBeenSet = true;
    m_failureType = value;
  }
  inline AbortConfigCriteria& WithFailureType(AbortCriteriaFailureType value) {
  ...
  inline AbortConfigCriteria& WithMinNumberOfExecutedThings(int value) {
  ...
  inline AbortConfigCriteria& WithThresholdPercentage(double value) {
