...
class CreateProvisioningProfileResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API CreateProvisioningProfileResult& operator=(
  ...
  template <typename ArnT = Aws::String>
  CreateProvisioningProfileResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateProvisioningProfileResult& WithName(NameT&& value) {
  ...
  inline CreateProvisioningProfileResult& WithProvisioningType(ProvisioningType value) {
  ...
  template <typename IdT = Aws::String>
  CreateProvisioningProfileResult& WithId(IdT&& value) {
  ...
  template <typename ClaimCertificateT = Aws::String>
  CreateProvisioningProfileResult& WithClaimCertificate(ClaimCertificateT&& value) {
  ...
  void SetClaimCertificatePrivateKey(ClaimCertificatePrivateKeyT&& value) {
    m_claimCertificatePrivateKeyHasBeenSet = true;
    m_claimCertificatePrivateKey = std::forward<ClaimCertificatePrivateKeyT>(value);
  }
  template <typename ClaimCertificatePrivateKeyT = Aws::String>
  CreateProvisioningProfileResult& WithClaimCertificatePrivateKey(ClaimCertificatePrivateKeyT&& value) {
    SetClaimCertificatePrivateKey(std::forward<ClaimCertificatePrivateKeyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateProvisioningProfileResult& WithRequestId(RequestIdT&& value) {
