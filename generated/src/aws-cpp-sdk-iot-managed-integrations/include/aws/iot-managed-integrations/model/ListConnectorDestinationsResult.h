...
class ListConnectorDestinationsResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListConnectorDestinationsResult& operator=(
  ...
  void SetConnectorDestinationList(ConnectorDestinationListT&& value) {
    m_connectorDestinationListHasBeenSet = true;
    m_connectorDestinationList = std::forward<ConnectorDestinationListT>(value);
  }
  template <typename ConnectorDestinationListT = Aws::Vector<ConnectorDestinationSummary>>
  ListConnectorDestinationsResult& WithConnectorDestinationList(ConnectorDestinationListT&& value) {
    SetConnectorDestinationList(std::forward<ConnectorDestinationListT>(value));
    return *this;
  }
  template <typename ConnectorDestinationListT = ConnectorDestinationSummary>
  ListConnectorDestinationsResult& AddConnectorDestinationList(ConnectorDestinationListT&& value) {
    m_connectorDestinationListHasBeenSet = true;
    m_connectorDestinationList.emplace_back(std::forward<ConnectorDestinationListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectorDestinationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConnectorDestinationsResult& WithRequestId(RequestIdT&& value) {
