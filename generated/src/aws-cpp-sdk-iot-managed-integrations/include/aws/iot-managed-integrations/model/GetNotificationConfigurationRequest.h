...
namespace Model
{
  ...
  {
  public:
    AWS_IOTMANAGEDINTEGRATIONS_API GetNotificationConfigurationRequest() = default;
    ...
    inline GetNotificationConfigurationRequest& WithEventType(EventType value) { SetEventType(value); return *this;}
    ///@}
  private:
