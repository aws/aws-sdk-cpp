...
/**
 * <p>Provides the default encryption configuration error update
 * details.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/iot-managed-integrations-2025-03-03/ConfigurationError">AWS
 * API Reference</a></p>
 */
class ConfigurationError {
 public:
  ...
  template <typename CodeT = Aws::String>
  ConfigurationError& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  ConfigurationError& WithMessage(MessageT&& value) {
