...
class OtaTaskAbortConfig {
 public:
  ...
  void SetAbortConfigCriteriaList(AbortConfigCriteriaListT&& value) {
    m_abortConfigCriteriaListHasBeenSet = true;
    m_abortConfigCriteriaList = std::forward<AbortConfigCriteriaListT>(value);
  }
  template <typename AbortConfigCriteriaListT = Aws::Vector<AbortConfigCriteria>>
  OtaTaskAbortConfig& WithAbortConfigCriteriaList(AbortConfigCriteriaListT&& value) {
    SetAbortConfigCriteriaList(std::forward<AbortConfigCriteriaListT>(value));
    return *this;
  }
  template <typename AbortConfigCriteriaListT = AbortConfigCriteria>
  OtaTaskAbortConfig& AddAbortConfigCriteriaList(AbortConfigCriteriaListT&& value) {
    m_abortConfigCriteriaListHasBeenSet = true;
    m_abortConfigCriteriaList.emplace_back(std::forward<AbortConfigCriteriaListT>(value));
    return *this;
  }
  ///@}
 private:
