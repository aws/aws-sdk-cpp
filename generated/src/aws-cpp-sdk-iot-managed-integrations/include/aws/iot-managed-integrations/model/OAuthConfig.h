...
class OAuthConfig {
 public:
  ...
  inline void SetTokenEndpointAuthenticationScheme(TokenEndpointAuthenticationScheme value) {
    m_tokenEndpointAuthenticationSchemeHasBeenSet = true;
    m_tokenEndpointAuthenticationScheme = value;
  }
  inline OAuthConfig& WithTokenEndpointAuthenticationScheme(TokenEndpointAuthenticationScheme value) {
    SetTokenEndpointAuthenticationScheme(value);
    return *this;
  }
  ///@}
