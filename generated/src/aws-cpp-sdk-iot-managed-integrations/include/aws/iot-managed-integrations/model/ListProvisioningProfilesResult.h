...
class ListProvisioningProfilesResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListProvisioningProfilesResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ProvisioningProfileSummary>>
  ListProvisioningProfilesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ProvisioningProfileSummary>
  ListProvisioningProfilesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListProvisioningProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProvisioningProfilesResult& WithRequestId(RequestIdT&& value) {
