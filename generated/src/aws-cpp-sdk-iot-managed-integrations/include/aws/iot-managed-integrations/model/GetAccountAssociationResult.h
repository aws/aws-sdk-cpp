...
class GetAccountAssociationResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API GetAccountAssociationResult& operator=(
  ...
  inline GetAccountAssociationResult& WithAssociationState(AssociationState value) {
  ...
  template <typename NameT = Aws::String>
  GetAccountAssociationResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetAccountAssociationResult& WithArn(ArnT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetAccountAssociationResult& WithTags(TagsT&& value) {
