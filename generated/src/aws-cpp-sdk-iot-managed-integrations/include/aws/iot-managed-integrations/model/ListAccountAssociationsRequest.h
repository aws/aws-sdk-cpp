...
class ListAccountAssociationsRequest : public IoTManagedIntegrationsRequest {
 public:
  ...
  void SetConnectorDestinationId(ConnectorDestinationIdT&& value) {
    ...
    m_connectorDestinationId = std::forward<ConnectorDestinationIdT>(value);
  }
  template <typename ConnectorDestinationIdT = Aws::String>
  ListAccountAssociationsRequest& WithConnectorDestinationId(ConnectorDestinationIdT&& value) {
    SetConnectorDestinationId(std::forward<ConnectorDestinationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListAccountAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
