...
class ListEventLogConfigurationsRequest : public IoTManagedIntegrationsRequest {
 public:
  AWS_IOTMANAGEDINTEGRATIONS_API ListEventLogConfigurationsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListEventLogConfigurationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEventLogConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
