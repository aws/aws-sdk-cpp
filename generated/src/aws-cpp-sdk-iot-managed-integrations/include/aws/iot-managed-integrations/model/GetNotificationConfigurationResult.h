...
class GetNotificationConfigurationResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API GetNotificationConfigurationResult& operator=(
  ...
  inline GetNotificationConfigurationResult& WithEventType(EventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetNotificationConfigurationResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetNotificationConfigurationResult& WithUpdatedAt(UpdatedAtT&& value) {
