...
class UpdateEventLogConfigurationRequest : public IoTManagedIntegrationsRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateEventLogConfigurationRequest& WithId(IdT&& value) {
  ...
  inline void SetEventLogLevel(LogLevel value) {
    m_eventLogLevelHasBeenSet = true;
    m_eventLogLevel = value;
  }
  inline UpdateEventLogConfigurationRequest& WithEventLogLevel(LogLevel value) {
    SetEventLogLevel(value);
    return *this;
  }
  ///@}
 private:
