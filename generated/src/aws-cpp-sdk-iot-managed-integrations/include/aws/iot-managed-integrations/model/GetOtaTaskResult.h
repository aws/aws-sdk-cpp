...
class GetOtaTaskResult {
 public:
  ...
  void SetS3Url(S3UrlT&& value) {
    ...
    m_s3Url = std::forward<S3UrlT>(value);
  }
  template <typename S3UrlT = Aws::String>
  GetOtaTaskResult& WithS3Url(S3UrlT&& value) {
    SetS3Url(std::forward<S3UrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProtocol(OtaProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline GetOtaTaskResult& WithProtocol(OtaProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOtaType(OtaType value) {
    m_otaTypeHasBeenSet = true;
    m_otaType = value;
  }
  inline GetOtaTaskResult& WithOtaType(OtaType value) {
    SetOtaType(value);
    return *this;
  }
  ///@}
  ...
  void SetOtaTargetQueryString(OtaTargetQueryStringT&& value) {
    ...
    m_otaTargetQueryString = std::forward<OtaTargetQueryStringT>(value);
  }
  template <typename OtaTargetQueryStringT = Aws::String>
  GetOtaTaskResult& WithOtaTargetQueryString(OtaTargetQueryStringT&& value) {
    SetOtaTargetQueryString(std::forward<OtaTargetQueryStringT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOtaMechanism(OtaMechanism value) {
    m_otaMechanismHasBeenSet = true;
    m_otaMechanism = value;
  }
  inline GetOtaTaskResult& WithOtaMechanism(OtaMechanism value) {
    SetOtaMechanism(value);
    return *this;
  }
  ///@}
  ...
  void SetTaskProcessingDetails(TaskProcessingDetailsT&& value) {
    ...
    m_taskProcessingDetails = std::forward<TaskProcessingDetailsT>(value);
  }
  template <typename TaskProcessingDetailsT = TaskProcessingDetails>
  GetOtaTaskResult& WithTaskProcessingDetails(TaskProcessingDetailsT&& value) {
    SetTaskProcessingDetails(std::forward<TaskProcessingDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOtaSchedulingConfig(OtaSchedulingConfigT&& value) {
    ...
    m_otaSchedulingConfig = std::forward<OtaSchedulingConfigT>(value);
  }
  template <typename OtaSchedulingConfigT = OtaTaskSchedulingConfig>
  GetOtaTaskResult& WithOtaSchedulingConfig(OtaSchedulingConfigT&& value) {
    SetOtaSchedulingConfig(std::forward<OtaSchedulingConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOtaTaskExecutionRetryConfig(OtaTaskExecutionRetryConfigT&& value) {
    ...
    m_otaTaskExecutionRetryConfig = std::forward<OtaTaskExecutionRetryConfigT>(value);
  }
  template <typename OtaTaskExecutionRetryConfigT = OtaTaskExecutionRetryConfig>
  GetOtaTaskResult& WithOtaTaskExecutionRetryConfig(OtaTaskExecutionRetryConfigT&& value) {
    SetOtaTaskExecutionRetryConfig(std::forward<OtaTaskExecutionRetryConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(OtaStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetOtaTaskResult& WithStatus(OtaStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
