...
class ListSchemaVersionsResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListSchemaVersionsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<SchemaVersionListItem>>
  ListSchemaVersionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = SchemaVersionListItem>
  ListSchemaVersionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
