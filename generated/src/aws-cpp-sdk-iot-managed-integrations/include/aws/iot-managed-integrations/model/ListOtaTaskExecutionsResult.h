...
class ListOtaTaskExecutionsResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListOtaTaskExecutionsResult& operator=(
  ...
  template <typename ExecutionSummariesT = Aws::Vector<OtaTaskExecutionSummaries>>
  ListOtaTaskExecutionsResult& WithExecutionSummaries(ExecutionSummariesT&& value) {
  ...
  ListOtaTaskExecutionsResult& AddExecutionSummaries(ExecutionSummariesT&& value) {
    m_executionSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListOtaTaskExecutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOtaTaskExecutionsResult& WithRequestId(RequestIdT&& value) {
