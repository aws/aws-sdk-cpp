...
class DiscoveredDeviceSummary {
 public:
  ...
  inline void SetModification(DiscoveryModification value) {
    m_modificationHasBeenSet = true;
    m_modification = value;
  }
  inline DiscoveredDeviceSummary& WithModification(DiscoveryModification value) {
  ...
  void SetDiscoveredAt(DiscoveredAtT&& value) {
    ...
    m_discoveredAt = std::forward<DiscoveredAtT>(value);
  }
  template <typename DiscoveredAtT = Aws::Utils::DateTime>
  DiscoveredDeviceSummary& WithDiscoveredAt(DiscoveredAtT&& value) {
    SetDiscoveredAt(std::forward<DiscoveredAtT>(value));
    return *this;
  }
  ///@}
