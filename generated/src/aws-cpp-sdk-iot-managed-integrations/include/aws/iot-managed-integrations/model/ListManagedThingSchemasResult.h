...
class ListManagedThingSchemasResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListManagedThingSchemasResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ManagedThingSchemaListItem>>
  ListManagedThingSchemasResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ManagedThingSchemaListItem>
  ListManagedThingSchemasResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedThingSchemasResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedThingSchemasResult& WithRequestId(RequestIdT&& value) {
