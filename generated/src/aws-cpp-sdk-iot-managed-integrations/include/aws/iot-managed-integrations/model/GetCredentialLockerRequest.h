...
namespace Model
{
  ...
  {
  public:
    AWS_IOTMANAGEDINTEGRATIONS_API GetCredentialLockerRequest() = default;
    ...
    template<typename IdentifierT = Aws::String>
    GetCredentialLockerRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
