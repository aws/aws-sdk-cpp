...
namespace Model
{
  ...
  {
  public:
    AWS_IOTMANAGEDINTEGRATIONS_API GetEventLogConfigurationRequest() = default;
    ...
    template<typename IdT = Aws::String>
    GetEventLogConfigurationRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
