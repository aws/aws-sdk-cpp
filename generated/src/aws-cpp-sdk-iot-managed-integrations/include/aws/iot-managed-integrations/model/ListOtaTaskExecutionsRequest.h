...
class ListOtaTaskExecutionsRequest : public IoTManagedIntegrationsRequest {
 public:
  AWS_IOTMANAGEDINTEGRATIONS_API ListOtaTaskExecutionsRequest() = default;
  ...
  template <typename IdentifierT = Aws::String>
  ListOtaTaskExecutionsRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListOtaTaskExecutionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListOtaTaskExecutionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
