...
class RetryConfigCriteria {
 public:
  ...
  inline void SetFailureType(RetryCriteriaFailureType value) {
    m_failureTypeHasBeenSet = true;
    m_failureType = value;
  }
  inline RetryConfigCriteria& WithFailureType(RetryCriteriaFailureType value) {
  ...
  inline void SetMinNumberOfRetries(int value) {
    m_minNumberOfRetriesHasBeenSet = true;
    m_minNumberOfRetries = value;
  }
  inline RetryConfigCriteria& WithMinNumberOfRetries(int value) {
    SetMinNumberOfRetries(value);
    return *this;
  }
  ///@}
 private:
