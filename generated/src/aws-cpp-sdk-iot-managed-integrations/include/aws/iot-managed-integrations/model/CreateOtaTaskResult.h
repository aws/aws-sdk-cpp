...
class CreateOtaTaskResult {
 public:
  AWS_IOTMANAGEDINTEGRATIONS_API CreateOtaTaskResult() = default;
  ...
  template <typename TaskIdT = Aws::String>
  CreateOtaTaskResult& WithTaskId(TaskIdT&& value) {
  ...
  template <typename TaskArnT = Aws::String>
  CreateOtaTaskResult& WithTaskArn(TaskArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateOtaTaskResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateOtaTaskResult& WithRequestId(RequestIdT&& value) {
