...
class ListDiscoveredDevicesResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListDiscoveredDevicesResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<DiscoveredDeviceSummary>>
  ListDiscoveredDevicesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DiscoveredDeviceSummary>
  ListDiscoveredDevicesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDiscoveredDevicesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDiscoveredDevicesResult& WithRequestId(RequestIdT&& value) {
