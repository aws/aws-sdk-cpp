...
namespace Model
{
  ...
  public:
    ...
    template<typename DeliveryDestinationArnT = Aws::String>
    UpdateDestinationRequest& WithDeliveryDestinationArn(DeliveryDestinationArnT&& value) { SetDeliveryDestinationArn(std::forward<DeliveryDestinationArnT>(value)); return *this;}
    ///@}
    ...
    inline UpdateDestinationRequest& WithDeliveryDestinationType(DeliveryDestinationType value) { SetDeliveryDestinationType(value); return *this;}
    ///@}
