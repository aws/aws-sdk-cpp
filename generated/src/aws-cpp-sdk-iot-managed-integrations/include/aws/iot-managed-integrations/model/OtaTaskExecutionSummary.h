...
class OtaTaskExecutionSummary {
 public:
  ...
  inline OtaTaskExecutionSummary& WithExecutionNumber(long long value) {
  ...
  inline OtaTaskExecutionSummary& WithRetryAttempt(int value) {
  ...
  inline void SetStatus(OtaTaskExecutionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline OtaTaskExecutionSummary& WithStatus(OtaTaskExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
