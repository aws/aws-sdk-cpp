...
class GetProvisioningProfileResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API GetProvisioningProfileResult& operator=(
  ...
  template <typename ArnT = Aws::String>
  GetProvisioningProfileResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetProvisioningProfileResult& WithName(NameT&& value) {
  ...
  inline GetProvisioningProfileResult& WithProvisioningType(ProvisioningType value) {
  ...
  template <typename IdT = Aws::String>
  GetProvisioningProfileResult& WithId(IdT&& value) {
  ...
  template <typename ClaimCertificateT = Aws::String>
  GetProvisioningProfileResult& WithClaimCertificate(ClaimCertificateT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetProvisioningProfileResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetProvisioningProfileResult& WithRequestId(RequestIdT&& value) {
