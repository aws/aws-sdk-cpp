...
class ListConnectorDestinationsRequest : public IoTManagedIntegrationsRequest {
 public:
  ...
  template <typename CloudConnectorIdT = Aws::String>
  ListConnectorDestinationsRequest& WithCloudConnectorId(CloudConnectorIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectorDestinationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListConnectorDestinationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
