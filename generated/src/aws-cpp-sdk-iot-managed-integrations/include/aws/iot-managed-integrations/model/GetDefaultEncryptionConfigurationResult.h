...
class GetDefaultEncryptionConfigurationResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API GetDefaultEncryptionConfigurationResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_IOTMANAGEDINTEGRATIONS_API GetDefaultEncryptionConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline GetDefaultEncryptionConfigurationResult& WithEncryptionType(EncryptionType value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  GetDefaultEncryptionConfigurationResult& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDefaultEncryptionConfigurationResult& WithRequestId(RequestIdT&& value) {
