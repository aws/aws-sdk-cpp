...
class OtaTaskSchedulingConfig {
 public:
  ...
  inline void SetEndBehavior(SchedulingConfigEndBehavior value) {
    m_endBehaviorHasBeenSet = true;
    m_endBehavior = value;
  }
  inline OtaTaskSchedulingConfig& WithEndBehavior(SchedulingConfigEndBehavior value) {
  ...
  template <typename EndTimeT = Aws::String>
  OtaTaskSchedulingConfig& WithEndTime(EndTimeT&& value) {
  ...
  template <typename MaintenanceWindowsT = Aws::Vector<ScheduleMaintenanceWindow>>
  OtaTaskSchedulingConfig& WithMaintenanceWindows(MaintenanceWindowsT&& value) {
  ...
  OtaTaskSchedulingConfig& AddMaintenanceWindows(MaintenanceWindowsT&& value) {
    m_maintenanceWindowsHasBeenSet = true;
  ...
  template <typename StartTimeT = Aws::String>
  OtaTaskSchedulingConfig& WithStartTime(StartTimeT&& value) {
