...
class CreateCredentialLockerResult {
 public:
  AWS_IOTMANAGEDINTEGRATIONS_API CreateCredentialLockerResult() = default;
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API CreateCredentialLockerResult& operator=(
  ...
  template <typename IdT = Aws::String>
  CreateCredentialLockerResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateCredentialLockerResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateCredentialLockerResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCredentialLockerResult& WithRequestId(RequestIdT&& value) {
