...
class ListManagedThingsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ManagedThingSummary>>
  ListManagedThingsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ManagedThingSummary>
  ListManagedThingsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedThingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedThingsResult& WithRequestId(RequestIdT&& value) {
