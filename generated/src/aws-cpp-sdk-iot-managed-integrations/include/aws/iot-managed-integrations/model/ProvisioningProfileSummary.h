...
class ProvisioningProfileSummary {
 public:
  ...
  template <typename NameT = Aws::String>
  ProvisioningProfileSummary& WithName(NameT&& value) {
  ...
  template <typename IdT = Aws::String>
  ProvisioningProfileSummary& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ProvisioningProfileSummary& WithArn(ArnT&& value) {
  ...
  inline ProvisioningProfileSummary& WithProvisioningType(ProvisioningType value) {
