...
namespace Model
{
  ...
  /**
   */
  class ListNotificationConfigurationsRequest : public IoTManagedIntegrationsRequest
  {
  public:
    AWS_IOTMANAGEDINTEGRATIONS_API ListNotificationConfigurationsRequest() = default;
