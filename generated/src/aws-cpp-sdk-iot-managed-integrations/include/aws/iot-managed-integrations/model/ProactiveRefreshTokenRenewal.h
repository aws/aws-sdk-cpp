...
class ProactiveRefreshTokenRenewal {
 public:
  ...
  inline ProactiveRefreshTokenRenewal& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDaysBeforeRenewal(int value) {
    m_daysBeforeRenewalHasBeenSet = true;
    m_daysBeforeRenewal = value;
  }
  inline ProactiveRefreshTokenRenewal& WithDaysBeforeRenewal(int value) {
    SetDaysBeforeRenewal(value);
    return *this;
  }
  ///@}
 private:
