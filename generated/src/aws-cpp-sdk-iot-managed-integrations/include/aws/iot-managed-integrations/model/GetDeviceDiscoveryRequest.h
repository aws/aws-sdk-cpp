...
namespace Model
{
  ...
  {
  public:
    AWS_IOTMANAGEDINTEGRATIONS_API GetDeviceDiscoveryRequest() = default;
    ...
    template<typename IdentifierT = Aws::String>
    GetDeviceDiscoveryRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
