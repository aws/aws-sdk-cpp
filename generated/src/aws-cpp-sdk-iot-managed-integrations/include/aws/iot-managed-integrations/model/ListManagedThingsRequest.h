...
class ListManagedThingsRequest : public IoTManagedIntegrationsRequest {
 public:
  ...
  void SetCredentialLockerFilter(CredentialLockerFilterT&& value) {
    m_credentialLockerFilterHasBeenSet = true;
    m_credentialLockerFilter = std::forward<CredentialLockerFilterT>(value);
  }
  template <typename CredentialLockerFilterT = Aws::String>
  ListManagedThingsRequest& WithCredentialLockerFilter(CredentialLockerFilterT&& value) {
    SetCredentialLockerFilter(std::forward<CredentialLockerFilterT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRoleFilter(Role value) {
    m_roleFilterHasBeenSet = true;
    m_roleFilter = value;
  }
  inline ListManagedThingsRequest& WithRoleFilter(Role value) {
    SetRoleFilter(value);
    return *this;
  }
  ///@}
  ...
  void SetParentControllerIdentifierFilter(ParentControllerIdentifierFilterT&& value) {
    m_parentControllerIdentifierFilterHasBeenSet = true;
    m_parentControllerIdentifierFilter = std::forward<ParentControllerIdentifierFilterT>(value);
  }
  template <typename ParentControllerIdentifierFilterT = Aws::String>
  ListManagedThingsRequest& WithParentControllerIdentifierFilter(ParentControllerIdentifierFilterT&& value) {
    SetParentControllerIdentifierFilter(std::forward<ParentControllerIdentifierFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectorDestinationIdFilter(ConnectorDestinationIdFilterT&& value) {
    m_connectorDestinationIdFilterHasBeenSet = true;
    m_connectorDestinationIdFilter = std::forward<ConnectorDestinationIdFilterT>(value);
  }
  template <typename ConnectorDestinationIdFilterT = Aws::String>
  ListManagedThingsRequest& WithConnectorDestinationIdFilter(ConnectorDestinationIdFilterT&& value) {
    SetConnectorDestinationIdFilter(std::forward<ConnectorDestinationIdFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectorDeviceIdFilter(ConnectorDeviceIdFilterT&& value) {
    m_connectorDeviceIdFilterHasBeenSet = true;
    m_connectorDeviceIdFilter = std::forward<ConnectorDeviceIdFilterT>(value);
  }
  template <typename ConnectorDeviceIdFilterT = Aws::String>
  ListManagedThingsRequest& WithConnectorDeviceIdFilter(ConnectorDeviceIdFilterT&& value) {
    SetConnectorDeviceIdFilter(std::forward<ConnectorDeviceIdFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSerialNumberFilter(SerialNumberFilterT&& value) {
    m_serialNumberFilterHasBeenSet = true;
    m_serialNumberFilter = std::forward<SerialNumberFilterT>(value);
  }
  template <typename SerialNumberFilterT = Aws::String>
  ListManagedThingsRequest& WithSerialNumberFilter(SerialNumberFilterT&& value) {
    SetSerialNumberFilter(std::forward<SerialNumberFilterT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProvisioningStatusFilter(ProvisioningStatus value) {
    m_provisioningStatusFilterHasBeenSet = true;
    m_provisioningStatusFilter = value;
  }
  inline ListManagedThingsRequest& WithProvisioningStatusFilter(ProvisioningStatus value) {
  ...
  inline ListManagedThingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
