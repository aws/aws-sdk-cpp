...
class GetManagedThingMetaDataResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API GetManagedThingMetaDataResult& operator=(
  ...
  template <typename ManagedThingIdT = Aws::String>
  GetManagedThingMetaDataResult& WithManagedThingId(ManagedThingIdT&& value) {
  ...
  template <typename MetaDataT = Aws::Map<Aws::String, Aws::String>>
  GetManagedThingMetaDataResult& WithMetaData(MetaDataT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetManagedThingMetaDataResult& WithRequestId(RequestIdT&& value) {
