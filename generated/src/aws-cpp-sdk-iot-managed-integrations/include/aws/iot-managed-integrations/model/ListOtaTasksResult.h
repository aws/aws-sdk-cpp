...
class ListOtaTasksResult {
 public:
  ...
  template <typename TasksT = Aws::Vector<OtaTaskSummary>>
  ListOtaTasksResult& WithTasks(TasksT&& value) {
    SetTasks(std::forward<TasksT>(value));
    return *this;
  }
  template <typename TasksT = OtaTaskSummary>
  ListOtaTasksResult& AddTasks(TasksT&& value) {
    m_tasksHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListOtaTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOtaTasksResult& WithRequestId(RequestIdT&& value) {
