...
class DeviceDiscoverySummary {
 public:
  ...
  template <typename IdT = Aws::String>
  DeviceDiscoverySummary& WithId(IdT&& value) {
  ...
  inline DeviceDiscoverySummary& WithDiscoveryType(DiscoveryType value) {
  ...
  inline DeviceDiscoverySummary& WithStatus(DeviceDiscoveryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
