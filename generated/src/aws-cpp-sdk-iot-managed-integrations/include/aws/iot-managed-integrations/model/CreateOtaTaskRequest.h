...
class CreateOtaTaskRequest : public IoTManagedIntegrationsRequest {
 public:
  ...
  inline CreateOtaTaskRequest& WithProtocol(OtaProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline CreateOtaTaskRequest& WithOtaMechanism(OtaMechanism value) {
  ...
  inline CreateOtaTaskRequest& WithOtaType(OtaType value) {
    SetOtaType(value);
    return *this;
  }
  ///@}
