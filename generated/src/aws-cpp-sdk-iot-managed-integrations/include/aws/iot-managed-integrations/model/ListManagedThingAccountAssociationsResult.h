...
class ListManagedThingAccountAssociationsResult {
 public:
  ...
  AWS_IOTMANAGEDINTEGRATIONS_API ListManagedThingAccountAssociationsResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_IOTMANAGEDINTEGRATIONS_API ListManagedThingAccountAssociationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ItemsT = Aws::Vector<ManagedThingAssociation>>
  ListManagedThingAccountAssociationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ManagedThingAssociation>
  ListManagedThingAccountAssociationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedThingAccountAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedThingAccountAssociationsResult& WithRequestId(RequestIdT&& value) {
