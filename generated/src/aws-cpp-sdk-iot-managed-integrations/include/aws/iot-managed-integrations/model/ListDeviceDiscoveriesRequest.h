...
class ListDeviceDiscoveriesRequest : public IoTManagedIntegrationsRequest {
 public:
  ...
  inline ListDeviceDiscoveriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTypeFilter(DiscoveryType value) {
    m_typeFilterHasBeenSet = true;
    m_typeFilter = value;
  }
  inline ListDeviceDiscoveriesRequest& WithTypeFilter(DiscoveryType value) {
    SetTypeFilter(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusFilter(DeviceDiscoveryStatus value) {
    m_statusFilterHasBeenSet = true;
    m_statusFilter = value;
  }
  inline ListDeviceDiscoveriesRequest& WithStatusFilter(DeviceDiscoveryStatus value) {
