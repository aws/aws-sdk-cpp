...
class UpdateOtaTaskRequest : public IoTManagedIntegrationsRequest {
 public:
  ...
  template <typename IdentifierT = Aws::String>
  UpdateOtaTaskRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateOtaTaskRequest& WithDescription(DescriptionT&& value) {
  ...
  void SetTaskConfigurationId(TaskConfigurationIdT&& value) {
    ...
    m_taskConfigurationId = std::forward<TaskConfigurationIdT>(value);
  }
  template <typename TaskConfigurationIdT = Aws::String>
  UpdateOtaTaskRequest& WithTaskConfigurationId(TaskConfigurationIdT&& value) {
    SetTaskConfigurationId(std::forward<TaskConfigurationIdT>(value));
    return *this;
  }
  ///@}
 private:
