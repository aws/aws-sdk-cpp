...
typedef Aws::Utils::Outcome<ListManagedThingAccountAssociationsResult, IoTManagedIntegrationsError>
...
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateAccountAssociationRequest&,
                           const Model::CreateAccountAssociationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateAccountAssociationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateCloudConnectorRequest&,
                           const Model::CreateCloudConnectorOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateCloudConnectorResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateConnectorDestinationRequest&,
                           const Model::CreateConnectorDestinationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateConnectorDestinationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateCredentialLockerRequest&,
                           const Model::CreateCredentialLockerOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateCredentialLockerResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateDestinationRequest&,
                           const Model::CreateDestinationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateDestinationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateEventLogConfigurationRequest&,
                           const Model::CreateEventLogConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateEventLogConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateManagedThingRequest&,
                           const Model::CreateManagedThingOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateManagedThingResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateNotificationConfigurationRequest&,
                           const Model::CreateNotificationConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateNotificationConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateOtaTaskRequest&, const Model::CreateOtaTaskOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateOtaTaskResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateOtaTaskConfigurationRequest&,
                           const Model::CreateOtaTaskConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateOtaTaskConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::CreateProvisioningProfileRequest&,
                           const Model::CreateProvisioningProfileOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateProvisioningProfileResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteAccountAssociationRequest&,
                           const Model::DeleteAccountAssociationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteAccountAssociationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteCloudConnectorRequest&,
                           const Model::DeleteCloudConnectorOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteCloudConnectorResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteConnectorDestinationRequest&,
                           const Model::DeleteConnectorDestinationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteConnectorDestinationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteCredentialLockerRequest&,
                           const Model::DeleteCredentialLockerOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteCredentialLockerResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteDestinationRequest&,
                           const Model::DeleteDestinationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteDestinationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteEventLogConfigurationRequest&,
                           const Model::DeleteEventLogConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteEventLogConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteManagedThingRequest&,
                           const Model::DeleteManagedThingOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteManagedThingResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteNotificationConfigurationRequest&,
                           const Model::DeleteNotificationConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteNotificationConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteOtaTaskRequest&, const Model::DeleteOtaTaskOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteOtaTaskResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteOtaTaskConfigurationRequest&,
                           const Model::DeleteOtaTaskConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteOtaTaskConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeleteProvisioningProfileRequest&,
                           const Model::DeleteProvisioningProfileOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteProvisioningProfileResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::DeregisterAccountAssociationRequest&,
                           const Model::DeregisterAccountAssociationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeregisterAccountAssociationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetAccountAssociationRequest&,
                           const Model::GetAccountAssociationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetAccountAssociationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetCloudConnectorRequest&,
                           const Model::GetCloudConnectorOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetCloudConnectorResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetConnectorDestinationRequest&,
                           const Model::GetConnectorDestinationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetConnectorDestinationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetCredentialLockerRequest&,
                           const Model::GetCredentialLockerOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetCredentialLockerResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetCustomEndpointRequest&,
                           const Model::GetCustomEndpointOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetCustomEndpointResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetDefaultEncryptionConfigurationRequest&,
                           const Model::GetDefaultEncryptionConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetDefaultEncryptionConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetDestinationRequest&, const Model::GetDestinationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetDestinationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetDeviceDiscoveryRequest&,
                           const Model::GetDeviceDiscoveryOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetDeviceDiscoveryResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetEventLogConfigurationRequest&,
                           const Model::GetEventLogConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetEventLogConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetHubConfigurationRequest&,
                           const Model::GetHubConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetHubConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetManagedThingRequest&, const Model::GetManagedThingOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetManagedThingResponseReceivedHandler;
...
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetManagedThingConnectivityDataRequest&,
                           ...
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetManagedThingConnectivityDataResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetManagedThingMetaDataRequest&,
                           const Model::GetManagedThingMetaDataOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetManagedThingMetaDataResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetManagedThingStateRequest&,
                           const Model::GetManagedThingStateOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetManagedThingStateResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetNotificationConfigurationRequest&,
                           const Model::GetNotificationConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetNotificationConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetOtaTaskRequest&, const Model::GetOtaTaskOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetOtaTaskResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetOtaTaskConfigurationRequest&,
                           const Model::GetOtaTaskConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetOtaTaskConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetProvisioningProfileRequest&,
                           const Model::GetProvisioningProfileOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetProvisioningProfileResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetRuntimeLogConfigurationRequest&,
                           const Model::GetRuntimeLogConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetRuntimeLogConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::GetSchemaVersionRequest&,
                           const Model::GetSchemaVersionOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetSchemaVersionResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListAccountAssociationsRequest&,
...
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListCloudConnectorsRequest&,
                           const Model::ListCloudConnectorsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListCloudConnectorsResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListConnectorDestinationsRequest&,
                           const Model::ListConnectorDestinationsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListConnectorDestinationsResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListCredentialLockersRequest&,
                           const Model::ListCredentialLockersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListCredentialLockersResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListDestinationsRequest&,
                           const Model::ListDestinationsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListDestinationsResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListDeviceDiscoveriesRequest&,
                           const Model::ListDeviceDiscoveriesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListDeviceDiscoveriesResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListDiscoveredDevicesRequest&,
                           const Model::ListDiscoveredDevicesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListDiscoveredDevicesResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListEventLogConfigurationsRequest&,
                           const Model::ListEventLogConfigurationsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListEventLogConfigurationsResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListManagedThingAccountAssociationsRequest&,
                           const Model::ListManagedThingAccountAssociationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListManagedThingAccountAssociationsResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListManagedThingSchemasRequest&,
                           const Model::ListManagedThingSchemasOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListManagedThingSchemasResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListManagedThingsRequest&,
                           const Model::ListManagedThingsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListManagedThingsResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListNotificationConfigurationsRequest&,
                           const Model::ListNotificationConfigurationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListNotificationConfigurationsResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListOtaTaskConfigurationsRequest&,
                           const Model::ListOtaTaskConfigurationsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListOtaTaskConfigurationsResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListOtaTaskExecutionsRequest&,
                           const Model::ListOtaTaskExecutionsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListOtaTaskExecutionsResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListOtaTasksRequest&, const Model::ListOtaTasksOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListOtaTasksResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListProvisioningProfilesRequest&,
                           const Model::ListProvisioningProfilesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListProvisioningProfilesResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListSchemaVersionsRequest&,
                           const Model::ListSchemaVersionsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListSchemaVersionsResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ListTagsForResourceRequest&,
                           const Model::ListTagsForResourceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::PutDefaultEncryptionConfigurationRequest&,
                           const Model::PutDefaultEncryptionConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutDefaultEncryptionConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::PutHubConfigurationRequest&,
                           const Model::PutHubConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutHubConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::PutRuntimeLogConfigurationRequest&,
                           const Model::PutRuntimeLogConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutRuntimeLogConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::RegisterAccountAssociationRequest&,
                           const Model::RegisterAccountAssociationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    RegisterAccountAssociationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::RegisterCustomEndpointRequest&,
                           const Model::RegisterCustomEndpointOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    RegisterCustomEndpointResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::ResetRuntimeLogConfigurationRequest&,
                           const Model::ResetRuntimeLogConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ResetRuntimeLogConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::SendConnectorEventRequest&,
                           const Model::SendConnectorEventOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    SendConnectorEventResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::SendManagedThingCommandRequest&,
                           const Model::SendManagedThingCommandOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    SendManagedThingCommandResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::StartAccountAssociationRefreshRequest&,
                           const Model::StartAccountAssociationRefreshOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartAccountAssociationRefreshResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::StartDeviceDiscoveryRequest&,
                           const Model::StartDeviceDiscoveryOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartDeviceDiscoveryResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::UpdateAccountAssociationRequest&,
                           const Model::UpdateAccountAssociationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateAccountAssociationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::UpdateCloudConnectorRequest&,
                           const Model::UpdateCloudConnectorOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateCloudConnectorResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::UpdateConnectorDestinationRequest&,
                           const Model::UpdateConnectorDestinationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateConnectorDestinationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::UpdateDestinationRequest&,
                           const Model::UpdateDestinationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateDestinationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::UpdateEventLogConfigurationRequest&,
                           const Model::UpdateEventLogConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateEventLogConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::UpdateManagedThingRequest&,
                           const Model::UpdateManagedThingOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateManagedThingResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::UpdateNotificationConfigurationRequest&,
                           const Model::UpdateNotificationConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateNotificationConfigurationResponseReceivedHandler;
typedef std::function<void(const IoTManagedIntegrationsClient*, const Model::UpdateOtaTaskRequest&, const Model::UpdateOtaTaskOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateOtaTaskResponseReceivedHandler;
