...
ListEventLogConfigurationsResult::ListEventLogConfigurationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListEventLogConfigurationsResult& ListEventLogConfigurationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("EventLogConfigurationList")) {
    ...
    for (unsigned eventLogConfigurationListIndex = 0; eventLogConfigurationListIndex < eventLogConfigurationListJsonList.GetLength();
         ++eventLogConfigurationListIndex) {
