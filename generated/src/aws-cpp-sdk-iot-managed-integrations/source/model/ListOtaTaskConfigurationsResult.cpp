...
ListOtaTaskConfigurationsResult::ListOtaTaskConfigurationsResult()
{
}

ListOtaTaskConfigurationsResult::ListOtaTaskConfigurationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
