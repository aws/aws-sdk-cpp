...
OtaTaskAbortConfig::OtaTaskAbortConfig(JsonView jsonValue) { *this = jsonValue; }
...
OtaTaskAbortConfig& OtaTaskAbortConfig::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("AbortConfigCriteriaList")) {
    ...
    for (unsigned abortConfigCriteriaListIndex = 0; abortConfigCriteriaListIndex < abortConfigCriteriaListJsonList.GetLength();
         ++abortConfigCriteriaListIndex) {
...
JsonValue OtaTaskAbortConfig::Jsonize() const {
  ...
  if (m_abortConfigCriteriaListHasBeenSet) {
    ...
    for (unsigned abortConfigCriteriaListIndex = 0; abortConfigCriteriaListIndex < abortConfigCriteriaListJsonList.GetLength();
         ++abortConfigCriteriaListIndex) {
      abortConfigCriteriaListJsonList[abortConfigCriteriaListIndex].AsObject(
          m_abortConfigCriteriaList[abortConfigCriteriaListIndex].Jsonize());
    }
