...
OAuthConfig::OAuthConfig(JsonView jsonValue) { *this = jsonValue; }
...
OAuthConfig& OAuthConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("tokenEndpointAuthenticationScheme")) {
    m_tokenEndpointAuthenticationScheme = TokenEndpointAuthenticationSchemeMapper::GetTokenEndpointAuthenticationSchemeForName(
        jsonValue.GetString("tokenEndpointAuthenticationScheme"));
...
JsonValue OAuthConfig::Jsonize() const {
  ...
  if (m_tokenEndpointAuthenticationSchemeHasBeenSet) {
    payload.WithString(
        ...
        TokenEndpointAuthenticationSchemeMapper::GetNameForTokenEndpointAuthenticationScheme(m_tokenEndpointAuthenticationScheme));
  }
