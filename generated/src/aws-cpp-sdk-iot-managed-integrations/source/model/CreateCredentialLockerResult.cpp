...
CreateCredentialLockerResult::CreateCredentialLockerResult()
{
}

CreateCredentialLockerResult::CreateCredentialLockerResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
