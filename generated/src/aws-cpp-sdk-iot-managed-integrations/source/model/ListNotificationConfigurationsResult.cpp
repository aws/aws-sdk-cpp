...
ListNotificationConfigurationsResult& ListNotificationConfigurationsResult::operator=(
  ...
  if (jsonValue.ValueExists("NotificationConfigurationList")) {
    ...
    for (unsigned notificationConfigurationListIndex = 0;
         notificationConfigurationListIndex < notificationConfigurationListJsonList.GetLength(); ++notificationConfigurationListIndex) {
