...
ListOtaTasksResult::ListOtaTasksResult()
{
}

ListOtaTasksResult::ListOtaTasksResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListOtaTasksResult& ListOtaTasksResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
