...
OtaTaskExecutionRetryConfig::OtaTaskExecutionRetryConfig(JsonView jsonValue) { *this = jsonValue; }
...
OtaTaskExecutionRetryConfig& OtaTaskExecutionRetryConfig::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("RetryConfigCriteria")) {
    ...
    for (unsigned retryConfigCriteriaIndex = 0; retryConfigCriteriaIndex < retryConfigCriteriaJsonList.GetLength();
         ++retryConfigCriteriaIndex) {
