...
ListDestinationsResult::ListDestinationsResult()
{
}

ListDestinationsResult::ListDestinationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListDestinationsResult& ListDestinationsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
