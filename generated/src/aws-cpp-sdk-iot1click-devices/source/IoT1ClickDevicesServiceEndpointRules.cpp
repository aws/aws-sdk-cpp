...
{
const size_t IoT1ClickDevicesServiceEndpointRules::RulesBlobStrLen = 3516;
const size_t IoT1ClickDevicesServiceEndpointRules::RulesBlobSize = 3517;

using RulesBlobT = Aws::Array<const char, IoT1ClickDevicesServiceEndpointRules::RulesBlobSize>;
...
'v','i','c','e','s','.','i','o','t','1','c','l','i','c','k','-','f','i','p','s','.','{','R','e','g',
...
':','/','/','d','e','v','i','c','e','s','.','i','o','t','1','c','l','i','c','k','.','{','R','e','g',
...
const char* IoT1ClickDevicesServiceEndpointRules::GetRulesBlob()
{
