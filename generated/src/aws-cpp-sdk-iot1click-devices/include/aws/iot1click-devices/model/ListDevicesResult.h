...
namespace Model
{
  ...
  {
  public:
    AWS_IOT1CLICKDEVICESSERVICE_API ListDevicesResult() = default;
    ...
    template<typename DevicesT = Aws::Vector<DeviceDescription>>
    ...
    template<typename DevicesT = DeviceDescription>
