...
namespace Model
{
  ...
  public:
    ...
    inline InitiateDeviceClaimResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline InitiateDeviceClaimResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline InitiateDeviceClaimResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
