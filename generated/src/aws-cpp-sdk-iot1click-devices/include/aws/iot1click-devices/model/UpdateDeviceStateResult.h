...
namespace Model
{
  ...
  public:
    ...
    inline UpdateDeviceStateResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateDeviceStateResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateDeviceStateResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
