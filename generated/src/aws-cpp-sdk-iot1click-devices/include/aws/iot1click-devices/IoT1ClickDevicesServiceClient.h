...
namespace IoT1ClickDevicesService
{
 ...
 protocols.</p>
   */
  class AWS_IOT1CLICKDEVICESSERVICE_API IoT1ClickDevicesServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<IoT1ClickDevicesServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::IoT1ClickDevicesService::SERVICE_NAME,
