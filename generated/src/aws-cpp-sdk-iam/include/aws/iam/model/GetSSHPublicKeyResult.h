...
class GetSSHPublicKeyResult {
 public:
  ...
  void SetSSHPublicKey(SSHPublicKeyT&& value) {
    ...
    m_sSHPublicKey = std::forward<SSHPublicKeyT>(value);
  }
  template <typename SSHPublicKeyT = SSHPublicKey>
  GetSSHPublicKeyResult& WithSSHPublicKey(SSHPublicKeyT&& value) {
    SetSSHPublicKey(std::forward<SSHPublicKeyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetSSHPublicKeyResult& WithResponseMetadata(ResponseMetadataT&& value) {
