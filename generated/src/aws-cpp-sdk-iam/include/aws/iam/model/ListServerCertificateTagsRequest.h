...
class ListServerCertificateTagsRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename ServerCertificateNameT = Aws::String>
  ListServerCertificateTagsRequest& WithServerCertificateName(ServerCertificateNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListServerCertificateTagsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListServerCertificateTagsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
