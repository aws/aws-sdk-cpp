...
class ListPoliciesResult {
 public:
  ...
  inline ListPoliciesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListPoliciesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListPoliciesResult& WithResponseMetadata(ResponseMetadataT&& value) {
