...
class ListSigningCertificatesResult {
 public:
  ...
  template <typename CertificatesT = Aws::Vector<SigningCertificate>>
  ListSigningCertificatesResult& WithCertificates(CertificatesT&& value) {
    SetCertificates(std::forward<CertificatesT>(value));
    return *this;
  }
  template <typename CertificatesT = SigningCertificate>
  ListSigningCertificatesResult& AddCertificates(CertificatesT&& value) {
    m_certificatesHasBeenSet = true;
  ...
  inline ListSigningCertificatesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListSigningCertificatesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListSigningCertificatesResult& WithResponseMetadata(ResponseMetadataT&& value) {
