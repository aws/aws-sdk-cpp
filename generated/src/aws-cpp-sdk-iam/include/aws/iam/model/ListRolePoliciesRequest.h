...
class ListRolePoliciesRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename RoleNameT = Aws::String>
  ListRolePoliciesRequest& WithRoleName(RoleNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListRolePoliciesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListRolePoliciesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
