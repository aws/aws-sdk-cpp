...
namespace Model
{
  ...
  public:
    ...
    template<typename PathPrefixT = Aws::String>
    ListGroupsRequest& WithPathPrefix(PathPrefixT&& value) { SetPathPrefix(std::forward<PathPrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListGroupsRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
