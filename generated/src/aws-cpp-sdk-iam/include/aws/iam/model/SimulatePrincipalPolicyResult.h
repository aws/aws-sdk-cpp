...
class SimulatePrincipalPolicyResult {
 public:
  ...
  template <typename EvaluationResultsT = Aws::Vector<EvaluationResult>>
  SimulatePrincipalPolicyResult& WithEvaluationResults(EvaluationResultsT&& value) {
    SetEvaluationResults(std::forward<EvaluationResultsT>(value));
    return *this;
  }
  template <typename EvaluationResultsT = EvaluationResult>
  SimulatePrincipalPolicyResult& AddEvaluationResults(EvaluationResultsT&& value) {
    m_evaluationResultsHasBeenSet = true;
  ...
  inline SimulatePrincipalPolicyResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  SimulatePrincipalPolicyResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SimulatePrincipalPolicyResult& WithResponseMetadata(ResponseMetadataT&& value) {
