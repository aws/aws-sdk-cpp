...
class ListPolicyVersionsRequest : public IAMRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListPolicyVersions"; }
 ...
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  ListPolicyVersionsRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListPolicyVersionsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListPolicyVersionsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
