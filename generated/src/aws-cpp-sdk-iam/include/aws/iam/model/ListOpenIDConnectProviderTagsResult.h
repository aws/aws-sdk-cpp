...
class ListOpenIDConnectProviderTagsResult {
 public:
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ListOpenIDConnectProviderTagsResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ListOpenIDConnectProviderTagsResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline ListOpenIDConnectProviderTagsResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListOpenIDConnectProviderTagsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListOpenIDConnectProviderTagsResult& WithResponseMetadata(ResponseMetadataT&& value) {
