...
class ListAttachedGroupPoliciesRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename GroupNameT = Aws::String>
  ListAttachedGroupPoliciesRequest& WithGroupName(GroupNameT&& value) {
  ...
  template <typename PathPrefixT = Aws::String>
  ListAttachedGroupPoliciesRequest& WithPathPrefix(PathPrefixT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListAttachedGroupPoliciesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListAttachedGroupPoliciesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
