...
class DeletePolicyVersionRequest : public IAMRequest {
 public:
  AWS_IAM_API DeletePolicyVersionRequest() = default;
 ...
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  DeletePolicyVersionRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  DeletePolicyVersionRequest& WithVersionId(VersionIdT&& value) {
