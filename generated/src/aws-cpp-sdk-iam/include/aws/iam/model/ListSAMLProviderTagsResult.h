...
class ListSAMLProviderTagsResult {
 public:
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ListSAMLProviderTagsResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ListSAMLProviderTagsResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline ListSAMLProviderTagsResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListSAMLProviderTagsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListSAMLProviderTagsResult& WithResponseMetadata(ResponseMetadataT&& value) {
