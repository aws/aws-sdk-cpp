...
class TagSAMLProviderRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename SAMLProviderArnT = Aws::String>
  TagSAMLProviderRequest& WithSAMLProviderArn(SAMLProviderArnT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  TagSAMLProviderRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  TagSAMLProviderRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
