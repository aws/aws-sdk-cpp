...
class ListAttachedRolePoliciesRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename RoleNameT = Aws::String>
  ListAttachedRolePoliciesRequest& WithRoleName(RoleNameT&& value) {
  ...
  template <typename PathPrefixT = Aws::String>
  ListAttachedRolePoliciesRequest& WithPathPrefix(PathPrefixT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListAttachedRolePoliciesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListAttachedRolePoliciesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
