...
class ListAttachedGroupPoliciesResult {
 public:
  ...
  void SetAttachedPolicies(AttachedPoliciesT&& value) {
    m_attachedPoliciesHasBeenSet = true;
    m_attachedPolicies = std::forward<AttachedPoliciesT>(value);
  }
  template <typename AttachedPoliciesT = Aws::Vector<AttachedPolicy>>
  ListAttachedGroupPoliciesResult& WithAttachedPolicies(AttachedPoliciesT&& value) {
    SetAttachedPolicies(std::forward<AttachedPoliciesT>(value));
    return *this;
  }
  template <typename AttachedPoliciesT = AttachedPolicy>
  ListAttachedGroupPoliciesResult& AddAttachedPolicies(AttachedPoliciesT&& value) {
    m_attachedPoliciesHasBeenSet = true;
    m_attachedPolicies.emplace_back(std::forward<AttachedPoliciesT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListAttachedGroupPoliciesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListAttachedGroupPoliciesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListAttachedGroupPoliciesResult& WithResponseMetadata(ResponseMetadataT&& value) {
