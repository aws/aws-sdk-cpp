...
class ListRolePoliciesResult {
 public:
  ...
  template <typename PolicyNamesT = Aws::Vector<Aws::String>>
  ListRolePoliciesResult& WithPolicyNames(PolicyNamesT&& value) {
    SetPolicyNames(std::forward<PolicyNamesT>(value));
    return *this;
  }
  template <typename PolicyNamesT = Aws::String>
  ListRolePoliciesResult& AddPolicyNames(PolicyNamesT&& value) {
    m_policyNamesHasBeenSet = true;
  ...
  inline ListRolePoliciesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListRolePoliciesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListRolePoliciesResult& WithResponseMetadata(ResponseMetadataT&& value) {
