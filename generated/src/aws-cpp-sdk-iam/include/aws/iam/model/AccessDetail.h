...
class AccessDetail {
 public:
  ...
  void SetLastAuthenticatedTime(LastAuthenticatedTimeT&& value) {
    ...
    m_lastAuthenticatedTime = std::forward<LastAuthenticatedTimeT>(value);
  }
  template <typename LastAuthenticatedTimeT = Aws::Utils::DateTime>
  AccessDetail& WithLastAuthenticatedTime(LastAuthenticatedTimeT&& value) {
    SetLastAuthenticatedTime(std::forward<LastAuthenticatedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline AccessDetail& WithTotalAuthenticatedEntities(int value) {
