...
namespace Model
{
  ...
  public:
    ...
    template<typename PolicyArnT = Aws::String>
    ListPolicyTagsRequest& WithPolicyArn(PolicyArnT&& value) { SetPolicyArn(std::forward<PolicyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListPolicyTagsRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
