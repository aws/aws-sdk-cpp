...
/**
 */
class ListPolicyTagsRequest : public IAMRequest {
 public:
  AWS_IAM_API ListPolicyTagsRequest() = default;
 ...
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  ListPolicyTagsRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListPolicyTagsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListPolicyTagsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
