...
class ListRolesResult {
 public:
  ...
  template <typename RolesT = Aws::Vector<Role>>
  ListRolesResult& WithRoles(RolesT&& value) {
    SetRoles(std::forward<RolesT>(value));
    return *this;
  }
  template <typename RolesT = Role>
  ListRolesResult& AddRoles(RolesT&& value) {
    m_rolesHasBeenSet = true;
  ...
  inline ListRolesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListRolesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListRolesResult& WithResponseMetadata(ResponseMetadataT&& value) {
