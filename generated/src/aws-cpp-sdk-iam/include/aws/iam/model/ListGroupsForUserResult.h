...
namespace Model
{
  ...
  {
  public:
    AWS_IAM_API ListGroupsForUserResult() = default;
    ...
    template<typename GroupsT = Aws::Vector<Group>>
    ListGroupsForUserResult& WithGroups(GroupsT&& value) { SetGroups(std::forward<GroupsT>(value)); return *this;}
    template<typename GroupsT = Group>
    ListGroupsForUserResult& AddGroups(GroupsT&& value) { m_groupsHasBeenSet = true; m_groups.emplace_back(std::forward<GroupsT>(value)); return *this; }
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListGroupsForUserResult& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ListGroupsForUserResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
