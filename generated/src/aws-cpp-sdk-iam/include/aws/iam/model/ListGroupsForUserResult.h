...
class ListGroupsForUserResult {
 public:
  ...
  template <typename GroupsT = Aws::Vector<Group>>
  ListGroupsForUserResult& WithGroups(GroupsT&& value) {
    SetGroups(std::forward<GroupsT>(value));
    return *this;
  }
  template <typename GroupsT = Group>
  ListGroupsForUserResult& AddGroups(GroupsT&& value) {
    m_groupsHasBeenSet = true;
  ...
  inline ListGroupsForUserResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListGroupsForUserResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListGroupsForUserResult& WithResponseMetadata(ResponseMetadataT&& value) {
