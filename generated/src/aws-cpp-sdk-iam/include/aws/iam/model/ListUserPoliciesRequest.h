...
class ListUserPoliciesRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename UserNameT = Aws::String>
  ListUserPoliciesRequest& WithUserName(UserNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListUserPoliciesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListUserPoliciesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
