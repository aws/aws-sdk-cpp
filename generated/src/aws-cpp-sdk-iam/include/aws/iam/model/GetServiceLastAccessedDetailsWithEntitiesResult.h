...
class GetServiceLastAccessedDetailsWithEntitiesResult {
 public:
  ...
  AWS_IAM_API GetServiceLastAccessedDetailsWithEntitiesResult& operator=(
  ...
  inline void SetJobStatus(JobStatusType value) {
    m_jobStatusHasBeenSet = true;
    m_jobStatus = value;
  }
  inline GetServiceLastAccessedDetailsWithEntitiesResult& WithJobStatus(JobStatusType value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetJobCreationDate(JobCreationDateT&& value) {
    ...
    m_jobCreationDate = std::forward<JobCreationDateT>(value);
  }
  template <typename JobCreationDateT = Aws::Utils::DateTime>
  GetServiceLastAccessedDetailsWithEntitiesResult& WithJobCreationDate(JobCreationDateT&& value) {
    SetJobCreationDate(std::forward<JobCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobCompletionDate(JobCompletionDateT&& value) {
    m_jobCompletionDateHasBeenSet = true;
    m_jobCompletionDate = std::forward<JobCompletionDateT>(value);
  }
  template <typename JobCompletionDateT = Aws::Utils::DateTime>
  GetServiceLastAccessedDetailsWithEntitiesResult& WithJobCompletionDate(JobCompletionDateT&& value) {
    SetJobCompletionDate(std::forward<JobCompletionDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEntityDetailsList(EntityDetailsListT&& value) {
    m_entityDetailsListHasBeenSet = true;
    m_entityDetailsList = std::forward<EntityDetailsListT>(value);
  }
  template <typename EntityDetailsListT = Aws::Vector<EntityDetails>>
  GetServiceLastAccessedDetailsWithEntitiesResult& WithEntityDetailsList(EntityDetailsListT&& value) {
    SetEntityDetailsList(std::forward<EntityDetailsListT>(value));
    return *this;
  }
  template <typename EntityDetailsListT = EntityDetails>
  GetServiceLastAccessedDetailsWithEntitiesResult& AddEntityDetailsList(EntityDetailsListT&& value) {
    m_entityDetailsListHasBeenSet = true;
    m_entityDetailsList.emplace_back(std::forward<EntityDetailsListT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetServiceLastAccessedDetailsWithEntitiesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  GetServiceLastAccessedDetailsWithEntitiesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ErrorT = ErrorDetails>
  GetServiceLastAccessedDetailsWithEntitiesResult& WithError(ErrorT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetServiceLastAccessedDetailsWithEntitiesResult& WithResponseMetadata(ResponseMetadataT&& value) {
