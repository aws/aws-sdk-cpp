...
class CreateLoginProfileResult {
 public:
  ...
  void SetLoginProfile(LoginProfileT&& value) {
    m_loginProfileHasBeenSet = true;
    m_loginProfile = std::forward<LoginProfileT>(value);
  }
  template <typename LoginProfileT = LoginProfile>
  CreateLoginProfileResult& WithLoginProfile(LoginProfileT&& value) {
    SetLoginProfile(std::forward<LoginProfileT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateLoginProfileResult& WithResponseMetadata(ResponseMetadataT&& value) {
