...
class ListSigningCertificatesRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename UserNameT = Aws::String>
  ListSigningCertificatesRequest& WithUserName(UserNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListSigningCertificatesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListSigningCertificatesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
