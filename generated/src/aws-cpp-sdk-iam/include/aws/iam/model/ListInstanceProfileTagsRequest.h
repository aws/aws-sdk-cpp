...
/**
 */
class ListInstanceProfileTagsRequest : public IAMRequest {
 public:
  AWS_IAM_API ListInstanceProfileTagsRequest() = default;
 ...
 public:
  ...
  template <typename InstanceProfileNameT = Aws::String>
  ListInstanceProfileTagsRequest& WithInstanceProfileName(InstanceProfileNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListInstanceProfileTagsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListInstanceProfileTagsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
