...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceProfileNameT = Aws::String>
    RemoveRoleFromInstanceProfileRequest& WithInstanceProfileName(InstanceProfileNameT&& value) { SetInstanceProfileName(std::forward<InstanceProfileNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleNameT = Aws::String>
    RemoveRoleFromInstanceProfileRequest& WithRoleName(RoleNameT&& value) { SetRoleName(std::forward<RoleNameT>(value)); return *this;}
    ///@}
  private:
