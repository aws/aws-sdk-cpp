...
class ListVirtualMFADevicesResult {
 public:
  ...
  void SetVirtualMFADevices(VirtualMFADevicesT&& value) {
    m_virtualMFADevicesHasBeenSet = true;
    m_virtualMFADevices = std::forward<VirtualMFADevicesT>(value);
  }
  template <typename VirtualMFADevicesT = Aws::Vector<VirtualMFADevice>>
  ListVirtualMFADevicesResult& WithVirtualMFADevices(VirtualMFADevicesT&& value) {
    SetVirtualMFADevices(std::forward<VirtualMFADevicesT>(value));
    return *this;
  }
  template <typename VirtualMFADevicesT = VirtualMFADevice>
  ListVirtualMFADevicesResult& AddVirtualMFADevices(VirtualMFADevicesT&& value) {
    m_virtualMFADevicesHasBeenSet = true;
    m_virtualMFADevices.emplace_back(std::forward<VirtualMFADevicesT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListVirtualMFADevicesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListVirtualMFADevicesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListVirtualMFADevicesResult& WithResponseMetadata(ResponseMetadataT&& value) {
