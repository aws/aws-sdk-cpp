...
class UpdateUserRequest : public IAMRequest {
 ...
 public:
  ...
  void SetNewPath(NewPathT&& value) {
    m_newPathHasBeenSet = true;
    m_newPath = std::forward<NewPathT>(value);
  }
  template <typename NewPathT = Aws::String>
  UpdateUserRequest& WithNewPath(NewPathT&& value) {
    SetNewPath(std::forward<NewPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewUserName(NewUserNameT&& value) {
    m_newUserNameHasBeenSet = true;
    m_newUserName = std::forward<NewUserNameT>(value);
  }
  template <typename NewUserNameT = Aws::String>
  UpdateUserRequest& WithNewUserName(NewUserNameT&& value) {
    SetNewUserName(std::forward<NewUserNameT>(value));
    return *this;
  }
  ///@}
 private:
