...
class ListAccessKeysResult {
 public:
  ...
  void SetAccessKeyMetadata(AccessKeyMetadataT&& value) {
    m_accessKeyMetadataHasBeenSet = true;
    m_accessKeyMetadata = std::forward<AccessKeyMetadataT>(value);
  }
  template <typename AccessKeyMetadataT = Aws::Vector<AccessKeyMetadata>>
  ListAccessKeysResult& WithAccessKeyMetadata(AccessKeyMetadataT&& value) {
    SetAccessKeyMetadata(std::forward<AccessKeyMetadataT>(value));
    return *this;
  }
  template <typename AccessKeyMetadataT = AccessKeyMetadata>
  ListAccessKeysResult& AddAccessKeyMetadata(AccessKeyMetadataT&& value) {
    m_accessKeyMetadataHasBeenSet = true;
    m_accessKeyMetadata.emplace_back(std::forward<AccessKeyMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListAccessKeysResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListAccessKeysResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListAccessKeysResult& WithResponseMetadata(ResponseMetadataT&& value) {
