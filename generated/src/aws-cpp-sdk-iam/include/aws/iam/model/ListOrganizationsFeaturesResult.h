...
class ListOrganizationsFeaturesResult {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  ListOrganizationsFeaturesResult& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename EnabledFeaturesT = Aws::Vector<FeatureType>>
  ListOrganizationsFeaturesResult& WithEnabledFeatures(EnabledFeaturesT&& value) {
    SetEnabledFeatures(std::forward<EnabledFeaturesT>(value));
    return *this;
  }
  inline ListOrganizationsFeaturesResult& AddEnabledFeatures(FeatureType value) {
    m_enabledFeaturesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListOrganizationsFeaturesResult& WithResponseMetadata(ResponseMetadataT&& value) {
