...
class ListPoliciesGrantingServiceAccessResult {
 public:
   ...
   * or role).</p>
   */
  inline const Aws::Vector<ListPoliciesGrantingServiceAccessEntry>& GetPoliciesGrantingServiceAccess() const {
    return m_policiesGrantingServiceAccess;
  }
  template <typename PoliciesGrantingServiceAccessT = Aws::Vector<ListPoliciesGrantingServiceAccessEntry>>
  void SetPoliciesGrantingServiceAccess(PoliciesGrantingServiceAccessT&& value) {
    m_policiesGrantingServiceAccessHasBeenSet = true;
    m_policiesGrantingServiceAccess = std::forward<PoliciesGrantingServiceAccessT>(value);
  }
  template <typename PoliciesGrantingServiceAccessT = Aws::Vector<ListPoliciesGrantingServiceAccessEntry>>
  ListPoliciesGrantingServiceAccessResult& WithPoliciesGrantingServiceAccess(PoliciesGrantingServiceAccessT&& value) {
    SetPoliciesGrantingServiceAccess(std::forward<PoliciesGrantingServiceAccessT>(value));
    return *this;
  }
  template <typename PoliciesGrantingServiceAccessT = ListPoliciesGrantingServiceAccessEntry>
  ListPoliciesGrantingServiceAccessResult& AddPoliciesGrantingServiceAccess(PoliciesGrantingServiceAccessT&& value) {
    m_policiesGrantingServiceAccessHasBeenSet = true;
    m_policiesGrantingServiceAccess.emplace_back(std::forward<PoliciesGrantingServiceAccessT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListPoliciesGrantingServiceAccessResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListPoliciesGrantingServiceAccessResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListPoliciesGrantingServiceAccessResult& WithResponseMetadata(ResponseMetadataT&& value) {
