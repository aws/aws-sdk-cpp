...
class TagServerCertificateRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename ServerCertificateNameT = Aws::String>
  TagServerCertificateRequest& WithServerCertificateName(ServerCertificateNameT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  TagServerCertificateRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  TagServerCertificateRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
