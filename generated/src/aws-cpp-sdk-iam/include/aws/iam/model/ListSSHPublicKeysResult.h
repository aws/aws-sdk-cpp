...
class ListSSHPublicKeysResult {
 public:
  ...
  template <typename SSHPublicKeysT = Aws::Vector<SSHPublicKeyMetadata>>
  ListSSHPublicKeysResult& WithSSHPublicKeys(SSHPublicKeysT&& value) {
    SetSSHPublicKeys(std::forward<SSHPublicKeysT>(value));
    return *this;
  }
  template <typename SSHPublicKeysT = SSHPublicKeyMetadata>
  ListSSHPublicKeysResult& AddSSHPublicKeys(SSHPublicKeysT&& value) {
    m_sSHPublicKeysHasBeenSet = true;
  ...
  inline ListSSHPublicKeysResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListSSHPublicKeysResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListSSHPublicKeysResult& WithResponseMetadata(ResponseMetadataT&& value) {
