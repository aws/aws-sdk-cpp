...
class GetServiceLastAccessedDetailsWithEntitiesRequest : public IAMRequest {
 public:
  AWS_IAM_API GetServiceLastAccessedDetailsWithEntitiesRequest() = default;
 ...
 public:
  ...
  template <typename JobIdT = Aws::String>
  GetServiceLastAccessedDetailsWithEntitiesRequest& WithJobId(JobIdT&& value) {
  ...
  void SetServiceNamespace(ServiceNamespaceT&& value) {
    ...
    m_serviceNamespace = std::forward<ServiceNamespaceT>(value);
  }
  template <typename ServiceNamespaceT = Aws::String>
  GetServiceLastAccessedDetailsWithEntitiesRequest& WithServiceNamespace(ServiceNamespaceT&& value) {
    SetServiceNamespace(std::forward<ServiceNamespaceT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetServiceLastAccessedDetailsWithEntitiesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  GetServiceLastAccessedDetailsWithEntitiesRequest& WithMarker(MarkerT&& value) {
