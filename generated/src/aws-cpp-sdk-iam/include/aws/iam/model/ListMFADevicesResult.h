...
class ListMFADevicesResult {
 public:
  ...
  void SetMFADevices(MFADevicesT&& value) {
    m_mFADevicesHasBeenSet = true;
    m_mFADevices = std::forward<MFADevicesT>(value);
  }
  template <typename MFADevicesT = Aws::Vector<MFADevice>>
  ListMFADevicesResult& WithMFADevices(MFADevicesT&& value) {
    SetMFADevices(std::forward<MFADevicesT>(value));
    return *this;
  }
  template <typename MFADevicesT = MFADevice>
  ListMFADevicesResult& AddMFADevices(MFADevicesT&& value) {
    m_mFADevicesHasBeenSet = true;
    m_mFADevices.emplace_back(std::forward<MFADevicesT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListMFADevicesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListMFADevicesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListMFADevicesResult& WithResponseMetadata(ResponseMetadataT&& value) {
