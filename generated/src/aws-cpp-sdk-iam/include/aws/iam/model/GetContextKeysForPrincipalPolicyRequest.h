...
class GetContextKeysForPrincipalPolicyRequest : public IAMRequest {
 ...
 public:
  ...
  void SetPolicySourceArn(PolicySourceArnT&& value) {
    m_policySourceArnHasBeenSet = true;
    m_policySourceArn = std::forward<PolicySourceArnT>(value);
  }
  template <typename PolicySourceArnT = Aws::String>
  GetContextKeysForPrincipalPolicyRequest& WithPolicySourceArn(PolicySourceArnT&& value) {
    SetPolicySourceArn(std::forward<PolicySourceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPolicyInputList(PolicyInputListT&& value) {
    ...
    m_policyInputList = std::forward<PolicyInputListT>(value);
  }
  template <typename PolicyInputListT = Aws::Vector<Aws::String>>
  GetContextKeysForPrincipalPolicyRequest& WithPolicyInputList(PolicyInputListT&& value) {
    SetPolicyInputList(std::forward<PolicyInputListT>(value));
    return *this;
  }
  template <typename PolicyInputListT = Aws::String>
  GetContextKeysForPrincipalPolicyRequest& AddPolicyInputList(PolicyInputListT&& value) {
    m_policyInputListHasBeenSet = true;
    m_policyInputList.emplace_back(std::forward<PolicyInputListT>(value));
    return *this;
  }
  ///@}
 private:
