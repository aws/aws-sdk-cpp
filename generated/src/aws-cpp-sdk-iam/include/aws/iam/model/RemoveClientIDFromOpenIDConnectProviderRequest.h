...
class RemoveClientIDFromOpenIDConnectProviderRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename OpenIDConnectProviderArnT = Aws::String>
  RemoveClientIDFromOpenIDConnectProviderRequest& WithOpenIDConnectProviderArn(OpenIDConnectProviderArnT&& value) {
  ...
  template <typename ClientIDT = Aws::String>
  RemoveClientIDFromOpenIDConnectProviderRequest& WithClientID(ClientIDT&& value) {
