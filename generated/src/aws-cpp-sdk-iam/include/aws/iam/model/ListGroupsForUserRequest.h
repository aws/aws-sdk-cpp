...
namespace Model
{
  ...
  {
  public:
    AWS_IAM_API ListGroupsForUserRequest() = default;
  ...
  public:
    ...
    template<typename UserNameT = Aws::String>
    ListGroupsForUserRequest& WithUserName(UserNameT&& value) { SetUserName(std::forward<UserNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListGroupsForUserRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
