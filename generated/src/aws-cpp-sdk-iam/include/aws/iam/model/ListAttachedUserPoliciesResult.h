...
class ListAttachedUserPoliciesResult {
 public:
  ...
  template <typename AttachedPoliciesT = Aws::Vector<AttachedPolicy>>
  ListAttachedUserPoliciesResult& WithAttachedPolicies(AttachedPoliciesT&& value) {
    SetAttachedPolicies(std::forward<AttachedPoliciesT>(value));
    return *this;
  }
  template <typename AttachedPoliciesT = AttachedPolicy>
  ListAttachedUserPoliciesResult& AddAttachedPolicies(AttachedPoliciesT&& value) {
    m_attachedPoliciesHasBeenSet = true;
  ...
  inline ListAttachedUserPoliciesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListAttachedUserPoliciesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListAttachedUserPoliciesResult& WithResponseMetadata(ResponseMetadataT&& value) {
