...
class GetAccountAuthorizationDetailsRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename FilterT = Aws::Vector<EntityType>>
  ...
  inline GetAccountAuthorizationDetailsRequest& AddFilter(EntityType value) {
    m_filterHasBeenSet = true;
  ...
  inline GetAccountAuthorizationDetailsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
