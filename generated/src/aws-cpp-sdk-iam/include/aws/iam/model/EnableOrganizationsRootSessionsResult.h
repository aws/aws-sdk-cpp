...
class EnableOrganizationsRootSessionsResult {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  EnableOrganizationsRootSessionsResult& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename EnabledFeaturesT = Aws::Vector<FeatureType>>
  EnableOrganizationsRootSessionsResult& WithEnabledFeatures(EnabledFeaturesT&& value) {
    SetEnabledFeatures(std::forward<EnabledFeaturesT>(value));
    return *this;
  }
  inline EnableOrganizationsRootSessionsResult& AddEnabledFeatures(FeatureType value) {
    m_enabledFeaturesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableOrganizationsRootSessionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
