...
class ListInstanceProfilesForRoleRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename RoleNameT = Aws::String>
  ListInstanceProfilesForRoleRequest& WithRoleName(RoleNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListInstanceProfilesForRoleRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListInstanceProfilesForRoleRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
