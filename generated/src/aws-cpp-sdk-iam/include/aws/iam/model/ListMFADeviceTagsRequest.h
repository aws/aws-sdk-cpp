...
class ListMFADeviceTagsRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename SerialNumberT = Aws::String>
  ListMFADeviceTagsRequest& WithSerialNumber(SerialNumberT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListMFADeviceTagsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListMFADeviceTagsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
