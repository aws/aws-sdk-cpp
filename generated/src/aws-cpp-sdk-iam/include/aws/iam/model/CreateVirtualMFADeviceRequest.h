...
class CreateVirtualMFADeviceRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename PathT = Aws::String>
  CreateVirtualMFADeviceRequest& WithPath(PathT&& value) {
  ...
  void SetVirtualMFADeviceName(VirtualMFADeviceNameT&& value) {
    m_virtualMFADeviceNameHasBeenSet = true;
    m_virtualMFADeviceName = std::forward<VirtualMFADeviceNameT>(value);
  }
  template <typename VirtualMFADeviceNameT = Aws::String>
  CreateVirtualMFADeviceRequest& WithVirtualMFADeviceName(VirtualMFADeviceNameT&& value) {
    SetVirtualMFADeviceName(std::forward<VirtualMFADeviceNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateVirtualMFADeviceRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateVirtualMFADeviceRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
