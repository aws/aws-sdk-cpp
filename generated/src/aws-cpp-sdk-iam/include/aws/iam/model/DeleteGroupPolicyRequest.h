...
namespace Model
{
  ...
  /**
   */
  class DeleteGroupPolicyRequest : public IAMRequest
  {
  public:
    AWS_IAM_API DeleteGroupPolicyRequest() = default;
  ...
  public:
    ...
    template<typename GroupNameT = Aws::String>
    DeleteGroupPolicyRequest& WithGroupName(GroupNameT&& value) { SetGroupName(std::forward<GroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PolicyNameT = Aws::String>
    DeleteGroupPolicyRequest& WithPolicyName(PolicyNameT&& value) { SetPolicyName(std::forward<PolicyNameT>(value)); return *this;}
    ///@}
  private:
