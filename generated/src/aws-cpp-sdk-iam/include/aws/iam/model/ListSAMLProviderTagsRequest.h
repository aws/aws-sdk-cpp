...
/**
 */
class ListSAMLProviderTagsRequest : public IAMRequest {
 public:
  AWS_IAM_API ListSAMLProviderTagsRequest() = default;
 ...
 public:
  ...
  void SetSAMLProviderArn(SAMLProviderArnT&& value) {
    m_sAMLProviderArnHasBeenSet = true;
    m_sAMLProviderArn = std::forward<SAMLProviderArnT>(value);
  }
  template <typename SAMLProviderArnT = Aws::String>
  ListSAMLProviderTagsRequest& WithSAMLProviderArn(SAMLProviderArnT&& value) {
    SetSAMLProviderArn(std::forward<SAMLProviderArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListSAMLProviderTagsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListSAMLProviderTagsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
