...
namespace Model
{
  ...
  public:
    ...
    template<typename SAMLProviderArnT = Aws::String>
    ListSAMLProviderTagsRequest& WithSAMLProviderArn(SAMLProviderArnT&& value) { SetSAMLProviderArn(std::forward<SAMLProviderArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListSAMLProviderTagsRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
