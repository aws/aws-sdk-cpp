...
class GenerateOrganizationsAccessReportRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename EntityPathT = Aws::String>
  GenerateOrganizationsAccessReportRequest& WithEntityPath(EntityPathT&& value) {
  ...
  void SetOrganizationsPolicyId(OrganizationsPolicyIdT&& value) {
    m_organizationsPolicyIdHasBeenSet = true;
    m_organizationsPolicyId = std::forward<OrganizationsPolicyIdT>(value);
  }
  template <typename OrganizationsPolicyIdT = Aws::String>
  GenerateOrganizationsAccessReportRequest& WithOrganizationsPolicyId(OrganizationsPolicyIdT&& value) {
    SetOrganizationsPolicyId(std::forward<OrganizationsPolicyIdT>(value));
    return *this;
  }
  ///@}
 private:
