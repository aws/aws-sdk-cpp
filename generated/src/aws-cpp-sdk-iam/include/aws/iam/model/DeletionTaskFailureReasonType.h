...
class DeletionTaskFailureReasonType {
 public:
  ...
  template <typename ReasonT = Aws::String>
  DeletionTaskFailureReasonType& WithReason(ReasonT&& value) {
  ...
  void SetRoleUsageList(RoleUsageListT&& value) {
    m_roleUsageListHasBeenSet = true;
    m_roleUsageList = std::forward<RoleUsageListT>(value);
  }
  template <typename RoleUsageListT = Aws::Vector<RoleUsageType>>
  DeletionTaskFailureReasonType& WithRoleUsageList(RoleUsageListT&& value) {
    SetRoleUsageList(std::forward<RoleUsageListT>(value));
    return *this;
  }
  template <typename RoleUsageListT = RoleUsageType>
  DeletionTaskFailureReasonType& AddRoleUsageList(RoleUsageListT&& value) {
    m_roleUsageListHasBeenSet = true;
    m_roleUsageList.emplace_back(std::forward<RoleUsageListT>(value));
    return *this;
  }
  ///@}
 private:
