...
class ListPolicyVersionsResult {
 public:
  ...
  template <typename VersionsT = Aws::Vector<PolicyVersion>>
  ListPolicyVersionsResult& WithVersions(VersionsT&& value) {
    SetVersions(std::forward<VersionsT>(value));
    return *this;
  }
  template <typename VersionsT = PolicyVersion>
  ListPolicyVersionsResult& AddVersions(VersionsT&& value) {
    m_versionsHasBeenSet = true;
  ...
  inline ListPolicyVersionsResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListPolicyVersionsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListPolicyVersionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
