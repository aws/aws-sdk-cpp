...
class ListPoliciesGrantingServiceAccessRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename MarkerT = Aws::String>
  ListPoliciesGrantingServiceAccessRequest& WithMarker(MarkerT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ListPoliciesGrantingServiceAccessRequest& WithArn(ArnT&& value) {
  ...
  void SetServiceNamespaces(ServiceNamespacesT&& value) {
    m_serviceNamespacesHasBeenSet = true;
    m_serviceNamespaces = std::forward<ServiceNamespacesT>(value);
  }
  template <typename ServiceNamespacesT = Aws::Vector<Aws::String>>
  ListPoliciesGrantingServiceAccessRequest& WithServiceNamespaces(ServiceNamespacesT&& value) {
    SetServiceNamespaces(std::forward<ServiceNamespacesT>(value));
    return *this;
  }
  template <typename ServiceNamespacesT = Aws::String>
  ListPoliciesGrantingServiceAccessRequest& AddServiceNamespaces(ServiceNamespacesT&& value) {
    m_serviceNamespacesHasBeenSet = true;
    m_serviceNamespaces.emplace_back(std::forward<ServiceNamespacesT>(value));
    return *this;
  }
  ///@}
 private:
