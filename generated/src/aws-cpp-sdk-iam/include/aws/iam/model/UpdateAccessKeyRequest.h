...
class UpdateAccessKeyRequest : public IAMRequest {
 public:
  AWS_IAM_API UpdateAccessKeyRequest() = default;
 ...
 public:
  ...
  template <typename UserNameT = Aws::String>
  UpdateAccessKeyRequest& WithUserName(UserNameT&& value) {
  ...
  template <typename AccessKeyIdT = Aws::String>
  UpdateAccessKeyRequest& WithAccessKeyId(AccessKeyIdT&& value) {
  ...
  inline UpdateAccessKeyRequest& WithStatus(StatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
