...
class ListSAMLProvidersResult {
 public:
  ...
  void SetSAMLProviderList(SAMLProviderListT&& value) {
    m_sAMLProviderListHasBeenSet = true;
    m_sAMLProviderList = std::forward<SAMLProviderListT>(value);
  }
  template <typename SAMLProviderListT = Aws::Vector<SAMLProviderListEntry>>
  ListSAMLProvidersResult& WithSAMLProviderList(SAMLProviderListT&& value) {
    SetSAMLProviderList(std::forward<SAMLProviderListT>(value));
    return *this;
  }
  template <typename SAMLProviderListT = SAMLProviderListEntry>
  ListSAMLProvidersResult& AddSAMLProviderList(SAMLProviderListT&& value) {
    m_sAMLProviderListHasBeenSet = true;
    m_sAMLProviderList.emplace_back(std::forward<SAMLProviderListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListSAMLProvidersResult& WithResponseMetadata(ResponseMetadataT&& value) {
