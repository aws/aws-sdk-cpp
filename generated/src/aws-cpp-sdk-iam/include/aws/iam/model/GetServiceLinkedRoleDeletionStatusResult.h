...
class GetServiceLinkedRoleDeletionStatusResult {
 public:
  ...
  inline void SetStatus(DeletionTaskStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetServiceLinkedRoleDeletionStatusResult& WithStatus(DeletionTaskStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonT = DeletionTaskFailureReasonType>
  GetServiceLinkedRoleDeletionStatusResult& WithReason(ReasonT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetServiceLinkedRoleDeletionStatusResult& WithResponseMetadata(ResponseMetadataT&& value) {
