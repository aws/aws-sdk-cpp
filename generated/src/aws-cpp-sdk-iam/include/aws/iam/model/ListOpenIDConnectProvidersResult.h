...
class ListOpenIDConnectProvidersResult {
 public:
  ...
  void SetOpenIDConnectProviderList(OpenIDConnectProviderListT&& value) {
    m_openIDConnectProviderListHasBeenSet = true;
    m_openIDConnectProviderList = std::forward<OpenIDConnectProviderListT>(value);
  }
  template <typename OpenIDConnectProviderListT = Aws::Vector<OpenIDConnectProviderListEntry>>
  ListOpenIDConnectProvidersResult& WithOpenIDConnectProviderList(OpenIDConnectProviderListT&& value) {
    SetOpenIDConnectProviderList(std::forward<OpenIDConnectProviderListT>(value));
    return *this;
  }
  template <typename OpenIDConnectProviderListT = OpenIDConnectProviderListEntry>
  ListOpenIDConnectProvidersResult& AddOpenIDConnectProviderList(OpenIDConnectProviderListT&& value) {
    m_openIDConnectProviderListHasBeenSet = true;
    m_openIDConnectProviderList.emplace_back(std::forward<OpenIDConnectProviderListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListOpenIDConnectProvidersResult& WithResponseMetadata(ResponseMetadataT&& value) {
