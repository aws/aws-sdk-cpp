...
class ListAttachedRolePoliciesResult {
 public:
  ...
  template <typename AttachedPoliciesT = Aws::Vector<AttachedPolicy>>
  ListAttachedRolePoliciesResult& WithAttachedPolicies(AttachedPoliciesT&& value) {
    SetAttachedPolicies(std::forward<AttachedPoliciesT>(value));
    return *this;
  }
  template <typename AttachedPoliciesT = AttachedPolicy>
  ListAttachedRolePoliciesResult& AddAttachedPolicies(AttachedPoliciesT&& value) {
    m_attachedPoliciesHasBeenSet = true;
  ...
  inline ListAttachedRolePoliciesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListAttachedRolePoliciesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListAttachedRolePoliciesResult& WithResponseMetadata(ResponseMetadataT&& value) {
