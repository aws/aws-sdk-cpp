...
namespace Model
{
  ...
  {
  public:
    AWS_IAM_API ListAttachedRolePoliciesResult() = default;
    ...
    template<typename AttachedPoliciesT = Aws::Vector<AttachedPolicy>>
    ListAttachedRolePoliciesResult& WithAttachedPolicies(AttachedPoliciesT&& value) { SetAttachedPolicies(std::forward<AttachedPoliciesT>(value)); return *this;}
    template<typename AttachedPoliciesT = AttachedPolicy>
    ListAttachedRolePoliciesResult& AddAttachedPolicies(AttachedPoliciesT&& value) { m_attachedPoliciesHasBeenSet = true; m_attachedPolicies.emplace_back(std::forward<AttachedPoliciesT>(value)); return *this; }
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListAttachedRolePoliciesResult& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ListAttachedRolePoliciesResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
