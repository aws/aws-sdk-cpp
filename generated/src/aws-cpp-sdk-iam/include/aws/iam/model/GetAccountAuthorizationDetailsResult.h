...
class GetAccountAuthorizationDetailsResult {
 public:
  ...
  void SetGroupDetailList(GroupDetailListT&& value) {
    ...
    m_groupDetailList = std::forward<GroupDetailListT>(value);
  }
  template <typename GroupDetailListT = Aws::Vector<GroupDetail>>
  GetAccountAuthorizationDetailsResult& WithGroupDetailList(GroupDetailListT&& value) {
    SetGroupDetailList(std::forward<GroupDetailListT>(value));
    return *this;
  }
  ...
  GetAccountAuthorizationDetailsResult& AddGroupDetailList(GroupDetailListT&& value) {
    m_groupDetailListHasBeenSet = true;
    m_groupDetailList.emplace_back(std::forward<GroupDetailListT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetAccountAuthorizationDetailsResult& WithIsTruncated(bool value) {
