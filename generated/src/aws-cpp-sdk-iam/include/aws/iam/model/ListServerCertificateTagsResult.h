...
class ListServerCertificateTagsResult {
 public:
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ListServerCertificateTagsResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ListServerCertificateTagsResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline ListServerCertificateTagsResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListServerCertificateTagsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListServerCertificateTagsResult& WithResponseMetadata(ResponseMetadataT&& value) {
