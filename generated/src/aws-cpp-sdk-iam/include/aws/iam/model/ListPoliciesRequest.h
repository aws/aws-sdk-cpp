...
class ListPoliciesRequest : public IAMRequest {
 ...
 public:
  ...
  inline void SetScope(PolicyScopeType value) {
    m_scopeHasBeenSet = true;
    m_scope = value;
  }
  inline ListPoliciesRequest& WithScope(PolicyScopeType value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOnlyAttached(bool value) {
    m_onlyAttachedHasBeenSet = true;
    m_onlyAttached = value;
  }
  inline ListPoliciesRequest& WithOnlyAttached(bool value) {
    SetOnlyAttached(value);
    return *this;
  }
  ///@}
  ...
  inline ListPoliciesRequest& WithPolicyUsageFilter(PolicyUsageType value) {
  ...
  inline ListPoliciesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
