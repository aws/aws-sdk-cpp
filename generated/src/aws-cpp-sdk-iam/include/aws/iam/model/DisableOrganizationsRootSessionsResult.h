...
namespace Model
{
  ...
  {
  public:
    AWS_IAM_API DisableOrganizationsRootSessionsResult() = default;
    ...
    template<typename OrganizationIdT = Aws::String>
    DisableOrganizationsRootSessionsResult& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EnabledFeaturesT = Aws::Vector<FeatureType>>
    DisableOrganizationsRootSessionsResult& WithEnabledFeatures(EnabledFeaturesT&& value) { SetEnabledFeatures(std::forward<EnabledFeaturesT>(value)); return *this;}
    inline DisableOrganizationsRootSessionsResult& AddEnabledFeatures(FeatureType value) { m_enabledFeaturesHasBeenSet = true; m_enabledFeatures.push_back(value); return *this; }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DisableOrganizationsRootSessionsResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
