...
class DisableOrganizationsRootSessionsResult {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  DisableOrganizationsRootSessionsResult& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename EnabledFeaturesT = Aws::Vector<FeatureType>>
  DisableOrganizationsRootSessionsResult& WithEnabledFeatures(EnabledFeaturesT&& value) {
    SetEnabledFeatures(std::forward<EnabledFeaturesT>(value));
    return *this;
  }
  inline DisableOrganizationsRootSessionsResult& AddEnabledFeatures(FeatureType value) {
    m_enabledFeaturesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableOrganizationsRootSessionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
