...
class CreateSAMLProviderResult {
 public:
  ...
  template <typename SAMLProviderArnT = Aws::String>
  CreateSAMLProviderResult& WithSAMLProviderArn(SAMLProviderArnT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateSAMLProviderResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateSAMLProviderResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateSAMLProviderResult& WithResponseMetadata(ResponseMetadataT&& value) {
