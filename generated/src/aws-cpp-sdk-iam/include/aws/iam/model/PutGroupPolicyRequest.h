...
class PutGroupPolicyRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename GroupNameT = Aws::String>
  PutGroupPolicyRequest& WithGroupName(GroupNameT&& value) {
  ...
  template <typename PolicyNameT = Aws::String>
  PutGroupPolicyRequest& WithPolicyName(PolicyNameT&& value) {
  ...
  template <typename PolicyDocumentT = Aws::String>
  PutGroupPolicyRequest& WithPolicyDocument(PolicyDocumentT&& value) {
