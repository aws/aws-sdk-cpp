...
class ListAttachedUserPoliciesRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename UserNameT = Aws::String>
  ListAttachedUserPoliciesRequest& WithUserName(UserNameT&& value) {
  ...
  template <typename PathPrefixT = Aws::String>
  ListAttachedUserPoliciesRequest& WithPathPrefix(PathPrefixT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListAttachedUserPoliciesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListAttachedUserPoliciesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
