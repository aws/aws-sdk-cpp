...
class ListAccountAliasesResult {
 public:
  ...
  void SetAccountAliases(AccountAliasesT&& value) {
    m_accountAliasesHasBeenSet = true;
    m_accountAliases = std::forward<AccountAliasesT>(value);
  }
  template <typename AccountAliasesT = Aws::Vector<Aws::String>>
  ListAccountAliasesResult& WithAccountAliases(AccountAliasesT&& value) {
    SetAccountAliases(std::forward<AccountAliasesT>(value));
    return *this;
  }
  template <typename AccountAliasesT = Aws::String>
  ListAccountAliasesResult& AddAccountAliases(AccountAliasesT&& value) {
    m_accountAliasesHasBeenSet = true;
    m_accountAliases.emplace_back(std::forward<AccountAliasesT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListAccountAliasesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListAccountAliasesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListAccountAliasesResult& WithResponseMetadata(ResponseMetadataT&& value) {
