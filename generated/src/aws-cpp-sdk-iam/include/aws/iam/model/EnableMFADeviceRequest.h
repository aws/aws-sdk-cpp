...
class EnableMFADeviceRequest : public IAMRequest {
 ...
 public:
  ...
  void SetAuthenticationCode1(AuthenticationCode1T&& value) {
    m_authenticationCode1HasBeenSet = true;
    m_authenticationCode1 = std::forward<AuthenticationCode1T>(value);
  }
  template <typename AuthenticationCode1T = Aws::String>
  EnableMFADeviceRequest& WithAuthenticationCode1(AuthenticationCode1T&& value) {
    SetAuthenticationCode1(std::forward<AuthenticationCode1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthenticationCode2(AuthenticationCode2T&& value) {
    m_authenticationCode2HasBeenSet = true;
    m_authenticationCode2 = std::forward<AuthenticationCode2T>(value);
  }
  template <typename AuthenticationCode2T = Aws::String>
  EnableMFADeviceRequest& WithAuthenticationCode2(AuthenticationCode2T&& value) {
    SetAuthenticationCode2(std::forward<AuthenticationCode2T>(value));
    return *this;
  }
  ///@}
 private:
