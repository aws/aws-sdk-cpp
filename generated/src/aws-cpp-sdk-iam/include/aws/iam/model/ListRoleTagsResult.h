...
class ListRoleTagsResult {
 public:
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ListRoleTagsResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ListRoleTagsResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline ListRoleTagsResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListRoleTagsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListRoleTagsResult& WithResponseMetadata(ResponseMetadataT&& value) {
