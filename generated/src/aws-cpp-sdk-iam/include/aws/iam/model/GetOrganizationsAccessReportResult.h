...
class GetOrganizationsAccessReportResult {
 public:
  ...
  inline GetOrganizationsAccessReportResult& WithJobStatus(JobStatusType value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename JobCreationDateT = Aws::Utils::DateTime>
  GetOrganizationsAccessReportResult& WithJobCreationDate(JobCreationDateT&& value) {
  ...
  template <typename JobCompletionDateT = Aws::Utils::DateTime>
  GetOrganizationsAccessReportResult& WithJobCompletionDate(JobCompletionDateT&& value) {
  ...
  inline void SetNumberOfServicesAccessible(int value) {
    m_numberOfServicesAccessibleHasBeenSet = true;
    m_numberOfServicesAccessible = value;
  }
  inline GetOrganizationsAccessReportResult& WithNumberOfServicesAccessible(int value) {
    SetNumberOfServicesAccessible(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfServicesNotAccessed(int value) {
    m_numberOfServicesNotAccessedHasBeenSet = true;
    m_numberOfServicesNotAccessed = value;
  }
  inline GetOrganizationsAccessReportResult& WithNumberOfServicesNotAccessed(int value) {
    SetNumberOfServicesNotAccessed(value);
    return *this;
  }
  ///@}
  ...
  template <typename AccessDetailsT = Aws::Vector<AccessDetail>>
  GetOrganizationsAccessReportResult& WithAccessDetails(AccessDetailsT&& value) {
    SetAccessDetails(std::forward<AccessDetailsT>(value));
    return *this;
  }
  template <typename AccessDetailsT = AccessDetail>
  GetOrganizationsAccessReportResult& AddAccessDetails(AccessDetailsT&& value) {
    m_accessDetailsHasBeenSet = true;
    m_accessDetails.emplace_back(std::forward<AccessDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetOrganizationsAccessReportResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  GetOrganizationsAccessReportResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ErrorDetailsT = ErrorDetails>
  GetOrganizationsAccessReportResult& WithErrorDetails(ErrorDetailsT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetOrganizationsAccessReportResult& WithResponseMetadata(ResponseMetadataT&& value) {
