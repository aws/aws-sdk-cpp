...
class AccessKeyMetadata {
 public:
  ...
  template <typename UserNameT = Aws::String>
  AccessKeyMetadata& WithUserName(UserNameT&& value) {
  ...
  template <typename AccessKeyIdT = Aws::String>
  AccessKeyMetadata& WithAccessKeyId(AccessKeyIdT&& value) {
  ...
  inline AccessKeyMetadata& WithStatus(StatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreateDateT = Aws::Utils::DateTime>
  AccessKeyMetadata& WithCreateDate(CreateDateT&& value) {
