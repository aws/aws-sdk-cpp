...
class GetServiceLastAccessedDetailsResult {
 public:
  ...
  inline GetServiceLastAccessedDetailsResult& WithJobStatus(JobStatusType value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetJobType(AccessAdvisorUsageGranularityType value) {
    m_jobTypeHasBeenSet = true;
    m_jobType = value;
  }
  inline GetServiceLastAccessedDetailsResult& WithJobType(AccessAdvisorUsageGranularityType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  void SetServicesLastAccessed(ServicesLastAccessedT&& value) {
    m_servicesLastAccessedHasBeenSet = true;
    m_servicesLastAccessed = std::forward<ServicesLastAccessedT>(value);
  }
  template <typename ServicesLastAccessedT = Aws::Vector<ServiceLastAccessed>>
  GetServiceLastAccessedDetailsResult& WithServicesLastAccessed(ServicesLastAccessedT&& value) {
    SetServicesLastAccessed(std::forward<ServicesLastAccessedT>(value));
    return *this;
  }
  ...
  GetServiceLastAccessedDetailsResult& AddServicesLastAccessed(ServicesLastAccessedT&& value) {
    m_servicesLastAccessedHasBeenSet = true;
    m_servicesLastAccessed.emplace_back(std::forward<ServicesLastAccessedT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetServiceLastAccessedDetailsResult& WithIsTruncated(bool value) {
