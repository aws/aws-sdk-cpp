...
class GetServiceLastAccessedDetailsRequest : public IAMRequest {
 public:
  AWS_IAM_API GetServiceLastAccessedDetailsRequest() = default;
 ...
 public:
  ///@{
  /**
   * <p>The ID of the request generated by the <a
  ...
  template <typename JobIdT = Aws::String>
  GetServiceLastAccessedDetailsRequest& WithJobId(JobIdT&& value) {
  ...
  inline GetServiceLastAccessedDetailsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  GetServiceLastAccessedDetailsRequest& WithMarker(MarkerT&& value) {
