...
class ListEntitiesForPolicyRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename PolicyArnT = Aws::String>
  ListEntitiesForPolicyRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  inline void SetEntityFilter(EntityType value) {
    m_entityFilterHasBeenSet = true;
    m_entityFilter = value;
  }
  inline ListEntitiesForPolicyRequest& WithEntityFilter(EntityType value) {
  ...
  template <typename PathPrefixT = Aws::String>
  ListEntitiesForPolicyRequest& WithPathPrefix(PathPrefixT&& value) {
  ...
  inline void SetPolicyUsageFilter(PolicyUsageType value) {
    m_policyUsageFilterHasBeenSet = true;
    m_policyUsageFilter = value;
  }
  inline ListEntitiesForPolicyRequest& WithPolicyUsageFilter(PolicyUsageType value) {
    SetPolicyUsageFilter(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListEntitiesForPolicyRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListEntitiesForPolicyRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
