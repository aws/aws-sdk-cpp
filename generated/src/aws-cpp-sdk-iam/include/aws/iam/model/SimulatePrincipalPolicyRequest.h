...
class SimulatePrincipalPolicyRequest : public IAMRequest {
 ...
 public:
  ...
  void SetPermissionsBoundaryPolicyInputList(PermissionsBoundaryPolicyInputListT&& value) {
    m_permissionsBoundaryPolicyInputListHasBeenSet = true;
    m_permissionsBoundaryPolicyInputList = std::forward<PermissionsBoundaryPolicyInputListT>(value);
  }
  template <typename PermissionsBoundaryPolicyInputListT = Aws::Vector<Aws::String>>
  SimulatePrincipalPolicyRequest& WithPermissionsBoundaryPolicyInputList(PermissionsBoundaryPolicyInputListT&& value) {
    SetPermissionsBoundaryPolicyInputList(std::forward<PermissionsBoundaryPolicyInputListT>(value));
    return *this;
  }
  ...
  SimulatePrincipalPolicyRequest& AddPermissionsBoundaryPolicyInputList(PermissionsBoundaryPolicyInputListT&& value) {
    m_permissionsBoundaryPolicyInputListHasBeenSet = true;
    m_permissionsBoundaryPolicyInputList.emplace_back(std::forward<PermissionsBoundaryPolicyInputListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceHandlingOption(ResourceHandlingOptionT&& value) {
    m_resourceHandlingOptionHasBeenSet = true;
    m_resourceHandlingOption = std::forward<ResourceHandlingOptionT>(value);
  }
  template <typename ResourceHandlingOptionT = Aws::String>
  SimulatePrincipalPolicyRequest& WithResourceHandlingOption(ResourceHandlingOptionT&& value) {
    SetResourceHandlingOption(std::forward<ResourceHandlingOptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline SimulatePrincipalPolicyRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
