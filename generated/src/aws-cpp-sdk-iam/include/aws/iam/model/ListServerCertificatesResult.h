...
class ListServerCertificatesResult {
 public:
  ...
  void SetServerCertificateMetadataList(ServerCertificateMetadataListT&& value) {
    m_serverCertificateMetadataListHasBeenSet = true;
    m_serverCertificateMetadataList = std::forward<ServerCertificateMetadataListT>(value);
  }
  template <typename ServerCertificateMetadataListT = Aws::Vector<ServerCertificateMetadata>>
  ListServerCertificatesResult& WithServerCertificateMetadataList(ServerCertificateMetadataListT&& value) {
    SetServerCertificateMetadataList(std::forward<ServerCertificateMetadataListT>(value));
    return *this;
  }
  template <typename ServerCertificateMetadataListT = ServerCertificateMetadata>
  ListServerCertificatesResult& AddServerCertificateMetadataList(ServerCertificateMetadataListT&& value) {
    m_serverCertificateMetadataListHasBeenSet = true;
    m_serverCertificateMetadataList.emplace_back(std::forward<ServerCertificateMetadataListT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListServerCertificatesResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListServerCertificatesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListServerCertificatesResult& WithResponseMetadata(ResponseMetadataT&& value) {
