...
class ResourceSpecificResult {
 public:
  ...
  inline void SetEvalResourceDecision(PolicyEvaluationDecisionType value) {
    m_evalResourceDecisionHasBeenSet = true;
    m_evalResourceDecision = value;
  }
  inline ResourceSpecificResult& WithEvalResourceDecision(PolicyEvaluationDecisionType value) {
    SetEvalResourceDecision(value);
    return *this;
  }
  ///@}
