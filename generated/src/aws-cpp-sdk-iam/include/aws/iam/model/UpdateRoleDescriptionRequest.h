...
class UpdateRoleDescriptionRequest : public IAMRequest {
 public:
  AWS_IAM_API UpdateRoleDescriptionRequest() = default;
 ...
 public:
  ...
  template <typename RoleNameT = Aws::String>
  UpdateRoleDescriptionRequest& WithRoleName(RoleNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateRoleDescriptionRequest& WithDescription(DescriptionT&& value) {
