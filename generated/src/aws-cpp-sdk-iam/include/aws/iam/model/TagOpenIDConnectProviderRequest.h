...
class TagOpenIDConnectProviderRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename OpenIDConnectProviderArnT = Aws::String>
  TagOpenIDConnectProviderRequest& WithOpenIDConnectProviderArn(OpenIDConnectProviderArnT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  TagOpenIDConnectProviderRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  TagOpenIDConnectProviderRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
