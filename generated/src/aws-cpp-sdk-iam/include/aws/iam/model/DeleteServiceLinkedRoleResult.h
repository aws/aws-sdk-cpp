...
class DeleteServiceLinkedRoleResult {
 public:
  ...
  void SetDeletionTaskId(DeletionTaskIdT&& value) {
    m_deletionTaskIdHasBeenSet = true;
    m_deletionTaskId = std::forward<DeletionTaskIdT>(value);
  }
  template <typename DeletionTaskIdT = Aws::String>
  DeleteServiceLinkedRoleResult& WithDeletionTaskId(DeletionTaskIdT&& value) {
    SetDeletionTaskId(std::forward<DeletionTaskIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteServiceLinkedRoleResult& WithResponseMetadata(ResponseMetadataT&& value) {
