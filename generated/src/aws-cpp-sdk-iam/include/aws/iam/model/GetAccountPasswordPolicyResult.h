...
class GetAccountPasswordPolicyResult {
 public:
  ...
  void SetPasswordPolicy(PasswordPolicyT&& value) {
    ...
    m_passwordPolicy = std::forward<PasswordPolicyT>(value);
  }
  template <typename PasswordPolicyT = PasswordPolicy>
  GetAccountPasswordPolicyResult& WithPasswordPolicy(PasswordPolicyT&& value) {
    SetPasswordPolicy(std::forward<PasswordPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetAccountPasswordPolicyResult& WithResponseMetadata(ResponseMetadataT&& value) {
