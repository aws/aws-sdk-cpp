...
class ListSSHPublicKeysRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename UserNameT = Aws::String>
  ListSSHPublicKeysRequest& WithUserName(UserNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListSSHPublicKeysRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListSSHPublicKeysRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
