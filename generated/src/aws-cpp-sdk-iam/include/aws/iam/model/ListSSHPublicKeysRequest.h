...
namespace Model
{
  ...
  {
  public:
    AWS_IAM_API ListSSHPublicKeysRequest() = default;
  ...
  public:
    ...
    template<typename UserNameT = Aws::String>
    ListSSHPublicKeysRequest& WithUserName(UserNameT&& value) { SetUserName(std::forward<UserNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListSSHPublicKeysRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
