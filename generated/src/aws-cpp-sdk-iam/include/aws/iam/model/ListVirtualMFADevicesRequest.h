...
class ListVirtualMFADevicesRequest : public IAMRequest {
 public:
  AWS_IAM_API ListVirtualMFADevicesRequest() = default;
 ...
 public:
   ...
   * MFA devices.,</p>
   */
  inline AssignmentStatusType GetAssignmentStatus() const { return m_assignmentStatus; }
  inline bool AssignmentStatusHasBeenSet() const { return m_assignmentStatusHasBeenSet; }
  inline void SetAssignmentStatus(AssignmentStatusType value) {
    m_assignmentStatusHasBeenSet = true;
    m_assignmentStatus = value;
  }
  inline ListVirtualMFADevicesRequest& WithAssignmentStatus(AssignmentStatusType value) {
  ...
  template <typename MarkerT = Aws::String>
  ListVirtualMFADevicesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListVirtualMFADevicesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
