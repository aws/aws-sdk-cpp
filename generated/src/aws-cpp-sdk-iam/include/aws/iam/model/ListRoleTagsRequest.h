...
namespace Model
{
  ...
  {
  public:
    AWS_IAM_API ListRoleTagsRequest() = default;
  ...
  public:
    ...
    template<typename RoleNameT = Aws::String>
    ListRoleTagsRequest& WithRoleName(RoleNameT&& value) { SetRoleName(std::forward<RoleNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListRoleTagsRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
