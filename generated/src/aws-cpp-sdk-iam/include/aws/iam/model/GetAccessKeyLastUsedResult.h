...
class GetAccessKeyLastUsedResult {
 public:
  ...
  template <typename UserNameT = Aws::String>
  GetAccessKeyLastUsedResult& WithUserName(UserNameT&& value) {
  ...
  void SetAccessKeyLastUsed(AccessKeyLastUsedT&& value) {
    m_accessKeyLastUsedHasBeenSet = true;
    m_accessKeyLastUsed = std::forward<AccessKeyLastUsedT>(value);
  }
  template <typename AccessKeyLastUsedT = AccessKeyLastUsed>
  GetAccessKeyLastUsedResult& WithAccessKeyLastUsed(AccessKeyLastUsedT&& value) {
    SetAccessKeyLastUsed(std::forward<AccessKeyLastUsedT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetAccessKeyLastUsedResult& WithResponseMetadata(ResponseMetadataT&& value) {
