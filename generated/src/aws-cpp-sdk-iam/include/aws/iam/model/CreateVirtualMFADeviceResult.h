...
class CreateVirtualMFADeviceResult {
 public:
  ...
  void SetVirtualMFADevice(VirtualMFADeviceT&& value) {
    m_virtualMFADeviceHasBeenSet = true;
    m_virtualMFADevice = std::forward<VirtualMFADeviceT>(value);
  }
  template <typename VirtualMFADeviceT = VirtualMFADevice>
  CreateVirtualMFADeviceResult& WithVirtualMFADevice(VirtualMFADeviceT&& value) {
    SetVirtualMFADevice(std::forward<VirtualMFADeviceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateVirtualMFADeviceResult& WithResponseMetadata(ResponseMetadataT&& value) {
