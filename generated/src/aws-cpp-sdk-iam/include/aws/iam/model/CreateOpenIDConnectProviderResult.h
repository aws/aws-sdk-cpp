...
class CreateOpenIDConnectProviderResult {
 public:
  ...
  void SetOpenIDConnectProviderArn(OpenIDConnectProviderArnT&& value) {
    m_openIDConnectProviderArnHasBeenSet = true;
    m_openIDConnectProviderArn = std::forward<OpenIDConnectProviderArnT>(value);
  }
  template <typename OpenIDConnectProviderArnT = Aws::String>
  CreateOpenIDConnectProviderResult& WithOpenIDConnectProviderArn(OpenIDConnectProviderArnT&& value) {
    SetOpenIDConnectProviderArn(std::forward<OpenIDConnectProviderArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateOpenIDConnectProviderResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateOpenIDConnectProviderResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateOpenIDConnectProviderResult& WithResponseMetadata(ResponseMetadataT&& value) {
