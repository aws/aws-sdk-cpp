...
class AddClientIDToOpenIDConnectProviderRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename OpenIDConnectProviderArnT = Aws::String>
  AddClientIDToOpenIDConnectProviderRequest& WithOpenIDConnectProviderArn(OpenIDConnectProviderArnT&& value) {
  ...
  template <typename ClientIDT = Aws::String>
  AddClientIDToOpenIDConnectProviderRequest& WithClientID(ClientIDT&& value) {
