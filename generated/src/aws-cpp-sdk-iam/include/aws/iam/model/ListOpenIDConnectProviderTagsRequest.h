...
class ListOpenIDConnectProviderTagsRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename OpenIDConnectProviderArnT = Aws::String>
  ListOpenIDConnectProviderTagsRequest& WithOpenIDConnectProviderArn(OpenIDConnectProviderArnT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListOpenIDConnectProviderTagsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListOpenIDConnectProviderTagsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
