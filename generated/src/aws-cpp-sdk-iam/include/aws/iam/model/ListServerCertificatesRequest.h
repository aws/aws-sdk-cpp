...
namespace Model
{
  ...
  {
  public:
    AWS_IAM_API ListServerCertificatesRequest() = default;
  ...
  public:
    ...
    template<typename PathPrefixT = Aws::String>
    ListServerCertificatesRequest& WithPathPrefix(PathPrefixT&& value) { SetPathPrefix(std::forward<PathPrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListServerCertificatesRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
