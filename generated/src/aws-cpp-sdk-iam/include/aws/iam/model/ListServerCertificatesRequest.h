...
class ListServerCertificatesRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename PathPrefixT = Aws::String>
  ListServerCertificatesRequest& WithPathPrefix(PathPrefixT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListServerCertificatesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListServerCertificatesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
