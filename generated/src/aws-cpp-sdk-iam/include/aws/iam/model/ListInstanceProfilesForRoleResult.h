...
class ListInstanceProfilesForRoleResult {
 public:
  ...
  template <typename InstanceProfilesT = Aws::Vector<InstanceProfile>>
  ListInstanceProfilesForRoleResult& WithInstanceProfiles(InstanceProfilesT&& value) {
    SetInstanceProfiles(std::forward<InstanceProfilesT>(value));
    return *this;
  }
  template <typename InstanceProfilesT = InstanceProfile>
  ListInstanceProfilesForRoleResult& AddInstanceProfiles(InstanceProfilesT&& value) {
    m_instanceProfilesHasBeenSet = true;
  ...
  inline ListInstanceProfilesForRoleResult& WithIsTruncated(bool value) {
  ...
  template <typename MarkerT = Aws::String>
  ListInstanceProfilesForRoleResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListInstanceProfilesForRoleResult& WithResponseMetadata(ResponseMetadataT&& value) {
