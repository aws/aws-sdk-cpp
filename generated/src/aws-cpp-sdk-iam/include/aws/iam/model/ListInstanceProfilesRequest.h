...
class ListInstanceProfilesRequest : public IAMRequest {
 ...
 public:
  ...
  template <typename PathPrefixT = Aws::String>
  ListInstanceProfilesRequest& WithPathPrefix(PathPrefixT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListInstanceProfilesRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListInstanceProfilesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
