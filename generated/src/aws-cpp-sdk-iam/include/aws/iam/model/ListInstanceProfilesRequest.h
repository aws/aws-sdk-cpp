...
namespace Model
{
  ...
  /**
   */
  class ListInstanceProfilesRequest : public IAMRequest
  {
  public:
    AWS_IAM_API ListInstanceProfilesRequest() = default;
  ...
  public:
    ...
    template<typename PathPrefixT = Aws::String>
    ListInstanceProfilesRequest& WithPathPrefix(PathPrefixT&& value) { SetPathPrefix(std::forward<PathPrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListInstanceProfilesRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
