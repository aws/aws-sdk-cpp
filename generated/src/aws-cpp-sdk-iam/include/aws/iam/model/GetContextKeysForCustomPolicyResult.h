...
namespace Model
{
  ...
  {
  public:
    AWS_IAM_API GetContextKeysForCustomPolicyResult() = default;
    ...
    template<typename ContextKeyNamesT = Aws::Vector<Aws::String>>
    GetContextKeysForCustomPolicyResult& WithContextKeyNames(ContextKeyNamesT&& value) { SetContextKeyNames(std::forward<ContextKeyNamesT>(value)); return *this;}
    template<typename ContextKeyNamesT = Aws::String>
    GetContextKeysForCustomPolicyResult& AddContextKeyNames(ContextKeyNamesT&& value) { m_contextKeyNamesHasBeenSet = true; m_contextKeyNames.emplace_back(std::forward<ContextKeyNamesT>(value)); return *this; }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    GetContextKeysForCustomPolicyResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
