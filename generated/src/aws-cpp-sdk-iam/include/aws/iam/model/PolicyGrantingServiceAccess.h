...
class PolicyGrantingServiceAccess {
 public:
  ...
  inline PolicyGrantingServiceAccess& WithPolicyType(PolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEntityType(PolicyOwnerEntityType value) {
    m_entityTypeHasBeenSet = true;
    m_entityType = value;
  }
  inline PolicyGrantingServiceAccess& WithEntityType(PolicyOwnerEntityType value) {
    SetEntityType(value);
    return *this;
  }
  ///@}
