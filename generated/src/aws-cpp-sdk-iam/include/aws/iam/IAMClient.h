 ...
 * Management User Guide</a>.</p> <p> <b>Programmatic access to IAM</b> </p> <p>We
 * recommend that you use the Amazon Web Services SDKs to make programmatic API
 ...
 * requests automatically. For more information, see <a
 * href="http://aws.amazon.com/tools/">Tools to build on Amazon Web
 * Services</a>.</p> <p>Alternatively, you can also use the IAM Query API to make
 * direct calls to the IAM service. For more information about calling the IAM
 * Query API, see <a
 * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/IAM_UsingQueryAPI.html">Making
 * query requests</a> in the <i>Identity and Access Management User Guide</i>. IAM
 ...
 * </p> <p>Requests must be signed using an access key ID and a secret access key.
 * We strongly recommend that you do not use your Amazon Web Services account
 * access key ID and secret access key for everyday work with IAM. You can use the
 * access key ID and secret access key for an IAM user or you can use the Security
 * Token Service to generate temporary security credentials and use those to sign
 * requests.</p> <p>To sign requests, we recommend that you use <a
 ...
 * about the types of credentials used for accessing Amazon Web Services.</p> </li>
 * <li> <p> <a
 ...
 * service to help secure your Amazon Web Services resources.</p> </li> <li> <p> <a
 * href="https://docs.aws.amazon.com/general/latest/gr/signing_aws_api_requests.html">Signing
 * Amazon Web Services API requests</a>. This set of topics walk you through the
 * process of signing a request using an access key ID and secret access key.</p>
 * </li> </ul>
 */
class AWS_IAM_API IAMClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  IAMClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<IAMEndpointProviderBase> endpointProvider = nullptr,
  ...
  virtual Model::AddClientIDToOpenIDConnectProviderOutcome AddClientIDToOpenIDConnectProvider(
      const Model::AddClientIDToOpenIDConnectProviderRequest& request) const;

  /**
   * A Callable wrapper for AddClientIDToOpenIDConnectProvider that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AddClientIDToOpenIDConnectProviderRequestT = Model::AddClientIDToOpenIDConnectProviderRequest>
  Model::AddClientIDToOpenIDConnectProviderOutcomeCallable AddClientIDToOpenIDConnectProviderCallable(
      const AddClientIDToOpenIDConnectProviderRequestT& request) const {
    return SubmitCallable(&IAMClient::AddClientIDToOpenIDConnectProvider, request);
  }

  /**
   * An Async wrapper for AddClientIDToOpenIDConnectProvider that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AddClientIDToOpenIDConnectProviderRequestT = Model::AddClientIDToOpenIDConnectProviderRequest>
  void AddClientIDToOpenIDConnectProviderAsync(const AddClientIDToOpenIDConnectProviderRequestT& request,
  ...
  /**
   * A Callable wrapper for AddRoleToInstanceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddRoleToInstanceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddRoleToInstanceProfileRequestT = Model::AddRoleToInstanceProfileRequest>
  void AddRoleToInstanceProfileAsync(const AddRoleToInstanceProfileRequestT& request,
  ...
  /**
   * An Async wrapper for AddUserToGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddUserToGroupRequestT = Model::AddUserToGroupRequest>
  ...
  /**
   * A Callable wrapper for AttachGroupPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AttachGroupPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AttachGroupPolicyRequestT = Model::AttachGroupPolicyRequest>
  void AttachGroupPolicyAsync(const AttachGroupPolicyRequestT& request, const AttachGroupPolicyResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AttachRolePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AttachRolePolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AttachRolePolicyRequestT = Model::AttachRolePolicyRequest>
  void AttachRolePolicyAsync(const AttachRolePolicyRequestT& request, const AttachRolePolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AttachUserPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AttachUserPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AttachUserPolicyRequestT = Model::AttachUserPolicyRequest>
  void AttachUserPolicyAsync(const AttachUserPolicyRequestT& request, const AttachUserPolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ChangePassword that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ChangePasswordRequestT = Model::ChangePasswordRequest>
  void ChangePasswordAsync(const ChangePasswordRequestT& request, const ChangePasswordResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAccessKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAccessKeyRequestT = Model::CreateAccessKeyRequest>
  void CreateAccessKeyAsync(const CreateAccessKeyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const CreateAccessKeyRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateAccountAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAccountAlias that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAccountAliasRequestT = Model::CreateAccountAliasRequest>
  void CreateAccountAliasAsync(const CreateAccountAliasRequestT& request, const CreateAccountAliasResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateInstanceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateInstanceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateInstanceProfileRequestT = Model::CreateInstanceProfileRequest>
  void CreateInstanceProfileAsync(const CreateInstanceProfileRequestT& request, const CreateInstanceProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * to update your own existing password in the <b>My Security Credentials</b> page
   * in the Amazon Web Services Management Console.</p> <p>For more information about
   * managing passwords, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_ManagingLogins.html">Managing
   * passwords</a> in the <i>IAM User Guide</i>.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for CreateLoginProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLoginProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateLoginProfileRequestT = Model::CreateLoginProfileRequest>
  void CreateLoginProfileAsync(const CreateLoginProfileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const CreateLoginProfileRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateOpenIDConnectProviderOutcome CreateOpenIDConnectProvider(
      const Model::CreateOpenIDConnectProviderRequest& request) const;

  /**
   * A Callable wrapper for CreateOpenIDConnectProvider that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateOpenIDConnectProviderRequestT = Model::CreateOpenIDConnectProviderRequest>
  Model::CreateOpenIDConnectProviderOutcomeCallable CreateOpenIDConnectProviderCallable(
      const CreateOpenIDConnectProviderRequestT& request) const {
    return SubmitCallable(&IAMClient::CreateOpenIDConnectProvider, request);
  }

  /**
   * An Async wrapper for CreateOpenIDConnectProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateOpenIDConnectProviderRequestT = Model::CreateOpenIDConnectProviderRequest>
  void CreateOpenIDConnectProviderAsync(const CreateOpenIDConnectProviderRequestT& request,
   ...
   * before you create a new version.</p> <p>Optionally, you can set the new version
   * as the policy's default version. The default version is the version that is in
   * effect for the IAM users, groups, and roles to which the policy is attached.</p>
  ...
  /**
   * A Callable wrapper for CreatePolicyVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePolicyVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePolicyVersionRequestT = Model::CreatePolicyVersionRequest>
  void CreatePolicyVersionAsync(const CreatePolicyVersionRequestT& request, const CreatePolicyVersionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateRole that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateRoleRequestT = Model::CreateRoleRequest>
  void CreateRoleAsync(const CreateRoleRequestT& request, const CreateRoleResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSAMLProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSAMLProvider that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateSAMLProviderRequestT = Model::CreateSAMLProviderRequest>
  void CreateSAMLProviderAsync(const CreateSAMLProviderRequestT& request, const CreateSAMLProviderResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateServiceLinkedRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateServiceLinkedRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateServiceLinkedRoleRequestT = Model::CreateServiceLinkedRoleRequest>
  void CreateServiceLinkedRoleAsync(const CreateServiceLinkedRoleRequestT& request,
   ...
   * supported service per user.</p> <p>You can reset the password to a new
   * service-generated value by calling <a
   ...
   * <p>For more information about using service-specific credentials to authenticate
   * to an Amazon Web Services service, refer to the following docs:</p> <ul> <li>
   * <p>For service-specific credentials with CodeCommit, refer to <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_ssh-keys.html">IAM
   * credentials for CodeCommit: Git credentials, SSH keys, and Amazon Web Services
   * access keys</a> in the <i>IAM User Guide</i>.</p> </li> <li> <p>For
   * service-specific credentials with Amazon Keyspaces (for Apache Cassandra), refer
   * to <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_keyspaces.html">Use
   * IAM with Amazon Keyspaces (for Apache Cassandra)</a> in the <i>IAM User
   * Guide</i>.</p> </li> <li> <p>For services that support long-term API keys, refer
   * to <a
  ...
  virtual Model::CreateServiceSpecificCredentialOutcome CreateServiceSpecificCredential(
      const Model::CreateServiceSpecificCredentialRequest& request) const;

  /**
   * A Callable wrapper for CreateServiceSpecificCredential that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateServiceSpecificCredentialRequestT = Model::CreateServiceSpecificCredentialRequest>
  Model::CreateServiceSpecificCredentialOutcomeCallable CreateServiceSpecificCredentialCallable(
      const CreateServiceSpecificCredentialRequestT& request) const {
    return SubmitCallable(&IAMClient::CreateServiceSpecificCredential, request);
  }

  /**
   * An Async wrapper for CreateServiceSpecificCredential that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateServiceSpecificCredentialRequestT = Model::CreateServiceSpecificCredentialRequest>
  void CreateServiceSpecificCredentialAsync(const CreateServiceSpecificCredentialRequestT& request,
   ...
   * creating the virtual MFA, use <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_EnableMFADevice.html">EnableMFADevice</a>
   * to attach the MFA device to an IAM user. For more information about creating and
  ...
  /**
   * A Callable wrapper for CreateVirtualMFADevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateVirtualMFADevice that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateVirtualMFADeviceRequestT = Model::CreateVirtualMFADeviceRequest>
  void CreateVirtualMFADeviceAsync(const CreateVirtualMFADeviceRequestT& request,
  ...
  /**
   * A Callable wrapper for DeactivateMFADevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeactivateMFADevice that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeactivateMFADeviceRequestT = Model::DeactivateMFADeviceRequest>
  void DeactivateMFADeviceAsync(const DeactivateMFADeviceRequestT& request, const DeactivateMFADeviceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAccessKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAccessKeyRequestT = Model::DeleteAccessKeyRequest>
  void DeleteAccessKeyAsync(const DeleteAccessKeyRequestT& request, const DeleteAccessKeyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAccountAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAccountAlias that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAccountAliasRequestT = Model::DeleteAccountAliasRequest>
  void DeleteAccountAliasAsync(const DeleteAccountAliasRequestT& request, const DeleteAccountAliasResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAccountPasswordPolicyOutcome DeleteAccountPasswordPolicy(
      const Model::DeleteAccountPasswordPolicyRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteAccountPasswordPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAccountPasswordPolicyRequestT = Model::DeleteAccountPasswordPolicyRequest>
  Model::DeleteAccountPasswordPolicyOutcomeCallable DeleteAccountPasswordPolicyCallable(
      const DeleteAccountPasswordPolicyRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::DeleteAccountPasswordPolicy, request);
  }

  /**
   * An Async wrapper for DeleteAccountPasswordPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAccountPasswordPolicyRequestT = Model::DeleteAccountPasswordPolicyRequest>
  void DeleteAccountPasswordPolicyAsync(const DeleteAccountPasswordPolicyResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DeleteAccountPasswordPolicyRequestT& request = {}) const {
   ...
   * managed policy from a group, use <a
  ...
  /**
   * A Callable wrapper for DeleteGroupPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteGroupPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteGroupPolicyRequestT = Model::DeleteGroupPolicyRequest>
  void DeleteGroupPolicyAsync(const DeleteGroupPolicyRequestT& request, const DeleteGroupPolicyResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteInstanceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInstanceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteInstanceProfileRequestT = Model::DeleteInstanceProfileRequest>
  void DeleteInstanceProfileAsync(const DeleteInstanceProfileRequestT& request, const DeleteInstanceProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&IAMClient::DeleteInstanceProfile, request, handler, context);
  }

  /**
   * <p>Deletes the password for the specified IAM user or root user, For more
   * information, see <a
   ...
   * IAM user. You can use <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ChangePassword.html">ChangePassword</a>
   * to update, but not delete, your own password in the <b>My Security
   * Credentials</b> page in the Amazon Web Services Management Console.</p>
   *  <p>Deleting a user's password does not prevent a user from accessing
   * Amazon Web Services through the command line interface or the API. To prevent
   * all user access, you must also either make any access keys inactive or delete
   ...
   * and <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeleteAccessKey.html">DeleteAccessKey</a>.</p>
   * <p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for DeleteLoginProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLoginProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteLoginProfileRequestT = Model::DeleteLoginProfileRequest>
  void DeleteLoginProfileAsync(const DeleteLoginProfileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DeleteLoginProfileRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteOpenIDConnectProviderOutcome DeleteOpenIDConnectProvider(
      const Model::DeleteOpenIDConnectProviderRequest& request) const;

  /**
   * A Callable wrapper for DeleteOpenIDConnectProvider that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteOpenIDConnectProviderRequestT = Model::DeleteOpenIDConnectProviderRequest>
  Model::DeleteOpenIDConnectProviderOutcomeCallable DeleteOpenIDConnectProviderCallable(
      const DeleteOpenIDConnectProviderRequestT& request) const {
    return SubmitCallable(&IAMClient::DeleteOpenIDConnectProvider, request);
  }

  /**
   * An Async wrapper for DeleteOpenIDConnectProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteOpenIDConnectProviderRequestT = Model::DeleteOpenIDConnectProviderRequest>
  void DeleteOpenIDConnectProviderAsync(const DeleteOpenIDConnectProviderRequestT& request,
   ...
   * To list all the users, groups, and roles that a policy is attached to, use <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListEntitiesForPolicy.html">ListEntitiesForPolicy</a>.</p>
   * </li> <li> <p>Delete all versions of the policy using <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeletePolicyVersion.html">DeletePolicyVersion</a>.
   ...
   * policy's default version in the next step of the process.</p> </li> <li>
   * <p>Delete the policy (this automatically deletes the policy's default version)
   * using this operation.</p> </li> </ul> <p>For information about managed policies,
   * see <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html">Managed
   * policies and inline policies</a> in the <i>IAM User Guide</i>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * the default version from a policy, use <a
   ...
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListPolicyVersions.html">ListPolicyVersions</a>.</p>
   * <p>For information about versions for managed policies, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-versions.html">Versioning
   * for managed policies</a> in the <i>IAM User Guide</i>.</p><p><h3>See Also:</h3>
   * <a
  ...
  /**
   * A Callable wrapper for DeletePolicyVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePolicyVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeletePolicyVersionRequestT = Model::DeletePolicyVersionRequest>
  void DeletePolicyVersionAsync(const DeletePolicyVersionRequestT& request, const DeletePolicyVersionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * attached items: </p> <ul> <li> <p>Inline policies (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeleteRolePolicy.html">DeleteRolePolicy</a>)</p>
   * </li> <li> <p>Attached managed policies (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DetachRolePolicy.html">DetachRolePolicy</a>)</p>
   * </li> <li> <p>Instance profile (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_RemoveRoleFromInstanceProfile.html">RemoveRoleFromInstanceProfile</a>)</p>
   * </li> <li> <p>Optional – Delete instance profile after detaching from role for
   * resource clean up (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeleteInstanceProfile.html">DeleteInstanceProfile</a>)</p>
   * </li> </ul>  <p>Make sure that you do not have any Amazon EC2
  ...
  /**
   * An Async wrapper for DeleteRole that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRoleRequestT = Model::DeleteRoleRequest>
  void DeleteRoleAsync(const DeleteRoleRequestT& request, const DeleteRoleResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRolePermissionsBoundaryOutcome DeleteRolePermissionsBoundary(
      const Model::DeleteRolePermissionsBoundaryRequest& request) const;

  /**
   * A Callable wrapper for DeleteRolePermissionsBoundary that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRolePermissionsBoundaryRequestT = Model::DeleteRolePermissionsBoundaryRequest>
  Model::DeleteRolePermissionsBoundaryOutcomeCallable DeleteRolePermissionsBoundaryCallable(
      const DeleteRolePermissionsBoundaryRequestT& request) const {
    return SubmitCallable(&IAMClient::DeleteRolePermissionsBoundary, request);
  }

  /**
   * An Async wrapper for DeleteRolePermissionsBoundary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRolePermissionsBoundaryRequestT = Model::DeleteRolePermissionsBoundaryRequest>
  void DeleteRolePermissionsBoundaryAsync(const DeleteRolePermissionsBoundaryRequestT& request,
   ...
   * managed policy from a role, use <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DetachRolePolicy.html">DetachRolePolicy</a>.
   * For more information about policies, refer to <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html">Managed
   * policies and inline policies</a> in the <i>IAM User Guide</i>.</p><p><h3>See
  ...
  /**
   * A Callable wrapper for DeleteRolePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRolePolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteRolePolicyRequestT = Model::DeleteRolePolicyRequest>
  void DeleteRolePolicyAsync(const DeleteRolePolicyRequestT& request, const DeleteRolePolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSAMLProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSAMLProvider that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteSAMLProviderRequestT = Model::DeleteSAMLProviderRequest>
  void DeleteSAMLProviderAsync(const DeleteSAMLProviderRequestT& request, const DeleteSAMLProviderResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteServerCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteServerCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteServerCertificateRequestT = Model::DeleteServerCertificateRequest>
  void DeleteServerCertificateAsync(const DeleteServerCertificateRequestT& request,
   ...
   * still accessing a resource, then the deletion task fails. If it fails, the <a
   ...
   * more information about removing resources from a service, see the <a
   * href="http://docs.aws.amazon.com/">Amazon Web Services documentation</a> for
   * your service.</p> <p>For more information about service-linked roles, see <a
  ...
  /**
   * A Callable wrapper for DeleteServiceLinkedRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteServiceLinkedRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteServiceLinkedRoleRequestT = Model::DeleteServiceLinkedRoleRequest>
  void DeleteServiceLinkedRoleAsync(const DeleteServiceLinkedRoleRequestT& request,
  ...
  virtual Model::DeleteServiceSpecificCredentialOutcome DeleteServiceSpecificCredential(
      const Model::DeleteServiceSpecificCredentialRequest& request) const;

  /**
   * A Callable wrapper for DeleteServiceSpecificCredential that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteServiceSpecificCredentialRequestT = Model::DeleteServiceSpecificCredentialRequest>
  Model::DeleteServiceSpecificCredentialOutcomeCallable DeleteServiceSpecificCredentialCallable(
      const DeleteServiceSpecificCredentialRequestT& request) const {
    return SubmitCallable(&IAMClient::DeleteServiceSpecificCredential, request);
  }

  /**
   * An Async wrapper for DeleteServiceSpecificCredential that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteServiceSpecificCredentialRequestT = Model::DeleteServiceSpecificCredentialRequest>
  void DeleteServiceSpecificCredentialAsync(const DeleteServiceSpecificCredentialRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteSigningCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSigningCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSigningCertificateRequestT = Model::DeleteSigningCertificateRequest>
  void DeleteSigningCertificateAsync(const DeleteSigningCertificateRequestT& request,
   ...
   * items:</p> <ul> <li> <p>Password (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeleteLoginProfile.html">DeleteLoginProfile</a>)</p>
   * </li> <li> <p>Access keys (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeleteAccessKey.html">DeleteAccessKey</a>)</p>
   * </li> <li> <p>Signing certificate (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeleteSigningCertificate.html">DeleteSigningCertificate</a>)</p>
   * </li> <li> <p>SSH public key (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeleteSSHPublicKey.html">DeleteSSHPublicKey</a>)</p>
   * </li> <li> <p>Git credentials (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeleteServiceSpecificCredential.html">DeleteServiceSpecificCredential</a>)</p>
   * </li> <li> <p>Multi-factor authentication (MFA) device (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeactivateMFADevice.html">DeactivateMFADevice</a>,
   * <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeleteVirtualMFADevice.html">DeleteVirtualMFADevice</a>)</p>
   * </li> <li> <p>Inline policies (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DeleteUserPolicy.html">DeleteUserPolicy</a>)</p>
   * </li> <li> <p>Attached managed policies (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DetachUserPolicy.html">DetachUserPolicy</a>)</p>
   * </li> <li> <p>Group memberships (<a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_RemoveUserFromGroup.html">RemoveUserFromGroup</a>)</p>
   * </li> </ul><p><h3>See Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteUserPermissionsBoundaryOutcome DeleteUserPermissionsBoundary(
      const Model::DeleteUserPermissionsBoundaryRequest& request) const;

  /**
   * A Callable wrapper for DeleteUserPermissionsBoundary that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteUserPermissionsBoundaryRequestT = Model::DeleteUserPermissionsBoundaryRequest>
  Model::DeleteUserPermissionsBoundaryOutcomeCallable DeleteUserPermissionsBoundaryCallable(
      const DeleteUserPermissionsBoundaryRequestT& request) const {
    return SubmitCallable(&IAMClient::DeleteUserPermissionsBoundary, request);
  }

  /**
   * An Async wrapper for DeleteUserPermissionsBoundary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteUserPermissionsBoundaryRequestT = Model::DeleteUserPermissionsBoundaryRequest>
  void DeleteUserPermissionsBoundaryAsync(const DeleteUserPermissionsBoundaryRequestT& request,
   ...
   * managed policy from a user, use <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_DetachUserPolicy.html">DetachUserPolicy</a>.
   * For more information about policies, refer to <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html">Managed
   * policies and inline policies</a> in the <i>IAM User Guide</i>.</p><p><h3>See
  ...
  /**
   * A Callable wrapper for DeleteUserPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteUserPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteUserPolicyRequestT = Model::DeleteUserPolicyRequest>
  void DeleteUserPolicyAsync(const DeleteUserPolicyRequestT& request, const DeleteUserPolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteVirtualMFADevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteVirtualMFADevice that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteVirtualMFADeviceRequestT = Model::DeleteVirtualMFADeviceRequest>
  void DeleteVirtualMFADeviceAsync(const DeleteVirtualMFADeviceRequestT& request,
  ...
  /**
   * A Callable wrapper for DetachGroupPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetachGroupPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetachGroupPolicyRequestT = Model::DetachGroupPolicyRequest>
  void DetachGroupPolicyAsync(const DetachGroupPolicyRequestT& request, const DetachGroupPolicyResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetachRolePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetachRolePolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetachRolePolicyRequestT = Model::DetachRolePolicyRequest>
  void DetachRolePolicyAsync(const DetachRolePolicyRequestT& request, const DetachRolePolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetachUserPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetachUserPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetachUserPolicyRequestT = Model::DetachUserPolicyRequest>
  void DetachUserPolicyAsync(const DetachUserPolicyRequestT& request, const DetachUserPolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableOrganizationsRootCredentialsManagementOutcome DisableOrganizationsRootCredentialsManagement(
      const Model::DisableOrganizationsRootCredentialsManagementRequest& request = {}) const;

  /**
   * A Callable wrapper for DisableOrganizationsRootCredentialsManagement that returns a future to the operation so that it can be executed
  ...
  Model::DisableOrganizationsRootCredentialsManagementOutcomeCallable DisableOrganizationsRootCredentialsManagementCallable(
      const DisableOrganizationsRootCredentialsManagementRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::DisableOrganizationsRootCredentialsManagement, request);
  }

  /**
   * An Async wrapper for DisableOrganizationsRootCredentialsManagement that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DisableOrganizationsRootCredentialsManagementRequestT = Model::DisableOrganizationsRootCredentialsManagementRequest>
  void DisableOrganizationsRootCredentialsManagementAsync(
      const DisableOrganizationsRootCredentialsManagementResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
      const DisableOrganizationsRootCredentialsManagementRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableOrganizationsRootSessionsOutcome DisableOrganizationsRootSessions(
      const Model::DisableOrganizationsRootSessionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DisableOrganizationsRootSessions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisableOrganizationsRootSessionsRequestT = Model::DisableOrganizationsRootSessionsRequest>
  Model::DisableOrganizationsRootSessionsOutcomeCallable DisableOrganizationsRootSessionsCallable(
      const DisableOrganizationsRootSessionsRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::DisableOrganizationsRootSessions, request);
  }

  /**
   * An Async wrapper for DisableOrganizationsRootSessions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisableOrganizationsRootSessionsRequestT = Model::DisableOrganizationsRootSessionsRequest>
  void DisableOrganizationsRootSessionsAsync(const DisableOrganizationsRootSessionsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const DisableOrganizationsRootSessionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for EnableMFADevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableMFADeviceRequestT = Model::EnableMFADeviceRequest>
  void EnableMFADeviceAsync(const EnableMFADeviceRequestT& request, const EnableMFADeviceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableOrganizationsRootCredentialsManagementOutcome EnableOrganizationsRootCredentialsManagement(
      const Model::EnableOrganizationsRootCredentialsManagementRequest& request = {}) const;

  /**
   * A Callable wrapper for EnableOrganizationsRootCredentialsManagement that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::EnableOrganizationsRootCredentialsManagementOutcomeCallable EnableOrganizationsRootCredentialsManagementCallable(
      const EnableOrganizationsRootCredentialsManagementRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::EnableOrganizationsRootCredentialsManagement, request);
  }

  /**
   * An Async wrapper for EnableOrganizationsRootCredentialsManagement that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename EnableOrganizationsRootCredentialsManagementRequestT = Model::EnableOrganizationsRootCredentialsManagementRequest>
  void EnableOrganizationsRootCredentialsManagementAsync(const EnableOrganizationsRootCredentialsManagementResponseReceivedHandler& handler,
                                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                         const EnableOrganizationsRootCredentialsManagementRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableOrganizationsRootSessionsOutcome EnableOrganizationsRootSessions(
      const Model::EnableOrganizationsRootSessionsRequest& request = {}) const;

  /**
   * A Callable wrapper for EnableOrganizationsRootSessions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename EnableOrganizationsRootSessionsRequestT = Model::EnableOrganizationsRootSessionsRequest>
  Model::EnableOrganizationsRootSessionsOutcomeCallable EnableOrganizationsRootSessionsCallable(
  ...
  /**
   * An Async wrapper for EnableOrganizationsRootSessions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename EnableOrganizationsRootSessionsRequestT = Model::EnableOrganizationsRootSessionsRequest>
  void EnableOrganizationsRootSessionsAsync(const EnableOrganizationsRootSessionsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const EnableOrganizationsRootSessionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GenerateCredentialReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GenerateCredentialReportRequestT = Model::GenerateCredentialReportRequest>
  Model::GenerateCredentialReportOutcomeCallable GenerateCredentialReportCallable(
      const GenerateCredentialReportRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::GenerateCredentialReport, request);
  }

  /**
   * An Async wrapper for GenerateCredentialReport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GenerateCredentialReportRequestT = Model::GenerateCredentialReportRequest>
  void GenerateCredentialReportAsync(const GenerateCredentialReportResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const GenerateCredentialReportRequestT& request = {}) const {
   ...
   * </code> operation to check the status of the report generation. To check the
   * status of this request, use the <code>JobId</code> parameter in the <code> <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetOrganizationsAccessReport.html">GetOrganizationsAccessReport</a>
   ...
   * API Reference</a></p>
   */
  virtual Model::GenerateOrganizationsAccessReportOutcome GenerateOrganizationsAccessReport(
      const Model::GenerateOrganizationsAccessReportRequest& request) const;

  /**
   * A Callable wrapper for GenerateOrganizationsAccessReport that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GenerateOrganizationsAccessReportRequestT = Model::GenerateOrganizationsAccessReportRequest>
  Model::GenerateOrganizationsAccessReportOutcomeCallable GenerateOrganizationsAccessReportCallable(
      const GenerateOrganizationsAccessReportRequestT& request) const {
    return SubmitCallable(&IAMClient::GenerateOrganizationsAccessReport, request);
  }

  /**
   * An Async wrapper for GenerateOrganizationsAccessReport that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GenerateOrganizationsAccessReportRequestT = Model::GenerateOrganizationsAccessReportRequest>
  void GenerateOrganizationsAccessReportAsync(const GenerateOrganizationsAccessReportRequestT& request,
   ...
   * the following details from your report: </p> <ul> <li> <p> <a
   ...
   * – Use this operation for users, groups, roles, or policies to list every Amazon
   * Web Services service that the resource could access using permissions policies.
   * For each service, the response includes information about the most recent access
   * attempt.</p> <p>The <code>JobId</code> returned by
   * <code>GenerateServiceLastAccessedDetail</code> must be used by the same role
   * within a session, or by the same user when used to call
   * <code>GetServiceLastAccessedDetail</code>.</p> </li> <li> <p> <a
   ...
   * Web Services service. </p> </li> </ul> <p>To check the status of the
   ...
   * access specific services, use the <a
   ...
   * API Reference</a></p>
   */
  virtual Model::GenerateServiceLastAccessedDetailsOutcome GenerateServiceLastAccessedDetails(
      const Model::GenerateServiceLastAccessedDetailsRequest& request) const;

  /**
   * A Callable wrapper for GenerateServiceLastAccessedDetails that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GenerateServiceLastAccessedDetailsRequestT = Model::GenerateServiceLastAccessedDetailsRequest>
  Model::GenerateServiceLastAccessedDetailsOutcomeCallable GenerateServiceLastAccessedDetailsCallable(
      const GenerateServiceLastAccessedDetailsRequestT& request) const {
    return SubmitCallable(&IAMClient::GenerateServiceLastAccessedDetails, request);
  }

  /**
   * An Async wrapper for GenerateServiceLastAccessedDetails that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GenerateServiceLastAccessedDetailsRequestT = Model::GenerateServiceLastAccessedDetailsRequest>
  void GenerateServiceLastAccessedDetailsAsync(const GenerateServiceLastAccessedDetailsRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAccessKeyLastUsed that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccessKeyLastUsed that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccessKeyLastUsedRequestT = Model::GetAccessKeyLastUsedRequest>
  void GetAccessKeyLastUsedAsync(const GetAccessKeyLastUsedRequestT& request, const GetAccessKeyLastUsedResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * and SDKs provide similar functionality, and some SDKs do this decoding
   * automatically.</p>  <p>You can optionally filter the results using the
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAccountAuthorizationDetailsOutcome GetAccountAuthorizationDetails(
      const Model::GetAccountAuthorizationDetailsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetAccountAuthorizationDetails that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetAccountAuthorizationDetailsRequestT = Model::GetAccountAuthorizationDetailsRequest>
  Model::GetAccountAuthorizationDetailsOutcomeCallable GetAccountAuthorizationDetailsCallable(
      const GetAccountAuthorizationDetailsRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::GetAccountAuthorizationDetails, request);
  }

  /**
   * An Async wrapper for GetAccountAuthorizationDetails that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetAccountAuthorizationDetailsRequestT = Model::GetAccountAuthorizationDetailsRequest>
  void GetAccountAuthorizationDetailsAsync(const GetAccountAuthorizationDetailsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const GetAccountAuthorizationDetailsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetAccountPasswordPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetAccountPasswordPolicyRequestT = Model::GetAccountPasswordPolicyRequest>
  Model::GetAccountPasswordPolicyOutcomeCallable GetAccountPasswordPolicyCallable(
      const GetAccountPasswordPolicyRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::GetAccountPasswordPolicy, request);
  }

  /**
   * An Async wrapper for GetAccountPasswordPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccountPasswordPolicyRequestT = Model::GetAccountPasswordPolicyRequest>
  void GetAccountPasswordPolicyAsync(const GetAccountPasswordPolicyResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const GetAccountPasswordPolicyRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetAccountSummary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccountSummary that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAccountSummaryRequestT = Model::GetAccountSummaryRequest>
  void GetAccountSummaryAsync(const GetAccountSummaryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetAccountSummaryRequestT& request = {}) const {
   ...
   * from policies associated with an IAM user, group, or role, use <a
   ...
   * <p>Context keys are variables maintained by Amazon Web Services and its services
   ...
   * values you must supply when you call <a
   ...
   * be URL encoded to be included as a part of a real HTML request.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/GetContextKeysForCustomPolicy">AWS
   * API Reference</a></p>
   */
  virtual Model::GetContextKeysForCustomPolicyOutcome GetContextKeysForCustomPolicy(
      const Model::GetContextKeysForCustomPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetContextKeysForCustomPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetContextKeysForCustomPolicyRequestT = Model::GetContextKeysForCustomPolicyRequest>
  Model::GetContextKeysForCustomPolicyOutcomeCallable GetContextKeysForCustomPolicyCallable(
      const GetContextKeysForCustomPolicyRequestT& request) const {
    return SubmitCallable(&IAMClient::GetContextKeysForCustomPolicy, request);
  }

  /**
   * An Async wrapper for GetContextKeysForCustomPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetContextKeysForCustomPolicyRequestT = Model::GetContextKeysForCustomPolicyRequest>
  void GetContextKeysForCustomPolicyAsync(const GetContextKeysForCustomPolicyRequestT& request,
   ...
   * strings. If you want to include <i>only</i> a list of policies by string, use <a
   ...
   * instead.</p> <p> <b>Note:</b> This operation discloses information about the
   ...
   * its services that provide details about the context of an API query request.
   * Context keys can be evaluated by testing against a value in an IAM policy. Use
   * <a
   ...
   * API Reference</a></p>
   */
  virtual Model::GetContextKeysForPrincipalPolicyOutcome GetContextKeysForPrincipalPolicy(
      const Model::GetContextKeysForPrincipalPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetContextKeysForPrincipalPolicy that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetContextKeysForPrincipalPolicyRequestT = Model::GetContextKeysForPrincipalPolicyRequest>
  Model::GetContextKeysForPrincipalPolicyOutcomeCallable GetContextKeysForPrincipalPolicyCallable(
      const GetContextKeysForPrincipalPolicyRequestT& request) const {
    return SubmitCallable(&IAMClient::GetContextKeysForPrincipalPolicy, request);
  }

  /**
   * An Async wrapper for GetContextKeysForPrincipalPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetContextKeysForPrincipalPolicyRequestT = Model::GetContextKeysForPrincipalPolicyRequest>
  void GetContextKeysForPrincipalPolicyAsync(const GetContextKeysForPrincipalPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for GetCredentialReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCredentialReport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCredentialReportRequestT = Model::GetCredentialReportRequest>
  void GetCredentialReportAsync(const GetCredentialReportResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetCredentialReportRequestT& request = {}) const {
   ...
   * Other languages and SDKs provide similar functionality, and some SDKs do this
   * decoding automatically.</p>  <p>An IAM group can also have managed
   * policies attached to it. To retrieve a managed policy document that is attached
   * to a group, use <a
   ...
   * to retrieve the policy document.</p> <p>For more information about policies, see
   * <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html">Managed
   * policies and inline policies</a> in the <i>IAM User Guide</i>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * An Async wrapper for GetGroupPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGroupPolicyRequestT = Model::GetGroupPolicyRequest>
  ...
  /**
   * A Callable wrapper for GetInstanceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInstanceProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetInstanceProfileRequestT = Model::GetInstanceProfileRequest>
  void GetInstanceProfileAsync(const GetInstanceProfileRequestT& request, const GetInstanceProfileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetLoginProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLoginProfileRequestT = Model::GetLoginProfileRequest>
  void GetLoginProfileAsync(const GetLoginProfileResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const GetLoginProfileRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetMFADevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMFADeviceRequestT = Model::GetMFADeviceRequest>
  void GetMFADeviceAsync(const GetMFADeviceRequestT& request, const GetMFADeviceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetOpenIDConnectProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOpenIDConnectProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOpenIDConnectProviderRequestT = Model::GetOpenIDConnectProviderRequest>
  void GetOpenIDConnectProviderAsync(const GetOpenIDConnectProviderRequestT& request,
   ...
   * details, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GenerateOrganizationsAccessReport.html">GenerateOrganizationsAccessReport</a>.</p>
   * <p>To call this operation, you must be signed in to the management account in
   * your organization. SCPs must be enabled for your organization root. You must
   * have permissions to perform this operation. For more information, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html">Refining
   * permissions using service last accessed data</a> in the <i>IAM User
  ...
  virtual Model::GetOrganizationsAccessReportOutcome GetOrganizationsAccessReport(
      const Model::GetOrganizationsAccessReportRequest& request) const;

  /**
   * A Callable wrapper for GetOrganizationsAccessReport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetOrganizationsAccessReportRequestT = Model::GetOrganizationsAccessReportRequest>
  Model::GetOrganizationsAccessReportOutcomeCallable GetOrganizationsAccessReportCallable(
      const GetOrganizationsAccessReportRequestT& request) const {
    return SubmitCallable(&IAMClient::GetOrganizationsAccessReport, request);
  }

  /**
   * An Async wrapper for GetOrganizationsAccessReport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOrganizationsAccessReportRequestT = Model::GetOrganizationsAccessReportRequest>
  void GetOrganizationsAccessReportAsync(const GetOrganizationsAccessReportRequestT& request,
   ...
   * groups, and roles that the policy is attached to, use <a
   ...
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetPolicyVersion.html">GetPolicyVersion</a>.</p>
   ...
   * or <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetRolePolicy.html">GetRolePolicy</a>.</p>
   ...
   * <code>java.net.URLDecoder</code> utility class in the Java SDK. Other languages
   * and SDKs provide similar functionality, and some SDKs do this decoding
   * automatically.</p>  <p>To list the available versions for a policy, use
   * <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListPolicyVersions.html">ListPolicyVersions</a>.</p>
   * <p>This operation retrieves information about managed policies. To retrieve
   ...
   * or <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetRolePolicy.html">GetRolePolicy</a>.</p>
   * <p>For more information about the types of policies, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html">Managed
  ...
  /**
   * A Callable wrapper for GetPolicyVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPolicyVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPolicyVersionRequestT = Model::GetPolicyVersionRequest>
  void GetPolicyVersionAsync(const GetPolicyVersionRequestT& request, const GetPolicyVersionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRole that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRoleRequestT = Model::GetRoleRequest>
  void GetRoleAsync(const GetRoleRequestT& request, const GetRoleResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * method of the <code>java.net.URLDecoder</code> utility class in the Java SDK.
   * Other languages and SDKs provide similar functionality, and some SDKs do this
   * decoding automatically.</p>  <p>An IAM role can also have managed
   * policies attached to it. To retrieve a managed policy document that is attached
   * to a role, use <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetPolicy.html">GetPolicy</a>
   * to determine the policy's default version, then use <a
  ...
  /**
   * An Async wrapper for GetRolePolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRolePolicyRequestT = Model::GetRolePolicyRequest>
  ...
  /**
   * An Async wrapper for GetSAMLProvider that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSAMLProviderRequestT = Model::GetSAMLProviderRequest>
  void GetSAMLProviderAsync(const GetSAMLProviderRequestT& request, const GetSAMLProviderResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSSHPublicKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSSHPublicKeyRequestT = Model::GetSSHPublicKeyRequest>
  void GetSSHPublicKeyAsync(const GetSSHPublicKeyRequestT& request, const GetSSHPublicKeyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetServerCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetServerCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetServerCertificateRequestT = Model::GetServerCertificateRequest>
  void GetServerCertificateAsync(const GetServerCertificateRequestT& request, const GetServerCertificateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetServiceLastAccessedDetailsOutcome GetServiceLastAccessedDetails(
      const Model::GetServiceLastAccessedDetailsRequest& request) const;

  /**
   * A Callable wrapper for GetServiceLastAccessedDetails that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetServiceLastAccessedDetailsRequestT = Model::GetServiceLastAccessedDetailsRequest>
  Model::GetServiceLastAccessedDetailsOutcomeCallable GetServiceLastAccessedDetailsCallable(
      const GetServiceLastAccessedDetailsRequestT& request) const {
    return SubmitCallable(&IAMClient::GetServiceLastAccessedDetails, request);
  }

  /**
   * An Async wrapper for GetServiceLastAccessedDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetServiceLastAccessedDetailsRequestT = Model::GetServiceLastAccessedDetailsRequest>
  void GetServiceLastAccessedDetailsAsync(const GetServiceLastAccessedDetailsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetServiceLastAccessedDetailsWithEntitiesOutcome GetServiceLastAccessedDetailsWithEntities(
      const Model::GetServiceLastAccessedDetailsWithEntitiesRequest& request) const;

  /**
   * A Callable wrapper for GetServiceLastAccessedDetailsWithEntities that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::GetServiceLastAccessedDetailsWithEntitiesOutcomeCallable GetServiceLastAccessedDetailsWithEntitiesCallable(
      const GetServiceLastAccessedDetailsWithEntitiesRequestT& request) const {
    return SubmitCallable(&IAMClient::GetServiceLastAccessedDetailsWithEntities, request);
  }

  /**
   * An Async wrapper for GetServiceLastAccessedDetailsWithEntities that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetServiceLastAccessedDetailsWithEntitiesRequestT = Model::GetServiceLastAccessedDetailsWithEntitiesRequest>
  void GetServiceLastAccessedDetailsWithEntitiesAsync(
      const GetServiceLastAccessedDetailsWithEntitiesRequestT& request,
  ...
  /**
   * <p>Retrieves the status of your service-linked role deletion. After you use <a
   ...
   * API Reference</a></p>
   */
  virtual Model::GetServiceLinkedRoleDeletionStatusOutcome GetServiceLinkedRoleDeletionStatus(
      const Model::GetServiceLinkedRoleDeletionStatusRequest& request) const;

  /**
   * A Callable wrapper for GetServiceLinkedRoleDeletionStatus that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetServiceLinkedRoleDeletionStatusRequestT = Model::GetServiceLinkedRoleDeletionStatusRequest>
  Model::GetServiceLinkedRoleDeletionStatusOutcomeCallable GetServiceLinkedRoleDeletionStatusCallable(
      const GetServiceLinkedRoleDeletionStatusRequestT& request) const {
    return SubmitCallable(&IAMClient::GetServiceLinkedRoleDeletionStatus, request);
  }

  /**
   * An Async wrapper for GetServiceLinkedRoleDeletionStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetServiceLinkedRoleDeletionStatusRequestT = Model::GetServiceLinkedRoleDeletionStatusRequest>
  void GetServiceLinkedRoleDeletionStatusAsync(const GetServiceLinkedRoleDeletionStatusRequestT& request,
   ...
   */
  template <typename GetUserRequestT = Model::GetUserRequest>
  void GetUserAsync(const GetUserResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                    const GetUserRequestT& request = {}) const {
   ...
   * method of the <code>java.net.URLDecoder</code> utility class in the Java SDK.
   * Other languages and SDKs provide similar functionality, and some SDKs do this
   * decoding automatically.</p>  <p>An IAM user can also have managed
   * policies attached to it. To retrieve a managed policy document that is attached
   * to a user, use <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetPolicy.html">GetPolicy</a>
   * to determine the policy's default version. Then use <a
  ...
  /**
   * An Async wrapper for GetUserPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetUserPolicyRequestT = Model::GetUserPolicyRequest>
  void GetUserPolicyAsync(const GetUserPolicyRequestT& request, const GetUserPolicyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAccessKeys that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAccessKeysRequestT = Model::ListAccessKeysRequest>
  void ListAccessKeysAsync(const ListAccessKeysResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListAccessKeysRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListAccountAliases that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccountAliases that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAccountAliasesRequestT = Model::ListAccountAliasesRequest>
  void ListAccountAliasesAsync(const ListAccountAliasesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListAccountAliasesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListAttachedGroupPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListAttachedGroupPoliciesRequestT = Model::ListAttachedGroupPoliciesRequest>
  Model::ListAttachedGroupPoliciesOutcomeCallable ListAttachedGroupPoliciesCallable(
      const ListAttachedGroupPoliciesRequestT& request) const {
    return SubmitCallable(&IAMClient::ListAttachedGroupPolicies, request);
  }

  /**
   * An Async wrapper for ListAttachedGroupPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAttachedGroupPoliciesRequestT = Model::ListAttachedGroupPoliciesRequest>
  void ListAttachedGroupPoliciesAsync(const ListAttachedGroupPoliciesRequestT& request,
  ...
  /**
   * A Callable wrapper for ListAttachedRolePolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAttachedRolePolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAttachedRolePoliciesRequestT = Model::ListAttachedRolePoliciesRequest>
  void ListAttachedRolePoliciesAsync(const ListAttachedRolePoliciesRequestT& request,
  ...
  /**
   * A Callable wrapper for ListAttachedUserPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAttachedUserPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAttachedUserPoliciesRequestT = Model::ListAttachedUserPoliciesRequest>
  void ListAttachedUserPoliciesAsync(const ListAttachedUserPoliciesRequestT& request,
  ...
  /**
   * A Callable wrapper for ListEntitiesForPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEntitiesForPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEntitiesForPolicyRequestT = Model::ListEntitiesForPolicyRequest>
  void ListEntitiesForPolicyAsync(const ListEntitiesForPolicyRequestT& request, const ListEntitiesForPolicyResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * list the managed policies that are attached to a group, use <a
  ...
  /**
   * A Callable wrapper for ListGroupPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGroupPolicies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGroupPoliciesRequestT = Model::ListGroupPoliciesRequest>
  void ListGroupPoliciesAsync(const ListGroupPoliciesRequestT& request, const ListGroupPoliciesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListGroupsForUser that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGroupsForUser that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGroupsForUserRequestT = Model::ListGroupsForUserRequest>
  void ListGroupsForUserAsync(const ListGroupsForUserRequestT& request, const ListGroupsForUserResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListInstanceProfileTags that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInstanceProfileTags that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInstanceProfileTagsRequestT = Model::ListInstanceProfileTagsRequest>
  void ListInstanceProfileTagsAsync(const ListInstanceProfileTagsRequestT& request,
                                    const ListInstanceProfileTagsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * instance profile, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetInstanceProfile.html">GetInstanceProfile</a>.</p>
  ...
  /**
   * A Callable wrapper for ListInstanceProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInstanceProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInstanceProfilesRequestT = Model::ListInstanceProfilesRequest>
  void ListInstanceProfilesAsync(const ListInstanceProfilesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListInstanceProfilesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListInstanceProfilesForRoleOutcome ListInstanceProfilesForRole(
      const Model::ListInstanceProfilesForRoleRequest& request) const;

  /**
   * A Callable wrapper for ListInstanceProfilesForRole that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListInstanceProfilesForRoleRequestT = Model::ListInstanceProfilesForRoleRequest>
  Model::ListInstanceProfilesForRoleOutcomeCallable ListInstanceProfilesForRoleCallable(
      const ListInstanceProfilesForRoleRequestT& request) const {
    return SubmitCallable(&IAMClient::ListInstanceProfilesForRole, request);
  }

  /**
   * An Async wrapper for ListInstanceProfilesForRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInstanceProfilesForRoleRequestT = Model::ListInstanceProfilesForRoleRequest>
  void ListInstanceProfilesForRoleAsync(const ListInstanceProfilesForRoleRequestT& request,
  ...
  /**
   * A Callable wrapper for ListMFADeviceTags that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMFADeviceTags that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMFADeviceTagsRequestT = Model::ListMFADeviceTagsRequest>
  void ListMFADeviceTagsAsync(const ListMFADeviceTagsRequestT& request, const ListMFADeviceTagsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListMFADevices that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMFADevicesRequestT = Model::ListMFADevicesRequest>
  void ListMFADevicesAsync(const ListMFADevicesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListMFADevicesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListOpenIDConnectProviderTagsOutcome ListOpenIDConnectProviderTags(
      const Model::ListOpenIDConnectProviderTagsRequest& request) const;

  /**
   * A Callable wrapper for ListOpenIDConnectProviderTags that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListOpenIDConnectProviderTagsRequestT = Model::ListOpenIDConnectProviderTagsRequest>
  Model::ListOpenIDConnectProviderTagsOutcomeCallable ListOpenIDConnectProviderTagsCallable(
      const ListOpenIDConnectProviderTagsRequestT& request) const {
    return SubmitCallable(&IAMClient::ListOpenIDConnectProviderTags, request);
  }

  /**
   * An Async wrapper for ListOpenIDConnectProviderTags that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOpenIDConnectProviderTagsRequestT = Model::ListOpenIDConnectProviderTagsRequest>
  void ListOpenIDConnectProviderTagsAsync(const ListOpenIDConnectProviderTagsRequestT& request,
                                          const ListOpenIDConnectProviderTagsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * provider, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetOpenIDConnectProvider.html">GetOpenIDConnectProvider</a>.</p>
   * <p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/ListOpenIDConnectProviders">AWS
   * API Reference</a></p>
   */
  virtual Model::ListOpenIDConnectProvidersOutcome ListOpenIDConnectProviders(
      const Model::ListOpenIDConnectProvidersRequest& request = {}) const;

  /**
   * A Callable wrapper for ListOpenIDConnectProviders that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListOpenIDConnectProvidersRequestT = Model::ListOpenIDConnectProvidersRequest>
  Model::ListOpenIDConnectProvidersOutcomeCallable ListOpenIDConnectProvidersCallable(
      const ListOpenIDConnectProvidersRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::ListOpenIDConnectProviders, request);
  }

  /**
   * An Async wrapper for ListOpenIDConnectProviders that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOpenIDConnectProvidersRequestT = Model::ListOpenIDConnectProvidersRequest>
  void ListOpenIDConnectProvidersAsync(const ListOpenIDConnectProvidersResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListOpenIDConnectProvidersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListOrganizationsFeaturesOutcome ListOrganizationsFeatures(
      const Model::ListOrganizationsFeaturesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListOrganizationsFeatures that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListOrganizationsFeaturesRequestT = Model::ListOrganizationsFeaturesRequest>
  Model::ListOrganizationsFeaturesOutcomeCallable ListOrganizationsFeaturesCallable(
      const ListOrganizationsFeaturesRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::ListOrganizationsFeatures, request);
  }

  /**
   * An Async wrapper for ListOrganizationsFeatures that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOrganizationsFeaturesRequestT = Model::ListOrganizationsFeaturesRequest>
  void ListOrganizationsFeaturesAsync(const ListOrganizationsFeaturesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListOrganizationsFeaturesRequestT& request = {}) const {
   ...
   * customer manged policy, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetPolicy.html">GetPolicy</a>.</p>
   * <p><h3>See Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPoliciesGrantingServiceAccessOutcome ListPoliciesGrantingServiceAccess(
      const Model::ListPoliciesGrantingServiceAccessRequest& request) const;

  /**
   * A Callable wrapper for ListPoliciesGrantingServiceAccess that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListPoliciesGrantingServiceAccessRequestT = Model::ListPoliciesGrantingServiceAccessRequest>
  Model::ListPoliciesGrantingServiceAccessOutcomeCallable ListPoliciesGrantingServiceAccessCallable(
      const ListPoliciesGrantingServiceAccessRequestT& request) const {
    return SubmitCallable(&IAMClient::ListPoliciesGrantingServiceAccess, request);
  }

  /**
   * An Async wrapper for ListPoliciesGrantingServiceAccess that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListPoliciesGrantingServiceAccessRequestT = Model::ListPoliciesGrantingServiceAccessRequest>
  void ListPoliciesGrantingServiceAccessAsync(const ListPoliciesGrantingServiceAccessRequestT& request,
  ...
  /**
   * An Async wrapper for ListPolicyTags that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPolicyTagsRequestT = Model::ListPolicyTagsRequest>
  void ListPolicyTagsAsync(const ListPolicyTagsRequestT& request, const ListPolicyTagsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPolicyVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPolicyVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPolicyVersionsRequestT = Model::ListPolicyVersionsRequest>
  void ListPolicyVersionsAsync(const ListPolicyVersionsRequestT& request, const ListPolicyVersionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * the managed policies that are attached to a role, use <a
  ...
  /**
   * A Callable wrapper for ListRolePolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRolePolicies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRolePoliciesRequestT = Model::ListRolePoliciesRequest>
  void ListRolePoliciesAsync(const ListRolePoliciesRequestT& request, const ListRolePoliciesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListRoleTags that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRoleTagsRequestT = Model::ListRoleTagsRequest>
  void ListRoleTagsAsync(const ListRoleTagsRequestT& request, const ListRoleTagsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * the information for a role, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetRole.html">GetRole</a>.</p>
   *  <p>You can paginate the results using the <code>MaxItems</code> and
   * <code>Marker</code> parameters.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * An Async wrapper for ListRoles that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRolesRequestT = Model::ListRolesRequest>
  void ListRolesAsync(const ListRolesResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListRolesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSAMLProviderTags that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSAMLProviderTags that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSAMLProviderTagsRequestT = Model::ListSAMLProviderTagsRequest>
  void ListSAMLProviderTagsAsync(const ListSAMLProviderTagsRequestT& request, const ListSAMLProviderTagsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * provider, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetSAMLProvider.html">GetSAMLProvider</a>.</p>
  ...
  /**
   * A Callable wrapper for ListSAMLProviders that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSAMLProviders that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSAMLProvidersRequestT = Model::ListSAMLProvidersRequest>
  void ListSAMLProvidersAsync(const ListSAMLProvidersResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListSAMLProvidersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSSHPublicKeys that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSSHPublicKeys that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSSHPublicKeysRequestT = Model::ListSSHPublicKeysRequest>
  void ListSSHPublicKeysAsync(const ListSSHPublicKeysResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListSSHPublicKeysRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListServerCertificateTags that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListServerCertificateTagsRequestT = Model::ListServerCertificateTagsRequest>
  Model::ListServerCertificateTagsOutcomeCallable ListServerCertificateTagsCallable(
      const ListServerCertificateTagsRequestT& request) const {
    return SubmitCallable(&IAMClient::ListServerCertificateTags, request);
  }

  /**
   * An Async wrapper for ListServerCertificateTags that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListServerCertificateTagsRequestT = Model::ListServerCertificateTagsRequest>
  void ListServerCertificateTagsAsync(const ListServerCertificateTagsRequestT& request,
                                      const ListServerCertificateTagsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * see <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetServerCertificate.html">GetServerCertificate</a>.</p>
   * <p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for ListServerCertificates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServerCertificates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListServerCertificatesRequestT = Model::ListServerCertificatesRequest>
  void ListServerCertificatesAsync(const ListServerCertificatesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListServerCertificatesRequestT& request = {}) const {
   ...
   * service, refer to the following docs:</p> <ul> <li> <p>For service-specific
   * credentials with CodeCommit, refer to <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_ssh-keys.html">IAM
   * credentials for CodeCommit: Git credentials, SSH keys, and Amazon Web Services
   * access keys</a> in the <i>IAM User Guide</i>.</p> </li> <li> <p>For
   * service-specific credentials with Amazon Keyspaces (for Apache Cassandra), refer
   ...
   * API Reference</a></p>
   */
  virtual Model::ListServiceSpecificCredentialsOutcome ListServiceSpecificCredentials(
      const Model::ListServiceSpecificCredentialsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListServiceSpecificCredentials that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListServiceSpecificCredentialsRequestT = Model::ListServiceSpecificCredentialsRequest>
  Model::ListServiceSpecificCredentialsOutcomeCallable ListServiceSpecificCredentialsCallable(
      const ListServiceSpecificCredentialsRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::ListServiceSpecificCredentials, request);
  }

  /**
   * An Async wrapper for ListServiceSpecificCredentials that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListServiceSpecificCredentialsRequestT = Model::ListServiceSpecificCredentialsRequest>
  void ListServiceSpecificCredentialsAsync(const ListServiceSpecificCredentialsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListServiceSpecificCredentialsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSigningCertificates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSigningCertificates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSigningCertificatesRequestT = Model::ListSigningCertificatesRequest>
  void ListSigningCertificatesAsync(const ListSigningCertificatesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListSigningCertificatesRequestT& request = {}) const {
   ...
   * the managed policies that are attached to a user, use <a
  ...
  /**
   * A Callable wrapper for ListUserPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListUserPolicies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListUserPoliciesRequestT = Model::ListUserPoliciesRequest>
  void ListUserPoliciesAsync(const ListUserPoliciesRequestT& request, const ListUserPoliciesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListUserTags that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListUserTagsRequestT = Model::ListUserTagsRequest>
  void ListUserTagsAsync(const ListUserTagsRequestT& request, const ListUserTagsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * the information for a user, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetUser.html">GetUser</a>.</p>
   *  <p>You can paginate the results using the <code>MaxItems</code> and
   * <code>Marker</code> parameters.</p><p><h3>See Also:</h3>   <a
   ...
   */
  template <typename ListUsersRequestT = Model::ListUsersRequest>
  void ListUsersAsync(const ListUsersResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListUsersRequestT& request = {}) const {
   ...
   * virtual MFA device, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListMFADeviceTags.html">ListMFADeviceTags</a>.</p>
   *  <p>You can paginate the results using the <code>MaxItems</code> and
   * <code>Marker</code> parameters.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for ListVirtualMFADevices that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListVirtualMFADevices that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVirtualMFADevicesRequestT = Model::ListVirtualMFADevicesRequest>
  void ListVirtualMFADevicesAsync(const ListVirtualMFADevicesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
  ...
  /**
   * An Async wrapper for PutGroupPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutGroupPolicyRequestT = Model::PutGroupPolicyRequest>
  void PutGroupPolicyAsync(const PutGroupPolicyRequestT& request, const PutGroupPolicyResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutRolePermissionsBoundaryOutcome PutRolePermissionsBoundary(
      const Model::PutRolePermissionsBoundaryRequest& request) const;

  /**
   * A Callable wrapper for PutRolePermissionsBoundary that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutRolePermissionsBoundaryRequestT = Model::PutRolePermissionsBoundaryRequest>
  Model::PutRolePermissionsBoundaryOutcomeCallable PutRolePermissionsBoundaryCallable(
      const PutRolePermissionsBoundaryRequestT& request) const {
    return SubmitCallable(&IAMClient::PutRolePermissionsBoundary, request);
  }

  /**
   * An Async wrapper for PutRolePermissionsBoundary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRolePermissionsBoundaryRequestT = Model::PutRolePermissionsBoundaryRequest>
  void PutRolePermissionsBoundaryAsync(const PutRolePermissionsBoundaryRequestT& request,
                                       const PutRolePermissionsBoundaryResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutRolePolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutRolePolicyRequestT = Model::PutRolePolicyRequest>
  void PutRolePolicyAsync(const PutRolePolicyRequestT& request, const PutRolePolicyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutUserPermissionsBoundaryOutcome PutUserPermissionsBoundary(
      const Model::PutUserPermissionsBoundaryRequest& request) const;

  /**
   * A Callable wrapper for PutUserPermissionsBoundary that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutUserPermissionsBoundaryRequestT = Model::PutUserPermissionsBoundaryRequest>
  Model::PutUserPermissionsBoundaryOutcomeCallable PutUserPermissionsBoundaryCallable(
      const PutUserPermissionsBoundaryRequestT& request) const {
    return SubmitCallable(&IAMClient::PutUserPermissionsBoundary, request);
  }

  /**
   * An Async wrapper for PutUserPermissionsBoundary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutUserPermissionsBoundaryRequestT = Model::PutUserPermissionsBoundaryRequest>
  void PutUserPermissionsBoundaryAsync(const PutUserPermissionsBoundaryRequestT& request,
                                       const PutUserPermissionsBoundaryResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutUserPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutUserPolicyRequestT = Model::PutUserPolicyRequest>
  void PutUserPolicyAsync(const PutUserPolicyRequestT& request, const PutUserPolicyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::RemoveClientIDFromOpenIDConnectProviderOutcome RemoveClientIDFromOpenIDConnectProvider(
      const Model::RemoveClientIDFromOpenIDConnectProviderRequest& request) const;

  /**
   * A Callable wrapper for RemoveClientIDFromOpenIDConnectProvider that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename RemoveClientIDFromOpenIDConnectProviderRequestT = Model::RemoveClientIDFromOpenIDConnectProviderRequest>
  Model::RemoveClientIDFromOpenIDConnectProviderOutcomeCallable RemoveClientIDFromOpenIDConnectProviderCallable(
      const RemoveClientIDFromOpenIDConnectProviderRequestT& request) const {
    return SubmitCallable(&IAMClient::RemoveClientIDFromOpenIDConnectProvider, request);
  }

  /**
   * An Async wrapper for RemoveClientIDFromOpenIDConnectProvider that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename RemoveClientIDFromOpenIDConnectProviderRequestT = Model::RemoveClientIDFromOpenIDConnectProviderRequest>
  void RemoveClientIDFromOpenIDConnectProviderAsync(const RemoveClientIDFromOpenIDConnectProviderRequestT& request,
                                                    const RemoveClientIDFromOpenIDConnectProviderResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveRoleFromInstanceProfileOutcome RemoveRoleFromInstanceProfile(
      const Model::RemoveRoleFromInstanceProfileRequest& request) const;

  /**
   * A Callable wrapper for RemoveRoleFromInstanceProfile that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveRoleFromInstanceProfileRequestT = Model::RemoveRoleFromInstanceProfileRequest>
  Model::RemoveRoleFromInstanceProfileOutcomeCallable RemoveRoleFromInstanceProfileCallable(
      const RemoveRoleFromInstanceProfileRequestT& request) const {
    return SubmitCallable(&IAMClient::RemoveRoleFromInstanceProfile, request);
  }

  /**
   * An Async wrapper for RemoveRoleFromInstanceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveRoleFromInstanceProfileRequestT = Model::RemoveRoleFromInstanceProfileRequest>
  void RemoveRoleFromInstanceProfileAsync(const RemoveRoleFromInstanceProfileRequestT& request,
                                          const RemoveRoleFromInstanceProfileResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RemoveUserFromGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveUserFromGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RemoveUserFromGroupRequestT = Model::RemoveUserFromGroupRequest>
  void RemoveUserFromGroupAsync(const RemoveUserFromGroupRequestT& request, const RemoveUserFromGroupResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ResetServiceSpecificCredentialOutcome ResetServiceSpecificCredential(
      const Model::ResetServiceSpecificCredentialRequest& request) const;

  /**
   * A Callable wrapper for ResetServiceSpecificCredential that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ResetServiceSpecificCredentialRequestT = Model::ResetServiceSpecificCredentialRequest>
  Model::ResetServiceSpecificCredentialOutcomeCallable ResetServiceSpecificCredentialCallable(
      const ResetServiceSpecificCredentialRequestT& request) const {
    return SubmitCallable(&IAMClient::ResetServiceSpecificCredential, request);
  }

  /**
   * An Async wrapper for ResetServiceSpecificCredential that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ResetServiceSpecificCredentialRequestT = Model::ResetServiceSpecificCredentialRequest>
  void ResetServiceSpecificCredentialAsync(const ResetServiceSpecificCredentialRequestT& request,
                                           const ResetServiceSpecificCredentialResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ResyncMFADevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResyncMFADeviceRequestT = Model::ResyncMFADeviceRequest>
   ...
   * policy is attached to, use <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListEntitiesForPolicy.html">ListEntitiesForPolicy</a>.</p>
   * <p>For information about managed policies, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html">Managed
   * policies and inline policies</a> in the <i>IAM User Guide</i>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for SetDefaultPolicyVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetDefaultPolicyVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetDefaultPolicyVersionRequestT = Model::SetDefaultPolicyVersionRequest>
  void SetDefaultPolicyVersionAsync(const SetDefaultPolicyVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SetSecurityTokenServicePreferencesOutcome SetSecurityTokenServicePreferences(
      const Model::SetSecurityTokenServicePreferencesRequest& request) const;

  /**
   * A Callable wrapper for SetSecurityTokenServicePreferences that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename SetSecurityTokenServicePreferencesRequestT = Model::SetSecurityTokenServicePreferencesRequest>
  Model::SetSecurityTokenServicePreferencesOutcomeCallable SetSecurityTokenServicePreferencesCallable(
      const SetSecurityTokenServicePreferencesRequestT& request) const {
    return SubmitCallable(&IAMClient::SetSecurityTokenServicePreferences, request);
  }

  /**
   * An Async wrapper for SetSecurityTokenServicePreferences that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SetSecurityTokenServicePreferencesRequestT = Model::SetSecurityTokenServicePreferencesRequest>
  void SetSecurityTokenServicePreferencesAsync(const SetSecurityTokenServicePreferencesRequestT& request,
                                               const SetSecurityTokenServicePreferencesResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * instead.</p> <p>Context keys are variables that are maintained by Amazon Web
   * Services and its services and which provide details about the context of an API
   * query request. You can use the <code>Condition</code> element of an IAM policy
   * to evaluate context keys. To get the list of context keys that the policies
  ...
  /**
   * A Callable wrapper for SimulateCustomPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SimulateCustomPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SimulateCustomPolicyRequestT = Model::SimulateCustomPolicyRequest>
  void SimulateCustomPolicyAsync(const SimulateCustomPolicyRequestT& request, const SimulateCustomPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * simulation. If you want to simulate only policies specified as strings, use <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_SimulateCustomPolicy.html">SimulateCustomPolicy</a>
   * instead.</p> <p>You can also optionally include one resource-based policy to be
   ...
   * can use the <code>Condition</code> element of an IAM policy to evaluate context
  ...
  /**
   * A Callable wrapper for SimulatePrincipalPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SimulatePrincipalPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SimulatePrincipalPolicyRequestT = Model::SimulatePrincipalPolicyRequest>
  void SimulatePrincipalPolicyAsync(const SimulatePrincipalPolicyRequestT& request,
                                    const SimulatePrincipalPolicyResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TagInstanceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TagInstanceProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TagInstanceProfileRequestT = Model::TagInstanceProfileRequest>
  void TagInstanceProfileAsync(const TagInstanceProfileRequestT& request, const TagInstanceProfileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TagMFADevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TagMFADeviceRequestT = Model::TagMFADeviceRequest>
  void TagMFADeviceAsync(const TagMFADeviceRequestT& request, const TagMFADeviceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TagOpenIDConnectProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TagOpenIDConnectProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TagOpenIDConnectProviderRequestT = Model::TagOpenIDConnectProviderRequest>
  void TagOpenIDConnectProviderAsync(const TagOpenIDConnectProviderRequestT& request,
                                     const TagOpenIDConnectProviderResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TagPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TagPolicyRequestT = Model::TagPolicyRequest>
  void TagPolicyAsync(const TagPolicyRequestT& request, const TagPolicyResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TagRole that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TagRoleRequestT = Model::TagRoleRequest>
  void TagRoleAsync(const TagRoleRequestT& request, const TagRoleResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TagSAMLProvider that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TagSAMLProviderRequestT = Model::TagSAMLProviderRequest>
  void TagSAMLProviderAsync(const TagSAMLProviderRequestT& request, const TagSAMLProviderResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TagServerCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TagServerCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TagServerCertificateRequestT = Model::TagServerCertificateRequest>
  void TagServerCertificateAsync(const TagServerCertificateRequestT& request, const TagServerCertificateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TagUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TagUserRequestT = Model::TagUserRequest>
  void TagUserAsync(const TagUserRequestT& request, const TagUserResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UntagInstanceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UntagInstanceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UntagInstanceProfileRequestT = Model::UntagInstanceProfileRequest>
  void UntagInstanceProfileAsync(const UntagInstanceProfileRequestT& request, const UntagInstanceProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UntagMFADevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UntagMFADeviceRequestT = Model::UntagMFADeviceRequest>
  void UntagMFADeviceAsync(const UntagMFADeviceRequestT& request, const UntagMFADeviceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UntagOpenIDConnectProviderOutcome UntagOpenIDConnectProvider(
      const Model::UntagOpenIDConnectProviderRequest& request) const;

  /**
   * A Callable wrapper for UntagOpenIDConnectProvider that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UntagOpenIDConnectProviderRequestT = Model::UntagOpenIDConnectProviderRequest>
  Model::UntagOpenIDConnectProviderOutcomeCallable UntagOpenIDConnectProviderCallable(
      const UntagOpenIDConnectProviderRequestT& request) const {
    return SubmitCallable(&IAMClient::UntagOpenIDConnectProvider, request);
  }

  /**
   * An Async wrapper for UntagOpenIDConnectProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UntagOpenIDConnectProviderRequestT = Model::UntagOpenIDConnectProviderRequest>
  void UntagOpenIDConnectProviderAsync(const UntagOpenIDConnectProviderRequestT& request,
                                       const UntagOpenIDConnectProviderResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UntagPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UntagPolicyRequestT = Model::UntagPolicyRequest>
  void UntagPolicyAsync(const UntagPolicyRequestT& request, const UntagPolicyResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UntagRole that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UntagRoleRequestT = Model::UntagRoleRequest>
  void UntagRoleAsync(const UntagRoleRequestT& request, const UntagRoleResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UntagSAMLProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UntagSAMLProvider that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UntagSAMLProviderRequestT = Model::UntagSAMLProviderRequest>
  void UntagSAMLProviderAsync(const UntagSAMLProviderRequestT& request, const UntagSAMLProviderResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UntagServerCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UntagServerCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UntagServerCertificateRequestT = Model::UntagServerCertificateRequest>
  void UntagServerCertificateAsync(const UntagServerCertificateRequestT& request,
                                   const UntagServerCertificateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UntagUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UntagUserRequestT = Model::UntagUserRequest>
  void UntagUserAsync(const UntagUserRequestT& request, const UntagUserResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateAccessKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAccessKeyRequestT = Model::UpdateAccessKeyRequest>
  void UpdateAccessKeyAsync(const UpdateAccessKeyRequestT& request, const UpdateAccessKeyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAccountPasswordPolicyOutcome UpdateAccountPasswordPolicy(
      const Model::UpdateAccountPasswordPolicyRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateAccountPasswordPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAccountPasswordPolicyRequestT = Model::UpdateAccountPasswordPolicyRequest>
  Model::UpdateAccountPasswordPolicyOutcomeCallable UpdateAccountPasswordPolicyCallable(
      const UpdateAccountPasswordPolicyRequestT& request = {}) const {
    return SubmitCallable(&IAMClient::UpdateAccountPasswordPolicy, request);
  }

  /**
   * An Async wrapper for UpdateAccountPasswordPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAccountPasswordPolicyRequestT = Model::UpdateAccountPasswordPolicyRequest>
  void UpdateAccountPasswordPolicyAsync(const UpdateAccountPasswordPolicyResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const UpdateAccountPasswordPolicyRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateAssumeRolePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAssumeRolePolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAssumeRolePolicyRequestT = Model::UpdateAssumeRolePolicyRequest>
  void UpdateAssumeRolePolicyAsync(const UpdateAssumeRolePolicyRequestT& request,
   ...
   * the password for any IAM user. Use <a
   * href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ChangePassword.html">ChangePassword</a>
   * to change your own password in the <b>My Security Credentials</b> page in the
   * Amazon Web Services Management Console.</p> <p>For more information about
   * modifying passwords, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_ManagingLogins.html">Managing
   * passwords</a> in the <i>IAM User Guide</i>.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for UpdateLoginProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateLoginProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateLoginProfileRequestT = Model::UpdateLoginProfileRequest>
  void UpdateLoginProfileAsync(const UpdateLoginProfileRequestT& request, const UpdateLoginProfileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateOpenIDConnectProviderThumbprintOutcome UpdateOpenIDConnectProviderThumbprint(
      const Model::UpdateOpenIDConnectProviderThumbprintRequest& request) const;

  /**
   * A Callable wrapper for UpdateOpenIDConnectProviderThumbprint that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateOpenIDConnectProviderThumbprintRequestT = Model::UpdateOpenIDConnectProviderThumbprintRequest>
  Model::UpdateOpenIDConnectProviderThumbprintOutcomeCallable UpdateOpenIDConnectProviderThumbprintCallable(
      const UpdateOpenIDConnectProviderThumbprintRequestT& request) const {
    return SubmitCallable(&IAMClient::UpdateOpenIDConnectProviderThumbprint, request);
  }

  /**
   * An Async wrapper for UpdateOpenIDConnectProviderThumbprint that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateOpenIDConnectProviderThumbprintRequestT = Model::UpdateOpenIDConnectProviderThumbprintRequest>
  void UpdateOpenIDConnectProviderThumbprintAsync(const UpdateOpenIDConnectProviderThumbprintRequestT& request,
                                                  const UpdateOpenIDConnectProviderThumbprintResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateRole that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRoleRequestT = Model::UpdateRoleRequest>
  void UpdateRoleAsync(const UpdateRoleRequestT& request, const UpdateRoleResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * instead.</p> <p>Modifies only the description of a role. This operation performs
   * the same function as the <code>Description</code> parameter in the
  ...
  /**
   * A Callable wrapper for UpdateRoleDescription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRoleDescription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRoleDescriptionRequestT = Model::UpdateRoleDescriptionRequest>
  void UpdateRoleDescriptionAsync(const UpdateRoleDescriptionRequestT& request, const UpdateRoleDescriptionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSAMLProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSAMLProvider that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateSAMLProviderRequestT = Model::UpdateSAMLProviderRequest>
  void UpdateSAMLProviderAsync(const UpdateSAMLProviderRequestT& request, const UpdateSAMLProviderResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSSHPublicKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSSHPublicKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateSSHPublicKeyRequestT = Model::UpdateSSHPublicKeyRequest>
  void UpdateSSHPublicKeyAsync(const UpdateSSHPublicKeyRequestT& request, const UpdateSSHPublicKeyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateServerCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateServerCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateServerCertificateRequestT = Model::UpdateServerCertificateRequest>
  void UpdateServerCertificateAsync(const UpdateServerCertificateRequestT& request,
                                    const UpdateServerCertificateResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateServiceSpecificCredentialOutcome UpdateServiceSpecificCredential(
      const Model::UpdateServiceSpecificCredentialRequest& request) const;

  /**
   * A Callable wrapper for UpdateServiceSpecificCredential that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateServiceSpecificCredentialRequestT = Model::UpdateServiceSpecificCredentialRequest>
  Model::UpdateServiceSpecificCredentialOutcomeCallable UpdateServiceSpecificCredentialCallable(
      const UpdateServiceSpecificCredentialRequestT& request) const {
    return SubmitCallable(&IAMClient::UpdateServiceSpecificCredential, request);
  }

  /**
   * An Async wrapper for UpdateServiceSpecificCredential that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateServiceSpecificCredentialRequestT = Model::UpdateServiceSpecificCredentialRequest>
  void UpdateServiceSpecificCredentialAsync(const UpdateServiceSpecificCredentialRequestT& request,
                                            const UpdateServiceSpecificCredentialResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSigningCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSigningCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSigningCertificateRequestT = Model::UpdateSigningCertificateRequest>
  void UpdateSigningCertificateAsync(const UpdateSigningCertificateRequestT& request,
                                     const UpdateSigningCertificateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UploadSSHPublicKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UploadSSHPublicKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UploadSSHPublicKeyRequestT = Model::UploadSSHPublicKeyRequest>
  void UploadSSHPublicKeyAsync(const UploadSSHPublicKeyRequestT& request, const UploadSSHPublicKeyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UploadServerCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UploadServerCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UploadServerCertificateRequestT = Model::UploadServerCertificateRequest>
  void UploadServerCertificateAsync(const UploadServerCertificateRequestT& request,
                                    const UploadServerCertificateResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UploadSigningCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UploadSigningCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UploadSigningCertificateRequestT = Model::UploadSigningCertificateRequest>
  void UploadSigningCertificateAsync(const UploadSigningCertificateRequestT& request,
                                     const UploadSigningCertificateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
