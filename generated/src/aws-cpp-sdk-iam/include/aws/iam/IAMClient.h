...
class AWS_IAM_API IAMClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   * for Amazon Bedrock, Amazon CloudWatch Logs, CodeCommit and Amazon Keyspaces (for
   * Apache Cassandra).</p> <p>You can reset the password to a new service-generated
   * value by calling <a
   ...
   * <p>For more information about service-specific credentials, see <a
   * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_bedrock.html">Service-specific
   * credentials for IAM users</a> in the <i>IAM User Guide</i>.</p><p><h3>See
   * Also:</h3>   <a
