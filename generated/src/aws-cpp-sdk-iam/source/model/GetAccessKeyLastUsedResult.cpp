...
GetAccessKeyLastUsedResult::GetAccessKeyLastUsedResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
GetAccessKeyLastUsedResult& GetAccessKeyLastUsedResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!accessKeyLastUsedNode.IsNull()) {
      ...
      m_accessKeyLastUsedHasBeenSet = true;
    }
  }
