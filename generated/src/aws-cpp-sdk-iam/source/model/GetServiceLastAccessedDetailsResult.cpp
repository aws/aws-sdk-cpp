...
GetServiceLastAccessedDetailsResult& GetServiceLastAccessedDetailsResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!jobTypeNode.IsNull()) {
      m_jobType = AccessAdvisorUsageGranularityTypeMapper::GetAccessAdvisorUsageGranularityTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(jobTypeNode.GetText()).c_str()));
