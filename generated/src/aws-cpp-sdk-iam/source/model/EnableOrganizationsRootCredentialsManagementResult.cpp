...
EnableOrganizationsRootCredentialsManagementResult& EnableOrganizationsRootCredentialsManagementResult::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  const XmlDocument& xmlDocument = result.GetPayload();
  XmlNode rootNode = xmlDocument.GetRootElement();
  XmlNode resultNode = rootNode;
  if (!rootNode.IsNull() && (rootNode.GetName() != "EnableOrganizationsRootCredentialsManagementResult")) {
    resultNode = rootNode.FirstChild("EnableOrganizationsRootCredentialsManagementResult");
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::IAM::Model::EnableOrganizationsRootCredentialsManagementResult",
