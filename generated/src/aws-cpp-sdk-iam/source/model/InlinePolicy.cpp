...
InlinePolicy::InlinePolicy(const XmlNode& xmlNode) { *this = xmlNode; }

InlinePolicy& InlinePolicy::operator=(const XmlNode& xmlNode) {
...
void InlinePolicy::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
...
void InlinePolicy::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_policyNameHasBeenSet) {
