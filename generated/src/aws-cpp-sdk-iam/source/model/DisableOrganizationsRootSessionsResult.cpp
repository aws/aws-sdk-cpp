...
DisableOrganizationsRootSessionsResult& DisableOrganizationsRootSessionsResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::IAM::Model::DisableOrganizationsRootSessionsResult",
