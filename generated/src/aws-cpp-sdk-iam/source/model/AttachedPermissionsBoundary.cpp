...
AttachedPermissionsBoundary::AttachedPermissionsBoundary(const XmlNode& xmlNode) { *this = xmlNode; }
...
AttachedPermissionsBoundary& AttachedPermissionsBoundary::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!permissionsBoundaryTypeNode.IsNull()) {
      m_permissionsBoundaryType = PermissionsBoundaryAttachmentTypeMapper::GetPermissionsBoundaryAttachmentTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(permissionsBoundaryTypeNode.GetText()).c_str()));
...
void AttachedPermissionsBoundary::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                 const char* locationValue) const {
  if (m_permissionsBoundaryTypeHasBeenSet) {
    oStream << location << index << locationValue << ".PermissionsBoundaryType="
            << StringUtils::URLEncode(
                   PermissionsBoundaryAttachmentTypeMapper::GetNameForPermissionsBoundaryAttachmentType(m_permissionsBoundaryType))
            << "&";
  }
...
void AttachedPermissionsBoundary::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_permissionsBoundaryTypeHasBeenSet) {
    oStream << location << ".PermissionsBoundaryType="
            << StringUtils::URLEncode(
                   PermissionsBoundaryAttachmentTypeMapper::GetNameForPermissionsBoundaryAttachmentType(m_permissionsBoundaryType))
            << "&";
  }
