...
DisableOrganizationsRootCredentialsManagementResult::DisableOrganizationsRootCredentialsManagementResult(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

DisableOrganizationsRootCredentialsManagementResult& DisableOrganizationsRootCredentialsManagementResult::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  const XmlDocument& xmlDocument = result.GetPayload();
  XmlNode rootNode = xmlDocument.GetRootElement();
  XmlNode resultNode = rootNode;
  if (!rootNode.IsNull() && (rootNode.GetName() != "DisableOrganizationsRootCredentialsManagementResult"))
  {
    resultNode = rootNode.FirstChild("DisableOrganizationsRootCredentialsManagementResult");
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::IAM::Model::DisableOrganizationsRootCredentialsManagementResult", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
