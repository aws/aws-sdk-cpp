...
DisableOrganizationsRootCredentialsManagementResult& DisableOrganizationsRootCredentialsManagementResult::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::IAM::Model::DisableOrganizationsRootCredentialsManagementResult",
