...
PasswordPolicy::PasswordPolicy(const XmlNode& xmlNode) { *this = xmlNode; }
...
PasswordPolicy& PasswordPolicy::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!minimumPasswordLengthNode.IsNull()) {
      m_minimumPasswordLength = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(minimumPasswordLengthNode.GetText()).c_str()).c_str());
    ...
    if (!requireSymbolsNode.IsNull()) {
      m_requireSymbols = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(requireSymbolsNode.GetText()).c_str()).c_str());
    ...
    if (!requireNumbersNode.IsNull()) {
      m_requireNumbers = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(requireNumbersNode.GetText()).c_str()).c_str());
    ...
    if (!requireUppercaseCharactersNode.IsNull()) {
      m_requireUppercaseCharacters = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(requireUppercaseCharactersNode.GetText()).c_str()).c_str());
    ...
    if (!requireLowercaseCharactersNode.IsNull()) {
      m_requireLowercaseCharacters = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(requireLowercaseCharactersNode.GetText()).c_str()).c_str());
    ...
    if (!allowUsersToChangePasswordNode.IsNull()) {
      m_allowUsersToChangePassword = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(allowUsersToChangePasswordNode.GetText()).c_str()).c_str());
    ...
    if (!expirePasswordsNode.IsNull()) {
      m_expirePasswords = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(expirePasswordsNode.GetText()).c_str()).c_str());
    ...
    if (!maxPasswordAgeNode.IsNull()) {
      m_maxPasswordAge = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maxPasswordAgeNode.GetText()).c_str()).c_str());
    ...
    if (!passwordReusePreventionNode.IsNull()) {
      m_passwordReusePrevention = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(passwordReusePreventionNode.GetText()).c_str()).c_str());
      m_passwordReusePreventionHasBeenSet = true;
    }
    XmlNode hardExpiryNode = resultNode.FirstChild("HardExpiry");
    if (!hardExpiryNode.IsNull()) {
      m_hardExpiry =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(hardExpiryNode.GetText()).c_str()).c_str());
