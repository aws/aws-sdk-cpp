...
DeletionTaskFailureReasonType::DeletionTaskFailureReasonType(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DeletionTaskFailureReasonType::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
