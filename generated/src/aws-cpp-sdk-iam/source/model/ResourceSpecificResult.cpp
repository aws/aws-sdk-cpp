...
ResourceSpecificResult::ResourceSpecificResult(const XmlNode& xmlNode) { *this = xmlNode; }
...
ResourceSpecificResult& ResourceSpecificResult::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!evalResourceDecisionNode.IsNull()) {
      m_evalResourceDecision = PolicyEvaluationDecisionTypeMapper::GetPolicyEvaluationDecisionTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(evalResourceDecisionNode.GetText()).c_str()));
...
void ResourceSpecificResult::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_evalResourceDecisionHasBeenSet) {
    oStream << location << index << locationValue << ".EvalResourceDecision="
            << StringUtils::URLEncode(PolicyEvaluationDecisionTypeMapper::GetNameForPolicyEvaluationDecisionType(m_evalResourceDecision))
            << "&";
  }
...
void ResourceSpecificResult::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_evalResourceDecisionHasBeenSet) {
    oStream << location << ".EvalResourceDecision="
            << StringUtils::URLEncode(PolicyEvaluationDecisionTypeMapper::GetNameForPolicyEvaluationDecisionType(m_evalResourceDecision))
            << "&";
  }
  if (m_matchedStatementsHasBeenSet) {
