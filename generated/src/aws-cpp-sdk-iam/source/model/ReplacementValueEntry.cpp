...
ReplacementValueEntry::ReplacementValueEntry(const XmlNode& xmlNode) { *this = xmlNode; }

ReplacementValueEntry& ReplacementValueEntry::operator=(const XmlNode& xmlNode) {
...
void ReplacementValueEntry::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
...
void ReplacementValueEntry::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_valuesHasBeenSet) {
    unsigned valuesIdx = 1;
    for (auto& item : m_values) {
