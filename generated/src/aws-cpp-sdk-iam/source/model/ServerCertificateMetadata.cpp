...
ServerCertificateMetadata::ServerCertificateMetadata(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ServerCertificateMetadata::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
