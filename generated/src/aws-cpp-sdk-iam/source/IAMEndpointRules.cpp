...
namespace IAM
{
const size_t IAMEndpointRules::RulesBlobStrLen = 6642;
const size_t IAMEndpointRules::RulesBlobSize = 6643;
...
'"','h','t','t','p','s',':','/','/','i','a','m','.','a','m','a','z','o','n','a','w','s','.','c','o',
'm','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','"','a','u','t','h','S','c','h',
'e','m','e','s','"',':','[','{','"','n','a','m','e','"',':','"','s','i','g','v','4','"',',','"','s',
'i','g','n','i','n','g','N','a','m','e','"',':','"','i','a','m','"',',','"','s','i','g','n','i','n',
...
'l','"',':','"','h','t','t','p','s',':','/','/','i','a','m','-','f','i','p','s','.','a','m','a','z',
...
'a','m','.','c','n','-','n','o','r','t','h','-','1','.','a','m','a','z','o','n','a','w','s','.','c',
...
':','/','/','i','a','m','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
