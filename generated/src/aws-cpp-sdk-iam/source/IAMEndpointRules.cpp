...
namespace IAM
{
const size_t IAMEndpointRules::RulesBlobStrLen = 6823;
const size_t IAMEndpointRules::RulesBlobSize = 6824;
...
't','t','p','s',':','/','/','i','a','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
