...
namespace IAM
{
const size_t IAMEndpointRules::RulesBlobStrLen = 9614;
const size_t IAMEndpointRules::RulesBlobSize = 9615;
...
'i','p','s','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','#','d','n','s','S',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','i','a','m','.','{','P','a','r','t','i','t','i',
