...
namespace CodeStarNotifications
{
   ...
   */
  class AWS_CODESTARNOTIFICATIONS_API CodeStarNotificationsClient : Aws::Client::ClientWithAsyncTemplateMethods<CodeStarNotificationsClient>,
    smithy::client::AwsSmithyClientT<Aws::CodeStarNotifications::SERVICE_NAME,
