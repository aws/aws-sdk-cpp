...
class AWS_CODESTARNOTIFICATIONS_API CodeStarNotificationsClient
 ...
 public:
   ...
   */
  CodeStarNotificationsClient(const Aws::CodeStarNotifications::CodeStarNotificationsClientConfiguration& clientConfiguration =
  ...
  CodeStarNotificationsClient(const Aws::Auth::AWSCredentials& credentials,
                              std::shared_ptr<CodeStarNotificationsEndpointProviderBase> endpointProvider = nullptr,
                              const Aws::CodeStarNotifications::CodeStarNotificationsClientConfiguration& clientConfiguration =
                                  Aws::CodeStarNotifications::CodeStarNotificationsClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateNotificationRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateNotificationRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateNotificationRuleRequestT = Model::CreateNotificationRuleRequest>
  void CreateNotificationRuleAsync(const CreateNotificationRuleRequestT& request,
                                   const CreateNotificationRuleResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteNotificationRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteNotificationRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteNotificationRuleRequestT = Model::DeleteNotificationRuleRequest>
  void DeleteNotificationRuleAsync(const DeleteNotificationRuleRequestT& request,
                                   const DeleteNotificationRuleResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteTarget that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTargetRequestT = Model::DeleteTargetRequest>
  void DeleteTargetAsync(const DeleteTargetRequestT& request, const DeleteTargetResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeNotificationRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeNotificationRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeNotificationRuleRequestT = Model::DescribeNotificationRuleRequest>
  void DescribeNotificationRuleAsync(const DescribeNotificationRuleRequestT& request,
                                     const DescribeNotificationRuleResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListEventTypes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListEventTypesRequestT = Model::ListEventTypesRequest>
  void ListEventTypesAsync(const ListEventTypesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListEventTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListNotificationRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListNotificationRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListNotificationRulesRequestT = Model::ListNotificationRulesRequest>
  void ListNotificationRulesAsync(const ListNotificationRulesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListNotificationRulesRequestT& request = {}) const {
   ...
   */
  template <typename ListTargetsRequestT = Model::ListTargetsRequest>
  void ListTargetsAsync(const ListTargetsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListTargetsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateNotificationRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateNotificationRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateNotificationRuleRequestT = Model::UpdateNotificationRuleRequest>
  void UpdateNotificationRuleAsync(const UpdateNotificationRuleRequestT& request,
                                   const UpdateNotificationRuleResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
