...
class ListEventTypesRequest : public CodeStarNotificationsRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<ListEventTypesFilter>>
  ListEventTypesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ListEventTypesFilter>
  ListEventTypesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEventTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEventTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
