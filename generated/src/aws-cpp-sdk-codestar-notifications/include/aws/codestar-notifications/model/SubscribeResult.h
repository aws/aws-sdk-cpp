...
namespace Model
{
  ...
  public:
    ...
    inline SubscribeResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline SubscribeResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline SubscribeResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
