...
namespace Model
{
  ...
  {
  public:
    AWS_CODESTARNOTIFICATIONS_API SubscribeResult() = default;
    ...
    template<typename ArnT = Aws::String>
    SubscribeResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SubscribeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
