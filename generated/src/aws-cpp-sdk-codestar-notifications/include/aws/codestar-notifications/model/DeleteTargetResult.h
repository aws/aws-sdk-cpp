...
namespace Model
{
  ...
  {
  public:
    AWS_CODESTARNOTIFICATIONS_API DeleteTargetResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteTargetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
