...
namespace Model
{
  ...
  public:
    ...
    inline DeleteTargetResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteTargetResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteTargetResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
