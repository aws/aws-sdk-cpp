...
class DeleteTargetRequest : public CodeStarNotificationsRequest {
 public:
  ...
  inline void SetForceUnsubscribeAll(bool value) {
    m_forceUnsubscribeAllHasBeenSet = true;
    m_forceUnsubscribeAll = value;
  }
  inline DeleteTargetRequest& WithForceUnsubscribeAll(bool value) {
    SetForceUnsubscribeAll(value);
    return *this;
  }
  ///@}
 private:
