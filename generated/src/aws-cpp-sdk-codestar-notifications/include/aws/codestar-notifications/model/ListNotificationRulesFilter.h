...
class ListNotificationRulesFilter {
 public:
  ...
  inline void SetName(ListNotificationRulesFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ListNotificationRulesFilter& WithName(ListNotificationRulesFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  ListNotificationRulesFilter& WithValue(ValueT&& value) {
