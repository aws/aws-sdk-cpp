...
class ListEventTypesFilter {
 public:
  ...
  inline void SetName(ListEventTypesFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ListEventTypesFilter& WithName(ListEventTypesFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  ListEventTypesFilter& WithValue(ValueT&& value) {
