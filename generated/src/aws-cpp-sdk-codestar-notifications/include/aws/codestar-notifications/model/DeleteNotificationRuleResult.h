...
namespace Model
{
  ...
  {
  public:
    AWS_CODESTARNOTIFICATIONS_API DeleteNotificationRuleResult() = default;
    ...
    template<typename ArnT = Aws::String>
    DeleteNotificationRuleResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteNotificationRuleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
