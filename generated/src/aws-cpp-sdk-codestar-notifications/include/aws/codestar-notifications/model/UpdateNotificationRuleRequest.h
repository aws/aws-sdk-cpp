...
class UpdateNotificationRuleRequest : public CodeStarNotificationsRequest {
 public:
  ...
  inline void SetStatus(NotificationRuleStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateNotificationRuleRequest& WithStatus(NotificationRuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDetailType(DetailType value) {
    m_detailTypeHasBeenSet = true;
    m_detailType = value;
  }
  inline UpdateNotificationRuleRequest& WithDetailType(DetailType value) {
    SetDetailType(value);
    return *this;
  }
  ///@}
