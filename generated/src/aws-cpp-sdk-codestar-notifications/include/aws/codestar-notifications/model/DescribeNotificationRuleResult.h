...
class DescribeNotificationRuleResult {
 public:
  ...
  AWS_CODESTARNOTIFICATIONS_API DescribeNotificationRuleResult& operator=(
  ...
  inline DescribeNotificationRuleResult& WithDetailType(DetailType value) {
    SetDetailType(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeNotificationRuleResult& WithStatus(NotificationRuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
