...
namespace Model
{
  ...
  {
  public:
    AWS_CODESTARNOTIFICATIONS_API ListTagsForResourceResult() = default;
    AWS_CODESTARNOTIFICATIONS_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_CODESTARNOTIFICATIONS_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
