...
namespace EMRContainers
{
   ...
   */
  class AWS_EMRCONTAINERS_API EMRContainersClient : Aws::Client::ClientWithAsyncTemplateMethods<EMRContainersClient>,
    smithy::client::AwsSmithyClientT<Aws::EMRContainers::SERVICE_NAME,
