...
class EncryptionConfiguration {
 public:
  ...
  void SetInTransitEncryptionConfiguration(InTransitEncryptionConfigurationT&& value) {
    m_inTransitEncryptionConfigurationHasBeenSet = true;
    m_inTransitEncryptionConfiguration = std::forward<InTransitEncryptionConfigurationT>(value);
  }
  template <typename InTransitEncryptionConfigurationT = InTransitEncryptionConfiguration>
  EncryptionConfiguration& WithInTransitEncryptionConfiguration(InTransitEncryptionConfigurationT&& value) {
    SetInTransitEncryptionConfiguration(std::forward<InTransitEncryptionConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
