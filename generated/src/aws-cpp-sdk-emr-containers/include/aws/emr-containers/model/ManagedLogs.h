...
class ManagedLogs {
 public:
  ...
  inline void SetAllowAWSToRetainLogs(AllowAWSToRetainLogs value) {
    m_allowAWSToRetainLogsHasBeenSet = true;
    m_allowAWSToRetainLogs = value;
  }
  inline ManagedLogs& WithAllowAWSToRetainLogs(AllowAWSToRetainLogs value) {
    SetAllowAWSToRetainLogs(value);
    return *this;
  }
  ///@}
