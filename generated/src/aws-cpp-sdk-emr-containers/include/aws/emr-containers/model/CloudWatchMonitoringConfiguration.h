...
class CloudWatchMonitoringConfiguration {
 public:
  ...
  template <typename LogGroupNameT = Aws::String>
  CloudWatchMonitoringConfiguration& WithLogGroupName(LogGroupNameT&& value) {
  ...
  template <typename LogStreamNamePrefixT = Aws::String>
  CloudWatchMonitoringConfiguration& WithLogStreamNamePrefix(LogStreamNamePrefixT&& value) {
