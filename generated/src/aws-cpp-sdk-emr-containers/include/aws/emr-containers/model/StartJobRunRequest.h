...
class StartJobRunRequest : public EMRContainersRequest {
 public:
  ...
  void SetVirtualClusterId(VirtualClusterIdT&& value) {
    ...
    m_virtualClusterId = std::forward<VirtualClusterIdT>(value);
  }
  template <typename VirtualClusterIdT = Aws::String>
  StartJobRunRequest& WithVirtualClusterId(VirtualClusterIdT&& value) {
    SetVirtualClusterId(std::forward<VirtualClusterIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobDriver(JobDriverT&& value) {
    ...
    m_jobDriver = std::forward<JobDriverT>(value);
  }
  template <typename JobDriverT = JobDriver>
  StartJobRunRequest& WithJobDriver(JobDriverT&& value) {
    SetJobDriver(std::forward<JobDriverT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobTemplateId(JobTemplateIdT&& value) {
    ...
    m_jobTemplateId = std::forward<JobTemplateIdT>(value);
  }
  template <typename JobTemplateIdT = Aws::String>
  StartJobRunRequest& WithJobTemplateId(JobTemplateIdT&& value) {
    SetJobTemplateId(std::forward<JobTemplateIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobTemplateParameters(JobTemplateParametersT&& value) {
    m_jobTemplateParametersHasBeenSet = true;
    m_jobTemplateParameters = std::forward<JobTemplateParametersT>(value);
  }
  template <typename JobTemplateParametersT = Aws::Map<Aws::String, Aws::String>>
  StartJobRunRequest& WithJobTemplateParameters(JobTemplateParametersT&& value) {
    SetJobTemplateParameters(std::forward<JobTemplateParametersT>(value));
    return *this;
  }
  ...
  StartJobRunRequest& AddJobTemplateParameters(JobTemplateParametersKeyT&& key, JobTemplateParametersValueT&& value) {
    m_jobTemplateParametersHasBeenSet = true;
    m_jobTemplateParameters.emplace(std::forward<JobTemplateParametersKeyT>(key), std::forward<JobTemplateParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRetryPolicyConfiguration(RetryPolicyConfigurationT&& value) {
    ...
    m_retryPolicyConfiguration = std::forward<RetryPolicyConfigurationT>(value);
  }
  template <typename RetryPolicyConfigurationT = RetryPolicyConfiguration>
  StartJobRunRequest& WithRetryPolicyConfiguration(RetryPolicyConfigurationT&& value) {
    SetRetryPolicyConfiguration(std::forward<RetryPolicyConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
