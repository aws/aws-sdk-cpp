...
class JobDriver {
 public:
  ...
  void SetSparkSubmitJobDriver(SparkSubmitJobDriverT&& value) {
    ...
    m_sparkSubmitJobDriver = std::forward<SparkSubmitJobDriverT>(value);
  }
  template <typename SparkSubmitJobDriverT = SparkSubmitJobDriver>
  JobDriver& WithSparkSubmitJobDriver(SparkSubmitJobDriverT&& value) {
    SetSparkSubmitJobDriver(std::forward<SparkSubmitJobDriverT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSparkSqlJobDriver(SparkSqlJobDriverT&& value) {
    ...
    m_sparkSqlJobDriver = std::forward<SparkSqlJobDriverT>(value);
  }
  template <typename SparkSqlJobDriverT = SparkSqlJobDriver>
  JobDriver& WithSparkSqlJobDriver(SparkSqlJobDriverT&& value) {
    SetSparkSqlJobDriver(std::forward<SparkSqlJobDriverT>(value));
    return *this;
  }
  ///@}
 private:
