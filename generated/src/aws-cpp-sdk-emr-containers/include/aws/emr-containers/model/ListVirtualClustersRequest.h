...
class ListVirtualClustersRequest : public EMRContainersRequest {
 public:
  ...
  void SetContainerProviderId(ContainerProviderIdT&& value) {
    m_containerProviderIdHasBeenSet = true;
    m_containerProviderId = std::forward<ContainerProviderIdT>(value);
  }
  template <typename ContainerProviderIdT = Aws::String>
  ListVirtualClustersRequest& WithContainerProviderId(ContainerProviderIdT&& value) {
    SetContainerProviderId(std::forward<ContainerProviderIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetContainerProviderType(ContainerProviderType value) {
    m_containerProviderTypeHasBeenSet = true;
    m_containerProviderType = value;
  }
  inline ListVirtualClustersRequest& WithContainerProviderType(ContainerProviderType value) {
    SetContainerProviderType(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  ListVirtualClustersRequest& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  ListVirtualClustersRequest& WithCreatedBefore(CreatedBeforeT&& value) {
  ...
  template <typename StatesT = Aws::Vector<VirtualClusterState>>
  ListVirtualClustersRequest& WithStates(StatesT&& value) {
    SetStates(std::forward<StatesT>(value));
    return *this;
  }
  inline ListVirtualClustersRequest& AddStates(VirtualClusterState value) {
    m_statesHasBeenSet = true;
  ...
  inline ListVirtualClustersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVirtualClustersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetEksAccessEntryIntegrated(bool value) {
    m_eksAccessEntryIntegratedHasBeenSet = true;
    m_eksAccessEntryIntegrated = value;
  }
  inline ListVirtualClustersRequest& WithEksAccessEntryIntegrated(bool value) {
    SetEksAccessEntryIntegrated(value);
    return *this;
  }
  ///@}
 private:
