...
namespace Model
{
  ...
  /**
   */
  class DescribeJobTemplateRequest : public EMRContainersRequest
  {
  public:
    AWS_EMRCONTAINERS_API DescribeJobTemplateRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DescribeJobTemplateRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
