...
class ParametricConfigurationOverrides {
 public:
  ...
  template <typename ApplicationConfigurationT = Aws::Vector<Configuration>>
  ParametricConfigurationOverrides& WithApplicationConfiguration(ApplicationConfigurationT&& value) {
  ...
  ParametricConfigurationOverrides& AddApplicationConfiguration(ApplicationConfigurationT&& value) {
    m_applicationConfigurationHasBeenSet = true;
  ...
  template <typename MonitoringConfigurationT = ParametricMonitoringConfiguration>
  ParametricConfigurationOverrides& WithMonitoringConfiguration(MonitoringConfigurationT&& value) {
