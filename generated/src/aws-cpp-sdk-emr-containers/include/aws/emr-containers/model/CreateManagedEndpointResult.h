...
class CreateManagedEndpointResult {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateManagedEndpointResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateManagedEndpointResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateManagedEndpointResult& WithArn(ArnT&& value) {
  ...
  template <typename VirtualClusterIdT = Aws::String>
  CreateManagedEndpointResult& WithVirtualClusterId(VirtualClusterIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateManagedEndpointResult& WithRequestId(RequestIdT&& value) {
