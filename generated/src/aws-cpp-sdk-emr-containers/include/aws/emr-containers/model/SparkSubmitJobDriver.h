...
class SparkSubmitJobDriver {
 public:
  ...
  template <typename EntryPointT = Aws::String>
  SparkSubmitJobDriver& WithEntryPoint(EntryPointT&& value) {
  ...
  void SetEntryPointArguments(EntryPointArgumentsT&& value) {
    m_entryPointArgumentsHasBeenSet = true;
    m_entryPointArguments = std::forward<EntryPointArgumentsT>(value);
  }
  template <typename EntryPointArgumentsT = Aws::Vector<Aws::String>>
  SparkSubmitJobDriver& WithEntryPointArguments(EntryPointArgumentsT&& value) {
    SetEntryPointArguments(std::forward<EntryPointArgumentsT>(value));
    return *this;
  }
  template <typename EntryPointArgumentsT = Aws::String>
  SparkSubmitJobDriver& AddEntryPointArguments(EntryPointArgumentsT&& value) {
    m_entryPointArgumentsHasBeenSet = true;
    m_entryPointArguments.emplace_back(std::forward<EntryPointArgumentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSparkSubmitParameters(SparkSubmitParametersT&& value) {
    m_sparkSubmitParametersHasBeenSet = true;
    m_sparkSubmitParameters = std::forward<SparkSubmitParametersT>(value);
  }
  template <typename SparkSubmitParametersT = Aws::String>
  SparkSubmitJobDriver& WithSparkSubmitParameters(SparkSubmitParametersT&& value) {
    SetSparkSubmitParameters(std::forward<SparkSubmitParametersT>(value));
    return *this;
  }
  ///@}
 private:
