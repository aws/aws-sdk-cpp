...
class RetryPolicyExecution {
 public:
  ...
  inline void SetCurrentAttemptCount(int value) {
    m_currentAttemptCountHasBeenSet = true;
    m_currentAttemptCount = value;
  }
  inline RetryPolicyExecution& WithCurrentAttemptCount(int value) {
    SetCurrentAttemptCount(value);
    return *this;
  }
  ///@}
 private:
