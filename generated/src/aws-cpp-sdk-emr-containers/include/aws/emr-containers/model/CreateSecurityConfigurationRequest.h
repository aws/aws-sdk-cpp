...
class CreateSecurityConfigurationRequest : public EMRContainersRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateSecurityConfigurationRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ContainerProviderT = ContainerProvider>
  CreateSecurityConfigurationRequest& WithContainerProvider(ContainerProviderT&& value) {
  ...
  void SetSecurityConfigurationData(SecurityConfigurationDataT&& value) {
    ...
    m_securityConfigurationData = std::forward<SecurityConfigurationDataT>(value);
  }
  template <typename SecurityConfigurationDataT = SecurityConfigurationData>
  CreateSecurityConfigurationRequest& WithSecurityConfigurationData(SecurityConfigurationDataT&& value) {
    SetSecurityConfigurationData(std::forward<SecurityConfigurationDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateSecurityConfigurationRequest& WithTags(TagsT&& value) {
