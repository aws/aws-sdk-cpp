...
class TLSCertificateConfiguration {
 public:
  ...
  inline void SetCertificateProviderType(CertificateProviderType value) {
    m_certificateProviderTypeHasBeenSet = true;
    m_certificateProviderType = value;
  }
  inline TLSCertificateConfiguration& WithCertificateProviderType(CertificateProviderType value) {
    SetCertificateProviderType(value);
    return *this;
  }
  ///@}
  ...
  void SetPublicCertificateSecretArn(PublicCertificateSecretArnT&& value) {
    m_publicCertificateSecretArnHasBeenSet = true;
    m_publicCertificateSecretArn = std::forward<PublicCertificateSecretArnT>(value);
  }
  template <typename PublicCertificateSecretArnT = Aws::String>
  TLSCertificateConfiguration& WithPublicCertificateSecretArn(PublicCertificateSecretArnT&& value) {
    SetPublicCertificateSecretArn(std::forward<PublicCertificateSecretArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrivateCertificateSecretArn(PrivateCertificateSecretArnT&& value) {
    m_privateCertificateSecretArnHasBeenSet = true;
    m_privateCertificateSecretArn = std::forward<PrivateCertificateSecretArnT>(value);
  }
  template <typename PrivateCertificateSecretArnT = Aws::String>
  TLSCertificateConfiguration& WithPrivateCertificateSecretArn(PrivateCertificateSecretArnT&& value) {
    SetPrivateCertificateSecretArn(std::forward<PrivateCertificateSecretArnT>(value));
    return *this;
  }
  ///@}
 private:
