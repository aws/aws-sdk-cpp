...
class ParametricCloudWatchMonitoringConfiguration {
 public:
  ...
  template <typename LogGroupNameT = Aws::String>
  ParametricCloudWatchMonitoringConfiguration& WithLogGroupName(LogGroupNameT&& value) {
  ...
  template <typename LogStreamNamePrefixT = Aws::String>
  ParametricCloudWatchMonitoringConfiguration& WithLogStreamNamePrefix(LogStreamNamePrefixT&& value) {
