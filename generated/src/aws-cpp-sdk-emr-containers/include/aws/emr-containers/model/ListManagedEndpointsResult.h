...
class ListManagedEndpointsResult {
 public:
  ...
  template <typename EndpointsT = Aws::Vector<Endpoint>>
  ListManagedEndpointsResult& WithEndpoints(EndpointsT&& value) {
    SetEndpoints(std::forward<EndpointsT>(value));
    return *this;
  }
  template <typename EndpointsT = Endpoint>
  ListManagedEndpointsResult& AddEndpoints(EndpointsT&& value) {
    m_endpointsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedEndpointsResult& WithRequestId(RequestIdT&& value) {
