...
class ListVirtualClustersResult {
 public:
  ...
  void SetVirtualClusters(VirtualClustersT&& value) {
    m_virtualClustersHasBeenSet = true;
    m_virtualClusters = std::forward<VirtualClustersT>(value);
  }
  template <typename VirtualClustersT = Aws::Vector<VirtualCluster>>
  ListVirtualClustersResult& WithVirtualClusters(VirtualClustersT&& value) {
    SetVirtualClusters(std::forward<VirtualClustersT>(value));
    return *this;
  }
  template <typename VirtualClustersT = VirtualCluster>
  ListVirtualClustersResult& AddVirtualClusters(VirtualClustersT&& value) {
    m_virtualClustersHasBeenSet = true;
    m_virtualClusters.emplace_back(std::forward<VirtualClustersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVirtualClustersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVirtualClustersResult& WithRequestId(RequestIdT&& value) {
