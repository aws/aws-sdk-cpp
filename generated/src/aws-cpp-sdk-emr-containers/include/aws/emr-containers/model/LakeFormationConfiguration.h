...
class LakeFormationConfiguration {
 public:
  ...
  void SetAuthorizedSessionTagValue(AuthorizedSessionTagValueT&& value) {
    ...
    m_authorizedSessionTagValue = std::forward<AuthorizedSessionTagValueT>(value);
  }
  template <typename AuthorizedSessionTagValueT = Aws::String>
  LakeFormationConfiguration& WithAuthorizedSessionTagValue(AuthorizedSessionTagValueT&& value) {
    SetAuthorizedSessionTagValue(std::forward<AuthorizedSessionTagValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecureNamespaceInfo(SecureNamespaceInfoT&& value) {
    m_secureNamespaceInfoHasBeenSet = true;
    m_secureNamespaceInfo = std::forward<SecureNamespaceInfoT>(value);
  }
  template <typename SecureNamespaceInfoT = SecureNamespaceInfo>
  LakeFormationConfiguration& WithSecureNamespaceInfo(SecureNamespaceInfoT&& value) {
    SetSecureNamespaceInfo(std::forward<SecureNamespaceInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueryEngineRoleArn(QueryEngineRoleArnT&& value) {
    m_queryEngineRoleArnHasBeenSet = true;
    m_queryEngineRoleArn = std::forward<QueryEngineRoleArnT>(value);
  }
  template <typename QueryEngineRoleArnT = Aws::String>
  LakeFormationConfiguration& WithQueryEngineRoleArn(QueryEngineRoleArnT&& value) {
    SetQueryEngineRoleArn(std::forward<QueryEngineRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
