...
class JobTemplate {
 public:
  ...
  template <typename CreatedByT = Aws::String>
  JobTemplate& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  JobTemplate& WithTags(TagsT&& value) {
  ...
  void SetJobTemplateData(JobTemplateDataT&& value) {
    m_jobTemplateDataHasBeenSet = true;
    m_jobTemplateData = std::forward<JobTemplateDataT>(value);
  }
  template <typename JobTemplateDataT = JobTemplateData>
  JobTemplate& WithJobTemplateData(JobTemplateDataT&& value) {
    SetJobTemplateData(std::forward<JobTemplateDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyArnT = Aws::String>
  JobTemplate& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  void SetDecryptionError(DecryptionErrorT&& value) {
    m_decryptionErrorHasBeenSet = true;
    m_decryptionError = std::forward<DecryptionErrorT>(value);
  }
  template <typename DecryptionErrorT = Aws::String>
  JobTemplate& WithDecryptionError(DecryptionErrorT&& value) {
    SetDecryptionError(std::forward<DecryptionErrorT>(value));
    return *this;
  }
  ///@}
 private:
