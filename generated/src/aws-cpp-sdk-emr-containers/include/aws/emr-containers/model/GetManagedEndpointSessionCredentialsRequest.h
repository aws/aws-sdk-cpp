...
class GetManagedEndpointSessionCredentialsRequest : public EMRContainersRequest {
 public:
  ...
  void SetVirtualClusterIdentifier(VirtualClusterIdentifierT&& value) {
    m_virtualClusterIdentifierHasBeenSet = true;
    m_virtualClusterIdentifier = std::forward<VirtualClusterIdentifierT>(value);
  }
  template <typename VirtualClusterIdentifierT = Aws::String>
  GetManagedEndpointSessionCredentialsRequest& WithVirtualClusterIdentifier(VirtualClusterIdentifierT&& value) {
    SetVirtualClusterIdentifier(std::forward<VirtualClusterIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCredentialType(CredentialTypeT&& value) {
    ...
    m_credentialType = std::forward<CredentialTypeT>(value);
  }
  template <typename CredentialTypeT = Aws::String>
  GetManagedEndpointSessionCredentialsRequest& WithCredentialType(CredentialTypeT&& value) {
    SetCredentialType(std::forward<CredentialTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetManagedEndpointSessionCredentialsRequest& WithDurationInSeconds(int value) {
  ...
  void SetLogContext(LogContextT&& value) {
    m_logContextHasBeenSet = true;
    m_logContext = std::forward<LogContextT>(value);
  }
  template <typename LogContextT = Aws::String>
  GetManagedEndpointSessionCredentialsRequest& WithLogContext(LogContextT&& value) {
    SetLogContext(std::forward<LogContextT>(value));
    return *this;
  }
  ///@}
