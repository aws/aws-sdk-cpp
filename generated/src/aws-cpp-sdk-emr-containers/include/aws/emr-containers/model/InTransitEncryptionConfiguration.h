...
class InTransitEncryptionConfiguration {
 public:
  ...
  void SetTlsCertificateConfiguration(TlsCertificateConfigurationT&& value) {
    m_tlsCertificateConfigurationHasBeenSet = true;
    m_tlsCertificateConfiguration = std::forward<TlsCertificateConfigurationT>(value);
  }
  template <typename TlsCertificateConfigurationT = TLSCertificateConfiguration>
  InTransitEncryptionConfiguration& WithTlsCertificateConfiguration(TlsCertificateConfigurationT&& value) {
    SetTlsCertificateConfiguration(std::forward<TlsCertificateConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
