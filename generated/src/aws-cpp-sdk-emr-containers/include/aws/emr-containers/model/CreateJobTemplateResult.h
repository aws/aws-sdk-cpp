...
class CreateJobTemplateResult {
 public:
  AWS_EMRCONTAINERS_API CreateJobTemplateResult() = default;
  ...
  template <typename IdT = Aws::String>
  CreateJobTemplateResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateJobTemplateResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateJobTemplateResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateJobTemplateResult& WithCreatedAt(CreatedAtT&& value) {
