...
class CreateJobTemplateRequest : public EMRContainersRequest {
 public:
  AWS_EMRCONTAINERS_API CreateJobTemplateRequest() = default;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateJobTemplateRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename JobTemplateDataT = JobTemplateData>
  CreateJobTemplateRequest& WithJobTemplateData(JobTemplateDataT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  CreateJobTemplateRequest& WithKmsKeyArn(KmsKeyArnT&& value) {
