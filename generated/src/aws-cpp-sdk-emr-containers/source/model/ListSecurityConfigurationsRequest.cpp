...
Aws::String ListSecurityConfigurationsRequest::SerializePayload() const { return {}; }

void ListSecurityConfigurationsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
