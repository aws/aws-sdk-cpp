...
namespace FIS
{
const size_t FISEndpointRules::RulesBlobStrLen = 3729;
const size_t FISEndpointRules::RulesBlobSize = 3730;
...
'h','t','t','p','s',':','/','/','f','i','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
