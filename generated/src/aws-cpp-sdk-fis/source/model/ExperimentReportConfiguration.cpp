...
ExperimentReportConfiguration::ExperimentReportConfiguration(JsonView jsonValue) { *this = jsonValue; }

ExperimentReportConfiguration& ExperimentReportConfiguration::operator=(JsonView jsonValue) {
...
JsonValue ExperimentReportConfiguration::Jsonize() const {
  JsonValue payload;
