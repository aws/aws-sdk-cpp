...
ExperimentTemplateReportConfiguration::ExperimentTemplateReportConfiguration() : 
...
ExperimentTemplateReportConfiguration::ExperimentTemplateReportConfiguration(JsonView jsonValue)
  : ExperimentTemplateReportConfiguration()
{
  *this = jsonValue;
}

ExperimentTemplateReportConfiguration& ExperimentTemplateReportConfiguration::operator =(JsonView jsonValue)
{
...
JsonValue ExperimentTemplateReportConfiguration::Jsonize() const
{
  JsonValue payload;
