...
ListExperimentTemplatesResult::ListExperimentTemplatesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListExperimentTemplatesResult& ListExperimentTemplatesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("experimentTemplates")) {
    ...
    for (unsigned experimentTemplatesIndex = 0; experimentTemplatesIndex < experimentTemplatesJsonList.GetLength();
         ++experimentTemplatesIndex) {
      m_experimentTemplates.push_back(experimentTemplatesJsonList[experimentTemplatesIndex].AsObject());
    }
    m_experimentTemplatesHasBeenSet = true;
  }
