...
namespace Model
{
  ...
  public:
    ...
    template<typename ExperimentTemplateT = ExperimentTemplate>
    CreateExperimentTemplateResult& WithExperimentTemplate(ExperimentTemplateT&& value) { SetExperimentTemplate(std::forward<ExperimentTemplateT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateExperimentTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
