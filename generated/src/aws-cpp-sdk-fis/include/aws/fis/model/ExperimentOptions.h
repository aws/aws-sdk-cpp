...
class ExperimentOptions {
 public:
  ...
  inline ExperimentOptions& WithAccountTargeting(AccountTargeting value) {
  ...
  inline ExperimentOptions& WithEmptyTargetResolutionMode(EmptyTargetResolutionMode value) {
  ...
  inline void SetActionsMode(ActionsMode value) {
    m_actionsModeHasBeenSet = true;
    m_actionsMode = value;
  }
  inline ExperimentOptions& WithActionsMode(ActionsMode value) {
    SetActionsMode(value);
    return *this;
  }
  ///@}
 private:
