...
class ListExperimentResolvedTargetsRequest : public FISRequest {
 public:
  ...
  template <typename ExperimentIdT = Aws::String>
  ListExperimentResolvedTargetsRequest& WithExperimentId(ExperimentIdT&& value) {
  ...
  inline ListExperimentResolvedTargetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListExperimentResolvedTargetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TargetNameT = Aws::String>
  ListExperimentResolvedTargetsRequest& WithTargetName(TargetNameT&& value) {
