...
class ExperimentReportState {
 public:
  ...
  inline void SetStatus(ExperimentReportStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ExperimentReportState& WithStatus(ExperimentReportStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonT = Aws::String>
  ExperimentReportState& WithReason(ReasonT&& value) {
  ...
  template <typename ErrorT = ExperimentReportError>
  ExperimentReportState& WithError(ErrorT&& value) {
