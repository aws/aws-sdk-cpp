 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/fis-2020-12-01/ReportConfigurationS3OutputInput">AWS
 * API Reference</a></p>
 */
class ReportConfigurationS3OutputInput {
 public:
  ...
  template <typename BucketNameT = Aws::String>
  ReportConfigurationS3OutputInput& WithBucketName(BucketNameT&& value) {
  ...
  template <typename PrefixT = Aws::String>
  ReportConfigurationS3OutputInput& WithPrefix(PrefixT&& value) {
