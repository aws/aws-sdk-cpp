...
class ExperimentReportConfigurationOutputsS3Configuration {
 public:
  ...
  template <typename BucketNameT = Aws::String>
  ExperimentReportConfigurationOutputsS3Configuration& WithBucketName(BucketNameT&& value) {
  ...
  template <typename PrefixT = Aws::String>
  ExperimentReportConfigurationOutputsS3Configuration& WithPrefix(PrefixT&& value) {
