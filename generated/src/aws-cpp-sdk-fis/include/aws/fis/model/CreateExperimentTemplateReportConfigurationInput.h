...
namespace Model
{
  ...
  /**
   * <p>Specifies the configuration for experiment reports.</p><p><h3>See Also:</h3> 
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/fis-2020-12-01/CreateExperimentTemplateReportConfigurationInput">AWS
   * API Reference</a></p>
   */
  class CreateExperimentTemplateReportConfigurationInput
  {
  public:
    AWS_FIS_API CreateExperimentTemplateReportConfigurationInput();
    AWS_FIS_API CreateExperimentTemplateReportConfigurationInput(Aws::Utils::Json::JsonView jsonValue);
    AWS_FIS_API CreateExperimentTemplateReportConfigurationInput& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline CreateExperimentTemplateReportConfigurationInput& WithOutputs(const ExperimentTemplateReportConfigurationOutputsInput& value) { SetOutputs(value); return *this;}
    inline CreateExperimentTemplateReportConfigurationInput& WithOutputs(ExperimentTemplateReportConfigurationOutputsInput&& value) { SetOutputs(std::move(value)); return *this;}
    ///@}
    ...
    inline CreateExperimentTemplateReportConfigurationInput& WithDataSources(const ExperimentTemplateReportConfigurationDataSourcesInput& value) { SetDataSources(value); return *this;}
    inline CreateExperimentTemplateReportConfigurationInput& WithDataSources(ExperimentTemplateReportConfigurationDataSourcesInput&& value) { SetDataSources(std::move(value)); return *this;}
    ///@}
    ...
    inline CreateExperimentTemplateReportConfigurationInput& WithPreExperimentDuration(const Aws::String& value) { SetPreExperimentDuration(value); return *this;}
    inline CreateExperimentTemplateReportConfigurationInput& WithPreExperimentDuration(Aws::String&& value) { SetPreExperimentDuration(std::move(value)); return *this;}
    inline CreateExperimentTemplateReportConfigurationInput& WithPreExperimentDuration(const char* value) { SetPreExperimentDuration(value); return *this;}
    ///@}
    ...
    inline CreateExperimentTemplateReportConfigurationInput& WithPostExperimentDuration(const Aws::String& value) { SetPostExperimentDuration(value); return *this;}
    inline CreateExperimentTemplateReportConfigurationInput& WithPostExperimentDuration(Aws::String&& value) { SetPostExperimentDuration(std::move(value)); return *this;}
    inline CreateExperimentTemplateReportConfigurationInput& WithPostExperimentDuration(const char* value) { SetPostExperimentDuration(value); return *this;}
    ///@}
  private:
