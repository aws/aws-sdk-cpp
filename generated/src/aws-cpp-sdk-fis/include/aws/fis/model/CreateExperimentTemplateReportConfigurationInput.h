...
class CreateExperimentTemplateReportConfigurationInput {
 public:
  AWS_FIS_API CreateExperimentTemplateReportConfigurationInput() = default;
  ...
  template <typename OutputsT = ExperimentTemplateReportConfigurationOutputsInput>
  CreateExperimentTemplateReportConfigurationInput& WithOutputs(OutputsT&& value) {
  ...
  template <typename DataSourcesT = ExperimentTemplateReportConfigurationDataSourcesInput>
  CreateExperimentTemplateReportConfigurationInput& WithDataSources(DataSourcesT&& value) {
  ...
  template <typename PreExperimentDurationT = Aws::String>
  CreateExperimentTemplateReportConfigurationInput& WithPreExperimentDuration(PreExperimentDurationT&& value) {
  ...
  template <typename PostExperimentDurationT = Aws::String>
  CreateExperimentTemplateReportConfigurationInput& WithPostExperimentDuration(PostExperimentDurationT&& value) {
