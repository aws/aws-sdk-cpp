...
class GetTargetAccountConfigurationResult {
 public:
  ...
  template <typename TargetAccountConfigurationT = TargetAccountConfiguration>
  GetTargetAccountConfigurationResult& WithTargetAccountConfiguration(TargetAccountConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTargetAccountConfigurationResult& WithRequestId(RequestIdT&& value) {
