...
namespace Model
{
  ...
  {
  public:
    AWS_FIS_API GetTargetAccountConfigurationResult() = default;
    ...
    template<typename TargetAccountConfigurationT = TargetAccountConfiguration>
    GetTargetAccountConfigurationResult& WithTargetAccountConfiguration(TargetAccountConfigurationT&& value) { SetTargetAccountConfiguration(std::forward<TargetAccountConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetTargetAccountConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
