...
class CreateExperimentTemplateExperimentOptionsInput {
 public:
  ...
  inline CreateExperimentTemplateExperimentOptionsInput& WithAccountTargeting(AccountTargeting value) {
  ...
  inline void SetEmptyTargetResolutionMode(EmptyTargetResolutionMode value) {
    m_emptyTargetResolutionModeHasBeenSet = true;
    m_emptyTargetResolutionMode = value;
  }
  inline CreateExperimentTemplateExperimentOptionsInput& WithEmptyTargetResolutionMode(EmptyTargetResolutionMode value) {
    SetEmptyTargetResolutionMode(value);
    return *this;
  }
  ///@}
 private:
