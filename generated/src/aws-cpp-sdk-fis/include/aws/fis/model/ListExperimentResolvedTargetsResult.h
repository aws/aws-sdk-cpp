...
class ListExperimentResolvedTargetsResult {
 public:
  ...
  template <typename ResolvedTargetsT = Aws::Vector<ResolvedTarget>>
  ListExperimentResolvedTargetsResult& WithResolvedTargets(ResolvedTargetsT&& value) {
    SetResolvedTargets(std::forward<ResolvedTargetsT>(value));
    return *this;
  }
  template <typename ResolvedTargetsT = ResolvedTarget>
  ListExperimentResolvedTargetsResult& AddResolvedTargets(ResolvedTargetsT&& value) {
    m_resolvedTargetsHasBeenSet = true;
    m_resolvedTargets.emplace_back(std::forward<ResolvedTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListExperimentResolvedTargetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExperimentResolvedTargetsResult& WithRequestId(RequestIdT&& value) {
