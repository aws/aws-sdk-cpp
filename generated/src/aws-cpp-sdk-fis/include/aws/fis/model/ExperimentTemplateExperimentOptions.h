...
class ExperimentTemplateExperimentOptions {
 public:
  ...
  inline ExperimentTemplateExperimentOptions& WithAccountTargeting(AccountTargeting value) {
  ...
  inline ExperimentTemplateExperimentOptions& WithEmptyTargetResolutionMode(EmptyTargetResolutionMode value) {
