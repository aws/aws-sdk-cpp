...
namespace Model
{
  ...
  public:
     ...
     * <p>The Amazon Resource Name (ARN) of the experiment template.</p>
     */
    inline ExperimentTemplateSummary& WithArn(const Aws::String& value) { SetArn(value); return *this;}

    /**
     * <p>The Amazon Resource Name (ARN) of the experiment template.</p>
     */
    inline ExperimentTemplateSummary& WithArn(Aws::String&& value) { SetArn(std::move(value)); return *this;}

    /**
     * <p>The Amazon Resource Name (ARN) of the experiment template.</p>
     */
    inline ExperimentTemplateSummary& WithArn(const char* value) { SetArn(value); return *this;}
