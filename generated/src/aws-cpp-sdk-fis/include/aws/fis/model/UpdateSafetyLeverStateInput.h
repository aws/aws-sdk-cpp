...
class UpdateSafetyLeverStateInput {
 public:
  ...
  inline void SetStatus(SafetyLeverStatusInput value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateSafetyLeverStateInput& WithStatus(SafetyLeverStatusInput value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonT = Aws::String>
  UpdateSafetyLeverStateInput& WithReason(ReasonT&& value) {
