...
namespace Model
{
  ...
  public:
    ...
    template<typename ExperimentTemplateT = ExperimentTemplate>
    GetExperimentTemplateResult& WithExperimentTemplate(ExperimentTemplateT&& value) { SetExperimentTemplate(std::forward<ExperimentTemplateT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetExperimentTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
