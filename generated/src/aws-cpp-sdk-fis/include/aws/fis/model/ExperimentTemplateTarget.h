...
class ExperimentTemplateTarget {
 public:
  ...
  template <typename ResourceTypeT = Aws::String>
  ExperimentTemplateTarget& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceArnsT = Aws::Vector<Aws::String>>
  ExperimentTemplateTarget& WithResourceArns(ResourceArnsT&& value) {
    SetResourceArns(std::forward<ResourceArnsT>(value));
    return *this;
  }
  template <typename ResourceArnsT = Aws::String>
  ExperimentTemplateTarget& AddResourceArns(ResourceArnsT&& value) {
    m_resourceArnsHasBeenSet = true;
  ...
  template <typename ResourceTagsT = Aws::Map<Aws::String, Aws::String>>
  ExperimentTemplateTarget& WithResourceTags(ResourceTagsT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<ExperimentTemplateTargetFilter>>
  ExperimentTemplateTarget& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ExperimentTemplateTargetFilter>
  ExperimentTemplateTarget& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename SelectionModeT = Aws::String>
  ExperimentTemplateTarget& WithSelectionMode(SelectionModeT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::String>>
  ExperimentTemplateTarget& WithParameters(ParametersT&& value) {
