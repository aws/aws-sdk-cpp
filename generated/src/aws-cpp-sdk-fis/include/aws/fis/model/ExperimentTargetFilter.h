...
class ExperimentTargetFilter {
 public:
  AWS_FIS_API ExperimentTargetFilter() = default;
  ...
  template <typename PathT = Aws::String>
  ExperimentTargetFilter& WithPath(PathT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ExperimentTargetFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ExperimentTargetFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
