...
namespace Model
{
  ...
  public:
    ...
    template<typename ResourceTypeT = Aws::String>
    TargetResourceTypeSummary& WithResourceType(ResourceTypeT&& value) { SetResourceType(std::forward<ResourceTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    TargetResourceTypeSummary& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
  private:
