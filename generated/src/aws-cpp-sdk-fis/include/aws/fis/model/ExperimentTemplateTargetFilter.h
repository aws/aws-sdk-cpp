...
class ExperimentTemplateTargetFilter {
 public:
  AWS_FIS_API ExperimentTemplateTargetFilter() = default;
  ...
  template <typename PathT = Aws::String>
  ExperimentTemplateTargetFilter& WithPath(PathT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ExperimentTemplateTargetFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ExperimentTemplateTargetFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
