...
class UpdateExperimentTemplateReportConfigurationInput {
 public:
  ...
  template <typename OutputsT = ExperimentTemplateReportConfigurationOutputsInput>
  UpdateExperimentTemplateReportConfigurationInput& WithOutputs(OutputsT&& value) {
  ...
  template <typename DataSourcesT = ExperimentTemplateReportConfigurationDataSourcesInput>
  UpdateExperimentTemplateReportConfigurationInput& WithDataSources(DataSourcesT&& value) {
  ...
  void SetPreExperimentDuration(PreExperimentDurationT&& value) {
    ...
    m_preExperimentDuration = std::forward<PreExperimentDurationT>(value);
  }
  template <typename PreExperimentDurationT = Aws::String>
  UpdateExperimentTemplateReportConfigurationInput& WithPreExperimentDuration(PreExperimentDurationT&& value) {
    SetPreExperimentDuration(std::forward<PreExperimentDurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostExperimentDuration(PostExperimentDurationT&& value) {
    ...
    m_postExperimentDuration = std::forward<PostExperimentDurationT>(value);
  }
  template <typename PostExperimentDurationT = Aws::String>
  UpdateExperimentTemplateReportConfigurationInput& WithPostExperimentDuration(PostExperimentDurationT&& value) {
    SetPostExperimentDuration(std::forward<PostExperimentDurationT>(value));
    return *this;
  }
  ///@}
 private:
