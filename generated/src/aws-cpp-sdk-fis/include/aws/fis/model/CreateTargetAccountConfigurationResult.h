...
class CreateTargetAccountConfigurationResult {
 public:
  ...
  template <typename TargetAccountConfigurationT = TargetAccountConfiguration>
  CreateTargetAccountConfigurationResult& WithTargetAccountConfiguration(TargetAccountConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTargetAccountConfigurationResult& WithRequestId(RequestIdT&& value) {
