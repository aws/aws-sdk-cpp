...
class CreateExperimentTemplateTargetInput {
 public:
  ...
  template <typename ResourceTypeT = Aws::String>
  CreateExperimentTemplateTargetInput& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceArnsT = Aws::Vector<Aws::String>>
  CreateExperimentTemplateTargetInput& WithResourceArns(ResourceArnsT&& value) {
    SetResourceArns(std::forward<ResourceArnsT>(value));
    return *this;
  }
  template <typename ResourceArnsT = Aws::String>
  CreateExperimentTemplateTargetInput& AddResourceArns(ResourceArnsT&& value) {
    m_resourceArnsHasBeenSet = true;
  ...
  template <typename ResourceTagsT = Aws::Map<Aws::String, Aws::String>>
  CreateExperimentTemplateTargetInput& WithResourceTags(ResourceTagsT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<ExperimentTemplateTargetInputFilter>>
  CreateExperimentTemplateTargetInput& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ExperimentTemplateTargetInputFilter>
  CreateExperimentTemplateTargetInput& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename SelectionModeT = Aws::String>
  CreateExperimentTemplateTargetInput& WithSelectionMode(SelectionModeT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::String>>
  CreateExperimentTemplateTargetInput& WithParameters(ParametersT&& value) {
