...
class ExperimentActionState {
 public:
  ...
  inline void SetStatus(ExperimentActionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ExperimentActionState& WithStatus(ExperimentActionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonT = Aws::String>
  ExperimentActionState& WithReason(ReasonT&& value) {
