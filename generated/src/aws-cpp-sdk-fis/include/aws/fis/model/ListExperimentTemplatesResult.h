...
class ListExperimentTemplatesResult {
 public:
  ...
  void SetExperimentTemplates(ExperimentTemplatesT&& value) {
    m_experimentTemplatesHasBeenSet = true;
    m_experimentTemplates = std::forward<ExperimentTemplatesT>(value);
  }
  template <typename ExperimentTemplatesT = Aws::Vector<ExperimentTemplateSummary>>
  ListExperimentTemplatesResult& WithExperimentTemplates(ExperimentTemplatesT&& value) {
    SetExperimentTemplates(std::forward<ExperimentTemplatesT>(value));
    return *this;
  }
  template <typename ExperimentTemplatesT = ExperimentTemplateSummary>
  ListExperimentTemplatesResult& AddExperimentTemplates(ExperimentTemplatesT&& value) {
    m_experimentTemplatesHasBeenSet = true;
    m_experimentTemplates.emplace_back(std::forward<ExperimentTemplatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListExperimentTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExperimentTemplatesResult& WithRequestId(RequestIdT&& value) {
