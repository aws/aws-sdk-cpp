...
class GetTargetAccountConfigurationRequest : public FISRequest {
 public:
  ...
  template <typename ExperimentTemplateIdT = Aws::String>
  GetTargetAccountConfigurationRequest& WithExperimentTemplateId(ExperimentTemplateIdT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  GetTargetAccountConfigurationRequest& WithAccountId(AccountIdT&& value) {
