...
namespace Model
{
  ...
  public:
    ...
    template<typename CloudWatchLogsConfigurationT = ExperimentTemplateCloudWatchLogsLogConfiguration>
    ExperimentTemplateLogConfiguration& WithCloudWatchLogsConfiguration(CloudWatchLogsConfigurationT&& value) { SetCloudWatchLogsConfiguration(std::forward<CloudWatchLogsConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename S3ConfigurationT = ExperimentTemplateS3LogConfiguration>
    ExperimentTemplateLogConfiguration& WithS3Configuration(S3ConfigurationT&& value) { SetS3Configuration(std::forward<S3ConfigurationT>(value)); return *this;}
    ///@}
