...
class ExperimentTemplateReportConfigurationDataSources {
 public:
   ...
   * report.</p>
   */
  inline const Aws::Vector<ExperimentTemplateReportConfigurationCloudWatchDashboard>& GetCloudWatchDashboards() const {
    return m_cloudWatchDashboards;
  }
  ...
  template <typename CloudWatchDashboardsT = Aws::Vector<ExperimentTemplateReportConfigurationCloudWatchDashboard>>
  ExperimentTemplateReportConfigurationDataSources& WithCloudWatchDashboards(CloudWatchDashboardsT&& value) {
  ...
  ExperimentTemplateReportConfigurationDataSources& AddCloudWatchDashboards(CloudWatchDashboardsT&& value) {
    m_cloudWatchDashboardsHasBeenSet = true;
