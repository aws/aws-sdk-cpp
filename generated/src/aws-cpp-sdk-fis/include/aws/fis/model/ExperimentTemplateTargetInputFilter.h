...
class ExperimentTemplateTargetInputFilter {
 public:
  ...
  template <typename PathT = Aws::String>
  ExperimentTemplateTargetInputFilter& WithPath(PathT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ExperimentTemplateTargetInputFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ExperimentTemplateTargetInputFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
