...
namespace Model
{
  ...
  public:
    ...
    template<typename BucketNameT = Aws::String>
    ReportConfigurationS3Output& WithBucketName(BucketNameT&& value) { SetBucketName(std::forward<BucketNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PrefixT = Aws::String>
    ReportConfigurationS3Output& WithPrefix(PrefixT&& value) { SetPrefix(std::forward<PrefixT>(value)); return *this;}
    ///@}
  private:
