...
class AWS_FIS_API FISClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  FISClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<FISEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreateExperimentTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateExperimentTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateExperimentTemplateRequestT = Model::CreateExperimentTemplateRequest>
  void CreateExperimentTemplateAsync(const CreateExperimentTemplateRequestT& request,
                                     const CreateExperimentTemplateResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateTargetAccountConfigurationOutcome CreateTargetAccountConfiguration(
      const Model::CreateTargetAccountConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateTargetAccountConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateTargetAccountConfigurationRequestT = Model::CreateTargetAccountConfigurationRequest>
  Model::CreateTargetAccountConfigurationOutcomeCallable CreateTargetAccountConfigurationCallable(
      const CreateTargetAccountConfigurationRequestT& request) const {
    return SubmitCallable(&FISClient::CreateTargetAccountConfiguration, request);
  }

  /**
   * An Async wrapper for CreateTargetAccountConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateTargetAccountConfigurationRequestT = Model::CreateTargetAccountConfigurationRequest>
  void CreateTargetAccountConfigurationAsync(const CreateTargetAccountConfigurationRequestT& request,
                                             const CreateTargetAccountConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteExperimentTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteExperimentTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteExperimentTemplateRequestT = Model::DeleteExperimentTemplateRequest>
  void DeleteExperimentTemplateAsync(const DeleteExperimentTemplateRequestT& request,
                                     const DeleteExperimentTemplateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteTargetAccountConfigurationOutcome DeleteTargetAccountConfiguration(
      const Model::DeleteTargetAccountConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteTargetAccountConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteTargetAccountConfigurationRequestT = Model::DeleteTargetAccountConfigurationRequest>
  Model::DeleteTargetAccountConfigurationOutcomeCallable DeleteTargetAccountConfigurationCallable(
      const DeleteTargetAccountConfigurationRequestT& request) const {
    return SubmitCallable(&FISClient::DeleteTargetAccountConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteTargetAccountConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteTargetAccountConfigurationRequestT = Model::DeleteTargetAccountConfigurationRequest>
  void DeleteTargetAccountConfigurationAsync(const DeleteTargetAccountConfigurationRequestT& request,
                                             const DeleteTargetAccountConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetExperiment that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetExperimentRequestT = Model::GetExperimentRequest>
  void GetExperimentAsync(const GetExperimentRequestT& request, const GetExperimentResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetExperimentTargetAccountConfigurationOutcome GetExperimentTargetAccountConfiguration(
      const Model::GetExperimentTargetAccountConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetExperimentTargetAccountConfiguration that returns a future to the operation so that it can be executed in
  ...
  Model::GetExperimentTargetAccountConfigurationOutcomeCallable GetExperimentTargetAccountConfigurationCallable(
      const GetExperimentTargetAccountConfigurationRequestT& request) const {
    return SubmitCallable(&FISClient::GetExperimentTargetAccountConfiguration, request);
  }

  /**
   * An Async wrapper for GetExperimentTargetAccountConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetExperimentTargetAccountConfigurationRequestT = Model::GetExperimentTargetAccountConfigurationRequest>
  void GetExperimentTargetAccountConfigurationAsync(const GetExperimentTargetAccountConfigurationRequestT& request,
                                                    const GetExperimentTargetAccountConfigurationResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetExperimentTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetExperimentTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetExperimentTemplateRequestT = Model::GetExperimentTemplateRequest>
  void GetExperimentTemplateAsync(const GetExperimentTemplateRequestT& request, const GetExperimentTemplateResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSafetyLever that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSafetyLeverRequestT = Model::GetSafetyLeverRequest>
  void GetSafetyLeverAsync(const GetSafetyLeverRequestT& request, const GetSafetyLeverResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTargetAccountConfigurationOutcome GetTargetAccountConfiguration(
      const Model::GetTargetAccountConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetTargetAccountConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetTargetAccountConfigurationRequestT = Model::GetTargetAccountConfigurationRequest>
  Model::GetTargetAccountConfigurationOutcomeCallable GetTargetAccountConfigurationCallable(
      const GetTargetAccountConfigurationRequestT& request) const {
    return SubmitCallable(&FISClient::GetTargetAccountConfiguration, request);
  }

  /**
   * An Async wrapper for GetTargetAccountConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTargetAccountConfigurationRequestT = Model::GetTargetAccountConfigurationRequest>
  void GetTargetAccountConfigurationAsync(const GetTargetAccountConfigurationRequestT& request,
                                          const GetTargetAccountConfigurationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTargetResourceType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTargetResourceType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTargetResourceTypeRequestT = Model::GetTargetResourceTypeRequest>
  void GetTargetResourceTypeAsync(const GetTargetResourceTypeRequestT& request, const GetTargetResourceTypeResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListActionsRequestT = Model::ListActionsRequest>
  void ListActionsAsync(const ListActionsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListActionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListExperimentResolvedTargetsOutcome ListExperimentResolvedTargets(
      const Model::ListExperimentResolvedTargetsRequest& request) const;

  /**
   * A Callable wrapper for ListExperimentResolvedTargets that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListExperimentResolvedTargetsRequestT = Model::ListExperimentResolvedTargetsRequest>
  Model::ListExperimentResolvedTargetsOutcomeCallable ListExperimentResolvedTargetsCallable(
      const ListExperimentResolvedTargetsRequestT& request) const {
    return SubmitCallable(&FISClient::ListExperimentResolvedTargets, request);
  }

  /**
   * An Async wrapper for ListExperimentResolvedTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListExperimentResolvedTargetsRequestT = Model::ListExperimentResolvedTargetsRequest>
  void ListExperimentResolvedTargetsAsync(const ListExperimentResolvedTargetsRequestT& request,
                                          const ListExperimentResolvedTargetsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListExperimentTargetAccountConfigurationsOutcome ListExperimentTargetAccountConfigurations(
      const Model::ListExperimentTargetAccountConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListExperimentTargetAccountConfigurations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListExperimentTargetAccountConfigurationsOutcomeCallable ListExperimentTargetAccountConfigurationsCallable(
      const ListExperimentTargetAccountConfigurationsRequestT& request) const {
    return SubmitCallable(&FISClient::ListExperimentTargetAccountConfigurations, request);
  }

  /**
   * An Async wrapper for ListExperimentTargetAccountConfigurations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListExperimentTargetAccountConfigurationsRequestT = Model::ListExperimentTargetAccountConfigurationsRequest>
  void ListExperimentTargetAccountConfigurationsAsync(
      const ListExperimentTargetAccountConfigurationsRequestT& request,
      const ListExperimentTargetAccountConfigurationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListExperimentTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListExperimentTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListExperimentTemplatesRequestT = Model::ListExperimentTemplatesRequest>
  void ListExperimentTemplatesAsync(const ListExperimentTemplatesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListExperimentTemplatesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListExperiments that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListExperimentsRequestT = Model::ListExperimentsRequest>
  void ListExperimentsAsync(const ListExperimentsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListExperimentsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTargetAccountConfigurationsOutcome ListTargetAccountConfigurations(
      const Model::ListTargetAccountConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListTargetAccountConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListTargetAccountConfigurationsRequestT = Model::ListTargetAccountConfigurationsRequest>
  Model::ListTargetAccountConfigurationsOutcomeCallable ListTargetAccountConfigurationsCallable(
      const ListTargetAccountConfigurationsRequestT& request) const {
    return SubmitCallable(&FISClient::ListTargetAccountConfigurations, request);
  }

  /**
   * An Async wrapper for ListTargetAccountConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListTargetAccountConfigurationsRequestT = Model::ListTargetAccountConfigurationsRequest>
  void ListTargetAccountConfigurationsAsync(const ListTargetAccountConfigurationsRequestT& request,
                                            const ListTargetAccountConfigurationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTargetResourceTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTargetResourceTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTargetResourceTypesRequestT = Model::ListTargetResourceTypesRequest>
  void ListTargetResourceTypesAsync(const ListTargetResourceTypesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListTargetResourceTypesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for StartExperiment that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartExperimentRequestT = Model::StartExperimentRequest>
  void StartExperimentAsync(const StartExperimentRequestT& request, const StartExperimentResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopExperiment that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopExperimentRequestT = Model::StopExperimentRequest>
  void StopExperimentAsync(const StopExperimentRequestT& request, const StopExperimentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateExperimentTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateExperimentTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateExperimentTemplateRequestT = Model::UpdateExperimentTemplateRequest>
  void UpdateExperimentTemplateAsync(const UpdateExperimentTemplateRequestT& request,
                                     const UpdateExperimentTemplateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSafetyLeverState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSafetyLeverState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSafetyLeverStateRequestT = Model::UpdateSafetyLeverStateRequest>
  void UpdateSafetyLeverStateAsync(const UpdateSafetyLeverStateRequestT& request,
                                   const UpdateSafetyLeverStateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateTargetAccountConfigurationOutcome UpdateTargetAccountConfiguration(
      const Model::UpdateTargetAccountConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateTargetAccountConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateTargetAccountConfigurationRequestT = Model::UpdateTargetAccountConfigurationRequest>
  Model::UpdateTargetAccountConfigurationOutcomeCallable UpdateTargetAccountConfigurationCallable(
      const UpdateTargetAccountConfigurationRequestT& request) const {
    return SubmitCallable(&FISClient::UpdateTargetAccountConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateTargetAccountConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateTargetAccountConfigurationRequestT = Model::UpdateTargetAccountConfigurationRequest>
  void UpdateTargetAccountConfigurationAsync(const UpdateTargetAccountConfigurationRequestT& request,
                                             const UpdateTargetAccountConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
