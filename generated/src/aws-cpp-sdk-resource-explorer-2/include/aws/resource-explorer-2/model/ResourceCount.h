...
class ResourceCount {
 public:
  AWS_RESOURCEEXPLORER2_API ResourceCount() = default;
  ...
  inline void SetTotalResources(long long value) {
    m_totalResourcesHasBeenSet = true;
    m_totalResources = value;
  }
  inline ResourceCount& WithTotalResources(long long value) {
  ...
  inline ResourceCount& WithComplete(bool value) {
    SetComplete(value);
    return *this;
  }
  ///@}
