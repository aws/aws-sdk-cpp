...
class UpdateIndexTypeResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateIndexTypeResult& WithArn(ArnT&& value) {
  ...
  inline UpdateIndexTypeResult& WithType(IndexType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(IndexState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline UpdateIndexTypeResult& WithState(IndexState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  UpdateIndexTypeResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateIndexTypeResult& WithRequestId(RequestIdT&& value) {
