...
class ListIndexesForMembersRequest : public ResourceExplorer2Request {
 public:
  ...
  void SetAccountIdList(AccountIdListT&& value) {
    m_accountIdListHasBeenSet = true;
    m_accountIdList = std::forward<AccountIdListT>(value);
  }
  template <typename AccountIdListT = Aws::Vector<Aws::String>>
  ListIndexesForMembersRequest& WithAccountIdList(AccountIdListT&& value) {
    SetAccountIdList(std::forward<AccountIdListT>(value));
    return *this;
  }
  template <typename AccountIdListT = Aws::String>
  ListIndexesForMembersRequest& AddAccountIdList(AccountIdListT&& value) {
    m_accountIdListHasBeenSet = true;
    m_accountIdList.emplace_back(std::forward<AccountIdListT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListIndexesForMembersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIndexesForMembersRequest& WithNextToken(NextTokenT&& value) {
