...
class ListResourcesResult {
 public:
  AWS_RESOURCEEXPLORER2_API ListResourcesResult() = default;
  ...
  template <typename ResourcesT = Aws::Vector<Resource>>
  ListResourcesResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Resource>
  ListResourcesResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename ViewArnT = Aws::String>
  ListResourcesResult& WithViewArn(ViewArnT&& value) {
