...
class GetAccountLevelServiceConfigurationResult {
 public:
  ...
  AWS_RESOURCEEXPLORER2_API GetAccountLevelServiceConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetOrgConfiguration(OrgConfigurationT&& value) {
    m_orgConfigurationHasBeenSet = true;
    m_orgConfiguration = std::forward<OrgConfigurationT>(value);
  }
  template <typename OrgConfigurationT = OrgConfiguration>
  GetAccountLevelServiceConfigurationResult& WithOrgConfiguration(OrgConfigurationT&& value) {
    SetOrgConfiguration(std::forward<OrgConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAccountLevelServiceConfigurationResult& WithRequestId(RequestIdT&& value) {
