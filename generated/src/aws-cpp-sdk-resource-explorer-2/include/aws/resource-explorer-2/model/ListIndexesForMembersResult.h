...
class ListIndexesForMembersResult {
 public:
  ...
  template <typename IndexesT = Aws::Vector<MemberIndex>>
  ListIndexesForMembersResult& WithIndexes(IndexesT&& value) {
    SetIndexes(std::forward<IndexesT>(value));
    return *this;
  }
  template <typename IndexesT = MemberIndex>
  ListIndexesForMembersResult& AddIndexes(IndexesT&& value) {
    m_indexesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListIndexesForMembersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIndexesForMembersResult& WithRequestId(RequestIdT&& value) {
