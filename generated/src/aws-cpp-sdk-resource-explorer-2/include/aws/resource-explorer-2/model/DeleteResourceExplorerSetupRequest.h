...
class DeleteResourceExplorerSetupRequest : public ResourceExplorer2Request {
 public:
  ...
  template <typename RegionListT = Aws::Vector<Aws::String>>
  DeleteResourceExplorerSetupRequest& WithRegionList(RegionListT&& value) {
    SetRegionList(std::forward<RegionListT>(value));
    return *this;
  }
  template <typename RegionListT = Aws::String>
  DeleteResourceExplorerSetupRequest& AddRegionList(RegionListT&& value) {
    m_regionListHasBeenSet = true;
  ...
  inline void SetDeleteInAllRegions(bool value) {
    m_deleteInAllRegionsHasBeenSet = true;
    m_deleteInAllRegions = value;
  }
  inline DeleteResourceExplorerSetupRequest& WithDeleteInAllRegions(bool value) {
    SetDeleteInAllRegions(value);
    return *this;
  }
  ///@}
 private:
