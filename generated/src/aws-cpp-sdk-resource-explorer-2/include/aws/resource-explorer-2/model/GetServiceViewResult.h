...
namespace Model
{
  ...
  public:
    ...
    template<typename ViewT = ServiceView>
    GetServiceViewResult& WithView(ViewT&& value) { SetView(std::forward<ViewT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetServiceViewResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
