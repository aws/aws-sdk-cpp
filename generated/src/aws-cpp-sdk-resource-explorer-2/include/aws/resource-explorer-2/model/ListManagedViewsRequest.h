...
class ListManagedViewsRequest : public ResourceExplorer2Request {
 public:
  ...
  inline ListManagedViewsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedViewsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ServicePrincipalT = Aws::String>
  ListManagedViewsRequest& WithServicePrincipal(ServicePrincipalT&& value) {
