...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public ResourceExplorer2Request
  {
  public:
    AWS_RESOURCEEXPLORER2_API UntagResourceRequest() = default;
    ...
    AWS_RESOURCEEXPLORER2_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;


    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the view or index that you want to remove
     * tags from.</p>
     */
    ...
    ///@{
    /**
     * <p>A list of the keys for the tags that you want to remove from the specified
     * view or index.</p>
     */
