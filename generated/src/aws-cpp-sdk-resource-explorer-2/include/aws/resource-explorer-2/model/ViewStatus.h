...
namespace Model
{
  ...
  public:
    ...
    inline ViewStatus& WithStatus(OperationStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename ViewT = View>
    ViewStatus& WithView(ViewT&& value) { SetView(std::forward<ViewT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorDetailsT = ErrorDetails>
    ViewStatus& WithErrorDetails(ErrorDetailsT&& value) { SetErrorDetails(std::forward<ErrorDetailsT>(value)); return *this;}
    ///@}
  private:
