...
class ListSupportedResourceTypesResult {
 public:
  ...
  AWS_RESOURCEEXPLORER2_API ListSupportedResourceTypesResult& operator=(
  ...
  template <typename ResourceTypesT = Aws::Vector<SupportedResourceType>>
  ListSupportedResourceTypesResult& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  template <typename ResourceTypesT = SupportedResourceType>
  ListSupportedResourceTypesResult& AddResourceTypes(ResourceTypesT&& value) {
    m_resourceTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSupportedResourceTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSupportedResourceTypesResult& WithRequestId(RequestIdT&& value) {
