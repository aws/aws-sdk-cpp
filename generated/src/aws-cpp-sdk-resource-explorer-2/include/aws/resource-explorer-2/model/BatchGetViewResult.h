...
class BatchGetViewResult {
 public:
  ...
  template <typename ViewsT = Aws::Vector<View>>
  BatchGetViewResult& WithViews(ViewsT&& value) {
    SetViews(std::forward<ViewsT>(value));
    return *this;
  }
  template <typename ViewsT = View>
  BatchGetViewResult& AddViews(ViewsT&& value) {
    m_viewsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<BatchGetViewError>>
  BatchGetViewResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchGetViewError>
  BatchGetViewResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetViewResult& WithRequestId(RequestIdT&& value) {
