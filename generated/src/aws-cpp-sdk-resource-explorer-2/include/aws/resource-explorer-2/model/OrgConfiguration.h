...
class OrgConfiguration {
 public:
  ...
  inline void SetAWSServiceAccessStatus(AWSServiceAccessStatus value) {
    m_aWSServiceAccessStatusHasBeenSet = true;
    m_aWSServiceAccessStatus = value;
  }
  inline OrgConfiguration& WithAWSServiceAccessStatus(AWSServiceAccessStatus value) {
    SetAWSServiceAccessStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetServiceLinkedRole(ServiceLinkedRoleT&& value) {
    ...
    m_serviceLinkedRole = std::forward<ServiceLinkedRoleT>(value);
  }
  template <typename ServiceLinkedRoleT = Aws::String>
  OrgConfiguration& WithServiceLinkedRole(ServiceLinkedRoleT&& value) {
    SetServiceLinkedRole(std::forward<ServiceLinkedRoleT>(value));
    return *this;
  }
  ///@}
 private:
