...
class GetIndexResult {
 public:
  ...
  inline GetIndexResult& WithState(IndexState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetReplicatingFrom(ReplicatingFromT&& value) {
    ...
    m_replicatingFrom = std::forward<ReplicatingFromT>(value);
  }
  template <typename ReplicatingFromT = Aws::Vector<Aws::String>>
  GetIndexResult& WithReplicatingFrom(ReplicatingFromT&& value) {
    SetReplicatingFrom(std::forward<ReplicatingFromT>(value));
    return *this;
  }
  template <typename ReplicatingFromT = Aws::String>
  GetIndexResult& AddReplicatingFrom(ReplicatingFromT&& value) {
    m_replicatingFromHasBeenSet = true;
    m_replicatingFrom.emplace_back(std::forward<ReplicatingFromT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicatingTo(ReplicatingToT&& value) {
    ...
    m_replicatingTo = std::forward<ReplicatingToT>(value);
  }
  template <typename ReplicatingToT = Aws::Vector<Aws::String>>
  GetIndexResult& WithReplicatingTo(ReplicatingToT&& value) {
    SetReplicatingTo(std::forward<ReplicatingToT>(value));
    return *this;
  }
  template <typename ReplicatingToT = Aws::String>
  GetIndexResult& AddReplicatingTo(ReplicatingToT&& value) {
    m_replicatingToHasBeenSet = true;
    m_replicatingTo.emplace_back(std::forward<ReplicatingToT>(value));
    return *this;
  }
  ///@}
