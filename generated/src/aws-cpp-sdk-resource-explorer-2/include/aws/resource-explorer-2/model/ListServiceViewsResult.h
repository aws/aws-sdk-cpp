...
class ListServiceViewsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceViewsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetServiceViews(ServiceViewsT&& value) {
    m_serviceViewsHasBeenSet = true;
    m_serviceViews = std::forward<ServiceViewsT>(value);
  }
  template <typename ServiceViewsT = Aws::Vector<Aws::String>>
  ListServiceViewsResult& WithServiceViews(ServiceViewsT&& value) {
    SetServiceViews(std::forward<ServiceViewsT>(value));
    return *this;
  }
  template <typename ServiceViewsT = Aws::String>
  ListServiceViewsResult& AddServiceViews(ServiceViewsT&& value) {
    m_serviceViewsHasBeenSet = true;
    m_serviceViews.emplace_back(std::forward<ServiceViewsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListServiceViewsResult& WithRequestId(RequestIdT&& value) {
