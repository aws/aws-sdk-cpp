...
class ListManagedViewsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedViewsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetManagedViews(ManagedViewsT&& value) {
    m_managedViewsHasBeenSet = true;
    m_managedViews = std::forward<ManagedViewsT>(value);
  }
  template <typename ManagedViewsT = Aws::Vector<Aws::String>>
  ListManagedViewsResult& WithManagedViews(ManagedViewsT&& value) {
    SetManagedViews(std::forward<ManagedViewsT>(value));
    return *this;
  }
  template <typename ManagedViewsT = Aws::String>
  ListManagedViewsResult& AddManagedViews(ManagedViewsT&& value) {
    m_managedViewsHasBeenSet = true;
    m_managedViews.emplace_back(std::forward<ManagedViewsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedViewsResult& WithRequestId(RequestIdT&& value) {
