...
class DeleteResourceExplorerSetupResult {
 public:
  ...
  AWS_RESOURCEEXPLORER2_API DeleteResourceExplorerSetupResult& operator=(
  ...
  template <typename TaskIdT = Aws::String>
  DeleteResourceExplorerSetupResult& WithTaskId(TaskIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteResourceExplorerSetupResult& WithRequestId(RequestIdT&& value) {
