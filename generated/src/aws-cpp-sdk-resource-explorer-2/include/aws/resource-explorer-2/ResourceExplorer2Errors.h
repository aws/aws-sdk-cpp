...
public:
  ...
  ResourceExplorer2Error(const Aws::Client::AWSError<ResourceExplorer2Errors>& rhs) : Aws::Client::AWSError<ResourceExplorer2Errors>(rhs) {}
  ResourceExplorer2Error(Aws::Client::AWSError<ResourceExplorer2Errors>&& rhs) : Aws::Client::AWSError<ResourceExplorer2Errors>(rhs) {}
