...
class AWS_RESOURCEEXPLORER2_API ResourceExplorer2Client : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ResourceExplorer2Client(const Aws::ResourceExplorer2::ResourceExplorer2ClientConfiguration& clientConfiguration =
  ...
  ResourceExplorer2Client(const Aws::Auth::AWSCredentials& credentials,
                          std::shared_ptr<ResourceExplorer2EndpointProviderBase> endpointProvider = nullptr,
                          const Aws::ResourceExplorer2::ResourceExplorer2ClientConfiguration& clientConfiguration =
                              Aws::ResourceExplorer2::ResourceExplorer2ClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateDefaultView that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AssociateDefaultViewRequestT = Model::AssociateDefaultViewRequest>
  ...
  /**
   * An Async wrapper for AssociateDefaultView that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateDefaultViewRequestT = Model::AssociateDefaultViewRequest>
  void AssociateDefaultViewAsync(const AssociateDefaultViewRequestT& request, const AssociateDefaultViewResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for BatchGetView that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetViewRequestT = Model::BatchGetViewRequest>
  void BatchGetViewAsync(const BatchGetViewResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const BatchGetViewRequestT& request = {}) const {
   ...
   */
  template <typename CreateIndexRequestT = Model::CreateIndexRequest>
  void CreateIndexAsync(const CreateIndexResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const CreateIndexRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateResourceExplorerSetupOutcome CreateResourceExplorerSetup(
      const Model::CreateResourceExplorerSetupRequest& request) const;

  /**
   * A Callable wrapper for CreateResourceExplorerSetup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateResourceExplorerSetupRequestT = Model::CreateResourceExplorerSetupRequest>
  Model::CreateResourceExplorerSetupOutcomeCallable CreateResourceExplorerSetupCallable(
      const CreateResourceExplorerSetupRequestT& request) const {
    return SubmitCallable(&ResourceExplorer2Client::CreateResourceExplorerSetup, request);
  }

  /**
   * An Async wrapper for CreateResourceExplorerSetup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResourceExplorerSetupRequestT = Model::CreateResourceExplorerSetupRequest>
  void CreateResourceExplorerSetupAsync(const CreateResourceExplorerSetupRequestT& request,
                                        const CreateResourceExplorerSetupResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteResourceExplorerSetupOutcome DeleteResourceExplorerSetup(
      const Model::DeleteResourceExplorerSetupRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteResourceExplorerSetup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteResourceExplorerSetupRequestT = Model::DeleteResourceExplorerSetupRequest>
  Model::DeleteResourceExplorerSetupOutcomeCallable DeleteResourceExplorerSetupCallable(
      const DeleteResourceExplorerSetupRequestT& request = {}) const {
    return SubmitCallable(&ResourceExplorer2Client::DeleteResourceExplorerSetup, request);
  }

  /**
   * An Async wrapper for DeleteResourceExplorerSetup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResourceExplorerSetupRequestT = Model::DeleteResourceExplorerSetupRequest>
  void DeleteResourceExplorerSetupAsync(const DeleteResourceExplorerSetupResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DeleteResourceExplorerSetupRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisassociateDefaultView that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DisassociateDefaultViewRequestT = Model::DisassociateDefaultViewRequest>
  Model::DisassociateDefaultViewOutcomeCallable DisassociateDefaultViewCallable(const DisassociateDefaultViewRequestT& request = {}) const {
    return SubmitCallable(&ResourceExplorer2Client::DisassociateDefaultView, request);
  }

  /**
   * An Async wrapper for DisassociateDefaultView that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateDefaultViewRequestT = Model::DisassociateDefaultViewRequest>
  void DisassociateDefaultViewAsync(const DisassociateDefaultViewResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DisassociateDefaultViewRequestT& request = {}) const {
    return SubmitAsync(&ResourceExplorer2Client::DisassociateDefaultView, request, handler, context);
  }
  ...
  virtual Model::GetAccountLevelServiceConfigurationOutcome GetAccountLevelServiceConfiguration(
      const Model::GetAccountLevelServiceConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetAccountLevelServiceConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetAccountLevelServiceConfigurationRequestT = Model::GetAccountLevelServiceConfigurationRequest>
  Model::GetAccountLevelServiceConfigurationOutcomeCallable GetAccountLevelServiceConfigurationCallable(
      const GetAccountLevelServiceConfigurationRequestT& request = {}) const {
    return SubmitCallable(&ResourceExplorer2Client::GetAccountLevelServiceConfiguration, request);
  }

  /**
   * An Async wrapper for GetAccountLevelServiceConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAccountLevelServiceConfigurationRequestT = Model::GetAccountLevelServiceConfigurationRequest>
  void GetAccountLevelServiceConfigurationAsync(const GetAccountLevelServiceConfigurationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const GetAccountLevelServiceConfigurationRequestT& request = {}) const {
   ...
   */
  template <typename GetDefaultViewRequestT = Model::GetDefaultViewRequest>
  Model::GetDefaultViewOutcomeCallable GetDefaultViewCallable(const GetDefaultViewRequestT& request = {}) const {
    return SubmitCallable(&ResourceExplorer2Client::GetDefaultView, request);
  }

  /**
   * An Async wrapper for GetDefaultView that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDefaultViewRequestT = Model::GetDefaultViewRequest>
  void GetDefaultViewAsync(const GetDefaultViewResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetDefaultViewRequestT& request = {}) const {
    return SubmitAsync(&ResourceExplorer2Client::GetDefaultView, request, handler, context);
  }
  ...
  Model::GetIndexOutcomeCallable GetIndexCallable(const GetIndexRequestT& request = {}) const {
    return SubmitCallable(&ResourceExplorer2Client::GetIndex, request);
  }
   ...
   */
  template <typename GetIndexRequestT = Model::GetIndexRequest>
  void GetIndexAsync(const GetIndexResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                     const GetIndexRequestT& request = {}) const {
    return SubmitAsync(&ResourceExplorer2Client::GetIndex, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for GetManagedView that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetManagedViewRequestT = Model::GetManagedViewRequest>
  void GetManagedViewAsync(const GetManagedViewRequestT& request, const GetManagedViewResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourceExplorerSetup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceExplorerSetup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResourceExplorerSetupRequestT = Model::GetResourceExplorerSetupRequest>
  void GetResourceExplorerSetupAsync(const GetResourceExplorerSetupRequestT& request,
                                     const GetResourceExplorerSetupResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetServiceIndex that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetServiceIndexRequestT = Model::GetServiceIndexRequest>
  void GetServiceIndexAsync(const GetServiceIndexResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const GetServiceIndexRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetServiceView that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetServiceViewRequestT = Model::GetServiceViewRequest>
  void GetServiceViewAsync(const GetServiceViewRequestT& request, const GetServiceViewResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListIndexes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListIndexesRequestT = Model::ListIndexesRequest>
  void ListIndexesAsync(const ListIndexesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListIndexesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListIndexesForMembers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListIndexesForMembers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIndexesForMembersRequestT = Model::ListIndexesForMembersRequest>
  void ListIndexesForMembersAsync(const ListIndexesForMembersRequestT& request, const ListIndexesForMembersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListManagedViews that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListManagedViews that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListManagedViewsRequestT = Model::ListManagedViewsRequest>
  void ListManagedViewsAsync(const ListManagedViewsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListManagedViewsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListServiceIndexes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServiceIndexes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListServiceIndexesRequestT = Model::ListServiceIndexesRequest>
  void ListServiceIndexesAsync(const ListServiceIndexesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListServiceIndexesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListServiceViews that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServiceViews that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListServiceViewsRequestT = Model::ListServiceViewsRequest>
  void ListServiceViewsAsync(const ListServiceViewsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListServiceViewsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListStreamingAccessForServicesOutcome ListStreamingAccessForServices(
      const Model::ListStreamingAccessForServicesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListStreamingAccessForServices that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListStreamingAccessForServicesRequestT = Model::ListStreamingAccessForServicesRequest>
  Model::ListStreamingAccessForServicesOutcomeCallable ListStreamingAccessForServicesCallable(
      const ListStreamingAccessForServicesRequestT& request = {}) const {
    return SubmitCallable(&ResourceExplorer2Client::ListStreamingAccessForServices, request);
  }

  /**
   * An Async wrapper for ListStreamingAccessForServices that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListStreamingAccessForServicesRequestT = Model::ListStreamingAccessForServicesRequest>
  void ListStreamingAccessForServicesAsync(const ListStreamingAccessForServicesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListStreamingAccessForServicesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSupportedResourceTypesOutcome ListSupportedResourceTypes(
      const Model::ListSupportedResourceTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSupportedResourceTypes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSupportedResourceTypesRequestT = Model::ListSupportedResourceTypesRequest>
  Model::ListSupportedResourceTypesOutcomeCallable ListSupportedResourceTypesCallable(
      const ListSupportedResourceTypesRequestT& request = {}) const {
    return SubmitCallable(&ResourceExplorer2Client::ListSupportedResourceTypes, request);
  }

  /**
   * An Async wrapper for ListSupportedResourceTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSupportedResourceTypesRequestT = Model::ListSupportedResourceTypesRequest>
  void ListSupportedResourceTypesAsync(const ListSupportedResourceTypesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListSupportedResourceTypesRequestT& request = {}) const {
   ...
   */
  template <typename UpdateIndexTypeRequestT = Model::UpdateIndexTypeRequest>
  ...
  /**
   * An Async wrapper for UpdateIndexType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateIndexTypeRequestT = Model::UpdateIndexTypeRequest>
  void UpdateIndexTypeAsync(const UpdateIndexTypeRequestT& request, const UpdateIndexTypeResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
