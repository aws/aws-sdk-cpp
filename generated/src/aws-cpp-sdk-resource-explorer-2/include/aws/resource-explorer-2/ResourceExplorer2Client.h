...
namespace ResourceExplorer2
{
   ...
   */
  class AWS_RESOURCEEXPLORER2_API ResourceExplorer2Client : Aws::Client::ClientWithAsyncTemplateMethods<ResourceExplorer2Client>,
    smithy::client::AwsSmithyClientT<Aws::ResourceExplorer2::SERVICE_NAME,
