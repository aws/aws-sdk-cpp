...
{
const size_t ResourceExplorer2EndpointRules::RulesBlobStrLen = 2613;
const size_t ResourceExplorer2EndpointRules::RulesBlobSize = 2614;
...
'"','r','e','f','"',':','"','E','n','d','p','o','i','n','t','"','}',']','}',']',',','"','t','y','p',
'e','"',':','"','t','r','e','e','"',',','"','r','u','l','e','s','"',':','[','{','"','c','o','n','d',
'i','t','i','o','n','s','"',':','[','{','"','f','n','"',':','"','b','o','o','l','e','a','n','E','q',
'u','a','l','s','"',',','"','a','r','g','v','"',':','[','{','"','r','e','f','"',':','"','U','s','e',
'F','I','P','S','"','}',',','t','r','u','e',']','}',']',',','"','e','r','r','o','r','"',':','"','I',
'n','v','a','l','i','d',' ','C','o','n','f','i','g','u','r','a','t','i','o','n',':',' ','F','I','P',
'S',' ','a','n','d',' ','c','u','s','t','o','m',' ','e','n','d','p','o','i','n','t',' ','a','r','e',
...
't','p','s',':','/','/','r','e','s','o','u','r','c','e','-','e','x','p','l','o','r','e','r','-','2',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','e','s','o','u','r','c','e','-','e','x',
'p','l','o','r','e','r','-','2','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'e','s','o','u','r','c','e','-','e','x','p','l','o','r','e','r','-','2','.','{','R','e','g','i','o',
