...
{
const size_t ResourceExplorer2EndpointRules::RulesBlobStrLen = 2693;
const size_t ResourceExplorer2EndpointRules::RulesBlobSize = 2694;
...
'r','a','t','i','o','n',':',' ','F','I','P','S',' ','a','n','d',' ','c','u','s','t','o','m',' ','e',
'n','d','p','o','i','n','t',' ','a','r','e',' ','n','o','t',' ','s','u','p','p','o','r','t','e','d',
'"',',','"','t','y','p','e','"',':','"','e','r','r','o','r','"','}',',','{','"','c','o','n','d','i',
't','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r',
'l','"',':','{','"','r','e','f','"',':','"','E','n','d','p','o','i','n','t','"','}',',','"','p','r',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','e','s',
'o','u','r','c','e','-','e','x','p','l','o','r','e','r','-','2','-','f','i','p','s','.','{','R','e',
...
'e','x','p','l','o','r','e','r','-','2','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','e','s','o','u','r','c','e','-','e',
'x','p','l','o','r','e','r','-','2','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'r','e','s','o','u','r','c','e','-','e','x','p','l','o','r','e','r','-','2','.','{','R','e','g','i',
...
const char* ResourceExplorer2EndpointRules::GetRulesBlob()
{
