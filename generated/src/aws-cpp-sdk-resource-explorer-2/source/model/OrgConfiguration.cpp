...
OrgConfiguration::OrgConfiguration(JsonView jsonValue) { *this = jsonValue; }

OrgConfiguration& OrgConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("AWSServiceAccessStatus")) {
    m_aWSServiceAccessStatus =
        AWSServiceAccessStatusMapper::GetAWSServiceAccessStatusForName(jsonValue.GetString("AWSServiceAccessStatus"));
