...
class BackintConfig {
 public:
  ...
  inline void SetBackintMode(BackintMode value) {
    m_backintModeHasBeenSet = true;
    m_backintMode = value;
  }
  inline BackintConfig& WithBackintMode(BackintMode value) {
    SetBackintMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnsureNoBackupInProcess(bool value) {
    m_ensureNoBackupInProcessHasBeenSet = true;
    m_ensureNoBackupInProcess = value;
  }
  inline BackintConfig& WithEnsureNoBackupInProcess(bool value) {
    SetEnsureNoBackupInProcess(value);
    return *this;
  }
  ///@}
 private:
