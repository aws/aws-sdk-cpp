...
class OperationEvent {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  OperationEvent& WithDescription(DescriptionT&& value) {
  ...
  template <typename ResourceT = Resource>
  OperationEvent& WithResource(ResourceT&& value) {
  ...
  inline void SetStatus(OperationEventStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline OperationEvent& WithStatus(OperationEventStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  OperationEvent& WithStatusMessage(StatusMessageT&& value) {
