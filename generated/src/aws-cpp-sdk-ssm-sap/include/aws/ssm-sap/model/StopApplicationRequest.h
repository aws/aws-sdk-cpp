...
class StopApplicationRequest : public SsmSapRequest {
 public:
  ...
  inline void SetStopConnectedEntity(ConnectedEntityType value) {
    m_stopConnectedEntityHasBeenSet = true;
    m_stopConnectedEntity = value;
  }
  inline StopApplicationRequest& WithStopConnectedEntity(ConnectedEntityType value) {
    SetStopConnectedEntity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeEc2InstanceShutdown(bool value) {
    m_includeEc2InstanceShutdownHasBeenSet = true;
    m_includeEc2InstanceShutdown = value;
  }
  inline StopApplicationRequest& WithIncludeEc2InstanceShutdown(bool value) {
    SetIncludeEc2InstanceShutdown(value);
    return *this;
  }
  ///@}
 private:
