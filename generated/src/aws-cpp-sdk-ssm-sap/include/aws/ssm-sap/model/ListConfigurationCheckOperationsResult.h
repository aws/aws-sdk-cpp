...
class ListConfigurationCheckOperationsResult {
 public:
  ...
  template <typename ConfigurationCheckOperationsT = Aws::Vector<ConfigurationCheckOperation>>
  ListConfigurationCheckOperationsResult& WithConfigurationCheckOperations(ConfigurationCheckOperationsT&& value) {
  ...
  ListConfigurationCheckOperationsResult& AddConfigurationCheckOperations(ConfigurationCheckOperationsT&& value) {
    m_configurationCheckOperationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationCheckOperationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConfigurationCheckOperationsResult& WithRequestId(RequestIdT&& value) {
