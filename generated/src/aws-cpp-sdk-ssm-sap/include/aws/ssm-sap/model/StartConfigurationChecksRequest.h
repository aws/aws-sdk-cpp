...
class StartConfigurationChecksRequest : public SsmSapRequest {
 public:
  ...
  void SetConfigurationCheckIds(ConfigurationCheckIdsT&& value) {
    m_configurationCheckIdsHasBeenSet = true;
    m_configurationCheckIds = std::forward<ConfigurationCheckIdsT>(value);
  }
  template <typename ConfigurationCheckIdsT = Aws::Vector<ConfigurationCheckType>>
  StartConfigurationChecksRequest& WithConfigurationCheckIds(ConfigurationCheckIdsT&& value) {
    SetConfigurationCheckIds(std::forward<ConfigurationCheckIdsT>(value));
    return *this;
  }
  inline StartConfigurationChecksRequest& AddConfigurationCheckIds(ConfigurationCheckType value) {
    m_configurationCheckIdsHasBeenSet = true;
    m_configurationCheckIds.push_back(value);
    return *this;
  }
  ///@}
 private:
