...
class StartApplicationResult {
 public:
  AWS_SSMSAP_API StartApplicationResult() = default;
  AWS_SSMSAP_API StartApplicationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename OperationIdT = Aws::String>
  StartApplicationResult& WithOperationId(OperationIdT&& value) {
