...
class ListConfigurationCheckDefinitionsResult {
 public:
  ...
  void SetConfigurationChecks(ConfigurationChecksT&& value) {
    m_configurationChecksHasBeenSet = true;
    m_configurationChecks = std::forward<ConfigurationChecksT>(value);
  }
  template <typename ConfigurationChecksT = Aws::Vector<ConfigurationCheckDefinition>>
  ListConfigurationCheckDefinitionsResult& WithConfigurationChecks(ConfigurationChecksT&& value) {
    SetConfigurationChecks(std::forward<ConfigurationChecksT>(value));
    return *this;
  }
  template <typename ConfigurationChecksT = ConfigurationCheckDefinition>
  ListConfigurationCheckDefinitionsResult& AddConfigurationChecks(ConfigurationChecksT&& value) {
    m_configurationChecksHasBeenSet = true;
    m_configurationChecks.emplace_back(std::forward<ConfigurationChecksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationCheckDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConfigurationCheckDefinitionsResult& WithRequestId(RequestIdT&& value) {
