...
class ConfigurationCheckDefinition {
 public:
  ...
  inline void SetId(ConfigurationCheckType value) {
    m_idHasBeenSet = true;
    m_id = value;
  }
  inline ConfigurationCheckDefinition& WithId(ConfigurationCheckType value) {
    SetId(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  ConfigurationCheckDefinition& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ConfigurationCheckDefinition& WithDescription(DescriptionT&& value) {
  ...
  void SetApplicableApplicationTypes(ApplicableApplicationTypesT&& value) {
    m_applicableApplicationTypesHasBeenSet = true;
    m_applicableApplicationTypes = std::forward<ApplicableApplicationTypesT>(value);
  }
  template <typename ApplicableApplicationTypesT = Aws::Vector<ApplicationType>>
  ConfigurationCheckDefinition& WithApplicableApplicationTypes(ApplicableApplicationTypesT&& value) {
    SetApplicableApplicationTypes(std::forward<ApplicableApplicationTypesT>(value));
    return *this;
  }
  inline ConfigurationCheckDefinition& AddApplicableApplicationTypes(ApplicationType value) {
    m_applicableApplicationTypesHasBeenSet = true;
    m_applicableApplicationTypes.push_back(value);
    return *this;
  }
  ///@}
 private:
