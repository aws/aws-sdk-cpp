...
class ListSubCheckRuleResultsRequest : public SsmSapRequest {
 public:
  ...
  void SetSubCheckResultId(SubCheckResultIdT&& value) {
    m_subCheckResultIdHasBeenSet = true;
    m_subCheckResultId = std::forward<SubCheckResultIdT>(value);
  }
  template <typename SubCheckResultIdT = Aws::String>
  ListSubCheckRuleResultsRequest& WithSubCheckResultId(SubCheckResultIdT&& value) {
    SetSubCheckResultId(std::forward<SubCheckResultIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListSubCheckRuleResultsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSubCheckRuleResultsRequest& WithNextToken(NextTokenT&& value) {
