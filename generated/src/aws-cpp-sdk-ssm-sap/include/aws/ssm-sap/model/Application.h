...
class Application {
 public:
  ...
  inline Application& WithDiscoveryStatus(ApplicationDiscoveryStatus value) {
  ...
  void SetAssociatedApplicationArns(AssociatedApplicationArnsT&& value) {
    ...
    m_associatedApplicationArns = std::forward<AssociatedApplicationArnsT>(value);
  }
  template <typename AssociatedApplicationArnsT = Aws::Vector<Aws::String>>
  Application& WithAssociatedApplicationArns(AssociatedApplicationArnsT&& value) {
    SetAssociatedApplicationArns(std::forward<AssociatedApplicationArnsT>(value));
    return *this;
  }
  ...
  Application& AddAssociatedApplicationArns(AssociatedApplicationArnsT&& value) {
    m_associatedApplicationArnsHasBeenSet = true;
    m_associatedApplicationArns.emplace_back(std::forward<AssociatedApplicationArnsT>(value));
    return *this;
  }
  ///@}
 private:
