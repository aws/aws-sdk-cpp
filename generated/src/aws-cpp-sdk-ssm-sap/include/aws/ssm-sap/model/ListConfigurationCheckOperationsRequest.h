...
class ListConfigurationCheckOperationsRequest : public SsmSapRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  ListConfigurationCheckOperationsRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline void SetListMode(ConfigurationCheckOperationListingMode value) {
    m_listModeHasBeenSet = true;
    m_listMode = value;
  }
  inline ListConfigurationCheckOperationsRequest& WithListMode(ConfigurationCheckOperationListingMode value) {
    SetListMode(value);
    return *this;
  }
  ///@}
  ...
  inline ListConfigurationCheckOperationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationCheckOperationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListConfigurationCheckOperationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListConfigurationCheckOperationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
