...
class StartConfigurationChecksResult {
 public:
  ...
  void SetConfigurationCheckOperations(ConfigurationCheckOperationsT&& value) {
    ...
    m_configurationCheckOperations = std::forward<ConfigurationCheckOperationsT>(value);
  }
  template <typename ConfigurationCheckOperationsT = Aws::Vector<ConfigurationCheckOperation>>
  StartConfigurationChecksResult& WithConfigurationCheckOperations(ConfigurationCheckOperationsT&& value) {
    SetConfigurationCheckOperations(std::forward<ConfigurationCheckOperationsT>(value));
    return *this;
  }
  ...
  StartConfigurationChecksResult& AddConfigurationCheckOperations(ConfigurationCheckOperationsT&& value) {
    m_configurationCheckOperationsHasBeenSet = true;
    m_configurationCheckOperations.emplace_back(std::forward<ConfigurationCheckOperationsT>(value));
    return *this;
  }
  ///@}
