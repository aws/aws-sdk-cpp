...
class ListSubCheckResultsResult {
 public:
  ...
  void SetSubCheckResults(SubCheckResultsT&& value) {
    m_subCheckResultsHasBeenSet = true;
    m_subCheckResults = std::forward<SubCheckResultsT>(value);
  }
  template <typename SubCheckResultsT = Aws::Vector<SubCheckResult>>
  ListSubCheckResultsResult& WithSubCheckResults(SubCheckResultsT&& value) {
    SetSubCheckResults(std::forward<SubCheckResultsT>(value));
    return *this;
  }
  template <typename SubCheckResultsT = SubCheckResult>
  ListSubCheckResultsResult& AddSubCheckResults(SubCheckResultsT&& value) {
    m_subCheckResultsHasBeenSet = true;
    m_subCheckResults.emplace_back(std::forward<SubCheckResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSubCheckResultsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSubCheckResultsResult& WithRequestId(RequestIdT&& value) {
