...
class ConfigurationCheckOperation {
 public:
  ...
  inline ConfigurationCheckOperation& WithStatus(OperationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConfigurationCheckId(ConfigurationCheckType value) {
    m_configurationCheckIdHasBeenSet = true;
    m_configurationCheckId = value;
  }
  inline ConfigurationCheckOperation& WithConfigurationCheckId(ConfigurationCheckType value) {
    SetConfigurationCheckId(value);
    return *this;
  }
  ///@}
  ...
  void SetConfigurationCheckName(ConfigurationCheckNameT&& value) {
    ...
    m_configurationCheckName = std::forward<ConfigurationCheckNameT>(value);
  }
  template <typename ConfigurationCheckNameT = Aws::String>
  ConfigurationCheckOperation& WithConfigurationCheckName(ConfigurationCheckNameT&& value) {
    SetConfigurationCheckName(std::forward<ConfigurationCheckNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfigurationCheckDescription(ConfigurationCheckDescriptionT&& value) {
    ...
    m_configurationCheckDescription = std::forward<ConfigurationCheckDescriptionT>(value);
  }
  template <typename ConfigurationCheckDescriptionT = Aws::String>
  ConfigurationCheckOperation& WithConfigurationCheckDescription(ConfigurationCheckDescriptionT&& value) {
    SetConfigurationCheckDescription(std::forward<ConfigurationCheckDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRuleStatusCounts(RuleStatusCountsT&& value) {
    ...
    m_ruleStatusCounts = std::forward<RuleStatusCountsT>(value);
  }
  template <typename RuleStatusCountsT = RuleStatusCounts>
  ConfigurationCheckOperation& WithRuleStatusCounts(RuleStatusCountsT&& value) {
    SetRuleStatusCounts(std::forward<RuleStatusCountsT>(value));
    return *this;
  }
  ///@}
 private:
