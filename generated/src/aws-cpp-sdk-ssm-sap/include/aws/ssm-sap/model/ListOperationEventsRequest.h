...
class ListOperationEventsRequest : public SsmSapRequest {
 public:
  ...
  template <typename OperationIdT = Aws::String>
  ListOperationEventsRequest& WithOperationId(OperationIdT&& value) {
  ...
  inline ListOperationEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOperationEventsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListOperationEventsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListOperationEventsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
