...
class StartApplicationRefreshResult {
 public:
  AWS_SSMSAP_API StartApplicationRefreshResult() = default;
  ...
  template <typename OperationIdT = Aws::String>
  StartApplicationRefreshResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartApplicationRefreshResult& WithRequestId(RequestIdT&& value) {
