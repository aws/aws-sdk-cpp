...
class AssociatedHost {
 public:
  ...
  template <typename HostnameT = Aws::String>
  AssociatedHost& WithHostname(HostnameT&& value) {
  ...
  template <typename Ec2InstanceIdT = Aws::String>
  AssociatedHost& WithEc2InstanceId(Ec2InstanceIdT&& value) {
  ...
  template <typename IpAddressesT = Aws::Vector<IpAddressMember>>
  AssociatedHost& WithIpAddresses(IpAddressesT&& value) {
    SetIpAddresses(std::forward<IpAddressesT>(value));
    return *this;
  }
  template <typename IpAddressesT = IpAddressMember>
  AssociatedHost& AddIpAddresses(IpAddressesT&& value) {
    m_ipAddressesHasBeenSet = true;
  ...
  template <typename OsVersionT = Aws::String>
  AssociatedHost& WithOsVersion(OsVersionT&& value) {
