...
class DatabaseConnection {
 public:
  ...
  inline void SetDatabaseConnectionMethod(DatabaseConnectionMethod value) {
    m_databaseConnectionMethodHasBeenSet = true;
    m_databaseConnectionMethod = value;
  }
  inline DatabaseConnection& WithDatabaseConnectionMethod(DatabaseConnectionMethod value) {
    SetDatabaseConnectionMethod(value);
    return *this;
  }
  ///@}
  ...
  void SetConnectionIp(ConnectionIpT&& value) {
    ...
    m_connectionIp = std::forward<ConnectionIpT>(value);
  }
  template <typename ConnectionIpT = Aws::String>
  DatabaseConnection& WithConnectionIp(ConnectionIpT&& value) {
    SetConnectionIp(std::forward<ConnectionIpT>(value));
    return *this;
  }
  ///@}
 private:
