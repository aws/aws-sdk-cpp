...
namespace SsmSap
{
const size_t SsmSapEndpointRules::RulesBlobStrLen = 3522;
const size_t SsmSapEndpointRules::RulesBlobSize = 3523;
...
'-','s','a','p','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
't','p','s',':','/','/','s','s','m','-','s','a','p','-','f','i','p','s','.','{','R','e','g','i','o',
