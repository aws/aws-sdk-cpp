...
namespace ChimeSDKMeetings
{
   ...
   */
  class AWS_CHIMESDKMEETINGS_API ChimeSDKMeetingsClient : Aws::Client::ClientWithAsyncTemplateMethods<ChimeSDKMeetingsClient>,
    smithy::client::AwsSmithyClientT<Aws::ChimeSDKMeetings::SERVICE_NAME,
