...
#include <aws/chime-sdk-meetings/ChimeSDKMeetingsWaiter.h>
...
class AWS_CHIMESDKMEETINGS_API ChimeSDKMeetingsClient : public Aws::Client::AWSJsonClient,
                                                        ...
                                                        public ChimeSDKMeetingsWaiter<ChimeSDKMeetingsClient> {
 public:
  ...
  ChimeSDKMeetingsClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<ChimeSDKMeetingsEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::ChimeSDKMeetings::ChimeSDKMeetingsClientConfiguration& clientConfiguration =
                             Aws::ChimeSDKMeetings::ChimeSDKMeetingsClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  ChimeSDKMeetingsClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for BatchCreateAttendee that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchCreateAttendee that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchCreateAttendeeRequestT = Model::BatchCreateAttendeeRequest>
  void BatchCreateAttendeeAsync(const BatchCreateAttendeeRequestT& request, const BatchCreateAttendeeResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateAttendeeCapabilitiesExceptOutcome BatchUpdateAttendeeCapabilitiesExcept(
      const Model::BatchUpdateAttendeeCapabilitiesExceptRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateAttendeeCapabilitiesExcept that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchUpdateAttendeeCapabilitiesExceptRequestT = Model::BatchUpdateAttendeeCapabilitiesExceptRequest>
  Model::BatchUpdateAttendeeCapabilitiesExceptOutcomeCallable BatchUpdateAttendeeCapabilitiesExceptCallable(
      const BatchUpdateAttendeeCapabilitiesExceptRequestT& request) const {
    return SubmitCallable(&ChimeSDKMeetingsClient::BatchUpdateAttendeeCapabilitiesExcept, request);
  }

  /**
   * An Async wrapper for BatchUpdateAttendeeCapabilitiesExcept that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchUpdateAttendeeCapabilitiesExceptRequestT = Model::BatchUpdateAttendeeCapabilitiesExceptRequest>
  void BatchUpdateAttendeeCapabilitiesExceptAsync(const BatchUpdateAttendeeCapabilitiesExceptRequestT& request,
                                                  const BatchUpdateAttendeeCapabilitiesExceptResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAttendee that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAttendeeRequestT = Model::CreateAttendeeRequest>
  void CreateAttendeeAsync(const CreateAttendeeRequestT& request, const CreateAttendeeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateMeeting that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateMeetingRequestT = Model::CreateMeetingRequest>
  void CreateMeetingAsync(const CreateMeetingRequestT& request, const CreateMeetingResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateMeetingWithAttendeesOutcome CreateMeetingWithAttendees(
      const Model::CreateMeetingWithAttendeesRequest& request) const;

  /**
   * A Callable wrapper for CreateMeetingWithAttendees that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateMeetingWithAttendeesRequestT = Model::CreateMeetingWithAttendeesRequest>
  Model::CreateMeetingWithAttendeesOutcomeCallable CreateMeetingWithAttendeesCallable(
      const CreateMeetingWithAttendeesRequestT& request) const {
    return SubmitCallable(&ChimeSDKMeetingsClient::CreateMeetingWithAttendees, request);
  }

  /**
   * An Async wrapper for CreateMeetingWithAttendees that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMeetingWithAttendeesRequestT = Model::CreateMeetingWithAttendeesRequest>
  void CreateMeetingWithAttendeesAsync(const CreateMeetingWithAttendeesRequestT& request,
                                       const CreateMeetingWithAttendeesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAttendee that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAttendeeRequestT = Model::DeleteAttendeeRequest>
  void DeleteAttendeeAsync(const DeleteAttendeeRequestT& request, const DeleteAttendeeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteMeeting that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteMeetingRequestT = Model::DeleteMeetingRequest>
  void DeleteMeetingAsync(const DeleteMeetingRequestT& request, const DeleteMeetingResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAttendee that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAttendeeRequestT = Model::GetAttendeeRequest>
  void GetAttendeeAsync(const GetAttendeeRequestT& request, const GetAttendeeResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMeeting that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMeetingRequestT = Model::GetMeetingRequest>
  void GetMeetingAsync(const GetMeetingRequestT& request, const GetMeetingResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAttendees that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAttendeesRequestT = Model::ListAttendeesRequest>
  void ListAttendeesAsync(const ListAttendeesRequestT& request, const ListAttendeesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMeetingTranscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartMeetingTranscriptionRequestT = Model::StartMeetingTranscriptionRequest>
  Model::StartMeetingTranscriptionOutcomeCallable StartMeetingTranscriptionCallable(
      const StartMeetingTranscriptionRequestT& request) const {
    return SubmitCallable(&ChimeSDKMeetingsClient::StartMeetingTranscription, request);
  }

  /**
   * An Async wrapper for StartMeetingTranscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMeetingTranscriptionRequestT = Model::StartMeetingTranscriptionRequest>
  void StartMeetingTranscriptionAsync(const StartMeetingTranscriptionRequestT& request,
  ...
  /**
   * A Callable wrapper for StopMeetingTranscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopMeetingTranscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopMeetingTranscriptionRequestT = Model::StopMeetingTranscriptionRequest>
  void StopMeetingTranscriptionAsync(const StopMeetingTranscriptionRequestT& request,
                                     const StopMeetingTranscriptionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAttendeeCapabilitiesOutcome UpdateAttendeeCapabilities(
      const Model::UpdateAttendeeCapabilitiesRequest& request) const;

  /**
   * A Callable wrapper for UpdateAttendeeCapabilities that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAttendeeCapabilitiesRequestT = Model::UpdateAttendeeCapabilitiesRequest>
  Model::UpdateAttendeeCapabilitiesOutcomeCallable UpdateAttendeeCapabilitiesCallable(
      const UpdateAttendeeCapabilitiesRequestT& request) const {
    return SubmitCallable(&ChimeSDKMeetingsClient::UpdateAttendeeCapabilities, request);
  }

  /**
   * An Async wrapper for UpdateAttendeeCapabilities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAttendeeCapabilitiesRequestT = Model::UpdateAttendeeCapabilitiesRequest>
  void UpdateAttendeeCapabilitiesAsync(const UpdateAttendeeCapabilitiesRequestT& request,
                                       const UpdateAttendeeCapabilitiesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
