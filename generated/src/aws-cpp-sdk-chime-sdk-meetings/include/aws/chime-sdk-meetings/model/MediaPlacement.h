...
class MediaPlacement {
 public:
  ...
  void SetScreenDataUrl(ScreenDataUrlT&& value) {
    m_screenDataUrlHasBeenSet = true;
    m_screenDataUrl = std::forward<ScreenDataUrlT>(value);
  }
  template <typename ScreenDataUrlT = Aws::String>
  MediaPlacement& WithScreenDataUrl(ScreenDataUrlT&& value) {
    SetScreenDataUrl(std::forward<ScreenDataUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScreenViewingUrl(ScreenViewingUrlT&& value) {
    m_screenViewingUrlHasBeenSet = true;
    m_screenViewingUrl = std::forward<ScreenViewingUrlT>(value);
  }
  template <typename ScreenViewingUrlT = Aws::String>
  MediaPlacement& WithScreenViewingUrl(ScreenViewingUrlT&& value) {
    SetScreenViewingUrl(std::forward<ScreenViewingUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScreenSharingUrl(ScreenSharingUrlT&& value) {
    m_screenSharingUrlHasBeenSet = true;
    m_screenSharingUrl = std::forward<ScreenSharingUrlT>(value);
  }
  template <typename ScreenSharingUrlT = Aws::String>
  MediaPlacement& WithScreenSharingUrl(ScreenSharingUrlT&& value) {
    SetScreenSharingUrl(std::forward<ScreenSharingUrlT>(value));
    return *this;
  }
  ///@}
