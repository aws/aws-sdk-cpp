...
class UpdateAttendeeCapabilitiesResult {
 public:
  ...
  AWS_CHIMESDKMEETINGS_API UpdateAttendeeCapabilitiesResult& operator=(
  ...
  template <typename AttendeeT = Attendee>
  UpdateAttendeeCapabilitiesResult& WithAttendee(AttendeeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAttendeeCapabilitiesResult& WithRequestId(RequestIdT&& value) {
