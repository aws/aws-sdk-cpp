...
class MeetingFeaturesConfiguration {
 public:
  ...
  template <typename AudioT = AudioFeatures>
  MeetingFeaturesConfiguration& WithAudio(AudioT&& value) {
  ...
  template <typename VideoT = VideoFeatures>
  MeetingFeaturesConfiguration& WithVideo(VideoT&& value) {
  ...
  template <typename ContentT = ContentFeatures>
  MeetingFeaturesConfiguration& WithContent(ContentT&& value) {
  ...
  template <typename AttendeeT = AttendeeFeatures>
  MeetingFeaturesConfiguration& WithAttendee(AttendeeT&& value) {
