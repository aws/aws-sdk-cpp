...
class BatchCreateAttendeeResult {
 public:
  ...
  template <typename AttendeesT = Aws::Vector<Attendee>>
  BatchCreateAttendeeResult& WithAttendees(AttendeesT&& value) {
    SetAttendees(std::forward<AttendeesT>(value));
    return *this;
  }
  template <typename AttendeesT = Attendee>
  BatchCreateAttendeeResult& AddAttendees(AttendeesT&& value) {
    m_attendeesHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<CreateAttendeeError>>
  BatchCreateAttendeeResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = CreateAttendeeError>
  BatchCreateAttendeeResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchCreateAttendeeResult& WithRequestId(RequestIdT&& value) {
