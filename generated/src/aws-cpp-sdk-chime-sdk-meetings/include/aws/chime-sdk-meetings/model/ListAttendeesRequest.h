...
class ListAttendeesRequest : public ChimeSDKMeetingsRequest {
 public:
  ...
  template <typename MeetingIdT = Aws::String>
  ListAttendeesRequest& WithMeetingId(MeetingIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAttendeesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAttendeesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
