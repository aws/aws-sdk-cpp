...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMEETINGS_API ServiceFailureException() = default;
    ...
    template<typename CodeT = Aws::String>
    ServiceFailureException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    ServiceFailureException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ServiceFailureException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
