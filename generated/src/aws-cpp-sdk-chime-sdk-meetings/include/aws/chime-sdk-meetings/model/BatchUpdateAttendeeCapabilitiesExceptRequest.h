...
class BatchUpdateAttendeeCapabilitiesExceptRequest : public ChimeSDKMeetingsRequest {
 public:
  ...
  template <typename MeetingIdT = Aws::String>
  BatchUpdateAttendeeCapabilitiesExceptRequest& WithMeetingId(MeetingIdT&& value) {
  ...
  void SetExcludedAttendeeIds(ExcludedAttendeeIdsT&& value) {
    m_excludedAttendeeIdsHasBeenSet = true;
    m_excludedAttendeeIds = std::forward<ExcludedAttendeeIdsT>(value);
  }
  template <typename ExcludedAttendeeIdsT = Aws::Vector<AttendeeIdItem>>
  BatchUpdateAttendeeCapabilitiesExceptRequest& WithExcludedAttendeeIds(ExcludedAttendeeIdsT&& value) {
    SetExcludedAttendeeIds(std::forward<ExcludedAttendeeIdsT>(value));
    return *this;
  }
  template <typename ExcludedAttendeeIdsT = AttendeeIdItem>
  BatchUpdateAttendeeCapabilitiesExceptRequest& AddExcludedAttendeeIds(ExcludedAttendeeIdsT&& value) {
    m_excludedAttendeeIdsHasBeenSet = true;
    m_excludedAttendeeIds.emplace_back(std::forward<ExcludedAttendeeIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CapabilitiesT = AttendeeCapabilities>
  BatchUpdateAttendeeCapabilitiesExceptRequest& WithCapabilities(CapabilitiesT&& value) {
