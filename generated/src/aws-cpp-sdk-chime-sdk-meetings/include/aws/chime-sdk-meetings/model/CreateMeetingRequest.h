...
class CreateMeetingRequest : public ChimeSDKMeetingsRequest {
 public:
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateMeetingRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename MediaRegionT = Aws::String>
  CreateMeetingRequest& WithMediaRegion(MediaRegionT&& value) {
  ...
  template <typename MeetingHostIdT = Aws::String>
  CreateMeetingRequest& WithMeetingHostId(MeetingHostIdT&& value) {
  ...
  template <typename ExternalMeetingIdT = Aws::String>
  CreateMeetingRequest& WithExternalMeetingId(ExternalMeetingIdT&& value) {
  ...
  template <typename NotificationsConfigurationT = NotificationsConfiguration>
  CreateMeetingRequest& WithNotificationsConfiguration(NotificationsConfigurationT&& value) {
  ...
  template <typename MeetingFeaturesT = MeetingFeaturesConfiguration>
  CreateMeetingRequest& WithMeetingFeatures(MeetingFeaturesT&& value) {
  ...
  template <typename PrimaryMeetingIdT = Aws::String>
  CreateMeetingRequest& WithPrimaryMeetingId(PrimaryMeetingIdT&& value) {
  ...
  template <typename TenantIdsT = Aws::Vector<Aws::String>>
  CreateMeetingRequest& WithTenantIds(TenantIdsT&& value) {
    SetTenantIds(std::forward<TenantIdsT>(value));
    return *this;
  }
  template <typename TenantIdsT = Aws::String>
  CreateMeetingRequest& AddTenantIds(TenantIdsT&& value) {
    m_tenantIdsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateMeetingRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateMeetingRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline CreateMeetingRequest& WithMediaPlacementNetworkType(MediaPlacementNetworkType value) {
