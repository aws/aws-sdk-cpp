...
class UpdateAttendeeCapabilitiesRequest : public ChimeSDKMeetingsRequest {
 public:
  ...
  template <typename MeetingIdT = Aws::String>
  UpdateAttendeeCapabilitiesRequest& WithMeetingId(MeetingIdT&& value) {
  ...
  template <typename AttendeeIdT = Aws::String>
  UpdateAttendeeCapabilitiesRequest& WithAttendeeId(AttendeeIdT&& value) {
  ...
  template <typename CapabilitiesT = AttendeeCapabilities>
  UpdateAttendeeCapabilitiesRequest& WithCapabilities(CapabilitiesT&& value) {
