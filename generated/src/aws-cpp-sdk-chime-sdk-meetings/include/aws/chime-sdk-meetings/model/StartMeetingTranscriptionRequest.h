...
class StartMeetingTranscriptionRequest : public ChimeSDKMeetingsRequest {
 public:
  ...
  template <typename MeetingIdT = Aws::String>
  StartMeetingTranscriptionRequest& WithMeetingId(MeetingIdT&& value) {
  ...
  void SetTranscriptionConfiguration(TranscriptionConfigurationT&& value) {
    m_transcriptionConfigurationHasBeenSet = true;
    m_transcriptionConfiguration = std::forward<TranscriptionConfigurationT>(value);
  }
  template <typename TranscriptionConfigurationT = TranscriptionConfiguration>
  StartMeetingTranscriptionRequest& WithTranscriptionConfiguration(TranscriptionConfigurationT&& value) {
    SetTranscriptionConfiguration(std::forward<TranscriptionConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
