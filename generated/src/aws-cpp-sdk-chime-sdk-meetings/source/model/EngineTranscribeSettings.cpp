...
EngineTranscribeSettings::EngineTranscribeSettings(JsonView jsonValue) { *this = jsonValue; }
...
EngineTranscribeSettings& EngineTranscribeSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("VocabularyFilterMethod")) {
    m_vocabularyFilterMethod =
        TranscribeVocabularyFilterMethodMapper::GetTranscribeVocabularyFilterMethodForName(jsonValue.GetString("VocabularyFilterMethod"));
  ...
  if (jsonValue.ValueExists("PartialResultsStability")) {
    m_partialResultsStability = TranscribePartialResultsStabilityMapper::GetTranscribePartialResultsStabilityForName(
        jsonValue.GetString("PartialResultsStability"));
    m_partialResultsStabilityHasBeenSet = true;
  }
  if (jsonValue.ValueExists("ContentIdentificationType")) {
    m_contentIdentificationType = TranscribeContentIdentificationTypeMapper::GetTranscribeContentIdentificationTypeForName(
  ...
  if (jsonValue.ValueExists("ContentRedactionType")) {
    m_contentRedactionType =
        TranscribeContentRedactionTypeMapper::GetTranscribeContentRedactionTypeForName(jsonValue.GetString("ContentRedactionType"));
...
JsonValue EngineTranscribeSettings::Jsonize() const {
  ...
  if (m_vocabularyFilterMethodHasBeenSet) {
    payload.WithString("VocabularyFilterMethod",
                       TranscribeVocabularyFilterMethodMapper::GetNameForTranscribeVocabularyFilterMethod(m_vocabularyFilterMethod));
  }
  ...
  if (m_partialResultsStabilityHasBeenSet) {
    payload.WithString("PartialResultsStability",
                       TranscribePartialResultsStabilityMapper::GetNameForTranscribePartialResultsStability(m_partialResultsStability));
  }

  if (m_contentIdentificationTypeHasBeenSet) {
    payload.WithString(
        "ContentIdentificationType",
        TranscribeContentIdentificationTypeMapper::GetNameForTranscribeContentIdentificationType(m_contentIdentificationType));
  }

  if (m_contentRedactionTypeHasBeenSet) {
    payload.WithString("ContentRedactionType",
                       TranscribeContentRedactionTypeMapper::GetNameForTranscribeContentRedactionType(m_contentRedactionType));
  }
