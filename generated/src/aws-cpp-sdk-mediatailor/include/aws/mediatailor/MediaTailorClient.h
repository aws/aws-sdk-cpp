...
namespace MediaTailor
{
   ...
   */
  class AWS_MEDIATAILOR_API MediaTailorClient : smithy::client::AwsSmithyClientT<Aws::MediaTailor::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<MediaTailorClient>
  {
    public:
