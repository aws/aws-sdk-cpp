...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIATAILOR_API DeleteVodSourceRequest() = default;
    ...
    template<typename SourceLocationNameT = Aws::String>
    DeleteVodSourceRequest& WithSourceLocationName(SourceLocationNameT&& value) { SetSourceLocationName(std::forward<SourceLocationNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VodSourceNameT = Aws::String>
    DeleteVodSourceRequest& WithVodSourceName(VodSourceNameT&& value) { SetVodSourceName(std::forward<VodSourceNameT>(value)); return *this;}
    ///@}
  private:
