...
class ListPrefetchSchedulesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<PrefetchSchedule>>
  ListPrefetchSchedulesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = PrefetchSchedule>
  ListPrefetchSchedulesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPrefetchSchedulesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPrefetchSchedulesResult& WithRequestId(RequestIdT&& value) {
