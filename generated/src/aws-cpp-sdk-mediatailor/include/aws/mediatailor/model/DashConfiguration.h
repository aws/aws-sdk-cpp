...
class DashConfiguration {
 public:
  ...
  ///@{
  /**
   * <p>The URL that MediaTailor generates to initiate a playback session. The
   * session uses server-side reporting.</p>
   */
   ...
   * playback session. The session uses server-side reporting.</p>
   */
  ...
  template <typename DualStackManifestEndpointPrefixT = Aws::String>
  DashConfiguration& WithDualStackManifestEndpointPrefix(DualStackManifestEndpointPrefixT&& value) {
  ...
  inline DashConfiguration& WithOriginManifestType(OriginManifestType value) {
