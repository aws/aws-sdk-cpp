...
class AdsInteractionLog {
 public:
  ...
  inline AdsInteractionLog& AddPublishOptInEventTypes(AdsInteractionPublishOptInEventType value) {
    m_publishOptInEventTypesHasBeenSet = true;
  ...
  inline AdsInteractionLog& AddExcludeEventTypes(AdsInteractionExcludeEventType value) {
    m_excludeEventTypesHasBeenSet = true;
