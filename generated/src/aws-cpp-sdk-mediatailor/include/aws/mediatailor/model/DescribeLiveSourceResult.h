...
class DescribeLiveSourceResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DescribeLiveSourceResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  DescribeLiveSourceResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename HttpPackageConfigurationsT = Aws::Vector<HttpPackageConfiguration>>
  DescribeLiveSourceResult& WithHttpPackageConfigurations(HttpPackageConfigurationsT&& value) {
  ...
  DescribeLiveSourceResult& AddHttpPackageConfigurations(HttpPackageConfigurationsT&& value) {
    m_httpPackageConfigurationsHasBeenSet = true;
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  DescribeLiveSourceResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename LiveSourceNameT = Aws::String>
  DescribeLiveSourceResult& WithLiveSourceName(LiveSourceNameT&& value) {
  ...
  template <typename SourceLocationNameT = Aws::String>
  DescribeLiveSourceResult& WithSourceLocationName(SourceLocationNameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DescribeLiveSourceResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeLiveSourceResult& WithRequestId(RequestIdT&& value) {
