...
class Function {
 public:
  ...
  template <typename AwsServiceRequestConfigurationT = AwsServiceRequestConfiguration>
  Function& WithAwsServiceRequestConfiguration(AwsServiceRequestConfigurationT&& value) {
  ...
  template <typename ConcurrentExecutorConfigurationT = ConcurrentExecutorConfiguration>
  Function& WithConcurrentExecutorConfiguration(ConcurrentExecutorConfigurationT&& value) {
