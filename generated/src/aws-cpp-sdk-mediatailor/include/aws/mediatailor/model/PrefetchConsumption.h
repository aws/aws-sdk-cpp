...
class PrefetchConsumption {
 public:
  ...
  void SetAvailMatchingCriteria(AvailMatchingCriteriaT&& value) {
    ...
    m_availMatchingCriteria = std::forward<AvailMatchingCriteriaT>(value);
  }
  template <typename AvailMatchingCriteriaT = Aws::Vector<AvailMatchingCriteria>>
  PrefetchConsumption& WithAvailMatchingCriteria(AvailMatchingCriteriaT&& value) {
    SetAvailMatchingCriteria(std::forward<AvailMatchingCriteriaT>(value));
    return *this;
  }
  ...
  PrefetchConsumption& AddAvailMatchingCriteria(AvailMatchingCriteriaT&& value) {
    m_availMatchingCriteriaHasBeenSet = true;
    m_availMatchingCriteria.emplace_back(std::forward<AvailMatchingCriteriaT>(value));
    return *this;
  }
  ///@}
