...
class UpdateProgramRequest : public MediaTailorRequest {
 public:
  ...
  template <typename AdBreaksT = Aws::Vector<AdBreak>>
  UpdateProgramRequest& WithAdBreaks(AdBreaksT&& value) {
    SetAdBreaks(std::forward<AdBreaksT>(value));
    return *this;
  }
  template <typename AdBreaksT = AdBreak>
  UpdateProgramRequest& AddAdBreaks(AdBreaksT&& value) {
    m_adBreaksHasBeenSet = true;
  ...
  template <typename ChannelNameT = Aws::String>
  UpdateProgramRequest& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename ProgramNameT = Aws::String>
  UpdateProgramRequest& WithProgramName(ProgramNameT&& value) {
  ...
  template <typename ScheduleConfigurationT = UpdateProgramScheduleConfiguration>
  UpdateProgramRequest& WithScheduleConfiguration(ScheduleConfigurationT&& value) {
  ...
  template <typename AudienceMediaT = Aws::Vector<AudienceMedia>>
  UpdateProgramRequest& WithAudienceMedia(AudienceMediaT&& value) {
    SetAudienceMedia(std::forward<AudienceMediaT>(value));
    return *this;
  }
  template <typename AudienceMediaT = AudienceMedia>
  UpdateProgramRequest& AddAudienceMedia(AudienceMediaT&& value) {
    m_audienceMediaHasBeenSet = true;
