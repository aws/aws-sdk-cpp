...
class UpdateLiveSourceRequest : public MediaTailorRequest {
 public:
  ...
  template <typename HttpPackageConfigurationsT = Aws::Vector<HttpPackageConfiguration>>
  UpdateLiveSourceRequest& WithHttpPackageConfigurations(HttpPackageConfigurationsT&& value) {
  ...
  UpdateLiveSourceRequest& AddHttpPackageConfigurations(HttpPackageConfigurationsT&& value) {
    m_httpPackageConfigurationsHasBeenSet = true;
  ...
  template <typename LiveSourceNameT = Aws::String>
  UpdateLiveSourceRequest& WithLiveSourceName(LiveSourceNameT&& value) {
  ...
  template <typename SourceLocationNameT = Aws::String>
  UpdateLiveSourceRequest& WithSourceLocationName(SourceLocationNameT&& value) {
