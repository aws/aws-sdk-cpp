...
class SpliceInsertMessage {
 public:
  ...
  inline void SetAvailNum(int value) {
    m_availNumHasBeenSet = true;
    m_availNum = value;
  }
  inline SpliceInsertMessage& WithAvailNum(int value) {
    SetAvailNum(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAvailsExpected(int value) {
    m_availsExpectedHasBeenSet = true;
    m_availsExpected = value;
  }
  inline SpliceInsertMessage& WithAvailsExpected(int value) {
    SetAvailsExpected(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpliceEventId(int value) {
    m_spliceEventIdHasBeenSet = true;
    m_spliceEventId = value;
  }
  inline SpliceInsertMessage& WithSpliceEventId(int value) {
  ...
  inline void SetUniqueProgramId(int value) {
    m_uniqueProgramIdHasBeenSet = true;
    m_uniqueProgramId = value;
  }
  inline SpliceInsertMessage& WithUniqueProgramId(int value) {
    SetUniqueProgramId(value);
    return *this;
  }
  ///@}
 private:
