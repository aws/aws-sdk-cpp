...
class CreateLiveSourceRequest : public MediaTailorRequest {
 public:
  ...
  template <typename HttpPackageConfigurationsT = Aws::Vector<HttpPackageConfiguration>>
  CreateLiveSourceRequest& WithHttpPackageConfigurations(HttpPackageConfigurationsT&& value) {
  ...
  CreateLiveSourceRequest& AddHttpPackageConfigurations(HttpPackageConfigurationsT&& value) {
    m_httpPackageConfigurationsHasBeenSet = true;
  ...
  template <typename LiveSourceNameT = Aws::String>
  CreateLiveSourceRequest& WithLiveSourceName(LiveSourceNameT&& value) {
  ...
  template <typename SourceLocationNameT = Aws::String>
  CreateLiveSourceRequest& WithSourceLocationName(SourceLocationNameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateLiveSourceRequest& WithTags(TagsT&& value) {
