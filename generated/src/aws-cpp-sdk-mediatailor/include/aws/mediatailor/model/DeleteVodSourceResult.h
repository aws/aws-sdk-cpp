...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIATAILOR_API DeleteVodSourceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteVodSourceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
