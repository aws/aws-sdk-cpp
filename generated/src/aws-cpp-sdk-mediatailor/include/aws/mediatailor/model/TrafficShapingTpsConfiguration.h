...
namespace Model
{
  ...
  public:
    ...
    inline void SetPeakTps(int value) { m_peakTpsHasBeenSet = true; m_peakTps = value; }
    inline TrafficShapingTpsConfiguration& WithPeakTps(int value) { SetPeakTps(value); return *this;}
    ///@}
    ...
    inline void SetPeakConcurrentUsers(int value) { m_peakConcurrentUsersHasBeenSet = true; m_peakConcurrentUsers = value; }
    inline TrafficShapingTpsConfiguration& WithPeakConcurrentUsers(int value) { SetPeakConcurrentUsers(value); return *this;}
    ///@}
  private:
