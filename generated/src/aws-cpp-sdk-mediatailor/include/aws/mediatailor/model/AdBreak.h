...
class AdBreak {
 public:
  ...
  inline AdBreak& WithMessageType(MessageType value) {
  ...
  inline void SetOffsetMillis(long long value) {
    m_offsetMillisHasBeenSet = true;
    m_offsetMillis = value;
  }
  inline AdBreak& WithOffsetMillis(long long value) {
    SetOffsetMillis(value);
    return *this;
  }
  ///@}
  ...
  void SetSlate(SlateT&& value) {
    ...
    m_slate = std::forward<SlateT>(value);
  }
  template <typename SlateT = SlateSource>
  AdBreak& WithSlate(SlateT&& value) {
    SetSlate(std::forward<SlateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpliceInsertMessage(SpliceInsertMessageT&& value) {
    ...
    m_spliceInsertMessage = std::forward<SpliceInsertMessageT>(value);
  }
  template <typename SpliceInsertMessageT = SpliceInsertMessage>
  AdBreak& WithSpliceInsertMessage(SpliceInsertMessageT&& value) {
    SetSpliceInsertMessage(std::forward<SpliceInsertMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeSignalMessage(TimeSignalMessageT&& value) {
    ...
    m_timeSignalMessage = std::forward<TimeSignalMessageT>(value);
  }
  template <typename TimeSignalMessageT = TimeSignalMessage>
  AdBreak& WithTimeSignalMessage(TimeSignalMessageT&& value) {
    SetTimeSignalMessage(std::forward<TimeSignalMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdBreakMetadata(AdBreakMetadataT&& value) {
    ...
    m_adBreakMetadata = std::forward<AdBreakMetadataT>(value);
  }
  template <typename AdBreakMetadataT = Aws::Vector<KeyValuePair>>
  AdBreak& WithAdBreakMetadata(AdBreakMetadataT&& value) {
    SetAdBreakMetadata(std::forward<AdBreakMetadataT>(value));
    return *this;
  }
  template <typename AdBreakMetadataT = KeyValuePair>
  AdBreak& AddAdBreakMetadata(AdBreakMetadataT&& value) {
    m_adBreakMetadataHasBeenSet = true;
    m_adBreakMetadata.emplace_back(std::forward<AdBreakMetadataT>(value));
    return *this;
  }
  ///@}
 private:
