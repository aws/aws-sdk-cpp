...
class GetPrefetchScheduleResult {
 public:
  ...
  inline GetPrefetchScheduleResult& WithScheduleType(PrefetchScheduleType value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetPrefetchScheduleResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  GetPrefetchScheduleResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
