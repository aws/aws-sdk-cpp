...
class SegmentDeliveryConfiguration {
 public:
  ...
  void SetBaseUrl(BaseUrlT&& value) {
    ...
    m_baseUrl = std::forward<BaseUrlT>(value);
  }
  template <typename BaseUrlT = Aws::String>
  SegmentDeliveryConfiguration& WithBaseUrl(BaseUrlT&& value) {
    SetBaseUrl(std::forward<BaseUrlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  SegmentDeliveryConfiguration& WithName(NameT&& value) {
