...
class Transition {
 public:
  ...
  inline Transition& WithDurationMillis(long long value) {
  ...
  inline void SetRelativePosition(RelativePosition value) {
    m_relativePositionHasBeenSet = true;
    m_relativePosition = value;
  }
  inline Transition& WithRelativePosition(RelativePosition value) {
  ...
  void SetRelativeProgram(RelativeProgramT&& value) {
    ...
    m_relativeProgram = std::forward<RelativeProgramT>(value);
  }
  template <typename RelativeProgramT = Aws::String>
  Transition& WithRelativeProgram(RelativeProgramT&& value) {
    SetRelativeProgram(std::forward<RelativeProgramT>(value));
    return *this;
  }
  ///@}
  ...
  inline Transition& WithScheduledStartTimeMillis(long long value) {
