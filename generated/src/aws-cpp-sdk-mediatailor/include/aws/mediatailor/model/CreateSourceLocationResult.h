...
class CreateSourceLocationResult {
 public:
  ...
  template <typename AccessConfigurationT = AccessConfiguration>
  CreateSourceLocationResult& WithAccessConfiguration(AccessConfigurationT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateSourceLocationResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  CreateSourceLocationResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename DefaultSegmentDeliveryConfigurationT = DefaultSegmentDeliveryConfiguration>
  CreateSourceLocationResult& WithDefaultSegmentDeliveryConfiguration(DefaultSegmentDeliveryConfigurationT&& value) {
  ...
  template <typename HttpConfigurationT = HttpConfiguration>
  CreateSourceLocationResult& WithHttpConfiguration(HttpConfigurationT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  CreateSourceLocationResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename SegmentDeliveryConfigurationsT = Aws::Vector<SegmentDeliveryConfiguration>>
  CreateSourceLocationResult& WithSegmentDeliveryConfigurations(SegmentDeliveryConfigurationsT&& value) {
  ...
  CreateSourceLocationResult& AddSegmentDeliveryConfigurations(SegmentDeliveryConfigurationsT&& value) {
    m_segmentDeliveryConfigurationsHasBeenSet = true;
  ...
  template <typename SourceLocationNameT = Aws::String>
  CreateSourceLocationResult& WithSourceLocationName(SourceLocationNameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateSourceLocationResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateSourceLocationResult& WithRequestId(RequestIdT&& value) {
