...
class AdConditioningConfiguration {
 public:
  ...
  inline void SetStreamingMediaFileConditioning(StreamingMediaFileConditioning value) {
    m_streamingMediaFileConditioningHasBeenSet = true;
    m_streamingMediaFileConditioning = value;
  }
  inline AdConditioningConfiguration& WithStreamingMediaFileConditioning(StreamingMediaFileConditioning value) {
    SetStreamingMediaFileConditioning(value);
    return *this;
  }
  ///@}
 private:
