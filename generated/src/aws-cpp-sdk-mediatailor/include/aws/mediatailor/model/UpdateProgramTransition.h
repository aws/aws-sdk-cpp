...
class UpdateProgramTransition {
 public:
  ...
  inline void SetScheduledStartTimeMillis(long long value) {
    m_scheduledStartTimeMillisHasBeenSet = true;
    m_scheduledStartTimeMillis = value;
  }
  inline UpdateProgramTransition& WithScheduledStartTimeMillis(long long value) {
    SetScheduledStartTimeMillis(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateProgramTransition& WithDurationMillis(long long value) {
