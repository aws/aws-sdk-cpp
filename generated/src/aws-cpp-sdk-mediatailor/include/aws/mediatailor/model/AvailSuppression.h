...
class AvailSuppression {
 public:
  ...
  inline AvailSuppression& WithMode(Mode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  AvailSuppression& WithValue(ValueT&& value) {
  ...
  inline void SetFillPolicy(FillPolicy value) {
    m_fillPolicyHasBeenSet = true;
    m_fillPolicy = value;
  }
  inline AvailSuppression& WithFillPolicy(FillPolicy value) {
    SetFillPolicy(value);
    return *this;
  }
  ///@}
