...
class GetPlaybackConfigurationResult {
 public:
  ...
  template <typename AdDecisionServerUrlT = Aws::String>
  GetPlaybackConfigurationResult& WithAdDecisionServerUrl(AdDecisionServerUrlT&& value) {
  ...
  template <typename AvailSuppressionT = AvailSuppression>
  GetPlaybackConfigurationResult& WithAvailSuppression(AvailSuppressionT&& value) {
  ...
  template <typename BumperT = Bumper>
  GetPlaybackConfigurationResult& WithBumper(BumperT&& value) {
  ...
  template <typename CdnConfigurationT = CdnConfiguration>
  GetPlaybackConfigurationResult& WithCdnConfiguration(CdnConfigurationT&& value) {
  ...
  template <typename ConfigurationAliasesT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
  GetPlaybackConfigurationResult& WithConfigurationAliases(ConfigurationAliasesT&& value) {
  ...
  template <typename DashConfigurationT = DashConfiguration>
  GetPlaybackConfigurationResult& WithDashConfiguration(DashConfigurationT&& value) {
  ...
  template <typename HlsConfigurationT = HlsConfiguration>
  GetPlaybackConfigurationResult& WithHlsConfiguration(HlsConfigurationT&& value) {
  ...
  inline GetPlaybackConfigurationResult& WithInsertionMode(InsertionMode value) {
  ...
  template <typename LivePreRollConfigurationT = LivePreRollConfiguration>
  GetPlaybackConfigurationResult& WithLivePreRollConfiguration(LivePreRollConfigurationT&& value) {
  ...
  template <typename LogConfigurationT = LogConfiguration>
  GetPlaybackConfigurationResult& WithLogConfiguration(LogConfigurationT&& value) {
  ...
  template <typename ManifestProcessingRulesT = ManifestProcessingRules>
  GetPlaybackConfigurationResult& WithManifestProcessingRules(ManifestProcessingRulesT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetPlaybackConfigurationResult& WithName(NameT&& value) {
  ...
  inline GetPlaybackConfigurationResult& WithPersonalizationThresholdSeconds(int value) {
  ...
  template <typename PlaybackConfigurationArnT = Aws::String>
  GetPlaybackConfigurationResult& WithPlaybackConfigurationArn(PlaybackConfigurationArnT&& value) {
   ...
   * MediaTailor. The session uses server-side reporting.</p>
   */
  ...
  template <typename PlaybackEndpointPrefixT = Aws::String>
  GetPlaybackConfigurationResult& WithPlaybackEndpointPrefix(PlaybackEndpointPrefixT&& value) {
  ...
  template <typename DualStackPlaybackEndpointPrefixT = Aws::String>
  GetPlaybackConfigurationResult& WithDualStackPlaybackEndpointPrefix(DualStackPlaybackEndpointPrefixT&& value) {
  ...
  template <typename SessionInitializationEndpointPrefixT = Aws::String>
  GetPlaybackConfigurationResult& WithSessionInitializationEndpointPrefix(SessionInitializationEndpointPrefixT&& value) {
  ...
  template <typename DualStackSessionInitializationEndpointPrefixT = Aws::String>
  GetPlaybackConfigurationResult& WithDualStackSessionInitializationEndpointPrefix(DualStackSessionInitializationEndpointPrefixT&& value) {
  ...
  template <typename SlateAdUrlT = Aws::String>
  GetPlaybackConfigurationResult& WithSlateAdUrl(SlateAdUrlT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetPlaybackConfigurationResult& WithTags(TagsT&& value) {
  ...
  template <typename TranscodeProfileNameT = Aws::String>
  GetPlaybackConfigurationResult& WithTranscodeProfileName(TranscodeProfileNameT&& value) {
  ...
  template <typename VideoContentSourceUrlT = Aws::String>
  GetPlaybackConfigurationResult& WithVideoContentSourceUrl(VideoContentSourceUrlT&& value) {
  ...
  template <typename AdConditioningConfigurationT = AdConditioningConfiguration>
  GetPlaybackConfigurationResult& WithAdConditioningConfiguration(AdConditioningConfigurationT&& value) {
  ...
  template <typename YieldOptimizationConfigurationT = YieldOptimizationConfiguration>
  GetPlaybackConfigurationResult& WithYieldOptimizationConfiguration(YieldOptimizationConfigurationT&& value) {
  ...
  template <typename FunctionMappingT = Aws::Map<EventName, Aws::String>>
  GetPlaybackConfigurationResult& WithFunctionMapping(FunctionMappingT&& value) {
    SetFunctionMapping(std::forward<FunctionMappingT>(value));
    return *this;
  }
  inline GetPlaybackConfigurationResult& AddFunctionMapping(EventName key, Aws::String value) {
    m_functionMappingHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetPlaybackConfigurationResult& WithRequestId(RequestIdT&& value) {
