...
class ListVodSourcesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<VodSource>>
  ListVodSourcesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = VodSource>
  ListVodSourcesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListVodSourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVodSourcesResult& WithRequestId(RequestIdT&& value) {
