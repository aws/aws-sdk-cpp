...
namespace Model
{
  ...
  public:
    ...
    template<typename TrafficShapingTpsConfigurationT = TrafficShapingTpsConfiguration>
    PrefetchRetrieval& WithTrafficShapingTpsConfiguration(TrafficShapingTpsConfigurationT&& value) { SetTrafficShapingTpsConfiguration(std::forward<TrafficShapingTpsConfigurationT>(value)); return *this;}
    ///@}
  private:
