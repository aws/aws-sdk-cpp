...
class PrefetchRetrieval {
 public:
  ...
  inline PrefetchRetrieval& WithTrafficShapingType(TrafficShapingType value) {
  ...
  template <typename TrafficShapingTpsConfigurationT = TrafficShapingTpsConfiguration>
  PrefetchRetrieval& WithTrafficShapingTpsConfiguration(TrafficShapingTpsConfigurationT&& value) {
