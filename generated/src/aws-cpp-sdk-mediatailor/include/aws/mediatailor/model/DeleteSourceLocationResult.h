...
namespace Model
{
  ...
  public:
    ...
    inline DeleteSourceLocationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteSourceLocationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteSourceLocationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
