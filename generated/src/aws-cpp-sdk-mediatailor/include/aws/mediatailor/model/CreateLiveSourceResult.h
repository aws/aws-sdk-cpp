...
class CreateLiveSourceResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateLiveSourceResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  CreateLiveSourceResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename HttpPackageConfigurationsT = Aws::Vector<HttpPackageConfiguration>>
  CreateLiveSourceResult& WithHttpPackageConfigurations(HttpPackageConfigurationsT&& value) {
  ...
  CreateLiveSourceResult& AddHttpPackageConfigurations(HttpPackageConfigurationsT&& value) {
    m_httpPackageConfigurationsHasBeenSet = true;
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  CreateLiveSourceResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename LiveSourceNameT = Aws::String>
  CreateLiveSourceResult& WithLiveSourceName(LiveSourceNameT&& value) {
  ...
  template <typename SourceLocationNameT = Aws::String>
  CreateLiveSourceResult& WithSourceLocationName(SourceLocationNameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateLiveSourceResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateLiveSourceResult& WithRequestId(RequestIdT&& value) {
