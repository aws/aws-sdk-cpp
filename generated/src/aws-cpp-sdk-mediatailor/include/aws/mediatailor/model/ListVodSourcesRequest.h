...
class ListVodSourcesRequest : public MediaTailorRequest {
 public:
  ...
  inline ListVodSourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
   ...
   * <code>ListVodSources</code> request, omit this value. For subsequent requests,
  ...
  template <typename NextTokenT = Aws::String>
  ListVodSourcesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SourceLocationNameT = Aws::String>
  ListVodSourcesRequest& WithSourceLocationName(SourceLocationNameT&& value) {
