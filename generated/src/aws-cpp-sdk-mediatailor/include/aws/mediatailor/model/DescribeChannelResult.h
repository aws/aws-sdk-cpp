...
namespace Model
{
  ...
  public:
    ...
    template<typename ChannelNameT = Aws::String>
    DescribeChannelResult& WithChannelName(ChannelNameT&& value) { SetChannelName(std::forward<ChannelNameT>(value)); return *this;}
    ///@}
    ...
    inline DescribeChannelResult& WithChannelState(ChannelState value) { SetChannelState(value); return *this;}
    ///@}
    ...
    template<typename CreationTimeT = Aws::Utils::DateTime>
    DescribeChannelResult& WithCreationTime(CreationTimeT&& value) { SetCreationTime(std::forward<CreationTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename FillerSlateT = SlateSource>
    DescribeChannelResult& WithFillerSlate(FillerSlateT&& value) { SetFillerSlate(std::forward<FillerSlateT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeT = Aws::Utils::DateTime>
    DescribeChannelResult& WithLastModifiedTime(LastModifiedTimeT&& value) { SetLastModifiedTime(std::forward<LastModifiedTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename OutputsT = Aws::Vector<ResponseOutputItem>>
    DescribeChannelResult& WithOutputs(OutputsT&& value) { SetOutputs(std::forward<OutputsT>(value)); return *this;}
    template<typename OutputsT = ResponseOutputItem>
    DescribeChannelResult& AddOutputs(OutputsT&& value) { m_outputsHasBeenSet = true; m_outputs.emplace_back(std::forward<OutputsT>(value)); return *this; }
    ///@}
    ...
    template<typename PlaybackModeT = Aws::String>
    DescribeChannelResult& WithPlaybackMode(PlaybackModeT&& value) { SetPlaybackMode(std::forward<PlaybackModeT>(value)); return *this;}
    ///@}
    ...
    template<typename TierT = Aws::String>
    DescribeChannelResult& WithTier(TierT&& value) { SetTier(std::forward<TierT>(value)); return *this;}
    ///@}
    ...
    template<typename LogConfigurationT = LogConfigurationForChannel>
    DescribeChannelResult& WithLogConfiguration(LogConfigurationT&& value) { SetLogConfiguration(std::forward<LogConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename TimeShiftConfigurationT = TimeShiftConfiguration>
    DescribeChannelResult& WithTimeShiftConfiguration(TimeShiftConfigurationT&& value) { SetTimeShiftConfiguration(std::forward<TimeShiftConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename AudiencesT = Aws::Vector<Aws::String>>
    DescribeChannelResult& WithAudiences(AudiencesT&& value) { SetAudiences(std::forward<AudiencesT>(value)); return *this;}
    template<typename AudiencesT = Aws::String>
    DescribeChannelResult& AddAudiences(AudiencesT&& value) { m_audiencesHasBeenSet = true; m_audiences.emplace_back(std::forward<AudiencesT>(value)); return *this; }
    ///@}
