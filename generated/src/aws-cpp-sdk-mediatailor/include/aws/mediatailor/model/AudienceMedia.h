...
class AudienceMedia {
 public:
  ...
  template <typename AudienceT = Aws::String>
  AudienceMedia& WithAudience(AudienceT&& value) {
  ...
  void SetAlternateMedia(AlternateMediaT&& value) {
    m_alternateMediaHasBeenSet = true;
    m_alternateMedia = std::forward<AlternateMediaT>(value);
  }
  template <typename AlternateMediaT = Aws::Vector<AlternateMedia>>
  AudienceMedia& WithAlternateMedia(AlternateMediaT&& value) {
    SetAlternateMedia(std::forward<AlternateMediaT>(value));
    return *this;
  }
  template <typename AlternateMediaT = AlternateMedia>
  AudienceMedia& AddAlternateMedia(AlternateMediaT&& value) {
    m_alternateMediaHasBeenSet = true;
    m_alternateMedia.emplace_back(std::forward<AlternateMediaT>(value));
    return *this;
  }
  ///@}
 private:
