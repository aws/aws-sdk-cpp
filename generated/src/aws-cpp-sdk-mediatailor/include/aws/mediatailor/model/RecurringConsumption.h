...
class RecurringConsumption {
 public:
  ...
  inline void SetRetrievedAdExpirationSeconds(int value) {
    m_retrievedAdExpirationSecondsHasBeenSet = true;
    m_retrievedAdExpirationSeconds = value;
  }
  inline RecurringConsumption& WithRetrievedAdExpirationSeconds(int value) {
    SetRetrievedAdExpirationSeconds(value);
    return *this;
  }
  ///@}
  ...
  template <typename AvailMatchingCriteriaT = Aws::Vector<AvailMatchingCriteria>>
  RecurringConsumption& WithAvailMatchingCriteria(AvailMatchingCriteriaT&& value) {
  ...
  RecurringConsumption& AddAvailMatchingCriteria(AvailMatchingCriteriaT&& value) {
    m_availMatchingCriteriaHasBeenSet = true;
