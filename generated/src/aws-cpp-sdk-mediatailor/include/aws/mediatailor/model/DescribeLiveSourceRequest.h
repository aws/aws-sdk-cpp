...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIATAILOR_API DescribeLiveSourceRequest() = default;
    ...
    template<typename LiveSourceNameT = Aws::String>
    DescribeLiveSourceRequest& WithLiveSourceName(LiveSourceNameT&& value) { SetLiveSourceName(std::forward<LiveSourceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceLocationNameT = Aws::String>
    DescribeLiveSourceRequest& WithSourceLocationName(SourceLocationNameT&& value) { SetSourceLocationName(std::forward<SourceLocationNameT>(value)); return *this;}
    ///@}
  private:
