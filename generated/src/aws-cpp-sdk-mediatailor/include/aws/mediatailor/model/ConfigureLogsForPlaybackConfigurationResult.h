...
class ConfigureLogsForPlaybackConfigurationResult {
 public:
  ...
  AWS_MEDIATAILOR_API ConfigureLogsForPlaybackConfigurationResult& operator=(
  ...
  inline void SetPercentEnabled(int value) {
    m_percentEnabledHasBeenSet = true;
    m_percentEnabled = value;
  }
  inline ConfigureLogsForPlaybackConfigurationResult& WithPercentEnabled(int value) {
    SetPercentEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename PlaybackConfigurationNameT = Aws::String>
  ConfigureLogsForPlaybackConfigurationResult& WithPlaybackConfigurationName(PlaybackConfigurationNameT&& value) {
  ...
  void SetEnabledLoggingStrategies(EnabledLoggingStrategiesT&& value) {
    ...
    m_enabledLoggingStrategies = std::forward<EnabledLoggingStrategiesT>(value);
  }
  template <typename EnabledLoggingStrategiesT = Aws::Vector<LoggingStrategy>>
  ConfigureLogsForPlaybackConfigurationResult& WithEnabledLoggingStrategies(EnabledLoggingStrategiesT&& value) {
    SetEnabledLoggingStrategies(std::forward<EnabledLoggingStrategiesT>(value));
    return *this;
  }
  inline ConfigureLogsForPlaybackConfigurationResult& AddEnabledLoggingStrategies(LoggingStrategy value) {
    m_enabledLoggingStrategiesHasBeenSet = true;
    m_enabledLoggingStrategies.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetAdsInteractionLog(AdsInteractionLogT&& value) {
    ...
    m_adsInteractionLog = std::forward<AdsInteractionLogT>(value);
  }
  template <typename AdsInteractionLogT = AdsInteractionLog>
  ConfigureLogsForPlaybackConfigurationResult& WithAdsInteractionLog(AdsInteractionLogT&& value) {
    SetAdsInteractionLog(std::forward<AdsInteractionLogT>(value));
    return *this;
  }
  ///@}
  ...
  void SetManifestServiceInteractionLog(ManifestServiceInteractionLogT&& value) {
    ...
    m_manifestServiceInteractionLog = std::forward<ManifestServiceInteractionLogT>(value);
  }
  template <typename ManifestServiceInteractionLogT = ManifestServiceInteractionLog>
  ConfigureLogsForPlaybackConfigurationResult& WithManifestServiceInteractionLog(ManifestServiceInteractionLogT&& value) {
    SetManifestServiceInteractionLog(std::forward<ManifestServiceInteractionLogT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ConfigureLogsForPlaybackConfigurationResult& WithRequestId(RequestIdT&& value) {
