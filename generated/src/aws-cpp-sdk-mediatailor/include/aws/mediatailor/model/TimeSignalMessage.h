...
class TimeSignalMessage {
 public:
  ...
  void SetSegmentationDescriptors(SegmentationDescriptorsT&& value) {
    m_segmentationDescriptorsHasBeenSet = true;
    m_segmentationDescriptors = std::forward<SegmentationDescriptorsT>(value);
  }
  template <typename SegmentationDescriptorsT = Aws::Vector<SegmentationDescriptor>>
  TimeSignalMessage& WithSegmentationDescriptors(SegmentationDescriptorsT&& value) {
    SetSegmentationDescriptors(std::forward<SegmentationDescriptorsT>(value));
    return *this;
  }
  template <typename SegmentationDescriptorsT = SegmentationDescriptor>
  TimeSignalMessage& AddSegmentationDescriptors(SegmentationDescriptorsT&& value) {
    m_segmentationDescriptorsHasBeenSet = true;
    m_segmentationDescriptors.emplace_back(std::forward<SegmentationDescriptorsT>(value));
    return *this;
  }
  ///@}
 private:
