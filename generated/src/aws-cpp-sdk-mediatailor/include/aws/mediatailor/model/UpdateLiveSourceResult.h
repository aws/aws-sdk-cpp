...
namespace Model
{
  ...
  public:
    ...
    inline UpdateLiveSourceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateLiveSourceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateLiveSourceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
