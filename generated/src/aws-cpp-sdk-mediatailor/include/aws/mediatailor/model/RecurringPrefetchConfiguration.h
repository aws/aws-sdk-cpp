...
class RecurringPrefetchConfiguration {
 public:
  ...
  void SetRecurringConsumption(RecurringConsumptionT&& value) {
    m_recurringConsumptionHasBeenSet = true;
    m_recurringConsumption = std::forward<RecurringConsumptionT>(value);
  }
  template <typename RecurringConsumptionT = RecurringConsumption>
  RecurringPrefetchConfiguration& WithRecurringConsumption(RecurringConsumptionT&& value) {
    SetRecurringConsumption(std::forward<RecurringConsumptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecurringRetrieval(RecurringRetrievalT&& value) {
    m_recurringRetrievalHasBeenSet = true;
    m_recurringRetrieval = std::forward<RecurringRetrievalT>(value);
  }
  template <typename RecurringRetrievalT = RecurringRetrieval>
  RecurringPrefetchConfiguration& WithRecurringRetrieval(RecurringRetrievalT&& value) {
    SetRecurringRetrieval(std::forward<RecurringRetrievalT>(value));
    return *this;
  }
  ///@}
 private:
