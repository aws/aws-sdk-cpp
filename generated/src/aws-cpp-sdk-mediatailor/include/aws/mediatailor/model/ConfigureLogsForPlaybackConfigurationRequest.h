...
class ConfigureLogsForPlaybackConfigurationRequest : public MediaTailorRequest {
 public:
  ...
  inline ConfigureLogsForPlaybackConfigurationRequest& WithPercentEnabled(int value) {
  ...
  template <typename PlaybackConfigurationNameT = Aws::String>
  ConfigureLogsForPlaybackConfigurationRequest& WithPlaybackConfigurationName(PlaybackConfigurationNameT&& value) {
  ...
  template <typename EnabledLoggingStrategiesT = Aws::Vector<LoggingStrategy>>
  ConfigureLogsForPlaybackConfigurationRequest& WithEnabledLoggingStrategies(EnabledLoggingStrategiesT&& value) {
    SetEnabledLoggingStrategies(std::forward<EnabledLoggingStrategiesT>(value));
    return *this;
  }
  inline ConfigureLogsForPlaybackConfigurationRequest& AddEnabledLoggingStrategies(LoggingStrategy value) {
    m_enabledLoggingStrategiesHasBeenSet = true;
  ...
  template <typename AdsInteractionLogT = AdsInteractionLog>
  ConfigureLogsForPlaybackConfigurationRequest& WithAdsInteractionLog(AdsInteractionLogT&& value) {
  ...
  template <typename ManifestServiceInteractionLogT = ManifestServiceInteractionLog>
  ConfigureLogsForPlaybackConfigurationRequest& WithManifestServiceInteractionLog(ManifestServiceInteractionLogT&& value) {
