...
class DescribeVodSourceResult {
 public:
  ...
  void SetAdBreakOpportunities(AdBreakOpportunitiesT&& value) {
    ...
    m_adBreakOpportunities = std::forward<AdBreakOpportunitiesT>(value);
  }
  template <typename AdBreakOpportunitiesT = Aws::Vector<AdBreakOpportunity>>
  DescribeVodSourceResult& WithAdBreakOpportunities(AdBreakOpportunitiesT&& value) {
    SetAdBreakOpportunities(std::forward<AdBreakOpportunitiesT>(value));
    return *this;
  }
  ...
  DescribeVodSourceResult& AddAdBreakOpportunities(AdBreakOpportunitiesT&& value) {
    m_adBreakOpportunitiesHasBeenSet = true;
    m_adBreakOpportunities.emplace_back(std::forward<AdBreakOpportunitiesT>(value));
    return *this;
  }
  ///@}
