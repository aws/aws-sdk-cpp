...
class UpdateProgramResult {
 public:
  ...
  template <typename AdBreaksT = Aws::Vector<AdBreak>>
  UpdateProgramResult& WithAdBreaks(AdBreaksT&& value) {
    SetAdBreaks(std::forward<AdBreaksT>(value));
    return *this;
  }
  template <typename AdBreaksT = AdBreak>
  UpdateProgramResult& AddAdBreaks(AdBreaksT&& value) {
    m_adBreaksHasBeenSet = true;
  ...
  template <typename ArnT = Aws::String>
  UpdateProgramResult& WithArn(ArnT&& value) {
  ...
  template <typename ChannelNameT = Aws::String>
  UpdateProgramResult& WithChannelName(ChannelNameT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  UpdateProgramResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename ProgramNameT = Aws::String>
  UpdateProgramResult& WithProgramName(ProgramNameT&& value) {
  ...
  template <typename SourceLocationNameT = Aws::String>
  UpdateProgramResult& WithSourceLocationName(SourceLocationNameT&& value) {
  ...
  template <typename VodSourceNameT = Aws::String>
  UpdateProgramResult& WithVodSourceName(VodSourceNameT&& value) {
  ...
  template <typename LiveSourceNameT = Aws::String>
  UpdateProgramResult& WithLiveSourceName(LiveSourceNameT&& value) {
  ...
  template <typename ClipRangeT = ClipRange>
  UpdateProgramResult& WithClipRange(ClipRangeT&& value) {
  ...
  inline UpdateProgramResult& WithDurationMillis(long long value) {
  ...
  template <typename ScheduledStartTimeT = Aws::Utils::DateTime>
  UpdateProgramResult& WithScheduledStartTime(ScheduledStartTimeT&& value) {
  ...
  template <typename AudienceMediaT = Aws::Vector<AudienceMedia>>
  UpdateProgramResult& WithAudienceMedia(AudienceMediaT&& value) {
    SetAudienceMedia(std::forward<AudienceMediaT>(value));
    return *this;
  }
  template <typename AudienceMediaT = AudienceMedia>
  UpdateProgramResult& AddAudienceMedia(AudienceMediaT&& value) {
    m_audienceMediaHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateProgramResult& WithRequestId(RequestIdT&& value) {
