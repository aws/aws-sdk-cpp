...
/**
 */
class ListPlaybackConfigurationsRequest : public MediaTailorRequest {
 public:
  AWS_MEDIATAILOR_API ListPlaybackConfigurationsRequest() = default;
  ...
  ///@{
  /**
   * <p>The maximum number of playback configurations that you want MediaTailor to
  ...
  inline ListPlaybackConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPlaybackConfigurationsRequest& WithNextToken(NextTokenT&& value) {
