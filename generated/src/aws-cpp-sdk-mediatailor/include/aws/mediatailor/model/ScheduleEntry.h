...
class ScheduleEntry {
 public:
  ...
  inline void SetApproximateDurationSeconds(long long value) {
    m_approximateDurationSecondsHasBeenSet = true;
    m_approximateDurationSeconds = value;
  }
  inline ScheduleEntry& WithApproximateDurationSeconds(long long value) {
    SetApproximateDurationSeconds(value);
    return *this;
  }
  ///@}
  ...
  void SetApproximateStartTime(ApproximateStartTimeT&& value) {
    ...
    m_approximateStartTime = std::forward<ApproximateStartTimeT>(value);
  }
  template <typename ApproximateStartTimeT = Aws::Utils::DateTime>
  ScheduleEntry& WithApproximateStartTime(ApproximateStartTimeT&& value) {
    SetApproximateStartTime(std::forward<ApproximateStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScheduleAdBreaks(ScheduleAdBreaksT&& value) {
    ...
    m_scheduleAdBreaks = std::forward<ScheduleAdBreaksT>(value);
  }
  template <typename ScheduleAdBreaksT = Aws::Vector<ScheduleAdBreak>>
  ScheduleEntry& WithScheduleAdBreaks(ScheduleAdBreaksT&& value) {
    SetScheduleAdBreaks(std::forward<ScheduleAdBreaksT>(value));
    return *this;
  }
  template <typename ScheduleAdBreaksT = ScheduleAdBreak>
  ScheduleEntry& AddScheduleAdBreaks(ScheduleAdBreaksT&& value) {
    m_scheduleAdBreaksHasBeenSet = true;
    m_scheduleAdBreaks.emplace_back(std::forward<ScheduleAdBreaksT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetScheduleEntryType(ScheduleEntryType value) {
    m_scheduleEntryTypeHasBeenSet = true;
    m_scheduleEntryType = value;
  }
  inline ScheduleEntry& WithScheduleEntryType(ScheduleEntryType value) {
    SetScheduleEntryType(value);
    return *this;
  }
  ///@}
