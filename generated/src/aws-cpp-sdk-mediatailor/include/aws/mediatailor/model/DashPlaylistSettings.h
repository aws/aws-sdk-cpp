...
class DashPlaylistSettings {
 public:
  ...
  inline DashPlaylistSettings& WithManifestWindowSeconds(int value) {
  ...
  inline DashPlaylistSettings& WithMinBufferTimeSeconds(int value) {
  ...
  inline DashPlaylistSettings& WithMinUpdatePeriodSeconds(int value) {
  ...
  inline DashPlaylistSettings& WithSuggestedPresentationDelaySeconds(int value) {
