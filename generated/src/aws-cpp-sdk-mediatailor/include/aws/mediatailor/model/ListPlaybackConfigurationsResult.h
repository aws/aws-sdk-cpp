...
class ListPlaybackConfigurationsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<PlaybackConfiguration>>
  ListPlaybackConfigurationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = PlaybackConfiguration>
  ListPlaybackConfigurationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPlaybackConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPlaybackConfigurationsResult& WithRequestId(RequestIdT&& value) {
