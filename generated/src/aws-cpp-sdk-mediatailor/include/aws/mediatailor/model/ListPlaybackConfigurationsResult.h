...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIATAILOR_API ListPlaybackConfigurationsResult();
    ...
    inline ListPlaybackConfigurationsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListPlaybackConfigurationsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListPlaybackConfigurationsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
