...
class ManifestProcessingRules {
 public:
  ...
  void SetAdMarkerPassthrough(AdMarkerPassthroughT&& value) {
    m_adMarkerPassthroughHasBeenSet = true;
    m_adMarkerPassthrough = std::forward<AdMarkerPassthroughT>(value);
  }
  template <typename AdMarkerPassthroughT = AdMarkerPassthrough>
  ManifestProcessingRules& WithAdMarkerPassthrough(AdMarkerPassthroughT&& value) {
    SetAdMarkerPassthrough(std::forward<AdMarkerPassthroughT>(value));
    return *this;
  }
  ///@}
 private:
