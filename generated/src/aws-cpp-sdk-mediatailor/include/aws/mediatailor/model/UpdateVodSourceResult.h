...
class UpdateVodSourceResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateVodSourceResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  UpdateVodSourceResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename HttpPackageConfigurationsT = Aws::Vector<HttpPackageConfiguration>>
  UpdateVodSourceResult& WithHttpPackageConfigurations(HttpPackageConfigurationsT&& value) {
  ...
  UpdateVodSourceResult& AddHttpPackageConfigurations(HttpPackageConfigurationsT&& value) {
    m_httpPackageConfigurationsHasBeenSet = true;
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  UpdateVodSourceResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename SourceLocationNameT = Aws::String>
  UpdateVodSourceResult& WithSourceLocationName(SourceLocationNameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateVodSourceResult& WithTags(TagsT&& value) {
  ...
  template <typename VodSourceNameT = Aws::String>
  UpdateVodSourceResult& WithVodSourceName(VodSourceNameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateVodSourceResult& WithRequestId(RequestIdT&& value) {
