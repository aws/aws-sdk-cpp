...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIATAILOR_API DeleteProgramResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteProgramResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
