...
class SegmentationDescriptor {
 public:
  ...
  inline void SetSegmentationEventId(int value) {
    m_segmentationEventIdHasBeenSet = true;
    m_segmentationEventId = value;
  }
  inline SegmentationDescriptor& WithSegmentationEventId(int value) {
  ...
  inline SegmentationDescriptor& WithSegmentationUpidType(int value) {
  ...
  inline SegmentationDescriptor& WithSegmentationTypeId(int value) {
  ...
  inline SegmentationDescriptor& WithSegmentNum(int value) {
    SetSegmentNum(value);
    return *this;
  }
  ///@}
  ...
  inline SegmentationDescriptor& WithSegmentsExpected(int value) {
  ...
  inline SegmentationDescriptor& WithSubSegmentNum(int value) {
  ...
  inline SegmentationDescriptor& WithSubSegmentsExpected(int value) {
