...
class ListLiveSourcesRequest : public MediaTailorRequest {
 public:
  ...
  inline ListLiveSourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLiveSourcesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SourceLocationNameT = Aws::String>
  ListLiveSourcesRequest& WithSourceLocationName(SourceLocationNameT&& value) {
