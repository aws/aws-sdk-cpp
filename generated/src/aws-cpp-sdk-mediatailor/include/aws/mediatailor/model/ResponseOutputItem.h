...
class ResponseOutputItem {
 public:
  ...
  template <typename DashPlaylistSettingsT = DashPlaylistSettings>
  ResponseOutputItem& WithDashPlaylistSettings(DashPlaylistSettingsT&& value) {
  ...
  template <typename HlsPlaylistSettingsT = HlsPlaylistSettings>
  ResponseOutputItem& WithHlsPlaylistSettings(HlsPlaylistSettingsT&& value) {
  ...
  template <typename ManifestNameT = Aws::String>
  ResponseOutputItem& WithManifestName(ManifestNameT&& value) {
  ...
  template <typename SourceGroupT = Aws::String>
  ResponseOutputItem& WithSourceGroup(SourceGroupT&& value) {
