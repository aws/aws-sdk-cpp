...
class ListSourceLocationsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<SourceLocation>>
  ListSourceLocationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = SourceLocation>
  ListSourceLocationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSourceLocationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSourceLocationsResult& WithRequestId(RequestIdT&& value) {
