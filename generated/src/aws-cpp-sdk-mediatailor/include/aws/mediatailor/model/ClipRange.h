...
class ClipRange {
 public:
  ...
  inline ClipRange& WithEndOffsetMillis(long long value) {
  ...
  inline void SetStartOffsetMillis(long long value) {
    m_startOffsetMillisHasBeenSet = true;
    m_startOffsetMillis = value;
  }
  inline ClipRange& WithStartOffsetMillis(long long value) {
    SetStartOffsetMillis(value);
    return *this;
  }
  ///@}
 private:
