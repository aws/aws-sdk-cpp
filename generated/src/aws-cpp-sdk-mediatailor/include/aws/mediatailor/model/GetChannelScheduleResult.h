...
class GetChannelScheduleResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ScheduleEntry>>
  GetChannelScheduleResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ScheduleEntry>
  GetChannelScheduleResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetChannelScheduleResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetChannelScheduleResult& WithRequestId(RequestIdT&& value) {
