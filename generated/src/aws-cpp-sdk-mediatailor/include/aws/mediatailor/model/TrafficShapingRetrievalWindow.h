...
class TrafficShapingRetrievalWindow {
 public:
  ...
  inline void SetRetrievalWindowDurationSeconds(int value) {
    m_retrievalWindowDurationSecondsHasBeenSet = true;
    m_retrievalWindowDurationSeconds = value;
  }
  inline TrafficShapingRetrievalWindow& WithRetrievalWindowDurationSeconds(int value) {
    SetRetrievalWindowDurationSeconds(value);
    return *this;
  }
  ///@}
 private:
