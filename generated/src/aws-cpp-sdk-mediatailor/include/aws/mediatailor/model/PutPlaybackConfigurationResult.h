...
class PutPlaybackConfigurationResult {
 public:
  ...
  inline PutPlaybackConfigurationResult& WithInsertionMode(InsertionMode value) {
  ...
  template <typename NameT = Aws::String>
  PutPlaybackConfigurationResult& WithName(NameT&& value) {
  ...
  inline PutPlaybackConfigurationResult& WithPersonalizationThresholdSeconds(int value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  PutPlaybackConfigurationResult& WithTags(TagsT&& value) {
  ...
  template <typename AdDecisionServerConfigurationT = AdDecisionServerConfiguration>
  PutPlaybackConfigurationResult& WithAdDecisionServerConfiguration(AdDecisionServerConfigurationT&& value) {
  ...
  template <typename YieldOptimizationConfigurationT = YieldOptimizationConfiguration>
  PutPlaybackConfigurationResult& WithYieldOptimizationConfiguration(YieldOptimizationConfigurationT&& value) {
  ...
  template <typename AdsPersonalizationTimeoutsT = AdsPersonalizationTimeouts>
  PutPlaybackConfigurationResult& WithAdsPersonalizationTimeouts(AdsPersonalizationTimeoutsT&& value) {
  ...
  template <typename AdsPersonalizationConcurrencyT = AdsPersonalizationConcurrency>
  PutPlaybackConfigurationResult& WithAdsPersonalizationConcurrency(AdsPersonalizationConcurrencyT&& value) {
