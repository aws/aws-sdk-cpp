...
namespace Model
{
  ...
  public:
    ...
    template<typename AdDecisionServerUrlT = Aws::String>
    PutPlaybackConfigurationResult& WithAdDecisionServerUrl(AdDecisionServerUrlT&& value) { SetAdDecisionServerUrl(std::forward<AdDecisionServerUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename AvailSuppressionT = AvailSuppression>
    PutPlaybackConfigurationResult& WithAvailSuppression(AvailSuppressionT&& value) { SetAvailSuppression(std::forward<AvailSuppressionT>(value)); return *this;}
    ///@}
    ...
    template<typename BumperT = Bumper>
    PutPlaybackConfigurationResult& WithBumper(BumperT&& value) { SetBumper(std::forward<BumperT>(value)); return *this;}
    ///@}
    ...
    template<typename CdnConfigurationT = CdnConfiguration>
    PutPlaybackConfigurationResult& WithCdnConfiguration(CdnConfigurationT&& value) { SetCdnConfiguration(std::forward<CdnConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigurationAliasesT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
    PutPlaybackConfigurationResult& WithConfigurationAliases(ConfigurationAliasesT&& value) { SetConfigurationAliases(std::forward<ConfigurationAliasesT>(value)); return *this;}
    ...
    template<typename DashConfigurationT = DashConfiguration>
    PutPlaybackConfigurationResult& WithDashConfiguration(DashConfigurationT&& value) { SetDashConfiguration(std::forward<DashConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename HlsConfigurationT = HlsConfiguration>
    PutPlaybackConfigurationResult& WithHlsConfiguration(HlsConfigurationT&& value) { SetHlsConfiguration(std::forward<HlsConfigurationT>(value)); return *this;}
    ///@}
    ...
    inline PutPlaybackConfigurationResult& WithInsertionMode(InsertionMode value) { SetInsertionMode(value); return *this;}
    ///@}
    ...
    template<typename LivePreRollConfigurationT = LivePreRollConfiguration>
    PutPlaybackConfigurationResult& WithLivePreRollConfiguration(LivePreRollConfigurationT&& value) { SetLivePreRollConfiguration(std::forward<LivePreRollConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename LogConfigurationT = LogConfiguration>
    PutPlaybackConfigurationResult& WithLogConfiguration(LogConfigurationT&& value) { SetLogConfiguration(std::forward<LogConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ManifestProcessingRulesT = ManifestProcessingRules>
    PutPlaybackConfigurationResult& WithManifestProcessingRules(ManifestProcessingRulesT&& value) { SetManifestProcessingRules(std::forward<ManifestProcessingRulesT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    PutPlaybackConfigurationResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename PlaybackConfigurationArnT = Aws::String>
    PutPlaybackConfigurationResult& WithPlaybackConfigurationArn(PlaybackConfigurationArnT&& value) { SetPlaybackConfigurationArn(std::forward<PlaybackConfigurationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename PlaybackEndpointPrefixT = Aws::String>
    PutPlaybackConfigurationResult& WithPlaybackEndpointPrefix(PlaybackEndpointPrefixT&& value) { SetPlaybackEndpointPrefix(std::forward<PlaybackEndpointPrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename SessionInitializationEndpointPrefixT = Aws::String>
    PutPlaybackConfigurationResult& WithSessionInitializationEndpointPrefix(SessionInitializationEndpointPrefixT&& value) { SetSessionInitializationEndpointPrefix(std::forward<SessionInitializationEndpointPrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename SlateAdUrlT = Aws::String>
    PutPlaybackConfigurationResult& WithSlateAdUrl(SlateAdUrlT&& value) { SetSlateAdUrl(std::forward<SlateAdUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    PutPlaybackConfigurationResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename TranscodeProfileNameT = Aws::String>
    PutPlaybackConfigurationResult& WithTranscodeProfileName(TranscodeProfileNameT&& value) { SetTranscodeProfileName(std::forward<TranscodeProfileNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VideoContentSourceUrlT = Aws::String>
    PutPlaybackConfigurationResult& WithVideoContentSourceUrl(VideoContentSourceUrlT&& value) { SetVideoContentSourceUrl(std::forward<VideoContentSourceUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename AdConditioningConfigurationT = AdConditioningConfiguration>
    PutPlaybackConfigurationResult& WithAdConditioningConfiguration(AdConditioningConfigurationT&& value) { SetAdConditioningConfiguration(std::forward<AdConditioningConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutPlaybackConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
