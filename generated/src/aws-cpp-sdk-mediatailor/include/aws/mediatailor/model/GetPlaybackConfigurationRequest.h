...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIATAILOR_API GetPlaybackConfigurationRequest() = default;
    ...
    template<typename NameT = Aws::String>
    GetPlaybackConfigurationRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
