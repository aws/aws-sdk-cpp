...
class ListLiveSourcesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<LiveSource>>
  ListLiveSourcesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = LiveSource>
  ListLiveSourcesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLiveSourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLiveSourcesResult& WithRequestId(RequestIdT&& value) {
