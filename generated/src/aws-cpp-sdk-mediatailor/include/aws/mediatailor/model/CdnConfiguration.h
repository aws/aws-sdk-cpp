...
class CdnConfiguration {
 public:
  ...
  void SetAdSegmentUrlPrefix(AdSegmentUrlPrefixT&& value) {
    m_adSegmentUrlPrefixHasBeenSet = true;
    m_adSegmentUrlPrefix = std::forward<AdSegmentUrlPrefixT>(value);
  }
  template <typename AdSegmentUrlPrefixT = Aws::String>
  CdnConfiguration& WithAdSegmentUrlPrefix(AdSegmentUrlPrefixT&& value) {
    SetAdSegmentUrlPrefix(std::forward<AdSegmentUrlPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContentSegmentUrlPrefix(ContentSegmentUrlPrefixT&& value) {
    m_contentSegmentUrlPrefixHasBeenSet = true;
    m_contentSegmentUrlPrefix = std::forward<ContentSegmentUrlPrefixT>(value);
  }
  template <typename ContentSegmentUrlPrefixT = Aws::String>
  CdnConfiguration& WithContentSegmentUrlPrefix(ContentSegmentUrlPrefixT&& value) {
    SetContentSegmentUrlPrefix(std::forward<ContentSegmentUrlPrefixT>(value));
    return *this;
  }
  ///@}
 private:
