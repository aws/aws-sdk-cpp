...
namespace Model
{
  ...
  public:
    ...
    inline DeleteLiveSourceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteLiveSourceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteLiveSourceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
