...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIATAILOR_API DeleteLiveSourceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteLiveSourceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
