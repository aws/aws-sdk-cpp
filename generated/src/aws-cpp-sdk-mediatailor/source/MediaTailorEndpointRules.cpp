...
{
const size_t MediaTailorEndpointRules::RulesBlobStrLen = 3554;
const size_t MediaTailorEndpointRules::RulesBlobSize = 3555;
...
'i','l','o','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'm','e','d','i','a','t','a','i','l','o','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
