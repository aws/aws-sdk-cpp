...
PrefetchConsumption::PrefetchConsumption(JsonView jsonValue) { *this = jsonValue; }
...
PrefetchConsumption& PrefetchConsumption::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("AvailMatchingCriteria")) {
    ...
    for (unsigned availMatchingCriteriaIndex = 0; availMatchingCriteriaIndex < availMatchingCriteriaJsonList.GetLength();
         ++availMatchingCriteriaIndex) {
