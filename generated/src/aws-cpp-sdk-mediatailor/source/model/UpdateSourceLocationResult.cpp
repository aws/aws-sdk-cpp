...
UpdateSourceLocationResult::UpdateSourceLocationResult()
{
}

UpdateSourceLocationResult::UpdateSourceLocationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
