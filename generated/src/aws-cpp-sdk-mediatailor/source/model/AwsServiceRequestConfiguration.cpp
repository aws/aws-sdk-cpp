...
AwsServiceRequestConfiguration::AwsServiceRequestConfiguration(JsonView jsonValue) { *this = jsonValue; }

AwsServiceRequestConfiguration& AwsServiceRequestConfiguration::operator=(JsonView jsonValue) {
...
JsonValue AwsServiceRequestConfiguration::Jsonize() const {
  JsonValue payload;
  ...
  if (m_targetServiceHasBeenSet) {
    payload.WithString("TargetService", m_targetService);
  }
