...
TimeSignalMessage::TimeSignalMessage(JsonView jsonValue) { *this = jsonValue; }
...
TimeSignalMessage& TimeSignalMessage::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("SegmentationDescriptors")) {
    ...
    for (unsigned segmentationDescriptorsIndex = 0; segmentationDescriptorsIndex < segmentationDescriptorsJsonList.GetLength();
         ++segmentationDescriptorsIndex) {
...
JsonValue TimeSignalMessage::Jsonize() const {
  ...
  if (m_segmentationDescriptorsHasBeenSet) {
    ...
    for (unsigned segmentationDescriptorsIndex = 0; segmentationDescriptorsIndex < segmentationDescriptorsJsonList.GetLength();
         ++segmentationDescriptorsIndex) {
      segmentationDescriptorsJsonList[segmentationDescriptorsIndex].AsObject(
          m_segmentationDescriptors[segmentationDescriptorsIndex].Jsonize());
    }
