...
Aws::String ConfigureLogsForPlaybackConfigurationRequest::SerializePayload() const {
  ...
  if (m_enabledLoggingStrategiesHasBeenSet) {
    ...
    for (unsigned enabledLoggingStrategiesIndex = 0; enabledLoggingStrategiesIndex < enabledLoggingStrategiesJsonList.GetLength();
      ...
      enabledLoggingStrategiesJsonList[enabledLoggingStrategiesIndex].AsString(
          LoggingStrategyMapper::GetNameForLoggingStrategy(m_enabledLoggingStrategies[enabledLoggingStrategiesIndex]));
    }
