...
ListPlaybackConfigurationsResult::ListPlaybackConfigurationsResult()
{
}

ListPlaybackConfigurationsResult::ListPlaybackConfigurationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
