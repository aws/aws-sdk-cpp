...
ServiceActionDetail::ServiceActionDetail(JsonView jsonValue) { *this = jsonValue; }
...
ServiceActionDetail& ServiceActionDetail::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Definition")) {
    ...
    for (auto& definitionItem : definitionJsonMap) {
      m_definition[ServiceActionDefinitionKeyMapper::GetServiceActionDefinitionKeyForName(definitionItem.first)] =
          definitionItem.second.AsString();
    }
