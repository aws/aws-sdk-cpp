...
BatchAssociateServiceActionWithProvisioningArtifactResult::BatchAssociateServiceActionWithProvisioningArtifactResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

BatchAssociateServiceActionWithProvisioningArtifactResult& BatchAssociateServiceActionWithProvisioningArtifactResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
