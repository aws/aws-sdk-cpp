...
DescribeProductViewResult::DescribeProductViewResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeProductViewResult& DescribeProductViewResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ProvisioningArtifacts")) {
    ...
    for (unsigned provisioningArtifactsIndex = 0; provisioningArtifactsIndex < provisioningArtifactsJsonList.GetLength();
         ++provisioningArtifactsIndex) {
