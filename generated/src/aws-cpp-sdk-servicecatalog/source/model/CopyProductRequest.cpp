...
Aws::String CopyProductRequest::SerializePayload() const {
  ...
  if (m_sourceProvisioningArtifactIdentifiersHasBeenSet) {
    ...
    for (unsigned sourceProvisioningArtifactIdentifiersIndex = 0;
         sourceProvisioningArtifactIdentifiersIndex < sourceProvisioningArtifactIdentifiersJsonList.GetLength();
         ++sourceProvisioningArtifactIdentifiersIndex) {
      JsonValue sourceProvisioningArtifactPropertiesMapJsonMap;
      for (auto& sourceProvisioningArtifactPropertiesMapItem :
           m_sourceProvisioningArtifactIdentifiers[sourceProvisioningArtifactIdentifiersIndex]) {
        sourceProvisioningArtifactPropertiesMapJsonMap.WithString(
            ProvisioningArtifactPropertyNameMapper::GetNameForProvisioningArtifactPropertyName(
                sourceProvisioningArtifactPropertiesMapItem.first),
            sourceProvisioningArtifactPropertiesMapItem.second);
      }
      sourceProvisioningArtifactIdentifiersJsonList[sourceProvisioningArtifactIdentifiersIndex].AsObject(
          std::move(sourceProvisioningArtifactPropertiesMapJsonMap));
    }
