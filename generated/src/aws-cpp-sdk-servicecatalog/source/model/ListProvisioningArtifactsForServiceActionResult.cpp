...
ListProvisioningArtifactsForServiceActionResult& ListProvisioningArtifactsForServiceActionResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ProvisioningArtifactViews")) {
    ...
    for (unsigned provisioningArtifactViewsIndex = 0; provisioningArtifactViewsIndex < provisioningArtifactViewsJsonList.GetLength();
         ++provisioningArtifactViewsIndex) {
