...
#define AWS_SERVICECATALOG_EXTERN
#else
#define AWS_SERVICECATALOG_API
#define AWS_SERVICECATALOG_EXTERN extern
#endif  // USE_IMPORT_EXPORT
#define AWS_SERVICECATALOG_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_SERVICECATALOG_API
#define AWS_SERVICECATALOG_EXTERN extern
#if __GNUC__ >= 4
#define AWS_SERVICECATALOG_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_SERVICECATALOG_LOCAL
#endif
