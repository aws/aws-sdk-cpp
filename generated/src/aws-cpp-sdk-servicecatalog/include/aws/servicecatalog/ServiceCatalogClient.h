...
namespace ServiceCatalog
{
   ...
   */
  class AWS_SERVICECATALOG_API ServiceCatalogClient : Aws::Client::ClientWithAsyncTemplateMethods<ServiceCatalogClient>,
    smithy::client::AwsSmithyClientT<Aws::ServiceCatalog::SERVICE_NAME,
