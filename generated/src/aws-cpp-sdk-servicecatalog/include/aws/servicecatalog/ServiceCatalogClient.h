...
class AWS_SERVICECATALOG_API ServiceCatalogClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ServiceCatalogClient(const Aws::ServiceCatalog::ServiceCatalogClientConfiguration& clientConfiguration =
  ...
  ServiceCatalogClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<ServiceCatalogEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::ServiceCatalog::ServiceCatalogClientConfiguration& clientConfiguration =
                           Aws::ServiceCatalog::ServiceCatalogClientConfiguration());
  ...
  /**
   * A Callable wrapper for AcceptPortfolioShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AcceptPortfolioShare that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptPortfolioShareRequestT = Model::AcceptPortfolioShareRequest>
  void AcceptPortfolioShareAsync(const AcceptPortfolioShareRequestT& request, const AcceptPortfolioShareResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateBudgetWithResourceOutcome AssociateBudgetWithResource(
      const Model::AssociateBudgetWithResourceRequest& request) const;

  /**
   * A Callable wrapper for AssociateBudgetWithResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateBudgetWithResourceRequestT = Model::AssociateBudgetWithResourceRequest>
  Model::AssociateBudgetWithResourceOutcomeCallable AssociateBudgetWithResourceCallable(
      const AssociateBudgetWithResourceRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::AssociateBudgetWithResource, request);
  }

  /**
   * An Async wrapper for AssociateBudgetWithResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateBudgetWithResourceRequestT = Model::AssociateBudgetWithResourceRequest>
  void AssociateBudgetWithResourceAsync(const AssociateBudgetWithResourceRequestT& request,
                                        const AssociateBudgetWithResourceResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociatePrincipalWithPortfolioOutcome AssociatePrincipalWithPortfolio(
      const Model::AssociatePrincipalWithPortfolioRequest& request) const;

  /**
   * A Callable wrapper for AssociatePrincipalWithPortfolio that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociatePrincipalWithPortfolioRequestT = Model::AssociatePrincipalWithPortfolioRequest>
  Model::AssociatePrincipalWithPortfolioOutcomeCallable AssociatePrincipalWithPortfolioCallable(
      const AssociatePrincipalWithPortfolioRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::AssociatePrincipalWithPortfolio, request);
  }

  /**
   * An Async wrapper for AssociatePrincipalWithPortfolio that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociatePrincipalWithPortfolioRequestT = Model::AssociatePrincipalWithPortfolioRequest>
  void AssociatePrincipalWithPortfolioAsync(const AssociatePrincipalWithPortfolioRequestT& request,
                                            const AssociatePrincipalWithPortfolioResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateProductWithPortfolioOutcome AssociateProductWithPortfolio(
      const Model::AssociateProductWithPortfolioRequest& request) const;

  /**
   * A Callable wrapper for AssociateProductWithPortfolio that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateProductWithPortfolioRequestT = Model::AssociateProductWithPortfolioRequest>
  Model::AssociateProductWithPortfolioOutcomeCallable AssociateProductWithPortfolioCallable(
      const AssociateProductWithPortfolioRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::AssociateProductWithPortfolio, request);
  }

  /**
   * An Async wrapper for AssociateProductWithPortfolio that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateProductWithPortfolioRequestT = Model::AssociateProductWithPortfolioRequest>
  void AssociateProductWithPortfolioAsync(const AssociateProductWithPortfolioRequestT& request,
                                          const AssociateProductWithPortfolioResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateServiceActionWithProvisioningArtifactOutcome AssociateServiceActionWithProvisioningArtifact(
      const Model::AssociateServiceActionWithProvisioningArtifactRequest& request) const;

  /**
   * A Callable wrapper for AssociateServiceActionWithProvisioningArtifact that returns a future to the operation so that it can be executed
  ...
  Model::AssociateServiceActionWithProvisioningArtifactOutcomeCallable AssociateServiceActionWithProvisioningArtifactCallable(
      const AssociateServiceActionWithProvisioningArtifactRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::AssociateServiceActionWithProvisioningArtifact, request);
  }

  /**
   * An Async wrapper for AssociateServiceActionWithProvisioningArtifact that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename AssociateServiceActionWithProvisioningArtifactRequestT = Model::AssociateServiceActionWithProvisioningArtifactRequest>
  void AssociateServiceActionWithProvisioningArtifactAsync(
      const AssociateServiceActionWithProvisioningArtifactRequestT& request,
      const AssociateServiceActionWithProvisioningArtifactResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateTagOptionWithResourceOutcome AssociateTagOptionWithResource(
      const Model::AssociateTagOptionWithResourceRequest& request) const;

  /**
   * A Callable wrapper for AssociateTagOptionWithResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateTagOptionWithResourceRequestT = Model::AssociateTagOptionWithResourceRequest>
  Model::AssociateTagOptionWithResourceOutcomeCallable AssociateTagOptionWithResourceCallable(
      const AssociateTagOptionWithResourceRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::AssociateTagOptionWithResource, request);
  }

  /**
   * An Async wrapper for AssociateTagOptionWithResource that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateTagOptionWithResourceRequestT = Model::AssociateTagOptionWithResourceRequest>
  void AssociateTagOptionWithResourceAsync(const AssociateTagOptionWithResourceRequestT& request,
                                           const AssociateTagOptionWithResourceResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchAssociateServiceActionWithProvisioningArtifactOutcome BatchAssociateServiceActionWithProvisioningArtifact(
      const Model::BatchAssociateServiceActionWithProvisioningArtifactRequest& request) const;

  /**
   * A Callable wrapper for BatchAssociateServiceActionWithProvisioningArtifact that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename BatchAssociateServiceActionWithProvisioningArtifactRequestT =
                Model::BatchAssociateServiceActionWithProvisioningArtifactRequest>
  Model::BatchAssociateServiceActionWithProvisioningArtifactOutcomeCallable BatchAssociateServiceActionWithProvisioningArtifactCallable(
      const BatchAssociateServiceActionWithProvisioningArtifactRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::BatchAssociateServiceActionWithProvisioningArtifact, request);
  }

  /**
   * An Async wrapper for BatchAssociateServiceActionWithProvisioningArtifact that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename BatchAssociateServiceActionWithProvisioningArtifactRequestT =
                Model::BatchAssociateServiceActionWithProvisioningArtifactRequest>
  void BatchAssociateServiceActionWithProvisioningArtifactAsync(
      const BatchAssociateServiceActionWithProvisioningArtifactRequestT& request,
      const BatchAssociateServiceActionWithProvisioningArtifactResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDisassociateServiceActionFromProvisioningArtifactOutcome BatchDisassociateServiceActionFromProvisioningArtifact(
      const Model::BatchDisassociateServiceActionFromProvisioningArtifactRequest& request) const;

  /**
   * A Callable wrapper for BatchDisassociateServiceActionFromProvisioningArtifact that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename BatchDisassociateServiceActionFromProvisioningArtifactRequestT =
                Model::BatchDisassociateServiceActionFromProvisioningArtifactRequest>
  Model::BatchDisassociateServiceActionFromProvisioningArtifactOutcomeCallable
  BatchDisassociateServiceActionFromProvisioningArtifactCallable(
      const BatchDisassociateServiceActionFromProvisioningArtifactRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::BatchDisassociateServiceActionFromProvisioningArtifact, request);
  }

  /**
   * An Async wrapper for BatchDisassociateServiceActionFromProvisioningArtifact that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename BatchDisassociateServiceActionFromProvisioningArtifactRequestT =
                Model::BatchDisassociateServiceActionFromProvisioningArtifactRequest>
  void BatchDisassociateServiceActionFromProvisioningArtifactAsync(
      const BatchDisassociateServiceActionFromProvisioningArtifactRequestT& request,
      const BatchDisassociateServiceActionFromProvisioningArtifactResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CopyProduct that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CopyProductRequestT = Model::CopyProductRequest>
  void CopyProductAsync(const CopyProductRequestT& request, const CopyProductResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateConstraint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateConstraint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateConstraintRequestT = Model::CreateConstraintRequest>
  void CreateConstraintAsync(const CreateConstraintRequestT& request, const CreateConstraintResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreatePortfolio that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreatePortfolioRequestT = Model::CreatePortfolioRequest>
  void CreatePortfolioAsync(const CreatePortfolioRequestT& request, const CreatePortfolioResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePortfolioShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePortfolioShare that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePortfolioShareRequestT = Model::CreatePortfolioShareRequest>
  void CreatePortfolioShareAsync(const CreatePortfolioShareRequestT& request, const CreatePortfolioShareResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateProduct that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateProductRequestT = Model::CreateProductRequest>
  void CreateProductAsync(const CreateProductRequestT& request, const CreateProductResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateProvisionedProductPlanOutcome CreateProvisionedProductPlan(
      const Model::CreateProvisionedProductPlanRequest& request) const;

  /**
   * A Callable wrapper for CreateProvisionedProductPlan that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateProvisionedProductPlanRequestT = Model::CreateProvisionedProductPlanRequest>
  Model::CreateProvisionedProductPlanOutcomeCallable CreateProvisionedProductPlanCallable(
      const CreateProvisionedProductPlanRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::CreateProvisionedProductPlan, request);
  }

  /**
   * An Async wrapper for CreateProvisionedProductPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProvisionedProductPlanRequestT = Model::CreateProvisionedProductPlanRequest>
  void CreateProvisionedProductPlanAsync(const CreateProvisionedProductPlanRequestT& request,
                                         const CreateProvisionedProductPlanResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateProvisioningArtifactOutcome CreateProvisioningArtifact(
      const Model::CreateProvisioningArtifactRequest& request) const;

  /**
   * A Callable wrapper for CreateProvisioningArtifact that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateProvisioningArtifactRequestT = Model::CreateProvisioningArtifactRequest>
  Model::CreateProvisioningArtifactOutcomeCallable CreateProvisioningArtifactCallable(
      const CreateProvisioningArtifactRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::CreateProvisioningArtifact, request);
  }

  /**
   * An Async wrapper for CreateProvisioningArtifact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProvisioningArtifactRequestT = Model::CreateProvisioningArtifactRequest>
  void CreateProvisioningArtifactAsync(const CreateProvisioningArtifactRequestT& request,
                                       const CreateProvisioningArtifactResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateServiceAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateServiceAction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateServiceActionRequestT = Model::CreateServiceActionRequest>
  void CreateServiceActionAsync(const CreateServiceActionRequestT& request, const CreateServiceActionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateTagOption that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateTagOptionRequestT = Model::CreateTagOptionRequest>
  void CreateTagOptionAsync(const CreateTagOptionRequestT& request, const CreateTagOptionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteConstraint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteConstraint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteConstraintRequestT = Model::DeleteConstraintRequest>
  void DeleteConstraintAsync(const DeleteConstraintRequestT& request, const DeleteConstraintResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeletePortfolio that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePortfolioRequestT = Model::DeletePortfolioRequest>
  void DeletePortfolioAsync(const DeletePortfolioRequestT& request, const DeletePortfolioResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePortfolioShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePortfolioShare that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePortfolioShareRequestT = Model::DeletePortfolioShareRequest>
  void DeletePortfolioShareAsync(const DeletePortfolioShareRequestT& request, const DeletePortfolioShareResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteProduct that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteProductRequestT = Model::DeleteProductRequest>
  void DeleteProductAsync(const DeleteProductRequestT& request, const DeleteProductResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteProvisionedProductPlanOutcome DeleteProvisionedProductPlan(
      const Model::DeleteProvisionedProductPlanRequest& request) const;

  /**
   * A Callable wrapper for DeleteProvisionedProductPlan that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteProvisionedProductPlanRequestT = Model::DeleteProvisionedProductPlanRequest>
  Model::DeleteProvisionedProductPlanOutcomeCallable DeleteProvisionedProductPlanCallable(
      const DeleteProvisionedProductPlanRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DeleteProvisionedProductPlan, request);
  }

  /**
   * An Async wrapper for DeleteProvisionedProductPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProvisionedProductPlanRequestT = Model::DeleteProvisionedProductPlanRequest>
  void DeleteProvisionedProductPlanAsync(const DeleteProvisionedProductPlanRequestT& request,
                                         const DeleteProvisionedProductPlanResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteProvisioningArtifactOutcome DeleteProvisioningArtifact(
      const Model::DeleteProvisioningArtifactRequest& request) const;

  /**
   * A Callable wrapper for DeleteProvisioningArtifact that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteProvisioningArtifactRequestT = Model::DeleteProvisioningArtifactRequest>
  Model::DeleteProvisioningArtifactOutcomeCallable DeleteProvisioningArtifactCallable(
      const DeleteProvisioningArtifactRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DeleteProvisioningArtifact, request);
  }

  /**
   * An Async wrapper for DeleteProvisioningArtifact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProvisioningArtifactRequestT = Model::DeleteProvisioningArtifactRequest>
  void DeleteProvisioningArtifactAsync(const DeleteProvisioningArtifactRequestT& request,
                                       const DeleteProvisioningArtifactResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteServiceAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteServiceAction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteServiceActionRequestT = Model::DeleteServiceActionRequest>
  void DeleteServiceActionAsync(const DeleteServiceActionRequestT& request, const DeleteServiceActionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteTagOption that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTagOptionRequestT = Model::DeleteTagOptionRequest>
  void DeleteTagOptionAsync(const DeleteTagOptionRequestT& request, const DeleteTagOptionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeConstraint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeConstraint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeConstraintRequestT = Model::DescribeConstraintRequest>
  void DescribeConstraintAsync(const DescribeConstraintRequestT& request, const DescribeConstraintResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeCopyProductStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeCopyProductStatusRequestT = Model::DescribeCopyProductStatusRequest>
  Model::DescribeCopyProductStatusOutcomeCallable DescribeCopyProductStatusCallable(
      const DescribeCopyProductStatusRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DescribeCopyProductStatus, request);
  }

  /**
   * An Async wrapper for DescribeCopyProductStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCopyProductStatusRequestT = Model::DescribeCopyProductStatusRequest>
  void DescribeCopyProductStatusAsync(const DescribeCopyProductStatusRequestT& request,
                                      const DescribeCopyProductStatusResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePortfolio that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePortfolio that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePortfolioRequestT = Model::DescribePortfolioRequest>
  void DescribePortfolioAsync(const DescribePortfolioRequestT& request, const DescribePortfolioResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribePortfolioShareStatusOutcome DescribePortfolioShareStatus(
      const Model::DescribePortfolioShareStatusRequest& request) const;

  /**
   * A Callable wrapper for DescribePortfolioShareStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribePortfolioShareStatusRequestT = Model::DescribePortfolioShareStatusRequest>
  Model::DescribePortfolioShareStatusOutcomeCallable DescribePortfolioShareStatusCallable(
      const DescribePortfolioShareStatusRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DescribePortfolioShareStatus, request);
  }

  /**
   * An Async wrapper for DescribePortfolioShareStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePortfolioShareStatusRequestT = Model::DescribePortfolioShareStatusRequest>
  void DescribePortfolioShareStatusAsync(const DescribePortfolioShareStatusRequestT& request,
                                         const DescribePortfolioShareStatusResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePortfolioShares that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePortfolioShares that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePortfolioSharesRequestT = Model::DescribePortfolioSharesRequest>
  void DescribePortfolioSharesAsync(const DescribePortfolioSharesRequestT& request,
                                    const DescribePortfolioSharesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeProduct that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeProductRequestT = Model::DescribeProductRequest>
  void DescribeProductAsync(const DescribeProductResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const DescribeProductRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeProductAsAdmin that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeProductAsAdmin that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProductAsAdminRequestT = Model::DescribeProductAsAdminRequest>
  void DescribeProductAsAdminAsync(const DescribeProductAsAdminResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribeProductAsAdminRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeProductView that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeProductView that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeProductViewRequestT = Model::DescribeProductViewRequest>
  void DescribeProductViewAsync(const DescribeProductViewRequestT& request, const DescribeProductViewResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeProvisionedProductOutcome DescribeProvisionedProduct(
      const Model::DescribeProvisionedProductRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeProvisionedProduct that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeProvisionedProductRequestT = Model::DescribeProvisionedProductRequest>
  Model::DescribeProvisionedProductOutcomeCallable DescribeProvisionedProductCallable(
      const DescribeProvisionedProductRequestT& request = {}) const {
    return SubmitCallable(&ServiceCatalogClient::DescribeProvisionedProduct, request);
  }

  /**
   * An Async wrapper for DescribeProvisionedProduct that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProvisionedProductRequestT = Model::DescribeProvisionedProductRequest>
  void DescribeProvisionedProductAsync(const DescribeProvisionedProductResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeProvisionedProductRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeProvisionedProductPlanOutcome DescribeProvisionedProductPlan(
      const Model::DescribeProvisionedProductPlanRequest& request) const;

  /**
   * A Callable wrapper for DescribeProvisionedProductPlan that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeProvisionedProductPlanRequestT = Model::DescribeProvisionedProductPlanRequest>
  Model::DescribeProvisionedProductPlanOutcomeCallable DescribeProvisionedProductPlanCallable(
      const DescribeProvisionedProductPlanRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DescribeProvisionedProductPlan, request);
  }

  /**
   * An Async wrapper for DescribeProvisionedProductPlan that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeProvisionedProductPlanRequestT = Model::DescribeProvisionedProductPlanRequest>
  void DescribeProvisionedProductPlanAsync(const DescribeProvisionedProductPlanRequestT& request,
                                           const DescribeProvisionedProductPlanResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeProvisioningArtifactOutcome DescribeProvisioningArtifact(
      const Model::DescribeProvisioningArtifactRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeProvisioningArtifact that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeProvisioningArtifactRequestT = Model::DescribeProvisioningArtifactRequest>
  Model::DescribeProvisioningArtifactOutcomeCallable DescribeProvisioningArtifactCallable(
      const DescribeProvisioningArtifactRequestT& request = {}) const {
    return SubmitCallable(&ServiceCatalogClient::DescribeProvisioningArtifact, request);
  }

  /**
   * An Async wrapper for DescribeProvisioningArtifact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProvisioningArtifactRequestT = Model::DescribeProvisioningArtifactRequest>
  void DescribeProvisioningArtifactAsync(const DescribeProvisioningArtifactResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeProvisioningArtifactRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeProvisioningParametersOutcome DescribeProvisioningParameters(
      const Model::DescribeProvisioningParametersRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeProvisioningParameters that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeProvisioningParametersRequestT = Model::DescribeProvisioningParametersRequest>
  Model::DescribeProvisioningParametersOutcomeCallable DescribeProvisioningParametersCallable(
      const DescribeProvisioningParametersRequestT& request = {}) const {
    return SubmitCallable(&ServiceCatalogClient::DescribeProvisioningParameters, request);
  }

  /**
   * An Async wrapper for DescribeProvisioningParameters that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeProvisioningParametersRequestT = Model::DescribeProvisioningParametersRequest>
  void DescribeProvisioningParametersAsync(const DescribeProvisioningParametersResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const DescribeProvisioningParametersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeRecord that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeRecordRequestT = Model::DescribeRecordRequest>
  void DescribeRecordAsync(const DescribeRecordRequestT& request, const DescribeRecordResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeServiceAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeServiceAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeServiceActionRequestT = Model::DescribeServiceActionRequest>
  void DescribeServiceActionAsync(const DescribeServiceActionRequestT& request, const DescribeServiceActionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeServiceActionExecutionParametersOutcome DescribeServiceActionExecutionParameters(
      const Model::DescribeServiceActionExecutionParametersRequest& request) const;

  /**
   * A Callable wrapper for DescribeServiceActionExecutionParameters that returns a future to the operation so that it can be executed in
  ...
  Model::DescribeServiceActionExecutionParametersOutcomeCallable DescribeServiceActionExecutionParametersCallable(
      const DescribeServiceActionExecutionParametersRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DescribeServiceActionExecutionParameters, request);
  }

  /**
   * An Async wrapper for DescribeServiceActionExecutionParameters that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeServiceActionExecutionParametersRequestT = Model::DescribeServiceActionExecutionParametersRequest>
  void DescribeServiceActionExecutionParametersAsync(
      const DescribeServiceActionExecutionParametersRequestT& request,
      const DescribeServiceActionExecutionParametersResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeTagOption that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTagOption that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeTagOptionRequestT = Model::DescribeTagOptionRequest>
  void DescribeTagOptionAsync(const DescribeTagOptionRequestT& request, const DescribeTagOptionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisableAWSOrganizationsAccessOutcome DisableAWSOrganizationsAccess(
      const Model::DisableAWSOrganizationsAccessRequest& request = {}) const;

  /**
   * A Callable wrapper for DisableAWSOrganizationsAccess that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisableAWSOrganizationsAccessRequestT = Model::DisableAWSOrganizationsAccessRequest>
  Model::DisableAWSOrganizationsAccessOutcomeCallable DisableAWSOrganizationsAccessCallable(
      const DisableAWSOrganizationsAccessRequestT& request = {}) const {
    return SubmitCallable(&ServiceCatalogClient::DisableAWSOrganizationsAccess, request);
  }

  /**
   * An Async wrapper for DisableAWSOrganizationsAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableAWSOrganizationsAccessRequestT = Model::DisableAWSOrganizationsAccessRequest>
  void DisableAWSOrganizationsAccessAsync(const DisableAWSOrganizationsAccessResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DisableAWSOrganizationsAccessRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateBudgetFromResourceOutcome DisassociateBudgetFromResource(
      const Model::DisassociateBudgetFromResourceRequest& request) const;

  /**
   * A Callable wrapper for DisassociateBudgetFromResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateBudgetFromResourceRequestT = Model::DisassociateBudgetFromResourceRequest>
  Model::DisassociateBudgetFromResourceOutcomeCallable DisassociateBudgetFromResourceCallable(
      const DisassociateBudgetFromResourceRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DisassociateBudgetFromResource, request);
  }

  /**
   * An Async wrapper for DisassociateBudgetFromResource that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateBudgetFromResourceRequestT = Model::DisassociateBudgetFromResourceRequest>
  void DisassociateBudgetFromResourceAsync(const DisassociateBudgetFromResourceRequestT& request,
                                           const DisassociateBudgetFromResourceResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisassociatePrincipalFromPortfolioOutcome DisassociatePrincipalFromPortfolio(
      const Model::DisassociatePrincipalFromPortfolioRequest& request) const;

  /**
   * A Callable wrapper for DisassociatePrincipalFromPortfolio that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociatePrincipalFromPortfolioRequestT = Model::DisassociatePrincipalFromPortfolioRequest>
  Model::DisassociatePrincipalFromPortfolioOutcomeCallable DisassociatePrincipalFromPortfolioCallable(
      const DisassociatePrincipalFromPortfolioRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DisassociatePrincipalFromPortfolio, request);
  }

  /**
   * An Async wrapper for DisassociatePrincipalFromPortfolio that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociatePrincipalFromPortfolioRequestT = Model::DisassociatePrincipalFromPortfolioRequest>
  void DisassociatePrincipalFromPortfolioAsync(const DisassociatePrincipalFromPortfolioRequestT& request,
                                               const DisassociatePrincipalFromPortfolioResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateProductFromPortfolioOutcome DisassociateProductFromPortfolio(
      const Model::DisassociateProductFromPortfolioRequest& request) const;

  /**
   * A Callable wrapper for DisassociateProductFromPortfolio that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateProductFromPortfolioRequestT = Model::DisassociateProductFromPortfolioRequest>
  Model::DisassociateProductFromPortfolioOutcomeCallable DisassociateProductFromPortfolioCallable(
      const DisassociateProductFromPortfolioRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DisassociateProductFromPortfolio, request);
  }

  /**
   * An Async wrapper for DisassociateProductFromPortfolio that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateProductFromPortfolioRequestT = Model::DisassociateProductFromPortfolioRequest>
  void DisassociateProductFromPortfolioAsync(const DisassociateProductFromPortfolioRequestT& request,
                                             const DisassociateProductFromPortfolioResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisassociateServiceActionFromProvisioningArtifactOutcome DisassociateServiceActionFromProvisioningArtifact(
      const Model::DisassociateServiceActionFromProvisioningArtifactRequest& request) const;

  /**
   * A Callable wrapper for DisassociateServiceActionFromProvisioningArtifact that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <
  ...
  Model::DisassociateServiceActionFromProvisioningArtifactOutcomeCallable DisassociateServiceActionFromProvisioningArtifactCallable(
      const DisassociateServiceActionFromProvisioningArtifactRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DisassociateServiceActionFromProvisioningArtifact, request);
  }

  /**
   * An Async wrapper for DisassociateServiceActionFromProvisioningArtifact that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <
      typename DisassociateServiceActionFromProvisioningArtifactRequestT = Model::DisassociateServiceActionFromProvisioningArtifactRequest>
  void DisassociateServiceActionFromProvisioningArtifactAsync(
      const DisassociateServiceActionFromProvisioningArtifactRequestT& request,
      const DisassociateServiceActionFromProvisioningArtifactResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateTagOptionFromResourceOutcome DisassociateTagOptionFromResource(
      const Model::DisassociateTagOptionFromResourceRequest& request) const;

  /**
   * A Callable wrapper for DisassociateTagOptionFromResource that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateTagOptionFromResourceRequestT = Model::DisassociateTagOptionFromResourceRequest>
  Model::DisassociateTagOptionFromResourceOutcomeCallable DisassociateTagOptionFromResourceCallable(
      const DisassociateTagOptionFromResourceRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::DisassociateTagOptionFromResource, request);
  }

  /**
   * An Async wrapper for DisassociateTagOptionFromResource that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateTagOptionFromResourceRequestT = Model::DisassociateTagOptionFromResourceRequest>
  void DisassociateTagOptionFromResourceAsync(const DisassociateTagOptionFromResourceRequestT& request,
                                              const DisassociateTagOptionFromResourceResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::EnableAWSOrganizationsAccessOutcome EnableAWSOrganizationsAccess(
      const Model::EnableAWSOrganizationsAccessRequest& request = {}) const;

  /**
   * A Callable wrapper for EnableAWSOrganizationsAccess that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename EnableAWSOrganizationsAccessRequestT = Model::EnableAWSOrganizationsAccessRequest>
  Model::EnableAWSOrganizationsAccessOutcomeCallable EnableAWSOrganizationsAccessCallable(
      const EnableAWSOrganizationsAccessRequestT& request = {}) const {
    return SubmitCallable(&ServiceCatalogClient::EnableAWSOrganizationsAccess, request);
  }

  /**
   * An Async wrapper for EnableAWSOrganizationsAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableAWSOrganizationsAccessRequestT = Model::EnableAWSOrganizationsAccessRequest>
  void EnableAWSOrganizationsAccessAsync(const EnableAWSOrganizationsAccessResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const EnableAWSOrganizationsAccessRequestT& request = {}) const {
  ...
  virtual Model::ExecuteProvisionedProductPlanOutcome ExecuteProvisionedProductPlan(
      const Model::ExecuteProvisionedProductPlanRequest& request) const;

  /**
   * A Callable wrapper for ExecuteProvisionedProductPlan that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ExecuteProvisionedProductPlanRequestT = Model::ExecuteProvisionedProductPlanRequest>
  Model::ExecuteProvisionedProductPlanOutcomeCallable ExecuteProvisionedProductPlanCallable(
      const ExecuteProvisionedProductPlanRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ExecuteProvisionedProductPlan, request);
  }

  /**
   * An Async wrapper for ExecuteProvisionedProductPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExecuteProvisionedProductPlanRequestT = Model::ExecuteProvisionedProductPlanRequest>
  void ExecuteProvisionedProductPlanAsync(const ExecuteProvisionedProductPlanRequestT& request,
                                          const ExecuteProvisionedProductPlanResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ExecuteProvisionedProductServiceActionOutcome ExecuteProvisionedProductServiceAction(
      const Model::ExecuteProvisionedProductServiceActionRequest& request) const;

  /**
   * A Callable wrapper for ExecuteProvisionedProductServiceAction that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ExecuteProvisionedProductServiceActionRequestT = Model::ExecuteProvisionedProductServiceActionRequest>
  Model::ExecuteProvisionedProductServiceActionOutcomeCallable ExecuteProvisionedProductServiceActionCallable(
      const ExecuteProvisionedProductServiceActionRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ExecuteProvisionedProductServiceAction, request);
  }

  /**
   * An Async wrapper for ExecuteProvisionedProductServiceAction that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ExecuteProvisionedProductServiceActionRequestT = Model::ExecuteProvisionedProductServiceActionRequest>
  void ExecuteProvisionedProductServiceActionAsync(const ExecuteProvisionedProductServiceActionRequestT& request,
                                                   const ExecuteProvisionedProductServiceActionResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAWSOrganizationsAccessStatusOutcome GetAWSOrganizationsAccessStatus(
      const Model::GetAWSOrganizationsAccessStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for GetAWSOrganizationsAccessStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetAWSOrganizationsAccessStatusRequestT = Model::GetAWSOrganizationsAccessStatusRequest>
  Model::GetAWSOrganizationsAccessStatusOutcomeCallable GetAWSOrganizationsAccessStatusCallable(
      const GetAWSOrganizationsAccessStatusRequestT& request = {}) const {
    return SubmitCallable(&ServiceCatalogClient::GetAWSOrganizationsAccessStatus, request);
  }

  /**
   * An Async wrapper for GetAWSOrganizationsAccessStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetAWSOrganizationsAccessStatusRequestT = Model::GetAWSOrganizationsAccessStatusRequest>
  void GetAWSOrganizationsAccessStatusAsync(const GetAWSOrganizationsAccessStatusResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const GetAWSOrganizationsAccessStatusRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetProvisionedProductOutputsOutcome GetProvisionedProductOutputs(
      const Model::GetProvisionedProductOutputsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetProvisionedProductOutputs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetProvisionedProductOutputsRequestT = Model::GetProvisionedProductOutputsRequest>
  Model::GetProvisionedProductOutputsOutcomeCallable GetProvisionedProductOutputsCallable(
      const GetProvisionedProductOutputsRequestT& request = {}) const {
    return SubmitCallable(&ServiceCatalogClient::GetProvisionedProductOutputs, request);
  }

  /**
   * An Async wrapper for GetProvisionedProductOutputs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetProvisionedProductOutputsRequestT = Model::GetProvisionedProductOutputsRequest>
  void GetProvisionedProductOutputsAsync(const GetProvisionedProductOutputsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const GetProvisionedProductOutputsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ImportAsProvisionedProductOutcome ImportAsProvisionedProduct(
      const Model::ImportAsProvisionedProductRequest& request) const;

  /**
   * A Callable wrapper for ImportAsProvisionedProduct that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ImportAsProvisionedProductRequestT = Model::ImportAsProvisionedProductRequest>
  Model::ImportAsProvisionedProductOutcomeCallable ImportAsProvisionedProductCallable(
      const ImportAsProvisionedProductRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ImportAsProvisionedProduct, request);
  }

  /**
   * An Async wrapper for ImportAsProvisionedProduct that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ImportAsProvisionedProductRequestT = Model::ImportAsProvisionedProductRequest>
  void ImportAsProvisionedProductAsync(const ImportAsProvisionedProductRequestT& request,
                                       const ImportAsProvisionedProductResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAcceptedPortfolioSharesOutcome ListAcceptedPortfolioShares(
      const Model::ListAcceptedPortfolioSharesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAcceptedPortfolioShares that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAcceptedPortfolioSharesRequestT = Model::ListAcceptedPortfolioSharesRequest>
  Model::ListAcceptedPortfolioSharesOutcomeCallable ListAcceptedPortfolioSharesCallable(
      const ListAcceptedPortfolioSharesRequestT& request = {}) const {
    return SubmitCallable(&ServiceCatalogClient::ListAcceptedPortfolioShares, request);
  }

  /**
   * An Async wrapper for ListAcceptedPortfolioShares that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAcceptedPortfolioSharesRequestT = Model::ListAcceptedPortfolioSharesRequest>
  void ListAcceptedPortfolioSharesAsync(const ListAcceptedPortfolioSharesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListAcceptedPortfolioSharesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListBudgetsForResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBudgetsForResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBudgetsForResourceRequestT = Model::ListBudgetsForResourceRequest>
  void ListBudgetsForResourceAsync(const ListBudgetsForResourceRequestT& request,
                                   const ListBudgetsForResourceResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConstraintsForPortfolioOutcome ListConstraintsForPortfolio(
      const Model::ListConstraintsForPortfolioRequest& request) const;

  /**
   * A Callable wrapper for ListConstraintsForPortfolio that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListConstraintsForPortfolioRequestT = Model::ListConstraintsForPortfolioRequest>
  Model::ListConstraintsForPortfolioOutcomeCallable ListConstraintsForPortfolioCallable(
      const ListConstraintsForPortfolioRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ListConstraintsForPortfolio, request);
  }

  /**
   * An Async wrapper for ListConstraintsForPortfolio that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConstraintsForPortfolioRequestT = Model::ListConstraintsForPortfolioRequest>
  void ListConstraintsForPortfolioAsync(const ListConstraintsForPortfolioRequestT& request,
                                        const ListConstraintsForPortfolioResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListLaunchPaths that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLaunchPathsRequestT = Model::ListLaunchPathsRequest>
  void ListLaunchPathsAsync(const ListLaunchPathsRequestT& request, const ListLaunchPathsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListOrganizationPortfolioAccessOutcome ListOrganizationPortfolioAccess(
      const Model::ListOrganizationPortfolioAccessRequest& request) const;

  /**
   * A Callable wrapper for ListOrganizationPortfolioAccess that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListOrganizationPortfolioAccessRequestT = Model::ListOrganizationPortfolioAccessRequest>
  Model::ListOrganizationPortfolioAccessOutcomeCallable ListOrganizationPortfolioAccessCallable(
      const ListOrganizationPortfolioAccessRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ListOrganizationPortfolioAccess, request);
  }

  /**
   * An Async wrapper for ListOrganizationPortfolioAccess that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListOrganizationPortfolioAccessRequestT = Model::ListOrganizationPortfolioAccessRequest>
  void ListOrganizationPortfolioAccessAsync(const ListOrganizationPortfolioAccessRequestT& request,
                                            const ListOrganizationPortfolioAccessResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPortfolioAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPortfolioAccess that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPortfolioAccessRequestT = Model::ListPortfolioAccessRequest>
  void ListPortfolioAccessAsync(const ListPortfolioAccessRequestT& request, const ListPortfolioAccessResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListPortfolios that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPortfoliosRequestT = Model::ListPortfoliosRequest>
  void ListPortfoliosAsync(const ListPortfoliosResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListPortfoliosRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPortfoliosForProduct that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPortfoliosForProduct that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPortfoliosForProductRequestT = Model::ListPortfoliosForProductRequest>
  void ListPortfoliosForProductAsync(const ListPortfoliosForProductRequestT& request,
                                     const ListPortfoliosForProductResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPrincipalsForPortfolioOutcome ListPrincipalsForPortfolio(
      const Model::ListPrincipalsForPortfolioRequest& request) const;

  /**
   * A Callable wrapper for ListPrincipalsForPortfolio that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPrincipalsForPortfolioRequestT = Model::ListPrincipalsForPortfolioRequest>
  Model::ListPrincipalsForPortfolioOutcomeCallable ListPrincipalsForPortfolioCallable(
      const ListPrincipalsForPortfolioRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ListPrincipalsForPortfolio, request);
  }

  /**
   * An Async wrapper for ListPrincipalsForPortfolio that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPrincipalsForPortfolioRequestT = Model::ListPrincipalsForPortfolioRequest>
  void ListPrincipalsForPortfolioAsync(const ListPrincipalsForPortfolioRequestT& request,
                                       const ListPrincipalsForPortfolioResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListProvisionedProductPlansOutcome ListProvisionedProductPlans(
      const Model::ListProvisionedProductPlansRequest& request = {}) const;

  /**
   * A Callable wrapper for ListProvisionedProductPlans that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListProvisionedProductPlansRequestT = Model::ListProvisionedProductPlansRequest>
  Model::ListProvisionedProductPlansOutcomeCallable ListProvisionedProductPlansCallable(
      const ListProvisionedProductPlansRequestT& request = {}) const {
    return SubmitCallable(&ServiceCatalogClient::ListProvisionedProductPlans, request);
  }

  /**
   * An Async wrapper for ListProvisionedProductPlans that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProvisionedProductPlansRequestT = Model::ListProvisionedProductPlansRequest>
  void ListProvisionedProductPlansAsync(const ListProvisionedProductPlansResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListProvisionedProductPlansRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProvisioningArtifacts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListProvisioningArtifactsRequestT = Model::ListProvisioningArtifactsRequest>
  Model::ListProvisioningArtifactsOutcomeCallable ListProvisioningArtifactsCallable(
      const ListProvisioningArtifactsRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ListProvisioningArtifacts, request);
  }

  /**
   * An Async wrapper for ListProvisioningArtifacts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProvisioningArtifactsRequestT = Model::ListProvisioningArtifactsRequest>
  void ListProvisioningArtifactsAsync(const ListProvisioningArtifactsRequestT& request,
                                      const ListProvisioningArtifactsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListProvisioningArtifactsForServiceActionOutcome ListProvisioningArtifactsForServiceAction(
      const Model::ListProvisioningArtifactsForServiceActionRequest& request) const;

  /**
   * A Callable wrapper for ListProvisioningArtifactsForServiceAction that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListProvisioningArtifactsForServiceActionOutcomeCallable ListProvisioningArtifactsForServiceActionCallable(
      const ListProvisioningArtifactsForServiceActionRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ListProvisioningArtifactsForServiceAction, request);
  }

  /**
   * An Async wrapper for ListProvisioningArtifactsForServiceAction that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListProvisioningArtifactsForServiceActionRequestT = Model::ListProvisioningArtifactsForServiceActionRequest>
  void ListProvisioningArtifactsForServiceActionAsync(
      const ListProvisioningArtifactsForServiceActionRequestT& request,
      const ListProvisioningArtifactsForServiceActionResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRecordHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRecordHistory that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRecordHistoryRequestT = Model::ListRecordHistoryRequest>
  void ListRecordHistoryAsync(const ListRecordHistoryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListRecordHistoryRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListResourcesForTagOption that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListResourcesForTagOptionRequestT = Model::ListResourcesForTagOptionRequest>
  Model::ListResourcesForTagOptionOutcomeCallable ListResourcesForTagOptionCallable(
      const ListResourcesForTagOptionRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ListResourcesForTagOption, request);
  }

  /**
   * An Async wrapper for ListResourcesForTagOption that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourcesForTagOptionRequestT = Model::ListResourcesForTagOptionRequest>
  void ListResourcesForTagOptionAsync(const ListResourcesForTagOptionRequestT& request,
                                      const ListResourcesForTagOptionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListServiceActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServiceActions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListServiceActionsRequestT = Model::ListServiceActionsRequest>
  void ListServiceActionsAsync(const ListServiceActionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListServiceActionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListServiceActionsForProvisioningArtifactOutcome ListServiceActionsForProvisioningArtifact(
      const Model::ListServiceActionsForProvisioningArtifactRequest& request) const;

  /**
   * A Callable wrapper for ListServiceActionsForProvisioningArtifact that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListServiceActionsForProvisioningArtifactOutcomeCallable ListServiceActionsForProvisioningArtifactCallable(
      const ListServiceActionsForProvisioningArtifactRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ListServiceActionsForProvisioningArtifact, request);
  }

  /**
   * An Async wrapper for ListServiceActionsForProvisioningArtifact that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListServiceActionsForProvisioningArtifactRequestT = Model::ListServiceActionsForProvisioningArtifactRequest>
  void ListServiceActionsForProvisioningArtifactAsync(
      const ListServiceActionsForProvisioningArtifactRequestT& request,
      const ListServiceActionsForProvisioningArtifactResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListStackInstancesForProvisionedProductOutcome ListStackInstancesForProvisionedProduct(
      const Model::ListStackInstancesForProvisionedProductRequest& request) const;

  /**
   * A Callable wrapper for ListStackInstancesForProvisionedProduct that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListStackInstancesForProvisionedProductRequestT = Model::ListStackInstancesForProvisionedProductRequest>
  Model::ListStackInstancesForProvisionedProductOutcomeCallable ListStackInstancesForProvisionedProductCallable(
      const ListStackInstancesForProvisionedProductRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::ListStackInstancesForProvisionedProduct, request);
  }

  /**
   * An Async wrapper for ListStackInstancesForProvisionedProduct that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListStackInstancesForProvisionedProductRequestT = Model::ListStackInstancesForProvisionedProductRequest>
  void ListStackInstancesForProvisionedProductAsync(const ListStackInstancesForProvisionedProductRequestT& request,
                                                    const ListStackInstancesForProvisionedProductResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListTagOptions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListTagOptionsRequestT = Model::ListTagOptionsRequest>
  void ListTagOptionsAsync(const ListTagOptionsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListTagOptionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::NotifyProvisionProductEngineWorkflowResultOutcome NotifyProvisionProductEngineWorkflowResult(
      const Model::NotifyProvisionProductEngineWorkflowResultRequest& request) const;

  /**
   * A Callable wrapper for NotifyProvisionProductEngineWorkflowResult that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::NotifyProvisionProductEngineWorkflowResultOutcomeCallable NotifyProvisionProductEngineWorkflowResultCallable(
      const NotifyProvisionProductEngineWorkflowResultRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::NotifyProvisionProductEngineWorkflowResult, request);
  }

  /**
   * An Async wrapper for NotifyProvisionProductEngineWorkflowResult that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename NotifyProvisionProductEngineWorkflowResultRequestT = Model::NotifyProvisionProductEngineWorkflowResultRequest>
  void NotifyProvisionProductEngineWorkflowResultAsync(
      const NotifyProvisionProductEngineWorkflowResultRequestT& request,
      const NotifyProvisionProductEngineWorkflowResultResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::NotifyTerminateProvisionedProductEngineWorkflowResultOutcome NotifyTerminateProvisionedProductEngineWorkflowResult(
      const Model::NotifyTerminateProvisionedProductEngineWorkflowResultRequest& request) const;

  /**
   * A Callable wrapper for NotifyTerminateProvisionedProductEngineWorkflowResult that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename NotifyTerminateProvisionedProductEngineWorkflowResultRequestT =
                Model::NotifyTerminateProvisionedProductEngineWorkflowResultRequest>
  Model::NotifyTerminateProvisionedProductEngineWorkflowResultOutcomeCallable NotifyTerminateProvisionedProductEngineWorkflowResultCallable(
      const NotifyTerminateProvisionedProductEngineWorkflowResultRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::NotifyTerminateProvisionedProductEngineWorkflowResult, request);
  }

  /**
   * An Async wrapper for NotifyTerminateProvisionedProductEngineWorkflowResult that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename NotifyTerminateProvisionedProductEngineWorkflowResultRequestT =
                Model::NotifyTerminateProvisionedProductEngineWorkflowResultRequest>
  void NotifyTerminateProvisionedProductEngineWorkflowResultAsync(
      const NotifyTerminateProvisionedProductEngineWorkflowResultRequestT& request,
      const NotifyTerminateProvisionedProductEngineWorkflowResultResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::NotifyUpdateProvisionedProductEngineWorkflowResultOutcome NotifyUpdateProvisionedProductEngineWorkflowResult(
      const Model::NotifyUpdateProvisionedProductEngineWorkflowResultRequest& request) const;

  /**
   * A Callable wrapper for NotifyUpdateProvisionedProductEngineWorkflowResult that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename NotifyUpdateProvisionedProductEngineWorkflowResultRequestT =
                Model::NotifyUpdateProvisionedProductEngineWorkflowResultRequest>
  Model::NotifyUpdateProvisionedProductEngineWorkflowResultOutcomeCallable NotifyUpdateProvisionedProductEngineWorkflowResultCallable(
      const NotifyUpdateProvisionedProductEngineWorkflowResultRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::NotifyUpdateProvisionedProductEngineWorkflowResult, request);
  }

  /**
   * An Async wrapper for NotifyUpdateProvisionedProductEngineWorkflowResult that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename NotifyUpdateProvisionedProductEngineWorkflowResultRequestT =
                Model::NotifyUpdateProvisionedProductEngineWorkflowResultRequest>
  void NotifyUpdateProvisionedProductEngineWorkflowResultAsync(
      const NotifyUpdateProvisionedProductEngineWorkflowResultRequestT& request,
      const NotifyUpdateProvisionedProductEngineWorkflowResultResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ProvisionProduct that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ProvisionProduct that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ProvisionProductRequestT = Model::ProvisionProductRequest>
  void ProvisionProductAsync(const ProvisionProductRequestT& request, const ProvisionProductResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RejectPortfolioShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RejectPortfolioShare that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RejectPortfolioShareRequestT = Model::RejectPortfolioShareRequest>
  void RejectPortfolioShareAsync(const RejectPortfolioShareRequestT& request, const RejectPortfolioShareResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ScanProvisionedProducts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ScanProvisionedProducts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ScanProvisionedProductsRequestT = Model::ScanProvisionedProductsRequest>
  void ScanProvisionedProductsAsync(const ScanProvisionedProductsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ScanProvisionedProductsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for SearchProducts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchProductsRequestT = Model::SearchProductsRequest>
  void SearchProductsAsync(const SearchProductsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const SearchProductsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for SearchProductsAsAdmin that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchProductsAsAdmin that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchProductsAsAdminRequestT = Model::SearchProductsAsAdminRequest>
  void SearchProductsAsAdminAsync(const SearchProductsAsAdminResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const SearchProductsAsAdminRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SearchProvisionedProductsOutcome SearchProvisionedProducts(
      const Model::SearchProvisionedProductsRequest& request = {}) const;

  /**
   * A Callable wrapper for SearchProvisionedProducts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SearchProvisionedProductsRequestT = Model::SearchProvisionedProductsRequest>
  Model::SearchProvisionedProductsOutcomeCallable SearchProvisionedProductsCallable(
      const SearchProvisionedProductsRequestT& request = {}) const {
    return SubmitCallable(&ServiceCatalogClient::SearchProvisionedProducts, request);
  }

  /**
   * An Async wrapper for SearchProvisionedProducts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchProvisionedProductsRequestT = Model::SearchProvisionedProductsRequest>
  void SearchProvisionedProductsAsync(const SearchProvisionedProductsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const SearchProvisionedProductsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::TerminateProvisionedProductOutcome TerminateProvisionedProduct(
      const Model::TerminateProvisionedProductRequest& request) const;

  /**
   * A Callable wrapper for TerminateProvisionedProduct that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename TerminateProvisionedProductRequestT = Model::TerminateProvisionedProductRequest>
  Model::TerminateProvisionedProductOutcomeCallable TerminateProvisionedProductCallable(
      const TerminateProvisionedProductRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::TerminateProvisionedProduct, request);
  }

  /**
   * An Async wrapper for TerminateProvisionedProduct that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TerminateProvisionedProductRequestT = Model::TerminateProvisionedProductRequest>
  void TerminateProvisionedProductAsync(const TerminateProvisionedProductRequestT& request,
                                        const TerminateProvisionedProductResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateConstraint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateConstraint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateConstraintRequestT = Model::UpdateConstraintRequest>
  void UpdateConstraintAsync(const UpdateConstraintRequestT& request, const UpdateConstraintResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdatePortfolio that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdatePortfolioRequestT = Model::UpdatePortfolioRequest>
  void UpdatePortfolioAsync(const UpdatePortfolioRequestT& request, const UpdatePortfolioResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePortfolioShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePortfolioShare that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePortfolioShareRequestT = Model::UpdatePortfolioShareRequest>
  void UpdatePortfolioShareAsync(const UpdatePortfolioShareRequestT& request, const UpdatePortfolioShareResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateProduct that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateProductRequestT = Model::UpdateProductRequest>
  void UpdateProductAsync(const UpdateProductRequestT& request, const UpdateProductResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateProvisionedProduct that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateProvisionedProduct that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateProvisionedProductRequestT = Model::UpdateProvisionedProductRequest>
  void UpdateProvisionedProductAsync(const UpdateProvisionedProductRequestT& request,
                                     const UpdateProvisionedProductResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateProvisionedProductPropertiesOutcome UpdateProvisionedProductProperties(
      const Model::UpdateProvisionedProductPropertiesRequest& request) const;

  /**
   * A Callable wrapper for UpdateProvisionedProductProperties that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateProvisionedProductPropertiesRequestT = Model::UpdateProvisionedProductPropertiesRequest>
  Model::UpdateProvisionedProductPropertiesOutcomeCallable UpdateProvisionedProductPropertiesCallable(
      const UpdateProvisionedProductPropertiesRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::UpdateProvisionedProductProperties, request);
  }

  /**
   * An Async wrapper for UpdateProvisionedProductProperties that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateProvisionedProductPropertiesRequestT = Model::UpdateProvisionedProductPropertiesRequest>
  void UpdateProvisionedProductPropertiesAsync(const UpdateProvisionedProductPropertiesRequestT& request,
                                               const UpdateProvisionedProductPropertiesResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateProvisioningArtifactOutcome UpdateProvisioningArtifact(
      const Model::UpdateProvisioningArtifactRequest& request) const;

  /**
   * A Callable wrapper for UpdateProvisioningArtifact that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateProvisioningArtifactRequestT = Model::UpdateProvisioningArtifactRequest>
  Model::UpdateProvisioningArtifactOutcomeCallable UpdateProvisioningArtifactCallable(
      const UpdateProvisioningArtifactRequestT& request) const {
    return SubmitCallable(&ServiceCatalogClient::UpdateProvisioningArtifact, request);
  }

  /**
   * An Async wrapper for UpdateProvisioningArtifact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateProvisioningArtifactRequestT = Model::UpdateProvisioningArtifactRequest>
  void UpdateProvisioningArtifactAsync(const UpdateProvisioningArtifactRequestT& request,
                                       const UpdateProvisioningArtifactResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateServiceAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateServiceAction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateServiceActionRequestT = Model::UpdateServiceActionRequest>
  void UpdateServiceActionAsync(const UpdateServiceActionRequestT& request, const UpdateServiceActionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateTagOption that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateTagOptionRequestT = Model::UpdateTagOptionRequest>
  void UpdateTagOptionAsync(const UpdateTagOptionRequestT& request, const UpdateTagOptionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
