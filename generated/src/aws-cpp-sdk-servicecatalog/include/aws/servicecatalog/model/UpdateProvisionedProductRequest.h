...
class UpdateProvisionedProductRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  UpdateProvisionedProductRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ProvisionedProductNameT = Aws::String>
  UpdateProvisionedProductRequest& WithProvisionedProductName(ProvisionedProductNameT&& value) {
  ...
  template <typename ProvisionedProductIdT = Aws::String>
  UpdateProvisionedProductRequest& WithProvisionedProductId(ProvisionedProductIdT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  UpdateProvisionedProductRequest& WithProductId(ProductIdT&& value) {
  ...
  template <typename ProductNameT = Aws::String>
  UpdateProvisionedProductRequest& WithProductName(ProductNameT&& value) {
  ...
  template <typename ProvisioningArtifactIdT = Aws::String>
  UpdateProvisionedProductRequest& WithProvisioningArtifactId(ProvisioningArtifactIdT&& value) {
  ...
  template <typename ProvisioningArtifactNameT = Aws::String>
  UpdateProvisionedProductRequest& WithProvisioningArtifactName(ProvisioningArtifactNameT&& value) {
  ...
  template <typename PathIdT = Aws::String>
  UpdateProvisionedProductRequest& WithPathId(PathIdT&& value) {
  ...
  template <typename PathNameT = Aws::String>
  UpdateProvisionedProductRequest& WithPathName(PathNameT&& value) {
  ...
  template <typename ProvisioningParametersT = Aws::Vector<UpdateProvisioningParameter>>
  UpdateProvisionedProductRequest& WithProvisioningParameters(ProvisioningParametersT&& value) {
  ...
  UpdateProvisionedProductRequest& AddProvisioningParameters(ProvisioningParametersT&& value) {
    m_provisioningParametersHasBeenSet = true;
  ...
  void SetProvisioningPreferences(ProvisioningPreferencesT&& value) {
    m_provisioningPreferencesHasBeenSet = true;
    m_provisioningPreferences = std::forward<ProvisioningPreferencesT>(value);
  }
  template <typename ProvisioningPreferencesT = UpdateProvisioningPreferences>
  UpdateProvisionedProductRequest& WithProvisioningPreferences(ProvisioningPreferencesT&& value) {
    SetProvisioningPreferences(std::forward<ProvisioningPreferencesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  UpdateProvisionedProductRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  UpdateProvisionedProductRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateProvisionedProductRequest& WithUpdateToken(UpdateTokenT&& value) {
