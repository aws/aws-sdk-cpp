...
class NotifyTerminateProvisionedProductEngineWorkflowResultRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename WorkflowTokenT = Aws::String>
  NotifyTerminateProvisionedProductEngineWorkflowResultRequest& WithWorkflowToken(WorkflowTokenT&& value) {
  ...
  template <typename RecordIdT = Aws::String>
  NotifyTerminateProvisionedProductEngineWorkflowResultRequest& WithRecordId(RecordIdT&& value) {
  ...
  inline NotifyTerminateProvisionedProductEngineWorkflowResultRequest& WithStatus(EngineWorkflowStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureReasonT = Aws::String>
  NotifyTerminateProvisionedProductEngineWorkflowResultRequest& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename IdempotencyTokenT = Aws::String>
  NotifyTerminateProvisionedProductEngineWorkflowResultRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
