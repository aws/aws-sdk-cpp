...
class ListProvisionedProductPlansRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListProvisionedProductPlansRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ProvisionProductIdT = Aws::String>
  ListProvisionedProductPlansRequest& WithProvisionProductId(ProvisionProductIdT&& value) {
  ...
  inline ListProvisionedProductPlansRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListProvisionedProductPlansRequest& WithPageToken(PageTokenT&& value) {
  ...
  template <typename AccessLevelFilterT = AccessLevelFilter>
  ListProvisionedProductPlansRequest& WithAccessLevelFilter(AccessLevelFilterT&& value) {
