...
class ListServiceActionsForProvisioningArtifactResult {
 public:
  ...
  AWS_SERVICECATALOG_API ListServiceActionsForProvisioningArtifactResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetServiceActionSummaries(ServiceActionSummariesT&& value) {
    m_serviceActionSummariesHasBeenSet = true;
    m_serviceActionSummaries = std::forward<ServiceActionSummariesT>(value);
  }
  template <typename ServiceActionSummariesT = Aws::Vector<ServiceActionSummary>>
  ListServiceActionsForProvisioningArtifactResult& WithServiceActionSummaries(ServiceActionSummariesT&& value) {
    SetServiceActionSummaries(std::forward<ServiceActionSummariesT>(value));
    return *this;
  }
  template <typename ServiceActionSummariesT = ServiceActionSummary>
  ListServiceActionsForProvisioningArtifactResult& AddServiceActionSummaries(ServiceActionSummariesT&& value) {
    m_serviceActionSummariesHasBeenSet = true;
    m_serviceActionSummaries.emplace_back(std::forward<ServiceActionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListServiceActionsForProvisioningArtifactResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServiceActionsForProvisioningArtifactResult& WithRequestId(RequestIdT&& value) {
