...
class ProvisioningArtifactDetail {
 public:
  ...
  inline ProvisioningArtifactDetail& WithType(ProvisioningArtifactType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline ProvisioningArtifactDetail& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  inline ProvisioningArtifactDetail& WithGuidance(ProvisioningArtifactGuidance value) {
    SetGuidance(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceRevision(SourceRevisionT&& value) {
    ...
    m_sourceRevision = std::forward<SourceRevisionT>(value);
  }
  template <typename SourceRevisionT = Aws::String>
  ProvisioningArtifactDetail& WithSourceRevision(SourceRevisionT&& value) {
    SetSourceRevision(std::forward<SourceRevisionT>(value));
    return *this;
  }
  ///@}
 private:
