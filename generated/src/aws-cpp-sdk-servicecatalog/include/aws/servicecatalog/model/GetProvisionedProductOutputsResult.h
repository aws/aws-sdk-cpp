...
class GetProvisionedProductOutputsResult {
 public:
  ...
  AWS_SERVICECATALOG_API GetProvisionedProductOutputsResult& operator=(
  ...
  template <typename OutputsT = Aws::Vector<RecordOutput>>
  GetProvisionedProductOutputsResult& WithOutputs(OutputsT&& value) {
    SetOutputs(std::forward<OutputsT>(value));
    return *this;
  }
  template <typename OutputsT = RecordOutput>
  GetProvisionedProductOutputsResult& AddOutputs(OutputsT&& value) {
    m_outputsHasBeenSet = true;
  ...
  template <typename NextPageTokenT = Aws::String>
  GetProvisionedProductOutputsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetProvisionedProductOutputsResult& WithRequestId(RequestIdT&& value) {
