...
class BatchAssociateServiceActionWithProvisioningArtifactRequest : public ServiceCatalogRequest {
 public:
  ...
  void SetServiceActionAssociations(ServiceActionAssociationsT&& value) {
    m_serviceActionAssociationsHasBeenSet = true;
    m_serviceActionAssociations = std::forward<ServiceActionAssociationsT>(value);
  }
  template <typename ServiceActionAssociationsT = Aws::Vector<ServiceActionAssociation>>
  BatchAssociateServiceActionWithProvisioningArtifactRequest& WithServiceActionAssociations(ServiceActionAssociationsT&& value) {
    SetServiceActionAssociations(std::forward<ServiceActionAssociationsT>(value));
    return *this;
  }
  template <typename ServiceActionAssociationsT = ServiceActionAssociation>
  BatchAssociateServiceActionWithProvisioningArtifactRequest& AddServiceActionAssociations(ServiceActionAssociationsT&& value) {
    m_serviceActionAssociationsHasBeenSet = true;
    m_serviceActionAssociations.emplace_back(std::forward<ServiceActionAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AcceptLanguageT = Aws::String>
  BatchAssociateServiceActionWithProvisioningArtifactRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
