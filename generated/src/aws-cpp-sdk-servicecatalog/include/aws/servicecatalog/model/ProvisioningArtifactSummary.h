...
class ProvisioningArtifactSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  ProvisioningArtifactSummary& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  ProvisioningArtifactSummary& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ProvisioningArtifactSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  ProvisioningArtifactSummary& WithCreatedTime(CreatedTimeT&& value) {
  ...
  void SetProvisioningArtifactMetadata(ProvisioningArtifactMetadataT&& value) {
    m_provisioningArtifactMetadataHasBeenSet = true;
    m_provisioningArtifactMetadata = std::forward<ProvisioningArtifactMetadataT>(value);
  }
  template <typename ProvisioningArtifactMetadataT = Aws::Map<Aws::String, Aws::String>>
  ProvisioningArtifactSummary& WithProvisioningArtifactMetadata(ProvisioningArtifactMetadataT&& value) {
    SetProvisioningArtifactMetadata(std::forward<ProvisioningArtifactMetadataT>(value));
    return *this;
  }
  template <typename ProvisioningArtifactMetadataKeyT = Aws::String, typename ProvisioningArtifactMetadataValueT = Aws::String>
  ProvisioningArtifactSummary& AddProvisioningArtifactMetadata(ProvisioningArtifactMetadataKeyT&& key,
                                                               ProvisioningArtifactMetadataValueT&& value) {
    m_provisioningArtifactMetadataHasBeenSet = true;
    m_provisioningArtifactMetadata.emplace(std::forward<ProvisioningArtifactMetadataKeyT>(key),
                                           std::forward<ProvisioningArtifactMetadataValueT>(value));
    return *this;
  }
  ///@}
 private:
