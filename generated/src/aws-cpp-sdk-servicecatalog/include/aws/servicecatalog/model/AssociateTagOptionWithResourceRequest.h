...
namespace Model
{
  ...
  public:
    ...
    template<typename ResourceIdT = Aws::String>
    AssociateTagOptionWithResourceRequest& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TagOptionIdT = Aws::String>
    AssociateTagOptionWithResourceRequest& WithTagOptionId(TagOptionIdT&& value) { SetTagOptionId(std::forward<TagOptionIdT>(value)); return *this;}
    ///@}
  private:
