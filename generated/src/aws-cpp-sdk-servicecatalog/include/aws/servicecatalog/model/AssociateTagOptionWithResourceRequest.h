...
class AssociateTagOptionWithResourceRequest : public ServiceCatalogRequest {
 public:
  AWS_SERVICECATALOG_API AssociateTagOptionWithResourceRequest() = default;
  ...
  template <typename ResourceIdT = Aws::String>
  AssociateTagOptionWithResourceRequest& WithResourceId(ResourceIdT&& value) {
  ...
  void SetTagOptionId(TagOptionIdT&& value) {
    m_tagOptionIdHasBeenSet = true;
    m_tagOptionId = std::forward<TagOptionIdT>(value);
  }
  template <typename TagOptionIdT = Aws::String>
  AssociateTagOptionWithResourceRequest& WithTagOptionId(TagOptionIdT&& value) {
    SetTagOptionId(std::forward<TagOptionIdT>(value));
    return *this;
  }
  ///@}
 private:
