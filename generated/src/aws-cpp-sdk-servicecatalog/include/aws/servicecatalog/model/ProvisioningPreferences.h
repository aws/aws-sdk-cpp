...
class ProvisioningPreferences {
 public:
  ...
  inline ProvisioningPreferences& WithStackSetFailureToleranceCount(int value) {
  ...
  inline ProvisioningPreferences& WithStackSetFailureTolerancePercentage(int value) {
  ...
  inline ProvisioningPreferences& WithStackSetMaxConcurrencyCount(int value) {
  ...
  inline ProvisioningPreferences& WithStackSetMaxConcurrencyPercentage(int value) {
