...
class ListAcceptedPortfolioSharesRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListAcceptedPortfolioSharesRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename PageTokenT = Aws::String>
  ListAcceptedPortfolioSharesRequest& WithPageToken(PageTokenT&& value) {
  ...
  inline ListAcceptedPortfolioSharesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  inline ListAcceptedPortfolioSharesRequest& WithPortfolioShareType(PortfolioShareType value) {
