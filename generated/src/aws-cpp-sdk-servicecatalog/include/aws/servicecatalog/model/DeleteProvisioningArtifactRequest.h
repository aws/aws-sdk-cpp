...
class DeleteProvisioningArtifactRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  DeleteProvisioningArtifactRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  DeleteProvisioningArtifactRequest& WithProductId(ProductIdT&& value) {
  ...
  template <typename ProvisioningArtifactIdT = Aws::String>
  DeleteProvisioningArtifactRequest& WithProvisioningArtifactId(ProvisioningArtifactIdT&& value) {
