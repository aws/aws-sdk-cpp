...
class DescribeProductViewResult {
 public:
  ...
  template <typename ProductViewSummaryT = ProductViewSummary>
  DescribeProductViewResult& WithProductViewSummary(ProductViewSummaryT&& value) {
  ...
  template <typename ProvisioningArtifactsT = Aws::Vector<ProvisioningArtifact>>
  DescribeProductViewResult& WithProvisioningArtifacts(ProvisioningArtifactsT&& value) {
  ...
  DescribeProductViewResult& AddProvisioningArtifacts(ProvisioningArtifactsT&& value) {
    m_provisioningArtifactsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeProductViewResult& WithRequestId(RequestIdT&& value) {
