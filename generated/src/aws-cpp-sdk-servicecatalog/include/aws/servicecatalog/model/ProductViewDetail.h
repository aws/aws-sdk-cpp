...
class ProductViewDetail {
 public:
  ...
  template <typename ProductViewSummaryT = ProductViewSummary>
  ProductViewDetail& WithProductViewSummary(ProductViewSummaryT&& value) {
  ...
  inline ProductViewDetail& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProductARNT = Aws::String>
  ProductViewDetail& WithProductARN(ProductARNT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  ProductViewDetail& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename SourceConnectionT = SourceConnectionDetail>
  ProductViewDetail& WithSourceConnection(SourceConnectionT&& value) {
