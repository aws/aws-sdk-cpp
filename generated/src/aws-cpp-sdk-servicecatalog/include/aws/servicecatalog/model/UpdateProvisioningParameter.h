...
class UpdateProvisioningParameter {
 public:
  ...
  template <typename KeyT = Aws::String>
  UpdateProvisioningParameter& WithKey(KeyT&& value) {
  ...
  template <typename ValueT = Aws::String>
  UpdateProvisioningParameter& WithValue(ValueT&& value) {
  ...
  inline UpdateProvisioningParameter& WithUsePreviousValue(bool value) {
