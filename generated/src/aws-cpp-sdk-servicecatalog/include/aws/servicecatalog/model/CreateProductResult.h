...
class CreateProductResult {
 public:
  ...
  template <typename ProductViewDetailT = ProductViewDetail>
  CreateProductResult& WithProductViewDetail(ProductViewDetailT&& value) {
  ...
  template <typename ProvisioningArtifactDetailT = ProvisioningArtifactDetail>
  CreateProductResult& WithProvisioningArtifactDetail(ProvisioningArtifactDetailT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateProductResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateProductResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateProductResult& WithRequestId(RequestIdT&& value) {
