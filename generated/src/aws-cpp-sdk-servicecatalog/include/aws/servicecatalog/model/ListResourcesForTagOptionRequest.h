...
class ListResourcesForTagOptionRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename TagOptionIdT = Aws::String>
  ListResourcesForTagOptionRequest& WithTagOptionId(TagOptionIdT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  ListResourcesForTagOptionRequest& WithResourceType(ResourceTypeT&& value) {
  ...
  inline ListResourcesForTagOptionRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListResourcesForTagOptionRequest& WithPageToken(PageTokenT&& value) {
