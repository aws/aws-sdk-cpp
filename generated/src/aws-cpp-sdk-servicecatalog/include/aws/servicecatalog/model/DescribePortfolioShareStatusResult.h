...
class DescribePortfolioShareStatusResult {
 public:
  ...
  AWS_SERVICECATALOG_API DescribePortfolioShareStatusResult& operator=(
  ...
  void SetPortfolioShareToken(PortfolioShareTokenT&& value) {
    m_portfolioShareTokenHasBeenSet = true;
    m_portfolioShareToken = std::forward<PortfolioShareTokenT>(value);
  }
  template <typename PortfolioShareTokenT = Aws::String>
  DescribePortfolioShareStatusResult& WithPortfolioShareToken(PortfolioShareTokenT&& value) {
    SetPortfolioShareToken(std::forward<PortfolioShareTokenT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PortfolioIdT = Aws::String>
  DescribePortfolioShareStatusResult& WithPortfolioId(PortfolioIdT&& value) {
  ...
  void SetOrganizationNodeValue(OrganizationNodeValueT&& value) {
    m_organizationNodeValueHasBeenSet = true;
    m_organizationNodeValue = std::forward<OrganizationNodeValueT>(value);
  }
  template <typename OrganizationNodeValueT = Aws::String>
  DescribePortfolioShareStatusResult& WithOrganizationNodeValue(OrganizationNodeValueT&& value) {
    SetOrganizationNodeValue(std::forward<OrganizationNodeValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribePortfolioShareStatusResult& WithStatus(ShareStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetShareDetails(ShareDetailsT&& value) {
    m_shareDetailsHasBeenSet = true;
    m_shareDetails = std::forward<ShareDetailsT>(value);
  }
  template <typename ShareDetailsT = ShareDetails>
  DescribePortfolioShareStatusResult& WithShareDetails(ShareDetailsT&& value) {
    SetShareDetails(std::forward<ShareDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribePortfolioShareStatusResult& WithRequestId(RequestIdT&& value) {
