...
class ListProvisionedProductPlansResult {
 public:
  ...
  AWS_SERVICECATALOG_API ListProvisionedProductPlansResult& operator=(
  ...
  void SetProvisionedProductPlans(ProvisionedProductPlansT&& value) {
    m_provisionedProductPlansHasBeenSet = true;
    m_provisionedProductPlans = std::forward<ProvisionedProductPlansT>(value);
  }
  template <typename ProvisionedProductPlansT = Aws::Vector<ProvisionedProductPlanSummary>>
  ListProvisionedProductPlansResult& WithProvisionedProductPlans(ProvisionedProductPlansT&& value) {
    SetProvisionedProductPlans(std::forward<ProvisionedProductPlansT>(value));
    return *this;
  }
  template <typename ProvisionedProductPlansT = ProvisionedProductPlanSummary>
  ListProvisionedProductPlansResult& AddProvisionedProductPlans(ProvisionedProductPlansT&& value) {
    m_provisionedProductPlansHasBeenSet = true;
    m_provisionedProductPlans.emplace_back(std::forward<ProvisionedProductPlansT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListProvisionedProductPlansResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProvisionedProductPlansResult& WithRequestId(RequestIdT&& value) {
