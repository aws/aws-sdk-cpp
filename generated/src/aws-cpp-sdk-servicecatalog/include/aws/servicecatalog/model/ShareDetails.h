...
class ShareDetails {
 public:
  ...
  void SetSuccessfulShares(SuccessfulSharesT&& value) {
    ...
    m_successfulShares = std::forward<SuccessfulSharesT>(value);
  }
  template <typename SuccessfulSharesT = Aws::Vector<Aws::String>>
  ShareDetails& WithSuccessfulShares(SuccessfulSharesT&& value) {
    SetSuccessfulShares(std::forward<SuccessfulSharesT>(value));
    return *this;
  }
  template <typename SuccessfulSharesT = Aws::String>
  ShareDetails& AddSuccessfulShares(SuccessfulSharesT&& value) {
    m_successfulSharesHasBeenSet = true;
    m_successfulShares.emplace_back(std::forward<SuccessfulSharesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShareErrors(ShareErrorsT&& value) {
    ...
    m_shareErrors = std::forward<ShareErrorsT>(value);
  }
  template <typename ShareErrorsT = Aws::Vector<ShareError>>
  ShareDetails& WithShareErrors(ShareErrorsT&& value) {
    SetShareErrors(std::forward<ShareErrorsT>(value));
    return *this;
  }
  template <typename ShareErrorsT = ShareError>
  ShareDetails& AddShareErrors(ShareErrorsT&& value) {
    m_shareErrorsHasBeenSet = true;
    m_shareErrors.emplace_back(std::forward<ShareErrorsT>(value));
    return *this;
  }
  ///@}
 private:
