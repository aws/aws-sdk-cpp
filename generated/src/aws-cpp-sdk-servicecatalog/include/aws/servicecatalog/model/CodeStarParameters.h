...
class CodeStarParameters {
 public:
  ...
  template <typename ConnectionArnT = Aws::String>
  CodeStarParameters& WithConnectionArn(ConnectionArnT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  CodeStarParameters& WithRepository(RepositoryT&& value) {
  ...
  template <typename BranchT = Aws::String>
  CodeStarParameters& WithBranch(BranchT&& value) {
  ...
  void SetArtifactPath(ArtifactPathT&& value) {
    m_artifactPathHasBeenSet = true;
    m_artifactPath = std::forward<ArtifactPathT>(value);
  }
  template <typename ArtifactPathT = Aws::String>
  CodeStarParameters& WithArtifactPath(ArtifactPathT&& value) {
    SetArtifactPath(std::forward<ArtifactPathT>(value));
    return *this;
  }
  ///@}
 private:
