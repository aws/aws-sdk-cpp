...
class UpdateProvisioningArtifactRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateProvisioningArtifactRequest& WithName(NameT&& value) {
  ...
  inline UpdateProvisioningArtifactRequest& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateProvisioningArtifactRequest& WithGuidance(ProvisioningArtifactGuidance value) {
    SetGuidance(value);
    return *this;
  }
  ///@}
