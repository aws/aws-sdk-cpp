...
class UpdateProvisionedProductPropertiesRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  UpdateProvisionedProductPropertiesRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ProvisionedProductIdT = Aws::String>
  UpdateProvisionedProductPropertiesRequest& WithProvisionedProductId(ProvisionedProductIdT&& value) {
  ...
  template <typename ProvisionedProductPropertiesT = Aws::Map<PropertyKey, Aws::String>>
  UpdateProvisionedProductPropertiesRequest& WithProvisionedProductProperties(ProvisionedProductPropertiesT&& value) {
  ...
  template <typename IdempotencyTokenT = Aws::String>
  UpdateProvisionedProductPropertiesRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
