...
class ListRecordHistoryRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListRecordHistoryRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename AccessLevelFilterT = AccessLevelFilter>
  ListRecordHistoryRequest& WithAccessLevelFilter(AccessLevelFilterT&& value) {
  ...
  template <typename SearchFilterT = ListRecordHistorySearchFilter>
  ListRecordHistoryRequest& WithSearchFilter(SearchFilterT&& value) {
  ...
  inline ListRecordHistoryRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListRecordHistoryRequest& WithPageToken(PageTokenT&& value) {
