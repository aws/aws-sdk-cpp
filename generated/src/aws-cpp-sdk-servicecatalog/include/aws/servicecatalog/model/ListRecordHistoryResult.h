...
class ListRecordHistoryResult {
 public:
  ...
  void SetRecordDetails(RecordDetailsT&& value) {
    m_recordDetailsHasBeenSet = true;
    m_recordDetails = std::forward<RecordDetailsT>(value);
  }
  template <typename RecordDetailsT = Aws::Vector<RecordDetail>>
  ListRecordHistoryResult& WithRecordDetails(RecordDetailsT&& value) {
    SetRecordDetails(std::forward<RecordDetailsT>(value));
    return *this;
  }
  template <typename RecordDetailsT = RecordDetail>
  ListRecordHistoryResult& AddRecordDetails(RecordDetailsT&& value) {
    m_recordDetailsHasBeenSet = true;
    m_recordDetails.emplace_back(std::forward<RecordDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListRecordHistoryResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRecordHistoryResult& WithRequestId(RequestIdT&& value) {
