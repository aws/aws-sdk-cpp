...
class ListConstraintsForPortfolioResult {
 public:
  ...
  AWS_SERVICECATALOG_API ListConstraintsForPortfolioResult& operator=(
  ...
  void SetConstraintDetails(ConstraintDetailsT&& value) {
    m_constraintDetailsHasBeenSet = true;
    m_constraintDetails = std::forward<ConstraintDetailsT>(value);
  }
  template <typename ConstraintDetailsT = Aws::Vector<ConstraintDetail>>
  ListConstraintsForPortfolioResult& WithConstraintDetails(ConstraintDetailsT&& value) {
    SetConstraintDetails(std::forward<ConstraintDetailsT>(value));
    return *this;
  }
  template <typename ConstraintDetailsT = ConstraintDetail>
  ListConstraintsForPortfolioResult& AddConstraintDetails(ConstraintDetailsT&& value) {
    m_constraintDetailsHasBeenSet = true;
    m_constraintDetails.emplace_back(std::forward<ConstraintDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListConstraintsForPortfolioResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConstraintsForPortfolioResult& WithRequestId(RequestIdT&& value) {
