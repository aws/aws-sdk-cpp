...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICECATALOG_API DeleteServiceActionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteServiceActionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
