...
class ListProvisioningArtifactsForServiceActionResult {
 public:
  ...
  AWS_SERVICECATALOG_API ListProvisioningArtifactsForServiceActionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetProvisioningArtifactViews(ProvisioningArtifactViewsT&& value) {
    m_provisioningArtifactViewsHasBeenSet = true;
    m_provisioningArtifactViews = std::forward<ProvisioningArtifactViewsT>(value);
  }
  template <typename ProvisioningArtifactViewsT = Aws::Vector<ProvisioningArtifactView>>
  ListProvisioningArtifactsForServiceActionResult& WithProvisioningArtifactViews(ProvisioningArtifactViewsT&& value) {
    SetProvisioningArtifactViews(std::forward<ProvisioningArtifactViewsT>(value));
    return *this;
  }
  template <typename ProvisioningArtifactViewsT = ProvisioningArtifactView>
  ListProvisioningArtifactsForServiceActionResult& AddProvisioningArtifactViews(ProvisioningArtifactViewsT&& value) {
    m_provisioningArtifactViewsHasBeenSet = true;
    m_provisioningArtifactViews.emplace_back(std::forward<ProvisioningArtifactViewsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListProvisioningArtifactsForServiceActionResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProvisioningArtifactsForServiceActionResult& WithRequestId(RequestIdT&& value) {
