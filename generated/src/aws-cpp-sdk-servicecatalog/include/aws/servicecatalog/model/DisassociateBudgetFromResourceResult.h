...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateBudgetFromResourceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateBudgetFromResourceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateBudgetFromResourceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
