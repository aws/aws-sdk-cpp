...
class ExecuteProvisionedProductServiceActionResult {
 public:
  ...
  AWS_SERVICECATALOG_API ExecuteProvisionedProductServiceActionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RecordDetailT = RecordDetail>
  ExecuteProvisionedProductServiceActionResult& WithRecordDetail(RecordDetailT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExecuteProvisionedProductServiceActionResult& WithRequestId(RequestIdT&& value) {
