...
class DisassociateServiceActionFromProvisioningArtifactRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename ProductIdT = Aws::String>
  DisassociateServiceActionFromProvisioningArtifactRequest& WithProductId(ProductIdT&& value) {
  ...
  template <typename ProvisioningArtifactIdT = Aws::String>
  DisassociateServiceActionFromProvisioningArtifactRequest& WithProvisioningArtifactId(ProvisioningArtifactIdT&& value) {
  ...
  template <typename ServiceActionIdT = Aws::String>
  DisassociateServiceActionFromProvisioningArtifactRequest& WithServiceActionId(ServiceActionIdT&& value) {
  ...
  template <typename AcceptLanguageT = Aws::String>
  DisassociateServiceActionFromProvisioningArtifactRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename IdempotencyTokenT = Aws::String>
  DisassociateServiceActionFromProvisioningArtifactRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
