...
class ListResourcesForTagOptionResult {
 public:
  ...
  template <typename ResourceDetailsT = Aws::Vector<ResourceDetail>>
  ListResourcesForTagOptionResult& WithResourceDetails(ResourceDetailsT&& value) {
    SetResourceDetails(std::forward<ResourceDetailsT>(value));
    return *this;
  }
  template <typename ResourceDetailsT = ResourceDetail>
  ListResourcesForTagOptionResult& AddResourceDetails(ResourceDetailsT&& value) {
    m_resourceDetailsHasBeenSet = true;
    m_resourceDetails.emplace_back(std::forward<ResourceDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListResourcesForTagOptionResult& WithPageToken(PageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourcesForTagOptionResult& WithRequestId(RequestIdT&& value) {
