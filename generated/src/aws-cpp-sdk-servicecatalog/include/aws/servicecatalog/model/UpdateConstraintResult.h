...
class UpdateConstraintResult {
 public:
  ...
  template <typename ConstraintDetailT = ConstraintDetail>
  UpdateConstraintResult& WithConstraintDetail(ConstraintDetailT&& value) {
  ...
  template <typename ConstraintParametersT = Aws::String>
  UpdateConstraintResult& WithConstraintParameters(ConstraintParametersT&& value) {
  ...
  inline UpdateConstraintResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConstraintResult& WithRequestId(RequestIdT&& value) {
