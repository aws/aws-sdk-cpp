...
class ProvisioningArtifactView {
 public:
  ...
  void SetProductViewSummary(ProductViewSummaryT&& value) {
    m_productViewSummaryHasBeenSet = true;
    m_productViewSummary = std::forward<ProductViewSummaryT>(value);
  }
  template <typename ProductViewSummaryT = ProductViewSummary>
  ProvisioningArtifactView& WithProductViewSummary(ProductViewSummaryT&& value) {
    SetProductViewSummary(std::forward<ProductViewSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProvisioningArtifact(ProvisioningArtifactT&& value) {
    m_provisioningArtifactHasBeenSet = true;
    m_provisioningArtifact = std::forward<ProvisioningArtifactT>(value);
  }
  template <typename ProvisioningArtifactT = ProvisioningArtifact>
  ProvisioningArtifactView& WithProvisioningArtifact(ProvisioningArtifactT&& value) {
    SetProvisioningArtifact(std::forward<ProvisioningArtifactT>(value));
    return *this;
  }
  ///@}
 private:
