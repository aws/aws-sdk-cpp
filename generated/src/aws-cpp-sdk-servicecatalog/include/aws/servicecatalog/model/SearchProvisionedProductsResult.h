...
class SearchProvisionedProductsResult {
 public:
  ...
  template <typename ProvisionedProductsT = Aws::Vector<ProvisionedProductAttribute>>
  SearchProvisionedProductsResult& WithProvisionedProducts(ProvisionedProductsT&& value) {
  ...
  SearchProvisionedProductsResult& AddProvisionedProducts(ProvisionedProductsT&& value) {
    m_provisionedProductsHasBeenSet = true;
  ...
  inline SearchProvisionedProductsResult& WithTotalResultsCount(int value) {
  ...
  template <typename NextPageTokenT = Aws::String>
  SearchProvisionedProductsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchProvisionedProductsResult& WithRequestId(RequestIdT&& value) {
