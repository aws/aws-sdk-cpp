...
class ListStackInstancesForProvisionedProductResult {
 public:
  ...
  AWS_SERVICECATALOG_API ListStackInstancesForProvisionedProductResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetStackInstances(StackInstancesT&& value) {
    m_stackInstancesHasBeenSet = true;
    m_stackInstances = std::forward<StackInstancesT>(value);
  }
  template <typename StackInstancesT = Aws::Vector<StackInstance>>
  ListStackInstancesForProvisionedProductResult& WithStackInstances(StackInstancesT&& value) {
    SetStackInstances(std::forward<StackInstancesT>(value));
    return *this;
  }
  template <typename StackInstancesT = StackInstance>
  ListStackInstancesForProvisionedProductResult& AddStackInstances(StackInstancesT&& value) {
    m_stackInstancesHasBeenSet = true;
    m_stackInstances.emplace_back(std::forward<StackInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListStackInstancesForProvisionedProductResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStackInstancesForProvisionedProductResult& WithRequestId(RequestIdT&& value) {
