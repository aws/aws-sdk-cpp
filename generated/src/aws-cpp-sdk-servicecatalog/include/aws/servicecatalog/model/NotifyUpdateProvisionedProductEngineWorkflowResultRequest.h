...
class NotifyUpdateProvisionedProductEngineWorkflowResultRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename WorkflowTokenT = Aws::String>
  NotifyUpdateProvisionedProductEngineWorkflowResultRequest& WithWorkflowToken(WorkflowTokenT&& value) {
  ...
  template <typename RecordIdT = Aws::String>
  NotifyUpdateProvisionedProductEngineWorkflowResultRequest& WithRecordId(RecordIdT&& value) {
  ...
  inline NotifyUpdateProvisionedProductEngineWorkflowResultRequest& WithStatus(EngineWorkflowStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureReasonT = Aws::String>
  NotifyUpdateProvisionedProductEngineWorkflowResultRequest& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename OutputsT = Aws::Vector<RecordOutput>>
  NotifyUpdateProvisionedProductEngineWorkflowResultRequest& WithOutputs(OutputsT&& value) {
    SetOutputs(std::forward<OutputsT>(value));
    return *this;
  }
  template <typename OutputsT = RecordOutput>
  NotifyUpdateProvisionedProductEngineWorkflowResultRequest& AddOutputs(OutputsT&& value) {
    m_outputsHasBeenSet = true;
  ...
  template <typename IdempotencyTokenT = Aws::String>
  NotifyUpdateProvisionedProductEngineWorkflowResultRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
