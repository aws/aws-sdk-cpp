...
class StackInstance {
 public:
  ...
  inline void SetStackInstanceStatus(StackInstanceStatus value) {
    m_stackInstanceStatusHasBeenSet = true;
    m_stackInstanceStatus = value;
  }
  inline StackInstance& WithStackInstanceStatus(StackInstanceStatus value) {
    SetStackInstanceStatus(value);
    return *this;
  }
  ///@}
 private:
