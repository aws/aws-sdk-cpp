...
class DescribeProvisioningArtifactRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  DescribeProvisioningArtifactRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ProvisioningArtifactIdT = Aws::String>
  DescribeProvisioningArtifactRequest& WithProvisioningArtifactId(ProvisioningArtifactIdT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  DescribeProvisioningArtifactRequest& WithProductId(ProductIdT&& value) {
  ...
  template <typename ProvisioningArtifactNameT = Aws::String>
  DescribeProvisioningArtifactRequest& WithProvisioningArtifactName(ProvisioningArtifactNameT&& value) {
  ...
  template <typename ProductNameT = Aws::String>
  DescribeProvisioningArtifactRequest& WithProductName(ProductNameT&& value) {
  ...
  inline DescribeProvisioningArtifactRequest& WithVerbose(bool value) {
    SetVerbose(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeProvisioningArtifactParameters(bool value) {
    m_includeProvisioningArtifactParametersHasBeenSet = true;
    m_includeProvisioningArtifactParameters = value;
  }
  inline DescribeProvisioningArtifactRequest& WithIncludeProvisioningArtifactParameters(bool value) {
    SetIncludeProvisioningArtifactParameters(value);
    return *this;
  }
  ///@}
 private:
