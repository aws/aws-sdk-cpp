...
class SearchProductsRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  SearchProductsRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename FiltersT = Aws::Map<ProductViewFilterBy, Aws::Vector<Aws::String>>>
  SearchProductsRequest& WithFilters(FiltersT&& value) {
  ...
  inline SearchProductsRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  inline SearchProductsRequest& WithSortBy(ProductViewSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline SearchProductsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  SearchProductsRequest& WithPageToken(PageTokenT&& value) {
