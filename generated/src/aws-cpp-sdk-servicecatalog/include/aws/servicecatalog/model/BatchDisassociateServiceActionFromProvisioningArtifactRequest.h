...
/**
 */
class BatchDisassociateServiceActionFromProvisioningArtifactRequest : public ServiceCatalogRequest {
 public:
  AWS_SERVICECATALOG_API BatchDisassociateServiceActionFromProvisioningArtifactRequest() = default;
  ...
  template <typename ServiceActionAssociationsT = Aws::Vector<ServiceActionAssociation>>
  BatchDisassociateServiceActionFromProvisioningArtifactRequest& WithServiceActionAssociations(ServiceActionAssociationsT&& value) {
  ...
  BatchDisassociateServiceActionFromProvisioningArtifactRequest& AddServiceActionAssociations(ServiceActionAssociationsT&& value) {
    m_serviceActionAssociationsHasBeenSet = true;
  ...
  template <typename AcceptLanguageT = Aws::String>
  BatchDisassociateServiceActionFromProvisioningArtifactRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
