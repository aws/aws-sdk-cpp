...
class SourceConnectionDetail {
 public:
  ...
  inline SourceConnectionDetail& WithType(SourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetConnectionParameters(ConnectionParametersT&& value) {
    ...
    m_connectionParameters = std::forward<ConnectionParametersT>(value);
  }
  template <typename ConnectionParametersT = SourceConnectionParameters>
  SourceConnectionDetail& WithConnectionParameters(ConnectionParametersT&& value) {
    SetConnectionParameters(std::forward<ConnectionParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSync(LastSyncT&& value) {
    ...
    m_lastSync = std::forward<LastSyncT>(value);
  }
  template <typename LastSyncT = LastSync>
  SourceConnectionDetail& WithLastSync(LastSyncT&& value) {
    SetLastSync(std::forward<LastSyncT>(value));
    return *this;
  }
  ///@}
 private:
