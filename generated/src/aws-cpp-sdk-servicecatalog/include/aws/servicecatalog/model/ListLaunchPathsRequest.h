...
/**
 */
class ListLaunchPathsRequest : public ServiceCatalogRequest {
 public:
  AWS_SERVICECATALOG_API ListLaunchPathsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListLaunchPaths"; }
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListLaunchPathsRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  ListLaunchPathsRequest& WithProductId(ProductIdT&& value) {
  ...
  inline ListLaunchPathsRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListLaunchPathsRequest& WithPageToken(PageTokenT&& value) {
