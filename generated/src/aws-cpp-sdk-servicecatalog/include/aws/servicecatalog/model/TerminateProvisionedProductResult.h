...
class TerminateProvisionedProductResult {
 public:
  AWS_SERVICECATALOG_API TerminateProvisionedProductResult() = default;
  ...
  AWS_SERVICECATALOG_API TerminateProvisionedProductResult& operator=(
  ...
  void SetRecordDetail(RecordDetailT&& value) {
    m_recordDetailHasBeenSet = true;
    m_recordDetail = std::forward<RecordDetailT>(value);
  }
  template <typename RecordDetailT = RecordDetail>
  TerminateProvisionedProductResult& WithRecordDetail(RecordDetailT&& value) {
    SetRecordDetail(std::forward<RecordDetailT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  TerminateProvisionedProductResult& WithRequestId(RequestIdT&& value) {
