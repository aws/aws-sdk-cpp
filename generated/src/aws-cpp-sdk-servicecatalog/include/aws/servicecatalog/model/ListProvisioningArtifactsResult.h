...
class ListProvisioningArtifactsResult {
 public:
  ...
  void SetProvisioningArtifactDetails(ProvisioningArtifactDetailsT&& value) {
    m_provisioningArtifactDetailsHasBeenSet = true;
    m_provisioningArtifactDetails = std::forward<ProvisioningArtifactDetailsT>(value);
  }
  template <typename ProvisioningArtifactDetailsT = Aws::Vector<ProvisioningArtifactDetail>>
  ListProvisioningArtifactsResult& WithProvisioningArtifactDetails(ProvisioningArtifactDetailsT&& value) {
    SetProvisioningArtifactDetails(std::forward<ProvisioningArtifactDetailsT>(value));
    return *this;
  }
  template <typename ProvisioningArtifactDetailsT = ProvisioningArtifactDetail>
  ListProvisioningArtifactsResult& AddProvisioningArtifactDetails(ProvisioningArtifactDetailsT&& value) {
    m_provisioningArtifactDetailsHasBeenSet = true;
    m_provisioningArtifactDetails.emplace_back(std::forward<ProvisioningArtifactDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListProvisioningArtifactsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProvisioningArtifactsResult& WithRequestId(RequestIdT&& value) {
