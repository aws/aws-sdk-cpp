...
class ListBudgetsForResourceRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListBudgetsForResourceRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  ListBudgetsForResourceRequest& WithResourceId(ResourceIdT&& value) {
  ...
  inline ListBudgetsForResourceRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListBudgetsForResourceRequest& WithPageToken(PageTokenT&& value) {
