...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICECATALOG_API ListBudgetsForResourceRequest() = default;
    ...
    template<typename AcceptLanguageT = Aws::String>
    ListBudgetsForResourceRequest& WithAcceptLanguage(AcceptLanguageT&& value) { SetAcceptLanguage(std::forward<AcceptLanguageT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceIdT = Aws::String>
    ListBudgetsForResourceRequest& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PageTokenT = Aws::String>
    ListBudgetsForResourceRequest& WithPageToken(PageTokenT&& value) { SetPageToken(std::forward<PageTokenT>(value)); return *this;}
    ///@}
  private:
