...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICECATALOG_API ListAcceptedPortfolioSharesResult() = default;
    ...
    template<typename PortfolioDetailsT = Aws::Vector<PortfolioDetail>>
    ListAcceptedPortfolioSharesResult& WithPortfolioDetails(PortfolioDetailsT&& value) { SetPortfolioDetails(std::forward<PortfolioDetailsT>(value)); return *this;}
    template<typename PortfolioDetailsT = PortfolioDetail>
    ListAcceptedPortfolioSharesResult& AddPortfolioDetails(PortfolioDetailsT&& value) { m_portfolioDetailsHasBeenSet = true; m_portfolioDetails.emplace_back(std::forward<PortfolioDetailsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextPageTokenT = Aws::String>
    ListAcceptedPortfolioSharesResult& WithNextPageToken(NextPageTokenT&& value) { SetNextPageToken(std::forward<NextPageTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListAcceptedPortfolioSharesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
