...
class CreateProductRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  CreateProductRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateProductRequest& WithName(NameT&& value) {
  ...
  template <typename OwnerT = Aws::String>
  CreateProductRequest& WithOwner(OwnerT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateProductRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename DistributorT = Aws::String>
  CreateProductRequest& WithDistributor(DistributorT&& value) {
  ...
  template <typename SupportDescriptionT = Aws::String>
  CreateProductRequest& WithSupportDescription(SupportDescriptionT&& value) {
  ...
  template <typename SupportEmailT = Aws::String>
  CreateProductRequest& WithSupportEmail(SupportEmailT&& value) {
  ...
  template <typename SupportUrlT = Aws::String>
  CreateProductRequest& WithSupportUrl(SupportUrlT&& value) {
  ...
  inline void SetProductType(ProductType value) {
    m_productTypeHasBeenSet = true;
    m_productType = value;
  }
  inline CreateProductRequest& WithProductType(ProductType value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateProductRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateProductRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ProvisioningArtifactParametersT = ProvisioningArtifactProperties>
  CreateProductRequest& WithProvisioningArtifactParameters(ProvisioningArtifactParametersT&& value) {
  ...
  template <typename IdempotencyTokenT = Aws::String>
  CreateProductRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
  ...
  template <typename SourceConnectionT = SourceConnection>
  CreateProductRequest& WithSourceConnection(SourceConnectionT&& value) {
