...
class SearchProvisionedProductsRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  SearchProvisionedProductsRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename AccessLevelFilterT = AccessLevelFilter>
  SearchProvisionedProductsRequest& WithAccessLevelFilter(AccessLevelFilterT&& value) {
  ...
  template <typename FiltersT = Aws::Map<ProvisionedProductViewFilterBy, Aws::Vector<Aws::String>>>
  SearchProvisionedProductsRequest& WithFilters(FiltersT&& value) {
  ...
  template <typename SortByT = Aws::String>
  SearchProvisionedProductsRequest& WithSortBy(SortByT&& value) {
  ...
  inline SearchProvisionedProductsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline SearchProvisionedProductsRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  SearchProvisionedProductsRequest& WithPageToken(PageTokenT&& value) {
