...
class DescribeProvisionedProductPlanRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  DescribeProvisionedProductPlanRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename PlanIdT = Aws::String>
  DescribeProvisionedProductPlanRequest& WithPlanId(PlanIdT&& value) {
  ...
  inline DescribeProvisionedProductPlanRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  DescribeProvisionedProductPlanRequest& WithPageToken(PageTokenT&& value) {
