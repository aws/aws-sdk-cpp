...
class ListPortfoliosRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListPortfoliosRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename PageTokenT = Aws::String>
  ListPortfoliosRequest& WithPageToken(PageTokenT&& value) {
  ...
  inline ListPortfoliosRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
