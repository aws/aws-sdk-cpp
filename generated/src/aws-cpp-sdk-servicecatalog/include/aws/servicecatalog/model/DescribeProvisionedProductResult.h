...
class DescribeProvisionedProductResult {
 public:
  ...
  AWS_SERVICECATALOG_API DescribeProvisionedProductResult& operator=(
  ...
  void SetProvisionedProductDetail(ProvisionedProductDetailT&& value) {
    m_provisionedProductDetailHasBeenSet = true;
    m_provisionedProductDetail = std::forward<ProvisionedProductDetailT>(value);
  }
  template <typename ProvisionedProductDetailT = ProvisionedProductDetail>
  DescribeProvisionedProductResult& WithProvisionedProductDetail(ProvisionedProductDetailT&& value) {
    SetProvisionedProductDetail(std::forward<ProvisionedProductDetailT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CloudWatchDashboardsT = Aws::Vector<CloudWatchDashboard>>
  DescribeProvisionedProductResult& WithCloudWatchDashboards(CloudWatchDashboardsT&& value) {
  ...
  DescribeProvisionedProductResult& AddCloudWatchDashboards(CloudWatchDashboardsT&& value) {
    m_cloudWatchDashboardsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeProvisionedProductResult& WithRequestId(RequestIdT&& value) {
