...
class DescribeRecordResult {
 public:
  ...
  template <typename RecordDetailT = RecordDetail>
  DescribeRecordResult& WithRecordDetail(RecordDetailT&& value) {
  ...
  void SetRecordOutputs(RecordOutputsT&& value) {
    m_recordOutputsHasBeenSet = true;
    m_recordOutputs = std::forward<RecordOutputsT>(value);
  }
  template <typename RecordOutputsT = Aws::Vector<RecordOutput>>
  DescribeRecordResult& WithRecordOutputs(RecordOutputsT&& value) {
    SetRecordOutputs(std::forward<RecordOutputsT>(value));
    return *this;
  }
  template <typename RecordOutputsT = RecordOutput>
  DescribeRecordResult& AddRecordOutputs(RecordOutputsT&& value) {
    m_recordOutputsHasBeenSet = true;
    m_recordOutputs.emplace_back(std::forward<RecordOutputsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  DescribeRecordResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRecordResult& WithRequestId(RequestIdT&& value) {
