...
namespace Model
{
  ...
  public:
    ...
    inline AssociateTagOptionWithResourceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateTagOptionWithResourceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateTagOptionWithResourceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
