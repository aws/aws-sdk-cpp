...
class ListPortfolioAccessRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListPortfolioAccessRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename PortfolioIdT = Aws::String>
  ListPortfolioAccessRequest& WithPortfolioId(PortfolioIdT&& value) {
  ...
  void SetOrganizationParentId(OrganizationParentIdT&& value) {
    m_organizationParentIdHasBeenSet = true;
    m_organizationParentId = std::forward<OrganizationParentIdT>(value);
  }
  template <typename OrganizationParentIdT = Aws::String>
  ListPortfolioAccessRequest& WithOrganizationParentId(OrganizationParentIdT&& value) {
    SetOrganizationParentId(std::forward<OrganizationParentIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListPortfolioAccessRequest& WithPageToken(PageTokenT&& value) {
  ...
  inline ListPortfolioAccessRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
