...
namespace Model
{
  ...
  public:
    ...
    inline AssociateProductWithPortfolioResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateProductWithPortfolioResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateProductWithPortfolioResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
