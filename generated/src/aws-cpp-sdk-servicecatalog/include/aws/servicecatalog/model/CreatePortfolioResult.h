...
class CreatePortfolioResult {
 public:
  ...
  template <typename PortfolioDetailT = PortfolioDetail>
  CreatePortfolioResult& WithPortfolioDetail(PortfolioDetailT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreatePortfolioResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreatePortfolioResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreatePortfolioResult& WithRequestId(RequestIdT&& value) {
