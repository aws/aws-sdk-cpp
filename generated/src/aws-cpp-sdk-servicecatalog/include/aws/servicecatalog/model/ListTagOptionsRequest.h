...
class ListTagOptionsRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename FiltersT = ListTagOptionsFilters>
  ListTagOptionsRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListTagOptionsRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListTagOptionsRequest& WithPageToken(PageTokenT&& value) {
