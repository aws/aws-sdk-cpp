...
class UpdateProvisionedProductPropertiesResult {
 public:
  ...
  AWS_SERVICECATALOG_API UpdateProvisionedProductPropertiesResult& operator=(
  ...
  template <typename ProvisionedProductIdT = Aws::String>
  UpdateProvisionedProductPropertiesResult& WithProvisionedProductId(ProvisionedProductIdT&& value) {
  ...
  void SetProvisionedProductProperties(ProvisionedProductPropertiesT&& value) {
    m_provisionedProductPropertiesHasBeenSet = true;
    m_provisionedProductProperties = std::forward<ProvisionedProductPropertiesT>(value);
  }
  template <typename ProvisionedProductPropertiesT = Aws::Map<PropertyKey, Aws::String>>
  UpdateProvisionedProductPropertiesResult& WithProvisionedProductProperties(ProvisionedProductPropertiesT&& value) {
    SetProvisionedProductProperties(std::forward<ProvisionedProductPropertiesT>(value));
    return *this;
  }
  inline UpdateProvisionedProductPropertiesResult& AddProvisionedProductProperties(PropertyKey key, Aws::String value) {
    m_provisionedProductPropertiesHasBeenSet = true;
    m_provisionedProductProperties.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  template <typename RecordIdT = Aws::String>
  UpdateProvisionedProductPropertiesResult& WithRecordId(RecordIdT&& value) {
  ...
  inline UpdateProvisionedProductPropertiesResult& WithStatus(RecordStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateProvisionedProductPropertiesResult& WithRequestId(RequestIdT&& value) {
