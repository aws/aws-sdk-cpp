...
class ExecuteProvisionedProductPlanResult {
 public:
  ...
  AWS_SERVICECATALOG_API ExecuteProvisionedProductPlanResult& operator=(
  ...
  template <typename RecordDetailT = RecordDetail>
  ExecuteProvisionedProductPlanResult& WithRecordDetail(RecordDetailT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExecuteProvisionedProductPlanResult& WithRequestId(RequestIdT&& value) {
