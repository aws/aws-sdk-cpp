...
class DescribeProductAsAdminResult {
 public:
  ...
  void SetProductViewDetail(ProductViewDetailT&& value) {
    m_productViewDetailHasBeenSet = true;
    m_productViewDetail = std::forward<ProductViewDetailT>(value);
  }
  template <typename ProductViewDetailT = ProductViewDetail>
  DescribeProductAsAdminResult& WithProductViewDetail(ProductViewDetailT&& value) {
    SetProductViewDetail(std::forward<ProductViewDetailT>(value));
    return *this;
  }
  ///@}
   ...
   * specified product.</p>
   */
  inline const Aws::Vector<ProvisioningArtifactSummary>& GetProvisioningArtifactSummaries() const {
    return m_provisioningArtifactSummaries;
  }
  template <typename ProvisioningArtifactSummariesT = Aws::Vector<ProvisioningArtifactSummary>>
  void SetProvisioningArtifactSummaries(ProvisioningArtifactSummariesT&& value) {
    m_provisioningArtifactSummariesHasBeenSet = true;
    m_provisioningArtifactSummaries = std::forward<ProvisioningArtifactSummariesT>(value);
  }
  template <typename ProvisioningArtifactSummariesT = Aws::Vector<ProvisioningArtifactSummary>>
  DescribeProductAsAdminResult& WithProvisioningArtifactSummaries(ProvisioningArtifactSummariesT&& value) {
    SetProvisioningArtifactSummaries(std::forward<ProvisioningArtifactSummariesT>(value));
    return *this;
  }
  template <typename ProvisioningArtifactSummariesT = ProvisioningArtifactSummary>
  DescribeProductAsAdminResult& AddProvisioningArtifactSummaries(ProvisioningArtifactSummariesT&& value) {
    m_provisioningArtifactSummariesHasBeenSet = true;
    m_provisioningArtifactSummaries.emplace_back(std::forward<ProvisioningArtifactSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  DescribeProductAsAdminResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  DescribeProductAsAdminResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename TagOptionsT = Aws::Vector<TagOptionDetail>>
  DescribeProductAsAdminResult& WithTagOptions(TagOptionsT&& value) {
    SetTagOptions(std::forward<TagOptionsT>(value));
    return *this;
  }
  template <typename TagOptionsT = TagOptionDetail>
  DescribeProductAsAdminResult& AddTagOptions(TagOptionsT&& value) {
    m_tagOptionsHasBeenSet = true;
  ...
  template <typename BudgetsT = Aws::Vector<BudgetDetail>>
  DescribeProductAsAdminResult& WithBudgets(BudgetsT&& value) {
    SetBudgets(std::forward<BudgetsT>(value));
    return *this;
  }
  template <typename BudgetsT = BudgetDetail>
  DescribeProductAsAdminResult& AddBudgets(BudgetsT&& value) {
    m_budgetsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeProductAsAdminResult& WithRequestId(RequestIdT&& value) {
