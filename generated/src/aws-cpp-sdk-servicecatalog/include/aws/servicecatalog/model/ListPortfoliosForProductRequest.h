...
class ListPortfoliosForProductRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListPortfoliosForProductRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  ListPortfoliosForProductRequest& WithProductId(ProductIdT&& value) {
  ...
  template <typename PageTokenT = Aws::String>
  ListPortfoliosForProductRequest& WithPageToken(PageTokenT&& value) {
  ...
  inline ListPortfoliosForProductRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
