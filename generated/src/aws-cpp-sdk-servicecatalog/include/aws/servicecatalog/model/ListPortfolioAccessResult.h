...
class ListPortfolioAccessResult {
 public:
  AWS_SERVICECATALOG_API ListPortfolioAccessResult() = default;
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  ListPortfolioAccessResult& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  ListPortfolioAccessResult& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  template <typename NextPageTokenT = Aws::String>
  ListPortfolioAccessResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPortfolioAccessResult& WithRequestId(RequestIdT&& value) {
