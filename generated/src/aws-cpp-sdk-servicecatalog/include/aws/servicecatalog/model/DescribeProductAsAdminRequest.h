...
class DescribeProductAsAdminRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  DescribeProductAsAdminRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename IdT = Aws::String>
  DescribeProductAsAdminRequest& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  DescribeProductAsAdminRequest& WithName(NameT&& value) {
  ...
  void SetSourcePortfolioId(SourcePortfolioIdT&& value) {
    m_sourcePortfolioIdHasBeenSet = true;
    m_sourcePortfolioId = std::forward<SourcePortfolioIdT>(value);
  }
  template <typename SourcePortfolioIdT = Aws::String>
  DescribeProductAsAdminRequest& WithSourcePortfolioId(SourcePortfolioIdT&& value) {
    SetSourcePortfolioId(std::forward<SourcePortfolioIdT>(value));
    return *this;
  }
  ///@}
 private:
