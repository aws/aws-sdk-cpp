...
class ScanProvisionedProductsResult {
 public:
  ...
  void SetProvisionedProducts(ProvisionedProductsT&& value) {
    m_provisionedProductsHasBeenSet = true;
    m_provisionedProducts = std::forward<ProvisionedProductsT>(value);
  }
  template <typename ProvisionedProductsT = Aws::Vector<ProvisionedProductDetail>>
  ScanProvisionedProductsResult& WithProvisionedProducts(ProvisionedProductsT&& value) {
    SetProvisionedProducts(std::forward<ProvisionedProductsT>(value));
    return *this;
  }
  template <typename ProvisionedProductsT = ProvisionedProductDetail>
  ScanProvisionedProductsResult& AddProvisionedProducts(ProvisionedProductsT&& value) {
    m_provisionedProductsHasBeenSet = true;
    m_provisionedProducts.emplace_back(std::forward<ProvisionedProductsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ScanProvisionedProductsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ScanProvisionedProductsResult& WithRequestId(RequestIdT&& value) {
