...
class ProvisionedProductDetail {
 public:
  ...
  template <typename NameT = Aws::String>
  ProvisionedProductDetail& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ProvisionedProductDetail& WithArn(ArnT&& value) {
  ...
  template <typename TypeT = Aws::String>
  ProvisionedProductDetail& WithType(TypeT&& value) {
  ...
  template <typename IdT = Aws::String>
  ProvisionedProductDetail& WithId(IdT&& value) {
  ...
  inline ProvisionedProductDetail& WithStatus(ProvisionedProductStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  ProvisionedProductDetail& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  ProvisionedProductDetail& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename IdempotencyTokenT = Aws::String>
  ProvisionedProductDetail& WithIdempotencyToken(IdempotencyTokenT&& value) {
  ...
  template <typename LastRecordIdT = Aws::String>
  ProvisionedProductDetail& WithLastRecordId(LastRecordIdT&& value) {
  ...
  template <typename LastProvisioningRecordIdT = Aws::String>
  ProvisionedProductDetail& WithLastProvisioningRecordId(LastProvisioningRecordIdT&& value) {
  ...
  template <typename LastSuccessfulProvisioningRecordIdT = Aws::String>
  ProvisionedProductDetail& WithLastSuccessfulProvisioningRecordId(LastSuccessfulProvisioningRecordIdT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  ProvisionedProductDetail& WithProductId(ProductIdT&& value) {
  ...
  template <typename ProvisioningArtifactIdT = Aws::String>
  ProvisionedProductDetail& WithProvisioningArtifactId(ProvisioningArtifactIdT&& value) {
  ...
  template <typename LaunchRoleArnT = Aws::String>
  ProvisionedProductDetail& WithLaunchRoleArn(LaunchRoleArnT&& value) {
