...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICECATALOG_API DeletePortfolioResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeletePortfolioResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
