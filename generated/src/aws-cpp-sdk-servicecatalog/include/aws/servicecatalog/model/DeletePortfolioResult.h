...
namespace Model
{
  ...
  public:
    ...
    inline DeletePortfolioResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeletePortfolioResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeletePortfolioResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
