...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICECATALOG_API UpdateProvisionedProductResult() = default;
    ...
    template<typename RecordDetailT = RecordDetail>
    UpdateProvisionedProductResult& WithRecordDetail(RecordDetailT&& value) { SetRecordDetail(std::forward<RecordDetailT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateProvisionedProductResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
