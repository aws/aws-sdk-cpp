...
class ProvisioningArtifactProperties {
 public:
  ...
  template <typename NameT = Aws::String>
  ProvisioningArtifactProperties& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ProvisioningArtifactProperties& WithDescription(DescriptionT&& value) {
  ...
  template <typename InfoT = Aws::Map<Aws::String, Aws::String>>
  ProvisioningArtifactProperties& WithInfo(InfoT&& value) {
  ...
  inline void SetType(ProvisioningArtifactType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ProvisioningArtifactProperties& WithType(ProvisioningArtifactType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDisableTemplateValidation(bool value) {
    m_disableTemplateValidationHasBeenSet = true;
    m_disableTemplateValidation = value;
  }
  inline ProvisioningArtifactProperties& WithDisableTemplateValidation(bool value) {
    SetDisableTemplateValidation(value);
    return *this;
  }
  ///@}
 private:
