...
class ProvisionedProductAttribute {
 public:
  ...
  template <typename NameT = Aws::String>
  ProvisionedProductAttribute& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ProvisionedProductAttribute& WithArn(ArnT&& value) {
  ...
  template <typename TypeT = Aws::String>
  ProvisionedProductAttribute& WithType(TypeT&& value) {
  ...
  template <typename IdT = Aws::String>
  ProvisionedProductAttribute& WithId(IdT&& value) {
  ...
  inline void SetStatus(ProvisionedProductStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ProvisionedProductAttribute& WithStatus(ProvisionedProductStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  ProvisionedProductAttribute& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  ProvisionedProductAttribute& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename IdempotencyTokenT = Aws::String>
  ProvisionedProductAttribute& WithIdempotencyToken(IdempotencyTokenT&& value) {
  ...
  void SetLastRecordId(LastRecordIdT&& value) {
    m_lastRecordIdHasBeenSet = true;
    m_lastRecordId = std::forward<LastRecordIdT>(value);
  }
  template <typename LastRecordIdT = Aws::String>
  ProvisionedProductAttribute& WithLastRecordId(LastRecordIdT&& value) {
    SetLastRecordId(std::forward<LastRecordIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastProvisioningRecordId(LastProvisioningRecordIdT&& value) {
    m_lastProvisioningRecordIdHasBeenSet = true;
    m_lastProvisioningRecordId = std::forward<LastProvisioningRecordIdT>(value);
  }
  template <typename LastProvisioningRecordIdT = Aws::String>
  ProvisionedProductAttribute& WithLastProvisioningRecordId(LastProvisioningRecordIdT&& value) {
    SetLastProvisioningRecordId(std::forward<LastProvisioningRecordIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSuccessfulProvisioningRecordId(LastSuccessfulProvisioningRecordIdT&& value) {
    m_lastSuccessfulProvisioningRecordIdHasBeenSet = true;
    m_lastSuccessfulProvisioningRecordId = std::forward<LastSuccessfulProvisioningRecordIdT>(value);
  }
  template <typename LastSuccessfulProvisioningRecordIdT = Aws::String>
  ProvisionedProductAttribute& WithLastSuccessfulProvisioningRecordId(LastSuccessfulProvisioningRecordIdT&& value) {
    SetLastSuccessfulProvisioningRecordId(std::forward<LastSuccessfulProvisioningRecordIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ProvisionedProductAttribute& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ProvisionedProductAttribute& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename PhysicalIdT = Aws::String>
  ProvisionedProductAttribute& WithPhysicalId(PhysicalIdT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  ProvisionedProductAttribute& WithProductId(ProductIdT&& value) {
  ...
  template <typename ProductNameT = Aws::String>
  ProvisionedProductAttribute& WithProductName(ProductNameT&& value) {
  ...
  template <typename ProvisioningArtifactIdT = Aws::String>
  ProvisionedProductAttribute& WithProvisioningArtifactId(ProvisioningArtifactIdT&& value) {
  ...
  void SetProvisioningArtifactName(ProvisioningArtifactNameT&& value) {
    m_provisioningArtifactNameHasBeenSet = true;
    m_provisioningArtifactName = std::forward<ProvisioningArtifactNameT>(value);
  }
  template <typename ProvisioningArtifactNameT = Aws::String>
  ProvisionedProductAttribute& WithProvisioningArtifactName(ProvisioningArtifactNameT&& value) {
    SetProvisioningArtifactName(std::forward<ProvisioningArtifactNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UserArnT = Aws::String>
  ProvisionedProductAttribute& WithUserArn(UserArnT&& value) {
  ...
  void SetUserArnSession(UserArnSessionT&& value) {
    m_userArnSessionHasBeenSet = true;
    m_userArnSession = std::forward<UserArnSessionT>(value);
  }
  template <typename UserArnSessionT = Aws::String>
  ProvisionedProductAttribute& WithUserArnSession(UserArnSessionT&& value) {
    SetUserArnSession(std::forward<UserArnSessionT>(value));
    return *this;
  }
  ///@}
 private:
