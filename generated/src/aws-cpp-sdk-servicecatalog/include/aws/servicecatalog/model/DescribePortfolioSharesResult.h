...
class DescribePortfolioSharesResult {
 public:
  ...
  template <typename NextPageTokenT = Aws::String>
  DescribePortfolioSharesResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  void SetPortfolioShareDetails(PortfolioShareDetailsT&& value) {
    m_portfolioShareDetailsHasBeenSet = true;
    m_portfolioShareDetails = std::forward<PortfolioShareDetailsT>(value);
  }
  template <typename PortfolioShareDetailsT = Aws::Vector<PortfolioShareDetail>>
  DescribePortfolioSharesResult& WithPortfolioShareDetails(PortfolioShareDetailsT&& value) {
    SetPortfolioShareDetails(std::forward<PortfolioShareDetailsT>(value));
    return *this;
  }
  template <typename PortfolioShareDetailsT = PortfolioShareDetail>
  DescribePortfolioSharesResult& AddPortfolioShareDetails(PortfolioShareDetailsT&& value) {
    m_portfolioShareDetailsHasBeenSet = true;
    m_portfolioShareDetails.emplace_back(std::forward<PortfolioShareDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribePortfolioSharesResult& WithRequestId(RequestIdT&& value) {
