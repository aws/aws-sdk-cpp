...
class DescribeProvisioningArtifactResult {
 public:
  ...
  AWS_SERVICECATALOG_API DescribeProvisioningArtifactResult& operator=(
  ...
  template <typename ProvisioningArtifactDetailT = ProvisioningArtifactDetail>
  DescribeProvisioningArtifactResult& WithProvisioningArtifactDetail(ProvisioningArtifactDetailT&& value) {
  ...
  template <typename InfoT = Aws::Map<Aws::String, Aws::String>>
  DescribeProvisioningArtifactResult& WithInfo(InfoT&& value) {
  ...
  inline DescribeProvisioningArtifactResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProvisioningArtifactParametersT = Aws::Vector<ProvisioningArtifactParameter>>
  DescribeProvisioningArtifactResult& WithProvisioningArtifactParameters(ProvisioningArtifactParametersT&& value) {
  ...
  DescribeProvisioningArtifactResult& AddProvisioningArtifactParameters(ProvisioningArtifactParametersT&& value) {
    m_provisioningArtifactParametersHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeProvisioningArtifactResult& WithRequestId(RequestIdT&& value) {
