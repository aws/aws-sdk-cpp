...
class ListOrganizationPortfolioAccessRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListOrganizationPortfolioAccessRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename PortfolioIdT = Aws::String>
  ListOrganizationPortfolioAccessRequest& WithPortfolioId(PortfolioIdT&& value) {
  ...
  inline void SetOrganizationNodeType(OrganizationNodeType value) {
    m_organizationNodeTypeHasBeenSet = true;
    m_organizationNodeType = value;
  }
  inline ListOrganizationPortfolioAccessRequest& WithOrganizationNodeType(OrganizationNodeType value) {
    SetOrganizationNodeType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListOrganizationPortfolioAccessRequest& WithPageToken(PageTokenT&& value) {
  ...
  inline ListOrganizationPortfolioAccessRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
