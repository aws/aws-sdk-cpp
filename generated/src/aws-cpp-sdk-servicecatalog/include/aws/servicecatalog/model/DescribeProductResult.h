...
class DescribeProductResult {
 public:
  ...
  template <typename ProductViewSummaryT = ProductViewSummary>
  DescribeProductResult& WithProductViewSummary(ProductViewSummaryT&& value) {
  ...
  void SetProvisioningArtifacts(ProvisioningArtifactsT&& value) {
    m_provisioningArtifactsHasBeenSet = true;
    m_provisioningArtifacts = std::forward<ProvisioningArtifactsT>(value);
  }
  template <typename ProvisioningArtifactsT = Aws::Vector<ProvisioningArtifact>>
  DescribeProductResult& WithProvisioningArtifacts(ProvisioningArtifactsT&& value) {
    SetProvisioningArtifacts(std::forward<ProvisioningArtifactsT>(value));
    return *this;
  }
  template <typename ProvisioningArtifactsT = ProvisioningArtifact>
  DescribeProductResult& AddProvisioningArtifacts(ProvisioningArtifactsT&& value) {
    m_provisioningArtifactsHasBeenSet = true;
    m_provisioningArtifacts.emplace_back(std::forward<ProvisioningArtifactsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename BudgetsT = Aws::Vector<BudgetDetail>>
  DescribeProductResult& WithBudgets(BudgetsT&& value) {
    SetBudgets(std::forward<BudgetsT>(value));
    return *this;
  }
  template <typename BudgetsT = BudgetDetail>
  DescribeProductResult& AddBudgets(BudgetsT&& value) {
    m_budgetsHasBeenSet = true;
  ...
  void SetLaunchPaths(LaunchPathsT&& value) {
    m_launchPathsHasBeenSet = true;
    m_launchPaths = std::forward<LaunchPathsT>(value);
  }
  template <typename LaunchPathsT = Aws::Vector<LaunchPath>>
  DescribeProductResult& WithLaunchPaths(LaunchPathsT&& value) {
    SetLaunchPaths(std::forward<LaunchPathsT>(value));
    return *this;
  }
  template <typename LaunchPathsT = LaunchPath>
  DescribeProductResult& AddLaunchPaths(LaunchPathsT&& value) {
    m_launchPathsHasBeenSet = true;
    m_launchPaths.emplace_back(std::forward<LaunchPathsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeProductResult& WithRequestId(RequestIdT&& value) {
