...
class AcceptPortfolioShareRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  AcceptPortfolioShareRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename PortfolioIdT = Aws::String>
  AcceptPortfolioShareRequest& WithPortfolioId(PortfolioIdT&& value) {
  ...
  inline void SetPortfolioShareType(PortfolioShareType value) {
    m_portfolioShareTypeHasBeenSet = true;
    m_portfolioShareType = value;
  }
  inline AcceptPortfolioShareRequest& WithPortfolioShareType(PortfolioShareType value) {
    SetPortfolioShareType(value);
    return *this;
  }
  ///@}
 private:
