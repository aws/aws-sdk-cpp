...
class UpdateProductResult {
 public:
  ...
  template <typename ProductViewDetailT = ProductViewDetail>
  UpdateProductResult& WithProductViewDetail(ProductViewDetailT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  UpdateProductResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  UpdateProductResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateProductResult& WithRequestId(RequestIdT&& value) {
