...
struct ListServiceActionsPaginationTraits {
  using RequestType = Model::ListServiceActionsRequest;
  using ResultType = Model::ListServiceActionsResult;
  using OutcomeType = Model::ListServiceActionsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListServiceActions(request); }
