...
class ListPrincipalsForPortfolioRequest : public ServiceCatalogRequest {
 public:
  AWS_SERVICECATALOG_API ListPrincipalsForPortfolioRequest() = default;
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListPrincipalsForPortfolioRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename PortfolioIdT = Aws::String>
  ListPrincipalsForPortfolioRequest& WithPortfolioId(PortfolioIdT&& value) {
  ...
  inline ListPrincipalsForPortfolioRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListPrincipalsForPortfolioRequest& WithPageToken(PageTokenT&& value) {
