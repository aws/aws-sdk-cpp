...
class ListPrincipalsForPortfolioResult {
 public:
  ...
  AWS_SERVICECATALOG_API ListPrincipalsForPortfolioResult& operator=(
  ...
  template <typename PrincipalsT = Aws::Vector<Principal>>
  ListPrincipalsForPortfolioResult& WithPrincipals(PrincipalsT&& value) {
    SetPrincipals(std::forward<PrincipalsT>(value));
    return *this;
  }
  template <typename PrincipalsT = Principal>
  ListPrincipalsForPortfolioResult& AddPrincipals(PrincipalsT&& value) {
    m_principalsHasBeenSet = true;
  ...
  template <typename NextPageTokenT = Aws::String>
  ListPrincipalsForPortfolioResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPrincipalsForPortfolioResult& WithRequestId(RequestIdT&& value) {
