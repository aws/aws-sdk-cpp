...
class SearchProductsAsAdminResult {
 public:
  ...
  void SetProductViewDetails(ProductViewDetailsT&& value) {
    m_productViewDetailsHasBeenSet = true;
    m_productViewDetails = std::forward<ProductViewDetailsT>(value);
  }
  template <typename ProductViewDetailsT = Aws::Vector<ProductViewDetail>>
  SearchProductsAsAdminResult& WithProductViewDetails(ProductViewDetailsT&& value) {
    SetProductViewDetails(std::forward<ProductViewDetailsT>(value));
    return *this;
  }
  template <typename ProductViewDetailsT = ProductViewDetail>
  SearchProductsAsAdminResult& AddProductViewDetails(ProductViewDetailsT&& value) {
    m_productViewDetailsHasBeenSet = true;
    m_productViewDetails.emplace_back(std::forward<ProductViewDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  SearchProductsAsAdminResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchProductsAsAdminResult& WithRequestId(RequestIdT&& value) {
