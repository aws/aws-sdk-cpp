...
class DeleteProvisionedProductPlanRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  DeleteProvisionedProductPlanRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename PlanIdT = Aws::String>
  DeleteProvisionedProductPlanRequest& WithPlanId(PlanIdT&& value) {
  ...
  inline void SetIgnoreErrors(bool value) {
    m_ignoreErrorsHasBeenSet = true;
    m_ignoreErrors = value;
  }
  inline DeleteProvisionedProductPlanRequest& WithIgnoreErrors(bool value) {
