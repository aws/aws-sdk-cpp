...
class BatchAssociateServiceActionWithProvisioningArtifactResult {
 public:
  ...
  AWS_SERVICECATALOG_API BatchAssociateServiceActionWithProvisioningArtifactResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename FailedServiceActionAssociationsT = Aws::Vector<FailedServiceActionAssociation>>
  BatchAssociateServiceActionWithProvisioningArtifactResult& WithFailedServiceActionAssociations(FailedServiceActionAssociationsT&& value) {
  ...
  BatchAssociateServiceActionWithProvisioningArtifactResult& AddFailedServiceActionAssociations(FailedServiceActionAssociationsT&& value) {
    m_failedServiceActionAssociationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchAssociateServiceActionWithProvisioningArtifactResult& WithRequestId(RequestIdT&& value) {
