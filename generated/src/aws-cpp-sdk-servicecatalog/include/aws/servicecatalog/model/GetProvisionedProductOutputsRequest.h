...
class GetProvisionedProductOutputsRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  GetProvisionedProductOutputsRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ProvisionedProductIdT = Aws::String>
  GetProvisionedProductOutputsRequest& WithProvisionedProductId(ProvisionedProductIdT&& value) {
  ...
  template <typename ProvisionedProductNameT = Aws::String>
  GetProvisionedProductOutputsRequest& WithProvisionedProductName(ProvisionedProductNameT&& value) {
  ...
  template <typename OutputKeysT = Aws::Vector<Aws::String>>
  GetProvisionedProductOutputsRequest& WithOutputKeys(OutputKeysT&& value) {
    SetOutputKeys(std::forward<OutputKeysT>(value));
    return *this;
  }
  template <typename OutputKeysT = Aws::String>
  GetProvisionedProductOutputsRequest& AddOutputKeys(OutputKeysT&& value) {
    m_outputKeysHasBeenSet = true;
  ...
  inline GetProvisionedProductOutputsRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  GetProvisionedProductOutputsRequest& WithPageToken(PageTokenT&& value) {
