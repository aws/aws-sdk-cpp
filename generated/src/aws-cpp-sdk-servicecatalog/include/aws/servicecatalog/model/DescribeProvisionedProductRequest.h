...
class DescribeProvisionedProductRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  DescribeProvisionedProductRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename IdT = Aws::String>
  DescribeProvisionedProductRequest& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  DescribeProvisionedProductRequest& WithName(NameT&& value) {
