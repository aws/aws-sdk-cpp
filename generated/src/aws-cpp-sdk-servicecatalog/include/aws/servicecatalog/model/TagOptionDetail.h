...
class TagOptionDetail {
 public:
  ...
  template <typename KeyT = Aws::String>
  TagOptionDetail& WithKey(KeyT&& value) {
  ...
  template <typename ValueT = Aws::String>
  TagOptionDetail& WithValue(ValueT&& value) {
  ...
  inline TagOptionDetail& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  TagOptionDetail& WithId(IdT&& value) {
  ...
  template <typename OwnerT = Aws::String>
  TagOptionDetail& WithOwner(OwnerT&& value) {
