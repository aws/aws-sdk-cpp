...
struct ListBudgetsForResourcePaginationTraits {
  using RequestType = Model::ListBudgetsForResourceRequest;
  using ResultType = Model::ListBudgetsForResourceResult;
  using OutcomeType = Model::ListBudgetsForResourceOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListBudgetsForResource(request); }
