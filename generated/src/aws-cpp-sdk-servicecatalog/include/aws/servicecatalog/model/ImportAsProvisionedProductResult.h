...
class ImportAsProvisionedProductResult {
 public:
  ...
  AWS_SERVICECATALOG_API ImportAsProvisionedProductResult& operator=(
  ...
  template <typename RecordDetailT = RecordDetail>
  ImportAsProvisionedProductResult& WithRecordDetail(RecordDetailT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ImportAsProvisionedProductResult& WithRequestId(RequestIdT&& value) {
