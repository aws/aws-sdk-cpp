...
class DisassociateProductFromPortfolioRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  DisassociateProductFromPortfolioRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  DisassociateProductFromPortfolioRequest& WithProductId(ProductIdT&& value) {
  ...
  template <typename PortfolioIdT = Aws::String>
  DisassociateProductFromPortfolioRequest& WithPortfolioId(PortfolioIdT&& value) {
