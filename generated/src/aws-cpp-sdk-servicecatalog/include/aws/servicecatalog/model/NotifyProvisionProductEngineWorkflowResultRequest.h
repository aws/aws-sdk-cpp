...
class NotifyProvisionProductEngineWorkflowResultRequest : public ServiceCatalogRequest {
 public:
  ...
  void SetWorkflowToken(WorkflowTokenT&& value) {
    m_workflowTokenHasBeenSet = true;
    m_workflowToken = std::forward<WorkflowTokenT>(value);
  }
  template <typename WorkflowTokenT = Aws::String>
  NotifyProvisionProductEngineWorkflowResultRequest& WithWorkflowToken(WorkflowTokenT&& value) {
    SetWorkflowToken(std::forward<WorkflowTokenT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RecordIdT = Aws::String>
  NotifyProvisionProductEngineWorkflowResultRequest& WithRecordId(RecordIdT&& value) {
  ...
  inline void SetStatus(EngineWorkflowStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline NotifyProvisionProductEngineWorkflowResultRequest& WithStatus(EngineWorkflowStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureReasonT = Aws::String>
  NotifyProvisionProductEngineWorkflowResultRequest& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename ResourceIdentifierT = EngineWorkflowResourceIdentifier>
  NotifyProvisionProductEngineWorkflowResultRequest& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename OutputsT = Aws::Vector<RecordOutput>>
  NotifyProvisionProductEngineWorkflowResultRequest& WithOutputs(OutputsT&& value) {
    SetOutputs(std::forward<OutputsT>(value));
    return *this;
  }
  template <typename OutputsT = RecordOutput>
  NotifyProvisionProductEngineWorkflowResultRequest& AddOutputs(OutputsT&& value) {
    m_outputsHasBeenSet = true;
  ...
  template <typename IdempotencyTokenT = Aws::String>
  NotifyProvisionProductEngineWorkflowResultRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
