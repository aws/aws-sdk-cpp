...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICECATALOG_API DescribeRecordRequest() = default;
    ...
    template<typename AcceptLanguageT = Aws::String>
    DescribeRecordRequest& WithAcceptLanguage(AcceptLanguageT&& value) { SetAcceptLanguage(std::forward<AcceptLanguageT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    DescribeRecordRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename PageTokenT = Aws::String>
    DescribeRecordRequest& WithPageToken(PageTokenT&& value) { SetPageToken(std::forward<PageTokenT>(value)); return *this;}
    ///@}
