...
class DescribeRecordRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  DescribeRecordRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename IdT = Aws::String>
  DescribeRecordRequest& WithId(IdT&& value) {
  ...
  template <typename PageTokenT = Aws::String>
  DescribeRecordRequest& WithPageToken(PageTokenT&& value) {
  ...
  inline DescribeRecordRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
