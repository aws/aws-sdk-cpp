...
class DescribeCopyProductStatusResult {
 public:
  ...
  inline void SetCopyProductStatus(CopyProductStatus value) {
    m_copyProductStatusHasBeenSet = true;
    m_copyProductStatus = value;
  }
  inline DescribeCopyProductStatusResult& WithCopyProductStatus(CopyProductStatus value) {
    SetCopyProductStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TargetProductIdT = Aws::String>
  DescribeCopyProductStatusResult& WithTargetProductId(TargetProductIdT&& value) {
  ...
  template <typename StatusDetailT = Aws::String>
  DescribeCopyProductStatusResult& WithStatusDetail(StatusDetailT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCopyProductStatusResult& WithRequestId(RequestIdT&& value) {
