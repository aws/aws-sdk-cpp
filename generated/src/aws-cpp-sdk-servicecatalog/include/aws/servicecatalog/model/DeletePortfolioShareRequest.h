...
class DeletePortfolioShareRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  DeletePortfolioShareRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename PortfolioIdT = Aws::String>
  DeletePortfolioShareRequest& WithPortfolioId(PortfolioIdT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  DeletePortfolioShareRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename OrganizationNodeT = OrganizationNode>
  DeletePortfolioShareRequest& WithOrganizationNode(OrganizationNodeT&& value) {
