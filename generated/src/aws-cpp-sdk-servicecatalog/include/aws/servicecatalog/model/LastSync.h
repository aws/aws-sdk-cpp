...
class LastSync {
 public:
  ...
  inline void SetLastSyncStatus(LastSyncStatus value) {
    m_lastSyncStatusHasBeenSet = true;
    m_lastSyncStatus = value;
  }
  inline LastSync& WithLastSyncStatus(LastSyncStatus value) {
  ...
  void SetLastSuccessfulSyncProvisioningArtifactId(LastSuccessfulSyncProvisioningArtifactIdT&& value) {
    ...
    m_lastSuccessfulSyncProvisioningArtifactId = std::forward<LastSuccessfulSyncProvisioningArtifactIdT>(value);
  }
  template <typename LastSuccessfulSyncProvisioningArtifactIdT = Aws::String>
  LastSync& WithLastSuccessfulSyncProvisioningArtifactId(LastSuccessfulSyncProvisioningArtifactIdT&& value) {
    SetLastSuccessfulSyncProvisioningArtifactId(std::forward<LastSuccessfulSyncProvisioningArtifactIdT>(value));
    return *this;
  }
  ///@}
 private:
