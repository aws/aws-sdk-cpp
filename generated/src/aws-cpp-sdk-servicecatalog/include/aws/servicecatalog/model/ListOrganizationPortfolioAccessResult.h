...
class ListOrganizationPortfolioAccessResult {
 public:
  ...
  AWS_SERVICECATALOG_API ListOrganizationPortfolioAccessResult& operator=(
  ...
  void SetOrganizationNodes(OrganizationNodesT&& value) {
    m_organizationNodesHasBeenSet = true;
    m_organizationNodes = std::forward<OrganizationNodesT>(value);
  }
  template <typename OrganizationNodesT = Aws::Vector<OrganizationNode>>
  ListOrganizationPortfolioAccessResult& WithOrganizationNodes(OrganizationNodesT&& value) {
    SetOrganizationNodes(std::forward<OrganizationNodesT>(value));
    return *this;
  }
  template <typename OrganizationNodesT = OrganizationNode>
  ListOrganizationPortfolioAccessResult& AddOrganizationNodes(OrganizationNodesT&& value) {
    m_organizationNodesHasBeenSet = true;
    m_organizationNodes.emplace_back(std::forward<OrganizationNodesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  ListOrganizationPortfolioAccessResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOrganizationPortfolioAccessResult& WithRequestId(RequestIdT&& value) {
