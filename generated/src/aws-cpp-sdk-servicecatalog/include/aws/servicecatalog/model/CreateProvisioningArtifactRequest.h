...
class CreateProvisioningArtifactRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename AcceptLanguageT = Aws::String>
  CreateProvisioningArtifactRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  CreateProvisioningArtifactRequest& WithProductId(ProductIdT&& value) {
  ...
  template <typename ParametersT = ProvisioningArtifactProperties>
  CreateProvisioningArtifactRequest& WithParameters(ParametersT&& value) {
  ...
  template <typename IdempotencyTokenT = Aws::String>
  CreateProvisioningArtifactRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
