...
class TerminateProvisionedProductRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename ProvisionedProductNameT = Aws::String>
  TerminateProvisionedProductRequest& WithProvisionedProductName(ProvisionedProductNameT&& value) {
  ...
  template <typename ProvisionedProductIdT = Aws::String>
  TerminateProvisionedProductRequest& WithProvisionedProductId(ProvisionedProductIdT&& value) {
  ...
  void SetTerminateToken(TerminateTokenT&& value) {
    m_terminateTokenHasBeenSet = true;
    m_terminateToken = std::forward<TerminateTokenT>(value);
  }
  template <typename TerminateTokenT = Aws::String>
  TerminateProvisionedProductRequest& WithTerminateToken(TerminateTokenT&& value) {
    SetTerminateToken(std::forward<TerminateTokenT>(value));
    return *this;
  }
  ///@}
  ...
  inline TerminateProvisionedProductRequest& WithIgnoreErrors(bool value) {
  ...
  template <typename AcceptLanguageT = Aws::String>
  TerminateProvisionedProductRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  inline void SetRetainPhysicalResources(bool value) {
    m_retainPhysicalResourcesHasBeenSet = true;
    m_retainPhysicalResources = value;
  }
  inline TerminateProvisionedProductRequest& WithRetainPhysicalResources(bool value) {
    SetRetainPhysicalResources(value);
    return *this;
  }
  ///@}
 private:
