...
class DescribeProvisioningParametersResult {
 public:
  ...
  AWS_SERVICECATALOG_API DescribeProvisioningParametersResult& operator=(
   ...
   */
  inline const Aws::Vector<ProvisioningArtifactParameter>& GetProvisioningArtifactParameters() const {
    return m_provisioningArtifactParameters;
  }
  template <typename ProvisioningArtifactParametersT = Aws::Vector<ProvisioningArtifactParameter>>
  void SetProvisioningArtifactParameters(ProvisioningArtifactParametersT&& value) {
    m_provisioningArtifactParametersHasBeenSet = true;
    m_provisioningArtifactParameters = std::forward<ProvisioningArtifactParametersT>(value);
  }
  template <typename ProvisioningArtifactParametersT = Aws::Vector<ProvisioningArtifactParameter>>
  DescribeProvisioningParametersResult& WithProvisioningArtifactParameters(ProvisioningArtifactParametersT&& value) {
    SetProvisioningArtifactParameters(std::forward<ProvisioningArtifactParametersT>(value));
    return *this;
  }
  ...
  DescribeProvisioningParametersResult& AddProvisioningArtifactParameters(ProvisioningArtifactParametersT&& value) {
    m_provisioningArtifactParametersHasBeenSet = true;
    m_provisioningArtifactParameters.emplace_back(std::forward<ProvisioningArtifactParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConstraintSummaries(ConstraintSummariesT&& value) {
    ...
    m_constraintSummaries = std::forward<ConstraintSummariesT>(value);
  }
  template <typename ConstraintSummariesT = Aws::Vector<ConstraintSummary>>
  DescribeProvisioningParametersResult& WithConstraintSummaries(ConstraintSummariesT&& value) {
    SetConstraintSummaries(std::forward<ConstraintSummariesT>(value));
    return *this;
  }
  ...
  DescribeProvisioningParametersResult& AddConstraintSummaries(ConstraintSummariesT&& value) {
    m_constraintSummariesHasBeenSet = true;
    m_constraintSummaries.emplace_back(std::forward<ConstraintSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  DescribeProvisioningParametersResult& AddUsageInstructions(UsageInstructionsT&& value) {
    m_usageInstructionsHasBeenSet = true;
    m_usageInstructions.emplace_back(std::forward<UsageInstructionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProvisioningArtifactPreferences(ProvisioningArtifactPreferencesT&& value) {
    m_provisioningArtifactPreferencesHasBeenSet = true;
    m_provisioningArtifactPreferences = std::forward<ProvisioningArtifactPreferencesT>(value);
  }
  template <typename ProvisioningArtifactPreferencesT = ProvisioningArtifactPreferences>
  DescribeProvisioningParametersResult& WithProvisioningArtifactPreferences(ProvisioningArtifactPreferencesT&& value) {
    SetProvisioningArtifactPreferences(std::forward<ProvisioningArtifactPreferencesT>(value));
    return *this;
  }
  ///@}
   ...
   * artifact.</p>
   */
  inline const Aws::Vector<ProvisioningArtifactOutput>& GetProvisioningArtifactOutputKeys() const {
    return m_provisioningArtifactOutputKeys;
  }
  template <typename ProvisioningArtifactOutputKeysT = Aws::Vector<ProvisioningArtifactOutput>>
  void SetProvisioningArtifactOutputKeys(ProvisioningArtifactOutputKeysT&& value) {
    m_provisioningArtifactOutputKeysHasBeenSet = true;
    m_provisioningArtifactOutputKeys = std::forward<ProvisioningArtifactOutputKeysT>(value);
  }
  template <typename ProvisioningArtifactOutputKeysT = Aws::Vector<ProvisioningArtifactOutput>>
  DescribeProvisioningParametersResult& WithProvisioningArtifactOutputKeys(ProvisioningArtifactOutputKeysT&& value) {
    SetProvisioningArtifactOutputKeys(std::forward<ProvisioningArtifactOutputKeysT>(value));
    return *this;
  }
  ...
  DescribeProvisioningParametersResult& AddProvisioningArtifactOutputKeys(ProvisioningArtifactOutputKeysT&& value) {
    m_provisioningArtifactOutputKeysHasBeenSet = true;
    m_provisioningArtifactOutputKeys.emplace_back(std::forward<ProvisioningArtifactOutputKeysT>(value));
    return *this;
  }
  ///@}
