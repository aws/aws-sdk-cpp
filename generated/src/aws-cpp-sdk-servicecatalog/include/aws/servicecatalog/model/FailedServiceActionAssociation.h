...
class FailedServiceActionAssociation {
 public:
  ...
  inline void SetErrorCode(ServiceActionAssociationErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline FailedServiceActionAssociation& WithErrorCode(ServiceActionAssociationErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
