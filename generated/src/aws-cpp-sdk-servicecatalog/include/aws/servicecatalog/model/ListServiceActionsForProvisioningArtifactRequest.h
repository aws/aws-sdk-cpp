...
namespace Model
{
  ...
  public:
    ...
    template<typename ProductIdT = Aws::String>
    ListServiceActionsForProvisioningArtifactRequest& WithProductId(ProductIdT&& value) { SetProductId(std::forward<ProductIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ProvisioningArtifactIdT = Aws::String>
    ListServiceActionsForProvisioningArtifactRequest& WithProvisioningArtifactId(ProvisioningArtifactIdT&& value) { SetProvisioningArtifactId(std::forward<ProvisioningArtifactIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PageTokenT = Aws::String>
    ListServiceActionsForProvisioningArtifactRequest& WithPageToken(PageTokenT&& value) { SetPageToken(std::forward<PageTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename AcceptLanguageT = Aws::String>
    ListServiceActionsForProvisioningArtifactRequest& WithAcceptLanguage(AcceptLanguageT&& value) { SetAcceptLanguage(std::forward<AcceptLanguageT>(value)); return *this;}
    ///@}
  private:
