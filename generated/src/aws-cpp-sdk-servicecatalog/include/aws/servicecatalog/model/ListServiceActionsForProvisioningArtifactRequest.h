...
class ListServiceActionsForProvisioningArtifactRequest : public ServiceCatalogRequest {
 public:
  AWS_SERVICECATALOG_API ListServiceActionsForProvisioningArtifactRequest() = default;
  ...
  template <typename ProductIdT = Aws::String>
  ListServiceActionsForProvisioningArtifactRequest& WithProductId(ProductIdT&& value) {
  ...
  template <typename ProvisioningArtifactIdT = Aws::String>
  ListServiceActionsForProvisioningArtifactRequest& WithProvisioningArtifactId(ProvisioningArtifactIdT&& value) {
  ...
  inline ListServiceActionsForProvisioningArtifactRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PageTokenT = Aws::String>
  ListServiceActionsForProvisioningArtifactRequest& WithPageToken(PageTokenT&& value) {
  ...
  template <typename AcceptLanguageT = Aws::String>
  ListServiceActionsForProvisioningArtifactRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
