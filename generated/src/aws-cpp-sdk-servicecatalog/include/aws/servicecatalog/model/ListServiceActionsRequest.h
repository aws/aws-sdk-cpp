...
namespace Model
{
  ...
  public:
    ...
    template<typename AcceptLanguageT = Aws::String>
    ListServiceActionsRequest& WithAcceptLanguage(AcceptLanguageT&& value) { SetAcceptLanguage(std::forward<AcceptLanguageT>(value)); return *this;}
    ///@}
    ...
    template<typename PageTokenT = Aws::String>
    ListServiceActionsRequest& WithPageToken(PageTokenT&& value) { SetPageToken(std::forward<PageTokenT>(value)); return *this;}
    ///@}
  private:
