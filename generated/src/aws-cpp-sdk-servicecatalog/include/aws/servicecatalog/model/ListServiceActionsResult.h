...
namespace Model
{
  ...
  {
  public:
    AWS_SERVICECATALOG_API ListServiceActionsResult();
    ...
    inline ListServiceActionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListServiceActionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListServiceActionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
