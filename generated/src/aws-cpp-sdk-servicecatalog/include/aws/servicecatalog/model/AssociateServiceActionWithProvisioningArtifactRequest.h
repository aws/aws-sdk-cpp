...
class AssociateServiceActionWithProvisioningArtifactRequest : public ServiceCatalogRequest {
 public:
  ...
  template <typename ProductIdT = Aws::String>
  AssociateServiceActionWithProvisioningArtifactRequest& WithProductId(ProductIdT&& value) {
  ...
  template <typename ProvisioningArtifactIdT = Aws::String>
  AssociateServiceActionWithProvisioningArtifactRequest& WithProvisioningArtifactId(ProvisioningArtifactIdT&& value) {
  ...
  template <typename ServiceActionIdT = Aws::String>
  AssociateServiceActionWithProvisioningArtifactRequest& WithServiceActionId(ServiceActionIdT&& value) {
  ...
  template <typename AcceptLanguageT = Aws::String>
  AssociateServiceActionWithProvisioningArtifactRequest& WithAcceptLanguage(AcceptLanguageT&& value) {
  ...
  template <typename IdempotencyTokenT = Aws::String>
  AssociateServiceActionWithProvisioningArtifactRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
