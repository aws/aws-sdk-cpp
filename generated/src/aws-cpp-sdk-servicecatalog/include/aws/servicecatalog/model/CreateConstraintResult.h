...
class CreateConstraintResult {
 public:
  ...
  template <typename ConstraintDetailT = ConstraintDetail>
  CreateConstraintResult& WithConstraintDetail(ConstraintDetailT&& value) {
  ...
  template <typename ConstraintParametersT = Aws::String>
  CreateConstraintResult& WithConstraintParameters(ConstraintParametersT&& value) {
  ...
  inline CreateConstraintResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateConstraintResult& WithRequestId(RequestIdT&& value) {
