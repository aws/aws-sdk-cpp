...
class PortfolioShareDetail {
 public:
  ...
  inline PortfolioShareDetail& WithType(DescribePortfolioShareType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline PortfolioShareDetail& WithAccepted(bool value) {
    SetAccepted(value);
    return *this;
  }
  ///@}
  ...
  inline PortfolioShareDetail& WithShareTagOptions(bool value) {
  ...
  inline PortfolioShareDetail& WithSharePrincipals(bool value) {
