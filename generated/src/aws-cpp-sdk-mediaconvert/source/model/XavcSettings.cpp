...
XavcSettings::XavcSettings(JsonView jsonValue) { *this = jsonValue; }

XavcSettings& XavcSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("adaptiveQuantization")) {
    m_adaptiveQuantization =
        XavcAdaptiveQuantizationMapper::GetXavcAdaptiveQuantizationForName(jsonValue.GetString("adaptiveQuantization"));
  ...
  if (jsonValue.ValueExists("framerateConversionAlgorithm")) {
    m_framerateConversionAlgorithm = XavcFramerateConversionAlgorithmMapper::GetXavcFramerateConversionAlgorithmForName(
  ...
  if (jsonValue.ValueExists("spatialAdaptiveQuantization")) {
    m_spatialAdaptiveQuantization = XavcSpatialAdaptiveQuantizationMapper::GetXavcSpatialAdaptiveQuantizationForName(
  ...
  if (jsonValue.ValueExists("temporalAdaptiveQuantization")) {
    m_temporalAdaptiveQuantization = XavcTemporalAdaptiveQuantizationMapper::GetXavcTemporalAdaptiveQuantizationForName(
...
JsonValue XavcSettings::Jsonize() const {
  ...
  if (m_framerateConversionAlgorithmHasBeenSet) {
    payload.WithString("framerateConversionAlgorithm",
                       XavcFramerateConversionAlgorithmMapper::GetNameForXavcFramerateConversionAlgorithm(m_framerateConversionAlgorithm));
  }
  ...
  if (m_spatialAdaptiveQuantizationHasBeenSet) {
    payload.WithString("spatialAdaptiveQuantization",
                       XavcSpatialAdaptiveQuantizationMapper::GetNameForXavcSpatialAdaptiveQuantization(m_spatialAdaptiveQuantization));
  }

  if (m_temporalAdaptiveQuantizationHasBeenSet) {
    payload.WithString("temporalAdaptiveQuantization",
                       XavcTemporalAdaptiveQuantizationMapper::GetNameForXavcTemporalAdaptiveQuantization(m_temporalAdaptiveQuantization));
  }
