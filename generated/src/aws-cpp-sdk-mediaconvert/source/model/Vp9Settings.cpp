...
Vp9Settings::Vp9Settings(JsonView jsonValue) { *this = jsonValue; }
...
Vp9Settings& Vp9Settings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("framerateConversionAlgorithm")) {
    m_framerateConversionAlgorithm = Vp9FramerateConversionAlgorithmMapper::GetVp9FramerateConversionAlgorithmForName(
...
JsonValue Vp9Settings::Jsonize() const {
  ...
  if (m_framerateConversionAlgorithmHasBeenSet) {
    payload.WithString("framerateConversionAlgorithm",
                       Vp9FramerateConversionAlgorithmMapper::GetNameForVp9FramerateConversionAlgorithm(m_framerateConversionAlgorithm));
  }
