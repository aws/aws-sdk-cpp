...
AvcIntraSettings::AvcIntraSettings(JsonView jsonValue) { *this = jsonValue; }
...
AvcIntraSettings& AvcIntraSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("framerateConversionAlgorithm")) {
    m_framerateConversionAlgorithm = AvcIntraFramerateConversionAlgorithmMapper::GetAvcIntraFramerateConversionAlgorithmForName(
  ...
  if (jsonValue.ValueExists("scanTypeConversionMode")) {
    m_scanTypeConversionMode =
        AvcIntraScanTypeConversionModeMapper::GetAvcIntraScanTypeConversionModeForName(jsonValue.GetString("scanTypeConversionMode"));
...
JsonValue AvcIntraSettings::Jsonize() const {
  ...
  if (m_framerateConversionAlgorithmHasBeenSet) {
    payload.WithString(
        ...
        AvcIntraFramerateConversionAlgorithmMapper::GetNameForAvcIntraFramerateConversionAlgorithm(m_framerateConversionAlgorithm));
  }
  ...
  if (m_scanTypeConversionModeHasBeenSet) {
    payload.WithString("scanTypeConversionMode",
                       AvcIntraScanTypeConversionModeMapper::GetNameForAvcIntraScanTypeConversionMode(m_scanTypeConversionMode));
  }
