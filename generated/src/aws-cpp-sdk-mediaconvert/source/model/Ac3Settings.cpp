...
Ac3Settings::Ac3Settings(JsonView jsonValue) { *this = jsonValue; }
...
Ac3Settings& Ac3Settings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("dynamicRangeCompressionLine")) {
    m_dynamicRangeCompressionLine =
        Ac3DynamicRangeCompressionLineMapper::GetAc3DynamicRangeCompressionLineForName(jsonValue.GetString("dynamicRangeCompressionLine"));
    m_dynamicRangeCompressionLineHasBeenSet = true;
  }
  if (jsonValue.ValueExists("dynamicRangeCompressionProfile")) {
    m_dynamicRangeCompressionProfile = Ac3DynamicRangeCompressionProfileMapper::GetAc3DynamicRangeCompressionProfileForName(
        jsonValue.GetString("dynamicRangeCompressionProfile"));
    m_dynamicRangeCompressionProfileHasBeenSet = true;
  }
  if (jsonValue.ValueExists("dynamicRangeCompressionRf")) {
    m_dynamicRangeCompressionRf =
        Ac3DynamicRangeCompressionRfMapper::GetAc3DynamicRangeCompressionRfForName(jsonValue.GetString("dynamicRangeCompressionRf"));
...
JsonValue Ac3Settings::Jsonize() const {
  ...
  if (m_dynamicRangeCompressionLineHasBeenSet) {
    payload.WithString("dynamicRangeCompressionLine",
                       Ac3DynamicRangeCompressionLineMapper::GetNameForAc3DynamicRangeCompressionLine(m_dynamicRangeCompressionLine));
  }

  if (m_dynamicRangeCompressionProfileHasBeenSet) {
    payload.WithString(
        "dynamicRangeCompressionProfile",
        Ac3DynamicRangeCompressionProfileMapper::GetNameForAc3DynamicRangeCompressionProfile(m_dynamicRangeCompressionProfile));
  }

  if (m_dynamicRangeCompressionRfHasBeenSet) {
    payload.WithString("dynamicRangeCompressionRf",
                       Ac3DynamicRangeCompressionRfMapper::GetNameForAc3DynamicRangeCompressionRf(m_dynamicRangeCompressionRf));
  }
