...
DashIsoGroupSettings::DashIsoGroupSettings(JsonView jsonValue) { *this = jsonValue; }
...
DashIsoGroupSettings& DashIsoGroupSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("audioChannelConfigSchemeIdUri")) {
    m_audioChannelConfigSchemeIdUri = DashIsoGroupAudioChannelConfigSchemeIdUriMapper::GetDashIsoGroupAudioChannelConfigSchemeIdUriForName(
        jsonValue.GetString("audioChannelConfigSchemeIdUri"));
  ...
  if (jsonValue.ValueExists("imageBasedTrickPlay")) {
    m_imageBasedTrickPlay =
        DashIsoImageBasedTrickPlayMapper::GetDashIsoImageBasedTrickPlayForName(jsonValue.GetString("imageBasedTrickPlay"));
  ...
  if (jsonValue.ValueExists("mpdManifestBandwidthType")) {
    m_mpdManifestBandwidthType =
        DashIsoMpdManifestBandwidthTypeMapper::GetDashIsoMpdManifestBandwidthTypeForName(jsonValue.GetString("mpdManifestBandwidthType"));
  ...
  if (jsonValue.ValueExists("ptsOffsetHandlingForBFrames")) {
    m_ptsOffsetHandlingForBFrames = DashIsoPtsOffsetHandlingForBFramesMapper::GetDashIsoPtsOffsetHandlingForBFramesForName(
  ...
  if (jsonValue.ValueExists("segmentLengthControl")) {
    m_segmentLengthControl =
        DashIsoSegmentLengthControlMapper::GetDashIsoSegmentLengthControlForName(jsonValue.GetString("segmentLengthControl"));
    m_segmentLengthControlHasBeenSet = true;
  }
  if (jsonValue.ValueExists("videoCompositionOffsets")) {
    m_videoCompositionOffsets =
        DashIsoVideoCompositionOffsetsMapper::GetDashIsoVideoCompositionOffsetsForName(jsonValue.GetString("videoCompositionOffsets"));
  ...
  if (jsonValue.ValueExists("writeSegmentTimelineInRepresentation")) {
    m_writeSegmentTimelineInRepresentation =
        DashIsoWriteSegmentTimelineInRepresentationMapper::GetDashIsoWriteSegmentTimelineInRepresentationForName(
...
JsonValue DashIsoGroupSettings::Jsonize() const {
  ...
  if (m_audioChannelConfigSchemeIdUriHasBeenSet) {
    payload.WithString("audioChannelConfigSchemeIdUri",
                       DashIsoGroupAudioChannelConfigSchemeIdUriMapper::GetNameForDashIsoGroupAudioChannelConfigSchemeIdUri(
                           m_audioChannelConfigSchemeIdUri));
  }
  ...
  if (m_imageBasedTrickPlayHasBeenSet) {
    payload.WithString("imageBasedTrickPlay",
                       DashIsoImageBasedTrickPlayMapper::GetNameForDashIsoImageBasedTrickPlay(m_imageBasedTrickPlay));
  }
  ...
  if (m_mpdManifestBandwidthTypeHasBeenSet) {
    payload.WithString("mpdManifestBandwidthType",
                       DashIsoMpdManifestBandwidthTypeMapper::GetNameForDashIsoMpdManifestBandwidthType(m_mpdManifestBandwidthType));
  }
  ...
  if (m_ptsOffsetHandlingForBFramesHasBeenSet) {
    payload.WithString(
        ...
        DashIsoPtsOffsetHandlingForBFramesMapper::GetNameForDashIsoPtsOffsetHandlingForBFrames(m_ptsOffsetHandlingForBFrames));
  }
  ...
  if (m_segmentLengthControlHasBeenSet) {
    payload.WithString("segmentLengthControl",
                       DashIsoSegmentLengthControlMapper::GetNameForDashIsoSegmentLengthControl(m_segmentLengthControl));
  }

  if (m_videoCompositionOffsetsHasBeenSet) {
    payload.WithString("videoCompositionOffsets",
                       DashIsoVideoCompositionOffsetsMapper::GetNameForDashIsoVideoCompositionOffsets(m_videoCompositionOffsets));
  }

  if (m_writeSegmentTimelineInRepresentationHasBeenSet) {
    payload.WithString("writeSegmentTimelineInRepresentation",
                       DashIsoWriteSegmentTimelineInRepresentationMapper::GetNameForDashIsoWriteSegmentTimelineInRepresentation(
                           m_writeSegmentTimelineInRepresentation));
  }
