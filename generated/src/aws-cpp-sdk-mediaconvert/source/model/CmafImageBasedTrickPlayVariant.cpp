...
CmafImageBasedTrickPlayVariant::CmafImageBasedTrickPlayVariant(JsonView jsonValue) { *this = jsonValue; }

CmafImageBasedTrickPlayVariant& CmafImageBasedTrickPlayVariant::operator=(JsonView jsonValue) {
...
JsonValue CmafImageBasedTrickPlayVariant::Jsonize() const {
  JsonValue payload;
