...
HlsSettings& HlsSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("descriptiveVideoServiceFlag")) {
    m_descriptiveVideoServiceFlag =
        HlsDescriptiveVideoServiceFlagMapper::GetHlsDescriptiveVideoServiceFlagForName(jsonValue.GetString("descriptiveVideoServiceFlag"));
...
JsonValue HlsSettings::Jsonize() const {
  ...
  if (m_descriptiveVideoServiceFlagHasBeenSet) {
    payload.WithString("descriptiveVideoServiceFlag",
                       HlsDescriptiveVideoServiceFlagMapper::GetNameForHlsDescriptiveVideoServiceFlag(m_descriptiveVideoServiceFlag));
  }
