...
M2tsSettings& M2tsSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("forceTsVideoEbpOrder")) {
    m_forceTsVideoEbpOrder =
        M2tsForceTsVideoEbpOrderMapper::GetM2tsForceTsVideoEbpOrderForName(jsonValue.GetString("forceTsVideoEbpOrder"));
  ...
  if (jsonValue.ValueExists("preventBufferUnderflow")) {
    m_preventBufferUnderflow =
        M2tsPreventBufferUnderflowMapper::GetM2tsPreventBufferUnderflowForName(jsonValue.GetString("preventBufferUnderflow"));
...
JsonValue M2tsSettings::Jsonize() const {
  ...
  if (m_preventBufferUnderflowHasBeenSet) {
    payload.WithString("preventBufferUnderflow",
                       M2tsPreventBufferUnderflowMapper::GetNameForM2tsPreventBufferUnderflow(m_preventBufferUnderflow));
  }
