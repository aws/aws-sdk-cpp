...
UncompressedSettings::UncompressedSettings(JsonView jsonValue) { *this = jsonValue; }
...
UncompressedSettings& UncompressedSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("framerateControl")) {
    m_framerateControl =
        UncompressedFramerateControlMapper::GetUncompressedFramerateControlForName(jsonValue.GetString("framerateControl"));
    m_framerateControlHasBeenSet = true;
  }
  if (jsonValue.ValueExists("framerateConversionAlgorithm")) {
    m_framerateConversionAlgorithm = UncompressedFramerateConversionAlgorithmMapper::GetUncompressedFramerateConversionAlgorithmForName(
  ...
  if (jsonValue.ValueExists("scanTypeConversionMode")) {
    m_scanTypeConversionMode = UncompressedScanTypeConversionModeMapper::GetUncompressedScanTypeConversionModeForName(
        jsonValue.GetString("scanTypeConversionMode"));
...
JsonValue UncompressedSettings::Jsonize() const {
  ...
  if (m_framerateConversionAlgorithmHasBeenSet) {
    payload.WithString(
        ...
        UncompressedFramerateConversionAlgorithmMapper::GetNameForUncompressedFramerateConversionAlgorithm(m_framerateConversionAlgorithm));
  }
  ...
  if (m_scanTypeConversionModeHasBeenSet) {
    payload.WithString("scanTypeConversionMode",
                       UncompressedScanTypeConversionModeMapper::GetNameForUncompressedScanTypeConversionMode(m_scanTypeConversionMode));
  }
