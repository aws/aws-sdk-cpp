...
SearchJobsResult::SearchJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

SearchJobsResult& SearchJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
