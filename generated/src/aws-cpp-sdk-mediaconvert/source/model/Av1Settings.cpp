...
Av1Settings::Av1Settings(JsonView jsonValue) { *this = jsonValue; }
...
Av1Settings& Av1Settings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("framerateConversionAlgorithm")) {
    m_framerateConversionAlgorithm = Av1FramerateConversionAlgorithmMapper::GetAv1FramerateConversionAlgorithmForName(
  ...
  if (jsonValue.ValueExists("spatialAdaptiveQuantization")) {
    m_spatialAdaptiveQuantization =
        Av1SpatialAdaptiveQuantizationMapper::GetAv1SpatialAdaptiveQuantizationForName(jsonValue.GetString("spatialAdaptiveQuantization"));
...
JsonValue Av1Settings::Jsonize() const {
  ...
  if (m_framerateConversionAlgorithmHasBeenSet) {
    payload.WithString("framerateConversionAlgorithm",
                       Av1FramerateConversionAlgorithmMapper::GetNameForAv1FramerateConversionAlgorithm(m_framerateConversionAlgorithm));
  }
  ...
  if (m_spatialAdaptiveQuantizationHasBeenSet) {
    payload.WithString("spatialAdaptiveQuantization",
                       Av1SpatialAdaptiveQuantizationMapper::GetNameForAv1SpatialAdaptiveQuantization(m_spatialAdaptiveQuantization));
  }
