...
GifSettings::GifSettings(JsonView jsonValue) { *this = jsonValue; }
...
GifSettings& GifSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("framerateConversionAlgorithm")) {
    m_framerateConversionAlgorithm = GifFramerateConversionAlgorithmMapper::GetGifFramerateConversionAlgorithmForName(
...
JsonValue GifSettings::Jsonize() const {
  ...
  if (m_framerateConversionAlgorithmHasBeenSet) {
    payload.WithString("framerateConversionAlgorithm",
                       GifFramerateConversionAlgorithmMapper::GetNameForGifFramerateConversionAlgorithm(m_framerateConversionAlgorithm));
  }
