...
H264Settings& H264Settings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("flickerAdaptiveQuantization")) {
    m_flickerAdaptiveQuantization = H264FlickerAdaptiveQuantizationMapper::GetH264FlickerAdaptiveQuantizationForName(
        jsonValue.GetString("flickerAdaptiveQuantization"));
  ...
  if (jsonValue.ValueExists("framerateConversionAlgorithm")) {
    m_framerateConversionAlgorithm = H264FramerateConversionAlgorithmMapper::GetH264FramerateConversionAlgorithmForName(
  ...
  if (jsonValue.ValueExists("saliencyAwareEncoding")) {
    m_saliencyAwareEncoding =
        H264SaliencyAwareEncodingMapper::GetH264SaliencyAwareEncodingForName(jsonValue.GetString("saliencyAwareEncoding"));
    m_saliencyAwareEncodingHasBeenSet = true;
  }
  if (jsonValue.ValueExists("scanTypeConversionMode")) {
    m_scanTypeConversionMode =
        H264ScanTypeConversionModeMapper::GetH264ScanTypeConversionModeForName(jsonValue.GetString("scanTypeConversionMode"));
  ...
  if (jsonValue.ValueExists("spatialAdaptiveQuantization")) {
    m_spatialAdaptiveQuantization = H264SpatialAdaptiveQuantizationMapper::GetH264SpatialAdaptiveQuantizationForName(
  ...
  if (jsonValue.ValueExists("temporalAdaptiveQuantization")) {
    m_temporalAdaptiveQuantization = H264TemporalAdaptiveQuantizationMapper::GetH264TemporalAdaptiveQuantizationForName(
  ...
  if (jsonValue.ValueExists("unregisteredSeiTimecode")) {
    m_unregisteredSeiTimecode =
        H264UnregisteredSeiTimecodeMapper::GetH264UnregisteredSeiTimecodeForName(jsonValue.GetString("unregisteredSeiTimecode"));
    m_unregisteredSeiTimecodeHasBeenSet = true;
  }
  if (jsonValue.ValueExists("writeMp4PackagingType")) {
    m_writeMp4PackagingType =
        H264WriteMp4PackagingTypeMapper::GetH264WriteMp4PackagingTypeForName(jsonValue.GetString("writeMp4PackagingType"));
...
JsonValue H264Settings::Jsonize() const {
  ...
  if (m_flickerAdaptiveQuantizationHasBeenSet) {
    payload.WithString("flickerAdaptiveQuantization",
                       H264FlickerAdaptiveQuantizationMapper::GetNameForH264FlickerAdaptiveQuantization(m_flickerAdaptiveQuantization));
  }
  ...
  if (m_framerateConversionAlgorithmHasBeenSet) {
    payload.WithString("framerateConversionAlgorithm",
                       H264FramerateConversionAlgorithmMapper::GetNameForH264FramerateConversionAlgorithm(m_framerateConversionAlgorithm));
  }
  ...
  if (m_saliencyAwareEncodingHasBeenSet) {
    payload.WithString("saliencyAwareEncoding",
                       H264SaliencyAwareEncodingMapper::GetNameForH264SaliencyAwareEncoding(m_saliencyAwareEncoding));
  }

  if (m_scanTypeConversionModeHasBeenSet) {
    payload.WithString("scanTypeConversionMode",
                       H264ScanTypeConversionModeMapper::GetNameForH264ScanTypeConversionMode(m_scanTypeConversionMode));
  }
  ...
  if (m_spatialAdaptiveQuantizationHasBeenSet) {
    payload.WithString("spatialAdaptiveQuantization",
                       H264SpatialAdaptiveQuantizationMapper::GetNameForH264SpatialAdaptiveQuantization(m_spatialAdaptiveQuantization));
  }
  ...
  if (m_temporalAdaptiveQuantizationHasBeenSet) {
    payload.WithString("temporalAdaptiveQuantization",
                       H264TemporalAdaptiveQuantizationMapper::GetNameForH264TemporalAdaptiveQuantization(m_temporalAdaptiveQuantization));
  }

  if (m_unregisteredSeiTimecodeHasBeenSet) {
    payload.WithString("unregisteredSeiTimecode",
                       H264UnregisteredSeiTimecodeMapper::GetNameForH264UnregisteredSeiTimecode(m_unregisteredSeiTimecode));
  }

  if (m_writeMp4PackagingTypeHasBeenSet) {
    payload.WithString("writeMp4PackagingType",
                       H264WriteMp4PackagingTypeMapper::GetNameForH264WriteMp4PackagingType(m_writeMp4PackagingType));
  }
