...
BurninDestinationSettings::BurninDestinationSettings(JsonView jsonValue) { *this = jsonValue; }
...
BurninDestinationSettings& BurninDestinationSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("backgroundColor")) {
    m_backgroundColor =
        BurninSubtitleBackgroundColorMapper::GetBurninSubtitleBackgroundColorForName(jsonValue.GetString("backgroundColor"));
  ...
  if (jsonValue.ValueExists("removeRubyReserveAttributes")) {
    m_removeRubyReserveAttributes =
        RemoveRubyReserveAttributesMapper::GetRemoveRubyReserveAttributesForName(jsonValue.GetString("removeRubyReserveAttributes"));
  ...
  if (jsonValue.ValueExists("stylePassthrough")) {
    m_stylePassthrough =
        BurnInSubtitleStylePassthroughMapper::GetBurnInSubtitleStylePassthroughForName(jsonValue.GetString("stylePassthrough"));
    m_stylePassthroughHasBeenSet = true;
  }
  if (jsonValue.ValueExists("teletextSpacing")) {
    m_teletextSpacing =
        BurninSubtitleTeletextSpacingMapper::GetBurninSubtitleTeletextSpacingForName(jsonValue.GetString("teletextSpacing"));
...
JsonValue BurninDestinationSettings::Jsonize() const {
  ...
  if (m_removeRubyReserveAttributesHasBeenSet) {
    payload.WithString("removeRubyReserveAttributes",
                       RemoveRubyReserveAttributesMapper::GetNameForRemoveRubyReserveAttributes(m_removeRubyReserveAttributes));
  }
  ...
  if (m_stylePassthroughHasBeenSet) {
    payload.WithString("stylePassthrough",
                       BurnInSubtitleStylePassthroughMapper::GetNameForBurnInSubtitleStylePassthrough(m_stylePassthrough));
  }
