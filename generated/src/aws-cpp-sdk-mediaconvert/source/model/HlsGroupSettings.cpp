...
HlsGroupSettings::HlsGroupSettings(JsonView jsonValue) { *this = jsonValue; }
...
HlsGroupSettings& HlsGroupSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("captionLanguageSetting")) {
    m_captionLanguageSetting =
        HlsCaptionLanguageSettingMapper::GetHlsCaptionLanguageSettingForName(jsonValue.GetString("captionLanguageSetting"));
    m_captionLanguageSettingHasBeenSet = true;
  }
  if (jsonValue.ValueExists("captionSegmentLengthControl")) {
    m_captionSegmentLengthControl =
        HlsCaptionSegmentLengthControlMapper::GetHlsCaptionSegmentLengthControlForName(jsonValue.GetString("captionSegmentLengthControl"));
  ...
  if (jsonValue.ValueExists("manifestDurationFormat")) {
    m_manifestDurationFormat =
        HlsManifestDurationFormatMapper::GetHlsManifestDurationFormatForName(jsonValue.GetString("manifestDurationFormat"));
  ...
  if (jsonValue.ValueExists("progressiveWriteHlsManifest")) {
    m_progressiveWriteHlsManifest =
        HlsProgressiveWriteHlsManifestMapper::GetHlsProgressiveWriteHlsManifestForName(jsonValue.GetString("progressiveWriteHlsManifest"));
  ...
  if (jsonValue.ValueExists("targetDurationCompatibilityMode")) {
    m_targetDurationCompatibilityMode = HlsTargetDurationCompatibilityModeMapper::GetHlsTargetDurationCompatibilityModeForName(
  ...
  if (jsonValue.ValueExists("timedMetadataId3Frame")) {
    m_timedMetadataId3Frame =
        HlsTimedMetadataId3FrameMapper::GetHlsTimedMetadataId3FrameForName(jsonValue.GetString("timedMetadataId3Frame"));
...
JsonValue HlsGroupSettings::Jsonize() const {
  ...
  if (m_captionLanguageSettingHasBeenSet) {
    payload.WithString("captionLanguageSetting",
                       HlsCaptionLanguageSettingMapper::GetNameForHlsCaptionLanguageSetting(m_captionLanguageSetting));
  }

  if (m_captionSegmentLengthControlHasBeenSet) {
    payload.WithString("captionSegmentLengthControl",
                       HlsCaptionSegmentLengthControlMapper::GetNameForHlsCaptionSegmentLengthControl(m_captionSegmentLengthControl));
  }
  ...
  if (m_manifestDurationFormatHasBeenSet) {
    payload.WithString("manifestDurationFormat",
                       HlsManifestDurationFormatMapper::GetNameForHlsManifestDurationFormat(m_manifestDurationFormat));
  }
  ...
  if (m_progressiveWriteHlsManifestHasBeenSet) {
    payload.WithString("progressiveWriteHlsManifest",
                       HlsProgressiveWriteHlsManifestMapper::GetNameForHlsProgressiveWriteHlsManifest(m_progressiveWriteHlsManifest));
  }
  ...
  if (m_targetDurationCompatibilityModeHasBeenSet) {
    payload.WithString(
        ...
        HlsTargetDurationCompatibilityModeMapper::GetNameForHlsTargetDurationCompatibilityMode(m_targetDurationCompatibilityMode));
  }

  if (m_timedMetadataId3FrameHasBeenSet) {
    payload.WithString("timedMetadataId3Frame",
                       HlsTimedMetadataId3FrameMapper::GetNameForHlsTimedMetadataId3Frame(m_timedMetadataId3Frame));
  }
