...
Xavc4kProfileSettings::Xavc4kProfileSettings(JsonView jsonValue) { *this = jsonValue; }
...
Xavc4kProfileSettings& Xavc4kProfileSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("flickerAdaptiveQuantization")) {
    m_flickerAdaptiveQuantization = XavcFlickerAdaptiveQuantizationMapper::GetXavcFlickerAdaptiveQuantizationForName(
  ...
  if (jsonValue.ValueExists("qualityTuningLevel")) {
    m_qualityTuningLevel =
        Xavc4kProfileQualityTuningLevelMapper::GetXavc4kProfileQualityTuningLevelForName(jsonValue.GetString("qualityTuningLevel"));
...
JsonValue Xavc4kProfileSettings::Jsonize() const {
  ...
  if (m_flickerAdaptiveQuantizationHasBeenSet) {
    payload.WithString("flickerAdaptiveQuantization",
                       XavcFlickerAdaptiveQuantizationMapper::GetNameForXavcFlickerAdaptiveQuantization(m_flickerAdaptiveQuantization));
  }
  ...
  if (m_qualityTuningLevelHasBeenSet) {
    payload.WithString("qualityTuningLevel",
                       Xavc4kProfileQualityTuningLevelMapper::GetNameForXavc4kProfileQualityTuningLevel(m_qualityTuningLevel));
  }
