...
AacSettings& AacSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("audioDescriptionBroadcasterMix")) {
    m_audioDescriptionBroadcasterMix = AacAudioDescriptionBroadcasterMixMapper::GetAacAudioDescriptionBroadcasterMixForName(
        jsonValue.GetString("audioDescriptionBroadcasterMix"));
...
JsonValue AacSettings::Jsonize() const {
  ...
  if (m_audioDescriptionBroadcasterMixHasBeenSet) {
    payload.WithString(
        ...
        AacAudioDescriptionBroadcasterMixMapper::GetNameForAacAudioDescriptionBroadcasterMix(m_audioDescriptionBroadcasterMix));
  }
