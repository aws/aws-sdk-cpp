...
JobSettings::JobSettings(JsonView jsonValue) { *this = jsonValue; }
...
JobSettings& JobSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("colorConversion3DLUTSettings")) {
    ...
    for (unsigned colorConversion3DLUTSettingsIndex = 0;
         colorConversion3DLUTSettingsIndex < colorConversion3DLUTSettingsJsonList.GetLength(); ++colorConversion3DLUTSettingsIndex) {
...
JsonValue JobSettings::Jsonize() const {
  ...
  if (m_colorConversion3DLUTSettingsHasBeenSet) {
    ...
    for (unsigned colorConversion3DLUTSettingsIndex = 0;
         colorConversion3DLUTSettingsIndex < colorConversion3DLUTSettingsJsonList.GetLength(); ++colorConversion3DLUTSettingsIndex) {
      colorConversion3DLUTSettingsJsonList[colorConversion3DLUTSettingsIndex].AsObject(
          m_colorConversion3DLUTSettings[colorConversion3DLUTSettingsIndex].Jsonize());
    }
