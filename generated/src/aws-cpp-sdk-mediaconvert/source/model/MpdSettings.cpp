...
MpdSettings::MpdSettings(JsonView jsonValue) { *this = jsonValue; }

MpdSettings& MpdSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("accessibilityCaptionHints")) {
    m_accessibilityCaptionHints =
        MpdAccessibilityCaptionHintsMapper::GetMpdAccessibilityCaptionHintsForName(jsonValue.GetString("accessibilityCaptionHints"));
  ...
  if (jsonValue.ValueExists("manifestMetadataSignaling")) {
    m_manifestMetadataSignaling =
        MpdManifestMetadataSignalingMapper::GetMpdManifestMetadataSignalingForName(jsonValue.GetString("manifestMetadataSignaling"));
  ...
  if (jsonValue.ValueExists("timedMetadataBoxVersion")) {
    m_timedMetadataBoxVersion =
        MpdTimedMetadataBoxVersionMapper::GetMpdTimedMetadataBoxVersionForName(jsonValue.GetString("timedMetadataBoxVersion"));
...
JsonValue MpdSettings::Jsonize() const {
  ...
  if (m_accessibilityCaptionHintsHasBeenSet) {
    payload.WithString("accessibilityCaptionHints",
                       MpdAccessibilityCaptionHintsMapper::GetNameForMpdAccessibilityCaptionHints(m_accessibilityCaptionHints));
  }
  ...
  if (m_manifestMetadataSignalingHasBeenSet) {
    payload.WithString("manifestMetadataSignaling",
                       MpdManifestMetadataSignalingMapper::GetNameForMpdManifestMetadataSignaling(m_manifestMetadataSignaling));
  }
  ...
  if (m_timedMetadataBoxVersionHasBeenSet) {
    payload.WithString("timedMetadataBoxVersion",
                       MpdTimedMetadataBoxVersionMapper::GetNameForMpdTimedMetadataBoxVersion(m_timedMetadataBoxVersion));
  }
