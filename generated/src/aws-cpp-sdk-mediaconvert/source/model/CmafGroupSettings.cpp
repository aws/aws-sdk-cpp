...
CmafGroupSettings::CmafGroupSettings(JsonView jsonValue) { *this = jsonValue; }
...
CmafGroupSettings& CmafGroupSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("additionalManifests")) {
    ...
    for (unsigned additionalManifestsIndex = 0; additionalManifestsIndex < additionalManifestsJsonList.GetLength();
         ++additionalManifestsIndex) {
  ...
  if (jsonValue.ValueExists("manifestDurationFormat")) {
    m_manifestDurationFormat =
        CmafManifestDurationFormatMapper::GetCmafManifestDurationFormatForName(jsonValue.GetString("manifestDurationFormat"));
  ...
  if (jsonValue.ValueExists("mpdManifestBandwidthType")) {
    m_mpdManifestBandwidthType =
        CmafMpdManifestBandwidthTypeMapper::GetCmafMpdManifestBandwidthTypeForName(jsonValue.GetString("mpdManifestBandwidthType"));
  ...
  if (jsonValue.ValueExists("ptsOffsetHandlingForBFrames")) {
    m_ptsOffsetHandlingForBFrames = CmafPtsOffsetHandlingForBFramesMapper::GetCmafPtsOffsetHandlingForBFramesForName(
        jsonValue.GetString("ptsOffsetHandlingForBFrames"));
  ...
  if (jsonValue.ValueExists("segmentLengthControl")) {
    m_segmentLengthControl =
        CmafSegmentLengthControlMapper::GetCmafSegmentLengthControlForName(jsonValue.GetString("segmentLengthControl"));
  ...
  if (jsonValue.ValueExists("targetDurationCompatibilityMode")) {
    m_targetDurationCompatibilityMode = CmafTargetDurationCompatibilityModeMapper::GetCmafTargetDurationCompatibilityModeForName(
        jsonValue.GetString("targetDurationCompatibilityMode"));
  ...
  if (jsonValue.ValueExists("videoCompositionOffsets")) {
    m_videoCompositionOffsets =
        CmafVideoCompositionOffsetsMapper::GetCmafVideoCompositionOffsetsForName(jsonValue.GetString("videoCompositionOffsets"));
  ...
  if (jsonValue.ValueExists("writeSegmentTimelineInRepresentation")) {
    m_writeSegmentTimelineInRepresentation =
        CmafWriteSegmentTimelineInRepresentationMapper::GetCmafWriteSegmentTimelineInRepresentationForName(
            jsonValue.GetString("writeSegmentTimelineInRepresentation"));
...
JsonValue CmafGroupSettings::Jsonize() const {
  ...
  if (m_manifestDurationFormatHasBeenSet) {
    payload.WithString("manifestDurationFormat",
                       CmafManifestDurationFormatMapper::GetNameForCmafManifestDurationFormat(m_manifestDurationFormat));
  }
  ...
  if (m_mpdManifestBandwidthTypeHasBeenSet) {
    payload.WithString("mpdManifestBandwidthType",
                       CmafMpdManifestBandwidthTypeMapper::GetNameForCmafMpdManifestBandwidthType(m_mpdManifestBandwidthType));
  }
  ...
  if (m_ptsOffsetHandlingForBFramesHasBeenSet) {
    payload.WithString("ptsOffsetHandlingForBFrames",
                       CmafPtsOffsetHandlingForBFramesMapper::GetNameForCmafPtsOffsetHandlingForBFrames(m_ptsOffsetHandlingForBFrames));
  }
  ...
  if (m_targetDurationCompatibilityModeHasBeenSet) {
    payload.WithString(
        ...
        CmafTargetDurationCompatibilityModeMapper::GetNameForCmafTargetDurationCompatibilityMode(m_targetDurationCompatibilityMode));
  }

  if (m_videoCompositionOffsetsHasBeenSet) {
    payload.WithString("videoCompositionOffsets",
                       CmafVideoCompositionOffsetsMapper::GetNameForCmafVideoCompositionOffsets(m_videoCompositionOffsets));
  }
  ...
  if (m_writeSegmentTimelineInRepresentationHasBeenSet) {
    payload.WithString("writeSegmentTimelineInRepresentation",
                       CmafWriteSegmentTimelineInRepresentationMapper::GetNameForCmafWriteSegmentTimelineInRepresentation(
                           m_writeSegmentTimelineInRepresentation));
  }
