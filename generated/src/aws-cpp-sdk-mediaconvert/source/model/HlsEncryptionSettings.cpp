...
HlsEncryptionSettings::HlsEncryptionSettings(JsonView jsonValue) { *this = jsonValue; }
...
HlsEncryptionSettings& HlsEncryptionSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("initializationVectorInManifest")) {
    m_initializationVectorInManifest = HlsInitializationVectorInManifestMapper::GetHlsInitializationVectorInManifestForName(
        jsonValue.GetString("initializationVectorInManifest"));
...
JsonValue HlsEncryptionSettings::Jsonize() const {
  ...
  if (m_initializationVectorInManifestHasBeenSet) {
    payload.WithString(
        ...
        HlsInitializationVectorInManifestMapper::GetNameForHlsInitializationVectorInManifest(m_initializationVectorInManifest));
  }
