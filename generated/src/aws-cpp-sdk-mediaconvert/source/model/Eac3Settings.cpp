...
Eac3Settings::Eac3Settings(JsonView jsonValue) { *this = jsonValue; }
...
Eac3Settings& Eac3Settings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("dynamicRangeCompressionLine")) {
    m_dynamicRangeCompressionLine = Eac3DynamicRangeCompressionLineMapper::GetEac3DynamicRangeCompressionLineForName(
  ...
  if (jsonValue.ValueExists("dynamicRangeCompressionRf")) {
    m_dynamicRangeCompressionRf =
        Eac3DynamicRangeCompressionRfMapper::GetEac3DynamicRangeCompressionRfForName(jsonValue.GetString("dynamicRangeCompressionRf"));
...
JsonValue Eac3Settings::Jsonize() const {
  ...
  if (m_dynamicRangeCompressionLineHasBeenSet) {
    payload.WithString("dynamicRangeCompressionLine",
                       Eac3DynamicRangeCompressionLineMapper::GetNameForEac3DynamicRangeCompressionLine(m_dynamicRangeCompressionLine));
  }

  if (m_dynamicRangeCompressionRfHasBeenSet) {
    payload.WithString("dynamicRangeCompressionRf",
                       Eac3DynamicRangeCompressionRfMapper::GetNameForEac3DynamicRangeCompressionRf(m_dynamicRangeCompressionRf));
  }
