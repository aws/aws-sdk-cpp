...
ProresSettings::ProresSettings(JsonView jsonValue) { *this = jsonValue; }
...
ProresSettings& ProresSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("framerateConversionAlgorithm")) {
    m_framerateConversionAlgorithm = ProresFramerateConversionAlgorithmMapper::GetProresFramerateConversionAlgorithmForName(
  ...
  if (jsonValue.ValueExists("scanTypeConversionMode")) {
    m_scanTypeConversionMode =
        ProresScanTypeConversionModeMapper::GetProresScanTypeConversionModeForName(jsonValue.GetString("scanTypeConversionMode"));
...
JsonValue ProresSettings::Jsonize() const {
  ...
  if (m_framerateConversionAlgorithmHasBeenSet) {
    payload.WithString(
        ...
        ProresFramerateConversionAlgorithmMapper::GetNameForProresFramerateConversionAlgorithm(m_framerateConversionAlgorithm));
  }
  ...
  if (m_scanTypeConversionModeHasBeenSet) {
    payload.WithString("scanTypeConversionMode",
                       ProresScanTypeConversionModeMapper::GetNameForProresScanTypeConversionMode(m_scanTypeConversionMode));
  }
