...
OutputChannelMapping::OutputChannelMapping(JsonView jsonValue) { *this = jsonValue; }
...
OutputChannelMapping& OutputChannelMapping::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("inputChannelsFineTune")) {
    ...
    for (unsigned inputChannelsFineTuneIndex = 0; inputChannelsFineTuneIndex < inputChannelsFineTuneJsonList.GetLength();
         ++inputChannelsFineTuneIndex) {
