...
Eac3AtmosSettings& Eac3AtmosSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("dialogueIntelligence")) {
    m_dialogueIntelligence =
        Eac3AtmosDialogueIntelligenceMapper::GetEac3AtmosDialogueIntelligenceForName(jsonValue.GetString("dialogueIntelligence"));
  ...
  if (jsonValue.ValueExists("dynamicRangeCompressionLine")) {
    m_dynamicRangeCompressionLine = Eac3AtmosDynamicRangeCompressionLineMapper::GetEac3AtmosDynamicRangeCompressionLineForName(
        jsonValue.GetString("dynamicRangeCompressionLine"));
    m_dynamicRangeCompressionLineHasBeenSet = true;
  }
  if (jsonValue.ValueExists("dynamicRangeCompressionRf")) {
    m_dynamicRangeCompressionRf = Eac3AtmosDynamicRangeCompressionRfMapper::GetEac3AtmosDynamicRangeCompressionRfForName(
        jsonValue.GetString("dynamicRangeCompressionRf"));
    m_dynamicRangeCompressionRfHasBeenSet = true;
  }
  if (jsonValue.ValueExists("dynamicRangeControl")) {
    m_dynamicRangeControl =
        Eac3AtmosDynamicRangeControlMapper::GetEac3AtmosDynamicRangeControlForName(jsonValue.GetString("dynamicRangeControl"));
...
JsonValue Eac3AtmosSettings::Jsonize() const {
  ...
  if (m_dialogueIntelligenceHasBeenSet) {
    payload.WithString("dialogueIntelligence",
                       Eac3AtmosDialogueIntelligenceMapper::GetNameForEac3AtmosDialogueIntelligence(m_dialogueIntelligence));
  }
  ...
  if (m_dynamicRangeCompressionLineHasBeenSet) {
    payload.WithString(
        ...
        Eac3AtmosDynamicRangeCompressionLineMapper::GetNameForEac3AtmosDynamicRangeCompressionLine(m_dynamicRangeCompressionLine));
  }

  if (m_dynamicRangeCompressionRfHasBeenSet) {
    payload.WithString("dynamicRangeCompressionRf",
                       Eac3AtmosDynamicRangeCompressionRfMapper::GetNameForEac3AtmosDynamicRangeCompressionRf(m_dynamicRangeCompressionRf));
  }

  if (m_dynamicRangeControlHasBeenSet) {
    payload.WithString("dynamicRangeControl",
                       Eac3AtmosDynamicRangeControlMapper::GetNameForEac3AtmosDynamicRangeControl(m_dynamicRangeControl));
  }
