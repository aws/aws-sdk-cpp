...
NielsenNonLinearWatermarkSettings::NielsenNonLinearWatermarkSettings(JsonView jsonValue) { *this = jsonValue; }
...
NielsenNonLinearWatermarkSettings& NielsenNonLinearWatermarkSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("activeWatermarkProcess")) {
    m_activeWatermarkProcess =
        NielsenActiveWatermarkProcessTypeMapper::GetNielsenActiveWatermarkProcessTypeForName(jsonValue.GetString("activeWatermarkProcess"));
  ...
  if (jsonValue.ValueExists("sourceWatermarkStatus")) {
    m_sourceWatermarkStatus =
        NielsenSourceWatermarkStatusTypeMapper::GetNielsenSourceWatermarkStatusTypeForName(jsonValue.GetString("sourceWatermarkStatus"));
  ...
  if (jsonValue.ValueExists("uniqueTicPerAudioTrack")) {
    m_uniqueTicPerAudioTrack =
        NielsenUniqueTicPerAudioTrackTypeMapper::GetNielsenUniqueTicPerAudioTrackTypeForName(jsonValue.GetString("uniqueTicPerAudioTrack"));
...
JsonValue NielsenNonLinearWatermarkSettings::Jsonize() const {
  ...
  if (m_activeWatermarkProcessHasBeenSet) {
    payload.WithString("activeWatermarkProcess",
                       NielsenActiveWatermarkProcessTypeMapper::GetNameForNielsenActiveWatermarkProcessType(m_activeWatermarkProcess));
  }
  ...
  if (m_sourceWatermarkStatusHasBeenSet) {
    payload.WithString("sourceWatermarkStatus",
                       NielsenSourceWatermarkStatusTypeMapper::GetNameForNielsenSourceWatermarkStatusType(m_sourceWatermarkStatus));
  }
  ...
  if (m_uniqueTicPerAudioTrackHasBeenSet) {
    payload.WithString("uniqueTicPerAudioTrack",
                       NielsenUniqueTicPerAudioTrackTypeMapper::GetNameForNielsenUniqueTicPerAudioTrackType(m_uniqueTicPerAudioTrack));
  }
