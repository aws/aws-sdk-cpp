...
FileSourceSettings::FileSourceSettings(JsonView jsonValue) { *this = jsonValue; }
...
FileSourceSettings& FileSourceSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("convertPaintToPop")) {
    m_convertPaintToPop =
        CaptionSourceConvertPaintOnToPopOnMapper::GetCaptionSourceConvertPaintOnToPopOnForName(jsonValue.GetString("convertPaintToPop"));
  ...
  if (jsonValue.ValueExists("upconvertSTLToTeletext")) {
    m_upconvertSTLToTeletext = CaptionSourceUpconvertSTLToTeletextMapper::GetCaptionSourceUpconvertSTLToTeletextForName(
        jsonValue.GetString("upconvertSTLToTeletext"));
...
JsonValue FileSourceSettings::Jsonize() const {
  ...
  if (m_convertPaintToPopHasBeenSet) {
    payload.WithString("convertPaintToPop",
                       CaptionSourceConvertPaintOnToPopOnMapper::GetNameForCaptionSourceConvertPaintOnToPopOn(m_convertPaintToPop));
  }
  ...
  if (m_upconvertSTLToTeletextHasBeenSet) {
    payload.WithString("upconvertSTLToTeletext",
                       CaptionSourceUpconvertSTLToTeletextMapper::GetNameForCaptionSourceUpconvertSTLToTeletext(m_upconvertSTLToTeletext));
  }
