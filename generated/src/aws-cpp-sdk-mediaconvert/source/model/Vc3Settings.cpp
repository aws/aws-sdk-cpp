...
Vc3Settings::Vc3Settings(JsonView jsonValue) { *this = jsonValue; }
...
Vc3Settings& Vc3Settings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("framerateConversionAlgorithm")) {
    m_framerateConversionAlgorithm = Vc3FramerateConversionAlgorithmMapper::GetVc3FramerateConversionAlgorithmForName(
  ...
  if (jsonValue.ValueExists("scanTypeConversionMode")) {
    m_scanTypeConversionMode =
        Vc3ScanTypeConversionModeMapper::GetVc3ScanTypeConversionModeForName(jsonValue.GetString("scanTypeConversionMode"));
...
JsonValue Vc3Settings::Jsonize() const {
  ...
  if (m_framerateConversionAlgorithmHasBeenSet) {
    payload.WithString("framerateConversionAlgorithm",
                       Vc3FramerateConversionAlgorithmMapper::GetNameForVc3FramerateConversionAlgorithm(m_framerateConversionAlgorithm));
  }
  ...
  if (m_scanTypeConversionModeHasBeenSet) {
    payload.WithString("scanTypeConversionMode",
                       Vc3ScanTypeConversionModeMapper::GetNameForVc3ScanTypeConversionMode(m_scanTypeConversionMode));
  }
