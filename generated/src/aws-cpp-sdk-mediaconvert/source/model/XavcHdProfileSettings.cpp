...
XavcHdProfileSettings::XavcHdProfileSettings(JsonView jsonValue) { *this = jsonValue; }
...
XavcHdProfileSettings& XavcHdProfileSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("qualityTuningLevel")) {
    m_qualityTuningLevel =
        XavcHdProfileQualityTuningLevelMapper::GetXavcHdProfileQualityTuningLevelForName(jsonValue.GetString("qualityTuningLevel"));
...
JsonValue XavcHdProfileSettings::Jsonize() const {
  ...
  if (m_qualityTuningLevelHasBeenSet) {
    payload.WithString("qualityTuningLevel",
                       XavcHdProfileQualityTuningLevelMapper::GetNameForXavcHdProfileQualityTuningLevel(m_qualityTuningLevel));
  }
