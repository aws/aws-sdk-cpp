...
PresetSettings::PresetSettings(JsonView jsonValue) { *this = jsonValue; }
...
PresetSettings& PresetSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("captionDescriptions")) {
    ...
    for (unsigned captionDescriptionsIndex = 0; captionDescriptionsIndex < captionDescriptionsJsonList.GetLength();
         ++captionDescriptionsIndex) {
