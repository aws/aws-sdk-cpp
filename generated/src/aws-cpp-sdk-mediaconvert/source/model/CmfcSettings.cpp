...
CmfcSettings::CmfcSettings(JsonView jsonValue) { *this = jsonValue; }
...
CmfcSettings& CmfcSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("manifestMetadataSignaling")) {
    m_manifestMetadataSignaling =
        CmfcManifestMetadataSignalingMapper::GetCmfcManifestMetadataSignalingForName(jsonValue.GetString("manifestMetadataSignaling"));
  ...
  if (jsonValue.ValueExists("timedMetadataBoxVersion")) {
    m_timedMetadataBoxVersion =
        CmfcTimedMetadataBoxVersionMapper::GetCmfcTimedMetadataBoxVersionForName(jsonValue.GetString("timedMetadataBoxVersion"));
...
JsonValue CmfcSettings::Jsonize() const {
  ...
  if (m_manifestMetadataSignalingHasBeenSet) {
    payload.WithString("manifestMetadataSignaling",
                       CmfcManifestMetadataSignalingMapper::GetNameForCmfcManifestMetadataSignaling(m_manifestMetadataSignaling));
  }
  ...
  if (m_timedMetadataBoxVersionHasBeenSet) {
    payload.WithString("timedMetadataBoxVersion",
                       CmfcTimedMetadataBoxVersionMapper::GetNameForCmfcTimedMetadataBoxVersion(m_timedMetadataBoxVersion));
  }
