...
MsSmoothGroupSettings::MsSmoothGroupSettings(JsonView jsonValue) { *this = jsonValue; }
...
MsSmoothGroupSettings& MsSmoothGroupSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("audioDeduplication")) {
    m_audioDeduplication =
        MsSmoothAudioDeduplicationMapper::GetMsSmoothAudioDeduplicationForName(jsonValue.GetString("audioDeduplication"));
  ...
  if (jsonValue.ValueExists("fragmentLengthControl")) {
    m_fragmentLengthControl =
        MsSmoothFragmentLengthControlMapper::GetMsSmoothFragmentLengthControlForName(jsonValue.GetString("fragmentLengthControl"));
...
JsonValue MsSmoothGroupSettings::Jsonize() const {
  ...
  if (m_fragmentLengthControlHasBeenSet) {
    payload.WithString("fragmentLengthControl",
                       MsSmoothFragmentLengthControlMapper::GetNameForMsSmoothFragmentLengthControl(m_fragmentLengthControl));
  }
