...
DashIsoEncryptionSettings::DashIsoEncryptionSettings(JsonView jsonValue) { *this = jsonValue; }
...
DashIsoEncryptionSettings& DashIsoEncryptionSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("playbackDeviceCompatibility")) {
    m_playbackDeviceCompatibility = DashIsoPlaybackDeviceCompatibilityMapper::GetDashIsoPlaybackDeviceCompatibilityForName(
        jsonValue.GetString("playbackDeviceCompatibility"));
...
JsonValue DashIsoEncryptionSettings::Jsonize() const {
  ...
  if (m_playbackDeviceCompatibilityHasBeenSet) {
    payload.WithString(
        ...
        DashIsoPlaybackDeviceCompatibilityMapper::GetNameForDashIsoPlaybackDeviceCompatibility(m_playbackDeviceCompatibility));
  }
