...
HlsImageBasedTrickPlayVariant::HlsImageBasedTrickPlayVariant(JsonView jsonValue) { *this = jsonValue; }

HlsImageBasedTrickPlayVariant& HlsImageBasedTrickPlayVariant::operator=(JsonView jsonValue) {
...
JsonValue HlsImageBasedTrickPlayVariant::Jsonize() const {
  JsonValue payload;
