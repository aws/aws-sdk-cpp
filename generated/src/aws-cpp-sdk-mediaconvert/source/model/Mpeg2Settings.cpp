...
Mpeg2Settings::Mpeg2Settings(JsonView jsonValue) { *this = jsonValue; }
...
Mpeg2Settings& Mpeg2Settings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("adaptiveQuantization")) {
    m_adaptiveQuantization =
        Mpeg2AdaptiveQuantizationMapper::GetMpeg2AdaptiveQuantizationForName(jsonValue.GetString("adaptiveQuantization"));
  ...
  if (jsonValue.ValueExists("framerateConversionAlgorithm")) {
    m_framerateConversionAlgorithm = Mpeg2FramerateConversionAlgorithmMapper::GetMpeg2FramerateConversionAlgorithmForName(
  ...
  if (jsonValue.ValueExists("perFrameMetrics")) {
    ...
    for (unsigned perFrameMetricsIndex = 0; perFrameMetricsIndex < perFrameMetricsJsonList.GetLength(); ++perFrameMetricsIndex) {
      m_perFrameMetrics.push_back(
          FrameMetricTypeMapper::GetFrameMetricTypeForName(perFrameMetricsJsonList[perFrameMetricsIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("scanTypeConversionMode")) {
    m_scanTypeConversionMode =
        Mpeg2ScanTypeConversionModeMapper::GetMpeg2ScanTypeConversionModeForName(jsonValue.GetString("scanTypeConversionMode"));
  ...
  if (jsonValue.ValueExists("spatialAdaptiveQuantization")) {
    m_spatialAdaptiveQuantization = Mpeg2SpatialAdaptiveQuantizationMapper::GetMpeg2SpatialAdaptiveQuantizationForName(
        jsonValue.GetString("spatialAdaptiveQuantization"));
  ...
  if (jsonValue.ValueExists("temporalAdaptiveQuantization")) {
    m_temporalAdaptiveQuantization = Mpeg2TemporalAdaptiveQuantizationMapper::GetMpeg2TemporalAdaptiveQuantizationForName(
        jsonValue.GetString("temporalAdaptiveQuantization"));
...
JsonValue Mpeg2Settings::Jsonize() const {
  ...
  if (m_adaptiveQuantizationHasBeenSet) {
    payload.WithString("adaptiveQuantization",
                       Mpeg2AdaptiveQuantizationMapper::GetNameForMpeg2AdaptiveQuantization(m_adaptiveQuantization));
  }
  ...
  if (m_framerateConversionAlgorithmHasBeenSet) {
    payload.WithString("framerateConversionAlgorithm", Mpeg2FramerateConversionAlgorithmMapper::GetNameForMpeg2FramerateConversionAlgorithm(
                                                           m_framerateConversionAlgorithm));
  }
  ...
  if (m_perFrameMetricsHasBeenSet) {
    ...
    for (unsigned perFrameMetricsIndex = 0; perFrameMetricsIndex < perFrameMetricsJsonList.GetLength(); ++perFrameMetricsIndex) {
      perFrameMetricsJsonList[perFrameMetricsIndex].AsString(
          FrameMetricTypeMapper::GetNameForFrameMetricType(m_perFrameMetrics[perFrameMetricsIndex]));
    }
  ...
  if (m_scanTypeConversionModeHasBeenSet) {
    payload.WithString("scanTypeConversionMode",
                       Mpeg2ScanTypeConversionModeMapper::GetNameForMpeg2ScanTypeConversionMode(m_scanTypeConversionMode));
  }
  ...
  if (m_spatialAdaptiveQuantizationHasBeenSet) {
    payload.WithString("spatialAdaptiveQuantization",
                       Mpeg2SpatialAdaptiveQuantizationMapper::GetNameForMpeg2SpatialAdaptiveQuantization(m_spatialAdaptiveQuantization));
  }
  ...
  if (m_temporalAdaptiveQuantizationHasBeenSet) {
    payload.WithString("temporalAdaptiveQuantization", Mpeg2TemporalAdaptiveQuantizationMapper::GetNameForMpeg2TemporalAdaptiveQuantization(
