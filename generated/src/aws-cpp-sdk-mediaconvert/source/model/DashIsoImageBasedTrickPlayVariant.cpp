...
DashIsoImageBasedTrickPlayVariant::DashIsoImageBasedTrickPlayVariant(JsonView jsonValue) { *this = jsonValue; }

DashIsoImageBasedTrickPlayVariant& DashIsoImageBasedTrickPlayVariant::operator=(JsonView jsonValue) {
...
JsonValue DashIsoImageBasedTrickPlayVariant::Jsonize() const {
  JsonValue payload;
