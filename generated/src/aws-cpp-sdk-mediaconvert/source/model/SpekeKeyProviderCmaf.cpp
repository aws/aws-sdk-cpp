...
SpekeKeyProviderCmaf::SpekeKeyProviderCmaf(JsonView jsonValue) { *this = jsonValue; }
...
SpekeKeyProviderCmaf& SpekeKeyProviderCmaf::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("dashSignaledSystemIds")) {
    ...
    for (unsigned dashSignaledSystemIdsIndex = 0; dashSignaledSystemIdsIndex < dashSignaledSystemIdsJsonList.GetLength();
         ++dashSignaledSystemIdsIndex) {
  ...
  if (jsonValue.ValueExists("hlsSignaledSystemIds")) {
    ...
    for (unsigned hlsSignaledSystemIdsIndex = 0; hlsSignaledSystemIdsIndex < hlsSignaledSystemIdsJsonList.GetLength();
         ++hlsSignaledSystemIdsIndex) {
