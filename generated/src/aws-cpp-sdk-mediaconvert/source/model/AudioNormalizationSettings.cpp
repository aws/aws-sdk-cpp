...
AudioNormalizationSettings& AudioNormalizationSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("loudnessLogging")) {
    m_loudnessLogging =
        AudioNormalizationLoudnessLoggingMapper::GetAudioNormalizationLoudnessLoggingForName(jsonValue.GetString("loudnessLogging"));
...
JsonValue AudioNormalizationSettings::Jsonize() const {
  ...
  if (m_loudnessLoggingHasBeenSet) {
    payload.WithString("loudnessLogging",
                       AudioNormalizationLoudnessLoggingMapper::GetNameForAudioNormalizationLoudnessLogging(m_loudnessLogging));
  }
