...
VideoSelector::VideoSelector(JsonView jsonValue) { *this = jsonValue; }
...
VideoSelector& VideoSelector::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("embeddedTimecodeOverride")) {
    m_embeddedTimecodeOverride =
        EmbeddedTimecodeOverrideMapper::GetEmbeddedTimecodeOverrideForName(jsonValue.GetString("embeddedTimecodeOverride"));
...
JsonValue VideoSelector::Jsonize() const {
  ...
  if (m_embeddedTimecodeOverrideHasBeenSet) {
    payload.WithString("embeddedTimecodeOverride",
                       EmbeddedTimecodeOverrideMapper::GetNameForEmbeddedTimecodeOverride(m_embeddedTimecodeOverride));
  }
