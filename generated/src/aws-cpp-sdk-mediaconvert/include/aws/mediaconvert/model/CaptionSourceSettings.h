...
class CaptionSourceSettings {
 public:
  ...
  void SetFileSourceSettings(FileSourceSettingsT&& value) {
    ...
    m_fileSourceSettings = std::forward<FileSourceSettingsT>(value);
  }
  template <typename FileSourceSettingsT = FileSourceSettings>
  CaptionSourceSettings& WithFileSourceSettings(FileSourceSettingsT&& value) {
    SetFileSourceSettings(std::forward<FileSourceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSourceType(CaptionSourceType value) {
    m_sourceTypeHasBeenSet = true;
    m_sourceType = value;
  }
  inline CaptionSourceSettings& WithSourceType(CaptionSourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  void SetTrackSourceSettings(TrackSourceSettingsT&& value) {
    ...
    m_trackSourceSettings = std::forward<TrackSourceSettingsT>(value);
  }
  template <typename TrackSourceSettingsT = TrackSourceSettings>
  CaptionSourceSettings& WithTrackSourceSettings(TrackSourceSettingsT&& value) {
    SetTrackSourceSettings(std::forward<TrackSourceSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWebvttHlsSourceSettings(WebvttHlsSourceSettingsT&& value) {
    ...
    m_webvttHlsSourceSettings = std::forward<WebvttHlsSourceSettingsT>(value);
  }
  template <typename WebvttHlsSourceSettingsT = WebvttHlsSourceSettings>
  CaptionSourceSettings& WithWebvttHlsSourceSettings(WebvttHlsSourceSettingsT&& value) {
    SetWebvttHlsSourceSettings(std::forward<WebvttHlsSourceSettingsT>(value));
    return *this;
  }
  ///@}
 private:
