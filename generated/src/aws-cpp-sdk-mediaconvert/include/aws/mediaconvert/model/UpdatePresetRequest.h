...
class UpdatePresetRequest : public MediaConvertRequest {
 public:
  ...
  template <typename CategoryT = Aws::String>
  UpdatePresetRequest& WithCategory(CategoryT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdatePresetRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdatePresetRequest& WithName(NameT&& value) {
  ...
  template <typename SettingsT = PresetSettings>
  UpdatePresetRequest& WithSettings(SettingsT&& value) {
