...
class VideoOverlay {
 public:
  ...
  template <typename CropT = VideoOverlayCrop>
  VideoOverlay& WithCrop(CropT&& value) {
  ...
  template <typename EndTimecodeT = Aws::String>
  VideoOverlay& WithEndTimecode(EndTimecodeT&& value) {
  ...
  void SetInitialPosition(InitialPositionT&& value) {
    m_initialPositionHasBeenSet = true;
    m_initialPosition = std::forward<InitialPositionT>(value);
  }
  template <typename InitialPositionT = VideoOverlayPosition>
  VideoOverlay& WithInitialPosition(InitialPositionT&& value) {
    SetInitialPosition(std::forward<InitialPositionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename InputT = VideoOverlayInput>
  VideoOverlay& WithInput(InputT&& value) {
  ...
  inline void SetPlayback(VideoOverlayPlayBackMode value) {
    m_playbackHasBeenSet = true;
    m_playback = value;
  }
  inline VideoOverlay& WithPlayback(VideoOverlayPlayBackMode value) {
    SetPlayback(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartTimecodeT = Aws::String>
  VideoOverlay& WithStartTimecode(StartTimecodeT&& value) {
