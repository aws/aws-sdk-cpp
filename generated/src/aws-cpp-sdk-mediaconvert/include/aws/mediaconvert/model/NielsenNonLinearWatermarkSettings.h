...
class NielsenNonLinearWatermarkSettings {
 public:
  ...
  inline void SetActiveWatermarkProcess(NielsenActiveWatermarkProcessType value) {
    m_activeWatermarkProcessHasBeenSet = true;
    m_activeWatermarkProcess = value;
  }
  inline NielsenNonLinearWatermarkSettings& WithActiveWatermarkProcess(NielsenActiveWatermarkProcessType value) {
    SetActiveWatermarkProcess(value);
    return *this;
  }
  ///@}
  ...
  void SetAdiFilename(AdiFilenameT&& value) {
    m_adiFilenameHasBeenSet = true;
    m_adiFilename = std::forward<AdiFilenameT>(value);
  }
  template <typename AdiFilenameT = Aws::String>
  NielsenNonLinearWatermarkSettings& WithAdiFilename(AdiFilenameT&& value) {
    SetAdiFilename(std::forward<AdiFilenameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCbetSourceId(CbetSourceIdT&& value) {
    m_cbetSourceIdHasBeenSet = true;
    m_cbetSourceId = std::forward<CbetSourceIdT>(value);
  }
  template <typename CbetSourceIdT = Aws::String>
  NielsenNonLinearWatermarkSettings& WithCbetSourceId(CbetSourceIdT&& value) {
    SetCbetSourceId(std::forward<CbetSourceIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEpisodeId(EpisodeIdT&& value) {
    m_episodeIdHasBeenSet = true;
    m_episodeId = std::forward<EpisodeIdT>(value);
  }
  template <typename EpisodeIdT = Aws::String>
  NielsenNonLinearWatermarkSettings& WithEpisodeId(EpisodeIdT&& value) {
    SetEpisodeId(std::forward<EpisodeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadataDestination(MetadataDestinationT&& value) {
    m_metadataDestinationHasBeenSet = true;
    m_metadataDestination = std::forward<MetadataDestinationT>(value);
  }
  template <typename MetadataDestinationT = Aws::String>
  NielsenNonLinearWatermarkSettings& WithMetadataDestination(MetadataDestinationT&& value) {
    SetMetadataDestination(std::forward<MetadataDestinationT>(value));
    return *this;
  }
  ///@}
  ...
  inline NielsenNonLinearWatermarkSettings& WithSourceId(int value) {
    SetSourceId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSourceWatermarkStatus(NielsenSourceWatermarkStatusType value) {
    m_sourceWatermarkStatusHasBeenSet = true;
    m_sourceWatermarkStatus = value;
  }
  inline NielsenNonLinearWatermarkSettings& WithSourceWatermarkStatus(NielsenSourceWatermarkStatusType value) {
    SetSourceWatermarkStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTicServerUrl(TicServerUrlT&& value) {
    m_ticServerUrlHasBeenSet = true;
    m_ticServerUrl = std::forward<TicServerUrlT>(value);
  }
  template <typename TicServerUrlT = Aws::String>
  NielsenNonLinearWatermarkSettings& WithTicServerUrl(TicServerUrlT&& value) {
    SetTicServerUrl(std::forward<TicServerUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUniqueTicPerAudioTrack(NielsenUniqueTicPerAudioTrackType value) {
    m_uniqueTicPerAudioTrackHasBeenSet = true;
    m_uniqueTicPerAudioTrack = value;
  }
  inline NielsenNonLinearWatermarkSettings& WithUniqueTicPerAudioTrack(NielsenUniqueTicPerAudioTrackType value) {
    SetUniqueTicPerAudioTrack(value);
    return *this;
  }
  ///@}
 private:
