...
class StartJobsQueryRequest : public MediaConvertRequest {
 public:
  ...
  template <typename FilterListT = Aws::Vector<JobsQueryFilter>>
  StartJobsQueryRequest& WithFilterList(FilterListT&& value) {
    SetFilterList(std::forward<FilterListT>(value));
    return *this;
  }
  template <typename FilterListT = JobsQueryFilter>
  StartJobsQueryRequest& AddFilterList(FilterListT&& value) {
    m_filterListHasBeenSet = true;
  ...
  inline StartJobsQueryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  StartJobsQueryRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline StartJobsQueryRequest& WithOrder(Order value) {
    SetOrder(value);
    return *this;
  }
  ///@}
