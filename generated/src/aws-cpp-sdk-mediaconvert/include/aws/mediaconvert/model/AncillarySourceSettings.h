...
class AncillarySourceSettings {
 public:
  ...
  inline void SetConvert608To708(AncillaryConvert608To708 value) {
    m_convert608To708HasBeenSet = true;
    m_convert608To708 = value;
  }
  inline AncillarySourceSettings& WithConvert608To708(AncillaryConvert608To708 value) {
    SetConvert608To708(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSourceAncillaryChannelNumber(int value) {
    m_sourceAncillaryChannelNumberHasBeenSet = true;
    m_sourceAncillaryChannelNumber = value;
  }
  inline AncillarySourceSettings& WithSourceAncillaryChannelNumber(int value) {
    SetSourceAncillaryChannelNumber(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTerminateCaptions(AncillaryTerminateCaptions value) {
    m_terminateCaptionsHasBeenSet = true;
    m_terminateCaptions = value;
  }
  inline AncillarySourceSettings& WithTerminateCaptions(AncillaryTerminateCaptions value) {
    SetTerminateCaptions(value);
    return *this;
  }
  ///@}
 private:
