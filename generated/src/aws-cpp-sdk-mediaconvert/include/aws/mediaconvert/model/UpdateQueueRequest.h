...
class UpdateQueueRequest : public MediaConvertRequest {
 public:
  ...
  inline UpdateQueueRequest& WithConcurrentJobs(int value) {
  ...
  template <typename NameT = Aws::String>
  UpdateQueueRequest& WithName(NameT&& value) {
  ...
  template <typename ReservationPlanSettingsT = ReservationPlanSettings>
  UpdateQueueRequest& WithReservationPlanSettings(ReservationPlanSettingsT&& value) {
  ...
  inline UpdateQueueRequest& WithStatus(QueueStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
