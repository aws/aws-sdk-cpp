...
class ImscDestinationSettings {
 public:
  ...
  inline void SetAccessibility(ImscAccessibilitySubs value) {
    m_accessibilityHasBeenSet = true;
    m_accessibility = value;
  }
  inline ImscDestinationSettings& WithAccessibility(ImscAccessibilitySubs value) {
  ...
  inline void SetStylePassthrough(ImscStylePassthrough value) {
    m_stylePassthroughHasBeenSet = true;
    m_stylePassthrough = value;
  }
  inline ImscDestinationSettings& WithStylePassthrough(ImscStylePassthrough value) {
