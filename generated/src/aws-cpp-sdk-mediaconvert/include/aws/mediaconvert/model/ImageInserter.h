...
class ImageInserter {
 public:
  ...
  void SetInsertableImages(InsertableImagesT&& value) {
    ...
    m_insertableImages = std::forward<InsertableImagesT>(value);
  }
  template <typename InsertableImagesT = Aws::Vector<InsertableImage>>
  ImageInserter& WithInsertableImages(InsertableImagesT&& value) {
    SetInsertableImages(std::forward<InsertableImagesT>(value));
    return *this;
  }
  template <typename InsertableImagesT = InsertableImage>
  ImageInserter& AddInsertableImages(InsertableImagesT&& value) {
    m_insertableImagesHasBeenSet = true;
    m_insertableImages.emplace_back(std::forward<InsertableImagesT>(value));
    return *this;
  }
  ///@}
  ...
  inline ImageInserter& WithSdrReferenceWhiteLevel(int value) {
