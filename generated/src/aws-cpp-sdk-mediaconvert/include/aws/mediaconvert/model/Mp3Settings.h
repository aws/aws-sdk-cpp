...
class Mp3Settings {
 public:
  ...
  inline Mp3Settings& WithBitrate(int value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline Mp3Settings& WithChannels(int value) {
    SetChannels(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRateControlMode(Mp3RateControlMode value) {
    m_rateControlModeHasBeenSet = true;
    m_rateControlMode = value;
  }
  inline Mp3Settings& WithRateControlMode(Mp3RateControlMode value) {
  ...
  inline Mp3Settings& WithSampleRate(int value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVbrQuality(int value) {
    m_vbrQualityHasBeenSet = true;
    m_vbrQuality = value;
  }
  inline Mp3Settings& WithVbrQuality(int value) {
    SetVbrQuality(value);
    return *this;
  }
  ///@}
