...
class ClipLimits {
 public:
  ...
  inline void SetMaximumRGBTolerance(int value) {
    m_maximumRGBToleranceHasBeenSet = true;
    m_maximumRGBTolerance = value;
  }
  inline ClipLimits& WithMaximumRGBTolerance(int value) {
    SetMaximumRGBTolerance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumYUV(int value) {
    m_maximumYUVHasBeenSet = true;
    m_maximumYUV = value;
  }
  inline ClipLimits& WithMaximumYUV(int value) {
    SetMaximumYUV(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumRGBTolerance(int value) {
    m_minimumRGBToleranceHasBeenSet = true;
    m_minimumRGBTolerance = value;
  }
  inline ClipLimits& WithMinimumRGBTolerance(int value) {
    SetMinimumRGBTolerance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumYUV(int value) {
    m_minimumYUVHasBeenSet = true;
    m_minimumYUV = value;
  }
  inline ClipLimits& WithMinimumYUV(int value) {
    SetMinimumYUV(value);
    return *this;
  }
  ///@}
