 ...
 * see
 * https://docs.aws.amazon.com/mediaconvert/latest/ug/scc-srt-output-captions.html.<p><h3>See
 * Also:</h3>   <a
...
class SccDestinationSettings {
 public:
  ...
  inline void SetFramerate(SccDestinationFramerate value) {
    m_framerateHasBeenSet = true;
    m_framerate = value;
  }
  inline SccDestinationSettings& WithFramerate(SccDestinationFramerate value) {
    SetFramerate(value);
    return *this;
  }
  ///@}
