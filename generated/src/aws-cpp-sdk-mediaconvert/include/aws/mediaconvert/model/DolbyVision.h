...
class DolbyVision {
 public:
  ...
  void SetL6Metadata(L6MetadataT&& value) {
    ...
    m_l6Metadata = std::forward<L6MetadataT>(value);
  }
  template <typename L6MetadataT = DolbyVisionLevel6Metadata>
  DolbyVision& WithL6Metadata(L6MetadataT&& value) {
    SetL6Metadata(std::forward<L6MetadataT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetL6Mode(DolbyVisionLevel6Mode value) {
    m_l6ModeHasBeenSet = true;
    m_l6Mode = value;
  }
  inline DolbyVision& WithL6Mode(DolbyVisionLevel6Mode value) {
    SetL6Mode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMapping(DolbyVisionMapping value) {
    m_mappingHasBeenSet = true;
    m_mapping = value;
  }
  inline DolbyVision& WithMapping(DolbyVisionMapping value) {
    SetMapping(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProfile(DolbyVisionProfile value) {
    m_profileHasBeenSet = true;
    m_profile = value;
  }
  inline DolbyVision& WithProfile(DolbyVisionProfile value) {
    SetProfile(value);
    return *this;
  }
  ///@}
