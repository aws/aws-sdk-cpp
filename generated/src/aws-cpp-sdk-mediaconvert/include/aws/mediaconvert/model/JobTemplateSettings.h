...
class JobTemplateSettings {
 public:
  ...
  inline JobTemplateSettings& WithAdAvailOffset(int value) {
  ...
  inline JobTemplateSettings& WithFollowSource(int value) {
  ...
  template <typename MotionImageInsertersT = Aws::Vector<MotionImageInserter>>
  JobTemplateSettings& WithMotionImageInserters(MotionImageInsertersT&& value) {
  ...
  JobTemplateSettings& AddMotionImageInserters(MotionImageInsertersT&& value) {
    m_motionImageInsertersHasBeenSet = true;
