...
class AllowedRenditionSize {
 public:
  ...
  inline AllowedRenditionSize& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequired(RequiredFlag value) {
    m_requiredHasBeenSet = true;
    m_required = value;
  }
  inline AllowedRenditionSize& WithRequired(RequiredFlag value) {
    SetRequired(value);
    return *this;
  }
  ///@}
  ...
  inline AllowedRenditionSize& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
