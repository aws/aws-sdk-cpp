...
class InsertableImage {
 public:
  ...
  inline InsertableImage& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline InsertableImage& WithFadeIn(int value) {
    SetFadeIn(value);
    return *this;
  }
  ///@}
  ...
  inline InsertableImage& WithFadeOut(int value) {
    SetFadeOut(value);
    return *this;
  }
  ///@}
  ...
  inline InsertableImage& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  void SetImageInserterInput(ImageInserterInputT&& value) {
    ...
    m_imageInserterInput = std::forward<ImageInserterInputT>(value);
  }
  template <typename ImageInserterInputT = Aws::String>
  InsertableImage& WithImageInserterInput(ImageInserterInputT&& value) {
    SetImageInserterInput(std::forward<ImageInserterInputT>(value));
    return *this;
  }
  ///@}
  ...
  inline InsertableImage& WithImageX(int value) {
    SetImageX(value);
    return *this;
  }
  ///@}
  ...
  inline InsertableImage& WithImageY(int value) {
    SetImageY(value);
    return *this;
  }
  ///@}
  ...
  inline InsertableImage& WithLayer(int value) {
    SetLayer(value);
    return *this;
  }
  ///@}
  ...
  inline InsertableImage& WithOpacity(int value) {
    SetOpacity(value);
    return *this;
  }
  ///@}
  ...
  inline InsertableImage& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
