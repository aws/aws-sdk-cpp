...
class NielsenConfiguration {
 public:
  ...
  inline void SetBreakoutCode(int value) {
    m_breakoutCodeHasBeenSet = true;
    m_breakoutCode = value;
  }
  inline NielsenConfiguration& WithBreakoutCode(int value) {
    SetBreakoutCode(value);
    return *this;
  }
  ///@}
  ...
  void SetDistributorId(DistributorIdT&& value) {
    m_distributorIdHasBeenSet = true;
    m_distributorId = std::forward<DistributorIdT>(value);
  }
  template <typename DistributorIdT = Aws::String>
  NielsenConfiguration& WithDistributorId(DistributorIdT&& value) {
    SetDistributorId(std::forward<DistributorIdT>(value));
    return *this;
  }
  ///@}
 private:
