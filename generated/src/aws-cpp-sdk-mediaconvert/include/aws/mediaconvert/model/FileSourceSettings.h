...
class FileSourceSettings {
 public:
  ...
  inline void SetByteRateLimit(CaptionSourceByteRateLimit value) {
    m_byteRateLimitHasBeenSet = true;
    m_byteRateLimit = value;
  }
  inline FileSourceSettings& WithByteRateLimit(CaptionSourceByteRateLimit value) {
    SetByteRateLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConvert608To708(FileSourceConvert608To708 value) {
    m_convert608To708HasBeenSet = true;
    m_convert608To708 = value;
  }
  inline FileSourceSettings& WithConvert608To708(FileSourceConvert608To708 value) {
  ...
  inline void SetConvertPaintToPop(CaptionSourceConvertPaintOnToPopOn value) {
    m_convertPaintToPopHasBeenSet = true;
    m_convertPaintToPop = value;
  }
  inline FileSourceSettings& WithConvertPaintToPop(CaptionSourceConvertPaintOnToPopOn value) {
    SetConvertPaintToPop(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimeDelta(int value) {
    m_timeDeltaHasBeenSet = true;
    m_timeDelta = value;
  }
  inline FileSourceSettings& WithTimeDelta(int value) {
    SetTimeDelta(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimeDeltaUnits(FileSourceTimeDeltaUnits value) {
    m_timeDeltaUnitsHasBeenSet = true;
    m_timeDeltaUnits = value;
  }
  inline FileSourceSettings& WithTimeDeltaUnits(FileSourceTimeDeltaUnits value) {
    SetTimeDeltaUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUpconvertSTLToTeletext(CaptionSourceUpconvertSTLToTeletext value) {
    m_upconvertSTLToTeletextHasBeenSet = true;
    m_upconvertSTLToTeletext = value;
  }
  inline FileSourceSettings& WithUpconvertSTLToTeletext(CaptionSourceUpconvertSTLToTeletext value) {
    SetUpconvertSTLToTeletext(value);
    return *this;
  }
  ///@}
 private:
