...
/**
 * Settings for one image-based trick play variant. Each variant produces its own
 * set of JPEG tile images and corresponding manifest entries.<p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mediaconvert-2017-08-29/HlsImageBasedTrickPlayVariant">AWS
 * API Reference</a></p>
 */
class HlsImageBasedTrickPlayVariant {
 public:
  AWS_MEDIACONVERT_API HlsImageBasedTrickPlayVariant() = default;
  AWS_MEDIACONVERT_API HlsImageBasedTrickPlayVariant(Aws::Utils::Json::JsonView jsonValue);
  AWS_MEDIACONVERT_API HlsImageBasedTrickPlayVariant& operator=(Aws::Utils::Json::JsonView jsonValue);
   ...
   * If set to FOLLOW_SEGMENTATION, MediaConvert generates thumbnail playlist entries
   * that align exactly with video segment boundaries. FOLLOW_SEGMENTATION requires
   * 1x1 tiling.
   */
  ...
  inline void SetIntervalCadence(HlsIntervalCadence value) {
    m_intervalCadenceHasBeenSet = true;
    m_intervalCadence = value;
  }
  inline HlsImageBasedTrickPlayVariant& WithIntervalCadence(HlsIntervalCadence value) {
    SetIntervalCadence(value);
    return *this;
  }
  ///@}
  ...
  inline void SetThumbnailHeight(int value) {
    m_thumbnailHeightHasBeenSet = true;
    m_thumbnailHeight = value;
  }
  inline HlsImageBasedTrickPlayVariant& WithThumbnailHeight(int value) {
  ...
  inline void SetThumbnailInterval(double value) {
    m_thumbnailIntervalHasBeenSet = true;
    m_thumbnailInterval = value;
  }
  inline HlsImageBasedTrickPlayVariant& WithThumbnailInterval(double value) {
  ...
  inline void SetThumbnailWidth(int value) {
    m_thumbnailWidthHasBeenSet = true;
    m_thumbnailWidth = value;
  }
  inline HlsImageBasedTrickPlayVariant& WithThumbnailWidth(int value) {
  ...
  inline HlsImageBasedTrickPlayVariant& WithTileHeight(int value) {
    SetTileHeight(value);
    return *this;
  }
  ///@}
  ...
  inline HlsImageBasedTrickPlayVariant& WithTileWidth(int value) {
    SetTileWidth(value);
    return *this;
  }
  ///@}
