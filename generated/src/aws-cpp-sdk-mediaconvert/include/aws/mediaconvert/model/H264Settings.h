...
class H264Settings {
 public:
  ...
  inline void SetAdaptiveQuantization(H264AdaptiveQuantization value) {
    m_adaptiveQuantizationHasBeenSet = true;
    m_adaptiveQuantization = value;
  }
  inline H264Settings& WithAdaptiveQuantization(H264AdaptiveQuantization value) {
  ...
  inline H264Settings& WithBitrate(int value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodecLevel(H264CodecLevel value) {
    m_codecLevelHasBeenSet = true;
    m_codecLevel = value;
  }
  inline H264Settings& WithCodecLevel(H264CodecLevel value) {
    SetCodecLevel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodecProfile(H264CodecProfile value) {
    m_codecProfileHasBeenSet = true;
    m_codecProfile = value;
  }
  inline H264Settings& WithCodecProfile(H264CodecProfile value) {
  ...
  inline void SetDynamicSubGop(H264DynamicSubGop value) {
    m_dynamicSubGopHasBeenSet = true;
    m_dynamicSubGop = value;
  }
  inline H264Settings& WithDynamicSubGop(H264DynamicSubGop value) {
  ...
  inline void SetEndOfStreamMarkers(H264EndOfStreamMarkers value) {
    m_endOfStreamMarkersHasBeenSet = true;
    m_endOfStreamMarkers = value;
  }
  inline H264Settings& WithEndOfStreamMarkers(H264EndOfStreamMarkers value) {
  ...
  inline void SetEntropyEncoding(H264EntropyEncoding value) {
  ...
  inline void SetFieldEncoding(H264FieldEncoding value) {
    m_fieldEncodingHasBeenSet = true;
    m_fieldEncoding = value;
  }
  inline H264Settings& WithFieldEncoding(H264FieldEncoding value) {
    SetFieldEncoding(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFlickerAdaptiveQuantization(H264FlickerAdaptiveQuantization value) {
    m_flickerAdaptiveQuantizationHasBeenSet = true;
    m_flickerAdaptiveQuantization = value;
  }
  inline H264Settings& WithFlickerAdaptiveQuantization(H264FlickerAdaptiveQuantization value) {
  ...
  inline void SetFramerateControl(H264FramerateControl value) {
    m_framerateControlHasBeenSet = true;
    m_framerateControl = value;
  }
  inline H264Settings& WithFramerateControl(H264FramerateControl value) {
  ...
  inline void SetFramerateConversionAlgorithm(H264FramerateConversionAlgorithm value) {
    m_framerateConversionAlgorithmHasBeenSet = true;
    m_framerateConversionAlgorithm = value;
  }
  inline H264Settings& WithFramerateConversionAlgorithm(H264FramerateConversionAlgorithm value) {
  ...
  inline H264Settings& WithFramerateDenominator(int value) {
  ...
  inline H264Settings& WithFramerateNumerator(int value) {
  ...
  inline void SetGopBReference(H264GopBReference value) {
    m_gopBReferenceHasBeenSet = true;
    m_gopBReference = value;
  }
  inline H264Settings& WithGopBReference(H264GopBReference value) {
  ...
  inline H264Settings& WithGopClosedCadence(int value) {
  ...
  inline H264Settings& WithGopSize(double value) {
    SetGopSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGopSizeUnits(H264GopSizeUnits value) {
    m_gopSizeUnitsHasBeenSet = true;
    m_gopSizeUnits = value;
  }
  inline H264Settings& WithGopSizeUnits(H264GopSizeUnits value) {
  ...
  inline H264Settings& WithHrdBufferFinalFillPercentage(int value) {
  ...
  inline H264Settings& WithHrdBufferInitialFillPercentage(int value) {
  ...
  inline H264Settings& WithHrdBufferSize(int value) {
  ...
  inline void SetInterlaceMode(H264InterlaceMode value) {
    m_interlaceModeHasBeenSet = true;
    m_interlaceMode = value;
  }
  inline H264Settings& WithInterlaceMode(H264InterlaceMode value) {
  ...
  inline H264Settings& WithMaxBitrate(int value) {
    SetMaxBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline H264Settings& WithMinIInterval(int value) {
  ...
  inline H264Settings& WithNumberBFramesBetweenReferenceFrames(int value) {
  ...
  inline H264Settings& WithNumberReferenceFrames(int value) {
  ...
  inline void SetParControl(H264ParControl value) {
    m_parControlHasBeenSet = true;
    m_parControl = value;
  }
  inline H264Settings& WithParControl(H264ParControl value) {
    SetParControl(value);
    return *this;
  }
  ///@}
  ...
  inline H264Settings& WithParDenominator(int value) {
  ...
  inline H264Settings& WithParNumerator(int value) {
  ...
  inline H264Settings& AddPerFrameMetrics(FrameMetricType value) {
    m_perFrameMetricsHasBeenSet = true;
  ...
  inline void SetQualityTuningLevel(H264QualityTuningLevel value) {
    m_qualityTuningLevelHasBeenSet = true;
    m_qualityTuningLevel = value;
  }
  inline H264Settings& WithQualityTuningLevel(H264QualityTuningLevel value) {
  ...
  inline void SetRateControlMode(H264RateControlMode value) {
    m_rateControlModeHasBeenSet = true;
    m_rateControlMode = value;
  }
  inline H264Settings& WithRateControlMode(H264RateControlMode value) {
  ...
  inline void SetRepeatPps(H264RepeatPps value) {
    m_repeatPpsHasBeenSet = true;
    m_repeatPps = value;
  }
  inline H264Settings& WithRepeatPps(H264RepeatPps value) {
    SetRepeatPps(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSaliencyAwareEncoding(H264SaliencyAwareEncoding value) {
    m_saliencyAwareEncodingHasBeenSet = true;
    m_saliencyAwareEncoding = value;
  }
  inline H264Settings& WithSaliencyAwareEncoding(H264SaliencyAwareEncoding value) {
    SetSaliencyAwareEncoding(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScanTypeConversionMode(H264ScanTypeConversionMode value) {
    m_scanTypeConversionModeHasBeenSet = true;
    m_scanTypeConversionMode = value;
  }
  inline H264Settings& WithScanTypeConversionMode(H264ScanTypeConversionMode value) {
  ...
  inline void SetSceneChangeDetect(H264SceneChangeDetect value) {
    m_sceneChangeDetectHasBeenSet = true;
    m_sceneChangeDetect = value;
  }
  inline H264Settings& WithSceneChangeDetect(H264SceneChangeDetect value) {
  ...
  inline H264Settings& WithSlices(int value) {
    SetSlices(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSlowPal(H264SlowPal value) {
    m_slowPalHasBeenSet = true;
    m_slowPal = value;
  }
  inline H264Settings& WithSlowPal(H264SlowPal value) {
    SetSlowPal(value);
    return *this;
  }
  ///@}
  ...
  inline H264Settings& WithSoftness(int value) {
    SetSoftness(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpatialAdaptiveQuantization(H264SpatialAdaptiveQuantization value) {
    m_spatialAdaptiveQuantizationHasBeenSet = true;
    m_spatialAdaptiveQuantization = value;
  }
  inline H264Settings& WithSpatialAdaptiveQuantization(H264SpatialAdaptiveQuantization value) {
  ...
  inline void SetSyntax(H264Syntax value) {
    m_syntaxHasBeenSet = true;
    m_syntax = value;
  }
  inline H264Settings& WithSyntax(H264Syntax value) {
    SetSyntax(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTelecine(H264Telecine value) {
    m_telecineHasBeenSet = true;
    m_telecine = value;
  }
  inline H264Settings& WithTelecine(H264Telecine value) {
    SetTelecine(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTemporalAdaptiveQuantization(H264TemporalAdaptiveQuantization value) {
    m_temporalAdaptiveQuantizationHasBeenSet = true;
    m_temporalAdaptiveQuantization = value;
  }
  inline H264Settings& WithTemporalAdaptiveQuantization(H264TemporalAdaptiveQuantization value) {
  ...
  inline void SetUnregisteredSeiTimecode(H264UnregisteredSeiTimecode value) {
    m_unregisteredSeiTimecodeHasBeenSet = true;
    m_unregisteredSeiTimecode = value;
  }
  inline H264Settings& WithUnregisteredSeiTimecode(H264UnregisteredSeiTimecode value) {
  ...
  inline void SetWriteMp4PackagingType(H264WriteMp4PackagingType value) {
    m_writeMp4PackagingTypeHasBeenSet = true;
    m_writeMp4PackagingType = value;
  }
  inline H264Settings& WithWriteMp4PackagingType(H264WriteMp4PackagingType value) {
