...
class S3DestinationSettings {
 public:
  ...
  void SetAccessControl(AccessControlT&& value) {
    m_accessControlHasBeenSet = true;
    m_accessControl = std::forward<AccessControlT>(value);
  }
  template <typename AccessControlT = S3DestinationAccessControl>
  S3DestinationSettings& WithAccessControl(AccessControlT&& value) {
    SetAccessControl(std::forward<AccessControlT>(value));
    return *this;
  }
  ///@}
  ...
  inline S3DestinationSettings& WithStorageClass(S3StorageClass value) {
