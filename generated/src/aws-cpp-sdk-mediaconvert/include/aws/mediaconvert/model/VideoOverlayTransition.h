...
class VideoOverlayTransition {
 public:
  ...
  void SetEndPosition(EndPositionT&& value) {
    ...
    m_endPosition = std::forward<EndPositionT>(value);
  }
  template <typename EndPositionT = VideoOverlayPosition>
  VideoOverlayTransition& WithEndPosition(EndPositionT&& value) {
    SetEndPosition(std::forward<EndPositionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndTimecode(EndTimecodeT&& value) {
    ...
    m_endTimecode = std::forward<EndTimecodeT>(value);
  }
  template <typename EndTimecodeT = Aws::String>
  VideoOverlayTransition& WithEndTimecode(EndTimecodeT&& value) {
    SetEndTimecode(std::forward<EndTimecodeT>(value));
    return *this;
  }
  ///@}
