...
class FrameCaptureSettings {
 public:
  ...
  inline FrameCaptureSettings& WithFramerateDenominator(int value) {
  ...
  inline FrameCaptureSettings& WithFramerateNumerator(int value) {
  ...
  inline void SetMaxCaptures(int value) {
    m_maxCapturesHasBeenSet = true;
    m_maxCaptures = value;
  }
  inline FrameCaptureSettings& WithMaxCaptures(int value) {
    SetMaxCaptures(value);
    return *this;
  }
  ///@}
  ...
  inline FrameCaptureSettings& WithQuality(int value) {
    SetQuality(value);
    return *this;
  }
  ///@}
