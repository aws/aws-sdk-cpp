...
class AutomatedAbrRule {
 public:
  ...
  void SetAllowedRenditions(AllowedRenditionsT&& value) {
    ...
    m_allowedRenditions = std::forward<AllowedRenditionsT>(value);
  }
  template <typename AllowedRenditionsT = Aws::Vector<AllowedRenditionSize>>
  AutomatedAbrRule& WithAllowedRenditions(AllowedRenditionsT&& value) {
    SetAllowedRenditions(std::forward<AllowedRenditionsT>(value));
    return *this;
  }
  template <typename AllowedRenditionsT = AllowedRenditionSize>
  AutomatedAbrRule& AddAllowedRenditions(AllowedRenditionsT&& value) {
    m_allowedRenditionsHasBeenSet = true;
    m_allowedRenditions.emplace_back(std::forward<AllowedRenditionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetForceIncludeRenditions(ForceIncludeRenditionsT&& value) {
    ...
    m_forceIncludeRenditions = std::forward<ForceIncludeRenditionsT>(value);
  }
  template <typename ForceIncludeRenditionsT = Aws::Vector<ForceIncludeRenditionSize>>
  AutomatedAbrRule& WithForceIncludeRenditions(ForceIncludeRenditionsT&& value) {
    SetForceIncludeRenditions(std::forward<ForceIncludeRenditionsT>(value));
    return *this;
  }
  ...
  AutomatedAbrRule& AddForceIncludeRenditions(ForceIncludeRenditionsT&& value) {
    m_forceIncludeRenditionsHasBeenSet = true;
    m_forceIncludeRenditions.emplace_back(std::forward<ForceIncludeRenditionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMinBottomRenditionSize(MinBottomRenditionSizeT&& value) {
    ...
    m_minBottomRenditionSize = std::forward<MinBottomRenditionSizeT>(value);
  }
  template <typename MinBottomRenditionSizeT = MinBottomRenditionSize>
  AutomatedAbrRule& WithMinBottomRenditionSize(MinBottomRenditionSizeT&& value) {
    SetMinBottomRenditionSize(std::forward<MinBottomRenditionSizeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMinTopRenditionSize(MinTopRenditionSizeT&& value) {
    ...
    m_minTopRenditionSize = std::forward<MinTopRenditionSizeT>(value);
  }
  template <typename MinTopRenditionSizeT = MinTopRenditionSize>
  AutomatedAbrRule& WithMinTopRenditionSize(MinTopRenditionSizeT&& value) {
    SetMinTopRenditionSize(std::forward<MinTopRenditionSizeT>(value));
    return *this;
  }
  ///@}
  ...
  inline AutomatedAbrRule& WithType(RuleType value) {
    SetType(value);
    return *this;
  }
  ///@}
