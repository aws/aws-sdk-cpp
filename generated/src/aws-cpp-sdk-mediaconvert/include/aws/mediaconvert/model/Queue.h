...
class Queue {
 public:
  ...
  inline Queue& WithConcurrentJobs(int value) {
  ...
  inline Queue& WithPricingPlan(PricingPlan value) {
  ...
  inline void SetProgressingJobsCount(int value) {
    m_progressingJobsCountHasBeenSet = true;
    m_progressingJobsCount = value;
  }
  inline Queue& WithProgressingJobsCount(int value) {
    SetProgressingJobsCount(value);
    return *this;
  }
  ///@}
  ...
  void SetReservationPlan(ReservationPlanT&& value) {
    ...
    m_reservationPlan = std::forward<ReservationPlanT>(value);
  }
  template <typename ReservationPlanT = ReservationPlan>
  Queue& WithReservationPlan(ReservationPlanT&& value) {
    SetReservationPlan(std::forward<ReservationPlanT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceOverrides(ServiceOverridesT&& value) {
    ...
    m_serviceOverrides = std::forward<ServiceOverridesT>(value);
  }
  template <typename ServiceOverridesT = Aws::Vector<ServiceOverride>>
  Queue& WithServiceOverrides(ServiceOverridesT&& value) {
    SetServiceOverrides(std::forward<ServiceOverridesT>(value));
    return *this;
  }
  template <typename ServiceOverridesT = ServiceOverride>
  Queue& AddServiceOverrides(ServiceOverridesT&& value) {
    m_serviceOverridesHasBeenSet = true;
    m_serviceOverrides.emplace_back(std::forward<ServiceOverridesT>(value));
    return *this;
  }
  ///@}
  ...
  inline Queue& WithStatus(QueueStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSubmittedJobsCount(int value) {
    m_submittedJobsCountHasBeenSet = true;
    m_submittedJobsCount = value;
  }
  inline Queue& WithSubmittedJobsCount(int value) {
    SetSubmittedJobsCount(value);
    return *this;
  }
  ///@}
  ...
  inline Queue& WithType(Type value) {
    SetType(value);
    return *this;
  }
  ///@}
