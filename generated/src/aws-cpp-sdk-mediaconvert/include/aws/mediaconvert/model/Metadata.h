...
class Metadata {
 public:
  ...
  inline Metadata& WithFileSize(long long value) {
    SetFileSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastModifiedT = Aws::Utils::DateTime>
  Metadata& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename MimeTypeT = Aws::String>
  Metadata& WithMimeType(MimeTypeT&& value) {
