...
class QueueTransition {
 public:
  ...
  void SetDestinationQueue(DestinationQueueT&& value) {
    ...
    m_destinationQueue = std::forward<DestinationQueueT>(value);
  }
  template <typename DestinationQueueT = Aws::String>
  QueueTransition& WithDestinationQueue(DestinationQueueT&& value) {
    SetDestinationQueue(std::forward<DestinationQueueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceQueue(SourceQueueT&& value) {
    ...
    m_sourceQueue = std::forward<SourceQueueT>(value);
  }
  template <typename SourceQueueT = Aws::String>
  QueueTransition& WithSourceQueue(SourceQueueT&& value) {
    SetSourceQueue(std::forward<SourceQueueT>(value));
    return *this;
  }
  ///@}
