...
namespace Model
{
  ...
  public:
    ...
    inline DeleteQueueResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteQueueResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteQueueResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
