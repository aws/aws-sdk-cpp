...
class HlsRenditionGroupSettings {
 public:
  ...
  void SetRenditionGroupId(RenditionGroupIdT&& value) {
    m_renditionGroupIdHasBeenSet = true;
    m_renditionGroupId = std::forward<RenditionGroupIdT>(value);
  }
  template <typename RenditionGroupIdT = Aws::String>
  HlsRenditionGroupSettings& WithRenditionGroupId(RenditionGroupIdT&& value) {
    SetRenditionGroupId(std::forward<RenditionGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRenditionLanguageCode(LanguageCode value) {
    m_renditionLanguageCodeHasBeenSet = true;
    m_renditionLanguageCode = value;
  }
  inline HlsRenditionGroupSettings& WithRenditionLanguageCode(LanguageCode value) {
    SetRenditionLanguageCode(value);
    return *this;
  }
  ///@}
  ...
  void SetRenditionName(RenditionNameT&& value) {
    m_renditionNameHasBeenSet = true;
    m_renditionName = std::forward<RenditionNameT>(value);
  }
  template <typename RenditionNameT = Aws::String>
  HlsRenditionGroupSettings& WithRenditionName(RenditionNameT&& value) {
    SetRenditionName(std::forward<RenditionNameT>(value));
    return *this;
  }
  ///@}
 private:
