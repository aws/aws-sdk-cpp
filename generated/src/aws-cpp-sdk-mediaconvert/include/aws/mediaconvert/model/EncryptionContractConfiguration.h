...
class EncryptionContractConfiguration {
 public:
  ...
  inline void SetSpekeAudioPreset(PresetSpeke20Audio value) {
    m_spekeAudioPresetHasBeenSet = true;
    m_spekeAudioPreset = value;
  }
  inline EncryptionContractConfiguration& WithSpekeAudioPreset(PresetSpeke20Audio value) {
    SetSpekeAudioPreset(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpekeVideoPreset(PresetSpeke20Video value) {
    m_spekeVideoPresetHasBeenSet = true;
    m_spekeVideoPreset = value;
  }
  inline EncryptionContractConfiguration& WithSpekeVideoPreset(PresetSpeke20Video value) {
    SetSpekeVideoPreset(value);
    return *this;
  }
  ///@}
 private:
