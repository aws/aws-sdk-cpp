...
class Preset {
 public:
  ...
  template <typename CategoryT = Aws::String>
  Preset& WithCategory(CategoryT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  Preset& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedT = Aws::Utils::DateTime>
  Preset& WithLastUpdated(LastUpdatedT&& value) {
  ...
  template <typename SettingsT = PresetSettings>
  Preset& WithSettings(SettingsT&& value) {
  ...
  inline Preset& WithType(Type value) {
    SetType(value);
    return *this;
  }
  ///@}
