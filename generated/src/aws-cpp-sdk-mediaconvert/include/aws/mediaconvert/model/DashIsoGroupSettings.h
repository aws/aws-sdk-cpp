...
class DashIsoGroupSettings {
 public:
  ...
  void SetAdditionalManifests(AdditionalManifestsT&& value) {
    ...
    m_additionalManifests = std::forward<AdditionalManifestsT>(value);
  }
  template <typename AdditionalManifestsT = Aws::Vector<DashAdditionalManifest>>
  DashIsoGroupSettings& WithAdditionalManifests(AdditionalManifestsT&& value) {
    SetAdditionalManifests(std::forward<AdditionalManifestsT>(value));
    return *this;
  }
  ...
  DashIsoGroupSettings& AddAdditionalManifests(AdditionalManifestsT&& value) {
    m_additionalManifestsHasBeenSet = true;
    m_additionalManifests.emplace_back(std::forward<AdditionalManifestsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAudioChannelConfigSchemeIdUri(DashIsoGroupAudioChannelConfigSchemeIdUri value) {
    m_audioChannelConfigSchemeIdUriHasBeenSet = true;
    m_audioChannelConfigSchemeIdUri = value;
  }
  inline DashIsoGroupSettings& WithAudioChannelConfigSchemeIdUri(DashIsoGroupAudioChannelConfigSchemeIdUri value) {
    SetAudioChannelConfigSchemeIdUri(value);
    return *this;
  }
  ///@}
  ...
  void SetDashIFrameTrickPlayNameModifier(DashIFrameTrickPlayNameModifierT&& value) {
    ...
    m_dashIFrameTrickPlayNameModifier = std::forward<DashIFrameTrickPlayNameModifierT>(value);
  }
  template <typename DashIFrameTrickPlayNameModifierT = Aws::String>
  DashIsoGroupSettings& WithDashIFrameTrickPlayNameModifier(DashIFrameTrickPlayNameModifierT&& value) {
    SetDashIFrameTrickPlayNameModifier(std::forward<DashIFrameTrickPlayNameModifierT>(value));
    return *this;
  }
  ///@}
   ...
   * write a SegmentTimeline for outputs that you also specify a Name modifier for:
   * Keep the default value, Basic. Note that if you do not specify a name modifier
   * for an output, MediaConvert will not write a SegmentTimeline for it. To write a
   * common SegmentTimeline in the video AdaptationSet: Choose Compact. Note that
   * MediaConvert will still write a SegmentTimeline in any Representation that does
   * not share a common timeline. To write a video AdaptationSet for each different
   * output framerate, and a common SegmentTimeline in each AdaptationSet: Choose
   * Distinct. To write a SegmentTimeline in each AdaptationSet: Choose Full.
   */
  ...
  inline void SetDashManifestStyle(DashManifestStyle value) {
    m_dashManifestStyleHasBeenSet = true;
    m_dashManifestStyle = value;
  }
  inline DashIsoGroupSettings& WithDashManifestStyle(DashManifestStyle value) {
    SetDashManifestStyle(value);
    return *this;
  }
  ///@}
  ...
  void SetDestinationSettings(DestinationSettingsT&& value) {
    ...
    m_destinationSettings = std::forward<DestinationSettingsT>(value);
  }
  template <typename DestinationSettingsT = DestinationSettings>
  DashIsoGroupSettings& WithDestinationSettings(DestinationSettingsT&& value) {
    SetDestinationSettings(std::forward<DestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFragmentLength(int value) {
    m_fragmentLengthHasBeenSet = true;
    m_fragmentLength = value;
  }
  inline DashIsoGroupSettings& WithFragmentLength(int value) {
    SetFragmentLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHbbtvCompliance(DashIsoHbbtvCompliance value) {
    m_hbbtvComplianceHasBeenSet = true;
    m_hbbtvCompliance = value;
  }
  inline DashIsoGroupSettings& WithHbbtvCompliance(DashIsoHbbtvCompliance value) {
    SetHbbtvCompliance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetImageBasedTrickPlay(DashIsoImageBasedTrickPlay value) {
    m_imageBasedTrickPlayHasBeenSet = true;
    m_imageBasedTrickPlay = value;
  }
  inline DashIsoGroupSettings& WithImageBasedTrickPlay(DashIsoImageBasedTrickPlay value) {
    SetImageBasedTrickPlay(value);
    return *this;
  }
  ///@}
  ...
  void SetImageBasedTrickPlaySettings(ImageBasedTrickPlaySettingsT&& value) {
    ...
    m_imageBasedTrickPlaySettings = std::forward<ImageBasedTrickPlaySettingsT>(value);
  }
  template <typename ImageBasedTrickPlaySettingsT = DashIsoImageBasedTrickPlaySettings>
  ...
  inline void SetMinBufferTime(int value) {
    m_minBufferTimeHasBeenSet = true;
    m_minBufferTime = value;
  }
  inline DashIsoGroupSettings& WithMinBufferTime(int value) {
    SetMinBufferTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinFinalSegmentLength(double value) {
    m_minFinalSegmentLengthHasBeenSet = true;
    m_minFinalSegmentLength = value;
  }
  inline DashIsoGroupSettings& WithMinFinalSegmentLength(double value) {
    SetMinFinalSegmentLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMpdManifestBandwidthType(DashIsoMpdManifestBandwidthType value) {
    m_mpdManifestBandwidthTypeHasBeenSet = true;
    m_mpdManifestBandwidthType = value;
  }
  inline DashIsoGroupSettings& WithMpdManifestBandwidthType(DashIsoMpdManifestBandwidthType value) {
    SetMpdManifestBandwidthType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMpdProfile(DashIsoMpdProfile value) {
    m_mpdProfileHasBeenSet = true;
    m_mpdProfile = value;
  }
  inline DashIsoGroupSettings& WithMpdProfile(DashIsoMpdProfile value) {
    SetMpdProfile(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPtsOffsetHandlingForBFrames(DashIsoPtsOffsetHandlingForBFrames value) {
    m_ptsOffsetHandlingForBFramesHasBeenSet = true;
    m_ptsOffsetHandlingForBFrames = value;
  }
  inline DashIsoGroupSettings& WithPtsOffsetHandlingForBFrames(DashIsoPtsOffsetHandlingForBFrames value) {
    SetPtsOffsetHandlingForBFrames(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSegmentControl(DashIsoSegmentControl value) {
    m_segmentControlHasBeenSet = true;
    m_segmentControl = value;
  }
  inline DashIsoGroupSettings& WithSegmentControl(DashIsoSegmentControl value) {
  ...
  inline DashIsoGroupSettings& WithSegmentLength(int value) {
  ...
  inline void SetSegmentLengthControl(DashIsoSegmentLengthControl value) {
    m_segmentLengthControlHasBeenSet = true;
    m_segmentLengthControl = value;
  }
  inline DashIsoGroupSettings& WithSegmentLengthControl(DashIsoSegmentLengthControl value) {
    SetSegmentLengthControl(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVideoCompositionOffsets(DashIsoVideoCompositionOffsets value) {
    m_videoCompositionOffsetsHasBeenSet = true;
    m_videoCompositionOffsets = value;
  }
  inline DashIsoGroupSettings& WithVideoCompositionOffsets(DashIsoVideoCompositionOffsets value) {
    SetVideoCompositionOffsets(value);
    return *this;
  }
  ///@}
   ...
   */
  inline DashIsoWriteSegmentTimelineInRepresentation GetWriteSegmentTimelineInRepresentation() const {
    return m_writeSegmentTimelineInRepresentation;
  }
  inline bool WriteSegmentTimelineInRepresentationHasBeenSet() const { return m_writeSegmentTimelineInRepresentationHasBeenSet; }
  inline void SetWriteSegmentTimelineInRepresentation(DashIsoWriteSegmentTimelineInRepresentation value) {
    m_writeSegmentTimelineInRepresentationHasBeenSet = true;
    m_writeSegmentTimelineInRepresentation = value;
  }
  inline DashIsoGroupSettings& WithWriteSegmentTimelineInRepresentation(DashIsoWriteSegmentTimelineInRepresentation value) {
    SetWriteSegmentTimelineInRepresentation(value);
    return *this;
  }
  ///@}
 private:
