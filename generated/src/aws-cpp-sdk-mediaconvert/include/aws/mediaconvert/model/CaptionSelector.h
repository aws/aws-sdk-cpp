...
class CaptionSelector {
 public:
  ...
  inline CaptionSelector& WithLanguageCode(LanguageCode value) {
  ...
  void SetSourceSettings(SourceSettingsT&& value) {
    ...
    m_sourceSettings = std::forward<SourceSettingsT>(value);
  }
  template <typename SourceSettingsT = CaptionSourceSettings>
  CaptionSelector& WithSourceSettings(SourceSettingsT&& value) {
    SetSourceSettings(std::forward<SourceSettingsT>(value));
    return *this;
  }
  ///@}
 private:
