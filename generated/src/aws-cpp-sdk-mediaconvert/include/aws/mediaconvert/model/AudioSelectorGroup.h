...
class AudioSelectorGroup {
 public:
  ...
  void SetAudioSelectorNames(AudioSelectorNamesT&& value) {
    m_audioSelectorNamesHasBeenSet = true;
    m_audioSelectorNames = std::forward<AudioSelectorNamesT>(value);
  }
  template <typename AudioSelectorNamesT = Aws::Vector<Aws::String>>
  AudioSelectorGroup& WithAudioSelectorNames(AudioSelectorNamesT&& value) {
    SetAudioSelectorNames(std::forward<AudioSelectorNamesT>(value));
    return *this;
  }
  template <typename AudioSelectorNamesT = Aws::String>
  AudioSelectorGroup& AddAudioSelectorNames(AudioSelectorNamesT&& value) {
    m_audioSelectorNamesHasBeenSet = true;
    m_audioSelectorNames.emplace_back(std::forward<AudioSelectorNamesT>(value));
    return *this;
  }
  ///@}
 private:
