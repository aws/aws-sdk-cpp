...
class AudioCodecSettings {
 public:
  ...
  void SetAiffSettings(AiffSettingsT&& value) {
    m_aiffSettingsHasBeenSet = true;
    m_aiffSettings = std::forward<AiffSettingsT>(value);
  }
  template <typename AiffSettingsT = AiffSettings>
  AudioCodecSettings& WithAiffSettings(AiffSettingsT&& value) {
    SetAiffSettings(std::forward<AiffSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * Choose the audio codec for this output. Note that the option passthrough applies
   * only to Dolby Digital, Dolby Digital Plus, AAC LC, AAC HEV1, and AAC HEV2 audio
  ...
  inline void SetCodec(AudioCodec value) {
    m_codecHasBeenSet = true;
    m_codec = value;
  }
  inline AudioCodecSettings& WithCodec(AudioCodec value) {
    SetCodec(value);
    return *this;
  }
  ///@}
  ...
  void SetFlacSettings(FlacSettingsT&& value) {
    m_flacSettingsHasBeenSet = true;
    m_flacSettings = std::forward<FlacSettingsT>(value);
  }
  template <typename FlacSettingsT = FlacSettings>
  AudioCodecSettings& WithFlacSettings(FlacSettingsT&& value) {
    SetFlacSettings(std::forward<FlacSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMp3Settings(Mp3SettingsT&& value) {
    m_mp3SettingsHasBeenSet = true;
    m_mp3Settings = std::forward<Mp3SettingsT>(value);
  }
  template <typename Mp3SettingsT = Mp3Settings>
  AudioCodecSettings& WithMp3Settings(Mp3SettingsT&& value) {
    SetMp3Settings(std::forward<Mp3SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOpusSettings(OpusSettingsT&& value) {
    m_opusSettingsHasBeenSet = true;
    m_opusSettings = std::forward<OpusSettingsT>(value);
  }
  template <typename OpusSettingsT = OpusSettings>
  AudioCodecSettings& WithOpusSettings(OpusSettingsT&& value) {
    SetOpusSettings(std::forward<OpusSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVorbisSettings(VorbisSettingsT&& value) {
    ...
    m_vorbisSettings = std::forward<VorbisSettingsT>(value);
  }
  template <typename VorbisSettingsT = VorbisSettings>
  AudioCodecSettings& WithVorbisSettings(VorbisSettingsT&& value) {
    SetVorbisSettings(std::forward<VorbisSettingsT>(value));
    return *this;
  }
  ///@}
