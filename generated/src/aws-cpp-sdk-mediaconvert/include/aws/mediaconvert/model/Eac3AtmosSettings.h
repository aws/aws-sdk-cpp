...
class Eac3AtmosSettings {
 public:
  ...
  inline Eac3AtmosSettings& WithBitrate(int value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBitstreamMode(Eac3AtmosBitstreamMode value) {
    m_bitstreamModeHasBeenSet = true;
    m_bitstreamMode = value;
  }
  inline Eac3AtmosSettings& WithBitstreamMode(Eac3AtmosBitstreamMode value) {
  ...
  inline void SetCodingMode(Eac3AtmosCodingMode value) {
    m_codingModeHasBeenSet = true;
    m_codingMode = value;
  }
  inline Eac3AtmosSettings& WithCodingMode(Eac3AtmosCodingMode value) {
    SetCodingMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDialogueIntelligence(Eac3AtmosDialogueIntelligence value) {
    m_dialogueIntelligenceHasBeenSet = true;
    m_dialogueIntelligence = value;
  }
  inline Eac3AtmosSettings& WithDialogueIntelligence(Eac3AtmosDialogueIntelligence value) {
    SetDialogueIntelligence(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDownmixControl(Eac3AtmosDownmixControl value) {
    m_downmixControlHasBeenSet = true;
    m_downmixControl = value;
  }
  inline Eac3AtmosSettings& WithDownmixControl(Eac3AtmosDownmixControl value) {
    SetDownmixControl(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDynamicRangeCompressionLine(Eac3AtmosDynamicRangeCompressionLine value) {
    m_dynamicRangeCompressionLineHasBeenSet = true;
    m_dynamicRangeCompressionLine = value;
  }
  inline Eac3AtmosSettings& WithDynamicRangeCompressionLine(Eac3AtmosDynamicRangeCompressionLine value) {
    SetDynamicRangeCompressionLine(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDynamicRangeCompressionRf(Eac3AtmosDynamicRangeCompressionRf value) {
    m_dynamicRangeCompressionRfHasBeenSet = true;
    m_dynamicRangeCompressionRf = value;
  }
  inline Eac3AtmosSettings& WithDynamicRangeCompressionRf(Eac3AtmosDynamicRangeCompressionRf value) {
    SetDynamicRangeCompressionRf(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDynamicRangeControl(Eac3AtmosDynamicRangeControl value) {
    m_dynamicRangeControlHasBeenSet = true;
    m_dynamicRangeControl = value;
  }
  inline Eac3AtmosSettings& WithDynamicRangeControl(Eac3AtmosDynamicRangeControl value) {
    SetDynamicRangeControl(value);
    return *this;
  }
  ///@}
  ...
  inline Eac3AtmosSettings& WithLoRoCenterMixLevel(double value) {
  ...
  inline Eac3AtmosSettings& WithLoRoSurroundMixLevel(double value) {
  ...
  inline Eac3AtmosSettings& WithLtRtCenterMixLevel(double value) {
  ...
  inline Eac3AtmosSettings& WithLtRtSurroundMixLevel(double value) {
  ...
  inline void SetMeteringMode(Eac3AtmosMeteringMode value) {
    m_meteringModeHasBeenSet = true;
    m_meteringMode = value;
  }
  inline Eac3AtmosSettings& WithMeteringMode(Eac3AtmosMeteringMode value) {
  ...
  inline Eac3AtmosSettings& WithSampleRate(int value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpeechThreshold(int value) {
    m_speechThresholdHasBeenSet = true;
    m_speechThreshold = value;
  }
  inline Eac3AtmosSettings& WithSpeechThreshold(int value) {
  ...
  inline void SetStereoDownmix(Eac3AtmosStereoDownmix value) {
    m_stereoDownmixHasBeenSet = true;
    m_stereoDownmix = value;
  }
  inline Eac3AtmosSettings& WithStereoDownmix(Eac3AtmosStereoDownmix value) {
  ...
  inline void SetSurroundExMode(Eac3AtmosSurroundExMode value) {
    m_surroundExModeHasBeenSet = true;
    m_surroundExMode = value;
  }
  inline Eac3AtmosSettings& WithSurroundExMode(Eac3AtmosSurroundExMode value) {
    SetSurroundExMode(value);
    return *this;
  }
  ///@}
 private:
