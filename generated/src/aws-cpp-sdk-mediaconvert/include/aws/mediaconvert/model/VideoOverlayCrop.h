...
class VideoOverlayCrop {
 public:
  ...
  inline VideoOverlayCrop& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline VideoOverlayCrop& WithUnit(VideoOverlayUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline VideoOverlayCrop& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
  ...
  inline VideoOverlayCrop& WithX(int value) {
    SetX(value);
    return *this;
  }
  ///@}
  ...
  inline VideoOverlayCrop& WithY(int value) {
    SetY(value);
    return *this;
  }
  ///@}
