...
class JobsQueryFilter {
 public:
  ...
  inline void SetKey(JobsQueryFilterKey value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline JobsQueryFilter& WithKey(JobsQueryFilterKey value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  JobsQueryFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  JobsQueryFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
