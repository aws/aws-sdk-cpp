...
class CreateJobRequest : public MediaConvertRequest {
 public:
  ...
  inline CreateJobRequest& WithBillingTagsSource(BillingTagsSource value) {
  ...
  void SetJobEngineVersion(JobEngineVersionT&& value) {
    m_jobEngineVersionHasBeenSet = true;
    m_jobEngineVersion = std::forward<JobEngineVersionT>(value);
  }
  template <typename JobEngineVersionT = Aws::String>
  CreateJobRequest& WithJobEngineVersion(JobEngineVersionT&& value) {
    SetJobEngineVersion(std::forward<JobEngineVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateJobRequest& WithSimulateReservedQueue(SimulateReservedQueue value) {
  ...
  inline CreateJobRequest& WithStatusUpdateInterval(StatusUpdateInterval value) {
