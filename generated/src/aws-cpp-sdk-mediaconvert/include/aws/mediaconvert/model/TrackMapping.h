...
class TrackMapping {
 public:
  ...
  void SetAudioTrackIndexes(AudioTrackIndexesT&& value) {
    ...
    m_audioTrackIndexes = std::forward<AudioTrackIndexesT>(value);
  }
  template <typename AudioTrackIndexesT = Aws::Vector<int>>
  TrackMapping& WithAudioTrackIndexes(AudioTrackIndexesT&& value) {
    SetAudioTrackIndexes(std::forward<AudioTrackIndexesT>(value));
    return *this;
  }
  inline TrackMapping& AddAudioTrackIndexes(int value) {
    m_audioTrackIndexesHasBeenSet = true;
    m_audioTrackIndexes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetDataTrackIndexes(DataTrackIndexesT&& value) {
    ...
    m_dataTrackIndexes = std::forward<DataTrackIndexesT>(value);
  }
  template <typename DataTrackIndexesT = Aws::Vector<int>>
  TrackMapping& WithDataTrackIndexes(DataTrackIndexesT&& value) {
    SetDataTrackIndexes(std::forward<DataTrackIndexesT>(value));
    return *this;
  }
  inline TrackMapping& AddDataTrackIndexes(int value) {
    m_dataTrackIndexesHasBeenSet = true;
    m_dataTrackIndexes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetVideoTrackIndexes(VideoTrackIndexesT&& value) {
    ...
    m_videoTrackIndexes = std::forward<VideoTrackIndexesT>(value);
  }
  template <typename VideoTrackIndexesT = Aws::Vector<int>>
  TrackMapping& WithVideoTrackIndexes(VideoTrackIndexesT&& value) {
    SetVideoTrackIndexes(std::forward<VideoTrackIndexesT>(value));
    return *this;
  }
  inline TrackMapping& AddVideoTrackIndexes(int value) {
    m_videoTrackIndexesHasBeenSet = true;
    m_videoTrackIndexes.push_back(value);
    return *this;
  }
  ///@}
 private:
