...
class DvbNitSettings {
 public:
  ...
  inline void SetNetworkId(int value) {
    m_networkIdHasBeenSet = true;
    m_networkId = value;
  }
  inline DvbNitSettings& WithNetworkId(int value) {
    SetNetworkId(value);
    return *this;
  }
  ///@}
  ...
  template <typename NetworkNameT = Aws::String>
  DvbNitSettings& WithNetworkName(NetworkNameT&& value) {
  ...
  inline void SetNitInterval(int value) {
    m_nitIntervalHasBeenSet = true;
    m_nitInterval = value;
  }
  inline DvbNitSettings& WithNitInterval(int value) {
    SetNitInterval(value);
    return *this;
  }
  ///@}
 private:
