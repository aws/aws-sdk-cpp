...
class AvcIntraUhdSettings {
 public:
  ...
  inline void SetQualityTuningLevel(AvcIntraUhdQualityTuningLevel value) {
    m_qualityTuningLevelHasBeenSet = true;
    m_qualityTuningLevel = value;
  }
  inline AvcIntraUhdSettings& WithQualityTuningLevel(AvcIntraUhdQualityTuningLevel value) {
