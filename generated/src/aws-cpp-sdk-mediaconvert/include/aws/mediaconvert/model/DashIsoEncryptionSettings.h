...
class DashIsoEncryptionSettings {
 public:
  ...
  inline void SetPlaybackDeviceCompatibility(DashIsoPlaybackDeviceCompatibility value) {
    m_playbackDeviceCompatibilityHasBeenSet = true;
    m_playbackDeviceCompatibility = value;
  }
  inline DashIsoEncryptionSettings& WithPlaybackDeviceCompatibility(DashIsoPlaybackDeviceCompatibility value) {
    SetPlaybackDeviceCompatibility(value);
    return *this;
  }
  ///@}
