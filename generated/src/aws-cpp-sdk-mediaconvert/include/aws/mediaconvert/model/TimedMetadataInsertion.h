...
class TimedMetadataInsertion {
 public:
  ...
  void SetId3Insertions(Id3InsertionsT&& value) {
    m_id3InsertionsHasBeenSet = true;
    m_id3Insertions = std::forward<Id3InsertionsT>(value);
  }
  template <typename Id3InsertionsT = Aws::Vector<Id3Insertion>>
  TimedMetadataInsertion& WithId3Insertions(Id3InsertionsT&& value) {
    SetId3Insertions(std::forward<Id3InsertionsT>(value));
    return *this;
  }
  template <typename Id3InsertionsT = Id3Insertion>
  TimedMetadataInsertion& AddId3Insertions(Id3InsertionsT&& value) {
    m_id3InsertionsHasBeenSet = true;
    m_id3Insertions.emplace_back(std::forward<Id3InsertionsT>(value));
    return *this;
  }
  ///@}
 private:
