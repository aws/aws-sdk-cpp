...
class ExtendedDataServices {
 public:
  ...
  inline void SetCopyProtectionAction(CopyProtectionAction value) {
    m_copyProtectionActionHasBeenSet = true;
    m_copyProtectionAction = value;
  }
  inline ExtendedDataServices& WithCopyProtectionAction(CopyProtectionAction value) {
    SetCopyProtectionAction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVchipAction(VchipAction value) {
    m_vchipActionHasBeenSet = true;
    m_vchipAction = value;
  }
  inline ExtendedDataServices& WithVchipAction(VchipAction value) {
    SetVchipAction(value);
    return *this;
  }
  ///@}
 private:
