...
class GifSettings {
 public:
  ...
  inline void SetFramerateControl(GifFramerateControl value) {
    m_framerateControlHasBeenSet = true;
    m_framerateControl = value;
  }
  inline GifSettings& WithFramerateControl(GifFramerateControl value) {
  ...
  inline void SetFramerateConversionAlgorithm(GifFramerateConversionAlgorithm value) {
    m_framerateConversionAlgorithmHasBeenSet = true;
    m_framerateConversionAlgorithm = value;
  }
  inline GifSettings& WithFramerateConversionAlgorithm(GifFramerateConversionAlgorithm value) {
  ...
  inline GifSettings& WithFramerateDenominator(int value) {
  ...
  inline GifSettings& WithFramerateNumerator(int value) {
