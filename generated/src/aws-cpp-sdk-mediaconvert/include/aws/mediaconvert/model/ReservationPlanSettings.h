...
class ReservationPlanSettings {
 public:
  ...
  inline void SetCommitment(Commitment value) {
    m_commitmentHasBeenSet = true;
    m_commitment = value;
  }
  inline ReservationPlanSettings& WithCommitment(Commitment value) {
    SetCommitment(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRenewalType(RenewalType value) {
    m_renewalTypeHasBeenSet = true;
    m_renewalType = value;
  }
  inline ReservationPlanSettings& WithRenewalType(RenewalType value) {
  ...
  inline void SetReservedSlots(int value) {
    m_reservedSlotsHasBeenSet = true;
    m_reservedSlots = value;
  }
  inline ReservationPlanSettings& WithReservedSlots(int value) {
    SetReservedSlots(value);
    return *this;
  }
  ///@}
 private:
