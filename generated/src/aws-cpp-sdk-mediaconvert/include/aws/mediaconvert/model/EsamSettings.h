...
class EsamSettings {
 public:
   ...
   */
  inline const EsamManifestConfirmConditionNotification& GetManifestConfirmConditionNotification() const {
    return m_manifestConfirmConditionNotification;
  }
  ...
  void SetManifestConfirmConditionNotification(ManifestConfirmConditionNotificationT&& value) {
    m_manifestConfirmConditionNotificationHasBeenSet = true;
    m_manifestConfirmConditionNotification = std::forward<ManifestConfirmConditionNotificationT>(value);
  }
  template <typename ManifestConfirmConditionNotificationT = EsamManifestConfirmConditionNotification>
  EsamSettings& WithManifestConfirmConditionNotification(ManifestConfirmConditionNotificationT&& value) {
    SetManifestConfirmConditionNotification(std::forward<ManifestConfirmConditionNotificationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetResponseSignalPreroll(int value) {
    m_responseSignalPrerollHasBeenSet = true;
    m_responseSignalPreroll = value;
  }
  inline EsamSettings& WithResponseSignalPreroll(int value) {
    SetResponseSignalPreroll(value);
    return *this;
  }
  ///@}
  ...
  void SetSignalProcessingNotification(SignalProcessingNotificationT&& value) {
    m_signalProcessingNotificationHasBeenSet = true;
    m_signalProcessingNotification = std::forward<SignalProcessingNotificationT>(value);
  }
  template <typename SignalProcessingNotificationT = EsamSignalProcessingNotification>
  EsamSettings& WithSignalProcessingNotification(SignalProcessingNotificationT&& value) {
    SetSignalProcessingNotification(std::forward<SignalProcessingNotificationT>(value));
    return *this;
  }
  ///@}
 private:
