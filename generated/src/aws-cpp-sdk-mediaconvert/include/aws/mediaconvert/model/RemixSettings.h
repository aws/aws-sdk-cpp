...
class RemixSettings {
 public:
  ...
  inline void SetAudioDescriptionAudioChannel(int value) {
    m_audioDescriptionAudioChannelHasBeenSet = true;
    m_audioDescriptionAudioChannel = value;
  }
  inline RemixSettings& WithAudioDescriptionAudioChannel(int value) {
    SetAudioDescriptionAudioChannel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAudioDescriptionDataChannel(int value) {
    m_audioDescriptionDataChannelHasBeenSet = true;
    m_audioDescriptionDataChannel = value;
  }
  inline RemixSettings& WithAudioDescriptionDataChannel(int value) {
    SetAudioDescriptionDataChannel(value);
    return *this;
  }
  ///@}
  ...
  void SetChannelMapping(ChannelMappingT&& value) {
    ...
    m_channelMapping = std::forward<ChannelMappingT>(value);
  }
  template <typename ChannelMappingT = ChannelMapping>
  RemixSettings& WithChannelMapping(ChannelMappingT&& value) {
    SetChannelMapping(std::forward<ChannelMappingT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetChannelsIn(int value) {
    m_channelsInHasBeenSet = true;
    m_channelsIn = value;
  }
  inline RemixSettings& WithChannelsIn(int value) {
    SetChannelsIn(value);
    return *this;
  }
  ///@}
  ...
  inline void SetChannelsOut(int value) {
    m_channelsOutHasBeenSet = true;
    m_channelsOut = value;
  }
  inline RemixSettings& WithChannelsOut(int value) {
    SetChannelsOut(value);
    return *this;
  }
  ///@}
 private:
