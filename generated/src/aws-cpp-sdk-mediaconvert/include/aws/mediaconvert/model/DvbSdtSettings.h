...
class DvbSdtSettings {
 public:
  ...
  inline void SetOutputSdt(OutputSdt value) {
    m_outputSdtHasBeenSet = true;
    m_outputSdt = value;
  }
  inline DvbSdtSettings& WithOutputSdt(OutputSdt value) {
    SetOutputSdt(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSdtInterval(int value) {
    m_sdtIntervalHasBeenSet = true;
    m_sdtInterval = value;
  }
  inline DvbSdtSettings& WithSdtInterval(int value) {
    SetSdtInterval(value);
    return *this;
  }
  ///@}
  ...
  void SetServiceProviderName(ServiceProviderNameT&& value) {
    ...
    m_serviceProviderName = std::forward<ServiceProviderNameT>(value);
  }
  template <typename ServiceProviderNameT = Aws::String>
  DvbSdtSettings& WithServiceProviderName(ServiceProviderNameT&& value) {
    SetServiceProviderName(std::forward<ServiceProviderNameT>(value));
    return *this;
  }
  ///@}
 private:
