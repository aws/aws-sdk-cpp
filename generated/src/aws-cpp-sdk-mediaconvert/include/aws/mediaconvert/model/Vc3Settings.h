...
class Vc3Settings {
 public:
  ...
  inline void SetFramerateControl(Vc3FramerateControl value) {
    m_framerateControlHasBeenSet = true;
    m_framerateControl = value;
  }
  inline Vc3Settings& WithFramerateControl(Vc3FramerateControl value) {
  ...
  inline void SetFramerateConversionAlgorithm(Vc3FramerateConversionAlgorithm value) {
    m_framerateConversionAlgorithmHasBeenSet = true;
    m_framerateConversionAlgorithm = value;
  }
  inline Vc3Settings& WithFramerateConversionAlgorithm(Vc3FramerateConversionAlgorithm value) {
  ...
  inline Vc3Settings& WithFramerateDenominator(int value) {
  ...
  inline Vc3Settings& WithFramerateNumerator(int value) {
  ...
  inline void SetInterlaceMode(Vc3InterlaceMode value) {
    m_interlaceModeHasBeenSet = true;
    m_interlaceMode = value;
  }
  inline Vc3Settings& WithInterlaceMode(Vc3InterlaceMode value) {
  ...
  inline void SetScanTypeConversionMode(Vc3ScanTypeConversionMode value) {
    m_scanTypeConversionModeHasBeenSet = true;
    m_scanTypeConversionMode = value;
  }
  inline Vc3Settings& WithScanTypeConversionMode(Vc3ScanTypeConversionMode value) {
  ...
  inline void SetSlowPal(Vc3SlowPal value) {
    m_slowPalHasBeenSet = true;
    m_slowPal = value;
  }
  inline Vc3Settings& WithSlowPal(Vc3SlowPal value) {
    SetSlowPal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTelecine(Vc3Telecine value) {
    m_telecineHasBeenSet = true;
    m_telecine = value;
  }
  inline Vc3Settings& WithTelecine(Vc3Telecine value) {
    SetTelecine(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVc3Class(Vc3Class value) {
    m_vc3ClassHasBeenSet = true;
    m_vc3Class = value;
  }
  inline Vc3Settings& WithVc3Class(Vc3Class value) {
    SetVc3Class(value);
    return *this;
  }
  ///@}
