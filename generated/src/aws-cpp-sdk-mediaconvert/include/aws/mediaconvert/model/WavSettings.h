...
class WavSettings {
 public:
  ...
  inline WavSettings& WithBitDepth(int value) {
    SetBitDepth(value);
    return *this;
  }
  ///@}
  ...
  inline WavSettings& WithChannels(int value) {
    SetChannels(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFormat(WavFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline WavSettings& WithFormat(WavFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline WavSettings& WithSampleRate(int value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
