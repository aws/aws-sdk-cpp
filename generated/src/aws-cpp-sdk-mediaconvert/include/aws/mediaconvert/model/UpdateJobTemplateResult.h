...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIACONVERT_API UpdateJobTemplateResult() = default;
    ...
    template<typename JobTemplateT = JobTemplate>
    UpdateJobTemplateResult& WithJobTemplate(JobTemplateT&& value) { SetJobTemplate(std::forward<JobTemplateT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateJobTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
