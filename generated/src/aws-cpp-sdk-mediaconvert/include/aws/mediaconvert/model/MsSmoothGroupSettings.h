...
class MsSmoothGroupSettings {
 public:
  ...
  inline void SetAudioDeduplication(MsSmoothAudioDeduplication value) {
    m_audioDeduplicationHasBeenSet = true;
    m_audioDeduplication = value;
  }
  inline MsSmoothGroupSettings& WithAudioDeduplication(MsSmoothAudioDeduplication value) {
    SetAudioDeduplication(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFragmentLengthControl(MsSmoothFragmentLengthControl value) {
    m_fragmentLengthControlHasBeenSet = true;
    m_fragmentLengthControl = value;
  }
  inline MsSmoothGroupSettings& WithFragmentLengthControl(MsSmoothFragmentLengthControl value) {
    SetFragmentLengthControl(value);
    return *this;
  }
  ///@}
  ...
  inline void SetManifestEncoding(MsSmoothManifestEncoding value) {
    m_manifestEncodingHasBeenSet = true;
    m_manifestEncoding = value;
  }
  inline MsSmoothGroupSettings& WithManifestEncoding(MsSmoothManifestEncoding value) {
    SetManifestEncoding(value);
    return *this;
  }
  ///@}
 private:
