...
class VideoCodecSettings {
 public:
  ...
  void SetAv1Settings(Av1SettingsT&& value) {
    m_av1SettingsHasBeenSet = true;
    m_av1Settings = std::forward<Av1SettingsT>(value);
  }
  template <typename Av1SettingsT = Av1Settings>
  VideoCodecSettings& WithAv1Settings(Av1SettingsT&& value) {
    SetAv1Settings(std::forward<Av1SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAvcIntraSettings(AvcIntraSettingsT&& value) {
    ...
    m_avcIntraSettings = std::forward<AvcIntraSettingsT>(value);
  }
  template <typename AvcIntraSettingsT = AvcIntraSettings>
  VideoCodecSettings& WithAvcIntraSettings(AvcIntraSettingsT&& value) {
    SetAvcIntraSettings(std::forward<AvcIntraSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCodec(VideoCodec value) {
    m_codecHasBeenSet = true;
    m_codec = value;
  }
  inline VideoCodecSettings& WithCodec(VideoCodec value) {
    SetCodec(value);
    return *this;
  }
  ///@}
  ...
  void SetFrameCaptureSettings(FrameCaptureSettingsT&& value) {
    ...
    m_frameCaptureSettings = std::forward<FrameCaptureSettingsT>(value);
  }
  template <typename FrameCaptureSettingsT = FrameCaptureSettings>
  VideoCodecSettings& WithFrameCaptureSettings(FrameCaptureSettingsT&& value) {
    SetFrameCaptureSettings(std::forward<FrameCaptureSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGifSettings(GifSettingsT&& value) {
    m_gifSettingsHasBeenSet = true;
    m_gifSettings = std::forward<GifSettingsT>(value);
  }
  template <typename GifSettingsT = GifSettings>
  VideoCodecSettings& WithGifSettings(GifSettingsT&& value) {
    SetGifSettings(std::forward<GifSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetH264Settings(H264SettingsT&& value) {
    ...
    m_h264Settings = std::forward<H264SettingsT>(value);
  }
  template <typename H264SettingsT = H264Settings>
  VideoCodecSettings& WithH264Settings(H264SettingsT&& value) {
    SetH264Settings(std::forward<H264SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetH265Settings(H265SettingsT&& value) {
    ...
    m_h265Settings = std::forward<H265SettingsT>(value);
  }
  template <typename H265SettingsT = H265Settings>
  VideoCodecSettings& WithH265Settings(H265SettingsT&& value) {
    SetH265Settings(std::forward<H265SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMpeg2Settings(Mpeg2SettingsT&& value) {
    ...
    m_mpeg2Settings = std::forward<Mpeg2SettingsT>(value);
  }
  template <typename Mpeg2SettingsT = Mpeg2Settings>
  VideoCodecSettings& WithMpeg2Settings(Mpeg2SettingsT&& value) {
    SetMpeg2Settings(std::forward<Mpeg2SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProresSettings(ProresSettingsT&& value) {
    ...
    m_proresSettings = std::forward<ProresSettingsT>(value);
  }
  template <typename ProresSettingsT = ProresSettings>
  VideoCodecSettings& WithProresSettings(ProresSettingsT&& value) {
    SetProresSettings(std::forward<ProresSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUncompressedSettings(UncompressedSettingsT&& value) {
    ...
    m_uncompressedSettings = std::forward<UncompressedSettingsT>(value);
  }
  template <typename UncompressedSettingsT = UncompressedSettings>
  VideoCodecSettings& WithUncompressedSettings(UncompressedSettingsT&& value) {
    SetUncompressedSettings(std::forward<UncompressedSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVc3Settings(Vc3SettingsT&& value) {
    m_vc3SettingsHasBeenSet = true;
    m_vc3Settings = std::forward<Vc3SettingsT>(value);
  }
  template <typename Vc3SettingsT = Vc3Settings>
  VideoCodecSettings& WithVc3Settings(Vc3SettingsT&& value) {
    SetVc3Settings(std::forward<Vc3SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVp8Settings(Vp8SettingsT&& value) {
    m_vp8SettingsHasBeenSet = true;
    m_vp8Settings = std::forward<Vp8SettingsT>(value);
  }
  template <typename Vp8SettingsT = Vp8Settings>
  VideoCodecSettings& WithVp8Settings(Vp8SettingsT&& value) {
    SetVp8Settings(std::forward<Vp8SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVp9Settings(Vp9SettingsT&& value) {
    m_vp9SettingsHasBeenSet = true;
    m_vp9Settings = std::forward<Vp9SettingsT>(value);
  }
  template <typename Vp9SettingsT = Vp9Settings>
  VideoCodecSettings& WithVp9Settings(Vp9SettingsT&& value) {
    SetVp9Settings(std::forward<Vp9SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetXavcSettings(XavcSettingsT&& value) {
    m_xavcSettingsHasBeenSet = true;
    m_xavcSettings = std::forward<XavcSettingsT>(value);
  }
  template <typename XavcSettingsT = XavcSettings>
  VideoCodecSettings& WithXavcSettings(XavcSettingsT&& value) {
    SetXavcSettings(std::forward<XavcSettingsT>(value));
    return *this;
  }
  ///@}
 private:
