...
class SearchJobsRequest : public MediaConvertRequest {
 public:
  ...
  void SetInputFile(InputFileT&& value) {
    ...
    m_inputFile = std::forward<InputFileT>(value);
  }
  template <typename InputFileT = Aws::String>
  SearchJobsRequest& WithInputFile(InputFileT&& value) {
    SetInputFile(std::forward<InputFileT>(value));
    return *this;
  }
  ///@}
  ...
  inline SearchJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline SearchJobsRequest& WithOrder(Order value) {
    SetOrder(value);
    return *this;
  }
  ///@}
  ...
  inline SearchJobsRequest& WithStatus(JobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
