...
class ForceIncludeRenditionSize {
 public:
  AWS_MEDIACONVERT_API ForceIncludeRenditionSize() = default;
  ...
  inline ForceIncludeRenditionSize& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline ForceIncludeRenditionSize& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
