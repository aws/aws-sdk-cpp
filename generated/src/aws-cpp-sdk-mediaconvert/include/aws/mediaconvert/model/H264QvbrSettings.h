...
class H264QvbrSettings {
 public:
  ...
  inline H264QvbrSettings& WithMaxAverageBitrate(int value) {
  ...
  inline H264QvbrSettings& WithQvbrQualityLevel(int value) {
  ...
  inline H264QvbrSettings& WithQvbrQualityLevelFineTune(double value) {
