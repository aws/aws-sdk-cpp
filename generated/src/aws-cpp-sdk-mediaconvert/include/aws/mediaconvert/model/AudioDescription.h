...
class AudioDescription {
 public:
  ...
  void SetAudioChannelTaggingSettings(AudioChannelTaggingSettingsT&& value) {
    ...
    m_audioChannelTaggingSettings = std::forward<AudioChannelTaggingSettingsT>(value);
  }
  template <typename AudioChannelTaggingSettingsT = AudioChannelTaggingSettings>
  AudioDescription& WithAudioChannelTaggingSettings(AudioChannelTaggingSettingsT&& value) {
    SetAudioChannelTaggingSettings(std::forward<AudioChannelTaggingSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAudioSourceName(AudioSourceNameT&& value) {
    ...
    m_audioSourceName = std::forward<AudioSourceNameT>(value);
  }
  template <typename AudioSourceNameT = Aws::String>
  AudioDescription& WithAudioSourceName(AudioSourceNameT&& value) {
    SetAudioSourceName(std::forward<AudioSourceNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAudioType(int value) {
    m_audioTypeHasBeenSet = true;
    m_audioType = value;
  }
  inline AudioDescription& WithAudioType(int value) {
    SetAudioType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAudioTypeControl(AudioTypeControl value) {
    m_audioTypeControlHasBeenSet = true;
    m_audioTypeControl = value;
  }
  inline AudioDescription& WithAudioTypeControl(AudioTypeControl value) {
  ...
  inline AudioDescription& WithLanguageCode(LanguageCode value) {
  ...
  inline void SetLanguageCodeControl(AudioLanguageCodeControl value) {
    m_languageCodeControlHasBeenSet = true;
    m_languageCodeControl = value;
  }
  inline AudioDescription& WithLanguageCodeControl(AudioLanguageCodeControl value) {
