...
class TeletextDestinationSettings {
 public:
  ...
  template <typename PageNumberT = Aws::String>
  TeletextDestinationSettings& WithPageNumber(PageNumberT&& value) {
  ...
  void SetPageTypes(PageTypesT&& value) {
    m_pageTypesHasBeenSet = true;
    m_pageTypes = std::forward<PageTypesT>(value);
  }
  template <typename PageTypesT = Aws::Vector<TeletextPageType>>
  TeletextDestinationSettings& WithPageTypes(PageTypesT&& value) {
    SetPageTypes(std::forward<PageTypesT>(value));
    return *this;
  }
  inline TeletextDestinationSettings& AddPageTypes(TeletextPageType value) {
    m_pageTypesHasBeenSet = true;
    m_pageTypes.push_back(value);
    return *this;
  }
  ///@}
 private:
