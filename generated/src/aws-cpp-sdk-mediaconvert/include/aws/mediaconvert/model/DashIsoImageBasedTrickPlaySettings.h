...
namespace Model
{
  ...
  public:
    ...
    inline void SetIntervalCadence(DashIsoIntervalCadence value) { m_intervalCadenceHasBeenSet = true; m_intervalCadence = value; }
    inline DashIsoImageBasedTrickPlaySettings& WithIntervalCadence(DashIsoIntervalCadence value) { SetIntervalCadence(value); return *this;}
    ///@}
