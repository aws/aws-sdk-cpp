...
class DashIsoImageBasedTrickPlaySettings {
 public:
  AWS_MEDIACONVERT_API DashIsoImageBasedTrickPlaySettings() = default;
  ...
  inline DashIsoImageBasedTrickPlaySettings& WithIntervalCadence(DashIsoIntervalCadence value) {
  ...
  inline DashIsoImageBasedTrickPlaySettings& WithThumbnailHeight(int value) {
  ...
  inline DashIsoImageBasedTrickPlaySettings& WithThumbnailInterval(double value) {
  ...
  inline DashIsoImageBasedTrickPlaySettings& WithThumbnailWidth(int value) {
  ...
  inline DashIsoImageBasedTrickPlaySettings& WithTileHeight(int value) {
    SetTileHeight(value);
    return *this;
  }
  ///@}
  ...
  inline DashIsoImageBasedTrickPlaySettings& WithTileWidth(int value) {
    SetTileWidth(value);
    return *this;
  }
  ///@}
