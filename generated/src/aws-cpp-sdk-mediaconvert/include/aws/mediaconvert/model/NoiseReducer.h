...
class NoiseReducer {
 public:
  ...
  inline void SetFilter(NoiseReducerFilter value) {
    m_filterHasBeenSet = true;
    m_filter = value;
  }
  inline NoiseReducer& WithFilter(NoiseReducerFilter value) {
    SetFilter(value);
    return *this;
  }
  ///@}
  ...
  void SetFilterSettings(FilterSettingsT&& value) {
    ...
    m_filterSettings = std::forward<FilterSettingsT>(value);
  }
  template <typename FilterSettingsT = NoiseReducerFilterSettings>
  NoiseReducer& WithFilterSettings(FilterSettingsT&& value) {
    SetFilterSettings(std::forward<FilterSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpatialFilterSettings(SpatialFilterSettingsT&& value) {
    ...
    m_spatialFilterSettings = std::forward<SpatialFilterSettingsT>(value);
  }
  template <typename SpatialFilterSettingsT = NoiseReducerSpatialFilterSettings>
  NoiseReducer& WithSpatialFilterSettings(SpatialFilterSettingsT&& value) {
    SetSpatialFilterSettings(std::forward<SpatialFilterSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemporalFilterSettings(TemporalFilterSettingsT&& value) {
    ...
    m_temporalFilterSettings = std::forward<TemporalFilterSettingsT>(value);
  }
  template <typename TemporalFilterSettingsT = NoiseReducerTemporalFilterSettings>
  NoiseReducer& WithTemporalFilterSettings(TemporalFilterSettingsT&& value) {
    SetTemporalFilterSettings(std::forward<TemporalFilterSettingsT>(value));
    return *this;
  }
  ///@}
 private:
