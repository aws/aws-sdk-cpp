...
class AudioChannelTaggingSettings {
 public:
  ...
  inline void SetChannelTag(AudioChannelTag value) {
    m_channelTagHasBeenSet = true;
    m_channelTag = value;
  }
  inline AudioChannelTaggingSettings& WithChannelTag(AudioChannelTag value) {
    SetChannelTag(value);
    return *this;
  }
  ///@}
  ...
  void SetChannelTags(ChannelTagsT&& value) {
    m_channelTagsHasBeenSet = true;
    m_channelTags = std::forward<ChannelTagsT>(value);
  }
  template <typename ChannelTagsT = Aws::Vector<AudioChannelTag>>
  AudioChannelTaggingSettings& WithChannelTags(ChannelTagsT&& value) {
    SetChannelTags(std::forward<ChannelTagsT>(value));
    return *this;
  }
  inline AudioChannelTaggingSettings& AddChannelTags(AudioChannelTag value) {
    m_channelTagsHasBeenSet = true;
    m_channelTags.push_back(value);
    return *this;
  }
  ///@}
 private:
