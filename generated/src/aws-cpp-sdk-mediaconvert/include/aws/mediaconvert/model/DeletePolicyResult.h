...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIACONVERT_API DeletePolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeletePolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
