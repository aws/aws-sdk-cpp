...
class Policy {
 public:
  ...
  inline void SetHttpInputs(InputPolicy value) {
    m_httpInputsHasBeenSet = true;
    m_httpInputs = value;
  }
  inline Policy& WithHttpInputs(InputPolicy value) {
    SetHttpInputs(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHttpsInputs(InputPolicy value) {
    m_httpsInputsHasBeenSet = true;
    m_httpsInputs = value;
  }
  inline Policy& WithHttpsInputs(InputPolicy value) {
    SetHttpsInputs(value);
    return *this;
  }
  ///@}
  ...
  inline void SetS3Inputs(InputPolicy value) {
    m_s3InputsHasBeenSet = true;
    m_s3Inputs = value;
  }
  inline Policy& WithS3Inputs(InputPolicy value) {
    SetS3Inputs(value);
    return *this;
  }
  ///@}
