...
class HlsSettings {
 public:
  ...
  void SetAudioGroupId(AudioGroupIdT&& value) {
    ...
    m_audioGroupId = std::forward<AudioGroupIdT>(value);
  }
  template <typename AudioGroupIdT = Aws::String>
  HlsSettings& WithAudioGroupId(AudioGroupIdT&& value) {
    SetAudioGroupId(std::forward<AudioGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAudioOnlyContainer(HlsAudioOnlyContainer value) {
    m_audioOnlyContainerHasBeenSet = true;
    m_audioOnlyContainer = value;
  }
  inline HlsSettings& WithAudioOnlyContainer(HlsAudioOnlyContainer value) {
    SetAudioOnlyContainer(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAudioTrackType(HlsAudioTrackType value) {
    m_audioTrackTypeHasBeenSet = true;
    m_audioTrackType = value;
  }
  inline HlsSettings& WithAudioTrackType(HlsAudioTrackType value) {
    SetAudioTrackType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDescriptiveVideoServiceFlag(HlsDescriptiveVideoServiceFlag value) {
    m_descriptiveVideoServiceFlagHasBeenSet = true;
    m_descriptiveVideoServiceFlag = value;
  }
  inline HlsSettings& WithDescriptiveVideoServiceFlag(HlsDescriptiveVideoServiceFlag value) {
    SetDescriptiveVideoServiceFlag(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIFrameOnlyManifest(HlsIFrameOnlyManifest value) {
    m_iFrameOnlyManifestHasBeenSet = true;
    m_iFrameOnlyManifest = value;
  }
  inline HlsSettings& WithIFrameOnlyManifest(HlsIFrameOnlyManifest value) {
    SetIFrameOnlyManifest(value);
    return *this;
  }
  ///@}
  ...
  void SetSegmentModifier(SegmentModifierT&& value) {
    ...
    m_segmentModifier = std::forward<SegmentModifierT>(value);
  }
  template <typename SegmentModifierT = Aws::String>
  HlsSettings& WithSegmentModifier(SegmentModifierT&& value) {
    SetSegmentModifier(std::forward<SegmentModifierT>(value));
    return *this;
  }
  ///@}
 private:
