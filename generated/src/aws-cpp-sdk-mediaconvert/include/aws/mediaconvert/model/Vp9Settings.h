...
class Vp9Settings {
 public:
  ...
  inline Vp9Settings& WithBitrate(int value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFramerateControl(Vp9FramerateControl value) {
    m_framerateControlHasBeenSet = true;
    m_framerateControl = value;
  }
  inline Vp9Settings& WithFramerateControl(Vp9FramerateControl value) {
  ...
  inline void SetFramerateConversionAlgorithm(Vp9FramerateConversionAlgorithm value) {
    m_framerateConversionAlgorithmHasBeenSet = true;
    m_framerateConversionAlgorithm = value;
  }
  inline Vp9Settings& WithFramerateConversionAlgorithm(Vp9FramerateConversionAlgorithm value) {
  ...
  inline Vp9Settings& WithFramerateDenominator(int value) {
  ...
  inline Vp9Settings& WithFramerateNumerator(int value) {
  ...
  inline Vp9Settings& WithGopSize(double value) {
    SetGopSize(value);
    return *this;
  }
  ///@}
  ...
  inline Vp9Settings& WithHrdBufferSize(int value) {
  ...
  inline Vp9Settings& WithMaxBitrate(int value) {
    SetMaxBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetParControl(Vp9ParControl value) {
    m_parControlHasBeenSet = true;
    m_parControl = value;
  }
  inline Vp9Settings& WithParControl(Vp9ParControl value) {
    SetParControl(value);
    return *this;
  }
  ///@}
  ...
  inline Vp9Settings& WithParDenominator(int value) {
  ...
  inline Vp9Settings& WithParNumerator(int value) {
  ...
  inline void SetQualityTuningLevel(Vp9QualityTuningLevel value) {
    m_qualityTuningLevelHasBeenSet = true;
    m_qualityTuningLevel = value;
  }
  inline Vp9Settings& WithQualityTuningLevel(Vp9QualityTuningLevel value) {
  ...
  inline void SetRateControlMode(Vp9RateControlMode value) {
    m_rateControlModeHasBeenSet = true;
    m_rateControlMode = value;
  }
  inline Vp9Settings& WithRateControlMode(Vp9RateControlMode value) {
