...
class ListQueuesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListQueuesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename QueuesT = Aws::Vector<Queue>>
  ListQueuesResult& WithQueues(QueuesT&& value) {
    SetQueues(std::forward<QueuesT>(value));
    return *this;
  }
  template <typename QueuesT = Queue>
  ListQueuesResult& AddQueues(QueuesT&& value) {
    m_queuesHasBeenSet = true;
  ...
  inline void SetTotalConcurrentJobs(int value) {
    m_totalConcurrentJobsHasBeenSet = true;
    m_totalConcurrentJobs = value;
  }
  inline ListQueuesResult& WithTotalConcurrentJobs(int value) {
    SetTotalConcurrentJobs(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnallocatedConcurrentJobs(int value) {
    m_unallocatedConcurrentJobsHasBeenSet = true;
    m_unallocatedConcurrentJobs = value;
  }
  inline ListQueuesResult& WithUnallocatedConcurrentJobs(int value) {
    SetUnallocatedConcurrentJobs(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListQueuesResult& WithRequestId(RequestIdT&& value) {
