...
class VideoOverlayPosition {
 public:
  ...
  inline VideoOverlayPosition& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnit(VideoOverlayUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline VideoOverlayPosition& WithUnit(VideoOverlayUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline VideoOverlayPosition& WithWidth(int value) {
    SetWidth(value);
    return *this;
  }
  ///@}
  ...
  inline VideoOverlayPosition& WithXPosition(int value) {
    SetXPosition(value);
    return *this;
  }
  ///@}
  ...
  inline VideoOverlayPosition& WithYPosition(int value) {
    SetYPosition(value);
    return *this;
  }
  ///@}
