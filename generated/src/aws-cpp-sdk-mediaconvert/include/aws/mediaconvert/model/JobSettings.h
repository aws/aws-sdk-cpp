...
class JobSettings {
 public:
  ...
  inline void SetAdAvailOffset(int value) {
    m_adAvailOffsetHasBeenSet = true;
    m_adAvailOffset = value;
  }
  inline JobSettings& WithAdAvailOffset(int value) {
    SetAdAvailOffset(value);
    return *this;
  }
  ///@}
  ...
  void SetAvailBlanking(AvailBlankingT&& value) {
    ...
    m_availBlanking = std::forward<AvailBlankingT>(value);
  }
  template <typename AvailBlankingT = AvailBlanking>
  JobSettings& WithAvailBlanking(AvailBlankingT&& value) {
    SetAvailBlanking(std::forward<AvailBlankingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetColorConversion3DLUTSettings(ColorConversion3DLUTSettingsT&& value) {
    ...
    m_colorConversion3DLUTSettings = std::forward<ColorConversion3DLUTSettingsT>(value);
  }
  template <typename ColorConversion3DLUTSettingsT = Aws::Vector<ColorConversion3DLUTSetting>>
  JobSettings& WithColorConversion3DLUTSettings(ColorConversion3DLUTSettingsT&& value) {
    SetColorConversion3DLUTSettings(std::forward<ColorConversion3DLUTSettingsT>(value));
    return *this;
  }
  ...
  JobSettings& AddColorConversion3DLUTSettings(ColorConversion3DLUTSettingsT&& value) {
    m_colorConversion3DLUTSettingsHasBeenSet = true;
    m_colorConversion3DLUTSettings.emplace_back(std::forward<ColorConversion3DLUTSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEsam(EsamT&& value) {
    m_esamHasBeenSet = true;
    m_esam = std::forward<EsamT>(value);
  }
  template <typename EsamT = EsamSettings>
  JobSettings& WithEsam(EsamT&& value) {
    SetEsam(std::forward<EsamT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExtendedDataServices(ExtendedDataServicesT&& value) {
    ...
    m_extendedDataServices = std::forward<ExtendedDataServicesT>(value);
  }
  template <typename ExtendedDataServicesT = ExtendedDataServices>
  JobSettings& WithExtendedDataServices(ExtendedDataServicesT&& value) {
    SetExtendedDataServices(std::forward<ExtendedDataServicesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFollowSource(int value) {
    m_followSourceHasBeenSet = true;
    m_followSource = value;
  }
  inline JobSettings& WithFollowSource(int value) {
  ...
  void SetKantarWatermark(KantarWatermarkT&& value) {
    ...
    m_kantarWatermark = std::forward<KantarWatermarkT>(value);
  }
  template <typename KantarWatermarkT = KantarWatermarkSettings>
  JobSettings& WithKantarWatermark(KantarWatermarkT&& value) {
    SetKantarWatermark(std::forward<KantarWatermarkT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMotionImageInserter(MotionImageInserterT&& value) {
    ...
    m_motionImageInserter = std::forward<MotionImageInserterT>(value);
  }
  template <typename MotionImageInserterT = MotionImageInserter>
  JobSettings& WithMotionImageInserter(MotionImageInserterT&& value) {
    SetMotionImageInserter(std::forward<MotionImageInserterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNielsenConfiguration(NielsenConfigurationT&& value) {
    ...
    m_nielsenConfiguration = std::forward<NielsenConfigurationT>(value);
  }
  template <typename NielsenConfigurationT = NielsenConfiguration>
  JobSettings& WithNielsenConfiguration(NielsenConfigurationT&& value) {
    SetNielsenConfiguration(std::forward<NielsenConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNielsenNonLinearWatermark(NielsenNonLinearWatermarkT&& value) {
    ...
    m_nielsenNonLinearWatermark = std::forward<NielsenNonLinearWatermarkT>(value);
  }
  template <typename NielsenNonLinearWatermarkT = NielsenNonLinearWatermarkSettings>
  JobSettings& WithNielsenNonLinearWatermark(NielsenNonLinearWatermarkT&& value) {
    SetNielsenNonLinearWatermark(std::forward<NielsenNonLinearWatermarkT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputGroups(OutputGroupsT&& value) {
    ...
    m_outputGroups = std::forward<OutputGroupsT>(value);
  }
  template <typename OutputGroupsT = Aws::Vector<OutputGroup>>
  JobSettings& WithOutputGroups(OutputGroupsT&& value) {
    SetOutputGroups(std::forward<OutputGroupsT>(value));
    return *this;
  }
  template <typename OutputGroupsT = OutputGroup>
  JobSettings& AddOutputGroups(OutputGroupsT&& value) {
    m_outputGroupsHasBeenSet = true;
    m_outputGroups.emplace_back(std::forward<OutputGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimecodeConfig(TimecodeConfigT&& value) {
    ...
    m_timecodeConfig = std::forward<TimecodeConfigT>(value);
  }
  template <typename TimecodeConfigT = TimecodeConfig>
  JobSettings& WithTimecodeConfig(TimecodeConfigT&& value) {
    SetTimecodeConfig(std::forward<TimecodeConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimedMetadataInsertion(TimedMetadataInsertionT&& value) {
    ...
    m_timedMetadataInsertion = std::forward<TimedMetadataInsertionT>(value);
  }
  template <typename TimedMetadataInsertionT = TimedMetadataInsertion>
  JobSettings& WithTimedMetadataInsertion(TimedMetadataInsertionT&& value) {
    SetTimedMetadataInsertion(std::forward<TimedMetadataInsertionT>(value));
    return *this;
  }
  ///@}
 private:
