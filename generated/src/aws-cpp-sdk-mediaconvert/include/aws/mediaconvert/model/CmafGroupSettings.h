...
class CmafGroupSettings {
 public:
  ...
  inline void SetClientCache(CmafClientCache value) {
    m_clientCacheHasBeenSet = true;
    m_clientCache = value;
  }
  inline CmafGroupSettings& WithClientCache(CmafClientCache value) {
  ...
  inline void SetCodecSpecification(CmafCodecSpecification value) {
    m_codecSpecificationHasBeenSet = true;
    m_codecSpecification = value;
  }
  inline CmafGroupSettings& WithCodecSpecification(CmafCodecSpecification value) {
  ...
  inline CmafGroupSettings& WithDashManifestStyle(DashManifestStyle value) {
  ...
  inline CmafGroupSettings& WithFragmentLength(int value) {
   ...
   * When you enable Write HLS manifest, MediaConvert creates a child manifest for
   * each set of images that you generate and adds corresponding entries to the
   * parent manifest. When you enable Write DASH manifest, MediaConvert adds an entry
   * in the .mpd manifest for each set of images that you generate. A common
   * application for these images is Roku trick mode. The thumbnails and full-frame
   * images that MediaConvert creates with this feature are compatible with this Roku
   * specification:
  ...
  inline void SetImageBasedTrickPlay(CmafImageBasedTrickPlay value) {
    m_imageBasedTrickPlayHasBeenSet = true;
    m_imageBasedTrickPlay = value;
  }
  inline CmafGroupSettings& WithImageBasedTrickPlay(CmafImageBasedTrickPlay value) {
   ...
   */
  inline const Aws::Vector<CmafImageBasedTrickPlayVariant>& GetImageBasedTrickPlayVariants() const { return m_imageBasedTrickPlayVariants; }
  inline bool ImageBasedTrickPlayVariantsHasBeenSet() const { return m_imageBasedTrickPlayVariantsHasBeenSet; }
  template <typename ImageBasedTrickPlayVariantsT = Aws::Vector<CmafImageBasedTrickPlayVariant>>
  ...
  template <typename ImageBasedTrickPlayVariantsT = CmafImageBasedTrickPlayVariant>
  ...
  inline void SetManifestCompression(CmafManifestCompression value) {
    m_manifestCompressionHasBeenSet = true;
    m_manifestCompression = value;
  }
  inline CmafGroupSettings& WithManifestCompression(CmafManifestCompression value) {
  ...
  inline void SetManifestDurationFormat(CmafManifestDurationFormat value) {
    m_manifestDurationFormatHasBeenSet = true;
    m_manifestDurationFormat = value;
  }
  inline CmafGroupSettings& WithManifestDurationFormat(CmafManifestDurationFormat value) {
  ...
  inline CmafGroupSettings& WithMinBufferTime(int value) {
  ...
  inline CmafGroupSettings& WithMinFinalSegmentLength(double value) {
  ...
  inline void SetMpdManifestBandwidthType(CmafMpdManifestBandwidthType value) {
    m_mpdManifestBandwidthTypeHasBeenSet = true;
    m_mpdManifestBandwidthType = value;
  }
  inline CmafGroupSettings& WithMpdManifestBandwidthType(CmafMpdManifestBandwidthType value) {
  ...
  inline void SetMpdProfile(CmafMpdProfile value) {
    m_mpdProfileHasBeenSet = true;
    m_mpdProfile = value;
  }
  inline CmafGroupSettings& WithMpdProfile(CmafMpdProfile value) {
    SetMpdProfile(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPtsOffsetHandlingForBFrames(CmafPtsOffsetHandlingForBFrames value) {
    m_ptsOffsetHandlingForBFramesHasBeenSet = true;
    m_ptsOffsetHandlingForBFrames = value;
  }
  inline CmafGroupSettings& WithPtsOffsetHandlingForBFrames(CmafPtsOffsetHandlingForBFrames value) {
  ...
  inline void SetSegmentControl(CmafSegmentControl value) {
    m_segmentControlHasBeenSet = true;
    m_segmentControl = value;
  }
  inline CmafGroupSettings& WithSegmentControl(CmafSegmentControl value) {
  ...
  inline CmafGroupSettings& WithSegmentLength(int value) {
  ...
  inline void SetSegmentLengthControl(CmafSegmentLengthControl value) {
    m_segmentLengthControlHasBeenSet = true;
    m_segmentLengthControl = value;
  }
  inline CmafGroupSettings& WithSegmentLengthControl(CmafSegmentLengthControl value) {
  ...
  inline void SetStreamInfResolution(CmafStreamInfResolution value) {
    m_streamInfResolutionHasBeenSet = true;
    m_streamInfResolution = value;
  }
  inline CmafGroupSettings& WithStreamInfResolution(CmafStreamInfResolution value) {
  ...
  inline void SetTargetDurationCompatibilityMode(CmafTargetDurationCompatibilityMode value) {
    m_targetDurationCompatibilityModeHasBeenSet = true;
    m_targetDurationCompatibilityMode = value;
  }
  inline CmafGroupSettings& WithTargetDurationCompatibilityMode(CmafTargetDurationCompatibilityMode value) {
  ...
  inline void SetVideoCompositionOffsets(CmafVideoCompositionOffsets value) {
    m_videoCompositionOffsetsHasBeenSet = true;
    m_videoCompositionOffsets = value;
  }
  inline CmafGroupSettings& WithVideoCompositionOffsets(CmafVideoCompositionOffsets value) {
  ...
  inline void SetWriteDashManifest(CmafWriteDASHManifest value) {
    m_writeDashManifestHasBeenSet = true;
    m_writeDashManifest = value;
  }
  inline CmafGroupSettings& WithWriteDashManifest(CmafWriteDASHManifest value) {
    SetWriteDashManifest(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWriteHlsManifest(CmafWriteHLSManifest value) {
    m_writeHlsManifestHasBeenSet = true;
    m_writeHlsManifest = value;
  }
  inline CmafGroupSettings& WithWriteHlsManifest(CmafWriteHLSManifest value) {
    SetWriteHlsManifest(value);
    return *this;
  }
  ///@}
   ...
   */
  inline CmafWriteSegmentTimelineInRepresentation GetWriteSegmentTimelineInRepresentation() const {
  ...
  inline void SetWriteSegmentTimelineInRepresentation(CmafWriteSegmentTimelineInRepresentation value) {
    m_writeSegmentTimelineInRepresentationHasBeenSet = true;
    m_writeSegmentTimelineInRepresentation = value;
  }
  inline CmafGroupSettings& WithWriteSegmentTimelineInRepresentation(CmafWriteSegmentTimelineInRepresentation value) {
 ...
 private:
  ...
  Aws::Vector<CmafImageBasedTrickPlayVariant> m_imageBasedTrickPlayVariants;
