...
class CaptionDestinationSettings {
 public:
  ...
  void SetBurninDestinationSettings(BurninDestinationSettingsT&& value) {
    ...
    m_burninDestinationSettings = std::forward<BurninDestinationSettingsT>(value);
  }
  template <typename BurninDestinationSettingsT = BurninDestinationSettings>
  CaptionDestinationSettings& WithBurninDestinationSettings(BurninDestinationSettingsT&& value) {
    SetBurninDestinationSettings(std::forward<BurninDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDestinationType(CaptionDestinationType value) {
    m_destinationTypeHasBeenSet = true;
    m_destinationType = value;
  }
  inline CaptionDestinationSettings& WithDestinationType(CaptionDestinationType value) {
  ...
  void SetDvbSubDestinationSettings(DvbSubDestinationSettingsT&& value) {
    ...
    m_dvbSubDestinationSettings = std::forward<DvbSubDestinationSettingsT>(value);
  }
  template <typename DvbSubDestinationSettingsT = DvbSubDestinationSettings>
  CaptionDestinationSettings& WithDvbSubDestinationSettings(DvbSubDestinationSettingsT&& value) {
    SetDvbSubDestinationSettings(std::forward<DvbSubDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmbeddedDestinationSettings(EmbeddedDestinationSettingsT&& value) {
    ...
    m_embeddedDestinationSettings = std::forward<EmbeddedDestinationSettingsT>(value);
  }
  template <typename EmbeddedDestinationSettingsT = EmbeddedDestinationSettings>
  CaptionDestinationSettings& WithEmbeddedDestinationSettings(EmbeddedDestinationSettingsT&& value) {
    SetEmbeddedDestinationSettings(std::forward<EmbeddedDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImscDestinationSettings(ImscDestinationSettingsT&& value) {
    ...
    m_imscDestinationSettings = std::forward<ImscDestinationSettingsT>(value);
  }
  template <typename ImscDestinationSettingsT = ImscDestinationSettings>
  CaptionDestinationSettings& WithImscDestinationSettings(ImscDestinationSettingsT&& value) {
    SetImscDestinationSettings(std::forward<ImscDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSccDestinationSettings(SccDestinationSettingsT&& value) {
    ...
    m_sccDestinationSettings = std::forward<SccDestinationSettingsT>(value);
  }
  template <typename SccDestinationSettingsT = SccDestinationSettings>
  CaptionDestinationSettings& WithSccDestinationSettings(SccDestinationSettingsT&& value) {
    SetSccDestinationSettings(std::forward<SccDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSrtDestinationSettings(SrtDestinationSettingsT&& value) {
    ...
    m_srtDestinationSettings = std::forward<SrtDestinationSettingsT>(value);
  }
  template <typename SrtDestinationSettingsT = SrtDestinationSettings>
  CaptionDestinationSettings& WithSrtDestinationSettings(SrtDestinationSettingsT&& value) {
    SetSrtDestinationSettings(std::forward<SrtDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTeletextDestinationSettings(TeletextDestinationSettingsT&& value) {
    ...
    m_teletextDestinationSettings = std::forward<TeletextDestinationSettingsT>(value);
  }
  template <typename TeletextDestinationSettingsT = TeletextDestinationSettings>
  CaptionDestinationSettings& WithTeletextDestinationSettings(TeletextDestinationSettingsT&& value) {
    SetTeletextDestinationSettings(std::forward<TeletextDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTtmlDestinationSettings(TtmlDestinationSettingsT&& value) {
    ...
    m_ttmlDestinationSettings = std::forward<TtmlDestinationSettingsT>(value);
  }
  template <typename TtmlDestinationSettingsT = TtmlDestinationSettings>
  CaptionDestinationSettings& WithTtmlDestinationSettings(TtmlDestinationSettingsT&& value) {
    SetTtmlDestinationSettings(std::forward<TtmlDestinationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWebvttDestinationSettings(WebvttDestinationSettingsT&& value) {
    ...
    m_webvttDestinationSettings = std::forward<WebvttDestinationSettingsT>(value);
  }
  template <typename WebvttDestinationSettingsT = WebvttDestinationSettings>
  CaptionDestinationSettings& WithWebvttDestinationSettings(WebvttDestinationSettingsT&& value) {
    SetWebvttDestinationSettings(std::forward<WebvttDestinationSettingsT>(value));
    return *this;
  }
  ///@}
 private:
