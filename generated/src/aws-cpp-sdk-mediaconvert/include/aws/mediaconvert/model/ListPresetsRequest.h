...
class ListPresetsRequest : public MediaConvertRequest {
 public:
  ...
  inline void SetListBy(PresetListBy value) {
    m_listByHasBeenSet = true;
    m_listBy = value;
  }
  inline ListPresetsRequest& WithListBy(PresetListBy value) {
    SetListBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListPresetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListPresetsRequest& WithOrder(Order value) {
    SetOrder(value);
    return *this;
  }
  ///@}
