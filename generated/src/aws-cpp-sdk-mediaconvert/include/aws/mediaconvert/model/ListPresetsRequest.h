...
namespace Model
{
  ...
  public:
    ...
    template<typename CategoryT = Aws::String>
    ListPresetsRequest& WithCategory(CategoryT&& value) { SetCategory(std::forward<CategoryT>(value)); return *this;}
    ///@}
     ...
     */
    inline PresetListBy GetListBy() const { return m_listBy; }
    inline bool ListByHasBeenSet() const { return m_listByHasBeenSet; }
    inline void SetListBy(PresetListBy value) { m_listByHasBeenSet = true; m_listBy = value; }
    inline ListPresetsRequest& WithListBy(PresetListBy value) { SetListBy(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListPresetsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline ListPresetsRequest& WithOrder(Order value) { SetOrder(value); return *this;}
    ///@}
  private:
    ...
    PresetListBy m_listBy{PresetListBy::NOT_SET};
