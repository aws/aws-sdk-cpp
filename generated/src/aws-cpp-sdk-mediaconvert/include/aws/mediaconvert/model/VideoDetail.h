...
class VideoDetail {
 public:
  ...
  inline void SetHeightInPx(int value) {
    m_heightInPxHasBeenSet = true;
    m_heightInPx = value;
  }
  inline VideoDetail& WithHeightInPx(int value) {
    SetHeightInPx(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWidthInPx(int value) {
    m_widthInPxHasBeenSet = true;
    m_widthInPx = value;
  }
  inline VideoDetail& WithWidthInPx(int value) {
    SetWidthInPx(value);
    return *this;
  }
  ///@}
