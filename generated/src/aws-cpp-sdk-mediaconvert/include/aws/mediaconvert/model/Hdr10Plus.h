...
class Hdr10Plus {
 public:
  ...
  inline void SetMasteringMonitorNits(int value) {
    m_masteringMonitorNitsHasBeenSet = true;
    m_masteringMonitorNits = value;
  }
  inline Hdr10Plus& WithMasteringMonitorNits(int value) {
    SetMasteringMonitorNits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetMonitorNits(int value) {
    m_targetMonitorNitsHasBeenSet = true;
    m_targetMonitorNits = value;
  }
  inline Hdr10Plus& WithTargetMonitorNits(int value) {
    SetTargetMonitorNits(value);
    return *this;
  }
  ///@}
 private:
