...
class Eac3Settings {
 public:
  ...
  inline void SetAttenuationControl(Eac3AttenuationControl value) {
    m_attenuationControlHasBeenSet = true;
    m_attenuationControl = value;
  }
  inline Eac3Settings& WithAttenuationControl(Eac3AttenuationControl value) {
    SetAttenuationControl(value);
    return *this;
  }
  ///@}
  ...
  inline Eac3Settings& WithBitrate(int value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBitstreamMode(Eac3BitstreamMode value) {
    m_bitstreamModeHasBeenSet = true;
    m_bitstreamMode = value;
  }
  inline Eac3Settings& WithBitstreamMode(Eac3BitstreamMode value) {
  ...
  inline void SetCodingMode(Eac3CodingMode value) {
    m_codingModeHasBeenSet = true;
    m_codingMode = value;
  }
  inline Eac3Settings& WithCodingMode(Eac3CodingMode value) {
    SetCodingMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDcFilter(Eac3DcFilter value) {
    m_dcFilterHasBeenSet = true;
    m_dcFilter = value;
  }
  inline Eac3Settings& WithDcFilter(Eac3DcFilter value) {
    SetDcFilter(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDialnorm(int value) {
    m_dialnormHasBeenSet = true;
    m_dialnorm = value;
  }
  inline Eac3Settings& WithDialnorm(int value) {
    SetDialnorm(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDynamicRangeCompressionLine(Eac3DynamicRangeCompressionLine value) {
    m_dynamicRangeCompressionLineHasBeenSet = true;
    m_dynamicRangeCompressionLine = value;
  }
  inline Eac3Settings& WithDynamicRangeCompressionLine(Eac3DynamicRangeCompressionLine value) {
  ...
  inline void SetDynamicRangeCompressionRf(Eac3DynamicRangeCompressionRf value) {
    m_dynamicRangeCompressionRfHasBeenSet = true;
    m_dynamicRangeCompressionRf = value;
  }
  inline Eac3Settings& WithDynamicRangeCompressionRf(Eac3DynamicRangeCompressionRf value) {
  ...
  inline void SetLfeControl(Eac3LfeControl value) {
    m_lfeControlHasBeenSet = true;
    m_lfeControl = value;
  }
  inline Eac3Settings& WithLfeControl(Eac3LfeControl value) {
    SetLfeControl(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLfeFilter(Eac3LfeFilter value) {
    m_lfeFilterHasBeenSet = true;
    m_lfeFilter = value;
  }
  inline Eac3Settings& WithLfeFilter(Eac3LfeFilter value) {
    SetLfeFilter(value);
    return *this;
  }
  ///@}
  ...
  inline Eac3Settings& WithLoRoCenterMixLevel(double value) {
  ...
  inline Eac3Settings& WithLoRoSurroundMixLevel(double value) {
  ...
  inline Eac3Settings& WithLtRtCenterMixLevel(double value) {
  ...
  inline Eac3Settings& WithLtRtSurroundMixLevel(double value) {
  ...
  inline void SetMetadataControl(Eac3MetadataControl value) {
    m_metadataControlHasBeenSet = true;
    m_metadataControl = value;
  }
  inline Eac3Settings& WithMetadataControl(Eac3MetadataControl value) {
    SetMetadataControl(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPassthroughControl(Eac3PassthroughControl value) {
    m_passthroughControlHasBeenSet = true;
    m_passthroughControl = value;
  }
  inline Eac3Settings& WithPassthroughControl(Eac3PassthroughControl value) {
  ...
  inline void SetPhaseControl(Eac3PhaseControl value) {
    m_phaseControlHasBeenSet = true;
    m_phaseControl = value;
  }
  inline Eac3Settings& WithPhaseControl(Eac3PhaseControl value) {
    SetPhaseControl(value);
    return *this;
  }
  ///@}
  ...
  inline Eac3Settings& WithSampleRate(int value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStereoDownmix(Eac3StereoDownmix value) {
    m_stereoDownmixHasBeenSet = true;
    m_stereoDownmix = value;
  }
  inline Eac3Settings& WithStereoDownmix(Eac3StereoDownmix value) {
  ...
  inline void SetSurroundExMode(Eac3SurroundExMode value) {
    m_surroundExModeHasBeenSet = true;
    m_surroundExMode = value;
  }
  inline Eac3Settings& WithSurroundExMode(Eac3SurroundExMode value) {
  ...
  inline void SetSurroundMode(Eac3SurroundMode value) {
    m_surroundModeHasBeenSet = true;
    m_surroundMode = value;
  }
  inline Eac3Settings& WithSurroundMode(Eac3SurroundMode value) {
    SetSurroundMode(value);
    return *this;
  }
  ///@}
 private:
