...
class ColorConversion3DLUTSetting {
 public:
  ...
  template <typename FileInputT = Aws::String>
  ColorConversion3DLUTSetting& WithFileInput(FileInputT&& value) {
  ...
  inline void SetInputColorSpace(ColorSpace value) {
    m_inputColorSpaceHasBeenSet = true;
    m_inputColorSpace = value;
  }
  inline ColorConversion3DLUTSetting& WithInputColorSpace(ColorSpace value) {
  ...
  inline void SetInputMasteringLuminance(int value) {
    m_inputMasteringLuminanceHasBeenSet = true;
    m_inputMasteringLuminance = value;
  }
  inline ColorConversion3DLUTSetting& WithInputMasteringLuminance(int value) {
    SetInputMasteringLuminance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutputColorSpace(ColorSpace value) {
    m_outputColorSpaceHasBeenSet = true;
    m_outputColorSpace = value;
  }
  inline ColorConversion3DLUTSetting& WithOutputColorSpace(ColorSpace value) {
    SetOutputColorSpace(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutputMasteringLuminance(int value) {
    m_outputMasteringLuminanceHasBeenSet = true;
    m_outputMasteringLuminance = value;
  }
  inline ColorConversion3DLUTSetting& WithOutputMasteringLuminance(int value) {
    SetOutputMasteringLuminance(value);
    return *this;
  }
  ///@}
 private:
