...
class InputDecryptionSettings {
 public:
  ...
  inline void SetDecryptionMode(DecryptionMode value) {
    m_decryptionModeHasBeenSet = true;
    m_decryptionMode = value;
  }
  inline InputDecryptionSettings& WithDecryptionMode(DecryptionMode value) {
    SetDecryptionMode(value);
    return *this;
  }
  ///@}
  ...
  void SetEncryptedDecryptionKey(EncryptedDecryptionKeyT&& value) {
    ...
    m_encryptedDecryptionKey = std::forward<EncryptedDecryptionKeyT>(value);
  }
  template <typename EncryptedDecryptionKeyT = Aws::String>
  InputDecryptionSettings& WithEncryptedDecryptionKey(EncryptedDecryptionKeyT&& value) {
    SetEncryptedDecryptionKey(std::forward<EncryptedDecryptionKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKmsKeyRegion(KmsKeyRegionT&& value) {
    m_kmsKeyRegionHasBeenSet = true;
    m_kmsKeyRegion = std::forward<KmsKeyRegionT>(value);
  }
  template <typename KmsKeyRegionT = Aws::String>
  InputDecryptionSettings& WithKmsKeyRegion(KmsKeyRegionT&& value) {
    SetKmsKeyRegion(std::forward<KmsKeyRegionT>(value));
    return *this;
  }
  ///@}
 private:
