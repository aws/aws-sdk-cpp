...
namespace Model
{
  ...
  public:
    ...
    inline void SetIntervalCadence(CmafIntervalCadence value) { m_intervalCadenceHasBeenSet = true; m_intervalCadence = value; }
    inline CmafImageBasedTrickPlaySettings& WithIntervalCadence(CmafIntervalCadence value) { SetIntervalCadence(value); return *this;}
    ///@}
