...
class CmafImageBasedTrickPlaySettings {
 public:
  AWS_MEDIACONVERT_API CmafImageBasedTrickPlaySettings() = default;
  ...
  inline CmafImageBasedTrickPlaySettings& WithIntervalCadence(CmafIntervalCadence value) {
  ...
  inline CmafImageBasedTrickPlaySettings& WithThumbnailHeight(int value) {
  ...
  inline CmafImageBasedTrickPlaySettings& WithThumbnailInterval(double value) {
  ...
  inline CmafImageBasedTrickPlaySettings& WithThumbnailWidth(int value) {
  ...
  inline CmafImageBasedTrickPlaySettings& WithTileHeight(int value) {
    SetTileHeight(value);
    return *this;
  }
  ///@}
  ...
  inline CmafImageBasedTrickPlaySettings& WithTileWidth(int value) {
    SetTileWidth(value);
    return *this;
  }
  ///@}
