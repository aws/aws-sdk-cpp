...
class WebvttDestinationSettings {
 public:
  ...
  inline void SetAccessibility(WebvttAccessibilitySubs value) {
    m_accessibilityHasBeenSet = true;
    m_accessibility = value;
  }
  inline WebvttDestinationSettings& WithAccessibility(WebvttAccessibilitySubs value) {
  ...
  inline void SetStylePassthrough(WebvttStylePassthrough value) {
    m_stylePassthroughHasBeenSet = true;
    m_stylePassthrough = value;
  }
  inline WebvttDestinationSettings& WithStylePassthrough(WebvttStylePassthrough value) {
