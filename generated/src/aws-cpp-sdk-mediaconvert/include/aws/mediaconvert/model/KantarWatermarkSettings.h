...
class KantarWatermarkSettings {
 public:
  ...
  void SetCredentialsSecretName(CredentialsSecretNameT&& value) {
    ...
    m_credentialsSecretName = std::forward<CredentialsSecretNameT>(value);
  }
  template <typename CredentialsSecretNameT = Aws::String>
  KantarWatermarkSettings& WithCredentialsSecretName(CredentialsSecretNameT&& value) {
    SetCredentialsSecretName(std::forward<CredentialsSecretNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFileOffset(double value) {
    m_fileOffsetHasBeenSet = true;
    m_fileOffset = value;
  }
  inline KantarWatermarkSettings& WithFileOffset(double value) {
    SetFileOffset(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKantarLicenseId(int value) {
    m_kantarLicenseIdHasBeenSet = true;
    m_kantarLicenseId = value;
  }
  inline KantarWatermarkSettings& WithKantarLicenseId(int value) {
    SetKantarLicenseId(value);
    return *this;
  }
  ///@}
  ...
  void SetKantarServerUrl(KantarServerUrlT&& value) {
    m_kantarServerUrlHasBeenSet = true;
    m_kantarServerUrl = std::forward<KantarServerUrlT>(value);
  }
  template <typename KantarServerUrlT = Aws::String>
  KantarWatermarkSettings& WithKantarServerUrl(KantarServerUrlT&& value) {
    SetKantarServerUrl(std::forward<KantarServerUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadata3(Metadata3T&& value) {
    m_metadata3HasBeenSet = true;
    m_metadata3 = std::forward<Metadata3T>(value);
  }
  template <typename Metadata3T = Aws::String>
  KantarWatermarkSettings& WithMetadata3(Metadata3T&& value) {
    SetMetadata3(std::forward<Metadata3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadata4(Metadata4T&& value) {
    m_metadata4HasBeenSet = true;
    m_metadata4 = std::forward<Metadata4T>(value);
  }
  template <typename Metadata4T = Aws::String>
  KantarWatermarkSettings& WithMetadata4(Metadata4T&& value) {
    SetMetadata4(std::forward<Metadata4T>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadata5(Metadata5T&& value) {
    m_metadata5HasBeenSet = true;
    m_metadata5 = std::forward<Metadata5T>(value);
  }
  template <typename Metadata5T = Aws::String>
  KantarWatermarkSettings& WithMetadata5(Metadata5T&& value) {
    SetMetadata5(std::forward<Metadata5T>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadata6(Metadata6T&& value) {
    m_metadata6HasBeenSet = true;
    m_metadata6 = std::forward<Metadata6T>(value);
  }
  template <typename Metadata6T = Aws::String>
  KantarWatermarkSettings& WithMetadata6(Metadata6T&& value) {
    SetMetadata6(std::forward<Metadata6T>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadata7(Metadata7T&& value) {
    m_metadata7HasBeenSet = true;
    m_metadata7 = std::forward<Metadata7T>(value);
  }
  template <typename Metadata7T = Aws::String>
  KantarWatermarkSettings& WithMetadata7(Metadata7T&& value) {
    SetMetadata7(std::forward<Metadata7T>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadata8(Metadata8T&& value) {
    m_metadata8HasBeenSet = true;
    m_metadata8 = std::forward<Metadata8T>(value);
  }
  template <typename Metadata8T = Aws::String>
  KantarWatermarkSettings& WithMetadata8(Metadata8T&& value) {
    SetMetadata8(std::forward<Metadata8T>(value));
    return *this;
  }
  ///@}
 private:
