...
class OutputGroup {
 public:
  ...
  void SetAutomatedEncodingSettings(AutomatedEncodingSettingsT&& value) {
    ...
    m_automatedEncodingSettings = std::forward<AutomatedEncodingSettingsT>(value);
  }
  template <typename AutomatedEncodingSettingsT = AutomatedEncodingSettings>
  OutputGroup& WithAutomatedEncodingSettings(AutomatedEncodingSettingsT&& value) {
    SetAutomatedEncodingSettings(std::forward<AutomatedEncodingSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomName(CustomNameT&& value) {
    ...
    m_customName = std::forward<CustomNameT>(value);
  }
  template <typename CustomNameT = Aws::String>
  OutputGroup& WithCustomName(CustomNameT&& value) {
    SetCustomName(std::forward<CustomNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputGroupSettings(OutputGroupSettingsT&& value) {
    ...
    m_outputGroupSettings = std::forward<OutputGroupSettingsT>(value);
  }
  template <typename OutputGroupSettingsT = OutputGroupSettings>
  OutputGroup& WithOutputGroupSettings(OutputGroupSettingsT&& value) {
    SetOutputGroupSettings(std::forward<OutputGroupSettingsT>(value));
    return *this;
  }
  ///@}
