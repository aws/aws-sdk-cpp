...
class Job {
 public:
  ...
  void SetAccelerationSettings(AccelerationSettingsT&& value) {
    ...
    m_accelerationSettings = std::forward<AccelerationSettingsT>(value);
  }
  template <typename AccelerationSettingsT = AccelerationSettings>
  Job& WithAccelerationSettings(AccelerationSettingsT&& value) {
    SetAccelerationSettings(std::forward<AccelerationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAccelerationStatus(AccelerationStatus value) {
    m_accelerationStatusHasBeenSet = true;
    m_accelerationStatus = value;
  }
  inline Job& WithAccelerationStatus(AccelerationStatus value) {
    SetAccelerationStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBillingTagsSource(BillingTagsSource value) {
    m_billingTagsSourceHasBeenSet = true;
    m_billingTagsSource = value;
  }
  inline Job& WithBillingTagsSource(BillingTagsSource value) {
    SetBillingTagsSource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCurrentPhase(JobPhase value) {
  ...
  inline Job& WithErrorCode(int value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  void SetHopDestinations(HopDestinationsT&& value) {
    ...
    m_hopDestinations = std::forward<HopDestinationsT>(value);
  }
  template <typename HopDestinationsT = Aws::Vector<HopDestination>>
  Job& WithHopDestinations(HopDestinationsT&& value) {
    SetHopDestinations(std::forward<HopDestinationsT>(value));
    return *this;
  }
  template <typename HopDestinationsT = HopDestination>
  Job& AddHopDestinations(HopDestinationsT&& value) {
    m_hopDestinationsHasBeenSet = true;
    m_hopDestinations.emplace_back(std::forward<HopDestinationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobEngineVersionRequested(JobEngineVersionRequestedT&& value) {
    ...
    m_jobEngineVersionRequested = std::forward<JobEngineVersionRequestedT>(value);
  }
  template <typename JobEngineVersionRequestedT = Aws::String>
  Job& WithJobEngineVersionRequested(JobEngineVersionRequestedT&& value) {
    SetJobEngineVersionRequested(std::forward<JobEngineVersionRequestedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobEngineVersionUsed(JobEngineVersionUsedT&& value) {
    ...
    m_jobEngineVersionUsed = std::forward<JobEngineVersionUsedT>(value);
  }
  template <typename JobEngineVersionUsedT = Aws::String>
  Job& WithJobEngineVersionUsed(JobEngineVersionUsedT&& value) {
    SetJobEngineVersionUsed(std::forward<JobEngineVersionUsedT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetJobPercentComplete(int value) {
    m_jobPercentCompleteHasBeenSet = true;
    m_jobPercentComplete = value;
  }
  inline Job& WithJobPercentComplete(int value) {
    SetJobPercentComplete(value);
    return *this;
  }
  ///@}
  ...
  void SetLastShareDetails(LastShareDetailsT&& value) {
    ...
    m_lastShareDetails = std::forward<LastShareDetailsT>(value);
  }
  template <typename LastShareDetailsT = Aws::String>
  Job& WithLastShareDetails(LastShareDetailsT&& value) {
    SetLastShareDetails(std::forward<LastShareDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputGroupDetails(OutputGroupDetailsT&& value) {
    ...
    m_outputGroupDetails = std::forward<OutputGroupDetailsT>(value);
  }
  template <typename OutputGroupDetailsT = Aws::Vector<OutputGroupDetail>>
  Job& WithOutputGroupDetails(OutputGroupDetailsT&& value) {
    SetOutputGroupDetails(std::forward<OutputGroupDetailsT>(value));
    return *this;
  }
  template <typename OutputGroupDetailsT = OutputGroupDetail>
  Job& AddOutputGroupDetails(OutputGroupDetailsT&& value) {
    m_outputGroupDetailsHasBeenSet = true;
    m_outputGroupDetails.emplace_back(std::forward<OutputGroupDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Job& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  void SetQueueTransitions(QueueTransitionsT&& value) {
    ...
    m_queueTransitions = std::forward<QueueTransitionsT>(value);
  }
  template <typename QueueTransitionsT = Aws::Vector<QueueTransition>>
  Job& WithQueueTransitions(QueueTransitionsT&& value) {
    SetQueueTransitions(std::forward<QueueTransitionsT>(value));
    return *this;
  }
  template <typename QueueTransitionsT = QueueTransition>
  Job& AddQueueTransitions(QueueTransitionsT&& value) {
    m_queueTransitionsHasBeenSet = true;
    m_queueTransitions.emplace_back(std::forward<QueueTransitionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRetryCount(int value) {
    m_retryCountHasBeenSet = true;
    m_retryCount = value;
  }
  inline Job& WithRetryCount(int value) {
    SetRetryCount(value);
    return *this;
  }
  ///@}
  ...
  inline Job& WithShareStatus(ShareStatus value) {
  ...
  inline void SetSimulateReservedQueue(SimulateReservedQueue value) {
    m_simulateReservedQueueHasBeenSet = true;
    m_simulateReservedQueue = value;
  }
  inline Job& WithSimulateReservedQueue(SimulateReservedQueue value) {
    SetSimulateReservedQueue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusUpdateInterval(StatusUpdateInterval value) {
    m_statusUpdateIntervalHasBeenSet = true;
    m_statusUpdateInterval = value;
  }
  inline Job& WithStatusUpdateInterval(StatusUpdateInterval value) {
