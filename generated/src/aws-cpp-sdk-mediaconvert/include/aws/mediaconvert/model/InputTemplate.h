...
class InputTemplate {
 public:
  ...
  inline InputTemplate& WithAdvancedInputFilter(AdvancedInputFilter value) {
  ...
  inline InputTemplate& WithDeblockFilter(InputDeblockFilter value) {
  ...
  inline InputTemplate& WithDenoiseFilter(InputDenoiseFilter value) {
  ...
  inline InputTemplate& WithFilterEnable(InputFilterEnable value) {
  ...
  inline InputTemplate& WithFilterStrength(int value) {
  ...
  inline InputTemplate& WithInputScanType(InputScanType value) {
  ...
  inline InputTemplate& WithProgramNumber(int value) {
  ...
  inline InputTemplate& WithPsiControl(InputPsiControl value) {
    SetPsiControl(value);
    return *this;
  }
  ///@}
  ...
  inline InputTemplate& WithTimecodeSource(InputTimecodeSource value) {
