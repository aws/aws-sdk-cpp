...
class Track {
 public:
  ...
  void SetAudioProperties(AudioPropertiesT&& value) {
    ...
    m_audioProperties = std::forward<AudioPropertiesT>(value);
  }
  template <typename AudioPropertiesT = AudioProperties>
  Track& WithAudioProperties(AudioPropertiesT&& value) {
    SetAudioProperties(std::forward<AudioPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCodec(Codec value) {
    m_codecHasBeenSet = true;
    m_codec = value;
  }
  inline Track& WithCodec(Codec value) {
    SetCodec(value);
    return *this;
  }
  ///@}
  ...
  void SetDataProperties(DataPropertiesT&& value) {
    ...
    m_dataProperties = std::forward<DataPropertiesT>(value);
  }
  template <typename DataPropertiesT = DataProperties>
  Track& WithDataProperties(DataPropertiesT&& value) {
    SetDataProperties(std::forward<DataPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline Track& WithDuration(double value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline Track& WithIndex(int value) {
    SetIndex(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTrackType(TrackType value) {
    m_trackTypeHasBeenSet = true;
    m_trackType = value;
  }
  inline Track& WithTrackType(TrackType value) {
    SetTrackType(value);
    return *this;
  }
  ///@}
  ...
  void SetVideoProperties(VideoPropertiesT&& value) {
    ...
    m_videoProperties = std::forward<VideoPropertiesT>(value);
  }
  template <typename VideoPropertiesT = VideoProperties>
  Track& WithVideoProperties(VideoPropertiesT&& value) {
    SetVideoProperties(std::forward<VideoPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
