 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mediaconvert-2017-08-29/DashIsoImageBasedTrickPlayVariant">AWS
 * API Reference</a></p>
 */
class DashIsoImageBasedTrickPlayVariant {
 public:
  AWS_MEDIACONVERT_API DashIsoImageBasedTrickPlayVariant() = default;
  AWS_MEDIACONVERT_API DashIsoImageBasedTrickPlayVariant(Aws::Utils::Json::JsonView jsonValue);
  AWS_MEDIACONVERT_API DashIsoImageBasedTrickPlayVariant& operator=(Aws::Utils::Json::JsonView jsonValue);
   ...
   * 1x1 tiling.
   */
  inline DashIsoIntervalCadence GetIntervalCadence() const { return m_intervalCadence; }
  inline bool IntervalCadenceHasBeenSet() const { return m_intervalCadenceHasBeenSet; }
  inline void SetIntervalCadence(DashIsoIntervalCadence value) {
    m_intervalCadenceHasBeenSet = true;
    m_intervalCadence = value;
  }
  inline DashIsoImageBasedTrickPlayVariant& WithIntervalCadence(DashIsoIntervalCadence value) {
  ...
  inline DashIsoImageBasedTrickPlayVariant& WithThumbnailHeight(int value) {
  ...
  inline DashIsoImageBasedTrickPlayVariant& WithThumbnailInterval(double value) {
  ...
  inline DashIsoImageBasedTrickPlayVariant& WithThumbnailWidth(int value) {
  ...
  inline DashIsoImageBasedTrickPlayVariant& WithTileHeight(int value) {
    SetTileHeight(value);
    return *this;
  }
  ///@}
  ...
  inline DashIsoImageBasedTrickPlayVariant& WithTileWidth(int value) {
    SetTileWidth(value);
    return *this;
  }
  ///@}
