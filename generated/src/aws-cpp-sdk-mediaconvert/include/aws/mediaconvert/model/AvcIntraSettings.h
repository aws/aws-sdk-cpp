...
class AvcIntraSettings {
 public:
  ...
  inline void SetAvcIntraClass(AvcIntraClass value) {
    m_avcIntraClassHasBeenSet = true;
    m_avcIntraClass = value;
  }
  inline AvcIntraSettings& WithAvcIntraClass(AvcIntraClass value) {
    SetAvcIntraClass(value);
    return *this;
  }
  ///@}
  ...
  void SetAvcIntraUhdSettings(AvcIntraUhdSettingsT&& value) {
    ...
    m_avcIntraUhdSettings = std::forward<AvcIntraUhdSettingsT>(value);
  }
  template <typename AvcIntraUhdSettingsT = AvcIntraUhdSettings>
  AvcIntraSettings& WithAvcIntraUhdSettings(AvcIntraUhdSettingsT&& value) {
    SetAvcIntraUhdSettings(std::forward<AvcIntraUhdSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFramerateControl(AvcIntraFramerateControl value) {
    m_framerateControlHasBeenSet = true;
    m_framerateControl = value;
  }
  inline AvcIntraSettings& WithFramerateControl(AvcIntraFramerateControl value) {
  ...
  inline void SetFramerateConversionAlgorithm(AvcIntraFramerateConversionAlgorithm value) {
    m_framerateConversionAlgorithmHasBeenSet = true;
    m_framerateConversionAlgorithm = value;
  }
  inline AvcIntraSettings& WithFramerateConversionAlgorithm(AvcIntraFramerateConversionAlgorithm value) {
  ...
  inline AvcIntraSettings& WithFramerateDenominator(int value) {
  ...
  inline AvcIntraSettings& WithFramerateNumerator(int value) {
  ...
  inline void SetInterlaceMode(AvcIntraInterlaceMode value) {
    m_interlaceModeHasBeenSet = true;
    m_interlaceMode = value;
  }
  inline AvcIntraSettings& WithInterlaceMode(AvcIntraInterlaceMode value) {
  ...
  inline AvcIntraSettings& AddPerFrameMetrics(FrameMetricType value) {
    m_perFrameMetricsHasBeenSet = true;
  ...
  inline void SetScanTypeConversionMode(AvcIntraScanTypeConversionMode value) {
    m_scanTypeConversionModeHasBeenSet = true;
    m_scanTypeConversionMode = value;
  }
  inline AvcIntraSettings& WithScanTypeConversionMode(AvcIntraScanTypeConversionMode value) {
  ...
  inline void SetSlowPal(AvcIntraSlowPal value) {
    m_slowPalHasBeenSet = true;
    m_slowPal = value;
  }
  inline AvcIntraSettings& WithSlowPal(AvcIntraSlowPal value) {
    SetSlowPal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTelecine(AvcIntraTelecine value) {
    m_telecineHasBeenSet = true;
    m_telecine = value;
  }
  inline AvcIntraSettings& WithTelecine(AvcIntraTelecine value) {
    SetTelecine(value);
    return *this;
  }
  ///@}
