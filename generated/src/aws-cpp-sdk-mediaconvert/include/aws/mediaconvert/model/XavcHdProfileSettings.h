...
class XavcHdProfileSettings {
 public:
  ...
  inline void SetBitrateClass(XavcHdProfileBitrateClass value) {
    m_bitrateClassHasBeenSet = true;
    m_bitrateClass = value;
  }
  inline XavcHdProfileSettings& WithBitrateClass(XavcHdProfileBitrateClass value) {
  ...
  inline XavcHdProfileSettings& WithFlickerAdaptiveQuantization(XavcFlickerAdaptiveQuantization value) {
  ...
  inline XavcHdProfileSettings& WithGopBReference(XavcGopBReference value) {
  ...
  inline XavcHdProfileSettings& WithGopClosedCadence(int value) {
  ...
  inline XavcHdProfileSettings& WithHrdBufferSize(int value) {
  ...
  inline XavcHdProfileSettings& WithInterlaceMode(XavcInterlaceMode value) {
  ...
  inline void SetQualityTuningLevel(XavcHdProfileQualityTuningLevel value) {
    m_qualityTuningLevelHasBeenSet = true;
    m_qualityTuningLevel = value;
  }
  inline XavcHdProfileSettings& WithQualityTuningLevel(XavcHdProfileQualityTuningLevel value) {
  ...
  inline XavcHdProfileSettings& WithSlices(int value) {
    SetSlices(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTelecine(XavcHdProfileTelecine value) {
    m_telecineHasBeenSet = true;
    m_telecine = value;
  }
  inline XavcHdProfileSettings& WithTelecine(XavcHdProfileTelecine value) {
    SetTelecine(value);
    return *this;
  }
  ///@}
