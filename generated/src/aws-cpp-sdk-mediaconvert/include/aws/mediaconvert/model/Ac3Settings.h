...
class Ac3Settings {
 public:
  ...
  inline Ac3Settings& WithBitrate(int value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBitstreamMode(Ac3BitstreamMode value) {
    m_bitstreamModeHasBeenSet = true;
    m_bitstreamMode = value;
  }
  inline Ac3Settings& WithBitstreamMode(Ac3BitstreamMode value) {
  ...
  inline void SetCodingMode(Ac3CodingMode value) {
    m_codingModeHasBeenSet = true;
    m_codingMode = value;
  }
  inline Ac3Settings& WithCodingMode(Ac3CodingMode value) {
    SetCodingMode(value);
    return *this;
  }
  ///@}
  ...
  inline Ac3Settings& WithDialnorm(int value) {
    SetDialnorm(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDynamicRangeCompressionLine(Ac3DynamicRangeCompressionLine value) {
    m_dynamicRangeCompressionLineHasBeenSet = true;
    m_dynamicRangeCompressionLine = value;
  }
  inline Ac3Settings& WithDynamicRangeCompressionLine(Ac3DynamicRangeCompressionLine value) {
  ...
  inline void SetDynamicRangeCompressionProfile(Ac3DynamicRangeCompressionProfile value) {
    m_dynamicRangeCompressionProfileHasBeenSet = true;
    m_dynamicRangeCompressionProfile = value;
  }
  inline Ac3Settings& WithDynamicRangeCompressionProfile(Ac3DynamicRangeCompressionProfile value) {
    SetDynamicRangeCompressionProfile(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDynamicRangeCompressionRf(Ac3DynamicRangeCompressionRf value) {
    m_dynamicRangeCompressionRfHasBeenSet = true;
    m_dynamicRangeCompressionRf = value;
  }
  inline Ac3Settings& WithDynamicRangeCompressionRf(Ac3DynamicRangeCompressionRf value) {
  ...
  inline void SetLfeFilter(Ac3LfeFilter value) {
    m_lfeFilterHasBeenSet = true;
    m_lfeFilter = value;
  }
  inline Ac3Settings& WithLfeFilter(Ac3LfeFilter value) {
    SetLfeFilter(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMetadataControl(Ac3MetadataControl value) {
    m_metadataControlHasBeenSet = true;
    m_metadataControl = value;
  }
  inline Ac3Settings& WithMetadataControl(Ac3MetadataControl value) {
  ...
  inline Ac3Settings& WithSampleRate(int value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
