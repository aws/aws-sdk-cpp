...
class ProbeSdkResult {
 public:
  ...
  void SetProbeResults(ProbeResultsT&& value) {
    m_probeResultsHasBeenSet = true;
    m_probeResults = std::forward<ProbeResultsT>(value);
  }
  template <typename ProbeResultsT = Aws::Vector<ProbeResult>>
  ProbeSdkResult& WithProbeResults(ProbeResultsT&& value) {
    SetProbeResults(std::forward<ProbeResultsT>(value));
    return *this;
  }
  template <typename ProbeResultsT = ProbeResult>
  ProbeSdkResult& AddProbeResults(ProbeResultsT&& value) {
    m_probeResultsHasBeenSet = true;
    m_probeResults.emplace_back(std::forward<ProbeResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ProbeSdkResult& WithRequestId(RequestIdT&& value) {
