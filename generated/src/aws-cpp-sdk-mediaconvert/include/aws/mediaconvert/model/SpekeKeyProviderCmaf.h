...
class SpekeKeyProviderCmaf {
 public:
  ...
  void SetDashSignaledSystemIds(DashSignaledSystemIdsT&& value) {
    ...
    m_dashSignaledSystemIds = std::forward<DashSignaledSystemIdsT>(value);
  }
  template <typename DashSignaledSystemIdsT = Aws::Vector<Aws::String>>
  SpekeKeyProviderCmaf& WithDashSignaledSystemIds(DashSignaledSystemIdsT&& value) {
    SetDashSignaledSystemIds(std::forward<DashSignaledSystemIdsT>(value));
    return *this;
  }
  ...
  SpekeKeyProviderCmaf& AddDashSignaledSystemIds(DashSignaledSystemIdsT&& value) {
    m_dashSignaledSystemIdsHasBeenSet = true;
    m_dashSignaledSystemIds.emplace_back(std::forward<DashSignaledSystemIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHlsSignaledSystemIds(HlsSignaledSystemIdsT&& value) {
    ...
    m_hlsSignaledSystemIds = std::forward<HlsSignaledSystemIdsT>(value);
  }
  template <typename HlsSignaledSystemIdsT = Aws::Vector<Aws::String>>
  SpekeKeyProviderCmaf& WithHlsSignaledSystemIds(HlsSignaledSystemIdsT&& value) {
    SetHlsSignaledSystemIds(std::forward<HlsSignaledSystemIdsT>(value));
    return *this;
  }
  ...
  SpekeKeyProviderCmaf& AddHlsSignaledSystemIds(HlsSignaledSystemIdsT&& value) {
    m_hlsSignaledSystemIdsHasBeenSet = true;
    m_hlsSignaledSystemIds.emplace_back(std::forward<HlsSignaledSystemIdsT>(value));
    return *this;
  }
  ///@}
