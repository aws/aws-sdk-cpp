...
class InputTamsSettings {
 public:
  ...
  void SetAuthConnectionArn(AuthConnectionArnT&& value) {
    ...
    m_authConnectionArn = std::forward<AuthConnectionArnT>(value);
  }
  template <typename AuthConnectionArnT = Aws::String>
  InputTamsSettings& WithAuthConnectionArn(AuthConnectionArnT&& value) {
    SetAuthConnectionArn(std::forward<AuthConnectionArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetGapHandling(TamsGapHandling value) {
    m_gapHandlingHasBeenSet = true;
    m_gapHandling = value;
  }
  inline InputTamsSettings& WithGapHandling(TamsGapHandling value) {
    SetGapHandling(value);
    return *this;
  }
  ///@}
