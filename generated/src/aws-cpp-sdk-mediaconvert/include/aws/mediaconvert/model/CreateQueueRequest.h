...
class CreateQueueRequest : public MediaConvertRequest {
 public:
  ...
  inline void SetConcurrentJobs(int value) {
    m_concurrentJobsHasBeenSet = true;
    m_concurrentJobs = value;
  }
  inline CreateQueueRequest& WithConcurrentJobs(int value) {
  ...
  inline void SetPricingPlan(PricingPlan value) {
    m_pricingPlanHasBeenSet = true;
    m_pricingPlan = value;
  }
  inline CreateQueueRequest& WithPricingPlan(PricingPlan value) {
  ...
  void SetReservationPlanSettings(ReservationPlanSettingsT&& value) {
    m_reservationPlanSettingsHasBeenSet = true;
    m_reservationPlanSettings = std::forward<ReservationPlanSettingsT>(value);
  }
  template <typename ReservationPlanSettingsT = ReservationPlanSettings>
  CreateQueueRequest& WithReservationPlanSettings(ReservationPlanSettingsT&& value) {
    SetReservationPlanSettings(std::forward<ReservationPlanSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateQueueRequest& WithStatus(QueueStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
