...
class AvailBlanking {
 public:
  ...
  void SetAvailBlankingImage(AvailBlankingImageT&& value) {
    m_availBlankingImageHasBeenSet = true;
    m_availBlankingImage = std::forward<AvailBlankingImageT>(value);
  }
  template <typename AvailBlankingImageT = Aws::String>
  AvailBlanking& WithAvailBlankingImage(AvailBlankingImageT&& value) {
    SetAvailBlankingImage(std::forward<AvailBlankingImageT>(value));
    return *this;
  }
  ///@}
 private:
