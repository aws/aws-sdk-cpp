...
class Mp4Settings {
 public:
  ...
  inline Mp4Settings& WithAudioDuration(CmfcAudioDuration value) {
  ...
  inline void SetC2paManifest(Mp4C2paManifest value) {
    m_c2paManifestHasBeenSet = true;
    m_c2paManifest = value;
  }
  inline Mp4Settings& WithC2paManifest(Mp4C2paManifest value) {
  ...
  inline void SetCslgAtom(Mp4CslgAtom value) {
    m_cslgAtomHasBeenSet = true;
    m_cslgAtom = value;
  }
  inline Mp4Settings& WithCslgAtom(Mp4CslgAtom value) {
    SetCslgAtom(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCttsVersion(int value) {
    m_cttsVersionHasBeenSet = true;
    m_cttsVersion = value;
  }
  inline Mp4Settings& WithCttsVersion(int value) {
    SetCttsVersion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFreeSpaceBox(Mp4FreeSpaceBox value) {
    m_freeSpaceBoxHasBeenSet = true;
    m_freeSpaceBox = value;
  }
  inline Mp4Settings& WithFreeSpaceBox(Mp4FreeSpaceBox value) {
    SetFreeSpaceBox(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMoovPlacement(Mp4MoovPlacement value) {
    m_moovPlacementHasBeenSet = true;
    m_moovPlacement = value;
  }
  inline Mp4Settings& WithMoovPlacement(Mp4MoovPlacement value) {
    SetMoovPlacement(value);
    return *this;
  }
  ///@}
  ...
  void SetMp4MajorBrand(Mp4MajorBrandT&& value) {
    ...
    m_mp4MajorBrand = std::forward<Mp4MajorBrandT>(value);
  }
  template <typename Mp4MajorBrandT = Aws::String>
  Mp4Settings& WithMp4MajorBrand(Mp4MajorBrandT&& value) {
    SetMp4MajorBrand(std::forward<Mp4MajorBrandT>(value));
    return *this;
  }
  ///@}
