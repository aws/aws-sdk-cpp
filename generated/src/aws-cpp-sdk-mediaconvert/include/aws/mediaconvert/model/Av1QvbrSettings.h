...
class Av1QvbrSettings {
 public:
  AWS_MEDIACONVERT_API Av1QvbrSettings() = default;
  ...
  inline Av1QvbrSettings& WithQvbrQualityLevel(int value) {
  ...
  inline Av1QvbrSettings& WithQvbrQualityLevelFineTune(double value) {
