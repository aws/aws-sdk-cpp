...
class Xavc4kProfileSettings {
 public:
  ...
  inline void SetBitrateClass(Xavc4kProfileBitrateClass value) {
    m_bitrateClassHasBeenSet = true;
    m_bitrateClass = value;
  }
  inline Xavc4kProfileSettings& WithBitrateClass(Xavc4kProfileBitrateClass value) {
    SetBitrateClass(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodecProfile(Xavc4kProfileCodecProfile value) {
    m_codecProfileHasBeenSet = true;
    m_codecProfile = value;
  }
  inline Xavc4kProfileSettings& WithCodecProfile(Xavc4kProfileCodecProfile value) {
  ...
  inline void SetFlickerAdaptiveQuantization(XavcFlickerAdaptiveQuantization value) {
    m_flickerAdaptiveQuantizationHasBeenSet = true;
    m_flickerAdaptiveQuantization = value;
  }
  inline Xavc4kProfileSettings& WithFlickerAdaptiveQuantization(XavcFlickerAdaptiveQuantization value) {
    SetFlickerAdaptiveQuantization(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGopBReference(XavcGopBReference value) {
    m_gopBReferenceHasBeenSet = true;
    m_gopBReference = value;
  }
  inline Xavc4kProfileSettings& WithGopBReference(XavcGopBReference value) {
    SetGopBReference(value);
    return *this;
  }
  ///@}
  ...
  inline Xavc4kProfileSettings& WithGopClosedCadence(int value) {
  ...
  inline Xavc4kProfileSettings& WithHrdBufferSize(int value) {
  ...
  inline void SetQualityTuningLevel(Xavc4kProfileQualityTuningLevel value) {
    m_qualityTuningLevelHasBeenSet = true;
    m_qualityTuningLevel = value;
  }
  inline Xavc4kProfileSettings& WithQualityTuningLevel(Xavc4kProfileQualityTuningLevel value) {
  ...
  inline void SetSlices(int value) {
    m_slicesHasBeenSet = true;
    m_slices = value;
  }
  inline Xavc4kProfileSettings& WithSlices(int value) {
    SetSlices(value);
    return *this;
  }
  ///@}
