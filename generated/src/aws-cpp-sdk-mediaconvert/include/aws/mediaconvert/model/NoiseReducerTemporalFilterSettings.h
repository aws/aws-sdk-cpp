...
class NoiseReducerTemporalFilterSettings {
 public:
  ...
  inline void SetAggressiveMode(int value) {
    m_aggressiveModeHasBeenSet = true;
    m_aggressiveMode = value;
  }
  inline NoiseReducerTemporalFilterSettings& WithAggressiveMode(int value) {
    SetAggressiveMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPostTemporalSharpening(NoiseFilterPostTemporalSharpening value) {
    m_postTemporalSharpeningHasBeenSet = true;
    m_postTemporalSharpening = value;
  }
  inline NoiseReducerTemporalFilterSettings& WithPostTemporalSharpening(NoiseFilterPostTemporalSharpening value) {
    SetPostTemporalSharpening(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPostTemporalSharpeningStrength(NoiseFilterPostTemporalSharpeningStrength value) {
    m_postTemporalSharpeningStrengthHasBeenSet = true;
    m_postTemporalSharpeningStrength = value;
  }
  inline NoiseReducerTemporalFilterSettings& WithPostTemporalSharpeningStrength(NoiseFilterPostTemporalSharpeningStrength value) {
    SetPostTemporalSharpeningStrength(value);
    return *this;
  }
  ///@}
  ...
  inline NoiseReducerTemporalFilterSettings& WithSpeed(int value) {
    SetSpeed(value);
    return *this;
  }
  ///@}
  ...
  inline NoiseReducerTemporalFilterSettings& WithStrength(int value) {
    SetStrength(value);
    return *this;
  }
  ///@}
