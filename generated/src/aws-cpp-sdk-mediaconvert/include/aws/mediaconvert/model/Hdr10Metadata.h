...
class Hdr10Metadata {
 public:
  ...
  inline Hdr10Metadata& WithBluePrimaryX(int value) {
  ...
  inline Hdr10Metadata& WithBluePrimaryY(int value) {
  ...
  inline Hdr10Metadata& WithGreenPrimaryX(int value) {
  ...
  inline Hdr10Metadata& WithGreenPrimaryY(int value) {
  ...
  inline Hdr10Metadata& WithMaxContentLightLevel(int value) {
  ...
  inline Hdr10Metadata& WithMaxFrameAverageLightLevel(int value) {
  ...
  inline Hdr10Metadata& WithMaxLuminance(int value) {
  ...
  inline void SetMinLuminance(int value) {
    m_minLuminanceHasBeenSet = true;
    m_minLuminance = value;
  }
  inline Hdr10Metadata& WithMinLuminance(int value) {
  ...
  inline Hdr10Metadata& WithRedPrimaryX(int value) {
  ...
  inline Hdr10Metadata& WithRedPrimaryY(int value) {
  ...
  inline Hdr10Metadata& WithWhitePointX(int value) {
  ...
  inline Hdr10Metadata& WithWhitePointY(int value) {
