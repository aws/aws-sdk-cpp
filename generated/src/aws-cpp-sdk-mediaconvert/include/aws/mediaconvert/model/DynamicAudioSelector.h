...
class DynamicAudioSelector {
 public:
  ...
  inline DynamicAudioSelector& WithAudioDurationCorrection(AudioDurationCorrection value) {
  ...
  inline DynamicAudioSelector& WithLanguageCode(LanguageCode value) {
...
To specify an offset:
  ...
  inline DynamicAudioSelector& WithOffset(int value) {
    SetOffset(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSelectorType(DynamicAudioSelectorType value) {
    m_selectorTypeHasBeenSet = true;
    m_selectorType = value;
  }
  inline DynamicAudioSelector& WithSelectorType(DynamicAudioSelectorType value) {
