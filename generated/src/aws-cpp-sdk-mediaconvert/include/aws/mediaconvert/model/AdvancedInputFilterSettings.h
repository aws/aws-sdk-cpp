...
class AdvancedInputFilterSettings {
 public:
  ...
  inline void SetAddTexture(AdvancedInputFilterAddTexture value) {
    m_addTextureHasBeenSet = true;
    m_addTexture = value;
  }
  inline AdvancedInputFilterSettings& WithAddTexture(AdvancedInputFilterAddTexture value) {
    SetAddTexture(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSharpening(AdvancedInputFilterSharpen value) {
    m_sharpeningHasBeenSet = true;
    m_sharpening = value;
  }
  inline AdvancedInputFilterSettings& WithSharpening(AdvancedInputFilterSharpen value) {
    SetSharpening(value);
    return *this;
  }
  ///@}
