 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mediaconvert-2017-08-29/CmafImageBasedTrickPlayVariant">AWS
 * API Reference</a></p>
 */
class CmafImageBasedTrickPlayVariant {
 public:
  AWS_MEDIACONVERT_API CmafImageBasedTrickPlayVariant() = default;
  AWS_MEDIACONVERT_API CmafImageBasedTrickPlayVariant(Aws::Utils::Json::JsonView jsonValue);
  AWS_MEDIACONVERT_API CmafImageBasedTrickPlayVariant& operator=(Aws::Utils::Json::JsonView jsonValue);
   ...
   * 1x1 tiling.
   */
  inline CmafIntervalCadence GetIntervalCadence() const { return m_intervalCadence; }
  inline bool IntervalCadenceHasBeenSet() const { return m_intervalCadenceHasBeenSet; }
  inline void SetIntervalCadence(CmafIntervalCadence value) {
    m_intervalCadenceHasBeenSet = true;
    m_intervalCadence = value;
  }
  inline CmafImageBasedTrickPlayVariant& WithIntervalCadence(CmafIntervalCadence value) {
  ...
  inline CmafImageBasedTrickPlayVariant& WithThumbnailHeight(int value) {
  ...
  inline CmafImageBasedTrickPlayVariant& WithThumbnailInterval(double value) {
  ...
  inline CmafImageBasedTrickPlayVariant& WithThumbnailWidth(int value) {
  ...
  inline CmafImageBasedTrickPlayVariant& WithTileHeight(int value) {
    SetTileHeight(value);
    return *this;
  }
  ///@}
  ...
  inline CmafImageBasedTrickPlayVariant& WithTileWidth(int value) {
    SetTileWidth(value);
    return *this;
  }
  ///@}
 private:
  CmafIntervalCadence m_intervalCadence{CmafIntervalCadence::NOT_SET};
