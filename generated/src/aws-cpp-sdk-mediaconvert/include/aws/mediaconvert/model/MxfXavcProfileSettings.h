...
class MxfXavcProfileSettings {
 public:
  ...
  inline void SetDurationMode(MxfXavcDurationMode value) {
    m_durationModeHasBeenSet = true;
    m_durationMode = value;
  }
  inline MxfXavcProfileSettings& WithDurationMode(MxfXavcDurationMode value) {
  ...
  inline void SetMaxAncDataSize(int value) {
    m_maxAncDataSizeHasBeenSet = true;
    m_maxAncDataSize = value;
  }
  inline MxfXavcProfileSettings& WithMaxAncDataSize(int value) {
    SetMaxAncDataSize(value);
    return *this;
  }
  ///@}
 private:
