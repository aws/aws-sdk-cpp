...
class StaticKeyProvider {
 public:
  ...
  void SetKeyFormat(KeyFormatT&& value) {
    m_keyFormatHasBeenSet = true;
    m_keyFormat = std::forward<KeyFormatT>(value);
  }
  template <typename KeyFormatT = Aws::String>
  StaticKeyProvider& WithKeyFormat(KeyFormatT&& value) {
    SetKeyFormat(std::forward<KeyFormatT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKeyFormatVersions(KeyFormatVersionsT&& value) {
    ...
    m_keyFormatVersions = std::forward<KeyFormatVersionsT>(value);
  }
  template <typename KeyFormatVersionsT = Aws::String>
  StaticKeyProvider& WithKeyFormatVersions(KeyFormatVersionsT&& value) {
    SetKeyFormatVersions(std::forward<KeyFormatVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStaticKeyValue(StaticKeyValueT&& value) {
    ...
    m_staticKeyValue = std::forward<StaticKeyValueT>(value);
  }
  template <typename StaticKeyValueT = Aws::String>
  StaticKeyProvider& WithStaticKeyValue(StaticKeyValueT&& value) {
    SetStaticKeyValue(std::forward<StaticKeyValueT>(value));
    return *this;
  }
  ///@}
