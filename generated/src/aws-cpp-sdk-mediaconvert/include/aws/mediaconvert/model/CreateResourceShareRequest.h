...
class CreateResourceShareRequest : public MediaConvertRequest {
 public:
  ...
  void SetSupportCaseId(SupportCaseIdT&& value) {
    m_supportCaseIdHasBeenSet = true;
    m_supportCaseId = std::forward<SupportCaseIdT>(value);
  }
  template <typename SupportCaseIdT = Aws::String>
  CreateResourceShareRequest& WithSupportCaseId(SupportCaseIdT&& value) {
    SetSupportCaseId(std::forward<SupportCaseIdT>(value));
    return *this;
  }
  ///@}
 private:
