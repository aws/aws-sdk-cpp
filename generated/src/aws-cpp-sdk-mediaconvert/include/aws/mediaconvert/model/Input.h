...
class Input {
 public:
  ...
  inline void SetAdvancedInputFilter(AdvancedInputFilter value) {
    m_advancedInputFilterHasBeenSet = true;
    m_advancedInputFilter = value;
  }
  inline Input& WithAdvancedInputFilter(AdvancedInputFilter value) {
    SetAdvancedInputFilter(value);
    return *this;
  }
  ///@}
  ...
  void SetAdvancedInputFilterSettings(AdvancedInputFilterSettingsT&& value) {
    ...
    m_advancedInputFilterSettings = std::forward<AdvancedInputFilterSettingsT>(value);
  }
  template <typename AdvancedInputFilterSettingsT = AdvancedInputFilterSettings>
  Input& WithAdvancedInputFilterSettings(AdvancedInputFilterSettingsT&& value) {
    SetAdvancedInputFilterSettings(std::forward<AdvancedInputFilterSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAudioSelectorGroups(AudioSelectorGroupsT&& value) {
    ...
    m_audioSelectorGroups = std::forward<AudioSelectorGroupsT>(value);
  }
  template <typename AudioSelectorGroupsT = Aws::Map<Aws::String, AudioSelectorGroup>>
  Input& WithAudioSelectorGroups(AudioSelectorGroupsT&& value) {
    SetAudioSelectorGroups(std::forward<AudioSelectorGroupsT>(value));
    return *this;
  }
  ...
  Input& AddAudioSelectorGroups(AudioSelectorGroupsKeyT&& key, AudioSelectorGroupsValueT&& value) {
    m_audioSelectorGroupsHasBeenSet = true;
    m_audioSelectorGroups.emplace(std::forward<AudioSelectorGroupsKeyT>(key), std::forward<AudioSelectorGroupsValueT>(value));
    return *this;
  }
  ///@}
  ...
  Input& AddCaptionSelectors(CaptionSelectorsKeyT&& key, CaptionSelectorsValueT&& value) {
    m_captionSelectorsHasBeenSet = true;
    m_captionSelectors.emplace(std::forward<CaptionSelectorsKeyT>(key), std::forward<CaptionSelectorsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCrop(CropT&& value) {
    ...
    m_crop = std::forward<CropT>(value);
  }
  template <typename CropT = Rectangle>
  Input& WithCrop(CropT&& value) {
    SetCrop(std::forward<CropT>(value));
    return *this;
  }
  ///@}
  ...
  inline Input& WithDeblockFilter(InputDeblockFilter value) {
  ...
  void SetDecryptionSettings(DecryptionSettingsT&& value) {
    ...
    m_decryptionSettings = std::forward<DecryptionSettingsT>(value);
  }
  template <typename DecryptionSettingsT = InputDecryptionSettings>
  Input& WithDecryptionSettings(DecryptionSettingsT&& value) {
    SetDecryptionSettings(std::forward<DecryptionSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Input& WithDenoiseFilter(InputDenoiseFilter value) {
  ...
  void SetDolbyVisionMetadataXml(DolbyVisionMetadataXmlT&& value) {
    ...
    m_dolbyVisionMetadataXml = std::forward<DolbyVisionMetadataXmlT>(value);
  }
  template <typename DolbyVisionMetadataXmlT = Aws::String>
  Input& WithDolbyVisionMetadataXml(DolbyVisionMetadataXmlT&& value) {
    SetDolbyVisionMetadataXml(std::forward<DolbyVisionMetadataXmlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamicAudioSelectors(DynamicAudioSelectorsT&& value) {
    ...
    m_dynamicAudioSelectors = std::forward<DynamicAudioSelectorsT>(value);
  }
  template <typename DynamicAudioSelectorsT = Aws::Map<Aws::String, DynamicAudioSelector>>
  Input& WithDynamicAudioSelectors(DynamicAudioSelectorsT&& value) {
    SetDynamicAudioSelectors(std::forward<DynamicAudioSelectorsT>(value));
    return *this;
  }
  ...
  Input& AddDynamicAudioSelectors(DynamicAudioSelectorsKeyT&& key, DynamicAudioSelectorsValueT&& value) {
    m_dynamicAudioSelectorsHasBeenSet = true;
    m_dynamicAudioSelectors.emplace(std::forward<DynamicAudioSelectorsKeyT>(key), std::forward<DynamicAudioSelectorsValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFilterEnable(InputFilterEnable value) {
    m_filterEnableHasBeenSet = true;
    m_filterEnable = value;
  }
  inline Input& WithFilterEnable(InputFilterEnable value) {
    SetFilterEnable(value);
    return *this;
  }
  ///@}
  ...
  inline Input& WithFilterStrength(int value) {
  ...
  void SetImageInserter(ImageInserterT&& value) {
    ...
    m_imageInserter = std::forward<ImageInserterT>(value);
  }
  template <typename ImageInserterT = ImageInserter>
  Input& WithImageInserter(ImageInserterT&& value) {
    SetImageInserter(std::forward<ImageInserterT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInputScanType(InputScanType value) {
    m_inputScanTypeHasBeenSet = true;
    m_inputScanType = value;
  }
  inline Input& WithInputScanType(InputScanType value) {
    SetInputScanType(value);
    return *this;
  }
  ///@}
  ...
  inline Input& WithProgramNumber(int value) {
  ...
  inline void SetPsiControl(InputPsiControl value) {
    m_psiControlHasBeenSet = true;
    m_psiControl = value;
  }
  inline Input& WithPsiControl(InputPsiControl value) {
    SetPsiControl(value);
    return *this;
  }
  ///@}
  ...
  void SetSupplementalImps(SupplementalImpsT&& value) {
    ...
    m_supplementalImps = std::forward<SupplementalImpsT>(value);
  }
  template <typename SupplementalImpsT = Aws::Vector<Aws::String>>
  Input& WithSupplementalImps(SupplementalImpsT&& value) {
    SetSupplementalImps(std::forward<SupplementalImpsT>(value));
    return *this;
  }
  template <typename SupplementalImpsT = Aws::String>
  Input& AddSupplementalImps(SupplementalImpsT&& value) {
    m_supplementalImpsHasBeenSet = true;
    m_supplementalImps.emplace_back(std::forward<SupplementalImpsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTamsSettings(TamsSettingsT&& value) {
    ...
    m_tamsSettings = std::forward<TamsSettingsT>(value);
  }
  template <typename TamsSettingsT = InputTamsSettings>
  Input& WithTamsSettings(TamsSettingsT&& value) {
    SetTamsSettings(std::forward<TamsSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Input& WithTimecodeSource(InputTimecodeSource value) {
  ...
  void SetVideoGenerator(VideoGeneratorT&& value) {
    ...
    m_videoGenerator = std::forward<VideoGeneratorT>(value);
  }
  template <typename VideoGeneratorT = InputVideoGenerator>
  Input& WithVideoGenerator(VideoGeneratorT&& value) {
    SetVideoGenerator(std::forward<VideoGeneratorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVideoOverlays(VideoOverlaysT&& value) {
    ...
    m_videoOverlays = std::forward<VideoOverlaysT>(value);
  }
  template <typename VideoOverlaysT = Aws::Vector<VideoOverlay>>
  Input& WithVideoOverlays(VideoOverlaysT&& value) {
    SetVideoOverlays(std::forward<VideoOverlaysT>(value));
    return *this;
  }
  template <typename VideoOverlaysT = VideoOverlay>
  Input& AddVideoOverlays(VideoOverlaysT&& value) {
    m_videoOverlaysHasBeenSet = true;
    m_videoOverlays.emplace_back(std::forward<VideoOverlaysT>(value));
    return *this;
  }
  ///@}
