...
class H265QvbrSettings {
 public:
  AWS_MEDIACONVERT_API H265QvbrSettings() = default;
  AWS_MEDIACONVERT_API H265QvbrSettings(Aws::Utils::Json::JsonView jsonValue);
  AWS_MEDIACONVERT_API H265QvbrSettings& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline void SetMaxAverageBitrate(int value) {
    m_maxAverageBitrateHasBeenSet = true;
    m_maxAverageBitrate = value;
  }
  inline H265QvbrSettings& WithMaxAverageBitrate(int value) {
    SetMaxAverageBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline H265QvbrSettings& WithQvbrQualityLevel(int value) {
  ...
  inline void SetQvbrQualityLevelFineTune(double value) {
    m_qvbrQualityLevelFineTuneHasBeenSet = true;
    m_qvbrQualityLevelFineTune = value;
  }
  inline H265QvbrSettings& WithQvbrQualityLevelFineTune(double value) {
    SetQvbrQualityLevelFineTune(value);
    return *this;
  }
  ///@}
 private:
