...
class CmafEncryptionSettings {
 public:
  ...
  inline void SetEncryptionMethod(CmafEncryptionType value) {
    m_encryptionMethodHasBeenSet = true;
    m_encryptionMethod = value;
  }
  inline CmafEncryptionSettings& WithEncryptionMethod(CmafEncryptionType value) {
  ...
  inline void SetInitializationVectorInManifest(CmafInitializationVectorInManifest value) {
    m_initializationVectorInManifestHasBeenSet = true;
    m_initializationVectorInManifest = value;
  }
  inline CmafEncryptionSettings& WithInitializationVectorInManifest(CmafInitializationVectorInManifest value) {
    SetInitializationVectorInManifest(value);
    return *this;
  }
  ///@}
  ...
  void SetStaticKeyProvider(StaticKeyProviderT&& value) {
    ...
    m_staticKeyProvider = std::forward<StaticKeyProviderT>(value);
  }
  template <typename StaticKeyProviderT = StaticKeyProvider>
  CmafEncryptionSettings& WithStaticKeyProvider(StaticKeyProviderT&& value) {
    SetStaticKeyProvider(std::forward<StaticKeyProviderT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(CmafKeyProviderType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CmafEncryptionSettings& WithType(CmafKeyProviderType value) {
    SetType(value);
    return *this;
  }
  ///@}
