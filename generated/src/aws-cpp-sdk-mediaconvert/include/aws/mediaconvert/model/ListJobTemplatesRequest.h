...
class ListJobTemplatesRequest : public MediaConvertRequest {
 public:
  ...
  inline void SetListBy(JobTemplateListBy value) {
    m_listByHasBeenSet = true;
    m_listBy = value;
  }
  inline ListJobTemplatesRequest& WithListBy(JobTemplateListBy value) {
    SetListBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListJobTemplatesRequest& WithOrder(Order value) {
    SetOrder(value);
    return *this;
  }
  ///@}
