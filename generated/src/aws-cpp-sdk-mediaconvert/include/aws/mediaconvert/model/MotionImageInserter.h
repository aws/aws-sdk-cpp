...
class MotionImageInserter {
 public:
  ...
  inline void SetInsertionMode(MotionImageInsertionMode value) {
    m_insertionModeHasBeenSet = true;
    m_insertionMode = value;
  }
  inline MotionImageInserter& WithInsertionMode(MotionImageInsertionMode value) {
  ...
  inline void SetPlayback(MotionImagePlayback value) {
    m_playbackHasBeenSet = true;
    m_playback = value;
  }
  inline MotionImageInserter& WithPlayback(MotionImagePlayback value) {
    SetPlayback(value);
    return *this;
  }
  ///@}
