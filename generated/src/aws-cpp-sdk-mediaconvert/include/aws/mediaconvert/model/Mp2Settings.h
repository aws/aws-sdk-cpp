...
class Mp2Settings {
 public:
  ...
  inline void SetAudioDescriptionMix(Mp2AudioDescriptionMix value) {
    m_audioDescriptionMixHasBeenSet = true;
    m_audioDescriptionMix = value;
  }
  inline Mp2Settings& WithAudioDescriptionMix(Mp2AudioDescriptionMix value) {
    SetAudioDescriptionMix(value);
    return *this;
  }
  ///@}
  ...
  inline Mp2Settings& WithBitrate(int value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline Mp2Settings& WithChannels(int value) {
    SetChannels(value);
    return *this;
  }
  ///@}
  ...
  inline Mp2Settings& WithSampleRate(int value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
