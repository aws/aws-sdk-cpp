...
class H265Settings {
 public:
  ...
  inline void SetAdaptiveQuantization(H265AdaptiveQuantization value) {
    m_adaptiveQuantizationHasBeenSet = true;
    m_adaptiveQuantization = value;
  }
  inline H265Settings& WithAdaptiveQuantization(H265AdaptiveQuantization value) {
  ...
  inline void SetAlternateTransferFunctionSei(H265AlternateTransferFunctionSei value) {
    m_alternateTransferFunctionSeiHasBeenSet = true;
    m_alternateTransferFunctionSei = value;
  }
  inline H265Settings& WithAlternateTransferFunctionSei(H265AlternateTransferFunctionSei value) {
    SetAlternateTransferFunctionSei(value);
    return *this;
  }
  ///@}
  ...
  void SetBandwidthReductionFilter(BandwidthReductionFilterT&& value) {
    ...
    m_bandwidthReductionFilter = std::forward<BandwidthReductionFilterT>(value);
  }
  template <typename BandwidthReductionFilterT = BandwidthReductionFilter>
  H265Settings& WithBandwidthReductionFilter(BandwidthReductionFilterT&& value) {
    SetBandwidthReductionFilter(std::forward<BandwidthReductionFilterT>(value));
    return *this;
  }
  ///@}
  ...
  inline H265Settings& WithBitrate(int value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodecLevel(H265CodecLevel value) {
    m_codecLevelHasBeenSet = true;
    m_codecLevel = value;
  }
  inline H265Settings& WithCodecLevel(H265CodecLevel value) {
    SetCodecLevel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodecProfile(H265CodecProfile value) {
    m_codecProfileHasBeenSet = true;
    m_codecProfile = value;
  }
  inline H265Settings& WithCodecProfile(H265CodecProfile value) {
  ...
  inline void SetDeblocking(H265Deblocking value) {
    m_deblockingHasBeenSet = true;
    m_deblocking = value;
  }
  inline H265Settings& WithDeblocking(H265Deblocking value) {
    SetDeblocking(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDynamicSubGop(H265DynamicSubGop value) {
    m_dynamicSubGopHasBeenSet = true;
    m_dynamicSubGop = value;
  }
  inline H265Settings& WithDynamicSubGop(H265DynamicSubGop value) {
  ...
  inline void SetEndOfStreamMarkers(H265EndOfStreamMarkers value) {
    m_endOfStreamMarkersHasBeenSet = true;
    m_endOfStreamMarkers = value;
  }
  inline H265Settings& WithEndOfStreamMarkers(H265EndOfStreamMarkers value) {
    SetEndOfStreamMarkers(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFlickerAdaptiveQuantization(H265FlickerAdaptiveQuantization value) {
    m_flickerAdaptiveQuantizationHasBeenSet = true;
    m_flickerAdaptiveQuantization = value;
  }
  inline H265Settings& WithFlickerAdaptiveQuantization(H265FlickerAdaptiveQuantization value) {
  ...
  inline void SetFramerateControl(H265FramerateControl value) {
    m_framerateControlHasBeenSet = true;
    m_framerateControl = value;
  }
  inline H265Settings& WithFramerateControl(H265FramerateControl value) {
  ...
  inline void SetFramerateConversionAlgorithm(H265FramerateConversionAlgorithm value) {
    m_framerateConversionAlgorithmHasBeenSet = true;
    m_framerateConversionAlgorithm = value;
  }
  inline H265Settings& WithFramerateConversionAlgorithm(H265FramerateConversionAlgorithm value) {
  ...
  inline H265Settings& WithFramerateDenominator(int value) {
  ...
  inline H265Settings& WithFramerateNumerator(int value) {
  ...
  inline void SetGopBReference(H265GopBReference value) {
    m_gopBReferenceHasBeenSet = true;
    m_gopBReference = value;
  }
  inline H265Settings& WithGopBReference(H265GopBReference value) {
  ...
  inline H265Settings& WithGopClosedCadence(int value) {
  ...
  inline H265Settings& WithGopSize(double value) {
    SetGopSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGopSizeUnits(H265GopSizeUnits value) {
    m_gopSizeUnitsHasBeenSet = true;
    m_gopSizeUnits = value;
  }
  inline H265Settings& WithGopSizeUnits(H265GopSizeUnits value) {
  ...
  inline H265Settings& WithHrdBufferFinalFillPercentage(int value) {
  ...
  inline H265Settings& WithHrdBufferInitialFillPercentage(int value) {
  ...
  inline H265Settings& WithHrdBufferSize(int value) {
  ...
  inline void SetInterlaceMode(H265InterlaceMode value) {
    m_interlaceModeHasBeenSet = true;
    m_interlaceMode = value;
  }
  inline H265Settings& WithInterlaceMode(H265InterlaceMode value) {
  ...
  inline H265Settings& WithMaxBitrate(int value) {
    SetMaxBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline H265Settings& WithMinIInterval(int value) {
  ...
  inline H265Settings& WithNumberBFramesBetweenReferenceFrames(int value) {
  ...
  inline void SetNumberReferenceFrames(int value) {
    m_numberReferenceFramesHasBeenSet = true;
    m_numberReferenceFrames = value;
  }
  inline H265Settings& WithNumberReferenceFrames(int value) {
    SetNumberReferenceFrames(value);
    return *this;
  }
  ///@}
  ...
  inline void SetParControl(H265ParControl value) {
    m_parControlHasBeenSet = true;
    m_parControl = value;
  }
  inline H265Settings& WithParControl(H265ParControl value) {
    SetParControl(value);
    return *this;
  }
  ///@}
  ...
  inline H265Settings& WithParDenominator(int value) {
  ...
  inline H265Settings& WithParNumerator(int value) {
  ...
  inline H265Settings& AddPerFrameMetrics(FrameMetricType value) {
    m_perFrameMetricsHasBeenSet = true;
  ...
  inline void SetQualityTuningLevel(H265QualityTuningLevel value) {
    m_qualityTuningLevelHasBeenSet = true;
    m_qualityTuningLevel = value;
  }
  inline H265Settings& WithQualityTuningLevel(H265QualityTuningLevel value) {
  ...
  inline void SetRateControlMode(H265RateControlMode value) {
    m_rateControlModeHasBeenSet = true;
    m_rateControlMode = value;
  }
  inline H265Settings& WithRateControlMode(H265RateControlMode value) {
  ...
  inline void SetSampleAdaptiveOffsetFilterMode(H265SampleAdaptiveOffsetFilterMode value) {
    m_sampleAdaptiveOffsetFilterModeHasBeenSet = true;
    m_sampleAdaptiveOffsetFilterMode = value;
  }
  inline H265Settings& WithSampleAdaptiveOffsetFilterMode(H265SampleAdaptiveOffsetFilterMode value) {
    SetSampleAdaptiveOffsetFilterMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScanTypeConversionMode(H265ScanTypeConversionMode value) {
    m_scanTypeConversionModeHasBeenSet = true;
    m_scanTypeConversionMode = value;
  }
  inline H265Settings& WithScanTypeConversionMode(H265ScanTypeConversionMode value) {
  ...
  inline void SetSceneChangeDetect(H265SceneChangeDetect value) {
    m_sceneChangeDetectHasBeenSet = true;
    m_sceneChangeDetect = value;
  }
  inline H265Settings& WithSceneChangeDetect(H265SceneChangeDetect value) {
  ...
  inline H265Settings& WithSlices(int value) {
    SetSlices(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSlowPal(H265SlowPal value) {
    m_slowPalHasBeenSet = true;
    m_slowPal = value;
  }
  inline H265Settings& WithSlowPal(H265SlowPal value) {
    SetSlowPal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpatialAdaptiveQuantization(H265SpatialAdaptiveQuantization value) {
    m_spatialAdaptiveQuantizationHasBeenSet = true;
    m_spatialAdaptiveQuantization = value;
  }
  inline H265Settings& WithSpatialAdaptiveQuantization(H265SpatialAdaptiveQuantization value) {
  ...
  inline void SetTelecine(H265Telecine value) {
    m_telecineHasBeenSet = true;
    m_telecine = value;
  }
  inline H265Settings& WithTelecine(H265Telecine value) {
    SetTelecine(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTemporalAdaptiveQuantization(H265TemporalAdaptiveQuantization value) {
    m_temporalAdaptiveQuantizationHasBeenSet = true;
    m_temporalAdaptiveQuantization = value;
  }
  inline H265Settings& WithTemporalAdaptiveQuantization(H265TemporalAdaptiveQuantization value) {
  ...
  inline void SetTemporalIds(H265TemporalIds value) {
    m_temporalIdsHasBeenSet = true;
    m_temporalIds = value;
  }
  inline H265Settings& WithTemporalIds(H265TemporalIds value) {
    SetTemporalIds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTiles(H265Tiles value) {
  ...
  inline void SetUnregisteredSeiTimecode(H265UnregisteredSeiTimecode value) {
    m_unregisteredSeiTimecodeHasBeenSet = true;
    m_unregisteredSeiTimecode = value;
  }
  inline H265Settings& WithUnregisteredSeiTimecode(H265UnregisteredSeiTimecode value) {
    SetUnregisteredSeiTimecode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWriteMp4PackagingType(H265WriteMp4PackagingType value) {
    m_writeMp4PackagingTypeHasBeenSet = true;
    m_writeMp4PackagingType = value;
  }
  inline H265Settings& WithWriteMp4PackagingType(H265WriteMp4PackagingType value) {
    SetWriteMp4PackagingType(value);
    return *this;
  }
  ///@}
 private:
