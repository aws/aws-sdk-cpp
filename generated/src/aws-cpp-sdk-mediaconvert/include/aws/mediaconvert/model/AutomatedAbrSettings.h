...
class AutomatedAbrSettings {
 public:
  ...
  inline void SetMaxAbrBitrate(int value) {
    m_maxAbrBitrateHasBeenSet = true;
    m_maxAbrBitrate = value;
  }
  inline AutomatedAbrSettings& WithMaxAbrBitrate(int value) {
    SetMaxAbrBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxQualityLevel(double value) {
    m_maxQualityLevelHasBeenSet = true;
    m_maxQualityLevel = value;
  }
  inline AutomatedAbrSettings& WithMaxQualityLevel(double value) {
    SetMaxQualityLevel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxRenditions(int value) {
    m_maxRenditionsHasBeenSet = true;
    m_maxRenditions = value;
  }
  inline AutomatedAbrSettings& WithMaxRenditions(int value) {
    SetMaxRenditions(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinAbrBitrate(int value) {
    m_minAbrBitrateHasBeenSet = true;
    m_minAbrBitrate = value;
  }
  inline AutomatedAbrSettings& WithMinAbrBitrate(int value) {
    SetMinAbrBitrate(value);
    return *this;
  }
  ///@}
