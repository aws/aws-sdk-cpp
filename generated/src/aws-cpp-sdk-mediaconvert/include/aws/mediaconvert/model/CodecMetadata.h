...
namespace Model
{
  ...
  public:
    ...
    inline CodecMetadata& WithBitDepth(int value) { SetBitDepth(value); return *this;}
    ///@}
    ...
    void SetChromaSubsampling(ChromaSubsamplingT&& value) { m_chromaSubsamplingHasBeenSet = true; m_chromaSubsampling = std::forward<ChromaSubsamplingT>(value); }
    template<typename ChromaSubsamplingT = Aws::String>
    CodecMetadata& WithChromaSubsampling(ChromaSubsamplingT&& value) { SetChromaSubsampling(std::forward<ChromaSubsamplingT>(value)); return *this;}
    ///@}
    ...
    void SetCodedFrameRate(CodedFrameRateT&& value) { m_codedFrameRateHasBeenSet = true; m_codedFrameRate = std::forward<CodedFrameRateT>(value); }
    template<typename CodedFrameRateT = FrameRate>
    CodecMetadata& WithCodedFrameRate(CodedFrameRateT&& value) { SetCodedFrameRate(std::forward<CodedFrameRateT>(value)); return *this;}
    ///@}
    ...
    inline CodecMetadata& WithColorPrimaries(ColorPrimaries value) { SetColorPrimaries(value); return *this;}
    ///@}
    ...
    inline CodecMetadata& WithHeight(int value) { SetHeight(value); return *this;}
    ///@}
    ...
    template<typename LevelT = Aws::String>
    CodecMetadata& WithLevel(LevelT&& value) { SetLevel(std::forward<LevelT>(value)); return *this;}
    ///@}
    ...
    inline CodecMetadata& WithMatrixCoefficients(MatrixCoefficients value) { SetMatrixCoefficients(value); return *this;}
    ///@}
    ...
    template<typename ProfileT = Aws::String>
    CodecMetadata& WithProfile(ProfileT&& value) { SetProfile(std::forward<ProfileT>(value)); return *this;}
    ///@}
    ...
    template<typename ScanTypeT = Aws::String>
    CodecMetadata& WithScanType(ScanTypeT&& value) { SetScanType(std::forward<ScanTypeT>(value)); return *this;}
    ///@}
    ...
    inline CodecMetadata& WithTransferCharacteristics(TransferCharacteristics value) { SetTransferCharacteristics(value); return *this;}
    ///@}
    ...
    inline CodecMetadata& WithWidth(int value) { SetWidth(value); return *this;}
    ///@}
  private:
