...
class VideoPreprocessor {
 public:
  ...
  void SetColorCorrector(ColorCorrectorT&& value) {
    ...
    m_colorCorrector = std::forward<ColorCorrectorT>(value);
  }
  template <typename ColorCorrectorT = ColorCorrector>
  VideoPreprocessor& WithColorCorrector(ColorCorrectorT&& value) {
    SetColorCorrector(std::forward<ColorCorrectorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeinterlacer(DeinterlacerT&& value) {
    m_deinterlacerHasBeenSet = true;
    m_deinterlacer = std::forward<DeinterlacerT>(value);
  }
  template <typename DeinterlacerT = Deinterlacer>
  VideoPreprocessor& WithDeinterlacer(DeinterlacerT&& value) {
    SetDeinterlacer(std::forward<DeinterlacerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHdr10Plus(Hdr10PlusT&& value) {
    m_hdr10PlusHasBeenSet = true;
    m_hdr10Plus = std::forward<Hdr10PlusT>(value);
  }
  template <typename Hdr10PlusT = Hdr10Plus>
  VideoPreprocessor& WithHdr10Plus(Hdr10PlusT&& value) {
    SetHdr10Plus(std::forward<Hdr10PlusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNoiseReducer(NoiseReducerT&& value) {
    m_noiseReducerHasBeenSet = true;
    m_noiseReducer = std::forward<NoiseReducerT>(value);
  }
  template <typename NoiseReducerT = NoiseReducer>
  VideoPreprocessor& WithNoiseReducer(NoiseReducerT&& value) {
    SetNoiseReducer(std::forward<NoiseReducerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPartnerWatermarking(PartnerWatermarkingT&& value) {
    ...
    m_partnerWatermarking = std::forward<PartnerWatermarkingT>(value);
  }
  template <typename PartnerWatermarkingT = PartnerWatermarking>
  VideoPreprocessor& WithPartnerWatermarking(PartnerWatermarkingT&& value) {
    SetPartnerWatermarking(std::forward<PartnerWatermarkingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimecodeBurnin(TimecodeBurninT&& value) {
    ...
    m_timecodeBurnin = std::forward<TimecodeBurninT>(value);
  }
  template <typename TimecodeBurninT = TimecodeBurnin>
  VideoPreprocessor& WithTimecodeBurnin(TimecodeBurninT&& value) {
    SetTimecodeBurnin(std::forward<TimecodeBurninT>(value));
    return *this;
  }
  ///@}
 private:
