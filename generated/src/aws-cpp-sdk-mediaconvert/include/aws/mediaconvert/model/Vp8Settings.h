...
class Vp8Settings {
 public:
  ...
  inline Vp8Settings& WithBitrate(int value) {
    SetBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFramerateControl(Vp8FramerateControl value) {
    m_framerateControlHasBeenSet = true;
    m_framerateControl = value;
  }
  inline Vp8Settings& WithFramerateControl(Vp8FramerateControl value) {
  ...
  inline void SetFramerateConversionAlgorithm(Vp8FramerateConversionAlgorithm value) {
    m_framerateConversionAlgorithmHasBeenSet = true;
    m_framerateConversionAlgorithm = value;
  }
  inline Vp8Settings& WithFramerateConversionAlgorithm(Vp8FramerateConversionAlgorithm value) {
  ...
  inline Vp8Settings& WithFramerateDenominator(int value) {
  ...
  inline Vp8Settings& WithFramerateNumerator(int value) {
  ...
  inline Vp8Settings& WithGopSize(double value) {
    SetGopSize(value);
    return *this;
  }
  ///@}
  ...
  inline Vp8Settings& WithHrdBufferSize(int value) {
  ...
  inline Vp8Settings& WithMaxBitrate(int value) {
    SetMaxBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetParControl(Vp8ParControl value) {
    m_parControlHasBeenSet = true;
    m_parControl = value;
  }
  inline Vp8Settings& WithParControl(Vp8ParControl value) {
    SetParControl(value);
    return *this;
  }
  ///@}
  ...
  inline Vp8Settings& WithParDenominator(int value) {
  ...
  inline Vp8Settings& WithParNumerator(int value) {
  ...
  inline void SetQualityTuningLevel(Vp8QualityTuningLevel value) {
    m_qualityTuningLevelHasBeenSet = true;
    m_qualityTuningLevel = value;
  }
  inline Vp8Settings& WithQualityTuningLevel(Vp8QualityTuningLevel value) {
  ...
  inline void SetRateControlMode(Vp8RateControlMode value) {
    m_rateControlModeHasBeenSet = true;
    m_rateControlMode = value;
  }
  inline Vp8Settings& WithRateControlMode(Vp8RateControlMode value) {
