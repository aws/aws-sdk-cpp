...
class ReservationPlan {
 public:
  ...
  inline ReservationPlan& WithCommitment(Commitment value) {
    SetCommitment(value);
    return *this;
  }
  ///@}
  ...
  void SetPurchasedAt(PurchasedAtT&& value) {
    ...
    m_purchasedAt = std::forward<PurchasedAtT>(value);
  }
  template <typename PurchasedAtT = Aws::Utils::DateTime>
  ReservationPlan& WithPurchasedAt(PurchasedAtT&& value) {
    SetPurchasedAt(std::forward<PurchasedAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReservationPlan& WithRenewalType(RenewalType value) {
  ...
  inline ReservationPlan& WithReservedSlots(int value) {
  ...
  inline void SetStatus(ReservationPlanStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ReservationPlan& WithStatus(ReservationPlanStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
