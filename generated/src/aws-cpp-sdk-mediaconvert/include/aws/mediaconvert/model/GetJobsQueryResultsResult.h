...
namespace Model
{
  ...
  public:
    ...
    template<typename JobsT = Aws::Vector<Job>>
    GetJobsQueryResultsResult& WithJobs(JobsT&& value) { SetJobs(std::forward<JobsT>(value)); return *this;}
    template<typename JobsT = Job>
    GetJobsQueryResultsResult& AddJobs(JobsT&& value) { m_jobsHasBeenSet = true; m_jobs.emplace_back(std::forward<JobsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetJobsQueryResultsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline void SetStatus(JobsQueryStatus value) { m_statusHasBeenSet = true; m_status = value; }
    inline GetJobsQueryResultsResult& WithStatus(JobsQueryStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetJobsQueryResultsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
