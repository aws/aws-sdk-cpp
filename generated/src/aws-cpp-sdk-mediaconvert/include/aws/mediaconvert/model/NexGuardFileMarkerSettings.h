...
class NexGuardFileMarkerSettings {
 public:
  ...
  template <typename LicenseT = Aws::String>
  NexGuardFileMarkerSettings& WithLicense(LicenseT&& value) {
  ...
  inline void SetPayload(int value) {
    m_payloadHasBeenSet = true;
    m_payload = value;
  }
  inline NexGuardFileMarkerSettings& WithPayload(int value) {
    SetPayload(value);
    return *this;
  }
  ///@}
  ...
  template <typename PresetT = Aws::String>
  NexGuardFileMarkerSettings& WithPreset(PresetT&& value) {
  ...
  inline void SetStrength(WatermarkingStrength value) {
    m_strengthHasBeenSet = true;
    m_strength = value;
  }
  inline NexGuardFileMarkerSettings& WithStrength(WatermarkingStrength value) {
    SetStrength(value);
    return *this;
  }
  ///@}
