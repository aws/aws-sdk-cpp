...
class HlsImageBasedTrickPlaySettings {
 public:
  ...
  inline HlsImageBasedTrickPlaySettings& WithIntervalCadence(HlsIntervalCadence value) {
  ...
  inline HlsImageBasedTrickPlaySettings& WithThumbnailHeight(int value) {
  ...
  inline HlsImageBasedTrickPlaySettings& WithThumbnailInterval(double value) {
  ...
  inline HlsImageBasedTrickPlaySettings& WithThumbnailWidth(int value) {
  ...
  inline HlsImageBasedTrickPlaySettings& WithTileHeight(int value) {
    SetTileHeight(value);
    return *this;
  }
  ///@}
  ...
  inline HlsImageBasedTrickPlaySettings& WithTileWidth(int value) {
    SetTileWidth(value);
    return *this;
  }
  ///@}
