...
class ContainerSettings {
 public:
  ...
  void SetCmfcSettings(CmfcSettingsT&& value) {
    m_cmfcSettingsHasBeenSet = true;
    m_cmfcSettings = std::forward<CmfcSettingsT>(value);
  }
  template <typename CmfcSettingsT = CmfcSettings>
  ContainerSettings& WithCmfcSettings(CmfcSettingsT&& value) {
    SetCmfcSettings(std::forward<CmfcSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetContainer(ContainerType value) {
    m_containerHasBeenSet = true;
    m_container = value;
  }
  inline ContainerSettings& WithContainer(ContainerType value) {
    SetContainer(value);
    return *this;
  }
  ///@}
  ...
  void SetF4vSettings(F4vSettingsT&& value) {
    m_f4vSettingsHasBeenSet = true;
    m_f4vSettings = std::forward<F4vSettingsT>(value);
  }
  template <typename F4vSettingsT = F4vSettings>
  ContainerSettings& WithF4vSettings(F4vSettingsT&& value) {
    SetF4vSettings(std::forward<F4vSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMovSettings(MovSettingsT&& value) {
    m_movSettingsHasBeenSet = true;
    m_movSettings = std::forward<MovSettingsT>(value);
  }
  template <typename MovSettingsT = MovSettings>
  ContainerSettings& WithMovSettings(MovSettingsT&& value) {
    SetMovSettings(std::forward<MovSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMp4Settings(Mp4SettingsT&& value) {
    m_mp4SettingsHasBeenSet = true;
    m_mp4Settings = std::forward<Mp4SettingsT>(value);
  }
  template <typename Mp4SettingsT = Mp4Settings>
  ContainerSettings& WithMp4Settings(Mp4SettingsT&& value) {
    SetMp4Settings(std::forward<Mp4SettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMpdSettings(MpdSettingsT&& value) {
    m_mpdSettingsHasBeenSet = true;
    m_mpdSettings = std::forward<MpdSettingsT>(value);
  }
  template <typename MpdSettingsT = MpdSettings>
  ContainerSettings& WithMpdSettings(MpdSettingsT&& value) {
    SetMpdSettings(std::forward<MpdSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMxfSettings(MxfSettingsT&& value) {
    m_mxfSettingsHasBeenSet = true;
    m_mxfSettings = std::forward<MxfSettingsT>(value);
  }
  template <typename MxfSettingsT = MxfSettings>
  ContainerSettings& WithMxfSettings(MxfSettingsT&& value) {
    SetMxfSettings(std::forward<MxfSettingsT>(value));
    return *this;
  }
  ///@}
 private:
