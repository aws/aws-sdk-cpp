...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIACONVERT_API SearchJobsResult();
    AWS_MEDIACONVERT_API SearchJobsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_MEDIACONVERT_API SearchJobsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline SearchJobsResult& WithJobs(const Aws::Vector<Job>& value) { SetJobs(value); return *this;}
    inline SearchJobsResult& WithJobs(Aws::Vector<Job>&& value) { SetJobs(std::move(value)); return *this;}
    inline SearchJobsResult& AddJobs(const Job& value) { m_jobs.push_back(value); return *this; }
    inline SearchJobsResult& AddJobs(Job&& value) { m_jobs.push_back(std::move(value)); return *this; }
    ///@}
