...
class AudioNormalizationSettings {
 public:
  ...
  inline void SetCorrectionGateLevel(int value) {
    m_correctionGateLevelHasBeenSet = true;
    m_correctionGateLevel = value;
  }
  inline AudioNormalizationSettings& WithCorrectionGateLevel(int value) {
    SetCorrectionGateLevel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLoudnessLogging(AudioNormalizationLoudnessLogging value) {
    m_loudnessLoggingHasBeenSet = true;
    m_loudnessLogging = value;
  }
  inline AudioNormalizationSettings& WithLoudnessLogging(AudioNormalizationLoudnessLogging value) {
    SetLoudnessLogging(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTruePeakLimiterThreshold(double value) {
    m_truePeakLimiterThresholdHasBeenSet = true;
    m_truePeakLimiterThreshold = value;
  }
  inline AudioNormalizationSettings& WithTruePeakLimiterThreshold(double value) {
    SetTruePeakLimiterThreshold(value);
    return *this;
  }
  ///@}
 private:
