...
namespace MediaConvert
{
   ...
   */
  class AWS_MEDIACONVERT_API MediaConvertClient : Aws::Client::ClientWithAsyncTemplateMethods<MediaConvertClient>,
    smithy::client::AwsSmithyClientT<Aws::MediaConvert::SERVICE_NAME,
