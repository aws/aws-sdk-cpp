...
namespace CloudControlApi
{
   ...
   */
  class AWS_CLOUDCONTROLAPI_API CloudControlApiClient : Aws::Client::ClientWithAsyncTemplateMethods<CloudControlApiClient>,
    smithy::client::AwsSmithyClientT<Aws::CloudControlApi::SERVICE_NAME,
