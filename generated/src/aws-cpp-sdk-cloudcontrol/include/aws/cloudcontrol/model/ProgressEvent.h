...
class ProgressEvent {
 public:
  ...
  void SetHooksRequestToken(HooksRequestTokenT&& value) {
    ...
    m_hooksRequestToken = std::forward<HooksRequestTokenT>(value);
  }
  template <typename HooksRequestTokenT = Aws::String>
  ProgressEvent& WithHooksRequestToken(HooksRequestTokenT&& value) {
    SetHooksRequestToken(std::forward<HooksRequestTokenT>(value));
    return *this;
  }
  ///@}
  ...
  inline ProgressEvent& WithOperation(Operation value) {
    SetOperation(value);
    return *this;
  }
  ///@}
  ...
  inline ProgressEvent& WithOperationStatus(OperationStatus value) {
  ...
  inline void SetErrorCode(HandlerErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline ProgressEvent& WithErrorCode(HandlerErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  void SetRetryAfter(RetryAfterT&& value) {
    ...
    m_retryAfter = std::forward<RetryAfterT>(value);
  }
  template <typename RetryAfterT = Aws::Utils::DateTime>
  ProgressEvent& WithRetryAfter(RetryAfterT&& value) {
    SetRetryAfter(std::forward<RetryAfterT>(value));
    return *this;
  }
  ///@}
 private:
