...
class DeleteResourceRequest : public CloudControlApiRequest {
 public:
  ...
  template <typename TypeNameT = Aws::String>
  DeleteResourceRequest& WithTypeName(TypeNameT&& value) {
  ...
  template <typename TypeVersionIdT = Aws::String>
  DeleteResourceRequest& WithTypeVersionId(TypeVersionIdT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  DeleteResourceRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteResourceRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  DeleteResourceRequest& WithIdentifier(IdentifierT&& value) {
