...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDCONTROLAPI_API DeleteResourceRequest() = default;
    ...
    template<typename TypeNameT = Aws::String>
    DeleteResourceRequest& WithTypeName(TypeNameT&& value) { SetTypeName(std::forward<TypeNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TypeVersionIdT = Aws::String>
    DeleteResourceRequest& WithTypeVersionId(TypeVersionIdT&& value) { SetTypeVersionId(std::forward<TypeVersionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    DeleteResourceRequest& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    DeleteResourceRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentifierT = Aws::String>
    DeleteResourceRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
