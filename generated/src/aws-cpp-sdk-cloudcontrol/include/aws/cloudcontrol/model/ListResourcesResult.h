...
class ListResourcesResult {
 public:
  ...
  void SetResourceDescriptions(ResourceDescriptionsT&& value) {
    ...
    m_resourceDescriptions = std::forward<ResourceDescriptionsT>(value);
  }
  template <typename ResourceDescriptionsT = Aws::Vector<ResourceDescription>>
  ListResourcesResult& WithResourceDescriptions(ResourceDescriptionsT&& value) {
    SetResourceDescriptions(std::forward<ResourceDescriptionsT>(value));
    return *this;
  }
  ...
  ListResourcesResult& AddResourceDescriptions(ResourceDescriptionsT&& value) {
    m_resourceDescriptionsHasBeenSet = true;
    m_resourceDescriptions.emplace_back(std::forward<ResourceDescriptionsT>(value));
    return *this;
  }
  ///@}
