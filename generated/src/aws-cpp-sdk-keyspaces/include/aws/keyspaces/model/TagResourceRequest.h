...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public KeyspacesRequest
  {
  public:
    AWS_KEYSPACES_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the Amazon Keyspaces resource to which to
     * add tags.</p>
     */
