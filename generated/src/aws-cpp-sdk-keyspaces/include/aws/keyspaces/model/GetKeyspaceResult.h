...
class GetKeyspaceResult {
 public:
  ...
  inline GetKeyspaceResult& WithReplicationStrategy(Rs value) {
  ...
  void SetReplicationGroupStatuses(ReplicationGroupStatusesT&& value) {
    ...
    m_replicationGroupStatuses = std::forward<ReplicationGroupStatusesT>(value);
  }
  template <typename ReplicationGroupStatusesT = Aws::Vector<ReplicationGroupStatus>>
  GetKeyspaceResult& WithReplicationGroupStatuses(ReplicationGroupStatusesT&& value) {
    SetReplicationGroupStatuses(std::forward<ReplicationGroupStatusesT>(value));
    return *this;
  }
  ...
  GetKeyspaceResult& AddReplicationGroupStatuses(ReplicationGroupStatusesT&& value) {
    m_replicationGroupStatusesHasBeenSet = true;
    m_replicationGroupStatuses.emplace_back(std::forward<ReplicationGroupStatusesT>(value));
    return *this;
  }
  ///@}
