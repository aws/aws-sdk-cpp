...
class AutoScalingSpecification {
 public:
  ...
  void SetWriteCapacityAutoScaling(WriteCapacityAutoScalingT&& value) {
    ...
    m_writeCapacityAutoScaling = std::forward<WriteCapacityAutoScalingT>(value);
  }
  template <typename WriteCapacityAutoScalingT = AutoScalingSettings>
  AutoScalingSpecification& WithWriteCapacityAutoScaling(WriteCapacityAutoScalingT&& value) {
    SetWriteCapacityAutoScaling(std::forward<WriteCapacityAutoScalingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReadCapacityAutoScaling(ReadCapacityAutoScalingT&& value) {
    ...
    m_readCapacityAutoScaling = std::forward<ReadCapacityAutoScalingT>(value);
  }
  template <typename ReadCapacityAutoScalingT = AutoScalingSettings>
  AutoScalingSpecification& WithReadCapacityAutoScaling(ReadCapacityAutoScalingT&& value) {
    SetReadCapacityAutoScaling(std::forward<ReadCapacityAutoScalingT>(value));
    return *this;
  }
  ///@}
 private:
