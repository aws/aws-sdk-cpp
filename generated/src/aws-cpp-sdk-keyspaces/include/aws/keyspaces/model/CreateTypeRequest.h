...
class CreateTypeRequest : public KeyspacesRequest {
 public:
  ...
  template <typename KeyspaceNameT = Aws::String>
  CreateTypeRequest& WithKeyspaceName(KeyspaceNameT&& value) {
  ...
  template <typename TypeNameT = Aws::String>
  CreateTypeRequest& WithTypeName(TypeNameT&& value) {
  ...
  void SetFieldDefinitions(FieldDefinitionsT&& value) {
    m_fieldDefinitionsHasBeenSet = true;
    m_fieldDefinitions = std::forward<FieldDefinitionsT>(value);
  }
  template <typename FieldDefinitionsT = Aws::Vector<FieldDefinition>>
  CreateTypeRequest& WithFieldDefinitions(FieldDefinitionsT&& value) {
    SetFieldDefinitions(std::forward<FieldDefinitionsT>(value));
    return *this;
  }
  template <typename FieldDefinitionsT = FieldDefinition>
  CreateTypeRequest& AddFieldDefinitions(FieldDefinitionsT&& value) {
    m_fieldDefinitionsHasBeenSet = true;
    m_fieldDefinitions.emplace_back(std::forward<FieldDefinitionsT>(value));
    return *this;
  }
  ///@}
 private:
