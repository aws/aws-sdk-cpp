...
namespace Model
{
  ...
  {
  public:
    AWS_KEYSPACES_API CreateTableResult() = default;
    ...
    template<typename ResourceArnT = Aws::String>
    CreateTableResult& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
