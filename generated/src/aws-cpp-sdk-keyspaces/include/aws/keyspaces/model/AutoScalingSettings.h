...
class AutoScalingSettings {
 public:
  ...
  inline AutoScalingSettings& WithAutoScalingDisabled(bool value) {
  ...
  inline AutoScalingSettings& WithMinimumUnits(long long value) {
  ...
  inline AutoScalingSettings& WithMaximumUnits(long long value) {
