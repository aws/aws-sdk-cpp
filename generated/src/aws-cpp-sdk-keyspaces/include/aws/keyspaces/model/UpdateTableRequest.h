...
class UpdateTableRequest : public KeyspacesRequest {
 public:
  ...
  void SetAddColumns(AddColumnsT&& value) {
    m_addColumnsHasBeenSet = true;
    m_addColumns = std::forward<AddColumnsT>(value);
  }
  template <typename AddColumnsT = Aws::Vector<ColumnDefinition>>
  UpdateTableRequest& WithAddColumns(AddColumnsT&& value) {
    SetAddColumns(std::forward<AddColumnsT>(value));
    return *this;
  }
  template <typename AddColumnsT = ColumnDefinition>
  UpdateTableRequest& AddAddColumns(AddColumnsT&& value) {
    m_addColumnsHasBeenSet = true;
    m_addColumns.emplace_back(std::forward<AddColumnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateTableRequest& WithDefaultTimeToLive(int value) {
