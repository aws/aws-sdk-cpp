...
class GetTypeResult {
 public:
  ...
  template <typename KeyspaceNameT = Aws::String>
  GetTypeResult& WithKeyspaceName(KeyspaceNameT&& value) {
  ...
  template <typename TypeNameT = Aws::String>
  GetTypeResult& WithTypeName(TypeNameT&& value) {
  ...
  template <typename FieldDefinitionsT = Aws::Vector<FieldDefinition>>
  GetTypeResult& WithFieldDefinitions(FieldDefinitionsT&& value) {
    SetFieldDefinitions(std::forward<FieldDefinitionsT>(value));
    return *this;
  }
  template <typename FieldDefinitionsT = FieldDefinition>
  GetTypeResult& AddFieldDefinitions(FieldDefinitionsT&& value) {
    m_fieldDefinitionsHasBeenSet = true;
  ...
  template <typename LastModifiedTimestampT = Aws::Utils::DateTime>
  GetTypeResult& WithLastModifiedTimestamp(LastModifiedTimestampT&& value) {
  ...
  inline void SetStatus(TypeStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetTypeResult& WithStatus(TypeStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDirectReferringTables(DirectReferringTablesT&& value) {
    m_directReferringTablesHasBeenSet = true;
    m_directReferringTables = std::forward<DirectReferringTablesT>(value);
  }
  template <typename DirectReferringTablesT = Aws::Vector<Aws::String>>
  GetTypeResult& WithDirectReferringTables(DirectReferringTablesT&& value) {
    SetDirectReferringTables(std::forward<DirectReferringTablesT>(value));
    return *this;
  }
  template <typename DirectReferringTablesT = Aws::String>
  GetTypeResult& AddDirectReferringTables(DirectReferringTablesT&& value) {
    m_directReferringTablesHasBeenSet = true;
    m_directReferringTables.emplace_back(std::forward<DirectReferringTablesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDirectParentTypes(DirectParentTypesT&& value) {
    m_directParentTypesHasBeenSet = true;
    m_directParentTypes = std::forward<DirectParentTypesT>(value);
  }
  template <typename DirectParentTypesT = Aws::Vector<Aws::String>>
  GetTypeResult& WithDirectParentTypes(DirectParentTypesT&& value) {
    SetDirectParentTypes(std::forward<DirectParentTypesT>(value));
    return *this;
  }
  template <typename DirectParentTypesT = Aws::String>
  GetTypeResult& AddDirectParentTypes(DirectParentTypesT&& value) {
    m_directParentTypesHasBeenSet = true;
    m_directParentTypes.emplace_back(std::forward<DirectParentTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename KeyspaceArnT = Aws::String>
  GetTypeResult& WithKeyspaceArn(KeyspaceArnT&& value) {
