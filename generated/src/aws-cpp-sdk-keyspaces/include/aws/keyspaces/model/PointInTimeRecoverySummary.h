...
class PointInTimeRecoverySummary {
 public:
  ...
  inline void SetStatus(PointInTimeRecoveryStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline PointInTimeRecoverySummary& WithStatus(PointInTimeRecoveryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetEarliestRestorableTimestamp(EarliestRestorableTimestampT&& value) {
    ...
    m_earliestRestorableTimestamp = std::forward<EarliestRestorableTimestampT>(value);
  }
  template <typename EarliestRestorableTimestampT = Aws::Utils::DateTime>
  PointInTimeRecoverySummary& WithEarliestRestorableTimestamp(EarliestRestorableTimestampT&& value) {
    SetEarliestRestorableTimestamp(std::forward<EarliestRestorableTimestampT>(value));
    return *this;
  }
  ///@}
 private:
