...
class ListKeyspacesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListKeyspacesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetKeyspaces(KeyspacesT&& value) {
    m_keyspacesHasBeenSet = true;
    m_keyspaces = std::forward<KeyspacesT>(value);
  }
  template <typename KeyspacesT = Aws::Vector<KeyspaceSummary>>
  ListKeyspacesResult& WithKeyspaces(KeyspacesT&& value) {
    SetKeyspaces(std::forward<KeyspacesT>(value));
    return *this;
  }
  template <typename KeyspacesT = KeyspaceSummary>
  ListKeyspacesResult& AddKeyspaces(KeyspacesT&& value) {
    m_keyspacesHasBeenSet = true;
    m_keyspaces.emplace_back(std::forward<KeyspacesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListKeyspacesResult& WithRequestId(RequestIdT&& value) {
