...
class CdcSpecification {
 public:
  ...
  inline void SetStatus(CdcStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CdcSpecification& WithStatus(CdcStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetViewType(ViewType value) {
    m_viewTypeHasBeenSet = true;
    m_viewType = value;
  }
  inline CdcSpecification& WithViewType(ViewType value) {
    SetViewType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPropagateTags(CdcPropagateTags value) {
    m_propagateTagsHasBeenSet = true;
    m_propagateTags = value;
  }
  inline CdcSpecification& WithPropagateTags(CdcPropagateTags value) {
