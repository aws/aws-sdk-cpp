...
class CapacitySpecificationSummary {
 public:
  ...
  inline CapacitySpecificationSummary& WithThroughputMode(ThroughputMode value) {
  ...
  inline CapacitySpecificationSummary& WithReadCapacityUnits(long long value) {
  ...
  inline CapacitySpecificationSummary& WithWriteCapacityUnits(long long value) {
  ...
  void SetLastUpdateToPayPerRequestTimestamp(LastUpdateToPayPerRequestTimestampT&& value) {
    ...
    m_lastUpdateToPayPerRequestTimestamp = std::forward<LastUpdateToPayPerRequestTimestampT>(value);
  }
  template <typename LastUpdateToPayPerRequestTimestampT = Aws::Utils::DateTime>
  CapacitySpecificationSummary& WithLastUpdateToPayPerRequestTimestamp(LastUpdateToPayPerRequestTimestampT&& value) {
    SetLastUpdateToPayPerRequestTimestamp(std::forward<LastUpdateToPayPerRequestTimestampT>(value));
    return *this;
  }
  ///@}
 private:
