...
class ReplicationGroupStatus {
 public:
  ...
  inline void SetKeyspaceStatus(KeyspaceStatus value) {
    m_keyspaceStatusHasBeenSet = true;
    m_keyspaceStatus = value;
  }
  inline ReplicationGroupStatus& WithKeyspaceStatus(KeyspaceStatus value) {
    SetKeyspaceStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTablesReplicationProgress(TablesReplicationProgressT&& value) {
    ...
    m_tablesReplicationProgress = std::forward<TablesReplicationProgressT>(value);
  }
  template <typename TablesReplicationProgressT = Aws::String>
  ReplicationGroupStatus& WithTablesReplicationProgress(TablesReplicationProgressT&& value) {
    SetTablesReplicationProgress(std::forward<TablesReplicationProgressT>(value));
    return *this;
  }
  ///@}
 private:
