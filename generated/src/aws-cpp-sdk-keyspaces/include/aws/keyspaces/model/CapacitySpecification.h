...
class CapacitySpecification {
 public:
  ...
  inline CapacitySpecification& WithThroughputMode(ThroughputMode value) {
  ...
  inline CapacitySpecification& WithReadCapacityUnits(long long value) {
  ...
  inline CapacitySpecification& WithWriteCapacityUnits(long long value) {
