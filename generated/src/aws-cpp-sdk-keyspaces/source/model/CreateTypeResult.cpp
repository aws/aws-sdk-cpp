...
CreateTypeResult::CreateTypeResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateTypeResult& CreateTypeResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
