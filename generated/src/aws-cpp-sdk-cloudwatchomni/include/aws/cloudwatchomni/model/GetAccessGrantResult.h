...
class GetAccessGrantResult {
 public:
  AWS_CLOUDWATCHOMNI_API GetAccessGrantResult() = default;
  AWS_CLOUDWATCHOMNI_API GetAccessGrantResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_CLOUDWATCHOMNI_API GetAccessGrantResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);

  ///@{
  /**
   * <p>The full details of the access grant.</p>
   */
  ...
  template <typename AccessGrantT = AccessGrant>
  GetAccessGrantResult& WithAccessGrant(AccessGrantT&& value) {
