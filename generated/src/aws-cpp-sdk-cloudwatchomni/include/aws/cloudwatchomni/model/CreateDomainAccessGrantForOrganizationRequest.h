...
/**
 */
class CreateDomainAccessGrantForOrganizationRequest : public CloudWatchOmniRequest {
 public:
  AWS_CLOUDWATCHOMNI_API CreateDomainAccessGrantForOrganizationRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "CreateDomainAccessGrantForOrganization"; }
  ...
  ///@{
  /**
   * <p>The ID of the organization domain to create the grant on.</p>
   */
  ...
  template <typename DomainIdT = Aws::String>
  CreateDomainAccessGrantForOrganizationRequest& WithDomainId(DomainIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateDomainAccessGrantForOrganizationRequest& WithName(NameT&& value) {
  ...
  template <typename PrincipalT = OrganizationAccessGrantPrincipal>
  CreateDomainAccessGrantForOrganizationRequest& WithPrincipal(PrincipalT&& value) {
  ...
  inline CreateDomainAccessGrantForOrganizationRequest& WithPermission(OrganizationGrantPermission value) {
    SetPermission(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateDomainAccessGrantForOrganizationRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateDomainAccessGrantForOrganizationRequest& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateDomainAccessGrantForOrganizationRequest& WithClientToken(ClientTokenT&& value) {
