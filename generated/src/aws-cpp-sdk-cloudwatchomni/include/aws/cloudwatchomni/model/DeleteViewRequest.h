...
/**
 */
class DeleteViewRequest : public CloudWatchOmniRequest {
 public:
  AWS_CLOUDWATCHOMNI_API DeleteViewRequest() = default;
  ...
  ///@{
  /**
   * <p>The name of the view to delete.</p>
   */
  ...
  template <typename NameT = Aws::String>
  DeleteViewRequest& WithName(NameT&& value) {
