...
/**
 * <p>The request for retrieving a single integration.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cloudwatchomni-2025-01-01/GetIntegrationInput">AWS
 * API Reference</a></p>
 */
class GetIntegrationRequest : public CloudWatchOmniRequest {
 public:
  AWS_CLOUDWATCHOMNI_API GetIntegrationRequest() = default;
  ...
  ///@{
  /**
   * <p>Identifies the integration to return — exactly one of integrationId,
  ...
  template <typename IdentifierT = IntegrationIdentifier>
  GetIntegrationRequest& WithIdentifier(IdentifierT&& value) {
