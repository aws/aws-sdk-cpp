...
/**
 * <p>An unexpected error occurred while processing the request.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cloudwatchomni-2025-01-01/InternalServerException">AWS
 * API Reference</a></p>
 */
class InternalServerException {
 public:
  ...
  ///@{
  /**
   * <p>The error code associated with the internal error.</p>
   */
