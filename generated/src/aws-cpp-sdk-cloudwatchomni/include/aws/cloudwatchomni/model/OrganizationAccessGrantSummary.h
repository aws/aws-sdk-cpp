...
/**
 * <p>Summary of an organization access grant. Call
 * GetDomainAccessGrantForOrganization for the full grant.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cloudwatchomni-2025-01-01/OrganizationAccessGrantSummary">AWS
 * API Reference</a></p>
 */
class OrganizationAccessGrantSummary {
 public:
  AWS_CLOUDWATCHOMNI_API OrganizationAccessGrantSummary() = default;
  AWS_CLOUDWATCHOMNI_API OrganizationAccessGrantSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_CLOUDWATCHOMNI_API OrganizationAccessGrantSummary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename GrantIdT = Aws::String>
  OrganizationAccessGrantSummary& WithGrantId(GrantIdT&& value) {
  ...
  template <typename GrantArnT = Aws::String>
  OrganizationAccessGrantSummary& WithGrantArn(GrantArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  OrganizationAccessGrantSummary& WithName(NameT&& value) {
  ...
  template <typename DomainIdT = Aws::String>
  OrganizationAccessGrantSummary& WithDomainId(DomainIdT&& value) {
  ...
  template <typename PrincipalT = OrganizationAccessGrantPrincipal>
  OrganizationAccessGrantSummary& WithPrincipal(PrincipalT&& value) {
  ...
  inline OrganizationAccessGrantSummary& WithPermission(OrganizationGrantPermission value) {
    SetPermission(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationAccessGrantSummary& WithGrantType(AccessGrantType value) {
    SetGrantType(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The timestamp when the access grant was created.</p>
   */
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  OrganizationAccessGrantSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  ///@{
  /**
   * <p>The timestamp when the access grant was last updated.</p>
   */
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  OrganizationAccessGrantSummary& WithUpdatedAt(UpdatedAtT&& value) {
