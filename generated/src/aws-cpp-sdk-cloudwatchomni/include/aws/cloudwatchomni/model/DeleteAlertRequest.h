...
/**
 */
class DeleteAlertRequest : public CloudWatchOmniRequest {
 public:
  AWS_CLOUDWATCHOMNI_API DeleteAlertRequest() = default;
  ...
  template <typename SpaceIdT = Aws::String>
  DeleteAlertRequest& WithSpaceId(SpaceIdT&& value) {
  ...
  template <typename AlertIdT = Aws::String>
  DeleteAlertRequest& WithAlertId(AlertIdT&& value) {
