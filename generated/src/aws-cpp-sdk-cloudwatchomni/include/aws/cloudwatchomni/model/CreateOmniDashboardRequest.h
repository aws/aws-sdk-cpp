...
/**
 */
class CreateOmniDashboardRequest : public CloudWatchOmniRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "CreateOmniDashboard"; }
  ...
  ///@{
  /**
   * <p>The unique ID of the space to create the dashboard in.</p>
   */
  ...
  ///@{
  /**
   * <p>The tags to associate with the dashboard.</p>
   */
  ...
  ///@{
  /**
   * <p>The dashboard definition, as a JSON document. Maximum 1 MiB.</p>
   */
