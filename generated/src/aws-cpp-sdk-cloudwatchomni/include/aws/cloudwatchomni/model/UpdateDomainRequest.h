...
/**
 */
class UpdateDomainRequest : public CloudWatchOmniRequest {
 public:
  AWS_CLOUDWATCHOMNI_API UpdateDomainRequest() = default;
  ...
  ///@{
  /**
   * <p>The unique ID of the domain to update.</p>
   */
  ...
  ///@{
  /**
   * <p>A new name for the domain. Omit to leave unchanged. Must be 3-63 characters:
  ...
  template <typename IdentityProvidersT = Aws::Vector<IdentityProvider>>
  UpdateDomainRequest& WithIdentityProviders(IdentityProvidersT&& value) {
    SetIdentityProviders(std::forward<IdentityProvidersT>(value));
    return *this;
  }
  inline UpdateDomainRequest& AddIdentityProviders(IdentityProvider value) {
    m_identityProvidersHasBeenSet = true;
  ...
  template <typename IdentityProviderConfigurationT = IdentityProviderConfiguration>
  UpdateDomainRequest& WithIdentityProviderConfiguration(IdentityProviderConfigurationT&& value) {
