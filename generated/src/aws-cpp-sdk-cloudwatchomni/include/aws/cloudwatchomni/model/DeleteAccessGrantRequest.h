...
/**
 */
class DeleteAccessGrantRequest : public CloudWatchOmniRequest {
 public:
  AWS_CLOUDWATCHOMNI_API DeleteAccessGrantRequest() = default;
  ...
  ///@{
  /**
   * <p>The ID of the access grant to delete.</p>
   */
  ...
  template <typename GrantIdT = Aws::String>
  DeleteAccessGrantRequest& WithGrantId(GrantIdT&& value) {
