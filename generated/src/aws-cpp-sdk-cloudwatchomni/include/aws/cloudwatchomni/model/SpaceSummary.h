...
/**
 * <p>Summary of a space. Call GetSpace for the full space.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cloudwatchomni-2025-01-01/SpaceSummary">AWS
 * API Reference</a></p>
 */
class SpaceSummary {
 public:
  AWS_CLOUDWATCHOMNI_API SpaceSummary() = default;
  AWS_CLOUDWATCHOMNI_API SpaceSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_CLOUDWATCHOMNI_API SpaceSummary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename DomainArnT = Aws::String>
  SpaceSummary& WithDomainArn(DomainArnT&& value) {
  ...
  template <typename RegionT = Aws::String>
  SpaceSummary& WithRegion(RegionT&& value) {
  ...
  template <typename OwnerAccountIdT = Aws::String>
  SpaceSummary& WithOwnerAccountId(OwnerAccountIdT&& value) {
  ...
  inline SpaceSummary& WithStatus(SpaceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  SpaceSummary& WithStatusReason(StatusReasonT&& value) {
