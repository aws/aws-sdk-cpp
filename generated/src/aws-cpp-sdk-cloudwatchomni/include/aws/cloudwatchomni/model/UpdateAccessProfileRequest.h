...
/**
 */
class UpdateAccessProfileRequest : public CloudWatchOmniRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "UpdateAccessProfile"; }
  ...
  ///@{
  /**
   * <p>The unique ID of the access profile to update.</p>
   */
  ...
  ///@{
  /**
   * <p>A new name for the access profile. Omit to leave unchanged.</p>
   */
  ...
  ///@{
  /**
   * <p>A new description of the access profile. Omit to leave unchanged.</p>
   */
