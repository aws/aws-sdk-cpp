...
/**
 */
class UpdateViewRequest : public CloudWatchOmniRequest {
 public:
  AWS_CLOUDWATCHOMNI_API UpdateViewRequest() = default;
  ...
  ///@{
  /**
   * <p>The name of the view to update.</p>
   */
  ...
  template <typename NameT = Aws::String>
  UpdateViewRequest& WithName(NameT&& value) {
  ...
  ///@{
  /**
   * <p>The new SQL query that defines the view. Omit to leave unchanged.</p>
   */
  ...
  template <typename DefinitionT = Aws::String>
  UpdateViewRequest& WithDefinition(DefinitionT&& value) {
  ...
  ///@{
  /**
   * <p>The new description of the view. Omit to leave unchanged.</p>
   */
  ...
  template <typename DescriptionT = Aws::String>
  UpdateViewRequest& WithDescription(DescriptionT&& value) {
