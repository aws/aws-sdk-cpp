...
namespace Model {
class UpdateDomainForOrganizationResult {
 public:
  AWS_CLOUDWATCHOMNI_API UpdateDomainForOrganizationResult() = default;
  AWS_CLOUDWATCHOMNI_API UpdateDomainForOrganizationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_CLOUDWATCHOMNI_API UpdateDomainForOrganizationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);

  ///@{
  /**
   * <p>The details of the updated organization domain.</p>
   */
  ...
  template <typename OrganizationDomainT = OrganizationDomain>
  UpdateDomainForOrganizationResult& WithOrganizationDomain(OrganizationDomainT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDomainForOrganizationResult& WithRequestId(RequestIdT&& value) {
