...
namespace Model {
class CreateDomainAccessGrantForOrganizationResult {
 public:
  AWS_CLOUDWATCHOMNI_API CreateDomainAccessGrantForOrganizationResult() = default;
  AWS_CLOUDWATCHOMNI_API CreateDomainAccessGrantForOrganizationResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_CLOUDWATCHOMNI_API CreateDomainAccessGrantForOrganizationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);

  ///@{
  /**
   * <p>The details of the created organization access grant.</p>
   */
  ...
  template <typename AccessGrantT = OrganizationAccessGrant>
  CreateDomainAccessGrantForOrganizationResult& WithAccessGrant(AccessGrantT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDomainAccessGrantForOrganizationResult& WithRequestId(RequestIdT&& value) {
