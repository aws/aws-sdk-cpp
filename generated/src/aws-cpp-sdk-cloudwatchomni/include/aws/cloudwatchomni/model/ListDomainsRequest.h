...
/**
 */
class ListDomainsRequest : public CloudWatchOmniRequest {
 public:
  AWS_CLOUDWATCHOMNI_API ListDomainsRequest() = default;
  ...
  ///@{
  /**
   * <p>A token to retrieve the next page of results. Tokens expire after 24
   * hours.</p>
   */
  ...
  ///@{
  /**
   * <p>The maximum number of domains to return per page. Defaults to 100.</p>
   */
