...
/**
 * <p>One LOGS query selector block on a node. The <code>attributes</code> map's
 * keys are AND'd; each selects with <code>col = value</code>. Deliberately
 * RAW/un-normalized so the selector matches the store, not the node's merged
 * identity.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cloudwatchomni-2025-01-01/LogMetadata">AWS
 * API Reference</a></p>
 */
class LogMetadata {
 public:
