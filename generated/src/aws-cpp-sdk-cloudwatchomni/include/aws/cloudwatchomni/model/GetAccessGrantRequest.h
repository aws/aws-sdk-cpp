...
/**
 */
class GetAccessGrantRequest : public CloudWatchOmniRequest {
 public:
  AWS_CLOUDWATCHOMNI_API GetAccessGrantRequest() = default;
  ...
  template <typename GrantIdT = Aws::String>
  GetAccessGrantRequest& WithGrantId(GrantIdT&& value) {
