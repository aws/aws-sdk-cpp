...
Aws::String CreateOmniDashboardRequest::SerializePayload() const {
  ...
  if (m_requestBodyHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("body"));
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(m_requestBody.c_str()));
  }
  const auto str = Aws::String(reinterpret_cast<char*>(encoder.GetEncodedData().ptr), encoder.GetEncodedData().len);
  return str;
}

Aws::Http::HeaderValueCollection CreateOmniDashboardRequest::GetRequestSpecificHeaders() const {
