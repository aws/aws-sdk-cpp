...
Aws::String DeleteDomainForOrganizationRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection DeleteDomainForOrganizationRequest::GetRequestSpecificHeaders() const {
