...
ScopedActions::ScopedActions(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) { *this = decoder; }

ScopedActions& ScopedActions::operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "actions") {
                      ...
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        ...
                        if (peekType_1.has_value()) {
                          if (peekType_1.value() == Aws::Crt::Cbor::CborType::Text) {
                            ...
                            if (val.has_value()) {
                              m_actions.push_back(Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                            }
                          } else {
                ...
                if (peekType_0.has_value() &&
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_resources.push_back(ResourceScope(decoder));
                      }
                    }
                  } else  // IndefArrayStart
                  {
              ...
              else if (initialKeyStr == "contextConditions") {
                auto peekType_0 = decoder->PeekType();
                      ...
                      for (size_t j_0 = 0; j_0 < mapSize_0.value(); j_0++) {
                        ...
                        if (key_1.has_value()) {
                          ...
                          if (peekType_1.has_value() &&
                            ...
                            m_contextConditions[keyStr_1] = nestedList_1;
                          }
                        }
                      }
                    }
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("ScopedActions", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void ScopedActions::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  ...
  if (m_contextConditionsHasBeenSet) {
    mapSize++;
  }
  ...
  if (m_resourcesHasBeenSet) {
    ...
    encoder.WriteArrayStart(m_resources.size());
    for (const auto& item_0 : m_resources) {
      item_0.CborEncode(encoder);
    }
  }

  if (m_contextConditionsHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("contextConditions"));
    encoder.WriteMapStart(m_contextConditions.size());
    for (const auto& item_0 : m_contextConditions) {
