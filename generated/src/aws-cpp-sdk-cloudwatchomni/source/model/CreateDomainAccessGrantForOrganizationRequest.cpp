...
Aws::String CreateDomainAccessGrantForOrganizationRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection CreateDomainAccessGrantForOrganizationRequest::GetRequestSpecificHeaders() const {
