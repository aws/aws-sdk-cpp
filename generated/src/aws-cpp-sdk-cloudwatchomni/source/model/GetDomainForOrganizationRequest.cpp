...
Aws::String GetDomainForOrganizationRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection GetDomainForOrganizationRequest::GetRequestSpecificHeaders() const {
