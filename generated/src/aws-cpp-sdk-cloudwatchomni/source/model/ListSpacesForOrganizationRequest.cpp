...
Aws::String ListSpacesForOrganizationRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection ListSpacesForOrganizationRequest::GetRequestSpecificHeaders() const {
