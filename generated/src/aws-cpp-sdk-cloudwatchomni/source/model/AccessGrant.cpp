...
AccessGrant::AccessGrant(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) { *this = decoder; }

AccessGrant& AccessGrant::operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "grantId") {
                ...
                m_principal = AccessGrantPrincipal(decoder);
                ...
                auto val = decoder->PopNextTextVal();
                if (val.has_value()) {
                  m_permission = AccessGrantPermissionMapper::GetAccessGrantPermissionForName(
              ...
              else if (initialKeyStr == "scopedActions") {
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_scopedActions.push_back(ScopedActions(decoder));
                      }
                    }
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("AccessGrant", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void AccessGrant::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
