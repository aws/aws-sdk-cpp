...
Aws::String CreateViewRequest::SerializePayload() const {
  ...
  if (m_definitionHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("definition"));
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(m_definition.c_str()));
  }
...
Aws::Http::HeaderValueCollection CreateViewRequest::GetRequestSpecificHeaders() const {
