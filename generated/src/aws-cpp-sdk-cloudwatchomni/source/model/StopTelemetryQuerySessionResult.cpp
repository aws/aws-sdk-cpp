...
StopTelemetryQuerySessionResult::StopTelemetryQuerySessionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

StopTelemetryQuerySessionResult& StopTelemetryQuerySessionResult::operator=(
