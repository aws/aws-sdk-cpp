...
Aws::String ListTelemetryQuerySessionsRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection ListTelemetryQuerySessionsRequest::GetRequestSpecificHeaders() const {
