...
Aws::String UpdateDomainForOrganizationRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection UpdateDomainForOrganizationRequest::GetRequestSpecificHeaders() const {
