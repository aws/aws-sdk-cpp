...
Aws::String ListViewsRequest::SerializePayload() const {
  ...
  if (m_typeHasBeenSet) {
    ...
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(ViewTypeMapper::GetNameForViewType(m_type).c_str()));
  }
...
Aws::Http::HeaderValueCollection ListViewsRequest::GetRequestSpecificHeaders() const {
