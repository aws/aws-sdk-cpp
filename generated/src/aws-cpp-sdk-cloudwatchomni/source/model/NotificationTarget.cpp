...
NotificationTarget::NotificationTarget(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) { *this = decoder; }

NotificationTarget& NotificationTarget::operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "type") {
                ...
                if (val.has_value()) {
                  m_type = NotificationTargetTypeMapper::GetNotificationTargetTypeForName(
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("NotificationTarget", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void NotificationTarget::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  if (m_typeHasBeenSet) {
    mapSize++;
  ...
  if (m_typeHasBeenSet) {
    ...
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(NotificationTargetTypeMapper::GetNameForNotificationTargetType(m_type).c_str()));
  }
