...
NodeFilters::NodeFilters(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) { *this = decoder; }

NodeFilters& NodeFilters::operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "nodeId") {
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_tags.push_back(KeyFilter(decoder));
                      }
                    }
                ...
                if (peekType_0.has_value() &&
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_telemetryAttributes.push_back(KeyFilter(decoder));
                      }
                    }
                  } else  // IndefArrayStart
                  {
                      ...
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        ...
                        if (peekType_1.has_value()) {
                          if (peekType_1.value() == Aws::Crt::Cbor::CborType::Text) {
                            auto val = decoder->PopNextTextVal();
                            if (val.has_value()) {
                              m_region.push_back(Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                            }
                          } else {
                            decoder->ConsumeNextSingleElement();
              ...
              else if (initialKeyStr == "cloudProvider") {
                auto peekType_0 = decoder->PeekType();
                if (peekType_0.has_value() &&
                    (peekType_0.value() == CborType::ArrayStart || peekType_0.value() == CborType::IndefArrayStart)) {
                  if (peekType_0.value() == CborType::ArrayStart) {
                      ...
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        ...
                        if (peekType_1.has_value()) {
                          if (peekType_1.value() == Aws::Crt::Cbor::CborType::Text) {
                            auto val = decoder->PopNextTextVal();
                            if (val.has_value()) {
                              m_cloudProvider.push_back(Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                            }
                          } else {
                            decoder->ConsumeNextSingleElement();
                            Aws::StringStream ss_1;
                            ...
                            m_cloudProvider.push_back(ss_1.str());
                            ss_1.clear();
                          }
                        }
                      }
              ...
              else if (initialKeyStr == "sourceAccountId") {
                auto peekType_0 = decoder->PeekType();
                if (peekType_0.has_value() &&
                    (peekType_0.value() == CborType::ArrayStart || peekType_0.value() == CborType::IndefArrayStart)) {
                  if (peekType_0.value() == CborType::ArrayStart) {
                      ...
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        ...
                        if (peekType_1.has_value()) {
                          if (peekType_1.value() == Aws::Crt::Cbor::CborType::Text) {
                            auto val = decoder->PopNextTextVal();
                            if (val.has_value()) {
                              m_sourceAccountId.push_back(Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                            }
                          } else {
                            decoder->ConsumeNextSingleElement();
                            Aws::StringStream ss_1;
                            ...
                            m_sourceAccountId.push_back(ss_1.str());
                            ss_1.clear();
                          }
                        }
                      }
                      ...
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        ...
                        if (peekType_1.has_value()) {
                          if (peekType_1.value() == Aws::Crt::Cbor::CborType::Text) {
                            auto val = decoder->PopNextTextVal();
                            if (val.has_value()) {
                              m_namespace.push_back(Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                            }
                          } else {
                            decoder->ConsumeNextSingleElement();
                            Aws::StringStream ss_1;
                            ...
                            m_namespace.push_back(ss_1.str());
                            ss_1.clear();
                          }
                        }
                      }
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        auto val = decoder->PopNextTextVal();
                        if (val.has_value()) {
                          m_category.push_back(NodeCategoryMapper::GetNodeCategoryForName(
                      ...
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        ...
                        if (peekType_1.has_value()) {
                          if (peekType_1.value() == Aws::Crt::Cbor::CborType::Text) {
                            auto val = decoder->PopNextTextVal();
                            if (val.has_value()) {
                              m_stage.push_back(Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                            }
                          } else {
                            decoder->ConsumeNextSingleElement();
                            Aws::StringStream ss_1;
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("NodeFilters", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void NodeFilters::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  ...
  if (m_telemetryAttributesHasBeenSet) {
    ...
    encoder.WriteArrayStart(m_telemetryAttributes.size());
  ...
  if (m_regionHasBeenSet) {
    ...
    encoder.WriteArrayStart(m_region.size());
    for (const auto& item_0 : m_region) {
      encoder.WriteText(Aws::Crt::ByteCursorFromCString(item_0.c_str()));
    }
  }

  if (m_cloudProviderHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("cloudProvider"));
    encoder.WriteArrayStart(m_cloudProvider.size());
    for (const auto& item_0 : m_cloudProvider) {
      encoder.WriteText(Aws::Crt::ByteCursorFromCString(item_0.c_str()));
    }
  }

  if (m_sourceAccountIdHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("sourceAccountId"));
    encoder.WriteArrayStart(m_sourceAccountId.size());
    for (const auto& item_0 : m_sourceAccountId) {
      encoder.WriteText(Aws::Crt::ByteCursorFromCString(item_0.c_str()));
    }
  }
  ...
  if (m_namespaceHasBeenSet) {
    ...
    encoder.WriteArrayStart(m_namespace.size());
    for (const auto& item_0 : m_namespace) {
      encoder.WriteText(Aws::Crt::ByteCursorFromCString(item_0.c_str()));
    }
  }
  ...
  if (m_categoryHasBeenSet) {
    ...
    encoder.WriteArrayStart(m_category.size());
    for (const auto& item_0 : m_category) {
      encoder.WriteText(Aws::Crt::ByteCursorFromCString(NodeCategoryMapper::GetNameForNodeCategory(item_0).c_str()));
    }
  }

  if (m_stageHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("stage"));
    encoder.WriteArrayStart(m_stage.size());
    for (const auto& item_0 : m_stage) {
      encoder.WriteText(Aws::Crt::ByteCursorFromCString(item_0.c_str()));
    }
  }
