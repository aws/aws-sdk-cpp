...
Aws::String CreateDomainForOrganizationRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection CreateDomainForOrganizationRequest::GetRequestSpecificHeaders() const {
