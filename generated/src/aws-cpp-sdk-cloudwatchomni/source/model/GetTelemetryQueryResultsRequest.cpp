...
Aws::String GetTelemetryQueryResultsRequest::SerializePayload() const {
  ...
  if (m_queryIdHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("queryId"));
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(m_queryId.c_str()));
  }
...
Aws::Http::HeaderValueCollection GetTelemetryQueryResultsRequest::GetRequestSpecificHeaders() const {
