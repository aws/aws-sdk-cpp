...
Aws::String PutIntelligenceConfigurationRequest::SerializePayload() const {
  ...
  if (m_removeKmsKeyHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("removeKmsKey"));
    encoder.WriteBool(m_removeKmsKey);
  }
...
Aws::Http::HeaderValueCollection PutIntelligenceConfigurationRequest::GetRequestSpecificHeaders() const {
