...
class NodeConfig {
 public:
  ...
  inline NodeConfig& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(OpenSearchPartitionInstanceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline NodeConfig& WithType(OpenSearchPartitionInstanceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline NodeConfig& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
