...
class AssociatePackagesResult {
 public:
  ...
  template <typename DomainPackageDetailsListT = Aws::Vector<DomainPackageDetails>>
  AssociatePackagesResult& WithDomainPackageDetailsList(DomainPackageDetailsListT&& value) {
  ...
  AssociatePackagesResult& AddDomainPackageDetailsList(DomainPackageDetailsListT&& value) {
    m_domainPackageDetailsListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AssociatePackagesResult& WithRequestId(RequestIdT&& value) {
