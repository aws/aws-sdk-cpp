...
/**
 */
class GetMigrationRequest : public OpenSearchServiceRequest {
 public:
  AWS_OPENSEARCHSERVICE_API GetMigrationRequest() = default;
  ...
  template <typename MigrationIdT = Aws::String>
  GetMigrationRequest& WithMigrationId(MigrationIdT&& value) {
