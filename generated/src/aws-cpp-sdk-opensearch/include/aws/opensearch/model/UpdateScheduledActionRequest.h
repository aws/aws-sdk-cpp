...
class UpdateScheduledActionRequest : public OpenSearchServiceRequest {
 public:
  ...
  inline UpdateScheduledActionRequest& WithActionType(ActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScheduleAt(ScheduleAt value) {
    m_scheduleAtHasBeenSet = true;
    m_scheduleAt = value;
  }
  inline UpdateScheduledActionRequest& WithScheduleAt(ScheduleAt value) {
    SetScheduleAt(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDesiredStartTime(long long value) {
    m_desiredStartTimeHasBeenSet = true;
    m_desiredStartTime = value;
  }
  inline UpdateScheduledActionRequest& WithDesiredStartTime(long long value) {
    SetDesiredStartTime(value);
    return *this;
  }
  ///@}
 private:
