...
namespace Model
{
  ...
  {
  public:
    AWS_OPENSEARCHSERVICE_API AcceptInboundConnectionRequest() = default;
    ...
    template<typename ConnectionIdT = Aws::String>
    AcceptInboundConnectionRequest& WithConnectionId(ConnectionIdT&& value) { SetConnectionId(std::forward<ConnectionIdT>(value)); return *this;}
    ///@}
  private:
