...
class ListDomainMaintenancesResult {
 public:
  ...
  void SetDomainMaintenances(DomainMaintenancesT&& value) {
    m_domainMaintenancesHasBeenSet = true;
    m_domainMaintenances = std::forward<DomainMaintenancesT>(value);
  }
  template <typename DomainMaintenancesT = Aws::Vector<DomainMaintenanceDetails>>
  ListDomainMaintenancesResult& WithDomainMaintenances(DomainMaintenancesT&& value) {
    SetDomainMaintenances(std::forward<DomainMaintenancesT>(value));
    return *this;
  }
  template <typename DomainMaintenancesT = DomainMaintenanceDetails>
  ListDomainMaintenancesResult& AddDomainMaintenances(DomainMaintenancesT&& value) {
    m_domainMaintenancesHasBeenSet = true;
    m_domainMaintenances.emplace_back(std::forward<DomainMaintenancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDomainMaintenancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDomainMaintenancesResult& WithRequestId(RequestIdT&& value) {
