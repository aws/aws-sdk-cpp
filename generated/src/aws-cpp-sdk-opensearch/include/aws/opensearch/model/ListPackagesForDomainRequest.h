...
class ListPackagesForDomainRequest : public OpenSearchServiceRequest {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  ListPackagesForDomainRequest& WithDomainName(DomainNameT&& value) {
  ...
  inline ListPackagesForDomainRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPackagesForDomainRequest& WithNextToken(NextTokenT&& value) {
