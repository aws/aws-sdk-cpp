...
class PackageConfiguration {
 public:
  ...
  inline void SetLicenseRequirement(RequirementLevel value) {
    m_licenseRequirementHasBeenSet = true;
    m_licenseRequirement = value;
  }
  inline PackageConfiguration& WithLicenseRequirement(RequirementLevel value) {
    SetLicenseRequirement(value);
    return *this;
  }
  ///@}
  ...
  void SetLicenseFilepath(LicenseFilepathT&& value) {
    ...
    m_licenseFilepath = std::forward<LicenseFilepathT>(value);
  }
  template <typename LicenseFilepathT = Aws::String>
  PackageConfiguration& WithLicenseFilepath(LicenseFilepathT&& value) {
    SetLicenseFilepath(std::forward<LicenseFilepathT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetConfigurationRequirement(RequirementLevel value) {
    m_configurationRequirementHasBeenSet = true;
    m_configurationRequirement = value;
  }
  inline PackageConfiguration& WithConfigurationRequirement(RequirementLevel value) {
    SetConfigurationRequirement(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequiresRestartForConfigurationUpdate(bool value) {
    m_requiresRestartForConfigurationUpdateHasBeenSet = true;
    m_requiresRestartForConfigurationUpdate = value;
  }
  inline PackageConfiguration& WithRequiresRestartForConfigurationUpdate(bool value) {
