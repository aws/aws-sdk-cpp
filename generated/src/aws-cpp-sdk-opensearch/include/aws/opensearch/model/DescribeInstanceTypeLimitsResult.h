...
class DescribeInstanceTypeLimitsResult {
 public:
  ...
  AWS_OPENSEARCHSERVICE_API DescribeInstanceTypeLimitsResult& operator=(
  ...
  template <typename LimitsByRoleT = Aws::Map<Aws::String, Limits>>
  DescribeInstanceTypeLimitsResult& WithLimitsByRole(LimitsByRoleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeInstanceTypeLimitsResult& WithRequestId(RequestIdT&& value) {
