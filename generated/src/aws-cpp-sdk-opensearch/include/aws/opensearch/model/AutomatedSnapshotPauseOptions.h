 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/opensearch-2021-01-01/AutomatedSnapshotPauseOptions">AWS
 * API Reference</a></p>
 */
class AutomatedSnapshotPauseOptions {
 public:
  AWS_OPENSEARCHSERVICE_API AutomatedSnapshotPauseOptions() = default;
  AWS_OPENSEARCHSERVICE_API AutomatedSnapshotPauseOptions(Aws::Utils::Json::JsonView jsonValue);
  AWS_OPENSEARCHSERVICE_API AutomatedSnapshotPauseOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
