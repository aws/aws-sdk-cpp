...
class ReservedInstanceOffering {
 public:
  ...
  inline ReservedInstanceOffering& WithInstanceType(OpenSearchPartitionInstanceType value) {
  ...
  inline ReservedInstanceOffering& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstanceOffering& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstanceOffering& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstanceOffering& WithPaymentOption(ReservedInstancePaymentOption value) {
