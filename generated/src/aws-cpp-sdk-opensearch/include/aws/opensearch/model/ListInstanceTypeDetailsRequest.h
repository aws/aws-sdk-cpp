...
class ListInstanceTypeDetailsRequest : public OpenSearchServiceRequest {
 public:
  ...
  template <typename EngineVersionT = Aws::String>
  ListInstanceTypeDetailsRequest& WithEngineVersion(EngineVersionT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  ListInstanceTypeDetailsRequest& WithDomainName(DomainNameT&& value) {
  ...
  inline ListInstanceTypeDetailsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInstanceTypeDetailsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetRetrieveAZs(bool value) {
    m_retrieveAZsHasBeenSet = true;
    m_retrieveAZs = value;
  }
  inline ListInstanceTypeDetailsRequest& WithRetrieveAZs(bool value) {
    SetRetrieveAZs(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceTypeT = Aws::String>
  ListInstanceTypeDetailsRequest& WithInstanceType(InstanceTypeT&& value) {
