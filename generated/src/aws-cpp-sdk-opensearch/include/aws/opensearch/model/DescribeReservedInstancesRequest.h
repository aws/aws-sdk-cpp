...
class DescribeReservedInstancesRequest : public OpenSearchServiceRequest {
 public:
  ...
  template <typename ReservedInstanceIdT = Aws::String>
  DescribeReservedInstancesRequest& WithReservedInstanceId(ReservedInstanceIdT&& value) {
  ...
  inline DescribeReservedInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeReservedInstancesRequest& WithNextToken(NextTokenT&& value) {
