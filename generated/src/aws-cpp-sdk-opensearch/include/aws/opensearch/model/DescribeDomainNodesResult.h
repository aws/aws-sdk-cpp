...
class DescribeDomainNodesResult {
 public:
  ...
  void SetDomainNodesStatusList(DomainNodesStatusListT&& value) {
    m_domainNodesStatusListHasBeenSet = true;
    m_domainNodesStatusList = std::forward<DomainNodesStatusListT>(value);
  }
  template <typename DomainNodesStatusListT = Aws::Vector<DomainNodesStatus>>
  DescribeDomainNodesResult& WithDomainNodesStatusList(DomainNodesStatusListT&& value) {
    SetDomainNodesStatusList(std::forward<DomainNodesStatusListT>(value));
    return *this;
  }
  template <typename DomainNodesStatusListT = DomainNodesStatus>
  DescribeDomainNodesResult& AddDomainNodesStatusList(DomainNodesStatusListT&& value) {
    m_domainNodesStatusListHasBeenSet = true;
    m_domainNodesStatusList.emplace_back(std::forward<DomainNodesStatusListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDomainNodesResult& WithRequestId(RequestIdT&& value) {
