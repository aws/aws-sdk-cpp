...
class EBSOptions {
 public:
  ...
  inline void SetEBSEnabled(bool value) {
    m_eBSEnabledHasBeenSet = true;
    m_eBSEnabled = value;
  }
  inline EBSOptions& WithEBSEnabled(bool value) {
    SetEBSEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline EBSOptions& WithVolumeType(VolumeType value) {
    SetVolumeType(value);
    return *this;
  }
  ///@}
  ...
  inline EBSOptions& WithVolumeSize(int value) {
    SetVolumeSize(value);
    return *this;
  }
  ///@}
  ...
  inline EBSOptions& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  inline EBSOptions& WithThroughput(int value) {
    SetThroughput(value);
    return *this;
  }
  ///@}
