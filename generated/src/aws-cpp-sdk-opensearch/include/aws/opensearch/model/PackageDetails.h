...
class PackageDetails {
 public:
  ...
  inline PackageDetails& WithPackageType(PackageType value) {
  ...
  inline void SetPackageStatus(PackageStatus value) {
    m_packageStatusHasBeenSet = true;
    m_packageStatus = value;
  }
  inline PackageDetails& WithPackageStatus(PackageStatus value) {
  ...
  void SetAvailablePackageVersion(AvailablePackageVersionT&& value) {
    ...
    m_availablePackageVersion = std::forward<AvailablePackageVersionT>(value);
  }
  template <typename AvailablePackageVersionT = Aws::String>
  PackageDetails& WithAvailablePackageVersion(AvailablePackageVersionT&& value) {
    SetAvailablePackageVersion(std::forward<AvailablePackageVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAvailablePluginProperties(AvailablePluginPropertiesT&& value) {
    ...
    m_availablePluginProperties = std::forward<AvailablePluginPropertiesT>(value);
  }
  template <typename AvailablePluginPropertiesT = PluginProperties>
  PackageDetails& WithAvailablePluginProperties(AvailablePluginPropertiesT&& value) {
    SetAvailablePluginProperties(std::forward<AvailablePluginPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAvailablePackageConfiguration(AvailablePackageConfigurationT&& value) {
    ...
    m_availablePackageConfiguration = std::forward<AvailablePackageConfigurationT>(value);
  }
  template <typename AvailablePackageConfigurationT = PackageConfiguration>
  PackageDetails& WithAvailablePackageConfiguration(AvailablePackageConfigurationT&& value) {
    SetAvailablePackageConfiguration(std::forward<AvailablePackageConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAllowListedUserList(AllowListedUserListT&& value) {
    ...
    m_allowListedUserList = std::forward<AllowListedUserListT>(value);
  }
  template <typename AllowListedUserListT = Aws::Vector<Aws::String>>
  PackageDetails& WithAllowListedUserList(AllowListedUserListT&& value) {
    SetAllowListedUserList(std::forward<AllowListedUserListT>(value));
    return *this;
  }
  template <typename AllowListedUserListT = Aws::String>
  PackageDetails& AddAllowListedUserList(AllowListedUserListT&& value) {
    m_allowListedUserListHasBeenSet = true;
    m_allowListedUserList.emplace_back(std::forward<AllowListedUserListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPackageOwner(PackageOwnerT&& value) {
    ...
    m_packageOwner = std::forward<PackageOwnerT>(value);
  }
  template <typename PackageOwnerT = Aws::String>
  PackageDetails& WithPackageOwner(PackageOwnerT&& value) {
    SetPackageOwner(std::forward<PackageOwnerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPackageVendingOptions(PackageVendingOptionsT&& value) {
    ...
    m_packageVendingOptions = std::forward<PackageVendingOptionsT>(value);
  }
  template <typename PackageVendingOptionsT = PackageVendingOptions>
  PackageDetails& WithPackageVendingOptions(PackageVendingOptionsT&& value) {
    SetPackageVendingOptions(std::forward<PackageVendingOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPackageEncryptionOptions(PackageEncryptionOptionsT&& value) {
    ...
    m_packageEncryptionOptions = std::forward<PackageEncryptionOptionsT>(value);
  }
  template <typename PackageEncryptionOptionsT = PackageEncryptionOptions>
  PackageDetails& WithPackageEncryptionOptions(PackageEncryptionOptionsT&& value) {
    SetPackageEncryptionOptions(std::forward<PackageEncryptionOptionsT>(value));
    return *this;
  }
  ///@}
 private:
