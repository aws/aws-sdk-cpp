...
class AttachDataSourceResult {
 public:
   ...
   * <code>PENDING</code> (waiting for resources to become active),
   * <code>ATTACHED</code> (successfully attached), and <code>FAILED</code>
   * (attachment timed out or encountered a non-retryable error).</p>
   */
  ...
  inline AttachDataSourceResult& WithStatus(DataSourceAttachmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
