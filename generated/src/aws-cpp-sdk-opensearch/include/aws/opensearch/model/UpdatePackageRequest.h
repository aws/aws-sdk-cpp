...
class UpdatePackageRequest : public OpenSearchServiceRequest {
 public:
  ...
  void SetPackageConfiguration(PackageConfigurationT&& value) {
    ...
    m_packageConfiguration = std::forward<PackageConfigurationT>(value);
  }
  template <typename PackageConfigurationT = PackageConfiguration>
  UpdatePackageRequest& WithPackageConfiguration(PackageConfigurationT&& value) {
    SetPackageConfiguration(std::forward<PackageConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PackageEncryptionOptionsT = PackageEncryptionOptions>
  UpdatePackageRequest& WithPackageEncryptionOptions(PackageEncryptionOptionsT&& value) {
