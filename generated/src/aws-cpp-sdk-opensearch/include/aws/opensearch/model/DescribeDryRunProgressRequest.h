...
class DescribeDryRunProgressRequest : public OpenSearchServiceRequest {
 public:
  ...
  inline void SetLoadDryRunConfig(bool value) {
    m_loadDryRunConfigHasBeenSet = true;
    m_loadDryRunConfig = value;
  }
  inline DescribeDryRunProgressRequest& WithLoadDryRunConfig(bool value) {
    SetLoadDryRunConfig(value);
    return *this;
  }
  ///@}
 private:
