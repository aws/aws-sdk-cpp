...
namespace Model
{
  ...
  {
  public:
    AWS_OPENSEARCHSERVICE_API DeleteDirectQueryDataSourceRequest() = default;
    ...
    template<typename DataSourceNameT = Aws::String>
    DeleteDirectQueryDataSourceRequest& WithDataSourceName(DataSourceNameT&& value) { SetDataSourceName(std::forward<DataSourceNameT>(value)); return *this;}
    ///@}
  private:
