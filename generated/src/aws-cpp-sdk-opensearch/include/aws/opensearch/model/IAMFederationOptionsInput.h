...
class IAMFederationOptionsInput {
 public:
  ...
  inline IAMFederationOptionsInput& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubjectKeyT = Aws::String>
  IAMFederationOptionsInput& WithSubjectKey(SubjectKeyT&& value) {
  ...
  template <typename RolesKeyT = Aws::String>
  IAMFederationOptionsInput& WithRolesKey(RolesKeyT&& value) {
