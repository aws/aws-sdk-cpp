...
class UpgradeStepItem {
 public:
  ...
  inline UpgradeStepItem& WithUpgradeStep(UpgradeStep value) {
  ...
  inline void SetUpgradeStepStatus(UpgradeStatus value) {
    m_upgradeStepStatusHasBeenSet = true;
    m_upgradeStepStatus = value;
  }
  inline UpgradeStepItem& WithUpgradeStepStatus(UpgradeStatus value) {
    SetUpgradeStepStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpgradeStepItem& WithProgressPercent(double value) {
