...
class DomainStatus {
 public:
  ...
  inline DomainStatus& WithCreated(bool value) {
    SetCreated(value);
    return *this;
  }
  ///@}
  ...
  inline DomainStatus& WithDeleted(bool value) {
    SetDeleted(value);
    return *this;
  }
  ///@}
  ...
  void SetEndpointV2(EndpointV2T&& value) {
    ...
    m_endpointV2 = std::forward<EndpointV2T>(value);
  }
  template <typename EndpointV2T = Aws::String>
  DomainStatus& WithEndpointV2(EndpointV2T&& value) {
    SetEndpointV2(std::forward<EndpointV2T>(value));
    return *this;
  }
  ///@}
  ...
  DomainStatus& AddEndpoints(EndpointsKeyT&& key, EndpointsValueT&& value) {
    m_endpointsHasBeenSet = true;
    m_endpoints.emplace(std::forward<EndpointsKeyT>(key), std::forward<EndpointsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDomainEndpointV2HostedZoneId(DomainEndpointV2HostedZoneIdT&& value) {
    ...
    m_domainEndpointV2HostedZoneId = std::forward<DomainEndpointV2HostedZoneIdT>(value);
  }
  template <typename DomainEndpointV2HostedZoneIdT = Aws::String>
  DomainStatus& WithDomainEndpointV2HostedZoneId(DomainEndpointV2HostedZoneIdT&& value) {
    SetDomainEndpointV2HostedZoneId(std::forward<DomainEndpointV2HostedZoneIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProcessing(bool value) {
    m_processingHasBeenSet = true;
    m_processing = value;
  }
  inline DomainStatus& WithProcessing(bool value) {
    SetProcessing(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUpgradeProcessing(bool value) {
    m_upgradeProcessingHasBeenSet = true;
    m_upgradeProcessing = value;
  }
  inline DomainStatus& WithUpgradeProcessing(bool value) {
    SetUpgradeProcessing(value);
    return *this;
  }
  ///@}
  ...
  void SetClusterConfig(ClusterConfigT&& value) {
    ...
    m_clusterConfig = std::forward<ClusterConfigT>(value);
  }
  template <typename ClusterConfigT = ClusterConfig>
  DomainStatus& WithClusterConfig(ClusterConfigT&& value) {
    SetClusterConfig(std::forward<ClusterConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline DomainStatus& WithIPAddressType(IPAddressType value) {
  ...
  void SetIdentityCenterOptions(IdentityCenterOptionsT&& value) {
    ...
    m_identityCenterOptions = std::forward<IdentityCenterOptionsT>(value);
  }
  template <typename IdentityCenterOptionsT = IdentityCenterOptions>
  DomainStatus& WithIdentityCenterOptions(IdentityCenterOptionsT&& value) {
    SetIdentityCenterOptions(std::forward<IdentityCenterOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetChangeProgressDetails(ChangeProgressDetailsT&& value) {
    ...
    m_changeProgressDetails = std::forward<ChangeProgressDetailsT>(value);
  }
  template <typename ChangeProgressDetailsT = ChangeProgressDetails>
  DomainStatus& WithChangeProgressDetails(ChangeProgressDetailsT&& value) {
    SetChangeProgressDetails(std::forward<ChangeProgressDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOffPeakWindowOptions(OffPeakWindowOptionsT&& value) {
    ...
    m_offPeakWindowOptions = std::forward<OffPeakWindowOptionsT>(value);
  }
  template <typename OffPeakWindowOptionsT = OffPeakWindowOptions>
  DomainStatus& WithOffPeakWindowOptions(OffPeakWindowOptionsT&& value) {
    SetOffPeakWindowOptions(std::forward<OffPeakWindowOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSoftwareUpdateOptions(SoftwareUpdateOptionsT&& value) {
    ...
    m_softwareUpdateOptions = std::forward<SoftwareUpdateOptionsT>(value);
  }
  template <typename SoftwareUpdateOptionsT = SoftwareUpdateOptions>
  DomainStatus& WithSoftwareUpdateOptions(SoftwareUpdateOptionsT&& value) {
    SetSoftwareUpdateOptions(std::forward<SoftwareUpdateOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDomainProcessingStatus(DomainProcessingStatusType value) {
    m_domainProcessingStatusHasBeenSet = true;
    m_domainProcessingStatus = value;
  }
  inline DomainStatus& WithDomainProcessingStatus(DomainProcessingStatusType value) {
    SetDomainProcessingStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetModifyingProperties(ModifyingPropertiesT&& value) {
    ...
    m_modifyingProperties = std::forward<ModifyingPropertiesT>(value);
  }
  template <typename ModifyingPropertiesT = Aws::Vector<ModifyingProperties>>
  DomainStatus& WithModifyingProperties(ModifyingPropertiesT&& value) {
    SetModifyingProperties(std::forward<ModifyingPropertiesT>(value));
    return *this;
  }
  template <typename ModifyingPropertiesT = ModifyingProperties>
  DomainStatus& AddModifyingProperties(ModifyingPropertiesT&& value) {
    m_modifyingPropertiesHasBeenSet = true;
    m_modifyingProperties.emplace_back(std::forward<ModifyingPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAIMLOptions(AIMLOptionsT&& value) {
    ...
    m_aIMLOptions = std::forward<AIMLOptionsT>(value);
  }
  template <typename AIMLOptionsT = AIMLOptionsOutput>
  DomainStatus& WithAIMLOptions(AIMLOptionsT&& value) {
    SetAIMLOptions(std::forward<AIMLOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DomainStatus& WithUseCase(DomainUseCase value) {
    SetUseCase(value);
    return *this;
  }
  ///@}
  ...
  inline DomainStatus& WithEngineMode(EngineMode value) {
    SetEngineMode(value);
    return *this;
  }
  ///@}
