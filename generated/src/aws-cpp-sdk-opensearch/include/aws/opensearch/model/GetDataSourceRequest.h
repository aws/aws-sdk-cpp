...
namespace Model
{
  ...
  {
  public:
    AWS_OPENSEARCHSERVICE_API GetDataSourceRequest() = default;
    ...
    template<typename DomainNameT = Aws::String>
    GetDataSourceRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
