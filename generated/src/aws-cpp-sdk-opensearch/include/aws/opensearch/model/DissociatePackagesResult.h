...
class DissociatePackagesResult {
 public:
  ...
  template <typename DomainPackageDetailsListT = Aws::Vector<DomainPackageDetails>>
  DissociatePackagesResult& WithDomainPackageDetailsList(DomainPackageDetailsListT&& value) {
  ...
  DissociatePackagesResult& AddDomainPackageDetailsList(DomainPackageDetailsListT&& value) {
    m_domainPackageDetailsListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DissociatePackagesResult& WithRequestId(RequestIdT&& value) {
