...
class ListScheduledActionsRequest : public OpenSearchServiceRequest {
 public:
  AWS_OPENSEARCHSERVICE_API ListScheduledActionsRequest() = default;
  ...
  template <typename DomainNameT = Aws::String>
  ListScheduledActionsRequest& WithDomainName(DomainNameT&& value) {
  ...
  inline ListScheduledActionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
