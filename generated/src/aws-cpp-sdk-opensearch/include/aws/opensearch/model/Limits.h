...
class Limits {
 public:
  ...
  void SetStorageTypes(StorageTypesT&& value) {
    ...
    m_storageTypes = std::forward<StorageTypesT>(value);
  }
  template <typename StorageTypesT = Aws::Vector<StorageType>>
  Limits& WithStorageTypes(StorageTypesT&& value) {
    SetStorageTypes(std::forward<StorageTypesT>(value));
    return *this;
  }
  template <typename StorageTypesT = StorageType>
  Limits& AddStorageTypes(StorageTypesT&& value) {
    m_storageTypesHasBeenSet = true;
    m_storageTypes.emplace_back(std::forward<StorageTypesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceLimits(InstanceLimitsT&& value) {
    ...
    m_instanceLimits = std::forward<InstanceLimitsT>(value);
  }
  template <typename InstanceLimitsT = InstanceLimits>
  Limits& WithInstanceLimits(InstanceLimitsT&& value) {
    SetInstanceLimits(std::forward<InstanceLimitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdditionalLimits(AdditionalLimitsT&& value) {
    ...
    m_additionalLimits = std::forward<AdditionalLimitsT>(value);
  }
  template <typename AdditionalLimitsT = Aws::Vector<AdditionalLimit>>
  Limits& WithAdditionalLimits(AdditionalLimitsT&& value) {
    SetAdditionalLimits(std::forward<AdditionalLimitsT>(value));
    return *this;
  }
  template <typename AdditionalLimitsT = AdditionalLimit>
  Limits& AddAdditionalLimits(AdditionalLimitsT&& value) {
    m_additionalLimitsHasBeenSet = true;
    m_additionalLimits.emplace_back(std::forward<AdditionalLimitsT>(value));
    return *this;
  }
  ///@}
 private:
