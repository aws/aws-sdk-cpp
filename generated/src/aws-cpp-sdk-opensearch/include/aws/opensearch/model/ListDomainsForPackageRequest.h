...
class ListDomainsForPackageRequest : public OpenSearchServiceRequest {
 public:
  ...
  template <typename PackageIDT = Aws::String>
  ListDomainsForPackageRequest& WithPackageID(PackageIDT&& value) {
  ...
  inline ListDomainsForPackageRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDomainsForPackageRequest& WithNextToken(NextTokenT&& value) {
