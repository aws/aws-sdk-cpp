...
class DescribeReservedInstanceOfferingsRequest : public OpenSearchServiceRequest {
 public:
  ...
  template <typename ReservedInstanceOfferingIdT = Aws::String>
  DescribeReservedInstanceOfferingsRequest& WithReservedInstanceOfferingId(ReservedInstanceOfferingIdT&& value) {
  ...
  inline DescribeReservedInstanceOfferingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeReservedInstanceOfferingsRequest& WithNextToken(NextTokenT&& value) {
