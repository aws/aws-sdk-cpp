...
class AvailabilityZoneInfo {
 public:
  ...
  inline void SetZoneStatus(ZoneStatus value) {
    m_zoneStatusHasBeenSet = true;
    m_zoneStatus = value;
  }
  inline AvailabilityZoneInfo& WithZoneStatus(ZoneStatus value) {
    SetZoneStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetConfiguredDataNodeCount(ConfiguredDataNodeCountT&& value) {
    ...
    m_configuredDataNodeCount = std::forward<ConfiguredDataNodeCountT>(value);
  }
  template <typename ConfiguredDataNodeCountT = Aws::String>
  AvailabilityZoneInfo& WithConfiguredDataNodeCount(ConfiguredDataNodeCountT&& value) {
    SetConfiguredDataNodeCount(std::forward<ConfiguredDataNodeCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAvailableDataNodeCount(AvailableDataNodeCountT&& value) {
    ...
    m_availableDataNodeCount = std::forward<AvailableDataNodeCountT>(value);
  }
  template <typename AvailableDataNodeCountT = Aws::String>
  AvailabilityZoneInfo& WithAvailableDataNodeCount(AvailableDataNodeCountT&& value) {
    SetAvailableDataNodeCount(std::forward<AvailableDataNodeCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalShards(TotalShardsT&& value) {
    ...
    m_totalShards = std::forward<TotalShardsT>(value);
  }
  template <typename TotalShardsT = Aws::String>
  AvailabilityZoneInfo& WithTotalShards(TotalShardsT&& value) {
    SetTotalShards(std::forward<TotalShardsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalUnAssignedShards(TotalUnAssignedShardsT&& value) {
    ...
    m_totalUnAssignedShards = std::forward<TotalUnAssignedShardsT>(value);
  }
  template <typename TotalUnAssignedShardsT = Aws::String>
  AvailabilityZoneInfo& WithTotalUnAssignedShards(TotalUnAssignedShardsT&& value) {
    SetTotalUnAssignedShards(std::forward<TotalUnAssignedShardsT>(value));
    return *this;
  }
  ///@}
 private:
