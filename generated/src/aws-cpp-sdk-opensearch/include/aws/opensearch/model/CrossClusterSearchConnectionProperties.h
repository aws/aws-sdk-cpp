...
class CrossClusterSearchConnectionProperties {
 public:
  ...
  inline void SetSkipUnavailable(SkipUnavailableStatus value) {
    m_skipUnavailableHasBeenSet = true;
    m_skipUnavailable = value;
  }
  inline CrossClusterSearchConnectionProperties& WithSkipUnavailable(SkipUnavailableStatus value) {
    SetSkipUnavailable(value);
    return *this;
  }
  ///@}
 private:
