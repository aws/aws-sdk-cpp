...
class GetDirectQueryDataSourceResult {
 public:
  ...
  AWS_OPENSEARCHSERVICE_API GetDirectQueryDataSourceResult& operator=(
  ...
  template <typename DataSourceNameT = Aws::String>
  GetDirectQueryDataSourceResult& WithDataSourceName(DataSourceNameT&& value) {
  ...
  template <typename DataSourceTypeT = DirectQueryDataSourceType>
  GetDirectQueryDataSourceResult& WithDataSourceType(DataSourceTypeT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetDirectQueryDataSourceResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename OpenSearchArnsT = Aws::Vector<Aws::String>>
  GetDirectQueryDataSourceResult& WithOpenSearchArns(OpenSearchArnsT&& value) {
    SetOpenSearchArns(std::forward<OpenSearchArnsT>(value));
    return *this;
  }
  template <typename OpenSearchArnsT = Aws::String>
  GetDirectQueryDataSourceResult& AddOpenSearchArns(OpenSearchArnsT&& value) {
    m_openSearchArnsHasBeenSet = true;
  ...
  template <typename DataSourceArnT = Aws::String>
  GetDirectQueryDataSourceResult& WithDataSourceArn(DataSourceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDirectQueryDataSourceResult& WithRequestId(RequestIdT&& value) {
