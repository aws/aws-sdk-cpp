...
class ListDomainMaintenancesRequest : public OpenSearchServiceRequest {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  ListDomainMaintenancesRequest& WithDomainName(DomainNameT&& value) {
  ...
  inline ListDomainMaintenancesRequest& WithAction(MaintenanceType value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline ListDomainMaintenancesRequest& WithStatus(MaintenanceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListDomainMaintenancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDomainMaintenancesRequest& WithNextToken(NextTokenT&& value) {
