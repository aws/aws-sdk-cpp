...
class ListDomainsForPackageResult {
 public:
  AWS_OPENSEARCHSERVICE_API ListDomainsForPackageResult() = default;
  ...
  template <typename DomainPackageDetailsListT = Aws::Vector<DomainPackageDetails>>
  ListDomainsForPackageResult& WithDomainPackageDetailsList(DomainPackageDetailsListT&& value) {
  ...
  ListDomainsForPackageResult& AddDomainPackageDetailsList(DomainPackageDetailsListT&& value) {
    m_domainPackageDetailsListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDomainsForPackageResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDomainsForPackageResult& WithRequestId(RequestIdT&& value) {
