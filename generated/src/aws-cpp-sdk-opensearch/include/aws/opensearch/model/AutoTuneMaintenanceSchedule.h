...
class AutoTuneMaintenanceSchedule {
 public:
  ...
  void SetCronExpressionForRecurrence(CronExpressionForRecurrenceT&& value) {
    ...
    m_cronExpressionForRecurrence = std::forward<CronExpressionForRecurrenceT>(value);
  }
  template <typename CronExpressionForRecurrenceT = Aws::String>
  AutoTuneMaintenanceSchedule& WithCronExpressionForRecurrence(CronExpressionForRecurrenceT&& value) {
    SetCronExpressionForRecurrence(std::forward<CronExpressionForRecurrenceT>(value));
    return *this;
  }
  ///@}
 private:
