...
class IdentityCenterOptions {
 public:
  ...
  inline IdentityCenterOptions& WithEnabledAPIAccess(bool value) {
  ...
  template <typename IdentityCenterInstanceRegionT = Aws::String>
  IdentityCenterOptions& WithIdentityCenterInstanceRegion(IdentityCenterInstanceRegionT&& value) {
  ...
  inline IdentityCenterOptions& WithSubjectKey(SubjectKeyIdCOption value) {
    SetSubjectKey(value);
    return *this;
  }
  ///@}
  ...
  inline IdentityCenterOptions& WithRolesKey(RolesKeyIdCOption value) {
    SetRolesKey(value);
    return *this;
  }
  ///@}
