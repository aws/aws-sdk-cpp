...
class UpdateDirectQueryDataSourceResult {
 public:
  ...
  AWS_OPENSEARCHSERVICE_API UpdateDirectQueryDataSourceResult& operator=(
  ...
  template <typename DataSourceArnT = Aws::String>
  UpdateDirectQueryDataSourceResult& WithDataSourceArn(DataSourceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDirectQueryDataSourceResult& WithRequestId(RequestIdT&& value) {
