...
/**
 */
class UpdateIndexRequest : public OpenSearchServiceRequest {
 public:
  ...
  ///@{
  /**
   * <p>The updated JSON schema for the index including any changes to mappings,
   * settings, and semantic enrichment configuration.</p>
   */
