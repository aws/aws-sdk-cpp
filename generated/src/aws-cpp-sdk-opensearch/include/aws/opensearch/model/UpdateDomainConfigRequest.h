...
class UpdateDomainConfigRequest : public OpenSearchServiceRequest {
 public:
  ...
  inline UpdateDomainConfigRequest& WithIPAddressType(IPAddressType value) {
  ...
  inline UpdateDomainConfigRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDryRunMode(DryRunMode value) {
    m_dryRunModeHasBeenSet = true;
    m_dryRunMode = value;
  }
  inline UpdateDomainConfigRequest& WithDryRunMode(DryRunMode value) {
    SetDryRunMode(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateDomainConfigRequest& WithUseCase(DomainUseCase value) {
    SetUseCase(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The engine mode for the domain. The engine mode can't be changed after the
   * domain is created. For valid values, see <code>EngineMode</code>.</p>
   */
  ...
  inline UpdateDomainConfigRequest& WithEngineMode(EngineMode value) {
    SetEngineMode(value);
    return *this;
  }
  ///@}
