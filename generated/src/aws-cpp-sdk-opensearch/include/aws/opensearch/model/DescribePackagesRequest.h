...
class DescribePackagesRequest : public OpenSearchServiceRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<DescribePackagesFilter>>
  DescribePackagesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = DescribePackagesFilter>
  DescribePackagesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribePackagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribePackagesRequest& WithNextToken(NextTokenT&& value) {
