...
class DirectQueryDataSourceType {
 public:
  ...
  template <typename CloudWatchLogT = CloudWatchDirectQueryDataSource>
  DirectQueryDataSourceType& WithCloudWatchLog(CloudWatchLogT&& value) {
  ...
  void SetSecurityLake(SecurityLakeT&& value) {
    m_securityLakeHasBeenSet = true;
    m_securityLake = std::forward<SecurityLakeT>(value);
  }
  template <typename SecurityLakeT = SecurityLakeDirectQueryDataSource>
  DirectQueryDataSourceType& WithSecurityLake(SecurityLakeT&& value) {
    SetSecurityLake(std::forward<SecurityLakeT>(value));
    return *this;
  }
  ///@}
 private:
