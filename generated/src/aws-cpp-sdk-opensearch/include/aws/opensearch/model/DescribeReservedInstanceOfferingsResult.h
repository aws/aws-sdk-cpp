...
class DescribeReservedInstanceOfferingsResult {
 public:
  ...
  AWS_OPENSEARCHSERVICE_API DescribeReservedInstanceOfferingsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  DescribeReservedInstanceOfferingsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetReservedInstanceOfferings(ReservedInstanceOfferingsT&& value) {
    m_reservedInstanceOfferingsHasBeenSet = true;
    m_reservedInstanceOfferings = std::forward<ReservedInstanceOfferingsT>(value);
  }
  template <typename ReservedInstanceOfferingsT = Aws::Vector<ReservedInstanceOffering>>
  DescribeReservedInstanceOfferingsResult& WithReservedInstanceOfferings(ReservedInstanceOfferingsT&& value) {
    SetReservedInstanceOfferings(std::forward<ReservedInstanceOfferingsT>(value));
    return *this;
  }
  template <typename ReservedInstanceOfferingsT = ReservedInstanceOffering>
  DescribeReservedInstanceOfferingsResult& AddReservedInstanceOfferings(ReservedInstanceOfferingsT&& value) {
    m_reservedInstanceOfferingsHasBeenSet = true;
    m_reservedInstanceOfferings.emplace_back(std::forward<ReservedInstanceOfferingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeReservedInstanceOfferingsResult& WithRequestId(RequestIdT&& value) {
