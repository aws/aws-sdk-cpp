...
class ClusterConfig {
 public:
  ...
  inline ClusterConfig& WithInstanceType(OpenSearchPartitionInstanceType value) {
  ...
  inline ClusterConfig& WithInstanceCount(int value) {
  ...
  inline ClusterConfig& WithDedicatedMasterEnabled(bool value) {
  ...
  inline ClusterConfig& WithZoneAwarenessEnabled(bool value) {
  ...
  inline void SetDedicatedMasterType(OpenSearchPartitionInstanceType value) {
    m_dedicatedMasterTypeHasBeenSet = true;
    m_dedicatedMasterType = value;
  }
  inline ClusterConfig& WithDedicatedMasterType(OpenSearchPartitionInstanceType value) {
    SetDedicatedMasterType(value);
    return *this;
  }
  ///@}
  ...
  inline ClusterConfig& WithDedicatedMasterCount(int value) {
  ...
  inline ClusterConfig& WithWarmEnabled(bool value) {
  ...
  inline void SetWarmType(OpenSearchWarmPartitionInstanceType value) {
    m_warmTypeHasBeenSet = true;
    m_warmType = value;
  }
  inline ClusterConfig& WithWarmType(OpenSearchWarmPartitionInstanceType value) {
    SetWarmType(value);
    return *this;
  }
  ///@}
  ...
  inline ClusterConfig& WithWarmCount(int value) {
    SetWarmCount(value);
    return *this;
  }
  ///@}
  ...
  void SetColdStorageOptions(ColdStorageOptionsT&& value) {
    ...
    m_coldStorageOptions = std::forward<ColdStorageOptionsT>(value);
  }
  template <typename ColdStorageOptionsT = ColdStorageOptions>
  ClusterConfig& WithColdStorageOptions(ColdStorageOptionsT&& value) {
    SetColdStorageOptions(std::forward<ColdStorageOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMultiAZWithStandbyEnabled(bool value) {
    m_multiAZWithStandbyEnabledHasBeenSet = true;
    m_multiAZWithStandbyEnabled = value;
  }
  inline ClusterConfig& WithMultiAZWithStandbyEnabled(bool value) {
    SetMultiAZWithStandbyEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetNodeOptions(NodeOptionsT&& value) {
    ...
    m_nodeOptions = std::forward<NodeOptionsT>(value);
  }
  template <typename NodeOptionsT = Aws::Vector<NodeOption>>
  ClusterConfig& WithNodeOptions(NodeOptionsT&& value) {
    SetNodeOptions(std::forward<NodeOptionsT>(value));
    return *this;
  }
  template <typename NodeOptionsT = NodeOption>
  ClusterConfig& AddNodeOptions(NodeOptionsT&& value) {
    m_nodeOptionsHasBeenSet = true;
    m_nodeOptions.emplace_back(std::forward<NodeOptionsT>(value));
    return *this;
  }
  ///@}
 private:
