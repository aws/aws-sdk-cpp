 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/opensearch-2021-01-01/AutomatedSnapshotPauseRequestOptions">AWS
 * API Reference</a></p>
 */
class AutomatedSnapshotPauseRequestOptions {
 public:
  AWS_OPENSEARCHSERVICE_API AutomatedSnapshotPauseRequestOptions() = default;
  AWS_OPENSEARCHSERVICE_API AutomatedSnapshotPauseRequestOptions(Aws::Utils::Json::JsonView jsonValue);
  AWS_OPENSEARCHSERVICE_API AutomatedSnapshotPauseRequestOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
