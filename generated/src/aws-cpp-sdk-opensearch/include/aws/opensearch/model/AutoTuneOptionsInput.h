...
class AutoTuneOptionsInput {
 public:
  ...
  inline AutoTuneOptionsInput& WithDesiredState(AutoTuneDesiredState value) {
  ...
  template <typename MaintenanceSchedulesT = Aws::Vector<AutoTuneMaintenanceSchedule>>
  AutoTuneOptionsInput& WithMaintenanceSchedules(MaintenanceSchedulesT&& value) {
  ...
  AutoTuneOptionsInput& AddMaintenanceSchedules(MaintenanceSchedulesT&& value) {
    m_maintenanceSchedulesHasBeenSet = true;
  ...
  inline AutoTuneOptionsInput& WithUseOffPeakWindow(bool value) {
