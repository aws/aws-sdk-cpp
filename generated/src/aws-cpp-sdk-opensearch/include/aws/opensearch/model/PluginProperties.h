...
class PluginProperties {
 public:
  ...
  inline void SetUncompressedSizeInBytes(long long value) {
    m_uncompressedSizeInBytesHasBeenSet = true;
    m_uncompressedSizeInBytes = value;
  }
  inline PluginProperties& WithUncompressedSizeInBytes(long long value) {
    SetUncompressedSizeInBytes(value);
    return *this;
  }
  ///@}
 private:
