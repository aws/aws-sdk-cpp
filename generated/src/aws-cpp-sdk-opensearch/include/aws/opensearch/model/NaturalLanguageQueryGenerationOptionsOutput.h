...
class NaturalLanguageQueryGenerationOptionsOutput {
 public:
  ...
  inline void SetDesiredState(NaturalLanguageQueryGenerationDesiredState value) {
    m_desiredStateHasBeenSet = true;
    m_desiredState = value;
  }
  inline NaturalLanguageQueryGenerationOptionsOutput& WithDesiredState(NaturalLanguageQueryGenerationDesiredState value) {
  ...
  inline void SetCurrentState(NaturalLanguageQueryGenerationCurrentState value) {
    m_currentStateHasBeenSet = true;
    m_currentState = value;
  }
  inline NaturalLanguageQueryGenerationOptionsOutput& WithCurrentState(NaturalLanguageQueryGenerationCurrentState value) {
