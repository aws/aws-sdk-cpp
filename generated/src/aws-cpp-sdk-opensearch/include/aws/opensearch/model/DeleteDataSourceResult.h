...
namespace Model
{
  ...
  {
  public:
    AWS_OPENSEARCHSERVICE_API DeleteDataSourceResult() = default;
    ...
    template<typename MessageT = Aws::String>
    DeleteDataSourceResult& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
