...
class ListDirectQueryDataSourcesResult {
 public:
  ...
  AWS_OPENSEARCHSERVICE_API ListDirectQueryDataSourcesResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListDirectQueryDataSourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetDirectQueryDataSources(DirectQueryDataSourcesT&& value) {
    m_directQueryDataSourcesHasBeenSet = true;
    m_directQueryDataSources = std::forward<DirectQueryDataSourcesT>(value);
  }
  template <typename DirectQueryDataSourcesT = Aws::Vector<DirectQueryDataSource>>
  ListDirectQueryDataSourcesResult& WithDirectQueryDataSources(DirectQueryDataSourcesT&& value) {
    SetDirectQueryDataSources(std::forward<DirectQueryDataSourcesT>(value));
    return *this;
  }
  template <typename DirectQueryDataSourcesT = DirectQueryDataSource>
  ListDirectQueryDataSourcesResult& AddDirectQueryDataSources(DirectQueryDataSourcesT&& value) {
    m_directQueryDataSourcesHasBeenSet = true;
    m_directQueryDataSources.emplace_back(std::forward<DirectQueryDataSourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListDirectQueryDataSourcesResult& WithRequestId(RequestIdT&& value) {
