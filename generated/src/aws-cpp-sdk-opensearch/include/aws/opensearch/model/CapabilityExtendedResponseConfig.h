...
/**
 * <p>The extended configuration returned for a registered capability, including
 * additional details beyond the base configuration.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/opensearch-2021-01-01/CapabilityExtendedResponseConfig">AWS
 * API Reference</a></p>
 */
