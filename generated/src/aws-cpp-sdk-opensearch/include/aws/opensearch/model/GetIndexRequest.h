...
/**
 */
class GetIndexRequest : public OpenSearchServiceRequest {
 public:
  AWS_OPENSEARCHSERVICE_API GetIndexRequest() = default;
  ...
  template <typename DomainNameT = Aws::String>
  GetIndexRequest& WithDomainName(DomainNameT&& value) {
