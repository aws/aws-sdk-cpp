...
class UpdatePackageScopeResult {
 public:
  ...
  inline void SetOperation(PackageScopeOperationEnum value) {
    m_operationHasBeenSet = true;
    m_operation = value;
  }
  inline UpdatePackageScopeResult& WithOperation(PackageScopeOperationEnum value) {
    SetOperation(value);
    return *this;
  }
  ///@}
