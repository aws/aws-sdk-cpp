...
class PackageAssociationConfiguration {
 public:
  ...
  void SetKeyStoreAccessOption(KeyStoreAccessOptionT&& value) {
    m_keyStoreAccessOptionHasBeenSet = true;
    m_keyStoreAccessOption = std::forward<KeyStoreAccessOptionT>(value);
  }
  template <typename KeyStoreAccessOptionT = KeyStoreAccessOption>
  PackageAssociationConfiguration& WithKeyStoreAccessOption(KeyStoreAccessOptionT&& value) {
    SetKeyStoreAccessOption(std::forward<KeyStoreAccessOptionT>(value));
    return *this;
  }
  ///@}
 private:
