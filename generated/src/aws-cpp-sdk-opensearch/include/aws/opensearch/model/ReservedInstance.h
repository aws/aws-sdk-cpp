...
class ReservedInstance {
 public:
  ...
  void SetReservedInstanceId(ReservedInstanceIdT&& value) {
    ...
    m_reservedInstanceId = std::forward<ReservedInstanceIdT>(value);
  }
  template <typename ReservedInstanceIdT = Aws::String>
  ReservedInstance& WithReservedInstanceId(ReservedInstanceIdT&& value) {
    SetReservedInstanceId(std::forward<ReservedInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBillingSubscriptionId(long long value) {
    m_billingSubscriptionIdHasBeenSet = true;
    m_billingSubscriptionId = value;
  }
  inline ReservedInstance& WithBillingSubscriptionId(long long value) {
    SetBillingSubscriptionId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceType(OpenSearchPartitionInstanceType value) {
    m_instanceTypeHasBeenSet = true;
    m_instanceType = value;
  }
  inline ReservedInstance& WithInstanceType(OpenSearchPartitionInstanceType value) {
  ...
  inline ReservedInstance& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstance& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstance& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstance& WithInstanceCount(int value) {
  ...
  inline void SetPaymentOption(ReservedInstancePaymentOption value) {
    m_paymentOptionHasBeenSet = true;
    m_paymentOption = value;
  }
  inline ReservedInstance& WithPaymentOption(ReservedInstancePaymentOption value) {
