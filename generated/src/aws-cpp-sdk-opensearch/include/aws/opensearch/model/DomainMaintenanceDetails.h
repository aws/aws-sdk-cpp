...
class DomainMaintenanceDetails {
 public:
  ...
  template <typename MaintenanceIdT = Aws::String>
  DomainMaintenanceDetails& WithMaintenanceId(MaintenanceIdT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  DomainMaintenanceDetails& WithDomainName(DomainNameT&& value) {
  ...
  inline DomainMaintenanceDetails& WithAction(MaintenanceType value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename NodeIdT = Aws::String>
  DomainMaintenanceDetails& WithNodeId(NodeIdT&& value) {
  ...
  inline DomainMaintenanceDetails& WithStatus(MaintenanceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  DomainMaintenanceDetails& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  DomainMaintenanceDetails& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  DomainMaintenanceDetails& WithUpdatedAt(UpdatedAtT&& value) {
