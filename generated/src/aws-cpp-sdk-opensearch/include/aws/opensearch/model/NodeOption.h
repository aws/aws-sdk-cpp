...
class NodeOption {
 public:
  ...
  inline void SetNodeType(NodeOptionsNodeType value) {
    m_nodeTypeHasBeenSet = true;
    m_nodeType = value;
  }
  inline NodeOption& WithNodeType(NodeOptionsNodeType value) {
    SetNodeType(value);
    return *this;
  }
  ///@}
  ...
  void SetNodeConfig(NodeConfigT&& value) {
    ...
    m_nodeConfig = std::forward<NodeConfigT>(value);
  }
  template <typename NodeConfigT = NodeConfig>
  NodeOption& WithNodeConfig(NodeConfigT&& value) {
    SetNodeConfig(std::forward<NodeConfigT>(value));
    return *this;
  }
  ///@}
 private:
