...
class StorageType {
 public:
  ...
  void SetStorageTypeName(StorageTypeNameT&& value) {
    m_storageTypeNameHasBeenSet = true;
    m_storageTypeName = std::forward<StorageTypeNameT>(value);
  }
  template <typename StorageTypeNameT = Aws::String>
  StorageType& WithStorageTypeName(StorageTypeNameT&& value) {
    SetStorageTypeName(std::forward<StorageTypeNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStorageSubTypeName(StorageSubTypeNameT&& value) {
    m_storageSubTypeNameHasBeenSet = true;
    m_storageSubTypeName = std::forward<StorageSubTypeNameT>(value);
  }
  template <typename StorageSubTypeNameT = Aws::String>
  StorageType& WithStorageSubTypeName(StorageSubTypeNameT&& value) {
    SetStorageSubTypeName(std::forward<StorageSubTypeNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStorageTypeLimits(StorageTypeLimitsT&& value) {
    m_storageTypeLimitsHasBeenSet = true;
    m_storageTypeLimits = std::forward<StorageTypeLimitsT>(value);
  }
  template <typename StorageTypeLimitsT = Aws::Vector<StorageTypeLimit>>
  StorageType& WithStorageTypeLimits(StorageTypeLimitsT&& value) {
    SetStorageTypeLimits(std::forward<StorageTypeLimitsT>(value));
    return *this;
  }
  template <typename StorageTypeLimitsT = StorageTypeLimit>
  StorageType& AddStorageTypeLimits(StorageTypeLimitsT&& value) {
    m_storageTypeLimitsHasBeenSet = true;
    m_storageTypeLimits.emplace_back(std::forward<StorageTypeLimitsT>(value));
    return *this;
  }
  ///@}
 private:
