...
class OptionStatus {
 public:
  ...
  inline OptionStatus& WithUpdateVersion(int value) {
  ...
  inline void SetState(OptionState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline OptionStatus& WithState(OptionState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline OptionStatus& WithPendingDeletion(bool value) {
