...
class AddDirectQueryDataSourceResult {
 public:
  ...
  AWS_OPENSEARCHSERVICE_API AddDirectQueryDataSourceResult& operator=(
  ...
  template <typename DataSourceArnT = Aws::String>
  AddDirectQueryDataSourceResult& WithDataSourceArn(DataSourceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AddDirectQueryDataSourceResult& WithRequestId(RequestIdT&& value) {
