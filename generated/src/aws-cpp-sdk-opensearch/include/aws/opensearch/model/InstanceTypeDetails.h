...
class InstanceTypeDetails {
 public:
  ...
  inline InstanceTypeDetails& WithInstanceType(OpenSearchPartitionInstanceType value) {
  ...
  inline InstanceTypeDetails& WithEncryptionEnabled(bool value) {
  ...
  inline void SetCognitoEnabled(bool value) {
    m_cognitoEnabledHasBeenSet = true;
    m_cognitoEnabled = value;
  }
  inline InstanceTypeDetails& WithCognitoEnabled(bool value) {
    SetCognitoEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAppLogsEnabled(bool value) {
    m_appLogsEnabledHasBeenSet = true;
    m_appLogsEnabled = value;
  }
  inline InstanceTypeDetails& WithAppLogsEnabled(bool value) {
    SetAppLogsEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAdvancedSecurityEnabled(bool value) {
    m_advancedSecurityEnabledHasBeenSet = true;
    m_advancedSecurityEnabled = value;
  }
  inline InstanceTypeDetails& WithAdvancedSecurityEnabled(bool value) {
    SetAdvancedSecurityEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceTypeDetails& WithWarmEnabled(bool value) {
  ...
  void SetInstanceRole(InstanceRoleT&& value) {
    ...
    m_instanceRole = std::forward<InstanceRoleT>(value);
  }
  template <typename InstanceRoleT = Aws::Vector<Aws::String>>
  InstanceTypeDetails& WithInstanceRole(InstanceRoleT&& value) {
    SetInstanceRole(std::forward<InstanceRoleT>(value));
    return *this;
  }
  template <typename InstanceRoleT = Aws::String>
  InstanceTypeDetails& AddInstanceRole(InstanceRoleT&& value) {
    m_instanceRoleHasBeenSet = true;
    m_instanceRole.emplace_back(std::forward<InstanceRoleT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  InstanceTypeDetails& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  InstanceTypeDetails& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
