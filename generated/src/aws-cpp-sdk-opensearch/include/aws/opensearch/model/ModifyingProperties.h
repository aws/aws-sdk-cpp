...
class ModifyingProperties {
 public:
  ...
  void SetPendingValue(PendingValueT&& value) {
    ...
    m_pendingValue = std::forward<PendingValueT>(value);
  }
  template <typename PendingValueT = Aws::String>
  ModifyingProperties& WithPendingValue(PendingValueT&& value) {
    SetPendingValue(std::forward<PendingValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetValueType(PropertyValueType value) {
    m_valueTypeHasBeenSet = true;
    m_valueType = value;
  }
  inline ModifyingProperties& WithValueType(PropertyValueType value) {
    SetValueType(value);
    return *this;
  }
  ///@}
