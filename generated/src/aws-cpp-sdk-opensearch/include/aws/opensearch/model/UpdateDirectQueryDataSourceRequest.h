...
class UpdateDirectQueryDataSourceRequest : public OpenSearchServiceRequest {
 public:
  ...
  template <typename DataSourceNameT = Aws::String>
  UpdateDirectQueryDataSourceRequest& WithDataSourceName(DataSourceNameT&& value) {
  ...
  template <typename DataSourceTypeT = DirectQueryDataSourceType>
  UpdateDirectQueryDataSourceRequest& WithDataSourceType(DataSourceTypeT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateDirectQueryDataSourceRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename OpenSearchArnsT = Aws::Vector<Aws::String>>
  UpdateDirectQueryDataSourceRequest& WithOpenSearchArns(OpenSearchArnsT&& value) {
    SetOpenSearchArns(std::forward<OpenSearchArnsT>(value));
    return *this;
  }
  template <typename OpenSearchArnsT = Aws::String>
  UpdateDirectQueryDataSourceRequest& AddOpenSearchArns(OpenSearchArnsT&& value) {
    m_openSearchArnsHasBeenSet = true;
