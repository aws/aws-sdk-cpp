...
class DescribeDomainAutoTunesResult {
 public:
  ...
  AWS_OPENSEARCHSERVICE_API DescribeDomainAutoTunesResult& operator=(
  ...
  void SetAutoTunes(AutoTunesT&& value) {
    m_autoTunesHasBeenSet = true;
    m_autoTunes = std::forward<AutoTunesT>(value);
  }
  template <typename AutoTunesT = Aws::Vector<AutoTune>>
  DescribeDomainAutoTunesResult& WithAutoTunes(AutoTunesT&& value) {
    SetAutoTunes(std::forward<AutoTunesT>(value));
    return *this;
  }
  template <typename AutoTunesT = AutoTune>
  DescribeDomainAutoTunesResult& AddAutoTunes(AutoTunesT&& value) {
    m_autoTunesHasBeenSet = true;
    m_autoTunes.emplace_back(std::forward<AutoTunesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDomainAutoTunesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDomainAutoTunesResult& WithRequestId(RequestIdT&& value) {
