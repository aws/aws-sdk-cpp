...
class DescribeDomainHealthResult {
 public:
  ...
  inline void SetDomainState(DomainState value) {
    m_domainStateHasBeenSet = true;
    m_domainState = value;
  }
  inline DescribeDomainHealthResult& WithDomainState(DomainState value) {
  ...
  void SetAvailabilityZoneCount(AvailabilityZoneCountT&& value) {
    ...
    m_availabilityZoneCount = std::forward<AvailabilityZoneCountT>(value);
  }
  template <typename AvailabilityZoneCountT = Aws::String>
  DescribeDomainHealthResult& WithAvailabilityZoneCount(AvailabilityZoneCountT&& value) {
    SetAvailabilityZoneCount(std::forward<AvailabilityZoneCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActiveAvailabilityZoneCount(ActiveAvailabilityZoneCountT&& value) {
    ...
    m_activeAvailabilityZoneCount = std::forward<ActiveAvailabilityZoneCountT>(value);
  }
  template <typename ActiveAvailabilityZoneCountT = Aws::String>
  DescribeDomainHealthResult& WithActiveAvailabilityZoneCount(ActiveAvailabilityZoneCountT&& value) {
    SetActiveAvailabilityZoneCount(std::forward<ActiveAvailabilityZoneCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStandByAvailabilityZoneCount(StandByAvailabilityZoneCountT&& value) {
    ...
    m_standByAvailabilityZoneCount = std::forward<StandByAvailabilityZoneCountT>(value);
  }
  template <typename StandByAvailabilityZoneCountT = Aws::String>
  DescribeDomainHealthResult& WithStandByAvailabilityZoneCount(StandByAvailabilityZoneCountT&& value) {
    SetStandByAvailabilityZoneCount(std::forward<StandByAvailabilityZoneCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataNodeCount(DataNodeCountT&& value) {
    ...
    m_dataNodeCount = std::forward<DataNodeCountT>(value);
  }
  template <typename DataNodeCountT = Aws::String>
  DescribeDomainHealthResult& WithDataNodeCount(DataNodeCountT&& value) {
    SetDataNodeCount(std::forward<DataNodeCountT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDedicatedMaster(bool value) {
    m_dedicatedMasterHasBeenSet = true;
    m_dedicatedMaster = value;
  }
  inline DescribeDomainHealthResult& WithDedicatedMaster(bool value) {
    SetDedicatedMaster(value);
    return *this;
  }
  ///@}
  ...
  void SetMasterEligibleNodeCount(MasterEligibleNodeCountT&& value) {
    ...
    m_masterEligibleNodeCount = std::forward<MasterEligibleNodeCountT>(value);
  }
  template <typename MasterEligibleNodeCountT = Aws::String>
  DescribeDomainHealthResult& WithMasterEligibleNodeCount(MasterEligibleNodeCountT&& value) {
    SetMasterEligibleNodeCount(std::forward<MasterEligibleNodeCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWarmNodeCount(WarmNodeCountT&& value) {
    ...
    m_warmNodeCount = std::forward<WarmNodeCountT>(value);
  }
  template <typename WarmNodeCountT = Aws::String>
  DescribeDomainHealthResult& WithWarmNodeCount(WarmNodeCountT&& value) {
    SetWarmNodeCount(std::forward<WarmNodeCountT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMasterNode(MasterNodeStatus value) {
    m_masterNodeHasBeenSet = true;
    m_masterNode = value;
  }
  inline DescribeDomainHealthResult& WithMasterNode(MasterNodeStatus value) {
    SetMasterNode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetClusterHealth(DomainHealth value) {
    m_clusterHealthHasBeenSet = true;
    m_clusterHealth = value;
  }
  inline DescribeDomainHealthResult& WithClusterHealth(DomainHealth value) {
    SetClusterHealth(value);
    return *this;
  }
  ///@}
  ...
  void SetEnvironmentInformation(EnvironmentInformationT&& value) {
    ...
    m_environmentInformation = std::forward<EnvironmentInformationT>(value);
  }
  template <typename EnvironmentInformationT = Aws::Vector<EnvironmentInfo>>
  DescribeDomainHealthResult& WithEnvironmentInformation(EnvironmentInformationT&& value) {
    SetEnvironmentInformation(std::forward<EnvironmentInformationT>(value));
    return *this;
  }
  ...
  DescribeDomainHealthResult& AddEnvironmentInformation(EnvironmentInformationT&& value) {
    m_environmentInformationHasBeenSet = true;
    m_environmentInformation.emplace_back(std::forward<EnvironmentInformationT>(value));
    return *this;
  }
  ///@}
