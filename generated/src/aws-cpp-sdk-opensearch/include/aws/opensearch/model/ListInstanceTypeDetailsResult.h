...
class ListInstanceTypeDetailsResult {
 public:
  ...
  AWS_OPENSEARCHSERVICE_API ListInstanceTypeDetailsResult& operator=(
  ...
  template <typename InstanceTypeDetailsT = Aws::Vector<InstanceTypeDetails>>
  ListInstanceTypeDetailsResult& WithInstanceTypeDetails(InstanceTypeDetailsT&& value) {
    SetInstanceTypeDetails(std::forward<InstanceTypeDetailsT>(value));
    return *this;
  }
  template <typename InstanceTypeDetailsT = InstanceTypeDetails>
  ListInstanceTypeDetailsResult& AddInstanceTypeDetails(InstanceTypeDetailsT&& value) {
    m_instanceTypeDetailsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListInstanceTypeDetailsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInstanceTypeDetailsResult& WithRequestId(RequestIdT&& value) {
