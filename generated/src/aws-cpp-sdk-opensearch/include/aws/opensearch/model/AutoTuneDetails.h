...
class AutoTuneDetails {
 public:
  ...
  void SetScheduledAutoTuneDetails(ScheduledAutoTuneDetailsT&& value) {
    m_scheduledAutoTuneDetailsHasBeenSet = true;
    m_scheduledAutoTuneDetails = std::forward<ScheduledAutoTuneDetailsT>(value);
  }
  template <typename ScheduledAutoTuneDetailsT = ScheduledAutoTuneDetails>
  AutoTuneDetails& WithScheduledAutoTuneDetails(ScheduledAutoTuneDetailsT&& value) {
    SetScheduledAutoTuneDetails(std::forward<ScheduledAutoTuneDetailsT>(value));
    return *this;
  }
  ///@}
 private:
