...
class KeyStoreAccessOption {
 public:
  ...
  void SetKeyAccessRoleArn(KeyAccessRoleArnT&& value) {
    m_keyAccessRoleArnHasBeenSet = true;
    m_keyAccessRoleArn = std::forward<KeyAccessRoleArnT>(value);
  }
  template <typename KeyAccessRoleArnT = Aws::String>
  KeyStoreAccessOption& WithKeyAccessRoleArn(KeyAccessRoleArnT&& value) {
    SetKeyAccessRoleArn(std::forward<KeyAccessRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetKeyStoreAccessEnabled(bool value) {
    m_keyStoreAccessEnabledHasBeenSet = true;
    m_keyStoreAccessEnabled = value;
  }
  inline KeyStoreAccessOption& WithKeyStoreAccessEnabled(bool value) {
    SetKeyStoreAccessEnabled(value);
    return *this;
  }
  ///@}
 private:
