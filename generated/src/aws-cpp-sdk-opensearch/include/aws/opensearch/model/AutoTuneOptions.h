...
class AutoTuneOptions {
 public:
  ...
  inline void SetDesiredState(AutoTuneDesiredState value) {
    m_desiredStateHasBeenSet = true;
    m_desiredState = value;
  }
  inline AutoTuneOptions& WithDesiredState(AutoTuneDesiredState value) {
  ...
  inline void SetRollbackOnDisable(RollbackOnDisable value) {
    m_rollbackOnDisableHasBeenSet = true;
    m_rollbackOnDisable = value;
  }
  inline AutoTuneOptions& WithRollbackOnDisable(RollbackOnDisable value) {
    SetRollbackOnDisable(value);
    return *this;
  }
  ///@}
  ...
  void SetMaintenanceSchedules(MaintenanceSchedulesT&& value) {
    m_maintenanceSchedulesHasBeenSet = true;
    m_maintenanceSchedules = std::forward<MaintenanceSchedulesT>(value);
  }
  template <typename MaintenanceSchedulesT = Aws::Vector<AutoTuneMaintenanceSchedule>>
  AutoTuneOptions& WithMaintenanceSchedules(MaintenanceSchedulesT&& value) {
    SetMaintenanceSchedules(std::forward<MaintenanceSchedulesT>(value));
    return *this;
  }
  template <typename MaintenanceSchedulesT = AutoTuneMaintenanceSchedule>
  AutoTuneOptions& AddMaintenanceSchedules(MaintenanceSchedulesT&& value) {
    m_maintenanceSchedulesHasBeenSet = true;
    m_maintenanceSchedules.emplace_back(std::forward<MaintenanceSchedulesT>(value));
    return *this;
  }
  ///@}
  ...
  inline AutoTuneOptions& WithUseOffPeakWindow(bool value) {
