...
class CancelDomainConfigChangeResult {
 public:
  ...
  AWS_OPENSEARCHSERVICE_API CancelDomainConfigChangeResult& operator=(
  ...
  void SetCancelledChangeIds(CancelledChangeIdsT&& value) {
    ...
    m_cancelledChangeIds = std::forward<CancelledChangeIdsT>(value);
  }
  template <typename CancelledChangeIdsT = Aws::Vector<Aws::String>>
  CancelDomainConfigChangeResult& WithCancelledChangeIds(CancelledChangeIdsT&& value) {
    SetCancelledChangeIds(std::forward<CancelledChangeIdsT>(value));
    return *this;
  }
  ...
  CancelDomainConfigChangeResult& AddCancelledChangeIds(CancelledChangeIdsT&& value) {
    m_cancelledChangeIdsHasBeenSet = true;
    m_cancelledChangeIds.emplace_back(std::forward<CancelledChangeIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCancelledChangeProperties(CancelledChangePropertiesT&& value) {
    ...
    m_cancelledChangeProperties = std::forward<CancelledChangePropertiesT>(value);
  }
  template <typename CancelledChangePropertiesT = Aws::Vector<CancelledChangeProperty>>
  CancelDomainConfigChangeResult& WithCancelledChangeProperties(CancelledChangePropertiesT&& value) {
    SetCancelledChangeProperties(std::forward<CancelledChangePropertiesT>(value));
    return *this;
  }
  ...
  CancelDomainConfigChangeResult& AddCancelledChangeProperties(CancelledChangePropertiesT&& value) {
    m_cancelledChangePropertiesHasBeenSet = true;
    m_cancelledChangeProperties.emplace_back(std::forward<CancelledChangePropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline CancelDomainConfigChangeResult& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
