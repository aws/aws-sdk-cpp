...
class AWS_OPENSEARCHSERVICE_API OpenSearchServiceClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  OpenSearchServiceClient(const Aws::OpenSearchService::OpenSearchServiceClientConfiguration& clientConfiguration =
  ...
  OpenSearchServiceClient(const Aws::Auth::AWSCredentials& credentials,
                          std::shared_ptr<OpenSearchServiceEndpointProviderBase> endpointProvider = nullptr,
                          const Aws::OpenSearchService::OpenSearchServiceClientConfiguration& clientConfiguration =
                              Aws::OpenSearchService::OpenSearchServiceClientConfiguration());
  ...
  /**
   * A Callable wrapper for AcceptInboundConnection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AcceptInboundConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptInboundConnectionRequestT = Model::AcceptInboundConnectionRequest>
  void AcceptInboundConnectionAsync(const AcceptInboundConnectionRequestT& request,
                                    const AcceptInboundConnectionResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for AddDataSource that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddDataSourceRequestT = Model::AddDataSourceRequest>
  void AddDataSourceAsync(const AddDataSourceRequestT& request, const AddDataSourceResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AddDirectQueryDataSource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddDirectQueryDataSource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddDirectQueryDataSourceRequestT = Model::AddDirectQueryDataSourceRequest>
  void AddDirectQueryDataSourceAsync(const AddDirectQueryDataSourceRequestT& request,
                                     const AddDirectQueryDataSourceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociatePackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociatePackage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociatePackageRequestT = Model::AssociatePackageRequest>
  void AssociatePackageAsync(const AssociatePackageRequestT& request, const AssociatePackageResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociatePackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociatePackages that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociatePackagesRequestT = Model::AssociatePackagesRequest>
  void AssociatePackagesAsync(const AssociatePackagesRequestT& request, const AssociatePackagesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&OpenSearchServiceClient::AssociatePackages, request, handler, context);
  }

  /**
   * <p>Attaches a data source to an OpenSearch application. The data source must be
   * an Amazon OpenSearch Service domain. If both the application and the data source
   * are active, the attachment completes immediately with a status of
   * <code>ATTACHED</code>. Otherwise, the operation returns <code>PENDING</code> and
   * completes the attachment automatically once both become active. If the
   * attachment cannot be completed, its status becomes <code>FAILED</code>. This
   * operation is idempotent: If the data source is already attached or pending, the
   * operation returns the existing attachment.</p><p><h3>See Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::AuthorizeVpcEndpointAccessOutcome AuthorizeVpcEndpointAccess(
      const Model::AuthorizeVpcEndpointAccessRequest& request) const;

  /**
   * A Callable wrapper for AuthorizeVpcEndpointAccess that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AuthorizeVpcEndpointAccessRequestT = Model::AuthorizeVpcEndpointAccessRequest>
  Model::AuthorizeVpcEndpointAccessOutcomeCallable AuthorizeVpcEndpointAccessCallable(
      const AuthorizeVpcEndpointAccessRequestT& request) const {
    return SubmitCallable(&OpenSearchServiceClient::AuthorizeVpcEndpointAccess, request);
  }

  /**
   * An Async wrapper for AuthorizeVpcEndpointAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AuthorizeVpcEndpointAccessRequestT = Model::AuthorizeVpcEndpointAccessRequest>
  void AuthorizeVpcEndpointAccessAsync(const AuthorizeVpcEndpointAccessRequestT& request,
                                       const AuthorizeVpcEndpointAccessResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelDomainConfigChange that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelDomainConfigChange that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelDomainConfigChangeRequestT = Model::CancelDomainConfigChangeRequest>
  void CancelDomainConfigChangeAsync(const CancelDomainConfigChangeRequestT& request,
                                     const CancelDomainConfigChangeResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CancelServiceSoftwareUpdateOutcome CancelServiceSoftwareUpdate(
      const Model::CancelServiceSoftwareUpdateRequest& request) const;

  /**
   * A Callable wrapper for CancelServiceSoftwareUpdate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CancelServiceSoftwareUpdateRequestT = Model::CancelServiceSoftwareUpdateRequest>
  Model::CancelServiceSoftwareUpdateOutcomeCallable CancelServiceSoftwareUpdateCallable(
      const CancelServiceSoftwareUpdateRequestT& request) const {
    return SubmitCallable(&OpenSearchServiceClient::CancelServiceSoftwareUpdate, request);
  }

  /**
   * An Async wrapper for CancelServiceSoftwareUpdate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelServiceSoftwareUpdateRequestT = Model::CancelServiceSoftwareUpdateRequest>
  void CancelServiceSoftwareUpdateAsync(const CancelServiceSoftwareUpdateRequestT& request,
                                        const CancelServiceSoftwareUpdateResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateOutboundConnection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateOutboundConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateOutboundConnectionRequestT = Model::CreateOutboundConnectionRequest>
  void CreateOutboundConnectionAsync(const CreateOutboundConnectionRequestT& request,
                                     const CreateOutboundConnectionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreatePackage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreatePackageRequestT = Model::CreatePackageRequest>
  void CreatePackageAsync(const CreatePackageRequestT& request, const CreatePackageResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDirectQueryDataSourceOutcome DeleteDirectQueryDataSource(
      const Model::DeleteDirectQueryDataSourceRequest& request) const;

  /**
   * A Callable wrapper for DeleteDirectQueryDataSource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDirectQueryDataSourceRequestT = Model::DeleteDirectQueryDataSourceRequest>
  Model::DeleteDirectQueryDataSourceOutcomeCallable DeleteDirectQueryDataSourceCallable(
      const DeleteDirectQueryDataSourceRequestT& request) const {
    return SubmitCallable(&OpenSearchServiceClient::DeleteDirectQueryDataSource, request);
  }

  /**
   * An Async wrapper for DeleteDirectQueryDataSource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDirectQueryDataSourceRequestT = Model::DeleteDirectQueryDataSourceRequest>
  void DeleteDirectQueryDataSourceAsync(const DeleteDirectQueryDataSourceRequestT& request,
                                        const DeleteDirectQueryDataSourceResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteInboundConnection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInboundConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteInboundConnectionRequestT = Model::DeleteInboundConnectionRequest>
  void DeleteInboundConnectionAsync(const DeleteInboundConnectionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteOutboundConnection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteOutboundConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteOutboundConnectionRequestT = Model::DeleteOutboundConnectionRequest>
  void DeleteOutboundConnectionAsync(const DeleteOutboundConnectionRequestT& request,
                                     const DeleteOutboundConnectionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeletePackage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePackageRequestT = Model::DeletePackageRequest>
  void DeletePackageAsync(const DeletePackageRequestT& request, const DeletePackageResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDomainAutoTunes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDomainAutoTunes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDomainAutoTunesRequestT = Model::DescribeDomainAutoTunesRequest>
  void DescribeDomainAutoTunesAsync(const DescribeDomainAutoTunesRequestT& request,
                                    const DescribeDomainAutoTunesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDomainChangeProgressOutcome DescribeDomainChangeProgress(
      const Model::DescribeDomainChangeProgressRequest& request) const;

  /**
   * A Callable wrapper for DescribeDomainChangeProgress that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDomainChangeProgressRequestT = Model::DescribeDomainChangeProgressRequest>
  Model::DescribeDomainChangeProgressOutcomeCallable DescribeDomainChangeProgressCallable(
      const DescribeDomainChangeProgressRequestT& request) const {
    return SubmitCallable(&OpenSearchServiceClient::DescribeDomainChangeProgress, request);
  }

  /**
   * An Async wrapper for DescribeDomainChangeProgress that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDomainChangeProgressRequestT = Model::DescribeDomainChangeProgressRequest>
  void DescribeDomainChangeProgressAsync(const DescribeDomainChangeProgressRequestT& request,
                                         const DescribeDomainChangeProgressResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDomainConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDomainConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDomainConfigRequestT = Model::DescribeDomainConfigRequest>
  void DescribeDomainConfigAsync(const DescribeDomainConfigRequestT& request, const DescribeDomainConfigResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDomainHealth that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDomainHealth that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDomainHealthRequestT = Model::DescribeDomainHealthRequest>
  void DescribeDomainHealthAsync(const DescribeDomainHealthRequestT& request, const DescribeDomainHealthResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDomainNodes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDomainNodes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDomainNodesRequestT = Model::DescribeDomainNodesRequest>
  void DescribeDomainNodesAsync(const DescribeDomainNodesRequestT& request, const DescribeDomainNodesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeDomains that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeDomainsRequestT = Model::DescribeDomainsRequest>
  void DescribeDomainsAsync(const DescribeDomainsRequestT& request, const DescribeDomainsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDryRunProgress that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDryRunProgress that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDryRunProgressRequestT = Model::DescribeDryRunProgressRequest>
  void DescribeDryRunProgressAsync(const DescribeDryRunProgressRequestT& request,
                                   const DescribeDryRunProgressResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeInboundConnectionsOutcome DescribeInboundConnections(
      const Model::DescribeInboundConnectionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeInboundConnections that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInboundConnectionsRequestT = Model::DescribeInboundConnectionsRequest>
  Model::DescribeInboundConnectionsOutcomeCallable DescribeInboundConnectionsCallable(
      const DescribeInboundConnectionsRequestT& request = {}) const {
    return SubmitCallable(&OpenSearchServiceClient::DescribeInboundConnections, request);
  }

  /**
   * An Async wrapper for DescribeInboundConnections that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInboundConnectionsRequestT = Model::DescribeInboundConnectionsRequest>
  void DescribeInboundConnectionsAsync(const DescribeInboundConnectionsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInstanceTypeLimitsOutcome DescribeInstanceTypeLimits(
      const Model::DescribeInstanceTypeLimitsRequest& request) const;

  /**
   * A Callable wrapper for DescribeInstanceTypeLimits that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInstanceTypeLimitsRequestT = Model::DescribeInstanceTypeLimitsRequest>
  Model::DescribeInstanceTypeLimitsOutcomeCallable DescribeInstanceTypeLimitsCallable(
      const DescribeInstanceTypeLimitsRequestT& request) const {
    return SubmitCallable(&OpenSearchServiceClient::DescribeInstanceTypeLimits, request);
  }

  /**
   * An Async wrapper for DescribeInstanceTypeLimits that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstanceTypeLimitsRequestT = Model::DescribeInstanceTypeLimitsRequest>
  void DescribeInstanceTypeLimitsAsync(const DescribeInstanceTypeLimitsRequestT& request,
                                       const DescribeInstanceTypeLimitsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeOutboundConnectionsOutcome DescribeOutboundConnections(
      const Model::DescribeOutboundConnectionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeOutboundConnections that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeOutboundConnectionsRequestT = Model::DescribeOutboundConnectionsRequest>
  Model::DescribeOutboundConnectionsOutcomeCallable DescribeOutboundConnectionsCallable(
      const DescribeOutboundConnectionsRequestT& request = {}) const {
    return SubmitCallable(&OpenSearchServiceClient::DescribeOutboundConnections, request);
  }

  /**
   * An Async wrapper for DescribeOutboundConnections that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeOutboundConnectionsRequestT = Model::DescribeOutboundConnectionsRequest>
  void DescribeOutboundConnectionsAsync(const DescribeOutboundConnectionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeOutboundConnectionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribePackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePackages that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePackagesRequestT = Model::DescribePackagesRequest>
  void DescribePackagesAsync(const DescribePackagesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DescribePackagesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReservedInstanceOfferingsOutcome DescribeReservedInstanceOfferings(
      const Model::DescribeReservedInstanceOfferingsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReservedInstanceOfferings that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeReservedInstanceOfferingsRequestT = Model::DescribeReservedInstanceOfferingsRequest>
  Model::DescribeReservedInstanceOfferingsOutcomeCallable DescribeReservedInstanceOfferingsCallable(
      const DescribeReservedInstanceOfferingsRequestT& request = {}) const {
    return SubmitCallable(&OpenSearchServiceClient::DescribeReservedInstanceOfferings, request);
  }

  /**
   * An Async wrapper for DescribeReservedInstanceOfferings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeReservedInstanceOfferingsRequestT = Model::DescribeReservedInstanceOfferingsRequest>
  void DescribeReservedInstanceOfferingsAsync(const DescribeReservedInstanceOfferingsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeReservedInstanceOfferingsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReservedInstancesOutcome DescribeReservedInstances(
      const Model::DescribeReservedInstancesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReservedInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeReservedInstancesRequestT = Model::DescribeReservedInstancesRequest>
  Model::DescribeReservedInstancesOutcomeCallable DescribeReservedInstancesCallable(
      const DescribeReservedInstancesRequestT& request = {}) const {
    return SubmitCallable(&OpenSearchServiceClient::DescribeReservedInstances, request);
  }

  /**
   * An Async wrapper for DescribeReservedInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReservedInstancesRequestT = Model::DescribeReservedInstancesRequest>
  void DescribeReservedInstancesAsync(const DescribeReservedInstancesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeReservedInstancesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeVpcEndpoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeVpcEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeVpcEndpointsRequestT = Model::DescribeVpcEndpointsRequest>
  void DescribeVpcEndpointsAsync(const DescribeVpcEndpointsRequestT& request, const DescribeVpcEndpointsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DissociatePackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DissociatePackage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DissociatePackageRequestT = Model::DissociatePackageRequest>
  void DissociatePackageAsync(const DissociatePackageRequestT& request, const DissociatePackageResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DissociatePackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DissociatePackages that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DissociatePackagesRequestT = Model::DissociatePackagesRequest>
  void DissociatePackagesAsync(const DissociatePackagesRequestT& request, const DissociatePackagesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCompatibleVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCompatibleVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCompatibleVersionsRequestT = Model::GetCompatibleVersionsRequest>
  void GetCompatibleVersionsAsync(const GetCompatibleVersionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const GetCompatibleVersionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetDirectQueryDataSource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDirectQueryDataSource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDirectQueryDataSourceRequestT = Model::GetDirectQueryDataSourceRequest>
  void GetDirectQueryDataSourceAsync(const GetDirectQueryDataSourceRequestT& request,
                                     const GetDirectQueryDataSourceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDomainMaintenanceStatusOutcome GetDomainMaintenanceStatus(
      const Model::GetDomainMaintenanceStatusRequest& request) const;

  /**
   * A Callable wrapper for GetDomainMaintenanceStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDomainMaintenanceStatusRequestT = Model::GetDomainMaintenanceStatusRequest>
  Model::GetDomainMaintenanceStatusOutcomeCallable GetDomainMaintenanceStatusCallable(
      const GetDomainMaintenanceStatusRequestT& request) const {
    return SubmitCallable(&OpenSearchServiceClient::GetDomainMaintenanceStatus, request);
  }

  /**
   * An Async wrapper for GetDomainMaintenanceStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDomainMaintenanceStatusRequestT = Model::GetDomainMaintenanceStatusRequest>
  void GetDomainMaintenanceStatusAsync(const GetDomainMaintenanceStatusRequestT& request,
  ...
  /**
   * A Callable wrapper for GetPackageVersionHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPackageVersionHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPackageVersionHistoryRequestT = Model::GetPackageVersionHistoryRequest>
  void GetPackageVersionHistoryAsync(const GetPackageVersionHistoryRequestT& request,
                                     const GetPackageVersionHistoryResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetUpgradeHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetUpgradeHistory that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetUpgradeHistoryRequestT = Model::GetUpgradeHistoryRequest>
  void GetUpgradeHistoryAsync(const GetUpgradeHistoryRequestT& request, const GetUpgradeHistoryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetUpgradeStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetUpgradeStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetUpgradeStatusRequestT = Model::GetUpgradeStatusRequest>
  void GetUpgradeStatusAsync(const GetUpgradeStatusRequestT& request, const GetUpgradeStatusResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDirectQueryDataSourcesOutcome ListDirectQueryDataSources(
      const Model::ListDirectQueryDataSourcesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDirectQueryDataSources that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDirectQueryDataSourcesRequestT = Model::ListDirectQueryDataSourcesRequest>
  Model::ListDirectQueryDataSourcesOutcomeCallable ListDirectQueryDataSourcesCallable(
      const ListDirectQueryDataSourcesRequestT& request = {}) const {
    return SubmitCallable(&OpenSearchServiceClient::ListDirectQueryDataSources, request);
  }

  /**
   * An Async wrapper for ListDirectQueryDataSources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDirectQueryDataSourcesRequestT = Model::ListDirectQueryDataSourcesRequest>
  void ListDirectQueryDataSourcesAsync(const ListDirectQueryDataSourcesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListDirectQueryDataSourcesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDomainMaintenances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDomainMaintenances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDomainMaintenancesRequestT = Model::ListDomainMaintenancesRequest>
  void ListDomainMaintenancesAsync(const ListDomainMaintenancesRequestT& request,
                                   const ListDomainMaintenancesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDomainsForPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDomainsForPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDomainsForPackageRequestT = Model::ListDomainsForPackageRequest>
  ...
  /**
   * A Callable wrapper for ListInstanceTypeDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInstanceTypeDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInstanceTypeDetailsRequestT = Model::ListInstanceTypeDetailsRequest>
  void ListInstanceTypeDetailsAsync(const ListInstanceTypeDetailsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListPackagesForDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPackagesForDomain that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPackagesForDomainRequestT = Model::ListPackagesForDomainRequest>
  void ListPackagesForDomainAsync(const ListPackagesForDomainRequestT& request, const ListPackagesForDomainResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListScheduledActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListScheduledActions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListScheduledActionsRequestT = Model::ListScheduledActionsRequest>
  void ListScheduledActionsAsync(const ListScheduledActionsRequestT& request, const ListScheduledActionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListVpcEndpointAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListVpcEndpointAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVpcEndpointAccessRequestT = Model::ListVpcEndpointAccessRequest>
  void ListVpcEndpointAccessAsync(const ListVpcEndpointAccessRequestT& request, const ListVpcEndpointAccessResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListVpcEndpointsForDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListVpcEndpointsForDomainRequestT = Model::ListVpcEndpointsForDomainRequest>
  Model::ListVpcEndpointsForDomainOutcomeCallable ListVpcEndpointsForDomainCallable(
      const ListVpcEndpointsForDomainRequestT& request) const {
    return SubmitCallable(&OpenSearchServiceClient::ListVpcEndpointsForDomain, request);
  }

  /**
   * An Async wrapper for ListVpcEndpointsForDomain that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVpcEndpointsForDomainRequestT = Model::ListVpcEndpointsForDomainRequest>
  void ListVpcEndpointsForDomainAsync(const ListVpcEndpointsForDomainRequestT& request,
                                      const ListVpcEndpointsForDomainResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PurchaseReservedInstanceOfferingOutcome PurchaseReservedInstanceOffering(
      const Model::PurchaseReservedInstanceOfferingRequest& request) const;

  /**
   * A Callable wrapper for PurchaseReservedInstanceOffering that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PurchaseReservedInstanceOfferingRequestT = Model::PurchaseReservedInstanceOfferingRequest>
  Model::PurchaseReservedInstanceOfferingOutcomeCallable PurchaseReservedInstanceOfferingCallable(
      const PurchaseReservedInstanceOfferingRequestT& request) const {
    return SubmitCallable(&OpenSearchServiceClient::PurchaseReservedInstanceOffering, request);
  }

  /**
   * An Async wrapper for PurchaseReservedInstanceOffering that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PurchaseReservedInstanceOfferingRequestT = Model::PurchaseReservedInstanceOfferingRequest>
  void PurchaseReservedInstanceOfferingAsync(const PurchaseReservedInstanceOfferingRequestT& request,
  ...
  /**
   * A Callable wrapper for RejectInboundConnection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RejectInboundConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RejectInboundConnectionRequestT = Model::RejectInboundConnectionRequest>
  void RejectInboundConnectionAsync(const RejectInboundConnectionRequestT& request,
                                    const RejectInboundConnectionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RevokeVpcEndpointAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RevokeVpcEndpointAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RevokeVpcEndpointAccessRequestT = Model::RevokeVpcEndpointAccessRequest>
  void RevokeVpcEndpointAccessAsync(const RevokeVpcEndpointAccessRequestT& request,
                                    const RevokeVpcEndpointAccessResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartDomainMaintenance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartDomainMaintenance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartDomainMaintenanceRequestT = Model::StartDomainMaintenanceRequest>
  void StartDomainMaintenanceAsync(const StartDomainMaintenanceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StartServiceSoftwareUpdateOutcome StartServiceSoftwareUpdate(
      const Model::StartServiceSoftwareUpdateRequest& request) const;

  /**
   * A Callable wrapper for StartServiceSoftwareUpdate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartServiceSoftwareUpdateRequestT = Model::StartServiceSoftwareUpdateRequest>
  Model::StartServiceSoftwareUpdateOutcomeCallable StartServiceSoftwareUpdateCallable(
      const StartServiceSoftwareUpdateRequestT& request) const {
    return SubmitCallable(&OpenSearchServiceClient::StartServiceSoftwareUpdate, request);
  }

  /**
   * An Async wrapper for StartServiceSoftwareUpdate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartServiceSoftwareUpdateRequestT = Model::StartServiceSoftwareUpdateRequest>
  void StartServiceSoftwareUpdateAsync(const StartServiceSoftwareUpdateRequestT& request,
                                       const StartServiceSoftwareUpdateResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDirectQueryDataSourceOutcome UpdateDirectQueryDataSource(
      const Model::UpdateDirectQueryDataSourceRequest& request) const;

  /**
   * A Callable wrapper for UpdateDirectQueryDataSource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateDirectQueryDataSourceRequestT = Model::UpdateDirectQueryDataSourceRequest>
  Model::UpdateDirectQueryDataSourceOutcomeCallable UpdateDirectQueryDataSourceCallable(
      const UpdateDirectQueryDataSourceRequestT& request) const {
    return SubmitCallable(&OpenSearchServiceClient::UpdateDirectQueryDataSource, request);
  }

  /**
   * An Async wrapper for UpdateDirectQueryDataSource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDirectQueryDataSourceRequestT = Model::UpdateDirectQueryDataSourceRequest>
  void UpdateDirectQueryDataSourceAsync(const UpdateDirectQueryDataSourceRequestT& request,
                                        const UpdateDirectQueryDataSourceResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDomainConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDomainConfig that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDomainConfigRequestT = Model::UpdateDomainConfigRequest>
  ...
  /**
   * An Async wrapper for UpdatePackage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdatePackageRequestT = Model::UpdatePackageRequest>
  void UpdatePackageAsync(const UpdatePackageRequestT& request, const UpdatePackageResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePackageScope that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePackageScope that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdatePackageScopeRequestT = Model::UpdatePackageScopeRequest>
  void UpdatePackageScopeAsync(const UpdatePackageScopeRequestT& request, const UpdatePackageScopeResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateScheduledAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateScheduledAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateScheduledActionRequestT = Model::UpdateScheduledActionRequest>
  void UpdateScheduledActionAsync(const UpdateScheduledActionRequestT& request, const UpdateScheduledActionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpgradeDomain that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpgradeDomainRequestT = Model::UpgradeDomainRequest>
  void UpgradeDomainAsync(const UpgradeDomainRequestT& request, const UpgradeDomainResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
