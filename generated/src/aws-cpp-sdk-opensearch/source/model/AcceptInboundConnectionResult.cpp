...
AcceptInboundConnectionResult::AcceptInboundConnectionResult()
{
}

AcceptInboundConnectionResult::AcceptInboundConnectionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
