...
PackageDetails::PackageDetails(JsonView jsonValue) { *this = jsonValue; }
...
PackageDetails& PackageDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AllowListedUserList")) {
    ...
    for (unsigned allowListedUserListIndex = 0; allowListedUserListIndex < allowListedUserListJsonList.GetLength();
         ++allowListedUserListIndex) {
