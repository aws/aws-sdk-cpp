...
StartServiceSoftwareUpdateResult::StartServiceSoftwareUpdateResult()
{
}

StartServiceSoftwareUpdateResult::StartServiceSoftwareUpdateResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
