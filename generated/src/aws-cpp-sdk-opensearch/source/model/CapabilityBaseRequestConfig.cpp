...
CapabilityBaseRequestConfig::CapabilityBaseRequestConfig(JsonView jsonValue) { *this = jsonValue; }

CapabilityBaseRequestConfig& CapabilityBaseRequestConfig::operator=(JsonView jsonValue) {
...
JsonValue CapabilityBaseRequestConfig::Jsonize() const {
  JsonValue payload;
