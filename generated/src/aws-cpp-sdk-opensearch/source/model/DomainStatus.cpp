...
DomainStatus::DomainStatus(JsonView jsonValue) { *this = jsonValue; }
...
DomainStatus& DomainStatus::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DomainProcessingStatus")) {
    m_domainProcessingStatus =
        DomainProcessingStatusTypeMapper::GetDomainProcessingStatusTypeForName(jsonValue.GetString("DomainProcessingStatus"));
  ...
  if (jsonValue.ValueExists("ModifyingProperties")) {
    ...
    for (unsigned modifyingPropertiesIndex = 0; modifyingPropertiesIndex < modifyingPropertiesJsonList.GetLength();
         ++modifyingPropertiesIndex) {
...
JsonValue DomainStatus::Jsonize() const {
  ...
  if (m_domainProcessingStatusHasBeenSet) {
    payload.WithString("DomainProcessingStatus",
                       DomainProcessingStatusTypeMapper::GetNameForDomainProcessingStatusType(m_domainProcessingStatus));
  }
