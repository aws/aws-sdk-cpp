  ...
  namespace OpenSearchService
  {
    namespace Model
    {
      namespace OpenSearchPartitionInstanceTypeMapper
      {
        ...
        static constexpr uint32_t m3_medium_search_HASH = ConstExprHashingUtils::HashString("m3.medium.search");
        static constexpr uint32_t m3_large_search_HASH = ConstExprHashingUtils::HashString("m3.large.search");
        static constexpr uint32_t m3_xlarge_search_HASH = ConstExprHashingUtils::HashString("m3.xlarge.search");
        static constexpr uint32_t m3_2xlarge_search_HASH = ConstExprHashingUtils::HashString("m3.2xlarge.search");
        static constexpr uint32_t m4_large_search_HASH = ConstExprHashingUtils::HashString("m4.large.search");
        static constexpr uint32_t m4_xlarge_search_HASH = ConstExprHashingUtils::HashString("m4.xlarge.search");
        static constexpr uint32_t m4_2xlarge_search_HASH = ConstExprHashingUtils::HashString("m4.2xlarge.search");
        static constexpr uint32_t m4_4xlarge_search_HASH = ConstExprHashingUtils::HashString("m4.4xlarge.search");
        static constexpr uint32_t m4_10xlarge_search_HASH = ConstExprHashingUtils::HashString("m4.10xlarge.search");
        static constexpr uint32_t m5_large_search_HASH = ConstExprHashingUtils::HashString("m5.large.search");
        static constexpr uint32_t m5_xlarge_search_HASH = ConstExprHashingUtils::HashString("m5.xlarge.search");
        static constexpr uint32_t m5_2xlarge_search_HASH = ConstExprHashingUtils::HashString("m5.2xlarge.search");
        static constexpr uint32_t m5_4xlarge_search_HASH = ConstExprHashingUtils::HashString("m5.4xlarge.search");
        static constexpr uint32_t m5_12xlarge_search_HASH = ConstExprHashingUtils::HashString("m5.12xlarge.search");
        static constexpr uint32_t m5_24xlarge_search_HASH = ConstExprHashingUtils::HashString("m5.24xlarge.search");
        static constexpr uint32_t r5_large_search_HASH = ConstExprHashingUtils::HashString("r5.large.search");
        static constexpr uint32_t r5_xlarge_search_HASH = ConstExprHashingUtils::HashString("r5.xlarge.search");
        static constexpr uint32_t r5_2xlarge_search_HASH = ConstExprHashingUtils::HashString("r5.2xlarge.search");
        static constexpr uint32_t r5_4xlarge_search_HASH = ConstExprHashingUtils::HashString("r5.4xlarge.search");
        static constexpr uint32_t r5_12xlarge_search_HASH = ConstExprHashingUtils::HashString("r5.12xlarge.search");
        static constexpr uint32_t r5_24xlarge_search_HASH = ConstExprHashingUtils::HashString("r5.24xlarge.search");
        static constexpr uint32_t c5_large_search_HASH = ConstExprHashingUtils::HashString("c5.large.search");
        static constexpr uint32_t c5_xlarge_search_HASH = ConstExprHashingUtils::HashString("c5.xlarge.search");
        static constexpr uint32_t c5_2xlarge_search_HASH = ConstExprHashingUtils::HashString("c5.2xlarge.search");
        static constexpr uint32_t c5_4xlarge_search_HASH = ConstExprHashingUtils::HashString("c5.4xlarge.search");
        static constexpr uint32_t c5_9xlarge_search_HASH = ConstExprHashingUtils::HashString("c5.9xlarge.search");
        static constexpr uint32_t c5_18xlarge_search_HASH = ConstExprHashingUtils::HashString("c5.18xlarge.search");
        static constexpr uint32_t t3_nano_search_HASH = ConstExprHashingUtils::HashString("t3.nano.search");
        static constexpr uint32_t t3_micro_search_HASH = ConstExprHashingUtils::HashString("t3.micro.search");
        static constexpr uint32_t t3_small_search_HASH = ConstExprHashingUtils::HashString("t3.small.search");
        static constexpr uint32_t t3_medium_search_HASH = ConstExprHashingUtils::HashString("t3.medium.search");
        static constexpr uint32_t t3_large_search_HASH = ConstExprHashingUtils::HashString("t3.large.search");
        static constexpr uint32_t t3_xlarge_search_HASH = ConstExprHashingUtils::HashString("t3.xlarge.search");
        static constexpr uint32_t t3_2xlarge_search_HASH = ConstExprHashingUtils::HashString("t3.2xlarge.search");
        ...
        static constexpr uint32_t t2_micro_search_HASH = ConstExprHashingUtils::HashString("t2.micro.search");
        static constexpr uint32_t t2_small_search_HASH = ConstExprHashingUtils::HashString("t2.small.search");
        static constexpr uint32_t t2_medium_search_HASH = ConstExprHashingUtils::HashString("t2.medium.search");
        static constexpr uint32_t r3_large_search_HASH = ConstExprHashingUtils::HashString("r3.large.search");
        static constexpr uint32_t r3_xlarge_search_HASH = ConstExprHashingUtils::HashString("r3.xlarge.search");
        static constexpr uint32_t r3_2xlarge_search_HASH = ConstExprHashingUtils::HashString("r3.2xlarge.search");
        static constexpr uint32_t r3_4xlarge_search_HASH = ConstExprHashingUtils::HashString("r3.4xlarge.search");
        static constexpr uint32_t r3_8xlarge_search_HASH = ConstExprHashingUtils::HashString("r3.8xlarge.search");
        static constexpr uint32_t i2_xlarge_search_HASH = ConstExprHashingUtils::HashString("i2.xlarge.search");
        static constexpr uint32_t i2_2xlarge_search_HASH = ConstExprHashingUtils::HashString("i2.2xlarge.search");
        static constexpr uint32_t d2_xlarge_search_HASH = ConstExprHashingUtils::HashString("d2.xlarge.search");
        static constexpr uint32_t d2_2xlarge_search_HASH = ConstExprHashingUtils::HashString("d2.2xlarge.search");
        static constexpr uint32_t d2_4xlarge_search_HASH = ConstExprHashingUtils::HashString("d2.4xlarge.search");
        static constexpr uint32_t d2_8xlarge_search_HASH = ConstExprHashingUtils::HashString("d2.8xlarge.search");
        static constexpr uint32_t c4_large_search_HASH = ConstExprHashingUtils::HashString("c4.large.search");
        static constexpr uint32_t c4_xlarge_search_HASH = ConstExprHashingUtils::HashString("c4.xlarge.search");
        static constexpr uint32_t c4_2xlarge_search_HASH = ConstExprHashingUtils::HashString("c4.2xlarge.search");
        static constexpr uint32_t c4_4xlarge_search_HASH = ConstExprHashingUtils::HashString("c4.4xlarge.search");
        static constexpr uint32_t c4_8xlarge_search_HASH = ConstExprHashingUtils::HashString("c4.8xlarge.search");
        static constexpr uint32_t r4_large_search_HASH = ConstExprHashingUtils::HashString("r4.large.search");
        static constexpr uint32_t r4_xlarge_search_HASH = ConstExprHashingUtils::HashString("r4.xlarge.search");
        static constexpr uint32_t r4_2xlarge_search_HASH = ConstExprHashingUtils::HashString("r4.2xlarge.search");
        static constexpr uint32_t r4_4xlarge_search_HASH = ConstExprHashingUtils::HashString("r4.4xlarge.search");
        static constexpr uint32_t r4_8xlarge_search_HASH = ConstExprHashingUtils::HashString("r4.8xlarge.search");
        static constexpr uint32_t r4_16xlarge_search_HASH = ConstExprHashingUtils::HashString("r4.16xlarge.search");
        static constexpr uint32_t i3_large_search_HASH = ConstExprHashingUtils::HashString("i3.large.search");
        static constexpr uint32_t i3_xlarge_search_HASH = ConstExprHashingUtils::HashString("i3.xlarge.search");
        static constexpr uint32_t i3_2xlarge_search_HASH = ConstExprHashingUtils::HashString("i3.2xlarge.search");
        static constexpr uint32_t i3_4xlarge_search_HASH = ConstExprHashingUtils::HashString("i3.4xlarge.search");
        static constexpr uint32_t i3_8xlarge_search_HASH = ConstExprHashingUtils::HashString("i3.8xlarge.search");
        static constexpr uint32_t i3_16xlarge_search_HASH = ConstExprHashingUtils::HashString("i3.16xlarge.search");
        static constexpr uint32_t r6g_large_search_HASH = ConstExprHashingUtils::HashString("r6g.large.search");
        static constexpr uint32_t r6g_xlarge_search_HASH = ConstExprHashingUtils::HashString("r6g.xlarge.search");
        static constexpr uint32_t r6g_2xlarge_search_HASH = ConstExprHashingUtils::HashString("r6g.2xlarge.search");
        static constexpr uint32_t r6g_4xlarge_search_HASH = ConstExprHashingUtils::HashString("r6g.4xlarge.search");
        static constexpr uint32_t r6g_8xlarge_search_HASH = ConstExprHashingUtils::HashString("r6g.8xlarge.search");
        static constexpr uint32_t r6g_12xlarge_search_HASH = ConstExprHashingUtils::HashString("r6g.12xlarge.search");
        static constexpr uint32_t m6g_large_search_HASH = ConstExprHashingUtils::HashString("m6g.large.search");
        static constexpr uint32_t m6g_xlarge_search_HASH = ConstExprHashingUtils::HashString("m6g.xlarge.search");
        static constexpr uint32_t m6g_2xlarge_search_HASH = ConstExprHashingUtils::HashString("m6g.2xlarge.search");
        static constexpr uint32_t m6g_4xlarge_search_HASH = ConstExprHashingUtils::HashString("m6g.4xlarge.search");
        static constexpr uint32_t m6g_8xlarge_search_HASH = ConstExprHashingUtils::HashString("m6g.8xlarge.search");
        static constexpr uint32_t m6g_12xlarge_search_HASH = ConstExprHashingUtils::HashString("m6g.12xlarge.search");
        static constexpr uint32_t c6g_large_search_HASH = ConstExprHashingUtils::HashString("c6g.large.search");
        static constexpr uint32_t c6g_xlarge_search_HASH = ConstExprHashingUtils::HashString("c6g.xlarge.search");
        static constexpr uint32_t c6g_2xlarge_search_HASH = ConstExprHashingUtils::HashString("c6g.2xlarge.search");
        static constexpr uint32_t c6g_4xlarge_search_HASH = ConstExprHashingUtils::HashString("c6g.4xlarge.search");
        static constexpr uint32_t c6g_8xlarge_search_HASH = ConstExprHashingUtils::HashString("c6g.8xlarge.search");
        static constexpr uint32_t c6g_12xlarge_search_HASH = ConstExprHashingUtils::HashString("c6g.12xlarge.search");
        static constexpr uint32_t r6gd_large_search_HASH = ConstExprHashingUtils::HashString("r6gd.large.search");
        static constexpr uint32_t r6gd_xlarge_search_HASH = ConstExprHashingUtils::HashString("r6gd.xlarge.search");
        static constexpr uint32_t r6gd_2xlarge_search_HASH = ConstExprHashingUtils::HashString("r6gd.2xlarge.search");
        static constexpr uint32_t r6gd_4xlarge_search_HASH = ConstExprHashingUtils::HashString("r6gd.4xlarge.search");
        static constexpr uint32_t r6gd_8xlarge_search_HASH = ConstExprHashingUtils::HashString("r6gd.8xlarge.search");
        static constexpr uint32_t r6gd_12xlarge_search_HASH = ConstExprHashingUtils::HashString("r6gd.12xlarge.search");
        static constexpr uint32_t r6gd_16xlarge_search_HASH = ConstExprHashingUtils::HashString("r6gd.16xlarge.search");
        static constexpr uint32_t t4g_small_search_HASH = ConstExprHashingUtils::HashString("t4g.small.search");
        static constexpr uint32_t t4g_medium_search_HASH = ConstExprHashingUtils::HashString("t4g.medium.search");
