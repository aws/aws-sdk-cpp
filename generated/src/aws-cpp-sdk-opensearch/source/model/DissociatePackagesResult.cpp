...
DissociatePackagesResult::DissociatePackagesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DissociatePackagesResult& DissociatePackagesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("DomainPackageDetailsList")) {
    ...
    for (unsigned domainPackageDetailsListIndex = 0; domainPackageDetailsListIndex < domainPackageDetailsListJsonList.GetLength();
         ++domainPackageDetailsListIndex) {
