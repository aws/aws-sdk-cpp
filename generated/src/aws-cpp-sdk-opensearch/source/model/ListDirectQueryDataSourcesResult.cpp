...
ListDirectQueryDataSourcesResult::ListDirectQueryDataSourcesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListDirectQueryDataSourcesResult& ListDirectQueryDataSourcesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("DirectQueryDataSources")) {
    ...
    for (unsigned directQueryDataSourcesIndex = 0; directQueryDataSourcesIndex < directQueryDataSourcesJsonList.GetLength();
         ++directQueryDataSourcesIndex) {
