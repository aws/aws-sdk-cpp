...
ChangeProgressStatusDetails::ChangeProgressStatusDetails(JsonView jsonValue) { *this = jsonValue; }
...
ChangeProgressStatusDetails& ChangeProgressStatusDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("CompletedProperties")) {
    ...
    for (unsigned completedPropertiesIndex = 0; completedPropertiesIndex < completedPropertiesJsonList.GetLength();
         ++completedPropertiesIndex) {
