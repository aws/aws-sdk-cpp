...
ClusterConfig::ClusterConfig(JsonView jsonValue) { *this = jsonValue; }
...
ClusterConfig& ClusterConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DedicatedMasterType")) {
    m_dedicatedMasterType =
        OpenSearchPartitionInstanceTypeMapper::GetOpenSearchPartitionInstanceTypeForName(jsonValue.GetString("DedicatedMasterType"));
...
JsonValue ClusterConfig::Jsonize() const {
  ...
  if (m_dedicatedMasterTypeHasBeenSet) {
    payload.WithString("DedicatedMasterType",
                       OpenSearchPartitionInstanceTypeMapper::GetNameForOpenSearchPartitionInstanceType(m_dedicatedMasterType));
  }
