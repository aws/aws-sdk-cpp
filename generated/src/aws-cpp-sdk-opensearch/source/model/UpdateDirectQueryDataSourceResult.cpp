...
UpdateDirectQueryDataSourceResult::UpdateDirectQueryDataSourceResult()
{
}

UpdateDirectQueryDataSourceResult::UpdateDirectQueryDataSourceResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
