...
DescribeDataSourceAttachmentResult::DescribeDataSourceAttachmentResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

DescribeDataSourceAttachmentResult& DescribeDataSourceAttachmentResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
