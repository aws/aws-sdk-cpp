...
{
const size_t OpenSearchServiceEndpointRules::RulesBlobStrLen = 3708;
const size_t OpenSearchServiceEndpointRules::RulesBlobSize = 3709;
...
's',':','/','/','e','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
