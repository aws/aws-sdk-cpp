...
{
const size_t OpenSearchServiceEndpointRules::RulesBlobStrLen = 3502;
const size_t OpenSearchServiceEndpointRules::RulesBlobSize = 3503;
...
'/','e','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
't','t','p','s',':','/','/','e','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
