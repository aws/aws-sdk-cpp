...
class TN3270StepOutput {
 public:
  ...
  void SetDataSetExportLocation(DataSetExportLocationT&& value) {
    m_dataSetExportLocationHasBeenSet = true;
    m_dataSetExportLocation = std::forward<DataSetExportLocationT>(value);
  }
  template <typename DataSetExportLocationT = Aws::String>
  TN3270StepOutput& WithDataSetExportLocation(DataSetExportLocationT&& value) {
    SetDataSetExportLocation(std::forward<DataSetExportLocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDmsOutputLocation(DmsOutputLocationT&& value) {
    m_dmsOutputLocationHasBeenSet = true;
    m_dmsOutputLocation = std::forward<DmsOutputLocationT>(value);
  }
  template <typename DmsOutputLocationT = Aws::String>
  TN3270StepOutput& WithDmsOutputLocation(DmsOutputLocationT&& value) {
    SetDmsOutputLocation(std::forward<DmsOutputLocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataSetDetails(DataSetDetailsT&& value) {
    m_dataSetDetailsHasBeenSet = true;
    m_dataSetDetails = std::forward<DataSetDetailsT>(value);
  }
  template <typename DataSetDetailsT = Aws::Vector<DataSet>>
  TN3270StepOutput& WithDataSetDetails(DataSetDetailsT&& value) {
    SetDataSetDetails(std::forward<DataSetDetailsT>(value));
    return *this;
  }
  template <typename DataSetDetailsT = DataSet>
  TN3270StepOutput& AddDataSetDetails(DataSetDetailsT&& value) {
    m_dataSetDetailsHasBeenSet = true;
    m_dataSetDetails.emplace_back(std::forward<DataSetDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScriptOutputLocation(ScriptOutputLocationT&& value) {
    m_scriptOutputLocationHasBeenSet = true;
    m_scriptOutputLocation = std::forward<ScriptOutputLocationT>(value);
  }
  template <typename ScriptOutputLocationT = Aws::String>
  TN3270StepOutput& WithScriptOutputLocation(ScriptOutputLocationT&& value) {
    SetScriptOutputLocation(std::forward<ScriptOutputLocationT>(value));
    return *this;
  }
  ///@}
 private:
