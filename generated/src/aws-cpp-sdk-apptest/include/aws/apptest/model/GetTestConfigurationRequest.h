...
class GetTestConfigurationRequest : public AppTestRequest {
 public:
  ...
  template <typename TestConfigurationIdT = Aws::String>
  GetTestConfigurationRequest& WithTestConfigurationId(TestConfigurationIdT&& value) {
  ...
  inline GetTestConfigurationRequest& WithTestConfigurationVersion(int value) {
