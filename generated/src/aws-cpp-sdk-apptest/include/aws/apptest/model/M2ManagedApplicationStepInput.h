...
class M2ManagedApplicationStepInput {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  M2ManagedApplicationStepInput& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename RuntimeT = Aws::String>
  M2ManagedApplicationStepInput& WithRuntime(RuntimeT&& value) {
  ...
  template <typename VpcEndpointServiceNameT = Aws::String>
  M2ManagedApplicationStepInput& WithVpcEndpointServiceName(VpcEndpointServiceNameT&& value) {
  ...
  inline M2ManagedApplicationStepInput& WithListenerPort(int value) {
  ...
  inline M2ManagedApplicationStepInput& WithActionType(M2ManagedActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PropertiesT = M2ManagedActionProperties>
  M2ManagedApplicationStepInput& WithProperties(PropertiesT&& value) {
