...
class GetTestConfigurationResult {
 public:
  ...
  template <typename TestConfigurationIdT = Aws::String>
  GetTestConfigurationResult& WithTestConfigurationId(TestConfigurationIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetTestConfigurationResult& WithName(NameT&& value) {
  ...
  template <typename TestConfigurationArnT = Aws::String>
  GetTestConfigurationResult& WithTestConfigurationArn(TestConfigurationArnT&& value) {
  ...
  template <typename LatestVersionT = TestConfigurationLatestVersion>
  GetTestConfigurationResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  inline GetTestConfigurationResult& WithTestConfigurationVersion(int value) {
  ...
  inline GetTestConfigurationResult& WithStatus(TestConfigurationLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  GetTestConfigurationResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetTestConfigurationResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  GetTestConfigurationResult& WithLastUpdateTime(LastUpdateTimeT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetTestConfigurationResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<Resource>>
  GetTestConfigurationResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Resource>
  GetTestConfigurationResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename PropertiesT = Aws::Map<Aws::String, Aws::String>>
  GetTestConfigurationResult& WithProperties(PropertiesT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetTestConfigurationResult& WithTags(TagsT&& value) {
  ...
  template <typename ServiceSettingsT = ServiceSettings>
  GetTestConfigurationResult& WithServiceSettings(ServiceSettingsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTestConfigurationResult& WithRequestId(RequestIdT&& value) {
