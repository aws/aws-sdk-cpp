...
class CompareDatabaseCDCStepInput {
 public:
  ...
  template <typename SourceLocationT = Aws::String>
  CompareDatabaseCDCStepInput& WithSourceLocation(SourceLocationT&& value) {
  ...
  void SetTargetLocation(TargetLocationT&& value) {
    ...
    m_targetLocation = std::forward<TargetLocationT>(value);
  }
  template <typename TargetLocationT = Aws::String>
  CompareDatabaseCDCStepInput& WithTargetLocation(TargetLocationT&& value) {
    SetTargetLocation(std::forward<TargetLocationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OutputLocationT = Aws::String>
  CompareDatabaseCDCStepInput& WithOutputLocation(OutputLocationT&& value) {
  ...
  template <typename SourceMetadataT = SourceDatabaseMetadata>
  CompareDatabaseCDCStepInput& WithSourceMetadata(SourceMetadataT&& value) {
  ...
  void SetTargetMetadata(TargetMetadataT&& value) {
    m_targetMetadataHasBeenSet = true;
    m_targetMetadata = std::forward<TargetMetadataT>(value);
  }
  template <typename TargetMetadataT = TargetDatabaseMetadata>
  CompareDatabaseCDCStepInput& WithTargetMetadata(TargetMetadataT&& value) {
    SetTargetMetadata(std::forward<TargetMetadataT>(value));
    return *this;
  }
  ///@}
 private:
