...
class InputFile {
 public:
  ...
  template <typename SourceLocationT = Aws::String>
  InputFile& WithSourceLocation(SourceLocationT&& value) {
  ...
  template <typename TargetLocationT = Aws::String>
  InputFile& WithTargetLocation(TargetLocationT&& value) {
  ...
  void SetFileMetadata(FileMetadataT&& value) {
    m_fileMetadataHasBeenSet = true;
    m_fileMetadata = std::forward<FileMetadataT>(value);
  }
  template <typename FileMetadataT = FileMetadata>
  InputFile& WithFileMetadata(FileMetadataT&& value) {
    SetFileMetadata(std::forward<FileMetadataT>(value));
    return *this;
  }
  ///@}
 private:
