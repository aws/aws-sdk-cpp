...
class ListTestSuitesRequest : public AppTestRequest {
 public:
  ...
  void SetTestSuiteIds(TestSuiteIdsT&& value) {
    m_testSuiteIdsHasBeenSet = true;
    m_testSuiteIds = std::forward<TestSuiteIdsT>(value);
  }
  template <typename TestSuiteIdsT = Aws::Vector<Aws::String>>
  ListTestSuitesRequest& WithTestSuiteIds(TestSuiteIdsT&& value) {
    SetTestSuiteIds(std::forward<TestSuiteIdsT>(value));
    return *this;
  }
  template <typename TestSuiteIdsT = Aws::String>
  ListTestSuitesRequest& AddTestSuiteIds(TestSuiteIdsT&& value) {
    m_testSuiteIdsHasBeenSet = true;
    m_testSuiteIds.emplace_back(std::forward<TestSuiteIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestSuitesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTestSuitesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
