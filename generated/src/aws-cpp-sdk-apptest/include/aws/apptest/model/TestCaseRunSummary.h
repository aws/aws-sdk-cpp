...
class TestCaseRunSummary {
 public:
  ...
  template <typename TestCaseIdT = Aws::String>
  TestCaseRunSummary& WithTestCaseId(TestCaseIdT&& value) {
  ...
  inline TestCaseRunSummary& WithTestCaseVersion(int value) {
  ...
  template <typename TestRunIdT = Aws::String>
  TestCaseRunSummary& WithTestRunId(TestRunIdT&& value) {
  ...
  inline void SetStatus(TestCaseRunStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline TestCaseRunSummary& WithStatus(TestCaseRunStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  TestCaseRunSummary& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RunStartTimeT = Aws::Utils::DateTime>
  TestCaseRunSummary& WithRunStartTime(RunStartTimeT&& value) {
  ...
  template <typename RunEndTimeT = Aws::Utils::DateTime>
  TestCaseRunSummary& WithRunEndTime(RunEndTimeT&& value) {
