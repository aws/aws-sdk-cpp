...
class ListTestRunTestCasesRequest : public AppTestRequest {
 public:
  ...
  template <typename TestRunIdT = Aws::String>
  ListTestRunTestCasesRequest& WithTestRunId(TestRunIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTestRunTestCasesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTestRunTestCasesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
