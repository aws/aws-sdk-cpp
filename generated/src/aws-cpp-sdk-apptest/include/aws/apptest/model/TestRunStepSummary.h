...
class TestRunStepSummary {
 public:
  ...
  template <typename StepNameT = Aws::String>
  TestRunStepSummary& WithStepName(StepNameT&& value) {
  ...
  template <typename TestRunIdT = Aws::String>
  TestRunStepSummary& WithTestRunId(TestRunIdT&& value) {
  ...
  template <typename TestCaseIdT = Aws::String>
  TestRunStepSummary& WithTestCaseId(TestCaseIdT&& value) {
  ...
  inline TestRunStepSummary& WithTestCaseVersion(int value) {
  ...
  template <typename TestSuiteIdT = Aws::String>
  TestRunStepSummary& WithTestSuiteId(TestSuiteIdT&& value) {
  ...
  inline TestRunStepSummary& WithTestSuiteVersion(int value) {
  ...
  inline TestRunStepSummary& WithBeforeStep(bool value) {
    SetBeforeStep(value);
    return *this;
  }
  ///@}
  ...
  inline TestRunStepSummary& WithAfterStep(bool value) {
    SetAfterStep(value);
    return *this;
  }
  ///@}
  ...
  inline TestRunStepSummary& WithStatus(StepRunStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  TestRunStepSummary& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RunStartTimeT = Aws::Utils::DateTime>
  TestRunStepSummary& WithRunStartTime(RunStartTimeT&& value) {
  ...
  template <typename RunEndTimeT = Aws::Utils::DateTime>
  TestRunStepSummary& WithRunEndTime(RunEndTimeT&& value) {
