...
class TestConfigurationLatestVersion {
 public:
  ...
  inline TestConfigurationLatestVersion& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline TestConfigurationLatestVersion& WithStatus(TestConfigurationLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  TestConfigurationLatestVersion& WithStatusReason(StatusReasonT&& value) {
