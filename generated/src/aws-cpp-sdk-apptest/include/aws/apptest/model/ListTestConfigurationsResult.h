...
class ListTestConfigurationsResult {
 public:
  ...
  void SetTestConfigurations(TestConfigurationsT&& value) {
    m_testConfigurationsHasBeenSet = true;
    m_testConfigurations = std::forward<TestConfigurationsT>(value);
  }
  template <typename TestConfigurationsT = Aws::Vector<TestConfigurationSummary>>
  ListTestConfigurationsResult& WithTestConfigurations(TestConfigurationsT&& value) {
    SetTestConfigurations(std::forward<TestConfigurationsT>(value));
    return *this;
  }
  template <typename TestConfigurationsT = TestConfigurationSummary>
  ListTestConfigurationsResult& AddTestConfigurations(TestConfigurationsT&& value) {
    m_testConfigurationsHasBeenSet = true;
    m_testConfigurations.emplace_back(std::forward<TestConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestConfigurationsResult& WithRequestId(RequestIdT&& value) {
