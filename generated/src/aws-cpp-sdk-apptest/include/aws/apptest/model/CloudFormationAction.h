...
class CloudFormationAction {
 public:
  ...
  template <typename ResourceT = Aws::String>
  CloudFormationAction& WithResource(ResourceT&& value) {
  ...
  inline void SetActionType(CloudFormationActionType value) {
    m_actionTypeHasBeenSet = true;
    m_actionType = value;
  }
  inline CloudFormationAction& WithActionType(CloudFormationActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
