...
class CreateTestSuiteRequest : public AppTestRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateTestSuiteRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateTestSuiteRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename BeforeStepsT = Aws::Vector<Step>>
  CreateTestSuiteRequest& WithBeforeSteps(BeforeStepsT&& value) {
    SetBeforeSteps(std::forward<BeforeStepsT>(value));
    return *this;
  }
  template <typename BeforeStepsT = Step>
  CreateTestSuiteRequest& AddBeforeSteps(BeforeStepsT&& value) {
    m_beforeStepsHasBeenSet = true;
  ...
  template <typename AfterStepsT = Aws::Vector<Step>>
  CreateTestSuiteRequest& WithAfterSteps(AfterStepsT&& value) {
    SetAfterSteps(std::forward<AfterStepsT>(value));
    return *this;
  }
  template <typename AfterStepsT = Step>
  CreateTestSuiteRequest& AddAfterSteps(AfterStepsT&& value) {
    m_afterStepsHasBeenSet = true;
  ...
  template <typename TestCasesT = TestCases>
  CreateTestSuiteRequest& WithTestCases(TestCasesT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTestSuiteRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateTestSuiteRequest& WithTags(TagsT&& value) {
