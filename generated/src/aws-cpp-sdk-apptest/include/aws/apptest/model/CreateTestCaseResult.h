...
namespace Model
{
  ...
  {
  public:
    AWS_APPTEST_API CreateTestCaseResult() = default;
    ...
    template<typename TestCaseIdT = Aws::String>
    CreateTestCaseResult& WithTestCaseId(TestCaseIdT&& value) { SetTestCaseId(std::forward<TestCaseIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateTestCaseResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
