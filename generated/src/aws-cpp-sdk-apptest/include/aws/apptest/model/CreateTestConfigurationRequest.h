...
class CreateTestConfigurationRequest : public AppTestRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateTestConfigurationRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateTestConfigurationRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<Resource>>
  CreateTestConfigurationRequest& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Resource>
  CreateTestConfigurationRequest& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename PropertiesT = Aws::Map<Aws::String, Aws::String>>
  CreateTestConfigurationRequest& WithProperties(PropertiesT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTestConfigurationRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateTestConfigurationRequest& WithTags(TagsT&& value) {
  ...
  template <typename ServiceSettingsT = ServiceSettings>
  CreateTestConfigurationRequest& WithServiceSettings(ServiceSettingsT&& value) {
