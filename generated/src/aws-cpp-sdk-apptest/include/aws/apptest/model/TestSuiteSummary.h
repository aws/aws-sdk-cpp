...
class TestSuiteSummary {
 public:
  ...
  template <typename TestSuiteIdT = Aws::String>
  TestSuiteSummary& WithTestSuiteId(TestSuiteIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  TestSuiteSummary& WithName(NameT&& value) {
  ...
  template <typename StatusReasonT = Aws::String>
  TestSuiteSummary& WithStatusReason(StatusReasonT&& value) {
  ...
  inline TestSuiteSummary& WithLatestVersion(int value) {
  ...
  template <typename TestSuiteArnT = Aws::String>
  TestSuiteSummary& WithTestSuiteArn(TestSuiteArnT&& value) {
  ...
  inline TestSuiteSummary& WithStatus(TestSuiteLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  TestSuiteSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  TestSuiteSummary& WithLastUpdateTime(LastUpdateTimeT&& value) {
