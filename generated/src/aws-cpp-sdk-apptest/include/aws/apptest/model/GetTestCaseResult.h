...
class GetTestCaseResult {
 public:
  ...
  template <typename TestCaseIdT = Aws::String>
  GetTestCaseResult& WithTestCaseId(TestCaseIdT&& value) {
  ...
  template <typename TestCaseArnT = Aws::String>
  GetTestCaseResult& WithTestCaseArn(TestCaseArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetTestCaseResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetTestCaseResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename LatestVersionT = TestCaseLatestVersion>
  GetTestCaseResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  inline GetTestCaseResult& WithTestCaseVersion(int value) {
  ...
  inline void SetStatus(TestCaseLifecycle value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetTestCaseResult& WithStatus(TestCaseLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  GetTestCaseResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetTestCaseResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  GetTestCaseResult& WithLastUpdateTime(LastUpdateTimeT&& value) {
  ...
  template <typename StepsT = Aws::Vector<Step>>
  GetTestCaseResult& WithSteps(StepsT&& value) {
    SetSteps(std::forward<StepsT>(value));
    return *this;
  }
  template <typename StepsT = Step>
  GetTestCaseResult& AddSteps(StepsT&& value) {
    m_stepsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetTestCaseResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTestCaseResult& WithRequestId(RequestIdT&& value) {
