...
class UpdateTestCaseResult {
 public:
  ...
  template <typename TestCaseIdT = Aws::String>
  UpdateTestCaseResult& WithTestCaseId(TestCaseIdT&& value) {
  ...
  inline void SetTestCaseVersion(int value) {
    m_testCaseVersionHasBeenSet = true;
    m_testCaseVersion = value;
  }
  inline UpdateTestCaseResult& WithTestCaseVersion(int value) {
    SetTestCaseVersion(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateTestCaseResult& WithRequestId(RequestIdT&& value) {
