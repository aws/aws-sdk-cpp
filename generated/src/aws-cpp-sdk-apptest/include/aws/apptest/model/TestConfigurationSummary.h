...
class TestConfigurationSummary {
 public:
  ...
  template <typename TestConfigurationIdT = Aws::String>
  TestConfigurationSummary& WithTestConfigurationId(TestConfigurationIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  TestConfigurationSummary& WithName(NameT&& value) {
  ...
  template <typename StatusReasonT = Aws::String>
  TestConfigurationSummary& WithStatusReason(StatusReasonT&& value) {
  ...
  inline TestConfigurationSummary& WithLatestVersion(int value) {
  ...
  void SetTestConfigurationArn(TestConfigurationArnT&& value) {
    m_testConfigurationArnHasBeenSet = true;
    m_testConfigurationArn = std::forward<TestConfigurationArnT>(value);
  }
  template <typename TestConfigurationArnT = Aws::String>
  TestConfigurationSummary& WithTestConfigurationArn(TestConfigurationArnT&& value) {
    SetTestConfigurationArn(std::forward<TestConfigurationArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(TestConfigurationLifecycle value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline TestConfigurationSummary& WithStatus(TestConfigurationLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  TestConfigurationSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  TestConfigurationSummary& WithLastUpdateTime(LastUpdateTimeT&& value) {
