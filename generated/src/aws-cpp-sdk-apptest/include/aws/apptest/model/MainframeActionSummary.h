...
class MainframeActionSummary {
 public:
  ...
  template <typename BatchT = BatchSummary>
  MainframeActionSummary& WithBatch(BatchT&& value) {
  ...
  void SetTn3270(Tn3270T&& value) {
    m_tn3270HasBeenSet = true;
    m_tn3270 = std::forward<Tn3270T>(value);
  }
  template <typename Tn3270T = TN3270Summary>
  MainframeActionSummary& WithTn3270(Tn3270T&& value) {
    SetTn3270(std::forward<Tn3270T>(value));
    return *this;
  }
  ///@}
 private:
