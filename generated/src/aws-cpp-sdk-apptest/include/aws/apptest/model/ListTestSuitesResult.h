...
class ListTestSuitesResult {
 public:
  ...
  void SetTestSuites(TestSuitesT&& value) {
    m_testSuitesHasBeenSet = true;
    m_testSuites = std::forward<TestSuitesT>(value);
  }
  template <typename TestSuitesT = Aws::Vector<TestSuiteSummary>>
  ListTestSuitesResult& WithTestSuites(TestSuitesT&& value) {
    SetTestSuites(std::forward<TestSuitesT>(value));
    return *this;
  }
  template <typename TestSuitesT = TestSuiteSummary>
  ListTestSuitesResult& AddTestSuites(TestSuitesT&& value) {
    m_testSuitesHasBeenSet = true;
    m_testSuites.emplace_back(std::forward<TestSuitesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestSuitesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestSuitesResult& WithRequestId(RequestIdT&& value) {
