...
class ResourceAction {
 public:
  ...
  void SetM2ManagedApplicationAction(M2ManagedApplicationActionT&& value) {
    m_m2ManagedApplicationActionHasBeenSet = true;
    m_m2ManagedApplicationAction = std::forward<M2ManagedApplicationActionT>(value);
  }
  template <typename M2ManagedApplicationActionT = M2ManagedApplicationAction>
  ResourceAction& WithM2ManagedApplicationAction(M2ManagedApplicationActionT&& value) {
    SetM2ManagedApplicationAction(std::forward<M2ManagedApplicationActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetM2NonManagedApplicationAction(M2NonManagedApplicationActionT&& value) {
    m_m2NonManagedApplicationActionHasBeenSet = true;
    m_m2NonManagedApplicationAction = std::forward<M2NonManagedApplicationActionT>(value);
  }
  template <typename M2NonManagedApplicationActionT = M2NonManagedApplicationAction>
  ResourceAction& WithM2NonManagedApplicationAction(M2NonManagedApplicationActionT&& value) {
    SetM2NonManagedApplicationAction(std::forward<M2NonManagedApplicationActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudFormationAction(CloudFormationActionT&& value) {
    m_cloudFormationActionHasBeenSet = true;
    m_cloudFormationAction = std::forward<CloudFormationActionT>(value);
  }
  template <typename CloudFormationActionT = CloudFormationAction>
  ResourceAction& WithCloudFormationAction(CloudFormationActionT&& value) {
    SetCloudFormationAction(std::forward<CloudFormationActionT>(value));
    return *this;
  }
  ///@}
 private:
