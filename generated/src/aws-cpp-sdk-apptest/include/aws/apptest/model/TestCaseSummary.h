...
class TestCaseSummary {
 public:
  ...
  template <typename TestCaseIdT = Aws::String>
  TestCaseSummary& WithTestCaseId(TestCaseIdT&& value) {
  ...
  template <typename TestCaseArnT = Aws::String>
  TestCaseSummary& WithTestCaseArn(TestCaseArnT&& value) {
  ...
  template <typename StatusReasonT = Aws::String>
  TestCaseSummary& WithStatusReason(StatusReasonT&& value) {
  ...
  inline TestCaseSummary& WithLatestVersion(int value) {
  ...
  inline TestCaseSummary& WithStatus(TestCaseLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  TestCaseSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  TestCaseSummary& WithLastUpdateTime(LastUpdateTimeT&& value) {
