...
class ListTestRunStepsRequest : public AppTestRequest {
 public:
  ...
  template <typename TestRunIdT = Aws::String>
  ListTestRunStepsRequest& WithTestRunId(TestRunIdT&& value) {
  ...
  template <typename TestCaseIdT = Aws::String>
  ListTestRunStepsRequest& WithTestCaseId(TestCaseIdT&& value) {
  ...
  template <typename TestSuiteIdT = Aws::String>
  ListTestRunStepsRequest& WithTestSuiteId(TestSuiteIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTestRunStepsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTestRunStepsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
