...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/apptest-2022-12-06/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_APPTEST_API ResourceNotFoundException() = default;
    AWS_APPTEST_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
