...
class UpdateTestConfigurationRequest : public AppTestRequest {
 public:
  ...
  void SetTestConfigurationId(TestConfigurationIdT&& value) {
    m_testConfigurationIdHasBeenSet = true;
    m_testConfigurationId = std::forward<TestConfigurationIdT>(value);
  }
  template <typename TestConfigurationIdT = Aws::String>
  UpdateTestConfigurationRequest& WithTestConfigurationId(TestConfigurationIdT&& value) {
    SetTestConfigurationId(std::forward<TestConfigurationIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  UpdateTestConfigurationRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<Resource>>
  UpdateTestConfigurationRequest& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Resource>
  UpdateTestConfigurationRequest& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename PropertiesT = Aws::Map<Aws::String, Aws::String>>
  UpdateTestConfigurationRequest& WithProperties(PropertiesT&& value) {
  ...
  template <typename ServiceSettingsT = ServiceSettings>
  UpdateTestConfigurationRequest& WithServiceSettings(ServiceSettingsT&& value) {
