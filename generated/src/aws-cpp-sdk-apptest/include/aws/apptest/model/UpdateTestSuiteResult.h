...
class UpdateTestSuiteResult {
 public:
  ...
  template <typename TestSuiteIdT = Aws::String>
  UpdateTestSuiteResult& WithTestSuiteId(TestSuiteIdT&& value) {
  ...
  inline UpdateTestSuiteResult& WithTestSuiteVersion(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateTestSuiteResult& WithRequestId(RequestIdT&& value) {
