...
class GetTestRunStepResult {
 public:
  ...
  template <typename StepNameT = Aws::String>
  GetTestRunStepResult& WithStepName(StepNameT&& value) {
  ...
  template <typename TestRunIdT = Aws::String>
  GetTestRunStepResult& WithTestRunId(TestRunIdT&& value) {
  ...
  template <typename TestCaseIdT = Aws::String>
  GetTestRunStepResult& WithTestCaseId(TestCaseIdT&& value) {
  ...
  inline GetTestRunStepResult& WithTestCaseVersion(int value) {
  ...
  template <typename TestSuiteIdT = Aws::String>
  GetTestRunStepResult& WithTestSuiteId(TestSuiteIdT&& value) {
  ...
  inline GetTestRunStepResult& WithTestSuiteVersion(int value) {
  ...
  inline void SetBeforeStep(bool value) {
    m_beforeStepHasBeenSet = true;
    m_beforeStep = value;
  }
  inline GetTestRunStepResult& WithBeforeStep(bool value) {
    SetBeforeStep(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAfterStep(bool value) {
    m_afterStepHasBeenSet = true;
    m_afterStep = value;
  }
  inline GetTestRunStepResult& WithAfterStep(bool value) {
    SetAfterStep(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(StepRunStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetTestRunStepResult& WithStatus(StepRunStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  GetTestRunStepResult& WithStatusReason(StatusReasonT&& value) {
  ...
  void SetRunStartTime(RunStartTimeT&& value) {
    m_runStartTimeHasBeenSet = true;
    m_runStartTime = std::forward<RunStartTimeT>(value);
  }
  template <typename RunStartTimeT = Aws::Utils::DateTime>
  GetTestRunStepResult& WithRunStartTime(RunStartTimeT&& value) {
    SetRunStartTime(std::forward<RunStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRunEndTime(RunEndTimeT&& value) {
    m_runEndTimeHasBeenSet = true;
    m_runEndTime = std::forward<RunEndTimeT>(value);
  }
  template <typename RunEndTimeT = Aws::Utils::DateTime>
  GetTestRunStepResult& WithRunEndTime(RunEndTimeT&& value) {
    SetRunEndTime(std::forward<RunEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStepRunSummary(StepRunSummaryT&& value) {
    m_stepRunSummaryHasBeenSet = true;
    m_stepRunSummary = std::forward<StepRunSummaryT>(value);
  }
  template <typename StepRunSummaryT = StepRunSummary>
  GetTestRunStepResult& WithStepRunSummary(StepRunSummaryT&& value) {
    SetStepRunSummary(std::forward<StepRunSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetTestRunStepResult& WithRequestId(RequestIdT&& value) {
