...
class M2ManagedActionProperties {
 public:
  ...
  inline M2ManagedActionProperties& WithForceStop(bool value) {
    SetForceStop(value);
    return *this;
  }
  ///@}
  ...
  void SetImportDataSetLocation(ImportDataSetLocationT&& value) {
    m_importDataSetLocationHasBeenSet = true;
    m_importDataSetLocation = std::forward<ImportDataSetLocationT>(value);
  }
  template <typename ImportDataSetLocationT = Aws::String>
  M2ManagedActionProperties& WithImportDataSetLocation(ImportDataSetLocationT&& value) {
    SetImportDataSetLocation(std::forward<ImportDataSetLocationT>(value));
    return *this;
  }
  ///@}
 private:
