...
class CloudFormation {
 public:
  ...
  void SetTemplateLocation(TemplateLocationT&& value) {
    ...
    m_templateLocation = std::forward<TemplateLocationT>(value);
  }
  template <typename TemplateLocationT = Aws::String>
  CloudFormation& WithTemplateLocation(TemplateLocationT&& value) {
    SetTemplateLocation(std::forward<TemplateLocationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::String>>
  CloudFormation& WithParameters(ParametersT&& value) {
