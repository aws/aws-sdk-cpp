...
class CompareDatabaseCDCStepOutput {
 public:
  ...
  void SetComparisonOutputLocation(ComparisonOutputLocationT&& value) {
    m_comparisonOutputLocationHasBeenSet = true;
    m_comparisonOutputLocation = std::forward<ComparisonOutputLocationT>(value);
  }
  template <typename ComparisonOutputLocationT = Aws::String>
  CompareDatabaseCDCStepOutput& WithComparisonOutputLocation(ComparisonOutputLocationT&& value) {
    SetComparisonOutputLocation(std::forward<ComparisonOutputLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetComparisonStatus(ComparisonStatusEnum value) {
    m_comparisonStatusHasBeenSet = true;
    m_comparisonStatus = value;
  }
  inline CompareDatabaseCDCStepOutput& WithComparisonStatus(ComparisonStatusEnum value) {
    SetComparisonStatus(value);
    return *this;
  }
  ///@}
 private:
