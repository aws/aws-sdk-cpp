...
class CompareDataSetsStepInput {
 public:
  ...
  template <typename SourceLocationT = Aws::String>
  CompareDataSetsStepInput& WithSourceLocation(SourceLocationT&& value) {
  ...
  template <typename TargetLocationT = Aws::String>
  CompareDataSetsStepInput& WithTargetLocation(TargetLocationT&& value) {
  ...
  void SetSourceDataSets(SourceDataSetsT&& value) {
    m_sourceDataSetsHasBeenSet = true;
    m_sourceDataSets = std::forward<SourceDataSetsT>(value);
  }
  template <typename SourceDataSetsT = Aws::Vector<DataSet>>
  CompareDataSetsStepInput& WithSourceDataSets(SourceDataSetsT&& value) {
    SetSourceDataSets(std::forward<SourceDataSetsT>(value));
    return *this;
  }
  template <typename SourceDataSetsT = DataSet>
  CompareDataSetsStepInput& AddSourceDataSets(SourceDataSetsT&& value) {
    m_sourceDataSetsHasBeenSet = true;
    m_sourceDataSets.emplace_back(std::forward<SourceDataSetsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetDataSets(TargetDataSetsT&& value) {
    m_targetDataSetsHasBeenSet = true;
    m_targetDataSets = std::forward<TargetDataSetsT>(value);
  }
  template <typename TargetDataSetsT = Aws::Vector<DataSet>>
  CompareDataSetsStepInput& WithTargetDataSets(TargetDataSetsT&& value) {
    SetTargetDataSets(std::forward<TargetDataSetsT>(value));
    return *this;
  }
  template <typename TargetDataSetsT = DataSet>
  CompareDataSetsStepInput& AddTargetDataSets(TargetDataSetsT&& value) {
    m_targetDataSetsHasBeenSet = true;
    m_targetDataSets.emplace_back(std::forward<TargetDataSetsT>(value));
    return *this;
  }
  ///@}
 private:
