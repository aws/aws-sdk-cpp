...
class CompareDataSetsStepOutput {
 public:
  ...
  template <typename ComparisonOutputLocationT = Aws::String>
  CompareDataSetsStepOutput& WithComparisonOutputLocation(ComparisonOutputLocationT&& value) {
  ...
  inline CompareDataSetsStepOutput& WithComparisonStatus(ComparisonStatusEnum value) {
