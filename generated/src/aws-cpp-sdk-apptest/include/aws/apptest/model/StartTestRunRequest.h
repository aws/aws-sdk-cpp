...
class StartTestRunRequest : public AppTestRequest {
 public:
  ...
  template <typename TestSuiteIdT = Aws::String>
  StartTestRunRequest& WithTestSuiteId(TestSuiteIdT&& value) {
  ...
  template <typename TestConfigurationIdT = Aws::String>
  StartTestRunRequest& WithTestConfigurationId(TestConfigurationIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StartTestRunRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StartTestRunRequest& WithTags(TagsT&& value) {
