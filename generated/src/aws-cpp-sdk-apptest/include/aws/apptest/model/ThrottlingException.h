...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/apptest-2022-12-06/ThrottlingException">AWS
   * API Reference</a></p>
   */
  class ThrottlingException
  {
  public:
    AWS_APPTEST_API ThrottlingException() = default;
    AWS_APPTEST_API ThrottlingException(Aws::Utils::Json::JsonView jsonValue);
