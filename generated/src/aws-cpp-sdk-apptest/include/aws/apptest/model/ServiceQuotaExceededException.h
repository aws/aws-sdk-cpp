...
namespace Model
{
  ...
  /**
   * <p>One or more quotas for AWS Application Testing exceeds the
   * limit.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/apptest-2022-12-06/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_APPTEST_API ServiceQuotaExceededException() = default;
    AWS_APPTEST_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
