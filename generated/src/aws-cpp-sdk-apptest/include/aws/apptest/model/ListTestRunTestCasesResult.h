...
class ListTestRunTestCasesResult {
 public:
  ...
  void SetTestRunTestCases(TestRunTestCasesT&& value) {
    m_testRunTestCasesHasBeenSet = true;
    m_testRunTestCases = std::forward<TestRunTestCasesT>(value);
  }
  template <typename TestRunTestCasesT = Aws::Vector<TestCaseRunSummary>>
  ListTestRunTestCasesResult& WithTestRunTestCases(TestRunTestCasesT&& value) {
    SetTestRunTestCases(std::forward<TestRunTestCasesT>(value));
    return *this;
  }
  template <typename TestRunTestCasesT = TestCaseRunSummary>
  ListTestRunTestCasesResult& AddTestRunTestCases(TestRunTestCasesT&& value) {
    m_testRunTestCasesHasBeenSet = true;
    m_testRunTestCases.emplace_back(std::forward<TestRunTestCasesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestRunTestCasesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestRunTestCasesResult& WithRequestId(RequestIdT&& value) {
