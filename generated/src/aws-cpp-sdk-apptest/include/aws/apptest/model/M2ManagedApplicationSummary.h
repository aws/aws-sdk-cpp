...
class M2ManagedApplicationSummary {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  M2ManagedApplicationSummary& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline M2ManagedApplicationSummary& WithRuntime(M2ManagedRuntime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  inline M2ManagedApplicationSummary& WithListenerPort(int value) {
