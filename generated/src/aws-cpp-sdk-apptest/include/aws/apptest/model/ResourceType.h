...
class ResourceType {
 public:
  ...
  template <typename CloudFormationT = CloudFormation>
  ResourceType& WithCloudFormation(CloudFormationT&& value) {
  ...
  template <typename M2ManagedApplicationT = M2ManagedApplication>
  ResourceType& WithM2ManagedApplication(M2ManagedApplicationT&& value) {
  ...
  template <typename M2NonManagedApplicationT = M2NonManagedApplication>
  ResourceType& WithM2NonManagedApplication(M2NonManagedApplicationT&& value) {
