...
class ListTestConfigurationsRequest : public AppTestRequest {
 public:
  ...
  void SetTestConfigurationIds(TestConfigurationIdsT&& value) {
    m_testConfigurationIdsHasBeenSet = true;
    m_testConfigurationIds = std::forward<TestConfigurationIdsT>(value);
  }
  template <typename TestConfigurationIdsT = Aws::Vector<Aws::String>>
  ListTestConfigurationsRequest& WithTestConfigurationIds(TestConfigurationIdsT&& value) {
    SetTestConfigurationIds(std::forward<TestConfigurationIdsT>(value));
    return *this;
  }
  template <typename TestConfigurationIdsT = Aws::String>
  ListTestConfigurationsRequest& AddTestConfigurationIds(TestConfigurationIdsT&& value) {
    m_testConfigurationIdsHasBeenSet = true;
    m_testConfigurationIds.emplace_back(std::forward<TestConfigurationIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestConfigurationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTestConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
