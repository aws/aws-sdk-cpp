...
class TargetDatabaseMetadata {
 public:
  ...
  inline void SetType(TargetDatabase value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TargetDatabaseMetadata& WithType(TargetDatabase value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCaptureTool(CaptureTool value) {
    m_captureToolHasBeenSet = true;
    m_captureTool = value;
  }
  inline TargetDatabaseMetadata& WithCaptureTool(CaptureTool value) {
    SetCaptureTool(value);
    return *this;
  }
  ///@}
 private:
