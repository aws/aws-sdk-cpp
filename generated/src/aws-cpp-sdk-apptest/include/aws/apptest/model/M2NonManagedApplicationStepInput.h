...
class M2NonManagedApplicationStepInput {
 public:
  ...
  template <typename VpcEndpointServiceNameT = Aws::String>
  M2NonManagedApplicationStepInput& WithVpcEndpointServiceName(VpcEndpointServiceNameT&& value) {
  ...
  inline M2NonManagedApplicationStepInput& WithListenerPort(int value) {
  ...
  inline M2NonManagedApplicationStepInput& WithRuntime(M2NonManagedRuntime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  template <typename WebAppNameT = Aws::String>
  M2NonManagedApplicationStepInput& WithWebAppName(WebAppNameT&& value) {
  ...
  inline void SetActionType(M2NonManagedActionType value) {
    m_actionTypeHasBeenSet = true;
    m_actionType = value;
  }
  inline M2NonManagedApplicationStepInput& WithActionType(M2NonManagedActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
