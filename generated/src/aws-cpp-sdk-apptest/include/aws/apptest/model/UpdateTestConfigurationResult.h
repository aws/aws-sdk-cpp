...
class UpdateTestConfigurationResult {
 public:
  ...
  template <typename TestConfigurationIdT = Aws::String>
  UpdateTestConfigurationResult& WithTestConfigurationId(TestConfigurationIdT&& value) {
  ...
  inline void SetTestConfigurationVersion(int value) {
    m_testConfigurationVersionHasBeenSet = true;
    m_testConfigurationVersion = value;
  }
  inline UpdateTestConfigurationResult& WithTestConfigurationVersion(int value) {
    SetTestConfigurationVersion(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateTestConfigurationResult& WithRequestId(RequestIdT&& value) {
