...
class M2NonManagedApplicationSummary {
 public:
  ...
  template <typename VpcEndpointServiceNameT = Aws::String>
  M2NonManagedApplicationSummary& WithVpcEndpointServiceName(VpcEndpointServiceNameT&& value) {
  ...
  inline M2NonManagedApplicationSummary& WithListenerPort(int value) {
  ...
  inline M2NonManagedApplicationSummary& WithRuntime(M2NonManagedRuntime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  template <typename WebAppNameT = Aws::String>
  M2NonManagedApplicationSummary& WithWebAppName(WebAppNameT&& value) {
