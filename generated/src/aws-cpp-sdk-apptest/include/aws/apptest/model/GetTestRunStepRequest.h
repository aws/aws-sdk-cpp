...
class GetTestRunStepRequest : public AppTestRequest {
 public:
  ...
  template <typename TestRunIdT = Aws::String>
  GetTestRunStepRequest& WithTestRunId(TestRunIdT&& value) {
  ...
  template <typename StepNameT = Aws::String>
  GetTestRunStepRequest& WithStepName(StepNameT&& value) {
  ...
  template <typename TestCaseIdT = Aws::String>
  GetTestRunStepRequest& WithTestCaseId(TestCaseIdT&& value) {
  ...
  template <typename TestSuiteIdT = Aws::String>
  GetTestRunStepRequest& WithTestSuiteId(TestSuiteIdT&& value) {
