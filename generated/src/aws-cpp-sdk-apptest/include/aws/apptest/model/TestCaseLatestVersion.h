...
class TestCaseLatestVersion {
 public:
  ...
  inline TestCaseLatestVersion& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline TestCaseLatestVersion& WithStatus(TestCaseLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  TestCaseLatestVersion& WithStatusReason(StatusReasonT&& value) {
