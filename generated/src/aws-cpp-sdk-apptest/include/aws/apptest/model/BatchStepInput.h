...
class BatchStepInput {
 public:
  ...
  template <typename ResourceT = MainframeResourceSummary>
  BatchStepInput& WithResource(ResourceT&& value) {
  ...
  void SetBatchJobName(BatchJobNameT&& value) {
    ...
    m_batchJobName = std::forward<BatchJobNameT>(value);
  }
  template <typename BatchJobNameT = Aws::String>
  BatchStepInput& WithBatchJobName(BatchJobNameT&& value) {
    SetBatchJobName(std::forward<BatchJobNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBatchJobParameters(BatchJobParametersT&& value) {
    ...
    m_batchJobParameters = std::forward<BatchJobParametersT>(value);
  }
  template <typename BatchJobParametersT = Aws::Map<Aws::String, Aws::String>>
  BatchStepInput& WithBatchJobParameters(BatchJobParametersT&& value) {
    SetBatchJobParameters(std::forward<BatchJobParametersT>(value));
    return *this;
  }
  ...
  BatchStepInput& AddBatchJobParameters(BatchJobParametersKeyT&& key, BatchJobParametersValueT&& value) {
    m_batchJobParametersHasBeenSet = true;
    m_batchJobParameters.emplace(std::forward<BatchJobParametersKeyT>(key), std::forward<BatchJobParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportDataSetNames(ExportDataSetNamesT&& value) {
    ...
    m_exportDataSetNames = std::forward<ExportDataSetNamesT>(value);
  }
  template <typename ExportDataSetNamesT = Aws::Vector<Aws::String>>
  BatchStepInput& WithExportDataSetNames(ExportDataSetNamesT&& value) {
    SetExportDataSetNames(std::forward<ExportDataSetNamesT>(value));
    return *this;
  }
  template <typename ExportDataSetNamesT = Aws::String>
  BatchStepInput& AddExportDataSetNames(ExportDataSetNamesT&& value) {
    m_exportDataSetNamesHasBeenSet = true;
    m_exportDataSetNames.emplace_back(std::forward<ExportDataSetNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PropertiesT = MainframeActionProperties>
  BatchStepInput& WithProperties(PropertiesT&& value) {
