...
class CreateTestConfigurationResult {
 public:
  ...
  template <typename TestConfigurationIdT = Aws::String>
  CreateTestConfigurationResult& WithTestConfigurationId(TestConfigurationIdT&& value) {
  ...
  inline CreateTestConfigurationResult& WithTestConfigurationVersion(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTestConfigurationResult& WithRequestId(RequestIdT&& value) {
