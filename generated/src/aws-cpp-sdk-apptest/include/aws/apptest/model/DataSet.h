...
class DataSet {
 public:
  ...
  inline void SetType(DataSetType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DataSet& WithType(DataSetType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetCcsid(CcsidT&& value) {
    m_ccsidHasBeenSet = true;
    m_ccsid = std::forward<CcsidT>(value);
  }
  template <typename CcsidT = Aws::String>
  DataSet& WithCcsid(CcsidT&& value) {
    SetCcsid(std::forward<CcsidT>(value));
    return *this;
  }
  ///@}
  ...
  inline DataSet& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline DataSet& WithLength(int value) {
    SetLength(value);
    return *this;
  }
  ///@}
