...
class M2ManagedApplicationStepOutput {
 public:
  ...
  void SetImportDataSetSummary(ImportDataSetSummaryT&& value) {
    m_importDataSetSummaryHasBeenSet = true;
    m_importDataSetSummary = std::forward<ImportDataSetSummaryT>(value);
  }
  template <typename ImportDataSetSummaryT = Aws::Map<Aws::String, Aws::String>>
  M2ManagedApplicationStepOutput& WithImportDataSetSummary(ImportDataSetSummaryT&& value) {
    SetImportDataSetSummary(std::forward<ImportDataSetSummaryT>(value));
    return *this;
  }
  ...
  M2ManagedApplicationStepOutput& AddImportDataSetSummary(ImportDataSetSummaryKeyT&& key, ImportDataSetSummaryValueT&& value) {
    m_importDataSetSummaryHasBeenSet = true;
    m_importDataSetSummary.emplace(std::forward<ImportDataSetSummaryKeyT>(key), std::forward<ImportDataSetSummaryValueT>(value));
    return *this;
  }
  ///@}
 private:
