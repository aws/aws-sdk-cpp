...
class GetTestSuiteResult {
 public:
  ...
  void SetTestSuiteId(TestSuiteIdT&& value) {
    m_testSuiteIdHasBeenSet = true;
    m_testSuiteId = std::forward<TestSuiteIdT>(value);
  }
  template <typename TestSuiteIdT = Aws::String>
  GetTestSuiteResult& WithTestSuiteId(TestSuiteIdT&& value) {
    SetTestSuiteId(std::forward<TestSuiteIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  GetTestSuiteResult& WithName(NameT&& value) {
  ...
  template <typename LatestVersionT = TestSuiteLatestVersion>
  GetTestSuiteResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  inline void SetTestSuiteVersion(int value) {
    m_testSuiteVersionHasBeenSet = true;
    m_testSuiteVersion = value;
  }
  inline GetTestSuiteResult& WithTestSuiteVersion(int value) {
    SetTestSuiteVersion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(TestSuiteLifecycle value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetTestSuiteResult& WithStatus(TestSuiteLifecycle value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  GetTestSuiteResult& WithStatusReason(StatusReasonT&& value) {
  ...
  void SetTestSuiteArn(TestSuiteArnT&& value) {
    m_testSuiteArnHasBeenSet = true;
    m_testSuiteArn = std::forward<TestSuiteArnT>(value);
  }
  template <typename TestSuiteArnT = Aws::String>
  GetTestSuiteResult& WithTestSuiteArn(TestSuiteArnT&& value) {
    SetTestSuiteArn(std::forward<TestSuiteArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetTestSuiteResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  GetTestSuiteResult& WithLastUpdateTime(LastUpdateTimeT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetTestSuiteResult& WithDescription(DescriptionT&& value) {
  ...
  void SetBeforeSteps(BeforeStepsT&& value) {
    m_beforeStepsHasBeenSet = true;
    m_beforeSteps = std::forward<BeforeStepsT>(value);
  }
  template <typename BeforeStepsT = Aws::Vector<Step>>
  GetTestSuiteResult& WithBeforeSteps(BeforeStepsT&& value) {
    SetBeforeSteps(std::forward<BeforeStepsT>(value));
    return *this;
  }
  template <typename BeforeStepsT = Step>
  GetTestSuiteResult& AddBeforeSteps(BeforeStepsT&& value) {
    m_beforeStepsHasBeenSet = true;
    m_beforeSteps.emplace_back(std::forward<BeforeStepsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAfterSteps(AfterStepsT&& value) {
    m_afterStepsHasBeenSet = true;
    m_afterSteps = std::forward<AfterStepsT>(value);
  }
  template <typename AfterStepsT = Aws::Vector<Step>>
  GetTestSuiteResult& WithAfterSteps(AfterStepsT&& value) {
    SetAfterSteps(std::forward<AfterStepsT>(value));
    return *this;
  }
  template <typename AfterStepsT = Step>
  GetTestSuiteResult& AddAfterSteps(AfterStepsT&& value) {
    m_afterStepsHasBeenSet = true;
    m_afterSteps.emplace_back(std::forward<AfterStepsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TestCasesT = TestCases>
  GetTestSuiteResult& WithTestCases(TestCasesT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetTestSuiteResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTestSuiteResult& WithRequestId(RequestIdT&& value) {
