...
class UpdateTestSuiteRequest : public AppTestRequest {
 public:
  ...
  template <typename TestSuiteIdT = Aws::String>
  UpdateTestSuiteRequest& WithTestSuiteId(TestSuiteIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateTestSuiteRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename BeforeStepsT = Aws::Vector<Step>>
  UpdateTestSuiteRequest& WithBeforeSteps(BeforeStepsT&& value) {
    SetBeforeSteps(std::forward<BeforeStepsT>(value));
    return *this;
  }
  template <typename BeforeStepsT = Step>
  UpdateTestSuiteRequest& AddBeforeSteps(BeforeStepsT&& value) {
    m_beforeStepsHasBeenSet = true;
  ...
  template <typename AfterStepsT = Aws::Vector<Step>>
  UpdateTestSuiteRequest& WithAfterSteps(AfterStepsT&& value) {
    SetAfterSteps(std::forward<AfterStepsT>(value));
    return *this;
  }
  template <typename AfterStepsT = Step>
  UpdateTestSuiteRequest& AddAfterSteps(AfterStepsT&& value) {
    m_afterStepsHasBeenSet = true;
  ...
  template <typename TestCasesT = TestCases>
  UpdateTestSuiteRequest& WithTestCases(TestCasesT&& value) {
