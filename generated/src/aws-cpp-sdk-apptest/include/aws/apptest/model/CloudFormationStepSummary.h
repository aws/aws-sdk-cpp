...
class CloudFormationStepSummary {
 public:
  ...
  void SetCreateCloudformation(CreateCloudformationT&& value) {
    m_createCloudformationHasBeenSet = true;
    m_createCloudformation = std::forward<CreateCloudformationT>(value);
  }
  template <typename CreateCloudformationT = CreateCloudFormationSummary>
  CloudFormationStepSummary& WithCreateCloudformation(CreateCloudformationT&& value) {
    SetCreateCloudformation(std::forward<CreateCloudformationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeleteCloudformation(DeleteCloudformationT&& value) {
    m_deleteCloudformationHasBeenSet = true;
    m_deleteCloudformation = std::forward<DeleteCloudformationT>(value);
  }
  template <typename DeleteCloudformationT = DeleteCloudFormationSummary>
  CloudFormationStepSummary& WithDeleteCloudformation(DeleteCloudformationT&& value) {
    SetDeleteCloudformation(std::forward<DeleteCloudformationT>(value));
    return *this;
  }
  ///@}
 private:
