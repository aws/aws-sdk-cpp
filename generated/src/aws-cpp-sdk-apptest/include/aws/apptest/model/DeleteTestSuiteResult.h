...
namespace Model
{
  ...
  {
  public:
    AWS_APPTEST_API DeleteTestSuiteResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteTestSuiteResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
