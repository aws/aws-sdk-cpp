...
class StartTestRunResult {
 public:
  ...
  inline void SetTestRunStatus(TestRunStatus value) {
    m_testRunStatusHasBeenSet = true;
    m_testRunStatus = value;
  }
  inline StartTestRunResult& WithTestRunStatus(TestRunStatus value) {
    SetTestRunStatus(value);
    return *this;
  }
  ///@}
