...
class M2NonManagedApplication {
 public:
  ...
  template <typename VpcEndpointServiceNameT = Aws::String>
  M2NonManagedApplication& WithVpcEndpointServiceName(VpcEndpointServiceNameT&& value) {
  ...
  void SetListenerPort(ListenerPortT&& value) {
    m_listenerPortHasBeenSet = true;
    m_listenerPort = std::forward<ListenerPortT>(value);
  }
  template <typename ListenerPortT = Aws::String>
  M2NonManagedApplication& WithListenerPort(ListenerPortT&& value) {
    SetListenerPort(std::forward<ListenerPortT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRuntime(M2NonManagedRuntime value) {
    m_runtimeHasBeenSet = true;
    m_runtime = value;
  }
  inline M2NonManagedApplication& WithRuntime(M2NonManagedRuntime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  void SetWebAppName(WebAppNameT&& value) {
    m_webAppNameHasBeenSet = true;
    m_webAppName = std::forward<WebAppNameT>(value);
  }
  template <typename WebAppNameT = Aws::String>
  M2NonManagedApplication& WithWebAppName(WebAppNameT&& value) {
    SetWebAppName(std::forward<WebAppNameT>(value));
    return *this;
  }
  ///@}
 private:
