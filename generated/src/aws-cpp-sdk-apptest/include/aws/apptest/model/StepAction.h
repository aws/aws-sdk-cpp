...
class StepAction {
 public:
  ...
  void SetResourceAction(ResourceActionT&& value) {
    m_resourceActionHasBeenSet = true;
    m_resourceAction = std::forward<ResourceActionT>(value);
  }
  template <typename ResourceActionT = ResourceAction>
  StepAction& WithResourceAction(ResourceActionT&& value) {
    SetResourceAction(std::forward<ResourceActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMainframeAction(MainframeActionT&& value) {
    m_mainframeActionHasBeenSet = true;
    m_mainframeAction = std::forward<MainframeActionT>(value);
  }
  template <typename MainframeActionT = MainframeAction>
  StepAction& WithMainframeAction(MainframeActionT&& value) {
    SetMainframeAction(std::forward<MainframeActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCompareAction(CompareActionT&& value) {
    m_compareActionHasBeenSet = true;
    m_compareAction = std::forward<CompareActionT>(value);
  }
  template <typename CompareActionT = CompareAction>
  StepAction& WithCompareAction(CompareActionT&& value) {
    SetCompareAction(std::forward<CompareActionT>(value));
    return *this;
  }
  ///@}
 private:
