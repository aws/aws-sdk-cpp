...
class TestRunSummary {
 public:
  ...
  void SetTestRunArn(TestRunArnT&& value) {
    m_testRunArnHasBeenSet = true;
    m_testRunArn = std::forward<TestRunArnT>(value);
  }
  template <typename TestRunArnT = Aws::String>
  TestRunSummary& WithTestRunArn(TestRunArnT&& value) {
    SetTestRunArn(std::forward<TestRunArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TestSuiteIdT = Aws::String>
  TestRunSummary& WithTestSuiteId(TestSuiteIdT&& value) {
  ...
  inline TestRunSummary& WithTestSuiteVersion(int value) {
  ...
  template <typename TestConfigurationIdT = Aws::String>
  TestRunSummary& WithTestConfigurationId(TestConfigurationIdT&& value) {
  ...
  inline TestRunSummary& WithTestConfigurationVersion(int value) {
  ...
  template <typename StatusReasonT = Aws::String>
  TestRunSummary& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RunStartTimeT = Aws::Utils::DateTime>
  TestRunSummary& WithRunStartTime(RunStartTimeT&& value) {
  ...
  template <typename RunEndTimeT = Aws::Utils::DateTime>
  TestRunSummary& WithRunEndTime(RunEndTimeT&& value) {
