...
class SourceDatabaseMetadata {
 public:
  ...
  inline void SetType(SourceDatabase value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline SourceDatabaseMetadata& WithType(SourceDatabase value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline SourceDatabaseMetadata& WithCaptureTool(CaptureTool value) {
