...
class ListTestRunsRequest : public AppTestRequest {
 public:
  ...
  template <typename TestSuiteIdT = Aws::String>
  ListTestRunsRequest& WithTestSuiteId(TestSuiteIdT&& value) {
  ...
  void SetTestRunIds(TestRunIdsT&& value) {
    m_testRunIdsHasBeenSet = true;
    m_testRunIds = std::forward<TestRunIdsT>(value);
  }
  template <typename TestRunIdsT = Aws::Vector<Aws::String>>
  ListTestRunsRequest& WithTestRunIds(TestRunIdsT&& value) {
    SetTestRunIds(std::forward<TestRunIdsT>(value));
    return *this;
  }
  template <typename TestRunIdsT = Aws::String>
  ListTestRunsRequest& AddTestRunIds(TestRunIdsT&& value) {
    m_testRunIdsHasBeenSet = true;
    m_testRunIds.emplace_back(std::forward<TestRunIdsT>(value));
    return *this;
  }
  ///@}
