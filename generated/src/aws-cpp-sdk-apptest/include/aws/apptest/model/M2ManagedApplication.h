...
class M2ManagedApplication {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  M2ManagedApplication& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline void SetRuntime(M2ManagedRuntime value) {
    m_runtimeHasBeenSet = true;
    m_runtime = value;
  }
  inline M2ManagedApplication& WithRuntime(M2ManagedRuntime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  template <typename VpcEndpointServiceNameT = Aws::String>
  M2ManagedApplication& WithVpcEndpointServiceName(VpcEndpointServiceNameT&& value) {
  ...
  template <typename ListenerPortT = Aws::String>
  M2ManagedApplication& WithListenerPort(ListenerPortT&& value) {
