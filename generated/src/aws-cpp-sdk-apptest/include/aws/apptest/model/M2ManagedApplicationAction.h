...
class M2ManagedApplicationAction {
 public:
  ...
  template <typename ResourceT = Aws::String>
  M2ManagedApplicationAction& WithResource(ResourceT&& value) {
  ...
  inline void SetActionType(M2ManagedActionType value) {
    m_actionTypeHasBeenSet = true;
    m_actionType = value;
  }
  inline M2ManagedApplicationAction& WithActionType(M2ManagedActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PropertiesT = M2ManagedActionProperties>
  M2ManagedApplicationAction& WithProperties(PropertiesT&& value) {
