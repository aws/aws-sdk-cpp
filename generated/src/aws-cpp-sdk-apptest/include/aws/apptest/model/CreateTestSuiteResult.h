...
class CreateTestSuiteResult {
 public:
  ...
  template <typename TestSuiteIdT = Aws::String>
  CreateTestSuiteResult& WithTestSuiteId(TestSuiteIdT&& value) {
  ...
  inline CreateTestSuiteResult& WithTestSuiteVersion(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTestSuiteResult& WithRequestId(RequestIdT&& value) {
