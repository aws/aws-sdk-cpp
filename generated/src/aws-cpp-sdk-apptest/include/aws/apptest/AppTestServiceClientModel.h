...
typedef std::function<void(const AppTestClient*, const Model::CreateTestCaseRequest&, const Model::CreateTestCaseOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateTestCaseResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::CreateTestConfigurationRequest&, const Model::CreateTestConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateTestConfigurationResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::CreateTestSuiteRequest&, const Model::CreateTestSuiteOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateTestSuiteResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::DeleteTestCaseRequest&, const Model::DeleteTestCaseOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteTestCaseResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::DeleteTestConfigurationRequest&, const Model::DeleteTestConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteTestConfigurationResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::DeleteTestRunRequest&, const Model::DeleteTestRunOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteTestRunResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::DeleteTestSuiteRequest&, const Model::DeleteTestSuiteOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteTestSuiteResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::GetTestCaseRequest&, const Model::GetTestCaseOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTestCaseResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::GetTestConfigurationRequest&, const Model::GetTestConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTestConfigurationResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::GetTestRunStepRequest&, const Model::GetTestRunStepOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTestRunStepResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::GetTestSuiteRequest&, const Model::GetTestSuiteOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTestSuiteResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::ListTagsForResourceRequest&, const Model::ListTagsForResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::ListTestCasesRequest&, const Model::ListTestCasesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTestCasesResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::ListTestConfigurationsRequest&, const Model::ListTestConfigurationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTestConfigurationsResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::ListTestRunStepsRequest&, const Model::ListTestRunStepsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTestRunStepsResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::ListTestRunTestCasesRequest&, const Model::ListTestRunTestCasesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTestRunTestCasesResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::ListTestRunsRequest&, const Model::ListTestRunsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTestRunsResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::ListTestSuitesRequest&, const Model::ListTestSuitesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTestSuitesResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::StartTestRunRequest&, const Model::StartTestRunOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartTestRunResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::UpdateTestCaseRequest&, const Model::UpdateTestCaseOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateTestCaseResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::UpdateTestConfigurationRequest&, const Model::UpdateTestConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateTestConfigurationResponseReceivedHandler;
typedef std::function<void(const AppTestClient*, const Model::UpdateTestSuiteRequest&, const Model::UpdateTestSuiteOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
