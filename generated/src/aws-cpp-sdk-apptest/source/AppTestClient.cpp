...
AppTestClient::AppTestClient(const AWSCredentials& credentials, std::shared_ptr<AppTestEndpointProviderBase> endpointProvider,
...
AppTestClient::AppTestClient(const AWSCredentials& credentials, const Client::ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<AWSAuthV4Signer>(ALLOCATION_TAG, Aws::MakeShared<SimpleAWSCredentialsProvider>(ALLOCATION_TAG, credentials),
                                                 SERVICE_NAME, Aws::Region::ComputeSignerRegion(clientConfiguration.region)),
                Aws::MakeShared<AppTestErrorMarshaller>(ALLOCATION_TAG)),
...
AppTestClient::~AppTestClient() { ShutdownSdkClient(this, -1); }

std::shared_ptr<AppTestEndpointProviderBase>& AppTestClient::accessEndpointProvider() { return m_endpointProvider; }
...
void AppTestClient::init(const AppTest::AppTestClientConfiguration& config) {
  ...
  if (!config.endpointOverride.empty()) {
    ...
    Aws::Config::EndpointResolver::EndpointSource("apptest", config.profileName, *m_endpointProvider);
  }
}
  ...
  return TracingUtils::MakeCallWithTiming<CreateTestConfigurationOutcome>(
      [&]() -> CreateTestConfigurationOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, CreateTestConfiguration, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testconfiguration");
        return CreateTestConfigurationOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
  ...
  return TracingUtils::MakeCallWithTiming<CreateTestSuiteOutcome>(
      [&]() -> CreateTestSuiteOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, CreateTestSuite, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testsuite");
        return CreateTestSuiteOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
...
DeleteTestCaseOutcome AppTestClient::DeleteTestCase(const DeleteTestCaseRequest& request) const {
  ...
  if (!request.TestCaseIdHasBeenSet()) {
    ...
    return DeleteTestCaseOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
...
DeleteTestConfigurationOutcome AppTestClient::DeleteTestConfiguration(const DeleteTestConfigurationRequest& request) const {
  ...
  if (!request.TestConfigurationIdHasBeenSet()) {
    ...
    return DeleteTestConfigurationOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                               "Missing required field [TestConfigurationId]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<DeleteTestConfigurationOutcome>(
      [&]() -> DeleteTestConfigurationOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, DeleteTestConfiguration, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        ...
        return DeleteTestConfigurationOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_DELETE, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
...
DeleteTestRunOutcome AppTestClient::DeleteTestRun(const DeleteTestRunRequest& request) const {
  ...
  if (!request.TestRunIdHasBeenSet()) {
    ...
    return DeleteTestRunOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
  ...
  return TracingUtils::MakeCallWithTiming<DeleteTestRunOutcome>(
      [&]() -> DeleteTestRunOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, DeleteTestRun, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
...
DeleteTestSuiteOutcome AppTestClient::DeleteTestSuite(const DeleteTestSuiteRequest& request) const {
  ...
  if (!request.TestSuiteIdHasBeenSet()) {
    ...
    return DeleteTestSuiteOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                       "Missing required field [TestSuiteId]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<DeleteTestSuiteOutcome>(
      [&]() -> DeleteTestSuiteOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, DeleteTestSuite, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
...
GetTestCaseOutcome AppTestClient::GetTestCase(const GetTestCaseRequest& request) const {
  ...
  if (!request.TestCaseIdHasBeenSet()) {
    ...
    return GetTestCaseOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                   "Missing required field [TestCaseId]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<GetTestCaseOutcome>(
      [&]() -> GetTestCaseOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, GetTestCase, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testcases/");
        endpointResolutionOutcome.GetResult().AddPathSegment(request.GetTestCaseId());
        return GetTestCaseOutcome(
...
GetTestConfigurationOutcome AppTestClient::GetTestConfiguration(const GetTestConfigurationRequest& request) const {
  ...
  if (!request.TestConfigurationIdHasBeenSet()) {
    ...
    return GetTestConfigurationOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                            "Missing required field [TestConfigurationId]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<GetTestConfigurationOutcome>(
      [&]() -> GetTestConfigurationOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, GetTestConfiguration, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testconfigurations/");
        endpointResolutionOutcome.GetResult().AddPathSegment(request.GetTestConfigurationId());
        return GetTestConfigurationOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_GET, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
...
GetTestRunStepOutcome AppTestClient::GetTestRunStep(const GetTestRunStepRequest& request) const {
  ...
  if (!request.TestRunIdHasBeenSet()) {
    ...
    return GetTestRunStepOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                      "Missing required field [TestRunId]", false));
  }
  if (!request.StepNameHasBeenSet()) {
    AWS_LOGSTREAM_ERROR("GetTestRunStep", "Required field: StepName, is not set");
    return GetTestRunStepOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                      "Missing required field [StepName]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<GetTestRunStepOutcome>(
      [&]() -> GetTestRunStepOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, GetTestRunStep, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testruns/");
        endpointResolutionOutcome.GetResult().AddPathSegment(request.GetTestRunId());
...
GetTestSuiteOutcome AppTestClient::GetTestSuite(const GetTestSuiteRequest& request) const {
  ...
  if (!request.TestSuiteIdHasBeenSet()) {
    ...
    return GetTestSuiteOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                    "Missing required field [TestSuiteId]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<GetTestSuiteOutcome>(
      [&]() -> GetTestSuiteOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, GetTestSuite, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testsuites/");
        endpointResolutionOutcome.GetResult().AddPathSegment(request.GetTestSuiteId());
        return GetTestSuiteOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_GET, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
...
ListTagsForResourceOutcome AppTestClient::ListTagsForResource(const ListTagsForResourceRequest& request) const {
  ...
  if (!request.ResourceArnHasBeenSet()) {
    ...
    return ListTagsForResourceOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
  ...
  return TracingUtils::MakeCallWithTiming<ListTestConfigurationsOutcome>(
      [&]() -> ListTestConfigurationsOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, ListTestConfigurations, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testconfigurations");
        return ListTestConfigurationsOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_GET, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
...
ListTestRunStepsOutcome AppTestClient::ListTestRunSteps(const ListTestRunStepsRequest& request) const {
  ...
  if (!request.TestRunIdHasBeenSet()) {
    ...
    return ListTestRunStepsOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                        "Missing required field [TestRunId]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<ListTestRunStepsOutcome>(
      [&]() -> ListTestRunStepsOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, ListTestRunSteps, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testruns/");
        endpointResolutionOutcome.GetResult().AddPathSegment(request.GetTestRunId());
        endpointResolutionOutcome.GetResult().AddPathSegments("/steps");
        return ListTestRunStepsOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_GET, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
...
ListTestRunTestCasesOutcome AppTestClient::ListTestRunTestCases(const ListTestRunTestCasesRequest& request) const {
  ...
  if (!request.TestRunIdHasBeenSet()) {
    ...
    return ListTestRunTestCasesOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                            "Missing required field [TestRunId]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<ListTestRunTestCasesOutcome>(
      [&]() -> ListTestRunTestCasesOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, ListTestRunTestCases, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testruns/");
        endpointResolutionOutcome.GetResult().AddPathSegment(request.GetTestRunId());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testcases");
        return ListTestRunTestCasesOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_GET, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
  ...
  return TracingUtils::MakeCallWithTiming<ListTestRunsOutcome>(
      [&]() -> ListTestRunsOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, ListTestRuns, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testruns");
        return ListTestRunsOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_GET, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
  ...
  return TracingUtils::MakeCallWithTiming<ListTestSuitesOutcome>(
      [&]() -> ListTestSuitesOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, ListTestSuites, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testsuites");
        return ListTestSuitesOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_GET, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
  ...
  return TracingUtils::MakeCallWithTiming<StartTestRunOutcome>(
      [&]() -> StartTestRunOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, StartTestRun, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testrun");
        return StartTestRunOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
...
TagResourceOutcome AppTestClient::TagResource(const TagResourceRequest& request) const {
  ...
  if (!request.ResourceArnHasBeenSet()) {
    ...
    return TagResourceOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                   "Missing required field [ResourceArn]", false));
  }
...
UntagResourceOutcome AppTestClient::UntagResource(const UntagResourceRequest& request) const {
  ...
  if (!request.ResourceArnHasBeenSet()) {
    ...
    return UntagResourceOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                     "Missing required field [ResourceArn]", false));
  }
...
UpdateTestCaseOutcome AppTestClient::UpdateTestCase(const UpdateTestCaseRequest& request) const {
  ...
  if (!request.TestCaseIdHasBeenSet()) {
    ...
    return UpdateTestCaseOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                      "Missing required field [TestCaseId]", false));
  }
...
UpdateTestConfigurationOutcome AppTestClient::UpdateTestConfiguration(const UpdateTestConfigurationRequest& request) const {
  ...
  if (!request.TestConfigurationIdHasBeenSet()) {
    ...
    return UpdateTestConfigurationOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                               "Missing required field [TestConfigurationId]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<UpdateTestConfigurationOutcome>(
      [&]() -> UpdateTestConfigurationOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, UpdateTestConfiguration, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testconfigurations/");
        endpointResolutionOutcome.GetResult().AddPathSegment(request.GetTestConfigurationId());
        return UpdateTestConfigurationOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_PATCH, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
...
UpdateTestSuiteOutcome AppTestClient::UpdateTestSuite(const UpdateTestSuiteRequest& request) const {
  ...
  if (!request.TestSuiteIdHasBeenSet()) {
    ...
    return UpdateTestSuiteOutcome(Aws::Client::AWSError<AppTestErrors>(AppTestErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                       "Missing required field [TestSuiteId]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<UpdateTestSuiteOutcome>(
      [&]() -> UpdateTestSuiteOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, UpdateTestSuite, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/testsuites/");
        endpointResolutionOutcome.GetResult().AddPathSegment(request.GetTestSuiteId());
        return UpdateTestSuiteOutcome(
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_PATCH, Aws::Auth::SIGV4_SIGNER));
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
