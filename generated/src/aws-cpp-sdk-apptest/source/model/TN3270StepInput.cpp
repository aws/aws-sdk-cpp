...
TN3270StepInput::TN3270StepInput(JsonView jsonValue) { *this = jsonValue; }
...
TN3270StepInput& TN3270StepInput::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("exportDataSetNames")) {
    ...
    for (unsigned exportDataSetNamesIndex = 0; exportDataSetNamesIndex < exportDataSetNamesJsonList.GetLength();
         ++exportDataSetNamesIndex) {
