...
ResourceActionSummary::ResourceActionSummary(JsonView jsonValue) { *this = jsonValue; }

ResourceActionSummary& ResourceActionSummary::operator=(JsonView jsonValue) {
...
JsonValue ResourceActionSummary::Jsonize() const {
  JsonValue payload;
