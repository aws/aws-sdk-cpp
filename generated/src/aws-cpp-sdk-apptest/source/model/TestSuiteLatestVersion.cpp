...
TestSuiteLatestVersion::TestSuiteLatestVersion(JsonView jsonValue) { *this = jsonValue; }

TestSuiteLatestVersion& TestSuiteLatestVersion::operator=(JsonView jsonValue) {
...
JsonValue TestSuiteLatestVersion::Jsonize() const {
  JsonValue payload;
