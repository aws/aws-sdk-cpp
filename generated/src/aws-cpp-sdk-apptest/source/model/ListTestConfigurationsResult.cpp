...
ListTestConfigurationsResult::ListTestConfigurationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListTestConfigurationsResult& ListTestConfigurationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("testConfigurations")) {
    ...
    for (unsigned testConfigurationsIndex = 0; testConfigurationsIndex < testConfigurationsJsonList.GetLength();
