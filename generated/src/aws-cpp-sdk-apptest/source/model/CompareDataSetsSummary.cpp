...
CompareDataSetsSummary::CompareDataSetsSummary(JsonView jsonValue) { *this = jsonValue; }

CompareDataSetsSummary& CompareDataSetsSummary::operator=(JsonView jsonValue) {
...
JsonValue CompareDataSetsSummary::Jsonize() const {
  JsonValue payload;
