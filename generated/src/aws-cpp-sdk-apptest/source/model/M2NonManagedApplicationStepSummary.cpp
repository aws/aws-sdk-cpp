...
M2NonManagedApplicationStepSummary::M2NonManagedApplicationStepSummary(JsonView jsonValue) { *this = jsonValue; }

M2NonManagedApplicationStepSummary& M2NonManagedApplicationStepSummary::operator=(JsonView jsonValue) {
...
JsonValue M2NonManagedApplicationStepSummary::Jsonize() const {
  JsonValue payload;
