...
'"','h','t','t','p','s',':','/','/','a','p','p','t','e','s','t','-','f','i','p','s','.','{','R','e',
...
'p','s',':','/','/','a','p','p','t','e','s','t','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','t','e','s','t','.','{','R','e','g','i',
...
const char* AppTestEndpointRules::GetRulesBlob()
{
