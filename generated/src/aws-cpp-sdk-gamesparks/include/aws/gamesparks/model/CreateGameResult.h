...
namespace Model
{
  ...
  public:
    ...
    inline CreateGameResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateGameResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateGameResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
