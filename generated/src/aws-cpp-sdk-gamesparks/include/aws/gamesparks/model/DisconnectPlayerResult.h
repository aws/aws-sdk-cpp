...
namespace Model
{
  ...
  public:
    ...
    inline DisconnectPlayerResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisconnectPlayerResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisconnectPlayerResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
