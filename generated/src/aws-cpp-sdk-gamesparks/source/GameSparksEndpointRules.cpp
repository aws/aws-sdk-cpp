...
{
const size_t GameSparksEndpointRules::RulesBlobStrLen = 3488;
const size_t GameSparksEndpointRules::RulesBlobSize = 3489;
...
's','p','a','r','k','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','a','m','e','s','p','a','r','k',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','a','m','e','s','p','a','r','k','s','.',
