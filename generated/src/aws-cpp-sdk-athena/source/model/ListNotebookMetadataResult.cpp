...
ListNotebookMetadataResult::ListNotebookMetadataResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListNotebookMetadataResult& ListNotebookMetadataResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("NotebookMetadataList")) {
    ...
    for (unsigned notebookMetadataListIndex = 0; notebookMetadataListIndex < notebookMetadataListJsonList.GetLength();
         ++notebookMetadataListIndex) {
