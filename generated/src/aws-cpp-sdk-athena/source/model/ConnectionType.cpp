  ...
  namespace Athena
  {
    namespace Model
    {
      namespace ConnectionTypeMapper
      {
        ...
        static const int MSK_HASH = HashingUtils::HashString("MSK");
        ...
        static const int HORTONWORKSHIVE_HASH = HashingUtils::HashString("HORTONWORKSHIVE");
        ...
        ConnectionType GetConnectionTypeForName(const Aws::String& name)
        {
          ...
          else if (hashCode == MSK_HASH)
          {
            return ConnectionType::MSK;
          }
          else if (hashCode == NEPTUNE_HASH)
          {
            return ConnectionType::NEPTUNE;
          }
          ...
          else if (hashCode == HORTONWORKSHIVE_HASH)
          {
            return ConnectionType::HORTONWORKSHIVE;
          }
        ...
        Aws::String GetNameForConnectionType(ConnectionType enumValue)
        {
          ...
          case ConnectionType::DOCUMENTDB:
            return "DOCUMENTDB";
          case ConnectionType::MSK:
            return "MSK";
          case ConnectionType::NEPTUNE:
            return "NEPTUNE";
          ...
          case ConnectionType::CLOUDERAHIVE:
            return "CLOUDERAHIVE";
          case ConnectionType::HORTONWORKSHIVE:
            return "HORTONWORKSHIVE";
