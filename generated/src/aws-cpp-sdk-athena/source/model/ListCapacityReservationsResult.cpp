...
ListCapacityReservationsResult::ListCapacityReservationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListCapacityReservationsResult& ListCapacityReservationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("CapacityReservations")) {
    ...
    for (unsigned capacityReservationsIndex = 0; capacityReservationsIndex < capacityReservationsJsonList.GetLength();
         ++capacityReservationsIndex) {
