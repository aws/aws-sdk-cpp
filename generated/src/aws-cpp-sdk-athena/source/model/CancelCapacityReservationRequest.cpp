...
Aws::Http::HeaderValueCollection CancelCapacityReservationRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AmazonAthena.CancelCapacityReservation"));
  return headers;
