...
QueryExecution::QueryExecution(JsonView jsonValue) { *this = jsonValue; }
...
QueryExecution& QueryExecution::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ExecutionParameters")) {
    ...
    for (unsigned executionParametersIndex = 0; executionParametersIndex < executionParametersJsonList.GetLength();
         ++executionParametersIndex) {
