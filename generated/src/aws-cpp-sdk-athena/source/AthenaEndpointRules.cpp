...
namespace Athena
{
const size_t AthenaEndpointRules::RulesBlobStrLen = 3724;
const size_t AthenaEndpointRules::RulesBlobSize = 3725;
...
'/','a','t','h','e','n','a','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'l','"',':','"','h','t','t','p','s',':','/','/','a','t','h','e','n','a','.','{','R','e','g','i','o',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','t','h','e','n','a','.','{','R','e',
