...
namespace Model
{
  ...
  /**
   */
  class ListQueryExecutionsRequest : public AthenaRequest
  {
  public:
    AWS_ATHENA_API ListQueryExecutionsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListQueryExecutionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkGroupT = Aws::String>
    ListQueryExecutionsRequest& WithWorkGroup(WorkGroupT&& value) { SetWorkGroup(std::forward<WorkGroupT>(value)); return *this;}
    ///@}
  private:
