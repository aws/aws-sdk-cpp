...
class ListQueryExecutionsRequest : public AthenaRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListQueryExecutionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListQueryExecutionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename WorkGroupT = Aws::String>
  ListQueryExecutionsRequest& WithWorkGroup(WorkGroupT&& value) {
