...
class DeleteDataCatalogRequest : public AthenaRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  DeleteDataCatalogRequest& WithName(NameT&& value) {
  ...
  inline void SetDeleteCatalogOnly(bool value) {
    m_deleteCatalogOnlyHasBeenSet = true;
    m_deleteCatalogOnly = value;
  }
  inline DeleteDataCatalogRequest& WithDeleteCatalogOnly(bool value) {
    SetDeleteCatalogOnly(value);
    return *this;
  }
  ///@}
 private:
