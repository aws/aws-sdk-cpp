...
class StartQueryExecutionRequest : public AthenaRequest {
 public:
  ...
  template <typename QueryStringT = Aws::String>
  StartQueryExecutionRequest& WithQueryString(QueryStringT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartQueryExecutionRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename QueryExecutionContextT = QueryExecutionContext>
  StartQueryExecutionRequest& WithQueryExecutionContext(QueryExecutionContextT&& value) {
  ...
  template <typename ResultConfigurationT = ResultConfiguration>
  StartQueryExecutionRequest& WithResultConfiguration(ResultConfigurationT&& value) {
  ...
  template <typename WorkGroupT = Aws::String>
  StartQueryExecutionRequest& WithWorkGroup(WorkGroupT&& value) {
  ...
  template <typename ExecutionParametersT = Aws::Vector<Aws::String>>
  StartQueryExecutionRequest& WithExecutionParameters(ExecutionParametersT&& value) {
    SetExecutionParameters(std::forward<ExecutionParametersT>(value));
    return *this;
  }
  template <typename ExecutionParametersT = Aws::String>
  StartQueryExecutionRequest& AddExecutionParameters(ExecutionParametersT&& value) {
    m_executionParametersHasBeenSet = true;
  ...
  template <typename ResultReuseConfigurationT = ResultReuseConfiguration>
  StartQueryExecutionRequest& WithResultReuseConfiguration(ResultReuseConfigurationT&& value) {
