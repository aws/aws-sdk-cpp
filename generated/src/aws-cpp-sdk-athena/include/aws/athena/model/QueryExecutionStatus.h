...
class QueryExecutionStatus {
 public:
  ...
  inline void SetState(QueryExecutionState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline QueryExecutionStatus& WithState(QueryExecutionState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetSubmissionDateTime(SubmissionDateTimeT&& value) {
    ...
    m_submissionDateTime = std::forward<SubmissionDateTimeT>(value);
  }
  template <typename SubmissionDateTimeT = Aws::Utils::DateTime>
  QueryExecutionStatus& WithSubmissionDateTime(SubmissionDateTimeT&& value) {
    SetSubmissionDateTime(std::forward<SubmissionDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCompletionDateTime(CompletionDateTimeT&& value) {
    ...
    m_completionDateTime = std::forward<CompletionDateTimeT>(value);
  }
  template <typename CompletionDateTimeT = Aws::Utils::DateTime>
  QueryExecutionStatus& WithCompletionDateTime(CompletionDateTimeT&& value) {
    SetCompletionDateTime(std::forward<CompletionDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAthenaError(AthenaErrorT&& value) {
    ...
    m_athenaError = std::forward<AthenaErrorT>(value);
  }
  template <typename AthenaErrorT = AthenaError>
  QueryExecutionStatus& WithAthenaError(AthenaErrorT&& value) {
    SetAthenaError(std::forward<AthenaErrorT>(value));
    return *this;
  }
  ///@}
 private:
