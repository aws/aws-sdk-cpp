...
class ListEngineVersionsResult {
 public:
  ...
  template <typename EngineVersionsT = Aws::Vector<EngineVersion>>
  ListEngineVersionsResult& WithEngineVersions(EngineVersionsT&& value) {
    SetEngineVersions(std::forward<EngineVersionsT>(value));
    return *this;
  }
  template <typename EngineVersionsT = EngineVersion>
  ListEngineVersionsResult& AddEngineVersions(EngineVersionsT&& value) {
    m_engineVersionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEngineVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEngineVersionsResult& WithRequestId(RequestIdT&& value) {
