...
class QueryRuntimeStatisticsRows {
 public:
  ...
  inline void SetInputRows(long long value) {
    m_inputRowsHasBeenSet = true;
    m_inputRows = value;
  }
  inline QueryRuntimeStatisticsRows& WithInputRows(long long value) {
    SetInputRows(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInputBytes(long long value) {
    m_inputBytesHasBeenSet = true;
    m_inputBytes = value;
  }
  inline QueryRuntimeStatisticsRows& WithInputBytes(long long value) {
    SetInputBytes(value);
    return *this;
  }
  ///@}
  ...
  inline QueryRuntimeStatisticsRows& WithOutputBytes(long long value) {
  ...
  inline QueryRuntimeStatisticsRows& WithOutputRows(long long value) {
    SetOutputRows(value);
    return *this;
  }
  ///@}
