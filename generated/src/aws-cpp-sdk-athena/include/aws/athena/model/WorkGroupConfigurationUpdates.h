...
class WorkGroupConfigurationUpdates {
 public:
  ...
  inline void SetEnforceWorkGroupConfiguration(bool value) {
    m_enforceWorkGroupConfigurationHasBeenSet = true;
    m_enforceWorkGroupConfiguration = value;
  }
  inline WorkGroupConfigurationUpdates& WithEnforceWorkGroupConfiguration(bool value) {
    SetEnforceWorkGroupConfiguration(value);
    return *this;
  }
  ///@}
  ...
  void SetResultConfigurationUpdates(ResultConfigurationUpdatesT&& value) {
    ...
    m_resultConfigurationUpdates = std::forward<ResultConfigurationUpdatesT>(value);
  }
  template <typename ResultConfigurationUpdatesT = ResultConfigurationUpdates>
  WorkGroupConfigurationUpdates& WithResultConfigurationUpdates(ResultConfigurationUpdatesT&& value) {
    SetResultConfigurationUpdates(std::forward<ResultConfigurationUpdatesT>(value));
    return *this;
  }
  ///@}
   ...
   * workgroup.</p>
   */
  inline const ManagedQueryResultsConfigurationUpdates& GetManagedQueryResultsConfigurationUpdates() const {
    return m_managedQueryResultsConfigurationUpdates;
  }
  ...
  void SetManagedQueryResultsConfigurationUpdates(ManagedQueryResultsConfigurationUpdatesT&& value) {
    ...
    m_managedQueryResultsConfigurationUpdates = std::forward<ManagedQueryResultsConfigurationUpdatesT>(value);
  }
  template <typename ManagedQueryResultsConfigurationUpdatesT = ManagedQueryResultsConfigurationUpdates>
  WorkGroupConfigurationUpdates& WithManagedQueryResultsConfigurationUpdates(ManagedQueryResultsConfigurationUpdatesT&& value) {
    SetManagedQueryResultsConfigurationUpdates(std::forward<ManagedQueryResultsConfigurationUpdatesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPublishCloudWatchMetricsEnabled(bool value) {
    m_publishCloudWatchMetricsEnabledHasBeenSet = true;
    m_publishCloudWatchMetricsEnabled = value;
  }
  inline WorkGroupConfigurationUpdates& WithPublishCloudWatchMetricsEnabled(bool value) {
    SetPublishCloudWatchMetricsEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBytesScannedCutoffPerQuery(long long value) {
    m_bytesScannedCutoffPerQueryHasBeenSet = true;
    m_bytesScannedCutoffPerQuery = value;
  }
  inline WorkGroupConfigurationUpdates& WithBytesScannedCutoffPerQuery(long long value) {
    SetBytesScannedCutoffPerQuery(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRemoveBytesScannedCutoffPerQuery(bool value) {
    m_removeBytesScannedCutoffPerQueryHasBeenSet = true;
    m_removeBytesScannedCutoffPerQuery = value;
  }
  inline WorkGroupConfigurationUpdates& WithRemoveBytesScannedCutoffPerQuery(bool value) {
    SetRemoveBytesScannedCutoffPerQuery(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequesterPaysEnabled(bool value) {
    m_requesterPaysEnabledHasBeenSet = true;
    m_requesterPaysEnabled = value;
  }
  inline WorkGroupConfigurationUpdates& WithRequesterPaysEnabled(bool value) {
    SetRequesterPaysEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline bool RemoveCustomerContentEncryptionConfigurationHasBeenSet() const {
    return m_removeCustomerContentEncryptionConfigurationHasBeenSet;
  }
  inline void SetRemoveCustomerContentEncryptionConfiguration(bool value) {
    m_removeCustomerContentEncryptionConfigurationHasBeenSet = true;
    m_removeCustomerContentEncryptionConfiguration = value;
  }
  inline WorkGroupConfigurationUpdates& WithRemoveCustomerContentEncryptionConfiguration(bool value) {
    SetRemoveCustomerContentEncryptionConfiguration(value);
    return *this;
  }
  ///@}
  ...
  inline const CustomerContentEncryptionConfiguration& GetCustomerContentEncryptionConfiguration() const {
    return m_customerContentEncryptionConfiguration;
  }
  ...
  void SetCustomerContentEncryptionConfiguration(CustomerContentEncryptionConfigurationT&& value) {
    ...
    m_customerContentEncryptionConfiguration = std::forward<CustomerContentEncryptionConfigurationT>(value);
  }
  template <typename CustomerContentEncryptionConfigurationT = CustomerContentEncryptionConfiguration>
  WorkGroupConfigurationUpdates& WithCustomerContentEncryptionConfiguration(CustomerContentEncryptionConfigurationT&& value) {
    SetCustomerContentEncryptionConfiguration(std::forward<CustomerContentEncryptionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEnableMinimumEncryptionConfiguration(bool value) {
    m_enableMinimumEncryptionConfigurationHasBeenSet = true;
    m_enableMinimumEncryptionConfiguration = value;
  }
  inline WorkGroupConfigurationUpdates& WithEnableMinimumEncryptionConfiguration(bool value) {
    SetEnableMinimumEncryptionConfiguration(value);
    return *this;
  }
  ///@}
