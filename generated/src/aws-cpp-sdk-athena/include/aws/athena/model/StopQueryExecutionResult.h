...
namespace Model
{
  ...
  {
  public:
    AWS_ATHENA_API StopQueryExecutionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StopQueryExecutionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
