...
class ApplicationDPUSizes {
 public:
  ...
  void SetApplicationRuntimeId(ApplicationRuntimeIdT&& value) {
    m_applicationRuntimeIdHasBeenSet = true;
    m_applicationRuntimeId = std::forward<ApplicationRuntimeIdT>(value);
  }
  template <typename ApplicationRuntimeIdT = Aws::String>
  ApplicationDPUSizes& WithApplicationRuntimeId(ApplicationRuntimeIdT&& value) {
    SetApplicationRuntimeId(std::forward<ApplicationRuntimeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSupportedDPUSizes(SupportedDPUSizesT&& value) {
    m_supportedDPUSizesHasBeenSet = true;
    m_supportedDPUSizes = std::forward<SupportedDPUSizesT>(value);
  }
  template <typename SupportedDPUSizesT = Aws::Vector<int>>
  ApplicationDPUSizes& WithSupportedDPUSizes(SupportedDPUSizesT&& value) {
    SetSupportedDPUSizes(std::forward<SupportedDPUSizesT>(value));
    return *this;
  }
  inline ApplicationDPUSizes& AddSupportedDPUSizes(int value) {
    m_supportedDPUSizesHasBeenSet = true;
    m_supportedDPUSizes.push_back(value);
    return *this;
  }
  ///@}
 private:
