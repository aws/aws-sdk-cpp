...
class ListExecutorsRequest : public AthenaRequest {
 public:
  ...
  inline void SetExecutorStateFilter(ExecutorState value) {
    m_executorStateFilterHasBeenSet = true;
    m_executorStateFilter = value;
  }
  inline ListExecutorsRequest& WithExecutorStateFilter(ExecutorState value) {
    SetExecutorStateFilter(value);
    return *this;
  }
  ///@}
  ...
  inline ListExecutorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
