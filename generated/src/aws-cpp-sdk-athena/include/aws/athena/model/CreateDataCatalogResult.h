...
namespace Model
{
  ...
  {
  public:
    AWS_ATHENA_API CreateDataCatalogResult();
    ...
    inline CreateDataCatalogResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateDataCatalogResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
