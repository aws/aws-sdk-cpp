...
namespace Model
{
  ...
  {
  public:
    AWS_ATHENA_API UpdateWorkGroupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateWorkGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
