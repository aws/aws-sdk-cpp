...
class GetNamedQueryResult {
 public:
  ...
  void SetNamedQuery(NamedQueryT&& value) {
    m_namedQueryHasBeenSet = true;
    m_namedQuery = std::forward<NamedQueryT>(value);
  }
  template <typename NamedQueryT = NamedQuery>
  GetNamedQueryResult& WithNamedQuery(NamedQueryT&& value) {
    SetNamedQuery(std::forward<NamedQueryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetNamedQueryResult& WithRequestId(RequestIdT&& value) {
