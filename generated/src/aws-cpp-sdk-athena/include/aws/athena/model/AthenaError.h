...
class AthenaError {
 public:
  ...
  inline void SetErrorCategory(int value) {
    m_errorCategoryHasBeenSet = true;
    m_errorCategory = value;
  }
  inline AthenaError& WithErrorCategory(int value) {
  ...
  inline void SetErrorType(int value) {
    m_errorTypeHasBeenSet = true;
    m_errorType = value;
  }
  inline AthenaError& WithErrorType(int value) {
    SetErrorType(value);
    return *this;
  }
  ///@}
  ...
  inline AthenaError& WithRetryable(bool value) {
    SetRetryable(value);
    return *this;
  }
  ///@}
