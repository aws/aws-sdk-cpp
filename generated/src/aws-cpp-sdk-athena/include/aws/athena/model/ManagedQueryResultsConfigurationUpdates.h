...
class ManagedQueryResultsConfigurationUpdates {
 public:
  ...
  inline ManagedQueryResultsConfigurationUpdates& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline ManagedQueryResultsConfigurationUpdates& WithRemoveEncryptionConfiguration(bool value) {
