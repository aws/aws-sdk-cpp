...
namespace Model
{
  ...
  {
  public:
    AWS_ATHENA_API UpdateCapacityReservationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateCapacityReservationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
