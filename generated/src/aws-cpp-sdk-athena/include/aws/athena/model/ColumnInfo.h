...
class ColumnInfo {
 public:
  ...
  inline ColumnInfo& WithPrecision(int value) {
    SetPrecision(value);
    return *this;
  }
  ///@}
  ...
  inline ColumnInfo& WithScale(int value) {
    SetScale(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNullable(ColumnNullable value) {
    m_nullableHasBeenSet = true;
    m_nullable = value;
  }
  inline ColumnInfo& WithNullable(ColumnNullable value) {
    SetNullable(value);
    return *this;
  }
  ///@}
  ...
  inline ColumnInfo& WithCaseSensitive(bool value) {
