...
class StartCalculationExecutionResult {
 public:
  ...
  template <typename CalculationExecutionIdT = Aws::String>
  StartCalculationExecutionResult& WithCalculationExecutionId(CalculationExecutionIdT&& value) {
  ...
  inline StartCalculationExecutionResult& WithState(CalculationExecutionState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartCalculationExecutionResult& WithRequestId(RequestIdT&& value) {
