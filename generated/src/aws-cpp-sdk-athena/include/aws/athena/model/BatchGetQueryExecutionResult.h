...
class BatchGetQueryExecutionResult {
 public:
  ...
  void SetUnprocessedQueryExecutionIds(UnprocessedQueryExecutionIdsT&& value) {
    ...
    m_unprocessedQueryExecutionIds = std::forward<UnprocessedQueryExecutionIdsT>(value);
  }
  template <typename UnprocessedQueryExecutionIdsT = Aws::Vector<UnprocessedQueryExecutionId>>
  BatchGetQueryExecutionResult& WithUnprocessedQueryExecutionIds(UnprocessedQueryExecutionIdsT&& value) {
    SetUnprocessedQueryExecutionIds(std::forward<UnprocessedQueryExecutionIdsT>(value));
    return *this;
  }
  ...
  BatchGetQueryExecutionResult& AddUnprocessedQueryExecutionIds(UnprocessedQueryExecutionIdsT&& value) {
    m_unprocessedQueryExecutionIdsHasBeenSet = true;
    m_unprocessedQueryExecutionIds.emplace_back(std::forward<UnprocessedQueryExecutionIdsT>(value));
    return *this;
  }
  ///@}
