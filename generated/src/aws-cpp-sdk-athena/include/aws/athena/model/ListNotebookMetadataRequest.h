...
class ListNotebookMetadataRequest : public AthenaRequest {
 public:
  ...
  template <typename FiltersT = FilterDefinition>
  ListNotebookMetadataRequest& WithFilters(FiltersT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListNotebookMetadataRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListNotebookMetadataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename WorkGroupT = Aws::String>
  ListNotebookMetadataRequest& WithWorkGroup(WorkGroupT&& value) {
