...
/**
 */
class ListEngineVersionsRequest : public AthenaRequest {
 public:
  AWS_ATHENA_API ListEngineVersionsRequest() = default;
  ...
  inline ListEngineVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
