...
class CreatePresignedNotebookUrlResult {
 public:
  ...
  void SetNotebookUrl(NotebookUrlT&& value) {
    ...
    m_notebookUrl = std::forward<NotebookUrlT>(value);
  }
  template <typename NotebookUrlT = Aws::String>
  CreatePresignedNotebookUrlResult& WithNotebookUrl(NotebookUrlT&& value) {
    SetNotebookUrl(std::forward<NotebookUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAuthTokenExpirationTime(long long value) {
    m_authTokenExpirationTimeHasBeenSet = true;
    m_authTokenExpirationTime = value;
  }
  inline CreatePresignedNotebookUrlResult& WithAuthTokenExpirationTime(long long value) {
    SetAuthTokenExpirationTime(value);
    return *this;
  }
  ///@}
