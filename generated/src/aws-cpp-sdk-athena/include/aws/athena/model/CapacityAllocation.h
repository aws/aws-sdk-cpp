...
class CapacityAllocation {
 public:
  ...
  inline void SetStatus(CapacityAllocationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CapacityAllocation& WithStatus(CapacityAllocationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  CapacityAllocation& WithStatusMessage(StatusMessageT&& value) {
  ...
  void SetRequestTime(RequestTimeT&& value) {
    ...
    m_requestTime = std::forward<RequestTimeT>(value);
  }
  template <typename RequestTimeT = Aws::Utils::DateTime>
  CapacityAllocation& WithRequestTime(RequestTimeT&& value) {
    SetRequestTime(std::forward<RequestTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequestCompletionTime(RequestCompletionTimeT&& value) {
    m_requestCompletionTimeHasBeenSet = true;
    m_requestCompletionTime = std::forward<RequestCompletionTimeT>(value);
  }
  template <typename RequestCompletionTimeT = Aws::Utils::DateTime>
  CapacityAllocation& WithRequestCompletionTime(RequestCompletionTimeT&& value) {
    SetRequestCompletionTime(std::forward<RequestCompletionTimeT>(value));
    return *this;
  }
  ///@}
 private:
