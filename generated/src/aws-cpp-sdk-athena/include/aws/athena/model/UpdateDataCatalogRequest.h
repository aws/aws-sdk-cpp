...
class UpdateDataCatalogRequest : public AthenaRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateDataCatalogRequest& WithName(NameT&& value) {
  ...
  inline UpdateDataCatalogRequest& WithType(DataCatalogType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  UpdateDataCatalogRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::String>>
  UpdateDataCatalogRequest& WithParameters(ParametersT&& value) {
