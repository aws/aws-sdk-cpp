...
class ListApplicationDPUSizesResult {
 public:
  ...
  void SetApplicationDPUSizes(ApplicationDPUSizesT&& value) {
    m_applicationDPUSizesHasBeenSet = true;
    m_applicationDPUSizes = std::forward<ApplicationDPUSizesT>(value);
  }
  template <typename ApplicationDPUSizesT = Aws::Vector<ApplicationDPUSizes>>
  ListApplicationDPUSizesResult& WithApplicationDPUSizes(ApplicationDPUSizesT&& value) {
    SetApplicationDPUSizes(std::forward<ApplicationDPUSizesT>(value));
    return *this;
  }
  template <typename ApplicationDPUSizesT = ApplicationDPUSizes>
  ListApplicationDPUSizesResult& AddApplicationDPUSizes(ApplicationDPUSizesT&& value) {
    m_applicationDPUSizesHasBeenSet = true;
    m_applicationDPUSizes.emplace_back(std::forward<ApplicationDPUSizesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationDPUSizesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApplicationDPUSizesResult& WithRequestId(RequestIdT&& value) {
