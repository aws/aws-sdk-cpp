...
class ResultReuseInformation {
 public:
  ...
  inline void SetReusedPreviousResult(bool value) {
    m_reusedPreviousResultHasBeenSet = true;
    m_reusedPreviousResult = value;
  }
  inline ResultReuseInformation& WithReusedPreviousResult(bool value) {
    SetReusedPreviousResult(value);
    return *this;
  }
  ///@}
 private:
