...
class CalculationSummary {
 public:
  ...
  template <typename CalculationExecutionIdT = Aws::String>
  CalculationSummary& WithCalculationExecutionId(CalculationExecutionIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CalculationSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename StatusT = CalculationStatus>
  CalculationSummary& WithStatus(StatusT&& value) {
