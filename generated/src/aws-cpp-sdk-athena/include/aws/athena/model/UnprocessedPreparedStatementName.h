...
class UnprocessedPreparedStatementName {
 public:
  ...
  template <typename StatementNameT = Aws::String>
  UnprocessedPreparedStatementName& WithStatementName(StatementNameT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  UnprocessedPreparedStatementName& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  UnprocessedPreparedStatementName& WithErrorMessage(ErrorMessageT&& value) {
