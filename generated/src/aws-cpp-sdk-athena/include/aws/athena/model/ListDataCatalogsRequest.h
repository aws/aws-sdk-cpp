...
namespace Model
{
  ...
  {
  public:
    AWS_ATHENA_API ListDataCatalogsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListDataCatalogsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkGroupT = Aws::String>
    ListDataCatalogsRequest& WithWorkGroup(WorkGroupT&& value) { SetWorkGroup(std::forward<WorkGroupT>(value)); return *this;}
    ///@}
  private:
