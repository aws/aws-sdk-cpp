...
class ListDataCatalogsRequest : public AthenaRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListDataCatalogsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDataCatalogsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename WorkGroupT = Aws::String>
  ListDataCatalogsRequest& WithWorkGroup(WorkGroupT&& value) {
