...
namespace Model
{
  ...
  /**
   */
  class ListPreparedStatementsRequest : public AthenaRequest
  {
  public:
    ...
    template<typename WorkGroupT = Aws::String>
    ListPreparedStatementsRequest& WithWorkGroup(WorkGroupT&& value) { SetWorkGroup(std::forward<WorkGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListPreparedStatementsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
