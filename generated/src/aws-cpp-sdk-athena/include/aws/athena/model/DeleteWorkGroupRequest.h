...
class DeleteWorkGroupRequest : public AthenaRequest {
 public:
  ...
  template <typename WorkGroupT = Aws::String>
  DeleteWorkGroupRequest& WithWorkGroup(WorkGroupT&& value) {
  ...
  inline void SetRecursiveDeleteOption(bool value) {
    m_recursiveDeleteOptionHasBeenSet = true;
    m_recursiveDeleteOption = value;
  }
  inline DeleteWorkGroupRequest& WithRecursiveDeleteOption(bool value) {
    SetRecursiveDeleteOption(value);
    return *this;
  }
  ///@}
 private:
