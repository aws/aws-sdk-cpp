...
class BatchGetPreparedStatementRequest : public AthenaRequest {
 public:
  ...
  void SetPreparedStatementNames(PreparedStatementNamesT&& value) {
    m_preparedStatementNamesHasBeenSet = true;
    m_preparedStatementNames = std::forward<PreparedStatementNamesT>(value);
  }
  template <typename PreparedStatementNamesT = Aws::Vector<Aws::String>>
  BatchGetPreparedStatementRequest& WithPreparedStatementNames(PreparedStatementNamesT&& value) {
    SetPreparedStatementNames(std::forward<PreparedStatementNamesT>(value));
    return *this;
  }
  ...
  BatchGetPreparedStatementRequest& AddPreparedStatementNames(PreparedStatementNamesT&& value) {
    m_preparedStatementNamesHasBeenSet = true;
    m_preparedStatementNames.emplace_back(std::forward<PreparedStatementNamesT>(value));
    return *this;
  }
  ///@}
