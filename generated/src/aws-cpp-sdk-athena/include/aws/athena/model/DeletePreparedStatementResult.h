...
namespace Model
{
  ...
  {
  public:
    AWS_ATHENA_API DeletePreparedStatementResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeletePreparedStatementResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
