...
class WorkGroupConfiguration {
 public:
  ...
  inline WorkGroupConfiguration& WithEnforceWorkGroupConfiguration(bool value) {
  ...
  inline WorkGroupConfiguration& WithPublishCloudWatchMetricsEnabled(bool value) {
  ...
  inline WorkGroupConfiguration& WithBytesScannedCutoffPerQuery(long long value) {
  ...
  inline WorkGroupConfiguration& WithRequesterPaysEnabled(bool value) {
  ...
  inline WorkGroupConfiguration& WithEnableMinimumEncryptionConfiguration(bool value) {
