...
class EngineVersion {
 public:
  ...
  void SetSelectedEngineVersion(SelectedEngineVersionT&& value) {
    ...
    m_selectedEngineVersion = std::forward<SelectedEngineVersionT>(value);
  }
  template <typename SelectedEngineVersionT = Aws::String>
  EngineVersion& WithSelectedEngineVersion(SelectedEngineVersionT&& value) {
    SetSelectedEngineVersion(std::forward<SelectedEngineVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEffectiveEngineVersion(EffectiveEngineVersionT&& value) {
    ...
    m_effectiveEngineVersion = std::forward<EffectiveEngineVersionT>(value);
  }
  template <typename EffectiveEngineVersionT = Aws::String>
  EngineVersion& WithEffectiveEngineVersion(EffectiveEngineVersionT&& value) {
    SetEffectiveEngineVersion(std::forward<EffectiveEngineVersionT>(value));
    return *this;
  }
  ///@}
 private:
