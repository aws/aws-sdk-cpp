...
class InvalidRequestException {
 public:
  ...
  void SetAthenaErrorCode(AthenaErrorCodeT&& value) {
    m_athenaErrorCodeHasBeenSet = true;
    m_athenaErrorCode = std::forward<AthenaErrorCodeT>(value);
  }
  template <typename AthenaErrorCodeT = Aws::String>
  InvalidRequestException& WithAthenaErrorCode(AthenaErrorCodeT&& value) {
    SetAthenaErrorCode(std::forward<AthenaErrorCodeT>(value));
    return *this;
  }
  ///@}
