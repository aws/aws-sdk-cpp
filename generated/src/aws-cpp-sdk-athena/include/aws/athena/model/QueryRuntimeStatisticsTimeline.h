...
class QueryRuntimeStatisticsTimeline {
 public:
  ...
  inline QueryRuntimeStatisticsTimeline& WithQueryQueueTimeInMillis(long long value) {
  ...
  inline QueryRuntimeStatisticsTimeline& WithServicePreProcessingTimeInMillis(long long value) {
  ...
  inline QueryRuntimeStatisticsTimeline& WithQueryPlanningTimeInMillis(long long value) {
  ...
  inline QueryRuntimeStatisticsTimeline& WithEngineExecutionTimeInMillis(long long value) {
  ...
  inline QueryRuntimeStatisticsTimeline& WithServiceProcessingTimeInMillis(long long value) {
  ...
  inline QueryRuntimeStatisticsTimeline& WithTotalExecutionTimeInMillis(long long value) {
