...
class ListTableMetadataRequest : public AthenaRequest {
 public:
  ...
  template <typename CatalogNameT = Aws::String>
  ListTableMetadataRequest& WithCatalogName(CatalogNameT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  ListTableMetadataRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename ExpressionT = Aws::String>
  ListTableMetadataRequest& WithExpression(ExpressionT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTableMetadataRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTableMetadataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename WorkGroupT = Aws::String>
  ListTableMetadataRequest& WithWorkGroup(WorkGroupT&& value) {
