...
namespace Model
{
  ...
  public:
     ...
     * if requesting an IAM Identity Center enabled Glue Data Catalog.</p>
     */
    inline ListTableMetadataRequest& WithWorkGroup(const Aws::String& value) { SetWorkGroup(value); return *this;}

    /**
     * <p>The name of the workgroup for which the metadata is being fetched. Required
     * if requesting an IAM Identity Center enabled Glue Data Catalog.</p>
     */
    inline ListTableMetadataRequest& WithWorkGroup(Aws::String&& value) { SetWorkGroup(std::move(value)); return *this;}

    /**
     * <p>The name of the workgroup for which the metadata is being fetched. Required
     * if requesting an IAM Identity Center enabled Glue Data Catalog.</p>
     */
    inline ListTableMetadataRequest& WithWorkGroup(const char* value) { SetWorkGroup(value); return *this;}
