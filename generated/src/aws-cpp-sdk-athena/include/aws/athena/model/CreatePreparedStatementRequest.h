...
namespace Model
{
  ...
  public:
    ...
    template<typename StatementNameT = Aws::String>
    CreatePreparedStatementRequest& WithStatementName(StatementNameT&& value) { SetStatementName(std::forward<StatementNameT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkGroupT = Aws::String>
    CreatePreparedStatementRequest& WithWorkGroup(WorkGroupT&& value) { SetWorkGroup(std::forward<WorkGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename QueryStatementT = Aws::String>
    CreatePreparedStatementRequest& WithQueryStatement(QueryStatementT&& value) { SetQueryStatement(std::forward<QueryStatementT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CreatePreparedStatementRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
  private:
