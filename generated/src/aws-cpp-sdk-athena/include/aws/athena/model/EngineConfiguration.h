...
class EngineConfiguration {
 public:
  ...
  inline void SetCoordinatorDpuSize(int value) {
    m_coordinatorDpuSizeHasBeenSet = true;
    m_coordinatorDpuSize = value;
  }
  inline EngineConfiguration& WithCoordinatorDpuSize(int value) {
    SetCoordinatorDpuSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxConcurrentDpus(int value) {
    m_maxConcurrentDpusHasBeenSet = true;
    m_maxConcurrentDpus = value;
  }
  inline EngineConfiguration& WithMaxConcurrentDpus(int value) {
    SetMaxConcurrentDpus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultExecutorDpuSize(int value) {
    m_defaultExecutorDpuSizeHasBeenSet = true;
    m_defaultExecutorDpuSize = value;
  }
  inline EngineConfiguration& WithDefaultExecutorDpuSize(int value) {
    SetDefaultExecutorDpuSize(value);
    return *this;
  }
  ///@}
  ...
  void SetAdditionalConfigs(AdditionalConfigsT&& value) {
    ...
    m_additionalConfigs = std::forward<AdditionalConfigsT>(value);
  }
  template <typename AdditionalConfigsT = Aws::Map<Aws::String, Aws::String>>
  EngineConfiguration& WithAdditionalConfigs(AdditionalConfigsT&& value) {
    SetAdditionalConfigs(std::forward<AdditionalConfigsT>(value));
    return *this;
  }
  ...
  EngineConfiguration& AddAdditionalConfigs(AdditionalConfigsKeyT&& key, AdditionalConfigsValueT&& value) {
    m_additionalConfigsHasBeenSet = true;
    m_additionalConfigs.emplace(std::forward<AdditionalConfigsKeyT>(key), std::forward<AdditionalConfigsValueT>(value));
    return *this;
  }
  ///@}
