...
namespace Model
{
  ...
  {
  public:
    AWS_ATHENA_API UpdateNotebookMetadataResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateNotebookMetadataResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
