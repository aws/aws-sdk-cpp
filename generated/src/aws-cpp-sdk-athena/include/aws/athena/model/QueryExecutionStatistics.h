...
class QueryExecutionStatistics {
 public:
  ...
  inline void SetEngineExecutionTimeInMillis(long long value) {
    m_engineExecutionTimeInMillisHasBeenSet = true;
    m_engineExecutionTimeInMillis = value;
  }
  inline QueryExecutionStatistics& WithEngineExecutionTimeInMillis(long long value) {
    SetEngineExecutionTimeInMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDataScannedInBytes(long long value) {
    m_dataScannedInBytesHasBeenSet = true;
    m_dataScannedInBytes = value;
  }
  inline QueryExecutionStatistics& WithDataScannedInBytes(long long value) {
    SetDataScannedInBytes(value);
    return *this;
  }
  ///@}
  ...
  void SetDataManifestLocation(DataManifestLocationT&& value) {
    ...
    m_dataManifestLocation = std::forward<DataManifestLocationT>(value);
  }
  template <typename DataManifestLocationT = Aws::String>
  QueryExecutionStatistics& WithDataManifestLocation(DataManifestLocationT&& value) {
    SetDataManifestLocation(std::forward<DataManifestLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalExecutionTimeInMillis(long long value) {
    m_totalExecutionTimeInMillisHasBeenSet = true;
    m_totalExecutionTimeInMillis = value;
  }
  inline QueryExecutionStatistics& WithTotalExecutionTimeInMillis(long long value) {
    SetTotalExecutionTimeInMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQueryQueueTimeInMillis(long long value) {
    m_queryQueueTimeInMillisHasBeenSet = true;
    m_queryQueueTimeInMillis = value;
  }
  inline QueryExecutionStatistics& WithQueryQueueTimeInMillis(long long value) {
    SetQueryQueueTimeInMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetServicePreProcessingTimeInMillis(long long value) {
    m_servicePreProcessingTimeInMillisHasBeenSet = true;
    m_servicePreProcessingTimeInMillis = value;
  }
  inline QueryExecutionStatistics& WithServicePreProcessingTimeInMillis(long long value) {
    SetServicePreProcessingTimeInMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQueryPlanningTimeInMillis(long long value) {
    m_queryPlanningTimeInMillisHasBeenSet = true;
    m_queryPlanningTimeInMillis = value;
  }
  inline QueryExecutionStatistics& WithQueryPlanningTimeInMillis(long long value) {
    SetQueryPlanningTimeInMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetServiceProcessingTimeInMillis(long long value) {
    m_serviceProcessingTimeInMillisHasBeenSet = true;
    m_serviceProcessingTimeInMillis = value;
  }
  inline QueryExecutionStatistics& WithServiceProcessingTimeInMillis(long long value) {
    SetServiceProcessingTimeInMillis(value);
    return *this;
  }
  ///@}
  ...
  void SetResultReuseInformation(ResultReuseInformationT&& value) {
    ...
    m_resultReuseInformation = std::forward<ResultReuseInformationT>(value);
  }
  template <typename ResultReuseInformationT = ResultReuseInformation>
  QueryExecutionStatistics& WithResultReuseInformation(ResultReuseInformationT&& value) {
    SetResultReuseInformation(std::forward<ResultReuseInformationT>(value));
    return *this;
  }
  ///@}
