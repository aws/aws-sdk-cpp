...
class ResultConfigurationUpdates {
 public:
  ...
  inline void SetRemoveOutputLocation(bool value) {
    m_removeOutputLocationHasBeenSet = true;
    m_removeOutputLocation = value;
  }
  inline ResultConfigurationUpdates& WithRemoveOutputLocation(bool value) {
    SetRemoveOutputLocation(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRemoveEncryptionConfiguration(bool value) {
    m_removeEncryptionConfigurationHasBeenSet = true;
    m_removeEncryptionConfiguration = value;
  }
  inline ResultConfigurationUpdates& WithRemoveEncryptionConfiguration(bool value) {
    SetRemoveEncryptionConfiguration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRemoveExpectedBucketOwner(bool value) {
    m_removeExpectedBucketOwnerHasBeenSet = true;
    m_removeExpectedBucketOwner = value;
  }
  inline ResultConfigurationUpdates& WithRemoveExpectedBucketOwner(bool value) {
    SetRemoveExpectedBucketOwner(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRemoveAclConfiguration(bool value) {
    m_removeAclConfigurationHasBeenSet = true;
    m_removeAclConfiguration = value;
  }
  inline ResultConfigurationUpdates& WithRemoveAclConfiguration(bool value) {
    SetRemoveAclConfiguration(value);
    return *this;
  }
  ///@}
 private:
