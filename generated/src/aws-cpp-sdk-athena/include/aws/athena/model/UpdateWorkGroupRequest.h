...
class UpdateWorkGroupRequest : public AthenaRequest {
 public:
  ...
  void SetConfigurationUpdates(ConfigurationUpdatesT&& value) {
    m_configurationUpdatesHasBeenSet = true;
    m_configurationUpdates = std::forward<ConfigurationUpdatesT>(value);
  }
  template <typename ConfigurationUpdatesT = WorkGroupConfigurationUpdates>
  UpdateWorkGroupRequest& WithConfigurationUpdates(ConfigurationUpdatesT&& value) {
    SetConfigurationUpdates(std::forward<ConfigurationUpdatesT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateWorkGroupRequest& WithState(WorkGroupState value) {
    SetState(value);
    return *this;
  }
  ///@}
