...
namespace Model
{
  ...
  /**
   */
  class DeletePreparedStatementRequest : public AthenaRequest
  {
  public:
    AWS_ATHENA_API DeletePreparedStatementRequest() = default;
    ...
    template<typename StatementNameT = Aws::String>
    DeletePreparedStatementRequest& WithStatementName(StatementNameT&& value) { SetStatementName(std::forward<StatementNameT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkGroupT = Aws::String>
    DeletePreparedStatementRequest& WithWorkGroup(WorkGroupT&& value) { SetWorkGroup(std::forward<WorkGroupT>(value)); return *this;}
    ///@}
  private:
