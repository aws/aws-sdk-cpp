...
class ImportNotebookRequest : public AthenaRequest {
 public:
  ...
  inline ImportNotebookRequest& WithType(NotebookType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetNotebookS3LocationUri(NotebookS3LocationUriT&& value) {
    m_notebookS3LocationUriHasBeenSet = true;
    m_notebookS3LocationUri = std::forward<NotebookS3LocationUriT>(value);
  }
  template <typename NotebookS3LocationUriT = Aws::String>
  ImportNotebookRequest& WithNotebookS3LocationUri(NotebookS3LocationUriT&& value) {
    SetNotebookS3LocationUri(std::forward<NotebookS3LocationUriT>(value));
    return *this;
  }
  ///@}
