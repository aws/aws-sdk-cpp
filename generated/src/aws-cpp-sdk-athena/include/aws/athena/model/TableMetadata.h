...
class TableMetadata {
 public:
  ...
  template <typename NameT = Aws::String>
  TableMetadata& WithName(NameT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  TableMetadata& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename LastAccessTimeT = Aws::Utils::DateTime>
  TableMetadata& WithLastAccessTime(LastAccessTimeT&& value) {
  ...
  void SetTableType(TableTypeT&& value) {
    ...
    m_tableType = std::forward<TableTypeT>(value);
  }
  template <typename TableTypeT = Aws::String>
  TableMetadata& WithTableType(TableTypeT&& value) {
    SetTableType(std::forward<TableTypeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ColumnsT = Aws::Vector<Column>>
  TableMetadata& WithColumns(ColumnsT&& value) {
    SetColumns(std::forward<ColumnsT>(value));
    return *this;
  }
  template <typename ColumnsT = Column>
  TableMetadata& AddColumns(ColumnsT&& value) {
    m_columnsHasBeenSet = true;
  ...
  template <typename PartitionKeysT = Aws::Vector<Column>>
  TableMetadata& WithPartitionKeys(PartitionKeysT&& value) {
    SetPartitionKeys(std::forward<PartitionKeysT>(value));
    return *this;
  }
  template <typename PartitionKeysT = Column>
  TableMetadata& AddPartitionKeys(PartitionKeysT&& value) {
    m_partitionKeysHasBeenSet = true;
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::String>>
  TableMetadata& WithParameters(ParametersT&& value) {
