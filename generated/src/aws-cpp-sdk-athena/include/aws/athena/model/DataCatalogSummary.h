...
class DataCatalogSummary {
 public:
  ...
  inline DataCatalogSummary& WithType(DataCatalogType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline DataCatalogSummary& WithStatus(DataCatalogStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DataCatalogSummary& WithConnectionType(ConnectionType value) {
