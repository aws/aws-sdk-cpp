...
namespace Model
{
  ...
  {
  public:
    AWS_ATHENA_API CreatePreparedStatementResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreatePreparedStatementResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
