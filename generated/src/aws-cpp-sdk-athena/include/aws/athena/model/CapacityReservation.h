...
class CapacityReservation {
 public:
  ...
  inline void SetStatus(CapacityReservationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CapacityReservation& WithStatus(CapacityReservationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CapacityReservation& WithTargetDpus(int value) {
    SetTargetDpus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllocatedDpus(int value) {
    m_allocatedDpusHasBeenSet = true;
    m_allocatedDpus = value;
  }
  inline CapacityReservation& WithAllocatedDpus(int value) {
    SetAllocatedDpus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastAllocation(LastAllocationT&& value) {
    ...
    m_lastAllocation = std::forward<LastAllocationT>(value);
  }
  template <typename LastAllocationT = CapacityAllocation>
  CapacityReservation& WithLastAllocation(LastAllocationT&& value) {
    SetLastAllocation(std::forward<LastAllocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSuccessfulAllocationTime(LastSuccessfulAllocationTimeT&& value) {
    ...
    m_lastSuccessfulAllocationTime = std::forward<LastSuccessfulAllocationTimeT>(value);
  }
  template <typename LastSuccessfulAllocationTimeT = Aws::Utils::DateTime>
  CapacityReservation& WithLastSuccessfulAllocationTime(LastSuccessfulAllocationTimeT&& value) {
    SetLastSuccessfulAllocationTime(std::forward<LastSuccessfulAllocationTimeT>(value));
    return *this;
  }
  ///@}
