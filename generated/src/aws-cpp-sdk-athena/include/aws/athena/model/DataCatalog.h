...
class DataCatalog {
 public:
  ...
  inline void SetType(DataCatalogType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DataCatalog& WithType(DataCatalogType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(DataCatalogStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DataCatalog& WithStatus(DataCatalogStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DataCatalog& WithConnectionType(ConnectionType value) {
