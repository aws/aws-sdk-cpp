...
class GetDatabaseRequest : public AthenaRequest {
 public:
  ...
  template <typename CatalogNameT = Aws::String>
  GetDatabaseRequest& WithCatalogName(CatalogNameT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GetDatabaseRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename WorkGroupT = Aws::String>
  GetDatabaseRequest& WithWorkGroup(WorkGroupT&& value) {
