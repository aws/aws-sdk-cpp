...
class GetNotebookMetadataResult {
 public:
  ...
  void SetNotebookMetadata(NotebookMetadataT&& value) {
    m_notebookMetadataHasBeenSet = true;
    m_notebookMetadata = std::forward<NotebookMetadataT>(value);
  }
  template <typename NotebookMetadataT = NotebookMetadata>
  GetNotebookMetadataResult& WithNotebookMetadata(NotebookMetadataT&& value) {
    SetNotebookMetadata(std::forward<NotebookMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetNotebookMetadataResult& WithRequestId(RequestIdT&& value) {
