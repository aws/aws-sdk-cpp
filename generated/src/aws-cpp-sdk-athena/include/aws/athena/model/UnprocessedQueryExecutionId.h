...
class UnprocessedQueryExecutionId {
 public:
  ...
  template <typename QueryExecutionIdT = Aws::String>
  UnprocessedQueryExecutionId& WithQueryExecutionId(QueryExecutionIdT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  UnprocessedQueryExecutionId& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  UnprocessedQueryExecutionId& WithErrorMessage(ErrorMessageT&& value) {
