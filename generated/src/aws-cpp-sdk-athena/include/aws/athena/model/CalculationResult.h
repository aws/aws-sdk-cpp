...
class CalculationResult {
 public:
  ...
  void SetStdOutS3Uri(StdOutS3UriT&& value) {
    ...
    m_stdOutS3Uri = std::forward<StdOutS3UriT>(value);
  }
  template <typename StdOutS3UriT = Aws::String>
  CalculationResult& WithStdOutS3Uri(StdOutS3UriT&& value) {
    SetStdOutS3Uri(std::forward<StdOutS3UriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStdErrorS3Uri(StdErrorS3UriT&& value) {
    ...
    m_stdErrorS3Uri = std::forward<StdErrorS3UriT>(value);
  }
  template <typename StdErrorS3UriT = Aws::String>
  CalculationResult& WithStdErrorS3Uri(StdErrorS3UriT&& value) {
    SetStdErrorS3Uri(std::forward<StdErrorS3UriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResultS3Uri(ResultS3UriT&& value) {
    ...
    m_resultS3Uri = std::forward<ResultS3UriT>(value);
  }
  template <typename ResultS3UriT = Aws::String>
  CalculationResult& WithResultS3Uri(ResultS3UriT&& value) {
    SetResultS3Uri(std::forward<ResultS3UriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResultType(ResultTypeT&& value) {
    ...
    m_resultType = std::forward<ResultTypeT>(value);
  }
  template <typename ResultTypeT = Aws::String>
  CalculationResult& WithResultType(ResultTypeT&& value) {
    SetResultType(std::forward<ResultTypeT>(value));
    return *this;
  }
  ///@}
 private:
