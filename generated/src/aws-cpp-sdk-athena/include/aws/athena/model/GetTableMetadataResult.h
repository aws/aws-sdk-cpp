...
class GetTableMetadataResult {
 public:
  ...
  void SetTableMetadata(TableMetadataT&& value) {
    m_tableMetadataHasBeenSet = true;
    m_tableMetadata = std::forward<TableMetadataT>(value);
  }
  template <typename TableMetadataT = TableMetadata>
  GetTableMetadataResult& WithTableMetadata(TableMetadataT&& value) {
    SetTableMetadata(std::forward<TableMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetTableMetadataResult& WithRequestId(RequestIdT&& value) {
