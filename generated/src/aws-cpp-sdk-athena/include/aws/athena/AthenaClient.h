...
class AWS_ATHENA_API AthenaClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  AthenaClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<AthenaEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for BatchGetNamedQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetNamedQuery that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetNamedQueryRequestT = Model::BatchGetNamedQueryRequest>
  void BatchGetNamedQueryAsync(const BatchGetNamedQueryRequestT& request, const BatchGetNamedQueryResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for BatchGetPreparedStatement that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchGetPreparedStatementRequestT = Model::BatchGetPreparedStatementRequest>
  Model::BatchGetPreparedStatementOutcomeCallable BatchGetPreparedStatementCallable(
      const BatchGetPreparedStatementRequestT& request) const {
    return SubmitCallable(&AthenaClient::BatchGetPreparedStatement, request);
  }

  /**
   * An Async wrapper for BatchGetPreparedStatement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetPreparedStatementRequestT = Model::BatchGetPreparedStatementRequest>
  void BatchGetPreparedStatementAsync(const BatchGetPreparedStatementRequestT& request,
                                      const BatchGetPreparedStatementResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetQueryExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetQueryExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetQueryExecutionRequestT = Model::BatchGetQueryExecutionRequest>
  void BatchGetQueryExecutionAsync(const BatchGetQueryExecutionRequestT& request,
                                   const BatchGetQueryExecutionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelCapacityReservation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CancelCapacityReservationRequestT = Model::CancelCapacityReservationRequest>
  Model::CancelCapacityReservationOutcomeCallable CancelCapacityReservationCallable(
      const CancelCapacityReservationRequestT& request) const {
    return SubmitCallable(&AthenaClient::CancelCapacityReservation, request);
  }

  /**
   * An Async wrapper for CancelCapacityReservation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelCapacityReservationRequestT = Model::CancelCapacityReservationRequest>
  void CancelCapacityReservationAsync(const CancelCapacityReservationRequestT& request,
                                      const CancelCapacityReservationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCapacityReservation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateCapacityReservationRequestT = Model::CreateCapacityReservationRequest>
  Model::CreateCapacityReservationOutcomeCallable CreateCapacityReservationCallable(
      const CreateCapacityReservationRequestT& request) const {
    return SubmitCallable(&AthenaClient::CreateCapacityReservation, request);
  }

  /**
   * An Async wrapper for CreateCapacityReservation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCapacityReservationRequestT = Model::CreateCapacityReservationRequest>
  void CreateCapacityReservationAsync(const CreateCapacityReservationRequestT& request,
                                      const CreateCapacityReservationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataCatalog that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataCatalog that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDataCatalogRequestT = Model::CreateDataCatalogRequest>
  void CreateDataCatalogAsync(const CreateDataCatalogRequestT& request, const CreateDataCatalogResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateNamedQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateNamedQuery that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateNamedQueryRequestT = Model::CreateNamedQueryRequest>
  void CreateNamedQueryAsync(const CreateNamedQueryRequestT& request, const CreateNamedQueryResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePreparedStatement that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePreparedStatement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePreparedStatementRequestT = Model::CreatePreparedStatementRequest>
  void CreatePreparedStatementAsync(const CreatePreparedStatementRequestT& request,
                                    const CreatePreparedStatementResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePresignedNotebookUrlOutcome CreatePresignedNotebookUrl(
      const Model::CreatePresignedNotebookUrlRequest& request) const;

  /**
   * A Callable wrapper for CreatePresignedNotebookUrl that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePresignedNotebookUrlRequestT = Model::CreatePresignedNotebookUrlRequest>
  Model::CreatePresignedNotebookUrlOutcomeCallable CreatePresignedNotebookUrlCallable(
      const CreatePresignedNotebookUrlRequestT& request) const {
    return SubmitCallable(&AthenaClient::CreatePresignedNotebookUrl, request);
  }

  /**
   * An Async wrapper for CreatePresignedNotebookUrl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePresignedNotebookUrlRequestT = Model::CreatePresignedNotebookUrlRequest>
  void CreatePresignedNotebookUrlAsync(const CreatePresignedNotebookUrlRequestT& request,
                                       const CreatePresignedNotebookUrlResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCapacityReservation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteCapacityReservationRequestT = Model::DeleteCapacityReservationRequest>
  Model::DeleteCapacityReservationOutcomeCallable DeleteCapacityReservationCallable(
      const DeleteCapacityReservationRequestT& request) const {
    return SubmitCallable(&AthenaClient::DeleteCapacityReservation, request);
  }

  /**
   * An Async wrapper for DeleteCapacityReservation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCapacityReservationRequestT = Model::DeleteCapacityReservationRequest>
  void DeleteCapacityReservationAsync(const DeleteCapacityReservationRequestT& request,
                                      const DeleteCapacityReservationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDataCatalog that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDataCatalog that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDataCatalogRequestT = Model::DeleteDataCatalogRequest>
  void DeleteDataCatalogAsync(const DeleteDataCatalogRequestT& request, const DeleteDataCatalogResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteNamedQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteNamedQuery that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteNamedQueryRequestT = Model::DeleteNamedQueryRequest>
  void DeleteNamedQueryAsync(const DeleteNamedQueryRequestT& request, const DeleteNamedQueryResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePreparedStatement that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePreparedStatement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePreparedStatementRequestT = Model::DeletePreparedStatementRequest>
  void DeletePreparedStatementAsync(const DeletePreparedStatementRequestT& request,
                                    const DeletePreparedStatementResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ExportNotebook that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ExportNotebookRequestT = Model::ExportNotebookRequest>
  void ExportNotebookAsync(const ExportNotebookRequestT& request, const ExportNotebookResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCalculationExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCalculationExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCalculationExecutionRequestT = Model::GetCalculationExecutionRequest>
  void GetCalculationExecutionAsync(const GetCalculationExecutionRequestT& request,
                                    const GetCalculationExecutionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCalculationExecutionCodeOutcome GetCalculationExecutionCode(
      const Model::GetCalculationExecutionCodeRequest& request) const;

  /**
   * A Callable wrapper for GetCalculationExecutionCode that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCalculationExecutionCodeRequestT = Model::GetCalculationExecutionCodeRequest>
  Model::GetCalculationExecutionCodeOutcomeCallable GetCalculationExecutionCodeCallable(
      const GetCalculationExecutionCodeRequestT& request) const {
    return SubmitCallable(&AthenaClient::GetCalculationExecutionCode, request);
  }

  /**
   * An Async wrapper for GetCalculationExecutionCode that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCalculationExecutionCodeRequestT = Model::GetCalculationExecutionCodeRequest>
  void GetCalculationExecutionCodeAsync(const GetCalculationExecutionCodeRequestT& request,
                                        const GetCalculationExecutionCodeResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCalculationExecutionStatusOutcome GetCalculationExecutionStatus(
      const Model::GetCalculationExecutionStatusRequest& request) const;

  /**
   * A Callable wrapper for GetCalculationExecutionStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCalculationExecutionStatusRequestT = Model::GetCalculationExecutionStatusRequest>
  Model::GetCalculationExecutionStatusOutcomeCallable GetCalculationExecutionStatusCallable(
      const GetCalculationExecutionStatusRequestT& request) const {
    return SubmitCallable(&AthenaClient::GetCalculationExecutionStatus, request);
  }

  /**
   * An Async wrapper for GetCalculationExecutionStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCalculationExecutionStatusRequestT = Model::GetCalculationExecutionStatusRequest>
  void GetCalculationExecutionStatusAsync(const GetCalculationExecutionStatusRequestT& request,
                                          const GetCalculationExecutionStatusResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCapacityAssignmentConfigurationOutcome GetCapacityAssignmentConfiguration(
      const Model::GetCapacityAssignmentConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetCapacityAssignmentConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetCapacityAssignmentConfigurationRequestT = Model::GetCapacityAssignmentConfigurationRequest>
  Model::GetCapacityAssignmentConfigurationOutcomeCallable GetCapacityAssignmentConfigurationCallable(
      const GetCapacityAssignmentConfigurationRequestT& request) const {
    return SubmitCallable(&AthenaClient::GetCapacityAssignmentConfiguration, request);
  }

  /**
   * An Async wrapper for GetCapacityAssignmentConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetCapacityAssignmentConfigurationRequestT = Model::GetCapacityAssignmentConfigurationRequest>
  void GetCapacityAssignmentConfigurationAsync(const GetCapacityAssignmentConfigurationRequestT& request,
                                               const GetCapacityAssignmentConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCapacityReservation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCapacityReservation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCapacityReservationRequestT = Model::GetCapacityReservationRequest>
  void GetCapacityReservationAsync(const GetCapacityReservationRequestT& request,
                                   const GetCapacityReservationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDataCatalog that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDataCatalogRequestT = Model::GetDataCatalogRequest>
  void GetDataCatalogAsync(const GetDataCatalogRequestT& request, const GetDataCatalogResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetNamedQuery that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetNamedQueryRequestT = Model::GetNamedQueryRequest>
  void GetNamedQueryAsync(const GetNamedQueryRequestT& request, const GetNamedQueryResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetNotebookMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetNotebookMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetNotebookMetadataRequestT = Model::GetNotebookMetadataRequest>
  void GetNotebookMetadataAsync(const GetNotebookMetadataRequestT& request, const GetNotebookMetadataResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPreparedStatement that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPreparedStatement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPreparedStatementRequestT = Model::GetPreparedStatementRequest>
  void GetPreparedStatementAsync(const GetPreparedStatementRequestT& request, const GetPreparedStatementResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetQueryExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetQueryExecution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetQueryExecutionRequestT = Model::GetQueryExecutionRequest>
  void GetQueryExecutionAsync(const GetQueryExecutionRequestT& request, const GetQueryExecutionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetQueryRuntimeStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetQueryRuntimeStatisticsRequestT = Model::GetQueryRuntimeStatisticsRequest>
  Model::GetQueryRuntimeStatisticsOutcomeCallable GetQueryRuntimeStatisticsCallable(
      const GetQueryRuntimeStatisticsRequestT& request) const {
    return SubmitCallable(&AthenaClient::GetQueryRuntimeStatistics, request);
  }

  /**
   * An Async wrapper for GetQueryRuntimeStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetQueryRuntimeStatisticsRequestT = Model::GetQueryRuntimeStatisticsRequest>
  void GetQueryRuntimeStatisticsAsync(const GetQueryRuntimeStatisticsRequestT& request,
                                      const GetQueryRuntimeStatisticsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSessionStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSessionStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSessionStatusRequestT = Model::GetSessionStatusRequest>
  void GetSessionStatusAsync(const GetSessionStatusRequestT& request, const GetSessionStatusResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTableMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTableMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTableMetadataRequestT = Model::GetTableMetadataRequest>
  void GetTableMetadataAsync(const GetTableMetadataRequestT& request, const GetTableMetadataResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportNotebook that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportNotebookRequestT = Model::ImportNotebookRequest>
  void ImportNotebookAsync(const ImportNotebookRequestT& request, const ImportNotebookResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListApplicationDPUSizes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListApplicationDPUSizes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListApplicationDPUSizesRequestT = Model::ListApplicationDPUSizesRequest>
  void ListApplicationDPUSizesAsync(const ListApplicationDPUSizesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListApplicationDPUSizesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCalculationExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListCalculationExecutionsRequestT = Model::ListCalculationExecutionsRequest>
  Model::ListCalculationExecutionsOutcomeCallable ListCalculationExecutionsCallable(
      const ListCalculationExecutionsRequestT& request) const {
    return SubmitCallable(&AthenaClient::ListCalculationExecutions, request);
  }

  /**
   * An Async wrapper for ListCalculationExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCalculationExecutionsRequestT = Model::ListCalculationExecutionsRequest>
  void ListCalculationExecutionsAsync(const ListCalculationExecutionsRequestT& request,
                                      const ListCalculationExecutionsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCapacityReservations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListCapacityReservationsRequestT = Model::ListCapacityReservationsRequest>
  Model::ListCapacityReservationsOutcomeCallable ListCapacityReservationsCallable(
      const ListCapacityReservationsRequestT& request = {}) const {
    return SubmitCallable(&AthenaClient::ListCapacityReservations, request);
  }

  /**
   * An Async wrapper for ListCapacityReservations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCapacityReservationsRequestT = Model::ListCapacityReservationsRequest>
  void ListCapacityReservationsAsync(const ListCapacityReservationsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListCapacityReservationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDataCatalogs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataCatalogs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDataCatalogsRequestT = Model::ListDataCatalogsRequest>
  void ListDataCatalogsAsync(const ListDataCatalogsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListDataCatalogsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListExecutors that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListExecutorsRequestT = Model::ListExecutorsRequest>
  void ListExecutorsAsync(const ListExecutorsRequestT& request, const ListExecutorsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListNamedQueries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListNamedQueries that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListNamedQueriesRequestT = Model::ListNamedQueriesRequest>
  void ListNamedQueriesAsync(const ListNamedQueriesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListNamedQueriesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListNotebookMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListNotebookMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListNotebookMetadataRequestT = Model::ListNotebookMetadataRequest>
  void ListNotebookMetadataAsync(const ListNotebookMetadataRequestT& request, const ListNotebookMetadataResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListNotebookSessions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListNotebookSessions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListNotebookSessionsRequestT = Model::ListNotebookSessionsRequest>
  void ListNotebookSessionsAsync(const ListNotebookSessionsRequestT& request, const ListNotebookSessionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPreparedStatements that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPreparedStatements that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPreparedStatementsRequestT = Model::ListPreparedStatementsRequest>
  void ListPreparedStatementsAsync(const ListPreparedStatementsRequestT& request,
                                   const ListPreparedStatementsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListQueryExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListQueryExecutions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListQueryExecutionsRequestT = Model::ListQueryExecutionsRequest>
  void ListQueryExecutionsAsync(const ListQueryExecutionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListQueryExecutionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTableMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTableMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTableMetadataRequestT = Model::ListTableMetadataRequest>
  void ListTableMetadataAsync(const ListTableMetadataRequestT& request, const ListTableMetadataResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutCapacityAssignmentConfigurationOutcome PutCapacityAssignmentConfiguration(
      const Model::PutCapacityAssignmentConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutCapacityAssignmentConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PutCapacityAssignmentConfigurationRequestT = Model::PutCapacityAssignmentConfigurationRequest>
  Model::PutCapacityAssignmentConfigurationOutcomeCallable PutCapacityAssignmentConfigurationCallable(
      const PutCapacityAssignmentConfigurationRequestT& request) const {
    return SubmitCallable(&AthenaClient::PutCapacityAssignmentConfiguration, request);
  }

  /**
   * An Async wrapper for PutCapacityAssignmentConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutCapacityAssignmentConfigurationRequestT = Model::PutCapacityAssignmentConfigurationRequest>
  void PutCapacityAssignmentConfigurationAsync(const PutCapacityAssignmentConfigurationRequestT& request,
                                               const PutCapacityAssignmentConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartCalculationExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartCalculationExecutionRequestT = Model::StartCalculationExecutionRequest>
  Model::StartCalculationExecutionOutcomeCallable StartCalculationExecutionCallable(
      const StartCalculationExecutionRequestT& request) const {
    return SubmitCallable(&AthenaClient::StartCalculationExecution, request);
  }

  /**
   * An Async wrapper for StartCalculationExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartCalculationExecutionRequestT = Model::StartCalculationExecutionRequest>
  void StartCalculationExecutionAsync(const StartCalculationExecutionRequestT& request,
                                      const StartCalculationExecutionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartQueryExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartQueryExecution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartQueryExecutionRequestT = Model::StartQueryExecutionRequest>
  void StartQueryExecutionAsync(const StartQueryExecutionRequestT& request, const StartQueryExecutionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopCalculationExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopCalculationExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopCalculationExecutionRequestT = Model::StopCalculationExecutionRequest>
  void StopCalculationExecutionAsync(const StopCalculationExecutionRequestT& request,
                                     const StopCalculationExecutionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopQueryExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopQueryExecution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopQueryExecutionRequestT = Model::StopQueryExecutionRequest>
  void StopQueryExecutionAsync(const StopQueryExecutionRequestT& request, const StopQueryExecutionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateCapacityReservation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateCapacityReservationRequestT = Model::UpdateCapacityReservationRequest>
  Model::UpdateCapacityReservationOutcomeCallable UpdateCapacityReservationCallable(
      const UpdateCapacityReservationRequestT& request) const {
    return SubmitCallable(&AthenaClient::UpdateCapacityReservation, request);
  }

  /**
   * An Async wrapper for UpdateCapacityReservation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCapacityReservationRequestT = Model::UpdateCapacityReservationRequest>
  void UpdateCapacityReservationAsync(const UpdateCapacityReservationRequestT& request,
                                      const UpdateCapacityReservationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDataCatalog that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDataCatalog that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDataCatalogRequestT = Model::UpdateDataCatalogRequest>
  void UpdateDataCatalogAsync(const UpdateDataCatalogRequestT& request, const UpdateDataCatalogResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateNamedQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateNamedQuery that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateNamedQueryRequestT = Model::UpdateNamedQueryRequest>
  void UpdateNamedQueryAsync(const UpdateNamedQueryRequestT& request, const UpdateNamedQueryResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateNotebookMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateNotebookMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateNotebookMetadataRequestT = Model::UpdateNotebookMetadataRequest>
  void UpdateNotebookMetadataAsync(const UpdateNotebookMetadataRequestT& request,
                                   const UpdateNotebookMetadataResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePreparedStatement that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePreparedStatement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePreparedStatementRequestT = Model::UpdatePreparedStatementRequest>
  void UpdatePreparedStatementAsync(const UpdatePreparedStatementRequestT& request,
                                    const UpdatePreparedStatementResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
