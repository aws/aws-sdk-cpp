...
class AWS_CODEGURUSECURITY_API CodeGuruSecurityClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CodeGuruSecurityClient(const Aws::CodeGuruSecurity::CodeGuruSecurityClientConfiguration& clientConfiguration =
  ...
  CodeGuruSecurityClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<CodeGuruSecurityEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::CodeGuruSecurity::CodeGuruSecurityClientConfiguration& clientConfiguration =
                             Aws::CodeGuruSecurity::CodeGuruSecurityClientConfiguration());
  ...
  /**
   * An Async wrapper for CreateScan that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateScanRequestT = Model::CreateScanRequest>
  void CreateScanAsync(const CreateScanRequestT& request, const CreateScanResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename CreateUploadUrlRequestT = Model::CreateUploadUrlRequest>
  void CreateUploadUrlAsync(const CreateUploadUrlRequestT& request, const CreateUploadUrlResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMetricsSummary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMetricsSummary that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMetricsSummaryRequestT = Model::GetMetricsSummaryRequest>
  void GetMetricsSummaryAsync(const GetMetricsSummaryRequestT& request, const GetMetricsSummaryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetScan that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetScanRequestT = Model::GetScanRequest>
  void GetScanAsync(const GetScanRequestT& request, const GetScanResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListFindingsMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFindingsMetrics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFindingsMetricsRequestT = Model::ListFindingsMetricsRequest>
  void ListFindingsMetricsAsync(const ListFindingsMetricsRequestT& request, const ListFindingsMetricsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListScans that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListScansRequestT = Model::ListScansRequest>
  void ListScansAsync(const ListScansResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListScansRequestT& request = {}) const {
   ...
   */
  template <typename UpdateAccountConfigurationRequestT = Model::UpdateAccountConfigurationRequest>
  void UpdateAccountConfigurationAsync(const UpdateAccountConfigurationRequestT& request,
                                       const UpdateAccountConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
