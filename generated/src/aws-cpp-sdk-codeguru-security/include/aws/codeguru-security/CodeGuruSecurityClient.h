...
namespace CodeGuruSecurity
{
   ...
   */
  class AWS_CODEGURUSECURITY_API CodeGuruSecurityClient : Aws::Client::ClientWithAsyncTemplateMethods<CodeGuruSecurityClient>,
    smithy::client::AwsSmithyClientT<Aws::CodeGuruSecurity::SERVICE_NAME,
