...
class FindingMetricsValuePerSeverity {
 public:
  ...
  inline void SetInfo(double value) {
    m_infoHasBeenSet = true;
    m_info = value;
  }
  inline FindingMetricsValuePerSeverity& WithInfo(double value) {
    SetInfo(value);
    return *this;
  }
  ///@}
  ...
  inline FindingMetricsValuePerSeverity& WithLow(double value) {
    SetLow(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMedium(double value) {
    m_mediumHasBeenSet = true;
    m_medium = value;
  }
  inline FindingMetricsValuePerSeverity& WithMedium(double value) {
    SetMedium(value);
    return *this;
  }
  ///@}
  ...
  inline FindingMetricsValuePerSeverity& WithHigh(double value) {
    SetHigh(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCritical(double value) {
    m_criticalHasBeenSet = true;
    m_critical = value;
  }
  inline FindingMetricsValuePerSeverity& WithCritical(double value) {
    SetCritical(value);
    return *this;
  }
  ///@}
