...
class Finding {
 public:
  ...
  inline Finding& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetVulnerability(VulnerabilityT&& value) {
    ...
    m_vulnerability = std::forward<VulnerabilityT>(value);
  }
  template <typename VulnerabilityT = Vulnerability>
  Finding& WithVulnerability(VulnerabilityT&& value) {
    SetVulnerability(std::forward<VulnerabilityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDetectorTags(DetectorTagsT&& value) {
    ...
    m_detectorTags = std::forward<DetectorTagsT>(value);
  }
  template <typename DetectorTagsT = Aws::Vector<Aws::String>>
  Finding& WithDetectorTags(DetectorTagsT&& value) {
    SetDetectorTags(std::forward<DetectorTagsT>(value));
    return *this;
  }
  template <typename DetectorTagsT = Aws::String>
  Finding& AddDetectorTags(DetectorTagsT&& value) {
    m_detectorTagsHasBeenSet = true;
    m_detectorTags.emplace_back(std::forward<DetectorTagsT>(value));
    return *this;
  }
  ///@}
