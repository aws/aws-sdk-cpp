...
class Resource {
 public:
  ...
  void SetSubResourceId(SubResourceIdT&& value) {
    m_subResourceIdHasBeenSet = true;
    m_subResourceId = std::forward<SubResourceIdT>(value);
  }
  template <typename SubResourceIdT = Aws::String>
  Resource& WithSubResourceId(SubResourceIdT&& value) {
    SetSubResourceId(std::forward<SubResourceIdT>(value));
    return *this;
  }
  ///@}
 private:
