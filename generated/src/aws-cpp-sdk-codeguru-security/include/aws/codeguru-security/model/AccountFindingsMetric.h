...
class AccountFindingsMetric {
 public:
  ...
  void SetNewFindings(NewFindingsT&& value) {
    ...
    m_newFindings = std::forward<NewFindingsT>(value);
  }
  template <typename NewFindingsT = FindingMetricsValuePerSeverity>
  AccountFindingsMetric& WithNewFindings(NewFindingsT&& value) {
    SetNewFindings(std::forward<NewFindingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClosedFindings(ClosedFindingsT&& value) {
    ...
    m_closedFindings = std::forward<ClosedFindingsT>(value);
  }
  template <typename ClosedFindingsT = FindingMetricsValuePerSeverity>
  AccountFindingsMetric& WithClosedFindings(ClosedFindingsT&& value) {
    SetClosedFindings(std::forward<ClosedFindingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMeanTimeToClose(MeanTimeToCloseT&& value) {
    ...
    m_meanTimeToClose = std::forward<MeanTimeToCloseT>(value);
  }
  template <typename MeanTimeToCloseT = FindingMetricsValuePerSeverity>
  AccountFindingsMetric& WithMeanTimeToClose(MeanTimeToCloseT&& value) {
    SetMeanTimeToClose(std::forward<MeanTimeToCloseT>(value));
    return *this;
  }
  ///@}
 private:
