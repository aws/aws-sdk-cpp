...
class ListScansResult {
 public:
  ...
  template <typename SummariesT = Aws::Vector<ScanSummary>>
  ListScansResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = ScanSummary>
  ListScansResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListScansResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListScansResult& WithRequestId(RequestIdT&& value) {
