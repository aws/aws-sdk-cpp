...
class MetricsSummary {
 public:
  ...
  void SetOpenFindings(OpenFindingsT&& value) {
    ...
    m_openFindings = std::forward<OpenFindingsT>(value);
  }
  template <typename OpenFindingsT = FindingMetricsValuePerSeverity>
  MetricsSummary& WithOpenFindings(OpenFindingsT&& value) {
    SetOpenFindings(std::forward<OpenFindingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCategoriesWithMostFindings(CategoriesWithMostFindingsT&& value) {
    ...
    m_categoriesWithMostFindings = std::forward<CategoriesWithMostFindingsT>(value);
  }
  template <typename CategoriesWithMostFindingsT = Aws::Vector<CategoryWithFindingNum>>
  MetricsSummary& WithCategoriesWithMostFindings(CategoriesWithMostFindingsT&& value) {
    SetCategoriesWithMostFindings(std::forward<CategoriesWithMostFindingsT>(value));
    return *this;
  }
  ...
  MetricsSummary& AddCategoriesWithMostFindings(CategoriesWithMostFindingsT&& value) {
    m_categoriesWithMostFindingsHasBeenSet = true;
    m_categoriesWithMostFindings.emplace_back(std::forward<CategoriesWithMostFindingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScansWithMostOpenFindings(ScansWithMostOpenFindingsT&& value) {
    ...
    m_scansWithMostOpenFindings = std::forward<ScansWithMostOpenFindingsT>(value);
  }
  template <typename ScansWithMostOpenFindingsT = Aws::Vector<ScanNameWithFindingNum>>
  MetricsSummary& WithScansWithMostOpenFindings(ScansWithMostOpenFindingsT&& value) {
    SetScansWithMostOpenFindings(std::forward<ScansWithMostOpenFindingsT>(value));
    return *this;
  }
  ...
  MetricsSummary& AddScansWithMostOpenFindings(ScansWithMostOpenFindingsT&& value) {
    m_scansWithMostOpenFindingsHasBeenSet = true;
    m_scansWithMostOpenFindings.emplace_back(std::forward<ScansWithMostOpenFindingsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<ScanNameWithFindingNum>& GetScansWithMostOpenCriticalFindings() const {
    return m_scansWithMostOpenCriticalFindings;
  }
  ...
  void SetScansWithMostOpenCriticalFindings(ScansWithMostOpenCriticalFindingsT&& value) {
    ...
    m_scansWithMostOpenCriticalFindings = std::forward<ScansWithMostOpenCriticalFindingsT>(value);
  }
  template <typename ScansWithMostOpenCriticalFindingsT = Aws::Vector<ScanNameWithFindingNum>>
  MetricsSummary& WithScansWithMostOpenCriticalFindings(ScansWithMostOpenCriticalFindingsT&& value) {
    SetScansWithMostOpenCriticalFindings(std::forward<ScansWithMostOpenCriticalFindingsT>(value));
    return *this;
  }
  ...
  MetricsSummary& AddScansWithMostOpenCriticalFindings(ScansWithMostOpenCriticalFindingsT&& value) {
    m_scansWithMostOpenCriticalFindingsHasBeenSet = true;
    m_scansWithMostOpenCriticalFindings.emplace_back(std::forward<ScansWithMostOpenCriticalFindingsT>(value));
    return *this;
  }
  ///@}
 private:
