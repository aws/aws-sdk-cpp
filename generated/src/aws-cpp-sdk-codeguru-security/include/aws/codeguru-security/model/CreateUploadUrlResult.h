...
class CreateUploadUrlResult {
 public:
  ...
  template <typename S3UrlT = Aws::String>
  CreateUploadUrlResult& WithS3Url(S3UrlT&& value) {
  ...
  template <typename RequestHeadersT = Aws::Map<Aws::String, Aws::String>>
  CreateUploadUrlResult& WithRequestHeaders(RequestHeadersT&& value) {
  ...
  void SetCodeArtifactId(CodeArtifactIdT&& value) {
    ...
    m_codeArtifactId = std::forward<CodeArtifactIdT>(value);
  }
  template <typename CodeArtifactIdT = Aws::String>
  CreateUploadUrlResult& WithCodeArtifactId(CodeArtifactIdT&& value) {
    SetCodeArtifactId(std::forward<CodeArtifactIdT>(value));
    return *this;
  }
  ///@}
