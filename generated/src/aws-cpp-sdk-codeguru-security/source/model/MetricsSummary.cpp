...
MetricsSummary::MetricsSummary(JsonView jsonValue) { *this = jsonValue; }
...
MetricsSummary& MetricsSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("categoriesWithMostFindings")) {
    ...
    for (unsigned categoriesWithMostFindingsIndex = 0; categoriesWithMostFindingsIndex < categoriesWithMostFindingsJsonList.GetLength();
         ++categoriesWithMostFindingsIndex) {
  ...
  if (jsonValue.ValueExists("scansWithMostOpenFindings")) {
    ...
    for (unsigned scansWithMostOpenFindingsIndex = 0; scansWithMostOpenFindingsIndex < scansWithMostOpenFindingsJsonList.GetLength();
         ++scansWithMostOpenFindingsIndex) {
  ...
  if (jsonValue.ValueExists("scansWithMostOpenCriticalFindings")) {
    ...
    for (unsigned scansWithMostOpenCriticalFindingsIndex = 0;
         scansWithMostOpenCriticalFindingsIndex < scansWithMostOpenCriticalFindingsJsonList.GetLength();
         ++scansWithMostOpenCriticalFindingsIndex) {
      m_scansWithMostOpenCriticalFindings.push_back(
          scansWithMostOpenCriticalFindingsJsonList[scansWithMostOpenCriticalFindingsIndex].AsObject());
    }
...
JsonValue MetricsSummary::Jsonize() const {
  ...
  if (m_categoriesWithMostFindingsHasBeenSet) {
    ...
    for (unsigned categoriesWithMostFindingsIndex = 0; categoriesWithMostFindingsIndex < categoriesWithMostFindingsJsonList.GetLength();
         ++categoriesWithMostFindingsIndex) {
      categoriesWithMostFindingsJsonList[categoriesWithMostFindingsIndex].AsObject(
          m_categoriesWithMostFindings[categoriesWithMostFindingsIndex].Jsonize());
    }
  ...
  if (m_scansWithMostOpenFindingsHasBeenSet) {
    ...
    for (unsigned scansWithMostOpenFindingsIndex = 0; scansWithMostOpenFindingsIndex < scansWithMostOpenFindingsJsonList.GetLength();
         ++scansWithMostOpenFindingsIndex) {
      scansWithMostOpenFindingsJsonList[scansWithMostOpenFindingsIndex].AsObject(
          m_scansWithMostOpenFindings[scansWithMostOpenFindingsIndex].Jsonize());
    }
  ...
  if (m_scansWithMostOpenCriticalFindingsHasBeenSet) {
    ...
    for (unsigned scansWithMostOpenCriticalFindingsIndex = 0;
         ...
         ++scansWithMostOpenCriticalFindingsIndex) {
      scansWithMostOpenCriticalFindingsJsonList[scansWithMostOpenCriticalFindingsIndex].AsObject(
          m_scansWithMostOpenCriticalFindings[scansWithMostOpenCriticalFindingsIndex].Jsonize());
    }
