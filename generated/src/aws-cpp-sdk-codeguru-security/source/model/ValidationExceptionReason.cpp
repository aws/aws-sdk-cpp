  ...
  namespace CodeGuruSecurity
  {
    namespace Model
    {
      namespace ValidationExceptionReasonMapper
      {
        ...
        static constexpr uint32_t lambdaCodeShaMisMatch_HASH = ConstExprHashingUtils::HashString("lambdaCodeShaMisMatch");
        ...
        ValidationExceptionReason GetValidationExceptionReasonForName(const Aws::String& name)
        {
          ...
          else if (hashCode == lambdaCodeShaMisMatch_HASH)
          {
            return ValidationExceptionReason::lambdaCodeShaMisMatch;
          }
        ...
        Aws::String GetNameForValidationExceptionReason(ValidationExceptionReason enumValue)
        {
          ...
          case ValidationExceptionReason::other:
            return "other";
          case ValidationExceptionReason::lambdaCodeShaMisMatch:
            return "lambdaCodeShaMisMatch";
          default:
            EnumParseOverflowContainer* overflowContainer = Aws::GetEnumOverflowContainer();
            if(overflowContainer)
            {
