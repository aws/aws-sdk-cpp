...
namespace Greengrass
{
   ...
   */
  class AWS_GREENGRASS_API GreengrassClient : Aws::Client::ClientWithAsyncTemplateMethods<GreengrassClient>,
    smithy::client::AwsSmithyClientT<Aws::Greengrass::SERVICE_NAME,
