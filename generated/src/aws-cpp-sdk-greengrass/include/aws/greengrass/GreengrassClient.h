...
class AWS_GREENGRASS_API GreengrassClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  GreengrassClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<GreengrassEndpointProviderBase> endpointProvider = nullptr,
      const Aws::Greengrass::GreengrassClientConfiguration& clientConfiguration = Aws::Greengrass::GreengrassClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateRoleToGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateRoleToGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateRoleToGroupRequestT = Model::AssociateRoleToGroupRequest>
  void AssociateRoleToGroupAsync(const AssociateRoleToGroupRequestT& request, const AssociateRoleToGroupResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConnectorDefinitionOutcome CreateConnectorDefinition(
      const Model::CreateConnectorDefinitionRequest& request = {}) const;

  /**
   * A Callable wrapper for CreateConnectorDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateConnectorDefinitionRequestT = Model::CreateConnectorDefinitionRequest>
  Model::CreateConnectorDefinitionOutcomeCallable CreateConnectorDefinitionCallable(
      const CreateConnectorDefinitionRequestT& request = {}) const {
    return SubmitCallable(&GreengrassClient::CreateConnectorDefinition, request);
  }

  /**
   * An Async wrapper for CreateConnectorDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConnectorDefinitionRequestT = Model::CreateConnectorDefinitionRequest>
  void CreateConnectorDefinitionAsync(const CreateConnectorDefinitionResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConnectorDefinitionVersionOutcome CreateConnectorDefinitionVersion(
      const Model::CreateConnectorDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateConnectorDefinitionVersion that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateConnectorDefinitionVersionRequestT = Model::CreateConnectorDefinitionVersionRequest>
  Model::CreateConnectorDefinitionVersionOutcomeCallable CreateConnectorDefinitionVersionCallable(
      const CreateConnectorDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::CreateConnectorDefinitionVersion, request);
  }

  /**
   * An Async wrapper for CreateConnectorDefinitionVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateConnectorDefinitionVersionRequestT = Model::CreateConnectorDefinitionVersionRequest>
  void CreateConnectorDefinitionVersionAsync(const CreateConnectorDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateCoreDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCoreDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCoreDefinitionRequestT = Model::CreateCoreDefinitionRequest>
  void CreateCoreDefinitionAsync(const CreateCoreDefinitionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const CreateCoreDefinitionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCoreDefinitionVersionOutcome CreateCoreDefinitionVersion(
      const Model::CreateCoreDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateCoreDefinitionVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCoreDefinitionVersionRequestT = Model::CreateCoreDefinitionVersionRequest>
  Model::CreateCoreDefinitionVersionOutcomeCallable CreateCoreDefinitionVersionCallable(
      const CreateCoreDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::CreateCoreDefinitionVersion, request);
  }

  /**
   * An Async wrapper for CreateCoreDefinitionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCoreDefinitionVersionRequestT = Model::CreateCoreDefinitionVersionRequest>
  void CreateCoreDefinitionVersionAsync(const CreateCoreDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateDeviceDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDeviceDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDeviceDefinitionRequestT = Model::CreateDeviceDefinitionRequest>
  void CreateDeviceDefinitionAsync(const CreateDeviceDefinitionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const CreateDeviceDefinitionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDeviceDefinitionVersionOutcome CreateDeviceDefinitionVersion(
      const Model::CreateDeviceDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateDeviceDefinitionVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateDeviceDefinitionVersionRequestT = Model::CreateDeviceDefinitionVersionRequest>
  Model::CreateDeviceDefinitionVersionOutcomeCallable CreateDeviceDefinitionVersionCallable(
      const CreateDeviceDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::CreateDeviceDefinitionVersion, request);
  }

  /**
   * An Async wrapper for CreateDeviceDefinitionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDeviceDefinitionVersionRequestT = Model::CreateDeviceDefinitionVersionRequest>
  void CreateDeviceDefinitionVersionAsync(const CreateDeviceDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateFunctionDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateFunctionDefinitionRequestT = Model::CreateFunctionDefinitionRequest>
  Model::CreateFunctionDefinitionOutcomeCallable CreateFunctionDefinitionCallable(
      const CreateFunctionDefinitionRequestT& request = {}) const {
    return SubmitCallable(&GreengrassClient::CreateFunctionDefinition, request);
  }

  /**
   * An Async wrapper for CreateFunctionDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFunctionDefinitionRequestT = Model::CreateFunctionDefinitionRequest>
  void CreateFunctionDefinitionAsync(const CreateFunctionDefinitionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const CreateFunctionDefinitionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateFunctionDefinitionVersionOutcome CreateFunctionDefinitionVersion(
      const Model::CreateFunctionDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateFunctionDefinitionVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateFunctionDefinitionVersionRequestT = Model::CreateFunctionDefinitionVersionRequest>
  Model::CreateFunctionDefinitionVersionOutcomeCallable CreateFunctionDefinitionVersionCallable(
      const CreateFunctionDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::CreateFunctionDefinitionVersion, request);
  }

  /**
   * An Async wrapper for CreateFunctionDefinitionVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateFunctionDefinitionVersionRequestT = Model::CreateFunctionDefinitionVersionRequest>
  void CreateFunctionDefinitionVersionAsync(const CreateFunctionDefinitionVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateGroupCertificateAuthorityOutcome CreateGroupCertificateAuthority(
      const Model::CreateGroupCertificateAuthorityRequest& request) const;

  /**
   * A Callable wrapper for CreateGroupCertificateAuthority that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateGroupCertificateAuthorityRequestT = Model::CreateGroupCertificateAuthorityRequest>
  Model::CreateGroupCertificateAuthorityOutcomeCallable CreateGroupCertificateAuthorityCallable(
      const CreateGroupCertificateAuthorityRequestT& request) const {
    return SubmitCallable(&GreengrassClient::CreateGroupCertificateAuthority, request);
  }

  /**
   * An Async wrapper for CreateGroupCertificateAuthority that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateGroupCertificateAuthorityRequestT = Model::CreateGroupCertificateAuthorityRequest>
  void CreateGroupCertificateAuthorityAsync(const CreateGroupCertificateAuthorityRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateGroupVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateGroupVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateGroupVersionRequestT = Model::CreateGroupVersionRequest>
  void CreateGroupVersionAsync(const CreateGroupVersionRequestT& request, const CreateGroupVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateLoggerDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLoggerDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateLoggerDefinitionRequestT = Model::CreateLoggerDefinitionRequest>
  void CreateLoggerDefinitionAsync(const CreateLoggerDefinitionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const CreateLoggerDefinitionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateLoggerDefinitionVersionOutcome CreateLoggerDefinitionVersion(
      const Model::CreateLoggerDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateLoggerDefinitionVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateLoggerDefinitionVersionRequestT = Model::CreateLoggerDefinitionVersionRequest>
  Model::CreateLoggerDefinitionVersionOutcomeCallable CreateLoggerDefinitionVersionCallable(
      const CreateLoggerDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::CreateLoggerDefinitionVersion, request);
  }

  /**
   * An Async wrapper for CreateLoggerDefinitionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateLoggerDefinitionVersionRequestT = Model::CreateLoggerDefinitionVersionRequest>
  void CreateLoggerDefinitionVersionAsync(const CreateLoggerDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateResourceDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateResourceDefinitionRequestT = Model::CreateResourceDefinitionRequest>
  Model::CreateResourceDefinitionOutcomeCallable CreateResourceDefinitionCallable(
      const CreateResourceDefinitionRequestT& request = {}) const {
    return SubmitCallable(&GreengrassClient::CreateResourceDefinition, request);
  }

  /**
   * An Async wrapper for CreateResourceDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResourceDefinitionRequestT = Model::CreateResourceDefinitionRequest>
  void CreateResourceDefinitionAsync(const CreateResourceDefinitionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const CreateResourceDefinitionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateResourceDefinitionVersionOutcome CreateResourceDefinitionVersion(
      const Model::CreateResourceDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateResourceDefinitionVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateResourceDefinitionVersionRequestT = Model::CreateResourceDefinitionVersionRequest>
  Model::CreateResourceDefinitionVersionOutcomeCallable CreateResourceDefinitionVersionCallable(
      const CreateResourceDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::CreateResourceDefinitionVersion, request);
  }

  /**
   * An Async wrapper for CreateResourceDefinitionVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateResourceDefinitionVersionRequestT = Model::CreateResourceDefinitionVersionRequest>
  void CreateResourceDefinitionVersionAsync(const CreateResourceDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateSoftwareUpdateJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSoftwareUpdateJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSoftwareUpdateJobRequestT = Model::CreateSoftwareUpdateJobRequest>
  void CreateSoftwareUpdateJobAsync(const CreateSoftwareUpdateJobRequestT& request,
  ...
  virtual Model::CreateSubscriptionDefinitionOutcome CreateSubscriptionDefinition(
      const Model::CreateSubscriptionDefinitionRequest& request = {}) const;

  /**
   * A Callable wrapper for CreateSubscriptionDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateSubscriptionDefinitionRequestT = Model::CreateSubscriptionDefinitionRequest>
  Model::CreateSubscriptionDefinitionOutcomeCallable CreateSubscriptionDefinitionCallable(
      const CreateSubscriptionDefinitionRequestT& request = {}) const {
    return SubmitCallable(&GreengrassClient::CreateSubscriptionDefinition, request);
  }

  /**
   * An Async wrapper for CreateSubscriptionDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSubscriptionDefinitionRequestT = Model::CreateSubscriptionDefinitionRequest>
  void CreateSubscriptionDefinitionAsync(const CreateSubscriptionDefinitionResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const CreateSubscriptionDefinitionRequestT& request = {}) const {
  ...
  virtual Model::CreateSubscriptionDefinitionVersionOutcome CreateSubscriptionDefinitionVersion(
      const Model::CreateSubscriptionDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateSubscriptionDefinitionVersion that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateSubscriptionDefinitionVersionRequestT = Model::CreateSubscriptionDefinitionVersionRequest>
  Model::CreateSubscriptionDefinitionVersionOutcomeCallable CreateSubscriptionDefinitionVersionCallable(
      const CreateSubscriptionDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::CreateSubscriptionDefinitionVersion, request);
  }

  /**
   * An Async wrapper for CreateSubscriptionDefinitionVersion that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateSubscriptionDefinitionVersionRequestT = Model::CreateSubscriptionDefinitionVersionRequest>
  void CreateSubscriptionDefinitionVersionAsync(const CreateSubscriptionDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteConnectorDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteConnectorDefinitionRequestT = Model::DeleteConnectorDefinitionRequest>
  Model::DeleteConnectorDefinitionOutcomeCallable DeleteConnectorDefinitionCallable(
      const DeleteConnectorDefinitionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::DeleteConnectorDefinition, request);
  }

  /**
   * An Async wrapper for DeleteConnectorDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConnectorDefinitionRequestT = Model::DeleteConnectorDefinitionRequest>
  void DeleteConnectorDefinitionAsync(const DeleteConnectorDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteCoreDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCoreDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCoreDefinitionRequestT = Model::DeleteCoreDefinitionRequest>
  void DeleteCoreDefinitionAsync(const DeleteCoreDefinitionRequestT& request, const DeleteCoreDefinitionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDeviceDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDeviceDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDeviceDefinitionRequestT = Model::DeleteDeviceDefinitionRequest>
  void DeleteDeviceDefinitionAsync(const DeleteDeviceDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteFunctionDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteFunctionDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteFunctionDefinitionRequestT = Model::DeleteFunctionDefinitionRequest>
  void DeleteFunctionDefinitionAsync(const DeleteFunctionDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteLoggerDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLoggerDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteLoggerDefinitionRequestT = Model::DeleteLoggerDefinitionRequest>
  void DeleteLoggerDefinitionAsync(const DeleteLoggerDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteResourceDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteResourceDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResourceDefinitionRequestT = Model::DeleteResourceDefinitionRequest>
  void DeleteResourceDefinitionAsync(const DeleteResourceDefinitionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteSubscriptionDefinitionOutcome DeleteSubscriptionDefinition(
      const Model::DeleteSubscriptionDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DeleteSubscriptionDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteSubscriptionDefinitionRequestT = Model::DeleteSubscriptionDefinitionRequest>
  Model::DeleteSubscriptionDefinitionOutcomeCallable DeleteSubscriptionDefinitionCallable(
      const DeleteSubscriptionDefinitionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::DeleteSubscriptionDefinition, request);
  }

  /**
   * An Async wrapper for DeleteSubscriptionDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSubscriptionDefinitionRequestT = Model::DeleteSubscriptionDefinitionRequest>
  void DeleteSubscriptionDefinitionAsync(const DeleteSubscriptionDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for DisassociateRoleFromGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DisassociateRoleFromGroupRequestT = Model::DisassociateRoleFromGroupRequest>
  Model::DisassociateRoleFromGroupOutcomeCallable DisassociateRoleFromGroupCallable(
      const DisassociateRoleFromGroupRequestT& request) const {
    return SubmitCallable(&GreengrassClient::DisassociateRoleFromGroup, request);
  }

  /**
   * An Async wrapper for DisassociateRoleFromGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateRoleFromGroupRequestT = Model::DisassociateRoleFromGroupRequest>
  void DisassociateRoleFromGroupAsync(const DisassociateRoleFromGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAssociatedRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAssociatedRole that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAssociatedRoleRequestT = Model::GetAssociatedRoleRequest>
  void GetAssociatedRoleAsync(const GetAssociatedRoleRequestT& request, const GetAssociatedRoleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBulkDeploymentStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBulkDeploymentStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBulkDeploymentStatusRequestT = Model::GetBulkDeploymentStatusRequest>
  void GetBulkDeploymentStatusAsync(const GetBulkDeploymentStatusRequestT& request,
  ...
  /**
   * A Callable wrapper for GetConnectorDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetConnectorDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConnectorDefinitionRequestT = Model::GetConnectorDefinitionRequest>
  void GetConnectorDefinitionAsync(const GetConnectorDefinitionRequestT& request,
  ...
  virtual Model::GetConnectorDefinitionVersionOutcome GetConnectorDefinitionVersion(
      const Model::GetConnectorDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for GetConnectorDefinitionVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetConnectorDefinitionVersionRequestT = Model::GetConnectorDefinitionVersionRequest>
  Model::GetConnectorDefinitionVersionOutcomeCallable GetConnectorDefinitionVersionCallable(
      const GetConnectorDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::GetConnectorDefinitionVersion, request);
  }

  /**
   * An Async wrapper for GetConnectorDefinitionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConnectorDefinitionVersionRequestT = Model::GetConnectorDefinitionVersionRequest>
  void GetConnectorDefinitionVersionAsync(const GetConnectorDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for GetCoreDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCoreDefinition that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCoreDefinitionRequestT = Model::GetCoreDefinitionRequest>
  void GetCoreDefinitionAsync(const GetCoreDefinitionRequestT& request, const GetCoreDefinitionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCoreDefinitionVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCoreDefinitionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCoreDefinitionVersionRequestT = Model::GetCoreDefinitionVersionRequest>
  void GetCoreDefinitionVersionAsync(const GetCoreDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for GetDeploymentStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDeploymentStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDeploymentStatusRequestT = Model::GetDeploymentStatusRequest>
  void GetDeploymentStatusAsync(const GetDeploymentStatusRequestT& request, const GetDeploymentStatusResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDeviceDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDeviceDefinition that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDeviceDefinitionRequestT = Model::GetDeviceDefinitionRequest>
  void GetDeviceDefinitionAsync(const GetDeviceDefinitionRequestT& request, const GetDeviceDefinitionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDeviceDefinitionVersionOutcome GetDeviceDefinitionVersion(
      const Model::GetDeviceDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for GetDeviceDefinitionVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDeviceDefinitionVersionRequestT = Model::GetDeviceDefinitionVersionRequest>
  Model::GetDeviceDefinitionVersionOutcomeCallable GetDeviceDefinitionVersionCallable(
      const GetDeviceDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::GetDeviceDefinitionVersion, request);
  }

  /**
   * An Async wrapper for GetDeviceDefinitionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDeviceDefinitionVersionRequestT = Model::GetDeviceDefinitionVersionRequest>
  void GetDeviceDefinitionVersionAsync(const GetDeviceDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for GetFunctionDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFunctionDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFunctionDefinitionRequestT = Model::GetFunctionDefinitionRequest>
  void GetFunctionDefinitionAsync(const GetFunctionDefinitionRequestT& request, const GetFunctionDefinitionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetFunctionDefinitionVersionOutcome GetFunctionDefinitionVersion(
      const Model::GetFunctionDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for GetFunctionDefinitionVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetFunctionDefinitionVersionRequestT = Model::GetFunctionDefinitionVersionRequest>
  Model::GetFunctionDefinitionVersionOutcomeCallable GetFunctionDefinitionVersionCallable(
      const GetFunctionDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::GetFunctionDefinitionVersion, request);
  }

  /**
   * An Async wrapper for GetFunctionDefinitionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFunctionDefinitionVersionRequestT = Model::GetFunctionDefinitionVersionRequest>
  void GetFunctionDefinitionVersionAsync(const GetFunctionDefinitionVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetGroupCertificateAuthorityOutcome GetGroupCertificateAuthority(
      const Model::GetGroupCertificateAuthorityRequest& request) const;

  /**
   * A Callable wrapper for GetGroupCertificateAuthority that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetGroupCertificateAuthorityRequestT = Model::GetGroupCertificateAuthorityRequest>
  Model::GetGroupCertificateAuthorityOutcomeCallable GetGroupCertificateAuthorityCallable(
      const GetGroupCertificateAuthorityRequestT& request) const {
    return SubmitCallable(&GreengrassClient::GetGroupCertificateAuthority, request);
  }

  /**
   * An Async wrapper for GetGroupCertificateAuthority that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetGroupCertificateAuthorityRequestT = Model::GetGroupCertificateAuthorityRequest>
  void GetGroupCertificateAuthorityAsync(const GetGroupCertificateAuthorityRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetGroupCertificateConfigurationOutcome GetGroupCertificateConfiguration(
      const Model::GetGroupCertificateConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetGroupCertificateConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetGroupCertificateConfigurationRequestT = Model::GetGroupCertificateConfigurationRequest>
  Model::GetGroupCertificateConfigurationOutcomeCallable GetGroupCertificateConfigurationCallable(
      const GetGroupCertificateConfigurationRequestT& request) const {
    return SubmitCallable(&GreengrassClient::GetGroupCertificateConfiguration, request);
  }

  /**
   * An Async wrapper for GetGroupCertificateConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetGroupCertificateConfigurationRequestT = Model::GetGroupCertificateConfigurationRequest>
  void GetGroupCertificateConfigurationAsync(const GetGroupCertificateConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for GetGroupVersion that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGroupVersionRequestT = Model::GetGroupVersionRequest>
  void GetGroupVersionAsync(const GetGroupVersionRequestT& request, const GetGroupVersionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLoggerDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLoggerDefinition that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetLoggerDefinitionRequestT = Model::GetLoggerDefinitionRequest>
  void GetLoggerDefinitionAsync(const GetLoggerDefinitionRequestT& request, const GetLoggerDefinitionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetLoggerDefinitionVersionOutcome GetLoggerDefinitionVersion(
      const Model::GetLoggerDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for GetLoggerDefinitionVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetLoggerDefinitionVersionRequestT = Model::GetLoggerDefinitionVersionRequest>
  Model::GetLoggerDefinitionVersionOutcomeCallable GetLoggerDefinitionVersionCallable(
      const GetLoggerDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::GetLoggerDefinitionVersion, request);
  }

  /**
   * An Async wrapper for GetLoggerDefinitionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetLoggerDefinitionVersionRequestT = Model::GetLoggerDefinitionVersionRequest>
  void GetLoggerDefinitionVersionAsync(const GetLoggerDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for GetResourceDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResourceDefinitionRequestT = Model::GetResourceDefinitionRequest>
  void GetResourceDefinitionAsync(const GetResourceDefinitionRequestT& request, const GetResourceDefinitionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetResourceDefinitionVersionOutcome GetResourceDefinitionVersion(
      const Model::GetResourceDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for GetResourceDefinitionVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetResourceDefinitionVersionRequestT = Model::GetResourceDefinitionVersionRequest>
  Model::GetResourceDefinitionVersionOutcomeCallable GetResourceDefinitionVersionCallable(
      const GetResourceDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::GetResourceDefinitionVersion, request);
  }

  /**
   * An Async wrapper for GetResourceDefinitionVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResourceDefinitionVersionRequestT = Model::GetResourceDefinitionVersionRequest>
  void GetResourceDefinitionVersionAsync(const GetResourceDefinitionVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for GetSubscriptionDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetSubscriptionDefinitionRequestT = Model::GetSubscriptionDefinitionRequest>
  Model::GetSubscriptionDefinitionOutcomeCallable GetSubscriptionDefinitionCallable(
      const GetSubscriptionDefinitionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::GetSubscriptionDefinition, request);
  }

  /**
   * An Async wrapper for GetSubscriptionDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSubscriptionDefinitionRequestT = Model::GetSubscriptionDefinitionRequest>
  void GetSubscriptionDefinitionAsync(const GetSubscriptionDefinitionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSubscriptionDefinitionVersionOutcome GetSubscriptionDefinitionVersion(
      const Model::GetSubscriptionDefinitionVersionRequest& request) const;

  /**
   * A Callable wrapper for GetSubscriptionDefinitionVersion that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetSubscriptionDefinitionVersionRequestT = Model::GetSubscriptionDefinitionVersionRequest>
  Model::GetSubscriptionDefinitionVersionOutcomeCallable GetSubscriptionDefinitionVersionCallable(
      const GetSubscriptionDefinitionVersionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::GetSubscriptionDefinitionVersion, request);
  }

  /**
   * An Async wrapper for GetSubscriptionDefinitionVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetSubscriptionDefinitionVersionRequestT = Model::GetSubscriptionDefinitionVersionRequest>
  void GetSubscriptionDefinitionVersionAsync(const GetSubscriptionDefinitionVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetThingRuntimeConfigurationOutcome GetThingRuntimeConfiguration(
      const Model::GetThingRuntimeConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetThingRuntimeConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetThingRuntimeConfigurationRequestT = Model::GetThingRuntimeConfigurationRequest>
  Model::GetThingRuntimeConfigurationOutcomeCallable GetThingRuntimeConfigurationCallable(
      const GetThingRuntimeConfigurationRequestT& request) const {
    return SubmitCallable(&GreengrassClient::GetThingRuntimeConfiguration, request);
  }

  /**
   * An Async wrapper for GetThingRuntimeConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetThingRuntimeConfigurationRequestT = Model::GetThingRuntimeConfigurationRequest>
  void GetThingRuntimeConfigurationAsync(const GetThingRuntimeConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBulkDeploymentDetailedReportsOutcome ListBulkDeploymentDetailedReports(
      const Model::ListBulkDeploymentDetailedReportsRequest& request) const;

  /**
   * A Callable wrapper for ListBulkDeploymentDetailedReports that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListBulkDeploymentDetailedReportsRequestT = Model::ListBulkDeploymentDetailedReportsRequest>
  Model::ListBulkDeploymentDetailedReportsOutcomeCallable ListBulkDeploymentDetailedReportsCallable(
      const ListBulkDeploymentDetailedReportsRequestT& request) const {
    return SubmitCallable(&GreengrassClient::ListBulkDeploymentDetailedReports, request);
  }

  /**
   * An Async wrapper for ListBulkDeploymentDetailedReports that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListBulkDeploymentDetailedReportsRequestT = Model::ListBulkDeploymentDetailedReportsRequest>
  void ListBulkDeploymentDetailedReportsAsync(const ListBulkDeploymentDetailedReportsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListBulkDeployments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBulkDeployments that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListBulkDeploymentsRequestT = Model::ListBulkDeploymentsRequest>
  void ListBulkDeploymentsAsync(const ListBulkDeploymentsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListBulkDeploymentsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConnectorDefinitionVersionsOutcome ListConnectorDefinitionVersions(
      const Model::ListConnectorDefinitionVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListConnectorDefinitionVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListConnectorDefinitionVersionsRequestT = Model::ListConnectorDefinitionVersionsRequest>
  Model::ListConnectorDefinitionVersionsOutcomeCallable ListConnectorDefinitionVersionsCallable(
      const ListConnectorDefinitionVersionsRequestT& request) const {
    return SubmitCallable(&GreengrassClient::ListConnectorDefinitionVersions, request);
  }

  /**
   * An Async wrapper for ListConnectorDefinitionVersions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListConnectorDefinitionVersionsRequestT = Model::ListConnectorDefinitionVersionsRequest>
  void ListConnectorDefinitionVersionsAsync(const ListConnectorDefinitionVersionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListConnectorDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListConnectorDefinitionsRequestT = Model::ListConnectorDefinitionsRequest>
  Model::ListConnectorDefinitionsOutcomeCallable ListConnectorDefinitionsCallable(
      const ListConnectorDefinitionsRequestT& request = {}) const {
    return SubmitCallable(&GreengrassClient::ListConnectorDefinitions, request);
  }

  /**
   * An Async wrapper for ListConnectorDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConnectorDefinitionsRequestT = Model::ListConnectorDefinitionsRequest>
  void ListConnectorDefinitionsAsync(const ListConnectorDefinitionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListConnectorDefinitionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCoreDefinitionVersionsOutcome ListCoreDefinitionVersions(
      const Model::ListCoreDefinitionVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListCoreDefinitionVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCoreDefinitionVersionsRequestT = Model::ListCoreDefinitionVersionsRequest>
  Model::ListCoreDefinitionVersionsOutcomeCallable ListCoreDefinitionVersionsCallable(
      const ListCoreDefinitionVersionsRequestT& request) const {
    return SubmitCallable(&GreengrassClient::ListCoreDefinitionVersions, request);
  }

  /**
   * An Async wrapper for ListCoreDefinitionVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCoreDefinitionVersionsRequestT = Model::ListCoreDefinitionVersionsRequest>
  void ListCoreDefinitionVersionsAsync(const ListCoreDefinitionVersionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListCoreDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCoreDefinitions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCoreDefinitionsRequestT = Model::ListCoreDefinitionsRequest>
  void ListCoreDefinitionsAsync(const ListCoreDefinitionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListCoreDefinitionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDeviceDefinitionVersionsOutcome ListDeviceDefinitionVersions(
      const Model::ListDeviceDefinitionVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListDeviceDefinitionVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDeviceDefinitionVersionsRequestT = Model::ListDeviceDefinitionVersionsRequest>
  Model::ListDeviceDefinitionVersionsOutcomeCallable ListDeviceDefinitionVersionsCallable(
      const ListDeviceDefinitionVersionsRequestT& request) const {
    return SubmitCallable(&GreengrassClient::ListDeviceDefinitionVersions, request);
  }

  /**
   * An Async wrapper for ListDeviceDefinitionVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDeviceDefinitionVersionsRequestT = Model::ListDeviceDefinitionVersionsRequest>
  void ListDeviceDefinitionVersionsAsync(const ListDeviceDefinitionVersionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListDeviceDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDeviceDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDeviceDefinitionsRequestT = Model::ListDeviceDefinitionsRequest>
  void ListDeviceDefinitionsAsync(const ListDeviceDefinitionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListDeviceDefinitionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListFunctionDefinitionVersionsOutcome ListFunctionDefinitionVersions(
      const Model::ListFunctionDefinitionVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListFunctionDefinitionVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListFunctionDefinitionVersionsRequestT = Model::ListFunctionDefinitionVersionsRequest>
  Model::ListFunctionDefinitionVersionsOutcomeCallable ListFunctionDefinitionVersionsCallable(
      const ListFunctionDefinitionVersionsRequestT& request) const {
    return SubmitCallable(&GreengrassClient::ListFunctionDefinitionVersions, request);
  }

  /**
   * An Async wrapper for ListFunctionDefinitionVersions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListFunctionDefinitionVersionsRequestT = Model::ListFunctionDefinitionVersionsRequest>
  void ListFunctionDefinitionVersionsAsync(const ListFunctionDefinitionVersionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListFunctionDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFunctionDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFunctionDefinitionsRequestT = Model::ListFunctionDefinitionsRequest>
  void ListFunctionDefinitionsAsync(const ListFunctionDefinitionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListFunctionDefinitionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListGroupCertificateAuthoritiesOutcome ListGroupCertificateAuthorities(
      const Model::ListGroupCertificateAuthoritiesRequest& request) const;

  /**
   * A Callable wrapper for ListGroupCertificateAuthorities that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListGroupCertificateAuthoritiesRequestT = Model::ListGroupCertificateAuthoritiesRequest>
  Model::ListGroupCertificateAuthoritiesOutcomeCallable ListGroupCertificateAuthoritiesCallable(
      const ListGroupCertificateAuthoritiesRequestT& request) const {
    return SubmitCallable(&GreengrassClient::ListGroupCertificateAuthorities, request);
  }

  /**
   * An Async wrapper for ListGroupCertificateAuthorities that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListGroupCertificateAuthoritiesRequestT = Model::ListGroupCertificateAuthoritiesRequest>
  void ListGroupCertificateAuthoritiesAsync(const ListGroupCertificateAuthoritiesRequestT& request,
  ...
  /**
   * A Callable wrapper for ListGroupVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGroupVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGroupVersionsRequestT = Model::ListGroupVersionsRequest>
  void ListGroupVersionsAsync(const ListGroupVersionsRequestT& request, const ListGroupVersionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListLoggerDefinitionVersionsOutcome ListLoggerDefinitionVersions(
      const Model::ListLoggerDefinitionVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListLoggerDefinitionVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListLoggerDefinitionVersionsRequestT = Model::ListLoggerDefinitionVersionsRequest>
  Model::ListLoggerDefinitionVersionsOutcomeCallable ListLoggerDefinitionVersionsCallable(
      const ListLoggerDefinitionVersionsRequestT& request) const {
    return SubmitCallable(&GreengrassClient::ListLoggerDefinitionVersions, request);
  }

  /**
   * An Async wrapper for ListLoggerDefinitionVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLoggerDefinitionVersionsRequestT = Model::ListLoggerDefinitionVersionsRequest>
  void ListLoggerDefinitionVersionsAsync(const ListLoggerDefinitionVersionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListLoggerDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLoggerDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLoggerDefinitionsRequestT = Model::ListLoggerDefinitionsRequest>
  void ListLoggerDefinitionsAsync(const ListLoggerDefinitionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListLoggerDefinitionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResourceDefinitionVersionsOutcome ListResourceDefinitionVersions(
      const Model::ListResourceDefinitionVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListResourceDefinitionVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListResourceDefinitionVersionsRequestT = Model::ListResourceDefinitionVersionsRequest>
  Model::ListResourceDefinitionVersionsOutcomeCallable ListResourceDefinitionVersionsCallable(
      const ListResourceDefinitionVersionsRequestT& request) const {
    return SubmitCallable(&GreengrassClient::ListResourceDefinitionVersions, request);
  }

  /**
   * An Async wrapper for ListResourceDefinitionVersions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListResourceDefinitionVersionsRequestT = Model::ListResourceDefinitionVersionsRequest>
  void ListResourceDefinitionVersionsAsync(const ListResourceDefinitionVersionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListResourceDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceDefinitionsRequestT = Model::ListResourceDefinitionsRequest>
  void ListResourceDefinitionsAsync(const ListResourceDefinitionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListResourceDefinitionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSubscriptionDefinitionVersionsOutcome ListSubscriptionDefinitionVersions(
      const Model::ListSubscriptionDefinitionVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListSubscriptionDefinitionVersions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListSubscriptionDefinitionVersionsRequestT = Model::ListSubscriptionDefinitionVersionsRequest>
  Model::ListSubscriptionDefinitionVersionsOutcomeCallable ListSubscriptionDefinitionVersionsCallable(
      const ListSubscriptionDefinitionVersionsRequestT& request) const {
    return SubmitCallable(&GreengrassClient::ListSubscriptionDefinitionVersions, request);
  }

  /**
   * An Async wrapper for ListSubscriptionDefinitionVersions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListSubscriptionDefinitionVersionsRequestT = Model::ListSubscriptionDefinitionVersionsRequest>
  void ListSubscriptionDefinitionVersionsAsync(const ListSubscriptionDefinitionVersionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSubscriptionDefinitionsOutcome ListSubscriptionDefinitions(
      const Model::ListSubscriptionDefinitionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSubscriptionDefinitions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSubscriptionDefinitionsRequestT = Model::ListSubscriptionDefinitionsRequest>
  Model::ListSubscriptionDefinitionsOutcomeCallable ListSubscriptionDefinitionsCallable(
      const ListSubscriptionDefinitionsRequestT& request = {}) const {
    return SubmitCallable(&GreengrassClient::ListSubscriptionDefinitions, request);
  }

  /**
   * An Async wrapper for ListSubscriptionDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSubscriptionDefinitionsRequestT = Model::ListSubscriptionDefinitionsRequest>
  void ListSubscriptionDefinitionsAsync(const ListSubscriptionDefinitionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListSubscriptionDefinitionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ResetDeployments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetDeployments that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ResetDeploymentsRequestT = Model::ResetDeploymentsRequest>
  void ResetDeploymentsAsync(const ResetDeploymentsRequestT& request, const ResetDeploymentsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartBulkDeployment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartBulkDeployment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartBulkDeploymentRequestT = Model::StartBulkDeploymentRequest>
  void StartBulkDeploymentAsync(const StartBulkDeploymentRequestT& request, const StartBulkDeploymentResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopBulkDeployment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopBulkDeployment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopBulkDeploymentRequestT = Model::StopBulkDeploymentRequest>
  void StopBulkDeploymentAsync(const StopBulkDeploymentRequestT& request, const StopBulkDeploymentResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateConnectorDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateConnectorDefinitionRequestT = Model::UpdateConnectorDefinitionRequest>
  Model::UpdateConnectorDefinitionOutcomeCallable UpdateConnectorDefinitionCallable(
      const UpdateConnectorDefinitionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::UpdateConnectorDefinition, request);
  }

  /**
   * An Async wrapper for UpdateConnectorDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConnectorDefinitionRequestT = Model::UpdateConnectorDefinitionRequest>
  void UpdateConnectorDefinitionAsync(const UpdateConnectorDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateCoreDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCoreDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCoreDefinitionRequestT = Model::UpdateCoreDefinitionRequest>
  void UpdateCoreDefinitionAsync(const UpdateCoreDefinitionRequestT& request, const UpdateCoreDefinitionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDeviceDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDeviceDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDeviceDefinitionRequestT = Model::UpdateDeviceDefinitionRequest>
  void UpdateDeviceDefinitionAsync(const UpdateDeviceDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateFunctionDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFunctionDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFunctionDefinitionRequestT = Model::UpdateFunctionDefinitionRequest>
  void UpdateFunctionDefinitionAsync(const UpdateFunctionDefinitionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateGroupCertificateConfigurationOutcome UpdateGroupCertificateConfiguration(
      const Model::UpdateGroupCertificateConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateGroupCertificateConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateGroupCertificateConfigurationRequestT = Model::UpdateGroupCertificateConfigurationRequest>
  Model::UpdateGroupCertificateConfigurationOutcomeCallable UpdateGroupCertificateConfigurationCallable(
      const UpdateGroupCertificateConfigurationRequestT& request) const {
    return SubmitCallable(&GreengrassClient::UpdateGroupCertificateConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateGroupCertificateConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateGroupCertificateConfigurationRequestT = Model::UpdateGroupCertificateConfigurationRequest>
  void UpdateGroupCertificateConfigurationAsync(const UpdateGroupCertificateConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateLoggerDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateLoggerDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateLoggerDefinitionRequestT = Model::UpdateLoggerDefinitionRequest>
  void UpdateLoggerDefinitionAsync(const UpdateLoggerDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateResourceDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResourceDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResourceDefinitionRequestT = Model::UpdateResourceDefinitionRequest>
  void UpdateResourceDefinitionAsync(const UpdateResourceDefinitionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateSubscriptionDefinitionOutcome UpdateSubscriptionDefinition(
      const Model::UpdateSubscriptionDefinitionRequest& request) const;

  /**
   * A Callable wrapper for UpdateSubscriptionDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateSubscriptionDefinitionRequestT = Model::UpdateSubscriptionDefinitionRequest>
  Model::UpdateSubscriptionDefinitionOutcomeCallable UpdateSubscriptionDefinitionCallable(
      const UpdateSubscriptionDefinitionRequestT& request) const {
    return SubmitCallable(&GreengrassClient::UpdateSubscriptionDefinition, request);
  }

  /**
   * An Async wrapper for UpdateSubscriptionDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSubscriptionDefinitionRequestT = Model::UpdateSubscriptionDefinitionRequest>
  void UpdateSubscriptionDefinitionAsync(const UpdateSubscriptionDefinitionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateThingRuntimeConfigurationOutcome UpdateThingRuntimeConfiguration(
      const Model::UpdateThingRuntimeConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateThingRuntimeConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateThingRuntimeConfigurationRequestT = Model::UpdateThingRuntimeConfigurationRequest>
  Model::UpdateThingRuntimeConfigurationOutcomeCallable UpdateThingRuntimeConfigurationCallable(
      const UpdateThingRuntimeConfigurationRequestT& request) const {
    return SubmitCallable(&GreengrassClient::UpdateThingRuntimeConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateThingRuntimeConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateThingRuntimeConfigurationRequestT = Model::UpdateThingRuntimeConfigurationRequest>
  void UpdateThingRuntimeConfigurationAsync(const UpdateThingRuntimeConfigurationRequestT& request,
