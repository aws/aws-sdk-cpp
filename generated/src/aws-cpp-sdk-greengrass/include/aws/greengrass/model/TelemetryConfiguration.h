...
class TelemetryConfiguration {
 public:
  ...
  inline void SetConfigurationSyncStatus(ConfigurationSyncStatus value) {
    m_configurationSyncStatusHasBeenSet = true;
    m_configurationSyncStatus = value;
  }
  inline TelemetryConfiguration& WithConfigurationSyncStatus(ConfigurationSyncStatus value) {
    SetConfigurationSyncStatus(value);
    return *this;
  }
  ///@}
  ...
  inline TelemetryConfiguration& WithTelemetry(Telemetry value) {
    SetTelemetry(value);
    return *this;
  }
  ///@}
