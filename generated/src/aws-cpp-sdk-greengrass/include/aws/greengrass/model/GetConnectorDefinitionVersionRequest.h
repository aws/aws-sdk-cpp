...
class GetConnectorDefinitionVersionRequest : public GreengrassRequest {
 public:
  ...
  template <typename ConnectorDefinitionIdT = Aws::String>
  GetConnectorDefinitionVersionRequest& WithConnectorDefinitionId(ConnectorDefinitionIdT&& value) {
  ...
  void SetConnectorDefinitionVersionId(ConnectorDefinitionVersionIdT&& value) {
    m_connectorDefinitionVersionIdHasBeenSet = true;
    m_connectorDefinitionVersionId = std::forward<ConnectorDefinitionVersionIdT>(value);
  }
  template <typename ConnectorDefinitionVersionIdT = Aws::String>
  GetConnectorDefinitionVersionRequest& WithConnectorDefinitionVersionId(ConnectorDefinitionVersionIdT&& value) {
    SetConnectorDefinitionVersionId(std::forward<ConnectorDefinitionVersionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetConnectorDefinitionVersionRequest& WithNextToken(NextTokenT&& value) {
