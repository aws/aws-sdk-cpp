...
class GetResourceDefinitionVersionRequest : public GreengrassRequest {
 public:
  ...
  void SetResourceDefinitionId(ResourceDefinitionIdT&& value) {
    m_resourceDefinitionIdHasBeenSet = true;
    m_resourceDefinitionId = std::forward<ResourceDefinitionIdT>(value);
  }
  template <typename ResourceDefinitionIdT = Aws::String>
  GetResourceDefinitionVersionRequest& WithResourceDefinitionId(ResourceDefinitionIdT&& value) {
    SetResourceDefinitionId(std::forward<ResourceDefinitionIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceDefinitionVersionId(ResourceDefinitionVersionIdT&& value) {
    m_resourceDefinitionVersionIdHasBeenSet = true;
    m_resourceDefinitionVersionId = std::forward<ResourceDefinitionVersionIdT>(value);
  }
  template <typename ResourceDefinitionVersionIdT = Aws::String>
  GetResourceDefinitionVersionRequest& WithResourceDefinitionVersionId(ResourceDefinitionVersionIdT&& value) {
    SetResourceDefinitionVersionId(std::forward<ResourceDefinitionVersionIdT>(value));
    return *this;
  }
  ///@}
 private:
