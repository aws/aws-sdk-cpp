...
class ListConnectorDefinitionVersionsResult {
 public:
  ...
  AWS_GREENGRASS_API ListConnectorDefinitionVersionsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectorDefinitionVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VersionsT = Aws::Vector<VersionInformation>>
  ListConnectorDefinitionVersionsResult& WithVersions(VersionsT&& value) {
    SetVersions(std::forward<VersionsT>(value));
    return *this;
  }
  template <typename VersionsT = VersionInformation>
  ListConnectorDefinitionVersionsResult& AddVersions(VersionsT&& value) {
    m_versionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListConnectorDefinitionVersionsResult& WithRequestId(RequestIdT&& value) {
