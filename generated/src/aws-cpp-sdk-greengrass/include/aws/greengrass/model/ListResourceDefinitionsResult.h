...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API ListResourceDefinitionsResult() = default;
    ...
    template<typename DefinitionsT = Aws::Vector<DefinitionInformation>>
    ListResourceDefinitionsResult& WithDefinitions(DefinitionsT&& value) { SetDefinitions(std::forward<DefinitionsT>(value)); return *this;}
    template<typename DefinitionsT = DefinitionInformation>
    ListResourceDefinitionsResult& AddDefinitions(DefinitionsT&& value) { m_definitionsHasBeenSet = true; m_definitions.emplace_back(std::forward<DefinitionsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListResourceDefinitionsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListResourceDefinitionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
