...
class ListResourceDefinitionsResult {
 public:
  ...
  template <typename DefinitionsT = Aws::Vector<DefinitionInformation>>
  ListResourceDefinitionsResult& WithDefinitions(DefinitionsT&& value) {
    SetDefinitions(std::forward<DefinitionsT>(value));
    return *this;
  }
  template <typename DefinitionsT = DefinitionInformation>
  ListResourceDefinitionsResult& AddDefinitions(DefinitionsT&& value) {
    m_definitionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceDefinitionsResult& WithRequestId(RequestIdT&& value) {
