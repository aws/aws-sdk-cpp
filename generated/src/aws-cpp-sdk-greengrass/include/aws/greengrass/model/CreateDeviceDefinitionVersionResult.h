...
class CreateDeviceDefinitionVersionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateDeviceDefinitionVersionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  CreateDeviceDefinitionVersionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateDeviceDefinitionVersionResult& WithId(IdT&& value) {
  ...
  template <typename VersionT = Aws::String>
  CreateDeviceDefinitionVersionResult& WithVersion(VersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDeviceDefinitionVersionResult& WithRequestId(RequestIdT&& value) {
