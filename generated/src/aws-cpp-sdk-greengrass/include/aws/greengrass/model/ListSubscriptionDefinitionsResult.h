...
class ListSubscriptionDefinitionsResult {
 public:
  ...
  template <typename DefinitionsT = Aws::Vector<DefinitionInformation>>
  ListSubscriptionDefinitionsResult& WithDefinitions(DefinitionsT&& value) {
    SetDefinitions(std::forward<DefinitionsT>(value));
    return *this;
  }
  template <typename DefinitionsT = DefinitionInformation>
  ListSubscriptionDefinitionsResult& AddDefinitions(DefinitionsT&& value) {
    m_definitionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSubscriptionDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSubscriptionDefinitionsResult& WithRequestId(RequestIdT&& value) {
