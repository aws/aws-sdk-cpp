...
namespace Model
{
  ...
  public:
    ...
    template<typename ErrorDetailsT = Aws::Vector<ErrorDetail>>
    InternalServerErrorException& WithErrorDetails(ErrorDetailsT&& value) { SetErrorDetails(std::forward<ErrorDetailsT>(value)); return *this;}
    template<typename ErrorDetailsT = ErrorDetail>
    InternalServerErrorException& AddErrorDetails(ErrorDetailsT&& value) { m_errorDetailsHasBeenSet = true; m_errorDetails.emplace_back(std::forward<ErrorDetailsT>(value)); return *this; }
    ///@}
