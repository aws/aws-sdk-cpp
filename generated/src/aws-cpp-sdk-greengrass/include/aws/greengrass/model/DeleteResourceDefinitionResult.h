...
namespace Model
{
  ...
  public:
    ...
    inline DeleteResourceDefinitionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteResourceDefinitionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteResourceDefinitionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
