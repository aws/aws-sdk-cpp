...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API DeleteResourceDefinitionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteResourceDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
