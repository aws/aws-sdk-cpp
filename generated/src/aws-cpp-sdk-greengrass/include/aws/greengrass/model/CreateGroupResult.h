...
class CreateGroupResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateGroupResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  CreateGroupResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateGroupResult& WithId(IdT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::String>
  CreateGroupResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename LatestVersionT = Aws::String>
  CreateGroupResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  template <typename LatestVersionArnT = Aws::String>
  CreateGroupResult& WithLatestVersionArn(LatestVersionArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateGroupResult& WithName(NameT&& value) {
