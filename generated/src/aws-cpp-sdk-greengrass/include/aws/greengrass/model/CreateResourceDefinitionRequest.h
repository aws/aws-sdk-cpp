...
class CreateResourceDefinitionRequest : public GreengrassRequest {
 public:
  ...
  template <typename AmznClientTokenT = Aws::String>
  CreateResourceDefinitionRequest& WithAmznClientToken(AmznClientTokenT&& value) {
  ...
  template <typename InitialVersionT = ResourceDefinitionVersion>
  CreateResourceDefinitionRequest& WithInitialVersion(InitialVersionT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateResourceDefinitionRequest& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateResourceDefinitionRequest& WithTags(TagsT&& value) {
