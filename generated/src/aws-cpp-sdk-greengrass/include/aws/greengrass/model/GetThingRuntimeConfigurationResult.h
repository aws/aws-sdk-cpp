...
class GetThingRuntimeConfigurationResult {
 public:
  ...
  template <typename RuntimeConfigurationT = RuntimeConfiguration>
  GetThingRuntimeConfigurationResult& WithRuntimeConfiguration(RuntimeConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetThingRuntimeConfigurationResult& WithRequestId(RequestIdT&& value) {
