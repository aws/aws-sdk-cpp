...
class ListBulkDeploymentDetailedReportsResult {
 public:
  ...
  AWS_GREENGRASS_API ListBulkDeploymentDetailedReportsResult& operator=(
  ...
  template <typename DeploymentsT = Aws::Vector<BulkDeploymentResult>>
  ListBulkDeploymentDetailedReportsResult& WithDeployments(DeploymentsT&& value) {
    SetDeployments(std::forward<DeploymentsT>(value));
    return *this;
  }
  template <typename DeploymentsT = BulkDeploymentResult>
  ListBulkDeploymentDetailedReportsResult& AddDeployments(DeploymentsT&& value) {
    m_deploymentsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBulkDeploymentDetailedReportsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBulkDeploymentDetailedReportsResult& WithRequestId(RequestIdT&& value) {
