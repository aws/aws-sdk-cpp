...
class ListResourceDefinitionVersionsResult {
 public:
  ...
  AWS_GREENGRASS_API ListResourceDefinitionVersionsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceDefinitionVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VersionsT = Aws::Vector<VersionInformation>>
  ListResourceDefinitionVersionsResult& WithVersions(VersionsT&& value) {
    SetVersions(std::forward<VersionsT>(value));
    return *this;
  }
  template <typename VersionsT = VersionInformation>
  ListResourceDefinitionVersionsResult& AddVersions(VersionsT&& value) {
    m_versionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceDefinitionVersionsResult& WithRequestId(RequestIdT&& value) {
