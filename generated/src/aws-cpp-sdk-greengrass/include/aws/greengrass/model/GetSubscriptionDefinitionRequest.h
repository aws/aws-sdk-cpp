...
class GetSubscriptionDefinitionRequest : public GreengrassRequest {
 public:
  AWS_GREENGRASS_API GetSubscriptionDefinitionRequest() = default;
  ...
  template <typename SubscriptionDefinitionIdT = Aws::String>
  GetSubscriptionDefinitionRequest& WithSubscriptionDefinitionId(SubscriptionDefinitionIdT&& value) {
