...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API ListLoggerDefinitionVersionsResult();
    ...
    inline ListLoggerDefinitionVersionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListLoggerDefinitionVersionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListLoggerDefinitionVersionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
