...
class CreateDeviceDefinitionVersionRequest : public GreengrassRequest {
 public:
  ...
  template <typename AmznClientTokenT = Aws::String>
  CreateDeviceDefinitionVersionRequest& WithAmznClientToken(AmznClientTokenT&& value) {
  ...
  void SetDeviceDefinitionId(DeviceDefinitionIdT&& value) {
    m_deviceDefinitionIdHasBeenSet = true;
    m_deviceDefinitionId = std::forward<DeviceDefinitionIdT>(value);
  }
  template <typename DeviceDefinitionIdT = Aws::String>
  CreateDeviceDefinitionVersionRequest& WithDeviceDefinitionId(DeviceDefinitionIdT&& value) {
    SetDeviceDefinitionId(std::forward<DeviceDefinitionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DevicesT = Aws::Vector<Device>>
  CreateDeviceDefinitionVersionRequest& WithDevices(DevicesT&& value) {
    SetDevices(std::forward<DevicesT>(value));
    return *this;
  }
  template <typename DevicesT = Device>
  CreateDeviceDefinitionVersionRequest& AddDevices(DevicesT&& value) {
    m_devicesHasBeenSet = true;
