...
class SecretsManagerSecretResourceData {
 public:
  ...
  template <typename ARNT = Aws::String>
  SecretsManagerSecretResourceData& WithARN(ARNT&& value) {
  ...
  void SetAdditionalStagingLabelsToDownload(AdditionalStagingLabelsToDownloadT&& value) {
    ...
    m_additionalStagingLabelsToDownload = std::forward<AdditionalStagingLabelsToDownloadT>(value);
  }
  template <typename AdditionalStagingLabelsToDownloadT = Aws::Vector<Aws::String>>
  SecretsManagerSecretResourceData& WithAdditionalStagingLabelsToDownload(AdditionalStagingLabelsToDownloadT&& value) {
    SetAdditionalStagingLabelsToDownload(std::forward<AdditionalStagingLabelsToDownloadT>(value));
    return *this;
  }
  ...
  SecretsManagerSecretResourceData& AddAdditionalStagingLabelsToDownload(AdditionalStagingLabelsToDownloadT&& value) {
    m_additionalStagingLabelsToDownloadHasBeenSet = true;
    m_additionalStagingLabelsToDownload.emplace_back(std::forward<AdditionalStagingLabelsToDownloadT>(value));
    return *this;
  }
  ///@}
 private:
