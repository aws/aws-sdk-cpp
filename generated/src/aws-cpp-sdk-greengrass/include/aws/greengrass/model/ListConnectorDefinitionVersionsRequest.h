...
class ListConnectorDefinitionVersionsRequest : public GreengrassRequest {
 public:
  ...
  void SetConnectorDefinitionId(ConnectorDefinitionIdT&& value) {
    m_connectorDefinitionIdHasBeenSet = true;
    m_connectorDefinitionId = std::forward<ConnectorDefinitionIdT>(value);
  }
  template <typename ConnectorDefinitionIdT = Aws::String>
  ListConnectorDefinitionVersionsRequest& WithConnectorDefinitionId(ConnectorDefinitionIdT&& value) {
    SetConnectorDefinitionId(std::forward<ConnectorDefinitionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MaxResultsT = Aws::String>
  ListConnectorDefinitionVersionsRequest& WithMaxResults(MaxResultsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectorDefinitionVersionsRequest& WithNextToken(NextTokenT&& value) {
