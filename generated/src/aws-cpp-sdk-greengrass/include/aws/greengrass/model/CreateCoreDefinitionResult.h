...
class CreateCoreDefinitionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateCoreDefinitionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  CreateCoreDefinitionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateCoreDefinitionResult& WithId(IdT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::String>
  CreateCoreDefinitionResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename LatestVersionT = Aws::String>
  CreateCoreDefinitionResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  template <typename LatestVersionArnT = Aws::String>
  CreateCoreDefinitionResult& WithLatestVersionArn(LatestVersionArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateCoreDefinitionResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCoreDefinitionResult& WithRequestId(RequestIdT&& value) {
