...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API DeleteSubscriptionDefinitionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSubscriptionDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
