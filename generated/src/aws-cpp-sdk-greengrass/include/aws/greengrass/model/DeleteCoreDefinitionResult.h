...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API DeleteCoreDefinitionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteCoreDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
