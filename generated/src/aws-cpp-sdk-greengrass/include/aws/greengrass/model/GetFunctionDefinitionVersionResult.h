...
class GetFunctionDefinitionVersionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetFunctionDefinitionVersionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  GetFunctionDefinitionVersionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename DefinitionT = FunctionDefinitionVersion>
  GetFunctionDefinitionVersionResult& WithDefinition(DefinitionT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetFunctionDefinitionVersionResult& WithId(IdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetFunctionDefinitionVersionResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VersionT = Aws::String>
  GetFunctionDefinitionVersionResult& WithVersion(VersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFunctionDefinitionVersionResult& WithRequestId(RequestIdT&& value) {
