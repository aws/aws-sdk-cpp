...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API ListSubscriptionDefinitionVersionsResult() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListSubscriptionDefinitionVersionsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionsT = Aws::Vector<VersionInformation>>
    ListSubscriptionDefinitionVersionsResult& WithVersions(VersionsT&& value) { SetVersions(std::forward<VersionsT>(value)); return *this;}
    template<typename VersionsT = VersionInformation>
    ListSubscriptionDefinitionVersionsResult& AddVersions(VersionsT&& value) { m_versionsHasBeenSet = true; m_versions.emplace_back(std::forward<VersionsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListSubscriptionDefinitionVersionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
