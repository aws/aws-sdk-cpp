...
class ListSubscriptionDefinitionVersionsResult {
 public:
  ...
  AWS_GREENGRASS_API ListSubscriptionDefinitionVersionsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListSubscriptionDefinitionVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VersionsT = Aws::Vector<VersionInformation>>
  ListSubscriptionDefinitionVersionsResult& WithVersions(VersionsT&& value) {
    SetVersions(std::forward<VersionsT>(value));
    return *this;
  }
  template <typename VersionsT = VersionInformation>
  ListSubscriptionDefinitionVersionsResult& AddVersions(VersionsT&& value) {
    m_versionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListSubscriptionDefinitionVersionsResult& WithRequestId(RequestIdT&& value) {
