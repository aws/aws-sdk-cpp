...
class GetDeviceDefinitionVersionRequest : public GreengrassRequest {
 public:
  ...
  template <typename DeviceDefinitionIdT = Aws::String>
  GetDeviceDefinitionVersionRequest& WithDeviceDefinitionId(DeviceDefinitionIdT&& value) {
  ...
  void SetDeviceDefinitionVersionId(DeviceDefinitionVersionIdT&& value) {
    m_deviceDefinitionVersionIdHasBeenSet = true;
    m_deviceDefinitionVersionId = std::forward<DeviceDefinitionVersionIdT>(value);
  }
  template <typename DeviceDefinitionVersionIdT = Aws::String>
  GetDeviceDefinitionVersionRequest& WithDeviceDefinitionVersionId(DeviceDefinitionVersionIdT&& value) {
    SetDeviceDefinitionVersionId(std::forward<DeviceDefinitionVersionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetDeviceDefinitionVersionRequest& WithNextToken(NextTokenT&& value) {
