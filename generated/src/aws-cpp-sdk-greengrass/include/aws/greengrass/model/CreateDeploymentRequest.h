...
class CreateDeploymentRequest : public GreengrassRequest {
 public:
  ...
  inline CreateDeploymentRequest& WithDeploymentType(DeploymentType value) {
  ...
  void SetGroupVersionId(GroupVersionIdT&& value) {
    m_groupVersionIdHasBeenSet = true;
    m_groupVersionId = std::forward<GroupVersionIdT>(value);
  }
  template <typename GroupVersionIdT = Aws::String>
  CreateDeploymentRequest& WithGroupVersionId(GroupVersionIdT&& value) {
    SetGroupVersionId(std::forward<GroupVersionIdT>(value));
    return *this;
  }
  ///@}
 private:
