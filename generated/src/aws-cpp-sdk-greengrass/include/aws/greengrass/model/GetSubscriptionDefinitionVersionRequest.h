...
class GetSubscriptionDefinitionVersionRequest : public GreengrassRequest {
 public:
  ...
  void SetSubscriptionDefinitionVersionId(SubscriptionDefinitionVersionIdT&& value) {
    m_subscriptionDefinitionVersionIdHasBeenSet = true;
    m_subscriptionDefinitionVersionId = std::forward<SubscriptionDefinitionVersionIdT>(value);
  }
  template <typename SubscriptionDefinitionVersionIdT = Aws::String>
  GetSubscriptionDefinitionVersionRequest& WithSubscriptionDefinitionVersionId(SubscriptionDefinitionVersionIdT&& value) {
    SetSubscriptionDefinitionVersionId(std::forward<SubscriptionDefinitionVersionIdT>(value));
    return *this;
  }
  ///@}
 private:
