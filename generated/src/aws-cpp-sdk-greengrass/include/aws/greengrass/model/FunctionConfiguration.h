...
class FunctionConfiguration {
 public:
  ...
  inline FunctionConfiguration& WithEncodingType(EncodingType value) {
  ...
  void SetExecArgs(ExecArgsT&& value) {
    ...
    m_execArgs = std::forward<ExecArgsT>(value);
  }
  template <typename ExecArgsT = Aws::String>
  FunctionConfiguration& WithExecArgs(ExecArgsT&& value) {
    SetExecArgs(std::forward<ExecArgsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExecutable(ExecutableT&& value) {
    ...
    m_executable = std::forward<ExecutableT>(value);
  }
  template <typename ExecutableT = Aws::String>
  FunctionConfiguration& WithExecutable(ExecutableT&& value) {
    SetExecutable(std::forward<ExecutableT>(value));
    return *this;
  }
  ///@}
  ...
  inline FunctionConfiguration& WithPinned(bool value) {
    SetPinned(value);
    return *this;
  }
  ///@}
  ...
  void SetFunctionRuntimeOverride(FunctionRuntimeOverrideT&& value) {
    ...
    m_functionRuntimeOverride = std::forward<FunctionRuntimeOverrideT>(value);
  }
  template <typename FunctionRuntimeOverrideT = Aws::String>
  FunctionConfiguration& WithFunctionRuntimeOverride(FunctionRuntimeOverrideT&& value) {
    SetFunctionRuntimeOverride(std::forward<FunctionRuntimeOverrideT>(value));
    return *this;
  }
  ///@}
 private:
