...
class ErrorDetail {
 public:
  ...
  void SetDetailedErrorCode(DetailedErrorCodeT&& value) {
    m_detailedErrorCodeHasBeenSet = true;
    m_detailedErrorCode = std::forward<DetailedErrorCodeT>(value);
  }
  template <typename DetailedErrorCodeT = Aws::String>
  ErrorDetail& WithDetailedErrorCode(DetailedErrorCodeT&& value) {
    SetDetailedErrorCode(std::forward<DetailedErrorCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDetailedErrorMessage(DetailedErrorMessageT&& value) {
    m_detailedErrorMessageHasBeenSet = true;
    m_detailedErrorMessage = std::forward<DetailedErrorMessageT>(value);
  }
  template <typename DetailedErrorMessageT = Aws::String>
  ErrorDetail& WithDetailedErrorMessage(DetailedErrorMessageT&& value) {
    SetDetailedErrorMessage(std::forward<DetailedErrorMessageT>(value));
    return *this;
  }
  ///@}
 private:
