...
class ListDeviceDefinitionVersionsRequest : public GreengrassRequest {
 public:
  ...
  template <typename DeviceDefinitionIdT = Aws::String>
  ListDeviceDefinitionVersionsRequest& WithDeviceDefinitionId(DeviceDefinitionIdT&& value) {
  ...
  template <typename MaxResultsT = Aws::String>
  ListDeviceDefinitionVersionsRequest& WithMaxResults(MaxResultsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDeviceDefinitionVersionsRequest& WithNextToken(NextTokenT&& value) {
