...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API DeleteDeviceDefinitionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDeviceDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
