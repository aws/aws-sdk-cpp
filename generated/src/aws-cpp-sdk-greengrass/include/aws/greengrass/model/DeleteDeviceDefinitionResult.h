...
namespace Model
{
  ...
  public:
    ...
    inline DeleteDeviceDefinitionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteDeviceDefinitionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteDeviceDefinitionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
