...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API ListFunctionDefinitionsResult();
    ...
    inline ListFunctionDefinitionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListFunctionDefinitionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListFunctionDefinitionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
