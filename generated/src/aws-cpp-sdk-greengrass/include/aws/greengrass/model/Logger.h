...
class Logger {
 public:
  ...
  inline void SetComponent(LoggerComponent value) {
    m_componentHasBeenSet = true;
    m_component = value;
  }
  inline Logger& WithComponent(LoggerComponent value) {
    SetComponent(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLevel(LoggerLevel value) {
    m_levelHasBeenSet = true;
    m_level = value;
  }
  inline Logger& WithLevel(LoggerLevel value) {
    SetLevel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpace(int value) {
    m_spaceHasBeenSet = true;
    m_space = value;
  }
  inline Logger& WithSpace(int value) {
    SetSpace(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(LoggerType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Logger& WithType(LoggerType value) {
    SetType(value);
    return *this;
  }
  ///@}
