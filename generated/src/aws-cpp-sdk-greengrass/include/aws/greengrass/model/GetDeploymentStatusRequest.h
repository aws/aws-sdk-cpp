...
class GetDeploymentStatusRequest : public GreengrassRequest {
 public:
  AWS_GREENGRASS_API GetDeploymentStatusRequest() = default;
  ...
  template <typename DeploymentIdT = Aws::String>
  GetDeploymentStatusRequest& WithDeploymentId(DeploymentIdT&& value) {
  ...
  template <typename GroupIdT = Aws::String>
  GetDeploymentStatusRequest& WithGroupId(GroupIdT&& value) {
