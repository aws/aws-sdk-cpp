...
namespace Model
{
  ...
  public:
    ...
    inline FunctionExecutionConfig& WithIsolationMode(FunctionIsolationMode value) { SetIsolationMode(value); return *this;}
    ///@}
    ...
    template<typename RunAsT = FunctionRunAsConfig>
    FunctionExecutionConfig& WithRunAs(RunAsT&& value) { SetRunAs(std::forward<RunAsT>(value)); return *this;}
    ///@}
  private:
