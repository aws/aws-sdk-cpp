...
class GetLoggerDefinitionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetLoggerDefinitionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  GetLoggerDefinitionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetLoggerDefinitionResult& WithId(IdT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::String>
  GetLoggerDefinitionResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename LatestVersionT = Aws::String>
  GetLoggerDefinitionResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  template <typename LatestVersionArnT = Aws::String>
  GetLoggerDefinitionResult& WithLatestVersionArn(LatestVersionArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetLoggerDefinitionResult& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetLoggerDefinitionResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetLoggerDefinitionResult& WithRequestId(RequestIdT&& value) {
