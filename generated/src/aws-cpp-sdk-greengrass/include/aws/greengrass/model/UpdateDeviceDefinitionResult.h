...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API UpdateDeviceDefinitionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDeviceDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
