...
namespace Model
{
  ...
  public:
    ...
    inline UpdateDeviceDefinitionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateDeviceDefinitionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateDeviceDefinitionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
