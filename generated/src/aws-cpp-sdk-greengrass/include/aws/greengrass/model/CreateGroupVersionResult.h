...
namespace Model
{
  ...
  public:
    ...
    inline CreateGroupVersionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateGroupVersionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateGroupVersionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
