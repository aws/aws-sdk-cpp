...
class CreateGroupVersionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateGroupVersionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  CreateGroupVersionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateGroupVersionResult& WithId(IdT&& value) {
  ...
  template <typename VersionT = Aws::String>
  CreateGroupVersionResult& WithVersion(VersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateGroupVersionResult& WithRequestId(RequestIdT&& value) {
