...
class ResourceDataContainer {
 public:
  ...
  void SetLocalDeviceResourceData(LocalDeviceResourceDataT&& value) {
    ...
    m_localDeviceResourceData = std::forward<LocalDeviceResourceDataT>(value);
  }
  template <typename LocalDeviceResourceDataT = LocalDeviceResourceData>
  ResourceDataContainer& WithLocalDeviceResourceData(LocalDeviceResourceDataT&& value) {
    SetLocalDeviceResourceData(std::forward<LocalDeviceResourceDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalVolumeResourceData(LocalVolumeResourceDataT&& value) {
    ...
    m_localVolumeResourceData = std::forward<LocalVolumeResourceDataT>(value);
  }
  template <typename LocalVolumeResourceDataT = LocalVolumeResourceData>
  ResourceDataContainer& WithLocalVolumeResourceData(LocalVolumeResourceDataT&& value) {
    SetLocalVolumeResourceData(std::forward<LocalVolumeResourceDataT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const S3MachineLearningModelResourceData& GetS3MachineLearningModelResourceData() const {
    return m_s3MachineLearningModelResourceData;
  }
  ...
  void SetS3MachineLearningModelResourceData(S3MachineLearningModelResourceDataT&& value) {
    ...
    m_s3MachineLearningModelResourceData = std::forward<S3MachineLearningModelResourceDataT>(value);
  }
  template <typename S3MachineLearningModelResourceDataT = S3MachineLearningModelResourceData>
  ResourceDataContainer& WithS3MachineLearningModelResourceData(S3MachineLearningModelResourceDataT&& value) {
    SetS3MachineLearningModelResourceData(std::forward<S3MachineLearningModelResourceDataT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const SageMakerMachineLearningModelResourceData& GetSageMakerMachineLearningModelResourceData() const {
    return m_sageMakerMachineLearningModelResourceData;
  }
  ...
  void SetSageMakerMachineLearningModelResourceData(SageMakerMachineLearningModelResourceDataT&& value) {
    ...
    m_sageMakerMachineLearningModelResourceData = std::forward<SageMakerMachineLearningModelResourceDataT>(value);
  }
  template <typename SageMakerMachineLearningModelResourceDataT = SageMakerMachineLearningModelResourceData>
  ResourceDataContainer& WithSageMakerMachineLearningModelResourceData(SageMakerMachineLearningModelResourceDataT&& value) {
    SetSageMakerMachineLearningModelResourceData(std::forward<SageMakerMachineLearningModelResourceDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecretsManagerSecretResourceData(SecretsManagerSecretResourceDataT&& value) {
    ...
    m_secretsManagerSecretResourceData = std::forward<SecretsManagerSecretResourceDataT>(value);
  }
  template <typename SecretsManagerSecretResourceDataT = SecretsManagerSecretResourceData>
  ResourceDataContainer& WithSecretsManagerSecretResourceData(SecretsManagerSecretResourceDataT&& value) {
    SetSecretsManagerSecretResourceData(std::forward<SecretsManagerSecretResourceDataT>(value));
    return *this;
  }
  ///@}
 private:
