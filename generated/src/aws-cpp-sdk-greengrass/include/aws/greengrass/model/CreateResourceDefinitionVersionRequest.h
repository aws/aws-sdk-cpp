...
class CreateResourceDefinitionVersionRequest : public GreengrassRequest {
 public:
  ...
  template <typename AmznClientTokenT = Aws::String>
  CreateResourceDefinitionVersionRequest& WithAmznClientToken(AmznClientTokenT&& value) {
  ...
  template <typename ResourceDefinitionIdT = Aws::String>
  CreateResourceDefinitionVersionRequest& WithResourceDefinitionId(ResourceDefinitionIdT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<Resource>>
  CreateResourceDefinitionVersionRequest& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Resource>
  CreateResourceDefinitionVersionRequest& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
