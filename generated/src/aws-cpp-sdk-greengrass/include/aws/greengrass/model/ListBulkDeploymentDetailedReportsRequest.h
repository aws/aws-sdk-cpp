...
class ListBulkDeploymentDetailedReportsRequest : public GreengrassRequest {
 public:
  ...
  template <typename BulkDeploymentIdT = Aws::String>
  ListBulkDeploymentDetailedReportsRequest& WithBulkDeploymentId(BulkDeploymentIdT&& value) {
  ...
  template <typename MaxResultsT = Aws::String>
  ListBulkDeploymentDetailedReportsRequest& WithMaxResults(MaxResultsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListBulkDeploymentDetailedReportsRequest& WithNextToken(NextTokenT&& value) {
