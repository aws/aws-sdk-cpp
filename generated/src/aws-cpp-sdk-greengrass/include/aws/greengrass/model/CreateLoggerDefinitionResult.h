...
class CreateLoggerDefinitionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateLoggerDefinitionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  CreateLoggerDefinitionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateLoggerDefinitionResult& WithId(IdT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::String>
  CreateLoggerDefinitionResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename LatestVersionT = Aws::String>
  CreateLoggerDefinitionResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  template <typename LatestVersionArnT = Aws::String>
  CreateLoggerDefinitionResult& WithLatestVersionArn(LatestVersionArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateLoggerDefinitionResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateLoggerDefinitionResult& WithRequestId(RequestIdT&& value) {
