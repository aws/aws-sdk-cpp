...
namespace Model
{
  ...
  public:
    ...
    inline UpdateResourceDefinitionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateResourceDefinitionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateResourceDefinitionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
