...
class GetGroupCertificateAuthorityResult {
 public:
  ...
  template <typename GroupCertificateAuthorityArnT = Aws::String>
  GetGroupCertificateAuthorityResult& WithGroupCertificateAuthorityArn(GroupCertificateAuthorityArnT&& value) {
  ...
  template <typename GroupCertificateAuthorityIdT = Aws::String>
  GetGroupCertificateAuthorityResult& WithGroupCertificateAuthorityId(GroupCertificateAuthorityIdT&& value) {
  ...
  template <typename PemEncodedCertificateT = Aws::String>
  GetGroupCertificateAuthorityResult& WithPemEncodedCertificate(PemEncodedCertificateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetGroupCertificateAuthorityResult& WithRequestId(RequestIdT&& value) {
