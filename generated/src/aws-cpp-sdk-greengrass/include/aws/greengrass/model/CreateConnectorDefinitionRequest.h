...
namespace Model
{
  ...
  /**
   */
  class CreateConnectorDefinitionRequest : public GreengrassRequest
  {
  public:
    AWS_GREENGRASS_API CreateConnectorDefinitionRequest() = default;
    ...
    template<typename AmznClientTokenT = Aws::String>
    CreateConnectorDefinitionRequest& WithAmznClientToken(AmznClientTokenT&& value) { SetAmznClientToken(std::forward<AmznClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename InitialVersionT = ConnectorDefinitionVersion>
    ...
    template<typename InitialVersionT = ConnectorDefinitionVersion>
    CreateConnectorDefinitionRequest& WithInitialVersion(InitialVersionT&& value) { SetInitialVersion(std::forward<InitialVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateConnectorDefinitionRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreateConnectorDefinitionRequest& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    CreateConnectorDefinitionRequest& AddTags(TagsKeyT&& key, TagsValueT&& value) {
