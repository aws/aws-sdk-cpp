...
class CreateDeviceDefinitionRequest : public GreengrassRequest {
 public:
  ...
  template <typename AmznClientTokenT = Aws::String>
  CreateDeviceDefinitionRequest& WithAmznClientToken(AmznClientTokenT&& value) {
  ...
  template <typename InitialVersionT = DeviceDefinitionVersion>
  CreateDeviceDefinitionRequest& WithInitialVersion(InitialVersionT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateDeviceDefinitionRequest& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateDeviceDefinitionRequest& WithTags(TagsT&& value) {
