...
class ListSubscriptionDefinitionVersionsRequest : public GreengrassRequest {
 public:
  ...
  template <typename MaxResultsT = Aws::String>
  ListSubscriptionDefinitionVersionsRequest& WithMaxResults(MaxResultsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSubscriptionDefinitionVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SubscriptionDefinitionIdT = Aws::String>
  ListSubscriptionDefinitionVersionsRequest& WithSubscriptionDefinitionId(SubscriptionDefinitionIdT&& value) {
