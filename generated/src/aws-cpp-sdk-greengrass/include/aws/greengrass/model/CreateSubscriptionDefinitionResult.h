...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API CreateSubscriptionDefinitionResult() = default;
    ...
    template<typename ArnT = Aws::String>
    CreateSubscriptionDefinitionResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimestampT = Aws::String>
    CreateSubscriptionDefinitionResult& WithCreationTimestamp(CreationTimestampT&& value) { SetCreationTimestamp(std::forward<CreationTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    CreateSubscriptionDefinitionResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedTimestampT = Aws::String>
    CreateSubscriptionDefinitionResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) { SetLastUpdatedTimestamp(std::forward<LastUpdatedTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename LatestVersionT = Aws::String>
    CreateSubscriptionDefinitionResult& WithLatestVersion(LatestVersionT&& value) { SetLatestVersion(std::forward<LatestVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename LatestVersionArnT = Aws::String>
    CreateSubscriptionDefinitionResult& WithLatestVersionArn(LatestVersionArnT&& value) { SetLatestVersionArn(std::forward<LatestVersionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateSubscriptionDefinitionResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateSubscriptionDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
