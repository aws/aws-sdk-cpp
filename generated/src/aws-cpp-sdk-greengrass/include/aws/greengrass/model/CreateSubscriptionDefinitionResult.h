...
class CreateSubscriptionDefinitionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateSubscriptionDefinitionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  CreateSubscriptionDefinitionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateSubscriptionDefinitionResult& WithId(IdT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::String>
  CreateSubscriptionDefinitionResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename LatestVersionT = Aws::String>
  CreateSubscriptionDefinitionResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  template <typename LatestVersionArnT = Aws::String>
  CreateSubscriptionDefinitionResult& WithLatestVersionArn(LatestVersionArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateSubscriptionDefinitionResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateSubscriptionDefinitionResult& WithRequestId(RequestIdT&& value) {
