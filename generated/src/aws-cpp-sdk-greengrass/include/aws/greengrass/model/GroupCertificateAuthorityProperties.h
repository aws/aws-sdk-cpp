...
class GroupCertificateAuthorityProperties {
 public:
  ...
  template <typename GroupCertificateAuthorityArnT = Aws::String>
  GroupCertificateAuthorityProperties& WithGroupCertificateAuthorityArn(GroupCertificateAuthorityArnT&& value) {
  ...
  void SetGroupCertificateAuthorityId(GroupCertificateAuthorityIdT&& value) {
    m_groupCertificateAuthorityIdHasBeenSet = true;
    m_groupCertificateAuthorityId = std::forward<GroupCertificateAuthorityIdT>(value);
  }
  template <typename GroupCertificateAuthorityIdT = Aws::String>
  GroupCertificateAuthorityProperties& WithGroupCertificateAuthorityId(GroupCertificateAuthorityIdT&& value) {
    SetGroupCertificateAuthorityId(std::forward<GroupCertificateAuthorityIdT>(value));
    return *this;
  }
  ///@}
 private:
