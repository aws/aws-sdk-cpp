...
namespace Model
{
  ...
  public:
    ...
    template<typename ConnectorArnT = Aws::String>
    Connector& WithConnectorArn(ConnectorArnT&& value) { SetConnectorArn(std::forward<ConnectorArnT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    Connector& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ParametersT = Aws::Map<Aws::String, Aws::String>>
    Connector& WithParameters(ParametersT&& value) { SetParameters(std::forward<ParametersT>(value)); return *this;}
