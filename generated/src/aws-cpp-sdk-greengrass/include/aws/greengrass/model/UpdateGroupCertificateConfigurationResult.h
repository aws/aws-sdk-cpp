...
namespace Model
{
  ...
  public:
    ...
    template<typename CertificateAuthorityExpiryInMillisecondsT = Aws::String>
    UpdateGroupCertificateConfigurationResult& WithCertificateAuthorityExpiryInMilliseconds(CertificateAuthorityExpiryInMillisecondsT&& value) { SetCertificateAuthorityExpiryInMilliseconds(std::forward<CertificateAuthorityExpiryInMillisecondsT>(value)); return *this;}
    ///@}
    ...
    template<typename CertificateExpiryInMillisecondsT = Aws::String>
    UpdateGroupCertificateConfigurationResult& WithCertificateExpiryInMilliseconds(CertificateExpiryInMillisecondsT&& value) { SetCertificateExpiryInMilliseconds(std::forward<CertificateExpiryInMillisecondsT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupIdT = Aws::String>
    UpdateGroupCertificateConfigurationResult& WithGroupId(GroupIdT&& value) { SetGroupId(std::forward<GroupIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateGroupCertificateConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
