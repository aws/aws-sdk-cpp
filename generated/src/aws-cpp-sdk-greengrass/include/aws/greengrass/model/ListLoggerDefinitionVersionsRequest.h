...
class ListLoggerDefinitionVersionsRequest : public GreengrassRequest {
 public:
  ...
  template <typename LoggerDefinitionIdT = Aws::String>
  ListLoggerDefinitionVersionsRequest& WithLoggerDefinitionId(LoggerDefinitionIdT&& value) {
  ...
  template <typename MaxResultsT = Aws::String>
  ListLoggerDefinitionVersionsRequest& WithMaxResults(MaxResultsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListLoggerDefinitionVersionsRequest& WithNextToken(NextTokenT&& value) {
