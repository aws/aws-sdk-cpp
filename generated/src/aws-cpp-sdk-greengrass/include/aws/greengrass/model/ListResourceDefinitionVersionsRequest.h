...
class ListResourceDefinitionVersionsRequest : public GreengrassRequest {
 public:
  ...
  template <typename MaxResultsT = Aws::String>
  ListResourceDefinitionVersionsRequest& WithMaxResults(MaxResultsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceDefinitionVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResourceDefinitionIdT = Aws::String>
  ListResourceDefinitionVersionsRequest& WithResourceDefinitionId(ResourceDefinitionIdT&& value) {
