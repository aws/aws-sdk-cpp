...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API ListFunctionDefinitionVersionsResult() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListFunctionDefinitionVersionsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionsT = Aws::Vector<VersionInformation>>
    ListFunctionDefinitionVersionsResult& WithVersions(VersionsT&& value) { SetVersions(std::forward<VersionsT>(value)); return *this;}
    template<typename VersionsT = VersionInformation>
    ListFunctionDefinitionVersionsResult& AddVersions(VersionsT&& value) { m_versionsHasBeenSet = true; m_versions.emplace_back(std::forward<VersionsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListFunctionDefinitionVersionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
