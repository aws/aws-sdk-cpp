...
class ListFunctionDefinitionVersionsResult {
 public:
  ...
  AWS_GREENGRASS_API ListFunctionDefinitionVersionsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListFunctionDefinitionVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VersionsT = Aws::Vector<VersionInformation>>
  ListFunctionDefinitionVersionsResult& WithVersions(VersionsT&& value) {
    SetVersions(std::forward<VersionsT>(value));
    return *this;
  }
  template <typename VersionsT = VersionInformation>
  ListFunctionDefinitionVersionsResult& AddVersions(VersionsT&& value) {
    m_versionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListFunctionDefinitionVersionsResult& WithRequestId(RequestIdT&& value) {
