...
namespace Model
{
  ...
  public:
    ...
    inline ListFunctionDefinitionVersionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListFunctionDefinitionVersionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListFunctionDefinitionVersionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
