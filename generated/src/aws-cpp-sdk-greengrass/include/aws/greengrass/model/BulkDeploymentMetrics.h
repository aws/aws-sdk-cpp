...
class BulkDeploymentMetrics {
 public:
  ...
  inline void SetInvalidInputRecords(int value) {
    m_invalidInputRecordsHasBeenSet = true;
    m_invalidInputRecords = value;
  }
  inline BulkDeploymentMetrics& WithInvalidInputRecords(int value) {
    SetInvalidInputRecords(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRecordsProcessed(int value) {
    m_recordsProcessedHasBeenSet = true;
    m_recordsProcessed = value;
  }
  inline BulkDeploymentMetrics& WithRecordsProcessed(int value) {
  ...
  inline void SetRetryAttempts(int value) {
    m_retryAttemptsHasBeenSet = true;
    m_retryAttempts = value;
  }
  inline BulkDeploymentMetrics& WithRetryAttempts(int value) {
