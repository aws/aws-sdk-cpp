...
class GroupVersion {
 public:
  ...
  void SetConnectorDefinitionVersionArn(ConnectorDefinitionVersionArnT&& value) {
    ...
    m_connectorDefinitionVersionArn = std::forward<ConnectorDefinitionVersionArnT>(value);
  }
  template <typename ConnectorDefinitionVersionArnT = Aws::String>
  GroupVersion& WithConnectorDefinitionVersionArn(ConnectorDefinitionVersionArnT&& value) {
    SetConnectorDefinitionVersionArn(std::forward<ConnectorDefinitionVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCoreDefinitionVersionArn(CoreDefinitionVersionArnT&& value) {
    ...
    m_coreDefinitionVersionArn = std::forward<CoreDefinitionVersionArnT>(value);
  }
  template <typename CoreDefinitionVersionArnT = Aws::String>
  GroupVersion& WithCoreDefinitionVersionArn(CoreDefinitionVersionArnT&& value) {
    SetCoreDefinitionVersionArn(std::forward<CoreDefinitionVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceDefinitionVersionArn(DeviceDefinitionVersionArnT&& value) {
    ...
    m_deviceDefinitionVersionArn = std::forward<DeviceDefinitionVersionArnT>(value);
  }
  template <typename DeviceDefinitionVersionArnT = Aws::String>
  GroupVersion& WithDeviceDefinitionVersionArn(DeviceDefinitionVersionArnT&& value) {
    SetDeviceDefinitionVersionArn(std::forward<DeviceDefinitionVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFunctionDefinitionVersionArn(FunctionDefinitionVersionArnT&& value) {
    ...
    m_functionDefinitionVersionArn = std::forward<FunctionDefinitionVersionArnT>(value);
  }
  template <typename FunctionDefinitionVersionArnT = Aws::String>
  GroupVersion& WithFunctionDefinitionVersionArn(FunctionDefinitionVersionArnT&& value) {
    SetFunctionDefinitionVersionArn(std::forward<FunctionDefinitionVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLoggerDefinitionVersionArn(LoggerDefinitionVersionArnT&& value) {
    ...
    m_loggerDefinitionVersionArn = std::forward<LoggerDefinitionVersionArnT>(value);
  }
  template <typename LoggerDefinitionVersionArnT = Aws::String>
  GroupVersion& WithLoggerDefinitionVersionArn(LoggerDefinitionVersionArnT&& value) {
    SetLoggerDefinitionVersionArn(std::forward<LoggerDefinitionVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceDefinitionVersionArn(ResourceDefinitionVersionArnT&& value) {
    ...
    m_resourceDefinitionVersionArn = std::forward<ResourceDefinitionVersionArnT>(value);
  }
  template <typename ResourceDefinitionVersionArnT = Aws::String>
  GroupVersion& WithResourceDefinitionVersionArn(ResourceDefinitionVersionArnT&& value) {
    SetResourceDefinitionVersionArn(std::forward<ResourceDefinitionVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubscriptionDefinitionVersionArn(SubscriptionDefinitionVersionArnT&& value) {
    ...
    m_subscriptionDefinitionVersionArn = std::forward<SubscriptionDefinitionVersionArnT>(value);
  }
  template <typename SubscriptionDefinitionVersionArnT = Aws::String>
  GroupVersion& WithSubscriptionDefinitionVersionArn(SubscriptionDefinitionVersionArnT&& value) {
    SetSubscriptionDefinitionVersionArn(std::forward<SubscriptionDefinitionVersionArnT>(value));
    return *this;
  }
  ///@}
 private:
