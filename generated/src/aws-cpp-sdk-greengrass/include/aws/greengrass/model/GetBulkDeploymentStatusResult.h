...
class GetBulkDeploymentStatusResult {
 public:
  ...
  void SetBulkDeploymentMetrics(BulkDeploymentMetricsT&& value) {
    m_bulkDeploymentMetricsHasBeenSet = true;
    m_bulkDeploymentMetrics = std::forward<BulkDeploymentMetricsT>(value);
  }
  template <typename BulkDeploymentMetricsT = BulkDeploymentMetrics>
  GetBulkDeploymentStatusResult& WithBulkDeploymentMetrics(BulkDeploymentMetricsT&& value) {
    SetBulkDeploymentMetrics(std::forward<BulkDeploymentMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBulkDeploymentStatus(BulkDeploymentStatus value) {
    m_bulkDeploymentStatusHasBeenSet = true;
    m_bulkDeploymentStatus = value;
  }
  inline GetBulkDeploymentStatusResult& WithBulkDeploymentStatus(BulkDeploymentStatus value) {
    SetBulkDeploymentStatus(value);
    return *this;
  }
  ///@}
