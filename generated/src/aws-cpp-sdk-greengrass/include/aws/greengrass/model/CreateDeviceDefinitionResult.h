...
class CreateDeviceDefinitionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateDeviceDefinitionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  CreateDeviceDefinitionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateDeviceDefinitionResult& WithId(IdT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::String>
  CreateDeviceDefinitionResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename LatestVersionT = Aws::String>
  CreateDeviceDefinitionResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  template <typename LatestVersionArnT = Aws::String>
  CreateDeviceDefinitionResult& WithLatestVersionArn(LatestVersionArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateDeviceDefinitionResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDeviceDefinitionResult& WithRequestId(RequestIdT&& value) {
