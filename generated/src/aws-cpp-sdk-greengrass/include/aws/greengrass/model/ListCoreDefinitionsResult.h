...
class ListCoreDefinitionsResult {
 public:
  ...
  template <typename DefinitionsT = Aws::Vector<DefinitionInformation>>
  ListCoreDefinitionsResult& WithDefinitions(DefinitionsT&& value) {
    SetDefinitions(std::forward<DefinitionsT>(value));
    return *this;
  }
  template <typename DefinitionsT = DefinitionInformation>
  ListCoreDefinitionsResult& AddDefinitions(DefinitionsT&& value) {
    m_definitionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCoreDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCoreDefinitionsResult& WithRequestId(RequestIdT&& value) {
