...
class GetFunctionDefinitionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetFunctionDefinitionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  GetFunctionDefinitionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetFunctionDefinitionResult& WithId(IdT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::String>
  GetFunctionDefinitionResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename LatestVersionT = Aws::String>
  GetFunctionDefinitionResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  template <typename LatestVersionArnT = Aws::String>
  GetFunctionDefinitionResult& WithLatestVersionArn(LatestVersionArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetFunctionDefinitionResult& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetFunctionDefinitionResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFunctionDefinitionResult& WithRequestId(RequestIdT&& value) {
