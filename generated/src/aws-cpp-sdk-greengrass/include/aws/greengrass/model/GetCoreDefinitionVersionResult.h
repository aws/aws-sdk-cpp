...
class GetCoreDefinitionVersionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetCoreDefinitionVersionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  GetCoreDefinitionVersionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename DefinitionT = CoreDefinitionVersion>
  GetCoreDefinitionVersionResult& WithDefinition(DefinitionT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetCoreDefinitionVersionResult& WithId(IdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetCoreDefinitionVersionResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VersionT = Aws::String>
  GetCoreDefinitionVersionResult& WithVersion(VersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCoreDefinitionVersionResult& WithRequestId(RequestIdT&& value) {
