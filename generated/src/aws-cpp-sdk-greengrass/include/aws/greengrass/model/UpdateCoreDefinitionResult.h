...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API UpdateCoreDefinitionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateCoreDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
