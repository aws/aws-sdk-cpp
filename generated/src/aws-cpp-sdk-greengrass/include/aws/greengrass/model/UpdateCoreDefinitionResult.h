...
namespace Model
{
  ...
  public:
    ...
    inline UpdateCoreDefinitionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateCoreDefinitionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateCoreDefinitionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
