...
class ListDeviceDefinitionVersionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListDeviceDefinitionVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VersionsT = Aws::Vector<VersionInformation>>
  ListDeviceDefinitionVersionsResult& WithVersions(VersionsT&& value) {
    SetVersions(std::forward<VersionsT>(value));
    return *this;
  }
  template <typename VersionsT = VersionInformation>
  ListDeviceDefinitionVersionsResult& AddVersions(VersionsT&& value) {
    m_versionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListDeviceDefinitionVersionsResult& WithRequestId(RequestIdT&& value) {
