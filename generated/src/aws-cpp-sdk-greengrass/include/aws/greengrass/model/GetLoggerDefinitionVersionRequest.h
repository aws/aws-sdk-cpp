...
class GetLoggerDefinitionVersionRequest : public GreengrassRequest {
 public:
  ...
  template <typename LoggerDefinitionIdT = Aws::String>
  GetLoggerDefinitionVersionRequest& WithLoggerDefinitionId(LoggerDefinitionIdT&& value) {
  ...
  void SetLoggerDefinitionVersionId(LoggerDefinitionVersionIdT&& value) {
    m_loggerDefinitionVersionIdHasBeenSet = true;
    m_loggerDefinitionVersionId = std::forward<LoggerDefinitionVersionIdT>(value);
  }
  template <typename LoggerDefinitionVersionIdT = Aws::String>
  GetLoggerDefinitionVersionRequest& WithLoggerDefinitionVersionId(LoggerDefinitionVersionIdT&& value) {
    SetLoggerDefinitionVersionId(std::forward<LoggerDefinitionVersionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetLoggerDefinitionVersionRequest& WithNextToken(NextTokenT&& value) {
