...
namespace Model
{
  ...
  public:
    ...
    inline GetDeviceDefinitionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetDeviceDefinitionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetDeviceDefinitionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
