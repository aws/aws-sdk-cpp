...
class GetDeviceDefinitionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetDeviceDefinitionResult& WithArn(ArnT&& value) {
  ...
  template <typename CreationTimestampT = Aws::String>
  GetDeviceDefinitionResult& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetDeviceDefinitionResult& WithId(IdT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::String>
  GetDeviceDefinitionResult& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename LatestVersionT = Aws::String>
  GetDeviceDefinitionResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  template <typename LatestVersionArnT = Aws::String>
  GetDeviceDefinitionResult& WithLatestVersionArn(LatestVersionArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetDeviceDefinitionResult& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetDeviceDefinitionResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDeviceDefinitionResult& WithRequestId(RequestIdT&& value) {
