...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API ListGroupsRequest() = default;
    ...
    template<typename MaxResultsT = Aws::String>
    ListGroupsRequest& WithMaxResults(MaxResultsT&& value) { SetMaxResults(std::forward<MaxResultsT>(value)); return *this;}
    ///@}
