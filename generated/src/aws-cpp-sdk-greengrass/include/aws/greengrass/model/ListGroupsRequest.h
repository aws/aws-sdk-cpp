...
namespace Model
{
  ...
  /**
   */
  class ListGroupsRequest : public GreengrassRequest
  {
  public:
    AWS_GREENGRASS_API ListGroupsRequest();
    ...
    inline ListGroupsRequest& WithMaxResults(const Aws::String& value) { SetMaxResults(value); return *this;}
    inline ListGroupsRequest& WithMaxResults(Aws::String&& value) { SetMaxResults(std::move(value)); return *this;}
    inline ListGroupsRequest& WithMaxResults(const char* value) { SetMaxResults(value); return *this;}
    ///@}
