...
class GetFunctionDefinitionVersionRequest : public GreengrassRequest {
 public:
  ...
  template <typename FunctionDefinitionIdT = Aws::String>
  GetFunctionDefinitionVersionRequest& WithFunctionDefinitionId(FunctionDefinitionIdT&& value) {
  ...
  void SetFunctionDefinitionVersionId(FunctionDefinitionVersionIdT&& value) {
    m_functionDefinitionVersionIdHasBeenSet = true;
    m_functionDefinitionVersionId = std::forward<FunctionDefinitionVersionIdT>(value);
  }
  template <typename FunctionDefinitionVersionIdT = Aws::String>
  GetFunctionDefinitionVersionRequest& WithFunctionDefinitionVersionId(FunctionDefinitionVersionIdT&& value) {
    SetFunctionDefinitionVersionId(std::forward<FunctionDefinitionVersionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetFunctionDefinitionVersionRequest& WithNextToken(NextTokenT&& value) {
