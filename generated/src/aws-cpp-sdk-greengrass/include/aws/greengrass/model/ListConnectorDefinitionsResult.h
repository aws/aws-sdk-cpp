...
class ListConnectorDefinitionsResult {
 public:
  ...
  template <typename DefinitionsT = Aws::Vector<DefinitionInformation>>
  ListConnectorDefinitionsResult& WithDefinitions(DefinitionsT&& value) {
    SetDefinitions(std::forward<DefinitionsT>(value));
    return *this;
  }
  template <typename DefinitionsT = DefinitionInformation>
  ListConnectorDefinitionsResult& AddDefinitions(DefinitionsT&& value) {
    m_definitionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectorDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConnectorDefinitionsResult& WithRequestId(RequestIdT&& value) {
