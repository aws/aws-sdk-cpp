...
namespace Model
{
  ...
  public:
    ...
    template<typename GroupIdT = Aws::String>
    ListGroupVersionsRequest& WithGroupId(GroupIdT&& value) { SetGroupId(std::forward<GroupIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MaxResultsT = Aws::String>
    ListGroupVersionsRequest& WithMaxResults(MaxResultsT&& value) { SetMaxResults(std::forward<MaxResultsT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListGroupVersionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
