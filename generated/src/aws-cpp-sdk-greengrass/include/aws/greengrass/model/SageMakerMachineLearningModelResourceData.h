...
class SageMakerMachineLearningModelResourceData {
 public:
  ...
  template <typename DestinationPathT = Aws::String>
  SageMakerMachineLearningModelResourceData& WithDestinationPath(DestinationPathT&& value) {
  ...
  template <typename OwnerSettingT = ResourceDownloadOwnerSetting>
  SageMakerMachineLearningModelResourceData& WithOwnerSetting(OwnerSettingT&& value) {
  ...
  void SetSageMakerJobArn(SageMakerJobArnT&& value) {
    m_sageMakerJobArnHasBeenSet = true;
    m_sageMakerJobArn = std::forward<SageMakerJobArnT>(value);
  }
  template <typename SageMakerJobArnT = Aws::String>
  SageMakerMachineLearningModelResourceData& WithSageMakerJobArn(SageMakerJobArnT&& value) {
    SetSageMakerJobArn(std::forward<SageMakerJobArnT>(value));
    return *this;
  }
  ///@}
 private:
