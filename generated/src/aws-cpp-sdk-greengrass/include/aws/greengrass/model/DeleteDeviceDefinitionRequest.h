...
namespace Model
{
  ...
  {
  public:
    AWS_GREENGRASS_API DeleteDeviceDefinitionRequest() = default;
    ...
    template<typename DeviceDefinitionIdT = Aws::String>
    DeleteDeviceDefinitionRequest& WithDeviceDefinitionId(DeviceDefinitionIdT&& value) { SetDeviceDefinitionId(std::forward<DeviceDefinitionIdT>(value)); return *this;}
    ///@}
  private:
