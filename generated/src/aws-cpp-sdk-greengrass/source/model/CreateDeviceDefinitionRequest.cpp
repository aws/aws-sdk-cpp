...
Aws::String CreateDeviceDefinitionRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection CreateDeviceDefinitionRequest::GetRequestSpecificHeaders() const
{
