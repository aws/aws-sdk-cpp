...
CreateConnectorDefinitionResult::CreateConnectorDefinitionResult()
{
}

CreateConnectorDefinitionResult::CreateConnectorDefinitionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateConnectorDefinitionResult& CreateConnectorDefinitionResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
