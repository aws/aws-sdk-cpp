...
ListGroupCertificateAuthoritiesResult& ListGroupCertificateAuthoritiesResult::operator=(
  ...
  if (jsonValue.ValueExists("GroupCertificateAuthorities")) {
    ...
    for (unsigned groupCertificateAuthoritiesIndex = 0; groupCertificateAuthoritiesIndex < groupCertificateAuthoritiesJsonList.GetLength();
         ++groupCertificateAuthoritiesIndex) {
