...
class AWS_CODEGURUPROFILER_API CodeGuruProfilerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CodeGuruProfilerClient(const Aws::CodeGuruProfiler::CodeGuruProfilerClientConfiguration& clientConfiguration =
  ...
  CodeGuruProfilerClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<CodeGuruProfilerEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::CodeGuruProfiler::CodeGuruProfilerClientConfiguration& clientConfiguration =
                             Aws::CodeGuruProfiler::CodeGuruProfilerClientConfiguration());
  ...
  /**
   * A Callable wrapper for AddNotificationChannels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddNotificationChannels that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddNotificationChannelsRequestT = Model::AddNotificationChannelsRequest>
  void AddNotificationChannelsAsync(const AddNotificationChannelsRequestT& request,
  ...
  /**
   * A Callable wrapper for BatchGetFrameMetricData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetFrameMetricData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetFrameMetricDataRequestT = Model::BatchGetFrameMetricDataRequest>
  void BatchGetFrameMetricDataAsync(const BatchGetFrameMetricDataRequestT& request,
  ...
  /**
   * An Async wrapper for ConfigureAgent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ConfigureAgentRequestT = Model::ConfigureAgentRequest>
  void ConfigureAgentAsync(const ConfigureAgentRequestT& request, const ConfigureAgentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateProfilingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateProfilingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProfilingGroupRequestT = Model::CreateProfilingGroupRequest>
  void CreateProfilingGroupAsync(const CreateProfilingGroupRequestT& request, const CreateProfilingGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteProfilingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProfilingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProfilingGroupRequestT = Model::DeleteProfilingGroupRequest>
  void DeleteProfilingGroupAsync(const DeleteProfilingGroupRequestT& request, const DeleteProfilingGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeProfilingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeProfilingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProfilingGroupRequestT = Model::DescribeProfilingGroupRequest>
  void DescribeProfilingGroupAsync(const DescribeProfilingGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetFindingsReportAccountSummaryOutcome GetFindingsReportAccountSummary(
      const Model::GetFindingsReportAccountSummaryRequest& request = {}) const;

  /**
   * A Callable wrapper for GetFindingsReportAccountSummary that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetFindingsReportAccountSummaryRequestT = Model::GetFindingsReportAccountSummaryRequest>
  Model::GetFindingsReportAccountSummaryOutcomeCallable GetFindingsReportAccountSummaryCallable(
      const GetFindingsReportAccountSummaryRequestT& request = {}) const {
    return SubmitCallable(&CodeGuruProfilerClient::GetFindingsReportAccountSummary, request);
  }

  /**
   * An Async wrapper for GetFindingsReportAccountSummary that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetFindingsReportAccountSummaryRequestT = Model::GetFindingsReportAccountSummaryRequest>
  void GetFindingsReportAccountSummaryAsync(const GetFindingsReportAccountSummaryResponseReceivedHandler& handler,
   ...
   */
  template <typename GetRecommendationsRequestT = Model::GetRecommendationsRequest>
  void GetRecommendationsAsync(const GetRecommendationsRequestT& request, const GetRecommendationsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListFindingsReports that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFindingsReports that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFindingsReportsRequestT = Model::ListFindingsReportsRequest>
  void ListFindingsReportsAsync(const ListFindingsReportsRequestT& request, const ListFindingsReportsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProfileTimes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProfileTimes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListProfileTimesRequestT = Model::ListProfileTimesRequest>
  void ListProfileTimesAsync(const ListProfileTimesRequestT& request, const ListProfileTimesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProfilingGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProfilingGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListProfilingGroupsRequestT = Model::ListProfilingGroupsRequest>
  void ListProfilingGroupsAsync(const ListProfilingGroupsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListProfilingGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PostAgentProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PostAgentProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PostAgentProfileRequestT = Model::PostAgentProfileRequest>
  void PostAgentProfileAsync(const PostAgentProfileRequestT& request, const PostAgentProfileResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename PutPermissionRequestT = Model::PutPermissionRequest>
  void PutPermissionAsync(const PutPermissionRequestT& request, const PutPermissionResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateProfilingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateProfilingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateProfilingGroupRequestT = Model::UpdateProfilingGroupRequest>
  void UpdateProfilingGroupAsync(const UpdateProfilingGroupRequestT& request, const UpdateProfilingGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
