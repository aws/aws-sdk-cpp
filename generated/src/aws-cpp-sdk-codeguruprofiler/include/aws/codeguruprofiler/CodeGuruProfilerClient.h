...
namespace CodeGuruProfiler
{
   ...
   * Guide</i>. </p>
   */
  class AWS_CODEGURUPROFILER_API CodeGuruProfilerClient : Aws::Client::ClientWithAsyncTemplateMethods<CodeGuruProfilerClient>,
    smithy::client::AwsSmithyClientT<Aws::CodeGuruProfiler::SERVICE_NAME,
