...
class ProfilingStatus {
 public:
  ...
  void SetLatestAgentOrchestratedAt(LatestAgentOrchestratedAtT&& value) {
    ...
    m_latestAgentOrchestratedAt = std::forward<LatestAgentOrchestratedAtT>(value);
  }
  template <typename LatestAgentOrchestratedAtT = Aws::Utils::DateTime>
  ProfilingStatus& WithLatestAgentOrchestratedAt(LatestAgentOrchestratedAtT&& value) {
    SetLatestAgentOrchestratedAt(std::forward<LatestAgentOrchestratedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLatestAgentProfileReportedAt(LatestAgentProfileReportedAtT&& value) {
    ...
    m_latestAgentProfileReportedAt = std::forward<LatestAgentProfileReportedAtT>(value);
  }
  template <typename LatestAgentProfileReportedAtT = Aws::Utils::DateTime>
  ProfilingStatus& WithLatestAgentProfileReportedAt(LatestAgentProfileReportedAtT&& value) {
    SetLatestAgentProfileReportedAt(std::forward<LatestAgentProfileReportedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLatestAggregatedProfile(LatestAggregatedProfileT&& value) {
    ...
    m_latestAggregatedProfile = std::forward<LatestAggregatedProfileT>(value);
  }
  template <typename LatestAggregatedProfileT = AggregatedProfileTime>
  ProfilingStatus& WithLatestAggregatedProfile(LatestAggregatedProfileT&& value) {
    SetLatestAggregatedProfile(std::forward<LatestAggregatedProfileT>(value));
    return *this;
  }
  ///@}
 private:
