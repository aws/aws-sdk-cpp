...
class BatchGetFrameMetricDataRequest : public CodeGuruProfilerRequest {
 public:
  ...
  void SetFrameMetrics(FrameMetricsT&& value) {
    m_frameMetricsHasBeenSet = true;
    m_frameMetrics = std::forward<FrameMetricsT>(value);
  }
  template <typename FrameMetricsT = Aws::Vector<FrameMetric>>
  BatchGetFrameMetricDataRequest& WithFrameMetrics(FrameMetricsT&& value) {
    SetFrameMetrics(std::forward<FrameMetricsT>(value));
    return *this;
  }
  template <typename FrameMetricsT = FrameMetric>
  BatchGetFrameMetricDataRequest& AddFrameMetrics(FrameMetricsT&& value) {
    m_frameMetricsHasBeenSet = true;
    m_frameMetrics.emplace_back(std::forward<FrameMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPeriod(PeriodT&& value) {
    ...
    m_period = std::forward<PeriodT>(value);
  }
  template <typename PeriodT = Aws::String>
  BatchGetFrameMetricDataRequest& WithPeriod(PeriodT&& value) {
    SetPeriod(std::forward<PeriodT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProfilingGroupName(ProfilingGroupNameT&& value) {
    ...
    m_profilingGroupName = std::forward<ProfilingGroupNameT>(value);
  }
  template <typename ProfilingGroupNameT = Aws::String>
  BatchGetFrameMetricDataRequest& WithProfilingGroupName(ProfilingGroupNameT&& value) {
    SetProfilingGroupName(std::forward<ProfilingGroupNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTargetResolution(AggregationPeriod value) {
    m_targetResolutionHasBeenSet = true;
    m_targetResolution = value;
  }
  inline BatchGetFrameMetricDataRequest& WithTargetResolution(AggregationPeriod value) {
