...
class CreateProfilingGroupRequest : public CodeGuruProfilerRequest {
 public:
  ...
  void SetAgentOrchestrationConfig(AgentOrchestrationConfigT&& value) {
    ...
    m_agentOrchestrationConfig = std::forward<AgentOrchestrationConfigT>(value);
  }
  template <typename AgentOrchestrationConfigT = AgentOrchestrationConfig>
  CreateProfilingGroupRequest& WithAgentOrchestrationConfig(AgentOrchestrationConfigT&& value) {
    SetAgentOrchestrationConfig(std::forward<AgentOrchestrationConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateProfilingGroupRequest& WithComputePlatform(ComputePlatform value) {
