...
class AgentConfiguration {
 public:
  ...
  inline AgentConfiguration& WithPeriodInSeconds(int value) {
  ...
  inline void SetShouldProfile(bool value) {
    m_shouldProfileHasBeenSet = true;
    m_shouldProfile = value;
  }
  inline AgentConfiguration& WithShouldProfile(bool value) {
    SetShouldProfile(value);
    return *this;
  }
  ///@}
 private:
