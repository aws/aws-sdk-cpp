...
class Metric {
 public:
  ...
  void SetFrameName(FrameNameT&& value) {
    ...
    m_frameName = std::forward<FrameNameT>(value);
  }
  template <typename FrameNameT = Aws::String>
  Metric& WithFrameName(FrameNameT&& value) {
    SetFrameName(std::forward<FrameNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThreadStates(ThreadStatesT&& value) {
    ...
    m_threadStates = std::forward<ThreadStatesT>(value);
  }
  template <typename ThreadStatesT = Aws::Vector<Aws::String>>
  Metric& WithThreadStates(ThreadStatesT&& value) {
    SetThreadStates(std::forward<ThreadStatesT>(value));
    return *this;
  }
  template <typename ThreadStatesT = Aws::String>
  Metric& AddThreadStates(ThreadStatesT&& value) {
    m_threadStatesHasBeenSet = true;
    m_threadStates.emplace_back(std::forward<ThreadStatesT>(value));
    return *this;
  }
  ///@}
  ...
  inline Metric& WithType(MetricType value) {
    SetType(value);
    return *this;
  }
  ///@}
