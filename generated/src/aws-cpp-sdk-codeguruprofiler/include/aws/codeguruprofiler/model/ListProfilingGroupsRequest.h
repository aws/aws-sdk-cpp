...
class ListProfilingGroupsRequest : public CodeGuruProfilerRequest {
 public:
  ...
  inline void SetIncludeDescription(bool value) {
    m_includeDescriptionHasBeenSet = true;
    m_includeDescription = value;
  }
  inline ListProfilingGroupsRequest& WithIncludeDescription(bool value) {
  ...
  inline ListProfilingGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
