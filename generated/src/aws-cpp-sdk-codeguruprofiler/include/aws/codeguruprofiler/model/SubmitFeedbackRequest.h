...
class SubmitFeedbackRequest : public CodeGuruProfilerRequest {
 public:
  ...
  void SetAnomalyInstanceId(AnomalyInstanceIdT&& value) {
    m_anomalyInstanceIdHasBeenSet = true;
    m_anomalyInstanceId = std::forward<AnomalyInstanceIdT>(value);
  }
  template <typename AnomalyInstanceIdT = Aws::String>
  SubmitFeedbackRequest& WithAnomalyInstanceId(AnomalyInstanceIdT&& value) {
    SetAnomalyInstanceId(std::forward<AnomalyInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline SubmitFeedbackRequest& WithType(FeedbackType value) {
    SetType(value);
    return *this;
  }
  ///@}
