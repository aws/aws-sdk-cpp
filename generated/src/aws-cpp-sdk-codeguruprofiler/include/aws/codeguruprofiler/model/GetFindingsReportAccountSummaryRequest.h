...
class GetFindingsReportAccountSummaryRequest : public CodeGuruProfilerRequest {
 public:
  ...
  inline GetFindingsReportAccountSummaryRequest& WithDailyReportsOnly(bool value) {
  ...
  inline GetFindingsReportAccountSummaryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetFindingsReportAccountSummaryRequest& WithNextToken(NextTokenT&& value) {
