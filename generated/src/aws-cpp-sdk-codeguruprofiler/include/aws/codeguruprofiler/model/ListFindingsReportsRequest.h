...
class ListFindingsReportsRequest : public CodeGuruProfilerRequest {
 public:
  ...
  inline void SetDailyReportsOnly(bool value) {
    m_dailyReportsOnlyHasBeenSet = true;
    m_dailyReportsOnly = value;
  }
  inline ListFindingsReportsRequest& WithDailyReportsOnly(bool value) {
    SetDailyReportsOnly(value);
    return *this;
  }
  ///@}
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ListFindingsReportsRequest& WithEndTime(EndTimeT&& value) {
  ...
  inline ListFindingsReportsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFindingsReportsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ProfilingGroupNameT = Aws::String>
  ListFindingsReportsRequest& WithProfilingGroupName(ProfilingGroupNameT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListFindingsReportsRequest& WithStartTime(StartTimeT&& value) {
