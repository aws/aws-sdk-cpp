...
class Match {
 public:
  ...
  void SetFrameAddress(FrameAddressT&& value) {
    ...
    m_frameAddress = std::forward<FrameAddressT>(value);
  }
  template <typename FrameAddressT = Aws::String>
  Match& WithFrameAddress(FrameAddressT&& value) {
    SetFrameAddress(std::forward<FrameAddressT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTargetFramesIndex(int value) {
    m_targetFramesIndexHasBeenSet = true;
    m_targetFramesIndex = value;
  }
  inline Match& WithTargetFramesIndex(int value) {
    SetTargetFramesIndex(value);
    return *this;
  }
  ///@}
  ...
  inline void SetThresholdBreachValue(double value) {
    m_thresholdBreachValueHasBeenSet = true;
    m_thresholdBreachValue = value;
  }
  inline Match& WithThresholdBreachValue(double value) {
    SetThresholdBreachValue(value);
    return *this;
  }
  ///@}
 private:
