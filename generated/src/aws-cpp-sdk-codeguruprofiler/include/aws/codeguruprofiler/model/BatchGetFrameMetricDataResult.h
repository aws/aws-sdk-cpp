...
class BatchGetFrameMetricDataResult {
 public:
  ...
  void SetFrameMetricData(FrameMetricDataT&& value) {
    ...
    m_frameMetricData = std::forward<FrameMetricDataT>(value);
  }
  template <typename FrameMetricDataT = Aws::Vector<FrameMetricDatum>>
  BatchGetFrameMetricDataResult& WithFrameMetricData(FrameMetricDataT&& value) {
    SetFrameMetricData(std::forward<FrameMetricDataT>(value));
    return *this;
  }
  ...
  BatchGetFrameMetricDataResult& AddFrameMetricData(FrameMetricDataT&& value) {
    m_frameMetricDataHasBeenSet = true;
    m_frameMetricData.emplace_back(std::forward<FrameMetricDataT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetResolution(AggregationPeriod value) {
    m_resolutionHasBeenSet = true;
    m_resolution = value;
  }
  inline BatchGetFrameMetricDataResult& WithResolution(AggregationPeriod value) {
    SetResolution(value);
    return *this;
  }
  ///@}
  ...
  void SetUnprocessedEndTimes(UnprocessedEndTimesT&& value) {
    ...
    m_unprocessedEndTimes = std::forward<UnprocessedEndTimesT>(value);
  }
  template <typename UnprocessedEndTimesT = Aws::Map<Aws::String, Aws::Vector<TimestampStructure>>>
  BatchGetFrameMetricDataResult& WithUnprocessedEndTimes(UnprocessedEndTimesT&& value) {
    SetUnprocessedEndTimes(std::forward<UnprocessedEndTimesT>(value));
    return *this;
  }
  ...
  BatchGetFrameMetricDataResult& AddUnprocessedEndTimes(UnprocessedEndTimesKeyT&& key, UnprocessedEndTimesValueT&& value) {
    m_unprocessedEndTimesHasBeenSet = true;
    m_unprocessedEndTimes.emplace(std::forward<UnprocessedEndTimesKeyT>(key), std::forward<UnprocessedEndTimesValueT>(value));
    return *this;
  }
  ///@}
