...
class Pattern {
 public:
  ...
  void SetCountersToAggregate(CountersToAggregateT&& value) {
    ...
    m_countersToAggregate = std::forward<CountersToAggregateT>(value);
  }
  template <typename CountersToAggregateT = Aws::Vector<Aws::String>>
  Pattern& WithCountersToAggregate(CountersToAggregateT&& value) {
    SetCountersToAggregate(std::forward<CountersToAggregateT>(value));
    return *this;
  }
  template <typename CountersToAggregateT = Aws::String>
  Pattern& AddCountersToAggregate(CountersToAggregateT&& value) {
    m_countersToAggregateHasBeenSet = true;
    m_countersToAggregate.emplace_back(std::forward<CountersToAggregateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResolutionSteps(ResolutionStepsT&& value) {
    ...
    m_resolutionSteps = std::forward<ResolutionStepsT>(value);
  }
  template <typename ResolutionStepsT = Aws::String>
  Pattern& WithResolutionSteps(ResolutionStepsT&& value) {
    SetResolutionSteps(std::forward<ResolutionStepsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetFrames(TargetFramesT&& value) {
    ...
    m_targetFrames = std::forward<TargetFramesT>(value);
  }
  template <typename TargetFramesT = Aws::Vector<Aws::Vector<Aws::String>>>
  Pattern& WithTargetFrames(TargetFramesT&& value) {
    SetTargetFrames(std::forward<TargetFramesT>(value));
    return *this;
  }
  template <typename TargetFramesT = Aws::Vector<Aws::String>>
  Pattern& AddTargetFrames(TargetFramesT&& value) {
    m_targetFramesHasBeenSet = true;
    m_targetFrames.emplace_back(std::forward<TargetFramesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetThresholdPercent(double value) {
    m_thresholdPercentHasBeenSet = true;
    m_thresholdPercent = value;
  }
  inline Pattern& WithThresholdPercent(double value) {
