...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public CodeGuruProfilerRequest
  {
  public:
    AWS_CODEGURUPROFILER_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p> A list of tag keys. Existing tags of resources with keys in this list are
