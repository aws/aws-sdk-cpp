...
class ListProfileTimesRequest : public CodeGuruProfilerRequest {
 public:
  ...
  inline ListProfileTimesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListProfileTimesRequest& WithOrderBy(OrderBy value) {
    SetOrderBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPeriod(AggregationPeriod value) {
    m_periodHasBeenSet = true;
    m_period = value;
  }
  inline ListProfileTimesRequest& WithPeriod(AggregationPeriod value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
