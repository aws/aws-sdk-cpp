...
class Recommendation {
 public:
  ...
  inline void SetAllMatchesCount(int value) {
    m_allMatchesCountHasBeenSet = true;
    m_allMatchesCount = value;
  }
  inline Recommendation& WithAllMatchesCount(int value) {
    SetAllMatchesCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllMatchesSum(double value) {
    m_allMatchesSumHasBeenSet = true;
    m_allMatchesSum = value;
  }
  inline Recommendation& WithAllMatchesSum(double value) {
    SetAllMatchesSum(value);
    return *this;
  }
  ///@}
  ...
  void SetTopMatches(TopMatchesT&& value) {
    ...
    m_topMatches = std::forward<TopMatchesT>(value);
  }
  template <typename TopMatchesT = Aws::Vector<Match>>
  Recommendation& WithTopMatches(TopMatchesT&& value) {
    SetTopMatches(std::forward<TopMatchesT>(value));
    return *this;
  }
  template <typename TopMatchesT = Match>
  Recommendation& AddTopMatches(TopMatchesT&& value) {
    m_topMatchesHasBeenSet = true;
    m_topMatches.emplace_back(std::forward<TopMatchesT>(value));
    return *this;
  }
  ///@}
 private:
