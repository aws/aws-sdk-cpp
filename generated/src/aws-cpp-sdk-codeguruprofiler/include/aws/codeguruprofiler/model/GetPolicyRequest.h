...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetPolicyRequest : public CodeGuruProfilerRequest
  {
  public:
    AWS_CODEGURUPROFILER_API GetPolicyRequest() = default;
    ...
    template<typename ProfilingGroupNameT = Aws::String>
    GetPolicyRequest& WithProfilingGroupName(ProfilingGroupNameT&& value) { SetProfilingGroupName(std::forward<ProfilingGroupNameT>(value)); return *this;}
    ///@}
  private:
