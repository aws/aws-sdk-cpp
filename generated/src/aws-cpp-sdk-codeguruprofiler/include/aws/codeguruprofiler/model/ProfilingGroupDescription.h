...
class ProfilingGroupDescription {
 public:
  ...
  inline ProfilingGroupDescription& WithComputePlatform(ComputePlatform value) {
  ...
  void SetProfilingStatus(ProfilingStatusT&& value) {
    ...
    m_profilingStatus = std::forward<ProfilingStatusT>(value);
  }
  template <typename ProfilingStatusT = ProfilingStatus>
  ProfilingGroupDescription& WithProfilingStatus(ProfilingStatusT&& value) {
    SetProfilingStatus(std::forward<ProfilingStatusT>(value));
    return *this;
  }
  ///@}
