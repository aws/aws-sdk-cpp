...
class Channel {
 public:
  ...
  void SetEventPublishers(EventPublishersT&& value) {
    ...
    m_eventPublishers = std::forward<EventPublishersT>(value);
  }
  template <typename EventPublishersT = Aws::Vector<EventPublisher>>
  Channel& WithEventPublishers(EventPublishersT&& value) {
    SetEventPublishers(std::forward<EventPublishersT>(value));
    return *this;
  }
  inline Channel& AddEventPublishers(EventPublisher value) {
    m_eventPublishersHasBeenSet = true;
    m_eventPublishers.push_back(value);
    return *this;
  }
  ///@}
