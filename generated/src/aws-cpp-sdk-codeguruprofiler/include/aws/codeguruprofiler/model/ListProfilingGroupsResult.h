...
class ListProfilingGroupsResult {
 public:
  ...
  void SetProfilingGroupNames(ProfilingGroupNamesT&& value) {
    ...
    m_profilingGroupNames = std::forward<ProfilingGroupNamesT>(value);
  }
  template <typename ProfilingGroupNamesT = Aws::Vector<Aws::String>>
  ListProfilingGroupsResult& WithProfilingGroupNames(ProfilingGroupNamesT&& value) {
    SetProfilingGroupNames(std::forward<ProfilingGroupNamesT>(value));
    return *this;
  }
  ...
  ListProfilingGroupsResult& AddProfilingGroupNames(ProfilingGroupNamesT&& value) {
    m_profilingGroupNamesHasBeenSet = true;
    m_profilingGroupNames.emplace_back(std::forward<ProfilingGroupNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProfilingGroups(ProfilingGroupsT&& value) {
    ...
    m_profilingGroups = std::forward<ProfilingGroupsT>(value);
  }
  template <typename ProfilingGroupsT = Aws::Vector<ProfilingGroupDescription>>
  ListProfilingGroupsResult& WithProfilingGroups(ProfilingGroupsT&& value) {
    SetProfilingGroups(std::forward<ProfilingGroupsT>(value));
    return *this;
  }
  ...
  ListProfilingGroupsResult& AddProfilingGroups(ProfilingGroupsT&& value) {
    m_profilingGroupsHasBeenSet = true;
    m_profilingGroups.emplace_back(std::forward<ProfilingGroupsT>(value));
    return *this;
  }
  ///@}
