...
namespace Model
{
  ...
  public:
    ...
    inline SubmitFeedbackResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline SubmitFeedbackResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline SubmitFeedbackResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
