...
class ListProfileTimesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListProfileTimesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetProfileTimes(ProfileTimesT&& value) {
    m_profileTimesHasBeenSet = true;
    m_profileTimes = std::forward<ProfileTimesT>(value);
  }
  template <typename ProfileTimesT = Aws::Vector<ProfileTime>>
  ListProfileTimesResult& WithProfileTimes(ProfileTimesT&& value) {
    SetProfileTimes(std::forward<ProfileTimesT>(value));
    return *this;
  }
  template <typename ProfileTimesT = ProfileTime>
  ListProfileTimesResult& AddProfileTimes(ProfileTimesT&& value) {
    m_profileTimesHasBeenSet = true;
    m_profileTimes.emplace_back(std::forward<ProfileTimesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListProfileTimesResult& WithRequestId(RequestIdT&& value) {
