...
namespace RedshiftServerless
{
   ...
   */
  class AWS_REDSHIFTSERVERLESS_API RedshiftServerlessClient : Aws::Client::ClientWithAsyncTemplateMethods<RedshiftServerlessClient>,
    smithy::client::AwsSmithyClientT<Aws::RedshiftServerless::SERVICE_NAME,
