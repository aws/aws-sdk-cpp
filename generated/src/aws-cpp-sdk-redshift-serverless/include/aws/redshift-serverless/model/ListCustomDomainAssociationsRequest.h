...
class ListCustomDomainAssociationsRequest : public RedshiftServerlessRequest {
 public:
  AWS_REDSHIFTSERVERLESS_API ListCustomDomainAssociationsRequest() = default;
  ...
  template <typename CustomDomainCertificateArnT = Aws::String>
  ListCustomDomainAssociationsRequest& WithCustomDomainCertificateArn(CustomDomainCertificateArnT&& value) {
  ...
  template <typename CustomDomainNameT = Aws::String>
  ListCustomDomainAssociationsRequest& WithCustomDomainName(CustomDomainNameT&& value) {
  ...
  inline ListCustomDomainAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomDomainAssociationsRequest& WithNextToken(NextTokenT&& value) {
