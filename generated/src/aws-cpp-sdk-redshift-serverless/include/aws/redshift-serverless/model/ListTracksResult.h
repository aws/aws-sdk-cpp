...
class ListTracksResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListTracksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TracksT = Aws::Vector<ServerlessTrack>>
  ListTracksResult& WithTracks(TracksT&& value) {
    SetTracks(std::forward<TracksT>(value));
    return *this;
  }
  template <typename TracksT = ServerlessTrack>
  ListTracksResult& AddTracks(TracksT&& value) {
    m_tracksHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListTracksResult& WithRequestId(RequestIdT&& value) {
