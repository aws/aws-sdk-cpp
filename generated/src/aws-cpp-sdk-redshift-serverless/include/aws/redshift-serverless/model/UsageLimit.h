...
class UsageLimit {
 public:
  ...
  inline UsageLimit& WithAmount(long long value) {
    SetAmount(value);
    return *this;
  }
  ///@}
  ...
  inline UsageLimit& WithBreachAction(UsageLimitBreachAction value) {
  ...
  inline UsageLimit& WithPeriod(UsageLimitPeriod value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  void SetUsageLimitArn(UsageLimitArnT&& value) {
    ...
    m_usageLimitArn = std::forward<UsageLimitArnT>(value);
  }
  template <typename UsageLimitArnT = Aws::String>
  UsageLimit& WithUsageLimitArn(UsageLimitArnT&& value) {
    SetUsageLimitArn(std::forward<UsageLimitArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline UsageLimit& WithUsageType(UsageLimitUsageType value) {
    SetUsageType(value);
    return *this;
  }
  ///@}
