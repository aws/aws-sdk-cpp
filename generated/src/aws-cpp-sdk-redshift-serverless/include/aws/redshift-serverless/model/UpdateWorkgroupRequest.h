...
class UpdateWorkgroupRequest : public RedshiftServerlessRequest {
 public:
  ...
  inline void SetBaseCapacity(int value) {
    m_baseCapacityHasBeenSet = true;
    m_baseCapacity = value;
  }
  inline UpdateWorkgroupRequest& WithBaseCapacity(int value) {
    SetBaseCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateWorkgroupRequest& WithEnhancedVpcRouting(bool value) {
  ...
  inline UpdateWorkgroupRequest& WithExtraComputeForAutomaticOptimization(bool value) {
  ...
  inline UpdateWorkgroupRequest& WithMaxCapacity(int value) {
  ...
  inline UpdateWorkgroupRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  void SetPricePerformanceTarget(PricePerformanceTargetT&& value) {
    ...
    m_pricePerformanceTarget = std::forward<PricePerformanceTargetT>(value);
  }
  template <typename PricePerformanceTargetT = PerformanceTarget>
  UpdateWorkgroupRequest& WithPricePerformanceTarget(PricePerformanceTargetT&& value) {
    SetPricePerformanceTarget(std::forward<PricePerformanceTargetT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateWorkgroupRequest& WithPubliclyAccessible(bool value) {
  ...
  void SetTrackName(TrackNameT&& value) {
    ...
    m_trackName = std::forward<TrackNameT>(value);
  }
  template <typename TrackNameT = Aws::String>
  UpdateWorkgroupRequest& WithTrackName(TrackNameT&& value) {
    SetTrackName(std::forward<TrackNameT>(value));
    return *this;
  }
  ///@}
