...
class Snapshot {
 public:
  ...
  void SetAccountsWithProvisionedRestoreAccess(AccountsWithProvisionedRestoreAccessT&& value) {
    ...
    m_accountsWithProvisionedRestoreAccess = std::forward<AccountsWithProvisionedRestoreAccessT>(value);
  }
  template <typename AccountsWithProvisionedRestoreAccessT = Aws::Vector<Aws::String>>
  Snapshot& WithAccountsWithProvisionedRestoreAccess(AccountsWithProvisionedRestoreAccessT&& value) {
    SetAccountsWithProvisionedRestoreAccess(std::forward<AccountsWithProvisionedRestoreAccessT>(value));
    return *this;
  }
  ...
  Snapshot& AddAccountsWithProvisionedRestoreAccess(AccountsWithProvisionedRestoreAccessT&& value) {
    m_accountsWithProvisionedRestoreAccessHasBeenSet = true;
    m_accountsWithProvisionedRestoreAccess.emplace_back(std::forward<AccountsWithProvisionedRestoreAccessT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSnapshotRemainingDays(int value) {
    m_snapshotRemainingDaysHasBeenSet = true;
    m_snapshotRemainingDays = value;
  }
  inline Snapshot& WithSnapshotRemainingDays(int value) {
    SetSnapshotRemainingDays(value);
    return *this;
  }
  ///@}
  ...
  inline Snapshot& WithSnapshotRetentionPeriod(int value) {
