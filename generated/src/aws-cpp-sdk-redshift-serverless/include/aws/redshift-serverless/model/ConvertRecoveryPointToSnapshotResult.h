...
class ConvertRecoveryPointToSnapshotResult {
 public:
  ...
  AWS_REDSHIFTSERVERLESS_API ConvertRecoveryPointToSnapshotResult& operator=(
  ...
  template <typename SnapshotT = Snapshot>
  ConvertRecoveryPointToSnapshotResult& WithSnapshot(SnapshotT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ConvertRecoveryPointToSnapshotResult& WithRequestId(RequestIdT&& value) {
