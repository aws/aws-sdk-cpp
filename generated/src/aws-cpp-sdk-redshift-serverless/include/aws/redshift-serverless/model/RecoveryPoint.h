...
class RecoveryPoint {
 public:
  ...
  void SetRecoveryPointCreateTime(RecoveryPointCreateTimeT&& value) {
    ...
    m_recoveryPointCreateTime = std::forward<RecoveryPointCreateTimeT>(value);
  }
  template <typename RecoveryPointCreateTimeT = Aws::Utils::DateTime>
  RecoveryPoint& WithRecoveryPointCreateTime(RecoveryPointCreateTimeT&& value) {
    SetRecoveryPointCreateTime(std::forward<RecoveryPointCreateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalSizeInMegaBytes(double value) {
    m_totalSizeInMegaBytesHasBeenSet = true;
    m_totalSizeInMegaBytes = value;
  }
  inline RecoveryPoint& WithTotalSizeInMegaBytes(double value) {
    SetTotalSizeInMegaBytes(value);
    return *this;
  }
  ///@}
