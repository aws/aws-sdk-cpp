...
class ListEndpointAccessRequest : public RedshiftServerlessRequest {
 public:
  AWS_REDSHIFTSERVERLESS_API ListEndpointAccessRequest() = default;
  ...
  inline ListEndpointAccessRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEndpointAccessRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename OwnerAccountT = Aws::String>
  ListEndpointAccessRequest& WithOwnerAccount(OwnerAccountT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  ListEndpointAccessRequest& WithVpcId(VpcIdT&& value) {
  ...
  template <typename WorkgroupNameT = Aws::String>
  ListEndpointAccessRequest& WithWorkgroupName(WorkgroupNameT&& value) {
