...
class ListSnapshotCopyConfigurationsResult {
 public:
  ...
  AWS_REDSHIFTSERVERLESS_API ListSnapshotCopyConfigurationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListSnapshotCopyConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetSnapshotCopyConfigurations(SnapshotCopyConfigurationsT&& value) {
    m_snapshotCopyConfigurationsHasBeenSet = true;
    m_snapshotCopyConfigurations = std::forward<SnapshotCopyConfigurationsT>(value);
  }
  template <typename SnapshotCopyConfigurationsT = Aws::Vector<SnapshotCopyConfiguration>>
  ListSnapshotCopyConfigurationsResult& WithSnapshotCopyConfigurations(SnapshotCopyConfigurationsT&& value) {
    SetSnapshotCopyConfigurations(std::forward<SnapshotCopyConfigurationsT>(value));
    return *this;
  }
  template <typename SnapshotCopyConfigurationsT = SnapshotCopyConfiguration>
  ListSnapshotCopyConfigurationsResult& AddSnapshotCopyConfigurations(SnapshotCopyConfigurationsT&& value) {
    m_snapshotCopyConfigurationsHasBeenSet = true;
    m_snapshotCopyConfigurations.emplace_back(std::forward<SnapshotCopyConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListSnapshotCopyConfigurationsResult& WithRequestId(RequestIdT&& value) {
