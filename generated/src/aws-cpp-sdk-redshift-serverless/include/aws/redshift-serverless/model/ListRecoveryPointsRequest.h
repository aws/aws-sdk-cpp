...
class ListRecoveryPointsRequest : public RedshiftServerlessRequest {
 public:
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ListRecoveryPointsRequest& WithEndTime(EndTimeT&& value) {
  ...
  inline ListRecoveryPointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceArnT = Aws::String>
  ListRecoveryPointsRequest& WithNamespaceArn(NamespaceArnT&& value) {
  ...
  template <typename NamespaceNameT = Aws::String>
  ListRecoveryPointsRequest& WithNamespaceName(NamespaceNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRecoveryPointsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListRecoveryPointsRequest& WithStartTime(StartTimeT&& value) {
