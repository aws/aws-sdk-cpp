...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFTSERVERLESS_API DeleteUsageLimitResult() = default;
    ...
    template<typename UsageLimitT = UsageLimit>
    DeleteUsageLimitResult& WithUsageLimit(UsageLimitT&& value) { SetUsageLimit(std::forward<UsageLimitT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteUsageLimitResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
