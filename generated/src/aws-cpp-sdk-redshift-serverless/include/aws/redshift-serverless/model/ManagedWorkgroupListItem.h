...
class ManagedWorkgroupListItem {
 public:
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  ManagedWorkgroupListItem& WithCreationDate(CreationDateT&& value) {
  ...
  void SetManagedWorkgroupId(ManagedWorkgroupIdT&& value) {
    m_managedWorkgroupIdHasBeenSet = true;
    m_managedWorkgroupId = std::forward<ManagedWorkgroupIdT>(value);
  }
  template <typename ManagedWorkgroupIdT = Aws::String>
  ManagedWorkgroupListItem& WithManagedWorkgroupId(ManagedWorkgroupIdT&& value) {
    SetManagedWorkgroupId(std::forward<ManagedWorkgroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ManagedWorkgroupNameT = Aws::String>
  ManagedWorkgroupListItem& WithManagedWorkgroupName(ManagedWorkgroupNameT&& value) {
  ...
  template <typename SourceArnT = Aws::String>
  ManagedWorkgroupListItem& WithSourceArn(SourceArnT&& value) {
  ...
  inline void SetStatus(ManagedWorkgroupStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ManagedWorkgroupListItem& WithStatus(ManagedWorkgroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
