...
class RestoreTableFromRecoveryPointResult {
 public:
  AWS_REDSHIFTSERVERLESS_API RestoreTableFromRecoveryPointResult() = default;
  ...
  AWS_REDSHIFTSERVERLESS_API RestoreTableFromRecoveryPointResult& operator=(
  ...
  void SetTableRestoreStatus(TableRestoreStatusT&& value) {
    m_tableRestoreStatusHasBeenSet = true;
    m_tableRestoreStatus = std::forward<TableRestoreStatusT>(value);
  }
  template <typename TableRestoreStatusT = TableRestoreStatus>
  RestoreTableFromRecoveryPointResult& WithTableRestoreStatus(TableRestoreStatusT&& value) {
    SetTableRestoreStatus(std::forward<TableRestoreStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  RestoreTableFromRecoveryPointResult& WithRequestId(RequestIdT&& value) {
