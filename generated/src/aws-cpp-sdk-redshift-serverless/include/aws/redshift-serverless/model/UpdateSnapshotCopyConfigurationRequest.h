...
class UpdateSnapshotCopyConfigurationRequest : public RedshiftServerlessRequest {
 public:
  ...
  template <typename SnapshotCopyConfigurationIdT = Aws::String>
  UpdateSnapshotCopyConfigurationRequest& WithSnapshotCopyConfigurationId(SnapshotCopyConfigurationIdT&& value) {
  ...
  inline UpdateSnapshotCopyConfigurationRequest& WithSnapshotRetentionPeriod(int value) {
