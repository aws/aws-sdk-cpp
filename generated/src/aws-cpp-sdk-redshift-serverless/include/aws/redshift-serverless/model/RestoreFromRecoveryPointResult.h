...
class RestoreFromRecoveryPointResult {
 public:
  ...
  AWS_REDSHIFTSERVERLESS_API RestoreFromRecoveryPointResult& operator=(
  ...
  template <typename NamespaceT = Namespace>
  RestoreFromRecoveryPointResult& WithNamespace(NamespaceT&& value) {
  ...
  template <typename RecoveryPointIdT = Aws::String>
  RestoreFromRecoveryPointResult& WithRecoveryPointId(RecoveryPointIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RestoreFromRecoveryPointResult& WithRequestId(RequestIdT&& value) {
