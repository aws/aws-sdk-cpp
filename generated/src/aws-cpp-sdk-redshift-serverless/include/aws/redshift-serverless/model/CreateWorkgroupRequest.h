...
class CreateWorkgroupRequest : public RedshiftServerlessRequest {
 public:
  ...
  inline CreateWorkgroupRequest& WithBaseCapacity(int value) {
  ...
  inline CreateWorkgroupRequest& WithMaxCapacity(int value) {
  ...
  inline CreateWorkgroupRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline CreateWorkgroupRequest& WithPubliclyAccessible(bool value) {
