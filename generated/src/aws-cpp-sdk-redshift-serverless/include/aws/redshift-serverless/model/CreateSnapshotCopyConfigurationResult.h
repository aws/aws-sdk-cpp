...
namespace Model
{
  ...
  public:
    ...
    template<typename SnapshotCopyConfigurationT = SnapshotCopyConfiguration>
    CreateSnapshotCopyConfigurationResult& WithSnapshotCopyConfiguration(SnapshotCopyConfigurationT&& value) { SetSnapshotCopyConfiguration(std::forward<SnapshotCopyConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateSnapshotCopyConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
