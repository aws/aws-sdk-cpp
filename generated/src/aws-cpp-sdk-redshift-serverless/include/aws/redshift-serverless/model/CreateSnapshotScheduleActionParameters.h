...
class CreateSnapshotScheduleActionParameters {
 public:
  ...
  inline CreateSnapshotScheduleActionParameters& WithRetentionPeriod(int value) {
  ...
  void SetSnapshotNamePrefix(SnapshotNamePrefixT&& value) {
    ...
    m_snapshotNamePrefix = std::forward<SnapshotNamePrefixT>(value);
  }
  template <typename SnapshotNamePrefixT = Aws::String>
  CreateSnapshotScheduleActionParameters& WithSnapshotNamePrefix(SnapshotNamePrefixT&& value) {
    SetSnapshotNamePrefix(std::forward<SnapshotNamePrefixT>(value));
    return *this;
  }
  ///@}
