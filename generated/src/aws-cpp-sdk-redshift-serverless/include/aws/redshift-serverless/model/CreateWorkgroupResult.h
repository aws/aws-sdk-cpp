...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFTSERVERLESS_API CreateWorkgroupResult() = default;
    ...
    template<typename WorkgroupT = Workgroup>
    CreateWorkgroupResult& WithWorkgroup(WorkgroupT&& value) { SetWorkgroup(std::forward<WorkgroupT>(value)); return *this;}
    ///@}
