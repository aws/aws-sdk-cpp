...
namespace Model
{
  ...
  public:
    ...
    template<typename ReservationT = Reservation>
    GetReservationResult& WithReservation(ReservationT&& value) { SetReservation(std::forward<ReservationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetReservationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
