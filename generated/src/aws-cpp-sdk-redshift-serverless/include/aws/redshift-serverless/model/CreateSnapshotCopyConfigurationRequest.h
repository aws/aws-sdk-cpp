...
class CreateSnapshotCopyConfigurationRequest : public RedshiftServerlessRequest {
 public:
  ...
  void SetDestinationKmsKeyId(DestinationKmsKeyIdT&& value) {
    ...
    m_destinationKmsKeyId = std::forward<DestinationKmsKeyIdT>(value);
  }
  template <typename DestinationKmsKeyIdT = Aws::String>
  CreateSnapshotCopyConfigurationRequest& WithDestinationKmsKeyId(DestinationKmsKeyIdT&& value) {
    SetDestinationKmsKeyId(std::forward<DestinationKmsKeyIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSnapshotRetentionPeriod(int value) {
    m_snapshotRetentionPeriodHasBeenSet = true;
    m_snapshotRetentionPeriod = value;
  }
  inline CreateSnapshotCopyConfigurationRequest& WithSnapshotRetentionPeriod(int value) {
    SetSnapshotRetentionPeriod(value);
    return *this;
  }
  ///@}
 private:
