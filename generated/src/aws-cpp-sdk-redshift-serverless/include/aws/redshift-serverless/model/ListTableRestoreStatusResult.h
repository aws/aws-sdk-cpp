...
class ListTableRestoreStatusResult {
 public:
  ...
  AWS_REDSHIFTSERVERLESS_API ListTableRestoreStatusResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListTableRestoreStatusResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetTableRestoreStatuses(TableRestoreStatusesT&& value) {
    m_tableRestoreStatusesHasBeenSet = true;
    m_tableRestoreStatuses = std::forward<TableRestoreStatusesT>(value);
  }
  template <typename TableRestoreStatusesT = Aws::Vector<TableRestoreStatus>>
  ListTableRestoreStatusResult& WithTableRestoreStatuses(TableRestoreStatusesT&& value) {
    SetTableRestoreStatuses(std::forward<TableRestoreStatusesT>(value));
    return *this;
  }
  template <typename TableRestoreStatusesT = TableRestoreStatus>
  ListTableRestoreStatusResult& AddTableRestoreStatuses(TableRestoreStatusesT&& value) {
    m_tableRestoreStatusesHasBeenSet = true;
    m_tableRestoreStatuses.emplace_back(std::forward<TableRestoreStatusesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTableRestoreStatusResult& WithRequestId(RequestIdT&& value) {
