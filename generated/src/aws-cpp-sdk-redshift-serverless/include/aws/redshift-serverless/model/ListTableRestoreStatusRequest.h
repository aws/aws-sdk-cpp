...
class ListTableRestoreStatusRequest : public RedshiftServerlessRequest {
 public:
  AWS_REDSHIFTSERVERLESS_API ListTableRestoreStatusRequest() = default;
  ...
  inline ListTableRestoreStatusRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceNameT = Aws::String>
  ListTableRestoreStatusRequest& WithNamespaceName(NamespaceNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTableRestoreStatusRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename WorkgroupNameT = Aws::String>
  ListTableRestoreStatusRequest& WithWorkgroupName(WorkgroupNameT&& value) {
