...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFTSERVERLESS_API UpdateSnapshotResult() = default;
    ...
    template<typename SnapshotT = Snapshot>
    UpdateSnapshotResult& WithSnapshot(SnapshotT&& value) { SetSnapshot(std::forward<SnapshotT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateSnapshotResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
