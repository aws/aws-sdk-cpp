...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFTSERVERLESS_API UpdateUsageLimitResult() = default;
    ...
    template<typename UsageLimitT = UsageLimit>
    UpdateUsageLimitResult& WithUsageLimit(UsageLimitT&& value) { SetUsageLimit(std::forward<UsageLimitT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateUsageLimitResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
