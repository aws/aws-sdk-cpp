...
class ListCustomDomainAssociationsResult {
 public:
  ...
  AWS_REDSHIFTSERVERLESS_API ListCustomDomainAssociationsResult& operator=(
  ...
  template <typename AssociationsT = Aws::Vector<Association>>
  ListCustomDomainAssociationsResult& WithAssociations(AssociationsT&& value) {
    SetAssociations(std::forward<AssociationsT>(value));
    return *this;
  }
  template <typename AssociationsT = Association>
  ListCustomDomainAssociationsResult& AddAssociations(AssociationsT&& value) {
    m_associationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomDomainAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomDomainAssociationsResult& WithRequestId(RequestIdT&& value) {
