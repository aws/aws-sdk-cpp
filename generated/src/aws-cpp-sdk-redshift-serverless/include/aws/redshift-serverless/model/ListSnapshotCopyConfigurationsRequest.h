...
class ListSnapshotCopyConfigurationsRequest : public RedshiftServerlessRequest {
 public:
  ...
  inline ListSnapshotCopyConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceNameT = Aws::String>
  ListSnapshotCopyConfigurationsRequest& WithNamespaceName(NamespaceNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSnapshotCopyConfigurationsRequest& WithNextToken(NextTokenT&& value) {
