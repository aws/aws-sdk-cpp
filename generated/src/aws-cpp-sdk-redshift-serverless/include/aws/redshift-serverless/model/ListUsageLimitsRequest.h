...
class ListUsageLimitsRequest : public RedshiftServerlessRequest {
 public:
  ...
  inline ListUsageLimitsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUsageLimitsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  ListUsageLimitsRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline void SetUsageType(UsageLimitUsageType value) {
    m_usageTypeHasBeenSet = true;
    m_usageType = value;
  }
  inline ListUsageLimitsRequest& WithUsageType(UsageLimitUsageType value) {
    SetUsageType(value);
    return *this;
  }
  ///@}
