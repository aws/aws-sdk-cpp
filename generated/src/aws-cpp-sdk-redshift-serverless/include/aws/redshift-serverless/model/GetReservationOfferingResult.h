...
class GetReservationOfferingResult {
 public:
  ...
  AWS_REDSHIFTSERVERLESS_API GetReservationOfferingResult& operator=(
  ...
  void SetReservationOffering(ReservationOfferingT&& value) {
    m_reservationOfferingHasBeenSet = true;
    m_reservationOffering = std::forward<ReservationOfferingT>(value);
  }
  template <typename ReservationOfferingT = ReservationOffering>
  GetReservationOfferingResult& WithReservationOffering(ReservationOfferingT&& value) {
    SetReservationOffering(std::forward<ReservationOfferingT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetReservationOfferingResult& WithRequestId(RequestIdT&& value) {
