...
class CreateEndpointAccessRequest : public RedshiftServerlessRequest {
 public:
  ...
  template <typename OwnerAccountT = Aws::String>
  CreateEndpointAccessRequest& WithOwnerAccount(OwnerAccountT&& value) {
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  CreateEndpointAccessRequest& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  CreateEndpointAccessRequest& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  template <typename WorkgroupNameT = Aws::String>
  CreateEndpointAccessRequest& WithWorkgroupName(WorkgroupNameT&& value) {
