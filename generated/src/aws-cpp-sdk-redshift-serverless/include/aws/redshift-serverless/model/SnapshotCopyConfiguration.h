...
class SnapshotCopyConfiguration {
 public:
  ...
  void SetSnapshotCopyConfigurationArn(SnapshotCopyConfigurationArnT&& value) {
    ...
    m_snapshotCopyConfigurationArn = std::forward<SnapshotCopyConfigurationArnT>(value);
  }
  template <typename SnapshotCopyConfigurationArnT = Aws::String>
  SnapshotCopyConfiguration& WithSnapshotCopyConfigurationArn(SnapshotCopyConfigurationArnT&& value) {
    SetSnapshotCopyConfigurationArn(std::forward<SnapshotCopyConfigurationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnapshotCopyConfigurationId(SnapshotCopyConfigurationIdT&& value) {
    ...
    m_snapshotCopyConfigurationId = std::forward<SnapshotCopyConfigurationIdT>(value);
  }
  template <typename SnapshotCopyConfigurationIdT = Aws::String>
  SnapshotCopyConfiguration& WithSnapshotCopyConfigurationId(SnapshotCopyConfigurationIdT&& value) {
    SetSnapshotCopyConfigurationId(std::forward<SnapshotCopyConfigurationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline SnapshotCopyConfiguration& WithSnapshotRetentionPeriod(int value) {
