...
class ListManagedWorkgroupsRequest : public RedshiftServerlessRequest {
 public:
  ...
  inline ListManagedWorkgroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedWorkgroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SourceArnT = Aws::String>
  ListManagedWorkgroupsRequest& WithSourceArn(SourceArnT&& value) {
