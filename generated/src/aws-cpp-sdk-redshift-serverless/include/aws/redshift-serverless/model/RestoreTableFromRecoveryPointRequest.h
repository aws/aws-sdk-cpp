...
namespace Model
{
  ...
  public:
    ...
    template<typename NamespaceNameT = Aws::String>
    RestoreTableFromRecoveryPointRequest& WithNamespaceName(NamespaceNameT&& value) { SetNamespaceName(std::forward<NamespaceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NewTableNameT = Aws::String>
    RestoreTableFromRecoveryPointRequest& WithNewTableName(NewTableNameT&& value) { SetNewTableName(std::forward<NewTableNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RecoveryPointIdT = Aws::String>
    RestoreTableFromRecoveryPointRequest& WithRecoveryPointId(RecoveryPointIdT&& value) { SetRecoveryPointId(std::forward<RecoveryPointIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceDatabaseNameT = Aws::String>
    RestoreTableFromRecoveryPointRequest& WithSourceDatabaseName(SourceDatabaseNameT&& value) { SetSourceDatabaseName(std::forward<SourceDatabaseNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceSchemaNameT = Aws::String>
    RestoreTableFromRecoveryPointRequest& WithSourceSchemaName(SourceSchemaNameT&& value) { SetSourceSchemaName(std::forward<SourceSchemaNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceTableNameT = Aws::String>
    RestoreTableFromRecoveryPointRequest& WithSourceTableName(SourceTableNameT&& value) { SetSourceTableName(std::forward<SourceTableNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetDatabaseNameT = Aws::String>
    RestoreTableFromRecoveryPointRequest& WithTargetDatabaseName(TargetDatabaseNameT&& value) { SetTargetDatabaseName(std::forward<TargetDatabaseNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetSchemaNameT = Aws::String>
    RestoreTableFromRecoveryPointRequest& WithTargetSchemaName(TargetSchemaNameT&& value) { SetTargetSchemaName(std::forward<TargetSchemaNameT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkgroupNameT = Aws::String>
    RestoreTableFromRecoveryPointRequest& WithWorkgroupName(WorkgroupNameT&& value) { SetWorkgroupName(std::forward<WorkgroupNameT>(value)); return *this;}
    ///@}
  private:
