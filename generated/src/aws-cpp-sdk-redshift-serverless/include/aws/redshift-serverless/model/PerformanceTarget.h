...
class PerformanceTarget {
 public:
  ...
  inline PerformanceTarget& WithLevel(int value) {
    SetLevel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(PerformanceTargetStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline PerformanceTarget& WithStatus(PerformanceTargetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
