...
class ListEndpointAccessResult {
 public:
  ...
  template <typename EndpointsT = Aws::Vector<EndpointAccess>>
  ListEndpointAccessResult& WithEndpoints(EndpointsT&& value) {
    SetEndpoints(std::forward<EndpointsT>(value));
    return *this;
  }
  template <typename EndpointsT = EndpointAccess>
  ListEndpointAccessResult& AddEndpoints(EndpointsT&& value) {
    m_endpointsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEndpointAccessResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEndpointAccessResult& WithRequestId(RequestIdT&& value) {
