...
ListEndpointAccessResult::ListEndpointAccessResult()
{
}

ListEndpointAccessResult::ListEndpointAccessResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListEndpointAccessResult& ListEndpointAccessResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
