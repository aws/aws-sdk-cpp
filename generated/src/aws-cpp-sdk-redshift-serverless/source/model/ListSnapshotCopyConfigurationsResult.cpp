...
ListSnapshotCopyConfigurationsResult& ListSnapshotCopyConfigurationsResult::operator=(
  ...
  if (jsonValue.ValueExists("snapshotCopyConfigurations")) {
    ...
    for (unsigned snapshotCopyConfigurationsIndex = 0; snapshotCopyConfigurationsIndex < snapshotCopyConfigurationsJsonList.GetLength();
         ++snapshotCopyConfigurationsIndex) {
