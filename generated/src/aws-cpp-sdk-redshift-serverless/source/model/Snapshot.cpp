...
Snapshot& Snapshot::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("accountsWithProvisionedRestoreAccess")) {
    ...
    for (unsigned accountsWithProvisionedRestoreAccessIndex = 0;
         accountsWithProvisionedRestoreAccessIndex < accountsWithProvisionedRestoreAccessJsonList.GetLength();
         ++accountsWithProvisionedRestoreAccessIndex) {
      m_accountsWithProvisionedRestoreAccess.push_back(
          accountsWithProvisionedRestoreAccessJsonList[accountsWithProvisionedRestoreAccessIndex].AsString());
    }
  ...
  if (jsonValue.ValueExists("accountsWithRestoreAccess")) {
    ...
    for (unsigned accountsWithRestoreAccessIndex = 0; accountsWithRestoreAccessIndex < accountsWithRestoreAccessJsonList.GetLength();
...
JsonValue Snapshot::Jsonize() const {
  ...
  if (m_accountsWithProvisionedRestoreAccessHasBeenSet) {
    ...
    for (unsigned accountsWithProvisionedRestoreAccessIndex = 0;
         ...
         ++accountsWithProvisionedRestoreAccessIndex) {
      accountsWithProvisionedRestoreAccessJsonList[accountsWithProvisionedRestoreAccessIndex].AsString(
          m_accountsWithProvisionedRestoreAccess[accountsWithProvisionedRestoreAccessIndex]);
    }
  ...
  if (m_accountsWithRestoreAccessHasBeenSet) {
    ...
    for (unsigned accountsWithRestoreAccessIndex = 0; accountsWithRestoreAccessIndex < accountsWithRestoreAccessJsonList.GetLength();
         ++accountsWithRestoreAccessIndex) {
      accountsWithRestoreAccessJsonList[accountsWithRestoreAccessIndex].AsString(
          m_accountsWithRestoreAccess[accountsWithRestoreAccessIndex]);
    }
