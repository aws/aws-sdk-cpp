...
ListReservationOfferingsResult::ListReservationOfferingsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListReservationOfferingsResult& ListReservationOfferingsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("reservationOfferingsList")) {
    ...
    for (unsigned reservationOfferingsListIndex = 0; reservationOfferingsListIndex < reservationOfferingsListJsonList.GetLength();
         ++reservationOfferingsListIndex) {
