...
template <>
AWS_GLACIER_API ResourceNotFoundException GlacierError::GetModeledError() {
  assert(this->GetErrorType() == GlacierErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_GLACIER_API InsufficientCapacityException GlacierError::GetModeledError() {
...
template <>
AWS_GLACIER_API MissingParameterValueException GlacierError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == NO_LONGER_SUPPORTED_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(GlacierErrors::LIMIT_EXCEEDED), RetryableType::RETRYABLE_THROTTLING);
