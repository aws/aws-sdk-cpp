 ...
 * following sections in the <i>Amazon Glacier Developer Guide</i>:</p> <ul> <li>
 * <p> <a
...
class AWS_GLACIER_API GlacierClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  GlacierClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<GlacierEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for AbortVaultLock that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AbortVaultLockRequestT = Model::AbortVaultLockRequest>
  void AbortVaultLockAsync(const AbortVaultLockRequestT& request, const AbortVaultLockResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AddTagsToVault that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddTagsToVaultRequestT = Model::AddTagsToVaultRequest>
  void AddTagsToVaultAsync(const AddTagsToVaultRequestT& request, const AddTagsToVaultResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&GlacierClient::AddTagsToVault, request, handler, context);
  }

  /**
   * <p>You call this operation to inform Amazon Glacier (Glacier) that all the
  ...
  /**
   * A Callable wrapper for CompleteVaultLock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CompleteVaultLock that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CompleteVaultLockRequestT = Model::CompleteVaultLockRequest>
  void CompleteVaultLockAsync(const CompleteVaultLockRequestT& request, const CompleteVaultLockResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateVault that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateVaultRequestT = Model::CreateVaultRequest>
  void CreateVaultAsync(const CreateVaultRequestT& request, const CreateVaultResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteVault that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteVaultRequestT = Model::DeleteVaultRequest>
  void DeleteVaultAsync(const DeleteVaultRequestT& request, const DeleteVaultResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteVaultAccessPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteVaultAccessPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteVaultAccessPolicyRequestT = Model::DeleteVaultAccessPolicyRequest>
  void DeleteVaultAccessPolicyAsync(const DeleteVaultAccessPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteVaultNotifications that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteVaultNotifications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteVaultNotificationsRequestT = Model::DeleteVaultNotificationsRequest>
  void DeleteVaultNotificationsAsync(const DeleteVaultNotificationsRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeVault that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeVaultRequestT = Model::DescribeVaultRequest>
  void DescribeVaultAsync(const DescribeVaultRequestT& request, const DescribeVaultResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataRetrievalPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataRetrievalPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDataRetrievalPolicyRequestT = Model::GetDataRetrievalPolicyRequest>
  void GetDataRetrievalPolicyAsync(const GetDataRetrievalPolicyRequestT& request,
   ...
   * depending on the byte range you specify, Amazon Glacier (Glacier) returns the
   ...
   * archive when you uploaded it to Amazon Glacier The expected size is also
  ...
  /**
   * An Async wrapper for GetJobOutput that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetJobOutputRequestT = Model::GetJobOutputRequest>
  void GetJobOutputAsync(const GetJobOutputRequestT& request, const GetJobOutputResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetVaultAccessPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetVaultAccessPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetVaultAccessPolicyRequestT = Model::GetVaultAccessPolicyRequest>
  void GetVaultAccessPolicyAsync(const GetVaultAccessPolicyRequestT& request, const GetVaultAccessPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetVaultLock that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetVaultLockRequestT = Model::GetVaultLockRequest>
  void GetVaultLockAsync(const GetVaultLockRequestT& request, const GetVaultLockResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetVaultNotifications that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetVaultNotifications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetVaultNotificationsRequestT = Model::GetVaultNotificationsRequest>
  void GetVaultNotificationsAsync(const GetVaultNotificationsRequestT& request, const GetVaultNotificationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for InitiateJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename InitiateJobRequestT = Model::InitiateJobRequest>
  void InitiateJobAsync(const InitiateJobRequestT& request, const InitiateJobResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Amazon Glacier (Glacier) removes the multipart upload resource referenced by the
   * ID. Glacier also removes the multipart upload resource if you cancel the
  ...
  /**
   * A Callable wrapper for InitiateMultipartUpload that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for InitiateMultipartUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename InitiateMultipartUploadRequestT = Model::InitiateMultipartUploadRequest>
  void InitiateMultipartUploadAsync(const InitiateMultipartUploadRequestT& request,
  ...
  /**
   * A Callable wrapper for InitiateVaultLock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for InitiateVaultLock that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename InitiateVaultLockRequestT = Model::InitiateVaultLockRequest>
  void InitiateVaultLockAsync(const InitiateVaultLockRequestT& request, const InitiateVaultLockResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProvisionedCapacity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProvisionedCapacity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProvisionedCapacityRequestT = Model::ListProvisionedCapacityRequest>
  void ListProvisionedCapacityAsync(const ListProvisionedCapacityRequestT& request,
  ...
  /**
   * A Callable wrapper for ListTagsForVault that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTagsForVault that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTagsForVaultRequestT = Model::ListTagsForVaultRequest>
  void ListTagsForVaultAsync(const ListTagsForVaultRequestT& request, const ListTagsForVaultResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListVaults that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListVaultsRequestT = Model::ListVaultsRequest>
  void ListVaultsAsync(const ListVaultsRequestT& request, const ListVaultsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PurchaseProvisionedCapacityOutcome PurchaseProvisionedCapacity(
      const Model::PurchaseProvisionedCapacityRequest& request) const;

  /**
   * A Callable wrapper for PurchaseProvisionedCapacity that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PurchaseProvisionedCapacityRequestT = Model::PurchaseProvisionedCapacityRequest>
  Model::PurchaseProvisionedCapacityOutcomeCallable PurchaseProvisionedCapacityCallable(
      const PurchaseProvisionedCapacityRequestT& request) const {
    return SubmitCallable(&GlacierClient::PurchaseProvisionedCapacity, request);
  }

  /**
   * An Async wrapper for PurchaseProvisionedCapacity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PurchaseProvisionedCapacityRequestT = Model::PurchaseProvisionedCapacityRequest>
  void PurchaseProvisionedCapacityAsync(const PurchaseProvisionedCapacityRequestT& request,
  ...
  /**
   * A Callable wrapper for RemoveTagsFromVault that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveTagsFromVault that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RemoveTagsFromVaultRequestT = Model::RemoveTagsFromVaultRequest>
  void RemoveTagsFromVaultAsync(const RemoveTagsFromVaultRequestT& request, const RemoveTagsFromVaultResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetDataRetrievalPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetDataRetrievalPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetDataRetrievalPolicyRequestT = Model::SetDataRetrievalPolicyRequest>
  void SetDataRetrievalPolicyAsync(const SetDataRetrievalPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for SetVaultAccessPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetVaultAccessPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetVaultAccessPolicyRequestT = Model::SetVaultAccessPolicyRequest>
  void SetVaultAccessPolicyAsync(const SetVaultAccessPolicyRequestT& request, const SetVaultAccessPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetVaultNotifications that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetVaultNotifications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetVaultNotificationsRequestT = Model::SetVaultNotificationsRequest>
  void SetVaultNotificationsAsync(const SetVaultNotificationsRequestT& request, const SetVaultNotificationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UploadArchive that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UploadArchiveRequestT = Model::UploadArchiveRequest>
  void UploadArchiveAsync(const UploadArchiveRequestT& request, const UploadArchiveResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UploadMultipartPart that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UploadMultipartPart that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UploadMultipartPartRequestT = Model::UploadMultipartPartRequest>
  void UploadMultipartPartAsync(const UploadMultipartPartRequestT& request, const UploadMultipartPartResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
