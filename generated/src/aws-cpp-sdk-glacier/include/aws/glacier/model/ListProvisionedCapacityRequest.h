...
namespace Model
{
  ...
  /**
   */
  class ListProvisionedCapacityRequest : public GlacierRequest
  {
  public:
    AWS_GLACIER_API ListProvisionedCapacityRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    ListProvisionedCapacityRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
  private:
