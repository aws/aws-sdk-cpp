...
class ListProvisionedCapacityResult {
 public:
  ...
  void SetProvisionedCapacityList(ProvisionedCapacityListT&& value) {
    m_provisionedCapacityListHasBeenSet = true;
    m_provisionedCapacityList = std::forward<ProvisionedCapacityListT>(value);
  }
  template <typename ProvisionedCapacityListT = Aws::Vector<ProvisionedCapacityDescription>>
  ListProvisionedCapacityResult& WithProvisionedCapacityList(ProvisionedCapacityListT&& value) {
    SetProvisionedCapacityList(std::forward<ProvisionedCapacityListT>(value));
    return *this;
  }
  template <typename ProvisionedCapacityListT = ProvisionedCapacityDescription>
  ListProvisionedCapacityResult& AddProvisionedCapacityList(ProvisionedCapacityListT&& value) {
    m_provisionedCapacityListHasBeenSet = true;
    m_provisionedCapacityList.emplace_back(std::forward<ProvisionedCapacityListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListProvisionedCapacityResult& WithRequestId(RequestIdT&& value) {
