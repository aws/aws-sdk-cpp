...
class RemoveTagsFromVaultRequest : public GlacierRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  RemoveTagsFromVaultRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename VaultNameT = Aws::String>
  RemoveTagsFromVaultRequest& WithVaultName(VaultNameT&& value) {
  ...
  template <typename TagKeysT = Aws::Vector<Aws::String>>
  RemoveTagsFromVaultRequest& WithTagKeys(TagKeysT&& value) {
    SetTagKeys(std::forward<TagKeysT>(value));
    return *this;
  }
  template <typename TagKeysT = Aws::String>
  RemoveTagsFromVaultRequest& AddTagKeys(TagKeysT&& value) {
    m_tagKeysHasBeenSet = true;
