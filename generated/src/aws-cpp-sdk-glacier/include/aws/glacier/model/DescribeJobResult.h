...
class DescribeJobResult {
 public:
  ...
  inline DescribeJobResult& WithAction(ActionCode value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeJobResult& WithCompleted(bool value) {
    SetCompleted(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeJobResult& WithStatusCode(StatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeJobResult& WithArchiveSizeInBytes(long long value) {
  ...
  inline DescribeJobResult& WithInventorySizeInBytes(long long value) {
