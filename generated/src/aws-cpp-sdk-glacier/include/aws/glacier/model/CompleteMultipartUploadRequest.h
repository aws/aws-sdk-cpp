...
class CompleteMultipartUploadRequest : public GlacierRequest {
 public:
  ...
  void SetArchiveSize(ArchiveSizeT&& value) {
    m_archiveSizeHasBeenSet = true;
    m_archiveSize = std::forward<ArchiveSizeT>(value);
  }
  template <typename ArchiveSizeT = Aws::String>
  CompleteMultipartUploadRequest& WithArchiveSize(ArchiveSizeT&& value) {
    SetArchiveSize(std::forward<ArchiveSizeT>(value));
    return *this;
  }
  ///@}
