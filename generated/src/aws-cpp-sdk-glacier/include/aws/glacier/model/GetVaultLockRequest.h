...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetVaultLockRequest : public GlacierRequest
  {
  public:
    AWS_GLACIER_API GetVaultLockRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    GetVaultLockRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VaultNameT = Aws::String>
    GetVaultLockRequest& WithVaultName(VaultNameT&& value) { SetVaultName(std::forward<VaultNameT>(value)); return *this;}
    ///@}
  private:
