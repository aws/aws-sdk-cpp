...
/**
 * <p>Provides options for deleting a vault from Amazon Glacier.</p><p><h3>See
 * Also:</h3>   <a
...
class DeleteVaultRequest : public GlacierRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  DeleteVaultRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename VaultNameT = Aws::String>
  DeleteVaultRequest& WithVaultName(VaultNameT&& value) {
