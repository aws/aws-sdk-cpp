...
namespace Model
{
  ...
  {
  public:
    AWS_GLACIER_API DeleteVaultRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    DeleteVaultRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VaultNameT = Aws::String>
    DeleteVaultRequest& WithVaultName(VaultNameT&& value) { SetVaultName(std::forward<VaultNameT>(value)); return *this;}
    ///@}
  private:
