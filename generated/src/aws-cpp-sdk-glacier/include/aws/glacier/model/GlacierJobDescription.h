...
class GlacierJobDescription {
 public:
  ...
  inline void SetAction(ActionCode value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline GlacierJobDescription& WithAction(ActionCode value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetVaultARN(VaultARNT&& value) {
    ...
    m_vaultARN = std::forward<VaultARNT>(value);
  }
  template <typename VaultARNT = Aws::String>
  GlacierJobDescription& WithVaultARN(VaultARNT&& value) {
    SetVaultARN(std::forward<VaultARNT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCompleted(bool value) {
    m_completedHasBeenSet = true;
    m_completed = value;
  }
  inline GlacierJobDescription& WithCompleted(bool value) {
    SetCompleted(value);
    return *this;
  }
  ///@}
  ...
  inline GlacierJobDescription& WithStatusCode(StatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetArchiveSizeInBytes(long long value) {
    m_archiveSizeInBytesHasBeenSet = true;
    m_archiveSizeInBytes = value;
  }
  inline GlacierJobDescription& WithArchiveSizeInBytes(long long value) {
    SetArchiveSizeInBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInventorySizeInBytes(long long value) {
    m_inventorySizeInBytesHasBeenSet = true;
    m_inventorySizeInBytes = value;
  }
  inline GlacierJobDescription& WithInventorySizeInBytes(long long value) {
    SetInventorySizeInBytes(value);
    return *this;
  }
  ///@}
  ...
  void SetArchiveSHA256TreeHash(ArchiveSHA256TreeHashT&& value) {
    ...
    m_archiveSHA256TreeHash = std::forward<ArchiveSHA256TreeHashT>(value);
  }
  template <typename ArchiveSHA256TreeHashT = Aws::String>
  GlacierJobDescription& WithArchiveSHA256TreeHash(ArchiveSHA256TreeHashT&& value) {
    SetArchiveSHA256TreeHash(std::forward<ArchiveSHA256TreeHashT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRetrievalByteRange(RetrievalByteRangeT&& value) {
    ...
    m_retrievalByteRange = std::forward<RetrievalByteRangeT>(value);
  }
  template <typename RetrievalByteRangeT = Aws::String>
  GlacierJobDescription& WithRetrievalByteRange(RetrievalByteRangeT&& value) {
    SetRetrievalByteRange(std::forward<RetrievalByteRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInventoryRetrievalParameters(InventoryRetrievalParametersT&& value) {
    ...
    m_inventoryRetrievalParameters = std::forward<InventoryRetrievalParametersT>(value);
  }
  template <typename InventoryRetrievalParametersT = InventoryRetrievalJobDescription>
  GlacierJobDescription& WithInventoryRetrievalParameters(InventoryRetrievalParametersT&& value) {
    SetInventoryRetrievalParameters(std::forward<InventoryRetrievalParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobOutputPath(JobOutputPathT&& value) {
    ...
    m_jobOutputPath = std::forward<JobOutputPathT>(value);
  }
  template <typename JobOutputPathT = Aws::String>
  GlacierJobDescription& WithJobOutputPath(JobOutputPathT&& value) {
    SetJobOutputPath(std::forward<JobOutputPathT>(value));
    return *this;
  }
  ///@}
