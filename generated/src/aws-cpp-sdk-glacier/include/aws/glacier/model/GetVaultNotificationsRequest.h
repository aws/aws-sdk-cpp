...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetVaultNotificationsRequest : public GlacierRequest
  {
  public:
    AWS_GLACIER_API GetVaultNotificationsRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    GetVaultNotificationsRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VaultNameT = Aws::String>
    GetVaultNotificationsRequest& WithVaultName(VaultNameT&& value) { SetVaultName(std::forward<VaultNameT>(value)); return *this;}
    ///@}
  private:
