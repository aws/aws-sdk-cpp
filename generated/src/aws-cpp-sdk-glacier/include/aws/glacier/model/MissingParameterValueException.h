...
class MissingParameterValueException {
 public:
  ...
  template <typename TypeT = Aws::String>
  MissingParameterValueException& WithType(TypeT&& value) {
  ...
  template <typename CodeT = Aws::String>
  MissingParameterValueException& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  MissingParameterValueException& WithMessage(MessageT&& value) {
