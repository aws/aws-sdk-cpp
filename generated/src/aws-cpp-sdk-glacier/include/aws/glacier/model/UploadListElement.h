...
class UploadListElement {
 public:
  ...
  void SetMultipartUploadId(MultipartUploadIdT&& value) {
    ...
    m_multipartUploadId = std::forward<MultipartUploadIdT>(value);
  }
  template <typename MultipartUploadIdT = Aws::String>
  UploadListElement& WithMultipartUploadId(MultipartUploadIdT&& value) {
    SetMultipartUploadId(std::forward<MultipartUploadIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPartSizeInBytes(long long value) {
    m_partSizeInBytesHasBeenSet = true;
    m_partSizeInBytes = value;
  }
  inline UploadListElement& WithPartSizeInBytes(long long value) {
    SetPartSizeInBytes(value);
    return *this;
  }
  ///@}
