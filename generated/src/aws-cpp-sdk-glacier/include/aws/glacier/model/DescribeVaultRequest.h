...
namespace Model
{
  ...
  {
  public:
    AWS_GLACIER_API DescribeVaultRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    DescribeVaultRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VaultNameT = Aws::String>
    DescribeVaultRequest& WithVaultName(VaultNameT&& value) { SetVaultName(std::forward<VaultNameT>(value)); return *this;}
    ///@}
  private:
