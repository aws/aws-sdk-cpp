...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DeleteVaultNotificationsRequest : public GlacierRequest
  {
  public:
    AWS_GLACIER_API DeleteVaultNotificationsRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    DeleteVaultNotificationsRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VaultNameT = Aws::String>
    DeleteVaultNotificationsRequest& WithVaultName(VaultNameT&& value) { SetVaultName(std::forward<VaultNameT>(value)); return *this;}
    ///@}
  private:
