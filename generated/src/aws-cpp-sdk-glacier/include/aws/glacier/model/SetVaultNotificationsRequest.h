...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class SetVaultNotificationsRequest : public GlacierRequest
  {
  public:
    ...
    template<typename AccountIdT = Aws::String>
    SetVaultNotificationsRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VaultNameT = Aws::String>
    SetVaultNotificationsRequest& WithVaultName(VaultNameT&& value) { SetVaultName(std::forward<VaultNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VaultNotificationConfigT = VaultNotificationConfig>
    SetVaultNotificationsRequest& WithVaultNotificationConfig(VaultNotificationConfigT&& value) { SetVaultNotificationConfig(std::forward<VaultNotificationConfigT>(value)); return *this;}
    ///@}
  private:
