...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetVaultAccessPolicyRequest : public GlacierRequest
  {
  public:
    AWS_GLACIER_API GetVaultAccessPolicyRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    GetVaultAccessPolicyRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VaultNameT = Aws::String>
    GetVaultAccessPolicyRequest& WithVaultName(VaultNameT&& value) { SetVaultName(std::forward<VaultNameT>(value)); return *this;}
    ///@}
  private:
