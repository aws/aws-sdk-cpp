...
{
const size_t DevOpsGuruEndpointRules::RulesBlobStrLen = 3744;
const size_t DevOpsGuruEndpointRules::RulesBlobSize = 3745;
...
't','p','s',':','/','/','d','e','v','o','p','s','-','g','u','r','u','-','f','i','p','s','.','{','R',
...
'p','s',':','/','/','d','e','v','o','p','s','-','g','u','r','u','.','{','R','e','g','i','o','n','}',
