...
AnomalySourceDetails::AnomalySourceDetails(JsonView jsonValue) { *this = jsonValue; }
...
AnomalySourceDetails& AnomalySourceDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("PerformanceInsightsMetrics")) {
    ...
    for (unsigned performanceInsightsMetricsIndex = 0; performanceInsightsMetricsIndex < performanceInsightsMetricsJsonList.GetLength();
         ++performanceInsightsMetricsIndex) {
...
JsonValue AnomalySourceDetails::Jsonize() const {
  ...
  if (m_performanceInsightsMetricsHasBeenSet) {
    ...
    for (unsigned performanceInsightsMetricsIndex = 0; performanceInsightsMetricsIndex < performanceInsightsMetricsJsonList.GetLength();
         ++performanceInsightsMetricsIndex) {
      performanceInsightsMetricsJsonList[performanceInsightsMetricsIndex].AsObject(
          m_performanceInsightsMetrics[performanceInsightsMetricsIndex].Jsonize());
    }
