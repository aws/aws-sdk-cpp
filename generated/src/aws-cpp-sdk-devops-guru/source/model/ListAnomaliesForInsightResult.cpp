...
ListAnomaliesForInsightResult::ListAnomaliesForInsightResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListAnomaliesForInsightResult& ListAnomaliesForInsightResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ProactiveAnomalies")) {
    ...
    for (unsigned proactiveAnomaliesIndex = 0; proactiveAnomaliesIndex < proactiveAnomaliesJsonList.GetLength();
         ++proactiveAnomaliesIndex) {
