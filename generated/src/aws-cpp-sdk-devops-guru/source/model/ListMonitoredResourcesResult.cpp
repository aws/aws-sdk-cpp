...
ListMonitoredResourcesResult::ListMonitoredResourcesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListMonitoredResourcesResult& ListMonitoredResourcesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("MonitoredResourceIdentifiers")) {
    ...
    for (unsigned monitoredResourceIdentifiersIndex = 0;
         monitoredResourceIdentifiersIndex < monitoredResourceIdentifiersJsonList.GetLength(); ++monitoredResourceIdentifiersIndex) {
      m_monitoredResourceIdentifiers.push_back(monitoredResourceIdentifiersJsonList[monitoredResourceIdentifiersIndex].AsObject());
    }
    m_monitoredResourceIdentifiersHasBeenSet = true;
  }
