...
TagCollection::TagCollection(JsonView jsonValue) { *this = jsonValue; }

TagCollection& TagCollection::operator=(JsonView jsonValue) {
...
JsonValue TagCollection::Jsonize() const {
  JsonValue payload;
