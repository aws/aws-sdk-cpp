...
namespace Model
{
  ...
  {
  public:
    AWS_DEVOPSGURU_API UpdateServiceIntegrationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateServiceIntegrationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
