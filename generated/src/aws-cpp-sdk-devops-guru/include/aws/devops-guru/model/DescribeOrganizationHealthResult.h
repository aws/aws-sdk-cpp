...
class DescribeOrganizationHealthResult {
 public:
  ...
  inline DescribeOrganizationHealthResult& WithOpenReactiveInsights(int value) {
  ...
  inline DescribeOrganizationHealthResult& WithOpenProactiveInsights(int value) {
  ...
  inline DescribeOrganizationHealthResult& WithMetricsAnalyzed(int value) {
  ...
  inline DescribeOrganizationHealthResult& WithResourceHours(long long value) {
