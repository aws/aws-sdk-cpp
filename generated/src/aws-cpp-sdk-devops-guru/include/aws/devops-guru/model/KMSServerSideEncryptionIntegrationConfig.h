 ...
 * data using KMS. </p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-guru-2020-12-01/KMSServerSideEncryptionIntegrationConfig">AWS
 * API Reference</a></p>
 */
class KMSServerSideEncryptionIntegrationConfig {
 public:
  ...
  template <typename KMSKeyIdT = Aws::String>
  KMSServerSideEncryptionIntegrationConfig& WithKMSKeyId(KMSKeyIdT&& value) {
  ...
  inline void SetOptInStatus(OptInStatus value) {
    m_optInStatusHasBeenSet = true;
    m_optInStatus = value;
  }
  inline KMSServerSideEncryptionIntegrationConfig& WithOptInStatus(OptInStatus value) {
    SetOptInStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(ServerSideEncryptionType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline KMSServerSideEncryptionIntegrationConfig& WithType(ServerSideEncryptionType value) {
    SetType(value);
    return *this;
  }
  ///@}
