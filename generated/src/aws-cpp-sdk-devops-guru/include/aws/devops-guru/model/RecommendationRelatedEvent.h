...
class RecommendationRelatedEvent {
 public:
  ...
  template <typename NameT = Aws::String>
  RecommendationRelatedEvent& WithName(NameT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<RecommendationRelatedEventResource>>
  RecommendationRelatedEvent& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = RecommendationRelatedEventResource>
  RecommendationRelatedEvent& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
