...
class DescribeResourceCollectionHealthRequest : public DevOpsGuruRequest {
 public:
  ...
  inline void SetResourceCollectionType(ResourceCollectionType value) {
    m_resourceCollectionTypeHasBeenSet = true;
    m_resourceCollectionType = value;
  }
  inline DescribeResourceCollectionHealthRequest& WithResourceCollectionType(ResourceCollectionType value) {
    SetResourceCollectionType(value);
    return *this;
  }
  ///@}
