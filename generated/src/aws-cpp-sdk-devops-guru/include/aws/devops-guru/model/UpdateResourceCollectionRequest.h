...
class UpdateResourceCollectionRequest : public DevOpsGuruRequest {
 public:
  ...
  inline void SetAction(UpdateResourceCollectionAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline UpdateResourceCollectionRequest& WithAction(UpdateResourceCollectionAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceCollectionT = UpdateResourceCollectionFilter>
  UpdateResourceCollectionRequest& WithResourceCollection(ResourceCollectionT&& value) {
