...
class LogAnomalyClass {
 public:
  ...
  inline void SetLogAnomalyType(LogAnomalyType value) {
    m_logAnomalyTypeHasBeenSet = true;
    m_logAnomalyType = value;
  }
  inline LogAnomalyClass& WithLogAnomalyType(LogAnomalyType value) {
    SetLogAnomalyType(value);
    return *this;
  }
  ///@}
  ...
  void SetLogAnomalyToken(LogAnomalyTokenT&& value) {
    ...
    m_logAnomalyToken = std::forward<LogAnomalyTokenT>(value);
  }
  template <typename LogAnomalyTokenT = Aws::String>
  LogAnomalyClass& WithLogAnomalyToken(LogAnomalyTokenT&& value) {
    SetLogAnomalyToken(std::forward<LogAnomalyTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLogEventId(LogEventIdT&& value) {
    ...
    m_logEventId = std::forward<LogEventIdT>(value);
  }
  template <typename LogEventIdT = Aws::String>
  LogAnomalyClass& WithLogEventId(LogEventIdT&& value) {
    SetLogEventId(std::forward<LogEventIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfLogLinesOccurrences(int value) {
    m_numberOfLogLinesOccurrencesHasBeenSet = true;
    m_numberOfLogLinesOccurrences = value;
  }
  inline LogAnomalyClass& WithNumberOfLogLinesOccurrences(int value) {
    SetNumberOfLogLinesOccurrences(value);
    return *this;
  }
  ///@}
  ...
  void SetLogEventTimestamp(LogEventTimestampT&& value) {
    ...
    m_logEventTimestamp = std::forward<LogEventTimestampT>(value);
  }
  template <typename LogEventTimestampT = Aws::Utils::DateTime>
  LogAnomalyClass& WithLogEventTimestamp(LogEventTimestampT&& value) {
    SetLogEventTimestamp(std::forward<LogEventTimestampT>(value));
    return *this;
  }
  ///@}
 private:
