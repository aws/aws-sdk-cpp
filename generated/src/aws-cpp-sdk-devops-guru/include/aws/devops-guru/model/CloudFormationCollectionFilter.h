...
class CloudFormationCollectionFilter {
 public:
  AWS_DEVOPSGURU_API CloudFormationCollectionFilter() = default;
  ...
  void SetStackNames(StackNamesT&& value) {
    m_stackNamesHasBeenSet = true;
    m_stackNames = std::forward<StackNamesT>(value);
  }
  template <typename StackNamesT = Aws::Vector<Aws::String>>
  CloudFormationCollectionFilter& WithStackNames(StackNamesT&& value) {
    SetStackNames(std::forward<StackNamesT>(value));
    return *this;
  }
  template <typename StackNamesT = Aws::String>
  CloudFormationCollectionFilter& AddStackNames(StackNamesT&& value) {
    m_stackNamesHasBeenSet = true;
    m_stackNames.emplace_back(std::forward<StackNamesT>(value));
    return *this;
  }
  ///@}
 private:
