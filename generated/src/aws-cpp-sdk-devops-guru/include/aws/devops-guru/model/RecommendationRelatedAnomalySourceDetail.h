...
class RecommendationRelatedAnomalySourceDetail {
 public:
  ...
  void SetCloudWatchMetrics(CloudWatchMetricsT&& value) {
    m_cloudWatchMetricsHasBeenSet = true;
    m_cloudWatchMetrics = std::forward<CloudWatchMetricsT>(value);
  }
  template <typename CloudWatchMetricsT = Aws::Vector<RecommendationRelatedCloudWatchMetricsSourceDetail>>
  RecommendationRelatedAnomalySourceDetail& WithCloudWatchMetrics(CloudWatchMetricsT&& value) {
    SetCloudWatchMetrics(std::forward<CloudWatchMetricsT>(value));
    return *this;
  }
  template <typename CloudWatchMetricsT = RecommendationRelatedCloudWatchMetricsSourceDetail>
  RecommendationRelatedAnomalySourceDetail& AddCloudWatchMetrics(CloudWatchMetricsT&& value) {
    m_cloudWatchMetricsHasBeenSet = true;
    m_cloudWatchMetrics.emplace_back(std::forward<CloudWatchMetricsT>(value));
    return *this;
  }
  ///@}
 private:
