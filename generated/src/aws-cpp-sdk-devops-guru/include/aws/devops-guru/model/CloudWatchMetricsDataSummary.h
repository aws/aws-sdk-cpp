...
class CloudWatchMetricsDataSummary {
 public:
  ...
  void SetTimestampMetricValuePairList(TimestampMetricValuePairListT&& value) {
    m_timestampMetricValuePairListHasBeenSet = true;
    m_timestampMetricValuePairList = std::forward<TimestampMetricValuePairListT>(value);
  }
  template <typename TimestampMetricValuePairListT = Aws::Vector<TimestampMetricValuePair>>
  CloudWatchMetricsDataSummary& WithTimestampMetricValuePairList(TimestampMetricValuePairListT&& value) {
    SetTimestampMetricValuePairList(std::forward<TimestampMetricValuePairListT>(value));
    return *this;
  }
  template <typename TimestampMetricValuePairListT = TimestampMetricValuePair>
  CloudWatchMetricsDataSummary& AddTimestampMetricValuePairList(TimestampMetricValuePairListT&& value) {
    m_timestampMetricValuePairListHasBeenSet = true;
    m_timestampMetricValuePairList.emplace_back(std::forward<TimestampMetricValuePairListT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatusCode(CloudWatchMetricDataStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline CloudWatchMetricsDataSummary& WithStatusCode(CloudWatchMetricDataStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
