...
class ListInsightsClosedStatusFilter {
 public:
  ...
  inline ListInsightsClosedStatusFilter& WithType(InsightType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetEndTimeRange(EndTimeRangeT&& value) {
    m_endTimeRangeHasBeenSet = true;
    m_endTimeRange = std::forward<EndTimeRangeT>(value);
  }
  template <typename EndTimeRangeT = EndTimeRange>
  ListInsightsClosedStatusFilter& WithEndTimeRange(EndTimeRangeT&& value) {
    SetEndTimeRange(std::forward<EndTimeRangeT>(value));
    return *this;
  }
  ///@}
 private:
