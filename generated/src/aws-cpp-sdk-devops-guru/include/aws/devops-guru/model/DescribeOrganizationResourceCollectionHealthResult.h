...
class DescribeOrganizationResourceCollectionHealthResult {
 public:
  ...
  AWS_DEVOPSGURU_API DescribeOrganizationResourceCollectionHealthResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename CloudFormationT = Aws::Vector<CloudFormationHealth>>
  DescribeOrganizationResourceCollectionHealthResult& WithCloudFormation(CloudFormationT&& value) {
    SetCloudFormation(std::forward<CloudFormationT>(value));
    return *this;
  }
  template <typename CloudFormationT = CloudFormationHealth>
  DescribeOrganizationResourceCollectionHealthResult& AddCloudFormation(CloudFormationT&& value) {
    m_cloudFormationHasBeenSet = true;
  ...
  template <typename ServiceT = Aws::Vector<ServiceHealth>>
  DescribeOrganizationResourceCollectionHealthResult& WithService(ServiceT&& value) {
    SetService(std::forward<ServiceT>(value));
    return *this;
  }
  template <typename ServiceT = ServiceHealth>
  DescribeOrganizationResourceCollectionHealthResult& AddService(ServiceT&& value) {
    m_serviceHasBeenSet = true;
  ...
  template <typename AccountT = Aws::Vector<AccountHealth>>
  DescribeOrganizationResourceCollectionHealthResult& WithAccount(AccountT&& value) {
    SetAccount(std::forward<AccountT>(value));
    return *this;
  }
  template <typename AccountT = AccountHealth>
  DescribeOrganizationResourceCollectionHealthResult& AddAccount(AccountT&& value) {
    m_accountHasBeenSet = true;
    m_account.emplace_back(std::forward<AccountT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeOrganizationResourceCollectionHealthResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<TagHealth>>
  DescribeOrganizationResourceCollectionHealthResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = TagHealth>
  DescribeOrganizationResourceCollectionHealthResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeOrganizationResourceCollectionHealthResult& WithRequestId(RequestIdT&& value) {
