...
class PerformanceInsightsReferenceData {
 public:
  ...
  template <typename NameT = Aws::String>
  PerformanceInsightsReferenceData& WithName(NameT&& value) {
  ...
  void SetComparisonValues(ComparisonValuesT&& value) {
    m_comparisonValuesHasBeenSet = true;
    m_comparisonValues = std::forward<ComparisonValuesT>(value);
  }
  template <typename ComparisonValuesT = PerformanceInsightsReferenceComparisonValues>
  PerformanceInsightsReferenceData& WithComparisonValues(ComparisonValuesT&& value) {
    SetComparisonValues(std::forward<ComparisonValuesT>(value));
    return *this;
  }
  ///@}
 private:
