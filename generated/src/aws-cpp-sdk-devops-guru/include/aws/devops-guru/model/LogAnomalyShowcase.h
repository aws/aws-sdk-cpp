...
class LogAnomalyShowcase {
 public:
  ...
  void SetLogAnomalyClasses(LogAnomalyClassesT&& value) {
    m_logAnomalyClassesHasBeenSet = true;
    m_logAnomalyClasses = std::forward<LogAnomalyClassesT>(value);
  }
  template <typename LogAnomalyClassesT = Aws::Vector<LogAnomalyClass>>
  LogAnomalyShowcase& WithLogAnomalyClasses(LogAnomalyClassesT&& value) {
    SetLogAnomalyClasses(std::forward<LogAnomalyClassesT>(value));
    return *this;
  }
  template <typename LogAnomalyClassesT = LogAnomalyClass>
  LogAnomalyShowcase& AddLogAnomalyClasses(LogAnomalyClassesT&& value) {
    m_logAnomalyClassesHasBeenSet = true;
    m_logAnomalyClasses.emplace_back(std::forward<LogAnomalyClassesT>(value));
    return *this;
  }
  ///@}
 private:
