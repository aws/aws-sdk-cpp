...
namespace Model
{
  ...
  public:
    ...
    template<typename FiltersT = ListEventsFilters>
    ListEventsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    ///@}
    ...
    template<typename AccountIdT = Aws::String>
    ListEventsRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
  private:
