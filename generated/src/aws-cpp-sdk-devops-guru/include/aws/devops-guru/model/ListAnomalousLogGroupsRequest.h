...
class ListAnomalousLogGroupsRequest : public DevOpsGuruRequest {
 public:
  AWS_DEVOPSGURU_API ListAnomalousLogGroupsRequest() = default;
  ...
  template <typename InsightIdT = Aws::String>
  ListAnomalousLogGroupsRequest& WithInsightId(InsightIdT&& value) {
  ...
  inline ListAnomalousLogGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnomalousLogGroupsRequest& WithNextToken(NextTokenT&& value) {
