...
class AnomalySourceMetadata {
 public:
  ...
  template <typename SourceT = Aws::String>
  AnomalySourceMetadata& WithSource(SourceT&& value) {
  ...
  template <typename SourceResourceNameT = Aws::String>
  AnomalySourceMetadata& WithSourceResourceName(SourceResourceNameT&& value) {
  ...
  void SetSourceResourceType(SourceResourceTypeT&& value) {
    m_sourceResourceTypeHasBeenSet = true;
    m_sourceResourceType = std::forward<SourceResourceTypeT>(value);
  }
  template <typename SourceResourceTypeT = Aws::String>
  AnomalySourceMetadata& WithSourceResourceType(SourceResourceTypeT&& value) {
    SetSourceResourceType(std::forward<SourceResourceTypeT>(value));
    return *this;
  }
  ///@}
 private:
