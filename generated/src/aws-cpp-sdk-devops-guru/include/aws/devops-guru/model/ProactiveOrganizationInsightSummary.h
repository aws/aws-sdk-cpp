...
class ProactiveOrganizationInsightSummary {
 public:
  ...
  inline ProactiveOrganizationInsightSummary& WithSeverity(InsightSeverity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline ProactiveOrganizationInsightSummary& WithStatus(InsightStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
