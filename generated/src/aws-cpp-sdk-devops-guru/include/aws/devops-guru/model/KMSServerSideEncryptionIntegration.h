...
class KMSServerSideEncryptionIntegration {
 public:
  ...
  template <typename KMSKeyIdT = Aws::String>
  KMSServerSideEncryptionIntegration& WithKMSKeyId(KMSKeyIdT&& value) {
  ...
  inline KMSServerSideEncryptionIntegration& WithOptInStatus(OptInStatus value) {
  ...
  inline KMSServerSideEncryptionIntegration& WithType(ServerSideEncryptionType value) {
    SetType(value);
    return *this;
  }
  ///@}
