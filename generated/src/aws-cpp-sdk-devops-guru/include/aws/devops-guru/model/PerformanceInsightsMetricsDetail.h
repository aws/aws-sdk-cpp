...
class PerformanceInsightsMetricsDetail {
 public:
  ...
  void SetMetricDisplayName(MetricDisplayNameT&& value) {
    m_metricDisplayNameHasBeenSet = true;
    m_metricDisplayName = std::forward<MetricDisplayNameT>(value);
  }
  template <typename MetricDisplayNameT = Aws::String>
  PerformanceInsightsMetricsDetail& WithMetricDisplayName(MetricDisplayNameT&& value) {
    SetMetricDisplayName(std::forward<MetricDisplayNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetricQuery(MetricQueryT&& value) {
    ...
    m_metricQuery = std::forward<MetricQueryT>(value);
  }
  template <typename MetricQueryT = PerformanceInsightsMetricQuery>
  PerformanceInsightsMetricsDetail& WithMetricQuery(MetricQueryT&& value) {
    SetMetricQuery(std::forward<MetricQueryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReferenceData(ReferenceDataT&& value) {
    m_referenceDataHasBeenSet = true;
    m_referenceData = std::forward<ReferenceDataT>(value);
  }
  template <typename ReferenceDataT = Aws::Vector<PerformanceInsightsReferenceData>>
  PerformanceInsightsMetricsDetail& WithReferenceData(ReferenceDataT&& value) {
    SetReferenceData(std::forward<ReferenceDataT>(value));
    return *this;
  }
  ...
  PerformanceInsightsMetricsDetail& AddReferenceData(ReferenceDataT&& value) {
    m_referenceDataHasBeenSet = true;
    m_referenceData.emplace_back(std::forward<ReferenceDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatsAtAnomaly(StatsAtAnomalyT&& value) {
    m_statsAtAnomalyHasBeenSet = true;
    m_statsAtAnomaly = std::forward<StatsAtAnomalyT>(value);
  }
  template <typename StatsAtAnomalyT = Aws::Vector<PerformanceInsightsStat>>
  PerformanceInsightsMetricsDetail& WithStatsAtAnomaly(StatsAtAnomalyT&& value) {
    SetStatsAtAnomaly(std::forward<StatsAtAnomalyT>(value));
    return *this;
  }
  ...
  PerformanceInsightsMetricsDetail& AddStatsAtAnomaly(StatsAtAnomalyT&& value) {
    m_statsAtAnomalyHasBeenSet = true;
    m_statsAtAnomaly.emplace_back(std::forward<StatsAtAnomalyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatsAtBaseline(StatsAtBaselineT&& value) {
    m_statsAtBaselineHasBeenSet = true;
    m_statsAtBaseline = std::forward<StatsAtBaselineT>(value);
  }
  template <typename StatsAtBaselineT = Aws::Vector<PerformanceInsightsStat>>
  PerformanceInsightsMetricsDetail& WithStatsAtBaseline(StatsAtBaselineT&& value) {
    SetStatsAtBaseline(std::forward<StatsAtBaselineT>(value));
    return *this;
  }
  ...
  PerformanceInsightsMetricsDetail& AddStatsAtBaseline(StatsAtBaselineT&& value) {
    m_statsAtBaselineHasBeenSet = true;
    m_statsAtBaseline.emplace_back(std::forward<StatsAtBaselineT>(value));
    return *this;
  }
  ///@}
 private:
