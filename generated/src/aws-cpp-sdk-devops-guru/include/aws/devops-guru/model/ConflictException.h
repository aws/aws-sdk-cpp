...
namespace Model
{
  ...
  {
  public:
    AWS_DEVOPSGURU_API ConflictException() = default;
    ...
    ///@{
    /**
     * <p> The ID of the Amazon Web Services resource in which a conflict occurred.
     * </p>
     */
    ...
    ///@{
    /**
     * <p> The type of the Amazon Web Services resource in which a conflict occurred.
     * </p>
     */
