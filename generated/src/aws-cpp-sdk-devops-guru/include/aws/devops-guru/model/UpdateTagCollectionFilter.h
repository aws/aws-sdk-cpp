...
class UpdateTagCollectionFilter {
 public:
  ...
  template <typename AppBoundaryKeyT = Aws::String>
  UpdateTagCollectionFilter& WithAppBoundaryKey(AppBoundaryKeyT&& value) {
  ...
  template <typename TagValuesT = Aws::Vector<Aws::String>>
  UpdateTagCollectionFilter& WithTagValues(TagValuesT&& value) {
    SetTagValues(std::forward<TagValuesT>(value));
    return *this;
  }
  template <typename TagValuesT = Aws::String>
  UpdateTagCollectionFilter& AddTagValues(TagValuesT&& value) {
    m_tagValuesHasBeenSet = true;
