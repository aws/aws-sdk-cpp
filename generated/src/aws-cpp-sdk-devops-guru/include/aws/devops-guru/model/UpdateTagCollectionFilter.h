...
namespace Model
{
  ...
  {
  public:
    AWS_DEVOPSGURU_API UpdateTagCollectionFilter() = default;
    ...
    template<typename AppBoundaryKeyT = Aws::String>
    UpdateTagCollectionFilter& WithAppBoundaryKey(AppBoundaryKeyT&& value) { SetAppBoundaryKey(std::forward<AppBoundaryKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename TagValuesT = Aws::Vector<Aws::String>>
    UpdateTagCollectionFilter& WithTagValues(TagValuesT&& value) { SetTagValues(std::forward<TagValuesT>(value)); return *this;}
    template<typename TagValuesT = Aws::String>
    UpdateTagCollectionFilter& AddTagValues(TagValuesT&& value) { m_tagValuesHasBeenSet = true; m_tagValues.emplace_back(std::forward<TagValuesT>(value)); return *this; }
    ///@}
  private:
