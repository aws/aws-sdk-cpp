...
namespace Model
{
  ...
  {
  public:
    AWS_DEVOPSGURU_API StartCostEstimationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartCostEstimationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
