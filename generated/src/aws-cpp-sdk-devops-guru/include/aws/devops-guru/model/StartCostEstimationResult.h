...
namespace Model
{
  ...
  public:
    ...
    inline StartCostEstimationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartCostEstimationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartCostEstimationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
