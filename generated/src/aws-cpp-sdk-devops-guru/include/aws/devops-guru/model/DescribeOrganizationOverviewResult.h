...
class DescribeOrganizationOverviewResult {
 public:
  ...
  inline void SetReactiveInsights(int value) {
    m_reactiveInsightsHasBeenSet = true;
    m_reactiveInsights = value;
  }
  inline DescribeOrganizationOverviewResult& WithReactiveInsights(int value) {
    SetReactiveInsights(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProactiveInsights(int value) {
    m_proactiveInsightsHasBeenSet = true;
    m_proactiveInsights = value;
  }
  inline DescribeOrganizationOverviewResult& WithProactiveInsights(int value) {
    SetProactiveInsights(value);
    return *this;
  }
  ///@}
