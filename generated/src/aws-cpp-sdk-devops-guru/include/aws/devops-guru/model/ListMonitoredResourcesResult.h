...
class ListMonitoredResourcesResult {
 public:
  ...
  void SetMonitoredResourceIdentifiers(MonitoredResourceIdentifiersT&& value) {
    m_monitoredResourceIdentifiersHasBeenSet = true;
    m_monitoredResourceIdentifiers = std::forward<MonitoredResourceIdentifiersT>(value);
  }
  template <typename MonitoredResourceIdentifiersT = Aws::Vector<MonitoredResourceIdentifier>>
  ListMonitoredResourcesResult& WithMonitoredResourceIdentifiers(MonitoredResourceIdentifiersT&& value) {
    SetMonitoredResourceIdentifiers(std::forward<MonitoredResourceIdentifiersT>(value));
    return *this;
  }
  template <typename MonitoredResourceIdentifiersT = MonitoredResourceIdentifier>
  ListMonitoredResourcesResult& AddMonitoredResourceIdentifiers(MonitoredResourceIdentifiersT&& value) {
    m_monitoredResourceIdentifiersHasBeenSet = true;
    m_monitoredResourceIdentifiers.emplace_back(std::forward<MonitoredResourceIdentifiersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMonitoredResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMonitoredResourcesResult& WithRequestId(RequestIdT&& value) {
