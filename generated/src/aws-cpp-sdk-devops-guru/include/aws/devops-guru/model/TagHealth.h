...
class TagHealth {
 public:
  ...
  template <typename AppBoundaryKeyT = Aws::String>
  TagHealth& WithAppBoundaryKey(AppBoundaryKeyT&& value) {
  ...
  template <typename TagValueT = Aws::String>
  TagHealth& WithTagValue(TagValueT&& value) {
  ...
  template <typename InsightT = InsightHealth>
  TagHealth& WithInsight(InsightT&& value) {
  ...
  inline TagHealth& WithAnalyzedResourceCount(long long value) {
