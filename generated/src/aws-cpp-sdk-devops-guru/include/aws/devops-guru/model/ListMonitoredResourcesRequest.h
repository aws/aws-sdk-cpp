...
class ListMonitoredResourcesRequest : public DevOpsGuruRequest {
 public:
  AWS_DEVOPSGURU_API ListMonitoredResourcesRequest() = default;
  ...
  template <typename FiltersT = ListMonitoredResourcesFilters>
  void SetFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
    m_filters = std::forward<FiltersT>(value);
  }
  template <typename FiltersT = ListMonitoredResourcesFilters>
  ListMonitoredResourcesRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListMonitoredResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMonitoredResourcesRequest& WithNextToken(NextTokenT&& value) {
