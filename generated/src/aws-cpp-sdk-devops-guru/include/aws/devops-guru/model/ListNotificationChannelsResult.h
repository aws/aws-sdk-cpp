...
class ListNotificationChannelsResult {
 public:
  ...
  template <typename ChannelsT = Aws::Vector<NotificationChannel>>
  ListNotificationChannelsResult& WithChannels(ChannelsT&& value) {
    SetChannels(std::forward<ChannelsT>(value));
    return *this;
  }
  template <typename ChannelsT = NotificationChannel>
  ListNotificationChannelsResult& AddChannels(ChannelsT&& value) {
    m_channelsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListNotificationChannelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListNotificationChannelsResult& WithRequestId(RequestIdT&& value) {
