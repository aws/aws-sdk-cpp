...
class ServiceResourceCost {
 public:
  ...
  inline void SetState(CostEstimationServiceResourceState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ServiceResourceCost& WithState(CostEstimationServiceResourceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline ServiceResourceCost& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnitCost(double value) {
    m_unitCostHasBeenSet = true;
    m_unitCost = value;
  }
  inline ServiceResourceCost& WithUnitCost(double value) {
    SetUnitCost(value);
    return *this;
  }
  ///@}
  ...
  inline ServiceResourceCost& WithCost(double value) {
    SetCost(value);
    return *this;
  }
  ///@}
