...
class TagCollection {
 public:
  ...
  void SetAppBoundaryKey(AppBoundaryKeyT&& value) {
    m_appBoundaryKeyHasBeenSet = true;
    m_appBoundaryKey = std::forward<AppBoundaryKeyT>(value);
  }
  template <typename AppBoundaryKeyT = Aws::String>
  TagCollection& WithAppBoundaryKey(AppBoundaryKeyT&& value) {
    SetAppBoundaryKey(std::forward<AppBoundaryKeyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagValuesT = Aws::Vector<Aws::String>>
  TagCollection& WithTagValues(TagValuesT&& value) {
    SetTagValues(std::forward<TagValuesT>(value));
    return *this;
  }
  template <typename TagValuesT = Aws::String>
  TagCollection& AddTagValues(TagValuesT&& value) {
    m_tagValuesHasBeenSet = true;
