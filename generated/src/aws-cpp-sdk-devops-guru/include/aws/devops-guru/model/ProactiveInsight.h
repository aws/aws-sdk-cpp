...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    ProactiveInsight& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ProactiveInsight& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline ProactiveInsight& WithSeverity(InsightSeverity value) { SetSeverity(value); return *this;}
    ///@}
    ...
    inline ProactiveInsight& WithStatus(InsightStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename InsightTimeRangeT = InsightTimeRange>
    ProactiveInsight& WithInsightTimeRange(InsightTimeRangeT&& value) { SetInsightTimeRange(std::forward<InsightTimeRangeT>(value)); return *this;}
    ///@}
    ...
    template<typename PredictionTimeRangeT = PredictionTimeRange>
    ProactiveInsight& WithPredictionTimeRange(PredictionTimeRangeT&& value) { SetPredictionTimeRange(std::forward<PredictionTimeRangeT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceCollectionT = ResourceCollection>
    ProactiveInsight& WithResourceCollection(ResourceCollectionT&& value) { SetResourceCollection(std::forward<ResourceCollectionT>(value)); return *this;}
    ///@}
    ...
    template<typename SsmOpsItemIdT = Aws::String>
    ProactiveInsight& WithSsmOpsItemId(SsmOpsItemIdT&& value) { SetSsmOpsItemId(std::forward<SsmOpsItemIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    ProactiveInsight& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
  private:
