...
namespace Model
{
  ...
  public:
    ...
    inline UpdateEventSourcesConfigResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateEventSourcesConfigResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateEventSourcesConfigResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
