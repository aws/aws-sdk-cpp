...
namespace Model
{
  ...
  {
  public:
    AWS_DEVOPSGURU_API UpdateEventSourcesConfigResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateEventSourcesConfigResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
