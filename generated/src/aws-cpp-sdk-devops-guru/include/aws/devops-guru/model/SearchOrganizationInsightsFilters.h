...
class SearchOrganizationInsightsFilters {
 public:
  ...
  template <typename SeveritiesT = Aws::Vector<InsightSeverity>>
  SearchOrganizationInsightsFilters& WithSeverities(SeveritiesT&& value) {
    SetSeverities(std::forward<SeveritiesT>(value));
    return *this;
  }
  inline SearchOrganizationInsightsFilters& AddSeverities(InsightSeverity value) {
    m_severitiesHasBeenSet = true;
  ...
  template <typename StatusesT = Aws::Vector<InsightStatus>>
  SearchOrganizationInsightsFilters& WithStatuses(StatusesT&& value) {
    SetStatuses(std::forward<StatusesT>(value));
    return *this;
  }
  inline SearchOrganizationInsightsFilters& AddStatuses(InsightStatus value) {
    m_statusesHasBeenSet = true;
  ...
  template <typename ResourceCollectionT = ResourceCollection>
  SearchOrganizationInsightsFilters& WithResourceCollection(ResourceCollectionT&& value) {
  ...
  template <typename ServiceCollectionT = ServiceCollection>
  SearchOrganizationInsightsFilters& WithServiceCollection(ServiceCollectionT&& value) {
