...
class ListInsightsStatusFilter {
 public:
  ...
  void SetOngoing(OngoingT&& value) {
    m_ongoingHasBeenSet = true;
    m_ongoing = std::forward<OngoingT>(value);
  }
  template <typename OngoingT = ListInsightsOngoingStatusFilter>
  ListInsightsStatusFilter& WithOngoing(OngoingT&& value) {
    SetOngoing(std::forward<OngoingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClosed(ClosedT&& value) {
    m_closedHasBeenSet = true;
    m_closed = std::forward<ClosedT>(value);
  }
  template <typename ClosedT = ListInsightsClosedStatusFilter>
  ListInsightsStatusFilter& WithClosed(ClosedT&& value) {
    SetClosed(std::forward<ClosedT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AnyT = ListInsightsAnyStatusFilter>
  ListInsightsStatusFilter& WithAny(AnyT&& value) {
