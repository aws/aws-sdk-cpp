...
namespace Model
{
  ...
  public:
    ...
    inline DescribeResourceCollectionHealthResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribeResourceCollectionHealthResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribeResourceCollectionHealthResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
