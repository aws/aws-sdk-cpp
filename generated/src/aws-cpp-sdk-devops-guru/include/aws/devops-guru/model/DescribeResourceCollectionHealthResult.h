...
class DescribeResourceCollectionHealthResult {
 public:
  ...
  AWS_DEVOPSGURU_API DescribeResourceCollectionHealthResult& operator=(
  ...
  DescribeResourceCollectionHealthResult& AddCloudFormation(CloudFormationT&& value) {
    m_cloudFormationHasBeenSet = true;
    m_cloudFormation.emplace_back(std::forward<CloudFormationT>(value));
    return *this;
  }
  ///@}
  ...
  DescribeResourceCollectionHealthResult& AddService(ServiceT&& value) {
    m_serviceHasBeenSet = true;
    m_service.emplace_back(std::forward<ServiceT>(value));
    return *this;
  }
  ///@}
