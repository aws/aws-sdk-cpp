...
class CloudFormationCostEstimationResourceCollectionFilter {
 public:
  ...
  template <typename StackNamesT = Aws::Vector<Aws::String>>
  CloudFormationCostEstimationResourceCollectionFilter& WithStackNames(StackNamesT&& value) {
    SetStackNames(std::forward<StackNamesT>(value));
    return *this;
  }
  template <typename StackNamesT = Aws::String>
  CloudFormationCostEstimationResourceCollectionFilter& AddStackNames(StackNamesT&& value) {
    m_stackNamesHasBeenSet = true;
