...
class ProactiveInsightSummary {
 public:
  ...
  inline void SetSeverity(InsightSeverity value) {
    m_severityHasBeenSet = true;
    m_severity = value;
  }
  inline ProactiveInsightSummary& WithSeverity(InsightSeverity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline ProactiveInsightSummary& WithStatus(InsightStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetInsightTimeRange(InsightTimeRangeT&& value) {
    ...
    m_insightTimeRange = std::forward<InsightTimeRangeT>(value);
  }
  template <typename InsightTimeRangeT = InsightTimeRange>
  ProactiveInsightSummary& WithInsightTimeRange(InsightTimeRangeT&& value) {
    SetInsightTimeRange(std::forward<InsightTimeRangeT>(value));
    return *this;
  }
  ///@}
