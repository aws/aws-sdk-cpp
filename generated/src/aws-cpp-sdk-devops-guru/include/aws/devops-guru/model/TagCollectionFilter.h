...
class TagCollectionFilter {
 public:
  ...
  template <typename AppBoundaryKeyT = Aws::String>
  TagCollectionFilter& WithAppBoundaryKey(AppBoundaryKeyT&& value) {
  ...
  template <typename TagValuesT = Aws::Vector<Aws::String>>
  TagCollectionFilter& WithTagValues(TagValuesT&& value) {
    SetTagValues(std::forward<TagValuesT>(value));
    return *this;
  }
  template <typename TagValuesT = Aws::String>
  TagCollectionFilter& AddTagValues(TagValuesT&& value) {
    m_tagValuesHasBeenSet = true;
