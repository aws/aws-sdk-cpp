...
class ListOrganizationInsightsResult {
 public:
  ...
  void SetProactiveInsights(ProactiveInsightsT&& value) {
    ...
    m_proactiveInsights = std::forward<ProactiveInsightsT>(value);
  }
  template <typename ProactiveInsightsT = Aws::Vector<ProactiveOrganizationInsightSummary>>
  ListOrganizationInsightsResult& WithProactiveInsights(ProactiveInsightsT&& value) {
    SetProactiveInsights(std::forward<ProactiveInsightsT>(value));
    return *this;
  }
  template <typename ProactiveInsightsT = ProactiveOrganizationInsightSummary>
  ListOrganizationInsightsResult& AddProactiveInsights(ProactiveInsightsT&& value) {
    m_proactiveInsightsHasBeenSet = true;
    m_proactiveInsights.emplace_back(std::forward<ProactiveInsightsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReactiveInsights(ReactiveInsightsT&& value) {
    ...
    m_reactiveInsights = std::forward<ReactiveInsightsT>(value);
  }
  template <typename ReactiveInsightsT = Aws::Vector<ReactiveOrganizationInsightSummary>>
  ListOrganizationInsightsResult& WithReactiveInsights(ReactiveInsightsT&& value) {
    SetReactiveInsights(std::forward<ReactiveInsightsT>(value));
    return *this;
  }
  template <typename ReactiveInsightsT = ReactiveOrganizationInsightSummary>
  ListOrganizationInsightsResult& AddReactiveInsights(ReactiveInsightsT&& value) {
    m_reactiveInsightsHasBeenSet = true;
    m_reactiveInsights.emplace_back(std::forward<ReactiveInsightsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOrganizationInsightsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOrganizationInsightsResult& WithRequestId(RequestIdT&& value) {
