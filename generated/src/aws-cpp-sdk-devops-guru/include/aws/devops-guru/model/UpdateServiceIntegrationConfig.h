...
class UpdateServiceIntegrationConfig {
 public:
  ...
  void SetOpsCenter(OpsCenterT&& value) {
    ...
    m_opsCenter = std::forward<OpsCenterT>(value);
  }
  template <typename OpsCenterT = OpsCenterIntegrationConfig>
  UpdateServiceIntegrationConfig& WithOpsCenter(OpsCenterT&& value) {
    SetOpsCenter(std::forward<OpsCenterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLogsAnomalyDetection(LogsAnomalyDetectionT&& value) {
    ...
    m_logsAnomalyDetection = std::forward<LogsAnomalyDetectionT>(value);
  }
  template <typename LogsAnomalyDetectionT = LogsAnomalyDetectionIntegrationConfig>
  UpdateServiceIntegrationConfig& WithLogsAnomalyDetection(LogsAnomalyDetectionT&& value) {
    SetLogsAnomalyDetection(std::forward<LogsAnomalyDetectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKMSServerSideEncryption(KMSServerSideEncryptionT&& value) {
    ...
    m_kMSServerSideEncryption = std::forward<KMSServerSideEncryptionT>(value);
  }
  template <typename KMSServerSideEncryptionT = KMSServerSideEncryptionIntegrationConfig>
  UpdateServiceIntegrationConfig& WithKMSServerSideEncryption(KMSServerSideEncryptionT&& value) {
    SetKMSServerSideEncryption(std::forward<KMSServerSideEncryptionT>(value));
    return *this;
  }
  ///@}
 private:
