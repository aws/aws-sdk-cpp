...
class DescribeAccountOverviewResult {
 public:
  ...
  inline DescribeAccountOverviewResult& WithReactiveInsights(int value) {
  ...
  inline DescribeAccountOverviewResult& WithProactiveInsights(int value) {
  ...
  inline DescribeAccountOverviewResult& WithMeanTimeToRecoverInMilliseconds(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAccountOverviewResult& WithRequestId(RequestIdT&& value) {
