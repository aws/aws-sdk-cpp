...
class AnomalySourceDetails {
 public:
  ...
  template <typename CloudWatchMetricsT = Aws::Vector<CloudWatchMetricsDetail>>
  AnomalySourceDetails& WithCloudWatchMetrics(CloudWatchMetricsT&& value) {
    SetCloudWatchMetrics(std::forward<CloudWatchMetricsT>(value));
    return *this;
  }
  template <typename CloudWatchMetricsT = CloudWatchMetricsDetail>
  AnomalySourceDetails& AddCloudWatchMetrics(CloudWatchMetricsT&& value) {
    m_cloudWatchMetricsHasBeenSet = true;
  ...
  void SetPerformanceInsightsMetrics(PerformanceInsightsMetricsT&& value) {
    m_performanceInsightsMetricsHasBeenSet = true;
    m_performanceInsightsMetrics = std::forward<PerformanceInsightsMetricsT>(value);
  }
  template <typename PerformanceInsightsMetricsT = Aws::Vector<PerformanceInsightsMetricsDetail>>
  AnomalySourceDetails& WithPerformanceInsightsMetrics(PerformanceInsightsMetricsT&& value) {
    SetPerformanceInsightsMetrics(std::forward<PerformanceInsightsMetricsT>(value));
    return *this;
  }
  template <typename PerformanceInsightsMetricsT = PerformanceInsightsMetricsDetail>
  AnomalySourceDetails& AddPerformanceInsightsMetrics(PerformanceInsightsMetricsT&& value) {
    m_performanceInsightsMetricsHasBeenSet = true;
    m_performanceInsightsMetrics.emplace_back(std::forward<PerformanceInsightsMetricsT>(value));
    return *this;
  }
  ///@}
 private:
