...
class SearchInsightsFilters {
 public:
  ...
  void SetSeverities(SeveritiesT&& value) {
    ...
    m_severities = std::forward<SeveritiesT>(value);
  }
  template <typename SeveritiesT = Aws::Vector<InsightSeverity>>
  SearchInsightsFilters& WithSeverities(SeveritiesT&& value) {
    SetSeverities(std::forward<SeveritiesT>(value));
    return *this;
  }
  inline SearchInsightsFilters& AddSeverities(InsightSeverity value) {
    m_severitiesHasBeenSet = true;
    m_severities.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusesT = Aws::Vector<InsightStatus>>
  SearchInsightsFilters& WithStatuses(StatusesT&& value) {
    SetStatuses(std::forward<StatusesT>(value));
    return *this;
  }
  inline SearchInsightsFilters& AddStatuses(InsightStatus value) {
    m_statusesHasBeenSet = true;
  ...
  template <typename ResourceCollectionT = ResourceCollection>
  SearchInsightsFilters& WithResourceCollection(ResourceCollectionT&& value) {
  ...
  void SetServiceCollection(ServiceCollectionT&& value) {
    ...
    m_serviceCollection = std::forward<ServiceCollectionT>(value);
  }
  template <typename ServiceCollectionT = ServiceCollection>
  SearchInsightsFilters& WithServiceCollection(ServiceCollectionT&& value) {
    SetServiceCollection(std::forward<ServiceCollectionT>(value));
    return *this;
  }
  ///@}
 private:
