...
class TagCostEstimationResourceCollectionFilter {
 public:
  ...
  template <typename AppBoundaryKeyT = Aws::String>
  TagCostEstimationResourceCollectionFilter& WithAppBoundaryKey(AppBoundaryKeyT&& value) {
  ...
  template <typename TagValuesT = Aws::Vector<Aws::String>>
  TagCostEstimationResourceCollectionFilter& WithTagValues(TagValuesT&& value) {
    SetTagValues(std::forward<TagValuesT>(value));
    return *this;
  }
  template <typename TagValuesT = Aws::String>
  TagCostEstimationResourceCollectionFilter& AddTagValues(TagValuesT&& value) {
    m_tagValuesHasBeenSet = true;
