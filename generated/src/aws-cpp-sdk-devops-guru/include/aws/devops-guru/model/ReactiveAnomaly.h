...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    ReactiveAnomaly& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    inline ReactiveAnomaly& WithSeverity(AnomalySeverity value) { SetSeverity(value); return *this;}
    ///@}
    ...
    inline ReactiveAnomaly& WithStatus(AnomalyStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename AnomalyTimeRangeT = AnomalyTimeRange>
    ReactiveAnomaly& WithAnomalyTimeRange(AnomalyTimeRangeT&& value) { SetAnomalyTimeRange(std::forward<AnomalyTimeRangeT>(value)); return *this;}
    ///@}
    ...
    template<typename AnomalyReportedTimeRangeT = AnomalyReportedTimeRange>
    ReactiveAnomaly& WithAnomalyReportedTimeRange(AnomalyReportedTimeRangeT&& value) { SetAnomalyReportedTimeRange(std::forward<AnomalyReportedTimeRangeT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceDetailsT = AnomalySourceDetails>
    ReactiveAnomaly& WithSourceDetails(SourceDetailsT&& value) { SetSourceDetails(std::forward<SourceDetailsT>(value)); return *this;}
    ///@}
    ...
    template<typename AssociatedInsightIdT = Aws::String>
    ReactiveAnomaly& WithAssociatedInsightId(AssociatedInsightIdT&& value) { SetAssociatedInsightId(std::forward<AssociatedInsightIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceCollectionT = ResourceCollection>
    ReactiveAnomaly& WithResourceCollection(ResourceCollectionT&& value) { SetResourceCollection(std::forward<ResourceCollectionT>(value)); return *this;}
    ///@}
    ...
    inline ReactiveAnomaly& WithType(AnomalyType value) { SetType(value); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ReactiveAnomaly& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    ReactiveAnomaly& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename CausalAnomalyIdT = Aws::String>
    ReactiveAnomaly& WithCausalAnomalyId(CausalAnomalyIdT&& value) { SetCausalAnomalyId(std::forward<CausalAnomalyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AnomalyResourcesT = Aws::Vector<AnomalyResource>>
    ReactiveAnomaly& WithAnomalyResources(AnomalyResourcesT&& value) { SetAnomalyResources(std::forward<AnomalyResourcesT>(value)); return *this;}
    template<typename AnomalyResourcesT = AnomalyResource>
    ReactiveAnomaly& AddAnomalyResources(AnomalyResourcesT&& value) { m_anomalyResourcesHasBeenSet = true; m_anomalyResources.emplace_back(std::forward<AnomalyResourcesT>(value)); return *this; }
    ///@}
  private:
