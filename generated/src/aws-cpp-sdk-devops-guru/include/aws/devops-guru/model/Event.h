...
class Event {
 public:
  ...
  inline void SetDataSource(EventDataSource value) {
    m_dataSourceHasBeenSet = true;
    m_dataSource = value;
  }
  inline Event& WithDataSource(EventDataSource value) {
    SetDataSource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEventClass(EventClass value) {
    m_eventClassHasBeenSet = true;
    m_eventClass = value;
  }
  inline Event& WithEventClass(EventClass value) {
    SetEventClass(value);
    return *this;
  }
  ///@}
