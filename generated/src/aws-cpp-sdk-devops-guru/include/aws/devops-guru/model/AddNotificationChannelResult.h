...
namespace Model
{
  ...
  {
  public:
    AWS_DEVOPSGURU_API AddNotificationChannelResult() = default;
    ...
    template<typename IdT = Aws::String>
    AddNotificationChannelResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AddNotificationChannelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
