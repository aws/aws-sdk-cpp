...
class GetCostEstimationResult {
 public:
  ...
  inline void SetStatus(CostEstimationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetCostEstimationResult& WithStatus(CostEstimationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetCostEstimationResult& WithTotalCost(double value) {
    SetTotalCost(value);
    return *this;
  }
  ///@}
