...
class ListOrganizationInsightsRequest : public DevOpsGuruRequest {
 public:
  ...
  template <typename StatusFilterT = ListInsightsStatusFilter>
  ListOrganizationInsightsRequest& WithStatusFilter(StatusFilterT&& value) {
  ...
  inline ListOrganizationInsightsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename AccountIdsT = Aws::Vector<Aws::String>>
  ListOrganizationInsightsRequest& WithAccountIds(AccountIdsT&& value) {
    SetAccountIds(std::forward<AccountIdsT>(value));
    return *this;
  }
  template <typename AccountIdsT = Aws::String>
  ListOrganizationInsightsRequest& AddAccountIds(AccountIdsT&& value) {
    m_accountIdsHasBeenSet = true;
  ...
  template <typename OrganizationalUnitIdsT = Aws::Vector<Aws::String>>
  ListOrganizationInsightsRequest& WithOrganizationalUnitIds(OrganizationalUnitIdsT&& value) {
    SetOrganizationalUnitIds(std::forward<OrganizationalUnitIdsT>(value));
    return *this;
  }
  template <typename OrganizationalUnitIdsT = Aws::String>
  ListOrganizationInsightsRequest& AddOrganizationalUnitIds(OrganizationalUnitIdsT&& value) {
    m_organizationalUnitIdsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListOrganizationInsightsRequest& WithNextToken(NextTokenT&& value) {
