...
class RecommendationRelatedCloudWatchMetricsSourceDetail {
 public:
  AWS_DEVOPSGURU_API RecommendationRelatedCloudWatchMetricsSourceDetail() = default;
  ...
  template <typename MetricNameT = Aws::String>
  RecommendationRelatedCloudWatchMetricsSourceDetail& WithMetricName(MetricNameT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  RecommendationRelatedCloudWatchMetricsSourceDetail& WithNamespace(NamespaceT&& value) {
