...
class ListMonitoredResourcesFilters {
 public:
  ...
  inline ListMonitoredResourcesFilters& WithResourcePermission(ResourcePermission value) {
  ...
  template <typename ResourceTypeFiltersT = Aws::Vector<ResourceTypeFilter>>
  ListMonitoredResourcesFilters& WithResourceTypeFilters(ResourceTypeFiltersT&& value) {
    SetResourceTypeFilters(std::forward<ResourceTypeFiltersT>(value));
    return *this;
  }
  inline ListMonitoredResourcesFilters& AddResourceTypeFilters(ResourceTypeFilter value) {
    m_resourceTypeFiltersHasBeenSet = true;
    m_resourceTypeFilters.push_back(value);
    return *this;
  }
  ///@}
 private:
