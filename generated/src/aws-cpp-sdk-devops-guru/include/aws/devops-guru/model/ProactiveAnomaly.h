...
class ProactiveAnomaly {
 public:
  ...
  inline ProactiveAnomaly& WithSeverity(AnomalySeverity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline ProactiveAnomaly& WithStatus(AnomalyStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ProactiveAnomaly& WithLimit(double value) {
    SetLimit(value);
    return *this;
  }
  ///@}
