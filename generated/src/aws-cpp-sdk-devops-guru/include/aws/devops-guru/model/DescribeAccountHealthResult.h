...
class DescribeAccountHealthResult {
 public:
  ...
  inline DescribeAccountHealthResult& WithOpenReactiveInsights(int value) {
  ...
  inline DescribeAccountHealthResult& WithOpenProactiveInsights(int value) {
  ...
  inline void SetMetricsAnalyzed(int value) {
    m_metricsAnalyzedHasBeenSet = true;
    m_metricsAnalyzed = value;
  }
  inline DescribeAccountHealthResult& WithMetricsAnalyzed(int value) {
    SetMetricsAnalyzed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResourceHours(long long value) {
    m_resourceHoursHasBeenSet = true;
    m_resourceHours = value;
  }
  inline DescribeAccountHealthResult& WithResourceHours(long long value) {
    SetResourceHours(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAnalyzedResourceCount(long long value) {
    m_analyzedResourceCountHasBeenSet = true;
    m_analyzedResourceCount = value;
  }
  inline DescribeAccountHealthResult& WithAnalyzedResourceCount(long long value) {
    SetAnalyzedResourceCount(value);
    return *this;
  }
  ///@}
