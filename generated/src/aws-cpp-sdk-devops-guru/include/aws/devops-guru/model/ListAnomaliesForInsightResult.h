...
class ListAnomaliesForInsightResult {
 public:
  ...
  void SetProactiveAnomalies(ProactiveAnomaliesT&& value) {
    m_proactiveAnomaliesHasBeenSet = true;
    m_proactiveAnomalies = std::forward<ProactiveAnomaliesT>(value);
  }
  template <typename ProactiveAnomaliesT = Aws::Vector<ProactiveAnomalySummary>>
  ListAnomaliesForInsightResult& WithProactiveAnomalies(ProactiveAnomaliesT&& value) {
    SetProactiveAnomalies(std::forward<ProactiveAnomaliesT>(value));
    return *this;
  }
  template <typename ProactiveAnomaliesT = ProactiveAnomalySummary>
  ListAnomaliesForInsightResult& AddProactiveAnomalies(ProactiveAnomaliesT&& value) {
    m_proactiveAnomaliesHasBeenSet = true;
    m_proactiveAnomalies.emplace_back(std::forward<ProactiveAnomaliesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReactiveAnomalies(ReactiveAnomaliesT&& value) {
    m_reactiveAnomaliesHasBeenSet = true;
    m_reactiveAnomalies = std::forward<ReactiveAnomaliesT>(value);
  }
  template <typename ReactiveAnomaliesT = Aws::Vector<ReactiveAnomalySummary>>
  ListAnomaliesForInsightResult& WithReactiveAnomalies(ReactiveAnomaliesT&& value) {
    SetReactiveAnomalies(std::forward<ReactiveAnomaliesT>(value));
    return *this;
  }
  template <typename ReactiveAnomaliesT = ReactiveAnomalySummary>
  ListAnomaliesForInsightResult& AddReactiveAnomalies(ReactiveAnomaliesT&& value) {
    m_reactiveAnomaliesHasBeenSet = true;
    m_reactiveAnomalies.emplace_back(std::forward<ReactiveAnomaliesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnomaliesForInsightResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnomaliesForInsightResult& WithRequestId(RequestIdT&& value) {
