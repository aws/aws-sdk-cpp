...
namespace Model
{
  ...
  {
  public:
    AWS_DEVOPSGURU_API UpdateResourceCollectionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateResourceCollectionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
