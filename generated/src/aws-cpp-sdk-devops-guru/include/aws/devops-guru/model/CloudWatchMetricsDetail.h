...
class CloudWatchMetricsDetail {
 public:
  ...
  inline void SetStat(CloudWatchMetricsStat value) {
    m_statHasBeenSet = true;
    m_stat = value;
  }
  inline CloudWatchMetricsDetail& WithStat(CloudWatchMetricsStat value) {
    SetStat(value);
    return *this;
  }
  ///@}
  ...
  inline CloudWatchMetricsDetail& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  void SetMetricDataSummary(MetricDataSummaryT&& value) {
    ...
    m_metricDataSummary = std::forward<MetricDataSummaryT>(value);
  }
  template <typename MetricDataSummaryT = CloudWatchMetricsDataSummary>
  CloudWatchMetricsDetail& WithMetricDataSummary(MetricDataSummaryT&& value) {
    SetMetricDataSummary(std::forward<MetricDataSummaryT>(value));
    return *this;
  }
  ///@}
 private:
