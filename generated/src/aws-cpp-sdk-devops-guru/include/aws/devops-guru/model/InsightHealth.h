...
class InsightHealth {
 public:
  ...
  inline InsightHealth& WithOpenProactiveInsights(int value) {
  ...
  inline InsightHealth& WithOpenReactiveInsights(int value) {
  ...
  inline void SetMeanTimeToRecoverInMilliseconds(long long value) {
    m_meanTimeToRecoverInMillisecondsHasBeenSet = true;
    m_meanTimeToRecoverInMilliseconds = value;
  }
  inline InsightHealth& WithMeanTimeToRecoverInMilliseconds(long long value) {
    SetMeanTimeToRecoverInMilliseconds(value);
    return *this;
  }
  ///@}
 private:
