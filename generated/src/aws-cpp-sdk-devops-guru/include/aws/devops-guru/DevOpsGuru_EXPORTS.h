...
#ifdef AWS_DEVOPSGURU_EXPORTS
#define AWS_DEVOPSGURU_API __declspec(dllexport)
#else
...
#define AWS_DEVOPSGURU_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_DEVOPSGURU_API
#define AWS_DEVOPSGURU_EXTERN extern
#if __GNUC__ >= 4
#define AWS_DEVOPSGURU_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_DEVOPSGURU_LOCAL
#endif
