...
class AWS_DEVOPSGURU_API DevOpsGuruClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DevOpsGuruClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DevOpsGuruEndpointProviderBase> endpointProvider = nullptr,
      const Aws::DevOpsGuru::DevOpsGuruClientConfiguration& clientConfiguration = Aws::DevOpsGuru::DevOpsGuruClientConfiguration());
  ...
  /**
   * A Callable wrapper for AddNotificationChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddNotificationChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddNotificationChannelRequestT = Model::AddNotificationChannelRequest>
  void AddNotificationChannelAsync(const AddNotificationChannelRequestT& request,
                                   const AddNotificationChannelResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for DeleteInsight that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteInsightRequestT = Model::DeleteInsightRequest>
  void DeleteInsightAsync(const DeleteInsightRequestT& request, const DeleteInsightResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAccountHealth that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAccountHealth that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAccountHealthRequestT = Model::DescribeAccountHealthRequest>
  void DescribeAccountHealthAsync(const DescribeAccountHealthResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeAccountHealthRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeAccountOverview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAccountOverview that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAccountOverviewRequestT = Model::DescribeAccountOverviewRequest>
  void DescribeAccountOverviewAsync(const DescribeAccountOverviewRequestT& request,
                                    const DescribeAccountOverviewResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeAnomaly that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeAnomalyRequestT = Model::DescribeAnomalyRequest>
  void DescribeAnomalyAsync(const DescribeAnomalyRequestT& request, const DescribeAnomalyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEventSourcesConfigOutcome DescribeEventSourcesConfig(
      const Model::DescribeEventSourcesConfigRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEventSourcesConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEventSourcesConfigRequestT = Model::DescribeEventSourcesConfigRequest>
  Model::DescribeEventSourcesConfigOutcomeCallable DescribeEventSourcesConfigCallable(
      const DescribeEventSourcesConfigRequestT& request = {}) const {
    return SubmitCallable(&DevOpsGuruClient::DescribeEventSourcesConfig, request);
  }

  /**
   * An Async wrapper for DescribeEventSourcesConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEventSourcesConfigRequestT = Model::DescribeEventSourcesConfigRequest>
  void DescribeEventSourcesConfigAsync(const DescribeEventSourcesConfigResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeEventSourcesConfigRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeFeedback that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFeedback that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeFeedbackRequestT = Model::DescribeFeedbackRequest>
  void DescribeFeedbackAsync(const DescribeFeedbackResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DescribeFeedbackRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeInsight that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeInsightRequestT = Model::DescribeInsightRequest>
  void DescribeInsightAsync(const DescribeInsightRequestT& request, const DescribeInsightResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeOrganizationHealthOutcome DescribeOrganizationHealth(
      const Model::DescribeOrganizationHealthRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeOrganizationHealth that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeOrganizationHealthRequestT = Model::DescribeOrganizationHealthRequest>
  Model::DescribeOrganizationHealthOutcomeCallable DescribeOrganizationHealthCallable(
      const DescribeOrganizationHealthRequestT& request = {}) const {
    return SubmitCallable(&DevOpsGuruClient::DescribeOrganizationHealth, request);
  }

  /**
   * An Async wrapper for DescribeOrganizationHealth that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeOrganizationHealthRequestT = Model::DescribeOrganizationHealthRequest>
  void DescribeOrganizationHealthAsync(const DescribeOrganizationHealthResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeOrganizationHealthRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeOrganizationOverviewOutcome DescribeOrganizationOverview(
      const Model::DescribeOrganizationOverviewRequest& request) const;

  /**
   * A Callable wrapper for DescribeOrganizationOverview that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeOrganizationOverviewRequestT = Model::DescribeOrganizationOverviewRequest>
  Model::DescribeOrganizationOverviewOutcomeCallable DescribeOrganizationOverviewCallable(
      const DescribeOrganizationOverviewRequestT& request) const {
    return SubmitCallable(&DevOpsGuruClient::DescribeOrganizationOverview, request);
  }

  /**
   * An Async wrapper for DescribeOrganizationOverview that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeOrganizationOverviewRequestT = Model::DescribeOrganizationOverviewRequest>
  void DescribeOrganizationOverviewAsync(const DescribeOrganizationOverviewRequestT& request,
                                         const DescribeOrganizationOverviewResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeOrganizationResourceCollectionHealthOutcome DescribeOrganizationResourceCollectionHealth(
      const Model::DescribeOrganizationResourceCollectionHealthRequest& request) const;

  /**
   * A Callable wrapper for DescribeOrganizationResourceCollectionHealth that returns a future to the operation so that it can be executed
  ...
  Model::DescribeOrganizationResourceCollectionHealthOutcomeCallable DescribeOrganizationResourceCollectionHealthCallable(
      const DescribeOrganizationResourceCollectionHealthRequestT& request) const {
    return SubmitCallable(&DevOpsGuruClient::DescribeOrganizationResourceCollectionHealth, request);
  }

  /**
   * An Async wrapper for DescribeOrganizationResourceCollectionHealth that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DescribeOrganizationResourceCollectionHealthRequestT = Model::DescribeOrganizationResourceCollectionHealthRequest>
  void DescribeOrganizationResourceCollectionHealthAsync(
      const DescribeOrganizationResourceCollectionHealthRequestT& request,
      const DescribeOrganizationResourceCollectionHealthResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeResourceCollectionHealthOutcome DescribeResourceCollectionHealth(
      const Model::DescribeResourceCollectionHealthRequest& request) const;

  /**
   * A Callable wrapper for DescribeResourceCollectionHealth that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeResourceCollectionHealthRequestT = Model::DescribeResourceCollectionHealthRequest>
  Model::DescribeResourceCollectionHealthOutcomeCallable DescribeResourceCollectionHealthCallable(
      const DescribeResourceCollectionHealthRequestT& request) const {
    return SubmitCallable(&DevOpsGuruClient::DescribeResourceCollectionHealth, request);
  }

  /**
   * An Async wrapper for DescribeResourceCollectionHealth that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeResourceCollectionHealthRequestT = Model::DescribeResourceCollectionHealthRequest>
  void DescribeResourceCollectionHealthAsync(const DescribeResourceCollectionHealthRequestT& request,
                                             const DescribeResourceCollectionHealthResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeServiceIntegrationOutcome DescribeServiceIntegration(
      const Model::DescribeServiceIntegrationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeServiceIntegration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeServiceIntegrationRequestT = Model::DescribeServiceIntegrationRequest>
  Model::DescribeServiceIntegrationOutcomeCallable DescribeServiceIntegrationCallable(
      const DescribeServiceIntegrationRequestT& request = {}) const {
    return SubmitCallable(&DevOpsGuruClient::DescribeServiceIntegration, request);
  }

  /**
   * An Async wrapper for DescribeServiceIntegration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeServiceIntegrationRequestT = Model::DescribeServiceIntegrationRequest>
  void DescribeServiceIntegrationAsync(const DescribeServiceIntegrationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeServiceIntegrationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetCostEstimation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCostEstimation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCostEstimationRequestT = Model::GetCostEstimationRequest>
  void GetCostEstimationAsync(const GetCostEstimationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetCostEstimationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetResourceCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResourceCollectionRequestT = Model::GetResourceCollectionRequest>
  void GetResourceCollectionAsync(const GetResourceCollectionRequestT& request, const GetResourceCollectionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAnomaliesForInsight that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAnomaliesForInsight that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnomaliesForInsightRequestT = Model::ListAnomaliesForInsightRequest>
  void ListAnomaliesForInsightAsync(const ListAnomaliesForInsightRequestT& request,
                                    const ListAnomaliesForInsightResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAnomalousLogGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAnomalousLogGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnomalousLogGroupsRequestT = Model::ListAnomalousLogGroupsRequest>
  void ListAnomalousLogGroupsAsync(const ListAnomalousLogGroupsRequestT& request,
                                   const ListAnomalousLogGroupsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMonitoredResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMonitoredResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMonitoredResourcesRequestT = Model::ListMonitoredResourcesRequest>
  void ListMonitoredResourcesAsync(const ListMonitoredResourcesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListMonitoredResourcesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListNotificationChannels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListNotificationChannelsRequestT = Model::ListNotificationChannelsRequest>
  Model::ListNotificationChannelsOutcomeCallable ListNotificationChannelsCallable(
      const ListNotificationChannelsRequestT& request = {}) const {
    return SubmitCallable(&DevOpsGuruClient::ListNotificationChannels, request);
  }

  /**
   * An Async wrapper for ListNotificationChannels that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListNotificationChannelsRequestT = Model::ListNotificationChannelsRequest>
  void ListNotificationChannelsAsync(const ListNotificationChannelsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListNotificationChannelsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListOrganizationInsights that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOrganizationInsights that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOrganizationInsightsRequestT = Model::ListOrganizationInsightsRequest>
  void ListOrganizationInsightsAsync(const ListOrganizationInsightsRequestT& request,
                                     const ListOrganizationInsightsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename PutFeedbackRequestT = Model::PutFeedbackRequest>
  void PutFeedbackAsync(const PutFeedbackResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const PutFeedbackRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RemoveNotificationChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RemoveNotificationChannelRequestT = Model::RemoveNotificationChannelRequest>
  Model::RemoveNotificationChannelOutcomeCallable RemoveNotificationChannelCallable(
      const RemoveNotificationChannelRequestT& request) const {
    return SubmitCallable(&DevOpsGuruClient::RemoveNotificationChannel, request);
  }

  /**
   * An Async wrapper for RemoveNotificationChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveNotificationChannelRequestT = Model::RemoveNotificationChannelRequest>
  void RemoveNotificationChannelAsync(const RemoveNotificationChannelRequestT& request,
  ...
  /**
   * An Async wrapper for SearchInsights that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchInsightsRequestT = Model::SearchInsightsRequest>
  void SearchInsightsAsync(const SearchInsightsRequestT& request, const SearchInsightsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SearchOrganizationInsightsOutcome SearchOrganizationInsights(
      const Model::SearchOrganizationInsightsRequest& request) const;

  /**
   * A Callable wrapper for SearchOrganizationInsights that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SearchOrganizationInsightsRequestT = Model::SearchOrganizationInsightsRequest>
  Model::SearchOrganizationInsightsOutcomeCallable SearchOrganizationInsightsCallable(
      const SearchOrganizationInsightsRequestT& request) const {
    return SubmitCallable(&DevOpsGuruClient::SearchOrganizationInsights, request);
  }

  /**
   * An Async wrapper for SearchOrganizationInsights that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchOrganizationInsightsRequestT = Model::SearchOrganizationInsightsRequest>
  void SearchOrganizationInsightsAsync(const SearchOrganizationInsightsRequestT& request,
                                       const SearchOrganizationInsightsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartCostEstimation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartCostEstimation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartCostEstimationRequestT = Model::StartCostEstimationRequest>
  void StartCostEstimationAsync(const StartCostEstimationRequestT& request, const StartCostEstimationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEventSourcesConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateEventSourcesConfigRequestT = Model::UpdateEventSourcesConfigRequest>
  Model::UpdateEventSourcesConfigOutcomeCallable UpdateEventSourcesConfigCallable(
      const UpdateEventSourcesConfigRequestT& request = {}) const {
    return SubmitCallable(&DevOpsGuruClient::UpdateEventSourcesConfig, request);
  }

  /**
   * An Async wrapper for UpdateEventSourcesConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEventSourcesConfigRequestT = Model::UpdateEventSourcesConfigRequest>
  void UpdateEventSourcesConfigAsync(const UpdateEventSourcesConfigResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const UpdateEventSourcesConfigRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateResourceCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResourceCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResourceCollectionRequestT = Model::UpdateResourceCollectionRequest>
  void UpdateResourceCollectionAsync(const UpdateResourceCollectionRequestT& request,
                                     const UpdateResourceCollectionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateServiceIntegration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateServiceIntegration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateServiceIntegrationRequestT = Model::UpdateServiceIntegrationRequest>
  void UpdateServiceIntegrationAsync(const UpdateServiceIntegrationRequestT& request,
                                     const UpdateServiceIntegrationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
