...
namespace DevOpsGuru
{
   ...
   * in DevOps Guru</a>. </p>
   */
  class AWS_DEVOPSGURU_API DevOpsGuruClient : Aws::Client::ClientWithAsyncTemplateMethods<DevOpsGuruClient>,
    smithy::client::AwsSmithyClientT<Aws::DevOpsGuru::SERVICE_NAME,
