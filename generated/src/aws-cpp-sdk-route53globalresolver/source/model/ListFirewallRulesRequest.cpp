...
Aws::String ListFirewallRulesRequest::SerializePayload() const { return {}; }

void ListFirewallRulesRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
  ...
  if (m_dnsViewIdHasBeenSet) {
    ss << m_dnsViewId;
    uri.AddQueryStringParameter("dnsview_id", ss.str());
    ss.str("");
  }
