...
BatchUpdateFirewallRuleResult::BatchUpdateFirewallRuleResult(JsonView jsonValue) { *this = jsonValue; }

BatchUpdateFirewallRuleResult& BatchUpdateFirewallRuleResult::operator=(JsonView jsonValue) {
...
JsonValue BatchUpdateFirewallRuleResult::Jsonize() const {
  JsonValue payload;
