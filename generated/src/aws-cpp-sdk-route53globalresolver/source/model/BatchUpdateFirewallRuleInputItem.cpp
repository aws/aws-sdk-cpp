...
BatchUpdateFirewallRuleInputItem::BatchUpdateFirewallRuleInputItem(JsonView jsonValue) { *this = jsonValue; }

BatchUpdateFirewallRuleInputItem& BatchUpdateFirewallRuleInputItem::operator=(JsonView jsonValue) {
...
JsonValue BatchUpdateFirewallRuleInputItem::Jsonize() const {
  JsonValue payload;
