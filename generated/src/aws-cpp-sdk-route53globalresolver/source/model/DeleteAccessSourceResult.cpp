...
DeleteAccessSourceResult::DeleteAccessSourceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteAccessSourceResult& DeleteAccessSourceResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
