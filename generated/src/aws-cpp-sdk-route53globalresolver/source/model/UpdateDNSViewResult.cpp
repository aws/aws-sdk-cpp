...
UpdateDNSViewResult::UpdateDNSViewResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateDNSViewResult& UpdateDNSViewResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
