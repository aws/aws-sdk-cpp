...
GetHostedZoneAssociationResult::GetHostedZoneAssociationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetHostedZoneAssociationResult& GetHostedZoneAssociationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
