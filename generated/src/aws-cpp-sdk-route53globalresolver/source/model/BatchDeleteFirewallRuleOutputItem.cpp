...
BatchDeleteFirewallRuleOutputItem::BatchDeleteFirewallRuleOutputItem(JsonView jsonValue) { *this = jsonValue; }

BatchDeleteFirewallRuleOutputItem& BatchDeleteFirewallRuleOutputItem::operator=(JsonView jsonValue) {
...
JsonValue BatchDeleteFirewallRuleOutputItem::Jsonize() const {
  JsonValue payload;
