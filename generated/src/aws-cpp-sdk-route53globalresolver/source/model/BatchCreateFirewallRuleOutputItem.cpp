...
BatchCreateFirewallRuleOutputItem::BatchCreateFirewallRuleOutputItem(JsonView jsonValue) { *this = jsonValue; }

BatchCreateFirewallRuleOutputItem& BatchCreateFirewallRuleOutputItem::operator=(JsonView jsonValue) {
...
JsonValue BatchCreateFirewallRuleOutputItem::Jsonize() const {
  JsonValue payload;
