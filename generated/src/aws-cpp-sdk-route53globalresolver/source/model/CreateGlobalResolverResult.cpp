...
CreateGlobalResolverResult::CreateGlobalResolverResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateGlobalResolverResult& CreateGlobalResolverResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
