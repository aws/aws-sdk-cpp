...
ListSharedDNSViewsResult::ListSharedDNSViewsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListSharedDNSViewsResult& ListSharedDNSViewsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
