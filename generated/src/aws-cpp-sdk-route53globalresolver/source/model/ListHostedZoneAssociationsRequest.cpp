...
Aws::String ListHostedZoneAssociationsRequest::SerializePayload() const { return {}; }

void ListHostedZoneAssociationsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
