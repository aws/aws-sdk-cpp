...
EnableDNSViewResult::EnableDNSViewResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

EnableDNSViewResult& EnableDNSViewResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
