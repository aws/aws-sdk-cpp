...
SharedDNSViewSummary::SharedDNSViewSummary(JsonView jsonValue) { *this = jsonValue; }

SharedDNSViewSummary& SharedDNSViewSummary::operator=(JsonView jsonValue) {
...
JsonValue SharedDNSViewSummary::Jsonize() const {
  JsonValue payload;
