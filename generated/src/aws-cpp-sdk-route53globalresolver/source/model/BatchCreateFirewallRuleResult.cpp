...
BatchCreateFirewallRuleResult::BatchCreateFirewallRuleResult(JsonView jsonValue) { *this = jsonValue; }

BatchCreateFirewallRuleResult& BatchCreateFirewallRuleResult::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("managedDomainListName")) {
    m_managedDomainListName = jsonValue.GetString("managedDomainListName");
    m_managedDomainListNameHasBeenSet = true;
  }
...
JsonValue BatchCreateFirewallRuleResult::Jsonize() const {
  JsonValue payload;
  ...
  if (m_managedDomainListNameHasBeenSet) {
    payload.WithString("managedDomainListName", m_managedDomainListName);
  }
