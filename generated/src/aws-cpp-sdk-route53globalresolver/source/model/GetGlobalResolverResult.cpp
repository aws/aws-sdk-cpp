...
GetGlobalResolverResult::GetGlobalResolverResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetGlobalResolverResult& GetGlobalResolverResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
