...
Aws::String ListManagedFirewallDomainListsRequest::SerializePayload() const { return {}; }

void ListManagedFirewallDomainListsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
