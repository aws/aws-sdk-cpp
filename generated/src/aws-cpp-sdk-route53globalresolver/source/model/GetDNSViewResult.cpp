...
GetDNSViewResult::GetDNSViewResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetDNSViewResult& GetDNSViewResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
