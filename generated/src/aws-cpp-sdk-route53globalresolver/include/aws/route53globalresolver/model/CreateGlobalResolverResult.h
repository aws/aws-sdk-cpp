...
namespace Model {
class CreateGlobalResolverResult {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API CreateGlobalResolverResult() = default;
  AWS_ROUTE53GLOBALRESOLVER_API CreateGlobalResolverResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ROUTE53GLOBALRESOLVER_API CreateGlobalResolverResult& operator=(
  ...
  template <typename IdT = Aws::String>
  CreateGlobalResolverResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateGlobalResolverResult& WithArn(ArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateGlobalResolverResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateGlobalResolverResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateGlobalResolverResult& WithDescription(DescriptionT&& value) {
  ...
  ///@{
  /**
   * <p>The hostname that DNS clients should use for TLS certificate validation when
   * connecting to the Route 53 Global Resolver. This value resolves to the global
   * anycast IP addresses for the resolver.</p>
   */
  ...
  template <typename DnsNameT = Aws::String>
  CreateGlobalResolverResult& WithDnsName(DnsNameT&& value) {
  ...
  template <typename Ipv4AddressesT = Aws::Vector<Aws::String>>
  CreateGlobalResolverResult& WithIpv4Addresses(Ipv4AddressesT&& value) {
    SetIpv4Addresses(std::forward<Ipv4AddressesT>(value));
    return *this;
  }
  template <typename Ipv4AddressesT = Aws::String>
  CreateGlobalResolverResult& AddIpv4Addresses(Ipv4AddressesT&& value) {
    m_ipv4AddressesHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  CreateGlobalResolverResult& WithName(NameT&& value) {
  ...
  template <typename ObservabilityRegionT = Aws::String>
  CreateGlobalResolverResult& WithObservabilityRegion(ObservabilityRegionT&& value) {
  ...
  template <typename RegionsT = Aws::Vector<Aws::String>>
  CreateGlobalResolverResult& WithRegions(RegionsT&& value) {
    SetRegions(std::forward<RegionsT>(value));
    return *this;
  }
  template <typename RegionsT = Aws::String>
  CreateGlobalResolverResult& AddRegions(RegionsT&& value) {
    m_regionsHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>The current status of the Route 53 Global Resolver. Possible values are
   * CREATING (being provisioned), UPDATING (being modified), OPERATIONAL (ready to
   * serve queries), or DELETING (being removed).</p>
   */
  ...
  inline CreateGlobalResolverResult& WithStatus(CRResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateGlobalResolverResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateGlobalResolverResult& WithRequestId(RequestIdT&& value) {
