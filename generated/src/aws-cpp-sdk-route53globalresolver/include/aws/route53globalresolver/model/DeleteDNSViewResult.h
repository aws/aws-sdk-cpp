...
namespace Model {
class DeleteDNSViewResult {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API DeleteDNSViewResult() = default;
  AWS_ROUTE53GLOBALRESOLVER_API DeleteDNSViewResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ROUTE53GLOBALRESOLVER_API DeleteDNSViewResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename IdT = Aws::String>
  DeleteDNSViewResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteDNSViewResult& WithArn(ArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteDNSViewResult& WithClientToken(ClientTokenT&& value) {
  ...
  inline DeleteDNSViewResult& WithDnssecValidation(DnsSecValidationType value) {
  ...
  ///@{
  /**
   * <p>Whether EDNS Client Subnet injection was enabled for the deleted DNS
   * view.</p>
   */
  ...
  inline DeleteDNSViewResult& WithEdnsClientSubnet(EdnsClientSubnetType value) {
  ...
  ///@{
  /**
   * <p>The firewall rules fail-open behavior that was configured for the deleted DNS
   * view.</p>
   */
  ...
  inline DeleteDNSViewResult& WithFirewallRulesFailOpen(FirewallRulesFailOpenType value) {
  ...
  template <typename NameT = Aws::String>
  DeleteDNSViewResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  DeleteDNSViewResult& WithDescription(DescriptionT&& value) {
  ...
  ///@{
  /**
   * <p>The ID of the Route 53 Global Resolver that the deleted DNS view was
   * associated with.</p>
   */
  ...
  template <typename GlobalResolverIdT = Aws::String>
  DeleteDNSViewResult& WithGlobalResolverId(GlobalResolverIdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  DeleteDNSViewResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  DeleteDNSViewResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline DeleteDNSViewResult& WithStatus(ProfileResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDNSViewResult& WithRequestId(RequestIdT&& value) {
