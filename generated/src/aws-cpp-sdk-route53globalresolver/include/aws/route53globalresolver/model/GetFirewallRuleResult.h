...
class GetFirewallRuleResult {
 public:
  ...
  inline GetFirewallRuleResult& WithAction(FirewallRuleAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline GetFirewallRuleResult& WithBlockOverrideDnsType(BlockOverrideDnsQueryType value) {
  ...
  inline GetFirewallRuleResult& WithBlockOverrideTtl(int value) {
  ...
  inline GetFirewallRuleResult& WithBlockResponse(FirewallBlockResponse value) {
  ...
  inline GetFirewallRuleResult& WithConfidenceThreshold(ConfidenceThreshold value) {
  ...
  inline GetFirewallRuleResult& WithDnsAdvancedProtection(DnsAdvancedProtection value) {
  ...
  inline GetFirewallRuleResult& WithPriority(long long value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline GetFirewallRuleResult& WithStatus(CRResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
