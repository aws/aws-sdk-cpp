...
/**
 * <p>The result of creating a firewall rule in a batch operation.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/route53globalresolver-2022-09-27/BatchCreateFirewallRuleResult">AWS
 * API Reference</a></p>
 */
class BatchCreateFirewallRuleResult {
 public:
  ...
  inline BatchCreateFirewallRuleResult& WithAction(FirewallRuleAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The DNS record type configured for the created firewall rule's custom
   * response.</p>
   */
  ...
  inline BatchCreateFirewallRuleResult& WithBlockOverrideDnsType(BlockOverrideDnsQueryType value) {
  ...
  ///@{
  /**
   * <p>The custom domain name configured for the created firewall rule's BLOCK
   * response.</p>
   */
  ...
  inline BatchCreateFirewallRuleResult& WithBlockOverrideTtl(int value) {
  ...
  inline BatchCreateFirewallRuleResult& WithBlockResponse(FirewallBlockResponse value) {
  ...
  ///@{
  /**
   * <p>The confidence threshold configured for the created firewall rule's advanced
   * threat detection.</p>
   */
  ...
  inline BatchCreateFirewallRuleResult& WithConfidenceThreshold(ConfidenceThreshold value) {
  ...
  ///@{
  /**
   * <p>Whether advanced DNS threat protection is enabled for the created firewall
   * rule.</p>
   */
  ...
  inline BatchCreateFirewallRuleResult& WithDnsAdvancedProtection(DnsAdvancedProtection value) {
  ...
  ///@{
  /**
   * <p>The ID of the firewall domain list associated with the created firewall
   * rule.</p>
   */
  ...
  ///@{
  /**
   * <p>The name of the managed domain list associated with the created firewall
   * rule.</p>
   */
  inline const Aws::String& GetManagedDomainListName() const { return m_managedDomainListName; }
  inline bool ManagedDomainListNameHasBeenSet() const { return m_managedDomainListNameHasBeenSet; }
  template <typename ManagedDomainListNameT = Aws::String>
  void SetManagedDomainListName(ManagedDomainListNameT&& value) {
    m_managedDomainListNameHasBeenSet = true;
    m_managedDomainListName = std::forward<ManagedDomainListNameT>(value);
  }
  template <typename ManagedDomainListNameT = Aws::String>
  BatchCreateFirewallRuleResult& WithManagedDomainListName(ManagedDomainListNameT&& value) {
    SetManagedDomainListName(std::forward<ManagedDomainListNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline BatchCreateFirewallRuleResult& WithPriority(long long value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline BatchCreateFirewallRuleResult& WithStatus(CRResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
 ...
 private:
  ...
  Aws::String m_managedDomainListName;
  ...
  bool m_managedDomainListNameHasBeenSet = false;
