...
/**
 * <p>The request would exceed one or more service quotas. Check your current usage
 * and quotas, then try again.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/route53globalresolver-2022-09-27/ServiceQuotaExceededException">AWS
 * API Reference</a></p>
 */
class ServiceQuotaExceededException {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API ServiceQuotaExceededException() = default;
  AWS_ROUTE53GLOBALRESOLVER_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
  AWS_ROUTE53GLOBALRESOLVER_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
