...
/**
 */
class GetAccessTokenRequest : public Route53GlobalResolverRequest {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API GetAccessTokenRequest() = default;
  ...
  template <typename AccessTokenIdT = Aws::String>
  GetAccessTokenRequest& WithAccessTokenId(AccessTokenIdT&& value) {
