...
/**
 */
class GetFirewallDomainListRequest : public Route53GlobalResolverRequest {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API GetFirewallDomainListRequest() = default;
  ...
  template <typename FirewallDomainListIdT = Aws::String>
  GetFirewallDomainListRequest& WithFirewallDomainListId(FirewallDomainListIdT&& value) {
