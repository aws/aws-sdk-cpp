...
/**
 */
class ListAccessTokensRequest : public Route53GlobalResolverRequest {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API ListAccessTokensRequest() = default;
  ...
  template <typename DnsViewIdT = Aws::String>
  ListAccessTokensRequest& WithDnsViewId(DnsViewIdT&& value) {
  ...
  template <typename FiltersT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  ListAccessTokensRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersKeyT = Aws::String, typename FiltersValueT = Aws::Vector<Aws::String>>
  ListAccessTokensRequest& AddFilters(FiltersKeyT&& key, FiltersValueT&& value) {
    m_filtersHasBeenSet = true;
