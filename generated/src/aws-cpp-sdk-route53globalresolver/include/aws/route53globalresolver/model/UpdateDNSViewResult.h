...
namespace Model {
class UpdateDNSViewResult {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API UpdateDNSViewResult() = default;
  AWS_ROUTE53GLOBALRESOLVER_API UpdateDNSViewResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ROUTE53GLOBALRESOLVER_API UpdateDNSViewResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename IdT = Aws::String>
  UpdateDNSViewResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateDNSViewResult& WithArn(ArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateDNSViewResult& WithClientToken(ClientTokenT&& value) {
  ...
  inline UpdateDNSViewResult& WithDnssecValidation(DnsSecValidationType value) {
  ...
  inline UpdateDNSViewResult& WithEdnsClientSubnet(EdnsClientSubnetType value) {
  ...
  ///@{
  /**
   * <p>Whether firewall rules fail open when they cannot be evaluated for the
   * updated DNS view.</p>
   */
  ...
  inline UpdateDNSViewResult& WithFirewallRulesFailOpen(FirewallRulesFailOpenType value) {
  ...
  template <typename NameT = Aws::String>
  UpdateDNSViewResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateDNSViewResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename GlobalResolverIdT = Aws::String>
  UpdateDNSViewResult& WithGlobalResolverId(GlobalResolverIdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateDNSViewResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateDNSViewResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline UpdateDNSViewResult& WithStatus(ProfileResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDNSViewResult& WithRequestId(RequestIdT&& value) {
