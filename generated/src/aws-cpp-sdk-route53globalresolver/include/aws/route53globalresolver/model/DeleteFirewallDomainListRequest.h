...
/**
 */
class DeleteFirewallDomainListRequest : public Route53GlobalResolverRequest {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API DeleteFirewallDomainListRequest() = default;
  ...
  template <typename FirewallDomainListIdT = Aws::String>
  DeleteFirewallDomainListRequest& WithFirewallDomainListId(FirewallDomainListIdT&& value) {
