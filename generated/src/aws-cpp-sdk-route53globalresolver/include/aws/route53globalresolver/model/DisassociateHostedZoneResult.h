...
namespace Model {
class DisassociateHostedZoneResult {
 public:
  ...
  AWS_ROUTE53GLOBALRESOLVER_API DisassociateHostedZoneResult& operator=(
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the Route 53 Global Resolver resource that
   * the hosted zone was disassociated from.</p>
   */
  ...
  ///@{
  /**
   * <p>The date and time when the association was last updated before
   * disassociation.</p>
   */
  ...
  inline DisassociateHostedZoneResult& WithStatus(HostedZoneAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
