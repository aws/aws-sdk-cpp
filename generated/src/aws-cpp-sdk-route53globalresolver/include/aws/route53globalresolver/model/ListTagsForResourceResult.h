...
class ListTagsForResourceResult {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API ListTagsForResourceResult() = default;
  AWS_ROUTE53GLOBALRESOLVER_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ROUTE53GLOBALRESOLVER_API ListTagsForResourceResult& operator=(
