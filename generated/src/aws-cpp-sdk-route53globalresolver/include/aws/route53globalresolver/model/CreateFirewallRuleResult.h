...
class CreateFirewallRuleResult {
 public:
  ...
  inline CreateFirewallRuleResult& WithAction(FirewallRuleAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The DNS record type for the custom response when blockResponse is
   * OVERRIDE.</p>
   */
  ...
  inline CreateFirewallRuleResult& WithBlockOverrideDnsType(BlockOverrideDnsQueryType value) {
  ...
  ///@{
  /**
   * <p>The custom domain to return when the action is BLOCK and blockResponse is
   * OVERRIDE.</p>
   */
  ...
  ///@{
  /**
   * <p>The time-to-live (TTL) value for the custom response when blockResponse is
   * OVERRIDE.</p>
   */
  ...
  inline CreateFirewallRuleResult& WithBlockOverrideTtl(int value) {
  ...
  inline CreateFirewallRuleResult& WithBlockResponse(FirewallBlockResponse value) {
  ...
  inline CreateFirewallRuleResult& WithConfidenceThreshold(ConfidenceThreshold value) {
  ...
  inline CreateFirewallRuleResult& WithDnsAdvancedProtection(DnsAdvancedProtection value) {
  ...
  template <typename IdT = Aws::String>
  CreateFirewallRuleResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateFirewallRuleResult& WithName(NameT&& value) {
  ...
  inline CreateFirewallRuleResult& WithPriority(long long value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFirewallRuleResult& WithStatus(CRResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
