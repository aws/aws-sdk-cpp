 ...
 * when trying to modify a resource that is not in a valid state for the requested
 * operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/route53globalresolver-2022-09-27/ConflictException">AWS
 * API Reference</a></p>
 */
class ConflictException {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API ConflictException() = default;
  AWS_ROUTE53GLOBALRESOLVER_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
  AWS_ROUTE53GLOBALRESOLVER_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
