...
class ListFirewallDomainsResult {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API ListFirewallDomainsResult() = default;
  AWS_ROUTE53GLOBALRESOLVER_API ListFirewallDomainsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ROUTE53GLOBALRESOLVER_API ListFirewallDomainsResult& operator=(
