...
namespace Model {
class DeleteAccessSourceResult {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API DeleteAccessSourceResult() = default;
  AWS_ROUTE53GLOBALRESOLVER_API DeleteAccessSourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ROUTE53GLOBALRESOLVER_API DeleteAccessSourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ArnT = Aws::String>
  DeleteAccessSourceResult& WithArn(ArnT&& value) {
  ...
  template <typename CidrT = Aws::String>
  DeleteAccessSourceResult& WithCidr(CidrT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  DeleteAccessSourceResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename IdT = Aws::String>
  DeleteAccessSourceResult& WithId(IdT&& value) {
  ...
  inline DeleteAccessSourceResult& WithIpAddressType(IpAddressType value) {
  ...
  template <typename NameT = Aws::String>
  DeleteAccessSourceResult& WithName(NameT&& value) {
  ...
  ///@{
  /**
   * <p>The ID of the DNS view that was associated with the deleted access
   * source.</p>
   */
  ...
  template <typename DnsViewIdT = Aws::String>
  DeleteAccessSourceResult& WithDnsViewId(DnsViewIdT&& value) {
  ...
  inline DeleteAccessSourceResult& WithProtocol(DnsProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteAccessSourceResult& WithStatus(CRResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The date and time when the access source was last updated before
   * deletion.</p>
   */
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  DeleteAccessSourceResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteAccessSourceResult& WithRequestId(RequestIdT&& value) {
