...
/**
 */
class GetGlobalResolverRequest : public Route53GlobalResolverRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetGlobalResolver"; }
