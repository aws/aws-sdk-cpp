...
/**
 * <p>Summary information about a DNS view that has been shared with your Amazon
 * Web Services account through Amazon Web Services RAM.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/route53globalresolver-2022-09-27/SharedDNSViewSummary">AWS
 * API Reference</a></p>
 */
class SharedDNSViewSummary {
 public:
  AWS_ROUTE53GLOBALRESOLVER_API SharedDNSViewSummary() = default;
  AWS_ROUTE53GLOBALRESOLVER_API SharedDNSViewSummary(Aws::Utils::Json::JsonView jsonValue);
  AWS_ROUTE53GLOBALRESOLVER_API SharedDNSViewSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename IdT = Aws::String>
  SharedDNSViewSummary& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  SharedDNSViewSummary& WithArn(ArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  SharedDNSViewSummary& WithClientToken(ClientTokenT&& value) {
  ...
  inline SharedDNSViewSummary& WithDnssecValidation(DnsSecValidationType value) {
  ...
  inline SharedDNSViewSummary& WithEdnsClientSubnet(EdnsClientSubnetType value) {
  ...
  inline SharedDNSViewSummary& WithFirewallRulesFailOpen(FirewallRulesFailOpenType value) {
  ...
  template <typename NameT = Aws::String>
  SharedDNSViewSummary& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  SharedDNSViewSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename GlobalResolverIdT = Aws::String>
  SharedDNSViewSummary& WithGlobalResolverId(GlobalResolverIdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  SharedDNSViewSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  SharedDNSViewSummary& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline SharedDNSViewSummary& WithStatus(ProfileResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The ID of the Amazon Web Services account that owns the DNS view and shared
   * it with your Amazon Web Services account.</p>
   */
  ...
  template <typename OwnerAccountIdT = Aws::String>
  SharedDNSViewSummary& WithOwnerAccountId(OwnerAccountIdT&& value) {
