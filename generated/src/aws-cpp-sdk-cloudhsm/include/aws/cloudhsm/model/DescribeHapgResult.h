...
namespace Model
{
  ...
  public:
    ...
    inline DescribeHapgResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribeHapgResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribeHapgResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
