...
namespace Model
{
  ...
  public:
    ...
    inline ListLunaClientsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListLunaClientsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListLunaClientsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
