...
class ListTunnelsResult {
 public:
  ...
  void SetTunnelSummaries(TunnelSummariesT&& value) {
    m_tunnelSummariesHasBeenSet = true;
    m_tunnelSummaries = std::forward<TunnelSummariesT>(value);
  }
  template <typename TunnelSummariesT = Aws::Vector<TunnelSummary>>
  ListTunnelsResult& WithTunnelSummaries(TunnelSummariesT&& value) {
    SetTunnelSummaries(std::forward<TunnelSummariesT>(value));
    return *this;
  }
  template <typename TunnelSummariesT = TunnelSummary>
  ListTunnelsResult& AddTunnelSummaries(TunnelSummariesT&& value) {
    m_tunnelSummariesHasBeenSet = true;
    m_tunnelSummaries.emplace_back(std::forward<TunnelSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTunnelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTunnelsResult& WithRequestId(RequestIdT&& value) {
