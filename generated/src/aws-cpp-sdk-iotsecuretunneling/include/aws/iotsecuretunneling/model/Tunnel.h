...
class Tunnel {
 public:
  ...
  inline Tunnel& WithStatus(TunnelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceConnectionState(SourceConnectionStateT&& value) {
    ...
    m_sourceConnectionState = std::forward<SourceConnectionStateT>(value);
  }
  template <typename SourceConnectionStateT = ConnectionState>
  Tunnel& WithSourceConnectionState(SourceConnectionStateT&& value) {
    SetSourceConnectionState(std::forward<SourceConnectionStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationConnectionState(DestinationConnectionStateT&& value) {
    ...
    m_destinationConnectionState = std::forward<DestinationConnectionStateT>(value);
  }
  template <typename DestinationConnectionStateT = ConnectionState>
  Tunnel& WithDestinationConnectionState(DestinationConnectionStateT&& value) {
    SetDestinationConnectionState(std::forward<DestinationConnectionStateT>(value));
    return *this;
  }
  ///@}
