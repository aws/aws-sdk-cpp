...
namespace Model
{
  ...
  {
  public:
    AWS_IOTSECURETUNNELING_API Tag() = default;
    AWS_IOTSECURETUNNELING_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_IOTSECURETUNNELING_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
