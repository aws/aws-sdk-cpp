...
namespace Model
{
  ...
  {
  public:
    AWS_IOTSECURETUNNELING_API ListTagsForResourceResult() = default;
    AWS_IOTSECURETUNNELING_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_IOTSECURETUNNELING_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
