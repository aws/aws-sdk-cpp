...
namespace Model
{
  ...
  {
  public:
    AWS_IOTSECURETUNNELING_API CloseTunnelResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CloseTunnelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
