...
class AWS_IOTSECURETUNNELING_API IoTSecureTunnelingClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IoTSecureTunnelingClient(const Aws::IoTSecureTunneling::IoTSecureTunnelingClientConfiguration& clientConfiguration =
  ...
  IoTSecureTunnelingClient(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<IoTSecureTunnelingEndpointProviderBase> endpointProvider = nullptr,
                           const Aws::IoTSecureTunneling::IoTSecureTunnelingClientConfiguration& clientConfiguration =
                               Aws::IoTSecureTunneling::IoTSecureTunnelingClientConfiguration());
  ...
  /**
   * An Async wrapper for CloseTunnel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CloseTunnelRequestT = Model::CloseTunnelRequest>
  void CloseTunnelAsync(const CloseTunnelRequestT& request, const CloseTunnelResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for DescribeTunnel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeTunnelRequestT = Model::DescribeTunnelRequest>
  void DescribeTunnelAsync(const DescribeTunnelRequestT& request, const DescribeTunnelResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListTunnels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListTunnelsRequestT = Model::ListTunnelsRequest>
  void ListTunnelsAsync(const ListTunnelsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListTunnelsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for OpenTunnel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename OpenTunnelRequestT = Model::OpenTunnelRequest>
  void OpenTunnelAsync(const OpenTunnelResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const OpenTunnelRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RotateTunnelAccessToken that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RotateTunnelAccessToken that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RotateTunnelAccessTokenRequestT = Model::RotateTunnelAccessTokenRequest>
  void RotateTunnelAccessTokenAsync(const RotateTunnelAccessTokenRequestT& request,
                                    const RotateTunnelAccessTokenResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
