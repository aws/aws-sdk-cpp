...
namespace Model
{
  ...
  /**
   */
  class GetSiteRequest : public IoTRoboRunnerRequest
  {
  public:
    AWS_IOTROBORUNNER_API GetSiteRequest();
    ...
    inline GetSiteRequest& WithId(const Aws::String& value) { SetId(value); return *this;}

    
    inline GetSiteRequest& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}

    
    inline GetSiteRequest& WithId(const char* value) { SetId(value); return *this;}
