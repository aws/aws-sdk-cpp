...
namespace Model
{
  ...
  public:
    ...
    inline UpdateWorkerFleetResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateWorkerFleetResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateWorkerFleetResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
