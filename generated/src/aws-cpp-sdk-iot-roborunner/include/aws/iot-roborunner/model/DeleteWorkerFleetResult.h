...
namespace Model
{
  ...
  public:
    ...
    inline DeleteWorkerFleetResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteWorkerFleetResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteWorkerFleetResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
