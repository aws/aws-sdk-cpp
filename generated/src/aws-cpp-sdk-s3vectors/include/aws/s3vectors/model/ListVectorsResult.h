...
class ListVectorsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListVectorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VectorsT = Aws::Vector<ListOutputVector>>
  ListVectorsResult& WithVectors(VectorsT&& value) {
    SetVectors(std::forward<VectorsT>(value));
    return *this;
  }
  template <typename VectorsT = ListOutputVector>
  ListVectorsResult& AddVectors(VectorsT&& value) {
    m_vectorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListVectorsResult& WithRequestId(RequestIdT&& value) {
