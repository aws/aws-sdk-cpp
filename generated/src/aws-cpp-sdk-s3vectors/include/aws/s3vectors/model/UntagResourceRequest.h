...
/**
 */
class UntagResourceRequest : public S3VectorsRequest {
 public:
  AWS_S3VECTORS_API UntagResourceRequest() = default;
  ...
  AWS_S3VECTORS_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;

  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the Amazon S3 Vectors resource that you're
  ...
  ///@{
  /**
   * <p>The array of tag keys that you're removing from the S3 Vectors resource. For
