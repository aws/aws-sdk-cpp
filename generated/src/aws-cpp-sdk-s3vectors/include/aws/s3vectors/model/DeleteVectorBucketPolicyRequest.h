...
class DeleteVectorBucketPolicyRequest : public S3VectorsRequest {
 public:
  ...
  template <typename VectorBucketNameT = Aws::String>
  DeleteVectorBucketPolicyRequest& WithVectorBucketName(VectorBucketNameT&& value) {
  ...
  template <typename VectorBucketArnT = Aws::String>
  DeleteVectorBucketPolicyRequest& WithVectorBucketArn(VectorBucketArnT&& value) {
