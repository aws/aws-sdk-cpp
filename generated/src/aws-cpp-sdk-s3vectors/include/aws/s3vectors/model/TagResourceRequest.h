...
/**
 */
class TagResourceRequest : public S3VectorsRequest {
 public:
  AWS_S3VECTORS_API TagResourceRequest() = default;
  ...
  ///@{
  /**
   * <p>The user-defined tag that you want to add to the specified S3 Vectors
