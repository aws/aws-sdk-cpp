...
namespace Model
{
  ...
  public:
    ...
    template<typename KeyT = Aws::String>
    ListOutputVector& WithKey(KeyT&& value) { SetKey(std::forward<KeyT>(value)); return *this;}
    ///@}
    ...
    template<typename DataT = VectorData>
    ListOutputVector& WithData(DataT&& value) { SetData(std::forward<DataT>(value)); return *this;}
    ///@}
    ...
    template<typename MetadataT = Aws::Utils::Document>
    ListOutputVector& WithMetadata(MetadataT&& value) { SetMetadata(std::forward<MetadataT>(value)); return *this;}
    ///@}
  private:
