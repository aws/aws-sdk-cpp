...
class ListVectorsRequest : public S3VectorsRequest {
 public:
  ...
  template <typename VectorBucketNameT = Aws::String>
  ListVectorsRequest& WithVectorBucketName(VectorBucketNameT&& value) {
  ...
  template <typename IndexNameT = Aws::String>
  ListVectorsRequest& WithIndexName(IndexNameT&& value) {
  ...
  template <typename IndexArnT = Aws::String>
  ListVectorsRequest& WithIndexArn(IndexArnT&& value) {
  ...
  inline ListVectorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVectorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetSegmentCount(int value) {
    m_segmentCountHasBeenSet = true;
    m_segmentCount = value;
  }
  inline ListVectorsRequest& WithSegmentCount(int value) {
  ...
  inline void SetSegmentIndex(int value) {
    m_segmentIndexHasBeenSet = true;
    m_segmentIndex = value;
  }
  inline ListVectorsRequest& WithSegmentIndex(int value) {
  ...
  inline ListVectorsRequest& WithReturnData(bool value) {
    SetReturnData(value);
    return *this;
  }
  ///@}
  ...
  inline ListVectorsRequest& WithReturnMetadata(bool value) {
