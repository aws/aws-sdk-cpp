...
namespace Model
{
  ...
  public:
    ...
    template<typename VectorBucketNameT = Aws::String>
    DeleteVectorsRequest& WithVectorBucketName(VectorBucketNameT&& value) { SetVectorBucketName(std::forward<VectorBucketNameT>(value)); return *this;}
    ///@}
    ...
    template<typename IndexNameT = Aws::String>
    DeleteVectorsRequest& WithIndexName(IndexNameT&& value) { SetIndexName(std::forward<IndexNameT>(value)); return *this;}
    ///@}
    ...
    template<typename IndexArnT = Aws::String>
    DeleteVectorsRequest& WithIndexArn(IndexArnT&& value) { SetIndexArn(std::forward<IndexArnT>(value)); return *this;}
    ///@}
    ...
    template<typename KeysT = Aws::Vector<Aws::String>>
    DeleteVectorsRequest& WithKeys(KeysT&& value) { SetKeys(std::forward<KeysT>(value)); return *this;}
    template<typename KeysT = Aws::String>
    DeleteVectorsRequest& AddKeys(KeysT&& value) { m_keysHasBeenSet = true; m_keys.emplace_back(std::forward<KeysT>(value)); return *this; }
    ///@}
  private:
