...
namespace Model
{
  ...
  {
  public:
    AWS_S3VECTORS_API GetIndexResult() = default;
    AWS_S3VECTORS_API GetIndexResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_S3VECTORS_API GetIndexResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename IndexT = Index>
    GetIndexResult& WithIndex(IndexT&& value) { SetIndex(std::forward<IndexT>(value)); return *this;}
    ///@}
