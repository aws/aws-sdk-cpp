...
namespace Model
{
  ...
  /**
   */
  class DeleteIndexRequest : public S3VectorsRequest
  {
  public:
    AWS_S3VECTORS_API DeleteIndexRequest() = default;
    ...
    template<typename VectorBucketNameT = Aws::String>
    DeleteIndexRequest& WithVectorBucketName(VectorBucketNameT&& value) { SetVectorBucketName(std::forward<VectorBucketNameT>(value)); return *this;}
    ///@}
    ...
    template<typename IndexArnT = Aws::String>
    DeleteIndexRequest& WithIndexArn(IndexArnT&& value) { SetIndexArn(std::forward<IndexArnT>(value)); return *this;}
    ///@}
  private:
