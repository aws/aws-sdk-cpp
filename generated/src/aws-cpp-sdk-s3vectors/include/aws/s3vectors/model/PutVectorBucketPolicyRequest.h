...
class PutVectorBucketPolicyRequest : public S3VectorsRequest {
 public:
  ...
  template <typename VectorBucketNameT = Aws::String>
  PutVectorBucketPolicyRequest& WithVectorBucketName(VectorBucketNameT&& value) {
  ...
  template <typename VectorBucketArnT = Aws::String>
  PutVectorBucketPolicyRequest& WithVectorBucketArn(VectorBucketArnT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  PutVectorBucketPolicyRequest& WithPolicy(PolicyT&& value) {
