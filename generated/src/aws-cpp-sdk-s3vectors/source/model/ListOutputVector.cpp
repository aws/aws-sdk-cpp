...
ListOutputVector::ListOutputVector(JsonView jsonValue) { *this = jsonValue; }

ListOutputVector& ListOutputVector::operator=(JsonView jsonValue) {
...
JsonValue ListOutputVector::Jsonize() const {
  JsonValue payload;
