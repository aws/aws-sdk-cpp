...
GetVectorsResult::GetVectorsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetVectorsResult& GetVectorsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
