...
PutInputVector::PutInputVector(JsonView jsonValue) { *this = jsonValue; }

PutInputVector& PutInputVector::operator=(JsonView jsonValue) {
...
JsonValue PutInputVector::Jsonize() const {
  JsonValue payload;
