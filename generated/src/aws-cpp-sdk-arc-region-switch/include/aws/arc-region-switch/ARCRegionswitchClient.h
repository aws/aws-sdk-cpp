  ...
  class AWS_ARCREGIONSWITCH_API ARCRegionswitchClient : public Aws::Client::AWSJsonClient, public Aws::Client::ClientWithAsyncTemplateMethods<ARCRegionswitchClient>
  {
    public:
      ...
      typedef ARCRegionswitchEndpointProvider EndpointProviderType;
        ...
        */
        ARCRegionswitchClient(const Aws::ARCRegionswitch::ARCRegionswitchClientConfiguration& clientConfiguration = Aws::ARCRegionswitch::ARCRegionswitchClientConfiguration(),
        ...
        */
        ARCRegionswitchClient(const Aws::Auth::AWSCredentials& credentials,
                              std::shared_ptr<ARCRegionswitchEndpointProviderBase> endpointProvider = nullptr,
                              const Aws::ARCRegionswitch::ARCRegionswitchClientConfiguration& clientConfiguration = Aws::ARCRegionswitch::ARCRegionswitchClientConfiguration());
        ...
        */
        ...
        /**
         * A Callable wrapper for ApprovePlanExecutionStep that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ApprovePlanExecutionStep that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ApprovePlanExecutionStepRequestT = Model::ApprovePlanExecutionStepRequest>
        void ApprovePlanExecutionStepAsync(const ApprovePlanExecutionStepRequestT& request, const ApprovePlanExecutionStepResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for CancelPlanExecution that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for CancelPlanExecution that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename CancelPlanExecutionRequestT = Model::CancelPlanExecutionRequest>
        void CancelPlanExecutionAsync(const CancelPlanExecutionRequestT& request, const CancelPlanExecutionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * An Async wrapper for CreatePlan that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename CreatePlanRequestT = Model::CreatePlanRequest>
        void CreatePlanAsync(const CreatePlanRequestT& request, const CreatePlanResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * An Async wrapper for DeletePlan that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename DeletePlanRequestT = Model::DeletePlanRequest>
        void DeletePlanAsync(const DeletePlanRequestT& request, const DeletePlanResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for GetPlanEvaluationStatus that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetPlanEvaluationStatus that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename GetPlanEvaluationStatusRequestT = Model::GetPlanEvaluationStatusRequest>
        void GetPlanEvaluationStatusAsync(const GetPlanEvaluationStatusRequestT& request, const GetPlanEvaluationStatusResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for GetPlanExecution that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetPlanExecution that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename GetPlanExecutionRequestT = Model::GetPlanExecutionRequest>
        void GetPlanExecutionAsync(const GetPlanExecutionRequestT& request, const GetPlanExecutionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * An Async wrapper for GetPlanInRegion that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename GetPlanInRegionRequestT = Model::GetPlanInRegionRequest>
        void GetPlanInRegionAsync(const GetPlanInRegionRequestT& request, const GetPlanInRegionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for ListPlanExecutionEvents that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ListPlanExecutionEvents that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ListPlanExecutionEventsRequestT = Model::ListPlanExecutionEventsRequest>
        void ListPlanExecutionEventsAsync(const ListPlanExecutionEventsRequestT& request, const ListPlanExecutionEventsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for ListPlanExecutions that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ListPlanExecutions that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ListPlanExecutionsRequestT = Model::ListPlanExecutionsRequest>
        void ListPlanExecutionsAsync(const ListPlanExecutionsRequestT& request, const ListPlanExecutionsResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * An Async wrapper for ListPlans that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ListPlansRequestT = Model::ListPlansRequest>
        void ListPlansAsync(const ListPlansResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const ListPlansRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for ListPlansInRegion that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ListPlansInRegion that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ListPlansInRegionRequestT = Model::ListPlansInRegionRequest>
        void ListPlansInRegionAsync(const ListPlansInRegionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const ListPlansInRegionRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for ListRoute53HealthChecks that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ListRoute53HealthChecks that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ListRoute53HealthChecksRequestT = Model::ListRoute53HealthChecksRequest>
        void ListRoute53HealthChecksAsync(const ListRoute53HealthChecksRequestT& request, const ListRoute53HealthChecksResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for StartPlanExecution that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for StartPlanExecution that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename StartPlanExecutionRequestT = Model::StartPlanExecutionRequest>
        void StartPlanExecutionAsync(const StartPlanExecutionRequestT& request, const StartPlanExecutionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * An Async wrapper for UpdatePlan that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename UpdatePlanRequestT = Model::UpdatePlanRequest>
        void UpdatePlanAsync(const UpdatePlanRequestT& request, const UpdatePlanResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for UpdatePlanExecution that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for UpdatePlanExecution that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename UpdatePlanExecutionRequestT = Model::UpdatePlanExecutionRequest>
        void UpdatePlanExecutionAsync(const UpdatePlanExecutionRequestT& request, const UpdatePlanExecutionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for UpdatePlanExecutionStep that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for UpdatePlanExecutionStep that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename UpdatePlanExecutionStepRequestT = Model::UpdatePlanExecutionStepRequest>
        void UpdatePlanExecutionStepAsync(const UpdatePlanExecutionStepRequestT& request, const UpdatePlanExecutionStepResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
