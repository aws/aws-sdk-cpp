...
typedef std::function<void(const ARCRegionswitchClient*, const Model::ApprovePlanExecutionStepRequest&,
                           const Model::ApprovePlanExecutionStepOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ApprovePlanExecutionStepResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::CancelPlanExecutionRequest&, const Model::CancelPlanExecutionOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CancelPlanExecutionResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::CreatePlanRequest&, const Model::CreatePlanOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreatePlanResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::DeletePlanRequest&, const Model::DeletePlanOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeletePlanResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::GetPlanRequest&, const Model::GetPlanOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetPlanResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::GetPlanEvaluationStatusRequest&,
                           const Model::GetPlanEvaluationStatusOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetPlanEvaluationStatusResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::GetPlanExecutionRequest&, const Model::GetPlanExecutionOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetPlanExecutionResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::GetPlanInRegionRequest&, const Model::GetPlanInRegionOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetPlanInRegionResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::ListPlanExecutionEventsRequest&,
                           const Model::ListPlanExecutionEventsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListPlanExecutionEventsResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::ListPlanExecutionsRequest&, const Model::ListPlanExecutionsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListPlanExecutionsResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::ListPlansRequest&, const Model::ListPlansOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListPlansResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::ListPlansInRegionRequest&, const Model::ListPlansInRegionOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
...
typedef std::function<void(const ARCRegionswitchClient*, const Model::StartPlanExecutionRequest&, const Model::StartPlanExecutionOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartPlanExecutionResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::UpdatePlanRequest&, const Model::UpdatePlanOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdatePlanResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::UpdatePlanExecutionRequest&, const Model::UpdatePlanExecutionOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdatePlanExecutionResponseReceivedHandler;
typedef std::function<void(const ARCRegionswitchClient*, const Model::UpdatePlanExecutionStepRequest&,
                           const Model::UpdatePlanExecutionStepOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
