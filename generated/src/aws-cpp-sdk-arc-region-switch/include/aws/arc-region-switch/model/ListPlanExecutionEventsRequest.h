...
class ListPlanExecutionEventsRequest : public ARCRegionswitchRequest {
 public:
  ...
  template <typename PlanArnT = Aws::String>
  ListPlanExecutionEventsRequest& WithPlanArn(PlanArnT&& value) {
  ...
  template <typename ExecutionIdT = Aws::String>
  ListPlanExecutionEventsRequest& WithExecutionId(ExecutionIdT&& value) {
  ...
  inline ListPlanExecutionEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPlanExecutionEventsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListPlanExecutionEventsRequest& WithName(NameT&& value) {
