...
class ListPlansResult {
 public:
  ...
  void SetPlans(PlansT&& value) {
    m_plansHasBeenSet = true;
    m_plans = std::forward<PlansT>(value);
  }
  template <typename PlansT = Aws::Vector<AbbreviatedPlan>>
  ListPlansResult& WithPlans(PlansT&& value) {
    SetPlans(std::forward<PlansT>(value));
    return *this;
  }
  template <typename PlansT = AbbreviatedPlan>
  ListPlansResult& AddPlans(PlansT&& value) {
    m_plansHasBeenSet = true;
    m_plans.emplace_back(std::forward<PlansT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPlansResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPlansResult& WithRequestId(RequestIdT&& value) {
