...
class AbbreviatedExecution {
 public:
  ...
  template <typename PlanArnT = Aws::String>
  AbbreviatedExecution& WithPlanArn(PlanArnT&& value) {
  ...
  template <typename ExecutionIdT = Aws::String>
  AbbreviatedExecution& WithExecutionId(ExecutionIdT&& value) {
  ...
  template <typename VersionT = Aws::String>
  AbbreviatedExecution& WithVersion(VersionT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  AbbreviatedExecution& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename CommentT = Aws::String>
  AbbreviatedExecution& WithComment(CommentT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  AbbreviatedExecution& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  AbbreviatedExecution& WithEndTime(EndTimeT&& value) {
  ...
  inline AbbreviatedExecution& WithMode(ExecutionMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExecutionState(ExecutionState value) {
    m_executionStateHasBeenSet = true;
    m_executionState = value;
  }
  inline AbbreviatedExecution& WithExecutionState(ExecutionState value) {
  ...
  inline void SetExecutionAction(ExecutionAction value) {
    m_executionActionHasBeenSet = true;
    m_executionAction = value;
  }
  inline AbbreviatedExecution& WithExecutionAction(ExecutionAction value) {
  ...
  void SetExecutionRegion(ExecutionRegionT&& value) {
    m_executionRegionHasBeenSet = true;
    m_executionRegion = std::forward<ExecutionRegionT>(value);
  }
  template <typename ExecutionRegionT = Aws::String>
  AbbreviatedExecution& WithExecutionRegion(ExecutionRegionT&& value) {
    SetExecutionRegion(std::forward<ExecutionRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActualRecoveryTime(ActualRecoveryTimeT&& value) {
    m_actualRecoveryTimeHasBeenSet = true;
    m_actualRecoveryTime = std::forward<ActualRecoveryTimeT>(value);
  }
  template <typename ActualRecoveryTimeT = Aws::String>
  AbbreviatedExecution& WithActualRecoveryTime(ActualRecoveryTimeT&& value) {
    SetActualRecoveryTime(std::forward<ActualRecoveryTimeT>(value));
    return *this;
  }
  ///@}
 private:
