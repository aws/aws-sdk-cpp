...
class Route53HealthCheckConfiguration {
 public:
  ...
  inline Route53HealthCheckConfiguration& WithTimeoutMinutes(int value) {
  ...
  template <typename CrossAccountRoleT = Aws::String>
  Route53HealthCheckConfiguration& WithCrossAccountRole(CrossAccountRoleT&& value) {
  ...
  template <typename ExternalIdT = Aws::String>
  Route53HealthCheckConfiguration& WithExternalId(ExternalIdT&& value) {
  ...
  template <typename HostedZoneIdT = Aws::String>
  Route53HealthCheckConfiguration& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  void SetRecordName(RecordNameT&& value) {
    ...
    m_recordName = std::forward<RecordNameT>(value);
  }
  template <typename RecordNameT = Aws::String>
  Route53HealthCheckConfiguration& WithRecordName(RecordNameT&& value) {
    SetRecordName(std::forward<RecordNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecordSets(RecordSetsT&& value) {
    m_recordSetsHasBeenSet = true;
    m_recordSets = std::forward<RecordSetsT>(value);
  }
  template <typename RecordSetsT = Aws::Vector<Route53ResourceRecordSet>>
  Route53HealthCheckConfiguration& WithRecordSets(RecordSetsT&& value) {
    SetRecordSets(std::forward<RecordSetsT>(value));
    return *this;
  }
  template <typename RecordSetsT = Route53ResourceRecordSet>
  Route53HealthCheckConfiguration& AddRecordSets(RecordSetsT&& value) {
    m_recordSetsHasBeenSet = true;
    m_recordSets.emplace_back(std::forward<RecordSetsT>(value));
    return *this;
  }
  ///@}
 private:
