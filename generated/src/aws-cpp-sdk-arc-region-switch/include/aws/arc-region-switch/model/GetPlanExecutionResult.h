...
class GetPlanExecutionResult {
 public:
  ...
  template <typename PlanArnT = Aws::String>
  GetPlanExecutionResult& WithPlanArn(PlanArnT&& value) {
  ...
  template <typename ExecutionIdT = Aws::String>
  GetPlanExecutionResult& WithExecutionId(ExecutionIdT&& value) {
  ...
  template <typename VersionT = Aws::String>
  GetPlanExecutionResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetPlanExecutionResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename CommentT = Aws::String>
  GetPlanExecutionResult& WithComment(CommentT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  GetPlanExecutionResult& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  GetPlanExecutionResult& WithEndTime(EndTimeT&& value) {
  ...
  inline GetPlanExecutionResult& WithMode(ExecutionMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline GetPlanExecutionResult& WithExecutionState(ExecutionState value) {
  ...
  inline GetPlanExecutionResult& WithExecutionAction(ExecutionAction value) {
  ...
  template <typename ExecutionRegionT = Aws::String>
  GetPlanExecutionResult& WithExecutionRegion(ExecutionRegionT&& value) {
  ...
  template <typename StepStatesT = Aws::Vector<StepState>>
  GetPlanExecutionResult& WithStepStates(StepStatesT&& value) {
    SetStepStates(std::forward<StepStatesT>(value));
    return *this;
  }
  template <typename StepStatesT = StepState>
  GetPlanExecutionResult& AddStepStates(StepStatesT&& value) {
    m_stepStatesHasBeenSet = true;
    m_stepStates.emplace_back(std::forward<StepStatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PlanT = Plan>
  GetPlanExecutionResult& WithPlan(PlanT&& value) {
  ...
  template <typename ActualRecoveryTimeT = Aws::String>
  GetPlanExecutionResult& WithActualRecoveryTime(ActualRecoveryTimeT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetPlanExecutionResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPlanExecutionResult& WithRequestId(RequestIdT&& value) {
