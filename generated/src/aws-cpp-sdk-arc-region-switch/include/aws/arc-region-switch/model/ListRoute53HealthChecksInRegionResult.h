...
namespace Model {
class ListRoute53HealthChecksInRegionResult {
 public:
  AWS_ARCREGIONSWITCH_API ListRoute53HealthChecksInRegionResult() = default;
  AWS_ARCREGIONSWITCH_API ListRoute53HealthChecksInRegionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ARCREGIONSWITCH_API ListRoute53HealthChecksInRegionResult& operator=(
  ...
  template <typename HealthChecksT = Aws::Vector<Route53HealthCheck>>
  ListRoute53HealthChecksInRegionResult& WithHealthChecks(HealthChecksT&& value) {
    SetHealthChecks(std::forward<HealthChecksT>(value));
    return *this;
  }
  template <typename HealthChecksT = Route53HealthCheck>
  ListRoute53HealthChecksInRegionResult& AddHealthChecks(HealthChecksT&& value) {
    m_healthChecksHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRoute53HealthChecksInRegionResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRoute53HealthChecksInRegionResult& WithRequestId(RequestIdT&& value) {
