...
class ExecutionEvent {
 public:
  ...
  template <typename TimestampT = Aws::Utils::DateTime>
  ExecutionEvent& WithTimestamp(TimestampT&& value) {
  ...
  inline void SetType(ExecutionEventType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ExecutionEvent& WithType(ExecutionEventType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename StepNameT = Aws::String>
  ExecutionEvent& WithStepName(StepNameT&& value) {
  ...
  inline void SetExecutionBlockType(ExecutionBlockType value) {
    m_executionBlockTypeHasBeenSet = true;
    m_executionBlockType = value;
  }
  inline ExecutionEvent& WithExecutionBlockType(ExecutionBlockType value) {
    SetExecutionBlockType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourcesT = Aws::Vector<Aws::String>>
  ExecutionEvent& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Aws::String>
  ExecutionEvent& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename ErrorT = Aws::String>
  ExecutionEvent& WithError(ErrorT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ExecutionEvent& WithDescription(DescriptionT&& value) {
  ...
  template <typename EventIdT = Aws::String>
  ExecutionEvent& WithEventId(EventIdT&& value) {
  ...
  void SetPreviousEventId(PreviousEventIdT&& value) {
    m_previousEventIdHasBeenSet = true;
    m_previousEventId = std::forward<PreviousEventIdT>(value);
  }
  template <typename PreviousEventIdT = Aws::String>
  ExecutionEvent& WithPreviousEventId(PreviousEventIdT&& value) {
    SetPreviousEventId(std::forward<PreviousEventIdT>(value));
    return *this;
  }
  ///@}
 private:
