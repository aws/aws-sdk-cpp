...
class UpdatePlanExecutionStepRequest : public ARCRegionswitchRequest {
 public:
  ...
  template <typename PlanArnT = Aws::String>
  UpdatePlanExecutionStepRequest& WithPlanArn(PlanArnT&& value) {
  ...
  template <typename ExecutionIdT = Aws::String>
  UpdatePlanExecutionStepRequest& WithExecutionId(ExecutionIdT&& value) {
  ...
  template <typename CommentT = Aws::String>
  UpdatePlanExecutionStepRequest& WithComment(CommentT&& value) {
  ...
  template <typename StepNameT = Aws::String>
  UpdatePlanExecutionStepRequest& WithStepName(StepNameT&& value) {
  ...
  inline void SetActionToTake(UpdatePlanExecutionStepAction value) {
    m_actionToTakeHasBeenSet = true;
    m_actionToTake = value;
  }
  inline UpdatePlanExecutionStepRequest& WithActionToTake(UpdatePlanExecutionStepAction value) {
    SetActionToTake(value);
    return *this;
  }
  ///@}
 private:
