...
class ListRoute53HealthChecksRequest : public ARCRegionswitchRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListRoute53HealthChecksRequest& WithArn(ArnT&& value) {
  ...
  template <typename HostedZoneIdT = Aws::String>
  ListRoute53HealthChecksRequest& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  template <typename RecordNameT = Aws::String>
  ListRoute53HealthChecksRequest& WithRecordName(RecordNameT&& value) {
  ...
  inline ListRoute53HealthChecksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRoute53HealthChecksRequest& WithNextToken(NextTokenT&& value) {
