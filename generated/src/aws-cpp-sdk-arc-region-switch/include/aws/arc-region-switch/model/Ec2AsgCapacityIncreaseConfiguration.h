...
class Ec2AsgCapacityIncreaseConfiguration {
 public:
  ...
  inline Ec2AsgCapacityIncreaseConfiguration& WithTimeoutMinutes(int value) {
  ...
  void SetAsgs(AsgsT&& value) {
    m_asgsHasBeenSet = true;
    m_asgs = std::forward<AsgsT>(value);
  }
  template <typename AsgsT = Aws::Vector<Asg>>
  Ec2AsgCapacityIncreaseConfiguration& WithAsgs(AsgsT&& value) {
    SetAsgs(std::forward<AsgsT>(value));
    return *this;
  }
  template <typename AsgsT = Asg>
  Ec2AsgCapacityIncreaseConfiguration& AddAsgs(AsgsT&& value) {
    m_asgsHasBeenSet = true;
    m_asgs.emplace_back(std::forward<AsgsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UngracefulT = Ec2Ungraceful>
  Ec2AsgCapacityIncreaseConfiguration& WithUngraceful(UngracefulT&& value) {
  ...
  inline Ec2AsgCapacityIncreaseConfiguration& WithTargetPercent(int value) {
  ...
  inline void SetCapacityMonitoringApproach(Ec2AsgCapacityMonitoringApproach value) {
    m_capacityMonitoringApproachHasBeenSet = true;
    m_capacityMonitoringApproach = value;
  }
  inline Ec2AsgCapacityIncreaseConfiguration& WithCapacityMonitoringApproach(Ec2AsgCapacityMonitoringApproach value) {
    SetCapacityMonitoringApproach(value);
    return *this;
  }
  ///@}
 private:
