...
class AssociatedAlarm {
 public:
  ...
  template <typename CrossAccountRoleT = Aws::String>
  AssociatedAlarm& WithCrossAccountRole(CrossAccountRoleT&& value) {
  ...
  template <typename ExternalIdT = Aws::String>
  AssociatedAlarm& WithExternalId(ExternalIdT&& value) {
  ...
  template <typename ResourceIdentifierT = Aws::String>
  AssociatedAlarm& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  inline void SetAlarmType(AlarmType value) {
    m_alarmTypeHasBeenSet = true;
    m_alarmType = value;
  }
  inline AssociatedAlarm& WithAlarmType(AlarmType value) {
    SetAlarmType(value);
    return *this;
  }
  ///@}
