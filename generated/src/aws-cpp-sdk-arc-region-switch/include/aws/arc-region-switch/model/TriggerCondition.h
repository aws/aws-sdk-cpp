...
class TriggerCondition {
 public:
  ...
  void SetAssociatedAlarmName(AssociatedAlarmNameT&& value) {
    m_associatedAlarmNameHasBeenSet = true;
    m_associatedAlarmName = std::forward<AssociatedAlarmNameT>(value);
  }
  template <typename AssociatedAlarmNameT = Aws::String>
  TriggerCondition& WithAssociatedAlarmName(AssociatedAlarmNameT&& value) {
    SetAssociatedAlarmName(std::forward<AssociatedAlarmNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCondition(AlarmCondition value) {
    m_conditionHasBeenSet = true;
    m_condition = value;
  }
  inline TriggerCondition& WithCondition(AlarmCondition value) {
    SetCondition(value);
    return *this;
  }
  ///@}
