...
class GetPlanEvaluationStatusResult {
 public:
  ...
  template <typename PlanArnT = Aws::String>
  GetPlanEvaluationStatusResult& WithPlanArn(PlanArnT&& value) {
  ...
  template <typename LastEvaluationTimeT = Aws::Utils::DateTime>
  GetPlanEvaluationStatusResult& WithLastEvaluationTime(LastEvaluationTimeT&& value) {
  ...
  void SetLastEvaluatedVersion(LastEvaluatedVersionT&& value) {
    m_lastEvaluatedVersionHasBeenSet = true;
    m_lastEvaluatedVersion = std::forward<LastEvaluatedVersionT>(value);
  }
  template <typename LastEvaluatedVersionT = Aws::String>
  GetPlanEvaluationStatusResult& WithLastEvaluatedVersion(LastEvaluatedVersionT&& value) {
    SetLastEvaluatedVersion(std::forward<LastEvaluatedVersionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RegionT = Aws::String>
  GetPlanEvaluationStatusResult& WithRegion(RegionT&& value) {
  ...
  inline void SetEvaluationState(EvaluationStatus value) {
    m_evaluationStateHasBeenSet = true;
    m_evaluationState = value;
  }
  inline GetPlanEvaluationStatusResult& WithEvaluationState(EvaluationStatus value) {
  ...
  template <typename WarningsT = Aws::Vector<ResourceWarning>>
  GetPlanEvaluationStatusResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = ResourceWarning>
  GetPlanEvaluationStatusResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetPlanEvaluationStatusResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPlanEvaluationStatusResult& WithRequestId(RequestIdT&& value) {
