...
/**
 * <p>Configuration for promoting an Amazon RDS read replica to a standalone
 * database instance during a Region switch.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/arc-region-switch-2022-07-26/RdsPromoteReadReplicaConfiguration">AWS
 * API Reference</a></p>
 */
class RdsPromoteReadReplicaConfiguration {
 public:
  AWS_ARCREGIONSWITCH_API RdsPromoteReadReplicaConfiguration() = default;
  AWS_ARCREGIONSWITCH_API RdsPromoteReadReplicaConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_ARCREGIONSWITCH_API RdsPromoteReadReplicaConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline RdsPromoteReadReplicaConfiguration& WithTimeoutMinutes(int value) {
  ...
  template <typename CrossAccountRoleT = Aws::String>
  RdsPromoteReadReplicaConfiguration& WithCrossAccountRole(CrossAccountRoleT&& value) {
  ...
  template <typename ExternalIdT = Aws::String>
  RdsPromoteReadReplicaConfiguration& WithExternalId(ExternalIdT&& value) {
  ...
  template <typename DbInstanceArnMapT = Aws::Map<Aws::String, Aws::String>>
  RdsPromoteReadReplicaConfiguration& WithDbInstanceArnMap(DbInstanceArnMapT&& value) {
  ...
  RdsPromoteReadReplicaConfiguration& AddDbInstanceArnMap(DbInstanceArnMapKeyT&& key, DbInstanceArnMapValueT&& value) {
    m_dbInstanceArnMapHasBeenSet = true;
