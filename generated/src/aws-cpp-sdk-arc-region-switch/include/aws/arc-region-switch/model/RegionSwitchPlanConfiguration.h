...
class RegionSwitchPlanConfiguration {
 public:
  ...
  template <typename CrossAccountRoleT = Aws::String>
  RegionSwitchPlanConfiguration& WithCrossAccountRole(CrossAccountRoleT&& value) {
  ...
  template <typename ExternalIdT = Aws::String>
  RegionSwitchPlanConfiguration& WithExternalId(ExternalIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  RegionSwitchPlanConfiguration& WithArn(ArnT&& value) {
