...
/**
 * <p>The client token was already used with different request parameters. A client
 * token must map to the same parameters for every request. To retry this
 * operation, provide a new client token.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/arc-region-switch-2022-07-26/ConflictException">AWS
 * API Reference</a></p>
 */
class ConflictException {
 public:
  AWS_ARCREGIONSWITCH_API ConflictException() = default;
  AWS_ARCREGIONSWITCH_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
  AWS_ARCREGIONSWITCH_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
