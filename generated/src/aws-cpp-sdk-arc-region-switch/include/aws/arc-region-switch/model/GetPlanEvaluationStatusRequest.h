...
class GetPlanEvaluationStatusRequest : public ARCRegionswitchRequest {
 public:
  ...
  template <typename PlanArnT = Aws::String>
  GetPlanEvaluationStatusRequest& WithPlanArn(PlanArnT&& value) {
  ...
  inline GetPlanEvaluationStatusRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetPlanEvaluationStatusRequest& WithNextToken(NextTokenT&& value) {
