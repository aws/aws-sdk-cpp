...
namespace Model
{
  ...
  /**
   */
  class CancelPlanExecutionRequest : public ARCRegionswitchRequest
  {
  public:
    AWS_ARCREGIONSWITCH_API CancelPlanExecutionRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "CancelPlanExecution"; }
    ...
    template<typename PlanArnT = Aws::String>
    CancelPlanExecutionRequest& WithPlanArn(PlanArnT&& value) { SetPlanArn(std::forward<PlanArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ExecutionIdT = Aws::String>
    CancelPlanExecutionRequest& WithExecutionId(ExecutionIdT&& value) { SetExecutionId(std::forward<ExecutionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CommentT = Aws::String>
    CancelPlanExecutionRequest& WithComment(CommentT&& value) { SetComment(std::forward<CommentT>(value)); return *this;}
    ///@}
  private:
