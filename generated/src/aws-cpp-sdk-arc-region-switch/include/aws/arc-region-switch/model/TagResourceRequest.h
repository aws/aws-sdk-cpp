...
/**
 */
class TagResourceRequest : public ARCRegionswitchRequest {
 public:
  AWS_ARCREGIONSWITCH_API TagResourceRequest() = default;
  ...
  ///@{
  /**
   * <p>Tags that you add to a resource. You can add a maximum of 50 tags in Region
   * switch.</p>
   */
