...
class StepState {
 public:
  ...
  template <typename NameT = Aws::String>
  StepState& WithName(NameT&& value) {
  ...
  inline StepState& WithStatus(StepStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  StepState& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  StepState& WithEndTime(EndTimeT&& value) {
  ...
  inline void SetStepMode(ExecutionMode value) {
    m_stepModeHasBeenSet = true;
    m_stepMode = value;
  }
  inline StepState& WithStepMode(ExecutionMode value) {
    SetStepMode(value);
    return *this;
  }
  ///@}
