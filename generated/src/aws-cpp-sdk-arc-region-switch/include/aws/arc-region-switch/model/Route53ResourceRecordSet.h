...
class Route53ResourceRecordSet {
 public:
  ...
  void SetRecordSetIdentifier(RecordSetIdentifierT&& value) {
    m_recordSetIdentifierHasBeenSet = true;
    m_recordSetIdentifier = std::forward<RecordSetIdentifierT>(value);
  }
  template <typename RecordSetIdentifierT = Aws::String>
  Route53ResourceRecordSet& WithRecordSetIdentifier(RecordSetIdentifierT&& value) {
    SetRecordSetIdentifier(std::forward<RecordSetIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RegionT = Aws::String>
  Route53ResourceRecordSet& WithRegion(RegionT&& value) {
