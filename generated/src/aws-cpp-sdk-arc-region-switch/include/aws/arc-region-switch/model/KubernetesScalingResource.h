...
class KubernetesScalingResource {
 public:
  ...
  template <typename NamespaceT = Aws::String>
  KubernetesScalingResource& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NameT = Aws::String>
  KubernetesScalingResource& WithName(NameT&& value) {
  ...
  void SetHpaName(HpaNameT&& value) {
    m_hpaNameHasBeenSet = true;
    m_hpaName = std::forward<HpaNameT>(value);
  }
  template <typename HpaNameT = Aws::String>
  KubernetesScalingResource& WithHpaName(HpaNameT&& value) {
    SetHpaName(std::forward<HpaNameT>(value));
    return *this;
  }
  ///@}
 private:
