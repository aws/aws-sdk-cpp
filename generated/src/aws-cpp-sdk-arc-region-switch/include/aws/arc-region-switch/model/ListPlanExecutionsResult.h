...
class ListPlanExecutionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<AbbreviatedExecution>>
  ListPlanExecutionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = AbbreviatedExecution>
  ListPlanExecutionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPlanExecutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPlanExecutionsResult& WithRequestId(RequestIdT&& value) {
