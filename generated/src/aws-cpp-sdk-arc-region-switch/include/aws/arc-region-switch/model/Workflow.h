...
class Workflow {
 public:
  ...
  inline void SetWorkflowTargetAction(WorkflowTargetAction value) {
    m_workflowTargetActionHasBeenSet = true;
    m_workflowTargetAction = value;
  }
  inline Workflow& WithWorkflowTargetAction(WorkflowTargetAction value) {
    SetWorkflowTargetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetWorkflowTargetRegion(WorkflowTargetRegionT&& value) {
    m_workflowTargetRegionHasBeenSet = true;
    m_workflowTargetRegion = std::forward<WorkflowTargetRegionT>(value);
  }
  template <typename WorkflowTargetRegionT = Aws::String>
  Workflow& WithWorkflowTargetRegion(WorkflowTargetRegionT&& value) {
    SetWorkflowTargetRegion(std::forward<WorkflowTargetRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorkflowDescription(WorkflowDescriptionT&& value) {
    m_workflowDescriptionHasBeenSet = true;
    m_workflowDescription = std::forward<WorkflowDescriptionT>(value);
  }
  template <typename WorkflowDescriptionT = Aws::String>
  Workflow& WithWorkflowDescription(WorkflowDescriptionT&& value) {
    SetWorkflowDescription(std::forward<WorkflowDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
