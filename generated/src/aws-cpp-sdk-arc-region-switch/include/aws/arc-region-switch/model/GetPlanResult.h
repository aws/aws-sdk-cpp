...
namespace Model
{
  ...
  {
  public:
    AWS_ARCREGIONSWITCH_API GetPlanResult() = default;
    AWS_ARCREGIONSWITCH_API GetPlanResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_ARCREGIONSWITCH_API GetPlanResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename PlanT = Plan>
    GetPlanResult& WithPlan(PlanT&& value) { SetPlan(std::forward<PlanT>(value)); return *this;}
    ///@}
