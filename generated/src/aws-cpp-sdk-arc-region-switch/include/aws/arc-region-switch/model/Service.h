...
/**
 * <p>The service for a cross account role.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/arc-region-switch-2022-07-26/Service">AWS
 * API Reference</a></p>
 */
class Service {
 public:
  AWS_ARCREGIONSWITCH_API Service() = default;
  AWS_ARCREGIONSWITCH_API Service(Aws::Utils::Json::JsonView jsonValue);
  AWS_ARCREGIONSWITCH_API Service& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename CrossAccountRoleT = Aws::String>
  Service& WithCrossAccountRole(CrossAccountRoleT&& value) {
  ...
  template <typename ExternalIdT = Aws::String>
  Service& WithExternalId(ExternalIdT&& value) {
