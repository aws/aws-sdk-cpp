...
EksResourceScalingConfiguration::EksResourceScalingConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
EksResourceScalingConfiguration& EksResourceScalingConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("capacityMonitoringApproach")) {
    m_capacityMonitoringApproach =
        EksCapacityMonitoringApproachMapper::GetEksCapacityMonitoringApproachForName(jsonValue.GetString("capacityMonitoringApproach"));
...
JsonValue EksResourceScalingConfiguration::Jsonize() const {
  ...
  if (m_capacityMonitoringApproachHasBeenSet) {
    payload.WithString("capacityMonitoringApproach",
                       EksCapacityMonitoringApproachMapper::GetNameForEksCapacityMonitoringApproach(m_capacityMonitoringApproach));
  }
