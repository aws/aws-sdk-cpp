...
Ec2AsgCapacityIncreaseConfiguration::Ec2AsgCapacityIncreaseConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
Ec2AsgCapacityIncreaseConfiguration& Ec2AsgCapacityIncreaseConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("capacityMonitoringApproach")) {
    m_capacityMonitoringApproach = Ec2AsgCapacityMonitoringApproachMapper::GetEc2AsgCapacityMonitoringApproachForName(
        jsonValue.GetString("capacityMonitoringApproach"));
...
JsonValue Ec2AsgCapacityIncreaseConfiguration::Jsonize() const {
  ...
  if (m_capacityMonitoringApproachHasBeenSet) {
    payload.WithString("capacityMonitoringApproach",
                       Ec2AsgCapacityMonitoringApproachMapper::GetNameForEc2AsgCapacityMonitoringApproach(m_capacityMonitoringApproach));
  }
