...
ExecutionBlockConfiguration::ExecutionBlockConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ExecutionBlockConfiguration& ExecutionBlockConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("parallelConfig")) {
    m_parallelConfig =
        Aws::MakeShared<ParallelExecutionBlockConfiguration>("ExecutionBlockConfiguration", jsonValue.GetObject("parallelConfig"));
