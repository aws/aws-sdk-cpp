...
RdsCreateCrossRegionReplicaConfiguration::RdsCreateCrossRegionReplicaConfiguration(JsonView jsonValue) { *this = jsonValue; }

RdsCreateCrossRegionReplicaConfiguration& RdsCreateCrossRegionReplicaConfiguration::operator=(JsonView jsonValue) {
...
JsonValue RdsCreateCrossRegionReplicaConfiguration::Jsonize() const {
  JsonValue payload;
