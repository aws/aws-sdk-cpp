...
RdsSwitchoverReadReplicaConfiguration::RdsSwitchoverReadReplicaConfiguration(JsonView jsonValue) { *this = jsonValue; }

RdsSwitchoverReadReplicaConfiguration& RdsSwitchoverReadReplicaConfiguration::operator=(JsonView jsonValue) {
...
JsonValue RdsSwitchoverReadReplicaConfiguration::Jsonize() const {
  JsonValue payload;
