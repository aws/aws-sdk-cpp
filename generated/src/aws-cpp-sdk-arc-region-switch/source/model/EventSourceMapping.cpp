...
EventSourceMapping::EventSourceMapping(JsonView jsonValue) { *this = jsonValue; }

EventSourceMapping& EventSourceMapping::operator=(JsonView jsonValue) {
...
JsonValue EventSourceMapping::Jsonize() const {
  JsonValue payload;
