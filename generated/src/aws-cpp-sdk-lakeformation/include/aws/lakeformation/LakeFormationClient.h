...
namespace LakeFormation
{
   ...
   * Formation service.</p>
   */
  class AWS_LAKEFORMATION_API LakeFormationClient : Aws::Client::ClientWithAsyncTemplateMethods<LakeFormationClient>,
    smithy::client::AwsSmithyClientT<Aws::LakeFormation::SERVICE_NAME,
