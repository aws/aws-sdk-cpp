...
class ListLFTagExpressionsRequest : public LakeFormationRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  ListLFTagExpressionsRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  inline ListLFTagExpressionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLFTagExpressionsRequest& WithNextToken(NextTokenT&& value) {
