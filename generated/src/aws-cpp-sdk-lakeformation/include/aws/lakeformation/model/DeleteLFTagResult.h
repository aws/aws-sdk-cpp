...
namespace Model
{
  ...
  public:
    ...
    inline DeleteLFTagResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteLFTagResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteLFTagResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
