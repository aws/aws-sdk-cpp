...
class PrincipalResourcePermissions {
 public:
  ...
  template <typename PrincipalT = DataLakePrincipal>
  PrincipalResourcePermissions& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename ResourceT = Resource>
  PrincipalResourcePermissions& WithResource(ResourceT&& value) {
  ...
  template <typename ConditionT = Condition>
  PrincipalResourcePermissions& WithCondition(ConditionT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<Permission>>
  PrincipalResourcePermissions& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  inline PrincipalResourcePermissions& AddPermissions(Permission value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename PermissionsWithGrantOptionT = Aws::Vector<Permission>>
  PrincipalResourcePermissions& WithPermissionsWithGrantOption(PermissionsWithGrantOptionT&& value) {
    SetPermissionsWithGrantOption(std::forward<PermissionsWithGrantOptionT>(value));
    return *this;
  }
  inline PrincipalResourcePermissions& AddPermissionsWithGrantOption(Permission value) {
    m_permissionsWithGrantOptionHasBeenSet = true;
  ...
  template <typename AdditionalDetailsT = DetailsMap>
  PrincipalResourcePermissions& WithAdditionalDetails(AdditionalDetailsT&& value) {
  ...
  template <typename LastUpdatedT = Aws::Utils::DateTime>
  PrincipalResourcePermissions& WithLastUpdated(LastUpdatedT&& value) {
  ...
  template <typename LastUpdatedByT = Aws::String>
  PrincipalResourcePermissions& WithLastUpdatedBy(LastUpdatedByT&& value) {
