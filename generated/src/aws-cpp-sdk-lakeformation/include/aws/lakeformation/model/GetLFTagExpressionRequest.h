...
class GetLFTagExpressionRequest : public LakeFormationRequest {
 public:
  AWS_LAKEFORMATION_API GetLFTagExpressionRequest() = default;
  ...
  template <typename NameT = Aws::String>
  GetLFTagExpressionRequest& WithName(NameT&& value) {
  ...
  template <typename CatalogIdT = Aws::String>
  GetLFTagExpressionRequest& WithCatalogId(CatalogIdT&& value) {
