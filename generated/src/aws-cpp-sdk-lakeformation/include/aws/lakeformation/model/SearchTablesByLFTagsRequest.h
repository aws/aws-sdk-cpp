...
class SearchTablesByLFTagsRequest : public LakeFormationRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  SearchTablesByLFTagsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchTablesByLFTagsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename CatalogIdT = Aws::String>
  SearchTablesByLFTagsRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename ExpressionT = Aws::Vector<LFTag>>
  SearchTablesByLFTagsRequest& WithExpression(ExpressionT&& value) {
    SetExpression(std::forward<ExpressionT>(value));
    return *this;
  }
  template <typename ExpressionT = LFTag>
  SearchTablesByLFTagsRequest& AddExpression(ExpressionT&& value) {
    m_expressionHasBeenSet = true;
