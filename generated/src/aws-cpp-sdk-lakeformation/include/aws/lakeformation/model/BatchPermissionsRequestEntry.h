...
class BatchPermissionsRequestEntry {
 public:
  ...
  template <typename IdT = Aws::String>
  BatchPermissionsRequestEntry& WithId(IdT&& value) {
  ...
  template <typename PrincipalT = DataLakePrincipal>
  BatchPermissionsRequestEntry& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename ResourceT = Resource>
  BatchPermissionsRequestEntry& WithResource(ResourceT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<Permission>>
  BatchPermissionsRequestEntry& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  inline BatchPermissionsRequestEntry& AddPermissions(Permission value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename ConditionT = Condition>
  BatchPermissionsRequestEntry& WithCondition(ConditionT&& value) {
  ...
  template <typename PermissionsWithGrantOptionT = Aws::Vector<Permission>>
  BatchPermissionsRequestEntry& WithPermissionsWithGrantOption(PermissionsWithGrantOptionT&& value) {
    SetPermissionsWithGrantOption(std::forward<PermissionsWithGrantOptionT>(value));
    return *this;
  }
  inline BatchPermissionsRequestEntry& AddPermissionsWithGrantOption(Permission value) {
    m_permissionsWithGrantOptionHasBeenSet = true;
