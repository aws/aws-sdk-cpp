...
class RevokePermissionsRequest : public LakeFormationRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  RevokePermissionsRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename PrincipalT = DataLakePrincipal>
  RevokePermissionsRequest& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename ResourceT = Resource>
  RevokePermissionsRequest& WithResource(ResourceT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<Permission>>
  RevokePermissionsRequest& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  inline RevokePermissionsRequest& AddPermissions(Permission value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename ConditionT = Condition>
  RevokePermissionsRequest& WithCondition(ConditionT&& value) {
  ...
  void SetPermissionsWithGrantOption(PermissionsWithGrantOptionT&& value) {
    m_permissionsWithGrantOptionHasBeenSet = true;
    m_permissionsWithGrantOption = std::forward<PermissionsWithGrantOptionT>(value);
  }
  template <typename PermissionsWithGrantOptionT = Aws::Vector<Permission>>
  RevokePermissionsRequest& WithPermissionsWithGrantOption(PermissionsWithGrantOptionT&& value) {
    SetPermissionsWithGrantOption(std::forward<PermissionsWithGrantOptionT>(value));
    return *this;
  }
  inline RevokePermissionsRequest& AddPermissionsWithGrantOption(Permission value) {
    m_permissionsWithGrantOptionHasBeenSet = true;
    m_permissionsWithGrantOption.push_back(value);
    return *this;
  }
  ///@}
 private:
