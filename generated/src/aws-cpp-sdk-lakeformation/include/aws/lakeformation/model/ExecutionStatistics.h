...
class ExecutionStatistics {
 public:
  ...
  inline void SetAverageExecutionTimeMillis(long long value) {
    m_averageExecutionTimeMillisHasBeenSet = true;
    m_averageExecutionTimeMillis = value;
  }
  inline ExecutionStatistics& WithAverageExecutionTimeMillis(long long value) {
    SetAverageExecutionTimeMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDataScannedBytes(long long value) {
    m_dataScannedBytesHasBeenSet = true;
    m_dataScannedBytes = value;
  }
  inline ExecutionStatistics& WithDataScannedBytes(long long value) {
    SetDataScannedBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWorkUnitsExecutedCount(long long value) {
    m_workUnitsExecutedCountHasBeenSet = true;
    m_workUnitsExecutedCount = value;
  }
  inline ExecutionStatistics& WithWorkUnitsExecutedCount(long long value) {
    SetWorkUnitsExecutedCount(value);
    return *this;
  }
  ///@}
 private:
