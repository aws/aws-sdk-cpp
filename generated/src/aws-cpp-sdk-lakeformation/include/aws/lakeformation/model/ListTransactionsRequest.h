...
class ListTransactionsRequest : public LakeFormationRequest {
 public:
  ...
  inline void SetStatusFilter(TransactionStatusFilter value) {
    m_statusFilterHasBeenSet = true;
    m_statusFilter = value;
  }
  inline ListTransactionsRequest& WithStatusFilter(TransactionStatusFilter value) {
  ...
  inline ListTransactionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
