...
class TableResource {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  TableResource& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  TableResource& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  TableResource& WithName(NameT&& value) {
  ...
  void SetTableWildcard(TableWildcardT&& value) {
    m_tableWildcardHasBeenSet = true;
    m_tableWildcard = std::forward<TableWildcardT>(value);
  }
  template <typename TableWildcardT = TableWildcard>
  TableResource& WithTableWildcard(TableWildcardT&& value) {
    SetTableWildcard(std::forward<TableWildcardT>(value));
    return *this;
  }
  ///@}
 private:
