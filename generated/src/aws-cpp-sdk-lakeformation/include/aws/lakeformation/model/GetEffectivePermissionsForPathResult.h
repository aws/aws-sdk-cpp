...
class GetEffectivePermissionsForPathResult {
 public:
  ...
  AWS_LAKEFORMATION_API GetEffectivePermissionsForPathResult& operator=(
  ...
  template <typename PermissionsT = Aws::Vector<PrincipalResourcePermissions>>
  GetEffectivePermissionsForPathResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = PrincipalResourcePermissions>
  GetEffectivePermissionsForPathResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetEffectivePermissionsForPathResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetEffectivePermissionsForPathResult& WithRequestId(RequestIdT&& value) {
