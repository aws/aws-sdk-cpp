...
class ListLFTagsResult {
 public:
  ...
  template <typename LFTagsT = Aws::Vector<LFTagPair>>
  ListLFTagsResult& WithLFTags(LFTagsT&& value) {
    SetLFTags(std::forward<LFTagsT>(value));
    return *this;
  }
  template <typename LFTagsT = LFTagPair>
  ListLFTagsResult& AddLFTags(LFTagsT&& value) {
    m_lFTagsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLFTagsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLFTagsResult& WithRequestId(RequestIdT&& value) {
