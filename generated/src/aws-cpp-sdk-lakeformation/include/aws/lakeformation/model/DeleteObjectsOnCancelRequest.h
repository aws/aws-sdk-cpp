...
class DeleteObjectsOnCancelRequest : public LakeFormationRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  DeleteObjectsOnCancelRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  DeleteObjectsOnCancelRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  DeleteObjectsOnCancelRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename TransactionIdT = Aws::String>
  DeleteObjectsOnCancelRequest& WithTransactionId(TransactionIdT&& value) {
  ...
  template <typename ObjectsT = Aws::Vector<VirtualObject>>
  DeleteObjectsOnCancelRequest& WithObjects(ObjectsT&& value) {
    SetObjects(std::forward<ObjectsT>(value));
    return *this;
  }
  template <typename ObjectsT = VirtualObject>
  DeleteObjectsOnCancelRequest& AddObjects(ObjectsT&& value) {
    m_objectsHasBeenSet = true;
