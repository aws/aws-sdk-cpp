...
class ErrorDetail {
 public:
  AWS_LAKEFORMATION_API ErrorDetail() = default;
  AWS_LAKEFORMATION_API ErrorDetail(Aws::Utils::Json::JsonView jsonValue);
  AWS_LAKEFORMATION_API ErrorDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
