...
class GetEffectivePermissionsForPathRequest : public LakeFormationRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  GetEffectivePermissionsForPathRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  GetEffectivePermissionsForPathRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetEffectivePermissionsForPathRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetEffectivePermissionsForPathRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
