...
class ListTableStorageOptimizersRequest : public LakeFormationRequest {
 public:
  AWS_LAKEFORMATION_API ListTableStorageOptimizersRequest() = default;
  ...
  template <typename CatalogIdT = Aws::String>
  ListTableStorageOptimizersRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  ListTableStorageOptimizersRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  ListTableStorageOptimizersRequest& WithTableName(TableNameT&& value) {
  ...
  inline void SetStorageOptimizerType(OptimizerType value) {
    m_storageOptimizerTypeHasBeenSet = true;
    m_storageOptimizerType = value;
  }
  inline ListTableStorageOptimizersRequest& WithStorageOptimizerType(OptimizerType value) {
    SetStorageOptimizerType(value);
    return *this;
  }
  ///@}
  ...
  inline ListTableStorageOptimizersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTableStorageOptimizersRequest& WithNextToken(NextTokenT&& value) {
