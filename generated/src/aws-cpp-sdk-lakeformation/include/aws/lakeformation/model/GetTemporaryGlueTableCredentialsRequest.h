...
class GetTemporaryGlueTableCredentialsRequest : public LakeFormationRequest {
 public:
  ...
  template <typename TableArnT = Aws::String>
  GetTemporaryGlueTableCredentialsRequest& WithTableArn(TableArnT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<Permission>>
  GetTemporaryGlueTableCredentialsRequest& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  inline GetTemporaryGlueTableCredentialsRequest& AddPermissions(Permission value) {
    m_permissionsHasBeenSet = true;
  ...
  inline GetTemporaryGlueTableCredentialsRequest& WithDurationSeconds(int value) {
  ...
  template <typename AuditContextT = AuditContext>
  GetTemporaryGlueTableCredentialsRequest& WithAuditContext(AuditContextT&& value) {
  ...
  void SetSupportedPermissionTypes(SupportedPermissionTypesT&& value) {
    m_supportedPermissionTypesHasBeenSet = true;
    m_supportedPermissionTypes = std::forward<SupportedPermissionTypesT>(value);
  }
  template <typename SupportedPermissionTypesT = Aws::Vector<PermissionType>>
  GetTemporaryGlueTableCredentialsRequest& WithSupportedPermissionTypes(SupportedPermissionTypesT&& value) {
    SetSupportedPermissionTypes(std::forward<SupportedPermissionTypesT>(value));
    return *this;
  }
  inline GetTemporaryGlueTableCredentialsRequest& AddSupportedPermissionTypes(PermissionType value) {
    m_supportedPermissionTypesHasBeenSet = true;
    m_supportedPermissionTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename S3PathT = Aws::String>
  GetTemporaryGlueTableCredentialsRequest& WithS3Path(S3PathT&& value) {
  ...
  template <typename QuerySessionContextT = QuerySessionContext>
  GetTemporaryGlueTableCredentialsRequest& WithQuerySessionContext(QuerySessionContextT&& value) {
