...
class ListTableStorageOptimizersResult {
 public:
  ...
  void SetStorageOptimizerList(StorageOptimizerListT&& value) {
    m_storageOptimizerListHasBeenSet = true;
    m_storageOptimizerList = std::forward<StorageOptimizerListT>(value);
  }
  template <typename StorageOptimizerListT = Aws::Vector<StorageOptimizer>>
  ListTableStorageOptimizersResult& WithStorageOptimizerList(StorageOptimizerListT&& value) {
    SetStorageOptimizerList(std::forward<StorageOptimizerListT>(value));
    return *this;
  }
  template <typename StorageOptimizerListT = StorageOptimizer>
  ListTableStorageOptimizersResult& AddStorageOptimizerList(StorageOptimizerListT&& value) {
    m_storageOptimizerListHasBeenSet = true;
    m_storageOptimizerList.emplace_back(std::forward<StorageOptimizerListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTableStorageOptimizersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTableStorageOptimizersResult& WithRequestId(RequestIdT&& value) {
