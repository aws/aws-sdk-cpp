...
namespace Model
{
  ...
  public:
    ...
    inline PutDataLakeSettingsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutDataLakeSettingsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutDataLakeSettingsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
