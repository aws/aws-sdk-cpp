...
namespace Model
{
  ...
  public:
    ...
    inline ExtendTransactionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ExtendTransactionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ExtendTransactionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
