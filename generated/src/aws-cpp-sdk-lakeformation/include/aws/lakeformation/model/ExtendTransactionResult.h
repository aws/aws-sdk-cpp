...
namespace Model
{
  ...
  {
  public:
    AWS_LAKEFORMATION_API ExtendTransactionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ExtendTransactionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
