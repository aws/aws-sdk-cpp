...
class ListResourcesRequest : public LakeFormationRequest {
 public:
  ...
  void SetFilterConditionList(FilterConditionListT&& value) {
    m_filterConditionListHasBeenSet = true;
    m_filterConditionList = std::forward<FilterConditionListT>(value);
  }
  template <typename FilterConditionListT = Aws::Vector<FilterCondition>>
  ListResourcesRequest& WithFilterConditionList(FilterConditionListT&& value) {
    SetFilterConditionList(std::forward<FilterConditionListT>(value));
    return *this;
  }
  template <typename FilterConditionListT = FilterCondition>
  ListResourcesRequest& AddFilterConditionList(FilterConditionListT&& value) {
    m_filterConditionListHasBeenSet = true;
    m_filterConditionList.emplace_back(std::forward<FilterConditionListT>(value));
    return *this;
  }
  ///@}
