...
class ListLakeFormationOptInsRequest : public LakeFormationRequest {
 public:
  ...
  template <typename PrincipalT = DataLakePrincipal>
  ListLakeFormationOptInsRequest& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename ResourceT = Resource>
  ListLakeFormationOptInsRequest& WithResource(ResourceT&& value) {
  ...
  inline ListLakeFormationOptInsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLakeFormationOptInsRequest& WithNextToken(NextTokenT&& value) {
