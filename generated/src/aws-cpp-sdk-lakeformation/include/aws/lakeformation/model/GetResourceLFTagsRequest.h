...
class GetResourceLFTagsRequest : public LakeFormationRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  GetResourceLFTagsRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename ResourceT = Resource>
  GetResourceLFTagsRequest& WithResource(ResourceT&& value) {
  ...
  inline void SetShowAssignedLFTags(bool value) {
    m_showAssignedLFTagsHasBeenSet = true;
    m_showAssignedLFTags = value;
  }
  inline GetResourceLFTagsRequest& WithShowAssignedLFTags(bool value) {
    SetShowAssignedLFTags(value);
    return *this;
  }
  ///@}
 private:
