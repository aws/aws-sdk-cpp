...
class CreateLFTagExpressionRequest : public LakeFormationRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateLFTagExpressionRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateLFTagExpressionRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename CatalogIdT = Aws::String>
  CreateLFTagExpressionRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename ExpressionT = Aws::Vector<LFTag>>
  CreateLFTagExpressionRequest& WithExpression(ExpressionT&& value) {
    SetExpression(std::forward<ExpressionT>(value));
    return *this;
  }
  template <typename ExpressionT = LFTag>
  CreateLFTagExpressionRequest& AddExpression(ExpressionT&& value) {
    m_expressionHasBeenSet = true;
