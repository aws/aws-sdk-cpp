...
class ListDataCellsFilterResult {
 public:
  ...
  void SetDataCellsFilters(DataCellsFiltersT&& value) {
    m_dataCellsFiltersHasBeenSet = true;
    m_dataCellsFilters = std::forward<DataCellsFiltersT>(value);
  }
  template <typename DataCellsFiltersT = Aws::Vector<DataCellsFilter>>
  ListDataCellsFilterResult& WithDataCellsFilters(DataCellsFiltersT&& value) {
    SetDataCellsFilters(std::forward<DataCellsFiltersT>(value));
    return *this;
  }
  template <typename DataCellsFiltersT = DataCellsFilter>
  ListDataCellsFilterResult& AddDataCellsFilters(DataCellsFiltersT&& value) {
    m_dataCellsFiltersHasBeenSet = true;
    m_dataCellsFilters.emplace_back(std::forward<DataCellsFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataCellsFilterResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataCellsFilterResult& WithRequestId(RequestIdT&& value) {
