...
class ListPermissionsRequest : public LakeFormationRequest {
 public:
  ...
  inline void SetResourceType(DataLakeResourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline ListPermissionsRequest& WithResourceType(DataLakeResourceType value) {
  ...
  void SetIncludeRelated(IncludeRelatedT&& value) {
    m_includeRelatedHasBeenSet = true;
    m_includeRelated = std::forward<IncludeRelatedT>(value);
  }
  template <typename IncludeRelatedT = Aws::String>
  ListPermissionsRequest& WithIncludeRelated(IncludeRelatedT&& value) {
    SetIncludeRelated(std::forward<IncludeRelatedT>(value));
    return *this;
  }
  ///@}
 private:
