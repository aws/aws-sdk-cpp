...
namespace Model
{
  ...
  {
  public:
    AWS_LAKEFORMATION_API RegisterResourceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RegisterResourceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
