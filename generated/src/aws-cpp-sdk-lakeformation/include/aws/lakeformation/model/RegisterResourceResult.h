...
namespace Model
{
  ...
  public:
    ...
    inline RegisterResourceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline RegisterResourceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline RegisterResourceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
