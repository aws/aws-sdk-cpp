...
class ListResourcesResult {
 public:
  ...
  void SetResourceInfoList(ResourceInfoListT&& value) {
    m_resourceInfoListHasBeenSet = true;
    m_resourceInfoList = std::forward<ResourceInfoListT>(value);
  }
  template <typename ResourceInfoListT = Aws::Vector<ResourceInfo>>
  ListResourcesResult& WithResourceInfoList(ResourceInfoListT&& value) {
    SetResourceInfoList(std::forward<ResourceInfoListT>(value));
    return *this;
  }
  template <typename ResourceInfoListT = ResourceInfo>
  ListResourcesResult& AddResourceInfoList(ResourceInfoListT&& value) {
    m_resourceInfoListHasBeenSet = true;
    m_resourceInfoList.emplace_back(std::forward<ResourceInfoListT>(value));
    return *this;
  }
  ///@}
