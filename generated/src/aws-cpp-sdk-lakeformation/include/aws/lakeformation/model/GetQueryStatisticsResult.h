...
class GetQueryStatisticsResult {
 public:
  ...
  void SetExecutionStatistics(ExecutionStatisticsT&& value) {
    m_executionStatisticsHasBeenSet = true;
    m_executionStatistics = std::forward<ExecutionStatisticsT>(value);
  }
  template <typename ExecutionStatisticsT = ExecutionStatistics>
  GetQueryStatisticsResult& WithExecutionStatistics(ExecutionStatisticsT&& value) {
    SetExecutionStatistics(std::forward<ExecutionStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlanningStatistics(PlanningStatisticsT&& value) {
    m_planningStatisticsHasBeenSet = true;
    m_planningStatistics = std::forward<PlanningStatisticsT>(value);
  }
  template <typename PlanningStatisticsT = PlanningStatistics>
  GetQueryStatisticsResult& WithPlanningStatistics(PlanningStatisticsT&& value) {
    SetPlanningStatistics(std::forward<PlanningStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQuerySubmissionTime(QuerySubmissionTimeT&& value) {
    m_querySubmissionTimeHasBeenSet = true;
    m_querySubmissionTime = std::forward<QuerySubmissionTimeT>(value);
  }
  template <typename QuerySubmissionTimeT = Aws::Utils::DateTime>
  GetQueryStatisticsResult& WithQuerySubmissionTime(QuerySubmissionTimeT&& value) {
    SetQuerySubmissionTime(std::forward<QuerySubmissionTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetQueryStatisticsResult& WithRequestId(RequestIdT&& value) {
