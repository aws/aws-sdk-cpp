...
namespace Model
{
  ...
  {
  public:
    AWS_LAKEFORMATION_API GetTemporaryGluePartitionCredentialsResult() = default;
    ...
    template<typename AccessKeyIdT = Aws::String>
    GetTemporaryGluePartitionCredentialsResult& WithAccessKeyId(AccessKeyIdT&& value) { SetAccessKeyId(std::forward<AccessKeyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SecretAccessKeyT = Aws::String>
    GetTemporaryGluePartitionCredentialsResult& WithSecretAccessKey(SecretAccessKeyT&& value) { SetSecretAccessKey(std::forward<SecretAccessKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename SessionTokenT = Aws::String>
    GetTemporaryGluePartitionCredentialsResult& WithSessionToken(SessionTokenT&& value) { SetSessionToken(std::forward<SessionTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ExpirationT = Aws::Utils::DateTime>
    GetTemporaryGluePartitionCredentialsResult& WithExpiration(ExpirationT&& value) { SetExpiration(std::forward<ExpirationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetTemporaryGluePartitionCredentialsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
