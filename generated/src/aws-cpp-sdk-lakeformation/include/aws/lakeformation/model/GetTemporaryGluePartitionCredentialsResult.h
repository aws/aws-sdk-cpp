...
class GetTemporaryGluePartitionCredentialsResult {
 public:
  ...
  AWS_LAKEFORMATION_API GetTemporaryGluePartitionCredentialsResult& operator=(
  ...
  template <typename AccessKeyIdT = Aws::String>
  GetTemporaryGluePartitionCredentialsResult& WithAccessKeyId(AccessKeyIdT&& value) {
  ...
  template <typename SecretAccessKeyT = Aws::String>
  GetTemporaryGluePartitionCredentialsResult& WithSecretAccessKey(SecretAccessKeyT&& value) {
  ...
  template <typename SessionTokenT = Aws::String>
  GetTemporaryGluePartitionCredentialsResult& WithSessionToken(SessionTokenT&& value) {
  ...
  template <typename ExpirationT = Aws::Utils::DateTime>
  GetTemporaryGluePartitionCredentialsResult& WithExpiration(ExpirationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTemporaryGluePartitionCredentialsResult& WithRequestId(RequestIdT&& value) {
