...
class WorkUnitRange {
 public:
  ...
  inline void SetWorkUnitIdMax(long long value) {
    m_workUnitIdMaxHasBeenSet = true;
    m_workUnitIdMax = value;
  }
  inline WorkUnitRange& WithWorkUnitIdMax(long long value) {
    SetWorkUnitIdMax(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWorkUnitIdMin(long long value) {
    m_workUnitIdMinHasBeenSet = true;
    m_workUnitIdMin = value;
  }
  inline WorkUnitRange& WithWorkUnitIdMin(long long value) {
    SetWorkUnitIdMin(value);
    return *this;
  }
  ///@}
  ...
  template <typename WorkUnitTokenT = Aws::String>
  WorkUnitRange& WithWorkUnitToken(WorkUnitTokenT&& value) {
