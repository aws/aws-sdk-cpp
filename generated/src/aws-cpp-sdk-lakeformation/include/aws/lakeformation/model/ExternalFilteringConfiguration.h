...
class ExternalFilteringConfiguration {
 public:
  ...
  inline void SetStatus(EnableStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ExternalFilteringConfiguration& WithStatus(EnableStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename AuthorizedTargetsT = Aws::Vector<Aws::String>>
  ExternalFilteringConfiguration& WithAuthorizedTargets(AuthorizedTargetsT&& value) {
    SetAuthorizedTargets(std::forward<AuthorizedTargetsT>(value));
    return *this;
  }
  template <typename AuthorizedTargetsT = Aws::String>
  ExternalFilteringConfiguration& AddAuthorizedTargets(AuthorizedTargetsT&& value) {
    m_authorizedTargetsHasBeenSet = true;
