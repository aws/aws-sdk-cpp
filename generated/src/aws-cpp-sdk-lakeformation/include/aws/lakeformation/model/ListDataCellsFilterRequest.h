...
class ListDataCellsFilterRequest : public LakeFormationRequest {
 public:
  ...
  template <typename TableT = TableResource>
  ListDataCellsFilterRequest& WithTable(TableT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDataCellsFilterRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDataCellsFilterRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
