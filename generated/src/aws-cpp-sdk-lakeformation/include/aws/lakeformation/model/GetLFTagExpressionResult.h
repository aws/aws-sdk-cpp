...
class GetLFTagExpressionResult {
 public:
  ...
  template <typename NameT = Aws::String>
  GetLFTagExpressionResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetLFTagExpressionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CatalogIdT = Aws::String>
  GetLFTagExpressionResult& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename ExpressionT = Aws::Vector<LFTag>>
  GetLFTagExpressionResult& WithExpression(ExpressionT&& value) {
    SetExpression(std::forward<ExpressionT>(value));
    return *this;
  }
  template <typename ExpressionT = LFTag>
  GetLFTagExpressionResult& AddExpression(ExpressionT&& value) {
    m_expressionHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetLFTagExpressionResult& WithRequestId(RequestIdT&& value) {
