...
class GetWorkUnitsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  GetWorkUnitsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename QueryIdT = Aws::String>
  GetWorkUnitsResult& WithQueryId(QueryIdT&& value) {
  ...
  void SetWorkUnitRanges(WorkUnitRangesT&& value) {
    m_workUnitRangesHasBeenSet = true;
    m_workUnitRanges = std::forward<WorkUnitRangesT>(value);
  }
  template <typename WorkUnitRangesT = Aws::Vector<WorkUnitRange>>
  GetWorkUnitsResult& WithWorkUnitRanges(WorkUnitRangesT&& value) {
    SetWorkUnitRanges(std::forward<WorkUnitRangesT>(value));
    return *this;
  }
  template <typename WorkUnitRangesT = WorkUnitRange>
  GetWorkUnitsResult& AddWorkUnitRanges(WorkUnitRangesT&& value) {
    m_workUnitRangesHasBeenSet = true;
    m_workUnitRanges.emplace_back(std::forward<WorkUnitRangesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetWorkUnitsResult& WithRequestId(RequestIdT&& value) {
