...
class AssumeDecoratedRoleWithSAMLResult {
 public:
  ...
  AWS_LAKEFORMATION_API AssumeDecoratedRoleWithSAMLResult& operator=(
  ...
  template <typename AccessKeyIdT = Aws::String>
  AssumeDecoratedRoleWithSAMLResult& WithAccessKeyId(AccessKeyIdT&& value) {
  ...
  template <typename SecretAccessKeyT = Aws::String>
  AssumeDecoratedRoleWithSAMLResult& WithSecretAccessKey(SecretAccessKeyT&& value) {
  ...
  template <typename SessionTokenT = Aws::String>
  AssumeDecoratedRoleWithSAMLResult& WithSessionToken(SessionTokenT&& value) {
  ...
  template <typename ExpirationT = Aws::Utils::DateTime>
  AssumeDecoratedRoleWithSAMLResult& WithExpiration(ExpirationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssumeDecoratedRoleWithSAMLResult& WithRequestId(RequestIdT&& value) {
