...
class WriteOperation {
 public:
  ...
  void SetAddObject(AddObjectT&& value) {
    m_addObjectHasBeenSet = true;
    m_addObject = std::forward<AddObjectT>(value);
  }
  template <typename AddObjectT = AddObjectInput>
  WriteOperation& WithAddObject(AddObjectT&& value) {
    SetAddObject(std::forward<AddObjectT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeleteObject(DeleteObjectT&& value) {
    ...
    m_deleteObject = std::forward<DeleteObjectT>(value);
  }
  template <typename DeleteObjectT = DeleteObjectInput>
  WriteOperation& WithDeleteObject(DeleteObjectT&& value) {
    SetDeleteObject(std::forward<DeleteObjectT>(value));
    return *this;
  }
  ///@}
 private:
