...
class FilterCondition {
 public:
  ...
  inline void SetField(FieldNameString value) {
    m_fieldHasBeenSet = true;
    m_field = value;
  }
  inline FilterCondition& WithField(FieldNameString value) {
    SetField(value);
    return *this;
  }
  ///@}
  ...
  inline FilterCondition& WithComparisonOperator(ComparisonOperator value) {
  ...
  void SetStringValueList(StringValueListT&& value) {
    m_stringValueListHasBeenSet = true;
    m_stringValueList = std::forward<StringValueListT>(value);
  }
  template <typename StringValueListT = Aws::Vector<Aws::String>>
  FilterCondition& WithStringValueList(StringValueListT&& value) {
    SetStringValueList(std::forward<StringValueListT>(value));
    return *this;
  }
  template <typename StringValueListT = Aws::String>
  FilterCondition& AddStringValueList(StringValueListT&& value) {
    m_stringValueListHasBeenSet = true;
    m_stringValueList.emplace_back(std::forward<StringValueListT>(value));
    return *this;
  }
  ///@}
 private:
