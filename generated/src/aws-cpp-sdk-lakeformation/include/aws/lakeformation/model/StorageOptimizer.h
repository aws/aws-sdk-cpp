...
class StorageOptimizer {
 public:
  ...
  inline StorageOptimizer& WithStorageOptimizerType(OptimizerType value) {
  ...
  void SetLastRunDetails(LastRunDetailsT&& value) {
    ...
    m_lastRunDetails = std::forward<LastRunDetailsT>(value);
  }
  template <typename LastRunDetailsT = Aws::String>
  StorageOptimizer& WithLastRunDetails(LastRunDetailsT&& value) {
    SetLastRunDetails(std::forward<LastRunDetailsT>(value));
    return *this;
  }
  ///@}
 private:
