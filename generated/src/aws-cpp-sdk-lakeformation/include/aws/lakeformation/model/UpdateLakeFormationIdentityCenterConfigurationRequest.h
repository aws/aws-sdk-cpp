...
class UpdateLakeFormationIdentityCenterConfigurationRequest : public LakeFormationRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  UpdateLakeFormationIdentityCenterConfigurationRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename ShareRecipientsT = Aws::Vector<DataLakePrincipal>>
  UpdateLakeFormationIdentityCenterConfigurationRequest& WithShareRecipients(ShareRecipientsT&& value) {
    SetShareRecipients(std::forward<ShareRecipientsT>(value));
    return *this;
  }
  template <typename ShareRecipientsT = DataLakePrincipal>
  UpdateLakeFormationIdentityCenterConfigurationRequest& AddShareRecipients(ShareRecipientsT&& value) {
    m_shareRecipientsHasBeenSet = true;
  ...
  inline UpdateLakeFormationIdentityCenterConfigurationRequest& WithApplicationStatus(ApplicationStatus value) {
  ...
  template <typename ExternalFilteringT = ExternalFilteringConfiguration>
  UpdateLakeFormationIdentityCenterConfigurationRequest& WithExternalFiltering(ExternalFilteringT&& value) {
