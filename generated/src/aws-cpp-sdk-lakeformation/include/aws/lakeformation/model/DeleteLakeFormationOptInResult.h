...
namespace Model
{
  ...
  {
  public:
    AWS_LAKEFORMATION_API DeleteLakeFormationOptInResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteLakeFormationOptInResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
