...
namespace Model
{
  ...
  {
  public:
    AWS_LAKEFORMATION_API CreateLFTagExpressionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateLFTagExpressionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
