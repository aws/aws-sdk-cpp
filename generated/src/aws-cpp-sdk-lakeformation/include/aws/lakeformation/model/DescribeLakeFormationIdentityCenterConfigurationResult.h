...
class DescribeLakeFormationIdentityCenterConfigurationResult {
 public:
  ...
  AWS_LAKEFORMATION_API DescribeLakeFormationIdentityCenterConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename CatalogIdT = Aws::String>
  DescribeLakeFormationIdentityCenterConfigurationResult& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename InstanceArnT = Aws::String>
  DescribeLakeFormationIdentityCenterConfigurationResult& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename ApplicationArnT = Aws::String>
  DescribeLakeFormationIdentityCenterConfigurationResult& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename ExternalFilteringT = ExternalFilteringConfiguration>
  DescribeLakeFormationIdentityCenterConfigurationResult& WithExternalFiltering(ExternalFilteringT&& value) {
  ...
  template <typename ShareRecipientsT = Aws::Vector<DataLakePrincipal>>
  DescribeLakeFormationIdentityCenterConfigurationResult& WithShareRecipients(ShareRecipientsT&& value) {
    SetShareRecipients(std::forward<ShareRecipientsT>(value));
    return *this;
  }
  template <typename ShareRecipientsT = DataLakePrincipal>
  DescribeLakeFormationIdentityCenterConfigurationResult& AddShareRecipients(ShareRecipientsT&& value) {
    m_shareRecipientsHasBeenSet = true;
  ...
  template <typename ResourceShareT = Aws::String>
  DescribeLakeFormationIdentityCenterConfigurationResult& WithResourceShare(ResourceShareT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeLakeFormationIdentityCenterConfigurationResult& WithRequestId(RequestIdT&& value) {
