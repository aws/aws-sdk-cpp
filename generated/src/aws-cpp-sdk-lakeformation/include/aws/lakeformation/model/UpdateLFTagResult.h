...
namespace Model
{
  ...
  public:
    ...
    inline UpdateLFTagResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateLFTagResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateLFTagResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
