...
namespace Model
{
  ...
  public:
    ...
    inline UpdateTableObjectsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateTableObjectsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateTableObjectsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
