...
class DataCellsFilter {
 public:
  ...
  template <typename TableCatalogIdT = Aws::String>
  DataCellsFilter& WithTableCatalogId(TableCatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  DataCellsFilter& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  DataCellsFilter& WithTableName(TableNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  DataCellsFilter& WithName(NameT&& value) {
  ...
  template <typename RowFilterT = RowFilter>
  DataCellsFilter& WithRowFilter(RowFilterT&& value) {
  ...
  template <typename ColumnNamesT = Aws::Vector<Aws::String>>
  DataCellsFilter& WithColumnNames(ColumnNamesT&& value) {
    SetColumnNames(std::forward<ColumnNamesT>(value));
    return *this;
  }
  template <typename ColumnNamesT = Aws::String>
  DataCellsFilter& AddColumnNames(ColumnNamesT&& value) {
    m_columnNamesHasBeenSet = true;
  ...
  template <typename ColumnWildcardT = ColumnWildcard>
  DataCellsFilter& WithColumnWildcard(ColumnWildcardT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  DataCellsFilter& WithVersionId(VersionIdT&& value) {
