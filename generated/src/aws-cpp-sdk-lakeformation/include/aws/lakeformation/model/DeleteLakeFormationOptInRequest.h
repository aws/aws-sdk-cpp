...
class DeleteLakeFormationOptInRequest : public LakeFormationRequest {
 public:
  ...
  template <typename PrincipalT = DataLakePrincipal>
  DeleteLakeFormationOptInRequest& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename ResourceT = Resource>
  DeleteLakeFormationOptInRequest& WithResource(ResourceT&& value) {
  ...
  template <typename ConditionT = Condition>
  DeleteLakeFormationOptInRequest& WithCondition(ConditionT&& value) {
