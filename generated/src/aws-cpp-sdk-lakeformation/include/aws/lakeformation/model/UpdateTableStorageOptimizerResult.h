...
class UpdateTableStorageOptimizerResult {
 public:
  ...
  AWS_LAKEFORMATION_API UpdateTableStorageOptimizerResult& operator=(
  ...
  template <typename ResultT = Aws::String>
  UpdateTableStorageOptimizerResult& WithResult(ResultT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateTableStorageOptimizerResult& WithRequestId(RequestIdT&& value) {
