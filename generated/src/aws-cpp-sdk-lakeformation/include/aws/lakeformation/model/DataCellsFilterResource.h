...
class DataCellsFilterResource {
 public:
  ...
  template <typename TableCatalogIdT = Aws::String>
  DataCellsFilterResource& WithTableCatalogId(TableCatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  DataCellsFilterResource& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  DataCellsFilterResource& WithTableName(TableNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  DataCellsFilterResource& WithName(NameT&& value) {
