...
namespace Model
{
  ...
  {
  public:
    AWS_LAKEFORMATION_API UpdateLFTagExpressionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLFTagExpressionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
