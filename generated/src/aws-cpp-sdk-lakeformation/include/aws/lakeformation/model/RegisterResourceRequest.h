...
class RegisterResourceRequest : public LakeFormationRequest {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  RegisterResourceRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline void SetUseServiceLinkedRole(bool value) {
    m_useServiceLinkedRoleHasBeenSet = true;
    m_useServiceLinkedRole = value;
  }
  inline RegisterResourceRequest& WithUseServiceLinkedRole(bool value) {
    SetUseServiceLinkedRole(value);
    return *this;
  }
  ///@}
  ...
  template <typename RoleArnT = Aws::String>
  RegisterResourceRequest& WithRoleArn(RoleArnT&& value) {
  ...
  inline RegisterResourceRequest& WithWithFederation(bool value) {
  ...
  inline RegisterResourceRequest& WithHybridAccessEnabled(bool value) {
  ...
  inline RegisterResourceRequest& WithWithPrivilegedAccess(bool value) {
  ...
  template <typename ExpectedResourceOwnerAccountT = Aws::String>
  RegisterResourceRequest& WithExpectedResourceOwnerAccount(ExpectedResourceOwnerAccountT&& value) {
