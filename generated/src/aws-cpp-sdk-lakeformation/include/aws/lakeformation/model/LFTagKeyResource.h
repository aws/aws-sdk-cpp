...
class LFTagKeyResource {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  LFTagKeyResource& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename TagKeyT = Aws::String>
  LFTagKeyResource& WithTagKey(TagKeyT&& value) {
  ...
  template <typename TagValuesT = Aws::Vector<Aws::String>>
  LFTagKeyResource& WithTagValues(TagValuesT&& value) {
    SetTagValues(std::forward<TagValuesT>(value));
    return *this;
  }
  template <typename TagValuesT = Aws::String>
  LFTagKeyResource& AddTagValues(TagValuesT&& value) {
    m_tagValuesHasBeenSet = true;
