...
class LFTagPair {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  LFTagPair& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename TagKeyT = Aws::String>
  LFTagPair& WithTagKey(TagKeyT&& value) {
