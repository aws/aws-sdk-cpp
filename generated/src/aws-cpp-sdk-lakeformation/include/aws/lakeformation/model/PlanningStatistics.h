...
class PlanningStatistics {
 public:
  ...
  inline void SetEstimatedDataToScanBytes(long long value) {
    m_estimatedDataToScanBytesHasBeenSet = true;
    m_estimatedDataToScanBytes = value;
  }
  inline PlanningStatistics& WithEstimatedDataToScanBytes(long long value) {
    SetEstimatedDataToScanBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPlanningTimeMillis(long long value) {
    m_planningTimeMillisHasBeenSet = true;
    m_planningTimeMillis = value;
  }
  inline PlanningStatistics& WithPlanningTimeMillis(long long value) {
    SetPlanningTimeMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQueueTimeMillis(long long value) {
    m_queueTimeMillisHasBeenSet = true;
    m_queueTimeMillis = value;
  }
  inline PlanningStatistics& WithQueueTimeMillis(long long value) {
    SetQueueTimeMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWorkUnitsGeneratedCount(long long value) {
    m_workUnitsGeneratedCountHasBeenSet = true;
    m_workUnitsGeneratedCount = value;
  }
  inline PlanningStatistics& WithWorkUnitsGeneratedCount(long long value) {
    SetWorkUnitsGeneratedCount(value);
    return *this;
  }
  ///@}
 private:
