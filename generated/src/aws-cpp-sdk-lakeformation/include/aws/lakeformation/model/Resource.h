...
class Resource {
 public:
  ...
  void SetTableWithColumns(TableWithColumnsT&& value) {
    ...
    m_tableWithColumns = std::forward<TableWithColumnsT>(value);
  }
  template <typename TableWithColumnsT = TableWithColumnsResource>
  Resource& WithTableWithColumns(TableWithColumnsT&& value) {
    SetTableWithColumns(std::forward<TableWithColumnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLFTagPolicy(LFTagPolicyT&& value) {
    ...
    m_lFTagPolicy = std::forward<LFTagPolicyT>(value);
  }
  template <typename LFTagPolicyT = LFTagPolicyResource>
  Resource& WithLFTagPolicy(LFTagPolicyT&& value) {
    SetLFTagPolicy(std::forward<LFTagPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLFTagExpression(LFTagExpressionT&& value) {
    ...
    m_lFTagExpression = std::forward<LFTagExpressionT>(value);
  }
  template <typename LFTagExpressionT = LFTagExpressionResource>
  Resource& WithLFTagExpression(LFTagExpressionT&& value) {
    SetLFTagExpression(std::forward<LFTagExpressionT>(value));
    return *this;
  }
  ///@}
 private:
