...
class UpdateLFTagRequest : public LakeFormationRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  UpdateLFTagRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename TagKeyT = Aws::String>
  UpdateLFTagRequest& WithTagKey(TagKeyT&& value) {
  ...
  void SetTagValuesToDelete(TagValuesToDeleteT&& value) {
    m_tagValuesToDeleteHasBeenSet = true;
    m_tagValuesToDelete = std::forward<TagValuesToDeleteT>(value);
  }
  template <typename TagValuesToDeleteT = Aws::Vector<Aws::String>>
  UpdateLFTagRequest& WithTagValuesToDelete(TagValuesToDeleteT&& value) {
    SetTagValuesToDelete(std::forward<TagValuesToDeleteT>(value));
    return *this;
  }
  template <typename TagValuesToDeleteT = Aws::String>
  UpdateLFTagRequest& AddTagValuesToDelete(TagValuesToDeleteT&& value) {
    m_tagValuesToDeleteHasBeenSet = true;
    m_tagValuesToDelete.emplace_back(std::forward<TagValuesToDeleteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTagValuesToAdd(TagValuesToAddT&& value) {
    m_tagValuesToAddHasBeenSet = true;
    m_tagValuesToAdd = std::forward<TagValuesToAddT>(value);
  }
  template <typename TagValuesToAddT = Aws::Vector<Aws::String>>
  UpdateLFTagRequest& WithTagValuesToAdd(TagValuesToAddT&& value) {
    SetTagValuesToAdd(std::forward<TagValuesToAddT>(value));
    return *this;
  }
  template <typename TagValuesToAddT = Aws::String>
  UpdateLFTagRequest& AddTagValuesToAdd(TagValuesToAddT&& value) {
    m_tagValuesToAddHasBeenSet = true;
    m_tagValuesToAdd.emplace_back(std::forward<TagValuesToAddT>(value));
    return *this;
  }
  ///@}
 private:
