...
class ListPermissionsResult {
 public:
  ...
  void SetPrincipalResourcePermissions(PrincipalResourcePermissionsT&& value) {
    m_principalResourcePermissionsHasBeenSet = true;
    m_principalResourcePermissions = std::forward<PrincipalResourcePermissionsT>(value);
  }
  template <typename PrincipalResourcePermissionsT = Aws::Vector<PrincipalResourcePermissions>>
  ListPermissionsResult& WithPrincipalResourcePermissions(PrincipalResourcePermissionsT&& value) {
    SetPrincipalResourcePermissions(std::forward<PrincipalResourcePermissionsT>(value));
    return *this;
  }
  template <typename PrincipalResourcePermissionsT = PrincipalResourcePermissions>
  ListPermissionsResult& AddPrincipalResourcePermissions(PrincipalResourcePermissionsT&& value) {
    m_principalResourcePermissionsHasBeenSet = true;
    m_principalResourcePermissions.emplace_back(std::forward<PrincipalResourcePermissionsT>(value));
    return *this;
  }
  ///@}
