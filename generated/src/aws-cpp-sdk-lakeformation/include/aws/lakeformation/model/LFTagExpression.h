...
class LFTagExpression {
 public:
  ...
  template <typename NameT = Aws::String>
  LFTagExpression& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  LFTagExpression& WithDescription(DescriptionT&& value) {
  ...
  template <typename CatalogIdT = Aws::String>
  LFTagExpression& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename ExpressionT = Aws::Vector<LFTag>>
  LFTagExpression& WithExpression(ExpressionT&& value) {
    SetExpression(std::forward<ExpressionT>(value));
    return *this;
  }
  template <typename ExpressionT = LFTag>
  LFTagExpression& AddExpression(ExpressionT&& value) {
    m_expressionHasBeenSet = true;
