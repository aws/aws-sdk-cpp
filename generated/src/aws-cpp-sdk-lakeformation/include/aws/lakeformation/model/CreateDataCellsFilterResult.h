...
namespace Model
{
  ...
  {
  public:
    AWS_LAKEFORMATION_API CreateDataCellsFilterResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateDataCellsFilterResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
