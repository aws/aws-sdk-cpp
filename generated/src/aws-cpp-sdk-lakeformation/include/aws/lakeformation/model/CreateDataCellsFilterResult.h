...
namespace Model
{
  ...
  public:
    ...
    inline CreateDataCellsFilterResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateDataCellsFilterResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateDataCellsFilterResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
