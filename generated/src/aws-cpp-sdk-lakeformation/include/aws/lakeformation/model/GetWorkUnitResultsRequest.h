...
class GetWorkUnitResultsRequest : public LakeFormationRequest {
 public:
  ...
  template <typename QueryIdT = Aws::String>
  GetWorkUnitResultsRequest& WithQueryId(QueryIdT&& value) {
  ...
  inline void SetWorkUnitId(long long value) {
    m_workUnitIdHasBeenSet = true;
    m_workUnitId = value;
  }
  inline GetWorkUnitResultsRequest& WithWorkUnitId(long long value) {
    SetWorkUnitId(value);
    return *this;
  }
  ///@}
  ...
  void SetWorkUnitToken(WorkUnitTokenT&& value) {
    m_workUnitTokenHasBeenSet = true;
    m_workUnitToken = std::forward<WorkUnitTokenT>(value);
  }
  template <typename WorkUnitTokenT = Aws::String>
  GetWorkUnitResultsRequest& WithWorkUnitToken(WorkUnitTokenT&& value) {
    SetWorkUnitToken(std::forward<WorkUnitTokenT>(value));
    return *this;
  }
  ///@}
 private:
