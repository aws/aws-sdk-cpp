...
class DataLakeSettings {
 public:
  ...
  void SetDataLakeAdmins(DataLakeAdminsT&& value) {
    ...
    m_dataLakeAdmins = std::forward<DataLakeAdminsT>(value);
  }
  template <typename DataLakeAdminsT = Aws::Vector<DataLakePrincipal>>
  DataLakeSettings& WithDataLakeAdmins(DataLakeAdminsT&& value) {
    SetDataLakeAdmins(std::forward<DataLakeAdminsT>(value));
    return *this;
  }
  template <typename DataLakeAdminsT = DataLakePrincipal>
  DataLakeSettings& AddDataLakeAdmins(DataLakeAdminsT&& value) {
    m_dataLakeAdminsHasBeenSet = true;
    m_dataLakeAdmins.emplace_back(std::forward<DataLakeAdminsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReadOnlyAdmins(ReadOnlyAdminsT&& value) {
    ...
    m_readOnlyAdmins = std::forward<ReadOnlyAdminsT>(value);
  }
  template <typename ReadOnlyAdminsT = Aws::Vector<DataLakePrincipal>>
  DataLakeSettings& WithReadOnlyAdmins(ReadOnlyAdminsT&& value) {
    SetReadOnlyAdmins(std::forward<ReadOnlyAdminsT>(value));
    return *this;
  }
  template <typename ReadOnlyAdminsT = DataLakePrincipal>
  DataLakeSettings& AddReadOnlyAdmins(ReadOnlyAdminsT&& value) {
    m_readOnlyAdminsHasBeenSet = true;
    m_readOnlyAdmins.emplace_back(std::forward<ReadOnlyAdminsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrustedResourceOwners(TrustedResourceOwnersT&& value) {
    ...
    m_trustedResourceOwners = std::forward<TrustedResourceOwnersT>(value);
  }
  template <typename TrustedResourceOwnersT = Aws::Vector<Aws::String>>
  DataLakeSettings& WithTrustedResourceOwners(TrustedResourceOwnersT&& value) {
    SetTrustedResourceOwners(std::forward<TrustedResourceOwnersT>(value));
    return *this;
  }
  ...
  DataLakeSettings& AddTrustedResourceOwners(TrustedResourceOwnersT&& value) {
    m_trustedResourceOwnersHasBeenSet = true;
    m_trustedResourceOwners.emplace_back(std::forward<TrustedResourceOwnersT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAllowExternalDataFiltering(bool value) {
    m_allowExternalDataFilteringHasBeenSet = true;
    m_allowExternalDataFiltering = value;
  }
  inline DataLakeSettings& WithAllowExternalDataFiltering(bool value) {
    SetAllowExternalDataFiltering(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllowFullTableExternalDataAccess(bool value) {
    m_allowFullTableExternalDataAccessHasBeenSet = true;
    m_allowFullTableExternalDataAccess = value;
  }
  inline DataLakeSettings& WithAllowFullTableExternalDataAccess(bool value) {
  ...
  void SetExternalDataFilteringAllowList(ExternalDataFilteringAllowListT&& value) {
    ...
    m_externalDataFilteringAllowList = std::forward<ExternalDataFilteringAllowListT>(value);
  }
  template <typename ExternalDataFilteringAllowListT = Aws::Vector<DataLakePrincipal>>
  DataLakeSettings& WithExternalDataFilteringAllowList(ExternalDataFilteringAllowListT&& value) {
    SetExternalDataFilteringAllowList(std::forward<ExternalDataFilteringAllowListT>(value));
    return *this;
  }
  ...
  DataLakeSettings& AddExternalDataFilteringAllowList(ExternalDataFilteringAllowListT&& value) {
    m_externalDataFilteringAllowListHasBeenSet = true;
    m_externalDataFilteringAllowList.emplace_back(std::forward<ExternalDataFilteringAllowListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthorizedSessionTagValueList(AuthorizedSessionTagValueListT&& value) {
    ...
    m_authorizedSessionTagValueList = std::forward<AuthorizedSessionTagValueListT>(value);
  }
  template <typename AuthorizedSessionTagValueListT = Aws::Vector<Aws::String>>
  DataLakeSettings& WithAuthorizedSessionTagValueList(AuthorizedSessionTagValueListT&& value) {
    SetAuthorizedSessionTagValueList(std::forward<AuthorizedSessionTagValueListT>(value));
    return *this;
  }
  ...
  DataLakeSettings& AddAuthorizedSessionTagValueList(AuthorizedSessionTagValueListT&& value) {
    m_authorizedSessionTagValueListHasBeenSet = true;
    m_authorizedSessionTagValueList.emplace_back(std::forward<AuthorizedSessionTagValueListT>(value));
    return *this;
  }
  ///@}
 private:
