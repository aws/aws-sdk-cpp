...
class ColumnWildcard {
 public:
  ...
  void SetExcludedColumnNames(ExcludedColumnNamesT&& value) {
    m_excludedColumnNamesHasBeenSet = true;
    m_excludedColumnNames = std::forward<ExcludedColumnNamesT>(value);
  }
  template <typename ExcludedColumnNamesT = Aws::Vector<Aws::String>>
  ColumnWildcard& WithExcludedColumnNames(ExcludedColumnNamesT&& value) {
    SetExcludedColumnNames(std::forward<ExcludedColumnNamesT>(value));
    return *this;
  }
  template <typename ExcludedColumnNamesT = Aws::String>
  ColumnWildcard& AddExcludedColumnNames(ExcludedColumnNamesT&& value) {
    m_excludedColumnNamesHasBeenSet = true;
    m_excludedColumnNames.emplace_back(std::forward<ExcludedColumnNamesT>(value));
    return *this;
  }
  ///@}
 private:
