...
class GetTableObjectsResult {
 public:
  ...
  template <typename ObjectsT = Aws::Vector<PartitionObjects>>
  GetTableObjectsResult& WithObjects(ObjectsT&& value) {
    SetObjects(std::forward<ObjectsT>(value));
    return *this;
  }
  template <typename ObjectsT = PartitionObjects>
  GetTableObjectsResult& AddObjects(ObjectsT&& value) {
    m_objectsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetTableObjectsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTableObjectsResult& WithRequestId(RequestIdT&& value) {
