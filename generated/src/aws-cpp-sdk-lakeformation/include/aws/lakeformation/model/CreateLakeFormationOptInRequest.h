...
class CreateLakeFormationOptInRequest : public LakeFormationRequest {
 public:
  ...
  template <typename PrincipalT = DataLakePrincipal>
  CreateLakeFormationOptInRequest& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename ResourceT = Resource>
  CreateLakeFormationOptInRequest& WithResource(ResourceT&& value) {
  ...
  template <typename ConditionT = Condition>
  CreateLakeFormationOptInRequest& WithCondition(ConditionT&& value) {
