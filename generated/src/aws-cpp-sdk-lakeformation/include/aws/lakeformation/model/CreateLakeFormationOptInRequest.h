...
namespace Model
{
  ...
  public:
    ...
    inline CreateLakeFormationOptInRequest& WithCondition(const Condition& value) { SetCondition(value); return *this;}
    inline CreateLakeFormationOptInRequest& WithCondition(Condition&& value) { SetCondition(std::move(value)); return *this;}
    ///@}
  private:
