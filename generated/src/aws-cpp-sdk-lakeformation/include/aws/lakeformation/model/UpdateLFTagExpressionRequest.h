...
class UpdateLFTagExpressionRequest : public LakeFormationRequest {
 public:
  AWS_LAKEFORMATION_API UpdateLFTagExpressionRequest() = default;
  ...
  template <typename NameT = Aws::String>
  UpdateLFTagExpressionRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateLFTagExpressionRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename CatalogIdT = Aws::String>
  UpdateLFTagExpressionRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename ExpressionT = Aws::Vector<LFTag>>
  UpdateLFTagExpressionRequest& WithExpression(ExpressionT&& value) {
    SetExpression(std::forward<ExpressionT>(value));
    return *this;
  }
  template <typename ExpressionT = LFTag>
  UpdateLFTagExpressionRequest& AddExpression(ExpressionT&& value) {
    m_expressionHasBeenSet = true;
