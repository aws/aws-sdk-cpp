...
class GrantPermissionsRequest : public LakeFormationRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  GrantPermissionsRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename PrincipalT = DataLakePrincipal>
  GrantPermissionsRequest& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename ResourceT = Resource>
  GrantPermissionsRequest& WithResource(ResourceT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<Permission>>
  GrantPermissionsRequest& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  inline GrantPermissionsRequest& AddPermissions(Permission value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename ConditionT = Condition>
  GrantPermissionsRequest& WithCondition(ConditionT&& value) {
  ...
  template <typename PermissionsWithGrantOptionT = Aws::Vector<Permission>>
  GrantPermissionsRequest& WithPermissionsWithGrantOption(PermissionsWithGrantOptionT&& value) {
    SetPermissionsWithGrantOption(std::forward<PermissionsWithGrantOptionT>(value));
    return *this;
  }
  inline GrantPermissionsRequest& AddPermissionsWithGrantOption(Permission value) {
    m_permissionsWithGrantOptionHasBeenSet = true;
