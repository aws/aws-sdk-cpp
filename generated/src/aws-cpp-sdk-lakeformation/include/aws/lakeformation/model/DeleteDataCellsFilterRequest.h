...
class DeleteDataCellsFilterRequest : public LakeFormationRequest {
 public:
  ...
  template <typename TableCatalogIdT = Aws::String>
  DeleteDataCellsFilterRequest& WithTableCatalogId(TableCatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  DeleteDataCellsFilterRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  DeleteDataCellsFilterRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteDataCellsFilterRequest& WithName(NameT&& value) {
