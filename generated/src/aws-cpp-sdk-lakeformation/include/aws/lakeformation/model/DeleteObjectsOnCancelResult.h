...
namespace Model
{
  ...
  {
  public:
    AWS_LAKEFORMATION_API DeleteObjectsOnCancelResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteObjectsOnCancelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
