...
class AddLFTagsToResourceRequest : public LakeFormationRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  AddLFTagsToResourceRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename ResourceT = Resource>
  AddLFTagsToResourceRequest& WithResource(ResourceT&& value) {
  ...
  template <typename LFTagsT = Aws::Vector<LFTagPair>>
  AddLFTagsToResourceRequest& WithLFTags(LFTagsT&& value) {
    SetLFTags(std::forward<LFTagsT>(value));
    return *this;
  }
  template <typename LFTagsT = LFTagPair>
  AddLFTagsToResourceRequest& AddLFTags(LFTagsT&& value) {
    m_lFTagsHasBeenSet = true;
