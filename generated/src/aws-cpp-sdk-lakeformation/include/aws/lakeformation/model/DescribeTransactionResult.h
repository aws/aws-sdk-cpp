...
class DescribeTransactionResult {
 public:
  ...
  void SetTransactionDescription(TransactionDescriptionT&& value) {
    m_transactionDescriptionHasBeenSet = true;
    m_transactionDescription = std::forward<TransactionDescriptionT>(value);
  }
  template <typename TransactionDescriptionT = TransactionDescription>
  DescribeTransactionResult& WithTransactionDescription(TransactionDescriptionT&& value) {
    SetTransactionDescription(std::forward<TransactionDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTransactionResult& WithRequestId(RequestIdT&& value) {
