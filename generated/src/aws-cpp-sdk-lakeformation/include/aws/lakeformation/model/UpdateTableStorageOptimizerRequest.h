...
class UpdateTableStorageOptimizerRequest : public LakeFormationRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  UpdateTableStorageOptimizerRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  UpdateTableStorageOptimizerRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  UpdateTableStorageOptimizerRequest& WithTableName(TableNameT&& value) {
   ...
   */
  inline const Aws::Map<OptimizerType, Aws::Map<Aws::String, Aws::String>>& GetStorageOptimizerConfig() const {
    return m_storageOptimizerConfig;
  }
  ...
  void SetStorageOptimizerConfig(StorageOptimizerConfigT&& value) {
    m_storageOptimizerConfigHasBeenSet = true;
    m_storageOptimizerConfig = std::forward<StorageOptimizerConfigT>(value);
  }
  template <typename StorageOptimizerConfigT = Aws::Map<OptimizerType, Aws::Map<Aws::String, Aws::String>>>
  UpdateTableStorageOptimizerRequest& WithStorageOptimizerConfig(StorageOptimizerConfigT&& value) {
    SetStorageOptimizerConfig(std::forward<StorageOptimizerConfigT>(value));
    return *this;
  }
  inline UpdateTableStorageOptimizerRequest& AddStorageOptimizerConfig(OptimizerType key, Aws::Map<Aws::String, Aws::String> value) {
    m_storageOptimizerConfigHasBeenSet = true;
    m_storageOptimizerConfig.emplace(key, value);
    return *this;
  }
  ///@}
 private:
