...
namespace Model
{
  ...
  public:
    ...
    inline CancelTransactionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CancelTransactionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CancelTransactionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
