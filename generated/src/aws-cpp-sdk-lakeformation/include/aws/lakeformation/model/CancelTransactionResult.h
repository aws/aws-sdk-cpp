...
namespace Model
{
  ...
  {
  public:
    AWS_LAKEFORMATION_API CancelTransactionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelTransactionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
