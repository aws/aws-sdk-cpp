...
class LakeFormationOptInsInfo {
 public:
  ...
  template <typename ResourceT = Resource>
  LakeFormationOptInsInfo& WithResource(ResourceT&& value) {
  ...
  template <typename PrincipalT = DataLakePrincipal>
  LakeFormationOptInsInfo& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename ConditionT = Condition>
  LakeFormationOptInsInfo& WithCondition(ConditionT&& value) {
  ...
  template <typename LastModifiedT = Aws::Utils::DateTime>
  LakeFormationOptInsInfo& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename LastUpdatedByT = Aws::String>
  LakeFormationOptInsInfo& WithLastUpdatedBy(LastUpdatedByT&& value) {
