...
class LFTagPolicyResource {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  LFTagPolicyResource& WithCatalogId(CatalogIdT&& value) {
  ...
  inline LFTagPolicyResource& WithResourceType(ResourceType value) {
  ...
  template <typename ExpressionT = Aws::Vector<LFTag>>
  LFTagPolicyResource& WithExpression(ExpressionT&& value) {
    SetExpression(std::forward<ExpressionT>(value));
    return *this;
  }
  template <typename ExpressionT = LFTag>
  LFTagPolicyResource& AddExpression(ExpressionT&& value) {
    m_expressionHasBeenSet = true;
  ...
  void SetExpressionName(ExpressionNameT&& value) {
    ...
    m_expressionName = std::forward<ExpressionNameT>(value);
  }
  template <typename ExpressionNameT = Aws::String>
  LFTagPolicyResource& WithExpressionName(ExpressionNameT&& value) {
    SetExpressionName(std::forward<ExpressionNameT>(value));
    return *this;
  }
  ///@}
 private:
