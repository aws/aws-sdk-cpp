...
{
const size_t LakeFormationEndpointRules::RulesBlobStrLen = 3752;
const size_t LakeFormationEndpointRules::RulesBlobSize = 3753;
...
'h','t','t','p','s',':','/','/','l','a','k','e','f','o','r','m','a','t','i','o','n','-','f','i','p',
