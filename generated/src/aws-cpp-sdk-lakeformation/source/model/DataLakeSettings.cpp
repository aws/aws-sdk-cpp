...
DataLakeSettings::DataLakeSettings(JsonView jsonValue) { *this = jsonValue; }
...
DataLakeSettings& DataLakeSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TrustedResourceOwners")) {
    ...
    for (unsigned trustedResourceOwnersIndex = 0; trustedResourceOwnersIndex < trustedResourceOwnersJsonList.GetLength();
         ++trustedResourceOwnersIndex) {
  ...
  if (jsonValue.ValueExists("ExternalDataFilteringAllowList")) {
    ...
    for (unsigned externalDataFilteringAllowListIndex = 0;
         externalDataFilteringAllowListIndex < externalDataFilteringAllowListJsonList.GetLength(); ++externalDataFilteringAllowListIndex) {
  ...
  if (jsonValue.ValueExists("AuthorizedSessionTagValueList")) {
    ...
    for (unsigned authorizedSessionTagValueListIndex = 0;
         authorizedSessionTagValueListIndex < authorizedSessionTagValueListJsonList.GetLength(); ++authorizedSessionTagValueListIndex) {
...
JsonValue DataLakeSettings::Jsonize() const {
  ...
  if (m_externalDataFilteringAllowListHasBeenSet) {
    ...
    for (unsigned externalDataFilteringAllowListIndex = 0;
         externalDataFilteringAllowListIndex < externalDataFilteringAllowListJsonList.GetLength(); ++externalDataFilteringAllowListIndex) {
      externalDataFilteringAllowListJsonList[externalDataFilteringAllowListIndex].AsObject(
          m_externalDataFilteringAllowList[externalDataFilteringAllowListIndex].Jsonize());
    }
  ...
  if (m_authorizedSessionTagValueListHasBeenSet) {
    ...
    for (unsigned authorizedSessionTagValueListIndex = 0;
         authorizedSessionTagValueListIndex < authorizedSessionTagValueListJsonList.GetLength(); ++authorizedSessionTagValueListIndex) {
      authorizedSessionTagValueListJsonList[authorizedSessionTagValueListIndex].AsString(
          m_authorizedSessionTagValueList[authorizedSessionTagValueListIndex]);
    }
