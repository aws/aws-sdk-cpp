...
BatchPermissionsRequestEntry::BatchPermissionsRequestEntry(JsonView jsonValue) { *this = jsonValue; }
...
BatchPermissionsRequestEntry& BatchPermissionsRequestEntry::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("PermissionsWithGrantOption")) {
    ...
    for (unsigned permissionsWithGrantOptionIndex = 0; permissionsWithGrantOptionIndex < permissionsWithGrantOptionJsonList.GetLength();
      ...
      m_permissionsWithGrantOption.push_back(
          PermissionMapper::GetPermissionForName(permissionsWithGrantOptionJsonList[permissionsWithGrantOptionIndex].AsString()));
    }
