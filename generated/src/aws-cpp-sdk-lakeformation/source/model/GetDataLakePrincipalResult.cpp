...
GetDataLakePrincipalResult::GetDataLakePrincipalResult()
{
}

GetDataLakePrincipalResult::GetDataLakePrincipalResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
