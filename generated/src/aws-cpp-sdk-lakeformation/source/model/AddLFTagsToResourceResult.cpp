...
AddLFTagsToResourceResult::AddLFTagsToResourceResult()
{
}

AddLFTagsToResourceResult::AddLFTagsToResourceResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

AddLFTagsToResourceResult& AddLFTagsToResourceResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
