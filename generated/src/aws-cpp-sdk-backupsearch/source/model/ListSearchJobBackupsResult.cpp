...
ListSearchJobBackupsResult::ListSearchJobBackupsResult()
{
}

ListSearchJobBackupsResult::ListSearchJobBackupsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListSearchJobBackupsResult& ListSearchJobBackupsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
