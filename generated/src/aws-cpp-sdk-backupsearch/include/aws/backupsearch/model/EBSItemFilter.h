...
class EBSItemFilter {
 public:
  ...
  template <typename FilePathsT = Aws::Vector<StringCondition>>
  EBSItemFilter& WithFilePaths(FilePathsT&& value) {
    SetFilePaths(std::forward<FilePathsT>(value));
    return *this;
  }
  template <typename FilePathsT = StringCondition>
  EBSItemFilter& AddFilePaths(FilePathsT&& value) {
    m_filePathsHasBeenSet = true;
  ...
  void SetSizes(SizesT&& value) {
    ...
    m_sizes = std::forward<SizesT>(value);
  }
  template <typename SizesT = Aws::Vector<LongCondition>>
  EBSItemFilter& WithSizes(SizesT&& value) {
    SetSizes(std::forward<SizesT>(value));
    return *this;
  }
  template <typename SizesT = LongCondition>
  EBSItemFilter& AddSizes(SizesT&& value) {
    m_sizesHasBeenSet = true;
    m_sizes.emplace_back(std::forward<SizesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreationTimes(CreationTimesT&& value) {
    m_creationTimesHasBeenSet = true;
    m_creationTimes = std::forward<CreationTimesT>(value);
  }
  template <typename CreationTimesT = Aws::Vector<TimeCondition>>
  EBSItemFilter& WithCreationTimes(CreationTimesT&& value) {
    SetCreationTimes(std::forward<CreationTimesT>(value));
    return *this;
  }
  template <typename CreationTimesT = TimeCondition>
  EBSItemFilter& AddCreationTimes(CreationTimesT&& value) {
    m_creationTimesHasBeenSet = true;
    m_creationTimes.emplace_back(std::forward<CreationTimesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastModificationTimes(LastModificationTimesT&& value) {
    m_lastModificationTimesHasBeenSet = true;
    m_lastModificationTimes = std::forward<LastModificationTimesT>(value);
  }
  template <typename LastModificationTimesT = Aws::Vector<TimeCondition>>
  EBSItemFilter& WithLastModificationTimes(LastModificationTimesT&& value) {
    SetLastModificationTimes(std::forward<LastModificationTimesT>(value));
    return *this;
  }
  template <typename LastModificationTimesT = TimeCondition>
  EBSItemFilter& AddLastModificationTimes(LastModificationTimesT&& value) {
    m_lastModificationTimesHasBeenSet = true;
    m_lastModificationTimes.emplace_back(std::forward<LastModificationTimesT>(value));
    return *this;
  }
  ///@}
 private:
