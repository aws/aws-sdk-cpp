...
class StartSearchResultExportJobResult {
 public:
  ...
  template <typename ExportJobArnT = Aws::String>
  StartSearchResultExportJobResult& WithExportJobArn(ExportJobArnT&& value) {
  ...
  template <typename ExportJobIdentifierT = Aws::String>
  StartSearchResultExportJobResult& WithExportJobIdentifier(ExportJobIdentifierT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartSearchResultExportJobResult& WithRequestId(RequestIdT&& value) {
