...
class ItemFilters {
 public:
  ...
  void SetS3ItemFilters(S3ItemFiltersT&& value) {
    m_s3ItemFiltersHasBeenSet = true;
    m_s3ItemFilters = std::forward<S3ItemFiltersT>(value);
  }
  template <typename S3ItemFiltersT = Aws::Vector<S3ItemFilter>>
  ItemFilters& WithS3ItemFilters(S3ItemFiltersT&& value) {
    SetS3ItemFilters(std::forward<S3ItemFiltersT>(value));
    return *this;
  }
  template <typename S3ItemFiltersT = S3ItemFilter>
  ItemFilters& AddS3ItemFilters(S3ItemFiltersT&& value) {
    m_s3ItemFiltersHasBeenSet = true;
    m_s3ItemFilters.emplace_back(std::forward<S3ItemFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEBSItemFilters(EBSItemFiltersT&& value) {
    m_eBSItemFiltersHasBeenSet = true;
    m_eBSItemFilters = std::forward<EBSItemFiltersT>(value);
  }
  template <typename EBSItemFiltersT = Aws::Vector<EBSItemFilter>>
  ItemFilters& WithEBSItemFilters(EBSItemFiltersT&& value) {
    SetEBSItemFilters(std::forward<EBSItemFiltersT>(value));
    return *this;
  }
  template <typename EBSItemFiltersT = EBSItemFilter>
  ItemFilters& AddEBSItemFilters(EBSItemFiltersT&& value) {
    m_eBSItemFiltersHasBeenSet = true;
    m_eBSItemFilters.emplace_back(std::forward<EBSItemFiltersT>(value));
    return *this;
  }
  ///@}
 private:
