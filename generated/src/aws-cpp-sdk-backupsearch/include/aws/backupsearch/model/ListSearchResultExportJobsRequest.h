...
class ListSearchResultExportJobsRequest : public BackupSearchRequest {
 public:
  ...
  inline ListSearchResultExportJobsRequest& WithStatus(ExportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SearchJobIdentifierT = Aws::String>
  ListSearchResultExportJobsRequest& WithSearchJobIdentifier(SearchJobIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSearchResultExportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSearchResultExportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
