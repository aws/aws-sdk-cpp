...
/**
 * <p>This exception occurs when a conflict with a previous successful operation is
 * detected. This generally occurs when the previous operation did not have time to
 * propagate to the host serving the current request.</p> <p>A retry (with
 * appropriate backoff logic) is the recommended response to this
 * exception.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/backupsearch-2018-05-10/ConflictException">AWS
 * API Reference</a></p>
 */
class ConflictException {
 public:
  AWS_BACKUPSEARCH_API ConflictException() = default;
  AWS_BACKUPSEARCH_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
  AWS_BACKUPSEARCH_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
