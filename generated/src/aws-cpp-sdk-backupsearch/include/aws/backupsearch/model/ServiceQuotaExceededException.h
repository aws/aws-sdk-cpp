...
namespace Model
{
  ...
  /**
   * <p>The request denied due to exceeding the quota limits permitted.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/backupsearch-2018-05-10/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_BACKUPSEARCH_API ServiceQuotaExceededException() = default;
    AWS_BACKUPSEARCH_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
    AWS_BACKUPSEARCH_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
