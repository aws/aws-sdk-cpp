...
class GetSearchJobResult {
 public:
  ...
  void SetSearchScopeSummary(SearchScopeSummaryT&& value) {
    ...
    m_searchScopeSummary = std::forward<SearchScopeSummaryT>(value);
  }
  template <typename SearchScopeSummaryT = SearchScopeSummary>
  GetSearchJobResult& WithSearchScopeSummary(SearchScopeSummaryT&& value) {
    SetSearchScopeSummary(std::forward<SearchScopeSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCurrentSearchProgress(CurrentSearchProgressT&& value) {
    ...
    m_currentSearchProgress = std::forward<CurrentSearchProgressT>(value);
  }
  template <typename CurrentSearchProgressT = CurrentSearchProgress>
  GetSearchJobResult& WithCurrentSearchProgress(CurrentSearchProgressT&& value) {
    SetCurrentSearchProgress(std::forward<CurrentSearchProgressT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(SearchJobState value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetSearchJobResult& WithStatus(SearchJobState value) {
    SetStatus(value);
    return *this;
  }
  ///@}
