...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUPSEARCH_API ListTagsForResourceResult() = default;
    AWS_BACKUPSEARCH_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_BACKUPSEARCH_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
