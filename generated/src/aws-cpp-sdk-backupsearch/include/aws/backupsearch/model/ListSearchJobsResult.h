...
class ListSearchJobsResult {
 public:
  ...
  void SetSearchJobs(SearchJobsT&& value) {
    m_searchJobsHasBeenSet = true;
    m_searchJobs = std::forward<SearchJobsT>(value);
  }
  template <typename SearchJobsT = Aws::Vector<SearchJobSummary>>
  ListSearchJobsResult& WithSearchJobs(SearchJobsT&& value) {
    SetSearchJobs(std::forward<SearchJobsT>(value));
    return *this;
  }
  template <typename SearchJobsT = SearchJobSummary>
  ListSearchJobsResult& AddSearchJobs(SearchJobsT&& value) {
    m_searchJobsHasBeenSet = true;
    m_searchJobs.emplace_back(std::forward<SearchJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSearchJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSearchJobsResult& WithRequestId(RequestIdT&& value) {
