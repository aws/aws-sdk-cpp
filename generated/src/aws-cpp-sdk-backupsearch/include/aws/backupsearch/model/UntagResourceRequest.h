...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public BackupSearchRequest
  {
  public:
    AWS_BACKUPSEARCH_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) that uniquely identifies the resource where
    ...
    ///@{
    /**
     * <p>This required parameter contains the tag keys you want to remove from the
     * source.</p>
     */
