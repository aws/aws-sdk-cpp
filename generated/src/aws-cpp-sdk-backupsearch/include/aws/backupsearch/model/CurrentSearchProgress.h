...
class CurrentSearchProgress {
 public:
  ...
  inline void SetRecoveryPointsScannedCount(int value) {
    m_recoveryPointsScannedCountHasBeenSet = true;
    m_recoveryPointsScannedCount = value;
  }
  inline CurrentSearchProgress& WithRecoveryPointsScannedCount(int value) {
    SetRecoveryPointsScannedCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetItemsScannedCount(long long value) {
    m_itemsScannedCountHasBeenSet = true;
    m_itemsScannedCount = value;
  }
  inline CurrentSearchProgress& WithItemsScannedCount(long long value) {
    SetItemsScannedCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetItemsMatchedCount(long long value) {
    m_itemsMatchedCountHasBeenSet = true;
    m_itemsMatchedCount = value;
  }
  inline CurrentSearchProgress& WithItemsMatchedCount(long long value) {
    SetItemsMatchedCount(value);
    return *this;
  }
  ///@}
 private:
