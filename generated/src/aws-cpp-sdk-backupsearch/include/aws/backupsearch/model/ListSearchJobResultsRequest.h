...
class ListSearchJobResultsRequest : public BackupSearchRequest {
 public:
  ...
  void SetSearchJobIdentifier(SearchJobIdentifierT&& value) {
    ...
    m_searchJobIdentifier = std::forward<SearchJobIdentifierT>(value);
  }
  template <typename SearchJobIdentifierT = Aws::String>
  ListSearchJobResultsRequest& WithSearchJobIdentifier(SearchJobIdentifierT&& value) {
    SetSearchJobIdentifier(std::forward<SearchJobIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSearchJobResultsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSearchJobResultsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
