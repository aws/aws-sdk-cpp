...
class ListSearchJobResultsResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<ResultItem>>
  ListSearchJobResultsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = ResultItem>
  ListSearchJobResultsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSearchJobResultsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSearchJobResultsResult& WithRequestId(RequestIdT&& value) {
