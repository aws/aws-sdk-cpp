...
class ListSearchJobBackupsResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<SearchJobBackupsResult>>
  ListSearchJobBackupsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = SearchJobBackupsResult>
  ListSearchJobBackupsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSearchJobBackupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSearchJobBackupsResult& WithRequestId(RequestIdT&& value) {
