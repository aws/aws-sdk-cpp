...
class ListSearchJobBackupsRequest : public BackupSearchRequest {
 public:
  ...
  template <typename SearchJobIdentifierT = Aws::String>
  ListSearchJobBackupsRequest& WithSearchJobIdentifier(SearchJobIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSearchJobBackupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSearchJobBackupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
