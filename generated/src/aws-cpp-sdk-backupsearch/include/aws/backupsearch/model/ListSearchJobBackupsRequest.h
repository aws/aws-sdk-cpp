...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUPSEARCH_API ListSearchJobBackupsRequest() = default;
    ...
    template<typename SearchJobIdentifierT = Aws::String>
    ListSearchJobBackupsRequest& WithSearchJobIdentifier(SearchJobIdentifierT&& value) { SetSearchJobIdentifier(std::forward<SearchJobIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListSearchJobBackupsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
