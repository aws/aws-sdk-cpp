...
class SearchScopeSummary {
 public:
  ...
  inline void SetTotalRecoveryPointsToScanCount(int value) {
    m_totalRecoveryPointsToScanCountHasBeenSet = true;
    m_totalRecoveryPointsToScanCount = value;
  }
  inline SearchScopeSummary& WithTotalRecoveryPointsToScanCount(int value) {
    SetTotalRecoveryPointsToScanCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalItemsToScanCount(long long value) {
    m_totalItemsToScanCountHasBeenSet = true;
    m_totalItemsToScanCount = value;
  }
  inline SearchScopeSummary& WithTotalItemsToScanCount(long long value) {
    SetTotalItemsToScanCount(value);
    return *this;
  }
  ///@}
 private:
