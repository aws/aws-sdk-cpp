...
class AWS_BACKUPSEARCH_API BackupSearchClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  BackupSearchClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<BackupSearchEndpointProviderBase> endpointProvider = nullptr,
      const Aws::BackupSearch::BackupSearchClientConfiguration& clientConfiguration = Aws::BackupSearch::BackupSearchClientConfiguration());
  ...
  /**
   * An Async wrapper for GetSearchJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSearchJobRequestT = Model::GetSearchJobRequest>
  void GetSearchJobAsync(const GetSearchJobRequestT& request, const GetSearchJobResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for GetSearchResultExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSearchResultExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSearchResultExportJobRequestT = Model::GetSearchResultExportJobRequest>
  void GetSearchResultExportJobAsync(const GetSearchResultExportJobRequestT& request,
                                     const GetSearchResultExportJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSearchJobBackups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSearchJobBackups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSearchJobBackupsRequestT = Model::ListSearchJobBackupsRequest>
  void ListSearchJobBackupsAsync(const ListSearchJobBackupsRequestT& request, const ListSearchJobBackupsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSearchJobResults that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSearchJobResults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSearchJobResultsRequestT = Model::ListSearchJobResultsRequest>
  void ListSearchJobResultsAsync(const ListSearchJobResultsRequestT& request, const ListSearchJobResultsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSearchJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSearchJobsRequestT = Model::ListSearchJobsRequest>
  void ListSearchJobsAsync(const ListSearchJobsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListSearchJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSearchResultExportJobsOutcome ListSearchResultExportJobs(
      const Model::ListSearchResultExportJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSearchResultExportJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSearchResultExportJobsRequestT = Model::ListSearchResultExportJobsRequest>
  Model::ListSearchResultExportJobsOutcomeCallable ListSearchResultExportJobsCallable(
      const ListSearchResultExportJobsRequestT& request = {}) const {
    return SubmitCallable(&BackupSearchClient::ListSearchResultExportJobs, request);
  }

  /**
   * An Async wrapper for ListSearchResultExportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSearchResultExportJobsRequestT = Model::ListSearchResultExportJobsRequest>
  void ListSearchResultExportJobsAsync(const ListSearchResultExportJobsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListSearchResultExportJobsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for StartSearchJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartSearchJobRequestT = Model::StartSearchJobRequest>
  void StartSearchJobAsync(const StartSearchJobRequestT& request, const StartSearchJobResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartSearchResultExportJobOutcome StartSearchResultExportJob(
      const Model::StartSearchResultExportJobRequest& request) const;

  /**
   * A Callable wrapper for StartSearchResultExportJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartSearchResultExportJobRequestT = Model::StartSearchResultExportJobRequest>
  Model::StartSearchResultExportJobOutcomeCallable StartSearchResultExportJobCallable(
      const StartSearchResultExportJobRequestT& request) const {
    return SubmitCallable(&BackupSearchClient::StartSearchResultExportJob, request);
  }

  /**
   * An Async wrapper for StartSearchResultExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartSearchResultExportJobRequestT = Model::StartSearchResultExportJobRequest>
  void StartSearchResultExportJobAsync(const StartSearchResultExportJobRequestT& request,
                                       const StartSearchResultExportJobResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopSearchJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopSearchJobRequestT = Model::StopSearchJobRequest>
  void StopSearchJobAsync(const StopSearchJobRequestT& request, const StopSearchJobResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
