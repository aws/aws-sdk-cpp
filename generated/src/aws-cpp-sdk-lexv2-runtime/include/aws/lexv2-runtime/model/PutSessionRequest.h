...
class PutSessionRequest : public LexRuntimeV2Request {
 public:
  ...
  template <typename BotIdT = Aws::String>
  PutSessionRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotAliasIdT = Aws::String>
  PutSessionRequest& WithBotAliasId(BotAliasIdT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  PutSessionRequest& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  PutSessionRequest& WithSessionId(SessionIdT&& value) {
  ...
  template <typename MessagesT = Aws::Vector<Message>>
  PutSessionRequest& WithMessages(MessagesT&& value) {
    SetMessages(std::forward<MessagesT>(value));
    return *this;
  }
  template <typename MessagesT = Message>
  PutSessionRequest& AddMessages(MessagesT&& value) {
    m_messagesHasBeenSet = true;
  ...
  template <typename SessionStateT = SessionState>
  PutSessionRequest& WithSessionState(SessionStateT&& value) {
  ...
  template <typename RequestAttributesT = Aws::Map<Aws::String, Aws::String>>
  PutSessionRequest& WithRequestAttributes(RequestAttributesT&& value) {
  ...
  template <typename ResponseContentTypeT = Aws::String>
  PutSessionRequest& WithResponseContentType(ResponseContentTypeT&& value) {
