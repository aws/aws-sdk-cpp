...
class DTMFInputEvent {
 public:
  ...
  void SetInputCharacter(InputCharacterT&& value) {
    ...
    m_inputCharacter = std::forward<InputCharacterT>(value);
  }
  template <typename InputCharacterT = Aws::String>
  DTMFInputEvent& WithInputCharacter(InputCharacterT&& value) {
    SetInputCharacter(std::forward<InputCharacterT>(value));
    return *this;
  }
  ///@}
  ...
  inline DTMFInputEvent& WithClientTimestampMillis(long long value) {
