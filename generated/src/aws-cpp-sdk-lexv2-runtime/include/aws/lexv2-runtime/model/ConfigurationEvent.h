...
class ConfigurationEvent {
 public:
  ...
  void SetRequestAttributes(RequestAttributesT&& value) {
    ...
    m_requestAttributes = std::forward<RequestAttributesT>(value);
  }
  template <typename RequestAttributesT = Aws::Map<Aws::String, Aws::String>>
  ConfigurationEvent& WithRequestAttributes(RequestAttributesT&& value) {
    SetRequestAttributes(std::forward<RequestAttributesT>(value));
    return *this;
  }
  ...
  ConfigurationEvent& AddRequestAttributes(RequestAttributesKeyT&& key, RequestAttributesValueT&& value) {
    m_requestAttributesHasBeenSet = true;
    m_requestAttributes.emplace(std::forward<RequestAttributesKeyT>(key), std::forward<RequestAttributesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSessionState(SessionStateT&& value) {
    ...
    m_sessionState = std::forward<SessionStateT>(value);
  }
  template <typename SessionStateT = SessionState>
  ConfigurationEvent& WithSessionState(SessionStateT&& value) {
    SetSessionState(std::forward<SessionStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWelcomeMessages(WelcomeMessagesT&& value) {
    ...
    m_welcomeMessages = std::forward<WelcomeMessagesT>(value);
  }
  template <typename WelcomeMessagesT = Aws::Vector<Message>>
  ConfigurationEvent& WithWelcomeMessages(WelcomeMessagesT&& value) {
    SetWelcomeMessages(std::forward<WelcomeMessagesT>(value));
    return *this;
  }
  template <typename WelcomeMessagesT = Message>
  ConfigurationEvent& AddWelcomeMessages(WelcomeMessagesT&& value) {
    m_welcomeMessagesHasBeenSet = true;
    m_welcomeMessages.emplace_back(std::forward<WelcomeMessagesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDisablePlayback(bool value) {
    m_disablePlaybackHasBeenSet = true;
    m_disablePlayback = value;
  }
  inline ConfigurationEvent& WithDisablePlayback(bool value) {
    SetDisablePlayback(value);
    return *this;
  }
  ///@}
  ...
  inline void SetClientTimestampMillis(long long value) {
    m_clientTimestampMillisHasBeenSet = true;
    m_clientTimestampMillis = value;
  }
  inline ConfigurationEvent& WithClientTimestampMillis(long long value) {
    SetClientTimestampMillis(value);
    return *this;
  }
  ///@}
 private:
