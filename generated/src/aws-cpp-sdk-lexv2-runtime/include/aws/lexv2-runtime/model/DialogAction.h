...
class DialogAction {
 public:
  ...
  inline void SetSlotElicitationStyle(StyleType value) {
    m_slotElicitationStyleHasBeenSet = true;
    m_slotElicitationStyle = value;
  }
  inline DialogAction& WithSlotElicitationStyle(StyleType value) {
    SetSlotElicitationStyle(value);
    return *this;
  }
  ///@}
  ...
  void SetSubSlotToElicit(SubSlotToElicitT&& value) {
    ...
    m_subSlotToElicit = std::forward<SubSlotToElicitT>(value);
  }
  template <typename SubSlotToElicitT = ElicitSubSlot>
