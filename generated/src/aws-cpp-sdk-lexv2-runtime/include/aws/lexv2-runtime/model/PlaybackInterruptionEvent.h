...
class PlaybackInterruptionEvent {
 public:
  ...
  inline void SetEventReason(PlaybackInterruptionReason value) {
    m_eventReasonHasBeenSet = true;
    m_eventReason = value;
  }
  inline PlaybackInterruptionEvent& WithEventReason(PlaybackInterruptionReason value) {
  ...
  void SetCausedByEventId(CausedByEventIdT&& value) {
    ...
    m_causedByEventId = std::forward<CausedByEventIdT>(value);
  }
  template <typename CausedByEventIdT = Aws::String>
  PlaybackInterruptionEvent& WithCausedByEventId(CausedByEventIdT&& value) {
    SetCausedByEventId(std::forward<CausedByEventIdT>(value));
    return *this;
  }
  ///@}
