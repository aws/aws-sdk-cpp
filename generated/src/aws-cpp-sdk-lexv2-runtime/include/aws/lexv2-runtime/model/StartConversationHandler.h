...
class StartConversationHandler : public Aws::Utils::Event::EventStreamHandler {
  ...
  typedef std::function<void(const StartConversationInitialResponse&, const Utils::Event::InitialResponseType)>
      StartConversationInitialResponseCallbackEx;
 ...
 public:
  ...
  inline void SetInitialResponseCallback(const StartConversationInitialResponseCallback& noArgCallback) {
    m_onInitialResponse = [noArgCallback](const StartConversationInitialResponse& rs, const Utils::Event::InitialResponseType) {
      return noArgCallback(rs);
    };
  }
  ///@}
  inline void SetPlaybackInterruptionEventCallback(const PlaybackInterruptionEventCallback& callback) {
    m_onPlaybackInterruptionEvent = callback;
  }
