...
class Value {
 public:
  ...
  void SetOriginalValue(OriginalValueT&& value) {
    ...
    m_originalValue = std::forward<OriginalValueT>(value);
  }
  template <typename OriginalValueT = Aws::String>
  Value& WithOriginalValue(OriginalValueT&& value) {
    SetOriginalValue(std::forward<OriginalValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInterpretedValue(InterpretedValueT&& value) {
    ...
    m_interpretedValue = std::forward<InterpretedValueT>(value);
  }
  template <typename InterpretedValueT = Aws::String>
  Value& WithInterpretedValue(InterpretedValueT&& value) {
    SetInterpretedValue(std::forward<InterpretedValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResolvedValues(ResolvedValuesT&& value) {
    ...
    m_resolvedValues = std::forward<ResolvedValuesT>(value);
  }
  template <typename ResolvedValuesT = Aws::Vector<Aws::String>>
  Value& WithResolvedValues(ResolvedValuesT&& value) {
    SetResolvedValues(std::forward<ResolvedValuesT>(value));
    return *this;
  }
  template <typename ResolvedValuesT = Aws::String>
  Value& AddResolvedValues(ResolvedValuesT&& value) {
    m_resolvedValuesHasBeenSet = true;
    m_resolvedValues.emplace_back(std::forward<ResolvedValuesT>(value));
    return *this;
  }
  ///@}
 private:
