...
DisconnectionEvent::DisconnectionEvent(JsonView jsonValue) { *this = jsonValue; }

DisconnectionEvent& DisconnectionEvent::operator=(JsonView jsonValue) {
...
JsonValue DisconnectionEvent::Jsonize() const {
  JsonValue payload;
