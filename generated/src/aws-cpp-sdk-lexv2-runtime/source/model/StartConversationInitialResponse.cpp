...
StartConversationInitialResponse::StartConversationInitialResponse(JsonView jsonValue) { *this = jsonValue; }
...
StartConversationInitialResponse::StartConversationInitialResponse(const Http::HeaderValueCollection& headers)
