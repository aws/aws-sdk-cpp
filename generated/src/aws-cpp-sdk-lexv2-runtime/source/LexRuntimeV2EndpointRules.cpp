...
{
const size_t LexRuntimeV2EndpointRules::RulesBlobStrLen = 3424;
const size_t LexRuntimeV2EndpointRules::RulesBlobSize = 3425;
...
'r','u','n','t','i','m','e','-','v','2','-','l','e','x','.','{','R','e','g','i','o','n','}','.','{',
...
'e','-','v','2','-','l','e','x','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
