...
class AWS_DYNAMODB_API DynamoDBClient
 ...
 public:
   ...
   */
  DynamoDBClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DynamoDBEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for BatchGetItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetItemRequestT = Model::BatchGetItemRequest>
  void BatchGetItemAsync(const BatchGetItemRequestT& request, const BatchGetItemResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for BatchWriteItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchWriteItemRequestT = Model::BatchWriteItemRequest>
  void BatchWriteItemAsync(const BatchWriteItemRequestT& request, const BatchWriteItemResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename CreateBackupRequestT = Model::CreateBackupRequest>
  void CreateBackupAsync(const CreateBackupRequestT& request, const CreateBackupResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateGlobalTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateGlobalTable that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateGlobalTableRequestT = Model::CreateGlobalTableRequest>
  void CreateGlobalTableAsync(const CreateGlobalTableRequestT& request, const CreateGlobalTableResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteItemRequestT = Model::DeleteItemRequest>
  void DeleteItemAsync(const DeleteItemRequestT& request, const DeleteItemResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeBackup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeBackupRequestT = Model::DescribeBackupRequest>
  void DescribeBackupAsync(const DescribeBackupRequestT& request, const DescribeBackupResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeContinuousBackups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeContinuousBackupsRequestT = Model::DescribeContinuousBackupsRequest>
  Model::DescribeContinuousBackupsOutcomeCallable DescribeContinuousBackupsCallable(
      const DescribeContinuousBackupsRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::DescribeContinuousBackups, request);
  }

  /**
   * An Async wrapper for DescribeContinuousBackups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeContinuousBackupsRequestT = Model::DescribeContinuousBackupsRequest>
  void DescribeContinuousBackupsAsync(const DescribeContinuousBackupsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeContributorInsightsOutcome DescribeContributorInsights(
      const Model::DescribeContributorInsightsRequest& request) const;

  /**
   * A Callable wrapper for DescribeContributorInsights that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeContributorInsightsRequestT = Model::DescribeContributorInsightsRequest>
  Model::DescribeContributorInsightsOutcomeCallable DescribeContributorInsightsCallable(
      const DescribeContributorInsightsRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::DescribeContributorInsights, request);
  }

  /**
   * An Async wrapper for DescribeContributorInsights that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeContributorInsightsRequestT = Model::DescribeContributorInsightsRequest>
  void DescribeContributorInsightsAsync(const DescribeContributorInsightsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeGlobalTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeGlobalTable that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeGlobalTableRequestT = Model::DescribeGlobalTableRequest>
  void DescribeGlobalTableAsync(const DescribeGlobalTableRequestT& request, const DescribeGlobalTableResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeGlobalTableSettingsOutcome DescribeGlobalTableSettings(
      const Model::DescribeGlobalTableSettingsRequest& request) const;

  /**
   * A Callable wrapper for DescribeGlobalTableSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeGlobalTableSettingsRequestT = Model::DescribeGlobalTableSettingsRequest>
  Model::DescribeGlobalTableSettingsOutcomeCallable DescribeGlobalTableSettingsCallable(
      const DescribeGlobalTableSettingsRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::DescribeGlobalTableSettings, request);
  }

  /**
   * An Async wrapper for DescribeGlobalTableSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeGlobalTableSettingsRequestT = Model::DescribeGlobalTableSettingsRequest>
  void DescribeGlobalTableSettingsAsync(const DescribeGlobalTableSettingsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeKinesisStreamingDestinationOutcome DescribeKinesisStreamingDestination(
      const Model::DescribeKinesisStreamingDestinationRequest& request) const;

  /**
   * A Callable wrapper for DescribeKinesisStreamingDestination that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeKinesisStreamingDestinationRequestT = Model::DescribeKinesisStreamingDestinationRequest>
  Model::DescribeKinesisStreamingDestinationOutcomeCallable DescribeKinesisStreamingDestinationCallable(
      const DescribeKinesisStreamingDestinationRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::DescribeKinesisStreamingDestination, request);
  }

  /**
   * An Async wrapper for DescribeKinesisStreamingDestination that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeKinesisStreamingDestinationRequestT = Model::DescribeKinesisStreamingDestinationRequest>
  void DescribeKinesisStreamingDestinationAsync(const DescribeKinesisStreamingDestinationRequestT& request,
                                                const DescribeKinesisStreamingDestinationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTableReplicaAutoScalingOutcome DescribeTableReplicaAutoScaling(
      const Model::DescribeTableReplicaAutoScalingRequest& request) const;

  /**
   * A Callable wrapper for DescribeTableReplicaAutoScaling that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeTableReplicaAutoScalingRequestT = Model::DescribeTableReplicaAutoScalingRequest>
  Model::DescribeTableReplicaAutoScalingOutcomeCallable DescribeTableReplicaAutoScalingCallable(
      const DescribeTableReplicaAutoScalingRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::DescribeTableReplicaAutoScaling, request);
  }

  /**
   * An Async wrapper for DescribeTableReplicaAutoScaling that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeTableReplicaAutoScalingRequestT = Model::DescribeTableReplicaAutoScalingRequest>
  void DescribeTableReplicaAutoScalingAsync(const DescribeTableReplicaAutoScalingRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeTimeToLive that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTimeToLive that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeTimeToLiveRequestT = Model::DescribeTimeToLiveRequest>
  void DescribeTimeToLiveAsync(const DescribeTimeToLiveRequestT& request, const DescribeTimeToLiveResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableKinesisStreamingDestinationOutcome DisableKinesisStreamingDestination(
      const Model::DisableKinesisStreamingDestinationRequest& request) const;

  /**
   * A Callable wrapper for DisableKinesisStreamingDestination that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisableKinesisStreamingDestinationRequestT = Model::DisableKinesisStreamingDestinationRequest>
  Model::DisableKinesisStreamingDestinationOutcomeCallable DisableKinesisStreamingDestinationCallable(
      const DisableKinesisStreamingDestinationRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::DisableKinesisStreamingDestination, request);
  }

  /**
   * An Async wrapper for DisableKinesisStreamingDestination that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisableKinesisStreamingDestinationRequestT = Model::DisableKinesisStreamingDestinationRequest>
  void DisableKinesisStreamingDestinationAsync(const DisableKinesisStreamingDestinationRequestT& request,
                                               const DisableKinesisStreamingDestinationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableKinesisStreamingDestinationOutcome EnableKinesisStreamingDestination(
      const Model::EnableKinesisStreamingDestinationRequest& request) const;

  /**
   * A Callable wrapper for EnableKinesisStreamingDestination that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename EnableKinesisStreamingDestinationRequestT = Model::EnableKinesisStreamingDestinationRequest>
  Model::EnableKinesisStreamingDestinationOutcomeCallable EnableKinesisStreamingDestinationCallable(
      const EnableKinesisStreamingDestinationRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::EnableKinesisStreamingDestination, request);
  }

  /**
   * An Async wrapper for EnableKinesisStreamingDestination that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename EnableKinesisStreamingDestinationRequestT = Model::EnableKinesisStreamingDestinationRequest>
  void EnableKinesisStreamingDestinationAsync(const EnableKinesisStreamingDestinationRequestT& request,
                                              const EnableKinesisStreamingDestinationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExecuteTransaction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExecuteTransaction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ExecuteTransactionRequestT = Model::ExecuteTransactionRequest>
  void ExecuteTransactionAsync(const ExecuteTransactionRequestT& request, const ExecuteTransactionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExportTableToPointInTime that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExportTableToPointInTime that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExportTableToPointInTimeRequestT = Model::ExportTableToPointInTimeRequest>
  void ExportTableToPointInTimeAsync(const ExportTableToPointInTimeRequestT& request,
  ...
  /**
   * An Async wrapper for GetItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetItemRequestT = Model::GetItemRequest>
  void GetItemAsync(const GetItemRequestT& request, const GetItemResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportTable that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportTableRequestT = Model::ImportTableRequest>
  void ImportTableAsync(const ImportTableRequestT& request, const ImportTableResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListBackups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBackupsRequestT = Model::ListBackupsRequest>
  void ListBackupsAsync(const ListBackupsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListBackupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListContributorInsights that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListContributorInsights that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListContributorInsightsRequestT = Model::ListContributorInsightsRequest>
  void ListContributorInsightsAsync(const ListContributorInsightsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListContributorInsightsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListGlobalTables that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGlobalTables that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGlobalTablesRequestT = Model::ListGlobalTablesRequest>
  void ListGlobalTablesAsync(const ListGlobalTablesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListGlobalTablesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTagsOfResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTagsOfResource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTagsOfResourceRequestT = Model::ListTagsOfResourceRequest>
  void ListTagsOfResourceAsync(const ListTagsOfResourceRequestT& request, const ListTagsOfResourceResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutItemRequestT = Model::PutItemRequest>
  void PutItemAsync(const PutItemRequestT& request, const PutItemResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RestoreTableFromBackup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RestoreTableFromBackup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestoreTableFromBackupRequestT = Model::RestoreTableFromBackupRequest>
  void RestoreTableFromBackupAsync(const RestoreTableFromBackupRequestT& request,
  ...
  /**
   * A Callable wrapper for RestoreTableToPointInTime that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RestoreTableToPointInTimeRequestT = Model::RestoreTableToPointInTimeRequest>
  Model::RestoreTableToPointInTimeOutcomeCallable RestoreTableToPointInTimeCallable(
      const RestoreTableToPointInTimeRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::RestoreTableToPointInTime, request);
  }

  /**
   * An Async wrapper for RestoreTableToPointInTime that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestoreTableToPointInTimeRequestT = Model::RestoreTableToPointInTimeRequest>
  void RestoreTableToPointInTimeAsync(const RestoreTableToPointInTimeRequestT& request,
  ...
  /**
   * A Callable wrapper for TransactGetItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TransactGetItems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TransactGetItemsRequestT = Model::TransactGetItemsRequest>
  void TransactGetItemsAsync(const TransactGetItemsRequestT& request, const TransactGetItemsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TransactWriteItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TransactWriteItems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TransactWriteItemsRequestT = Model::TransactWriteItemsRequest>
  void TransactWriteItemsAsync(const TransactWriteItemsRequestT& request, const TransactWriteItemsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateContinuousBackups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateContinuousBackups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContinuousBackupsRequestT = Model::UpdateContinuousBackupsRequest>
  void UpdateContinuousBackupsAsync(const UpdateContinuousBackupsRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateContributorInsights that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateContributorInsightsRequestT = Model::UpdateContributorInsightsRequest>
  Model::UpdateContributorInsightsOutcomeCallable UpdateContributorInsightsCallable(
      const UpdateContributorInsightsRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::UpdateContributorInsights, request);
  }

  /**
   * An Async wrapper for UpdateContributorInsights that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContributorInsightsRequestT = Model::UpdateContributorInsightsRequest>
  void UpdateContributorInsightsAsync(const UpdateContributorInsightsRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateGlobalTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateGlobalTable that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateGlobalTableRequestT = Model::UpdateGlobalTableRequest>
  void UpdateGlobalTableAsync(const UpdateGlobalTableRequestT& request, const UpdateGlobalTableResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateGlobalTableSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateGlobalTableSettingsRequestT = Model::UpdateGlobalTableSettingsRequest>
  Model::UpdateGlobalTableSettingsOutcomeCallable UpdateGlobalTableSettingsCallable(
      const UpdateGlobalTableSettingsRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::UpdateGlobalTableSettings, request);
  }

  /**
   * An Async wrapper for UpdateGlobalTableSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateGlobalTableSettingsRequestT = Model::UpdateGlobalTableSettingsRequest>
  void UpdateGlobalTableSettingsAsync(const UpdateGlobalTableSettingsRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateItemRequestT = Model::UpdateItemRequest>
  void UpdateItemAsync(const UpdateItemRequestT& request, const UpdateItemResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateKinesisStreamingDestinationOutcome UpdateKinesisStreamingDestination(
      const Model::UpdateKinesisStreamingDestinationRequest& request) const;

  /**
   * A Callable wrapper for UpdateKinesisStreamingDestination that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateKinesisStreamingDestinationRequestT = Model::UpdateKinesisStreamingDestinationRequest>
  Model::UpdateKinesisStreamingDestinationOutcomeCallable UpdateKinesisStreamingDestinationCallable(
      const UpdateKinesisStreamingDestinationRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::UpdateKinesisStreamingDestination, request);
  }

  /**
   * An Async wrapper for UpdateKinesisStreamingDestination that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateKinesisStreamingDestinationRequestT = Model::UpdateKinesisStreamingDestinationRequest>
  void UpdateKinesisStreamingDestinationAsync(const UpdateKinesisStreamingDestinationRequestT& request,
                                              const UpdateKinesisStreamingDestinationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateTableReplicaAutoScalingOutcome UpdateTableReplicaAutoScaling(
      const Model::UpdateTableReplicaAutoScalingRequest& request) const;

  /**
   * A Callable wrapper for UpdateTableReplicaAutoScaling that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateTableReplicaAutoScalingRequestT = Model::UpdateTableReplicaAutoScalingRequest>
  Model::UpdateTableReplicaAutoScalingOutcomeCallable UpdateTableReplicaAutoScalingCallable(
      const UpdateTableReplicaAutoScalingRequestT& request) const {
    return SubmitCallable(&DynamoDBClient::UpdateTableReplicaAutoScaling, request);
  }

  /**
   * An Async wrapper for UpdateTableReplicaAutoScaling that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTableReplicaAutoScalingRequestT = Model::UpdateTableReplicaAutoScalingRequest>
  void UpdateTableReplicaAutoScalingAsync(const UpdateTableReplicaAutoScalingRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateTimeToLive that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTimeToLive that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateTimeToLiveRequestT = Model::UpdateTimeToLiveRequest>
  void UpdateTimeToLiveAsync(const UpdateTimeToLiveRequestT& request, const UpdateTimeToLiveResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
