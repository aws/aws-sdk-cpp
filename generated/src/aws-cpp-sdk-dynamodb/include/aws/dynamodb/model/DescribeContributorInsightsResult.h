...
namespace Model
{
  ...
  public:
    ...
    void SetIndexName(IndexNameT&& value) { m_indexName = std::forward<IndexNameT>(value); }
    template<typename IndexNameT = Aws::String>
    ...
    void SetContributorInsightsRuleList(ContributorInsightsRuleListT&& value) { m_contributorInsightsRuleList = std::forward<ContributorInsightsRuleListT>(value); }
    template<typename ContributorInsightsRuleListT = Aws::Vector<Aws::String>>
    ...
    DescribeContributorInsightsResult& AddContributorInsightsRuleList(ContributorInsightsRuleListT&& value) { m_contributorInsightsRuleList.emplace_back(std::forward<ContributorInsightsRuleListT>(value)); return *this; }
    ///@}
    ...
    inline void SetContributorInsightsStatus(ContributorInsightsStatus value) { m_contributorInsightsStatus = value; }
    ...
    void SetLastUpdateDateTime(LastUpdateDateTimeT&& value) { m_lastUpdateDateTime = std::forward<LastUpdateDateTimeT>(value); }
    template<typename LastUpdateDateTimeT = Aws::Utils::DateTime>
    ...
    void SetFailureException(FailureExceptionT&& value) { m_failureException = std::forward<FailureExceptionT>(value); }
    template<typename FailureExceptionT = FailureException>
