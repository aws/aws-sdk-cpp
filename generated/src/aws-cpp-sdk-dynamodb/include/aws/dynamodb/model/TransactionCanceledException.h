...
class TransactionCanceledException {
 public:
  ...
  void SetCancellationReasons(CancellationReasonsT&& value) {
    ...
    m_cancellationReasons = std::forward<CancellationReasonsT>(value);
  }
  template <typename CancellationReasonsT = Aws::Vector<CancellationReason>>
  TransactionCanceledException& WithCancellationReasons(CancellationReasonsT&& value) {
    SetCancellationReasons(std::forward<CancellationReasonsT>(value));
    return *this;
  }
  ...
  TransactionCanceledException& AddCancellationReasons(CancellationReasonsT&& value) {
    m_cancellationReasonsHasBeenSet = true;
    m_cancellationReasons.emplace_back(std::forward<CancellationReasonsT>(value));
    return *this;
  }
  ///@}
 private:
