...
class ReplicaGlobalSecondaryIndexAutoScalingUpdate {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  ReplicaGlobalSecondaryIndexAutoScalingUpdate& WithIndexName(IndexNameT&& value) {
  ...
  inline const AutoScalingSettingsUpdate& GetProvisionedReadCapacityAutoScalingUpdate() const {
    return m_provisionedReadCapacityAutoScalingUpdate;
  }
  ...
  void SetProvisionedReadCapacityAutoScalingUpdate(ProvisionedReadCapacityAutoScalingUpdateT&& value) {
    m_provisionedReadCapacityAutoScalingUpdateHasBeenSet = true;
    m_provisionedReadCapacityAutoScalingUpdate = std::forward<ProvisionedReadCapacityAutoScalingUpdateT>(value);
  }
  template <typename ProvisionedReadCapacityAutoScalingUpdateT = AutoScalingSettingsUpdate>
  ReplicaGlobalSecondaryIndexAutoScalingUpdate& WithProvisionedReadCapacityAutoScalingUpdate(
      ProvisionedReadCapacityAutoScalingUpdateT&& value) {
    SetProvisionedReadCapacityAutoScalingUpdate(std::forward<ProvisionedReadCapacityAutoScalingUpdateT>(value));
    return *this;
  }
  ///@}
 private:
