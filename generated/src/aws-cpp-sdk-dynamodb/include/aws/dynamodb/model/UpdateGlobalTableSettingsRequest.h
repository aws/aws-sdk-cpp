...
class UpdateGlobalTableSettingsRequest : public DynamoDBRequest {
 public:
  ...
  void SetGlobalTableName(GlobalTableNameT&& value) {
    ...
    m_globalTableName = std::forward<GlobalTableNameT>(value);
  }
  template <typename GlobalTableNameT = Aws::String>
  UpdateGlobalTableSettingsRequest& WithGlobalTableName(GlobalTableNameT&& value) {
    SetGlobalTableName(std::forward<GlobalTableNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetGlobalTableBillingMode(BillingMode value) {
    m_globalTableBillingModeHasBeenSet = true;
    m_globalTableBillingMode = value;
  }
  inline UpdateGlobalTableSettingsRequest& WithGlobalTableBillingMode(BillingMode value) {
    SetGlobalTableBillingMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGlobalTableProvisionedWriteCapacityUnits(long long value) {
    m_globalTableProvisionedWriteCapacityUnitsHasBeenSet = true;
    m_globalTableProvisionedWriteCapacityUnits = value;
  }
  inline UpdateGlobalTableSettingsRequest& WithGlobalTableProvisionedWriteCapacityUnits(long long value) {
    SetGlobalTableProvisionedWriteCapacityUnits(value);
    return *this;
  }
  ///@}
   ...
   * table.</p>
   */
  inline const AutoScalingSettingsUpdate& GetGlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate() const {
    return m_globalTableProvisionedWriteCapacityAutoScalingSettingsUpdate;
  }
  inline bool GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdateHasBeenSet() const {
    return m_globalTableProvisionedWriteCapacityAutoScalingSettingsUpdateHasBeenSet;
  }
  ...
  void SetGlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate(
      GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdateT&& value) {
    m_globalTableProvisionedWriteCapacityAutoScalingSettingsUpdateHasBeenSet = true;
    m_globalTableProvisionedWriteCapacityAutoScalingSettingsUpdate =
        std::forward<GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdateT>(value);
  }
  template <typename GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdateT = AutoScalingSettingsUpdate>
   ...
   * will be modified.</p>
   */
  inline const Aws::Vector<GlobalTableGlobalSecondaryIndexSettingsUpdate>& GetGlobalTableGlobalSecondaryIndexSettingsUpdate() const {
    return m_globalTableGlobalSecondaryIndexSettingsUpdate;
  }
  inline bool GlobalTableGlobalSecondaryIndexSettingsUpdateHasBeenSet() const {
    return m_globalTableGlobalSecondaryIndexSettingsUpdateHasBeenSet;
  }
  ...
  void SetGlobalTableGlobalSecondaryIndexSettingsUpdate(GlobalTableGlobalSecondaryIndexSettingsUpdateT&& value) {
    m_globalTableGlobalSecondaryIndexSettingsUpdateHasBeenSet = true;
    m_globalTableGlobalSecondaryIndexSettingsUpdate = std::forward<GlobalTableGlobalSecondaryIndexSettingsUpdateT>(value);
  }
  template <typename GlobalTableGlobalSecondaryIndexSettingsUpdateT = Aws::Vector<GlobalTableGlobalSecondaryIndexSettingsUpdate>>
  UpdateGlobalTableSettingsRequest& WithGlobalTableGlobalSecondaryIndexSettingsUpdate(
      GlobalTableGlobalSecondaryIndexSettingsUpdateT&& value) {
    SetGlobalTableGlobalSecondaryIndexSettingsUpdate(std::forward<GlobalTableGlobalSecondaryIndexSettingsUpdateT>(value));
    return *this;
  }
  template <typename GlobalTableGlobalSecondaryIndexSettingsUpdateT = GlobalTableGlobalSecondaryIndexSettingsUpdate>
  UpdateGlobalTableSettingsRequest& AddGlobalTableGlobalSecondaryIndexSettingsUpdate(
      GlobalTableGlobalSecondaryIndexSettingsUpdateT&& value) {
    m_globalTableGlobalSecondaryIndexSettingsUpdateHasBeenSet = true;
    m_globalTableGlobalSecondaryIndexSettingsUpdate.emplace_back(std::forward<GlobalTableGlobalSecondaryIndexSettingsUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicaSettingsUpdate(ReplicaSettingsUpdateT&& value) {
    m_replicaSettingsUpdateHasBeenSet = true;
    m_replicaSettingsUpdate = std::forward<ReplicaSettingsUpdateT>(value);
  }
  template <typename ReplicaSettingsUpdateT = Aws::Vector<ReplicaSettingsUpdate>>
  UpdateGlobalTableSettingsRequest& WithReplicaSettingsUpdate(ReplicaSettingsUpdateT&& value) {
    SetReplicaSettingsUpdate(std::forward<ReplicaSettingsUpdateT>(value));
    return *this;
  }
  ...
  UpdateGlobalTableSettingsRequest& AddReplicaSettingsUpdate(ReplicaSettingsUpdateT&& value) {
    m_replicaSettingsUpdateHasBeenSet = true;
    m_replicaSettingsUpdate.emplace_back(std::forward<ReplicaSettingsUpdateT>(value));
    return *this;
  }
  ///@}
 private:
