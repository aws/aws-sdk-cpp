...
namespace Model
{
  ...
  public:
    ...
    BatchExecuteStatementResult& AddResponses(ResponsesT&& value) { m_responses.emplace_back(std::forward<ResponsesT>(value)); return *this; }
    ///@}
    ...
    BatchExecuteStatementResult& AddConsumedCapacity(ConsumedCapacityT&& value) { m_consumedCapacity.emplace_back(std::forward<ConsumedCapacityT>(value)); return *this; }
    ///@}
