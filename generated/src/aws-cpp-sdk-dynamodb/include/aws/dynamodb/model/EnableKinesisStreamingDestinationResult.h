...
class EnableKinesisStreamingDestinationResult {
 public:
  ...
  AWS_DYNAMODB_API EnableKinesisStreamingDestinationResult& operator=(
  ...
  inline EnableKinesisStreamingDestinationResult& WithDestinationStatus(DestinationStatus value) {
