...
namespace Model
{
  ...
  public:
    ...
    void SetConsumedCapacity(ConsumedCapacityT&& value) { m_consumedCapacity = std::forward<ConsumedCapacityT>(value); }
    template<typename ConsumedCapacityT = Aws::Vector<ConsumedCapacity>>
    ...
    TransactGetItemsResult& AddConsumedCapacity(ConsumedCapacityT&& value) { m_consumedCapacity.emplace_back(std::forward<ConsumedCapacityT>(value)); return *this; }
    ///@}
    ...
    void SetResponses(ResponsesT&& value) { m_responses = std::forward<ResponsesT>(value); }
    template<typename ResponsesT = Aws::Vector<ItemResponse>>
    ...
    TransactGetItemsResult& AddResponses(ResponsesT&& value) { m_responses.emplace_back(std::forward<ResponsesT>(value)); return *this; }
    ///@}
