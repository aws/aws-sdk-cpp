...
namespace Model
{
  ...
  public:
    ...
    void SetBackupSummaries(BackupSummariesT&& value) { m_backupSummaries = std::forward<BackupSummariesT>(value); }
    template<typename BackupSummariesT = Aws::Vector<BackupSummary>>
    ...
    ListBackupsResult& AddBackupSummaries(BackupSummariesT&& value) { m_backupSummaries.emplace_back(std::forward<BackupSummariesT>(value)); return *this; }
    ///@}
    ...
    void SetLastEvaluatedBackupArn(LastEvaluatedBackupArnT&& value) { m_lastEvaluatedBackupArn = std::forward<LastEvaluatedBackupArnT>(value); }
    template<typename LastEvaluatedBackupArnT = Aws::String>
