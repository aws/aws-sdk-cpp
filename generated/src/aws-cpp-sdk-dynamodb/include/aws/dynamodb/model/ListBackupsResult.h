...
class ListBackupsResult {
 public:
  ...
  void SetBackupSummaries(BackupSummariesT&& value) {
    m_backupSummariesHasBeenSet = true;
    m_backupSummaries = std::forward<BackupSummariesT>(value);
  }
  template <typename BackupSummariesT = Aws::Vector<BackupSummary>>
  ListBackupsResult& WithBackupSummaries(BackupSummariesT&& value) {
    SetBackupSummaries(std::forward<BackupSummariesT>(value));
    return *this;
  }
  template <typename BackupSummariesT = BackupSummary>
  ListBackupsResult& AddBackupSummaries(BackupSummariesT&& value) {
    m_backupSummariesHasBeenSet = true;
    m_backupSummaries.emplace_back(std::forward<BackupSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastEvaluatedBackupArn(LastEvaluatedBackupArnT&& value) {
    m_lastEvaluatedBackupArnHasBeenSet = true;
    m_lastEvaluatedBackupArn = std::forward<LastEvaluatedBackupArnT>(value);
  }
  template <typename LastEvaluatedBackupArnT = Aws::String>
  ListBackupsResult& WithLastEvaluatedBackupArn(LastEvaluatedBackupArnT&& value) {
    SetLastEvaluatedBackupArn(std::forward<LastEvaluatedBackupArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBackupsResult& WithRequestId(RequestIdT&& value) {
