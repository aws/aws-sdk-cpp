...
class FailureException {
 public:
  ...
  void SetExceptionName(ExceptionNameT&& value) {
    ...
    m_exceptionName = std::forward<ExceptionNameT>(value);
  }
  template <typename ExceptionNameT = Aws::String>
  FailureException& WithExceptionName(ExceptionNameT&& value) {
    SetExceptionName(std::forward<ExceptionNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExceptionDescription(ExceptionDescriptionT&& value) {
    ...
    m_exceptionDescription = std::forward<ExceptionDescriptionT>(value);
  }
  template <typename ExceptionDescriptionT = Aws::String>
  FailureException& WithExceptionDescription(ExceptionDescriptionT&& value) {
    SetExceptionDescription(std::forward<ExceptionDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
