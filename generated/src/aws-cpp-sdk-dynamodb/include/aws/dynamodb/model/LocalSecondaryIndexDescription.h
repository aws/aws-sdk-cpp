...
class LocalSecondaryIndexDescription {
 public:
  ...
  inline LocalSecondaryIndexDescription& WithIndexSizeBytes(long long value) {
  ...
  inline LocalSecondaryIndexDescription& WithItemCount(long long value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
