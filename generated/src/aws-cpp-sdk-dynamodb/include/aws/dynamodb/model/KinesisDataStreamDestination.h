...
class KinesisDataStreamDestination {
 public:
  ...
  template <typename StreamArnT = Aws::String>
  KinesisDataStreamDestination& WithStreamArn(StreamArnT&& value) {
  ...
  inline KinesisDataStreamDestination& WithDestinationStatus(DestinationStatus value) {
  ...
  void SetDestinationStatusDescription(DestinationStatusDescriptionT&& value) {
    m_destinationStatusDescriptionHasBeenSet = true;
    m_destinationStatusDescription = std::forward<DestinationStatusDescriptionT>(value);
  }
  template <typename DestinationStatusDescriptionT = Aws::String>
  KinesisDataStreamDestination& WithDestinationStatusDescription(DestinationStatusDescriptionT&& value) {
    SetDestinationStatusDescription(std::forward<DestinationStatusDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline KinesisDataStreamDestination& WithApproximateCreationDateTimePrecision(ApproximateCreationDateTimePrecision value) {
