...
class GlobalTableWitnessDescription {
 public:
  ...
  inline void SetWitnessStatus(WitnessStatus value) {
    m_witnessStatusHasBeenSet = true;
    m_witnessStatus = value;
  }
  inline GlobalTableWitnessDescription& WithWitnessStatus(WitnessStatus value) {
    SetWitnessStatus(value);
    return *this;
  }
  ///@}
 private:
