...
class PointInTimeRecoveryDescription {
 public:
  ...
  inline void SetPointInTimeRecoveryStatus(PointInTimeRecoveryStatus value) {
    m_pointInTimeRecoveryStatusHasBeenSet = true;
    m_pointInTimeRecoveryStatus = value;
  }
  inline PointInTimeRecoveryDescription& WithPointInTimeRecoveryStatus(PointInTimeRecoveryStatus value) {
    SetPointInTimeRecoveryStatus(value);
    return *this;
  }
  ///@}
  ...
  inline PointInTimeRecoveryDescription& WithRecoveryPeriodInDays(int value) {
  ...
  void SetEarliestRestorableDateTime(EarliestRestorableDateTimeT&& value) {
    ...
    m_earliestRestorableDateTime = std::forward<EarliestRestorableDateTimeT>(value);
  }
  template <typename EarliestRestorableDateTimeT = Aws::Utils::DateTime>
  PointInTimeRecoveryDescription& WithEarliestRestorableDateTime(EarliestRestorableDateTimeT&& value) {
    SetEarliestRestorableDateTime(std::forward<EarliestRestorableDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLatestRestorableDateTime(LatestRestorableDateTimeT&& value) {
    ...
    m_latestRestorableDateTime = std::forward<LatestRestorableDateTimeT>(value);
  }
  template <typename LatestRestorableDateTimeT = Aws::Utils::DateTime>
  PointInTimeRecoveryDescription& WithLatestRestorableDateTime(LatestRestorableDateTimeT&& value) {
    SetLatestRestorableDateTime(std::forward<LatestRestorableDateTimeT>(value));
    return *this;
  }
  ///@}
 private:
