...
class SourceTableDetails {
 public:
  ...
  inline SourceTableDetails& WithTableSizeBytes(long long value) {
  ...
  void SetTableCreationDateTime(TableCreationDateTimeT&& value) {
    ...
    m_tableCreationDateTime = std::forward<TableCreationDateTimeT>(value);
  }
  template <typename TableCreationDateTimeT = Aws::Utils::DateTime>
  SourceTableDetails& WithTableCreationDateTime(TableCreationDateTimeT&& value) {
    SetTableCreationDateTime(std::forward<TableCreationDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline SourceTableDetails& WithItemCount(long long value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
  ...
  inline SourceTableDetails& WithBillingMode(BillingMode value) {
