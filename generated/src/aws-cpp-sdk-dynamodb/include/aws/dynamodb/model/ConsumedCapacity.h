...
class ConsumedCapacity {
 public:
  ...
  inline ConsumedCapacity& WithCapacityUnits(double value) {
  ...
  inline ConsumedCapacity& WithReadCapacityUnits(double value) {
  ...
  inline ConsumedCapacity& WithWriteCapacityUnits(double value) {
  ...
  ConsumedCapacity& AddLocalSecondaryIndexes(LocalSecondaryIndexesKeyT&& key, LocalSecondaryIndexesValueT&& value) {
    m_localSecondaryIndexesHasBeenSet = true;
    m_localSecondaryIndexes.emplace(std::forward<LocalSecondaryIndexesKeyT>(key), std::forward<LocalSecondaryIndexesValueT>(value));
    return *this;
  }
  ///@}
  ...
  ConsumedCapacity& AddGlobalSecondaryIndexes(GlobalSecondaryIndexesKeyT&& key, GlobalSecondaryIndexesValueT&& value) {
    m_globalSecondaryIndexesHasBeenSet = true;
    m_globalSecondaryIndexes.emplace(std::forward<GlobalSecondaryIndexesKeyT>(key), std::forward<GlobalSecondaryIndexesValueT>(value));
    return *this;
  }
  ///@}
 private:
