...
class BatchStatementRequest {
 public:
  ...
  inline BatchStatementRequest& WithConsistentRead(bool value) {
  ...
  inline BatchStatementRequest& WithReturnValuesOnConditionCheckFailure(ReturnValuesOnConditionCheckFailure value) {
