...
class ReplicaAutoScalingUpdate {
 public:
  ...
  template <typename RegionNameT = Aws::String>
  ReplicaAutoScalingUpdate& WithRegionName(RegionNameT&& value) {
   ...
   * modified.</p>
   */
  inline const Aws::Vector<ReplicaGlobalSecondaryIndexAutoScalingUpdate>& GetReplicaGlobalSecondaryIndexUpdates() const {
    return m_replicaGlobalSecondaryIndexUpdates;
  }
  ...
  void SetReplicaGlobalSecondaryIndexUpdates(ReplicaGlobalSecondaryIndexUpdatesT&& value) {
    m_replicaGlobalSecondaryIndexUpdatesHasBeenSet = true;
    m_replicaGlobalSecondaryIndexUpdates = std::forward<ReplicaGlobalSecondaryIndexUpdatesT>(value);
  }
  template <typename ReplicaGlobalSecondaryIndexUpdatesT = Aws::Vector<ReplicaGlobalSecondaryIndexAutoScalingUpdate>>
  ReplicaAutoScalingUpdate& WithReplicaGlobalSecondaryIndexUpdates(ReplicaGlobalSecondaryIndexUpdatesT&& value) {
    SetReplicaGlobalSecondaryIndexUpdates(std::forward<ReplicaGlobalSecondaryIndexUpdatesT>(value));
    return *this;
  }
  template <typename ReplicaGlobalSecondaryIndexUpdatesT = ReplicaGlobalSecondaryIndexAutoScalingUpdate>
  ReplicaAutoScalingUpdate& AddReplicaGlobalSecondaryIndexUpdates(ReplicaGlobalSecondaryIndexUpdatesT&& value) {
    m_replicaGlobalSecondaryIndexUpdatesHasBeenSet = true;
    m_replicaGlobalSecondaryIndexUpdates.emplace_back(std::forward<ReplicaGlobalSecondaryIndexUpdatesT>(value));
    return *this;
  }
  ///@}
  ...
  inline const AutoScalingSettingsUpdate& GetReplicaProvisionedReadCapacityAutoScalingUpdate() const {
    return m_replicaProvisionedReadCapacityAutoScalingUpdate;
  }
  inline bool ReplicaProvisionedReadCapacityAutoScalingUpdateHasBeenSet() const {
    return m_replicaProvisionedReadCapacityAutoScalingUpdateHasBeenSet;
  }
  template <typename ReplicaProvisionedReadCapacityAutoScalingUpdateT = AutoScalingSettingsUpdate>
  void SetReplicaProvisionedReadCapacityAutoScalingUpdate(ReplicaProvisionedReadCapacityAutoScalingUpdateT&& value) {
    m_replicaProvisionedReadCapacityAutoScalingUpdateHasBeenSet = true;
    m_replicaProvisionedReadCapacityAutoScalingUpdate = std::forward<ReplicaProvisionedReadCapacityAutoScalingUpdateT>(value);
  }
  template <typename ReplicaProvisionedReadCapacityAutoScalingUpdateT = AutoScalingSettingsUpdate>
  ReplicaAutoScalingUpdate& WithReplicaProvisionedReadCapacityAutoScalingUpdate(ReplicaProvisionedReadCapacityAutoScalingUpdateT&& value) {
    SetReplicaProvisionedReadCapacityAutoScalingUpdate(std::forward<ReplicaProvisionedReadCapacityAutoScalingUpdateT>(value));
    return *this;
  }
  ///@}
 private:
