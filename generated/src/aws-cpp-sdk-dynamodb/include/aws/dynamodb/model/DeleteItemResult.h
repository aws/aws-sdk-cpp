...
class DeleteItemResult {
 public:
  ...
  template <typename AttributesT = Aws::Map<Aws::String, AttributeValue>>
  DeleteItemResult& WithAttributes(AttributesT&& value) {
  ...
  template <typename ConsumedCapacityT = ConsumedCapacity>
  DeleteItemResult& WithConsumedCapacity(ConsumedCapacityT&& value) {
  ...
  template <typename ItemCollectionMetricsT = ItemCollectionMetrics>
  DeleteItemResult& WithItemCollectionMetrics(ItemCollectionMetricsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteItemResult& WithRequestId(RequestIdT&& value) {
