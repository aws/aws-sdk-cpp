...
class DescribeTableReplicaAutoScalingResult {
 public:
  ...
  void SetTableAutoScalingDescription(TableAutoScalingDescriptionT&& value) {
    m_tableAutoScalingDescriptionHasBeenSet = true;
    m_tableAutoScalingDescription = std::forward<TableAutoScalingDescriptionT>(value);
  }
  template <typename TableAutoScalingDescriptionT = TableAutoScalingDescription>
  DescribeTableReplicaAutoScalingResult& WithTableAutoScalingDescription(TableAutoScalingDescriptionT&& value) {
    SetTableAutoScalingDescription(std::forward<TableAutoScalingDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTableReplicaAutoScalingResult& WithRequestId(RequestIdT&& value) {
