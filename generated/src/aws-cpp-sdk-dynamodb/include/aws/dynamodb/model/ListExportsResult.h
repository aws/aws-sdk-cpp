...
namespace Model
{
  ...
  public:
    ...
    void SetExportSummaries(ExportSummariesT&& value) { m_exportSummaries = std::forward<ExportSummariesT>(value); }
    template<typename ExportSummariesT = Aws::Vector<ExportSummary>>
    ...
    ListExportsResult& AddExportSummaries(ExportSummariesT&& value) { m_exportSummaries.emplace_back(std::forward<ExportSummariesT>(value)); return *this; }
    ///@}
