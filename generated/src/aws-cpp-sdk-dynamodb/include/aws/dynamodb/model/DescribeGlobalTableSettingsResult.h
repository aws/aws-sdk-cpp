...
namespace Model
{
  ...
  public:
    ...
    void SetGlobalTableName(GlobalTableNameT&& value) { m_globalTableName = std::forward<GlobalTableNameT>(value); }
    template<typename GlobalTableNameT = Aws::String>
    ...
    void SetReplicaSettings(ReplicaSettingsT&& value) { m_replicaSettings = std::forward<ReplicaSettingsT>(value); }
    template<typename ReplicaSettingsT = Aws::Vector<ReplicaSettingsDescription>>
    ...
    DescribeGlobalTableSettingsResult& AddReplicaSettings(ReplicaSettingsT&& value) { m_replicaSettings.emplace_back(std::forward<ReplicaSettingsT>(value)); return *this; }
    ///@}
