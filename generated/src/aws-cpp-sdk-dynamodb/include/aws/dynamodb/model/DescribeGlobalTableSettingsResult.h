...
class DescribeGlobalTableSettingsResult {
 public:
  ...
  void SetReplicaSettings(ReplicaSettingsT&& value) {
    ...
    m_replicaSettings = std::forward<ReplicaSettingsT>(value);
  }
  template <typename ReplicaSettingsT = Aws::Vector<ReplicaSettingsDescription>>
  DescribeGlobalTableSettingsResult& WithReplicaSettings(ReplicaSettingsT&& value) {
    SetReplicaSettings(std::forward<ReplicaSettingsT>(value));
    return *this;
  }
  ...
  DescribeGlobalTableSettingsResult& AddReplicaSettings(ReplicaSettingsT&& value) {
    m_replicaSettingsHasBeenSet = true;
    m_replicaSettings.emplace_back(std::forward<ReplicaSettingsT>(value));
    return *this;
  }
  ///@}
