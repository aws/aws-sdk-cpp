...
class UpdateGlobalTableRequest : public DynamoDBRequest {
 public:
  ...
  template <typename GlobalTableNameT = Aws::String>
  UpdateGlobalTableRequest& WithGlobalTableName(GlobalTableNameT&& value) {
  ...
  template <typename ReplicaUpdatesT = Aws::Vector<ReplicaUpdate>>
  UpdateGlobalTableRequest& WithReplicaUpdates(ReplicaUpdatesT&& value) {
    SetReplicaUpdates(std::forward<ReplicaUpdatesT>(value));
    return *this;
  }
  template <typename ReplicaUpdatesT = ReplicaUpdate>
  UpdateGlobalTableRequest& AddReplicaUpdates(ReplicaUpdatesT&& value) {
    m_replicaUpdatesHasBeenSet = true;
