...
class UpdateTableRequest : public DynamoDBRequest {
 public:
  ...
  inline UpdateTableRequest& WithBillingMode(BillingMode value) {
  ...
  void SetStreamSpecification(StreamSpecificationT&& value) {
    ...
    m_streamSpecification = std::forward<StreamSpecificationT>(value);
  }
  template <typename StreamSpecificationT = StreamSpecification>
  UpdateTableRequest& WithStreamSpecification(StreamSpecificationT&& value) {
    SetStreamSpecification(std::forward<StreamSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateTableRequest& WithTableClass(TableClass value) {
    SetTableClass(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateTableRequest& WithDeletionProtectionEnabled(bool value) {
  ...
  inline void SetMultiRegionConsistency(MultiRegionConsistency value) {
    m_multiRegionConsistencyHasBeenSet = true;
    m_multiRegionConsistency = value;
  }
  inline UpdateTableRequest& WithMultiRegionConsistency(MultiRegionConsistency value) {
    SetMultiRegionConsistency(value);
    return *this;
  }
  ///@}
  ...
  void SetGlobalTableWitnessUpdates(GlobalTableWitnessUpdatesT&& value) {
    m_globalTableWitnessUpdatesHasBeenSet = true;
    m_globalTableWitnessUpdates = std::forward<GlobalTableWitnessUpdatesT>(value);
  }
  template <typename GlobalTableWitnessUpdatesT = Aws::Vector<GlobalTableWitnessGroupUpdate>>
  UpdateTableRequest& WithGlobalTableWitnessUpdates(GlobalTableWitnessUpdatesT&& value) {
    SetGlobalTableWitnessUpdates(std::forward<GlobalTableWitnessUpdatesT>(value));
    return *this;
  }
  ...
  UpdateTableRequest& AddGlobalTableWitnessUpdates(GlobalTableWitnessUpdatesT&& value) {
    m_globalTableWitnessUpdatesHasBeenSet = true;
    m_globalTableWitnessUpdates.emplace_back(std::forward<GlobalTableWitnessUpdatesT>(value));
    return *this;
  }
  ///@}
