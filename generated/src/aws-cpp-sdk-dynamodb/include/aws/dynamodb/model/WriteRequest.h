...
class WriteRequest {
 public:
  ...
  void SetPutRequest(PutRequestT&& value) {
    ...
    m_putRequest = std::forward<PutRequestT>(value);
  }
  template <typename PutRequestT = PutRequest>
  WriteRequest& WithPutRequest(PutRequestT&& value) {
    SetPutRequest(std::forward<PutRequestT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeleteRequest(DeleteRequestT&& value) {
    ...
    m_deleteRequest = std::forward<DeleteRequestT>(value);
  }
  template <typename DeleteRequestT = DeleteRequest>
  WriteRequest& WithDeleteRequest(DeleteRequestT&& value) {
    SetDeleteRequest(std::forward<DeleteRequestT>(value));
    return *this;
  }
  ///@}
 private:
