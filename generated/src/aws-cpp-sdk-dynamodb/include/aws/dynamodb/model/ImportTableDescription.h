...
class ImportTableDescription {
 public:
  ...
  void SetImportArn(ImportArnT&& value) {
    ...
    m_importArn = std::forward<ImportArnT>(value);
  }
  template <typename ImportArnT = Aws::String>
  ImportTableDescription& WithImportArn(ImportArnT&& value) {
    SetImportArn(std::forward<ImportArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ImportTableDescription& WithImportStatus(ImportStatus value) {
  ...
  inline ImportTableDescription& WithErrorCount(long long value) {
    SetErrorCount(value);
    return *this;
  }
  ///@}
  ...
  inline ImportTableDescription& WithInputFormat(InputFormat value) {
  ...
  void SetInputFormatOptions(InputFormatOptionsT&& value) {
    ...
    m_inputFormatOptions = std::forward<InputFormatOptionsT>(value);
  }
  template <typename InputFormatOptionsT = InputFormatOptions>
  ImportTableDescription& WithInputFormatOptions(InputFormatOptionsT&& value) {
    SetInputFormatOptions(std::forward<InputFormatOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInputCompressionType(InputCompressionType value) {
    m_inputCompressionTypeHasBeenSet = true;
    m_inputCompressionType = value;
  }
  inline ImportTableDescription& WithInputCompressionType(InputCompressionType value) {
    SetInputCompressionType(value);
    return *this;
  }
  ///@}
  ...
  void SetTableCreationParameters(TableCreationParametersT&& value) {
    ...
    m_tableCreationParameters = std::forward<TableCreationParametersT>(value);
  }
  template <typename TableCreationParametersT = TableCreationParameters>
  ImportTableDescription& WithTableCreationParameters(TableCreationParametersT&& value) {
    SetTableCreationParameters(std::forward<TableCreationParametersT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProcessedSizeBytes(long long value) {
    m_processedSizeBytesHasBeenSet = true;
    m_processedSizeBytes = value;
  }
  inline ImportTableDescription& WithProcessedSizeBytes(long long value) {
    SetProcessedSizeBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProcessedItemCount(long long value) {
    m_processedItemCountHasBeenSet = true;
    m_processedItemCount = value;
  }
  inline ImportTableDescription& WithProcessedItemCount(long long value) {
    SetProcessedItemCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetImportedItemCount(long long value) {
    m_importedItemCountHasBeenSet = true;
    m_importedItemCount = value;
  }
  inline ImportTableDescription& WithImportedItemCount(long long value) {
    SetImportedItemCount(value);
    return *this;
  }
  ///@}
