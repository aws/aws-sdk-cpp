 ...
 * replica and all if its items in the destination Region.</p> </li> </ul>  <p>When
 * you manually remove a table or global table replica, you do not automatically
 * remove any associated scalable targets, scaling policies, or CloudWatch
 * alarms.</p> <p><h3>See Also:</h3>   <a
