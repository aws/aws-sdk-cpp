...
class ArchivalSummary {
 public:
  ...
  void SetArchivalDateTime(ArchivalDateTimeT&& value) {
    ...
    m_archivalDateTime = std::forward<ArchivalDateTimeT>(value);
  }
  template <typename ArchivalDateTimeT = Aws::Utils::DateTime>
  ArchivalSummary& WithArchivalDateTime(ArchivalDateTimeT&& value) {
    SetArchivalDateTime(std::forward<ArchivalDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArchivalReason(ArchivalReasonT&& value) {
    ...
    m_archivalReason = std::forward<ArchivalReasonT>(value);
  }
  template <typename ArchivalReasonT = Aws::String>
  ArchivalSummary& WithArchivalReason(ArchivalReasonT&& value) {
    SetArchivalReason(std::forward<ArchivalReasonT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArchivalBackupArn(ArchivalBackupArnT&& value) {
    ...
    m_archivalBackupArn = std::forward<ArchivalBackupArnT>(value);
  }
  template <typename ArchivalBackupArnT = Aws::String>
  ArchivalSummary& WithArchivalBackupArn(ArchivalBackupArnT&& value) {
    SetArchivalBackupArn(std::forward<ArchivalBackupArnT>(value));
    return *this;
  }
  ///@}
 private:
