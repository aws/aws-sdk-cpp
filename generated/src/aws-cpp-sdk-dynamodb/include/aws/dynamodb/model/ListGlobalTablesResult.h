...
namespace Model
{
  ...
  public:
    ...
    void SetGlobalTables(GlobalTablesT&& value) { m_globalTables = std::forward<GlobalTablesT>(value); }
    template<typename GlobalTablesT = Aws::Vector<GlobalTable>>
    ...
    ListGlobalTablesResult& AddGlobalTables(GlobalTablesT&& value) { m_globalTables.emplace_back(std::forward<GlobalTablesT>(value)); return *this; }
    ///@}
    ...
    void SetLastEvaluatedGlobalTableName(LastEvaluatedGlobalTableNameT&& value) { m_lastEvaluatedGlobalTableName = std::forward<LastEvaluatedGlobalTableNameT>(value); }
    template<typename LastEvaluatedGlobalTableNameT = Aws::String>
