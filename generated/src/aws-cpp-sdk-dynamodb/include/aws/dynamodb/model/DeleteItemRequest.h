...
class DeleteItemRequest : public DynamoDBRequest {
 public:
  ...
  void SetExpected(ExpectedT&& value) {
    ...
    m_expected = std::forward<ExpectedT>(value);
  }
  template <typename ExpectedT = Aws::Map<Aws::String, ExpectedAttributeValue>>
  DeleteItemRequest& WithExpected(ExpectedT&& value) {
    SetExpected(std::forward<ExpectedT>(value));
    return *this;
  }
  ...
  DeleteItemRequest& AddExpected(ExpectedKeyT&& key, ExpectedValueT&& value) {
    m_expectedHasBeenSet = true;
    m_expected.emplace(std::forward<ExpectedKeyT>(key), std::forward<ExpectedValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetConditionalOperator(ConditionalOperator value) {
    m_conditionalOperatorHasBeenSet = true;
    m_conditionalOperator = value;
  }
  inline DeleteItemRequest& WithConditionalOperator(ConditionalOperator value) {
  ...
  inline void SetReturnValues(ReturnValue value) {
    m_returnValuesHasBeenSet = true;
    m_returnValues = value;
  }
  inline DeleteItemRequest& WithReturnValues(ReturnValue value) {
  ...
  inline DeleteItemRequest& WithReturnConsumedCapacity(ReturnConsumedCapacity value) {
  ...
  inline void SetReturnItemCollectionMetrics(ReturnItemCollectionMetrics value) {
    m_returnItemCollectionMetricsHasBeenSet = true;
    m_returnItemCollectionMetrics = value;
  }
  inline DeleteItemRequest& WithReturnItemCollectionMetrics(ReturnItemCollectionMetrics value) {
    SetReturnItemCollectionMetrics(value);
    return *this;
  }
  ///@}
   ...
   * information about condition expressions, see <a
  ...
  inline DeleteItemRequest& WithReturnValuesOnConditionCheckFailure(ReturnValuesOnConditionCheckFailure value) {
