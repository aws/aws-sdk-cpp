...
class UpdateTableReplicaAutoScalingResult {
 public:
  ...
  template <typename TableAutoScalingDescriptionT = TableAutoScalingDescription>
  UpdateTableReplicaAutoScalingResult& WithTableAutoScalingDescription(TableAutoScalingDescriptionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateTableReplicaAutoScalingResult& WithRequestId(RequestIdT&& value) {
