...
class ReplicaSettingsDescription {
 public:
  ...
  inline ReplicaSettingsDescription& WithReplicaStatus(ReplicaStatus value) {
  ...
  void SetReplicaBillingModeSummary(ReplicaBillingModeSummaryT&& value) {
    ...
    m_replicaBillingModeSummary = std::forward<ReplicaBillingModeSummaryT>(value);
  }
  template <typename ReplicaBillingModeSummaryT = BillingModeSummary>
  ReplicaSettingsDescription& WithReplicaBillingModeSummary(ReplicaBillingModeSummaryT&& value) {
    SetReplicaBillingModeSummary(std::forward<ReplicaBillingModeSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReplicaProvisionedReadCapacityUnits(long long value) {
    m_replicaProvisionedReadCapacityUnitsHasBeenSet = true;
    m_replicaProvisionedReadCapacityUnits = value;
  }
  inline ReplicaSettingsDescription& WithReplicaProvisionedReadCapacityUnits(long long value) {
    SetReplicaProvisionedReadCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReplicaProvisionedReadCapacityAutoScalingSettingsT = AutoScalingSettingsDescription>
  ReplicaSettingsDescription& WithReplicaProvisionedReadCapacityAutoScalingSettings(
  ...
  inline void SetReplicaProvisionedWriteCapacityUnits(long long value) {
    m_replicaProvisionedWriteCapacityUnitsHasBeenSet = true;
    m_replicaProvisionedWriteCapacityUnits = value;
  }
  inline ReplicaSettingsDescription& WithReplicaProvisionedWriteCapacityUnits(long long value) {
    SetReplicaProvisionedWriteCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReplicaProvisionedWriteCapacityAutoScalingSettingsT = AutoScalingSettingsDescription>
  ReplicaSettingsDescription& WithReplicaProvisionedWriteCapacityAutoScalingSettings(
   ...
   */
  inline const Aws::Vector<ReplicaGlobalSecondaryIndexSettingsDescription>& GetReplicaGlobalSecondaryIndexSettings() const {
    return m_replicaGlobalSecondaryIndexSettings;
  }
  ...
  void SetReplicaGlobalSecondaryIndexSettings(ReplicaGlobalSecondaryIndexSettingsT&& value) {
    ...
    m_replicaGlobalSecondaryIndexSettings = std::forward<ReplicaGlobalSecondaryIndexSettingsT>(value);
  }
  template <typename ReplicaGlobalSecondaryIndexSettingsT = Aws::Vector<ReplicaGlobalSecondaryIndexSettingsDescription>>
  ReplicaSettingsDescription& WithReplicaGlobalSecondaryIndexSettings(ReplicaGlobalSecondaryIndexSettingsT&& value) {
    SetReplicaGlobalSecondaryIndexSettings(std::forward<ReplicaGlobalSecondaryIndexSettingsT>(value));
    return *this;
  }
  ...
  ReplicaSettingsDescription& AddReplicaGlobalSecondaryIndexSettings(ReplicaGlobalSecondaryIndexSettingsT&& value) {
    m_replicaGlobalSecondaryIndexSettingsHasBeenSet = true;
    m_replicaGlobalSecondaryIndexSettings.emplace_back(std::forward<ReplicaGlobalSecondaryIndexSettingsT>(value));
    return *this;
  }
  ///@}
