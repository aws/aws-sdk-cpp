...
class TableWarmThroughputDescription {
 public:
  ...
  inline TableWarmThroughputDescription& WithReadUnitsPerSecond(long long value) {
  ...
  inline TableWarmThroughputDescription& WithWriteUnitsPerSecond(long long value) {
  ...
  inline TableWarmThroughputDescription& WithStatus(TableStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
