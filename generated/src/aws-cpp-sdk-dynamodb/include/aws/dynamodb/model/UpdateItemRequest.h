...
class UpdateItemRequest : public DynamoDBRequest {
 public:
  ...
  UpdateItemRequest& AddAttributeUpdates(AttributeUpdatesKeyT&& key, AttributeUpdatesValueT&& value) {
    m_attributeUpdatesHasBeenSet = true;
    m_attributeUpdates.emplace(std::forward<AttributeUpdatesKeyT>(key), std::forward<AttributeUpdatesValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateItemRequest& WithConditionalOperator(ConditionalOperator value) {
  ...
  inline UpdateItemRequest& WithReturnValues(ReturnValue value) {
  ...
  inline UpdateItemRequest& WithReturnConsumedCapacity(ReturnConsumedCapacity value) {
  ...
  inline UpdateItemRequest& WithReturnItemCollectionMetrics(ReturnItemCollectionMetrics value) {
  ...
  inline UpdateItemRequest& WithReturnValuesOnConditionCheckFailure(ReturnValuesOnConditionCheckFailure value) {
