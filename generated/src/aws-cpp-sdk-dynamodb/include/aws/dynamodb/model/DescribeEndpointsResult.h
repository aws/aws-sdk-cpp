...
namespace Model
{
  ...
  public:
    ...
    void SetEndpoints(EndpointsT&& value) { m_endpoints = std::forward<EndpointsT>(value); }
    template<typename EndpointsT = Aws::Vector<Endpoint>>
    ...
    DescribeEndpointsResult& AddEndpoints(EndpointsT&& value) { m_endpoints.emplace_back(std::forward<EndpointsT>(value)); return *this; }
    ///@}
