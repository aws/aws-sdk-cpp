...
class Capacity {
 public:
  ...
  inline void SetReadCapacityUnits(double value) {
    m_readCapacityUnitsHasBeenSet = true;
    m_readCapacityUnits = value;
  }
  inline Capacity& WithReadCapacityUnits(double value) {
  ...
  inline void SetWriteCapacityUnits(double value) {
    m_writeCapacityUnitsHasBeenSet = true;
    m_writeCapacityUnits = value;
  }
  inline Capacity& WithWriteCapacityUnits(double value) {
    SetWriteCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCapacityUnits(double value) {
    m_capacityUnitsHasBeenSet = true;
    m_capacityUnits = value;
  }
  inline Capacity& WithCapacityUnits(double value) {
    SetCapacityUnits(value);
    return *this;
  }
  ///@}
 private:
