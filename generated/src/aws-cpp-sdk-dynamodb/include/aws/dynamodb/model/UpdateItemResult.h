...
namespace Model
{
  ...
  public:
    ...
    void SetAttributes(AttributesT&& value) { m_attributes = std::forward<AttributesT>(value); }
    template<typename AttributesT = Aws::Map<Aws::String, AttributeValue>>
    ...
    UpdateItemResult& AddAttributes(AttributesKeyT&& key, AttributesValueT&& value) {
      m_attributes.emplace(std::forward<AttributesKeyT>(key), std::forward<AttributesValueT>(value)); return *this;
    }
    ///@}
