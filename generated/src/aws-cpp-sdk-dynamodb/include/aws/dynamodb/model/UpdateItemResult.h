...
class UpdateItemResult {
 public:
  ...
  template <typename AttributesT = Aws::Map<Aws::String, AttributeValue>>
  UpdateItemResult& WithAttributes(AttributesT&& value) {
   ...
   * Guide</i>.</p> <p>If the table has vector indexes, the response includes a
   * <code>VectorIndexes</code> field with <code>VectorWriteRequestBytes</code>
   * consumed for each affected vector index.</p>
   */
  ...
  template <typename ConsumedCapacityT = ConsumedCapacity>
  UpdateItemResult& WithConsumedCapacity(ConsumedCapacityT&& value) {
  ...
  template <typename ItemCollectionMetricsT = ItemCollectionMetrics>
  UpdateItemResult& WithItemCollectionMetrics(ItemCollectionMetricsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateItemResult& WithRequestId(RequestIdT&& value) {
