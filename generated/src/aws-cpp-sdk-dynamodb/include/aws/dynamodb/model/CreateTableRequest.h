...
class CreateTableRequest : public DynamoDBRequest {
 public:
  ...
  inline CreateTableRequest& WithBillingMode(BillingMode value) {
  ...
  inline CreateTableRequest& WithTableClass(TableClass value) {
    SetTableClass(value);
    return *this;
  }
  ///@}
  ...
  inline CreateTableRequest& WithDeletionProtectionEnabled(bool value) {
