...
class UpdateTableReplicaAutoScalingRequest : public DynamoDBRequest {
 public:
   ...
   */
  inline const Aws::Vector<GlobalSecondaryIndexAutoScalingUpdate>& GetGlobalSecondaryIndexUpdates() const {
    return m_globalSecondaryIndexUpdates;
  }
  ...
  void SetGlobalSecondaryIndexUpdates(GlobalSecondaryIndexUpdatesT&& value) {
    m_globalSecondaryIndexUpdatesHasBeenSet = true;
    m_globalSecondaryIndexUpdates = std::forward<GlobalSecondaryIndexUpdatesT>(value);
  }
  template <typename GlobalSecondaryIndexUpdatesT = Aws::Vector<GlobalSecondaryIndexAutoScalingUpdate>>
  UpdateTableReplicaAutoScalingRequest& WithGlobalSecondaryIndexUpdates(GlobalSecondaryIndexUpdatesT&& value) {
    SetGlobalSecondaryIndexUpdates(std::forward<GlobalSecondaryIndexUpdatesT>(value));
    return *this;
  }
  template <typename GlobalSecondaryIndexUpdatesT = GlobalSecondaryIndexAutoScalingUpdate>
  UpdateTableReplicaAutoScalingRequest& AddGlobalSecondaryIndexUpdates(GlobalSecondaryIndexUpdatesT&& value) {
    m_globalSecondaryIndexUpdatesHasBeenSet = true;
    m_globalSecondaryIndexUpdates.emplace_back(std::forward<GlobalSecondaryIndexUpdatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TableNameT = Aws::String>
  UpdateTableReplicaAutoScalingRequest& WithTableName(TableNameT&& value) {
  ...
  inline const AutoScalingSettingsUpdate& GetProvisionedWriteCapacityAutoScalingUpdate() const {
    return m_provisionedWriteCapacityAutoScalingUpdate;
  }
  ...
  void SetProvisionedWriteCapacityAutoScalingUpdate(ProvisionedWriteCapacityAutoScalingUpdateT&& value) {
    ...
    m_provisionedWriteCapacityAutoScalingUpdate = std::forward<ProvisionedWriteCapacityAutoScalingUpdateT>(value);
  }
  template <typename ProvisionedWriteCapacityAutoScalingUpdateT = AutoScalingSettingsUpdate>
  UpdateTableReplicaAutoScalingRequest& WithProvisionedWriteCapacityAutoScalingUpdate(ProvisionedWriteCapacityAutoScalingUpdateT&& value) {
    SetProvisionedWriteCapacityAutoScalingUpdate(std::forward<ProvisionedWriteCapacityAutoScalingUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicaUpdates(ReplicaUpdatesT&& value) {
    m_replicaUpdatesHasBeenSet = true;
    m_replicaUpdates = std::forward<ReplicaUpdatesT>(value);
  }
  template <typename ReplicaUpdatesT = Aws::Vector<ReplicaAutoScalingUpdate>>
  UpdateTableReplicaAutoScalingRequest& WithReplicaUpdates(ReplicaUpdatesT&& value) {
    SetReplicaUpdates(std::forward<ReplicaUpdatesT>(value));
    return *this;
  }
  template <typename ReplicaUpdatesT = ReplicaAutoScalingUpdate>
  UpdateTableReplicaAutoScalingRequest& AddReplicaUpdates(ReplicaUpdatesT&& value) {
    m_replicaUpdatesHasBeenSet = true;
    m_replicaUpdates.emplace_back(std::forward<ReplicaUpdatesT>(value));
    return *this;
  }
  ///@}
 private:
