...
class ReplicaGlobalSecondaryIndexAutoScalingDescription {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  ReplicaGlobalSecondaryIndexAutoScalingDescription& WithIndexName(IndexNameT&& value) {
  ...
  inline ReplicaGlobalSecondaryIndexAutoScalingDescription& WithIndexStatus(IndexStatus value) {
  ...
  template <typename ProvisionedReadCapacityAutoScalingSettingsT = AutoScalingSettingsDescription>
  ReplicaGlobalSecondaryIndexAutoScalingDescription& WithProvisionedReadCapacityAutoScalingSettings(
  ...
  template <typename ProvisionedWriteCapacityAutoScalingSettingsT = AutoScalingSettingsDescription>
  ReplicaGlobalSecondaryIndexAutoScalingDescription& WithProvisionedWriteCapacityAutoScalingSettings(
