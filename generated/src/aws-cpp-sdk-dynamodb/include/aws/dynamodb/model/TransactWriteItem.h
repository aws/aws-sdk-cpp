...
class TransactWriteItem {
 public:
  ...
  void SetConditionCheck(ConditionCheckT&& value) {
    ...
    m_conditionCheck = std::forward<ConditionCheckT>(value);
  }
  template <typename ConditionCheckT = ConditionCheck>
  TransactWriteItem& WithConditionCheck(ConditionCheckT&& value) {
    SetConditionCheck(std::forward<ConditionCheckT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPut(PutT&& value) {
    ...
    m_put = std::forward<PutT>(value);
  }
  template <typename PutT = Put>
  TransactWriteItem& WithPut(PutT&& value) {
    SetPut(std::forward<PutT>(value));
    return *this;
  }
  ///@}
