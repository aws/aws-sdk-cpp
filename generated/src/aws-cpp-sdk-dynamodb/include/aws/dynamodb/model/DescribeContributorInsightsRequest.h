...
namespace Model
{
  ...
  public:
    ...
    template<typename TableNameT = Aws::String>
    DescribeContributorInsightsRequest& WithTableName(TableNameT&& value) { SetTableName(std::forward<TableNameT>(value)); return *this;}
    ///@}
    ...
    template<typename IndexNameT = Aws::String>
    DescribeContributorInsightsRequest& WithIndexName(IndexNameT&& value) { SetIndexName(std::forward<IndexNameT>(value)); return *this;}
    ///@}
  private:
