...
class ReplicaDescription {
 public:
  ...
  inline void SetReplicaStatus(ReplicaStatus value) {
    m_replicaStatusHasBeenSet = true;
    m_replicaStatus = value;
  }
  inline ReplicaDescription& WithReplicaStatus(ReplicaStatus value) {
    SetReplicaStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetReplicaStatusDescription(ReplicaStatusDescriptionT&& value) {
    ...
    m_replicaStatusDescription = std::forward<ReplicaStatusDescriptionT>(value);
  }
  template <typename ReplicaStatusDescriptionT = Aws::String>
  ReplicaDescription& WithReplicaStatusDescription(ReplicaStatusDescriptionT&& value) {
    SetReplicaStatusDescription(std::forward<ReplicaStatusDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicaStatusPercentProgress(ReplicaStatusPercentProgressT&& value) {
    ...
    m_replicaStatusPercentProgress = std::forward<ReplicaStatusPercentProgressT>(value);
  }
  template <typename ReplicaStatusPercentProgressT = Aws::String>
  ReplicaDescription& WithReplicaStatusPercentProgress(ReplicaStatusPercentProgressT&& value) {
    SetReplicaStatusPercentProgress(std::forward<ReplicaStatusPercentProgressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKMSMasterKeyId(KMSMasterKeyIdT&& value) {
    ...
    m_kMSMasterKeyId = std::forward<KMSMasterKeyIdT>(value);
  }
  template <typename KMSMasterKeyIdT = Aws::String>
  ReplicaDescription& WithKMSMasterKeyId(KMSMasterKeyIdT&& value) {
    SetKMSMasterKeyId(std::forward<KMSMasterKeyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProvisionedThroughputOverride(ProvisionedThroughputOverrideT&& value) {
    ...
    m_provisionedThroughputOverride = std::forward<ProvisionedThroughputOverrideT>(value);
  }
  template <typename ProvisionedThroughputOverrideT = ProvisionedThroughputOverride>
  ReplicaDescription& WithProvisionedThroughputOverride(ProvisionedThroughputOverrideT&& value) {
    SetProvisionedThroughputOverride(std::forward<ProvisionedThroughputOverrideT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnDemandThroughputOverride(OnDemandThroughputOverrideT&& value) {
    ...
    m_onDemandThroughputOverride = std::forward<OnDemandThroughputOverrideT>(value);
  }
  template <typename OnDemandThroughputOverrideT = OnDemandThroughputOverride>
  ReplicaDescription& WithOnDemandThroughputOverride(OnDemandThroughputOverrideT&& value) {
    SetOnDemandThroughputOverride(std::forward<OnDemandThroughputOverrideT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGlobalSecondaryIndexes(GlobalSecondaryIndexesT&& value) {
    ...
    m_globalSecondaryIndexes = std::forward<GlobalSecondaryIndexesT>(value);
  }
  template <typename GlobalSecondaryIndexesT = Aws::Vector<ReplicaGlobalSecondaryIndexDescription>>
  ReplicaDescription& WithGlobalSecondaryIndexes(GlobalSecondaryIndexesT&& value) {
    SetGlobalSecondaryIndexes(std::forward<GlobalSecondaryIndexesT>(value));
    return *this;
  }
  ...
  ReplicaDescription& AddGlobalSecondaryIndexes(GlobalSecondaryIndexesT&& value) {
    m_globalSecondaryIndexesHasBeenSet = true;
    m_globalSecondaryIndexes.emplace_back(std::forward<GlobalSecondaryIndexesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicaInaccessibleDateTime(ReplicaInaccessibleDateTimeT&& value) {
    ...
    m_replicaInaccessibleDateTime = std::forward<ReplicaInaccessibleDateTimeT>(value);
  }
  template <typename ReplicaInaccessibleDateTimeT = Aws::Utils::DateTime>
  ReplicaDescription& WithReplicaInaccessibleDateTime(ReplicaInaccessibleDateTimeT&& value) {
    SetReplicaInaccessibleDateTime(std::forward<ReplicaInaccessibleDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicaTableClassSummary(ReplicaTableClassSummaryT&& value) {
    ...
    m_replicaTableClassSummary = std::forward<ReplicaTableClassSummaryT>(value);
  }
  template <typename ReplicaTableClassSummaryT = TableClassSummary>
  ReplicaDescription& WithReplicaTableClassSummary(ReplicaTableClassSummaryT&& value) {
    SetReplicaTableClassSummary(std::forward<ReplicaTableClassSummaryT>(value));
    return *this;
  }
  ///@}
 private:
