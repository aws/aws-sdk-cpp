...
class ReplicaGlobalSecondaryIndexSettingsUpdate {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  ReplicaGlobalSecondaryIndexSettingsUpdate& WithIndexName(IndexNameT&& value) {
  ...
  inline ReplicaGlobalSecondaryIndexSettingsUpdate& WithProvisionedReadCapacityUnits(long long value) {
   ...
   * capacity units.</p>
   */
  inline const AutoScalingSettingsUpdate& GetProvisionedReadCapacityAutoScalingSettingsUpdate() const {
    return m_provisionedReadCapacityAutoScalingSettingsUpdate;
  }
  inline bool ProvisionedReadCapacityAutoScalingSettingsUpdateHasBeenSet() const {
    return m_provisionedReadCapacityAutoScalingSettingsUpdateHasBeenSet;
  }
  template <typename ProvisionedReadCapacityAutoScalingSettingsUpdateT = AutoScalingSettingsUpdate>
  void SetProvisionedReadCapacityAutoScalingSettingsUpdate(ProvisionedReadCapacityAutoScalingSettingsUpdateT&& value) {
    m_provisionedReadCapacityAutoScalingSettingsUpdateHasBeenSet = true;
    m_provisionedReadCapacityAutoScalingSettingsUpdate = std::forward<ProvisionedReadCapacityAutoScalingSettingsUpdateT>(value);
  }
  template <typename ProvisionedReadCapacityAutoScalingSettingsUpdateT = AutoScalingSettingsUpdate>
  ReplicaGlobalSecondaryIndexSettingsUpdate& WithProvisionedReadCapacityAutoScalingSettingsUpdate(
      ProvisionedReadCapacityAutoScalingSettingsUpdateT&& value) {
    SetProvisionedReadCapacityAutoScalingSettingsUpdate(std::forward<ProvisionedReadCapacityAutoScalingSettingsUpdateT>(value));
    return *this;
  }
  ///@}
 private:
