...
class UpdateContributorInsightsResult {
 public:
  ...
  inline UpdateContributorInsightsResult& WithContributorInsightsStatus(ContributorInsightsStatus value) {
  ...
  inline UpdateContributorInsightsResult& WithContributorInsightsMode(ContributorInsightsMode value) {
