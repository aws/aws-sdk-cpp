...
class TableDescription {
 public:
   ...
   * <p> <code>RANGE</code> - sort key</p> </li> </ul>  <p>The partition key of an
   * item is also known as its <i>hash attribute</i>. The term "hash attribute"
   ...
   * key physically close together, in sorted order by the sort key value.</p>  </li>
  ...
  inline void SetTableStatus(TableStatus value) {
    m_tableStatusHasBeenSet = true;
    m_tableStatus = value;
  }
  inline TableDescription& WithTableStatus(TableStatus value) {
  ...
  inline TableDescription& WithTableSizeBytes(long long value) {
  ...
  inline TableDescription& WithItemCount(long long value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>A unique identifier for the table, in UUID format, generated by DynamoDB when
   * the table is created.</p>
   */
  ...
  void SetGlobalTableWitnesses(GlobalTableWitnessesT&& value) {
    ...
    m_globalTableWitnesses = std::forward<GlobalTableWitnessesT>(value);
  }
  template <typename GlobalTableWitnessesT = Aws::Vector<GlobalTableWitnessDescription>>
  TableDescription& WithGlobalTableWitnesses(GlobalTableWitnessesT&& value) {
    SetGlobalTableWitnesses(std::forward<GlobalTableWitnessesT>(value));
    return *this;
  }
  ...
  TableDescription& AddGlobalTableWitnesses(GlobalTableWitnessesT&& value) {
    m_globalTableWitnessesHasBeenSet = true;
    m_globalTableWitnesses.emplace_back(std::forward<GlobalTableWitnessesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArchivalSummary(ArchivalSummaryT&& value) {
    ...
    m_archivalSummary = std::forward<ArchivalSummaryT>(value);
  }
  template <typename ArchivalSummaryT = ArchivalSummary>
  TableDescription& WithArchivalSummary(ArchivalSummaryT&& value) {
    SetArchivalSummary(std::forward<ArchivalSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTableClassSummary(TableClassSummaryT&& value) {
    ...
    m_tableClassSummary = std::forward<TableClassSummaryT>(value);
  }
  template <typename TableClassSummaryT = TableClassSummary>
  TableDescription& WithTableClassSummary(TableClassSummaryT&& value) {
    SetTableClassSummary(std::forward<TableClassSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  inline TableDescription& WithDeletionProtectionEnabled(bool value) {
  ...
  inline TableDescription& WithMultiRegionConsistency(MultiRegionConsistency value) {
   ...
   * <ul> <li> <p> <code>IndexName</code> - The name of the vector index.</p> </li>
   * <li> <p> <code>IndexStatus</code> - The current status of the vector index:
   * <code>CREATING</code>, <code>ACTIVE</code>, or <code>DELETING</code>.</p> </li>
   * <li> <p> <code>Backfilling</code> - Specifies whether the index is currently
   * backfilling. During backfill, <code>SearchVectors</code> operations might return
   * incomplete results.</p> </li> <li> <p> <code>VectorAttribute</code> - The
   * attribute that contains vector embeddings.</p> </li> <li> <p>
   * <code>Dimensions</code> - The number of dimensions in each vector.</p> </li>
   * <li> <p> <code>DistanceFunction</code> - The distance function used to calculate
   * similarity (<code>COSINE</code>, <code>EUCLIDEAN</code>, or
   * <code>DOT_PRODUCT</code>).</p> </li> <li> <p> <code>SearchSchema</code> - The
   * partition key and inline filter attributes for the vector index.</p> </li> <li>
   * <p> <code>Projection</code> - Specifies attributes that are copied (projected)
   * from the table into the vector index.</p> </li> <li> <p> <code>IndexArn</code> -
   * The Amazon Resource Name (ARN) that uniquely identifies the index.</p> </li>
   * <li> <p> <code>IndexSizeBytes</code> - The total size of the vector index, in
   * bytes. Amazon DynamoDB updates this value approximately every six hours. Recent
   * changes might not be reflected in this value.</p> </li> <li> <p>
   * <code>ItemCount</code> - The number of items indexed in the vector index. Amazon
   * DynamoDB updates this value approximately every six hours. Recent changes might
   * not be reflected in this value.</p> </li> </ul>
   */
  inline const Aws::Vector<VectorIndexDescription>& GetVectorIndexes() const { return m_vectorIndexes; }
  inline bool VectorIndexesHasBeenSet() const { return m_vectorIndexesHasBeenSet; }
  template <typename VectorIndexesT = Aws::Vector<VectorIndexDescription>>
  ...
  template <typename VectorIndexesT = VectorIndexDescription>
 ...
 private:
  ...
  Aws::Vector<VectorIndexDescription> m_vectorIndexes;
