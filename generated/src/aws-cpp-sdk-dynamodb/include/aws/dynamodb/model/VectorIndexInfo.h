...
/**
 * <p>Contains the configuration of a vector index as it existed at the time a
 * backup was created.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/VectorIndexInfo">AWS
 * API Reference</a></p>
 */
class VectorIndexInfo {
 public:
  ...
  inline VectorIndexInfo& WithDimensions(long long value) {
    SetDimensions(value);
    return *this;
  }
  ///@}
  ...
  inline VectorIndexInfo& WithDistanceFunction(VectorDistanceFunction value) {
