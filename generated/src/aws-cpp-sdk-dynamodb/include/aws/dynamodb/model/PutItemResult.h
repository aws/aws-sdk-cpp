...
class PutItemResult {
 public:
  ...
  template <typename AttributesT = Aws::Map<Aws::String, AttributeValue>>
  PutItemResult& WithAttributes(AttributesT&& value) {
  ...
  template <typename ConsumedCapacityT = ConsumedCapacity>
  PutItemResult& WithConsumedCapacity(ConsumedCapacityT&& value) {
  ...
  template <typename ItemCollectionMetricsT = ItemCollectionMetrics>
  PutItemResult& WithItemCollectionMetrics(ItemCollectionMetricsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutItemResult& WithRequestId(RequestIdT&& value) {
