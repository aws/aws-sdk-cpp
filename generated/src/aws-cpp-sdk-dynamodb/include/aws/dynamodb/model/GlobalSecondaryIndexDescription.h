...
class GlobalSecondaryIndexDescription {
 public:
  ...
  inline GlobalSecondaryIndexDescription& WithIndexStatus(IndexStatus value) {
  ...
  inline GlobalSecondaryIndexDescription& WithBackfilling(bool value) {
  ...
  inline GlobalSecondaryIndexDescription& WithIndexSizeBytes(long long value) {
  ...
  inline GlobalSecondaryIndexDescription& WithItemCount(long long value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
