...
namespace Model
{
   ...
   * field in the returned exception.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ThrottlingException">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    template<typename ThrottlingReasonsT = Aws::Vector<ThrottlingReason>>
    ThrottlingException& WithThrottlingReasons(ThrottlingReasonsT&& value) { SetThrottlingReasons(std::forward<ThrottlingReasonsT>(value)); return *this;}
    template<typename ThrottlingReasonsT = ThrottlingReason>
    ThrottlingException& AddThrottlingReasons(ThrottlingReasonsT&& value) { m_throttlingReasonsHasBeenSet = true; m_throttlingReasons.emplace_back(std::forward<ThrottlingReasonsT>(value)); return *this; }
    ///@}
  private:
