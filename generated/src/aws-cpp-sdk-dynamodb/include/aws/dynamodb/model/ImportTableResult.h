...
class ImportTableResult {
 public:
  ...
  void SetImportTableDescription(ImportTableDescriptionT&& value) {
    m_importTableDescriptionHasBeenSet = true;
    m_importTableDescription = std::forward<ImportTableDescriptionT>(value);
  }
  template <typename ImportTableDescriptionT = ImportTableDescription>
  ImportTableResult& WithImportTableDescription(ImportTableDescriptionT&& value) {
    SetImportTableDescription(std::forward<ImportTableDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ImportTableResult& WithRequestId(RequestIdT&& value) {
