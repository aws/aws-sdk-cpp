...
class ProvisionedThroughputDescription {
 public:
  ...
  void SetLastIncreaseDateTime(LastIncreaseDateTimeT&& value) {
    ...
    m_lastIncreaseDateTime = std::forward<LastIncreaseDateTimeT>(value);
  }
  template <typename LastIncreaseDateTimeT = Aws::Utils::DateTime>
  ProvisionedThroughputDescription& WithLastIncreaseDateTime(LastIncreaseDateTimeT&& value) {
    SetLastIncreaseDateTime(std::forward<LastIncreaseDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastDecreaseDateTime(LastDecreaseDateTimeT&& value) {
    ...
    m_lastDecreaseDateTime = std::forward<LastDecreaseDateTimeT>(value);
  }
  template <typename LastDecreaseDateTimeT = Aws::Utils::DateTime>
  ProvisionedThroughputDescription& WithLastDecreaseDateTime(LastDecreaseDateTimeT&& value) {
    SetLastDecreaseDateTime(std::forward<LastDecreaseDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfDecreasesToday(long long value) {
    m_numberOfDecreasesTodayHasBeenSet = true;
    m_numberOfDecreasesToday = value;
  }
  inline ProvisionedThroughputDescription& WithNumberOfDecreasesToday(long long value) {
    SetNumberOfDecreasesToday(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReadCapacityUnits(long long value) {
    m_readCapacityUnitsHasBeenSet = true;
    m_readCapacityUnits = value;
  }
  inline ProvisionedThroughputDescription& WithReadCapacityUnits(long long value) {
  ...
  inline void SetWriteCapacityUnits(long long value) {
    m_writeCapacityUnitsHasBeenSet = true;
    m_writeCapacityUnits = value;
  }
  inline ProvisionedThroughputDescription& WithWriteCapacityUnits(long long value) {
