...
/**
 * <p>A new vector index to be added to a table.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/CreateVectorIndexAction">AWS
 * API Reference</a></p>
 */
class CreateVectorIndexAction {
 public:
  ...
  inline CreateVectorIndexAction& WithDimensions(long long value) {
    SetDimensions(value);
    return *this;
  }
  ///@}
  ...
  inline CreateVectorIndexAction& WithDistanceFunction(VectorDistanceFunction value) {
