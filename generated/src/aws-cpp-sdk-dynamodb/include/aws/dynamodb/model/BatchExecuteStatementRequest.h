...
class BatchExecuteStatementRequest : public DynamoDBRequest {
 public:
  ...
  template <typename StatementsT = Aws::Vector<BatchStatementRequest>>
  BatchExecuteStatementRequest& WithStatements(StatementsT&& value) {
    SetStatements(std::forward<StatementsT>(value));
    return *this;
  }
  template <typename StatementsT = BatchStatementRequest>
  BatchExecuteStatementRequest& AddStatements(StatementsT&& value) {
    m_statementsHasBeenSet = true;
  ...
  inline BatchExecuteStatementRequest& WithReturnConsumedCapacity(ReturnConsumedCapacity value) {
