...
class TableClassSummary {
 public:
  ...
  inline void SetTableClass(TableClass value) {
    m_tableClassHasBeenSet = true;
    m_tableClass = value;
  }
  inline TableClassSummary& WithTableClass(TableClass value) {
    SetTableClass(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdateDateTimeT = Aws::Utils::DateTime>
  TableClassSummary& WithLastUpdateDateTime(LastUpdateDateTimeT&& value) {
