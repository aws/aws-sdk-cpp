...
class GlobalSecondaryIndexWarmThroughputDescription {
 public:
  ...
  inline GlobalSecondaryIndexWarmThroughputDescription& WithReadUnitsPerSecond(long long value) {
  ...
  inline GlobalSecondaryIndexWarmThroughputDescription& WithWriteUnitsPerSecond(long long value) {
  ...
  inline GlobalSecondaryIndexWarmThroughputDescription& WithStatus(IndexStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
