...
class DisableKinesisStreamingDestinationResult {
 public:
  ...
  AWS_DYNAMODB_API DisableKinesisStreamingDestinationResult& operator=(
  ...
  inline DisableKinesisStreamingDestinationResult& WithDestinationStatus(DestinationStatus value) {
