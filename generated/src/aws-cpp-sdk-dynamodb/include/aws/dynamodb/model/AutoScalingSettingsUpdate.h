...
class AutoScalingSettingsUpdate {
 public:
  ...
  inline void SetMinimumUnits(long long value) {
    m_minimumUnitsHasBeenSet = true;
    m_minimumUnits = value;
  }
  inline AutoScalingSettingsUpdate& WithMinimumUnits(long long value) {
    SetMinimumUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumUnits(long long value) {
    m_maximumUnitsHasBeenSet = true;
    m_maximumUnits = value;
  }
  inline AutoScalingSettingsUpdate& WithMaximumUnits(long long value) {
    SetMaximumUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAutoScalingDisabled(bool value) {
    m_autoScalingDisabledHasBeenSet = true;
    m_autoScalingDisabled = value;
  }
  inline AutoScalingSettingsUpdate& WithAutoScalingDisabled(bool value) {
    SetAutoScalingDisabled(value);
    return *this;
  }
  ///@}
  ...
  void SetAutoScalingRoleArn(AutoScalingRoleArnT&& value) {
    ...
    m_autoScalingRoleArn = std::forward<AutoScalingRoleArnT>(value);
  }
  template <typename AutoScalingRoleArnT = Aws::String>
  AutoScalingSettingsUpdate& WithAutoScalingRoleArn(AutoScalingRoleArnT&& value) {
    SetAutoScalingRoleArn(std::forward<AutoScalingRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScalingPolicyUpdate(ScalingPolicyUpdateT&& value) {
    ...
    m_scalingPolicyUpdate = std::forward<ScalingPolicyUpdateT>(value);
  }
  template <typename ScalingPolicyUpdateT = AutoScalingPolicyUpdate>
  AutoScalingSettingsUpdate& WithScalingPolicyUpdate(ScalingPolicyUpdateT&& value) {
    SetScalingPolicyUpdate(std::forward<ScalingPolicyUpdateT>(value));
    return *this;
  }
  ///@}
 private:
