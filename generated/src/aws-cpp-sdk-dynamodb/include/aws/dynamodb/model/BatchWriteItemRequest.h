...
class BatchWriteItemRequest : public DynamoDBRequest {
 public:
  ...
  void SetRequestItems(RequestItemsT&& value) {
    m_requestItemsHasBeenSet = true;
    m_requestItems = std::forward<RequestItemsT>(value);
  }
  template <typename RequestItemsT = Aws::Map<Aws::String, Aws::Vector<WriteRequest>>>
  BatchWriteItemRequest& WithRequestItems(RequestItemsT&& value) {
    SetRequestItems(std::forward<RequestItemsT>(value));
    return *this;
  }
  ...
  BatchWriteItemRequest& AddRequestItems(RequestItemsKeyT&& key, RequestItemsValueT&& value) {
    m_requestItemsHasBeenSet = true;
    m_requestItems.emplace(std::forward<RequestItemsKeyT>(key), std::forward<RequestItemsValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline BatchWriteItemRequest& WithReturnConsumedCapacity(ReturnConsumedCapacity value) {
  ...
  inline BatchWriteItemRequest& WithReturnItemCollectionMetrics(ReturnItemCollectionMetrics value) {
