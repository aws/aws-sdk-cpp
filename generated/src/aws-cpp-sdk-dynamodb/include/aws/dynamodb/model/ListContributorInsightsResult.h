...
class ListContributorInsightsResult {
 public:
  ...
  void SetContributorInsightsSummaries(ContributorInsightsSummariesT&& value) {
    m_contributorInsightsSummariesHasBeenSet = true;
    m_contributorInsightsSummaries = std::forward<ContributorInsightsSummariesT>(value);
  }
  template <typename ContributorInsightsSummariesT = Aws::Vector<ContributorInsightsSummary>>
  ListContributorInsightsResult& WithContributorInsightsSummaries(ContributorInsightsSummariesT&& value) {
    SetContributorInsightsSummaries(std::forward<ContributorInsightsSummariesT>(value));
    return *this;
  }
  template <typename ContributorInsightsSummariesT = ContributorInsightsSummary>
  ListContributorInsightsResult& AddContributorInsightsSummaries(ContributorInsightsSummariesT&& value) {
    m_contributorInsightsSummariesHasBeenSet = true;
    m_contributorInsightsSummaries.emplace_back(std::forward<ContributorInsightsSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContributorInsightsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListContributorInsightsResult& WithRequestId(RequestIdT&& value) {
