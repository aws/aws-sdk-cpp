...
namespace Model
{
  ...
  public:
    ...
    void SetContributorInsightsSummaries(ContributorInsightsSummariesT&& value) { m_contributorInsightsSummaries = std::forward<ContributorInsightsSummariesT>(value); }
    template<typename ContributorInsightsSummariesT = Aws::Vector<ContributorInsightsSummary>>
    ...
    ListContributorInsightsResult& AddContributorInsightsSummaries(ContributorInsightsSummariesT&& value) { m_contributorInsightsSummaries.emplace_back(std::forward<ContributorInsightsSummariesT>(value)); return *this; }
    ///@}
