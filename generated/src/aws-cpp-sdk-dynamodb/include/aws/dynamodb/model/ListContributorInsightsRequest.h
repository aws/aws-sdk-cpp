...
class ListContributorInsightsRequest : public DynamoDBRequest {
 public:
  ...
  template <typename TableNameT = Aws::String>
  ListContributorInsightsRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListContributorInsightsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListContributorInsightsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
