...
class BatchWriteItemResult {
 public:
  ...
  void SetUnprocessedItems(UnprocessedItemsT&& value) {
    ...
    m_unprocessedItems = std::forward<UnprocessedItemsT>(value);
  }
  template <typename UnprocessedItemsT = Aws::Map<Aws::String, Aws::Vector<WriteRequest>>>
  BatchWriteItemResult& WithUnprocessedItems(UnprocessedItemsT&& value) {
    SetUnprocessedItems(std::forward<UnprocessedItemsT>(value));
    return *this;
  }
  ...
  BatchWriteItemResult& AddUnprocessedItems(UnprocessedItemsKeyT&& key, UnprocessedItemsValueT&& value) {
    m_unprocessedItemsHasBeenSet = true;
    m_unprocessedItems.emplace(std::forward<UnprocessedItemsKeyT>(key), std::forward<UnprocessedItemsValueT>(value));
    return *this;
  }
  ///@}
   ...
   * estimate.</p> </li> </ul>
   */
  inline const Aws::Map<Aws::String, Aws::Vector<ItemCollectionMetrics>>& GetItemCollectionMetrics() const {
    return m_itemCollectionMetrics;
  }
  ...
  void SetItemCollectionMetrics(ItemCollectionMetricsT&& value) {
    ...
    m_itemCollectionMetrics = std::forward<ItemCollectionMetricsT>(value);
  }
  template <typename ItemCollectionMetricsT = Aws::Map<Aws::String, Aws::Vector<ItemCollectionMetrics>>>
  BatchWriteItemResult& WithItemCollectionMetrics(ItemCollectionMetricsT&& value) {
    SetItemCollectionMetrics(std::forward<ItemCollectionMetricsT>(value));
    return *this;
  }
  ...
  BatchWriteItemResult& AddItemCollectionMetrics(ItemCollectionMetricsKeyT&& key, ItemCollectionMetricsValueT&& value) {
    m_itemCollectionMetricsHasBeenSet = true;
    m_itemCollectionMetrics.emplace(std::forward<ItemCollectionMetricsKeyT>(key), std::forward<ItemCollectionMetricsValueT>(value));
    return *this;
  }
  ///@}
