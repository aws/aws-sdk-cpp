...
namespace Model
{
  ...
  public:
    ...
    void SetUnprocessedItems(UnprocessedItemsT&& value) { m_unprocessedItems = std::forward<UnprocessedItemsT>(value); }
    template<typename UnprocessedItemsT = Aws::Map<Aws::String, Aws::Vector<WriteRequest>>>
    ...
    BatchWriteItemResult& AddUnprocessedItems(UnprocessedItemsKeyT&& key, UnprocessedItemsValueT&& value) {
      m_unprocessedItems.emplace(std::forward<UnprocessedItemsKeyT>(key), std::forward<UnprocessedItemsValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetItemCollectionMetrics(ItemCollectionMetricsT&& value) { m_itemCollectionMetrics = std::forward<ItemCollectionMetricsT>(value); }
    template<typename ItemCollectionMetricsT = Aws::Map<Aws::String, Aws::Vector<ItemCollectionMetrics>>>
    ...
    BatchWriteItemResult& AddItemCollectionMetrics(ItemCollectionMetricsKeyT&& key, ItemCollectionMetricsValueT&& value) {
      m_itemCollectionMetrics.emplace(std::forward<ItemCollectionMetricsKeyT>(key), std::forward<ItemCollectionMetricsValueT>(value)); return *this;
    }
    ///@}
    ...
    BatchWriteItemResult& AddConsumedCapacity(ConsumedCapacityT&& value) { m_consumedCapacity.emplace_back(std::forward<ConsumedCapacityT>(value)); return *this; }
    ///@}
