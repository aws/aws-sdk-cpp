...
namespace Model
{
  ...
  public:
    ...
    void SetImportSummaryList(ImportSummaryListT&& value) { m_importSummaryList = std::forward<ImportSummaryListT>(value); }
    template<typename ImportSummaryListT = Aws::Vector<ImportSummary>>
    ...
    ListImportsResult& AddImportSummaryList(ImportSummaryListT&& value) { m_importSummaryList.emplace_back(std::forward<ImportSummaryListT>(value)); return *this; }
    ///@}
