...
class ListImportsResult {
 public:
  ...
  void SetImportSummaryList(ImportSummaryListT&& value) {
    m_importSummaryListHasBeenSet = true;
    m_importSummaryList = std::forward<ImportSummaryListT>(value);
  }
  template <typename ImportSummaryListT = Aws::Vector<ImportSummary>>
  ListImportsResult& WithImportSummaryList(ImportSummaryListT&& value) {
    SetImportSummaryList(std::forward<ImportSummaryListT>(value));
    return *this;
  }
  template <typename ImportSummaryListT = ImportSummary>
  ListImportsResult& AddImportSummaryList(ImportSummaryListT&& value) {
    m_importSummaryListHasBeenSet = true;
    m_importSummaryList.emplace_back(std::forward<ImportSummaryListT>(value));
    return *this;
  }
  ///@}
