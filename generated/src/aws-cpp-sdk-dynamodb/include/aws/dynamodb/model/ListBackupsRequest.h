...
class ListBackupsRequest : public DynamoDBRequest {
 public:
  ...
  inline ListBackupsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  void SetTimeRangeLowerBound(TimeRangeLowerBoundT&& value) {
    m_timeRangeLowerBoundHasBeenSet = true;
    m_timeRangeLowerBound = std::forward<TimeRangeLowerBoundT>(value);
  }
  template <typename TimeRangeLowerBoundT = Aws::Utils::DateTime>
  ListBackupsRequest& WithTimeRangeLowerBound(TimeRangeLowerBoundT&& value) {
    SetTimeRangeLowerBound(std::forward<TimeRangeLowerBoundT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeRangeUpperBound(TimeRangeUpperBoundT&& value) {
    m_timeRangeUpperBoundHasBeenSet = true;
    m_timeRangeUpperBound = std::forward<TimeRangeUpperBoundT>(value);
  }
  template <typename TimeRangeUpperBoundT = Aws::Utils::DateTime>
  ListBackupsRequest& WithTimeRangeUpperBound(TimeRangeUpperBoundT&& value) {
    SetTimeRangeUpperBound(std::forward<TimeRangeUpperBoundT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExclusiveStartBackupArn(ExclusiveStartBackupArnT&& value) {
    m_exclusiveStartBackupArnHasBeenSet = true;
    m_exclusiveStartBackupArn = std::forward<ExclusiveStartBackupArnT>(value);
  }
  template <typename ExclusiveStartBackupArnT = Aws::String>
  ListBackupsRequest& WithExclusiveStartBackupArn(ExclusiveStartBackupArnT&& value) {
    SetExclusiveStartBackupArn(std::forward<ExclusiveStartBackupArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBackupType(BackupTypeFilter value) {
    m_backupTypeHasBeenSet = true;
    m_backupType = value;
  }
  inline ListBackupsRequest& WithBackupType(BackupTypeFilter value) {
    SetBackupType(value);
    return *this;
  }
  ///@}
