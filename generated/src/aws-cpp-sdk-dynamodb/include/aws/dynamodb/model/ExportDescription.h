...
class ExportDescription {
 public:
  ...
  inline ExportDescription& WithExportStatus(ExportStatus value) {
  ...
  inline ExportDescription& WithS3SseAlgorithm(S3SseAlgorithm value) {
  ...
  inline ExportDescription& WithExportFormat(ExportFormat value) {
  ...
  inline void SetBilledSizeBytes(long long value) {
    m_billedSizeBytesHasBeenSet = true;
    m_billedSizeBytes = value;
  }
  inline ExportDescription& WithBilledSizeBytes(long long value) {
    SetBilledSizeBytes(value);
    return *this;
  }
  ///@}
  ...
  inline ExportDescription& WithItemCount(long long value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
  ...
  inline ExportDescription& WithExportType(ExportType value) {
    SetExportType(value);
    return *this;
  }
  ///@}
