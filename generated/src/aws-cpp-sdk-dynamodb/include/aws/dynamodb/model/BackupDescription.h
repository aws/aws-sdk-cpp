...
class BackupDescription {
 public:
  ...
  void SetBackupDetails(BackupDetailsT&& value) {
    ...
    m_backupDetails = std::forward<BackupDetailsT>(value);
  }
  template <typename BackupDetailsT = BackupDetails>
  BackupDescription& WithBackupDetails(BackupDetailsT&& value) {
    SetBackupDetails(std::forward<BackupDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceTableDetails(SourceTableDetailsT&& value) {
    ...
    m_sourceTableDetails = std::forward<SourceTableDetailsT>(value);
  }
  template <typename SourceTableDetailsT = SourceTableDetails>
  BackupDescription& WithSourceTableDetails(SourceTableDetailsT&& value) {
    SetSourceTableDetails(std::forward<SourceTableDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceTableFeatureDetails(SourceTableFeatureDetailsT&& value) {
    ...
    m_sourceTableFeatureDetails = std::forward<SourceTableFeatureDetailsT>(value);
  }
  template <typename SourceTableFeatureDetailsT = SourceTableFeatureDetails>
  BackupDescription& WithSourceTableFeatureDetails(SourceTableFeatureDetailsT&& value) {
    SetSourceTableFeatureDetails(std::forward<SourceTableFeatureDetailsT>(value));
    return *this;
  }
  ///@}
 private:
