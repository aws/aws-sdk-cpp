...
class ItemCollectionMetrics {
 public:
  ...
  void SetItemCollectionKey(ItemCollectionKeyT&& value) {
    ...
    m_itemCollectionKey = std::forward<ItemCollectionKeyT>(value);
  }
  template <typename ItemCollectionKeyT = Aws::Map<Aws::String, AttributeValue>>
  ItemCollectionMetrics& WithItemCollectionKey(ItemCollectionKeyT&& value) {
    SetItemCollectionKey(std::forward<ItemCollectionKeyT>(value));
    return *this;
  }
  ...
  ItemCollectionMetrics& AddItemCollectionKey(ItemCollectionKeyKeyT&& key, ItemCollectionKeyValueT&& value) {
    m_itemCollectionKeyHasBeenSet = true;
    m_itemCollectionKey.emplace(std::forward<ItemCollectionKeyKeyT>(key), std::forward<ItemCollectionKeyValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSizeEstimateRangeGB(SizeEstimateRangeGBT&& value) {
    ...
    m_sizeEstimateRangeGB = std::forward<SizeEstimateRangeGBT>(value);
  }
  template <typename SizeEstimateRangeGBT = Aws::Vector<double>>
  ItemCollectionMetrics& WithSizeEstimateRangeGB(SizeEstimateRangeGBT&& value) {
    SetSizeEstimateRangeGB(std::forward<SizeEstimateRangeGBT>(value));
    return *this;
  }
  inline ItemCollectionMetrics& AddSizeEstimateRangeGB(double value) {
    m_sizeEstimateRangeGBHasBeenSet = true;
    m_sizeEstimateRangeGB.push_back(value);
    return *this;
  }
  ///@}
 private:
