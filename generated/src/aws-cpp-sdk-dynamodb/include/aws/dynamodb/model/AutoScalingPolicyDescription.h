...
class AutoScalingPolicyDescription {
 public:
  ...
  template <typename PolicyNameT = Aws::String>
  AutoScalingPolicyDescription& WithPolicyName(PolicyNameT&& value) {
   ...
   */
  inline const AutoScalingTargetTrackingScalingPolicyConfigurationDescription& GetTargetTrackingScalingPolicyConfiguration() const {
  ...
  template <typename TargetTrackingScalingPolicyConfigurationT = AutoScalingTargetTrackingScalingPolicyConfigurationDescription>
  AutoScalingPolicyDescription& WithTargetTrackingScalingPolicyConfiguration(TargetTrackingScalingPolicyConfigurationT&& value) {
