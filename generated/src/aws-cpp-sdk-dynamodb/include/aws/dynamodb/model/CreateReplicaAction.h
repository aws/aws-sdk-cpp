...
namespace Model
{
  ...
  {
  public:
    AWS_DYNAMODB_API CreateReplicaAction() = default;
    ...
    template<typename RegionNameT = Aws::String>
    CreateReplicaAction& WithRegionName(RegionNameT&& value) { SetRegionName(std::forward<RegionNameT>(value)); return *this;}
    ///@}
  private:
