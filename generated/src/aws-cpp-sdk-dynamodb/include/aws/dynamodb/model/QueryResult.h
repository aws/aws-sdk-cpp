...
class QueryResult {
 public:
  ...
  inline QueryResult& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline QueryResult& WithScannedCount(int value) {
  ...
  template <typename LastEvaluatedKeyT = Aws::Map<Aws::String, AttributeValue>>
  QueryResult& WithLastEvaluatedKey(LastEvaluatedKeyT&& value) {
  ...
  template <typename ConsumedCapacityT = ConsumedCapacity>
  QueryResult& WithConsumedCapacity(ConsumedCapacityT&& value) {
