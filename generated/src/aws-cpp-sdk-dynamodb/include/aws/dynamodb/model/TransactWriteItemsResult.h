...
class TransactWriteItemsResult {
 public:
  ...
  template <typename ConsumedCapacityT = Aws::Vector<ConsumedCapacity>>
  TransactWriteItemsResult& WithConsumedCapacity(ConsumedCapacityT&& value) {
    SetConsumedCapacity(std::forward<ConsumedCapacityT>(value));
    return *this;
  }
  template <typename ConsumedCapacityT = ConsumedCapacity>
  TransactWriteItemsResult& AddConsumedCapacity(ConsumedCapacityT&& value) {
    m_consumedCapacityHasBeenSet = true;
  ...
  template <typename ItemCollectionMetricsT = Aws::Map<Aws::String, Aws::Vector<ItemCollectionMetrics>>>
  TransactWriteItemsResult& WithItemCollectionMetrics(ItemCollectionMetricsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  TransactWriteItemsResult& WithRequestId(RequestIdT&& value) {
