...
class GlobalTable {
 public:
  ...
  template <typename GlobalTableNameT = Aws::String>
  GlobalTable& WithGlobalTableName(GlobalTableNameT&& value) {
  ...
  template <typename ReplicationGroupT = Aws::Vector<Replica>>
  GlobalTable& WithReplicationGroup(ReplicationGroupT&& value) {
    SetReplicationGroup(std::forward<ReplicationGroupT>(value));
    return *this;
  }
  template <typename ReplicationGroupT = Replica>
  GlobalTable& AddReplicationGroup(ReplicationGroupT&& value) {
    m_replicationGroupHasBeenSet = true;
