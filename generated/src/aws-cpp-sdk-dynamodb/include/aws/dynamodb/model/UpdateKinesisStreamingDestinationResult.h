...
namespace Model
{
  ...
  public:
    ...
    inline void SetDestinationStatus(DestinationStatus value) { m_destinationStatus = value; }
    ...
    void SetUpdateKinesisStreamingConfiguration(UpdateKinesisStreamingConfigurationT&& value) { m_updateKinesisStreamingConfiguration = std::forward<UpdateKinesisStreamingConfigurationT>(value); }
    template<typename UpdateKinesisStreamingConfigurationT = UpdateKinesisStreamingConfiguration>
