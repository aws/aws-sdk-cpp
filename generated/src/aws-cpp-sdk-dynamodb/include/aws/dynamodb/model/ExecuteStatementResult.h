...
namespace Model
{
  ...
  public:
    ...
    void SetItems(ItemsT&& value) { m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<Aws::Map<Aws::String, AttributeValue>>>
    ...
    ExecuteStatementResult& AddItems(ItemsT&& value) { m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
    ...
    void SetLastEvaluatedKey(LastEvaluatedKeyT&& value) { m_lastEvaluatedKey = std::forward<LastEvaluatedKeyT>(value); }
    template<typename LastEvaluatedKeyT = Aws::Map<Aws::String, AttributeValue>>
    ...
    ExecuteStatementResult& AddLastEvaluatedKey(LastEvaluatedKeyKeyT&& key, LastEvaluatedKeyValueT&& value) {
      m_lastEvaluatedKey.emplace(std::forward<LastEvaluatedKeyKeyT>(key), std::forward<LastEvaluatedKeyValueT>(value)); return *this;
    }
    ///@}
