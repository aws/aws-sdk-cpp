...
class ListTablesResult {
 public:
  ...
  void SetTableNames(TableNamesT&& value) {
    m_tableNamesHasBeenSet = true;
    m_tableNames = std::forward<TableNamesT>(value);
  }
  template <typename TableNamesT = Aws::Vector<Aws::String>>
  ListTablesResult& WithTableNames(TableNamesT&& value) {
    SetTableNames(std::forward<TableNamesT>(value));
    return *this;
  }
  template <typename TableNamesT = Aws::String>
  ListTablesResult& AddTableNames(TableNamesT&& value) {
    m_tableNamesHasBeenSet = true;
    m_tableNames.emplace_back(std::forward<TableNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastEvaluatedTableName(LastEvaluatedTableNameT&& value) {
    m_lastEvaluatedTableNameHasBeenSet = true;
    m_lastEvaluatedTableName = std::forward<LastEvaluatedTableNameT>(value);
  }
  template <typename LastEvaluatedTableNameT = Aws::String>
  ListTablesResult& WithLastEvaluatedTableName(LastEvaluatedTableNameT&& value) {
    SetLastEvaluatedTableName(std::forward<LastEvaluatedTableNameT>(value));
    return *this;
  }
  ///@}
