...
namespace Model
{
  ...
  public:
    ...
    void SetTableNames(TableNamesT&& value) { m_tableNames = std::forward<TableNamesT>(value); }
    template<typename TableNamesT = Aws::Vector<Aws::String>>
    ...
    ListTablesResult& AddTableNames(TableNamesT&& value) { m_tableNames.emplace_back(std::forward<TableNamesT>(value)); return *this; }
    ///@}
    ...
    void SetLastEvaluatedTableName(LastEvaluatedTableNameT&& value) { m_lastEvaluatedTableName = std::forward<LastEvaluatedTableNameT>(value); }
    template<typename LastEvaluatedTableNameT = Aws::String>
