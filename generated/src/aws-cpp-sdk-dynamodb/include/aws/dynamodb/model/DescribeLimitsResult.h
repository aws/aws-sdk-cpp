...
class DescribeLimitsResult {
 public:
  ...
  inline void SetAccountMaxReadCapacityUnits(long long value) {
    m_accountMaxReadCapacityUnitsHasBeenSet = true;
    m_accountMaxReadCapacityUnits = value;
  }
  inline DescribeLimitsResult& WithAccountMaxReadCapacityUnits(long long value) {
    SetAccountMaxReadCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAccountMaxWriteCapacityUnits(long long value) {
    m_accountMaxWriteCapacityUnitsHasBeenSet = true;
    m_accountMaxWriteCapacityUnits = value;
  }
  inline DescribeLimitsResult& WithAccountMaxWriteCapacityUnits(long long value) {
    SetAccountMaxWriteCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTableMaxReadCapacityUnits(long long value) {
    m_tableMaxReadCapacityUnitsHasBeenSet = true;
    m_tableMaxReadCapacityUnits = value;
  }
  inline DescribeLimitsResult& WithTableMaxReadCapacityUnits(long long value) {
    SetTableMaxReadCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTableMaxWriteCapacityUnits(long long value) {
    m_tableMaxWriteCapacityUnitsHasBeenSet = true;
    m_tableMaxWriteCapacityUnits = value;
  }
  inline DescribeLimitsResult& WithTableMaxWriteCapacityUnits(long long value) {
    SetTableMaxWriteCapacityUnits(value);
    return *this;
  }
  ///@}
