...
class UpdateContinuousBackupsRequest : public DynamoDBRequest {
 public:
  ...
  template <typename TableNameT = Aws::String>
  UpdateContinuousBackupsRequest& WithTableName(TableNameT&& value) {
  ...
  void SetPointInTimeRecoverySpecification(PointInTimeRecoverySpecificationT&& value) {
    m_pointInTimeRecoverySpecificationHasBeenSet = true;
    m_pointInTimeRecoverySpecification = std::forward<PointInTimeRecoverySpecificationT>(value);
  }
  template <typename PointInTimeRecoverySpecificationT = PointInTimeRecoverySpecification>
  UpdateContinuousBackupsRequest& WithPointInTimeRecoverySpecification(PointInTimeRecoverySpecificationT&& value) {
    SetPointInTimeRecoverySpecification(std::forward<PointInTimeRecoverySpecificationT>(value));
    return *this;
  }
  ///@}
 private:
