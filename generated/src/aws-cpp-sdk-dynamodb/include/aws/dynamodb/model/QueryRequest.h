...
class QueryRequest : public DynamoDBRequest {
 public:
  ...
  inline QueryRequest& WithSelect(Select value) {
    SetSelect(value);
    return *this;
  }
  ///@}
  ...
  inline QueryRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  inline QueryRequest& WithConsistentRead(bool value) {
  ...
  void SetKeyConditions(KeyConditionsT&& value) {
    m_keyConditionsHasBeenSet = true;
    m_keyConditions = std::forward<KeyConditionsT>(value);
  }
  template <typename KeyConditionsT = Aws::Map<Aws::String, Condition>>
  QueryRequest& WithKeyConditions(KeyConditionsT&& value) {
    SetKeyConditions(std::forward<KeyConditionsT>(value));
    return *this;
  }
  ...
  QueryRequest& AddKeyConditions(KeyConditionsKeyT&& key, KeyConditionsValueT&& value) {
    m_keyConditionsHasBeenSet = true;
    m_keyConditions.emplace(std::forward<KeyConditionsKeyT>(key), std::forward<KeyConditionsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueryFilter(QueryFilterT&& value) {
    m_queryFilterHasBeenSet = true;
    m_queryFilter = std::forward<QueryFilterT>(value);
  }
  template <typename QueryFilterT = Aws::Map<Aws::String, Condition>>
  QueryRequest& WithQueryFilter(QueryFilterT&& value) {
    SetQueryFilter(std::forward<QueryFilterT>(value));
    return *this;
  }
  ...
  QueryRequest& AddQueryFilter(QueryFilterKeyT&& key, QueryFilterValueT&& value) {
    m_queryFilterHasBeenSet = true;
    m_queryFilter.emplace(std::forward<QueryFilterKeyT>(key), std::forward<QueryFilterValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline QueryRequest& WithConditionalOperator(ConditionalOperator value) {
  ...
  inline void SetScanIndexForward(bool value) {
    m_scanIndexForwardHasBeenSet = true;
    m_scanIndexForward = value;
  }
  inline QueryRequest& WithScanIndexForward(bool value) {
    SetScanIndexForward(value);
    return *this;
  }
  ///@}
  ...
  inline QueryRequest& WithReturnConsumedCapacity(ReturnConsumedCapacity value) {
