...
namespace Model
{
  ...
  public:
    ...
    void SetContinuousBackupsDescription(ContinuousBackupsDescriptionT&& value) { m_continuousBackupsDescription = std::forward<ContinuousBackupsDescriptionT>(value); }
    template<typename ContinuousBackupsDescriptionT = ContinuousBackupsDescription>
