...
class UpdateContinuousBackupsResult {
 public:
  ...
  void SetContinuousBackupsDescription(ContinuousBackupsDescriptionT&& value) {
    m_continuousBackupsDescriptionHasBeenSet = true;
    m_continuousBackupsDescription = std::forward<ContinuousBackupsDescriptionT>(value);
  }
  template <typename ContinuousBackupsDescriptionT = ContinuousBackupsDescription>
  UpdateContinuousBackupsResult& WithContinuousBackupsDescription(ContinuousBackupsDescriptionT&& value) {
    SetContinuousBackupsDescription(std::forward<ContinuousBackupsDescriptionT>(value));
    return *this;
  }
  ///@}
