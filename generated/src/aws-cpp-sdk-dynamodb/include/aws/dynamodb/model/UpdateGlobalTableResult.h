...
namespace Model
{
  ...
  {
  public:
    AWS_DYNAMODB_API UpdateGlobalTableResult() = default;
    ...
    template<typename GlobalTableDescriptionT = GlobalTableDescription>
    UpdateGlobalTableResult& WithGlobalTableDescription(GlobalTableDescriptionT&& value) { SetGlobalTableDescription(std::forward<GlobalTableDescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateGlobalTableResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
