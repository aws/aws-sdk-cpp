...
namespace Model
{
  ...
  public:
    ...
    BatchGetItemResult& AddResponses(ResponsesKeyT&& key, ResponsesValueT&& value) {
      m_responses.emplace(std::forward<ResponsesKeyT>(key), std::forward<ResponsesValueT>(value)); return *this;
    }
    ///@}
    ...
    void SetUnprocessedKeys(UnprocessedKeysT&& value) { m_unprocessedKeys = std::forward<UnprocessedKeysT>(value); }
    template<typename UnprocessedKeysT = Aws::Map<Aws::String, KeysAndAttributes>>
    ...
    BatchGetItemResult& AddUnprocessedKeys(UnprocessedKeysKeyT&& key, UnprocessedKeysValueT&& value) {
      m_unprocessedKeys.emplace(std::forward<UnprocessedKeysKeyT>(key), std::forward<UnprocessedKeysValueT>(value)); return *this;
    }
    ///@}
    ...
    BatchGetItemResult& AddConsumedCapacity(ConsumedCapacityT&& value) { m_consumedCapacity.emplace_back(std::forward<ConsumedCapacityT>(value)); return *this; }
    ///@}
