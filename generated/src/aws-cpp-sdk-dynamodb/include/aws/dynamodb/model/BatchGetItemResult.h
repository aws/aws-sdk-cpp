...
class BatchGetItemResult {
 public:
  ...
  template <typename ResponsesT = Aws::Map<Aws::String, Aws::Vector<Aws::Map<Aws::String, AttributeValue>>>>
  BatchGetItemResult& WithResponses(ResponsesT&& value) {
  ...
  BatchGetItemResult& AddResponses(ResponsesKeyT&& key, ResponsesValueT&& value) {
    m_responsesHasBeenSet = true;
    m_responses.emplace(std::forward<ResponsesKeyT>(key), std::forward<ResponsesValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UnprocessedKeysT = Aws::Map<Aws::String, KeysAndAttributes>>
  BatchGetItemResult& WithUnprocessedKeys(UnprocessedKeysT&& value) {
  ...
  BatchGetItemResult& AddUnprocessedKeys(UnprocessedKeysKeyT&& key, UnprocessedKeysValueT&& value) {
    m_unprocessedKeysHasBeenSet = true;
    m_unprocessedKeys.emplace(std::forward<UnprocessedKeysKeyT>(key), std::forward<UnprocessedKeysValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ConsumedCapacityT = Aws::Vector<ConsumedCapacity>>
  BatchGetItemResult& WithConsumedCapacity(ConsumedCapacityT&& value) {
    SetConsumedCapacity(std::forward<ConsumedCapacityT>(value));
    return *this;
  }
  template <typename ConsumedCapacityT = ConsumedCapacity>
  BatchGetItemResult& AddConsumedCapacity(ConsumedCapacityT&& value) {
    m_consumedCapacityHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetItemResult& WithRequestId(RequestIdT&& value) {
