...
class ExecuteTransactionRequest : public DynamoDBRequest {
 public:
  ...
  void SetTransactStatements(TransactStatementsT&& value) {
    m_transactStatementsHasBeenSet = true;
    m_transactStatements = std::forward<TransactStatementsT>(value);
  }
  template <typename TransactStatementsT = Aws::Vector<ParameterizedStatement>>
  ExecuteTransactionRequest& WithTransactStatements(TransactStatementsT&& value) {
    SetTransactStatements(std::forward<TransactStatementsT>(value));
    return *this;
  }
  template <typename TransactStatementsT = ParameterizedStatement>
  ExecuteTransactionRequest& AddTransactStatements(TransactStatementsT&& value) {
    m_transactStatementsHasBeenSet = true;
    m_transactStatements.emplace_back(std::forward<TransactStatementsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientRequestTokenT = Aws::String>
  ExecuteTransactionRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  inline ExecuteTransactionRequest& WithReturnConsumedCapacity(ReturnConsumedCapacity value) {
