...
class AutoScalingTargetTrackingScalingPolicyConfigurationUpdate {
 public:
  AWS_DYNAMODB_API AutoScalingTargetTrackingScalingPolicyConfigurationUpdate() = default;
  ...
  inline AutoScalingTargetTrackingScalingPolicyConfigurationUpdate& WithDisableScaleIn(bool value) {
  ...
  inline AutoScalingTargetTrackingScalingPolicyConfigurationUpdate& WithScaleInCooldown(int value) {
  ...
  inline AutoScalingTargetTrackingScalingPolicyConfigurationUpdate& WithScaleOutCooldown(int value) {
  ...
  inline AutoScalingTargetTrackingScalingPolicyConfigurationUpdate& WithTargetValue(double value) {
