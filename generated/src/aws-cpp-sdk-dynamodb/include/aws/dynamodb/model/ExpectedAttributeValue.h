...
class ExpectedAttributeValue {
 public:
  ...
  inline ExpectedAttributeValue& WithExists(bool value) {
    SetExists(value);
    return *this;
  }
  ///@}
  ...
  inline ExpectedAttributeValue& WithComparisonOperator(ComparisonOperator value) {
  ...
  void SetAttributeValueList(AttributeValueListT&& value) {
    ...
    m_attributeValueList = std::forward<AttributeValueListT>(value);
  }
  template <typename AttributeValueListT = Aws::Vector<AttributeValue>>
  ExpectedAttributeValue& WithAttributeValueList(AttributeValueListT&& value) {
    SetAttributeValueList(std::forward<AttributeValueListT>(value));
    return *this;
  }
  ...
  ExpectedAttributeValue& AddAttributeValueList(AttributeValueListT&& value) {
    m_attributeValueListHasBeenSet = true;
    m_attributeValueList.emplace_back(std::forward<AttributeValueListT>(value));
    return *this;
  }
  ///@}
 private:
