...
class ScanRequest : public DynamoDBRequest {
 public:
  ...
  inline ScanRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSelect(Select value) {
    m_selectHasBeenSet = true;
    m_select = value;
  }
  inline ScanRequest& WithSelect(Select value) {
    SetSelect(value);
    return *this;
  }
  ///@}
  ...
  void SetScanFilter(ScanFilterT&& value) {
    m_scanFilterHasBeenSet = true;
    m_scanFilter = std::forward<ScanFilterT>(value);
  }
  template <typename ScanFilterT = Aws::Map<Aws::String, Condition>>
  ScanRequest& WithScanFilter(ScanFilterT&& value) {
    SetScanFilter(std::forward<ScanFilterT>(value));
    return *this;
  }
  ...
  ScanRequest& AddScanFilter(ScanFilterKeyT&& key, ScanFilterValueT&& value) {
    m_scanFilterHasBeenSet = true;
    m_scanFilter.emplace(std::forward<ScanFilterKeyT>(key), std::forward<ScanFilterValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline ScanRequest& WithConditionalOperator(ConditionalOperator value) {
  ...
  void SetExclusiveStartKey(ExclusiveStartKeyT&& value) {
    m_exclusiveStartKeyHasBeenSet = true;
    m_exclusiveStartKey = std::forward<ExclusiveStartKeyT>(value);
  }
  template <typename ExclusiveStartKeyT = Aws::Map<Aws::String, AttributeValue>>
  ScanRequest& WithExclusiveStartKey(ExclusiveStartKeyT&& value) {
    SetExclusiveStartKey(std::forward<ExclusiveStartKeyT>(value));
    return *this;
  }
  ...
  ScanRequest& AddExclusiveStartKey(ExclusiveStartKeyKeyT&& key, ExclusiveStartKeyValueT&& value) {
    m_exclusiveStartKeyHasBeenSet = true;
    m_exclusiveStartKey.emplace(std::forward<ExclusiveStartKeyKeyT>(key), std::forward<ExclusiveStartKeyValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline ScanRequest& WithReturnConsumedCapacity(ReturnConsumedCapacity value) {
  ...
  inline void SetTotalSegments(int value) {
    m_totalSegmentsHasBeenSet = true;
    m_totalSegments = value;
  }
  inline ScanRequest& WithTotalSegments(int value) {
  ...
  inline void SetSegment(int value) {
    m_segmentHasBeenSet = true;
    m_segment = value;
  }
  inline ScanRequest& WithSegment(int value) {
    SetSegment(value);
    return *this;
  }
  ///@}
  ...
  inline ScanRequest& WithConsistentRead(bool value) {
