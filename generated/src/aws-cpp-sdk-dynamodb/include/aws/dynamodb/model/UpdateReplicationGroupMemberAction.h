...
class UpdateReplicationGroupMemberAction {
 public:
  ...
  inline void SetTableClassOverride(TableClass value) {
    m_tableClassOverrideHasBeenSet = true;
    m_tableClassOverride = value;
  }
  inline UpdateReplicationGroupMemberAction& WithTableClassOverride(TableClass value) {
    SetTableClassOverride(value);
    return *this;
  }
  ///@}
 private:
