...
class ListTagsOfResourceResult {
 public:
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ListTagsOfResourceResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ListTagsOfResourceResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTagsOfResourceResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTagsOfResourceResult& WithRequestId(RequestIdT&& value) {
