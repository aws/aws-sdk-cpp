...
class RestoreSummary {
 public:
  ...
  void SetSourceBackupArn(SourceBackupArnT&& value) {
    ...
    m_sourceBackupArn = std::forward<SourceBackupArnT>(value);
  }
  template <typename SourceBackupArnT = Aws::String>
  RestoreSummary& WithSourceBackupArn(SourceBackupArnT&& value) {
    SetSourceBackupArn(std::forward<SourceBackupArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRestoreInProgress(bool value) {
    m_restoreInProgressHasBeenSet = true;
    m_restoreInProgress = value;
  }
  inline RestoreSummary& WithRestoreInProgress(bool value) {
