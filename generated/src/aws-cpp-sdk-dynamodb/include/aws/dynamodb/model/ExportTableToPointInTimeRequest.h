...
class ExportTableToPointInTimeRequest : public DynamoDBRequest {
 public:
  ...
  template <typename TableArnT = Aws::String>
  ExportTableToPointInTimeRequest& WithTableArn(TableArnT&& value) {
  ...
  void SetExportTime(ExportTimeT&& value) {
    ...
    m_exportTime = std::forward<ExportTimeT>(value);
  }
  template <typename ExportTimeT = Aws::Utils::DateTime>
  ExportTableToPointInTimeRequest& WithExportTime(ExportTimeT&& value) {
    SetExportTime(std::forward<ExportTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  ExportTableToPointInTimeRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename S3BucketT = Aws::String>
  ExportTableToPointInTimeRequest& WithS3Bucket(S3BucketT&& value) {
  ...
  template <typename S3BucketOwnerT = Aws::String>
  ExportTableToPointInTimeRequest& WithS3BucketOwner(S3BucketOwnerT&& value) {
  ...
  template <typename S3PrefixT = Aws::String>
  ExportTableToPointInTimeRequest& WithS3Prefix(S3PrefixT&& value) {
  ...
  inline ExportTableToPointInTimeRequest& WithS3SseAlgorithm(S3SseAlgorithm value) {
  ...
  template <typename S3SseKmsKeyIdT = Aws::String>
  ExportTableToPointInTimeRequest& WithS3SseKmsKeyId(S3SseKmsKeyIdT&& value) {
  ...
  inline void SetExportFormat(ExportFormat value) {
    m_exportFormatHasBeenSet = true;
    m_exportFormat = value;
  }
  inline ExportTableToPointInTimeRequest& WithExportFormat(ExportFormat value) {
  ...
  inline ExportTableToPointInTimeRequest& WithExportType(ExportType value) {
    SetExportType(value);
    return *this;
  }
  ///@}
  ...
  void SetIncrementalExportSpecification(IncrementalExportSpecificationT&& value) {
    ...
    m_incrementalExportSpecification = std::forward<IncrementalExportSpecificationT>(value);
  }
  template <typename IncrementalExportSpecificationT = IncrementalExportSpecification>
  ExportTableToPointInTimeRequest& WithIncrementalExportSpecification(IncrementalExportSpecificationT&& value) {
    SetIncrementalExportSpecification(std::forward<IncrementalExportSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
