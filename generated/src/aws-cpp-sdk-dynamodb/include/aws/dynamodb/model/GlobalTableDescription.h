...
class GlobalTableDescription {
 public:
  ...
  GlobalTableDescription& AddReplicationGroup(ReplicationGroupT&& value) {
    m_replicationGroupHasBeenSet = true;
    m_replicationGroup.emplace_back(std::forward<ReplicationGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGlobalTableArn(GlobalTableArnT&& value) {
    m_globalTableArnHasBeenSet = true;
    m_globalTableArn = std::forward<GlobalTableArnT>(value);
  }
  template <typename GlobalTableArnT = Aws::String>
  GlobalTableDescription& WithGlobalTableArn(GlobalTableArnT&& value) {
    SetGlobalTableArn(std::forward<GlobalTableArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetGlobalTableStatus(GlobalTableStatus value) {
    m_globalTableStatusHasBeenSet = true;
    m_globalTableStatus = value;
  }
  inline GlobalTableDescription& WithGlobalTableStatus(GlobalTableStatus value) {
    SetGlobalTableStatus(value);
    return *this;
  }
  ///@}
