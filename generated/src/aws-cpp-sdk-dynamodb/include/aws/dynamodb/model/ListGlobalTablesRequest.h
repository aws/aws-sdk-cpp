...
class ListGlobalTablesRequest : public DynamoDBRequest {
 public:
  ...
  void SetExclusiveStartGlobalTableName(ExclusiveStartGlobalTableNameT&& value) {
    m_exclusiveStartGlobalTableNameHasBeenSet = true;
    m_exclusiveStartGlobalTableName = std::forward<ExclusiveStartGlobalTableNameT>(value);
  }
  template <typename ExclusiveStartGlobalTableNameT = Aws::String>
  ListGlobalTablesRequest& WithExclusiveStartGlobalTableName(ExclusiveStartGlobalTableNameT&& value) {
    SetExclusiveStartGlobalTableName(std::forward<ExclusiveStartGlobalTableNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListGlobalTablesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
