...
class TableCreationParameters {
 public:
  ...
  void SetAttributeDefinitions(AttributeDefinitionsT&& value) {
    ...
    m_attributeDefinitions = std::forward<AttributeDefinitionsT>(value);
  }
  template <typename AttributeDefinitionsT = Aws::Vector<AttributeDefinition>>
  TableCreationParameters& WithAttributeDefinitions(AttributeDefinitionsT&& value) {
    SetAttributeDefinitions(std::forward<AttributeDefinitionsT>(value));
    return *this;
  }
  ...
  TableCreationParameters& AddAttributeDefinitions(AttributeDefinitionsT&& value) {
    m_attributeDefinitionsHasBeenSet = true;
    m_attributeDefinitions.emplace_back(std::forward<AttributeDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline TableCreationParameters& WithBillingMode(BillingMode value) {
