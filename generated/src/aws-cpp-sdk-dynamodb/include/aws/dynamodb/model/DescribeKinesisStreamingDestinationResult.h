...
namespace Model
{
  ...
  public:
    ...
    void SetTableName(TableNameT&& value) { m_tableName = std::forward<TableNameT>(value); }
    template<typename TableNameT = Aws::String>
    ...
    void SetKinesisDataStreamDestinations(KinesisDataStreamDestinationsT&& value) { m_kinesisDataStreamDestinations = std::forward<KinesisDataStreamDestinationsT>(value); }
    template<typename KinesisDataStreamDestinationsT = Aws::Vector<KinesisDataStreamDestination>>
    ...
    DescribeKinesisStreamingDestinationResult& AddKinesisDataStreamDestinations(KinesisDataStreamDestinationsT&& value) { m_kinesisDataStreamDestinations.emplace_back(std::forward<KinesisDataStreamDestinationsT>(value)); return *this; }
    ///@}
