...
class DescribeKinesisStreamingDestinationResult {
 public:
  ...
  AWS_DYNAMODB_API DescribeKinesisStreamingDestinationResult& operator=(
   ...
   */
  inline const Aws::Vector<KinesisDataStreamDestination>& GetKinesisDataStreamDestinations() const {
    return m_kinesisDataStreamDestinations;
  }
  template <typename KinesisDataStreamDestinationsT = Aws::Vector<KinesisDataStreamDestination>>
  void SetKinesisDataStreamDestinations(KinesisDataStreamDestinationsT&& value) {
    m_kinesisDataStreamDestinationsHasBeenSet = true;
    m_kinesisDataStreamDestinations = std::forward<KinesisDataStreamDestinationsT>(value);
  }
  template <typename KinesisDataStreamDestinationsT = Aws::Vector<KinesisDataStreamDestination>>
  DescribeKinesisStreamingDestinationResult& WithKinesisDataStreamDestinations(KinesisDataStreamDestinationsT&& value) {
    SetKinesisDataStreamDestinations(std::forward<KinesisDataStreamDestinationsT>(value));
    return *this;
  }
  ...
  DescribeKinesisStreamingDestinationResult& AddKinesisDataStreamDestinations(KinesisDataStreamDestinationsT&& value) {
    m_kinesisDataStreamDestinationsHasBeenSet = true;
    m_kinesisDataStreamDestinations.emplace_back(std::forward<KinesisDataStreamDestinationsT>(value));
    return *this;
  }
  ///@}
