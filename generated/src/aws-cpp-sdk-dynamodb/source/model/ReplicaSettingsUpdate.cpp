...
ReplicaSettingsUpdate::ReplicaSettingsUpdate(JsonView jsonValue) { *this = jsonValue; }
...
ReplicaSettingsUpdate& ReplicaSettingsUpdate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate")) {
    m_replicaProvisionedReadCapacityAutoScalingSettingsUpdate =
        jsonValue.GetObject("ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate");
  ...
  if (jsonValue.ValueExists("ReplicaGlobalSecondaryIndexSettingsUpdate")) {
    Aws::Utils::Array<JsonView> replicaGlobalSecondaryIndexSettingsUpdateJsonList =
        jsonValue.GetArray("ReplicaGlobalSecondaryIndexSettingsUpdate");
    for (unsigned replicaGlobalSecondaryIndexSettingsUpdateIndex = 0;
         replicaGlobalSecondaryIndexSettingsUpdateIndex < replicaGlobalSecondaryIndexSettingsUpdateJsonList.GetLength();
         ++replicaGlobalSecondaryIndexSettingsUpdateIndex) {
      m_replicaGlobalSecondaryIndexSettingsUpdate.push_back(
          replicaGlobalSecondaryIndexSettingsUpdateJsonList[replicaGlobalSecondaryIndexSettingsUpdateIndex].AsObject());
    }
...
JsonValue ReplicaSettingsUpdate::Jsonize() const {
  ...
  if (m_replicaProvisionedReadCapacityAutoScalingSettingsUpdateHasBeenSet) {
    payload.WithObject("ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate",
                       m_replicaProvisionedReadCapacityAutoScalingSettingsUpdate.Jsonize());
  }
  ...
  if (m_replicaGlobalSecondaryIndexSettingsUpdateHasBeenSet) {
    ...
    for (unsigned replicaGlobalSecondaryIndexSettingsUpdateIndex = 0;
         ...
         ++replicaGlobalSecondaryIndexSettingsUpdateIndex) {
      replicaGlobalSecondaryIndexSettingsUpdateJsonList[replicaGlobalSecondaryIndexSettingsUpdateIndex].AsObject(
          m_replicaGlobalSecondaryIndexSettingsUpdate[replicaGlobalSecondaryIndexSettingsUpdateIndex].Jsonize());
    }
