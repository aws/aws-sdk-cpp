...
DescribeKinesisStreamingDestinationResult& DescribeKinesisStreamingDestinationResult::operator=(
  ...
  if (jsonValue.ValueExists("KinesisDataStreamDestinations")) {
    ...
    for (unsigned kinesisDataStreamDestinationsIndex = 0;
         kinesisDataStreamDestinationsIndex < kinesisDataStreamDestinationsJsonList.GetLength(); ++kinesisDataStreamDestinationsIndex) {
