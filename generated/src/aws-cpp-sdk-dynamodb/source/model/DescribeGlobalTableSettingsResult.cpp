...
DescribeGlobalTableSettingsResult::DescribeGlobalTableSettingsResult()
{
}

DescribeGlobalTableSettingsResult::DescribeGlobalTableSettingsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
