...
namespace DynamoDBStreams
{
   ...
   * Guide.</p>
   */
  class AWS_DYNAMODBSTREAMS_API DynamoDBStreamsClient : Aws::Client::ClientWithAsyncTemplateMethods<DynamoDBStreamsClient>,
    smithy::client::AwsSmithyClientT<Aws::DynamoDBStreams::SERVICE_NAME,
