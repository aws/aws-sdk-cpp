...
class AWS_DYNAMODBSTREAMS_API DynamoDBStreamsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DynamoDBStreamsClient(const Aws::DynamoDBStreams::DynamoDBStreamsClientConfiguration& clientConfiguration =
  ...
  DynamoDBStreamsClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<DynamoDBStreamsEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::DynamoDBStreams::DynamoDBStreamsClientConfiguration& clientConfiguration =
                            Aws::DynamoDBStreams::DynamoDBStreamsClientConfiguration());
