...
class StreamRecord {
 public:
  ...
  void SetApproximateCreationDateTime(ApproximateCreationDateTimeT&& value) {
    ...
    m_approximateCreationDateTime = std::forward<ApproximateCreationDateTimeT>(value);
  }
  template <typename ApproximateCreationDateTimeT = Aws::Utils::DateTime>
  StreamRecord& WithApproximateCreationDateTime(ApproximateCreationDateTimeT&& value) {
    SetApproximateCreationDateTime(std::forward<ApproximateCreationDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  StreamRecord& AddNewImage(NewImageKeyT&& key, NewImageValueT&& value) {
    m_newImageHasBeenSet = true;
    m_newImage.emplace(std::forward<NewImageKeyT>(key), std::forward<NewImageValueT>(value));
    return *this;
  }
  ///@}
  ...
  StreamRecord& AddOldImage(OldImageKeyT&& key, OldImageValueT&& value) {
    m_oldImageHasBeenSet = true;
    m_oldImage.emplace(std::forward<OldImageKeyT>(key), std::forward<OldImageValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline StreamRecord& WithSizeBytes(long long value) {
    SetSizeBytes(value);
    return *this;
  }
  ///@}
  ...
  inline StreamRecord& WithStreamViewType(StreamViewType value) {
