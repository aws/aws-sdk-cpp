...
class StreamDescription {
 public:
  ...
  inline StreamDescription& WithStreamStatus(StreamStatus value) {
  ...
  inline void SetStreamViewType(StreamViewType value) {
    m_streamViewTypeHasBeenSet = true;
    m_streamViewType = value;
  }
  inline StreamDescription& WithStreamViewType(StreamViewType value) {
    SetStreamViewType(value);
    return *this;
  }
  ///@}
  ...
  void SetCreationRequestDateTime(CreationRequestDateTimeT&& value) {
    ...
    m_creationRequestDateTime = std::forward<CreationRequestDateTimeT>(value);
  }
  template <typename CreationRequestDateTimeT = Aws::Utils::DateTime>
  StreamDescription& WithCreationRequestDateTime(CreationRequestDateTimeT&& value) {
    SetCreationRequestDateTime(std::forward<CreationRequestDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShards(ShardsT&& value) {
    ...
    m_shards = std::forward<ShardsT>(value);
  }
  template <typename ShardsT = Aws::Vector<Shard>>
  StreamDescription& WithShards(ShardsT&& value) {
    SetShards(std::forward<ShardsT>(value));
    return *this;
  }
  template <typename ShardsT = Shard>
  StreamDescription& AddShards(ShardsT&& value) {
    m_shardsHasBeenSet = true;
    m_shards.emplace_back(std::forward<ShardsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastEvaluatedShardId(LastEvaluatedShardIdT&& value) {
    ...
    m_lastEvaluatedShardId = std::forward<LastEvaluatedShardIdT>(value);
  }
  template <typename LastEvaluatedShardIdT = Aws::String>
  StreamDescription& WithLastEvaluatedShardId(LastEvaluatedShardIdT&& value) {
    SetLastEvaluatedShardId(std::forward<LastEvaluatedShardIdT>(value));
    return *this;
  }
  ///@}
 private:
