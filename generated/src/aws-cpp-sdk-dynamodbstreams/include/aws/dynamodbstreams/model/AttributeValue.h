...
class AttributeValue {
 public:
  ...
  void SetS(ST&& value) {
    m_sHasBeenSet = true;
    m_s = std::forward<ST>(value);
  }
  template <typename ST = Aws::String>
  AttributeValue& WithS(ST&& value) {
    SetS(std::forward<ST>(value));
    return *this;
  }
  ///@}
  ...
  void SetN(NT&& value) {
    m_nHasBeenSet = true;
    m_n = std::forward<NT>(value);
  }
  template <typename NT = Aws::String>
  AttributeValue& WithN(NT&& value) {
    SetN(std::forward<NT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSS(SST&& value) {
    m_sSHasBeenSet = true;
    m_sS = std::forward<SST>(value);
  }
  template <typename SST = Aws::Vector<Aws::String>>
  AttributeValue& WithSS(SST&& value) {
    SetSS(std::forward<SST>(value));
    return *this;
  }
  template <typename SST = Aws::String>
  AttributeValue& AddSS(SST&& value) {
    m_sSHasBeenSet = true;
    m_sS.emplace_back(std::forward<SST>(value));
    return *this;
  }
  ///@}
  ...
  void SetNS(NST&& value) {
    m_nSHasBeenSet = true;
    m_nS = std::forward<NST>(value);
  }
  template <typename NST = Aws::Vector<Aws::String>>
  AttributeValue& WithNS(NST&& value) {
    SetNS(std::forward<NST>(value));
    return *this;
  }
  template <typename NST = Aws::String>
  AttributeValue& AddNS(NST&& value) {
    m_nSHasBeenSet = true;
    m_nS.emplace_back(std::forward<NST>(value));
    return *this;
  }
  ///@}
  ...
  void SetBS(BST&& value) {
    m_bSHasBeenSet = true;
    m_bS = std::forward<BST>(value);
  }
  template <typename BST = Aws::Vector<Aws::Utils::ByteBuffer>>
  AttributeValue& WithBS(BST&& value) {
    SetBS(std::forward<BST>(value));
    return *this;
  }
  template <typename BST = Aws::Utils::ByteBuffer>
  AttributeValue& AddBS(BST&& value) {
    m_bSHasBeenSet = true;
    m_bS.emplace_back(std::forward<BST>(value));
    return *this;
  }
  ///@}
  ...
  inline AttributeValue& WithNULL(bool value) {
    SetNULL(value);
    return *this;
  }
  ///@}
  ...
  inline AttributeValue& WithBOOL(bool value) {
    SetBOOL(value);
    return *this;
  }
  ///@}
