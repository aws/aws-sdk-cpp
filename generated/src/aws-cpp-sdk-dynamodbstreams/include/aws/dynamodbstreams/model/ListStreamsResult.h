...
class ListStreamsResult {
 public:
  ...
  void SetLastEvaluatedStreamArn(LastEvaluatedStreamArnT&& value) {
    m_lastEvaluatedStreamArnHasBeenSet = true;
    m_lastEvaluatedStreamArn = std::forward<LastEvaluatedStreamArnT>(value);
  }
  template <typename LastEvaluatedStreamArnT = Aws::String>
  ListStreamsResult& WithLastEvaluatedStreamArn(LastEvaluatedStreamArnT&& value) {
    SetLastEvaluatedStreamArn(std::forward<LastEvaluatedStreamArnT>(value));
    return *this;
  }
  ///@}
