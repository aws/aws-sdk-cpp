...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKDATAAUTOMATION_API UpdateBlueprintResult() = default;
    ...
    template<typename BlueprintT = Blueprint>
    UpdateBlueprintResult& WithBlueprint(BlueprintT&& value) { SetBlueprint(std::forward<BlueprintT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateBlueprintResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
