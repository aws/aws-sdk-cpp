...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKDATAAUTOMATION_API ListTagsForResourceResult() = default;
    AWS_BEDROCKDATAAUTOMATION_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_BEDROCKDATAAUTOMATION_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
