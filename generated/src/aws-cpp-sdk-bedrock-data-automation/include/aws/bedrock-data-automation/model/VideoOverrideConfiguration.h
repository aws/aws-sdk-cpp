...
/**
 * <p>Override Configuration of Video</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-data-automation-2023-07-26/VideoOverrideConfiguration">AWS
 * API Reference</a></p>
 */
class VideoOverrideConfiguration {
 public:
  AWS_BEDROCKDATAAUTOMATION_API VideoOverrideConfiguration() = default;
  AWS_BEDROCKDATAAUTOMATION_API VideoOverrideConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKDATAAUTOMATION_API VideoOverrideConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ModalityProcessingT = ModalityProcessingConfiguration>
  VideoOverrideConfiguration& WithModalityProcessing(ModalityProcessingT&& value) {
  ...
  template <typename SensitiveDataConfigurationT = SensitiveDataConfiguration>
  VideoOverrideConfiguration& WithSensitiveDataConfiguration(SensitiveDataConfigurationT&& value) {
