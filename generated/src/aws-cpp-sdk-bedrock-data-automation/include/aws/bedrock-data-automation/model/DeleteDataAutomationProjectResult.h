...
class DeleteDataAutomationProjectResult {
 public:
  ...
  AWS_BEDROCKDATAAUTOMATION_API DeleteDataAutomationProjectResult& operator=(
  ...
  inline DeleteDataAutomationProjectResult& WithStatus(DataAutomationProjectStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDataAutomationProjectResult& WithRequestId(RequestIdT&& value) {
