...
class CreateDataAutomationProjectResult {
 public:
  ...
  AWS_BEDROCKDATAAUTOMATION_API CreateDataAutomationProjectResult& operator=(
  ...
  inline CreateDataAutomationProjectResult& WithProjectStage(DataAutomationProjectStage value) {
  ...
  inline CreateDataAutomationProjectResult& WithStatus(DataAutomationProjectStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
