...
class ImageExtractionCategory {
 public:
  ...
  inline ImageExtractionCategory& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypesT = Aws::Vector<ImageExtractionCategoryType>>
  ImageExtractionCategory& WithTypes(TypesT&& value) {
    SetTypes(std::forward<TypesT>(value));
    return *this;
  }
  inline ImageExtractionCategory& AddTypes(ImageExtractionCategoryType value) {
    m_typesHasBeenSet = true;
