...
class UpdateDataAutomationProjectResult {
 public:
  ...
  AWS_BEDROCKDATAAUTOMATION_API UpdateDataAutomationProjectResult& operator=(
  ...
  inline UpdateDataAutomationProjectResult& WithProjectStage(DataAutomationProjectStage value) {
  ...
  inline UpdateDataAutomationProjectResult& WithStatus(DataAutomationProjectStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
