...
/**
 * <p>Vocabulary entity with detailed information</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-data-automation-2023-07-26/VocabularyEntity">AWS
 * API Reference</a></p>
 */
class VocabularyEntity {
 public:
  ...
  inline VocabularyEntity& WithLanguage(Language value) {
    SetLanguage(value);
    return *this;
  }
  ///@}
