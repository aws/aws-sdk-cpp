...
/**
 * <p>Delete DataAutomationLibrary Request</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-data-automation-2023-07-26/DeleteDataAutomationLibraryRequest">AWS
 * API Reference</a></p>
 */
class DeleteDataAutomationLibraryRequest : public BedrockDataAutomationRequest {
 public:
  AWS_BEDROCKDATAAUTOMATION_API DeleteDataAutomationLibraryRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "DeleteDataAutomationLibrary"; }
  ...
  template <typename LibraryArnT = Aws::String>
  DeleteDataAutomationLibraryRequest& WithLibraryArn(LibraryArnT&& value) {
