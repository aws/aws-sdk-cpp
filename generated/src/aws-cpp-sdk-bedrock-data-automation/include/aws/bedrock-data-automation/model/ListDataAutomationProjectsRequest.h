...
class ListDataAutomationProjectsRequest : public BedrockDataAutomationRequest {
 public:
  ...
  inline ListDataAutomationProjectsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataAutomationProjectsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetProjectStageFilter(DataAutomationProjectStageFilter value) {
    m_projectStageFilterHasBeenSet = true;
    m_projectStageFilter = value;
  }
  inline ListDataAutomationProjectsRequest& WithProjectStageFilter(DataAutomationProjectStageFilter value) {
  ...
  void SetBlueprintFilter(BlueprintFilterT&& value) {
    m_blueprintFilterHasBeenSet = true;
    m_blueprintFilter = std::forward<BlueprintFilterT>(value);
  }
  template <typename BlueprintFilterT = BlueprintFilter>
  ListDataAutomationProjectsRequest& WithBlueprintFilter(BlueprintFilterT&& value) {
    SetBlueprintFilter(std::forward<BlueprintFilterT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListDataAutomationProjectsRequest& WithResourceOwner(ResourceOwner value) {
