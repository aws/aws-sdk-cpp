...
class AudioOverrideConfiguration {
 public:
  ...
  template <typename ModalityProcessingT = ModalityProcessingConfiguration>
  AudioOverrideConfiguration& WithModalityProcessing(ModalityProcessingT&& value) {
  ...
  template <typename SensitiveDataConfigurationT = SensitiveDataConfiguration>
  AudioOverrideConfiguration& WithSensitiveDataConfiguration(SensitiveDataConfigurationT&& value) {
