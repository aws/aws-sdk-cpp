...
class ImageOverrideConfiguration {
 public:
  ...
  template <typename ModalityProcessingT = ModalityProcessingConfiguration>
  ImageOverrideConfiguration& WithModalityProcessing(ModalityProcessingT&& value) {
  ...
  template <typename SensitiveDataConfigurationT = SensitiveDataConfiguration>
  ImageOverrideConfiguration& WithSensitiveDataConfiguration(SensitiveDataConfigurationT&& value) {
