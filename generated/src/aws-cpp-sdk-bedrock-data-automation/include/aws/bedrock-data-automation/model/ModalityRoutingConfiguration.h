...
class ModalityRoutingConfiguration {
 public:
  ...
  inline void SetJpeg(DesiredModality value) {
    m_jpegHasBeenSet = true;
    m_jpeg = value;
  }
  inline ModalityRoutingConfiguration& WithJpeg(DesiredModality value) {
    SetJpeg(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPng(DesiredModality value) {
    m_pngHasBeenSet = true;
    m_png = value;
  }
  inline ModalityRoutingConfiguration& WithPng(DesiredModality value) {
    SetPng(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMp4(DesiredModality value) {
    m_mp4HasBeenSet = true;
    m_mp4 = value;
  }
  inline ModalityRoutingConfiguration& WithMp4(DesiredModality value) {
    SetMp4(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMov(DesiredModality value) {
    m_movHasBeenSet = true;
    m_mov = value;
  }
  inline ModalityRoutingConfiguration& WithMov(DesiredModality value) {
    SetMov(value);
    return *this;
  }
  ///@}
