...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKDATAAUTOMATION_API DeleteDataAutomationProjectRequest() = default;
    ...
    template<typename ProjectArnT = Aws::String>
    DeleteDataAutomationProjectRequest& WithProjectArn(ProjectArnT&& value) { SetProjectArn(std::forward<ProjectArnT>(value)); return *this;}
    ///@}
  private:
