...
class ListBlueprintsRequest : public BedrockDataAutomationRequest {
 public:
  ...
  inline ListBlueprintsRequest& WithResourceOwner(ResourceOwner value) {
  ...
  inline void SetBlueprintStageFilter(BlueprintStageFilter value) {
    m_blueprintStageFilterHasBeenSet = true;
    m_blueprintStageFilter = value;
  }
  inline ListBlueprintsRequest& WithBlueprintStageFilter(BlueprintStageFilter value) {
    SetBlueprintStageFilter(value);
    return *this;
  }
  ///@}
  ...
  inline ListBlueprintsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
