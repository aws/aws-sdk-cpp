...
class AudioExtractionCategory {
 public:
  ...
  inline AudioExtractionCategory& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypesT = Aws::Vector<AudioExtractionCategoryType>>
  AudioExtractionCategory& WithTypes(TypesT&& value) {
    SetTypes(std::forward<TypesT>(value));
    return *this;
  }
  inline AudioExtractionCategory& AddTypes(AudioExtractionCategoryType value) {
    m_typesHasBeenSet = true;
  ...
  void SetTypeConfiguration(TypeConfigurationT&& value) {
    m_typeConfigurationHasBeenSet = true;
    m_typeConfiguration = std::forward<TypeConfigurationT>(value);
  }
  template <typename TypeConfigurationT = AudioExtractionCategoryTypeConfiguration>
  AudioExtractionCategory& WithTypeConfiguration(TypeConfigurationT&& value) {
    SetTypeConfiguration(std::forward<TypeConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
