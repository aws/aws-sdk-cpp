...
namespace Model
{
  ...
  public:
    ...
    inline ImageStandardGenerativeField& WithState(State value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename TypesT = Aws::Vector<ImageStandardGenerativeFieldType>>
    void SetTypes(TypesT&& value) { m_typesHasBeenSet = true; m_types = std::forward<TypesT>(value); }
    template<typename TypesT = Aws::Vector<ImageStandardGenerativeFieldType>>
    ImageStandardGenerativeField& WithTypes(TypesT&& value) { SetTypes(std::forward<TypesT>(value)); return *this;}
    inline ImageStandardGenerativeField& AddTypes(ImageStandardGenerativeFieldType value) { m_typesHasBeenSet = true; m_types.push_back(value); return *this; }
    ///@}
  private:
