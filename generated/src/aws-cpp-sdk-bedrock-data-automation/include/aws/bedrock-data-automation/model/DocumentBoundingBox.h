...
/**
 * <p>Bounding Box Configuration of Document Extraction</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-data-automation-2023-07-26/DocumentBoundingBox">AWS
 * API Reference</a></p>
 */
class DocumentBoundingBox {
 public:
  ...
  inline DocumentBoundingBox& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
