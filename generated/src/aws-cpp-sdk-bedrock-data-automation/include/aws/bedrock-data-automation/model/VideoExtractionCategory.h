...
class VideoExtractionCategory {
 public:
  ...
  inline VideoExtractionCategory& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypesT = Aws::Vector<VideoExtractionCategoryType>>
  VideoExtractionCategory& WithTypes(TypesT&& value) {
    SetTypes(std::forward<TypesT>(value));
    return *this;
  }
  inline VideoExtractionCategory& AddTypes(VideoExtractionCategoryType value) {
    m_typesHasBeenSet = true;
