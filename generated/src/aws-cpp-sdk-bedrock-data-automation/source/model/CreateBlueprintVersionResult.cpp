...
CreateBlueprintVersionResult::CreateBlueprintVersionResult()
{
}

CreateBlueprintVersionResult::CreateBlueprintVersionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
