...
VocabularyEntity::VocabularyEntity(JsonView jsonValue) { *this = jsonValue; }

VocabularyEntity& VocabularyEntity::operator=(JsonView jsonValue) {
...
JsonValue VocabularyEntity::Jsonize() const {
  JsonValue payload;
