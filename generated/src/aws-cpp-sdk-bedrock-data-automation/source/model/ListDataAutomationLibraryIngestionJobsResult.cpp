...
ListDataAutomationLibraryIngestionJobsResult::ListDataAutomationLibraryIngestionJobsResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListDataAutomationLibraryIngestionJobsResult& ListDataAutomationLibraryIngestionJobsResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
