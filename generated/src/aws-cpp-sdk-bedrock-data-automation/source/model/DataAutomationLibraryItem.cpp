...
DataAutomationLibraryItem::DataAutomationLibraryItem(JsonView jsonValue) { *this = jsonValue; }

DataAutomationLibraryItem& DataAutomationLibraryItem::operator=(JsonView jsonValue) {
...
JsonValue DataAutomationLibraryItem::Jsonize() const {
  JsonValue payload;
