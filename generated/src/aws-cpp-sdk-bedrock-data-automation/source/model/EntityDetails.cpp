...
EntityDetails::EntityDetails(JsonView jsonValue) { *this = jsonValue; }

EntityDetails& EntityDetails::operator=(JsonView jsonValue) {
...
JsonValue EntityDetails::Jsonize() const {
  JsonValue payload;
