...
GetDataAutomationLibraryIngestionJobResult::GetDataAutomationLibraryIngestionJobResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

GetDataAutomationLibraryIngestionJobResult& GetDataAutomationLibraryIngestionJobResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
