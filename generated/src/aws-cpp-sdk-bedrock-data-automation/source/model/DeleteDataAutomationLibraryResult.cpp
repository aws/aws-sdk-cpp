...
DeleteDataAutomationLibraryResult::DeleteDataAutomationLibraryResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

DeleteDataAutomationLibraryResult& DeleteDataAutomationLibraryResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
