...
ListDataAutomationLibraryEntitiesResult::ListDataAutomationLibraryEntitiesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListDataAutomationLibraryEntitiesResult& ListDataAutomationLibraryEntitiesResult::operator=(
