...
CreateDataAutomationLibraryResult::CreateDataAutomationLibraryResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CreateDataAutomationLibraryResult& CreateDataAutomationLibraryResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
