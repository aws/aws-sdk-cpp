...
GetBlueprintResult::GetBlueprintResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetBlueprintResult& GetBlueprintResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
