...
UpdateDataAutomationLibraryResult::UpdateDataAutomationLibraryResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdateDataAutomationLibraryResult& UpdateDataAutomationLibraryResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
