...
SessionState& SessionState::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("returnControlInvocationResults")) {
    ...
    for (unsigned returnControlInvocationResultsIndex = 0;
         returnControlInvocationResultsIndex < returnControlInvocationResultsJsonList.GetLength(); ++returnControlInvocationResultsIndex) {
...
JsonValue SessionState::Jsonize() const {
  ...
  if (m_returnControlInvocationResultsHasBeenSet) {
    ...
    for (unsigned returnControlInvocationResultsIndex = 0;
         returnControlInvocationResultsIndex < returnControlInvocationResultsJsonList.GetLength(); ++returnControlInvocationResultsIndex) {
      returnControlInvocationResultsJsonList[returnControlInvocationResultsIndex].AsObject(
          m_returnControlInvocationResults[returnControlInvocationResultsIndex].Jsonize());
    }
