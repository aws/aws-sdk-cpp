...
FlowInputContent::FlowInputContent(JsonView jsonValue) { *this = jsonValue; }

FlowInputContent& FlowInputContent::operator=(JsonView jsonValue) {
...
JsonValue FlowInputContent::Jsonize() const {
  JsonValue payload;
