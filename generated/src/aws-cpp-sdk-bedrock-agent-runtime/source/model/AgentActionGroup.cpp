...
AgentActionGroup::AgentActionGroup(JsonView jsonValue) { *this = jsonValue; }
...
AgentActionGroup& AgentActionGroup::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("parentActionGroupSignature")) {
    m_parentActionGroupSignature =
        ActionGroupSignatureMapper::GetActionGroupSignatureForName(jsonValue.GetString("parentActionGroupSignature"));
  ...
  if (jsonValue.ValueExists("parentActionGroupSignatureParams")) {
    Aws::Map<Aws::String, JsonView> parentActionGroupSignatureParamsJsonMap =
        jsonValue.GetObject("parentActionGroupSignatureParams").GetAllObjects();
    for (auto& parentActionGroupSignatureParamsItem : parentActionGroupSignatureParamsJsonMap) {
      m_parentActionGroupSignatureParams[parentActionGroupSignatureParamsItem.first] =
          parentActionGroupSignatureParamsItem.second.AsString();
    }
...
JsonValue AgentActionGroup::Jsonize() const {
  ...
  if (m_parentActionGroupSignatureHasBeenSet) {
    payload.WithString("parentActionGroupSignature",
                       ActionGroupSignatureMapper::GetNameForActionGroupSignature(m_parentActionGroupSignature));
  }
  ...
  if (m_parentActionGroupSignatureParamsHasBeenSet) {
    ...
    for (auto& parentActionGroupSignatureParamsItem : m_parentActionGroupSignatureParams) {
      parentActionGroupSignatureParamsJsonMap.WithString(parentActionGroupSignatureParamsItem.first,
                                                         parentActionGroupSignatureParamsItem.second);
    }
