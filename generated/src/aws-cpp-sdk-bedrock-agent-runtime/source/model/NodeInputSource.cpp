...
NodeInputSource::NodeInputSource(JsonView jsonValue) { *this = jsonValue; }

NodeInputSource& NodeInputSource::operator=(JsonView jsonValue) {
...
JsonValue NodeInputSource::Jsonize() const {
  JsonValue payload;
