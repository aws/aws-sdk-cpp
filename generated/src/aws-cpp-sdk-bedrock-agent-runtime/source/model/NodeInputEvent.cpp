...
NodeInputEvent::NodeInputEvent(JsonView jsonValue) { *this = jsonValue; }

NodeInputEvent& NodeInputEvent::operator=(JsonView jsonValue) {
...
JsonValue NodeInputEvent::Jsonize() const {
  JsonValue payload;
