...
ManagedSearchBedrockRerankingModelConfiguration::ManagedSearchBedrockRerankingModelConfiguration(JsonView jsonValue) { *this = jsonValue; }

ManagedSearchBedrockRerankingModelConfiguration& ManagedSearchBedrockRerankingModelConfiguration::operator=(JsonView jsonValue) {
...
JsonValue ManagedSearchBedrockRerankingModelConfiguration::Jsonize() const {
  JsonValue payload;
