...
InlineAgentFilePart::InlineAgentFilePart(JsonView jsonValue) { *this = jsonValue; }

InlineAgentFilePart& InlineAgentFilePart::operator=(JsonView jsonValue) {
...
JsonValue InlineAgentFilePart::Jsonize() const {
  JsonValue payload;
