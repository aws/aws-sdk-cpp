...
FlowExecutionInputEvent::FlowExecutionInputEvent(JsonView jsonValue) { *this = jsonValue; }

FlowExecutionInputEvent& FlowExecutionInputEvent::operator=(JsonView jsonValue) {
...
JsonValue FlowExecutionInputEvent::Jsonize() const {
  JsonValue payload;
