...
InvokeInlineAgentInitialResponse::InvokeInlineAgentInitialResponse(JsonView jsonValue) { *this = jsonValue; }
...
InvokeInlineAgentInitialResponse::InvokeInlineAgentInitialResponse(const Http::HeaderValueCollection& headers)
