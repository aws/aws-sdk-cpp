...
AgenticRetrieveTraceResultItem::AgenticRetrieveTraceResultItem(JsonView jsonValue) { *this = jsonValue; }

AgenticRetrieveTraceResultItem& AgenticRetrieveTraceResultItem::operator=(JsonView jsonValue) {
...
JsonValue AgenticRetrieveTraceResultItem::Jsonize() const {
  JsonValue payload;
