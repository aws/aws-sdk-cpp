...
EndSessionResult::EndSessionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

EndSessionResult& EndSessionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
