...
FlowExecutionOutputEvent::FlowExecutionOutputEvent(JsonView jsonValue) { *this = jsonValue; }

FlowExecutionOutputEvent& FlowExecutionOutputEvent::operator=(JsonView jsonValue) {
...
JsonValue FlowExecutionOutputEvent::Jsonize() const {
  JsonValue payload;
