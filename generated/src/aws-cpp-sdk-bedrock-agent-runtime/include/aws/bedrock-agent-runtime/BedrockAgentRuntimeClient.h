...
namespace BedrockAgentRuntime
{
   ...
   * bases.</p>
   */
  class AWS_BEDROCKAGENTRUNTIME_API BedrockAgentRuntimeClient : Aws::Client::ClientWithAsyncTemplateMethods<BedrockAgentRuntimeClient>,
    smithy::client::AwsSmithyClientT<Aws::BedrockAgentRuntime::SERVICE_NAME,
