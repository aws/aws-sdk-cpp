...
class ListFlowExecutionEventsResult {
 public:
  ...
  AWS_BEDROCKAGENTRUNTIME_API ListFlowExecutionEventsResult& operator=(
  ...
  void SetFlowExecutionEvents(FlowExecutionEventsT&& value) {
    m_flowExecutionEventsHasBeenSet = true;
    m_flowExecutionEvents = std::forward<FlowExecutionEventsT>(value);
  }
  template <typename FlowExecutionEventsT = Aws::Vector<FlowExecutionEvent>>
  ListFlowExecutionEventsResult& WithFlowExecutionEvents(FlowExecutionEventsT&& value) {
    SetFlowExecutionEvents(std::forward<FlowExecutionEventsT>(value));
    return *this;
  }
  template <typename FlowExecutionEventsT = FlowExecutionEvent>
  ListFlowExecutionEventsResult& AddFlowExecutionEvents(FlowExecutionEventsT&& value) {
    m_flowExecutionEventsHasBeenSet = true;
    m_flowExecutionEvents.emplace_back(std::forward<FlowExecutionEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFlowExecutionEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFlowExecutionEventsResult& WithRequestId(RequestIdT&& value) {
