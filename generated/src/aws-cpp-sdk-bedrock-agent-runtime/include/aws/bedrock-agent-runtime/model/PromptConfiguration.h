...
namespace Model
{
  ...
  /**
   * <p> Contains configurations to override a prompt template in one part of an
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/PromptConfiguration">AWS
   * API Reference</a></p>
   */
  class PromptConfiguration
  {
  public:
    AWS_BEDROCKAGENTRUNTIME_API PromptConfiguration();
