...
class ListInvocationsResult {
 public:
  ...
  void SetInvocationSummaries(InvocationSummariesT&& value) {
    m_invocationSummariesHasBeenSet = true;
    m_invocationSummaries = std::forward<InvocationSummariesT>(value);
  }
  template <typename InvocationSummariesT = Aws::Vector<InvocationSummary>>
  ListInvocationsResult& WithInvocationSummaries(InvocationSummariesT&& value) {
    SetInvocationSummaries(std::forward<InvocationSummariesT>(value));
    return *this;
  }
  template <typename InvocationSummariesT = InvocationSummary>
  ListInvocationsResult& AddInvocationSummaries(InvocationSummariesT&& value) {
    m_invocationSummariesHasBeenSet = true;
    m_invocationSummaries.emplace_back(std::forward<InvocationSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInvocationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInvocationsResult& WithRequestId(RequestIdT&& value) {
