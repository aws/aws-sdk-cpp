...
class CollaboratorConfiguration {
 public:
  ...
  void SetCollaboratorInstruction(CollaboratorInstructionT&& value) {
    ...
    m_collaboratorInstruction = std::forward<CollaboratorInstructionT>(value);
  }
  template <typename CollaboratorInstructionT = Aws::String>
  CollaboratorConfiguration& WithCollaboratorInstruction(CollaboratorInstructionT&& value) {
    SetCollaboratorInstruction(std::forward<CollaboratorInstructionT>(value));
    return *this;
  }
  ///@}
  ...
  inline CollaboratorConfiguration& WithRelayConversationHistory(RelayConversationHistory value) {
