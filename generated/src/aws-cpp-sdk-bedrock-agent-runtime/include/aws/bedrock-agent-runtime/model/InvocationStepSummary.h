...
class InvocationStepSummary {
 public:
  ...
  template <typename InvocationIdT = Aws::String>
  InvocationStepSummary& WithInvocationId(InvocationIdT&& value) {
  ...
  void SetInvocationStepId(InvocationStepIdT&& value) {
    ...
    m_invocationStepId = std::forward<InvocationStepIdT>(value);
  }
  template <typename InvocationStepIdT = Aws::String>
  InvocationStepSummary& WithInvocationStepId(InvocationStepIdT&& value) {
    SetInvocationStepId(std::forward<InvocationStepIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvocationStepTime(InvocationStepTimeT&& value) {
    m_invocationStepTimeHasBeenSet = true;
    m_invocationStepTime = std::forward<InvocationStepTimeT>(value);
  }
  template <typename InvocationStepTimeT = Aws::Utils::DateTime>
  InvocationStepSummary& WithInvocationStepTime(InvocationStepTimeT&& value) {
    SetInvocationStepTime(std::forward<InvocationStepTimeT>(value));
    return *this;
  }
  ///@}
