...
namespace Model
{
  ...
  /**
   * <p>Represents an item in the execution chain for node input
   * tracking.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/NodeInputExecutionChainItem">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    template<typename NodeNameT = Aws::String>
    NodeInputExecutionChainItem& WithNodeName(NodeNameT&& value) { SetNodeName(std::forward<NodeNameT>(value)); return *this;}
    ///@}
    ...
    inline NodeInputExecutionChainItem& WithIndex(int value) { SetIndex(value); return *this;}
    ///@}
    ...
    inline NodeInputExecutionChainItem& WithType(FlowControlNodeType value) { SetType(value); return *this;}
    ///@}
  private:
