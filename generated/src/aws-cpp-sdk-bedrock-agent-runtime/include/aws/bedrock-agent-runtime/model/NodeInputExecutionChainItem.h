...
class NodeInputExecutionChainItem {
 public:
  ...
  inline NodeInputExecutionChainItem& WithIndex(int value) {
    SetIndex(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(FlowControlNodeType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline NodeInputExecutionChainItem& WithType(FlowControlNodeType value) {
    SetType(value);
    return *this;
  }
  ///@}
