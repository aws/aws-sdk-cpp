...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENTRUNTIME_API InternalServerException();
    ...
    inline InternalServerException& WithReason(const Aws::String& value) { SetReason(value); return *this;}
    inline InternalServerException& WithReason(Aws::String&& value) { SetReason(std::move(value)); return *this;}
    inline InternalServerException& WithReason(const char* value) { SetReason(value); return *this;}
    ///@}
  private:
