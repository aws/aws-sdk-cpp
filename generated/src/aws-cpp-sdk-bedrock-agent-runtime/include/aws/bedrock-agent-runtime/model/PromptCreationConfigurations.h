...
class PromptCreationConfigurations {
 public:
  ...
  inline void SetExcludePreviousThinkingSteps(bool value) {
    m_excludePreviousThinkingStepsHasBeenSet = true;
    m_excludePreviousThinkingSteps = value;
  }
  inline PromptCreationConfigurations& WithExcludePreviousThinkingSteps(bool value) {
    SetExcludePreviousThinkingSteps(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreviousConversationTurnsToInclude(int value) {
    m_previousConversationTurnsToIncludeHasBeenSet = true;
    m_previousConversationTurnsToInclude = value;
  }
  inline PromptCreationConfigurations& WithPreviousConversationTurnsToInclude(int value) {
    SetPreviousConversationTurnsToInclude(value);
    return *this;
  }
  ///@}
 private:
