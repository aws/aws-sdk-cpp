...
namespace Model
{
  ...
  /**
   * <p>Represents the next node that receives output data from a flow
   * trace.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/FlowTraceNodeOutputNext">AWS
   * API Reference</a></p>
   */
  class FlowTraceNodeOutputNext
  {
  public:
    AWS_BEDROCKAGENTRUNTIME_API FlowTraceNodeOutputNext() = default;
    AWS_BEDROCKAGENTRUNTIME_API FlowTraceNodeOutputNext(Aws::Utils::Json::JsonView jsonValue);
    AWS_BEDROCKAGENTRUNTIME_API FlowTraceNodeOutputNext& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename NodeNameT = Aws::String>
    FlowTraceNodeOutputNext& WithNodeName(NodeNameT&& value) { SetNodeName(std::forward<NodeNameT>(value)); return *this;}
    ///@}
    ...
    template<typename InputFieldNameT = Aws::String>
    FlowTraceNodeOutputNext& WithInputFieldName(InputFieldNameT&& value) { SetInputFieldName(std::forward<InputFieldNameT>(value)); return *this;}
    ///@}
  private:
