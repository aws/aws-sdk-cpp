...
class RetrievalFilter {
 public:
  ...
  template <typename AndAllT = Aws::Vector<RetrievalFilter>>
  RetrievalFilter& WithAndAll(AndAllT&& value) {
    SetAndAll(std::forward<AndAllT>(value));
    return *this;
  }
  template <typename AndAllT = RetrievalFilter>
  RetrievalFilter& AddAndAll(AndAllT&& value) {
    m_andAllHasBeenSet = true;
  ...
  template <typename EqualsT = FilterAttribute>
  RetrievalFilter& WithEquals(EqualsT&& value) {
  ...
  template <typename GreaterThanT = FilterAttribute>
  RetrievalFilter& WithGreaterThan(GreaterThanT&& value) {
  ...
  template <typename GreaterThanOrEqualsT = FilterAttribute>
  RetrievalFilter& WithGreaterThanOrEquals(GreaterThanOrEqualsT&& value) {
  ...
  template <typename InT = FilterAttribute>
  RetrievalFilter& WithIn(InT&& value) {
  ...
  template <typename LessThanT = FilterAttribute>
  RetrievalFilter& WithLessThan(LessThanT&& value) {
  ...
  template <typename LessThanOrEqualsT = FilterAttribute>
  RetrievalFilter& WithLessThanOrEquals(LessThanOrEqualsT&& value) {
  ...
  template <typename ListContainsT = FilterAttribute>
  RetrievalFilter& WithListContains(ListContainsT&& value) {
  ...
  template <typename NotEqualsT = FilterAttribute>
  RetrievalFilter& WithNotEquals(NotEqualsT&& value) {
  ...
  template <typename NotInT = FilterAttribute>
  RetrievalFilter& WithNotIn(NotInT&& value) {
  ...
  template <typename OrAllT = Aws::Vector<RetrievalFilter>>
  RetrievalFilter& WithOrAll(OrAllT&& value) {
    SetOrAll(std::forward<OrAllT>(value));
    return *this;
  }
  template <typename OrAllT = RetrievalFilter>
  RetrievalFilter& AddOrAll(OrAllT&& value) {
    m_orAllHasBeenSet = true;
  ...
  template <typename StartsWithT = FilterAttribute>
  RetrievalFilter& WithStartsWith(StartsWithT&& value) {
  ...
  template <typename StringContainsT = FilterAttribute>
  RetrievalFilter& WithStringContains(StringContainsT&& value) {
