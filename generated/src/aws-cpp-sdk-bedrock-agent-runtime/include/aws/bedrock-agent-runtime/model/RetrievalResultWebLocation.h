...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENTRUNTIME_API RetrievalResultWebLocation();
    ...
    inline RetrievalResultWebLocation& WithUrl(const Aws::String& value) { SetUrl(value); return *this;}
    inline RetrievalResultWebLocation& WithUrl(Aws::String&& value) { SetUrl(std::move(value)); return *this;}
    inline RetrievalResultWebLocation& WithUrl(const char* value) { SetUrl(value); return *this;}
    ///@}
  private:
