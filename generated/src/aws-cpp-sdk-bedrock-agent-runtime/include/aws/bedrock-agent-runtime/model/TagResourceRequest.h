...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public BedrockAgentRuntimeRequest
  {
  public:
    AWS_BEDROCKAGENTRUNTIME_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>An object containing key-value pairs that define the tags to attach to the
     * resource.</p>
     */
