...
class RetrieveAndGenerateStreamHandler : public Aws::Utils::Event::EventStreamHandler {
 ...
 public:
   ...
   * @param callback
   */
  inline void SetInitialResponseCallbackEx(const RetrieveAndGenerateStreamInitialResponseCallbackEx& callback) {
  ...
  inline void SetInitialResponseCallback(const RetrieveAndGenerateStreamInitialResponseCallback& noArgCallback) {
    m_onInitialResponse = [noArgCallback](const RetrieveAndGenerateStreamInitialResponse& rs, const Utils::Event::InitialResponseType) {
