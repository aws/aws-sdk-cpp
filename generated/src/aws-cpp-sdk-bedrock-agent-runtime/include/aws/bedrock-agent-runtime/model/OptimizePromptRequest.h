...
class OptimizePromptRequest : public BedrockAgentRuntimeRequest {
 public:
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const OptimizePromptHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline OptimizePromptRequest& WithEventStreamHandler(const OptimizePromptHandler& value) {
  ...
  template <typename InputT = InputPrompt>
  OptimizePromptRequest& WithInput(InputT&& value) {
  ...
  void SetTargetModelId(TargetModelIdT&& value) {
    m_targetModelIdHasBeenSet = true;
    m_targetModelId = std::forward<TargetModelIdT>(value);
  }
  template <typename TargetModelIdT = Aws::String>
  OptimizePromptRequest& WithTargetModelId(TargetModelIdT&& value) {
    SetTargetModelId(std::forward<TargetModelIdT>(value));
    return *this;
  }
  ///@}
 private:
