...
class Observation {
 public:
  ...
  void SetActionGroupInvocationOutput(ActionGroupInvocationOutputT&& value) {
    ...
    m_actionGroupInvocationOutput = std::forward<ActionGroupInvocationOutputT>(value);
  }
  template <typename ActionGroupInvocationOutputT = ActionGroupInvocationOutput>
  Observation& WithActionGroupInvocationOutput(ActionGroupInvocationOutputT&& value) {
    SetActionGroupInvocationOutput(std::forward<ActionGroupInvocationOutputT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AgentCollaboratorInvocationOutput& GetAgentCollaboratorInvocationOutput() const {
    return m_agentCollaboratorInvocationOutput;
  }
  ...
  void SetAgentCollaboratorInvocationOutput(AgentCollaboratorInvocationOutputT&& value) {
    ...
    m_agentCollaboratorInvocationOutput = std::forward<AgentCollaboratorInvocationOutputT>(value);
  }
  template <typename AgentCollaboratorInvocationOutputT = AgentCollaboratorInvocationOutput>
  Observation& WithAgentCollaboratorInvocationOutput(AgentCollaboratorInvocationOutputT&& value) {
    SetAgentCollaboratorInvocationOutput(std::forward<AgentCollaboratorInvocationOutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFinalResponse(FinalResponseT&& value) {
    ...
    m_finalResponse = std::forward<FinalResponseT>(value);
  }
  template <typename FinalResponseT = FinalResponse>
  Observation& WithFinalResponse(FinalResponseT&& value) {
    SetFinalResponse(std::forward<FinalResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRepromptResponse(RepromptResponseT&& value) {
    ...
    m_repromptResponse = std::forward<RepromptResponseT>(value);
  }
  template <typename RepromptResponseT = RepromptResponse>
  Observation& WithRepromptResponse(RepromptResponseT&& value) {
    SetRepromptResponse(std::forward<RepromptResponseT>(value));
    return *this;
  }
  ///@}
