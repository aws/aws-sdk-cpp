...
/**
 * <p>The Microsoft OneDrive location of a retrieval result.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/RetrievalResultOneDriveLocation">AWS
 * API Reference</a></p>
 */
