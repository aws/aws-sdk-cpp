...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENTRUNTIME_API DeleteAgentMemoryResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAgentMemoryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
