...
class RetrievalResultContentColumn {
 public:
  ...
  void SetColumnValue(ColumnValueT&& value) {
    ...
    m_columnValue = std::forward<ColumnValueT>(value);
  }
  template <typename ColumnValueT = Aws::String>
  RetrievalResultContentColumn& WithColumnValue(ColumnValueT&& value) {
    SetColumnValue(std::forward<ColumnValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(RetrievalResultContentColumnType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RetrievalResultContentColumn& WithType(RetrievalResultContentColumnType value) {
    SetType(value);
    return *this;
  }
  ///@}
