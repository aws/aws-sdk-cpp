...
class Citation {
 public:
  ...
  void SetGeneratedResponsePart(GeneratedResponsePartT&& value) {
    m_generatedResponsePartHasBeenSet = true;
    m_generatedResponsePart = std::forward<GeneratedResponsePartT>(value);
  }
  template <typename GeneratedResponsePartT = GeneratedResponsePart>
  Citation& WithGeneratedResponsePart(GeneratedResponsePartT&& value) {
    SetGeneratedResponsePart(std::forward<GeneratedResponsePartT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRetrievedReferences(RetrievedReferencesT&& value) {
    m_retrievedReferencesHasBeenSet = true;
    m_retrievedReferences = std::forward<RetrievedReferencesT>(value);
  }
  template <typename RetrievedReferencesT = Aws::Vector<RetrievedReference>>
  Citation& WithRetrievedReferences(RetrievedReferencesT&& value) {
    SetRetrievedReferences(std::forward<RetrievedReferencesT>(value));
    return *this;
  }
  template <typename RetrievedReferencesT = RetrievedReference>
  Citation& AddRetrievedReferences(RetrievedReferencesT&& value) {
    m_retrievedReferencesHasBeenSet = true;
    m_retrievedReferences.emplace_back(std::forward<RetrievedReferencesT>(value));
    return *this;
  }
  ///@}
 private:
