...
class TransformationConfiguration {
 public:
  ...
  inline void SetMode(QueryTransformationMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline TransformationConfiguration& WithMode(QueryTransformationMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  void SetTextToSqlConfiguration(TextToSqlConfigurationT&& value) {
    m_textToSqlConfigurationHasBeenSet = true;
    m_textToSqlConfiguration = std::forward<TextToSqlConfigurationT>(value);
  }
  template <typename TextToSqlConfigurationT = TextToSqlConfiguration>
  TransformationConfiguration& WithTextToSqlConfiguration(TextToSqlConfigurationT&& value) {
    SetTextToSqlConfiguration(std::forward<TextToSqlConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
