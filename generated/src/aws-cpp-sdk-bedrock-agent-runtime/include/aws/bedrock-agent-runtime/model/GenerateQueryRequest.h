...
class GenerateQueryRequest : public BedrockAgentRuntimeRequest {
 public:
  ...
  void SetQueryGenerationInput(QueryGenerationInputT&& value) {
    m_queryGenerationInputHasBeenSet = true;
    m_queryGenerationInput = std::forward<QueryGenerationInputT>(value);
  }
  template <typename QueryGenerationInputT = QueryGenerationInput>
  GenerateQueryRequest& WithQueryGenerationInput(QueryGenerationInputT&& value) {
    SetQueryGenerationInput(std::forward<QueryGenerationInputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransformationConfiguration(TransformationConfigurationT&& value) {
    m_transformationConfigurationHasBeenSet = true;
    m_transformationConfiguration = std::forward<TransformationConfigurationT>(value);
  }
  template <typename TransformationConfigurationT = TransformationConfiguration>
  GenerateQueryRequest& WithTransformationConfiguration(TransformationConfigurationT&& value) {
    SetTransformationConfiguration(std::forward<TransformationConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
