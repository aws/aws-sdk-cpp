...
class ApiResult {
 public:
  ...
  inline void SetConfirmationState(ConfirmationState value) {
    m_confirmationStateHasBeenSet = true;
    m_confirmationState = value;
  }
  inline ApiResult& WithConfirmationState(ConfirmationState value) {
  ...
  inline void SetHttpStatusCode(int value) {
    m_httpStatusCodeHasBeenSet = true;
    m_httpStatusCode = value;
  }
  inline ApiResult& WithHttpStatusCode(int value) {
  ...
  void SetResponseBody(ResponseBodyT&& value) {
    ...
    m_responseBody = std::forward<ResponseBodyT>(value);
  }
  template <typename ResponseBodyT = Aws::Map<Aws::String, ContentBody>>
  ApiResult& WithResponseBody(ResponseBodyT&& value) {
    SetResponseBody(std::forward<ResponseBodyT>(value));
    return *this;
  }
  ...
  ApiResult& AddResponseBody(ResponseBodyKeyT&& key, ResponseBodyValueT&& value) {
    m_responseBodyHasBeenSet = true;
    m_responseBody.emplace(std::forward<ResponseBodyKeyT>(key), std::forward<ResponseBodyValueT>(value));
    return *this;
  }
  ///@}
