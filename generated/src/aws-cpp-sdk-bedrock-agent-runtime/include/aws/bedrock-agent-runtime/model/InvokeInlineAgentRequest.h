...
class InvokeInlineAgentRequest : public BedrockAgentRuntimeRequest {
 public:
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const InvokeInlineAgentHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline InvokeInlineAgentRequest& WithEventStreamHandler(const InvokeInlineAgentHandler& value) {
  ...
  inline InvokeInlineAgentRequest& WithEnableTrace(bool value) {
  ...
  void SetInlineSessionState(InlineSessionStateT&& value) {
    m_inlineSessionStateHasBeenSet = true;
    m_inlineSessionState = std::forward<InlineSessionStateT>(value);
  }
  template <typename InlineSessionStateT = InlineSessionState>
  InvokeInlineAgentRequest& WithInlineSessionState(InlineSessionStateT&& value) {
    SetInlineSessionState(std::forward<InlineSessionStateT>(value));
    return *this;
  }
  ///@}
  ...
  inline InvokeInlineAgentRequest& WithOrchestrationType(OrchestrationType value) {
