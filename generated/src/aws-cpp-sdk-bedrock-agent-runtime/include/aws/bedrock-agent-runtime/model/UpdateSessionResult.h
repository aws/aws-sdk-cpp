...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENTRUNTIME_API UpdateSessionResult() = default;
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    UpdateSessionResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedAtT = Aws::Utils::DateTime>
    UpdateSessionResult& WithLastUpdatedAt(LastUpdatedAtT&& value) { SetLastUpdatedAt(std::forward<LastUpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename SessionArnT = Aws::String>
    UpdateSessionResult& WithSessionArn(SessionArnT&& value) { SetSessionArn(std::forward<SessionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SessionIdT = Aws::String>
    UpdateSessionResult& WithSessionId(SessionIdT&& value) { SetSessionId(std::forward<SessionIdT>(value)); return *this;}
    ///@}
    ...
    inline UpdateSessionResult& WithSessionStatus(SessionStatus value) { SetSessionStatus(value); return *this;}
    ///@}
