...
class RoutingClassifierTrace {
 public:
  ...
  void SetInvocationInput(InvocationInputT&& value) {
    ...
    m_invocationInput = std::forward<InvocationInputT>(value);
  }
  template <typename InvocationInputT = InvocationInput>
  ...
  void SetModelInvocationInput(ModelInvocationInputT&& value) {
    ...
    m_modelInvocationInput = std::forward<ModelInvocationInputT>(value);
  }
  template <typename ModelInvocationInputT = ModelInvocationInput>
  RoutingClassifierTrace& WithModelInvocationInput(ModelInvocationInputT&& value) {
    SetModelInvocationInput(std::forward<ModelInvocationInputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelInvocationOutput(ModelInvocationOutputT&& value) {
    ...
    m_modelInvocationOutput = std::forward<ModelInvocationOutputT>(value);
  }
  template <typename ModelInvocationOutputT = RoutingClassifierModelInvocationOutput>
  RoutingClassifierTrace& WithModelInvocationOutput(ModelInvocationOutputT&& value) {
    SetModelInvocationOutput(std::forward<ModelInvocationOutputT>(value));
    return *this;
  }
  ///@}
