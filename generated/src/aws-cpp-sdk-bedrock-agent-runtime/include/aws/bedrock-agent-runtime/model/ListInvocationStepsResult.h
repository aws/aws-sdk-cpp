...
class ListInvocationStepsResult {
 public:
  ...
  void SetInvocationStepSummaries(InvocationStepSummariesT&& value) {
    m_invocationStepSummariesHasBeenSet = true;
    m_invocationStepSummaries = std::forward<InvocationStepSummariesT>(value);
  }
  template <typename InvocationStepSummariesT = Aws::Vector<InvocationStepSummary>>
  ListInvocationStepsResult& WithInvocationStepSummaries(InvocationStepSummariesT&& value) {
    SetInvocationStepSummaries(std::forward<InvocationStepSummariesT>(value));
    return *this;
  }
  template <typename InvocationStepSummariesT = InvocationStepSummary>
  ListInvocationStepsResult& AddInvocationStepSummaries(InvocationStepSummariesT&& value) {
    m_invocationStepSummariesHasBeenSet = true;
    m_invocationStepSummaries.emplace_back(std::forward<InvocationStepSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInvocationStepsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInvocationStepsResult& WithRequestId(RequestIdT&& value) {
