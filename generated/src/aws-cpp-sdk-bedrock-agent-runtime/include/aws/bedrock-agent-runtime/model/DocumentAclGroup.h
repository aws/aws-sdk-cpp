...
/**
 * <p>A group entry within a document access control list (ACL)
 * condition.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/DocumentAclGroup">AWS
 * API Reference</a></p>
 */
class DocumentAclGroup {
 public:
  ...
  inline DocumentAclGroup& WithType(DocumentAclMembershipType value) {
    SetType(value);
    return *this;
  }
  ///@}
