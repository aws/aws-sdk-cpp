...
/**
 * <p>Model configuration for a Bedrock reranking model used in managed
 * search.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/ManagedSearchBedrockRerankingModelConfiguration">AWS
 * API Reference</a></p>
 */
class ManagedSearchBedrockRerankingModelConfiguration {
 public:
  AWS_BEDROCKAGENTRUNTIME_API ManagedSearchBedrockRerankingModelConfiguration() = default;
  AWS_BEDROCKAGENTRUNTIME_API ManagedSearchBedrockRerankingModelConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENTRUNTIME_API ManagedSearchBedrockRerankingModelConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AdditionalModelRequestFieldsT = Aws::Map<Aws::String, Aws::Utils::Document>>
  ManagedSearchBedrockRerankingModelConfiguration& WithAdditionalModelRequestFields(AdditionalModelRequestFieldsT&& value) {
  ...
  ManagedSearchBedrockRerankingModelConfiguration& AddAdditionalModelRequestFields(AdditionalModelRequestFieldsKeyT&& key,
  ...
  template <typename ModelArnT = Aws::String>
  ManagedSearchBedrockRerankingModelConfiguration& WithModelArn(ModelArnT&& value) {
