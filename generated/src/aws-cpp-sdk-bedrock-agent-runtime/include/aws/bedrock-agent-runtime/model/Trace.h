...
class Trace {
 public:
  ...
  void SetCustomOrchestrationTrace(CustomOrchestrationTraceT&& value) {
    ...
    m_customOrchestrationTrace = std::forward<CustomOrchestrationTraceT>(value);
  }
  template <typename CustomOrchestrationTraceT = CustomOrchestrationTrace>
  Trace& WithCustomOrchestrationTrace(CustomOrchestrationTraceT&& value) {
    SetCustomOrchestrationTrace(std::forward<CustomOrchestrationTraceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailureTrace(FailureTraceT&& value) {
    ...
    m_failureTrace = std::forward<FailureTraceT>(value);
  }
  template <typename FailureTraceT = FailureTrace>
  Trace& WithFailureTrace(FailureTraceT&& value) {
    SetFailureTrace(std::forward<FailureTraceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGuardrailTrace(GuardrailTraceT&& value) {
    ...
    m_guardrailTrace = std::forward<GuardrailTraceT>(value);
  }
  template <typename GuardrailTraceT = GuardrailTrace>
  Trace& WithGuardrailTrace(GuardrailTraceT&& value) {
    SetGuardrailTrace(std::forward<GuardrailTraceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOrchestrationTrace(OrchestrationTraceT&& value) {
    ...
    m_orchestrationTrace = std::forward<OrchestrationTraceT>(value);
  }
  template <typename OrchestrationTraceT = OrchestrationTrace>
  Trace& WithOrchestrationTrace(OrchestrationTraceT&& value) {
    SetOrchestrationTrace(std::forward<OrchestrationTraceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostProcessingTrace(PostProcessingTraceT&& value) {
    ...
    m_postProcessingTrace = std::forward<PostProcessingTraceT>(value);
  }
  template <typename PostProcessingTraceT = PostProcessingTrace>
  Trace& WithPostProcessingTrace(PostProcessingTraceT&& value) {
    SetPostProcessingTrace(std::forward<PostProcessingTraceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreProcessingTrace(PreProcessingTraceT&& value) {
    ...
    m_preProcessingTrace = std::forward<PreProcessingTraceT>(value);
  }
  template <typename PreProcessingTraceT = PreProcessingTrace>
  Trace& WithPreProcessingTrace(PreProcessingTraceT&& value) {
    SetPreProcessingTrace(std::forward<PreProcessingTraceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRoutingClassifierTrace(RoutingClassifierTraceT&& value) {
    ...
    m_routingClassifierTrace = std::forward<RoutingClassifierTraceT>(value);
  }
  template <typename RoutingClassifierTraceT = RoutingClassifierTrace>
  Trace& WithRoutingClassifierTrace(RoutingClassifierTraceT&& value) {
    SetRoutingClassifierTrace(std::forward<RoutingClassifierTraceT>(value));
    return *this;
  }
  ///@}
 private:
