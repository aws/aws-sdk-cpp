...
class FlowTrace {
 public:
  ...
  void SetConditionNodeResultTrace(ConditionNodeResultTraceT&& value) {
    ...
    m_conditionNodeResultTrace = std::forward<ConditionNodeResultTraceT>(value);
  }
  template <typename ConditionNodeResultTraceT = FlowTraceConditionNodeResultEvent>
  FlowTrace& WithConditionNodeResultTrace(ConditionNodeResultTraceT&& value) {
    SetConditionNodeResultTrace(std::forward<ConditionNodeResultTraceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeActionTrace(NodeActionTraceT&& value) {
    ...
    m_nodeActionTrace = std::forward<NodeActionTraceT>(value);
  }
  template <typename NodeActionTraceT = FlowTraceNodeActionEvent>
  FlowTrace& WithNodeActionTrace(NodeActionTraceT&& value) {
    SetNodeActionTrace(std::forward<NodeActionTraceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeDependencyTrace(NodeDependencyTraceT&& value) {
    ...
    m_nodeDependencyTrace = std::forward<NodeDependencyTraceT>(value);
  }
  template <typename NodeDependencyTraceT = FlowTraceDependencyEvent>
  FlowTrace& WithNodeDependencyTrace(NodeDependencyTraceT&& value) {
    SetNodeDependencyTrace(std::forward<NodeDependencyTraceT>(value));
    return *this;
  }
  ///@}
