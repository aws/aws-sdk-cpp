...
class FunctionDefinition {
 public:
  ...
  inline void SetRequireConfirmation(RequireConfirmation value) {
    m_requireConfirmationHasBeenSet = true;
    m_requireConfirmation = value;
  }
  inline FunctionDefinition& WithRequireConfirmation(RequireConfirmation value) {
