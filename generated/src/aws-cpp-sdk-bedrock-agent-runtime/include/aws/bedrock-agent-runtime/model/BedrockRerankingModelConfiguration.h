...
class BedrockRerankingModelConfiguration {
 public:
  ...
  BedrockRerankingModelConfiguration& AddAdditionalModelRequestFields(AdditionalModelRequestFieldsKeyT&& key,
  ...
  template <typename ModelArnT = Aws::String>
  BedrockRerankingModelConfiguration& WithModelArn(ModelArnT&& value) {
