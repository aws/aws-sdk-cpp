...
class ListFlowExecutionsResult {
 public:
  ...
  void SetFlowExecutionSummaries(FlowExecutionSummariesT&& value) {
    m_flowExecutionSummariesHasBeenSet = true;
    m_flowExecutionSummaries = std::forward<FlowExecutionSummariesT>(value);
  }
  template <typename FlowExecutionSummariesT = Aws::Vector<FlowExecutionSummary>>
  ListFlowExecutionsResult& WithFlowExecutionSummaries(FlowExecutionSummariesT&& value) {
    SetFlowExecutionSummaries(std::forward<FlowExecutionSummariesT>(value));
    return *this;
  }
  template <typename FlowExecutionSummariesT = FlowExecutionSummary>
  ListFlowExecutionsResult& AddFlowExecutionSummaries(FlowExecutionSummariesT&& value) {
    m_flowExecutionSummariesHasBeenSet = true;
    m_flowExecutionSummaries.emplace_back(std::forward<FlowExecutionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFlowExecutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFlowExecutionsResult& WithRequestId(RequestIdT&& value) {
