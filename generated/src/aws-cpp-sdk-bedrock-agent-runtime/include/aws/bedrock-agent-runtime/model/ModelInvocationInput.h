...
class ModelInvocationInput {
 public:
  ...
  inline void SetParserMode(CreationMode value) {
    m_parserModeHasBeenSet = true;
    m_parserMode = value;
  }
  inline ModelInvocationInput& WithParserMode(CreationMode value) {
    SetParserMode(value);
    return *this;
  }
  ///@}
  ...
  inline ModelInvocationInput& WithPromptCreationMode(CreationMode value) {
  ...
  template <typename TextT = Aws::String>
  ModelInvocationInput& WithText(TextT&& value) {
  ...
  inline void SetType(PromptType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ModelInvocationInput& WithType(PromptType value) {
    SetType(value);
    return *this;
  }
  ///@}
