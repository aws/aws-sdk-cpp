...
namespace Model
{
  ...
  /**
   * <p>The SharePoint data source location.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/RetrievalResultSharePointLocation">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    template<typename UrlT = Aws::String>
    RetrievalResultSharePointLocation& WithUrl(UrlT&& value) { SetUrl(std::forward<UrlT>(value)); return *this;}
    ///@}
  private:
