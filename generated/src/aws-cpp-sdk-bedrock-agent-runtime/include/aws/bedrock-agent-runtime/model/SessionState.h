...
class SessionState {
 public:
  ...
  void SetConversationHistory(ConversationHistoryT&& value) {
    ...
    m_conversationHistory = std::forward<ConversationHistoryT>(value);
  }
  template <typename ConversationHistoryT = ConversationHistory>
  SessionState& WithConversationHistory(ConversationHistoryT&& value) {
    SetConversationHistory(std::forward<ConversationHistoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKnowledgeBaseConfigurations(KnowledgeBaseConfigurationsT&& value) {
    ...
    m_knowledgeBaseConfigurations = std::forward<KnowledgeBaseConfigurationsT>(value);
  }
  template <typename KnowledgeBaseConfigurationsT = Aws::Vector<KnowledgeBaseConfiguration>>
  SessionState& WithKnowledgeBaseConfigurations(KnowledgeBaseConfigurationsT&& value) {
    SetKnowledgeBaseConfigurations(std::forward<KnowledgeBaseConfigurationsT>(value));
    return *this;
  }
  ...
  SessionState& AddKnowledgeBaseConfigurations(KnowledgeBaseConfigurationsT&& value) {
    m_knowledgeBaseConfigurationsHasBeenSet = true;
    m_knowledgeBaseConfigurations.emplace_back(std::forward<KnowledgeBaseConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPromptSessionAttributes(PromptSessionAttributesT&& value) {
    ...
    m_promptSessionAttributes = std::forward<PromptSessionAttributesT>(value);
  }
  template <typename PromptSessionAttributesT = Aws::Map<Aws::String, Aws::String>>
  SessionState& WithPromptSessionAttributes(PromptSessionAttributesT&& value) {
    SetPromptSessionAttributes(std::forward<PromptSessionAttributesT>(value));
    return *this;
  }
  ...
  SessionState& AddPromptSessionAttributes(PromptSessionAttributesKeyT&& key, PromptSessionAttributesValueT&& value) {
    m_promptSessionAttributesHasBeenSet = true;
    m_promptSessionAttributes.emplace(std::forward<PromptSessionAttributesKeyT>(key), std::forward<PromptSessionAttributesValueT>(value));
    return *this;
  }
  ///@}
