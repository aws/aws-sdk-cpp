...
class NodeOutputNext {
 public:
  ...
  void SetInputFieldName(InputFieldNameT&& value) {
    m_inputFieldNameHasBeenSet = true;
    m_inputFieldName = std::forward<InputFieldNameT>(value);
  }
  template <typename InputFieldNameT = Aws::String>
  NodeOutputNext& WithInputFieldName(InputFieldNameT&& value) {
    SetInputFieldName(std::forward<InputFieldNameT>(value));
    return *this;
  }
  ///@}
