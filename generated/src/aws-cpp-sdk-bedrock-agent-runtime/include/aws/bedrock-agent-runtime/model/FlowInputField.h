...
namespace Model
{
  ...
  public:
    ...
    template<typename ContentT = FlowExecutionContent>
    FlowInputField& WithContent(ContentT&& value) { SetContent(std::forward<ContentT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    FlowInputField& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
