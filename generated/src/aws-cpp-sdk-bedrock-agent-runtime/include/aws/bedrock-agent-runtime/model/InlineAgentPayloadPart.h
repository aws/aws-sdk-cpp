 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/InlineAgentPayloadPart">AWS
 * API Reference</a></p>
 */
class InlineAgentPayloadPart {
 public:
  ...
  void SetAttribution(AttributionT&& value) {
    ...
    m_attribution = std::forward<AttributionT>(value);
  }
  template <typename AttributionT = Attribution>
  InlineAgentPayloadPart& WithAttribution(AttributionT&& value) {
    SetAttribution(std::forward<AttributionT>(value));
    return *this;
  }
  ///@}
 private:
