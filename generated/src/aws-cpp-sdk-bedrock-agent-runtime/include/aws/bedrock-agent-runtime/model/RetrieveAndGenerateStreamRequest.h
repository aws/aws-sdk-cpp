...
class RetrieveAndGenerateStreamRequest : public BedrockAgentRuntimeRequest {
 public:
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const RetrieveAndGenerateStreamHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline RetrieveAndGenerateStreamRequest& WithEventStreamHandler(const RetrieveAndGenerateStreamHandler& value) {
  ...
  template <typename InputT = RetrieveAndGenerateInput>
  RetrieveAndGenerateStreamRequest& WithInput(InputT&& value) {
