...
namespace Model
{
  ...
  public:
    ...
    template<typename NodeNameT = Aws::String>
    FlowTraceDependencyEvent& WithNodeName(NodeNameT&& value) { SetNodeName(std::forward<NodeNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TimestampT = Aws::Utils::DateTime>
    FlowTraceDependencyEvent& WithTimestamp(TimestampT&& value) { SetTimestamp(std::forward<TimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename TraceElementsT = TraceElements>
    FlowTraceDependencyEvent& WithTraceElements(TraceElementsT&& value) { SetTraceElements(std::forward<TraceElementsT>(value)); return *this;}
    ///@}
  private:
