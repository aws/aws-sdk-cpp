...
/**
 */
class CheckIngestedDocumentAclRequest : public BedrockAgentRuntimeRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "CheckIngestedDocumentAcl"; }
  ...
  ///@{
  /**
   * <p>The context object containing identity information for access control
   * filtering, including user ID and optional group memberships used to evaluate the
   * document access control list (ACL).</p>
   */
