...
class RetrievalResultLocation {
 public:
  ...
  void SetConfluenceLocation(ConfluenceLocationT&& value) {
    ...
    m_confluenceLocation = std::forward<ConfluenceLocationT>(value);
  }
  template <typename ConfluenceLocationT = RetrievalResultConfluenceLocation>
  ...
  void SetCustomDocumentLocation(CustomDocumentLocationT&& value) {
    ...
    m_customDocumentLocation = std::forward<CustomDocumentLocationT>(value);
  }
  template <typename CustomDocumentLocationT = RetrievalResultCustomDocumentLocation>
  RetrievalResultLocation& WithCustomDocumentLocation(CustomDocumentLocationT&& value) {
    SetCustomDocumentLocation(std::forward<CustomDocumentLocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKendraDocumentLocation(KendraDocumentLocationT&& value) {
    ...
    m_kendraDocumentLocation = std::forward<KendraDocumentLocationT>(value);
  }
  template <typename KendraDocumentLocationT = RetrievalResultKendraDocumentLocation>
  ...
  void SetSqlLocation(SqlLocationT&& value) {
    ...
    m_sqlLocation = std::forward<SqlLocationT>(value);
  }
  template <typename SqlLocationT = RetrievalResultSqlLocation>
  RetrievalResultLocation& WithSqlLocation(SqlLocationT&& value) {
    SetSqlLocation(std::forward<SqlLocationT>(value));
    return *this;
  }
  ///@}
 private:
