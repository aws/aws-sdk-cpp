...
class FlowTraceConditionNodeResultEvent {
 public:
  ...
  void SetSatisfiedConditions(SatisfiedConditionsT&& value) {
    ...
    m_satisfiedConditions = std::forward<SatisfiedConditionsT>(value);
  }
  template <typename SatisfiedConditionsT = Aws::Vector<FlowTraceCondition>>
  FlowTraceConditionNodeResultEvent& WithSatisfiedConditions(SatisfiedConditionsT&& value) {
    SetSatisfiedConditions(std::forward<SatisfiedConditionsT>(value));
    return *this;
  }
  ...
  FlowTraceConditionNodeResultEvent& AddSatisfiedConditions(SatisfiedConditionsT&& value) {
    m_satisfiedConditionsHasBeenSet = true;
    m_satisfiedConditions.emplace_back(std::forward<SatisfiedConditionsT>(value));
    return *this;
  }
  ///@}
