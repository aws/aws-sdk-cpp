...
class InvocationResultMember {
 public:
  ...
  void SetApiResult(ApiResultT&& value) {
    ...
    m_apiResult = std::forward<ApiResultT>(value);
  }
  template <typename ApiResultT = ApiResult>
  InvocationResultMember& WithApiResult(ApiResultT&& value) {
    SetApiResult(std::forward<ApiResultT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFunctionResult(FunctionResultT&& value) {
    ...
    m_functionResult = std::forward<FunctionResultT>(value);
  }
  template <typename FunctionResultT = FunctionResult>
  InvocationResultMember& WithFunctionResult(FunctionResultT&& value) {
    SetFunctionResult(std::forward<FunctionResultT>(value));
    return *this;
  }
  ///@}
 private:
