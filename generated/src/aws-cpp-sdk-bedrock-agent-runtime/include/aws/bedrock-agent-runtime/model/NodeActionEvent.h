...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime-2023-07-26/NodeActionEvent">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    template<typename NodeNameT = Aws::String>
    NodeActionEvent& WithNodeName(NodeNameT&& value) { SetNodeName(std::forward<NodeNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TimestampT = Aws::Utils::DateTime>
    NodeActionEvent& WithTimestamp(TimestampT&& value) { SetTimestamp(std::forward<TimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    NodeActionEvent& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ServiceNameT = Aws::String>
    NodeActionEvent& WithServiceName(ServiceNameT&& value) { SetServiceName(std::forward<ServiceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename OperationNameT = Aws::String>
    NodeActionEvent& WithOperationName(OperationNameT&& value) { SetOperationName(std::forward<OperationNameT>(value)); return *this;}
    ///@}
    ...
    template<typename OperationRequestT = Aws::Utils::Document>
    NodeActionEvent& WithOperationRequest(OperationRequestT&& value) { SetOperationRequest(std::forward<OperationRequestT>(value)); return *this;}
    ///@}
    ...
    template<typename OperationResponseT = Aws::Utils::Document>
    NodeActionEvent& WithOperationResponse(OperationResponseT&& value) { SetOperationResponse(std::forward<OperationResponseT>(value)); return *this;}
    ///@}
  private:
