...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENTRUNTIME_API BedrockRerankingConfiguration();
    ...
    inline void SetModelConfiguration(const BedrockRerankingModelConfiguration& value) { m_modelConfigurationHasBeenSet = true; m_modelConfiguration = value; }
    inline void SetModelConfiguration(BedrockRerankingModelConfiguration&& value) { m_modelConfigurationHasBeenSet = true; m_modelConfiguration = std::move(value); }
    inline BedrockRerankingConfiguration& WithModelConfiguration(const BedrockRerankingModelConfiguration& value) { SetModelConfiguration(value); return *this;}
    inline BedrockRerankingConfiguration& WithModelConfiguration(BedrockRerankingModelConfiguration&& value) { SetModelConfiguration(std::move(value)); return *this;}
    ///@}
