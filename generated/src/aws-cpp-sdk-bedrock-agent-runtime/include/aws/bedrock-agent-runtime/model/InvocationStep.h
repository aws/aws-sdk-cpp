...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENTRUNTIME_API InvocationStep() = default;
    ...
    template<typename InvocationIdT = Aws::String>
    InvocationStep& WithInvocationId(InvocationIdT&& value) { SetInvocationId(std::forward<InvocationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InvocationStepIdT = Aws::String>
    InvocationStep& WithInvocationStepId(InvocationStepIdT&& value) { SetInvocationStepId(std::forward<InvocationStepIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InvocationStepTimeT = Aws::Utils::DateTime>
    InvocationStep& WithInvocationStepTime(InvocationStepTimeT&& value) { SetInvocationStepTime(std::forward<InvocationStepTimeT>(value)); return *this;}
    ///@}
