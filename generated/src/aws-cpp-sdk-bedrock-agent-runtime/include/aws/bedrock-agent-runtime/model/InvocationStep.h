...
class InvocationStep {
 public:
  ...
  template <typename SessionIdT = Aws::String>
  InvocationStep& WithSessionId(SessionIdT&& value) {
  ...
  template <typename InvocationIdT = Aws::String>
  InvocationStep& WithInvocationId(InvocationIdT&& value) {
  ...
  template <typename InvocationStepIdT = Aws::String>
  InvocationStep& WithInvocationStepId(InvocationStepIdT&& value) {
  ...
  template <typename InvocationStepTimeT = Aws::Utils::DateTime>
  InvocationStep& WithInvocationStepTime(InvocationStepTimeT&& value) {
  ...
  template <typename PayloadT = InvocationStepPayload>
  InvocationStep& WithPayload(PayloadT&& value) {
