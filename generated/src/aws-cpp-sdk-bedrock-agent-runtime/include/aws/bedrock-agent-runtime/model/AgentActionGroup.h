...
class AgentActionGroup {
 public:
  ...
  inline AgentActionGroup& WithParentActionGroupSignature(ActionGroupSignature value) {
  ...
  AgentActionGroup& AddParentActionGroupSignatureParams(ParentActionGroupSignatureParamsKeyT&& key,
