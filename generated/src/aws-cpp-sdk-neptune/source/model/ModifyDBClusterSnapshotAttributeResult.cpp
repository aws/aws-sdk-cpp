...
ModifyDBClusterSnapshotAttributeResult& ModifyDBClusterSnapshotAttributeResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::Neptune::Model::ModifyDBClusterSnapshotAttributeResult",
