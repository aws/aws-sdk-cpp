...
ClusterPendingModifiedValues::ClusterPendingModifiedValues(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ClusterPendingModifiedValues::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
