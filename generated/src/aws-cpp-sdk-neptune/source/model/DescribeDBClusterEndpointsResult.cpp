...
DescribeDBClusterEndpointsResult& DescribeDBClusterEndpointsResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!dBClusterEndpointsNode.IsNull()) {
      ...
      m_dBClusterEndpointsHasBeenSet = !dBClusterEndpointsMember.IsNull();
      ...
      m_dBClusterEndpointsHasBeenSet = true;
    }
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::Neptune::Model::DescribeDBClusterEndpointsResult",
