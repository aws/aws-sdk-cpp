...
DBClusterOptionGroupStatus::DBClusterOptionGroupStatus(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DBClusterOptionGroupStatus::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                const char* locationValue) const {
  if (m_dBClusterOptionGroupNameHasBeenSet) {
    oStream << location << index << locationValue
            << ".DBClusterOptionGroupName=" << StringUtils::URLEncode(m_dBClusterOptionGroupName.c_str()) << "&";
  }
