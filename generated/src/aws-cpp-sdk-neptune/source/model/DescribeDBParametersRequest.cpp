...
Aws::String DescribeDBParametersRequest::SerializePayload() const {
  Aws::StringStream ss;
...
void DescribeDBParametersRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
