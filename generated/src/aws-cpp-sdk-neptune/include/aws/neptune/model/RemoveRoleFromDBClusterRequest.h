...
class RemoveRoleFromDBClusterRequest : public NeptuneRequest {
 ...
 public:
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  RemoveRoleFromDBClusterRequest& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  RemoveRoleFromDBClusterRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename FeatureNameT = Aws::String>
  RemoveRoleFromDBClusterRequest& WithFeatureName(FeatureNameT&& value) {
