...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNE_API RemoveRoleFromDBClusterRequest() = default;
  ...
  public:
    ...
    template<typename DBClusterIdentifierT = Aws::String>
    RemoveRoleFromDBClusterRequest& WithDBClusterIdentifier(DBClusterIdentifierT&& value) { SetDBClusterIdentifier(std::forward<DBClusterIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    RemoveRoleFromDBClusterRequest& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FeatureNameT = Aws::String>
    RemoveRoleFromDBClusterRequest& WithFeatureName(FeatureNameT&& value) { SetFeatureName(std::forward<FeatureNameT>(value)); return *this;}
    ///@}
  private:
