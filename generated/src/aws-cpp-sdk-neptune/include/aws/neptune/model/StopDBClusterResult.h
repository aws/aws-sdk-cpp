...
class StopDBClusterResult {
 public:
  AWS_NEPTUNE_API StopDBClusterResult() = default;
  ...
  template <typename DBClusterT = DBCluster>
  StopDBClusterResult& WithDBCluster(DBClusterT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StopDBClusterResult& WithResponseMetadata(ResponseMetadataT&& value) {
