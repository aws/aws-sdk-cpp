...
class CopyDBParameterGroupRequest : public NeptuneRequest {
 ...
 public:
  ...
  void SetSourceDBParameterGroupIdentifier(SourceDBParameterGroupIdentifierT&& value) {
    m_sourceDBParameterGroupIdentifierHasBeenSet = true;
    m_sourceDBParameterGroupIdentifier = std::forward<SourceDBParameterGroupIdentifierT>(value);
  }
  template <typename SourceDBParameterGroupIdentifierT = Aws::String>
  CopyDBParameterGroupRequest& WithSourceDBParameterGroupIdentifier(SourceDBParameterGroupIdentifierT&& value) {
    SetSourceDBParameterGroupIdentifier(std::forward<SourceDBParameterGroupIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetDBParameterGroupIdentifier(TargetDBParameterGroupIdentifierT&& value) {
    m_targetDBParameterGroupIdentifierHasBeenSet = true;
    m_targetDBParameterGroupIdentifier = std::forward<TargetDBParameterGroupIdentifierT>(value);
  }
  template <typename TargetDBParameterGroupIdentifierT = Aws::String>
  CopyDBParameterGroupRequest& WithTargetDBParameterGroupIdentifier(TargetDBParameterGroupIdentifierT&& value) {
    SetTargetDBParameterGroupIdentifier(std::forward<TargetDBParameterGroupIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetDBParameterGroupDescription(TargetDBParameterGroupDescriptionT&& value) {
    m_targetDBParameterGroupDescriptionHasBeenSet = true;
    m_targetDBParameterGroupDescription = std::forward<TargetDBParameterGroupDescriptionT>(value);
  }
  template <typename TargetDBParameterGroupDescriptionT = Aws::String>
  CopyDBParameterGroupRequest& WithTargetDBParameterGroupDescription(TargetDBParameterGroupDescriptionT&& value) {
    SetTargetDBParameterGroupDescription(std::forward<TargetDBParameterGroupDescriptionT>(value));
    return *this;
  }
  ///@}
