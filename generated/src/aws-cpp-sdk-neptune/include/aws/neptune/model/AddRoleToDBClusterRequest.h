...
class AddRoleToDBClusterRequest : public NeptuneRequest {
 public:
  AWS_NEPTUNE_API AddRoleToDBClusterRequest() = default;
 ...
 public:
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  AddRoleToDBClusterRequest& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  AddRoleToDBClusterRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename FeatureNameT = Aws::String>
  AddRoleToDBClusterRequest& WithFeatureName(FeatureNameT&& value) {
