...
/**
 */
class ModifyDBClusterEndpointRequest : public NeptuneRequest {
 public:
  AWS_NEPTUNE_API ModifyDBClusterEndpointRequest() = default;
 ...
 public:
  ...
  template <typename DBClusterEndpointIdentifierT = Aws::String>
  ModifyDBClusterEndpointRequest& WithDBClusterEndpointIdentifier(DBClusterEndpointIdentifierT&& value) {
  ...
  template <typename EndpointTypeT = Aws::String>
  ModifyDBClusterEndpointRequest& WithEndpointType(EndpointTypeT&& value) {
  ...
  template <typename StaticMembersT = Aws::Vector<Aws::String>>
  ModifyDBClusterEndpointRequest& WithStaticMembers(StaticMembersT&& value) {
    SetStaticMembers(std::forward<StaticMembersT>(value));
    return *this;
  }
  template <typename StaticMembersT = Aws::String>
  ModifyDBClusterEndpointRequest& AddStaticMembers(StaticMembersT&& value) {
    m_staticMembersHasBeenSet = true;
  ...
  template <typename ExcludedMembersT = Aws::Vector<Aws::String>>
  ModifyDBClusterEndpointRequest& WithExcludedMembers(ExcludedMembersT&& value) {
    SetExcludedMembers(std::forward<ExcludedMembersT>(value));
    return *this;
  }
  template <typename ExcludedMembersT = Aws::String>
  ModifyDBClusterEndpointRequest& AddExcludedMembers(ExcludedMembersT&& value) {
    m_excludedMembersHasBeenSet = true;
