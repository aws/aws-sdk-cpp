...
class RestoreDBClusterFromSnapshotRequest : public NeptuneRequest {
 ...
 public:
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  RestoreDBClusterFromSnapshotRequest& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  template <typename SnapshotIdentifierT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithSnapshotIdentifier(SnapshotIdentifierT&& value) {
  ...
  template <typename EngineT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithEngine(EngineT&& value) {
  ...
  template <typename EngineVersionT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithEngineVersion(EngineVersionT&& value) {
  ...
  inline RestoreDBClusterFromSnapshotRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename DBSubnetGroupNameT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithDBSubnetGroupName(DBSubnetGroupNameT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename OptionGroupNameT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithOptionGroupName(OptionGroupNameT&& value) {
  ...
  template <typename VpcSecurityGroupIdsT = Aws::Vector<Aws::String>>
  RestoreDBClusterFromSnapshotRequest& WithVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    SetVpcSecurityGroupIds(std::forward<VpcSecurityGroupIdsT>(value));
    return *this;
  }
  template <typename VpcSecurityGroupIdsT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& AddVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    m_vpcSecurityGroupIdsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  RestoreDBClusterFromSnapshotRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  RestoreDBClusterFromSnapshotRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename KmsKeyIdT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  inline RestoreDBClusterFromSnapshotRequest& WithEnableIAMDatabaseAuthentication(bool value) {
  ...
  template <typename EnableCloudwatchLogsExportsT = Aws::Vector<Aws::String>>
  RestoreDBClusterFromSnapshotRequest& WithEnableCloudwatchLogsExports(EnableCloudwatchLogsExportsT&& value) {
  ...
  RestoreDBClusterFromSnapshotRequest& AddEnableCloudwatchLogsExports(EnableCloudwatchLogsExportsT&& value) {
    m_enableCloudwatchLogsExportsHasBeenSet = true;
  ...
  template <typename DBClusterParameterGroupNameT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithDBClusterParameterGroupName(DBClusterParameterGroupNameT&& value) {
  ...
  inline RestoreDBClusterFromSnapshotRequest& WithDeletionProtection(bool value) {
  ...
  template <typename ServerlessV2ScalingConfigurationT = ServerlessV2ScalingConfiguration>
  RestoreDBClusterFromSnapshotRequest& WithServerlessV2ScalingConfiguration(ServerlessV2ScalingConfigurationT&& value) {
  ...
  template <typename StorageTypeT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithStorageType(StorageTypeT&& value) {
