...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNE_API PromoteReadReplicaDBClusterResult() = default;
    ...
    template<typename DBClusterT = DBCluster>
    PromoteReadReplicaDBClusterResult& WithDBCluster(DBClusterT&& value) { SetDBCluster(std::forward<DBClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    PromoteReadReplicaDBClusterResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
