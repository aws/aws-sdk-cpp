...
class Filter {
 public:
  AWS_NEPTUNE_API Filter() = default;
  AWS_NEPTUNE_API Filter(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_NEPTUNE_API Filter& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
