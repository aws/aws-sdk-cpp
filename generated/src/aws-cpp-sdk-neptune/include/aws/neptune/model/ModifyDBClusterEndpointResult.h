...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNE_API ModifyDBClusterEndpointResult() = default;
    ...
    template<typename DBClusterEndpointIdentifierT = Aws::String>
    ModifyDBClusterEndpointResult& WithDBClusterEndpointIdentifier(DBClusterEndpointIdentifierT&& value) { SetDBClusterEndpointIdentifier(std::forward<DBClusterEndpointIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename DBClusterIdentifierT = Aws::String>
    ModifyDBClusterEndpointResult& WithDBClusterIdentifier(DBClusterIdentifierT&& value) { SetDBClusterIdentifier(std::forward<DBClusterIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename DBClusterEndpointResourceIdentifierT = Aws::String>
    ModifyDBClusterEndpointResult& WithDBClusterEndpointResourceIdentifier(DBClusterEndpointResourceIdentifierT&& value) { SetDBClusterEndpointResourceIdentifier(std::forward<DBClusterEndpointResourceIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename EndpointT = Aws::String>
    ModifyDBClusterEndpointResult& WithEndpoint(EndpointT&& value) { SetEndpoint(std::forward<EndpointT>(value)); return *this;}
    ///@}
    ...
    template<typename StatusT = Aws::String>
    ModifyDBClusterEndpointResult& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename EndpointTypeT = Aws::String>
    ModifyDBClusterEndpointResult& WithEndpointType(EndpointTypeT&& value) { SetEndpointType(std::forward<EndpointTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomEndpointTypeT = Aws::String>
    ModifyDBClusterEndpointResult& WithCustomEndpointType(CustomEndpointTypeT&& value) { SetCustomEndpointType(std::forward<CustomEndpointTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename StaticMembersT = Aws::Vector<Aws::String>>
    ModifyDBClusterEndpointResult& WithStaticMembers(StaticMembersT&& value) { SetStaticMembers(std::forward<StaticMembersT>(value)); return *this;}
    template<typename StaticMembersT = Aws::String>
    ModifyDBClusterEndpointResult& AddStaticMembers(StaticMembersT&& value) { m_staticMembersHasBeenSet = true; m_staticMembers.emplace_back(std::forward<StaticMembersT>(value)); return *this; }
    ///@}
    ...
    template<typename ExcludedMembersT = Aws::Vector<Aws::String>>
    ModifyDBClusterEndpointResult& WithExcludedMembers(ExcludedMembersT&& value) { SetExcludedMembers(std::forward<ExcludedMembersT>(value)); return *this;}
    template<typename ExcludedMembersT = Aws::String>
    ModifyDBClusterEndpointResult& AddExcludedMembers(ExcludedMembersT&& value) { m_excludedMembersHasBeenSet = true; m_excludedMembers.emplace_back(std::forward<ExcludedMembersT>(value)); return *this; }
    ///@}
    ...
    template<typename DBClusterEndpointArnT = Aws::String>
    ModifyDBClusterEndpointResult& WithDBClusterEndpointArn(DBClusterEndpointArnT&& value) { SetDBClusterEndpointArn(std::forward<DBClusterEndpointArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyDBClusterEndpointResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
