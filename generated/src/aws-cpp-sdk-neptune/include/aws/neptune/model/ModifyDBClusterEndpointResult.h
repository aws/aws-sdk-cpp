...
class ModifyDBClusterEndpointResult {
 public:
  ...
  template <typename DBClusterEndpointIdentifierT = Aws::String>
  ModifyDBClusterEndpointResult& WithDBClusterEndpointIdentifier(DBClusterEndpointIdentifierT&& value) {
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  ModifyDBClusterEndpointResult& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  template <typename DBClusterEndpointResourceIdentifierT = Aws::String>
  ModifyDBClusterEndpointResult& WithDBClusterEndpointResourceIdentifier(DBClusterEndpointResourceIdentifierT&& value) {
  ...
  template <typename EndpointT = Aws::String>
  ModifyDBClusterEndpointResult& WithEndpoint(EndpointT&& value) {
  ...
  template <typename StatusT = Aws::String>
  ModifyDBClusterEndpointResult& WithStatus(StatusT&& value) {
  ...
  template <typename EndpointTypeT = Aws::String>
  ModifyDBClusterEndpointResult& WithEndpointType(EndpointTypeT&& value) {
  ...
  template <typename CustomEndpointTypeT = Aws::String>
  ModifyDBClusterEndpointResult& WithCustomEndpointType(CustomEndpointTypeT&& value) {
  ...
  template <typename StaticMembersT = Aws::Vector<Aws::String>>
  ModifyDBClusterEndpointResult& WithStaticMembers(StaticMembersT&& value) {
    SetStaticMembers(std::forward<StaticMembersT>(value));
    return *this;
  }
  template <typename StaticMembersT = Aws::String>
  ModifyDBClusterEndpointResult& AddStaticMembers(StaticMembersT&& value) {
    m_staticMembersHasBeenSet = true;
  ...
  template <typename ExcludedMembersT = Aws::Vector<Aws::String>>
  ModifyDBClusterEndpointResult& WithExcludedMembers(ExcludedMembersT&& value) {
    SetExcludedMembers(std::forward<ExcludedMembersT>(value));
    return *this;
  }
  template <typename ExcludedMembersT = Aws::String>
  ModifyDBClusterEndpointResult& AddExcludedMembers(ExcludedMembersT&& value) {
    m_excludedMembersHasBeenSet = true;
  ...
  template <typename DBClusterEndpointArnT = Aws::String>
  ModifyDBClusterEndpointResult& WithDBClusterEndpointArn(DBClusterEndpointArnT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyDBClusterEndpointResult& WithResponseMetadata(ResponseMetadataT&& value) {
