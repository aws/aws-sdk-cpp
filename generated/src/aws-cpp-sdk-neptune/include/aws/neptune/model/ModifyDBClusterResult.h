...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNE_API ModifyDBClusterResult() = default;
    AWS_NEPTUNE_API ModifyDBClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    AWS_NEPTUNE_API ModifyDBClusterResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
