...
class ModifyDBClusterParameterGroupRequest : public NeptuneRequest {
 public:
  AWS_NEPTUNE_API ModifyDBClusterParameterGroupRequest() = default;
 ...
 public:
  ...
  template <typename DBClusterParameterGroupNameT = Aws::String>
  ModifyDBClusterParameterGroupRequest& WithDBClusterParameterGroupName(DBClusterParameterGroupNameT&& value) {
  ...
  template <typename ParametersT = Aws::Vector<Parameter>>
  ModifyDBClusterParameterGroupRequest& WithParameters(ParametersT&& value) {
    SetParameters(std::forward<ParametersT>(value));
    return *this;
  }
  template <typename ParametersT = Parameter>
  ModifyDBClusterParameterGroupRequest& AddParameters(ParametersT&& value) {
    m_parametersHasBeenSet = true;
