...
class DescribeOrderableDBInstanceOptionsRequest : public NeptuneRequest {
 public:
  AWS_NEPTUNE_API DescribeOrderableDBInstanceOptionsRequest() = default;
 ...
 public:
  ...
  template <typename EngineT = Aws::String>
  DescribeOrderableDBInstanceOptionsRequest& WithEngine(EngineT&& value) {
  ...
  template <typename EngineVersionT = Aws::String>
  DescribeOrderableDBInstanceOptionsRequest& WithEngineVersion(EngineVersionT&& value) {
  ...
  template <typename DBInstanceClassT = Aws::String>
  DescribeOrderableDBInstanceOptionsRequest& WithDBInstanceClass(DBInstanceClassT&& value) {
  ...
  template <typename LicenseModelT = Aws::String>
  DescribeOrderableDBInstanceOptionsRequest& WithLicenseModel(LicenseModelT&& value) {
  ...
  inline void SetVpc(bool value) {
    m_vpcHasBeenSet = true;
    m_vpc = value;
  }
  inline DescribeOrderableDBInstanceOptionsRequest& WithVpc(bool value) {
    SetVpc(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeOrderableDBInstanceOptionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeOrderableDBInstanceOptionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeOrderableDBInstanceOptionsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeOrderableDBInstanceOptionsRequest& WithMarker(MarkerT&& value) {
