...
class DBInstanceStatusInfo {
 public:
  ...
  template <typename StatusTypeT = Aws::String>
  DBInstanceStatusInfo& WithStatusType(StatusTypeT&& value) {
  ...
  inline DBInstanceStatusInfo& WithNormal(bool value) {
    SetNormal(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusT = Aws::String>
  DBInstanceStatusInfo& WithStatus(StatusT&& value) {
  ...
  template <typename MessageT = Aws::String>
  DBInstanceStatusInfo& WithMessage(MessageT&& value) {
