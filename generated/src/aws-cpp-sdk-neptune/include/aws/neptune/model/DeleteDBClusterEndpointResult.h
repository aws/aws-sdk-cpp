...
class DeleteDBClusterEndpointResult {
 public:
  ...
  template <typename DBClusterEndpointIdentifierT = Aws::String>
  DeleteDBClusterEndpointResult& WithDBClusterEndpointIdentifier(DBClusterEndpointIdentifierT&& value) {
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  DeleteDBClusterEndpointResult& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  void SetDBClusterEndpointResourceIdentifier(DBClusterEndpointResourceIdentifierT&& value) {
    ...
    m_dBClusterEndpointResourceIdentifier = std::forward<DBClusterEndpointResourceIdentifierT>(value);
  }
  template <typename DBClusterEndpointResourceIdentifierT = Aws::String>
  DeleteDBClusterEndpointResult& WithDBClusterEndpointResourceIdentifier(DBClusterEndpointResourceIdentifierT&& value) {
    SetDBClusterEndpointResourceIdentifier(std::forward<DBClusterEndpointResourceIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EndpointT = Aws::String>
  DeleteDBClusterEndpointResult& WithEndpoint(EndpointT&& value) {
  ...
  template <typename StatusT = Aws::String>
  DeleteDBClusterEndpointResult& WithStatus(StatusT&& value) {
  ...
  template <typename EndpointTypeT = Aws::String>
  DeleteDBClusterEndpointResult& WithEndpointType(EndpointTypeT&& value) {
  ...
  void SetCustomEndpointType(CustomEndpointTypeT&& value) {
    ...
    m_customEndpointType = std::forward<CustomEndpointTypeT>(value);
  }
  template <typename CustomEndpointTypeT = Aws::String>
  DeleteDBClusterEndpointResult& WithCustomEndpointType(CustomEndpointTypeT&& value) {
    SetCustomEndpointType(std::forward<CustomEndpointTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStaticMembers(StaticMembersT&& value) {
    ...
    m_staticMembers = std::forward<StaticMembersT>(value);
  }
  template <typename StaticMembersT = Aws::Vector<Aws::String>>
  DeleteDBClusterEndpointResult& WithStaticMembers(StaticMembersT&& value) {
    SetStaticMembers(std::forward<StaticMembersT>(value));
    return *this;
  }
  template <typename StaticMembersT = Aws::String>
  DeleteDBClusterEndpointResult& AddStaticMembers(StaticMembersT&& value) {
    m_staticMembersHasBeenSet = true;
    m_staticMembers.emplace_back(std::forward<StaticMembersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludedMembers(ExcludedMembersT&& value) {
    ...
    m_excludedMembers = std::forward<ExcludedMembersT>(value);
  }
  template <typename ExcludedMembersT = Aws::Vector<Aws::String>>
  DeleteDBClusterEndpointResult& WithExcludedMembers(ExcludedMembersT&& value) {
    SetExcludedMembers(std::forward<ExcludedMembersT>(value));
    return *this;
  }
  template <typename ExcludedMembersT = Aws::String>
  DeleteDBClusterEndpointResult& AddExcludedMembers(ExcludedMembersT&& value) {
    m_excludedMembersHasBeenSet = true;
    m_excludedMembers.emplace_back(std::forward<ExcludedMembersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDBClusterEndpointArn(DBClusterEndpointArnT&& value) {
    ...
    m_dBClusterEndpointArn = std::forward<DBClusterEndpointArnT>(value);
  }
  template <typename DBClusterEndpointArnT = Aws::String>
  DeleteDBClusterEndpointResult& WithDBClusterEndpointArn(DBClusterEndpointArnT&& value) {
    SetDBClusterEndpointArn(std::forward<DBClusterEndpointArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteDBClusterEndpointResult& WithResponseMetadata(ResponseMetadataT&& value) {
