...
class CopyDBClusterParameterGroupRequest : public NeptuneRequest {
 ...
 public:
   ...
   * <li> <p>Must specify a valid DB cluster parameter group.</p> </li> <li> <p>Must
   * specify a valid DB cluster parameter group identifier, for example
   * <code>my-db-cluster-param-group</code>, or a valid ARN.</p> </li> <li> <p>The
   * source DB cluster parameter group must be in the same Amazon Region as the copy.
   * Neptune does not support cross-Region copying of parameter groups.</p> </li>
   * </ul>
   */
  ...
  void SetSourceDBClusterParameterGroupIdentifier(SourceDBClusterParameterGroupIdentifierT&& value) {
    m_sourceDBClusterParameterGroupIdentifierHasBeenSet = true;
    m_sourceDBClusterParameterGroupIdentifier = std::forward<SourceDBClusterParameterGroupIdentifierT>(value);
  }
  template <typename SourceDBClusterParameterGroupIdentifierT = Aws::String>
  CopyDBClusterParameterGroupRequest& WithSourceDBClusterParameterGroupIdentifier(SourceDBClusterParameterGroupIdentifierT&& value) {
    SetSourceDBClusterParameterGroupIdentifier(std::forward<SourceDBClusterParameterGroupIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetDBClusterParameterGroupIdentifier(TargetDBClusterParameterGroupIdentifierT&& value) {
    m_targetDBClusterParameterGroupIdentifierHasBeenSet = true;
    m_targetDBClusterParameterGroupIdentifier = std::forward<TargetDBClusterParameterGroupIdentifierT>(value);
  }
  template <typename TargetDBClusterParameterGroupIdentifierT = Aws::String>
  CopyDBClusterParameterGroupRequest& WithTargetDBClusterParameterGroupIdentifier(TargetDBClusterParameterGroupIdentifierT&& value) {
    SetTargetDBClusterParameterGroupIdentifier(std::forward<TargetDBClusterParameterGroupIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetDBClusterParameterGroupDescription(TargetDBClusterParameterGroupDescriptionT&& value) {
    m_targetDBClusterParameterGroupDescriptionHasBeenSet = true;
    m_targetDBClusterParameterGroupDescription = std::forward<TargetDBClusterParameterGroupDescriptionT>(value);
  }
  template <typename TargetDBClusterParameterGroupDescriptionT = Aws::String>
  CopyDBClusterParameterGroupRequest& WithTargetDBClusterParameterGroupDescription(TargetDBClusterParameterGroupDescriptionT&& value) {
    SetTargetDBClusterParameterGroupDescription(std::forward<TargetDBClusterParameterGroupDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CopyDBClusterParameterGroupRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CopyDBClusterParameterGroupRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
