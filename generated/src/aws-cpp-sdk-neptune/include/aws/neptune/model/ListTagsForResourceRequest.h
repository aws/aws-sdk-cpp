...
class ListTagsForResourceRequest : public NeptuneRequest {
 public:
  AWS_NEPTUNE_API ListTagsForResourceRequest() = default;
 ...
 public:
  ...
  template <typename ResourceNameT = Aws::String>
  ListTagsForResourceRequest& WithResourceName(ResourceNameT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListTagsForResourceRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListTagsForResourceRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
