...
class ExportSourceNetworkCfnTemplateResult {
 public:
  ...
  void SetS3DestinationUrl(S3DestinationUrlT&& value) {
    m_s3DestinationUrlHasBeenSet = true;
    m_s3DestinationUrl = std::forward<S3DestinationUrlT>(value);
  }
  template <typename S3DestinationUrlT = Aws::String>
  ExportSourceNetworkCfnTemplateResult& WithS3DestinationUrl(S3DestinationUrlT&& value) {
    SetS3DestinationUrl(std::forward<S3DestinationUrlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ExportSourceNetworkCfnTemplateResult& WithRequestId(RequestIdT&& value) {
