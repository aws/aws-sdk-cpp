...
class PutLaunchActionRequest : public DrsRequest {
 public:
  ...
  inline PutLaunchActionRequest& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  inline PutLaunchActionRequest& WithCategory(LaunchActionCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  inline PutLaunchActionRequest& WithOptional(bool value) {
    SetOptional(value);
    return *this;
  }
  ///@}
  ...
  inline PutLaunchActionRequest& WithOrder(int value) {
    SetOrder(value);
    return *this;
  }
  ///@}
