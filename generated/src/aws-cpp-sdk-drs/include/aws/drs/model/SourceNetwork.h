...
class SourceNetwork {
 public:
  ...
  inline SourceNetwork& WithReplicationStatus(ReplicationStatus value) {
  ...
  void SetReplicationStatusDetails(ReplicationStatusDetailsT&& value) {
    ...
    m_replicationStatusDetails = std::forward<ReplicationStatusDetailsT>(value);
  }
  template <typename ReplicationStatusDetailsT = Aws::String>
  SourceNetwork& WithReplicationStatusDetails(ReplicationStatusDetailsT&& value) {
    SetReplicationStatusDetails(std::forward<ReplicationStatusDetailsT>(value));
    return *this;
  }
  ///@}
