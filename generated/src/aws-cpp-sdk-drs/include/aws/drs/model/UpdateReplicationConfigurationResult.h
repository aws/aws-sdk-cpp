...
class UpdateReplicationConfigurationResult {
 public:
  ...
  inline UpdateReplicationConfigurationResult& WithAssociateDefaultSecurityGroup(bool value) {
  ...
  inline UpdateReplicationConfigurationResult& WithUseDedicatedReplicationServer(bool value) {
  ...
  inline UpdateReplicationConfigurationResult& WithDefaultLargeStagingDiskType(ReplicationConfigurationDefaultLargeStagingDiskType value) {
  ...
  inline UpdateReplicationConfigurationResult& WithEbsEncryption(ReplicationConfigurationEbsEncryption value) {
  ...
  inline UpdateReplicationConfigurationResult& WithBandwidthThrottling(long long value) {
  ...
  inline UpdateReplicationConfigurationResult& WithDataPlaneRouting(ReplicationConfigurationDataPlaneRouting value) {
  ...
  inline UpdateReplicationConfigurationResult& WithCreatePublicIP(bool value) {
  ...
  template <typename PitPolicyT = Aws::Vector<PITPolicyRule>>
  UpdateReplicationConfigurationResult& WithPitPolicy(PitPolicyT&& value) {
    SetPitPolicy(std::forward<PitPolicyT>(value));
    return *this;
  }
  template <typename PitPolicyT = PITPolicyRule>
  UpdateReplicationConfigurationResult& AddPitPolicy(PitPolicyT&& value) {
    m_pitPolicyHasBeenSet = true;
  ...
  inline UpdateReplicationConfigurationResult& WithAutoReplicateNewDisks(bool value) {
  ...
  inline UpdateReplicationConfigurationResult& WithInternetProtocol(InternetProtocol value) {
