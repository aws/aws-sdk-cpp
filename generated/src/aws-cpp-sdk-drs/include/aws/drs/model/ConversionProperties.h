...
class ConversionProperties {
 public:
  ...
  void SetRootVolumeName(RootVolumeNameT&& value) {
    ...
    m_rootVolumeName = std::forward<RootVolumeNameT>(value);
  }
  template <typename RootVolumeNameT = Aws::String>
  ConversionProperties& WithRootVolumeName(RootVolumeNameT&& value) {
    SetRootVolumeName(std::forward<RootVolumeNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVolumeToProductCodes(VolumeToProductCodesT&& value) {
    ...
    m_volumeToProductCodes = std::forward<VolumeToProductCodesT>(value);
  }
  template <typename VolumeToProductCodesT = Aws::Map<Aws::String, Aws::Vector<ProductCode>>>
  ConversionProperties& WithVolumeToProductCodes(VolumeToProductCodesT&& value) {
    SetVolumeToProductCodes(std::forward<VolumeToProductCodesT>(value));
    return *this;
  }
  ...
  ConversionProperties& AddVolumeToProductCodes(VolumeToProductCodesKeyT&& key, VolumeToProductCodesValueT&& value) {
    m_volumeToProductCodesHasBeenSet = true;
    m_volumeToProductCodes.emplace(std::forward<VolumeToProductCodesKeyT>(key), std::forward<VolumeToProductCodesValueT>(value));
    return *this;
  }
  ///@}
