...
class RecoveryInstanceDataReplicationInfo {
 public:
  ...
  void SetStagingAvailabilityZone(StagingAvailabilityZoneT&& value) {
    ...
    m_stagingAvailabilityZone = std::forward<StagingAvailabilityZoneT>(value);
  }
  template <typename StagingAvailabilityZoneT = Aws::String>
  RecoveryInstanceDataReplicationInfo& WithStagingAvailabilityZone(StagingAvailabilityZoneT&& value) {
    SetStagingAvailabilityZone(std::forward<StagingAvailabilityZoneT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStagingOutpostArn(StagingOutpostArnT&& value) {
    ...
    m_stagingOutpostArn = std::forward<StagingOutpostArnT>(value);
  }
  template <typename StagingOutpostArnT = Aws::String>
  RecoveryInstanceDataReplicationInfo& WithStagingOutpostArn(StagingOutpostArnT&& value) {
    SetStagingOutpostArn(std::forward<StagingOutpostArnT>(value));
    return *this;
  }
  ///@}
 private:
