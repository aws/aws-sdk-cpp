...
class DescribeLaunchConfigurationTemplatesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<LaunchConfigurationTemplate>>
  DescribeLaunchConfigurationTemplatesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = LaunchConfigurationTemplate>
  DescribeLaunchConfigurationTemplatesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeLaunchConfigurationTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeLaunchConfigurationTemplatesResult& WithRequestId(RequestIdT&& value) {
