...
namespace Model
{
  ...
  {
  public:
    AWS_DRS_API DescribeLaunchConfigurationTemplatesResult();
    ...
    inline DescribeLaunchConfigurationTemplatesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribeLaunchConfigurationTemplatesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribeLaunchConfigurationTemplatesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
