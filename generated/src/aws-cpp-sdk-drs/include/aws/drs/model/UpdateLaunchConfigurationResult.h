...
namespace Model
{
  ...
  public:
    ...
    template<typename Ec2LaunchTemplateIDT = Aws::String>
    UpdateLaunchConfigurationResult& WithEc2LaunchTemplateID(Ec2LaunchTemplateIDT&& value) { SetEc2LaunchTemplateID(std::forward<Ec2LaunchTemplateIDT>(value)); return *this;}
    ///@}
    ...
    inline UpdateLaunchConfigurationResult& WithLaunchDisposition(LaunchDisposition value) { SetLaunchDisposition(value); return *this;}
    ///@}
    ...
    template<typename LaunchIntoInstancePropertiesT = LaunchIntoInstanceProperties>
    UpdateLaunchConfigurationResult& WithLaunchIntoInstanceProperties(LaunchIntoInstancePropertiesT&& value) { SetLaunchIntoInstanceProperties(std::forward<LaunchIntoInstancePropertiesT>(value)); return *this;}
    ///@}
    ...
    template<typename LicensingT = Licensing>
    UpdateLaunchConfigurationResult& WithLicensing(LicensingT&& value) { SetLicensing(std::forward<LicensingT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateLaunchConfigurationResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceServerIDT = Aws::String>
    UpdateLaunchConfigurationResult& WithSourceServerID(SourceServerIDT&& value) { SetSourceServerID(std::forward<SourceServerIDT>(value)); return *this;}
    ///@}
    ...
    inline UpdateLaunchConfigurationResult& WithTargetInstanceTypeRightSizingMethod(TargetInstanceTypeRightSizingMethod value) { SetTargetInstanceTypeRightSizingMethod(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLaunchConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
