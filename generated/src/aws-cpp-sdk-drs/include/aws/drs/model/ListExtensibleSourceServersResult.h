...
class ListExtensibleSourceServersResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<StagingSourceServer>>
  ListExtensibleSourceServersResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = StagingSourceServer>
  ListExtensibleSourceServersResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListExtensibleSourceServersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExtensibleSourceServersResult& WithRequestId(RequestIdT&& value) {
