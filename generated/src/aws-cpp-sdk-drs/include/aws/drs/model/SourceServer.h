...
namespace Model
{
  ...
  public:
    ...
    template<typename AgentVersionT = Aws::String>
    SourceServer& WithAgentVersion(AgentVersionT&& value) { SetAgentVersion(std::forward<AgentVersionT>(value)); return *this;}
    ///@}
    ...
    inline SourceServer& WithLastLaunchResult(LastLaunchResult value) { SetLastLaunchResult(value); return *this;}
    ///@}
    ...
    template<typename RecoveryInstanceIdT = Aws::String>
    SourceServer& WithRecoveryInstanceId(RecoveryInstanceIdT&& value) { SetRecoveryInstanceId(std::forward<RecoveryInstanceIdT>(value)); return *this;}
    ///@}
    ...
    inline SourceServer& WithReplicationDirection(ReplicationDirection value) { SetReplicationDirection(value); return *this;}
    ///@}
    ...
    template<typename ReversedDirectionSourceServerArnT = Aws::String>
    SourceServer& WithReversedDirectionSourceServerArn(ReversedDirectionSourceServerArnT&& value) { SetReversedDirectionSourceServerArn(std::forward<ReversedDirectionSourceServerArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceCloudPropertiesT = SourceCloudProperties>
    SourceServer& WithSourceCloudProperties(SourceCloudPropertiesT&& value) { SetSourceCloudProperties(std::forward<SourceCloudPropertiesT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceNetworkIDT = Aws::String>
    SourceServer& WithSourceNetworkID(SourceNetworkIDT&& value) { SetSourceNetworkID(std::forward<SourceNetworkIDT>(value)); return *this;}
    ///@}
    ...
    template<typename StagingAreaT = StagingArea>
    SourceServer& WithStagingArea(StagingAreaT&& value) { SetStagingArea(std::forward<StagingAreaT>(value)); return *this;}
    ///@}
