...
class DescribeSourceServersResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<SourceServer>>
  DescribeSourceServersResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = SourceServer>
  DescribeSourceServersResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSourceServersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSourceServersResult& WithRequestId(RequestIdT&& value) {
