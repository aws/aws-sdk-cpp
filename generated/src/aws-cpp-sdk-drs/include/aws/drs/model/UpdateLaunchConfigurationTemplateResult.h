...
class UpdateLaunchConfigurationTemplateResult {
 public:
  ...
  void SetLaunchConfigurationTemplate(LaunchConfigurationTemplateT&& value) {
    m_launchConfigurationTemplateHasBeenSet = true;
    m_launchConfigurationTemplate = std::forward<LaunchConfigurationTemplateT>(value);
  }
  template <typename LaunchConfigurationTemplateT = LaunchConfigurationTemplate>
  UpdateLaunchConfigurationTemplateResult& WithLaunchConfigurationTemplate(LaunchConfigurationTemplateT&& value) {
    SetLaunchConfigurationTemplate(std::forward<LaunchConfigurationTemplateT>(value));
    return *this;
  }
  ///@}
