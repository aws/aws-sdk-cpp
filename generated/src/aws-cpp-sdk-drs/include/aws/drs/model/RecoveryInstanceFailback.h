...
class RecoveryInstanceFailback {
 public:
  ...
  void SetAgentLastSeenByServiceDateTime(AgentLastSeenByServiceDateTimeT&& value) {
    ...
    m_agentLastSeenByServiceDateTime = std::forward<AgentLastSeenByServiceDateTimeT>(value);
  }
  template <typename AgentLastSeenByServiceDateTimeT = Aws::String>
  RecoveryInstanceFailback& WithAgentLastSeenByServiceDateTime(AgentLastSeenByServiceDateTimeT&& value) {
    SetAgentLastSeenByServiceDateTime(std::forward<AgentLastSeenByServiceDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailbackClientID(FailbackClientIDT&& value) {
    ...
    m_failbackClientID = std::forward<FailbackClientIDT>(value);
  }
  template <typename FailbackClientIDT = Aws::String>
  RecoveryInstanceFailback& WithFailbackClientID(FailbackClientIDT&& value) {
    SetFailbackClientID(std::forward<FailbackClientIDT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailbackClientLastSeenByServiceDateTime(FailbackClientLastSeenByServiceDateTimeT&& value) {
    ...
    m_failbackClientLastSeenByServiceDateTime = std::forward<FailbackClientLastSeenByServiceDateTimeT>(value);
  }
  template <typename FailbackClientLastSeenByServiceDateTimeT = Aws::String>
  RecoveryInstanceFailback& WithFailbackClientLastSeenByServiceDateTime(FailbackClientLastSeenByServiceDateTimeT&& value) {
    SetFailbackClientLastSeenByServiceDateTime(std::forward<FailbackClientLastSeenByServiceDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailbackInitiationTime(FailbackInitiationTimeT&& value) {
    ...
    m_failbackInitiationTime = std::forward<FailbackInitiationTimeT>(value);
  }
  template <typename FailbackInitiationTimeT = Aws::String>
  RecoveryInstanceFailback& WithFailbackInitiationTime(FailbackInitiationTimeT&& value) {
    SetFailbackInitiationTime(std::forward<FailbackInitiationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailbackJobID(FailbackJobIDT&& value) {
    ...
    m_failbackJobID = std::forward<FailbackJobIDT>(value);
  }
  template <typename FailbackJobIDT = Aws::String>
  RecoveryInstanceFailback& WithFailbackJobID(FailbackJobIDT&& value) {
    SetFailbackJobID(std::forward<FailbackJobIDT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFailbackLaunchType(FailbackLaunchType value) {
    m_failbackLaunchTypeHasBeenSet = true;
    m_failbackLaunchType = value;
  }
  inline RecoveryInstanceFailback& WithFailbackLaunchType(FailbackLaunchType value) {
    SetFailbackLaunchType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailbackToOriginalServer(bool value) {
    m_failbackToOriginalServerHasBeenSet = true;
    m_failbackToOriginalServer = value;
  }
  inline RecoveryInstanceFailback& WithFailbackToOriginalServer(bool value) {
    SetFailbackToOriginalServer(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(FailbackState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline RecoveryInstanceFailback& WithState(FailbackState value) {
    SetState(value);
    return *this;
  }
  ///@}
