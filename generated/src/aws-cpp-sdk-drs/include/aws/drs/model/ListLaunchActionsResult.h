...
class ListLaunchActionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<LaunchAction>>
  ListLaunchActionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = LaunchAction>
  ListLaunchActionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLaunchActionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLaunchActionsResult& WithRequestId(RequestIdT&& value) {
