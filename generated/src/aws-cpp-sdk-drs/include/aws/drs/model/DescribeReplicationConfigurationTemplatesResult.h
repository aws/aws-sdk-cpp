...
class DescribeReplicationConfigurationTemplatesResult {
 public:
  AWS_DRS_API DescribeReplicationConfigurationTemplatesResult() = default;
  ...
  AWS_DRS_API DescribeReplicationConfigurationTemplatesResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ReplicationConfigurationTemplate>>
  DescribeReplicationConfigurationTemplatesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ReplicationConfigurationTemplate>
  DescribeReplicationConfigurationTemplatesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeReplicationConfigurationTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeReplicationConfigurationTemplatesResult& WithRequestId(RequestIdT&& value) {
