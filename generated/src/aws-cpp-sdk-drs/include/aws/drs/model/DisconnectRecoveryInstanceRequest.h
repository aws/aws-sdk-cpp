...
namespace Model
{
  ...
  /**
   */
  class DisconnectRecoveryInstanceRequest : public DrsRequest
  {
  public:
    AWS_DRS_API DisconnectRecoveryInstanceRequest() = default;
    ...
    template<typename RecoveryInstanceIDT = Aws::String>
    DisconnectRecoveryInstanceRequest& WithRecoveryInstanceID(RecoveryInstanceIDT&& value) { SetRecoveryInstanceID(std::forward<RecoveryInstanceIDT>(value)); return *this;}
    ///@}
  private:
