...
class RecoveryInstanceDataReplicationError {
 public:
  ...
  inline void SetError(FailbackReplicationError value) {
    m_errorHasBeenSet = true;
    m_error = value;
  }
  inline RecoveryInstanceDataReplicationError& WithError(FailbackReplicationError value) {
    SetError(value);
    return *this;
  }
  ///@}
  ...
  template <typename RawErrorT = Aws::String>
  RecoveryInstanceDataReplicationError& WithRawError(RawErrorT&& value) {
