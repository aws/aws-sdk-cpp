...
namespace Model
{
  ...
  /**
   */
  class DisconnectSourceServerRequest : public DrsRequest
  {
  public:
    ...
    template<typename SourceServerIDT = Aws::String>
    DisconnectSourceServerRequest& WithSourceServerID(SourceServerIDT&& value) { SetSourceServerID(std::forward<SourceServerIDT>(value)); return *this;}
    ///@}
  private:
