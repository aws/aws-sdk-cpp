...
namespace Model
{
  ...
  {
  public:
    AWS_DRS_API DeleteLaunchConfigurationTemplateResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteLaunchConfigurationTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
