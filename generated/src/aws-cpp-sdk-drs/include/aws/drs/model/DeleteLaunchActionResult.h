...
namespace Model
{
  ...
  {
  public:
    AWS_DRS_API DeleteLaunchActionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteLaunchActionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
