...
namespace drs {
namespace Model {
class UpdateRecoveryPlanExecutionStepResult {
 public:
  AWS_DRS_API UpdateRecoveryPlanExecutionStepResult() = default;
  AWS_DRS_API UpdateRecoveryPlanExecutionStepResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_DRS_API UpdateRecoveryPlanExecutionStepResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RecoveryPlanExecutionStepT = RecoveryPlanExecutionStep>
  UpdateRecoveryPlanExecutionStepResult& WithRecoveryPlanExecutionStep(RecoveryPlanExecutionStepT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRecoveryPlanExecutionStepResult& WithRequestId(RequestIdT&& value) {
