...
class StartSourceNetworkReplicationResult {
 public:
  AWS_DRS_API StartSourceNetworkReplicationResult() = default;
  ...
  void SetSourceNetwork(SourceNetworkT&& value) {
    m_sourceNetworkHasBeenSet = true;
    m_sourceNetwork = std::forward<SourceNetworkT>(value);
  }
  template <typename SourceNetworkT = SourceNetwork>
  StartSourceNetworkReplicationResult& WithSourceNetwork(SourceNetworkT&& value) {
    SetSourceNetwork(std::forward<SourceNetworkT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartSourceNetworkReplicationResult& WithRequestId(RequestIdT&& value) {
