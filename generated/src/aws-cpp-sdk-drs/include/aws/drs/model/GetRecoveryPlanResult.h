...
class GetRecoveryPlanResult {
 public:
  AWS_DRS_API GetRecoveryPlanResult() = default;
  AWS_DRS_API GetRecoveryPlanResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_DRS_API GetRecoveryPlanResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RecoveryPlanT = RecoveryPlan>
  GetRecoveryPlanResult& WithRecoveryPlan(RecoveryPlanT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRecoveryPlanResult& WithRequestId(RequestIdT&& value) {
