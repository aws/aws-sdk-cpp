...
class ListStagingAccountsRequest : public DrsRequest {
 public:
  AWS_DRS_API ListStagingAccountsRequest() = default;
  ...
  inline ListStagingAccountsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListStagingAccountsRequest& WithNextToken(NextTokenT&& value) {
