...
class UpdateLaunchConfigurationTemplateRequest : public DrsRequest {
 public:
  ...
  inline UpdateLaunchConfigurationTemplateRequest& WithPostLaunchEnabled(bool value) {
  ...
  inline UpdateLaunchConfigurationTemplateRequest& WithRecoveryMode(RecoveryMode value) {
