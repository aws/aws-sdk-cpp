...
class CreateReplicationConfigurationTemplateResult {
 public:
  AWS_DRS_API CreateReplicationConfigurationTemplateResult() = default;
  ...
  AWS_DRS_API CreateReplicationConfigurationTemplateResult& operator=(
  ...
  void SetReplicationConfigurationTemplateID(ReplicationConfigurationTemplateIDT&& value) {
    ...
    m_replicationConfigurationTemplateID = std::forward<ReplicationConfigurationTemplateIDT>(value);
  }
  template <typename ReplicationConfigurationTemplateIDT = Aws::String>
  CreateReplicationConfigurationTemplateResult& WithReplicationConfigurationTemplateID(ReplicationConfigurationTemplateIDT&& value) {
    SetReplicationConfigurationTemplateID(std::forward<ReplicationConfigurationTemplateIDT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  CreateReplicationConfigurationTemplateResult& WithArn(ArnT&& value) {
  ...
  inline CreateReplicationConfigurationTemplateResult& WithAssociateDefaultSecurityGroup(bool value) {
  ...
  inline CreateReplicationConfigurationTemplateResult& WithUseDedicatedReplicationServer(bool value) {
  ...
  inline CreateReplicationConfigurationTemplateResult& WithDefaultLargeStagingDiskType(
  ...
  inline CreateReplicationConfigurationTemplateResult& WithEbsEncryption(ReplicationConfigurationEbsEncryption value) {
  ...
  inline CreateReplicationConfigurationTemplateResult& WithBandwidthThrottling(long long value) {
  ...
  inline CreateReplicationConfigurationTemplateResult& WithDataPlaneRouting(ReplicationConfigurationDataPlaneRouting value) {
  ...
  inline CreateReplicationConfigurationTemplateResult& WithCreatePublicIP(bool value) {
  ...
  template <typename PitPolicyT = Aws::Vector<PITPolicyRule>>
  CreateReplicationConfigurationTemplateResult& WithPitPolicy(PitPolicyT&& value) {
    SetPitPolicy(std::forward<PitPolicyT>(value));
    return *this;
  }
  template <typename PitPolicyT = PITPolicyRule>
  CreateReplicationConfigurationTemplateResult& AddPitPolicy(PitPolicyT&& value) {
    m_pitPolicyHasBeenSet = true;
  ...
  inline CreateReplicationConfigurationTemplateResult& WithAutoReplicateNewDisks(bool value) {
  ...
  inline CreateReplicationConfigurationTemplateResult& WithInternetProtocol(InternetProtocol value) {
