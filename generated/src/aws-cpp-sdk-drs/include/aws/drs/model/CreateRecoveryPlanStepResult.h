...
namespace drs {
namespace Model {
class CreateRecoveryPlanStepResult {
 public:
  AWS_DRS_API CreateRecoveryPlanStepResult() = default;
  AWS_DRS_API CreateRecoveryPlanStepResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_DRS_API CreateRecoveryPlanStepResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RecoveryPlanStepT = RecoveryPlanStep>
  CreateRecoveryPlanStepResult& WithRecoveryPlanStep(RecoveryPlanStepT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRecoveryPlanStepResult& WithRequestId(RequestIdT&& value) {
