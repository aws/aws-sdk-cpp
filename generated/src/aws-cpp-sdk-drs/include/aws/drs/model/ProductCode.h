...
class ProductCode {
 public:
  ...
  inline void SetProductCodeMode(ProductCodeMode value) {
    m_productCodeModeHasBeenSet = true;
    m_productCodeMode = value;
  }
  inline ProductCode& WithProductCodeMode(ProductCodeMode value) {
    SetProductCodeMode(value);
    return *this;
  }
  ///@}
 private:
