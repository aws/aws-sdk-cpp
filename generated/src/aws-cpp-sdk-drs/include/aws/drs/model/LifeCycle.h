...
class LifeCycle {
 public:
  ...
  void SetAddedToServiceDateTime(AddedToServiceDateTimeT&& value) {
    ...
    m_addedToServiceDateTime = std::forward<AddedToServiceDateTimeT>(value);
  }
  template <typename AddedToServiceDateTimeT = Aws::String>
  LifeCycle& WithAddedToServiceDateTime(AddedToServiceDateTimeT&& value) {
    SetAddedToServiceDateTime(std::forward<AddedToServiceDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastLaunch(LastLaunchT&& value) {
    ...
    m_lastLaunch = std::forward<LastLaunchT>(value);
  }
  template <typename LastLaunchT = LifeCycleLastLaunch>
  LifeCycle& WithLastLaunch(LastLaunchT&& value) {
    SetLastLaunch(std::forward<LastLaunchT>(value));
    return *this;
  }
  ///@}
