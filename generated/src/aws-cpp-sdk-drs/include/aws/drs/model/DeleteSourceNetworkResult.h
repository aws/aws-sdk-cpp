...
namespace Model
{
  ...
  {
  public:
    AWS_DRS_API DeleteSourceNetworkResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSourceNetworkResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
