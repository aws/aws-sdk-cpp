...
class CreateExtendedSourceServerResult {
 public:
  AWS_DRS_API CreateExtendedSourceServerResult() = default;
  ...
  void SetSourceServer(SourceServerT&& value) {
    m_sourceServerHasBeenSet = true;
    m_sourceServer = std::forward<SourceServerT>(value);
  }
  template <typename SourceServerT = SourceServer>
  CreateExtendedSourceServerResult& WithSourceServer(SourceServerT&& value) {
    SetSourceServer(std::forward<SourceServerT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateExtendedSourceServerResult& WithRequestId(RequestIdT&& value) {
