...
class CreateLaunchConfigurationTemplateRequest : public DrsRequest {
 public:
  ...
  inline CreateLaunchConfigurationTemplateRequest& WithPostLaunchEnabled(bool value) {
  ...
  inline CreateLaunchConfigurationTemplateRequest& WithRecoveryMode(RecoveryMode value) {
