...
class DataReplicationInfoReplicatedDisk {
 public:
  ...
  inline void SetReplicatedStorageBytes(long long value) {
    m_replicatedStorageBytesHasBeenSet = true;
    m_replicatedStorageBytes = value;
  }
  inline DataReplicationInfoReplicatedDisk& WithReplicatedStorageBytes(long long value) {
    SetReplicatedStorageBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRescannedStorageBytes(long long value) {
    m_rescannedStorageBytesHasBeenSet = true;
    m_rescannedStorageBytes = value;
  }
  inline DataReplicationInfoReplicatedDisk& WithRescannedStorageBytes(long long value) {
    SetRescannedStorageBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVolumeStatus(VolumeStatus value) {
    m_volumeStatusHasBeenSet = true;
    m_volumeStatus = value;
  }
  inline DataReplicationInfoReplicatedDisk& WithVolumeStatus(VolumeStatus value) {
    SetVolumeStatus(value);
    return *this;
  }
  ///@}
 private:
