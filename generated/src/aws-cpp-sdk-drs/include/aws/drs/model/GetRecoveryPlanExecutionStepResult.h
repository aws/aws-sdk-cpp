...
namespace drs {
namespace Model {
class GetRecoveryPlanExecutionStepResult {
 public:
  AWS_DRS_API GetRecoveryPlanExecutionStepResult() = default;
  AWS_DRS_API GetRecoveryPlanExecutionStepResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_DRS_API GetRecoveryPlanExecutionStepResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RecoveryPlanExecutionStepT = RecoveryPlanExecutionStep>
  GetRecoveryPlanExecutionStepResult& WithRecoveryPlanExecutionStep(RecoveryPlanExecutionStepT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRecoveryPlanExecutionStepResult& WithRequestId(RequestIdT&& value) {
