...
class DescribeSourceNetworksRequest : public DrsRequest {
 public:
  ...
  template <typename FiltersT = DescribeSourceNetworksRequestFilters>
  DescribeSourceNetworksRequest& WithFilters(FiltersT&& value) {
  ...
  inline DescribeSourceNetworksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSourceNetworksRequest& WithNextToken(NextTokenT&& value) {
