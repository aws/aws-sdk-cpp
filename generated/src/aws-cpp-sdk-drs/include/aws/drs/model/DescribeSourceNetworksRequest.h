...
namespace Model
{
  ...
  {
  public:
    AWS_DRS_API DescribeSourceNetworksRequest() = default;
    ...
    template<typename FiltersT = DescribeSourceNetworksRequestFilters>
    void SetFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters = std::forward<FiltersT>(value); }
    template<typename FiltersT = DescribeSourceNetworksRequestFilters>
    DescribeSourceNetworksRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeSourceNetworksRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
