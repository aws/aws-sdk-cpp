...
/**
 */
class ListRecoveryPlanExecutionsRequest : public DrsRequest {
 public:
  AWS_DRS_API ListRecoveryPlanExecutionsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListRecoveryPlanExecutions"; }
  ...
  template <typename RecoveryPlanArnT = Aws::String>
  ListRecoveryPlanExecutionsRequest& WithRecoveryPlanArn(RecoveryPlanArnT&& value) {
  ...
  inline ListRecoveryPlanExecutionsRequest& WithStatus(RecoveryPlanExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListRecoveryPlanExecutionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRecoveryPlanExecutionsRequest& WithNextToken(NextTokenT&& value) {
