...
class RecoveryLifeCycle {
 public:
  ...
  inline void SetLastRecoveryResult(RecoveryResult value) {
    m_lastRecoveryResultHasBeenSet = true;
    m_lastRecoveryResult = value;
  }
  inline RecoveryLifeCycle& WithLastRecoveryResult(RecoveryResult value) {
    SetLastRecoveryResult(value);
    return *this;
  }
  ///@}
 private:
