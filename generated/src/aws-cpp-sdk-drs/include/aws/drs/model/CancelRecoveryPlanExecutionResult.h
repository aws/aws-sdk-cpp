...
namespace drs {
namespace Model {
class CancelRecoveryPlanExecutionResult {
 public:
  AWS_DRS_API CancelRecoveryPlanExecutionResult() = default;
  AWS_DRS_API CancelRecoveryPlanExecutionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_DRS_API CancelRecoveryPlanExecutionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RecoveryPlanExecutionT = RecoveryPlanExecution>
  CancelRecoveryPlanExecutionResult& WithRecoveryPlanExecution(RecoveryPlanExecutionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CancelRecoveryPlanExecutionResult& WithRequestId(RequestIdT&& value) {
