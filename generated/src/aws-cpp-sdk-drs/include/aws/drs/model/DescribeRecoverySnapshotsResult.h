...
class DescribeRecoverySnapshotsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<RecoverySnapshot>>
  DescribeRecoverySnapshotsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = RecoverySnapshot>
  DescribeRecoverySnapshotsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRecoverySnapshotsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRecoverySnapshotsResult& WithRequestId(RequestIdT&& value) {
