...
namespace Model
{
  ...
  {
  public:
    AWS_DRS_API GetReplicationConfigurationResult() = default;
    ...
    inline GetReplicationConfigurationResult& WithAutoReplicateNewDisks(bool value) { SetAutoReplicateNewDisks(value); return *this;}
    ///@}
    ...
    template<typename PitPolicyT = Aws::Vector<PITPolicyRule>>
    GetReplicationConfigurationResult& WithPitPolicy(PitPolicyT&& value) { SetPitPolicy(std::forward<PitPolicyT>(value)); return *this;}
    template<typename PitPolicyT = PITPolicyRule>
    GetReplicationConfigurationResult& AddPitPolicy(PitPolicyT&& value) { m_pitPolicyHasBeenSet = true; m_pitPolicy.emplace_back(std::forward<PitPolicyT>(value)); return *this; }
    ///@}
