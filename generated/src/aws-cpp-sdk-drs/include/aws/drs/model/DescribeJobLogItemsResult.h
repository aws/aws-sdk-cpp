...
class DescribeJobLogItemsResult {
 public:
  AWS_DRS_API DescribeJobLogItemsResult() = default;
  ...
  template <typename ItemsT = Aws::Vector<JobLog>>
  DescribeJobLogItemsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = JobLog>
  DescribeJobLogItemsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeJobLogItemsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeJobLogItemsResult& WithRequestId(RequestIdT&& value) {
