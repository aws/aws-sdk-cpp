...
namespace Model
{
  ...
  public:
    ...
    inline DescribeRecoveryInstancesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribeRecoveryInstancesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribeRecoveryInstancesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
