...
class DescribeRecoveryInstancesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<RecoveryInstance>>
  DescribeRecoveryInstancesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = RecoveryInstance>
  DescribeRecoveryInstancesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRecoveryInstancesResult& WithRequestId(RequestIdT&& value) {
