...
class DescribeRecoverySnapshotsRequestFilters {
 public:
  ...
  void SetFromDateTime(FromDateTimeT&& value) {
    m_fromDateTimeHasBeenSet = true;
    m_fromDateTime = std::forward<FromDateTimeT>(value);
  }
  template <typename FromDateTimeT = Aws::String>
  DescribeRecoverySnapshotsRequestFilters& WithFromDateTime(FromDateTimeT&& value) {
    SetFromDateTime(std::forward<FromDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetToDateTime(ToDateTimeT&& value) {
    m_toDateTimeHasBeenSet = true;
    m_toDateTime = std::forward<ToDateTimeT>(value);
  }
  template <typename ToDateTimeT = Aws::String>
  DescribeRecoverySnapshotsRequestFilters& WithToDateTime(ToDateTimeT&& value) {
    SetToDateTime(std::forward<ToDateTimeT>(value));
    return *this;
  }
  ///@}
 private:
