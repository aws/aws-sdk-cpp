...
class UpdateReplicationConfigurationTemplateResult {
 public:
  ...
  AWS_DRS_API UpdateReplicationConfigurationTemplateResult& operator=(
  ...
  template <typename ArnT = Aws::String>
  UpdateReplicationConfigurationTemplateResult& WithArn(ArnT&& value) {
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithAssociateDefaultSecurityGroup(bool value) {
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithUseDedicatedReplicationServer(bool value) {
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithDefaultLargeStagingDiskType(
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithEbsEncryption(ReplicationConfigurationEbsEncryption value) {
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithBandwidthThrottling(long long value) {
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithDataPlaneRouting(ReplicationConfigurationDataPlaneRouting value) {
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithCreatePublicIP(bool value) {
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithAutoReplicateNewDisks(bool value) {
  ...
  inline UpdateReplicationConfigurationTemplateResult& WithInternetProtocol(InternetProtocol value) {
