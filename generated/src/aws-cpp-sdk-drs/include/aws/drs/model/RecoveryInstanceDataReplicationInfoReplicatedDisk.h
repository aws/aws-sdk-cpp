...
class RecoveryInstanceDataReplicationInfoReplicatedDisk {
 public:
  ...
  inline RecoveryInstanceDataReplicationInfoReplicatedDisk& WithBackloggedStorageBytes(long long value) {
  ...
  template <typename DeviceNameT = Aws::String>
  RecoveryInstanceDataReplicationInfoReplicatedDisk& WithDeviceName(DeviceNameT&& value) {
  ...
  inline RecoveryInstanceDataReplicationInfoReplicatedDisk& WithReplicatedStorageBytes(long long value) {
  ...
  inline RecoveryInstanceDataReplicationInfoReplicatedDisk& WithRescannedStorageBytes(long long value) {
  ...
  inline RecoveryInstanceDataReplicationInfoReplicatedDisk& WithTotalStorageBytes(long long value) {
