...
class ReplicationConfigurationReplicatedDisk {
 public:
  ...
  inline void SetIsBootDisk(bool value) {
  ...
  inline void SetStagingDiskType(ReplicationConfigurationReplicatedDiskStagingDiskType value) {
    m_stagingDiskTypeHasBeenSet = true;
    m_stagingDiskType = value;
  }
  inline ReplicationConfigurationReplicatedDisk& WithStagingDiskType(ReplicationConfigurationReplicatedDiskStagingDiskType value) {
    SetStagingDiskType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetThroughput(long long value) {
    m_throughputHasBeenSet = true;
    m_throughput = value;
  }
  inline ReplicationConfigurationReplicatedDisk& WithThroughput(long long value) {
    SetThroughput(value);
    return *this;
  }
  ///@}
