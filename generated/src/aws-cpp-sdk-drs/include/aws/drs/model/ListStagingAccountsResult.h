...
class ListStagingAccountsResult {
 public:
  ...
  template <typename AccountsT = Aws::Vector<Account>>
  ListStagingAccountsResult& WithAccounts(AccountsT&& value) {
    SetAccounts(std::forward<AccountsT>(value));
    return *this;
  }
  template <typename AccountsT = Account>
  ListStagingAccountsResult& AddAccounts(AccountsT&& value) {
    m_accountsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListStagingAccountsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStagingAccountsResult& WithRequestId(RequestIdT&& value) {
