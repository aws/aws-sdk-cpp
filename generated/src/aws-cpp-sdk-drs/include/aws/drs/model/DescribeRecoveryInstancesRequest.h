...
class DescribeRecoveryInstancesRequest : public DrsRequest {
 public:
  ...
  template <typename FiltersT = DescribeRecoveryInstancesRequestFilters>
  DescribeRecoveryInstancesRequest& WithFilters(FiltersT&& value) {
  ...
  inline DescribeRecoveryInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRecoveryInstancesRequest& WithNextToken(NextTokenT&& value) {
