...
ReorderRecoveryPlanStepsResult::ReorderRecoveryPlanStepsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ReorderRecoveryPlanStepsResult& ReorderRecoveryPlanStepsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
