...
StartSourceNetworkReplicationResult::StartSourceNetworkReplicationResult()
{
}

StartSourceNetworkReplicationResult::StartSourceNetworkReplicationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
