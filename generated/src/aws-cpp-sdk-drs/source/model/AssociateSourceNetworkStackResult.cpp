...
AssociateSourceNetworkStackResult::AssociateSourceNetworkStackResult()
{
}

AssociateSourceNetworkStackResult::AssociateSourceNetworkStackResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
