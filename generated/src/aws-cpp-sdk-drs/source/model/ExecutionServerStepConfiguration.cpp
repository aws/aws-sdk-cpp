...
ExecutionServerStepConfiguration::ExecutionServerStepConfiguration(JsonView jsonValue) { *this = jsonValue; }

ExecutionServerStepConfiguration& ExecutionServerStepConfiguration::operator=(JsonView jsonValue) {
...
JsonValue ExecutionServerStepConfiguration::Jsonize() const {
  JsonValue payload;
