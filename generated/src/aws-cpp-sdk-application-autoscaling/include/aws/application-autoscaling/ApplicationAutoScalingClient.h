...
namespace ApplicationAutoScaling
{
   ...
   */
  class AWS_APPLICATIONAUTOSCALING_API ApplicationAutoScalingClient : Aws::Client::ClientWithAsyncTemplateMethods<ApplicationAutoScalingClient>,
    smithy::client::AwsSmithyClientT<Aws::ApplicationAutoScaling::SERVICE_NAME,
