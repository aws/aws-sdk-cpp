...
class DescribeScalingActivitiesResult {
 public:
  ...
  AWS_APPLICATIONAUTOSCALING_API DescribeScalingActivitiesResult& operator=(
  ...
  void SetScalingActivities(ScalingActivitiesT&& value) {
    m_scalingActivitiesHasBeenSet = true;
    m_scalingActivities = std::forward<ScalingActivitiesT>(value);
  }
  template <typename ScalingActivitiesT = Aws::Vector<ScalingActivity>>
  DescribeScalingActivitiesResult& WithScalingActivities(ScalingActivitiesT&& value) {
    SetScalingActivities(std::forward<ScalingActivitiesT>(value));
    return *this;
  }
  template <typename ScalingActivitiesT = ScalingActivity>
  DescribeScalingActivitiesResult& AddScalingActivities(ScalingActivitiesT&& value) {
    m_scalingActivitiesHasBeenSet = true;
    m_scalingActivities.emplace_back(std::forward<ScalingActivitiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeScalingActivitiesResult& WithRequestId(RequestIdT&& value) {
