...
/**
 */
class DescribeScheduledActionsRequest : public ApplicationAutoScalingRequest {
 public:
  ...
  void SetScheduledActionNames(ScheduledActionNamesT&& value) {
    m_scheduledActionNamesHasBeenSet = true;
    m_scheduledActionNames = std::forward<ScheduledActionNamesT>(value);
  }
  template <typename ScheduledActionNamesT = Aws::Vector<Aws::String>>
  DescribeScheduledActionsRequest& WithScheduledActionNames(ScheduledActionNamesT&& value) {
    SetScheduledActionNames(std::forward<ScheduledActionNamesT>(value));
    return *this;
  }
  ...
  DescribeScheduledActionsRequest& AddScheduledActionNames(ScheduledActionNamesT&& value) {
    m_scheduledActionNamesHasBeenSet = true;
    m_scheduledActionNames.emplace_back(std::forward<ScheduledActionNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeScheduledActionsRequest& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline DescribeScheduledActionsRequest& WithScalableDimension(ScalableDimension value) {
  ...
  inline DescribeScheduledActionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
