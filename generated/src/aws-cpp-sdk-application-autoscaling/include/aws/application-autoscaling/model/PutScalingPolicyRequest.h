...
class PutScalingPolicyRequest : public ApplicationAutoScalingRequest {
 public:
  ...
  inline PutScalingPolicyRequest& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline PutScalingPolicyRequest& WithScalableDimension(ScalableDimension value) {
