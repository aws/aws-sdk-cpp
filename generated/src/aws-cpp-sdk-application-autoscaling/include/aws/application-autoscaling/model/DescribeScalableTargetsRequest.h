...
class DescribeScalableTargetsRequest : public ApplicationAutoScalingRequest {
 public:
  ...
  inline DescribeScalableTargetsRequest& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline DescribeScalableTargetsRequest& WithScalableDimension(ScalableDimension value) {
  ...
  inline DescribeScalableTargetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
