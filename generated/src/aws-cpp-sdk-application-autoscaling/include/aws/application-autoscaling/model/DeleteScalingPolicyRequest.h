...
class DeleteScalingPolicyRequest : public ApplicationAutoScalingRequest {
 public:
  ...
  inline DeleteScalingPolicyRequest& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline DeleteScalingPolicyRequest& WithScalableDimension(ScalableDimension value) {
