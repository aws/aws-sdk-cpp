...
class PredictiveScalingPolicyConfiguration {
 public:
  ...
  void SetMetricSpecifications(MetricSpecificationsT&& value) {
    ...
    m_metricSpecifications = std::forward<MetricSpecificationsT>(value);
  }
  template <typename MetricSpecificationsT = Aws::Vector<PredictiveScalingMetricSpecification>>
  PredictiveScalingPolicyConfiguration& WithMetricSpecifications(MetricSpecificationsT&& value) {
    SetMetricSpecifications(std::forward<MetricSpecificationsT>(value));
    return *this;
  }
  ...
  PredictiveScalingPolicyConfiguration& AddMetricSpecifications(MetricSpecificationsT&& value) {
    m_metricSpecificationsHasBeenSet = true;
    m_metricSpecifications.emplace_back(std::forward<MetricSpecificationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMode(PredictiveScalingMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline PredictiveScalingPolicyConfiguration& WithMode(PredictiveScalingMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSchedulingBufferTime(int value) {
    m_schedulingBufferTimeHasBeenSet = true;
    m_schedulingBufferTime = value;
  }
  inline PredictiveScalingPolicyConfiguration& WithSchedulingBufferTime(int value) {
    SetSchedulingBufferTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxCapacityBreachBehavior(PredictiveScalingMaxCapacityBreachBehavior value) {
    m_maxCapacityBreachBehaviorHasBeenSet = true;
    m_maxCapacityBreachBehavior = value;
  }
  inline PredictiveScalingPolicyConfiguration& WithMaxCapacityBreachBehavior(PredictiveScalingMaxCapacityBreachBehavior value) {
    SetMaxCapacityBreachBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxCapacityBuffer(int value) {
    m_maxCapacityBufferHasBeenSet = true;
    m_maxCapacityBuffer = value;
  }
  inline PredictiveScalingPolicyConfiguration& WithMaxCapacityBuffer(int value) {
    SetMaxCapacityBuffer(value);
    return *this;
  }
  ///@}
 private:
