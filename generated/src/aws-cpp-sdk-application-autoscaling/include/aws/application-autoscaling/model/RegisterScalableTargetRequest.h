...
class RegisterScalableTargetRequest : public ApplicationAutoScalingRequest {
 public:
  ...
  inline RegisterScalableTargetRequest& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline RegisterScalableTargetRequest& WithScalableDimension(ScalableDimension value) {
  ...
  inline RegisterScalableTargetRequest& WithMinCapacity(int value) {
  ...
  inline RegisterScalableTargetRequest& WithMaxCapacity(int value) {
  ...
  template <typename RoleARNT = Aws::String>
  RegisterScalableTargetRequest& WithRoleARN(RoleARNT&& value) {
  ...
  void SetSuspendedState(SuspendedStateT&& value) {
    m_suspendedStateHasBeenSet = true;
    m_suspendedState = std::forward<SuspendedStateT>(value);
  }
  template <typename SuspendedStateT = SuspendedState>
  RegisterScalableTargetRequest& WithSuspendedState(SuspendedStateT&& value) {
    SetSuspendedState(std::forward<SuspendedStateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  RegisterScalableTargetRequest& WithTags(TagsT&& value) {
