...
class DeregisterScalableTargetRequest : public ApplicationAutoScalingRequest {
 public:
  ...
  inline DeregisterScalableTargetRequest& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline DeregisterScalableTargetRequest& WithScalableDimension(ScalableDimension value) {
