 ...
 * math</a> in the <i>Application Auto Scaling User Guide</i>.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/application-autoscaling-2016-02-06/TargetTrackingMetricDataQuery">AWS
 * API Reference</a></p>
 */
class TargetTrackingMetricDataQuery {
 public:
  ...
  template <typename IdT = Aws::String>
  TargetTrackingMetricDataQuery& WithId(IdT&& value) {
  ...
  template <typename LabelT = Aws::String>
  TargetTrackingMetricDataQuery& WithLabel(LabelT&& value) {
  ...
  inline TargetTrackingMetricDataQuery& WithReturnData(bool value) {
    SetReturnData(value);
    return *this;
  }
  ///@}
