...
class ScalableTarget {
 public:
  ...
  inline ScalableTarget& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline ScalableTarget& WithScalableDimension(ScalableDimension value) {
  ...
  inline ScalableTarget& WithMinCapacity(int value) {
  ...
  inline ScalableTarget& WithMaxCapacity(int value) {
  ...
  inline ScalableTarget& WithPredictedCapacity(int value) {
