...
class StepScalingPolicyConfiguration {
 public:
  ...
  inline StepScalingPolicyConfiguration& WithAdjustmentType(AdjustmentType value) {
  ...
  inline StepScalingPolicyConfiguration& WithMinAdjustmentMagnitude(int value) {
  ...
  inline StepScalingPolicyConfiguration& WithCooldown(int value) {
    SetCooldown(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMetricAggregationType(MetricAggregationType value) {
    m_metricAggregationTypeHasBeenSet = true;
    m_metricAggregationType = value;
  }
  inline StepScalingPolicyConfiguration& WithMetricAggregationType(MetricAggregationType value) {
    SetMetricAggregationType(value);
    return *this;
  }
  ///@}
 private:
