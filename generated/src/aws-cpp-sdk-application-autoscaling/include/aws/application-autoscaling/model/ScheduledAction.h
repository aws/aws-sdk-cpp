...
class ScheduledAction {
 public:
  ...
  void SetScheduledActionARN(ScheduledActionARNT&& value) {
    ...
    m_scheduledActionARN = std::forward<ScheduledActionARNT>(value);
  }
  template <typename ScheduledActionARNT = Aws::String>
  ScheduledAction& WithScheduledActionARN(ScheduledActionARNT&& value) {
    SetScheduledActionARN(std::forward<ScheduledActionARNT>(value));
    return *this;
  }
  ///@}
  ...
  inline ScheduledAction& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline ScheduledAction& WithScalableDimension(ScalableDimension value) {
  ...
  void SetScalableTargetAction(ScalableTargetActionT&& value) {
    ...
    m_scalableTargetAction = std::forward<ScalableTargetActionT>(value);
  }
  template <typename ScalableTargetActionT = ScalableTargetAction>
  ScheduledAction& WithScalableTargetAction(ScalableTargetActionT&& value) {
    SetScalableTargetAction(std::forward<ScalableTargetActionT>(value));
    return *this;
  }
  ///@}
