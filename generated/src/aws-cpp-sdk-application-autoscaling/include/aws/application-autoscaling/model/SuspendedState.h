...
class SuspendedState {
 public:
  ...
  inline void SetDynamicScalingInSuspended(bool value) {
    m_dynamicScalingInSuspendedHasBeenSet = true;
    m_dynamicScalingInSuspended = value;
  }
  inline SuspendedState& WithDynamicScalingInSuspended(bool value) {
    SetDynamicScalingInSuspended(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDynamicScalingOutSuspended(bool value) {
    m_dynamicScalingOutSuspendedHasBeenSet = true;
    m_dynamicScalingOutSuspended = value;
  }
  inline SuspendedState& WithDynamicScalingOutSuspended(bool value) {
    SetDynamicScalingOutSuspended(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScheduledScalingSuspended(bool value) {
    m_scheduledScalingSuspendedHasBeenSet = true;
    m_scheduledScalingSuspended = value;
  }
  inline SuspendedState& WithScheduledScalingSuspended(bool value) {
    SetScheduledScalingSuspended(value);
    return *this;
  }
  ///@}
 private:
