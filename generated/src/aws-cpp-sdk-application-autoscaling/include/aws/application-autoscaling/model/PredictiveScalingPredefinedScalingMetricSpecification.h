...
namespace Model
{
  ...
  public:
    ...
    template<typename PredefinedMetricTypeT = Aws::String>
    PredictiveScalingPredefinedScalingMetricSpecification& WithPredefinedMetricType(PredefinedMetricTypeT&& value) { SetPredefinedMetricType(std::forward<PredefinedMetricTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceLabelT = Aws::String>
    PredictiveScalingPredefinedScalingMetricSpecification& WithResourceLabel(ResourceLabelT&& value) { SetResourceLabel(std::forward<ResourceLabelT>(value)); return *this;}
    ///@}
  private:
