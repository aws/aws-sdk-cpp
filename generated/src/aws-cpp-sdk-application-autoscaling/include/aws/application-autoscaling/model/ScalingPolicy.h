...
class ScalingPolicy {
 public:
  ...
  inline ScalingPolicy& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline ScalingPolicy& WithScalableDimension(ScalableDimension value) {
  ...
  inline ScalingPolicy& WithPolicyType(PolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  void SetStepScalingPolicyConfiguration(StepScalingPolicyConfigurationT&& value) {
    ...
    m_stepScalingPolicyConfiguration = std::forward<StepScalingPolicyConfigurationT>(value);
  }
  template <typename StepScalingPolicyConfigurationT = StepScalingPolicyConfiguration>
  ScalingPolicy& WithStepScalingPolicyConfiguration(StepScalingPolicyConfigurationT&& value) {
    SetStepScalingPolicyConfiguration(std::forward<StepScalingPolicyConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const TargetTrackingScalingPolicyConfiguration& GetTargetTrackingScalingPolicyConfiguration() const {
    return m_targetTrackingScalingPolicyConfiguration;
  }
  ...
  void SetTargetTrackingScalingPolicyConfiguration(TargetTrackingScalingPolicyConfigurationT&& value) {
    ...
    m_targetTrackingScalingPolicyConfiguration = std::forward<TargetTrackingScalingPolicyConfigurationT>(value);
  }
  template <typename TargetTrackingScalingPolicyConfigurationT = TargetTrackingScalingPolicyConfiguration>
  ScalingPolicy& WithTargetTrackingScalingPolicyConfiguration(TargetTrackingScalingPolicyConfigurationT&& value) {
    SetTargetTrackingScalingPolicyConfiguration(std::forward<TargetTrackingScalingPolicyConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const PredictiveScalingPolicyConfiguration& GetPredictiveScalingPolicyConfiguration() const {
    return m_predictiveScalingPolicyConfiguration;
  }
  ...
  void SetPredictiveScalingPolicyConfiguration(PredictiveScalingPolicyConfigurationT&& value) {
    ...
    m_predictiveScalingPolicyConfiguration = std::forward<PredictiveScalingPolicyConfigurationT>(value);
  }
  template <typename PredictiveScalingPolicyConfigurationT = PredictiveScalingPolicyConfiguration>
  ScalingPolicy& WithPredictiveScalingPolicyConfiguration(PredictiveScalingPolicyConfigurationT&& value) {
    SetPredictiveScalingPolicyConfiguration(std::forward<PredictiveScalingPolicyConfigurationT>(value));
    return *this;
  }
  ///@}
