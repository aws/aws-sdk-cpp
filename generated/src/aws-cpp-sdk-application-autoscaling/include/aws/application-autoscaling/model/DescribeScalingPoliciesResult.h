...
class DescribeScalingPoliciesResult {
 public:
  ...
  AWS_APPLICATIONAUTOSCALING_API DescribeScalingPoliciesResult& operator=(
  ...
  template <typename ScalingPoliciesT = Aws::Vector<ScalingPolicy>>
  DescribeScalingPoliciesResult& WithScalingPolicies(ScalingPoliciesT&& value) {
    SetScalingPolicies(std::forward<ScalingPoliciesT>(value));
    return *this;
  }
  template <typename ScalingPoliciesT = ScalingPolicy>
  DescribeScalingPoliciesResult& AddScalingPolicies(ScalingPoliciesT&& value) {
    m_scalingPoliciesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeScalingPoliciesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeScalingPoliciesResult& WithRequestId(RequestIdT&& value) {
