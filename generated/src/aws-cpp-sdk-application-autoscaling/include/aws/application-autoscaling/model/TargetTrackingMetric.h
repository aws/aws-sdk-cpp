...
class TargetTrackingMetric {
 public:
  ...
  template <typename DimensionsT = Aws::Vector<TargetTrackingMetricDimension>>
  TargetTrackingMetric& WithDimensions(DimensionsT&& value) {
    SetDimensions(std::forward<DimensionsT>(value));
    return *this;
  }
  template <typename DimensionsT = TargetTrackingMetricDimension>
  TargetTrackingMetric& AddDimensions(DimensionsT&& value) {
    m_dimensionsHasBeenSet = true;
  ...
  template <typename MetricNameT = Aws::String>
  TargetTrackingMetric& WithMetricName(MetricNameT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  TargetTrackingMetric& WithNamespace(NamespaceT&& value) {
