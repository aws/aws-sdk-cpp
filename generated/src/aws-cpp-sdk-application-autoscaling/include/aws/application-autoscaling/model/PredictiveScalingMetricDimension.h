...
namespace Model
{
  ...
  {
  public:
    AWS_APPLICATIONAUTOSCALING_API PredictiveScalingMetricDimension() = default;
    ...
    template<typename NameT = Aws::String>
    PredictiveScalingMetricDimension& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    PredictiveScalingMetricDimension& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
