...
class DescribeScalableTargetsResult {
 public:
  ...
  AWS_APPLICATIONAUTOSCALING_API DescribeScalableTargetsResult& operator=(
  ...
  void SetScalableTargets(ScalableTargetsT&& value) {
    m_scalableTargetsHasBeenSet = true;
    m_scalableTargets = std::forward<ScalableTargetsT>(value);
  }
  template <typename ScalableTargetsT = Aws::Vector<ScalableTarget>>
  DescribeScalableTargetsResult& WithScalableTargets(ScalableTargetsT&& value) {
    SetScalableTargets(std::forward<ScalableTargetsT>(value));
    return *this;
  }
  template <typename ScalableTargetsT = ScalableTarget>
  DescribeScalableTargetsResult& AddScalableTargets(ScalableTargetsT&& value) {
    m_scalableTargetsHasBeenSet = true;
    m_scalableTargets.emplace_back(std::forward<ScalableTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeScalableTargetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeScalableTargetsResult& WithRequestId(RequestIdT&& value) {
