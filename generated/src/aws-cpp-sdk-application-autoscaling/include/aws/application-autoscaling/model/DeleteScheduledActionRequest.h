...
class DeleteScheduledActionRequest : public ApplicationAutoScalingRequest {
 public:
  ...
  inline DeleteScheduledActionRequest& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline DeleteScheduledActionRequest& WithScalableDimension(ScalableDimension value) {
