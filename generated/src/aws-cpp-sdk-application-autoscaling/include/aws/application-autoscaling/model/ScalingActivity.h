...
class ScalingActivity {
 public:
  ...
  inline ScalingActivity& WithServiceNamespace(ServiceNamespace value) {
  ...
  inline ScalingActivity& WithScalableDimension(ScalableDimension value) {
  ...
  inline ScalingActivity& WithStatusCode(ScalingActivityStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  void SetNotScaledReasons(NotScaledReasonsT&& value) {
    ...
    m_notScaledReasons = std::forward<NotScaledReasonsT>(value);
  }
  template <typename NotScaledReasonsT = Aws::Vector<NotScaledReason>>
  ScalingActivity& WithNotScaledReasons(NotScaledReasonsT&& value) {
    SetNotScaledReasons(std::forward<NotScaledReasonsT>(value));
    return *this;
  }
  template <typename NotScaledReasonsT = NotScaledReason>
  ScalingActivity& AddNotScaledReasons(NotScaledReasonsT&& value) {
    m_notScaledReasonsHasBeenSet = true;
    m_notScaledReasons.emplace_back(std::forward<NotScaledReasonsT>(value));
    return *this;
  }
  ///@}
 private:
