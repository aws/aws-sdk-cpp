...
static const int elasticmapreduce_instancegroup_InstanceCount_HASH =
...
static const int comprehend_document_classifier_endpoint_DesiredInferenceUnits_HASH =
    HashingUtils::HashString("comprehend:document-classifier-endpoint:DesiredInferenceUnits");
static const int comprehend_entity_recognizer_endpoint_DesiredInferenceUnits_HASH =
    HashingUtils::HashString("comprehend:entity-recognizer-endpoint:DesiredInferenceUnits");
...
static const int sagemaker_variant_DesiredProvisionedConcurrency_HASH =
    HashingUtils::HashString("sagemaker:variant:DesiredProvisionedConcurrency");
static const int sagemaker_inference_component_DesiredCopyCount_HASH =
    HashingUtils::HashString("sagemaker:inference-component:DesiredCopyCount");
static const int workspaces_workspacespool_DesiredUserSessions_HASH =
    HashingUtils::HashString("workspaces:workspacespool:DesiredUserSessions");
