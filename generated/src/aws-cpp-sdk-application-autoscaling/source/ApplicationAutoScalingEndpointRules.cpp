...
{
const size_t ApplicationAutoScalingEndpointRules::RulesBlobStrLen = 3829;
const size_t ApplicationAutoScalingEndpointRules::RulesBlobSize = 3830;
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p',
'l','i','c','a','t','i','o','n','-','a','u','t','o','s','c','a','l','i','n','g','-','f','i','p','s',
...
's','t','r','i','n','g','E','q','u','a','l','s','"',',','"','a','r','g','v','"',':','[','"','a','w',
's','-','u','s','-','g','o','v','"',',','{','"','f','n','"',':','"','g','e','t','A','t','t','r','"',
',','"','a','r','g','v','"',':','[','{','"','r','e','f','"',':','"','P','a','r','t','i','t','i','o',
'n','R','e','s','u','l','t','"','}',',','"','n','a','m','e','"',']','}',']','}',']',',','"','e','n',
'd','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a',
'p','p','l','i','c','a','t','i','o','n','-','a','u','t','o','s','c','a','l','i','n','g','.','{','R',
'e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.','c','o','m','"',',','"','p','r',
'o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}',
'}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',',','{','"','c','o',
'n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',':','{',
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','l','i','c','a','t','i','o',
'n','-','a','u','t','o','s','c','a','l','i','n','g','-','f','i','p','s','.','{','R','e','g','i','o',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','l','i','c','a','t','i','o','n','-',
'a','u','t','o','s','c','a','l','i','n','g','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
const char* ApplicationAutoScalingEndpointRules::GetRulesBlob()
{
