...
DatasourcePackageIngestDetail::DatasourcePackageIngestDetail(JsonView jsonValue) { *this = jsonValue; }
...
DatasourcePackageIngestDetail& DatasourcePackageIngestDetail::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("DatasourcePackageIngestState")) {
    m_datasourcePackageIngestState =
        DatasourcePackageIngestStateMapper::GetDatasourcePackageIngestStateForName(jsonValue.GetString("DatasourcePackageIngestState"));
  ...
  if (jsonValue.ValueExists("LastIngestStateChange")) {
    ...
    for (auto& lastIngestStateChangeItem : lastIngestStateChangeJsonMap) {
      m_lastIngestStateChange[DatasourcePackageIngestStateMapper::GetDatasourcePackageIngestStateForName(lastIngestStateChangeItem.first)] =
          lastIngestStateChangeItem.second.AsObject();
    }
...
JsonValue DatasourcePackageIngestDetail::Jsonize() const {
  ...
  if (m_datasourcePackageIngestStateHasBeenSet) {
    payload.WithString("DatasourcePackageIngestState",
                       DatasourcePackageIngestStateMapper::GetNameForDatasourcePackageIngestState(m_datasourcePackageIngestState));
  }
  ...
  if (m_lastIngestStateChangeHasBeenSet) {
    ...
    for (auto& lastIngestStateChangeItem : m_lastIngestStateChange) {
      lastIngestStateChangeJsonMap.WithObject(
          DatasourcePackageIngestStateMapper::GetNameForDatasourcePackageIngestState(lastIngestStateChangeItem.first),
          lastIngestStateChangeItem.second.Jsonize());
    }
