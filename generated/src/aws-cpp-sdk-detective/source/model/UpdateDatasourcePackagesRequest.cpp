...
Aws::String UpdateDatasourcePackagesRequest::SerializePayload() const {
  ...
  if (m_datasourcePackagesHasBeenSet) {
    ...
    for (unsigned datasourcePackagesIndex = 0; datasourcePackagesIndex < datasourcePackagesJsonList.GetLength();
         ++datasourcePackagesIndex) {
      datasourcePackagesJsonList[datasourcePackagesIndex].AsString(
          DatasourcePackageMapper::GetNameForDatasourcePackage(m_datasourcePackages[datasourcePackagesIndex]));
    }
