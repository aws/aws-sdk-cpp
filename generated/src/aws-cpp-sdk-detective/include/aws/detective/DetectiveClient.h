...
class AWS_DETECTIVE_API DetectiveClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DetectiveClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DetectiveEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetGraphMemberDatasourcesOutcome BatchGetGraphMemberDatasources(
      const Model::BatchGetGraphMemberDatasourcesRequest& request) const;

  /**
   * A Callable wrapper for BatchGetGraphMemberDatasources that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchGetGraphMemberDatasourcesRequestT = Model::BatchGetGraphMemberDatasourcesRequest>
  Model::BatchGetGraphMemberDatasourcesOutcomeCallable BatchGetGraphMemberDatasourcesCallable(
      const BatchGetGraphMemberDatasourcesRequestT& request) const {
    return SubmitCallable(&DetectiveClient::BatchGetGraphMemberDatasources, request);
  }

  /**
   * An Async wrapper for BatchGetGraphMemberDatasources that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchGetGraphMemberDatasourcesRequestT = Model::BatchGetGraphMemberDatasourcesRequest>
  void BatchGetGraphMemberDatasourcesAsync(const BatchGetGraphMemberDatasourcesRequestT& request,
                                           const BatchGetGraphMemberDatasourcesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetMembershipDatasourcesOutcome BatchGetMembershipDatasources(
      const Model::BatchGetMembershipDatasourcesRequest& request) const;

  /**
   * A Callable wrapper for BatchGetMembershipDatasources that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchGetMembershipDatasourcesRequestT = Model::BatchGetMembershipDatasourcesRequest>
  Model::BatchGetMembershipDatasourcesOutcomeCallable BatchGetMembershipDatasourcesCallable(
      const BatchGetMembershipDatasourcesRequestT& request) const {
    return SubmitCallable(&DetectiveClient::BatchGetMembershipDatasources, request);
  }

  /**
   * An Async wrapper for BatchGetMembershipDatasources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetMembershipDatasourcesRequestT = Model::BatchGetMembershipDatasourcesRequest>
  void BatchGetMembershipDatasourcesAsync(const BatchGetMembershipDatasourcesRequestT& request,
                                          const BatchGetMembershipDatasourcesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename CreateGraphRequestT = Model::CreateGraphRequest>
  void CreateGraphAsync(const CreateGraphResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const CreateGraphRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for CreateMembers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateMembersRequestT = Model::CreateMembersRequest>
  void CreateMembersAsync(const CreateMembersRequestT& request, const CreateMembersResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteMembers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteMembersRequestT = Model::DeleteMembersRequest>
  void DeleteMembersAsync(const DeleteMembersRequestT& request, const DeleteMembersResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename DescribeOrganizationConfigurationRequestT = Model::DescribeOrganizationConfigurationRequest>
  void DescribeOrganizationConfigurationAsync(const DescribeOrganizationConfigurationRequestT& request,
   ...
   */
  template <typename DisableOrganizationAdminAccountRequestT = Model::DisableOrganizationAdminAccountRequest>
  void DisableOrganizationAdminAccountAsync(const DisableOrganizationAdminAccountResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DisableOrganizationAdminAccountRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisassociateMembership that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateMembershipRequestT = Model::DisassociateMembershipRequest>
  void DisassociateMembershipAsync(const DisassociateMembershipRequestT& request,
                                   const DisassociateMembershipResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMembers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMembersRequestT = Model::GetMembersRequest>
  ...
  /**
   * A Callable wrapper for ListDatasourcePackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDatasourcePackages that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDatasourcePackagesRequestT = Model::ListDatasourcePackagesRequest>
  void ListDatasourcePackagesAsync(const ListDatasourcePackagesRequestT& request,
                                   const ListDatasourcePackagesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListIndicators that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListIndicatorsRequestT = Model::ListIndicatorsRequest>
  void ListIndicatorsAsync(const ListIndicatorsRequestT& request, const ListIndicatorsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListMembersRequestT = Model::ListMembersRequest>
  void ListMembersAsync(const ListMembersRequestT& request, const ListMembersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RejectInvitation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RejectInvitation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RejectInvitationRequestT = Model::RejectInvitationRequest>
  void RejectInvitationAsync(const RejectInvitationRequestT& request, const RejectInvitationResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartInvestigation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartInvestigation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartInvestigationRequestT = Model::StartInvestigationRequest>
  void StartInvestigationAsync(const StartInvestigationRequestT& request, const StartInvestigationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMonitoringMember that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMonitoringMember that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMonitoringMemberRequestT = Model::StartMonitoringMemberRequest>
  void StartMonitoringMemberAsync(const StartMonitoringMemberRequestT& request, const StartMonitoringMemberResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDatasourcePackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDatasourcePackages that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDatasourcePackagesRequestT = Model::UpdateDatasourcePackagesRequest>
  void UpdateDatasourcePackagesAsync(const UpdateDatasourcePackagesRequestT& request,
                                     const UpdateDatasourcePackagesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateInvestigationState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateInvestigationState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateInvestigationStateRequestT = Model::UpdateInvestigationStateRequest>
  void UpdateInvestigationStateAsync(const UpdateInvestigationStateRequestT& request,
                                     const UpdateInvestigationStateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
