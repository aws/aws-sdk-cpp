...
namespace Model
{
  ...
  {
  public:
    AWS_DETECTIVE_API DescribeOrganizationConfigurationRequest() = default;
    ...
    template<typename GraphArnT = Aws::String>
    DescribeOrganizationConfigurationRequest& WithGraphArn(GraphArnT&& value) { SetGraphArn(std::forward<GraphArnT>(value)); return *this;}
    ///@}
  private:
