...
class ListDatasourcePackagesRequest : public DetectiveRequest {
 public:
  AWS_DETECTIVE_API ListDatasourcePackagesRequest() = default;
  ...
  template <typename GraphArnT = Aws::String>
  ListDatasourcePackagesRequest& WithGraphArn(GraphArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDatasourcePackagesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDatasourcePackagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
