...
class FilterCriteria {
 public:
  ...
  template <typename StatusT = StringFilter>
  FilterCriteria& WithStatus(StatusT&& value) {
  ...
  template <typename StateT = StringFilter>
  FilterCriteria& WithState(StateT&& value) {
  ...
  template <typename EntityArnT = StringFilter>
  FilterCriteria& WithEntityArn(EntityArnT&& value) {
  ...
  template <typename CreatedTimeT = DateFilter>
  FilterCriteria& WithCreatedTime(CreatedTimeT&& value) {
