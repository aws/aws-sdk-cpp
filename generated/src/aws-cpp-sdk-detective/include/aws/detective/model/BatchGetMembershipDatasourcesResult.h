...
class BatchGetMembershipDatasourcesResult {
 public:
  ...
  void SetMembershipDatasources(MembershipDatasourcesT&& value) {
    m_membershipDatasourcesHasBeenSet = true;
    m_membershipDatasources = std::forward<MembershipDatasourcesT>(value);
  }
  template <typename MembershipDatasourcesT = Aws::Vector<MembershipDatasources>>
  BatchGetMembershipDatasourcesResult& WithMembershipDatasources(MembershipDatasourcesT&& value) {
    SetMembershipDatasources(std::forward<MembershipDatasourcesT>(value));
    return *this;
  }
  template <typename MembershipDatasourcesT = MembershipDatasources>
  BatchGetMembershipDatasourcesResult& AddMembershipDatasources(MembershipDatasourcesT&& value) {
    m_membershipDatasourcesHasBeenSet = true;
    m_membershipDatasources.emplace_back(std::forward<MembershipDatasourcesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnprocessedGraphs(UnprocessedGraphsT&& value) {
    m_unprocessedGraphsHasBeenSet = true;
    m_unprocessedGraphs = std::forward<UnprocessedGraphsT>(value);
  }
  template <typename UnprocessedGraphsT = Aws::Vector<UnprocessedGraph>>
  BatchGetMembershipDatasourcesResult& WithUnprocessedGraphs(UnprocessedGraphsT&& value) {
    SetUnprocessedGraphs(std::forward<UnprocessedGraphsT>(value));
    return *this;
  }
  template <typename UnprocessedGraphsT = UnprocessedGraph>
  BatchGetMembershipDatasourcesResult& AddUnprocessedGraphs(UnprocessedGraphsT&& value) {
    m_unprocessedGraphsHasBeenSet = true;
    m_unprocessedGraphs.emplace_back(std::forward<UnprocessedGraphsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetMembershipDatasourcesResult& WithRequestId(RequestIdT&& value) {
