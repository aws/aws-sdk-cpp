...
class Indicator {
 public:
  ...
  inline Indicator& WithIndicatorType(IndicatorType value) {
  ...
  void SetIndicatorDetail(IndicatorDetailT&& value) {
    ...
    m_indicatorDetail = std::forward<IndicatorDetailT>(value);
  }
  template <typename IndicatorDetailT = IndicatorDetail>
  Indicator& WithIndicatorDetail(IndicatorDetailT&& value) {
    SetIndicatorDetail(std::forward<IndicatorDetailT>(value));
    return *this;
  }
  ///@}
 private:
