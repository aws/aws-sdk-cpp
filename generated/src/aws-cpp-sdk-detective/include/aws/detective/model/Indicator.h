...
namespace Model
{
  ...
  /**
   * <p>Investigations triages indicators of compromises such as a finding and
   * surfaces only the most critical and suspicious issues, so you can focus on
   * high-level investigations. </p><p><h3>See Also:</h3>   <a
