...
class ListIndicatorsRequest : public DetectiveRequest {
 public:
  ...
  inline void SetIndicatorType(IndicatorType value) {
    m_indicatorTypeHasBeenSet = true;
    m_indicatorType = value;
  }
  inline ListIndicatorsRequest& WithIndicatorType(IndicatorType value) {
  ...
  inline ListIndicatorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
