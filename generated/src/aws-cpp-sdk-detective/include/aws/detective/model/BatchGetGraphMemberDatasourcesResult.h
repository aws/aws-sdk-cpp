...
class BatchGetGraphMemberDatasourcesResult {
 public:
  ...
  void SetMemberDatasources(MemberDatasourcesT&& value) {
    m_memberDatasourcesHasBeenSet = true;
    m_memberDatasources = std::forward<MemberDatasourcesT>(value);
  }
  template <typename MemberDatasourcesT = Aws::Vector<MembershipDatasources>>
  BatchGetGraphMemberDatasourcesResult& WithMemberDatasources(MemberDatasourcesT&& value) {
    SetMemberDatasources(std::forward<MemberDatasourcesT>(value));
    return *this;
  }
  template <typename MemberDatasourcesT = MembershipDatasources>
  BatchGetGraphMemberDatasourcesResult& AddMemberDatasources(MemberDatasourcesT&& value) {
    m_memberDatasourcesHasBeenSet = true;
    m_memberDatasources.emplace_back(std::forward<MemberDatasourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UnprocessedAccountsT = Aws::Vector<UnprocessedAccount>>
  BatchGetGraphMemberDatasourcesResult& WithUnprocessedAccounts(UnprocessedAccountsT&& value) {
    SetUnprocessedAccounts(std::forward<UnprocessedAccountsT>(value));
    return *this;
  }
  template <typename UnprocessedAccountsT = UnprocessedAccount>
  BatchGetGraphMemberDatasourcesResult& AddUnprocessedAccounts(UnprocessedAccountsT&& value) {
    m_unprocessedAccountsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetGraphMemberDatasourcesResult& WithRequestId(RequestIdT&& value) {
