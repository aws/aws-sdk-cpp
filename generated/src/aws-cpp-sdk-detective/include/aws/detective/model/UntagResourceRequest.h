...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public DetectiveRequest
  {
  public:
    AWS_DETECTIVE_API UntagResourceRequest() = default;
    ...
    AWS_DETECTIVE_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
