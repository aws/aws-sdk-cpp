...
class ListDatasourcePackagesResult {
 public:
  ...
  template <typename DatasourcePackagesT = Aws::Map<DatasourcePackage, DatasourcePackageIngestDetail>>
  ListDatasourcePackagesResult& WithDatasourcePackages(DatasourcePackagesT&& value) {
  ...
  inline ListDatasourcePackagesResult& AddDatasourcePackages(DatasourcePackage key, DatasourcePackageIngestDetail value) {
    m_datasourcePackagesHasBeenSet = true;
    m_datasourcePackages.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDatasourcePackagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDatasourcePackagesResult& WithRequestId(RequestIdT&& value) {
