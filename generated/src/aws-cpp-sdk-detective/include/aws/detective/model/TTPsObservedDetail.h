...
class TTPsObservedDetail {
 public:
  ...
  void SetProcedure(ProcedureT&& value) {
    ...
    m_procedure = std::forward<ProcedureT>(value);
  }
  template <typename ProcedureT = Aws::String>
  TTPsObservedDetail& WithProcedure(ProcedureT&& value) {
    SetProcedure(std::forward<ProcedureT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAPISuccessCount(long long value) {
    m_aPISuccessCountHasBeenSet = true;
    m_aPISuccessCount = value;
  }
  inline TTPsObservedDetail& WithAPISuccessCount(long long value) {
    SetAPISuccessCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAPIFailureCount(long long value) {
    m_aPIFailureCountHasBeenSet = true;
    m_aPIFailureCount = value;
  }
  inline TTPsObservedDetail& WithAPIFailureCount(long long value) {
    SetAPIFailureCount(value);
    return *this;
  }
  ///@}
 private:
