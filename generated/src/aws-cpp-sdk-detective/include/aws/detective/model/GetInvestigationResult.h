...
class GetInvestigationResult {
 public:
  ...
  inline GetInvestigationResult& WithEntityType(EntityType value) {
    SetEntityType(value);
    return *this;
  }
  ///@}
  ...
  inline GetInvestigationResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetInvestigationResult& WithSeverity(Severity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline GetInvestigationResult& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
