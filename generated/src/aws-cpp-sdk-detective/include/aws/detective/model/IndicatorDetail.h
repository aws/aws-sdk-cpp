...
class IndicatorDetail {
 public:
  ...
  void SetTTPsObservedDetail(TTPsObservedDetailT&& value) {
    ...
    m_tTPsObservedDetail = std::forward<TTPsObservedDetailT>(value);
  }
  template <typename TTPsObservedDetailT = TTPsObservedDetail>
  IndicatorDetail& WithTTPsObservedDetail(TTPsObservedDetailT&& value) {
    SetTTPsObservedDetail(std::forward<TTPsObservedDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpossibleTravelDetail(ImpossibleTravelDetailT&& value) {
    ...
    m_impossibleTravelDetail = std::forward<ImpossibleTravelDetailT>(value);
  }
  template <typename ImpossibleTravelDetailT = ImpossibleTravelDetail>
  IndicatorDetail& WithImpossibleTravelDetail(ImpossibleTravelDetailT&& value) {
    SetImpossibleTravelDetail(std::forward<ImpossibleTravelDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFlaggedIpAddressDetail(FlaggedIpAddressDetailT&& value) {
    ...
    m_flaggedIpAddressDetail = std::forward<FlaggedIpAddressDetailT>(value);
  }
  template <typename FlaggedIpAddressDetailT = FlaggedIpAddressDetail>
  IndicatorDetail& WithFlaggedIpAddressDetail(FlaggedIpAddressDetailT&& value) {
    SetFlaggedIpAddressDetail(std::forward<FlaggedIpAddressDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewGeolocationDetail(NewGeolocationDetailT&& value) {
    ...
    m_newGeolocationDetail = std::forward<NewGeolocationDetailT>(value);
  }
  template <typename NewGeolocationDetailT = NewGeolocationDetail>
  IndicatorDetail& WithNewGeolocationDetail(NewGeolocationDetailT&& value) {
    SetNewGeolocationDetail(std::forward<NewGeolocationDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewAsoDetail(NewAsoDetailT&& value) {
    ...
    m_newAsoDetail = std::forward<NewAsoDetailT>(value);
  }
  template <typename NewAsoDetailT = NewAsoDetail>
  IndicatorDetail& WithNewAsoDetail(NewAsoDetailT&& value) {
    SetNewAsoDetail(std::forward<NewAsoDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewUserAgentDetail(NewUserAgentDetailT&& value) {
    ...
    m_newUserAgentDetail = std::forward<NewUserAgentDetailT>(value);
  }
  template <typename NewUserAgentDetailT = NewUserAgentDetail>
  IndicatorDetail& WithNewUserAgentDetail(NewUserAgentDetailT&& value) {
    SetNewUserAgentDetail(std::forward<NewUserAgentDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelatedFindingDetail(RelatedFindingDetailT&& value) {
    ...
    m_relatedFindingDetail = std::forward<RelatedFindingDetailT>(value);
  }
  template <typename RelatedFindingDetailT = RelatedFindingDetail>
  IndicatorDetail& WithRelatedFindingDetail(RelatedFindingDetailT&& value) {
    SetRelatedFindingDetail(std::forward<RelatedFindingDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelatedFindingGroupDetail(RelatedFindingGroupDetailT&& value) {
    ...
    m_relatedFindingGroupDetail = std::forward<RelatedFindingGroupDetailT>(value);
  }
  template <typename RelatedFindingGroupDetailT = RelatedFindingGroupDetail>
  IndicatorDetail& WithRelatedFindingGroupDetail(RelatedFindingGroupDetailT&& value) {
    SetRelatedFindingGroupDetail(std::forward<RelatedFindingGroupDetailT>(value));
    return *this;
  }
  ///@}
 private:
