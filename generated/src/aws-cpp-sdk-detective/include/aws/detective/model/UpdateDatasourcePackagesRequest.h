...
class UpdateDatasourcePackagesRequest : public DetectiveRequest {
 public:
  ...
  void SetDatasourcePackages(DatasourcePackagesT&& value) {
    m_datasourcePackagesHasBeenSet = true;
    m_datasourcePackages = std::forward<DatasourcePackagesT>(value);
  }
  template <typename DatasourcePackagesT = Aws::Vector<DatasourcePackage>>
  UpdateDatasourcePackagesRequest& WithDatasourcePackages(DatasourcePackagesT&& value) {
    SetDatasourcePackages(std::forward<DatasourcePackagesT>(value));
    return *this;
  }
  inline UpdateDatasourcePackagesRequest& AddDatasourcePackages(DatasourcePackage value) {
    m_datasourcePackagesHasBeenSet = true;
    m_datasourcePackages.push_back(value);
    return *this;
  }
  ///@}
 private:
