...
class DatasourcePackageIngestDetail {
 public:
  ...
  inline void SetDatasourcePackageIngestState(DatasourcePackageIngestState value) {
    m_datasourcePackageIngestStateHasBeenSet = true;
    m_datasourcePackageIngestState = value;
  }
  inline DatasourcePackageIngestDetail& WithDatasourcePackageIngestState(DatasourcePackageIngestState value) {
    SetDatasourcePackageIngestState(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Map<DatasourcePackageIngestState, TimestampForCollection>& GetLastIngestStateChange() const {
    return m_lastIngestStateChange;
  }
  ...
  void SetLastIngestStateChange(LastIngestStateChangeT&& value) {
    ...
    m_lastIngestStateChange = std::forward<LastIngestStateChangeT>(value);
  }
  template <typename LastIngestStateChangeT = Aws::Map<DatasourcePackageIngestState, TimestampForCollection>>
  DatasourcePackageIngestDetail& WithLastIngestStateChange(LastIngestStateChangeT&& value) {
    SetLastIngestStateChange(std::forward<LastIngestStateChangeT>(value));
    return *this;
  }
  inline DatasourcePackageIngestDetail& AddLastIngestStateChange(DatasourcePackageIngestState key, TimestampForCollection value) {
    m_lastIngestStateChangeHasBeenSet = true;
    m_lastIngestStateChange.emplace(key, value);
    return *this;
  }
  ///@}
 private:
