...
namespace LexModelBuildingService
{
   ...
   * applications. </p>
   */
  class AWS_LEXMODELBUILDINGSERVICE_API LexModelBuildingServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<LexModelBuildingServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::LexModelBuildingService::SERVICE_NAME,
