...
class AWS_LEXMODELBUILDINGSERVICE_API LexModelBuildingServiceClient
 ...
 public:
  ...
  /**
   * A Callable wrapper for CreateIntentVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateIntentVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateIntentVersionRequestT = Model::CreateIntentVersionRequest>
  void CreateIntentVersionAsync(const CreateIntentVersionRequestT& request, const CreateIntentVersionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSlotTypeVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSlotTypeVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSlotTypeVersionRequestT = Model::CreateSlotTypeVersionRequest>
  void CreateSlotTypeVersionAsync(const CreateSlotTypeVersionRequestT& request, const CreateSlotTypeVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBotChannelAssociationOutcome DeleteBotChannelAssociation(
      const Model::DeleteBotChannelAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteBotChannelAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteBotChannelAssociationRequestT = Model::DeleteBotChannelAssociationRequest>
  Model::DeleteBotChannelAssociationOutcomeCallable DeleteBotChannelAssociationCallable(
      const DeleteBotChannelAssociationRequestT& request) const {
    return SubmitCallable(&LexModelBuildingServiceClient::DeleteBotChannelAssociation, request);
  }

  /**
   * An Async wrapper for DeleteBotChannelAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBotChannelAssociationRequestT = Model::DeleteBotChannelAssociationRequest>
  void DeleteBotChannelAssociationAsync(const DeleteBotChannelAssociationRequestT& request,
                                        const DeleteBotChannelAssociationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteIntentVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteIntentVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteIntentVersionRequestT = Model::DeleteIntentVersionRequest>
  void DeleteIntentVersionAsync(const DeleteIntentVersionRequestT& request, const DeleteIntentVersionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSlotTypeVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSlotTypeVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSlotTypeVersionRequestT = Model::DeleteSlotTypeVersionRequest>
  void DeleteSlotTypeVersionAsync(const DeleteSlotTypeVersionRequestT& request, const DeleteSlotTypeVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBotAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBotAliasRequestT = Model::GetBotAliasRequest>
  void GetBotAliasAsync(const GetBotAliasRequestT& request, const GetBotAliasResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBotAliases that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBotAliasesRequestT = Model::GetBotAliasesRequest>
  void GetBotAliasesAsync(const GetBotAliasesRequestT& request, const GetBotAliasesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBotChannelAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBotChannelAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBotChannelAssociationRequestT = Model::GetBotChannelAssociationRequest>
  void GetBotChannelAssociationAsync(const GetBotChannelAssociationRequestT& request,
                                     const GetBotChannelAssociationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBotChannelAssociations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetBotChannelAssociationsRequestT = Model::GetBotChannelAssociationsRequest>
  Model::GetBotChannelAssociationsOutcomeCallable GetBotChannelAssociationsCallable(
      const GetBotChannelAssociationsRequestT& request) const {
    return SubmitCallable(&LexModelBuildingServiceClient::GetBotChannelAssociations, request);
  }

  /**
   * An Async wrapper for GetBotChannelAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBotChannelAssociationsRequestT = Model::GetBotChannelAssociationsRequest>
  void GetBotChannelAssociationsAsync(const GetBotChannelAssociationsRequestT& request,
                                      const GetBotChannelAssociationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBotVersions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBotVersionsRequestT = Model::GetBotVersionsRequest>
  void GetBotVersionsAsync(const GetBotVersionsRequestT& request, const GetBotVersionsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBots that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBotsRequestT = Model::GetBotsRequest>
  void GetBotsAsync(const GetBotsResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                    const GetBotsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetBuiltinIntent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBuiltinIntent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBuiltinIntentRequestT = Model::GetBuiltinIntentRequest>
  void GetBuiltinIntentAsync(const GetBuiltinIntentRequestT& request, const GetBuiltinIntentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBuiltinIntents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBuiltinIntents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBuiltinIntentsRequestT = Model::GetBuiltinIntentsRequest>
  void GetBuiltinIntentsAsync(const GetBuiltinIntentsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetBuiltinIntentsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetBuiltinSlotTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBuiltinSlotTypes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBuiltinSlotTypesRequestT = Model::GetBuiltinSlotTypesRequest>
  void GetBuiltinSlotTypesAsync(const GetBuiltinSlotTypesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetBuiltinSlotTypesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetIntent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetIntentRequestT = Model::GetIntentRequest>
  void GetIntentAsync(const GetIntentRequestT& request, const GetIntentResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetIntentVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIntentVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetIntentVersionsRequestT = Model::GetIntentVersionsRequest>
  void GetIntentVersionsAsync(const GetIntentVersionsRequestT& request, const GetIntentVersionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetIntents that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetIntentsRequestT = Model::GetIntentsRequest>
  void GetIntentsAsync(const GetIntentsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const GetIntentsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetMigrations that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMigrationsRequestT = Model::GetMigrationsRequest>
  void GetMigrationsAsync(const GetMigrationsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const GetMigrationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetSlotType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSlotTypeRequestT = Model::GetSlotTypeRequest>
  void GetSlotTypeAsync(const GetSlotTypeRequestT& request, const GetSlotTypeResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSlotTypeVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSlotTypeVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSlotTypeVersionsRequestT = Model::GetSlotTypeVersionsRequest>
  void GetSlotTypeVersionsAsync(const GetSlotTypeVersionsRequestT& request, const GetSlotTypeVersionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSlotTypes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSlotTypesRequestT = Model::GetSlotTypesRequest>
  void GetSlotTypesAsync(const GetSlotTypesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const GetSlotTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetUtterancesView that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetUtterancesView that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetUtterancesViewRequestT = Model::GetUtterancesViewRequest>
  void GetUtterancesViewAsync(const GetUtterancesViewRequestT& request, const GetUtterancesViewResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutBot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutBotRequestT = Model::PutBotRequest>
  void PutBotAsync(const PutBotRequestT& request, const PutBotResponseReceivedHandler& handler,
                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutBotAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutBotAliasRequestT = Model::PutBotAliasRequest>
  void PutBotAliasAsync(const PutBotAliasRequestT& request, const PutBotAliasResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutIntent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutIntentRequestT = Model::PutIntentRequest>
  void PutIntentAsync(const PutIntentRequestT& request, const PutIntentResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutSlotType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutSlotTypeRequestT = Model::PutSlotTypeRequest>
  void PutSlotTypeAsync(const PutSlotTypeRequestT& request, const PutSlotTypeResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
