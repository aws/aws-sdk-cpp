...
class CreateBotVersionResult {
 public:
  ...
  inline CreateBotVersionResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateBotVersionResult& WithIdleSessionTTLInSeconds(int value) {
  ...
  inline CreateBotVersionResult& WithLocale(Locale value) {
    SetLocale(value);
    return *this;
  }
  ///@}
  ...
  inline CreateBotVersionResult& WithChildDirected(bool value) {
  ...
  inline CreateBotVersionResult& WithEnableModelImprovements(bool value) {
  ...
  inline CreateBotVersionResult& WithDetectSentiment(bool value) {
