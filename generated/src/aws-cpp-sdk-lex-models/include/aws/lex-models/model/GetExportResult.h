...
class GetExportResult {
 public:
  ...
  template <typename NameT = Aws::String>
  GetExportResult& WithName(NameT&& value) {
  ...
  inline GetExportResult& WithResourceType(ResourceType value) {
  ...
  inline void SetExportType(ExportType value) {
    m_exportTypeHasBeenSet = true;
    m_exportType = value;
  }
  inline GetExportResult& WithExportType(ExportType value) {
    SetExportType(value);
    return *this;
  }
  ///@}
  ...
  template <typename UrlT = Aws::String>
  GetExportResult& WithUrl(UrlT&& value) {
