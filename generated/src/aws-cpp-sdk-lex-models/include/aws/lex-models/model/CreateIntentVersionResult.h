...
class CreateIntentVersionResult {
 public:
  ...
  AWS_LEXMODELBUILDINGSERVICE_API CreateIntentVersionResult& operator=(
  ...
  CreateIntentVersionResult& AddSlots(SlotsT&& value) {
    m_slotsHasBeenSet = true;
    m_slots.emplace_back(std::forward<SlotsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfirmationPrompt(ConfirmationPromptT&& value) {
    ...
    m_confirmationPrompt = std::forward<ConfirmationPromptT>(value);
  }
  template <typename ConfirmationPromptT = Prompt>
  CreateIntentVersionResult& WithConfirmationPrompt(ConfirmationPromptT&& value) {
    SetConfirmationPrompt(std::forward<ConfirmationPromptT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRejectionStatement(RejectionStatementT&& value) {
    ...
    m_rejectionStatement = std::forward<RejectionStatementT>(value);
  }
  template <typename RejectionStatementT = Statement>
  CreateIntentVersionResult& WithRejectionStatement(RejectionStatementT&& value) {
    SetRejectionStatement(std::forward<RejectionStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFollowUpPrompt(FollowUpPromptT&& value) {
    ...
    m_followUpPrompt = std::forward<FollowUpPromptT>(value);
  }
  template <typename FollowUpPromptT = FollowUpPrompt>
  CreateIntentVersionResult& WithFollowUpPrompt(FollowUpPromptT&& value) {
    SetFollowUpPrompt(std::forward<FollowUpPromptT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConclusionStatement(ConclusionStatementT&& value) {
    ...
    m_conclusionStatement = std::forward<ConclusionStatementT>(value);
  }
  template <typename ConclusionStatementT = Statement>
  CreateIntentVersionResult& WithConclusionStatement(ConclusionStatementT&& value) {
    SetConclusionStatement(std::forward<ConclusionStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFulfillmentActivity(FulfillmentActivityT&& value) {
    ...
    m_fulfillmentActivity = std::forward<FulfillmentActivityT>(value);
  }
  template <typename FulfillmentActivityT = FulfillmentActivity>
  CreateIntentVersionResult& WithFulfillmentActivity(FulfillmentActivityT&& value) {
    SetFulfillmentActivity(std::forward<FulfillmentActivityT>(value));
    return *this;
  }
  ///@}
