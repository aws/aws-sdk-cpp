...
class GetIntentsRequest : public LexModelBuildingServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  GetIntentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetIntentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  GetIntentsRequest& WithNameContains(NameContainsT&& value) {
