...
class GetImportResult {
 public:
  ...
  template <typename NameT = Aws::String>
  GetImportResult& WithName(NameT&& value) {
  ...
  inline GetImportResult& WithResourceType(ResourceType value) {
  ...
  inline GetImportResult& WithMergeStrategy(MergeStrategy value) {
  ...
  inline GetImportResult& WithImportStatus(ImportStatus value) {
  ...
  template <typename FailureReasonT = Aws::Vector<Aws::String>>
  GetImportResult& WithFailureReason(FailureReasonT&& value) {
    SetFailureReason(std::forward<FailureReasonT>(value));
    return *this;
  }
  template <typename FailureReasonT = Aws::String>
  GetImportResult& AddFailureReason(FailureReasonT&& value) {
    m_failureReasonHasBeenSet = true;
    m_failureReason.emplace_back(std::forward<FailureReasonT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  GetImportResult& WithCreatedDate(CreatedDateT&& value) {
