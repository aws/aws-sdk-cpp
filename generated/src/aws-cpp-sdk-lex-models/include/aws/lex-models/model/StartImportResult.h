...
class StartImportResult {
 public:
  ...
  template <typename NameT = Aws::String>
  StartImportResult& WithName(NameT&& value) {
  ...
  inline StartImportResult& WithResourceType(ResourceType value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  StartImportResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  StartImportResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  StartImportResult& WithCreatedDate(CreatedDateT&& value) {
