...
/**
 */
class GetSlotTypesRequest : public LexModelBuildingServiceRequest {
 public:
  AWS_LEXMODELBUILDINGSERVICE_API GetSlotTypesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  GetSlotTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetSlotTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  GetSlotTypesRequest& WithNameContains(NameContainsT&& value) {
