...
class GetSlotTypeResult {
 public:
  ...
  template <typename NameT = Aws::String>
  GetSlotTypeResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetSlotTypeResult& WithDescription(DescriptionT&& value) {
  ...
  void SetEnumerationValues(EnumerationValuesT&& value) {
    m_enumerationValuesHasBeenSet = true;
    m_enumerationValues = std::forward<EnumerationValuesT>(value);
  }
  template <typename EnumerationValuesT = Aws::Vector<EnumerationValue>>
  GetSlotTypeResult& WithEnumerationValues(EnumerationValuesT&& value) {
    SetEnumerationValues(std::forward<EnumerationValuesT>(value));
    return *this;
  }
  template <typename EnumerationValuesT = EnumerationValue>
  GetSlotTypeResult& AddEnumerationValues(EnumerationValuesT&& value) {
    m_enumerationValuesHasBeenSet = true;
    m_enumerationValues.emplace_back(std::forward<EnumerationValuesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedDateT = Aws::Utils::DateTime>
  GetSlotTypeResult& WithLastUpdatedDate(LastUpdatedDateT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  GetSlotTypeResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename VersionT = Aws::String>
  GetSlotTypeResult& WithVersion(VersionT&& value) {
  ...
  template <typename ChecksumT = Aws::String>
  GetSlotTypeResult& WithChecksum(ChecksumT&& value) {
  ...
  inline void SetValueSelectionStrategy(SlotValueSelectionStrategy value) {
    m_valueSelectionStrategyHasBeenSet = true;
    m_valueSelectionStrategy = value;
  }
  inline GetSlotTypeResult& WithValueSelectionStrategy(SlotValueSelectionStrategy value) {
    SetValueSelectionStrategy(value);
    return *this;
  }
  ///@}
  ...
  template <typename ParentSlotTypeSignatureT = Aws::String>
  GetSlotTypeResult& WithParentSlotTypeSignature(ParentSlotTypeSignatureT&& value) {
  ...
  void SetSlotTypeConfigurations(SlotTypeConfigurationsT&& value) {
    m_slotTypeConfigurationsHasBeenSet = true;
    m_slotTypeConfigurations = std::forward<SlotTypeConfigurationsT>(value);
  }
  template <typename SlotTypeConfigurationsT = Aws::Vector<SlotTypeConfiguration>>
  GetSlotTypeResult& WithSlotTypeConfigurations(SlotTypeConfigurationsT&& value) {
    SetSlotTypeConfigurations(std::forward<SlotTypeConfigurationsT>(value));
    return *this;
  }
  template <typename SlotTypeConfigurationsT = SlotTypeConfiguration>
  GetSlotTypeResult& AddSlotTypeConfigurations(SlotTypeConfigurationsT&& value) {
    m_slotTypeConfigurationsHasBeenSet = true;
    m_slotTypeConfigurations.emplace_back(std::forward<SlotTypeConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetSlotTypeResult& WithRequestId(RequestIdT&& value) {
