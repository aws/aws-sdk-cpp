...
class GetBotChannelAssociationsResult {
 public:
  ...
  AWS_LEXMODELBUILDINGSERVICE_API GetBotChannelAssociationsResult& operator=(
  ...
  void SetBotChannelAssociations(BotChannelAssociationsT&& value) {
    ...
    m_botChannelAssociations = std::forward<BotChannelAssociationsT>(value);
  }
  template <typename BotChannelAssociationsT = Aws::Vector<BotChannelAssociation>>
  GetBotChannelAssociationsResult& WithBotChannelAssociations(BotChannelAssociationsT&& value) {
    SetBotChannelAssociations(std::forward<BotChannelAssociationsT>(value));
    return *this;
  }
  ...
  GetBotChannelAssociationsResult& AddBotChannelAssociations(BotChannelAssociationsT&& value) {
    m_botChannelAssociationsHasBeenSet = true;
    m_botChannelAssociations.emplace_back(std::forward<BotChannelAssociationsT>(value));
    return *this;
  }
  ///@}
