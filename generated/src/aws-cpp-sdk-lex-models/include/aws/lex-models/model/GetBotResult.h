...
class GetBotResult {
 public:
  ...
  inline GetBotResult& WithEnableModelImprovements(bool value) {
  ...
  inline GetBotResult& WithNluIntentConfidenceThreshold(double value) {
  ...
  inline GetBotResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetBotResult& WithIdleSessionTTLInSeconds(int value) {
  ...
  inline GetBotResult& WithLocale(Locale value) {
    SetLocale(value);
    return *this;
  }
  ///@}
  ...
  inline GetBotResult& WithChildDirected(bool value) {
  ...
  inline GetBotResult& WithDetectSentiment(bool value) {
