...
class StartMigrationRequest : public LexModelBuildingServiceRequest {
 public:
  ...
  void SetV2BotName(V2BotNameT&& value) {
    m_v2BotNameHasBeenSet = true;
    m_v2BotName = std::forward<V2BotNameT>(value);
  }
  template <typename V2BotNameT = Aws::String>
  StartMigrationRequest& WithV2BotName(V2BotNameT&& value) {
    SetV2BotName(std::forward<V2BotNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline StartMigrationRequest& WithMigrationStrategy(MigrationStrategy value) {
