...
class KendraConfiguration {
 public:
  ...
  void SetKendraIndex(KendraIndexT&& value) {
    ...
    m_kendraIndex = std::forward<KendraIndexT>(value);
  }
  template <typename KendraIndexT = Aws::String>
  KendraConfiguration& WithKendraIndex(KendraIndexT&& value) {
    SetKendraIndex(std::forward<KendraIndexT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueryFilterString(QueryFilterStringT&& value) {
    ...
    m_queryFilterString = std::forward<QueryFilterStringT>(value);
  }
  template <typename QueryFilterStringT = Aws::String>
  KendraConfiguration& WithQueryFilterString(QueryFilterStringT&& value) {
    SetQueryFilterString(std::forward<QueryFilterStringT>(value));
    return *this;
  }
  ///@}
