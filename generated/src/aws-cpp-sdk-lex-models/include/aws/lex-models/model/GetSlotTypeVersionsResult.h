...
class GetSlotTypeVersionsResult {
 public:
  ...
  AWS_LEXMODELBUILDINGSERVICE_API GetSlotTypeVersionsResult& operator=(
  ...
  template <typename SlotTypesT = Aws::Vector<SlotTypeMetadata>>
  GetSlotTypeVersionsResult& WithSlotTypes(SlotTypesT&& value) {
    SetSlotTypes(std::forward<SlotTypesT>(value));
    return *this;
  }
  template <typename SlotTypesT = SlotTypeMetadata>
  GetSlotTypeVersionsResult& AddSlotTypes(SlotTypesT&& value) {
    m_slotTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetSlotTypeVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSlotTypeVersionsResult& WithRequestId(RequestIdT&& value) {
