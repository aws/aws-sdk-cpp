...
class ResourceInUseException {
 public:
  ...
  inline ResourceInUseException& WithReferenceType(ReferenceType value) {
  ...
  void SetExampleReference(ExampleReferenceT&& value) {
    ...
    m_exampleReference = std::forward<ExampleReferenceT>(value);
  }
  template <typename ExampleReferenceT = ResourceReference>
  ResourceInUseException& WithExampleReference(ExampleReferenceT&& value) {
    SetExampleReference(std::forward<ExampleReferenceT>(value));
    return *this;
  }
  ///@}
 private:
