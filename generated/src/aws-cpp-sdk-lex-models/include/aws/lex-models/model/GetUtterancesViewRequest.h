...
class GetUtterancesViewRequest : public LexModelBuildingServiceRequest {
 public:
  ...
  void SetBotVersions(BotVersionsT&& value) {
    m_botVersionsHasBeenSet = true;
    m_botVersions = std::forward<BotVersionsT>(value);
  }
  template <typename BotVersionsT = Aws::Vector<Aws::String>>
  GetUtterancesViewRequest& WithBotVersions(BotVersionsT&& value) {
    SetBotVersions(std::forward<BotVersionsT>(value));
    return *this;
  }
  template <typename BotVersionsT = Aws::String>
  GetUtterancesViewRequest& AddBotVersions(BotVersionsT&& value) {
    m_botVersionsHasBeenSet = true;
    m_botVersions.emplace_back(std::forward<BotVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetUtterancesViewRequest& WithStatusType(StatusType value) {
    SetStatusType(value);
    return *this;
  }
  ///@}
