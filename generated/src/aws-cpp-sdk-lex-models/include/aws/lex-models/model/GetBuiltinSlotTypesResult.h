...
class GetBuiltinSlotTypesResult {
 public:
  ...
  AWS_LEXMODELBUILDINGSERVICE_API GetBuiltinSlotTypesResult& operator=(
  ...
  template <typename SlotTypesT = Aws::Vector<BuiltinSlotTypeMetadata>>
  GetBuiltinSlotTypesResult& WithSlotTypes(SlotTypesT&& value) {
    SetSlotTypes(std::forward<SlotTypesT>(value));
    return *this;
  }
  template <typename SlotTypesT = BuiltinSlotTypeMetadata>
  GetBuiltinSlotTypesResult& AddSlotTypes(SlotTypesT&& value) {
    m_slotTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetBuiltinSlotTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBuiltinSlotTypesResult& WithRequestId(RequestIdT&& value) {
