...
class CreateSlotTypeVersionResult {
 public:
  AWS_LEXMODELBUILDINGSERVICE_API CreateSlotTypeVersionResult() = default;
  ...
  AWS_LEXMODELBUILDINGSERVICE_API CreateSlotTypeVersionResult& operator=(
  ...
  template <typename NameT = Aws::String>
  CreateSlotTypeVersionResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateSlotTypeVersionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename EnumerationValuesT = Aws::Vector<EnumerationValue>>
  CreateSlotTypeVersionResult& WithEnumerationValues(EnumerationValuesT&& value) {
    SetEnumerationValues(std::forward<EnumerationValuesT>(value));
    return *this;
  }
  template <typename EnumerationValuesT = EnumerationValue>
  CreateSlotTypeVersionResult& AddEnumerationValues(EnumerationValuesT&& value) {
    m_enumerationValuesHasBeenSet = true;
  ...
  template <typename LastUpdatedDateT = Aws::Utils::DateTime>
  CreateSlotTypeVersionResult& WithLastUpdatedDate(LastUpdatedDateT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  CreateSlotTypeVersionResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename VersionT = Aws::String>
  CreateSlotTypeVersionResult& WithVersion(VersionT&& value) {
  ...
  template <typename ChecksumT = Aws::String>
  CreateSlotTypeVersionResult& WithChecksum(ChecksumT&& value) {
  ...
  inline CreateSlotTypeVersionResult& WithValueSelectionStrategy(SlotValueSelectionStrategy value) {
  ...
  template <typename ParentSlotTypeSignatureT = Aws::String>
  CreateSlotTypeVersionResult& WithParentSlotTypeSignature(ParentSlotTypeSignatureT&& value) {
  ...
  template <typename SlotTypeConfigurationsT = Aws::Vector<SlotTypeConfiguration>>
  CreateSlotTypeVersionResult& WithSlotTypeConfigurations(SlotTypeConfigurationsT&& value) {
  ...
  CreateSlotTypeVersionResult& AddSlotTypeConfigurations(SlotTypeConfigurationsT&& value) {
    m_slotTypeConfigurationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateSlotTypeVersionResult& WithRequestId(RequestIdT&& value) {
