...
class PutSlotTypeRequest : public LexModelBuildingServiceRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  PutSlotTypeRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  PutSlotTypeRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename EnumerationValuesT = Aws::Vector<EnumerationValue>>
  PutSlotTypeRequest& WithEnumerationValues(EnumerationValuesT&& value) {
    SetEnumerationValues(std::forward<EnumerationValuesT>(value));
    return *this;
  }
  template <typename EnumerationValuesT = EnumerationValue>
  PutSlotTypeRequest& AddEnumerationValues(EnumerationValuesT&& value) {
    m_enumerationValuesHasBeenSet = true;
  ...
  template <typename ChecksumT = Aws::String>
  PutSlotTypeRequest& WithChecksum(ChecksumT&& value) {
  ...
  inline PutSlotTypeRequest& WithValueSelectionStrategy(SlotValueSelectionStrategy value) {
  ...
  inline PutSlotTypeRequest& WithCreateVersion(bool value) {
  ...
  template <typename ParentSlotTypeSignatureT = Aws::String>
  PutSlotTypeRequest& WithParentSlotTypeSignature(ParentSlotTypeSignatureT&& value) {
  ...
  template <typename SlotTypeConfigurationsT = Aws::Vector<SlotTypeConfiguration>>
  PutSlotTypeRequest& WithSlotTypeConfigurations(SlotTypeConfigurationsT&& value) {
  ...
  PutSlotTypeRequest& AddSlotTypeConfigurations(SlotTypeConfigurationsT&& value) {
    m_slotTypeConfigurationsHasBeenSet = true;
