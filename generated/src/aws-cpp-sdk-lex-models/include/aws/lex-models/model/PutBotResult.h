...
class PutBotResult {
 public:
  ...
  inline PutBotResult& WithEnableModelImprovements(bool value) {
  ...
  inline PutBotResult& WithNluIntentConfidenceThreshold(double value) {
  ...
  inline PutBotResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline PutBotResult& WithIdleSessionTTLInSeconds(int value) {
  ...
  inline PutBotResult& WithLocale(Locale value) {
    SetLocale(value);
    return *this;
  }
  ///@}
  ...
  inline PutBotResult& WithChildDirected(bool value) {
  ...
  inline PutBotResult& WithCreateVersion(bool value) {
  ...
  inline PutBotResult& WithDetectSentiment(bool value) {
