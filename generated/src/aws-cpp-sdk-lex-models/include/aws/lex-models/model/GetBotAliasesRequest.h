...
class GetBotAliasesRequest : public LexModelBuildingServiceRequest {
 public:
  ...
  template <typename BotNameT = Aws::String>
  GetBotAliasesRequest& WithBotName(BotNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetBotAliasesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetBotAliasesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  GetBotAliasesRequest& WithNameContains(NameContainsT&& value) {
