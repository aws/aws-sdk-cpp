...
/**
 */
class GetIntentVersionsRequest : public LexModelBuildingServiceRequest {
 public:
  AWS_LEXMODELBUILDINGSERVICE_API GetIntentVersionsRequest() = default;
  ...
  template <typename NameT = Aws::String>
  GetIntentVersionsRequest& WithName(NameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetIntentVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetIntentVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
