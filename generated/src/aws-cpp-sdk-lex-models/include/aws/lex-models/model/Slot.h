...
class Slot {
 public:
  ...
  inline void SetSlotConstraint(SlotConstraint value) {
    m_slotConstraintHasBeenSet = true;
    m_slotConstraint = value;
  }
  inline Slot& WithSlotConstraint(SlotConstraint value) {
    SetSlotConstraint(value);
    return *this;
  }
  ///@}
  ...
  void SetSlotType(SlotTypeT&& value) {
    ...
    m_slotType = std::forward<SlotTypeT>(value);
  }
  template <typename SlotTypeT = Aws::String>
  Slot& WithSlotType(SlotTypeT&& value) {
    SetSlotType(std::forward<SlotTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSlotTypeVersion(SlotTypeVersionT&& value) {
    ...
    m_slotTypeVersion = std::forward<SlotTypeVersionT>(value);
  }
  template <typename SlotTypeVersionT = Aws::String>
  Slot& WithSlotTypeVersion(SlotTypeVersionT&& value) {
    SetSlotTypeVersion(std::forward<SlotTypeVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetValueElicitationPrompt(ValueElicitationPromptT&& value) {
    ...
    m_valueElicitationPrompt = std::forward<ValueElicitationPromptT>(value);
  }
  template <typename ValueElicitationPromptT = Prompt>
  Slot& WithValueElicitationPrompt(ValueElicitationPromptT&& value) {
    SetValueElicitationPrompt(std::forward<ValueElicitationPromptT>(value));
    return *this;
  }
  ///@}
  ...
  inline Slot& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  void SetResponseCard(ResponseCardT&& value) {
    ...
    m_responseCard = std::forward<ResponseCardT>(value);
  }
  template <typename ResponseCardT = Aws::String>
  Slot& WithResponseCard(ResponseCardT&& value) {
    SetResponseCard(std::forward<ResponseCardT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetObfuscationSetting(ObfuscationSetting value) {
    m_obfuscationSettingHasBeenSet = true;
    m_obfuscationSetting = value;
  }
  inline Slot& WithObfuscationSetting(ObfuscationSetting value) {
    SetObfuscationSetting(value);
    return *this;
  }
  ///@}
  ...
  void SetDefaultValueSpec(DefaultValueSpecT&& value) {
    ...
    m_defaultValueSpec = std::forward<DefaultValueSpecT>(value);
  }
  template <typename DefaultValueSpecT = SlotDefaultValueSpec>
  Slot& WithDefaultValueSpec(DefaultValueSpecT&& value) {
    SetDefaultValueSpec(std::forward<DefaultValueSpecT>(value));
    return *this;
  }
  ///@}
 private:
