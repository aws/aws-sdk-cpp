...
class MigrationSummary {
 public:
  ...
  inline MigrationSummary& WithV1BotLocale(Locale value) {
  ...
  inline MigrationSummary& WithMigrationStatus(MigrationStatus value) {
  ...
  inline MigrationSummary& WithMigrationStrategy(MigrationStrategy value) {
