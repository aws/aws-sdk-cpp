...
class GetBotVersionsResult {
 public:
  ...
  template <typename BotsT = Aws::Vector<BotMetadata>>
  GetBotVersionsResult& WithBots(BotsT&& value) {
    SetBots(std::forward<BotsT>(value));
    return *this;
  }
  template <typename BotsT = BotMetadata>
  GetBotVersionsResult& AddBots(BotsT&& value) {
    m_botsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetBotVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBotVersionsResult& WithRequestId(RequestIdT&& value) {
