...
class StartMigrationResult {
 public:
  ...
  inline StartMigrationResult& WithV1BotLocale(Locale value) {
  ...
  template <typename V2BotIdT = Aws::String>
  StartMigrationResult& WithV2BotId(V2BotIdT&& value) {
  ...
  inline StartMigrationResult& WithMigrationStrategy(MigrationStrategy value) {
