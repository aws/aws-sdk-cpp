...
class GetBotChannelAssociationRequest : public LexModelBuildingServiceRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  GetBotChannelAssociationRequest& WithName(NameT&& value) {
  ...
  template <typename BotNameT = Aws::String>
  GetBotChannelAssociationRequest& WithBotName(BotNameT&& value) {
  ...
  template <typename BotAliasT = Aws::String>
  GetBotChannelAssociationRequest& WithBotAlias(BotAliasT&& value) {
