...
class PutSlotTypeResult {
 public:
  ...
  template <typename NameT = Aws::String>
  PutSlotTypeResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  PutSlotTypeResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename EnumerationValuesT = Aws::Vector<EnumerationValue>>
  PutSlotTypeResult& WithEnumerationValues(EnumerationValuesT&& value) {
    SetEnumerationValues(std::forward<EnumerationValuesT>(value));
    return *this;
  }
  template <typename EnumerationValuesT = EnumerationValue>
  PutSlotTypeResult& AddEnumerationValues(EnumerationValuesT&& value) {
    m_enumerationValuesHasBeenSet = true;
  ...
  template <typename LastUpdatedDateT = Aws::Utils::DateTime>
  PutSlotTypeResult& WithLastUpdatedDate(LastUpdatedDateT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  PutSlotTypeResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename VersionT = Aws::String>
  PutSlotTypeResult& WithVersion(VersionT&& value) {
  ...
  template <typename ChecksumT = Aws::String>
  PutSlotTypeResult& WithChecksum(ChecksumT&& value) {
  ...
  inline PutSlotTypeResult& WithValueSelectionStrategy(SlotValueSelectionStrategy value) {
  ...
  inline PutSlotTypeResult& WithCreateVersion(bool value) {
  ...
  template <typename ParentSlotTypeSignatureT = Aws::String>
  PutSlotTypeResult& WithParentSlotTypeSignature(ParentSlotTypeSignatureT&& value) {
  ...
  template <typename SlotTypeConfigurationsT = Aws::Vector<SlotTypeConfiguration>>
  PutSlotTypeResult& WithSlotTypeConfigurations(SlotTypeConfigurationsT&& value) {
  ...
  PutSlotTypeResult& AddSlotTypeConfigurations(SlotTypeConfigurationsT&& value) {
    m_slotTypeConfigurationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  PutSlotTypeResult& WithRequestId(RequestIdT&& value) {
