...
class LogSettingsRequest {
 public:
  ...
  inline LogSettingsRequest& WithLogType(LogType value) {
    SetLogType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDestination(Destination value) {
    m_destinationHasBeenSet = true;
    m_destination = value;
  }
  inline LogSettingsRequest& WithDestination(Destination value) {
