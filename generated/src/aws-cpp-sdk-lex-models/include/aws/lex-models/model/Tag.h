...
namespace Model
{
  ...
  {
  public:
    AWS_LEXMODELBUILDINGSERVICE_API Tag() = default;
    AWS_LEXMODELBUILDINGSERVICE_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_LEXMODELBUILDINGSERVICE_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
