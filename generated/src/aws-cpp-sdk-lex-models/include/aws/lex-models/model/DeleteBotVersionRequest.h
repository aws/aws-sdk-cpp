...
namespace Model
{
  ...
  {
  public:
    AWS_LEXMODELBUILDINGSERVICE_API DeleteBotVersionRequest() = default;
    ...
    template<typename NameT = Aws::String>
    DeleteBotVersionRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    DeleteBotVersionRequest& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
