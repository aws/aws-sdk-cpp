...
class LogSettingsResponse {
 public:
  ...
  inline LogSettingsResponse& WithLogType(LogType value) {
    SetLogType(value);
    return *this;
  }
  ///@}
  ...
  inline LogSettingsResponse& WithDestination(Destination value) {
  ...
  void SetResourcePrefix(ResourcePrefixT&& value) {
    m_resourcePrefixHasBeenSet = true;
    m_resourcePrefix = std::forward<ResourcePrefixT>(value);
  }
  template <typename ResourcePrefixT = Aws::String>
  LogSettingsResponse& WithResourcePrefix(ResourcePrefixT&& value) {
    SetResourcePrefix(std::forward<ResourcePrefixT>(value));
    return *this;
  }
  ///@}
 private:
