...
class GetMigrationResult {
 public:
  ...
  void SetV1BotName(V1BotNameT&& value) {
    ...
    m_v1BotName = std::forward<V1BotNameT>(value);
  }
  template <typename V1BotNameT = Aws::String>
  GetMigrationResult& WithV1BotName(V1BotNameT&& value) {
    SetV1BotName(std::forward<V1BotNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetV1BotVersion(V1BotVersionT&& value) {
    ...
    m_v1BotVersion = std::forward<V1BotVersionT>(value);
  }
  template <typename V1BotVersionT = Aws::String>
  GetMigrationResult& WithV1BotVersion(V1BotVersionT&& value) {
    SetV1BotVersion(std::forward<V1BotVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetV1BotLocale(Locale value) {
    m_v1BotLocaleHasBeenSet = true;
    m_v1BotLocale = value;
  }
  inline GetMigrationResult& WithV1BotLocale(Locale value) {
    SetV1BotLocale(value);
    return *this;
  }
  ///@}
  ...
  void SetV2BotId(V2BotIdT&& value) {
    ...
    m_v2BotId = std::forward<V2BotIdT>(value);
  }
  template <typename V2BotIdT = Aws::String>
  GetMigrationResult& WithV2BotId(V2BotIdT&& value) {
    SetV2BotId(std::forward<V2BotIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetV2BotRole(V2BotRoleT&& value) {
    ...
    m_v2BotRole = std::forward<V2BotRoleT>(value);
  }
  template <typename V2BotRoleT = Aws::String>
  GetMigrationResult& WithV2BotRole(V2BotRoleT&& value) {
    SetV2BotRole(std::forward<V2BotRoleT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMigrationStatus(MigrationStatus value) {
    m_migrationStatusHasBeenSet = true;
    m_migrationStatus = value;
  }
  inline GetMigrationResult& WithMigrationStatus(MigrationStatus value) {
  ...
  inline void SetMigrationStrategy(MigrationStrategy value) {
    m_migrationStrategyHasBeenSet = true;
    m_migrationStrategy = value;
  }
  inline GetMigrationResult& WithMigrationStrategy(MigrationStrategy value) {
  ...
  void SetMigrationTimestamp(MigrationTimestampT&& value) {
    ...
    m_migrationTimestamp = std::forward<MigrationTimestampT>(value);
  }
  template <typename MigrationTimestampT = Aws::Utils::DateTime>
  GetMigrationResult& WithMigrationTimestamp(MigrationTimestampT&& value) {
    SetMigrationTimestamp(std::forward<MigrationTimestampT>(value));
    return *this;
  }
  ///@}
