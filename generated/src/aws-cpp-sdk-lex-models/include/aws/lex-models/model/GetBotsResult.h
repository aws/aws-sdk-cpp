...
namespace Model
{
  ...
  public:
    ...
    inline GetBotsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetBotsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetBotsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
