...
class DeleteBotChannelAssociationRequest : public LexModelBuildingServiceRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  DeleteBotChannelAssociationRequest& WithName(NameT&& value) {
  ...
  template <typename BotNameT = Aws::String>
  DeleteBotChannelAssociationRequest& WithBotName(BotNameT&& value) {
  ...
  template <typename BotAliasT = Aws::String>
  DeleteBotChannelAssociationRequest& WithBotAlias(BotAliasT&& value) {
