...
class GetBuiltinIntentsRequest : public LexModelBuildingServiceRequest {
 public:
  ...
  inline GetBuiltinIntentsRequest& WithLocale(Locale value) {
    SetLocale(value);
    return *this;
  }
  ///@}
  ...
  void SetSignatureContains(SignatureContainsT&& value) {
    m_signatureContainsHasBeenSet = true;
    m_signatureContains = std::forward<SignatureContainsT>(value);
  }
  template <typename SignatureContainsT = Aws::String>
  GetBuiltinIntentsRequest& WithSignatureContains(SignatureContainsT&& value) {
    SetSignatureContains(std::forward<SignatureContainsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetBuiltinIntentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetBuiltinIntentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
