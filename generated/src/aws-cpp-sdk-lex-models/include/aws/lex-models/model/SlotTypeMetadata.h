...
class SlotTypeMetadata {
 public:
  AWS_LEXMODELBUILDINGSERVICE_API SlotTypeMetadata() = default;
  ...
  template <typename NameT = Aws::String>
  SlotTypeMetadata& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  SlotTypeMetadata& WithDescription(DescriptionT&& value) {
  ...
  template <typename LastUpdatedDateT = Aws::Utils::DateTime>
  SlotTypeMetadata& WithLastUpdatedDate(LastUpdatedDateT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  SlotTypeMetadata& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename VersionT = Aws::String>
  SlotTypeMetadata& WithVersion(VersionT&& value) {
