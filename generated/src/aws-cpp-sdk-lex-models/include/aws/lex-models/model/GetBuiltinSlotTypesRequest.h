...
class GetBuiltinSlotTypesRequest : public LexModelBuildingServiceRequest {
 public:
  ...
  inline GetBuiltinSlotTypesRequest& WithLocale(Locale value) {
    SetLocale(value);
    return *this;
  }
  ///@}
  ...
  template <typename SignatureContainsT = Aws::String>
  GetBuiltinSlotTypesRequest& WithSignatureContains(SignatureContainsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetBuiltinSlotTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetBuiltinSlotTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
