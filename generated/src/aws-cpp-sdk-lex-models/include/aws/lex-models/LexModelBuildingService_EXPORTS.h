...
#ifdef AWS_LEXMODELBUILDINGSERVICE_EXPORTS
#define AWS_LEXMODELBUILDINGSERVICE_API __declspec(dllexport)
#else
...
#define AWS_LEXMODELBUILDINGSERVICE_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_LEXMODELBUILDINGSERVICE_API
#define AWS_LEXMODELBUILDINGSERVICE_EXTERN extern
#if __GNUC__ >= 4
#define AWS_LEXMODELBUILDINGSERVICE_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_LEXMODELBUILDINGSERVICE_LOCAL
#endif
