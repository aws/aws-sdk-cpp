...
{
const size_t LexModelBuildingServiceEndpointRules::RulesBlobStrLen = 3961;
const size_t LexModelBuildingServiceEndpointRules::RulesBlobSize = 3962;
...
'o','d','e','l','s','-','f','i','p','s','.','l','e','x','.','{','R','e','g','i','o','n','}','.','{',
...
's','.','l','e','x','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
':','"','h','t','t','p','s',':','/','/','m','o','d','e','l','s','.','l','e','x','.','{','R','e','g',
