...
ListPersonalAccessTokensResult::ListPersonalAccessTokensResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListPersonalAccessTokensResult& ListPersonalAccessTokensResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("PersonalAccessTokenSummaries")) {
    ...
    for (unsigned personalAccessTokenSummariesIndex = 0;
         personalAccessTokenSummariesIndex < personalAccessTokenSummariesJsonList.GetLength(); ++personalAccessTokenSummariesIndex) {
