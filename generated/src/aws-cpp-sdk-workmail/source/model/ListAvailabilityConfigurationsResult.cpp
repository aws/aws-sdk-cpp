...
ListAvailabilityConfigurationsResult& ListAvailabilityConfigurationsResult::operator=(
  ...
  if (jsonValue.ValueExists("AvailabilityConfigurations")) {
    ...
    for (unsigned availabilityConfigurationsIndex = 0; availabilityConfigurationsIndex < availabilityConfigurationsJsonList.GetLength();
         ++availabilityConfigurationsIndex) {
      m_availabilityConfigurations.push_back(availabilityConfigurationsJsonList[availabilityConfigurationsIndex].AsObject());
    }
    m_availabilityConfigurationsHasBeenSet = true;
  }
