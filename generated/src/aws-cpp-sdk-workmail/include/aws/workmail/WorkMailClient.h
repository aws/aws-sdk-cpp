...
class AWS_WORKMAIL_API WorkMailClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  WorkMailClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<WorkMailEndpointProviderBase> endpointProvider = nullptr,
  ...
  virtual Model::AssociateDelegateToResourceOutcome AssociateDelegateToResource(
      const Model::AssociateDelegateToResourceRequest& request) const;

  /**
   * A Callable wrapper for AssociateDelegateToResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateDelegateToResourceRequestT = Model::AssociateDelegateToResourceRequest>
  Model::AssociateDelegateToResourceOutcomeCallable AssociateDelegateToResourceCallable(
      const AssociateDelegateToResourceRequestT& request) const {
    return SubmitCallable(&WorkMailClient::AssociateDelegateToResource, request);
  }

  /**
   * An Async wrapper for AssociateDelegateToResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateDelegateToResourceRequestT = Model::AssociateDelegateToResourceRequest>
  void AssociateDelegateToResourceAsync(const AssociateDelegateToResourceRequestT& request,
  ...
  /**
   * A Callable wrapper for AssociateMemberToGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateMemberToGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateMemberToGroupRequestT = Model::AssociateMemberToGroupRequest>
  void AssociateMemberToGroupAsync(const AssociateMemberToGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for AssumeImpersonationRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssumeImpersonationRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssumeImpersonationRoleRequestT = Model::AssumeImpersonationRoleRequest>
  void AssumeImpersonationRoleAsync(const AssumeImpersonationRoleRequestT& request,
                                    const AssumeImpersonationRoleResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelMailboxExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelMailboxExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelMailboxExportJobRequestT = Model::CancelMailboxExportJobRequest>
  void CancelMailboxExportJobAsync(const CancelMailboxExportJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAvailabilityConfigurationOutcome CreateAvailabilityConfiguration(
      const Model::CreateAvailabilityConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateAvailabilityConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAvailabilityConfigurationRequestT = Model::CreateAvailabilityConfigurationRequest>
  Model::CreateAvailabilityConfigurationOutcomeCallable CreateAvailabilityConfigurationCallable(
      const CreateAvailabilityConfigurationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::CreateAvailabilityConfiguration, request);
  }

  /**
   * An Async wrapper for CreateAvailabilityConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateAvailabilityConfigurationRequestT = Model::CreateAvailabilityConfigurationRequest>
  void CreateAvailabilityConfigurationAsync(const CreateAvailabilityConfigurationRequestT& request,
                                            const CreateAvailabilityConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateIdentityCenterApplicationOutcome CreateIdentityCenterApplication(
      const Model::CreateIdentityCenterApplicationRequest& request) const;

  /**
   * A Callable wrapper for CreateIdentityCenterApplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateIdentityCenterApplicationRequestT = Model::CreateIdentityCenterApplicationRequest>
  Model::CreateIdentityCenterApplicationOutcomeCallable CreateIdentityCenterApplicationCallable(
      const CreateIdentityCenterApplicationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::CreateIdentityCenterApplication, request);
  }

  /**
   * An Async wrapper for CreateIdentityCenterApplication that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateIdentityCenterApplicationRequestT = Model::CreateIdentityCenterApplicationRequest>
  void CreateIdentityCenterApplicationAsync(const CreateIdentityCenterApplicationRequestT& request,
                                            const CreateIdentityCenterApplicationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateImpersonationRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateImpersonationRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateImpersonationRoleRequestT = Model::CreateImpersonationRoleRequest>
  void CreateImpersonationRoleAsync(const CreateImpersonationRoleRequestT& request,
                                    const CreateImpersonationRoleResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateMobileDeviceAccessRuleOutcome CreateMobileDeviceAccessRule(
      const Model::CreateMobileDeviceAccessRuleRequest& request) const;

  /**
   * A Callable wrapper for CreateMobileDeviceAccessRule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateMobileDeviceAccessRuleRequestT = Model::CreateMobileDeviceAccessRuleRequest>
  Model::CreateMobileDeviceAccessRuleOutcomeCallable CreateMobileDeviceAccessRuleCallable(
      const CreateMobileDeviceAccessRuleRequestT& request) const {
    return SubmitCallable(&WorkMailClient::CreateMobileDeviceAccessRule, request);
  }

  /**
   * An Async wrapper for CreateMobileDeviceAccessRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMobileDeviceAccessRuleRequestT = Model::CreateMobileDeviceAccessRuleRequest>
  void CreateMobileDeviceAccessRuleAsync(const CreateMobileDeviceAccessRuleRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateOrganization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateOrganization that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateOrganizationRequestT = Model::CreateOrganizationRequest>
  void CreateOrganizationAsync(const CreateOrganizationRequestT& request, const CreateOrganizationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAccessControlRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAccessControlRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAccessControlRuleRequestT = Model::DeleteAccessControlRuleRequest>
  void DeleteAccessControlRuleAsync(const DeleteAccessControlRuleRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAvailabilityConfigurationOutcome DeleteAvailabilityConfiguration(
      const Model::DeleteAvailabilityConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteAvailabilityConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAvailabilityConfigurationRequestT = Model::DeleteAvailabilityConfigurationRequest>
  Model::DeleteAvailabilityConfigurationOutcomeCallable DeleteAvailabilityConfigurationCallable(
      const DeleteAvailabilityConfigurationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DeleteAvailabilityConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteAvailabilityConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteAvailabilityConfigurationRequestT = Model::DeleteAvailabilityConfigurationRequest>
  void DeleteAvailabilityConfigurationAsync(const DeleteAvailabilityConfigurationRequestT& request,
                                            const DeleteAvailabilityConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteEmailMonitoringConfigurationOutcome DeleteEmailMonitoringConfiguration(
      const Model::DeleteEmailMonitoringConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteEmailMonitoringConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteEmailMonitoringConfigurationRequestT = Model::DeleteEmailMonitoringConfigurationRequest>
  Model::DeleteEmailMonitoringConfigurationOutcomeCallable DeleteEmailMonitoringConfigurationCallable(
      const DeleteEmailMonitoringConfigurationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DeleteEmailMonitoringConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteEmailMonitoringConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteEmailMonitoringConfigurationRequestT = Model::DeleteEmailMonitoringConfigurationRequest>
  void DeleteEmailMonitoringConfigurationAsync(const DeleteEmailMonitoringConfigurationRequestT& request,
                                               const DeleteEmailMonitoringConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteIdentityCenterApplicationOutcome DeleteIdentityCenterApplication(
      const Model::DeleteIdentityCenterApplicationRequest& request) const;

  /**
   * A Callable wrapper for DeleteIdentityCenterApplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteIdentityCenterApplicationRequestT = Model::DeleteIdentityCenterApplicationRequest>
  Model::DeleteIdentityCenterApplicationOutcomeCallable DeleteIdentityCenterApplicationCallable(
      const DeleteIdentityCenterApplicationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DeleteIdentityCenterApplication, request);
  }

  /**
   * An Async wrapper for DeleteIdentityCenterApplication that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteIdentityCenterApplicationRequestT = Model::DeleteIdentityCenterApplicationRequest>
  void DeleteIdentityCenterApplicationAsync(const DeleteIdentityCenterApplicationRequestT& request,
                                            const DeleteIdentityCenterApplicationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteIdentityProviderConfigurationOutcome DeleteIdentityProviderConfiguration(
      const Model::DeleteIdentityProviderConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteIdentityProviderConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteIdentityProviderConfigurationRequestT = Model::DeleteIdentityProviderConfigurationRequest>
  Model::DeleteIdentityProviderConfigurationOutcomeCallable DeleteIdentityProviderConfigurationCallable(
      const DeleteIdentityProviderConfigurationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DeleteIdentityProviderConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteIdentityProviderConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteIdentityProviderConfigurationRequestT = Model::DeleteIdentityProviderConfigurationRequest>
  void DeleteIdentityProviderConfigurationAsync(const DeleteIdentityProviderConfigurationRequestT& request,
                                                const DeleteIdentityProviderConfigurationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteImpersonationRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteImpersonationRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteImpersonationRoleRequestT = Model::DeleteImpersonationRoleRequest>
  void DeleteImpersonationRoleAsync(const DeleteImpersonationRoleRequestT& request,
                                    const DeleteImpersonationRoleResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMailboxPermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMailboxPermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMailboxPermissionsRequestT = Model::DeleteMailboxPermissionsRequest>
  void DeleteMailboxPermissionsAsync(const DeleteMailboxPermissionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteMobileDeviceAccessOverrideOutcome DeleteMobileDeviceAccessOverride(
      const Model::DeleteMobileDeviceAccessOverrideRequest& request) const;

  /**
   * A Callable wrapper for DeleteMobileDeviceAccessOverride that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteMobileDeviceAccessOverrideRequestT = Model::DeleteMobileDeviceAccessOverrideRequest>
  Model::DeleteMobileDeviceAccessOverrideOutcomeCallable DeleteMobileDeviceAccessOverrideCallable(
      const DeleteMobileDeviceAccessOverrideRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DeleteMobileDeviceAccessOverride, request);
  }

  /**
   * An Async wrapper for DeleteMobileDeviceAccessOverride that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteMobileDeviceAccessOverrideRequestT = Model::DeleteMobileDeviceAccessOverrideRequest>
  void DeleteMobileDeviceAccessOverrideAsync(const DeleteMobileDeviceAccessOverrideRequestT& request,
                                             const DeleteMobileDeviceAccessOverrideResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteMobileDeviceAccessRuleOutcome DeleteMobileDeviceAccessRule(
      const Model::DeleteMobileDeviceAccessRuleRequest& request) const;

  /**
   * A Callable wrapper for DeleteMobileDeviceAccessRule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteMobileDeviceAccessRuleRequestT = Model::DeleteMobileDeviceAccessRuleRequest>
  Model::DeleteMobileDeviceAccessRuleOutcomeCallable DeleteMobileDeviceAccessRuleCallable(
      const DeleteMobileDeviceAccessRuleRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DeleteMobileDeviceAccessRule, request);
  }

  /**
   * An Async wrapper for DeleteMobileDeviceAccessRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMobileDeviceAccessRuleRequestT = Model::DeleteMobileDeviceAccessRuleRequest>
  void DeleteMobileDeviceAccessRuleAsync(const DeleteMobileDeviceAccessRuleRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteOrganization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteOrganization that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteOrganizationRequestT = Model::DeleteOrganizationRequest>
  void DeleteOrganizationAsync(const DeleteOrganizationRequestT& request, const DeleteOrganizationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePersonalAccessToken that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeletePersonalAccessTokenRequestT = Model::DeletePersonalAccessTokenRequest>
  Model::DeletePersonalAccessTokenOutcomeCallable DeletePersonalAccessTokenCallable(
      const DeletePersonalAccessTokenRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DeletePersonalAccessToken, request);
  }

  /**
   * An Async wrapper for DeletePersonalAccessToken that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePersonalAccessTokenRequestT = Model::DeletePersonalAccessTokenRequest>
  void DeletePersonalAccessTokenAsync(const DeletePersonalAccessTokenRequestT& request,
                                      const DeletePersonalAccessTokenResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteRetentionPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRetentionPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRetentionPolicyRequestT = Model::DeleteRetentionPolicyRequest>
  ...
  /**
   * A Callable wrapper for DeregisterFromWorkMail that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterFromWorkMail that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterFromWorkMailRequestT = Model::DeregisterFromWorkMailRequest>
  void DeregisterFromWorkMailAsync(const DeregisterFromWorkMailRequestT& request,
  ...
  /**
   * A Callable wrapper for DeregisterMailDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterMailDomain that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterMailDomainRequestT = Model::DeregisterMailDomainRequest>
  void DeregisterMailDomainAsync(const DeregisterMailDomainRequestT& request, const DeregisterMailDomainResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEmailMonitoringConfigurationOutcome DescribeEmailMonitoringConfiguration(
      const Model::DescribeEmailMonitoringConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeEmailMonitoringConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeEmailMonitoringConfigurationRequestT = Model::DescribeEmailMonitoringConfigurationRequest>
  Model::DescribeEmailMonitoringConfigurationOutcomeCallable DescribeEmailMonitoringConfigurationCallable(
      const DescribeEmailMonitoringConfigurationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DescribeEmailMonitoringConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeEmailMonitoringConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeEmailMonitoringConfigurationRequestT = Model::DescribeEmailMonitoringConfigurationRequest>
  void DescribeEmailMonitoringConfigurationAsync(const DescribeEmailMonitoringConfigurationRequestT& request,
                                                 const DescribeEmailMonitoringConfigurationResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeIdentityProviderConfigurationOutcome DescribeIdentityProviderConfiguration(
      const Model::DescribeIdentityProviderConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeIdentityProviderConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeIdentityProviderConfigurationRequestT = Model::DescribeIdentityProviderConfigurationRequest>
  Model::DescribeIdentityProviderConfigurationOutcomeCallable DescribeIdentityProviderConfigurationCallable(
      const DescribeIdentityProviderConfigurationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DescribeIdentityProviderConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeIdentityProviderConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeIdentityProviderConfigurationRequestT = Model::DescribeIdentityProviderConfigurationRequest>
  void DescribeIdentityProviderConfigurationAsync(const DescribeIdentityProviderConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInboundDmarcSettingsOutcome DescribeInboundDmarcSettings(
      const Model::DescribeInboundDmarcSettingsRequest& request) const;

  /**
   * A Callable wrapper for DescribeInboundDmarcSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInboundDmarcSettingsRequestT = Model::DescribeInboundDmarcSettingsRequest>
  Model::DescribeInboundDmarcSettingsOutcomeCallable DescribeInboundDmarcSettingsCallable(
      const DescribeInboundDmarcSettingsRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DescribeInboundDmarcSettings, request);
  }

  /**
   * An Async wrapper for DescribeInboundDmarcSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInboundDmarcSettingsRequestT = Model::DescribeInboundDmarcSettingsRequest>
  void DescribeInboundDmarcSettingsAsync(const DescribeInboundDmarcSettingsRequestT& request,
                                         const DescribeInboundDmarcSettingsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeMailboxExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMailboxExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMailboxExportJobRequestT = Model::DescribeMailboxExportJobRequest>
  void DescribeMailboxExportJobAsync(const DescribeMailboxExportJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeOrganization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeOrganization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeOrganizationRequestT = Model::DescribeOrganizationRequest>
  void DescribeOrganizationAsync(const DescribeOrganizationRequestT& request, const DescribeOrganizationResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateDelegateFromResourceOutcome DisassociateDelegateFromResource(
      const Model::DisassociateDelegateFromResourceRequest& request) const;

  /**
   * A Callable wrapper for DisassociateDelegateFromResource that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateDelegateFromResourceRequestT = Model::DisassociateDelegateFromResourceRequest>
  Model::DisassociateDelegateFromResourceOutcomeCallable DisassociateDelegateFromResourceCallable(
      const DisassociateDelegateFromResourceRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DisassociateDelegateFromResource, request);
  }

  /**
   * An Async wrapper for DisassociateDelegateFromResource that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateDelegateFromResourceRequestT = Model::DisassociateDelegateFromResourceRequest>
  void DisassociateDelegateFromResourceAsync(const DisassociateDelegateFromResourceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateMemberFromGroupOutcome DisassociateMemberFromGroup(
      const Model::DisassociateMemberFromGroupRequest& request) const;

  /**
   * A Callable wrapper for DisassociateMemberFromGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateMemberFromGroupRequestT = Model::DisassociateMemberFromGroupRequest>
  Model::DisassociateMemberFromGroupOutcomeCallable DisassociateMemberFromGroupCallable(
      const DisassociateMemberFromGroupRequestT& request) const {
    return SubmitCallable(&WorkMailClient::DisassociateMemberFromGroup, request);
  }

  /**
   * An Async wrapper for DisassociateMemberFromGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateMemberFromGroupRequestT = Model::DisassociateMemberFromGroupRequest>
  void DisassociateMemberFromGroupAsync(const DisassociateMemberFromGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAccessControlEffect that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccessControlEffect that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAccessControlEffectRequestT = Model::GetAccessControlEffectRequest>
  void GetAccessControlEffectAsync(const GetAccessControlEffectRequestT& request,
  ...
  /**
   * A Callable wrapper for GetDefaultRetentionPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetDefaultRetentionPolicyRequestT = Model::GetDefaultRetentionPolicyRequest>
  Model::GetDefaultRetentionPolicyOutcomeCallable GetDefaultRetentionPolicyCallable(
      const GetDefaultRetentionPolicyRequestT& request) const {
    return SubmitCallable(&WorkMailClient::GetDefaultRetentionPolicy, request);
  }

  /**
   * An Async wrapper for GetDefaultRetentionPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDefaultRetentionPolicyRequestT = Model::GetDefaultRetentionPolicyRequest>
  void GetDefaultRetentionPolicyAsync(const GetDefaultRetentionPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for GetImpersonationRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetImpersonationRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetImpersonationRoleRequestT = Model::GetImpersonationRoleRequest>
  void GetImpersonationRoleAsync(const GetImpersonationRoleRequestT& request, const GetImpersonationRoleResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetImpersonationRoleEffectOutcome GetImpersonationRoleEffect(
      const Model::GetImpersonationRoleEffectRequest& request) const;

  /**
   * A Callable wrapper for GetImpersonationRoleEffect that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetImpersonationRoleEffectRequestT = Model::GetImpersonationRoleEffectRequest>
  Model::GetImpersonationRoleEffectOutcomeCallable GetImpersonationRoleEffectCallable(
      const GetImpersonationRoleEffectRequestT& request) const {
    return SubmitCallable(&WorkMailClient::GetImpersonationRoleEffect, request);
  }

  /**
   * An Async wrapper for GetImpersonationRoleEffect that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetImpersonationRoleEffectRequestT = Model::GetImpersonationRoleEffectRequest>
  void GetImpersonationRoleEffectAsync(const GetImpersonationRoleEffectRequestT& request,
                                       const GetImpersonationRoleEffectResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMailDomain that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMailDomainRequestT = Model::GetMailDomainRequest>
  void GetMailDomainAsync(const GetMailDomainRequestT& request, const GetMailDomainResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMailboxDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMailboxDetails that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMailboxDetailsRequestT = Model::GetMailboxDetailsRequest>
  void GetMailboxDetailsAsync(const GetMailboxDetailsRequestT& request, const GetMailboxDetailsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMobileDeviceAccessEffectOutcome GetMobileDeviceAccessEffect(
      const Model::GetMobileDeviceAccessEffectRequest& request) const;

  /**
   * A Callable wrapper for GetMobileDeviceAccessEffect that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetMobileDeviceAccessEffectRequestT = Model::GetMobileDeviceAccessEffectRequest>
  Model::GetMobileDeviceAccessEffectOutcomeCallable GetMobileDeviceAccessEffectCallable(
      const GetMobileDeviceAccessEffectRequestT& request) const {
    return SubmitCallable(&WorkMailClient::GetMobileDeviceAccessEffect, request);
  }

  /**
   * An Async wrapper for GetMobileDeviceAccessEffect that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMobileDeviceAccessEffectRequestT = Model::GetMobileDeviceAccessEffectRequest>
  void GetMobileDeviceAccessEffectAsync(const GetMobileDeviceAccessEffectRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetMobileDeviceAccessOverrideOutcome GetMobileDeviceAccessOverride(
      const Model::GetMobileDeviceAccessOverrideRequest& request) const;

  /**
   * A Callable wrapper for GetMobileDeviceAccessOverride that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetMobileDeviceAccessOverrideRequestT = Model::GetMobileDeviceAccessOverrideRequest>
  Model::GetMobileDeviceAccessOverrideOutcomeCallable GetMobileDeviceAccessOverrideCallable(
      const GetMobileDeviceAccessOverrideRequestT& request) const {
    return SubmitCallable(&WorkMailClient::GetMobileDeviceAccessOverride, request);
  }

  /**
   * An Async wrapper for GetMobileDeviceAccessOverride that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMobileDeviceAccessOverrideRequestT = Model::GetMobileDeviceAccessOverrideRequest>
  void GetMobileDeviceAccessOverrideAsync(const GetMobileDeviceAccessOverrideRequestT& request,
                                          const GetMobileDeviceAccessOverrideResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetPersonalAccessTokenMetadataOutcome GetPersonalAccessTokenMetadata(
      const Model::GetPersonalAccessTokenMetadataRequest& request) const;

  /**
   * A Callable wrapper for GetPersonalAccessTokenMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPersonalAccessTokenMetadataRequestT = Model::GetPersonalAccessTokenMetadataRequest>
  Model::GetPersonalAccessTokenMetadataOutcomeCallable GetPersonalAccessTokenMetadataCallable(
      const GetPersonalAccessTokenMetadataRequestT& request) const {
    return SubmitCallable(&WorkMailClient::GetPersonalAccessTokenMetadata, request);
  }

  /**
   * An Async wrapper for GetPersonalAccessTokenMetadata that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetPersonalAccessTokenMetadataRequestT = Model::GetPersonalAccessTokenMetadataRequest>
  void GetPersonalAccessTokenMetadataAsync(const GetPersonalAccessTokenMetadataRequestT& request,
                                           const GetPersonalAccessTokenMetadataResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccessControlRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccessControlRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAccessControlRulesRequestT = Model::ListAccessControlRulesRequest>
  void ListAccessControlRulesAsync(const ListAccessControlRulesRequestT& request,
  ...
  virtual Model::ListAvailabilityConfigurationsOutcome ListAvailabilityConfigurations(
      const Model::ListAvailabilityConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListAvailabilityConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAvailabilityConfigurationsRequestT = Model::ListAvailabilityConfigurationsRequest>
  Model::ListAvailabilityConfigurationsOutcomeCallable ListAvailabilityConfigurationsCallable(
      const ListAvailabilityConfigurationsRequestT& request) const {
    return SubmitCallable(&WorkMailClient::ListAvailabilityConfigurations, request);
  }

  /**
   * An Async wrapper for ListAvailabilityConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAvailabilityConfigurationsRequestT = Model::ListAvailabilityConfigurationsRequest>
  void ListAvailabilityConfigurationsAsync(const ListAvailabilityConfigurationsRequestT& request,
                                           const ListAvailabilityConfigurationsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListGroupsForEntity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGroupsForEntity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGroupsForEntityRequestT = Model::ListGroupsForEntityRequest>
  void ListGroupsForEntityAsync(const ListGroupsForEntityRequestT& request, const ListGroupsForEntityResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListImpersonationRoles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListImpersonationRoles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListImpersonationRolesRequestT = Model::ListImpersonationRolesRequest>
  void ListImpersonationRolesAsync(const ListImpersonationRolesRequestT& request,
                                   const ListImpersonationRolesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListMailDomains that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMailDomainsRequestT = Model::ListMailDomainsRequest>
  void ListMailDomainsAsync(const ListMailDomainsRequestT& request, const ListMailDomainsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMailboxExportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMailboxExportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMailboxExportJobsRequestT = Model::ListMailboxExportJobsRequest>
  void ListMailboxExportJobsAsync(const ListMailboxExportJobsRequestT& request, const ListMailboxExportJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMailboxPermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMailboxPermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMailboxPermissionsRequestT = Model::ListMailboxPermissionsRequest>
  void ListMailboxPermissionsAsync(const ListMailboxPermissionsRequestT& request,
  ...
  virtual Model::ListMobileDeviceAccessOverridesOutcome ListMobileDeviceAccessOverrides(
      const Model::ListMobileDeviceAccessOverridesRequest& request) const;

  /**
   * A Callable wrapper for ListMobileDeviceAccessOverrides that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMobileDeviceAccessOverridesRequestT = Model::ListMobileDeviceAccessOverridesRequest>
  Model::ListMobileDeviceAccessOverridesOutcomeCallable ListMobileDeviceAccessOverridesCallable(
      const ListMobileDeviceAccessOverridesRequestT& request) const {
    return SubmitCallable(&WorkMailClient::ListMobileDeviceAccessOverrides, request);
  }

  /**
   * An Async wrapper for ListMobileDeviceAccessOverrides that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListMobileDeviceAccessOverridesRequestT = Model::ListMobileDeviceAccessOverridesRequest>
  void ListMobileDeviceAccessOverridesAsync(const ListMobileDeviceAccessOverridesRequestT& request,
                                            const ListMobileDeviceAccessOverridesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMobileDeviceAccessRulesOutcome ListMobileDeviceAccessRules(
      const Model::ListMobileDeviceAccessRulesRequest& request) const;

  /**
   * A Callable wrapper for ListMobileDeviceAccessRules that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMobileDeviceAccessRulesRequestT = Model::ListMobileDeviceAccessRulesRequest>
  Model::ListMobileDeviceAccessRulesOutcomeCallable ListMobileDeviceAccessRulesCallable(
      const ListMobileDeviceAccessRulesRequestT& request) const {
    return SubmitCallable(&WorkMailClient::ListMobileDeviceAccessRules, request);
  }

  /**
   * An Async wrapper for ListMobileDeviceAccessRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMobileDeviceAccessRulesRequestT = Model::ListMobileDeviceAccessRulesRequest>
  void ListMobileDeviceAccessRulesAsync(const ListMobileDeviceAccessRulesRequestT& request,
  ...
  /**
   * A Callable wrapper for ListOrganizations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOrganizations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListOrganizationsRequestT = Model::ListOrganizationsRequest>
  void ListOrganizationsAsync(const ListOrganizationsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListOrganizationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPersonalAccessTokens that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPersonalAccessTokens that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPersonalAccessTokensRequestT = Model::ListPersonalAccessTokensRequest>
  void ListPersonalAccessTokensAsync(const ListPersonalAccessTokensRequestT& request,
                                     const ListPersonalAccessTokensResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListResourceDelegates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceDelegates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceDelegatesRequestT = Model::ListResourceDelegatesRequest>
  void ListResourceDelegatesAsync(const ListResourceDelegatesRequestT& request, const ListResourceDelegatesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutAccessControlRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutAccessControlRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutAccessControlRuleRequestT = Model::PutAccessControlRuleRequest>
  void PutAccessControlRuleAsync(const PutAccessControlRuleRequestT& request, const PutAccessControlRuleResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutEmailMonitoringConfigurationOutcome PutEmailMonitoringConfiguration(
      const Model::PutEmailMonitoringConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutEmailMonitoringConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutEmailMonitoringConfigurationRequestT = Model::PutEmailMonitoringConfigurationRequest>
  Model::PutEmailMonitoringConfigurationOutcomeCallable PutEmailMonitoringConfigurationCallable(
      const PutEmailMonitoringConfigurationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::PutEmailMonitoringConfiguration, request);
  }

  /**
   * An Async wrapper for PutEmailMonitoringConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutEmailMonitoringConfigurationRequestT = Model::PutEmailMonitoringConfigurationRequest>
  void PutEmailMonitoringConfigurationAsync(const PutEmailMonitoringConfigurationRequestT& request,
                                            const PutEmailMonitoringConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutIdentityProviderConfigurationOutcome PutIdentityProviderConfiguration(
      const Model::PutIdentityProviderConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutIdentityProviderConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PutIdentityProviderConfigurationRequestT = Model::PutIdentityProviderConfigurationRequest>
  Model::PutIdentityProviderConfigurationOutcomeCallable PutIdentityProviderConfigurationCallable(
      const PutIdentityProviderConfigurationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::PutIdentityProviderConfiguration, request);
  }

  /**
   * An Async wrapper for PutIdentityProviderConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutIdentityProviderConfigurationRequestT = Model::PutIdentityProviderConfigurationRequest>
  void PutIdentityProviderConfigurationAsync(const PutIdentityProviderConfigurationRequestT& request,
                                             const PutIdentityProviderConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutInboundDmarcSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutInboundDmarcSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutInboundDmarcSettingsRequestT = Model::PutInboundDmarcSettingsRequest>
  void PutInboundDmarcSettingsAsync(const PutInboundDmarcSettingsRequestT& request,
                                    const PutInboundDmarcSettingsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutMailboxPermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutMailboxPermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutMailboxPermissionsRequestT = Model::PutMailboxPermissionsRequest>
  void PutMailboxPermissionsAsync(const PutMailboxPermissionsRequestT& request, const PutMailboxPermissionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutMobileDeviceAccessOverrideOutcome PutMobileDeviceAccessOverride(
      const Model::PutMobileDeviceAccessOverrideRequest& request) const;

  /**
   * A Callable wrapper for PutMobileDeviceAccessOverride that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutMobileDeviceAccessOverrideRequestT = Model::PutMobileDeviceAccessOverrideRequest>
  Model::PutMobileDeviceAccessOverrideOutcomeCallable PutMobileDeviceAccessOverrideCallable(
      const PutMobileDeviceAccessOverrideRequestT& request) const {
    return SubmitCallable(&WorkMailClient::PutMobileDeviceAccessOverride, request);
  }

  /**
   * An Async wrapper for PutMobileDeviceAccessOverride that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutMobileDeviceAccessOverrideRequestT = Model::PutMobileDeviceAccessOverrideRequest>
  void PutMobileDeviceAccessOverrideAsync(const PutMobileDeviceAccessOverrideRequestT& request,
                                          const PutMobileDeviceAccessOverrideResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutRetentionPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutRetentionPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutRetentionPolicyRequestT = Model::PutRetentionPolicyRequest>
  ...
  /**
   * A Callable wrapper for RegisterMailDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterMailDomain that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RegisterMailDomainRequestT = Model::RegisterMailDomainRequest>
  void RegisterMailDomainAsync(const RegisterMailDomainRequestT& request, const RegisterMailDomainResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterToWorkMail that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterToWorkMail that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RegisterToWorkMailRequestT = Model::RegisterToWorkMailRequest>
  void RegisterToWorkMailAsync(const RegisterToWorkMailRequestT& request, const RegisterToWorkMailResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ResetPassword that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResetPasswordRequestT = Model::ResetPasswordRequest>
  void ResetPasswordAsync(const ResetPasswordRequestT& request, const ResetPasswordResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMailboxExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMailboxExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMailboxExportJobRequestT = Model::StartMailboxExportJobRequest>
  void StartMailboxExportJobAsync(const StartMailboxExportJobRequestT& request, const StartMailboxExportJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::TestAvailabilityConfigurationOutcome TestAvailabilityConfiguration(
      const Model::TestAvailabilityConfigurationRequest& request) const;

  /**
   * A Callable wrapper for TestAvailabilityConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename TestAvailabilityConfigurationRequestT = Model::TestAvailabilityConfigurationRequest>
  Model::TestAvailabilityConfigurationOutcomeCallable TestAvailabilityConfigurationCallable(
      const TestAvailabilityConfigurationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::TestAvailabilityConfiguration, request);
  }

  /**
   * An Async wrapper for TestAvailabilityConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TestAvailabilityConfigurationRequestT = Model::TestAvailabilityConfigurationRequest>
  void TestAvailabilityConfigurationAsync(const TestAvailabilityConfigurationRequestT& request,
                                          const TestAvailabilityConfigurationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateAvailabilityConfigurationOutcome UpdateAvailabilityConfiguration(
      const Model::UpdateAvailabilityConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateAvailabilityConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAvailabilityConfigurationRequestT = Model::UpdateAvailabilityConfigurationRequest>
  Model::UpdateAvailabilityConfigurationOutcomeCallable UpdateAvailabilityConfigurationCallable(
      const UpdateAvailabilityConfigurationRequestT& request) const {
    return SubmitCallable(&WorkMailClient::UpdateAvailabilityConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateAvailabilityConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateAvailabilityConfigurationRequestT = Model::UpdateAvailabilityConfigurationRequest>
  void UpdateAvailabilityConfigurationAsync(const UpdateAvailabilityConfigurationRequestT& request,
                                            const UpdateAvailabilityConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDefaultMailDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDefaultMailDomain that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDefaultMailDomainRequestT = Model::UpdateDefaultMailDomainRequest>
  void UpdateDefaultMailDomainAsync(const UpdateDefaultMailDomainRequestT& request,
                                    const UpdateDefaultMailDomainResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateImpersonationRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateImpersonationRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateImpersonationRoleRequestT = Model::UpdateImpersonationRoleRequest>
  void UpdateImpersonationRoleAsync(const UpdateImpersonationRoleRequestT& request,
                                    const UpdateImpersonationRoleResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMailboxQuota that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMailboxQuota that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateMailboxQuotaRequestT = Model::UpdateMailboxQuotaRequest>
  void UpdateMailboxQuotaAsync(const UpdateMailboxQuotaRequestT& request, const UpdateMailboxQuotaResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateMobileDeviceAccessRuleOutcome UpdateMobileDeviceAccessRule(
      const Model::UpdateMobileDeviceAccessRuleRequest& request) const;

  /**
   * A Callable wrapper for UpdateMobileDeviceAccessRule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateMobileDeviceAccessRuleRequestT = Model::UpdateMobileDeviceAccessRuleRequest>
  Model::UpdateMobileDeviceAccessRuleOutcomeCallable UpdateMobileDeviceAccessRuleCallable(
      const UpdateMobileDeviceAccessRuleRequestT& request) const {
    return SubmitCallable(&WorkMailClient::UpdateMobileDeviceAccessRule, request);
  }

  /**
   * An Async wrapper for UpdateMobileDeviceAccessRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMobileDeviceAccessRuleRequestT = Model::UpdateMobileDeviceAccessRuleRequest>
  void UpdateMobileDeviceAccessRuleAsync(const UpdateMobileDeviceAccessRuleRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdatePrimaryEmailAddress that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdatePrimaryEmailAddressRequestT = Model::UpdatePrimaryEmailAddressRequest>
  Model::UpdatePrimaryEmailAddressOutcomeCallable UpdatePrimaryEmailAddressCallable(
      const UpdatePrimaryEmailAddressRequestT& request) const {
    return SubmitCallable(&WorkMailClient::UpdatePrimaryEmailAddress, request);
  }

  /**
   * An Async wrapper for UpdatePrimaryEmailAddress that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePrimaryEmailAddressRequestT = Model::UpdatePrimaryEmailAddressRequest>
  void UpdatePrimaryEmailAddressAsync(const UpdatePrimaryEmailAddressRequestT& request,
