...
class CancelMailboxExportJobRequest : public WorkMailRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CancelMailboxExportJobRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  CancelMailboxExportJobRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename OrganizationIdT = Aws::String>
  CancelMailboxExportJobRequest& WithOrganizationId(OrganizationIdT&& value) {
