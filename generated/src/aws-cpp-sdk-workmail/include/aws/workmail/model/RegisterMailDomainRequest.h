...
class RegisterMailDomainRequest : public WorkMailRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  RegisterMailDomainRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename OrganizationIdT = Aws::String>
  RegisterMailDomainRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  RegisterMailDomainRequest& WithDomainName(DomainNameT&& value) {
