...
class GetImpersonationRoleEffectResult {
 public:
  ...
  inline void SetType(ImpersonationRoleType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline GetImpersonationRoleEffectResult& WithType(ImpersonationRoleType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEffect(AccessEffect value) {
    m_effectHasBeenSet = true;
    m_effect = value;
  }
  inline GetImpersonationRoleEffectResult& WithEffect(AccessEffect value) {
    SetEffect(value);
    return *this;
  }
  ///@}
  ...
  void SetMatchedRules(MatchedRulesT&& value) {
    m_matchedRulesHasBeenSet = true;
    m_matchedRules = std::forward<MatchedRulesT>(value);
  }
  template <typename MatchedRulesT = Aws::Vector<ImpersonationMatchedRule>>
  GetImpersonationRoleEffectResult& WithMatchedRules(MatchedRulesT&& value) {
    SetMatchedRules(std::forward<MatchedRulesT>(value));
    return *this;
  }
  template <typename MatchedRulesT = ImpersonationMatchedRule>
  GetImpersonationRoleEffectResult& AddMatchedRules(MatchedRulesT&& value) {
    m_matchedRulesHasBeenSet = true;
    m_matchedRules.emplace_back(std::forward<MatchedRulesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetImpersonationRoleEffectResult& WithRequestId(RequestIdT&& value) {
