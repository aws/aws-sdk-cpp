...
class PutRetentionPolicyRequest : public WorkMailRequest {
 public:
  ...
  void SetFolderConfigurations(FolderConfigurationsT&& value) {
    ...
    m_folderConfigurations = std::forward<FolderConfigurationsT>(value);
  }
  template <typename FolderConfigurationsT = Aws::Vector<FolderConfiguration>>
  PutRetentionPolicyRequest& WithFolderConfigurations(FolderConfigurationsT&& value) {
    SetFolderConfigurations(std::forward<FolderConfigurationsT>(value));
    return *this;
  }
  ...
  PutRetentionPolicyRequest& AddFolderConfigurations(FolderConfigurationsT&& value) {
    m_folderConfigurationsHasBeenSet = true;
    m_folderConfigurations.emplace_back(std::forward<FolderConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
