...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API ListGroupMembersRequest() = default;
    ...
    template<typename OrganizationIdT = Aws::String>
    ListGroupMembersRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupIdT = Aws::String>
    ListGroupMembersRequest& WithGroupId(GroupIdT&& value) { SetGroupId(std::forward<GroupIdT>(value)); return *this;}
    ///@}
