...
class DeleteImpersonationRoleRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  DeleteImpersonationRoleRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename ImpersonationRoleIdT = Aws::String>
  DeleteImpersonationRoleRequest& WithImpersonationRoleId(ImpersonationRoleIdT&& value) {
