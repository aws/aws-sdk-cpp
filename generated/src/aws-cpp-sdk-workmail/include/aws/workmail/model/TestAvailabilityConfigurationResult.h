...
class TestAvailabilityConfigurationResult {
 public:
  ...
  inline void SetTestPassed(bool value) {
    m_testPassedHasBeenSet = true;
    m_testPassed = value;
  }
  inline TestAvailabilityConfigurationResult& WithTestPassed(bool value) {
    SetTestPassed(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureReasonT = Aws::String>
  TestAvailabilityConfigurationResult& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  TestAvailabilityConfigurationResult& WithRequestId(RequestIdT&& value) {
