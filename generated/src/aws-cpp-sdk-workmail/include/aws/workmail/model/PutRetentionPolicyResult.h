...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API PutRetentionPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutRetentionPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
