...
class ListUsersFilters {
 public:
  ...
  template <typename UsernamePrefixT = Aws::String>
  ListUsersFilters& WithUsernamePrefix(UsernamePrefixT&& value) {
  ...
  void SetDisplayNamePrefix(DisplayNamePrefixT&& value) {
    m_displayNamePrefixHasBeenSet = true;
    m_displayNamePrefix = std::forward<DisplayNamePrefixT>(value);
  }
  template <typename DisplayNamePrefixT = Aws::String>
  ListUsersFilters& WithDisplayNamePrefix(DisplayNamePrefixT&& value) {
    SetDisplayNamePrefix(std::forward<DisplayNamePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PrimaryEmailPrefixT = Aws::String>
  ListUsersFilters& WithPrimaryEmailPrefix(PrimaryEmailPrefixT&& value) {
  ...
  inline ListUsersFilters& WithState(EntityState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetIdentityProviderUserIdPrefix(IdentityProviderUserIdPrefixT&& value) {
    m_identityProviderUserIdPrefixHasBeenSet = true;
    m_identityProviderUserIdPrefix = std::forward<IdentityProviderUserIdPrefixT>(value);
  }
  template <typename IdentityProviderUserIdPrefixT = Aws::String>
  ListUsersFilters& WithIdentityProviderUserIdPrefix(IdentityProviderUserIdPrefixT&& value) {
    SetIdentityProviderUserIdPrefix(std::forward<IdentityProviderUserIdPrefixT>(value));
    return *this;
  }
  ///@}
 private:
