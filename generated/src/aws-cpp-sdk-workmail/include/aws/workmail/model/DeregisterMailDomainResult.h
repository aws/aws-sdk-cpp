...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API DeregisterMailDomainResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeregisterMailDomainResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
