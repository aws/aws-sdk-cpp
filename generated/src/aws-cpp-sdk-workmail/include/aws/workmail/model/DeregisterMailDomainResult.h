...
namespace Model
{
  ...
  public:
    ...
    inline DeregisterMailDomainResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeregisterMailDomainResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeregisterMailDomainResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
