...
class EwsAvailabilityProvider {
 public:
  ...
  void SetEwsEndpoint(EwsEndpointT&& value) {
    ...
    m_ewsEndpoint = std::forward<EwsEndpointT>(value);
  }
  template <typename EwsEndpointT = Aws::String>
  EwsAvailabilityProvider& WithEwsEndpoint(EwsEndpointT&& value) {
    SetEwsEndpoint(std::forward<EwsEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEwsUsername(EwsUsernameT&& value) {
    ...
    m_ewsUsername = std::forward<EwsUsernameT>(value);
  }
  template <typename EwsUsernameT = Aws::String>
  EwsAvailabilityProvider& WithEwsUsername(EwsUsernameT&& value) {
    SetEwsUsername(std::forward<EwsUsernameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEwsPassword(EwsPasswordT&& value) {
    ...
    m_ewsPassword = std::forward<EwsPasswordT>(value);
  }
  template <typename EwsPasswordT = Aws::String>
  EwsAvailabilityProvider& WithEwsPassword(EwsPasswordT&& value) {
    SetEwsPassword(std::forward<EwsPasswordT>(value));
    return *this;
  }
  ///@}
 private:
