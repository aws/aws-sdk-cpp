...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API DescribeEmailMonitoringConfigurationRequest() = default;
    ...
    template<typename OrganizationIdT = Aws::String>
    DescribeEmailMonitoringConfigurationRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
  private:
