...
class UpdatePrimaryEmailAddressRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  UpdatePrimaryEmailAddressRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename EntityIdT = Aws::String>
  UpdatePrimaryEmailAddressRequest& WithEntityId(EntityIdT&& value) {
  ...
  template <typename EmailT = Aws::String>
  UpdatePrimaryEmailAddressRequest& WithEmail(EmailT&& value) {
