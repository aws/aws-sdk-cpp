...
class ListGroupsFilters {
 public:
  AWS_WORKMAIL_API ListGroupsFilters() = default;
  ...
  template <typename NamePrefixT = Aws::String>
  ListGroupsFilters& WithNamePrefix(NamePrefixT&& value) {
  ...
  template <typename PrimaryEmailPrefixT = Aws::String>
  ListGroupsFilters& WithPrimaryEmailPrefix(PrimaryEmailPrefixT&& value) {
  ...
  inline ListGroupsFilters& WithState(EntityState value) {
    SetState(value);
    return *this;
  }
  ///@}
