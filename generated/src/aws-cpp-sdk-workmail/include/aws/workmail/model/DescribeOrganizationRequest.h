...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API DescribeOrganizationRequest() = default;
    ...
    template<typename OrganizationIdT = Aws::String>
    DescribeOrganizationRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
  private:
