...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API UpdateMobileDeviceAccessRuleResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateMobileDeviceAccessRuleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
