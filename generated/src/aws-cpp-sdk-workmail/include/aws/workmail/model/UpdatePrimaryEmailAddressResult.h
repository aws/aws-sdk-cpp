...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API UpdatePrimaryEmailAddressResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdatePrimaryEmailAddressResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
