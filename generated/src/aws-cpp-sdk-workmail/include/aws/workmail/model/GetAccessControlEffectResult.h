...
class GetAccessControlEffectResult {
 public:
  ...
  inline GetAccessControlEffectResult& WithEffect(AccessControlRuleEffect value) {
    SetEffect(value);
    return *this;
  }
  ///@}
  ...
  template <typename MatchedRulesT = Aws::Vector<Aws::String>>
  GetAccessControlEffectResult& WithMatchedRules(MatchedRulesT&& value) {
    SetMatchedRules(std::forward<MatchedRulesT>(value));
    return *this;
  }
  template <typename MatchedRulesT = Aws::String>
  GetAccessControlEffectResult& AddMatchedRules(MatchedRulesT&& value) {
    m_matchedRulesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetAccessControlEffectResult& WithRequestId(RequestIdT&& value) {
