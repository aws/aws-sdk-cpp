...
class DescribeUserResult {
 public:
  ...
  inline DescribeUserResult& WithState(EntityState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUserRole(UserRole value) {
    m_userRoleHasBeenSet = true;
    m_userRole = value;
  }
  inline DescribeUserResult& WithUserRole(UserRole value) {
    SetUserRole(value);
    return *this;
  }
  ///@}
  ...
  void SetMailboxProvisionedDate(MailboxProvisionedDateT&& value) {
    ...
    m_mailboxProvisionedDate = std::forward<MailboxProvisionedDateT>(value);
  }
  template <typename MailboxProvisionedDateT = Aws::Utils::DateTime>
  DescribeUserResult& WithMailboxProvisionedDate(MailboxProvisionedDateT&& value) {
    SetMailboxProvisionedDate(std::forward<MailboxProvisionedDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailboxDeprovisionedDate(MailboxDeprovisionedDateT&& value) {
    ...
    m_mailboxDeprovisionedDate = std::forward<MailboxDeprovisionedDateT>(value);
  }
  template <typename MailboxDeprovisionedDateT = Aws::Utils::DateTime>
  DescribeUserResult& WithMailboxDeprovisionedDate(MailboxDeprovisionedDateT&& value) {
    SetMailboxDeprovisionedDate(std::forward<MailboxDeprovisionedDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeUserResult& WithHiddenFromGlobalAddressList(bool value) {
  ...
  void SetTelephone(TelephoneT&& value) {
    ...
    m_telephone = std::forward<TelephoneT>(value);
  }
  template <typename TelephoneT = Aws::String>
  DescribeUserResult& WithTelephone(TelephoneT&& value) {
    SetTelephone(std::forward<TelephoneT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDepartment(DepartmentT&& value) {
    ...
    m_department = std::forward<DepartmentT>(value);
  }
  template <typename DepartmentT = Aws::String>
  DescribeUserResult& WithDepartment(DepartmentT&& value) {
    SetDepartment(std::forward<DepartmentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOffice(OfficeT&& value) {
    ...
    m_office = std::forward<OfficeT>(value);
  }
  template <typename OfficeT = Aws::String>
  DescribeUserResult& WithOffice(OfficeT&& value) {
    SetOffice(std::forward<OfficeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdentityProviderIdentityStoreId(IdentityProviderIdentityStoreIdT&& value) {
    ...
    m_identityProviderIdentityStoreId = std::forward<IdentityProviderIdentityStoreIdT>(value);
  }
  template <typename IdentityProviderIdentityStoreIdT = Aws::String>
  DescribeUserResult& WithIdentityProviderIdentityStoreId(IdentityProviderIdentityStoreIdT&& value) {
    SetIdentityProviderIdentityStoreId(std::forward<IdentityProviderIdentityStoreIdT>(value));
    return *this;
  }
  ///@}
