...
namespace Model
{
  ...
  public:
    ...
    template<typename OrganizationIdT = Aws::String>
    DeletePersonalAccessTokenRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PersonalAccessTokenIdT = Aws::String>
    DeletePersonalAccessTokenRequest& WithPersonalAccessTokenId(PersonalAccessTokenIdT&& value) { SetPersonalAccessTokenId(std::forward<PersonalAccessTokenIdT>(value)); return *this;}
    ///@}
  private:
