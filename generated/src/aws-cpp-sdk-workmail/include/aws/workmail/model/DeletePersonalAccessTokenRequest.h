...
class DeletePersonalAccessTokenRequest : public WorkMailRequest {
 public:
  AWS_WORKMAIL_API DeletePersonalAccessTokenRequest() = default;
  ...
  template <typename OrganizationIdT = Aws::String>
  DeletePersonalAccessTokenRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename PersonalAccessTokenIdT = Aws::String>
  DeletePersonalAccessTokenRequest& WithPersonalAccessTokenId(PersonalAccessTokenIdT&& value) {
