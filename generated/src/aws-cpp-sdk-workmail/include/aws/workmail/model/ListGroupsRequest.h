...
class ListGroupsRequest : public WorkMailRequest {
 public:
  AWS_WORKMAIL_API ListGroupsRequest() = default;
  ...
  template <typename OrganizationIdT = Aws::String>
  ListGroupsRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename FiltersT = ListGroupsFilters>
  void SetFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
    m_filters = std::forward<FiltersT>(value);
  }
  template <typename FiltersT = ListGroupsFilters>
  ListGroupsRequest& WithFilters(FiltersT&& value) {
