...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API DeregisterFromWorkMailResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeregisterFromWorkMailResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
