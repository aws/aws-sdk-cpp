...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API CreateAvailabilityConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateAvailabilityConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
