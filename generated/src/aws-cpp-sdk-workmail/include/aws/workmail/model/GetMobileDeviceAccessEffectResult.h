...
class GetMobileDeviceAccessEffectResult {
 public:
  ...
  inline GetMobileDeviceAccessEffectResult& WithEffect(MobileDeviceAccessRuleEffect value) {
    SetEffect(value);
    return *this;
  }
  ///@}
  ...
  template <typename MatchedRulesT = Aws::Vector<MobileDeviceAccessMatchedRule>>
  GetMobileDeviceAccessEffectResult& WithMatchedRules(MatchedRulesT&& value) {
    SetMatchedRules(std::forward<MatchedRulesT>(value));
    return *this;
  }
  template <typename MatchedRulesT = MobileDeviceAccessMatchedRule>
  GetMobileDeviceAccessEffectResult& AddMatchedRules(MatchedRulesT&& value) {
    m_matchedRulesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetMobileDeviceAccessEffectResult& WithRequestId(RequestIdT&& value) {
