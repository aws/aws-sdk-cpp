...
namespace Model
{
  ...
  public:
    ...
    inline PutMailboxPermissionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutMailboxPermissionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutMailboxPermissionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
