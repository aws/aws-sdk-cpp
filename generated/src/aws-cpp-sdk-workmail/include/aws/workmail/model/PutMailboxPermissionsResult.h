...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API PutMailboxPermissionsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutMailboxPermissionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
