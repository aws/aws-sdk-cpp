...
class ListGroupsForEntityResult {
 public:
  ...
  template <typename GroupsT = Aws::Vector<GroupIdentifier>>
  ListGroupsForEntityResult& WithGroups(GroupsT&& value) {
    SetGroups(std::forward<GroupsT>(value));
    return *this;
  }
  template <typename GroupsT = GroupIdentifier>
  ListGroupsForEntityResult& AddGroups(GroupsT&& value) {
    m_groupsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListGroupsForEntityResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListGroupsForEntityResult& WithRequestId(RequestIdT&& value) {
