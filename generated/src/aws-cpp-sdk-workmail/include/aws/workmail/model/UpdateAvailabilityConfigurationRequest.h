...
class UpdateAvailabilityConfigurationRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  UpdateAvailabilityConfigurationRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  UpdateAvailabilityConfigurationRequest& WithDomainName(DomainNameT&& value) {
  ...
  void SetEwsProvider(EwsProviderT&& value) {
    m_ewsProviderHasBeenSet = true;
    m_ewsProvider = std::forward<EwsProviderT>(value);
  }
  template <typename EwsProviderT = EwsAvailabilityProvider>
  UpdateAvailabilityConfigurationRequest& WithEwsProvider(EwsProviderT&& value) {
    SetEwsProvider(std::forward<EwsProviderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLambdaProvider(LambdaProviderT&& value) {
    m_lambdaProviderHasBeenSet = true;
    m_lambdaProvider = std::forward<LambdaProviderT>(value);
  }
  template <typename LambdaProviderT = LambdaAvailabilityProvider>
  UpdateAvailabilityConfigurationRequest& WithLambdaProvider(LambdaProviderT&& value) {
    SetLambdaProvider(std::forward<LambdaProviderT>(value));
    return *this;
  }
  ///@}
 private:
