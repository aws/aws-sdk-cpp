...
class GetPersonalAccessTokenMetadataRequest : public WorkMailRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetPersonalAccessTokenMetadata"; }
  ...
  template <typename OrganizationIdT = Aws::String>
  GetPersonalAccessTokenMetadataRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename PersonalAccessTokenIdT = Aws::String>
  GetPersonalAccessTokenMetadataRequest& WithPersonalAccessTokenId(PersonalAccessTokenIdT&& value) {
