...
class ListResourceDelegatesResult {
 public:
  ...
  void SetDelegates(DelegatesT&& value) {
    m_delegatesHasBeenSet = true;
    m_delegates = std::forward<DelegatesT>(value);
  }
  template <typename DelegatesT = Aws::Vector<Delegate>>
  ListResourceDelegatesResult& WithDelegates(DelegatesT&& value) {
    SetDelegates(std::forward<DelegatesT>(value));
    return *this;
  }
  template <typename DelegatesT = Delegate>
  ListResourceDelegatesResult& AddDelegates(DelegatesT&& value) {
    m_delegatesHasBeenSet = true;
    m_delegates.emplace_back(std::forward<DelegatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceDelegatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceDelegatesResult& WithRequestId(RequestIdT&& value) {
