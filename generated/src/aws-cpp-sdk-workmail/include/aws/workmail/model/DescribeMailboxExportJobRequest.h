...
class DescribeMailboxExportJobRequest : public WorkMailRequest {
 public:
  AWS_WORKMAIL_API DescribeMailboxExportJobRequest() = default;
  ...
  template <typename JobIdT = Aws::String>
  DescribeMailboxExportJobRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename OrganizationIdT = Aws::String>
  DescribeMailboxExportJobRequest& WithOrganizationId(OrganizationIdT&& value) {
