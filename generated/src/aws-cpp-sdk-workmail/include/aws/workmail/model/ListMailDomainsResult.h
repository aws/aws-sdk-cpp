...
class ListMailDomainsResult {
 public:
  ...
  void SetMailDomains(MailDomainsT&& value) {
    m_mailDomainsHasBeenSet = true;
    m_mailDomains = std::forward<MailDomainsT>(value);
  }
  template <typename MailDomainsT = Aws::Vector<MailDomainSummary>>
  ListMailDomainsResult& WithMailDomains(MailDomainsT&& value) {
    SetMailDomains(std::forward<MailDomainsT>(value));
    return *this;
  }
  template <typename MailDomainsT = MailDomainSummary>
  ListMailDomainsResult& AddMailDomains(MailDomainsT&& value) {
    m_mailDomainsHasBeenSet = true;
    m_mailDomains.emplace_back(std::forward<MailDomainsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMailDomainsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMailDomainsResult& WithRequestId(RequestIdT&& value) {
