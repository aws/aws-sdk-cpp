...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API RegisterToWorkMailResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RegisterToWorkMailResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
