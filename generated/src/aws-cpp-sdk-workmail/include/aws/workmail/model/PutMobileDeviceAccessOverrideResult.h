...
namespace Model
{
  ...
  public:
    ...
    inline PutMobileDeviceAccessOverrideResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutMobileDeviceAccessOverrideResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutMobileDeviceAccessOverrideResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
