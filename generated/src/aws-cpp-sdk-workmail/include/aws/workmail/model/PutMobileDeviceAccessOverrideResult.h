...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API PutMobileDeviceAccessOverrideResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutMobileDeviceAccessOverrideResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
