...
class DeleteOrganizationRequest : public WorkMailRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteOrganizationRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename OrganizationIdT = Aws::String>
  DeleteOrganizationRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  inline void SetDeleteDirectory(bool value) {
    m_deleteDirectoryHasBeenSet = true;
    m_deleteDirectory = value;
  }
  inline DeleteOrganizationRequest& WithDeleteDirectory(bool value) {
    SetDeleteDirectory(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteOrganizationRequest& WithForceDelete(bool value) {
  ...
  inline void SetDeleteIdentityCenterApplication(bool value) {
    m_deleteIdentityCenterApplicationHasBeenSet = true;
    m_deleteIdentityCenterApplication = value;
  }
  inline DeleteOrganizationRequest& WithDeleteIdentityCenterApplication(bool value) {
    SetDeleteIdentityCenterApplication(value);
    return *this;
  }
  ///@}
 private:
