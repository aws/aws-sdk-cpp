...
class PutEmailMonitoringConfigurationRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  PutEmailMonitoringConfigurationRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  PutEmailMonitoringConfigurationRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename LogGroupArnT = Aws::String>
  PutEmailMonitoringConfigurationRequest& WithLogGroupArn(LogGroupArnT&& value) {
