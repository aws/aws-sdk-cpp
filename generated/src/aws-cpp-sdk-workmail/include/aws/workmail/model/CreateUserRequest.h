...
class CreateUserRequest : public WorkMailRequest {
 public:
  ...
  inline CreateUserRequest& WithRole(UserRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
  ...
  inline CreateUserRequest& WithHiddenFromGlobalAddressList(bool value) {
  ...
  void SetIdentityProviderUserId(IdentityProviderUserIdT&& value) {
    ...
    m_identityProviderUserId = std::forward<IdentityProviderUserIdT>(value);
  }
  template <typename IdentityProviderUserIdT = Aws::String>
  CreateUserRequest& WithIdentityProviderUserId(IdentityProviderUserIdT&& value) {
    SetIdentityProviderUserId(std::forward<IdentityProviderUserIdT>(value));
    return *this;
  }
  ///@}
 private:
