...
class DeleteOrganizationResult {
 public:
  AWS_WORKMAIL_API DeleteOrganizationResult() = default;
  ...
  template <typename OrganizationIdT = Aws::String>
  DeleteOrganizationResult& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename StateT = Aws::String>
  DeleteOrganizationResult& WithState(StateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteOrganizationResult& WithRequestId(RequestIdT&& value) {
