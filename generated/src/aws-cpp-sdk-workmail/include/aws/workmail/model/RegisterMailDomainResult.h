...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API RegisterMailDomainResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RegisterMailDomainResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
