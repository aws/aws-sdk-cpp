...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API AssociateMemberToGroupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateMemberToGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
