...
namespace Model
{
  ...
  public:
    ...
    inline AssociateMemberToGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateMemberToGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateMemberToGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
