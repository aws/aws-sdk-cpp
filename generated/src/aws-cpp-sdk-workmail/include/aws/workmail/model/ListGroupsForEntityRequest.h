...
class ListGroupsForEntityRequest : public WorkMailRequest {
 public:
  AWS_WORKMAIL_API ListGroupsForEntityRequest() = default;
  ...
  template <typename OrganizationIdT = Aws::String>
  ListGroupsForEntityRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename EntityIdT = Aws::String>
  ListGroupsForEntityRequest& WithEntityId(EntityIdT&& value) {
  ...
  template <typename FiltersT = ListGroupsForEntityFilters>
  void SetFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
    m_filters = std::forward<FiltersT>(value);
  }
  template <typename FiltersT = ListGroupsForEntityFilters>
  ListGroupsForEntityRequest& WithFilters(FiltersT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListGroupsForEntityRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListGroupsForEntityRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
