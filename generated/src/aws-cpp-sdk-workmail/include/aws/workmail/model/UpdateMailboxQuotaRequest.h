...
class UpdateMailboxQuotaRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  UpdateMailboxQuotaRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  UpdateMailboxQuotaRequest& WithUserId(UserIdT&& value) {
  ...
  inline UpdateMailboxQuotaRequest& WithMailboxQuota(int value) {
