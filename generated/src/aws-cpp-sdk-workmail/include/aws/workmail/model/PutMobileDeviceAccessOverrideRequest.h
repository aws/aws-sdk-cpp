...
class PutMobileDeviceAccessOverrideRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  PutMobileDeviceAccessOverrideRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  PutMobileDeviceAccessOverrideRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename DeviceIdT = Aws::String>
  PutMobileDeviceAccessOverrideRequest& WithDeviceId(DeviceIdT&& value) {
  ...
  inline void SetEffect(MobileDeviceAccessRuleEffect value) {
    m_effectHasBeenSet = true;
    m_effect = value;
  }
  inline PutMobileDeviceAccessOverrideRequest& WithEffect(MobileDeviceAccessRuleEffect value) {
    SetEffect(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  PutMobileDeviceAccessOverrideRequest& WithDescription(DescriptionT&& value) {
