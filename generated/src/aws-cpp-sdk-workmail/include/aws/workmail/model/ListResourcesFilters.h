...
class ListResourcesFilters {
 public:
  ...
  template <typename NamePrefixT = Aws::String>
  ListResourcesFilters& WithNamePrefix(NamePrefixT&& value) {
  ...
  void SetPrimaryEmailPrefix(PrimaryEmailPrefixT&& value) {
    m_primaryEmailPrefixHasBeenSet = true;
    m_primaryEmailPrefix = std::forward<PrimaryEmailPrefixT>(value);
  }
  template <typename PrimaryEmailPrefixT = Aws::String>
  ListResourcesFilters& WithPrimaryEmailPrefix(PrimaryEmailPrefixT&& value) {
    SetPrimaryEmailPrefix(std::forward<PrimaryEmailPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListResourcesFilters& WithState(EntityState value) {
    SetState(value);
    return *this;
  }
  ///@}
