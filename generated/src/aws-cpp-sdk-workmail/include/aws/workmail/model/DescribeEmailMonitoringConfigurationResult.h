...
class DescribeEmailMonitoringConfigurationResult {
 public:
  ...
  AWS_WORKMAIL_API DescribeEmailMonitoringConfigurationResult& operator=(
  ...
  template <typename RoleArnT = Aws::String>
  DescribeEmailMonitoringConfigurationResult& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename LogGroupArnT = Aws::String>
  DescribeEmailMonitoringConfigurationResult& WithLogGroupArn(LogGroupArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEmailMonitoringConfigurationResult& WithRequestId(RequestIdT&& value) {
