...
class CreateIdentityCenterApplicationRequest : public WorkMailRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateIdentityCenterApplicationRequest& WithName(NameT&& value) {
  ...
  template <typename InstanceArnT = Aws::String>
  CreateIdentityCenterApplicationRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateIdentityCenterApplicationRequest& WithClientToken(ClientTokenT&& value) {
