...
class DeleteMailboxPermissionsRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  DeleteMailboxPermissionsRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename EntityIdT = Aws::String>
  DeleteMailboxPermissionsRequest& WithEntityId(EntityIdT&& value) {
  ...
  template <typename GranteeIdT = Aws::String>
  DeleteMailboxPermissionsRequest& WithGranteeId(GranteeIdT&& value) {
