...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API UpdateDefaultMailDomainResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDefaultMailDomainResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
