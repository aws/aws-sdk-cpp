...
class FolderConfiguration {
 public:
  ...
  inline void SetName(FolderName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline FolderConfiguration& WithName(FolderName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAction(RetentionAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline FolderConfiguration& WithAction(RetentionAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline FolderConfiguration& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
