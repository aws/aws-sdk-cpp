...
namespace Model
{
  ...
  public:
    ...
    inline PutAccessControlRuleResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutAccessControlRuleResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutAccessControlRuleResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
