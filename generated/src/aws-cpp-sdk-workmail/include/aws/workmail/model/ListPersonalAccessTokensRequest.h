...
class ListPersonalAccessTokensRequest : public WorkMailRequest {
 public:
  AWS_WORKMAIL_API ListPersonalAccessTokensRequest() = default;
  ...
  template <typename OrganizationIdT = Aws::String>
  ListPersonalAccessTokensRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  ListPersonalAccessTokensRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPersonalAccessTokensRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPersonalAccessTokensRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
