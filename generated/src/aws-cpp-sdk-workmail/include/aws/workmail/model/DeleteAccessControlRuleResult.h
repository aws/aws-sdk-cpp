...
namespace Model
{
  ...
  public:
    ...
    inline DeleteAccessControlRuleResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteAccessControlRuleResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteAccessControlRuleResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
