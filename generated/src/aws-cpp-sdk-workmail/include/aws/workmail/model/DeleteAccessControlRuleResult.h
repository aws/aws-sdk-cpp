...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API DeleteAccessControlRuleResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAccessControlRuleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
