...
namespace Model
{
  ...
  public:
    ...
    inline PutInboundDmarcSettingsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutInboundDmarcSettingsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutInboundDmarcSettingsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
