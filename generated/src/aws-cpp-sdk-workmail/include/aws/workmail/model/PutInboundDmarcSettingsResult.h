...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API PutInboundDmarcSettingsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutInboundDmarcSettingsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
