...
class RegisterToWorkMailRequest : public WorkMailRequest {
 public:
  AWS_WORKMAIL_API RegisterToWorkMailRequest() = default;
  ...
  template <typename OrganizationIdT = Aws::String>
  RegisterToWorkMailRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename EntityIdT = Aws::String>
  RegisterToWorkMailRequest& WithEntityId(EntityIdT&& value) {
  ...
  template <typename EmailT = Aws::String>
  RegisterToWorkMailRequest& WithEmail(EmailT&& value) {
