...
namespace Model
{
  ...
  public:
    ...
    template<typename OrganizationIdT = Aws::String>
    RegisterToWorkMailRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EntityIdT = Aws::String>
    RegisterToWorkMailRequest& WithEntityId(EntityIdT&& value) { SetEntityId(std::forward<EntityIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EmailT = Aws::String>
    RegisterToWorkMailRequest& WithEmail(EmailT&& value) { SetEmail(std::forward<EmailT>(value)); return *this;}
    ///@}
  private:
