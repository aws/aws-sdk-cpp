...
class ListMailboxExportJobsResult {
 public:
  ...
  template <typename JobsT = Aws::Vector<MailboxExportJob>>
  ListMailboxExportJobsResult& WithJobs(JobsT&& value) {
    SetJobs(std::forward<JobsT>(value));
    return *this;
  }
  template <typename JobsT = MailboxExportJob>
  ListMailboxExportJobsResult& AddJobs(JobsT&& value) {
    m_jobsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMailboxExportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMailboxExportJobsResult& WithRequestId(RequestIdT&& value) {
