...
namespace Model
{
  ...
  public:
    ...
    inline DeleteMobileDeviceAccessOverrideResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteMobileDeviceAccessOverrideResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteMobileDeviceAccessOverrideResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
