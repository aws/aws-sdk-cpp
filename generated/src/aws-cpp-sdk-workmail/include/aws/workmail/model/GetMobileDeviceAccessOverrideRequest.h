...
class GetMobileDeviceAccessOverrideRequest : public WorkMailRequest {
 public:
  AWS_WORKMAIL_API GetMobileDeviceAccessOverrideRequest() = default;
  ...
  template <typename OrganizationIdT = Aws::String>
  GetMobileDeviceAccessOverrideRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  GetMobileDeviceAccessOverrideRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename DeviceIdT = Aws::String>
  GetMobileDeviceAccessOverrideRequest& WithDeviceId(DeviceIdT&& value) {
