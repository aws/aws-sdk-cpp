...
namespace Model
{
  ...
  public:
    ...
    template<typename OrganizationIdT = Aws::String>
    GetMobileDeviceAccessOverrideRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UserIdT = Aws::String>
    GetMobileDeviceAccessOverrideRequest& WithUserId(UserIdT&& value) { SetUserId(std::forward<UserIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DeviceIdT = Aws::String>
    GetMobileDeviceAccessOverrideRequest& WithDeviceId(DeviceIdT&& value) { SetDeviceId(std::forward<DeviceIdT>(value)); return *this;}
    ///@}
  private:
