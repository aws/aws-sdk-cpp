...
class Member {
 public:
  ...
  inline void SetType(MemberType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Member& WithType(MemberType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline Member& WithState(EntityState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename EnabledDateT = Aws::Utils::DateTime>
  Member& WithEnabledDate(EnabledDateT&& value) {
  ...
  template <typename DisabledDateT = Aws::Utils::DateTime>
  Member& WithDisabledDate(DisabledDateT&& value) {
