...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API ListImpersonationRolesRequest() = default;
    ...
    template<typename OrganizationIdT = Aws::String>
    ListImpersonationRolesRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListImpersonationRolesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
