...
class ListImpersonationRolesRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  ListImpersonationRolesRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListImpersonationRolesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListImpersonationRolesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
