...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API DisassociateMemberFromGroupRequest() = default;
    ...
    template<typename OrganizationIdT = Aws::String>
    DisassociateMemberFromGroupRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupIdT = Aws::String>
    DisassociateMemberFromGroupRequest& WithGroupId(GroupIdT&& value) { SetGroupId(std::forward<GroupIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberIdT = Aws::String>
    DisassociateMemberFromGroupRequest& WithMemberId(MemberIdT&& value) { SetMemberId(std::forward<MemberIdT>(value)); return *this;}
    ///@}
  private:
