...
class DisassociateMemberFromGroupRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  DisassociateMemberFromGroupRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename GroupIdT = Aws::String>
  DisassociateMemberFromGroupRequest& WithGroupId(GroupIdT&& value) {
  ...
  template <typename MemberIdT = Aws::String>
  DisassociateMemberFromGroupRequest& WithMemberId(MemberIdT&& value) {
