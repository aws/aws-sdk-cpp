...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API ListUsersRequest() = default;
    ...
    template<typename OrganizationIdT = Aws::String>
    ListUsersRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = ListUsersFilters>
    void SetFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters = std::forward<FiltersT>(value); }
    template<typename FiltersT = ListUsersFilters>
    ListUsersRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    ///@}
  private:
