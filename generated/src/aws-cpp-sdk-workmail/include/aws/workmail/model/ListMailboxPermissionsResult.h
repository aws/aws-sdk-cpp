...
class ListMailboxPermissionsResult {
 public:
  ...
  template <typename PermissionsT = Aws::Vector<Permission>>
  ListMailboxPermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = Permission>
  ListMailboxPermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMailboxPermissionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMailboxPermissionsResult& WithRequestId(RequestIdT&& value) {
