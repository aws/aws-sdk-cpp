...
namespace Model
{
  ...
  public:
    ...
    inline CancelMailboxExportJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CancelMailboxExportJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CancelMailboxExportJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
