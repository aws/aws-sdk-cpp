...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API CancelMailboxExportJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelMailboxExportJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
