...
class CreateAvailabilityConfigurationRequest : public WorkMailRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateAvailabilityConfigurationRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename OrganizationIdT = Aws::String>
  CreateAvailabilityConfigurationRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  CreateAvailabilityConfigurationRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename EwsProviderT = EwsAvailabilityProvider>
  CreateAvailabilityConfigurationRequest& WithEwsProvider(EwsProviderT&& value) {
  ...
  template <typename LambdaProviderT = LambdaAvailabilityProvider>
  CreateAvailabilityConfigurationRequest& WithLambdaProvider(LambdaProviderT&& value) {
