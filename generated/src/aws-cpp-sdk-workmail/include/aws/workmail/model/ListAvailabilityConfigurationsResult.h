...
class ListAvailabilityConfigurationsResult {
 public:
  ...
  void SetAvailabilityConfigurations(AvailabilityConfigurationsT&& value) {
    m_availabilityConfigurationsHasBeenSet = true;
    m_availabilityConfigurations = std::forward<AvailabilityConfigurationsT>(value);
  }
  template <typename AvailabilityConfigurationsT = Aws::Vector<AvailabilityConfiguration>>
  ListAvailabilityConfigurationsResult& WithAvailabilityConfigurations(AvailabilityConfigurationsT&& value) {
    SetAvailabilityConfigurations(std::forward<AvailabilityConfigurationsT>(value));
    return *this;
  }
  template <typename AvailabilityConfigurationsT = AvailabilityConfiguration>
  ListAvailabilityConfigurationsResult& AddAvailabilityConfigurations(AvailabilityConfigurationsT&& value) {
    m_availabilityConfigurationsHasBeenSet = true;
    m_availabilityConfigurations.emplace_back(std::forward<AvailabilityConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAvailabilityConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAvailabilityConfigurationsResult& WithRequestId(RequestIdT&& value) {
