...
class DisassociateDelegateFromResourceRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  DisassociateDelegateFromResourceRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  DisassociateDelegateFromResourceRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename EntityIdT = Aws::String>
  DisassociateDelegateFromResourceRequest& WithEntityId(EntityIdT&& value) {
