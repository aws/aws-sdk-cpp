...
class CreateMobileDeviceAccessRuleRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& WithDescription(DescriptionT&& value) {
  ...
  inline CreateMobileDeviceAccessRuleRequest& WithEffect(MobileDeviceAccessRuleEffect value) {
    SetEffect(value);
    return *this;
  }
  ///@}
  ...
  template <typename DeviceTypesT = Aws::Vector<Aws::String>>
  CreateMobileDeviceAccessRuleRequest& WithDeviceTypes(DeviceTypesT&& value) {
    SetDeviceTypes(std::forward<DeviceTypesT>(value));
    return *this;
  }
  template <typename DeviceTypesT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& AddDeviceTypes(DeviceTypesT&& value) {
    m_deviceTypesHasBeenSet = true;
  ...
  template <typename NotDeviceTypesT = Aws::Vector<Aws::String>>
  CreateMobileDeviceAccessRuleRequest& WithNotDeviceTypes(NotDeviceTypesT&& value) {
    SetNotDeviceTypes(std::forward<NotDeviceTypesT>(value));
    return *this;
  }
  template <typename NotDeviceTypesT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& AddNotDeviceTypes(NotDeviceTypesT&& value) {
    m_notDeviceTypesHasBeenSet = true;
  ...
  template <typename DeviceModelsT = Aws::Vector<Aws::String>>
  CreateMobileDeviceAccessRuleRequest& WithDeviceModels(DeviceModelsT&& value) {
    SetDeviceModels(std::forward<DeviceModelsT>(value));
    return *this;
  }
  template <typename DeviceModelsT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& AddDeviceModels(DeviceModelsT&& value) {
    m_deviceModelsHasBeenSet = true;
  ...
  template <typename NotDeviceModelsT = Aws::Vector<Aws::String>>
  CreateMobileDeviceAccessRuleRequest& WithNotDeviceModels(NotDeviceModelsT&& value) {
    SetNotDeviceModels(std::forward<NotDeviceModelsT>(value));
    return *this;
  }
  template <typename NotDeviceModelsT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& AddNotDeviceModels(NotDeviceModelsT&& value) {
    m_notDeviceModelsHasBeenSet = true;
  ...
  template <typename DeviceOperatingSystemsT = Aws::Vector<Aws::String>>
  CreateMobileDeviceAccessRuleRequest& WithDeviceOperatingSystems(DeviceOperatingSystemsT&& value) {
    SetDeviceOperatingSystems(std::forward<DeviceOperatingSystemsT>(value));
    return *this;
  }
  template <typename DeviceOperatingSystemsT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& AddDeviceOperatingSystems(DeviceOperatingSystemsT&& value) {
    m_deviceOperatingSystemsHasBeenSet = true;
  ...
  template <typename NotDeviceOperatingSystemsT = Aws::Vector<Aws::String>>
  CreateMobileDeviceAccessRuleRequest& WithNotDeviceOperatingSystems(NotDeviceOperatingSystemsT&& value) {
  ...
  CreateMobileDeviceAccessRuleRequest& AddNotDeviceOperatingSystems(NotDeviceOperatingSystemsT&& value) {
    m_notDeviceOperatingSystemsHasBeenSet = true;
  ...
  template <typename DeviceUserAgentsT = Aws::Vector<Aws::String>>
  CreateMobileDeviceAccessRuleRequest& WithDeviceUserAgents(DeviceUserAgentsT&& value) {
    SetDeviceUserAgents(std::forward<DeviceUserAgentsT>(value));
    return *this;
  }
  template <typename DeviceUserAgentsT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& AddDeviceUserAgents(DeviceUserAgentsT&& value) {
    m_deviceUserAgentsHasBeenSet = true;
  ...
  template <typename NotDeviceUserAgentsT = Aws::Vector<Aws::String>>
  CreateMobileDeviceAccessRuleRequest& WithNotDeviceUserAgents(NotDeviceUserAgentsT&& value) {
    SetNotDeviceUserAgents(std::forward<NotDeviceUserAgentsT>(value));
    return *this;
  }
  template <typename NotDeviceUserAgentsT = Aws::String>
  CreateMobileDeviceAccessRuleRequest& AddNotDeviceUserAgents(NotDeviceUserAgentsT&& value) {
    m_notDeviceUserAgentsHasBeenSet = true;
