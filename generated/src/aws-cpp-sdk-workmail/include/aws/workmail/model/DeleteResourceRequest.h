...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API DeleteResourceRequest() = default;
    ...
    template<typename OrganizationIdT = Aws::String>
    DeleteResourceRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
