...
class UpdateDefaultMailDomainRequest : public WorkMailRequest {
 public:
  AWS_WORKMAIL_API UpdateDefaultMailDomainRequest() = default;
  ...
  template <typename OrganizationIdT = Aws::String>
  UpdateDefaultMailDomainRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  UpdateDefaultMailDomainRequest& WithDomainName(DomainNameT&& value) {
