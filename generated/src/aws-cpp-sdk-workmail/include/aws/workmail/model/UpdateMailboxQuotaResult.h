...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API UpdateMailboxQuotaResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateMailboxQuotaResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
