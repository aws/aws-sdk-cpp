...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API ListAliasesRequest() = default;
    ...
    template<typename OrganizationIdT = Aws::String>
    ListAliasesRequest& WithOrganizationId(OrganizationIdT&& value) { SetOrganizationId(std::forward<OrganizationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EntityIdT = Aws::String>
    ListAliasesRequest& WithEntityId(EntityIdT&& value) { SetEntityId(std::forward<EntityIdT>(value)); return *this;}
    ///@}
