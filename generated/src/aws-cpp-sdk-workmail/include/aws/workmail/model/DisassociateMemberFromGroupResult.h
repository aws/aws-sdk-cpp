...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API DisassociateMemberFromGroupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateMemberFromGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
