...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateMemberFromGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateMemberFromGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateMemberFromGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
