...
class PersonalAccessTokenSummary {
 public:
  ...
  void SetPersonalAccessTokenId(PersonalAccessTokenIdT&& value) {
    m_personalAccessTokenIdHasBeenSet = true;
    m_personalAccessTokenId = std::forward<PersonalAccessTokenIdT>(value);
  }
  template <typename PersonalAccessTokenIdT = Aws::String>
  PersonalAccessTokenSummary& WithPersonalAccessTokenId(PersonalAccessTokenIdT&& value) {
    SetPersonalAccessTokenId(std::forward<PersonalAccessTokenIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UserIdT = Aws::String>
  PersonalAccessTokenSummary& WithUserId(UserIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  PersonalAccessTokenSummary& WithName(NameT&& value) {
  ...
  template <typename DateCreatedT = Aws::Utils::DateTime>
  PersonalAccessTokenSummary& WithDateCreated(DateCreatedT&& value) {
  ...
  void SetDateLastUsed(DateLastUsedT&& value) {
    m_dateLastUsedHasBeenSet = true;
    m_dateLastUsed = std::forward<DateLastUsedT>(value);
  }
  template <typename DateLastUsedT = Aws::Utils::DateTime>
  PersonalAccessTokenSummary& WithDateLastUsed(DateLastUsedT&& value) {
    SetDateLastUsed(std::forward<DateLastUsedT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExpiresTimeT = Aws::Utils::DateTime>
  PersonalAccessTokenSummary& WithExpiresTime(ExpiresTimeT&& value) {
  ...
  template <typename ScopesT = Aws::Vector<Aws::String>>
  PersonalAccessTokenSummary& WithScopes(ScopesT&& value) {
    SetScopes(std::forward<ScopesT>(value));
    return *this;
  }
  template <typename ScopesT = Aws::String>
  PersonalAccessTokenSummary& AddScopes(ScopesT&& value) {
    m_scopesHasBeenSet = true;
