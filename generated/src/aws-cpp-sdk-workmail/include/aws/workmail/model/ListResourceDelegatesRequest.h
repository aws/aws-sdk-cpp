...
class ListResourceDelegatesRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  ListResourceDelegatesRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  ListResourceDelegatesRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceDelegatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResourceDelegatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
