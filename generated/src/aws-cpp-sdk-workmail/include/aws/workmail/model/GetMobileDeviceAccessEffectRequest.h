...
class GetMobileDeviceAccessEffectRequest : public WorkMailRequest {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  GetMobileDeviceAccessEffectRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  template <typename DeviceTypeT = Aws::String>
  GetMobileDeviceAccessEffectRequest& WithDeviceType(DeviceTypeT&& value) {
  ...
  void SetDeviceModel(DeviceModelT&& value) {
    m_deviceModelHasBeenSet = true;
    m_deviceModel = std::forward<DeviceModelT>(value);
  }
  template <typename DeviceModelT = Aws::String>
  GetMobileDeviceAccessEffectRequest& WithDeviceModel(DeviceModelT&& value) {
    SetDeviceModel(std::forward<DeviceModelT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceOperatingSystem(DeviceOperatingSystemT&& value) {
    m_deviceOperatingSystemHasBeenSet = true;
    m_deviceOperatingSystem = std::forward<DeviceOperatingSystemT>(value);
  }
  template <typename DeviceOperatingSystemT = Aws::String>
  GetMobileDeviceAccessEffectRequest& WithDeviceOperatingSystem(DeviceOperatingSystemT&& value) {
    SetDeviceOperatingSystem(std::forward<DeviceOperatingSystemT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceUserAgent(DeviceUserAgentT&& value) {
    m_deviceUserAgentHasBeenSet = true;
    m_deviceUserAgent = std::forward<DeviceUserAgentT>(value);
  }
  template <typename DeviceUserAgentT = Aws::String>
  GetMobileDeviceAccessEffectRequest& WithDeviceUserAgent(DeviceUserAgentT&& value) {
    SetDeviceUserAgent(std::forward<DeviceUserAgentT>(value));
    return *this;
  }
  ///@}
 private:
