...
namespace Model
{
  ...
  {
  public:
    AWS_WORKMAIL_API PutEmailMonitoringConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutEmailMonitoringConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
