...
class ListMailDomainsRequest : public WorkMailRequest {
 public:
  AWS_WORKMAIL_API ListMailDomainsRequest() = default;
  ...
  template <typename OrganizationIdT = Aws::String>
  ListMailDomainsRequest& WithOrganizationId(OrganizationIdT&& value) {
  ...
  inline ListMailDomainsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMailDomainsRequest& WithNextToken(NextTokenT&& value) {
