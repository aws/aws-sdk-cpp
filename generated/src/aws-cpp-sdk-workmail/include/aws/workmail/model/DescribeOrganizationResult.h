...
class DescribeOrganizationResult {
 public:
  ...
  void SetCompletedDate(CompletedDateT&& value) {
    ...
    m_completedDate = std::forward<CompletedDateT>(value);
  }
  template <typename CompletedDateT = Aws::Utils::DateTime>
  DescribeOrganizationResult& WithCompletedDate(CompletedDateT&& value) {
    SetCompletedDate(std::forward<CompletedDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMigrationAdmin(MigrationAdminT&& value) {
    ...
    m_migrationAdmin = std::forward<MigrationAdminT>(value);
  }
  template <typename MigrationAdminT = Aws::String>
  DescribeOrganizationResult& WithMigrationAdmin(MigrationAdminT&& value) {
    SetMigrationAdmin(std::forward<MigrationAdminT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInteroperabilityEnabled(bool value) {
    m_interoperabilityEnabledHasBeenSet = true;
    m_interoperabilityEnabled = value;
  }
  inline DescribeOrganizationResult& WithInteroperabilityEnabled(bool value) {
    SetInteroperabilityEnabled(value);
    return *this;
  }
  ///@}
