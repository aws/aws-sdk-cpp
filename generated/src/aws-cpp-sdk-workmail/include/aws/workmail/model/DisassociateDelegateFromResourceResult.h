...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateDelegateFromResourceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateDelegateFromResourceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateDelegateFromResourceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
