...
'"','h','t','t','p','s',':','/','/','t','n','b','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','t','n','b','-','f','i','p','s','.','{','R',
...
't','n','b','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
...
const char* TnbEndpointRules::GetRulesBlob()
{
