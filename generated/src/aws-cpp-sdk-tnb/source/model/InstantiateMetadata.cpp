...
InstantiateMetadata::InstantiateMetadata(JsonView jsonValue) { *this = jsonValue; }

InstantiateMetadata& InstantiateMetadata::operator=(JsonView jsonValue) {
...
JsonValue InstantiateMetadata::Jsonize() const {
  JsonValue payload;
