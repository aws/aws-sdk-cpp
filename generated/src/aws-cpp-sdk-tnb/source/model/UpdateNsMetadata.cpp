...
UpdateNsMetadata::UpdateNsMetadata(JsonView jsonValue) { *this = jsonValue; }

UpdateNsMetadata& UpdateNsMetadata::operator=(JsonView jsonValue) {
...
JsonValue UpdateNsMetadata::Jsonize() const {
  JsonValue payload;
