...
class AWS_TNB_API TnbClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  TnbClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<TnbEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CancelSolNetworkOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CancelSolNetworkOperationRequestT = Model::CancelSolNetworkOperationRequest>
  Model::CancelSolNetworkOperationOutcomeCallable CancelSolNetworkOperationCallable(
      const CancelSolNetworkOperationRequestT& request) const {
    return SubmitCallable(&TnbClient::CancelSolNetworkOperation, request);
  }

  /**
   * An Async wrapper for CancelSolNetworkOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelSolNetworkOperationRequestT = Model::CancelSolNetworkOperationRequest>
  void CancelSolNetworkOperationAsync(const CancelSolNetworkOperationRequestT& request,
                                      const CancelSolNetworkOperationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateSolFunctionPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateSolFunctionPackageRequestT = Model::CreateSolFunctionPackageRequest>
  Model::CreateSolFunctionPackageOutcomeCallable CreateSolFunctionPackageCallable(
      const CreateSolFunctionPackageRequestT& request = {}) const {
    return SubmitCallable(&TnbClient::CreateSolFunctionPackage, request);
  }

  /**
   * An Async wrapper for CreateSolFunctionPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSolFunctionPackageRequestT = Model::CreateSolFunctionPackageRequest>
  void CreateSolFunctionPackageAsync(const CreateSolFunctionPackageResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateSolNetworkInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSolNetworkInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSolNetworkInstanceRequestT = Model::CreateSolNetworkInstanceRequest>
  void CreateSolNetworkInstanceAsync(const CreateSolNetworkInstanceRequestT& request,
                                     const CreateSolNetworkInstanceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSolNetworkPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSolNetworkPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSolNetworkPackageRequestT = Model::CreateSolNetworkPackageRequest>
  void CreateSolNetworkPackageAsync(const CreateSolNetworkPackageResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const CreateSolNetworkPackageRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteSolFunctionPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSolFunctionPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSolFunctionPackageRequestT = Model::DeleteSolFunctionPackageRequest>
  void DeleteSolFunctionPackageAsync(const DeleteSolFunctionPackageRequestT& request,
                                     const DeleteSolFunctionPackageResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSolNetworkInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSolNetworkInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSolNetworkInstanceRequestT = Model::DeleteSolNetworkInstanceRequest>
  void DeleteSolNetworkInstanceAsync(const DeleteSolNetworkInstanceRequestT& request,
                                     const DeleteSolNetworkInstanceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSolNetworkPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSolNetworkPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSolNetworkPackageRequestT = Model::DeleteSolNetworkPackageRequest>
  void DeleteSolNetworkPackageAsync(const DeleteSolNetworkPackageRequestT& request,
                                    const DeleteSolNetworkPackageResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSolFunctionInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSolFunctionInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSolFunctionInstanceRequestT = Model::GetSolFunctionInstanceRequest>
  void GetSolFunctionInstanceAsync(const GetSolFunctionInstanceRequestT& request,
                                   const GetSolFunctionInstanceResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSolFunctionPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSolFunctionPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSolFunctionPackageRequestT = Model::GetSolFunctionPackageRequest>
  void GetSolFunctionPackageAsync(const GetSolFunctionPackageRequestT& request, const GetSolFunctionPackageResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSolFunctionPackageContentOutcome GetSolFunctionPackageContent(
      const Model::GetSolFunctionPackageContentRequest& request) const;

  /**
   * A Callable wrapper for GetSolFunctionPackageContent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSolFunctionPackageContentRequestT = Model::GetSolFunctionPackageContentRequest>
  Model::GetSolFunctionPackageContentOutcomeCallable GetSolFunctionPackageContentCallable(
      const GetSolFunctionPackageContentRequestT& request) const {
    return SubmitCallable(&TnbClient::GetSolFunctionPackageContent, request);
  }

  /**
   * An Async wrapper for GetSolFunctionPackageContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSolFunctionPackageContentRequestT = Model::GetSolFunctionPackageContentRequest>
  void GetSolFunctionPackageContentAsync(const GetSolFunctionPackageContentRequestT& request,
                                         const GetSolFunctionPackageContentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetSolFunctionPackageDescriptorOutcome GetSolFunctionPackageDescriptor(
      const Model::GetSolFunctionPackageDescriptorRequest& request) const;

  /**
   * A Callable wrapper for GetSolFunctionPackageDescriptor that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSolFunctionPackageDescriptorRequestT = Model::GetSolFunctionPackageDescriptorRequest>
  Model::GetSolFunctionPackageDescriptorOutcomeCallable GetSolFunctionPackageDescriptorCallable(
      const GetSolFunctionPackageDescriptorRequestT& request) const {
    return SubmitCallable(&TnbClient::GetSolFunctionPackageDescriptor, request);
  }

  /**
   * An Async wrapper for GetSolFunctionPackageDescriptor that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetSolFunctionPackageDescriptorRequestT = Model::GetSolFunctionPackageDescriptorRequest>
  void GetSolFunctionPackageDescriptorAsync(const GetSolFunctionPackageDescriptorRequestT& request,
                                            const GetSolFunctionPackageDescriptorResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSolNetworkInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSolNetworkInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSolNetworkInstanceRequestT = Model::GetSolNetworkInstanceRequest>
  void GetSolNetworkInstanceAsync(const GetSolNetworkInstanceRequestT& request, const GetSolNetworkInstanceResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSolNetworkOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSolNetworkOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSolNetworkOperationRequestT = Model::GetSolNetworkOperationRequest>
  void GetSolNetworkOperationAsync(const GetSolNetworkOperationRequestT& request,
                                   const GetSolNetworkOperationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSolNetworkPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSolNetworkPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSolNetworkPackageRequestT = Model::GetSolNetworkPackageRequest>
  void GetSolNetworkPackageAsync(const GetSolNetworkPackageRequestT& request, const GetSolNetworkPackageResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSolNetworkPackageContentOutcome GetSolNetworkPackageContent(
      const Model::GetSolNetworkPackageContentRequest& request) const;

  /**
   * A Callable wrapper for GetSolNetworkPackageContent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSolNetworkPackageContentRequestT = Model::GetSolNetworkPackageContentRequest>
  Model::GetSolNetworkPackageContentOutcomeCallable GetSolNetworkPackageContentCallable(
      const GetSolNetworkPackageContentRequestT& request) const {
    return SubmitCallable(&TnbClient::GetSolNetworkPackageContent, request);
  }

  /**
   * An Async wrapper for GetSolNetworkPackageContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSolNetworkPackageContentRequestT = Model::GetSolNetworkPackageContentRequest>
  void GetSolNetworkPackageContentAsync(const GetSolNetworkPackageContentRequestT& request,
                                        const GetSolNetworkPackageContentResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSolNetworkPackageDescriptorOutcome GetSolNetworkPackageDescriptor(
      const Model::GetSolNetworkPackageDescriptorRequest& request) const;

  /**
   * A Callable wrapper for GetSolNetworkPackageDescriptor that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSolNetworkPackageDescriptorRequestT = Model::GetSolNetworkPackageDescriptorRequest>
  Model::GetSolNetworkPackageDescriptorOutcomeCallable GetSolNetworkPackageDescriptorCallable(
      const GetSolNetworkPackageDescriptorRequestT& request) const {
    return SubmitCallable(&TnbClient::GetSolNetworkPackageDescriptor, request);
  }

  /**
   * An Async wrapper for GetSolNetworkPackageDescriptor that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetSolNetworkPackageDescriptorRequestT = Model::GetSolNetworkPackageDescriptorRequest>
  void GetSolNetworkPackageDescriptorAsync(const GetSolNetworkPackageDescriptorRequestT& request,
                                           const GetSolNetworkPackageDescriptorResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::InstantiateSolNetworkInstanceOutcome InstantiateSolNetworkInstance(
      const Model::InstantiateSolNetworkInstanceRequest& request) const;

  /**
   * A Callable wrapper for InstantiateSolNetworkInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename InstantiateSolNetworkInstanceRequestT = Model::InstantiateSolNetworkInstanceRequest>
  Model::InstantiateSolNetworkInstanceOutcomeCallable InstantiateSolNetworkInstanceCallable(
      const InstantiateSolNetworkInstanceRequestT& request) const {
    return SubmitCallable(&TnbClient::InstantiateSolNetworkInstance, request);
  }

  /**
   * An Async wrapper for InstantiateSolNetworkInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename InstantiateSolNetworkInstanceRequestT = Model::InstantiateSolNetworkInstanceRequest>
  void InstantiateSolNetworkInstanceAsync(const InstantiateSolNetworkInstanceRequestT& request,
                                          const InstantiateSolNetworkInstanceResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSolFunctionInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListSolFunctionInstancesRequestT = Model::ListSolFunctionInstancesRequest>
  Model::ListSolFunctionInstancesOutcomeCallable ListSolFunctionInstancesCallable(
      const ListSolFunctionInstancesRequestT& request = {}) const {
    return SubmitCallable(&TnbClient::ListSolFunctionInstances, request);
  }

  /**
   * An Async wrapper for ListSolFunctionInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSolFunctionInstancesRequestT = Model::ListSolFunctionInstancesRequest>
  void ListSolFunctionInstancesAsync(const ListSolFunctionInstancesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListSolFunctionInstancesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSolFunctionPackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSolFunctionPackages that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSolFunctionPackagesRequestT = Model::ListSolFunctionPackagesRequest>
  void ListSolFunctionPackagesAsync(const ListSolFunctionPackagesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListSolFunctionPackagesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSolNetworkInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSolNetworkInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSolNetworkInstancesRequestT = Model::ListSolNetworkInstancesRequest>
  void ListSolNetworkInstancesAsync(const ListSolNetworkInstancesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListSolNetworkInstancesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSolNetworkOperations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListSolNetworkOperationsRequestT = Model::ListSolNetworkOperationsRequest>
  Model::ListSolNetworkOperationsOutcomeCallable ListSolNetworkOperationsCallable(
      const ListSolNetworkOperationsRequestT& request = {}) const {
    return SubmitCallable(&TnbClient::ListSolNetworkOperations, request);
  }

  /**
   * An Async wrapper for ListSolNetworkOperations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSolNetworkOperationsRequestT = Model::ListSolNetworkOperationsRequest>
  void ListSolNetworkOperationsAsync(const ListSolNetworkOperationsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListSolNetworkOperationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSolNetworkPackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSolNetworkPackages that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSolNetworkPackagesRequestT = Model::ListSolNetworkPackagesRequest>
  void ListSolNetworkPackagesAsync(const ListSolNetworkPackagesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListSolNetworkPackagesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutSolFunctionPackageContentOutcome PutSolFunctionPackageContent(
      const Model::PutSolFunctionPackageContentRequest& request) const;

  /**
   * A Callable wrapper for PutSolFunctionPackageContent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutSolFunctionPackageContentRequestT = Model::PutSolFunctionPackageContentRequest>
  Model::PutSolFunctionPackageContentOutcomeCallable PutSolFunctionPackageContentCallable(
      const PutSolFunctionPackageContentRequestT& request) const {
    return SubmitCallable(&TnbClient::PutSolFunctionPackageContent, request);
  }

  /**
   * An Async wrapper for PutSolFunctionPackageContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutSolFunctionPackageContentRequestT = Model::PutSolFunctionPackageContentRequest>
  void PutSolFunctionPackageContentAsync(const PutSolFunctionPackageContentRequestT& request,
                                         const PutSolFunctionPackageContentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutSolNetworkPackageContentOutcome PutSolNetworkPackageContent(
      const Model::PutSolNetworkPackageContentRequest& request) const;

  /**
   * A Callable wrapper for PutSolNetworkPackageContent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutSolNetworkPackageContentRequestT = Model::PutSolNetworkPackageContentRequest>
  Model::PutSolNetworkPackageContentOutcomeCallable PutSolNetworkPackageContentCallable(
      const PutSolNetworkPackageContentRequestT& request) const {
    return SubmitCallable(&TnbClient::PutSolNetworkPackageContent, request);
  }

  /**
   * An Async wrapper for PutSolNetworkPackageContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutSolNetworkPackageContentRequestT = Model::PutSolNetworkPackageContentRequest>
  void PutSolNetworkPackageContentAsync(const PutSolNetworkPackageContentRequestT& request,
                                        const PutSolNetworkPackageContentResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::TerminateSolNetworkInstanceOutcome TerminateSolNetworkInstance(
      const Model::TerminateSolNetworkInstanceRequest& request) const;

  /**
   * A Callable wrapper for TerminateSolNetworkInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename TerminateSolNetworkInstanceRequestT = Model::TerminateSolNetworkInstanceRequest>
  Model::TerminateSolNetworkInstanceOutcomeCallable TerminateSolNetworkInstanceCallable(
      const TerminateSolNetworkInstanceRequestT& request) const {
    return SubmitCallable(&TnbClient::TerminateSolNetworkInstance, request);
  }

  /**
   * An Async wrapper for TerminateSolNetworkInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TerminateSolNetworkInstanceRequestT = Model::TerminateSolNetworkInstanceRequest>
  void TerminateSolNetworkInstanceAsync(const TerminateSolNetworkInstanceRequestT& request,
                                        const TerminateSolNetworkInstanceResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSolFunctionPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSolFunctionPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSolFunctionPackageRequestT = Model::UpdateSolFunctionPackageRequest>
  void UpdateSolFunctionPackageAsync(const UpdateSolFunctionPackageRequestT& request,
                                     const UpdateSolFunctionPackageResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSolNetworkInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSolNetworkInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSolNetworkInstanceRequestT = Model::UpdateSolNetworkInstanceRequest>
  void UpdateSolNetworkInstanceAsync(const UpdateSolNetworkInstanceRequestT& request,
                                     const UpdateSolNetworkInstanceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSolNetworkPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSolNetworkPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSolNetworkPackageRequestT = Model::UpdateSolNetworkPackageRequest>
  void UpdateSolNetworkPackageAsync(const UpdateSolNetworkPackageRequestT& request,
                                    const UpdateSolNetworkPackageResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ValidateSolFunctionPackageContentOutcome ValidateSolFunctionPackageContent(
      const Model::ValidateSolFunctionPackageContentRequest& request) const;

  /**
   * A Callable wrapper for ValidateSolFunctionPackageContent that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ValidateSolFunctionPackageContentRequestT = Model::ValidateSolFunctionPackageContentRequest>
  Model::ValidateSolFunctionPackageContentOutcomeCallable ValidateSolFunctionPackageContentCallable(
      const ValidateSolFunctionPackageContentRequestT& request) const {
    return SubmitCallable(&TnbClient::ValidateSolFunctionPackageContent, request);
  }

  /**
   * An Async wrapper for ValidateSolFunctionPackageContent that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ValidateSolFunctionPackageContentRequestT = Model::ValidateSolFunctionPackageContentRequest>
  void ValidateSolFunctionPackageContentAsync(const ValidateSolFunctionPackageContentRequestT& request,
                                              const ValidateSolFunctionPackageContentResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ValidateSolNetworkPackageContentOutcome ValidateSolNetworkPackageContent(
      const Model::ValidateSolNetworkPackageContentRequest& request) const;

  /**
   * A Callable wrapper for ValidateSolNetworkPackageContent that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ValidateSolNetworkPackageContentRequestT = Model::ValidateSolNetworkPackageContentRequest>
  Model::ValidateSolNetworkPackageContentOutcomeCallable ValidateSolNetworkPackageContentCallable(
      const ValidateSolNetworkPackageContentRequestT& request) const {
    return SubmitCallable(&TnbClient::ValidateSolNetworkPackageContent, request);
  }

  /**
   * An Async wrapper for ValidateSolNetworkPackageContent that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ValidateSolNetworkPackageContentRequestT = Model::ValidateSolNetworkPackageContentRequest>
  void ValidateSolNetworkPackageContentAsync(const ValidateSolNetworkPackageContentRequestT& request,
                                             const ValidateSolNetworkPackageContentResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
