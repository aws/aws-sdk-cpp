...
namespace Model
{
  ...
  {
  public:
    AWS_TNB_API ListSolNetworkInstanceMetadata() = default;
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    ListSolNetworkInstanceMetadata& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedT = Aws::Utils::DateTime>
    ListSolNetworkInstanceMetadata& WithLastModified(LastModifiedT&& value) { SetLastModified(std::forward<LastModifiedT>(value)); return *this;}
    ///@}
  private:
