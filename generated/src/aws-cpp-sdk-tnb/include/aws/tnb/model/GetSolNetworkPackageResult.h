...
class GetSolNetworkPackageResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetSolNetworkPackageResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetSolNetworkPackageResult& WithId(IdT&& value) {
  ...
  template <typename MetadataT = GetSolNetworkPackageMetadata>
  GetSolNetworkPackageResult& WithMetadata(MetadataT&& value) {
  ...
  template <typename NsdIdT = Aws::String>
  GetSolNetworkPackageResult& WithNsdId(NsdIdT&& value) {
  ...
  template <typename NsdNameT = Aws::String>
  GetSolNetworkPackageResult& WithNsdName(NsdNameT&& value) {
  ...
  inline GetSolNetworkPackageResult& WithNsdOnboardingState(NsdOnboardingState value) {
  ...
  inline GetSolNetworkPackageResult& WithNsdOperationalState(NsdOperationalState value) {
  ...
  inline GetSolNetworkPackageResult& WithNsdUsageState(NsdUsageState value) {
  ...
  template <typename NsdVersionT = Aws::String>
  GetSolNetworkPackageResult& WithNsdVersion(NsdVersionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetSolNetworkPackageResult& WithTags(TagsT&& value) {
  ...
  template <typename VnfPkgIdsT = Aws::Vector<Aws::String>>
  GetSolNetworkPackageResult& WithVnfPkgIds(VnfPkgIdsT&& value) {
    SetVnfPkgIds(std::forward<VnfPkgIdsT>(value));
    return *this;
  }
  template <typename VnfPkgIdsT = Aws::String>
  GetSolNetworkPackageResult& AddVnfPkgIds(VnfPkgIdsT&& value) {
    m_vnfPkgIdsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetSolNetworkPackageResult& WithRequestId(RequestIdT&& value) {
