...
class ModifyVnfInfoMetadata {
 public:
  ...
  void SetVnfConfigurableProperties(VnfConfigurablePropertiesT&& value) {
    m_vnfConfigurablePropertiesHasBeenSet = true;
    m_vnfConfigurableProperties = std::forward<VnfConfigurablePropertiesT>(value);
  }
  template <typename VnfConfigurablePropertiesT = Aws::Utils::Document>
  ModifyVnfInfoMetadata& WithVnfConfigurableProperties(VnfConfigurablePropertiesT&& value) {
    SetVnfConfigurableProperties(std::forward<VnfConfigurablePropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVnfInstanceId(VnfInstanceIdT&& value) {
    m_vnfInstanceIdHasBeenSet = true;
    m_vnfInstanceId = std::forward<VnfInstanceIdT>(value);
  }
  template <typename VnfInstanceIdT = Aws::String>
  ModifyVnfInfoMetadata& WithVnfInstanceId(VnfInstanceIdT&& value) {
    SetVnfInstanceId(std::forward<VnfInstanceIdT>(value));
    return *this;
  }
  ///@}
 private:
