...
class GetSolNetworkPackageDescriptorResult {
 public:
  ...
  inline void SetContentType(DescriptorContentType value) {
    m_contentTypeHasBeenSet = true;
    m_contentType = value;
  }
  inline GetSolNetworkPackageDescriptorResult& WithContentType(DescriptorContentType value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSolNetworkPackageDescriptorResult& WithRequestId(RequestIdT&& value) {
