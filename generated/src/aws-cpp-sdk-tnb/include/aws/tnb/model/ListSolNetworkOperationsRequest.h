...
class ListSolNetworkOperationsRequest : public TnbRequest {
 public:
  ...
  inline ListSolNetworkOperationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSolNetworkOperationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename NsInstanceIdT = Aws::String>
  ListSolNetworkOperationsRequest& WithNsInstanceId(NsInstanceIdT&& value) {
