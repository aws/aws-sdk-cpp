...
class GetSolFunctionPackageDescriptorResult {
 public:
  ...
  inline GetSolFunctionPackageDescriptorResult& WithContentType(DescriptorContentType value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSolFunctionPackageDescriptorResult& WithRequestId(RequestIdT&& value) {
