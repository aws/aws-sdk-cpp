...
class GetSolFunctionPackageContentResult {
 public:
  ...
  inline void SetContentType(PackageContentType value) {
    m_contentTypeHasBeenSet = true;
    m_contentType = value;
  }
  inline GetSolFunctionPackageContentResult& WithContentType(PackageContentType value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSolFunctionPackageContentResult& WithRequestId(RequestIdT&& value) {
