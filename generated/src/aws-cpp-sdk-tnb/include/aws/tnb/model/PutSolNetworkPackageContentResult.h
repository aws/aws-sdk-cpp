...
class PutSolNetworkPackageContentResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  PutSolNetworkPackageContentResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  PutSolNetworkPackageContentResult& WithId(IdT&& value) {
  ...
  template <typename MetadataT = PutSolNetworkPackageContentMetadata>
  PutSolNetworkPackageContentResult& WithMetadata(MetadataT&& value) {
  ...
  template <typename NsdIdT = Aws::String>
  PutSolNetworkPackageContentResult& WithNsdId(NsdIdT&& value) {
  ...
  template <typename NsdNameT = Aws::String>
  PutSolNetworkPackageContentResult& WithNsdName(NsdNameT&& value) {
  ...
  template <typename NsdVersionT = Aws::String>
  PutSolNetworkPackageContentResult& WithNsdVersion(NsdVersionT&& value) {
  ...
  template <typename VnfPkgIdsT = Aws::Vector<Aws::String>>
  PutSolNetworkPackageContentResult& WithVnfPkgIds(VnfPkgIdsT&& value) {
    SetVnfPkgIds(std::forward<VnfPkgIdsT>(value));
    return *this;
  }
  template <typename VnfPkgIdsT = Aws::String>
  PutSolNetworkPackageContentResult& AddVnfPkgIds(VnfPkgIdsT&& value) {
    m_vnfPkgIdsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  PutSolNetworkPackageContentResult& WithRequestId(RequestIdT&& value) {
