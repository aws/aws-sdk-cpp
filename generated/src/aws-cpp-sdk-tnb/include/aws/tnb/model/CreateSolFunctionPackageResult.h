...
class CreateSolFunctionPackageResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateSolFunctionPackageResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateSolFunctionPackageResult& WithId(IdT&& value) {
  ...
  inline CreateSolFunctionPackageResult& WithOnboardingState(OnboardingState value) {
  ...
  inline CreateSolFunctionPackageResult& WithOperationalState(OperationalState value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateSolFunctionPackageResult& WithTags(TagsT&& value) {
  ...
  inline CreateSolFunctionPackageResult& WithUsageState(UsageState value) {
    SetUsageState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateSolFunctionPackageResult& WithRequestId(RequestIdT&& value) {
