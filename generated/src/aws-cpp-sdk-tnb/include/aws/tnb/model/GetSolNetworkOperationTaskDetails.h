...
class GetSolNetworkOperationTaskDetails {
 public:
  ...
  void SetTaskContext(TaskContextT&& value) {
    m_taskContextHasBeenSet = true;
    m_taskContext = std::forward<TaskContextT>(value);
  }
  template <typename TaskContextT = Aws::Map<Aws::String, Aws::String>>
  GetSolNetworkOperationTaskDetails& WithTaskContext(TaskContextT&& value) {
    SetTaskContext(std::forward<TaskContextT>(value));
    return *this;
  }
  ...
  GetSolNetworkOperationTaskDetails& AddTaskContext(TaskContextKeyT&& key, TaskContextValueT&& value) {
    m_taskContextHasBeenSet = true;
    m_taskContext.emplace(std::forward<TaskContextKeyT>(key), std::forward<TaskContextValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TaskEndTimeT = Aws::Utils::DateTime>
  GetSolNetworkOperationTaskDetails& WithTaskEndTime(TaskEndTimeT&& value) {
  ...
  void SetTaskErrorDetails(TaskErrorDetailsT&& value) {
    m_taskErrorDetailsHasBeenSet = true;
    m_taskErrorDetails = std::forward<TaskErrorDetailsT>(value);
  }
  template <typename TaskErrorDetailsT = ErrorInfo>
  GetSolNetworkOperationTaskDetails& WithTaskErrorDetails(TaskErrorDetailsT&& value) {
    SetTaskErrorDetails(std::forward<TaskErrorDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TaskNameT = Aws::String>
  GetSolNetworkOperationTaskDetails& WithTaskName(TaskNameT&& value) {
  ...
  template <typename TaskStartTimeT = Aws::Utils::DateTime>
  GetSolNetworkOperationTaskDetails& WithTaskStartTime(TaskStartTimeT&& value) {
  ...
  inline GetSolNetworkOperationTaskDetails& WithTaskStatus(TaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
