...
class GetSolNetworkOperationResult {
 public:
  ...
  inline GetSolNetworkOperationResult& WithLcmOperationType(LcmOperationType value) {
  ...
  inline GetSolNetworkOperationResult& WithOperationState(NsLcmOperationState value) {
  ...
  inline GetSolNetworkOperationResult& WithUpdateType(UpdateSolNetworkType value) {
    SetUpdateType(value);
    return *this;
  }
  ///@}
