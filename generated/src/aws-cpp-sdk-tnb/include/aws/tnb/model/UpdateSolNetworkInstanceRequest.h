...
class UpdateSolNetworkInstanceRequest : public TnbRequest {
 public:
  ...
  void SetModifyVnfInfoData(ModifyVnfInfoDataT&& value) {
    m_modifyVnfInfoDataHasBeenSet = true;
    m_modifyVnfInfoData = std::forward<ModifyVnfInfoDataT>(value);
  }
  template <typename ModifyVnfInfoDataT = UpdateSolNetworkModify>
  UpdateSolNetworkInstanceRequest& WithModifyVnfInfoData(ModifyVnfInfoDataT&& value) {
    SetModifyVnfInfoData(std::forward<ModifyVnfInfoDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUpdateNs(UpdateNsT&& value) {
    m_updateNsHasBeenSet = true;
    m_updateNs = std::forward<UpdateNsT>(value);
  }
  template <typename UpdateNsT = UpdateSolNetworkServiceData>
  UpdateSolNetworkInstanceRequest& WithUpdateNs(UpdateNsT&& value) {
    SetUpdateNs(std::forward<UpdateNsT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateSolNetworkInstanceRequest& WithUpdateType(UpdateSolNetworkType value) {
    SetUpdateType(value);
    return *this;
  }
  ///@}
