...
class UpdateSolNetworkServiceData {
 public:
  ...
  void SetAdditionalParamsForNs(AdditionalParamsForNsT&& value) {
    m_additionalParamsForNsHasBeenSet = true;
    m_additionalParamsForNs = std::forward<AdditionalParamsForNsT>(value);
  }
  template <typename AdditionalParamsForNsT = Aws::Utils::Document>
  UpdateSolNetworkServiceData& WithAdditionalParamsForNs(AdditionalParamsForNsT&& value) {
    SetAdditionalParamsForNs(std::forward<AdditionalParamsForNsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NsdInfoIdT = Aws::String>
  UpdateSolNetworkServiceData& WithNsdInfoId(NsdInfoIdT&& value) {
