...
class CreateSolNetworkPackageResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateSolNetworkPackageResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateSolNetworkPackageResult& WithId(IdT&& value) {
  ...
  inline CreateSolNetworkPackageResult& WithNsdOnboardingState(NsdOnboardingState value) {
  ...
  inline CreateSolNetworkPackageResult& WithNsdOperationalState(NsdOperationalState value) {
  ...
  inline CreateSolNetworkPackageResult& WithNsdUsageState(NsdUsageState value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateSolNetworkPackageResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateSolNetworkPackageResult& WithRequestId(RequestIdT&& value) {
