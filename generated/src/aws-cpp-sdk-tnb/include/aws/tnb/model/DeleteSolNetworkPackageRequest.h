...
namespace Model
{
  ...
  {
  public:
    AWS_TNB_API DeleteSolNetworkPackageRequest() = default;
    ...
    template<typename NsdInfoIdT = Aws::String>
    DeleteSolNetworkPackageRequest& WithNsdInfoId(NsdInfoIdT&& value) { SetNsdInfoId(std::forward<NsdInfoIdT>(value)); return *this;}
    ///@}
  private:
