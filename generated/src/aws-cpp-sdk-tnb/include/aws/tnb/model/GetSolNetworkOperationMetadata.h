...
class GetSolNetworkOperationMetadata {
 public:
  ...
  void SetInstantiateMetadata(InstantiateMetadataT&& value) {
    m_instantiateMetadataHasBeenSet = true;
    m_instantiateMetadata = std::forward<InstantiateMetadataT>(value);
  }
  template <typename InstantiateMetadataT = InstantiateMetadata>
  GetSolNetworkOperationMetadata& WithInstantiateMetadata(InstantiateMetadataT&& value) {
    SetInstantiateMetadata(std::forward<InstantiateMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModifyVnfInfoMetadata(ModifyVnfInfoMetadataT&& value) {
    ...
    m_modifyVnfInfoMetadata = std::forward<ModifyVnfInfoMetadataT>(value);
  }
  template <typename ModifyVnfInfoMetadataT = ModifyVnfInfoMetadata>
  GetSolNetworkOperationMetadata& WithModifyVnfInfoMetadata(ModifyVnfInfoMetadataT&& value) {
    SetModifyVnfInfoMetadata(std::forward<ModifyVnfInfoMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUpdateNsMetadata(UpdateNsMetadataT&& value) {
    m_updateNsMetadataHasBeenSet = true;
    m_updateNsMetadata = std::forward<UpdateNsMetadataT>(value);
  }
  template <typename UpdateNsMetadataT = UpdateNsMetadata>
  GetSolNetworkOperationMetadata& WithUpdateNsMetadata(UpdateNsMetadataT&& value) {
    SetUpdateNsMetadata(std::forward<UpdateNsMetadataT>(value));
    return *this;
  }
  ///@}
 private:
