...
class ListSolFunctionPackagesResult {
 public:
  ...
  void SetFunctionPackages(FunctionPackagesT&& value) {
    m_functionPackagesHasBeenSet = true;
    m_functionPackages = std::forward<FunctionPackagesT>(value);
  }
  template <typename FunctionPackagesT = Aws::Vector<ListSolFunctionPackageInfo>>
  ListSolFunctionPackagesResult& WithFunctionPackages(FunctionPackagesT&& value) {
    SetFunctionPackages(std::forward<FunctionPackagesT>(value));
    return *this;
  }
  template <typename FunctionPackagesT = ListSolFunctionPackageInfo>
  ListSolFunctionPackagesResult& AddFunctionPackages(FunctionPackagesT&& value) {
    m_functionPackagesHasBeenSet = true;
    m_functionPackages.emplace_back(std::forward<FunctionPackagesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSolFunctionPackagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSolFunctionPackagesResult& WithRequestId(RequestIdT&& value) {
