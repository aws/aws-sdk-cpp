...
class GetSolFunctionPackageContentRequest : public TnbRequest {
 public:
  ...
  inline void SetAccept(PackageContentType value) {
    m_acceptHasBeenSet = true;
    m_accept = value;
  }
  inline GetSolFunctionPackageContentRequest& WithAccept(PackageContentType value) {
    SetAccept(value);
    return *this;
  }
  ///@}
  ...
  template <typename VnfPkgIdT = Aws::String>
  GetSolFunctionPackageContentRequest& WithVnfPkgId(VnfPkgIdT&& value) {
