...
class ListSolFunctionInstancesResult {
 public:
  ...
  void SetFunctionInstances(FunctionInstancesT&& value) {
    m_functionInstancesHasBeenSet = true;
    m_functionInstances = std::forward<FunctionInstancesT>(value);
  }
  template <typename FunctionInstancesT = Aws::Vector<ListSolFunctionInstanceInfo>>
  ListSolFunctionInstancesResult& WithFunctionInstances(FunctionInstancesT&& value) {
    SetFunctionInstances(std::forward<FunctionInstancesT>(value));
    return *this;
  }
  template <typename FunctionInstancesT = ListSolFunctionInstanceInfo>
  ListSolFunctionInstancesResult& AddFunctionInstances(FunctionInstancesT&& value) {
    m_functionInstancesHasBeenSet = true;
    m_functionInstances.emplace_back(std::forward<FunctionInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSolFunctionInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSolFunctionInstancesResult& WithRequestId(RequestIdT&& value) {
