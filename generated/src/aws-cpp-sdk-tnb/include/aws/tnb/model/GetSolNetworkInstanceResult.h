...
class GetSolNetworkInstanceResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  GetSolNetworkInstanceResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetSolNetworkInstanceResult& WithId(IdT&& value) {
  ...
  void SetLcmOpInfo(LcmOpInfoT&& value) {
    m_lcmOpInfoHasBeenSet = true;
    m_lcmOpInfo = std::forward<LcmOpInfoT>(value);
  }
  template <typename LcmOpInfoT = LcmOperationInfo>
  GetSolNetworkInstanceResult& WithLcmOpInfo(LcmOpInfoT&& value) {
    SetLcmOpInfo(std::forward<LcmOpInfoT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MetadataT = GetSolNetworkInstanceMetadata>
  GetSolNetworkInstanceResult& WithMetadata(MetadataT&& value) {
  ...
  template <typename NsInstanceDescriptionT = Aws::String>
  GetSolNetworkInstanceResult& WithNsInstanceDescription(NsInstanceDescriptionT&& value) {
  ...
  template <typename NsInstanceNameT = Aws::String>
  GetSolNetworkInstanceResult& WithNsInstanceName(NsInstanceNameT&& value) {
  ...
  inline GetSolNetworkInstanceResult& WithNsState(NsState value) {
    SetNsState(value);
    return *this;
  }
  ///@}
  ...
  template <typename NsdIdT = Aws::String>
  GetSolNetworkInstanceResult& WithNsdId(NsdIdT&& value) {
  ...
  template <typename NsdInfoIdT = Aws::String>
  GetSolNetworkInstanceResult& WithNsdInfoId(NsdInfoIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetSolNetworkInstanceResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSolNetworkInstanceResult& WithRequestId(RequestIdT&& value) {
