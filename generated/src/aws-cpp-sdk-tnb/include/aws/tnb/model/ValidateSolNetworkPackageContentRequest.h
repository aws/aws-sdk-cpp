...
class ValidateSolNetworkPackageContentRequest : public StreamingTnbRequest {
 public:
  AWS_TNB_API ValidateSolNetworkPackageContentRequest() = default;
  ...
  void SetNsdInfoId(NsdInfoIdT&& value) {
    ...
    m_nsdInfoId = std::forward<NsdInfoIdT>(value);
  }
  template <typename NsdInfoIdT = Aws::String>
  ValidateSolNetworkPackageContentRequest& WithNsdInfoId(NsdInfoIdT&& value) {
    SetNsdInfoId(std::forward<NsdInfoIdT>(value));
    return *this;
  }
  ///@}
 private:
