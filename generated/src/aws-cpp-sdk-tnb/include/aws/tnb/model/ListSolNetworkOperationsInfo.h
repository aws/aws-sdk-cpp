...
class ListSolNetworkOperationsInfo {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListSolNetworkOperationsInfo& WithArn(ArnT&& value) {
  ...
  template <typename ErrorT = ProblemDetails>
  ListSolNetworkOperationsInfo& WithError(ErrorT&& value) {
  ...
  template <typename IdT = Aws::String>
  ListSolNetworkOperationsInfo& WithId(IdT&& value) {
  ...
  inline void SetLcmOperationType(LcmOperationType value) {
    m_lcmOperationTypeHasBeenSet = true;
    m_lcmOperationType = value;
  }
  inline ListSolNetworkOperationsInfo& WithLcmOperationType(LcmOperationType value) {
    SetLcmOperationType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetadataT = ListSolNetworkOperationsMetadata>
  ListSolNetworkOperationsInfo& WithMetadata(MetadataT&& value) {
  ...
  void SetNsInstanceId(NsInstanceIdT&& value) {
    ...
    m_nsInstanceId = std::forward<NsInstanceIdT>(value);
  }
  template <typename NsInstanceIdT = Aws::String>
  ListSolNetworkOperationsInfo& WithNsInstanceId(NsInstanceIdT&& value) {
    SetNsInstanceId(std::forward<NsInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOperationState(NsLcmOperationState value) {
    m_operationStateHasBeenSet = true;
    m_operationState = value;
  }
  inline ListSolNetworkOperationsInfo& WithOperationState(NsLcmOperationState value) {
  ...
  inline void SetUpdateType(UpdateSolNetworkType value) {
    m_updateTypeHasBeenSet = true;
    m_updateType = value;
  }
  inline ListSolNetworkOperationsInfo& WithUpdateType(UpdateSolNetworkType value) {
    SetUpdateType(value);
    return *this;
  }
  ///@}
