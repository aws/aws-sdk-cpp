...
class ListSolFunctionInstanceInfo {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListSolFunctionInstanceInfo& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  ListSolFunctionInstanceInfo& WithId(IdT&& value) {
  ...
  void SetInstantiatedVnfInfo(InstantiatedVnfInfoT&& value) {
    ...
    m_instantiatedVnfInfo = std::forward<InstantiatedVnfInfoT>(value);
  }
  template <typename InstantiatedVnfInfoT = GetSolInstantiatedVnfInfo>
  ListSolFunctionInstanceInfo& WithInstantiatedVnfInfo(InstantiatedVnfInfoT&& value) {
    SetInstantiatedVnfInfo(std::forward<InstantiatedVnfInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInstantiationState(VnfInstantiationState value) {
    m_instantiationStateHasBeenSet = true;
    m_instantiationState = value;
  }
  inline ListSolFunctionInstanceInfo& WithInstantiationState(VnfInstantiationState value) {
    SetInstantiationState(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetadataT = ListSolFunctionInstanceMetadata>
  ListSolFunctionInstanceInfo& WithMetadata(MetadataT&& value) {
  ...
  template <typename NsInstanceIdT = Aws::String>
  ListSolFunctionInstanceInfo& WithNsInstanceId(NsInstanceIdT&& value) {
  ...
  template <typename VnfPkgIdT = Aws::String>
  ListSolFunctionInstanceInfo& WithVnfPkgId(VnfPkgIdT&& value) {
  ...
  void SetVnfPkgName(VnfPkgNameT&& value) {
    m_vnfPkgNameHasBeenSet = true;
    m_vnfPkgName = std::forward<VnfPkgNameT>(value);
  }
  template <typename VnfPkgNameT = Aws::String>
  ListSolFunctionInstanceInfo& WithVnfPkgName(VnfPkgNameT&& value) {
    SetVnfPkgName(std::forward<VnfPkgNameT>(value));
    return *this;
  }
  ///@}
 private:
