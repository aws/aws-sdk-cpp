...
class CreateSolNetworkInstanceResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateSolNetworkInstanceResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateSolNetworkInstanceResult& WithId(IdT&& value) {
  ...
  template <typename NsInstanceNameT = Aws::String>
  CreateSolNetworkInstanceResult& WithNsInstanceName(NsInstanceNameT&& value) {
  ...
  template <typename NsdInfoIdT = Aws::String>
  CreateSolNetworkInstanceResult& WithNsdInfoId(NsdInfoIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateSolNetworkInstanceResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateSolNetworkInstanceResult& WithRequestId(RequestIdT&& value) {
