...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    PutSolFunctionPackageContentResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename MetadataT = PutSolFunctionPackageContentMetadata>
    void SetMetadata(MetadataT&& value) { m_metadataHasBeenSet = true; m_metadata = std::forward<MetadataT>(value); }
    template<typename MetadataT = PutSolFunctionPackageContentMetadata>
    PutSolFunctionPackageContentResult& WithMetadata(MetadataT&& value) { SetMetadata(std::forward<MetadataT>(value)); return *this;}
    ///@}
    ...
    template<typename VnfProductNameT = Aws::String>
    PutSolFunctionPackageContentResult& WithVnfProductName(VnfProductNameT&& value) { SetVnfProductName(std::forward<VnfProductNameT>(value)); return *this;}
    ///@}
    ...
    template<typename VnfProviderT = Aws::String>
    PutSolFunctionPackageContentResult& WithVnfProvider(VnfProviderT&& value) { SetVnfProvider(std::forward<VnfProviderT>(value)); return *this;}
    ///@}
    ...
    template<typename VnfdIdT = Aws::String>
    PutSolFunctionPackageContentResult& WithVnfdId(VnfdIdT&& value) { SetVnfdId(std::forward<VnfdIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VnfdVersionT = Aws::String>
    PutSolFunctionPackageContentResult& WithVnfdVersion(VnfdVersionT&& value) { SetVnfdVersion(std::forward<VnfdVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutSolFunctionPackageContentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
