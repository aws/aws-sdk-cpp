...
class ListSolNetworkInstancesResult {
 public:
  ...
  void SetNetworkInstances(NetworkInstancesT&& value) {
    m_networkInstancesHasBeenSet = true;
    m_networkInstances = std::forward<NetworkInstancesT>(value);
  }
  template <typename NetworkInstancesT = Aws::Vector<ListSolNetworkInstanceInfo>>
  ListSolNetworkInstancesResult& WithNetworkInstances(NetworkInstancesT&& value) {
    SetNetworkInstances(std::forward<NetworkInstancesT>(value));
    return *this;
  }
  template <typename NetworkInstancesT = ListSolNetworkInstanceInfo>
  ListSolNetworkInstancesResult& AddNetworkInstances(NetworkInstancesT&& value) {
    m_networkInstancesHasBeenSet = true;
    m_networkInstances.emplace_back(std::forward<NetworkInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSolNetworkInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSolNetworkInstancesResult& WithRequestId(RequestIdT&& value) {
