...
class CreateSolNetworkInstanceRequest : public TnbRequest {
 public:
  ...
  void SetNsDescription(NsDescriptionT&& value) {
    m_nsDescriptionHasBeenSet = true;
    m_nsDescription = std::forward<NsDescriptionT>(value);
  }
  template <typename NsDescriptionT = Aws::String>
  CreateSolNetworkInstanceRequest& WithNsDescription(NsDescriptionT&& value) {
    SetNsDescription(std::forward<NsDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNsName(NsNameT&& value) {
    ...
    m_nsName = std::forward<NsNameT>(value);
  }
  template <typename NsNameT = Aws::String>
  CreateSolNetworkInstanceRequest& WithNsName(NsNameT&& value) {
    SetNsName(std::forward<NsNameT>(value));
    return *this;
  }
  ///@}
