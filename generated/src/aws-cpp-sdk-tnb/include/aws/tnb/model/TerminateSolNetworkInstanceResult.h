...
class TerminateSolNetworkInstanceResult {
 public:
  ...
  template <typename NsLcmOpOccIdT = Aws::String>
  TerminateSolNetworkInstanceResult& WithNsLcmOpOccId(NsLcmOpOccIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  TerminateSolNetworkInstanceResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  TerminateSolNetworkInstanceResult& WithRequestId(RequestIdT&& value) {
