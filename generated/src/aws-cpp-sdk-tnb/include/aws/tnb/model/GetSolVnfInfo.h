...
class GetSolVnfInfo {
 public:
  ...
  inline void SetVnfState(VnfOperationalState value) {
    m_vnfStateHasBeenSet = true;
    m_vnfState = value;
  }
  inline GetSolVnfInfo& WithVnfState(VnfOperationalState value) {
    SetVnfState(value);
    return *this;
  }
  ///@}
  ...
  void SetVnfcResourceInfo(VnfcResourceInfoT&& value) {
    ...
    m_vnfcResourceInfo = std::forward<VnfcResourceInfoT>(value);
  }
  template <typename VnfcResourceInfoT = Aws::Vector<GetSolVnfcResourceInfo>>
  GetSolVnfInfo& WithVnfcResourceInfo(VnfcResourceInfoT&& value) {
    SetVnfcResourceInfo(std::forward<VnfcResourceInfoT>(value));
    return *this;
  }
  template <typename VnfcResourceInfoT = GetSolVnfcResourceInfo>
  GetSolVnfInfo& AddVnfcResourceInfo(VnfcResourceInfoT&& value) {
    m_vnfcResourceInfoHasBeenSet = true;
    m_vnfcResourceInfo.emplace_back(std::forward<VnfcResourceInfoT>(value));
    return *this;
  }
  ///@}
 private:
