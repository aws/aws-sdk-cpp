...
class ValidateSolNetworkPackageContentResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  ValidateSolNetworkPackageContentResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  ValidateSolNetworkPackageContentResult& WithId(IdT&& value) {
  ...
  template <typename MetadataT = ValidateSolNetworkPackageContentMetadata>
  ValidateSolNetworkPackageContentResult& WithMetadata(MetadataT&& value) {
  ...
  void SetNsdId(NsdIdT&& value) {
    m_nsdIdHasBeenSet = true;
    m_nsdId = std::forward<NsdIdT>(value);
  }
  template <typename NsdIdT = Aws::String>
  ValidateSolNetworkPackageContentResult& WithNsdId(NsdIdT&& value) {
    SetNsdId(std::forward<NsdIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNsdName(NsdNameT&& value) {
    m_nsdNameHasBeenSet = true;
    m_nsdName = std::forward<NsdNameT>(value);
  }
  template <typename NsdNameT = Aws::String>
  ValidateSolNetworkPackageContentResult& WithNsdName(NsdNameT&& value) {
    SetNsdName(std::forward<NsdNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNsdVersion(NsdVersionT&& value) {
    m_nsdVersionHasBeenSet = true;
    m_nsdVersion = std::forward<NsdVersionT>(value);
  }
  template <typename NsdVersionT = Aws::String>
  ValidateSolNetworkPackageContentResult& WithNsdVersion(NsdVersionT&& value) {
    SetNsdVersion(std::forward<NsdVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVnfPkgIds(VnfPkgIdsT&& value) {
    m_vnfPkgIdsHasBeenSet = true;
    m_vnfPkgIds = std::forward<VnfPkgIdsT>(value);
  }
  template <typename VnfPkgIdsT = Aws::Vector<Aws::String>>
  ValidateSolNetworkPackageContentResult& WithVnfPkgIds(VnfPkgIdsT&& value) {
    SetVnfPkgIds(std::forward<VnfPkgIdsT>(value));
    return *this;
  }
  template <typename VnfPkgIdsT = Aws::String>
  ValidateSolNetworkPackageContentResult& AddVnfPkgIds(VnfPkgIdsT&& value) {
    m_vnfPkgIdsHasBeenSet = true;
    m_vnfPkgIds.emplace_back(std::forward<VnfPkgIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ValidateSolNetworkPackageContentResult& WithRequestId(RequestIdT&& value) {
