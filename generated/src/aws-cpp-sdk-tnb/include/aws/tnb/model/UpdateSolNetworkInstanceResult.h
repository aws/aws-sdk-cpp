...
class UpdateSolNetworkInstanceResult {
 public:
  ...
  template <typename NsLcmOpOccIdT = Aws::String>
  UpdateSolNetworkInstanceResult& WithNsLcmOpOccId(NsLcmOpOccIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateSolNetworkInstanceResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSolNetworkInstanceResult& WithRequestId(RequestIdT&& value) {
