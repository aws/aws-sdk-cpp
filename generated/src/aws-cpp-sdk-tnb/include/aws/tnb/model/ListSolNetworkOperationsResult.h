...
class ListSolNetworkOperationsResult {
 public:
  ...
  void SetNetworkOperations(NetworkOperationsT&& value) {
    m_networkOperationsHasBeenSet = true;
    m_networkOperations = std::forward<NetworkOperationsT>(value);
  }
  template <typename NetworkOperationsT = Aws::Vector<ListSolNetworkOperationsInfo>>
  ListSolNetworkOperationsResult& WithNetworkOperations(NetworkOperationsT&& value) {
    SetNetworkOperations(std::forward<NetworkOperationsT>(value));
    return *this;
  }
  template <typename NetworkOperationsT = ListSolNetworkOperationsInfo>
  ListSolNetworkOperationsResult& AddNetworkOperations(NetworkOperationsT&& value) {
    m_networkOperationsHasBeenSet = true;
    m_networkOperations.emplace_back(std::forward<NetworkOperationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSolNetworkOperationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSolNetworkOperationsResult& WithRequestId(RequestIdT&& value) {
