...
class GetSolNetworkPackageMetadata {
 public:
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetSolNetworkPackageMetadata& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastModifiedT = Aws::Utils::DateTime>
  GetSolNetworkPackageMetadata& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename NsdT = NetworkArtifactMeta>
  GetSolNetworkPackageMetadata& WithNsd(NsdT&& value) {
