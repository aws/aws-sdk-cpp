...
class ListSolNetworkPackageInfo {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListSolNetworkPackageInfo& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  ListSolNetworkPackageInfo& WithId(IdT&& value) {
  ...
  template <typename MetadataT = ListSolNetworkPackageMetadata>
  ListSolNetworkPackageInfo& WithMetadata(MetadataT&& value) {
  ...
  void SetNsdDesigner(NsdDesignerT&& value) {
    m_nsdDesignerHasBeenSet = true;
    m_nsdDesigner = std::forward<NsdDesignerT>(value);
  }
  template <typename NsdDesignerT = Aws::String>
  ListSolNetworkPackageInfo& WithNsdDesigner(NsdDesignerT&& value) {
    SetNsdDesigner(std::forward<NsdDesignerT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NsdIdT = Aws::String>
  ListSolNetworkPackageInfo& WithNsdId(NsdIdT&& value) {
  ...
  void SetNsdInvariantId(NsdInvariantIdT&& value) {
    m_nsdInvariantIdHasBeenSet = true;
    m_nsdInvariantId = std::forward<NsdInvariantIdT>(value);
  }
  template <typename NsdInvariantIdT = Aws::String>
  ListSolNetworkPackageInfo& WithNsdInvariantId(NsdInvariantIdT&& value) {
    SetNsdInvariantId(std::forward<NsdInvariantIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NsdNameT = Aws::String>
  ListSolNetworkPackageInfo& WithNsdName(NsdNameT&& value) {
  ...
  inline void SetNsdOnboardingState(NsdOnboardingState value) {
    m_nsdOnboardingStateHasBeenSet = true;
    m_nsdOnboardingState = value;
  }
  inline ListSolNetworkPackageInfo& WithNsdOnboardingState(NsdOnboardingState value) {
    SetNsdOnboardingState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNsdOperationalState(NsdOperationalState value) {
    m_nsdOperationalStateHasBeenSet = true;
    m_nsdOperationalState = value;
  }
  inline ListSolNetworkPackageInfo& WithNsdOperationalState(NsdOperationalState value) {
    SetNsdOperationalState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNsdUsageState(NsdUsageState value) {
    m_nsdUsageStateHasBeenSet = true;
    m_nsdUsageState = value;
  }
  inline ListSolNetworkPackageInfo& WithNsdUsageState(NsdUsageState value) {
    SetNsdUsageState(value);
    return *this;
  }
  ///@}
  ...
  template <typename NsdVersionT = Aws::String>
  ListSolNetworkPackageInfo& WithNsdVersion(NsdVersionT&& value) {
  ...
  template <typename VnfPkgIdsT = Aws::Vector<Aws::String>>
  ListSolNetworkPackageInfo& WithVnfPkgIds(VnfPkgIdsT&& value) {
    SetVnfPkgIds(std::forward<VnfPkgIdsT>(value));
    return *this;
  }
  template <typename VnfPkgIdsT = Aws::String>
  ListSolNetworkPackageInfo& AddVnfPkgIds(VnfPkgIdsT&& value) {
    m_vnfPkgIdsHasBeenSet = true;
