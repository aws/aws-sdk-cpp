...
class InputSummary {
 public:
  ...
  void SetInputArn(InputArnT&& value) {
    ...
    m_inputArn = std::forward<InputArnT>(value);
  }
  template <typename InputArnT = Aws::String>
  InputSummary& WithInputArn(InputArnT&& value) {
    SetInputArn(std::forward<InputArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(InputStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline InputSummary& WithStatus(InputStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
