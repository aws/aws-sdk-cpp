...
class ListInputRoutingsResult {
 public:
  ...
  void SetRoutedResources(RoutedResourcesT&& value) {
    m_routedResourcesHasBeenSet = true;
    m_routedResources = std::forward<RoutedResourcesT>(value);
  }
  template <typename RoutedResourcesT = Aws::Vector<RoutedResource>>
  ListInputRoutingsResult& WithRoutedResources(RoutedResourcesT&& value) {
    SetRoutedResources(std::forward<RoutedResourcesT>(value));
    return *this;
  }
  template <typename RoutedResourcesT = RoutedResource>
  ListInputRoutingsResult& AddRoutedResources(RoutedResourcesT&& value) {
    m_routedResourcesHasBeenSet = true;
    m_routedResources.emplace_back(std::forward<RoutedResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInputRoutingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInputRoutingsResult& WithRequestId(RequestIdT&& value) {
