...
class InputIdentifier {
 public:
  ...
  void SetIotEventsInputIdentifier(IotEventsInputIdentifierT&& value) {
    ...
    m_iotEventsInputIdentifier = std::forward<IotEventsInputIdentifierT>(value);
  }
  template <typename IotEventsInputIdentifierT = IotEventsInputIdentifier>
  InputIdentifier& WithIotEventsInputIdentifier(IotEventsInputIdentifierT&& value) {
    SetIotEventsInputIdentifier(std::forward<IotEventsInputIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIotSiteWiseInputIdentifier(IotSiteWiseInputIdentifierT&& value) {
    ...
    m_iotSiteWiseInputIdentifier = std::forward<IotSiteWiseInputIdentifierT>(value);
  }
  template <typename IotSiteWiseInputIdentifierT = IotSiteWiseInputIdentifier>
  InputIdentifier& WithIotSiteWiseInputIdentifier(IotSiteWiseInputIdentifierT&& value) {
    SetIotSiteWiseInputIdentifier(std::forward<IotSiteWiseInputIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
