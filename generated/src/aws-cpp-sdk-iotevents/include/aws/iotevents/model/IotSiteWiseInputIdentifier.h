...
class IotSiteWiseInputIdentifier {
 public:
   ...
   */
  inline const IotSiteWiseAssetModelPropertyIdentifier& GetIotSiteWiseAssetModelPropertyIdentifier() const {
    return m_iotSiteWiseAssetModelPropertyIdentifier;
  }
  ...
  void SetIotSiteWiseAssetModelPropertyIdentifier(IotSiteWiseAssetModelPropertyIdentifierT&& value) {
    m_iotSiteWiseAssetModelPropertyIdentifierHasBeenSet = true;
    m_iotSiteWiseAssetModelPropertyIdentifier = std::forward<IotSiteWiseAssetModelPropertyIdentifierT>(value);
  }
  template <typename IotSiteWiseAssetModelPropertyIdentifierT = IotSiteWiseAssetModelPropertyIdentifier>
  IotSiteWiseInputIdentifier& WithIotSiteWiseAssetModelPropertyIdentifier(IotSiteWiseAssetModelPropertyIdentifierT&& value) {
    SetIotSiteWiseAssetModelPropertyIdentifier(std::forward<IotSiteWiseAssetModelPropertyIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
