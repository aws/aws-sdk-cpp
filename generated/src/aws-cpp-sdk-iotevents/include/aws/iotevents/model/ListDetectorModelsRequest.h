...
class ListDetectorModelsRequest : public IoTEventsRequest {
 public:
  AWS_IOTEVENTS_API ListDetectorModelsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListDetectorModelsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDetectorModelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
