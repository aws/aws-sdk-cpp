...
class DetectorModelConfiguration {
 public:
  ...
  inline DetectorModelConfiguration& WithStatus(DetectorModelVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DetectorModelConfiguration& WithEvaluationMethod(EvaluationMethod value) {
