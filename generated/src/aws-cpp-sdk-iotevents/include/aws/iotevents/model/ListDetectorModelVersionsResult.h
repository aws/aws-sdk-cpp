...
class ListDetectorModelVersionsResult {
 public:
   ...
   */
  inline const Aws::Vector<DetectorModelVersionSummary>& GetDetectorModelVersionSummaries() const {
    return m_detectorModelVersionSummaries;
  }
  template <typename DetectorModelVersionSummariesT = Aws::Vector<DetectorModelVersionSummary>>
  void SetDetectorModelVersionSummaries(DetectorModelVersionSummariesT&& value) {
    m_detectorModelVersionSummariesHasBeenSet = true;
    m_detectorModelVersionSummaries = std::forward<DetectorModelVersionSummariesT>(value);
  }
  template <typename DetectorModelVersionSummariesT = Aws::Vector<DetectorModelVersionSummary>>
  ListDetectorModelVersionsResult& WithDetectorModelVersionSummaries(DetectorModelVersionSummariesT&& value) {
    SetDetectorModelVersionSummaries(std::forward<DetectorModelVersionSummariesT>(value));
    return *this;
  }
  template <typename DetectorModelVersionSummariesT = DetectorModelVersionSummary>
  ListDetectorModelVersionsResult& AddDetectorModelVersionSummaries(DetectorModelVersionSummariesT&& value) {
    m_detectorModelVersionSummariesHasBeenSet = true;
    m_detectorModelVersionSummaries.emplace_back(std::forward<DetectorModelVersionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDetectorModelVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDetectorModelVersionsResult& WithRequestId(RequestIdT&& value) {
