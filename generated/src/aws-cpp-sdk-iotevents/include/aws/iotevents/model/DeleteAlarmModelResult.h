...
namespace Model
{
  ...
  {
  public:
    AWS_IOTEVENTS_API DeleteAlarmModelResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAlarmModelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
