...
class GetDetectorModelAnalysisResultsRequest : public IoTEventsRequest {
 public:
  AWS_IOTEVENTS_API GetDetectorModelAnalysisResultsRequest() = default;
  ...
  template <typename AnalysisIdT = Aws::String>
  GetDetectorModelAnalysisResultsRequest& WithAnalysisId(AnalysisIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetDetectorModelAnalysisResultsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetDetectorModelAnalysisResultsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
