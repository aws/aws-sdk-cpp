...
class DetectorModelVersionSummary {
 public:
  ...
  void SetDetectorModelArn(DetectorModelArnT&& value) {
    ...
    m_detectorModelArn = std::forward<DetectorModelArnT>(value);
  }
  template <typename DetectorModelArnT = Aws::String>
  DetectorModelVersionSummary& WithDetectorModelArn(DetectorModelArnT&& value) {
    SetDetectorModelArn(std::forward<DetectorModelArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(DetectorModelVersionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DetectorModelVersionSummary& WithStatus(DetectorModelVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DetectorModelVersionSummary& WithEvaluationMethod(EvaluationMethod value) {
