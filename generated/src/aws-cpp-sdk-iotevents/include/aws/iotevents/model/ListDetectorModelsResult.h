...
class ListDetectorModelsResult {
 public:
  ...
  void SetDetectorModelSummaries(DetectorModelSummariesT&& value) {
    m_detectorModelSummariesHasBeenSet = true;
    m_detectorModelSummaries = std::forward<DetectorModelSummariesT>(value);
  }
  template <typename DetectorModelSummariesT = Aws::Vector<DetectorModelSummary>>
  ListDetectorModelsResult& WithDetectorModelSummaries(DetectorModelSummariesT&& value) {
    SetDetectorModelSummaries(std::forward<DetectorModelSummariesT>(value));
    return *this;
  }
  template <typename DetectorModelSummariesT = DetectorModelSummary>
  ListDetectorModelsResult& AddDetectorModelSummaries(DetectorModelSummariesT&& value) {
    m_detectorModelSummariesHasBeenSet = true;
    m_detectorModelSummaries.emplace_back(std::forward<DetectorModelSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDetectorModelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDetectorModelsResult& WithRequestId(RequestIdT&& value) {
