...
class AlarmNotification {
 public:
  ...
  void SetNotificationActions(NotificationActionsT&& value) {
    ...
    m_notificationActions = std::forward<NotificationActionsT>(value);
  }
  template <typename NotificationActionsT = Aws::Vector<NotificationAction>>
  AlarmNotification& WithNotificationActions(NotificationActionsT&& value) {
    SetNotificationActions(std::forward<NotificationActionsT>(value));
    return *this;
  }
  ...
  AlarmNotification& AddNotificationActions(NotificationActionsT&& value) {
    m_notificationActionsHasBeenSet = true;
    m_notificationActions.emplace_back(std::forward<NotificationActionsT>(value));
    return *this;
  }
  ///@}
 private:
