...
class Payload {
 public:
  ...
  void SetContentExpression(ContentExpressionT&& value) {
    m_contentExpressionHasBeenSet = true;
    m_contentExpression = std::forward<ContentExpressionT>(value);
  }
  template <typename ContentExpressionT = Aws::String>
  Payload& WithContentExpression(ContentExpressionT&& value) {
    SetContentExpression(std::forward<ContentExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(PayloadType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Payload& WithType(PayloadType value) {
    SetType(value);
    return *this;
  }
  ///@}
