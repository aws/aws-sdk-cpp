...
class Action {
 public:
  ...
  void SetSetVariable(SetVariableT&& value) {
    ...
    m_setVariable = std::forward<SetVariableT>(value);
  }
  template <typename SetVariableT = SetVariableAction>
  Action& WithSetVariable(SetVariableT&& value) {
    SetSetVariable(std::forward<SetVariableT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIotTopicPublish(IotTopicPublishT&& value) {
    ...
    m_iotTopicPublish = std::forward<IotTopicPublishT>(value);
  }
  template <typename IotTopicPublishT = IotTopicPublishAction>
  Action& WithIotTopicPublish(IotTopicPublishT&& value) {
    SetIotTopicPublish(std::forward<IotTopicPublishT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSetTimer(SetTimerT&& value) {
    ...
    m_setTimer = std::forward<SetTimerT>(value);
  }
  template <typename SetTimerT = SetTimerAction>
  Action& WithSetTimer(SetTimerT&& value) {
    SetSetTimer(std::forward<SetTimerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClearTimer(ClearTimerT&& value) {
    ...
    m_clearTimer = std::forward<ClearTimerT>(value);
  }
  template <typename ClearTimerT = ClearTimerAction>
  Action& WithClearTimer(ClearTimerT&& value) {
    SetClearTimer(std::forward<ClearTimerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResetTimer(ResetTimerT&& value) {
    ...
    m_resetTimer = std::forward<ResetTimerT>(value);
  }
  template <typename ResetTimerT = ResetTimerAction>
  Action& WithResetTimer(ResetTimerT&& value) {
    SetResetTimer(std::forward<ResetTimerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIotEvents(IotEventsT&& value) {
    ...
    m_iotEvents = std::forward<IotEventsT>(value);
  }
  template <typename IotEventsT = IotEventsAction>
  Action& WithIotEvents(IotEventsT&& value) {
    SetIotEvents(std::forward<IotEventsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSqs(SqsT&& value) {
    ...
    m_sqs = std::forward<SqsT>(value);
  }
  template <typename SqsT = SqsAction>
  Action& WithSqs(SqsT&& value) {
    SetSqs(std::forward<SqsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamoDB(DynamoDBT&& value) {
    ...
    m_dynamoDB = std::forward<DynamoDBT>(value);
  }
  template <typename DynamoDBT = DynamoDBAction>
  Action& WithDynamoDB(DynamoDBT&& value) {
    SetDynamoDB(std::forward<DynamoDBT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamoDBv2(DynamoDBv2T&& value) {
    ...
    m_dynamoDBv2 = std::forward<DynamoDBv2T>(value);
  }
  template <typename DynamoDBv2T = DynamoDBv2Action>
  Action& WithDynamoDBv2(DynamoDBv2T&& value) {
    SetDynamoDBv2(std::forward<DynamoDBv2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetIotSiteWise(IotSiteWiseT&& value) {
    ...
    m_iotSiteWise = std::forward<IotSiteWiseT>(value);
  }
  template <typename IotSiteWiseT = IotSiteWiseAction>
  Action& WithIotSiteWise(IotSiteWiseT&& value) {
    SetIotSiteWise(std::forward<IotSiteWiseT>(value));
    return *this;
  }
  ///@}
 private:
