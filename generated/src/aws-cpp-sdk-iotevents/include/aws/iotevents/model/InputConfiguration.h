...
namespace Model
{
  ...
  public:
    ...
    template<typename InputNameT = Aws::String>
    InputConfiguration& WithInputName(InputNameT&& value) { SetInputName(std::forward<InputNameT>(value)); return *this;}
    ///@}
    ...
    template<typename InputDescriptionT = Aws::String>
    InputConfiguration& WithInputDescription(InputDescriptionT&& value) { SetInputDescription(std::forward<InputDescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename InputArnT = Aws::String>
    InputConfiguration& WithInputArn(InputArnT&& value) { SetInputArn(std::forward<InputArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimeT = Aws::Utils::DateTime>
    InputConfiguration& WithCreationTime(CreationTimeT&& value) { SetCreationTime(std::forward<CreationTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdateTimeT = Aws::Utils::DateTime>
    InputConfiguration& WithLastUpdateTime(LastUpdateTimeT&& value) { SetLastUpdateTime(std::forward<LastUpdateTimeT>(value)); return *this;}
    ///@}
    ...
    inline InputConfiguration& WithStatus(InputStatus value) { SetStatus(value); return *this;}
    ///@}
  private:
