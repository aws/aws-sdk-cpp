...
class State {
 public:
  ...
  void SetOnInput(OnInputT&& value) {
    ...
    m_onInput = std::forward<OnInputT>(value);
  }
  template <typename OnInputT = OnInputLifecycle>
  State& WithOnInput(OnInputT&& value) {
    SetOnInput(std::forward<OnInputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnEnter(OnEnterT&& value) {
    ...
    m_onEnter = std::forward<OnEnterT>(value);
  }
  template <typename OnEnterT = OnEnterLifecycle>
  State& WithOnEnter(OnEnterT&& value) {
    SetOnEnter(std::forward<OnEnterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnExit(OnExitT&& value) {
    ...
    m_onExit = std::forward<OnExitT>(value);
  }
  template <typename OnExitT = OnExitLifecycle>
  State& WithOnExit(OnExitT&& value) {
    SetOnExit(std::forward<OnExitT>(value));
    return *this;
  }
  ///@}
 private:
