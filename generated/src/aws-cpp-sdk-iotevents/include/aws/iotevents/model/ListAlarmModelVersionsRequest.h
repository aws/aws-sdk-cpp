...
class ListAlarmModelVersionsRequest : public IoTEventsRequest {
 public:
  ...
  template <typename AlarmModelNameT = Aws::String>
  ListAlarmModelVersionsRequest& WithAlarmModelName(AlarmModelNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAlarmModelVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAlarmModelVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
