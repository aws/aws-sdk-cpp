...
class DetectorModelDefinition {
 public:
  ...
  template <typename StatesT = Aws::Vector<State>>
  DetectorModelDefinition& WithStates(StatesT&& value) {
    SetStates(std::forward<StatesT>(value));
    return *this;
  }
  template <typename StatesT = State>
  DetectorModelDefinition& AddStates(StatesT&& value) {
    m_statesHasBeenSet = true;
    m_states.emplace_back(std::forward<StatesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInitialStateName(InitialStateNameT&& value) {
    m_initialStateNameHasBeenSet = true;
    m_initialStateName = std::forward<InitialStateNameT>(value);
  }
  template <typename InitialStateNameT = Aws::String>
  DetectorModelDefinition& WithInitialStateName(InitialStateNameT&& value) {
    SetInitialStateName(std::forward<InitialStateNameT>(value));
    return *this;
  }
  ///@}
 private:
