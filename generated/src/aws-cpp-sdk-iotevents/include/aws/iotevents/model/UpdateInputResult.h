...
namespace Model
{
  ...
  {
  public:
    AWS_IOTEVENTS_API UpdateInputResult() = default;
    ...
    template<typename InputConfigurationT = InputConfiguration>
    UpdateInputResult& WithInputConfiguration(InputConfigurationT&& value) { SetInputConfiguration(std::forward<InputConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateInputResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
