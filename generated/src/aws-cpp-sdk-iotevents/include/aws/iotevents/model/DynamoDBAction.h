...
class DynamoDBAction {
 public:
  ...
  void SetHashKeyType(HashKeyTypeT&& value) {
    ...
    m_hashKeyType = std::forward<HashKeyTypeT>(value);
  }
  template <typename HashKeyTypeT = Aws::String>
  DynamoDBAction& WithHashKeyType(HashKeyTypeT&& value) {
    SetHashKeyType(std::forward<HashKeyTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHashKeyField(HashKeyFieldT&& value) {
    ...
    m_hashKeyField = std::forward<HashKeyFieldT>(value);
  }
  template <typename HashKeyFieldT = Aws::String>
  DynamoDBAction& WithHashKeyField(HashKeyFieldT&& value) {
    SetHashKeyField(std::forward<HashKeyFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHashKeyValue(HashKeyValueT&& value) {
    ...
    m_hashKeyValue = std::forward<HashKeyValueT>(value);
  }
  template <typename HashKeyValueT = Aws::String>
  DynamoDBAction& WithHashKeyValue(HashKeyValueT&& value) {
    SetHashKeyValue(std::forward<HashKeyValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRangeKeyType(RangeKeyTypeT&& value) {
    ...
    m_rangeKeyType = std::forward<RangeKeyTypeT>(value);
  }
  template <typename RangeKeyTypeT = Aws::String>
  DynamoDBAction& WithRangeKeyType(RangeKeyTypeT&& value) {
    SetRangeKeyType(std::forward<RangeKeyTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRangeKeyField(RangeKeyFieldT&& value) {
    ...
    m_rangeKeyField = std::forward<RangeKeyFieldT>(value);
  }
  template <typename RangeKeyFieldT = Aws::String>
  DynamoDBAction& WithRangeKeyField(RangeKeyFieldT&& value) {
    SetRangeKeyField(std::forward<RangeKeyFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRangeKeyValue(RangeKeyValueT&& value) {
    ...
    m_rangeKeyValue = std::forward<RangeKeyValueT>(value);
  }
  template <typename RangeKeyValueT = Aws::String>
  DynamoDBAction& WithRangeKeyValue(RangeKeyValueT&& value) {
    SetRangeKeyValue(std::forward<RangeKeyValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPayloadField(PayloadFieldT&& value) {
    ...
    m_payloadField = std::forward<PayloadFieldT>(value);
  }
  template <typename PayloadFieldT = Aws::String>
  DynamoDBAction& WithPayloadField(PayloadFieldT&& value) {
    SetPayloadField(std::forward<PayloadFieldT>(value));
    return *this;
  }
  ///@}
