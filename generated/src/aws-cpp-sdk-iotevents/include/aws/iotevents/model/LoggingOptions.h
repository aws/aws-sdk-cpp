...
class LoggingOptions {
 public:
  ...
  void SetDetectorDebugOptions(DetectorDebugOptionsT&& value) {
    ...
    m_detectorDebugOptions = std::forward<DetectorDebugOptionsT>(value);
  }
  template <typename DetectorDebugOptionsT = Aws::Vector<DetectorDebugOption>>
  LoggingOptions& WithDetectorDebugOptions(DetectorDebugOptionsT&& value) {
    SetDetectorDebugOptions(std::forward<DetectorDebugOptionsT>(value));
    return *this;
  }
  ...
  LoggingOptions& AddDetectorDebugOptions(DetectorDebugOptionsT&& value) {
    m_detectorDebugOptionsHasBeenSet = true;
    m_detectorDebugOptions.emplace_back(std::forward<DetectorDebugOptionsT>(value));
    return *this;
  }
  ///@}
 private:
