...
class UpdateDetectorModelRequest : public IoTEventsRequest {
 public:
  ...
  template <typename DetectorModelNameT = Aws::String>
  UpdateDetectorModelRequest& WithDetectorModelName(DetectorModelNameT&& value) {
  ...
  void SetDetectorModelDefinition(DetectorModelDefinitionT&& value) {
    ...
    m_detectorModelDefinition = std::forward<DetectorModelDefinitionT>(value);
  }
  template <typename DetectorModelDefinitionT = DetectorModelDefinition>
  UpdateDetectorModelRequest& WithDetectorModelDefinition(DetectorModelDefinitionT&& value) {
    SetDetectorModelDefinition(std::forward<DetectorModelDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DetectorModelDescriptionT = Aws::String>
  UpdateDetectorModelRequest& WithDetectorModelDescription(DetectorModelDescriptionT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  UpdateDetectorModelRequest& WithRoleArn(RoleArnT&& value) {
  ...
  inline void SetEvaluationMethod(EvaluationMethod value) {
    m_evaluationMethodHasBeenSet = true;
    m_evaluationMethod = value;
  }
  inline UpdateDetectorModelRequest& WithEvaluationMethod(EvaluationMethod value) {
