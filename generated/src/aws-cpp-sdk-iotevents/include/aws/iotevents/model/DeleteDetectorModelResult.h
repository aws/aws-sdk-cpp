...
namespace Model
{
  ...
  {
  public:
    AWS_IOTEVENTS_API DeleteDetectorModelResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDetectorModelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
