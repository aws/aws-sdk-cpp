...
class GetDetectorModelAnalysisResultsResult {
 public:
  ...
  AWS_IOTEVENTS_API GetDetectorModelAnalysisResultsResult& operator=(
  ...
  void SetAnalysisResults(AnalysisResultsT&& value) {
    ...
    m_analysisResults = std::forward<AnalysisResultsT>(value);
  }
  template <typename AnalysisResultsT = Aws::Vector<AnalysisResult>>
  GetDetectorModelAnalysisResultsResult& WithAnalysisResults(AnalysisResultsT&& value) {
    SetAnalysisResults(std::forward<AnalysisResultsT>(value));
    return *this;
  }
  template <typename AnalysisResultsT = AnalysisResult>
  GetDetectorModelAnalysisResultsResult& AddAnalysisResults(AnalysisResultsT&& value) {
    m_analysisResultsHasBeenSet = true;
    m_analysisResults.emplace_back(std::forward<AnalysisResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetDetectorModelAnalysisResultsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDetectorModelAnalysisResultsResult& WithRequestId(RequestIdT&& value) {
