...
class AWS_IOTEVENTS_API IoTEventsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IoTEventsClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<IoTEventsEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreateAlarmModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAlarmModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAlarmModelRequestT = Model::CreateAlarmModelRequest>
  void CreateAlarmModelAsync(const CreateAlarmModelRequestT& request, const CreateAlarmModelResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateDetectorModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDetectorModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDetectorModelRequestT = Model::CreateDetectorModelRequest>
  void CreateDetectorModelAsync(const CreateDetectorModelRequestT& request, const CreateDetectorModelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename CreateInputRequestT = Model::CreateInputRequest>
  void CreateInputAsync(const CreateInputRequestT& request, const CreateInputResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAlarmModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAlarmModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAlarmModelRequestT = Model::DeleteAlarmModelRequest>
  void DeleteAlarmModelAsync(const DeleteAlarmModelRequestT& request, const DeleteAlarmModelResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDetectorModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDetectorModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDetectorModelRequestT = Model::DeleteDetectorModelRequest>
  void DeleteDetectorModelAsync(const DeleteDetectorModelRequestT& request, const DeleteDetectorModelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAlarmModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAlarmModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAlarmModelRequestT = Model::DescribeAlarmModelRequest>
  void DescribeAlarmModelAsync(const DescribeAlarmModelRequestT& request, const DescribeAlarmModelResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDetectorModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDetectorModel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDetectorModelRequestT = Model::DescribeDetectorModelRequest>
  void DescribeDetectorModelAsync(const DescribeDetectorModelRequestT& request, const DescribeDetectorModelResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDetectorModelAnalysisOutcome DescribeDetectorModelAnalysis(
      const Model::DescribeDetectorModelAnalysisRequest& request) const;

  /**
   * A Callable wrapper for DescribeDetectorModelAnalysis that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDetectorModelAnalysisRequestT = Model::DescribeDetectorModelAnalysisRequest>
  Model::DescribeDetectorModelAnalysisOutcomeCallable DescribeDetectorModelAnalysisCallable(
      const DescribeDetectorModelAnalysisRequestT& request) const {
    return SubmitCallable(&IoTEventsClient::DescribeDetectorModelAnalysis, request);
  }

  /**
   * An Async wrapper for DescribeDetectorModelAnalysis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDetectorModelAnalysisRequestT = Model::DescribeDetectorModelAnalysisRequest>
  void DescribeDetectorModelAnalysisAsync(const DescribeDetectorModelAnalysisRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDetectorModelAnalysisResultsOutcome GetDetectorModelAnalysisResults(
      const Model::GetDetectorModelAnalysisResultsRequest& request) const;

  /**
   * A Callable wrapper for GetDetectorModelAnalysisResults that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDetectorModelAnalysisResultsRequestT = Model::GetDetectorModelAnalysisResultsRequest>
  Model::GetDetectorModelAnalysisResultsOutcomeCallable GetDetectorModelAnalysisResultsCallable(
      const GetDetectorModelAnalysisResultsRequestT& request) const {
    return SubmitCallable(&IoTEventsClient::GetDetectorModelAnalysisResults, request);
  }

  /**
   * An Async wrapper for GetDetectorModelAnalysisResults that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetDetectorModelAnalysisResultsRequestT = Model::GetDetectorModelAnalysisResultsRequest>
  void GetDetectorModelAnalysisResultsAsync(const GetDetectorModelAnalysisResultsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListAlarmModelVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAlarmModelVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAlarmModelVersionsRequestT = Model::ListAlarmModelVersionsRequest>
  void ListAlarmModelVersionsAsync(const ListAlarmModelVersionsRequestT& request,
  ...
  /**
   * An Async wrapper for ListAlarmModels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAlarmModelsRequestT = Model::ListAlarmModelsRequest>
  void ListAlarmModelsAsync(const ListAlarmModelsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListAlarmModelsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDetectorModelVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListDetectorModelVersionsRequestT = Model::ListDetectorModelVersionsRequest>
  Model::ListDetectorModelVersionsOutcomeCallable ListDetectorModelVersionsCallable(
      const ListDetectorModelVersionsRequestT& request) const {
    return SubmitCallable(&IoTEventsClient::ListDetectorModelVersions, request);
  }

  /**
   * An Async wrapper for ListDetectorModelVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDetectorModelVersionsRequestT = Model::ListDetectorModelVersionsRequest>
  void ListDetectorModelVersionsAsync(const ListDetectorModelVersionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListDetectorModels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDetectorModels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDetectorModelsRequestT = Model::ListDetectorModelsRequest>
  void ListDetectorModelsAsync(const ListDetectorModelsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListDetectorModelsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListInputRoutings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInputRoutings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListInputRoutingsRequestT = Model::ListInputRoutingsRequest>
  void ListInputRoutingsAsync(const ListInputRoutingsRequestT& request, const ListInputRoutingsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartDetectorModelAnalysisOutcome StartDetectorModelAnalysis(
      const Model::StartDetectorModelAnalysisRequest& request) const;

  /**
   * A Callable wrapper for StartDetectorModelAnalysis that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartDetectorModelAnalysisRequestT = Model::StartDetectorModelAnalysisRequest>
  Model::StartDetectorModelAnalysisOutcomeCallable StartDetectorModelAnalysisCallable(
      const StartDetectorModelAnalysisRequestT& request) const {
    return SubmitCallable(&IoTEventsClient::StartDetectorModelAnalysis, request);
  }

  /**
   * An Async wrapper for StartDetectorModelAnalysis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartDetectorModelAnalysisRequestT = Model::StartDetectorModelAnalysisRequest>
  void StartDetectorModelAnalysisAsync(const StartDetectorModelAnalysisRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateAlarmModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAlarmModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAlarmModelRequestT = Model::UpdateAlarmModelRequest>
  void UpdateAlarmModelAsync(const UpdateAlarmModelRequestT& request, const UpdateAlarmModelResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDetectorModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDetectorModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDetectorModelRequestT = Model::UpdateDetectorModelRequest>
  void UpdateDetectorModelAsync(const UpdateDetectorModelRequestT& request, const UpdateDetectorModelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
