...
namespace IoTEvents
{
   ...
   */
  class AWS_IOTEVENTS_API IoTEventsClient : smithy::client::AwsSmithyClientT<Aws::IoTEvents::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<IoTEventsClient>
  {
    public:
