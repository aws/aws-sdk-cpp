...
/**
 * <fullname>Amazon EC2 Auto Scaling</fullname> <p>The <a
 ...
 * group that contains many instances. By default, this operation returns details
 * for all instances in the group. To help prevent throttling, you can set the
 * <code>IncludeInstances</code> parameter to <code>false</code> to exclude
 * instance details from the response.</p> <p>Amazon EC2 Auto Scaling is designed
 * to automatically launch and terminate EC2 instances based on user-defined
 * scaling policies, scheduled actions, and health checks.</p> <p>For more
...
class AWS_AUTOSCALING_API AutoScalingClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  AutoScalingClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<AutoScalingEndpointProviderBase> endpointProvider = nullptr,
      const Aws::AutoScaling::AutoScalingClientConfiguration& clientConfiguration = Aws::AutoScaling::AutoScalingClientConfiguration());
  ...
  /**
   * An Async wrapper for AttachInstances that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AttachInstancesRequestT = Model::AttachInstancesRequest>
  void AttachInstancesAsync(const AttachInstancesRequestT& request, const AttachInstancesResponseReceivedHandler& handler,
   ...
   * API.</p> <p>This operation is additive and does not detach existing target
   * groups or Classic Load Balancers from the Auto Scaling group.</p> <p>For more
   * information, see <a
  ...
  virtual Model::AttachLoadBalancerTargetGroupsOutcome AttachLoadBalancerTargetGroups(
      const Model::AttachLoadBalancerTargetGroupsRequest& request) const;

  /**
   * A Callable wrapper for AttachLoadBalancerTargetGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AttachLoadBalancerTargetGroupsRequestT = Model::AttachLoadBalancerTargetGroupsRequest>
  Model::AttachLoadBalancerTargetGroupsOutcomeCallable AttachLoadBalancerTargetGroupsCallable(
      const AttachLoadBalancerTargetGroupsRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::AttachLoadBalancerTargetGroups, request);
  }

  /**
   * An Async wrapper for AttachLoadBalancerTargetGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AttachLoadBalancerTargetGroupsRequestT = Model::AttachLoadBalancerTargetGroupsRequest>
  void AttachLoadBalancerTargetGroupsAsync(const AttachLoadBalancerTargetGroupsRequestT& request,
  ...
  /**
   * A Callable wrapper for AttachLoadBalancers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AttachLoadBalancers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AttachLoadBalancersRequestT = Model::AttachLoadBalancersRequest>
  void AttachLoadBalancersAsync(const AttachLoadBalancersRequestT& request, const AttachLoadBalancersResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * group. </p> <p>After the operation completes, use the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeTrafficSources.html">DescribeTrafficSources</a>
   * API to return details about the state of the attachments between traffic sources
   * and your Auto Scaling group. To detach a traffic source from the Auto Scaling
   * group, call the <a
  ...
  /**
   * A Callable wrapper for AttachTrafficSources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AttachTrafficSources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AttachTrafficSourcesRequestT = Model::AttachTrafficSourcesRequest>
  void AttachTrafficSourcesAsync(const AttachTrafficSourcesRequestT& request, const AttachTrafficSourcesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDeleteScheduledActionOutcome BatchDeleteScheduledAction(
      const Model::BatchDeleteScheduledActionRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteScheduledAction that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDeleteScheduledActionRequestT = Model::BatchDeleteScheduledActionRequest>
  Model::BatchDeleteScheduledActionOutcomeCallable BatchDeleteScheduledActionCallable(
      const BatchDeleteScheduledActionRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::BatchDeleteScheduledAction, request);
  }

  /**
   * An Async wrapper for BatchDeleteScheduledAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeleteScheduledActionRequestT = Model::BatchDeleteScheduledActionRequest>
  void BatchDeleteScheduledActionAsync(const BatchDeleteScheduledActionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchPutScheduledUpdateGroupActionOutcome BatchPutScheduledUpdateGroupAction(
      const Model::BatchPutScheduledUpdateGroupActionRequest& request) const;

  /**
   * A Callable wrapper for BatchPutScheduledUpdateGroupAction that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename BatchPutScheduledUpdateGroupActionRequestT = Model::BatchPutScheduledUpdateGroupActionRequest>
  Model::BatchPutScheduledUpdateGroupActionOutcomeCallable BatchPutScheduledUpdateGroupActionCallable(
      const BatchPutScheduledUpdateGroupActionRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::BatchPutScheduledUpdateGroupAction, request);
  }

  /**
   * An Async wrapper for BatchPutScheduledUpdateGroupAction that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchPutScheduledUpdateGroupActionRequestT = Model::BatchPutScheduledUpdateGroupActionRequest>
  void BatchPutScheduledUpdateGroupActionAsync(const BatchPutScheduledUpdateGroupActionRequestT& request,
   ...
   * API to roll back instead.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for CancelInstanceRefresh that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelInstanceRefresh that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelInstanceRefreshRequestT = Model::CancelInstanceRefreshRequest>
  void CancelInstanceRefreshAsync(const CancelInstanceRefreshRequestT& request, const CancelInstanceRefreshResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CompleteLifecycleAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CompleteLifecycleAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CompleteLifecycleActionRequestT = Model::CompleteLifecycleActionRequest>
  void CompleteLifecycleActionAsync(const CompleteLifecycleActionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateAutoScalingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAutoScalingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAutoScalingGroupRequestT = Model::CreateAutoScalingGroupRequest>
  void CreateAutoScalingGroupAsync(const CreateAutoScalingGroupRequestT& request,
   ...
   * launch configurations, the call fails. To query this limit, call the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeAccountLimits.html">DescribeAccountLimits</a>
   * API. For information about updating this limit, see <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-quotas.html">Quotas
   * for Amazon EC2 Auto Scaling</a> in the <i>Amazon EC2 Auto Scaling User
  ...
  /**
   * A Callable wrapper for CreateLaunchConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateLaunchConfigurationRequestT = Model::CreateLaunchConfigurationRequest>
  Model::CreateLaunchConfigurationOutcomeCallable CreateLaunchConfigurationCallable(
      const CreateLaunchConfigurationRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::CreateLaunchConfiguration, request);
  }

  /**
   * An Async wrapper for CreateLaunchConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateLaunchConfigurationRequestT = Model::CreateLaunchConfigurationRequest>
  void CreateLaunchConfigurationAsync(const CreateLaunchConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateOrUpdateTags that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateOrUpdateTags that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateOrUpdateTagsRequestT = Model::CreateOrUpdateTagsRequest>
  void CreateOrUpdateTagsAsync(const CreateOrUpdateTagsRequestT& request, const CreateOrUpdateTagsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Scaling group before deleting it, call the <a
   ...
   * This ensures that Amazon EC2 Auto Scaling does not launch replacement
   * instances.</p> <p>To terminate all instances before deleting the Auto Scaling
   * group, call the <a
   ...
   * zero.</p> <p>If the group has scaling policies, deleting the group deletes the
   * policies, the underlying alarm actions, and any alarm that no longer has an
  ...
  /**
   * A Callable wrapper for DeleteAutoScalingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAutoScalingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAutoScalingGroupRequestT = Model::DeleteAutoScalingGroupRequest>
  void DeleteAutoScalingGroupAsync(const DeleteAutoScalingGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteLaunchConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteLaunchConfigurationRequestT = Model::DeleteLaunchConfigurationRequest>
  Model::DeleteLaunchConfigurationOutcomeCallable DeleteLaunchConfigurationCallable(
      const DeleteLaunchConfigurationRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::DeleteLaunchConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteLaunchConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteLaunchConfigurationRequestT = Model::DeleteLaunchConfigurationRequest>
  void DeleteLaunchConfigurationAsync(const DeleteLaunchConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteLifecycleHook that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLifecycleHook that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteLifecycleHookRequestT = Model::DeleteLifecycleHookRequest>
  void DeleteLifecycleHookAsync(const DeleteLifecycleHookRequestT& request, const DeleteLifecycleHookResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteScheduledAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteScheduledAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteScheduledActionRequestT = Model::DeleteScheduledActionRequest>
  void DeleteScheduledActionAsync(const DeleteScheduledActionRequestT& request, const DeleteScheduledActionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteWarmPool that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteWarmPoolRequestT = Model::DeleteWarmPoolRequest>
  void DeleteWarmPoolAsync(const DeleteWarmPoolRequestT& request, const DeleteWarmPoolResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAdjustmentTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAdjustmentTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAdjustmentTypesRequestT = Model::DescribeAdjustmentTypesRequest>
  void DescribeAdjustmentTypesAsync(const DescribeAdjustmentTypesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DescribeAdjustmentTypesRequestT& request = {}) const {
   ...
   * about the instances in a warm pool, you must call the <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAutoScalingGroupsOutcome DescribeAutoScalingGroups(
      const Model::DescribeAutoScalingGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAutoScalingGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeAutoScalingGroupsRequestT = Model::DescribeAutoScalingGroupsRequest>
  Model::DescribeAutoScalingGroupsOutcomeCallable DescribeAutoScalingGroupsCallable(
      const DescribeAutoScalingGroupsRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeAutoScalingGroups, request);
  }

  /**
   * An Async wrapper for DescribeAutoScalingGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAutoScalingGroupsRequestT = Model::DescribeAutoScalingGroupsRequest>
  void DescribeAutoScalingGroupsAsync(const DescribeAutoScalingGroupsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeAutoScalingGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAutoScalingInstancesOutcome DescribeAutoScalingInstances(
      const Model::DescribeAutoScalingInstancesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAutoScalingInstances that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAutoScalingInstancesRequestT = Model::DescribeAutoScalingInstancesRequest>
  Model::DescribeAutoScalingInstancesOutcomeCallable DescribeAutoScalingInstancesCallable(
      const DescribeAutoScalingInstancesRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeAutoScalingInstances, request);
  }

  /**
   * An Async wrapper for DescribeAutoScalingInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAutoScalingInstancesRequestT = Model::DescribeAutoScalingInstancesRequest>
  void DescribeAutoScalingInstancesAsync(const DescribeAutoScalingInstancesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeAutoScalingInstancesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAutoScalingNotificationTypesOutcome DescribeAutoScalingNotificationTypes(
      const Model::DescribeAutoScalingNotificationTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAutoScalingNotificationTypes that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeAutoScalingNotificationTypesRequestT = Model::DescribeAutoScalingNotificationTypesRequest>
  Model::DescribeAutoScalingNotificationTypesOutcomeCallable DescribeAutoScalingNotificationTypesCallable(
      const DescribeAutoScalingNotificationTypesRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeAutoScalingNotificationTypes, request);
  }

  /**
   * An Async wrapper for DescribeAutoScalingNotificationTypes that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeAutoScalingNotificationTypesRequestT = Model::DescribeAutoScalingNotificationTypesRequest>
  void DescribeAutoScalingNotificationTypesAsync(const DescribeAutoScalingNotificationTypesResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const DescribeAutoScalingNotificationTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeInstanceRefreshes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeInstanceRefreshesRequestT = Model::DescribeInstanceRefreshesRequest>
  Model::DescribeInstanceRefreshesOutcomeCallable DescribeInstanceRefreshesCallable(
      const DescribeInstanceRefreshesRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::DescribeInstanceRefreshes, request);
  }

  /**
   * An Async wrapper for DescribeInstanceRefreshes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstanceRefreshesRequestT = Model::DescribeInstanceRefreshesRequest>
  void DescribeInstanceRefreshesAsync(const DescribeInstanceRefreshesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeLaunchConfigurationsOutcome DescribeLaunchConfigurations(
      const Model::DescribeLaunchConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeLaunchConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeLaunchConfigurationsRequestT = Model::DescribeLaunchConfigurationsRequest>
  Model::DescribeLaunchConfigurationsOutcomeCallable DescribeLaunchConfigurationsCallable(
      const DescribeLaunchConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeLaunchConfigurations, request);
  }

  /**
   * An Async wrapper for DescribeLaunchConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeLaunchConfigurationsRequestT = Model::DescribeLaunchConfigurationsRequest>
  void DescribeLaunchConfigurationsAsync(const DescribeLaunchConfigurationsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeLaunchConfigurationsRequestT& request = {}) const {
  ...
  virtual Model::DescribeLifecycleHookTypesOutcome DescribeLifecycleHookTypes(
      const Model::DescribeLifecycleHookTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeLifecycleHookTypes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeLifecycleHookTypesRequestT = Model::DescribeLifecycleHookTypesRequest>
  Model::DescribeLifecycleHookTypesOutcomeCallable DescribeLifecycleHookTypesCallable(
      const DescribeLifecycleHookTypesRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeLifecycleHookTypes, request);
  }

  /**
   * An Async wrapper for DescribeLifecycleHookTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeLifecycleHookTypesRequestT = Model::DescribeLifecycleHookTypesRequest>
  void DescribeLifecycleHookTypesAsync(const DescribeLifecycleHookTypesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeLifecycleHookTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeLifecycleHooks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeLifecycleHooks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeLifecycleHooksRequestT = Model::DescribeLifecycleHooksRequest>
  void DescribeLifecycleHooksAsync(const DescribeLifecycleHooksRequestT& request,
   ...
   * <code>InService</code> state if you attach them in the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_CreateAutoScalingGroup.html">CreateAutoScalingGroup</a>
   * API call. If your target group state is <code>InService</code>, but it is not
   * working properly, check the scaling activities by calling <a
   ...
   * and take any corrective actions necessary.</p> <p>For help with failed health
   * checks, see <a
   ...
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_AttachTrafficSources.html">AttachTrafficSources</a>.</p>
   * <p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/DescribeLoadBalancerTargetGroups">AWS
   * API Reference</a></p>
   */
  virtual Model::DescribeLoadBalancerTargetGroupsOutcome DescribeLoadBalancerTargetGroups(
      const Model::DescribeLoadBalancerTargetGroupsRequest& request) const;

  /**
   * A Callable wrapper for DescribeLoadBalancerTargetGroups that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeLoadBalancerTargetGroupsRequestT = Model::DescribeLoadBalancerTargetGroupsRequest>
  Model::DescribeLoadBalancerTargetGroupsOutcomeCallable DescribeLoadBalancerTargetGroupsCallable(
      const DescribeLoadBalancerTargetGroupsRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::DescribeLoadBalancerTargetGroups, request);
  }

  /**
   * An Async wrapper for DescribeLoadBalancerTargetGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeLoadBalancerTargetGroupsRequestT = Model::DescribeLoadBalancerTargetGroupsRequest>
  void DescribeLoadBalancerTargetGroupsAsync(const DescribeLoadBalancerTargetGroupsRequestT& request,
   ...
   * use the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeLoadBalancerTargetGroups.html">DescribeLoadBalancerTargetGroups</a>
   * API instead.</p> <p>To determine the attachment status of the load balancer, use
   * the <code>State</code> element in the response. When you attach a load balancer
   ...
   * balancers also have an <code>InService</code> state if you attach them in the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_CreateAutoScalingGroup.html">CreateAutoScalingGroup</a>
   * API call. If your load balancer state is <code>InService</code>, but it is not
   * working properly, check the scaling activities by calling <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeScalingActivities.html">DescribeScalingActivities</a>
   * and take any corrective actions necessary.</p> <p>For help with failed health
   * checks, see <a
  ...
  /**
   * A Callable wrapper for DescribeLoadBalancers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeLoadBalancers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeLoadBalancersRequestT = Model::DescribeLoadBalancersRequest>
  void DescribeLoadBalancersAsync(const DescribeLoadBalancersRequestT& request, const DescribeLoadBalancersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMetricCollectionTypesOutcome DescribeMetricCollectionTypes(
      const Model::DescribeMetricCollectionTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeMetricCollectionTypes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeMetricCollectionTypesRequestT = Model::DescribeMetricCollectionTypesRequest>
  Model::DescribeMetricCollectionTypesOutcomeCallable DescribeMetricCollectionTypesCallable(
      const DescribeMetricCollectionTypesRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeMetricCollectionTypes, request);
  }

  /**
   * An Async wrapper for DescribeMetricCollectionTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMetricCollectionTypesRequestT = Model::DescribeMetricCollectionTypesRequest>
  void DescribeMetricCollectionTypesAsync(const DescribeMetricCollectionTypesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeMetricCollectionTypesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeNotificationConfigurationsOutcome DescribeNotificationConfigurations(
      const Model::DescribeNotificationConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeNotificationConfigurations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeNotificationConfigurationsRequestT = Model::DescribeNotificationConfigurationsRequest>
  Model::DescribeNotificationConfigurationsOutcomeCallable DescribeNotificationConfigurationsCallable(
      const DescribeNotificationConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeNotificationConfigurations, request);
  }

  /**
   * An Async wrapper for DescribeNotificationConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeNotificationConfigurationsRequestT = Model::DescribeNotificationConfigurationsRequest>
  void DescribeNotificationConfigurationsAsync(const DescribeNotificationConfigurationsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const DescribeNotificationConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribePolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePolicies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePoliciesRequestT = Model::DescribePoliciesRequest>
  void DescribePoliciesAsync(const DescribePoliciesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DescribePoliciesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeScalingActivitiesOutcome DescribeScalingActivities(
      const Model::DescribeScalingActivitiesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeScalingActivities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeScalingActivitiesRequestT = Model::DescribeScalingActivitiesRequest>
  Model::DescribeScalingActivitiesOutcomeCallable DescribeScalingActivitiesCallable(
      const DescribeScalingActivitiesRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeScalingActivities, request);
  }

  /**
   * An Async wrapper for DescribeScalingActivities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeScalingActivitiesRequestT = Model::DescribeScalingActivitiesRequest>
  void DescribeScalingActivitiesAsync(const DescribeScalingActivitiesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeScalingActivitiesRequestT& request = {}) const {
  ...
  /**
   * <p>Describes the scaling process types for use with the <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeScalingProcessTypesOutcome DescribeScalingProcessTypes(
      const Model::DescribeScalingProcessTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeScalingProcessTypes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeScalingProcessTypesRequestT = Model::DescribeScalingProcessTypesRequest>
  Model::DescribeScalingProcessTypesOutcomeCallable DescribeScalingProcessTypesCallable(
      const DescribeScalingProcessTypesRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeScalingProcessTypes, request);
  }

  /**
   * An Async wrapper for DescribeScalingProcessTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeScalingProcessTypesRequestT = Model::DescribeScalingProcessTypesRequest>
  void DescribeScalingProcessTypesAsync(const DescribeScalingProcessTypesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeScalingProcessTypesRequestT& request = {}) const {
   ...
   * scheduled actions that have already run, call the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeScalingActivities.html">DescribeScalingActivities</a>
   * API.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for DescribeScheduledActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeScheduledActionsRequestT = Model::DescribeScheduledActionsRequest>
  Model::DescribeScheduledActionsOutcomeCallable DescribeScheduledActionsCallable(
      const DescribeScheduledActionsRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeScheduledActions, request);
  }

  /**
   * An Async wrapper for DescribeScheduledActions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeScheduledActionsRequestT = Model::DescribeScheduledActionsRequest>
  void DescribeScheduledActionsAsync(const DescribeScheduledActionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeScheduledActionsRequestT& request = {}) const {
   ...
   */
  template <typename DescribeTagsRequestT = Model::DescribeTagsRequest>
  void DescribeTagsAsync(const DescribeTagsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const DescribeTagsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTerminationPolicyTypesOutcome DescribeTerminationPolicyTypes(
      const Model::DescribeTerminationPolicyTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeTerminationPolicyTypes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeTerminationPolicyTypesRequestT = Model::DescribeTerminationPolicyTypesRequest>
  Model::DescribeTerminationPolicyTypesOutcomeCallable DescribeTerminationPolicyTypesCallable(
      const DescribeTerminationPolicyTypesRequestT& request = {}) const {
    return SubmitCallable(&AutoScalingClient::DescribeTerminationPolicyTypes, request);
  }

  /**
   * An Async wrapper for DescribeTerminationPolicyTypes that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeTerminationPolicyTypesRequestT = Model::DescribeTerminationPolicyTypesRequest>
  void DescribeTerminationPolicyTypesAsync(const DescribeTerminationPolicyTypesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const DescribeTerminationPolicyTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeTrafficSources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTrafficSources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTrafficSourcesRequestT = Model::DescribeTrafficSourcesRequest>
  void DescribeTrafficSourcesAsync(const DescribeTrafficSourcesRequestT& request,
                                   const DescribeTrafficSourcesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWarmPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWarmPool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeWarmPoolRequestT = Model::DescribeWarmPoolRequest>
  void DescribeWarmPoolAsync(const DescribeWarmPoolRequestT& request, const DescribeWarmPoolResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DetachInstances that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetachInstancesRequestT = Model::DetachInstancesRequest>
  void DetachInstancesAsync(const DetachInstancesRequestT& request, const DetachInstancesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * using the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeLoadBalancerTargetGroups.html">DescribeLoadBalancerTargetGroups</a>
   * API call. The instances remain running.</p>  <p>You can use this operation
   * to detach target groups that were attached by using <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_AttachLoadBalancerTargetGroups.html">AttachLoadBalancerTargetGroups</a>,
   * but not for target groups that were attached by using <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_AttachTrafficSources.html">AttachTrafficSources</a>.</p>
   * <p><h3>See Also:</h3>   <a
  ...
  virtual Model::DetachLoadBalancerTargetGroupsOutcome DetachLoadBalancerTargetGroups(
      const Model::DetachLoadBalancerTargetGroupsRequest& request) const;

  /**
   * A Callable wrapper for DetachLoadBalancerTargetGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DetachLoadBalancerTargetGroupsRequestT = Model::DetachLoadBalancerTargetGroupsRequest>
  Model::DetachLoadBalancerTargetGroupsOutcomeCallable DetachLoadBalancerTargetGroupsCallable(
      const DetachLoadBalancerTargetGroupsRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::DetachLoadBalancerTargetGroups, request);
  }

  /**
   * An Async wrapper for DetachLoadBalancerTargetGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DetachLoadBalancerTargetGroupsRequestT = Model::DetachLoadBalancerTargetGroupsRequest>
  void DetachLoadBalancerTargetGroupsAsync(const DetachLoadBalancerTargetGroupsRequestT& request,
   ...
   * use the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DetachLoadBalancerTargetGroups.html">DetachLoadBalancerTargetGroups</a>
   * API instead.</p> <p>When you detach a load balancer, it enters the
   * <code>Removing</code> state while deregistering the instances in the group. When
   * all instances are deregistered, then you can no longer describe the load
   * balancer using the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeLoadBalancers.html">DescribeLoadBalancers</a>
   * API call. The instances remain running.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for DetachLoadBalancers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetachLoadBalancers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetachLoadBalancersRequestT = Model::DetachLoadBalancersRequest>
  void DetachLoadBalancersAsync(const DetachLoadBalancersRequestT& request, const DetachLoadBalancersResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * source using the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeTrafficSources.html">DescribeTrafficSources</a>
   * API call. The instances continue to run.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for DetachTrafficSources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetachTrafficSources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetachTrafficSourcesRequestT = Model::DetachTrafficSourcesRequest>
  void DetachTrafficSourcesAsync(const DetachTrafficSourcesRequestT& request, const DetachTrafficSourcesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisableMetricsCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableMetricsCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableMetricsCollectionRequestT = Model::DisableMetricsCollectionRequest>
  void DisableMetricsCollectionAsync(const DisableMetricsCollectionRequestT& request,
  ...
  /**
   * A Callable wrapper for EnableMetricsCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableMetricsCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableMetricsCollectionRequestT = Model::EnableMetricsCollectionRequest>
  void EnableMetricsCollectionAsync(const EnableMetricsCollectionRequestT& request,
  ...
  /**
   * An Async wrapper for EnterStandby that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnterStandbyRequestT = Model::EnterStandbyRequest>
  void EnterStandbyAsync(const EnterStandbyRequestT& request, const EnterStandbyResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ExecutePolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ExecutePolicyRequestT = Model::ExecutePolicyRequest>
  void ExecutePolicyAsync(const ExecutePolicyRequestT& request, const ExecutePolicyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ExitStandby that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ExitStandbyRequestT = Model::ExitStandbyRequest>
  void ExitStandbyAsync(const ExitStandbyRequestT& request, const ExitStandbyResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetPredictiveScalingForecastOutcome GetPredictiveScalingForecast(
      const Model::GetPredictiveScalingForecastRequest& request) const;

  /**
   * A Callable wrapper for GetPredictiveScalingForecast that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPredictiveScalingForecastRequestT = Model::GetPredictiveScalingForecastRequest>
  Model::GetPredictiveScalingForecastOutcomeCallable GetPredictiveScalingForecastCallable(
      const GetPredictiveScalingForecastRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::GetPredictiveScalingForecast, request);
  }

  /**
   * An Async wrapper for GetPredictiveScalingForecast that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPredictiveScalingForecastRequestT = Model::GetPredictiveScalingForecastRequest>
  void GetPredictiveScalingForecastAsync(const GetPredictiveScalingForecastRequestT& request,
   ...
   * action heartbeat to keep the instance in a wait state using the <a
   ...
   * API call.</p> </li> <li> <p>If you finish before the timeout period ends, send a
   * callback by using the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_CompleteLifecycleAction.html">CompleteLifecycleAction</a>
   * API call.</p> </li> </ol> <p>For more information, see <a
   ...
   * lifecycle hooks for an Auto Scaling group using the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeLifecycleHooks.html">DescribeLifecycleHooks</a>
   * API call. If you are no longer using a lifecycle hook, you can delete it by
   * calling the <a
  ...
  /**
   * A Callable wrapper for PutLifecycleHook that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutLifecycleHook that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutLifecycleHookRequestT = Model::PutLifecycleHookRequest>
  void PutLifecycleHookAsync(const PutLifecycleHookRequestT& request, const PutLifecycleHookResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutNotificationConfigurationOutcome PutNotificationConfiguration(
      const Model::PutNotificationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutNotificationConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutNotificationConfigurationRequestT = Model::PutNotificationConfigurationRequest>
  Model::PutNotificationConfigurationOutcomeCallable PutNotificationConfigurationCallable(
      const PutNotificationConfigurationRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::PutNotificationConfiguration, request);
  }

  /**
   * An Async wrapper for PutNotificationConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutNotificationConfigurationRequestT = Model::PutNotificationConfigurationRequest>
  void PutNotificationConfigurationAsync(const PutNotificationConfigurationRequestT& request,
   ...
   * API call. If you are no longer using a scaling policy, you can delete it by
   * calling the <a
  ...
  /**
   * A Callable wrapper for PutScalingPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutScalingPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutScalingPolicyRequestT = Model::PutScalingPolicyRequest>
  void PutScalingPolicyAsync(const PutScalingPolicyRequestT& request, const PutScalingPolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * view the scheduled actions for an Auto Scaling group using the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeScheduledActions.html">DescribeScheduledActions</a>
   * API call. If you are no longer using a scheduled action, you can delete it by
   * calling the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DeleteScheduledAction.html">DeleteScheduledAction</a>
   * API.</p> <p>If you try to schedule your action in the past, Amazon EC2 Auto
   * Scaling returns an error message.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/PutScheduledUpdateGroupAction">AWS
   * API Reference</a></p>
   */
  virtual Model::PutScheduledUpdateGroupActionOutcome PutScheduledUpdateGroupAction(
      const Model::PutScheduledUpdateGroupActionRequest& request) const;

  /**
   * A Callable wrapper for PutScheduledUpdateGroupAction that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutScheduledUpdateGroupActionRequestT = Model::PutScheduledUpdateGroupActionRequest>
  Model::PutScheduledUpdateGroupActionOutcomeCallable PutScheduledUpdateGroupActionCallable(
      const PutScheduledUpdateGroupActionRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::PutScheduledUpdateGroupAction, request);
  }

  /**
   * An Async wrapper for PutScheduledUpdateGroupAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutScheduledUpdateGroupActionRequestT = Model::PutScheduledUpdateGroupActionRequest>
  void PutScheduledUpdateGroupActionAsync(const PutScheduledUpdateGroupActionRequestT& request,
   ...
   * created.</p> <p>You can view the instances in the warm pool using the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeWarmPool.html">DescribeWarmPool</a>
   * API call. If you are no longer using a warm pool, you can delete it by calling
   * the <a
  ...
  /**
   * An Async wrapper for PutWarmPool that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutWarmPoolRequestT = Model::PutWarmPoolRequest>
  void PutWarmPoolAsync(const PutWarmPoolRequestT& request, const PutWarmPoolResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API call.</p> <p>This step is a part of the procedure for adding a lifecycle
   * hook to an Auto Scaling group:</p> <ol> <li> <p>(Optional) Create a launch
   * template or launch configuration with a user data script that runs while an
   * instance is in a wait state due to a lifecycle hook.</p> </li> <li>
   * <p>(Optional) Create a Lambda function and a rule that allows Amazon EventBridge
   * to invoke your Lambda function when an instance is put into a wait state due to
   * a lifecycle hook.</p> </li> <li> <p>(Optional) Create a notification target and
   * an IAM role. The target can be either an Amazon SQS queue or an Amazon SNS
   ...
   * to keep the instance in a wait state.</b> </p> </li> <li> <p>If you finish
   * before the timeout period ends, send a callback by using the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_CompleteLifecycleAction.html">CompleteLifecycleAction</a>
   * API call.</p> </li> </ol> <p>For more information, see <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/lifecycle-hooks.html">Amazon
   * EC2 Auto Scaling lifecycle hooks</a> in the <i>Amazon EC2 Auto Scaling User
  ...
  virtual Model::RecordLifecycleActionHeartbeatOutcome RecordLifecycleActionHeartbeat(
      const Model::RecordLifecycleActionHeartbeatRequest& request) const;

  /**
   * A Callable wrapper for RecordLifecycleActionHeartbeat that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RecordLifecycleActionHeartbeatRequestT = Model::RecordLifecycleActionHeartbeatRequest>
  Model::RecordLifecycleActionHeartbeatOutcomeCallable RecordLifecycleActionHeartbeatCallable(
      const RecordLifecycleActionHeartbeatRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::RecordLifecycleActionHeartbeat, request);
  }

  /**
   * An Async wrapper for RecordLifecycleActionHeartbeat that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RecordLifecycleActionHeartbeatRequestT = Model::RecordLifecycleActionHeartbeatRequest>
  void RecordLifecycleActionHeartbeatAsync(const RecordLifecycleActionHeartbeatRequestT& request,
  ...
  /**
   * An Async wrapper for ResumeProcesses that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResumeProcessesRequestT = Model::ResumeProcessesRequest>
  void ResumeProcessesAsync(const ResumeProcessesRequestT& request, const ResumeProcessesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RollbackInstanceRefresh that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RollbackInstanceRefresh that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RollbackInstanceRefreshRequestT = Model::RollbackInstanceRefreshRequest>
  void RollbackInstanceRefreshAsync(const RollbackInstanceRefreshRequestT& request,
                                    const RollbackInstanceRefreshResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetDesiredCapacity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetDesiredCapacity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetDesiredCapacityRequestT = Model::SetDesiredCapacityRequest>
  void SetDesiredCapacityAsync(const SetDesiredCapacityRequestT& request, const SetDesiredCapacityResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetInstanceHealth that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetInstanceHealth that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetInstanceHealthRequestT = Model::SetInstanceHealthRequest>
  void SetInstanceHealthAsync(const SetInstanceHealthRequestT& request, const SetInstanceHealthResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetInstanceProtection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetInstanceProtection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetInstanceProtectionRequestT = Model::SetInstanceProtectionRequest>
  void SetInstanceProtectionAsync(const SetInstanceProtectionRequestT& request, const SetInstanceProtectionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API. </p> <p>An instance refresh might fail for several reasons, such as EC2
   * launch failures, misconfigured health checks, or not ignoring or allowing the
   ...
   * activities. To find the scaling activities, call the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeScalingActivities.html">DescribeScalingActivities</a>
   * API.</p> <p>If you enable auto rollback, your Auto Scaling group will be rolled
   * back automatically when the instance refresh fails. You can enable this feature
   * before starting an instance refresh by specifying the <code>AutoRollback</code>
   * property in the instance refresh preferences. Otherwise, to roll back an
   * instance refresh before it finishes, use the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_RollbackInstanceRefresh.html">RollbackInstanceRefresh</a>
   * API. </p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for StartInstanceRefresh that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartInstanceRefresh that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartInstanceRefreshRequestT = Model::StartInstanceRefreshRequest>
  void StartInstanceRefreshAsync(const StartInstanceRefreshRequestT& request, const StartInstanceRefreshResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SuspendProcesses that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SuspendProcesses that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SuspendProcessesRequestT = Model::SuspendProcessesRequest>
  void SuspendProcessesAsync(const SuspendProcessesRequestT& request, const SuspendProcessesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * call simply makes a termination request. The instances are not terminated
   ...
   * capacity, Amazon EC2 Auto Scaling launches instances to replace the ones that
   * are terminated. </p> <p>To terminate multiple instances in a single call, use
   * the <code>InstanceIds</code> and <code>AutoScalingGroupName</code> parameters
   * instead of <code>InstanceId</code>. When terminating multiple instances, the
   * response populates <code>Activities</code> instead of <code>Activity</code>.</p>
   * <p>By default, Amazon EC2 Auto Scaling balances instances across all
   * Availability Zones. If you decrement the desired capacity, your Auto Scaling
   * group can become unbalanced between Availability Zones. Amazon EC2 Auto Scaling
   * tries to rebalance the group, and rebalancing might terminate instances in other
   ...
   * API Reference</a></p>
   */
  virtual Model::TerminateInstanceInAutoScalingGroupOutcome TerminateInstanceInAutoScalingGroup(
      const Model::TerminateInstanceInAutoScalingGroupRequest& request) const;

  /**
   * A Callable wrapper for TerminateInstanceInAutoScalingGroup that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename TerminateInstanceInAutoScalingGroupRequestT = Model::TerminateInstanceInAutoScalingGroupRequest>
  Model::TerminateInstanceInAutoScalingGroupOutcomeCallable TerminateInstanceInAutoScalingGroupCallable(
      const TerminateInstanceInAutoScalingGroupRequestT& request) const {
    return SubmitCallable(&AutoScalingClient::TerminateInstanceInAutoScalingGroup, request);
  }

  /**
   * An Async wrapper for TerminateInstanceInAutoScalingGroup that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename TerminateInstanceInAutoScalingGroupRequestT = Model::TerminateInstanceInAutoScalingGroupRequest>
  void TerminateInstanceInAutoScalingGroupAsync(const TerminateInstanceInAutoScalingGroupRequestT& request,
   ...
   * </ul> <p>To see which properties have been set, call the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeAutoScalingGroups.html">DescribeAutoScalingGroups</a>
   * API. To view the scaling policies for an Auto Scaling group, call the <a
   * href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribePolicies.html">DescribePolicies</a>
   * API. If the group has scaling policies, you can update them by calling the <a
  ...
  /**
   * A Callable wrapper for UpdateAutoScalingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAutoScalingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAutoScalingGroupRequestT = Model::UpdateAutoScalingGroupRequest>
  void UpdateAutoScalingGroupAsync(const UpdateAutoScalingGroupRequestT& request,
