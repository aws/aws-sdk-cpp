...
class DescribeScalingActivitiesRequest : public AutoScalingRequest {
 ...
 public:
  ...
  inline void SetIncludeDeletedGroups(bool value) {
    m_includeDeletedGroupsHasBeenSet = true;
    m_includeDeletedGroups = value;
  }
  inline DescribeScalingActivitiesRequest& WithIncludeDeletedGroups(bool value) {
    SetIncludeDeletedGroups(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeScalingActivitiesRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
