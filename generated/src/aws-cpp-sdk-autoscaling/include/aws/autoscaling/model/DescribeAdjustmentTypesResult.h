...
class DescribeAdjustmentTypesResult {
 public:
  ...
  void SetAdjustmentTypes(AdjustmentTypesT&& value) {
    m_adjustmentTypesHasBeenSet = true;
    m_adjustmentTypes = std::forward<AdjustmentTypesT>(value);
  }
  template <typename AdjustmentTypesT = Aws::Vector<AdjustmentType>>
  DescribeAdjustmentTypesResult& WithAdjustmentTypes(AdjustmentTypesT&& value) {
    SetAdjustmentTypes(std::forward<AdjustmentTypesT>(value));
    return *this;
  }
  template <typename AdjustmentTypesT = AdjustmentType>
  DescribeAdjustmentTypesResult& AddAdjustmentTypes(AdjustmentTypesT&& value) {
    m_adjustmentTypesHasBeenSet = true;
    m_adjustmentTypes.emplace_back(std::forward<AdjustmentTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeAdjustmentTypesResult& WithResponseMetadata(ResponseMetadataT&& value) {
