...
namespace Model
{
  ...
  {
  public:
    AWS_AUTOSCALING_API DetachLoadBalancerTargetGroupsResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DetachLoadBalancerTargetGroupsResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
