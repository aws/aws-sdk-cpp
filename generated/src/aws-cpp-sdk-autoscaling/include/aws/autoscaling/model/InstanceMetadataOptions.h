...
class InstanceMetadataOptions {
 public:
  ...
  inline void SetHttpTokens(InstanceMetadataHttpTokensState value) {
    m_httpTokensHasBeenSet = true;
    m_httpTokens = value;
  }
  inline InstanceMetadataOptions& WithHttpTokens(InstanceMetadataHttpTokensState value) {
    SetHttpTokens(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceMetadataOptions& WithHttpEndpoint(InstanceMetadataEndpointState value) {
