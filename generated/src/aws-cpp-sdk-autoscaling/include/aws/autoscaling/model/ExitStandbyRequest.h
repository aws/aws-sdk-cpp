...
namespace Model
{
  ...
  {
  public:
    AWS_AUTOSCALING_API ExitStandbyRequest();
  ...
  public:
     ...
     * <p>The name of the Auto Scaling group.</p>
     */
    inline ExitStandbyRequest& WithAutoScalingGroupName(Aws::String&& value) { SetAutoScalingGroupName(std::move(value)); return *this;}
