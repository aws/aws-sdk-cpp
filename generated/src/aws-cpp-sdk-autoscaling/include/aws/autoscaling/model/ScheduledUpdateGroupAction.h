...
class ScheduledUpdateGroupAction {
 public:
  ...
  inline ScheduledUpdateGroupAction& WithMinSize(int value) {
    SetMinSize(value);
    return *this;
  }
  ///@}
  ...
  inline ScheduledUpdateGroupAction& WithMaxSize(int value) {
    SetMaxSize(value);
    return *this;
  }
  ///@}
  ...
  inline ScheduledUpdateGroupAction& WithDesiredCapacity(int value) {
