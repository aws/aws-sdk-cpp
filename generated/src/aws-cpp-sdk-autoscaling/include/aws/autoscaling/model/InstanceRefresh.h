...
class InstanceRefresh {
 public:
  ...
  inline void SetStatus(InstanceRefreshStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline InstanceRefresh& WithStatus(InstanceRefreshStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceRefresh& WithPercentageComplete(int value) {
  ...
  inline InstanceRefresh& WithInstancesToUpdate(int value) {
  ...
  void SetProgressDetails(ProgressDetailsT&& value) {
    ...
    m_progressDetails = std::forward<ProgressDetailsT>(value);
  }
  template <typename ProgressDetailsT = InstanceRefreshProgressDetails>
  InstanceRefresh& WithProgressDetails(ProgressDetailsT&& value) {
    SetProgressDetails(std::forward<ProgressDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDesiredConfiguration(DesiredConfigurationT&& value) {
    ...
    m_desiredConfiguration = std::forward<DesiredConfigurationT>(value);
  }
  template <typename DesiredConfigurationT = DesiredConfiguration>
  InstanceRefresh& WithDesiredConfiguration(DesiredConfigurationT&& value) {
    SetDesiredConfiguration(std::forward<DesiredConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRollbackDetails(RollbackDetailsT&& value) {
    ...
    m_rollbackDetails = std::forward<RollbackDetailsT>(value);
  }
  template <typename RollbackDetailsT = RollbackDetails>
  InstanceRefresh& WithRollbackDetails(RollbackDetailsT&& value) {
    SetRollbackDetails(std::forward<RollbackDetailsT>(value));
    return *this;
  }
  ///@}
