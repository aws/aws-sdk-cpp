...
class PutNotificationConfigurationRequest : public AutoScalingRequest {
 ...
 public:
  ...
  void SetNotificationTypes(NotificationTypesT&& value) {
    m_notificationTypesHasBeenSet = true;
    m_notificationTypes = std::forward<NotificationTypesT>(value);
  }
  template <typename NotificationTypesT = Aws::Vector<Aws::String>>
  PutNotificationConfigurationRequest& WithNotificationTypes(NotificationTypesT&& value) {
    SetNotificationTypes(std::forward<NotificationTypesT>(value));
    return *this;
  }
  ...
  PutNotificationConfigurationRequest& AddNotificationTypes(NotificationTypesT&& value) {
    m_notificationTypesHasBeenSet = true;
    m_notificationTypes.emplace_back(std::forward<NotificationTypesT>(value));
    return *this;
  }
  ///@}
 private:
