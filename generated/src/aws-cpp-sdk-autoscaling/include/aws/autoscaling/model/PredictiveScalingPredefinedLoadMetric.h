...
class PredictiveScalingPredefinedLoadMetric {
 public:
  ...
  inline void SetPredefinedMetricType(PredefinedLoadMetricType value) {
    m_predefinedMetricTypeHasBeenSet = true;
    m_predefinedMetricType = value;
  }
  inline PredictiveScalingPredefinedLoadMetric& WithPredefinedMetricType(PredefinedLoadMetricType value) {
