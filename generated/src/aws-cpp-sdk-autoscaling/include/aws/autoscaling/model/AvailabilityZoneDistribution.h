...
class AvailabilityZoneDistribution {
 public:
  ...
  inline void SetCapacityDistributionStrategy(CapacityDistributionStrategy value) {
    m_capacityDistributionStrategyHasBeenSet = true;
    m_capacityDistributionStrategy = value;
  }
  inline AvailabilityZoneDistribution& WithCapacityDistributionStrategy(CapacityDistributionStrategy value) {
    SetCapacityDistributionStrategy(value);
    return *this;
  }
  ///@}
 private:
