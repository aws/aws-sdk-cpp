...
class DescribeAccountLimitsResult {
 public:
  ...
  inline void SetMaxNumberOfAutoScalingGroups(int value) {
    m_maxNumberOfAutoScalingGroupsHasBeenSet = true;
    m_maxNumberOfAutoScalingGroups = value;
  }
  inline DescribeAccountLimitsResult& WithMaxNumberOfAutoScalingGroups(int value) {
    SetMaxNumberOfAutoScalingGroups(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxNumberOfLaunchConfigurations(int value) {
    m_maxNumberOfLaunchConfigurationsHasBeenSet = true;
    m_maxNumberOfLaunchConfigurations = value;
  }
  inline DescribeAccountLimitsResult& WithMaxNumberOfLaunchConfigurations(int value) {
    SetMaxNumberOfLaunchConfigurations(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfAutoScalingGroups(int value) {
    m_numberOfAutoScalingGroupsHasBeenSet = true;
    m_numberOfAutoScalingGroups = value;
  }
  inline DescribeAccountLimitsResult& WithNumberOfAutoScalingGroups(int value) {
    SetNumberOfAutoScalingGroups(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfLaunchConfigurations(int value) {
    m_numberOfLaunchConfigurationsHasBeenSet = true;
    m_numberOfLaunchConfigurations = value;
  }
  inline DescribeAccountLimitsResult& WithNumberOfLaunchConfigurations(int value) {
    SetNumberOfLaunchConfigurations(value);
    return *this;
  }
  ///@}
