...
class DescribeNotificationConfigurationsResult {
 public:
  ...
  AWS_AUTOSCALING_API DescribeNotificationConfigurationsResult& operator=(
  ...
  void SetNotificationConfigurations(NotificationConfigurationsT&& value) {
    ...
    m_notificationConfigurations = std::forward<NotificationConfigurationsT>(value);
  }
  template <typename NotificationConfigurationsT = Aws::Vector<NotificationConfiguration>>
  DescribeNotificationConfigurationsResult& WithNotificationConfigurations(NotificationConfigurationsT&& value) {
    SetNotificationConfigurations(std::forward<NotificationConfigurationsT>(value));
    return *this;
  }
  ...
  DescribeNotificationConfigurationsResult& AddNotificationConfigurations(NotificationConfigurationsT&& value) {
    m_notificationConfigurationsHasBeenSet = true;
    m_notificationConfigurations.emplace_back(std::forward<NotificationConfigurationsT>(value));
    return *this;
  }
  ///@}
