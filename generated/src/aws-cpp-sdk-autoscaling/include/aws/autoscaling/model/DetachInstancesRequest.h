...
namespace Model
{
  ...
  {
  public:
    AWS_AUTOSCALING_API DetachInstancesRequest() = default;
  ...
  public:
    ...
    template<typename InstanceIdsT = Aws::Vector<Aws::String>>
    DetachInstancesRequest& WithInstanceIds(InstanceIdsT&& value) { SetInstanceIds(std::forward<InstanceIdsT>(value)); return *this;}
    template<typename InstanceIdsT = Aws::String>
    DetachInstancesRequest& AddInstanceIds(InstanceIdsT&& value) { m_instanceIdsHasBeenSet = true; m_instanceIds.emplace_back(std::forward<InstanceIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename AutoScalingGroupNameT = Aws::String>
    DetachInstancesRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) { SetAutoScalingGroupName(std::forward<AutoScalingGroupNameT>(value)); return *this;}
    ///@}
