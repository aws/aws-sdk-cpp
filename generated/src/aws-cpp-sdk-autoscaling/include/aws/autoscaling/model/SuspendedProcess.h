...
class SuspendedProcess {
 public:
  ...
  template <typename ProcessNameT = Aws::String>
  SuspendedProcess& WithProcessName(ProcessNameT&& value) {
  ...
  void SetSuspensionReason(SuspensionReasonT&& value) {
    m_suspensionReasonHasBeenSet = true;
    m_suspensionReason = std::forward<SuspensionReasonT>(value);
  }
  template <typename SuspensionReasonT = Aws::String>
  SuspendedProcess& WithSuspensionReason(SuspensionReasonT&& value) {
    SetSuspensionReason(std::forward<SuspensionReasonT>(value));
    return *this;
  }
  ///@}
 private:
