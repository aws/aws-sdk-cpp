...
class MetricDataQuery {
 public:
  ...
  void SetMetricStat(MetricStatT&& value) {
    ...
    m_metricStat = std::forward<MetricStatT>(value);
  }
  template <typename MetricStatT = MetricStat>
  MetricDataQuery& WithMetricStat(MetricStatT&& value) {
    SetMetricStat(std::forward<MetricStatT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReturnData(bool value) {
    m_returnDataHasBeenSet = true;
    m_returnData = value;
  }
  inline MetricDataQuery& WithReturnData(bool value) {
    SetReturnData(value);
    return *this;
  }
  ///@}
