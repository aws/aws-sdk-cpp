...
class DescribeLaunchConfigurationsRequest : public AutoScalingRequest {
 ...
 public:
  ...
  void SetLaunchConfigurationNames(LaunchConfigurationNamesT&& value) {
    m_launchConfigurationNamesHasBeenSet = true;
    m_launchConfigurationNames = std::forward<LaunchConfigurationNamesT>(value);
  }
  template <typename LaunchConfigurationNamesT = Aws::Vector<Aws::String>>
  DescribeLaunchConfigurationsRequest& WithLaunchConfigurationNames(LaunchConfigurationNamesT&& value) {
    SetLaunchConfigurationNames(std::forward<LaunchConfigurationNamesT>(value));
    return *this;
  }
  ...
  DescribeLaunchConfigurationsRequest& AddLaunchConfigurationNames(LaunchConfigurationNamesT&& value) {
    m_launchConfigurationNamesHasBeenSet = true;
    m_launchConfigurationNames.emplace_back(std::forward<LaunchConfigurationNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeLaunchConfigurationsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
