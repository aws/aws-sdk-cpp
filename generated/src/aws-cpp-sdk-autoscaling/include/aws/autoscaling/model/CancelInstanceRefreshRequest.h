...
class CancelInstanceRefreshRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  CancelInstanceRefreshRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
  ...
  inline void SetWaitForTransitioningInstances(bool value) {
    m_waitForTransitioningInstancesHasBeenSet = true;
    m_waitForTransitioningInstances = value;
  }
  inline CancelInstanceRefreshRequest& WithWaitForTransitioningInstances(bool value) {
    SetWaitForTransitioningInstances(value);
    return *this;
  }
  ///@}
 private:
