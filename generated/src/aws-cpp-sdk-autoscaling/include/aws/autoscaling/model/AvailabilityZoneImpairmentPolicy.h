...
class AvailabilityZoneImpairmentPolicy {
 public:
  ...
  inline void SetZonalShiftEnabled(bool value) {
    m_zonalShiftEnabledHasBeenSet = true;
    m_zonalShiftEnabled = value;
  }
  inline AvailabilityZoneImpairmentPolicy& WithZonalShiftEnabled(bool value) {
    SetZonalShiftEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetImpairedZoneHealthCheckBehavior(ImpairedZoneHealthCheckBehavior value) {
    m_impairedZoneHealthCheckBehaviorHasBeenSet = true;
    m_impairedZoneHealthCheckBehavior = value;
  }
  inline AvailabilityZoneImpairmentPolicy& WithImpairedZoneHealthCheckBehavior(ImpairedZoneHealthCheckBehavior value) {
    SetImpairedZoneHealthCheckBehavior(value);
    return *this;
  }
  ///@}
 private:
