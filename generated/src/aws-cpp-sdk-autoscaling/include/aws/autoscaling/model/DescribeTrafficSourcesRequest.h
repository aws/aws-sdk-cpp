...
class DescribeTrafficSourcesRequest : public AutoScalingRequest {
 ...
 public:
  ...
  void SetTrafficSourceType(TrafficSourceTypeT&& value) {
    m_trafficSourceTypeHasBeenSet = true;
    m_trafficSourceType = std::forward<TrafficSourceTypeT>(value);
  }
  template <typename TrafficSourceTypeT = Aws::String>
  DescribeTrafficSourcesRequest& WithTrafficSourceType(TrafficSourceTypeT&& value) {
    SetTrafficSourceType(std::forward<TrafficSourceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeTrafficSourcesRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
