...
namespace Model
{
   ...
   * for an Auto Scaling group.</p>  <p>Setting the minimum bandwidth does not
   * guarantee that your instance will achieve the minimum bandwidth. Amazon EC2 will
   * identify instance types that support the specified minimum bandwidth, but the
