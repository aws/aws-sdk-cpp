...
class EnableMetricsCollectionRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  EnableMetricsCollectionRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
  ...
  template <typename MetricsT = Aws::Vector<Aws::String>>
  EnableMetricsCollectionRequest& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  template <typename MetricsT = Aws::String>
  EnableMetricsCollectionRequest& AddMetrics(MetricsT&& value) {
    m_metricsHasBeenSet = true;
  ...
  template <typename GranularityT = Aws::String>
  EnableMetricsCollectionRequest& WithGranularity(GranularityT&& value) {
