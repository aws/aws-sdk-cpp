...
class PredictiveScalingPredefinedMetricPair {
 public:
  ...
  inline void SetPredefinedMetricType(PredefinedMetricPairType value) {
    m_predefinedMetricTypeHasBeenSet = true;
    m_predefinedMetricType = value;
  }
  inline PredictiveScalingPredefinedMetricPair& WithPredefinedMetricType(PredefinedMetricPairType value) {
