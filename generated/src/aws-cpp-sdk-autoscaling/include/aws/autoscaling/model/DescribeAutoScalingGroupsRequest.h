...
class DescribeAutoScalingGroupsRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename AutoScalingGroupNamesT = Aws::Vector<Aws::String>>
  DescribeAutoScalingGroupsRequest& WithAutoScalingGroupNames(AutoScalingGroupNamesT&& value) {
    SetAutoScalingGroupNames(std::forward<AutoScalingGroupNamesT>(value));
    return *this;
  }
  template <typename AutoScalingGroupNamesT = Aws::String>
  DescribeAutoScalingGroupsRequest& AddAutoScalingGroupNames(AutoScalingGroupNamesT&& value) {
    m_autoScalingGroupNamesHasBeenSet = true;
  ...
  inline void SetIncludeInstances(bool value) {
    m_includeInstancesHasBeenSet = true;
    m_includeInstances = value;
  }
  inline DescribeAutoScalingGroupsRequest& WithIncludeInstances(bool value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAutoScalingGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeAutoScalingGroupsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeAutoScalingGroupsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeAutoScalingGroupsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
