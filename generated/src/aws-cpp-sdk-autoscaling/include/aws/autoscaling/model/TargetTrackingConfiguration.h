...
class TargetTrackingConfiguration {
 public:
  ...
  void SetPredefinedMetricSpecification(PredefinedMetricSpecificationT&& value) {
    ...
    m_predefinedMetricSpecification = std::forward<PredefinedMetricSpecificationT>(value);
  }
  template <typename PredefinedMetricSpecificationT = PredefinedMetricSpecification>
  TargetTrackingConfiguration& WithPredefinedMetricSpecification(PredefinedMetricSpecificationT&& value) {
    SetPredefinedMetricSpecification(std::forward<PredefinedMetricSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomizedMetricSpecification(CustomizedMetricSpecificationT&& value) {
    ...
    m_customizedMetricSpecification = std::forward<CustomizedMetricSpecificationT>(value);
  }
  template <typename CustomizedMetricSpecificationT = CustomizedMetricSpecification>
  TargetTrackingConfiguration& WithCustomizedMetricSpecification(CustomizedMetricSpecificationT&& value) {
    SetCustomizedMetricSpecification(std::forward<CustomizedMetricSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  inline TargetTrackingConfiguration& WithTargetValue(double value) {
  ...
  inline TargetTrackingConfiguration& WithDisableScaleIn(bool value) {
