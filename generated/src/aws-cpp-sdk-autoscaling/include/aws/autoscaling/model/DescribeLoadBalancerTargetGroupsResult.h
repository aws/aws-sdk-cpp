...
class DescribeLoadBalancerTargetGroupsResult {
 public:
  ...
  AWS_AUTOSCALING_API DescribeLoadBalancerTargetGroupsResult& operator=(
  ...
  template <typename LoadBalancerTargetGroupsT = Aws::Vector<LoadBalancerTargetGroupState>>
  DescribeLoadBalancerTargetGroupsResult& WithLoadBalancerTargetGroups(LoadBalancerTargetGroupsT&& value) {
  ...
  DescribeLoadBalancerTargetGroupsResult& AddLoadBalancerTargetGroups(LoadBalancerTargetGroupsT&& value) {
    m_loadBalancerTargetGroupsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeLoadBalancerTargetGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeLoadBalancerTargetGroupsResult& WithResponseMetadata(ResponseMetadataT&& value) {
