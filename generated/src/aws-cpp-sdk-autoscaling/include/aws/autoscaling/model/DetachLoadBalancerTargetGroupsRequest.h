...
class DetachLoadBalancerTargetGroupsRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  DetachLoadBalancerTargetGroupsRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
  ...
  template <typename TargetGroupARNsT = Aws::Vector<Aws::String>>
  DetachLoadBalancerTargetGroupsRequest& WithTargetGroupARNs(TargetGroupARNsT&& value) {
    SetTargetGroupARNs(std::forward<TargetGroupARNsT>(value));
    return *this;
  }
  template <typename TargetGroupARNsT = Aws::String>
  DetachLoadBalancerTargetGroupsRequest& AddTargetGroupARNs(TargetGroupARNsT&& value) {
    m_targetGroupARNsHasBeenSet = true;
