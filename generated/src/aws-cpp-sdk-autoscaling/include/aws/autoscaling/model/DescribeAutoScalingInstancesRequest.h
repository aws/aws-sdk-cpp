...
class DescribeAutoScalingInstancesRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename InstanceIdsT = Aws::Vector<Aws::String>>
  DescribeAutoScalingInstancesRequest& WithInstanceIds(InstanceIdsT&& value) {
    SetInstanceIds(std::forward<InstanceIdsT>(value));
    return *this;
  }
  template <typename InstanceIdsT = Aws::String>
  DescribeAutoScalingInstancesRequest& AddInstanceIds(InstanceIdsT&& value) {
    m_instanceIdsHasBeenSet = true;
  ...
  inline DescribeAutoScalingInstancesRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAutoScalingInstancesRequest& WithNextToken(NextTokenT&& value) {
