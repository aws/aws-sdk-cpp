...
class CapacityReservationTarget {
 public:
  ...
  template <typename CapacityReservationIdsT = Aws::Vector<Aws::String>>
  CapacityReservationTarget& WithCapacityReservationIds(CapacityReservationIdsT&& value) {
    SetCapacityReservationIds(std::forward<CapacityReservationIdsT>(value));
    return *this;
  }
  template <typename CapacityReservationIdsT = Aws::String>
  CapacityReservationTarget& AddCapacityReservationIds(CapacityReservationIdsT&& value) {
    m_capacityReservationIdsHasBeenSet = true;
  ...
  template <typename CapacityReservationResourceGroupArnsT = Aws::Vector<Aws::String>>
  CapacityReservationTarget& WithCapacityReservationResourceGroupArns(CapacityReservationResourceGroupArnsT&& value) {
  ...
  CapacityReservationTarget& AddCapacityReservationResourceGroupArns(CapacityReservationResourceGroupArnsT&& value) {
    m_capacityReservationResourceGroupArnsHasBeenSet = true;
