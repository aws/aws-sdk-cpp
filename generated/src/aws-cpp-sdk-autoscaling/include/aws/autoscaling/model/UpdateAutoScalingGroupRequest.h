...
class UpdateAutoScalingGroupRequest : public AutoScalingRequest {
 ...
 public:
  ...
  inline UpdateAutoScalingGroupRequest& WithMinSize(int value) {
    SetMinSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateAutoScalingGroupRequest& WithMaxSize(int value) {
    SetMaxSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateAutoScalingGroupRequest& WithDesiredCapacity(int value) {
  ...
  inline UpdateAutoScalingGroupRequest& WithDefaultCooldown(int value) {
  ...
  inline UpdateAutoScalingGroupRequest& WithHealthCheckGracePeriod(int value) {
  ...
  inline UpdateAutoScalingGroupRequest& WithNewInstancesProtectedFromScaleIn(bool value) {
  ...
  inline UpdateAutoScalingGroupRequest& WithMaxInstanceLifetime(int value) {
  ...
  inline UpdateAutoScalingGroupRequest& WithCapacityRebalance(bool value) {
  ...
  inline UpdateAutoScalingGroupRequest& WithDefaultInstanceWarmup(int value) {
  ...
  inline UpdateAutoScalingGroupRequest& WithSkipZonalShiftValidation(bool value) {
