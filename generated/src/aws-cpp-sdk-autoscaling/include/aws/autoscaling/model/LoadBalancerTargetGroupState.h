...
class LoadBalancerTargetGroupState {
 public:
  ...
  void SetLoadBalancerTargetGroupARN(LoadBalancerTargetGroupARNT&& value) {
    m_loadBalancerTargetGroupARNHasBeenSet = true;
    m_loadBalancerTargetGroupARN = std::forward<LoadBalancerTargetGroupARNT>(value);
  }
  template <typename LoadBalancerTargetGroupARNT = Aws::String>
  LoadBalancerTargetGroupState& WithLoadBalancerTargetGroupARN(LoadBalancerTargetGroupARNT&& value) {
    SetLoadBalancerTargetGroupARN(std::forward<LoadBalancerTargetGroupARNT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StateT = Aws::String>
  LoadBalancerTargetGroupState& WithState(StateT&& value) {
