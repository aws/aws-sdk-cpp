...
class DescribeLifecycleHooksRequest : public AutoScalingRequest {
 ...
 public:
  ...
  void SetLifecycleHookNames(LifecycleHookNamesT&& value) {
    m_lifecycleHookNamesHasBeenSet = true;
    m_lifecycleHookNames = std::forward<LifecycleHookNamesT>(value);
  }
  template <typename LifecycleHookNamesT = Aws::Vector<Aws::String>>
  DescribeLifecycleHooksRequest& WithLifecycleHookNames(LifecycleHookNamesT&& value) {
    SetLifecycleHookNames(std::forward<LifecycleHookNamesT>(value));
    return *this;
  }
  ...
  DescribeLifecycleHooksRequest& AddLifecycleHookNames(LifecycleHookNamesT&& value) {
    m_lifecycleHookNamesHasBeenSet = true;
    m_lifecycleHookNames.emplace_back(std::forward<LifecycleHookNamesT>(value));
    return *this;
  }
  ///@}
 private:
