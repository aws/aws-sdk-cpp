...
class DescribeLifecycleHookTypesResult {
 public:
  ...
  void SetLifecycleHookTypes(LifecycleHookTypesT&& value) {
    m_lifecycleHookTypesHasBeenSet = true;
    m_lifecycleHookTypes = std::forward<LifecycleHookTypesT>(value);
  }
  template <typename LifecycleHookTypesT = Aws::Vector<Aws::String>>
  DescribeLifecycleHookTypesResult& WithLifecycleHookTypes(LifecycleHookTypesT&& value) {
    SetLifecycleHookTypes(std::forward<LifecycleHookTypesT>(value));
    return *this;
  }
  template <typename LifecycleHookTypesT = Aws::String>
  DescribeLifecycleHookTypesResult& AddLifecycleHookTypes(LifecycleHookTypesT&& value) {
    m_lifecycleHookTypesHasBeenSet = true;
    m_lifecycleHookTypes.emplace_back(std::forward<LifecycleHookTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeLifecycleHookTypesResult& WithResponseMetadata(ResponseMetadataT&& value) {
