...
class EnterStandbyRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename InstanceIdsT = Aws::Vector<Aws::String>>
  EnterStandbyRequest& WithInstanceIds(InstanceIdsT&& value) {
    SetInstanceIds(std::forward<InstanceIdsT>(value));
    return *this;
  }
  template <typename InstanceIdsT = Aws::String>
  EnterStandbyRequest& AddInstanceIds(InstanceIdsT&& value) {
    m_instanceIdsHasBeenSet = true;
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  EnterStandbyRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
  ...
  inline EnterStandbyRequest& WithShouldDecrementDesiredCapacity(bool value) {
