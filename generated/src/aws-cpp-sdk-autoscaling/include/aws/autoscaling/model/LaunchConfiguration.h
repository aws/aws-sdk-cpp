...
class LaunchConfiguration {
 public:
  ...
  void SetLaunchConfigurationARN(LaunchConfigurationARNT&& value) {
    ...
    m_launchConfigurationARN = std::forward<LaunchConfigurationARNT>(value);
  }
  template <typename LaunchConfigurationARNT = Aws::String>
  LaunchConfiguration& WithLaunchConfigurationARN(LaunchConfigurationARNT&& value) {
    SetLaunchConfigurationARN(std::forward<LaunchConfigurationARNT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClassicLinkVPCId(ClassicLinkVPCIdT&& value) {
    ...
    m_classicLinkVPCId = std::forward<ClassicLinkVPCIdT>(value);
  }
  template <typename ClassicLinkVPCIdT = Aws::String>
  LaunchConfiguration& WithClassicLinkVPCId(ClassicLinkVPCIdT&& value) {
    SetClassicLinkVPCId(std::forward<ClassicLinkVPCIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClassicLinkVPCSecurityGroups(ClassicLinkVPCSecurityGroupsT&& value) {
    ...
    m_classicLinkVPCSecurityGroups = std::forward<ClassicLinkVPCSecurityGroupsT>(value);
  }
  template <typename ClassicLinkVPCSecurityGroupsT = Aws::Vector<Aws::String>>
  LaunchConfiguration& WithClassicLinkVPCSecurityGroups(ClassicLinkVPCSecurityGroupsT&& value) {
    SetClassicLinkVPCSecurityGroups(std::forward<ClassicLinkVPCSecurityGroupsT>(value));
    return *this;
  }
  ...
  LaunchConfiguration& AddClassicLinkVPCSecurityGroups(ClassicLinkVPCSecurityGroupsT&& value) {
    m_classicLinkVPCSecurityGroupsHasBeenSet = true;
    m_classicLinkVPCSecurityGroups.emplace_back(std::forward<ClassicLinkVPCSecurityGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceMonitoring(InstanceMonitoringT&& value) {
    ...
    m_instanceMonitoring = std::forward<InstanceMonitoringT>(value);
  }
  template <typename InstanceMonitoringT = InstanceMonitoring>
  LaunchConfiguration& WithInstanceMonitoring(InstanceMonitoringT&& value) {
    SetInstanceMonitoring(std::forward<InstanceMonitoringT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpotPrice(SpotPriceT&& value) {
    ...
    m_spotPrice = std::forward<SpotPriceT>(value);
  }
  template <typename SpotPriceT = Aws::String>
  LaunchConfiguration& WithSpotPrice(SpotPriceT&& value) {
    SetSpotPrice(std::forward<SpotPriceT>(value));
    return *this;
  }
  ///@}
  ...
  inline LaunchConfiguration& WithEbsOptimized(bool value) {
  ...
  inline LaunchConfiguration& WithAssociatePublicIpAddress(bool value) {
  ...
  void SetPlacementTenancy(PlacementTenancyT&& value) {
    ...
    m_placementTenancy = std::forward<PlacementTenancyT>(value);
  }
  template <typename PlacementTenancyT = Aws::String>
  LaunchConfiguration& WithPlacementTenancy(PlacementTenancyT&& value) {
    SetPlacementTenancy(std::forward<PlacementTenancyT>(value));
    return *this;
  }
  ///@}
