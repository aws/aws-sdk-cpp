...
class DisableMetricsCollectionRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  DisableMetricsCollectionRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
  ...
  template <typename MetricsT = Aws::Vector<Aws::String>>
  DisableMetricsCollectionRequest& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  template <typename MetricsT = Aws::String>
  DisableMetricsCollectionRequest& AddMetrics(MetricsT&& value) {
    m_metricsHasBeenSet = true;
