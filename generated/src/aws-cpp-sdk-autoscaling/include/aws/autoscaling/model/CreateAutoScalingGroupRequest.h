...
class CreateAutoScalingGroupRequest : public AutoScalingRequest {
 ...
 public:
  ...
  inline CreateAutoScalingGroupRequest& WithMinSize(int value) {
    SetMinSize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateAutoScalingGroupRequest& WithMaxSize(int value) {
    SetMaxSize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateAutoScalingGroupRequest& WithDesiredCapacity(int value) {
  ...
  inline CreateAutoScalingGroupRequest& WithDefaultCooldown(int value) {
  ...
  inline CreateAutoScalingGroupRequest& WithHealthCheckGracePeriod(int value) {
  ...
  inline CreateAutoScalingGroupRequest& WithNewInstancesProtectedFromScaleIn(bool value) {
  ...
  inline CreateAutoScalingGroupRequest& WithCapacityRebalance(bool value) {
   ...
   * are launched.</p>
   */
  inline const Aws::Vector<LifecycleHookSpecification>& GetLifecycleHookSpecificationList() const {
    return m_lifecycleHookSpecificationList;
  }
  ...
  void SetLifecycleHookSpecificationList(LifecycleHookSpecificationListT&& value) {
    m_lifecycleHookSpecificationListHasBeenSet = true;
    m_lifecycleHookSpecificationList = std::forward<LifecycleHookSpecificationListT>(value);
  }
  template <typename LifecycleHookSpecificationListT = Aws::Vector<LifecycleHookSpecification>>
  CreateAutoScalingGroupRequest& WithLifecycleHookSpecificationList(LifecycleHookSpecificationListT&& value) {
    SetLifecycleHookSpecificationList(std::forward<LifecycleHookSpecificationListT>(value));
    return *this;
  }
  ...
  CreateAutoScalingGroupRequest& AddLifecycleHookSpecificationList(LifecycleHookSpecificationListT&& value) {
    m_lifecycleHookSpecificationListHasBeenSet = true;
    m_lifecycleHookSpecificationList.emplace_back(std::forward<LifecycleHookSpecificationListT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateAutoScalingGroupRequest& WithMaxInstanceLifetime(int value) {
  ...
  inline CreateAutoScalingGroupRequest& WithDefaultInstanceWarmup(int value) {
  ...
  inline void SetSkipZonalShiftValidation(bool value) {
    m_skipZonalShiftValidationHasBeenSet = true;
    m_skipZonalShiftValidation = value;
  }
  inline CreateAutoScalingGroupRequest& WithSkipZonalShiftValidation(bool value) {
    SetSkipZonalShiftValidation(value);
    return *this;
  }
  ///@}
   ...
   * EC2 Auto Scaling User Guide</i>. </p>  <p>Instances in a Retained state
   * will continue to incur standard EC2 charges until terminated.</p>
   */
