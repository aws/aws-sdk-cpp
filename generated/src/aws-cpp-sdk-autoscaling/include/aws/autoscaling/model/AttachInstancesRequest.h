...
namespace Model
{
  ...
  {
  public:
    AWS_AUTOSCALING_API AttachInstancesRequest() = default;
  ...
  public:
    ...
    template<typename InstanceIdsT = Aws::Vector<Aws::String>>
    AttachInstancesRequest& WithInstanceIds(InstanceIdsT&& value) { SetInstanceIds(std::forward<InstanceIdsT>(value)); return *this;}
    template<typename InstanceIdsT = Aws::String>
    AttachInstancesRequest& AddInstanceIds(InstanceIdsT&& value) { m_instanceIdsHasBeenSet = true; m_instanceIds.emplace_back(std::forward<InstanceIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename AutoScalingGroupNameT = Aws::String>
    AttachInstancesRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) { SetAutoScalingGroupName(std::forward<AutoScalingGroupNameT>(value)); return *this;}
    ///@}
  private:
