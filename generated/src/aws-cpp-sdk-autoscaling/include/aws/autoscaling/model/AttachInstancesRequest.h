...
class AttachInstancesRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename InstanceIdsT = Aws::Vector<Aws::String>>
  AttachInstancesRequest& WithInstanceIds(InstanceIdsT&& value) {
    SetInstanceIds(std::forward<InstanceIdsT>(value));
    return *this;
  }
  template <typename InstanceIdsT = Aws::String>
  AttachInstancesRequest& AddInstanceIds(InstanceIdsT&& value) {
    m_instanceIdsHasBeenSet = true;
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  AttachInstancesRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
