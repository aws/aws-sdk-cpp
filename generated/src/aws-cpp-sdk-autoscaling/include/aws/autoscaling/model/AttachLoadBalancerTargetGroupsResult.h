...
namespace Model
{
  ...
  {
  public:
    AWS_AUTOSCALING_API AttachLoadBalancerTargetGroupsResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    AttachLoadBalancerTargetGroupsResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
