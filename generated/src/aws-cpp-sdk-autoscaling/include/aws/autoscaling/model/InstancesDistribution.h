...
class InstancesDistribution {
 public:
  ...
  inline InstancesDistribution& WithOnDemandBaseCapacity(int value) {
  ...
  inline InstancesDistribution& WithOnDemandPercentageAboveBaseCapacity(int value) {
  ...
  inline InstancesDistribution& WithSpotInstancePools(int value) {
