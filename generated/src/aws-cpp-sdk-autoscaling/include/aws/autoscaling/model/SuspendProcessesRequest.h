...
class SuspendProcessesRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  SuspendProcessesRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
  ...
  template <typename ScalingProcessesT = Aws::Vector<Aws::String>>
  SuspendProcessesRequest& WithScalingProcesses(ScalingProcessesT&& value) {
    SetScalingProcesses(std::forward<ScalingProcessesT>(value));
    return *this;
  }
  template <typename ScalingProcessesT = Aws::String>
  SuspendProcessesRequest& AddScalingProcesses(ScalingProcessesT&& value) {
    m_scalingProcessesHasBeenSet = true;
