...
class InstanceRequirements {
 public:
  ...
  inline InstanceRequirements& AddCpuManufacturers(CpuManufacturer value) {
    m_cpuManufacturersHasBeenSet = true;
  ...
  inline InstanceRequirements& AddInstanceGenerations(InstanceGeneration value) {
    m_instanceGenerationsHasBeenSet = true;
  ...
  inline InstanceRequirements& WithSpotMaxPricePercentageOverLowestPrice(int value) {
  ...
  inline InstanceRequirements& WithMaxSpotPriceAsPercentageOfOptimalOnDemandPrice(int value) {
  ...
  inline InstanceRequirements& WithOnDemandMaxPricePercentageOverLowestPrice(int value) {
  ...
  inline InstanceRequirements& WithBareMetal(BareMetal value) {
    SetBareMetal(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceRequirements& WithBurstablePerformance(BurstablePerformance value) {
  ...
  inline InstanceRequirements& WithRequireHibernateSupport(bool value) {
  ...
  inline InstanceRequirements& WithLocalStorage(LocalStorage value) {
  ...
  inline InstanceRequirements& AddLocalStorageTypes(LocalStorageType value) {
    m_localStorageTypesHasBeenSet = true;
  ...
  inline InstanceRequirements& AddAcceleratorTypes(AcceleratorType value) {
    m_acceleratorTypesHasBeenSet = true;
  ...
  inline InstanceRequirements& AddAcceleratorManufacturers(AcceleratorManufacturer value) {
    m_acceleratorManufacturersHasBeenSet = true;
  ...
  inline InstanceRequirements& AddAcceleratorNames(AcceleratorName value) {
    m_acceleratorNamesHasBeenSet = true;
  ...
  void SetBaselinePerformanceFactors(BaselinePerformanceFactorsT&& value) {
    ...
    m_baselinePerformanceFactors = std::forward<BaselinePerformanceFactorsT>(value);
  }
  template <typename BaselinePerformanceFactorsT = BaselinePerformanceFactorsRequest>
  InstanceRequirements& WithBaselinePerformanceFactors(BaselinePerformanceFactorsT&& value) {
    SetBaselinePerformanceFactors(std::forward<BaselinePerformanceFactorsT>(value));
    return *this;
  }
  ///@}
 private:
