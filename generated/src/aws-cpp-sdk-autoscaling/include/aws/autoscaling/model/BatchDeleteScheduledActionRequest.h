...
class BatchDeleteScheduledActionRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  BatchDeleteScheduledActionRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
  ...
  template <typename ScheduledActionNamesT = Aws::Vector<Aws::String>>
  BatchDeleteScheduledActionRequest& WithScheduledActionNames(ScheduledActionNamesT&& value) {
    SetScheduledActionNames(std::forward<ScheduledActionNamesT>(value));
    return *this;
  }
  template <typename ScheduledActionNamesT = Aws::String>
  BatchDeleteScheduledActionRequest& AddScheduledActionNames(ScheduledActionNamesT&& value) {
    m_scheduledActionNamesHasBeenSet = true;
