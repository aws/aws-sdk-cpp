...
class AttachLoadBalancerTargetGroupsRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  AttachLoadBalancerTargetGroupsRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
  ...
  template <typename TargetGroupARNsT = Aws::Vector<Aws::String>>
  AttachLoadBalancerTargetGroupsRequest& WithTargetGroupARNs(TargetGroupARNsT&& value) {
    SetTargetGroupARNs(std::forward<TargetGroupARNsT>(value));
    return *this;
  }
  template <typename TargetGroupARNsT = Aws::String>
  AttachLoadBalancerTargetGroupsRequest& AddTargetGroupARNs(TargetGroupARNsT&& value) {
    m_targetGroupARNsHasBeenSet = true;
