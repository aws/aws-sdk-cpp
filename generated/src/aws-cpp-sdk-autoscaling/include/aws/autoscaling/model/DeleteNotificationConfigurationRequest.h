...
class DeleteNotificationConfigurationRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  DeleteNotificationConfigurationRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
  ...
  template <typename TopicARNT = Aws::String>
  DeleteNotificationConfigurationRequest& WithTopicARN(TopicARNT&& value) {
