...
namespace Model
{
  ...
  {
  public:
    AWS_AUTOSCALING_API AttachLoadBalancersResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    AttachLoadBalancersResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
