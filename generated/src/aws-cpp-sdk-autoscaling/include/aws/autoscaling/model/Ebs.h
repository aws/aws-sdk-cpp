...
class Ebs {
 public:
  ...
  inline Ebs& WithVolumeSize(int value) {
    SetVolumeSize(value);
    return *this;
  }
  ///@}
  ...
  inline Ebs& WithDeleteOnTermination(bool value) {
  ...
  inline Ebs& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline Ebs& WithThroughput(int value) {
    SetThroughput(value);
    return *this;
  }
  ///@}
