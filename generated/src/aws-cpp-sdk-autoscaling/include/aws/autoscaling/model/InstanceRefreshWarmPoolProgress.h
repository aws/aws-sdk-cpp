...
class InstanceRefreshWarmPoolProgress {
 public:
  ...
  inline InstanceRefreshWarmPoolProgress& WithPercentageComplete(int value) {
  ...
  inline void SetInstancesToUpdate(int value) {
    m_instancesToUpdateHasBeenSet = true;
    m_instancesToUpdate = value;
  }
  inline InstanceRefreshWarmPoolProgress& WithInstancesToUpdate(int value) {
    SetInstancesToUpdate(value);
    return *this;
  }
  ///@}
 private:
