...
class DescribeAutoScalingInstancesResult {
 public:
  ...
  AWS_AUTOSCALING_API DescribeAutoScalingInstancesResult& operator=(
  ...
  void SetAutoScalingInstances(AutoScalingInstancesT&& value) {
    m_autoScalingInstancesHasBeenSet = true;
    m_autoScalingInstances = std::forward<AutoScalingInstancesT>(value);
  }
  template <typename AutoScalingInstancesT = Aws::Vector<AutoScalingInstanceDetails>>
  DescribeAutoScalingInstancesResult& WithAutoScalingInstances(AutoScalingInstancesT&& value) {
    SetAutoScalingInstances(std::forward<AutoScalingInstancesT>(value));
    return *this;
  }
  template <typename AutoScalingInstancesT = AutoScalingInstanceDetails>
  DescribeAutoScalingInstancesResult& AddAutoScalingInstances(AutoScalingInstancesT&& value) {
    m_autoScalingInstancesHasBeenSet = true;
    m_autoScalingInstances.emplace_back(std::forward<AutoScalingInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAutoScalingInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeAutoScalingInstancesResult& WithResponseMetadata(ResponseMetadataT&& value) {
