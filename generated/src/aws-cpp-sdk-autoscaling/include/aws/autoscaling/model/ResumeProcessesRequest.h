...
namespace Model
{
  ...
  /**
   */
  class ResumeProcessesRequest : public AutoScalingRequest
  {
  public:
    AWS_AUTOSCALING_API ResumeProcessesRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "ResumeProcesses"; }
  ...
  public:
    ...
    template<typename AutoScalingGroupNameT = Aws::String>
    ResumeProcessesRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) { SetAutoScalingGroupName(std::forward<AutoScalingGroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ScalingProcessesT = Aws::Vector<Aws::String>>
    ResumeProcessesRequest& WithScalingProcesses(ScalingProcessesT&& value) { SetScalingProcesses(std::forward<ScalingProcessesT>(value)); return *this;}
    template<typename ScalingProcessesT = Aws::String>
    ResumeProcessesRequest& AddScalingProcesses(ScalingProcessesT&& value) { m_scalingProcessesHasBeenSet = true; m_scalingProcesses.emplace_back(std::forward<ScalingProcessesT>(value)); return *this; }
    ///@}
  private:
