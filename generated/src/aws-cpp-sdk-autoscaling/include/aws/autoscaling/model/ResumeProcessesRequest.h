...
class ResumeProcessesRequest : public AutoScalingRequest {
 ...
 public:
  ...
  template <typename AutoScalingGroupNameT = Aws::String>
  ResumeProcessesRequest& WithAutoScalingGroupName(AutoScalingGroupNameT&& value) {
  ...
  void SetScalingProcesses(ScalingProcessesT&& value) {
    m_scalingProcessesHasBeenSet = true;
    m_scalingProcesses = std::forward<ScalingProcessesT>(value);
  }
  template <typename ScalingProcessesT = Aws::Vector<Aws::String>>
  ResumeProcessesRequest& WithScalingProcesses(ScalingProcessesT&& value) {
    SetScalingProcesses(std::forward<ScalingProcessesT>(value));
    return *this;
  }
  template <typename ScalingProcessesT = Aws::String>
  ResumeProcessesRequest& AddScalingProcesses(ScalingProcessesT&& value) {
    m_scalingProcessesHasBeenSet = true;
    m_scalingProcesses.emplace_back(std::forward<ScalingProcessesT>(value));
    return *this;
  }
  ///@}
 private:
