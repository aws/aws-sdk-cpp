...
class DescribeAutoScalingGroupsResult {
 public:
  ...
  template <typename AutoScalingGroupsT = Aws::Vector<AutoScalingGroup>>
  DescribeAutoScalingGroupsResult& WithAutoScalingGroups(AutoScalingGroupsT&& value) {
    SetAutoScalingGroups(std::forward<AutoScalingGroupsT>(value));
    return *this;
  }
  template <typename AutoScalingGroupsT = AutoScalingGroup>
  DescribeAutoScalingGroupsResult& AddAutoScalingGroups(AutoScalingGroupsT&& value) {
    m_autoScalingGroupsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAutoScalingGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeAutoScalingGroupsResult& WithResponseMetadata(ResponseMetadataT&& value) {
