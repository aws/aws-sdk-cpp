...
namespace Model
{
  ...
  {
  public:
    AWS_AUTOSCALING_API DeleteLifecycleHookResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteLifecycleHookResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
