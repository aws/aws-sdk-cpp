...
class DescribePoliciesRequest : public AutoScalingRequest {
 ...
 public:
  ...
  inline DescribePoliciesRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
