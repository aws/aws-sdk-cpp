...
class Activity {
 public:
  ...
  inline void SetStatusCode(ScalingActivityStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline Activity& WithStatusCode(ScalingActivityStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  inline Activity& WithProgress(int value) {
    SetProgress(value);
    return *this;
  }
  ///@}
  ...
  void SetAutoScalingGroupState(AutoScalingGroupStateT&& value) {
    ...
    m_autoScalingGroupState = std::forward<AutoScalingGroupStateT>(value);
  }
  template <typename AutoScalingGroupStateT = Aws::String>
  Activity& WithAutoScalingGroupState(AutoScalingGroupStateT&& value) {
    SetAutoScalingGroupState(std::forward<AutoScalingGroupStateT>(value));
    return *this;
  }
  ///@}
