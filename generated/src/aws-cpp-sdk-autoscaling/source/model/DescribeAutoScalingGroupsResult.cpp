...
DescribeAutoScalingGroupsResult::DescribeAutoScalingGroupsResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeAutoScalingGroupsResult& DescribeAutoScalingGroupsResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::AutoScaling::Model::DescribeAutoScalingGroupsResult",
