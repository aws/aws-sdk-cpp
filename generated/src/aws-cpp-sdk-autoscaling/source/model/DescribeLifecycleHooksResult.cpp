...
DescribeLifecycleHooksResult::DescribeLifecycleHooksResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeLifecycleHooksResult& DescribeLifecycleHooksResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!lifecycleHooksNode.IsNull()) {
      ...
      m_lifecycleHooksHasBeenSet = !lifecycleHooksMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::AutoScaling::Model::DescribeLifecycleHooksResult",
