...
TargetTrackingMetricStat::TargetTrackingMetricStat(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TargetTrackingMetricStat::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
