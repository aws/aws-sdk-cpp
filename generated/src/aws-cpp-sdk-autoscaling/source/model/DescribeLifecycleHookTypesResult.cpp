...
DescribeLifecycleHookTypesResult& DescribeLifecycleHookTypesResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!lifecycleHookTypesNode.IsNull()) {
      ...
      m_lifecycleHookTypesHasBeenSet = !lifecycleHookTypesMember.IsNull();
      ...
      m_lifecycleHookTypesHasBeenSet = true;
    }
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::AutoScaling::Model::DescribeLifecycleHookTypesResult",
