...
InstanceRefreshLivePoolProgress::InstanceRefreshLivePoolProgress(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceRefreshLivePoolProgress::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
