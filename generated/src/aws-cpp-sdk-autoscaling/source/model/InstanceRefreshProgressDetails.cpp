...
InstanceRefreshProgressDetails::InstanceRefreshProgressDetails(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceRefreshProgressDetails::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
