...
NetworkInterfaceCountRequest::NetworkInterfaceCountRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void NetworkInterfaceCountRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
