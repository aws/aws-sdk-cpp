...
RollbackInstanceRefreshResult::RollbackInstanceRefreshResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
RollbackInstanceRefreshResult& RollbackInstanceRefreshResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::AutoScaling::Model::RollbackInstanceRefreshResult",
