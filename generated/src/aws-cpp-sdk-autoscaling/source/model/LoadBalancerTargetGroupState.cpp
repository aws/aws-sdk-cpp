...
LoadBalancerTargetGroupState::LoadBalancerTargetGroupState(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LoadBalancerTargetGroupState::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                  const char* locationValue) const {
  if (m_loadBalancerTargetGroupARNHasBeenSet) {
    oStream << location << index << locationValue
            << ".LoadBalancerTargetGroupARN=" << StringUtils::URLEncode(m_loadBalancerTargetGroupARN.c_str()) << "&";
  }
