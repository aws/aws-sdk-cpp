...
DescribeInstanceRefreshesResult::DescribeInstanceRefreshesResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeInstanceRefreshesResult& DescribeInstanceRefreshesResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!instanceRefreshesNode.IsNull()) {
      ...
      m_instanceRefreshesHasBeenSet = !instanceRefreshesMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::AutoScaling::Model::DescribeInstanceRefreshesResult",
