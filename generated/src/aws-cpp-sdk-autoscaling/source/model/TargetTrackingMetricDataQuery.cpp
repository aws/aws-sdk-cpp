...
TargetTrackingMetricDataQuery::TargetTrackingMetricDataQuery(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TargetTrackingMetricDataQuery::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
