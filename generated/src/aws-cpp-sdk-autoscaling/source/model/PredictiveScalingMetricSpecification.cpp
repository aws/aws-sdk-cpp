...
PredictiveScalingMetricSpecification::PredictiveScalingMetricSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
PredictiveScalingMetricSpecification& PredictiveScalingMetricSpecification::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!targetValueNode.IsNull()) {
      m_targetValue =
          StringUtils::ConvertToDouble(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(targetValueNode.GetText()).c_str()).c_str());
...
void PredictiveScalingMetricSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_predefinedScalingMetricSpecificationHasBeenSet) {
    ...
    predefinedScalingMetricSpecificationLocationAndMemberSs << location << index << locationValue
  ...
  if (m_customizedScalingMetricSpecificationHasBeenSet) {
    ...
    customizedScalingMetricSpecificationLocationAndMemberSs << location << index << locationValue
  ...
  if (m_customizedCapacityMetricSpecificationHasBeenSet) {
    ...
    customizedCapacityMetricSpecificationLocationAndMemberSs << location << index << locationValue
