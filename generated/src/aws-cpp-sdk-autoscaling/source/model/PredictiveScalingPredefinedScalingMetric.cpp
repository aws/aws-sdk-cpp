...
PredictiveScalingPredefinedScalingMetric::PredictiveScalingPredefinedScalingMetric(const XmlNode& xmlNode) { *this = xmlNode; }
...
PredictiveScalingPredefinedScalingMetric& PredictiveScalingPredefinedScalingMetric::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!predefinedMetricTypeNode.IsNull()) {
      m_predefinedMetricType = PredefinedScalingMetricTypeMapper::GetPredefinedScalingMetricTypeForName(
...
void PredictiveScalingPredefinedScalingMetric::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                              const char* locationValue) const {
  if (m_predefinedMetricTypeHasBeenSet) {
    oStream << location << index << locationValue << ".PredefinedMetricType="
            << StringUtils::URLEncode(PredefinedScalingMetricTypeMapper::GetNameForPredefinedScalingMetricType(m_predefinedMetricType))
            << "&";
  }
