...
CompleteLifecycleActionResult::CompleteLifecycleActionResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
CompleteLifecycleActionResult& CompleteLifecycleActionResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::AutoScaling::Model::CompleteLifecycleActionResult",
