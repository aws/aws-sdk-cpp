...
namespace Model
{
  ...
  public:
    ...
    template<typename ResourceArnT = Aws::String>
    CommitTransactionRequest& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SecretArnT = Aws::String>
    CommitTransactionRequest& WithSecretArn(SecretArnT&& value) { SetSecretArn(std::forward<SecretArnT>(value)); return *this;}
    ///@}
