...
class CommitTransactionRequest : public RDSDataServiceRequest {
 public:
  AWS_RDSDATASERVICE_API CommitTransactionRequest() = default;
  ...
  template <typename ResourceArnT = Aws::String>
  CommitTransactionRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename SecretArnT = Aws::String>
  CommitTransactionRequest& WithSecretArn(SecretArnT&& value) {
  ...
  template <typename TransactionIdT = Aws::String>
  CommitTransactionRequest& WithTransactionId(TransactionIdT&& value) {
