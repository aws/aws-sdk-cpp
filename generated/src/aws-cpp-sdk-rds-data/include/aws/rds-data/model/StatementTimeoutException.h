...
class StatementTimeoutException {
 public:
  ...
  template <typename MessageT = Aws::String>
  StatementTimeoutException& WithMessage(MessageT&& value) {
  ...
  inline void SetDbConnectionId(long long value) {
    m_dbConnectionIdHasBeenSet = true;
    m_dbConnectionId = value;
  }
  inline StatementTimeoutException& WithDbConnectionId(long long value) {
