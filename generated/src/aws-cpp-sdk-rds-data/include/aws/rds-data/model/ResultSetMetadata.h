...
class ResultSetMetadata {
 public:
  ...
  inline void SetColumnCount(long long value) {
    m_columnCountHasBeenSet = true;
    m_columnCount = value;
  }
  inline ResultSetMetadata& WithColumnCount(long long value) {
  ...
  template <typename ColumnMetadataT = Aws::Vector<ColumnMetadata>>
  ResultSetMetadata& WithColumnMetadata(ColumnMetadataT&& value) {
    SetColumnMetadata(std::forward<ColumnMetadataT>(value));
    return *this;
  }
  template <typename ColumnMetadataT = ColumnMetadata>
  ResultSetMetadata& AddColumnMetadata(ColumnMetadataT&& value) {
    m_columnMetadataHasBeenSet = true;
