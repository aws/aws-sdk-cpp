...
class RollbackTransactionRequest : public RDSDataServiceRequest {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  RollbackTransactionRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename SecretArnT = Aws::String>
  RollbackTransactionRequest& WithSecretArn(SecretArnT&& value) {
  ...
  template <typename TransactionIdT = Aws::String>
  RollbackTransactionRequest& WithTransactionId(TransactionIdT&& value) {
