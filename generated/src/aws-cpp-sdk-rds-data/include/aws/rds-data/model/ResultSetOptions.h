...
class ResultSetOptions {
 public:
  ...
  inline void SetDecimalReturnType(DecimalReturnType value) {
    m_decimalReturnTypeHasBeenSet = true;
    m_decimalReturnType = value;
  }
  inline ResultSetOptions& WithDecimalReturnType(DecimalReturnType value) {
    SetDecimalReturnType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLongReturnType(LongReturnType value) {
    m_longReturnTypeHasBeenSet = true;
    m_longReturnType = value;
  }
  inline ResultSetOptions& WithLongReturnType(LongReturnType value) {
    SetLongReturnType(value);
    return *this;
  }
  ///@}
 private:
