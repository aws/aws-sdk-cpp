...
class ExecuteStatementResult {
 public:
  ...
  template <typename RecordsT = Aws::Vector<Aws::Vector<Field>>>
  ExecuteStatementResult& WithRecords(RecordsT&& value) {
    SetRecords(std::forward<RecordsT>(value));
    return *this;
  }
  template <typename RecordsT = Aws::Vector<Field>>
  ExecuteStatementResult& AddRecords(RecordsT&& value) {
    m_recordsHasBeenSet = true;
  ...
  template <typename ColumnMetadataT = Aws::Vector<ColumnMetadata>>
  ExecuteStatementResult& WithColumnMetadata(ColumnMetadataT&& value) {
    SetColumnMetadata(std::forward<ColumnMetadataT>(value));
    return *this;
  }
  template <typename ColumnMetadataT = ColumnMetadata>
  ExecuteStatementResult& AddColumnMetadata(ColumnMetadataT&& value) {
    m_columnMetadataHasBeenSet = true;
  ...
  inline void SetNumberOfRecordsUpdated(long long value) {
    m_numberOfRecordsUpdatedHasBeenSet = true;
    m_numberOfRecordsUpdated = value;
  }
  inline ExecuteStatementResult& WithNumberOfRecordsUpdated(long long value) {
    SetNumberOfRecordsUpdated(value);
    return *this;
  }
  ///@}
  ...
  void SetGeneratedFields(GeneratedFieldsT&& value) {
    m_generatedFieldsHasBeenSet = true;
    m_generatedFields = std::forward<GeneratedFieldsT>(value);
  }
  template <typename GeneratedFieldsT = Aws::Vector<Field>>
  ExecuteStatementResult& WithGeneratedFields(GeneratedFieldsT&& value) {
    SetGeneratedFields(std::forward<GeneratedFieldsT>(value));
    return *this;
  }
  template <typename GeneratedFieldsT = Field>
  ExecuteStatementResult& AddGeneratedFields(GeneratedFieldsT&& value) {
    m_generatedFieldsHasBeenSet = true;
    m_generatedFields.emplace_back(std::forward<GeneratedFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFormattedRecords(FormattedRecordsT&& value) {
    m_formattedRecordsHasBeenSet = true;
    m_formattedRecords = std::forward<FormattedRecordsT>(value);
  }
  template <typename FormattedRecordsT = Aws::String>
  ExecuteStatementResult& WithFormattedRecords(FormattedRecordsT&& value) {
    SetFormattedRecords(std::forward<FormattedRecordsT>(value));
    return *this;
  }
  ///@}
