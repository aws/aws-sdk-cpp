...
class SqlStatementResult {
 public:
  ...
  void SetResultFrame(ResultFrameT&& value) {
    m_resultFrameHasBeenSet = true;
    m_resultFrame = std::forward<ResultFrameT>(value);
  }
  template <typename ResultFrameT = ResultFrame>
  SqlStatementResult& WithResultFrame(ResultFrameT&& value) {
    SetResultFrame(std::forward<ResultFrameT>(value));
    return *this;
  }
  ///@}
  ...
  inline SqlStatementResult& WithNumberOfRecordsUpdated(long long value) {
