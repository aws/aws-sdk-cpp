...
class BatchExecuteStatementRequest : public RDSDataServiceRequest {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  BatchExecuteStatementRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename SqlT = Aws::String>
  BatchExecuteStatementRequest& WithSql(SqlT&& value) {
  ...
  template <typename SchemaT = Aws::String>
  BatchExecuteStatementRequest& WithSchema(SchemaT&& value) {
  ...
  void SetParameterSets(ParameterSetsT&& value) {
    m_parameterSetsHasBeenSet = true;
    m_parameterSets = std::forward<ParameterSetsT>(value);
  }
  template <typename ParameterSetsT = Aws::Vector<Aws::Vector<SqlParameter>>>
  BatchExecuteStatementRequest& WithParameterSets(ParameterSetsT&& value) {
    SetParameterSets(std::forward<ParameterSetsT>(value));
    return *this;
  }
  template <typename ParameterSetsT = Aws::Vector<SqlParameter>>
  BatchExecuteStatementRequest& AddParameterSets(ParameterSetsT&& value) {
    m_parameterSetsHasBeenSet = true;
    m_parameterSets.emplace_back(std::forward<ParameterSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TransactionIdT = Aws::String>
  BatchExecuteStatementRequest& WithTransactionId(TransactionIdT&& value) {
