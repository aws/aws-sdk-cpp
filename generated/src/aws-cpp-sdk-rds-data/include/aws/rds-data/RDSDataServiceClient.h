...
namespace RDSDataService
{
   ...
   */
  class AWS_RDSDATASERVICE_API RDSDataServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<RDSDataServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::RDSDataService::SERVICE_NAME,
