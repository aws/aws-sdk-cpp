 ...
 * types of Aurora databases:</p> <ul> <li> <p>Aurora PostgreSQL - Serverless and
 * provisioned</p> </li> <li> <p>Aurora MySQL - Serverless and provisioned</p>
 * </li> </ul> <p>For more information about the Data API, see <a
...
class AWS_RDSDATASERVICE_API RDSDataServiceClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  RDSDataServiceClient(const Aws::RDSDataService::RDSDataServiceClientConfiguration& clientConfiguration =
  ...
  RDSDataServiceClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<RDSDataServiceEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::RDSDataService::RDSDataServiceClientConfiguration& clientConfiguration =
                           Aws::RDSDataService::RDSDataServiceClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  RDSDataServiceClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for BeginTransaction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BeginTransaction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BeginTransactionRequestT = Model::BeginTransactionRequest>
  void BeginTransactionAsync(const BeginTransactionRequestT& request, const BeginTransactionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CommitTransaction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CommitTransaction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CommitTransactionRequestT = Model::CommitTransactionRequest>
  void CommitTransactionAsync(const CommitTransactionRequestT& request, const CommitTransactionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RollbackTransaction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RollbackTransaction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RollbackTransactionRequestT = Model::RollbackTransactionRequest>
  void RollbackTransactionAsync(const RollbackTransactionRequestT& request, const RollbackTransactionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
