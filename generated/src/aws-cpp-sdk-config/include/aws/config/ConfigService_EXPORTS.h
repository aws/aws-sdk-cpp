...
#ifdef AWS_CONFIGSERVICE_EXPORTS
#define AWS_CONFIGSERVICE_API __declspec(dllexport)
#else
...
#define AWS_CONFIGSERVICE_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_CONFIGSERVICE_API
#define AWS_CONFIGSERVICE_EXTERN extern
#if __GNUC__ >= 4
#define AWS_CONFIGSERVICE_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_CONFIGSERVICE_LOCAL
#endif
