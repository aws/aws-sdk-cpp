...
class AWS_CONFIGSERVICE_API ConfigServiceClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ConfigServiceClient(const Aws::ConfigService::ConfigServiceClientConfiguration& clientConfiguration =
  ...
  ConfigServiceClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<ConfigServiceEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::ConfigService::ConfigServiceClientConfiguration& clientConfiguration =
                          Aws::ConfigService::ConfigServiceClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateResourceTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateResourceTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateResourceTypesRequestT = Model::AssociateResourceTypesRequest>
  void AssociateResourceTypesAsync(const AssociateResourceTypesRequestT& request,
                                   const AssociateResourceTypesResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetAggregateResourceConfigOutcome BatchGetAggregateResourceConfig(
      const Model::BatchGetAggregateResourceConfigRequest& request) const;

  /**
   * A Callable wrapper for BatchGetAggregateResourceConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchGetAggregateResourceConfigRequestT = Model::BatchGetAggregateResourceConfigRequest>
  Model::BatchGetAggregateResourceConfigOutcomeCallable BatchGetAggregateResourceConfigCallable(
      const BatchGetAggregateResourceConfigRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::BatchGetAggregateResourceConfig, request);
  }

  /**
   * An Async wrapper for BatchGetAggregateResourceConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchGetAggregateResourceConfigRequestT = Model::BatchGetAggregateResourceConfigRequest>
  void BatchGetAggregateResourceConfigAsync(const BatchGetAggregateResourceConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for BatchGetResourceConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetResourceConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetResourceConfigRequestT = Model::BatchGetResourceConfigRequest>
  void BatchGetResourceConfigAsync(const BatchGetResourceConfigRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAggregationAuthorizationOutcome DeleteAggregationAuthorization(
      const Model::DeleteAggregationAuthorizationRequest& request) const;

  /**
   * A Callable wrapper for DeleteAggregationAuthorization that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAggregationAuthorizationRequestT = Model::DeleteAggregationAuthorizationRequest>
  Model::DeleteAggregationAuthorizationOutcomeCallable DeleteAggregationAuthorizationCallable(
      const DeleteAggregationAuthorizationRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DeleteAggregationAuthorization, request);
  }

  /**
   * An Async wrapper for DeleteAggregationAuthorization that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteAggregationAuthorizationRequestT = Model::DeleteAggregationAuthorizationRequest>
  void DeleteAggregationAuthorizationAsync(const DeleteAggregationAuthorizationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteConfigRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteConfigRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteConfigRuleRequestT = Model::DeleteConfigRuleRequest>
  void DeleteConfigRuleAsync(const DeleteConfigRuleRequestT& request, const DeleteConfigRuleResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfigurationAggregatorOutcome DeleteConfigurationAggregator(
      const Model::DeleteConfigurationAggregatorRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfigurationAggregator that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteConfigurationAggregatorRequestT = Model::DeleteConfigurationAggregatorRequest>
  Model::DeleteConfigurationAggregatorOutcomeCallable DeleteConfigurationAggregatorCallable(
      const DeleteConfigurationAggregatorRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DeleteConfigurationAggregator, request);
  }

  /**
   * An Async wrapper for DeleteConfigurationAggregator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConfigurationAggregatorRequestT = Model::DeleteConfigurationAggregatorRequest>
  void DeleteConfigurationAggregatorAsync(const DeleteConfigurationAggregatorRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfigurationRecorderOutcome DeleteConfigurationRecorder(
      const Model::DeleteConfigurationRecorderRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfigurationRecorder that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteConfigurationRecorderRequestT = Model::DeleteConfigurationRecorderRequest>
  Model::DeleteConfigurationRecorderOutcomeCallable DeleteConfigurationRecorderCallable(
      const DeleteConfigurationRecorderRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DeleteConfigurationRecorder, request);
  }

  /**
   * An Async wrapper for DeleteConfigurationRecorder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConfigurationRecorderRequestT = Model::DeleteConfigurationRecorderRequest>
  void DeleteConfigurationRecorderAsync(const DeleteConfigurationRecorderRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteConformancePack that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteConformancePack that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConformancePackRequestT = Model::DeleteConformancePackRequest>
  void DeleteConformancePackAsync(const DeleteConformancePackRequestT& request, const DeleteConformancePackResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDeliveryChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDeliveryChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDeliveryChannelRequestT = Model::DeleteDeliveryChannelRequest>
  void DeleteDeliveryChannelAsync(const DeleteDeliveryChannelRequestT& request, const DeleteDeliveryChannelResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEvaluationResults that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEvaluationResults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEvaluationResultsRequestT = Model::DeleteEvaluationResultsRequest>
  void DeleteEvaluationResultsAsync(const DeleteEvaluationResultsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteOrganizationConfigRuleOutcome DeleteOrganizationConfigRule(
      const Model::DeleteOrganizationConfigRuleRequest& request) const;

  /**
   * A Callable wrapper for DeleteOrganizationConfigRule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteOrganizationConfigRuleRequestT = Model::DeleteOrganizationConfigRuleRequest>
  Model::DeleteOrganizationConfigRuleOutcomeCallable DeleteOrganizationConfigRuleCallable(
      const DeleteOrganizationConfigRuleRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DeleteOrganizationConfigRule, request);
  }

  /**
   * An Async wrapper for DeleteOrganizationConfigRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteOrganizationConfigRuleRequestT = Model::DeleteOrganizationConfigRuleRequest>
  void DeleteOrganizationConfigRuleAsync(const DeleteOrganizationConfigRuleRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteOrganizationConformancePackOutcome DeleteOrganizationConformancePack(
      const Model::DeleteOrganizationConformancePackRequest& request) const;

  /**
   * A Callable wrapper for DeleteOrganizationConformancePack that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteOrganizationConformancePackRequestT = Model::DeleteOrganizationConformancePackRequest>
  Model::DeleteOrganizationConformancePackOutcomeCallable DeleteOrganizationConformancePackCallable(
      const DeleteOrganizationConformancePackRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DeleteOrganizationConformancePack, request);
  }

  /**
   * An Async wrapper for DeleteOrganizationConformancePack that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteOrganizationConformancePackRequestT = Model::DeleteOrganizationConformancePackRequest>
  void DeleteOrganizationConformancePackAsync(const DeleteOrganizationConformancePackRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePendingAggregationRequestOutcome DeletePendingAggregationRequest(
      const Model::DeletePendingAggregationRequestRequest& request) const;

  /**
   * A Callable wrapper for DeletePendingAggregationRequest that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePendingAggregationRequestRequestT = Model::DeletePendingAggregationRequestRequest>
  Model::DeletePendingAggregationRequestOutcomeCallable DeletePendingAggregationRequestCallable(
      const DeletePendingAggregationRequestRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DeletePendingAggregationRequest, request);
  }

  /**
   * An Async wrapper for DeletePendingAggregationRequest that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeletePendingAggregationRequestRequestT = Model::DeletePendingAggregationRequestRequest>
  void DeletePendingAggregationRequestAsync(const DeletePendingAggregationRequestRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRemediationConfigurationOutcome DeleteRemediationConfiguration(
      const Model::DeleteRemediationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteRemediationConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRemediationConfigurationRequestT = Model::DeleteRemediationConfigurationRequest>
  Model::DeleteRemediationConfigurationOutcomeCallable DeleteRemediationConfigurationCallable(
      const DeleteRemediationConfigurationRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DeleteRemediationConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteRemediationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteRemediationConfigurationRequestT = Model::DeleteRemediationConfigurationRequest>
  void DeleteRemediationConfigurationAsync(const DeleteRemediationConfigurationRequestT& request,
  ...
  virtual Model::DeleteRemediationExceptionsOutcome DeleteRemediationExceptions(
      const Model::DeleteRemediationExceptionsRequest& request) const;

  /**
   * A Callable wrapper for DeleteRemediationExceptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRemediationExceptionsRequestT = Model::DeleteRemediationExceptionsRequest>
  Model::DeleteRemediationExceptionsOutcomeCallable DeleteRemediationExceptionsCallable(
      const DeleteRemediationExceptionsRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DeleteRemediationExceptions, request);
  }

  /**
   * An Async wrapper for DeleteRemediationExceptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRemediationExceptionsRequestT = Model::DeleteRemediationExceptionsRequest>
  void DeleteRemediationExceptionsAsync(const DeleteRemediationExceptionsRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteResourceConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteResourceConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResourceConfigRequestT = Model::DeleteResourceConfigRequest>
  void DeleteResourceConfigAsync(const DeleteResourceConfigRequestT& request, const DeleteResourceConfigResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRetentionConfigurationOutcome DeleteRetentionConfiguration(
      const Model::DeleteRetentionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteRetentionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRetentionConfigurationRequestT = Model::DeleteRetentionConfigurationRequest>
  Model::DeleteRetentionConfigurationOutcomeCallable DeleteRetentionConfigurationCallable(
      const DeleteRetentionConfigurationRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DeleteRetentionConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteRetentionConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRetentionConfigurationRequestT = Model::DeleteRetentionConfigurationRequest>
  void DeleteRetentionConfigurationAsync(const DeleteRetentionConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteServiceLinkedConfigurationRecorder that queues the request into a thread executor and triggers associated
  ...
  /**
   * A Callable wrapper for DeleteStoredQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteStoredQuery that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteStoredQueryRequestT = Model::DeleteStoredQueryRequest>
  void DeleteStoredQueryAsync(const DeleteStoredQueryRequestT& request, const DeleteStoredQueryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeliverConfigSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeliverConfigSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeliverConfigSnapshotRequestT = Model::DeliverConfigSnapshotRequest>
  void DeliverConfigSnapshotAsync(const DeliverConfigSnapshotRequestT& request, const DeliverConfigSnapshotResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeAggregateComplianceByConfigRulesOutcome DescribeAggregateComplianceByConfigRules(
      const Model::DescribeAggregateComplianceByConfigRulesRequest& request) const;

  /**
   * A Callable wrapper for DescribeAggregateComplianceByConfigRules that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeAggregateComplianceByConfigRulesRequestT = Model::DescribeAggregateComplianceByConfigRulesRequest>
  Model::DescribeAggregateComplianceByConfigRulesOutcomeCallable DescribeAggregateComplianceByConfigRulesCallable(
      const DescribeAggregateComplianceByConfigRulesRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DescribeAggregateComplianceByConfigRules, request);
  }

  /**
   * An Async wrapper for DescribeAggregateComplianceByConfigRules that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeAggregateComplianceByConfigRulesRequestT = Model::DescribeAggregateComplianceByConfigRulesRequest>
  void DescribeAggregateComplianceByConfigRulesAsync(
      const DescribeAggregateComplianceByConfigRulesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAggregateComplianceByConformancePacksOutcome DescribeAggregateComplianceByConformancePacks(
      const Model::DescribeAggregateComplianceByConformancePacksRequest& request) const;

  /**
   * A Callable wrapper for DescribeAggregateComplianceByConformancePacks that returns a future to the operation so that it can be executed
  ...
  Model::DescribeAggregateComplianceByConformancePacksOutcomeCallable DescribeAggregateComplianceByConformancePacksCallable(
      const DescribeAggregateComplianceByConformancePacksRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DescribeAggregateComplianceByConformancePacks, request);
  }

  /**
   * An Async wrapper for DescribeAggregateComplianceByConformancePacks that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DescribeAggregateComplianceByConformancePacksRequestT = Model::DescribeAggregateComplianceByConformancePacksRequest>
  void DescribeAggregateComplianceByConformancePacksAsync(
      const DescribeAggregateComplianceByConformancePacksRequestT& request,
      const DescribeAggregateComplianceByConformancePacksResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAggregationAuthorizationsOutcome DescribeAggregationAuthorizations(
      const Model::DescribeAggregationAuthorizationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAggregationAuthorizations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeAggregationAuthorizationsRequestT = Model::DescribeAggregationAuthorizationsRequest>
  Model::DescribeAggregationAuthorizationsOutcomeCallable DescribeAggregationAuthorizationsCallable(
      const DescribeAggregationAuthorizationsRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeAggregationAuthorizations, request);
  }

  /**
   * An Async wrapper for DescribeAggregationAuthorizations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAggregationAuthorizationsRequestT = Model::DescribeAggregationAuthorizationsRequest>
  void DescribeAggregationAuthorizationsAsync(const DescribeAggregationAuthorizationsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeComplianceByConfigRuleOutcome DescribeComplianceByConfigRule(
      const Model::DescribeComplianceByConfigRuleRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeComplianceByConfigRule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeComplianceByConfigRuleRequestT = Model::DescribeComplianceByConfigRuleRequest>
  Model::DescribeComplianceByConfigRuleOutcomeCallable DescribeComplianceByConfigRuleCallable(
      const DescribeComplianceByConfigRuleRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeComplianceByConfigRule, request);
  }

  /**
   * An Async wrapper for DescribeComplianceByConfigRule that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeComplianceByConfigRuleRequestT = Model::DescribeComplianceByConfigRuleRequest>
  void DescribeComplianceByConfigRuleAsync(const DescribeComplianceByConfigRuleResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const DescribeComplianceByConfigRuleRequestT& request = {}) const {
  ...
  virtual Model::DescribeComplianceByResourceOutcome DescribeComplianceByResource(
      const Model::DescribeComplianceByResourceRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeComplianceByResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeComplianceByResourceRequestT = Model::DescribeComplianceByResourceRequest>
  Model::DescribeComplianceByResourceOutcomeCallable DescribeComplianceByResourceCallable(
      const DescribeComplianceByResourceRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeComplianceByResource, request);
  }

  /**
   * An Async wrapper for DescribeComplianceByResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeComplianceByResourceRequestT = Model::DescribeComplianceByResourceRequest>
  void DescribeComplianceByResourceAsync(const DescribeComplianceByResourceResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeComplianceByResourceRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConfigRuleEvaluationStatusOutcome DescribeConfigRuleEvaluationStatus(
      const Model::DescribeConfigRuleEvaluationStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeConfigRuleEvaluationStatus that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeConfigRuleEvaluationStatusRequestT = Model::DescribeConfigRuleEvaluationStatusRequest>
  Model::DescribeConfigRuleEvaluationStatusOutcomeCallable DescribeConfigRuleEvaluationStatusCallable(
      const DescribeConfigRuleEvaluationStatusRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeConfigRuleEvaluationStatus, request);
  }

  /**
   * An Async wrapper for DescribeConfigRuleEvaluationStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeConfigRuleEvaluationStatusRequestT = Model::DescribeConfigRuleEvaluationStatusRequest>
  void DescribeConfigRuleEvaluationStatusAsync(const DescribeConfigRuleEvaluationStatusResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const DescribeConfigRuleEvaluationStatusRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeConfigRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeConfigRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeConfigRulesRequestT = Model::DescribeConfigRulesRequest>
  void DescribeConfigRulesAsync(const DescribeConfigRulesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeConfigRulesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConfigurationAggregatorSourcesStatusOutcome DescribeConfigurationAggregatorSourcesStatus(
      const Model::DescribeConfigurationAggregatorSourcesStatusRequest& request) const;

  /**
   * A Callable wrapper for DescribeConfigurationAggregatorSourcesStatus that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::DescribeConfigurationAggregatorSourcesStatusOutcomeCallable DescribeConfigurationAggregatorSourcesStatusCallable(
      const DescribeConfigurationAggregatorSourcesStatusRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DescribeConfigurationAggregatorSourcesStatus, request);
  }

  /**
   * An Async wrapper for DescribeConfigurationAggregatorSourcesStatus that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DescribeConfigurationAggregatorSourcesStatusRequestT = Model::DescribeConfigurationAggregatorSourcesStatusRequest>
  void DescribeConfigurationAggregatorSourcesStatusAsync(
      const DescribeConfigurationAggregatorSourcesStatusRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConfigurationAggregatorsOutcome DescribeConfigurationAggregators(
      const Model::DescribeConfigurationAggregatorsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeConfigurationAggregators that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeConfigurationAggregatorsRequestT = Model::DescribeConfigurationAggregatorsRequest>
  Model::DescribeConfigurationAggregatorsOutcomeCallable DescribeConfigurationAggregatorsCallable(
      const DescribeConfigurationAggregatorsRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeConfigurationAggregators, request);
  }

  /**
   * An Async wrapper for DescribeConfigurationAggregators that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeConfigurationAggregatorsRequestT = Model::DescribeConfigurationAggregatorsRequest>
  void DescribeConfigurationAggregatorsAsync(const DescribeConfigurationAggregatorsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const DescribeConfigurationAggregatorsRequestT& request = {}) const {
  ...
  virtual Model::DescribeConfigurationRecorderStatusOutcome DescribeConfigurationRecorderStatus(
      const Model::DescribeConfigurationRecorderStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeConfigurationRecorderStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeConfigurationRecorderStatusRequestT = Model::DescribeConfigurationRecorderStatusRequest>
  Model::DescribeConfigurationRecorderStatusOutcomeCallable DescribeConfigurationRecorderStatusCallable(
      const DescribeConfigurationRecorderStatusRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeConfigurationRecorderStatus, request);
  }

  /**
   * An Async wrapper for DescribeConfigurationRecorderStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeConfigurationRecorderStatusRequestT = Model::DescribeConfigurationRecorderStatusRequest>
  void DescribeConfigurationRecorderStatusAsync(const DescribeConfigurationRecorderStatusResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const DescribeConfigurationRecorderStatusRequestT& request = {}) const {
  ...
  virtual Model::DescribeConfigurationRecordersOutcome DescribeConfigurationRecorders(
      const Model::DescribeConfigurationRecordersRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeConfigurationRecorders that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeConfigurationRecordersRequestT = Model::DescribeConfigurationRecordersRequest>
  Model::DescribeConfigurationRecordersOutcomeCallable DescribeConfigurationRecordersCallable(
      const DescribeConfigurationRecordersRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeConfigurationRecorders, request);
  }

  /**
   * An Async wrapper for DescribeConfigurationRecorders that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeConfigurationRecordersRequestT = Model::DescribeConfigurationRecordersRequest>
  void DescribeConfigurationRecordersAsync(const DescribeConfigurationRecordersResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const DescribeConfigurationRecordersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConformancePackComplianceOutcome DescribeConformancePackCompliance(
      const Model::DescribeConformancePackComplianceRequest& request) const;

  /**
   * A Callable wrapper for DescribeConformancePackCompliance that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeConformancePackComplianceRequestT = Model::DescribeConformancePackComplianceRequest>
  Model::DescribeConformancePackComplianceOutcomeCallable DescribeConformancePackComplianceCallable(
      const DescribeConformancePackComplianceRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DescribeConformancePackCompliance, request);
  }

  /**
   * An Async wrapper for DescribeConformancePackCompliance that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeConformancePackComplianceRequestT = Model::DescribeConformancePackComplianceRequest>
  void DescribeConformancePackComplianceAsync(const DescribeConformancePackComplianceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConformancePackStatusOutcome DescribeConformancePackStatus(
      const Model::DescribeConformancePackStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeConformancePackStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeConformancePackStatusRequestT = Model::DescribeConformancePackStatusRequest>
  Model::DescribeConformancePackStatusOutcomeCallable DescribeConformancePackStatusCallable(
      const DescribeConformancePackStatusRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeConformancePackStatus, request);
  }

  /**
   * An Async wrapper for DescribeConformancePackStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConformancePackStatusRequestT = Model::DescribeConformancePackStatusRequest>
  void DescribeConformancePackStatusAsync(const DescribeConformancePackStatusResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeConformancePackStatusRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeConformancePacks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeConformancePacksRequestT = Model::DescribeConformancePacksRequest>
  Model::DescribeConformancePacksOutcomeCallable DescribeConformancePacksCallable(
      const DescribeConformancePacksRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeConformancePacks, request);
  }

  /**
   * An Async wrapper for DescribeConformancePacks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConformancePacksRequestT = Model::DescribeConformancePacksRequest>
  void DescribeConformancePacksAsync(const DescribeConformancePacksResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeConformancePacksRequestT& request = {}) const {
  ...
  virtual Model::DescribeDeliveryChannelStatusOutcome DescribeDeliveryChannelStatus(
      const Model::DescribeDeliveryChannelStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDeliveryChannelStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDeliveryChannelStatusRequestT = Model::DescribeDeliveryChannelStatusRequest>
  Model::DescribeDeliveryChannelStatusOutcomeCallable DescribeDeliveryChannelStatusCallable(
      const DescribeDeliveryChannelStatusRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeDeliveryChannelStatus, request);
  }

  /**
   * An Async wrapper for DescribeDeliveryChannelStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDeliveryChannelStatusRequestT = Model::DescribeDeliveryChannelStatusRequest>
  void DescribeDeliveryChannelStatusAsync(const DescribeDeliveryChannelStatusResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeDeliveryChannelStatusRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDeliveryChannels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeDeliveryChannelsRequestT = Model::DescribeDeliveryChannelsRequest>
  Model::DescribeDeliveryChannelsOutcomeCallable DescribeDeliveryChannelsCallable(
      const DescribeDeliveryChannelsRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeDeliveryChannels, request);
  }

  /**
   * An Async wrapper for DescribeDeliveryChannels that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDeliveryChannelsRequestT = Model::DescribeDeliveryChannelsRequest>
  void DescribeDeliveryChannelsAsync(const DescribeDeliveryChannelsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeDeliveryChannelsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeOrganizationConfigRuleStatusesOutcome DescribeOrganizationConfigRuleStatuses(
      const Model::DescribeOrganizationConfigRuleStatusesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeOrganizationConfigRuleStatuses that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeOrganizationConfigRuleStatusesRequestT = Model::DescribeOrganizationConfigRuleStatusesRequest>
  Model::DescribeOrganizationConfigRuleStatusesOutcomeCallable DescribeOrganizationConfigRuleStatusesCallable(
      const DescribeOrganizationConfigRuleStatusesRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeOrganizationConfigRuleStatuses, request);
  }

  /**
   * An Async wrapper for DescribeOrganizationConfigRuleStatuses that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeOrganizationConfigRuleStatusesRequestT = Model::DescribeOrganizationConfigRuleStatusesRequest>
  void DescribeOrganizationConfigRuleStatusesAsync(const DescribeOrganizationConfigRuleStatusesResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                   const DescribeOrganizationConfigRuleStatusesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeOrganizationConfigRulesOutcome DescribeOrganizationConfigRules(
      const Model::DescribeOrganizationConfigRulesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeOrganizationConfigRules that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeOrganizationConfigRulesRequestT = Model::DescribeOrganizationConfigRulesRequest>
  Model::DescribeOrganizationConfigRulesOutcomeCallable DescribeOrganizationConfigRulesCallable(
      const DescribeOrganizationConfigRulesRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeOrganizationConfigRules, request);
  }

  /**
   * An Async wrapper for DescribeOrganizationConfigRules that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeOrganizationConfigRulesRequestT = Model::DescribeOrganizationConfigRulesRequest>
  void DescribeOrganizationConfigRulesAsync(const DescribeOrganizationConfigRulesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DescribeOrganizationConfigRulesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeOrganizationConformancePackStatusesOutcome DescribeOrganizationConformancePackStatuses(
      const Model::DescribeOrganizationConformancePackStatusesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeOrganizationConformancePackStatuses that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DescribeOrganizationConformancePackStatusesOutcomeCallable DescribeOrganizationConformancePackStatusesCallable(
      const DescribeOrganizationConformancePackStatusesRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeOrganizationConformancePackStatuses, request);
  }

  /**
   * An Async wrapper for DescribeOrganizationConformancePackStatuses that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeOrganizationConformancePackStatusesRequestT = Model::DescribeOrganizationConformancePackStatusesRequest>
  void DescribeOrganizationConformancePackStatusesAsync(const DescribeOrganizationConformancePackStatusesResponseReceivedHandler& handler,
                                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                        const DescribeOrganizationConformancePackStatusesRequestT& request = {}) const {
  ...
  virtual Model::DescribeOrganizationConformancePacksOutcome DescribeOrganizationConformancePacks(
      const Model::DescribeOrganizationConformancePacksRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeOrganizationConformancePacks that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeOrganizationConformancePacksRequestT = Model::DescribeOrganizationConformancePacksRequest>
  Model::DescribeOrganizationConformancePacksOutcomeCallable DescribeOrganizationConformancePacksCallable(
      const DescribeOrganizationConformancePacksRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeOrganizationConformancePacks, request);
  }

  /**
   * An Async wrapper for DescribeOrganizationConformancePacks that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeOrganizationConformancePacksRequestT = Model::DescribeOrganizationConformancePacksRequest>
  void DescribeOrganizationConformancePacksAsync(const DescribeOrganizationConformancePacksResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const DescribeOrganizationConformancePacksRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribePendingAggregationRequestsOutcome DescribePendingAggregationRequests(
      const Model::DescribePendingAggregationRequestsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribePendingAggregationRequests that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribePendingAggregationRequestsRequestT = Model::DescribePendingAggregationRequestsRequest>
  Model::DescribePendingAggregationRequestsOutcomeCallable DescribePendingAggregationRequestsCallable(
      const DescribePendingAggregationRequestsRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribePendingAggregationRequests, request);
  }

  /**
   * An Async wrapper for DescribePendingAggregationRequests that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribePendingAggregationRequestsRequestT = Model::DescribePendingAggregationRequestsRequest>
  void DescribePendingAggregationRequestsAsync(const DescribePendingAggregationRequestsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const DescribePendingAggregationRequestsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRemediationConfigurationsOutcome DescribeRemediationConfigurations(
      const Model::DescribeRemediationConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeRemediationConfigurations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeRemediationConfigurationsRequestT = Model::DescribeRemediationConfigurationsRequest>
  Model::DescribeRemediationConfigurationsOutcomeCallable DescribeRemediationConfigurationsCallable(
      const DescribeRemediationConfigurationsRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DescribeRemediationConfigurations, request);
  }

  /**
   * An Async wrapper for DescribeRemediationConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeRemediationConfigurationsRequestT = Model::DescribeRemediationConfigurationsRequest>
  void DescribeRemediationConfigurationsAsync(const DescribeRemediationConfigurationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRemediationExceptionsOutcome DescribeRemediationExceptions(
      const Model::DescribeRemediationExceptionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeRemediationExceptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRemediationExceptionsRequestT = Model::DescribeRemediationExceptionsRequest>
  Model::DescribeRemediationExceptionsOutcomeCallable DescribeRemediationExceptionsCallable(
      const DescribeRemediationExceptionsRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DescribeRemediationExceptions, request);
  }

  /**
   * An Async wrapper for DescribeRemediationExceptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRemediationExceptionsRequestT = Model::DescribeRemediationExceptionsRequest>
  void DescribeRemediationExceptionsAsync(const DescribeRemediationExceptionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRemediationExecutionStatusOutcome DescribeRemediationExecutionStatus(
      const Model::DescribeRemediationExecutionStatusRequest& request) const;

  /**
   * A Callable wrapper for DescribeRemediationExecutionStatus that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeRemediationExecutionStatusRequestT = Model::DescribeRemediationExecutionStatusRequest>
  Model::DescribeRemediationExecutionStatusOutcomeCallable DescribeRemediationExecutionStatusCallable(
      const DescribeRemediationExecutionStatusRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DescribeRemediationExecutionStatus, request);
  }

  /**
   * An Async wrapper for DescribeRemediationExecutionStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeRemediationExecutionStatusRequestT = Model::DescribeRemediationExecutionStatusRequest>
  void DescribeRemediationExecutionStatusAsync(const DescribeRemediationExecutionStatusRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRetentionConfigurationsOutcome DescribeRetentionConfigurations(
      const Model::DescribeRetentionConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeRetentionConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRetentionConfigurationsRequestT = Model::DescribeRetentionConfigurationsRequest>
  Model::DescribeRetentionConfigurationsOutcomeCallable DescribeRetentionConfigurationsCallable(
      const DescribeRetentionConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::DescribeRetentionConfigurations, request);
  }

  /**
   * An Async wrapper for DescribeRetentionConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeRetentionConfigurationsRequestT = Model::DescribeRetentionConfigurationsRequest>
  void DescribeRetentionConfigurationsAsync(const DescribeRetentionConfigurationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DescribeRetentionConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisassociateResourceTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DisassociateResourceTypesRequestT = Model::DisassociateResourceTypesRequest>
  Model::DisassociateResourceTypesOutcomeCallable DisassociateResourceTypesCallable(
      const DisassociateResourceTypesRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::DisassociateResourceTypes, request);
  }

  /**
   * An Async wrapper for DisassociateResourceTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateResourceTypesRequestT = Model::DisassociateResourceTypesRequest>
  void DisassociateResourceTypesAsync(const DisassociateResourceTypesRequestT& request,
                                      const DisassociateResourceTypesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAggregateComplianceDetailsByConfigRuleOutcome GetAggregateComplianceDetailsByConfigRule(
      const Model::GetAggregateComplianceDetailsByConfigRuleRequest& request) const;

  /**
   * A Callable wrapper for GetAggregateComplianceDetailsByConfigRule that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::GetAggregateComplianceDetailsByConfigRuleOutcomeCallable GetAggregateComplianceDetailsByConfigRuleCallable(
      const GetAggregateComplianceDetailsByConfigRuleRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetAggregateComplianceDetailsByConfigRule, request);
  }

  /**
   * An Async wrapper for GetAggregateComplianceDetailsByConfigRule that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAggregateComplianceDetailsByConfigRuleRequestT = Model::GetAggregateComplianceDetailsByConfigRuleRequest>
  void GetAggregateComplianceDetailsByConfigRuleAsync(
      const GetAggregateComplianceDetailsByConfigRuleRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAggregateConfigRuleComplianceSummaryOutcome GetAggregateConfigRuleComplianceSummary(
      const Model::GetAggregateConfigRuleComplianceSummaryRequest& request) const;

  /**
   * A Callable wrapper for GetAggregateConfigRuleComplianceSummary that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetAggregateConfigRuleComplianceSummaryRequestT = Model::GetAggregateConfigRuleComplianceSummaryRequest>
  Model::GetAggregateConfigRuleComplianceSummaryOutcomeCallable GetAggregateConfigRuleComplianceSummaryCallable(
      const GetAggregateConfigRuleComplianceSummaryRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetAggregateConfigRuleComplianceSummary, request);
  }

  /**
   * An Async wrapper for GetAggregateConfigRuleComplianceSummary that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAggregateConfigRuleComplianceSummaryRequestT = Model::GetAggregateConfigRuleComplianceSummaryRequest>
  void GetAggregateConfigRuleComplianceSummaryAsync(const GetAggregateConfigRuleComplianceSummaryRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAggregateConformancePackComplianceSummaryOutcome GetAggregateConformancePackComplianceSummary(
      const Model::GetAggregateConformancePackComplianceSummaryRequest& request) const;

  /**
   * A Callable wrapper for GetAggregateConformancePackComplianceSummary that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::GetAggregateConformancePackComplianceSummaryOutcomeCallable GetAggregateConformancePackComplianceSummaryCallable(
      const GetAggregateConformancePackComplianceSummaryRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetAggregateConformancePackComplianceSummary, request);
  }

  /**
   * An Async wrapper for GetAggregateConformancePackComplianceSummary that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename GetAggregateConformancePackComplianceSummaryRequestT = Model::GetAggregateConformancePackComplianceSummaryRequest>
  void GetAggregateConformancePackComplianceSummaryAsync(
      const GetAggregateConformancePackComplianceSummaryRequestT& request,
      const GetAggregateConformancePackComplianceSummaryResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAggregateDiscoveredResourceCountsOutcome GetAggregateDiscoveredResourceCounts(
      const Model::GetAggregateDiscoveredResourceCountsRequest& request) const;

  /**
   * A Callable wrapper for GetAggregateDiscoveredResourceCounts that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetAggregateDiscoveredResourceCountsRequestT = Model::GetAggregateDiscoveredResourceCountsRequest>
  Model::GetAggregateDiscoveredResourceCountsOutcomeCallable GetAggregateDiscoveredResourceCountsCallable(
      const GetAggregateDiscoveredResourceCountsRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetAggregateDiscoveredResourceCounts, request);
  }

  /**
   * An Async wrapper for GetAggregateDiscoveredResourceCounts that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetAggregateDiscoveredResourceCountsRequestT = Model::GetAggregateDiscoveredResourceCountsRequest>
  void GetAggregateDiscoveredResourceCountsAsync(const GetAggregateDiscoveredResourceCountsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetAggregateResourceConfigOutcome GetAggregateResourceConfig(
      const Model::GetAggregateResourceConfigRequest& request) const;

  /**
   * A Callable wrapper for GetAggregateResourceConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetAggregateResourceConfigRequestT = Model::GetAggregateResourceConfigRequest>
  Model::GetAggregateResourceConfigOutcomeCallable GetAggregateResourceConfigCallable(
      const GetAggregateResourceConfigRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetAggregateResourceConfig, request);
  }

  /**
   * An Async wrapper for GetAggregateResourceConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAggregateResourceConfigRequestT = Model::GetAggregateResourceConfigRequest>
  void GetAggregateResourceConfigAsync(const GetAggregateResourceConfigRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetComplianceDetailsByConfigRuleOutcome GetComplianceDetailsByConfigRule(
      const Model::GetComplianceDetailsByConfigRuleRequest& request) const;

  /**
   * A Callable wrapper for GetComplianceDetailsByConfigRule that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetComplianceDetailsByConfigRuleRequestT = Model::GetComplianceDetailsByConfigRuleRequest>
  Model::GetComplianceDetailsByConfigRuleOutcomeCallable GetComplianceDetailsByConfigRuleCallable(
      const GetComplianceDetailsByConfigRuleRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetComplianceDetailsByConfigRule, request);
  }

  /**
   * An Async wrapper for GetComplianceDetailsByConfigRule that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetComplianceDetailsByConfigRuleRequestT = Model::GetComplianceDetailsByConfigRuleRequest>
  void GetComplianceDetailsByConfigRuleAsync(const GetComplianceDetailsByConfigRuleRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetComplianceDetailsByResourceOutcome GetComplianceDetailsByResource(
      const Model::GetComplianceDetailsByResourceRequest& request = {}) const;

  /**
   * A Callable wrapper for GetComplianceDetailsByResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetComplianceDetailsByResourceRequestT = Model::GetComplianceDetailsByResourceRequest>
  Model::GetComplianceDetailsByResourceOutcomeCallable GetComplianceDetailsByResourceCallable(
      const GetComplianceDetailsByResourceRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::GetComplianceDetailsByResource, request);
  }

  /**
   * An Async wrapper for GetComplianceDetailsByResource that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetComplianceDetailsByResourceRequestT = Model::GetComplianceDetailsByResourceRequest>
  void GetComplianceDetailsByResourceAsync(const GetComplianceDetailsByResourceResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const GetComplianceDetailsByResourceRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetComplianceSummaryByConfigRuleOutcome GetComplianceSummaryByConfigRule(
      const Model::GetComplianceSummaryByConfigRuleRequest& request = {}) const;

  /**
   * A Callable wrapper for GetComplianceSummaryByConfigRule that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetComplianceSummaryByConfigRuleRequestT = Model::GetComplianceSummaryByConfigRuleRequest>
  Model::GetComplianceSummaryByConfigRuleOutcomeCallable GetComplianceSummaryByConfigRuleCallable(
      const GetComplianceSummaryByConfigRuleRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::GetComplianceSummaryByConfigRule, request);
  }

  /**
   * An Async wrapper for GetComplianceSummaryByConfigRule that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetComplianceSummaryByConfigRuleRequestT = Model::GetComplianceSummaryByConfigRuleRequest>
  void GetComplianceSummaryByConfigRuleAsync(const GetComplianceSummaryByConfigRuleResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const GetComplianceSummaryByConfigRuleRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetComplianceSummaryByResourceTypeOutcome GetComplianceSummaryByResourceType(
      const Model::GetComplianceSummaryByResourceTypeRequest& request = {}) const;

  /**
   * A Callable wrapper for GetComplianceSummaryByResourceType that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetComplianceSummaryByResourceTypeRequestT = Model::GetComplianceSummaryByResourceTypeRequest>
  Model::GetComplianceSummaryByResourceTypeOutcomeCallable GetComplianceSummaryByResourceTypeCallable(
      const GetComplianceSummaryByResourceTypeRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::GetComplianceSummaryByResourceType, request);
  }

  /**
   * An Async wrapper for GetComplianceSummaryByResourceType that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetComplianceSummaryByResourceTypeRequestT = Model::GetComplianceSummaryByResourceTypeRequest>
  void GetComplianceSummaryByResourceTypeAsync(const GetComplianceSummaryByResourceTypeResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const GetComplianceSummaryByResourceTypeRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConformancePackComplianceDetailsOutcome GetConformancePackComplianceDetails(
      const Model::GetConformancePackComplianceDetailsRequest& request) const;

  /**
   * A Callable wrapper for GetConformancePackComplianceDetails that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetConformancePackComplianceDetailsRequestT = Model::GetConformancePackComplianceDetailsRequest>
  Model::GetConformancePackComplianceDetailsOutcomeCallable GetConformancePackComplianceDetailsCallable(
      const GetConformancePackComplianceDetailsRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetConformancePackComplianceDetails, request);
  }

  /**
   * An Async wrapper for GetConformancePackComplianceDetails that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetConformancePackComplianceDetailsRequestT = Model::GetConformancePackComplianceDetailsRequest>
  void GetConformancePackComplianceDetailsAsync(const GetConformancePackComplianceDetailsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConformancePackComplianceSummaryOutcome GetConformancePackComplianceSummary(
      const Model::GetConformancePackComplianceSummaryRequest& request) const;

  /**
   * A Callable wrapper for GetConformancePackComplianceSummary that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetConformancePackComplianceSummaryRequestT = Model::GetConformancePackComplianceSummaryRequest>
  Model::GetConformancePackComplianceSummaryOutcomeCallable GetConformancePackComplianceSummaryCallable(
      const GetConformancePackComplianceSummaryRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetConformancePackComplianceSummary, request);
  }

  /**
   * An Async wrapper for GetConformancePackComplianceSummary that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetConformancePackComplianceSummaryRequestT = Model::GetConformancePackComplianceSummaryRequest>
  void GetConformancePackComplianceSummaryAsync(const GetConformancePackComplianceSummaryRequestT& request,
  ...
  /**
   * A Callable wrapper for GetCustomRulePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCustomRulePolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCustomRulePolicyRequestT = Model::GetCustomRulePolicyRequest>
  void GetCustomRulePolicyAsync(const GetCustomRulePolicyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetCustomRulePolicyRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDiscoveredResourceCountsOutcome GetDiscoveredResourceCounts(
      const Model::GetDiscoveredResourceCountsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetDiscoveredResourceCounts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDiscoveredResourceCountsRequestT = Model::GetDiscoveredResourceCountsRequest>
  Model::GetDiscoveredResourceCountsOutcomeCallable GetDiscoveredResourceCountsCallable(
      const GetDiscoveredResourceCountsRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::GetDiscoveredResourceCounts, request);
  }

  /**
   * An Async wrapper for GetDiscoveredResourceCounts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDiscoveredResourceCountsRequestT = Model::GetDiscoveredResourceCountsRequest>
  void GetDiscoveredResourceCountsAsync(const GetDiscoveredResourceCountsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const GetDiscoveredResourceCountsRequestT& request = {}) const {
  ...
  virtual Model::GetOrganizationConfigRuleDetailedStatusOutcome GetOrganizationConfigRuleDetailedStatus(
      const Model::GetOrganizationConfigRuleDetailedStatusRequest& request) const;

  /**
   * A Callable wrapper for GetOrganizationConfigRuleDetailedStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetOrganizationConfigRuleDetailedStatusRequestT = Model::GetOrganizationConfigRuleDetailedStatusRequest>
  Model::GetOrganizationConfigRuleDetailedStatusOutcomeCallable GetOrganizationConfigRuleDetailedStatusCallable(
      const GetOrganizationConfigRuleDetailedStatusRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetOrganizationConfigRuleDetailedStatus, request);
  }

  /**
   * An Async wrapper for GetOrganizationConfigRuleDetailedStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetOrganizationConfigRuleDetailedStatusRequestT = Model::GetOrganizationConfigRuleDetailedStatusRequest>
  void GetOrganizationConfigRuleDetailedStatusAsync(const GetOrganizationConfigRuleDetailedStatusRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetOrganizationConformancePackDetailedStatusOutcome GetOrganizationConformancePackDetailedStatus(
      const Model::GetOrganizationConformancePackDetailedStatusRequest& request) const;

  /**
   * A Callable wrapper for GetOrganizationConformancePackDetailedStatus that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::GetOrganizationConformancePackDetailedStatusOutcomeCallable GetOrganizationConformancePackDetailedStatusCallable(
      const GetOrganizationConformancePackDetailedStatusRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetOrganizationConformancePackDetailedStatus, request);
  }

  /**
   * An Async wrapper for GetOrganizationConformancePackDetailedStatus that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename GetOrganizationConformancePackDetailedStatusRequestT = Model::GetOrganizationConformancePackDetailedStatusRequest>
  void GetOrganizationConformancePackDetailedStatusAsync(
      const GetOrganizationConformancePackDetailedStatusRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetOrganizationCustomRulePolicyOutcome GetOrganizationCustomRulePolicy(
      const Model::GetOrganizationCustomRulePolicyRequest& request) const;

  /**
   * A Callable wrapper for GetOrganizationCustomRulePolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetOrganizationCustomRulePolicyRequestT = Model::GetOrganizationCustomRulePolicyRequest>
  Model::GetOrganizationCustomRulePolicyOutcomeCallable GetOrganizationCustomRulePolicyCallable(
      const GetOrganizationCustomRulePolicyRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetOrganizationCustomRulePolicy, request);
  }

  /**
   * An Async wrapper for GetOrganizationCustomRulePolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetOrganizationCustomRulePolicyRequestT = Model::GetOrganizationCustomRulePolicyRequest>
  void GetOrganizationCustomRulePolicyAsync(const GetOrganizationCustomRulePolicyRequestT& request,
                                            const GetOrganizationCustomRulePolicyResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourceConfigHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceConfigHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResourceConfigHistoryRequestT = Model::GetResourceConfigHistoryRequest>
  void GetResourceConfigHistoryAsync(const GetResourceConfigHistoryRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetResourceEvaluationSummaryOutcome GetResourceEvaluationSummary(
      const Model::GetResourceEvaluationSummaryRequest& request) const;

  /**
   * A Callable wrapper for GetResourceEvaluationSummary that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetResourceEvaluationSummaryRequestT = Model::GetResourceEvaluationSummaryRequest>
  Model::GetResourceEvaluationSummaryOutcomeCallable GetResourceEvaluationSummaryCallable(
      const GetResourceEvaluationSummaryRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::GetResourceEvaluationSummary, request);
  }

  /**
   * An Async wrapper for GetResourceEvaluationSummary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResourceEvaluationSummaryRequestT = Model::GetResourceEvaluationSummaryRequest>
  void GetResourceEvaluationSummaryAsync(const GetResourceEvaluationSummaryRequestT& request,
                                         const GetResourceEvaluationSummaryResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetStoredQuery that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetStoredQueryRequestT = Model::GetStoredQueryRequest>
  void GetStoredQueryAsync(const GetStoredQueryRequestT& request, const GetStoredQueryResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListAggregateDiscoveredResourcesOutcome ListAggregateDiscoveredResources(
      const Model::ListAggregateDiscoveredResourcesRequest& request) const;

  /**
   * A Callable wrapper for ListAggregateDiscoveredResources that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListAggregateDiscoveredResourcesRequestT = Model::ListAggregateDiscoveredResourcesRequest>
  Model::ListAggregateDiscoveredResourcesOutcomeCallable ListAggregateDiscoveredResourcesCallable(
      const ListAggregateDiscoveredResourcesRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::ListAggregateDiscoveredResources, request);
  }

  /**
   * An Async wrapper for ListAggregateDiscoveredResources that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAggregateDiscoveredResourcesRequestT = Model::ListAggregateDiscoveredResourcesRequest>
  void ListAggregateDiscoveredResourcesAsync(const ListAggregateDiscoveredResourcesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConfigurationRecordersOutcome ListConfigurationRecorders(
      const Model::ListConfigurationRecordersRequest& request = {}) const;

  /**
   * A Callable wrapper for ListConfigurationRecorders that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListConfigurationRecordersRequestT = Model::ListConfigurationRecordersRequest>
  Model::ListConfigurationRecordersOutcomeCallable ListConfigurationRecordersCallable(
      const ListConfigurationRecordersRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::ListConfigurationRecorders, request);
  }

  /**
   * An Async wrapper for ListConfigurationRecorders that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConfigurationRecordersRequestT = Model::ListConfigurationRecordersRequest>
  void ListConfigurationRecordersAsync(const ListConfigurationRecordersResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListConfigurationRecordersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConformancePackComplianceScoresOutcome ListConformancePackComplianceScores(
      const Model::ListConformancePackComplianceScoresRequest& request = {}) const;

  /**
   * A Callable wrapper for ListConformancePackComplianceScores that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListConformancePackComplianceScoresRequestT = Model::ListConformancePackComplianceScoresRequest>
  Model::ListConformancePackComplianceScoresOutcomeCallable ListConformancePackComplianceScoresCallable(
  ...
  /**
   * An Async wrapper for ListConformancePackComplianceScores that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListConformancePackComplianceScoresRequestT = Model::ListConformancePackComplianceScoresRequest>
  void ListConformancePackComplianceScoresAsync(const ListConformancePackComplianceScoresResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const ListConformancePackComplianceScoresRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDiscoveredResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDiscoveredResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDiscoveredResourcesRequestT = Model::ListDiscoveredResourcesRequest>
  void ListDiscoveredResourcesAsync(const ListDiscoveredResourcesRequestT& request,
  ...
  /**
   * A Callable wrapper for ListResourceEvaluations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceEvaluations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceEvaluationsRequestT = Model::ListResourceEvaluationsRequest>
  void ListResourceEvaluationsAsync(const ListResourceEvaluationsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListResourceEvaluationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListStoredQueries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStoredQueries that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStoredQueriesRequestT = Model::ListStoredQueriesRequest>
  void ListStoredQueriesAsync(const ListStoredQueriesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListStoredQueriesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutAggregationAuthorizationOutcome PutAggregationAuthorization(
      const Model::PutAggregationAuthorizationRequest& request) const;

  /**
   * A Callable wrapper for PutAggregationAuthorization that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutAggregationAuthorizationRequestT = Model::PutAggregationAuthorizationRequest>
  Model::PutAggregationAuthorizationOutcomeCallable PutAggregationAuthorizationCallable(
      const PutAggregationAuthorizationRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::PutAggregationAuthorization, request);
  }

  /**
   * An Async wrapper for PutAggregationAuthorization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutAggregationAuthorizationRequestT = Model::PutAggregationAuthorizationRequest>
  void PutAggregationAuthorizationAsync(const PutAggregationAuthorizationRequestT& request,
  ...
  /**
   * An Async wrapper for PutConfigRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutConfigRuleRequestT = Model::PutConfigRuleRequest>
  void PutConfigRuleAsync(const PutConfigRuleRequestT& request, const PutConfigRuleResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutConfigurationAggregatorOutcome PutConfigurationAggregator(
      const Model::PutConfigurationAggregatorRequest& request) const;

  /**
   * A Callable wrapper for PutConfigurationAggregator that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutConfigurationAggregatorRequestT = Model::PutConfigurationAggregatorRequest>
  Model::PutConfigurationAggregatorOutcomeCallable PutConfigurationAggregatorCallable(
      const PutConfigurationAggregatorRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::PutConfigurationAggregator, request);
  }

  /**
   * An Async wrapper for PutConfigurationAggregator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutConfigurationAggregatorRequestT = Model::PutConfigurationAggregatorRequest>
  void PutConfigurationAggregatorAsync(const PutConfigurationAggregatorRequestT& request,
  ...
  /**
   * A Callable wrapper for PutConfigurationRecorder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutConfigurationRecorder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutConfigurationRecorderRequestT = Model::PutConfigurationRecorderRequest>
  void PutConfigurationRecorderAsync(const PutConfigurationRecorderRequestT& request,
  ...
  /**
   * A Callable wrapper for PutConformancePack that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutConformancePack that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutConformancePackRequestT = Model::PutConformancePackRequest>
  ...
  /**
   * A Callable wrapper for PutDeliveryChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutDeliveryChannel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutDeliveryChannelRequestT = Model::PutDeliveryChannelRequest>
  void PutDeliveryChannelAsync(const PutDeliveryChannelRequestT& request, const PutDeliveryChannelResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutEvaluations that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutEvaluationsRequestT = Model::PutEvaluationsRequest>
  void PutEvaluationsAsync(const PutEvaluationsRequestT& request, const PutEvaluationsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutExternalEvaluation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutExternalEvaluation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutExternalEvaluationRequestT = Model::PutExternalEvaluationRequest>
  void PutExternalEvaluationAsync(const PutExternalEvaluationRequestT& request, const PutExternalEvaluationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutOrganizationConfigRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename PutOrganizationConfigRuleRequestT = Model::PutOrganizationConfigRuleRequest>
  Model::PutOrganizationConfigRuleOutcomeCallable PutOrganizationConfigRuleCallable(
      const PutOrganizationConfigRuleRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::PutOrganizationConfigRule, request);
  }

  /**
   * An Async wrapper for PutOrganizationConfigRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutOrganizationConfigRuleRequestT = Model::PutOrganizationConfigRuleRequest>
  void PutOrganizationConfigRuleAsync(const PutOrganizationConfigRuleRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutOrganizationConformancePackOutcome PutOrganizationConformancePack(
      const Model::PutOrganizationConformancePackRequest& request) const;

  /**
   * A Callable wrapper for PutOrganizationConformancePack that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutOrganizationConformancePackRequestT = Model::PutOrganizationConformancePackRequest>
  Model::PutOrganizationConformancePackOutcomeCallable PutOrganizationConformancePackCallable(
      const PutOrganizationConformancePackRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::PutOrganizationConformancePack, request);
  }

  /**
   * An Async wrapper for PutOrganizationConformancePack that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutOrganizationConformancePackRequestT = Model::PutOrganizationConformancePackRequest>
  void PutOrganizationConformancePackAsync(const PutOrganizationConformancePackRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutRemediationConfigurationsOutcome PutRemediationConfigurations(
      const Model::PutRemediationConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for PutRemediationConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutRemediationConfigurationsRequestT = Model::PutRemediationConfigurationsRequest>
  Model::PutRemediationConfigurationsOutcomeCallable PutRemediationConfigurationsCallable(
      const PutRemediationConfigurationsRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::PutRemediationConfigurations, request);
  }

  /**
   * An Async wrapper for PutRemediationConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRemediationConfigurationsRequestT = Model::PutRemediationConfigurationsRequest>
  void PutRemediationConfigurationsAsync(const PutRemediationConfigurationsRequestT& request,
  ...
  /**
   * A Callable wrapper for PutRemediationExceptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutRemediationExceptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRemediationExceptionsRequestT = Model::PutRemediationExceptionsRequest>
  void PutRemediationExceptionsAsync(const PutRemediationExceptionsRequestT& request,
  ...
  /**
   * A Callable wrapper for PutResourceConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutResourceConfig that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutResourceConfigRequestT = Model::PutResourceConfigRequest>
  void PutResourceConfigAsync(const PutResourceConfigRequestT& request, const PutResourceConfigResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutRetentionConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename PutRetentionConfigurationRequestT = Model::PutRetentionConfigurationRequest>
  Model::PutRetentionConfigurationOutcomeCallable PutRetentionConfigurationCallable(
      const PutRetentionConfigurationRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::PutRetentionConfiguration, request);
  }

  /**
   * An Async wrapper for PutRetentionConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRetentionConfigurationRequestT = Model::PutRetentionConfigurationRequest>
  void PutRetentionConfigurationAsync(const PutRetentionConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutServiceLinkedConfigurationRecorderOutcome PutServiceLinkedConfigurationRecorder(
      const Model::PutServiceLinkedConfigurationRecorderRequest& request) const;

  /**
   * A Callable wrapper for PutServiceLinkedConfigurationRecorder that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutServiceLinkedConfigurationRecorderRequestT = Model::PutServiceLinkedConfigurationRecorderRequest>
  Model::PutServiceLinkedConfigurationRecorderOutcomeCallable PutServiceLinkedConfigurationRecorderCallable(
      const PutServiceLinkedConfigurationRecorderRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::PutServiceLinkedConfigurationRecorder, request);
  }

  /**
   * An Async wrapper for PutServiceLinkedConfigurationRecorder that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutServiceLinkedConfigurationRecorderRequestT = Model::PutServiceLinkedConfigurationRecorderRequest>
  void PutServiceLinkedConfigurationRecorderAsync(const PutServiceLinkedConfigurationRecorderRequestT& request,
                                                  const PutServiceLinkedConfigurationRecorderResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutStoredQuery that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutStoredQueryRequestT = Model::PutStoredQueryRequest>
  ...
  virtual Model::SelectAggregateResourceConfigOutcome SelectAggregateResourceConfig(
      const Model::SelectAggregateResourceConfigRequest& request) const;

  /**
   * A Callable wrapper for SelectAggregateResourceConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SelectAggregateResourceConfigRequestT = Model::SelectAggregateResourceConfigRequest>
  Model::SelectAggregateResourceConfigOutcomeCallable SelectAggregateResourceConfigCallable(
      const SelectAggregateResourceConfigRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::SelectAggregateResourceConfig, request);
  }

  /**
   * An Async wrapper for SelectAggregateResourceConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SelectAggregateResourceConfigRequestT = Model::SelectAggregateResourceConfigRequest>
  void SelectAggregateResourceConfigAsync(const SelectAggregateResourceConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for SelectResourceConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SelectResourceConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SelectResourceConfigRequestT = Model::SelectResourceConfigRequest>
  void SelectResourceConfigAsync(const SelectResourceConfigRequestT& request, const SelectResourceConfigResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartConfigRulesEvaluationOutcome StartConfigRulesEvaluation(
      const Model::StartConfigRulesEvaluationRequest& request = {}) const;

  /**
   * A Callable wrapper for StartConfigRulesEvaluation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartConfigRulesEvaluationRequestT = Model::StartConfigRulesEvaluationRequest>
  Model::StartConfigRulesEvaluationOutcomeCallable StartConfigRulesEvaluationCallable(
      const StartConfigRulesEvaluationRequestT& request = {}) const {
    return SubmitCallable(&ConfigServiceClient::StartConfigRulesEvaluation, request);
  }

  /**
   * An Async wrapper for StartConfigRulesEvaluation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartConfigRulesEvaluationRequestT = Model::StartConfigRulesEvaluationRequest>
  void StartConfigRulesEvaluationAsync(const StartConfigRulesEvaluationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const StartConfigRulesEvaluationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartConfigurationRecorderOutcome StartConfigurationRecorder(
      const Model::StartConfigurationRecorderRequest& request) const;

  /**
   * A Callable wrapper for StartConfigurationRecorder that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartConfigurationRecorderRequestT = Model::StartConfigurationRecorderRequest>
  Model::StartConfigurationRecorderOutcomeCallable StartConfigurationRecorderCallable(
      const StartConfigurationRecorderRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::StartConfigurationRecorder, request);
  }

  /**
   * An Async wrapper for StartConfigurationRecorder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartConfigurationRecorderRequestT = Model::StartConfigurationRecorderRequest>
  void StartConfigurationRecorderAsync(const StartConfigurationRecorderRequestT& request,
  ...
  /**
   * A Callable wrapper for StartRemediationExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartRemediationExecutionRequestT = Model::StartRemediationExecutionRequest>
  Model::StartRemediationExecutionOutcomeCallable StartRemediationExecutionCallable(
      const StartRemediationExecutionRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::StartRemediationExecution, request);
  }

  /**
   * An Async wrapper for StartRemediationExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartRemediationExecutionRequestT = Model::StartRemediationExecutionRequest>
  void StartRemediationExecutionAsync(const StartRemediationExecutionRequestT& request,
  ...
  /**
   * A Callable wrapper for StartResourceEvaluation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartResourceEvaluation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartResourceEvaluationRequestT = Model::StartResourceEvaluationRequest>
  void StartResourceEvaluationAsync(const StartResourceEvaluationRequestT& request,
                                    const StartResourceEvaluationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopConfigurationRecorder that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StopConfigurationRecorderRequestT = Model::StopConfigurationRecorderRequest>
  Model::StopConfigurationRecorderOutcomeCallable StopConfigurationRecorderCallable(
      const StopConfigurationRecorderRequestT& request) const {
    return SubmitCallable(&ConfigServiceClient::StopConfigurationRecorder, request);
  }

  /**
   * An Async wrapper for StopConfigurationRecorder that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopConfigurationRecorderRequestT = Model::StopConfigurationRecorderRequest>
  void StopConfigurationRecorderAsync(const StopConfigurationRecorderRequestT& request,
