...
class DescribeConfigurationAggregatorsResult {
 public:
  ...
  AWS_CONFIGSERVICE_API DescribeConfigurationAggregatorsResult& operator=(
  ...
  void SetConfigurationAggregators(ConfigurationAggregatorsT&& value) {
    m_configurationAggregatorsHasBeenSet = true;
    m_configurationAggregators = std::forward<ConfigurationAggregatorsT>(value);
  }
  template <typename ConfigurationAggregatorsT = Aws::Vector<ConfigurationAggregator>>
  DescribeConfigurationAggregatorsResult& WithConfigurationAggregators(ConfigurationAggregatorsT&& value) {
    SetConfigurationAggregators(std::forward<ConfigurationAggregatorsT>(value));
    return *this;
  }
  template <typename ConfigurationAggregatorsT = ConfigurationAggregator>
  DescribeConfigurationAggregatorsResult& AddConfigurationAggregators(ConfigurationAggregatorsT&& value) {
    m_configurationAggregatorsHasBeenSet = true;
    m_configurationAggregators.emplace_back(std::forward<ConfigurationAggregatorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConfigurationAggregatorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeConfigurationAggregatorsResult& WithRequestId(RequestIdT&& value) {
