...
class DescribeAggregateComplianceByConfigRulesRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConfigurationAggregatorNameT = Aws::String>
  DescribeAggregateComplianceByConfigRulesRequest& WithConfigurationAggregatorName(ConfigurationAggregatorNameT&& value) {
  ...
  template <typename FiltersT = ConfigRuleComplianceFilters>
  DescribeAggregateComplianceByConfigRulesRequest& WithFilters(FiltersT&& value) {
  ...
  inline DescribeAggregateComplianceByConfigRulesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAggregateComplianceByConfigRulesRequest& WithNextToken(NextTokenT&& value) {
