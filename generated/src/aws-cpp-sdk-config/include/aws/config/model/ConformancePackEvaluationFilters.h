...
class ConformancePackEvaluationFilters {
 public:
  ...
  template <typename ConfigRuleNamesT = Aws::Vector<Aws::String>>
  ConformancePackEvaluationFilters& WithConfigRuleNames(ConfigRuleNamesT&& value) {
    SetConfigRuleNames(std::forward<ConfigRuleNamesT>(value));
    return *this;
  }
  template <typename ConfigRuleNamesT = Aws::String>
  ConformancePackEvaluationFilters& AddConfigRuleNames(ConfigRuleNamesT&& value) {
    m_configRuleNamesHasBeenSet = true;
  ...
  inline void SetComplianceType(ConformancePackComplianceType value) {
    m_complianceTypeHasBeenSet = true;
    m_complianceType = value;
  }
  inline ConformancePackEvaluationFilters& WithComplianceType(ConformancePackComplianceType value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  ConformancePackEvaluationFilters& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceIdsT = Aws::Vector<Aws::String>>
  ConformancePackEvaluationFilters& WithResourceIds(ResourceIdsT&& value) {
    SetResourceIds(std::forward<ResourceIdsT>(value));
    return *this;
  }
  template <typename ResourceIdsT = Aws::String>
  ConformancePackEvaluationFilters& AddResourceIds(ResourceIdsT&& value) {
    m_resourceIdsHasBeenSet = true;
