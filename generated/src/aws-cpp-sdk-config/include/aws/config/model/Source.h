...
class Source {
 public:
  ...
  inline Source& WithOwner(Owner value) {
    SetOwner(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomPolicyDetails(CustomPolicyDetailsT&& value) {
    ...
    m_customPolicyDetails = std::forward<CustomPolicyDetailsT>(value);
  }
  template <typename CustomPolicyDetailsT = CustomPolicyDetails>
  Source& WithCustomPolicyDetails(CustomPolicyDetailsT&& value) {
    SetCustomPolicyDetails(std::forward<CustomPolicyDetailsT>(value));
    return *this;
  }
  ///@}
 private:
