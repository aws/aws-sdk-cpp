...
class GetConformancePackComplianceSummaryRequest : public ConfigServiceRequest {
 public:
  ...
  void SetConformancePackNames(ConformancePackNamesT&& value) {
    m_conformancePackNamesHasBeenSet = true;
    m_conformancePackNames = std::forward<ConformancePackNamesT>(value);
  }
  template <typename ConformancePackNamesT = Aws::Vector<Aws::String>>
  GetConformancePackComplianceSummaryRequest& WithConformancePackNames(ConformancePackNamesT&& value) {
    SetConformancePackNames(std::forward<ConformancePackNamesT>(value));
    return *this;
  }
  template <typename ConformancePackNamesT = Aws::String>
  GetConformancePackComplianceSummaryRequest& AddConformancePackNames(ConformancePackNamesT&& value) {
    m_conformancePackNamesHasBeenSet = true;
    m_conformancePackNames.emplace_back(std::forward<ConformancePackNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetConformancePackComplianceSummaryRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetConformancePackComplianceSummaryRequest& WithNextToken(NextTokenT&& value) {
