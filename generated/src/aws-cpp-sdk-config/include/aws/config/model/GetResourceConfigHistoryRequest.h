...
class GetResourceConfigHistoryRequest : public ConfigServiceRequest {
 public:
  ...
  inline GetResourceConfigHistoryRequest& WithResourceType(ResourceType value) {
  ...
  void SetLaterTime(LaterTimeT&& value) {
    m_laterTimeHasBeenSet = true;
    m_laterTime = std::forward<LaterTimeT>(value);
  }
  template <typename LaterTimeT = Aws::Utils::DateTime>
  GetResourceConfigHistoryRequest& WithLaterTime(LaterTimeT&& value) {
    SetLaterTime(std::forward<LaterTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEarlierTime(EarlierTimeT&& value) {
    m_earlierTimeHasBeenSet = true;
    m_earlierTime = std::forward<EarlierTimeT>(value);
  }
  template <typename EarlierTimeT = Aws::Utils::DateTime>
  GetResourceConfigHistoryRequest& WithEarlierTime(EarlierTimeT&& value) {
    SetEarlierTime(std::forward<EarlierTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetResourceConfigHistoryRequest& WithChronologicalOrder(ChronologicalOrder value) {
  ...
  inline GetResourceConfigHistoryRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
