...
class GetOrganizationConformancePackDetailedStatusRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename OrganizationConformancePackNameT = Aws::String>
  GetOrganizationConformancePackDetailedStatusRequest& WithOrganizationConformancePackName(OrganizationConformancePackNameT&& value) {
  ...
  template <typename FiltersT = OrganizationResourceDetailedStatusFilters>
  GetOrganizationConformancePackDetailedStatusRequest& WithFilters(FiltersT&& value) {
  ...
  inline GetOrganizationConformancePackDetailedStatusRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetOrganizationConformancePackDetailedStatusRequest& WithNextToken(NextTokenT&& value) {
