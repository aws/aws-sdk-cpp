...
class ConformancePackComplianceSummary {
 public:
  ...
  inline void SetConformancePackComplianceStatus(ConformancePackComplianceType value) {
    m_conformancePackComplianceStatusHasBeenSet = true;
    m_conformancePackComplianceStatus = value;
  }
  inline ConformancePackComplianceSummary& WithConformancePackComplianceStatus(ConformancePackComplianceType value) {
    SetConformancePackComplianceStatus(value);
    return *this;
  }
  ///@}
 private:
