...
class ComplianceSummary {
 public:
  ...
  void SetCompliantResourceCount(CompliantResourceCountT&& value) {
    ...
    m_compliantResourceCount = std::forward<CompliantResourceCountT>(value);
  }
  template <typename CompliantResourceCountT = ComplianceContributorCount>
  ComplianceSummary& WithCompliantResourceCount(CompliantResourceCountT&& value) {
    SetCompliantResourceCount(std::forward<CompliantResourceCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNonCompliantResourceCount(NonCompliantResourceCountT&& value) {
    ...
    m_nonCompliantResourceCount = std::forward<NonCompliantResourceCountT>(value);
  }
  template <typename NonCompliantResourceCountT = ComplianceContributorCount>
  ComplianceSummary& WithNonCompliantResourceCount(NonCompliantResourceCountT&& value) {
    SetNonCompliantResourceCount(std::forward<NonCompliantResourceCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComplianceSummaryTimestamp(ComplianceSummaryTimestampT&& value) {
    ...
    m_complianceSummaryTimestamp = std::forward<ComplianceSummaryTimestampT>(value);
  }
  template <typename ComplianceSummaryTimestampT = Aws::Utils::DateTime>
  ComplianceSummary& WithComplianceSummaryTimestamp(ComplianceSummaryTimestampT&& value) {
    SetComplianceSummaryTimestamp(std::forward<ComplianceSummaryTimestampT>(value));
    return *this;
  }
  ///@}
 private:
