...
class AggregateConformancePackComplianceFilters {
 public:
  ...
  template <typename ConformancePackNameT = Aws::String>
  AggregateConformancePackComplianceFilters& WithConformancePackName(ConformancePackNameT&& value) {
  ...
  inline AggregateConformancePackComplianceFilters& WithComplianceType(ConformancePackComplianceType value) {
  ...
  template <typename AccountIdT = Aws::String>
  AggregateConformancePackComplianceFilters& WithAccountId(AccountIdT&& value) {
  ...
  template <typename AwsRegionT = Aws::String>
  AggregateConformancePackComplianceFilters& WithAwsRegion(AwsRegionT&& value) {
