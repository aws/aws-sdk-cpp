...
namespace Model
{
  ...
  {
  public:
    AWS_CONFIGSERVICE_API SelectResourceConfigResult() = default;
    ...
    template<typename ResultsT = Aws::Vector<Aws::String>>
    SelectResourceConfigResult& WithResults(ResultsT&& value) { SetResults(std::forward<ResultsT>(value)); return *this;}
    template<typename ResultsT = Aws::String>
    SelectResourceConfigResult& AddResults(ResultsT&& value) { m_resultsHasBeenSet = true; m_results.emplace_back(std::forward<ResultsT>(value)); return *this; }
    ///@}
    ...
    template<typename QueryInfoT = QueryInfo>
    SelectResourceConfigResult& WithQueryInfo(QueryInfoT&& value) { SetQueryInfo(std::forward<QueryInfoT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    SelectResourceConfigResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SelectResourceConfigResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
