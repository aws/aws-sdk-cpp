...
class SelectResourceConfigResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<Aws::String>>
  SelectResourceConfigResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = Aws::String>
  SelectResourceConfigResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename QueryInfoT = QueryInfo>
  SelectResourceConfigResult& WithQueryInfo(QueryInfoT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  SelectResourceConfigResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SelectResourceConfigResult& WithRequestId(RequestIdT&& value) {
