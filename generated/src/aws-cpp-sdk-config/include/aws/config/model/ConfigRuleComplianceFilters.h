...
class ConfigRuleComplianceFilters {
 public:
  ...
  template <typename ConfigRuleNameT = Aws::String>
  ConfigRuleComplianceFilters& WithConfigRuleName(ConfigRuleNameT&& value) {
  ...
  inline ConfigRuleComplianceFilters& WithComplianceType(ComplianceType value) {
  ...
  template <typename AccountIdT = Aws::String>
  ConfigRuleComplianceFilters& WithAccountId(AccountIdT&& value) {
  ...
  template <typename AwsRegionT = Aws::String>
  ConfigRuleComplianceFilters& WithAwsRegion(AwsRegionT&& value) {
