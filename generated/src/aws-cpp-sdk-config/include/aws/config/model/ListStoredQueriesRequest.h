...
class ListStoredQueriesRequest : public ConfigServiceRequest {
 public:
  AWS_CONFIGSERVICE_API ListStoredQueriesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListStoredQueriesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStoredQueriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
