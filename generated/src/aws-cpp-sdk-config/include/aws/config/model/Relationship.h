...
class Relationship {
 public:
  ...
  inline Relationship& WithResourceType(ResourceType value) {
  ...
  void SetRelationshipName(RelationshipNameT&& value) {
    ...
    m_relationshipName = std::forward<RelationshipNameT>(value);
  }
  template <typename RelationshipNameT = Aws::String>
  Relationship& WithRelationshipName(RelationshipNameT&& value) {
    SetRelationshipName(std::forward<RelationshipNameT>(value));
    return *this;
  }
  ///@}
 private:
