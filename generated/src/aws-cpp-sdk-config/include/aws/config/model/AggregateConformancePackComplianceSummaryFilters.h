...
class AggregateConformancePackComplianceSummaryFilters {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  AggregateConformancePackComplianceSummaryFilters& WithAccountId(AccountIdT&& value) {
  ...
  template <typename AwsRegionT = Aws::String>
  AggregateConformancePackComplianceSummaryFilters& WithAwsRegion(AwsRegionT&& value) {
