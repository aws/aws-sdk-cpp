...
namespace Model
{
  ...
  {
  public:
    AWS_CONFIGSERVICE_API PutExternalEvaluationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutExternalEvaluationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
