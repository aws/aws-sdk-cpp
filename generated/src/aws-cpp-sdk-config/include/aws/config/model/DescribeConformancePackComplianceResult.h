...
class DescribeConformancePackComplianceResult {
 public:
  ...
  AWS_CONFIGSERVICE_API DescribeConformancePackComplianceResult& operator=(
  ...
  template <typename ConformancePackNameT = Aws::String>
  DescribeConformancePackComplianceResult& WithConformancePackName(ConformancePackNameT&& value) {
   ...
   */
  inline const Aws::Vector<ConformancePackRuleCompliance>& GetConformancePackRuleComplianceList() const {
    return m_conformancePackRuleComplianceList;
  }
  template <typename ConformancePackRuleComplianceListT = Aws::Vector<ConformancePackRuleCompliance>>
  void SetConformancePackRuleComplianceList(ConformancePackRuleComplianceListT&& value) {
    m_conformancePackRuleComplianceListHasBeenSet = true;
    m_conformancePackRuleComplianceList = std::forward<ConformancePackRuleComplianceListT>(value);
  }
  template <typename ConformancePackRuleComplianceListT = Aws::Vector<ConformancePackRuleCompliance>>
  DescribeConformancePackComplianceResult& WithConformancePackRuleComplianceList(ConformancePackRuleComplianceListT&& value) {
    SetConformancePackRuleComplianceList(std::forward<ConformancePackRuleComplianceListT>(value));
    return *this;
  }
  template <typename ConformancePackRuleComplianceListT = ConformancePackRuleCompliance>
  DescribeConformancePackComplianceResult& AddConformancePackRuleComplianceList(ConformancePackRuleComplianceListT&& value) {
    m_conformancePackRuleComplianceListHasBeenSet = true;
    m_conformancePackRuleComplianceList.emplace_back(std::forward<ConformancePackRuleComplianceListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConformancePackComplianceResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeConformancePackComplianceResult& WithRequestId(RequestIdT&& value) {
