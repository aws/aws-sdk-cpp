...
class PutOrganizationConformancePackResult {
 public:
  ...
  AWS_CONFIGSERVICE_API PutOrganizationConformancePackResult& operator=(
  ...
  template <typename OrganizationConformancePackArnT = Aws::String>
  PutOrganizationConformancePackResult& WithOrganizationConformancePackArn(OrganizationConformancePackArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutOrganizationConformancePackResult& WithRequestId(RequestIdT&& value) {
