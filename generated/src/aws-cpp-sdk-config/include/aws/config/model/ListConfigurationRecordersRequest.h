...
class ListConfigurationRecordersRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<ConfigurationRecorderFilter>>
  ListConfigurationRecordersRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ConfigurationRecorderFilter>
  ListConfigurationRecordersRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListConfigurationRecordersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationRecordersRequest& WithNextToken(NextTokenT&& value) {
