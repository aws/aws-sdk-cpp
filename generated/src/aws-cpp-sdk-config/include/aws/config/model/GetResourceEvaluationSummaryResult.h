...
class GetResourceEvaluationSummaryResult {
 public:
  ...
  AWS_CONFIGSERVICE_API GetResourceEvaluationSummaryResult& operator=(
  ...
  inline GetResourceEvaluationSummaryResult& WithEvaluationMode(EvaluationMode value) {
  ...
  void SetEvaluationStatus(EvaluationStatusT&& value) {
    ...
    m_evaluationStatus = std::forward<EvaluationStatusT>(value);
  }
  template <typename EvaluationStatusT = EvaluationStatus>
  GetResourceEvaluationSummaryResult& WithEvaluationStatus(EvaluationStatusT&& value) {
    SetEvaluationStatus(std::forward<EvaluationStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCompliance(ComplianceType value) {
    m_complianceHasBeenSet = true;
    m_compliance = value;
  }
  inline GetResourceEvaluationSummaryResult& WithCompliance(ComplianceType value) {
    SetCompliance(value);
    return *this;
  }
  ///@}
