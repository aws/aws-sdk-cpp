...
class AssociateResourceTypesRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConfigurationRecorderArnT = Aws::String>
  AssociateResourceTypesRequest& WithConfigurationRecorderArn(ConfigurationRecorderArnT&& value) {
  ...
  template <typename ResourceTypesT = Aws::Vector<ResourceType>>
  AssociateResourceTypesRequest& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  inline AssociateResourceTypesRequest& AddResourceTypes(ResourceType value) {
    m_resourceTypesHasBeenSet = true;
