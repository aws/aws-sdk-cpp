...
class ResourceDetails {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  ResourceDetails& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  ResourceDetails& WithResourceType(ResourceTypeT&& value) {
  ...
  void SetResourceConfiguration(ResourceConfigurationT&& value) {
    ...
    m_resourceConfiguration = std::forward<ResourceConfigurationT>(value);
  }
  template <typename ResourceConfigurationT = Aws::String>
  ResourceDetails& WithResourceConfiguration(ResourceConfigurationT&& value) {
    SetResourceConfiguration(std::forward<ResourceConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetResourceConfigurationSchemaType(ResourceConfigurationSchemaType value) {
    m_resourceConfigurationSchemaTypeHasBeenSet = true;
    m_resourceConfigurationSchemaType = value;
  }
  inline ResourceDetails& WithResourceConfigurationSchemaType(ResourceConfigurationSchemaType value) {
    SetResourceConfigurationSchemaType(value);
    return *this;
  }
  ///@}
 private:
