...
class DeletePendingAggregationRequestRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename RequesterAccountIdT = Aws::String>
  DeletePendingAggregationRequestRequest& WithRequesterAccountId(RequesterAccountIdT&& value) {
  ...
  template <typename RequesterAwsRegionT = Aws::String>
  DeletePendingAggregationRequestRequest& WithRequesterAwsRegion(RequesterAwsRegionT&& value) {
