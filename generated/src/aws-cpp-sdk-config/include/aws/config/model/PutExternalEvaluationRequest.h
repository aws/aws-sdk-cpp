...
class PutExternalEvaluationRequest : public ConfigServiceRequest {
 public:
  ...
  void SetExternalEvaluation(ExternalEvaluationT&& value) {
    m_externalEvaluationHasBeenSet = true;
    m_externalEvaluation = std::forward<ExternalEvaluationT>(value);
  }
  template <typename ExternalEvaluationT = ExternalEvaluation>
  PutExternalEvaluationRequest& WithExternalEvaluation(ExternalEvaluationT&& value) {
    SetExternalEvaluation(std::forward<ExternalEvaluationT>(value));
    return *this;
  }
  ///@}
 private:
