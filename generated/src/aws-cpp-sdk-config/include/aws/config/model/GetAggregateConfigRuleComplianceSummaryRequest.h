...
class GetAggregateConfigRuleComplianceSummaryRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConfigurationAggregatorNameT = Aws::String>
  GetAggregateConfigRuleComplianceSummaryRequest& WithConfigurationAggregatorName(ConfigurationAggregatorNameT&& value) {
  ...
  template <typename FiltersT = ConfigRuleComplianceSummaryFilters>
  GetAggregateConfigRuleComplianceSummaryRequest& WithFilters(FiltersT&& value) {
  ...
  inline void SetGroupByKey(ConfigRuleComplianceSummaryGroupKey value) {
    m_groupByKeyHasBeenSet = true;
    m_groupByKey = value;
  }
  inline GetAggregateConfigRuleComplianceSummaryRequest& WithGroupByKey(ConfigRuleComplianceSummaryGroupKey value) {
    SetGroupByKey(value);
    return *this;
  }
  ///@}
  ...
  inline GetAggregateConfigRuleComplianceSummaryRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetAggregateConfigRuleComplianceSummaryRequest& WithNextToken(NextTokenT&& value) {
