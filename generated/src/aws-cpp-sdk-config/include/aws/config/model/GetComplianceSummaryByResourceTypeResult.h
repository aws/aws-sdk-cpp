...
class GetComplianceSummaryByResourceTypeResult {
 public:
  ...
  AWS_CONFIGSERVICE_API GetComplianceSummaryByResourceTypeResult& operator=(
   ...
   * 100.</p>
   */
  inline const Aws::Vector<ComplianceSummaryByResourceType>& GetComplianceSummariesByResourceType() const {
    return m_complianceSummariesByResourceType;
  }
  template <typename ComplianceSummariesByResourceTypeT = Aws::Vector<ComplianceSummaryByResourceType>>
  void SetComplianceSummariesByResourceType(ComplianceSummariesByResourceTypeT&& value) {
    m_complianceSummariesByResourceTypeHasBeenSet = true;
    m_complianceSummariesByResourceType = std::forward<ComplianceSummariesByResourceTypeT>(value);
  }
  template <typename ComplianceSummariesByResourceTypeT = Aws::Vector<ComplianceSummaryByResourceType>>
  GetComplianceSummaryByResourceTypeResult& WithComplianceSummariesByResourceType(ComplianceSummariesByResourceTypeT&& value) {
    SetComplianceSummariesByResourceType(std::forward<ComplianceSummariesByResourceTypeT>(value));
    return *this;
  }
  template <typename ComplianceSummariesByResourceTypeT = ComplianceSummaryByResourceType>
  GetComplianceSummaryByResourceTypeResult& AddComplianceSummariesByResourceType(ComplianceSummariesByResourceTypeT&& value) {
    m_complianceSummariesByResourceTypeHasBeenSet = true;
    m_complianceSummariesByResourceType.emplace_back(std::forward<ComplianceSummariesByResourceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetComplianceSummaryByResourceTypeResult& WithRequestId(RequestIdT&& value) {
