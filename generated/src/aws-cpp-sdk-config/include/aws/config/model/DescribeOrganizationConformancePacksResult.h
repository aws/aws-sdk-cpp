...
class DescribeOrganizationConformancePacksResult {
 public:
  ...
  AWS_CONFIGSERVICE_API DescribeOrganizationConformancePacksResult& operator=(
  ...
  void SetOrganizationConformancePacks(OrganizationConformancePacksT&& value) {
    m_organizationConformancePacksHasBeenSet = true;
    m_organizationConformancePacks = std::forward<OrganizationConformancePacksT>(value);
  }
  template <typename OrganizationConformancePacksT = Aws::Vector<OrganizationConformancePack>>
  DescribeOrganizationConformancePacksResult& WithOrganizationConformancePacks(OrganizationConformancePacksT&& value) {
    SetOrganizationConformancePacks(std::forward<OrganizationConformancePacksT>(value));
    return *this;
  }
  template <typename OrganizationConformancePacksT = OrganizationConformancePack>
  DescribeOrganizationConformancePacksResult& AddOrganizationConformancePacks(OrganizationConformancePacksT&& value) {
    m_organizationConformancePacksHasBeenSet = true;
    m_organizationConformancePacks.emplace_back(std::forward<OrganizationConformancePacksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeOrganizationConformancePacksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeOrganizationConformancePacksResult& WithRequestId(RequestIdT&& value) {
