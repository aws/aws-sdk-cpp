...
class GetDiscoveredResourceCountsResult {
 public:
  ...
  AWS_CONFIGSERVICE_API GetDiscoveredResourceCountsResult& operator=(
  ...
  inline GetDiscoveredResourceCountsResult& WithTotalDiscoveredResources(long long value) {
  ...
  void SetResourceCounts(ResourceCountsT&& value) {
    m_resourceCountsHasBeenSet = true;
    m_resourceCounts = std::forward<ResourceCountsT>(value);
  }
  template <typename ResourceCountsT = Aws::Vector<ResourceCount>>
  GetDiscoveredResourceCountsResult& WithResourceCounts(ResourceCountsT&& value) {
    SetResourceCounts(std::forward<ResourceCountsT>(value));
    return *this;
  }
  template <typename ResourceCountsT = ResourceCount>
  GetDiscoveredResourceCountsResult& AddResourceCounts(ResourceCountsT&& value) {
    m_resourceCountsHasBeenSet = true;
    m_resourceCounts.emplace_back(std::forward<ResourceCountsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetDiscoveredResourceCountsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDiscoveredResourceCountsResult& WithRequestId(RequestIdT&& value) {
