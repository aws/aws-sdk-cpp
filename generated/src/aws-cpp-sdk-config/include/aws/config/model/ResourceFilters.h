...
class ResourceFilters {
 public:
  AWS_CONFIGSERVICE_API ResourceFilters() = default;
  ...
  template <typename AccountIdT = Aws::String>
  ResourceFilters& WithAccountId(AccountIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  ResourceFilters& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  ResourceFilters& WithResourceName(ResourceNameT&& value) {
  ...
  template <typename RegionT = Aws::String>
  ResourceFilters& WithRegion(RegionT&& value) {
