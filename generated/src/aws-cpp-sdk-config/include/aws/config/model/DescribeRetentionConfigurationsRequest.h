...
class DescribeRetentionConfigurationsRequest : public ConfigServiceRequest {
 public:
  ...
  void SetRetentionConfigurationNames(RetentionConfigurationNamesT&& value) {
    m_retentionConfigurationNamesHasBeenSet = true;
    m_retentionConfigurationNames = std::forward<RetentionConfigurationNamesT>(value);
  }
  template <typename RetentionConfigurationNamesT = Aws::Vector<Aws::String>>
  DescribeRetentionConfigurationsRequest& WithRetentionConfigurationNames(RetentionConfigurationNamesT&& value) {
    SetRetentionConfigurationNames(std::forward<RetentionConfigurationNamesT>(value));
    return *this;
  }
  ...
  DescribeRetentionConfigurationsRequest& AddRetentionConfigurationNames(RetentionConfigurationNamesT&& value) {
    m_retentionConfigurationNamesHasBeenSet = true;
    m_retentionConfigurationNames.emplace_back(std::forward<RetentionConfigurationNamesT>(value));
    return *this;
  }
  ///@}
