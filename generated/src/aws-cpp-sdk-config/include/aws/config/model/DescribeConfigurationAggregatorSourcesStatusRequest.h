...
class DescribeConfigurationAggregatorSourcesStatusRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConfigurationAggregatorNameT = Aws::String>
  DescribeConfigurationAggregatorSourcesStatusRequest& WithConfigurationAggregatorName(ConfigurationAggregatorNameT&& value) {
  ...
  template <typename UpdateStatusT = Aws::Vector<AggregatedSourceStatusType>>
  DescribeConfigurationAggregatorSourcesStatusRequest& WithUpdateStatus(UpdateStatusT&& value) {
    SetUpdateStatus(std::forward<UpdateStatusT>(value));
    return *this;
  }
  inline DescribeConfigurationAggregatorSourcesStatusRequest& AddUpdateStatus(AggregatedSourceStatusType value) {
    m_updateStatusHasBeenSet = true;
    m_updateStatus.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConfigurationAggregatorSourcesStatusRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeConfigurationAggregatorSourcesStatusRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
