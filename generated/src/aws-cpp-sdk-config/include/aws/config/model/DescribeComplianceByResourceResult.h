...
class DescribeComplianceByResourceResult {
 public:
  ...
  AWS_CONFIGSERVICE_API DescribeComplianceByResourceResult& operator=(
  ...
  void SetComplianceByResources(ComplianceByResourcesT&& value) {
    m_complianceByResourcesHasBeenSet = true;
    m_complianceByResources = std::forward<ComplianceByResourcesT>(value);
  }
  template <typename ComplianceByResourcesT = Aws::Vector<ComplianceByResource>>
  DescribeComplianceByResourceResult& WithComplianceByResources(ComplianceByResourcesT&& value) {
    SetComplianceByResources(std::forward<ComplianceByResourcesT>(value));
    return *this;
  }
  template <typename ComplianceByResourcesT = ComplianceByResource>
  DescribeComplianceByResourceResult& AddComplianceByResources(ComplianceByResourcesT&& value) {
    m_complianceByResourcesHasBeenSet = true;
    m_complianceByResources.emplace_back(std::forward<ComplianceByResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeComplianceByResourceResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeComplianceByResourceResult& WithRequestId(RequestIdT&& value) {
