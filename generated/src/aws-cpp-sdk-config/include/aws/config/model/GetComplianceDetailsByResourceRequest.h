...
class GetComplianceDetailsByResourceRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ResourceTypeT = Aws::String>
  GetComplianceDetailsByResourceRequest& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  GetComplianceDetailsByResourceRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename ComplianceTypesT = Aws::Vector<ComplianceType>>
  GetComplianceDetailsByResourceRequest& WithComplianceTypes(ComplianceTypesT&& value) {
    SetComplianceTypes(std::forward<ComplianceTypesT>(value));
    return *this;
  }
  inline GetComplianceDetailsByResourceRequest& AddComplianceTypes(ComplianceType value) {
    m_complianceTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetComplianceDetailsByResourceRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResourceEvaluationIdT = Aws::String>
  GetComplianceDetailsByResourceRequest& WithResourceEvaluationId(ResourceEvaluationIdT&& value) {
