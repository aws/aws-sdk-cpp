...
class ConfigurationItem {
 public:
  ...
  inline ConfigurationItem& WithConfigurationItemStatus(ConfigurationItemStatus value) {
  ...
  void SetConfigurationItemMD5Hash(ConfigurationItemMD5HashT&& value) {
    ...
    m_configurationItemMD5Hash = std::forward<ConfigurationItemMD5HashT>(value);
  }
  template <typename ConfigurationItemMD5HashT = Aws::String>
  ConfigurationItem& WithConfigurationItemMD5Hash(ConfigurationItemMD5HashT&& value) {
    SetConfigurationItemMD5Hash(std::forward<ConfigurationItemMD5HashT>(value));
    return *this;
  }
  ///@}
  ...
  inline ConfigurationItem& WithResourceType(ResourceType value) {
  ...
  inline ConfigurationItem& WithRecordingFrequency(RecordingFrequency value) {
