...
class GetComplianceSummaryByConfigRuleResult {
 public:
  ...
  AWS_CONFIGSERVICE_API GetComplianceSummaryByConfigRuleResult& operator=(
  ...
  template <typename ComplianceSummaryT = ComplianceSummary>
  GetComplianceSummaryByConfigRuleResult& WithComplianceSummary(ComplianceSummaryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetComplianceSummaryByConfigRuleResult& WithRequestId(RequestIdT&& value) {
