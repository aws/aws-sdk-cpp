...
class GetConformancePackComplianceDetailsRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConformancePackNameT = Aws::String>
  GetConformancePackComplianceDetailsRequest& WithConformancePackName(ConformancePackNameT&& value) {
  ...
  template <typename FiltersT = ConformancePackEvaluationFilters>
  GetConformancePackComplianceDetailsRequest& WithFilters(FiltersT&& value) {
  ...
  inline GetConformancePackComplianceDetailsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetConformancePackComplianceDetailsRequest& WithNextToken(NextTokenT&& value) {
