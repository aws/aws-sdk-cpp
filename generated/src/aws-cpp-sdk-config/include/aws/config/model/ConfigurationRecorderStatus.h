...
class ConfigurationRecorderStatus {
 public:
  ...
  void SetLastStopTime(LastStopTimeT&& value) {
    ...
    m_lastStopTime = std::forward<LastStopTimeT>(value);
  }
  template <typename LastStopTimeT = Aws::Utils::DateTime>
  ConfigurationRecorderStatus& WithLastStopTime(LastStopTimeT&& value) {
    SetLastStopTime(std::forward<LastStopTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRecording(bool value) {
    m_recordingHasBeenSet = true;
    m_recording = value;
  }
  inline ConfigurationRecorderStatus& WithRecording(bool value) {
    SetRecording(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLastStatus(RecorderStatus value) {
    m_lastStatusHasBeenSet = true;
    m_lastStatus = value;
  }
  inline ConfigurationRecorderStatus& WithLastStatus(RecorderStatus value) {
    SetLastStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastErrorCode(LastErrorCodeT&& value) {
    ...
    m_lastErrorCode = std::forward<LastErrorCodeT>(value);
  }
  template <typename LastErrorCodeT = Aws::String>
  ConfigurationRecorderStatus& WithLastErrorCode(LastErrorCodeT&& value) {
    SetLastErrorCode(std::forward<LastErrorCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastErrorMessage(LastErrorMessageT&& value) {
    ...
    m_lastErrorMessage = std::forward<LastErrorMessageT>(value);
  }
  template <typename LastErrorMessageT = Aws::String>
  ConfigurationRecorderStatus& WithLastErrorMessage(LastErrorMessageT&& value) {
    SetLastErrorMessage(std::forward<LastErrorMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastStatusChangeTime(LastStatusChangeTimeT&& value) {
    ...
    m_lastStatusChangeTime = std::forward<LastStatusChangeTimeT>(value);
  }
  template <typename LastStatusChangeTimeT = Aws::Utils::DateTime>
  ConfigurationRecorderStatus& WithLastStatusChangeTime(LastStatusChangeTimeT&& value) {
    SetLastStatusChangeTime(std::forward<LastStatusChangeTimeT>(value));
    return *this;
  }
  ///@}
