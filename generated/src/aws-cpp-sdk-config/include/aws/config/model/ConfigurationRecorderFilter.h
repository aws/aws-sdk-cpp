...
class ConfigurationRecorderFilter {
 public:
  ...
  inline void SetFilterName(ConfigurationRecorderFilterName value) {
    m_filterNameHasBeenSet = true;
    m_filterName = value;
  }
  inline ConfigurationRecorderFilter& WithFilterName(ConfigurationRecorderFilterName value) {
    SetFilterName(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterValueT = Aws::Vector<Aws::String>>
  ConfigurationRecorderFilter& WithFilterValue(FilterValueT&& value) {
    SetFilterValue(std::forward<FilterValueT>(value));
    return *this;
  }
  template <typename FilterValueT = Aws::String>
  ConfigurationRecorderFilter& AddFilterValue(FilterValueT&& value) {
    m_filterValueHasBeenSet = true;
    m_filterValue.emplace_back(std::forward<FilterValueT>(value));
    return *this;
  }
  ///@}
 private:
