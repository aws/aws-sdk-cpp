...
class DescribeRetentionConfigurationsResult {
 public:
  ...
  AWS_CONFIGSERVICE_API DescribeRetentionConfigurationsResult& operator=(
  ...
  void SetRetentionConfigurations(RetentionConfigurationsT&& value) {
    m_retentionConfigurationsHasBeenSet = true;
    m_retentionConfigurations = std::forward<RetentionConfigurationsT>(value);
  }
  template <typename RetentionConfigurationsT = Aws::Vector<RetentionConfiguration>>
  DescribeRetentionConfigurationsResult& WithRetentionConfigurations(RetentionConfigurationsT&& value) {
    SetRetentionConfigurations(std::forward<RetentionConfigurationsT>(value));
    return *this;
  }
  template <typename RetentionConfigurationsT = RetentionConfiguration>
  DescribeRetentionConfigurationsResult& AddRetentionConfigurations(RetentionConfigurationsT&& value) {
    m_retentionConfigurationsHasBeenSet = true;
    m_retentionConfigurations.emplace_back(std::forward<RetentionConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRetentionConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRetentionConfigurationsResult& WithRequestId(RequestIdT&& value) {
