...
class DescribeDeliveryChannelsRequest : public ConfigServiceRequest {
 public:
  ...
  void SetDeliveryChannelNames(DeliveryChannelNamesT&& value) {
    m_deliveryChannelNamesHasBeenSet = true;
    m_deliveryChannelNames = std::forward<DeliveryChannelNamesT>(value);
  }
  template <typename DeliveryChannelNamesT = Aws::Vector<Aws::String>>
  DescribeDeliveryChannelsRequest& WithDeliveryChannelNames(DeliveryChannelNamesT&& value) {
    SetDeliveryChannelNames(std::forward<DeliveryChannelNamesT>(value));
    return *this;
  }
  ...
  DescribeDeliveryChannelsRequest& AddDeliveryChannelNames(DeliveryChannelNamesT&& value) {
    m_deliveryChannelNamesHasBeenSet = true;
    m_deliveryChannelNames.emplace_back(std::forward<DeliveryChannelNamesT>(value));
    return *this;
  }
  ///@}
 private:
