...
class ListConfigurationRecordersResult {
 public:
   ...
   * includes.</p>
   */
  inline const Aws::Vector<ConfigurationRecorderSummary>& GetConfigurationRecorderSummaries() const {
    return m_configurationRecorderSummaries;
  }
  template <typename ConfigurationRecorderSummariesT = Aws::Vector<ConfigurationRecorderSummary>>
  void SetConfigurationRecorderSummaries(ConfigurationRecorderSummariesT&& value) {
    m_configurationRecorderSummariesHasBeenSet = true;
    m_configurationRecorderSummaries = std::forward<ConfigurationRecorderSummariesT>(value);
  }
  template <typename ConfigurationRecorderSummariesT = Aws::Vector<ConfigurationRecorderSummary>>
  ListConfigurationRecordersResult& WithConfigurationRecorderSummaries(ConfigurationRecorderSummariesT&& value) {
    SetConfigurationRecorderSummaries(std::forward<ConfigurationRecorderSummariesT>(value));
    return *this;
  }
  template <typename ConfigurationRecorderSummariesT = ConfigurationRecorderSummary>
  ListConfigurationRecordersResult& AddConfigurationRecorderSummaries(ConfigurationRecorderSummariesT&& value) {
    m_configurationRecorderSummariesHasBeenSet = true;
    m_configurationRecorderSummaries.emplace_back(std::forward<ConfigurationRecorderSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationRecordersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConfigurationRecordersResult& WithRequestId(RequestIdT&& value) {
