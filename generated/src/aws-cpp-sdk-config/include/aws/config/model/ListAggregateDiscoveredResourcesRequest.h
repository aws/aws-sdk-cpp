...
class ListAggregateDiscoveredResourcesRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConfigurationAggregatorNameT = Aws::String>
  ListAggregateDiscoveredResourcesRequest& WithConfigurationAggregatorName(ConfigurationAggregatorNameT&& value) {
  ...
  inline ListAggregateDiscoveredResourcesRequest& WithResourceType(ResourceType value) {
  ...
  template <typename FiltersT = ResourceFilters>
  ListAggregateDiscoveredResourcesRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListAggregateDiscoveredResourcesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAggregateDiscoveredResourcesRequest& WithNextToken(NextTokenT&& value) {
