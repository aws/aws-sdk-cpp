...
class GetOrganizationCustomRulePolicyResult {
 public:
  ...
  AWS_CONFIGSERVICE_API GetOrganizationCustomRulePolicyResult& operator=(
  ...
  template <typename PolicyTextT = Aws::String>
  GetOrganizationCustomRulePolicyResult& WithPolicyText(PolicyTextT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOrganizationCustomRulePolicyResult& WithRequestId(RequestIdT&& value) {
