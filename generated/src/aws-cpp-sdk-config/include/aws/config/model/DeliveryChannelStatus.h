...
class DeliveryChannelStatus {
 public:
  ...
  void SetConfigSnapshotDeliveryInfo(ConfigSnapshotDeliveryInfoT&& value) {
    ...
    m_configSnapshotDeliveryInfo = std::forward<ConfigSnapshotDeliveryInfoT>(value);
  }
  template <typename ConfigSnapshotDeliveryInfoT = ConfigExportDeliveryInfo>
  DeliveryChannelStatus& WithConfigSnapshotDeliveryInfo(ConfigSnapshotDeliveryInfoT&& value) {
    SetConfigSnapshotDeliveryInfo(std::forward<ConfigSnapshotDeliveryInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfigHistoryDeliveryInfo(ConfigHistoryDeliveryInfoT&& value) {
    ...
    m_configHistoryDeliveryInfo = std::forward<ConfigHistoryDeliveryInfoT>(value);
  }
  template <typename ConfigHistoryDeliveryInfoT = ConfigExportDeliveryInfo>
  DeliveryChannelStatus& WithConfigHistoryDeliveryInfo(ConfigHistoryDeliveryInfoT&& value) {
    SetConfigHistoryDeliveryInfo(std::forward<ConfigHistoryDeliveryInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfigStreamDeliveryInfo(ConfigStreamDeliveryInfoT&& value) {
    ...
    m_configStreamDeliveryInfo = std::forward<ConfigStreamDeliveryInfoT>(value);
  }
  template <typename ConfigStreamDeliveryInfoT = ConfigStreamDeliveryInfo>
  DeliveryChannelStatus& WithConfigStreamDeliveryInfo(ConfigStreamDeliveryInfoT&& value) {
    SetConfigStreamDeliveryInfo(std::forward<ConfigStreamDeliveryInfoT>(value));
    return *this;
  }
  ///@}
 private:
