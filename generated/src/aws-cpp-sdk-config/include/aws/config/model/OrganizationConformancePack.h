...
class OrganizationConformancePack {
 public:
  ...
  void SetOrganizationConformancePackArn(OrganizationConformancePackArnT&& value) {
    ...
    m_organizationConformancePackArn = std::forward<OrganizationConformancePackArnT>(value);
  }
  template <typename OrganizationConformancePackArnT = Aws::String>
  OrganizationConformancePack& WithOrganizationConformancePackArn(OrganizationConformancePackArnT&& value) {
    SetOrganizationConformancePackArn(std::forward<OrganizationConformancePackArnT>(value));
    return *this;
  }
  ///@}
