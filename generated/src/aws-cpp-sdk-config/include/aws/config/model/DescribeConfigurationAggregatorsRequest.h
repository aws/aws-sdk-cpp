...
class DescribeConfigurationAggregatorsRequest : public ConfigServiceRequest {
 public:
  ...
  void SetConfigurationAggregatorNames(ConfigurationAggregatorNamesT&& value) {
    m_configurationAggregatorNamesHasBeenSet = true;
    m_configurationAggregatorNames = std::forward<ConfigurationAggregatorNamesT>(value);
  }
  template <typename ConfigurationAggregatorNamesT = Aws::Vector<Aws::String>>
  DescribeConfigurationAggregatorsRequest& WithConfigurationAggregatorNames(ConfigurationAggregatorNamesT&& value) {
    SetConfigurationAggregatorNames(std::forward<ConfigurationAggregatorNamesT>(value));
    return *this;
  }
  ...
  DescribeConfigurationAggregatorsRequest& AddConfigurationAggregatorNames(ConfigurationAggregatorNamesT&& value) {
    m_configurationAggregatorNamesHasBeenSet = true;
    m_configurationAggregatorNames.emplace_back(std::forward<ConfigurationAggregatorNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeConfigurationAggregatorsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
