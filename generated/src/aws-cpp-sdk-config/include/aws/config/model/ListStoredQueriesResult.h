...
class ListStoredQueriesResult {
 public:
  ...
  void SetStoredQueryMetadata(StoredQueryMetadataT&& value) {
    m_storedQueryMetadataHasBeenSet = true;
    m_storedQueryMetadata = std::forward<StoredQueryMetadataT>(value);
  }
  template <typename StoredQueryMetadataT = Aws::Vector<StoredQueryMetadata>>
  ListStoredQueriesResult& WithStoredQueryMetadata(StoredQueryMetadataT&& value) {
    SetStoredQueryMetadata(std::forward<StoredQueryMetadataT>(value));
    return *this;
  }
  template <typename StoredQueryMetadataT = StoredQueryMetadata>
  ListStoredQueriesResult& AddStoredQueryMetadata(StoredQueryMetadataT&& value) {
    m_storedQueryMetadataHasBeenSet = true;
    m_storedQueryMetadata.emplace_back(std::forward<StoredQueryMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListStoredQueriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStoredQueriesResult& WithRequestId(RequestIdT&& value) {
