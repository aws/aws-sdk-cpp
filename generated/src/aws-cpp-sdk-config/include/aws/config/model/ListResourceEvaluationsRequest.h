...
class ListResourceEvaluationsRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename FiltersT = ResourceEvaluationFilters>
  ListResourceEvaluationsRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListResourceEvaluationsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceEvaluationsRequest& WithNextToken(NextTokenT&& value) {
