...
class PutEvaluationsResult {
 public:
  ...
  void SetFailedEvaluations(FailedEvaluationsT&& value) {
    m_failedEvaluationsHasBeenSet = true;
    m_failedEvaluations = std::forward<FailedEvaluationsT>(value);
  }
  template <typename FailedEvaluationsT = Aws::Vector<Evaluation>>
  PutEvaluationsResult& WithFailedEvaluations(FailedEvaluationsT&& value) {
    SetFailedEvaluations(std::forward<FailedEvaluationsT>(value));
    return *this;
  }
  template <typename FailedEvaluationsT = Evaluation>
  PutEvaluationsResult& AddFailedEvaluations(FailedEvaluationsT&& value) {
    m_failedEvaluationsHasBeenSet = true;
    m_failedEvaluations.emplace_back(std::forward<FailedEvaluationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutEvaluationsResult& WithRequestId(RequestIdT&& value) {
