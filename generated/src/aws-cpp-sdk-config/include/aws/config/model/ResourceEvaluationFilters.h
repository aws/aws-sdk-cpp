...
class ResourceEvaluationFilters {
 public:
  ...
  inline ResourceEvaluationFilters& WithEvaluationMode(EvaluationMode value) {
  ...
  template <typename TimeWindowT = TimeWindow>
  ResourceEvaluationFilters& WithTimeWindow(TimeWindowT&& value) {
  ...
  void SetEvaluationContextIdentifier(EvaluationContextIdentifierT&& value) {
    ...
    m_evaluationContextIdentifier = std::forward<EvaluationContextIdentifierT>(value);
  }
  template <typename EvaluationContextIdentifierT = Aws::String>
  ResourceEvaluationFilters& WithEvaluationContextIdentifier(EvaluationContextIdentifierT&& value) {
    SetEvaluationContextIdentifier(std::forward<EvaluationContextIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
