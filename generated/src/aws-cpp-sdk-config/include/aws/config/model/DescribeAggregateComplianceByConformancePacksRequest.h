...
class DescribeAggregateComplianceByConformancePacksRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConfigurationAggregatorNameT = Aws::String>
  DescribeAggregateComplianceByConformancePacksRequest& WithConfigurationAggregatorName(ConfigurationAggregatorNameT&& value) {
  ...
  template <typename FiltersT = AggregateConformancePackComplianceFilters>
  DescribeAggregateComplianceByConformancePacksRequest& WithFilters(FiltersT&& value) {
  ...
  inline DescribeAggregateComplianceByConformancePacksRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAggregateComplianceByConformancePacksRequest& WithNextToken(NextTokenT&& value) {
