...
class ResourceEvaluation {
 public:
  ...
  void SetResourceEvaluationId(ResourceEvaluationIdT&& value) {
    ...
    m_resourceEvaluationId = std::forward<ResourceEvaluationIdT>(value);
  }
  template <typename ResourceEvaluationIdT = Aws::String>
  ResourceEvaluation& WithResourceEvaluationId(ResourceEvaluationIdT&& value) {
    SetResourceEvaluationId(std::forward<ResourceEvaluationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ResourceEvaluation& WithEvaluationMode(EvaluationMode value) {
  ...
  void SetEvaluationStartTimestamp(EvaluationStartTimestampT&& value) {
    ...
    m_evaluationStartTimestamp = std::forward<EvaluationStartTimestampT>(value);
  }
  template <typename EvaluationStartTimestampT = Aws::Utils::DateTime>
  ResourceEvaluation& WithEvaluationStartTimestamp(EvaluationStartTimestampT&& value) {
    SetEvaluationStartTimestamp(std::forward<EvaluationStartTimestampT>(value));
    return *this;
  }
  ///@}
 private:
