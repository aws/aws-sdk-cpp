...
class GetAggregateDiscoveredResourceCountsRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename FiltersT = ResourceCountFilters>
   ...
   */
  inline ResourceCountGroupKey GetGroupByKey() const { return m_groupByKey; }
  inline bool GroupByKeyHasBeenSet() const { return m_groupByKeyHasBeenSet; }
  inline void SetGroupByKey(ResourceCountGroupKey value) {
    m_groupByKeyHasBeenSet = true;
    m_groupByKey = value;
  }
  inline GetAggregateDiscoveredResourceCountsRequest& WithGroupByKey(ResourceCountGroupKey value) {
    SetGroupByKey(value);
    return *this;
  }
  ///@}
  ...
  inline GetAggregateDiscoveredResourceCountsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
 ...
 private:
  ...
  ResourceCountGroupKey m_groupByKey{ResourceCountGroupKey::NOT_SET};
