...
class Compliance {
 public:
  ...
  inline Compliance& WithComplianceType(ComplianceType value) {
  ...
  void SetComplianceContributorCount(ComplianceContributorCountT&& value) {
    ...
    m_complianceContributorCount = std::forward<ComplianceContributorCountT>(value);
  }
  template <typename ComplianceContributorCountT = ComplianceContributorCount>
  Compliance& WithComplianceContributorCount(ComplianceContributorCountT&& value) {
    SetComplianceContributorCount(std::forward<ComplianceContributorCountT>(value));
    return *this;
  }
  ///@}
 private:
