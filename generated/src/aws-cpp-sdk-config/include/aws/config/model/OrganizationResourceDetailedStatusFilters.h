...
class OrganizationResourceDetailedStatusFilters {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  OrganizationResourceDetailedStatusFilters& WithAccountId(AccountIdT&& value) {
  ...
  inline void SetStatus(OrganizationResourceDetailedStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline OrganizationResourceDetailedStatusFilters& WithStatus(OrganizationResourceDetailedStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
