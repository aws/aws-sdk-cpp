...
namespace Model
{
  ...
  public:
    ...
    template<typename ExpressionT = Aws::String>
    SelectResourceConfigRequest& WithExpression(ExpressionT&& value) { SetExpression(std::forward<ExpressionT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    SelectResourceConfigRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
