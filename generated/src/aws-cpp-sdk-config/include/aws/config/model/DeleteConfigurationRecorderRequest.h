...
class DeleteConfigurationRecorderRequest : public ConfigServiceRequest {
 public:
  ...
  void SetConfigurationRecorderName(ConfigurationRecorderNameT&& value) {
    m_configurationRecorderNameHasBeenSet = true;
    m_configurationRecorderName = std::forward<ConfigurationRecorderNameT>(value);
  }
  template <typename ConfigurationRecorderNameT = Aws::String>
  DeleteConfigurationRecorderRequest& WithConfigurationRecorderName(ConfigurationRecorderNameT&& value) {
    SetConfigurationRecorderName(std::forward<ConfigurationRecorderNameT>(value));
    return *this;
  }
  ///@}
 private:
