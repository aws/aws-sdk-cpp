...
namespace Model
{
  ...
  public:
     ...
     * <code>allSupported</code> option to <code>true</code>.</p> <p>If you set the
     * <code>AllSupported</code> option to false and populate the
     * <code>ResourceTypes</code> option with values, when Config adds support for a
     * new type of resource, it will not record resources of that type unless you
     * manually add that type to your recording group.</p> <p>For a list of valid
