...
class ResourceIdentifier {
 public:
  ...
  inline ResourceIdentifier& WithResourceType(ResourceType value) {
  ...
  void SetResourceDeletionTime(ResourceDeletionTimeT&& value) {
    ...
    m_resourceDeletionTime = std::forward<ResourceDeletionTimeT>(value);
  }
  template <typename ResourceDeletionTimeT = Aws::Utils::DateTime>
  ResourceIdentifier& WithResourceDeletionTime(ResourceDeletionTimeT&& value) {
    SetResourceDeletionTime(std::forward<ResourceDeletionTimeT>(value));
    return *this;
  }
  ///@}
 private:
