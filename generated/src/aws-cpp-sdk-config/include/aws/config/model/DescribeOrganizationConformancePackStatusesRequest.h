...
class DescribeOrganizationConformancePackStatusesRequest : public ConfigServiceRequest {
 public:
  ...
  void SetOrganizationConformancePackNames(OrganizationConformancePackNamesT&& value) {
    m_organizationConformancePackNamesHasBeenSet = true;
    m_organizationConformancePackNames = std::forward<OrganizationConformancePackNamesT>(value);
  }
  template <typename OrganizationConformancePackNamesT = Aws::Vector<Aws::String>>
  DescribeOrganizationConformancePackStatusesRequest& WithOrganizationConformancePackNames(OrganizationConformancePackNamesT&& value) {
    SetOrganizationConformancePackNames(std::forward<OrganizationConformancePackNamesT>(value));
    return *this;
  }
  template <typename OrganizationConformancePackNamesT = Aws::String>
  DescribeOrganizationConformancePackStatusesRequest& AddOrganizationConformancePackNames(OrganizationConformancePackNamesT&& value) {
    m_organizationConformancePackNamesHasBeenSet = true;
    m_organizationConformancePackNames.emplace_back(std::forward<OrganizationConformancePackNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeOrganizationConformancePackStatusesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeOrganizationConformancePackStatusesRequest& WithNextToken(NextTokenT&& value) {
