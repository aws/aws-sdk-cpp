...
class ListConformancePackComplianceScoresRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename FiltersT = ConformancePackComplianceScoresFilters>
  ListConformancePackComplianceScoresRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListConformancePackComplianceScoresRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline ListConformancePackComplianceScoresRequest& WithSortBy(SortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListConformancePackComplianceScoresRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConformancePackComplianceScoresRequest& WithNextToken(NextTokenT&& value) {
