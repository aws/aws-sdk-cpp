...
class PutConfigurationRecorderRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConfigurationRecorderT = ConfigurationRecorder>
  PutConfigurationRecorderRequest& WithConfigurationRecorder(ConfigurationRecorderT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  PutConfigurationRecorderRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  PutConfigurationRecorderRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
