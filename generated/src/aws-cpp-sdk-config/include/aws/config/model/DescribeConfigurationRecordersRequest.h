...
class DescribeConfigurationRecordersRequest : public ConfigServiceRequest {
 public:
  ...
  void SetConfigurationRecorderNames(ConfigurationRecorderNamesT&& value) {
    m_configurationRecorderNamesHasBeenSet = true;
    m_configurationRecorderNames = std::forward<ConfigurationRecorderNamesT>(value);
  }
  template <typename ConfigurationRecorderNamesT = Aws::Vector<Aws::String>>
  DescribeConfigurationRecordersRequest& WithConfigurationRecorderNames(ConfigurationRecorderNamesT&& value) {
    SetConfigurationRecorderNames(std::forward<ConfigurationRecorderNamesT>(value));
    return *this;
  }
  template <typename ConfigurationRecorderNamesT = Aws::String>
  DescribeConfigurationRecordersRequest& AddConfigurationRecorderNames(ConfigurationRecorderNamesT&& value) {
    m_configurationRecorderNamesHasBeenSet = true;
    m_configurationRecorderNames.emplace_back(std::forward<ConfigurationRecorderNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ServicePrincipalT = Aws::String>
  DescribeConfigurationRecordersRequest& WithServicePrincipal(ServicePrincipalT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DescribeConfigurationRecordersRequest& WithArn(ArnT&& value) {
