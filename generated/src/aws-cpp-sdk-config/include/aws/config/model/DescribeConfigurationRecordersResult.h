...
class DescribeConfigurationRecordersResult {
 public:
  ...
  AWS_CONFIGSERVICE_API DescribeConfigurationRecordersResult& operator=(
  ...
  void SetConfigurationRecorders(ConfigurationRecordersT&& value) {
    m_configurationRecordersHasBeenSet = true;
    m_configurationRecorders = std::forward<ConfigurationRecordersT>(value);
  }
  template <typename ConfigurationRecordersT = Aws::Vector<ConfigurationRecorder>>
  DescribeConfigurationRecordersResult& WithConfigurationRecorders(ConfigurationRecordersT&& value) {
    SetConfigurationRecorders(std::forward<ConfigurationRecordersT>(value));
    return *this;
  }
  template <typename ConfigurationRecordersT = ConfigurationRecorder>
  DescribeConfigurationRecordersResult& AddConfigurationRecorders(ConfigurationRecordersT&& value) {
    m_configurationRecordersHasBeenSet = true;
    m_configurationRecorders.emplace_back(std::forward<ConfigurationRecordersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeConfigurationRecordersResult& WithRequestId(RequestIdT&& value) {
