...
class GetConnectorResult {
 public:
  AWS_CONFIGSERVICE_API GetConnectorResult() = default;
  AWS_CONFIGSERVICE_API GetConnectorResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CONFIGSERVICE_API GetConnectorResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ConnectorT = Connector>
  GetConnectorResult& WithConnector(ConnectorT&& value) {
