...
class RecordingMode {
 public:
  ...
  inline RecordingMode& WithRecordingFrequency(RecordingFrequency value) {
  ...
  void SetRecordingModeOverrides(RecordingModeOverridesT&& value) {
    ...
    m_recordingModeOverrides = std::forward<RecordingModeOverridesT>(value);
  }
  template <typename RecordingModeOverridesT = Aws::Vector<RecordingModeOverride>>
  RecordingMode& WithRecordingModeOverrides(RecordingModeOverridesT&& value) {
    SetRecordingModeOverrides(std::forward<RecordingModeOverridesT>(value));
    return *this;
  }
  ...
  RecordingMode& AddRecordingModeOverrides(RecordingModeOverridesT&& value) {
    m_recordingModeOverridesHasBeenSet = true;
    m_recordingModeOverrides.emplace_back(std::forward<RecordingModeOverridesT>(value));
    return *this;
  }
  ///@}
 private:
