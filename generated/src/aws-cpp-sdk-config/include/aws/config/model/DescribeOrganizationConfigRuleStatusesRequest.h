...
class DescribeOrganizationConfigRuleStatusesRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename OrganizationConfigRuleNamesT = Aws::Vector<Aws::String>>
  DescribeOrganizationConfigRuleStatusesRequest& WithOrganizationConfigRuleNames(OrganizationConfigRuleNamesT&& value) {
  ...
  DescribeOrganizationConfigRuleStatusesRequest& AddOrganizationConfigRuleNames(OrganizationConfigRuleNamesT&& value) {
    m_organizationConfigRuleNamesHasBeenSet = true;
  ...
  inline DescribeOrganizationConfigRuleStatusesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeOrganizationConfigRuleStatusesRequest& WithNextToken(NextTokenT&& value) {
