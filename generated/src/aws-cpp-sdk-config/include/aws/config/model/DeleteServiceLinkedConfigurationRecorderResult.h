...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    DeleteServiceLinkedConfigurationRecorderResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DeleteServiceLinkedConfigurationRecorderResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteServiceLinkedConfigurationRecorderResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
