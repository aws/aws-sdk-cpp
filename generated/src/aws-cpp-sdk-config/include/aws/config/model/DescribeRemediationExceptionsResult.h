...
class DescribeRemediationExceptionsResult {
 public:
  ...
  AWS_CONFIGSERVICE_API DescribeRemediationExceptionsResult& operator=(
  ...
  void SetRemediationExceptions(RemediationExceptionsT&& value) {
    m_remediationExceptionsHasBeenSet = true;
    m_remediationExceptions = std::forward<RemediationExceptionsT>(value);
  }
  template <typename RemediationExceptionsT = Aws::Vector<RemediationException>>
  DescribeRemediationExceptionsResult& WithRemediationExceptions(RemediationExceptionsT&& value) {
    SetRemediationExceptions(std::forward<RemediationExceptionsT>(value));
    return *this;
  }
  template <typename RemediationExceptionsT = RemediationException>
  DescribeRemediationExceptionsResult& AddRemediationExceptions(RemediationExceptionsT&& value) {
    m_remediationExceptionsHasBeenSet = true;
    m_remediationExceptions.emplace_back(std::forward<RemediationExceptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRemediationExceptionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRemediationExceptionsResult& WithRequestId(RequestIdT&& value) {
