...
class AggregatorFilterResourceType {
 public:
  ...
  inline AggregatorFilterResourceType& WithType(AggregatorFilterType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::Vector<Aws::String>>
  AggregatorFilterResourceType& WithValue(ValueT&& value) {
    SetValue(std::forward<ValueT>(value));
    return *this;
  }
  template <typename ValueT = Aws::String>
  AggregatorFilterResourceType& AddValue(ValueT&& value) {
    m_valueHasBeenSet = true;
