...
class GetAggregateConformancePackComplianceSummaryRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConfigurationAggregatorNameT = Aws::String>
  GetAggregateConformancePackComplianceSummaryRequest& WithConfigurationAggregatorName(ConfigurationAggregatorNameT&& value) {
  ...
  template <typename FiltersT = AggregateConformancePackComplianceSummaryFilters>
  GetAggregateConformancePackComplianceSummaryRequest& WithFilters(FiltersT&& value) {
  ...
  inline void SetGroupByKey(AggregateConformancePackComplianceSummaryGroupKey value) {
    m_groupByKeyHasBeenSet = true;
    m_groupByKey = value;
  }
  inline GetAggregateConformancePackComplianceSummaryRequest& WithGroupByKey(AggregateConformancePackComplianceSummaryGroupKey value) {
    SetGroupByKey(value);
    return *this;
  }
  ///@}
  ...
  inline GetAggregateConformancePackComplianceSummaryRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetAggregateConformancePackComplianceSummaryRequest& WithNextToken(NextTokenT&& value) {
