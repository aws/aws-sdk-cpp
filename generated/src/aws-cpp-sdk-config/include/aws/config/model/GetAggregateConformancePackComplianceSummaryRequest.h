...
namespace Model
{
  ...
  {
  public:
    AWS_CONFIGSERVICE_API GetAggregateConformancePackComplianceSummaryRequest() = default;
    ...
    template<typename ConfigurationAggregatorNameT = Aws::String>
    GetAggregateConformancePackComplianceSummaryRequest& WithConfigurationAggregatorName(ConfigurationAggregatorNameT&& value) { SetConfigurationAggregatorName(std::forward<ConfigurationAggregatorNameT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = AggregateConformancePackComplianceSummaryFilters>
    void SetFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters = std::forward<FiltersT>(value); }
    template<typename FiltersT = AggregateConformancePackComplianceSummaryFilters>
    GetAggregateConformancePackComplianceSummaryRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    ///@}
     ...
     * Services Region.</p>
     */
    inline AggregateConformancePackComplianceSummaryGroupKey GetGroupByKey() const { return m_groupByKey; }
    inline bool GroupByKeyHasBeenSet() const { return m_groupByKeyHasBeenSet; }
    inline void SetGroupByKey(AggregateConformancePackComplianceSummaryGroupKey value) { m_groupByKeyHasBeenSet = true; m_groupByKey = value; }
    inline GetAggregateConformancePackComplianceSummaryRequest& WithGroupByKey(AggregateConformancePackComplianceSummaryGroupKey value) { SetGroupByKey(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetAggregateConformancePackComplianceSummaryRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
