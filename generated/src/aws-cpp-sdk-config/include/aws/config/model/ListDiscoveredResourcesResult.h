...
class ListDiscoveredResourcesResult {
 public:
  ...
  template <typename ResourceIdentifiersT = Aws::Vector<ResourceIdentifier>>
  ListDiscoveredResourcesResult& WithResourceIdentifiers(ResourceIdentifiersT&& value) {
    SetResourceIdentifiers(std::forward<ResourceIdentifiersT>(value));
    return *this;
  }
  template <typename ResourceIdentifiersT = ResourceIdentifier>
  ListDiscoveredResourcesResult& AddResourceIdentifiers(ResourceIdentifiersT&& value) {
    m_resourceIdentifiersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDiscoveredResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDiscoveredResourcesResult& WithRequestId(RequestIdT&& value) {
