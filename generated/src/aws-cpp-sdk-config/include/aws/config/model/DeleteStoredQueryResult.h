...
namespace Model
{
  ...
  public:
    ...
    inline DeleteStoredQueryResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteStoredQueryResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteStoredQueryResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
