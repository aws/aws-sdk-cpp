...
class OrganizationCustomPolicyRuleMetadata {
 public:
   ...
   */
  inline const Aws::Vector<OrganizationConfigRuleTriggerTypeNoSN>& GetOrganizationConfigRuleTriggerTypes() const {
  ...
  inline OrganizationCustomPolicyRuleMetadata& AddOrganizationConfigRuleTriggerTypes(OrganizationConfigRuleTriggerTypeNoSN value) {
    m_organizationConfigRuleTriggerTypesHasBeenSet = true;
  ...
  inline OrganizationCustomPolicyRuleMetadata& WithMaximumExecutionFrequency(MaximumExecutionFrequency value) {
  ...
  void SetDebugLogDeliveryAccounts(DebugLogDeliveryAccountsT&& value) {
    m_debugLogDeliveryAccountsHasBeenSet = true;
    m_debugLogDeliveryAccounts = std::forward<DebugLogDeliveryAccountsT>(value);
  }
  template <typename DebugLogDeliveryAccountsT = Aws::Vector<Aws::String>>
  OrganizationCustomPolicyRuleMetadata& WithDebugLogDeliveryAccounts(DebugLogDeliveryAccountsT&& value) {
    SetDebugLogDeliveryAccounts(std::forward<DebugLogDeliveryAccountsT>(value));
    return *this;
  }
  ...
  OrganizationCustomPolicyRuleMetadata& AddDebugLogDeliveryAccounts(DebugLogDeliveryAccountsT&& value) {
    m_debugLogDeliveryAccountsHasBeenSet = true;
    m_debugLogDeliveryAccounts.emplace_back(std::forward<DebugLogDeliveryAccountsT>(value));
    return *this;
  }
  ///@}
 private:
