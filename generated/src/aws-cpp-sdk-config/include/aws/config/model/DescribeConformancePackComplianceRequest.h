...
class DescribeConformancePackComplianceRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConformancePackNameT = Aws::String>
  DescribeConformancePackComplianceRequest& WithConformancePackName(ConformancePackNameT&& value) {
  ...
  template <typename FiltersT = ConformancePackComplianceFilters>
  DescribeConformancePackComplianceRequest& WithFilters(FiltersT&& value) {
  ...
  inline DescribeConformancePackComplianceRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConformancePackComplianceRequest& WithNextToken(NextTokenT&& value) {
