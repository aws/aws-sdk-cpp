...
class ConfigurationRecorderSummary {
 public:
  ...
  inline void SetRecordingScope(RecordingScope value) {
    m_recordingScopeHasBeenSet = true;
    m_recordingScope = value;
  }
  inline ConfigurationRecorderSummary& WithRecordingScope(RecordingScope value) {
    SetRecordingScope(value);
    return *this;
  }
  ///@}
 private:
