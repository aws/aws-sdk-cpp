...
class ConformancePackComplianceFilters {
 public:
  ...
  template <typename ConfigRuleNamesT = Aws::Vector<Aws::String>>
  ConformancePackComplianceFilters& WithConfigRuleNames(ConfigRuleNamesT&& value) {
    SetConfigRuleNames(std::forward<ConfigRuleNamesT>(value));
    return *this;
  }
  template <typename ConfigRuleNamesT = Aws::String>
  ConformancePackComplianceFilters& AddConfigRuleNames(ConfigRuleNamesT&& value) {
    m_configRuleNamesHasBeenSet = true;
  ...
  inline ConformancePackComplianceFilters& WithComplianceType(ConformancePackComplianceType value) {
