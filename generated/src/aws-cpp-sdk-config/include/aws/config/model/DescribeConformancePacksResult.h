...
class DescribeConformancePacksResult {
 public:
  ...
  void SetConformancePackDetails(ConformancePackDetailsT&& value) {
    m_conformancePackDetailsHasBeenSet = true;
    m_conformancePackDetails = std::forward<ConformancePackDetailsT>(value);
  }
  template <typename ConformancePackDetailsT = Aws::Vector<ConformancePackDetail>>
  DescribeConformancePacksResult& WithConformancePackDetails(ConformancePackDetailsT&& value) {
    SetConformancePackDetails(std::forward<ConformancePackDetailsT>(value));
    return *this;
  }
  template <typename ConformancePackDetailsT = ConformancePackDetail>
  DescribeConformancePacksResult& AddConformancePackDetails(ConformancePackDetailsT&& value) {
    m_conformancePackDetailsHasBeenSet = true;
    m_conformancePackDetails.emplace_back(std::forward<ConformancePackDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConformancePacksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeConformancePacksResult& WithRequestId(RequestIdT&& value) {
