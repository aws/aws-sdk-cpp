...
class PutServiceLinkedConfigurationRecorderResult {
 public:
  AWS_CONFIGSERVICE_API PutServiceLinkedConfigurationRecorderResult() = default;
  ...
  AWS_CONFIGSERVICE_API PutServiceLinkedConfigurationRecorderResult& operator=(
  ...
  template <typename ArnT = Aws::String>
  PutServiceLinkedConfigurationRecorderResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  PutServiceLinkedConfigurationRecorderResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutServiceLinkedConfigurationRecorderResult& WithRequestId(RequestIdT&& value) {
