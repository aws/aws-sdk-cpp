...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    PutServiceLinkedConfigurationRecorderResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    PutServiceLinkedConfigurationRecorderResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutServiceLinkedConfigurationRecorderResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
