...
class GetComplianceDetailsByConfigRuleResult {
 public:
  ...
  AWS_CONFIGSERVICE_API GetComplianceDetailsByConfigRuleResult& operator=(
  ...
  template <typename EvaluationResultsT = Aws::Vector<EvaluationResult>>
  GetComplianceDetailsByConfigRuleResult& WithEvaluationResults(EvaluationResultsT&& value) {
    SetEvaluationResults(std::forward<EvaluationResultsT>(value));
    return *this;
  }
  template <typename EvaluationResultsT = EvaluationResult>
  GetComplianceDetailsByConfigRuleResult& AddEvaluationResults(EvaluationResultsT&& value) {
    m_evaluationResultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetComplianceDetailsByConfigRuleResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetComplianceDetailsByConfigRuleResult& WithRequestId(RequestIdT&& value) {
