...
struct GetOrganizationConformancePackDetailedStatusPaginationTraits {
  using RequestType = Model::GetOrganizationConformancePackDetailedStatusRequest;
  using ResultType = Model::GetOrganizationConformancePackDetailedStatusResult;
  using OutcomeType = Model::GetOrganizationConformancePackDetailedStatusOutcome;
