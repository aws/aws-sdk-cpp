...
namespace Model
{
  ...
  public:
     ...
     * configuration changes for all supported regionally recorded resource types. You
     * also must set the <code>allSupported</code> field of <a
     * href="https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html">RecordingGroup</a>
     * to <code>true</code>. When Config adds support for a new regionally recorded
     * resource type, Config automatically starts recording resources of that type. For
     * a list of supported resource types, see <a
     ...
     * <code>includeGlobalResourceTypes</code> to false, globally recorded IAM resource
     * types will still be automatically recorded in this option unless those resource
     * types are specifically listed as exclusions in the <code>resourceTypes</code>
     * field of <code>exclusionByResourceTypes</code>.</p>   <p> <b>Global
     * resource types and the exclusion recording strategy</b> </p> <p>By default, if
     * you choose the <code>EXCLUSION_BY_RESOURCE_TYPES</code> recording strategy, when
     ...
     * resources of that type automatically.</p> <p>In addition, unless specifically
     * listed as exclusions, <code>AWS::RDS::GlobalCluster</code> will be recorded
     * automatically in all supported Config Regions were the configuration recorder is
     * enabled. IAM users, groups, roles, and customer managed policies will be
     * recorded automatically in all enabled Config Regions where Config was available
     * before February 2022. This list does not include the following Regions:</p> <ul>
     * <li> <p>Asia Pacific (Hyderabad)</p> </li> <li> <p>Asia Pacific (Melbourne)</p>
     * </li> <li> <p>Europe (Spain)</p> </li> <li> <p>Europe (Zurich)</p> </li> <li>
     * <p>Israel (Tel Aviv)</p> </li> <li> <p>Middle East (UAE)</p> </li> </ul> 
     */
