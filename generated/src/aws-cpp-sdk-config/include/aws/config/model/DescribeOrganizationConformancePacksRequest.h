...
class DescribeOrganizationConformancePacksRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename OrganizationConformancePackNamesT = Aws::Vector<Aws::String>>
  DescribeOrganizationConformancePacksRequest& WithOrganizationConformancePackNames(OrganizationConformancePackNamesT&& value) {
  ...
  DescribeOrganizationConformancePacksRequest& AddOrganizationConformancePackNames(OrganizationConformancePackNamesT&& value) {
    m_organizationConformancePackNamesHasBeenSet = true;
  ...
  inline DescribeOrganizationConformancePacksRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeOrganizationConformancePacksRequest& WithNextToken(NextTokenT&& value) {
