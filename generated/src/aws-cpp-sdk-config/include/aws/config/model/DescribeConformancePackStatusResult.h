...
class DescribeConformancePackStatusResult {
 public:
  ...
  AWS_CONFIGSERVICE_API DescribeConformancePackStatusResult& operator=(
  ...
  void SetConformancePackStatusDetails(ConformancePackStatusDetailsT&& value) {
    m_conformancePackStatusDetailsHasBeenSet = true;
    m_conformancePackStatusDetails = std::forward<ConformancePackStatusDetailsT>(value);
  }
  template <typename ConformancePackStatusDetailsT = Aws::Vector<ConformancePackStatusDetail>>
  DescribeConformancePackStatusResult& WithConformancePackStatusDetails(ConformancePackStatusDetailsT&& value) {
    SetConformancePackStatusDetails(std::forward<ConformancePackStatusDetailsT>(value));
    return *this;
  }
  template <typename ConformancePackStatusDetailsT = ConformancePackStatusDetail>
  DescribeConformancePackStatusResult& AddConformancePackStatusDetails(ConformancePackStatusDetailsT&& value) {
    m_conformancePackStatusDetailsHasBeenSet = true;
    m_conformancePackStatusDetails.emplace_back(std::forward<ConformancePackStatusDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConformancePackStatusResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeConformancePackStatusResult& WithRequestId(RequestIdT&& value) {
