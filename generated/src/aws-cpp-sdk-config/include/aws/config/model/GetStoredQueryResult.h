...
class GetStoredQueryResult {
 public:
  ...
  void SetStoredQuery(StoredQueryT&& value) {
    m_storedQueryHasBeenSet = true;
    m_storedQuery = std::forward<StoredQueryT>(value);
  }
  template <typename StoredQueryT = StoredQuery>
  GetStoredQueryResult& WithStoredQuery(StoredQueryT&& value) {
    SetStoredQuery(std::forward<StoredQueryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetStoredQueryResult& WithRequestId(RequestIdT&& value) {
