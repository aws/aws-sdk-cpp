...
class AggregatorFilterServicePrincipal {
 public:
  ...
  inline void SetType(AggregatorFilterType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline AggregatorFilterServicePrincipal& WithType(AggregatorFilterType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::Vector<Aws::String>>
  AggregatorFilterServicePrincipal& WithValue(ValueT&& value) {
    SetValue(std::forward<ValueT>(value));
    return *this;
  }
  template <typename ValueT = Aws::String>
  AggregatorFilterServicePrincipal& AddValue(ValueT&& value) {
    m_valueHasBeenSet = true;
