...
namespace Model
{
  ...
  {
  public:
    AWS_CONFIGSERVICE_API DisassociateResourceTypesResult() = default;
    ...
    template<typename ConfigurationRecorderT = ConfigurationRecorder>
    DisassociateResourceTypesResult& WithConfigurationRecorder(ConfigurationRecorderT&& value) { SetConfigurationRecorder(std::forward<ConfigurationRecorderT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateResourceTypesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
