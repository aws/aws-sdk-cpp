...
class ResourceCountFilters {
 public:
  ...
  inline ResourceCountFilters& WithResourceType(ResourceType value) {
  ...
  template <typename AccountIdT = Aws::String>
  ResourceCountFilters& WithAccountId(AccountIdT&& value) {
  ...
  template <typename RegionT = Aws::String>
  ResourceCountFilters& WithRegion(RegionT&& value) {
