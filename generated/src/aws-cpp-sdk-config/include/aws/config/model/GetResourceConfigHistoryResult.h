...
class GetResourceConfigHistoryResult {
 public:
  ...
  void SetConfigurationItems(ConfigurationItemsT&& value) {
    ...
    m_configurationItems = std::forward<ConfigurationItemsT>(value);
  }
  template <typename ConfigurationItemsT = Aws::Vector<ConfigurationItem>>
  GetResourceConfigHistoryResult& WithConfigurationItems(ConfigurationItemsT&& value) {
    SetConfigurationItems(std::forward<ConfigurationItemsT>(value));
    return *this;
  }
  ...
  GetResourceConfigHistoryResult& AddConfigurationItems(ConfigurationItemsT&& value) {
    m_configurationItemsHasBeenSet = true;
    m_configurationItems.emplace_back(std::forward<ConfigurationItemsT>(value));
    return *this;
  }
  ///@}
