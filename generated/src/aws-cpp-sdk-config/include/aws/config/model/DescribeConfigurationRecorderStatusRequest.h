...
class DescribeConfigurationRecorderStatusRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConfigurationRecorderNamesT = Aws::Vector<Aws::String>>
  DescribeConfigurationRecorderStatusRequest& WithConfigurationRecorderNames(ConfigurationRecorderNamesT&& value) {
  ...
  DescribeConfigurationRecorderStatusRequest& AddConfigurationRecorderNames(ConfigurationRecorderNamesT&& value) {
    m_configurationRecorderNamesHasBeenSet = true;
  ...
  template <typename ServicePrincipalT = Aws::String>
  DescribeConfigurationRecorderStatusRequest& WithServicePrincipal(ServicePrincipalT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DescribeConfigurationRecorderStatusRequest& WithArn(ArnT&& value) {
