...
class AggregateConformancePackComplianceCount {
 public:
  ...
  inline void SetCompliantConformancePackCount(int value) {
    m_compliantConformancePackCountHasBeenSet = true;
    m_compliantConformancePackCount = value;
  }
  inline AggregateConformancePackComplianceCount& WithCompliantConformancePackCount(int value) {
    SetCompliantConformancePackCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNonCompliantConformancePackCount(int value) {
    m_nonCompliantConformancePackCountHasBeenSet = true;
    m_nonCompliantConformancePackCount = value;
  }
  inline AggregateConformancePackComplianceCount& WithNonCompliantConformancePackCount(int value) {
    SetNonCompliantConformancePackCount(value);
    return *this;
  }
  ///@}
 private:
