...
class DescribeConformancePackStatusRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConformancePackNamesT = Aws::Vector<Aws::String>>
  DescribeConformancePackStatusRequest& WithConformancePackNames(ConformancePackNamesT&& value) {
    SetConformancePackNames(std::forward<ConformancePackNamesT>(value));
    return *this;
  }
  template <typename ConformancePackNamesT = Aws::String>
  DescribeConformancePackStatusRequest& AddConformancePackNames(ConformancePackNamesT&& value) {
    m_conformancePackNamesHasBeenSet = true;
  ...
  inline DescribeConformancePackStatusRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConformancePackStatusRequest& WithNextToken(NextTokenT&& value) {
