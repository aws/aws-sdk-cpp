...
namespace Model
{
  ...
  {
  public:
    AWS_CONFIGSERVICE_API DescribeConformancePackStatusRequest() = default;
    ...
    template<typename ConformancePackNamesT = Aws::Vector<Aws::String>>
    DescribeConformancePackStatusRequest& WithConformancePackNames(ConformancePackNamesT&& value) { SetConformancePackNames(std::forward<ConformancePackNamesT>(value)); return *this;}
    template<typename ConformancePackNamesT = Aws::String>
    DescribeConformancePackStatusRequest& AddConformancePackNames(ConformancePackNamesT&& value) { m_conformancePackNamesHasBeenSet = true; m_conformancePackNames.emplace_back(std::forward<ConformancePackNamesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeConformancePackStatusRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
