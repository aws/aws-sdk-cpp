...
class DescribeDeliveryChannelStatusResult {
 public:
  ...
  AWS_CONFIGSERVICE_API DescribeDeliveryChannelStatusResult& operator=(
  ...
  void SetDeliveryChannelsStatus(DeliveryChannelsStatusT&& value) {
    m_deliveryChannelsStatusHasBeenSet = true;
    m_deliveryChannelsStatus = std::forward<DeliveryChannelsStatusT>(value);
  }
  template <typename DeliveryChannelsStatusT = Aws::Vector<DeliveryChannelStatus>>
  DescribeDeliveryChannelStatusResult& WithDeliveryChannelsStatus(DeliveryChannelsStatusT&& value) {
    SetDeliveryChannelsStatus(std::forward<DeliveryChannelsStatusT>(value));
    return *this;
  }
  template <typename DeliveryChannelsStatusT = DeliveryChannelStatus>
  DescribeDeliveryChannelStatusResult& AddDeliveryChannelsStatus(DeliveryChannelsStatusT&& value) {
    m_deliveryChannelsStatusHasBeenSet = true;
    m_deliveryChannelsStatus.emplace_back(std::forward<DeliveryChannelsStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDeliveryChannelStatusResult& WithRequestId(RequestIdT&& value) {
