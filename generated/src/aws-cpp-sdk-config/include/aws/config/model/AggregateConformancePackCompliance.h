...
class AggregateConformancePackCompliance {
 public:
  ...
  inline AggregateConformancePackCompliance& WithComplianceType(ConformancePackComplianceType value) {
  ...
  inline void SetCompliantRuleCount(int value) {
    m_compliantRuleCountHasBeenSet = true;
    m_compliantRuleCount = value;
  }
  inline AggregateConformancePackCompliance& WithCompliantRuleCount(int value) {
    SetCompliantRuleCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNonCompliantRuleCount(int value) {
    m_nonCompliantRuleCountHasBeenSet = true;
    m_nonCompliantRuleCount = value;
  }
  inline AggregateConformancePackCompliance& WithNonCompliantRuleCount(int value) {
    SetNonCompliantRuleCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalRuleCount(int value) {
    m_totalRuleCountHasBeenSet = true;
    m_totalRuleCount = value;
  }
  inline AggregateConformancePackCompliance& WithTotalRuleCount(int value) {
    SetTotalRuleCount(value);
    return *this;
  }
  ///@}
 private:
