...
class PutEvaluationsRequest : public ConfigServiceRequest {
 public:
  ...
  void SetResultToken(ResultTokenT&& value) {
    ...
    m_resultToken = std::forward<ResultTokenT>(value);
  }
  template <typename ResultTokenT = Aws::String>
  PutEvaluationsRequest& WithResultToken(ResultTokenT&& value) {
    SetResultToken(std::forward<ResultTokenT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTestMode(bool value) {
    m_testModeHasBeenSet = true;
    m_testMode = value;
  }
  inline PutEvaluationsRequest& WithTestMode(bool value) {
    SetTestMode(value);
    return *this;
  }
  ///@}
