...
class DisassociateResourceTypesRequest : public ConfigServiceRequest {
 public:
  AWS_CONFIGSERVICE_API DisassociateResourceTypesRequest() = default;
  ...
  void SetConfigurationRecorderArn(ConfigurationRecorderArnT&& value) {
    m_configurationRecorderArnHasBeenSet = true;
    m_configurationRecorderArn = std::forward<ConfigurationRecorderArnT>(value);
  }
  template <typename ConfigurationRecorderArnT = Aws::String>
  DisassociateResourceTypesRequest& WithConfigurationRecorderArn(ConfigurationRecorderArnT&& value) {
    SetConfigurationRecorderArn(std::forward<ConfigurationRecorderArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceTypesT = Aws::Vector<ResourceType>>
  DisassociateResourceTypesRequest& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  inline DisassociateResourceTypesRequest& AddResourceTypes(ResourceType value) {
    m_resourceTypesHasBeenSet = true;
