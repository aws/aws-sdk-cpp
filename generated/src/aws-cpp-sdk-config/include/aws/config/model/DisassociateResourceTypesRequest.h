...
namespace Model
{
  ...
  public:
    ...
    template<typename ConfigurationRecorderArnT = Aws::String>
    DisassociateResourceTypesRequest& WithConfigurationRecorderArn(ConfigurationRecorderArnT&& value) { SetConfigurationRecorderArn(std::forward<ConfigurationRecorderArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceTypesT = Aws::Vector<ResourceType>>
    DisassociateResourceTypesRequest& WithResourceTypes(ResourceTypesT&& value) { SetResourceTypes(std::forward<ResourceTypesT>(value)); return *this;}
    inline DisassociateResourceTypesRequest& AddResourceTypes(ResourceType value) { m_resourceTypesHasBeenSet = true; m_resourceTypes.push_back(value); return *this; }
    ///@}
  private:
