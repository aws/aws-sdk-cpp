...
class OrganizationConfigRuleStatus {
 public:
  ...
  inline void SetOrganizationRuleStatus(OrganizationRuleStatus value) {
    m_organizationRuleStatusHasBeenSet = true;
    m_organizationRuleStatus = value;
  }
  inline OrganizationConfigRuleStatus& WithOrganizationRuleStatus(OrganizationRuleStatus value) {
    SetOrganizationRuleStatus(value);
    return *this;
  }
  ///@}
