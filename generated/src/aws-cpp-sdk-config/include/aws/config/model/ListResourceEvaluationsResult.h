...
class ListResourceEvaluationsResult {
 public:
  ...
  void SetResourceEvaluations(ResourceEvaluationsT&& value) {
    m_resourceEvaluationsHasBeenSet = true;
    m_resourceEvaluations = std::forward<ResourceEvaluationsT>(value);
  }
  template <typename ResourceEvaluationsT = Aws::Vector<ResourceEvaluation>>
  ListResourceEvaluationsResult& WithResourceEvaluations(ResourceEvaluationsT&& value) {
    SetResourceEvaluations(std::forward<ResourceEvaluationsT>(value));
    return *this;
  }
  template <typename ResourceEvaluationsT = ResourceEvaluation>
  ListResourceEvaluationsResult& AddResourceEvaluations(ResourceEvaluationsT&& value) {
    m_resourceEvaluationsHasBeenSet = true;
    m_resourceEvaluations.emplace_back(std::forward<ResourceEvaluationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceEvaluationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceEvaluationsResult& WithRequestId(RequestIdT&& value) {
