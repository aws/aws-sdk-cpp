...
class GetComplianceDetailsByConfigRuleRequest : public ConfigServiceRequest {
 public:
  ...
  template <typename ConfigRuleNameT = Aws::String>
  GetComplianceDetailsByConfigRuleRequest& WithConfigRuleName(ConfigRuleNameT&& value) {
  ...
  void SetComplianceTypes(ComplianceTypesT&& value) {
    m_complianceTypesHasBeenSet = true;
    m_complianceTypes = std::forward<ComplianceTypesT>(value);
  }
  template <typename ComplianceTypesT = Aws::Vector<ComplianceType>>
  GetComplianceDetailsByConfigRuleRequest& WithComplianceTypes(ComplianceTypesT&& value) {
    SetComplianceTypes(std::forward<ComplianceTypesT>(value));
    return *this;
  }
  inline GetComplianceDetailsByConfigRuleRequest& AddComplianceTypes(ComplianceType value) {
    m_complianceTypesHasBeenSet = true;
    m_complianceTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline GetComplianceDetailsByConfigRuleRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetComplianceDetailsByConfigRuleRequest& WithNextToken(NextTokenT&& value) {
