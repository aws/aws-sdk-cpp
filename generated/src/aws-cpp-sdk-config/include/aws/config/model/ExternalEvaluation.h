...
class ExternalEvaluation {
 public:
  ...
  void SetComplianceResourceType(ComplianceResourceTypeT&& value) {
    ...
    m_complianceResourceType = std::forward<ComplianceResourceTypeT>(value);
  }
  template <typename ComplianceResourceTypeT = Aws::String>
  ExternalEvaluation& WithComplianceResourceType(ComplianceResourceTypeT&& value) {
    SetComplianceResourceType(std::forward<ComplianceResourceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComplianceResourceId(ComplianceResourceIdT&& value) {
    ...
    m_complianceResourceId = std::forward<ComplianceResourceIdT>(value);
  }
  template <typename ComplianceResourceIdT = Aws::String>
  ExternalEvaluation& WithComplianceResourceId(ComplianceResourceIdT&& value) {
    SetComplianceResourceId(std::forward<ComplianceResourceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetComplianceType(ComplianceType value) {
    m_complianceTypeHasBeenSet = true;
    m_complianceType = value;
  }
  inline ExternalEvaluation& WithComplianceType(ComplianceType value) {
  ...
  void SetOrderingTimestamp(OrderingTimestampT&& value) {
    ...
    m_orderingTimestamp = std::forward<OrderingTimestampT>(value);
  }
  template <typename OrderingTimestampT = Aws::Utils::DateTime>
  ExternalEvaluation& WithOrderingTimestamp(OrderingTimestampT&& value) {
    SetOrderingTimestamp(std::forward<OrderingTimestampT>(value));
    return *this;
  }
  ///@}
 private:
