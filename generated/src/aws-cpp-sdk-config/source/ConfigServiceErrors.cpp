...
static const int MAX_NUMBER_OF_CONFIGURATION_RECORDERS_EXCEEDED_HASH =
    HashingUtils::HashString("MaxNumberOfConfigurationRecordersExceededException");
...
static const int MAX_NUMBER_OF_ORGANIZATION_CONFORMANCE_PACKS_EXCEEDED_HASH =
    HashingUtils::HashString("MaxNumberOfOrganizationConformancePacksExceededException");
static const int NO_AVAILABLE_ORGANIZATION_HASH = HashingUtils::HashString("NoAvailableOrganizationException");
static const int ORGANIZATION_CONFORMANCE_PACK_TEMPLATE_VALIDATION_HASH =
...
static const int MAX_NUMBER_OF_ORGANIZATION_CONFIG_RULES_EXCEEDED_HASH =
    HashingUtils::HashString("MaxNumberOfOrganizationConfigRulesExceededException");
...
static const int MAX_NUMBER_OF_RETENTION_CONFIGURATIONS_EXCEEDED_HASH =
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == MAX_NUMBER_OF_CONFIG_RULES_EXCEEDED_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::MAX_NUMBER_OF_CONFIG_RULES_EXCEEDED),
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::LIMIT_EXCEEDED), RetryableType::RETRYABLE_THROTTLING);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::CONFORMANCE_PACK_TEMPLATE_VALIDATION),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::MAX_NUMBER_OF_CONFIGURATION_RECORDERS_EXCEEDED),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::NO_AVAILABLE_CONFIGURATION_RECORDER),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::RESOURCE_CONCURRENT_MODIFICATION),
                                RetryableType::NOT_RETRYABLE);
  } else if (hashCode == NO_SUCH_CONFIGURATION_AGGREGATOR_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::NO_SUCH_CONFIGURATION_AGGREGATOR),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::MAX_NUMBER_OF_ORGANIZATION_CONFORMANCE_PACKS_EXCEEDED),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::ORGANIZATION_CONFORMANCE_PACK_TEMPLATE_VALIDATION),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::NO_RUNNING_CONFIGURATION_RECORDER),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::LAST_DELIVERY_CHANNEL_DELETE_FAILED),
                                RetryableType::NOT_RETRYABLE);
  } else if (hashCode == ORGANIZATION_ALL_FEATURES_NOT_ENABLED_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::ORGANIZATION_ALL_FEATURES_NOT_ENABLED),
                                RetryableType::NOT_RETRYABLE);
  } else if (hashCode == MAX_NUMBER_OF_ORGANIZATION_CONFIG_RULES_EXCEEDED_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::MAX_NUMBER_OF_ORGANIZATION_CONFIG_RULES_EXCEEDED),
                                RetryableType::NOT_RETRYABLE);
  } else if (hashCode == NO_SUCH_ORGANIZATION_CONFORMANCE_PACK_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::NO_SUCH_ORGANIZATION_CONFORMANCE_PACK),
                                RetryableType::NOT_RETRYABLE);
  } else if (hashCode == NO_SUCH_REMEDIATION_CONFIGURATION_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::NO_SUCH_REMEDIATION_CONFIGURATION),
                                RetryableType::NOT_RETRYABLE);
  } else if (hashCode == MAX_NUMBER_OF_RETENTION_CONFIGURATIONS_EXCEEDED_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::MAX_NUMBER_OF_RETENTION_CONFIGURATIONS_EXCEEDED),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::MAX_NUMBER_OF_CONFORMANCE_PACKS_EXCEEDED),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::MAX_NUMBER_OF_DELIVERY_CHANNELS_EXCEEDED),
                                RetryableType::NOT_RETRYABLE);
  } else if (hashCode == NO_SUCH_CONFIG_RULE_IN_CONFORMANCE_PACK_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::NO_SUCH_CONFIG_RULE_IN_CONFORMANCE_PACK),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::NO_SUCH_RETENTION_CONFIGURATION),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ConfigServiceErrors::NO_SUCH_ORGANIZATION_CONFIG_RULE),
                                RetryableType::NOT_RETRYABLE);
