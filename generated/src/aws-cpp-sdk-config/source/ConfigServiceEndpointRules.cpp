...
{
const size_t ConfigServiceEndpointRules::RulesBlobStrLen = 3950;
const size_t ConfigServiceEndpointRules::RulesBlobSize = 3951;
...
':','/','/','c','o','n','f','i','g','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','n','f','i','g','.','{','R','e','g','i',
