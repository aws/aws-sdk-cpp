...
{
const size_t ConfigServiceEndpointRules::RulesBlobStrLen = 3693;
const size_t ConfigServiceEndpointRules::RulesBlobSize = 3694;
...
':','"','h','t','t','p','s',':','/','/','c','o','n','f','i','g','.','{','R','e','g','i','o','n','}',
