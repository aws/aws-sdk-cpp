...
DescribeRetentionConfigurationsResult& DescribeRetentionConfigurationsResult::operator=(
  ...
  if (jsonValue.ValueExists("RetentionConfigurations")) {
    ...
    for (unsigned retentionConfigurationsIndex = 0; retentionConfigurationsIndex < retentionConfigurationsJsonList.GetLength();
