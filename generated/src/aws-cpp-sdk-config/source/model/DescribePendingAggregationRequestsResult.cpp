...
DescribePendingAggregationRequestsResult::DescribePendingAggregationRequestsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}
...
DescribePendingAggregationRequestsResult& DescribePendingAggregationRequestsResult::operator=(
  ...
  if (jsonValue.ValueExists("PendingAggregationRequests")) {
    ...
    for (unsigned pendingAggregationRequestsIndex = 0; pendingAggregationRequestsIndex < pendingAggregationRequestsJsonList.GetLength();
         ++pendingAggregationRequestsIndex) {
