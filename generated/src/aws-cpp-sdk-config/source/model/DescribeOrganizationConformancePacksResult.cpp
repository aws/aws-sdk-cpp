...
DescribeOrganizationConformancePacksResult& DescribeOrganizationConformancePacksResult::operator=(
  ...
  if (jsonValue.ValueExists("OrganizationConformancePacks")) {
    ...
    for (unsigned organizationConformancePacksIndex = 0;
         organizationConformancePacksIndex < organizationConformancePacksJsonList.GetLength(); ++organizationConformancePacksIndex) {
