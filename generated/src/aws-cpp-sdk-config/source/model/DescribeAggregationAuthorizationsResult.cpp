...
DescribeAggregationAuthorizationsResult& DescribeAggregationAuthorizationsResult::operator=(
  ...
  if (jsonValue.ValueExists("AggregationAuthorizations")) {
    ...
    for (unsigned aggregationAuthorizationsIndex = 0; aggregationAuthorizationsIndex < aggregationAuthorizationsJsonList.GetLength();
         ++aggregationAuthorizationsIndex) {
