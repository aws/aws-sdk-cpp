...
Aws::String DescribeOrganizationConfigRuleStatusesRequest::SerializePayload() const {
  ...
  if (m_organizationConfigRuleNamesHasBeenSet) {
    ...
    for (unsigned organizationConfigRuleNamesIndex = 0; organizationConfigRuleNamesIndex < organizationConfigRuleNamesJsonList.GetLength();
         ++organizationConfigRuleNamesIndex) {
      organizationConfigRuleNamesJsonList[organizationConfigRuleNamesIndex].AsString(
          m_organizationConfigRuleNames[organizationConfigRuleNamesIndex]);
    }
