...
ListConformancePackComplianceScoresResult& ListConformancePackComplianceScoresResult::operator=(
  ...
  if (jsonValue.ValueExists("ConformancePackComplianceScores")) {
    ...
    for (unsigned conformancePackComplianceScoresIndex = 0;
         conformancePackComplianceScoresIndex < conformancePackComplianceScoresJsonList.GetLength();
         ++conformancePackComplianceScoresIndex) {
