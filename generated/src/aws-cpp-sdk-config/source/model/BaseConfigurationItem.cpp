...
BaseConfigurationItem::BaseConfigurationItem(JsonView jsonValue) { *this = jsonValue; }
...
BaseConfigurationItem& BaseConfigurationItem::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("configurationItemStatus")) {
    m_configurationItemStatus =
        ConfigurationItemStatusMapper::GetConfigurationItemStatusForName(jsonValue.GetString("configurationItemStatus"));
...
JsonValue BaseConfigurationItem::Jsonize() const {
  ...
  if (m_configurationItemStatusHasBeenSet) {
    payload.WithString("configurationItemStatus",
                       ConfigurationItemStatusMapper::GetNameForConfigurationItemStatus(m_configurationItemStatus));
  }
