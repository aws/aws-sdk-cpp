...
OrganizationCustomPolicyRuleMetadataNoPolicy::OrganizationCustomPolicyRuleMetadataNoPolicy(JsonView jsonValue) { *this = jsonValue; }

OrganizationCustomPolicyRuleMetadataNoPolicy& OrganizationCustomPolicyRuleMetadataNoPolicy::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("OrganizationConfigRuleTriggerTypes")) {
    ...
    for (unsigned organizationConfigRuleTriggerTypesIndex = 0;
      ...
      m_organizationConfigRuleTriggerTypes.push_back(
          OrganizationConfigRuleTriggerTypeNoSNMapper::GetOrganizationConfigRuleTriggerTypeNoSNForName(
  ...
  if (jsonValue.ValueExists("DebugLogDeliveryAccounts")) {
    ...
    for (unsigned debugLogDeliveryAccountsIndex = 0; debugLogDeliveryAccountsIndex < debugLogDeliveryAccountsJsonList.GetLength();
         ++debugLogDeliveryAccountsIndex) {
...
JsonValue OrganizationCustomPolicyRuleMetadataNoPolicy::Jsonize() const {
  JsonValue payload;
  ...
  if (m_organizationConfigRuleTriggerTypesHasBeenSet) {
    ...
    for (unsigned organizationConfigRuleTriggerTypesIndex = 0;
         ...
         ++organizationConfigRuleTriggerTypesIndex) {
      organizationConfigRuleTriggerTypesJsonList[organizationConfigRuleTriggerTypesIndex].AsString(
          OrganizationConfigRuleTriggerTypeNoSNMapper::GetNameForOrganizationConfigRuleTriggerTypeNoSN(
