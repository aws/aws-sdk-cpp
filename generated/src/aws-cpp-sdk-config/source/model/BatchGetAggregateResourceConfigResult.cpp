...
BatchGetAggregateResourceConfigResult& BatchGetAggregateResourceConfigResult::operator=(
  ...
  if (jsonValue.ValueExists("BaseConfigurationItems")) {
    ...
    for (unsigned baseConfigurationItemsIndex = 0; baseConfigurationItemsIndex < baseConfigurationItemsJsonList.GetLength();
         ++baseConfigurationItemsIndex) {
  ...
  if (jsonValue.ValueExists("UnprocessedResourceIdentifiers")) {
    ...
    for (unsigned unprocessedResourceIdentifiersIndex = 0;
         unprocessedResourceIdentifiersIndex < unprocessedResourceIdentifiersJsonList.GetLength(); ++unprocessedResourceIdentifiersIndex) {
