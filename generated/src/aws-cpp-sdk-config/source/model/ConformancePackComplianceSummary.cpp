...
ConformancePackComplianceSummary::ConformancePackComplianceSummary(JsonView jsonValue) { *this = jsonValue; }
...
ConformancePackComplianceSummary& ConformancePackComplianceSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ConformancePackComplianceStatus")) {
    m_conformancePackComplianceStatus = ConformancePackComplianceTypeMapper::GetConformancePackComplianceTypeForName(
        jsonValue.GetString("ConformancePackComplianceStatus"));
...
JsonValue ConformancePackComplianceSummary::Jsonize() const {
  ...
  if (m_conformancePackComplianceStatusHasBeenSet) {
    payload.WithString("ConformancePackComplianceStatus",
                       ConformancePackComplianceTypeMapper::GetNameForConformancePackComplianceType(m_conformancePackComplianceStatus));
  }
