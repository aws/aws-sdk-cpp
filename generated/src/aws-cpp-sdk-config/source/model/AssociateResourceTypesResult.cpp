...
AssociateResourceTypesResult::AssociateResourceTypesResult()
{
}

AssociateResourceTypesResult::AssociateResourceTypesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
