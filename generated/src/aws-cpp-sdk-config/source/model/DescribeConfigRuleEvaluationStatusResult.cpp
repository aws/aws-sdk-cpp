...
DescribeConfigRuleEvaluationStatusResult& DescribeConfigRuleEvaluationStatusResult::operator=(
  ...
  if (jsonValue.ValueExists("ConfigRulesEvaluationStatus")) {
    ...
    for (unsigned configRulesEvaluationStatusIndex = 0; configRulesEvaluationStatusIndex < configRulesEvaluationStatusJsonList.GetLength();
         ++configRulesEvaluationStatusIndex) {
