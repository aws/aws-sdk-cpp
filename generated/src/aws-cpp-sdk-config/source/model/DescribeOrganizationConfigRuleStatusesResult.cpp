...
DescribeOrganizationConfigRuleStatusesResult& DescribeOrganizationConfigRuleStatusesResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("OrganizationConfigRuleStatuses")) {
    ...
    for (unsigned organizationConfigRuleStatusesIndex = 0;
         organizationConfigRuleStatusesIndex < organizationConfigRuleStatusesJsonList.GetLength(); ++organizationConfigRuleStatusesIndex) {
