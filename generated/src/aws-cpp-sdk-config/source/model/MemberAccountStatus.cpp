...
MemberAccountStatus::MemberAccountStatus(JsonView jsonValue) { *this = jsonValue; }
...
MemberAccountStatus& MemberAccountStatus::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("MemberAccountRuleStatus")) {
    m_memberAccountRuleStatus =
        MemberAccountRuleStatusMapper::GetMemberAccountRuleStatusForName(jsonValue.GetString("MemberAccountRuleStatus"));
...
JsonValue MemberAccountStatus::Jsonize() const {
  ...
  if (m_memberAccountRuleStatusHasBeenSet) {
    payload.WithString("MemberAccountRuleStatus",
                       MemberAccountRuleStatusMapper::GetNameForMemberAccountRuleStatus(m_memberAccountRuleStatus));
  }
