...
Aws::String DescribeConfigurationRecorderStatusRequest::SerializePayload() const {
  ...
  if (m_configurationRecorderNamesHasBeenSet) {
    ...
    for (unsigned configurationRecorderNamesIndex = 0; configurationRecorderNamesIndex < configurationRecorderNamesJsonList.GetLength();
         ++configurationRecorderNamesIndex) {
      configurationRecorderNamesJsonList[configurationRecorderNamesIndex].AsString(
          m_configurationRecorderNames[configurationRecorderNamesIndex]);
    }
