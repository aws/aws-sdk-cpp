...
DescribeRemediationExecutionStatusResult& DescribeRemediationExecutionStatusResult::operator=(
  ...
  if (jsonValue.ValueExists("RemediationExecutionStatuses")) {
    ...
    for (unsigned remediationExecutionStatusesIndex = 0;
         remediationExecutionStatusesIndex < remediationExecutionStatusesJsonList.GetLength(); ++remediationExecutionStatusesIndex) {
