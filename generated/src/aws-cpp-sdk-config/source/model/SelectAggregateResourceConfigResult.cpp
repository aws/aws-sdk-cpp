...
SelectAggregateResourceConfigResult::SelectAggregateResourceConfigResult()
{
}

SelectAggregateResourceConfigResult::SelectAggregateResourceConfigResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

SelectAggregateResourceConfigResult& SelectAggregateResourceConfigResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
