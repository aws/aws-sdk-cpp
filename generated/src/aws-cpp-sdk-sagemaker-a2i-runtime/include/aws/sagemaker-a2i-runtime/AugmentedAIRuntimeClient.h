...
class AWS_AUGMENTEDAIRUNTIME_API AugmentedAIRuntimeClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  AugmentedAIRuntimeClient(const Aws::AugmentedAIRuntime::AugmentedAIRuntimeClientConfiguration& clientConfiguration =
  ...
  AugmentedAIRuntimeClient(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<AugmentedAIRuntimeEndpointProviderBase> endpointProvider = nullptr,
                           const Aws::AugmentedAIRuntime::AugmentedAIRuntimeClientConfiguration& clientConfiguration =
                               Aws::AugmentedAIRuntime::AugmentedAIRuntimeClientConfiguration());
  ...
  /**
   * An Async wrapper for DeleteHumanLoop that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteHumanLoopRequestT = Model::DeleteHumanLoopRequest>
  void DeleteHumanLoopAsync(const DeleteHumanLoopRequestT& request, const DeleteHumanLoopResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeHumanLoop that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeHumanLoop that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeHumanLoopRequestT = Model::DescribeHumanLoopRequest>
  void DescribeHumanLoopAsync(const DescribeHumanLoopRequestT& request, const DescribeHumanLoopResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListHumanLoops that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListHumanLoopsRequestT = Model::ListHumanLoopsRequest>
  void ListHumanLoopsAsync(const ListHumanLoopsRequestT& request, const ListHumanLoopsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartHumanLoop that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartHumanLoopRequestT = Model::StartHumanLoopRequest>
  void StartHumanLoopAsync(const StartHumanLoopRequestT& request, const StartHumanLoopResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopHumanLoop that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopHumanLoopRequestT = Model::StopHumanLoopRequest>
  void StopHumanLoopAsync(const StopHumanLoopRequestT& request, const StopHumanLoopResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&AugmentedAIRuntimeClient::StopHumanLoop, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<AugmentedAIRuntimeEndpointProviderBase>& accessEndpointProvider();
