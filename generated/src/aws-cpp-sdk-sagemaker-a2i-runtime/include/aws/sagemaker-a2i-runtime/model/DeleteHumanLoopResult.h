...
namespace Model
{
  ...
  {
  public:
    AWS_AUGMENTEDAIRUNTIME_API DeleteHumanLoopResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteHumanLoopResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
