...
class ListHumanLoopsResult {
 public:
  ...
  void SetHumanLoopSummaries(HumanLoopSummariesT&& value) {
    ...
    m_humanLoopSummaries = std::forward<HumanLoopSummariesT>(value);
  }
  template <typename HumanLoopSummariesT = Aws::Vector<HumanLoopSummary>>
  ListHumanLoopsResult& WithHumanLoopSummaries(HumanLoopSummariesT&& value) {
    SetHumanLoopSummaries(std::forward<HumanLoopSummariesT>(value));
    return *this;
  }
  ...
  ListHumanLoopsResult& AddHumanLoopSummaries(HumanLoopSummariesT&& value) {
    m_humanLoopSummariesHasBeenSet = true;
    m_humanLoopSummaries.emplace_back(std::forward<HumanLoopSummariesT>(value));
    return *this;
  }
  ///@}
