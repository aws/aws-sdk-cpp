 ...
 */
using EVSEndpointProviderBase = EndpointProviderBase<EVSClientConfiguration, EVSBuiltInParameters, EVSClientContextParameters>;

using EVSDefaultEpProviderBase = DefaultEndpointProvider<EVSClientConfiguration, EVSBuiltInParameters, EVSClientContextParameters>;
