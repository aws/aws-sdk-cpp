...
namespace Model
{
  ...
  /**
   */
  class DeleteEnvironmentRequest : public EVSRequest
  {
  public:
    AWS_EVS_API DeleteEnvironmentRequest() = default;
     ...
     * environment deletion request. If you do not specify a client token, a randomly
