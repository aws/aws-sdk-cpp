...
/**
 */
class DeleteEnvironmentConnectorRequest : public EVSRequest {
 public:
  AWS_EVS_API DeleteEnvironmentConnectorRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "DeleteEnvironmentConnector"; }
   ...
   * connector deletion request. If you do not specify a client token, a randomly
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteEnvironmentConnectorRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  DeleteEnvironmentConnectorRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename ConnectorIdT = Aws::String>
  DeleteEnvironmentConnectorRequest& WithConnectorId(ConnectorIdT&& value) {
