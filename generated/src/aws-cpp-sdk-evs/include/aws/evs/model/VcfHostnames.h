...
class VcfHostnames {
 public:
  ...
  void SetVCenter(VCenterT&& value) {
    ...
    m_vCenter = std::forward<VCenterT>(value);
  }
  template <typename VCenterT = Aws::String>
  VcfHostnames& WithVCenter(VCenterT&& value) {
    SetVCenter(std::forward<VCenterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNsx(NsxT&& value) {
    ...
    m_nsx = std::forward<NsxT>(value);
  }
  template <typename NsxT = Aws::String>
  VcfHostnames& WithNsx(NsxT&& value) {
    SetNsx(std::forward<NsxT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNsxManager1(NsxManager1T&& value) {
    ...
    m_nsxManager1 = std::forward<NsxManager1T>(value);
  }
  template <typename NsxManager1T = Aws::String>
  VcfHostnames& WithNsxManager1(NsxManager1T&& value) {
    SetNsxManager1(std::forward<NsxManager1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetNsxManager2(NsxManager2T&& value) {
    ...
    m_nsxManager2 = std::forward<NsxManager2T>(value);
  }
  template <typename NsxManager2T = Aws::String>
  VcfHostnames& WithNsxManager2(NsxManager2T&& value) {
    SetNsxManager2(std::forward<NsxManager2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetNsxManager3(NsxManager3T&& value) {
    ...
    m_nsxManager3 = std::forward<NsxManager3T>(value);
  }
  template <typename NsxManager3T = Aws::String>
  VcfHostnames& WithNsxManager3(NsxManager3T&& value) {
    SetNsxManager3(std::forward<NsxManager3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetNsxEdge1(NsxEdge1T&& value) {
    ...
    m_nsxEdge1 = std::forward<NsxEdge1T>(value);
  }
  template <typename NsxEdge1T = Aws::String>
  VcfHostnames& WithNsxEdge1(NsxEdge1T&& value) {
    SetNsxEdge1(std::forward<NsxEdge1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetNsxEdge2(NsxEdge2T&& value) {
    ...
    m_nsxEdge2 = std::forward<NsxEdge2T>(value);
  }
  template <typename NsxEdge2T = Aws::String>
  VcfHostnames& WithNsxEdge2(NsxEdge2T&& value) {
    SetNsxEdge2(std::forward<NsxEdge2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetSddcManager(SddcManagerT&& value) {
    ...
    m_sddcManager = std::forward<SddcManagerT>(value);
  }
  template <typename SddcManagerT = Aws::String>
  VcfHostnames& WithSddcManager(SddcManagerT&& value) {
    SetSddcManager(std::forward<SddcManagerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudBuilder(CloudBuilderT&& value) {
    ...
    m_cloudBuilder = std::forward<CloudBuilderT>(value);
  }
  template <typename CloudBuilderT = Aws::String>
  VcfHostnames& WithCloudBuilder(CloudBuilderT&& value) {
    SetCloudBuilder(std::forward<CloudBuilderT>(value));
    return *this;
  }
  ///@}
 private:
