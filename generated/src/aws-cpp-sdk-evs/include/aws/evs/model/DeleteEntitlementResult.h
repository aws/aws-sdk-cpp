...
class DeleteEntitlementResult {
 public:
  AWS_EVS_API DeleteEntitlementResult() = default;
  AWS_EVS_API DeleteEntitlementResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_EVS_API DeleteEntitlementResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename EntitlementsT = Aws::Vector<VmEntitlement>>
  DeleteEntitlementResult& WithEntitlements(EntitlementsT&& value) {
    SetEntitlements(std::forward<EntitlementsT>(value));
    return *this;
  }
  template <typename EntitlementsT = VmEntitlement>
  DeleteEntitlementResult& AddEntitlements(EntitlementsT&& value) {
    m_entitlementsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteEntitlementResult& WithRequestId(RequestIdT&& value) {
