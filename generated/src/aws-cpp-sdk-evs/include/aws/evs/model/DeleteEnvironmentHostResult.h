...
class DeleteEnvironmentHostResult {
 public:
  ...
  template <typename EnvironmentSummaryT = EnvironmentSummary>
  DeleteEnvironmentHostResult& WithEnvironmentSummary(EnvironmentSummaryT&& value) {
  ...
  template <typename HostT = Host>
  DeleteEnvironmentHostResult& WithHost(HostT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteEnvironmentHostResult& WithRequestId(RequestIdT&& value) {
