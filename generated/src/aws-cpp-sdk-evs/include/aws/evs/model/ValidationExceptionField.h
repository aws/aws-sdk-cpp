...
namespace Model
{
  ...
  {
  public:
    AWS_EVS_API ValidationExceptionField() = default;
    AWS_EVS_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_EVS_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
