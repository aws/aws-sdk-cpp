...
/**
 */
class CreateEntitlementRequest : public EVSRequest {
 public:
  AWS_EVS_API CreateEntitlementRequest() = default;
   ...
   * entitlement creation request. If you do not specify a client token, a randomly
  ...
  template <typename ClientTokenT = Aws::String>
  CreateEntitlementRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  CreateEntitlementRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename ConnectorIdT = Aws::String>
  CreateEntitlementRequest& WithConnectorId(ConnectorIdT&& value) {
  ...
  inline CreateEntitlementRequest& WithEntitlementType(EntitlementType value) {
  ...
  ///@{
  /**
   * <p>The list of VMware vSphere virtual machine managed object IDs to create
   * entitlements for.</p>
   */
  ...
  template <typename VmIdsT = Aws::Vector<Aws::String>>
  CreateEntitlementRequest& WithVmIds(VmIdsT&& value) {
    SetVmIds(std::forward<VmIdsT>(value));
    return *this;
  }
  template <typename VmIdsT = Aws::String>
  CreateEntitlementRequest& AddVmIds(VmIdsT&& value) {
    m_vmIdsHasBeenSet = true;
