...
class CreateEnvironmentRequest : public EVSRequest {
 public:
  ...
  void SetServiceAccessSecurityGroups(ServiceAccessSecurityGroupsT&& value) {
    ...
    m_serviceAccessSecurityGroups = std::forward<ServiceAccessSecurityGroupsT>(value);
  }
  template <typename ServiceAccessSecurityGroupsT = ServiceAccessSecurityGroups>
  CreateEnvironmentRequest& WithServiceAccessSecurityGroups(ServiceAccessSecurityGroupsT&& value) {
    SetServiceAccessSecurityGroups(std::forward<ServiceAccessSecurityGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceAccessSubnetId(ServiceAccessSubnetIdT&& value) {
    ...
    m_serviceAccessSubnetId = std::forward<ServiceAccessSubnetIdT>(value);
  }
  template <typename ServiceAccessSubnetIdT = Aws::String>
  CreateEnvironmentRequest& WithServiceAccessSubnetId(ServiceAccessSubnetIdT&& value) {
    SetServiceAccessSubnetId(std::forward<ServiceAccessSubnetIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateEnvironmentRequest& WithVcfVersion(VcfVersion value) {
    SetVcfVersion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTermsAccepted(bool value) {
  ...
  void SetInitialVlans(InitialVlansT&& value) {
    m_initialVlansHasBeenSet = true;
    m_initialVlans = std::forward<InitialVlansT>(value);
  }
  template <typename InitialVlansT = InitialVlans>
  CreateEnvironmentRequest& WithInitialVlans(InitialVlansT&& value) {
    SetInitialVlans(std::forward<InitialVlansT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVcfHostnames(VcfHostnamesT&& value) {
    ...
    m_vcfHostnames = std::forward<VcfHostnamesT>(value);
  }
  template <typename VcfHostnamesT = VcfHostnames>
  CreateEnvironmentRequest& WithVcfHostnames(VcfHostnamesT&& value) {
    SetVcfHostnames(std::forward<VcfHostnamesT>(value));
    return *this;
  }
  ///@}
