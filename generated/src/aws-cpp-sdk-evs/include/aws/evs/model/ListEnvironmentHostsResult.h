...
class ListEnvironmentHostsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentHostsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetEnvironmentHosts(EnvironmentHostsT&& value) {
    m_environmentHostsHasBeenSet = true;
    m_environmentHosts = std::forward<EnvironmentHostsT>(value);
  }
  template <typename EnvironmentHostsT = Aws::Vector<Host>>
  ListEnvironmentHostsResult& WithEnvironmentHosts(EnvironmentHostsT&& value) {
    SetEnvironmentHosts(std::forward<EnvironmentHostsT>(value));
    return *this;
  }
  template <typename EnvironmentHostsT = Host>
  ListEnvironmentHostsResult& AddEnvironmentHosts(EnvironmentHostsT&& value) {
    m_environmentHostsHasBeenSet = true;
    m_environmentHosts.emplace_back(std::forward<EnvironmentHostsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListEnvironmentHostsResult& WithRequestId(RequestIdT&& value) {
