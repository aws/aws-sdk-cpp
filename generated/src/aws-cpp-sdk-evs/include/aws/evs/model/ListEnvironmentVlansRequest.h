...
class ListEnvironmentVlansRequest : public EVSRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentVlansRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEnvironmentVlansRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename EnvironmentIdT = Aws::String>
  ListEnvironmentVlansRequest& WithEnvironmentId(EnvironmentIdT&& value) {
