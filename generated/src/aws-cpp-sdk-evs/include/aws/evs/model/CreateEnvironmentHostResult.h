...
namespace Model
{
  ...
  public:
    ...
    template<typename EnvironmentSummaryT = EnvironmentSummary>
    CreateEnvironmentHostResult& WithEnvironmentSummary(EnvironmentSummaryT&& value) { SetEnvironmentSummary(std::forward<EnvironmentSummaryT>(value)); return *this;}
    ///@}
    ...
    template<typename HostT = Host>
    CreateEnvironmentHostResult& WithHost(HostT&& value) { SetHost(std::forward<HostT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateEnvironmentHostResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
