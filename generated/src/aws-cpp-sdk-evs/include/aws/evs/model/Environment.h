...
class Environment {
 public:
  ...
  inline Environment& WithEnvironmentState(EnvironmentState value) {
  ...
  inline Environment& WithVcfVersion(VcfVersion value) {
    SetVcfVersion(value);
    return *this;
  }
  ///@}
  ...
  inline Environment& WithTermsAccepted(bool value) {
   ...
   * VCF subscriptions section</a> in the <i>Amazon EVS User Guide</i>.</p>
   */
  ...
  inline Environment& WithEnvironmentStatus(CheckResult value) {
