...
class ListEnvironmentsResult {
 public:
  ...
  void SetEnvironmentSummaries(EnvironmentSummariesT&& value) {
    m_environmentSummariesHasBeenSet = true;
    m_environmentSummaries = std::forward<EnvironmentSummariesT>(value);
  }
  template <typename EnvironmentSummariesT = Aws::Vector<EnvironmentSummary>>
  ListEnvironmentsResult& WithEnvironmentSummaries(EnvironmentSummariesT&& value) {
    SetEnvironmentSummaries(std::forward<EnvironmentSummariesT>(value));
    return *this;
  }
  template <typename EnvironmentSummariesT = EnvironmentSummary>
  ListEnvironmentsResult& AddEnvironmentSummaries(EnvironmentSummariesT&& value) {
    m_environmentSummariesHasBeenSet = true;
    m_environmentSummaries.emplace_back(std::forward<EnvironmentSummariesT>(value));
    return *this;
  }
  ///@}
