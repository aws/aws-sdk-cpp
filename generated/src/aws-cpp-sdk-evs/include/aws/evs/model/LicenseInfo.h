...
class LicenseInfo {
 public:
  ...
  void SetSolutionKey(SolutionKeyT&& value) {
    ...
    m_solutionKey = std::forward<SolutionKeyT>(value);
  }
  template <typename SolutionKeyT = Aws::String>
  LicenseInfo& WithSolutionKey(SolutionKeyT&& value) {
    SetSolutionKey(std::forward<SolutionKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVsanKey(VsanKeyT&& value) {
    ...
    m_vsanKey = std::forward<VsanKeyT>(value);
  }
  template <typename VsanKeyT = Aws::String>
  LicenseInfo& WithVsanKey(VsanKeyT&& value) {
    SetVsanKey(std::forward<VsanKeyT>(value));
    return *this;
  }
  ///@}
 private:
