 ...
 * overlay network.</p>  <p>Not supported when <code>vcfVersion</code> is
 * <code>SELF_DEPLOYED</code>.</p> <p><h3>See Also:</h3>   <a
...
class ConnectivityInfo {
 public:
  ...
  void SetPrivateRouteServerPeerings(PrivateRouteServerPeeringsT&& value) {
    m_privateRouteServerPeeringsHasBeenSet = true;
    m_privateRouteServerPeerings = std::forward<PrivateRouteServerPeeringsT>(value);
  }
  template <typename PrivateRouteServerPeeringsT = Aws::Vector<Aws::String>>
  ConnectivityInfo& WithPrivateRouteServerPeerings(PrivateRouteServerPeeringsT&& value) {
    SetPrivateRouteServerPeerings(std::forward<PrivateRouteServerPeeringsT>(value));
    return *this;
  }
  template <typename PrivateRouteServerPeeringsT = Aws::String>
  ConnectivityInfo& AddPrivateRouteServerPeerings(PrivateRouteServerPeeringsT&& value) {
    m_privateRouteServerPeeringsHasBeenSet = true;
    m_privateRouteServerPeerings.emplace_back(std::forward<PrivateRouteServerPeeringsT>(value));
    return *this;
  }
  ///@}
 private:
