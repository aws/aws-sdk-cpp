...
class ListEnvironmentVlansResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentVlansResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetEnvironmentVlans(EnvironmentVlansT&& value) {
    m_environmentVlansHasBeenSet = true;
    m_environmentVlans = std::forward<EnvironmentVlansT>(value);
  }
  template <typename EnvironmentVlansT = Aws::Vector<Vlan>>
  ListEnvironmentVlansResult& WithEnvironmentVlans(EnvironmentVlansT&& value) {
    SetEnvironmentVlans(std::forward<EnvironmentVlansT>(value));
    return *this;
  }
  template <typename EnvironmentVlansT = Vlan>
  ListEnvironmentVlansResult& AddEnvironmentVlans(EnvironmentVlansT&& value) {
    m_environmentVlansHasBeenSet = true;
    m_environmentVlans.emplace_back(std::forward<EnvironmentVlansT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListEnvironmentVlansResult& WithRequestId(RequestIdT&& value) {
