...
class EnvironmentSummary {
 public:
  ...
  inline EnvironmentSummary& WithVcfVersion(VcfVersion value) {
    SetVcfVersion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnvironmentStatus(CheckResult value) {
    m_environmentStatusHasBeenSet = true;
    m_environmentStatus = value;
  }
  inline EnvironmentSummary& WithEnvironmentStatus(CheckResult value) {
    SetEnvironmentStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnvironmentState(EnvironmentState value) {
    m_environmentStateHasBeenSet = true;
    m_environmentState = value;
  }
  inline EnvironmentSummary& WithEnvironmentState(EnvironmentState value) {
