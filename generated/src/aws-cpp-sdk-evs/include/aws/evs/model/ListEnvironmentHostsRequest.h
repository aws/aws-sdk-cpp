...
class ListEnvironmentHostsRequest : public EVSRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentHostsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEnvironmentHostsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename EnvironmentIdT = Aws::String>
  ListEnvironmentHostsRequest& WithEnvironmentId(EnvironmentIdT&& value) {
