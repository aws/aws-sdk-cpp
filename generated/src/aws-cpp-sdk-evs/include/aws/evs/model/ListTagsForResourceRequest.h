...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public EVSRequest
  {
  public:
    AWS_EVS_API ListTagsForResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) that identifies the resource to list tags
     * for.</p>
     */
