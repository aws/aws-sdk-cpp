...
/**
 */
class ListVmEntitlementsRequest : public EVSRequest {
 public:
  AWS_EVS_API ListVmEntitlementsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListVmEntitlements"; }
  ...
  template <typename NextTokenT = Aws::String>
  ListVmEntitlementsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListVmEntitlementsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename EnvironmentIdT = Aws::String>
  ListVmEntitlementsRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename ConnectorIdT = Aws::String>
  ListVmEntitlementsRequest& WithConnectorId(ConnectorIdT&& value) {
  ...
  inline ListVmEntitlementsRequest& WithEntitlementType(EntitlementType value) {
