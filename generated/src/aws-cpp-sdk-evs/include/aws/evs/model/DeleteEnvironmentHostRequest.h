...
class DeleteEnvironmentHostRequest : public EVSRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteEnvironmentHostRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  DeleteEnvironmentHostRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename HostNameT = Aws::String>
  DeleteEnvironmentHostRequest& WithHostName(HostNameT&& value) {
