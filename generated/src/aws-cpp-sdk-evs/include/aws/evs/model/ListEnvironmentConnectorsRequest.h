...
/**
 */
class ListEnvironmentConnectorsRequest : public EVSRequest {
 public:
  AWS_EVS_API ListEnvironmentConnectorsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListEnvironmentConnectors"; }
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentConnectorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEnvironmentConnectorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename EnvironmentIdT = Aws::String>
  ListEnvironmentConnectorsRequest& WithEnvironmentId(EnvironmentIdT&& value) {
