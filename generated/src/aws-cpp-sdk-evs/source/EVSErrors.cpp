...
namespace EVS {
template <>
AWS_EVS_API ThrottlingException EVSError::GetModeledError() {
  assert(this->GetErrorType() == EVSErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_EVS_API ResourceNotFoundException EVSError::GetModeledError() {
  assert(this->GetErrorType() == EVSErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_EVS_API ValidationException EVSError::GetModeledError() {
