...
DeleteEntitlementResult::DeleteEntitlementResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteEntitlementResult& DeleteEntitlementResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
