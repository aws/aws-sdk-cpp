...
ListEnvironmentConnectorsResult::ListEnvironmentConnectorsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListEnvironmentConnectorsResult& ListEnvironmentConnectorsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
