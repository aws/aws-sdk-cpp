...
DeleteEnvironmentHostResult::DeleteEnvironmentHostResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteEnvironmentHostResult& DeleteEnvironmentHostResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
