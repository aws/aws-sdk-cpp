...
class ImportPhoneNumberRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ImportPhoneNumberRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename SourcePhoneNumberArnT = Aws::String>
  ImportPhoneNumberRequest& WithSourcePhoneNumberArn(SourcePhoneNumberArnT&& value) {
  ...
  template <typename PhoneNumberDescriptionT = Aws::String>
  ImportPhoneNumberRequest& WithPhoneNumberDescription(PhoneNumberDescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ImportPhoneNumberRequest& WithTags(TagsT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  ImportPhoneNumberRequest& WithClientToken(ClientTokenT&& value) {
