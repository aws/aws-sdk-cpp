...
class DescribePhoneNumberResult {
 public:
  ...
  void SetClaimedPhoneNumberSummary(ClaimedPhoneNumberSummaryT&& value) {
    m_claimedPhoneNumberSummaryHasBeenSet = true;
    m_claimedPhoneNumberSummary = std::forward<ClaimedPhoneNumberSummaryT>(value);
  }
  template <typename ClaimedPhoneNumberSummaryT = ClaimedPhoneNumberSummary>
  DescribePhoneNumberResult& WithClaimedPhoneNumberSummary(ClaimedPhoneNumberSummaryT&& value) {
    SetClaimedPhoneNumberSummary(std::forward<ClaimedPhoneNumberSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribePhoneNumberResult& WithRequestId(RequestIdT&& value) {
