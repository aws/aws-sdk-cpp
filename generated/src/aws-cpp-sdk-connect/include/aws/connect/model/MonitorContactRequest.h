...
class MonitorContactRequest : public ConnectRequest {
 public:
  ...
  void SetAllowedMonitorCapabilities(AllowedMonitorCapabilitiesT&& value) {
    m_allowedMonitorCapabilitiesHasBeenSet = true;
    m_allowedMonitorCapabilities = std::forward<AllowedMonitorCapabilitiesT>(value);
  }
  template <typename AllowedMonitorCapabilitiesT = Aws::Vector<MonitorCapability>>
  MonitorContactRequest& WithAllowedMonitorCapabilities(AllowedMonitorCapabilitiesT&& value) {
    SetAllowedMonitorCapabilities(std::forward<AllowedMonitorCapabilitiesT>(value));
    return *this;
  }
  inline MonitorContactRequest& AddAllowedMonitorCapabilities(MonitorCapability value) {
    m_allowedMonitorCapabilitiesHasBeenSet = true;
    m_allowedMonitorCapabilities.push_back(value);
    return *this;
  }
  ///@}
