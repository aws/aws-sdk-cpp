...
class ListContactFlowsResult {
 public:
  ...
  void SetContactFlowSummaryList(ContactFlowSummaryListT&& value) {
    m_contactFlowSummaryListHasBeenSet = true;
    m_contactFlowSummaryList = std::forward<ContactFlowSummaryListT>(value);
  }
  template <typename ContactFlowSummaryListT = Aws::Vector<ContactFlowSummary>>
  ListContactFlowsResult& WithContactFlowSummaryList(ContactFlowSummaryListT&& value) {
    SetContactFlowSummaryList(std::forward<ContactFlowSummaryListT>(value));
    return *this;
  }
  template <typename ContactFlowSummaryListT = ContactFlowSummary>
  ListContactFlowsResult& AddContactFlowSummaryList(ContactFlowSummaryListT&& value) {
    m_contactFlowSummaryListHasBeenSet = true;
    m_contactFlowSummaryList.emplace_back(std::forward<ContactFlowSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContactFlowsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListContactFlowsResult& WithRequestId(RequestIdT&& value) {
