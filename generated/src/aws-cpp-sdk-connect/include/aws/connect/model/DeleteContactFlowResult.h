...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DeleteContactFlowResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteContactFlowResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
