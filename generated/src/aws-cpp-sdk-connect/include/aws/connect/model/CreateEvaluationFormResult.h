...
class CreateEvaluationFormResult {
 public:
  ...
  template <typename EvaluationFormIdT = Aws::String>
  CreateEvaluationFormResult& WithEvaluationFormId(EvaluationFormIdT&& value) {
  ...
  template <typename EvaluationFormArnT = Aws::String>
  CreateEvaluationFormResult& WithEvaluationFormArn(EvaluationFormArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEvaluationFormResult& WithRequestId(RequestIdT&& value) {
