...
class ListTaskTemplatesResult {
 public:
  ...
  void SetTaskTemplates(TaskTemplatesT&& value) {
    m_taskTemplatesHasBeenSet = true;
    m_taskTemplates = std::forward<TaskTemplatesT>(value);
  }
  template <typename TaskTemplatesT = Aws::Vector<TaskTemplateMetadata>>
  ListTaskTemplatesResult& WithTaskTemplates(TaskTemplatesT&& value) {
    SetTaskTemplates(std::forward<TaskTemplatesT>(value));
    return *this;
  }
  template <typename TaskTemplatesT = TaskTemplateMetadata>
  ListTaskTemplatesResult& AddTaskTemplates(TaskTemplatesT&& value) {
    m_taskTemplatesHasBeenSet = true;
    m_taskTemplates.emplace_back(std::forward<TaskTemplatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTaskTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTaskTemplatesResult& WithRequestId(RequestIdT&& value) {
