...
class ParticipantCapabilities {
 public:
  ...
  inline void SetVideo(VideoCapability value) {
    m_videoHasBeenSet = true;
    m_video = value;
  }
  inline ParticipantCapabilities& WithVideo(VideoCapability value) {
    SetVideo(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScreenShare(ScreenShareCapability value) {
    m_screenShareHasBeenSet = true;
    m_screenShare = value;
  }
  inline ParticipantCapabilities& WithScreenShare(ScreenShareCapability value) {
