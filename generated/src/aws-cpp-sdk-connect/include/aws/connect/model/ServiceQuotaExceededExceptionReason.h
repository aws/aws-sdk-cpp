...
class ServiceQuotaExceededExceptionReason {
 public:
   ...
   * quota</p>
   */
  inline AttachedFileServiceQuotaExceededExceptionReason GetAttachedFileServiceQuotaExceededExceptionReason() const {
    return m_attachedFileServiceQuotaExceededExceptionReason;
  }
  inline bool AttachedFileServiceQuotaExceededExceptionReasonHasBeenSet() const {
    return m_attachedFileServiceQuotaExceededExceptionReasonHasBeenSet;
  }
  inline void SetAttachedFileServiceQuotaExceededExceptionReason(AttachedFileServiceQuotaExceededExceptionReason value) {
    m_attachedFileServiceQuotaExceededExceptionReasonHasBeenSet = true;
    m_attachedFileServiceQuotaExceededExceptionReason = value;
  }
  inline ServiceQuotaExceededExceptionReason& WithAttachedFileServiceQuotaExceededExceptionReason(
      AttachedFileServiceQuotaExceededExceptionReason value) {
    SetAttachedFileServiceQuotaExceededExceptionReason(value);
    return *this;
  }
  ///@}
 private:
  AttachedFileServiceQuotaExceededExceptionReason m_attachedFileServiceQuotaExceededExceptionReason{
      AttachedFileServiceQuotaExceededExceptionReason::NOT_SET};
