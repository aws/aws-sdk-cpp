...
class ContactFlowSearchCriteria {
 public:
  ...
  inline void SetTypeCondition(ContactFlowType value) {
    m_typeConditionHasBeenSet = true;
    m_typeCondition = value;
  }
  inline ContactFlowSearchCriteria& WithTypeCondition(ContactFlowType value) {
  ...
  inline void SetStateCondition(ContactFlowState value) {
    m_stateConditionHasBeenSet = true;
    m_stateCondition = value;
  }
  inline ContactFlowSearchCriteria& WithStateCondition(ContactFlowState value) {
  ...
  inline void SetStatusCondition(ContactFlowStatus value) {
    m_statusConditionHasBeenSet = true;
    m_statusCondition = value;
  }
  inline ContactFlowSearchCriteria& WithStatusCondition(ContactFlowStatus value) {
