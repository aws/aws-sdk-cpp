...
class FailedRequest {
 public:
  ...
  template <typename RequestIdentifierT = Aws::String>
  FailedRequest& WithRequestIdentifier(RequestIdentifierT&& value) {
  ...
  inline void SetFailureReasonCode(FailureReasonCode value) {
    m_failureReasonCodeHasBeenSet = true;
    m_failureReasonCode = value;
  }
  inline FailedRequest& WithFailureReasonCode(FailureReasonCode value) {
  ...
  void SetFailureReasonMessage(FailureReasonMessageT&& value) {
    m_failureReasonMessageHasBeenSet = true;
    m_failureReasonMessage = std::forward<FailureReasonMessageT>(value);
  }
  template <typename FailureReasonMessageT = Aws::String>
  FailedRequest& WithFailureReasonMessage(FailureReasonMessageT&& value) {
    SetFailureReasonMessage(std::forward<FailureReasonMessageT>(value));
    return *this;
  }
  ///@}
 private:
