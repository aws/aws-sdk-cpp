...
class UpdateUserHierarchyStructureRequest : public ConnectRequest {
 public:
  ...
  template <typename HierarchyStructureT = HierarchyStructureUpdate>
  UpdateUserHierarchyStructureRequest& WithHierarchyStructure(HierarchyStructureT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateUserHierarchyStructureRequest& WithInstanceId(InstanceIdT&& value) {
