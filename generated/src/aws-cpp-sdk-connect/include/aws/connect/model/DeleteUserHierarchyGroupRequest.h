...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DeleteUserHierarchyGroupRequest() = default;
    ...
    template<typename HierarchyGroupIdT = Aws::String>
    DeleteUserHierarchyGroupRequest& WithHierarchyGroupId(HierarchyGroupIdT&& value) { SetHierarchyGroupId(std::forward<HierarchyGroupIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceIdT = Aws::String>
    DeleteUserHierarchyGroupRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
  private:
