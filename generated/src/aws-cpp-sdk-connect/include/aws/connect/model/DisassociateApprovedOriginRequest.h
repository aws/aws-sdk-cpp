...
class DisassociateApprovedOriginRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DisassociateApprovedOriginRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename OriginT = Aws::String>
  DisassociateApprovedOriginRequest& WithOrigin(OriginT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DisassociateApprovedOriginRequest& WithClientToken(ClientTokenT&& value) {
