...
class SearchQueuesRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  SearchQueuesRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  SearchQueuesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchQueuesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename SearchFilterT = QueueSearchFilter>
  SearchQueuesRequest& WithSearchFilter(SearchFilterT&& value) {
  ...
  template <typename SearchCriteriaT = QueueSearchCriteria>
  SearchQueuesRequest& WithSearchCriteria(SearchCriteriaT&& value) {
