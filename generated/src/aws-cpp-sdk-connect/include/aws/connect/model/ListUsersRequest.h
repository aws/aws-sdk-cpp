...
namespace Model
{
  ...
  /**
   */
  class ListUsersRequest : public ConnectRequest
  {
  public:
    AWS_CONNECT_API ListUsersRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    ListUsersRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
