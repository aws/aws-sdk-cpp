...
class HierarchyStructureUpdate {
 public:
  ...
  void SetLevelOne(LevelOneT&& value) {
    ...
    m_levelOne = std::forward<LevelOneT>(value);
  }
  template <typename LevelOneT = HierarchyLevelUpdate>
  HierarchyStructureUpdate& WithLevelOne(LevelOneT&& value) {
    SetLevelOne(std::forward<LevelOneT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLevelTwo(LevelTwoT&& value) {
    ...
    m_levelTwo = std::forward<LevelTwoT>(value);
  }
  template <typename LevelTwoT = HierarchyLevelUpdate>
  HierarchyStructureUpdate& WithLevelTwo(LevelTwoT&& value) {
    SetLevelTwo(std::forward<LevelTwoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLevelThree(LevelThreeT&& value) {
    ...
    m_levelThree = std::forward<LevelThreeT>(value);
  }
  template <typename LevelThreeT = HierarchyLevelUpdate>
  HierarchyStructureUpdate& WithLevelThree(LevelThreeT&& value) {
    SetLevelThree(std::forward<LevelThreeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLevelFour(LevelFourT&& value) {
    ...
    m_levelFour = std::forward<LevelFourT>(value);
  }
  template <typename LevelFourT = HierarchyLevelUpdate>
  HierarchyStructureUpdate& WithLevelFour(LevelFourT&& value) {
    SetLevelFour(std::forward<LevelFourT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLevelFive(LevelFiveT&& value) {
    ...
    m_levelFive = std::forward<LevelFiveT>(value);
  }
  template <typename LevelFiveT = HierarchyLevelUpdate>
  HierarchyStructureUpdate& WithLevelFive(LevelFiveT&& value) {
    SetLevelFive(std::forward<LevelFiveT>(value));
    return *this;
  }
  ///@}
 private:
