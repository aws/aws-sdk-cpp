...
class ListContactFlowVersionsResult {
 public:
  ...
  void SetContactFlowVersionSummaryList(ContactFlowVersionSummaryListT&& value) {
    m_contactFlowVersionSummaryListHasBeenSet = true;
    m_contactFlowVersionSummaryList = std::forward<ContactFlowVersionSummaryListT>(value);
  }
  template <typename ContactFlowVersionSummaryListT = Aws::Vector<ContactFlowVersionSummary>>
  ListContactFlowVersionsResult& WithContactFlowVersionSummaryList(ContactFlowVersionSummaryListT&& value) {
    SetContactFlowVersionSummaryList(std::forward<ContactFlowVersionSummaryListT>(value));
    return *this;
  }
  template <typename ContactFlowVersionSummaryListT = ContactFlowVersionSummary>
  ListContactFlowVersionsResult& AddContactFlowVersionSummaryList(ContactFlowVersionSummaryListT&& value) {
    m_contactFlowVersionSummaryListHasBeenSet = true;
    m_contactFlowVersionSummaryList.emplace_back(std::forward<ContactFlowVersionSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContactFlowVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListContactFlowVersionsResult& WithRequestId(RequestIdT&& value) {
