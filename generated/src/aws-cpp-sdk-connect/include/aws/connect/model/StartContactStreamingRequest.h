...
class StartContactStreamingRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  StartContactStreamingRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactIdT = Aws::String>
  StartContactStreamingRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename ChatStreamingConfigurationT = ChatStreamingConfiguration>
  StartContactStreamingRequest& WithChatStreamingConfiguration(ChatStreamingConfigurationT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StartContactStreamingRequest& WithClientToken(ClientTokenT&& value) {
