...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API StartContactStreamingRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    StartContactStreamingRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ContactIdT = Aws::String>
    StartContactStreamingRequest& WithContactId(ContactIdT&& value) { SetContactId(std::forward<ContactIdT>(value)); return *this;}
    ///@}
    ...
    void SetChatStreamingConfiguration(ChatStreamingConfigurationT&& value) { m_chatStreamingConfigurationHasBeenSet = true; m_chatStreamingConfiguration = std::forward<ChatStreamingConfigurationT>(value); }
    template<typename ChatStreamingConfigurationT = ChatStreamingConfiguration>
    StartContactStreamingRequest& WithChatStreamingConfiguration(ChatStreamingConfigurationT&& value) { SetChatStreamingConfiguration(std::forward<ChatStreamingConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    StartContactStreamingRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
  private:
