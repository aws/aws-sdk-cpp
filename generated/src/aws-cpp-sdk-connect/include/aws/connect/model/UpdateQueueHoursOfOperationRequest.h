...
class UpdateQueueHoursOfOperationRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateQueueHoursOfOperationRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  UpdateQueueHoursOfOperationRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename HoursOfOperationIdT = Aws::String>
  UpdateQueueHoursOfOperationRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) {
