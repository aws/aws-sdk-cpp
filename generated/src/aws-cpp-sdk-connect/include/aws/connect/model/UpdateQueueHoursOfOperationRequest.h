...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API UpdateQueueHoursOfOperationRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    UpdateQueueHoursOfOperationRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QueueIdT = Aws::String>
    UpdateQueueHoursOfOperationRequest& WithQueueId(QueueIdT&& value) { SetQueueId(std::forward<QueueIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HoursOfOperationIdT = Aws::String>
    UpdateQueueHoursOfOperationRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) { SetHoursOfOperationId(std::forward<HoursOfOperationIdT>(value)); return *this;}
    ///@}
  private:
