...
class SecurityProfileSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  SecurityProfileSummary& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  SecurityProfileSummary& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  SecurityProfileSummary& WithName(NameT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  SecurityProfileSummary& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename LastModifiedRegionT = Aws::String>
  SecurityProfileSummary& WithLastModifiedRegion(LastModifiedRegionT&& value) {
