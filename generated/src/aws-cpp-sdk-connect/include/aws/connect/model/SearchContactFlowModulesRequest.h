...
class SearchContactFlowModulesRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  SearchContactFlowModulesRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  SearchContactFlowModulesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchContactFlowModulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename SearchFilterT = ContactFlowModuleSearchFilter>
  SearchContactFlowModulesRequest& WithSearchFilter(SearchFilterT&& value) {
  ...
  template <typename SearchCriteriaT = ContactFlowModuleSearchCriteria>
  SearchContactFlowModulesRequest& WithSearchCriteria(SearchCriteriaT&& value) {
