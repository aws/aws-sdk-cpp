...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API ListTrafficDistributionGroupUsersRequest();
    ...
    inline ListTrafficDistributionGroupUsersRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ///@}
  private:
