...
class RealTimeContactAnalysisCharacterInterval {
 public:
  ...
  inline void SetBeginOffsetChar(int value) {
    m_beginOffsetCharHasBeenSet = true;
    m_beginOffsetChar = value;
  }
  inline RealTimeContactAnalysisCharacterInterval& WithBeginOffsetChar(int value) {
    SetBeginOffsetChar(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEndOffsetChar(int value) {
    m_endOffsetCharHasBeenSet = true;
    m_endOffsetChar = value;
  }
  inline RealTimeContactAnalysisCharacterInterval& WithEndOffsetChar(int value) {
    SetEndOffsetChar(value);
    return *this;
  }
  ///@}
 private:
