...
/**
 * <p>A batch delete data table value failure result.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/BatchDeleteDataTableValueFailureResult">AWS
 * API Reference</a></p>
 */
class BatchDeleteDataTableValueFailureResult {
 public:
  AWS_CONNECT_API BatchDeleteDataTableValueFailureResult() = default;
  AWS_CONNECT_API BatchDeleteDataTableValueFailureResult(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECT_API BatchDeleteDataTableValueFailureResult& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename PrimaryValuesT = Aws::Vector<PrimaryValue>>
  BatchDeleteDataTableValueFailureResult& WithPrimaryValues(PrimaryValuesT&& value) {
    SetPrimaryValues(std::forward<PrimaryValuesT>(value));
    return *this;
  }
  template <typename PrimaryValuesT = PrimaryValue>
  BatchDeleteDataTableValueFailureResult& AddPrimaryValues(PrimaryValuesT&& value) {
    m_primaryValuesHasBeenSet = true;
  ...
  template <typename AttributeNameT = Aws::String>
  BatchDeleteDataTableValueFailureResult& WithAttributeName(AttributeNameT&& value) {
  ...
  template <typename MessageT = Aws::String>
  BatchDeleteDataTableValueFailureResult& WithMessage(MessageT&& value) {
