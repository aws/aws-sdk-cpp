...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DescribeContactEvaluationRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeContactEvaluationRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EvaluationIdT = Aws::String>
    DescribeContactEvaluationRequest& WithEvaluationId(EvaluationIdT&& value) { SetEvaluationId(std::forward<EvaluationIdT>(value)); return *this;}
    ///@}
  private:
