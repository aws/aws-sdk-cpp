...
class CreateContactRequest : public ConnectRequest {
 public:
  ...
  inline CreateContactRequest& WithChannel(Channel value) {
    SetChannel(value);
    return *this;
  }
  ///@}
  ...
  inline CreateContactRequest& WithInitiationMethod(ContactInitiationMethod value) {
  ...
  inline void SetExpiryDurationInMinutes(int value) {
    m_expiryDurationInMinutesHasBeenSet = true;
    m_expiryDurationInMinutes = value;
  }
  inline CreateContactRequest& WithExpiryDurationInMinutes(int value) {
    SetExpiryDurationInMinutes(value);
    return *this;
  }
  ///@}
  ...
  void SetUserInfo(UserInfoT&& value) {
    m_userInfoHasBeenSet = true;
    m_userInfo = std::forward<UserInfoT>(value);
  }
  template <typename UserInfoT = UserInfo>
  CreateContactRequest& WithUserInfo(UserInfoT&& value) {
    SetUserInfo(std::forward<UserInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInitiateAs(InitiateAs value) {
    m_initiateAsHasBeenSet = true;
    m_initiateAs = value;
  }
  inline CreateContactRequest& WithInitiateAs(InitiateAs value) {
    SetInitiateAs(value);
    return *this;
  }
  ///@}
