...
class RealTimeContactAnalysisTranscriptItemWithContent {
 public:
  ...
  template <typename ContentT = Aws::String>
  RealTimeContactAnalysisTranscriptItemWithContent& WithContent(ContentT&& value) {
  ...
  template <typename IdT = Aws::String>
  RealTimeContactAnalysisTranscriptItemWithContent& WithId(IdT&& value) {
  ...
  template <typename CharacterOffsetsT = RealTimeContactAnalysisCharacterInterval>
  RealTimeContactAnalysisTranscriptItemWithContent& WithCharacterOffsets(CharacterOffsetsT&& value) {
