...
class PropertyValidationExceptionProperty {
 public:
  ...
  inline void SetReason(PropertyValidationExceptionReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline PropertyValidationExceptionProperty& WithReason(PropertyValidationExceptionReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
