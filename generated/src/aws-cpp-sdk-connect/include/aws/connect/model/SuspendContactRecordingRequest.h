...
namespace Model
{
  ...
  public:
    ...
    inline SuspendContactRecordingRequest& WithContactRecordingType(const ContactRecordingType& value) { SetContactRecordingType(value); return *this;}
    inline SuspendContactRecordingRequest& WithContactRecordingType(ContactRecordingType&& value) { SetContactRecordingType(std::move(value)); return *this;}
    ///@}
  private:
