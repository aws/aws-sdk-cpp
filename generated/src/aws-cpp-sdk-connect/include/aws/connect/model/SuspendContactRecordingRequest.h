...
class SuspendContactRecordingRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  SuspendContactRecordingRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactIdT = Aws::String>
  SuspendContactRecordingRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename InitialContactIdT = Aws::String>
  SuspendContactRecordingRequest& WithInitialContactId(InitialContactIdT&& value) {
  ...
  inline SuspendContactRecordingRequest& WithContactRecordingType(ContactRecordingType value) {
