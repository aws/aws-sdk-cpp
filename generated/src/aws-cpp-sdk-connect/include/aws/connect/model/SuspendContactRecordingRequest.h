...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API SuspendContactRecordingRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    SuspendContactRecordingRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ContactIdT = Aws::String>
    SuspendContactRecordingRequest& WithContactId(ContactIdT&& value) { SetContactId(std::forward<ContactIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InitialContactIdT = Aws::String>
    SuspendContactRecordingRequest& WithInitialContactId(InitialContactIdT&& value) { SetInitialContactId(std::forward<InitialContactIdT>(value)); return *this;}
    ///@}
    ...
    inline SuspendContactRecordingRequest& WithContactRecordingType(ContactRecordingType value) { SetContactRecordingType(value); return *this;}
    ///@}
  private:
