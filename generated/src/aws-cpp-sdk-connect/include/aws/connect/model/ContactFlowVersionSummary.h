...
class ContactFlowVersionSummary {
 public:
  ...
  template <typename ArnT = Aws::String>
  ContactFlowVersionSummary& WithArn(ArnT&& value) {
  ...
  template <typename VersionDescriptionT = Aws::String>
  ContactFlowVersionSummary& WithVersionDescription(VersionDescriptionT&& value) {
  ...
  inline ContactFlowVersionSummary& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
