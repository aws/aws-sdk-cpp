...
namespace Model
{
  ...
  public:
    ...
    void SetEvaluationSummaryList(EvaluationSummaryListT&& value) { m_evaluationSummaryListHasBeenSet = true; m_evaluationSummaryList = std::forward<EvaluationSummaryListT>(value); }
    template<typename EvaluationSummaryListT = Aws::Vector<EvaluationSummary>>
    ListContactEvaluationsResult& WithEvaluationSummaryList(EvaluationSummaryListT&& value) { SetEvaluationSummaryList(std::forward<EvaluationSummaryListT>(value)); return *this;}
    template<typename EvaluationSummaryListT = EvaluationSummary>
    ListContactEvaluationsResult& AddEvaluationSummaryList(EvaluationSummaryListT&& value) { m_evaluationSummaryListHasBeenSet = true; m_evaluationSummaryList.emplace_back(std::forward<EvaluationSummaryListT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListContactEvaluationsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListContactEvaluationsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
