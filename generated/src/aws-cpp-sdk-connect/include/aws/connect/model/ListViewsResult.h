...
class ListViewsResult {
 public:
  ...
  void SetViewsSummaryList(ViewsSummaryListT&& value) {
    m_viewsSummaryListHasBeenSet = true;
    m_viewsSummaryList = std::forward<ViewsSummaryListT>(value);
  }
  template <typename ViewsSummaryListT = Aws::Vector<ViewSummary>>
  ListViewsResult& WithViewsSummaryList(ViewsSummaryListT&& value) {
    SetViewsSummaryList(std::forward<ViewsSummaryListT>(value));
    return *this;
  }
  template <typename ViewsSummaryListT = ViewSummary>
  ListViewsResult& AddViewsSummaryList(ViewsSummaryListT&& value) {
    m_viewsSummaryListHasBeenSet = true;
    m_viewsSummaryList.emplace_back(std::forward<ViewsSummaryListT>(value));
    return *this;
  }
  ///@}
