...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DescribeHoursOfOperationRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeHoursOfOperationRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HoursOfOperationIdT = Aws::String>
    DescribeHoursOfOperationRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) { SetHoursOfOperationId(std::forward<HoursOfOperationIdT>(value)); return *this;}
    ///@}
  private:
