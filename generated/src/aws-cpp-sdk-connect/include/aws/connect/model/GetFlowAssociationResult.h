...
class GetFlowAssociationResult {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  GetFlowAssociationResult& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename FlowIdT = Aws::String>
  GetFlowAssociationResult& WithFlowId(FlowIdT&& value) {
  ...
  inline void SetResourceType(FlowAssociationResourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline GetFlowAssociationResult& WithResourceType(FlowAssociationResourceType value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFlowAssociationResult& WithRequestId(RequestIdT&& value) {
