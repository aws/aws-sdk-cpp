...
class CreateTrafficDistributionGroupResult {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateTrafficDistributionGroupResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateTrafficDistributionGroupResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTrafficDistributionGroupResult& WithRequestId(RequestIdT&& value) {
