...
class SearchAgentStatusesResult {
 public:
  ...
  template <typename AgentStatusesT = Aws::Vector<AgentStatus>>
  SearchAgentStatusesResult& WithAgentStatuses(AgentStatusesT&& value) {
    SetAgentStatuses(std::forward<AgentStatusesT>(value));
    return *this;
  }
  template <typename AgentStatusesT = AgentStatus>
  SearchAgentStatusesResult& AddAgentStatuses(AgentStatusesT&& value) {
    m_agentStatusesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchAgentStatusesResult& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchAgentStatusesResult& WithApproximateTotalCount(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchAgentStatusesResult& WithRequestId(RequestIdT&& value) {
