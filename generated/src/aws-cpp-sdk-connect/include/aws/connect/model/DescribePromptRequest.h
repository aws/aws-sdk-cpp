...
class DescribePromptRequest : public ConnectRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DescribePrompt"; }
  ...
  template <typename InstanceIdT = Aws::String>
  DescribePromptRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename PromptIdT = Aws::String>
  DescribePromptRequest& WithPromptId(PromptIdT&& value) {
