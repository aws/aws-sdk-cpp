...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API StartEmailContactResult() = default;
    ...
    template<typename ContactIdT = Aws::String>
    StartEmailContactResult& WithContactId(ContactIdT&& value) { SetContactId(std::forward<ContactIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartEmailContactResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
