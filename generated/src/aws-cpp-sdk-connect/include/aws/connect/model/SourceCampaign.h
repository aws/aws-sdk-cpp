...
class SourceCampaign {
 public:
  ...
  template <typename CampaignIdT = Aws::String>
  SourceCampaign& WithCampaignId(CampaignIdT&& value) {
  ...
  void SetOutboundRequestId(OutboundRequestIdT&& value) {
    m_outboundRequestIdHasBeenSet = true;
    m_outboundRequestId = std::forward<OutboundRequestIdT>(value);
  }
  template <typename OutboundRequestIdT = Aws::String>
  SourceCampaign& WithOutboundRequestId(OutboundRequestIdT&& value) {
    SetOutboundRequestId(std::forward<OutboundRequestIdT>(value));
    return *this;
  }
  ///@}
 private:
