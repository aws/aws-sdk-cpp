...
class RealTimeContactAnalysisTranscriptItemWithCharacterOffsets {
 public:
  ...
  template <typename IdT = Aws::String>
  RealTimeContactAnalysisTranscriptItemWithCharacterOffsets& WithId(IdT&& value) {
  ...
  void SetCharacterOffsets(CharacterOffsetsT&& value) {
    ...
    m_characterOffsets = std::forward<CharacterOffsetsT>(value);
  }
  template <typename CharacterOffsetsT = RealTimeContactAnalysisCharacterInterval>
  RealTimeContactAnalysisTranscriptItemWithCharacterOffsets& WithCharacterOffsets(CharacterOffsetsT&& value) {
    SetCharacterOffsets(std::forward<CharacterOffsetsT>(value));
    return *this;
  }
  ///@}
 private:
