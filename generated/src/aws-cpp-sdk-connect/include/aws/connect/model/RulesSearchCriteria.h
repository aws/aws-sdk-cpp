...
/**
 * <p>The search criteria to be used to return rules.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/RulesSearchCriteria">AWS
 * API Reference</a></p>
 */
class RulesSearchCriteria {
 public:
   ...
   * condition.</p>
   */
  inline const Aws::Vector<RulesSearchCriteria>& GetOrConditions() const { return m_orConditions; }
  inline bool OrConditionsHasBeenSet() const { return m_orConditionsHasBeenSet; }
  template <typename OrConditionsT = Aws::Vector<RulesSearchCriteria>>
  ...
  template <typename OrConditionsT = RulesSearchCriteria>
   ...
   * condition.</p>
   */
  inline const Aws::Vector<RulesSearchCriteria>& GetAndConditions() const { return m_andConditions; }
  inline bool AndConditionsHasBeenSet() const { return m_andConditionsHasBeenSet; }
  template <typename AndConditionsT = Aws::Vector<RulesSearchCriteria>>
  ...
  template <typename AndConditionsT = RulesSearchCriteria>
   ...
   * <code>Name</code>, <code>PublishStatus</code>, <code>EventSourceName</code>,
   * <code>RuleId</code>, <code>IntegrationAssociationId</code>,
   * <code>ActionSummaries</code>, and <code>RuleCapabilityTiers</code>.</p>
   */
  ...
  ///@}
 private:
  Aws::Vector<RulesSearchCriteria> m_orConditions;

  Aws::Vector<RulesSearchCriteria> m_andConditions;
