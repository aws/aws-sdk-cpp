...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/PromptSearchFilter">AWS
   * API Reference</a></p>
   */
  class PromptSearchFilter
  {
  public:
    AWS_CONNECT_API PromptSearchFilter();
    AWS_CONNECT_API PromptSearchFilter(Aws::Utils::Json::JsonView jsonValue);
    AWS_CONNECT_API PromptSearchFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline PromptSearchFilter& WithTagFilter(const ControlPlaneTagFilter& value) { SetTagFilter(value); return *this;}

    
    inline PromptSearchFilter& WithTagFilter(ControlPlaneTagFilter&& value) { SetTagFilter(std::move(value)); return *this;}
