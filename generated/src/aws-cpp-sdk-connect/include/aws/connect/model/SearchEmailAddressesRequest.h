...
class SearchEmailAddressesRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  SearchEmailAddressesRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline SearchEmailAddressesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchEmailAddressesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SearchCriteriaT = EmailAddressSearchCriteria>
  SearchEmailAddressesRequest& WithSearchCriteria(SearchCriteriaT&& value) {
  ...
  template <typename SearchFilterT = EmailAddressSearchFilter>
  SearchEmailAddressesRequest& WithSearchFilter(SearchFilterT&& value) {
