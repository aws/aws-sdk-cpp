...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API SearchEmailAddressesRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    SearchEmailAddressesRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    SearchEmailAddressesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename SearchCriteriaT = EmailAddressSearchCriteria>
    ...
    template<typename SearchCriteriaT = EmailAddressSearchCriteria>
    SearchEmailAddressesRequest& WithSearchCriteria(SearchCriteriaT&& value) { SetSearchCriteria(std::forward<SearchCriteriaT>(value)); return *this;}
    ///@}
    ...
    template<typename SearchFilterT = EmailAddressSearchFilter>
    void SetSearchFilter(SearchFilterT&& value) { m_searchFilterHasBeenSet = true; m_searchFilter = std::forward<SearchFilterT>(value); }
    template<typename SearchFilterT = EmailAddressSearchFilter>
    SearchEmailAddressesRequest& WithSearchFilter(SearchFilterT&& value) { SetSearchFilter(std::forward<SearchFilterT>(value)); return *this;}
    ///@}
  private:
