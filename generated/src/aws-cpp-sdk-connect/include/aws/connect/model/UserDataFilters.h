...
class UserDataFilters {
 public:
  ...
  template <typename QueuesT = Aws::Vector<Aws::String>>
  UserDataFilters& WithQueues(QueuesT&& value) {
    SetQueues(std::forward<QueuesT>(value));
    return *this;
  }
  template <typename QueuesT = Aws::String>
  UserDataFilters& AddQueues(QueuesT&& value) {
    m_queuesHasBeenSet = true;
  ...
  void SetContactFilter(ContactFilterT&& value) {
    m_contactFilterHasBeenSet = true;
    m_contactFilter = std::forward<ContactFilterT>(value);
  }
  template <typename ContactFilterT = ContactFilter>
  UserDataFilters& WithContactFilter(ContactFilterT&& value) {
    SetContactFilter(std::forward<ContactFilterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RoutingProfilesT = Aws::Vector<Aws::String>>
  UserDataFilters& WithRoutingProfiles(RoutingProfilesT&& value) {
    SetRoutingProfiles(std::forward<RoutingProfilesT>(value));
    return *this;
  }
  template <typename RoutingProfilesT = Aws::String>
  UserDataFilters& AddRoutingProfiles(RoutingProfilesT&& value) {
    m_routingProfilesHasBeenSet = true;
  ...
  void SetAgents(AgentsT&& value) {
    ...
    m_agents = std::forward<AgentsT>(value);
  }
  template <typename AgentsT = Aws::Vector<Aws::String>>
  UserDataFilters& WithAgents(AgentsT&& value) {
    SetAgents(std::forward<AgentsT>(value));
    return *this;
  }
  template <typename AgentsT = Aws::String>
  UserDataFilters& AddAgents(AgentsT&& value) {
    m_agentsHasBeenSet = true;
    m_agents.emplace_back(std::forward<AgentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserHierarchyGroups(UserHierarchyGroupsT&& value) {
    ...
    m_userHierarchyGroups = std::forward<UserHierarchyGroupsT>(value);
  }
  template <typename UserHierarchyGroupsT = Aws::Vector<Aws::String>>
  UserDataFilters& WithUserHierarchyGroups(UserHierarchyGroupsT&& value) {
    SetUserHierarchyGroups(std::forward<UserHierarchyGroupsT>(value));
    return *this;
  }
  template <typename UserHierarchyGroupsT = Aws::String>
  UserDataFilters& AddUserHierarchyGroups(UserHierarchyGroupsT&& value) {
    m_userHierarchyGroupsHasBeenSet = true;
    m_userHierarchyGroups.emplace_back(std::forward<UserHierarchyGroupsT>(value));
    return *this;
  }
  ///@}
 private:
