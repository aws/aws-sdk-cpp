...
class UpdateEmailAddressMetadataResult {
 public:
  ...
  template <typename EmailAddressIdT = Aws::String>
  UpdateEmailAddressMetadataResult& WithEmailAddressId(EmailAddressIdT&& value) {
  ...
  template <typename EmailAddressArnT = Aws::String>
  UpdateEmailAddressMetadataResult& WithEmailAddressArn(EmailAddressArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateEmailAddressMetadataResult& WithRequestId(RequestIdT&& value) {
