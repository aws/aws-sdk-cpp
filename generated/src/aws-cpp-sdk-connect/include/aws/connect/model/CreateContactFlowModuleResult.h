...
class CreateContactFlowModuleResult {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateContactFlowModuleResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateContactFlowModuleResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateContactFlowModuleResult& WithRequestId(RequestIdT&& value) {
