...
class AgentStatusReference {
 public:
  ...
  void SetStatusStartTimestamp(StatusStartTimestampT&& value) {
    m_statusStartTimestampHasBeenSet = true;
    m_statusStartTimestamp = std::forward<StatusStartTimestampT>(value);
  }
  template <typename StatusStartTimestampT = Aws::Utils::DateTime>
  AgentStatusReference& WithStatusStartTimestamp(StatusStartTimestampT&& value) {
    SetStatusStartTimestamp(std::forward<StatusStartTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatusArn(StatusArnT&& value) {
    m_statusArnHasBeenSet = true;
    m_statusArn = std::forward<StatusArnT>(value);
  }
  template <typename StatusArnT = Aws::String>
  AgentStatusReference& WithStatusArn(StatusArnT&& value) {
    SetStatusArn(std::forward<StatusArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatusName(StatusNameT&& value) {
    m_statusNameHasBeenSet = true;
    m_statusName = std::forward<StatusNameT>(value);
  }
  template <typename StatusNameT = Aws::String>
  AgentStatusReference& WithStatusName(StatusNameT&& value) {
    SetStatusName(std::forward<StatusNameT>(value));
    return *this;
  }
  ///@}
 private:
