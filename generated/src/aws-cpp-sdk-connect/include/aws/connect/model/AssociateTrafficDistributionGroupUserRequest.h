...
class AssociateTrafficDistributionGroupUserRequest : public ConnectRequest {
 public:
  ...
  template <typename TrafficDistributionGroupIdT = Aws::String>
  AssociateTrafficDistributionGroupUserRequest& WithTrafficDistributionGroupId(TrafficDistributionGroupIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  AssociateTrafficDistributionGroupUserRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  AssociateTrafficDistributionGroupUserRequest& WithInstanceId(InstanceIdT&& value) {
