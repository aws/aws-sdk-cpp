...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DeactivateEvaluationFormRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DeactivateEvaluationFormRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EvaluationFormIdT = Aws::String>
    DeactivateEvaluationFormRequest& WithEvaluationFormId(EvaluationFormIdT&& value) { SetEvaluationFormId(std::forward<EvaluationFormIdT>(value)); return *this;}
    ///@}
