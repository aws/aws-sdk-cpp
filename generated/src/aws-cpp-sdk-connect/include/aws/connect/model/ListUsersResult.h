...
class ListUsersResult {
 public:
  ...
  void SetUserSummaryList(UserSummaryListT&& value) {
    m_userSummaryListHasBeenSet = true;
    m_userSummaryList = std::forward<UserSummaryListT>(value);
  }
  template <typename UserSummaryListT = Aws::Vector<UserSummary>>
  ListUsersResult& WithUserSummaryList(UserSummaryListT&& value) {
    SetUserSummaryList(std::forward<UserSummaryListT>(value));
    return *this;
  }
  template <typename UserSummaryListT = UserSummary>
  ListUsersResult& AddUserSummaryList(UserSummaryListT&& value) {
    m_userSummaryListHasBeenSet = true;
    m_userSummaryList.emplace_back(std::forward<UserSummaryListT>(value));
    return *this;
  }
  ///@}
