...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DeleteContactFlowVersionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteContactFlowVersionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
