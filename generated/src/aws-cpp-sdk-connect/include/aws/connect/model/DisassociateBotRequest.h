...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    DisassociateBotRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LexBotT = LexBot>
    DisassociateBotRequest& WithLexBot(LexBotT&& value) { SetLexBot(std::forward<LexBotT>(value)); return *this;}
    ///@}
    ...
    template<typename LexV2BotT = LexV2Bot>
    DisassociateBotRequest& WithLexV2Bot(LexV2BotT&& value) { SetLexV2Bot(std::forward<LexV2BotT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    DisassociateBotRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
  private:
