...
class UpdateUserHierarchyGroupNameRequest : public ConnectRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateUserHierarchyGroupNameRequest& WithName(NameT&& value) {
  ...
  template <typename HierarchyGroupIdT = Aws::String>
  UpdateUserHierarchyGroupNameRequest& WithHierarchyGroupId(HierarchyGroupIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateUserHierarchyGroupNameRequest& WithInstanceId(InstanceIdT&& value) {
