...
namespace Model
{
  ...
  public:
    ...
    template<typename EmailAddressIdT = Aws::String>
    AssociateEmailAddressAliasRequest& WithEmailAddressId(EmailAddressIdT&& value) { SetEmailAddressId(std::forward<EmailAddressIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceIdT = Aws::String>
    AssociateEmailAddressAliasRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    void SetAliasConfiguration(AliasConfigurationT&& value) { m_aliasConfigurationHasBeenSet = true; m_aliasConfiguration = std::forward<AliasConfigurationT>(value); }
    template<typename AliasConfigurationT = AliasConfiguration>
    AssociateEmailAddressAliasRequest& WithAliasConfiguration(AliasConfigurationT&& value) { SetAliasConfiguration(std::forward<AliasConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    AssociateEmailAddressAliasRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
  private:
