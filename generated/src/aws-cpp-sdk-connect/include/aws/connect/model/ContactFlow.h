...
class ContactFlow {
 public:
   ...
   * a flow type</a> in the <i>Connect Customer Administrator Guide</i>.</p>
   */
  inline ContactFlowType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(ContactFlowType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ContactFlow& WithType(ContactFlowType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(ContactFlowState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ContactFlow& WithState(ContactFlowState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ContactFlowStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ContactFlow& WithStatus(ContactFlowStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetFlowContentSha256(FlowContentSha256T&& value) {
    ...
    m_flowContentSha256 = std::forward<FlowContentSha256T>(value);
  }
  template <typename FlowContentSha256T = Aws::String>
  ContactFlow& WithFlowContentSha256(FlowContentSha256T&& value) {
    SetFlowContentSha256(std::forward<FlowContentSha256T>(value));
    return *this;
  }
  ///@}
  ...
  inline ContactFlow& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
