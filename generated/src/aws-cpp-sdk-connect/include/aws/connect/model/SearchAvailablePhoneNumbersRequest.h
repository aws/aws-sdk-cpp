...
class SearchAvailablePhoneNumbersRequest : public ConnectRequest {
 public:
  ...
  inline SearchAvailablePhoneNumbersRequest& WithPhoneNumberCountryCode(PhoneNumberCountryCode value) {
  ...
  inline SearchAvailablePhoneNumbersRequest& WithPhoneNumberType(PhoneNumberType value) {
  ...
  inline SearchAvailablePhoneNumbersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
