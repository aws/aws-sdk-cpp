...
class CreatePersistentContactAssociationResult {
 public:
  ...
  AWS_CONNECT_API CreatePersistentContactAssociationResult& operator=(
  ...
  template <typename ContinuedFromContactIdT = Aws::String>
  CreatePersistentContactAssociationResult& WithContinuedFromContactId(ContinuedFromContactIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePersistentContactAssociationResult& WithRequestId(RequestIdT&& value) {
