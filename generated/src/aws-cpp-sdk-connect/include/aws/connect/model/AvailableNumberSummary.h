...
class AvailableNumberSummary {
 public:
  ...
  inline AvailableNumberSummary& WithPhoneNumberCountryCode(PhoneNumberCountryCode value) {
  ...
  inline AvailableNumberSummary& WithPhoneNumberType(PhoneNumberType value) {
