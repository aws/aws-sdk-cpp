...
class DeletePushNotificationRegistrationRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API DeletePushNotificationRegistrationRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  DeletePushNotificationRegistrationRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  DeletePushNotificationRegistrationRequest& WithRegistrationId(RegistrationIdT&& value) {
  ...
  template <typename ContactIdT = Aws::String>
  DeletePushNotificationRegistrationRequest& WithContactId(ContactIdT&& value) {
