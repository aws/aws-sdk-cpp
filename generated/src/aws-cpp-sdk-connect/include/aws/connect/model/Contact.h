...
class Contact {
 public:
  ...
  void SetContactAssociationId(ContactAssociationIdT&& value) {
    ...
    m_contactAssociationId = std::forward<ContactAssociationIdT>(value);
  }
  template <typename ContactAssociationIdT = Aws::String>
  Contact& WithContactAssociationId(ContactAssociationIdT&& value) {
    SetContactAssociationId(std::forward<ContactAssociationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline Contact& WithInitiationMethod(ContactInitiationMethod value) {
  ...
  inline Contact& WithChannel(Channel value) {
    SetChannel(value);
    return *this;
  }
  ///@}
  ...
  void SetLastPausedTimestamp(LastPausedTimestampT&& value) {
    ...
    m_lastPausedTimestamp = std::forward<LastPausedTimestampT>(value);
  }
  template <typename LastPausedTimestampT = Aws::Utils::DateTime>
  Contact& WithLastPausedTimestamp(LastPausedTimestampT&& value) {
    SetLastPausedTimestamp(std::forward<LastPausedTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastResumedTimestamp(LastResumedTimestampT&& value) {
    ...
    m_lastResumedTimestamp = std::forward<LastResumedTimestampT>(value);
  }
  template <typename LastResumedTimestampT = Aws::Utils::DateTime>
  Contact& WithLastResumedTimestamp(LastResumedTimestampT&& value) {
    SetLastResumedTimestamp(std::forward<LastResumedTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalPauseCount(int value) {
    m_totalPauseCountHasBeenSet = true;
    m_totalPauseCount = value;
  }
  inline Contact& WithTotalPauseCount(int value) {
    SetTotalPauseCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalPauseDurationInSeconds(int value) {
    m_totalPauseDurationInSecondsHasBeenSet = true;
    m_totalPauseDurationInSeconds = value;
  }
  inline Contact& WithTotalPauseDurationInSeconds(int value) {
    SetTotalPauseDurationInSeconds(value);
    return *this;
  }
  ///@}
  ...
  void SetWisdomInfo(WisdomInfoT&& value) {
    ...
    m_wisdomInfo = std::forward<WisdomInfoT>(value);
  }
  template <typename WisdomInfoT = WisdomInfo>
  Contact& WithWisdomInfo(WisdomInfoT&& value) {
    SetWisdomInfo(std::forward<WisdomInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline Contact& WithQueueTimeAdjustmentSeconds(int value) {
  ...
  inline Contact& WithQueuePriority(long long value) {
  ...
  void SetConnectedToSystemTimestamp(ConnectedToSystemTimestampT&& value) {
    ...
    m_connectedToSystemTimestamp = std::forward<ConnectedToSystemTimestampT>(value);
  }
  template <typename ConnectedToSystemTimestampT = Aws::Utils::DateTime>
  Contact& WithConnectedToSystemTimestamp(ConnectedToSystemTimestampT&& value) {
    SetConnectedToSystemTimestamp(std::forward<ConnectedToSystemTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAnsweringMachineDetectionStatus(AnsweringMachineDetectionStatus value) {
    m_answeringMachineDetectionStatusHasBeenSet = true;
    m_answeringMachineDetectionStatus = value;
  }
  inline Contact& WithAnsweringMachineDetectionStatus(AnsweringMachineDetectionStatus value) {
    SetAnsweringMachineDetectionStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomerVoiceActivity(CustomerVoiceActivityT&& value) {
    ...
    m_customerVoiceActivity = std::forward<CustomerVoiceActivityT>(value);
  }
  template <typename CustomerVoiceActivityT = CustomerVoiceActivity>
  Contact& WithCustomerVoiceActivity(CustomerVoiceActivityT&& value) {
    SetCustomerVoiceActivity(std::forward<CustomerVoiceActivityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQualityMetrics(QualityMetricsT&& value) {
    ...
    m_qualityMetrics = std::forward<QualityMetricsT>(value);
  }
  template <typename QualityMetricsT = QualityMetrics>
  Contact& WithQualityMetrics(QualityMetricsT&& value) {
    SetQualityMetrics(std::forward<QualityMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetChatMetrics(ChatMetricsT&& value) {
    ...
    m_chatMetrics = std::forward<ChatMetricsT>(value);
  }
  template <typename ChatMetricsT = ChatMetrics>
  Contact& WithChatMetrics(ChatMetricsT&& value) {
    SetChatMetrics(std::forward<ChatMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDisconnectDetails(DisconnectDetailsT&& value) {
    ...
    m_disconnectDetails = std::forward<DisconnectDetailsT>(value);
  }
  template <typename DisconnectDetailsT = DisconnectDetails>
  Contact& WithDisconnectDetails(DisconnectDetailsT&& value) {
    SetDisconnectDetails(std::forward<DisconnectDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdditionalEmailRecipients(AdditionalEmailRecipientsT&& value) {
    ...
    m_additionalEmailRecipients = std::forward<AdditionalEmailRecipientsT>(value);
  }
  template <typename AdditionalEmailRecipientsT = AdditionalEmailRecipients>
  Contact& WithAdditionalEmailRecipients(AdditionalEmailRecipientsT&& value) {
    SetAdditionalEmailRecipients(std::forward<AdditionalEmailRecipientsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecordings(RecordingsT&& value) {
    ...
    m_recordings = std::forward<RecordingsT>(value);
  }
  template <typename RecordingsT = Aws::Vector<RecordingInfo>>
  Contact& WithRecordings(RecordingsT&& value) {
    SetRecordings(std::forward<RecordingsT>(value));
    return *this;
  }
  template <typename RecordingsT = RecordingInfo>
  Contact& AddRecordings(RecordingsT&& value) {
    m_recordingsHasBeenSet = true;
    m_recordings.emplace_back(std::forward<RecordingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContactEvaluations(ContactEvaluationsT&& value) {
    ...
    m_contactEvaluations = std::forward<ContactEvaluationsT>(value);
  }
  template <typename ContactEvaluationsT = Aws::Map<Aws::String, ContactEvaluation>>
  Contact& WithContactEvaluations(ContactEvaluationsT&& value) {
    SetContactEvaluations(std::forward<ContactEvaluationsT>(value));
    return *this;
  }
  ...
  Contact& AddContactEvaluations(ContactEvaluationsKeyT&& key, ContactEvaluationsValueT&& value) {
    m_contactEvaluationsHasBeenSet = true;
    m_contactEvaluations.emplace(std::forward<ContactEvaluationsKeyT>(key), std::forward<ContactEvaluationsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTaskTemplateInfo(TaskTemplateInfoT&& value) {
    ...
    m_taskTemplateInfo = std::forward<TaskTemplateInfoT>(value);
  }
  template <typename TaskTemplateInfoT = TaskTemplateInfoV2>
  Contact& WithTaskTemplateInfo(TaskTemplateInfoT&& value) {
    SetTaskTemplateInfo(std::forward<TaskTemplateInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContactDetails(ContactDetailsT&& value) {
    ...
    m_contactDetails = std::forward<ContactDetailsT>(value);
  }
  template <typename ContactDetailsT = ContactDetails>
  Contact& WithContactDetails(ContactDetailsT&& value) {
    SetContactDetails(std::forward<ContactDetailsT>(value));
    return *this;
  }
  ///@}
