...
class EvaluationFormNumericQuestionAutomation {
 public:
  ...
  template <typename PropertyValueT = NumericQuestionPropertyValueAutomation>
  EvaluationFormNumericQuestionAutomation& WithPropertyValue(PropertyValueT&& value) {
  ...
  template <typename AnswerSourceT = EvaluationFormQuestionAutomationAnswerSource>
  EvaluationFormNumericQuestionAutomation& WithAnswerSource(AnswerSourceT&& value) {
