...
namespace Connect {
namespace Model {
class StartEvaluationFormValidationResult {
 public:
  AWS_CONNECT_API StartEvaluationFormValidationResult() = default;
  AWS_CONNECT_API StartEvaluationFormValidationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CONNECT_API StartEvaluationFormValidationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename EvaluationFormIdT = Aws::String>
  StartEvaluationFormValidationResult& WithEvaluationFormId(EvaluationFormIdT&& value) {
  ...
  template <typename EvaluationFormArnT = Aws::String>
  StartEvaluationFormValidationResult& WithEvaluationFormArn(EvaluationFormArnT&& value) {
  ...
  inline StartEvaluationFormValidationResult& WithEvaluationFormVersion(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartEvaluationFormValidationResult& WithRequestId(RequestIdT&& value) {
