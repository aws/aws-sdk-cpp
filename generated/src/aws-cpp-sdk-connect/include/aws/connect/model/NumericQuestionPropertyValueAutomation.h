 ...
 * minimum value of 0 and maximum value of 63072000.</p> </li> <li> <p>Percentages
...
class NumericQuestionPropertyValueAutomation {
 public:
  ...
  inline void SetLabel(NumericQuestionPropertyAutomationLabel value) {
    m_labelHasBeenSet = true;
    m_label = value;
  }
  inline NumericQuestionPropertyValueAutomation& WithLabel(NumericQuestionPropertyAutomationLabel value) {
    SetLabel(value);
    return *this;
  }
  ///@}
