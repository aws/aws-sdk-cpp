...
class ListAnalyticsDataLakeDataSetsResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<AnalyticsDataSetsResult>>
  ListAnalyticsDataLakeDataSetsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = AnalyticsDataSetsResult>
  ListAnalyticsDataLakeDataSetsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAnalyticsDataLakeDataSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnalyticsDataLakeDataSetsResult& WithRequestId(RequestIdT&& value) {
