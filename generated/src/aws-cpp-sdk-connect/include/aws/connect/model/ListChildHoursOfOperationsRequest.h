...
/**
 */
class ListChildHoursOfOperationsRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API ListChildHoursOfOperationsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListChildHoursOfOperations"; }
  ...
  template <typename InstanceIdT = Aws::String>
  ListChildHoursOfOperationsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename HoursOfOperationIdT = Aws::String>
  ListChildHoursOfOperationsRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListChildHoursOfOperationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListChildHoursOfOperationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
