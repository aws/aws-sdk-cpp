...
class Evaluation {
 public:
  ...
  Evaluation& AddAnswers(AnswersKeyT&& key, AnswersValueT&& value) {
    m_answersHasBeenSet = true;
    m_answers.emplace(std::forward<AnswersKeyT>(key), std::forward<AnswersValueT>(value));
    return *this;
  }
  ///@}
  ...
  Evaluation& AddNotes(NotesKeyT&& key, NotesValueT&& value) {
    m_notesHasBeenSet = true;
    m_notes.emplace(std::forward<NotesKeyT>(key), std::forward<NotesValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline Evaluation& WithStatus(EvaluationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  Evaluation& AddScores(ScoresKeyT&& key, ScoresValueT&& value) {
    m_scoresHasBeenSet = true;
    m_scores.emplace(std::forward<ScoresKeyT>(key), std::forward<ScoresValueT>(value));
    return *this;
  }
  ///@}
