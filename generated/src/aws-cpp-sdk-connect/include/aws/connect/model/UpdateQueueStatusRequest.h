...
class UpdateQueueStatusRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateQueueStatusRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  UpdateQueueStatusRequest& WithQueueId(QueueIdT&& value) {
  ...
  inline UpdateQueueStatusRequest& WithStatus(QueueStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
