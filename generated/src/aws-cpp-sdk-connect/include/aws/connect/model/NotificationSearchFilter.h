...
/**
 * <p>Filters to apply when searching for notifications.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/NotificationSearchFilter">AWS
 * API Reference</a></p>
 */
class NotificationSearchFilter {
 public:
  AWS_CONNECT_API NotificationSearchFilter() = default;
  AWS_CONNECT_API NotificationSearchFilter(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECT_API NotificationSearchFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AttributeFilterT = ControlPlaneAttributeFilter>
  NotificationSearchFilter& WithAttributeFilter(AttributeFilterT&& value) {
