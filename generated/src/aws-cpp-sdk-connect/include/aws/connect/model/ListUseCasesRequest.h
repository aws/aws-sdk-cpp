...
class ListUseCasesRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListUseCasesRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename IntegrationAssociationIdT = Aws::String>
  ListUseCasesRequest& WithIntegrationAssociationId(IntegrationAssociationIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListUseCasesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListUseCasesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
