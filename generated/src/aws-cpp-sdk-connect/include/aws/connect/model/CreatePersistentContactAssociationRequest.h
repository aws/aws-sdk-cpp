...
class CreatePersistentContactAssociationRequest : public ConnectRequest {
 public:
  ...
  inline void SetRehydrationType(RehydrationType value) {
    m_rehydrationTypeHasBeenSet = true;
    m_rehydrationType = value;
  }
  inline CreatePersistentContactAssociationRequest& WithRehydrationType(RehydrationType value) {
    SetRehydrationType(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceContactId(SourceContactIdT&& value) {
    ...
    m_sourceContactId = std::forward<SourceContactIdT>(value);
  }
  template <typename SourceContactIdT = Aws::String>
  CreatePersistentContactAssociationRequest& WithSourceContactId(SourceContactIdT&& value) {
    SetSourceContactId(std::forward<SourceContactIdT>(value));
    return *this;
  }
  ///@}
