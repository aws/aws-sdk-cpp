...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API ActivateEvaluationFormResult() = default;
    ...
    template<typename EvaluationFormIdT = Aws::String>
    ActivateEvaluationFormResult& WithEvaluationFormId(EvaluationFormIdT&& value) { SetEvaluationFormId(std::forward<EvaluationFormIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EvaluationFormArnT = Aws::String>
    ActivateEvaluationFormResult& WithEvaluationFormArn(EvaluationFormArnT&& value) { SetEvaluationFormArn(std::forward<EvaluationFormArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ActivateEvaluationFormResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
