...
class PutUserStatusRequest : public ConnectRequest {
 public:
  ...
  template <typename UserIdT = Aws::String>
  PutUserStatusRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  PutUserStatusRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename AgentStatusIdT = Aws::String>
  PutUserStatusRequest& WithAgentStatusId(AgentStatusIdT&& value) {
