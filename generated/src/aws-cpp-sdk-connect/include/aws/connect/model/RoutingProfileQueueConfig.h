...
class RoutingProfileQueueConfig {
 public:
  ...
  void SetQueueReference(QueueReferenceT&& value) {
    ...
    m_queueReference = std::forward<QueueReferenceT>(value);
  }
  template <typename QueueReferenceT = RoutingProfileQueueReference>
  RoutingProfileQueueConfig& WithQueueReference(QueueReferenceT&& value) {
    SetQueueReference(std::forward<QueueReferenceT>(value));
    return *this;
  }
  ///@}
  ...
  inline RoutingProfileQueueConfig& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline RoutingProfileQueueConfig& WithDelay(int value) {
    SetDelay(value);
    return *this;
  }
  ///@}
