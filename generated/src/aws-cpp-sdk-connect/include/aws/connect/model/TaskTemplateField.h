...
class TaskTemplateField {
 public:
  ...
  inline void SetType(TaskTemplateFieldType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TaskTemplateField& WithType(TaskTemplateFieldType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetSingleSelectOptions(SingleSelectOptionsT&& value) {
    ...
    m_singleSelectOptions = std::forward<SingleSelectOptionsT>(value);
  }
  template <typename SingleSelectOptionsT = Aws::Vector<Aws::String>>
  TaskTemplateField& WithSingleSelectOptions(SingleSelectOptionsT&& value) {
    SetSingleSelectOptions(std::forward<SingleSelectOptionsT>(value));
    return *this;
  }
  template <typename SingleSelectOptionsT = Aws::String>
  TaskTemplateField& AddSingleSelectOptions(SingleSelectOptionsT&& value) {
    m_singleSelectOptionsHasBeenSet = true;
    m_singleSelectOptions.emplace_back(std::forward<SingleSelectOptionsT>(value));
    return *this;
  }
  ///@}
 private:
