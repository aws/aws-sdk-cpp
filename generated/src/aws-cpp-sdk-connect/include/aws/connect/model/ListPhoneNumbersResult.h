...
class ListPhoneNumbersResult {
 public:
  ...
  void SetPhoneNumberSummaryList(PhoneNumberSummaryListT&& value) {
    m_phoneNumberSummaryListHasBeenSet = true;
    m_phoneNumberSummaryList = std::forward<PhoneNumberSummaryListT>(value);
  }
  template <typename PhoneNumberSummaryListT = Aws::Vector<PhoneNumberSummary>>
  ListPhoneNumbersResult& WithPhoneNumberSummaryList(PhoneNumberSummaryListT&& value) {
    SetPhoneNumberSummaryList(std::forward<PhoneNumberSummaryListT>(value));
    return *this;
  }
  template <typename PhoneNumberSummaryListT = PhoneNumberSummary>
  ListPhoneNumbersResult& AddPhoneNumberSummaryList(PhoneNumberSummaryListT&& value) {
    m_phoneNumberSummaryListHasBeenSet = true;
    m_phoneNumberSummaryList.emplace_back(std::forward<PhoneNumberSummaryListT>(value));
    return *this;
  }
  ///@}
