...
class SearchContactsAdditionalTimeRange {
 public:
  ...
  template <typename CriteriaT = Aws::Vector<SearchContactsAdditionalTimeRangeCriteria>>
  SearchContactsAdditionalTimeRange& WithCriteria(CriteriaT&& value) {
    SetCriteria(std::forward<CriteriaT>(value));
    return *this;
  }
  template <typename CriteriaT = SearchContactsAdditionalTimeRangeCriteria>
  SearchContactsAdditionalTimeRange& AddCriteria(CriteriaT&& value) {
    m_criteriaHasBeenSet = true;
  ...
  inline SearchContactsAdditionalTimeRange& WithMatchType(SearchContactsMatchType value) {
    SetMatchType(value);
    return *this;
  }
  ///@}
