...
class UpdateViewMetadataRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API UpdateViewMetadataRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateViewMetadataRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ViewIdT = Aws::String>
  UpdateViewMetadataRequest& WithViewId(ViewIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateViewMetadataRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateViewMetadataRequest& WithDescription(DescriptionT&& value) {
