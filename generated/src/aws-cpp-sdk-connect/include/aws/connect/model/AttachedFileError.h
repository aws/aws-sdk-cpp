...
class AttachedFileError {
 public:
  AWS_CONNECT_API AttachedFileError() = default;
  ...
  template <typename ErrorCodeT = Aws::String>
  AttachedFileError& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  AttachedFileError& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename FileIdT = Aws::String>
  AttachedFileError& WithFileId(FileIdT&& value) {
