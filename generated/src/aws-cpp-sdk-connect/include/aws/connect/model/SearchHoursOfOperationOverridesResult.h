...
class SearchHoursOfOperationOverridesResult {
 public:
  ...
  void SetHoursOfOperationOverrides(HoursOfOperationOverridesT&& value) {
    m_hoursOfOperationOverridesHasBeenSet = true;
    m_hoursOfOperationOverrides = std::forward<HoursOfOperationOverridesT>(value);
  }
  template <typename HoursOfOperationOverridesT = Aws::Vector<HoursOfOperationOverride>>
  SearchHoursOfOperationOverridesResult& WithHoursOfOperationOverrides(HoursOfOperationOverridesT&& value) {
    SetHoursOfOperationOverrides(std::forward<HoursOfOperationOverridesT>(value));
    return *this;
  }
  template <typename HoursOfOperationOverridesT = HoursOfOperationOverride>
  SearchHoursOfOperationOverridesResult& AddHoursOfOperationOverrides(HoursOfOperationOverridesT&& value) {
    m_hoursOfOperationOverridesHasBeenSet = true;
    m_hoursOfOperationOverrides.emplace_back(std::forward<HoursOfOperationOverridesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchHoursOfOperationOverridesResult& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchHoursOfOperationOverridesResult& WithApproximateTotalCount(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchHoursOfOperationOverridesResult& WithRequestId(RequestIdT&& value) {
