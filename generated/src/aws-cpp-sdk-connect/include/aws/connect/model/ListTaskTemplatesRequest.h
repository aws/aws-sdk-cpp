...
class ListTaskTemplatesRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API ListTaskTemplatesRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  ListTaskTemplatesRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTaskTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTaskTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListTaskTemplatesRequest& WithStatus(TaskTemplateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  ListTaskTemplatesRequest& WithName(NameT&& value) {
