...
class CreatePushNotificationRegistrationResult {
 public:
  ...
  AWS_CONNECT_API CreatePushNotificationRegistrationResult& operator=(
  ...
  template <typename RegistrationIdT = Aws::String>
  CreatePushNotificationRegistrationResult& WithRegistrationId(RegistrationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePushNotificationRegistrationResult& WithRequestId(RequestIdT&& value) {
