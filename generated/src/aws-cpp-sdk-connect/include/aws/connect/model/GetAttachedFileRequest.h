...
class GetAttachedFileRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  GetAttachedFileRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename FileIdT = Aws::String>
  GetAttachedFileRequest& WithFileId(FileIdT&& value) {
  ...
  inline void SetUrlExpiryInSeconds(int value) {
    m_urlExpiryInSecondsHasBeenSet = true;
    m_urlExpiryInSeconds = value;
  }
  inline GetAttachedFileRequest& WithUrlExpiryInSeconds(int value) {
    SetUrlExpiryInSeconds(value);
    return *this;
  }
  ///@}
  ...
  template <typename AssociatedResourceArnT = Aws::String>
  GetAttachedFileRequest& WithAssociatedResourceArn(AssociatedResourceArnT&& value) {
