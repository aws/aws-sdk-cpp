...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DescribeUserHierarchyGroupRequest() = default;
    ...
    template<typename HierarchyGroupIdT = Aws::String>
    DescribeUserHierarchyGroupRequest& WithHierarchyGroupId(HierarchyGroupIdT&& value) { SetHierarchyGroupId(std::forward<HierarchyGroupIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeUserHierarchyGroupRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
  private:
