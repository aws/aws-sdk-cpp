...
class ListLambdaFunctionsResult {
 public:
  ...
  void SetLambdaFunctions(LambdaFunctionsT&& value) {
    m_lambdaFunctionsHasBeenSet = true;
    m_lambdaFunctions = std::forward<LambdaFunctionsT>(value);
  }
  template <typename LambdaFunctionsT = Aws::Vector<Aws::String>>
  ListLambdaFunctionsResult& WithLambdaFunctions(LambdaFunctionsT&& value) {
    SetLambdaFunctions(std::forward<LambdaFunctionsT>(value));
    return *this;
  }
  template <typename LambdaFunctionsT = Aws::String>
  ListLambdaFunctionsResult& AddLambdaFunctions(LambdaFunctionsT&& value) {
    m_lambdaFunctionsHasBeenSet = true;
    m_lambdaFunctions.emplace_back(std::forward<LambdaFunctionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLambdaFunctionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLambdaFunctionsResult& WithRequestId(RequestIdT&& value) {
