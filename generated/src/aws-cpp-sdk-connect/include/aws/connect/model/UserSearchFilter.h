...
class UserSearchFilter {
 public:
  ...
  template <typename TagFilterT = ControlPlaneTagFilter>
  UserSearchFilter& WithTagFilter(TagFilterT&& value) {
  ...
  void SetUserAttributeFilter(UserAttributeFilterT&& value) {
    m_userAttributeFilterHasBeenSet = true;
    m_userAttributeFilter = std::forward<UserAttributeFilterT>(value);
  }
  template <typename UserAttributeFilterT = ControlPlaneUserAttributeFilter>
  UserSearchFilter& WithUserAttributeFilter(UserAttributeFilterT&& value) {
    SetUserAttributeFilter(std::forward<UserAttributeFilterT>(value));
    return *this;
  }
  ///@}
 private:
