...
class AttachedFile {
 public:
  ...
  inline void SetFileSizeInBytes(long long value) {
    m_fileSizeInBytesHasBeenSet = true;
    m_fileSizeInBytes = value;
  }
  inline AttachedFile& WithFileSizeInBytes(long long value) {
    SetFileSizeInBytes(value);
    return *this;
  }
  ///@}
  ...
  inline AttachedFile& WithFileStatus(FileStatusType value) {
    SetFileStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AttachedFile& WithFileUseCaseType(FileUseCaseType value) {
