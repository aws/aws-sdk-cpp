...
class SearchPredefinedAttributesResult {
 public:
  ...
  void SetPredefinedAttributes(PredefinedAttributesT&& value) {
    ...
    m_predefinedAttributes = std::forward<PredefinedAttributesT>(value);
  }
  template <typename PredefinedAttributesT = Aws::Vector<PredefinedAttribute>>
  SearchPredefinedAttributesResult& WithPredefinedAttributes(PredefinedAttributesT&& value) {
    SetPredefinedAttributes(std::forward<PredefinedAttributesT>(value));
    return *this;
  }
  ...
  SearchPredefinedAttributesResult& AddPredefinedAttributes(PredefinedAttributesT&& value) {
    m_predefinedAttributesHasBeenSet = true;
    m_predefinedAttributes.emplace_back(std::forward<PredefinedAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  inline SearchPredefinedAttributesResult& WithApproximateTotalCount(long long value) {
