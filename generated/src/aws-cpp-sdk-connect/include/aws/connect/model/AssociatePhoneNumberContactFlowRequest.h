...
class AssociatePhoneNumberContactFlowRequest : public ConnectRequest {
 public:
  ...
  template <typename PhoneNumberIdT = Aws::String>
  AssociatePhoneNumberContactFlowRequest& WithPhoneNumberId(PhoneNumberIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  AssociatePhoneNumberContactFlowRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactFlowIdT = Aws::String>
  AssociatePhoneNumberContactFlowRequest& WithContactFlowId(ContactFlowIdT&& value) {
