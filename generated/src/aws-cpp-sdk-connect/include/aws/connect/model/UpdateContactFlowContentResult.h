...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API UpdateContactFlowContentResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateContactFlowContentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
