...
namespace Model
{
  ...
  public:
    ...
    inline UpdateContactFlowContentResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateContactFlowContentResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateContactFlowContentResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
