...
class UserPhoneConfig {
 public:
  ...
  inline UserPhoneConfig& WithPhoneType(PhoneType value) {
    SetPhoneType(value);
    return *this;
  }
  ///@}
  ...
  inline UserPhoneConfig& WithAutoAccept(bool value) {
    SetAutoAccept(value);
    return *this;
  }
  ///@}
  ...
  inline UserPhoneConfig& WithAfterContactWorkTimeLimit(int value) {
  ...
  void SetDeskPhoneNumber(DeskPhoneNumberT&& value) {
    ...
    m_deskPhoneNumber = std::forward<DeskPhoneNumberT>(value);
  }
  template <typename DeskPhoneNumberT = Aws::String>
  UserPhoneConfig& WithDeskPhoneNumber(DeskPhoneNumberT&& value) {
    SetDeskPhoneNumber(std::forward<DeskPhoneNumberT>(value));
    return *this;
  }
  ///@}
  ...
  inline UserPhoneConfig& WithPersistentConnection(bool value) {
