...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API HoursOfOperationSearchFilter() = default;
    ...
    template<typename TagFilterT = ControlPlaneTagFilter>
    HoursOfOperationSearchFilter& WithTagFilter(TagFilterT&& value) { SetTagFilter(std::forward<TagFilterT>(value)); return *this;}
    ///@}
  private:
