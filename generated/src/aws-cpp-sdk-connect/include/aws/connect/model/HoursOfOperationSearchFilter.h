...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/HoursOfOperationSearchFilter">AWS
   * API Reference</a></p>
   */
  class HoursOfOperationSearchFilter
  {
  public:
    AWS_CONNECT_API HoursOfOperationSearchFilter();
    AWS_CONNECT_API HoursOfOperationSearchFilter(Aws::Utils::Json::JsonView jsonValue);
    AWS_CONNECT_API HoursOfOperationSearchFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline HoursOfOperationSearchFilter& WithTagFilter(const ControlPlaneTagFilter& value) { SetTagFilter(value); return *this;}

    
    inline HoursOfOperationSearchFilter& WithTagFilter(ControlPlaneTagFilter&& value) { SetTagFilter(std::move(value)); return *this;}
