...
class ListSecurityProfilesResult {
 public:
  ...
  void SetSecurityProfileSummaryList(SecurityProfileSummaryListT&& value) {
    m_securityProfileSummaryListHasBeenSet = true;
    m_securityProfileSummaryList = std::forward<SecurityProfileSummaryListT>(value);
  }
  template <typename SecurityProfileSummaryListT = Aws::Vector<SecurityProfileSummary>>
  ListSecurityProfilesResult& WithSecurityProfileSummaryList(SecurityProfileSummaryListT&& value) {
    SetSecurityProfileSummaryList(std::forward<SecurityProfileSummaryListT>(value));
    return *this;
  }
  template <typename SecurityProfileSummaryListT = SecurityProfileSummary>
  ListSecurityProfilesResult& AddSecurityProfileSummaryList(SecurityProfileSummaryListT&& value) {
    m_securityProfileSummaryListHasBeenSet = true;
    m_securityProfileSummaryList.emplace_back(std::forward<SecurityProfileSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSecurityProfilesResult& WithRequestId(RequestIdT&& value) {
