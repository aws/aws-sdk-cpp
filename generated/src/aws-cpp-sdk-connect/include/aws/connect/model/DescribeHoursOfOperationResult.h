...
class DescribeHoursOfOperationResult {
 public:
  ...
  void SetHoursOfOperation(HoursOfOperationT&& value) {
    m_hoursOfOperationHasBeenSet = true;
    m_hoursOfOperation = std::forward<HoursOfOperationT>(value);
  }
  template <typename HoursOfOperationT = HoursOfOperation>
  DescribeHoursOfOperationResult& WithHoursOfOperation(HoursOfOperationT&& value) {
    SetHoursOfOperation(std::forward<HoursOfOperationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeHoursOfOperationResult& WithRequestId(RequestIdT&& value) {
