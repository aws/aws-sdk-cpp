...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    CreatePromptRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename S3UriT = Aws::String>
    CreatePromptRequest& WithS3Uri(S3UriT&& value) { SetS3Uri(std::forward<S3UriT>(value)); return *this;}
    ///@}
