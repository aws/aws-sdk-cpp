...
class DisassociateFlowRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API DisassociateFlowRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  DisassociateFlowRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  DisassociateFlowRequest& WithResourceId(ResourceIdT&& value) {
  ...
  inline DisassociateFlowRequest& WithResourceType(FlowAssociationResourceType value) {
