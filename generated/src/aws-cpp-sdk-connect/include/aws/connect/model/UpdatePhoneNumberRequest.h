...
class UpdatePhoneNumberRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API UpdatePhoneNumberRequest() = default;
  ...
  template <typename TargetArnT = Aws::String>
  UpdatePhoneNumberRequest& WithTargetArn(TargetArnT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  UpdatePhoneNumberRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdatePhoneNumberRequest& WithClientToken(ClientTokenT&& value) {
