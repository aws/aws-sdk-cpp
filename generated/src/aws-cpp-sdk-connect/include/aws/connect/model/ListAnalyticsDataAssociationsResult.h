...
class ListAnalyticsDataAssociationsResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<AnalyticsDataAssociationResult>>
  ListAnalyticsDataAssociationsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = AnalyticsDataAssociationResult>
  ListAnalyticsDataAssociationsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAnalyticsDataAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnalyticsDataAssociationsResult& WithRequestId(RequestIdT&& value) {
