...
class ControlPlaneAttributeFilter {
 public:
  ...
  template <typename OrConditionsT = Aws::Vector<CommonAttributeAndCondition>>
  ControlPlaneAttributeFilter& WithOrConditions(OrConditionsT&& value) {
    SetOrConditions(std::forward<OrConditionsT>(value));
    return *this;
  }
  template <typename OrConditionsT = CommonAttributeAndCondition>
  ControlPlaneAttributeFilter& AddOrConditions(OrConditionsT&& value) {
    m_orConditionsHasBeenSet = true;
  ...
  template <typename AndConditionT = CommonAttributeAndCondition>
  ControlPlaneAttributeFilter& WithAndCondition(AndConditionT&& value) {
  ...
  template <typename TagConditionT = TagCondition>
  ControlPlaneAttributeFilter& WithTagCondition(TagConditionT&& value) {
