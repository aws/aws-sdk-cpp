...
class ChatContactMetrics {
 public:
  ...
  inline void SetMultiParty(bool value) {
    m_multiPartyHasBeenSet = true;
    m_multiParty = value;
  }
  inline ChatContactMetrics& WithMultiParty(bool value) {
    SetMultiParty(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalMessages(int value) {
    m_totalMessagesHasBeenSet = true;
    m_totalMessages = value;
  }
  inline ChatContactMetrics& WithTotalMessages(int value) {
    SetTotalMessages(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalBotMessages(int value) {
    m_totalBotMessagesHasBeenSet = true;
    m_totalBotMessages = value;
  }
  inline ChatContactMetrics& WithTotalBotMessages(int value) {
    SetTotalBotMessages(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalBotMessageLengthInChars(int value) {
    m_totalBotMessageLengthInCharsHasBeenSet = true;
    m_totalBotMessageLengthInChars = value;
  }
  inline ChatContactMetrics& WithTotalBotMessageLengthInChars(int value) {
    SetTotalBotMessageLengthInChars(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConversationCloseTimeInMillis(long long value) {
    m_conversationCloseTimeInMillisHasBeenSet = true;
    m_conversationCloseTimeInMillis = value;
  }
  inline ChatContactMetrics& WithConversationCloseTimeInMillis(long long value) {
    SetConversationCloseTimeInMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConversationTurnCount(int value) {
    m_conversationTurnCountHasBeenSet = true;
    m_conversationTurnCount = value;
  }
  inline ChatContactMetrics& WithConversationTurnCount(int value) {
    SetConversationTurnCount(value);
    return *this;
  }
  ///@}
  ...
  void SetAgentFirstResponseTimestamp(AgentFirstResponseTimestampT&& value) {
    ...
    m_agentFirstResponseTimestamp = std::forward<AgentFirstResponseTimestampT>(value);
  }
  template <typename AgentFirstResponseTimestampT = Aws::Utils::DateTime>
  ChatContactMetrics& WithAgentFirstResponseTimestamp(AgentFirstResponseTimestampT&& value) {
    SetAgentFirstResponseTimestamp(std::forward<AgentFirstResponseTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAgentFirstResponseTimeInMillis(long long value) {
    m_agentFirstResponseTimeInMillisHasBeenSet = true;
    m_agentFirstResponseTimeInMillis = value;
  }
  inline ChatContactMetrics& WithAgentFirstResponseTimeInMillis(long long value) {
    SetAgentFirstResponseTimeInMillis(value);
    return *this;
  }
  ///@}
 private:
