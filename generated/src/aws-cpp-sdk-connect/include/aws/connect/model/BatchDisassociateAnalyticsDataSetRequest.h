...
class BatchDisassociateAnalyticsDataSetRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  BatchDisassociateAnalyticsDataSetRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename DataSetIdsT = Aws::Vector<Aws::String>>
  BatchDisassociateAnalyticsDataSetRequest& WithDataSetIds(DataSetIdsT&& value) {
    SetDataSetIds(std::forward<DataSetIdsT>(value));
    return *this;
  }
  template <typename DataSetIdsT = Aws::String>
  BatchDisassociateAnalyticsDataSetRequest& AddDataSetIds(DataSetIdsT&& value) {
    m_dataSetIdsHasBeenSet = true;
  ...
  template <typename TargetAccountIdT = Aws::String>
  BatchDisassociateAnalyticsDataSetRequest& WithTargetAccountId(TargetAccountIdT&& value) {
