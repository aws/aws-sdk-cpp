...
class SearchContactFlowsRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  SearchContactFlowsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  SearchContactFlowsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchContactFlowsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename SearchFilterT = ContactFlowSearchFilter>
  SearchContactFlowsRequest& WithSearchFilter(SearchFilterT&& value) {
  ...
  template <typename SearchCriteriaT = ContactFlowSearchCriteria>
  SearchContactFlowsRequest& WithSearchCriteria(SearchCriteriaT&& value) {
