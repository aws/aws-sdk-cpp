...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API SearchContactFlowsRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    SearchContactFlowsRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    SearchContactFlowsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename SearchFilterT = ContactFlowSearchFilter>
    void SetSearchFilter(SearchFilterT&& value) { m_searchFilterHasBeenSet = true; m_searchFilter = std::forward<SearchFilterT>(value); }
    template<typename SearchFilterT = ContactFlowSearchFilter>
    SearchContactFlowsRequest& WithSearchFilter(SearchFilterT&& value) { SetSearchFilter(std::forward<SearchFilterT>(value)); return *this;}
    ///@}
    ...
    template<typename SearchCriteriaT = ContactFlowSearchCriteria>
    ...
    template<typename SearchCriteriaT = ContactFlowSearchCriteria>
    SearchContactFlowsRequest& WithSearchCriteria(SearchCriteriaT&& value) { SetSearchCriteria(std::forward<SearchCriteriaT>(value)); return *this;}
    ///@}
  private:
