...
class UpdateHoursOfOperationOverrideRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateHoursOfOperationOverrideRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename HoursOfOperationIdT = Aws::String>
  UpdateHoursOfOperationOverrideRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) {
  ...
  template <typename HoursOfOperationOverrideIdT = Aws::String>
  UpdateHoursOfOperationOverrideRequest& WithHoursOfOperationOverrideId(HoursOfOperationOverrideIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateHoursOfOperationOverrideRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateHoursOfOperationOverrideRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ConfigT = Aws::Vector<HoursOfOperationOverrideConfig>>
  UpdateHoursOfOperationOverrideRequest& WithConfig(ConfigT&& value) {
    SetConfig(std::forward<ConfigT>(value));
    return *this;
  }
  template <typename ConfigT = HoursOfOperationOverrideConfig>
  UpdateHoursOfOperationOverrideRequest& AddConfig(ConfigT&& value) {
    m_configHasBeenSet = true;
  ...
  template <typename EffectiveFromT = Aws::String>
  UpdateHoursOfOperationOverrideRequest& WithEffectiveFrom(EffectiveFromT&& value) {
  ...
  template <typename EffectiveTillT = Aws::String>
  UpdateHoursOfOperationOverrideRequest& WithEffectiveTill(EffectiveTillT&& value) {
  ...
  template <typename RecurrenceConfigT = RecurrenceConfig>
  UpdateHoursOfOperationOverrideRequest& WithRecurrenceConfig(RecurrenceConfigT&& value) {
  ...
  inline UpdateHoursOfOperationOverrideRequest& WithOverrideType(OverrideType value) {
