...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API UpdateHoursOfOperationOverrideRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    UpdateHoursOfOperationOverrideRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HoursOfOperationIdT = Aws::String>
    UpdateHoursOfOperationOverrideRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) { SetHoursOfOperationId(std::forward<HoursOfOperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HoursOfOperationOverrideIdT = Aws::String>
    UpdateHoursOfOperationOverrideRequest& WithHoursOfOperationOverrideId(HoursOfOperationOverrideIdT&& value) { SetHoursOfOperationOverrideId(std::forward<HoursOfOperationOverrideIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateHoursOfOperationOverrideRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateHoursOfOperationOverrideRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigT = Aws::Vector<HoursOfOperationOverrideConfig>>
    UpdateHoursOfOperationOverrideRequest& WithConfig(ConfigT&& value) { SetConfig(std::forward<ConfigT>(value)); return *this;}
    template<typename ConfigT = HoursOfOperationOverrideConfig>
    UpdateHoursOfOperationOverrideRequest& AddConfig(ConfigT&& value) { m_configHasBeenSet = true; m_config.emplace_back(std::forward<ConfigT>(value)); return *this; }
    ///@}
    ...
    template<typename EffectiveFromT = Aws::String>
    UpdateHoursOfOperationOverrideRequest& WithEffectiveFrom(EffectiveFromT&& value) { SetEffectiveFrom(std::forward<EffectiveFromT>(value)); return *this;}
    ///@}
    ...
    template<typename EffectiveTillT = Aws::String>
    UpdateHoursOfOperationOverrideRequest& WithEffectiveTill(EffectiveTillT&& value) { SetEffectiveTill(std::forward<EffectiveTillT>(value)); return *this;}
    ///@}
  private:
