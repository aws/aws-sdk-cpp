...
class ListPhoneNumbersV2Result {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPhoneNumbersV2Result& WithNextToken(NextTokenT&& value) {
  ...
  void SetListPhoneNumbersSummaryList(ListPhoneNumbersSummaryListT&& value) {
    m_listPhoneNumbersSummaryListHasBeenSet = true;
    m_listPhoneNumbersSummaryList = std::forward<ListPhoneNumbersSummaryListT>(value);
  }
  template <typename ListPhoneNumbersSummaryListT = Aws::Vector<ListPhoneNumbersSummary>>
  ListPhoneNumbersV2Result& WithListPhoneNumbersSummaryList(ListPhoneNumbersSummaryListT&& value) {
    SetListPhoneNumbersSummaryList(std::forward<ListPhoneNumbersSummaryListT>(value));
    return *this;
  }
  template <typename ListPhoneNumbersSummaryListT = ListPhoneNumbersSummary>
  ListPhoneNumbersV2Result& AddListPhoneNumbersSummaryList(ListPhoneNumbersSummaryListT&& value) {
    m_listPhoneNumbersSummaryListHasBeenSet = true;
    m_listPhoneNumbersSummaryList.emplace_back(std::forward<ListPhoneNumbersSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPhoneNumbersV2Result& WithRequestId(RequestIdT&& value) {
