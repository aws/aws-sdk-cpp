...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API ResumeContactRecordingRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    ResumeContactRecordingRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ContactIdT = Aws::String>
    ResumeContactRecordingRequest& WithContactId(ContactIdT&& value) { SetContactId(std::forward<ContactIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InitialContactIdT = Aws::String>
    ResumeContactRecordingRequest& WithInitialContactId(InitialContactIdT&& value) { SetInitialContactId(std::forward<InitialContactIdT>(value)); return *this;}
    ///@}
    ...
    inline ResumeContactRecordingRequest& WithContactRecordingType(ContactRecordingType value) { SetContactRecordingType(value); return *this;}
    ///@}
  private:
