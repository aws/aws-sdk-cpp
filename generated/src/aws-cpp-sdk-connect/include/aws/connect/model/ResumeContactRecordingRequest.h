...
class ResumeContactRecordingRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ResumeContactRecordingRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactIdT = Aws::String>
  ResumeContactRecordingRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename InitialContactIdT = Aws::String>
  ResumeContactRecordingRequest& WithInitialContactId(InitialContactIdT&& value) {
  ...
  inline void SetContactRecordingType(ContactRecordingType value) {
    m_contactRecordingTypeHasBeenSet = true;
    m_contactRecordingType = value;
  }
  inline ResumeContactRecordingRequest& WithContactRecordingType(ContactRecordingType value) {
    SetContactRecordingType(value);
    return *this;
  }
  ///@}
 private:
