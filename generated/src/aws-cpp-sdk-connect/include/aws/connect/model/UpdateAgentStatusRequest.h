...
class UpdateAgentStatusRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateAgentStatusRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename AgentStatusIdT = Aws::String>
  UpdateAgentStatusRequest& WithAgentStatusId(AgentStatusIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateAgentStatusRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateAgentStatusRequest& WithDescription(DescriptionT&& value) {
  ...
  inline UpdateAgentStatusRequest& WithState(AgentStatusState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateAgentStatusRequest& WithDisplayOrder(int value) {
  ...
  inline void SetResetOrderNumber(bool value) {
    m_resetOrderNumberHasBeenSet = true;
    m_resetOrderNumber = value;
  }
  inline UpdateAgentStatusRequest& WithResetOrderNumber(bool value) {
    SetResetOrderNumber(value);
    return *this;
  }
  ///@}
 private:
