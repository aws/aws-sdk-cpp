...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API SearchHoursOfOperationsRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    SearchHoursOfOperationsRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    SearchHoursOfOperationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename SearchFilterT = HoursOfOperationSearchFilter>
    SearchHoursOfOperationsRequest& WithSearchFilter(SearchFilterT&& value) { SetSearchFilter(std::forward<SearchFilterT>(value)); return *this;}
    ///@}
    ...
    template<typename SearchCriteriaT = HoursOfOperationSearchCriteria>
    ...
    template<typename SearchCriteriaT = HoursOfOperationSearchCriteria>
    SearchHoursOfOperationsRequest& WithSearchCriteria(SearchCriteriaT&& value) { SetSearchCriteria(std::forward<SearchCriteriaT>(value)); return *this;}
    ///@}
  private:
