...
class SearchHoursOfOperationsRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  SearchHoursOfOperationsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  SearchHoursOfOperationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchHoursOfOperationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename SearchFilterT = HoursOfOperationSearchFilter>
  SearchHoursOfOperationsRequest& WithSearchFilter(SearchFilterT&& value) {
  ...
  template <typename SearchCriteriaT = HoursOfOperationSearchCriteria>
  SearchHoursOfOperationsRequest& WithSearchCriteria(SearchCriteriaT&& value) {
