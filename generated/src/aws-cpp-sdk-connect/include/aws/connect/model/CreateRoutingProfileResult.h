...
class CreateRoutingProfileResult {
 public:
  ...
  template <typename RoutingProfileArnT = Aws::String>
  CreateRoutingProfileResult& WithRoutingProfileArn(RoutingProfileArnT&& value) {
  ...
  template <typename RoutingProfileIdT = Aws::String>
  CreateRoutingProfileResult& WithRoutingProfileId(RoutingProfileIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRoutingProfileResult& WithRequestId(RequestIdT&& value) {
