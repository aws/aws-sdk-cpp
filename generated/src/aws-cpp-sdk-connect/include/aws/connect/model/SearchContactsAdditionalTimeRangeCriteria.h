...
class SearchContactsAdditionalTimeRangeCriteria {
 public:
  ...
  template <typename TimeRangeT = SearchContactsTimeRange>
  SearchContactsAdditionalTimeRangeCriteria& WithTimeRange(TimeRangeT&& value) {
  ...
  void SetTimestampCondition(TimestampConditionT&& value) {
    m_timestampConditionHasBeenSet = true;
    m_timestampCondition = std::forward<TimestampConditionT>(value);
  }
  template <typename TimestampConditionT = SearchContactsTimestampCondition>
  SearchContactsAdditionalTimeRangeCriteria& WithTimestampCondition(TimestampConditionT&& value) {
    SetTimestampCondition(std::forward<TimestampConditionT>(value));
    return *this;
  }
  ///@}
 private:
