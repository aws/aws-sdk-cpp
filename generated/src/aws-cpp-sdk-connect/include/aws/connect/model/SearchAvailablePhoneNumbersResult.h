...
class SearchAvailablePhoneNumbersResult {
 public:
  ...
  void SetAvailableNumbersList(AvailableNumbersListT&& value) {
    m_availableNumbersListHasBeenSet = true;
    m_availableNumbersList = std::forward<AvailableNumbersListT>(value);
  }
  template <typename AvailableNumbersListT = Aws::Vector<AvailableNumberSummary>>
  SearchAvailablePhoneNumbersResult& WithAvailableNumbersList(AvailableNumbersListT&& value) {
    SetAvailableNumbersList(std::forward<AvailableNumbersListT>(value));
    return *this;
  }
  template <typename AvailableNumbersListT = AvailableNumberSummary>
  SearchAvailablePhoneNumbersResult& AddAvailableNumbersList(AvailableNumbersListT&& value) {
    m_availableNumbersListHasBeenSet = true;
    m_availableNumbersList.emplace_back(std::forward<AvailableNumbersListT>(value));
    return *this;
  }
  ///@}
