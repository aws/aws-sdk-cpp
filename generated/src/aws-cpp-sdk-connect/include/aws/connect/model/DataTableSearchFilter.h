...
/**
 * <p>A data table search filter.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/DataTableSearchFilter">AWS
 * API Reference</a></p>
 */
class DataTableSearchFilter {
 public:
  AWS_CONNECT_API DataTableSearchFilter() = default;
  AWS_CONNECT_API DataTableSearchFilter(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECT_API DataTableSearchFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AttributeFilterT = ControlPlaneAttributeFilter>
  DataTableSearchFilter& WithAttributeFilter(AttributeFilterT&& value) {
