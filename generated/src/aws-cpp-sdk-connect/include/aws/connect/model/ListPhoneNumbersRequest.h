...
class ListPhoneNumbersRequest : public ConnectRequest {
 public:
  ...
  inline ListPhoneNumbersRequest& AddPhoneNumberTypes(PhoneNumberType value) {
    m_phoneNumberTypesHasBeenSet = true;
  ...
  inline ListPhoneNumbersRequest& AddPhoneNumberCountryCodes(PhoneNumberCountryCode value) {
    m_phoneNumberCountryCodesHasBeenSet = true;
