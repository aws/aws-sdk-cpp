...
class InstanceStorageConfig {
 public:
  ...
  inline InstanceStorageConfig& WithStorageType(StorageType value) {
  ...
  void SetKinesisVideoStreamConfig(KinesisVideoStreamConfigT&& value) {
    ...
    m_kinesisVideoStreamConfig = std::forward<KinesisVideoStreamConfigT>(value);
  }
  template <typename KinesisVideoStreamConfigT = KinesisVideoStreamConfig>
  InstanceStorageConfig& WithKinesisVideoStreamConfig(KinesisVideoStreamConfigT&& value) {
    SetKinesisVideoStreamConfig(std::forward<KinesisVideoStreamConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKinesisFirehoseConfig(KinesisFirehoseConfigT&& value) {
    ...
    m_kinesisFirehoseConfig = std::forward<KinesisFirehoseConfigT>(value);
  }
  template <typename KinesisFirehoseConfigT = KinesisFirehoseConfig>
  InstanceStorageConfig& WithKinesisFirehoseConfig(KinesisFirehoseConfigT&& value) {
    SetKinesisFirehoseConfig(std::forward<KinesisFirehoseConfigT>(value));
    return *this;
  }
  ///@}
 private:
