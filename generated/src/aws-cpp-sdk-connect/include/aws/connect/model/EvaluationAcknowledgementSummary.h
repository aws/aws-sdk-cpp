...
/**
 * <p>Summary information about an evaluation acknowledgement.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/EvaluationAcknowledgementSummary">AWS
 * API Reference</a></p>
 */
class EvaluationAcknowledgementSummary {
 public:
  AWS_CONNECT_API EvaluationAcknowledgementSummary() = default;
  AWS_CONNECT_API EvaluationAcknowledgementSummary(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECT_API EvaluationAcknowledgementSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AcknowledgedTimeT = Aws::Utils::DateTime>
  EvaluationAcknowledgementSummary& WithAcknowledgedTime(AcknowledgedTimeT&& value) {
  ...
  template <typename AcknowledgedByT = Aws::String>
  EvaluationAcknowledgementSummary& WithAcknowledgedBy(AcknowledgedByT&& value) {
  ...
  template <typename AcknowledgerCommentT = Aws::String>
  EvaluationAcknowledgementSummary& WithAcknowledgerComment(AcknowledgerCommentT&& value) {
