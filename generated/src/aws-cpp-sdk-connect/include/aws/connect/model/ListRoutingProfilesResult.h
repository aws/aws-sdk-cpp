...
class ListRoutingProfilesResult {
 public:
  ...
  void SetRoutingProfileSummaryList(RoutingProfileSummaryListT&& value) {
    m_routingProfileSummaryListHasBeenSet = true;
    m_routingProfileSummaryList = std::forward<RoutingProfileSummaryListT>(value);
  }
  template <typename RoutingProfileSummaryListT = Aws::Vector<RoutingProfileSummary>>
  ListRoutingProfilesResult& WithRoutingProfileSummaryList(RoutingProfileSummaryListT&& value) {
    SetRoutingProfileSummaryList(std::forward<RoutingProfileSummaryListT>(value));
    return *this;
  }
  template <typename RoutingProfileSummaryListT = RoutingProfileSummary>
  ListRoutingProfilesResult& AddRoutingProfileSummaryList(RoutingProfileSummaryListT&& value) {
    m_routingProfileSummaryListHasBeenSet = true;
    m_routingProfileSummaryList.emplace_back(std::forward<RoutingProfileSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRoutingProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRoutingProfilesResult& WithRequestId(RequestIdT&& value) {
