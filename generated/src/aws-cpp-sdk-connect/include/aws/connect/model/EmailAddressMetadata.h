...
class EmailAddressMetadata {
 public:
  ...
  template <typename EmailAddressIdT = Aws::String>
  EmailAddressMetadata& WithEmailAddressId(EmailAddressIdT&& value) {
  ...
  void SetEmailAddressArn(EmailAddressArnT&& value) {
    ...
    m_emailAddressArn = std::forward<EmailAddressArnT>(value);
  }
  template <typename EmailAddressArnT = Aws::String>
  EmailAddressMetadata& WithEmailAddressArn(EmailAddressArnT&& value) {
    SetEmailAddressArn(std::forward<EmailAddressArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EmailAddressT = Aws::String>
  EmailAddressMetadata& WithEmailAddress(EmailAddressT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  EmailAddressMetadata& WithDescription(DescriptionT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  EmailAddressMetadata& WithDisplayName(DisplayNameT&& value) {
  ...
  void SetAliasConfigurations(AliasConfigurationsT&& value) {
    ...
    m_aliasConfigurations = std::forward<AliasConfigurationsT>(value);
  }
  template <typename AliasConfigurationsT = Aws::Vector<AliasConfiguration>>
  EmailAddressMetadata& WithAliasConfigurations(AliasConfigurationsT&& value) {
    SetAliasConfigurations(std::forward<AliasConfigurationsT>(value));
    return *this;
  }
  template <typename AliasConfigurationsT = AliasConfiguration>
  EmailAddressMetadata& AddAliasConfigurations(AliasConfigurationsT&& value) {
    m_aliasConfigurationsHasBeenSet = true;
    m_aliasConfigurations.emplace_back(std::forward<AliasConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
