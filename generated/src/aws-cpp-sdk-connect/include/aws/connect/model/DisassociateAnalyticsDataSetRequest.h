...
class DisassociateAnalyticsDataSetRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DisassociateAnalyticsDataSetRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  DisassociateAnalyticsDataSetRequest& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename TargetAccountIdT = Aws::String>
  DisassociateAnalyticsDataSetRequest& WithTargetAccountId(TargetAccountIdT&& value) {
