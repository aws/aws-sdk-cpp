...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    AssociateAnalyticsDataSetRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DataSetIdT = Aws::String>
    AssociateAnalyticsDataSetRequest& WithDataSetId(DataSetIdT&& value) { SetDataSetId(std::forward<DataSetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetAccountIdT = Aws::String>
    AssociateAnalyticsDataSetRequest& WithTargetAccountId(TargetAccountIdT&& value) { SetTargetAccountId(std::forward<TargetAccountIdT>(value)); return *this;}
    ///@}
  private:
