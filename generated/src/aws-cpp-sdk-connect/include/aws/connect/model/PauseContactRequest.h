...
class PauseContactRequest : public ConnectRequest {
 public:
  ...
  template <typename ContactIdT = Aws::String>
  PauseContactRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  PauseContactRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactFlowIdT = Aws::String>
  PauseContactRequest& WithContactFlowId(ContactFlowIdT&& value) {
