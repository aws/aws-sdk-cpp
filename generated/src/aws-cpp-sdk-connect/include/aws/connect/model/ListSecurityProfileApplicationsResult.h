...
class ListSecurityProfileApplicationsResult {
 public:
  ...
  template <typename ApplicationsT = Aws::Vector<Application>>
  ListSecurityProfileApplicationsResult& WithApplications(ApplicationsT&& value) {
    SetApplications(std::forward<ApplicationsT>(value));
    return *this;
  }
  template <typename ApplicationsT = Application>
  ListSecurityProfileApplicationsResult& AddApplications(ApplicationsT&& value) {
    m_applicationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityProfileApplicationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  ListSecurityProfileApplicationsResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename LastModifiedRegionT = Aws::String>
  ListSecurityProfileApplicationsResult& WithLastModifiedRegion(LastModifiedRegionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSecurityProfileApplicationsResult& WithRequestId(RequestIdT&& value) {
