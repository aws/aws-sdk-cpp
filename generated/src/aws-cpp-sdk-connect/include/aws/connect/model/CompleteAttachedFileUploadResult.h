...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API CompleteAttachedFileUploadResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CompleteAttachedFileUploadResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
