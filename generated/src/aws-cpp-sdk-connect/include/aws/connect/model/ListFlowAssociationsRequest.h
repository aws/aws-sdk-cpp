...
class ListFlowAssociationsRequest : public ConnectRequest {
 public:
  ...
  inline void SetResourceType(ListFlowAssociationResourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline ListFlowAssociationsRequest& WithResourceType(ListFlowAssociationResourceType value) {
  ...
  inline ListFlowAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
