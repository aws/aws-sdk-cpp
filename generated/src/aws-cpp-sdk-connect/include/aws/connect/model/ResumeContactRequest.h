...
class ResumeContactRequest : public ConnectRequest {
 public:
  ...
  template <typename ContactIdT = Aws::String>
  ResumeContactRequest& WithContactId(ContactIdT&& value) {
  ...
  ///@{
  /**
   * <p>The identifier of the Connect Customer instance. You can find the
  ...
  template <typename InstanceIdT = Aws::String>
  ResumeContactRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactFlowIdT = Aws::String>
  ResumeContactRequest& WithContactFlowId(ContactFlowIdT&& value) {
