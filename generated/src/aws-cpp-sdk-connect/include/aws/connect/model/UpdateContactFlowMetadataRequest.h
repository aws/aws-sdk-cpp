...
class UpdateContactFlowMetadataRequest : public ConnectRequest {
 public:
  ...
  inline void SetContactFlowState(ContactFlowState value) {
    m_contactFlowStateHasBeenSet = true;
    m_contactFlowState = value;
  }
  inline UpdateContactFlowMetadataRequest& WithContactFlowState(ContactFlowState value) {
    SetContactFlowState(value);
    return *this;
  }
  ///@}
 private:
