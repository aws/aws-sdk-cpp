...
class CreateIntegrationAssociationRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  CreateIntegrationAssociationRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline CreateIntegrationAssociationRequest& WithIntegrationType(IntegrationType value) {
  ...
  template <typename IntegrationArnT = Aws::String>
  CreateIntegrationAssociationRequest& WithIntegrationArn(IntegrationArnT&& value) {
  ...
  void SetSourceApplicationUrl(SourceApplicationUrlT&& value) {
    m_sourceApplicationUrlHasBeenSet = true;
    m_sourceApplicationUrl = std::forward<SourceApplicationUrlT>(value);
  }
  template <typename SourceApplicationUrlT = Aws::String>
  CreateIntegrationAssociationRequest& WithSourceApplicationUrl(SourceApplicationUrlT&& value) {
    SetSourceApplicationUrl(std::forward<SourceApplicationUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceApplicationName(SourceApplicationNameT&& value) {
    m_sourceApplicationNameHasBeenSet = true;
    m_sourceApplicationName = std::forward<SourceApplicationNameT>(value);
  }
  template <typename SourceApplicationNameT = Aws::String>
  CreateIntegrationAssociationRequest& WithSourceApplicationName(SourceApplicationNameT&& value) {
    SetSourceApplicationName(std::forward<SourceApplicationNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateIntegrationAssociationRequest& WithSourceType(SourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateIntegrationAssociationRequest& WithTags(TagsT&& value) {
