...
class ListAgentStatusesRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListAgentStatusesRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentStatusesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAgentStatusesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetAgentStatusTypes(AgentStatusTypesT&& value) {
    m_agentStatusTypesHasBeenSet = true;
    m_agentStatusTypes = std::forward<AgentStatusTypesT>(value);
  }
  template <typename AgentStatusTypesT = Aws::Vector<AgentStatusType>>
  ListAgentStatusesRequest& WithAgentStatusTypes(AgentStatusTypesT&& value) {
    SetAgentStatusTypes(std::forward<AgentStatusTypesT>(value));
    return *this;
  }
  inline ListAgentStatusesRequest& AddAgentStatusTypes(AgentStatusType value) {
    m_agentStatusTypesHasBeenSet = true;
    m_agentStatusTypes.push_back(value);
    return *this;
  }
  ///@}
 private:
