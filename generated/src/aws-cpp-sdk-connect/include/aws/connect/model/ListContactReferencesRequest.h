...
class ListContactReferencesRequest : public ConnectRequest {
 public:
  ...
  void SetReferenceTypes(ReferenceTypesT&& value) {
    m_referenceTypesHasBeenSet = true;
    m_referenceTypes = std::forward<ReferenceTypesT>(value);
  }
  template <typename ReferenceTypesT = Aws::Vector<ReferenceType>>
  ListContactReferencesRequest& WithReferenceTypes(ReferenceTypesT&& value) {
    SetReferenceTypes(std::forward<ReferenceTypesT>(value));
    return *this;
  }
  inline ListContactReferencesRequest& AddReferenceTypes(ReferenceType value) {
    m_referenceTypesHasBeenSet = true;
    m_referenceTypes.push_back(value);
    return *this;
  }
  ///@}
