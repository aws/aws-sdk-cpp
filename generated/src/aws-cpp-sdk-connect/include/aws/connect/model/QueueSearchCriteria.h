...
class QueueSearchCriteria {
 public:
  ...
  inline void SetQueueTypeCondition(SearchableQueueType value) {
    m_queueTypeConditionHasBeenSet = true;
    m_queueTypeCondition = value;
  }
  inline QueueSearchCriteria& WithQueueTypeCondition(SearchableQueueType value) {
    SetQueueTypeCondition(value);
    return *this;
  }
  ///@}
 private:
