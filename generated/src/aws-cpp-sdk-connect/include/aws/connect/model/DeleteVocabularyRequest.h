...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DeleteVocabularyRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DeleteVocabularyRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VocabularyIdT = Aws::String>
    DeleteVocabularyRequest& WithVocabularyId(VocabularyIdT&& value) { SetVocabularyId(std::forward<VocabularyIdT>(value)); return *this;}
    ///@}
  private:
