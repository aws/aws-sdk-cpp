...
class UpdateContactFlowContentRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateContactFlowContentRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactFlowIdT = Aws::String>
  UpdateContactFlowContentRequest& WithContactFlowId(ContactFlowIdT&& value) {
  ...
  template <typename ContentT = Aws::String>
  UpdateContactFlowContentRequest& WithContent(ContentT&& value) {
