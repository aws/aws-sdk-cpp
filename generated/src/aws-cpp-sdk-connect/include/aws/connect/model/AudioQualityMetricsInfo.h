...
class AudioQualityMetricsInfo {
 public:
  ...
  inline void SetQualityScore(double value) {
    m_qualityScoreHasBeenSet = true;
    m_qualityScore = value;
  }
  inline AudioQualityMetricsInfo& WithQualityScore(double value) {
  ...
  void SetPotentialQualityIssues(PotentialQualityIssuesT&& value) {
    m_potentialQualityIssuesHasBeenSet = true;
    m_potentialQualityIssues = std::forward<PotentialQualityIssuesT>(value);
  }
  template <typename PotentialQualityIssuesT = Aws::Vector<Aws::String>>
  AudioQualityMetricsInfo& WithPotentialQualityIssues(PotentialQualityIssuesT&& value) {
    SetPotentialQualityIssues(std::forward<PotentialQualityIssuesT>(value));
    return *this;
  }
  template <typename PotentialQualityIssuesT = Aws::String>
  AudioQualityMetricsInfo& AddPotentialQualityIssues(PotentialQualityIssuesT&& value) {
    m_potentialQualityIssuesHasBeenSet = true;
    m_potentialQualityIssues.emplace_back(std::forward<PotentialQualityIssuesT>(value));
    return *this;
  }
  ///@}
 private:
