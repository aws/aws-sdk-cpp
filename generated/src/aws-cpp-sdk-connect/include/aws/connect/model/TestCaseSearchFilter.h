 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/TestCaseSearchFilter">AWS
 * API Reference</a></p>
 */
class TestCaseSearchFilter {
 public:
  AWS_CONNECT_API TestCaseSearchFilter() = default;
  AWS_CONNECT_API TestCaseSearchFilter(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECT_API TestCaseSearchFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
   ...
   * conditions that need to be applied with AND operator.</p>
   */
  ...
  template <typename TagFilterT = ControlPlaneTagFilter>
  TestCaseSearchFilter& WithTagFilter(TagFilterT&& value) {
