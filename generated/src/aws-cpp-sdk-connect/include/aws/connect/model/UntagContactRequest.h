...
class UntagContactRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API UntagContactRequest() = default;
  ...
  template <typename ContactIdT = Aws::String>
  UntagContactRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  UntagContactRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename TagKeysT = Aws::Vector<Aws::String>>
  UntagContactRequest& WithTagKeys(TagKeysT&& value) {
    SetTagKeys(std::forward<TagKeysT>(value));
    return *this;
  }
  template <typename TagKeysT = Aws::String>
  UntagContactRequest& AddTagKeys(TagKeysT&& value) {
    m_tagKeysHasBeenSet = true;
