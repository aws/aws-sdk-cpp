...
/**
 * <p>If this contact was queued, this contains information about the
 * queue.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/ContactSearchSummaryQueueInfo">AWS
 * API Reference</a></p>
 */
class ContactSearchSummaryQueueInfo {
 public:
  ...
  template <typename IdT = Aws::String>
  ContactSearchSummaryQueueInfo& WithId(IdT&& value) {
  ...
  void SetEnqueueTimestamp(EnqueueTimestampT&& value) {
    m_enqueueTimestampHasBeenSet = true;
    m_enqueueTimestamp = std::forward<EnqueueTimestampT>(value);
  }
  template <typename EnqueueTimestampT = Aws::Utils::DateTime>
  ContactSearchSummaryQueueInfo& WithEnqueueTimestamp(EnqueueTimestampT&& value) {
    SetEnqueueTimestamp(std::forward<EnqueueTimestampT>(value));
    return *this;
  }
  ///@}
 private:
