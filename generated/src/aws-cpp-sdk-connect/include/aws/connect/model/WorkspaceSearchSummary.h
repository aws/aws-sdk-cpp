...
/**
 * <p>Contains summary information about a workspace returned from a search
 * operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/WorkspaceSearchSummary">AWS
 * API Reference</a></p>
 */
class WorkspaceSearchSummary {
 public:
  ...
  inline WorkspaceSearchSummary& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
