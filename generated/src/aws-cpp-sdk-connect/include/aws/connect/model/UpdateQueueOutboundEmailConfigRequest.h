...
class UpdateQueueOutboundEmailConfigRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateQueueOutboundEmailConfigRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  UpdateQueueOutboundEmailConfigRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename OutboundEmailConfigT = OutboundEmailConfig>
  UpdateQueueOutboundEmailConfigRequest& WithOutboundEmailConfig(OutboundEmailConfigT&& value) {
