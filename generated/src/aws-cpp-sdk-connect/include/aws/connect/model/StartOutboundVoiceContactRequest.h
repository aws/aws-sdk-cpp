...
class StartOutboundVoiceContactRequest : public ConnectRequest {
 public:
  ...
  inline StartOutboundVoiceContactRequest& WithTrafficType(TrafficType value) {
  ...
  void SetOutboundStrategy(OutboundStrategyT&& value) {
    ...
    m_outboundStrategy = std::forward<OutboundStrategyT>(value);
  }
  template <typename OutboundStrategyT = OutboundStrategy>
  StartOutboundVoiceContactRequest& WithOutboundStrategy(OutboundStrategyT&& value) {
    SetOutboundStrategy(std::forward<OutboundStrategyT>(value));
    return *this;
  }
  ///@}
