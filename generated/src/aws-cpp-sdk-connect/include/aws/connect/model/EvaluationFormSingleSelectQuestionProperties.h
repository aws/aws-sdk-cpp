...
class EvaluationFormSingleSelectQuestionProperties {
 public:
  ...
  template <typename OptionsT = Aws::Vector<EvaluationFormSingleSelectQuestionOption>>
  EvaluationFormSingleSelectQuestionProperties& WithOptions(OptionsT&& value) {
    SetOptions(std::forward<OptionsT>(value));
    return *this;
  }
  template <typename OptionsT = EvaluationFormSingleSelectQuestionOption>
  EvaluationFormSingleSelectQuestionProperties& AddOptions(OptionsT&& value) {
    m_optionsHasBeenSet = true;
  ...
  inline void SetDisplayAs(EvaluationFormSingleSelectQuestionDisplayMode value) {
    m_displayAsHasBeenSet = true;
    m_displayAs = value;
  }
  inline EvaluationFormSingleSelectQuestionProperties& WithDisplayAs(EvaluationFormSingleSelectQuestionDisplayMode value) {
    SetDisplayAs(value);
    return *this;
  }
  ///@}
  ...
  template <typename AutomationT = EvaluationFormSingleSelectQuestionAutomation>
  EvaluationFormSingleSelectQuestionProperties& WithAutomation(AutomationT&& value) {
