...
class CreateRuleRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  CreateRuleRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename TriggerEventSourceT = RuleTriggerEventSource>
  CreateRuleRequest& WithTriggerEventSource(TriggerEventSourceT&& value) {
  ...
  template <typename FunctionT = Aws::String>
  CreateRuleRequest& WithFunction(FunctionT&& value) {
  ...
  inline CreateRuleRequest& WithPublishStatus(RulePublishStatus value) {
