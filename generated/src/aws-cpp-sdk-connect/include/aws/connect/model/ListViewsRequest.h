...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    ListViewsRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    inline ListViewsRequest& WithType(ViewType value) { SetType(value); return *this;}
    ///@}
