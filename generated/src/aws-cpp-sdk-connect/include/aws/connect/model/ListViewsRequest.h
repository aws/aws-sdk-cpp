...
namespace Model
{
  ...
  /**
   */
  class ListViewsRequest : public ConnectRequest
  {
  public:
    AWS_CONNECT_API ListViewsRequest();
    ...
    inline ListViewsRequest& WithInstanceId(const Aws::String& value) { SetInstanceId(value); return *this;}
    inline ListViewsRequest& WithInstanceId(Aws::String&& value) { SetInstanceId(std::move(value)); return *this;}
    inline ListViewsRequest& WithInstanceId(const char* value) { SetInstanceId(value); return *this;}
    ///@}
    ...
    inline ListViewsRequest& WithType(const ViewType& value) { SetType(value); return *this;}
    inline ListViewsRequest& WithType(ViewType&& value) { SetType(std::move(value)); return *this;}
    ///@}
