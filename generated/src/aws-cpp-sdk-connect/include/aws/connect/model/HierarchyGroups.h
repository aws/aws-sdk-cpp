...
class HierarchyGroups {
 public:
  ...
  void SetLevel1(Level1T&& value) {
    ...
    m_level1 = std::forward<Level1T>(value);
  }
  template <typename Level1T = AgentHierarchyGroup>
  HierarchyGroups& WithLevel1(Level1T&& value) {
    SetLevel1(std::forward<Level1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetLevel2(Level2T&& value) {
    ...
    m_level2 = std::forward<Level2T>(value);
  }
  template <typename Level2T = AgentHierarchyGroup>
  HierarchyGroups& WithLevel2(Level2T&& value) {
    SetLevel2(std::forward<Level2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetLevel3(Level3T&& value) {
    ...
    m_level3 = std::forward<Level3T>(value);
  }
  template <typename Level3T = AgentHierarchyGroup>
  HierarchyGroups& WithLevel3(Level3T&& value) {
    SetLevel3(std::forward<Level3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetLevel4(Level4T&& value) {
    ...
    m_level4 = std::forward<Level4T>(value);
  }
  template <typename Level4T = AgentHierarchyGroup>
  HierarchyGroups& WithLevel4(Level4T&& value) {
    SetLevel4(std::forward<Level4T>(value));
    return *this;
  }
  ///@}
  ...
  void SetLevel5(Level5T&& value) {
    ...
    m_level5 = std::forward<Level5T>(value);
  }
  template <typename Level5T = AgentHierarchyGroup>
  HierarchyGroups& WithLevel5(Level5T&& value) {
    SetLevel5(std::forward<Level5T>(value));
    return *this;
  }
  ///@}
 private:
