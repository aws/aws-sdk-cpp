...
/**
 * <p>A batch create data table value success result.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/BatchCreateDataTableValueSuccessResult">AWS
 * API Reference</a></p>
 */
class BatchCreateDataTableValueSuccessResult {
 public:
  AWS_CONNECT_API BatchCreateDataTableValueSuccessResult() = default;
  AWS_CONNECT_API BatchCreateDataTableValueSuccessResult(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECT_API BatchCreateDataTableValueSuccessResult& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename PrimaryValuesT = Aws::Vector<PrimaryValue>>
  BatchCreateDataTableValueSuccessResult& WithPrimaryValues(PrimaryValuesT&& value) {
    SetPrimaryValues(std::forward<PrimaryValuesT>(value));
    return *this;
  }
  template <typename PrimaryValuesT = PrimaryValue>
  BatchCreateDataTableValueSuccessResult& AddPrimaryValues(PrimaryValuesT&& value) {
    m_primaryValuesHasBeenSet = true;
  ...
  template <typename AttributeNameT = Aws::String>
  BatchCreateDataTableValueSuccessResult& WithAttributeName(AttributeNameT&& value) {
  ...
  template <typename RecordIdT = Aws::String>
  BatchCreateDataTableValueSuccessResult& WithRecordId(RecordIdT&& value) {
  ...
  template <typename LockVersionT = DataTableLockVersion>
  BatchCreateDataTableValueSuccessResult& WithLockVersion(LockVersionT&& value) {
