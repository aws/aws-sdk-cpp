...
class ListHoursOfOperationsResult {
 public:
  ...
  void SetHoursOfOperationSummaryList(HoursOfOperationSummaryListT&& value) {
    m_hoursOfOperationSummaryListHasBeenSet = true;
    m_hoursOfOperationSummaryList = std::forward<HoursOfOperationSummaryListT>(value);
  }
  template <typename HoursOfOperationSummaryListT = Aws::Vector<HoursOfOperationSummary>>
  ListHoursOfOperationsResult& WithHoursOfOperationSummaryList(HoursOfOperationSummaryListT&& value) {
    SetHoursOfOperationSummaryList(std::forward<HoursOfOperationSummaryListT>(value));
    return *this;
  }
  template <typename HoursOfOperationSummaryListT = HoursOfOperationSummary>
  ListHoursOfOperationsResult& AddHoursOfOperationSummaryList(HoursOfOperationSummaryListT&& value) {
    m_hoursOfOperationSummaryListHasBeenSet = true;
    m_hoursOfOperationSummaryList.emplace_back(std::forward<HoursOfOperationSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListHoursOfOperationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListHoursOfOperationsResult& WithRequestId(RequestIdT&& value) {
