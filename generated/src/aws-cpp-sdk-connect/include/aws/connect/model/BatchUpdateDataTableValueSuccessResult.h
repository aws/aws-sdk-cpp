...
/**
 * <p>A batch update data table value success result.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/BatchUpdateDataTableValueSuccessResult">AWS
 * API Reference</a></p>
 */
class BatchUpdateDataTableValueSuccessResult {
 public:
  AWS_CONNECT_API BatchUpdateDataTableValueSuccessResult() = default;
  AWS_CONNECT_API BatchUpdateDataTableValueSuccessResult(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECT_API BatchUpdateDataTableValueSuccessResult& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename PrimaryValuesT = Aws::Vector<PrimaryValue>>
  BatchUpdateDataTableValueSuccessResult& WithPrimaryValues(PrimaryValuesT&& value) {
    SetPrimaryValues(std::forward<PrimaryValuesT>(value));
    return *this;
  }
  template <typename PrimaryValuesT = PrimaryValue>
  BatchUpdateDataTableValueSuccessResult& AddPrimaryValues(PrimaryValuesT&& value) {
    m_primaryValuesHasBeenSet = true;
  ...
  template <typename AttributeNameT = Aws::String>
  BatchUpdateDataTableValueSuccessResult& WithAttributeName(AttributeNameT&& value) {
  ...
  template <typename LockVersionT = DataTableLockVersion>
  BatchUpdateDataTableValueSuccessResult& WithLockVersion(LockVersionT&& value) {
