...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DeleteAttachedFileResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAttachedFileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
