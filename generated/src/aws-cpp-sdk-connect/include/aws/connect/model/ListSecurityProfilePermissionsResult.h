...
class ListSecurityProfilePermissionsResult {
 public:
  ...
  template <typename PermissionsT = Aws::Vector<Aws::String>>
  ListSecurityProfilePermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = Aws::String>
  ListSecurityProfilePermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityProfilePermissionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  ListSecurityProfilePermissionsResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename LastModifiedRegionT = Aws::String>
  ListSecurityProfilePermissionsResult& WithLastModifiedRegion(LastModifiedRegionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSecurityProfilePermissionsResult& WithRequestId(RequestIdT&& value) {
