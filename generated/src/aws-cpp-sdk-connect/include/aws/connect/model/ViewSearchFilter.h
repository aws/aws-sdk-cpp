...
/**
 * <p>Defines filters to apply when searching for views, such as tag-based
 * filters.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/ViewSearchFilter">AWS
 * API Reference</a></p>
 */
class ViewSearchFilter {
 public:
  AWS_CONNECT_API ViewSearchFilter() = default;
  AWS_CONNECT_API ViewSearchFilter(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECT_API ViewSearchFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AttributeFilterT = ControlPlaneAttributeFilter>
  ViewSearchFilter& WithAttributeFilter(AttributeFilterT&& value) {
