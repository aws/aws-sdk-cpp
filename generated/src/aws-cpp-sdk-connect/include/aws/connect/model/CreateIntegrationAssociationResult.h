...
class CreateIntegrationAssociationResult {
 public:
  ...
  void SetIntegrationAssociationId(IntegrationAssociationIdT&& value) {
    ...
    m_integrationAssociationId = std::forward<IntegrationAssociationIdT>(value);
  }
  template <typename IntegrationAssociationIdT = Aws::String>
  CreateIntegrationAssociationResult& WithIntegrationAssociationId(IntegrationAssociationIdT&& value) {
    SetIntegrationAssociationId(std::forward<IntegrationAssociationIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntegrationAssociationArn(IntegrationAssociationArnT&& value) {
    ...
    m_integrationAssociationArn = std::forward<IntegrationAssociationArnT>(value);
  }
  template <typename IntegrationAssociationArnT = Aws::String>
  CreateIntegrationAssociationResult& WithIntegrationAssociationArn(IntegrationAssociationArnT&& value) {
    SetIntegrationAssociationArn(std::forward<IntegrationAssociationArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateIntegrationAssociationResult& WithRequestId(RequestIdT&& value) {
