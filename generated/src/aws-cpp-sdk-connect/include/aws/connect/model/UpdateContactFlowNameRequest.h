...
class UpdateContactFlowNameRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API UpdateContactFlowNameRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateContactFlowNameRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactFlowIdT = Aws::String>
  UpdateContactFlowNameRequest& WithContactFlowId(ContactFlowIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateContactFlowNameRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateContactFlowNameRequest& WithDescription(DescriptionT&& value) {
