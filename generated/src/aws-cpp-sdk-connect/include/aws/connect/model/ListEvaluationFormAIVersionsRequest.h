...
/**
 */
class ListEvaluationFormAIVersionsRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API ListEvaluationFormAIVersionsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListEvaluationFormAIVersions"; }
  ...
  template <typename InstanceIdT = Aws::String>
  ListEvaluationFormAIVersionsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline ListEvaluationFormAIVersionsRequest& WithContactInteractionType(ContactInteractionType value) {
  ...
  inline ListEvaluationFormAIVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEvaluationFormAIVersionsRequest& WithNextToken(NextTokenT&& value) {
