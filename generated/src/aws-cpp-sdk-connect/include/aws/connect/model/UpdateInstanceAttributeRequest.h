...
class UpdateInstanceAttributeRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateInstanceAttributeRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline UpdateInstanceAttributeRequest& WithAttributeType(InstanceAttributeType value) {
  ...
  template <typename ValueT = Aws::String>
  UpdateInstanceAttributeRequest& WithValue(ValueT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateInstanceAttributeRequest& WithClientToken(ClientTokenT&& value) {
