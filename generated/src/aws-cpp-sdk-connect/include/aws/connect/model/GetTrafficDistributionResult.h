...
class GetTrafficDistributionResult {
 public:
  ...
  void SetTelephonyConfig(TelephonyConfigT&& value) {
    ...
    m_telephonyConfig = std::forward<TelephonyConfigT>(value);
  }
  template <typename TelephonyConfigT = TelephonyConfig>
  GetTrafficDistributionResult& WithTelephonyConfig(TelephonyConfigT&& value) {
    SetTelephonyConfig(std::forward<TelephonyConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSignInConfig(SignInConfigT&& value) {
    ...
    m_signInConfig = std::forward<SignInConfigT>(value);
  }
  template <typename SignInConfigT = SignInConfig>
  GetTrafficDistributionResult& WithSignInConfig(SignInConfigT&& value) {
    SetSignInConfig(std::forward<SignInConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAgentConfig(AgentConfigT&& value) {
    ...
    m_agentConfig = std::forward<AgentConfigT>(value);
  }
  template <typename AgentConfigT = AgentConfig>
  GetTrafficDistributionResult& WithAgentConfig(AgentConfigT&& value) {
    SetAgentConfig(std::forward<AgentConfigT>(value));
    return *this;
  }
  ///@}
