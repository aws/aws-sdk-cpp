...
class StartContactRecordingRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  StartContactRecordingRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactIdT = Aws::String>
  StartContactRecordingRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename InitialContactIdT = Aws::String>
  StartContactRecordingRequest& WithInitialContactId(InitialContactIdT&& value) {
  ...
  void SetVoiceRecordingConfiguration(VoiceRecordingConfigurationT&& value) {
    m_voiceRecordingConfigurationHasBeenSet = true;
    m_voiceRecordingConfiguration = std::forward<VoiceRecordingConfigurationT>(value);
  }
  template <typename VoiceRecordingConfigurationT = VoiceRecordingConfiguration>
  StartContactRecordingRequest& WithVoiceRecordingConfiguration(VoiceRecordingConfigurationT&& value) {
    SetVoiceRecordingConfiguration(std::forward<VoiceRecordingConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
