 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/RuleAttributeAndCondition">AWS
 * API Reference</a></p>
 */
class RuleAttributeAndCondition {
 public:
  ...
  ///@{
  /**
   * <p>A list of tag conditions that need to be applied with <code>AND</code>
   * condition.</p>
   */
