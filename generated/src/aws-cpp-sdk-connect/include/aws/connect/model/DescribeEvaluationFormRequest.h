...
class DescribeEvaluationFormRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DescribeEvaluationFormRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename EvaluationFormIdT = Aws::String>
  DescribeEvaluationFormRequest& WithEvaluationFormId(EvaluationFormIdT&& value) {
  ...
  inline DescribeEvaluationFormRequest& WithEvaluationFormVersion(int value) {
