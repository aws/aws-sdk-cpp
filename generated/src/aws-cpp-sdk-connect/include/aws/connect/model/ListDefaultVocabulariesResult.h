...
namespace Model
{
  ...
  public:
    ...
    inline ListDefaultVocabulariesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListDefaultVocabulariesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListDefaultVocabulariesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
