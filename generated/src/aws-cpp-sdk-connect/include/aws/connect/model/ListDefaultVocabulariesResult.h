...
class ListDefaultVocabulariesResult {
 public:
  ...
  void SetDefaultVocabularyList(DefaultVocabularyListT&& value) {
    m_defaultVocabularyListHasBeenSet = true;
    m_defaultVocabularyList = std::forward<DefaultVocabularyListT>(value);
  }
  template <typename DefaultVocabularyListT = Aws::Vector<DefaultVocabulary>>
  ListDefaultVocabulariesResult& WithDefaultVocabularyList(DefaultVocabularyListT&& value) {
    SetDefaultVocabularyList(std::forward<DefaultVocabularyListT>(value));
    return *this;
  }
  template <typename DefaultVocabularyListT = DefaultVocabulary>
  ListDefaultVocabulariesResult& AddDefaultVocabularyList(DefaultVocabularyListT&& value) {
    m_defaultVocabularyListHasBeenSet = true;
    m_defaultVocabularyList.emplace_back(std::forward<DefaultVocabularyListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDefaultVocabulariesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDefaultVocabulariesResult& WithRequestId(RequestIdT&& value) {
