...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API ResumeContactRecordingResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ResumeContactRecordingResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
