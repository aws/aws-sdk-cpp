...
class SearchHoursOfOperationOverridesRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  SearchHoursOfOperationOverridesRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  SearchHoursOfOperationOverridesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchHoursOfOperationOverridesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename SearchFilterT = HoursOfOperationSearchFilter>
  SearchHoursOfOperationOverridesRequest& WithSearchFilter(SearchFilterT&& value) {
  ...
  template <typename SearchCriteriaT = HoursOfOperationOverrideSearchCriteria>
  SearchHoursOfOperationOverridesRequest& WithSearchCriteria(SearchCriteriaT&& value) {
