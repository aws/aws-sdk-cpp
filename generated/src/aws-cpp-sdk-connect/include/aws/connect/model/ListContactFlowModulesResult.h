...
class ListContactFlowModulesResult {
 public:
  ...
  void SetContactFlowModulesSummaryList(ContactFlowModulesSummaryListT&& value) {
    m_contactFlowModulesSummaryListHasBeenSet = true;
    m_contactFlowModulesSummaryList = std::forward<ContactFlowModulesSummaryListT>(value);
  }
  template <typename ContactFlowModulesSummaryListT = Aws::Vector<ContactFlowModuleSummary>>
  ListContactFlowModulesResult& WithContactFlowModulesSummaryList(ContactFlowModulesSummaryListT&& value) {
    SetContactFlowModulesSummaryList(std::forward<ContactFlowModulesSummaryListT>(value));
    return *this;
  }
  template <typename ContactFlowModulesSummaryListT = ContactFlowModuleSummary>
  ListContactFlowModulesResult& AddContactFlowModulesSummaryList(ContactFlowModulesSummaryListT&& value) {
    m_contactFlowModulesSummaryListHasBeenSet = true;
    m_contactFlowModulesSummaryList.emplace_back(std::forward<ContactFlowModulesSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContactFlowModulesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListContactFlowModulesResult& WithRequestId(RequestIdT&& value) {
