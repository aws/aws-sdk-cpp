...
namespace Model
{
  ...
  public:
     ...
     * | <code>AGENT_HIERARCHY_LEVEL_THREE</code> |
     * <code>AGENT_HIERARCHY_LEVEL_FOUR</code> |
     * <code>AGENT_HIERARCHY_LEVEL_FIVE</code> </p>
     */
     ...
     * <dt>AGENT_ADHERENT_TIME</dt> <dd> <p>This metric is available only in Amazon Web
     * Services Regions where <a
     ...
     * Hierarchy </p> </dd> <dt>AGENT_NON_RESPONSE</dt> <dd> <p>Unit: Count</p>
     * <p>Valid groupings and filters: Queue, Channel, Routing Profile, Agent, Agent
     * Hierarchy </p> </dd> <dt>AGENT_NON_RESPONSE_WITHOUT_CUSTOMER_ABANDONS</dt> <dd>
     * <p>Unit: Count</p> <p>Valid groupings and filters: Queue, Channel, Routing
     * Profile, Agent, Agent Hierarchy</p> <p>Data for this metric is available
     * starting from October 1, 2023 0:00:00 GMT.</p> </dd> <dt>AGENT_OCCUPANCY</dt>
     * <dd> <p>Unit: Percentage</p> <p>Valid groupings and filters: Routing Profile,
     * Agent, Agent Hierarchy </p> </dd> <dt>AGENT_SCHEDULE_ADHERENCE</dt> <dd> <p>This
     * metric is available only in Amazon Web Services Regions where <a
     * href="https://docs.aws.amazon.com/connect/latest/adminguide/regions.html#optimization_region">Forecasting,
     ...
     * Queue, Channel, Routing Profile, Agent, Agent Hierarchy</p>  <p>The
     * <code>Negate</code> key in Metric Level Filters is not applicable for this
     * metric.</p>  </dd> <dt>AVG_CONTACT_DURATION</dt> <dd> <p>Unit:
     * Seconds</p> <p>Valid groupings and filters: Queue, Channel, Routing Profile,
     * Agent, Agent Hierarchy, Feature</p>  <p>Feature is a valid filter but not
     * a valid grouping.</p>  </dd> <dt>AVG_CONVERSATION_DURATION</dt> <dd>
     * <p>Unit: Seconds</p> <p>Valid groupings and filters: Queue, Channel, Routing
     * Profile, Agent, Agent Hierarchy</p> </dd> <dt>AVG_GREETING_TIME_AGENT</dt> <dd>
     ...
     * and filters: Queue, Channel, Routing Profile, Agent, Agent Hierarchy</p> </dd>
     ...
     * <p>Valid groupings and filters: Queue, Channel, Routing Profile, Feature</p>
     *  <p>Feature is a valid filter but not a valid grouping.</p>  </dd>
     * <dt>AVG_RESOLUTION_TIME</dt> <dd> <p>Unit: Seconds</p> <p>Valid groupings and
     * filters: Queue, Channel, Routing Profile</p> </dd> <dt>AVG_TALK_TIME</dt> <dd>
     * <p>This metric is available only for contacts analyzed by Contact Lens
     * conversational analytics.</p> <p>Unit: Seconds</p> <p>Valid groupings and
     * filters: Queue, Channel, Routing Profile, Agent, Agent Hierarchy</p> </dd>
     ...
     * analyzed by Contact Lens conversational analytics.</p> <p>Unit: Seconds</p>
     * <p>Valid groupings and filters: Queue, Channel, Routing Profile, Agent, Agent
     * Hierarchy</p> </dd> <dt>AVG_TALK_TIME_CUSTOMER</dt> <dd> <p>This metric is
     ...
     * Channel, Routing Profile, Feature</p>  <p>Feature is a valid filter but
     * not a valid grouping.</p>  </dd> <dt>CONTACTS_HANDLED</dt> <dd> <p>Unit:
     * Count</p> <p>Valid metric filter key: <code>INITIATION_METHOD</code>,
     * <code>DISCONNECT_REASON</code> </p> <p>Valid groupings and filters: Queue,
     * Channel, Routing Profile, Agent, Agent Hierarchy, Feature</p>  <p>Feature
     * is a valid filter but not a valid grouping.</p>  </dd>
     * <dt>CONTACTS_HOLD_ABANDONS</dt> <dd> <p>Unit: Count</p> <p>Valid groupings and
     * filters: Queue, Channel, Routing Profile, Agent, Agent Hierarchy</p> </dd>
     * <dt>CONTACTS_QUEUED</dt> <dd> <p>Unit: Count</p> <p>Valid groupings and filters:
     ...
     * filters: Queue, Channel, Routing Profile</p> <p>Threshold: For
     ...
     * Count</p> <p>Valid groupings and filters: Queue, Channel, Routing Profile,
     * Agent, Agent Hierarchy, Feature</p>  <p>Feature is a valid filter but not
     * a valid grouping.</p>  </dd> <dt>CONTACTS_TRANSFERRED_OUT_BY_AGENT</dt>
