...
namespace Model
{
  ...
  public:
     ...
     * <dl> <dt>AGENT_ADHERENT_TIME</dt> <dd> <p>This metric is available only in
     * Amazon Web Services Regions where <a
     ...
     * <p>Valid groupings and filters: Queue, Channel, Routing Profile, Agent, Agent
     * Hierarchy </p> </dd> <dt>AGENT_OCCUPANCY</dt> <dd> <p>Unit: Percentage</p>
     * <p>Valid groupings and filters: Routing Profile, Agent, Agent Hierarchy </p>
     * </dd> <dt>AGENT_SCHEDULE_ADHERENCE</dt> <dd> <p>This metric is available only in
     * Amazon Web Services Regions where <a
     * href="https://docs.aws.amazon.com/connect/latest/adminguide/regions.html#optimization_region">Forecasting,
