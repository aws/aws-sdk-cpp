...
class EvaluationFormVersionSummary {
 public:
  ...
  inline EvaluationFormVersionSummary& WithEvaluationFormVersion(int value) {
  ...
  inline EvaluationFormVersionSummary& WithLocked(bool value) {
    SetLocked(value);
    return *this;
  }
  ///@}
  ...
  inline EvaluationFormVersionSummary& WithStatus(EvaluationFormVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
