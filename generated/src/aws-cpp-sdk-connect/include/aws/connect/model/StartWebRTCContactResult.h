...
class StartWebRTCContactResult {
 public:
  ...
  void SetConnectionData(ConnectionDataT&& value) {
    m_connectionDataHasBeenSet = true;
    m_connectionData = std::forward<ConnectionDataT>(value);
  }
  template <typename ConnectionDataT = ConnectionData>
  StartWebRTCContactResult& WithConnectionData(ConnectionDataT&& value) {
    SetConnectionData(std::forward<ConnectionDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ContactIdT = Aws::String>
  StartWebRTCContactResult& WithContactId(ContactIdT&& value) {
  ...
  template <typename ParticipantIdT = Aws::String>
  StartWebRTCContactResult& WithParticipantId(ParticipantIdT&& value) {
  ...
  template <typename ParticipantTokenT = Aws::String>
  StartWebRTCContactResult& WithParticipantToken(ParticipantTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartWebRTCContactResult& WithRequestId(RequestIdT&& value) {
