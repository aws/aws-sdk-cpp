...
class Expression {
 public:
  ...
  void SetAttributeCondition(AttributeConditionT&& value) {
    ...
    m_attributeCondition = std::forward<AttributeConditionT>(value);
  }
  template <typename AttributeConditionT = AttributeCondition>
  Expression& WithAttributeCondition(AttributeConditionT&& value) {
    SetAttributeCondition(std::forward<AttributeConditionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAndExpression(AndExpressionT&& value) {
    ...
    m_andExpression = std::forward<AndExpressionT>(value);
  }
  template <typename AndExpressionT = Aws::Vector<Expression>>
  Expression& WithAndExpression(AndExpressionT&& value) {
    SetAndExpression(std::forward<AndExpressionT>(value));
    return *this;
  }
  template <typename AndExpressionT = Expression>
  Expression& AddAndExpression(AndExpressionT&& value) {
    m_andExpressionHasBeenSet = true;
    m_andExpression.emplace_back(std::forward<AndExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOrExpression(OrExpressionT&& value) {
    ...
    m_orExpression = std::forward<OrExpressionT>(value);
  }
  template <typename OrExpressionT = Aws::Vector<Expression>>
  Expression& WithOrExpression(OrExpressionT&& value) {
    SetOrExpression(std::forward<OrExpressionT>(value));
    return *this;
  }
  template <typename OrExpressionT = Expression>
  Expression& AddOrExpression(OrExpressionT&& value) {
    m_orExpressionHasBeenSet = true;
    m_orExpression.emplace_back(std::forward<OrExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNotAttributeCondition(NotAttributeConditionT&& value) {
    ...
    m_notAttributeCondition = std::forward<NotAttributeConditionT>(value);
  }
  template <typename NotAttributeConditionT = AttributeCondition>
  Expression& WithNotAttributeCondition(NotAttributeConditionT&& value) {
    SetNotAttributeCondition(std::forward<NotAttributeConditionT>(value));
    return *this;
  }
  ///@}
 private:
