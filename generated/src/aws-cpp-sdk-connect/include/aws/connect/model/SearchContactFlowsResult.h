...
class SearchContactFlowsResult {
 public:
  ...
  void SetContactFlows(ContactFlowsT&& value) {
    m_contactFlowsHasBeenSet = true;
    m_contactFlows = std::forward<ContactFlowsT>(value);
  }
  template <typename ContactFlowsT = Aws::Vector<ContactFlow>>
  SearchContactFlowsResult& WithContactFlows(ContactFlowsT&& value) {
    SetContactFlows(std::forward<ContactFlowsT>(value));
    return *this;
  }
  template <typename ContactFlowsT = ContactFlow>
  SearchContactFlowsResult& AddContactFlows(ContactFlowsT&& value) {
    m_contactFlowsHasBeenSet = true;
    m_contactFlows.emplace_back(std::forward<ContactFlowsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchContactFlowsResult& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchContactFlowsResult& WithApproximateTotalCount(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchContactFlowsResult& WithRequestId(RequestIdT&& value) {
