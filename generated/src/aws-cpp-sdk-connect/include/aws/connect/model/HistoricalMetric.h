...
class HistoricalMetric {
 public:
  ...
  inline void SetName(HistoricalMetricName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline HistoricalMetric& WithName(HistoricalMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline HistoricalMetric& WithStatistic(Statistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline HistoricalMetric& WithUnit(Unit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
