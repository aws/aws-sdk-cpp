...
class ListSecurityKeysResult {
 public:
  ...
  void SetSecurityKeys(SecurityKeysT&& value) {
    m_securityKeysHasBeenSet = true;
    m_securityKeys = std::forward<SecurityKeysT>(value);
  }
  template <typename SecurityKeysT = Aws::Vector<SecurityKey>>
  ListSecurityKeysResult& WithSecurityKeys(SecurityKeysT&& value) {
    SetSecurityKeys(std::forward<SecurityKeysT>(value));
    return *this;
  }
  template <typename SecurityKeysT = SecurityKey>
  ListSecurityKeysResult& AddSecurityKeys(SecurityKeysT&& value) {
    m_securityKeysHasBeenSet = true;
    m_securityKeys.emplace_back(std::forward<SecurityKeysT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityKeysResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSecurityKeysResult& WithRequestId(RequestIdT&& value) {
