...
class UserData {
 public:
  ...
  void SetRoutingProfile(RoutingProfileT&& value) {
    ...
    m_routingProfile = std::forward<RoutingProfileT>(value);
  }
  template <typename RoutingProfileT = RoutingProfileReference>
  UserData& WithRoutingProfile(RoutingProfileT&& value) {
    SetRoutingProfile(std::forward<RoutingProfileT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHierarchyPath(HierarchyPathT&& value) {
    ...
    m_hierarchyPath = std::forward<HierarchyPathT>(value);
  }
  template <typename HierarchyPathT = HierarchyPathReference>
  UserData& WithHierarchyPath(HierarchyPathT&& value) {
    SetHierarchyPath(std::forward<HierarchyPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAvailableSlotsByChannel(AvailableSlotsByChannelT&& value) {
    ...
    m_availableSlotsByChannel = std::forward<AvailableSlotsByChannelT>(value);
  }
  template <typename AvailableSlotsByChannelT = Aws::Map<Channel, int>>
  UserData& WithAvailableSlotsByChannel(AvailableSlotsByChannelT&& value) {
    SetAvailableSlotsByChannel(std::forward<AvailableSlotsByChannelT>(value));
    return *this;
  }
  inline UserData& AddAvailableSlotsByChannel(Channel key, int value) {
    m_availableSlotsByChannelHasBeenSet = true;
    m_availableSlotsByChannel.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetMaxSlotsByChannel(MaxSlotsByChannelT&& value) {
    ...
    m_maxSlotsByChannel = std::forward<MaxSlotsByChannelT>(value);
  }
  template <typename MaxSlotsByChannelT = Aws::Map<Channel, int>>
  UserData& WithMaxSlotsByChannel(MaxSlotsByChannelT&& value) {
    SetMaxSlotsByChannel(std::forward<MaxSlotsByChannelT>(value));
    return *this;
  }
  inline UserData& AddMaxSlotsByChannel(Channel key, int value) {
    m_maxSlotsByChannelHasBeenSet = true;
    m_maxSlotsByChannel.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetActiveSlotsByChannel(ActiveSlotsByChannelT&& value) {
    ...
    m_activeSlotsByChannel = std::forward<ActiveSlotsByChannelT>(value);
  }
  template <typename ActiveSlotsByChannelT = Aws::Map<Channel, int>>
  UserData& WithActiveSlotsByChannel(ActiveSlotsByChannelT&& value) {
    SetActiveSlotsByChannel(std::forward<ActiveSlotsByChannelT>(value));
    return *this;
  }
  inline UserData& AddActiveSlotsByChannel(Channel key, int value) {
    m_activeSlotsByChannelHasBeenSet = true;
    m_activeSlotsByChannel.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetNextStatus(NextStatusT&& value) {
    ...
    m_nextStatus = std::forward<NextStatusT>(value);
  }
  template <typename NextStatusT = Aws::String>
  UserData& WithNextStatus(NextStatusT&& value) {
    SetNextStatus(std::forward<NextStatusT>(value));
    return *this;
  }
  ///@}
 private:
