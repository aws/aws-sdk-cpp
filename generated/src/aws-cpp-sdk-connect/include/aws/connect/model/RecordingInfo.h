...
class RecordingInfo {
 public:
  ...
  inline RecordingInfo& WithStorageType(StorageType value) {
  ...
  inline RecordingInfo& WithMediaStreamType(MediaStreamType value) {
  ...
  inline RecordingInfo& WithParticipantType(ParticipantType value) {
  ...
  void SetFragmentStartNumber(FragmentStartNumberT&& value) {
    ...
    m_fragmentStartNumber = std::forward<FragmentStartNumberT>(value);
  }
  template <typename FragmentStartNumberT = Aws::String>
  RecordingInfo& WithFragmentStartNumber(FragmentStartNumberT&& value) {
    SetFragmentStartNumber(std::forward<FragmentStartNumberT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFragmentStopNumber(FragmentStopNumberT&& value) {
    ...
    m_fragmentStopNumber = std::forward<FragmentStopNumberT>(value);
  }
  template <typename FragmentStopNumberT = Aws::String>
  RecordingInfo& WithFragmentStopNumber(FragmentStopNumberT&& value) {
    SetFragmentStopNumber(std::forward<FragmentStopNumberT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(RecordingStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline RecordingInfo& WithStatus(RecordingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDeletionReason(DeletionReasonT&& value) {
    ...
    m_deletionReason = std::forward<DeletionReasonT>(value);
  }
  template <typename DeletionReasonT = Aws::String>
  RecordingInfo& WithDeletionReason(DeletionReasonT&& value) {
    SetDeletionReason(std::forward<DeletionReasonT>(value));
    return *this;
  }
  ///@}
