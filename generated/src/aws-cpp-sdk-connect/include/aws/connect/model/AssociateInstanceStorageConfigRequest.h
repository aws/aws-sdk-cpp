...
class AssociateInstanceStorageConfigRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  AssociateInstanceStorageConfigRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline AssociateInstanceStorageConfigRequest& WithResourceType(InstanceStorageResourceType value) {
  ...
  template <typename StorageConfigT = InstanceStorageConfig>
  AssociateInstanceStorageConfigRequest& WithStorageConfig(StorageConfigT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  AssociateInstanceStorageConfigRequest& WithClientToken(ClientTokenT&& value) {
