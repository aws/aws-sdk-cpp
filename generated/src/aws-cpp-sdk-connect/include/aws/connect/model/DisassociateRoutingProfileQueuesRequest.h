...
class DisassociateRoutingProfileQueuesRequest : public ConnectRequest {
 public:
  ...
  void SetQueueReferences(QueueReferencesT&& value) {
    m_queueReferencesHasBeenSet = true;
    m_queueReferences = std::forward<QueueReferencesT>(value);
  }
  template <typename QueueReferencesT = Aws::Vector<RoutingProfileQueueReference>>
  DisassociateRoutingProfileQueuesRequest& WithQueueReferences(QueueReferencesT&& value) {
    SetQueueReferences(std::forward<QueueReferencesT>(value));
    return *this;
  }
  ...
  DisassociateRoutingProfileQueuesRequest& AddQueueReferences(QueueReferencesT&& value) {
    m_queueReferencesHasBeenSet = true;
    m_queueReferences.emplace_back(std::forward<QueueReferencesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<RoutingProfileQueueReference>& GetManualAssignmentQueueReferences() const {
    return m_manualAssignmentQueueReferences;
  }
  ...
  void SetManualAssignmentQueueReferences(ManualAssignmentQueueReferencesT&& value) {
    m_manualAssignmentQueueReferencesHasBeenSet = true;
    m_manualAssignmentQueueReferences = std::forward<ManualAssignmentQueueReferencesT>(value);
  }
  template <typename ManualAssignmentQueueReferencesT = Aws::Vector<RoutingProfileQueueReference>>
  DisassociateRoutingProfileQueuesRequest& WithManualAssignmentQueueReferences(ManualAssignmentQueueReferencesT&& value) {
    SetManualAssignmentQueueReferences(std::forward<ManualAssignmentQueueReferencesT>(value));
    return *this;
  }
  ...
  DisassociateRoutingProfileQueuesRequest& AddManualAssignmentQueueReferences(ManualAssignmentQueueReferencesT&& value) {
    m_manualAssignmentQueueReferencesHasBeenSet = true;
    m_manualAssignmentQueueReferences.emplace_back(std::forward<ManualAssignmentQueueReferencesT>(value));
    return *this;
  }
  ///@}
 private:
