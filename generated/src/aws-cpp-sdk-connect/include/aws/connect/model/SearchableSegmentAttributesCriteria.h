...
class SearchableSegmentAttributesCriteria {
 public:
  ...
  template <typename KeyT = Aws::String>
  SearchableSegmentAttributesCriteria& WithKey(KeyT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  SearchableSegmentAttributesCriteria& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  SearchableSegmentAttributesCriteria& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
