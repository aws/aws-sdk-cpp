...
class TagContactRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API TagContactRequest() = default;
  ...
  template <typename ContactIdT = Aws::String>
  TagContactRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  TagContactRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  TagContactRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  TagContactRequest& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
