...
class DeletePredefinedAttributeRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API DeletePredefinedAttributeRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  DeletePredefinedAttributeRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeletePredefinedAttributeRequest& WithName(NameT&& value) {
