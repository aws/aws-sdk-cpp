...
class ImportPhoneNumberResult {
 public:
  ...
  template <typename PhoneNumberIdT = Aws::String>
  ImportPhoneNumberResult& WithPhoneNumberId(PhoneNumberIdT&& value) {
  ...
  template <typename PhoneNumberArnT = Aws::String>
  ImportPhoneNumberResult& WithPhoneNumberArn(PhoneNumberArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ImportPhoneNumberResult& WithRequestId(RequestIdT&& value) {
