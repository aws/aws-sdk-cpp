...
namespace Model
{
  ...
  public:
    ...
    void SetPostAcceptTimeoutConfig(PostAcceptTimeoutConfigT&& value) { m_postAcceptTimeoutConfigHasBeenSet = true; m_postAcceptTimeoutConfig = std::forward<PostAcceptTimeoutConfigT>(value); }
    template<typename PostAcceptTimeoutConfigT = PostAcceptTimeoutConfig>
    Preview& WithPostAcceptTimeoutConfig(PostAcceptTimeoutConfigT&& value) { SetPostAcceptTimeoutConfig(std::forward<PostAcceptTimeoutConfigT>(value)); return *this;}
    ///@}
    ...
    void SetAllowedUserActions(AllowedUserActionsT&& value) { m_allowedUserActionsHasBeenSet = true; m_allowedUserActions = std::forward<AllowedUserActionsT>(value); }
    template<typename AllowedUserActionsT = Aws::Vector<AllowedUserAction>>
    Preview& WithAllowedUserActions(AllowedUserActionsT&& value) { SetAllowedUserActions(std::forward<AllowedUserActionsT>(value)); return *this;}
    inline Preview& AddAllowedUserActions(AllowedUserAction value) { m_allowedUserActionsHasBeenSet = true; m_allowedUserActions.push_back(value); return *this; }
    ///@}
  private:
