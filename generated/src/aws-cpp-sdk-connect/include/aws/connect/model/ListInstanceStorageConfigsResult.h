...
class ListInstanceStorageConfigsResult {
 public:
  ...
  void SetStorageConfigs(StorageConfigsT&& value) {
    m_storageConfigsHasBeenSet = true;
    m_storageConfigs = std::forward<StorageConfigsT>(value);
  }
  template <typename StorageConfigsT = Aws::Vector<InstanceStorageConfig>>
  ListInstanceStorageConfigsResult& WithStorageConfigs(StorageConfigsT&& value) {
    SetStorageConfigs(std::forward<StorageConfigsT>(value));
    return *this;
  }
  template <typename StorageConfigsT = InstanceStorageConfig>
  ListInstanceStorageConfigsResult& AddStorageConfigs(StorageConfigsT&& value) {
    m_storageConfigsHasBeenSet = true;
    m_storageConfigs.emplace_back(std::forward<StorageConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInstanceStorageConfigsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInstanceStorageConfigsResult& WithRequestId(RequestIdT&& value) {
