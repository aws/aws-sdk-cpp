...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API UpdateContactFlowModuleMetadataResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateContactFlowModuleMetadataResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
