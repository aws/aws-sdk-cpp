...
class UserIdentityInfo {
 public:
  ...
  void SetSecondaryEmail(SecondaryEmailT&& value) {
    ...
    m_secondaryEmail = std::forward<SecondaryEmailT>(value);
  }
  template <typename SecondaryEmailT = Aws::String>
  UserIdentityInfo& WithSecondaryEmail(SecondaryEmailT&& value) {
    SetSecondaryEmail(std::forward<SecondaryEmailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMobile(MobileT&& value) {
    ...
    m_mobile = std::forward<MobileT>(value);
  }
  template <typename MobileT = Aws::String>
  UserIdentityInfo& WithMobile(MobileT&& value) {
    SetMobile(std::forward<MobileT>(value));
    return *this;
  }
  ///@}
 private:
