...
class CreateEmailAddressResult {
 public:
  ...
  template <typename EmailAddressIdT = Aws::String>
  CreateEmailAddressResult& WithEmailAddressId(EmailAddressIdT&& value) {
  ...
  template <typename EmailAddressArnT = Aws::String>
  CreateEmailAddressResult& WithEmailAddressArn(EmailAddressArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEmailAddressResult& WithRequestId(RequestIdT&& value) {
