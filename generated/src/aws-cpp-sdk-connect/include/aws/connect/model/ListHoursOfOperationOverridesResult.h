...
class ListHoursOfOperationOverridesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListHoursOfOperationOverridesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetHoursOfOperationOverrideList(HoursOfOperationOverrideListT&& value) {
    m_hoursOfOperationOverrideListHasBeenSet = true;
    m_hoursOfOperationOverrideList = std::forward<HoursOfOperationOverrideListT>(value);
  }
  template <typename HoursOfOperationOverrideListT = Aws::Vector<HoursOfOperationOverride>>
  ListHoursOfOperationOverridesResult& WithHoursOfOperationOverrideList(HoursOfOperationOverrideListT&& value) {
    SetHoursOfOperationOverrideList(std::forward<HoursOfOperationOverrideListT>(value));
    return *this;
  }
  template <typename HoursOfOperationOverrideListT = HoursOfOperationOverride>
  ListHoursOfOperationOverridesResult& AddHoursOfOperationOverrideList(HoursOfOperationOverrideListT&& value) {
    m_hoursOfOperationOverrideListHasBeenSet = true;
    m_hoursOfOperationOverrideList.emplace_back(std::forward<HoursOfOperationOverrideListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastModifiedRegionT = Aws::String>
  ListHoursOfOperationOverridesResult& WithLastModifiedRegion(LastModifiedRegionT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  ListHoursOfOperationOverridesResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListHoursOfOperationOverridesResult& WithRequestId(RequestIdT&& value) {
