...
class UpdateEvaluationFormRequest : public ConnectRequest {
 public:
  ...
  inline UpdateEvaluationFormRequest& WithEvaluationFormVersion(int value) {
  ...
  inline UpdateEvaluationFormRequest& WithCreateNewVersion(bool value) {
  ...
  template <typename AIVersionT = Aws::String>
  UpdateEvaluationFormRequest& WithAIVersion(AIVersionT&& value) {
