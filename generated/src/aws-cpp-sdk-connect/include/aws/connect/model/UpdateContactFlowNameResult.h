...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API UpdateContactFlowNameResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateContactFlowNameResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
