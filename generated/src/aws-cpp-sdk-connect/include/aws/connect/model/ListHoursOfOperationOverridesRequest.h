...
class ListHoursOfOperationOverridesRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListHoursOfOperationOverridesRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename HoursOfOperationIdT = Aws::String>
  ListHoursOfOperationOverridesRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListHoursOfOperationOverridesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListHoursOfOperationOverridesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
