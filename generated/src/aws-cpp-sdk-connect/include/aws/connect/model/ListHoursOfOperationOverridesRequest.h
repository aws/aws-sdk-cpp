...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API ListHoursOfOperationOverridesRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    ListHoursOfOperationOverridesRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HoursOfOperationIdT = Aws::String>
    ListHoursOfOperationOverridesRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) { SetHoursOfOperationId(std::forward<HoursOfOperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListHoursOfOperationOverridesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
