...
class GetCurrentMetricDataRequest : public ConnectRequest {
 public:
  ...
  inline GetCurrentMetricDataRequest& AddGroupings(Grouping value) {
    m_groupingsHasBeenSet = true;
  ...
  void SetCurrentMetrics(CurrentMetricsT&& value) {
    m_currentMetricsHasBeenSet = true;
    m_currentMetrics = std::forward<CurrentMetricsT>(value);
  }
  template <typename CurrentMetricsT = Aws::Vector<CurrentMetric>>
  GetCurrentMetricDataRequest& WithCurrentMetrics(CurrentMetricsT&& value) {
    SetCurrentMetrics(std::forward<CurrentMetricsT>(value));
    return *this;
  }
  template <typename CurrentMetricsT = CurrentMetric>
  GetCurrentMetricDataRequest& AddCurrentMetrics(CurrentMetricsT&& value) {
    m_currentMetricsHasBeenSet = true;
    m_currentMetrics.emplace_back(std::forward<CurrentMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetCurrentMetricDataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
