...
class ListQuickConnectsResult {
 public:
  ...
  template <typename QuickConnectSummaryListT = Aws::Vector<QuickConnectSummary>>
  ListQuickConnectsResult& WithQuickConnectSummaryList(QuickConnectSummaryListT&& value) {
  ...
  ListQuickConnectsResult& AddQuickConnectSummaryList(QuickConnectSummaryListT&& value) {
    m_quickConnectSummaryListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListQuickConnectsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListQuickConnectsResult& WithRequestId(RequestIdT&& value) {
