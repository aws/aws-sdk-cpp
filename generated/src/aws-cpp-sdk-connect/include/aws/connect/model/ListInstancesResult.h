...
class ListInstancesResult {
 public:
  ...
  void SetInstanceSummaryList(InstanceSummaryListT&& value) {
    m_instanceSummaryListHasBeenSet = true;
    m_instanceSummaryList = std::forward<InstanceSummaryListT>(value);
  }
  template <typename InstanceSummaryListT = Aws::Vector<InstanceSummary>>
  ListInstancesResult& WithInstanceSummaryList(InstanceSummaryListT&& value) {
    SetInstanceSummaryList(std::forward<InstanceSummaryListT>(value));
    return *this;
  }
  template <typename InstanceSummaryListT = InstanceSummary>
  ListInstancesResult& AddInstanceSummaryList(InstanceSummaryListT&& value) {
    m_instanceSummaryListHasBeenSet = true;
    m_instanceSummaryList.emplace_back(std::forward<InstanceSummaryListT>(value));
    return *this;
  }
  ///@}
