...
class AssociateAnalyticsDataSetResult {
 public:
  ...
  template <typename DataSetIdT = Aws::String>
  AssociateAnalyticsDataSetResult& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename TargetAccountIdT = Aws::String>
  AssociateAnalyticsDataSetResult& WithTargetAccountId(TargetAccountIdT&& value) {
  ...
  void SetResourceShareId(ResourceShareIdT&& value) {
    ...
    m_resourceShareId = std::forward<ResourceShareIdT>(value);
  }
  template <typename ResourceShareIdT = Aws::String>
  AssociateAnalyticsDataSetResult& WithResourceShareId(ResourceShareIdT&& value) {
    SetResourceShareId(std::forward<ResourceShareIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceShareArnT = Aws::String>
  AssociateAnalyticsDataSetResult& WithResourceShareArn(ResourceShareArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateAnalyticsDataSetResult& WithRequestId(RequestIdT&& value) {
