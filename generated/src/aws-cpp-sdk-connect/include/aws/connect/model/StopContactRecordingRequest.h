...
class StopContactRecordingRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  StopContactRecordingRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactIdT = Aws::String>
  StopContactRecordingRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename InitialContactIdT = Aws::String>
  StopContactRecordingRequest& WithInitialContactId(InitialContactIdT&& value) {
  ...
  inline StopContactRecordingRequest& WithContactRecordingType(ContactRecordingType value) {
