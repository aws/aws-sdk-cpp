...
/**
 */
class SearchRulesRequest : public ConnectRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "SearchRules"; }
  ...
  inline SearchRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const RulesSearchCriteria& GetSearchCriteria() const { return m_searchCriteria; }
  inline bool SearchCriteriaHasBeenSet() const { return m_searchCriteriaHasBeenSet; }
  template <typename SearchCriteriaT = RulesSearchCriteria>
   ...
   */
  inline const RulesSearchFilter& GetSearchFilter() const { return m_searchFilter; }
  inline bool SearchFilterHasBeenSet() const { return m_searchFilterHasBeenSet; }
  template <typename SearchFilterT = RulesSearchFilter>
 ...
 private:
  ...
  RulesSearchCriteria m_searchCriteria;

  RulesSearchFilter m_searchFilter;
