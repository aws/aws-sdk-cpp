...
/**
 */
class DeleteContactFlowModuleAliasRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API DeleteContactFlowModuleAliasRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "DeleteContactFlowModuleAlias"; }
  ...
  template <typename InstanceIdT = Aws::String>
  DeleteContactFlowModuleAliasRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactFlowModuleIdT = Aws::String>
  DeleteContactFlowModuleAliasRequest& WithContactFlowModuleId(ContactFlowModuleIdT&& value) {
  ...
  template <typename AliasIdT = Aws::String>
  DeleteContactFlowModuleAliasRequest& WithAliasId(AliasIdT&& value) {
