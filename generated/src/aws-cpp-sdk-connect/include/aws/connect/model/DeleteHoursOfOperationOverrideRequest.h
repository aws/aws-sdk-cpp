...
class DeleteHoursOfOperationOverrideRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DeleteHoursOfOperationOverrideRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename HoursOfOperationIdT = Aws::String>
  DeleteHoursOfOperationOverrideRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) {
  ...
  template <typename HoursOfOperationOverrideIdT = Aws::String>
  DeleteHoursOfOperationOverrideRequest& WithHoursOfOperationOverrideId(HoursOfOperationOverrideIdT&& value) {
