...
class ClaimPhoneNumberRequest : public ConnectRequest {
 public:
  ...
  template <typename TargetArnT = Aws::String>
  ClaimPhoneNumberRequest& WithTargetArn(TargetArnT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  ClaimPhoneNumberRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename PhoneNumberT = Aws::String>
  ClaimPhoneNumberRequest& WithPhoneNumber(PhoneNumberT&& value) {
  ...
  template <typename PhoneNumberDescriptionT = Aws::String>
  ClaimPhoneNumberRequest& WithPhoneNumberDescription(PhoneNumberDescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ClaimPhoneNumberRequest& WithTags(TagsT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  ClaimPhoneNumberRequest& WithClientToken(ClientTokenT&& value) {
