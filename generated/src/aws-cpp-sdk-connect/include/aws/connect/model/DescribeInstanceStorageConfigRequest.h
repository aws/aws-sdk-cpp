...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DescribeInstanceStorageConfigRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeInstanceStorageConfigRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AssociationIdT = Aws::String>
    DescribeInstanceStorageConfigRequest& WithAssociationId(AssociationIdT&& value) { SetAssociationId(std::forward<AssociationIdT>(value)); return *this;}
    ///@}
    ...
    inline DescribeInstanceStorageConfigRequest& WithResourceType(InstanceStorageResourceType value) { SetResourceType(value); return *this;}
    ///@}
  private:
