...
class DescribeInstanceStorageConfigRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DescribeInstanceStorageConfigRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename AssociationIdT = Aws::String>
  DescribeInstanceStorageConfigRequest& WithAssociationId(AssociationIdT&& value) {
  ...
  inline DescribeInstanceStorageConfigRequest& WithResourceType(InstanceStorageResourceType value) {
