...
/**
 */
class AssociateContactWithUserRequest : public ConnectRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "AssociateContactWithUser"; }
