...
class ListQuickConnectsRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListQuickConnectsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListQuickConnectsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListQuickConnectsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetQuickConnectTypes(QuickConnectTypesT&& value) {
    m_quickConnectTypesHasBeenSet = true;
    m_quickConnectTypes = std::forward<QuickConnectTypesT>(value);
  }
  template <typename QuickConnectTypesT = Aws::Vector<QuickConnectType>>
  ListQuickConnectsRequest& WithQuickConnectTypes(QuickConnectTypesT&& value) {
    SetQuickConnectTypes(std::forward<QuickConnectTypesT>(value));
    return *this;
  }
  inline ListQuickConnectsRequest& AddQuickConnectTypes(QuickConnectType value) {
    m_quickConnectTypesHasBeenSet = true;
    m_quickConnectTypes.push_back(value);
    return *this;
  }
  ///@}
 private:
