...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DescribeUserRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeUserRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
  private:
