...
class StartContactEvaluationResult {
 public:
  ...
  template <typename EvaluationIdT = Aws::String>
  StartContactEvaluationResult& WithEvaluationId(EvaluationIdT&& value) {
  ...
  template <typename EvaluationArnT = Aws::String>
  StartContactEvaluationResult& WithEvaluationArn(EvaluationArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartContactEvaluationResult& WithRequestId(RequestIdT&& value) {
