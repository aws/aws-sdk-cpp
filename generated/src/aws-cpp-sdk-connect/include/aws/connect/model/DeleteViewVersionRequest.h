...
class DeleteViewVersionRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DeleteViewVersionRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ViewIdT = Aws::String>
  DeleteViewVersionRequest& WithViewId(ViewIdT&& value) {
  ...
  inline void SetViewVersion(int value) {
    m_viewVersionHasBeenSet = true;
    m_viewVersion = value;
  }
  inline DeleteViewVersionRequest& WithViewVersion(int value) {
