...
class UpdateEvaluationFormResult {
 public:
  ...
  template <typename EvaluationFormIdT = Aws::String>
  UpdateEvaluationFormResult& WithEvaluationFormId(EvaluationFormIdT&& value) {
  ...
  template <typename EvaluationFormArnT = Aws::String>
  UpdateEvaluationFormResult& WithEvaluationFormArn(EvaluationFormArnT&& value) {
  ...
  inline UpdateEvaluationFormResult& WithEvaluationFormVersion(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateEvaluationFormResult& WithRequestId(RequestIdT&& value) {
