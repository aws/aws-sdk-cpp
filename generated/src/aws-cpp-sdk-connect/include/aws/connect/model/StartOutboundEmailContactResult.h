...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API StartOutboundEmailContactResult() = default;
    ...
    template<typename ContactIdT = Aws::String>
    StartOutboundEmailContactResult& WithContactId(ContactIdT&& value) { SetContactId(std::forward<ContactIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartOutboundEmailContactResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
