...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    UpdateContactEvaluationRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EvaluationIdT = Aws::String>
    UpdateContactEvaluationRequest& WithEvaluationId(EvaluationIdT&& value) { SetEvaluationId(std::forward<EvaluationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AnswersT = Aws::Map<Aws::String, EvaluationAnswerInput>>
    UpdateContactEvaluationRequest& WithAnswers(AnswersT&& value) { SetAnswers(std::forward<AnswersT>(value)); return *this;}
    ...
    template<typename NotesT = Aws::Map<Aws::String, EvaluationNote>>
    UpdateContactEvaluationRequest& WithNotes(NotesT&& value) { SetNotes(std::forward<NotesT>(value)); return *this;}
