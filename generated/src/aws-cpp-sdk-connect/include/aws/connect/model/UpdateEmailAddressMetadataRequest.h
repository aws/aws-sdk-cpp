...
class UpdateEmailAddressMetadataRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateEmailAddressMetadataRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename EmailAddressIdT = Aws::String>
  UpdateEmailAddressMetadataRequest& WithEmailAddressId(EmailAddressIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateEmailAddressMetadataRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  UpdateEmailAddressMetadataRequest& WithDisplayName(DisplayNameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateEmailAddressMetadataRequest& WithClientToken(ClientTokenT&& value) {
