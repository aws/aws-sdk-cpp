...
class UpdateUserPhoneConfigRequest : public ConnectRequest {
 public:
  ...
  template <typename PhoneConfigT = UserPhoneConfig>
  UpdateUserPhoneConfigRequest& WithPhoneConfig(PhoneConfigT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  UpdateUserPhoneConfigRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateUserPhoneConfigRequest& WithInstanceId(InstanceIdT&& value) {
