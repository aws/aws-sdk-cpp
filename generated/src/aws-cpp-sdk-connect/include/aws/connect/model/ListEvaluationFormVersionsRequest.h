...
class ListEvaluationFormVersionsRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListEvaluationFormVersionsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename EvaluationFormIdT = Aws::String>
  ListEvaluationFormVersionsRequest& WithEvaluationFormId(EvaluationFormIdT&& value) {
  ...
  inline ListEvaluationFormVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEvaluationFormVersionsRequest& WithNextToken(NextTokenT&& value) {
