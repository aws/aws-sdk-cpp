...
class SearchQueuesResult {
 public:
  AWS_CONNECT_API SearchQueuesResult() = default;
  ...
  template <typename QueuesT = Aws::Vector<Queue>>
  SearchQueuesResult& WithQueues(QueuesT&& value) {
    SetQueues(std::forward<QueuesT>(value));
    return *this;
  }
  template <typename QueuesT = Queue>
  SearchQueuesResult& AddQueues(QueuesT&& value) {
    m_queuesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchQueuesResult& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchQueuesResult& WithApproximateTotalCount(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchQueuesResult& WithRequestId(RequestIdT&& value) {
