...
class ReplicateInstanceResult {
 public:
  AWS_CONNECT_API ReplicateInstanceResult() = default;
  ...
  template <typename IdT = Aws::String>
  ReplicateInstanceResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ReplicateInstanceResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ReplicateInstanceResult& WithRequestId(RequestIdT&& value) {
