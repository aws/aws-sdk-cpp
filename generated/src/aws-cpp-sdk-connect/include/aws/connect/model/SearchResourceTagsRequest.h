...
class SearchResourceTagsRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API SearchResourceTagsRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  SearchResourceTagsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ResourceTypesT = Aws::Vector<Aws::String>>
  SearchResourceTagsRequest& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  template <typename ResourceTypesT = Aws::String>
  SearchResourceTagsRequest& AddResourceTypes(ResourceTypesT&& value) {
    m_resourceTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchResourceTagsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchResourceTagsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename SearchCriteriaT = ResourceTagsSearchCriteria>
  ...
  template <typename SearchCriteriaT = ResourceTagsSearchCriteria>
  SearchResourceTagsRequest& WithSearchCriteria(SearchCriteriaT&& value) {
