...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API EmailReference() = default;
    ...
    template<typename NameT = Aws::String>
    EmailReference& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    EmailReference& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
