...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API BatchAssociateAnalyticsDataSetRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    BatchAssociateAnalyticsDataSetRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DataSetIdsT = Aws::Vector<Aws::String>>
    BatchAssociateAnalyticsDataSetRequest& WithDataSetIds(DataSetIdsT&& value) { SetDataSetIds(std::forward<DataSetIdsT>(value)); return *this;}
    template<typename DataSetIdsT = Aws::String>
    BatchAssociateAnalyticsDataSetRequest& AddDataSetIds(DataSetIdsT&& value) { m_dataSetIdsHasBeenSet = true; m_dataSetIds.emplace_back(std::forward<DataSetIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename TargetAccountIdT = Aws::String>
    BatchAssociateAnalyticsDataSetRequest& WithTargetAccountId(TargetAccountIdT&& value) { SetTargetAccountId(std::forward<TargetAccountIdT>(value)); return *this;}
    ///@}
  private:
