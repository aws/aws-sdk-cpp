...
class BatchAssociateAnalyticsDataSetRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  BatchAssociateAnalyticsDataSetRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename DataSetIdsT = Aws::Vector<Aws::String>>
  BatchAssociateAnalyticsDataSetRequest& WithDataSetIds(DataSetIdsT&& value) {
    SetDataSetIds(std::forward<DataSetIdsT>(value));
    return *this;
  }
  template <typename DataSetIdsT = Aws::String>
  BatchAssociateAnalyticsDataSetRequest& AddDataSetIds(DataSetIdsT&& value) {
    m_dataSetIdsHasBeenSet = true;
  ...
  template <typename TargetAccountIdT = Aws::String>
  BatchAssociateAnalyticsDataSetRequest& WithTargetAccountId(TargetAccountIdT&& value) {
