...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API AssociateDefaultVocabularyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateDefaultVocabularyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
