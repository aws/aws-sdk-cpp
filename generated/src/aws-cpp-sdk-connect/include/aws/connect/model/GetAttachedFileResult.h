...
class GetAttachedFileResult {
 public:
  ...
  inline GetAttachedFileResult& WithFileStatus(FileStatusType value) {
    SetFileStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetAttachedFileResult& WithFileSizeInBytes(long long value) {
  ...
  inline GetAttachedFileResult& WithFileUseCaseType(FileUseCaseType value) {
  ...
  void SetDownloadUrlMetadata(DownloadUrlMetadataT&& value) {
    ...
    m_downloadUrlMetadata = std::forward<DownloadUrlMetadataT>(value);
  }
  template <typename DownloadUrlMetadataT = DownloadUrlMetadata>
  GetAttachedFileResult& WithDownloadUrlMetadata(DownloadUrlMetadataT&& value) {
    SetDownloadUrlMetadata(std::forward<DownloadUrlMetadataT>(value));
    return *this;
  }
  ///@}
