...
class HierarchyGroupCondition {
 public:
  ...
  template <typename ValueT = Aws::String>
  HierarchyGroupCondition& WithValue(ValueT&& value) {
  ...
  inline void SetHierarchyGroupMatchType(HierarchyGroupMatchType value) {
    m_hierarchyGroupMatchTypeHasBeenSet = true;
    m_hierarchyGroupMatchType = value;
  }
  inline HierarchyGroupCondition& WithHierarchyGroupMatchType(HierarchyGroupMatchType value) {
    SetHierarchyGroupMatchType(value);
    return *this;
  }
  ///@}
 private:
