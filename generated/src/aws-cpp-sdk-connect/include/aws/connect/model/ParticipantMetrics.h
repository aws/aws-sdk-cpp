...
class ParticipantMetrics {
 public:
  ...
  inline ParticipantMetrics& WithParticipantType(ParticipantType value) {
  ...
  inline void SetConversationAbandon(bool value) {
    m_conversationAbandonHasBeenSet = true;
    m_conversationAbandon = value;
  }
  inline ParticipantMetrics& WithConversationAbandon(bool value) {
    SetConversationAbandon(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMessagesSent(int value) {
    m_messagesSentHasBeenSet = true;
    m_messagesSent = value;
  }
  inline ParticipantMetrics& WithMessagesSent(int value) {
  ...
  inline void SetNumResponses(int value) {
    m_numResponsesHasBeenSet = true;
    m_numResponses = value;
  }
  inline ParticipantMetrics& WithNumResponses(int value) {
  ...
  inline void SetMessageLengthInChars(int value) {
    m_messageLengthInCharsHasBeenSet = true;
    m_messageLengthInChars = value;
  }
  inline ParticipantMetrics& WithMessageLengthInChars(int value) {
    SetMessageLengthInChars(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalResponseTimeInMillis(long long value) {
    m_totalResponseTimeInMillisHasBeenSet = true;
    m_totalResponseTimeInMillis = value;
  }
  inline ParticipantMetrics& WithTotalResponseTimeInMillis(long long value) {
    SetTotalResponseTimeInMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxResponseTimeInMillis(long long value) {
    m_maxResponseTimeInMillisHasBeenSet = true;
    m_maxResponseTimeInMillis = value;
  }
  inline ParticipantMetrics& WithMaxResponseTimeInMillis(long long value) {
    SetMaxResponseTimeInMillis(value);
    return *this;
  }
  ///@}
  ...
  void SetLastMessageTimestamp(LastMessageTimestampT&& value) {
    ...
    m_lastMessageTimestamp = std::forward<LastMessageTimestampT>(value);
  }
  template <typename LastMessageTimestampT = Aws::Utils::DateTime>
  ParticipantMetrics& WithLastMessageTimestamp(LastMessageTimestampT&& value) {
    SetLastMessageTimestamp(std::forward<LastMessageTimestampT>(value));
    return *this;
  }
  ///@}
 private:
