...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API UpdateTrafficDistributionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateTrafficDistributionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
