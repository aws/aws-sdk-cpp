...
namespace Model
{
  ...
  public:
    ...
    inline UpdateTrafficDistributionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateTrafficDistributionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateTrafficDistributionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
