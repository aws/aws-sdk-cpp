...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DescribeContactRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeContactRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
