...
class ListUserProficienciesResult {
 public:
  ...
  void SetUserProficiencyList(UserProficiencyListT&& value) {
    m_userProficiencyListHasBeenSet = true;
    m_userProficiencyList = std::forward<UserProficiencyListT>(value);
  }
  template <typename UserProficiencyListT = Aws::Vector<UserProficiency>>
  ListUserProficienciesResult& WithUserProficiencyList(UserProficiencyListT&& value) {
    SetUserProficiencyList(std::forward<UserProficiencyListT>(value));
    return *this;
  }
  ...
  ListUserProficienciesResult& AddUserProficiencyList(UserProficiencyListT&& value) {
    m_userProficiencyListHasBeenSet = true;
    m_userProficiencyList.emplace_back(std::forward<UserProficiencyListT>(value));
    return *this;
  }
  ///@}
