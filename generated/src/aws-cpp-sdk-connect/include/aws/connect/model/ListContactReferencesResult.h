...
class ListContactReferencesResult {
 public:
  ...
  void SetReferenceSummaryList(ReferenceSummaryListT&& value) {
    m_referenceSummaryListHasBeenSet = true;
    m_referenceSummaryList = std::forward<ReferenceSummaryListT>(value);
  }
  template <typename ReferenceSummaryListT = Aws::Vector<ReferenceSummary>>
  ListContactReferencesResult& WithReferenceSummaryList(ReferenceSummaryListT&& value) {
    SetReferenceSummaryList(std::forward<ReferenceSummaryListT>(value));
    return *this;
  }
  template <typename ReferenceSummaryListT = ReferenceSummary>
  ListContactReferencesResult& AddReferenceSummaryList(ReferenceSummaryListT&& value) {
    m_referenceSummaryListHasBeenSet = true;
    m_referenceSummaryList.emplace_back(std::forward<ReferenceSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContactReferencesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListContactReferencesResult& WithRequestId(RequestIdT&& value) {
