...
/**
 * <p>A batch create data table value failure result.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/BatchCreateDataTableValueFailureResult">AWS
 * API Reference</a></p>
 */
class BatchCreateDataTableValueFailureResult {
 public:
  AWS_CONNECT_API BatchCreateDataTableValueFailureResult() = default;
  AWS_CONNECT_API BatchCreateDataTableValueFailureResult(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECT_API BatchCreateDataTableValueFailureResult& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename PrimaryValuesT = Aws::Vector<PrimaryValue>>
  BatchCreateDataTableValueFailureResult& WithPrimaryValues(PrimaryValuesT&& value) {
    SetPrimaryValues(std::forward<PrimaryValuesT>(value));
    return *this;
  }
  template <typename PrimaryValuesT = PrimaryValue>
  BatchCreateDataTableValueFailureResult& AddPrimaryValues(PrimaryValuesT&& value) {
    m_primaryValuesHasBeenSet = true;
  ...
  template <typename AttributeNameT = Aws::String>
  BatchCreateDataTableValueFailureResult& WithAttributeName(AttributeNameT&& value) {
  ...
  template <typename MessageT = Aws::String>
  BatchCreateDataTableValueFailureResult& WithMessage(MessageT&& value) {
