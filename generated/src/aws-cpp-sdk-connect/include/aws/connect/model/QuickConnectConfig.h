...
class QuickConnectConfig {
 public:
  ...
  inline QuickConnectConfig& WithQuickConnectType(QuickConnectType value) {
  ...
  void SetUserConfig(UserConfigT&& value) {
    ...
    m_userConfig = std::forward<UserConfigT>(value);
  }
  template <typename UserConfigT = UserQuickConnectConfig>
  QuickConnectConfig& WithUserConfig(UserConfigT&& value) {
    SetUserConfig(std::forward<UserConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueueConfig(QueueConfigT&& value) {
    ...
    m_queueConfig = std::forward<QueueConfigT>(value);
  }
  template <typename QueueConfigT = QueueQuickConnectConfig>
  QuickConnectConfig& WithQueueConfig(QueueConfigT&& value) {
    SetQueueConfig(std::forward<QueueConfigT>(value));
    return *this;
  }
  ///@}
