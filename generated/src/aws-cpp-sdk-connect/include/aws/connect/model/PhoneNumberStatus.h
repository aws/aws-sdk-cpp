...
class PhoneNumberStatus {
 public:
  ...
  inline void SetStatus(PhoneNumberWorkflowStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline PhoneNumberStatus& WithStatus(PhoneNumberWorkflowStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  PhoneNumberStatus& WithMessage(MessageT&& value) {
