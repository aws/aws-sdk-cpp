...
class StartScreenSharingRequest : public ConnectRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  StartScreenSharingRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  StartScreenSharingRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactIdT = Aws::String>
  StartScreenSharingRequest& WithContactId(ContactIdT&& value) {
