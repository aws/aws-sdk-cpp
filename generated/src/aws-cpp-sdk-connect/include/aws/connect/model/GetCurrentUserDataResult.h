...
class GetCurrentUserDataResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  GetCurrentUserDataResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetUserDataList(UserDataListT&& value) {
    m_userDataListHasBeenSet = true;
    m_userDataList = std::forward<UserDataListT>(value);
  }
  template <typename UserDataListT = Aws::Vector<UserData>>
  GetCurrentUserDataResult& WithUserDataList(UserDataListT&& value) {
    SetUserDataList(std::forward<UserDataListT>(value));
    return *this;
  }
  template <typename UserDataListT = UserData>
  GetCurrentUserDataResult& AddUserDataList(UserDataListT&& value) {
    m_userDataListHasBeenSet = true;
    m_userDataList.emplace_back(std::forward<UserDataListT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetCurrentUserDataResult& WithApproximateTotalCount(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCurrentUserDataResult& WithRequestId(RequestIdT&& value) {
