...
namespace Model
{
  ...
  public:
    ...
    inline GetCurrentUserDataResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetCurrentUserDataResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetCurrentUserDataResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
