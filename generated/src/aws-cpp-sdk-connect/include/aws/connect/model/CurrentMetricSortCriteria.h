...
class CurrentMetricSortCriteria {
 public:
  ...
  inline void SetSortByMetric(CurrentMetricName value) {
    m_sortByMetricHasBeenSet = true;
    m_sortByMetric = value;
  }
  inline CurrentMetricSortCriteria& WithSortByMetric(CurrentMetricName value) {
    SetSortByMetric(value);
    return *this;
  }
  ///@}
  ...
  inline CurrentMetricSortCriteria& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
