...
class TransferContactRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  TransferContactRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactIdT = Aws::String>
  TransferContactRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  TransferContactRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  TransferContactRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename ContactFlowIdT = Aws::String>
  TransferContactRequest& WithContactFlowId(ContactFlowIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  TransferContactRequest& WithClientToken(ClientTokenT&& value) {
