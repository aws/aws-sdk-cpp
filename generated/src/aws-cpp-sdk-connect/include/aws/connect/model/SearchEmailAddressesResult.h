...
class SearchEmailAddressesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  SearchEmailAddressesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetEmailAddresses(EmailAddressesT&& value) {
    m_emailAddressesHasBeenSet = true;
    m_emailAddresses = std::forward<EmailAddressesT>(value);
  }
  template <typename EmailAddressesT = Aws::Vector<EmailAddressMetadata>>
  SearchEmailAddressesResult& WithEmailAddresses(EmailAddressesT&& value) {
    SetEmailAddresses(std::forward<EmailAddressesT>(value));
    return *this;
  }
  template <typename EmailAddressesT = EmailAddressMetadata>
  SearchEmailAddressesResult& AddEmailAddresses(EmailAddressesT&& value) {
    m_emailAddressesHasBeenSet = true;
    m_emailAddresses.emplace_back(std::forward<EmailAddressesT>(value));
    return *this;
  }
  ///@}
  ...
  inline SearchEmailAddressesResult& WithApproximateTotalCount(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchEmailAddressesResult& WithRequestId(RequestIdT&& value) {
