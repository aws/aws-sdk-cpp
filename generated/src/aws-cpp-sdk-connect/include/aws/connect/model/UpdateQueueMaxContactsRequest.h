...
class UpdateQueueMaxContactsRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateQueueMaxContactsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  UpdateQueueMaxContactsRequest& WithQueueId(QueueIdT&& value) {
  ...
  inline UpdateQueueMaxContactsRequest& WithMaxContacts(int value) {
