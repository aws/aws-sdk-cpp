...
class DescribeSecurityProfileResult {
 public:
  ...
  void SetSecurityProfile(SecurityProfileT&& value) {
    m_securityProfileHasBeenSet = true;
    m_securityProfile = std::forward<SecurityProfileT>(value);
  }
  template <typename SecurityProfileT = SecurityProfile>
  DescribeSecurityProfileResult& WithSecurityProfile(SecurityProfileT&& value) {
    SetSecurityProfile(std::forward<SecurityProfileT>(value));
    return *this;
  }
  ///@}
