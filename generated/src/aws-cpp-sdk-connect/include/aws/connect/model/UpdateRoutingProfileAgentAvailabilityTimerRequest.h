...
class UpdateRoutingProfileAgentAvailabilityTimerRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateRoutingProfileAgentAvailabilityTimerRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename RoutingProfileIdT = Aws::String>
  UpdateRoutingProfileAgentAvailabilityTimerRequest& WithRoutingProfileId(RoutingProfileIdT&& value) {
  ...
  inline UpdateRoutingProfileAgentAvailabilityTimerRequest& WithAgentAvailabilityTimer(AgentAvailabilityTimer value) {
