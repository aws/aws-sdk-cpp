...
class ListInstanceAttributesResult {
 public:
  AWS_CONNECT_API ListInstanceAttributesResult() = default;
  ...
  template <typename AttributesT = Aws::Vector<Attribute>>
  ListInstanceAttributesResult& WithAttributes(AttributesT&& value) {
    SetAttributes(std::forward<AttributesT>(value));
    return *this;
  }
  template <typename AttributesT = Attribute>
  ListInstanceAttributesResult& AddAttributes(AttributesT&& value) {
    m_attributesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListInstanceAttributesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInstanceAttributesResult& WithRequestId(RequestIdT&& value) {
