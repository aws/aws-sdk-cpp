...
class SearchableContactAttributesCriteria {
 public:
  ...
  template <typename KeyT = Aws::String>
  SearchableContactAttributesCriteria& WithKey(KeyT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  SearchableContactAttributesCriteria& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  SearchableContactAttributesCriteria& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
