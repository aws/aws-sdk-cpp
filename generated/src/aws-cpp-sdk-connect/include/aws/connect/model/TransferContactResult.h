...
class TransferContactResult {
 public:
  ...
  template <typename ContactIdT = Aws::String>
  TransferContactResult& WithContactId(ContactIdT&& value) {
  ...
  template <typename ContactArnT = Aws::String>
  TransferContactResult& WithContactArn(ContactArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  TransferContactResult& WithRequestId(RequestIdT&& value) {
