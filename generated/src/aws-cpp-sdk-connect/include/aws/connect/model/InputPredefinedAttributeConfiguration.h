...
class InputPredefinedAttributeConfiguration {
 public:
   ...
   * The contact will store only valid and predefined values for the predefined
   * attribute key.</p>
   */
  ...
  inline InputPredefinedAttributeConfiguration& WithEnableValueValidationOnAssociation(bool value) {
