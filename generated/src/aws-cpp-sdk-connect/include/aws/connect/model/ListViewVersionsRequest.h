...
class ListViewVersionsRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListViewVersionsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ViewIdT = Aws::String>
  ListViewVersionsRequest& WithViewId(ViewIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListViewVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListViewVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
