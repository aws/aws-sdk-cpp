...
namespace Model
{
  ...
  /**
   */
  class ListPromptsRequest : public ConnectRequest
  {
  public:
    AWS_CONNECT_API ListPromptsRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    ListPromptsRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
