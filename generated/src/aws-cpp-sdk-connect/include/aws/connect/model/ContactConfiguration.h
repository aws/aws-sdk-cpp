...
class ContactConfiguration {
 public:
  ...
  inline ContactConfiguration& WithParticipantRole(ParticipantRole value) {
  ...
  inline void SetIncludeRawMessage(bool value) {
    m_includeRawMessageHasBeenSet = true;
    m_includeRawMessage = value;
  }
  inline ContactConfiguration& WithIncludeRawMessage(bool value) {
    SetIncludeRawMessage(value);
    return *this;
  }
  ///@}
 private:
