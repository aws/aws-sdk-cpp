...
class CustomerVoiceActivity {
 public:
  ...
  void SetGreetingStartTimestamp(GreetingStartTimestampT&& value) {
    ...
    m_greetingStartTimestamp = std::forward<GreetingStartTimestampT>(value);
  }
  template <typename GreetingStartTimestampT = Aws::Utils::DateTime>
  CustomerVoiceActivity& WithGreetingStartTimestamp(GreetingStartTimestampT&& value) {
    SetGreetingStartTimestamp(std::forward<GreetingStartTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGreetingEndTimestamp(GreetingEndTimestampT&& value) {
    ...
    m_greetingEndTimestamp = std::forward<GreetingEndTimestampT>(value);
  }
  template <typename GreetingEndTimestampT = Aws::Utils::DateTime>
  CustomerVoiceActivity& WithGreetingEndTimestamp(GreetingEndTimestampT&& value) {
    SetGreetingEndTimestamp(std::forward<GreetingEndTimestampT>(value));
    return *this;
  }
  ///@}
 private:
