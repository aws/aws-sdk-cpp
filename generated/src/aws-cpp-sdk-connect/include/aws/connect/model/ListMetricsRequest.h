...
/**
 */
class ListMetricsRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API ListMetricsRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  ListMetricsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  ///@{
  /**
   * <p>The type of metrics to list. Valid values: <code>AWS_MANAGED</code> |
  ...
  inline ListMetricsRequest& WithType(MetricType value) {
    SetType(value);
    return *this;
  }
  ///@}
