...
class ControlPlaneUserAttributeFilter {
 public:
  ...
  template <typename OrConditionsT = Aws::Vector<AttributeAndCondition>>
  ControlPlaneUserAttributeFilter& WithOrConditions(OrConditionsT&& value) {
    SetOrConditions(std::forward<OrConditionsT>(value));
    return *this;
  }
  template <typename OrConditionsT = AttributeAndCondition>
  ControlPlaneUserAttributeFilter& AddOrConditions(OrConditionsT&& value) {
    m_orConditionsHasBeenSet = true;
  ...
  template <typename AndConditionT = AttributeAndCondition>
  ControlPlaneUserAttributeFilter& WithAndCondition(AndConditionT&& value) {
  ...
  template <typename TagConditionT = TagCondition>
  ControlPlaneUserAttributeFilter& WithTagCondition(TagConditionT&& value) {
  ...
  template <typename HierarchyGroupConditionT = HierarchyGroupCondition>
  ControlPlaneUserAttributeFilter& WithHierarchyGroupCondition(HierarchyGroupConditionT&& value) {
