...
class HoursOfOperationSearchCriteria {
 public:
  ...
  template <typename OrConditionsT = Aws::Vector<HoursOfOperationSearchCriteria>>
  HoursOfOperationSearchCriteria& WithOrConditions(OrConditionsT&& value) {
    SetOrConditions(std::forward<OrConditionsT>(value));
    return *this;
  }
  template <typename OrConditionsT = HoursOfOperationSearchCriteria>
  HoursOfOperationSearchCriteria& AddOrConditions(OrConditionsT&& value) {
    m_orConditionsHasBeenSet = true;
  ...
  template <typename AndConditionsT = Aws::Vector<HoursOfOperationSearchCriteria>>
  HoursOfOperationSearchCriteria& WithAndConditions(AndConditionsT&& value) {
    SetAndConditions(std::forward<AndConditionsT>(value));
    return *this;
  }
  template <typename AndConditionsT = HoursOfOperationSearchCriteria>
  HoursOfOperationSearchCriteria& AddAndConditions(AndConditionsT&& value) {
    m_andConditionsHasBeenSet = true;
  ...
  template <typename StringConditionT = StringCondition>
  HoursOfOperationSearchCriteria& WithStringCondition(StringConditionT&& value) {
