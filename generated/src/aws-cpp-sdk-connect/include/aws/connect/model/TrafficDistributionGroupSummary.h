...
class TrafficDistributionGroupSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  TrafficDistributionGroupSummary& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  TrafficDistributionGroupSummary& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  TrafficDistributionGroupSummary& WithName(NameT&& value) {
  ...
  template <typename InstanceArnT = Aws::String>
  TrafficDistributionGroupSummary& WithInstanceArn(InstanceArnT&& value) {
  ...
  inline void SetStatus(TrafficDistributionGroupStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline TrafficDistributionGroupSummary& WithStatus(TrafficDistributionGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline TrafficDistributionGroupSummary& WithIsDefault(bool value) {
    SetIsDefault(value);
    return *this;
  }
  ///@}
