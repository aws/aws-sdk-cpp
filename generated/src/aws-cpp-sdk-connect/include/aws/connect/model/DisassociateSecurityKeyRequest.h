...
class DisassociateSecurityKeyRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DisassociateSecurityKeyRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename AssociationIdT = Aws::String>
  DisassociateSecurityKeyRequest& WithAssociationId(AssociationIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DisassociateSecurityKeyRequest& WithClientToken(ClientTokenT&& value) {
