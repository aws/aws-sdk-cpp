...
class GetTaskTemplateRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  GetTaskTemplateRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename TaskTemplateIdT = Aws::String>
  GetTaskTemplateRequest& WithTaskTemplateId(TaskTemplateIdT&& value) {
  ...
  void SetSnapshotVersion(SnapshotVersionT&& value) {
    m_snapshotVersionHasBeenSet = true;
    m_snapshotVersion = std::forward<SnapshotVersionT>(value);
  }
  template <typename SnapshotVersionT = Aws::String>
  GetTaskTemplateRequest& WithSnapshotVersion(SnapshotVersionT&& value) {
    SetSnapshotVersion(std::forward<SnapshotVersionT>(value));
    return *this;
  }
  ///@}
 private:
