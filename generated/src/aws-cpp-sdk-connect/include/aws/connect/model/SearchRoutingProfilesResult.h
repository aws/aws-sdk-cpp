...
class SearchRoutingProfilesResult {
 public:
  ...
  template <typename RoutingProfilesT = Aws::Vector<RoutingProfile>>
  SearchRoutingProfilesResult& WithRoutingProfiles(RoutingProfilesT&& value) {
    SetRoutingProfiles(std::forward<RoutingProfilesT>(value));
    return *this;
  }
  template <typename RoutingProfilesT = RoutingProfile>
  SearchRoutingProfilesResult& AddRoutingProfiles(RoutingProfilesT&& value) {
    m_routingProfilesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchRoutingProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchRoutingProfilesResult& WithApproximateTotalCount(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchRoutingProfilesResult& WithRequestId(RequestIdT&& value) {
