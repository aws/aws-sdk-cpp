...
class RealTimeContactAnalysisSegmentTranscript {
 public:
  ...
  template <typename IdT = Aws::String>
  RealTimeContactAnalysisSegmentTranscript& WithId(IdT&& value) {
  ...
  inline RealTimeContactAnalysisSegmentTranscript& WithParticipantRole(ParticipantRole value) {
  ...
  template <typename TimeT = RealTimeContactAnalysisTimeData>
  RealTimeContactAnalysisSegmentTranscript& WithTime(TimeT&& value) {
  ...
  void SetRedaction(RedactionT&& value) {
    m_redactionHasBeenSet = true;
    m_redaction = std::forward<RedactionT>(value);
  }
  template <typename RedactionT = RealTimeContactAnalysisTranscriptItemRedaction>
  RealTimeContactAnalysisSegmentTranscript& WithRedaction(RedactionT&& value) {
    SetRedaction(std::forward<RedactionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSentiment(RealTimeContactAnalysisSentimentLabel value) {
    m_sentimentHasBeenSet = true;
    m_sentiment = value;
  }
  inline RealTimeContactAnalysisSegmentTranscript& WithSentiment(RealTimeContactAnalysisSentimentLabel value) {
    SetSentiment(value);
    return *this;
  }
  ///@}
