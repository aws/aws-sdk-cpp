...
/**
 * <p>Contains information about a workspace, which defines the user experience by
 * mapping views to pages.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/Workspace">AWS
 * API Reference</a></p>
 */
class Workspace {
 public:
  ...
  ///@{
  /**
   * <p>Controls who can access the workspace. Valid values are: <code>ALL</code>
   * (all users), <code>ASSIGNED</code> (only assigned users and routing profiles),
   * and <code>NONE</code> (not visible).</p>
   */
  ...
  inline Workspace& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
