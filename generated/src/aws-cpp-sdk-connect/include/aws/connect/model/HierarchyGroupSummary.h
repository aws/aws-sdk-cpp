...
class HierarchyGroupSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  HierarchyGroupSummary& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  HierarchyGroupSummary& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  HierarchyGroupSummary& WithName(NameT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  HierarchyGroupSummary& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename LastModifiedRegionT = Aws::String>
  HierarchyGroupSummary& WithLastModifiedRegion(LastModifiedRegionT&& value) {
