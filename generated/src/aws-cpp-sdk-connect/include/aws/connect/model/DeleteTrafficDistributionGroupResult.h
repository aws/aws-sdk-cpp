...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DeleteTrafficDistributionGroupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteTrafficDistributionGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
