...
namespace Model
{
  ...
  public:
    ...
    inline DeleteTrafficDistributionGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteTrafficDistributionGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteTrafficDistributionGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
