...
class DeleteEvaluationFormRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DeleteEvaluationFormRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename EvaluationFormIdT = Aws::String>
  DeleteEvaluationFormRequest& WithEvaluationFormId(EvaluationFormIdT&& value) {
  ...
  inline DeleteEvaluationFormRequest& WithEvaluationFormVersion(int value) {
