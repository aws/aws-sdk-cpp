...
class UpdateUserHierarchyRequest : public ConnectRequest {
 public:
  ...
  template <typename HierarchyGroupIdT = Aws::String>
  UpdateUserHierarchyRequest& WithHierarchyGroupId(HierarchyGroupIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  UpdateUserHierarchyRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateUserHierarchyRequest& WithInstanceId(InstanceIdT&& value) {
