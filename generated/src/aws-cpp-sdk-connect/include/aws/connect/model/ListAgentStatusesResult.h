...
class ListAgentStatusesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentStatusesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetAgentStatusSummaryList(AgentStatusSummaryListT&& value) {
    m_agentStatusSummaryListHasBeenSet = true;
    m_agentStatusSummaryList = std::forward<AgentStatusSummaryListT>(value);
  }
  template <typename AgentStatusSummaryListT = Aws::Vector<AgentStatusSummary>>
  ListAgentStatusesResult& WithAgentStatusSummaryList(AgentStatusSummaryListT&& value) {
    SetAgentStatusSummaryList(std::forward<AgentStatusSummaryListT>(value));
    return *this;
  }
  template <typename AgentStatusSummaryListT = AgentStatusSummary>
  ListAgentStatusesResult& AddAgentStatusSummaryList(AgentStatusSummaryListT&& value) {
    m_agentStatusSummaryListHasBeenSet = true;
    m_agentStatusSummaryList.emplace_back(std::forward<AgentStatusSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAgentStatusesResult& WithRequestId(RequestIdT&& value) {
