...
class ListRoutingProfileQueuesRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListRoutingProfileQueuesRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename RoutingProfileIdT = Aws::String>
  ListRoutingProfileQueuesRequest& WithRoutingProfileId(RoutingProfileIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRoutingProfileQueuesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRoutingProfileQueuesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
