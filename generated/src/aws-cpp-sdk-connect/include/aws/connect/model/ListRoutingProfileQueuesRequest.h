...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API ListRoutingProfileQueuesRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    ListRoutingProfileQueuesRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RoutingProfileIdT = Aws::String>
    ListRoutingProfileQueuesRequest& WithRoutingProfileId(RoutingProfileIdT&& value) { SetRoutingProfileId(std::forward<RoutingProfileIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListRoutingProfileQueuesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
