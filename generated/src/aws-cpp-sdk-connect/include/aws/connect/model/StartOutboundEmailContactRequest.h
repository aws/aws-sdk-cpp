...
class StartOutboundEmailContactRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  StartOutboundEmailContactRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactIdT = Aws::String>
  StartOutboundEmailContactRequest& WithContactId(ContactIdT&& value) {
  ...
  template <typename FromEmailAddressT = EmailAddressInfo>
  StartOutboundEmailContactRequest& WithFromEmailAddress(FromEmailAddressT&& value) {
  ...
  template <typename AdditionalRecipientsT = OutboundAdditionalRecipients>
  StartOutboundEmailContactRequest& WithAdditionalRecipients(AdditionalRecipientsT&& value) {
  ...
  template <typename EmailMessageT = OutboundEmailContent>
  StartOutboundEmailContactRequest& WithEmailMessage(EmailMessageT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StartOutboundEmailContactRequest& WithClientToken(ClientTokenT&& value) {
