...
class OutboundEmailConfig {
 public:
  ...
  void SetOutboundEmailAddressId(OutboundEmailAddressIdT&& value) {
    m_outboundEmailAddressIdHasBeenSet = true;
    m_outboundEmailAddressId = std::forward<OutboundEmailAddressIdT>(value);
  }
  template <typename OutboundEmailAddressIdT = Aws::String>
  OutboundEmailConfig& WithOutboundEmailAddressId(OutboundEmailAddressIdT&& value) {
    SetOutboundEmailAddressId(std::forward<OutboundEmailAddressIdT>(value));
    return *this;
  }
  ///@}
 private:
