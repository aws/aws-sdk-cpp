...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DescribeRoutingProfileRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeRoutingProfileRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RoutingProfileIdT = Aws::String>
    DescribeRoutingProfileRequest& WithRoutingProfileId(RoutingProfileIdT&& value) { SetRoutingProfileId(std::forward<RoutingProfileIdT>(value)); return *this;}
    ///@}
  private:
