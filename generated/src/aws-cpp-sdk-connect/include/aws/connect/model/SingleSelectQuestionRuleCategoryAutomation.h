...
class SingleSelectQuestionRuleCategoryAutomation {
 public:
  ...
  template <typename CategoryT = Aws::String>
  SingleSelectQuestionRuleCategoryAutomation& WithCategory(CategoryT&& value) {
  ...
  inline void SetCondition(SingleSelectQuestionRuleCategoryAutomationCondition value) {
    m_conditionHasBeenSet = true;
    m_condition = value;
  }
  inline SingleSelectQuestionRuleCategoryAutomation& WithCondition(SingleSelectQuestionRuleCategoryAutomationCondition value) {
    SetCondition(value);
    return *this;
  }
  ///@}
  ...
  void SetOptionRefId(OptionRefIdT&& value) {
    m_optionRefIdHasBeenSet = true;
    m_optionRefId = std::forward<OptionRefIdT>(value);
  }
  template <typename OptionRefIdT = Aws::String>
  SingleSelectQuestionRuleCategoryAutomation& WithOptionRefId(OptionRefIdT&& value) {
    SetOptionRefId(std::forward<OptionRefIdT>(value));
    return *this;
  }
  ///@}
 private:
