...
class RoutingCriteria {
 public:
  ...
  ///@{
  /**
   * <p>List of routing steps. When Connect Customer does not find an available agent
  ...
  void SetActivationTimestamp(ActivationTimestampT&& value) {
    ...
    m_activationTimestamp = std::forward<ActivationTimestampT>(value);
  }
  template <typename ActivationTimestampT = Aws::Utils::DateTime>
  RoutingCriteria& WithActivationTimestamp(ActivationTimestampT&& value) {
    SetActivationTimestamp(std::forward<ActivationTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline RoutingCriteria& WithIndex(int value) {
    SetIndex(value);
    return *this;
  }
  ///@}
