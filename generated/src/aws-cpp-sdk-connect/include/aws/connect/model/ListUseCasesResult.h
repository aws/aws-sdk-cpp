...
class ListUseCasesResult {
 public:
  ...
  void SetUseCaseSummaryList(UseCaseSummaryListT&& value) {
    m_useCaseSummaryListHasBeenSet = true;
    m_useCaseSummaryList = std::forward<UseCaseSummaryListT>(value);
  }
  template <typename UseCaseSummaryListT = Aws::Vector<UseCase>>
  ListUseCasesResult& WithUseCaseSummaryList(UseCaseSummaryListT&& value) {
    SetUseCaseSummaryList(std::forward<UseCaseSummaryListT>(value));
    return *this;
  }
  template <typename UseCaseSummaryListT = UseCase>
  ListUseCasesResult& AddUseCaseSummaryList(UseCaseSummaryListT&& value) {
    m_useCaseSummaryListHasBeenSet = true;
    m_useCaseSummaryList.emplace_back(std::forward<UseCaseSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUseCasesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListUseCasesResult& WithRequestId(RequestIdT&& value) {
