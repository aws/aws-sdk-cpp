...
class SendChatIntegrationEventResult {
 public:
  ...
  inline void SetNewChatCreated(bool value) {
    m_newChatCreatedHasBeenSet = true;
    m_newChatCreated = value;
  }
  inline SendChatIntegrationEventResult& WithNewChatCreated(bool value) {
    SetNewChatCreated(value);
    return *this;
  }
  ///@}
