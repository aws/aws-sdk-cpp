...
class RuleTriggerEventSource {
 public:
  ...
  inline RuleTriggerEventSource& WithEventSourceName(EventSourceName value) {
  ...
  template <typename IntegrationAssociationIdT = Aws::String>
  RuleTriggerEventSource& WithIntegrationAssociationId(IntegrationAssociationIdT&& value) {
