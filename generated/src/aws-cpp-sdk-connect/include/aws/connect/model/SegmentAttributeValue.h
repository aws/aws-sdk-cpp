...
class SegmentAttributeValue {
 public:
  ...
  inline void SetValueInteger(int value) {
    m_valueIntegerHasBeenSet = true;
    m_valueInteger = value;
  }
  inline SegmentAttributeValue& WithValueInteger(int value) {
  ...
  void SetValueArn(ValueArnT&& value) {
    ...
    m_valueArn = std::forward<ValueArnT>(value);
  }
  template <typename ValueArnT = Aws::String>
  SegmentAttributeValue& WithValueArn(ValueArnT&& value) {
    SetValueArn(std::forward<ValueArnT>(value));
    return *this;
  }
  ///@}
 private:
