...
class EffectiveHoursOfOperations {
 public:
  ...
  template <typename DateT = Aws::String>
  EffectiveHoursOfOperations& WithDate(DateT&& value) {
  ...
  void SetOperationalHours(OperationalHoursT&& value) {
    m_operationalHoursHasBeenSet = true;
    m_operationalHours = std::forward<OperationalHoursT>(value);
  }
  template <typename OperationalHoursT = Aws::Vector<OperationalHour>>
  EffectiveHoursOfOperations& WithOperationalHours(OperationalHoursT&& value) {
    SetOperationalHours(std::forward<OperationalHoursT>(value));
    return *this;
  }
  template <typename OperationalHoursT = OperationalHour>
  EffectiveHoursOfOperations& AddOperationalHours(OperationalHoursT&& value) {
    m_operationalHoursHasBeenSet = true;
    m_operationalHours.emplace_back(std::forward<OperationalHoursT>(value));
    return *this;
  }
  ///@}
 private:
