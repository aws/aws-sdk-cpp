...
class ListIntegrationAssociationsRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListIntegrationAssociationsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline ListIntegrationAssociationsRequest& WithIntegrationType(IntegrationType value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListIntegrationAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListIntegrationAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename IntegrationArnT = Aws::String>
  ListIntegrationAssociationsRequest& WithIntegrationArn(IntegrationArnT&& value) {
