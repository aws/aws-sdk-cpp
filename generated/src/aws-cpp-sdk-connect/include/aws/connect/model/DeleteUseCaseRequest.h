...
class DeleteUseCaseRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DeleteUseCaseRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename IntegrationAssociationIdT = Aws::String>
  DeleteUseCaseRequest& WithIntegrationAssociationId(IntegrationAssociationIdT&& value) {
  ...
  template <typename UseCaseIdT = Aws::String>
  DeleteUseCaseRequest& WithUseCaseId(UseCaseIdT&& value) {
