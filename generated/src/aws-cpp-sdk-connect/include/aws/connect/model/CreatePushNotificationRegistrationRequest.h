...
class CreatePushNotificationRegistrationRequest : public ConnectRequest {
 public:
  ...
  void SetPinpointAppArn(PinpointAppArnT&& value) {
    m_pinpointAppArnHasBeenSet = true;
    m_pinpointAppArn = std::forward<PinpointAppArnT>(value);
  }
  template <typename PinpointAppArnT = Aws::String>
  CreatePushNotificationRegistrationRequest& WithPinpointAppArn(PinpointAppArnT&& value) {
    SetPinpointAppArn(std::forward<PinpointAppArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreatePushNotificationRegistrationRequest& WithDeviceType(DeviceType value) {
    SetDeviceType(value);
    return *this;
  }
  ///@}
  ...
  void SetContactConfiguration(ContactConfigurationT&& value) {
    m_contactConfigurationHasBeenSet = true;
    m_contactConfiguration = std::forward<ContactConfigurationT>(value);
  }
  template <typename ContactConfigurationT = ContactConfiguration>
  CreatePushNotificationRegistrationRequest& WithContactConfiguration(ContactConfigurationT&& value) {
    SetContactConfiguration(std::forward<ContactConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
