...
struct SearchContactFlowModulesPaginationTraits {
  using RequestType = Model::SearchContactFlowModulesRequest;
  using ResultType = Model::SearchContactFlowModulesResult;
  using OutcomeType = Model::SearchContactFlowModulesOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->SearchContactFlowModules(request); }
