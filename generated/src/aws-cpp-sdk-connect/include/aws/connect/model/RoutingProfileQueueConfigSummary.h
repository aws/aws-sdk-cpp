...
class RoutingProfileQueueConfigSummary {
 public:
  ...
  inline RoutingProfileQueueConfigSummary& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline RoutingProfileQueueConfigSummary& WithDelay(int value) {
    SetDelay(value);
    return *this;
  }
  ///@}
  ...
  inline RoutingProfileQueueConfigSummary& WithChannel(Channel value) {
    SetChannel(value);
    return *this;
  }
  ///@}
