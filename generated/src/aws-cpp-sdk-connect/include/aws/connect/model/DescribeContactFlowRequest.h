...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeContactFlowRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ContactFlowIdT = Aws::String>
    DescribeContactFlowRequest& WithContactFlowId(ContactFlowIdT&& value) { SetContactFlowId(std::forward<ContactFlowIdT>(value)); return *this;}
    ///@}
  private:
