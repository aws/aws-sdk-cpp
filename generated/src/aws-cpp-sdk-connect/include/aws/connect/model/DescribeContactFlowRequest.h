...
class DescribeContactFlowRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API DescribeContactFlowRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  DescribeContactFlowRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactFlowIdT = Aws::String>
  DescribeContactFlowRequest& WithContactFlowId(ContactFlowIdT&& value) {
