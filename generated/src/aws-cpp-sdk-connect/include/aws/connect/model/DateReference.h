...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DateReference() = default;
    ...
    template<typename NameT = Aws::String>
    DateReference& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    DateReference& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
