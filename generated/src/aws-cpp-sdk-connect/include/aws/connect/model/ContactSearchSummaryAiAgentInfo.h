...
/**
 * <p>Information of the AI agent involved in the contact.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/ContactSearchSummaryAiAgentInfo">AWS
 * API Reference</a></p>
 */
class ContactSearchSummaryAiAgentInfo {
 public:
  AWS_CONNECT_API ContactSearchSummaryAiAgentInfo() = default;
  AWS_CONNECT_API ContactSearchSummaryAiAgentInfo(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECT_API ContactSearchSummaryAiAgentInfo& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AiAgentVersionIdT = Aws::String>
  ContactSearchSummaryAiAgentInfo& WithAiAgentVersionId(AiAgentVersionIdT&& value) {
  ...
  inline ContactSearchSummaryAiAgentInfo& WithAiAgentEscalated(bool value) {
   ...
   * Valid values are <code>AgentAssistance</code> and <code>SelfService</code>.</p>
   */
  ...
  inline ContactSearchSummaryAiAgentInfo& WithAiUseCase(AiUseCase value) {
    SetAiUseCase(value);
    return *this;
  }
  ///@}
