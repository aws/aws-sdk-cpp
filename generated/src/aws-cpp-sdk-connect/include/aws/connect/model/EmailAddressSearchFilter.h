...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API EmailAddressSearchFilter() = default;
    ...
    template<typename TagFilterT = ControlPlaneTagFilter>
    EmailAddressSearchFilter& WithTagFilter(TagFilterT&& value) { SetTagFilter(std::forward<TagFilterT>(value)); return *this;}
    ///@}
  private:
