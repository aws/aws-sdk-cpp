...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/EmailAddressSearchFilter">AWS
   * API Reference</a></p>
   */
  class EmailAddressSearchFilter
  {
  public:
    AWS_CONNECT_API EmailAddressSearchFilter();
    AWS_CONNECT_API EmailAddressSearchFilter(Aws::Utils::Json::JsonView jsonValue);
    AWS_CONNECT_API EmailAddressSearchFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline EmailAddressSearchFilter& WithTagFilter(const ControlPlaneTagFilter& value) { SetTagFilter(value); return *this;}
    inline EmailAddressSearchFilter& WithTagFilter(ControlPlaneTagFilter&& value) { SetTagFilter(std::move(value)); return *this;}
    ///@}
  private:
