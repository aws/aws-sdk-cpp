...
class SearchHoursOfOperationsResult {
 public:
  ...
  void SetHoursOfOperations(HoursOfOperationsT&& value) {
    m_hoursOfOperationsHasBeenSet = true;
    m_hoursOfOperations = std::forward<HoursOfOperationsT>(value);
  }
  template <typename HoursOfOperationsT = Aws::Vector<HoursOfOperation>>
  SearchHoursOfOperationsResult& WithHoursOfOperations(HoursOfOperationsT&& value) {
    SetHoursOfOperations(std::forward<HoursOfOperationsT>(value));
    return *this;
  }
  template <typename HoursOfOperationsT = HoursOfOperation>
  SearchHoursOfOperationsResult& AddHoursOfOperations(HoursOfOperationsT&& value) {
    m_hoursOfOperationsHasBeenSet = true;
    m_hoursOfOperations.emplace_back(std::forward<HoursOfOperationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchHoursOfOperationsResult& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchHoursOfOperationsResult& WithApproximateTotalCount(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchHoursOfOperationsResult& WithRequestId(RequestIdT&& value) {
