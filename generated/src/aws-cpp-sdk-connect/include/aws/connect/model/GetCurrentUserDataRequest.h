...
class GetCurrentUserDataRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API GetCurrentUserDataRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  GetCurrentUserDataRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename FiltersT = UserDataFilters>
  void SetFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
    m_filters = std::forward<FiltersT>(value);
  }
  template <typename FiltersT = UserDataFilters>
  GetCurrentUserDataRequest& WithFilters(FiltersT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetCurrentUserDataRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetCurrentUserDataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
