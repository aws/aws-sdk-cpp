...
class ListEvaluationFormsResult {
 public:
  ...
  void SetEvaluationFormSummaryList(EvaluationFormSummaryListT&& value) {
    m_evaluationFormSummaryListHasBeenSet = true;
    m_evaluationFormSummaryList = std::forward<EvaluationFormSummaryListT>(value);
  }
  template <typename EvaluationFormSummaryListT = Aws::Vector<EvaluationFormSummary>>
  ListEvaluationFormsResult& WithEvaluationFormSummaryList(EvaluationFormSummaryListT&& value) {
    SetEvaluationFormSummaryList(std::forward<EvaluationFormSummaryListT>(value));
    return *this;
  }
  template <typename EvaluationFormSummaryListT = EvaluationFormSummary>
  ListEvaluationFormsResult& AddEvaluationFormSummaryList(EvaluationFormSummaryListT&& value) {
    m_evaluationFormSummaryListHasBeenSet = true;
    m_evaluationFormSummaryList.emplace_back(std::forward<EvaluationFormSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEvaluationFormsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEvaluationFormsResult& WithRequestId(RequestIdT&& value) {
