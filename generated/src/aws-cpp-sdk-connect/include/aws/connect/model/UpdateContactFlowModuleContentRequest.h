...
class UpdateContactFlowModuleContentRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateContactFlowModuleContentRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactFlowModuleIdT = Aws::String>
  UpdateContactFlowModuleContentRequest& WithContactFlowModuleId(ContactFlowModuleIdT&& value) {
  ...
  template <typename ContentT = Aws::String>
  UpdateContactFlowModuleContentRequest& WithContent(ContentT&& value) {
