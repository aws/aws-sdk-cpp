...
class TrafficDistributionGroup {
 public:
  ...
  template <typename IdT = Aws::String>
  TrafficDistributionGroup& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  TrafficDistributionGroup& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  TrafficDistributionGroup& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  TrafficDistributionGroup& WithDescription(DescriptionT&& value) {
  ...
  template <typename InstanceArnT = Aws::String>
  TrafficDistributionGroup& WithInstanceArn(InstanceArnT&& value) {
  ...
  inline TrafficDistributionGroup& WithStatus(TrafficDistributionGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  TrafficDistributionGroup& WithTags(TagsT&& value) {
  ...
  inline TrafficDistributionGroup& WithIsDefault(bool value) {
    SetIsDefault(value);
    return *this;
  }
  ///@}
