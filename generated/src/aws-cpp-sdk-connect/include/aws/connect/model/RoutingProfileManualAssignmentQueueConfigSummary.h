...
class RoutingProfileManualAssignmentQueueConfigSummary {
 public:
  ...
  template <typename QueueIdT = Aws::String>
  RoutingProfileManualAssignmentQueueConfigSummary& WithQueueId(QueueIdT&& value) {
  ...
  template <typename QueueArnT = Aws::String>
  RoutingProfileManualAssignmentQueueConfigSummary& WithQueueArn(QueueArnT&& value) {
  ...
  template <typename QueueNameT = Aws::String>
  RoutingProfileManualAssignmentQueueConfigSummary& WithQueueName(QueueNameT&& value) {
  ...
  inline RoutingProfileManualAssignmentQueueConfigSummary& WithChannel(Channel value) {
    SetChannel(value);
    return *this;
  }
  ///@}
