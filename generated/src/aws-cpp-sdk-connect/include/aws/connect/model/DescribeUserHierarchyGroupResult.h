...
class DescribeUserHierarchyGroupResult {
 public:
  ...
  void SetHierarchyGroup(HierarchyGroupT&& value) {
    m_hierarchyGroupHasBeenSet = true;
    m_hierarchyGroup = std::forward<HierarchyGroupT>(value);
  }
  template <typename HierarchyGroupT = HierarchyGroup>
  DescribeUserHierarchyGroupResult& WithHierarchyGroup(HierarchyGroupT&& value) {
    SetHierarchyGroup(std::forward<HierarchyGroupT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeUserHierarchyGroupResult& WithRequestId(RequestIdT&& value) {
