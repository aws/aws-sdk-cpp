...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DescribeHoursOfOperationOverrideRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DescribeHoursOfOperationOverrideRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HoursOfOperationIdT = Aws::String>
    DescribeHoursOfOperationOverrideRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) { SetHoursOfOperationId(std::forward<HoursOfOperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HoursOfOperationOverrideIdT = Aws::String>
    DescribeHoursOfOperationOverrideRequest& WithHoursOfOperationOverrideId(HoursOfOperationOverrideIdT&& value) { SetHoursOfOperationOverrideId(std::forward<HoursOfOperationOverrideIdT>(value)); return *this;}
    ///@}
  private:
