...
class DescribeHoursOfOperationOverrideRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DescribeHoursOfOperationOverrideRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename HoursOfOperationIdT = Aws::String>
  DescribeHoursOfOperationOverrideRequest& WithHoursOfOperationId(HoursOfOperationIdT&& value) {
  ...
  void SetHoursOfOperationOverrideId(HoursOfOperationOverrideIdT&& value) {
    ...
    m_hoursOfOperationOverrideId = std::forward<HoursOfOperationOverrideIdT>(value);
  }
  template <typename HoursOfOperationOverrideIdT = Aws::String>
  DescribeHoursOfOperationOverrideRequest& WithHoursOfOperationOverrideId(HoursOfOperationOverrideIdT&& value) {
    SetHoursOfOperationOverrideId(std::forward<HoursOfOperationOverrideIdT>(value));
    return *this;
  }
  ///@}
 private:
