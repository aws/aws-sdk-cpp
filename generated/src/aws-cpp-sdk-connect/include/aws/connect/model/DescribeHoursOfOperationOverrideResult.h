...
class DescribeHoursOfOperationOverrideResult {
 public:
  ...
  void SetHoursOfOperationOverride(HoursOfOperationOverrideT&& value) {
    m_hoursOfOperationOverrideHasBeenSet = true;
    m_hoursOfOperationOverride = std::forward<HoursOfOperationOverrideT>(value);
  }
  template <typename HoursOfOperationOverrideT = HoursOfOperationOverride>
  DescribeHoursOfOperationOverrideResult& WithHoursOfOperationOverride(HoursOfOperationOverrideT&& value) {
    SetHoursOfOperationOverride(std::forward<HoursOfOperationOverrideT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeHoursOfOperationOverrideResult& WithRequestId(RequestIdT&& value) {
