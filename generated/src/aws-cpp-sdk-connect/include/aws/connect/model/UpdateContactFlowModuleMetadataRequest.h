...
class UpdateContactFlowModuleMetadataRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateContactFlowModuleMetadataRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ContactFlowModuleIdT = Aws::String>
  UpdateContactFlowModuleMetadataRequest& WithContactFlowModuleId(ContactFlowModuleIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateContactFlowModuleMetadataRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateContactFlowModuleMetadataRequest& WithDescription(DescriptionT&& value) {
  ...
  inline UpdateContactFlowModuleMetadataRequest& WithState(ContactFlowModuleState value) {
    SetState(value);
    return *this;
  }
  ///@}
