...
class ListCondition {
 public:
  ...
  inline void SetTargetListType(TargetListType value) {
    m_targetListTypeHasBeenSet = true;
    m_targetListType = value;
  }
  inline ListCondition& WithTargetListType(TargetListType value) {
    SetTargetListType(value);
    return *this;
  }
  ///@}
