...
namespace Model
{
  ...
  public:
    ...
    inline UpdateContactFlowModuleContentResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateContactFlowModuleContentResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateContactFlowModuleContentResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
