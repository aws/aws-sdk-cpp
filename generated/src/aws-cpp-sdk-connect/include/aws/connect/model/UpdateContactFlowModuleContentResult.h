...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API UpdateContactFlowModuleContentResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateContactFlowModuleContentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
