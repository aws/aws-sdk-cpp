...
class ListQueueQuickConnectsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListQueueQuickConnectsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetQuickConnectSummaryList(QuickConnectSummaryListT&& value) {
    m_quickConnectSummaryListHasBeenSet = true;
    m_quickConnectSummaryList = std::forward<QuickConnectSummaryListT>(value);
  }
  template <typename QuickConnectSummaryListT = Aws::Vector<QuickConnectSummary>>
  ListQueueQuickConnectsResult& WithQuickConnectSummaryList(QuickConnectSummaryListT&& value) {
    SetQuickConnectSummaryList(std::forward<QuickConnectSummaryListT>(value));
    return *this;
  }
  template <typename QuickConnectSummaryListT = QuickConnectSummary>
  ListQueueQuickConnectsResult& AddQuickConnectSummaryList(QuickConnectSummaryListT&& value) {
    m_quickConnectSummaryListHasBeenSet = true;
    m_quickConnectSummaryList.emplace_back(std::forward<QuickConnectSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  ListQueueQuickConnectsResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename LastModifiedRegionT = Aws::String>
  ListQueueQuickConnectsResult& WithLastModifiedRegion(LastModifiedRegionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListQueueQuickConnectsResult& WithRequestId(RequestIdT&& value) {
