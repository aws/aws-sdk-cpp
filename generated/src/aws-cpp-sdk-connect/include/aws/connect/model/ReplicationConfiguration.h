...
class ReplicationConfiguration {
 public:
  ...
  void SetReplicationStatusSummaryList(ReplicationStatusSummaryListT&& value) {
    m_replicationStatusSummaryListHasBeenSet = true;
    m_replicationStatusSummaryList = std::forward<ReplicationStatusSummaryListT>(value);
  }
  template <typename ReplicationStatusSummaryListT = Aws::Vector<ReplicationStatusSummary>>
  ReplicationConfiguration& WithReplicationStatusSummaryList(ReplicationStatusSummaryListT&& value) {
    SetReplicationStatusSummaryList(std::forward<ReplicationStatusSummaryListT>(value));
    return *this;
  }
  template <typename ReplicationStatusSummaryListT = ReplicationStatusSummary>
  ReplicationConfiguration& AddReplicationStatusSummaryList(ReplicationStatusSummaryListT&& value) {
    m_replicationStatusSummaryListHasBeenSet = true;
    m_replicationStatusSummaryList.emplace_back(std::forward<ReplicationStatusSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SourceRegionT = Aws::String>
  ReplicationConfiguration& WithSourceRegion(SourceRegionT&& value) {
  ...
  void SetGlobalSignInEndpoint(GlobalSignInEndpointT&& value) {
    m_globalSignInEndpointHasBeenSet = true;
    m_globalSignInEndpoint = std::forward<GlobalSignInEndpointT>(value);
  }
  template <typename GlobalSignInEndpointT = Aws::String>
  ReplicationConfiguration& WithGlobalSignInEndpoint(GlobalSignInEndpointT&& value) {
    SetGlobalSignInEndpoint(std::forward<GlobalSignInEndpointT>(value));
    return *this;
  }
  ///@}
 private:
