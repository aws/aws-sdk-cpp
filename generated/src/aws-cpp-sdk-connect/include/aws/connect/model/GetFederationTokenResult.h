...
class GetFederationTokenResult {
 public:
  ...
  void SetSignInUrl(SignInUrlT&& value) {
    m_signInUrlHasBeenSet = true;
    m_signInUrl = std::forward<SignInUrlT>(value);
  }
  template <typename SignInUrlT = Aws::String>
  GetFederationTokenResult& WithSignInUrl(SignInUrlT&& value) {
    SetSignInUrl(std::forward<SignInUrlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetFederationTokenResult& WithRequestId(RequestIdT&& value) {
