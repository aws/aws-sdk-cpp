...
class UpdateQueueOutboundCallerConfigRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateQueueOutboundCallerConfigRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  UpdateQueueOutboundCallerConfigRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename OutboundCallerConfigT = OutboundCallerConfig>
  UpdateQueueOutboundCallerConfigRequest& WithOutboundCallerConfig(OutboundCallerConfigT&& value) {
