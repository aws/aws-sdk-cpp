...
class UpdateInstanceStorageConfigRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateInstanceStorageConfigRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename AssociationIdT = Aws::String>
  UpdateInstanceStorageConfigRequest& WithAssociationId(AssociationIdT&& value) {
  ...
  inline UpdateInstanceStorageConfigRequest& WithResourceType(InstanceStorageResourceType value) {
  ...
  template <typename StorageConfigT = InstanceStorageConfig>
  UpdateInstanceStorageConfigRequest& WithStorageConfig(StorageConfigT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateInstanceStorageConfigRequest& WithClientToken(ClientTokenT&& value) {
