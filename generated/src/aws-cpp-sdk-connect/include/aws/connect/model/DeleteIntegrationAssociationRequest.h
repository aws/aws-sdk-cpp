...
class DeleteIntegrationAssociationRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DeleteIntegrationAssociationRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename IntegrationAssociationIdT = Aws::String>
  DeleteIntegrationAssociationRequest& WithIntegrationAssociationId(IntegrationAssociationIdT&& value) {
