...
namespace Model
{
  ...
  public:
     ...
     * the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
     */
    inline ListSecurityProfilesRequest& WithInstanceId(const Aws::String& value) { SetInstanceId(value); return *this;}
     ...
     * the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
     */
    inline ListSecurityProfilesRequest& WithInstanceId(Aws::String&& value) { SetInstanceId(std::move(value)); return *this;}
     ...
     * the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
     */
    inline ListSecurityProfilesRequest& WithInstanceId(const char* value) { SetInstanceId(value); return *this;}
