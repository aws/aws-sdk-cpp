...
class SearchContactFlowModulesResult {
 public:
  ...
  void SetContactFlowModules(ContactFlowModulesT&& value) {
    m_contactFlowModulesHasBeenSet = true;
    m_contactFlowModules = std::forward<ContactFlowModulesT>(value);
  }
  template <typename ContactFlowModulesT = Aws::Vector<ContactFlowModule>>
  SearchContactFlowModulesResult& WithContactFlowModules(ContactFlowModulesT&& value) {
    SetContactFlowModules(std::forward<ContactFlowModulesT>(value));
    return *this;
  }
  template <typename ContactFlowModulesT = ContactFlowModule>
  SearchContactFlowModulesResult& AddContactFlowModules(ContactFlowModulesT&& value) {
    m_contactFlowModulesHasBeenSet = true;
    m_contactFlowModules.emplace_back(std::forward<ContactFlowModulesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchContactFlowModulesResult& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchContactFlowModulesResult& WithApproximateTotalCount(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchContactFlowModulesResult& WithRequestId(RequestIdT&& value) {
