...
/**
 */
class ListNotificationsRequest : public ConnectRequest {
 public:
  AWS_CONNECT_API ListNotificationsRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  ListNotificationsRequest& WithInstanceId(InstanceIdT&& value) {
