...
class EvaluationFormSingleSelectQuestionAutomation {
 public:
  ...
  template <typename OptionsT = Aws::Vector<EvaluationFormSingleSelectQuestionAutomationOption>>
  EvaluationFormSingleSelectQuestionAutomation& WithOptions(OptionsT&& value) {
    SetOptions(std::forward<OptionsT>(value));
    return *this;
  }
  template <typename OptionsT = EvaluationFormSingleSelectQuestionAutomationOption>
  EvaluationFormSingleSelectQuestionAutomation& AddOptions(OptionsT&& value) {
    m_optionsHasBeenSet = true;
  ...
  void SetDefaultOptionRefId(DefaultOptionRefIdT&& value) {
    m_defaultOptionRefIdHasBeenSet = true;
    m_defaultOptionRefId = std::forward<DefaultOptionRefIdT>(value);
  }
  template <typename DefaultOptionRefIdT = Aws::String>
  EvaluationFormSingleSelectQuestionAutomation& WithDefaultOptionRefId(DefaultOptionRefIdT&& value) {
    SetDefaultOptionRefId(std::forward<DefaultOptionRefIdT>(value));
    return *this;
  }
  ///@}
