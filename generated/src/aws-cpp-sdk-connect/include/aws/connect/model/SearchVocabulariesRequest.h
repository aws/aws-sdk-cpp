...
class SearchVocabulariesRequest : public ConnectRequest {
 public:
  ...
  inline SearchVocabulariesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline SearchVocabulariesRequest& WithState(VocabularyState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetNameStartsWith(NameStartsWithT&& value) {
    m_nameStartsWithHasBeenSet = true;
    m_nameStartsWith = std::forward<NameStartsWithT>(value);
  }
  template <typename NameStartsWithT = Aws::String>
  SearchVocabulariesRequest& WithNameStartsWith(NameStartsWithT&& value) {
    SetNameStartsWith(std::forward<NameStartsWithT>(value));
    return *this;
  }
  ///@}
  ...
  inline SearchVocabulariesRequest& WithLanguageCode(VocabularyLanguageCode value) {
