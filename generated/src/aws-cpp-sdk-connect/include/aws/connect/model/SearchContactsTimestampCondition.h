...
class SearchContactsTimestampCondition {
 public:
  ...
  inline void SetType(SearchContactsTimeRangeType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline SearchContactsTimestampCondition& WithType(SearchContactsTimeRangeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConditionType(SearchContactsTimeRangeConditionType value) {
    m_conditionTypeHasBeenSet = true;
    m_conditionType = value;
  }
  inline SearchContactsTimestampCondition& WithConditionType(SearchContactsTimeRangeConditionType value) {
