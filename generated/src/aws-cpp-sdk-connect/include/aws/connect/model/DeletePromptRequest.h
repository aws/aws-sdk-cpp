...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API DeletePromptRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    DeletePromptRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PromptIdT = Aws::String>
    DeletePromptRequest& WithPromptId(PromptIdT&& value) { SetPromptId(std::forward<PromptIdT>(value)); return *this;}
    ///@}
  private:
