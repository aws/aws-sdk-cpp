...
class Dimensions {
 public:
  ...
  inline Dimensions& WithChannel(Channel value) {
    SetChannel(value);
    return *this;
  }
  ///@}
  ...
  void SetRoutingStepExpression(RoutingStepExpressionT&& value) {
    ...
    m_routingStepExpression = std::forward<RoutingStepExpressionT>(value);
  }
  template <typename RoutingStepExpressionT = Aws::String>
  Dimensions& WithRoutingStepExpression(RoutingStepExpressionT&& value) {
    SetRoutingStepExpression(std::forward<RoutingStepExpressionT>(value));
    return *this;
  }
  ///@}
