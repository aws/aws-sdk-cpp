...
class ListPromptsResult {
 public:
  ...
  void SetPromptSummaryList(PromptSummaryListT&& value) {
    m_promptSummaryListHasBeenSet = true;
    m_promptSummaryList = std::forward<PromptSummaryListT>(value);
  }
  template <typename PromptSummaryListT = Aws::Vector<PromptSummary>>
  ListPromptsResult& WithPromptSummaryList(PromptSummaryListT&& value) {
    SetPromptSummaryList(std::forward<PromptSummaryListT>(value));
    return *this;
  }
  template <typename PromptSummaryListT = PromptSummary>
  ListPromptsResult& AddPromptSummaryList(PromptSummaryListT&& value) {
    m_promptSummaryListHasBeenSet = true;
    m_promptSummaryList.emplace_back(std::forward<PromptSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPromptsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPromptsResult& WithRequestId(RequestIdT&& value) {
