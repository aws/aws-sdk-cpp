...
class AgentStatus {
 public:
  ...
  void SetAgentStatusARN(AgentStatusARNT&& value) {
    ...
    m_agentStatusARN = std::forward<AgentStatusARNT>(value);
  }
  template <typename AgentStatusARNT = Aws::String>
  AgentStatus& WithAgentStatusARN(AgentStatusARNT&& value) {
    SetAgentStatusARN(std::forward<AgentStatusARNT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAgentStatusId(AgentStatusIdT&& value) {
    ...
    m_agentStatusId = std::forward<AgentStatusIdT>(value);
  }
  template <typename AgentStatusIdT = Aws::String>
  AgentStatus& WithAgentStatusId(AgentStatusIdT&& value) {
    SetAgentStatusId(std::forward<AgentStatusIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(AgentStatusType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline AgentStatus& WithType(AgentStatusType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDisplayOrder(int value) {
    m_displayOrderHasBeenSet = true;
    m_displayOrder = value;
  }
  inline AgentStatus& WithDisplayOrder(int value) {
  ...
  inline void SetState(AgentStatusState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline AgentStatus& WithState(AgentStatusState value) {
    SetState(value);
    return *this;
  }
  ///@}
