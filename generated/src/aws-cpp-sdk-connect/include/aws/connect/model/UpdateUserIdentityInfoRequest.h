...
class UpdateUserIdentityInfoRequest : public ConnectRequest {
 public:
  ...
  template <typename IdentityInfoT = UserIdentityInfo>
  UpdateUserIdentityInfoRequest& WithIdentityInfo(IdentityInfoT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  UpdateUserIdentityInfoRequest& WithUserId(UserIdT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateUserIdentityInfoRequest& WithInstanceId(InstanceIdT&& value) {
