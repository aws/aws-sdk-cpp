...
class DescribeTrafficDistributionGroupResult {
 public:
  ...
  void SetTrafficDistributionGroup(TrafficDistributionGroupT&& value) {
    m_trafficDistributionGroupHasBeenSet = true;
    m_trafficDistributionGroup = std::forward<TrafficDistributionGroupT>(value);
  }
  template <typename TrafficDistributionGroupT = TrafficDistributionGroup>
  DescribeTrafficDistributionGroupResult& WithTrafficDistributionGroup(TrafficDistributionGroupT&& value) {
    SetTrafficDistributionGroup(std::forward<TrafficDistributionGroupT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTrafficDistributionGroupResult& WithRequestId(RequestIdT&& value) {
