...
class DisassociateLambdaFunctionRequest : public ConnectRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  DisassociateLambdaFunctionRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename FunctionArnT = Aws::String>
  DisassociateLambdaFunctionRequest& WithFunctionArn(FunctionArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DisassociateLambdaFunctionRequest& WithClientToken(ClientTokenT&& value) {
