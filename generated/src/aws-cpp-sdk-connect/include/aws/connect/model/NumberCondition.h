...
class NumberCondition {
 public:
  ...
  template <typename FieldNameT = Aws::String>
  NumberCondition& WithFieldName(FieldNameT&& value) {
  ...
  inline NumberCondition& WithMinValue(int value) {
    SetMinValue(value);
    return *this;
  }
  ///@}
  ...
  inline NumberCondition& WithMaxValue(int value) {
    SetMaxValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetComparisonType(NumberComparisonType value) {
    m_comparisonTypeHasBeenSet = true;
    m_comparisonType = value;
  }
  inline NumberCondition& WithComparisonType(NumberComparisonType value) {
