...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    DeleteRoutingProfileRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RoutingProfileIdT = Aws::String>
    DeleteRoutingProfileRequest& WithRoutingProfileId(RoutingProfileIdT&& value) { SetRoutingProfileId(std::forward<RoutingProfileIdT>(value)); return *this;}
    ///@}
  private:
