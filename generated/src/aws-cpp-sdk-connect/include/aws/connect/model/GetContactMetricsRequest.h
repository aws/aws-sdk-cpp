...
/**
 */
class GetContactMetricsRequest : public ConnectRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetContactMetrics"; }
  ...
  template <typename MetricsT = Aws::Vector<ContactMetricInfo>>
  ...
  template <typename MetricsT = ContactMetricInfo>
 ...
 private:
  ...
  Aws::Vector<ContactMetricInfo> m_metrics;
