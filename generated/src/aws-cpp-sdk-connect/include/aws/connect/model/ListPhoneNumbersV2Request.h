...
class ListPhoneNumbersV2Request : public ConnectRequest {
 public:
  ...
  template <typename TargetArnT = Aws::String>
  ListPhoneNumbersV2Request& WithTargetArn(TargetArnT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  ListPhoneNumbersV2Request& WithInstanceId(InstanceIdT&& value) {
  ...
  inline ListPhoneNumbersV2Request& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPhoneNumbersV2Request& WithNextToken(NextTokenT&& value) {
  ...
  void SetPhoneNumberCountryCodes(PhoneNumberCountryCodesT&& value) {
    m_phoneNumberCountryCodesHasBeenSet = true;
    m_phoneNumberCountryCodes = std::forward<PhoneNumberCountryCodesT>(value);
  }
  template <typename PhoneNumberCountryCodesT = Aws::Vector<PhoneNumberCountryCode>>
  ListPhoneNumbersV2Request& WithPhoneNumberCountryCodes(PhoneNumberCountryCodesT&& value) {
    SetPhoneNumberCountryCodes(std::forward<PhoneNumberCountryCodesT>(value));
    return *this;
  }
  inline ListPhoneNumbersV2Request& AddPhoneNumberCountryCodes(PhoneNumberCountryCode value) {
    m_phoneNumberCountryCodesHasBeenSet = true;
    m_phoneNumberCountryCodes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetPhoneNumberTypes(PhoneNumberTypesT&& value) {
    m_phoneNumberTypesHasBeenSet = true;
    m_phoneNumberTypes = std::forward<PhoneNumberTypesT>(value);
  }
  template <typename PhoneNumberTypesT = Aws::Vector<PhoneNumberType>>
  ListPhoneNumbersV2Request& WithPhoneNumberTypes(PhoneNumberTypesT&& value) {
    SetPhoneNumberTypes(std::forward<PhoneNumberTypesT>(value));
    return *this;
  }
  inline ListPhoneNumbersV2Request& AddPhoneNumberTypes(PhoneNumberType value) {
    m_phoneNumberTypesHasBeenSet = true;
    m_phoneNumberTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetPhoneNumberPrefix(PhoneNumberPrefixT&& value) {
    m_phoneNumberPrefixHasBeenSet = true;
    m_phoneNumberPrefix = std::forward<PhoneNumberPrefixT>(value);
  }
  template <typename PhoneNumberPrefixT = Aws::String>
  ListPhoneNumbersV2Request& WithPhoneNumberPrefix(PhoneNumberPrefixT&& value) {
    SetPhoneNumberPrefix(std::forward<PhoneNumberPrefixT>(value));
    return *this;
  }
  ///@}
 private:
