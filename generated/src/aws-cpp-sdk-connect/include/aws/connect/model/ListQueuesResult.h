...
class ListQueuesResult {
 public:
  ...
  void SetQueueSummaryList(QueueSummaryListT&& value) {
    m_queueSummaryListHasBeenSet = true;
    m_queueSummaryList = std::forward<QueueSummaryListT>(value);
  }
  template <typename QueueSummaryListT = Aws::Vector<QueueSummary>>
  ListQueuesResult& WithQueueSummaryList(QueueSummaryListT&& value) {
    SetQueueSummaryList(std::forward<QueueSummaryListT>(value));
    return *this;
  }
  template <typename QueueSummaryListT = QueueSummary>
  ListQueuesResult& AddQueueSummaryList(QueueSummaryListT&& value) {
    m_queueSummaryListHasBeenSet = true;
    m_queueSummaryList.emplace_back(std::forward<QueueSummaryListT>(value));
    return *this;
  }
  ///@}
