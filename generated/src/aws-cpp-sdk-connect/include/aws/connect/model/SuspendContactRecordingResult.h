...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECT_API SuspendContactRecordingResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    SuspendContactRecordingResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
