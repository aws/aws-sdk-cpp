...
namespace Model
{
  ...
  public:
    ...
    inline SuspendContactRecordingResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline SuspendContactRecordingResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline SuspendContactRecordingResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
