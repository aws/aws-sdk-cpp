...
namespace Connect {
/**
 *  <p>Amazon Connect now refers to a portfolio of agentic solutions for
 * business functions. The legacy product is now called Amazon Connect Customer, or
 * simply Customer. The legacy name is used interchangeably in this
 * documentation.</p>  <ul> <li> <p> <a
 * href="https://docs.aws.amazon.com/connect/latest/APIReference/API_Operations_Amazon_Connect_Service.html">Connect
 * Customer Customer actions</a> </p> </li> <li> <p> <a
 * href="https://docs.aws.amazon.com/connect/latest/APIReference/API_Types_Amazon_Connect_Service.html">Connect
 * Customer Customer data types</a> </p> </li> </ul> <p>Connect Customer Customer
 * engages customers at every touchpoint and creates deeper relationships with AI
 * powered capabilities.</p> <p>Build and manage customer communication
 * experiences. Connect customers to agents, enable intelligent routing, and track
 * performance in real-time.</p> <p>There are limits to the number of Connect
 * Customer resources that you can create. There are also limits to the number of
...
class AWS_CONNECT_API ConnectClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ConnectClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ConnectEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for ActivateEvaluationForm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ActivateEvaluationForm that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ActivateEvaluationFormRequestT = Model::ActivateEvaluationFormRequest>
  void ActivateEvaluationFormAsync(const ActivateEvaluationFormRequestT& request,
                                   const ActivateEvaluationFormResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssociateAnalyticsDataSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AssociateAnalyticsDataSetRequestT = Model::AssociateAnalyticsDataSetRequest>
  Model::AssociateAnalyticsDataSetOutcomeCallable AssociateAnalyticsDataSetCallable(
      const AssociateAnalyticsDataSetRequestT& request) const {
    return SubmitCallable(&ConnectClient::AssociateAnalyticsDataSet, request);
  }

  /**
   * An Async wrapper for AssociateAnalyticsDataSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateAnalyticsDataSetRequestT = Model::AssociateAnalyticsDataSetRequest>
  void AssociateAnalyticsDataSetAsync(const AssociateAnalyticsDataSetRequestT& request,
                                      const AssociateAnalyticsDataSetResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateApprovedOrigin that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateApprovedOrigin that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateApprovedOriginRequestT = Model::AssociateApprovedOriginRequest>
  void AssociateApprovedOriginAsync(const AssociateApprovedOriginRequestT& request,
  ...
  /**
   * An Async wrapper for AssociateBot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateBotRequestT = Model::AssociateBotRequest>
  void AssociateBotAsync(const AssociateBotRequestT& request, const AssociateBotResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateContactWithUser that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateContactWithUser that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateContactWithUserRequestT = Model::AssociateContactWithUserRequest>
  void AssociateContactWithUserAsync(const AssociateContactWithUserRequestT& request,
                                     const AssociateContactWithUserResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateDefaultVocabularyOutcome AssociateDefaultVocabulary(
      const Model::AssociateDefaultVocabularyRequest& request) const;

  /**
   * A Callable wrapper for AssociateDefaultVocabulary that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateDefaultVocabularyRequestT = Model::AssociateDefaultVocabularyRequest>
  Model::AssociateDefaultVocabularyOutcomeCallable AssociateDefaultVocabularyCallable(
      const AssociateDefaultVocabularyRequestT& request) const {
    return SubmitCallable(&ConnectClient::AssociateDefaultVocabulary, request);
  }

  /**
   * An Async wrapper for AssociateDefaultVocabulary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateDefaultVocabularyRequestT = Model::AssociateDefaultVocabularyRequest>
  void AssociateDefaultVocabularyAsync(const AssociateDefaultVocabularyRequestT& request,
                                       const AssociateDefaultVocabularyResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateEmailAddressAliasOutcome AssociateEmailAddressAlias(
      const Model::AssociateEmailAddressAliasRequest& request) const;

  /**
   * A Callable wrapper for AssociateEmailAddressAlias that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateEmailAddressAliasRequestT = Model::AssociateEmailAddressAliasRequest>
  Model::AssociateEmailAddressAliasOutcomeCallable AssociateEmailAddressAliasCallable(
      const AssociateEmailAddressAliasRequestT& request) const {
    return SubmitCallable(&ConnectClient::AssociateEmailAddressAlias, request);
  }

  /**
   * An Async wrapper for AssociateEmailAddressAlias that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateEmailAddressAliasRequestT = Model::AssociateEmailAddressAliasRequest>
  void AssociateEmailAddressAliasAsync(const AssociateEmailAddressAliasRequestT& request,
                                       const AssociateEmailAddressAliasResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AssociateFlow that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateFlowRequestT = Model::AssociateFlowRequest>
  void AssociateFlowAsync(const AssociateFlowRequestT& request, const AssociateFlowResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::AssociateInstanceStorageConfigOutcome AssociateInstanceStorageConfig(
      const Model::AssociateInstanceStorageConfigRequest& request) const;

  /**
   * A Callable wrapper for AssociateInstanceStorageConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateInstanceStorageConfigRequestT = Model::AssociateInstanceStorageConfigRequest>
  Model::AssociateInstanceStorageConfigOutcomeCallable AssociateInstanceStorageConfigCallable(
      const AssociateInstanceStorageConfigRequestT& request) const {
    return SubmitCallable(&ConnectClient::AssociateInstanceStorageConfig, request);
  }

  /**
   * An Async wrapper for AssociateInstanceStorageConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateInstanceStorageConfigRequestT = Model::AssociateInstanceStorageConfigRequest>
  void AssociateInstanceStorageConfigAsync(const AssociateInstanceStorageConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for AssociateLambdaFunction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateLambdaFunction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateLambdaFunctionRequestT = Model::AssociateLambdaFunctionRequest>
  void AssociateLambdaFunctionAsync(const AssociateLambdaFunctionRequestT& request,
  ...
  /**
   * An Async wrapper for AssociateLexBot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateLexBotRequestT = Model::AssociateLexBotRequest>
  void AssociateLexBotAsync(const AssociateLexBotRequestT& request, const AssociateLexBotResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociatePhoneNumberContactFlowOutcome AssociatePhoneNumberContactFlow(
      const Model::AssociatePhoneNumberContactFlowRequest& request) const;

  /**
   * A Callable wrapper for AssociatePhoneNumberContactFlow that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociatePhoneNumberContactFlowRequestT = Model::AssociatePhoneNumberContactFlowRequest>
  Model::AssociatePhoneNumberContactFlowOutcomeCallable AssociatePhoneNumberContactFlowCallable(
      const AssociatePhoneNumberContactFlowRequestT& request) const {
    return SubmitCallable(&ConnectClient::AssociatePhoneNumberContactFlow, request);
  }

  /**
   * An Async wrapper for AssociatePhoneNumberContactFlow that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociatePhoneNumberContactFlowRequestT = Model::AssociatePhoneNumberContactFlowRequest>
  void AssociatePhoneNumberContactFlowAsync(const AssociatePhoneNumberContactFlowRequestT& request,
                                            const AssociatePhoneNumberContactFlowResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateQueueQuickConnectsOutcome AssociateQueueQuickConnects(
      const Model::AssociateQueueQuickConnectsRequest& request) const;

  /**
   * A Callable wrapper for AssociateQueueQuickConnects that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateQueueQuickConnectsRequestT = Model::AssociateQueueQuickConnectsRequest>
  Model::AssociateQueueQuickConnectsOutcomeCallable AssociateQueueQuickConnectsCallable(
      const AssociateQueueQuickConnectsRequestT& request) const {
    return SubmitCallable(&ConnectClient::AssociateQueueQuickConnects, request);
  }

  /**
   * An Async wrapper for AssociateQueueQuickConnects that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateQueueQuickConnectsRequestT = Model::AssociateQueueQuickConnectsRequest>
  void AssociateQueueQuickConnectsAsync(const AssociateQueueQuickConnectsRequestT& request,
  ...
  virtual Model::AssociateRoutingProfileQueuesOutcome AssociateRoutingProfileQueues(
      const Model::AssociateRoutingProfileQueuesRequest& request) const;

  /**
   * A Callable wrapper for AssociateRoutingProfileQueues that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateRoutingProfileQueuesRequestT = Model::AssociateRoutingProfileQueuesRequest>
  Model::AssociateRoutingProfileQueuesOutcomeCallable AssociateRoutingProfileQueuesCallable(
      const AssociateRoutingProfileQueuesRequestT& request) const {
    return SubmitCallable(&ConnectClient::AssociateRoutingProfileQueues, request);
  }

  /**
   * An Async wrapper for AssociateRoutingProfileQueues that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateRoutingProfileQueuesRequestT = Model::AssociateRoutingProfileQueuesRequest>
  void AssociateRoutingProfileQueuesAsync(const AssociateRoutingProfileQueuesRequestT& request,
  ...
  /**
   * A Callable wrapper for AssociateSecurityKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateSecurityKey that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateSecurityKeyRequestT = Model::AssociateSecurityKeyRequest>
  void AssociateSecurityKeyAsync(const AssociateSecurityKeyRequestT& request, const AssociateSecurityKeyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateTrafficDistributionGroupUserOutcome AssociateTrafficDistributionGroupUser(
      const Model::AssociateTrafficDistributionGroupUserRequest& request) const;

  /**
   * A Callable wrapper for AssociateTrafficDistributionGroupUser that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename AssociateTrafficDistributionGroupUserRequestT = Model::AssociateTrafficDistributionGroupUserRequest>
  Model::AssociateTrafficDistributionGroupUserOutcomeCallable AssociateTrafficDistributionGroupUserCallable(
      const AssociateTrafficDistributionGroupUserRequestT& request) const {
    return SubmitCallable(&ConnectClient::AssociateTrafficDistributionGroupUser, request);
  }

  /**
   * An Async wrapper for AssociateTrafficDistributionGroupUser that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateTrafficDistributionGroupUserRequestT = Model::AssociateTrafficDistributionGroupUserRequest>
  void AssociateTrafficDistributionGroupUserAsync(const AssociateTrafficDistributionGroupUserRequestT& request,
                                                  const AssociateTrafficDistributionGroupUserResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateUserProficienciesOutcome AssociateUserProficiencies(
      const Model::AssociateUserProficienciesRequest& request) const;

  /**
   * A Callable wrapper for AssociateUserProficiencies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateUserProficienciesRequestT = Model::AssociateUserProficienciesRequest>
  Model::AssociateUserProficienciesOutcomeCallable AssociateUserProficienciesCallable(
      const AssociateUserProficienciesRequestT& request) const {
    return SubmitCallable(&ConnectClient::AssociateUserProficiencies, request);
  }

  /**
   * An Async wrapper for AssociateUserProficiencies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateUserProficienciesRequestT = Model::AssociateUserProficienciesRequest>
  void AssociateUserProficienciesAsync(const AssociateUserProficienciesRequestT& request,
                                       const AssociateUserProficienciesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchAssociateAnalyticsDataSetOutcome BatchAssociateAnalyticsDataSet(
      const Model::BatchAssociateAnalyticsDataSetRequest& request) const;

  /**
   * A Callable wrapper for BatchAssociateAnalyticsDataSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchAssociateAnalyticsDataSetRequestT = Model::BatchAssociateAnalyticsDataSetRequest>
  Model::BatchAssociateAnalyticsDataSetOutcomeCallable BatchAssociateAnalyticsDataSetCallable(
      const BatchAssociateAnalyticsDataSetRequestT& request) const {
    return SubmitCallable(&ConnectClient::BatchAssociateAnalyticsDataSet, request);
  }

  /**
   * An Async wrapper for BatchAssociateAnalyticsDataSet that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchAssociateAnalyticsDataSetRequestT = Model::BatchAssociateAnalyticsDataSetRequest>
  void BatchAssociateAnalyticsDataSetAsync(const BatchAssociateAnalyticsDataSetRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDisassociateAnalyticsDataSetOutcome BatchDisassociateAnalyticsDataSet(
      const Model::BatchDisassociateAnalyticsDataSetRequest& request) const;

  /**
   * A Callable wrapper for BatchDisassociateAnalyticsDataSet that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename BatchDisassociateAnalyticsDataSetRequestT = Model::BatchDisassociateAnalyticsDataSetRequest>
  Model::BatchDisassociateAnalyticsDataSetOutcomeCallable BatchDisassociateAnalyticsDataSetCallable(
      const BatchDisassociateAnalyticsDataSetRequestT& request) const {
    return SubmitCallable(&ConnectClient::BatchDisassociateAnalyticsDataSet, request);
  }

  /**
   * An Async wrapper for BatchDisassociateAnalyticsDataSet that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchDisassociateAnalyticsDataSetRequestT = Model::BatchDisassociateAnalyticsDataSetRequest>
  void BatchDisassociateAnalyticsDataSetAsync(const BatchDisassociateAnalyticsDataSetRequestT& request,
                                              const BatchDisassociateAnalyticsDataSetResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::BatchGetAttachedFileMetadataOutcome BatchGetAttachedFileMetadata(
      const Model::BatchGetAttachedFileMetadataRequest& request) const;

  /**
   * A Callable wrapper for BatchGetAttachedFileMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchGetAttachedFileMetadataRequestT = Model::BatchGetAttachedFileMetadataRequest>
  Model::BatchGetAttachedFileMetadataOutcomeCallable BatchGetAttachedFileMetadataCallable(
      const BatchGetAttachedFileMetadataRequestT& request) const {
    return SubmitCallable(&ConnectClient::BatchGetAttachedFileMetadata, request);
  }

  /**
   * An Async wrapper for BatchGetAttachedFileMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetAttachedFileMetadataRequestT = Model::BatchGetAttachedFileMetadataRequest>
  void BatchGetAttachedFileMetadataAsync(const BatchGetAttachedFileMetadataRequestT& request,
                                         const BatchGetAttachedFileMetadataResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetFlowAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetFlowAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetFlowAssociationRequestT = Model::BatchGetFlowAssociationRequest>
  void BatchGetFlowAssociationAsync(const BatchGetFlowAssociationRequestT& request,
                                    const BatchGetFlowAssociationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for BatchPutContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchPutContactRequestT = Model::BatchPutContactRequest>
   ...
   * claim and release up to 200% of your maximum number of active phone numbers. If
   * you claim and release phone numbers using the UI or API during a rolling 180 day
   * cycle that exceeds 200% of your phone number service level quota, you will be
   * blocked from claiming any more numbers until 180 days past the oldest number
   * released has expired. </p> <p>For example, if you already have 99 claimed
   * numbers and a service level quota of 99 phone numbers, and in any 180 day period
   ...
   * open an Amazon Web Services support ticket.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for ClaimPhoneNumber that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ClaimPhoneNumber that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ClaimPhoneNumberRequestT = Model::ClaimPhoneNumberRequest>
  void ClaimPhoneNumberAsync(const ClaimPhoneNumberRequestT& request, const ClaimPhoneNumberResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CompleteAttachedFileUploadOutcome CompleteAttachedFileUpload(
      const Model::CompleteAttachedFileUploadRequest& request) const;

  /**
   * A Callable wrapper for CompleteAttachedFileUpload that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CompleteAttachedFileUploadRequestT = Model::CompleteAttachedFileUploadRequest>
  Model::CompleteAttachedFileUploadOutcomeCallable CompleteAttachedFileUploadCallable(
      const CompleteAttachedFileUploadRequestT& request) const {
    return SubmitCallable(&ConnectClient::CompleteAttachedFileUpload, request);
  }

  /**
   * An Async wrapper for CompleteAttachedFileUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CompleteAttachedFileUploadRequestT = Model::CompleteAttachedFileUploadRequest>
  void CompleteAttachedFileUploadAsync(const CompleteAttachedFileUploadRequestT& request,
                                       const CompleteAttachedFileUploadResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAgentStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAgentStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAgentStatusRequestT = Model::CreateAgentStatusRequest>
  void CreateAgentStatusAsync(const CreateAgentStatusRequestT& request, const CreateAgentStatusResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <code>connect:ExternalAudio</code>. </p> </li> <li> <p>For EMAIL: The supported
   * initiation methods are <code>OUTBOUND</code>, <code>AGENT_REPLY</code>, and
   * <code>FLOW</code>. </p> </li> <li> <p>For TASK: The supported initiation method
   * is <code>API</code>. Contacts created with this API have a sub-type of
   * <code>connect:ExternalTask</code>.</p> </li> </ul>  <p>Creates a new
   * VOICE, EMAIL, or TASK contact. </p> <p>After a contact is created, you can move
   * it to the desired state by using the <code>InitiateAs</code> parameter. While
   * you can use API to create task contacts that are in the <code>COMPLETED</code>
   * state, you must contact Amazon Web Services Support before using it for bulk
   * import use cases. Bulk import causes your requests to be throttled or fail if
   * your CreateContact limits aren't high enough. </p><p><h3>See Also:</h3>   <a
  ...
  Model::CreateContactOutcomeCallable CreateContactCallable(const CreateContactRequestT& request) const {
    return SubmitCallable(&ConnectClient::CreateContact, request);
  }

  /**
   * An Async wrapper for CreateContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateContactRequestT = Model::CreateContactRequest>
  void CreateContactAsync(const CreateContactRequestT& request, const CreateContactResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::CreateContact, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateContactFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateContactFlow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateContactFlowRequestT = Model::CreateContactFlowRequest>
  void CreateContactFlowAsync(const CreateContactFlowRequestT& request, const CreateContactFlowResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateContactFlowModule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateContactFlowModule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateContactFlowModuleRequestT = Model::CreateContactFlowModuleRequest>
  void CreateContactFlowModuleAsync(const CreateContactFlowModuleRequestT& request,
                                    const CreateContactFlowModuleResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateContactFlowVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateContactFlowVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateContactFlowVersionRequestT = Model::CreateContactFlowVersionRequest>
  void CreateContactFlowVersionAsync(const CreateContactFlowVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateEmailAddress that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateEmailAddressRequestT = Model::CreateEmailAddressRequest>
  Model::CreateEmailAddressOutcomeCallable CreateEmailAddressCallable(const CreateEmailAddressRequestT& request) const {
    return SubmitCallable(&ConnectClient::CreateEmailAddress, request);
  }

  /**
   * An Async wrapper for CreateEmailAddress that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateEmailAddressRequestT = Model::CreateEmailAddressRequest>
  void CreateEmailAddressAsync(const CreateEmailAddressRequestT& request, const CreateEmailAddressResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::CreateEmailAddress, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateEvaluationForm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEvaluationForm that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEvaluationFormRequestT = Model::CreateEvaluationFormRequest>
  void CreateEvaluationFormAsync(const CreateEvaluationFormRequestT& request, const CreateEvaluationFormResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateHoursOfOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateHoursOfOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateHoursOfOperationRequestT = Model::CreateHoursOfOperationRequest>
  void CreateHoursOfOperationAsync(const CreateHoursOfOperationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateHoursOfOperationOverrideOutcome CreateHoursOfOperationOverride(
      const Model::CreateHoursOfOperationOverrideRequest& request) const;

  /**
   * A Callable wrapper for CreateHoursOfOperationOverride that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateHoursOfOperationOverrideRequestT = Model::CreateHoursOfOperationOverrideRequest>
  Model::CreateHoursOfOperationOverrideOutcomeCallable CreateHoursOfOperationOverrideCallable(
      const CreateHoursOfOperationOverrideRequestT& request) const {
    return SubmitCallable(&ConnectClient::CreateHoursOfOperationOverride, request);
  }

  /**
   * An Async wrapper for CreateHoursOfOperationOverride that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateHoursOfOperationOverrideRequestT = Model::CreateHoursOfOperationOverrideRequest>
  void CreateHoursOfOperationOverrideAsync(const CreateHoursOfOperationOverrideRequestT& request,
                                           const CreateHoursOfOperationOverrideResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename CreateInstanceRequestT = Model::CreateInstanceRequest>
  void CreateInstanceAsync(const CreateInstanceRequestT& request, const CreateInstanceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateIntegrationAssociationOutcome CreateIntegrationAssociation(
      const Model::CreateIntegrationAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateIntegrationAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateIntegrationAssociationRequestT = Model::CreateIntegrationAssociationRequest>
  Model::CreateIntegrationAssociationOutcomeCallable CreateIntegrationAssociationCallable(
      const CreateIntegrationAssociationRequestT& request) const {
    return SubmitCallable(&ConnectClient::CreateIntegrationAssociation, request);
  }

  /**
   * An Async wrapper for CreateIntegrationAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateIntegrationAssociationRequestT = Model::CreateIntegrationAssociationRequest>
  void CreateIntegrationAssociationAsync(const CreateIntegrationAssociationRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateParticipant that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateParticipant that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateParticipantRequestT = Model::CreateParticipantRequest>
  void CreateParticipantAsync(const CreateParticipantRequestT& request, const CreateParticipantResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePersistentContactAssociationOutcome CreatePersistentContactAssociation(
      const Model::CreatePersistentContactAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreatePersistentContactAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreatePersistentContactAssociationRequestT = Model::CreatePersistentContactAssociationRequest>
  Model::CreatePersistentContactAssociationOutcomeCallable CreatePersistentContactAssociationCallable(
      const CreatePersistentContactAssociationRequestT& request) const {
    return SubmitCallable(&ConnectClient::CreatePersistentContactAssociation, request);
  }

  /**
   * An Async wrapper for CreatePersistentContactAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreatePersistentContactAssociationRequestT = Model::CreatePersistentContactAssociationRequest>
  void CreatePersistentContactAssociationAsync(const CreatePersistentContactAssociationRequestT& request,
                                               const CreatePersistentContactAssociationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePredefinedAttribute that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreatePredefinedAttributeRequestT = Model::CreatePredefinedAttributeRequest>
  Model::CreatePredefinedAttributeOutcomeCallable CreatePredefinedAttributeCallable(
      const CreatePredefinedAttributeRequestT& request) const {
    return SubmitCallable(&ConnectClient::CreatePredefinedAttribute, request);
  }

  /**
   * An Async wrapper for CreatePredefinedAttribute that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePredefinedAttributeRequestT = Model::CreatePredefinedAttributeRequest>
  void CreatePredefinedAttributeAsync(const CreatePredefinedAttributeRequestT& request,
                                      const CreatePredefinedAttributeResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreatePrompt that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreatePromptRequestT = Model::CreatePromptRequest>
  void CreatePromptAsync(const CreatePromptRequestT& request, const CreatePromptResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePushNotificationRegistrationOutcome CreatePushNotificationRegistration(
      const Model::CreatePushNotificationRegistrationRequest& request) const;

  /**
   * A Callable wrapper for CreatePushNotificationRegistration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreatePushNotificationRegistrationRequestT = Model::CreatePushNotificationRegistrationRequest>
  Model::CreatePushNotificationRegistrationOutcomeCallable CreatePushNotificationRegistrationCallable(
      const CreatePushNotificationRegistrationRequestT& request) const {
    return SubmitCallable(&ConnectClient::CreatePushNotificationRegistration, request);
  }

  /**
   * An Async wrapper for CreatePushNotificationRegistration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreatePushNotificationRegistrationRequestT = Model::CreatePushNotificationRegistrationRequest>
  void CreatePushNotificationRegistrationAsync(const CreatePushNotificationRegistrationRequestT& request,
                                               const CreatePushNotificationRegistrationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateQueue that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateQueueRequestT = Model::CreateQueueRequest>
  void CreateQueueAsync(const CreateQueueRequestT& request, const CreateQueueResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateQuickConnect that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateQuickConnect that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateQuickConnectRequestT = Model::CreateQuickConnectRequest>
  void CreateQuickConnectAsync(const CreateQuickConnectRequestT& request, const CreateQuickConnectResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateRoutingProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateRoutingProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRoutingProfileRequestT = Model::CreateRoutingProfileRequest>
  void CreateRoutingProfileAsync(const CreateRoutingProfileRequestT& request, const CreateRoutingProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSecurityProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSecurityProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSecurityProfileRequestT = Model::CreateSecurityProfileRequest>
  void CreateSecurityProfileAsync(const CreateSecurityProfileRequestT& request, const CreateSecurityProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTaskTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTaskTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateTaskTemplateRequestT = Model::CreateTaskTemplateRequest>
  void CreateTaskTemplateAsync(const CreateTaskTemplateRequestT& request, const CreateTaskTemplateResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CreateTrafficDistributionGroupOutcome CreateTrafficDistributionGroup(
      const Model::CreateTrafficDistributionGroupRequest& request) const;

  /**
   * A Callable wrapper for CreateTrafficDistributionGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateTrafficDistributionGroupRequestT = Model::CreateTrafficDistributionGroupRequest>
  Model::CreateTrafficDistributionGroupOutcomeCallable CreateTrafficDistributionGroupCallable(
      const CreateTrafficDistributionGroupRequestT& request) const {
    return SubmitCallable(&ConnectClient::CreateTrafficDistributionGroup, request);
  }

  /**
   * An Async wrapper for CreateTrafficDistributionGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateTrafficDistributionGroupRequestT = Model::CreateTrafficDistributionGroupRequest>
  void CreateTrafficDistributionGroupAsync(const CreateTrafficDistributionGroupRequestT& request,
                                           const CreateTrafficDistributionGroupResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateUseCase that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateUseCaseRequestT = Model::CreateUseCaseRequest>
  void CreateUseCaseAsync(const CreateUseCaseRequestT& request, const CreateUseCaseResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateUserHierarchyGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateUserHierarchyGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateUserHierarchyGroupRequestT = Model::CreateUserHierarchyGroupRequest>
  void CreateUserHierarchyGroupAsync(const CreateUserHierarchyGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateViewVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateViewVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateViewVersionRequestT = Model::CreateViewVersionRequest>
  void CreateViewVersionAsync(const CreateViewVersionRequestT& request, const CreateViewVersionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateVocabulary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateVocabulary that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateVocabularyRequestT = Model::CreateVocabularyRequest>
  void CreateVocabularyAsync(const CreateVocabularyRequestT& request, const CreateVocabularyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeactivateEvaluationForm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeactivateEvaluationForm that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeactivateEvaluationFormRequestT = Model::DeactivateEvaluationFormRequest>
  void DeactivateEvaluationFormAsync(const DeactivateEvaluationFormRequestT& request,
                                     const DeactivateEvaluationFormResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAttachedFile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAttachedFile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAttachedFileRequestT = Model::DeleteAttachedFileRequest>
  void DeleteAttachedFileAsync(const DeleteAttachedFileRequestT& request, const DeleteAttachedFileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteContactEvaluation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteContactEvaluation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteContactEvaluationRequestT = Model::DeleteContactEvaluationRequest>
  void DeleteContactEvaluationAsync(const DeleteContactEvaluationRequestT& request,
                                    const DeleteContactEvaluationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteContactFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteContactFlow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteContactFlowRequestT = Model::DeleteContactFlowRequest>
  void DeleteContactFlowAsync(const DeleteContactFlowRequestT& request, const DeleteContactFlowResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteContactFlowModule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteContactFlowModule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteContactFlowModuleRequestT = Model::DeleteContactFlowModuleRequest>
  void DeleteContactFlowModuleAsync(const DeleteContactFlowModuleRequestT& request,
                                    const DeleteContactFlowModuleResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteContactFlowVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteContactFlowVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteContactFlowVersionRequestT = Model::DeleteContactFlowVersionRequest>
  void DeleteContactFlowVersionAsync(const DeleteContactFlowVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteEmailAddress that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteEmailAddressRequestT = Model::DeleteEmailAddressRequest>
  Model::DeleteEmailAddressOutcomeCallable DeleteEmailAddressCallable(const DeleteEmailAddressRequestT& request) const {
    return SubmitCallable(&ConnectClient::DeleteEmailAddress, request);
  }

  /**
   * An Async wrapper for DeleteEmailAddress that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteEmailAddressRequestT = Model::DeleteEmailAddressRequest>
  void DeleteEmailAddressAsync(const DeleteEmailAddressRequestT& request, const DeleteEmailAddressResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::DeleteEmailAddress, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeleteEvaluationForm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEvaluationForm that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEvaluationFormRequestT = Model::DeleteEvaluationFormRequest>
  void DeleteEvaluationFormAsync(const DeleteEvaluationFormRequestT& request, const DeleteEvaluationFormResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteHoursOfOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteHoursOfOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteHoursOfOperationRequestT = Model::DeleteHoursOfOperationRequest>
  void DeleteHoursOfOperationAsync(const DeleteHoursOfOperationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteHoursOfOperationOverrideOutcome DeleteHoursOfOperationOverride(
      const Model::DeleteHoursOfOperationOverrideRequest& request) const;

  /**
   * A Callable wrapper for DeleteHoursOfOperationOverride that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteHoursOfOperationOverrideRequestT = Model::DeleteHoursOfOperationOverrideRequest>
  Model::DeleteHoursOfOperationOverrideOutcomeCallable DeleteHoursOfOperationOverrideCallable(
      const DeleteHoursOfOperationOverrideRequestT& request) const {
    return SubmitCallable(&ConnectClient::DeleteHoursOfOperationOverride, request);
  }

  /**
   * An Async wrapper for DeleteHoursOfOperationOverride that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteHoursOfOperationOverrideRequestT = Model::DeleteHoursOfOperationOverrideRequest>
  void DeleteHoursOfOperationOverrideAsync(const DeleteHoursOfOperationOverrideRequestT& request,
                                           const DeleteHoursOfOperationOverrideResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteIntegrationAssociationOutcome DeleteIntegrationAssociation(
      const Model::DeleteIntegrationAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteIntegrationAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteIntegrationAssociationRequestT = Model::DeleteIntegrationAssociationRequest>
  Model::DeleteIntegrationAssociationOutcomeCallable DeleteIntegrationAssociationCallable(
      const DeleteIntegrationAssociationRequestT& request) const {
    return SubmitCallable(&ConnectClient::DeleteIntegrationAssociation, request);
  }

  /**
   * An Async wrapper for DeleteIntegrationAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteIntegrationAssociationRequestT = Model::DeleteIntegrationAssociationRequest>
  void DeleteIntegrationAssociationAsync(const DeleteIntegrationAssociationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeletePredefinedAttribute that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeletePredefinedAttributeRequestT = Model::DeletePredefinedAttributeRequest>
  Model::DeletePredefinedAttributeOutcomeCallable DeletePredefinedAttributeCallable(
      const DeletePredefinedAttributeRequestT& request) const {
    return SubmitCallable(&ConnectClient::DeletePredefinedAttribute, request);
  }

  /**
   * An Async wrapper for DeletePredefinedAttribute that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePredefinedAttributeRequestT = Model::DeletePredefinedAttributeRequest>
  void DeletePredefinedAttributeAsync(const DeletePredefinedAttributeRequestT& request,
                                      const DeletePredefinedAttributeResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeletePrompt that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePromptRequestT = Model::DeletePromptRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePushNotificationRegistrationOutcome DeletePushNotificationRegistration(
      const Model::DeletePushNotificationRegistrationRequest& request) const;

  /**
   * A Callable wrapper for DeletePushNotificationRegistration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeletePushNotificationRegistrationRequestT = Model::DeletePushNotificationRegistrationRequest>
  Model::DeletePushNotificationRegistrationOutcomeCallable DeletePushNotificationRegistrationCallable(
      const DeletePushNotificationRegistrationRequestT& request) const {
    return SubmitCallable(&ConnectClient::DeletePushNotificationRegistration, request);
  }

  /**
   * An Async wrapper for DeletePushNotificationRegistration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeletePushNotificationRegistrationRequestT = Model::DeletePushNotificationRegistrationRequest>
  void DeletePushNotificationRegistrationAsync(const DeletePushNotificationRegistrationRequestT& request,
                                               const DeletePushNotificationRegistrationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteQueue that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteQueueRequestT = Model::DeleteQueueRequest>
  void DeleteQueueAsync(const DeleteQueueRequestT& request, const DeleteQueueResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteQuickConnect that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteQuickConnect that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteQuickConnectRequestT = Model::DeleteQuickConnectRequest>
  void DeleteQuickConnectAsync(const DeleteQuickConnectRequestT& request, const DeleteQuickConnectResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteRoutingProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRoutingProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRoutingProfileRequestT = Model::DeleteRoutingProfileRequest>
  void DeleteRoutingProfileAsync(const DeleteRoutingProfileRequestT& request, const DeleteRoutingProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSecurityProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSecurityProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSecurityProfileRequestT = Model::DeleteSecurityProfileRequest>
  ...
  /**
   * A Callable wrapper for DeleteTaskTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTaskTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteTaskTemplateRequestT = Model::DeleteTaskTemplateRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteTrafficDistributionGroupOutcome DeleteTrafficDistributionGroup(
      const Model::DeleteTrafficDistributionGroupRequest& request) const;

  /**
   * A Callable wrapper for DeleteTrafficDistributionGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteTrafficDistributionGroupRequestT = Model::DeleteTrafficDistributionGroupRequest>
  Model::DeleteTrafficDistributionGroupOutcomeCallable DeleteTrafficDistributionGroupCallable(
      const DeleteTrafficDistributionGroupRequestT& request) const {
    return SubmitCallable(&ConnectClient::DeleteTrafficDistributionGroup, request);
  }

  /**
   * An Async wrapper for DeleteTrafficDistributionGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteTrafficDistributionGroupRequestT = Model::DeleteTrafficDistributionGroupRequest>
  void DeleteTrafficDistributionGroupAsync(const DeleteTrafficDistributionGroupRequestT& request,
                                           const DeleteTrafficDistributionGroupResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteUseCase that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteUseCaseRequestT = Model::DeleteUseCaseRequest>
  void DeleteUseCaseAsync(const DeleteUseCaseRequestT& request, const DeleteUseCaseResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteUserHierarchyGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteUserHierarchyGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteUserHierarchyGroupRequestT = Model::DeleteUserHierarchyGroupRequest>
  void DeleteUserHierarchyGroupAsync(const DeleteUserHierarchyGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteViewVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteViewVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteViewVersionRequestT = Model::DeleteViewVersionRequest>
  void DeleteViewVersionAsync(const DeleteViewVersionRequestT& request, const DeleteViewVersionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteVocabulary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteVocabulary that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteVocabularyRequestT = Model::DeleteVocabularyRequest>
  void DeleteVocabularyAsync(const DeleteVocabularyRequestT& request, const DeleteVocabularyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAgentStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAgentStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAgentStatusRequestT = Model::DescribeAgentStatusRequest>
  void DescribeAgentStatusAsync(const DescribeAgentStatusRequestT& request, const DescribeAgentStatusResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAuthenticationProfileOutcome DescribeAuthenticationProfile(
      const Model::DescribeAuthenticationProfileRequest& request) const;

  /**
   * A Callable wrapper for DescribeAuthenticationProfile that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAuthenticationProfileRequestT = Model::DescribeAuthenticationProfileRequest>
  Model::DescribeAuthenticationProfileOutcomeCallable DescribeAuthenticationProfileCallable(
      const DescribeAuthenticationProfileRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribeAuthenticationProfile, request);
  }

  /**
   * An Async wrapper for DescribeAuthenticationProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAuthenticationProfileRequestT = Model::DescribeAuthenticationProfileRequest>
  void DescribeAuthenticationProfileAsync(const DescribeAuthenticationProfileRequestT& request,
                                          const DescribeAuthenticationProfileResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeContactRequestT = Model::DescribeContactRequest>
  void DescribeContactAsync(const DescribeContactRequestT& request, const DescribeContactResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeContactEvaluation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeContactEvaluationRequestT = Model::DescribeContactEvaluationRequest>
  Model::DescribeContactEvaluationOutcomeCallable DescribeContactEvaluationCallable(
      const DescribeContactEvaluationRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribeContactEvaluation, request);
  }

  /**
   * An Async wrapper for DescribeContactEvaluation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeContactEvaluationRequestT = Model::DescribeContactEvaluationRequest>
  void DescribeContactEvaluationAsync(const DescribeContactEvaluationRequestT& request,
                                      const DescribeContactEvaluationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeContactFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeContactFlow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeContactFlowRequestT = Model::DescribeContactFlowRequest>
  void DescribeContactFlowAsync(const DescribeContactFlowRequestT& request, const DescribeContactFlowResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeContactFlowModule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeContactFlowModuleRequestT = Model::DescribeContactFlowModuleRequest>
  Model::DescribeContactFlowModuleOutcomeCallable DescribeContactFlowModuleCallable(
      const DescribeContactFlowModuleRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribeContactFlowModule, request);
  }

  /**
   * An Async wrapper for DescribeContactFlowModule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeContactFlowModuleRequestT = Model::DescribeContactFlowModuleRequest>
  void DescribeContactFlowModuleAsync(const DescribeContactFlowModuleRequestT& request,
                                      const DescribeContactFlowModuleResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEmailAddress that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeEmailAddressRequestT = Model::DescribeEmailAddressRequest>
  Model::DescribeEmailAddressOutcomeCallable DescribeEmailAddressCallable(const DescribeEmailAddressRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribeEmailAddress, request);
  }

  /**
   * An Async wrapper for DescribeEmailAddress that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEmailAddressRequestT = Model::DescribeEmailAddressRequest>
  void DescribeEmailAddressAsync(const DescribeEmailAddressRequestT& request, const DescribeEmailAddressResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::DescribeEmailAddress, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DescribeEvaluationForm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEvaluationForm that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEvaluationFormRequestT = Model::DescribeEvaluationFormRequest>
  void DescribeEvaluationFormAsync(const DescribeEvaluationFormRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeHoursOfOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeHoursOfOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeHoursOfOperationRequestT = Model::DescribeHoursOfOperationRequest>
  void DescribeHoursOfOperationAsync(const DescribeHoursOfOperationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeHoursOfOperationOverrideOutcome DescribeHoursOfOperationOverride(
      const Model::DescribeHoursOfOperationOverrideRequest& request) const;

  /**
   * A Callable wrapper for DescribeHoursOfOperationOverride that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeHoursOfOperationOverrideRequestT = Model::DescribeHoursOfOperationOverrideRequest>
  Model::DescribeHoursOfOperationOverrideOutcomeCallable DescribeHoursOfOperationOverrideCallable(
      const DescribeHoursOfOperationOverrideRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribeHoursOfOperationOverride, request);
  }

  /**
   * An Async wrapper for DescribeHoursOfOperationOverride that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeHoursOfOperationOverrideRequestT = Model::DescribeHoursOfOperationOverrideRequest>
  void DescribeHoursOfOperationOverrideAsync(const DescribeHoursOfOperationOverrideRequestT& request,
                                             const DescribeHoursOfOperationOverrideResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeInstanceRequestT = Model::DescribeInstanceRequest>
  void DescribeInstanceAsync(const DescribeInstanceRequestT& request, const DescribeInstanceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeInstanceAttribute that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeInstanceAttributeRequestT = Model::DescribeInstanceAttributeRequest>
  Model::DescribeInstanceAttributeOutcomeCallable DescribeInstanceAttributeCallable(
      const DescribeInstanceAttributeRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribeInstanceAttribute, request);
  }

  /**
   * An Async wrapper for DescribeInstanceAttribute that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstanceAttributeRequestT = Model::DescribeInstanceAttributeRequest>
  void DescribeInstanceAttributeAsync(const DescribeInstanceAttributeRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInstanceStorageConfigOutcome DescribeInstanceStorageConfig(
      const Model::DescribeInstanceStorageConfigRequest& request) const;

  /**
   * A Callable wrapper for DescribeInstanceStorageConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInstanceStorageConfigRequestT = Model::DescribeInstanceStorageConfigRequest>
  Model::DescribeInstanceStorageConfigOutcomeCallable DescribeInstanceStorageConfigCallable(
      const DescribeInstanceStorageConfigRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribeInstanceStorageConfig, request);
  }

  /**
   * An Async wrapper for DescribeInstanceStorageConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstanceStorageConfigRequestT = Model::DescribeInstanceStorageConfigRequest>
  void DescribeInstanceStorageConfigAsync(const DescribeInstanceStorageConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribePhoneNumber that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePhoneNumber that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePhoneNumberRequestT = Model::DescribePhoneNumberRequest>
  void DescribePhoneNumberAsync(const DescribePhoneNumberRequestT& request, const DescribePhoneNumberResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribePredefinedAttributeOutcome DescribePredefinedAttribute(
      const Model::DescribePredefinedAttributeRequest& request) const;

  /**
   * A Callable wrapper for DescribePredefinedAttribute that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribePredefinedAttributeRequestT = Model::DescribePredefinedAttributeRequest>
  Model::DescribePredefinedAttributeOutcomeCallable DescribePredefinedAttributeCallable(
      const DescribePredefinedAttributeRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribePredefinedAttribute, request);
  }

  /**
   * An Async wrapper for DescribePredefinedAttribute that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePredefinedAttributeRequestT = Model::DescribePredefinedAttributeRequest>
  void DescribePredefinedAttributeAsync(const DescribePredefinedAttributeRequestT& request,
                                        const DescribePredefinedAttributeResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribePrompt that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribePromptRequestT = Model::DescribePromptRequest>
  void DescribePromptAsync(const DescribePromptRequestT& request, const DescribePromptResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeQueue that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeQueueRequestT = Model::DescribeQueueRequest>
  void DescribeQueueAsync(const DescribeQueueRequestT& request, const DescribeQueueResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeQuickConnect that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeQuickConnect that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeQuickConnectRequestT = Model::DescribeQuickConnectRequest>
  void DescribeQuickConnectAsync(const DescribeQuickConnectRequestT& request, const DescribeQuickConnectResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeRoutingProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRoutingProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRoutingProfileRequestT = Model::DescribeRoutingProfileRequest>
  void DescribeRoutingProfileAsync(const DescribeRoutingProfileRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeSecurityProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSecurityProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSecurityProfileRequestT = Model::DescribeSecurityProfileRequest>
  void DescribeSecurityProfileAsync(const DescribeSecurityProfileRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTrafficDistributionGroupOutcome DescribeTrafficDistributionGroup(
      const Model::DescribeTrafficDistributionGroupRequest& request) const;

  /**
   * A Callable wrapper for DescribeTrafficDistributionGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeTrafficDistributionGroupRequestT = Model::DescribeTrafficDistributionGroupRequest>
  Model::DescribeTrafficDistributionGroupOutcomeCallable DescribeTrafficDistributionGroupCallable(
      const DescribeTrafficDistributionGroupRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribeTrafficDistributionGroup, request);
  }

  /**
   * An Async wrapper for DescribeTrafficDistributionGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeTrafficDistributionGroupRequestT = Model::DescribeTrafficDistributionGroupRequest>
  void DescribeTrafficDistributionGroupAsync(const DescribeTrafficDistributionGroupRequestT& request,
                                             const DescribeTrafficDistributionGroupResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeUserHierarchyGroupOutcome DescribeUserHierarchyGroup(
      const Model::DescribeUserHierarchyGroupRequest& request) const;

  /**
   * A Callable wrapper for DescribeUserHierarchyGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeUserHierarchyGroupRequestT = Model::DescribeUserHierarchyGroupRequest>
  Model::DescribeUserHierarchyGroupOutcomeCallable DescribeUserHierarchyGroupCallable(
      const DescribeUserHierarchyGroupRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribeUserHierarchyGroup, request);
  }

  /**
   * An Async wrapper for DescribeUserHierarchyGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeUserHierarchyGroupRequestT = Model::DescribeUserHierarchyGroupRequest>
  void DescribeUserHierarchyGroupAsync(const DescribeUserHierarchyGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeUserHierarchyStructureOutcome DescribeUserHierarchyStructure(
      const Model::DescribeUserHierarchyStructureRequest& request) const;

  /**
   * A Callable wrapper for DescribeUserHierarchyStructure that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeUserHierarchyStructureRequestT = Model::DescribeUserHierarchyStructureRequest>
  Model::DescribeUserHierarchyStructureOutcomeCallable DescribeUserHierarchyStructureCallable(
      const DescribeUserHierarchyStructureRequestT& request) const {
    return SubmitCallable(&ConnectClient::DescribeUserHierarchyStructure, request);
  }

  /**
   * An Async wrapper for DescribeUserHierarchyStructure that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeUserHierarchyStructureRequestT = Model::DescribeUserHierarchyStructureRequest>
  void DescribeUserHierarchyStructureAsync(const DescribeUserHierarchyStructureRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeView that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeViewRequestT = Model::DescribeViewRequest>
  void DescribeViewAsync(const DescribeViewRequestT& request, const DescribeViewResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeVocabulary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeVocabulary that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeVocabularyRequestT = Model::DescribeVocabularyRequest>
  void DescribeVocabularyAsync(const DescribeVocabularyRequestT& request, const DescribeVocabularyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateAnalyticsDataSetOutcome DisassociateAnalyticsDataSet(
      const Model::DisassociateAnalyticsDataSetRequest& request) const;

  /**
   * A Callable wrapper for DisassociateAnalyticsDataSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateAnalyticsDataSetRequestT = Model::DisassociateAnalyticsDataSetRequest>
  Model::DisassociateAnalyticsDataSetOutcomeCallable DisassociateAnalyticsDataSetCallable(
      const DisassociateAnalyticsDataSetRequestT& request) const {
    return SubmitCallable(&ConnectClient::DisassociateAnalyticsDataSet, request);
  }

  /**
   * An Async wrapper for DisassociateAnalyticsDataSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateAnalyticsDataSetRequestT = Model::DisassociateAnalyticsDataSetRequest>
  void DisassociateAnalyticsDataSetAsync(const DisassociateAnalyticsDataSetRequestT& request,
                                         const DisassociateAnalyticsDataSetResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisassociateApprovedOriginOutcome DisassociateApprovedOrigin(
      const Model::DisassociateApprovedOriginRequest& request) const;

  /**
   * A Callable wrapper for DisassociateApprovedOrigin that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateApprovedOriginRequestT = Model::DisassociateApprovedOriginRequest>
  Model::DisassociateApprovedOriginOutcomeCallable DisassociateApprovedOriginCallable(
      const DisassociateApprovedOriginRequestT& request) const {
    return SubmitCallable(&ConnectClient::DisassociateApprovedOrigin, request);
  }

  /**
   * An Async wrapper for DisassociateApprovedOrigin that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateApprovedOriginRequestT = Model::DisassociateApprovedOriginRequest>
  void DisassociateApprovedOriginAsync(const DisassociateApprovedOriginRequestT& request,
  ...
  /**
   * An Async wrapper for DisassociateBot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisassociateBotRequestT = Model::DisassociateBotRequest>
  void DisassociateBotAsync(const DisassociateBotRequestT& request, const DisassociateBotResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateEmailAddressAliasOutcome DisassociateEmailAddressAlias(
      const Model::DisassociateEmailAddressAliasRequest& request) const;

  /**
   * A Callable wrapper for DisassociateEmailAddressAlias that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateEmailAddressAliasRequestT = Model::DisassociateEmailAddressAliasRequest>
  Model::DisassociateEmailAddressAliasOutcomeCallable DisassociateEmailAddressAliasCallable(
      const DisassociateEmailAddressAliasRequestT& request) const {
    return SubmitCallable(&ConnectClient::DisassociateEmailAddressAlias, request);
  }

  /**
   * An Async wrapper for DisassociateEmailAddressAlias that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateEmailAddressAliasRequestT = Model::DisassociateEmailAddressAliasRequest>
  void DisassociateEmailAddressAliasAsync(const DisassociateEmailAddressAliasRequestT& request,
                                          const DisassociateEmailAddressAliasResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateFlow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateFlow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateFlowRequestT = Model::DisassociateFlowRequest>
  void DisassociateFlowAsync(const DisassociateFlowRequestT& request, const DisassociateFlowResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateInstanceStorageConfigOutcome DisassociateInstanceStorageConfig(
      const Model::DisassociateInstanceStorageConfigRequest& request) const;

  /**
   * A Callable wrapper for DisassociateInstanceStorageConfig that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateInstanceStorageConfigRequestT = Model::DisassociateInstanceStorageConfigRequest>
  Model::DisassociateInstanceStorageConfigOutcomeCallable DisassociateInstanceStorageConfigCallable(
      const DisassociateInstanceStorageConfigRequestT& request) const {
    return SubmitCallable(&ConnectClient::DisassociateInstanceStorageConfig, request);
  }

  /**
   * An Async wrapper for DisassociateInstanceStorageConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateInstanceStorageConfigRequestT = Model::DisassociateInstanceStorageConfigRequest>
  void DisassociateInstanceStorageConfigAsync(const DisassociateInstanceStorageConfigRequestT& request,
  ...
  virtual Model::DisassociateLambdaFunctionOutcome DisassociateLambdaFunction(
      const Model::DisassociateLambdaFunctionRequest& request) const;

  /**
   * A Callable wrapper for DisassociateLambdaFunction that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateLambdaFunctionRequestT = Model::DisassociateLambdaFunctionRequest>
  Model::DisassociateLambdaFunctionOutcomeCallable DisassociateLambdaFunctionCallable(
      const DisassociateLambdaFunctionRequestT& request) const {
    return SubmitCallable(&ConnectClient::DisassociateLambdaFunction, request);
  }

  /**
   * An Async wrapper for DisassociateLambdaFunction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateLambdaFunctionRequestT = Model::DisassociateLambdaFunctionRequest>
  void DisassociateLambdaFunctionAsync(const DisassociateLambdaFunctionRequestT& request,
  ...
  /**
   * A Callable wrapper for DisassociateLexBot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateLexBot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateLexBotRequestT = Model::DisassociateLexBotRequest>
  void DisassociateLexBotAsync(const DisassociateLexBotRequestT& request, const DisassociateLexBotResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociatePhoneNumberContactFlowOutcome DisassociatePhoneNumberContactFlow(
      const Model::DisassociatePhoneNumberContactFlowRequest& request) const;

  /**
   * A Callable wrapper for DisassociatePhoneNumberContactFlow that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociatePhoneNumberContactFlowRequestT = Model::DisassociatePhoneNumberContactFlowRequest>
  Model::DisassociatePhoneNumberContactFlowOutcomeCallable DisassociatePhoneNumberContactFlowCallable(
      const DisassociatePhoneNumberContactFlowRequestT& request) const {
    return SubmitCallable(&ConnectClient::DisassociatePhoneNumberContactFlow, request);
  }

  /**
   * An Async wrapper for DisassociatePhoneNumberContactFlow that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociatePhoneNumberContactFlowRequestT = Model::DisassociatePhoneNumberContactFlowRequest>
  void DisassociatePhoneNumberContactFlowAsync(const DisassociatePhoneNumberContactFlowRequestT& request,
                                               const DisassociatePhoneNumberContactFlowResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateQueueQuickConnectsOutcome DisassociateQueueQuickConnects(
      const Model::DisassociateQueueQuickConnectsRequest& request) const;

  /**
   * A Callable wrapper for DisassociateQueueQuickConnects that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateQueueQuickConnectsRequestT = Model::DisassociateQueueQuickConnectsRequest>
  Model::DisassociateQueueQuickConnectsOutcomeCallable DisassociateQueueQuickConnectsCallable(
      const DisassociateQueueQuickConnectsRequestT& request) const {
    return SubmitCallable(&ConnectClient::DisassociateQueueQuickConnects, request);
  }

  /**
   * An Async wrapper for DisassociateQueueQuickConnects that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateQueueQuickConnectsRequestT = Model::DisassociateQueueQuickConnectsRequest>
  void DisassociateQueueQuickConnectsAsync(const DisassociateQueueQuickConnectsRequestT& request,
  ...
  /**
   * <p>Disassociates a set of queues from a routing profile.</p> <p>Up to 10 queue
   * references can be disassociated in a single API call. More than 10 queue
   * references results in a single call results in an
   * InvalidParameterException.</p><p><h3>See Also:</h3>   <a
  ...
  virtual Model::DisassociateRoutingProfileQueuesOutcome DisassociateRoutingProfileQueues(
      const Model::DisassociateRoutingProfileQueuesRequest& request) const;

  /**
   * A Callable wrapper for DisassociateRoutingProfileQueues that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateRoutingProfileQueuesRequestT = Model::DisassociateRoutingProfileQueuesRequest>
  Model::DisassociateRoutingProfileQueuesOutcomeCallable DisassociateRoutingProfileQueuesCallable(
      const DisassociateRoutingProfileQueuesRequestT& request) const {
    return SubmitCallable(&ConnectClient::DisassociateRoutingProfileQueues, request);
  }

  /**
   * An Async wrapper for DisassociateRoutingProfileQueues that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateRoutingProfileQueuesRequestT = Model::DisassociateRoutingProfileQueuesRequest>
  void DisassociateRoutingProfileQueuesAsync(const DisassociateRoutingProfileQueuesRequestT& request,
  ...
  /**
   * A Callable wrapper for DisassociateSecurityKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateSecurityKey that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateSecurityKeyRequestT = Model::DisassociateSecurityKeyRequest>
  void DisassociateSecurityKeyAsync(const DisassociateSecurityKeyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateTrafficDistributionGroupUserOutcome DisassociateTrafficDistributionGroupUser(
      const Model::DisassociateTrafficDistributionGroupUserRequest& request) const;

  /**
   * A Callable wrapper for DisassociateTrafficDistributionGroupUser that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateTrafficDistributionGroupUserRequestT = Model::DisassociateTrafficDistributionGroupUserRequest>
  Model::DisassociateTrafficDistributionGroupUserOutcomeCallable DisassociateTrafficDistributionGroupUserCallable(
      const DisassociateTrafficDistributionGroupUserRequestT& request) const {
    return SubmitCallable(&ConnectClient::DisassociateTrafficDistributionGroupUser, request);
  }

  /**
   * An Async wrapper for DisassociateTrafficDistributionGroupUser that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateTrafficDistributionGroupUserRequestT = Model::DisassociateTrafficDistributionGroupUserRequest>
  void DisassociateTrafficDistributionGroupUserAsync(
      const DisassociateTrafficDistributionGroupUserRequestT& request,
      const DisassociateTrafficDistributionGroupUserResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateUserProficienciesOutcome DisassociateUserProficiencies(
      const Model::DisassociateUserProficienciesRequest& request) const;

  /**
   * A Callable wrapper for DisassociateUserProficiencies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateUserProficienciesRequestT = Model::DisassociateUserProficienciesRequest>
  Model::DisassociateUserProficienciesOutcomeCallable DisassociateUserProficienciesCallable(
      const DisassociateUserProficienciesRequestT& request) const {
    return SubmitCallable(&ConnectClient::DisassociateUserProficiencies, request);
  }

  /**
   * An Async wrapper for DisassociateUserProficiencies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateUserProficienciesRequestT = Model::DisassociateUserProficienciesRequest>
  void DisassociateUserProficienciesAsync(const DisassociateUserProficienciesRequestT& request,
                                          const DisassociateUserProficienciesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DismissUserContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DismissUserContact that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DismissUserContactRequestT = Model::DismissUserContactRequest>
  ...
  /**
   * An Async wrapper for GetAttachedFile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAttachedFileRequestT = Model::GetAttachedFileRequest>
  void GetAttachedFileAsync(const GetAttachedFileRequestT& request, const GetAttachedFileResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetContactAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetContactAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetContactAttributesRequestT = Model::GetContactAttributesRequest>
  void GetContactAttributesAsync(const GetContactAttributesRequestT& request, const GetContactAttributesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetContactMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetContactMetrics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetContactMetricsRequestT = Model::GetContactMetricsRequest>
  void GetContactMetricsAsync(const GetContactMetricsRequestT& request, const GetContactMetricsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCurrentMetricData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCurrentMetricData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCurrentMetricDataRequestT = Model::GetCurrentMetricDataRequest>
  void GetCurrentMetricDataAsync(const GetCurrentMetricDataRequestT& request, const GetCurrentMetricDataResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCurrentUserData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCurrentUserData that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCurrentUserDataRequestT = Model::GetCurrentUserDataRequest>
  void GetCurrentUserDataAsync(const GetCurrentUserDataRequestT& request, const GetCurrentUserDataResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetEffectiveHoursOfOperationsOutcome GetEffectiveHoursOfOperations(
      const Model::GetEffectiveHoursOfOperationsRequest& request) const;

  /**
   * A Callable wrapper for GetEffectiveHoursOfOperations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetEffectiveHoursOfOperationsRequestT = Model::GetEffectiveHoursOfOperationsRequest>
  Model::GetEffectiveHoursOfOperationsOutcomeCallable GetEffectiveHoursOfOperationsCallable(
      const GetEffectiveHoursOfOperationsRequestT& request) const {
    return SubmitCallable(&ConnectClient::GetEffectiveHoursOfOperations, request);
  }

  /**
   * An Async wrapper for GetEffectiveHoursOfOperations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEffectiveHoursOfOperationsRequestT = Model::GetEffectiveHoursOfOperationsRequest>
  void GetEffectiveHoursOfOperationsAsync(const GetEffectiveHoursOfOperationsRequestT& request,
                                          const GetEffectiveHoursOfOperationsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFederationToken that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFederationToken that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetFederationTokenRequestT = Model::GetFederationTokenRequest>
  void GetFederationTokenAsync(const GetFederationTokenRequestT& request, const GetFederationTokenResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFlowAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFlowAssociation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetFlowAssociationRequestT = Model::GetFlowAssociationRequest>
  void GetFlowAssociationAsync(const GetFlowAssociationRequestT& request, const GetFlowAssociationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMetricData that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMetricDataRequestT = Model::GetMetricDataRequest>
  void GetMetricDataAsync(const GetMetricDataRequestT& request, const GetMetricDataResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMetricDataV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMetricDataV2RequestT = Model::GetMetricDataV2Request>
  void GetMetricDataV2Async(const GetMetricDataV2RequestT& request, const GetMetricDataV2ResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetPromptFile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPromptFileRequestT = Model::GetPromptFileRequest>
  void GetPromptFileAsync(const GetPromptFileRequestT& request, const GetPromptFileResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTaskTemplate that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTaskTemplateRequestT = Model::GetTaskTemplateRequest>
  ...
  /**
   * A Callable wrapper for GetTrafficDistribution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTrafficDistribution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTrafficDistributionRequestT = Model::GetTrafficDistributionRequest>
  void GetTrafficDistributionAsync(const GetTrafficDistributionRequestT& request,
                                   const GetTrafficDistributionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * numbers frequently, contact us for a service quota exception. Otherwise, it is
   * possible you will be blocked from claiming and releasing any more numbers until
   * up to 180 days past the oldest number released has expired. </p> <p> By default
   * you can claim or import and then release up to 200% of your maximum number of
   * active phone numbers. If you claim or import and then release phone numbers
   * using the UI or API during a rolling 180 day cycle that exceeds 200% of your
   * phone number service level quota, you will be blocked from claiming or importing
   * any more numbers until 180 days past the oldest number released has expired.
   * </p> <p>For example, if you already have 99 claimed or imported numbers and a
  ...
  /**
   * A Callable wrapper for ImportPhoneNumber that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportPhoneNumber that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ImportPhoneNumberRequestT = Model::ImportPhoneNumberRequest>
  void ImportPhoneNumberAsync(const ImportPhoneNumberRequestT& request, const ImportPhoneNumberResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAgentStatuses that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAgentStatuses that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAgentStatusesRequestT = Model::ListAgentStatusesRequest>
  void ListAgentStatusesAsync(const ListAgentStatusesRequestT& request, const ListAgentStatusesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAnalyticsDataAssociationsOutcome ListAnalyticsDataAssociations(
      const Model::ListAnalyticsDataAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListAnalyticsDataAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAnalyticsDataAssociationsRequestT = Model::ListAnalyticsDataAssociationsRequest>
  Model::ListAnalyticsDataAssociationsOutcomeCallable ListAnalyticsDataAssociationsCallable(
      const ListAnalyticsDataAssociationsRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListAnalyticsDataAssociations, request);
  }

  /**
   * An Async wrapper for ListAnalyticsDataAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnalyticsDataAssociationsRequestT = Model::ListAnalyticsDataAssociationsRequest>
  void ListAnalyticsDataAssociationsAsync(const ListAnalyticsDataAssociationsRequestT& request,
                                          const ListAnalyticsDataAssociationsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAnalyticsDataLakeDataSetsOutcome ListAnalyticsDataLakeDataSets(
      const Model::ListAnalyticsDataLakeDataSetsRequest& request) const;

  /**
   * A Callable wrapper for ListAnalyticsDataLakeDataSets that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAnalyticsDataLakeDataSetsRequestT = Model::ListAnalyticsDataLakeDataSetsRequest>
  Model::ListAnalyticsDataLakeDataSetsOutcomeCallable ListAnalyticsDataLakeDataSetsCallable(
      const ListAnalyticsDataLakeDataSetsRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListAnalyticsDataLakeDataSets, request);
  }

  /**
   * An Async wrapper for ListAnalyticsDataLakeDataSets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnalyticsDataLakeDataSetsRequestT = Model::ListAnalyticsDataLakeDataSetsRequest>
  void ListAnalyticsDataLakeDataSetsAsync(const ListAnalyticsDataLakeDataSetsRequestT& request,
                                          const ListAnalyticsDataLakeDataSetsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListApprovedOrigins that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListApprovedOrigins that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListApprovedOriginsRequestT = Model::ListApprovedOriginsRequest>
  void ListApprovedOriginsAsync(const ListApprovedOriginsRequestT& request, const ListApprovedOriginsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAssociatedContacts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListAssociatedContactsRequestT = Model::ListAssociatedContactsRequest>
  Model::ListAssociatedContactsOutcomeCallable ListAssociatedContactsCallable(const ListAssociatedContactsRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListAssociatedContacts, request);
  }

  /**
   * An Async wrapper for ListAssociatedContacts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssociatedContactsRequestT = Model::ListAssociatedContactsRequest>
  void ListAssociatedContactsAsync(const ListAssociatedContactsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAuthenticationProfilesOutcome ListAuthenticationProfiles(
      const Model::ListAuthenticationProfilesRequest& request) const;

  /**
   * A Callable wrapper for ListAuthenticationProfiles that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAuthenticationProfilesRequestT = Model::ListAuthenticationProfilesRequest>
  Model::ListAuthenticationProfilesOutcomeCallable ListAuthenticationProfilesCallable(
      const ListAuthenticationProfilesRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListAuthenticationProfiles, request);
  }

  /**
   * An Async wrapper for ListAuthenticationProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAuthenticationProfilesRequestT = Model::ListAuthenticationProfilesRequest>
  void ListAuthenticationProfilesAsync(const ListAuthenticationProfilesRequestT& request,
                                       const ListAuthenticationProfilesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListContactEvaluations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListContactEvaluations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListContactEvaluationsRequestT = Model::ListContactEvaluationsRequest>
  void ListContactEvaluationsAsync(const ListContactEvaluationsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListContactFlowModules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListContactFlowModules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListContactFlowModulesRequestT = Model::ListContactFlowModulesRequest>
  void ListContactFlowModulesAsync(const ListContactFlowModulesRequestT& request,
                                   const ListContactFlowModulesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListContactFlowVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListContactFlowVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListContactFlowVersionsRequestT = Model::ListContactFlowVersionsRequest>
  void ListContactFlowVersionsAsync(const ListContactFlowVersionsRequestT& request,
                                    const ListContactFlowVersionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListContactFlows that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListContactFlows that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListContactFlowsRequestT = Model::ListContactFlowsRequest>
  void ListContactFlowsAsync(const ListContactFlowsRequestT& request, const ListContactFlowsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListContactReferences that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListContactReferences that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListContactReferencesRequestT = Model::ListContactReferencesRequest>
  void ListContactReferencesAsync(const ListContactReferencesRequestT& request, const ListContactReferencesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDefaultVocabularies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDefaultVocabularies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDefaultVocabulariesRequestT = Model::ListDefaultVocabulariesRequest>
  void ListDefaultVocabulariesAsync(const ListDefaultVocabulariesRequestT& request,
  ...
  virtual Model::ListEvaluationFormVersionsOutcome ListEvaluationFormVersions(
      const Model::ListEvaluationFormVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListEvaluationFormVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListEvaluationFormVersionsRequestT = Model::ListEvaluationFormVersionsRequest>
  Model::ListEvaluationFormVersionsOutcomeCallable ListEvaluationFormVersionsCallable(
      const ListEvaluationFormVersionsRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListEvaluationFormVersions, request);
  }

  /**
   * An Async wrapper for ListEvaluationFormVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEvaluationFormVersionsRequestT = Model::ListEvaluationFormVersionsRequest>
  void ListEvaluationFormVersionsAsync(const ListEvaluationFormVersionsRequestT& request,
                                       const ListEvaluationFormVersionsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEvaluationForms that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEvaluationForms that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEvaluationFormsRequestT = Model::ListEvaluationFormsRequest>
  void ListEvaluationFormsAsync(const ListEvaluationFormsRequestT& request, const ListEvaluationFormsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListFlowAssociations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFlowAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFlowAssociationsRequestT = Model::ListFlowAssociationsRequest>
  void ListFlowAssociationsAsync(const ListFlowAssociationsRequestT& request, const ListFlowAssociationsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListHoursOfOperationOverridesOutcome ListHoursOfOperationOverrides(
      const Model::ListHoursOfOperationOverridesRequest& request) const;

  /**
   * A Callable wrapper for ListHoursOfOperationOverrides that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListHoursOfOperationOverridesRequestT = Model::ListHoursOfOperationOverridesRequest>
  Model::ListHoursOfOperationOverridesOutcomeCallable ListHoursOfOperationOverridesCallable(
      const ListHoursOfOperationOverridesRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListHoursOfOperationOverrides, request);
  }

  /**
   * An Async wrapper for ListHoursOfOperationOverrides that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListHoursOfOperationOverridesRequestT = Model::ListHoursOfOperationOverridesRequest>
  void ListHoursOfOperationOverridesAsync(const ListHoursOfOperationOverridesRequestT& request,
                                          const ListHoursOfOperationOverridesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListHoursOfOperations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListHoursOfOperations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListHoursOfOperationsRequestT = Model::ListHoursOfOperationsRequest>
  void ListHoursOfOperationsAsync(const ListHoursOfOperationsRequestT& request, const ListHoursOfOperationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListInstanceAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInstanceAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInstanceAttributesRequestT = Model::ListInstanceAttributesRequest>
  void ListInstanceAttributesAsync(const ListInstanceAttributesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListInstanceStorageConfigsOutcome ListInstanceStorageConfigs(
      const Model::ListInstanceStorageConfigsRequest& request) const;

  /**
   * A Callable wrapper for ListInstanceStorageConfigs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListInstanceStorageConfigsRequestT = Model::ListInstanceStorageConfigsRequest>
  Model::ListInstanceStorageConfigsOutcomeCallable ListInstanceStorageConfigsCallable(
      const ListInstanceStorageConfigsRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListInstanceStorageConfigs, request);
  }

  /**
   * An Async wrapper for ListInstanceStorageConfigs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInstanceStorageConfigsRequestT = Model::ListInstanceStorageConfigsRequest>
  void ListInstanceStorageConfigsAsync(const ListInstanceStorageConfigsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListIntegrationAssociationsOutcome ListIntegrationAssociations(
      const Model::ListIntegrationAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListIntegrationAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListIntegrationAssociationsRequestT = Model::ListIntegrationAssociationsRequest>
  Model::ListIntegrationAssociationsOutcomeCallable ListIntegrationAssociationsCallable(
      const ListIntegrationAssociationsRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListIntegrationAssociations, request);
  }

  /**
   * An Async wrapper for ListIntegrationAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIntegrationAssociationsRequestT = Model::ListIntegrationAssociationsRequest>
  void ListIntegrationAssociationsAsync(const ListIntegrationAssociationsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListLambdaFunctions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLambdaFunctions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListLambdaFunctionsRequestT = Model::ListLambdaFunctionsRequest>
  void ListLambdaFunctionsAsync(const ListLambdaFunctionsRequestT& request, const ListLambdaFunctionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListLexBots that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLexBotsRequestT = Model::ListLexBotsRequest>
  void ListLexBotsAsync(const ListLexBotsRequestT& request, const ListLexBotsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPhoneNumbers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPhoneNumbers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPhoneNumbersRequestT = Model::ListPhoneNumbersRequest>
  void ListPhoneNumbersAsync(const ListPhoneNumbersRequestT& request, const ListPhoneNumbersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPhoneNumbersV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPhoneNumbersV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPhoneNumbersV2RequestT = Model::ListPhoneNumbersV2Request>
  void ListPhoneNumbersV2Async(const ListPhoneNumbersV2ResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListPhoneNumbersV2RequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPredefinedAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPredefinedAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPredefinedAttributesRequestT = Model::ListPredefinedAttributesRequest>
  void ListPredefinedAttributesAsync(const ListPredefinedAttributesRequestT& request,
                                     const ListPredefinedAttributesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListPrompts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPromptsRequestT = Model::ListPromptsRequest>
  void ListPromptsAsync(const ListPromptsRequestT& request, const ListPromptsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListQueueQuickConnects that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListQueueQuickConnects that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListQueueQuickConnectsRequestT = Model::ListQueueQuickConnectsRequest>
  void ListQueueQuickConnectsAsync(const ListQueueQuickConnectsRequestT& request,
  ...
  /**
   * An Async wrapper for ListQueues that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListQueuesRequestT = Model::ListQueuesRequest>
  void ListQueuesAsync(const ListQueuesRequestT& request, const ListQueuesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListQuickConnects that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListQuickConnects that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListQuickConnectsRequestT = Model::ListQuickConnectsRequest>
  void ListQuickConnectsAsync(const ListQuickConnectsRequestT& request, const ListQuickConnectsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRealtimeContactAnalysisSegmentsV2Outcome ListRealtimeContactAnalysisSegmentsV2(
      const Model::ListRealtimeContactAnalysisSegmentsV2Request& request) const;

  /**
   * A Callable wrapper for ListRealtimeContactAnalysisSegmentsV2 that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListRealtimeContactAnalysisSegmentsV2RequestT = Model::ListRealtimeContactAnalysisSegmentsV2Request>
  Model::ListRealtimeContactAnalysisSegmentsV2OutcomeCallable ListRealtimeContactAnalysisSegmentsV2Callable(
      const ListRealtimeContactAnalysisSegmentsV2RequestT& request) const {
    return SubmitCallable(&ConnectClient::ListRealtimeContactAnalysisSegmentsV2, request);
  }

  /**
   * An Async wrapper for ListRealtimeContactAnalysisSegmentsV2 that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListRealtimeContactAnalysisSegmentsV2RequestT = Model::ListRealtimeContactAnalysisSegmentsV2Request>
  void ListRealtimeContactAnalysisSegmentsV2Async(const ListRealtimeContactAnalysisSegmentsV2RequestT& request,
                                                  const ListRealtimeContactAnalysisSegmentsV2ResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRoutingProfileManualAssignmentQueuesOutcome ListRoutingProfileManualAssignmentQueues(
      const Model::ListRoutingProfileManualAssignmentQueuesRequest& request) const;

  /**
   * A Callable wrapper for ListRoutingProfileManualAssignmentQueues that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListRoutingProfileManualAssignmentQueuesRequestT = Model::ListRoutingProfileManualAssignmentQueuesRequest>
  Model::ListRoutingProfileManualAssignmentQueuesOutcomeCallable ListRoutingProfileManualAssignmentQueuesCallable(
      const ListRoutingProfileManualAssignmentQueuesRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListRoutingProfileManualAssignmentQueues, request);
  }

  /**
   * An Async wrapper for ListRoutingProfileManualAssignmentQueues that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListRoutingProfileManualAssignmentQueuesRequestT = Model::ListRoutingProfileManualAssignmentQueuesRequest>
  void ListRoutingProfileManualAssignmentQueuesAsync(
      const ListRoutingProfileManualAssignmentQueuesRequestT& request,
      const ListRoutingProfileManualAssignmentQueuesResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRoutingProfileQueues that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRoutingProfileQueues that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRoutingProfileQueuesRequestT = Model::ListRoutingProfileQueuesRequest>
  void ListRoutingProfileQueuesAsync(const ListRoutingProfileQueuesRequestT& request,
  ...
  /**
   * A Callable wrapper for ListRoutingProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRoutingProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRoutingProfilesRequestT = Model::ListRoutingProfilesRequest>
  void ListRoutingProfilesAsync(const ListRoutingProfilesRequestT& request, const ListRoutingProfilesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListRulesRequestT = Model::ListRulesRequest>
  void ListRulesAsync(const ListRulesRequestT& request, const ListRulesResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSecurityKeys that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSecurityKeys that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSecurityKeysRequestT = Model::ListSecurityKeysRequest>
  void ListSecurityKeysAsync(const ListSecurityKeysRequestT& request, const ListSecurityKeysResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSecurityProfileApplicationsOutcome ListSecurityProfileApplications(
      const Model::ListSecurityProfileApplicationsRequest& request) const;

  /**
   * A Callable wrapper for ListSecurityProfileApplications that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSecurityProfileApplicationsRequestT = Model::ListSecurityProfileApplicationsRequest>
  Model::ListSecurityProfileApplicationsOutcomeCallable ListSecurityProfileApplicationsCallable(
      const ListSecurityProfileApplicationsRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListSecurityProfileApplications, request);
  }

  /**
   * An Async wrapper for ListSecurityProfileApplications that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListSecurityProfileApplicationsRequestT = Model::ListSecurityProfileApplicationsRequest>
  void ListSecurityProfileApplicationsAsync(const ListSecurityProfileApplicationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSecurityProfilePermissionsOutcome ListSecurityProfilePermissions(
      const Model::ListSecurityProfilePermissionsRequest& request) const;

  /**
   * A Callable wrapper for ListSecurityProfilePermissions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSecurityProfilePermissionsRequestT = Model::ListSecurityProfilePermissionsRequest>
  Model::ListSecurityProfilePermissionsOutcomeCallable ListSecurityProfilePermissionsCallable(
      const ListSecurityProfilePermissionsRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListSecurityProfilePermissions, request);
  }

  /**
   * An Async wrapper for ListSecurityProfilePermissions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListSecurityProfilePermissionsRequestT = Model::ListSecurityProfilePermissionsRequest>
  void ListSecurityProfilePermissionsAsync(const ListSecurityProfilePermissionsRequestT& request,
                                           const ListSecurityProfilePermissionsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSecurityProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSecurityProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSecurityProfilesRequestT = Model::ListSecurityProfilesRequest>
  void ListSecurityProfilesAsync(const ListSecurityProfilesRequestT& request, const ListSecurityProfilesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTaskTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTaskTemplates that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTaskTemplatesRequestT = Model::ListTaskTemplatesRequest>
  void ListTaskTemplatesAsync(const ListTaskTemplatesRequestT& request, const ListTaskTemplatesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTrafficDistributionGroupUsersOutcome ListTrafficDistributionGroupUsers(
      const Model::ListTrafficDistributionGroupUsersRequest& request) const;

  /**
   * A Callable wrapper for ListTrafficDistributionGroupUsers that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListTrafficDistributionGroupUsersRequestT = Model::ListTrafficDistributionGroupUsersRequest>
  Model::ListTrafficDistributionGroupUsersOutcomeCallable ListTrafficDistributionGroupUsersCallable(
      const ListTrafficDistributionGroupUsersRequestT& request) const {
    return SubmitCallable(&ConnectClient::ListTrafficDistributionGroupUsers, request);
  }

  /**
   * An Async wrapper for ListTrafficDistributionGroupUsers that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListTrafficDistributionGroupUsersRequestT = Model::ListTrafficDistributionGroupUsersRequest>
  void ListTrafficDistributionGroupUsersAsync(const ListTrafficDistributionGroupUsersRequestT& request,
                                              const ListTrafficDistributionGroupUsersResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTrafficDistributionGroupsOutcome ListTrafficDistributionGroups(
      const Model::ListTrafficDistributionGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListTrafficDistributionGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListTrafficDistributionGroupsRequestT = Model::ListTrafficDistributionGroupsRequest>
  Model::ListTrafficDistributionGroupsOutcomeCallable ListTrafficDistributionGroupsCallable(
      const ListTrafficDistributionGroupsRequestT& request = {}) const {
    return SubmitCallable(&ConnectClient::ListTrafficDistributionGroups, request);
  }

  /**
   * An Async wrapper for ListTrafficDistributionGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTrafficDistributionGroupsRequestT = Model::ListTrafficDistributionGroupsRequest>
  void ListTrafficDistributionGroupsAsync(const ListTrafficDistributionGroupsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListTrafficDistributionGroupsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListUseCases that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListUseCasesRequestT = Model::ListUseCasesRequest>
  void ListUseCasesAsync(const ListUseCasesRequestT& request, const ListUseCasesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListUserHierarchyGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListUserHierarchyGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListUserHierarchyGroupsRequestT = Model::ListUserHierarchyGroupsRequest>
  void ListUserHierarchyGroupsAsync(const ListUserHierarchyGroupsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListUserProficiencies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListUserProficiencies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListUserProficienciesRequestT = Model::ListUserProficienciesRequest>
  void ListUserProficienciesAsync(const ListUserProficienciesRequestT& request, const ListUserProficienciesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListViewVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListViewVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListViewVersionsRequestT = Model::ListViewVersionsRequest>
  void ListViewVersionsAsync(const ListViewVersionsRequestT& request, const ListViewVersionsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for MonitorContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename MonitorContactRequestT = Model::MonitorContactRequest>
  void MonitorContactAsync(const MonitorContactRequestT& request, const MonitorContactResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PauseContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PauseContactRequestT = Model::PauseContactRequest>
  void PauseContactAsync(const PauseContactRequestT& request, const PauseContactResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutUserStatus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutUserStatusRequestT = Model::PutUserStatusRequest>
  void PutUserStatusAsync(const PutUserStatusRequestT& request, const PutUserStatusResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ReleasePhoneNumber that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ReleasePhoneNumber that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ReleasePhoneNumberRequestT = Model::ReleasePhoneNumberRequest>
  void ReleasePhoneNumberAsync(const ReleasePhoneNumberRequestT& request, const ReleasePhoneNumberResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ReplicateInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ReplicateInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ReplicateInstanceRequestT = Model::ReplicateInstanceRequest>
  void ReplicateInstanceAsync(const ReplicateInstanceRequestT& request, const ReplicateInstanceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ResumeContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResumeContactRequestT = Model::ResumeContactRequest>
  void ResumeContactAsync(const ResumeContactRequestT& request, const ResumeContactResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ResumeContactRecording that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResumeContactRecording that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResumeContactRecordingRequestT = Model::ResumeContactRecordingRequest>
  void ResumeContactRecordingAsync(const ResumeContactRecordingRequestT& request,
  ...
  /**
   * A Callable wrapper for SearchAgentStatuses that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchAgentStatuses that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SearchAgentStatusesRequestT = Model::SearchAgentStatusesRequest>
  void SearchAgentStatusesAsync(const SearchAgentStatusesRequestT& request, const SearchAgentStatusesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SearchAvailablePhoneNumbersOutcome SearchAvailablePhoneNumbers(
      const Model::SearchAvailablePhoneNumbersRequest& request) const;

  /**
   * A Callable wrapper for SearchAvailablePhoneNumbers that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SearchAvailablePhoneNumbersRequestT = Model::SearchAvailablePhoneNumbersRequest>
  Model::SearchAvailablePhoneNumbersOutcomeCallable SearchAvailablePhoneNumbersCallable(
      const SearchAvailablePhoneNumbersRequestT& request) const {
    return SubmitCallable(&ConnectClient::SearchAvailablePhoneNumbers, request);
  }

  /**
   * An Async wrapper for SearchAvailablePhoneNumbers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchAvailablePhoneNumbersRequestT = Model::SearchAvailablePhoneNumbersRequest>
  void SearchAvailablePhoneNumbersAsync(const SearchAvailablePhoneNumbersRequestT& request,
                                        const SearchAvailablePhoneNumbersResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * specific set of tags.</p> </li> </ul> <p> <b>Important things to know</b> </p>
  ...
  /**
   * A Callable wrapper for SearchContactEvaluations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SearchContactEvaluationsRequestT = Model::SearchContactEvaluationsRequest>
  Model::SearchContactEvaluationsOutcomeCallable SearchContactEvaluationsCallable(const SearchContactEvaluationsRequestT& request) const {
    return SubmitCallable(&ConnectClient::SearchContactEvaluations, request);
  }

  /**
   * An Async wrapper for SearchContactEvaluations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchContactEvaluationsRequestT = Model::SearchContactEvaluationsRequest>
  void SearchContactEvaluationsAsync(const SearchContactEvaluationsRequestT& request,
                                     const SearchContactEvaluationsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::SearchContactEvaluations, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for SearchContactFlowModules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchContactFlowModules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchContactFlowModulesRequestT = Model::SearchContactFlowModulesRequest>
  void SearchContactFlowModulesAsync(const SearchContactFlowModulesRequestT& request,
                                     const SearchContactFlowModulesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchContactFlows that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchContactFlows that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SearchContactFlowsRequestT = Model::SearchContactFlowsRequest>
  void SearchContactFlowsAsync(const SearchContactFlowsRequestT& request, const SearchContactFlowsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchContacts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchContactsRequestT = Model::SearchContactsRequest>
  void SearchContactsAsync(const SearchContactsRequestT& request, const SearchContactsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchEmailAddresses that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SearchEmailAddressesRequestT = Model::SearchEmailAddressesRequest>
  Model::SearchEmailAddressesOutcomeCallable SearchEmailAddressesCallable(const SearchEmailAddressesRequestT& request) const {
    return SubmitCallable(&ConnectClient::SearchEmailAddresses, request);
  }

  /**
   * An Async wrapper for SearchEmailAddresses that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchEmailAddressesRequestT = Model::SearchEmailAddressesRequest>
  void SearchEmailAddressesAsync(const SearchEmailAddressesRequestT& request, const SearchEmailAddressesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * Description, Status, and more.</p> </li> <li> <p>Find all evaluation forms that
   * are tagged with a specific set of tags.</p> </li> </ul> <p> <b>Important things
   * to know</b> </p> <ul> <li> <p>A Search operation, unlike a List operation, takes
  ...
  /**
   * A Callable wrapper for SearchEvaluationForms that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SearchEvaluationFormsRequestT = Model::SearchEvaluationFormsRequest>
  Model::SearchEvaluationFormsOutcomeCallable SearchEvaluationFormsCallable(const SearchEvaluationFormsRequestT& request) const {
    return SubmitCallable(&ConnectClient::SearchEvaluationForms, request);
  }

  /**
   * An Async wrapper for SearchEvaluationForms that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchEvaluationFormsRequestT = Model::SearchEvaluationFormsRequest>
  void SearchEvaluationFormsAsync(const SearchEvaluationFormsRequestT& request, const SearchEvaluationFormsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::SearchEvaluationForms, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::SearchHoursOfOperationOverridesOutcome SearchHoursOfOperationOverrides(
      const Model::SearchHoursOfOperationOverridesRequest& request) const;

  /**
   * A Callable wrapper for SearchHoursOfOperationOverrides that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SearchHoursOfOperationOverridesRequestT = Model::SearchHoursOfOperationOverridesRequest>
  Model::SearchHoursOfOperationOverridesOutcomeCallable SearchHoursOfOperationOverridesCallable(
      const SearchHoursOfOperationOverridesRequestT& request) const {
    return SubmitCallable(&ConnectClient::SearchHoursOfOperationOverrides, request);
  }

  /**
   * An Async wrapper for SearchHoursOfOperationOverrides that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SearchHoursOfOperationOverridesRequestT = Model::SearchHoursOfOperationOverridesRequest>
  void SearchHoursOfOperationOverridesAsync(const SearchHoursOfOperationOverridesRequestT& request,
                                            const SearchHoursOfOperationOverridesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchHoursOfOperations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchHoursOfOperations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchHoursOfOperationsRequestT = Model::SearchHoursOfOperationsRequest>
  void SearchHoursOfOperationsAsync(const SearchHoursOfOperationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SearchPredefinedAttributesOutcome SearchPredefinedAttributes(
      const Model::SearchPredefinedAttributesRequest& request) const;

  /**
   * A Callable wrapper for SearchPredefinedAttributes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SearchPredefinedAttributesRequestT = Model::SearchPredefinedAttributesRequest>
  Model::SearchPredefinedAttributesOutcomeCallable SearchPredefinedAttributesCallable(
      const SearchPredefinedAttributesRequestT& request) const {
    return SubmitCallable(&ConnectClient::SearchPredefinedAttributes, request);
  }

  /**
   * An Async wrapper for SearchPredefinedAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchPredefinedAttributesRequestT = Model::SearchPredefinedAttributesRequest>
  void SearchPredefinedAttributesAsync(const SearchPredefinedAttributesRequestT& request,
                                       const SearchPredefinedAttributesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchPrompts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchPromptsRequestT = Model::SearchPromptsRequest>
  void SearchPromptsAsync(const SearchPromptsRequestT& request, const SearchPromptsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchQueues that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchQueuesRequestT = Model::SearchQueuesRequest>
  void SearchQueuesAsync(const SearchQueuesRequestT& request, const SearchQueuesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchQuickConnects that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchQuickConnects that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SearchQuickConnectsRequestT = Model::SearchQuickConnectsRequest>
  void SearchQuickConnectsAsync(const SearchQuickConnectsRequestT& request, const SearchQuickConnectsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchResourceTags that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchResourceTags that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SearchResourceTagsRequestT = Model::SearchResourceTagsRequest>
  void SearchResourceTagsAsync(const SearchResourceTagsRequestT& request, const SearchResourceTagsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchRoutingProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchRoutingProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchRoutingProfilesRequestT = Model::SearchRoutingProfilesRequest>
  ...
  /**
   * A Callable wrapper for SearchSecurityProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchSecurityProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchSecurityProfilesRequestT = Model::SearchSecurityProfilesRequest>
  void SearchSecurityProfilesAsync(const SearchSecurityProfilesRequestT& request,
                                   const SearchSecurityProfilesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchUserHierarchyGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SearchUserHierarchyGroupsRequestT = Model::SearchUserHierarchyGroupsRequest>
  Model::SearchUserHierarchyGroupsOutcomeCallable SearchUserHierarchyGroupsCallable(
      const SearchUserHierarchyGroupsRequestT& request) const {
    return SubmitCallable(&ConnectClient::SearchUserHierarchyGroups, request);
  }

  /**
   * An Async wrapper for SearchUserHierarchyGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchUserHierarchyGroupsRequestT = Model::SearchUserHierarchyGroupsRequest>
  void SearchUserHierarchyGroupsAsync(const SearchUserHierarchyGroupsRequestT& request,
                                      const SearchUserHierarchyGroupsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchVocabularies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchVocabularies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SearchVocabulariesRequestT = Model::SearchVocabulariesRequest>
  ...
  /**
   * A Callable wrapper for SendChatIntegrationEvent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendChatIntegrationEvent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendChatIntegrationEventRequestT = Model::SendChatIntegrationEventRequest>
  void SendChatIntegrationEventAsync(const SendChatIntegrationEventRequestT& request,
                                     const SendChatIntegrationEventResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendOutboundEmail that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SendOutboundEmailRequestT = Model::SendOutboundEmailRequest>
  Model::SendOutboundEmailOutcomeCallable SendOutboundEmailCallable(const SendOutboundEmailRequestT& request) const {
    return SubmitCallable(&ConnectClient::SendOutboundEmail, request);
  }

  /**
   * An Async wrapper for SendOutboundEmail that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SendOutboundEmailRequestT = Model::SendOutboundEmailRequest>
  ...
  /**
   * A Callable wrapper for StartAttachedFileUpload that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAttachedFileUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartAttachedFileUploadRequestT = Model::StartAttachedFileUploadRequest>
  void StartAttachedFileUploadAsync(const StartAttachedFileUploadRequestT& request,
                                    const StartAttachedFileUploadResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartChatContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartChatContact that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartChatContactRequestT = Model::StartChatContactRequest>
  ...
  /**
   * A Callable wrapper for StartContactEvaluation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartContactEvaluation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartContactEvaluationRequestT = Model::StartContactEvaluationRequest>
  void StartContactEvaluationAsync(const StartContactEvaluationRequestT& request,
  ...
  /**
   * A Callable wrapper for StartContactRecording that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartContactRecording that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartContactRecordingRequestT = Model::StartContactRecordingRequest>
  void StartContactRecordingAsync(const StartContactRecordingRequestT& request, const StartContactRecordingResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartContactStreaming that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartContactStreaming that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartContactStreamingRequestT = Model::StartContactStreamingRequest>
  void StartContactStreamingAsync(const StartContactStreamingRequestT& request, const StartContactStreamingResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartEmailContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartEmailContactRequestT = Model::StartEmailContactRequest>
  Model::StartEmailContactOutcomeCallable StartEmailContactCallable(const StartEmailContactRequestT& request) const {
    return SubmitCallable(&ConnectClient::StartEmailContact, request);
  }

  /**
   * An Async wrapper for StartEmailContact that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartEmailContactRequestT = Model::StartEmailContactRequest>
  ...
  /**
   * A Callable wrapper for StartOutboundChatContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::StartOutboundChatContactOutcomeCallable StartOutboundChatContactCallable(const StartOutboundChatContactRequestT& request) const {
    return SubmitCallable(&ConnectClient::StartOutboundChatContact, request);
  }

  /**
   * An Async wrapper for StartOutboundChatContact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartOutboundChatContactRequestT = Model::StartOutboundChatContactRequest>
  void StartOutboundChatContactAsync(const StartOutboundChatContactRequestT& request,
                                     const StartOutboundChatContactResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::StartOutboundChatContact, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for StartOutboundEmailContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartOutboundEmailContactRequestT = Model::StartOutboundEmailContactRequest>
  Model::StartOutboundEmailContactOutcomeCallable StartOutboundEmailContactCallable(
      const StartOutboundEmailContactRequestT& request) const {
    return SubmitCallable(&ConnectClient::StartOutboundEmailContact, request);
  }

  /**
   * An Async wrapper for StartOutboundEmailContact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartOutboundEmailContactRequestT = Model::StartOutboundEmailContactRequest>
  void StartOutboundEmailContactAsync(const StartOutboundEmailContactRequestT& request,
                                      const StartOutboundEmailContactResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::StartOutboundEmailContact, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for StartOutboundVoiceContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartOutboundVoiceContactRequestT = Model::StartOutboundVoiceContactRequest>
  Model::StartOutboundVoiceContactOutcomeCallable StartOutboundVoiceContactCallable(
      const StartOutboundVoiceContactRequestT& request) const {
    return SubmitCallable(&ConnectClient::StartOutboundVoiceContact, request);
  }

  /**
   * An Async wrapper for StartOutboundVoiceContact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartOutboundVoiceContactRequestT = Model::StartOutboundVoiceContactRequest>
  void StartOutboundVoiceContactAsync(const StartOutboundVoiceContactRequestT& request,
  ...
  /**
   * A Callable wrapper for StartScreenSharing that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartScreenSharing that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartScreenSharingRequestT = Model::StartScreenSharingRequest>
  void StartScreenSharingAsync(const StartScreenSharingRequestT& request, const StartScreenSharingResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartTaskContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartTaskContact that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartTaskContactRequestT = Model::StartTaskContactRequest>
  void StartTaskContactAsync(const StartTaskContactRequestT& request, const StartTaskContactResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartWebRTCContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartWebRTCContact that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartWebRTCContactRequestT = Model::StartWebRTCContactRequest>
  void StartWebRTCContactAsync(const StartWebRTCContactRequestT& request, const StartWebRTCContactResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <p>QUEUE_TRANSFER</p> </li> <li> <p>EXTERNAL_OUTBOUND</p> </li> <li>
   * <p>MONITOR</p> </li> </ul> <p>Chat and task contacts can be terminated in any
   * state, regardless of initiation method.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * An Async wrapper for StopContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopContactRequestT = Model::StopContactRequest>
  ...
  /**
   * A Callable wrapper for StopContactRecording that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopContactRecording that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopContactRecordingRequestT = Model::StopContactRecordingRequest>
  void StopContactRecordingAsync(const StopContactRecordingRequestT& request, const StopContactRecordingResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopContactStreaming that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopContactStreaming that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopContactStreamingRequestT = Model::StopContactStreamingRequest>
  ...
  /**
   * A Callable wrapper for SubmitContactEvaluation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SubmitContactEvaluation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SubmitContactEvaluationRequestT = Model::SubmitContactEvaluationRequest>
  void SubmitContactEvaluationAsync(const SubmitContactEvaluationRequestT& request,
                                    const SubmitContactEvaluationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SuspendContactRecording that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SuspendContactRecording that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SuspendContactRecordingRequestT = Model::SuspendContactRecordingRequest>
  void SuspendContactRecordingAsync(const SuspendContactRecordingRequestT& request,
  ...
  /**
   * An Async wrapper for TagContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TagContactRequestT = Model::TagContactRequest>
  void TagContactAsync(const TagContactRequestT& request, const TagContactResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TransferContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TransferContactRequestT = Model::TransferContactRequest>
  void TransferContactAsync(const TransferContactRequestT& request, const TransferContactResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UntagContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UntagContactRequestT = Model::UntagContactRequest>
  void UntagContactAsync(const UntagContactRequestT& request, const UntagContactResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAgentStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAgentStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAgentStatusRequestT = Model::UpdateAgentStatusRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAuthenticationProfileOutcome UpdateAuthenticationProfile(
      const Model::UpdateAuthenticationProfileRequest& request) const;

  /**
   * A Callable wrapper for UpdateAuthenticationProfile that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAuthenticationProfileRequestT = Model::UpdateAuthenticationProfileRequest>
  Model::UpdateAuthenticationProfileOutcomeCallable UpdateAuthenticationProfileCallable(
      const UpdateAuthenticationProfileRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateAuthenticationProfile, request);
  }

  /**
   * An Async wrapper for UpdateAuthenticationProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAuthenticationProfileRequestT = Model::UpdateAuthenticationProfileRequest>
  void UpdateAuthenticationProfileAsync(const UpdateAuthenticationProfileRequestT& request,
                                        const UpdateAuthenticationProfileResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateContactAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateContactAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContactAttributesRequestT = Model::UpdateContactAttributesRequest>
  void UpdateContactAttributesAsync(const UpdateContactAttributesRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateContactEvaluation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateContactEvaluation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContactEvaluationRequestT = Model::UpdateContactEvaluationRequest>
  void UpdateContactEvaluationAsync(const UpdateContactEvaluationRequestT& request,
                                    const UpdateContactEvaluationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateContactFlowContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateContactFlowContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContactFlowContentRequestT = Model::UpdateContactFlowContentRequest>
  void UpdateContactFlowContentAsync(const UpdateContactFlowContentRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateContactFlowMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateContactFlowMetadataRequestT = Model::UpdateContactFlowMetadataRequest>
  Model::UpdateContactFlowMetadataOutcomeCallable UpdateContactFlowMetadataCallable(
      const UpdateContactFlowMetadataRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateContactFlowMetadata, request);
  }

  /**
   * An Async wrapper for UpdateContactFlowMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContactFlowMetadataRequestT = Model::UpdateContactFlowMetadataRequest>
  void UpdateContactFlowMetadataAsync(const UpdateContactFlowMetadataRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateContactFlowModuleContentOutcome UpdateContactFlowModuleContent(
      const Model::UpdateContactFlowModuleContentRequest& request) const;

  /**
   * A Callable wrapper for UpdateContactFlowModuleContent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateContactFlowModuleContentRequestT = Model::UpdateContactFlowModuleContentRequest>
  Model::UpdateContactFlowModuleContentOutcomeCallable UpdateContactFlowModuleContentCallable(
      const UpdateContactFlowModuleContentRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateContactFlowModuleContent, request);
  }

  /**
   * An Async wrapper for UpdateContactFlowModuleContent that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateContactFlowModuleContentRequestT = Model::UpdateContactFlowModuleContentRequest>
  void UpdateContactFlowModuleContentAsync(const UpdateContactFlowModuleContentRequestT& request,
                                           const UpdateContactFlowModuleContentResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateContactFlowModuleMetadataOutcome UpdateContactFlowModuleMetadata(
      const Model::UpdateContactFlowModuleMetadataRequest& request) const;

  /**
   * A Callable wrapper for UpdateContactFlowModuleMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateContactFlowModuleMetadataRequestT = Model::UpdateContactFlowModuleMetadataRequest>
  Model::UpdateContactFlowModuleMetadataOutcomeCallable UpdateContactFlowModuleMetadataCallable(
      const UpdateContactFlowModuleMetadataRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateContactFlowModuleMetadata, request);
  }

  /**
   * An Async wrapper for UpdateContactFlowModuleMetadata that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateContactFlowModuleMetadataRequestT = Model::UpdateContactFlowModuleMetadataRequest>
  void UpdateContactFlowModuleMetadataAsync(const UpdateContactFlowModuleMetadataRequestT& request,
                                            const UpdateContactFlowModuleMetadataResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateContactFlowName that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateContactFlowName that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContactFlowNameRequestT = Model::UpdateContactFlowNameRequest>
  void UpdateContactFlowNameAsync(const UpdateContactFlowNameRequestT& request, const UpdateContactFlowNameResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::UpdateContactFlowName, request, handler, context);
  }

  /**
   * <p>Updates routing priority and age on the contact (<b>QueuePriority</b> and
   * <b>QueueTimeAdjustmentInSeconds</b>). These properties can be used to change a
   ...
   * Set routing priority / age flow block</a>.</p>  <p>Either
   * <b>QueuePriority</b> or <b>QueueTimeAdjustmentInSeconds</b> should be provided
   * within the request body, but not both.</p> <p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for UpdateContactRoutingData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateContactRoutingData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContactRoutingDataRequestT = Model::UpdateContactRoutingDataRequest>
  void UpdateContactRoutingDataAsync(const UpdateContactRoutingDataRequestT& request,
                                     const UpdateContactRoutingDataResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateContactSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateContactSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContactScheduleRequestT = Model::UpdateContactScheduleRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEmailAddressMetadataOutcome UpdateEmailAddressMetadata(
      const Model::UpdateEmailAddressMetadataRequest& request) const;

  /**
   * A Callable wrapper for UpdateEmailAddressMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateEmailAddressMetadataRequestT = Model::UpdateEmailAddressMetadataRequest>
  Model::UpdateEmailAddressMetadataOutcomeCallable UpdateEmailAddressMetadataCallable(
      const UpdateEmailAddressMetadataRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateEmailAddressMetadata, request);
  }

  /**
   * An Async wrapper for UpdateEmailAddressMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEmailAddressMetadataRequestT = Model::UpdateEmailAddressMetadataRequest>
  void UpdateEmailAddressMetadataAsync(const UpdateEmailAddressMetadataRequestT& request,
                                       const UpdateEmailAddressMetadataResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::UpdateEmailAddressMetadata, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for UpdateEvaluationForm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEvaluationForm that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEvaluationFormRequestT = Model::UpdateEvaluationFormRequest>
  ...
  /**
   * A Callable wrapper for UpdateHoursOfOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateHoursOfOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateHoursOfOperationRequestT = Model::UpdateHoursOfOperationRequest>
  void UpdateHoursOfOperationAsync(const UpdateHoursOfOperationRequestT& request,
  ...
  virtual Model::UpdateHoursOfOperationOverrideOutcome UpdateHoursOfOperationOverride(
      const Model::UpdateHoursOfOperationOverrideRequest& request) const;

  /**
   * A Callable wrapper for UpdateHoursOfOperationOverride that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateHoursOfOperationOverrideRequestT = Model::UpdateHoursOfOperationOverrideRequest>
  Model::UpdateHoursOfOperationOverrideOutcomeCallable UpdateHoursOfOperationOverrideCallable(
      const UpdateHoursOfOperationOverrideRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateHoursOfOperationOverride, request);
  }

  /**
   * An Async wrapper for UpdateHoursOfOperationOverride that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateHoursOfOperationOverrideRequestT = Model::UpdateHoursOfOperationOverrideRequest>
  void UpdateHoursOfOperationOverrideAsync(const UpdateHoursOfOperationOverrideRequestT& request,
                                           const UpdateHoursOfOperationOverrideResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateInstanceAttribute that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateInstanceAttribute that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateInstanceAttributeRequestT = Model::UpdateInstanceAttributeRequest>
  void UpdateInstanceAttributeAsync(const UpdateInstanceAttributeRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateInstanceStorageConfigOutcome UpdateInstanceStorageConfig(
      const Model::UpdateInstanceStorageConfigRequest& request) const;

  /**
   * A Callable wrapper for UpdateInstanceStorageConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateInstanceStorageConfigRequestT = Model::UpdateInstanceStorageConfigRequest>
  Model::UpdateInstanceStorageConfigOutcomeCallable UpdateInstanceStorageConfigCallable(
      const UpdateInstanceStorageConfigRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateInstanceStorageConfig, request);
  }

  /**
   * An Async wrapper for UpdateInstanceStorageConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateInstanceStorageConfigRequestT = Model::UpdateInstanceStorageConfigRequest>
  void UpdateInstanceStorageConfigAsync(const UpdateInstanceStorageConfigRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateParticipantAuthenticationOutcome UpdateParticipantAuthentication(
      const Model::UpdateParticipantAuthenticationRequest& request) const;

  /**
   * A Callable wrapper for UpdateParticipantAuthentication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateParticipantAuthenticationRequestT = Model::UpdateParticipantAuthenticationRequest>
  Model::UpdateParticipantAuthenticationOutcomeCallable UpdateParticipantAuthenticationCallable(
      const UpdateParticipantAuthenticationRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateParticipantAuthentication, request);
  }

  /**
   * An Async wrapper for UpdateParticipantAuthentication that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateParticipantAuthenticationRequestT = Model::UpdateParticipantAuthenticationRequest>
  void UpdateParticipantAuthenticationAsync(const UpdateParticipantAuthenticationRequestT& request,
                                            const UpdateParticipantAuthenticationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateParticipantRoleConfigOutcome UpdateParticipantRoleConfig(
      const Model::UpdateParticipantRoleConfigRequest& request) const;

  /**
   * A Callable wrapper for UpdateParticipantRoleConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateParticipantRoleConfigRequestT = Model::UpdateParticipantRoleConfigRequest>
  Model::UpdateParticipantRoleConfigOutcomeCallable UpdateParticipantRoleConfigCallable(
      const UpdateParticipantRoleConfigRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateParticipantRoleConfig, request);
  }

  /**
   * An Async wrapper for UpdateParticipantRoleConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateParticipantRoleConfigRequestT = Model::UpdateParticipantRoleConfigRequest>
  void UpdateParticipantRoleConfigAsync(const UpdateParticipantRoleConfigRequestT& request,
                                        const UpdateParticipantRoleConfigResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePhoneNumber that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePhoneNumber that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdatePhoneNumberRequestT = Model::UpdatePhoneNumberRequest>
  void UpdatePhoneNumberAsync(const UpdatePhoneNumberRequestT& request, const UpdatePhoneNumberResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePhoneNumberMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdatePhoneNumberMetadataRequestT = Model::UpdatePhoneNumberMetadataRequest>
  Model::UpdatePhoneNumberMetadataOutcomeCallable UpdatePhoneNumberMetadataCallable(
      const UpdatePhoneNumberMetadataRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdatePhoneNumberMetadata, request);
  }

  /**
   * An Async wrapper for UpdatePhoneNumberMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePhoneNumberMetadataRequestT = Model::UpdatePhoneNumberMetadataRequest>
  void UpdatePhoneNumberMetadataAsync(const UpdatePhoneNumberMetadataRequestT& request,
                                      const UpdatePhoneNumberMetadataResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePredefinedAttribute that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdatePredefinedAttributeRequestT = Model::UpdatePredefinedAttributeRequest>
  Model::UpdatePredefinedAttributeOutcomeCallable UpdatePredefinedAttributeCallable(
      const UpdatePredefinedAttributeRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdatePredefinedAttribute, request);
  }

  /**
   * An Async wrapper for UpdatePredefinedAttribute that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePredefinedAttributeRequestT = Model::UpdatePredefinedAttributeRequest>
  void UpdatePredefinedAttributeAsync(const UpdatePredefinedAttributeRequestT& request,
                                      const UpdatePredefinedAttributeResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdatePrompt that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdatePromptRequestT = Model::UpdatePromptRequest>
  void UpdatePromptAsync(const UpdatePromptRequestT& request, const UpdatePromptResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateQueueHoursOfOperationOutcome UpdateQueueHoursOfOperation(
      const Model::UpdateQueueHoursOfOperationRequest& request) const;

  /**
   * A Callable wrapper for UpdateQueueHoursOfOperation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateQueueHoursOfOperationRequestT = Model::UpdateQueueHoursOfOperationRequest>
  Model::UpdateQueueHoursOfOperationOutcomeCallable UpdateQueueHoursOfOperationCallable(
      const UpdateQueueHoursOfOperationRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateQueueHoursOfOperation, request);
  }

  /**
   * An Async wrapper for UpdateQueueHoursOfOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQueueHoursOfOperationRequestT = Model::UpdateQueueHoursOfOperationRequest>
  void UpdateQueueHoursOfOperationAsync(const UpdateQueueHoursOfOperationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateQueueMaxContacts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateQueueMaxContacts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQueueMaxContactsRequestT = Model::UpdateQueueMaxContactsRequest>
  void UpdateQueueMaxContactsAsync(const UpdateQueueMaxContactsRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateQueueName that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateQueueNameRequestT = Model::UpdateQueueNameRequest>
  void UpdateQueueNameAsync(const UpdateQueueNameRequestT& request, const UpdateQueueNameResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateQueueOutboundCallerConfigOutcome UpdateQueueOutboundCallerConfig(
      const Model::UpdateQueueOutboundCallerConfigRequest& request) const;

  /**
   * A Callable wrapper for UpdateQueueOutboundCallerConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateQueueOutboundCallerConfigRequestT = Model::UpdateQueueOutboundCallerConfigRequest>
  Model::UpdateQueueOutboundCallerConfigOutcomeCallable UpdateQueueOutboundCallerConfigCallable(
      const UpdateQueueOutboundCallerConfigRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateQueueOutboundCallerConfig, request);
  }

  /**
   * An Async wrapper for UpdateQueueOutboundCallerConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateQueueOutboundCallerConfigRequestT = Model::UpdateQueueOutboundCallerConfigRequest>
  void UpdateQueueOutboundCallerConfigAsync(const UpdateQueueOutboundCallerConfigRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateQueueOutboundEmailConfigOutcome UpdateQueueOutboundEmailConfig(
      const Model::UpdateQueueOutboundEmailConfigRequest& request) const;

  /**
   * A Callable wrapper for UpdateQueueOutboundEmailConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateQueueOutboundEmailConfigRequestT = Model::UpdateQueueOutboundEmailConfigRequest>
  Model::UpdateQueueOutboundEmailConfigOutcomeCallable UpdateQueueOutboundEmailConfigCallable(
      const UpdateQueueOutboundEmailConfigRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateQueueOutboundEmailConfig, request);
  }

  /**
   * An Async wrapper for UpdateQueueOutboundEmailConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateQueueOutboundEmailConfigRequestT = Model::UpdateQueueOutboundEmailConfigRequest>
  void UpdateQueueOutboundEmailConfigAsync(const UpdateQueueOutboundEmailConfigRequestT& request,
                                           const UpdateQueueOutboundEmailConfigResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&ConnectClient::UpdateQueueOutboundEmailConfig, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for UpdateQueueStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateQueueStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateQueueStatusRequestT = Model::UpdateQueueStatusRequest>
  void UpdateQueueStatusAsync(const UpdateQueueStatusRequestT& request, const UpdateQueueStatusResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateQuickConnectConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateQuickConnectConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQuickConnectConfigRequestT = Model::UpdateQuickConnectConfigRequest>
  void UpdateQuickConnectConfigAsync(const UpdateQuickConnectConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateQuickConnectName that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateQuickConnectName that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQuickConnectNameRequestT = Model::UpdateQuickConnectNameRequest>
  void UpdateQuickConnectNameAsync(const UpdateQuickConnectNameRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRoutingProfileAgentAvailabilityTimerOutcome UpdateRoutingProfileAgentAvailabilityTimer(
      const Model::UpdateRoutingProfileAgentAvailabilityTimerRequest& request) const;

  /**
   * A Callable wrapper for UpdateRoutingProfileAgentAvailabilityTimer that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::UpdateRoutingProfileAgentAvailabilityTimerOutcomeCallable UpdateRoutingProfileAgentAvailabilityTimerCallable(
      const UpdateRoutingProfileAgentAvailabilityTimerRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateRoutingProfileAgentAvailabilityTimer, request);
  }

  /**
   * An Async wrapper for UpdateRoutingProfileAgentAvailabilityTimer that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateRoutingProfileAgentAvailabilityTimerRequestT = Model::UpdateRoutingProfileAgentAvailabilityTimerRequest>
  void UpdateRoutingProfileAgentAvailabilityTimerAsync(
      const UpdateRoutingProfileAgentAvailabilityTimerRequestT& request,
      const UpdateRoutingProfileAgentAvailabilityTimerResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRoutingProfileConcurrencyOutcome UpdateRoutingProfileConcurrency(
      const Model::UpdateRoutingProfileConcurrencyRequest& request) const;

  /**
   * A Callable wrapper for UpdateRoutingProfileConcurrency that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateRoutingProfileConcurrencyRequestT = Model::UpdateRoutingProfileConcurrencyRequest>
  Model::UpdateRoutingProfileConcurrencyOutcomeCallable UpdateRoutingProfileConcurrencyCallable(
      const UpdateRoutingProfileConcurrencyRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateRoutingProfileConcurrency, request);
  }

  /**
   * An Async wrapper for UpdateRoutingProfileConcurrency that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateRoutingProfileConcurrencyRequestT = Model::UpdateRoutingProfileConcurrencyRequest>
  void UpdateRoutingProfileConcurrencyAsync(const UpdateRoutingProfileConcurrencyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRoutingProfileDefaultOutboundQueueOutcome UpdateRoutingProfileDefaultOutboundQueue(
      const Model::UpdateRoutingProfileDefaultOutboundQueueRequest& request) const;

  /**
   * A Callable wrapper for UpdateRoutingProfileDefaultOutboundQueue that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateRoutingProfileDefaultOutboundQueueRequestT = Model::UpdateRoutingProfileDefaultOutboundQueueRequest>
  Model::UpdateRoutingProfileDefaultOutboundQueueOutcomeCallable UpdateRoutingProfileDefaultOutboundQueueCallable(
      const UpdateRoutingProfileDefaultOutboundQueueRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateRoutingProfileDefaultOutboundQueue, request);
  }

  /**
   * An Async wrapper for UpdateRoutingProfileDefaultOutboundQueue that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateRoutingProfileDefaultOutboundQueueRequestT = Model::UpdateRoutingProfileDefaultOutboundQueueRequest>
  void UpdateRoutingProfileDefaultOutboundQueueAsync(
      const UpdateRoutingProfileDefaultOutboundQueueRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateRoutingProfileName that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRoutingProfileName that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRoutingProfileNameRequestT = Model::UpdateRoutingProfileNameRequest>
  void UpdateRoutingProfileNameAsync(const UpdateRoutingProfileNameRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRoutingProfileQueuesOutcome UpdateRoutingProfileQueues(
      const Model::UpdateRoutingProfileQueuesRequest& request) const;

  /**
   * A Callable wrapper for UpdateRoutingProfileQueues that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateRoutingProfileQueuesRequestT = Model::UpdateRoutingProfileQueuesRequest>
  Model::UpdateRoutingProfileQueuesOutcomeCallable UpdateRoutingProfileQueuesCallable(
      const UpdateRoutingProfileQueuesRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateRoutingProfileQueues, request);
  }

  /**
   * An Async wrapper for UpdateRoutingProfileQueues that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRoutingProfileQueuesRequestT = Model::UpdateRoutingProfileQueuesRequest>
  void UpdateRoutingProfileQueuesAsync(const UpdateRoutingProfileQueuesRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateSecurityProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSecurityProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSecurityProfileRequestT = Model::UpdateSecurityProfileRequest>
  void UpdateSecurityProfileAsync(const UpdateSecurityProfileRequestT& request, const UpdateSecurityProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateTaskTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTaskTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateTaskTemplateRequestT = Model::UpdateTaskTemplateRequest>
  ...
  /**
   * A Callable wrapper for UpdateTrafficDistribution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateTrafficDistributionRequestT = Model::UpdateTrafficDistributionRequest>
  Model::UpdateTrafficDistributionOutcomeCallable UpdateTrafficDistributionCallable(
      const UpdateTrafficDistributionRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateTrafficDistribution, request);
  }

  /**
   * An Async wrapper for UpdateTrafficDistribution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTrafficDistributionRequestT = Model::UpdateTrafficDistributionRequest>
  void UpdateTrafficDistributionAsync(const UpdateTrafficDistributionRequestT& request,
                                      const UpdateTrafficDistributionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateUserHierarchy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateUserHierarchy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateUserHierarchyRequestT = Model::UpdateUserHierarchyRequest>
  void UpdateUserHierarchyAsync(const UpdateUserHierarchyRequestT& request, const UpdateUserHierarchyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateUserHierarchyGroupNameOutcome UpdateUserHierarchyGroupName(
      const Model::UpdateUserHierarchyGroupNameRequest& request) const;

  /**
   * A Callable wrapper for UpdateUserHierarchyGroupName that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateUserHierarchyGroupNameRequestT = Model::UpdateUserHierarchyGroupNameRequest>
  Model::UpdateUserHierarchyGroupNameOutcomeCallable UpdateUserHierarchyGroupNameCallable(
      const UpdateUserHierarchyGroupNameRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateUserHierarchyGroupName, request);
  }

  /**
   * An Async wrapper for UpdateUserHierarchyGroupName that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateUserHierarchyGroupNameRequestT = Model::UpdateUserHierarchyGroupNameRequest>
  void UpdateUserHierarchyGroupNameAsync(const UpdateUserHierarchyGroupNameRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateUserHierarchyStructureOutcome UpdateUserHierarchyStructure(
      const Model::UpdateUserHierarchyStructureRequest& request) const;

  /**
   * A Callable wrapper for UpdateUserHierarchyStructure that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateUserHierarchyStructureRequestT = Model::UpdateUserHierarchyStructureRequest>
  Model::UpdateUserHierarchyStructureOutcomeCallable UpdateUserHierarchyStructureCallable(
      const UpdateUserHierarchyStructureRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateUserHierarchyStructure, request);
  }

  /**
   * An Async wrapper for UpdateUserHierarchyStructure that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateUserHierarchyStructureRequestT = Model::UpdateUserHierarchyStructureRequest>
  void UpdateUserHierarchyStructureAsync(const UpdateUserHierarchyStructureRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateUserIdentityInfo that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateUserIdentityInfo that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateUserIdentityInfoRequestT = Model::UpdateUserIdentityInfoRequest>
  void UpdateUserIdentityInfoAsync(const UpdateUserIdentityInfoRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateUserPhoneConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateUserPhoneConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateUserPhoneConfigRequestT = Model::UpdateUserPhoneConfigRequest>
  void UpdateUserPhoneConfigAsync(const UpdateUserPhoneConfigRequestT& request, const UpdateUserPhoneConfigResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateUserProficiencies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateUserProficiencies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateUserProficienciesRequestT = Model::UpdateUserProficienciesRequest>
  void UpdateUserProficienciesAsync(const UpdateUserProficienciesRequestT& request,
                                    const UpdateUserProficienciesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateUserRoutingProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateUserRoutingProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateUserRoutingProfileRequestT = Model::UpdateUserRoutingProfileRequest>
  void UpdateUserRoutingProfileAsync(const UpdateUserRoutingProfileRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateUserSecurityProfilesOutcome UpdateUserSecurityProfiles(
      const Model::UpdateUserSecurityProfilesRequest& request) const;

  /**
   * A Callable wrapper for UpdateUserSecurityProfiles that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateUserSecurityProfilesRequestT = Model::UpdateUserSecurityProfilesRequest>
  Model::UpdateUserSecurityProfilesOutcomeCallable UpdateUserSecurityProfilesCallable(
      const UpdateUserSecurityProfilesRequestT& request) const {
    return SubmitCallable(&ConnectClient::UpdateUserSecurityProfiles, request);
  }

  /**
   * An Async wrapper for UpdateUserSecurityProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateUserSecurityProfilesRequestT = Model::UpdateUserSecurityProfilesRequest>
  void UpdateUserSecurityProfilesAsync(const UpdateUserSecurityProfilesRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateViewContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateViewContent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateViewContentRequestT = Model::UpdateViewContentRequest>
  void UpdateViewContentAsync(const UpdateViewContentRequestT& request, const UpdateViewContentResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateViewMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateViewMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateViewMetadataRequestT = Model::UpdateViewMetadataRequest>
