...
InvalidRequestExceptionReason::InvalidRequestExceptionReason(JsonView jsonValue) { *this = jsonValue; }
...
InvalidRequestExceptionReason& InvalidRequestExceptionReason::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("AttachedFileInvalidRequestExceptionReason")) {
    m_attachedFileInvalidRequestExceptionReason =
        AttachedFileInvalidRequestExceptionReasonMapper::GetAttachedFileInvalidRequestExceptionReasonForName(
...
JsonValue InvalidRequestExceptionReason::Jsonize() const {
  ...
  if (m_attachedFileInvalidRequestExceptionReasonHasBeenSet) {
    payload.WithString("AttachedFileInvalidRequestExceptionReason",
                       AttachedFileInvalidRequestExceptionReasonMapper::GetNameForAttachedFileInvalidRequestExceptionReason(
                           m_attachedFileInvalidRequestExceptionReason));
  }
