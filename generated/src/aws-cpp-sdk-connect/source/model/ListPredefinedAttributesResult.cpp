...
ListPredefinedAttributesResult::ListPredefinedAttributesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListPredefinedAttributesResult& ListPredefinedAttributesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("PredefinedAttributeSummaryList")) {
    ...
    for (unsigned predefinedAttributeSummaryListIndex = 0;
         predefinedAttributeSummaryListIndex < predefinedAttributeSummaryListJsonList.GetLength(); ++predefinedAttributeSummaryListIndex) {
