...
ContactEvaluationAttributeFilter::ContactEvaluationAttributeFilter(JsonView jsonValue) { *this = jsonValue; }

ContactEvaluationAttributeFilter& ContactEvaluationAttributeFilter::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ContactEvaluationAttributeCondition")) {
    m_contactEvaluationAttributeCondition = jsonValue.GetObject("ContactEvaluationAttributeCondition");
    m_contactEvaluationAttributeConditionHasBeenSet = true;
  }
  return *this;
}

JsonValue ContactEvaluationAttributeFilter::Jsonize() const {
  JsonValue payload;
  ...
  if (m_contactEvaluationAttributeConditionHasBeenSet) {
    payload.WithObject("ContactEvaluationAttributeCondition", m_contactEvaluationAttributeCondition.Jsonize());
  }
