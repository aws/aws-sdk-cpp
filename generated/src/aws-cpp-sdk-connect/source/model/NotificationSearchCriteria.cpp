...
NotificationSearchCriteria::NotificationSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

NotificationSearchCriteria& NotificationSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue NotificationSearchCriteria::Jsonize() const {
  JsonValue payload;
