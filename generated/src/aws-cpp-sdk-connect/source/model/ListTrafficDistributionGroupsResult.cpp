...
ListTrafficDistributionGroupsResult& ListTrafficDistributionGroupsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("TrafficDistributionGroupSummaryList")) {
    ...
    for (unsigned trafficDistributionGroupSummaryListIndex = 0;
         trafficDistributionGroupSummaryListIndex < trafficDistributionGroupSummaryListJsonList.GetLength();
         ++trafficDistributionGroupSummaryListIndex) {
      m_trafficDistributionGroupSummaryList.push_back(
          trafficDistributionGroupSummaryListJsonList[trafficDistributionGroupSummaryListIndex].AsObject());
    }
