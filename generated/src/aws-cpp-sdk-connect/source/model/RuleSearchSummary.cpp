...
RuleSearchSummary::RuleSearchSummary(JsonView jsonValue) { *this = jsonValue; }

RuleSearchSummary& RuleSearchSummary::operator=(JsonView jsonValue) {
...
JsonValue RuleSearchSummary::Jsonize() const {
  JsonValue payload;
