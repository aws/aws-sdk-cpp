...
HierarchyGroupSummary::HierarchyGroupSummary(JsonView jsonValue) { *this = jsonValue; }

HierarchyGroupSummary& HierarchyGroupSummary::operator=(JsonView jsonValue) {
...
JsonValue HierarchyGroupSummary::Jsonize() const {
  JsonValue payload;
