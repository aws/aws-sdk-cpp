...
BatchDescribeDataTableValueFailureResult::BatchDescribeDataTableValueFailureResult(JsonView jsonValue) { *this = jsonValue; }

BatchDescribeDataTableValueFailureResult& BatchDescribeDataTableValueFailureResult::operator=(JsonView jsonValue) {
...
JsonValue BatchDescribeDataTableValueFailureResult::Jsonize() const {
  JsonValue payload;
