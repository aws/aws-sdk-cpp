...
ValidationEnum::ValidationEnum(JsonView jsonValue) { *this = jsonValue; }

ValidationEnum& ValidationEnum::operator=(JsonView jsonValue) {
...
JsonValue ValidationEnum::Jsonize() const {
  JsonValue payload;
