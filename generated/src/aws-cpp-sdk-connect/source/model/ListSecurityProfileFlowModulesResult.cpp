...
ListSecurityProfileFlowModulesResult::ListSecurityProfileFlowModulesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}
...
ListSecurityProfileFlowModulesResult& ListSecurityProfileFlowModulesResult::operator=(
  ...
  if (jsonValue.ValueExists("AllowedFlowModules")) {
    ...
    for (unsigned allowedFlowModulesIndex = 0; allowedFlowModulesIndex < allowedFlowModulesJsonList.GetLength();
      ...
      m_allowedFlowModules.push_back(allowedFlowModulesJsonList[allowedFlowModulesIndex].AsObject());
    }
