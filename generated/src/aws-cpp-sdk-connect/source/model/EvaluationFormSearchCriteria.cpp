...
EvaluationFormSearchCriteria::EvaluationFormSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

EvaluationFormSearchCriteria& EvaluationFormSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue EvaluationFormSearchCriteria::Jsonize() const {
  JsonValue payload;
