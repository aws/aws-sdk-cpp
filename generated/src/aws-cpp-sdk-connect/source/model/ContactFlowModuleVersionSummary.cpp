...
ContactFlowModuleVersionSummary::ContactFlowModuleVersionSummary(JsonView jsonValue) { *this = jsonValue; }

ContactFlowModuleVersionSummary& ContactFlowModuleVersionSummary::operator=(JsonView jsonValue) {
...
JsonValue ContactFlowModuleVersionSummary::Jsonize() const {
  JsonValue payload;
