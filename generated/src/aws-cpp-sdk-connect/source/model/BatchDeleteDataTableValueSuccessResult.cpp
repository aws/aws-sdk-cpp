...
BatchDeleteDataTableValueSuccessResult::BatchDeleteDataTableValueSuccessResult(JsonView jsonValue) { *this = jsonValue; }

BatchDeleteDataTableValueSuccessResult& BatchDeleteDataTableValueSuccessResult::operator=(JsonView jsonValue) {
...
JsonValue BatchDeleteDataTableValueSuccessResult::Jsonize() const {
  JsonValue payload;
