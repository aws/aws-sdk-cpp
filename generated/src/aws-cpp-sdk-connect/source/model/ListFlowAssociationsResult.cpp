...
ListFlowAssociationsResult::ListFlowAssociationsResult()
{
}

ListFlowAssociationsResult::ListFlowAssociationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
