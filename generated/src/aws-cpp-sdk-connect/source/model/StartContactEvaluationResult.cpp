...
StartContactEvaluationResult::StartContactEvaluationResult()
{
}

StartContactEvaluationResult::StartContactEvaluationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
