...
DataTableValueIdentifier::DataTableValueIdentifier(JsonView jsonValue) { *this = jsonValue; }

DataTableValueIdentifier& DataTableValueIdentifier::operator=(JsonView jsonValue) {
...
JsonValue DataTableValueIdentifier::Jsonize() const {
  JsonValue payload;
