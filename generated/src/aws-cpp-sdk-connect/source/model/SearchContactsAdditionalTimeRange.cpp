...
SearchContactsAdditionalTimeRange::SearchContactsAdditionalTimeRange(JsonView jsonValue) { *this = jsonValue; }

SearchContactsAdditionalTimeRange& SearchContactsAdditionalTimeRange::operator=(JsonView jsonValue) {
...
JsonValue SearchContactsAdditionalTimeRange::Jsonize() const {
  JsonValue payload;
