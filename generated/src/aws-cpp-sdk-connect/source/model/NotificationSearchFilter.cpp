...
NotificationSearchFilter::NotificationSearchFilter(JsonView jsonValue) { *this = jsonValue; }

NotificationSearchFilter& NotificationSearchFilter::operator=(JsonView jsonValue) {
...
JsonValue NotificationSearchFilter::Jsonize() const {
  JsonValue payload;
