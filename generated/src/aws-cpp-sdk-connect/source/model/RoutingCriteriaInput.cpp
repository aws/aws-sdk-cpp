...
RoutingCriteriaInput::RoutingCriteriaInput(JsonView jsonValue) { *this = jsonValue; }

RoutingCriteriaInput& RoutingCriteriaInput::operator=(JsonView jsonValue) {
...
JsonValue RoutingCriteriaInput::Jsonize() const {
  JsonValue payload;
