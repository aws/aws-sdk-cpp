...
WorkspaceAssociationSearchCriteria::WorkspaceAssociationSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

WorkspaceAssociationSearchCriteria& WorkspaceAssociationSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue WorkspaceAssociationSearchCriteria::Jsonize() const {
  JsonValue payload;
