...
CreateExtractionDefinitionResult::CreateExtractionDefinitionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateExtractionDefinitionResult& CreateExtractionDefinitionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
