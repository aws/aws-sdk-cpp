...
QuickConnectSummary::QuickConnectSummary(JsonView jsonValue) { *this = jsonValue; }

QuickConnectSummary& QuickConnectSummary::operator=(JsonView jsonValue) {
...
JsonValue QuickConnectSummary::Jsonize() const {
  JsonValue payload;
