...
RuleAttributeAndCondition::RuleAttributeAndCondition(JsonView jsonValue) { *this = jsonValue; }

RuleAttributeAndCondition& RuleAttributeAndCondition::operator=(JsonView jsonValue) {
...
JsonValue RuleAttributeAndCondition::Jsonize() const {
  JsonValue payload;
