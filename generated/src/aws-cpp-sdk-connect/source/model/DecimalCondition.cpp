...
DecimalCondition::DecimalCondition(JsonView jsonValue) { *this = jsonValue; }

DecimalCondition& DecimalCondition::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ComparisonType")) {
    m_comparisonType = DecimalComparisonTypeMapper::GetDecimalComparisonTypeForName(jsonValue.GetString("ComparisonType"));
    m_comparisonTypeHasBeenSet = true;
  }
  return *this;
}

JsonValue DecimalCondition::Jsonize() const {
  JsonValue payload;
  ...
  if (m_comparisonTypeHasBeenSet) {
    payload.WithString("ComparisonType", DecimalComparisonTypeMapper::GetNameForDecimalComparisonType(m_comparisonType));
  }
