...
PromptSearchCriteria::PromptSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

PromptSearchCriteria& PromptSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue PromptSearchCriteria::Jsonize() const {
  JsonValue payload;
