...
QuickConnectSearchCriteria::QuickConnectSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

QuickConnectSearchCriteria& QuickConnectSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue QuickConnectSearchCriteria::Jsonize() const {
  JsonValue payload;
