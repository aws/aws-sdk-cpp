...
ListAuthenticationProfilesResult& ListAuthenticationProfilesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("AuthenticationProfileSummaryList")) {
    ...
    for (unsigned authenticationProfileSummaryListIndex = 0;
         authenticationProfileSummaryListIndex < authenticationProfileSummaryListJsonList.GetLength();
         ++authenticationProfileSummaryListIndex) {
      m_authenticationProfileSummaryList.push_back(
          authenticationProfileSummaryListJsonList[authenticationProfileSummaryListIndex].AsObject());
    }
