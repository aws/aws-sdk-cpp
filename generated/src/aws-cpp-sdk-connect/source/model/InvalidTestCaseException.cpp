...
InvalidTestCaseException::InvalidTestCaseException(JsonView jsonValue) { *this = jsonValue; }

InvalidTestCaseException& InvalidTestCaseException::operator=(JsonView jsonValue) {
...
JsonValue InvalidTestCaseException::Jsonize() const {
  JsonValue payload;
