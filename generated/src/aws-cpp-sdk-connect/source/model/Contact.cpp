...
Contact& Contact::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AnsweringMachineDetectionStatus")) {
    m_answeringMachineDetectionStatus = AnsweringMachineDetectionStatusMapper::GetAnsweringMachineDetectionStatusForName(
        jsonValue.GetString("AnsweringMachineDetectionStatus"));
...
JsonValue Contact::Jsonize() const {
  ...
  if (m_answeringMachineDetectionStatusHasBeenSet) {
    payload.WithString("AnsweringMachineDetectionStatus",
                       AnsweringMachineDetectionStatusMapper::GetNameForAnsweringMachineDetectionStatus(m_answeringMachineDetectionStatus));
  }
