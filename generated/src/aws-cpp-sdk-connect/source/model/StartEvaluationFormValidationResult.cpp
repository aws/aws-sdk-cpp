...
StartEvaluationFormValidationResult::StartEvaluationFormValidationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

StartEvaluationFormValidationResult& StartEvaluationFormValidationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
