...
RulesSearchFilter::RulesSearchFilter(JsonView jsonValue) { *this = jsonValue; }

RulesSearchFilter& RulesSearchFilter::operator=(JsonView jsonValue) {
...
JsonValue RulesSearchFilter::Jsonize() const {
  JsonValue payload;
