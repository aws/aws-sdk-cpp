...
BatchUpdateDataTableValueFailureResult::BatchUpdateDataTableValueFailureResult(JsonView jsonValue) { *this = jsonValue; }

BatchUpdateDataTableValueFailureResult& BatchUpdateDataTableValueFailureResult::operator=(JsonView jsonValue) {
...
JsonValue BatchUpdateDataTableValueFailureResult::Jsonize() const {
  JsonValue payload;
