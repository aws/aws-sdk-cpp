...
ViewVersionSummary::ViewVersionSummary(JsonView jsonValue) { *this = jsonValue; }

ViewVersionSummary& ViewVersionSummary::operator=(JsonView jsonValue) {
...
JsonValue ViewVersionSummary::Jsonize() const {
  JsonValue payload;
