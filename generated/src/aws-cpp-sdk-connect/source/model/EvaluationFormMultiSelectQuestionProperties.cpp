...
EvaluationFormMultiSelectQuestionProperties::EvaluationFormMultiSelectQuestionProperties(JsonView jsonValue) { *this = jsonValue; }

EvaluationFormMultiSelectQuestionProperties& EvaluationFormMultiSelectQuestionProperties::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DisplayAs")) {
    m_displayAs = EvaluationFormMultiSelectQuestionDisplayModeMapper::GetEvaluationFormMultiSelectQuestionDisplayModeForName(
        jsonValue.GetString("DisplayAs"));
...
JsonValue EvaluationFormMultiSelectQuestionProperties::Jsonize() const {
  JsonValue payload;
  ...
  if (m_displayAsHasBeenSet) {
    payload.WithString(
        "DisplayAs",
        EvaluationFormMultiSelectQuestionDisplayModeMapper::GetNameForEvaluationFormMultiSelectQuestionDisplayMode(m_displayAs));
  }
