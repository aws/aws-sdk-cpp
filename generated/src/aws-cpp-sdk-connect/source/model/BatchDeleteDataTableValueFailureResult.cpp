...
BatchDeleteDataTableValueFailureResult::BatchDeleteDataTableValueFailureResult(JsonView jsonValue) { *this = jsonValue; }

BatchDeleteDataTableValueFailureResult& BatchDeleteDataTableValueFailureResult::operator=(JsonView jsonValue) {
...
JsonValue BatchDeleteDataTableValueFailureResult::Jsonize() const {
  JsonValue payload;
