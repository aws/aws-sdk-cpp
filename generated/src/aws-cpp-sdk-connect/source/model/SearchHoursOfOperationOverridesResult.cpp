...
SearchHoursOfOperationOverridesResult& SearchHoursOfOperationOverridesResult::operator=(
  ...
  if (jsonValue.ValueExists("HoursOfOperationOverrides")) {
    ...
    for (unsigned hoursOfOperationOverridesIndex = 0; hoursOfOperationOverridesIndex < hoursOfOperationOverridesJsonList.GetLength();
         ++hoursOfOperationOverridesIndex) {
