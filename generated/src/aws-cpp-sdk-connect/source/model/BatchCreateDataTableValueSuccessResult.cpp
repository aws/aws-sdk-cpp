...
BatchCreateDataTableValueSuccessResult::BatchCreateDataTableValueSuccessResult(JsonView jsonValue) { *this = jsonValue; }

BatchCreateDataTableValueSuccessResult& BatchCreateDataTableValueSuccessResult::operator=(JsonView jsonValue) {
...
JsonValue BatchCreateDataTableValueSuccessResult::Jsonize() const {
  JsonValue payload;
