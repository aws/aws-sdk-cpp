...
SearchRulesResult::SearchRulesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

SearchRulesResult& SearchRulesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
