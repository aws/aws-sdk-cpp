...
MetricSearchFilter::MetricSearchFilter(JsonView jsonValue) { *this = jsonValue; }

MetricSearchFilter& MetricSearchFilter::operator=(JsonView jsonValue) {
...
JsonValue MetricSearchFilter::Jsonize() const {
  JsonValue payload;
