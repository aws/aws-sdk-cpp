...
ParticipantTimerValue::ParticipantTimerValue(JsonView jsonValue) { *this = jsonValue; }

ParticipantTimerValue& ParticipantTimerValue::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ParticipantTimerAction")) {
    m_participantTimerAction =
        ParticipantTimerActionMapper::GetParticipantTimerActionForName(jsonValue.GetString("ParticipantTimerAction"));
