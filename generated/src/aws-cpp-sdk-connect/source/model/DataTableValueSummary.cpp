...
DataTableValueSummary::DataTableValueSummary(JsonView jsonValue) { *this = jsonValue; }

DataTableValueSummary& DataTableValueSummary::operator=(JsonView jsonValue) {
...
JsonValue DataTableValueSummary::Jsonize() const {
  JsonValue payload;
