...
PredefinedAttributeSearchCriteria::PredefinedAttributeSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

PredefinedAttributeSearchCriteria& PredefinedAttributeSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue PredefinedAttributeSearchCriteria::Jsonize() const {
  JsonValue payload;
