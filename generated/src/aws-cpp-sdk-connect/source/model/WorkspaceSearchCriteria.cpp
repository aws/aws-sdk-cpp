...
WorkspaceSearchCriteria::WorkspaceSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

WorkspaceSearchCriteria& WorkspaceSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue WorkspaceSearchCriteria::Jsonize() const {
  JsonValue payload;
