...
TaskTemplateField::TaskTemplateField(JsonView jsonValue) { *this = jsonValue; }
...
TaskTemplateField& TaskTemplateField::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SingleSelectOptions")) {
    ...
    for (unsigned singleSelectOptionsIndex = 0; singleSelectOptionsIndex < singleSelectOptionsJsonList.GetLength();
         ++singleSelectOptionsIndex) {
