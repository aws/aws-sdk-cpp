...
ListIntegrationAssociationsResult& ListIntegrationAssociationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("IntegrationAssociationSummaryList")) {
    ...
    for (unsigned integrationAssociationSummaryListIndex = 0;
         integrationAssociationSummaryListIndex < integrationAssociationSummaryListJsonList.GetLength();
         ++integrationAssociationSummaryListIndex) {
      m_integrationAssociationSummaryList.push_back(
          integrationAssociationSummaryListJsonList[integrationAssociationSummaryListIndex].AsObject());
    }
