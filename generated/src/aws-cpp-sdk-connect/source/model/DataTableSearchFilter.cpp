...
DataTableSearchFilter::DataTableSearchFilter(JsonView jsonValue) { *this = jsonValue; }

DataTableSearchFilter& DataTableSearchFilter::operator=(JsonView jsonValue) {
...
JsonValue DataTableSearchFilter::Jsonize() const {
  JsonValue payload;
