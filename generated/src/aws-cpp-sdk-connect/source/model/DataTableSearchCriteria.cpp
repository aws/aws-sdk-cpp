...
DataTableSearchCriteria::DataTableSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

DataTableSearchCriteria& DataTableSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue DataTableSearchCriteria::Jsonize() const {
  JsonValue payload;
