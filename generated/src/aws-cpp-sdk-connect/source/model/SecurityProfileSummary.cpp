...
SecurityProfileSummary::SecurityProfileSummary(JsonView jsonValue) { *this = jsonValue; }

SecurityProfileSummary& SecurityProfileSummary::operator=(JsonView jsonValue) {
...
JsonValue SecurityProfileSummary::Jsonize() const {
  JsonValue payload;
