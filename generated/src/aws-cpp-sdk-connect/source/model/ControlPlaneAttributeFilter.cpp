...
ControlPlaneAttributeFilter::ControlPlaneAttributeFilter(JsonView jsonValue) { *this = jsonValue; }

ControlPlaneAttributeFilter& ControlPlaneAttributeFilter::operator=(JsonView jsonValue) {
...
JsonValue ControlPlaneAttributeFilter::Jsonize() const {
  JsonValue payload;
