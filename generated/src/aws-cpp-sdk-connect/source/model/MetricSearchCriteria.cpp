...
MetricSearchCriteria::MetricSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

MetricSearchCriteria& MetricSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue MetricSearchCriteria::Jsonize() const {
  JsonValue payload;
