...
HoursOfOperationSearchCriteria::HoursOfOperationSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

HoursOfOperationSearchCriteria& HoursOfOperationSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue HoursOfOperationSearchCriteria::Jsonize() const {
  JsonValue payload;
