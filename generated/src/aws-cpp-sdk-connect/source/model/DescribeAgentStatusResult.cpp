...
DescribeAgentStatusResult::DescribeAgentStatusResult()
{
}

DescribeAgentStatusResult::DescribeAgentStatusResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
