...
HierarchyPathReference::HierarchyPathReference(JsonView jsonValue) { *this = jsonValue; }

HierarchyPathReference& HierarchyPathReference::operator=(JsonView jsonValue) {
...
JsonValue HierarchyPathReference::Jsonize() const {
  JsonValue payload;
