...
HierarchyLevel::HierarchyLevel(JsonView jsonValue) { *this = jsonValue; }

HierarchyLevel& HierarchyLevel::operator=(JsonView jsonValue) {
...
JsonValue HierarchyLevel::Jsonize() const {
  JsonValue payload;
