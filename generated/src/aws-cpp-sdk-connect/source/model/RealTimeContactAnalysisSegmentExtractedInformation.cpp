...
RealTimeContactAnalysisSegmentExtractedInformation::RealTimeContactAnalysisSegmentExtractedInformation(JsonView jsonValue) {
  *this = jsonValue;
}

RealTimeContactAnalysisSegmentExtractedInformation& RealTimeContactAnalysisSegmentExtractedInformation::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("FailureCode")) {
    m_failureCode =
        RealTimeContactAnalysisExtractedInformationFailureCodeMapper::GetRealTimeContactAnalysisExtractedInformationFailureCodeForName(
            jsonValue.GetString("FailureCode"));
    m_failureCodeHasBeenSet = true;
  }
  return *this;
}

JsonValue RealTimeContactAnalysisSegmentExtractedInformation::Jsonize() const {
  JsonValue payload;
  ...
  if (m_failureCodeHasBeenSet) {
    payload.WithString(
        "FailureCode",
        RealTimeContactAnalysisExtractedInformationFailureCodeMapper::GetNameForRealTimeContactAnalysisExtractedInformationFailureCode(
            m_failureCode));
  }
