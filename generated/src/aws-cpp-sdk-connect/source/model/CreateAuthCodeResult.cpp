...
CreateAuthCodeResult::CreateAuthCodeResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateAuthCodeResult& CreateAuthCodeResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
