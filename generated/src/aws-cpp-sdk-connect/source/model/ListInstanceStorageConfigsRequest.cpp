...
Aws::String ListInstanceStorageConfigsRequest::SerializePayload() const { return {}; }

void ListInstanceStorageConfigsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
