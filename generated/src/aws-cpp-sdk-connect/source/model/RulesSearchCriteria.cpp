...
RulesSearchCriteria::RulesSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

RulesSearchCriteria& RulesSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue RulesSearchCriteria::Jsonize() const {
  JsonValue payload;
