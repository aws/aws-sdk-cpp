...
RuleAttributeFilter::RuleAttributeFilter(JsonView jsonValue) { *this = jsonValue; }

RuleAttributeFilter& RuleAttributeFilter::operator=(JsonView jsonValue) {
...
JsonValue RuleAttributeFilter::Jsonize() const {
  JsonValue payload;
