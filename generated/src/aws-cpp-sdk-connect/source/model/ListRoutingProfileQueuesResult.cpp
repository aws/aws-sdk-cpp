...
ListRoutingProfileQueuesResult::ListRoutingProfileQueuesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListRoutingProfileQueuesResult& ListRoutingProfileQueuesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("RoutingProfileQueueConfigSummaryList")) {
    ...
    for (unsigned routingProfileQueueConfigSummaryListIndex = 0;
         routingProfileQueueConfigSummaryListIndex < routingProfileQueueConfigSummaryListJsonList.GetLength();
         ++routingProfileQueueConfigSummaryListIndex) {
      m_routingProfileQueueConfigSummaryList.push_back(
          routingProfileQueueConfigSummaryListJsonList[routingProfileQueueConfigSummaryListIndex].AsObject());
    }
