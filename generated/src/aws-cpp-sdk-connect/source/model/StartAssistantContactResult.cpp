...
StartAssistantContactResult::StartAssistantContactResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartAssistantContactResult& StartAssistantContactResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
