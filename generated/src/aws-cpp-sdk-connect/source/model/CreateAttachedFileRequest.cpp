...
Aws::String CreateAttachedFileRequest::SerializePayload() const {
  JsonValue payload;
  ...
  if (m_fileSourceUriHasBeenSet) {
    payload.WithString("FileSourceUri", m_fileSourceUri);
  }
...
void CreateAttachedFileRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
