...
TaskAttachment::TaskAttachment(JsonView jsonValue) { *this = jsonValue; }

TaskAttachment& TaskAttachment::operator=(JsonView jsonValue) {
...
JsonValue TaskAttachment::Jsonize() const {
  JsonValue payload;
