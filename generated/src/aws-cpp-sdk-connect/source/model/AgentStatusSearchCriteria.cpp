...
AgentStatusSearchCriteria::AgentStatusSearchCriteria(JsonView jsonValue) { *this = jsonValue; }

AgentStatusSearchCriteria& AgentStatusSearchCriteria::operator=(JsonView jsonValue) {
...
JsonValue AgentStatusSearchCriteria::Jsonize() const {
  JsonValue payload;
