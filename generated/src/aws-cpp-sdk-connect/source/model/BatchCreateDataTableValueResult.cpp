...
BatchCreateDataTableValueResult::BatchCreateDataTableValueResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchCreateDataTableValueResult& BatchCreateDataTableValueResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
