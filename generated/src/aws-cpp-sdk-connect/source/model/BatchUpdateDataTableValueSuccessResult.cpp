...
BatchUpdateDataTableValueSuccessResult::BatchUpdateDataTableValueSuccessResult(JsonView jsonValue) { *this = jsonValue; }

BatchUpdateDataTableValueSuccessResult& BatchUpdateDataTableValueSuccessResult::operator=(JsonView jsonValue) {
...
JsonValue BatchUpdateDataTableValueSuccessResult::Jsonize() const {
  JsonValue payload;
