...
namespace Connect
{
const size_t ConnectEndpointRules::RulesBlobStrLen = 3703;
const size_t ConnectEndpointRules::RulesBlobSize = 3704;
...
'n','e','c','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
