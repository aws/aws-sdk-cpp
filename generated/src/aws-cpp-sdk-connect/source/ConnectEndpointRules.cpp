...
namespace Connect
{
const size_t ConnectEndpointRules::RulesBlobStrLen = 3749;
const size_t ConnectEndpointRules::RulesBlobSize = 3750;
...
'n','e','c','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
