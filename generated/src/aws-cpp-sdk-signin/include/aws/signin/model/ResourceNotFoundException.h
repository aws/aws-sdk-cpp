...
/**
 * <p>Error thrown when requested resource is not found</p> <p>HTTP Status Code:
 * 404 Not Found</p> <p>Used when the specified resource does not
 * exist</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/signin-2023-01-01/ResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class ResourceNotFoundException {
 public:
  ...
  ///@{
  /**
   * <p>OAuth 2.0 error code indicating resource not found Will be
   * RESOURCE_NOT_FOUND</p>
   */
  ...
  inline ResourceNotFoundException& WithError(OAuth2ErrorCode value) {
    SetError(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>Detailed message explaining which resource was not found Provides specific
   * information about the missing resource</p>
   */
