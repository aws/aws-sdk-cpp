...
PutConsoleAuthorizationConfigurationResult::PutConsoleAuthorizationConfigurationResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

PutConsoleAuthorizationConfigurationResult& PutConsoleAuthorizationConfigurationResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
