...
GetConsoleAuthorizationConfigurationResult::GetConsoleAuthorizationConfigurationResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

GetConsoleAuthorizationConfigurationResult& GetConsoleAuthorizationConfigurationResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
