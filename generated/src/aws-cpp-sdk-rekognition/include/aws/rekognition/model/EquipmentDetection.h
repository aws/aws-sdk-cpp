...
class EquipmentDetection {
 public:
  ...
  inline EquipmentDetection& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(ProtectiveEquipmentType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline EquipmentDetection& WithType(ProtectiveEquipmentType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetCoversBodyPart(CoversBodyPartT&& value) {
    ...
    m_coversBodyPart = std::forward<CoversBodyPartT>(value);
  }
  template <typename CoversBodyPartT = CoversBodyPart>
  EquipmentDetection& WithCoversBodyPart(CoversBodyPartT&& value) {
    SetCoversBodyPart(std::forward<CoversBodyPartT>(value));
    return *this;
  }
  ///@}
 private:
