...
namespace Model
{
  ...
  {
  public:
    AWS_REKOGNITION_API MediaAnalysisInput();
    ...
    inline MediaAnalysisInput& WithS3Object(const S3Object& value) { SetS3Object(value); return *this;}

    
    inline MediaAnalysisInput& WithS3Object(S3Object&& value) { SetS3Object(std::move(value)); return *this;}
