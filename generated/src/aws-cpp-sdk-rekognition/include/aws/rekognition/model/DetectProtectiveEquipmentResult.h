...
class DetectProtectiveEquipmentResult {
 public:
  ...
  void SetProtectiveEquipmentModelVersion(ProtectiveEquipmentModelVersionT&& value) {
    ...
    m_protectiveEquipmentModelVersion = std::forward<ProtectiveEquipmentModelVersionT>(value);
  }
  template <typename ProtectiveEquipmentModelVersionT = Aws::String>
  DetectProtectiveEquipmentResult& WithProtectiveEquipmentModelVersion(ProtectiveEquipmentModelVersionT&& value) {
    SetProtectiveEquipmentModelVersion(std::forward<ProtectiveEquipmentModelVersionT>(value));
    return *this;
  }
  ///@}
