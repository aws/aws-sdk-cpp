...
class GetFaceLivenessSessionResultsResult {
 public:
  ...
  AWS_REKOGNITION_API GetFaceLivenessSessionResultsResult& operator=(
  ...
  inline void SetStatus(LivenessSessionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetFaceLivenessSessionResultsResult& WithStatus(LivenessSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetFaceLivenessSessionResultsResult& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  void SetReferenceImage(ReferenceImageT&& value) {
    m_referenceImageHasBeenSet = true;
    m_referenceImage = std::forward<ReferenceImageT>(value);
  }
  template <typename ReferenceImageT = AuditImage>
  GetFaceLivenessSessionResultsResult& WithReferenceImage(ReferenceImageT&& value) {
    SetReferenceImage(std::forward<ReferenceImageT>(value));
    return *this;
  }
  ///@}
