...
namespace Model
{
  ...
  {
  public:
    AWS_REKOGNITION_API ListDatasetLabelsRequest() = default;
    ...
    template<typename DatasetArnT = Aws::String>
    ListDatasetLabelsRequest& WithDatasetArn(DatasetArnT&& value) { SetDatasetArn(std::forward<DatasetArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListDatasetLabelsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
