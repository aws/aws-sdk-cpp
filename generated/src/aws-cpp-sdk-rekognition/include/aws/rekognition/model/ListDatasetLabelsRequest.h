...
class ListDatasetLabelsRequest : public RekognitionRequest {
 public:
  ...
  template <typename DatasetArnT = Aws::String>
  ListDatasetLabelsRequest& WithDatasetArn(DatasetArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDatasetLabelsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDatasetLabelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
