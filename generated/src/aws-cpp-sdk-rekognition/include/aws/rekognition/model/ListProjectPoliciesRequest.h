...
class ListProjectPoliciesRequest : public RekognitionRequest {
 public:
  ...
  template <typename ProjectArnT = Aws::String>
  ListProjectPoliciesRequest& WithProjectArn(ProjectArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListProjectPoliciesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListProjectPoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
