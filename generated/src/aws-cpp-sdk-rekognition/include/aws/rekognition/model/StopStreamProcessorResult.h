...
namespace Model
{
  ...
  public:
    ...
    inline StopStreamProcessorResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StopStreamProcessorResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StopStreamProcessorResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
