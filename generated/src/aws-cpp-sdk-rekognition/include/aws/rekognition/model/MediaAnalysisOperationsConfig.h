...
class MediaAnalysisOperationsConfig {
 public:
  ...
  void SetDetectModerationLabels(DetectModerationLabelsT&& value) {
    m_detectModerationLabelsHasBeenSet = true;
    m_detectModerationLabels = std::forward<DetectModerationLabelsT>(value);
  }
  template <typename DetectModerationLabelsT = MediaAnalysisDetectModerationLabelsConfig>
  MediaAnalysisOperationsConfig& WithDetectModerationLabels(DetectModerationLabelsT&& value) {
    SetDetectModerationLabels(std::forward<DetectModerationLabelsT>(value));
    return *this;
  }
  ///@}
 private:
