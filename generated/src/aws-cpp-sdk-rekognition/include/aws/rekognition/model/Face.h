...
class Face {
 public:
  ...
  inline Face& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  void SetIndexFacesModelVersion(IndexFacesModelVersionT&& value) {
    ...
    m_indexFacesModelVersion = std::forward<IndexFacesModelVersionT>(value);
  }
  template <typename IndexFacesModelVersionT = Aws::String>
  Face& WithIndexFacesModelVersion(IndexFacesModelVersionT&& value) {
    SetIndexFacesModelVersion(std::forward<IndexFacesModelVersionT>(value));
    return *this;
  }
  ///@}
