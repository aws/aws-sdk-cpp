...
class SegmentDetection {
 public:
  ...
  inline void SetType(SegmentType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline SegmentDetection& WithType(SegmentType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline SegmentDetection& WithStartTimestampMillis(long long value) {
  ...
  inline SegmentDetection& WithEndTimestampMillis(long long value) {
  ...
  inline SegmentDetection& WithDurationMillis(long long value) {
  ...
  void SetStartTimecodeSMPTE(StartTimecodeSMPTET&& value) {
    ...
    m_startTimecodeSMPTE = std::forward<StartTimecodeSMPTET>(value);
  }
  template <typename StartTimecodeSMPTET = Aws::String>
  SegmentDetection& WithStartTimecodeSMPTE(StartTimecodeSMPTET&& value) {
    SetStartTimecodeSMPTE(std::forward<StartTimecodeSMPTET>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndTimecodeSMPTE(EndTimecodeSMPTET&& value) {
    ...
    m_endTimecodeSMPTE = std::forward<EndTimecodeSMPTET>(value);
  }
  template <typename EndTimecodeSMPTET = Aws::String>
  SegmentDetection& WithEndTimecodeSMPTE(EndTimecodeSMPTET&& value) {
    SetEndTimecodeSMPTE(std::forward<EndTimecodeSMPTET>(value));
    return *this;
  }
  ///@}
  ...
  void SetDurationSMPTE(DurationSMPTET&& value) {
    ...
    m_durationSMPTE = std::forward<DurationSMPTET>(value);
  }
  template <typename DurationSMPTET = Aws::String>
  SegmentDetection& WithDurationSMPTE(DurationSMPTET&& value) {
    SetDurationSMPTE(std::forward<DurationSMPTET>(value));
    return *this;
  }
  ///@}
  ...
  void SetTechnicalCueSegment(TechnicalCueSegmentT&& value) {
    ...
    m_technicalCueSegment = std::forward<TechnicalCueSegmentT>(value);
  }
  template <typename TechnicalCueSegmentT = TechnicalCueSegment>
  SegmentDetection& WithTechnicalCueSegment(TechnicalCueSegmentT&& value) {
    SetTechnicalCueSegment(std::forward<TechnicalCueSegmentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShotSegment(ShotSegmentT&& value) {
    ...
    m_shotSegment = std::forward<ShotSegmentT>(value);
  }
  template <typename ShotSegmentT = ShotSegment>
  SegmentDetection& WithShotSegment(ShotSegmentT&& value) {
    SetShotSegment(std::forward<ShotSegmentT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStartFrameNumber(long long value) {
    m_startFrameNumberHasBeenSet = true;
    m_startFrameNumber = value;
  }
  inline SegmentDetection& WithStartFrameNumber(long long value) {
  ...
  inline void SetEndFrameNumber(long long value) {
    m_endFrameNumberHasBeenSet = true;
    m_endFrameNumber = value;
  }
  inline SegmentDetection& WithEndFrameNumber(long long value) {
  ...
  inline void SetDurationFrames(long long value) {
    m_durationFramesHasBeenSet = true;
    m_durationFrames = value;
  }
  inline SegmentDetection& WithDurationFrames(long long value) {
