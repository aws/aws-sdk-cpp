...
class SearchFacesResult {
 public:
  ...
  void SetSearchedFaceId(SearchedFaceIdT&& value) {
    ...
    m_searchedFaceId = std::forward<SearchedFaceIdT>(value);
  }
  template <typename SearchedFaceIdT = Aws::String>
  SearchFacesResult& WithSearchedFaceId(SearchedFaceIdT&& value) {
    SetSearchedFaceId(std::forward<SearchedFaceIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFaceMatches(FaceMatchesT&& value) {
    ...
    m_faceMatches = std::forward<FaceMatchesT>(value);
  }
  template <typename FaceMatchesT = Aws::Vector<FaceMatch>>
  SearchFacesResult& WithFaceMatches(FaceMatchesT&& value) {
    SetFaceMatches(std::forward<FaceMatchesT>(value));
    return *this;
  }
  template <typename FaceMatchesT = FaceMatch>
  SearchFacesResult& AddFaceMatches(FaceMatchesT&& value) {
    m_faceMatchesHasBeenSet = true;
    m_faceMatches.emplace_back(std::forward<FaceMatchesT>(value));
    return *this;
  }
  ///@}
