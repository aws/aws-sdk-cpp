...
class CreateFaceLivenessSessionRequestSettings {
 public:
  ...
  inline void SetAuditImagesLimit(int value) {
    m_auditImagesLimitHasBeenSet = true;
    m_auditImagesLimit = value;
  }
  inline CreateFaceLivenessSessionRequestSettings& WithAuditImagesLimit(int value) {
    SetAuditImagesLimit(value);
    return *this;
  }
  ///@}
  ...
  void SetChallengePreferences(ChallengePreferencesT&& value) {
    ...
    m_challengePreferences = std::forward<ChallengePreferencesT>(value);
  }
  template <typename ChallengePreferencesT = Aws::Vector<ChallengePreference>>
  CreateFaceLivenessSessionRequestSettings& WithChallengePreferences(ChallengePreferencesT&& value) {
    SetChallengePreferences(std::forward<ChallengePreferencesT>(value));
    return *this;
  }
  ...
  CreateFaceLivenessSessionRequestSettings& AddChallengePreferences(ChallengePreferencesT&& value) {
    m_challengePreferencesHasBeenSet = true;
    m_challengePreferences.emplace_back(std::forward<ChallengePreferencesT>(value));
    return *this;
  }
  ///@}
 private:
