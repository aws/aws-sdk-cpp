...
class ListMediaAnalysisJobsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListMediaAnalysisJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetMediaAnalysisJobs(MediaAnalysisJobsT&& value) {
    m_mediaAnalysisJobsHasBeenSet = true;
    m_mediaAnalysisJobs = std::forward<MediaAnalysisJobsT>(value);
  }
  template <typename MediaAnalysisJobsT = Aws::Vector<MediaAnalysisJobDescription>>
  ListMediaAnalysisJobsResult& WithMediaAnalysisJobs(MediaAnalysisJobsT&& value) {
    SetMediaAnalysisJobs(std::forward<MediaAnalysisJobsT>(value));
    return *this;
  }
  template <typename MediaAnalysisJobsT = MediaAnalysisJobDescription>
  ListMediaAnalysisJobsResult& AddMediaAnalysisJobs(MediaAnalysisJobsT&& value) {
    m_mediaAnalysisJobsHasBeenSet = true;
    m_mediaAnalysisJobs.emplace_back(std::forward<MediaAnalysisJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListMediaAnalysisJobsResult& WithRequestId(RequestIdT&& value) {
