...
class DetectTextResult {
 public:
  ...
  void SetTextDetections(TextDetectionsT&& value) {
    ...
    m_textDetections = std::forward<TextDetectionsT>(value);
  }
  template <typename TextDetectionsT = Aws::Vector<TextDetection>>
  DetectTextResult& WithTextDetections(TextDetectionsT&& value) {
    SetTextDetections(std::forward<TextDetectionsT>(value));
    return *this;
  }
  template <typename TextDetectionsT = TextDetection>
  DetectTextResult& AddTextDetections(TextDetectionsT&& value) {
    m_textDetectionsHasBeenSet = true;
    m_textDetections.emplace_back(std::forward<TextDetectionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextModelVersion(TextModelVersionT&& value) {
    ...
    m_textModelVersion = std::forward<TextModelVersionT>(value);
  }
  template <typename TextModelVersionT = Aws::String>
  DetectTextResult& WithTextModelVersion(TextModelVersionT&& value) {
    SetTextModelVersion(std::forward<TextModelVersionT>(value));
    return *this;
  }
  ///@}
