...
class IndexFacesResult {
 public:
  ...
  void SetFaceRecords(FaceRecordsT&& value) {
    m_faceRecordsHasBeenSet = true;
    m_faceRecords = std::forward<FaceRecordsT>(value);
  }
  template <typename FaceRecordsT = Aws::Vector<FaceRecord>>
  IndexFacesResult& WithFaceRecords(FaceRecordsT&& value) {
    SetFaceRecords(std::forward<FaceRecordsT>(value));
    return *this;
  }
  template <typename FaceRecordsT = FaceRecord>
  IndexFacesResult& AddFaceRecords(FaceRecordsT&& value) {
    m_faceRecordsHasBeenSet = true;
    m_faceRecords.emplace_back(std::forward<FaceRecordsT>(value));
    return *this;
  }
  ///@}
  ...
  inline IndexFacesResult& WithOrientationCorrection(OrientationCorrection value) {
  ...
  template <typename FaceModelVersionT = Aws::String>
  IndexFacesResult& WithFaceModelVersion(FaceModelVersionT&& value) {
  ...
  void SetUnindexedFaces(UnindexedFacesT&& value) {
    m_unindexedFacesHasBeenSet = true;
    m_unindexedFaces = std::forward<UnindexedFacesT>(value);
  }
  template <typename UnindexedFacesT = Aws::Vector<UnindexedFace>>
  IndexFacesResult& WithUnindexedFaces(UnindexedFacesT&& value) {
    SetUnindexedFaces(std::forward<UnindexedFacesT>(value));
    return *this;
  }
  template <typename UnindexedFacesT = UnindexedFace>
  IndexFacesResult& AddUnindexedFaces(UnindexedFacesT&& value) {
    m_unindexedFacesHasBeenSet = true;
    m_unindexedFaces.emplace_back(std::forward<UnindexedFacesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  IndexFacesResult& WithRequestId(RequestIdT&& value) {
