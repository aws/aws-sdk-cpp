...
class SearchFacesByImageRequest : public RekognitionRequest {
 public:
  ...
  inline SearchFacesByImageRequest& WithMaxFaces(int value) {
    SetMaxFaces(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFaceMatchThreshold(double value) {
    m_faceMatchThresholdHasBeenSet = true;
    m_faceMatchThreshold = value;
  }
  inline SearchFacesByImageRequest& WithFaceMatchThreshold(double value) {
  ...
  inline SearchFacesByImageRequest& WithQualityFilter(QualityFilter value) {
