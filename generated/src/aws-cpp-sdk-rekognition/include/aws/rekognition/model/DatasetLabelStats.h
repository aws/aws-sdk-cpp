...
class DatasetLabelStats {
 public:
  ...
  inline void SetEntryCount(int value) {
    m_entryCountHasBeenSet = true;
    m_entryCount = value;
  }
  inline DatasetLabelStats& WithEntryCount(int value) {
    SetEntryCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBoundingBoxCount(int value) {
    m_boundingBoxCountHasBeenSet = true;
    m_boundingBoxCount = value;
  }
  inline DatasetLabelStats& WithBoundingBoxCount(int value) {
    SetBoundingBoxCount(value);
    return *this;
  }
  ///@}
 private:
