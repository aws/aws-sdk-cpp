...
class GetContentModerationRequestMetadata {
 public:
  ...
  inline GetContentModerationRequestMetadata& WithSortBy(ContentModerationSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline GetContentModerationRequestMetadata& WithAggregateBy(ContentModerationAggregateBy value) {
