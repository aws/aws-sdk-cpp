...
class ListMediaAnalysisJobsRequest : public RekognitionRequest {
 public:
  AWS_REKOGNITION_API ListMediaAnalysisJobsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListMediaAnalysisJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMediaAnalysisJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
