...
class StreamProcessingStartSelector {
 public:
  ...
  void SetKVSStreamStartSelector(KVSStreamStartSelectorT&& value) {
    m_kVSStreamStartSelectorHasBeenSet = true;
    m_kVSStreamStartSelector = std::forward<KVSStreamStartSelectorT>(value);
  }
  template <typename KVSStreamStartSelectorT = KinesisVideoStreamStartSelector>
  StreamProcessingStartSelector& WithKVSStreamStartSelector(KVSStreamStartSelectorT&& value) {
    SetKVSStreamStartSelector(std::forward<KVSStreamStartSelectorT>(value));
    return *this;
  }
  ///@}
 private:
