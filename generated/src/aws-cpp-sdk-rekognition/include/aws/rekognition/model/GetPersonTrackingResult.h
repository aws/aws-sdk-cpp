...
class GetPersonTrackingResult {
 public:
  ...
  inline GetPersonTrackingResult& WithJobStatus(VideoJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  GetPersonTrackingResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename VideoMetadataT = VideoMetadata>
  GetPersonTrackingResult& WithVideoMetadata(VideoMetadataT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetPersonTrackingResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename PersonsT = Aws::Vector<PersonDetection>>
  GetPersonTrackingResult& WithPersons(PersonsT&& value) {
    SetPersons(std::forward<PersonsT>(value));
    return *this;
  }
  template <typename PersonsT = PersonDetection>
  GetPersonTrackingResult& AddPersons(PersonsT&& value) {
    m_personsHasBeenSet = true;
  ...
  template <typename JobIdT = Aws::String>
  GetPersonTrackingResult& WithJobId(JobIdT&& value) {
  ...
  template <typename VideoT = Video>
  GetPersonTrackingResult& WithVideo(VideoT&& value) {
  ...
  template <typename JobTagT = Aws::String>
  GetPersonTrackingResult& WithJobTag(JobTagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPersonTrackingResult& WithRequestId(RequestIdT&& value) {
