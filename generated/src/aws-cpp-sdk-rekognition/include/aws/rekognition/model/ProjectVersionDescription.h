...
class ProjectVersionDescription {
 public:
  ...
  inline ProjectVersionDescription& WithMinInferenceUnits(int value) {
  ...
  inline ProjectVersionDescription& WithStatus(ProjectVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBillableTrainingTimeInSeconds(long long value) {
    m_billableTrainingTimeInSecondsHasBeenSet = true;
    m_billableTrainingTimeInSeconds = value;
  }
  inline ProjectVersionDescription& WithBillableTrainingTimeInSeconds(long long value) {
    SetBillableTrainingTimeInSeconds(value);
    return *this;
  }
  ///@}
  ...
  void SetTrainingEndTimestamp(TrainingEndTimestampT&& value) {
    ...
    m_trainingEndTimestamp = std::forward<TrainingEndTimestampT>(value);
  }
  template <typename TrainingEndTimestampT = Aws::Utils::DateTime>
  ProjectVersionDescription& WithTrainingEndTimestamp(TrainingEndTimestampT&& value) {
    SetTrainingEndTimestamp(std::forward<TrainingEndTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingDataResult(TrainingDataResultT&& value) {
    ...
    m_trainingDataResult = std::forward<TrainingDataResultT>(value);
  }
  template <typename TrainingDataResultT = TrainingDataResult>
  ProjectVersionDescription& WithTrainingDataResult(TrainingDataResultT&& value) {
    SetTrainingDataResult(std::forward<TrainingDataResultT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTestingDataResult(TestingDataResultT&& value) {
    ...
    m_testingDataResult = std::forward<TestingDataResultT>(value);
  }
  template <typename TestingDataResultT = TestingDataResult>
  ProjectVersionDescription& WithTestingDataResult(TestingDataResultT&& value) {
    SetTestingDataResult(std::forward<TestingDataResultT>(value));
    return *this;
  }
  ///@}
  ...
  inline ProjectVersionDescription& WithMaxInferenceUnits(int value) {
  ...
  inline ProjectVersionDescription& WithFeature(CustomizationFeature value) {
    SetFeature(value);
    return *this;
  }
  ///@}
  ...
  void SetBaseModelVersion(BaseModelVersionT&& value) {
    ...
    m_baseModelVersion = std::forward<BaseModelVersionT>(value);
  }
  template <typename BaseModelVersionT = Aws::String>
  ProjectVersionDescription& WithBaseModelVersion(BaseModelVersionT&& value) {
    SetBaseModelVersion(std::forward<BaseModelVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFeatureConfig(FeatureConfigT&& value) {
    ...
    m_featureConfig = std::forward<FeatureConfigT>(value);
  }
  template <typename FeatureConfigT = CustomizationFeatureConfig>
  ProjectVersionDescription& WithFeatureConfig(FeatureConfigT&& value) {
    SetFeatureConfig(std::forward<FeatureConfigT>(value));
    return *this;
  }
  ///@}
 private:
