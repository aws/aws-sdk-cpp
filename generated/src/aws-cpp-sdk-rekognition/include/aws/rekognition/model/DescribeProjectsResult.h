...
class DescribeProjectsResult {
 public:
  ...
  void SetProjectDescriptions(ProjectDescriptionsT&& value) {
    m_projectDescriptionsHasBeenSet = true;
    m_projectDescriptions = std::forward<ProjectDescriptionsT>(value);
  }
  template <typename ProjectDescriptionsT = Aws::Vector<ProjectDescription>>
  DescribeProjectsResult& WithProjectDescriptions(ProjectDescriptionsT&& value) {
    SetProjectDescriptions(std::forward<ProjectDescriptionsT>(value));
    return *this;
  }
  ...
  DescribeProjectsResult& AddProjectDescriptions(ProjectDescriptionsT&& value) {
    m_projectDescriptionsHasBeenSet = true;
    m_projectDescriptions.emplace_back(std::forward<ProjectDescriptionsT>(value));
    return *this;
  }
  ///@}
