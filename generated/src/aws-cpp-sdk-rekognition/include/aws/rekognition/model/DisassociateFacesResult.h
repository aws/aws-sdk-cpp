...
class DisassociateFacesResult {
 public:
  ...
  void SetDisassociatedFaces(DisassociatedFacesT&& value) {
    ...
    m_disassociatedFaces = std::forward<DisassociatedFacesT>(value);
  }
  template <typename DisassociatedFacesT = Aws::Vector<DisassociatedFace>>
  DisassociateFacesResult& WithDisassociatedFaces(DisassociatedFacesT&& value) {
    SetDisassociatedFaces(std::forward<DisassociatedFacesT>(value));
    return *this;
  }
  ...
  DisassociateFacesResult& AddDisassociatedFaces(DisassociatedFacesT&& value) {
    m_disassociatedFacesHasBeenSet = true;
    m_disassociatedFaces.emplace_back(std::forward<DisassociatedFacesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<UnsuccessfulFaceDisassociation>& GetUnsuccessfulFaceDisassociations() const {
    return m_unsuccessfulFaceDisassociations;
  }
  ...
  void SetUnsuccessfulFaceDisassociations(UnsuccessfulFaceDisassociationsT&& value) {
    ...
    m_unsuccessfulFaceDisassociations = std::forward<UnsuccessfulFaceDisassociationsT>(value);
  }
  template <typename UnsuccessfulFaceDisassociationsT = Aws::Vector<UnsuccessfulFaceDisassociation>>
  DisassociateFacesResult& WithUnsuccessfulFaceDisassociations(UnsuccessfulFaceDisassociationsT&& value) {
    SetUnsuccessfulFaceDisassociations(std::forward<UnsuccessfulFaceDisassociationsT>(value));
    return *this;
  }
  ...
  DisassociateFacesResult& AddUnsuccessfulFaceDisassociations(UnsuccessfulFaceDisassociationsT&& value) {
    m_unsuccessfulFaceDisassociationsHasBeenSet = true;
    m_unsuccessfulFaceDisassociations.emplace_back(std::forward<UnsuccessfulFaceDisassociationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DisassociateFacesResult& WithUserStatus(UserStatus value) {
    SetUserStatus(value);
    return *this;
  }
  ///@}
