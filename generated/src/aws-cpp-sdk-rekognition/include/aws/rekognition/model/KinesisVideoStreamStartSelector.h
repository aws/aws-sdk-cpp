...
class KinesisVideoStreamStartSelector {
 public:
  ...
  inline void SetProducerTimestamp(long long value) {
    m_producerTimestampHasBeenSet = true;
    m_producerTimestamp = value;
  }
  inline KinesisVideoStreamStartSelector& WithProducerTimestamp(long long value) {
    SetProducerTimestamp(value);
    return *this;
  }
  ///@}
  ...
  template <typename FragmentNumberT = Aws::String>
  KinesisVideoStreamStartSelector& WithFragmentNumber(FragmentNumberT&& value) {
