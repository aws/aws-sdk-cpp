...
namespace Model
{
  ...
  {
  public:
    AWS_REKOGNITION_API StartCelebrityRecognitionResult() = default;
    ...
    template<typename JobIdT = Aws::String>
    StartCelebrityRecognitionResult& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartCelebrityRecognitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
