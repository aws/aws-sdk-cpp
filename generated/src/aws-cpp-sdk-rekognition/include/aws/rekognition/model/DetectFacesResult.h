...
class DetectFacesResult {
 public:
  ...
  void SetFaceDetails(FaceDetailsT&& value) {
    m_faceDetailsHasBeenSet = true;
    m_faceDetails = std::forward<FaceDetailsT>(value);
  }
  template <typename FaceDetailsT = Aws::Vector<FaceDetail>>
  DetectFacesResult& WithFaceDetails(FaceDetailsT&& value) {
    SetFaceDetails(std::forward<FaceDetailsT>(value));
    return *this;
  }
  template <typename FaceDetailsT = FaceDetail>
  DetectFacesResult& AddFaceDetails(FaceDetailsT&& value) {
    m_faceDetailsHasBeenSet = true;
    m_faceDetails.emplace_back(std::forward<FaceDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DetectFacesResult& WithOrientationCorrection(OrientationCorrection value) {
  ...
  template <typename RequestIdT = Aws::String>
  DetectFacesResult& WithRequestId(RequestIdT&& value) {
