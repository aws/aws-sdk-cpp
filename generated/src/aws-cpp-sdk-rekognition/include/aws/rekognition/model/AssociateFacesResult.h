...
class AssociateFacesResult {
 public:
  ...
  void SetAssociatedFaces(AssociatedFacesT&& value) {
    m_associatedFacesHasBeenSet = true;
    m_associatedFaces = std::forward<AssociatedFacesT>(value);
  }
  template <typename AssociatedFacesT = Aws::Vector<AssociatedFace>>
  AssociateFacesResult& WithAssociatedFaces(AssociatedFacesT&& value) {
    SetAssociatedFaces(std::forward<AssociatedFacesT>(value));
    return *this;
  }
  template <typename AssociatedFacesT = AssociatedFace>
  AssociateFacesResult& AddAssociatedFaces(AssociatedFacesT&& value) {
    m_associatedFacesHasBeenSet = true;
    m_associatedFaces.emplace_back(std::forward<AssociatedFacesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnsuccessfulFaceAssociations(UnsuccessfulFaceAssociationsT&& value) {
    m_unsuccessfulFaceAssociationsHasBeenSet = true;
    m_unsuccessfulFaceAssociations = std::forward<UnsuccessfulFaceAssociationsT>(value);
  }
  template <typename UnsuccessfulFaceAssociationsT = Aws::Vector<UnsuccessfulFaceAssociation>>
  AssociateFacesResult& WithUnsuccessfulFaceAssociations(UnsuccessfulFaceAssociationsT&& value) {
    SetUnsuccessfulFaceAssociations(std::forward<UnsuccessfulFaceAssociationsT>(value));
    return *this;
  }
  template <typename UnsuccessfulFaceAssociationsT = UnsuccessfulFaceAssociation>
  AssociateFacesResult& AddUnsuccessfulFaceAssociations(UnsuccessfulFaceAssociationsT&& value) {
    m_unsuccessfulFaceAssociationsHasBeenSet = true;
    m_unsuccessfulFaceAssociations.emplace_back(std::forward<UnsuccessfulFaceAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline AssociateFacesResult& WithUserStatus(UserStatus value) {
    SetUserStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AssociateFacesResult& WithRequestId(RequestIdT&& value) {
