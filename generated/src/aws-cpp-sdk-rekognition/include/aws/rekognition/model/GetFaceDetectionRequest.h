...
class GetFaceDetectionRequest : public RekognitionRequest {
 public:
  AWS_REKOGNITION_API GetFaceDetectionRequest() = default;
  ...
  template <typename JobIdT = Aws::String>
  GetFaceDetectionRequest& WithJobId(JobIdT&& value) {
  ...
  inline GetFaceDetectionRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetFaceDetectionRequest& WithNextToken(NextTokenT&& value) {
