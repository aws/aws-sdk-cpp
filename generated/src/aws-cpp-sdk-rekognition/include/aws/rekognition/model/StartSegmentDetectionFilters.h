...
class StartSegmentDetectionFilters {
 public:
  ...
  void SetTechnicalCueFilter(TechnicalCueFilterT&& value) {
    m_technicalCueFilterHasBeenSet = true;
    m_technicalCueFilter = std::forward<TechnicalCueFilterT>(value);
  }
  template <typename TechnicalCueFilterT = StartTechnicalCueDetectionFilter>
  StartSegmentDetectionFilters& WithTechnicalCueFilter(TechnicalCueFilterT&& value) {
    SetTechnicalCueFilter(std::forward<TechnicalCueFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShotFilter(ShotFilterT&& value) {
    m_shotFilterHasBeenSet = true;
    m_shotFilter = std::forward<ShotFilterT>(value);
  }
  template <typename ShotFilterT = StartShotDetectionFilter>
  StartSegmentDetectionFilters& WithShotFilter(ShotFilterT&& value) {
    SetShotFilter(std::forward<ShotFilterT>(value));
    return *this;
  }
  ///@}
 private:
