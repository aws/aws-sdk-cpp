...
class DescribeCollectionResult {
 public:
  ...
  inline void SetFaceCount(long long value) {
    m_faceCountHasBeenSet = true;
    m_faceCount = value;
  }
  inline DescribeCollectionResult& WithFaceCount(long long value) {
    SetFaceCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUserCount(long long value) {
    m_userCountHasBeenSet = true;
    m_userCount = value;
  }
  inline DescribeCollectionResult& WithUserCount(long long value) {
    SetUserCount(value);
    return *this;
  }
  ///@}
