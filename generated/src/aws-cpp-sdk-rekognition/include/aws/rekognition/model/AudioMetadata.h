...
class AudioMetadata {
 public:
  ...
  template <typename CodecT = Aws::String>
  AudioMetadata& WithCodec(CodecT&& value) {
  ...
  inline AudioMetadata& WithDurationMillis(long long value) {
  ...
  inline AudioMetadata& WithSampleRate(long long value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfChannels(long long value) {
    m_numberOfChannelsHasBeenSet = true;
    m_numberOfChannels = value;
  }
  inline AudioMetadata& WithNumberOfChannels(long long value) {
