...
class StartFaceDetectionResult {
 public:
  AWS_REKOGNITION_API StartFaceDetectionResult() = default;
  ...
  template <typename JobIdT = Aws::String>
  StartFaceDetectionResult& WithJobId(JobIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartFaceDetectionResult& WithRequestId(RequestIdT&& value) {
