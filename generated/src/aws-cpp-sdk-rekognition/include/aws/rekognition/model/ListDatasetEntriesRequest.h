...
class ListDatasetEntriesRequest : public RekognitionRequest {
 public:
  ...
  void SetContainsLabels(ContainsLabelsT&& value) {
    m_containsLabelsHasBeenSet = true;
    m_containsLabels = std::forward<ContainsLabelsT>(value);
  }
  template <typename ContainsLabelsT = Aws::Vector<Aws::String>>
  ListDatasetEntriesRequest& WithContainsLabels(ContainsLabelsT&& value) {
    SetContainsLabels(std::forward<ContainsLabelsT>(value));
    return *this;
  }
  template <typename ContainsLabelsT = Aws::String>
  ListDatasetEntriesRequest& AddContainsLabels(ContainsLabelsT&& value) {
    m_containsLabelsHasBeenSet = true;
    m_containsLabels.emplace_back(std::forward<ContainsLabelsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLabeled(bool value) {
    m_labeledHasBeenSet = true;
    m_labeled = value;
  }
  inline ListDatasetEntriesRequest& WithLabeled(bool value) {
    SetLabeled(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceRefContains(SourceRefContainsT&& value) {
    m_sourceRefContainsHasBeenSet = true;
    m_sourceRefContains = std::forward<SourceRefContainsT>(value);
  }
  template <typename SourceRefContainsT = Aws::String>
  ListDatasetEntriesRequest& WithSourceRefContains(SourceRefContainsT&& value) {
    SetSourceRefContains(std::forward<SourceRefContainsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHasErrors(bool value) {
    m_hasErrorsHasBeenSet = true;
    m_hasErrors = value;
  }
  inline ListDatasetEntriesRequest& WithHasErrors(bool value) {
    SetHasErrors(value);
    return *this;
  }
  ///@}
  ...
  inline ListDatasetEntriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
