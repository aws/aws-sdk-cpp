...
class IndexFacesRequest : public RekognitionRequest {
 public:
  ...
  void SetExternalImageId(ExternalImageIdT&& value) {
    ...
    m_externalImageId = std::forward<ExternalImageIdT>(value);
  }
  template <typename ExternalImageIdT = Aws::String>
  IndexFacesRequest& WithExternalImageId(ExternalImageIdT&& value) {
    SetExternalImageId(std::forward<ExternalImageIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDetectionAttributes(DetectionAttributesT&& value) {
    m_detectionAttributesHasBeenSet = true;
    m_detectionAttributes = std::forward<DetectionAttributesT>(value);
  }
  template <typename DetectionAttributesT = Aws::Vector<Attribute>>
  IndexFacesRequest& WithDetectionAttributes(DetectionAttributesT&& value) {
    SetDetectionAttributes(std::forward<DetectionAttributesT>(value));
    return *this;
  }
  inline IndexFacesRequest& AddDetectionAttributes(Attribute value) {
    m_detectionAttributesHasBeenSet = true;
    m_detectionAttributes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxFaces(int value) {
    m_maxFacesHasBeenSet = true;
    m_maxFaces = value;
  }
  inline IndexFacesRequest& WithMaxFaces(int value) {
    SetMaxFaces(value);
    return *this;
  }
  ///@}
  ...
  inline IndexFacesRequest& WithQualityFilter(QualityFilter value) {
