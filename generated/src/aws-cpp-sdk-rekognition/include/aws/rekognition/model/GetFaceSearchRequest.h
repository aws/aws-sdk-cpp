...
class GetFaceSearchRequest : public RekognitionRequest {
 public:
  ...
  inline GetFaceSearchRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(FaceSearchSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline GetFaceSearchRequest& WithSortBy(FaceSearchSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
