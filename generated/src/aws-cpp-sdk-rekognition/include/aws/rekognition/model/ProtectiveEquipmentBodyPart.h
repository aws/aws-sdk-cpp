...
class ProtectiveEquipmentBodyPart {
 public:
  ...
  inline void SetName(BodyPart value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ProtectiveEquipmentBodyPart& WithName(BodyPart value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline ProtectiveEquipmentBodyPart& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  void SetEquipmentDetections(EquipmentDetectionsT&& value) {
    ...
    m_equipmentDetections = std::forward<EquipmentDetectionsT>(value);
  }
  template <typename EquipmentDetectionsT = Aws::Vector<EquipmentDetection>>
  ProtectiveEquipmentBodyPart& WithEquipmentDetections(EquipmentDetectionsT&& value) {
    SetEquipmentDetections(std::forward<EquipmentDetectionsT>(value));
    return *this;
  }
  ...
  ProtectiveEquipmentBodyPart& AddEquipmentDetections(EquipmentDetectionsT&& value) {
    m_equipmentDetectionsHasBeenSet = true;
    m_equipmentDetections.emplace_back(std::forward<EquipmentDetectionsT>(value));
    return *this;
  }
  ///@}
 private:
