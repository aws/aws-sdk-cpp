...
class ModerationLabel {
 public:
  ...
  inline ModerationLabel& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  void SetParentName(ParentNameT&& value) {
    ...
    m_parentName = std::forward<ParentNameT>(value);
  }
  template <typename ParentNameT = Aws::String>
  ModerationLabel& WithParentName(ParentNameT&& value) {
    SetParentName(std::forward<ParentNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTaxonomyLevel(int value) {
    m_taxonomyLevelHasBeenSet = true;
    m_taxonomyLevel = value;
  }
  inline ModerationLabel& WithTaxonomyLevel(int value) {
    SetTaxonomyLevel(value);
    return *this;
  }
  ///@}
 private:
