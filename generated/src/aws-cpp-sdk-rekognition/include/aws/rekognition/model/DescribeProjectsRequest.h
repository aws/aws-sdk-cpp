...
class DescribeProjectsRequest : public RekognitionRequest {
 public:
  ...
  inline DescribeProjectsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeProjectsRequest& AddFeatures(CustomizationFeature value) {
    m_featuresHasBeenSet = true;
