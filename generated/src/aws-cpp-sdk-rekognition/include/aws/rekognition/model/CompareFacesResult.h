...
class CompareFacesResult {
 public:
  ...
  void SetSourceImageFace(SourceImageFaceT&& value) {
    ...
    m_sourceImageFace = std::forward<SourceImageFaceT>(value);
  }
  template <typename SourceImageFaceT = ComparedSourceImageFace>
  CompareFacesResult& WithSourceImageFace(SourceImageFaceT&& value) {
    SetSourceImageFace(std::forward<SourceImageFaceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnmatchedFaces(UnmatchedFacesT&& value) {
    ...
    m_unmatchedFaces = std::forward<UnmatchedFacesT>(value);
  }
  template <typename UnmatchedFacesT = Aws::Vector<ComparedFace>>
  CompareFacesResult& WithUnmatchedFaces(UnmatchedFacesT&& value) {
    SetUnmatchedFaces(std::forward<UnmatchedFacesT>(value));
    return *this;
  }
  template <typename UnmatchedFacesT = ComparedFace>
  CompareFacesResult& AddUnmatchedFaces(UnmatchedFacesT&& value) {
    m_unmatchedFacesHasBeenSet = true;
    m_unmatchedFaces.emplace_back(std::forward<UnmatchedFacesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSourceImageOrientationCorrection(OrientationCorrection value) {
    m_sourceImageOrientationCorrectionHasBeenSet = true;
    m_sourceImageOrientationCorrection = value;
  }
  inline CompareFacesResult& WithSourceImageOrientationCorrection(OrientationCorrection value) {
    SetSourceImageOrientationCorrection(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetImageOrientationCorrection(OrientationCorrection value) {
    m_targetImageOrientationCorrectionHasBeenSet = true;
    m_targetImageOrientationCorrection = value;
  }
  inline CompareFacesResult& WithTargetImageOrientationCorrection(OrientationCorrection value) {
    SetTargetImageOrientationCorrection(value);
    return *this;
  }
  ///@}
