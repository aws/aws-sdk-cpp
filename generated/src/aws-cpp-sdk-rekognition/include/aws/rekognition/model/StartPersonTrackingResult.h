...
namespace Model
{
  ...
  {
  public:
    AWS_REKOGNITION_API StartPersonTrackingResult() = default;
    ...
    template<typename JobIdT = Aws::String>
    StartPersonTrackingResult& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartPersonTrackingResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
