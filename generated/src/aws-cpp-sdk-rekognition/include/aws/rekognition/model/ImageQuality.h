...
class ImageQuality {
 public:
  ...
  inline void SetBrightness(double value) {
    m_brightnessHasBeenSet = true;
    m_brightness = value;
  }
  inline ImageQuality& WithBrightness(double value) {
    SetBrightness(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSharpness(double value) {
    m_sharpnessHasBeenSet = true;
    m_sharpness = value;
  }
  inline ImageQuality& WithSharpness(double value) {
    SetSharpness(value);
    return *this;
  }
  ///@}
