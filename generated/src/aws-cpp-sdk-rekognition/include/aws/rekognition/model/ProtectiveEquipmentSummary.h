...
class ProtectiveEquipmentSummary {
 public:
  ...
  void SetPersonsWithRequiredEquipment(PersonsWithRequiredEquipmentT&& value) {
    ...
    m_personsWithRequiredEquipment = std::forward<PersonsWithRequiredEquipmentT>(value);
  }
  template <typename PersonsWithRequiredEquipmentT = Aws::Vector<int>>
  ProtectiveEquipmentSummary& WithPersonsWithRequiredEquipment(PersonsWithRequiredEquipmentT&& value) {
    SetPersonsWithRequiredEquipment(std::forward<PersonsWithRequiredEquipmentT>(value));
    return *this;
  }
  inline ProtectiveEquipmentSummary& AddPersonsWithRequiredEquipment(int value) {
    m_personsWithRequiredEquipmentHasBeenSet = true;
    m_personsWithRequiredEquipment.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetPersonsWithoutRequiredEquipment(PersonsWithoutRequiredEquipmentT&& value) {
    ...
    m_personsWithoutRequiredEquipment = std::forward<PersonsWithoutRequiredEquipmentT>(value);
  }
  template <typename PersonsWithoutRequiredEquipmentT = Aws::Vector<int>>
  ProtectiveEquipmentSummary& WithPersonsWithoutRequiredEquipment(PersonsWithoutRequiredEquipmentT&& value) {
    SetPersonsWithoutRequiredEquipment(std::forward<PersonsWithoutRequiredEquipmentT>(value));
    return *this;
  }
  inline ProtectiveEquipmentSummary& AddPersonsWithoutRequiredEquipment(int value) {
    m_personsWithoutRequiredEquipmentHasBeenSet = true;
    m_personsWithoutRequiredEquipment.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetPersonsIndeterminate(PersonsIndeterminateT&& value) {
    m_personsIndeterminateHasBeenSet = true;
    m_personsIndeterminate = std::forward<PersonsIndeterminateT>(value);
  }
  template <typename PersonsIndeterminateT = Aws::Vector<int>>
  ProtectiveEquipmentSummary& WithPersonsIndeterminate(PersonsIndeterminateT&& value) {
    SetPersonsIndeterminate(std::forward<PersonsIndeterminateT>(value));
    return *this;
  }
  inline ProtectiveEquipmentSummary& AddPersonsIndeterminate(int value) {
    m_personsIndeterminateHasBeenSet = true;
    m_personsIndeterminate.push_back(value);
    return *this;
  }
  ///@}
 private:
