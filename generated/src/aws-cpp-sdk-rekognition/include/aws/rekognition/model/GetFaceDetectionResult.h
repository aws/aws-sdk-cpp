...
class GetFaceDetectionResult {
 public:
  ...
  inline GetFaceDetectionResult& WithJobStatus(VideoJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
