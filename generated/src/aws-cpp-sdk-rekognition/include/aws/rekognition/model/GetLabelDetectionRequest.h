...
class GetLabelDetectionRequest : public RekognitionRequest {
 public:
  ...
  inline GetLabelDetectionRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline GetLabelDetectionRequest& WithSortBy(LabelDetectionSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline GetLabelDetectionRequest& WithAggregateBy(LabelDetectionAggregateBy value) {
