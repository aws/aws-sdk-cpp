...
/**
 */
class GetPersonTrackingRequest : public RekognitionRequest {
 public:
  AWS_REKOGNITION_API GetPersonTrackingRequest() = default;
  ...
  template <typename JobIdT = Aws::String>
  GetPersonTrackingRequest& WithJobId(JobIdT&& value) {
  ...
  inline GetPersonTrackingRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetPersonTrackingRequest& WithNextToken(NextTokenT&& value) {
   ...
   */
  inline PersonTrackingSortBy GetSortBy() const { return m_sortBy; }
  inline bool SortByHasBeenSet() const { return m_sortByHasBeenSet; }
  inline void SetSortBy(PersonTrackingSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline GetPersonTrackingRequest& WithSortBy(PersonTrackingSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
