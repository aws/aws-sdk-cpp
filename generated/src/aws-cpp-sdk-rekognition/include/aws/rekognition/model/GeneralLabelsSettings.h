...
class GeneralLabelsSettings {
 public:
  ...
  void SetLabelInclusionFilters(LabelInclusionFiltersT&& value) {
    ...
    m_labelInclusionFilters = std::forward<LabelInclusionFiltersT>(value);
  }
  template <typename LabelInclusionFiltersT = Aws::Vector<Aws::String>>
  GeneralLabelsSettings& WithLabelInclusionFilters(LabelInclusionFiltersT&& value) {
    SetLabelInclusionFilters(std::forward<LabelInclusionFiltersT>(value));
    return *this;
  }
  ...
  GeneralLabelsSettings& AddLabelInclusionFilters(LabelInclusionFiltersT&& value) {
    m_labelInclusionFiltersHasBeenSet = true;
    m_labelInclusionFilters.emplace_back(std::forward<LabelInclusionFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLabelExclusionFilters(LabelExclusionFiltersT&& value) {
    ...
    m_labelExclusionFilters = std::forward<LabelExclusionFiltersT>(value);
  }
  template <typename LabelExclusionFiltersT = Aws::Vector<Aws::String>>
  GeneralLabelsSettings& WithLabelExclusionFilters(LabelExclusionFiltersT&& value) {
    SetLabelExclusionFilters(std::forward<LabelExclusionFiltersT>(value));
    return *this;
  }
  ...
  GeneralLabelsSettings& AddLabelExclusionFilters(LabelExclusionFiltersT&& value) {
    m_labelExclusionFiltersHasBeenSet = true;
    m_labelExclusionFilters.emplace_back(std::forward<LabelExclusionFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLabelCategoryInclusionFilters(LabelCategoryInclusionFiltersT&& value) {
    ...
    m_labelCategoryInclusionFilters = std::forward<LabelCategoryInclusionFiltersT>(value);
  }
  template <typename LabelCategoryInclusionFiltersT = Aws::Vector<Aws::String>>
  GeneralLabelsSettings& WithLabelCategoryInclusionFilters(LabelCategoryInclusionFiltersT&& value) {
    SetLabelCategoryInclusionFilters(std::forward<LabelCategoryInclusionFiltersT>(value));
    return *this;
  }
  ...
  GeneralLabelsSettings& AddLabelCategoryInclusionFilters(LabelCategoryInclusionFiltersT&& value) {
    m_labelCategoryInclusionFiltersHasBeenSet = true;
    m_labelCategoryInclusionFilters.emplace_back(std::forward<LabelCategoryInclusionFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLabelCategoryExclusionFilters(LabelCategoryExclusionFiltersT&& value) {
    ...
    m_labelCategoryExclusionFilters = std::forward<LabelCategoryExclusionFiltersT>(value);
  }
  template <typename LabelCategoryExclusionFiltersT = Aws::Vector<Aws::String>>
  GeneralLabelsSettings& WithLabelCategoryExclusionFilters(LabelCategoryExclusionFiltersT&& value) {
    SetLabelCategoryExclusionFilters(std::forward<LabelCategoryExclusionFiltersT>(value));
    return *this;
  }
  ...
  GeneralLabelsSettings& AddLabelCategoryExclusionFilters(LabelCategoryExclusionFiltersT&& value) {
    m_labelCategoryExclusionFiltersHasBeenSet = true;
    m_labelCategoryExclusionFilters.emplace_back(std::forward<LabelCategoryExclusionFiltersT>(value));
    return *this;
  }
  ///@}
 private:
