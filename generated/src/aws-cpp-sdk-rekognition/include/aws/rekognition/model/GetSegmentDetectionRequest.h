...
class GetSegmentDetectionRequest : public RekognitionRequest {
 public:
  ...
  template <typename JobIdT = Aws::String>
  GetSegmentDetectionRequest& WithJobId(JobIdT&& value) {
  ...
  inline GetSegmentDetectionRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetSegmentDetectionRequest& WithNextToken(NextTokenT&& value) {
