...
namespace Model
{
  ...
  public:
    ...
    template<typename VideoT = Video>
    StartCelebrityRecognitionRequest& WithVideo(VideoT&& value) { SetVideo(std::forward<VideoT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientRequestTokenT = Aws::String>
    StartCelebrityRecognitionRequest& WithClientRequestToken(ClientRequestTokenT&& value) { SetClientRequestToken(std::forward<ClientRequestTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename NotificationChannelT = NotificationChannel>
    StartCelebrityRecognitionRequest& WithNotificationChannel(NotificationChannelT&& value) { SetNotificationChannel(std::forward<NotificationChannelT>(value)); return *this;}
    ///@}
    ...
    template<typename JobTagT = Aws::String>
    StartCelebrityRecognitionRequest& WithJobTag(JobTagT&& value) { SetJobTag(std::forward<JobTagT>(value)); return *this;}
    ///@}
  private:
