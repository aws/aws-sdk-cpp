...
class TextDetectionResult {
 public:
  ...
  inline TextDetectionResult& WithTimestamp(long long value) {
    SetTimestamp(value);
    return *this;
  }
  ///@}
  ...
  void SetTextDetection(TextDetectionT&& value) {
    m_textDetectionHasBeenSet = true;
    m_textDetection = std::forward<TextDetectionT>(value);
  }
  template <typename TextDetectionT = TextDetection>
  TextDetectionResult& WithTextDetection(TextDetectionT&& value) {
    SetTextDetection(std::forward<TextDetectionT>(value));
    return *this;
  }
  ///@}
 private:
