...
class CompareFacesRequest : public RekognitionRequest {
 public:
  ...
  void SetTargetImage(TargetImageT&& value) {
    m_targetImageHasBeenSet = true;
    m_targetImage = std::forward<TargetImageT>(value);
  }
  template <typename TargetImageT = Image>
  CompareFacesRequest& WithTargetImage(TargetImageT&& value) {
    SetTargetImage(std::forward<TargetImageT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSimilarityThreshold(double value) {
    m_similarityThresholdHasBeenSet = true;
    m_similarityThreshold = value;
  }
  inline CompareFacesRequest& WithSimilarityThreshold(double value) {
  ...
  inline void SetQualityFilter(QualityFilter value) {
    m_qualityFilterHasBeenSet = true;
    m_qualityFilter = value;
  }
  inline CompareFacesRequest& WithQualityFilter(QualityFilter value) {
