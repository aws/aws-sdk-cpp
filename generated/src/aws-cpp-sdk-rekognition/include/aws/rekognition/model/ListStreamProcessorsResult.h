...
class ListStreamProcessorsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListStreamProcessorsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetStreamProcessors(StreamProcessorsT&& value) {
    m_streamProcessorsHasBeenSet = true;
    m_streamProcessors = std::forward<StreamProcessorsT>(value);
  }
  template <typename StreamProcessorsT = Aws::Vector<StreamProcessor>>
  ListStreamProcessorsResult& WithStreamProcessors(StreamProcessorsT&& value) {
    SetStreamProcessors(std::forward<StreamProcessorsT>(value));
    return *this;
  }
  template <typename StreamProcessorsT = StreamProcessor>
  ListStreamProcessorsResult& AddStreamProcessors(StreamProcessorsT&& value) {
    m_streamProcessorsHasBeenSet = true;
    m_streamProcessors.emplace_back(std::forward<StreamProcessorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListStreamProcessorsResult& WithRequestId(RequestIdT&& value) {
