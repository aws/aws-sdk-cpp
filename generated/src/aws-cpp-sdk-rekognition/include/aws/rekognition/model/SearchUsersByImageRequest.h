...
class SearchUsersByImageRequest : public RekognitionRequest {
 public:
  ...
  inline void SetUserMatchThreshold(double value) {
    m_userMatchThresholdHasBeenSet = true;
    m_userMatchThreshold = value;
  }
  inline SearchUsersByImageRequest& WithUserMatchThreshold(double value) {
    SetUserMatchThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxUsers(int value) {
    m_maxUsersHasBeenSet = true;
    m_maxUsers = value;
  }
  inline SearchUsersByImageRequest& WithMaxUsers(int value) {
    SetMaxUsers(value);
    return *this;
  }
  ///@}
  ...
  inline SearchUsersByImageRequest& WithQualityFilter(QualityFilter value) {
