...
class GetCelebrityRecognitionRequest : public RekognitionRequest {
 public:
  ...
  inline GetCelebrityRecognitionRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(CelebrityRecognitionSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline GetCelebrityRecognitionRequest& WithSortBy(CelebrityRecognitionSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
