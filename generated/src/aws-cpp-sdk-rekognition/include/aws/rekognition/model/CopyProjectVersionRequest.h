...
class CopyProjectVersionRequest : public RekognitionRequest {
 public:
  ...
  void SetSourceProjectArn(SourceProjectArnT&& value) {
    m_sourceProjectArnHasBeenSet = true;
    m_sourceProjectArn = std::forward<SourceProjectArnT>(value);
  }
  template <typename SourceProjectArnT = Aws::String>
  CopyProjectVersionRequest& WithSourceProjectArn(SourceProjectArnT&& value) {
    SetSourceProjectArn(std::forward<SourceProjectArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceProjectVersionArn(SourceProjectVersionArnT&& value) {
    ...
    m_sourceProjectVersionArn = std::forward<SourceProjectVersionArnT>(value);
  }
  template <typename SourceProjectVersionArnT = Aws::String>
  CopyProjectVersionRequest& WithSourceProjectVersionArn(SourceProjectVersionArnT&& value) {
    SetSourceProjectVersionArn(std::forward<SourceProjectVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationProjectArn(DestinationProjectArnT&& value) {
    m_destinationProjectArnHasBeenSet = true;
    m_destinationProjectArn = std::forward<DestinationProjectArnT>(value);
  }
  template <typename DestinationProjectArnT = Aws::String>
  CopyProjectVersionRequest& WithDestinationProjectArn(DestinationProjectArnT&& value) {
    SetDestinationProjectArn(std::forward<DestinationProjectArnT>(value));
    return *this;
  }
  ///@}
