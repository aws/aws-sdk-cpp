...
class ListStreamProcessorsRequest : public RekognitionRequest {
 public:
  AWS_REKOGNITION_API ListStreamProcessorsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListStreamProcessorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStreamProcessorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
