...
class GetFaceSearchResult {
 public:
  ...
  inline GetFaceSearchResult& WithJobStatus(VideoJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
