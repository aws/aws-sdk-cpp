...
class DetectLabelsImageQuality {
 public:
  ...
  inline DetectLabelsImageQuality& WithBrightness(double value) {
    SetBrightness(value);
    return *this;
  }
  ///@}
  ...
  inline DetectLabelsImageQuality& WithSharpness(double value) {
    SetSharpness(value);
    return *this;
  }
  ///@}
  ...
  inline void SetContrast(double value) {
    m_contrastHasBeenSet = true;
    m_contrast = value;
  }
  inline DetectLabelsImageQuality& WithContrast(double value) {
    SetContrast(value);
    return *this;
  }
  ///@}
