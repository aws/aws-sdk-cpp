...
class ContentModerationDetection {
 public:
  ...
  inline ContentModerationDetection& WithTimestamp(long long value) {
    SetTimestamp(value);
    return *this;
  }
  ///@}
  ...
  void SetModerationLabel(ModerationLabelT&& value) {
    ...
    m_moderationLabel = std::forward<ModerationLabelT>(value);
  }
  template <typename ModerationLabelT = ModerationLabel>
  ContentModerationDetection& WithModerationLabel(ModerationLabelT&& value) {
    SetModerationLabel(std::forward<ModerationLabelT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStartTimestampMillis(long long value) {
    m_startTimestampMillisHasBeenSet = true;
    m_startTimestampMillis = value;
  }
  inline ContentModerationDetection& WithStartTimestampMillis(long long value) {
    SetStartTimestampMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEndTimestampMillis(long long value) {
    m_endTimestampMillisHasBeenSet = true;
    m_endTimestampMillis = value;
  }
  inline ContentModerationDetection& WithEndTimestampMillis(long long value) {
    SetEndTimestampMillis(value);
    return *this;
  }
  ///@}
  ...
  inline ContentModerationDetection& WithDurationMillis(long long value) {
