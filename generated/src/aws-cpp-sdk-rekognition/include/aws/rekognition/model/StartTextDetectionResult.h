...
class StartTextDetectionResult {
 public:
  AWS_REKOGNITION_API StartTextDetectionResult() = default;
  ...
  template <typename JobIdT = Aws::String>
  StartTextDetectionResult& WithJobId(JobIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartTextDetectionResult& WithRequestId(RequestIdT&& value) {
