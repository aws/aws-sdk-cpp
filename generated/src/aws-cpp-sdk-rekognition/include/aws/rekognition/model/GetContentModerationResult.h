...
class GetContentModerationResult {
 public:
  ...
  inline GetContentModerationResult& WithJobStatus(VideoJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetGetRequestMetadata(GetRequestMetadataT&& value) {
    ...
    m_getRequestMetadata = std::forward<GetRequestMetadataT>(value);
  }
  template <typename GetRequestMetadataT = GetContentModerationRequestMetadata>
  GetContentModerationResult& WithGetRequestMetadata(GetRequestMetadataT&& value) {
    SetGetRequestMetadata(std::forward<GetRequestMetadataT>(value));
    return *this;
  }
  ///@}
