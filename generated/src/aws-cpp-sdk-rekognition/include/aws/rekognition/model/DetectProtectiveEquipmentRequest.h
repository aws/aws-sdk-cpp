...
class DetectProtectiveEquipmentRequest : public RekognitionRequest {
 public:
  ...
  template <typename ImageT = Image>
  DetectProtectiveEquipmentRequest& WithImage(ImageT&& value) {
  ...
  void SetSummarizationAttributes(SummarizationAttributesT&& value) {
    m_summarizationAttributesHasBeenSet = true;
    m_summarizationAttributes = std::forward<SummarizationAttributesT>(value);
  }
  template <typename SummarizationAttributesT = ProtectiveEquipmentSummarizationAttributes>
  DetectProtectiveEquipmentRequest& WithSummarizationAttributes(SummarizationAttributesT&& value) {
    SetSummarizationAttributes(std::forward<SummarizationAttributesT>(value));
    return *this;
  }
  ///@}
 private:
