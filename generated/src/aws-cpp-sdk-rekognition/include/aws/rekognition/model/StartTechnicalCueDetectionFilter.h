...
class StartTechnicalCueDetectionFilter {
 public:
  ...
  inline void SetMinSegmentConfidence(double value) {
    m_minSegmentConfidenceHasBeenSet = true;
    m_minSegmentConfidence = value;
  }
  inline StartTechnicalCueDetectionFilter& WithMinSegmentConfidence(double value) {
    SetMinSegmentConfidence(value);
    return *this;
  }
  ///@}
  ...
  void SetBlackFrame(BlackFrameT&& value) {
    m_blackFrameHasBeenSet = true;
    m_blackFrame = std::forward<BlackFrameT>(value);
  }
  template <typename BlackFrameT = BlackFrame>
  StartTechnicalCueDetectionFilter& WithBlackFrame(BlackFrameT&& value) {
    SetBlackFrame(std::forward<BlackFrameT>(value));
    return *this;
  }
  ///@}
 private:
