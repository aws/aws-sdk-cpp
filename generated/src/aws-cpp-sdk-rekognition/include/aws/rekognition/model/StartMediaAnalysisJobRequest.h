...
class StartMediaAnalysisJobRequest : public RekognitionRequest {
 public:
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartMediaAnalysisJobRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename JobNameT = Aws::String>
  StartMediaAnalysisJobRequest& WithJobName(JobNameT&& value) {
  ...
  void SetOperationsConfig(OperationsConfigT&& value) {
    m_operationsConfigHasBeenSet = true;
    m_operationsConfig = std::forward<OperationsConfigT>(value);
  }
  template <typename OperationsConfigT = MediaAnalysisOperationsConfig>
  StartMediaAnalysisJobRequest& WithOperationsConfig(OperationsConfigT&& value) {
    SetOperationsConfig(std::forward<OperationsConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename InputT = MediaAnalysisInput>
  StartMediaAnalysisJobRequest& WithInput(InputT&& value) {
  ...
  template <typename OutputConfigT = MediaAnalysisOutputConfig>
  StartMediaAnalysisJobRequest& WithOutputConfig(OutputConfigT&& value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  StartMediaAnalysisJobRequest& WithKmsKeyId(KmsKeyIdT&& value) {
