...
class StartTextDetectionFilters {
 public:
  ...
  void SetWordFilter(WordFilterT&& value) {
    m_wordFilterHasBeenSet = true;
    m_wordFilter = std::forward<WordFilterT>(value);
  }
  template <typename WordFilterT = DetectionFilter>
  StartTextDetectionFilters& WithWordFilter(WordFilterT&& value) {
    SetWordFilter(std::forward<WordFilterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RegionsOfInterestT = Aws::Vector<RegionOfInterest>>
  StartTextDetectionFilters& WithRegionsOfInterest(RegionsOfInterestT&& value) {
    SetRegionsOfInterest(std::forward<RegionsOfInterestT>(value));
    return *this;
  }
  template <typename RegionsOfInterestT = RegionOfInterest>
  StartTextDetectionFilters& AddRegionsOfInterest(RegionsOfInterestT&& value) {
    m_regionsOfInterestHasBeenSet = true;
