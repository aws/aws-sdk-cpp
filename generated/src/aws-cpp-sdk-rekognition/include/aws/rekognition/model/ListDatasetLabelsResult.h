...
class ListDatasetLabelsResult {
 public:
  ...
  void SetDatasetLabelDescriptions(DatasetLabelDescriptionsT&& value) {
    m_datasetLabelDescriptionsHasBeenSet = true;
    m_datasetLabelDescriptions = std::forward<DatasetLabelDescriptionsT>(value);
  }
  template <typename DatasetLabelDescriptionsT = Aws::Vector<DatasetLabelDescription>>
  ListDatasetLabelsResult& WithDatasetLabelDescriptions(DatasetLabelDescriptionsT&& value) {
    SetDatasetLabelDescriptions(std::forward<DatasetLabelDescriptionsT>(value));
    return *this;
  }
  template <typename DatasetLabelDescriptionsT = DatasetLabelDescription>
  ListDatasetLabelsResult& AddDatasetLabelDescriptions(DatasetLabelDescriptionsT&& value) {
    m_datasetLabelDescriptionsHasBeenSet = true;
    m_datasetLabelDescriptions.emplace_back(std::forward<DatasetLabelDescriptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDatasetLabelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDatasetLabelsResult& WithRequestId(RequestIdT&& value) {
