...
class TechnicalCueSegment {
 public:
  ...
  inline void SetType(TechnicalCueType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TechnicalCueSegment& WithType(TechnicalCueType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline TechnicalCueSegment& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
