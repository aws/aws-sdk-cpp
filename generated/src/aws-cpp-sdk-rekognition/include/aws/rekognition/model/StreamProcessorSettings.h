...
class StreamProcessorSettings {
 public:
  ...
  void SetFaceSearch(FaceSearchT&& value) {
    ...
    m_faceSearch = std::forward<FaceSearchT>(value);
  }
  template <typename FaceSearchT = FaceSearchSettings>
  StreamProcessorSettings& WithFaceSearch(FaceSearchT&& value) {
    SetFaceSearch(std::forward<FaceSearchT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectedHome(ConnectedHomeT&& value) {
    ...
    m_connectedHome = std::forward<ConnectedHomeT>(value);
  }
  template <typename ConnectedHomeT = ConnectedHomeSettings>
  StreamProcessorSettings& WithConnectedHome(ConnectedHomeT&& value) {
    SetConnectedHome(std::forward<ConnectedHomeT>(value));
    return *this;
  }
  ///@}
 private:
