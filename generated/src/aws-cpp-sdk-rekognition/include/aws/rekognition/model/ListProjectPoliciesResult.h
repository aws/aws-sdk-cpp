...
class ListProjectPoliciesResult {
 public:
  ...
  void SetProjectPolicies(ProjectPoliciesT&& value) {
    m_projectPoliciesHasBeenSet = true;
    m_projectPolicies = std::forward<ProjectPoliciesT>(value);
  }
  template <typename ProjectPoliciesT = Aws::Vector<ProjectPolicy>>
  ListProjectPoliciesResult& WithProjectPolicies(ProjectPoliciesT&& value) {
    SetProjectPolicies(std::forward<ProjectPoliciesT>(value));
    return *this;
  }
  template <typename ProjectPoliciesT = ProjectPolicy>
  ListProjectPoliciesResult& AddProjectPolicies(ProjectPoliciesT&& value) {
    m_projectPoliciesHasBeenSet = true;
    m_projectPolicies.emplace_back(std::forward<ProjectPoliciesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProjectPoliciesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProjectPoliciesResult& WithRequestId(RequestIdT&& value) {
