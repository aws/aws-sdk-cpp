...
class DatasetMetadata {
 public:
  ...
  template <typename CreationTimestampT = Aws::Utils::DateTime>
  DatasetMetadata& WithCreationTimestamp(CreationTimestampT&& value) {
  ...
  inline DatasetMetadata& WithDatasetType(DatasetType value) {
  ...
  inline DatasetMetadata& WithStatus(DatasetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  DatasetMetadata& WithStatusMessage(StatusMessageT&& value) {
  ...
  inline void SetStatusMessageCode(DatasetStatusMessageCode value) {
    m_statusMessageCodeHasBeenSet = true;
    m_statusMessageCode = value;
  }
  inline DatasetMetadata& WithStatusMessageCode(DatasetStatusMessageCode value) {
    SetStatusMessageCode(value);
    return *this;
  }
  ///@}
 private:
