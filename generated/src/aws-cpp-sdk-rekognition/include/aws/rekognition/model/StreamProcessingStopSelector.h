...
class StreamProcessingStopSelector {
 public:
  ...
  inline void SetMaxDurationInSeconds(long long value) {
    m_maxDurationInSecondsHasBeenSet = true;
    m_maxDurationInSeconds = value;
  }
  inline StreamProcessingStopSelector& WithMaxDurationInSeconds(long long value) {
