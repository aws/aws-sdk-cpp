...
class UpdateStreamProcessorRequest : public RekognitionRequest {
 public:
  ...
  void SetSettingsForUpdate(SettingsForUpdateT&& value) {
    m_settingsForUpdateHasBeenSet = true;
    m_settingsForUpdate = std::forward<SettingsForUpdateT>(value);
  }
  template <typename SettingsForUpdateT = StreamProcessorSettingsForUpdate>
  UpdateStreamProcessorRequest& WithSettingsForUpdate(SettingsForUpdateT&& value) {
    SetSettingsForUpdate(std::forward<SettingsForUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegionsOfInterestForUpdate(RegionsOfInterestForUpdateT&& value) {
    m_regionsOfInterestForUpdateHasBeenSet = true;
    m_regionsOfInterestForUpdate = std::forward<RegionsOfInterestForUpdateT>(value);
  }
  template <typename RegionsOfInterestForUpdateT = Aws::Vector<RegionOfInterest>>
  UpdateStreamProcessorRequest& WithRegionsOfInterestForUpdate(RegionsOfInterestForUpdateT&& value) {
    SetRegionsOfInterestForUpdate(std::forward<RegionsOfInterestForUpdateT>(value));
    return *this;
  }
  ...
  UpdateStreamProcessorRequest& AddRegionsOfInterestForUpdate(RegionsOfInterestForUpdateT&& value) {
    m_regionsOfInterestForUpdateHasBeenSet = true;
    m_regionsOfInterestForUpdate.emplace_back(std::forward<RegionsOfInterestForUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataSharingPreferenceForUpdate(DataSharingPreferenceForUpdateT&& value) {
    m_dataSharingPreferenceForUpdateHasBeenSet = true;
    m_dataSharingPreferenceForUpdate = std::forward<DataSharingPreferenceForUpdateT>(value);
  }
  template <typename DataSharingPreferenceForUpdateT = StreamProcessorDataSharingPreference>
  UpdateStreamProcessorRequest& WithDataSharingPreferenceForUpdate(DataSharingPreferenceForUpdateT&& value) {
    SetDataSharingPreferenceForUpdate(std::forward<DataSharingPreferenceForUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetParametersToDelete(ParametersToDeleteT&& value) {
    m_parametersToDeleteHasBeenSet = true;
    m_parametersToDelete = std::forward<ParametersToDeleteT>(value);
  }
  template <typename ParametersToDeleteT = Aws::Vector<StreamProcessorParameterToDelete>>
  UpdateStreamProcessorRequest& WithParametersToDelete(ParametersToDeleteT&& value) {
    SetParametersToDelete(std::forward<ParametersToDeleteT>(value));
    return *this;
  }
  inline UpdateStreamProcessorRequest& AddParametersToDelete(StreamProcessorParameterToDelete value) {
    m_parametersToDeleteHasBeenSet = true;
    m_parametersToDelete.push_back(value);
    return *this;
  }
  ///@}
 private:
