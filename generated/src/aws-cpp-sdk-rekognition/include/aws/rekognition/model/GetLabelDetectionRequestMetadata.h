...
class GetLabelDetectionRequestMetadata {
 public:
  ...
  inline void SetSortBy(LabelDetectionSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline GetLabelDetectionRequestMetadata& WithSortBy(LabelDetectionSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAggregateBy(LabelDetectionAggregateBy value) {
    m_aggregateByHasBeenSet = true;
    m_aggregateBy = value;
  }
  inline GetLabelDetectionRequestMetadata& WithAggregateBy(LabelDetectionAggregateBy value) {
