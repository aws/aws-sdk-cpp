...
class ListCollectionsResult {
 public:
  ...
  void SetFaceModelVersions(FaceModelVersionsT&& value) {
    ...
    m_faceModelVersions = std::forward<FaceModelVersionsT>(value);
  }
  template <typename FaceModelVersionsT = Aws::Vector<Aws::String>>
  ListCollectionsResult& WithFaceModelVersions(FaceModelVersionsT&& value) {
    SetFaceModelVersions(std::forward<FaceModelVersionsT>(value));
    return *this;
  }
  template <typename FaceModelVersionsT = Aws::String>
  ListCollectionsResult& AddFaceModelVersions(FaceModelVersionsT&& value) {
    m_faceModelVersionsHasBeenSet = true;
    m_faceModelVersions.emplace_back(std::forward<FaceModelVersionsT>(value));
    return *this;
  }
  ///@}
