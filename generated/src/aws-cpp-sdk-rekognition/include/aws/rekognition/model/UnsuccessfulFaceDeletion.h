...
namespace Model
{
  ...
  {
  public:
    AWS_REKOGNITION_API UnsuccessfulFaceDeletion() = default;
    ...
    template<typename FaceIdT = Aws::String>
    UnsuccessfulFaceDeletion& WithFaceId(FaceIdT&& value) { SetFaceId(std::forward<FaceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UserIdT = Aws::String>
    UnsuccessfulFaceDeletion& WithUserId(UserIdT&& value) { SetUserId(std::forward<UserIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ReasonsT = Aws::Vector<UnsuccessfulFaceDeletionReason>>
    void SetReasons(ReasonsT&& value) { m_reasonsHasBeenSet = true; m_reasons = std::forward<ReasonsT>(value); }
    template<typename ReasonsT = Aws::Vector<UnsuccessfulFaceDeletionReason>>
    UnsuccessfulFaceDeletion& WithReasons(ReasonsT&& value) { SetReasons(std::forward<ReasonsT>(value)); return *this;}
    inline UnsuccessfulFaceDeletion& AddReasons(UnsuccessfulFaceDeletionReason value) { m_reasonsHasBeenSet = true; m_reasons.push_back(value); return *this; }
    ///@}
  private:
