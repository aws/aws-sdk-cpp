...
class UnsuccessfulFaceDeletion {
 public:
  ...
  template <typename FaceIdT = Aws::String>
  UnsuccessfulFaceDeletion& WithFaceId(FaceIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  UnsuccessfulFaceDeletion& WithUserId(UserIdT&& value) {
  ...
  template <typename ReasonsT = Aws::Vector<UnsuccessfulFaceDeletionReason>>
  UnsuccessfulFaceDeletion& WithReasons(ReasonsT&& value) {
    SetReasons(std::forward<ReasonsT>(value));
    return *this;
  }
  inline UnsuccessfulFaceDeletion& AddReasons(UnsuccessfulFaceDeletionReason value) {
    m_reasonsHasBeenSet = true;
