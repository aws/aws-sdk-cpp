...
namespace Model
{
  ...
  public:
    ...
    template<typename QualityT = DetectLabelsImageQuality>
    DetectLabelsImageBackground& WithQuality(QualityT&& value) { SetQuality(std::forward<QualityT>(value)); return *this;}
    ///@}
    ...
    template<typename DominantColorsT = Aws::Vector<DominantColor>>
    DetectLabelsImageBackground& WithDominantColors(DominantColorsT&& value) { SetDominantColors(std::forward<DominantColorsT>(value)); return *this;}
    template<typename DominantColorsT = DominantColor>
    DetectLabelsImageBackground& AddDominantColors(DominantColorsT&& value) { m_dominantColorsHasBeenSet = true; m_dominantColors.emplace_back(std::forward<DominantColorsT>(value)); return *this; }
    ///@}
  private:
