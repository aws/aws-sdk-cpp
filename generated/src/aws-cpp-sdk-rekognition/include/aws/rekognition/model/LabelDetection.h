...
class LabelDetection {
 public:
  ...
  inline LabelDetection& WithTimestamp(long long value) {
    SetTimestamp(value);
    return *this;
  }
  ///@}
  ...
  inline LabelDetection& WithStartTimestampMillis(long long value) {
  ...
  inline LabelDetection& WithEndTimestampMillis(long long value) {
  ...
  inline LabelDetection& WithDurationMillis(long long value) {
