...
class DescribeProjectVersionsResult {
 public:
  ...
  void SetProjectVersionDescriptions(ProjectVersionDescriptionsT&& value) {
    ...
    m_projectVersionDescriptions = std::forward<ProjectVersionDescriptionsT>(value);
  }
  template <typename ProjectVersionDescriptionsT = Aws::Vector<ProjectVersionDescription>>
  DescribeProjectVersionsResult& WithProjectVersionDescriptions(ProjectVersionDescriptionsT&& value) {
    SetProjectVersionDescriptions(std::forward<ProjectVersionDescriptionsT>(value));
    return *this;
  }
  ...
  DescribeProjectVersionsResult& AddProjectVersionDescriptions(ProjectVersionDescriptionsT&& value) {
    m_projectVersionDescriptionsHasBeenSet = true;
    m_projectVersionDescriptions.emplace_back(std::forward<ProjectVersionDescriptionsT>(value));
    return *this;
  }
  ///@}
