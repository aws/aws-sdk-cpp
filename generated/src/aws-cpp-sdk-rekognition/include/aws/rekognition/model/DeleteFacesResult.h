...
class DeleteFacesResult {
 public:
  ...
  void SetDeletedFaces(DeletedFacesT&& value) {
    m_deletedFacesHasBeenSet = true;
    m_deletedFaces = std::forward<DeletedFacesT>(value);
  }
  template <typename DeletedFacesT = Aws::Vector<Aws::String>>
  DeleteFacesResult& WithDeletedFaces(DeletedFacesT&& value) {
    SetDeletedFaces(std::forward<DeletedFacesT>(value));
    return *this;
  }
  template <typename DeletedFacesT = Aws::String>
  DeleteFacesResult& AddDeletedFaces(DeletedFacesT&& value) {
    m_deletedFacesHasBeenSet = true;
    m_deletedFaces.emplace_back(std::forward<DeletedFacesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnsuccessfulFaceDeletions(UnsuccessfulFaceDeletionsT&& value) {
    m_unsuccessfulFaceDeletionsHasBeenSet = true;
    m_unsuccessfulFaceDeletions = std::forward<UnsuccessfulFaceDeletionsT>(value);
  }
  template <typename UnsuccessfulFaceDeletionsT = Aws::Vector<UnsuccessfulFaceDeletion>>
  DeleteFacesResult& WithUnsuccessfulFaceDeletions(UnsuccessfulFaceDeletionsT&& value) {
    SetUnsuccessfulFaceDeletions(std::forward<UnsuccessfulFaceDeletionsT>(value));
    return *this;
  }
  template <typename UnsuccessfulFaceDeletionsT = UnsuccessfulFaceDeletion>
  DeleteFacesResult& AddUnsuccessfulFaceDeletions(UnsuccessfulFaceDeletionsT&& value) {
    m_unsuccessfulFaceDeletionsHasBeenSet = true;
    m_unsuccessfulFaceDeletions.emplace_back(std::forward<UnsuccessfulFaceDeletionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteFacesResult& WithRequestId(RequestIdT&& value) {
