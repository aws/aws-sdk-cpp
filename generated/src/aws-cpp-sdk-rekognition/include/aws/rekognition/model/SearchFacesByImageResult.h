...
class SearchFacesByImageResult {
 public:
  ...
  void SetSearchedFaceBoundingBox(SearchedFaceBoundingBoxT&& value) {
    ...
    m_searchedFaceBoundingBox = std::forward<SearchedFaceBoundingBoxT>(value);
  }
  template <typename SearchedFaceBoundingBoxT = BoundingBox>
  SearchFacesByImageResult& WithSearchedFaceBoundingBox(SearchedFaceBoundingBoxT&& value) {
    SetSearchedFaceBoundingBox(std::forward<SearchedFaceBoundingBoxT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSearchedFaceConfidence(double value) {
    m_searchedFaceConfidenceHasBeenSet = true;
    m_searchedFaceConfidence = value;
  }
  inline SearchFacesByImageResult& WithSearchedFaceConfidence(double value) {
    SetSearchedFaceConfidence(value);
    return *this;
  }
  ///@}
