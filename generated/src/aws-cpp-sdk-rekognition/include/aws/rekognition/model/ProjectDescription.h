...
class ProjectDescription {
 public:
  ...
  inline ProjectDescription& WithStatus(ProjectStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ProjectDescription& WithFeature(CustomizationFeature value) {
    SetFeature(value);
    return *this;
  }
  ///@}
  ...
  inline ProjectDescription& WithAutoUpdate(ProjectAutoUpdate value) {
    SetAutoUpdate(value);
    return *this;
  }
  ///@}
