...
class FaceDetail {
 public:
  ...
  void SetAgeRange(AgeRangeT&& value) {
    ...
    m_ageRange = std::forward<AgeRangeT>(value);
  }
  template <typename AgeRangeT = AgeRange>
  FaceDetail& WithAgeRange(AgeRangeT&& value) {
    SetAgeRange(std::forward<AgeRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSmile(SmileT&& value) {
    ...
    m_smile = std::forward<SmileT>(value);
  }
  template <typename SmileT = Smile>
  FaceDetail& WithSmile(SmileT&& value) {
    SetSmile(std::forward<SmileT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEyeglasses(EyeglassesT&& value) {
    ...
    m_eyeglasses = std::forward<EyeglassesT>(value);
  }
  template <typename EyeglassesT = Eyeglasses>
  FaceDetail& WithEyeglasses(EyeglassesT&& value) {
    SetEyeglasses(std::forward<EyeglassesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSunglasses(SunglassesT&& value) {
    ...
    m_sunglasses = std::forward<SunglassesT>(value);
  }
  template <typename SunglassesT = Sunglasses>
  FaceDetail& WithSunglasses(SunglassesT&& value) {
    SetSunglasses(std::forward<SunglassesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBeard(BeardT&& value) {
    ...
    m_beard = std::forward<BeardT>(value);
  }
  template <typename BeardT = Beard>
  FaceDetail& WithBeard(BeardT&& value) {
    SetBeard(std::forward<BeardT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMustache(MustacheT&& value) {
    ...
    m_mustache = std::forward<MustacheT>(value);
  }
  template <typename MustacheT = Mustache>
  FaceDetail& WithMustache(MustacheT&& value) {
    SetMustache(std::forward<MustacheT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEyesOpen(EyesOpenT&& value) {
    ...
    m_eyesOpen = std::forward<EyesOpenT>(value);
  }
  template <typename EyesOpenT = EyeOpen>
  FaceDetail& WithEyesOpen(EyesOpenT&& value) {
    SetEyesOpen(std::forward<EyesOpenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMouthOpen(MouthOpenT&& value) {
    ...
    m_mouthOpen = std::forward<MouthOpenT>(value);
  }
  template <typename MouthOpenT = MouthOpen>
  FaceDetail& WithMouthOpen(MouthOpenT&& value) {
    SetMouthOpen(std::forward<MouthOpenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmotions(EmotionsT&& value) {
    ...
    m_emotions = std::forward<EmotionsT>(value);
  }
  template <typename EmotionsT = Aws::Vector<Emotion>>
  FaceDetail& WithEmotions(EmotionsT&& value) {
    SetEmotions(std::forward<EmotionsT>(value));
    return *this;
  }
  template <typename EmotionsT = Emotion>
  FaceDetail& AddEmotions(EmotionsT&& value) {
    m_emotionsHasBeenSet = true;
    m_emotions.emplace_back(std::forward<EmotionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLandmarks(LandmarksT&& value) {
    ...
    m_landmarks = std::forward<LandmarksT>(value);
  }
  template <typename LandmarksT = Aws::Vector<Landmark>>
  FaceDetail& WithLandmarks(LandmarksT&& value) {
    SetLandmarks(std::forward<LandmarksT>(value));
    return *this;
  }
  template <typename LandmarksT = Landmark>
  FaceDetail& AddLandmarks(LandmarksT&& value) {
    m_landmarksHasBeenSet = true;
    m_landmarks.emplace_back(std::forward<LandmarksT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPose(PoseT&& value) {
    ...
    m_pose = std::forward<PoseT>(value);
  }
  template <typename PoseT = Pose>
  FaceDetail& WithPose(PoseT&& value) {
    SetPose(std::forward<PoseT>(value));
    return *this;
  }
  ///@}
  ...
  inline FaceDetail& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  void SetFaceOccluded(FaceOccludedT&& value) {
    ...
    m_faceOccluded = std::forward<FaceOccludedT>(value);
  }
  template <typename FaceOccludedT = FaceOccluded>
  FaceDetail& WithFaceOccluded(FaceOccludedT&& value) {
    SetFaceOccluded(std::forward<FaceOccludedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEyeDirection(EyeDirectionT&& value) {
    ...
    m_eyeDirection = std::forward<EyeDirectionT>(value);
  }
  template <typename EyeDirectionT = EyeDirection>
  FaceDetail& WithEyeDirection(EyeDirectionT&& value) {
    SetEyeDirection(std::forward<EyeDirectionT>(value));
    return *this;
  }
  ///@}
 private:
