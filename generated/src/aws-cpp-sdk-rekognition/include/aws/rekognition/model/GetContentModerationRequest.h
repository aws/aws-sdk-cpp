...
class GetContentModerationRequest : public RekognitionRequest {
 public:
  ...
  inline GetContentModerationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(ContentModerationSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline GetContentModerationRequest& WithSortBy(ContentModerationSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAggregateBy(ContentModerationAggregateBy value) {
    m_aggregateByHasBeenSet = true;
    m_aggregateBy = value;
  }
  inline GetContentModerationRequest& WithAggregateBy(ContentModerationAggregateBy value) {
