...
class StartProjectVersionResult {
 public:
  ...
  inline void SetStatus(ProjectVersionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline StartProjectVersionResult& WithStatus(ProjectVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartProjectVersionResult& WithRequestId(RequestIdT&& value) {
