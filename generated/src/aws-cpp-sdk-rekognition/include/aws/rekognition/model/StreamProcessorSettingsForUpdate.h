...
class StreamProcessorSettingsForUpdate {
 public:
  ...
  void SetConnectedHomeForUpdate(ConnectedHomeForUpdateT&& value) {
    m_connectedHomeForUpdateHasBeenSet = true;
    m_connectedHomeForUpdate = std::forward<ConnectedHomeForUpdateT>(value);
  }
  template <typename ConnectedHomeForUpdateT = ConnectedHomeSettingsForUpdate>
  StreamProcessorSettingsForUpdate& WithConnectedHomeForUpdate(ConnectedHomeForUpdateT&& value) {
    SetConnectedHomeForUpdate(std::forward<ConnectedHomeForUpdateT>(value));
    return *this;
  }
  ///@}
 private:
