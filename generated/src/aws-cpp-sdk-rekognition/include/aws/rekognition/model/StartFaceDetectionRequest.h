...
class StartFaceDetectionRequest : public RekognitionRequest {
 public:
  ...
  inline void SetFaceAttributes(FaceAttributes value) {
    m_faceAttributesHasBeenSet = true;
    m_faceAttributes = value;
  }
  inline StartFaceDetectionRequest& WithFaceAttributes(FaceAttributes value) {
    SetFaceAttributes(value);
    return *this;
  }
  ///@}
