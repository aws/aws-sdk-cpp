...
class AWS_REKOGNITION_API RekognitionClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  RekognitionClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<RekognitionEndpointProviderBase> endpointProvider = nullptr,
      const Aws::Rekognition::RekognitionClientConfiguration& clientConfiguration = Aws::Rekognition::RekognitionClientConfiguration());
  ...
  /**
   * An Async wrapper for AssociateFaces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateFacesRequestT = Model::AssociateFacesRequest>
  void AssociateFacesAsync(const AssociateFacesRequestT& request, const AssociateFacesResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CompareFaces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CompareFacesRequestT = Model::CompareFacesRequest>
  void CompareFacesAsync(const CompareFacesRequestT& request, const CompareFacesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CopyProjectVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CopyProjectVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CopyProjectVersionRequestT = Model::CopyProjectVersionRequest>
  void CopyProjectVersionAsync(const CopyProjectVersionRequestT& request, const CopyProjectVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateFaceLivenessSessionOutcome CreateFaceLivenessSession(
      const Model::CreateFaceLivenessSessionRequest& request = {}) const;

  /**
   * A Callable wrapper for CreateFaceLivenessSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateFaceLivenessSessionRequestT = Model::CreateFaceLivenessSessionRequest>
  Model::CreateFaceLivenessSessionOutcomeCallable CreateFaceLivenessSessionCallable(
      const CreateFaceLivenessSessionRequestT& request = {}) const {
    return SubmitCallable(&RekognitionClient::CreateFaceLivenessSession, request);
  }

  /**
   * An Async wrapper for CreateFaceLivenessSession that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFaceLivenessSessionRequestT = Model::CreateFaceLivenessSessionRequest>
  void CreateFaceLivenessSessionAsync(const CreateFaceLivenessSessionResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateProjectVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateProjectVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProjectVersionRequestT = Model::CreateProjectVersionRequest>
  void CreateProjectVersionAsync(const CreateProjectVersionRequestT& request, const CreateProjectVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateStreamProcessor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStreamProcessor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStreamProcessorRequestT = Model::CreateStreamProcessorRequest>
  void CreateStreamProcessorAsync(const CreateStreamProcessorRequestT& request, const CreateStreamProcessorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFaces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFacesRequestT = Model::DeleteFacesRequest>
  void DeleteFacesAsync(const DeleteFacesRequestT& request, const DeleteFacesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteProjectPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProjectPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteProjectPolicyRequestT = Model::DeleteProjectPolicyRequest>
  void DeleteProjectPolicyAsync(const DeleteProjectPolicyRequestT& request, const DeleteProjectPolicyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteProjectVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProjectVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProjectVersionRequestT = Model::DeleteProjectVersionRequest>
  void DeleteProjectVersionAsync(const DeleteProjectVersionRequestT& request, const DeleteProjectVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteStreamProcessor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteStreamProcessor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteStreamProcessorRequestT = Model::DeleteStreamProcessorRequest>
  void DeleteStreamProcessorAsync(const DeleteStreamProcessorRequestT& request, const DeleteStreamProcessorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCollection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeCollectionRequestT = Model::DescribeCollectionRequest>
  void DescribeCollectionAsync(const DescribeCollectionRequestT& request, const DescribeCollectionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeProjectVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeProjectVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProjectVersionsRequestT = Model::DescribeProjectVersionsRequest>
  void DescribeProjectVersionsAsync(const DescribeProjectVersionsRequestT& request,
                                    const DescribeProjectVersionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeProjects that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeProjects that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeProjectsRequestT = Model::DescribeProjectsRequest>
  void DescribeProjectsAsync(const DescribeProjectsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DescribeProjectsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeStreamProcessor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeStreamProcessor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStreamProcessorRequestT = Model::DescribeStreamProcessorRequest>
  void DescribeStreamProcessorAsync(const DescribeStreamProcessorRequestT& request,
                                    const DescribeStreamProcessorResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectCustomLabels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectCustomLabels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetectCustomLabelsRequestT = Model::DetectCustomLabelsRequest>
  void DetectCustomLabelsAsync(const DetectCustomLabelsRequestT& request, const DetectCustomLabelsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DetectFaces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetectFacesRequestT = Model::DetectFacesRequest>
  void DetectFacesAsync(const DetectFacesRequestT& request, const DetectFacesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DetectLabels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetectLabelsRequestT = Model::DetectLabelsRequest>
  void DetectLabelsAsync(const DetectLabelsRequestT& request, const DetectLabelsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectModerationLabels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectModerationLabels that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetectModerationLabelsRequestT = Model::DetectModerationLabelsRequest>
  void DetectModerationLabelsAsync(const DetectModerationLabelsRequestT& request,
                                   const DetectModerationLabelsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectProtectiveEquipment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DetectProtectiveEquipmentRequestT = Model::DetectProtectiveEquipmentRequest>
  Model::DetectProtectiveEquipmentOutcomeCallable DetectProtectiveEquipmentCallable(
      const DetectProtectiveEquipmentRequestT& request) const {
    return SubmitCallable(&RekognitionClient::DetectProtectiveEquipment, request);
  }

  /**
   * An Async wrapper for DetectProtectiveEquipment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetectProtectiveEquipmentRequestT = Model::DetectProtectiveEquipmentRequest>
  void DetectProtectiveEquipmentAsync(const DetectProtectiveEquipmentRequestT& request,
                                      const DetectProtectiveEquipmentResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DetectText that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetectTextRequestT = Model::DetectTextRequest>
  void DetectTextAsync(const DetectTextRequestT& request, const DetectTextResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateFaces that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateFaces that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateFacesRequestT = Model::DisassociateFacesRequest>
  void DisassociateFacesAsync(const DisassociateFacesRequestT& request, const DisassociateFacesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DistributeDatasetEntries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DistributeDatasetEntries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DistributeDatasetEntriesRequestT = Model::DistributeDatasetEntriesRequest>
  void DistributeDatasetEntriesAsync(const DistributeDatasetEntriesRequestT& request,
                                     const DistributeDatasetEntriesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCelebrityInfo that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCelebrityInfo that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCelebrityInfoRequestT = Model::GetCelebrityInfoRequest>
  void GetCelebrityInfoAsync(const GetCelebrityInfoRequestT& request, const GetCelebrityInfoResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCelebrityRecognition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCelebrityRecognition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCelebrityRecognitionRequestT = Model::GetCelebrityRecognitionRequest>
  void GetCelebrityRecognitionAsync(const GetCelebrityRecognitionRequestT& request,
                                    const GetCelebrityRecognitionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetContentModeration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetContentModeration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetContentModerationRequestT = Model::GetContentModerationRequest>
  void GetContentModerationAsync(const GetContentModerationRequestT& request, const GetContentModerationResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFaceDetection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFaceDetection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetFaceDetectionRequestT = Model::GetFaceDetectionRequest>
  void GetFaceDetectionAsync(const GetFaceDetectionRequestT& request, const GetFaceDetectionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetFaceLivenessSessionResultsOutcome GetFaceLivenessSessionResults(
      const Model::GetFaceLivenessSessionResultsRequest& request) const;

  /**
   * A Callable wrapper for GetFaceLivenessSessionResults that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetFaceLivenessSessionResultsRequestT = Model::GetFaceLivenessSessionResultsRequest>
  Model::GetFaceLivenessSessionResultsOutcomeCallable GetFaceLivenessSessionResultsCallable(
      const GetFaceLivenessSessionResultsRequestT& request) const {
    return SubmitCallable(&RekognitionClient::GetFaceLivenessSessionResults, request);
  }

  /**
   * An Async wrapper for GetFaceLivenessSessionResults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFaceLivenessSessionResultsRequestT = Model::GetFaceLivenessSessionResultsRequest>
  void GetFaceLivenessSessionResultsAsync(const GetFaceLivenessSessionResultsRequestT& request,
                                          const GetFaceLivenessSessionResultsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetFaceSearch that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFaceSearchRequestT = Model::GetFaceSearchRequest>
  void GetFaceSearchAsync(const GetFaceSearchRequestT& request, const GetFaceSearchResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLabelDetection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLabelDetection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetLabelDetectionRequestT = Model::GetLabelDetectionRequest>
  void GetLabelDetectionAsync(const GetLabelDetectionRequestT& request, const GetLabelDetectionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMediaAnalysisJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMediaAnalysisJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMediaAnalysisJobRequestT = Model::GetMediaAnalysisJobRequest>
  void GetMediaAnalysisJobAsync(const GetMediaAnalysisJobRequestT& request, const GetMediaAnalysisJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPersonTracking that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPersonTracking that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPersonTrackingRequestT = Model::GetPersonTrackingRequest>
  void GetPersonTrackingAsync(const GetPersonTrackingRequestT& request, const GetPersonTrackingResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSegmentDetection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSegmentDetection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSegmentDetectionRequestT = Model::GetSegmentDetectionRequest>
  void GetSegmentDetectionAsync(const GetSegmentDetectionRequestT& request, const GetSegmentDetectionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTextDetection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTextDetection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTextDetectionRequestT = Model::GetTextDetectionRequest>
  void GetTextDetectionAsync(const GetTextDetectionRequestT& request, const GetTextDetectionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for IndexFaces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename IndexFacesRequestT = Model::IndexFacesRequest>
  void IndexFacesAsync(const IndexFacesRequestT& request, const IndexFacesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDatasetLabels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDatasetLabels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDatasetLabelsRequestT = Model::ListDatasetLabelsRequest>
  void ListDatasetLabelsAsync(const ListDatasetLabelsRequestT& request, const ListDatasetLabelsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListFaces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFacesRequestT = Model::ListFacesRequest>
  void ListFacesAsync(const ListFacesRequestT& request, const ListFacesResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMediaAnalysisJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMediaAnalysisJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMediaAnalysisJobsRequestT = Model::ListMediaAnalysisJobsRequest>
  void ListMediaAnalysisJobsAsync(const ListMediaAnalysisJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListMediaAnalysisJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProjectPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProjectPolicies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListProjectPoliciesRequestT = Model::ListProjectPoliciesRequest>
  void ListProjectPoliciesAsync(const ListProjectPoliciesRequestT& request, const ListProjectPoliciesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStreamProcessors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStreamProcessors that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStreamProcessorsRequestT = Model::ListStreamProcessorsRequest>
  void ListStreamProcessorsAsync(const ListStreamProcessorsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListStreamProcessorsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutProjectPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutProjectPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutProjectPolicyRequestT = Model::PutProjectPolicyRequest>
  void PutProjectPolicyAsync(const PutProjectPolicyRequestT& request, const PutProjectPolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RecognizeCelebrities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RecognizeCelebrities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RecognizeCelebritiesRequestT = Model::RecognizeCelebritiesRequest>
  void RecognizeCelebritiesAsync(const RecognizeCelebritiesRequestT& request, const RecognizeCelebritiesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchFaces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchFacesRequestT = Model::SearchFacesRequest>
  void SearchFacesAsync(const SearchFacesRequestT& request, const SearchFacesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchFacesByImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchFacesByImage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SearchFacesByImageRequestT = Model::SearchFacesByImageRequest>
  void SearchFacesByImageAsync(const SearchFacesByImageRequestT& request, const SearchFacesByImageResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchUsersByImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchUsersByImage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SearchUsersByImageRequestT = Model::SearchUsersByImageRequest>
  void SearchUsersByImageAsync(const SearchUsersByImageRequestT& request, const SearchUsersByImageResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartCelebrityRecognition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartCelebrityRecognitionRequestT = Model::StartCelebrityRecognitionRequest>
  Model::StartCelebrityRecognitionOutcomeCallable StartCelebrityRecognitionCallable(
      const StartCelebrityRecognitionRequestT& request) const {
    return SubmitCallable(&RekognitionClient::StartCelebrityRecognition, request);
  }

  /**
   * An Async wrapper for StartCelebrityRecognition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartCelebrityRecognitionRequestT = Model::StartCelebrityRecognitionRequest>
  void StartCelebrityRecognitionAsync(const StartCelebrityRecognitionRequestT& request,
                                      const StartCelebrityRecognitionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartContentModeration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartContentModeration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartContentModerationRequestT = Model::StartContentModerationRequest>
  void StartContentModerationAsync(const StartContentModerationRequestT& request,
                                   const StartContentModerationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartFaceDetection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartFaceDetection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartFaceDetectionRequestT = Model::StartFaceDetectionRequest>
  void StartFaceDetectionAsync(const StartFaceDetectionRequestT& request, const StartFaceDetectionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartFaceSearch that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartFaceSearchRequestT = Model::StartFaceSearchRequest>
  void StartFaceSearchAsync(const StartFaceSearchRequestT& request, const StartFaceSearchResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartLabelDetection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartLabelDetection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartLabelDetectionRequestT = Model::StartLabelDetectionRequest>
  void StartLabelDetectionAsync(const StartLabelDetectionRequestT& request, const StartLabelDetectionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMediaAnalysisJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMediaAnalysisJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMediaAnalysisJobRequestT = Model::StartMediaAnalysisJobRequest>
  void StartMediaAnalysisJobAsync(const StartMediaAnalysisJobRequestT& request, const StartMediaAnalysisJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartPersonTracking that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartPersonTracking that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartPersonTrackingRequestT = Model::StartPersonTrackingRequest>
  void StartPersonTrackingAsync(const StartPersonTrackingRequestT& request, const StartPersonTrackingResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartProjectVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartProjectVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartProjectVersionRequestT = Model::StartProjectVersionRequest>
  void StartProjectVersionAsync(const StartProjectVersionRequestT& request, const StartProjectVersionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartSegmentDetection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartSegmentDetection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartSegmentDetectionRequestT = Model::StartSegmentDetectionRequest>
  void StartSegmentDetectionAsync(const StartSegmentDetectionRequestT& request, const StartSegmentDetectionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartStreamProcessor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartStreamProcessor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartStreamProcessorRequestT = Model::StartStreamProcessorRequest>
  void StartStreamProcessorAsync(const StartStreamProcessorRequestT& request, const StartStreamProcessorResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartTextDetection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartTextDetection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartTextDetectionRequestT = Model::StartTextDetectionRequest>
  void StartTextDetectionAsync(const StartTextDetectionRequestT& request, const StartTextDetectionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopProjectVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopProjectVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopProjectVersionRequestT = Model::StopProjectVersionRequest>
  void StopProjectVersionAsync(const StopProjectVersionRequestT& request, const StopProjectVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopStreamProcessor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopStreamProcessor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopStreamProcessorRequestT = Model::StopStreamProcessorRequest>
  void StopStreamProcessorAsync(const StopStreamProcessorRequestT& request, const StopStreamProcessorResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateStreamProcessor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateStreamProcessor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateStreamProcessorRequestT = Model::UpdateStreamProcessorRequest>
  void UpdateStreamProcessorAsync(const UpdateStreamProcessorRequestT& request, const UpdateStreamProcessorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
