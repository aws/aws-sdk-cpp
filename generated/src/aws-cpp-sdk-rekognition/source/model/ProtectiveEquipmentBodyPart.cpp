...
ProtectiveEquipmentBodyPart::ProtectiveEquipmentBodyPart(JsonView jsonValue) { *this = jsonValue; }
...
ProtectiveEquipmentBodyPart& ProtectiveEquipmentBodyPart::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("EquipmentDetections")) {
    ...
    for (unsigned equipmentDetectionsIndex = 0; equipmentDetectionsIndex < equipmentDetectionsJsonList.GetLength();
         ++equipmentDetectionsIndex) {
