...
GeneralLabelsSettings::GeneralLabelsSettings(JsonView jsonValue) { *this = jsonValue; }
...
GeneralLabelsSettings& GeneralLabelsSettings::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("LabelInclusionFilters")) {
    ...
    for (unsigned labelInclusionFiltersIndex = 0; labelInclusionFiltersIndex < labelInclusionFiltersJsonList.GetLength();
         ++labelInclusionFiltersIndex) {
  ...
  if (jsonValue.ValueExists("LabelExclusionFilters")) {
    ...
    for (unsigned labelExclusionFiltersIndex = 0; labelExclusionFiltersIndex < labelExclusionFiltersJsonList.GetLength();
         ++labelExclusionFiltersIndex) {
  ...
  if (jsonValue.ValueExists("LabelCategoryInclusionFilters")) {
    ...
    for (unsigned labelCategoryInclusionFiltersIndex = 0;
         labelCategoryInclusionFiltersIndex < labelCategoryInclusionFiltersJsonList.GetLength(); ++labelCategoryInclusionFiltersIndex) {
  ...
  if (jsonValue.ValueExists("LabelCategoryExclusionFilters")) {
    ...
    for (unsigned labelCategoryExclusionFiltersIndex = 0;
         labelCategoryExclusionFiltersIndex < labelCategoryExclusionFiltersJsonList.GetLength(); ++labelCategoryExclusionFiltersIndex) {
...
JsonValue GeneralLabelsSettings::Jsonize() const {
  ...
  if (m_labelCategoryInclusionFiltersHasBeenSet) {
    ...
    for (unsigned labelCategoryInclusionFiltersIndex = 0;
         labelCategoryInclusionFiltersIndex < labelCategoryInclusionFiltersJsonList.GetLength(); ++labelCategoryInclusionFiltersIndex) {
      labelCategoryInclusionFiltersJsonList[labelCategoryInclusionFiltersIndex].AsString(
          m_labelCategoryInclusionFilters[labelCategoryInclusionFiltersIndex]);
    }
  ...
  if (m_labelCategoryExclusionFiltersHasBeenSet) {
    ...
    for (unsigned labelCategoryExclusionFiltersIndex = 0;
         labelCategoryExclusionFiltersIndex < labelCategoryExclusionFiltersJsonList.GetLength(); ++labelCategoryExclusionFiltersIndex) {
      labelCategoryExclusionFiltersJsonList[labelCategoryExclusionFiltersIndex].AsString(
          m_labelCategoryExclusionFilters[labelCategoryExclusionFiltersIndex]);
    }
