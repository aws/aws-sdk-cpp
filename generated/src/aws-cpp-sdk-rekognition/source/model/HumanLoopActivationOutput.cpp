...
HumanLoopActivationOutput::HumanLoopActivationOutput(JsonView jsonValue) { *this = jsonValue; }
...
HumanLoopActivationOutput& HumanLoopActivationOutput::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("HumanLoopActivationReasons")) {
    ...
    for (unsigned humanLoopActivationReasonsIndex = 0; humanLoopActivationReasonsIndex < humanLoopActivationReasonsJsonList.GetLength();
         ++humanLoopActivationReasonsIndex) {
...
JsonValue HumanLoopActivationOutput::Jsonize() const {
  ...
  if (m_humanLoopActivationReasonsHasBeenSet) {
    ...
    for (unsigned humanLoopActivationReasonsIndex = 0; humanLoopActivationReasonsIndex < humanLoopActivationReasonsJsonList.GetLength();
         ++humanLoopActivationReasonsIndex) {
      humanLoopActivationReasonsJsonList[humanLoopActivationReasonsIndex].AsString(
          m_humanLoopActivationReasons[humanLoopActivationReasonsIndex]);
    }
