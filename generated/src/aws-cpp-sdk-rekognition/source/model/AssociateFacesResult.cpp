...
AssociateFacesResult& AssociateFacesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("UnsuccessfulFaceAssociations")) {
    ...
    for (unsigned unsuccessfulFaceAssociationsIndex = 0;
         unsuccessfulFaceAssociationsIndex < unsuccessfulFaceAssociationsJsonList.GetLength(); ++unsuccessfulFaceAssociationsIndex) {
