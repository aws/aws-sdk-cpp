...
class ListVPCAssociationAuthorizationsResult {
 public:
  ...
  AWS_ROUTE53_API ListVPCAssociationAuthorizationsResult& operator=(
  ...
  template <typename HostedZoneIdT = Aws::String>
  ListVPCAssociationAuthorizationsResult& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListVPCAssociationAuthorizationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VPCsT = Aws::Vector<VPC>>
  ListVPCAssociationAuthorizationsResult& WithVPCs(VPCsT&& value) {
    SetVPCs(std::forward<VPCsT>(value));
    return *this;
  }
  template <typename VPCsT = VPC>
  ListVPCAssociationAuthorizationsResult& AddVPCs(VPCsT&& value) {
    m_vPCsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListVPCAssociationAuthorizationsResult& WithRequestId(RequestIdT&& value) {
