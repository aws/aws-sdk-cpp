...
class HealthCheck {
 public:
  ...
  void SetLinkedService(LinkedServiceT&& value) {
    ...
    m_linkedService = std::forward<LinkedServiceT>(value);
  }
  template <typename LinkedServiceT = LinkedService>
  HealthCheck& WithLinkedService(LinkedServiceT&& value) {
    SetLinkedService(std::forward<LinkedServiceT>(value));
    return *this;
  }
  ///@}
  ...
  inline HealthCheck& WithHealthCheckVersion(long long value) {
  ...
  void SetCloudWatchAlarmConfiguration(CloudWatchAlarmConfigurationT&& value) {
    ...
    m_cloudWatchAlarmConfiguration = std::forward<CloudWatchAlarmConfigurationT>(value);
  }
  template <typename CloudWatchAlarmConfigurationT = CloudWatchAlarmConfiguration>
  HealthCheck& WithCloudWatchAlarmConfiguration(CloudWatchAlarmConfigurationT&& value) {
    SetCloudWatchAlarmConfiguration(std::forward<CloudWatchAlarmConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
