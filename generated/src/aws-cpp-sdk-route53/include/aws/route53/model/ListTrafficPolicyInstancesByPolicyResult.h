...
class ListTrafficPolicyInstancesByPolicyResult {
 public:
  ...
  AWS_ROUTE53_API ListTrafficPolicyInstancesByPolicyResult& operator=(
  ...
  template <typename TrafficPolicyInstancesT = Aws::Vector<TrafficPolicyInstance>>
  ListTrafficPolicyInstancesByPolicyResult& WithTrafficPolicyInstances(TrafficPolicyInstancesT&& value) {
  ...
  ListTrafficPolicyInstancesByPolicyResult& AddTrafficPolicyInstances(TrafficPolicyInstancesT&& value) {
    m_trafficPolicyInstancesHasBeenSet = true;
  ...
  template <typename HostedZoneIdMarkerT = Aws::String>
  ListTrafficPolicyInstancesByPolicyResult& WithHostedZoneIdMarker(HostedZoneIdMarkerT&& value) {
  ...
  template <typename TrafficPolicyInstanceNameMarkerT = Aws::String>
  ListTrafficPolicyInstancesByPolicyResult& WithTrafficPolicyInstanceNameMarker(TrafficPolicyInstanceNameMarkerT&& value) {
  ...
  inline ListTrafficPolicyInstancesByPolicyResult& WithTrafficPolicyInstanceTypeMarker(RRType value) {
  ...
  inline ListTrafficPolicyInstancesByPolicyResult& WithIsTruncated(bool value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListTrafficPolicyInstancesByPolicyResult& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTrafficPolicyInstancesByPolicyResult& WithRequestId(RequestIdT&& value) {
