...
class CloudWatchAlarmConfiguration {
 public:
  ...
  inline CloudWatchAlarmConfiguration& WithEvaluationPeriods(int value) {
  ...
  inline CloudWatchAlarmConfiguration& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline CloudWatchAlarmConfiguration& WithComparisonOperator(ComparisonOperator value) {
  ...
  inline CloudWatchAlarmConfiguration& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline CloudWatchAlarmConfiguration& WithStatistic(Statistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
