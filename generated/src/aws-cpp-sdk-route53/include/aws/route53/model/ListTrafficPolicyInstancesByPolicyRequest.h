...
class ListTrafficPolicyInstancesByPolicyRequest : public Route53Request {
 public:
  ...
  template <typename TrafficPolicyIdT = Aws::String>
  ListTrafficPolicyInstancesByPolicyRequest& WithTrafficPolicyId(TrafficPolicyIdT&& value) {
  ...
  inline ListTrafficPolicyInstancesByPolicyRequest& WithTrafficPolicyVersion(int value) {
  ...
  template <typename HostedZoneIdMarkerT = Aws::String>
  ListTrafficPolicyInstancesByPolicyRequest& WithHostedZoneIdMarker(HostedZoneIdMarkerT&& value) {
  ...
  template <typename TrafficPolicyInstanceNameMarkerT = Aws::String>
  ListTrafficPolicyInstancesByPolicyRequest& WithTrafficPolicyInstanceNameMarker(TrafficPolicyInstanceNameMarkerT&& value) {
  ...
  inline ListTrafficPolicyInstancesByPolicyRequest& WithTrafficPolicyInstanceTypeMarker(RRType value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListTrafficPolicyInstancesByPolicyRequest& WithMaxItems(MaxItemsT&& value) {
