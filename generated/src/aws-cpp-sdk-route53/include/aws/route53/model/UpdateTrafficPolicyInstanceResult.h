...
class UpdateTrafficPolicyInstanceResult {
 public:
  ...
  template <typename TrafficPolicyInstanceT = TrafficPolicyInstance>
  UpdateTrafficPolicyInstanceResult& WithTrafficPolicyInstance(TrafficPolicyInstanceT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateTrafficPolicyInstanceResult& WithRequestId(RequestIdT&& value) {
