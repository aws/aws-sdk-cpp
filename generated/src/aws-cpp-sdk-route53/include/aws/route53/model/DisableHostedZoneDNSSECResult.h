...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53_API DisableHostedZoneDNSSECResult() = default;
    ...
    template<typename ChangeInfoT = ChangeInfo>
    DisableHostedZoneDNSSECResult& WithChangeInfo(ChangeInfoT&& value) { SetChangeInfo(std::forward<ChangeInfoT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DisableHostedZoneDNSSECResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
