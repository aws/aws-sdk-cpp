...
class HostedZoneLimit {
 public:
  ...
  inline void SetType(HostedZoneLimitType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline HostedZoneLimit& WithType(HostedZoneLimitType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline HostedZoneLimit& WithValue(long long value) {
    SetValue(value);
    return *this;
  }
  ///@}
