...
class CreateTrafficPolicyInstanceResult {
 public:
  ...
  template <typename TrafficPolicyInstanceT = TrafficPolicyInstance>
  CreateTrafficPolicyInstanceResult& WithTrafficPolicyInstance(TrafficPolicyInstanceT&& value) {
  ...
  template <typename LocationT = Aws::String>
  CreateTrafficPolicyInstanceResult& WithLocation(LocationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTrafficPolicyInstanceResult& WithRequestId(RequestIdT&& value) {
