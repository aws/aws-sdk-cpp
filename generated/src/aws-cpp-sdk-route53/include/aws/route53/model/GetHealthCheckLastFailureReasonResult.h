...
class GetHealthCheckLastFailureReasonResult {
 public:
  ...
  template <typename HealthCheckObservationsT = Aws::Vector<HealthCheckObservation>>
  GetHealthCheckLastFailureReasonResult& WithHealthCheckObservations(HealthCheckObservationsT&& value) {
  ...
  GetHealthCheckLastFailureReasonResult& AddHealthCheckObservations(HealthCheckObservationsT&& value) {
    m_healthCheckObservationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetHealthCheckLastFailureReasonResult& WithRequestId(RequestIdT&& value) {
