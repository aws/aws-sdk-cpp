...
class ListHostedZonesByVPCRequest : public Route53Request {
 public:
  ...
  template <typename VPCIdT = Aws::String>
  ListHostedZonesByVPCRequest& WithVPCId(VPCIdT&& value) {
  ...
  inline ListHostedZonesByVPCRequest& WithVPCRegion(VPCRegion value) {
    SetVPCRegion(value);
    return *this;
  }
  ///@}
  ...
  template <typename MaxItemsT = Aws::String>
  ListHostedZonesByVPCRequest& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListHostedZonesByVPCRequest& WithNextToken(NextTokenT&& value) {
