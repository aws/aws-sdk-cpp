...
class TestDNSAnswerRequest : public Route53Request {
 public:
  ...
  inline void SetRecordType(RRType value) {
    m_recordTypeHasBeenSet = true;
    m_recordType = value;
  }
  inline TestDNSAnswerRequest& WithRecordType(RRType value) {
    SetRecordType(value);
    return *this;
  }
  ///@}
  ...
  void SetResolverIP(ResolverIPT&& value) {
    m_resolverIPHasBeenSet = true;
    m_resolverIP = std::forward<ResolverIPT>(value);
  }
  template <typename ResolverIPT = Aws::String>
  TestDNSAnswerRequest& WithResolverIP(ResolverIPT&& value) {
    SetResolverIP(std::forward<ResolverIPT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEDNS0ClientSubnetIP(EDNS0ClientSubnetIPT&& value) {
    m_eDNS0ClientSubnetIPHasBeenSet = true;
    m_eDNS0ClientSubnetIP = std::forward<EDNS0ClientSubnetIPT>(value);
  }
  template <typename EDNS0ClientSubnetIPT = Aws::String>
  TestDNSAnswerRequest& WithEDNS0ClientSubnetIP(EDNS0ClientSubnetIPT&& value) {
    SetEDNS0ClientSubnetIP(std::forward<EDNS0ClientSubnetIPT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEDNS0ClientSubnetMask(EDNS0ClientSubnetMaskT&& value) {
    m_eDNS0ClientSubnetMaskHasBeenSet = true;
    m_eDNS0ClientSubnetMask = std::forward<EDNS0ClientSubnetMaskT>(value);
  }
  template <typename EDNS0ClientSubnetMaskT = Aws::String>
  TestDNSAnswerRequest& WithEDNS0ClientSubnetMask(EDNS0ClientSubnetMaskT&& value) {
    SetEDNS0ClientSubnetMask(std::forward<EDNS0ClientSubnetMaskT>(value));
    return *this;
  }
  ///@}
 private:
