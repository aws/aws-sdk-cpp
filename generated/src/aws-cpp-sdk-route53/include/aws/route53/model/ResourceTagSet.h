...
class ResourceTagSet {
 public:
  ...
  inline ResourceTagSet& WithResourceType(TagResourceType value) {
  ...
  template <typename ResourceIdT = Aws::String>
  ResourceTagSet& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ResourceTagSet& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ResourceTagSet& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
