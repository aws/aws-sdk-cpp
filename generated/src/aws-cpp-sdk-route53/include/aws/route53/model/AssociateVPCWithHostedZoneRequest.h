...
class AssociateVPCWithHostedZoneRequest : public Route53Request {
 public:
  ...
  template <typename HostedZoneIdT = Aws::String>
  AssociateVPCWithHostedZoneRequest& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  template <typename VPCT = VPC>
  AssociateVPCWithHostedZoneRequest& WithVPC(VPCT&& value) {
  ...
  template <typename CommentT = Aws::String>
  AssociateVPCWithHostedZoneRequest& WithComment(CommentT&& value) {
