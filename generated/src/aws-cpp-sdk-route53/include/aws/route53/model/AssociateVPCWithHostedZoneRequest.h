...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53_API AssociateVPCWithHostedZoneRequest() = default;
    ...
    template<typename HostedZoneIdT = Aws::String>
    AssociateVPCWithHostedZoneRequest& WithHostedZoneId(HostedZoneIdT&& value) { SetHostedZoneId(std::forward<HostedZoneIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VPCT = VPC>
    AssociateVPCWithHostedZoneRequest& WithVPC(VPCT&& value) { SetVPC(std::forward<VPCT>(value)); return *this;}
    ///@}
    ...
    template<typename CommentT = Aws::String>
    AssociateVPCWithHostedZoneRequest& WithComment(CommentT&& value) { SetComment(std::forward<CommentT>(value)); return *this;}
    ///@}
  private:
