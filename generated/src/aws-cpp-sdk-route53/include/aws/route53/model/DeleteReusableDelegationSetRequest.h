...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DeleteReusableDelegationSetRequest : public Route53Request
  {
  public:
    AWS_ROUTE53_API DeleteReusableDelegationSetRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DeleteReusableDelegationSetRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
