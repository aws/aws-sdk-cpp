...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53_API DeleteKeySigningKeyRequest() = default;
    ...
    template<typename HostedZoneIdT = Aws::String>
    DeleteKeySigningKeyRequest& WithHostedZoneId(HostedZoneIdT&& value) { SetHostedZoneId(std::forward<HostedZoneIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DeleteKeySigningKeyRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
