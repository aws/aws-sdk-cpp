...
class UpdateTrafficPolicyInstanceRequest : public Route53Request {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateTrafficPolicyInstanceRequest& WithId(IdT&& value) {
  ...
  inline UpdateTrafficPolicyInstanceRequest& WithTTL(long long value) {
    SetTTL(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateTrafficPolicyInstanceRequest& WithTrafficPolicyVersion(int value) {
