...
class HealthCheckObservation {
 public:
  ...
  inline void SetRegion(HealthCheckRegion value) {
    m_regionHasBeenSet = true;
    m_region = value;
  }
  inline HealthCheckObservation& WithRegion(HealthCheckRegion value) {
    SetRegion(value);
    return *this;
  }
  ///@}
  ...
  void SetStatusReport(StatusReportT&& value) {
    ...
    m_statusReport = std::forward<StatusReportT>(value);
  }
  template <typename StatusReportT = StatusReport>
  HealthCheckObservation& WithStatusReport(StatusReportT&& value) {
    SetStatusReport(std::forward<StatusReportT>(value));
    return *this;
  }
  ///@}
 private:
