...
class GetTrafficPolicyInstanceResult {
 public:
  ...
  void SetTrafficPolicyInstance(TrafficPolicyInstanceT&& value) {
    m_trafficPolicyInstanceHasBeenSet = true;
    m_trafficPolicyInstance = std::forward<TrafficPolicyInstanceT>(value);
  }
  template <typename TrafficPolicyInstanceT = TrafficPolicyInstance>
  GetTrafficPolicyInstanceResult& WithTrafficPolicyInstance(TrafficPolicyInstanceT&& value) {
    SetTrafficPolicyInstance(std::forward<TrafficPolicyInstanceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetTrafficPolicyInstanceResult& WithRequestId(RequestIdT&& value) {
