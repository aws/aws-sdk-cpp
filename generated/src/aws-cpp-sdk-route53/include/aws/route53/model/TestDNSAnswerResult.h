...
class TestDNSAnswerResult {
 public:
  ...
  void SetNameserver(NameserverT&& value) {
    ...
    m_nameserver = std::forward<NameserverT>(value);
  }
  template <typename NameserverT = Aws::String>
  TestDNSAnswerResult& WithNameserver(NameserverT&& value) {
    SetNameserver(std::forward<NameserverT>(value));
    return *this;
  }
  ///@}
  ...
  inline TestDNSAnswerResult& WithRecordType(RRType value) {
    SetRecordType(value);
    return *this;
  }
  ///@}
