...
class CreateTrafficPolicyResult {
 public:
  ...
  template <typename TrafficPolicyT = TrafficPolicy>
  CreateTrafficPolicyResult& WithTrafficPolicy(TrafficPolicyT&& value) {
  ...
  template <typename LocationT = Aws::String>
  CreateTrafficPolicyResult& WithLocation(LocationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTrafficPolicyResult& WithRequestId(RequestIdT&& value) {
