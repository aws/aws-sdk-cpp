...
class ListResourceRecordSetsRequest : public Route53Request {
 public:
  ...
  template <typename HostedZoneIdT = Aws::String>
  ListResourceRecordSetsRequest& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  void SetStartRecordName(StartRecordNameT&& value) {
    m_startRecordNameHasBeenSet = true;
    m_startRecordName = std::forward<StartRecordNameT>(value);
  }
  template <typename StartRecordNameT = Aws::String>
  ListResourceRecordSetsRequest& WithStartRecordName(StartRecordNameT&& value) {
    SetStartRecordName(std::forward<StartRecordNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStartRecordType(RRType value) {
    m_startRecordTypeHasBeenSet = true;
    m_startRecordType = value;
  }
  inline ListResourceRecordSetsRequest& WithStartRecordType(RRType value) {
    SetStartRecordType(value);
    return *this;
  }
  ///@}
  ...
  void SetStartRecordIdentifier(StartRecordIdentifierT&& value) {
    m_startRecordIdentifierHasBeenSet = true;
    m_startRecordIdentifier = std::forward<StartRecordIdentifierT>(value);
  }
  template <typename StartRecordIdentifierT = Aws::String>
  ListResourceRecordSetsRequest& WithStartRecordIdentifier(StartRecordIdentifierT&& value) {
    SetStartRecordIdentifier(std::forward<StartRecordIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MaxItemsT = Aws::String>
  ListResourceRecordSetsRequest& WithMaxItems(MaxItemsT&& value) {
