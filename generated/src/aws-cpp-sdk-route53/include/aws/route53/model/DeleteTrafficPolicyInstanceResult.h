...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53_API DeleteTrafficPolicyInstanceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteTrafficPolicyInstanceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
