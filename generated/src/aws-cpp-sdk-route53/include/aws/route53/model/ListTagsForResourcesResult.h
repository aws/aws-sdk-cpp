...
class ListTagsForResourcesResult {
 public:
  ...
  void SetResourceTagSets(ResourceTagSetsT&& value) {
    m_resourceTagSetsHasBeenSet = true;
    m_resourceTagSets = std::forward<ResourceTagSetsT>(value);
  }
  template <typename ResourceTagSetsT = Aws::Vector<ResourceTagSet>>
  ListTagsForResourcesResult& WithResourceTagSets(ResourceTagSetsT&& value) {
    SetResourceTagSets(std::forward<ResourceTagSetsT>(value));
    return *this;
  }
  template <typename ResourceTagSetsT = ResourceTagSet>
  ListTagsForResourcesResult& AddResourceTagSets(ResourceTagSetsT&& value) {
    m_resourceTagSetsHasBeenSet = true;
    m_resourceTagSets.emplace_back(std::forward<ResourceTagSetsT>(value));
    return *this;
  }
  ///@}
