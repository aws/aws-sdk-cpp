...
class GetDNSSECResult {
 public:
  ...
  template <typename StatusT = DNSSECStatus>
  GetDNSSECResult& WithStatus(StatusT&& value) {
  ...
  void SetKeySigningKeys(KeySigningKeysT&& value) {
    m_keySigningKeysHasBeenSet = true;
    m_keySigningKeys = std::forward<KeySigningKeysT>(value);
  }
  template <typename KeySigningKeysT = Aws::Vector<KeySigningKey>>
  GetDNSSECResult& WithKeySigningKeys(KeySigningKeysT&& value) {
    SetKeySigningKeys(std::forward<KeySigningKeysT>(value));
    return *this;
  }
  template <typename KeySigningKeysT = KeySigningKey>
  GetDNSSECResult& AddKeySigningKeys(KeySigningKeysT&& value) {
    m_keySigningKeysHasBeenSet = true;
    m_keySigningKeys.emplace_back(std::forward<KeySigningKeysT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetDNSSECResult& WithRequestId(RequestIdT&& value) {
