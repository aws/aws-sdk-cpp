...
class ListHostedZonesRequest : public Route53Request {
 public:
  ...
  inline void SetHostedZoneType(HostedZoneType value) {
    m_hostedZoneTypeHasBeenSet = true;
    m_hostedZoneType = value;
  }
  inline ListHostedZonesRequest& WithHostedZoneType(HostedZoneType value) {
    SetHostedZoneType(value);
    return *this;
  }
  ///@}
 private:
