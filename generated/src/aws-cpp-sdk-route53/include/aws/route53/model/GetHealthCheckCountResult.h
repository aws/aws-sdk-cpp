...
class GetHealthCheckCountResult {
 public:
  ...
  inline void SetHealthCheckCount(long long value) {
    m_healthCheckCountHasBeenSet = true;
    m_healthCheckCount = value;
  }
  inline GetHealthCheckCountResult& WithHealthCheckCount(long long value) {
    SetHealthCheckCount(value);
    return *this;
  }
  ///@}
