...
class CreateTrafficPolicyVersionResult {
 public:
  ...
  void SetTrafficPolicy(TrafficPolicyT&& value) {
    m_trafficPolicyHasBeenSet = true;
    m_trafficPolicy = std::forward<TrafficPolicyT>(value);
  }
  template <typename TrafficPolicyT = TrafficPolicy>
  CreateTrafficPolicyVersionResult& WithTrafficPolicy(TrafficPolicyT&& value) {
    SetTrafficPolicy(std::forward<TrafficPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocationT = Aws::String>
  CreateTrafficPolicyVersionResult& WithLocation(LocationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTrafficPolicyVersionResult& WithRequestId(RequestIdT&& value) {
