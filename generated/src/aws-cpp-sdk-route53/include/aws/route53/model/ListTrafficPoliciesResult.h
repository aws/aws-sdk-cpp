...
class ListTrafficPoliciesResult {
 public:
  ...
  void SetTrafficPolicySummaries(TrafficPolicySummariesT&& value) {
    ...
    m_trafficPolicySummaries = std::forward<TrafficPolicySummariesT>(value);
  }
  template <typename TrafficPolicySummariesT = Aws::Vector<TrafficPolicySummary>>
  ListTrafficPoliciesResult& WithTrafficPolicySummaries(TrafficPolicySummariesT&& value) {
    SetTrafficPolicySummaries(std::forward<TrafficPolicySummariesT>(value));
    return *this;
  }
  ...
  ListTrafficPoliciesResult& AddTrafficPolicySummaries(TrafficPolicySummariesT&& value) {
    m_trafficPolicySummariesHasBeenSet = true;
    m_trafficPolicySummaries.emplace_back(std::forward<TrafficPolicySummariesT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListTrafficPoliciesResult& WithIsTruncated(bool value) {
  ...
  void SetTrafficPolicyIdMarker(TrafficPolicyIdMarkerT&& value) {
    ...
    m_trafficPolicyIdMarker = std::forward<TrafficPolicyIdMarkerT>(value);
  }
  template <typename TrafficPolicyIdMarkerT = Aws::String>
  ListTrafficPoliciesResult& WithTrafficPolicyIdMarker(TrafficPolicyIdMarkerT&& value) {
    SetTrafficPolicyIdMarker(std::forward<TrafficPolicyIdMarkerT>(value));
    return *this;
  }
  ///@}
