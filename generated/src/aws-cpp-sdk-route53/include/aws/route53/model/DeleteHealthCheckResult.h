...
namespace Model
{
  ...
  public:
    ...
    inline DeleteHealthCheckResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteHealthCheckResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteHealthCheckResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
