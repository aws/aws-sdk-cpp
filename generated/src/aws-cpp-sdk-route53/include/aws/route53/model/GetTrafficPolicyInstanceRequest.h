...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetTrafficPolicyInstanceRequest : public Route53Request
  {
  public:
    AWS_ROUTE53_API GetTrafficPolicyInstanceRequest() = default;
    ...
    template<typename IdT = Aws::String>
    GetTrafficPolicyInstanceRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
