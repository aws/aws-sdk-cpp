...
class ListTrafficPolicyInstancesRequest : public Route53Request {
 public:
  ...
  template <typename HostedZoneIdMarkerT = Aws::String>
  ListTrafficPolicyInstancesRequest& WithHostedZoneIdMarker(HostedZoneIdMarkerT&& value) {
  ...
  template <typename TrafficPolicyInstanceNameMarkerT = Aws::String>
  ListTrafficPolicyInstancesRequest& WithTrafficPolicyInstanceNameMarker(TrafficPolicyInstanceNameMarkerT&& value) {
  ...
  inline ListTrafficPolicyInstancesRequest& WithTrafficPolicyInstanceTypeMarker(RRType value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListTrafficPolicyInstancesRequest& WithMaxItems(MaxItemsT&& value) {
