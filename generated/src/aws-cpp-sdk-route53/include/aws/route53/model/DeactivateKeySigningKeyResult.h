...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53_API DeactivateKeySigningKeyResult() = default;
    ...
    template<typename ChangeInfoT = ChangeInfo>
    DeactivateKeySigningKeyResult& WithChangeInfo(ChangeInfoT&& value) { SetChangeInfo(std::forward<ChangeInfoT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeactivateKeySigningKeyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
