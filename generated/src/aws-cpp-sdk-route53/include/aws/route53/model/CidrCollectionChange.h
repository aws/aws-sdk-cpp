...
class CidrCollectionChange {
 public:
  ...
  inline void SetAction(CidrCollectionChangeAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline CidrCollectionChange& WithAction(CidrCollectionChangeAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
