...
class DNSSECStatus {
 public:
  ...
  void SetServeSignature(ServeSignatureT&& value) {
    m_serveSignatureHasBeenSet = true;
    m_serveSignature = std::forward<ServeSignatureT>(value);
  }
  template <typename ServeSignatureT = Aws::String>
  DNSSECStatus& WithServeSignature(ServeSignatureT&& value) {
    SetServeSignature(std::forward<ServeSignatureT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  DNSSECStatus& WithStatusMessage(StatusMessageT&& value) {
