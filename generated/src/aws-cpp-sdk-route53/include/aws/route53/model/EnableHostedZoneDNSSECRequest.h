...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53_API EnableHostedZoneDNSSECRequest() = default;
    ...
    template<typename HostedZoneIdT = Aws::String>
    EnableHostedZoneDNSSECRequest& WithHostedZoneId(HostedZoneIdT&& value) { SetHostedZoneId(std::forward<HostedZoneIdT>(value)); return *this;}
    ///@}
  private:
