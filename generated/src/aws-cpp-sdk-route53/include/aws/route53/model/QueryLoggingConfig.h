...
class QueryLoggingConfig {
 public:
  ...
  template <typename IdT = Aws::String>
  QueryLoggingConfig& WithId(IdT&& value) {
  ...
  template <typename HostedZoneIdT = Aws::String>
  QueryLoggingConfig& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  template <typename CloudWatchLogsLogGroupArnT = Aws::String>
  QueryLoggingConfig& WithCloudWatchLogsLogGroupArn(CloudWatchLogsLogGroupArnT&& value) {
