...
class HealthCheckConfig {
 public:
  ...
  inline void SetRequestInterval(int value) {
    m_requestIntervalHasBeenSet = true;
    m_requestInterval = value;
  }
  inline HealthCheckConfig& WithRequestInterval(int value) {
  ...
  inline void SetMeasureLatency(bool value) {
    m_measureLatencyHasBeenSet = true;
    m_measureLatency = value;
  }
  inline HealthCheckConfig& WithMeasureLatency(bool value) {
    SetMeasureLatency(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckConfig& WithInverted(bool value) {
    SetInverted(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckConfig& WithDisabled(bool value) {
    SetDisabled(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckConfig& WithHealthThreshold(int value) {
  ...
  inline HealthCheckConfig& WithEnableSNI(bool value) {
    SetEnableSNI(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheckConfig& AddRegions(HealthCheckRegion value) {
    m_regionsHasBeenSet = true;
  ...
  inline HealthCheckConfig& WithInsufficientDataHealthStatus(InsufficientDataHealthStatus value) {
