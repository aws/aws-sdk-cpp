...
class CreateTrafficPolicyInstanceRequest : public Route53Request {
 public:
  ...
  template <typename HostedZoneIdT = Aws::String>
  CreateTrafficPolicyInstanceRequest& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateTrafficPolicyInstanceRequest& WithName(NameT&& value) {
  ...
  inline CreateTrafficPolicyInstanceRequest& WithTTL(long long value) {
    SetTTL(value);
    return *this;
  }
  ///@}
  ...
  template <typename TrafficPolicyIdT = Aws::String>
  CreateTrafficPolicyInstanceRequest& WithTrafficPolicyId(TrafficPolicyIdT&& value) {
  ...
  inline void SetTrafficPolicyVersion(int value) {
    m_trafficPolicyVersionHasBeenSet = true;
    m_trafficPolicyVersion = value;
  }
  inline CreateTrafficPolicyInstanceRequest& WithTrafficPolicyVersion(int value) {
    SetTrafficPolicyVersion(value);
    return *this;
  }
  ///@}
 private:
