...
class ListCidrLocationsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCidrLocationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetCidrLocations(CidrLocationsT&& value) {
    m_cidrLocationsHasBeenSet = true;
    m_cidrLocations = std::forward<CidrLocationsT>(value);
  }
  template <typename CidrLocationsT = Aws::Vector<LocationSummary>>
  ListCidrLocationsResult& WithCidrLocations(CidrLocationsT&& value) {
    SetCidrLocations(std::forward<CidrLocationsT>(value));
    return *this;
  }
  template <typename CidrLocationsT = LocationSummary>
  ListCidrLocationsResult& AddCidrLocations(CidrLocationsT&& value) {
    m_cidrLocationsHasBeenSet = true;
    m_cidrLocations.emplace_back(std::forward<CidrLocationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCidrLocationsResult& WithRequestId(RequestIdT&& value) {
