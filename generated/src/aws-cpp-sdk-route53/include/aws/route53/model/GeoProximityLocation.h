...
class GeoProximityLocation {
 public:
  ...
  void SetLocalZoneGroup(LocalZoneGroupT&& value) {
    ...
    m_localZoneGroup = std::forward<LocalZoneGroupT>(value);
  }
  template <typename LocalZoneGroupT = Aws::String>
  GeoProximityLocation& WithLocalZoneGroup(LocalZoneGroupT&& value) {
    SetLocalZoneGroup(std::forward<LocalZoneGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCoordinates(CoordinatesT&& value) {
    ...
    m_coordinates = std::forward<CoordinatesT>(value);
  }
  template <typename CoordinatesT = Coordinates>
  GeoProximityLocation& WithCoordinates(CoordinatesT&& value) {
    SetCoordinates(std::forward<CoordinatesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBias(int value) {
    m_biasHasBeenSet = true;
    m_bias = value;
  }
  inline GeoProximityLocation& WithBias(int value) {
    SetBias(value);
    return *this;
  }
  ///@}
