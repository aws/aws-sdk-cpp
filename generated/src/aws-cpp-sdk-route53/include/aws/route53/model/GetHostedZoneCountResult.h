...
class GetHostedZoneCountResult {
 public:
  ...
  inline void SetHostedZoneCount(long long value) {
    m_hostedZoneCountHasBeenSet = true;
    m_hostedZoneCount = value;
  }
  inline GetHostedZoneCountResult& WithHostedZoneCount(long long value) {
    SetHostedZoneCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetHostedZoneCountResult& WithRequestId(RequestIdT&& value) {
