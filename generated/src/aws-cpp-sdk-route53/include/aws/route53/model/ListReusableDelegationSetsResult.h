...
class ListReusableDelegationSetsResult {
 public:
  ...
  void SetDelegationSets(DelegationSetsT&& value) {
    m_delegationSetsHasBeenSet = true;
    m_delegationSets = std::forward<DelegationSetsT>(value);
  }
  template <typename DelegationSetsT = Aws::Vector<DelegationSet>>
  ListReusableDelegationSetsResult& WithDelegationSets(DelegationSetsT&& value) {
    SetDelegationSets(std::forward<DelegationSetsT>(value));
    return *this;
  }
  template <typename DelegationSetsT = DelegationSet>
  ListReusableDelegationSetsResult& AddDelegationSets(DelegationSetsT&& value) {
    m_delegationSetsHasBeenSet = true;
    m_delegationSets.emplace_back(std::forward<DelegationSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListReusableDelegationSetsResult& WithMarker(MarkerT&& value) {
  ...
  inline ListReusableDelegationSetsResult& WithIsTruncated(bool value) {
  ...
  template <typename NextMarkerT = Aws::String>
  ListReusableDelegationSetsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListReusableDelegationSetsResult& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListReusableDelegationSetsResult& WithRequestId(RequestIdT&& value) {
