...
class UpdateTrafficPolicyCommentRequest : public Route53Request {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateTrafficPolicyCommentRequest& WithId(IdT&& value) {
  ...
  inline UpdateTrafficPolicyCommentRequest& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  template <typename CommentT = Aws::String>
  UpdateTrafficPolicyCommentRequest& WithComment(CommentT&& value) {
