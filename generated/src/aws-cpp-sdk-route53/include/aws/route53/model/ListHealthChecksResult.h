...
namespace Model
{
  ...
  public:
    ...
    inline ListHealthChecksResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListHealthChecksResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListHealthChecksResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
