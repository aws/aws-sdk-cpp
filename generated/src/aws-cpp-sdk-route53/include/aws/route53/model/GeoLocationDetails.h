...
class GeoLocationDetails {
 public:
  ...
  void SetContinentName(ContinentNameT&& value) {
    ...
    m_continentName = std::forward<ContinentNameT>(value);
  }
  template <typename ContinentNameT = Aws::String>
  GeoLocationDetails& WithContinentName(ContinentNameT&& value) {
    SetContinentName(std::forward<ContinentNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubdivisionName(SubdivisionNameT&& value) {
    ...
    m_subdivisionName = std::forward<SubdivisionNameT>(value);
  }
  template <typename SubdivisionNameT = Aws::String>
  GeoLocationDetails& WithSubdivisionName(SubdivisionNameT&& value) {
    SetSubdivisionName(std::forward<SubdivisionNameT>(value));
    return *this;
  }
  ///@}
 private:
