...
class ListHostedZonesByNameResult {
 public:
  ...
  void SetHostedZones(HostedZonesT&& value) {
    ...
    m_hostedZones = std::forward<HostedZonesT>(value);
  }
  template <typename HostedZonesT = Aws::Vector<HostedZone>>
  ListHostedZonesByNameResult& WithHostedZones(HostedZonesT&& value) {
    SetHostedZones(std::forward<HostedZonesT>(value));
    return *this;
  }
  template <typename HostedZonesT = HostedZone>
  ListHostedZonesByNameResult& AddHostedZones(HostedZonesT&& value) {
    m_hostedZonesHasBeenSet = true;
    m_hostedZones.emplace_back(std::forward<HostedZonesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DNSNameT = Aws::String>
  ListHostedZonesByNameResult& WithDNSName(DNSNameT&& value) {
  ...
  template <typename HostedZoneIdT = Aws::String>
  ListHostedZonesByNameResult& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  inline ListHostedZonesByNameResult& WithIsTruncated(bool value) {
  ...
  void SetNextDNSName(NextDNSNameT&& value) {
    m_nextDNSNameHasBeenSet = true;
    m_nextDNSName = std::forward<NextDNSNameT>(value);
  }
  template <typename NextDNSNameT = Aws::String>
  ListHostedZonesByNameResult& WithNextDNSName(NextDNSNameT&& value) {
    SetNextDNSName(std::forward<NextDNSNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextHostedZoneId(NextHostedZoneIdT&& value) {
    m_nextHostedZoneIdHasBeenSet = true;
    m_nextHostedZoneId = std::forward<NextHostedZoneIdT>(value);
  }
  template <typename NextHostedZoneIdT = Aws::String>
  ListHostedZonesByNameResult& WithNextHostedZoneId(NextHostedZoneIdT&& value) {
    SetNextHostedZoneId(std::forward<NextHostedZoneIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MaxItemsT = Aws::String>
  ListHostedZonesByNameResult& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListHostedZonesByNameResult& WithRequestId(RequestIdT&& value) {
