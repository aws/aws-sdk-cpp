...
class ListVPCAssociationAuthorizationsRequest : public Route53Request {
 public:
  ...
  template <typename HostedZoneIdT = Aws::String>
  ListVPCAssociationAuthorizationsRequest& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListVPCAssociationAuthorizationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename MaxResultsT = Aws::String>
  ListVPCAssociationAuthorizationsRequest& WithMaxResults(MaxResultsT&& value) {
