...
class ListCidrBlocksResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCidrBlocksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename CidrBlocksT = Aws::Vector<CidrBlockSummary>>
  ListCidrBlocksResult& WithCidrBlocks(CidrBlocksT&& value) {
    SetCidrBlocks(std::forward<CidrBlocksT>(value));
    return *this;
  }
  template <typename CidrBlocksT = CidrBlockSummary>
  ListCidrBlocksResult& AddCidrBlocks(CidrBlocksT&& value) {
    m_cidrBlocksHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListCidrBlocksResult& WithRequestId(RequestIdT&& value) {
