...
class ResourceRecordSet {
 public:
  ...
  inline void SetType(RRType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ResourceRecordSet& WithType(RRType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetSetIdentifier(SetIdentifierT&& value) {
    ...
    m_setIdentifier = std::forward<SetIdentifierT>(value);
  }
  template <typename SetIdentifierT = Aws::String>
  ResourceRecordSet& WithSetIdentifier(SetIdentifierT&& value) {
    SetSetIdentifier(std::forward<SetIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetWeight(long long value) {
    m_weightHasBeenSet = true;
    m_weight = value;
  }
  inline ResourceRecordSet& WithWeight(long long value) {
    SetWeight(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRegion(ResourceRecordSetRegion value) {
    m_regionHasBeenSet = true;
    m_region = value;
  }
  inline ResourceRecordSet& WithRegion(ResourceRecordSetRegion value) {
    SetRegion(value);
    return *this;
  }
  ///@}
  ...
  void SetGeoLocation(GeoLocationT&& value) {
    ...
    m_geoLocation = std::forward<GeoLocationT>(value);
  }
  template <typename GeoLocationT = GeoLocation>
  ResourceRecordSet& WithGeoLocation(GeoLocationT&& value) {
    SetGeoLocation(std::forward<GeoLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFailover(ResourceRecordSetFailover value) {
    m_failoverHasBeenSet = true;
    m_failover = value;
  }
  inline ResourceRecordSet& WithFailover(ResourceRecordSetFailover value) {
    SetFailover(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMultiValueAnswer(bool value) {
    m_multiValueAnswerHasBeenSet = true;
    m_multiValueAnswer = value;
  }
  inline ResourceRecordSet& WithMultiValueAnswer(bool value) {
    SetMultiValueAnswer(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTTL(long long value) {
    m_tTLHasBeenSet = true;
    m_tTL = value;
  }
  inline ResourceRecordSet& WithTTL(long long value) {
    SetTTL(value);
    return *this;
  }
  ///@}
  ...
  void SetResourceRecords(ResourceRecordsT&& value) {
    ...
    m_resourceRecords = std::forward<ResourceRecordsT>(value);
  }
  template <typename ResourceRecordsT = Aws::Vector<ResourceRecord>>
  ResourceRecordSet& WithResourceRecords(ResourceRecordsT&& value) {
    SetResourceRecords(std::forward<ResourceRecordsT>(value));
    return *this;
  }
  template <typename ResourceRecordsT = ResourceRecord>
  ResourceRecordSet& AddResourceRecords(ResourceRecordsT&& value) {
    m_resourceRecordsHasBeenSet = true;
    m_resourceRecords.emplace_back(std::forward<ResourceRecordsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAliasTarget(AliasTargetT&& value) {
    ...
    m_aliasTarget = std::forward<AliasTargetT>(value);
  }
  template <typename AliasTargetT = AliasTarget>
  ResourceRecordSet& WithAliasTarget(AliasTargetT&& value) {
    SetAliasTarget(std::forward<AliasTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrafficPolicyInstanceId(TrafficPolicyInstanceIdT&& value) {
    ...
    m_trafficPolicyInstanceId = std::forward<TrafficPolicyInstanceIdT>(value);
  }
  template <typename TrafficPolicyInstanceIdT = Aws::String>
  ResourceRecordSet& WithTrafficPolicyInstanceId(TrafficPolicyInstanceIdT&& value) {
    SetTrafficPolicyInstanceId(std::forward<TrafficPolicyInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCidrRoutingConfig(CidrRoutingConfigT&& value) {
    ...
    m_cidrRoutingConfig = std::forward<CidrRoutingConfigT>(value);
  }
  template <typename CidrRoutingConfigT = CidrRoutingConfig>
  ResourceRecordSet& WithCidrRoutingConfig(CidrRoutingConfigT&& value) {
    SetCidrRoutingConfig(std::forward<CidrRoutingConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGeoProximityLocation(GeoProximityLocationT&& value) {
    ...
    m_geoProximityLocation = std::forward<GeoProximityLocationT>(value);
  }
  template <typename GeoProximityLocationT = GeoProximityLocation>
  ResourceRecordSet& WithGeoProximityLocation(GeoProximityLocationT&& value) {
    SetGeoProximityLocation(std::forward<GeoProximityLocationT>(value));
    return *this;
  }
  ///@}
 private:
