...
class HostedZoneOwner {
 public:
  ...
  void SetOwningAccount(OwningAccountT&& value) {
    ...
    m_owningAccount = std::forward<OwningAccountT>(value);
  }
  template <typename OwningAccountT = Aws::String>
  HostedZoneOwner& WithOwningAccount(OwningAccountT&& value) {
    SetOwningAccount(std::forward<OwningAccountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOwningService(OwningServiceT&& value) {
    ...
    m_owningService = std::forward<OwningServiceT>(value);
  }
  template <typename OwningServiceT = Aws::String>
  HostedZoneOwner& WithOwningService(OwningServiceT&& value) {
    SetOwningService(std::forward<OwningServiceT>(value));
    return *this;
  }
  ///@}
 private:
