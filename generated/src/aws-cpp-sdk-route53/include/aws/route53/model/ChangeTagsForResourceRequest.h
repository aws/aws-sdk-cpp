...
class ChangeTagsForResourceRequest : public Route53Request {
 public:
  ...
  inline ChangeTagsForResourceRequest& WithResourceType(TagResourceType value) {
  ...
  template <typename ResourceIdT = Aws::String>
  ChangeTagsForResourceRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename AddTagsT = Aws::Vector<Tag>>
  ChangeTagsForResourceRequest& WithAddTags(AddTagsT&& value) {
    SetAddTags(std::forward<AddTagsT>(value));
    return *this;
  }
  template <typename AddTagsT = Tag>
  ChangeTagsForResourceRequest& AddAddTags(AddTagsT&& value) {
    m_addTagsHasBeenSet = true;
  ...
  void SetRemoveTagKeys(RemoveTagKeysT&& value) {
    m_removeTagKeysHasBeenSet = true;
    m_removeTagKeys = std::forward<RemoveTagKeysT>(value);
  }
  template <typename RemoveTagKeysT = Aws::Vector<Aws::String>>
  ChangeTagsForResourceRequest& WithRemoveTagKeys(RemoveTagKeysT&& value) {
    SetRemoveTagKeys(std::forward<RemoveTagKeysT>(value));
    return *this;
  }
  template <typename RemoveTagKeysT = Aws::String>
  ChangeTagsForResourceRequest& AddRemoveTagKeys(RemoveTagKeysT&& value) {
    m_removeTagKeysHasBeenSet = true;
    m_removeTagKeys.emplace_back(std::forward<RemoveTagKeysT>(value));
    return *this;
  }
  ///@}
 private:
