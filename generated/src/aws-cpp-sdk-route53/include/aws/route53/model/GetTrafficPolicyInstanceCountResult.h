...
class GetTrafficPolicyInstanceCountResult {
 public:
  ...
  inline void SetTrafficPolicyInstanceCount(int value) {
    m_trafficPolicyInstanceCountHasBeenSet = true;
    m_trafficPolicyInstanceCount = value;
  }
  inline GetTrafficPolicyInstanceCountResult& WithTrafficPolicyInstanceCount(int value) {
    SetTrafficPolicyInstanceCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetTrafficPolicyInstanceCountResult& WithRequestId(RequestIdT&& value) {
