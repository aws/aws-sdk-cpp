...
class ListQueryLoggingConfigsRequest : public Route53Request {
 public:
  ...
  template <typename HostedZoneIdT = Aws::String>
  ListQueryLoggingConfigsRequest& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListQueryLoggingConfigsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename MaxResultsT = Aws::String>
  ListQueryLoggingConfigsRequest& WithMaxResults(MaxResultsT&& value) {
