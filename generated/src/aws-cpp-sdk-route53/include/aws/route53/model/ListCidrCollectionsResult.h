...
class ListCidrCollectionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCidrCollectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetCidrCollections(CidrCollectionsT&& value) {
    m_cidrCollectionsHasBeenSet = true;
    m_cidrCollections = std::forward<CidrCollectionsT>(value);
  }
  template <typename CidrCollectionsT = Aws::Vector<CollectionSummary>>
  ListCidrCollectionsResult& WithCidrCollections(CidrCollectionsT&& value) {
    SetCidrCollections(std::forward<CidrCollectionsT>(value));
    return *this;
  }
  template <typename CidrCollectionsT = CollectionSummary>
  ListCidrCollectionsResult& AddCidrCollections(CidrCollectionsT&& value) {
    m_cidrCollectionsHasBeenSet = true;
    m_cidrCollections.emplace_back(std::forward<CidrCollectionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCidrCollectionsResult& WithRequestId(RequestIdT&& value) {
