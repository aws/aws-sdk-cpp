...
class CreateHostedZoneRequest : public Route53Request {
 public:
  ...
  void SetHostedZoneConfig(HostedZoneConfigT&& value) {
    m_hostedZoneConfigHasBeenSet = true;
    m_hostedZoneConfig = std::forward<HostedZoneConfigT>(value);
  }
  template <typename HostedZoneConfigT = HostedZoneConfig>
  CreateHostedZoneRequest& WithHostedZoneConfig(HostedZoneConfigT&& value) {
    SetHostedZoneConfig(std::forward<HostedZoneConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDelegationSetId(DelegationSetIdT&& value) {
    m_delegationSetIdHasBeenSet = true;
    m_delegationSetId = std::forward<DelegationSetIdT>(value);
  }
  template <typename DelegationSetIdT = Aws::String>
  CreateHostedZoneRequest& WithDelegationSetId(DelegationSetIdT&& value) {
    SetDelegationSetId(std::forward<DelegationSetIdT>(value));
    return *this;
  }
  ///@}
 private:
