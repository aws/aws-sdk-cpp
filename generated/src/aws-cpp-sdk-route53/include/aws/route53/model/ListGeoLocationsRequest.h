...
class ListGeoLocationsRequest : public Route53Request {
 public:
  ...
  void SetStartContinentCode(StartContinentCodeT&& value) {
    m_startContinentCodeHasBeenSet = true;
    m_startContinentCode = std::forward<StartContinentCodeT>(value);
  }
  template <typename StartContinentCodeT = Aws::String>
  ListGeoLocationsRequest& WithStartContinentCode(StartContinentCodeT&& value) {
    SetStartContinentCode(std::forward<StartContinentCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartCountryCode(StartCountryCodeT&& value) {
    m_startCountryCodeHasBeenSet = true;
    m_startCountryCode = std::forward<StartCountryCodeT>(value);
  }
  template <typename StartCountryCodeT = Aws::String>
  ListGeoLocationsRequest& WithStartCountryCode(StartCountryCodeT&& value) {
    SetStartCountryCode(std::forward<StartCountryCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartSubdivisionCode(StartSubdivisionCodeT&& value) {
    m_startSubdivisionCodeHasBeenSet = true;
    m_startSubdivisionCode = std::forward<StartSubdivisionCodeT>(value);
  }
  template <typename StartSubdivisionCodeT = Aws::String>
  ListGeoLocationsRequest& WithStartSubdivisionCode(StartSubdivisionCodeT&& value) {
    SetStartSubdivisionCode(std::forward<StartSubdivisionCodeT>(value));
    return *this;
  }
  ///@}
