...
class ReusableDelegationSetLimit {
 public:
  ...
  inline void SetType(ReusableDelegationSetLimitType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ReusableDelegationSetLimit& WithType(ReusableDelegationSetLimitType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline ReusableDelegationSetLimit& WithValue(long long value) {
    SetValue(value);
    return *this;
  }
  ///@}
