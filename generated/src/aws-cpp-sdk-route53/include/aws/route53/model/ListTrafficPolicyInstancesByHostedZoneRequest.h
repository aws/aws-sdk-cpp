...
class ListTrafficPolicyInstancesByHostedZoneRequest : public Route53Request {
 public:
  ...
  template <typename HostedZoneIdT = Aws::String>
  ListTrafficPolicyInstancesByHostedZoneRequest& WithHostedZoneId(HostedZoneIdT&& value) {
  ...
  template <typename TrafficPolicyInstanceNameMarkerT = Aws::String>
  ListTrafficPolicyInstancesByHostedZoneRequest& WithTrafficPolicyInstanceNameMarker(TrafficPolicyInstanceNameMarkerT&& value) {
  ...
  inline ListTrafficPolicyInstancesByHostedZoneRequest& WithTrafficPolicyInstanceTypeMarker(RRType value) {
  ...
  template <typename MaxItemsT = Aws::String>
  ListTrafficPolicyInstancesByHostedZoneRequest& WithMaxItems(MaxItemsT&& value) {
