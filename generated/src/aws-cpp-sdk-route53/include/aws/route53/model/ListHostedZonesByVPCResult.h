...
class ListHostedZonesByVPCResult {
 public:
  ...
  void SetHostedZoneSummaries(HostedZoneSummariesT&& value) {
    m_hostedZoneSummariesHasBeenSet = true;
    m_hostedZoneSummaries = std::forward<HostedZoneSummariesT>(value);
  }
  template <typename HostedZoneSummariesT = Aws::Vector<HostedZoneSummary>>
  ListHostedZonesByVPCResult& WithHostedZoneSummaries(HostedZoneSummariesT&& value) {
    SetHostedZoneSummaries(std::forward<HostedZoneSummariesT>(value));
    return *this;
  }
  template <typename HostedZoneSummariesT = HostedZoneSummary>
  ListHostedZonesByVPCResult& AddHostedZoneSummaries(HostedZoneSummariesT&& value) {
    m_hostedZoneSummariesHasBeenSet = true;
    m_hostedZoneSummaries.emplace_back(std::forward<HostedZoneSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MaxItemsT = Aws::String>
  ListHostedZonesByVPCResult& WithMaxItems(MaxItemsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListHostedZonesByVPCResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListHostedZonesByVPCResult& WithRequestId(RequestIdT&& value) {
