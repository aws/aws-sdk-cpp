...
class AWS_ROUTE53_API Route53Client : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  Route53Client(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<Route53EndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for ActivateKeySigningKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ActivateKeySigningKey that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ActivateKeySigningKeyRequestT = Model::ActivateKeySigningKeyRequest>
  void ActivateKeySigningKeyAsync(const ActivateKeySigningKeyRequestT& request, const ActivateKeySigningKeyResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateVPCWithHostedZoneOutcome AssociateVPCWithHostedZone(
      const Model::AssociateVPCWithHostedZoneRequest& request) const;

  /**
   * A Callable wrapper for AssociateVPCWithHostedZone that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateVPCWithHostedZoneRequestT = Model::AssociateVPCWithHostedZoneRequest>
  Model::AssociateVPCWithHostedZoneOutcomeCallable AssociateVPCWithHostedZoneCallable(
      const AssociateVPCWithHostedZoneRequestT& request) const {
    return SubmitCallable(&Route53Client::AssociateVPCWithHostedZone, request);
  }

  /**
   * An Async wrapper for AssociateVPCWithHostedZone that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateVPCWithHostedZoneRequestT = Model::AssociateVPCWithHostedZoneRequest>
  void AssociateVPCWithHostedZoneAsync(const AssociateVPCWithHostedZoneRequestT& request,
  ...
  /**
   * A Callable wrapper for ChangeCidrCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ChangeCidrCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ChangeCidrCollectionRequestT = Model::ChangeCidrCollectionRequest>
  void ChangeCidrCollectionAsync(const ChangeCidrCollectionRequestT& request, const ChangeCidrCollectionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ChangeResourceRecordSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ChangeResourceRecordSets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ChangeResourceRecordSetsRequestT = Model::ChangeResourceRecordSetsRequest>
  void ChangeResourceRecordSetsAsync(const ChangeResourceRecordSetsRequestT& request,
  ...
  /**
   * A Callable wrapper for ChangeTagsForResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ChangeTagsForResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ChangeTagsForResourceRequestT = Model::ChangeTagsForResourceRequest>
  void ChangeTagsForResourceAsync(const ChangeTagsForResourceRequestT& request, const ChangeTagsForResourceResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCidrCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCidrCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCidrCollectionRequestT = Model::CreateCidrCollectionRequest>
  void CreateCidrCollectionAsync(const CreateCidrCollectionRequestT& request, const CreateCidrCollectionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateHealthCheck that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateHealthCheck that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateHealthCheckRequestT = Model::CreateHealthCheckRequest>
  void CreateHealthCheckAsync(const CreateHealthCheckRequestT& request, const CreateHealthCheckResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateHostedZone that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateHostedZone that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateHostedZoneRequestT = Model::CreateHostedZoneRequest>
  void CreateHostedZoneAsync(const CreateHostedZoneRequestT& request, const CreateHostedZoneResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateKeySigningKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateKeySigningKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateKeySigningKeyRequestT = Model::CreateKeySigningKeyRequest>
  void CreateKeySigningKeyAsync(const CreateKeySigningKeyRequestT& request, const CreateKeySigningKeyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateQueryLoggingConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateQueryLoggingConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateQueryLoggingConfigRequestT = Model::CreateQueryLoggingConfigRequest>
  void CreateQueryLoggingConfigAsync(const CreateQueryLoggingConfigRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateReusableDelegationSetOutcome CreateReusableDelegationSet(
      const Model::CreateReusableDelegationSetRequest& request) const;

  /**
   * A Callable wrapper for CreateReusableDelegationSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateReusableDelegationSetRequestT = Model::CreateReusableDelegationSetRequest>
  Model::CreateReusableDelegationSetOutcomeCallable CreateReusableDelegationSetCallable(
      const CreateReusableDelegationSetRequestT& request) const {
    return SubmitCallable(&Route53Client::CreateReusableDelegationSet, request);
  }

  /**
   * An Async wrapper for CreateReusableDelegationSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateReusableDelegationSetRequestT = Model::CreateReusableDelegationSetRequest>
  void CreateReusableDelegationSetAsync(const CreateReusableDelegationSetRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateTrafficPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTrafficPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateTrafficPolicyRequestT = Model::CreateTrafficPolicyRequest>
  void CreateTrafficPolicyAsync(const CreateTrafficPolicyRequestT& request, const CreateTrafficPolicyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateTrafficPolicyInstanceOutcome CreateTrafficPolicyInstance(
      const Model::CreateTrafficPolicyInstanceRequest& request) const;

  /**
   * A Callable wrapper for CreateTrafficPolicyInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateTrafficPolicyInstanceRequestT = Model::CreateTrafficPolicyInstanceRequest>
  Model::CreateTrafficPolicyInstanceOutcomeCallable CreateTrafficPolicyInstanceCallable(
      const CreateTrafficPolicyInstanceRequestT& request) const {
    return SubmitCallable(&Route53Client::CreateTrafficPolicyInstance, request);
  }

  /**
   * An Async wrapper for CreateTrafficPolicyInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTrafficPolicyInstanceRequestT = Model::CreateTrafficPolicyInstanceRequest>
  void CreateTrafficPolicyInstanceAsync(const CreateTrafficPolicyInstanceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateTrafficPolicyVersionOutcome CreateTrafficPolicyVersion(
      const Model::CreateTrafficPolicyVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateTrafficPolicyVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateTrafficPolicyVersionRequestT = Model::CreateTrafficPolicyVersionRequest>
  Model::CreateTrafficPolicyVersionOutcomeCallable CreateTrafficPolicyVersionCallable(
      const CreateTrafficPolicyVersionRequestT& request) const {
    return SubmitCallable(&Route53Client::CreateTrafficPolicyVersion, request);
  }

  /**
   * An Async wrapper for CreateTrafficPolicyVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTrafficPolicyVersionRequestT = Model::CreateTrafficPolicyVersionRequest>
  void CreateTrafficPolicyVersionAsync(const CreateTrafficPolicyVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateVPCAssociationAuthorizationOutcome CreateVPCAssociationAuthorization(
      const Model::CreateVPCAssociationAuthorizationRequest& request) const;

  /**
   * A Callable wrapper for CreateVPCAssociationAuthorization that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateVPCAssociationAuthorizationRequestT = Model::CreateVPCAssociationAuthorizationRequest>
  Model::CreateVPCAssociationAuthorizationOutcomeCallable CreateVPCAssociationAuthorizationCallable(
      const CreateVPCAssociationAuthorizationRequestT& request) const {
    return SubmitCallable(&Route53Client::CreateVPCAssociationAuthorization, request);
  }

  /**
   * An Async wrapper for CreateVPCAssociationAuthorization that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateVPCAssociationAuthorizationRequestT = Model::CreateVPCAssociationAuthorizationRequest>
  void CreateVPCAssociationAuthorizationAsync(const CreateVPCAssociationAuthorizationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeactivateKeySigningKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeactivateKeySigningKey that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeactivateKeySigningKeyRequestT = Model::DeactivateKeySigningKeyRequest>
  void DeactivateKeySigningKeyAsync(const DeactivateKeySigningKeyRequestT& request,
                                    const DeactivateKeySigningKeyResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCidrCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCidrCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCidrCollectionRequestT = Model::DeleteCidrCollectionRequest>
  void DeleteCidrCollectionAsync(const DeleteCidrCollectionRequestT& request, const DeleteCidrCollectionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteHealthCheck that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteHealthCheck that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteHealthCheckRequestT = Model::DeleteHealthCheckRequest>
  void DeleteHealthCheckAsync(const DeleteHealthCheckRequestT& request, const DeleteHealthCheckResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * default SOA and NS records and has DNSSEC signing disabled. If the hosted zone
   * contains other records or has DNSSEC enabled, you must delete the records and
   * disable DNSSEC before deletion. Attempting to delete a hosted zone with
   * additional records or DNSSEC enabled returns a <code>HostedZoneNotEmpty</code>
   * error. For information about deleting records, see <a
   * href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_ChangeResourceRecordSets.html">ChangeResourceRecordSets</a>.
   * </p> <p>To verify that the hosted zone has been deleted, do one of the
   * following:</p> <ul> <li> <p>Use the <code>GetHostedZone</code> action to request
   * information about the hosted zone.</p> </li> <li> <p>Use the
   * <code>ListHostedZones</code> action to get a list of the hosted zones associated
   * with the current Amazon Web Services account.</p> </li> </ul><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for DeleteHostedZone that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteHostedZone that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteHostedZoneRequestT = Model::DeleteHostedZoneRequest>
  void DeleteHostedZoneAsync(const DeleteHostedZoneRequestT& request, const DeleteHostedZoneResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteKeySigningKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteKeySigningKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteKeySigningKeyRequestT = Model::DeleteKeySigningKeyRequest>
  void DeleteKeySigningKeyAsync(const DeleteKeySigningKeyRequestT& request, const DeleteKeySigningKeyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteQueryLoggingConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteQueryLoggingConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteQueryLoggingConfigRequestT = Model::DeleteQueryLoggingConfigRequest>
  void DeleteQueryLoggingConfigAsync(const DeleteQueryLoggingConfigRequestT& request,
  ...
  virtual Model::DeleteReusableDelegationSetOutcome DeleteReusableDelegationSet(
      const Model::DeleteReusableDelegationSetRequest& request) const;

  /**
   * A Callable wrapper for DeleteReusableDelegationSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteReusableDelegationSetRequestT = Model::DeleteReusableDelegationSetRequest>
  Model::DeleteReusableDelegationSetOutcomeCallable DeleteReusableDelegationSetCallable(
      const DeleteReusableDelegationSetRequestT& request) const {
    return SubmitCallable(&Route53Client::DeleteReusableDelegationSet, request);
  }

  /**
   * An Async wrapper for DeleteReusableDelegationSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteReusableDelegationSetRequestT = Model::DeleteReusableDelegationSetRequest>
  void DeleteReusableDelegationSetAsync(const DeleteReusableDelegationSetRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteTrafficPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTrafficPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteTrafficPolicyRequestT = Model::DeleteTrafficPolicyRequest>
  void DeleteTrafficPolicyAsync(const DeleteTrafficPolicyRequestT& request, const DeleteTrafficPolicyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteTrafficPolicyInstanceOutcome DeleteTrafficPolicyInstance(
      const Model::DeleteTrafficPolicyInstanceRequest& request) const;

  /**
   * A Callable wrapper for DeleteTrafficPolicyInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteTrafficPolicyInstanceRequestT = Model::DeleteTrafficPolicyInstanceRequest>
  Model::DeleteTrafficPolicyInstanceOutcomeCallable DeleteTrafficPolicyInstanceCallable(
      const DeleteTrafficPolicyInstanceRequestT& request) const {
    return SubmitCallable(&Route53Client::DeleteTrafficPolicyInstance, request);
  }

  /**
   * An Async wrapper for DeleteTrafficPolicyInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTrafficPolicyInstanceRequestT = Model::DeleteTrafficPolicyInstanceRequest>
  void DeleteTrafficPolicyInstanceAsync(const DeleteTrafficPolicyInstanceRequestT& request,
  ...
  virtual Model::DeleteVPCAssociationAuthorizationOutcome DeleteVPCAssociationAuthorization(
      const Model::DeleteVPCAssociationAuthorizationRequest& request) const;

  /**
   * A Callable wrapper for DeleteVPCAssociationAuthorization that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteVPCAssociationAuthorizationRequestT = Model::DeleteVPCAssociationAuthorizationRequest>
  Model::DeleteVPCAssociationAuthorizationOutcomeCallable DeleteVPCAssociationAuthorizationCallable(
      const DeleteVPCAssociationAuthorizationRequestT& request) const {
    return SubmitCallable(&Route53Client::DeleteVPCAssociationAuthorization, request);
  }

  /**
   * An Async wrapper for DeleteVPCAssociationAuthorization that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteVPCAssociationAuthorizationRequestT = Model::DeleteVPCAssociationAuthorizationRequest>
  void DeleteVPCAssociationAuthorizationAsync(const DeleteVPCAssociationAuthorizationRequestT& request,
  ...
  /**
   * A Callable wrapper for DisableHostedZoneDNSSEC that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableHostedZoneDNSSEC that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableHostedZoneDNSSECRequestT = Model::DisableHostedZoneDNSSECRequest>
  void DisableHostedZoneDNSSECAsync(const DisableHostedZoneDNSSECRequestT& request,
                                    const DisableHostedZoneDNSSECResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateVPCFromHostedZoneOutcome DisassociateVPCFromHostedZone(
      const Model::DisassociateVPCFromHostedZoneRequest& request) const;

  /**
   * A Callable wrapper for DisassociateVPCFromHostedZone that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateVPCFromHostedZoneRequestT = Model::DisassociateVPCFromHostedZoneRequest>
  Model::DisassociateVPCFromHostedZoneOutcomeCallable DisassociateVPCFromHostedZoneCallable(
      const DisassociateVPCFromHostedZoneRequestT& request) const {
    return SubmitCallable(&Route53Client::DisassociateVPCFromHostedZone, request);
  }

  /**
   * An Async wrapper for DisassociateVPCFromHostedZone that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateVPCFromHostedZoneRequestT = Model::DisassociateVPCFromHostedZoneRequest>
  void DisassociateVPCFromHostedZoneAsync(const DisassociateVPCFromHostedZoneRequestT& request,
  ...
  /**
   * A Callable wrapper for EnableHostedZoneDNSSEC that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableHostedZoneDNSSEC that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableHostedZoneDNSSECRequestT = Model::EnableHostedZoneDNSSECRequest>
  void EnableHostedZoneDNSSECAsync(const EnableHostedZoneDNSSECRequestT& request,
                                   const EnableHostedZoneDNSSECResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAccountLimit that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAccountLimitRequestT = Model::GetAccountLimitRequest>
  void GetAccountLimitAsync(const GetAccountLimitRequestT& request, const GetAccountLimitResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetChange that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetChangeRequestT = Model::GetChangeRequest>
  void GetChangeAsync(const GetChangeRequestT& request, const GetChangeResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCheckerIpRanges that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCheckerIpRanges that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCheckerIpRangesRequestT = Model::GetCheckerIpRangesRequest>
  void GetCheckerIpRangesAsync(const GetCheckerIpRangesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetCheckerIpRangesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetDNSSEC that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDNSSECRequestT = Model::GetDNSSECRequest>
  void GetDNSSECAsync(const GetDNSSECRequestT& request, const GetDNSSECResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetGeoLocation that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGeoLocationRequestT = Model::GetGeoLocationRequest>
  void GetGeoLocationAsync(const GetGeoLocationResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetGeoLocationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetHealthCheck that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetHealthCheckRequestT = Model::GetHealthCheckRequest>
  void GetHealthCheckAsync(const GetHealthCheckRequestT& request, const GetHealthCheckResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetHealthCheckCount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetHealthCheckCount that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetHealthCheckCountRequestT = Model::GetHealthCheckCountRequest>
  void GetHealthCheckCountAsync(const GetHealthCheckCountResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetHealthCheckCountRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetHealthCheckLastFailureReasonOutcome GetHealthCheckLastFailureReason(
      const Model::GetHealthCheckLastFailureReasonRequest& request) const;

  /**
   * A Callable wrapper for GetHealthCheckLastFailureReason that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetHealthCheckLastFailureReasonRequestT = Model::GetHealthCheckLastFailureReasonRequest>
  Model::GetHealthCheckLastFailureReasonOutcomeCallable GetHealthCheckLastFailureReasonCallable(
      const GetHealthCheckLastFailureReasonRequestT& request) const {
    return SubmitCallable(&Route53Client::GetHealthCheckLastFailureReason, request);
  }

  /**
   * An Async wrapper for GetHealthCheckLastFailureReason that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetHealthCheckLastFailureReasonRequestT = Model::GetHealthCheckLastFailureReasonRequest>
  void GetHealthCheckLastFailureReasonAsync(const GetHealthCheckLastFailureReasonRequestT& request,
  ...
  /**
   * A Callable wrapper for GetHealthCheckStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetHealthCheckStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetHealthCheckStatusRequestT = Model::GetHealthCheckStatusRequest>
  void GetHealthCheckStatusAsync(const GetHealthCheckStatusRequestT& request, const GetHealthCheckStatusResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetHostedZone that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetHostedZoneRequestT = Model::GetHostedZoneRequest>
  void GetHostedZoneAsync(const GetHostedZoneRequestT& request, const GetHostedZoneResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetHostedZoneCount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetHostedZoneCount that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetHostedZoneCountRequestT = Model::GetHostedZoneCountRequest>
  void GetHostedZoneCountAsync(const GetHostedZoneCountResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetHostedZoneCountRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetHostedZoneLimit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetHostedZoneLimit that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetHostedZoneLimitRequestT = Model::GetHostedZoneLimitRequest>
  void GetHostedZoneLimitAsync(const GetHostedZoneLimitRequestT& request, const GetHostedZoneLimitResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetQueryLoggingConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetQueryLoggingConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetQueryLoggingConfigRequestT = Model::GetQueryLoggingConfigRequest>
  void GetQueryLoggingConfigAsync(const GetQueryLoggingConfigRequestT& request, const GetQueryLoggingConfigResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReusableDelegationSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReusableDelegationSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetReusableDelegationSetRequestT = Model::GetReusableDelegationSetRequest>
  void GetReusableDelegationSetAsync(const GetReusableDelegationSetRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetReusableDelegationSetLimitOutcome GetReusableDelegationSetLimit(
      const Model::GetReusableDelegationSetLimitRequest& request) const;

  /**
   * A Callable wrapper for GetReusableDelegationSetLimit that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetReusableDelegationSetLimitRequestT = Model::GetReusableDelegationSetLimitRequest>
  Model::GetReusableDelegationSetLimitOutcomeCallable GetReusableDelegationSetLimitCallable(
      const GetReusableDelegationSetLimitRequestT& request) const {
    return SubmitCallable(&Route53Client::GetReusableDelegationSetLimit, request);
  }

  /**
   * An Async wrapper for GetReusableDelegationSetLimit that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetReusableDelegationSetLimitRequestT = Model::GetReusableDelegationSetLimitRequest>
  void GetReusableDelegationSetLimitAsync(const GetReusableDelegationSetLimitRequestT& request,
  ...
  /**
   * A Callable wrapper for GetTrafficPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTrafficPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTrafficPolicyRequestT = Model::GetTrafficPolicyRequest>
  void GetTrafficPolicyAsync(const GetTrafficPolicyRequestT& request, const GetTrafficPolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTrafficPolicyInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTrafficPolicyInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTrafficPolicyInstanceRequestT = Model::GetTrafficPolicyInstanceRequest>
  void GetTrafficPolicyInstanceAsync(const GetTrafficPolicyInstanceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTrafficPolicyInstanceCountOutcome GetTrafficPolicyInstanceCount(
      const Model::GetTrafficPolicyInstanceCountRequest& request = {}) const;

  /**
   * A Callable wrapper for GetTrafficPolicyInstanceCount that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetTrafficPolicyInstanceCountRequestT = Model::GetTrafficPolicyInstanceCountRequest>
  Model::GetTrafficPolicyInstanceCountOutcomeCallable GetTrafficPolicyInstanceCountCallable(
      const GetTrafficPolicyInstanceCountRequestT& request = {}) const {
    return SubmitCallable(&Route53Client::GetTrafficPolicyInstanceCount, request);
  }

  /**
   * An Async wrapper for GetTrafficPolicyInstanceCount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTrafficPolicyInstanceCountRequestT = Model::GetTrafficPolicyInstanceCountRequest>
  void GetTrafficPolicyInstanceCountAsync(const GetTrafficPolicyInstanceCountResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const GetTrafficPolicyInstanceCountRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListCidrBlocks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCidrBlocksRequestT = Model::ListCidrBlocksRequest>
  void ListCidrBlocksAsync(const ListCidrBlocksRequestT& request, const ListCidrBlocksResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCidrCollections that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCidrCollections that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCidrCollectionsRequestT = Model::ListCidrCollectionsRequest>
  void ListCidrCollectionsAsync(const ListCidrCollectionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListCidrCollectionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCidrLocations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCidrLocations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCidrLocationsRequestT = Model::ListCidrLocationsRequest>
  void ListCidrLocationsAsync(const ListCidrLocationsRequestT& request, const ListCidrLocationsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListGeoLocations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGeoLocations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGeoLocationsRequestT = Model::ListGeoLocationsRequest>
  void ListGeoLocationsAsync(const ListGeoLocationsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListGeoLocationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListHealthChecks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListHealthChecks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListHealthChecksRequestT = Model::ListHealthChecksRequest>
  void ListHealthChecksAsync(const ListHealthChecksResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListHealthChecksRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListHostedZones that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListHostedZonesRequestT = Model::ListHostedZonesRequest>
  void ListHostedZonesAsync(const ListHostedZonesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListHostedZonesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListHostedZonesByName that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListHostedZonesByName that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListHostedZonesByNameRequestT = Model::ListHostedZonesByNameRequest>
  void ListHostedZonesByNameAsync(const ListHostedZonesByNameResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListHostedZonesByNameRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListHostedZonesByVPC that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListHostedZonesByVPC that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListHostedZonesByVPCRequestT = Model::ListHostedZonesByVPCRequest>
  void ListHostedZonesByVPCAsync(const ListHostedZonesByVPCRequestT& request, const ListHostedZonesByVPCResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListQueryLoggingConfigs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListQueryLoggingConfigs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListQueryLoggingConfigsRequestT = Model::ListQueryLoggingConfigsRequest>
  void ListQueryLoggingConfigsAsync(const ListQueryLoggingConfigsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListQueryLoggingConfigsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListResourceRecordSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceRecordSets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceRecordSetsRequestT = Model::ListResourceRecordSetsRequest>
  void ListResourceRecordSetsAsync(const ListResourceRecordSetsRequestT& request,
  ...
  virtual Model::ListReusableDelegationSetsOutcome ListReusableDelegationSets(
      const Model::ListReusableDelegationSetsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListReusableDelegationSets that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListReusableDelegationSetsRequestT = Model::ListReusableDelegationSetsRequest>
  Model::ListReusableDelegationSetsOutcomeCallable ListReusableDelegationSetsCallable(
      const ListReusableDelegationSetsRequestT& request = {}) const {
    return SubmitCallable(&Route53Client::ListReusableDelegationSets, request);
  }

  /**
   * An Async wrapper for ListReusableDelegationSets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListReusableDelegationSetsRequestT = Model::ListReusableDelegationSetsRequest>
  void ListReusableDelegationSetsAsync(const ListReusableDelegationSetsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListReusableDelegationSetsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTagsForResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTagsForResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTagsForResourcesRequestT = Model::ListTagsForResourcesRequest>
  void ListTagsForResourcesAsync(const ListTagsForResourcesRequestT& request, const ListTagsForResourcesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTrafficPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTrafficPolicies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTrafficPoliciesRequestT = Model::ListTrafficPoliciesRequest>
  void ListTrafficPoliciesAsync(const ListTrafficPoliciesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListTrafficPoliciesRequestT& request = {}) const {
  ...
  virtual Model::ListTrafficPolicyInstancesOutcome ListTrafficPolicyInstances(
      const Model::ListTrafficPolicyInstancesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListTrafficPolicyInstances that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListTrafficPolicyInstancesRequestT = Model::ListTrafficPolicyInstancesRequest>
  Model::ListTrafficPolicyInstancesOutcomeCallable ListTrafficPolicyInstancesCallable(
      const ListTrafficPolicyInstancesRequestT& request = {}) const {
    return SubmitCallable(&Route53Client::ListTrafficPolicyInstances, request);
  }

  /**
   * An Async wrapper for ListTrafficPolicyInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTrafficPolicyInstancesRequestT = Model::ListTrafficPolicyInstancesRequest>
  void ListTrafficPolicyInstancesAsync(const ListTrafficPolicyInstancesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListTrafficPolicyInstancesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTrafficPolicyInstancesByHostedZoneOutcome ListTrafficPolicyInstancesByHostedZone(
      const Model::ListTrafficPolicyInstancesByHostedZoneRequest& request) const;

  /**
   * A Callable wrapper for ListTrafficPolicyInstancesByHostedZone that returns a future to the operation so that it can be executed in
  ...
  Model::ListTrafficPolicyInstancesByHostedZoneOutcomeCallable ListTrafficPolicyInstancesByHostedZoneCallable(
      const ListTrafficPolicyInstancesByHostedZoneRequestT& request) const {
    return SubmitCallable(&Route53Client::ListTrafficPolicyInstancesByHostedZone, request);
  }

  /**
   * An Async wrapper for ListTrafficPolicyInstancesByHostedZone that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListTrafficPolicyInstancesByHostedZoneRequestT = Model::ListTrafficPolicyInstancesByHostedZoneRequest>
  void ListTrafficPolicyInstancesByHostedZoneAsync(const ListTrafficPolicyInstancesByHostedZoneRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTrafficPolicyInstancesByPolicyOutcome ListTrafficPolicyInstancesByPolicy(
      const Model::ListTrafficPolicyInstancesByPolicyRequest& request) const;

  /**
   * A Callable wrapper for ListTrafficPolicyInstancesByPolicy that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListTrafficPolicyInstancesByPolicyRequestT = Model::ListTrafficPolicyInstancesByPolicyRequest>
  Model::ListTrafficPolicyInstancesByPolicyOutcomeCallable ListTrafficPolicyInstancesByPolicyCallable(
      const ListTrafficPolicyInstancesByPolicyRequestT& request) const {
    return SubmitCallable(&Route53Client::ListTrafficPolicyInstancesByPolicy, request);
  }

  /**
   * An Async wrapper for ListTrafficPolicyInstancesByPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListTrafficPolicyInstancesByPolicyRequestT = Model::ListTrafficPolicyInstancesByPolicyRequest>
  void ListTrafficPolicyInstancesByPolicyAsync(const ListTrafficPolicyInstancesByPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for ListTrafficPolicyVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListTrafficPolicyVersionsRequestT = Model::ListTrafficPolicyVersionsRequest>
  Model::ListTrafficPolicyVersionsOutcomeCallable ListTrafficPolicyVersionsCallable(
      const ListTrafficPolicyVersionsRequestT& request) const {
    return SubmitCallable(&Route53Client::ListTrafficPolicyVersions, request);
  }

  /**
   * An Async wrapper for ListTrafficPolicyVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTrafficPolicyVersionsRequestT = Model::ListTrafficPolicyVersionsRequest>
  void ListTrafficPolicyVersionsAsync(const ListTrafficPolicyVersionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListVPCAssociationAuthorizationsOutcome ListVPCAssociationAuthorizations(
      const Model::ListVPCAssociationAuthorizationsRequest& request) const;

  /**
   * A Callable wrapper for ListVPCAssociationAuthorizations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListVPCAssociationAuthorizationsRequestT = Model::ListVPCAssociationAuthorizationsRequest>
  Model::ListVPCAssociationAuthorizationsOutcomeCallable ListVPCAssociationAuthorizationsCallable(
      const ListVPCAssociationAuthorizationsRequestT& request) const {
    return SubmitCallable(&Route53Client::ListVPCAssociationAuthorizations, request);
  }

  /**
   * An Async wrapper for ListVPCAssociationAuthorizations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListVPCAssociationAuthorizationsRequestT = Model::ListVPCAssociationAuthorizationsRequest>
  void ListVPCAssociationAuthorizationsAsync(const ListVPCAssociationAuthorizationsRequestT& request,
  ...
  /**
   * An Async wrapper for TestDNSAnswer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TestDNSAnswerRequestT = Model::TestDNSAnswerRequest>
  void TestDNSAnswerAsync(const TestDNSAnswerRequestT& request, const TestDNSAnswerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateHealthCheck that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateHealthCheck that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateHealthCheckRequestT = Model::UpdateHealthCheckRequest>
  void UpdateHealthCheckAsync(const UpdateHealthCheckRequestT& request, const UpdateHealthCheckResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateHostedZoneComment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateHostedZoneComment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateHostedZoneCommentRequestT = Model::UpdateHostedZoneCommentRequest>
  void UpdateHostedZoneCommentAsync(const UpdateHostedZoneCommentRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateTrafficPolicyCommentOutcome UpdateTrafficPolicyComment(
      const Model::UpdateTrafficPolicyCommentRequest& request) const;

  /**
   * A Callable wrapper for UpdateTrafficPolicyComment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateTrafficPolicyCommentRequestT = Model::UpdateTrafficPolicyCommentRequest>
  Model::UpdateTrafficPolicyCommentOutcomeCallable UpdateTrafficPolicyCommentCallable(
      const UpdateTrafficPolicyCommentRequestT& request) const {
    return SubmitCallable(&Route53Client::UpdateTrafficPolicyComment, request);
  }

  /**
   * An Async wrapper for UpdateTrafficPolicyComment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTrafficPolicyCommentRequestT = Model::UpdateTrafficPolicyCommentRequest>
  void UpdateTrafficPolicyCommentAsync(const UpdateTrafficPolicyCommentRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateTrafficPolicyInstanceOutcome UpdateTrafficPolicyInstance(
      const Model::UpdateTrafficPolicyInstanceRequest& request) const;

  /**
   * A Callable wrapper for UpdateTrafficPolicyInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateTrafficPolicyInstanceRequestT = Model::UpdateTrafficPolicyInstanceRequest>
  Model::UpdateTrafficPolicyInstanceOutcomeCallable UpdateTrafficPolicyInstanceCallable(
      const UpdateTrafficPolicyInstanceRequestT& request) const {
    return SubmitCallable(&Route53Client::UpdateTrafficPolicyInstance, request);
  }

  /**
   * An Async wrapper for UpdateTrafficPolicyInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTrafficPolicyInstanceRequestT = Model::UpdateTrafficPolicyInstanceRequest>
  void UpdateTrafficPolicyInstanceAsync(const UpdateTrafficPolicyInstanceRequestT& request,
