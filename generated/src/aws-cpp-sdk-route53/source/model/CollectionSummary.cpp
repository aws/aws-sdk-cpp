...
CollectionSummary::CollectionSummary(const XmlNode& xmlNode) { *this = xmlNode; }

CollectionSummary& CollectionSummary::operator=(const XmlNode& xmlNode) {
...
void CollectionSummary::AddToNode(XmlNode& parentNode) const {
  Aws::StringStream ss;
  if (m_arnHasBeenSet) {
