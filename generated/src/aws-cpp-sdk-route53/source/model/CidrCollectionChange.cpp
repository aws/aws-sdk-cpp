...
CidrCollectionChange::CidrCollectionChange(const XmlNode& xmlNode) { *this = xmlNode; }
...
CidrCollectionChange& CidrCollectionChange::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!actionNode.IsNull()) {
      m_action = CidrCollectionChangeActionMapper::GetCidrCollectionChangeActionForName(
