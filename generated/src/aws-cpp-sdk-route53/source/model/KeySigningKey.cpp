...
KeySigningKey::KeySigningKey(const XmlNode& xmlNode) { *this = xmlNode; }
...
KeySigningKey& KeySigningKey::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!signingAlgorithmTypeNode.IsNull()) {
      m_signingAlgorithmType = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(signingAlgorithmTypeNode.GetText()).c_str()).c_str());
    ...
    if (!digestAlgorithmTypeNode.IsNull()) {
      m_digestAlgorithmType = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(digestAlgorithmTypeNode.GetText()).c_str()).c_str());
      m_digestAlgorithmTypeHasBeenSet = true;
    }
    XmlNode keyTagNode = resultNode.FirstChild("KeyTag");
    if (!keyTagNode.IsNull()) {
      m_keyTag =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(keyTagNode.GetText()).c_str()).c_str());
    ...
    if (!lastModifiedDateNode.IsNull()) {
      m_lastModifiedDate =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lastModifiedDateNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
