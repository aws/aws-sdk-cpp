...
/**
 */
class ListAccountsRequest : public ComputeOptimizerAutomationRequest {
 public:
  AWS_COMPUTEOPTIMIZERAUTOMATION_API ListAccountsRequest() = default;
  ...
  inline ListAccountsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountsRequest& WithNextToken(NextTokenT&& value) {
