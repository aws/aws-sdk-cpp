...
class RecommendedActionSummary {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API RecommendedActionSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API RecommendedActionSummary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
