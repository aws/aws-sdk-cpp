...
class Criteria {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API Criteria(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API Criteria& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
