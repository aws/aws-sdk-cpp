...
/**
 */
class ListAutomationRulePreviewRequest : public ComputeOptimizerAutomationRequest {
 public:
  AWS_COMPUTEOPTIMIZERAUTOMATION_API ListAutomationRulePreviewRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListAutomationRulePreview"; }
  ...
  inline ListAutomationRulePreviewRequest& WithRuleType(RuleType value) {
    SetRuleType(value);
    return *this;
  }
  ///@}
  ...
  template <typename OrganizationScopeT = OrganizationScope>
  ListAutomationRulePreviewRequest& WithOrganizationScope(OrganizationScopeT&& value) {
  ...
  template <typename RecommendedActionTypesT = Aws::Vector<RecommendedActionType>>
  ListAutomationRulePreviewRequest& WithRecommendedActionTypes(RecommendedActionTypesT&& value) {
    SetRecommendedActionTypes(std::forward<RecommendedActionTypesT>(value));
    return *this;
  }
  inline ListAutomationRulePreviewRequest& AddRecommendedActionTypes(RecommendedActionType value) {
    m_recommendedActionTypesHasBeenSet = true;
  ...
  template <typename CriteriaT = Criteria>
  ListAutomationRulePreviewRequest& WithCriteria(CriteriaT&& value) {
  ...
  ///@{
  /**
   * <p>The maximum number of automation rule preview results to return in a single
  ...
  inline ListAutomationRulePreviewRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAutomationRulePreviewRequest& WithNextToken(NextTokenT&& value) {
