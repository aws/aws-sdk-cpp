...
class AccountInfo {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AccountInfo(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AccountInfo& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
