...
class DisassociateAccountsResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API DisassociateAccountsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API DisassociateAccountsResult& operator=(
