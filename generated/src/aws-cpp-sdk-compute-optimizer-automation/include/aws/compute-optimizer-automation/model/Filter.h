...
class Filter {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API Filter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API Filter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
