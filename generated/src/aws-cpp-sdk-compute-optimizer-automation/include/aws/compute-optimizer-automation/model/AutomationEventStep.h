...
class AutomationEventStep {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AutomationEventStep(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AutomationEventStep& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
