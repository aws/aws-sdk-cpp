...
class AutomationEvent {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AutomationEvent(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AutomationEvent& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
