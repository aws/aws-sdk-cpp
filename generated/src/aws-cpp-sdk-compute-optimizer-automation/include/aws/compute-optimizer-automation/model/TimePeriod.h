...
class TimePeriod {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API TimePeriod(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API TimePeriod& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
