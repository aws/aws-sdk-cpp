...
class AutomationEventSummary {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AutomationEventSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AutomationEventSummary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
