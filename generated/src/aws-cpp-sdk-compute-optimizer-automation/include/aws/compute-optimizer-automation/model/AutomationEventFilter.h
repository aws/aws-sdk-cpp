...
class AutomationEventFilter {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AutomationEventFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AutomationEventFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
