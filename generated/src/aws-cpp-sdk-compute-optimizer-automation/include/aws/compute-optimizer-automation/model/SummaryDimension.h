...
class SummaryDimension {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API SummaryDimension(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API SummaryDimension& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
