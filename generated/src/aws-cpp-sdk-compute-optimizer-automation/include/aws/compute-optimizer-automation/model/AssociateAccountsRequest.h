...
/**
 */
class AssociateAccountsRequest : public ComputeOptimizerAutomationRequest {
 public:
  ...
  ///@{
  /**
   * <p> The IDs of the member accounts to associate. You can specify up to 50
   * account IDs. </p>
   */
  ...
  ///@{
  /**
   * <p> A unique identifier to ensure idempotency of the request. Valid for 24 hours
   * after creation. </p>
   */
