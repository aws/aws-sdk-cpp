...
class AutomationRule {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AutomationRule(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API AutomationRule& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
