...
class StringCriteriaCondition {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API StringCriteriaCondition(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API StringCriteriaCondition& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
