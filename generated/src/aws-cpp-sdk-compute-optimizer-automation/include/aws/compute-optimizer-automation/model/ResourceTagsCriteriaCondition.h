...
class ResourceTagsCriteriaCondition {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API ResourceTagsCriteriaCondition(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API ResourceTagsCriteriaCondition& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
