...
class PreviewResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API PreviewResult(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API PreviewResult& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline PreviewResult& WithLookBackPeriodInDays(int64_t value) {
