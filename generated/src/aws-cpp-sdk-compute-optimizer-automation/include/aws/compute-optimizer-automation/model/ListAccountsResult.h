...
class ListAccountsResult {
 public:
  ...
  AWS_COMPUTEOPTIMIZERAUTOMATION_API ListAccountsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPUTEOPTIMIZERAUTOMATION_API ListAccountsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
