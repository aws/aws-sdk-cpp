...
GetEnrollmentConfigurationResult::GetEnrollmentConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

GetEnrollmentConfigurationResult& GetEnrollmentConfigurationResult::operator=(
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "status") {
                ...
                if (val.has_value()) {
                  m_status = EnrollmentStatusMapper::GetEnrollmentStatusForName(
              ...
              else if (initialKeyStr == "organizationRuleMode") {
                auto val = decoder->PopNextTextVal();
                if (val.has_value()) {
                  m_organizationRuleMode = OrganizationRuleModeMapper::GetOrganizationRuleModeForName(
                      Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len));
                }
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("GetEnrollmentConfigurationResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
