...
PreviewResult::PreviewResult(JsonView jsonValue) { *this = jsonValue; }

PreviewResult& PreviewResult::operator=(JsonView jsonValue) {
...
JsonValue PreviewResult::Jsonize() const {
  JsonValue payload;
