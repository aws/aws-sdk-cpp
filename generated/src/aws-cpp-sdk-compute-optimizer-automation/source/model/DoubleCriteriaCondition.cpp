...
DoubleCriteriaCondition::DoubleCriteriaCondition(JsonView jsonValue) { *this = jsonValue; }

DoubleCriteriaCondition& DoubleCriteriaCondition::operator=(JsonView jsonValue) {
...
JsonValue DoubleCriteriaCondition::Jsonize() const {
  JsonValue payload;
