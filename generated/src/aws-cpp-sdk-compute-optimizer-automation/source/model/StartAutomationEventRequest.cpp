...
Aws::String StartAutomationEventRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection StartAutomationEventRequest::GetRequestSpecificHeaders() const {
