...
StringCriteriaCondition::StringCriteriaCondition(JsonView jsonValue) { *this = jsonValue; }

StringCriteriaCondition& StringCriteriaCondition::operator=(JsonView jsonValue) {
...
JsonValue StringCriteriaCondition::Jsonize() const {
  JsonValue payload;
