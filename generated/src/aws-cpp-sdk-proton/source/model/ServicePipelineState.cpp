...
ServicePipelineState::ServicePipelineState(JsonView jsonValue) { *this = jsonValue; }

ServicePipelineState& ServicePipelineState::operator=(JsonView jsonValue) {
...
JsonValue ServicePipelineState::Jsonize() const {
  JsonValue payload;
