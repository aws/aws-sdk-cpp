...
Deployment& Deployment::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("targetResourceType")) {
    m_targetResourceType =
        DeploymentTargetResourceTypeMapper::GetDeploymentTargetResourceTypeForName(jsonValue.GetString("targetResourceType"));
...
JsonValue Deployment::Jsonize() const {
  ...
  if (m_targetResourceTypeHasBeenSet) {
    payload.WithString("targetResourceType",
                       DeploymentTargetResourceTypeMapper::GetNameForDeploymentTargetResourceType(m_targetResourceType));
  }
