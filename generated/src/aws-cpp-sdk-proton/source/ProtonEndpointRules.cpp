...
namespace Proton
{
const size_t ProtonEndpointRules::RulesBlobStrLen = 3518;
const size_t ProtonEndpointRules::RulesBlobSize = 3519;
...
't','o','n','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'p','s',':','/','/','p','r','o','t','o','n','-','f','i','p','s','.','{','R','e','g','i','o','n','}',
...
const char* ProtonEndpointRules::GetRulesBlob()
{
