...
class DeploymentState {
 public:
  ...
  void SetServiceInstance(ServiceInstanceT&& value) {
    ...
    m_serviceInstance = std::forward<ServiceInstanceT>(value);
  }
  template <typename ServiceInstanceT = ServiceInstanceState>
  DeploymentState& WithServiceInstance(ServiceInstanceT&& value) {
    SetServiceInstance(std::forward<ServiceInstanceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServicePipeline(ServicePipelineT&& value) {
    ...
    m_servicePipeline = std::forward<ServicePipelineT>(value);
  }
  template <typename ServicePipelineT = ServicePipelineState>
  DeploymentState& WithServicePipeline(ServicePipelineT&& value) {
    SetServicePipeline(std::forward<ServicePipelineT>(value));
    return *this;
  }
  ///@}
 private:
