...
class ComponentState {
 public:
  ...
  void SetServiceSpec(ServiceSpecT&& value) {
    ...
    m_serviceSpec = std::forward<ServiceSpecT>(value);
  }
  template <typename ServiceSpecT = Aws::String>
  ComponentState& WithServiceSpec(ServiceSpecT&& value) {
    SetServiceSpec(std::forward<ServiceSpecT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateFile(TemplateFileT&& value) {
    ...
    m_templateFile = std::forward<TemplateFileT>(value);
  }
  template <typename TemplateFileT = Aws::String>
  ComponentState& WithTemplateFile(TemplateFileT&& value) {
    SetTemplateFile(std::forward<TemplateFileT>(value));
    return *this;
  }
  ///@}
 private:
