...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API GetRepositoryResult() = default;
    ...
    template<typename RepositoryT = Repository>
    GetRepositoryResult& WithRepository(RepositoryT&& value) { SetRepository(std::forward<RepositoryT>(value)); return *this;}
    ///@}
