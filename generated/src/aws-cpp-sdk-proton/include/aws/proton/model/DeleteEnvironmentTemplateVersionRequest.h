...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API DeleteEnvironmentTemplateVersionRequest() = default;
    ...
    template<typename MajorVersionT = Aws::String>
    DeleteEnvironmentTemplateVersionRequest& WithMajorVersion(MajorVersionT&& value) { SetMajorVersion(std::forward<MajorVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename MinorVersionT = Aws::String>
    DeleteEnvironmentTemplateVersionRequest& WithMinorVersion(MinorVersionT&& value) { SetMinorVersion(std::forward<MinorVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename TemplateNameT = Aws::String>
    DeleteEnvironmentTemplateVersionRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
  private:
