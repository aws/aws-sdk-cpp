...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API ListComponentsRequest() = default;
    ...
    template<typename ServiceInstanceNameT = Aws::String>
    ListComponentsRequest& WithServiceInstanceName(ServiceInstanceNameT&& value) { SetServiceInstanceName(std::forward<ServiceInstanceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ServiceNameT = Aws::String>
    ListComponentsRequest& WithServiceName(ServiceNameT&& value) { SetServiceName(std::forward<ServiceNameT>(value)); return *this;}
    ///@}
  private:
