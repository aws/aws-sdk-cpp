...
class ListServiceInstancesFilter {
 public:
  ...
  inline void SetKey(ListServiceInstancesFilterBy value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline ListServiceInstancesFilter& WithKey(ListServiceInstancesFilterBy value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  ListServiceInstancesFilter& WithValue(ValueT&& value) {
