...
namespace Model
{
  ...
  /**
   * <p>Summary data of an Proton service template resource.</p><p><h3>See Also:</h3>
   * <a
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    ServiceTemplateSummary& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    ServiceTemplateSummary& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    ServiceTemplateSummary& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DisplayNameT = Aws::String>
    ServiceTemplateSummary& WithDisplayName(DisplayNameT&& value) { SetDisplayName(std::forward<DisplayNameT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedAtT = Aws::Utils::DateTime>
    ServiceTemplateSummary& WithLastModifiedAt(LastModifiedAtT&& value) { SetLastModifiedAt(std::forward<LastModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ServiceTemplateSummary& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline ServiceTemplateSummary& WithPipelineProvisioning(Provisioning value) { SetPipelineProvisioning(value); return *this;}
    ///@}
    ...
    template<typename RecommendedVersionT = Aws::String>
    ServiceTemplateSummary& WithRecommendedVersion(RecommendedVersionT&& value) { SetRecommendedVersion(std::forward<RecommendedVersionT>(value)); return *this;}
    ///@}
  private:
