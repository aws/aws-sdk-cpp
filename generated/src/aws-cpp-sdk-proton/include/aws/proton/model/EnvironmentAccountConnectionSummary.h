...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    EnvironmentAccountConnectionSummary& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ComponentRoleArnT = Aws::String>
    EnvironmentAccountConnectionSummary& WithComponentRoleArn(ComponentRoleArnT&& value) { SetComponentRoleArn(std::forward<ComponentRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentAccountIdT = Aws::String>
    EnvironmentAccountConnectionSummary& WithEnvironmentAccountId(EnvironmentAccountIdT&& value) { SetEnvironmentAccountId(std::forward<EnvironmentAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentNameT = Aws::String>
    EnvironmentAccountConnectionSummary& WithEnvironmentName(EnvironmentNameT&& value) { SetEnvironmentName(std::forward<EnvironmentNameT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    EnvironmentAccountConnectionSummary& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedAtT = Aws::Utils::DateTime>
    EnvironmentAccountConnectionSummary& WithLastModifiedAt(LastModifiedAtT&& value) { SetLastModifiedAt(std::forward<LastModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename ManagementAccountIdT = Aws::String>
    EnvironmentAccountConnectionSummary& WithManagementAccountId(ManagementAccountIdT&& value) { SetManagementAccountId(std::forward<ManagementAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestedAtT = Aws::Utils::DateTime>
    EnvironmentAccountConnectionSummary& WithRequestedAt(RequestedAtT&& value) { SetRequestedAt(std::forward<RequestedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    EnvironmentAccountConnectionSummary& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
    ...
    inline EnvironmentAccountConnectionSummary& WithStatus(EnvironmentAccountConnectionStatus value) { SetStatus(value); return *this;}
    ///@}
  private:
