...
class EnvironmentAccountConnection {
 public:
  ...
  void SetCodebuildRoleArn(CodebuildRoleArnT&& value) {
    ...
    m_codebuildRoleArn = std::forward<CodebuildRoleArnT>(value);
  }
  template <typename CodebuildRoleArnT = Aws::String>
  EnvironmentAccountConnection& WithCodebuildRoleArn(CodebuildRoleArnT&& value) {
    SetCodebuildRoleArn(std::forward<CodebuildRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline EnvironmentAccountConnection& WithStatus(EnvironmentAccountConnectionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
