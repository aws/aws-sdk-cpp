...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API GetServiceTemplateVersionResult() = default;
    ...
    template<typename ServiceTemplateVersionT = ServiceTemplateVersion>
    GetServiceTemplateVersionResult& WithServiceTemplateVersion(ServiceTemplateVersionT&& value) { SetServiceTemplateVersion(std::forward<ServiceTemplateVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetServiceTemplateVersionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
