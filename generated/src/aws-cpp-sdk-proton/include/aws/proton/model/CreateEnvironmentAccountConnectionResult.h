...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API CreateEnvironmentAccountConnectionResult() = default;
    ...
    template<typename EnvironmentAccountConnectionT = EnvironmentAccountConnection>
    CreateEnvironmentAccountConnectionResult& WithEnvironmentAccountConnection(EnvironmentAccountConnectionT&& value) { SetEnvironmentAccountConnection(std::forward<EnvironmentAccountConnectionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateEnvironmentAccountConnectionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
