...
class ServiceInstanceState {
 public:
  ...
  void SetLastSuccessfulComponentDeploymentIds(LastSuccessfulComponentDeploymentIdsT&& value) {
    ...
    m_lastSuccessfulComponentDeploymentIds = std::forward<LastSuccessfulComponentDeploymentIdsT>(value);
  }
  template <typename LastSuccessfulComponentDeploymentIdsT = Aws::Vector<Aws::String>>
  ServiceInstanceState& WithLastSuccessfulComponentDeploymentIds(LastSuccessfulComponentDeploymentIdsT&& value) {
    SetLastSuccessfulComponentDeploymentIds(std::forward<LastSuccessfulComponentDeploymentIdsT>(value));
    return *this;
  }
  ...
  ServiceInstanceState& AddLastSuccessfulComponentDeploymentIds(LastSuccessfulComponentDeploymentIdsT&& value) {
    m_lastSuccessfulComponentDeploymentIdsHasBeenSet = true;
    m_lastSuccessfulComponentDeploymentIds.emplace_back(std::forward<LastSuccessfulComponentDeploymentIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSuccessfulEnvironmentDeploymentId(LastSuccessfulEnvironmentDeploymentIdT&& value) {
    ...
    m_lastSuccessfulEnvironmentDeploymentId = std::forward<LastSuccessfulEnvironmentDeploymentIdT>(value);
  }
  template <typename LastSuccessfulEnvironmentDeploymentIdT = Aws::String>
  ServiceInstanceState& WithLastSuccessfulEnvironmentDeploymentId(LastSuccessfulEnvironmentDeploymentIdT&& value) {
    SetLastSuccessfulEnvironmentDeploymentId(std::forward<LastSuccessfulEnvironmentDeploymentIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSuccessfulServicePipelineDeploymentId(LastSuccessfulServicePipelineDeploymentIdT&& value) {
    ...
    m_lastSuccessfulServicePipelineDeploymentId = std::forward<LastSuccessfulServicePipelineDeploymentIdT>(value);
  }
  template <typename LastSuccessfulServicePipelineDeploymentIdT = Aws::String>
  ServiceInstanceState& WithLastSuccessfulServicePipelineDeploymentId(LastSuccessfulServicePipelineDeploymentIdT&& value) {
    SetLastSuccessfulServicePipelineDeploymentId(std::forward<LastSuccessfulServicePipelineDeploymentIdT>(value));
    return *this;
  }
  ///@}
