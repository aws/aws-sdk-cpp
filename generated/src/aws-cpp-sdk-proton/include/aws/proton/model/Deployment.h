...
class Deployment {
 public:
  ...
  void SetInitialState(InitialStateT&& value) {
    ...
    m_initialState = std::forward<InitialStateT>(value);
  }
  template <typename InitialStateT = DeploymentState>
  Deployment& WithInitialState(InitialStateT&& value) {
    SetInitialState(std::forward<InitialStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceInstanceName(ServiceInstanceNameT&& value) {
    ...
    m_serviceInstanceName = std::forward<ServiceInstanceNameT>(value);
  }
  template <typename ServiceInstanceNameT = Aws::String>
  Deployment& WithServiceInstanceName(ServiceInstanceNameT&& value) {
    SetServiceInstanceName(std::forward<ServiceInstanceNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetResourceCreatedAt(TargetResourceCreatedAtT&& value) {
    ...
    m_targetResourceCreatedAt = std::forward<TargetResourceCreatedAtT>(value);
  }
  template <typename TargetResourceCreatedAtT = Aws::Utils::DateTime>
  Deployment& WithTargetResourceCreatedAt(TargetResourceCreatedAtT&& value) {
    SetTargetResourceCreatedAt(std::forward<TargetResourceCreatedAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTargetResourceType(DeploymentTargetResourceType value) {
    m_targetResourceTypeHasBeenSet = true;
    m_targetResourceType = value;
  }
  inline Deployment& WithTargetResourceType(DeploymentTargetResourceType value) {
  ...
  void SetTargetState(TargetStateT&& value) {
    ...
    m_targetState = std::forward<TargetStateT>(value);
  }
  template <typename TargetStateT = DeploymentState>
  Deployment& WithTargetState(TargetStateT&& value) {
    SetTargetState(std::forward<TargetStateT>(value));
    return *this;
  }
  ///@}
 private:
