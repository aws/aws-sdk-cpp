...
class ProvisionedResource {
 public:
  ...
  inline void SetProvisioningEngine(ProvisionedResourceEngine value) {
    m_provisioningEngineHasBeenSet = true;
    m_provisioningEngine = value;
  }
  inline ProvisionedResource& WithProvisioningEngine(ProvisionedResourceEngine value) {
    SetProvisioningEngine(value);
    return *this;
  }
  ///@}
 private:
