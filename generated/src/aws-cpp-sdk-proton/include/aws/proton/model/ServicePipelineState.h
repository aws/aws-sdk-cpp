...
class ServicePipelineState {
 public:
  ...
  template <typename SpecT = Aws::String>
  ServicePipelineState& WithSpec(SpecT&& value) {
  ...
  template <typename TemplateMajorVersionT = Aws::String>
  ServicePipelineState& WithTemplateMajorVersion(TemplateMajorVersionT&& value) {
  ...
  template <typename TemplateMinorVersionT = Aws::String>
  ServicePipelineState& WithTemplateMinorVersion(TemplateMinorVersionT&& value) {
  ...
  template <typename TemplateNameT = Aws::String>
  ServicePipelineState& WithTemplateName(TemplateNameT&& value) {
