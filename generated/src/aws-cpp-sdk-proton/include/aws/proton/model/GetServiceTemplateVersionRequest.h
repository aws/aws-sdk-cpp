...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API GetServiceTemplateVersionRequest() = default;
    ...
    template<typename MajorVersionT = Aws::String>
    GetServiceTemplateVersionRequest& WithMajorVersion(MajorVersionT&& value) { SetMajorVersion(std::forward<MajorVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename MinorVersionT = Aws::String>
    GetServiceTemplateVersionRequest& WithMinorVersion(MinorVersionT&& value) { SetMinorVersion(std::forward<MinorVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename TemplateNameT = Aws::String>
    GetServiceTemplateVersionRequest& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
  private:
