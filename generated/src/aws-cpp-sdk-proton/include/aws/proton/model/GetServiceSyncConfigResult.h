...
namespace Model
{
  class GetServiceSyncConfigResult
  {
  public:
    AWS_PROTON_API GetServiceSyncConfigResult();
    AWS_PROTON_API GetServiceSyncConfigResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
