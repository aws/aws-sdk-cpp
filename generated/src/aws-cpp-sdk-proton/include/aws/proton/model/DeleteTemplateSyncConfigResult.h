...
namespace Model
{
  ...
  public:
     ...
     * <p>The template sync configuration detail data that's returned by Proton.</p>
     */
    inline DeleteTemplateSyncConfigResult& WithTemplateSyncConfig(const TemplateSyncConfig& value) { SetTemplateSyncConfig(value); return *this;}

    /**
     * <p>The template sync configuration detail data that's returned by Proton.</p>
     */
    inline DeleteTemplateSyncConfigResult& WithTemplateSyncConfig(TemplateSyncConfig&& value) { SetTemplateSyncConfig(std::move(value)); return *this;}
    ...
    inline DeleteTemplateSyncConfigResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteTemplateSyncConfigResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteTemplateSyncConfigResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
