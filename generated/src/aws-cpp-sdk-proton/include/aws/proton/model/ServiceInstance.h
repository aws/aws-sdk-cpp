...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    ServiceInstance& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    ServiceInstance& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    inline ServiceInstance& WithDeploymentStatus(DeploymentStatus value) { SetDeploymentStatus(value); return *this;}
    ///@}
    ...
    template<typename DeploymentStatusMessageT = Aws::String>
    ServiceInstance& WithDeploymentStatusMessage(DeploymentStatusMessageT&& value) { SetDeploymentStatusMessage(std::forward<DeploymentStatusMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentNameT = Aws::String>
    ServiceInstance& WithEnvironmentName(EnvironmentNameT&& value) { SetEnvironmentName(std::forward<EnvironmentNameT>(value)); return *this;}
    ///@}
    ...
    template<typename LastAttemptedDeploymentIdT = Aws::String>
    ServiceInstance& WithLastAttemptedDeploymentId(LastAttemptedDeploymentIdT&& value) { SetLastAttemptedDeploymentId(std::forward<LastAttemptedDeploymentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastClientRequestTokenT = Aws::String>
    ServiceInstance& WithLastClientRequestToken(LastClientRequestTokenT&& value) { SetLastClientRequestToken(std::forward<LastClientRequestTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename LastDeploymentAttemptedAtT = Aws::Utils::DateTime>
    ServiceInstance& WithLastDeploymentAttemptedAt(LastDeploymentAttemptedAtT&& value) { SetLastDeploymentAttemptedAt(std::forward<LastDeploymentAttemptedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename LastDeploymentSucceededAtT = Aws::Utils::DateTime>
    ServiceInstance& WithLastDeploymentSucceededAt(LastDeploymentSucceededAtT&& value) { SetLastDeploymentSucceededAt(std::forward<LastDeploymentSucceededAtT>(value)); return *this;}
    ///@}
    ...
    template<typename LastSucceededDeploymentIdT = Aws::String>
    ServiceInstance& WithLastSucceededDeploymentId(LastSucceededDeploymentIdT&& value) { SetLastSucceededDeploymentId(std::forward<LastSucceededDeploymentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ServiceInstance& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ServiceNameT = Aws::String>
    ServiceInstance& WithServiceName(ServiceNameT&& value) { SetServiceName(std::forward<ServiceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SpecT = Aws::String>
    ServiceInstance& WithSpec(SpecT&& value) { SetSpec(std::forward<SpecT>(value)); return *this;}
    ///@}
    ...
    template<typename TemplateMajorVersionT = Aws::String>
    ServiceInstance& WithTemplateMajorVersion(TemplateMajorVersionT&& value) { SetTemplateMajorVersion(std::forward<TemplateMajorVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename TemplateMinorVersionT = Aws::String>
    ServiceInstance& WithTemplateMinorVersion(TemplateMinorVersionT&& value) { SetTemplateMinorVersion(std::forward<TemplateMinorVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename TemplateNameT = Aws::String>
    ServiceInstance& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
  private:
