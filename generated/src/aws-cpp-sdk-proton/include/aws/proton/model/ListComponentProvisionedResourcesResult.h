...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API ListComponentProvisionedResourcesResult() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListComponentProvisionedResourcesResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ProvisionedResourcesT = Aws::Vector<ProvisionedResource>>
    ListComponentProvisionedResourcesResult& WithProvisionedResources(ProvisionedResourcesT&& value) { SetProvisionedResources(std::forward<ProvisionedResourcesT>(value)); return *this;}
    template<typename ProvisionedResourcesT = ProvisionedResource>
    ListComponentProvisionedResourcesResult& AddProvisionedResources(ProvisionedResourcesT&& value) { m_provisionedResourcesHasBeenSet = true; m_provisionedResources.emplace_back(std::forward<ProvisionedResourcesT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListComponentProvisionedResourcesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
