...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API NotifyResourceDeploymentStatusChangeResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    NotifyResourceDeploymentStatusChangeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
