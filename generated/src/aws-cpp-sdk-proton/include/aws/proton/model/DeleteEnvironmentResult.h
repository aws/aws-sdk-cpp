...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API DeleteEnvironmentResult();
    AWS_PROTON_API DeleteEnvironmentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_PROTON_API DeleteEnvironmentResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>The detailed data of the environment being deleted.</p>
     */
    inline DeleteEnvironmentResult& WithEnvironment(const Environment& value) { SetEnvironment(value); return *this;}

    /**
     * <p>The detailed data of the environment being deleted.</p>
     */
    inline DeleteEnvironmentResult& WithEnvironment(Environment&& value) { SetEnvironment(std::move(value)); return *this;}
