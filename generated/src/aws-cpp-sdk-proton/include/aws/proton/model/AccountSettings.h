...
class AccountSettings {
 public:
  ...
  void SetPipelineCodebuildRoleArn(PipelineCodebuildRoleArnT&& value) {
    m_pipelineCodebuildRoleArnHasBeenSet = true;
    m_pipelineCodebuildRoleArn = std::forward<PipelineCodebuildRoleArnT>(value);
  }
  template <typename PipelineCodebuildRoleArnT = Aws::String>
  AccountSettings& WithPipelineCodebuildRoleArn(PipelineCodebuildRoleArnT&& value) {
    SetPipelineCodebuildRoleArn(std::forward<PipelineCodebuildRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPipelineProvisioningRepository(PipelineProvisioningRepositoryT&& value) {
    m_pipelineProvisioningRepositoryHasBeenSet = true;
    m_pipelineProvisioningRepository = std::forward<PipelineProvisioningRepositoryT>(value);
  }
  template <typename PipelineProvisioningRepositoryT = RepositoryBranch>
  AccountSettings& WithPipelineProvisioningRepository(PipelineProvisioningRepositoryT&& value) {
    SetPipelineProvisioningRepository(std::forward<PipelineProvisioningRepositoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPipelineServiceRoleArn(PipelineServiceRoleArnT&& value) {
    m_pipelineServiceRoleArnHasBeenSet = true;
    m_pipelineServiceRoleArn = std::forward<PipelineServiceRoleArnT>(value);
  }
  template <typename PipelineServiceRoleArnT = Aws::String>
  AccountSettings& WithPipelineServiceRoleArn(PipelineServiceRoleArnT&& value) {
    SetPipelineServiceRoleArn(std::forward<PipelineServiceRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
