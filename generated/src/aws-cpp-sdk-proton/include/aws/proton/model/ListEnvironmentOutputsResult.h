...
namespace Model
{
  ...
  public:
    ...
    inline ListEnvironmentOutputsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListEnvironmentOutputsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListEnvironmentOutputsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
