...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API EnvironmentTemplateVersionSummary() = default;
    ...
    template<typename ArnT = Aws::String>
    EnvironmentTemplateVersionSummary& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    EnvironmentTemplateVersionSummary& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    EnvironmentTemplateVersionSummary& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedAtT = Aws::Utils::DateTime>
    EnvironmentTemplateVersionSummary& WithLastModifiedAt(LastModifiedAtT&& value) { SetLastModifiedAt(std::forward<LastModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename MajorVersionT = Aws::String>
    EnvironmentTemplateVersionSummary& WithMajorVersion(MajorVersionT&& value) { SetMajorVersion(std::forward<MajorVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename MinorVersionT = Aws::String>
    EnvironmentTemplateVersionSummary& WithMinorVersion(MinorVersionT&& value) { SetMinorVersion(std::forward<MinorVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename RecommendedMinorVersionT = Aws::String>
    EnvironmentTemplateVersionSummary& WithRecommendedMinorVersion(RecommendedMinorVersionT&& value) { SetRecommendedMinorVersion(std::forward<RecommendedMinorVersionT>(value)); return *this;}
    ///@}
    ...
    inline EnvironmentTemplateVersionSummary& WithStatus(TemplateVersionStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename StatusMessageT = Aws::String>
    EnvironmentTemplateVersionSummary& WithStatusMessage(StatusMessageT&& value) { SetStatusMessage(std::forward<StatusMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename TemplateNameT = Aws::String>
    EnvironmentTemplateVersionSummary& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
  private:
