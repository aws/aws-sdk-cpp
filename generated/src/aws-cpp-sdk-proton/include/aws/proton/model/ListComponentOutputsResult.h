...
namespace Model
{
  ...
  public:
    ...
    inline ListComponentOutputsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListComponentOutputsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListComponentOutputsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
