...
class DeploymentSummary {
 public:
  ...
  inline DeploymentSummary& WithDeploymentStatus(DeploymentStatus value) {
  ...
  inline DeploymentSummary& WithTargetResourceType(DeploymentTargetResourceType value) {
