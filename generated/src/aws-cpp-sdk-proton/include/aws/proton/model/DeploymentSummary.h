...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    DeploymentSummary& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ComponentNameT = Aws::String>
    DeploymentSummary& WithComponentName(ComponentNameT&& value) { SetComponentName(std::forward<ComponentNameT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    DeploymentSummary& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    inline DeploymentSummary& WithDeploymentStatus(DeploymentStatus value) { SetDeploymentStatus(value); return *this;}
    ///@}
    ...
    template<typename EnvironmentNameT = Aws::String>
    DeploymentSummary& WithEnvironmentName(EnvironmentNameT&& value) { SetEnvironmentName(std::forward<EnvironmentNameT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    DeploymentSummary& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastAttemptedDeploymentIdT = Aws::String>
    DeploymentSummary& WithLastAttemptedDeploymentId(LastAttemptedDeploymentIdT&& value) { SetLastAttemptedDeploymentId(std::forward<LastAttemptedDeploymentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedAtT = Aws::Utils::DateTime>
    DeploymentSummary& WithLastModifiedAt(LastModifiedAtT&& value) { SetLastModifiedAt(std::forward<LastModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename LastSucceededDeploymentIdT = Aws::String>
    DeploymentSummary& WithLastSucceededDeploymentId(LastSucceededDeploymentIdT&& value) { SetLastSucceededDeploymentId(std::forward<LastSucceededDeploymentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ServiceInstanceNameT = Aws::String>
    DeploymentSummary& WithServiceInstanceName(ServiceInstanceNameT&& value) { SetServiceInstanceName(std::forward<ServiceInstanceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ServiceNameT = Aws::String>
    DeploymentSummary& WithServiceName(ServiceNameT&& value) { SetServiceName(std::forward<ServiceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetArnT = Aws::String>
    DeploymentSummary& WithTargetArn(TargetArnT&& value) { SetTargetArn(std::forward<TargetArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetResourceCreatedAtT = Aws::Utils::DateTime>
    DeploymentSummary& WithTargetResourceCreatedAt(TargetResourceCreatedAtT&& value) { SetTargetResourceCreatedAt(std::forward<TargetResourceCreatedAtT>(value)); return *this;}
    ///@}
    ...
    inline DeploymentSummary& WithTargetResourceType(DeploymentTargetResourceType value) { SetTargetResourceType(value); return *this;}
    ///@}
  private:
