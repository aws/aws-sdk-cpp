...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API UpdateEnvironmentTemplateResult() = default;
    ...
    template<typename EnvironmentTemplateT = EnvironmentTemplate>
    UpdateEnvironmentTemplateResult& WithEnvironmentTemplate(EnvironmentTemplateT&& value) { SetEnvironmentTemplate(std::forward<EnvironmentTemplateT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateEnvironmentTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
