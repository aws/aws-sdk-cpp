...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API ListServiceInstanceOutputsResult() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListServiceInstanceOutputsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename OutputsT = Aws::Vector<Output>>
    ListServiceInstanceOutputsResult& WithOutputs(OutputsT&& value) { SetOutputs(std::forward<OutputsT>(value)); return *this;}
    template<typename OutputsT = Output>
    ListServiceInstanceOutputsResult& AddOutputs(OutputsT&& value) { m_outputsHasBeenSet = true; m_outputs.emplace_back(std::forward<OutputsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListServiceInstanceOutputsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
