...
namespace Model
{
  ...
  {
  public:
    AWS_PROTON_API RejectEnvironmentAccountConnectionRequest() = default;
    ...
    template<typename IdT = Aws::String>
    RejectEnvironmentAccountConnectionRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
