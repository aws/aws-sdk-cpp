...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public ProtonRequest
  {
  public:
    AWS_PROTON_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the resource to remove customer tags
     * from.</p>
     */
    ...
    ///@{
    /**
     * <p>A list of customer tag keys that indicate the customer tags to be removed
     * from the resource.</p>
     */
