...
namespace Model
{
  ...
  /**
   */
  class DeleteTagsRequest : public MQRequest
  {
  public:
    AWS_MQ_API DeleteTagsRequest() = default;
    ...
    template<typename ResourceArnT = Aws::String>
    DeleteTagsRequest& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
