...
class LdapServerMetadataInput {
 public:
  ...
  void SetRoleBase(RoleBaseT&& value) {
    m_roleBaseHasBeenSet = true;
    m_roleBase = std::forward<RoleBaseT>(value);
  }
  template <typename RoleBaseT = Aws::String>
  LdapServerMetadataInput& WithRoleBase(RoleBaseT&& value) {
    SetRoleBase(std::forward<RoleBaseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRoleSearchMatching(RoleSearchMatchingT&& value) {
    ...
    m_roleSearchMatching = std::forward<RoleSearchMatchingT>(value);
  }
  template <typename RoleSearchMatchingT = Aws::String>
  LdapServerMetadataInput& WithRoleSearchMatching(RoleSearchMatchingT&& value) {
    SetRoleSearchMatching(std::forward<RoleSearchMatchingT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRoleSearchSubtree(bool value) {
    m_roleSearchSubtreeHasBeenSet = true;
    m_roleSearchSubtree = value;
  }
  inline LdapServerMetadataInput& WithRoleSearchSubtree(bool value) {
    SetRoleSearchSubtree(value);
    return *this;
  }
  ///@}
  ...
  void SetServiceAccountPassword(ServiceAccountPasswordT&& value) {
    m_serviceAccountPasswordHasBeenSet = true;
    m_serviceAccountPassword = std::forward<ServiceAccountPasswordT>(value);
  }
  template <typename ServiceAccountPasswordT = Aws::String>
  LdapServerMetadataInput& WithServiceAccountPassword(ServiceAccountPasswordT&& value) {
    SetServiceAccountPassword(std::forward<ServiceAccountPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceAccountUsername(ServiceAccountUsernameT&& value) {
    ...
    m_serviceAccountUsername = std::forward<ServiceAccountUsernameT>(value);
  }
  template <typename ServiceAccountUsernameT = Aws::String>
  LdapServerMetadataInput& WithServiceAccountUsername(ServiceAccountUsernameT&& value) {
    SetServiceAccountUsername(std::forward<ServiceAccountUsernameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserBase(UserBaseT&& value) {
    m_userBaseHasBeenSet = true;
    m_userBase = std::forward<UserBaseT>(value);
  }
  template <typename UserBaseT = Aws::String>
  LdapServerMetadataInput& WithUserBase(UserBaseT&& value) {
    SetUserBase(std::forward<UserBaseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserRoleName(UserRoleNameT&& value) {
    m_userRoleNameHasBeenSet = true;
    m_userRoleName = std::forward<UserRoleNameT>(value);
  }
  template <typename UserRoleNameT = Aws::String>
  LdapServerMetadataInput& WithUserRoleName(UserRoleNameT&& value) {
    SetUserRoleName(std::forward<UserRoleNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserSearchMatching(UserSearchMatchingT&& value) {
    ...
    m_userSearchMatching = std::forward<UserSearchMatchingT>(value);
  }
  template <typename UserSearchMatchingT = Aws::String>
  LdapServerMetadataInput& WithUserSearchMatching(UserSearchMatchingT&& value) {
    SetUserSearchMatching(std::forward<UserSearchMatchingT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUserSearchSubtree(bool value) {
    m_userSearchSubtreeHasBeenSet = true;
    m_userSearchSubtree = value;
  }
  inline LdapServerMetadataInput& WithUserSearchSubtree(bool value) {
    SetUserSearchSubtree(value);
    return *this;
  }
  ///@}
 private:
