...
class UpdateBrokerRequest : public MQRequest {
 public:
  ...
  inline UpdateBrokerRequest& WithAuthenticationStrategy(AuthenticationStrategy value) {
  ...
  inline UpdateBrokerRequest& WithAutoMinorVersionUpgrade(bool value) {
  ...
  void SetHostInstanceType(HostInstanceTypeT&& value) {
    ...
    m_hostInstanceType = std::forward<HostInstanceTypeT>(value);
  }
  template <typename HostInstanceTypeT = Aws::String>
  UpdateBrokerRequest& WithHostInstanceType(HostInstanceTypeT&& value) {
    SetHostInstanceType(std::forward<HostInstanceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLdapServerMetadata(LdapServerMetadataT&& value) {
    ...
    m_ldapServerMetadata = std::forward<LdapServerMetadataT>(value);
  }
  template <typename LdapServerMetadataT = LdapServerMetadataInput>
  UpdateBrokerRequest& WithLdapServerMetadata(LdapServerMetadataT&& value) {
    SetLdapServerMetadata(std::forward<LdapServerMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaintenanceWindowStartTime(MaintenanceWindowStartTimeT&& value) {
    ...
    m_maintenanceWindowStartTime = std::forward<MaintenanceWindowStartTimeT>(value);
  }
  template <typename MaintenanceWindowStartTimeT = WeeklyStartTime>
  UpdateBrokerRequest& WithMaintenanceWindowStartTime(MaintenanceWindowStartTimeT&& value) {
    SetMaintenanceWindowStartTime(std::forward<MaintenanceWindowStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDataReplicationMode(DataReplicationMode value) {
    m_dataReplicationModeHasBeenSet = true;
    m_dataReplicationMode = value;
  }
  inline UpdateBrokerRequest& WithDataReplicationMode(DataReplicationMode value) {
    SetDataReplicationMode(value);
    return *this;
  }
  ///@}
 private:
