...
class BrokerSummary {
 public:
  ...
  inline BrokerSummary& WithBrokerState(BrokerState value) {
  ...
  inline BrokerSummary& WithDeploymentMode(DeploymentMode value) {
  ...
  inline BrokerSummary& WithEngineType(EngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
