...
class CreateBrokerRequest : public MQRequest {
 public:
  ...
  inline CreateBrokerRequest& WithAuthenticationStrategy(AuthenticationStrategy value) {
  ...
  inline CreateBrokerRequest& WithAutoMinorVersionUpgrade(bool value) {
  ...
  void SetBrokerName(BrokerNameT&& value) {
    ...
    m_brokerName = std::forward<BrokerNameT>(value);
  }
  template <typename BrokerNameT = Aws::String>
  CreateBrokerRequest& WithBrokerName(BrokerNameT&& value) {
    SetBrokerName(std::forward<BrokerNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateBrokerRequest& WithDeploymentMode(DeploymentMode value) {
  ...
  void SetEncryptionOptions(EncryptionOptionsT&& value) {
    ...
    m_encryptionOptions = std::forward<EncryptionOptionsT>(value);
  }
  template <typename EncryptionOptionsT = EncryptionOptions>
  CreateBrokerRequest& WithEncryptionOptions(EncryptionOptionsT&& value) {
    SetEncryptionOptions(std::forward<EncryptionOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateBrokerRequest& WithEngineType(EngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateBrokerRequest& WithPubliclyAccessible(bool value) {
  ...
  inline void SetStorageType(BrokerStorageType value) {
    m_storageTypeHasBeenSet = true;
    m_storageType = value;
  }
  inline CreateBrokerRequest& WithStorageType(BrokerStorageType value) {
  ...
  inline CreateBrokerRequest& WithDataReplicationMode(DataReplicationMode value) {
  ...
  void SetDataReplicationPrimaryBrokerArn(DataReplicationPrimaryBrokerArnT&& value) {
    m_dataReplicationPrimaryBrokerArnHasBeenSet = true;
    m_dataReplicationPrimaryBrokerArn = std::forward<DataReplicationPrimaryBrokerArnT>(value);
  }
  template <typename DataReplicationPrimaryBrokerArnT = Aws::String>
  CreateBrokerRequest& WithDataReplicationPrimaryBrokerArn(DataReplicationPrimaryBrokerArnT&& value) {
    SetDataReplicationPrimaryBrokerArn(std::forward<DataReplicationPrimaryBrokerArnT>(value));
    return *this;
  }
  ///@}
 private:
