...
class DescribeConfigurationResult {
 public:
  ...
  inline DescribeConfigurationResult& WithAuthenticationStrategy(AuthenticationStrategy value) {
  ...
  inline DescribeConfigurationResult& WithEngineType(EngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
