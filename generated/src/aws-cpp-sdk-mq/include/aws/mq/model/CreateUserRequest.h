...
namespace Model
{
  ...
  public:
    ...
    template<typename BrokerIdT = Aws::String>
    CreateUserRequest& WithBrokerId(BrokerIdT&& value) { SetBrokerId(std::forward<BrokerIdT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupsT = Aws::Vector<Aws::String>>
    CreateUserRequest& WithGroups(GroupsT&& value) { SetGroups(std::forward<GroupsT>(value)); return *this;}
    template<typename GroupsT = Aws::String>
    CreateUserRequest& AddGroups(GroupsT&& value) { m_groupsHasBeenSet = true; m_groups.emplace_back(std::forward<GroupsT>(value)); return *this; }
    ///@}
