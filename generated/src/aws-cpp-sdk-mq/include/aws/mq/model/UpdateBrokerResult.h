...
class UpdateBrokerResult {
 public:
  ...
  inline UpdateBrokerResult& WithAuthenticationStrategy(AuthenticationStrategy value) {
  ...
  inline UpdateBrokerResult& WithAutoMinorVersionUpgrade(bool value) {
  ...
  inline UpdateBrokerResult& WithDataReplicationMode(DataReplicationMode value) {
  ...
  inline UpdateBrokerResult& WithPendingDataReplicationMode(DataReplicationMode value) {
