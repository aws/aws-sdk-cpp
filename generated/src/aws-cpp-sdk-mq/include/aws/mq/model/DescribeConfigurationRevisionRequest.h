...
class DescribeConfigurationRevisionRequest : public MQRequest {
 public:
  ...
  template <typename ConfigurationIdT = Aws::String>
  DescribeConfigurationRevisionRequest& WithConfigurationId(ConfigurationIdT&& value) {
  ...
  void SetConfigurationRevision(ConfigurationRevisionT&& value) {
    m_configurationRevisionHasBeenSet = true;
    m_configurationRevision = std::forward<ConfigurationRevisionT>(value);
  }
  template <typename ConfigurationRevisionT = Aws::String>
  DescribeConfigurationRevisionRequest& WithConfigurationRevision(ConfigurationRevisionT&& value) {
    SetConfigurationRevision(std::forward<ConfigurationRevisionT>(value));
    return *this;
  }
  ///@}
 private:
