...
/**
 */
class ListBrokersRequest : public MQRequest {
 public:
  AWS_MQ_API ListBrokersRequest() = default;
  ...
  inline ListBrokersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBrokersRequest& WithNextToken(NextTokenT&& value) {
