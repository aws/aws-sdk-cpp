...
class BrokerInstanceOption {
 public:
  ...
  inline BrokerInstanceOption& WithEngineType(EngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
  ...
  inline BrokerInstanceOption& WithStorageType(BrokerStorageType value) {
  ...
  void SetSupportedDeploymentModes(SupportedDeploymentModesT&& value) {
    ...
    m_supportedDeploymentModes = std::forward<SupportedDeploymentModesT>(value);
  }
  template <typename SupportedDeploymentModesT = Aws::Vector<DeploymentMode>>
  BrokerInstanceOption& WithSupportedDeploymentModes(SupportedDeploymentModesT&& value) {
    SetSupportedDeploymentModes(std::forward<SupportedDeploymentModesT>(value));
    return *this;
  }
  inline BrokerInstanceOption& AddSupportedDeploymentModes(DeploymentMode value) {
    m_supportedDeploymentModesHasBeenSet = true;
    m_supportedDeploymentModes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedEngineVersions(SupportedEngineVersionsT&& value) {
    ...
    m_supportedEngineVersions = std::forward<SupportedEngineVersionsT>(value);
  }
  template <typename SupportedEngineVersionsT = Aws::Vector<Aws::String>>
  BrokerInstanceOption& WithSupportedEngineVersions(SupportedEngineVersionsT&& value) {
    SetSupportedEngineVersions(std::forward<SupportedEngineVersionsT>(value));
    return *this;
  }
  ...
  BrokerInstanceOption& AddSupportedEngineVersions(SupportedEngineVersionsT&& value) {
    m_supportedEngineVersionsHasBeenSet = true;
    m_supportedEngineVersions.emplace_back(std::forward<SupportedEngineVersionsT>(value));
    return *this;
  }
  ///@}
 private:
