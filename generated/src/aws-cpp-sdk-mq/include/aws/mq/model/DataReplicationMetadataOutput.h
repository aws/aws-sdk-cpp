...
class DataReplicationMetadataOutput {
 public:
  ...
  void SetDataReplicationCounterpart(DataReplicationCounterpartT&& value) {
    m_dataReplicationCounterpartHasBeenSet = true;
    m_dataReplicationCounterpart = std::forward<DataReplicationCounterpartT>(value);
  }
  template <typename DataReplicationCounterpartT = DataReplicationCounterpart>
  DataReplicationMetadataOutput& WithDataReplicationCounterpart(DataReplicationCounterpartT&& value) {
    SetDataReplicationCounterpart(std::forward<DataReplicationCounterpartT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataReplicationRole(DataReplicationRoleT&& value) {
    m_dataReplicationRoleHasBeenSet = true;
    m_dataReplicationRole = std::forward<DataReplicationRoleT>(value);
  }
  template <typename DataReplicationRoleT = Aws::String>
  DataReplicationMetadataOutput& WithDataReplicationRole(DataReplicationRoleT&& value) {
    SetDataReplicationRole(std::forward<DataReplicationRoleT>(value));
    return *this;
  }
  ///@}
 private:
