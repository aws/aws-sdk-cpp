...
class DescribeBrokerEngineTypesRequest : public MQRequest {
 public:
  ...
  template <typename EngineTypeT = Aws::String>
  DescribeBrokerEngineTypesRequest& WithEngineType(EngineTypeT&& value) {
  ...
  inline DescribeBrokerEngineTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeBrokerEngineTypesRequest& WithNextToken(NextTokenT&& value) {
