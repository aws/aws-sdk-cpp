...
class BrokerEngineType {
 public:
  ...
  inline BrokerEngineType& WithEngineType(EngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
  ...
  template <typename EngineVersionsT = Aws::Vector<EngineVersion>>
  BrokerEngineType& WithEngineVersions(EngineVersionsT&& value) {
    SetEngineVersions(std::forward<EngineVersionsT>(value));
    return *this;
  }
  template <typename EngineVersionsT = EngineVersion>
  BrokerEngineType& AddEngineVersions(EngineVersionsT&& value) {
    m_engineVersionsHasBeenSet = true;
