...
class ActionRequired {
 public:
  ...
  void SetActionRequiredCode(ActionRequiredCodeT&& value) {
    m_actionRequiredCodeHasBeenSet = true;
    m_actionRequiredCode = std::forward<ActionRequiredCodeT>(value);
  }
  template <typename ActionRequiredCodeT = Aws::String>
  ActionRequired& WithActionRequiredCode(ActionRequiredCodeT&& value) {
    SetActionRequiredCode(std::forward<ActionRequiredCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActionRequiredInfo(ActionRequiredInfoT&& value) {
    m_actionRequiredInfoHasBeenSet = true;
    m_actionRequiredInfo = std::forward<ActionRequiredInfoT>(value);
  }
  template <typename ActionRequiredInfoT = Aws::String>
  ActionRequired& WithActionRequiredInfo(ActionRequiredInfoT&& value) {
    SetActionRequiredInfo(std::forward<ActionRequiredInfoT>(value));
    return *this;
  }
  ///@}
 private:
