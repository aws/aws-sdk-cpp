...
class DescribeBrokerResult {
 public:
  ...
  inline DescribeBrokerResult& WithAuthenticationStrategy(AuthenticationStrategy value) {
  ...
  inline DescribeBrokerResult& WithAutoMinorVersionUpgrade(bool value) {
  ...
  inline void SetBrokerState(BrokerState value) {
    m_brokerStateHasBeenSet = true;
    m_brokerState = value;
  }
  inline DescribeBrokerResult& WithBrokerState(BrokerState value) {
  ...
  inline DescribeBrokerResult& WithDeploymentMode(DeploymentMode value) {
  ...
  inline DescribeBrokerResult& WithEngineType(EngineType value) {
    SetEngineType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPendingAuthenticationStrategy(AuthenticationStrategy value) {
    m_pendingAuthenticationStrategyHasBeenSet = true;
    m_pendingAuthenticationStrategy = value;
  }
  inline DescribeBrokerResult& WithPendingAuthenticationStrategy(AuthenticationStrategy value) {
    SetPendingAuthenticationStrategy(value);
    return *this;
  }
  ///@}
  ...
  void SetPendingEngineVersion(PendingEngineVersionT&& value) {
    ...
    m_pendingEngineVersion = std::forward<PendingEngineVersionT>(value);
  }
  template <typename PendingEngineVersionT = Aws::String>
  DescribeBrokerResult& WithPendingEngineVersion(PendingEngineVersionT&& value) {
    SetPendingEngineVersion(std::forward<PendingEngineVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPendingHostInstanceType(PendingHostInstanceTypeT&& value) {
    ...
    m_pendingHostInstanceType = std::forward<PendingHostInstanceTypeT>(value);
  }
  template <typename PendingHostInstanceTypeT = Aws::String>
  DescribeBrokerResult& WithPendingHostInstanceType(PendingHostInstanceTypeT&& value) {
    SetPendingHostInstanceType(std::forward<PendingHostInstanceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPendingLdapServerMetadata(PendingLdapServerMetadataT&& value) {
    ...
    m_pendingLdapServerMetadata = std::forward<PendingLdapServerMetadataT>(value);
  }
  template <typename PendingLdapServerMetadataT = LdapServerMetadataOutput>
  DescribeBrokerResult& WithPendingLdapServerMetadata(PendingLdapServerMetadataT&& value) {
    SetPendingLdapServerMetadata(std::forward<PendingLdapServerMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPendingSecurityGroups(PendingSecurityGroupsT&& value) {
    ...
    m_pendingSecurityGroups = std::forward<PendingSecurityGroupsT>(value);
  }
  template <typename PendingSecurityGroupsT = Aws::Vector<Aws::String>>
  DescribeBrokerResult& WithPendingSecurityGroups(PendingSecurityGroupsT&& value) {
    SetPendingSecurityGroups(std::forward<PendingSecurityGroupsT>(value));
    return *this;
  }
  ...
  DescribeBrokerResult& AddPendingSecurityGroups(PendingSecurityGroupsT&& value) {
    m_pendingSecurityGroupsHasBeenSet = true;
    m_pendingSecurityGroups.emplace_back(std::forward<PendingSecurityGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeBrokerResult& WithPubliclyAccessible(bool value) {
  ...
  inline DescribeBrokerResult& WithStorageType(BrokerStorageType value) {
  ...
  void SetDataReplicationMetadata(DataReplicationMetadataT&& value) {
    ...
    m_dataReplicationMetadata = std::forward<DataReplicationMetadataT>(value);
  }
  template <typename DataReplicationMetadataT = DataReplicationMetadataOutput>
  DescribeBrokerResult& WithDataReplicationMetadata(DataReplicationMetadataT&& value) {
    SetDataReplicationMetadata(std::forward<DataReplicationMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeBrokerResult& WithDataReplicationMode(DataReplicationMode value) {
  ...
  void SetPendingDataReplicationMetadata(PendingDataReplicationMetadataT&& value) {
    ...
    m_pendingDataReplicationMetadata = std::forward<PendingDataReplicationMetadataT>(value);
  }
  template <typename PendingDataReplicationMetadataT = DataReplicationMetadataOutput>
  DescribeBrokerResult& WithPendingDataReplicationMetadata(PendingDataReplicationMetadataT&& value) {
    SetPendingDataReplicationMetadata(std::forward<PendingDataReplicationMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPendingDataReplicationMode(DataReplicationMode value) {
    m_pendingDataReplicationModeHasBeenSet = true;
    m_pendingDataReplicationMode = value;
  }
  inline DescribeBrokerResult& WithPendingDataReplicationMode(DataReplicationMode value) {
    SetPendingDataReplicationMode(value);
    return *this;
  }
  ///@}
