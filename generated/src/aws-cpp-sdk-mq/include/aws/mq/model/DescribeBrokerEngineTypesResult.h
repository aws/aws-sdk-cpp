...
class DescribeBrokerEngineTypesResult {
 public:
  ...
  void SetBrokerEngineTypes(BrokerEngineTypesT&& value) {
    m_brokerEngineTypesHasBeenSet = true;
    m_brokerEngineTypes = std::forward<BrokerEngineTypesT>(value);
  }
  template <typename BrokerEngineTypesT = Aws::Vector<BrokerEngineType>>
  DescribeBrokerEngineTypesResult& WithBrokerEngineTypes(BrokerEngineTypesT&& value) {
    SetBrokerEngineTypes(std::forward<BrokerEngineTypesT>(value));
    return *this;
  }
  template <typename BrokerEngineTypesT = BrokerEngineType>
  DescribeBrokerEngineTypesResult& AddBrokerEngineTypes(BrokerEngineTypesT&& value) {
    m_brokerEngineTypesHasBeenSet = true;
    m_brokerEngineTypes.emplace_back(std::forward<BrokerEngineTypesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeBrokerEngineTypesResult& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeBrokerEngineTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBrokerEngineTypesResult& WithRequestId(RequestIdT&& value) {
