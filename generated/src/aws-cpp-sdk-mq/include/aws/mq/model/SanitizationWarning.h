...
class SanitizationWarning {
 public:
  ...
  template <typename AttributeNameT = Aws::String>
  SanitizationWarning& WithAttributeName(AttributeNameT&& value) {
  ...
  void SetElementName(ElementNameT&& value) {
    m_elementNameHasBeenSet = true;
    m_elementName = std::forward<ElementNameT>(value);
  }
  template <typename ElementNameT = Aws::String>
  SanitizationWarning& WithElementName(ElementNameT&& value) {
    SetElementName(std::forward<ElementNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReason(SanitizationWarningReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline SanitizationWarning& WithReason(SanitizationWarningReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
