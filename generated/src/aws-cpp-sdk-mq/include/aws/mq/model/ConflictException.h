...
class ConflictException {
 public:
  AWS_MQ_API ConflictException() = default;
  AWS_MQ_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
  AWS_MQ_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ErrorAttributeT = Aws::String>
  ConflictException& WithErrorAttribute(ErrorAttributeT&& value) {
  ...
  template <typename ResourceShareErrorsT = Aws::Vector<ResourceShareError>>
  ConflictException& WithResourceShareErrors(ResourceShareErrorsT&& value) {
    SetResourceShareErrors(std::forward<ResourceShareErrorsT>(value));
    return *this;
  }
  template <typename ResourceShareErrorsT = ResourceShareError>
  ConflictException& AddResourceShareErrors(ResourceShareErrorsT&& value) {
    m_resourceShareErrorsHasBeenSet = true;
