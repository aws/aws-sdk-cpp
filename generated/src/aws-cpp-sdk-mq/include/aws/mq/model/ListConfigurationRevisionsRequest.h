...
class ListConfigurationRevisionsRequest : public MQRequest {
 public:
  ...
  template <typename ConfigurationIdT = Aws::String>
  ListConfigurationRevisionsRequest& WithConfigurationId(ConfigurationIdT&& value) {
  ...
  inline ListConfigurationRevisionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationRevisionsRequest& WithNextToken(NextTokenT&& value) {
