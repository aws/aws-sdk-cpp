...
namespace Model
{
  ...
  /**
   */
  class DescribeBrokerRequest : public MQRequest
  {
  public:
    AWS_MQ_API DescribeBrokerRequest() = default;
    ...
    template<typename BrokerIdT = Aws::String>
    DescribeBrokerRequest& WithBrokerId(BrokerIdT&& value) { SetBrokerId(std::forward<BrokerIdT>(value)); return *this;}
    ///@}
  private:
