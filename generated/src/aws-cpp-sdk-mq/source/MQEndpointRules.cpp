...
namespace MQ
{
const size_t MQEndpointRules::RulesBlobStrLen = 3438;
const size_t MQEndpointRules::RulesBlobSize = 3439;
...
const char* MQEndpointRules::GetRulesBlob()
{
