...
LdapServerMetadataInput::LdapServerMetadataInput(JsonView jsonValue) { *this = jsonValue; }

LdapServerMetadataInput& LdapServerMetadataInput::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("serviceAccountPassword")) {
    m_serviceAccountPassword = jsonValue.GetString("serviceAccountPassword");
...
JsonValue LdapServerMetadataInput::Jsonize() const {
  JsonValue payload;
  ...
  if (m_serviceAccountPasswordHasBeenSet) {
    payload.WithString("serviceAccountPassword", m_serviceAccountPassword);
  }
