...
namespace Mobile
{
const size_t MobileEndpointRules::RulesBlobStrLen = 3472;
const size_t MobileEndpointRules::RulesBlobSize = 3473;
...
'l','"',':','"','h','t','t','p','s',':','/','/','m','o','b','i','l','e','-','f','i','p','s','.','{',
...
't','p','s',':','/','/','m','o','b','i','l','e','.','{','R','e','g','i','o','n','}','.','{','P','a',
