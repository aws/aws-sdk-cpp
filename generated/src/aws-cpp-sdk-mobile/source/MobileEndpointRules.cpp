...
namespace Mobile
{
const size_t MobileEndpointRules::RulesBlobStrLen = 3412;
const size_t MobileEndpointRules::RulesBlobSize = 3413;

using RulesBlobT = Aws::Array<const char, MobileEndpointRules::RulesBlobSize>;
...
':','"','h','t','t','p','s',':','/','/','m','o','b','i','l','e','-','f','i','p','s','.','{','R','e',
...
's',':','/','/','m','o','b','i','l','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','o','b','i','l','e','.','{','R','e',
'g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','#','d','n',
's','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','}',
',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e','"',':','"','e','n',
'd','p','o','i','n','t','"','}',']','}',']','}','\0'
...
const char* MobileEndpointRules::GetRulesBlob()
{
