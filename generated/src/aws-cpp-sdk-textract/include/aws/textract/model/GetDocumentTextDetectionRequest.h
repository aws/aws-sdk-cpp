...
namespace Model
{
  ...
  /**
   */
  class GetDocumentTextDetectionRequest : public TextractRequest
  {
  public:
    AWS_TEXTRACT_API GetDocumentTextDetectionRequest();

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "GetDocumentTextDetection"; }
     ...
     * of 1,000 results is returned. The default value is 1,000.</p>
     */
    inline GetDocumentTextDetectionRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
     ...
     * use this pagination token to retrieve the next set of blocks.</p>
     */
    inline GetDocumentTextDetectionRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
     ...
     * use this pagination token to retrieve the next set of blocks.</p>
     */
    inline GetDocumentTextDetectionRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
     ...
     * use this pagination token to retrieve the next set of blocks.</p>
     */
    inline GetDocumentTextDetectionRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
