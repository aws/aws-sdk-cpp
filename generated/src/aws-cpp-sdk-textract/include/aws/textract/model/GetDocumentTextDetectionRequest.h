...
class GetDocumentTextDetectionRequest : public TextractRequest {
 public:
  ...
  template <typename JobIdT = Aws::String>
  GetDocumentTextDetectionRequest& WithJobId(JobIdT&& value) {
  ...
  inline GetDocumentTextDetectionRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetDocumentTextDetectionRequest& WithNextToken(NextTokenT&& value) {
