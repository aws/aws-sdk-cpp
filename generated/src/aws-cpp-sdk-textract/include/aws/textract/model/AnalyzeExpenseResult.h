...
class AnalyzeExpenseResult {
 public:
  ...
  template <typename DocumentMetadataT = DocumentMetadata>
  AnalyzeExpenseResult& WithDocumentMetadata(DocumentMetadataT&& value) {
  ...
  template <typename ExpenseDocumentsT = Aws::Vector<ExpenseDocument>>
  AnalyzeExpenseResult& WithExpenseDocuments(ExpenseDocumentsT&& value) {
    SetExpenseDocuments(std::forward<ExpenseDocumentsT>(value));
    return *this;
  }
  template <typename ExpenseDocumentsT = ExpenseDocument>
  AnalyzeExpenseResult& AddExpenseDocuments(ExpenseDocumentsT&& value) {
    m_expenseDocumentsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AnalyzeExpenseResult& WithRequestId(RequestIdT&& value) {
