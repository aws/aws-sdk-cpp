...
class CreateAdapterVersionResult {
 public:
  ...
  template <typename AdapterIdT = Aws::String>
  CreateAdapterVersionResult& WithAdapterId(AdapterIdT&& value) {
  ...
  template <typename AdapterVersionT = Aws::String>
  CreateAdapterVersionResult& WithAdapterVersion(AdapterVersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAdapterVersionResult& WithRequestId(RequestIdT&& value) {
