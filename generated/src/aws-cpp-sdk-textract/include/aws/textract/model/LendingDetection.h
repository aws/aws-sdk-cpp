...
class LendingDetection {
 public:
  ...
  inline void SetSelectionStatus(SelectionStatus value) {
    m_selectionStatusHasBeenSet = true;
    m_selectionStatus = value;
  }
  inline LendingDetection& WithSelectionStatus(SelectionStatus value) {
    SetSelectionStatus(value);
    return *this;
  }
  ///@}
  ...
  inline LendingDetection& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
