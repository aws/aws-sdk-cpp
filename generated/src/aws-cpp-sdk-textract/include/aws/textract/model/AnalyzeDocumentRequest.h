...
class AnalyzeDocumentRequest : public TextractRequest {
 public:
  ...
  inline AnalyzeDocumentRequest& AddFeatureTypes(FeatureType value) {
    m_featureTypesHasBeenSet = true;
  ...
  void SetQueriesConfig(QueriesConfigT&& value) {
    m_queriesConfigHasBeenSet = true;
    m_queriesConfig = std::forward<QueriesConfigT>(value);
  }
  template <typename QueriesConfigT = QueriesConfig>
  AnalyzeDocumentRequest& WithQueriesConfig(QueriesConfigT&& value) {
    SetQueriesConfig(std::forward<QueriesConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdaptersConfig(AdaptersConfigT&& value) {
    m_adaptersConfigHasBeenSet = true;
    m_adaptersConfig = std::forward<AdaptersConfigT>(value);
  }
  template <typename AdaptersConfigT = AdaptersConfig>
  AnalyzeDocumentRequest& WithAdaptersConfig(AdaptersConfigT&& value) {
    SetAdaptersConfig(std::forward<AdaptersConfigT>(value));
    return *this;
  }
  ///@}
 private:
