...
class IdentityDocument {
 public:
  ...
  inline void SetDocumentIndex(int value) {
    m_documentIndexHasBeenSet = true;
    m_documentIndex = value;
  }
  inline IdentityDocument& WithDocumentIndex(int value) {
  ...
  void SetIdentityDocumentFields(IdentityDocumentFieldsT&& value) {
    ...
    m_identityDocumentFields = std::forward<IdentityDocumentFieldsT>(value);
  }
  template <typename IdentityDocumentFieldsT = Aws::Vector<IdentityDocumentField>>
  IdentityDocument& WithIdentityDocumentFields(IdentityDocumentFieldsT&& value) {
    SetIdentityDocumentFields(std::forward<IdentityDocumentFieldsT>(value));
    return *this;
  }
  ...
  IdentityDocument& AddIdentityDocumentFields(IdentityDocumentFieldsT&& value) {
    m_identityDocumentFieldsHasBeenSet = true;
    m_identityDocumentFields.emplace_back(std::forward<IdentityDocumentFieldsT>(value));
    return *this;
  }
  ///@}
