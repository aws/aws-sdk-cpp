...
class BoundingBox {
 public:
  ...
  inline BoundingBox& WithWidth(double value) {
    SetWidth(value);
    return *this;
  }
  ///@}
  ...
  inline BoundingBox& WithHeight(double value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline BoundingBox& WithLeft(double value) {
    SetLeft(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTop(double value) {
    m_topHasBeenSet = true;
    m_top = value;
  }
  inline BoundingBox& WithTop(double value) {
    SetTop(value);
    return *this;
  }
  ///@}
