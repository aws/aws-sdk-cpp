...
class LendingDocument {
 public:
  ...
  void SetLendingFields(LendingFieldsT&& value) {
    ...
    m_lendingFields = std::forward<LendingFieldsT>(value);
  }
  template <typename LendingFieldsT = Aws::Vector<LendingField>>
  LendingDocument& WithLendingFields(LendingFieldsT&& value) {
    SetLendingFields(std::forward<LendingFieldsT>(value));
    return *this;
  }
  template <typename LendingFieldsT = LendingField>
  LendingDocument& AddLendingFields(LendingFieldsT&& value) {
    m_lendingFieldsHasBeenSet = true;
    m_lendingFields.emplace_back(std::forward<LendingFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSignatureDetections(SignatureDetectionsT&& value) {
    ...
    m_signatureDetections = std::forward<SignatureDetectionsT>(value);
  }
  template <typename SignatureDetectionsT = Aws::Vector<SignatureDetection>>
  LendingDocument& WithSignatureDetections(SignatureDetectionsT&& value) {
    SetSignatureDetections(std::forward<SignatureDetectionsT>(value));
    return *this;
  }
  ...
  LendingDocument& AddSignatureDetections(SignatureDetectionsT&& value) {
    m_signatureDetectionsHasBeenSet = true;
    m_signatureDetections.emplace_back(std::forward<SignatureDetectionsT>(value));
    return *this;
  }
  ///@}
 private:
