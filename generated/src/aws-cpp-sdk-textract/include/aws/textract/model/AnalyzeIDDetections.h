...
class AnalyzeIDDetections {
 public:
  ...
  void SetNormalizedValue(NormalizedValueT&& value) {
    ...
    m_normalizedValue = std::forward<NormalizedValueT>(value);
  }
  template <typename NormalizedValueT = NormalizedValue>
  AnalyzeIDDetections& WithNormalizedValue(NormalizedValueT&& value) {
    SetNormalizedValue(std::forward<NormalizedValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline AnalyzeIDDetections& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
