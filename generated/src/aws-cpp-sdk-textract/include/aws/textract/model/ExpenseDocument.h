...
class ExpenseDocument {
 public:
  ...
  inline void SetExpenseIndex(int value) {
    m_expenseIndexHasBeenSet = true;
    m_expenseIndex = value;
  }
  inline ExpenseDocument& WithExpenseIndex(int value) {
    SetExpenseIndex(value);
    return *this;
  }
  ///@}
  ...
  void SetSummaryFields(SummaryFieldsT&& value) {
    ...
    m_summaryFields = std::forward<SummaryFieldsT>(value);
  }
  template <typename SummaryFieldsT = Aws::Vector<ExpenseField>>
  ExpenseDocument& WithSummaryFields(SummaryFieldsT&& value) {
    SetSummaryFields(std::forward<SummaryFieldsT>(value));
    return *this;
  }
  template <typename SummaryFieldsT = ExpenseField>
  ExpenseDocument& AddSummaryFields(SummaryFieldsT&& value) {
    m_summaryFieldsHasBeenSet = true;
    m_summaryFields.emplace_back(std::forward<SummaryFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLineItemGroups(LineItemGroupsT&& value) {
    ...
    m_lineItemGroups = std::forward<LineItemGroupsT>(value);
  }
  template <typename LineItemGroupsT = Aws::Vector<LineItemGroup>>
  ExpenseDocument& WithLineItemGroups(LineItemGroupsT&& value) {
    SetLineItemGroups(std::forward<LineItemGroupsT>(value));
    return *this;
  }
  template <typename LineItemGroupsT = LineItemGroup>
  ExpenseDocument& AddLineItemGroups(LineItemGroupsT&& value) {
    m_lineItemGroupsHasBeenSet = true;
    m_lineItemGroups.emplace_back(std::forward<LineItemGroupsT>(value));
    return *this;
  }
  ///@}
