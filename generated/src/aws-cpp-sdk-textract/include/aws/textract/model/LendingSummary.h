...
class LendingSummary {
 public:
  ...
  void SetDocumentGroups(DocumentGroupsT&& value) {
    ...
    m_documentGroups = std::forward<DocumentGroupsT>(value);
  }
  template <typename DocumentGroupsT = Aws::Vector<DocumentGroup>>
  LendingSummary& WithDocumentGroups(DocumentGroupsT&& value) {
    SetDocumentGroups(std::forward<DocumentGroupsT>(value));
    return *this;
  }
  template <typename DocumentGroupsT = DocumentGroup>
  LendingSummary& AddDocumentGroups(DocumentGroupsT&& value) {
    m_documentGroupsHasBeenSet = true;
    m_documentGroups.emplace_back(std::forward<DocumentGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUndetectedDocumentTypes(UndetectedDocumentTypesT&& value) {
    ...
    m_undetectedDocumentTypes = std::forward<UndetectedDocumentTypesT>(value);
  }
  template <typename UndetectedDocumentTypesT = Aws::Vector<Aws::String>>
  LendingSummary& WithUndetectedDocumentTypes(UndetectedDocumentTypesT&& value) {
    SetUndetectedDocumentTypes(std::forward<UndetectedDocumentTypesT>(value));
    return *this;
  }
  ...
  LendingSummary& AddUndetectedDocumentTypes(UndetectedDocumentTypesT&& value) {
    m_undetectedDocumentTypesHasBeenSet = true;
    m_undetectedDocumentTypes.emplace_back(std::forward<UndetectedDocumentTypesT>(value));
    return *this;
  }
  ///@}
 private:
