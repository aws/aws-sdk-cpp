...
class HumanLoopActivationOutput {
 public:
  ...
  void SetHumanLoopActivationReasons(HumanLoopActivationReasonsT&& value) {
    ...
    m_humanLoopActivationReasons = std::forward<HumanLoopActivationReasonsT>(value);
  }
  template <typename HumanLoopActivationReasonsT = Aws::Vector<Aws::String>>
  HumanLoopActivationOutput& WithHumanLoopActivationReasons(HumanLoopActivationReasonsT&& value) {
    SetHumanLoopActivationReasons(std::forward<HumanLoopActivationReasonsT>(value));
    return *this;
  }
  ...
  HumanLoopActivationOutput& AddHumanLoopActivationReasons(HumanLoopActivationReasonsT&& value) {
    m_humanLoopActivationReasonsHasBeenSet = true;
    m_humanLoopActivationReasons.emplace_back(std::forward<HumanLoopActivationReasonsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::String& GetHumanLoopActivationConditionsEvaluationResults() const {
    return m_humanLoopActivationConditionsEvaluationResults;
  }
  inline bool HumanLoopActivationConditionsEvaluationResultsHasBeenSet() const {
    return m_humanLoopActivationConditionsEvaluationResultsHasBeenSet;
  }
  ...
  void SetHumanLoopActivationConditionsEvaluationResults(HumanLoopActivationConditionsEvaluationResultsT&& value) {
    ...
    m_humanLoopActivationConditionsEvaluationResults = std::forward<HumanLoopActivationConditionsEvaluationResultsT>(value);
  }
  template <typename HumanLoopActivationConditionsEvaluationResultsT = Aws::String>
  HumanLoopActivationOutput& WithHumanLoopActivationConditionsEvaluationResults(HumanLoopActivationConditionsEvaluationResultsT&& value) {
    SetHumanLoopActivationConditionsEvaluationResults(std::forward<HumanLoopActivationConditionsEvaluationResultsT>(value));
    return *this;
  }
  ///@}
 private:
