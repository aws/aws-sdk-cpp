...
class ListAdaptersResult {
 public:
  ...
  void SetAdapters(AdaptersT&& value) {
    ...
    m_adapters = std::forward<AdaptersT>(value);
  }
  template <typename AdaptersT = Aws::Vector<AdapterOverview>>
  ListAdaptersResult& WithAdapters(AdaptersT&& value) {
    SetAdapters(std::forward<AdaptersT>(value));
    return *this;
  }
  template <typename AdaptersT = AdapterOverview>
  ListAdaptersResult& AddAdapters(AdaptersT&& value) {
    m_adaptersHasBeenSet = true;
    m_adapters.emplace_back(std::forward<AdaptersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAdaptersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAdaptersResult& WithRequestId(RequestIdT&& value) {
