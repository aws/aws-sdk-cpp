...
namespace Model
{
  ...
  {
  public:
    AWS_TEXTRACT_API DeleteAdapterRequest() = default;
    ...
    template<typename AdapterIdT = Aws::String>
    DeleteAdapterRequest& WithAdapterId(AdapterIdT&& value) { SetAdapterId(std::forward<AdapterIdT>(value)); return *this;}
    ///@}
  private:
