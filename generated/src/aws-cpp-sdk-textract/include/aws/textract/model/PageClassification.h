...
class PageClassification {
 public:
  ...
  void SetPageType(PageTypeT&& value) {
    m_pageTypeHasBeenSet = true;
    m_pageType = std::forward<PageTypeT>(value);
  }
  template <typename PageTypeT = Aws::Vector<Prediction>>
  PageClassification& WithPageType(PageTypeT&& value) {
    SetPageType(std::forward<PageTypeT>(value));
    return *this;
  }
  template <typename PageTypeT = Prediction>
  PageClassification& AddPageType(PageTypeT&& value) {
    m_pageTypeHasBeenSet = true;
    m_pageType.emplace_back(std::forward<PageTypeT>(value));
    return *this;
  }
  ///@}
