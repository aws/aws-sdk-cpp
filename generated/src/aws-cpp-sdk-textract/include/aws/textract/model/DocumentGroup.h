...
class DocumentGroup {
 public:
  ...
  void SetSplitDocuments(SplitDocumentsT&& value) {
    ...
    m_splitDocuments = std::forward<SplitDocumentsT>(value);
  }
  template <typename SplitDocumentsT = Aws::Vector<SplitDocument>>
  DocumentGroup& WithSplitDocuments(SplitDocumentsT&& value) {
    SetSplitDocuments(std::forward<SplitDocumentsT>(value));
    return *this;
  }
  template <typename SplitDocumentsT = SplitDocument>
  DocumentGroup& AddSplitDocuments(SplitDocumentsT&& value) {
    m_splitDocumentsHasBeenSet = true;
    m_splitDocuments.emplace_back(std::forward<SplitDocumentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDetectedSignatures(DetectedSignaturesT&& value) {
    ...
    m_detectedSignatures = std::forward<DetectedSignaturesT>(value);
  }
  template <typename DetectedSignaturesT = Aws::Vector<DetectedSignature>>
  DocumentGroup& WithDetectedSignatures(DetectedSignaturesT&& value) {
    SetDetectedSignatures(std::forward<DetectedSignaturesT>(value));
    return *this;
  }
  template <typename DetectedSignaturesT = DetectedSignature>
  DocumentGroup& AddDetectedSignatures(DetectedSignaturesT&& value) {
    m_detectedSignaturesHasBeenSet = true;
    m_detectedSignatures.emplace_back(std::forward<DetectedSignaturesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUndetectedSignatures(UndetectedSignaturesT&& value) {
    ...
    m_undetectedSignatures = std::forward<UndetectedSignaturesT>(value);
  }
  template <typename UndetectedSignaturesT = Aws::Vector<UndetectedSignature>>
  DocumentGroup& WithUndetectedSignatures(UndetectedSignaturesT&& value) {
    SetUndetectedSignatures(std::forward<UndetectedSignaturesT>(value));
    return *this;
  }
  ...
  DocumentGroup& AddUndetectedSignatures(UndetectedSignaturesT&& value) {
    m_undetectedSignaturesHasBeenSet = true;
    m_undetectedSignatures.emplace_back(std::forward<UndetectedSignaturesT>(value));
    return *this;
  }
  ///@}
 private:
