...
class LineItemGroup {
 public:
  ...
  inline void SetLineItemGroupIndex(int value) {
    m_lineItemGroupIndexHasBeenSet = true;
    m_lineItemGroupIndex = value;
  }
  inline LineItemGroup& WithLineItemGroupIndex(int value) {
    SetLineItemGroupIndex(value);
    return *this;
  }
  ///@}
  ...
  template <typename LineItemsT = Aws::Vector<LineItemFields>>
  LineItemGroup& WithLineItems(LineItemsT&& value) {
    SetLineItems(std::forward<LineItemsT>(value));
    return *this;
  }
  template <typename LineItemsT = LineItemFields>
  LineItemGroup& AddLineItems(LineItemsT&& value) {
    m_lineItemsHasBeenSet = true;
