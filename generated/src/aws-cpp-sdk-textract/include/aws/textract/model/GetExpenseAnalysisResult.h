...
class GetExpenseAnalysisResult {
 public:
  ...
  template <typename DocumentMetadataT = DocumentMetadata>
  GetExpenseAnalysisResult& WithDocumentMetadata(DocumentMetadataT&& value) {
  ...
  inline GetExpenseAnalysisResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetExpenseAnalysisResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetExpenseDocuments(ExpenseDocumentsT&& value) {
    m_expenseDocumentsHasBeenSet = true;
    m_expenseDocuments = std::forward<ExpenseDocumentsT>(value);
  }
  template <typename ExpenseDocumentsT = Aws::Vector<ExpenseDocument>>
  GetExpenseAnalysisResult& WithExpenseDocuments(ExpenseDocumentsT&& value) {
    SetExpenseDocuments(std::forward<ExpenseDocumentsT>(value));
    return *this;
  }
  template <typename ExpenseDocumentsT = ExpenseDocument>
  GetExpenseAnalysisResult& AddExpenseDocuments(ExpenseDocumentsT&& value) {
    m_expenseDocumentsHasBeenSet = true;
    m_expenseDocuments.emplace_back(std::forward<ExpenseDocumentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WarningsT = Aws::Vector<Warning>>
  GetExpenseAnalysisResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = Warning>
  GetExpenseAnalysisResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
  ...
  template <typename StatusMessageT = Aws::String>
  GetExpenseAnalysisResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  void SetAnalyzeExpenseModelVersion(AnalyzeExpenseModelVersionT&& value) {
    m_analyzeExpenseModelVersionHasBeenSet = true;
    m_analyzeExpenseModelVersion = std::forward<AnalyzeExpenseModelVersionT>(value);
  }
  template <typename AnalyzeExpenseModelVersionT = Aws::String>
  GetExpenseAnalysisResult& WithAnalyzeExpenseModelVersion(AnalyzeExpenseModelVersionT&& value) {
    SetAnalyzeExpenseModelVersion(std::forward<AnalyzeExpenseModelVersionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetExpenseAnalysisResult& WithRequestId(RequestIdT&& value) {
