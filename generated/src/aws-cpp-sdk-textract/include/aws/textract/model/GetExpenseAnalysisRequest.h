...
class GetExpenseAnalysisRequest : public TextractRequest {
 public:
  ...
  template <typename JobIdT = Aws::String>
  GetExpenseAnalysisRequest& WithJobId(JobIdT&& value) {
  ...
  inline GetExpenseAnalysisRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetExpenseAnalysisRequest& WithNextToken(NextTokenT&& value) {
