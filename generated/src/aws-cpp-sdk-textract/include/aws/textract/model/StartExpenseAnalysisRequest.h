...
class StartExpenseAnalysisRequest : public TextractRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "StartExpenseAnalysis"; }
  ...
  void SetDocumentLocation(DocumentLocationT&& value) {
    m_documentLocationHasBeenSet = true;
    m_documentLocation = std::forward<DocumentLocationT>(value);
  }
  template <typename DocumentLocationT = DocumentLocation>
  StartExpenseAnalysisRequest& WithDocumentLocation(DocumentLocationT&& value) {
    SetDocumentLocation(std::forward<DocumentLocationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartExpenseAnalysisRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename JobTagT = Aws::String>
  StartExpenseAnalysisRequest& WithJobTag(JobTagT&& value) {
  ...
  template <typename NotificationChannelT = NotificationChannel>
  StartExpenseAnalysisRequest& WithNotificationChannel(NotificationChannelT&& value) {
  ...
  template <typename OutputConfigT = OutputConfig>
  StartExpenseAnalysisRequest& WithOutputConfig(OutputConfigT&& value) {
  ...
  template <typename KMSKeyIdT = Aws::String>
  StartExpenseAnalysisRequest& WithKMSKeyId(KMSKeyIdT&& value) {
