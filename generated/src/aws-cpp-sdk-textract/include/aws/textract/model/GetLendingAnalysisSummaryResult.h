...
class GetLendingAnalysisSummaryResult {
 public:
  ...
  template <typename DocumentMetadataT = DocumentMetadata>
  GetLendingAnalysisSummaryResult& WithDocumentMetadata(DocumentMetadataT&& value) {
  ...
  inline GetLendingAnalysisSummaryResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SummaryT = LendingSummary>
  GetLendingAnalysisSummaryResult& WithSummary(SummaryT&& value) {
  ...
  template <typename WarningsT = Aws::Vector<Warning>>
  GetLendingAnalysisSummaryResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = Warning>
  GetLendingAnalysisSummaryResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
  ...
  template <typename StatusMessageT = Aws::String>
  GetLendingAnalysisSummaryResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename AnalyzeLendingModelVersionT = Aws::String>
  GetLendingAnalysisSummaryResult& WithAnalyzeLendingModelVersion(AnalyzeLendingModelVersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetLendingAnalysisSummaryResult& WithRequestId(RequestIdT&& value) {
