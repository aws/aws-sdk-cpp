...
class GetDocumentAnalysisRequest : public TextractRequest {
 public:
  ...
  template <typename JobIdT = Aws::String>
  GetDocumentAnalysisRequest& WithJobId(JobIdT&& value) {
  ...
  inline GetDocumentAnalysisRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetDocumentAnalysisRequest& WithNextToken(NextTokenT&& value) {
