...
class GetAdapterVersionResult {
 public:
  ...
  inline GetAdapterVersionResult& AddFeatureTypes(FeatureType value) {
    m_featureTypesHasBeenSet = true;
  ...
  inline GetAdapterVersionResult& WithStatus(AdapterVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  GetAdapterVersionResult& AddEvaluationMetrics(EvaluationMetricsT&& value) {
    m_evaluationMetricsHasBeenSet = true;
    m_evaluationMetrics.emplace_back(std::forward<EvaluationMetricsT>(value));
    return *this;
  }
  ///@}
