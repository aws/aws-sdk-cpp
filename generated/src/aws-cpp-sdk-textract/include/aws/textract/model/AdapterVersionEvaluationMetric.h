...
class AdapterVersionEvaluationMetric {
 public:
  ...
  void SetBaseline(BaselineT&& value) {
    m_baselineHasBeenSet = true;
    m_baseline = std::forward<BaselineT>(value);
  }
  template <typename BaselineT = EvaluationMetric>
  AdapterVersionEvaluationMetric& WithBaseline(BaselineT&& value) {
    SetBaseline(std::forward<BaselineT>(value));
    return *this;
  }
  ///@}
  ...
  inline AdapterVersionEvaluationMetric& WithFeatureType(FeatureType value) {
