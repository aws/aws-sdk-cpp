...
class ExpenseField {
 public:
  ...
  void SetLabelDetection(LabelDetectionT&& value) {
    ...
    m_labelDetection = std::forward<LabelDetectionT>(value);
  }
  template <typename LabelDetectionT = ExpenseDetection>
  ExpenseField& WithLabelDetection(LabelDetectionT&& value) {
    SetLabelDetection(std::forward<LabelDetectionT>(value));
    return *this;
  }
  ///@}
  ...
  inline ExpenseField& WithPageNumber(int value) {
    SetPageNumber(value);
    return *this;
  }
  ///@}
  ...
  void SetGroupProperties(GroupPropertiesT&& value) {
    ...
    m_groupProperties = std::forward<GroupPropertiesT>(value);
  }
  template <typename GroupPropertiesT = Aws::Vector<ExpenseGroupProperty>>
  ExpenseField& WithGroupProperties(GroupPropertiesT&& value) {
    SetGroupProperties(std::forward<GroupPropertiesT>(value));
    return *this;
  }
  template <typename GroupPropertiesT = ExpenseGroupProperty>
  ExpenseField& AddGroupProperties(GroupPropertiesT&& value) {
    m_groupPropertiesHasBeenSet = true;
    m_groupProperties.emplace_back(std::forward<GroupPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
