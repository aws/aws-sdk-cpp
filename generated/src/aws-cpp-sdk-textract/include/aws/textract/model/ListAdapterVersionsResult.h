...
class ListAdapterVersionsResult {
 public:
  ...
  void SetAdapterVersions(AdapterVersionsT&& value) {
    m_adapterVersionsHasBeenSet = true;
    m_adapterVersions = std::forward<AdapterVersionsT>(value);
  }
  template <typename AdapterVersionsT = Aws::Vector<AdapterVersionOverview>>
  ListAdapterVersionsResult& WithAdapterVersions(AdapterVersionsT&& value) {
    SetAdapterVersions(std::forward<AdapterVersionsT>(value));
    return *this;
  }
  template <typename AdapterVersionsT = AdapterVersionOverview>
  ListAdapterVersionsResult& AddAdapterVersions(AdapterVersionsT&& value) {
    m_adapterVersionsHasBeenSet = true;
    m_adapterVersions.emplace_back(std::forward<AdapterVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAdapterVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAdapterVersionsResult& WithRequestId(RequestIdT&& value) {
