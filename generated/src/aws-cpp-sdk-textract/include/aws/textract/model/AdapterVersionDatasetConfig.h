...
class AdapterVersionDatasetConfig {
 public:
  ...
  void SetManifestS3Object(ManifestS3ObjectT&& value) {
    m_manifestS3ObjectHasBeenSet = true;
    m_manifestS3Object = std::forward<ManifestS3ObjectT>(value);
  }
  template <typename ManifestS3ObjectT = S3Object>
  AdapterVersionDatasetConfig& WithManifestS3Object(ManifestS3ObjectT&& value) {
    SetManifestS3Object(std::forward<ManifestS3ObjectT>(value));
    return *this;
  }
  ///@}
 private:
