...
class AnalyzeIDResult {
 public:
  ...
  void SetIdentityDocuments(IdentityDocumentsT&& value) {
    ...
    m_identityDocuments = std::forward<IdentityDocumentsT>(value);
  }
  template <typename IdentityDocumentsT = Aws::Vector<IdentityDocument>>
  AnalyzeIDResult& WithIdentityDocuments(IdentityDocumentsT&& value) {
    SetIdentityDocuments(std::forward<IdentityDocumentsT>(value));
    return *this;
  }
  template <typename IdentityDocumentsT = IdentityDocument>
  AnalyzeIDResult& AddIdentityDocuments(IdentityDocumentsT&& value) {
    m_identityDocumentsHasBeenSet = true;
    m_identityDocuments.emplace_back(std::forward<IdentityDocumentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnalyzeIDModelVersion(AnalyzeIDModelVersionT&& value) {
    ...
    m_analyzeIDModelVersion = std::forward<AnalyzeIDModelVersionT>(value);
  }
  template <typename AnalyzeIDModelVersionT = Aws::String>
  AnalyzeIDResult& WithAnalyzeIDModelVersion(AnalyzeIDModelVersionT&& value) {
    SetAnalyzeIDModelVersion(std::forward<AnalyzeIDModelVersionT>(value));
    return *this;
  }
  ///@}
