...
class AWS_TEXTRACT_API TextractClient : public Aws::Client::AWSJsonClient,
                                        ...
                                        public TextractWaiter<TextractClient> {
 public:
   ...
   */
  TextractClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<TextractEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for AnalyzeDocument that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AnalyzeDocumentRequestT = Model::AnalyzeDocumentRequest>
  void AnalyzeDocumentAsync(const AnalyzeDocumentRequestT& request, const AnalyzeDocumentResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for AnalyzeExpense that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AnalyzeExpenseRequestT = Model::AnalyzeExpenseRequest>
  void AnalyzeExpenseAsync(const AnalyzeExpenseRequestT& request, const AnalyzeExpenseResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AnalyzeID that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AnalyzeIDRequestT = Model::AnalyzeIDRequest>
  void AnalyzeIDAsync(const AnalyzeIDRequestT& request, const AnalyzeIDResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAdapter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAdapterRequestT = Model::CreateAdapterRequest>
  void CreateAdapterAsync(const CreateAdapterRequestT& request, const CreateAdapterResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAdapterVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAdapterVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAdapterVersionRequestT = Model::CreateAdapterVersionRequest>
  void CreateAdapterVersionAsync(const CreateAdapterVersionRequestT& request, const CreateAdapterVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAdapter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAdapterRequestT = Model::DeleteAdapterRequest>
  void DeleteAdapterAsync(const DeleteAdapterRequestT& request, const DeleteAdapterResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAdapterVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAdapterVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAdapterVersionRequestT = Model::DeleteAdapterVersionRequest>
  void DeleteAdapterVersionAsync(const DeleteAdapterVersionRequestT& request, const DeleteAdapterVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectDocumentText that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectDocumentText that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetectDocumentTextRequestT = Model::DetectDocumentTextRequest>
  void DetectDocumentTextAsync(const DetectDocumentTextRequestT& request, const DetectDocumentTextResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAdapter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAdapterRequestT = Model::GetAdapterRequest>
  void GetAdapterAsync(const GetAdapterRequestT& request, const GetAdapterResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAdapterVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAdapterVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAdapterVersionRequestT = Model::GetAdapterVersionRequest>
  void GetAdapterVersionAsync(const GetAdapterVersionRequestT& request, const GetAdapterVersionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDocumentAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDocumentAnalysis that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDocumentAnalysisRequestT = Model::GetDocumentAnalysisRequest>
  void GetDocumentAnalysisAsync(const GetDocumentAnalysisRequestT& request, const GetDocumentAnalysisResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDocumentTextDetection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDocumentTextDetection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDocumentTextDetectionRequestT = Model::GetDocumentTextDetectionRequest>
  void GetDocumentTextDetectionAsync(const GetDocumentTextDetectionRequestT& request,
                                     const GetDocumentTextDetectionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetExpenseAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetExpenseAnalysis that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetExpenseAnalysisRequestT = Model::GetExpenseAnalysisRequest>
  void GetExpenseAnalysisAsync(const GetExpenseAnalysisRequestT& request, const GetExpenseAnalysisResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLendingAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLendingAnalysis that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetLendingAnalysisRequestT = Model::GetLendingAnalysisRequest>
  void GetLendingAnalysisAsync(const GetLendingAnalysisRequestT& request, const GetLendingAnalysisResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLendingAnalysisSummary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetLendingAnalysisSummaryRequestT = Model::GetLendingAnalysisSummaryRequest>
  Model::GetLendingAnalysisSummaryOutcomeCallable GetLendingAnalysisSummaryCallable(
      const GetLendingAnalysisSummaryRequestT& request) const {
    return SubmitCallable(&TextractClient::GetLendingAnalysisSummary, request);
  }

  /**
   * An Async wrapper for GetLendingAnalysisSummary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetLendingAnalysisSummaryRequestT = Model::GetLendingAnalysisSummaryRequest>
  void GetLendingAnalysisSummaryAsync(const GetLendingAnalysisSummaryRequestT& request,
                                      const GetLendingAnalysisSummaryResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAdapterVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAdapterVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAdapterVersionsRequestT = Model::ListAdapterVersionsRequest>
  void ListAdapterVersionsAsync(const ListAdapterVersionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListAdapterVersionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListAdapters that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAdaptersRequestT = Model::ListAdaptersRequest>
  void ListAdaptersAsync(const ListAdaptersResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListAdaptersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for StartDocumentAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartDocumentAnalysis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartDocumentAnalysisRequestT = Model::StartDocumentAnalysisRequest>
  void StartDocumentAnalysisAsync(const StartDocumentAnalysisRequestT& request, const StartDocumentAnalysisResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartDocumentTextDetectionOutcome StartDocumentTextDetection(
      const Model::StartDocumentTextDetectionRequest& request) const;

  /**
   * A Callable wrapper for StartDocumentTextDetection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartDocumentTextDetectionRequestT = Model::StartDocumentTextDetectionRequest>
  Model::StartDocumentTextDetectionOutcomeCallable StartDocumentTextDetectionCallable(
      const StartDocumentTextDetectionRequestT& request) const {
    return SubmitCallable(&TextractClient::StartDocumentTextDetection, request);
  }

  /**
   * An Async wrapper for StartDocumentTextDetection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartDocumentTextDetectionRequestT = Model::StartDocumentTextDetectionRequest>
  void StartDocumentTextDetectionAsync(const StartDocumentTextDetectionRequestT& request,
                                       const StartDocumentTextDetectionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartExpenseAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartExpenseAnalysis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartExpenseAnalysisRequestT = Model::StartExpenseAnalysisRequest>
  void StartExpenseAnalysisAsync(const StartExpenseAnalysisRequestT& request, const StartExpenseAnalysisResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartLendingAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartLendingAnalysis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartLendingAnalysisRequestT = Model::StartLendingAnalysisRequest>
  void StartLendingAnalysisAsync(const StartLendingAnalysisRequestT& request, const StartLendingAnalysisResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateAdapter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAdapterRequestT = Model::UpdateAdapterRequest>
  void UpdateAdapterAsync(const UpdateAdapterRequestT& request, const UpdateAdapterResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
