...
namespace Textract
{
   ...
   * Textract.</p>
   */
  class AWS_TEXTRACT_API TextractClient : Aws::Client::ClientWithAsyncTemplateMethods<TextractClient>,
    smithy::client::AwsSmithyClientT<Aws::Textract::SERVICE_NAME,
