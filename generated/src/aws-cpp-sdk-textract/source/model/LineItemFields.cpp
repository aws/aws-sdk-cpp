...
LineItemFields::LineItemFields(JsonView jsonValue) { *this = jsonValue; }
...
LineItemFields& LineItemFields::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("LineItemExpenseFields")) {
    ...
    for (unsigned lineItemExpenseFieldsIndex = 0; lineItemExpenseFieldsIndex < lineItemExpenseFieldsJsonList.GetLength();
         ++lineItemExpenseFieldsIndex) {
