...
namespace Textract
{
const size_t TextractEndpointRules::RulesBlobStrLen = 3732;
const size_t TextractEndpointRules::RulesBlobSize = 3733;
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','t','e','x','t','r','a','c','t','.',
...
'r','a','c','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
