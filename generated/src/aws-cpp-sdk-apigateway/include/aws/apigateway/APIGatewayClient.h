...
class AWS_APIGATEWAY_API APIGatewayClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  APIGatewayClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<APIGatewayEndpointProviderBase> endpointProvider = nullptr,
      const Aws::APIGateway::APIGatewayClientConfiguration& clientConfiguration = Aws::APIGateway::APIGatewayClientConfiguration());
   ...
   */
  template <typename CreateApiKeyRequestT = Model::CreateApiKeyRequest>
  void CreateApiKeyAsync(const CreateApiKeyResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const CreateApiKeyRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateBasePathMapping that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBasePathMapping that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateBasePathMappingRequestT = Model::CreateBasePathMappingRequest>
  void CreateBasePathMappingAsync(const CreateBasePathMappingRequestT& request, const CreateBasePathMappingResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDocumentationPart that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDocumentationPart that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDocumentationPartRequestT = Model::CreateDocumentationPartRequest>
  void CreateDocumentationPartAsync(const CreateDocumentationPartRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDocumentationVersionOutcome CreateDocumentationVersion(
      const Model::CreateDocumentationVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateDocumentationVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateDocumentationVersionRequestT = Model::CreateDocumentationVersionRequest>
  Model::CreateDocumentationVersionOutcomeCallable CreateDocumentationVersionCallable(
      const CreateDocumentationVersionRequestT& request) const {
    return SubmitCallable(&APIGatewayClient::CreateDocumentationVersion, request);
  }

  /**
   * An Async wrapper for CreateDocumentationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDocumentationVersionRequestT = Model::CreateDocumentationVersionRequest>
  void CreateDocumentationVersionAsync(const CreateDocumentationVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDomainNameAccessAssociationOutcome CreateDomainNameAccessAssociation(
      const Model::CreateDomainNameAccessAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateDomainNameAccessAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateDomainNameAccessAssociationRequestT = Model::CreateDomainNameAccessAssociationRequest>
  Model::CreateDomainNameAccessAssociationOutcomeCallable CreateDomainNameAccessAssociationCallable(
      const CreateDomainNameAccessAssociationRequestT& request) const {
    return SubmitCallable(&APIGatewayClient::CreateDomainNameAccessAssociation, request);
  }

  /**
   * An Async wrapper for CreateDomainNameAccessAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateDomainNameAccessAssociationRequestT = Model::CreateDomainNameAccessAssociationRequest>
  void CreateDomainNameAccessAssociationAsync(const CreateDomainNameAccessAssociationRequestT& request,
                                              const CreateDomainNameAccessAssociationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateRequestValidator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateRequestValidator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRequestValidatorRequestT = Model::CreateRequestValidatorRequest>
  void CreateRequestValidatorAsync(const CreateRequestValidatorRequestT& request,
  ...
  /**
   * An Async wrapper for CreateRestApi that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateRestApiRequestT = Model::CreateRestApiRequest>
  void CreateRestApiAsync(const CreateRestApiRequestT& request, const CreateRestApiResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateUsagePlan that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateUsagePlanRequestT = Model::CreateUsagePlanRequest>
  void CreateUsagePlanAsync(const CreateUsagePlanRequestT& request, const CreateUsagePlanResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateUsagePlanKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateUsagePlanKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateUsagePlanKeyRequestT = Model::CreateUsagePlanKeyRequest>
  void CreateUsagePlanKeyAsync(const CreateUsagePlanKeyRequestT& request, const CreateUsagePlanKeyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBasePathMapping that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBasePathMapping that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBasePathMappingRequestT = Model::DeleteBasePathMappingRequest>
  void DeleteBasePathMappingAsync(const DeleteBasePathMappingRequestT& request, const DeleteBasePathMappingResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteClientCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteClientCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteClientCertificateRequestT = Model::DeleteClientCertificateRequest>
  void DeleteClientCertificateAsync(const DeleteClientCertificateRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteDocumentationPart that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDocumentationPart that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDocumentationPartRequestT = Model::DeleteDocumentationPartRequest>
  void DeleteDocumentationPartAsync(const DeleteDocumentationPartRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDocumentationVersionOutcome DeleteDocumentationVersion(
      const Model::DeleteDocumentationVersionRequest& request) const;

  /**
   * A Callable wrapper for DeleteDocumentationVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDocumentationVersionRequestT = Model::DeleteDocumentationVersionRequest>
  Model::DeleteDocumentationVersionOutcomeCallable DeleteDocumentationVersionCallable(
      const DeleteDocumentationVersionRequestT& request) const {
    return SubmitCallable(&APIGatewayClient::DeleteDocumentationVersion, request);
  }

  /**
   * An Async wrapper for DeleteDocumentationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDocumentationVersionRequestT = Model::DeleteDocumentationVersionRequest>
  void DeleteDocumentationVersionAsync(const DeleteDocumentationVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDomainNameAccessAssociationOutcome DeleteDomainNameAccessAssociation(
      const Model::DeleteDomainNameAccessAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteDomainNameAccessAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteDomainNameAccessAssociationRequestT = Model::DeleteDomainNameAccessAssociationRequest>
  Model::DeleteDomainNameAccessAssociationOutcomeCallable DeleteDomainNameAccessAssociationCallable(
      const DeleteDomainNameAccessAssociationRequestT& request) const {
    return SubmitCallable(&APIGatewayClient::DeleteDomainNameAccessAssociation, request);
  }

  /**
   * An Async wrapper for DeleteDomainNameAccessAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteDomainNameAccessAssociationRequestT = Model::DeleteDomainNameAccessAssociationRequest>
  void DeleteDomainNameAccessAssociationAsync(const DeleteDomainNameAccessAssociationRequestT& request,
                                              const DeleteDomainNameAccessAssociationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteGatewayResponse that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteGatewayResponse that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteGatewayResponseRequestT = Model::DeleteGatewayResponseRequest>
  void DeleteGatewayResponseAsync(const DeleteGatewayResponseRequestT& request, const DeleteGatewayResponseResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteMethod that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteMethodRequestT = Model::DeleteMethodRequest>
  void DeleteMethodAsync(const DeleteMethodRequestT& request, const DeleteMethodResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMethodResponse that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMethodResponse that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMethodResponseRequestT = Model::DeleteMethodResponseRequest>
  void DeleteMethodResponseAsync(const DeleteMethodResponseRequestT& request, const DeleteMethodResponseResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteRequestValidator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRequestValidator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRequestValidatorRequestT = Model::DeleteRequestValidatorRequest>
  void DeleteRequestValidatorAsync(const DeleteRequestValidatorRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteRestApi that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRestApiRequestT = Model::DeleteRestApiRequest>
  void DeleteRestApiAsync(const DeleteRestApiRequestT& request, const DeleteRestApiResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteUsagePlan that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteUsagePlanRequestT = Model::DeleteUsagePlanRequest>
  void DeleteUsagePlanAsync(const DeleteUsagePlanRequestT& request, const DeleteUsagePlanResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteUsagePlanKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteUsagePlanKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteUsagePlanKeyRequestT = Model::DeleteUsagePlanKeyRequest>
  void DeleteUsagePlanKeyAsync(const DeleteUsagePlanKeyRequestT& request, const DeleteUsagePlanKeyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::FlushStageAuthorizersCacheOutcome FlushStageAuthorizersCache(
      const Model::FlushStageAuthorizersCacheRequest& request) const;

  /**
   * A Callable wrapper for FlushStageAuthorizersCache that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename FlushStageAuthorizersCacheRequestT = Model::FlushStageAuthorizersCacheRequest>
  Model::FlushStageAuthorizersCacheOutcomeCallable FlushStageAuthorizersCacheCallable(
      const FlushStageAuthorizersCacheRequestT& request) const {
    return SubmitCallable(&APIGatewayClient::FlushStageAuthorizersCache, request);
  }

  /**
   * An Async wrapper for FlushStageAuthorizersCache that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename FlushStageAuthorizersCacheRequestT = Model::FlushStageAuthorizersCacheRequest>
  void FlushStageAuthorizersCacheAsync(const FlushStageAuthorizersCacheRequestT& request,
  ...
  /**
   * An Async wrapper for FlushStageCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename FlushStageCacheRequestT = Model::FlushStageCacheRequest>
  void FlushStageCacheAsync(const FlushStageCacheRequestT& request, const FlushStageCacheResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GenerateClientCertificateOutcome GenerateClientCertificate(
      const Model::GenerateClientCertificateRequest& request = {}) const;

  /**
   * A Callable wrapper for GenerateClientCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GenerateClientCertificateRequestT = Model::GenerateClientCertificateRequest>
  Model::GenerateClientCertificateOutcomeCallable GenerateClientCertificateCallable(
      const GenerateClientCertificateRequestT& request = {}) const {
    return SubmitCallable(&APIGatewayClient::GenerateClientCertificate, request);
  }

  /**
   * An Async wrapper for GenerateClientCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GenerateClientCertificateRequestT = Model::GenerateClientCertificateRequest>
  void GenerateClientCertificateAsync(const GenerateClientCertificateResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const GenerateClientCertificateRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetApiKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetApiKeyRequestT = Model::GetApiKeyRequest>
  void GetApiKeyAsync(const GetApiKeyRequestT& request, const GetApiKeyResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetApiKeys that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetApiKeysRequestT = Model::GetApiKeysRequest>
  void GetApiKeysAsync(const GetApiKeysResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const GetApiKeysRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetBasePathMapping that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBasePathMapping that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBasePathMappingRequestT = Model::GetBasePathMappingRequest>
  void GetBasePathMappingAsync(const GetBasePathMappingRequestT& request, const GetBasePathMappingResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBasePathMappings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBasePathMappings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBasePathMappingsRequestT = Model::GetBasePathMappingsRequest>
  void GetBasePathMappingsAsync(const GetBasePathMappingsRequestT& request, const GetBasePathMappingsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetClientCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetClientCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetClientCertificateRequestT = Model::GetClientCertificateRequest>
  void GetClientCertificateAsync(const GetClientCertificateRequestT& request, const GetClientCertificateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetClientCertificates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetClientCertificates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetClientCertificatesRequestT = Model::GetClientCertificatesRequest>
  void GetClientCertificatesAsync(const GetClientCertificatesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const GetClientCertificatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetDocumentationPart that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDocumentationPart that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDocumentationPartRequestT = Model::GetDocumentationPartRequest>
  void GetDocumentationPartAsync(const GetDocumentationPartRequestT& request, const GetDocumentationPartResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDocumentationParts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDocumentationParts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDocumentationPartsRequestT = Model::GetDocumentationPartsRequest>
  void GetDocumentationPartsAsync(const GetDocumentationPartsRequestT& request, const GetDocumentationPartsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDocumentationVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDocumentationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDocumentationVersionRequestT = Model::GetDocumentationVersionRequest>
  void GetDocumentationVersionAsync(const GetDocumentationVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for GetDocumentationVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDocumentationVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDocumentationVersionsRequestT = Model::GetDocumentationVersionsRequest>
  void GetDocumentationVersionsAsync(const GetDocumentationVersionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDomainNameAccessAssociationsOutcome GetDomainNameAccessAssociations(
      const Model::GetDomainNameAccessAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetDomainNameAccessAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDomainNameAccessAssociationsRequestT = Model::GetDomainNameAccessAssociationsRequest>
  Model::GetDomainNameAccessAssociationsOutcomeCallable GetDomainNameAccessAssociationsCallable(
      const GetDomainNameAccessAssociationsRequestT& request = {}) const {
    return SubmitCallable(&APIGatewayClient::GetDomainNameAccessAssociations, request);
  }

  /**
   * An Async wrapper for GetDomainNameAccessAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetDomainNameAccessAssociationsRequestT = Model::GetDomainNameAccessAssociationsRequest>
  void GetDomainNameAccessAssociationsAsync(const GetDomainNameAccessAssociationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const GetDomainNameAccessAssociationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetGatewayResponse that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetGatewayResponse that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetGatewayResponseRequestT = Model::GetGatewayResponseRequest>
  void GetGatewayResponseAsync(const GetGatewayResponseRequestT& request, const GetGatewayResponseResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetGatewayResponses that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetGatewayResponses that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetGatewayResponsesRequestT = Model::GetGatewayResponsesRequest>
  void GetGatewayResponsesAsync(const GetGatewayResponsesRequestT& request, const GetGatewayResponsesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMethod that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMethodRequestT = Model::GetMethodRequest>
  void GetMethodAsync(const GetMethodRequestT& request, const GetMethodResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMethodResponse that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMethodResponse that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMethodResponseRequestT = Model::GetMethodResponseRequest>
  void GetMethodResponseAsync(const GetMethodResponseRequestT& request, const GetMethodResponseResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRequestValidator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRequestValidator that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetRequestValidatorRequestT = Model::GetRequestValidatorRequest>
  void GetRequestValidatorAsync(const GetRequestValidatorRequestT& request, const GetRequestValidatorResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRequestValidators that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRequestValidators that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRequestValidatorsRequestT = Model::GetRequestValidatorsRequest>
  void GetRequestValidatorsAsync(const GetRequestValidatorsRequestT& request, const GetRequestValidatorsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetResourcesRequestT = Model::GetResourcesRequest>
  void GetResourcesAsync(const GetResourcesRequestT& request, const GetResourcesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRestApi that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRestApiRequestT = Model::GetRestApiRequest>
  void GetRestApiAsync(const GetRestApiRequestT& request, const GetRestApiResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRestApis that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRestApisRequestT = Model::GetRestApisRequest>
  void GetRestApisAsync(const GetRestApisResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetRestApisRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetSdk that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSdkRequestT = Model::GetSdkRequest>
  void GetSdkAsync(const GetSdkRequestT& request, const GetSdkResponseReceivedHandler& handler,
                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSdkType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSdkTypeRequestT = Model::GetSdkTypeRequest>
  void GetSdkTypeAsync(const GetSdkTypeRequestT& request, const GetSdkTypeResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSdkTypes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSdkTypesRequestT = Model::GetSdkTypesRequest>
  void GetSdkTypesAsync(const GetSdkTypesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetSdkTypesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetUsage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetUsageRequestT = Model::GetUsageRequest>
  void GetUsageAsync(const GetUsageRequestT& request, const GetUsageResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetUsagePlan that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetUsagePlanRequestT = Model::GetUsagePlanRequest>
  void GetUsagePlanAsync(const GetUsagePlanRequestT& request, const GetUsagePlanResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetUsagePlanKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetUsagePlanKeyRequestT = Model::GetUsagePlanKeyRequest>
  void GetUsagePlanKeyAsync(const GetUsagePlanKeyRequestT& request, const GetUsagePlanKeyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetUsagePlanKeys that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetUsagePlanKeys that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetUsagePlanKeysRequestT = Model::GetUsagePlanKeysRequest>
  void GetUsagePlanKeysAsync(const GetUsagePlanKeysRequestT& request, const GetUsagePlanKeysResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetUsagePlans that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetUsagePlansRequestT = Model::GetUsagePlansRequest>
  void GetUsagePlansAsync(const GetUsagePlansResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const GetUsagePlansRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ImportApiKeys that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportApiKeysRequestT = Model::ImportApiKeysRequest>
  void ImportApiKeysAsync(const ImportApiKeysRequestT& request, const ImportApiKeysResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ImportDocumentationParts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportDocumentationParts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ImportDocumentationPartsRequestT = Model::ImportDocumentationPartsRequest>
  void ImportDocumentationPartsAsync(const ImportDocumentationPartsRequestT& request,
  ...
  /**
   * An Async wrapper for ImportRestApi that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportRestApiRequestT = Model::ImportRestApiRequest>
  void ImportRestApiAsync(const ImportRestApiRequestT& request, const ImportRestApiResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutGatewayResponse that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutGatewayResponse that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutGatewayResponseRequestT = Model::PutGatewayResponseRequest>
  void PutGatewayResponseAsync(const PutGatewayResponseRequestT& request, const PutGatewayResponseResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutIntegrationResponse that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutIntegrationResponse that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutIntegrationResponseRequestT = Model::PutIntegrationResponseRequest>
  void PutIntegrationResponseAsync(const PutIntegrationResponseRequestT& request,
  ...
  /**
   * An Async wrapper for PutMethod that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutMethodRequestT = Model::PutMethodRequest>
  void PutMethodAsync(const PutMethodRequestT& request, const PutMethodResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutMethodResponse that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutMethodResponse that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutMethodResponseRequestT = Model::PutMethodResponseRequest>
  void PutMethodResponseAsync(const PutMethodResponseRequestT& request, const PutMethodResponseResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutRestApi that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutRestApiRequestT = Model::PutRestApiRequest>
  void PutRestApiAsync(const PutRestApiRequestT& request, const PutRestApiResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RejectDomainNameAccessAssociationOutcome RejectDomainNameAccessAssociation(
      const Model::RejectDomainNameAccessAssociationRequest& request) const;

  /**
   * A Callable wrapper for RejectDomainNameAccessAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename RejectDomainNameAccessAssociationRequestT = Model::RejectDomainNameAccessAssociationRequest>
  Model::RejectDomainNameAccessAssociationOutcomeCallable RejectDomainNameAccessAssociationCallable(
      const RejectDomainNameAccessAssociationRequestT& request) const {
    return SubmitCallable(&APIGatewayClient::RejectDomainNameAccessAssociation, request);
  }

  /**
   * An Async wrapper for RejectDomainNameAccessAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RejectDomainNameAccessAssociationRequestT = Model::RejectDomainNameAccessAssociationRequest>
  void RejectDomainNameAccessAssociationAsync(const RejectDomainNameAccessAssociationRequestT& request,
                                              const RejectDomainNameAccessAssociationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TestInvokeMethod that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TestInvokeMethod that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TestInvokeMethodRequestT = Model::TestInvokeMethodRequest>
  void TestInvokeMethodAsync(const TestInvokeMethodRequestT& request, const TestInvokeMethodResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename UpdateAccountRequestT = Model::UpdateAccountRequest>
  void UpdateAccountAsync(const UpdateAccountResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const UpdateAccountRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateBasePathMapping that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBasePathMapping that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateBasePathMappingRequestT = Model::UpdateBasePathMappingRequest>
  void UpdateBasePathMappingAsync(const UpdateBasePathMappingRequestT& request, const UpdateBasePathMappingResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateClientCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateClientCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateClientCertificateRequestT = Model::UpdateClientCertificateRequest>
  void UpdateClientCertificateAsync(const UpdateClientCertificateRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateDocumentationPart that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDocumentationPart that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDocumentationPartRequestT = Model::UpdateDocumentationPartRequest>
  void UpdateDocumentationPartAsync(const UpdateDocumentationPartRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDocumentationVersionOutcome UpdateDocumentationVersion(
      const Model::UpdateDocumentationVersionRequest& request) const;

  /**
   * A Callable wrapper for UpdateDocumentationVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateDocumentationVersionRequestT = Model::UpdateDocumentationVersionRequest>
  Model::UpdateDocumentationVersionOutcomeCallable UpdateDocumentationVersionCallable(
      const UpdateDocumentationVersionRequestT& request) const {
    return SubmitCallable(&APIGatewayClient::UpdateDocumentationVersion, request);
  }

  /**
   * An Async wrapper for UpdateDocumentationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDocumentationVersionRequestT = Model::UpdateDocumentationVersionRequest>
  void UpdateDocumentationVersionAsync(const UpdateDocumentationVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateGatewayResponse that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateGatewayResponse that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateGatewayResponseRequestT = Model::UpdateGatewayResponseRequest>
  void UpdateGatewayResponseAsync(const UpdateGatewayResponseRequestT& request, const UpdateGatewayResponseResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateMethod that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateMethodRequestT = Model::UpdateMethodRequest>
  void UpdateMethodAsync(const UpdateMethodRequestT& request, const UpdateMethodResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMethodResponse that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMethodResponse that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMethodResponseRequestT = Model::UpdateMethodResponseRequest>
  void UpdateMethodResponseAsync(const UpdateMethodResponseRequestT& request, const UpdateMethodResponseResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateRequestValidator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRequestValidator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRequestValidatorRequestT = Model::UpdateRequestValidatorRequest>
  void UpdateRequestValidatorAsync(const UpdateRequestValidatorRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateRestApi that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRestApiRequestT = Model::UpdateRestApiRequest>
  void UpdateRestApiAsync(const UpdateRestApiRequestT& request, const UpdateRestApiResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateUsage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateUsageRequestT = Model::UpdateUsageRequest>
  void UpdateUsageAsync(const UpdateUsageRequestT& request, const UpdateUsageResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateUsagePlan that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateUsagePlanRequestT = Model::UpdateUsagePlanRequest>
  void UpdateUsagePlanAsync(const UpdateUsagePlanRequestT& request, const UpdateUsagePlanResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
