...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    UpdateResourceResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ParentIdT = Aws::String>
    UpdateResourceResult& WithParentId(ParentIdT&& value) { SetParentId(std::forward<ParentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PathPartT = Aws::String>
    UpdateResourceResult& WithPathPart(PathPartT&& value) { SetPathPart(std::forward<PathPartT>(value)); return *this;}
    ///@}
    ...
    template<typename PathT = Aws::String>
    UpdateResourceResult& WithPath(PathT&& value) { SetPath(std::forward<PathT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceMethodsT = Aws::Map<Aws::String, Method>>
    UpdateResourceResult& WithResourceMethods(ResourceMethodsT&& value) { SetResourceMethods(std::forward<ResourceMethodsT>(value)); return *this;}
