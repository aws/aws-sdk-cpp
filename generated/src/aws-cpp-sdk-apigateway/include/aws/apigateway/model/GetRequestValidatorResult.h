...
class GetRequestValidatorResult {
 public:
  AWS_APIGATEWAY_API GetRequestValidatorResult() = default;
  ...
  template <typename IdT = Aws::String>
  GetRequestValidatorResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetRequestValidatorResult& WithName(NameT&& value) {
  ...
  inline GetRequestValidatorResult& WithValidateRequestBody(bool value) {
  ...
  inline GetRequestValidatorResult& WithValidateRequestParameters(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRequestValidatorResult& WithRequestId(RequestIdT&& value) {
