...
namespace Model
{
  ...
  /**
   * <p>Request to list existing Models defined for a RestApi resource.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/apigateway-2015-07-09/GetModelsRequest">AWS
   * API Reference</a></p>
   */
  class GetModelsRequest : public APIGatewayRequest
  {
  public:
    ...
    template<typename RestApiIdT = Aws::String>
    GetModelsRequest& WithRestApiId(RestApiIdT&& value) { SetRestApiId(std::forward<RestApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PositionT = Aws::String>
    GetModelsRequest& WithPosition(PositionT&& value) { SetPosition(std::forward<PositionT>(value)); return *this;}
    ///@}
