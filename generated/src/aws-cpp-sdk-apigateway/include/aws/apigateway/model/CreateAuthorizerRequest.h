...
class CreateAuthorizerRequest : public APIGatewayRequest {
 public:
  ...
  inline void SetType(AuthorizerType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CreateAuthorizerRequest& WithType(AuthorizerType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetAuthType(AuthTypeT&& value) {
    ...
    m_authType = std::forward<AuthTypeT>(value);
  }
  template <typename AuthTypeT = Aws::String>
  CreateAuthorizerRequest& WithAuthType(AuthTypeT&& value) {
    SetAuthType(std::forward<AuthTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthorizerCredentials(AuthorizerCredentialsT&& value) {
    ...
    m_authorizerCredentials = std::forward<AuthorizerCredentialsT>(value);
  }
  template <typename AuthorizerCredentialsT = Aws::String>
  CreateAuthorizerRequest& WithAuthorizerCredentials(AuthorizerCredentialsT&& value) {
    SetAuthorizerCredentials(std::forward<AuthorizerCredentialsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateAuthorizerRequest& WithAuthorizerResultTtlInSeconds(int value) {
