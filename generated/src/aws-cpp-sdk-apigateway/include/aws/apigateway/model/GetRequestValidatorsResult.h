...
class GetRequestValidatorsResult {
 public:
  ...
  template <typename PositionT = Aws::String>
  GetRequestValidatorsResult& WithPosition(PositionT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<RequestValidator>>
  GetRequestValidatorsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = RequestValidator>
  GetRequestValidatorsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetRequestValidatorsResult& WithRequestId(RequestIdT&& value) {
