...
class PutRestApiResult {
 public:
  ...
  template <typename IdT = Aws::String>
  PutRestApiResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  PutRestApiResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  PutRestApiResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  PutRestApiResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename VersionT = Aws::String>
  PutRestApiResult& WithVersion(VersionT&& value) {
  ...
  template <typename WarningsT = Aws::Vector<Aws::String>>
  PutRestApiResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = Aws::String>
  PutRestApiResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
  ...
  template <typename BinaryMediaTypesT = Aws::Vector<Aws::String>>
  PutRestApiResult& WithBinaryMediaTypes(BinaryMediaTypesT&& value) {
    SetBinaryMediaTypes(std::forward<BinaryMediaTypesT>(value));
    return *this;
  }
  template <typename BinaryMediaTypesT = Aws::String>
  PutRestApiResult& AddBinaryMediaTypes(BinaryMediaTypesT&& value) {
    m_binaryMediaTypesHasBeenSet = true;
  ...
  inline PutRestApiResult& WithMinimumCompressionSize(int value) {
  ...
  inline PutRestApiResult& WithApiKeySource(ApiKeySourceType value) {
  ...
  template <typename EndpointConfigurationT = EndpointConfiguration>
  PutRestApiResult& WithEndpointConfiguration(EndpointConfigurationT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  PutRestApiResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  PutRestApiResult& WithTags(TagsT&& value) {
  ...
  inline PutRestApiResult& WithDisableExecuteApiEndpoint(bool value) {
  ...
  template <typename RootResourceIdT = Aws::String>
  PutRestApiResult& WithRootResourceId(RootResourceIdT&& value) {
  ...
  inline PutRestApiResult& WithSecurityPolicy(SecurityPolicy value) {
  ...
  inline PutRestApiResult& WithEndpointAccessMode(EndpointAccessMode value) {
  ...
  inline PutRestApiResult& WithApiStatus(ApiStatus value) {
    SetApiStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ApiStatusMessageT = Aws::String>
  PutRestApiResult& WithApiStatusMessage(ApiStatusMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutRestApiResult& WithRequestId(RequestIdT&& value) {
