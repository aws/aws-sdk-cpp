...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetDocumentationVersionsRequest : public APIGatewayRequest
  {
  public:
    ...
    template<typename RestApiIdT = Aws::String>
    GetDocumentationVersionsRequest& WithRestApiId(RestApiIdT&& value) { SetRestApiId(std::forward<RestApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PositionT = Aws::String>
    GetDocumentationVersionsRequest& WithPosition(PositionT&& value) { SetPosition(std::forward<PositionT>(value)); return *this;}
    ///@}
