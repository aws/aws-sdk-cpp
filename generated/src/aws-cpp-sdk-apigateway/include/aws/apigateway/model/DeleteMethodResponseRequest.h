...
class DeleteMethodResponseRequest : public APIGatewayRequest {
 public:
  ...
  template <typename RestApiIdT = Aws::String>
  DeleteMethodResponseRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  DeleteMethodResponseRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename HttpMethodT = Aws::String>
  DeleteMethodResponseRequest& WithHttpMethod(HttpMethodT&& value) {
  ...
  template <typename StatusCodeT = Aws::String>
  DeleteMethodResponseRequest& WithStatusCode(StatusCodeT&& value) {
