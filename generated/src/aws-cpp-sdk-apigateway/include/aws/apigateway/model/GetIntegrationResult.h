...
namespace Model
{
  ...
  public:
    ...
    template<typename HttpMethodT = Aws::String>
    GetIntegrationResult& WithHttpMethod(HttpMethodT&& value) { SetHttpMethod(std::forward<HttpMethodT>(value)); return *this;}
    ///@}
    ...
    inline GetIntegrationResult& WithConnectionType(ConnectionType value) { SetConnectionType(value); return *this;}
    ///@}
    ...
    template<typename ConnectionIdT = Aws::String>
    GetIntegrationResult& WithConnectionId(ConnectionIdT&& value) { SetConnectionId(std::forward<ConnectionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CredentialsT = Aws::String>
    GetIntegrationResult& WithCredentials(CredentialsT&& value) { SetCredentials(std::forward<CredentialsT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestParametersT = Aws::Map<Aws::String, Aws::String>>
    GetIntegrationResult& WithRequestParameters(RequestParametersT&& value) { SetRequestParameters(std::forward<RequestParametersT>(value)); return *this;}
    ...
    template<typename RequestTemplatesT = Aws::Map<Aws::String, Aws::String>>
    GetIntegrationResult& WithRequestTemplates(RequestTemplatesT&& value) { SetRequestTemplates(std::forward<RequestTemplatesT>(value)); return *this;}
    ...
    template<typename PassthroughBehaviorT = Aws::String>
    GetIntegrationResult& WithPassthroughBehavior(PassthroughBehaviorT&& value) { SetPassthroughBehavior(std::forward<PassthroughBehaviorT>(value)); return *this;}
    ///@}
    ...
    template<typename CacheNamespaceT = Aws::String>
    GetIntegrationResult& WithCacheNamespace(CacheNamespaceT&& value) { SetCacheNamespace(std::forward<CacheNamespaceT>(value)); return *this;}
    ///@}
    ...
    template<typename CacheKeyParametersT = Aws::Vector<Aws::String>>
    GetIntegrationResult& WithCacheKeyParameters(CacheKeyParametersT&& value) { SetCacheKeyParameters(std::forward<CacheKeyParametersT>(value)); return *this;}
    template<typename CacheKeyParametersT = Aws::String>
    GetIntegrationResult& AddCacheKeyParameters(CacheKeyParametersT&& value) { m_cacheKeyParametersHasBeenSet = true; m_cacheKeyParameters.emplace_back(std::forward<CacheKeyParametersT>(value)); return *this; }
    ///@}
    ...
    template<typename IntegrationResponsesT = Aws::Map<Aws::String, IntegrationResponse>>
    GetIntegrationResult& WithIntegrationResponses(IntegrationResponsesT&& value) { SetIntegrationResponses(std::forward<IntegrationResponsesT>(value)); return *this;}
    ...
    template<typename TlsConfigT = TlsConfig>
    GetIntegrationResult& WithTlsConfig(TlsConfigT&& value) { SetTlsConfig(std::forward<TlsConfigT>(value)); return *this;}
    ///@}
