...
class GetIntegrationResult {
 public:
  ...
  inline GetIntegrationResult& WithType(IntegrationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline GetIntegrationResult& WithConnectionType(ConnectionType value) {
  ...
  inline GetIntegrationResult& WithContentHandling(ContentHandlingStrategy value) {
  ...
  inline GetIntegrationResult& WithTimeoutInMillis(int value) {
  ...
  inline GetIntegrationResult& WithResponseTransferMode(ResponseTransferMode value) {
