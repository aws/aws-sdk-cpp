...
class GetDocumentationPartsRequest : public APIGatewayRequest {
 public:
  ...
  inline void SetType(DocumentationPartType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline GetDocumentationPartsRequest& WithType(DocumentationPartType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetNameQuery(NameQueryT&& value) {
    m_nameQueryHasBeenSet = true;
    m_nameQuery = std::forward<NameQueryT>(value);
  }
  template <typename NameQueryT = Aws::String>
  GetDocumentationPartsRequest& WithNameQuery(NameQueryT&& value) {
    SetNameQuery(std::forward<NameQueryT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetDocumentationPartsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLocationStatus(LocationStatusType value) {
    m_locationStatusHasBeenSet = true;
    m_locationStatus = value;
  }
  inline GetDocumentationPartsRequest& WithLocationStatus(LocationStatusType value) {
