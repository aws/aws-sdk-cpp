...
class DomainName {
 public:
  ...
  void SetCertificateUploadDate(CertificateUploadDateT&& value) {
    ...
    m_certificateUploadDate = std::forward<CertificateUploadDateT>(value);
  }
  template <typename CertificateUploadDateT = Aws::Utils::DateTime>
  DomainName& WithCertificateUploadDate(CertificateUploadDateT&& value) {
    SetCertificateUploadDate(std::forward<CertificateUploadDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegionalDomainName(RegionalDomainNameT&& value) {
    ...
    m_regionalDomainName = std::forward<RegionalDomainNameT>(value);
  }
  template <typename RegionalDomainNameT = Aws::String>
  DomainName& WithRegionalDomainName(RegionalDomainNameT&& value) {
    SetRegionalDomainName(std::forward<RegionalDomainNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegionalHostedZoneId(RegionalHostedZoneIdT&& value) {
    ...
    m_regionalHostedZoneId = std::forward<RegionalHostedZoneIdT>(value);
  }
  template <typename RegionalHostedZoneIdT = Aws::String>
  DomainName& WithRegionalHostedZoneId(RegionalHostedZoneIdT&& value) {
    SetRegionalHostedZoneId(std::forward<RegionalHostedZoneIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegionalCertificateName(RegionalCertificateNameT&& value) {
    ...
    m_regionalCertificateName = std::forward<RegionalCertificateNameT>(value);
  }
  template <typename RegionalCertificateNameT = Aws::String>
  DomainName& WithRegionalCertificateName(RegionalCertificateNameT&& value) {
    SetRegionalCertificateName(std::forward<RegionalCertificateNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegionalCertificateArn(RegionalCertificateArnT&& value) {
    ...
    m_regionalCertificateArn = std::forward<RegionalCertificateArnT>(value);
  }
  template <typename RegionalCertificateArnT = Aws::String>
  DomainName& WithRegionalCertificateArn(RegionalCertificateArnT&& value) {
    SetRegionalCertificateArn(std::forward<RegionalCertificateArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDistributionDomainName(DistributionDomainNameT&& value) {
    ...
    m_distributionDomainName = std::forward<DistributionDomainNameT>(value);
  }
  template <typename DistributionDomainNameT = Aws::String>
  DomainName& WithDistributionDomainName(DistributionDomainNameT&& value) {
    SetDistributionDomainName(std::forward<DistributionDomainNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDistributionHostedZoneId(DistributionHostedZoneIdT&& value) {
    ...
    m_distributionHostedZoneId = std::forward<DistributionHostedZoneIdT>(value);
  }
  template <typename DistributionHostedZoneIdT = Aws::String>
  DomainName& WithDistributionHostedZoneId(DistributionHostedZoneIdT&& value) {
    SetDistributionHostedZoneId(std::forward<DistributionHostedZoneIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDomainNameStatus(DomainNameStatus value) {
    m_domainNameStatusHasBeenSet = true;
    m_domainNameStatus = value;
  }
  inline DomainName& WithDomainNameStatus(DomainNameStatus value) {
    SetDomainNameStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDomainNameStatusMessage(DomainNameStatusMessageT&& value) {
    ...
    m_domainNameStatusMessage = std::forward<DomainNameStatusMessageT>(value);
  }
  template <typename DomainNameStatusMessageT = Aws::String>
  DomainName& WithDomainNameStatusMessage(DomainNameStatusMessageT&& value) {
    SetDomainNameStatusMessage(std::forward<DomainNameStatusMessageT>(value));
    return *this;
  }
  ///@}
  ...
  inline DomainName& WithSecurityPolicy(SecurityPolicy value) {
  ...
  void SetMutualTlsAuthentication(MutualTlsAuthenticationT&& value) {
    ...
    m_mutualTlsAuthentication = std::forward<MutualTlsAuthenticationT>(value);
  }
  template <typename MutualTlsAuthenticationT = MutualTlsAuthentication>
  DomainName& WithMutualTlsAuthentication(MutualTlsAuthenticationT&& value) {
    SetMutualTlsAuthentication(std::forward<MutualTlsAuthenticationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOwnershipVerificationCertificateArn(OwnershipVerificationCertificateArnT&& value) {
    ...
    m_ownershipVerificationCertificateArn = std::forward<OwnershipVerificationCertificateArnT>(value);
  }
  template <typename OwnershipVerificationCertificateArnT = Aws::String>
  DomainName& WithOwnershipVerificationCertificateArn(OwnershipVerificationCertificateArnT&& value) {
    SetOwnershipVerificationCertificateArn(std::forward<OwnershipVerificationCertificateArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetManagementPolicy(ManagementPolicyT&& value) {
    ...
    m_managementPolicy = std::forward<ManagementPolicyT>(value);
  }
  template <typename ManagementPolicyT = Aws::String>
  DomainName& WithManagementPolicy(ManagementPolicyT&& value) {
    SetManagementPolicy(std::forward<ManagementPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRoutingMode(RoutingMode value) {
    m_routingModeHasBeenSet = true;
    m_routingMode = value;
  }
  inline DomainName& WithRoutingMode(RoutingMode value) {
