...
class GetAuthorizersResult {
 public:
  AWS_APIGATEWAY_API GetAuthorizersResult() = default;
  ...
  template <typename PositionT = Aws::String>
  GetAuthorizersResult& WithPosition(PositionT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<Authorizer>>
  void SetItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
    m_items = std::forward<ItemsT>(value);
  }
  template <typename ItemsT = Aws::Vector<Authorizer>>
  GetAuthorizersResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = Authorizer>
  GetAuthorizersResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetAuthorizersResult& WithRequestId(RequestIdT&& value) {
