 ...
 * API Reference</a></p>
 */
class UpdateResourceRequest : public APIGatewayRequest {
 public:
  AWS_APIGATEWAY_API UpdateResourceRequest() = default;
  ...
  template <typename RestApiIdT = Aws::String>
  UpdateResourceRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename PatchOperationsT = Aws::Vector<PatchOperation>>
  UpdateResourceRequest& WithPatchOperations(PatchOperationsT&& value) {
    SetPatchOperations(std::forward<PatchOperationsT>(value));
    return *this;
  }
  template <typename PatchOperationsT = PatchOperation>
  UpdateResourceRequest& AddPatchOperations(PatchOperationsT&& value) {
    m_patchOperationsHasBeenSet = true;
