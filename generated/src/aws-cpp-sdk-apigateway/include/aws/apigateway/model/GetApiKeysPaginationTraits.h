...
struct GetApiKeysPaginationTraits {
  using RequestType = Model::GetApiKeysRequest;
  using ResultType = Model::GetApiKeysResult;
  using OutcomeType = Model::GetApiKeysOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->GetApiKeys(request); }
