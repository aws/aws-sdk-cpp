...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API GetIntegrationResponseResult() = default;
    ...
    template<typename StatusCodeT = Aws::String>
    GetIntegrationResponseResult& WithStatusCode(StatusCodeT&& value) { SetStatusCode(std::forward<StatusCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename SelectionPatternT = Aws::String>
    GetIntegrationResponseResult& WithSelectionPattern(SelectionPatternT&& value) { SetSelectionPattern(std::forward<SelectionPatternT>(value)); return *this;}
    ///@}
