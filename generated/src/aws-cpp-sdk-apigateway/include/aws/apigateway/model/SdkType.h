...
class SdkType {
 public:
  ...
  template <typename FriendlyNameT = Aws::String>
  SdkType& WithFriendlyName(FriendlyNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  SdkType& WithDescription(DescriptionT&& value) {
  ...
  template <typename ConfigurationPropertiesT = Aws::Vector<SdkConfigurationProperty>>
  SdkType& WithConfigurationProperties(ConfigurationPropertiesT&& value) {
  ...
  SdkType& AddConfigurationProperties(ConfigurationPropertiesT&& value) {
    m_configurationPropertiesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  SdkType& WithRequestId(RequestIdT&& value) {
