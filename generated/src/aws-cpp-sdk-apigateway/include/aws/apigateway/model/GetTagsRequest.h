...
class GetTagsRequest : public APIGatewayRequest {
 public:
  AWS_APIGATEWAY_API GetTagsRequest() = default;
  ...
  template <typename ResourceArnT = Aws::String>
  GetTagsRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename PositionT = Aws::String>
  GetTagsRequest& WithPosition(PositionT&& value) {
  ...
  inline GetTagsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
