...
class GetDomainNameAccessAssociationsResult {
 public:
  ...
  AWS_APIGATEWAY_API GetDomainNameAccessAssociationsResult& operator=(
  ...
  template <typename PositionT = Aws::String>
  GetDomainNameAccessAssociationsResult& WithPosition(PositionT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<DomainNameAccessAssociation>>
  GetDomainNameAccessAssociationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DomainNameAccessAssociation>
  GetDomainNameAccessAssociationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetDomainNameAccessAssociationsResult& WithRequestId(RequestIdT&& value) {
