...
class PutIntegrationResponseResult {
 public:
  ...
  template <typename StatusCodeT = Aws::String>
  PutIntegrationResponseResult& WithStatusCode(StatusCodeT&& value) {
  ...
  template <typename SelectionPatternT = Aws::String>
  PutIntegrationResponseResult& WithSelectionPattern(SelectionPatternT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, Aws::String>>
  PutIntegrationResponseResult& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename ResponseTemplatesT = Aws::Map<Aws::String, Aws::String>>
  PutIntegrationResponseResult& WithResponseTemplates(ResponseTemplatesT&& value) {
  ...
  inline PutIntegrationResponseResult& WithContentHandling(ContentHandlingStrategy value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutIntegrationResponseResult& WithRequestId(RequestIdT&& value) {
