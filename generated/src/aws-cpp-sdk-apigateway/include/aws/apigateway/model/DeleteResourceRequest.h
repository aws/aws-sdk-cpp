...
class DeleteResourceRequest : public APIGatewayRequest {
 public:
  AWS_APIGATEWAY_API DeleteResourceRequest() = default;
  ...
  template <typename RestApiIdT = Aws::String>
  DeleteResourceRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  DeleteResourceRequest& WithResourceId(ResourceIdT&& value) {
