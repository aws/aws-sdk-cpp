...
namespace Model
{
  ...
  public:
    ...
    template<typename RestApiIdT = Aws::String>
    GetMethodRequest& WithRestApiId(RestApiIdT&& value) { SetRestApiId(std::forward<RestApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceIdT = Aws::String>
    GetMethodRequest& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpMethodT = Aws::String>
    GetMethodRequest& WithHttpMethod(HttpMethodT&& value) { SetHttpMethod(std::forward<HttpMethodT>(value)); return *this;}
    ///@}
  private:
