...
class UpdateDocumentationVersionRequest : public APIGatewayRequest {
 public:
  ...
  template <typename RestApiIdT = Aws::String>
  UpdateDocumentationVersionRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename DocumentationVersionT = Aws::String>
  UpdateDocumentationVersionRequest& WithDocumentationVersion(DocumentationVersionT&& value) {
  ...
  template <typename PatchOperationsT = Aws::Vector<PatchOperation>>
  UpdateDocumentationVersionRequest& WithPatchOperations(PatchOperationsT&& value) {
    SetPatchOperations(std::forward<PatchOperationsT>(value));
    return *this;
  }
  template <typename PatchOperationsT = PatchOperation>
  UpdateDocumentationVersionRequest& AddPatchOperations(PatchOperationsT&& value) {
    m_patchOperationsHasBeenSet = true;
