...
class CreateVpcLinkResult {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateVpcLinkResult& WithId(IdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateVpcLinkResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename TargetArnsT = Aws::Vector<Aws::String>>
  CreateVpcLinkResult& WithTargetArns(TargetArnsT&& value) {
    SetTargetArns(std::forward<TargetArnsT>(value));
    return *this;
  }
  template <typename TargetArnsT = Aws::String>
  CreateVpcLinkResult& AddTargetArns(TargetArnsT&& value) {
    m_targetArnsHasBeenSet = true;
  ...
  inline CreateVpcLinkResult& WithStatus(VpcLinkStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  CreateVpcLinkResult& WithStatusMessage(StatusMessageT&& value) {
