...
class GetStageResult {
 public:
  ...
  template <typename DeploymentIdT = Aws::String>
  GetStageResult& WithDeploymentId(DeploymentIdT&& value) {
  ...
  template <typename ClientCertificateIdT = Aws::String>
  GetStageResult& WithClientCertificateId(ClientCertificateIdT&& value) {
  ...
  template <typename StageNameT = Aws::String>
  GetStageResult& WithStageName(StageNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetStageResult& WithDescription(DescriptionT&& value) {
  ...
  inline GetStageResult& WithCacheClusterEnabled(bool value) {
  ...
  inline GetStageResult& WithCacheClusterSize(CacheClusterSize value) {
  ...
  inline GetStageResult& WithCacheClusterStatus(CacheClusterStatus value) {
  ...
  template <typename MethodSettingsT = Aws::Map<Aws::String, MethodSetting>>
  GetStageResult& WithMethodSettings(MethodSettingsT&& value) {
  ...
  template <typename VariablesT = Aws::Map<Aws::String, Aws::String>>
  GetStageResult& WithVariables(VariablesT&& value) {
  ...
  template <typename DocumentationVersionT = Aws::String>
  GetStageResult& WithDocumentationVersion(DocumentationVersionT&& value) {
  ...
  template <typename AccessLogSettingsT = AccessLogSettings>
  GetStageResult& WithAccessLogSettings(AccessLogSettingsT&& value) {
  ...
  template <typename CanarySettingsT = CanarySettings>
  GetStageResult& WithCanarySettings(CanarySettingsT&& value) {
  ...
  inline GetStageResult& WithTracingEnabled(bool value) {
  ...
  template <typename WebAclArnT = Aws::String>
  GetStageResult& WithWebAclArn(WebAclArnT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetStageResult& WithTags(TagsT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  GetStageResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename LastUpdatedDateT = Aws::Utils::DateTime>
  GetStageResult& WithLastUpdatedDate(LastUpdatedDateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetStageResult& WithRequestId(RequestIdT&& value) {
