...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API GetStageResult() = default;
    ...
    template<typename DeploymentIdT = Aws::String>
    GetStageResult& WithDeploymentId(DeploymentIdT&& value) { SetDeploymentId(std::forward<DeploymentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientCertificateIdT = Aws::String>
    GetStageResult& WithClientCertificateId(ClientCertificateIdT&& value) { SetClientCertificateId(std::forward<ClientCertificateIdT>(value)); return *this;}
    ///@}
    ...
    template<typename StageNameT = Aws::String>
    GetStageResult& WithStageName(StageNameT&& value) { SetStageName(std::forward<StageNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    GetStageResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename MethodSettingsT = Aws::Map<Aws::String, MethodSetting>>
    GetStageResult& WithMethodSettings(MethodSettingsT&& value) { SetMethodSettings(std::forward<MethodSettingsT>(value)); return *this;}
    template<typename MethodSettingsKeyT = Aws::String, typename MethodSettingsValueT = MethodSetting>
    GetStageResult& AddMethodSettings(MethodSettingsKeyT&& key, MethodSettingsValueT&& value) {
    ...
    template<typename VariablesT = Aws::Map<Aws::String, Aws::String>>
    GetStageResult& WithVariables(VariablesT&& value) { SetVariables(std::forward<VariablesT>(value)); return *this;}
    template<typename VariablesKeyT = Aws::String, typename VariablesValueT = Aws::String>
    GetStageResult& AddVariables(VariablesKeyT&& key, VariablesValueT&& value) {
    ...
    template<typename DocumentationVersionT = Aws::String>
    GetStageResult& WithDocumentationVersion(DocumentationVersionT&& value) { SetDocumentationVersion(std::forward<DocumentationVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessLogSettingsT = AccessLogSettings>
    GetStageResult& WithAccessLogSettings(AccessLogSettingsT&& value) { SetAccessLogSettings(std::forward<AccessLogSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename CanarySettingsT = CanarySettings>
    GetStageResult& WithCanarySettings(CanarySettingsT&& value) { SetCanarySettings(std::forward<CanarySettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename WebAclArnT = Aws::String>
    GetStageResult& WithWebAclArn(WebAclArnT&& value) { SetWebAclArn(std::forward<WebAclArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    GetStageResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    GetStageResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename CreatedDateT = Aws::Utils::DateTime>
    GetStageResult& WithCreatedDate(CreatedDateT&& value) { SetCreatedDate(std::forward<CreatedDateT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedDateT = Aws::Utils::DateTime>
    GetStageResult& WithLastUpdatedDate(LastUpdatedDateT&& value) { SetLastUpdatedDate(std::forward<LastUpdatedDateT>(value)); return *this;}
    ///@}
