...
class CreateResourceResult {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateResourceResult& WithId(IdT&& value) {
  ...
  template <typename ParentIdT = Aws::String>
  CreateResourceResult& WithParentId(ParentIdT&& value) {
  ...
  template <typename PathPartT = Aws::String>
  CreateResourceResult& WithPathPart(PathPartT&& value) {
  ...
  template <typename PathT = Aws::String>
  CreateResourceResult& WithPath(PathT&& value) {
  ...
  template <typename ResourceMethodsT = Aws::Map<Aws::String, Method>>
  CreateResourceResult& WithResourceMethods(ResourceMethodsT&& value) {
