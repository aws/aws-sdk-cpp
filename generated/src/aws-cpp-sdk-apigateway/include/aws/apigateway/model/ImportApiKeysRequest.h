...
class ImportApiKeysRequest : public StreamingAPIGatewayRequest {
 public:
  ...
  inline void SetFormat(ApiKeysFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline ImportApiKeysRequest& WithFormat(ApiKeysFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline ImportApiKeysRequest& WithFailOnWarnings(bool value) {
