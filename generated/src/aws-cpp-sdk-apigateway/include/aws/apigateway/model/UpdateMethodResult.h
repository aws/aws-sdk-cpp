...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API UpdateMethodResult() = default;
    ...
    template<typename HttpMethodT = Aws::String>
    UpdateMethodResult& WithHttpMethod(HttpMethodT&& value) { SetHttpMethod(std::forward<HttpMethodT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizationTypeT = Aws::String>
    UpdateMethodResult& WithAuthorizationType(AuthorizationTypeT&& value) { SetAuthorizationType(std::forward<AuthorizationTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizerIdT = Aws::String>
    UpdateMethodResult& WithAuthorizerId(AuthorizerIdT&& value) { SetAuthorizerId(std::forward<AuthorizerIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestValidatorIdT = Aws::String>
    UpdateMethodResult& WithRequestValidatorId(RequestValidatorIdT&& value) { SetRequestValidatorId(std::forward<RequestValidatorIdT>(value)); return *this;}
    ///@}
    ...
    template<typename OperationNameT = Aws::String>
    UpdateMethodResult& WithOperationName(OperationNameT&& value) { SetOperationName(std::forward<OperationNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestParametersT = Aws::Map<Aws::String, bool>>
    UpdateMethodResult& WithRequestParameters(RequestParametersT&& value) { SetRequestParameters(std::forward<RequestParametersT>(value)); return *this;}
    inline UpdateMethodResult& AddRequestParameters(Aws::String key, bool value) {
    ...
    template<typename RequestModelsT = Aws::Map<Aws::String, Aws::String>>
    UpdateMethodResult& WithRequestModels(RequestModelsT&& value) { SetRequestModels(std::forward<RequestModelsT>(value)); return *this;}
    template<typename RequestModelsKeyT = Aws::String, typename RequestModelsValueT = Aws::String>
    UpdateMethodResult& AddRequestModels(RequestModelsKeyT&& key, RequestModelsValueT&& value) {
    ...
    template<typename MethodResponsesT = Aws::Map<Aws::String, MethodResponse>>
    UpdateMethodResult& WithMethodResponses(MethodResponsesT&& value) { SetMethodResponses(std::forward<MethodResponsesT>(value)); return *this;}
    template<typename MethodResponsesKeyT = Aws::String, typename MethodResponsesValueT = MethodResponse>
    UpdateMethodResult& AddMethodResponses(MethodResponsesKeyT&& key, MethodResponsesValueT&& value) {
    ...
    template<typename MethodIntegrationT = Integration>
    UpdateMethodResult& WithMethodIntegration(MethodIntegrationT&& value) { SetMethodIntegration(std::forward<MethodIntegrationT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizationScopesT = Aws::Vector<Aws::String>>
    UpdateMethodResult& WithAuthorizationScopes(AuthorizationScopesT&& value) { SetAuthorizationScopes(std::forward<AuthorizationScopesT>(value)); return *this;}
    template<typename AuthorizationScopesT = Aws::String>
    UpdateMethodResult& AddAuthorizationScopes(AuthorizationScopesT&& value) { m_authorizationScopesHasBeenSet = true; m_authorizationScopes.emplace_back(std::forward<AuthorizationScopesT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateMethodResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
