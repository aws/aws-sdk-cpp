...
class DeleteIntegrationRequest : public APIGatewayRequest {
 public:
  ...
  template <typename RestApiIdT = Aws::String>
  DeleteIntegrationRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  DeleteIntegrationRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename HttpMethodT = Aws::String>
  DeleteIntegrationRequest& WithHttpMethod(HttpMethodT&& value) {
