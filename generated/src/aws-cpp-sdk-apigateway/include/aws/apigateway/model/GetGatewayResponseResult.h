...
class GetGatewayResponseResult {
 public:
  ...
  inline GetGatewayResponseResult& WithResponseType(GatewayResponseType value) {
  ...
  template <typename StatusCodeT = Aws::String>
  GetGatewayResponseResult& WithStatusCode(StatusCodeT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, Aws::String>>
  GetGatewayResponseResult& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename ResponseTemplatesT = Aws::Map<Aws::String, Aws::String>>
  GetGatewayResponseResult& WithResponseTemplates(ResponseTemplatesT&& value) {
  ...
  inline GetGatewayResponseResult& WithDefaultResponse(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetGatewayResponseResult& WithRequestId(RequestIdT&& value) {
