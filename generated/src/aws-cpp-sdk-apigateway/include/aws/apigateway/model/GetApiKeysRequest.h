...
class GetApiKeysRequest : public APIGatewayRequest {
 public:
  ...
  inline GetApiKeysRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeValues(bool value) {
    m_includeValuesHasBeenSet = true;
    m_includeValues = value;
  }
  inline GetApiKeysRequest& WithIncludeValues(bool value) {
    SetIncludeValues(value);
    return *this;
  }
  ///@}
 private:
