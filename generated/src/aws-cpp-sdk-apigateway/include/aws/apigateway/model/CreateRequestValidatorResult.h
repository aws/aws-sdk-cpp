...
class CreateRequestValidatorResult {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateRequestValidatorResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateRequestValidatorResult& WithName(NameT&& value) {
  ...
  inline CreateRequestValidatorResult& WithValidateRequestBody(bool value) {
  ...
  inline CreateRequestValidatorResult& WithValidateRequestParameters(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRequestValidatorResult& WithRequestId(RequestIdT&& value) {
