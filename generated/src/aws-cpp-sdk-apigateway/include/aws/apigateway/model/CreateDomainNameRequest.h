...
class CreateDomainNameRequest : public APIGatewayRequest {
 public:
  ...
  void SetCertificatePrivateKey(CertificatePrivateKeyT&& value) {
    ...
    m_certificatePrivateKey = std::forward<CertificatePrivateKeyT>(value);
  }
  template <typename CertificatePrivateKeyT = Aws::String>
  CreateDomainNameRequest& WithCertificatePrivateKey(CertificatePrivateKeyT&& value) {
    SetCertificatePrivateKey(std::forward<CertificatePrivateKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateDomainNameRequest& WithRoutingMode(RoutingMode value) {
