...
class UpdateRestApiRequest : public APIGatewayRequest {
 public:
  ...
  template <typename RestApiIdT = Aws::String>
  UpdateRestApiRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename PatchOperationsT = Aws::Vector<PatchOperation>>
  UpdateRestApiRequest& WithPatchOperations(PatchOperationsT&& value) {
    SetPatchOperations(std::forward<PatchOperationsT>(value));
    return *this;
  }
  template <typename PatchOperationsT = PatchOperation>
  UpdateRestApiRequest& AddPatchOperations(PatchOperationsT&& value) {
    m_patchOperationsHasBeenSet = true;
