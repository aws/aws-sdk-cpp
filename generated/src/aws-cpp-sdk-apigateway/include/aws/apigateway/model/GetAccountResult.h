...
class GetAccountResult {
 public:
  ...
  void SetCloudwatchRoleArn(CloudwatchRoleArnT&& value) {
    ...
    m_cloudwatchRoleArn = std::forward<CloudwatchRoleArnT>(value);
  }
  template <typename CloudwatchRoleArnT = Aws::String>
  GetAccountResult& WithCloudwatchRoleArn(CloudwatchRoleArnT&& value) {
    SetCloudwatchRoleArn(std::forward<CloudwatchRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThrottleSettings(ThrottleSettingsT&& value) {
    ...
    m_throttleSettings = std::forward<ThrottleSettingsT>(value);
  }
  template <typename ThrottleSettingsT = ThrottleSettings>
  GetAccountResult& WithThrottleSettings(ThrottleSettingsT&& value) {
    SetThrottleSettings(std::forward<ThrottleSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApiKeyVersion(ApiKeyVersionT&& value) {
    ...
    m_apiKeyVersion = std::forward<ApiKeyVersionT>(value);
  }
  template <typename ApiKeyVersionT = Aws::String>
  GetAccountResult& WithApiKeyVersion(ApiKeyVersionT&& value) {
    SetApiKeyVersion(std::forward<ApiKeyVersionT>(value));
    return *this;
  }
  ///@}
