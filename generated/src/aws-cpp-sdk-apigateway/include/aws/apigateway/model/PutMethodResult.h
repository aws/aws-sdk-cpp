...
class PutMethodResult {
 public:
  AWS_APIGATEWAY_API PutMethodResult() = default;
  AWS_APIGATEWAY_API PutMethodResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_APIGATEWAY_API PutMethodResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename HttpMethodT = Aws::String>
  PutMethodResult& WithHttpMethod(HttpMethodT&& value) {
  ...
  template <typename AuthorizationTypeT = Aws::String>
  PutMethodResult& WithAuthorizationType(AuthorizationTypeT&& value) {
  ...
  template <typename AuthorizerIdT = Aws::String>
  PutMethodResult& WithAuthorizerId(AuthorizerIdT&& value) {
  ...
  inline PutMethodResult& WithApiKeyRequired(bool value) {
  ...
  template <typename RequestValidatorIdT = Aws::String>
  PutMethodResult& WithRequestValidatorId(RequestValidatorIdT&& value) {
  ...
  template <typename OperationNameT = Aws::String>
  PutMethodResult& WithOperationName(OperationNameT&& value) {
  ...
  template <typename RequestParametersT = Aws::Map<Aws::String, bool>>
  PutMethodResult& WithRequestParameters(RequestParametersT&& value) {
    SetRequestParameters(std::forward<RequestParametersT>(value));
    return *this;
  }
  inline PutMethodResult& AddRequestParameters(Aws::String key, bool value) {
    m_requestParametersHasBeenSet = true;
  ...
  template <typename RequestModelsT = Aws::Map<Aws::String, Aws::String>>
  PutMethodResult& WithRequestModels(RequestModelsT&& value) {
  ...
  PutMethodResult& AddRequestModels(RequestModelsKeyT&& key, RequestModelsValueT&& value) {
    m_requestModelsHasBeenSet = true;
  ...
  template <typename MethodResponsesT = Aws::Map<Aws::String, MethodResponse>>
  PutMethodResult& WithMethodResponses(MethodResponsesT&& value) {
  ...
  PutMethodResult& AddMethodResponses(MethodResponsesKeyT&& key, MethodResponsesValueT&& value) {
    m_methodResponsesHasBeenSet = true;
  ...
  template <typename MethodIntegrationT = Integration>
  PutMethodResult& WithMethodIntegration(MethodIntegrationT&& value) {
  ...
  template <typename AuthorizationScopesT = Aws::Vector<Aws::String>>
  PutMethodResult& WithAuthorizationScopes(AuthorizationScopesT&& value) {
    SetAuthorizationScopes(std::forward<AuthorizationScopesT>(value));
    return *this;
  }
  template <typename AuthorizationScopesT = Aws::String>
  PutMethodResult& AddAuthorizationScopes(AuthorizationScopesT&& value) {
    m_authorizationScopesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  PutMethodResult& WithRequestId(RequestIdT&& value) {
