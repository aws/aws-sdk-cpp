...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API PutMethodResult();
    ...
    inline PutMethodResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutMethodResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutMethodResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
