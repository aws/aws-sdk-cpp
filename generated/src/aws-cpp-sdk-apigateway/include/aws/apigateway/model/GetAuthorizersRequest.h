...
class GetAuthorizersRequest : public APIGatewayRequest {
 public:
  AWS_APIGATEWAY_API GetAuthorizersRequest() = default;
  ...
  template <typename RestApiIdT = Aws::String>
  GetAuthorizersRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename PositionT = Aws::String>
  GetAuthorizersRequest& WithPosition(PositionT&& value) {
  ...
  inline GetAuthorizersRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
