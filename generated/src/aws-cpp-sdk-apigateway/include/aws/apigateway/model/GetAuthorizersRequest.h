...
namespace Model
{
  ...
  public:
    ...
    template<typename RestApiIdT = Aws::String>
    GetAuthorizersRequest& WithRestApiId(RestApiIdT&& value) { SetRestApiId(std::forward<RestApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PositionT = Aws::String>
    GetAuthorizersRequest& WithPosition(PositionT&& value) { SetPosition(std::forward<PositionT>(value)); return *this;}
    ///@}
