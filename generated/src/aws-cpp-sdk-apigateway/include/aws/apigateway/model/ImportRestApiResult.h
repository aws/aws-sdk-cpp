...
class ImportRestApiResult {
 public:
  ...
  inline ImportRestApiResult& WithMinimumCompressionSize(int value) {
  ...
  inline ImportRestApiResult& WithApiKeySource(ApiKeySourceType value) {
  ...
  inline ImportRestApiResult& WithDisableExecuteApiEndpoint(bool value) {
  ...
  inline ImportRestApiResult& WithSecurityPolicy(SecurityPolicy value) {
  ...
  inline ImportRestApiResult& WithEndpointAccessMode(EndpointAccessMode value) {
  ...
  inline ImportRestApiResult& WithApiStatus(ApiStatus value) {
    SetApiStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ApiStatusMessageT = Aws::String>
  ImportRestApiResult& WithApiStatusMessage(ApiStatusMessageT&& value) {
