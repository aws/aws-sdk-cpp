...
class PutMethodResponseResult {
 public:
  ...
  template <typename StatusCodeT = Aws::String>
  PutMethodResponseResult& WithStatusCode(StatusCodeT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, bool>>
  PutMethodResponseResult& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
  PutMethodResponseResult& WithResponseModels(ResponseModelsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutMethodResponseResult& WithRequestId(RequestIdT&& value) {
