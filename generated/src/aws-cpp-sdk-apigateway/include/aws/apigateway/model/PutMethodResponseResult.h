...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API PutMethodResponseResult() = default;
    ...
    template<typename StatusCodeT = Aws::String>
    PutMethodResponseResult& WithStatusCode(StatusCodeT&& value) { SetStatusCode(std::forward<StatusCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseParametersT = Aws::Map<Aws::String, bool>>
    PutMethodResponseResult& WithResponseParameters(ResponseParametersT&& value) { SetResponseParameters(std::forward<ResponseParametersT>(value)); return *this;}
    inline PutMethodResponseResult& AddResponseParameters(Aws::String key, bool value) {
    ...
    template<typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
    PutMethodResponseResult& WithResponseModels(ResponseModelsT&& value) { SetResponseModels(std::forward<ResponseModelsT>(value)); return *this;}
    template<typename ResponseModelsKeyT = Aws::String, typename ResponseModelsValueT = Aws::String>
    PutMethodResponseResult& AddResponseModels(ResponseModelsKeyT&& key, ResponseModelsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    PutMethodResponseResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
