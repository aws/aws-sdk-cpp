...
class QuotaSettings {
 public:
  ...
  inline QuotaSettings& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  inline QuotaSettings& WithOffset(int value) {
    SetOffset(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPeriod(QuotaPeriodType value) {
    m_periodHasBeenSet = true;
    m_period = value;
  }
  inline QuotaSettings& WithPeriod(QuotaPeriodType value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
