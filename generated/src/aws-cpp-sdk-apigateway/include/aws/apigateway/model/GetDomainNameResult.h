...
class GetDomainNameResult {
 public:
  ...
  inline GetDomainNameResult& WithDomainNameStatus(DomainNameStatus value) {
  ...
  inline GetDomainNameResult& WithSecurityPolicy(SecurityPolicy value) {
  ...
  inline GetDomainNameResult& WithEndpointAccessMode(EndpointAccessMode value) {
