...
namespace Model
{
  ...
  public:
    ...
    inline GetDomainNameResult& WithDomainNameId(const Aws::String& value) { SetDomainNameId(value); return *this;}
    inline GetDomainNameResult& WithDomainNameId(Aws::String&& value) { SetDomainNameId(std::move(value)); return *this;}
    inline GetDomainNameResult& WithDomainNameId(const char* value) { SetDomainNameId(value); return *this;}
    ///@}
    ...
    inline GetDomainNameResult& WithDomainNameArn(const Aws::String& value) { SetDomainNameArn(value); return *this;}
    inline GetDomainNameResult& WithDomainNameArn(Aws::String&& value) { SetDomainNameArn(std::move(value)); return *this;}
    inline GetDomainNameResult& WithDomainNameArn(const char* value) { SetDomainNameArn(value); return *this;}
    ///@}
    ...
    inline GetDomainNameResult& WithManagementPolicy(const Aws::String& value) { SetManagementPolicy(value); return *this;}
    inline GetDomainNameResult& WithManagementPolicy(Aws::String&& value) { SetManagementPolicy(std::move(value)); return *this;}
    inline GetDomainNameResult& WithManagementPolicy(const char* value) { SetManagementPolicy(value); return *this;}
    ///@}
    ...
    inline GetDomainNameResult& WithPolicy(const Aws::String& value) { SetPolicy(value); return *this;}
    inline GetDomainNameResult& WithPolicy(Aws::String&& value) { SetPolicy(std::move(value)); return *this;}
    inline GetDomainNameResult& WithPolicy(const char* value) { SetPolicy(value); return *this;}
    ///@}
