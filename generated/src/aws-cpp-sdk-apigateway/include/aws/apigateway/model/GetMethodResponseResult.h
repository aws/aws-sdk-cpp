...
class GetMethodResponseResult {
 public:
  ...
  template <typename StatusCodeT = Aws::String>
  GetMethodResponseResult& WithStatusCode(StatusCodeT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, bool>>
  GetMethodResponseResult& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
  GetMethodResponseResult& WithResponseModels(ResponseModelsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetMethodResponseResult& WithRequestId(RequestIdT&& value) {
