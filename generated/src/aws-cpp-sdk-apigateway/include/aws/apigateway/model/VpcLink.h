...
class VpcLink {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  VpcLink& WithDescription(DescriptionT&& value) {
  ...
  inline VpcLink& WithStatus(VpcLinkStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  VpcLink& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  VpcLink& WithRequestId(RequestIdT&& value) {
