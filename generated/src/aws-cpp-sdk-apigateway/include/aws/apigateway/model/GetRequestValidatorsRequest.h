...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetRequestValidatorsRequest : public APIGatewayRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetRequestValidators"; }
    ...
    template<typename RestApiIdT = Aws::String>
    GetRequestValidatorsRequest& WithRestApiId(RestApiIdT&& value) { SetRestApiId(std::forward<RestApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PositionT = Aws::String>
    GetRequestValidatorsRequest& WithPosition(PositionT&& value) { SetPosition(std::forward<PositionT>(value)); return *this;}
    ///@}
