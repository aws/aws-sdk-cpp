...
class GetDeploymentsRequest : public APIGatewayRequest {
 public:
  ...
  template <typename RestApiIdT = Aws::String>
  GetDeploymentsRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename PositionT = Aws::String>
  GetDeploymentsRequest& WithPosition(PositionT&& value) {
  ...
  inline GetDeploymentsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
