...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API GetDeploymentsRequest() = default;
    ...
    template<typename RestApiIdT = Aws::String>
    GetDeploymentsRequest& WithRestApiId(RestApiIdT&& value) { SetRestApiId(std::forward<RestApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PositionT = Aws::String>
    GetDeploymentsRequest& WithPosition(PositionT&& value) { SetPosition(std::forward<PositionT>(value)); return *this;}
    ///@}
