...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API UpdateGatewayResponseResult() = default;
    ...
    inline UpdateGatewayResponseResult& WithResponseType(GatewayResponseType value) { SetResponseType(value); return *this;}
    ///@}
    ...
    template<typename StatusCodeT = Aws::String>
    UpdateGatewayResponseResult& WithStatusCode(StatusCodeT&& value) { SetStatusCode(std::forward<StatusCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseParametersT = Aws::Map<Aws::String, Aws::String>>
    UpdateGatewayResponseResult& WithResponseParameters(ResponseParametersT&& value) { SetResponseParameters(std::forward<ResponseParametersT>(value)); return *this;}
    template<typename ResponseParametersKeyT = Aws::String, typename ResponseParametersValueT = Aws::String>
    UpdateGatewayResponseResult& AddResponseParameters(ResponseParametersKeyT&& key, ResponseParametersValueT&& value) {
    ...
    template<typename ResponseTemplatesT = Aws::Map<Aws::String, Aws::String>>
    UpdateGatewayResponseResult& WithResponseTemplates(ResponseTemplatesT&& value) { SetResponseTemplates(std::forward<ResponseTemplatesT>(value)); return *this;}
    template<typename ResponseTemplatesKeyT = Aws::String, typename ResponseTemplatesValueT = Aws::String>
    UpdateGatewayResponseResult& AddResponseTemplates(ResponseTemplatesKeyT&& key, ResponseTemplatesValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    UpdateGatewayResponseResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
