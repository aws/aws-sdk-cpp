...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    GetAuthorizerResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ProviderARNsT = Aws::Vector<Aws::String>>
    GetAuthorizerResult& WithProviderARNs(ProviderARNsT&& value) { SetProviderARNs(std::forward<ProviderARNsT>(value)); return *this;}
    template<typename ProviderARNsT = Aws::String>
    GetAuthorizerResult& AddProviderARNs(ProviderARNsT&& value) { m_providerARNsHasBeenSet = true; m_providerARNs.emplace_back(std::forward<ProviderARNsT>(value)); return *this; }
    ///@}
    ...
    template<typename AuthTypeT = Aws::String>
    GetAuthorizerResult& WithAuthType(AuthTypeT&& value) { SetAuthType(std::forward<AuthTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizerCredentialsT = Aws::String>
    GetAuthorizerResult& WithAuthorizerCredentials(AuthorizerCredentialsT&& value) { SetAuthorizerCredentials(std::forward<AuthorizerCredentialsT>(value)); return *this;}
    ///@}
