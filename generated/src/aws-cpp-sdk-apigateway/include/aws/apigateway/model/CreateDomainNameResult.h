...
class CreateDomainNameResult {
 public:
  ...
  template <typename DomainNameIdT = Aws::String>
  CreateDomainNameResult& WithDomainNameId(DomainNameIdT&& value) {
  ...
  template <typename CertificateNameT = Aws::String>
  CreateDomainNameResult& WithCertificateName(CertificateNameT&& value) {
  ...
  template <typename CertificateArnT = Aws::String>
  CreateDomainNameResult& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename CertificateUploadDateT = Aws::Utils::DateTime>
  CreateDomainNameResult& WithCertificateUploadDate(CertificateUploadDateT&& value) {
  ...
  template <typename RegionalDomainNameT = Aws::String>
  CreateDomainNameResult& WithRegionalDomainName(RegionalDomainNameT&& value) {
  ...
  template <typename RegionalHostedZoneIdT = Aws::String>
  CreateDomainNameResult& WithRegionalHostedZoneId(RegionalHostedZoneIdT&& value) {
  ...
  template <typename RegionalCertificateNameT = Aws::String>
  CreateDomainNameResult& WithRegionalCertificateName(RegionalCertificateNameT&& value) {
  ...
  template <typename RegionalCertificateArnT = Aws::String>
  CreateDomainNameResult& WithRegionalCertificateArn(RegionalCertificateArnT&& value) {
  ...
  template <typename DistributionDomainNameT = Aws::String>
  CreateDomainNameResult& WithDistributionDomainName(DistributionDomainNameT&& value) {
  ...
  template <typename DistributionHostedZoneIdT = Aws::String>
  CreateDomainNameResult& WithDistributionHostedZoneId(DistributionHostedZoneIdT&& value) {
  ...
  template <typename EndpointConfigurationT = EndpointConfiguration>
  CreateDomainNameResult& WithEndpointConfiguration(EndpointConfigurationT&& value) {
  ...
  inline CreateDomainNameResult& WithDomainNameStatus(DomainNameStatus value) {
  ...
  template <typename DomainNameStatusMessageT = Aws::String>
  CreateDomainNameResult& WithDomainNameStatusMessage(DomainNameStatusMessageT&& value) {
  ...
  inline CreateDomainNameResult& WithSecurityPolicy(SecurityPolicy value) {
  ...
  template <typename OwnershipVerificationCertificateArnT = Aws::String>
  CreateDomainNameResult& WithOwnershipVerificationCertificateArn(OwnershipVerificationCertificateArnT&& value) {
  ...
  template <typename ManagementPolicyT = Aws::String>
  CreateDomainNameResult& WithManagementPolicy(ManagementPolicyT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  CreateDomainNameResult& WithPolicy(PolicyT&& value) {
  ...
  inline CreateDomainNameResult& WithRoutingMode(RoutingMode value) {
