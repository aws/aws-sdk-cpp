...
class CreateUsagePlanResult {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateUsagePlanResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateUsagePlanResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateUsagePlanResult& WithDescription(DescriptionT&& value) {
  ...
  void SetApiStages(ApiStagesT&& value) {
    ...
    m_apiStages = std::forward<ApiStagesT>(value);
  }
  template <typename ApiStagesT = Aws::Vector<ApiStage>>
  CreateUsagePlanResult& WithApiStages(ApiStagesT&& value) {
    SetApiStages(std::forward<ApiStagesT>(value));
    return *this;
  }
  template <typename ApiStagesT = ApiStage>
  CreateUsagePlanResult& AddApiStages(ApiStagesT&& value) {
    m_apiStagesHasBeenSet = true;
    m_apiStages.emplace_back(std::forward<ApiStagesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThrottle(ThrottleT&& value) {
    ...
    m_throttle = std::forward<ThrottleT>(value);
  }
  template <typename ThrottleT = ThrottleSettings>
  CreateUsagePlanResult& WithThrottle(ThrottleT&& value) {
    SetThrottle(std::forward<ThrottleT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename QuotaT = QuotaSettings>
  CreateUsagePlanResult& WithQuota(QuotaT&& value) {
  ...
  template <typename ProductCodeT = Aws::String>
  CreateUsagePlanResult& WithProductCode(ProductCodeT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateUsagePlanResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateUsagePlanResult& WithRequestId(RequestIdT&& value) {
