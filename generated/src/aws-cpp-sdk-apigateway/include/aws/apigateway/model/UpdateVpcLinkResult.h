...
class UpdateVpcLinkResult {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateVpcLinkResult& WithId(IdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateVpcLinkResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename TargetArnsT = Aws::Vector<Aws::String>>
  UpdateVpcLinkResult& WithTargetArns(TargetArnsT&& value) {
    SetTargetArns(std::forward<TargetArnsT>(value));
    return *this;
  }
  template <typename TargetArnsT = Aws::String>
  UpdateVpcLinkResult& AddTargetArns(TargetArnsT&& value) {
    m_targetArnsHasBeenSet = true;
  ...
  inline UpdateVpcLinkResult& WithStatus(VpcLinkStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  UpdateVpcLinkResult& WithStatusMessage(StatusMessageT&& value) {
