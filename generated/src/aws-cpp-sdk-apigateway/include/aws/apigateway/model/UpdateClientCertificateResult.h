...
class UpdateClientCertificateResult {
 public:
  AWS_APIGATEWAY_API UpdateClientCertificateResult() = default;
  ...
  template <typename ClientCertificateIdT = Aws::String>
  UpdateClientCertificateResult& WithClientCertificateId(ClientCertificateIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateClientCertificateResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename PemEncodedCertificateT = Aws::String>
  UpdateClientCertificateResult& WithPemEncodedCertificate(PemEncodedCertificateT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  UpdateClientCertificateResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename ExpirationDateT = Aws::Utils::DateTime>
  UpdateClientCertificateResult& WithExpirationDate(ExpirationDateT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateClientCertificateResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  UpdateClientCertificateResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateClientCertificateResult& WithRequestId(RequestIdT&& value) {
