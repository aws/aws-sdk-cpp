...
class IntegrationResponse {
 public:
  AWS_APIGATEWAY_API IntegrationResponse() = default;
  ...
  template <typename StatusCodeT = Aws::String>
  IntegrationResponse& WithStatusCode(StatusCodeT&& value) {
  ...
  void SetSelectionPattern(SelectionPatternT&& value) {
    m_selectionPatternHasBeenSet = true;
    m_selectionPattern = std::forward<SelectionPatternT>(value);
  }
  template <typename SelectionPatternT = Aws::String>
  IntegrationResponse& WithSelectionPattern(SelectionPatternT&& value) {
    SetSelectionPattern(std::forward<SelectionPatternT>(value));
    return *this;
  }
  ///@}
  ...
  inline IntegrationResponse& WithContentHandling(ContentHandlingStrategy value) {
  ...
  template <typename RequestIdT = Aws::String>
  IntegrationResponse& WithRequestId(RequestIdT&& value) {
