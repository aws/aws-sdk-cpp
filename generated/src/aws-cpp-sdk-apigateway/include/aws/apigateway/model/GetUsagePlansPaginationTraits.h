...
struct GetUsagePlansPaginationTraits {
  using RequestType = Model::GetUsagePlansRequest;
  using ResultType = Model::GetUsagePlansResult;
  using OutcomeType = Model::GetUsagePlansOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->GetUsagePlans(request); }
