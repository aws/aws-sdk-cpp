...
class GetUsagePlanKeysResult {
 public:
  ...
  template <typename PositionT = Aws::String>
  GetUsagePlanKeysResult& WithPosition(PositionT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<UsagePlanKey>>
  GetUsagePlanKeysResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = UsagePlanKey>
  GetUsagePlanKeysResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetUsagePlanKeysResult& WithRequestId(RequestIdT&& value) {
