...
class GetExportRequest : public APIGatewayRequest {
 public:
  ...
  void SetExportType(ExportTypeT&& value) {
    ...
    m_exportType = std::forward<ExportTypeT>(value);
  }
  template <typename ExportTypeT = Aws::String>
  GetExportRequest& WithExportType(ExportTypeT&& value) {
    SetExportType(std::forward<ExportTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccepts(AcceptsT&& value) {
    m_acceptsHasBeenSet = true;
    m_accepts = std::forward<AcceptsT>(value);
  }
  template <typename AcceptsT = Aws::String>
  GetExportRequest& WithAccepts(AcceptsT&& value) {
    SetAccepts(std::forward<AcceptsT>(value));
    return *this;
  }
  ///@}
 private:
