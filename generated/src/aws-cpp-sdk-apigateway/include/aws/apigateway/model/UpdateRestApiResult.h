...
class UpdateRestApiResult {
 public:
  ...
  inline UpdateRestApiResult& WithMinimumCompressionSize(int value) {
  ...
  inline UpdateRestApiResult& WithApiKeySource(ApiKeySourceType value) {
  ...
  inline UpdateRestApiResult& WithDisableExecuteApiEndpoint(bool value) {
