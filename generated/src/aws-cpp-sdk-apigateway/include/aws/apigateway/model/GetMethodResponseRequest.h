...
class GetMethodResponseRequest : public APIGatewayRequest {
 public:
  ...
  template <typename RestApiIdT = Aws::String>
  GetMethodResponseRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  GetMethodResponseRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename HttpMethodT = Aws::String>
  GetMethodResponseRequest& WithHttpMethod(HttpMethodT&& value) {
  ...
  template <typename StatusCodeT = Aws::String>
  GetMethodResponseRequest& WithStatusCode(StatusCodeT&& value) {
