...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API GetMethodResponseRequest() = default;
    ...
    template<typename RestApiIdT = Aws::String>
    GetMethodResponseRequest& WithRestApiId(RestApiIdT&& value) { SetRestApiId(std::forward<RestApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceIdT = Aws::String>
    GetMethodResponseRequest& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpMethodT = Aws::String>
    GetMethodResponseRequest& WithHttpMethod(HttpMethodT&& value) { SetHttpMethod(std::forward<HttpMethodT>(value)); return *this;}
    ///@}
    ...
    template<typename StatusCodeT = Aws::String>
    GetMethodResponseRequest& WithStatusCode(StatusCodeT&& value) { SetStatusCode(std::forward<StatusCodeT>(value)); return *this;}
    ///@}
  private:
