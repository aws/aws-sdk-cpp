...
namespace Model
{
  ...
  public:
    ...
    template<typename HttpMethodT = Aws::String>
    UpdateIntegrationResult& WithHttpMethod(HttpMethodT&& value) { SetHttpMethod(std::forward<HttpMethodT>(value)); return *this;}
    ///@}
    ...
    template<typename UriT = Aws::String>
    UpdateIntegrationResult& WithUri(UriT&& value) { SetUri(std::forward<UriT>(value)); return *this;}
    ///@}
    ...
    template<typename CredentialsT = Aws::String>
    UpdateIntegrationResult& WithCredentials(CredentialsT&& value) { SetCredentials(std::forward<CredentialsT>(value)); return *this;}
    ///@}
    ...
    template<typename PassthroughBehaviorT = Aws::String>
    UpdateIntegrationResult& WithPassthroughBehavior(PassthroughBehaviorT&& value) { SetPassthroughBehavior(std::forward<PassthroughBehaviorT>(value)); return *this;}
    ///@}
    ...
    template<typename CacheNamespaceT = Aws::String>
    UpdateIntegrationResult& WithCacheNamespace(CacheNamespaceT&& value) { SetCacheNamespace(std::forward<CacheNamespaceT>(value)); return *this;}
    ///@}
    ...
    template<typename CacheKeyParametersT = Aws::Vector<Aws::String>>
    UpdateIntegrationResult& WithCacheKeyParameters(CacheKeyParametersT&& value) { SetCacheKeyParameters(std::forward<CacheKeyParametersT>(value)); return *this;}
    template<typename CacheKeyParametersT = Aws::String>
    UpdateIntegrationResult& AddCacheKeyParameters(CacheKeyParametersT&& value) { m_cacheKeyParametersHasBeenSet = true; m_cacheKeyParameters.emplace_back(std::forward<CacheKeyParametersT>(value)); return *this; }
    ///@}
    ...
    template<typename IntegrationResponsesT = Aws::Map<Aws::String, IntegrationResponse>>
    UpdateIntegrationResult& WithIntegrationResponses(IntegrationResponsesT&& value) { SetIntegrationResponses(std::forward<IntegrationResponsesT>(value)); return *this;}
