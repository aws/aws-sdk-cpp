...
class UpdateIntegrationResult {
 public:
  ...
  inline UpdateIntegrationResult& WithType(IntegrationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateIntegrationResult& WithContentHandling(ContentHandlingStrategy value) {
  ...
  inline UpdateIntegrationResult& WithResponseTransferMode(ResponseTransferMode value) {
