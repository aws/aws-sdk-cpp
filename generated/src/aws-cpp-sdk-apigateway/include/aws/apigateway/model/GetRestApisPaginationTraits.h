...
struct GetRestApisPaginationTraits {
  using RequestType = Model::GetRestApisRequest;
  using ResultType = Model::GetRestApisResult;
  using OutcomeType = Model::GetRestApisOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->GetRestApis(request); }
