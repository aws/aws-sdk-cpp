...
namespace Model
{
  ...
  public:
    ...
    template<typename UsagePlanIdT = Aws::String>
    UpdateUsageResult& WithUsagePlanId(UsagePlanIdT&& value) { SetUsagePlanId(std::forward<UsagePlanIdT>(value)); return *this;}
    ///@}
    ...
    template<typename StartDateT = Aws::String>
    UpdateUsageResult& WithStartDate(StartDateT&& value) { SetStartDate(std::forward<StartDateT>(value)); return *this;}
    ///@}
    ...
    template<typename EndDateT = Aws::String>
    UpdateUsageResult& WithEndDate(EndDateT&& value) { SetEndDate(std::forward<EndDateT>(value)); return *this;}
    ///@}
    ...
    template<typename PositionT = Aws::String>
    UpdateUsageResult& WithPosition(PositionT&& value) { SetPosition(std::forward<PositionT>(value)); return *this;}
    ///@}
    ...
    template<typename ItemsT = Aws::Map<Aws::String, Aws::Vector<Aws::Vector<long long>>>>
    UpdateUsageResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateUsageResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
