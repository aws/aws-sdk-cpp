...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetVpcLinksRequest : public APIGatewayRequest
  {
  public:
    AWS_APIGATEWAY_API GetVpcLinksRequest() = default;
    ...
    template<typename PositionT = Aws::String>
    GetVpcLinksRequest& WithPosition(PositionT&& value) { SetPosition(std::forward<PositionT>(value)); return *this;}
    ///@}
