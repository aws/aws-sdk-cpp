...
class CreateStageResult {
 public:
  ...
  inline CreateStageResult& WithCacheClusterEnabled(bool value) {
  ...
  inline CreateStageResult& WithCacheClusterSize(CacheClusterSize value) {
  ...
  inline CreateStageResult& WithCacheClusterStatus(CacheClusterStatus value) {
  ...
  template <typename MethodSettingsT = Aws::Map<Aws::String, MethodSetting>>
  CreateStageResult& WithMethodSettings(MethodSettingsT&& value) {
  ...
  template <typename VariablesT = Aws::Map<Aws::String, Aws::String>>
  CreateStageResult& WithVariables(VariablesT&& value) {
  ...
  template <typename DocumentationVersionT = Aws::String>
  CreateStageResult& WithDocumentationVersion(DocumentationVersionT&& value) {
  ...
  template <typename CanarySettingsT = CanarySettings>
  CreateStageResult& WithCanarySettings(CanarySettingsT&& value) {
  ...
  inline CreateStageResult& WithTracingEnabled(bool value) {
  ...
  template <typename WebAclArnT = Aws::String>
  CreateStageResult& WithWebAclArn(WebAclArnT&& value) {
