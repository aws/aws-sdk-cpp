...
class PutIntegrationRequest : public APIGatewayRequest {
 public:
  ...
  inline PutIntegrationRequest& WithType(IntegrationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetIntegrationHttpMethod(IntegrationHttpMethodT&& value) {
    m_integrationHttpMethodHasBeenSet = true;
    m_integrationHttpMethod = std::forward<IntegrationHttpMethodT>(value);
  }
  template <typename IntegrationHttpMethodT = Aws::String>
  PutIntegrationRequest& WithIntegrationHttpMethod(IntegrationHttpMethodT&& value) {
    SetIntegrationHttpMethod(std::forward<IntegrationHttpMethodT>(value));
    return *this;
  }
  ///@}
  ...
  inline PutIntegrationRequest& WithConnectionType(ConnectionType value) {
  ...
  inline PutIntegrationRequest& WithContentHandling(ContentHandlingStrategy value) {
  ...
  inline PutIntegrationRequest& WithTimeoutInMillis(int value) {
  ...
  inline PutIntegrationRequest& WithResponseTransferMode(ResponseTransferMode value) {
