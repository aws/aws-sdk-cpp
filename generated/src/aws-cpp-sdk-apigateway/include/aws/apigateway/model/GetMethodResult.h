...
class GetMethodResult {
 public:
  ...
  template <typename HttpMethodT = Aws::String>
  GetMethodResult& WithHttpMethod(HttpMethodT&& value) {
  ...
  template <typename AuthorizationTypeT = Aws::String>
  GetMethodResult& WithAuthorizationType(AuthorizationTypeT&& value) {
  ...
  template <typename AuthorizerIdT = Aws::String>
  GetMethodResult& WithAuthorizerId(AuthorizerIdT&& value) {
  ...
  inline GetMethodResult& WithApiKeyRequired(bool value) {
  ...
  template <typename RequestValidatorIdT = Aws::String>
  GetMethodResult& WithRequestValidatorId(RequestValidatorIdT&& value) {
  ...
  template <typename OperationNameT = Aws::String>
  GetMethodResult& WithOperationName(OperationNameT&& value) {
  ...
  template <typename RequestParametersT = Aws::Map<Aws::String, bool>>
  GetMethodResult& WithRequestParameters(RequestParametersT&& value) {
  ...
  template <typename RequestModelsT = Aws::Map<Aws::String, Aws::String>>
  GetMethodResult& WithRequestModels(RequestModelsT&& value) {
  ...
  template <typename MethodResponsesT = Aws::Map<Aws::String, MethodResponse>>
  GetMethodResult& WithMethodResponses(MethodResponsesT&& value) {
  ...
  template <typename MethodIntegrationT = Integration>
  GetMethodResult& WithMethodIntegration(MethodIntegrationT&& value) {
  ...
  template <typename AuthorizationScopesT = Aws::Vector<Aws::String>>
  GetMethodResult& WithAuthorizationScopes(AuthorizationScopesT&& value) {
    SetAuthorizationScopes(std::forward<AuthorizationScopesT>(value));
    return *this;
  }
  template <typename AuthorizationScopesT = Aws::String>
  GetMethodResult& AddAuthorizationScopes(AuthorizationScopesT&& value) {
    m_authorizationScopesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetMethodResult& WithRequestId(RequestIdT&& value) {
