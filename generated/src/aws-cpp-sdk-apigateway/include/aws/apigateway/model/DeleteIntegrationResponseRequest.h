...
class DeleteIntegrationResponseRequest : public APIGatewayRequest {
 public:
  ...
  template <typename RestApiIdT = Aws::String>
  DeleteIntegrationResponseRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  DeleteIntegrationResponseRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename HttpMethodT = Aws::String>
  DeleteIntegrationResponseRequest& WithHttpMethod(HttpMethodT&& value) {
  ...
  template <typename StatusCodeT = Aws::String>
  DeleteIntegrationResponseRequest& WithStatusCode(StatusCodeT&& value) {
