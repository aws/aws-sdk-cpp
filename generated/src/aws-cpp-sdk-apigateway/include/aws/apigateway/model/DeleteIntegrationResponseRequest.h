...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API DeleteIntegrationResponseRequest() = default;
    ...
    template<typename RestApiIdT = Aws::String>
    DeleteIntegrationResponseRequest& WithRestApiId(RestApiIdT&& value) { SetRestApiId(std::forward<RestApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceIdT = Aws::String>
    DeleteIntegrationResponseRequest& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HttpMethodT = Aws::String>
    DeleteIntegrationResponseRequest& WithHttpMethod(HttpMethodT&& value) { SetHttpMethod(std::forward<HttpMethodT>(value)); return *this;}
    ///@}
    ...
    template<typename StatusCodeT = Aws::String>
    DeleteIntegrationResponseRequest& WithStatusCode(StatusCodeT&& value) { SetStatusCode(std::forward<StatusCodeT>(value)); return *this;}
    ///@}
  private:
