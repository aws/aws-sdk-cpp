...
class UpdateStageResult {
 public:
  ...
  template <typename DeploymentIdT = Aws::String>
  UpdateStageResult& WithDeploymentId(DeploymentIdT&& value) {
  ...
  template <typename ClientCertificateIdT = Aws::String>
  UpdateStageResult& WithClientCertificateId(ClientCertificateIdT&& value) {
  ...
  template <typename StageNameT = Aws::String>
  UpdateStageResult& WithStageName(StageNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateStageResult& WithDescription(DescriptionT&& value) {
  ...
  inline void SetCacheClusterEnabled(bool value) {
    m_cacheClusterEnabledHasBeenSet = true;
    m_cacheClusterEnabled = value;
  }
  inline UpdateStageResult& WithCacheClusterEnabled(bool value) {
    SetCacheClusterEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCacheClusterSize(CacheClusterSize value) {
    m_cacheClusterSizeHasBeenSet = true;
    m_cacheClusterSize = value;
  }
  inline UpdateStageResult& WithCacheClusterSize(CacheClusterSize value) {
    SetCacheClusterSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCacheClusterStatus(CacheClusterStatus value) {
    m_cacheClusterStatusHasBeenSet = true;
    m_cacheClusterStatus = value;
  }
  inline UpdateStageResult& WithCacheClusterStatus(CacheClusterStatus value) {
    SetCacheClusterStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetMethodSettings(MethodSettingsT&& value) {
    m_methodSettingsHasBeenSet = true;
    m_methodSettings = std::forward<MethodSettingsT>(value);
  }
  template <typename MethodSettingsT = Aws::Map<Aws::String, MethodSetting>>
  UpdateStageResult& WithMethodSettings(MethodSettingsT&& value) {
    SetMethodSettings(std::forward<MethodSettingsT>(value));
    return *this;
  }
  ...
  UpdateStageResult& AddMethodSettings(MethodSettingsKeyT&& key, MethodSettingsValueT&& value) {
    m_methodSettingsHasBeenSet = true;
    m_methodSettings.emplace(std::forward<MethodSettingsKeyT>(key), std::forward<MethodSettingsValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VariablesT = Aws::Map<Aws::String, Aws::String>>
  UpdateStageResult& WithVariables(VariablesT&& value) {
  ...
  template <typename DocumentationVersionT = Aws::String>
  UpdateStageResult& WithDocumentationVersion(DocumentationVersionT&& value) {
  ...
  template <typename AccessLogSettingsT = AccessLogSettings>
  UpdateStageResult& WithAccessLogSettings(AccessLogSettingsT&& value) {
  ...
  void SetCanarySettings(CanarySettingsT&& value) {
    ...
    m_canarySettings = std::forward<CanarySettingsT>(value);
  }
  template <typename CanarySettingsT = CanarySettings>
  UpdateStageResult& WithCanarySettings(CanarySettingsT&& value) {
    SetCanarySettings(std::forward<CanarySettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTracingEnabled(bool value) {
    m_tracingEnabledHasBeenSet = true;
    m_tracingEnabled = value;
  }
  inline UpdateStageResult& WithTracingEnabled(bool value) {
  ...
  template <typename WebAclArnT = Aws::String>
  UpdateStageResult& WithWebAclArn(WebAclArnT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateStageResult& WithTags(TagsT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  UpdateStageResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename LastUpdatedDateT = Aws::Utils::DateTime>
  UpdateStageResult& WithLastUpdatedDate(LastUpdatedDateT&& value) {
