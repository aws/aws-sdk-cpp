...
class PutIntegrationResult {
 public:
  AWS_APIGATEWAY_API PutIntegrationResult() = default;
  AWS_APIGATEWAY_API PutIntegrationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_APIGATEWAY_API PutIntegrationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline void SetType(IntegrationType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline PutIntegrationResult& WithType(IntegrationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename HttpMethodT = Aws::String>
  PutIntegrationResult& WithHttpMethod(HttpMethodT&& value) {
  ...
  inline PutIntegrationResult& WithConnectionType(ConnectionType value) {
  ...
  template <typename ConnectionIdT = Aws::String>
  PutIntegrationResult& WithConnectionId(ConnectionIdT&& value) {
  ...
  template <typename CredentialsT = Aws::String>
  PutIntegrationResult& WithCredentials(CredentialsT&& value) {
  ...
  template <typename RequestParametersT = Aws::Map<Aws::String, Aws::String>>
  PutIntegrationResult& WithRequestParameters(RequestParametersT&& value) {
  ...
  PutIntegrationResult& AddRequestParameters(RequestParametersKeyT&& key, RequestParametersValueT&& value) {
    m_requestParametersHasBeenSet = true;
    m_requestParameters.emplace(std::forward<RequestParametersKeyT>(key), std::forward<RequestParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequestTemplates(RequestTemplatesT&& value) {
    ...
    m_requestTemplates = std::forward<RequestTemplatesT>(value);
  }
  template <typename RequestTemplatesT = Aws::Map<Aws::String, Aws::String>>
  PutIntegrationResult& WithRequestTemplates(RequestTemplatesT&& value) {
    SetRequestTemplates(std::forward<RequestTemplatesT>(value));
    return *this;
  }
  template <typename RequestTemplatesKeyT = Aws::String, typename RequestTemplatesValueT = Aws::String>
  PutIntegrationResult& AddRequestTemplates(RequestTemplatesKeyT&& key, RequestTemplatesValueT&& value) {
    m_requestTemplatesHasBeenSet = true;
    m_requestTemplates.emplace(std::forward<RequestTemplatesKeyT>(key), std::forward<RequestTemplatesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPassthroughBehavior(PassthroughBehaviorT&& value) {
    ...
    m_passthroughBehavior = std::forward<PassthroughBehaviorT>(value);
  }
  template <typename PassthroughBehaviorT = Aws::String>
  PutIntegrationResult& WithPassthroughBehavior(PassthroughBehaviorT&& value) {
    SetPassthroughBehavior(std::forward<PassthroughBehaviorT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetContentHandling(ContentHandlingStrategy value) {
    m_contentHandlingHasBeenSet = true;
    m_contentHandling = value;
  }
  inline PutIntegrationResult& WithContentHandling(ContentHandlingStrategy value) {
    SetContentHandling(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimeoutInMillis(int value) {
    m_timeoutInMillisHasBeenSet = true;
    m_timeoutInMillis = value;
  }
  inline PutIntegrationResult& WithTimeoutInMillis(int value) {
  ...
  void SetCacheNamespace(CacheNamespaceT&& value) {
    ...
    m_cacheNamespace = std::forward<CacheNamespaceT>(value);
  }
  template <typename CacheNamespaceT = Aws::String>
  PutIntegrationResult& WithCacheNamespace(CacheNamespaceT&& value) {
    SetCacheNamespace(std::forward<CacheNamespaceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCacheKeyParameters(CacheKeyParametersT&& value) {
    ...
    m_cacheKeyParameters = std::forward<CacheKeyParametersT>(value);
  }
  template <typename CacheKeyParametersT = Aws::Vector<Aws::String>>
  PutIntegrationResult& WithCacheKeyParameters(CacheKeyParametersT&& value) {
    SetCacheKeyParameters(std::forward<CacheKeyParametersT>(value));
    return *this;
  }
  template <typename CacheKeyParametersT = Aws::String>
  PutIntegrationResult& AddCacheKeyParameters(CacheKeyParametersT&& value) {
    m_cacheKeyParametersHasBeenSet = true;
    m_cacheKeyParameters.emplace_back(std::forward<CacheKeyParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntegrationResponses(IntegrationResponsesT&& value) {
    ...
    m_integrationResponses = std::forward<IntegrationResponsesT>(value);
  }
  template <typename IntegrationResponsesT = Aws::Map<Aws::String, IntegrationResponse>>
  PutIntegrationResult& WithIntegrationResponses(IntegrationResponsesT&& value) {
    SetIntegrationResponses(std::forward<IntegrationResponsesT>(value));
    return *this;
  }
  template <typename IntegrationResponsesKeyT = Aws::String, typename IntegrationResponsesValueT = IntegrationResponse>
  PutIntegrationResult& AddIntegrationResponses(IntegrationResponsesKeyT&& key, IntegrationResponsesValueT&& value) {
    m_integrationResponsesHasBeenSet = true;
    m_integrationResponses.emplace(std::forward<IntegrationResponsesKeyT>(key), std::forward<IntegrationResponsesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTlsConfig(TlsConfigT&& value) {
    ...
    m_tlsConfig = std::forward<TlsConfigT>(value);
  }
  template <typename TlsConfigT = TlsConfig>
  PutIntegrationResult& WithTlsConfig(TlsConfigT&& value) {
    SetTlsConfig(std::forward<TlsConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline PutIntegrationResult& WithResponseTransferMode(ResponseTransferMode value) {
