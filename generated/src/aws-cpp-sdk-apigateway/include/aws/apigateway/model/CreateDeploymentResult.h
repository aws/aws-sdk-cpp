...
class CreateDeploymentResult {
 public:
  ...
  void SetApiSummary(ApiSummaryT&& value) {
    ...
    m_apiSummary = std::forward<ApiSummaryT>(value);
  }
  template <typename ApiSummaryT = Aws::Map<Aws::String, Aws::Map<Aws::String, MethodSnapshot>>>
  CreateDeploymentResult& WithApiSummary(ApiSummaryT&& value) {
    SetApiSummary(std::forward<ApiSummaryT>(value));
    return *this;
  }
  ...
  CreateDeploymentResult& AddApiSummary(ApiSummaryKeyT&& key, ApiSummaryValueT&& value) {
    m_apiSummaryHasBeenSet = true;
    m_apiSummary.emplace(std::forward<ApiSummaryKeyT>(key), std::forward<ApiSummaryValueT>(value));
    return *this;
  }
  ///@}
