...
class GetDocumentationPartsResult {
 public:
  ...
  template <typename PositionT = Aws::String>
  GetDocumentationPartsResult& WithPosition(PositionT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<DocumentationPart>>
  GetDocumentationPartsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DocumentationPart>
  GetDocumentationPartsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetDocumentationPartsResult& WithRequestId(RequestIdT&& value) {
