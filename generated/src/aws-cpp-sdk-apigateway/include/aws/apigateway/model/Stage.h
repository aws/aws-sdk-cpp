...
class Stage {
 public:
  ...
  inline Stage& WithCacheClusterEnabled(bool value) {
  ...
  inline Stage& WithCacheClusterSize(CacheClusterSize value) {
  ...
  inline Stage& WithCacheClusterStatus(CacheClusterStatus value) {
  ...
  template <typename MethodSettingsT = Aws::Map<Aws::String, MethodSetting>>
  Stage& WithMethodSettings(MethodSettingsT&& value) {
  ...
  template <typename VariablesT = Aws::Map<Aws::String, Aws::String>>
  Stage& WithVariables(VariablesT&& value) {
  ...
  template <typename DocumentationVersionT = Aws::String>
  Stage& WithDocumentationVersion(DocumentationVersionT&& value) {
  ...
  template <typename CanarySettingsT = CanarySettings>
  Stage& WithCanarySettings(CanarySettingsT&& value) {
  ...
  inline Stage& WithTracingEnabled(bool value) {
  ...
  template <typename WebAclArnT = Aws::String>
  Stage& WithWebAclArn(WebAclArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  Stage& WithRequestId(RequestIdT&& value) {
