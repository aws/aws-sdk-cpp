...
class GetIntegrationResponseRequest : public APIGatewayRequest {
 public:
  ...
  template <typename RestApiIdT = Aws::String>
  GetIntegrationResponseRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  GetIntegrationResponseRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename HttpMethodT = Aws::String>
  GetIntegrationResponseRequest& WithHttpMethod(HttpMethodT&& value) {
  ...
  template <typename StatusCodeT = Aws::String>
  GetIntegrationResponseRequest& WithStatusCode(StatusCodeT&& value) {
