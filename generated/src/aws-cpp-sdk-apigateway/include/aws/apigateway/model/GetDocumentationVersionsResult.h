...
class GetDocumentationVersionsResult {
 public:
  ...
  template <typename PositionT = Aws::String>
  GetDocumentationVersionsResult& WithPosition(PositionT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<DocumentationVersion>>
  GetDocumentationVersionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DocumentationVersion>
  GetDocumentationVersionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetDocumentationVersionsResult& WithRequestId(RequestIdT&& value) {
