...
class FlushStageAuthorizersCacheRequest : public APIGatewayRequest {
 public:
  AWS_APIGATEWAY_API FlushStageAuthorizersCacheRequest() = default;
  ...
  template <typename RestApiIdT = Aws::String>
  FlushStageAuthorizersCacheRequest& WithRestApiId(RestApiIdT&& value) {
  ...
  template <typename StageNameT = Aws::String>
  FlushStageAuthorizersCacheRequest& WithStageName(StageNameT&& value) {
