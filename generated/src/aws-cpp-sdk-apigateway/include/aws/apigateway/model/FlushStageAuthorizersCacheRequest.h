...
namespace Model
{
  ...
  public:
    ...
    template<typename RestApiIdT = Aws::String>
    FlushStageAuthorizersCacheRequest& WithRestApiId(RestApiIdT&& value) { SetRestApiId(std::forward<RestApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename StageNameT = Aws::String>
    FlushStageAuthorizersCacheRequest& WithStageName(StageNameT&& value) { SetStageName(std::forward<StageNameT>(value)); return *this;}
    ///@}
  private:
