...
class MethodResponse {
 public:
  ...
  template <typename StatusCodeT = Aws::String>
  MethodResponse& WithStatusCode(StatusCodeT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, bool>>
  MethodResponse& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
  MethodResponse& WithResponseModels(ResponseModelsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  MethodResponse& WithRequestId(RequestIdT&& value) {
