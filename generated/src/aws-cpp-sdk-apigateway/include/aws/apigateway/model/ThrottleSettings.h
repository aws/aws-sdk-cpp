...
class ThrottleSettings {
 public:
  ...
  inline void SetBurstLimit(int value) {
    m_burstLimitHasBeenSet = true;
    m_burstLimit = value;
  }
  inline ThrottleSettings& WithBurstLimit(int value) {
    SetBurstLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRateLimit(double value) {
    m_rateLimitHasBeenSet = true;
    m_rateLimit = value;
  }
  inline ThrottleSettings& WithRateLimit(double value) {
    SetRateLimit(value);
    return *this;
  }
  ///@}
