...
class UpdateUsagePlanRequest : public APIGatewayRequest {
 public:
  ...
  template <typename UsagePlanIdT = Aws::String>
  UpdateUsagePlanRequest& WithUsagePlanId(UsagePlanIdT&& value) {
  ...
  template <typename PatchOperationsT = Aws::Vector<PatchOperation>>
  UpdateUsagePlanRequest& WithPatchOperations(PatchOperationsT&& value) {
    SetPatchOperations(std::forward<PatchOperationsT>(value));
    return *this;
  }
  template <typename PatchOperationsT = PatchOperation>
  UpdateUsagePlanRequest& AddPatchOperations(PatchOperationsT&& value) {
    m_patchOperationsHasBeenSet = true;
