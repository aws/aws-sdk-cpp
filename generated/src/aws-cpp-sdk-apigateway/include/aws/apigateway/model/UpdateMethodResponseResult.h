...
class UpdateMethodResponseResult {
 public:
  ...
  template <typename StatusCodeT = Aws::String>
  UpdateMethodResponseResult& WithStatusCode(StatusCodeT&& value) {
  ...
  template <typename ResponseParametersT = Aws::Map<Aws::String, bool>>
  UpdateMethodResponseResult& WithResponseParameters(ResponseParametersT&& value) {
  ...
  template <typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
  UpdateMethodResponseResult& WithResponseModels(ResponseModelsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateMethodResponseResult& WithRequestId(RequestIdT&& value) {
