...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API UpdateMethodResponseResult() = default;
    AWS_APIGATEWAY_API UpdateMethodResponseResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_APIGATEWAY_API UpdateMethodResponseResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename StatusCodeT = Aws::String>
    UpdateMethodResponseResult& WithStatusCode(StatusCodeT&& value) { SetStatusCode(std::forward<StatusCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseParametersT = Aws::Map<Aws::String, bool>>
    UpdateMethodResponseResult& WithResponseParameters(ResponseParametersT&& value) { SetResponseParameters(std::forward<ResponseParametersT>(value)); return *this;}
    inline UpdateMethodResponseResult& AddResponseParameters(Aws::String key, bool value) {
    ...
    template<typename ResponseModelsT = Aws::Map<Aws::String, Aws::String>>
    UpdateMethodResponseResult& WithResponseModels(ResponseModelsT&& value) { SetResponseModels(std::forward<ResponseModelsT>(value)); return *this;}
    template<typename ResponseModelsKeyT = Aws::String, typename ResponseModelsValueT = Aws::String>
    UpdateMethodResponseResult& AddResponseModels(ResponseModelsKeyT&& key, ResponseModelsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    UpdateMethodResponseResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
