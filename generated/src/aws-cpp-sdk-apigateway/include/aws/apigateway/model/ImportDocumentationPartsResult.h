...
class ImportDocumentationPartsResult {
 public:
  ...
  template <typename IdsT = Aws::Vector<Aws::String>>
  ImportDocumentationPartsResult& WithIds(IdsT&& value) {
    SetIds(std::forward<IdsT>(value));
    return *this;
  }
  template <typename IdsT = Aws::String>
  ImportDocumentationPartsResult& AddIds(IdsT&& value) {
    m_idsHasBeenSet = true;
  ...
  template <typename WarningsT = Aws::Vector<Aws::String>>
  ImportDocumentationPartsResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = Aws::String>
  ImportDocumentationPartsResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ImportDocumentationPartsResult& WithRequestId(RequestIdT&& value) {
