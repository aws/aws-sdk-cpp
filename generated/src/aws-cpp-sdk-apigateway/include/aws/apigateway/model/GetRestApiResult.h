...
class GetRestApiResult {
 public:
  ...
  template <typename IdT = Aws::String>
  GetRestApiResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetRestApiResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetRestApiResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  GetRestApiResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename VersionT = Aws::String>
  GetRestApiResult& WithVersion(VersionT&& value) {
  ...
  template <typename WarningsT = Aws::Vector<Aws::String>>
  GetRestApiResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = Aws::String>
  GetRestApiResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
  ...
  template <typename BinaryMediaTypesT = Aws::Vector<Aws::String>>
  GetRestApiResult& WithBinaryMediaTypes(BinaryMediaTypesT&& value) {
    SetBinaryMediaTypes(std::forward<BinaryMediaTypesT>(value));
    return *this;
  }
  template <typename BinaryMediaTypesT = Aws::String>
  GetRestApiResult& AddBinaryMediaTypes(BinaryMediaTypesT&& value) {
    m_binaryMediaTypesHasBeenSet = true;
  ...
  inline GetRestApiResult& WithMinimumCompressionSize(int value) {
  ...
  inline GetRestApiResult& WithApiKeySource(ApiKeySourceType value) {
  ...
  template <typename EndpointConfigurationT = EndpointConfiguration>
  GetRestApiResult& WithEndpointConfiguration(EndpointConfigurationT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  GetRestApiResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetRestApiResult& WithTags(TagsT&& value) {
  ...
  inline GetRestApiResult& WithDisableExecuteApiEndpoint(bool value) {
  ...
  template <typename RootResourceIdT = Aws::String>
  GetRestApiResult& WithRootResourceId(RootResourceIdT&& value) {
  ...
  inline GetRestApiResult& WithSecurityPolicy(SecurityPolicy value) {
  ...
  inline GetRestApiResult& WithEndpointAccessMode(EndpointAccessMode value) {
  ...
  inline GetRestApiResult& WithApiStatus(ApiStatus value) {
    SetApiStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ApiStatusMessageT = Aws::String>
  GetRestApiResult& WithApiStatusMessage(ApiStatusMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRestApiResult& WithRequestId(RequestIdT&& value) {
