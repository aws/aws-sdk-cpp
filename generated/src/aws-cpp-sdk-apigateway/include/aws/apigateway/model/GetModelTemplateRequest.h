...
namespace Model
{
  ...
  {
  public:
    AWS_APIGATEWAY_API GetModelTemplateRequest() = default;
    ...
    template<typename RestApiIdT = Aws::String>
    GetModelTemplateRequest& WithRestApiId(RestApiIdT&& value) { SetRestApiId(std::forward<RestApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ModelNameT = Aws::String>
    GetModelTemplateRequest& WithModelName(ModelNameT&& value) { SetModelName(std::forward<ModelNameT>(value)); return *this;}
    ///@}
  private:
