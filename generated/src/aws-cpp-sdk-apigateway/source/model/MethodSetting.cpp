...
MethodSetting::MethodSetting(JsonView jsonValue) { *this = jsonValue; }
...
MethodSetting& MethodSetting::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("unauthorizedCacheControlHeaderStrategy")) {
    m_unauthorizedCacheControlHeaderStrategy =
        UnauthorizedCacheControlHeaderStrategyMapper::GetUnauthorizedCacheControlHeaderStrategyForName(
            jsonValue.GetString("unauthorizedCacheControlHeaderStrategy"));
...
JsonValue MethodSetting::Jsonize() const {
  ...
  if (m_unauthorizedCacheControlHeaderStrategyHasBeenSet) {
    payload.WithString("unauthorizedCacheControlHeaderStrategy",
                       UnauthorizedCacheControlHeaderStrategyMapper::GetNameForUnauthorizedCacheControlHeaderStrategy(
                           m_unauthorizedCacheControlHeaderStrategy));
  }
