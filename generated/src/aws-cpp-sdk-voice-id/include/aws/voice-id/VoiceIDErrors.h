...
public:
  ...
  VoiceIDError(const Aws::Client::AWSError<VoiceIDErrors>& rhs) : Aws::Client::AWSError<VoiceIDErrors>(rhs) {}
  VoiceIDError(Aws::Client::AWSError<VoiceIDErrors>&& rhs) : Aws::Client::AWSError<VoiceIDErrors>(rhs) {}
