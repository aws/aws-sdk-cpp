...
class AWS_VOICEID_API VoiceIDClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  VoiceIDClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<VoiceIDEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AssociateFraudster that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateFraudster that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociateFraudsterRequestT = Model::AssociateFraudsterRequest>
  void AssociateFraudsterAsync(const AssociateFraudsterRequestT& request, const AssociateFraudsterResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateWatchlist that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateWatchlistRequestT = Model::CreateWatchlistRequest>
  void CreateWatchlistAsync(const CreateWatchlistRequestT& request, const CreateWatchlistResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFraudster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFraudsterRequestT = Model::DeleteFraudsterRequest>
  void DeleteFraudsterAsync(const DeleteFraudsterRequestT& request, const DeleteFraudsterResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteSpeaker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSpeakerRequestT = Model::DeleteSpeakerRequest>
  void DeleteSpeakerAsync(const DeleteSpeakerRequestT& request, const DeleteSpeakerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteWatchlist that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteWatchlistRequestT = Model::DeleteWatchlistRequest>
  void DeleteWatchlistAsync(const DeleteWatchlistRequestT& request, const DeleteWatchlistResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeDomain that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeDomainRequestT = Model::DescribeDomainRequest>
  void DescribeDomainAsync(const DescribeDomainRequestT& request, const DescribeDomainResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeFraudster that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFraudster that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeFraudsterRequestT = Model::DescribeFraudsterRequest>
  void DescribeFraudsterAsync(const DescribeFraudsterRequestT& request, const DescribeFraudsterResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeFraudsterRegistrationJobOutcome DescribeFraudsterRegistrationJob(
      const Model::DescribeFraudsterRegistrationJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeFraudsterRegistrationJob that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeFraudsterRegistrationJobRequestT = Model::DescribeFraudsterRegistrationJobRequest>
  Model::DescribeFraudsterRegistrationJobOutcomeCallable DescribeFraudsterRegistrationJobCallable(
      const DescribeFraudsterRegistrationJobRequestT& request) const {
    return SubmitCallable(&VoiceIDClient::DescribeFraudsterRegistrationJob, request);
  }

  /**
   * An Async wrapper for DescribeFraudsterRegistrationJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeFraudsterRegistrationJobRequestT = Model::DescribeFraudsterRegistrationJobRequest>
  void DescribeFraudsterRegistrationJobAsync(const DescribeFraudsterRegistrationJobRequestT& request,
                                             const DescribeFraudsterRegistrationJobResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeSpeaker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeSpeakerRequestT = Model::DescribeSpeakerRequest>
  void DescribeSpeakerAsync(const DescribeSpeakerRequestT& request, const DescribeSpeakerResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeSpeakerEnrollmentJobOutcome DescribeSpeakerEnrollmentJob(
      const Model::DescribeSpeakerEnrollmentJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeSpeakerEnrollmentJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeSpeakerEnrollmentJobRequestT = Model::DescribeSpeakerEnrollmentJobRequest>
  Model::DescribeSpeakerEnrollmentJobOutcomeCallable DescribeSpeakerEnrollmentJobCallable(
      const DescribeSpeakerEnrollmentJobRequestT& request) const {
    return SubmitCallable(&VoiceIDClient::DescribeSpeakerEnrollmentJob, request);
  }

  /**
   * An Async wrapper for DescribeSpeakerEnrollmentJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSpeakerEnrollmentJobRequestT = Model::DescribeSpeakerEnrollmentJobRequest>
  void DescribeSpeakerEnrollmentJobAsync(const DescribeSpeakerEnrollmentJobRequestT& request,
                                         const DescribeSpeakerEnrollmentJobResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWatchlist that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWatchlist that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeWatchlistRequestT = Model::DescribeWatchlistRequest>
  void DescribeWatchlistAsync(const DescribeWatchlistRequestT& request, const DescribeWatchlistResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateFraudster that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateFraudster that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateFraudsterRequestT = Model::DisassociateFraudsterRequest>
  void DisassociateFraudsterAsync(const DisassociateFraudsterRequestT& request, const DisassociateFraudsterResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EvaluateSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EvaluateSessionRequestT = Model::EvaluateSessionRequest>
  void EvaluateSessionAsync(const EvaluateSessionRequestT& request, const EvaluateSessionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListFraudsterRegistrationJobsOutcome ListFraudsterRegistrationJobs(
      const Model::ListFraudsterRegistrationJobsRequest& request) const;

  /**
   * A Callable wrapper for ListFraudsterRegistrationJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListFraudsterRegistrationJobsRequestT = Model::ListFraudsterRegistrationJobsRequest>
  Model::ListFraudsterRegistrationJobsOutcomeCallable ListFraudsterRegistrationJobsCallable(
      const ListFraudsterRegistrationJobsRequestT& request) const {
    return SubmitCallable(&VoiceIDClient::ListFraudsterRegistrationJobs, request);
  }

  /**
   * An Async wrapper for ListFraudsterRegistrationJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFraudsterRegistrationJobsRequestT = Model::ListFraudsterRegistrationJobsRequest>
  void ListFraudsterRegistrationJobsAsync(const ListFraudsterRegistrationJobsRequestT& request,
                                          const ListFraudsterRegistrationJobsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListFraudsters that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFraudstersRequestT = Model::ListFraudstersRequest>
  void ListFraudstersAsync(const ListFraudstersRequestT& request, const ListFraudstersResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSpeakerEnrollmentJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListSpeakerEnrollmentJobsRequestT = Model::ListSpeakerEnrollmentJobsRequest>
  Model::ListSpeakerEnrollmentJobsOutcomeCallable ListSpeakerEnrollmentJobsCallable(
      const ListSpeakerEnrollmentJobsRequestT& request) const {
    return SubmitCallable(&VoiceIDClient::ListSpeakerEnrollmentJobs, request);
  }

  /**
   * An Async wrapper for ListSpeakerEnrollmentJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSpeakerEnrollmentJobsRequestT = Model::ListSpeakerEnrollmentJobsRequest>
  void ListSpeakerEnrollmentJobsAsync(const ListSpeakerEnrollmentJobsRequestT& request,
                                      const ListSpeakerEnrollmentJobsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSpeakers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSpeakersRequestT = Model::ListSpeakersRequest>
  void ListSpeakersAsync(const ListSpeakersRequestT& request, const ListSpeakersResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListWatchlists that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListWatchlistsRequestT = Model::ListWatchlistsRequest>
  void ListWatchlistsAsync(const ListWatchlistsRequestT& request, const ListWatchlistsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for OptOutSpeaker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename OptOutSpeakerRequestT = Model::OptOutSpeakerRequest>
  void OptOutSpeakerAsync(const OptOutSpeakerRequestT& request, const OptOutSpeakerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartFraudsterRegistrationJobOutcome StartFraudsterRegistrationJob(
      const Model::StartFraudsterRegistrationJobRequest& request) const;

  /**
   * A Callable wrapper for StartFraudsterRegistrationJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartFraudsterRegistrationJobRequestT = Model::StartFraudsterRegistrationJobRequest>
  Model::StartFraudsterRegistrationJobOutcomeCallable StartFraudsterRegistrationJobCallable(
      const StartFraudsterRegistrationJobRequestT& request) const {
    return SubmitCallable(&VoiceIDClient::StartFraudsterRegistrationJob, request);
  }

  /**
   * An Async wrapper for StartFraudsterRegistrationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartFraudsterRegistrationJobRequestT = Model::StartFraudsterRegistrationJobRequest>
  void StartFraudsterRegistrationJobAsync(const StartFraudsterRegistrationJobRequestT& request,
                                          const StartFraudsterRegistrationJobResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartSpeakerEnrollmentJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartSpeakerEnrollmentJobRequestT = Model::StartSpeakerEnrollmentJobRequest>
  Model::StartSpeakerEnrollmentJobOutcomeCallable StartSpeakerEnrollmentJobCallable(
      const StartSpeakerEnrollmentJobRequestT& request) const {
    return SubmitCallable(&VoiceIDClient::StartSpeakerEnrollmentJob, request);
  }

  /**
   * An Async wrapper for StartSpeakerEnrollmentJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartSpeakerEnrollmentJobRequestT = Model::StartSpeakerEnrollmentJobRequest>
  void StartSpeakerEnrollmentJobAsync(const StartSpeakerEnrollmentJobRequestT& request,
                                      const StartSpeakerEnrollmentJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateWatchlist that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateWatchlistRequestT = Model::UpdateWatchlistRequest>
  void UpdateWatchlistAsync(const UpdateWatchlistRequestT& request, const UpdateWatchlistResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
