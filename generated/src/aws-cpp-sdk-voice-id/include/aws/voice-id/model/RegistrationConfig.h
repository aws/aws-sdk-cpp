...
class RegistrationConfig {
 public:
  ...
  inline void SetDuplicateRegistrationAction(DuplicateRegistrationAction value) {
    m_duplicateRegistrationActionHasBeenSet = true;
    m_duplicateRegistrationAction = value;
  }
  inline RegistrationConfig& WithDuplicateRegistrationAction(DuplicateRegistrationAction value) {
    SetDuplicateRegistrationAction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFraudsterSimilarityThreshold(int value) {
    m_fraudsterSimilarityThresholdHasBeenSet = true;
    m_fraudsterSimilarityThreshold = value;
  }
  inline RegistrationConfig& WithFraudsterSimilarityThreshold(int value) {
    SetFraudsterSimilarityThreshold(value);
    return *this;
  }
  ///@}
