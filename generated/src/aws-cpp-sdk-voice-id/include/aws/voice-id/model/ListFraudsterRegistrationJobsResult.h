...
class ListFraudsterRegistrationJobsResult {
 public:
  ...
  template <typename JobSummariesT = Aws::Vector<FraudsterRegistrationJobSummary>>
  ListFraudsterRegistrationJobsResult& WithJobSummaries(JobSummariesT&& value) {
    SetJobSummaries(std::forward<JobSummariesT>(value));
    return *this;
  }
  template <typename JobSummariesT = FraudsterRegistrationJobSummary>
  ListFraudsterRegistrationJobsResult& AddJobSummaries(JobSummariesT&& value) {
    m_jobSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListFraudsterRegistrationJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFraudsterRegistrationJobsResult& WithRequestId(RequestIdT&& value) {
