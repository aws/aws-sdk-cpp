...
class KnownFraudsterRisk {
 public:
  ...
  void SetGeneratedFraudsterId(GeneratedFraudsterIdT&& value) {
    ...
    m_generatedFraudsterId = std::forward<GeneratedFraudsterIdT>(value);
  }
  template <typename GeneratedFraudsterIdT = Aws::String>
  KnownFraudsterRisk& WithGeneratedFraudsterId(GeneratedFraudsterIdT&& value) {
    SetGeneratedFraudsterId(std::forward<GeneratedFraudsterIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline KnownFraudsterRisk& WithRiskScore(int value) {
    SetRiskScore(value);
    return *this;
  }
  ///@}
