...
class EvaluateSessionRequest : public VoiceIDRequest {
 public:
  ...
  template <typename DomainIdT = Aws::String>
  EvaluateSessionRequest& WithDomainId(DomainIdT&& value) {
  ...
  void SetSessionNameOrId(SessionNameOrIdT&& value) {
    m_sessionNameOrIdHasBeenSet = true;
    m_sessionNameOrId = std::forward<SessionNameOrIdT>(value);
  }
  template <typename SessionNameOrIdT = Aws::String>
  EvaluateSessionRequest& WithSessionNameOrId(SessionNameOrIdT&& value) {
    SetSessionNameOrId(std::forward<SessionNameOrIdT>(value));
    return *this;
  }
  ///@}
 private:
