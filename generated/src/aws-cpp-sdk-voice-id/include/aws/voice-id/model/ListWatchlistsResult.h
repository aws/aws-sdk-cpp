...
class ListWatchlistsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWatchlistsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetWatchlistSummaries(WatchlistSummariesT&& value) {
    m_watchlistSummariesHasBeenSet = true;
    m_watchlistSummaries = std::forward<WatchlistSummariesT>(value);
  }
  template <typename WatchlistSummariesT = Aws::Vector<WatchlistSummary>>
  ListWatchlistsResult& WithWatchlistSummaries(WatchlistSummariesT&& value) {
    SetWatchlistSummaries(std::forward<WatchlistSummariesT>(value));
    return *this;
  }
  template <typename WatchlistSummariesT = WatchlistSummary>
  ListWatchlistsResult& AddWatchlistSummaries(WatchlistSummariesT&& value) {
    m_watchlistSummariesHasBeenSet = true;
    m_watchlistSummaries.emplace_back(std::forward<WatchlistSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListWatchlistsResult& WithRequestId(RequestIdT&& value) {
