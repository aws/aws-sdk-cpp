...
class ListSpeakerEnrollmentJobsRequest : public VoiceIDRequest {
 public:
  ...
  template <typename DomainIdT = Aws::String>
  ListSpeakerEnrollmentJobsRequest& WithDomainId(DomainIdT&& value) {
  ...
  inline ListSpeakerEnrollmentJobsRequest& WithJobStatus(SpeakerEnrollmentJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListSpeakerEnrollmentJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSpeakerEnrollmentJobsRequest& WithNextToken(NextTokenT&& value) {
