...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public VoiceIDRequest
  {
  public:
    AWS_VOICEID_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the Voice ID resource you want to remove
     * tags from.</p>
     */
