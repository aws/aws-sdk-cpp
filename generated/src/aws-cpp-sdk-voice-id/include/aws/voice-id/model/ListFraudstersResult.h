...
class ListFraudstersResult {
 public:
  ...
  void SetFraudsterSummaries(FraudsterSummariesT&& value) {
    m_fraudsterSummariesHasBeenSet = true;
    m_fraudsterSummaries = std::forward<FraudsterSummariesT>(value);
  }
  template <typename FraudsterSummariesT = Aws::Vector<FraudsterSummary>>
  ListFraudstersResult& WithFraudsterSummaries(FraudsterSummariesT&& value) {
    SetFraudsterSummaries(std::forward<FraudsterSummariesT>(value));
    return *this;
  }
  template <typename FraudsterSummariesT = FraudsterSummary>
  ListFraudstersResult& AddFraudsterSummaries(FraudsterSummariesT&& value) {
    m_fraudsterSummariesHasBeenSet = true;
    m_fraudsterSummaries.emplace_back(std::forward<FraudsterSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFraudstersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFraudstersResult& WithRequestId(RequestIdT&& value) {
