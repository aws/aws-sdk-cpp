...
class AssociateFraudsterRequest : public VoiceIDRequest {
 public:
  AWS_VOICEID_API AssociateFraudsterRequest() = default;
  ...
  template <typename DomainIdT = Aws::String>
  AssociateFraudsterRequest& WithDomainId(DomainIdT&& value) {
  ...
  void SetFraudsterId(FraudsterIdT&& value) {
    m_fraudsterIdHasBeenSet = true;
    m_fraudsterId = std::forward<FraudsterIdT>(value);
  }
  template <typename FraudsterIdT = Aws::String>
  AssociateFraudsterRequest& WithFraudsterId(FraudsterIdT&& value) {
    SetFraudsterId(std::forward<FraudsterIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WatchlistIdT = Aws::String>
  AssociateFraudsterRequest& WithWatchlistId(WatchlistIdT&& value) {
