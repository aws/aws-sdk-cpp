...
class FraudDetectionResult {
 public:
  ...
  inline void SetDecision(FraudDetectionDecision value) {
    m_decisionHasBeenSet = true;
    m_decision = value;
  }
  inline FraudDetectionResult& WithDecision(FraudDetectionDecision value) {
    SetDecision(value);
    return *this;
  }
  ///@}
  ...
  void SetFraudDetectionResultId(FraudDetectionResultIdT&& value) {
    ...
    m_fraudDetectionResultId = std::forward<FraudDetectionResultIdT>(value);
  }
  template <typename FraudDetectionResultIdT = Aws::String>
  FraudDetectionResult& WithFraudDetectionResultId(FraudDetectionResultIdT&& value) {
    SetFraudDetectionResultId(std::forward<FraudDetectionResultIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline FraudDetectionResult& AddReasons(FraudDetectionReason value) {
    m_reasonsHasBeenSet = true;
  ...
  void SetRiskDetails(RiskDetailsT&& value) {
    ...
    m_riskDetails = std::forward<RiskDetailsT>(value);
  }
  template <typename RiskDetailsT = FraudRiskDetails>
  FraudDetectionResult& WithRiskDetails(RiskDetailsT&& value) {
    SetRiskDetails(std::forward<RiskDetailsT>(value));
    return *this;
  }
  ///@}
 private:
