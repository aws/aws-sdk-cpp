...
class ListSpeakersRequest : public VoiceIDRequest {
 public:
  AWS_VOICEID_API ListSpeakersRequest() = default;
  ...
  template <typename DomainIdT = Aws::String>
  ListSpeakersRequest& WithDomainId(DomainIdT&& value) {
  ...
  inline ListSpeakersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSpeakersRequest& WithNextToken(NextTokenT&& value) {
