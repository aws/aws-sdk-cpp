...
namespace Model
{
  ...
  {
  public:
    AWS_VOICEID_API ListFraudstersRequest() = default;
    ...
    template<typename DomainIdT = Aws::String>
    ListFraudstersRequest& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListFraudstersRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename WatchlistIdT = Aws::String>
    ListFraudstersRequest& WithWatchlistId(WatchlistIdT&& value) { SetWatchlistId(std::forward<WatchlistIdT>(value)); return *this;}
    ///@}
  private:
