...
class ListFraudstersRequest : public VoiceIDRequest {
 public:
  ...
  template <typename DomainIdT = Aws::String>
  ListFraudstersRequest& WithDomainId(DomainIdT&& value) {
  ...
  inline ListFraudstersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFraudstersRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename WatchlistIdT = Aws::String>
  ListFraudstersRequest& WithWatchlistId(WatchlistIdT&& value) {
