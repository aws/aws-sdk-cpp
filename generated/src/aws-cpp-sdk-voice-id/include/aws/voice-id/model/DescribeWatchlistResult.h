...
namespace Model
{
  ...
  {
  public:
    AWS_VOICEID_API DescribeWatchlistResult() = default;
    ...
    template<typename WatchlistT = Watchlist>
    DescribeWatchlistResult& WithWatchlist(WatchlistT&& value) { SetWatchlist(std::forward<WatchlistT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeWatchlistResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
