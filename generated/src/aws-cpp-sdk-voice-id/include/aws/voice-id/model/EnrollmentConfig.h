...
class EnrollmentConfig {
 public:
  ...
  inline void SetExistingEnrollmentAction(ExistingEnrollmentAction value) {
    m_existingEnrollmentActionHasBeenSet = true;
    m_existingEnrollmentAction = value;
  }
  inline EnrollmentConfig& WithExistingEnrollmentAction(ExistingEnrollmentAction value) {
    SetExistingEnrollmentAction(value);
    return *this;
  }
  ///@}
  ...
  void SetFraudDetectionConfig(FraudDetectionConfigT&& value) {
    ...
    m_fraudDetectionConfig = std::forward<FraudDetectionConfigT>(value);
  }
  template <typename FraudDetectionConfigT = EnrollmentJobFraudDetectionConfig>
  EnrollmentConfig& WithFraudDetectionConfig(FraudDetectionConfigT&& value) {
    SetFraudDetectionConfig(std::forward<FraudDetectionConfigT>(value));
    return *this;
  }
  ///@}
 private:
