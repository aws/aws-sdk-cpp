...
class FraudsterRegistrationJobSummary {
 public:
  ...
  void SetJobProgress(JobProgressT&& value) {
    ...
    m_jobProgress = std::forward<JobProgressT>(value);
  }
  template <typename JobProgressT = JobProgress>
  FraudsterRegistrationJobSummary& WithJobProgress(JobProgressT&& value) {
    SetJobProgress(std::forward<JobProgressT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetJobStatus(FraudsterRegistrationJobStatus value) {
    m_jobStatusHasBeenSet = true;
    m_jobStatus = value;
  }
  inline FraudsterRegistrationJobSummary& WithJobStatus(FraudsterRegistrationJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
