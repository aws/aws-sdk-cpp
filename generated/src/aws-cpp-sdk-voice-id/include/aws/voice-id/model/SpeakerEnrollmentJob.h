...
class SpeakerEnrollmentJob {
 public:
  ...
  void SetEnrollmentConfig(EnrollmentConfigT&& value) {
    ...
    m_enrollmentConfig = std::forward<EnrollmentConfigT>(value);
  }
  template <typename EnrollmentConfigT = EnrollmentConfig>
  SpeakerEnrollmentJob& WithEnrollmentConfig(EnrollmentConfigT&& value) {
    SetEnrollmentConfig(std::forward<EnrollmentConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline SpeakerEnrollmentJob& WithJobStatus(SpeakerEnrollmentJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
