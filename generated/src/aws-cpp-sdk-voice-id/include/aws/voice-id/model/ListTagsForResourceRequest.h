...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public VoiceIDRequest
  {
  public:
    AWS_VOICEID_API ListTagsForResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the Voice ID resource for which you want to
     * list the tags.</p>
     */
