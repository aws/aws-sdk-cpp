...
class ListWatchlistsRequest : public VoiceIDRequest {
 public:
  ...
  template <typename DomainIdT = Aws::String>
  ListWatchlistsRequest& WithDomainId(DomainIdT&& value) {
  ...
  inline ListWatchlistsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWatchlistsRequest& WithNextToken(NextTokenT&& value) {
