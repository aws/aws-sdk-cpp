...
class ListFraudsterRegistrationJobsRequest : public VoiceIDRequest {
 public:
  ...
  template <typename DomainIdT = Aws::String>
  ListFraudsterRegistrationJobsRequest& WithDomainId(DomainIdT&& value) {
  ...
  inline ListFraudsterRegistrationJobsRequest& WithJobStatus(FraudsterRegistrationJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListFraudsterRegistrationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFraudsterRegistrationJobsRequest& WithNextToken(NextTokenT&& value) {
