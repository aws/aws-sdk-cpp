...
class FraudRiskDetails {
 public:
  ...
  void SetKnownFraudsterRisk(KnownFraudsterRiskT&& value) {
    ...
    m_knownFraudsterRisk = std::forward<KnownFraudsterRiskT>(value);
  }
  template <typename KnownFraudsterRiskT = KnownFraudsterRisk>
  FraudRiskDetails& WithKnownFraudsterRisk(KnownFraudsterRiskT&& value) {
    SetKnownFraudsterRisk(std::forward<KnownFraudsterRiskT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVoiceSpoofingRisk(VoiceSpoofingRiskT&& value) {
    ...
    m_voiceSpoofingRisk = std::forward<VoiceSpoofingRiskT>(value);
  }
  template <typename VoiceSpoofingRiskT = VoiceSpoofingRisk>
  FraudRiskDetails& WithVoiceSpoofingRisk(VoiceSpoofingRiskT&& value) {
    SetVoiceSpoofingRisk(std::forward<VoiceSpoofingRiskT>(value));
    return *this;
  }
  ///@}
 private:
