...
class EnrollmentJobFraudDetectionConfig {
 public:
  ...
  inline void SetFraudDetectionAction(FraudDetectionAction value) {
    m_fraudDetectionActionHasBeenSet = true;
    m_fraudDetectionAction = value;
  }
  inline EnrollmentJobFraudDetectionConfig& WithFraudDetectionAction(FraudDetectionAction value) {
    SetFraudDetectionAction(value);
    return *this;
  }
  ///@}
  ...
  inline EnrollmentJobFraudDetectionConfig& WithRiskThreshold(int value) {
