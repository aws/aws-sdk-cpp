...
class WatchlistDetails {
 public:
  ...
  void SetDefaultWatchlistId(DefaultWatchlistIdT&& value) {
    m_defaultWatchlistIdHasBeenSet = true;
    m_defaultWatchlistId = std::forward<DefaultWatchlistIdT>(value);
  }
  template <typename DefaultWatchlistIdT = Aws::String>
  WatchlistDetails& WithDefaultWatchlistId(DefaultWatchlistIdT&& value) {
    SetDefaultWatchlistId(std::forward<DefaultWatchlistIdT>(value));
    return *this;
  }
  ///@}
 private:
