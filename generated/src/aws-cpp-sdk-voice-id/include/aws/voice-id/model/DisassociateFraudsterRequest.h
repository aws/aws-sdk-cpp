...
class DisassociateFraudsterRequest : public VoiceIDRequest {
 public:
  ...
  template <typename DomainIdT = Aws::String>
  DisassociateFraudsterRequest& WithDomainId(DomainIdT&& value) {
  ...
  template <typename FraudsterIdT = Aws::String>
  DisassociateFraudsterRequest& WithFraudsterId(FraudsterIdT&& value) {
  ...
  template <typename WatchlistIdT = Aws::String>
  DisassociateFraudsterRequest& WithWatchlistId(WatchlistIdT&& value) {
