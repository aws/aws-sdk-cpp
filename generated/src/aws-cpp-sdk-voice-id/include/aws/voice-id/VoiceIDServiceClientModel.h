...
typedef Aws::Utils::Outcome<AssociateFraudsterResult, VoiceIDError> AssociateFraudsterOutcome;
typedef Aws::Utils::Outcome<CreateDomainResult, VoiceIDError> CreateDomainOutcome;
typedef Aws::Utils::Outcome<CreateWatchlistResult, VoiceIDError> CreateWatchlistOutcome;
...
typedef Aws::Utils::Outcome<Aws::NoResult, VoiceIDError> DeleteWatchlistOutcome;
...
typedef Aws::Utils::Outcome<DescribeWatchlistResult, VoiceIDError> DescribeWatchlistOutcome;
typedef Aws::Utils::Outcome<DisassociateFraudsterResult, VoiceIDError> DisassociateFraudsterOutcome;
...
typedef Aws::Utils::Outcome<ListFraudstersResult, VoiceIDError> ListFraudstersOutcome;
...
typedef Aws::Utils::Outcome<ListWatchlistsResult, VoiceIDError> ListWatchlistsOutcome;
...
typedef Aws::Utils::Outcome<UpdateWatchlistResult, VoiceIDError> UpdateWatchlistOutcome;
/* End of service model Outcome class definitions */

/* Service model Outcome callable definitions */
typedef std::future<AssociateFraudsterOutcome> AssociateFraudsterOutcomeCallable;
typedef std::future<CreateDomainOutcome> CreateDomainOutcomeCallable;
typedef std::future<CreateWatchlistOutcome> CreateWatchlistOutcomeCallable;
...
typedef std::future<DeleteWatchlistOutcome> DeleteWatchlistOutcomeCallable;
...
typedef std::future<DescribeWatchlistOutcome> DescribeWatchlistOutcomeCallable;
typedef std::future<DisassociateFraudsterOutcome> DisassociateFraudsterOutcomeCallable;
...
typedef std::future<ListFraudstersOutcome> ListFraudstersOutcomeCallable;
...
typedef std::future<ListWatchlistsOutcome> ListWatchlistsOutcomeCallable;
...
typedef std::future<UpdateWatchlistOutcome> UpdateWatchlistOutcomeCallable;
...
typedef std::function<void(const VoiceIDClient*, const Model::AssociateFraudsterRequest&, const Model::AssociateFraudsterOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    AssociateFraudsterResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::CreateDomainRequest&, const Model::CreateDomainOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateDomainResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::CreateWatchlistRequest&, const Model::CreateWatchlistOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateWatchlistResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DeleteDomainRequest&, const Model::DeleteDomainOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteDomainResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DeleteFraudsterRequest&, const Model::DeleteFraudsterOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteFraudsterResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DeleteSpeakerRequest&, const Model::DeleteSpeakerOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteSpeakerResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DeleteWatchlistRequest&, const Model::DeleteWatchlistOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteWatchlistResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DescribeDomainRequest&, const Model::DescribeDomainOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DescribeDomainResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DescribeFraudsterRequest&, const Model::DescribeFraudsterOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DescribeFraudsterResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DescribeFraudsterRegistrationJobRequest&,
                           const Model::DescribeFraudsterRegistrationJobOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DescribeFraudsterRegistrationJobResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DescribeSpeakerRequest&, const Model::DescribeSpeakerOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DescribeSpeakerResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DescribeSpeakerEnrollmentJobRequest&,
                           const Model::DescribeSpeakerEnrollmentJobOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DescribeSpeakerEnrollmentJobResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DescribeWatchlistRequest&, const Model::DescribeWatchlistOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DescribeWatchlistResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::DisassociateFraudsterRequest&, const Model::DisassociateFraudsterOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DisassociateFraudsterResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::EvaluateSessionRequest&, const Model::EvaluateSessionOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    EvaluateSessionResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::ListDomainsRequest&, const Model::ListDomainsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListDomainsResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::ListFraudsterRegistrationJobsRequest&,
                           const Model::ListFraudsterRegistrationJobsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListFraudsterRegistrationJobsResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::ListFraudstersRequest&, const Model::ListFraudstersOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListFraudstersResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::ListSpeakerEnrollmentJobsRequest&,
                           const Model::ListSpeakerEnrollmentJobsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListSpeakerEnrollmentJobsResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::ListSpeakersRequest&, const Model::ListSpeakersOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListSpeakersResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::ListTagsForResourceRequest&, const Model::ListTagsForResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::ListWatchlistsRequest&, const Model::ListWatchlistsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListWatchlistsResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::OptOutSpeakerRequest&, const Model::OptOutSpeakerOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    OptOutSpeakerResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::StartFraudsterRegistrationJobRequest&,
                           const Model::StartFraudsterRegistrationJobOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartFraudsterRegistrationJobResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::StartSpeakerEnrollmentJobRequest&,
                           const Model::StartSpeakerEnrollmentJobOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartSpeakerEnrollmentJobResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::UpdateDomainRequest&, const Model::UpdateDomainOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateDomainResponseReceivedHandler;
typedef std::function<void(const VoiceIDClient*, const Model::UpdateWatchlistRequest&, const Model::UpdateWatchlistOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateWatchlistResponseReceivedHandler;
