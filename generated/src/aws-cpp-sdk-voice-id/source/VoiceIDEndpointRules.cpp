...
namespace VoiceID
{
const size_t VoiceIDEndpointRules::RulesBlobStrLen = 3728;
const size_t VoiceIDEndpointRules::RulesBlobSize = 3729;
...
'/','/','v','o','i','c','e','i','d','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','v','o','i','c','e','i','d','.','{','R','e',
