...
FraudsterSummary::FraudsterSummary(JsonView jsonValue) { *this = jsonValue; }

FraudsterSummary& FraudsterSummary::operator=(JsonView jsonValue) {
...
JsonValue FraudsterSummary::Jsonize() const {
  JsonValue payload;
