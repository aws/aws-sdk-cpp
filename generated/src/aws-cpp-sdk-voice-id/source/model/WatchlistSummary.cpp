...
WatchlistSummary::WatchlistSummary(JsonView jsonValue) { *this = jsonValue; }

WatchlistSummary& WatchlistSummary::operator=(JsonView jsonValue) {
...
JsonValue WatchlistSummary::Jsonize() const {
  JsonValue payload;
