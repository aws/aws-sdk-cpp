...
StartFraudsterRegistrationJobResult::StartFraudsterRegistrationJobResult()
{
}

StartFraudsterRegistrationJobResult::StartFraudsterRegistrationJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
