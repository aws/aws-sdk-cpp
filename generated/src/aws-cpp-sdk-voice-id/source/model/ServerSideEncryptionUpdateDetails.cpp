...
ServerSideEncryptionUpdateDetails::ServerSideEncryptionUpdateDetails(JsonView jsonValue) { *this = jsonValue; }
...
ServerSideEncryptionUpdateDetails& ServerSideEncryptionUpdateDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("UpdateStatus")) {
    m_updateStatus =
        ServerSideEncryptionUpdateStatusMapper::GetServerSideEncryptionUpdateStatusForName(jsonValue.GetString("UpdateStatus"));
