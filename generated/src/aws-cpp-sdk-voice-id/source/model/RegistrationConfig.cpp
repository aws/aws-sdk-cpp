...
RegistrationConfig& RegistrationConfig::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("DuplicateRegistrationAction")) {
    m_duplicateRegistrationAction =
        DuplicateRegistrationActionMapper::GetDuplicateRegistrationActionForName(jsonValue.GetString("DuplicateRegistrationAction"));
...
JsonValue RegistrationConfig::Jsonize() const {
  ...
  if (m_duplicateRegistrationActionHasBeenSet) {
    payload.WithString("DuplicateRegistrationAction",
                       DuplicateRegistrationActionMapper::GetNameForDuplicateRegistrationAction(m_duplicateRegistrationAction));
  }
