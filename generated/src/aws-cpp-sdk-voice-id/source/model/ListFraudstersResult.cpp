...
ListFraudstersResult::ListFraudstersResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListFraudstersResult& ListFraudstersResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("FraudsterSummaries")) {
    ...
    for (unsigned fraudsterSummariesIndex = 0; fraudsterSummariesIndex < fraudsterSummariesJsonList.GetLength();
         ++fraudsterSummariesIndex) {
      m_fraudsterSummaries.push_back(fraudsterSummariesJsonList[fraudsterSummariesIndex].AsObject());
    }
    m_fraudsterSummariesHasBeenSet = true;
  }
