...
class AssetModelCompositeModelPathSegment {
 public:
  AWS_IOTSITEWISE_API AssetModelCompositeModelPathSegment() = default;
  ...
  template <typename IdT = Aws::String>
  AssetModelCompositeModelPathSegment& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  AssetModelCompositeModelPathSegment& WithName(NameT&& value) {
