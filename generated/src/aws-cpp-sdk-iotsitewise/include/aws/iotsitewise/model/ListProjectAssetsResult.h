...
class ListProjectAssetsResult {
 public:
  ...
  template <typename AssetIdsT = Aws::Vector<Aws::String>>
  ListProjectAssetsResult& WithAssetIds(AssetIdsT&& value) {
    SetAssetIds(std::forward<AssetIdsT>(value));
    return *this;
  }
  template <typename AssetIdsT = Aws::String>
  ListProjectAssetsResult& AddAssetIds(AssetIdsT&& value) {
    m_assetIdsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListProjectAssetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProjectAssetsResult& WithRequestId(RequestIdT&& value) {
