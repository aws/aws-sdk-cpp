...
class ListActionsRequest : public IoTSiteWiseRequest {
 public:
  ...
  inline ListActionsRequest& WithTargetResourceType(TargetResourceType value) {
  ...
  template <typename TargetResourceIdT = Aws::String>
  ListActionsRequest& WithTargetResourceId(TargetResourceIdT&& value) {
  ...
  inline ListActionsRequest& WithResolveToResourceType(ResolveToResourceType value) {
  ...
  template <typename ResolveToResourceIdT = Aws::String>
  ListActionsRequest& WithResolveToResourceId(ResolveToResourceIdT&& value) {
