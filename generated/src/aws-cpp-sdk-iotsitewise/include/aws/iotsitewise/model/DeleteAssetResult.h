...
namespace Model
{
  ...
  {
  public:
    AWS_IOTSITEWISE_API DeleteAssetResult() = default;
    ...
    template<typename AssetStatusT = AssetStatus>
    DeleteAssetResult& WithAssetStatus(AssetStatusT&& value) { SetAssetStatus(std::forward<AssetStatusT>(value)); return *this;}
    ///@}
