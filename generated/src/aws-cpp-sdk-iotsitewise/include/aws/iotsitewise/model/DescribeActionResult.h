...
class DescribeActionResult {
 public:
  ...
  template <typename ActionIdT = Aws::String>
  DescribeActionResult& WithActionId(ActionIdT&& value) {
  ...
  template <typename TargetResourceT = TargetResource>
  DescribeActionResult& WithTargetResource(TargetResourceT&& value) {
  ...
  template <typename ActionDefinitionIdT = Aws::String>
  DescribeActionResult& WithActionDefinitionId(ActionDefinitionIdT&& value) {
  ...
  void SetActionPayload(ActionPayloadT&& value) {
    m_actionPayloadHasBeenSet = true;
    m_actionPayload = std::forward<ActionPayloadT>(value);
  }
  template <typename ActionPayloadT = ActionPayload>
  DescribeActionResult& WithActionPayload(ActionPayloadT&& value) {
    SetActionPayload(std::forward<ActionPayloadT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExecutionTimeT = Aws::Utils::DateTime>
  DescribeActionResult& WithExecutionTime(ExecutionTimeT&& value) {
  ...
  template <typename ResolveToT = ResolveTo>
  DescribeActionResult& WithResolveTo(ResolveToT&& value) {
