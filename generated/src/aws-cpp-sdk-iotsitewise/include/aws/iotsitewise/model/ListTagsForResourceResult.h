...
class ListTagsForResourceResult {
 public:
  AWS_IOTSITEWISE_API ListTagsForResourceResult() = default;
  AWS_IOTSITEWISE_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
