...
class BatchPutAssetPropertyValueRequest : public IoTSiteWiseRequest {
 public:
  ...
  inline void SetEnablePartialEntryProcessing(bool value) {
    m_enablePartialEntryProcessingHasBeenSet = true;
    m_enablePartialEntryProcessing = value;
  }
  inline BatchPutAssetPropertyValueRequest& WithEnablePartialEntryProcessing(bool value) {
    SetEnablePartialEntryProcessing(value);
    return *this;
  }
  ///@}
