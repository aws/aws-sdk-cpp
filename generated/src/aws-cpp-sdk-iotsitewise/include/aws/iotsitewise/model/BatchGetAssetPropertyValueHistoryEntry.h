...
class BatchGetAssetPropertyValueHistoryEntry {
 public:
  AWS_IOTSITEWISE_API BatchGetAssetPropertyValueHistoryEntry() = default;
  ...
  template <typename EntryIdT = Aws::String>
  BatchGetAssetPropertyValueHistoryEntry& WithEntryId(EntryIdT&& value) {
  ...
  template <typename AssetIdT = Aws::String>
  BatchGetAssetPropertyValueHistoryEntry& WithAssetId(AssetIdT&& value) {
  ...
  template <typename PropertyIdT = Aws::String>
  BatchGetAssetPropertyValueHistoryEntry& WithPropertyId(PropertyIdT&& value) {
  ...
  template <typename PropertyAliasT = Aws::String>
  BatchGetAssetPropertyValueHistoryEntry& WithPropertyAlias(PropertyAliasT&& value) {
  ...
  template <typename StartDateT = Aws::Utils::DateTime>
  BatchGetAssetPropertyValueHistoryEntry& WithStartDate(StartDateT&& value) {
  ...
  template <typename EndDateT = Aws::Utils::DateTime>
  BatchGetAssetPropertyValueHistoryEntry& WithEndDate(EndDateT&& value) {
  ...
  void SetQualities(QualitiesT&& value) {
    ...
    m_qualities = std::forward<QualitiesT>(value);
  }
  template <typename QualitiesT = Aws::Vector<Quality>>
  BatchGetAssetPropertyValueHistoryEntry& WithQualities(QualitiesT&& value) {
    SetQualities(std::forward<QualitiesT>(value));
    return *this;
  }
  inline BatchGetAssetPropertyValueHistoryEntry& AddQualities(Quality value) {
    m_qualitiesHasBeenSet = true;
    m_qualities.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimeOrdering(TimeOrdering value) {
    m_timeOrderingHasBeenSet = true;
    m_timeOrdering = value;
  }
  inline BatchGetAssetPropertyValueHistoryEntry& WithTimeOrdering(TimeOrdering value) {
    SetTimeOrdering(value);
    return *this;
  }
  ///@}
 private:
