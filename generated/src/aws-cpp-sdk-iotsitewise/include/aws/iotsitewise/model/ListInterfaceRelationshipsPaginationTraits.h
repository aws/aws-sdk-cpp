...
struct ListInterfaceRelationshipsPaginationTraits {
  using RequestType = Model::ListInterfaceRelationshipsRequest;
  using ResultType = Model::ListInterfaceRelationshipsResult;
  using OutcomeType = Model::ListInterfaceRelationshipsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListInterfaceRelationships(request); }
