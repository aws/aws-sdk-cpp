...
class GetAssetPropertyAggregatesRequest : public IoTSiteWiseRequest {
 public:
  ...
  void SetAggregateTypes(AggregateTypesT&& value) {
    ...
    m_aggregateTypes = std::forward<AggregateTypesT>(value);
  }
  template <typename AggregateTypesT = Aws::Vector<AggregateType>>
  GetAssetPropertyAggregatesRequest& WithAggregateTypes(AggregateTypesT&& value) {
    SetAggregateTypes(std::forward<AggregateTypesT>(value));
    return *this;
  }
  inline GetAssetPropertyAggregatesRequest& AddAggregateTypes(AggregateType value) {
    m_aggregateTypesHasBeenSet = true;
    m_aggregateTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline GetAssetPropertyAggregatesRequest& AddQualities(Quality value) {
    m_qualitiesHasBeenSet = true;
  ...
  inline GetAssetPropertyAggregatesRequest& WithTimeOrdering(TimeOrdering value) {
  ...
  inline GetAssetPropertyAggregatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
