...
class PropertyMappingConfiguration {
 public:
  ...
  inline void SetMatchByPropertyName(bool value) {
    m_matchByPropertyNameHasBeenSet = true;
    m_matchByPropertyName = value;
  }
  inline PropertyMappingConfiguration& WithMatchByPropertyName(bool value) {
    SetMatchByPropertyName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCreateMissingProperty(bool value) {
    m_createMissingPropertyHasBeenSet = true;
    m_createMissingProperty = value;
  }
  inline PropertyMappingConfiguration& WithCreateMissingProperty(bool value) {
    SetCreateMissingProperty(value);
    return *this;
  }
  ///@}
  ...
  template <typename OverridesT = Aws::Vector<PropertyMapping>>
  PropertyMappingConfiguration& WithOverrides(OverridesT&& value) {
    SetOverrides(std::forward<OverridesT>(value));
    return *this;
  }
  template <typename OverridesT = PropertyMapping>
  PropertyMappingConfiguration& AddOverrides(OverridesT&& value) {
    m_overridesHasBeenSet = true;
