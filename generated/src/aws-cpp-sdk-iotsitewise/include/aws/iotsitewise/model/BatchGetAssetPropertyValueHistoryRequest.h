...
class BatchGetAssetPropertyValueHistoryRequest : public IoTSiteWiseRequest {
 public:
  AWS_IOTSITEWISE_API BatchGetAssetPropertyValueHistoryRequest() = default;
  ...
  template <typename EntriesT = Aws::Vector<BatchGetAssetPropertyValueHistoryEntry>>
  void SetEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
    m_entries = std::forward<EntriesT>(value);
  }
  template <typename EntriesT = Aws::Vector<BatchGetAssetPropertyValueHistoryEntry>>
  BatchGetAssetPropertyValueHistoryRequest& WithEntries(EntriesT&& value) {
    SetEntries(std::forward<EntriesT>(value));
    return *this;
  }
  template <typename EntriesT = BatchGetAssetPropertyValueHistoryEntry>
  BatchGetAssetPropertyValueHistoryRequest& AddEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  BatchGetAssetPropertyValueHistoryRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline BatchGetAssetPropertyValueHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
