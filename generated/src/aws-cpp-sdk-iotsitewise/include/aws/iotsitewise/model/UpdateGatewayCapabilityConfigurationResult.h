...
class UpdateGatewayCapabilityConfigurationResult {
 public:
  ...
  AWS_IOTSITEWISE_API UpdateGatewayCapabilityConfigurationResult& operator=(
  ...
  template <typename CapabilityNamespaceT = Aws::String>
  UpdateGatewayCapabilityConfigurationResult& WithCapabilityNamespace(CapabilityNamespaceT&& value) {
  ...
  inline UpdateGatewayCapabilityConfigurationResult& WithCapabilitySyncStatus(CapabilitySyncStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateGatewayCapabilityConfigurationResult& WithRequestId(RequestIdT&& value) {
