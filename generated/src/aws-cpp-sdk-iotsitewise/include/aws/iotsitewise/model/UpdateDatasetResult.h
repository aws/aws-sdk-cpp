...
class UpdateDatasetResult {
 public:
  ...
  void SetDatasetStatus(DatasetStatusT&& value) {
    ...
    m_datasetStatus = std::forward<DatasetStatusT>(value);
  }
  template <typename DatasetStatusT = DatasetStatus>
  UpdateDatasetResult& WithDatasetStatus(DatasetStatusT&& value) {
    SetDatasetStatus(std::forward<DatasetStatusT>(value));
    return *this;
  }
  ///@}
