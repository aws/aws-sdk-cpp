...
class ListAssociatedAssetsResult {
 public:
  ...
  void SetAssetSummaries(AssetSummariesT&& value) {
    m_assetSummariesHasBeenSet = true;
    m_assetSummaries = std::forward<AssetSummariesT>(value);
  }
  template <typename AssetSummariesT = Aws::Vector<AssociatedAssetsSummary>>
  ListAssociatedAssetsResult& WithAssetSummaries(AssetSummariesT&& value) {
    SetAssetSummaries(std::forward<AssetSummariesT>(value));
    return *this;
  }
  template <typename AssetSummariesT = AssociatedAssetsSummary>
  ListAssociatedAssetsResult& AddAssetSummaries(AssetSummariesT&& value) {
    m_assetSummariesHasBeenSet = true;
    m_assetSummaries.emplace_back(std::forward<AssetSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociatedAssetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssociatedAssetsResult& WithRequestId(RequestIdT&& value) {
