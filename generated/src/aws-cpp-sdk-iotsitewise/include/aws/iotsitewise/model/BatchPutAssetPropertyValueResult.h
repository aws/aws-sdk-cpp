...
class BatchPutAssetPropertyValueResult {
 public:
  ...
  template <typename ErrorEntriesT = Aws::Vector<BatchPutAssetPropertyErrorEntry>>
  BatchPutAssetPropertyValueResult& WithErrorEntries(ErrorEntriesT&& value) {
    SetErrorEntries(std::forward<ErrorEntriesT>(value));
    return *this;
  }
  template <typename ErrorEntriesT = BatchPutAssetPropertyErrorEntry>
  BatchPutAssetPropertyValueResult& AddErrorEntries(ErrorEntriesT&& value) {
    m_errorEntriesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchPutAssetPropertyValueResult& WithRequestId(RequestIdT&& value) {
