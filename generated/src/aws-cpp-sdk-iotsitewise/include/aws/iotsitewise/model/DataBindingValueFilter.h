...
class DataBindingValueFilter {
 public:
  ...
  template <typename AssetT = AssetBindingValueFilter>
  DataBindingValueFilter& WithAsset(AssetT&& value) {
  ...
  void SetAssetModel(AssetModelT&& value) {
    m_assetModelHasBeenSet = true;
    m_assetModel = std::forward<AssetModelT>(value);
  }
  template <typename AssetModelT = AssetModelBindingValueFilter>
  DataBindingValueFilter& WithAssetModel(AssetModelT&& value) {
    SetAssetModel(std::forward<AssetModelT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssetProperty(AssetPropertyT&& value) {
    ...
    m_assetProperty = std::forward<AssetPropertyT>(value);
  }
  template <typename AssetPropertyT = AssetPropertyBindingValueFilter>
  DataBindingValueFilter& WithAssetProperty(AssetPropertyT&& value) {
    SetAssetProperty(std::forward<AssetPropertyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssetModelProperty(AssetModelPropertyT&& value) {
    m_assetModelPropertyHasBeenSet = true;
    m_assetModelProperty = std::forward<AssetModelPropertyT>(value);
  }
  template <typename AssetModelPropertyT = AssetModelPropertyBindingValueFilter>
  DataBindingValueFilter& WithAssetModelProperty(AssetModelPropertyT&& value) {
    SetAssetModelProperty(std::forward<AssetModelPropertyT>(value));
    return *this;
  }
  ///@}
 private:
