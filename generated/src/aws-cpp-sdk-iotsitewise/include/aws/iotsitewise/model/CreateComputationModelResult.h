...
class CreateComputationModelResult {
 public:
  ...
  void SetComputationModelId(ComputationModelIdT&& value) {
    m_computationModelIdHasBeenSet = true;
    m_computationModelId = std::forward<ComputationModelIdT>(value);
  }
  template <typename ComputationModelIdT = Aws::String>
  CreateComputationModelResult& WithComputationModelId(ComputationModelIdT&& value) {
    SetComputationModelId(std::forward<ComputationModelIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComputationModelArn(ComputationModelArnT&& value) {
    m_computationModelArnHasBeenSet = true;
    m_computationModelArn = std::forward<ComputationModelArnT>(value);
  }
  template <typename ComputationModelArnT = Aws::String>
  CreateComputationModelResult& WithComputationModelArn(ComputationModelArnT&& value) {
    SetComputationModelArn(std::forward<ComputationModelArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComputationModelStatus(ComputationModelStatusT&& value) {
    m_computationModelStatusHasBeenSet = true;
    m_computationModelStatus = std::forward<ComputationModelStatusT>(value);
  }
  template <typename ComputationModelStatusT = ComputationModelStatus>
  CreateComputationModelResult& WithComputationModelStatus(ComputationModelStatusT&& value) {
    SetComputationModelStatus(std::forward<ComputationModelStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateComputationModelResult& WithRequestId(RequestIdT&& value) {
