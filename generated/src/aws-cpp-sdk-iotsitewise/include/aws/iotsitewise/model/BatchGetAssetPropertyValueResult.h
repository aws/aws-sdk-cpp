...
namespace Model
{
  ...
  public:
    ...
    template<typename ErrorEntriesT = Aws::Vector<BatchGetAssetPropertyValueErrorEntry>>
    void SetErrorEntries(ErrorEntriesT&& value) { m_errorEntriesHasBeenSet = true; m_errorEntries = std::forward<ErrorEntriesT>(value); }
    template<typename ErrorEntriesT = Aws::Vector<BatchGetAssetPropertyValueErrorEntry>>
    BatchGetAssetPropertyValueResult& WithErrorEntries(ErrorEntriesT&& value) { SetErrorEntries(std::forward<ErrorEntriesT>(value)); return *this;}
    template<typename ErrorEntriesT = BatchGetAssetPropertyValueErrorEntry>
    BatchGetAssetPropertyValueResult& AddErrorEntries(ErrorEntriesT&& value) { m_errorEntriesHasBeenSet = true; m_errorEntries.emplace_back(std::forward<ErrorEntriesT>(value)); return *this; }
    ///@}
    ...
    template<typename SuccessEntriesT = Aws::Vector<BatchGetAssetPropertyValueSuccessEntry>>
    ...
    template<typename SuccessEntriesT = Aws::Vector<BatchGetAssetPropertyValueSuccessEntry>>
    BatchGetAssetPropertyValueResult& WithSuccessEntries(SuccessEntriesT&& value) { SetSuccessEntries(std::forward<SuccessEntriesT>(value)); return *this;}
    template<typename SuccessEntriesT = BatchGetAssetPropertyValueSuccessEntry>
    BatchGetAssetPropertyValueResult& AddSuccessEntries(SuccessEntriesT&& value) { m_successEntriesHasBeenSet = true; m_successEntries.emplace_back(std::forward<SuccessEntriesT>(value)); return *this; }
    ///@}
    ...
    template<typename SkippedEntriesT = Aws::Vector<BatchGetAssetPropertyValueSkippedEntry>>
    ...
    template<typename SkippedEntriesT = Aws::Vector<BatchGetAssetPropertyValueSkippedEntry>>
    BatchGetAssetPropertyValueResult& WithSkippedEntries(SkippedEntriesT&& value) { SetSkippedEntries(std::forward<SkippedEntriesT>(value)); return *this;}
    template<typename SkippedEntriesT = BatchGetAssetPropertyValueSkippedEntry>
    BatchGetAssetPropertyValueResult& AddSkippedEntries(SkippedEntriesT&& value) { m_skippedEntriesHasBeenSet = true; m_skippedEntries.emplace_back(std::forward<SkippedEntriesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    BatchGetAssetPropertyValueResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    BatchGetAssetPropertyValueResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
