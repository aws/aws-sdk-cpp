...
class ConfigurationErrorDetails {
 public:
  AWS_IOTSITEWISE_API ConfigurationErrorDetails() = default;
  ...
  inline ConfigurationErrorDetails& WithCode(ErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ConfigurationErrorDetails& WithMessage(MessageT&& value) {
