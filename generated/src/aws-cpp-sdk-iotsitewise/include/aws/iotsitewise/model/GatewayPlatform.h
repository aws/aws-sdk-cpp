...
class GatewayPlatform {
 public:
  ...
  template <typename GreengrassT = Greengrass>
  GatewayPlatform& WithGreengrass(GreengrassT&& value) {
  ...
  void SetGreengrassV2(GreengrassV2T&& value) {
    m_greengrassV2HasBeenSet = true;
    m_greengrassV2 = std::forward<GreengrassV2T>(value);
  }
  template <typename GreengrassV2T = GreengrassV2>
  GatewayPlatform& WithGreengrassV2(GreengrassV2T&& value) {
    SetGreengrassV2(std::forward<GreengrassV2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetSiemensIE(SiemensIET&& value) {
    m_siemensIEHasBeenSet = true;
    m_siemensIE = std::forward<SiemensIET>(value);
  }
  template <typename SiemensIET = SiemensIE>
  GatewayPlatform& WithSiemensIE(SiemensIET&& value) {
    SetSiemensIE(std::forward<SiemensIET>(value));
    return *this;
  }
  ///@}
 private:
