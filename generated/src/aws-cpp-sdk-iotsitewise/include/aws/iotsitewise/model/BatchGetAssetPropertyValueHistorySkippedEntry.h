...
class BatchGetAssetPropertyValueHistorySkippedEntry {
 public:
  ...
  template <typename EntryIdT = Aws::String>
  BatchGetAssetPropertyValueHistorySkippedEntry& WithEntryId(EntryIdT&& value) {
  ...
  inline void SetCompletionStatus(BatchEntryCompletionStatus value) {
    m_completionStatusHasBeenSet = true;
    m_completionStatus = value;
  }
  inline BatchGetAssetPropertyValueHistorySkippedEntry& WithCompletionStatus(BatchEntryCompletionStatus value) {
  ...
  template <typename ErrorInfoT = BatchGetAssetPropertyValueHistoryErrorInfo>
  BatchGetAssetPropertyValueHistorySkippedEntry& WithErrorInfo(ErrorInfoT&& value) {
