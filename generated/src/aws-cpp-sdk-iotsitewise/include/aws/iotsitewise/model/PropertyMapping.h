...
class PropertyMapping {
 public:
  ...
  void SetAssetModelPropertyId(AssetModelPropertyIdT&& value) {
    m_assetModelPropertyIdHasBeenSet = true;
    m_assetModelPropertyId = std::forward<AssetModelPropertyIdT>(value);
  }
  template <typename AssetModelPropertyIdT = Aws::String>
  PropertyMapping& WithAssetModelPropertyId(AssetModelPropertyIdT&& value) {
    SetAssetModelPropertyId(std::forward<AssetModelPropertyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInterfaceAssetModelPropertyId(InterfaceAssetModelPropertyIdT&& value) {
    m_interfaceAssetModelPropertyIdHasBeenSet = true;
    m_interfaceAssetModelPropertyId = std::forward<InterfaceAssetModelPropertyIdT>(value);
  }
  template <typename InterfaceAssetModelPropertyIdT = Aws::String>
  PropertyMapping& WithInterfaceAssetModelPropertyId(InterfaceAssetModelPropertyIdT&& value) {
    SetInterfaceAssetModelPropertyId(std::forward<InterfaceAssetModelPropertyIdT>(value));
    return *this;
  }
  ///@}
 private:
