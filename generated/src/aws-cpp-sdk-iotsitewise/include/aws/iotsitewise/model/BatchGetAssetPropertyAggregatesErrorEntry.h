...
class BatchGetAssetPropertyAggregatesErrorEntry {
 public:
  ...
  inline void SetErrorCode(BatchGetAssetPropertyAggregatesErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline BatchGetAssetPropertyAggregatesErrorEntry& WithErrorCode(BatchGetAssetPropertyAggregatesErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchGetAssetPropertyAggregatesErrorEntry& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename EntryIdT = Aws::String>
  BatchGetAssetPropertyAggregatesErrorEntry& WithEntryId(EntryIdT&& value) {
