...
class UpdateAssetPropertyRequest : public IoTSiteWiseRequest {
 public:
  ...
  inline void SetPropertyNotificationState(PropertyNotificationState value) {
    m_propertyNotificationStateHasBeenSet = true;
    m_propertyNotificationState = value;
  }
  inline UpdateAssetPropertyRequest& WithPropertyNotificationState(PropertyNotificationState value) {
    SetPropertyNotificationState(value);
    return *this;
  }
  ///@}
  ...
  void SetPropertyUnit(PropertyUnitT&& value) {
    m_propertyUnitHasBeenSet = true;
    m_propertyUnit = std::forward<PropertyUnitT>(value);
  }
  template <typename PropertyUnitT = Aws::String>
  UpdateAssetPropertyRequest& WithPropertyUnit(PropertyUnitT&& value) {
    SetPropertyUnit(std::forward<PropertyUnitT>(value));
    return *this;
  }
  ///@}
 private:
