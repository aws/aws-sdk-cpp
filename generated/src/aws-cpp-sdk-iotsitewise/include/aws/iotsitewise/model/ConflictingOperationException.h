...
class ConflictingOperationException {
 public:
  AWS_IOTSITEWISE_API ConflictingOperationException() = default;
  ...
  template <typename MessageT = Aws::String>
  ConflictingOperationException& WithMessage(MessageT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  ConflictingOperationException& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  ConflictingOperationException& WithResourceArn(ResourceArnT&& value) {
