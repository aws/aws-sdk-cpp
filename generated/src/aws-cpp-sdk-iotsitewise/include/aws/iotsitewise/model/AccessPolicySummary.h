...
class AccessPolicySummary {
 public:
  ...
  template <typename IdT = Aws::String>
  AccessPolicySummary& WithId(IdT&& value) {
  ...
  template <typename IdentityT = Identity>
  AccessPolicySummary& WithIdentity(IdentityT&& value) {
  ...
  template <typename ResourceT = Resource>
  AccessPolicySummary& WithResource(ResourceT&& value) {
  ...
  inline AccessPolicySummary& WithPermission(Permission value) {
    SetPermission(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  AccessPolicySummary& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename LastUpdateDateT = Aws::Utils::DateTime>
  AccessPolicySummary& WithLastUpdateDate(LastUpdateDateT&& value) {
