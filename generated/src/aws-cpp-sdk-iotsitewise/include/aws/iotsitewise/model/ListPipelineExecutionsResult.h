...
namespace Model {
/**
 * <p>Response structure for ListPipelineExecutions operation.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/ListPipelineExecutionsResponse">AWS
 * API Reference</a></p>
 */
class ListPipelineExecutionsResult {
 public:
  AWS_IOTSITEWISE_API ListPipelineExecutionsResult() = default;
  AWS_IOTSITEWISE_API ListPipelineExecutionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_IOTSITEWISE_API ListPipelineExecutionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
