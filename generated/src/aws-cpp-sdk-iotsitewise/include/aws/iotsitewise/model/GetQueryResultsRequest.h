...
/**
 */
class GetQueryResultsRequest : public IoTSiteWiseRequest {
 public:
  AWS_IOTSITEWISE_API GetQueryResultsRequest() = default;
  ...
  template <typename WorkspaceNameT = Aws::String>
  GetQueryResultsRequest& WithWorkspaceName(WorkspaceNameT&& value) {
