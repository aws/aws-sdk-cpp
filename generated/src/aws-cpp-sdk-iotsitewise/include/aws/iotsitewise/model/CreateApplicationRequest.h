...
/**
 */
class CreateApplicationRequest : public IoTSiteWiseRequest {
 public:
  AWS_IOTSITEWISE_API CreateApplicationRequest() = default;
  ...
  template <typename WorkspaceNameT = Aws::String>
  CreateApplicationRequest& WithWorkspaceName(WorkspaceNameT&& value) {
