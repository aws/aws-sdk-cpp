...
class PutStorageConfigurationRequest : public IoTSiteWiseRequest {
 public:
  ...
  inline PutStorageConfigurationRequest& WithStorageType(StorageType value) {
  ...
  inline PutStorageConfigurationRequest& WithDisassociatedDataStorage(DisassociatedDataStorageState value) {
  ...
  inline PutStorageConfigurationRequest& WithWarmTier(WarmTierState value) {
    SetWarmTier(value);
    return *this;
  }
  ///@}
  ...
  inline PutStorageConfigurationRequest& WithDisallowIngestNullNaN(bool value) {
