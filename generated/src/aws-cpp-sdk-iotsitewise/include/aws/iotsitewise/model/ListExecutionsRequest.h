...
namespace Model
{
  ...
  public:
    ...
    inline ListExecutionsRequest& WithTargetResourceType(TargetResourceType value) { SetTargetResourceType(value); return *this;}
    ///@}
    ...
    template<typename TargetResourceIdT = Aws::String>
    ListExecutionsRequest& WithTargetResourceId(TargetResourceIdT&& value) { SetTargetResourceId(std::forward<TargetResourceIdT>(value)); return *this;}
    ///@}
    ...
    inline ListExecutionsRequest& WithResolveToResourceType(ResolveToResourceType value) { SetResolveToResourceType(value); return *this;}
    ///@}
    ...
    template<typename ResolveToResourceIdT = Aws::String>
    ListExecutionsRequest& WithResolveToResourceId(ResolveToResourceIdT&& value) { SetResolveToResourceId(std::forward<ResolveToResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionTypeT = Aws::String>
    ListExecutionsRequest& WithActionType(ActionTypeT&& value) { SetActionType(std::forward<ActionTypeT>(value)); return *this;}
    ///@}
  private:
