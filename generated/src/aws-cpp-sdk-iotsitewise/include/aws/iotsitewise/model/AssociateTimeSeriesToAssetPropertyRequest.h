...
class AssociateTimeSeriesToAssetPropertyRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename AliasT = Aws::String>
  AssociateTimeSeriesToAssetPropertyRequest& WithAlias(AliasT&& value) {
  ...
  template <typename AssetIdT = Aws::String>
  AssociateTimeSeriesToAssetPropertyRequest& WithAssetId(AssetIdT&& value) {
  ...
  template <typename PropertyIdT = Aws::String>
  AssociateTimeSeriesToAssetPropertyRequest& WithPropertyId(PropertyIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  AssociateTimeSeriesToAssetPropertyRequest& WithClientToken(ClientTokenT&& value) {
