...
class UpdateComputationModelRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename ComputationModelIdT = Aws::String>
  UpdateComputationModelRequest& WithComputationModelId(ComputationModelIdT&& value) {
  ...
  template <typename ComputationModelNameT = Aws::String>
  UpdateComputationModelRequest& WithComputationModelName(ComputationModelNameT&& value) {
  ...
  template <typename ComputationModelDescriptionT = Aws::String>
  UpdateComputationModelRequest& WithComputationModelDescription(ComputationModelDescriptionT&& value) {
  ...
  template <typename ComputationModelConfigurationT = ComputationModelConfiguration>
  UpdateComputationModelRequest& WithComputationModelConfiguration(ComputationModelConfigurationT&& value) {
  ...
  template <typename ComputationModelDataBindingT = Aws::Map<Aws::String, ComputationModelDataBindingValue>>
  UpdateComputationModelRequest& WithComputationModelDataBinding(ComputationModelDataBindingT&& value) {
  ...
  UpdateComputationModelRequest& AddComputationModelDataBinding(ComputationModelDataBindingKeyT&& key,
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateComputationModelRequest& WithClientToken(ClientTokenT&& value) {
