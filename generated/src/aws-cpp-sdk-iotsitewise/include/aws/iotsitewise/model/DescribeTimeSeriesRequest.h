...
class DescribeTimeSeriesRequest : public IoTSiteWiseRequest {
 public:
  AWS_IOTSITEWISE_API DescribeTimeSeriesRequest() = default;
  ...
  template <typename AliasT = Aws::String>
  DescribeTimeSeriesRequest& WithAlias(AliasT&& value) {
  ...
  template <typename AssetIdT = Aws::String>
  DescribeTimeSeriesRequest& WithAssetId(AssetIdT&& value) {
  ...
  template <typename PropertyIdT = Aws::String>
  DescribeTimeSeriesRequest& WithPropertyId(PropertyIdT&& value) {
  ...
  template <typename WorkspaceNameT = Aws::String>
  DescribeTimeSeriesRequest& WithWorkspaceName(WorkspaceNameT&& value) {
