...
namespace Model
{
  ...
  public:
    ...
    template<typename AliasT = Aws::String>
    DescribeTimeSeriesRequest& WithAlias(AliasT&& value) { SetAlias(std::forward<AliasT>(value)); return *this;}
    ///@}
    ...
    template<typename AssetIdT = Aws::String>
    DescribeTimeSeriesRequest& WithAssetId(AssetIdT&& value) { SetAssetId(std::forward<AssetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PropertyIdT = Aws::String>
    DescribeTimeSeriesRequest& WithPropertyId(PropertyIdT&& value) { SetPropertyId(std::forward<PropertyIdT>(value)); return *this;}
    ///@}
  private:
