...
/**
 * <p>Request structure for UpdatePipeline operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/UpdatePipelineRequest">AWS
 * API Reference</a></p>
 */
class UpdatePipelineRequest : public IoTSiteWiseRequest {
 public:
  AWS_IOTSITEWISE_API UpdatePipelineRequest() = default;
  ...
  template <typename WorkspaceNameT = Aws::String>
  UpdatePipelineRequest& WithWorkspaceName(WorkspaceNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdatePipelineRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename EnvironmentVariablesT = Aws::Map<Aws::String, Aws::String>>
  UpdatePipelineRequest& WithEnvironmentVariables(EnvironmentVariablesT&& value) {
  ...
  UpdatePipelineRequest& AddEnvironmentVariables(EnvironmentVariablesKeyT&& key, EnvironmentVariablesValueT&& value) {
    m_environmentVariablesHasBeenSet = true;
  ...
  template <typename ComputationsT = Aws::Vector<ComputeNode>>
  UpdatePipelineRequest& WithComputations(ComputationsT&& value) {
    SetComputations(std::forward<ComputationsT>(value));
    return *this;
  }
  template <typename ComputationsT = ComputeNode>
  UpdatePipelineRequest& AddComputations(ComputationsT&& value) {
    m_computationsHasBeenSet = true;
