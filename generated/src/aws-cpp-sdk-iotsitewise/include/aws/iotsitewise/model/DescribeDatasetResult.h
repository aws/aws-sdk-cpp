...
class DescribeDatasetResult {
 public:
  ...
  void SetDatasetCreationDate(DatasetCreationDateT&& value) {
    ...
    m_datasetCreationDate = std::forward<DatasetCreationDateT>(value);
  }
  template <typename DatasetCreationDateT = Aws::Utils::DateTime>
  DescribeDatasetResult& WithDatasetCreationDate(DatasetCreationDateT&& value) {
    SetDatasetCreationDate(std::forward<DatasetCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatasetLastUpdateDate(DatasetLastUpdateDateT&& value) {
    ...
    m_datasetLastUpdateDate = std::forward<DatasetLastUpdateDateT>(value);
  }
  template <typename DatasetLastUpdateDateT = Aws::Utils::DateTime>
  DescribeDatasetResult& WithDatasetLastUpdateDate(DatasetLastUpdateDateT&& value) {
    SetDatasetLastUpdateDate(std::forward<DatasetLastUpdateDateT>(value));
    return *this;
  }
  ///@}
