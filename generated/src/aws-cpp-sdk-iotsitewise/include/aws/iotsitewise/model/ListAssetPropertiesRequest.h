...
class ListAssetPropertiesRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename AssetIdT = Aws::String>
  ListAssetPropertiesRequest& WithAssetId(AssetIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssetPropertiesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssetPropertiesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFilter(ListAssetPropertiesFilter value) {
    m_filterHasBeenSet = true;
    m_filter = value;
  }
  inline ListAssetPropertiesRequest& WithFilter(ListAssetPropertiesFilter value) {
    SetFilter(value);
    return *this;
  }
  ///@}
