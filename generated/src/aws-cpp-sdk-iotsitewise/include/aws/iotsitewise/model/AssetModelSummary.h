...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    AssetModelSummary& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ExternalIdT = Aws::String>
    AssetModelSummary& WithExternalId(ExternalIdT&& value) { SetExternalId(std::forward<ExternalIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    AssetModelSummary& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    AssetModelSummary& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline AssetModelSummary& WithAssetModelType(AssetModelType value) { SetAssetModelType(value); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    AssetModelSummary& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationDateT = Aws::Utils::DateTime>
    AssetModelSummary& WithCreationDate(CreationDateT&& value) { SetCreationDate(std::forward<CreationDateT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdateDateT = Aws::Utils::DateTime>
    AssetModelSummary& WithLastUpdateDate(LastUpdateDateT&& value) { SetLastUpdateDate(std::forward<LastUpdateDateT>(value)); return *this;}
    ///@}
    ...
    template<typename StatusT = AssetModelStatus>
    AssetModelSummary& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    AssetModelSummary& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
