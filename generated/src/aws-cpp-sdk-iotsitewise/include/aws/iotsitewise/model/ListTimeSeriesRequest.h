...
class ListTimeSeriesRequest : public IoTSiteWiseRequest {
 public:
  ...
  inline ListTimeSeriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimeSeriesType(ListTimeSeriesType value) {
    m_timeSeriesTypeHasBeenSet = true;
    m_timeSeriesType = value;
  }
  inline ListTimeSeriesRequest& WithTimeSeriesType(ListTimeSeriesType value) {
