...
class ExecuteActionRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename TargetResourceT = TargetResource>
  ExecuteActionRequest& WithTargetResource(TargetResourceT&& value) {
  ...
  template <typename ActionDefinitionIdT = Aws::String>
  ExecuteActionRequest& WithActionDefinitionId(ActionDefinitionIdT&& value) {
  ...
  template <typename ActionPayloadT = ActionPayload>
  ExecuteActionRequest& WithActionPayload(ActionPayloadT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  ExecuteActionRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResolveToT = ResolveTo>
  ExecuteActionRequest& WithResolveTo(ResolveToT&& value) {
