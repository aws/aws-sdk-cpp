...
class GetAssetPropertyAggregatesResult {
 public:
  ...
  void SetAggregatedValues(AggregatedValuesT&& value) {
    m_aggregatedValuesHasBeenSet = true;
    m_aggregatedValues = std::forward<AggregatedValuesT>(value);
  }
  template <typename AggregatedValuesT = Aws::Vector<AggregatedValue>>
  GetAssetPropertyAggregatesResult& WithAggregatedValues(AggregatedValuesT&& value) {
    SetAggregatedValues(std::forward<AggregatedValuesT>(value));
    return *this;
  }
  template <typename AggregatedValuesT = AggregatedValue>
  GetAssetPropertyAggregatesResult& AddAggregatedValues(AggregatedValuesT&& value) {
    m_aggregatedValuesHasBeenSet = true;
    m_aggregatedValues.emplace_back(std::forward<AggregatedValuesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetAssetPropertyAggregatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAssetPropertyAggregatesResult& WithRequestId(RequestIdT&& value) {
