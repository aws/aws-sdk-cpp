...
class DescribeAssetModelCompositeModelResult {
 public:
  ...
  AWS_IOTSITEWISE_API DescribeAssetModelCompositeModelResult& operator=(
  ...
  void SetAssetModelCompositeModelExternalId(AssetModelCompositeModelExternalIdT&& value) {
    ...
    m_assetModelCompositeModelExternalId = std::forward<AssetModelCompositeModelExternalIdT>(value);
  }
  template <typename AssetModelCompositeModelExternalIdT = Aws::String>
  DescribeAssetModelCompositeModelResult& WithAssetModelCompositeModelExternalId(AssetModelCompositeModelExternalIdT&& value) {
    SetAssetModelCompositeModelExternalId(std::forward<AssetModelCompositeModelExternalIdT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<AssetModelCompositeModelPathSegment>& GetAssetModelCompositeModelPath() const {
    return m_assetModelCompositeModelPath;
  }
  ...
  void SetAssetModelCompositeModelPath(AssetModelCompositeModelPathT&& value) {
    ...
    m_assetModelCompositeModelPath = std::forward<AssetModelCompositeModelPathT>(value);
  }
  template <typename AssetModelCompositeModelPathT = Aws::Vector<AssetModelCompositeModelPathSegment>>
  DescribeAssetModelCompositeModelResult& WithAssetModelCompositeModelPath(AssetModelCompositeModelPathT&& value) {
    SetAssetModelCompositeModelPath(std::forward<AssetModelCompositeModelPathT>(value));
    return *this;
  }
  ...
  DescribeAssetModelCompositeModelResult& AddAssetModelCompositeModelPath(AssetModelCompositeModelPathT&& value) {
    m_assetModelCompositeModelPathHasBeenSet = true;
    m_assetModelCompositeModelPath.emplace_back(std::forward<AssetModelCompositeModelPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssetModelCompositeModelName(AssetModelCompositeModelNameT&& value) {
    ...
    m_assetModelCompositeModelName = std::forward<AssetModelCompositeModelNameT>(value);
  }
  template <typename AssetModelCompositeModelNameT = Aws::String>
  DescribeAssetModelCompositeModelResult& WithAssetModelCompositeModelName(AssetModelCompositeModelNameT&& value) {
    SetAssetModelCompositeModelName(std::forward<AssetModelCompositeModelNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssetModelCompositeModelDescription(AssetModelCompositeModelDescriptionT&& value) {
    ...
    m_assetModelCompositeModelDescription = std::forward<AssetModelCompositeModelDescriptionT>(value);
  }
  template <typename AssetModelCompositeModelDescriptionT = Aws::String>
  DescribeAssetModelCompositeModelResult& WithAssetModelCompositeModelDescription(AssetModelCompositeModelDescriptionT&& value) {
    SetAssetModelCompositeModelDescription(std::forward<AssetModelCompositeModelDescriptionT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<AssetModelProperty>& GetAssetModelCompositeModelProperties() const {
    return m_assetModelCompositeModelProperties;
  }
  ...
  void SetAssetModelCompositeModelProperties(AssetModelCompositeModelPropertiesT&& value) {
    ...
    m_assetModelCompositeModelProperties = std::forward<AssetModelCompositeModelPropertiesT>(value);
  }
  template <typename AssetModelCompositeModelPropertiesT = Aws::Vector<AssetModelProperty>>
  DescribeAssetModelCompositeModelResult& WithAssetModelCompositeModelProperties(AssetModelCompositeModelPropertiesT&& value) {
    SetAssetModelCompositeModelProperties(std::forward<AssetModelCompositeModelPropertiesT>(value));
    return *this;
  }
  ...
  DescribeAssetModelCompositeModelResult& AddAssetModelCompositeModelProperties(AssetModelCompositeModelPropertiesT&& value) {
    m_assetModelCompositeModelPropertiesHasBeenSet = true;
    m_assetModelCompositeModelProperties.emplace_back(std::forward<AssetModelCompositeModelPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCompositionDetails(CompositionDetailsT&& value) {
    ...
    m_compositionDetails = std::forward<CompositionDetailsT>(value);
  }
  template <typename CompositionDetailsT = CompositionDetails>
  DescribeAssetModelCompositeModelResult& WithCompositionDetails(CompositionDetailsT&& value) {
    SetCompositionDetails(std::forward<CompositionDetailsT>(value));
    return *this;
  }
  ///@}
