...
class ListAssetModelsRequest : public IoTSiteWiseRequest {
 public:
  ...
  void SetAssetModelTypes(AssetModelTypesT&& value) {
    m_assetModelTypesHasBeenSet = true;
    m_assetModelTypes = std::forward<AssetModelTypesT>(value);
  }
  template <typename AssetModelTypesT = Aws::Vector<AssetModelType>>
  ListAssetModelsRequest& WithAssetModelTypes(AssetModelTypesT&& value) {
    SetAssetModelTypes(std::forward<AssetModelTypesT>(value));
    return *this;
  }
  inline ListAssetModelsRequest& AddAssetModelTypes(AssetModelType value) {
    m_assetModelTypesHasBeenSet = true;
    m_assetModelTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssetModelsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssetModelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename AssetModelVersionT = Aws::String>
  ListAssetModelsRequest& WithAssetModelVersion(AssetModelVersionT&& value) {
