...
class CompositionDetails {
 public:
  ...
  void SetCompositionRelationship(CompositionRelationshipT&& value) {
    m_compositionRelationshipHasBeenSet = true;
    m_compositionRelationship = std::forward<CompositionRelationshipT>(value);
  }
  template <typename CompositionRelationshipT = Aws::Vector<CompositionRelationshipItem>>
  CompositionDetails& WithCompositionRelationship(CompositionRelationshipT&& value) {
    SetCompositionRelationship(std::forward<CompositionRelationshipT>(value));
    return *this;
  }
  template <typename CompositionRelationshipT = CompositionRelationshipItem>
  CompositionDetails& AddCompositionRelationship(CompositionRelationshipT&& value) {
    m_compositionRelationshipHasBeenSet = true;
    m_compositionRelationship.emplace_back(std::forward<CompositionRelationshipT>(value));
    return *this;
  }
  ///@}
 private:
