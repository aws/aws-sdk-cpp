...
class BatchGetAssetPropertyValueHistorySuccessEntry {
 public:
  ...
  template <typename EntryIdT = Aws::String>
  BatchGetAssetPropertyValueHistorySuccessEntry& WithEntryId(EntryIdT&& value) {
  ...
  template <typename AssetPropertyValueHistoryT = Aws::Vector<AssetPropertyValue>>
  BatchGetAssetPropertyValueHistorySuccessEntry& WithAssetPropertyValueHistory(AssetPropertyValueHistoryT&& value) {
  ...
  BatchGetAssetPropertyValueHistorySuccessEntry& AddAssetPropertyValueHistory(AssetPropertyValueHistoryT&& value) {
    m_assetPropertyValueHistoryHasBeenSet = true;
