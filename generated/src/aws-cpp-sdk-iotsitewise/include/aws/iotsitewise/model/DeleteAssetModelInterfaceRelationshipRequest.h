...
class DeleteAssetModelInterfaceRelationshipRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename AssetModelIdT = Aws::String>
  DeleteAssetModelInterfaceRelationshipRequest& WithAssetModelId(AssetModelIdT&& value) {
  ...
  template <typename InterfaceAssetModelIdT = Aws::String>
  DeleteAssetModelInterfaceRelationshipRequest& WithInterfaceAssetModelId(InterfaceAssetModelIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteAssetModelInterfaceRelationshipRequest& WithClientToken(ClientTokenT&& value) {
