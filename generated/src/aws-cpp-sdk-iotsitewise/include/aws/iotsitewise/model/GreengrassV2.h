...
class GreengrassV2 {
 public:
  ...
  inline void SetCoreDeviceOperatingSystem(CoreDeviceOperatingSystem value) {
    m_coreDeviceOperatingSystemHasBeenSet = true;
    m_coreDeviceOperatingSystem = value;
  }
  inline GreengrassV2& WithCoreDeviceOperatingSystem(CoreDeviceOperatingSystem value) {
    SetCoreDeviceOperatingSystem(value);
    return *this;
  }
  ///@}
 private:
