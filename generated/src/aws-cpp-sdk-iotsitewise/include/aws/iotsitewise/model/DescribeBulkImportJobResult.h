...
class DescribeBulkImportJobResult {
 public:
  ...
  inline DescribeBulkImportJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetJobLastUpdateDate(JobLastUpdateDateT&& value) {
    ...
    m_jobLastUpdateDate = std::forward<JobLastUpdateDateT>(value);
  }
  template <typename JobLastUpdateDateT = Aws::Utils::DateTime>
  DescribeBulkImportJobResult& WithJobLastUpdateDate(JobLastUpdateDateT&& value) {
    SetJobLastUpdateDate(std::forward<JobLastUpdateDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAdaptiveIngestion(bool value) {
    m_adaptiveIngestionHasBeenSet = true;
    m_adaptiveIngestion = value;
  }
  inline DescribeBulkImportJobResult& WithAdaptiveIngestion(bool value) {
    SetAdaptiveIngestion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeleteFilesAfterImport(bool value) {
    m_deleteFilesAfterImportHasBeenSet = true;
    m_deleteFilesAfterImport = value;
  }
  inline DescribeBulkImportJobResult& WithDeleteFilesAfterImport(bool value) {
    SetDeleteFilesAfterImport(value);
    return *this;
  }
  ///@}
