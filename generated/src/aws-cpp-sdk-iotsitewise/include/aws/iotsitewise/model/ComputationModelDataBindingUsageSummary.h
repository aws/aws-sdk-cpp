...
class ComputationModelDataBindingUsageSummary {
 public:
  ...
  void SetComputationModelIds(ComputationModelIdsT&& value) {
    m_computationModelIdsHasBeenSet = true;
    m_computationModelIds = std::forward<ComputationModelIdsT>(value);
  }
  template <typename ComputationModelIdsT = Aws::Vector<Aws::String>>
  ComputationModelDataBindingUsageSummary& WithComputationModelIds(ComputationModelIdsT&& value) {
    SetComputationModelIds(std::forward<ComputationModelIdsT>(value));
    return *this;
  }
  template <typename ComputationModelIdsT = Aws::String>
  ComputationModelDataBindingUsageSummary& AddComputationModelIds(ComputationModelIdsT&& value) {
    m_computationModelIdsHasBeenSet = true;
    m_computationModelIds.emplace_back(std::forward<ComputationModelIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMatchedDataBinding(MatchedDataBindingT&& value) {
    m_matchedDataBindingHasBeenSet = true;
    m_matchedDataBinding = std::forward<MatchedDataBindingT>(value);
  }
  template <typename MatchedDataBindingT = MatchedDataBinding>
  ComputationModelDataBindingUsageSummary& WithMatchedDataBinding(MatchedDataBindingT&& value) {
    SetMatchedDataBinding(std::forward<MatchedDataBindingT>(value));
    return *this;
  }
  ///@}
 private:
