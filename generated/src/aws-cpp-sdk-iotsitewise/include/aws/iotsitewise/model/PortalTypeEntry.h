...
class PortalTypeEntry {
 public:
  ...
  void SetPortalTools(PortalToolsT&& value) {
    m_portalToolsHasBeenSet = true;
    m_portalTools = std::forward<PortalToolsT>(value);
  }
  template <typename PortalToolsT = Aws::Vector<Aws::String>>
  PortalTypeEntry& WithPortalTools(PortalToolsT&& value) {
    SetPortalTools(std::forward<PortalToolsT>(value));
    return *this;
  }
  template <typename PortalToolsT = Aws::String>
  PortalTypeEntry& AddPortalTools(PortalToolsT&& value) {
    m_portalToolsHasBeenSet = true;
    m_portalTools.emplace_back(std::forward<PortalToolsT>(value));
    return *this;
  }
  ///@}
 private:
