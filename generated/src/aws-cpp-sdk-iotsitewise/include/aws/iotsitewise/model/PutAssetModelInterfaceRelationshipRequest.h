...
class PutAssetModelInterfaceRelationshipRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename AssetModelIdT = Aws::String>
  PutAssetModelInterfaceRelationshipRequest& WithAssetModelId(AssetModelIdT&& value) {
  ...
  template <typename InterfaceAssetModelIdT = Aws::String>
  PutAssetModelInterfaceRelationshipRequest& WithInterfaceAssetModelId(InterfaceAssetModelIdT&& value) {
  ...
  void SetPropertyMappingConfiguration(PropertyMappingConfigurationT&& value) {
    m_propertyMappingConfigurationHasBeenSet = true;
    m_propertyMappingConfiguration = std::forward<PropertyMappingConfigurationT>(value);
  }
  template <typename PropertyMappingConfigurationT = PropertyMappingConfiguration>
  PutAssetModelInterfaceRelationshipRequest& WithPropertyMappingConfiguration(PropertyMappingConfigurationT&& value) {
    SetPropertyMappingConfiguration(std::forward<PropertyMappingConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  PutAssetModelInterfaceRelationshipRequest& WithClientToken(ClientTokenT&& value) {
