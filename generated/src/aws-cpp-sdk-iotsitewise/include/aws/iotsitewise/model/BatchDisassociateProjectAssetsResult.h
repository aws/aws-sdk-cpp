...
class BatchDisassociateProjectAssetsResult {
 public:
  ...
  AWS_IOTSITEWISE_API BatchDisassociateProjectAssetsResult& operator=(
  ...
  template <typename ErrorsT = Aws::Vector<AssetErrorDetails>>
  BatchDisassociateProjectAssetsResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = AssetErrorDetails>
  BatchDisassociateProjectAssetsResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDisassociateProjectAssetsResult& WithRequestId(RequestIdT&& value) {
