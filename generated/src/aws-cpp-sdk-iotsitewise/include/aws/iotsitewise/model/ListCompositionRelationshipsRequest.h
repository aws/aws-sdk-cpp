...
class ListCompositionRelationshipsRequest : public IoTSiteWiseRequest {
 public:
  AWS_IOTSITEWISE_API ListCompositionRelationshipsRequest() = default;
  ...
  template <typename AssetModelIdT = Aws::String>
  ListCompositionRelationshipsRequest& WithAssetModelId(AssetModelIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListCompositionRelationshipsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCompositionRelationshipsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
