...
class ListAssetPropertiesResult {
 public:
  ...
  void SetAssetPropertySummaries(AssetPropertySummariesT&& value) {
    m_assetPropertySummariesHasBeenSet = true;
    m_assetPropertySummaries = std::forward<AssetPropertySummariesT>(value);
  }
  template <typename AssetPropertySummariesT = Aws::Vector<AssetPropertySummary>>
  ListAssetPropertiesResult& WithAssetPropertySummaries(AssetPropertySummariesT&& value) {
    SetAssetPropertySummaries(std::forward<AssetPropertySummariesT>(value));
    return *this;
  }
  template <typename AssetPropertySummariesT = AssetPropertySummary>
  ListAssetPropertiesResult& AddAssetPropertySummaries(AssetPropertySummariesT&& value) {
    m_assetPropertySummariesHasBeenSet = true;
    m_assetPropertySummaries.emplace_back(std::forward<AssetPropertySummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssetPropertiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssetPropertiesResult& WithRequestId(RequestIdT&& value) {
