...
class ListComputationModelsRequest : public IoTSiteWiseRequest {
 public:
  ...
  inline void SetComputationModelType(ComputationModelType value) {
    m_computationModelTypeHasBeenSet = true;
    m_computationModelType = value;
  }
  inline ListComputationModelsRequest& WithComputationModelType(ComputationModelType value) {
    SetComputationModelType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListComputationModelsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListComputationModelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
