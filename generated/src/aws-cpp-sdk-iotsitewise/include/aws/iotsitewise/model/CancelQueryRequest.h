...
/**
 */
class CancelQueryRequest : public IoTSiteWiseRequest {
 public:
  AWS_IOTSITEWISE_API CancelQueryRequest() = default;
  ...
  template <typename WorkspaceNameT = Aws::String>
  CancelQueryRequest& WithWorkspaceName(WorkspaceNameT&& value) {
