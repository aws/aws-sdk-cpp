...
class DescribeGatewayCapabilityConfigurationResult {
 public:
  ...
  AWS_IOTSITEWISE_API DescribeGatewayCapabilityConfigurationResult& operator=(
  ...
  template <typename GatewayIdT = Aws::String>
  DescribeGatewayCapabilityConfigurationResult& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename CapabilityNamespaceT = Aws::String>
  DescribeGatewayCapabilityConfigurationResult& WithCapabilityNamespace(CapabilityNamespaceT&& value) {
  ...
  template <typename CapabilityConfigurationT = Aws::String>
  DescribeGatewayCapabilityConfigurationResult& WithCapabilityConfiguration(CapabilityConfigurationT&& value) {
  ...
  inline DescribeGatewayCapabilityConfigurationResult& WithCapabilitySyncStatus(CapabilitySyncStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeGatewayCapabilityConfigurationResult& WithRequestId(RequestIdT&& value) {
