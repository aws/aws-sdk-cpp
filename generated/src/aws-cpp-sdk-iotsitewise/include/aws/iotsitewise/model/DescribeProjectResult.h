...
class DescribeProjectResult {
 public:
  ...
  void SetProjectCreationDate(ProjectCreationDateT&& value) {
    ...
    m_projectCreationDate = std::forward<ProjectCreationDateT>(value);
  }
  template <typename ProjectCreationDateT = Aws::Utils::DateTime>
  DescribeProjectResult& WithProjectCreationDate(ProjectCreationDateT&& value) {
    SetProjectCreationDate(std::forward<ProjectCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProjectLastUpdateDate(ProjectLastUpdateDateT&& value) {
    ...
    m_projectLastUpdateDate = std::forward<ProjectLastUpdateDateT>(value);
  }
  template <typename ProjectLastUpdateDateT = Aws::Utils::DateTime>
  DescribeProjectResult& WithProjectLastUpdateDate(ProjectLastUpdateDateT&& value) {
    SetProjectLastUpdateDate(std::forward<ProjectLastUpdateDateT>(value));
    return *this;
  }
  ///@}
