...
class AssetRelationshipSummary {
 public:
  ...
  void SetHierarchyInfo(HierarchyInfoT&& value) {
    ...
    m_hierarchyInfo = std::forward<HierarchyInfoT>(value);
  }
  template <typename HierarchyInfoT = AssetHierarchyInfo>
  AssetRelationshipSummary& WithHierarchyInfo(HierarchyInfoT&& value) {
    SetHierarchyInfo(std::forward<HierarchyInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRelationshipType(AssetRelationshipType value) {
    m_relationshipTypeHasBeenSet = true;
    m_relationshipType = value;
  }
  inline AssetRelationshipSummary& WithRelationshipType(AssetRelationshipType value) {
