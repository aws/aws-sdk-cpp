...
class BatchGetAssetPropertyAggregatesSkippedEntry {
 public:
  ...
  template <typename EntryIdT = Aws::String>
  BatchGetAssetPropertyAggregatesSkippedEntry& WithEntryId(EntryIdT&& value) {
  ...
  inline BatchGetAssetPropertyAggregatesSkippedEntry& WithCompletionStatus(BatchEntryCompletionStatus value) {
  ...
  template <typename ErrorInfoT = BatchGetAssetPropertyAggregatesErrorInfo>
  BatchGetAssetPropertyAggregatesSkippedEntry& WithErrorInfo(ErrorInfoT&& value) {
