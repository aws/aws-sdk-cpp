...
class DescribePortalResult {
 public:
  ...
  void SetPortalClientId(PortalClientIdT&& value) {
    ...
    m_portalClientId = std::forward<PortalClientIdT>(value);
  }
  template <typename PortalClientIdT = Aws::String>
  DescribePortalResult& WithPortalClientId(PortalClientIdT&& value) {
    SetPortalClientId(std::forward<PortalClientIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPortalCreationDate(PortalCreationDateT&& value) {
    ...
    m_portalCreationDate = std::forward<PortalCreationDateT>(value);
  }
  template <typename PortalCreationDateT = Aws::Utils::DateTime>
  DescribePortalResult& WithPortalCreationDate(PortalCreationDateT&& value) {
    SetPortalCreationDate(std::forward<PortalCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPortalLastUpdateDate(PortalLastUpdateDateT&& value) {
    ...
    m_portalLastUpdateDate = std::forward<PortalLastUpdateDateT>(value);
  }
  template <typename PortalLastUpdateDateT = Aws::Utils::DateTime>
  DescribePortalResult& WithPortalLastUpdateDate(PortalLastUpdateDateT&& value) {
    SetPortalLastUpdateDate(std::forward<PortalLastUpdateDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPortalLogoImageLocation(PortalLogoImageLocationT&& value) {
    ...
    m_portalLogoImageLocation = std::forward<PortalLogoImageLocationT>(value);
  }
  template <typename PortalLogoImageLocationT = ImageLocation>
  DescribePortalResult& WithPortalLogoImageLocation(PortalLogoImageLocationT&& value) {
    SetPortalLogoImageLocation(std::forward<PortalLogoImageLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribePortalResult& WithPortalAuthMode(AuthMode value) {
  ...
  inline DescribePortalResult& WithPortalType(PortalType value) {
    SetPortalType(value);
    return *this;
  }
  ///@}
