...
class ListAssetRelationshipsRequest : public IoTSiteWiseRequest {
 public:
   ...
   * result.</p> </li> </ul>
   */
  inline TraversalType GetTraversalType() const { return m_traversalType; }
  inline bool TraversalTypeHasBeenSet() const { return m_traversalTypeHasBeenSet; }
  inline void SetTraversalType(TraversalType value) {
    m_traversalTypeHasBeenSet = true;
    m_traversalType = value;
  }
  inline ListAssetRelationshipsRequest& WithTraversalType(TraversalType value) {
  ...
  inline ListAssetRelationshipsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
