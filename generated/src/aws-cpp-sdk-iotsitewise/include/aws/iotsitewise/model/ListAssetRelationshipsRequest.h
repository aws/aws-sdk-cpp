...
namespace Model
{
  ...
  public:
    ...
    template<typename AssetIdT = Aws::String>
    ListAssetRelationshipsRequest& WithAssetId(AssetIdT&& value) { SetAssetId(std::forward<AssetIdT>(value)); return *this;}
    ///@}
    ...
    inline void SetTraversalType(TraversalType value) { m_traversalTypeHasBeenSet = true; m_traversalType = value; }
    inline ListAssetRelationshipsRequest& WithTraversalType(TraversalType value) { SetTraversalType(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAssetRelationshipsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
