...
class HierarchyMapping {
 public:
  ...
  void SetAssetModelHierarchyId(AssetModelHierarchyIdT&& value) {
    m_assetModelHierarchyIdHasBeenSet = true;
    m_assetModelHierarchyId = std::forward<AssetModelHierarchyIdT>(value);
  }
  template <typename AssetModelHierarchyIdT = Aws::String>
  HierarchyMapping& WithAssetModelHierarchyId(AssetModelHierarchyIdT&& value) {
    SetAssetModelHierarchyId(std::forward<AssetModelHierarchyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInterfaceAssetModelHierarchyId(InterfaceAssetModelHierarchyIdT&& value) {
    m_interfaceAssetModelHierarchyIdHasBeenSet = true;
    m_interfaceAssetModelHierarchyId = std::forward<InterfaceAssetModelHierarchyIdT>(value);
  }
  template <typename InterfaceAssetModelHierarchyIdT = Aws::String>
  HierarchyMapping& WithInterfaceAssetModelHierarchyId(InterfaceAssetModelHierarchyIdT&& value) {
    SetInterfaceAssetModelHierarchyId(std::forward<InterfaceAssetModelHierarchyIdT>(value));
    return *this;
  }
  ///@}
 private:
