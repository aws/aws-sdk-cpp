...
class DescribeExecutionResult {
 public:
  ...
  template <typename ActionTypeT = Aws::String>
  DescribeExecutionResult& WithActionType(ActionTypeT&& value) {
  ...
  template <typename TargetResourceT = TargetResource>
  DescribeExecutionResult& WithTargetResource(TargetResourceT&& value) {
  ...
  template <typename TargetResourceVersionT = Aws::String>
  DescribeExecutionResult& WithTargetResourceVersion(TargetResourceVersionT&& value) {
  ...
  template <typename ResolveToT = ResolveTo>
  DescribeExecutionResult& WithResolveTo(ResolveToT&& value) {
  ...
  template <typename ExecutionStartTimeT = Aws::Utils::DateTime>
  DescribeExecutionResult& WithExecutionStartTime(ExecutionStartTimeT&& value) {
  ...
  template <typename ExecutionEndTimeT = Aws::Utils::DateTime>
  DescribeExecutionResult& WithExecutionEndTime(ExecutionEndTimeT&& value) {
  ...
  template <typename ExecutionStatusT = ExecutionStatus>
  DescribeExecutionResult& WithExecutionStatus(ExecutionStatusT&& value) {
  ...
  template <typename ExecutionResultT = Aws::Map<Aws::String, Aws::String>>
  DescribeExecutionResult& WithExecutionResult(ExecutionResultT&& value) {
  ...
  DescribeExecutionResult& AddExecutionResult(ExecutionResultKeyT&& key, ExecutionResultValueT&& value) {
    m_executionResultHasBeenSet = true;
    m_executionResult.emplace(std::forward<ExecutionResultKeyT>(key), std::forward<ExecutionResultValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExecutionDetailsT = Aws::Map<Aws::String, Aws::String>>
  DescribeExecutionResult& WithExecutionDetails(ExecutionDetailsT&& value) {
  ...
  DescribeExecutionResult& AddExecutionDetails(ExecutionDetailsKeyT&& key, ExecutionDetailsValueT&& value) {
    m_executionDetailsHasBeenSet = true;
    m_executionDetails.emplace(std::forward<ExecutionDetailsKeyT>(key), std::forward<ExecutionDetailsValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExecutionEntityVersionT = Aws::String>
  DescribeExecutionResult& WithExecutionEntityVersion(ExecutionEntityVersionT&& value) {
