...
class TimeInNanos {
 public:
  ...
  inline void SetTimeInSeconds(long long value) {
    m_timeInSecondsHasBeenSet = true;
    m_timeInSeconds = value;
  }
  inline TimeInNanos& WithTimeInSeconds(long long value) {
  ...
  inline void SetOffsetInNanos(int value) {
    m_offsetInNanosHasBeenSet = true;
    m_offsetInNanos = value;
  }
  inline TimeInNanos& WithOffsetInNanos(int value) {
    SetOffsetInNanos(value);
    return *this;
  }
  ///@}
 private:
