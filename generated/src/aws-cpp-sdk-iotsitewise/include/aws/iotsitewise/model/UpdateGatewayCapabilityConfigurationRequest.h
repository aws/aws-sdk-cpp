...
class UpdateGatewayCapabilityConfigurationRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename GatewayIdT = Aws::String>
  UpdateGatewayCapabilityConfigurationRequest& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename CapabilityNamespaceT = Aws::String>
  UpdateGatewayCapabilityConfigurationRequest& WithCapabilityNamespace(CapabilityNamespaceT&& value) {
  ...
  template <typename CapabilityConfigurationT = Aws::String>
  UpdateGatewayCapabilityConfigurationRequest& WithCapabilityConfiguration(CapabilityConfigurationT&& value) {
