...
class CreatePortalRequest : public IoTSiteWiseRequest {
 public:
  ...
  void SetPortalName(PortalNameT&& value) {
    ...
    m_portalName = std::forward<PortalNameT>(value);
  }
  template <typename PortalNameT = Aws::String>
  CreatePortalRequest& WithPortalName(PortalNameT&& value) {
    SetPortalName(std::forward<PortalNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPortalDescription(PortalDescriptionT&& value) {
    ...
    m_portalDescription = std::forward<PortalDescriptionT>(value);
  }
  template <typename PortalDescriptionT = Aws::String>
  CreatePortalRequest& WithPortalDescription(PortalDescriptionT&& value) {
    SetPortalDescription(std::forward<PortalDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPortalContactEmail(PortalContactEmailT&& value) {
    ...
    m_portalContactEmail = std::forward<PortalContactEmailT>(value);
  }
  template <typename PortalContactEmailT = Aws::String>
  CreatePortalRequest& WithPortalContactEmail(PortalContactEmailT&& value) {
    SetPortalContactEmail(std::forward<PortalContactEmailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPortalLogoImageFile(PortalLogoImageFileT&& value) {
    m_portalLogoImageFileHasBeenSet = true;
    m_portalLogoImageFile = std::forward<PortalLogoImageFileT>(value);
  }
  template <typename PortalLogoImageFileT = ImageFile>
  CreatePortalRequest& WithPortalLogoImageFile(PortalLogoImageFileT&& value) {
    SetPortalLogoImageFile(std::forward<PortalLogoImageFileT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPortalAuthMode(AuthMode value) {
    m_portalAuthModeHasBeenSet = true;
    m_portalAuthMode = value;
  }
  inline CreatePortalRequest& WithPortalAuthMode(AuthMode value) {
    SetPortalAuthMode(value);
    return *this;
  }
  ///@}
  ...
  void SetNotificationSenderEmail(NotificationSenderEmailT&& value) {
    ...
    m_notificationSenderEmail = std::forward<NotificationSenderEmailT>(value);
  }
  template <typename NotificationSenderEmailT = Aws::String>
  CreatePortalRequest& WithNotificationSenderEmail(NotificationSenderEmailT&& value) {
    SetNotificationSenderEmail(std::forward<NotificationSenderEmailT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPortalType(PortalType value) {
    m_portalTypeHasBeenSet = true;
    m_portalType = value;
  }
  inline CreatePortalRequest& WithPortalType(PortalType value) {
    SetPortalType(value);
    return *this;
  }
  ///@}
  ...
  void SetPortalTypeConfiguration(PortalTypeConfigurationT&& value) {
    ...
    m_portalTypeConfiguration = std::forward<PortalTypeConfigurationT>(value);
  }
  template <typename PortalTypeConfigurationT = Aws::Map<Aws::String, PortalTypeEntry>>
  CreatePortalRequest& WithPortalTypeConfiguration(PortalTypeConfigurationT&& value) {
    SetPortalTypeConfiguration(std::forward<PortalTypeConfigurationT>(value));
    return *this;
  }
  ...
  CreatePortalRequest& AddPortalTypeConfiguration(PortalTypeConfigurationKeyT&& key, PortalTypeConfigurationValueT&& value) {
    m_portalTypeConfigurationHasBeenSet = true;
    m_portalTypeConfiguration.emplace(std::forward<PortalTypeConfigurationKeyT>(key), std::forward<PortalTypeConfigurationValueT>(value));
    return *this;
  }
  ///@}
 private:
