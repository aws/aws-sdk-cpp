...
class DescribeDashboardResult {
 public:
  ...
  void SetDashboardDescription(DashboardDescriptionT&& value) {
    ...
    m_dashboardDescription = std::forward<DashboardDescriptionT>(value);
  }
  template <typename DashboardDescriptionT = Aws::String>
  DescribeDashboardResult& WithDashboardDescription(DashboardDescriptionT&& value) {
    SetDashboardDescription(std::forward<DashboardDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDashboardDefinition(DashboardDefinitionT&& value) {
    ...
    m_dashboardDefinition = std::forward<DashboardDefinitionT>(value);
  }
  template <typename DashboardDefinitionT = Aws::String>
  DescribeDashboardResult& WithDashboardDefinition(DashboardDefinitionT&& value) {
    SetDashboardDefinition(std::forward<DashboardDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDashboardCreationDate(DashboardCreationDateT&& value) {
    ...
    m_dashboardCreationDate = std::forward<DashboardCreationDateT>(value);
  }
  template <typename DashboardCreationDateT = Aws::Utils::DateTime>
  DescribeDashboardResult& WithDashboardCreationDate(DashboardCreationDateT&& value) {
    SetDashboardCreationDate(std::forward<DashboardCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDashboardLastUpdateDate(DashboardLastUpdateDateT&& value) {
    ...
    m_dashboardLastUpdateDate = std::forward<DashboardLastUpdateDateT>(value);
  }
  template <typename DashboardLastUpdateDateT = Aws::Utils::DateTime>
  DescribeDashboardResult& WithDashboardLastUpdateDate(DashboardLastUpdateDateT&& value) {
    SetDashboardLastUpdateDate(std::forward<DashboardLastUpdateDateT>(value));
    return *this;
  }
  ///@}
