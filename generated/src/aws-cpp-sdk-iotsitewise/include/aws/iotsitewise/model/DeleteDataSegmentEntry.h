...
/**
 * <p>Contains information about a data segment entry to delete.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/DeleteDataSegmentEntry">AWS
 * API Reference</a></p>
 */
class DeleteDataSegmentEntry {
 public:
  AWS_IOTSITEWISE_API DeleteDataSegmentEntry() = default;
  AWS_IOTSITEWISE_API DeleteDataSegmentEntry(Aws::Utils::Json::JsonView jsonValue);
  AWS_IOTSITEWISE_API DeleteDataSegmentEntry& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename TimeSeriesIdT = Aws::String>
  DeleteDataSegmentEntry& WithTimeSeriesId(TimeSeriesIdT&& value) {
  ...
  template <typename StartTimestampT = TimeInNanos>
  DeleteDataSegmentEntry& WithStartTimestamp(StartTimestampT&& value) {
  ...
  template <typename EndTimestampT = TimeInNanos>
  DeleteDataSegmentEntry& WithEndTimestamp(EndTimestampT&& value) {
