...
namespace Model
{
  ...
  {
  public:
    AWS_IOTSITEWISE_API DisassociateTimeSeriesFromAssetPropertyRequest() = default;
    ...
    template<typename AliasT = Aws::String>
    DisassociateTimeSeriesFromAssetPropertyRequest& WithAlias(AliasT&& value) { SetAlias(std::forward<AliasT>(value)); return *this;}
    ///@}
    ...
    template<typename AssetIdT = Aws::String>
    DisassociateTimeSeriesFromAssetPropertyRequest& WithAssetId(AssetIdT&& value) { SetAssetId(std::forward<AssetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PropertyIdT = Aws::String>
    DisassociateTimeSeriesFromAssetPropertyRequest& WithPropertyId(PropertyIdT&& value) { SetPropertyId(std::forward<PropertyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    DisassociateTimeSeriesFromAssetPropertyRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
  private:
