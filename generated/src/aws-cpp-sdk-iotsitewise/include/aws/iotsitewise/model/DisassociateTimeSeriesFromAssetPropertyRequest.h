...
class DisassociateTimeSeriesFromAssetPropertyRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename AliasT = Aws::String>
  DisassociateTimeSeriesFromAssetPropertyRequest& WithAlias(AliasT&& value) {
  ...
  template <typename AssetIdT = Aws::String>
  DisassociateTimeSeriesFromAssetPropertyRequest& WithAssetId(AssetIdT&& value) {
  ...
  template <typename PropertyIdT = Aws::String>
  DisassociateTimeSeriesFromAssetPropertyRequest& WithPropertyId(PropertyIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DisassociateTimeSeriesFromAssetPropertyRequest& WithClientToken(ClientTokenT&& value) {
