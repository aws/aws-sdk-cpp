...
class ListAssetModelsResult {
 public:
  ...
  void SetAssetModelSummaries(AssetModelSummariesT&& value) {
    m_assetModelSummariesHasBeenSet = true;
    m_assetModelSummaries = std::forward<AssetModelSummariesT>(value);
  }
  template <typename AssetModelSummariesT = Aws::Vector<AssetModelSummary>>
  ListAssetModelsResult& WithAssetModelSummaries(AssetModelSummariesT&& value) {
    SetAssetModelSummaries(std::forward<AssetModelSummariesT>(value));
    return *this;
  }
  template <typename AssetModelSummariesT = AssetModelSummary>
  ListAssetModelsResult& AddAssetModelSummaries(AssetModelSummariesT&& value) {
    m_assetModelSummariesHasBeenSet = true;
    m_assetModelSummaries.emplace_back(std::forward<AssetModelSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssetModelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssetModelsResult& WithRequestId(RequestIdT&& value) {
