...
class DescribeAssetModelRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename AssetModelIdT = Aws::String>
  DescribeAssetModelRequest& WithAssetModelId(AssetModelIdT&& value) {
  ...
  inline DescribeAssetModelRequest& WithExcludeProperties(bool value) {
  ...
  template <typename AssetModelVersionT = Aws::String>
  DescribeAssetModelRequest& WithAssetModelVersion(AssetModelVersionT&& value) {
