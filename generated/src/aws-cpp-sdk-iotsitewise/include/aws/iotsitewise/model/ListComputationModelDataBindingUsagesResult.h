...
class ListComputationModelDataBindingUsagesResult {
 public:
  ...
  AWS_IOTSITEWISE_API ListComputationModelDataBindingUsagesResult& operator=(
   ...
   * binding details.</p>
   */
  inline const Aws::Vector<ComputationModelDataBindingUsageSummary>& GetDataBindingUsageSummaries() const {
    return m_dataBindingUsageSummaries;
  }
  template <typename DataBindingUsageSummariesT = Aws::Vector<ComputationModelDataBindingUsageSummary>>
  void SetDataBindingUsageSummaries(DataBindingUsageSummariesT&& value) {
    m_dataBindingUsageSummariesHasBeenSet = true;
    m_dataBindingUsageSummaries = std::forward<DataBindingUsageSummariesT>(value);
  }
  template <typename DataBindingUsageSummariesT = Aws::Vector<ComputationModelDataBindingUsageSummary>>
  ListComputationModelDataBindingUsagesResult& WithDataBindingUsageSummaries(DataBindingUsageSummariesT&& value) {
    SetDataBindingUsageSummaries(std::forward<DataBindingUsageSummariesT>(value));
    return *this;
  }
  template <typename DataBindingUsageSummariesT = ComputationModelDataBindingUsageSummary>
  ListComputationModelDataBindingUsagesResult& AddDataBindingUsageSummaries(DataBindingUsageSummariesT&& value) {
    m_dataBindingUsageSummariesHasBeenSet = true;
    m_dataBindingUsageSummaries.emplace_back(std::forward<DataBindingUsageSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListComputationModelDataBindingUsagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListComputationModelDataBindingUsagesResult& WithRequestId(RequestIdT&& value) {
