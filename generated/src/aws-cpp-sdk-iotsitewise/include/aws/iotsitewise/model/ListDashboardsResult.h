...
class ListDashboardsResult {
 public:
  ...
  void SetDashboardSummaries(DashboardSummariesT&& value) {
    m_dashboardSummariesHasBeenSet = true;
    m_dashboardSummaries = std::forward<DashboardSummariesT>(value);
  }
  template <typename DashboardSummariesT = Aws::Vector<DashboardSummary>>
  ListDashboardsResult& WithDashboardSummaries(DashboardSummariesT&& value) {
    SetDashboardSummaries(std::forward<DashboardSummariesT>(value));
    return *this;
  }
  template <typename DashboardSummariesT = DashboardSummary>
  ListDashboardsResult& AddDashboardSummaries(DashboardSummariesT&& value) {
    m_dashboardSummariesHasBeenSet = true;
    m_dashboardSummaries.emplace_back(std::forward<DashboardSummariesT>(value));
    return *this;
  }
  ///@}
