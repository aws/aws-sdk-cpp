...
class BatchGetAssetPropertyAggregatesSuccessEntry {
 public:
  ...
  template <typename EntryIdT = Aws::String>
  BatchGetAssetPropertyAggregatesSuccessEntry& WithEntryId(EntryIdT&& value) {
  ...
  template <typename AggregatedValuesT = Aws::Vector<AggregatedValue>>
  BatchGetAssetPropertyAggregatesSuccessEntry& WithAggregatedValues(AggregatedValuesT&& value) {
    SetAggregatedValues(std::forward<AggregatedValuesT>(value));
    return *this;
  }
  template <typename AggregatedValuesT = AggregatedValue>
  BatchGetAssetPropertyAggregatesSuccessEntry& AddAggregatedValues(AggregatedValuesT&& value) {
    m_aggregatedValuesHasBeenSet = true;
