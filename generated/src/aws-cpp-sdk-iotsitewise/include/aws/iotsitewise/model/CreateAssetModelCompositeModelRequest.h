...
class CreateAssetModelCompositeModelRequest : public IoTSiteWiseRequest {
 public:
  ...
  void SetParentAssetModelCompositeModelId(ParentAssetModelCompositeModelIdT&& value) {
    m_parentAssetModelCompositeModelIdHasBeenSet = true;
    m_parentAssetModelCompositeModelId = std::forward<ParentAssetModelCompositeModelIdT>(value);
  }
  template <typename ParentAssetModelCompositeModelIdT = Aws::String>
  CreateAssetModelCompositeModelRequest& WithParentAssetModelCompositeModelId(ParentAssetModelCompositeModelIdT&& value) {
    SetParentAssetModelCompositeModelId(std::forward<ParentAssetModelCompositeModelIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComposedAssetModelId(ComposedAssetModelIdT&& value) {
    m_composedAssetModelIdHasBeenSet = true;
    m_composedAssetModelId = std::forward<ComposedAssetModelIdT>(value);
  }
  template <typename ComposedAssetModelIdT = Aws::String>
  CreateAssetModelCompositeModelRequest& WithComposedAssetModelId(ComposedAssetModelIdT&& value) {
    SetComposedAssetModelId(std::forward<ComposedAssetModelIdT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<AssetModelPropertyDefinition>& GetAssetModelCompositeModelProperties() const {
  ...
  inline CreateAssetModelCompositeModelRequest& WithMatchForVersionType(AssetModelVersionType value) {
