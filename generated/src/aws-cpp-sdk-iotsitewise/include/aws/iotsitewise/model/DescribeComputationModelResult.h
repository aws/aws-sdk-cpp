...
class DescribeComputationModelResult {
 public:
  ...
  template <typename ComputationModelIdT = Aws::String>
  DescribeComputationModelResult& WithComputationModelId(ComputationModelIdT&& value) {
  ...
  template <typename ComputationModelArnT = Aws::String>
  DescribeComputationModelResult& WithComputationModelArn(ComputationModelArnT&& value) {
  ...
  void SetComputationModelName(ComputationModelNameT&& value) {
    m_computationModelNameHasBeenSet = true;
    m_computationModelName = std::forward<ComputationModelNameT>(value);
  }
  template <typename ComputationModelNameT = Aws::String>
  DescribeComputationModelResult& WithComputationModelName(ComputationModelNameT&& value) {
    SetComputationModelName(std::forward<ComputationModelNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComputationModelDescription(ComputationModelDescriptionT&& value) {
    m_computationModelDescriptionHasBeenSet = true;
    m_computationModelDescription = std::forward<ComputationModelDescriptionT>(value);
  }
  template <typename ComputationModelDescriptionT = Aws::String>
  DescribeComputationModelResult& WithComputationModelDescription(ComputationModelDescriptionT&& value) {
    SetComputationModelDescription(std::forward<ComputationModelDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComputationModelConfiguration(ComputationModelConfigurationT&& value) {
    m_computationModelConfigurationHasBeenSet = true;
    m_computationModelConfiguration = std::forward<ComputationModelConfigurationT>(value);
  }
  template <typename ComputationModelConfigurationT = ComputationModelConfiguration>
  DescribeComputationModelResult& WithComputationModelConfiguration(ComputationModelConfigurationT&& value) {
    SetComputationModelConfiguration(std::forward<ComputationModelConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Map<Aws::String, ComputationModelDataBindingValue>& GetComputationModelDataBinding() const {
    return m_computationModelDataBinding;
  }
  template <typename ComputationModelDataBindingT = Aws::Map<Aws::String, ComputationModelDataBindingValue>>
  void SetComputationModelDataBinding(ComputationModelDataBindingT&& value) {
    m_computationModelDataBindingHasBeenSet = true;
    m_computationModelDataBinding = std::forward<ComputationModelDataBindingT>(value);
  }
  template <typename ComputationModelDataBindingT = Aws::Map<Aws::String, ComputationModelDataBindingValue>>
  DescribeComputationModelResult& WithComputationModelDataBinding(ComputationModelDataBindingT&& value) {
    SetComputationModelDataBinding(std::forward<ComputationModelDataBindingT>(value));
    return *this;
  }
  template <typename ComputationModelDataBindingKeyT = Aws::String,
            typename ComputationModelDataBindingValueT = ComputationModelDataBindingValue>
  DescribeComputationModelResult& AddComputationModelDataBinding(ComputationModelDataBindingKeyT&& key,
                                                                 ComputationModelDataBindingValueT&& value) {
    m_computationModelDataBindingHasBeenSet = true;
    m_computationModelDataBinding.emplace(std::forward<ComputationModelDataBindingKeyT>(key),
                                          std::forward<ComputationModelDataBindingValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComputationModelCreationDate(ComputationModelCreationDateT&& value) {
    m_computationModelCreationDateHasBeenSet = true;
    m_computationModelCreationDate = std::forward<ComputationModelCreationDateT>(value);
  }
  template <typename ComputationModelCreationDateT = Aws::Utils::DateTime>
  DescribeComputationModelResult& WithComputationModelCreationDate(ComputationModelCreationDateT&& value) {
    SetComputationModelCreationDate(std::forward<ComputationModelCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComputationModelLastUpdateDate(ComputationModelLastUpdateDateT&& value) {
    m_computationModelLastUpdateDateHasBeenSet = true;
    m_computationModelLastUpdateDate = std::forward<ComputationModelLastUpdateDateT>(value);
  }
  template <typename ComputationModelLastUpdateDateT = Aws::Utils::DateTime>
  DescribeComputationModelResult& WithComputationModelLastUpdateDate(ComputationModelLastUpdateDateT&& value) {
    SetComputationModelLastUpdateDate(std::forward<ComputationModelLastUpdateDateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ComputationModelStatusT = ComputationModelStatus>
  DescribeComputationModelResult& WithComputationModelStatus(ComputationModelStatusT&& value) {
  ...
  void SetComputationModelVersion(ComputationModelVersionT&& value) {
    m_computationModelVersionHasBeenSet = true;
    m_computationModelVersion = std::forward<ComputationModelVersionT>(value);
  }
  template <typename ComputationModelVersionT = Aws::String>
  DescribeComputationModelResult& WithComputationModelVersion(ComputationModelVersionT&& value) {
    SetComputationModelVersion(std::forward<ComputationModelVersionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ActionDefinitionsT = Aws::Vector<ActionDefinition>>
  DescribeComputationModelResult& WithActionDefinitions(ActionDefinitionsT&& value) {
    SetActionDefinitions(std::forward<ActionDefinitionsT>(value));
    return *this;
  }
  template <typename ActionDefinitionsT = ActionDefinition>
  DescribeComputationModelResult& AddActionDefinitions(ActionDefinitionsT&& value) {
    m_actionDefinitionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeComputationModelResult& WithRequestId(RequestIdT&& value) {
