...
class InvokeAssistantRequest : public IoTSiteWiseRequest {
 public:
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const InvokeAssistantHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline InvokeAssistantRequest& WithEventStreamHandler(const InvokeAssistantHandler& value) {
  ...
  inline InvokeAssistantRequest& WithEnableTrace(bool value) {
