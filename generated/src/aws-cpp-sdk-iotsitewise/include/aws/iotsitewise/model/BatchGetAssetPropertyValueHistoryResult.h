...
class BatchGetAssetPropertyValueHistoryResult {
 public:
  ...
  AWS_IOTSITEWISE_API BatchGetAssetPropertyValueHistoryResult& operator=(
  ...
  template <typename ErrorEntriesT = Aws::Vector<BatchGetAssetPropertyValueHistoryErrorEntry>>
  BatchGetAssetPropertyValueHistoryResult& WithErrorEntries(ErrorEntriesT&& value) {
  ...
  BatchGetAssetPropertyValueHistoryResult& AddErrorEntries(ErrorEntriesT&& value) {
    m_errorEntriesHasBeenSet = true;
  ...
  void SetSuccessEntries(SuccessEntriesT&& value) {
    ...
    m_successEntries = std::forward<SuccessEntriesT>(value);
  }
  template <typename SuccessEntriesT = Aws::Vector<BatchGetAssetPropertyValueHistorySuccessEntry>>
  BatchGetAssetPropertyValueHistoryResult& WithSuccessEntries(SuccessEntriesT&& value) {
    SetSuccessEntries(std::forward<SuccessEntriesT>(value));
    return *this;
  }
  template <typename SuccessEntriesT = BatchGetAssetPropertyValueHistorySuccessEntry>
  BatchGetAssetPropertyValueHistoryResult& AddSuccessEntries(SuccessEntriesT&& value) {
    m_successEntriesHasBeenSet = true;
    m_successEntries.emplace_back(std::forward<SuccessEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSkippedEntries(SkippedEntriesT&& value) {
    ...
    m_skippedEntries = std::forward<SkippedEntriesT>(value);
  }
  template <typename SkippedEntriesT = Aws::Vector<BatchGetAssetPropertyValueHistorySkippedEntry>>
  BatchGetAssetPropertyValueHistoryResult& WithSkippedEntries(SkippedEntriesT&& value) {
    SetSkippedEntries(std::forward<SkippedEntriesT>(value));
    return *this;
  }
  template <typename SkippedEntriesT = BatchGetAssetPropertyValueHistorySkippedEntry>
  BatchGetAssetPropertyValueHistoryResult& AddSkippedEntries(SkippedEntriesT&& value) {
    m_skippedEntriesHasBeenSet = true;
    m_skippedEntries.emplace_back(std::forward<SkippedEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  BatchGetAssetPropertyValueHistoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetAssetPropertyValueHistoryResult& WithRequestId(RequestIdT&& value) {
