...
class DashboardSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  DashboardSummary& WithId(IdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  DashboardSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  DashboardSummary& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename LastUpdateDateT = Aws::Utils::DateTime>
  DashboardSummary& WithLastUpdateDate(LastUpdateDateT&& value) {
