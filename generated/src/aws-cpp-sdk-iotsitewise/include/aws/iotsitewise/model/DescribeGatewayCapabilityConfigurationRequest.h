...
class DescribeGatewayCapabilityConfigurationRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename GatewayIdT = Aws::String>
  DescribeGatewayCapabilityConfigurationRequest& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename CapabilityNamespaceT = Aws::String>
  DescribeGatewayCapabilityConfigurationRequest& WithCapabilityNamespace(CapabilityNamespaceT&& value) {
