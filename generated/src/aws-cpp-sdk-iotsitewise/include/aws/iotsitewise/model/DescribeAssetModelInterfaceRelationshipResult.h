...
class DescribeAssetModelInterfaceRelationshipResult {
 public:
  ...
  AWS_IOTSITEWISE_API DescribeAssetModelInterfaceRelationshipResult& operator=(
  ...
  template <typename AssetModelIdT = Aws::String>
  DescribeAssetModelInterfaceRelationshipResult& WithAssetModelId(AssetModelIdT&& value) {
  ...
  template <typename InterfaceAssetModelIdT = Aws::String>
  DescribeAssetModelInterfaceRelationshipResult& WithInterfaceAssetModelId(InterfaceAssetModelIdT&& value) {
  ...
  void SetPropertyMappings(PropertyMappingsT&& value) {
    m_propertyMappingsHasBeenSet = true;
    m_propertyMappings = std::forward<PropertyMappingsT>(value);
  }
  template <typename PropertyMappingsT = Aws::Vector<PropertyMapping>>
  DescribeAssetModelInterfaceRelationshipResult& WithPropertyMappings(PropertyMappingsT&& value) {
    SetPropertyMappings(std::forward<PropertyMappingsT>(value));
    return *this;
  }
  template <typename PropertyMappingsT = PropertyMapping>
  DescribeAssetModelInterfaceRelationshipResult& AddPropertyMappings(PropertyMappingsT&& value) {
    m_propertyMappingsHasBeenSet = true;
    m_propertyMappings.emplace_back(std::forward<PropertyMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHierarchyMappings(HierarchyMappingsT&& value) {
    m_hierarchyMappingsHasBeenSet = true;
    m_hierarchyMappings = std::forward<HierarchyMappingsT>(value);
  }
  template <typename HierarchyMappingsT = Aws::Vector<HierarchyMapping>>
  DescribeAssetModelInterfaceRelationshipResult& WithHierarchyMappings(HierarchyMappingsT&& value) {
    SetHierarchyMappings(std::forward<HierarchyMappingsT>(value));
    return *this;
  }
  template <typename HierarchyMappingsT = HierarchyMapping>
  DescribeAssetModelInterfaceRelationshipResult& AddHierarchyMappings(HierarchyMappingsT&& value) {
    m_hierarchyMappingsHasBeenSet = true;
    m_hierarchyMappings.emplace_back(std::forward<HierarchyMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAssetModelInterfaceRelationshipResult& WithRequestId(RequestIdT&& value) {
