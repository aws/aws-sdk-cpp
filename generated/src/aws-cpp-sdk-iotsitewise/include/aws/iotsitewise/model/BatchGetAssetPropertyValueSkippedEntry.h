...
class BatchGetAssetPropertyValueSkippedEntry {
 public:
  ...
  template <typename EntryIdT = Aws::String>
  BatchGetAssetPropertyValueSkippedEntry& WithEntryId(EntryIdT&& value) {
  ...
  inline BatchGetAssetPropertyValueSkippedEntry& WithCompletionStatus(BatchEntryCompletionStatus value) {
  ...
  template <typename ErrorInfoT = BatchGetAssetPropertyValueErrorInfo>
  BatchGetAssetPropertyValueSkippedEntry& WithErrorInfo(ErrorInfoT&& value) {
