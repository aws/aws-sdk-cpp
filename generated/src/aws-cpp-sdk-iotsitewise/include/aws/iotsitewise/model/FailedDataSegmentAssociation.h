...
/**
 * <p>Contains error information for a data segment association that
 * failed.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/FailedDataSegmentAssociation">AWS
 * API Reference</a></p>
 */
class FailedDataSegmentAssociation {
 public:
  AWS_IOTSITEWISE_API FailedDataSegmentAssociation() = default;
  AWS_IOTSITEWISE_API FailedDataSegmentAssociation(Aws::Utils::Json::JsonView jsonValue);
  AWS_IOTSITEWISE_API FailedDataSegmentAssociation& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename SourceDatasetIdT = Aws::String>
  FailedDataSegmentAssociation& WithSourceDatasetId(SourceDatasetIdT&& value) {
  ...
  template <typename TimeSeriesIdT = Aws::String>
  FailedDataSegmentAssociation& WithTimeSeriesId(TimeSeriesIdT&& value) {
  ...
  template <typename StartTimestampT = TimeInNanos>
  FailedDataSegmentAssociation& WithStartTimestamp(StartTimestampT&& value) {
  ...
  template <typename EndTimestampT = TimeInNanos>
  FailedDataSegmentAssociation& WithEndTimestamp(EndTimestampT&& value) {
  ...
  inline FailedDataSegmentAssociation& WithErrorCode(DataSegmentErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  FailedDataSegmentAssociation& WithErrorMessage(ErrorMessageT&& value) {
