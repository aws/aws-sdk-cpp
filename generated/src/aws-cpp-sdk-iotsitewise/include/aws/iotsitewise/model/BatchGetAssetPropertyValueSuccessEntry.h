...
class BatchGetAssetPropertyValueSuccessEntry {
 public:
  ...
  template <typename EntryIdT = Aws::String>
  BatchGetAssetPropertyValueSuccessEntry& WithEntryId(EntryIdT&& value) {
  ...
  void SetAssetPropertyValue(AssetPropertyValueT&& value) {
    m_assetPropertyValueHasBeenSet = true;
    m_assetPropertyValue = std::forward<AssetPropertyValueT>(value);
  }
  template <typename AssetPropertyValueT = AssetPropertyValue>
  BatchGetAssetPropertyValueSuccessEntry& WithAssetPropertyValue(AssetPropertyValueT&& value) {
    SetAssetPropertyValue(std::forward<AssetPropertyValueT>(value));
    return *this;
  }
  ///@}
 private:
