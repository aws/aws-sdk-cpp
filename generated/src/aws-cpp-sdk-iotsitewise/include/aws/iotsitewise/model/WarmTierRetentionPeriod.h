...
class WarmTierRetentionPeriod {
 public:
  ...
  inline void SetNumberOfDays(int value) {
    m_numberOfDaysHasBeenSet = true;
    m_numberOfDays = value;
  }
  inline WarmTierRetentionPeriod& WithNumberOfDays(int value) {
  ...
  inline void SetUnlimited(bool value) {
    m_unlimitedHasBeenSet = true;
    m_unlimited = value;
  }
  inline WarmTierRetentionPeriod& WithUnlimited(bool value) {
    SetUnlimited(value);
    return *this;
  }
  ///@}
