...
class DescribeAssetRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename AssetIdT = Aws::String>
  DescribeAssetRequest& WithAssetId(AssetIdT&& value) {
  ...
  inline void SetExcludeProperties(bool value) {
    m_excludePropertiesHasBeenSet = true;
    m_excludeProperties = value;
  }
  inline DescribeAssetRequest& WithExcludeProperties(bool value) {
    SetExcludeProperties(value);
    return *this;
  }
  ///@}
 private:
