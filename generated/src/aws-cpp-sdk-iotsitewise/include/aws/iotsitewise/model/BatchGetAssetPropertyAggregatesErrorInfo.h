...
class BatchGetAssetPropertyAggregatesErrorInfo {
 public:
  ...
  inline BatchGetAssetPropertyAggregatesErrorInfo& WithErrorCode(BatchGetAssetPropertyAggregatesErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorTimestampT = Aws::Utils::DateTime>
  BatchGetAssetPropertyAggregatesErrorInfo& WithErrorTimestamp(ErrorTimestampT&& value) {
