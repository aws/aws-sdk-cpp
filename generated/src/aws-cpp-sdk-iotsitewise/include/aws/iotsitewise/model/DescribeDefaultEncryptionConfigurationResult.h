...
namespace Model
{
  ...
  {
  public:
    AWS_IOTSITEWISE_API DescribeDefaultEncryptionConfigurationResult() = default;
    ...
    inline DescribeDefaultEncryptionConfigurationResult& WithEncryptionType(EncryptionType value) { SetEncryptionType(value); return *this;}
    ///@}
    ...
    template<typename KmsKeyArnT = Aws::String>
    DescribeDefaultEncryptionConfigurationResult& WithKmsKeyArn(KmsKeyArnT&& value) { SetKmsKeyArn(std::forward<KmsKeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigurationStatusT = ConfigurationStatus>
    DescribeDefaultEncryptionConfigurationResult& WithConfigurationStatus(ConfigurationStatusT&& value) { SetConfigurationStatus(std::forward<ConfigurationStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeDefaultEncryptionConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
