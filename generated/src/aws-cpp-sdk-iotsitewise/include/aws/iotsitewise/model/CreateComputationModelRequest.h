...
class CreateComputationModelRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename ComputationModelNameT = Aws::String>
  CreateComputationModelRequest& WithComputationModelName(ComputationModelNameT&& value) {
  ...
  template <typename ComputationModelDescriptionT = Aws::String>
  CreateComputationModelRequest& WithComputationModelDescription(ComputationModelDescriptionT&& value) {
  ...
  template <typename ComputationModelConfigurationT = ComputationModelConfiguration>
  CreateComputationModelRequest& WithComputationModelConfiguration(ComputationModelConfigurationT&& value) {
  ...
  template <typename ComputationModelDataBindingT = Aws::Map<Aws::String, ComputationModelDataBindingValue>>
  CreateComputationModelRequest& WithComputationModelDataBinding(ComputationModelDataBindingT&& value) {
  ...
  CreateComputationModelRequest& AddComputationModelDataBinding(ComputationModelDataBindingKeyT&& key,
  ...
  template <typename ClientTokenT = Aws::String>
  CreateComputationModelRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateComputationModelRequest& WithTags(TagsT&& value) {
