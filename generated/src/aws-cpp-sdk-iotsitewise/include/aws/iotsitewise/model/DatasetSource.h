...
class DatasetSource {
 public:
  ...
  inline DatasetSource& WithSourceType(DatasetSourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSourceFormat(DatasetSourceFormat value) {
    m_sourceFormatHasBeenSet = true;
    m_sourceFormat = value;
  }
  inline DatasetSource& WithSourceFormat(DatasetSourceFormat value) {
