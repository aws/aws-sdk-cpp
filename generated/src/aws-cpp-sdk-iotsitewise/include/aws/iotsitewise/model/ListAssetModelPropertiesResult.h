...
class ListAssetModelPropertiesResult {
 public:
  ...
  void SetAssetModelPropertySummaries(AssetModelPropertySummariesT&& value) {
    m_assetModelPropertySummariesHasBeenSet = true;
    m_assetModelPropertySummaries = std::forward<AssetModelPropertySummariesT>(value);
  }
  template <typename AssetModelPropertySummariesT = Aws::Vector<AssetModelPropertySummary>>
  ListAssetModelPropertiesResult& WithAssetModelPropertySummaries(AssetModelPropertySummariesT&& value) {
    SetAssetModelPropertySummaries(std::forward<AssetModelPropertySummariesT>(value));
    return *this;
  }
  template <typename AssetModelPropertySummariesT = AssetModelPropertySummary>
  ListAssetModelPropertiesResult& AddAssetModelPropertySummaries(AssetModelPropertySummariesT&& value) {
    m_assetModelPropertySummariesHasBeenSet = true;
    m_assetModelPropertySummaries.emplace_back(std::forward<AssetModelPropertySummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssetModelPropertiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssetModelPropertiesResult& WithRequestId(RequestIdT&& value) {
