...
class DescribeGatewayResult {
 public:
  ...
  template <typename GatewayIdT = Aws::String>
  DescribeGatewayResult& WithGatewayId(GatewayIdT&& value) {
  ...
  void SetGatewayName(GatewayNameT&& value) {
    ...
    m_gatewayName = std::forward<GatewayNameT>(value);
  }
  template <typename GatewayNameT = Aws::String>
  DescribeGatewayResult& WithGatewayName(GatewayNameT&& value) {
    SetGatewayName(std::forward<GatewayNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename GatewayArnT = Aws::String>
  DescribeGatewayResult& WithGatewayArn(GatewayArnT&& value) {
  ...
  void SetGatewayPlatform(GatewayPlatformT&& value) {
    ...
    m_gatewayPlatform = std::forward<GatewayPlatformT>(value);
  }
  template <typename GatewayPlatformT = GatewayPlatform>
  DescribeGatewayResult& WithGatewayPlatform(GatewayPlatformT&& value) {
    SetGatewayPlatform(std::forward<GatewayPlatformT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGatewayVersion(GatewayVersionT&& value) {
    ...
    m_gatewayVersion = std::forward<GatewayVersionT>(value);
  }
  template <typename GatewayVersionT = Aws::String>
  DescribeGatewayResult& WithGatewayVersion(GatewayVersionT&& value) {
    SetGatewayVersion(std::forward<GatewayVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGatewayCapabilitySummaries(GatewayCapabilitySummariesT&& value) {
    ...
    m_gatewayCapabilitySummaries = std::forward<GatewayCapabilitySummariesT>(value);
  }
  template <typename GatewayCapabilitySummariesT = Aws::Vector<GatewayCapabilitySummary>>
  DescribeGatewayResult& WithGatewayCapabilitySummaries(GatewayCapabilitySummariesT&& value) {
    SetGatewayCapabilitySummaries(std::forward<GatewayCapabilitySummariesT>(value));
    return *this;
  }
  template <typename GatewayCapabilitySummariesT = GatewayCapabilitySummary>
  DescribeGatewayResult& AddGatewayCapabilitySummaries(GatewayCapabilitySummariesT&& value) {
    m_gatewayCapabilitySummariesHasBeenSet = true;
    m_gatewayCapabilitySummaries.emplace_back(std::forward<GatewayCapabilitySummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  DescribeGatewayResult& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename LastUpdateDateT = Aws::Utils::DateTime>
  DescribeGatewayResult& WithLastUpdateDate(LastUpdateDateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeGatewayResult& WithRequestId(RequestIdT&& value) {
