...
class Aggregates {
 public:
  ...
  inline Aggregates& WithAverage(double value) {
    SetAverage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCount(double value) {
    m_countHasBeenSet = true;
    m_count = value;
  }
  inline Aggregates& WithCount(double value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline Aggregates& WithMaximum(double value) {
    SetMaximum(value);
    return *this;
  }
  ///@}
  ...
  inline Aggregates& WithMinimum(double value) {
    SetMinimum(value);
    return *this;
  }
  ///@}
  ...
  inline Aggregates& WithSum(double value) {
    SetSum(value);
    return *this;
  }
  ///@}
  ...
  inline Aggregates& WithStandardDeviation(double value) {
