...
class DescribeAssetResult {
 public:
  ...
  void SetAssetCompositeModels(AssetCompositeModelsT&& value) {
    ...
    m_assetCompositeModels = std::forward<AssetCompositeModelsT>(value);
  }
  template <typename AssetCompositeModelsT = Aws::Vector<AssetCompositeModel>>
  DescribeAssetResult& WithAssetCompositeModels(AssetCompositeModelsT&& value) {
    SetAssetCompositeModels(std::forward<AssetCompositeModelsT>(value));
    return *this;
  }
  ...
  DescribeAssetResult& AddAssetCompositeModels(AssetCompositeModelsT&& value) {
    m_assetCompositeModelsHasBeenSet = true;
    m_assetCompositeModels.emplace_back(std::forward<AssetCompositeModelsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssetCreationDate(AssetCreationDateT&& value) {
    ...
    m_assetCreationDate = std::forward<AssetCreationDateT>(value);
  }
  template <typename AssetCreationDateT = Aws::Utils::DateTime>
  DescribeAssetResult& WithAssetCreationDate(AssetCreationDateT&& value) {
    SetAssetCreationDate(std::forward<AssetCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssetLastUpdateDate(AssetLastUpdateDateT&& value) {
    ...
    m_assetLastUpdateDate = std::forward<AssetLastUpdateDateT>(value);
  }
  template <typename AssetLastUpdateDateT = Aws::Utils::DateTime>
  DescribeAssetResult& WithAssetLastUpdateDate(AssetLastUpdateDateT&& value) {
    SetAssetLastUpdateDate(std::forward<AssetLastUpdateDateT>(value));
    return *this;
  }
  ///@}
