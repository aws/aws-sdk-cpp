...
class ComputationModelSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  ComputationModelSummary& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ComputationModelSummary& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  ComputationModelSummary& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ComputationModelSummary& WithDescription(DescriptionT&& value) {
  ...
  inline void SetType(ComputationModelType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ComputationModelSummary& WithType(ComputationModelType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  ComputationModelSummary& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename LastUpdateDateT = Aws::Utils::DateTime>
  ComputationModelSummary& WithLastUpdateDate(LastUpdateDateT&& value) {
  ...
  template <typename StatusT = ComputationModelStatus>
  ComputationModelSummary& WithStatus(StatusT&& value) {
  ...
  template <typename VersionT = Aws::String>
  ComputationModelSummary& WithVersion(VersionT&& value) {
