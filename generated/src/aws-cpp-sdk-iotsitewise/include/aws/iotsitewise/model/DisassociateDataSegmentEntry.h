...
/**
 * <p>Contains information about a data segment entry to disassociate from a
 * dataset.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/DisassociateDataSegmentEntry">AWS
 * API Reference</a></p>
 */
class DisassociateDataSegmentEntry {
 public:
  AWS_IOTSITEWISE_API DisassociateDataSegmentEntry() = default;
  AWS_IOTSITEWISE_API DisassociateDataSegmentEntry(Aws::Utils::Json::JsonView jsonValue);
  AWS_IOTSITEWISE_API DisassociateDataSegmentEntry& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename SourceDatasetIdT = Aws::String>
  DisassociateDataSegmentEntry& WithSourceDatasetId(SourceDatasetIdT&& value) {
  ...
  template <typename TimeSeriesIdT = Aws::String>
  DisassociateDataSegmentEntry& WithTimeSeriesId(TimeSeriesIdT&& value) {
  ...
  template <typename StartTimestampT = TimeInNanos>
  DisassociateDataSegmentEntry& WithStartTimestamp(StartTimestampT&& value) {
  ...
  template <typename EndTimestampT = TimeInNanos>
  DisassociateDataSegmentEntry& WithEndTimestamp(EndTimestampT&& value) {
