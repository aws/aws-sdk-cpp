...
class ListBulkImportJobsRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListBulkImportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBulkImportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFilter(ListBulkImportJobsFilter value) {
    m_filterHasBeenSet = true;
    m_filter = value;
  }
  inline ListBulkImportJobsRequest& WithFilter(ListBulkImportJobsFilter value) {
    SetFilter(value);
    return *this;
  }
  ///@}
