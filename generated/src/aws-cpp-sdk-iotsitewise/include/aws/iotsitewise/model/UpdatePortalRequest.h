...
class UpdatePortalRequest : public IoTSiteWiseRequest {
 public:
  ...
  void SetPortalLogoImage(PortalLogoImageT&& value) {
    m_portalLogoImageHasBeenSet = true;
    m_portalLogoImage = std::forward<PortalLogoImageT>(value);
  }
  template <typename PortalLogoImageT = Image>
  UpdatePortalRequest& WithPortalLogoImage(PortalLogoImageT&& value) {
    SetPortalLogoImage(std::forward<PortalLogoImageT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdatePortalRequest& WithPortalType(PortalType value) {
    SetPortalType(value);
    return *this;
  }
  ///@}
