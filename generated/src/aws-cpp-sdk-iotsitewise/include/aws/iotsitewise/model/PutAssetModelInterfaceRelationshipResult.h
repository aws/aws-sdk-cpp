...
class PutAssetModelInterfaceRelationshipResult {
 public:
  ...
  AWS_IOTSITEWISE_API PutAssetModelInterfaceRelationshipResult& operator=(
  ...
  template <typename AssetModelIdT = Aws::String>
  PutAssetModelInterfaceRelationshipResult& WithAssetModelId(AssetModelIdT&& value) {
  ...
  template <typename InterfaceAssetModelIdT = Aws::String>
  PutAssetModelInterfaceRelationshipResult& WithInterfaceAssetModelId(InterfaceAssetModelIdT&& value) {
  ...
  template <typename AssetModelArnT = Aws::String>
  PutAssetModelInterfaceRelationshipResult& WithAssetModelArn(AssetModelArnT&& value) {
  ...
  template <typename AssetModelStatusT = AssetModelStatus>
  PutAssetModelInterfaceRelationshipResult& WithAssetModelStatus(AssetModelStatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutAssetModelInterfaceRelationshipResult& WithRequestId(RequestIdT&& value) {
