...
namespace Model
{
  class PutAssetModelInterfaceRelationshipResult
  {
  public:
    AWS_IOTSITEWISE_API PutAssetModelInterfaceRelationshipResult() = default;
    AWS_IOTSITEWISE_API PutAssetModelInterfaceRelationshipResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_IOTSITEWISE_API PutAssetModelInterfaceRelationshipResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename AssetModelIdT = Aws::String>
    PutAssetModelInterfaceRelationshipResult& WithAssetModelId(AssetModelIdT&& value) { SetAssetModelId(std::forward<AssetModelIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InterfaceAssetModelIdT = Aws::String>
    PutAssetModelInterfaceRelationshipResult& WithInterfaceAssetModelId(InterfaceAssetModelIdT&& value) { SetInterfaceAssetModelId(std::forward<InterfaceAssetModelIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AssetModelArnT = Aws::String>
    PutAssetModelInterfaceRelationshipResult& WithAssetModelArn(AssetModelArnT&& value) { SetAssetModelArn(std::forward<AssetModelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AssetModelStatusT = AssetModelStatus>
    PutAssetModelInterfaceRelationshipResult& WithAssetModelStatus(AssetModelStatusT&& value) { SetAssetModelStatus(std::forward<AssetModelStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutAssetModelInterfaceRelationshipResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
