...
class AssetModelPropertySummary {
 public:
  ...
  inline AssetModelPropertySummary& WithDataType(PropertyDataType value) {
    SetDataType(value);
    return *this;
  }
  ///@}
  ...
  AssetModelPropertySummary& AddPath(PathT&& value) {
    m_pathHasBeenSet = true;
    m_path.emplace_back(std::forward<PathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInterfaceSummaries(InterfaceSummariesT&& value) {
    m_interfaceSummariesHasBeenSet = true;
    m_interfaceSummaries = std::forward<InterfaceSummariesT>(value);
  }
  template <typename InterfaceSummariesT = Aws::Vector<InterfaceSummary>>
  AssetModelPropertySummary& WithInterfaceSummaries(InterfaceSummariesT&& value) {
    SetInterfaceSummaries(std::forward<InterfaceSummariesT>(value));
    return *this;
  }
  template <typename InterfaceSummariesT = InterfaceSummary>
  AssetModelPropertySummary& AddInterfaceSummaries(InterfaceSummariesT&& value) {
    m_interfaceSummariesHasBeenSet = true;
    m_interfaceSummaries.emplace_back(std::forward<InterfaceSummariesT>(value));
    return *this;
  }
  ///@}
 private:
