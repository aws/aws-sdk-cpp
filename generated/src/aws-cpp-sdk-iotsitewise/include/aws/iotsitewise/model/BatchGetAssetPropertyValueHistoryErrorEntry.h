...
class BatchGetAssetPropertyValueHistoryErrorEntry {
 public:
  ...
  inline BatchGetAssetPropertyValueHistoryErrorEntry& WithErrorCode(BatchGetAssetPropertyValueHistoryErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  BatchGetAssetPropertyValueHistoryErrorEntry& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename EntryIdT = Aws::String>
  BatchGetAssetPropertyValueHistoryErrorEntry& WithEntryId(EntryIdT&& value) {
