...
class ResponseStream {
 public:
  ...
  void SetConflictingOperationException(ConflictingOperationExceptionT&& value) {
    m_conflictingOperationExceptionHasBeenSet = true;
    m_conflictingOperationException = std::forward<ConflictingOperationExceptionT>(value);
  }
  template <typename ConflictingOperationExceptionT = ConflictingOperationException>
  ResponseStream& WithConflictingOperationException(ConflictingOperationExceptionT&& value) {
    SetConflictingOperationException(std::forward<ConflictingOperationExceptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvalidRequestException(InvalidRequestExceptionT&& value) {
    m_invalidRequestExceptionHasBeenSet = true;
    m_invalidRequestException = std::forward<InvalidRequestExceptionT>(value);
  }
  template <typename InvalidRequestExceptionT = IoTSiteWiseError>
  ResponseStream& WithInvalidRequestException(InvalidRequestExceptionT&& value) {
    SetInvalidRequestException(std::forward<InvalidRequestExceptionT>(value));
    return *this;
  }
  ///@}
