...
class ListComputationModelsResult {
 public:
  ...
  void SetComputationModelSummaries(ComputationModelSummariesT&& value) {
    m_computationModelSummariesHasBeenSet = true;
    m_computationModelSummaries = std::forward<ComputationModelSummariesT>(value);
  }
  template <typename ComputationModelSummariesT = Aws::Vector<ComputationModelSummary>>
  ListComputationModelsResult& WithComputationModelSummaries(ComputationModelSummariesT&& value) {
    SetComputationModelSummaries(std::forward<ComputationModelSummariesT>(value));
    return *this;
  }
  template <typename ComputationModelSummariesT = ComputationModelSummary>
  ListComputationModelsResult& AddComputationModelSummaries(ComputationModelSummariesT&& value) {
    m_computationModelSummariesHasBeenSet = true;
    m_computationModelSummaries.emplace_back(std::forward<ComputationModelSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListComputationModelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListComputationModelsResult& WithRequestId(RequestIdT&& value) {
