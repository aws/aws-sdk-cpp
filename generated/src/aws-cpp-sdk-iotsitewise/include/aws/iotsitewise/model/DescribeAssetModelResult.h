...
class DescribeAssetModelResult {
 public:
  ...
  inline DescribeAssetModelResult& WithAssetModelType(AssetModelType value) {
   ...
   * asset model.</p>
   */
  inline const Aws::Vector<AssetModelCompositeModelSummary>& GetAssetModelCompositeModelSummaries() const {
    return m_assetModelCompositeModelSummaries;
  }
  ...
  void SetAssetModelCompositeModelSummaries(AssetModelCompositeModelSummariesT&& value) {
    ...
    m_assetModelCompositeModelSummaries = std::forward<AssetModelCompositeModelSummariesT>(value);
  }
  template <typename AssetModelCompositeModelSummariesT = Aws::Vector<AssetModelCompositeModelSummary>>
  DescribeAssetModelResult& WithAssetModelCompositeModelSummaries(AssetModelCompositeModelSummariesT&& value) {
    SetAssetModelCompositeModelSummaries(std::forward<AssetModelCompositeModelSummariesT>(value));
    return *this;
  }
  ...
  DescribeAssetModelResult& AddAssetModelCompositeModelSummaries(AssetModelCompositeModelSummariesT&& value) {
    m_assetModelCompositeModelSummariesHasBeenSet = true;
    m_assetModelCompositeModelSummaries.emplace_back(std::forward<AssetModelCompositeModelSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssetModelCreationDate(AssetModelCreationDateT&& value) {
    ...
    m_assetModelCreationDate = std::forward<AssetModelCreationDateT>(value);
  }
  template <typename AssetModelCreationDateT = Aws::Utils::DateTime>
  DescribeAssetModelResult& WithAssetModelCreationDate(AssetModelCreationDateT&& value) {
    SetAssetModelCreationDate(std::forward<AssetModelCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssetModelLastUpdateDate(AssetModelLastUpdateDateT&& value) {
    ...
    m_assetModelLastUpdateDate = std::forward<AssetModelLastUpdateDateT>(value);
  }
  template <typename AssetModelLastUpdateDateT = Aws::Utils::DateTime>
  DescribeAssetModelResult& WithAssetModelLastUpdateDate(AssetModelLastUpdateDateT&& value) {
    SetAssetModelLastUpdateDate(std::forward<AssetModelLastUpdateDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInterfaceDetails(InterfaceDetailsT&& value) {
    m_interfaceDetailsHasBeenSet = true;
    m_interfaceDetails = std::forward<InterfaceDetailsT>(value);
  }
  template <typename InterfaceDetailsT = Aws::Vector<InterfaceRelationship>>
  DescribeAssetModelResult& WithInterfaceDetails(InterfaceDetailsT&& value) {
    SetInterfaceDetails(std::forward<InterfaceDetailsT>(value));
    return *this;
  }
  template <typename InterfaceDetailsT = InterfaceRelationship>
  DescribeAssetModelResult& AddInterfaceDetails(InterfaceDetailsT&& value) {
    m_interfaceDetailsHasBeenSet = true;
    m_interfaceDetails.emplace_back(std::forward<InterfaceDetailsT>(value));
    return *this;
  }
  ///@}
