...
class ListComputationModelDataBindingUsagesRequest : public IoTSiteWiseRequest {
 public:
  ...
  void SetDataBindingValueFilter(DataBindingValueFilterT&& value) {
    m_dataBindingValueFilterHasBeenSet = true;
    m_dataBindingValueFilter = std::forward<DataBindingValueFilterT>(value);
  }
  template <typename DataBindingValueFilterT = DataBindingValueFilter>
  ListComputationModelDataBindingUsagesRequest& WithDataBindingValueFilter(DataBindingValueFilterT&& value) {
    SetDataBindingValueFilter(std::forward<DataBindingValueFilterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListComputationModelDataBindingUsagesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListComputationModelDataBindingUsagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
