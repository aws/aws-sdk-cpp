...
class ListInterfaceRelationshipsRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename InterfaceAssetModelIdT = Aws::String>
  ListInterfaceRelationshipsRequest& WithInterfaceAssetModelId(InterfaceAssetModelIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListInterfaceRelationshipsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListInterfaceRelationshipsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
