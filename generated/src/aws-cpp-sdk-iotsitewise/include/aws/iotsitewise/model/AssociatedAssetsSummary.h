...
class AssociatedAssetsSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  AssociatedAssetsSummary& WithId(IdT&& value) {
  ...
  template <typename ExternalIdT = Aws::String>
  AssociatedAssetsSummary& WithExternalId(ExternalIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  AssociatedAssetsSummary& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  AssociatedAssetsSummary& WithName(NameT&& value) {
  ...
  template <typename AssetModelIdT = Aws::String>
  AssociatedAssetsSummary& WithAssetModelId(AssetModelIdT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  AssociatedAssetsSummary& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename LastUpdateDateT = Aws::Utils::DateTime>
  AssociatedAssetsSummary& WithLastUpdateDate(LastUpdateDateT&& value) {
  ...
  template <typename StatusT = AssetStatus>
  AssociatedAssetsSummary& WithStatus(StatusT&& value) {
  ...
  template <typename HierarchiesT = Aws::Vector<AssetHierarchy>>
  AssociatedAssetsSummary& WithHierarchies(HierarchiesT&& value) {
    SetHierarchies(std::forward<HierarchiesT>(value));
    return *this;
  }
  template <typename HierarchiesT = AssetHierarchy>
  AssociatedAssetsSummary& AddHierarchies(HierarchiesT&& value) {
    m_hierarchiesHasBeenSet = true;
  ...
  template <typename DescriptionT = Aws::String>
  AssociatedAssetsSummary& WithDescription(DescriptionT&& value) {
