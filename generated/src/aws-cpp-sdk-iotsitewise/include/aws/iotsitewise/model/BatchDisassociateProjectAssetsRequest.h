...
class BatchDisassociateProjectAssetsRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename ProjectIdT = Aws::String>
  BatchDisassociateProjectAssetsRequest& WithProjectId(ProjectIdT&& value) {
  ...
  template <typename AssetIdsT = Aws::Vector<Aws::String>>
  BatchDisassociateProjectAssetsRequest& WithAssetIds(AssetIdsT&& value) {
    SetAssetIds(std::forward<AssetIdsT>(value));
    return *this;
  }
  template <typename AssetIdsT = Aws::String>
  BatchDisassociateProjectAssetsRequest& AddAssetIds(AssetIdsT&& value) {
    m_assetIdsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  BatchDisassociateProjectAssetsRequest& WithClientToken(ClientTokenT&& value) {
