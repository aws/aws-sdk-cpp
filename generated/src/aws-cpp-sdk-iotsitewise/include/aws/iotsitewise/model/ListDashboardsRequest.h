...
namespace Model
{
  ...
  {
  public:
    AWS_IOTSITEWISE_API ListDashboardsRequest();
     ...
     * <p>The ID of the project.</p>
     */
    inline ListDashboardsRequest& WithProjectId(const Aws::String& value) { SetProjectId(value); return *this;}

    /**
     * <p>The ID of the project.</p>
     */
    inline ListDashboardsRequest& WithProjectId(Aws::String&& value) { SetProjectId(std::move(value)); return *this;}

    /**
     * <p>The ID of the project.</p>
     */
    inline ListDashboardsRequest& WithProjectId(const char* value) { SetProjectId(value); return *this;}
