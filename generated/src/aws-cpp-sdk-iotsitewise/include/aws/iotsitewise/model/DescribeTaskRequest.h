...
/**
 * <p>Request structure for DescribeTask operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/DescribeTaskRequest">AWS
 * API Reference</a></p>
 */
class DescribeTaskRequest : public IoTSiteWiseRequest {
 public:
  AWS_IOTSITEWISE_API DescribeTaskRequest() = default;
  ...
  template <typename WorkspaceNameT = Aws::String>
  DescribeTaskRequest& WithWorkspaceName(WorkspaceNameT&& value) {
  ...
  template <typename TaskNameT = Aws::String>
  DescribeTaskRequest& WithTaskName(TaskNameT&& value) {
  ...
  ///@{
  /**
   * <p>The version number of the task to retrieve. If not specified, returns the
   * latest version.</p>
   */
  ...
  template <typename TaskVersionT = Aws::String>
  DescribeTaskRequest& WithTaskVersion(TaskVersionT&& value) {
