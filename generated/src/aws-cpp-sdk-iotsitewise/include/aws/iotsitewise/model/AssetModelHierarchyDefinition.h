...
class AssetModelHierarchyDefinition {
 public:
  ...
  template <typename IdT = Aws::String>
  AssetModelHierarchyDefinition& WithId(IdT&& value) {
  ...
  void SetChildAssetModelId(ChildAssetModelIdT&& value) {
    ...
    m_childAssetModelId = std::forward<ChildAssetModelIdT>(value);
  }
  template <typename ChildAssetModelIdT = Aws::String>
  AssetModelHierarchyDefinition& WithChildAssetModelId(ChildAssetModelIdT&& value) {
    SetChildAssetModelId(std::forward<ChildAssetModelIdT>(value));
    return *this;
  }
  ///@}
 private:
