...
class CreateAssetModelCompositeModelResult {
 public:
  ...
  AWS_IOTSITEWISE_API CreateAssetModelCompositeModelResult& operator=(
  ...
  template <typename AssetModelCompositeModelIdT = Aws::String>
  CreateAssetModelCompositeModelResult& WithAssetModelCompositeModelId(AssetModelCompositeModelIdT&& value) {
  ...
  template <typename AssetModelCompositeModelPathT = Aws::Vector<AssetModelCompositeModelPathSegment>>
  CreateAssetModelCompositeModelResult& WithAssetModelCompositeModelPath(AssetModelCompositeModelPathT&& value) {
  ...
  CreateAssetModelCompositeModelResult& AddAssetModelCompositeModelPath(AssetModelCompositeModelPathT&& value) {
    m_assetModelCompositeModelPathHasBeenSet = true;
  ...
  template <typename AssetModelStatusT = AssetModelStatus>
  CreateAssetModelCompositeModelResult& WithAssetModelStatus(AssetModelStatusT&& value) {
  ...
  template <typename AssetModelIdT = Aws::String>
  CreateAssetModelCompositeModelResult& WithAssetModelId(AssetModelIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAssetModelCompositeModelResult& WithRequestId(RequestIdT&& value) {
