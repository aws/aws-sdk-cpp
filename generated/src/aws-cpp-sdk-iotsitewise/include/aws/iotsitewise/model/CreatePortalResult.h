...
class CreatePortalResult {
 public:
  ...
  void SetPortalStartUrl(PortalStartUrlT&& value) {
    ...
    m_portalStartUrl = std::forward<PortalStartUrlT>(value);
  }
  template <typename PortalStartUrlT = Aws::String>
  CreatePortalResult& WithPortalStartUrl(PortalStartUrlT&& value) {
    SetPortalStartUrl(std::forward<PortalStartUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSsoApplicationId(SsoApplicationIdT&& value) {
    ...
    m_ssoApplicationId = std::forward<SsoApplicationIdT>(value);
  }
  template <typename SsoApplicationIdT = Aws::String>
  CreatePortalResult& WithSsoApplicationId(SsoApplicationIdT&& value) {
    SetSsoApplicationId(std::forward<SsoApplicationIdT>(value));
    return *this;
  }
  ///@}
