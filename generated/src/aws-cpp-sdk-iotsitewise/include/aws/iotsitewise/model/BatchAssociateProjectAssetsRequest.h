...
class BatchAssociateProjectAssetsRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename ProjectIdT = Aws::String>
  BatchAssociateProjectAssetsRequest& WithProjectId(ProjectIdT&& value) {
  ...
  template <typename AssetIdsT = Aws::Vector<Aws::String>>
  BatchAssociateProjectAssetsRequest& WithAssetIds(AssetIdsT&& value) {
    SetAssetIds(std::forward<AssetIdsT>(value));
    return *this;
  }
  template <typename AssetIdsT = Aws::String>
  BatchAssociateProjectAssetsRequest& AddAssetIds(AssetIdsT&& value) {
    m_assetIdsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  BatchAssociateProjectAssetsRequest& WithClientToken(ClientTokenT&& value) {
