...
class BatchGetAssetPropertyValueErrorInfo {
 public:
  ...
  inline BatchGetAssetPropertyValueErrorInfo& WithErrorCode(BatchGetAssetPropertyValueErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorTimestampT = Aws::Utils::DateTime>
  BatchGetAssetPropertyValueErrorInfo& WithErrorTimestamp(ErrorTimestampT&& value) {
