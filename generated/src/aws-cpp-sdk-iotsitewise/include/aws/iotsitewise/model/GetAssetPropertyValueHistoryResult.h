...
class GetAssetPropertyValueHistoryResult {
 public:
  ...
  void SetAssetPropertyValueHistory(AssetPropertyValueHistoryT&& value) {
    m_assetPropertyValueHistoryHasBeenSet = true;
    m_assetPropertyValueHistory = std::forward<AssetPropertyValueHistoryT>(value);
  }
  template <typename AssetPropertyValueHistoryT = Aws::Vector<AssetPropertyValue>>
  GetAssetPropertyValueHistoryResult& WithAssetPropertyValueHistory(AssetPropertyValueHistoryT&& value) {
    SetAssetPropertyValueHistory(std::forward<AssetPropertyValueHistoryT>(value));
    return *this;
  }
  template <typename AssetPropertyValueHistoryT = AssetPropertyValue>
  GetAssetPropertyValueHistoryResult& AddAssetPropertyValueHistory(AssetPropertyValueHistoryT&& value) {
    m_assetPropertyValueHistoryHasBeenSet = true;
    m_assetPropertyValueHistory.emplace_back(std::forward<AssetPropertyValueHistoryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetAssetPropertyValueHistoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAssetPropertyValueHistoryResult& WithRequestId(RequestIdT&& value) {
