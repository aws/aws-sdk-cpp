...
class DescribeStorageConfigurationResult {
 public:
  ...
  inline DescribeStorageConfigurationResult& WithStorageType(StorageType value) {
  ...
  inline DescribeStorageConfigurationResult& WithDisassociatedDataStorage(DisassociatedDataStorageState value) {
  ...
  inline DescribeStorageConfigurationResult& WithWarmTier(WarmTierState value) {
    SetWarmTier(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeStorageConfigurationResult& WithDisallowIngestNullNaN(bool value) {
