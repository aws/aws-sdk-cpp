...
class DescribeAssetCompositeModelRequest : public IoTSiteWiseRequest {
 public:
  ...
  template <typename AssetIdT = Aws::String>
  DescribeAssetCompositeModelRequest& WithAssetId(AssetIdT&& value) {
  ...
  template <typename AssetCompositeModelIdT = Aws::String>
  DescribeAssetCompositeModelRequest& WithAssetCompositeModelId(AssetCompositeModelIdT&& value) {
