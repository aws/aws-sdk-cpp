...
namespace IoTSiteWise
{
   ...
   */
  class AWS_IOTSITEWISE_API IoTSiteWiseClient : Aws::Client::ClientWithAsyncTemplateMethods<IoTSiteWiseClient>,
    smithy::client::AwsSmithyClientT<Aws::IoTSiteWise::SERVICE_NAME,
