...
BatchPutAssetPropertyError::BatchPutAssetPropertyError(JsonView jsonValue) { *this = jsonValue; }

BatchPutAssetPropertyError& BatchPutAssetPropertyError::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("errorCode")) {
    m_errorCode =
        BatchPutAssetPropertyValueErrorCodeMapper::GetBatchPutAssetPropertyValueErrorCodeForName(jsonValue.GetString("errorCode"));
