...
InvokeAssistantInitialResponse::InvokeAssistantInitialResponse(JsonView jsonValue) { *this = jsonValue; }
...
InvokeAssistantInitialResponse::InvokeAssistantInitialResponse(const Http::HeaderValueCollection& headers)
