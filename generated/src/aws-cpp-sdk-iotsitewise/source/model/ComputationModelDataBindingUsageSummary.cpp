...
ComputationModelDataBindingUsageSummary::ComputationModelDataBindingUsageSummary(JsonView jsonValue) { *this = jsonValue; }
...
ComputationModelDataBindingUsageSummary& ComputationModelDataBindingUsageSummary::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("computationModelIds")) {
    ...
    for (unsigned computationModelIdsIndex = 0; computationModelIdsIndex < computationModelIdsJsonList.GetLength();
         ++computationModelIdsIndex) {
