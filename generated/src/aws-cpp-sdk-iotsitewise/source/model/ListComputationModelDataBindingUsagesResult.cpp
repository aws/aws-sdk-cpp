...
ListComputationModelDataBindingUsagesResult::ListComputationModelDataBindingUsagesResult(
...
ListComputationModelDataBindingUsagesResult& ListComputationModelDataBindingUsagesResult::operator=(
  ...
  if (jsonValue.ValueExists("dataBindingUsageSummaries")) {
    ...
    for (unsigned dataBindingUsageSummariesIndex = 0; dataBindingUsageSummariesIndex < dataBindingUsageSummariesJsonList.GetLength();
         ++dataBindingUsageSummariesIndex) {
