...
DescribeAssetCompositeModelResult& DescribeAssetCompositeModelResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("assetCompositeModelPath")) {
    ...
    for (unsigned assetCompositeModelPathIndex = 0; assetCompositeModelPathIndex < assetCompositeModelPathJsonList.GetLength();
         ++assetCompositeModelPathIndex) {
  ...
  if (jsonValue.ValueExists("assetCompositeModelProperties")) {
    ...
    for (unsigned assetCompositeModelPropertiesIndex = 0;
         assetCompositeModelPropertiesIndex < assetCompositeModelPropertiesJsonList.GetLength(); ++assetCompositeModelPropertiesIndex) {
  ...
  if (jsonValue.ValueExists("assetCompositeModelSummaries")) {
    ...
    for (unsigned assetCompositeModelSummariesIndex = 0;
         assetCompositeModelSummariesIndex < assetCompositeModelSummariesJsonList.GetLength(); ++assetCompositeModelSummariesIndex) {
