...
ListAssetModelCompositeModelsResult::ListAssetModelCompositeModelsResult()
{
}

ListAssetModelCompositeModelsResult::ListAssetModelCompositeModelsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
