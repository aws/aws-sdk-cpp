...
FailedDataSegmentDisassociation::FailedDataSegmentDisassociation(JsonView jsonValue) { *this = jsonValue; }

FailedDataSegmentDisassociation& FailedDataSegmentDisassociation::operator=(JsonView jsonValue) {
...
JsonValue FailedDataSegmentDisassociation::Jsonize() const {
  JsonValue payload;
