...
AssetModelCompositeModelSummary::AssetModelCompositeModelSummary() : 
...
AssetModelCompositeModelSummary::AssetModelCompositeModelSummary(JsonView jsonValue) : 
    m_idHasBeenSet(false),
    m_externalIdHasBeenSet(false),
    m_nameHasBeenSet(false),
    m_typeHasBeenSet(false),
...
AssetModelCompositeModelSummary& AssetModelCompositeModelSummary::operator =(JsonView jsonValue)
{
...
JsonValue AssetModelCompositeModelSummary::Jsonize() const
{
  JsonValue payload;
