...
Aws::String UpdateAssetModelCompositeModelRequest::SerializePayload() const {
  ...
  if (m_assetModelCompositeModelPropertiesHasBeenSet) {
    ...
    for (unsigned assetModelCompositeModelPropertiesIndex = 0;
         assetModelCompositeModelPropertiesIndex < assetModelCompositeModelPropertiesJsonList.GetLength();
         ++assetModelCompositeModelPropertiesIndex) {
      assetModelCompositeModelPropertiesJsonList[assetModelCompositeModelPropertiesIndex].AsObject(
          m_assetModelCompositeModelProperties[assetModelCompositeModelPropertiesIndex].Jsonize());
    }
