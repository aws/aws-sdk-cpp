...
Aws::String ListAssetModelCompositeModelsRequest::SerializePayload() const { return {}; }

void ListAssetModelCompositeModelsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
