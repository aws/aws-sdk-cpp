...
StartSearchResult::StartSearchResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartSearchResult& StartSearchResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
