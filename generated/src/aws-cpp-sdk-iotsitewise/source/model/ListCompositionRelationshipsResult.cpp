...
ListCompositionRelationshipsResult& ListCompositionRelationshipsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("compositionRelationshipSummaries")) {
    ...
    for (unsigned compositionRelationshipSummariesIndex = 0;
         compositionRelationshipSummariesIndex < compositionRelationshipSummariesJsonList.GetLength();
         ++compositionRelationshipSummariesIndex) {
      m_compositionRelationshipSummaries.push_back(
          compositionRelationshipSummariesJsonList[compositionRelationshipSummariesIndex].AsObject());
    }
    m_compositionRelationshipSummariesHasBeenSet = true;
  }
