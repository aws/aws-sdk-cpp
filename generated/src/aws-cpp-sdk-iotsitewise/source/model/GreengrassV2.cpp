...
GreengrassV2::GreengrassV2(JsonView jsonValue) { *this = jsonValue; }
...
GreengrassV2& GreengrassV2::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("coreDeviceOperatingSystem")) {
    m_coreDeviceOperatingSystem =
        CoreDeviceOperatingSystemMapper::GetCoreDeviceOperatingSystemForName(jsonValue.GetString("coreDeviceOperatingSystem"));
...
JsonValue GreengrassV2::Jsonize() const {
  ...
  if (m_coreDeviceOperatingSystemHasBeenSet) {
    payload.WithString("coreDeviceOperatingSystem",
                       CoreDeviceOperatingSystemMapper::GetNameForCoreDeviceOperatingSystem(m_coreDeviceOperatingSystem));
  }
