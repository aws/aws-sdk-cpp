...
DisassociateDataSegmentEntry::DisassociateDataSegmentEntry(JsonView jsonValue) { *this = jsonValue; }

DisassociateDataSegmentEntry& DisassociateDataSegmentEntry::operator=(JsonView jsonValue) {
...
JsonValue DisassociateDataSegmentEntry::Jsonize() const {
  JsonValue payload;
