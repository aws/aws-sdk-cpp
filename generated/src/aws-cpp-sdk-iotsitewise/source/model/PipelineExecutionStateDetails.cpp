...
PipelineExecutionStateDetails::PipelineExecutionStateDetails(JsonView jsonValue) { *this = jsonValue; }

PipelineExecutionStateDetails& PipelineExecutionStateDetails::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("code")) {
    m_code = PipelineErrorCodeMapper::GetPipelineErrorCodeForName(jsonValue.GetString("code"));
...
JsonValue PipelineExecutionStateDetails::Jsonize() const {
  JsonValue payload;

  if (m_codeHasBeenSet) {
    payload.WithString("code", PipelineErrorCodeMapper::GetNameForPipelineErrorCode(m_code));
  }
