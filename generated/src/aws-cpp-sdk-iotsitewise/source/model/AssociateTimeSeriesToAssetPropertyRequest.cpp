...
Aws::String AssociateTimeSeriesToAssetPropertyRequest::SerializePayload() const
{
  JsonValue payload;
...
void AssociateTimeSeriesToAssetPropertyRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
