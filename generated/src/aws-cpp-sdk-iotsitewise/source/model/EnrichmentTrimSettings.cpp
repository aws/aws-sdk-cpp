...
EnrichmentTrimSettings::EnrichmentTrimSettings(JsonView jsonValue) { *this = jsonValue; }

EnrichmentTrimSettings& EnrichmentTrimSettings::operator=(JsonView jsonValue) {
...
JsonValue EnrichmentTrimSettings::Jsonize() const {
  JsonValue payload;
