...
BatchGetAssetPropertyAggregatesErrorEntry::BatchGetAssetPropertyAggregatesErrorEntry(JsonView jsonValue) { *this = jsonValue; }

BatchGetAssetPropertyAggregatesErrorEntry& BatchGetAssetPropertyAggregatesErrorEntry::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("errorCode")) {
    m_errorCode = BatchGetAssetPropertyAggregatesErrorCodeMapper::GetBatchGetAssetPropertyAggregatesErrorCodeForName(
...
JsonValue BatchGetAssetPropertyAggregatesErrorEntry::Jsonize() const {
  ...
  if (m_errorCodeHasBeenSet) {
    payload.WithString("errorCode",
                       BatchGetAssetPropertyAggregatesErrorCodeMapper::GetNameForBatchGetAssetPropertyAggregatesErrorCode(m_errorCode));
  }
