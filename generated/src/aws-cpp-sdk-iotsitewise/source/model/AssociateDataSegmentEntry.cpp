...
AssociateDataSegmentEntry::AssociateDataSegmentEntry(JsonView jsonValue) { *this = jsonValue; }

AssociateDataSegmentEntry& AssociateDataSegmentEntry::operator=(JsonView jsonValue) {
...
JsonValue AssociateDataSegmentEntry::Jsonize() const {
  JsonValue payload;
