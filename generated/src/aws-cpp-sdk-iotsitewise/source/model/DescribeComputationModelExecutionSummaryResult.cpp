...
DescribeComputationModelExecutionSummaryResult::DescribeComputationModelExecutionSummaryResult(
...
DescribeComputationModelExecutionSummaryResult& DescribeComputationModelExecutionSummaryResult::operator=(
  ...
  if (jsonValue.ValueExists("computationModelExecutionSummary")) {
    Aws::Map<Aws::String, JsonView> computationModelExecutionSummaryJsonMap =
        jsonValue.GetObject("computationModelExecutionSummary").GetAllObjects();
    for (auto& computationModelExecutionSummaryItem : computationModelExecutionSummaryJsonMap) {
      m_computationModelExecutionSummary[computationModelExecutionSummaryItem.first] =
          computationModelExecutionSummaryItem.second.AsString();
    }
