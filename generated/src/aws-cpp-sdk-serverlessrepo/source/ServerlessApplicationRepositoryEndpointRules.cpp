...
{
const size_t ServerlessApplicationRepositoryEndpointRules::RulesBlobStrLen = 4184;
const size_t ServerlessApplicationRepositoryEndpointRules::RulesBlobSize = 4185;
...
'v','e','r','l','e','s','s','r','e','p','o','-','f','i','p','s','.','{','R','e','g','i','o','n','}',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','e','r','v','e','r','l','e','s','s',
'r','e','p','o','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.','c',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','e','r','v','e','r','l','e','s',
's','r','e','p','o','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','e','r','v','e','r','l','e','s','s',
'r','e','p','o','.','u','s','-','g','o','v','-','e','a','s','t','-','1','.','a','m','a','z','o','n',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','e','r','v','e','r','l','e','s','s',
'r','e','p','o','.','u','s','-','g','o','v','-','w','e','s','t','-','1','.','a','m','a','z','o','n',
'a','w','s','.','c','o','m','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','}',',',
'"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e','"',':','"','e','n','d',
'p','o','i','n','t','"','}',',','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',',
'"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':',
'/','/','s','e','r','v','e','r','l','e','s','s','r','e','p','o','.','{','R','e','g','i','o','n','}',
'.','{','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','#','d','n','s','S','u','f','f',
'i','x','}','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a',
'd','e','r','s','"',':','{','}','}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n',
't','"','}',']','}',']','}',']','}','\0'
...
const char* ServerlessApplicationRepositoryEndpointRules::GetRulesBlob()
{
