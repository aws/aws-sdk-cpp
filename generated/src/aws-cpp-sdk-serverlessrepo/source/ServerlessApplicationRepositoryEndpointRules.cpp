...
{
const size_t ServerlessApplicationRepositoryEndpointRules::RulesBlobStrLen = 3738;
const size_t ServerlessApplicationRepositoryEndpointRules::RulesBlobSize = 3739;
...
'r','e','p','o','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'v','e','r','l','e','s','s','r','e','p','o','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
