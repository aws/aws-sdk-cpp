...
{
const size_t ServerlessApplicationRepositoryEndpointRules::RulesBlobStrLen = 3486;
const size_t ServerlessApplicationRepositoryEndpointRules::RulesBlobSize = 3487;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','e','r','v','e','r',
'l','e','s','s','r','e','p','o','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','s','e','r','v','e','r','l','e','s','s','r','e','p','o','-','f','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','s','e','r','v','e','r','l','e','s','s','r','e','p',
