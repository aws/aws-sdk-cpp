...
class AWS_SERVERLESSAPPLICATIONREPOSITORY_API ServerlessApplicationRepositoryClient
 ...
 public:
  ...
  ServerlessApplicationRepositoryClient(
      const Aws::ServerlessApplicationRepository::ServerlessApplicationRepositoryClientConfiguration& clientConfiguration =
  ...
  /**
   * A Callable wrapper for CreateApplicationVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateApplicationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateApplicationVersionRequestT = Model::CreateApplicationVersionRequest>
  void CreateApplicationVersionAsync(const CreateApplicationVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCloudFormationChangeSetOutcome CreateCloudFormationChangeSet(
      const Model::CreateCloudFormationChangeSetRequest& request) const;

  /**
   * A Callable wrapper for CreateCloudFormationChangeSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCloudFormationChangeSetRequestT = Model::CreateCloudFormationChangeSetRequest>
  Model::CreateCloudFormationChangeSetOutcomeCallable CreateCloudFormationChangeSetCallable(
      const CreateCloudFormationChangeSetRequestT& request) const {
    return SubmitCallable(&ServerlessApplicationRepositoryClient::CreateCloudFormationChangeSet, request);
  }

  /**
   * An Async wrapper for CreateCloudFormationChangeSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCloudFormationChangeSetRequestT = Model::CreateCloudFormationChangeSetRequest>
  void CreateCloudFormationChangeSetAsync(const CreateCloudFormationChangeSetRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCloudFormationTemplateOutcome CreateCloudFormationTemplate(
      const Model::CreateCloudFormationTemplateRequest& request) const;

  /**
   * A Callable wrapper for CreateCloudFormationTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCloudFormationTemplateRequestT = Model::CreateCloudFormationTemplateRequest>
  Model::CreateCloudFormationTemplateOutcomeCallable CreateCloudFormationTemplateCallable(
      const CreateCloudFormationTemplateRequestT& request) const {
    return SubmitCallable(&ServerlessApplicationRepositoryClient::CreateCloudFormationTemplate, request);
  }

  /**
   * An Async wrapper for CreateCloudFormationTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCloudFormationTemplateRequestT = Model::CreateCloudFormationTemplateRequest>
  void CreateCloudFormationTemplateAsync(const CreateCloudFormationTemplateRequestT& request,
  ...
  /**
   * A Callable wrapper for GetApplicationPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetApplicationPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetApplicationPolicyRequestT = Model::GetApplicationPolicyRequest>
  void GetApplicationPolicyAsync(const GetApplicationPolicyRequestT& request, const GetApplicationPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCloudFormationTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetCloudFormationTemplateRequestT = Model::GetCloudFormationTemplateRequest>
  Model::GetCloudFormationTemplateOutcomeCallable GetCloudFormationTemplateCallable(
      const GetCloudFormationTemplateRequestT& request) const {
    return SubmitCallable(&ServerlessApplicationRepositoryClient::GetCloudFormationTemplate, request);
  }

  /**
   * An Async wrapper for GetCloudFormationTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCloudFormationTemplateRequestT = Model::GetCloudFormationTemplateRequest>
  void GetCloudFormationTemplateAsync(const GetCloudFormationTemplateRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListApplicationDependenciesOutcome ListApplicationDependencies(
      const Model::ListApplicationDependenciesRequest& request) const;

  /**
   * A Callable wrapper for ListApplicationDependencies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListApplicationDependenciesRequestT = Model::ListApplicationDependenciesRequest>
  Model::ListApplicationDependenciesOutcomeCallable ListApplicationDependenciesCallable(
      const ListApplicationDependenciesRequestT& request) const {
    return SubmitCallable(&ServerlessApplicationRepositoryClient::ListApplicationDependencies, request);
  }

  /**
   * An Async wrapper for ListApplicationDependencies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListApplicationDependenciesRequestT = Model::ListApplicationDependenciesRequest>
  void ListApplicationDependenciesAsync(const ListApplicationDependenciesRequestT& request,
...
.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for PutApplicationPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutApplicationPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutApplicationPolicyRequestT = Model::PutApplicationPolicyRequest>
  void PutApplicationPolicyAsync(const PutApplicationPolicyRequestT& request, const PutApplicationPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UnshareApplication that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UnshareApplication that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UnshareApplicationRequestT = Model::UnshareApplicationRequest>
  void UnshareApplicationAsync(const UnshareApplicationRequestT& request, const UnshareApplicationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
