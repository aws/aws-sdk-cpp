...
class UpdateApplicationResult {
 public:
  ...
  AWS_SERVERLESSAPPLICATIONREPOSITORY_API UpdateApplicationResult& operator=(
  ...
  template <typename AuthorT = Aws::String>
  UpdateApplicationResult& WithAuthor(AuthorT&& value) {
  ...
  template <typename CreationTimeT = Aws::String>
  UpdateApplicationResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename HomePageUrlT = Aws::String>
  UpdateApplicationResult& WithHomePageUrl(HomePageUrlT&& value) {
  ...
  inline UpdateApplicationResult& WithIsVerifiedAuthor(bool value) {
  ...
  template <typename LabelsT = Aws::Vector<Aws::String>>
  UpdateApplicationResult& WithLabels(LabelsT&& value) {
    SetLabels(std::forward<LabelsT>(value));
    return *this;
  }
  template <typename LabelsT = Aws::String>
  UpdateApplicationResult& AddLabels(LabelsT&& value) {
    m_labelsHasBeenSet = true;
  ...
  template <typename LicenseUrlT = Aws::String>
  UpdateApplicationResult& WithLicenseUrl(LicenseUrlT&& value) {
  ...
  template <typename ReadmeUrlT = Aws::String>
  UpdateApplicationResult& WithReadmeUrl(ReadmeUrlT&& value) {
  ...
  template <typename SpdxLicenseIdT = Aws::String>
  UpdateApplicationResult& WithSpdxLicenseId(SpdxLicenseIdT&& value) {
  ...
  template <typename VerifiedAuthorUrlT = Aws::String>
  UpdateApplicationResult& WithVerifiedAuthorUrl(VerifiedAuthorUrlT&& value) {
  ...
  template <typename VersionT = Version>
  UpdateApplicationResult& WithVersion(VersionT&& value) {
