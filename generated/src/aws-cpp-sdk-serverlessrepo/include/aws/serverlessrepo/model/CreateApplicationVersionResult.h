...
class CreateApplicationVersionResult {
 public:
  ...
  AWS_SERVERLESSAPPLICATIONREPOSITORY_API CreateApplicationVersionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  CreateApplicationVersionResult& AddParameterDefinitions(ParameterDefinitionsT&& value) {
    m_parameterDefinitionsHasBeenSet = true;
    m_parameterDefinitions.emplace_back(std::forward<ParameterDefinitionsT>(value));
    return *this;
  }
  ///@}
...
this parameter for an
  ...
  inline CreateApplicationVersionResult& AddRequiredCapabilities(Capability value) {
    m_requiredCapabilitiesHasBeenSet = true;
...
in which it is being retrieved.</p>
  ...
  inline void SetResourcesSupported(bool value) {
    m_resourcesSupportedHasBeenSet = true;
    m_resourcesSupported = value;
  }
  inline CreateApplicationVersionResult& WithResourcesSupported(bool value) {
    SetResourcesSupported(value);
    return *this;
  }
  ///@}
