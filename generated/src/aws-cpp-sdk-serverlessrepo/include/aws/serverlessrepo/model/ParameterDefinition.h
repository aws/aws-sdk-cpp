...
Malformed
  ...
  void SetConstraintDescription(ConstraintDescriptionT&& value) {
    ...
    m_constraintDescription = std::forward<ConstraintDescriptionT>(value);
  }
  template <typename ConstraintDescriptionT = Aws::String>
  ParameterDefinition& WithConstraintDescription(ConstraintDescriptionT&& value) {
    SetConstraintDescription(std::forward<ConstraintDescriptionT>(value));
    return *this;
  }
  ///@}
...
If you define constraints for the parameter,
  ...
  inline ParameterDefinition& WithMaxLength(int value) {
    SetMaxLength(value);
    return *this;
  }
  ///@}
  ...
  inline ParameterDefinition& WithMaxValue(int value) {
    SetMaxValue(value);
    return *this;
  }
  ///@}
  ...
  inline ParameterDefinition& WithMinLength(int value) {
    SetMinLength(value);
    return *this;
  }
  ///@}
  ...
  inline ParameterDefinition& WithMinValue(int value) {
    SetMinValue(value);
    return *this;
  }
  ///@}
...
value to true, the parameter value is
  ...
  inline void SetNoEcho(bool value) {
    m_noEchoHasBeenSet = true;
    m_noEcho = value;
  }
  inline ParameterDefinition& WithNoEcho(bool value) {
    SetNoEcho(value);
    return *this;
  }
  ///@}
  ...
  void SetReferencedByResources(ReferencedByResourcesT&& value) {
    ...
    m_referencedByResources = std::forward<ReferencedByResourcesT>(value);
  }
  template <typename ReferencedByResourcesT = Aws::Vector<Aws::String>>
  ParameterDefinition& WithReferencedByResources(ReferencedByResourcesT&& value) {
    SetReferencedByResources(std::forward<ReferencedByResourcesT>(value));
    return *this;
  }
  ...
  ParameterDefinition& AddReferencedByResources(ReferencedByResourcesT&& value) {
    m_referencedByResourcesHasBeenSet = true;
    m_referencedByResources.emplace_back(std::forward<ReferencedByResourcesT>(value));
    return *this;
  }
  ///@}
