...
class CreateCloudFormationTemplateRequest : public ServerlessApplicationRepositoryRequest {
 public:
  ...
  template <typename ApplicationIdT = Aws::String>
  CreateCloudFormationTemplateRequest& WithApplicationId(ApplicationIdT&& value) {
...
<a
  ...
  template <typename SemanticVersionT = Aws::String>
  CreateCloudFormationTemplateRequest& WithSemanticVersion(SemanticVersionT&& value) {
