...
The file has the format
  ...
  void SetLicenseBody(LicenseBodyT&& value) {
    m_licenseBodyHasBeenSet = true;
    m_licenseBody = std::forward<LicenseBodyT>(value);
  }
  template <typename LicenseBodyT = Aws::String>
  CreateApplicationRequest& WithLicenseBody(LicenseBodyT&& value) {
    SetLicenseBody(std::forward<LicenseBodyT>(value));
    return *this;
  }
  ///@}
...
The file has the format
  ...
  void SetReadmeBody(ReadmeBodyT&& value) {
    m_readmeBodyHasBeenSet = true;
    m_readmeBody = std::forward<ReadmeBodyT>(value);
  }
  template <typename ReadmeBodyT = Aws::String>
  CreateApplicationRequest& WithReadmeBody(ReadmeBodyT&& value) {
    SetReadmeBody(std::forward<ReadmeBodyT>(value));
    return *this;
  }
  ///@}
...
<a
  ...
  void SetSourceCodeArchiveUrl(SourceCodeArchiveUrlT&& value) {
    ...
    m_sourceCodeArchiveUrl = std::forward<SourceCodeArchiveUrlT>(value);
  }
  template <typename SourceCodeArchiveUrlT = Aws::String>
  CreateApplicationRequest& WithSourceCodeArchiveUrl(SourceCodeArchiveUrlT&& value) {
    SetSourceCodeArchiveUrl(std::forward<SourceCodeArchiveUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceCodeUrl(SourceCodeUrlT&& value) {
    ...
    m_sourceCodeUrl = std::forward<SourceCodeUrlT>(value);
  }
  template <typename SourceCodeUrlT = Aws::String>
  CreateApplicationRequest& WithSourceCodeUrl(SourceCodeUrlT&& value) {
    SetSourceCodeUrl(std::forward<SourceCodeUrlT>(value));
    return *this;
  }
  ///@}
