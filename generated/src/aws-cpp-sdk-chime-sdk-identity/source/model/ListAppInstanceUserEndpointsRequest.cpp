...
Aws::String ListAppInstanceUserEndpointsRequest::SerializePayload() const { return {}; }

void ListAppInstanceUserEndpointsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
