...
UpdateAppInstanceBotResult::UpdateAppInstanceBotResult()
{
}

UpdateAppInstanceBotResult::UpdateAppInstanceBotResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
