...
template <>
AWS_CHIMESDKIDENTITY_API ConflictException ChimeSDKIdentityError::GetModeledError() {
  assert(this->GetErrorType() == ChimeSDKIdentityErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_CHIMESDKIDENTITY_API ServiceUnavailableException ChimeSDKIdentityError::GetModeledError() {
...
template <>
AWS_CHIMESDKIDENTITY_API NotFoundException ChimeSDKIdentityError::GetModeledError() {
  assert(this->GetErrorType() == ChimeSDKIdentityErrors::NOT_FOUND);
  return NotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_CHIMESDKIDENTITY_API ServiceFailureException ChimeSDKIdentityError::GetModeledError() {
  assert(this->GetErrorType() == ChimeSDKIdentityErrors::SERVICE_FAILURE);
  return ServiceFailureException(this->GetJsonPayload().View());
}

template <>
AWS_CHIMESDKIDENTITY_API ForbiddenException ChimeSDKIdentityError::GetModeledError() {
  assert(this->GetErrorType() == ChimeSDKIdentityErrors::FORBIDDEN);
  return ForbiddenException(this->GetJsonPayload().View());
}

template <>
AWS_CHIMESDKIDENTITY_API ResourceLimitExceededException ChimeSDKIdentityError::GetModeledError() {
...
template <>
AWS_CHIMESDKIDENTITY_API ThrottledClientException ChimeSDKIdentityError::GetModeledError() {
  assert(this->GetErrorType() == ChimeSDKIdentityErrors::THROTTLED_CLIENT);
  return ThrottledClientException(this->GetJsonPayload().View());
}

template <>
AWS_CHIMESDKIDENTITY_API BadRequestException ChimeSDKIdentityError::GetModeledError() {
  assert(this->GetErrorType() == ChimeSDKIdentityErrors::BAD_REQUEST);
  return BadRequestException(this->GetJsonPayload().View());
}

template <>
AWS_CHIMESDKIDENTITY_API UnauthorizedClientException ChimeSDKIdentityError::GetModeledError() {
