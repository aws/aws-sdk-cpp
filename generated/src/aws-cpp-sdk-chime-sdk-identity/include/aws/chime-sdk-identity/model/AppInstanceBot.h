...
class AppInstanceBot {
 public:
  ...
  template <typename AppInstanceBotArnT = Aws::String>
  AppInstanceBot& WithAppInstanceBotArn(AppInstanceBotArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  AppInstanceBot& WithName(NameT&& value) {
  ...
  template <typename ConfigurationT = Configuration>
  AppInstanceBot& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  AppInstanceBot& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::Utils::DateTime>
  AppInstanceBot& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  template <typename MetadataT = Aws::String>
  AppInstanceBot& WithMetadata(MetadataT&& value) {
