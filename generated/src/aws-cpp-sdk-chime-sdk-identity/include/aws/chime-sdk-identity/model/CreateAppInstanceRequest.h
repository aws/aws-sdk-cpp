...
class CreateAppInstanceRequest : public ChimeSDKIdentityRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateAppInstanceRequest& WithName(NameT&& value) {
  ...
  template <typename MetadataT = Aws::String>
  CreateAppInstanceRequest& WithMetadata(MetadataT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateAppInstanceRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateAppInstanceRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateAppInstanceRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
