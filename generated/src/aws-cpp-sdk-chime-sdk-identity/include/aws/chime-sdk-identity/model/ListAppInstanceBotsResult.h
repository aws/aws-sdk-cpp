...
class ListAppInstanceBotsResult {
 public:
  ...
  template <typename AppInstanceArnT = Aws::String>
  ListAppInstanceBotsResult& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  void SetAppInstanceBots(AppInstanceBotsT&& value) {
    m_appInstanceBotsHasBeenSet = true;
    m_appInstanceBots = std::forward<AppInstanceBotsT>(value);
  }
  template <typename AppInstanceBotsT = Aws::Vector<AppInstanceBotSummary>>
  ListAppInstanceBotsResult& WithAppInstanceBots(AppInstanceBotsT&& value) {
    SetAppInstanceBots(std::forward<AppInstanceBotsT>(value));
    return *this;
  }
  template <typename AppInstanceBotsT = AppInstanceBotSummary>
  ListAppInstanceBotsResult& AddAppInstanceBots(AppInstanceBotsT&& value) {
    m_appInstanceBotsHasBeenSet = true;
    m_appInstanceBots.emplace_back(std::forward<AppInstanceBotsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppInstanceBotsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppInstanceBotsResult& WithRequestId(RequestIdT&& value) {
