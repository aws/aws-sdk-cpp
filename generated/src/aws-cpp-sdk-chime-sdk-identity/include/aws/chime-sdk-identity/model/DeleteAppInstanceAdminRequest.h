...
namespace Model
{
  ...
  public:
    ...
    template<typename AppInstanceAdminArnT = Aws::String>
    DeleteAppInstanceAdminRequest& WithAppInstanceAdminArn(AppInstanceAdminArnT&& value) { SetAppInstanceAdminArn(std::forward<AppInstanceAdminArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AppInstanceArnT = Aws::String>
    DeleteAppInstanceAdminRequest& WithAppInstanceArn(AppInstanceArnT&& value) { SetAppInstanceArn(std::forward<AppInstanceArnT>(value)); return *this;}
    ///@}
  private:
