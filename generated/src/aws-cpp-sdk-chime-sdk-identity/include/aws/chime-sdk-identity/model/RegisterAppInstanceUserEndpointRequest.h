...
class RegisterAppInstanceUserEndpointRequest : public ChimeSDKIdentityRequest {
 public:
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  RegisterAppInstanceUserEndpointRequest& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  RegisterAppInstanceUserEndpointRequest& WithName(NameT&& value) {
  ...
  inline void SetType(AppInstanceUserEndpointType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RegisterAppInstanceUserEndpointRequest& WithType(AppInstanceUserEndpointType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceArnT = Aws::String>
  RegisterAppInstanceUserEndpointRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  void SetEndpointAttributes(EndpointAttributesT&& value) {
    m_endpointAttributesHasBeenSet = true;
    m_endpointAttributes = std::forward<EndpointAttributesT>(value);
  }
  template <typename EndpointAttributesT = EndpointAttributes>
  RegisterAppInstanceUserEndpointRequest& WithEndpointAttributes(EndpointAttributesT&& value) {
    SetEndpointAttributes(std::forward<EndpointAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientRequestTokenT = Aws::String>
  RegisterAppInstanceUserEndpointRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  inline void SetAllowMessages(AllowMessages value) {
    m_allowMessagesHasBeenSet = true;
    m_allowMessages = value;
  }
  inline RegisterAppInstanceUserEndpointRequest& WithAllowMessages(AllowMessages value) {
