...
class EndpointAttributes {
 public:
  ...
  void SetDeviceToken(DeviceTokenT&& value) {
    ...
    m_deviceToken = std::forward<DeviceTokenT>(value);
  }
  template <typename DeviceTokenT = Aws::String>
  EndpointAttributes& WithDeviceToken(DeviceTokenT&& value) {
    SetDeviceToken(std::forward<DeviceTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVoipDeviceToken(VoipDeviceTokenT&& value) {
    m_voipDeviceTokenHasBeenSet = true;
    m_voipDeviceToken = std::forward<VoipDeviceTokenT>(value);
  }
  template <typename VoipDeviceTokenT = Aws::String>
  EndpointAttributes& WithVoipDeviceToken(VoipDeviceTokenT&& value) {
    SetVoipDeviceToken(std::forward<VoipDeviceTokenT>(value));
    return *this;
  }
  ///@}
 private:
