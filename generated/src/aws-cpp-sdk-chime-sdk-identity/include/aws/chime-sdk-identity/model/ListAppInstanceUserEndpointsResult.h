...
class ListAppInstanceUserEndpointsResult {
 public:
  ...
  AWS_CHIMESDKIDENTITY_API ListAppInstanceUserEndpointsResult& operator=(
  ...
  void SetAppInstanceUserEndpoints(AppInstanceUserEndpointsT&& value) {
    m_appInstanceUserEndpointsHasBeenSet = true;
    m_appInstanceUserEndpoints = std::forward<AppInstanceUserEndpointsT>(value);
  }
  template <typename AppInstanceUserEndpointsT = Aws::Vector<AppInstanceUserEndpointSummary>>
  ListAppInstanceUserEndpointsResult& WithAppInstanceUserEndpoints(AppInstanceUserEndpointsT&& value) {
    SetAppInstanceUserEndpoints(std::forward<AppInstanceUserEndpointsT>(value));
    return *this;
  }
  template <typename AppInstanceUserEndpointsT = AppInstanceUserEndpointSummary>
  ListAppInstanceUserEndpointsResult& AddAppInstanceUserEndpoints(AppInstanceUserEndpointsT&& value) {
    m_appInstanceUserEndpointsHasBeenSet = true;
    m_appInstanceUserEndpoints.emplace_back(std::forward<AppInstanceUserEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppInstanceUserEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppInstanceUserEndpointsResult& WithRequestId(RequestIdT&& value) {
