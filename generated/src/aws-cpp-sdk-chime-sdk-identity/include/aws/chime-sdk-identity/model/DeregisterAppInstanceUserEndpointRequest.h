...
class DeregisterAppInstanceUserEndpointRequest : public ChimeSDKIdentityRequest {
 public:
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  DeregisterAppInstanceUserEndpointRequest& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  template <typename EndpointIdT = Aws::String>
  DeregisterAppInstanceUserEndpointRequest& WithEndpointId(EndpointIdT&& value) {
