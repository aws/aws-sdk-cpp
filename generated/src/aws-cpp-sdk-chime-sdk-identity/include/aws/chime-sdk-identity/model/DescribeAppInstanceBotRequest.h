...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKIDENTITY_API DescribeAppInstanceBotRequest() = default;
    ...
    template<typename AppInstanceBotArnT = Aws::String>
    DescribeAppInstanceBotRequest& WithAppInstanceBotArn(AppInstanceBotArnT&& value) { SetAppInstanceBotArn(std::forward<AppInstanceBotArnT>(value)); return *this;}
    ///@}
  private:
