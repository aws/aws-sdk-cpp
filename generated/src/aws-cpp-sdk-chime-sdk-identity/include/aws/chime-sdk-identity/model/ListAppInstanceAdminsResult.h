...
class ListAppInstanceAdminsResult {
 public:
  ...
  template <typename AppInstanceArnT = Aws::String>
  ListAppInstanceAdminsResult& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  void SetAppInstanceAdmins(AppInstanceAdminsT&& value) {
    m_appInstanceAdminsHasBeenSet = true;
    m_appInstanceAdmins = std::forward<AppInstanceAdminsT>(value);
  }
  template <typename AppInstanceAdminsT = Aws::Vector<AppInstanceAdminSummary>>
  ListAppInstanceAdminsResult& WithAppInstanceAdmins(AppInstanceAdminsT&& value) {
    SetAppInstanceAdmins(std::forward<AppInstanceAdminsT>(value));
    return *this;
  }
  template <typename AppInstanceAdminsT = AppInstanceAdminSummary>
  ListAppInstanceAdminsResult& AddAppInstanceAdmins(AppInstanceAdminsT&& value) {
    m_appInstanceAdminsHasBeenSet = true;
    m_appInstanceAdmins.emplace_back(std::forward<AppInstanceAdminsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppInstanceAdminsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppInstanceAdminsResult& WithRequestId(RequestIdT&& value) {
