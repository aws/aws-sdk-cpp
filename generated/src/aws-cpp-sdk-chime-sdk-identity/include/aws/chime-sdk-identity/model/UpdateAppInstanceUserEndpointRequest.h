...
class UpdateAppInstanceUserEndpointRequest : public ChimeSDKIdentityRequest {
 public:
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  UpdateAppInstanceUserEndpointRequest& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  template <typename EndpointIdT = Aws::String>
  UpdateAppInstanceUserEndpointRequest& WithEndpointId(EndpointIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateAppInstanceUserEndpointRequest& WithName(NameT&& value) {
  ...
  inline UpdateAppInstanceUserEndpointRequest& WithAllowMessages(AllowMessages value) {
