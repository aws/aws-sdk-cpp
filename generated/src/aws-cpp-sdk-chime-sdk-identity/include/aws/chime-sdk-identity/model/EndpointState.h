...
class EndpointState {
 public:
  ...
  inline EndpointState& WithStatus(EndpointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusReason(EndpointStatusReason value) {
    m_statusReasonHasBeenSet = true;
    m_statusReason = value;
  }
  inline EndpointState& WithStatusReason(EndpointStatusReason value) {
