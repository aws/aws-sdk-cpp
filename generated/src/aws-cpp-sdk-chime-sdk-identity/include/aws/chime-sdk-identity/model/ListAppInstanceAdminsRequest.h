...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKIDENTITY_API ListAppInstanceAdminsRequest() = default;
    ...
    template<typename AppInstanceArnT = Aws::String>
    ListAppInstanceAdminsRequest& WithAppInstanceArn(AppInstanceArnT&& value) { SetAppInstanceArn(std::forward<AppInstanceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAppInstanceAdminsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
