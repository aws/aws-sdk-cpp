...
class ListAppInstanceAdminsRequest : public ChimeSDKIdentityRequest {
 public:
  ...
  template <typename AppInstanceArnT = Aws::String>
  ListAppInstanceAdminsRequest& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  inline ListAppInstanceAdminsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppInstanceAdminsRequest& WithNextToken(NextTokenT&& value) {
