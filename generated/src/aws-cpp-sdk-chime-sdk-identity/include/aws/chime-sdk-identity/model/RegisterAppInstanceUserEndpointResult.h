...
class RegisterAppInstanceUserEndpointResult {
 public:
  ...
  AWS_CHIMESDKIDENTITY_API RegisterAppInstanceUserEndpointResult& operator=(
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  RegisterAppInstanceUserEndpointResult& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  template <typename EndpointIdT = Aws::String>
  RegisterAppInstanceUserEndpointResult& WithEndpointId(EndpointIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RegisterAppInstanceUserEndpointResult& WithRequestId(RequestIdT&& value) {
