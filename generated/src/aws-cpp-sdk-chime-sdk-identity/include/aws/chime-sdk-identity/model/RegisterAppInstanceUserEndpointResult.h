...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKIDENTITY_API RegisterAppInstanceUserEndpointResult() = default;
    ...
    template<typename AppInstanceUserArnT = Aws::String>
    RegisterAppInstanceUserEndpointResult& WithAppInstanceUserArn(AppInstanceUserArnT&& value) { SetAppInstanceUserArn(std::forward<AppInstanceUserArnT>(value)); return *this;}
    ///@}
    ...
    template<typename EndpointIdT = Aws::String>
    RegisterAppInstanceUserEndpointResult& WithEndpointId(EndpointIdT&& value) { SetEndpointId(std::forward<EndpointIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    RegisterAppInstanceUserEndpointResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
