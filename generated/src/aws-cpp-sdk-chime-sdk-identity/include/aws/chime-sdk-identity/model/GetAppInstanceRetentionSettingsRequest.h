...
/**
 */
class GetAppInstanceRetentionSettingsRequest : public ChimeSDKIdentityRequest {
 public:
  AWS_CHIMESDKIDENTITY_API GetAppInstanceRetentionSettingsRequest() = default;
  ...
  template <typename AppInstanceArnT = Aws::String>
  GetAppInstanceRetentionSettingsRequest& WithAppInstanceArn(AppInstanceArnT&& value) {
