...
class GetAppInstanceRetentionSettingsResult {
 public:
  ...
  AWS_CHIMESDKIDENTITY_API GetAppInstanceRetentionSettingsResult& operator=(
  ...
  template <typename AppInstanceRetentionSettingsT = AppInstanceRetentionSettings>
  GetAppInstanceRetentionSettingsResult& WithAppInstanceRetentionSettings(AppInstanceRetentionSettingsT&& value) {
  ...
  template <typename InitiateDeletionTimestampT = Aws::Utils::DateTime>
  GetAppInstanceRetentionSettingsResult& WithInitiateDeletionTimestamp(InitiateDeletionTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAppInstanceRetentionSettingsResult& WithRequestId(RequestIdT&& value) {
