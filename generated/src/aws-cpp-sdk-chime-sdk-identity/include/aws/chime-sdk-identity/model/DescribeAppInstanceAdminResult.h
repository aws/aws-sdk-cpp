...
class DescribeAppInstanceAdminResult {
 public:
  ...
  AWS_CHIMESDKIDENTITY_API DescribeAppInstanceAdminResult& operator=(
  ...
  template <typename AppInstanceAdminT = AppInstanceAdmin>
  DescribeAppInstanceAdminResult& WithAppInstanceAdmin(AppInstanceAdminT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAppInstanceAdminResult& WithRequestId(RequestIdT&& value) {
