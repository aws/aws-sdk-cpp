...
class PutAppInstanceUserExpirationSettingsRequest : public ChimeSDKIdentityRequest {
 public:
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  PutAppInstanceUserExpirationSettingsRequest& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  template <typename ExpirationSettingsT = ExpirationSettings>
  PutAppInstanceUserExpirationSettingsRequest& WithExpirationSettings(ExpirationSettingsT&& value) {
