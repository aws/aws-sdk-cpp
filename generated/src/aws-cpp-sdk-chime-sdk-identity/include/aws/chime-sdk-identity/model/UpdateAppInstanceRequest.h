...
class UpdateAppInstanceRequest : public ChimeSDKIdentityRequest {
 public:
  AWS_CHIMESDKIDENTITY_API UpdateAppInstanceRequest() = default;
  ...
  template <typename AppInstanceArnT = Aws::String>
  UpdateAppInstanceRequest& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateAppInstanceRequest& WithName(NameT&& value) {
  ...
  template <typename MetadataT = Aws::String>
  UpdateAppInstanceRequest& WithMetadata(MetadataT&& value) {
