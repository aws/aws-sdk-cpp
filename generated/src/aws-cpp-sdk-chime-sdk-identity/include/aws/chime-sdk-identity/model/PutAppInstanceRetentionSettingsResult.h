...
class PutAppInstanceRetentionSettingsResult {
 public:
  ...
  AWS_CHIMESDKIDENTITY_API PutAppInstanceRetentionSettingsResult& operator=(
  ...
  void SetAppInstanceRetentionSettings(AppInstanceRetentionSettingsT&& value) {
    m_appInstanceRetentionSettingsHasBeenSet = true;
    m_appInstanceRetentionSettings = std::forward<AppInstanceRetentionSettingsT>(value);
  }
  template <typename AppInstanceRetentionSettingsT = AppInstanceRetentionSettings>
  PutAppInstanceRetentionSettingsResult& WithAppInstanceRetentionSettings(AppInstanceRetentionSettingsT&& value) {
    SetAppInstanceRetentionSettings(std::forward<AppInstanceRetentionSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInitiateDeletionTimestamp(InitiateDeletionTimestampT&& value) {
    m_initiateDeletionTimestampHasBeenSet = true;
    m_initiateDeletionTimestamp = std::forward<InitiateDeletionTimestampT>(value);
  }
  template <typename InitiateDeletionTimestampT = Aws::Utils::DateTime>
  PutAppInstanceRetentionSettingsResult& WithInitiateDeletionTimestamp(InitiateDeletionTimestampT&& value) {
    SetInitiateDeletionTimestamp(std::forward<InitiateDeletionTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutAppInstanceRetentionSettingsResult& WithRequestId(RequestIdT&& value) {
