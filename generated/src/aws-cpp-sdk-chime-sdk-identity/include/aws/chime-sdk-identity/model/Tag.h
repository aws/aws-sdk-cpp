...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKIDENTITY_API Tag() = default;
    AWS_CHIMESDKIDENTITY_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_CHIMESDKIDENTITY_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
