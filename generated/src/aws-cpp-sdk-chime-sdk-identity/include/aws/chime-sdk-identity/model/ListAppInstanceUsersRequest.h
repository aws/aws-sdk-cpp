...
class ListAppInstanceUsersRequest : public ChimeSDKIdentityRequest {
 public:
  ...
  template <typename AppInstanceArnT = Aws::String>
  ListAppInstanceUsersRequest& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  inline ListAppInstanceUsersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppInstanceUsersRequest& WithNextToken(NextTokenT&& value) {
