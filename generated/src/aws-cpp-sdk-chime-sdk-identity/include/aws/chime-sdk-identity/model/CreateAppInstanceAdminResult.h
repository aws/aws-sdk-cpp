...
class CreateAppInstanceAdminResult {
 public:
  ...
  void SetAppInstanceAdmin(AppInstanceAdminT&& value) {
    m_appInstanceAdminHasBeenSet = true;
    m_appInstanceAdmin = std::forward<AppInstanceAdminT>(value);
  }
  template <typename AppInstanceAdminT = Identity>
  CreateAppInstanceAdminResult& WithAppInstanceAdmin(AppInstanceAdminT&& value) {
    SetAppInstanceAdmin(std::forward<AppInstanceAdminT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AppInstanceArnT = Aws::String>
  CreateAppInstanceAdminResult& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAppInstanceAdminResult& WithRequestId(RequestIdT&& value) {
