...
class AppInstanceUserEndpointSummary {
 public:
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  AppInstanceUserEndpointSummary& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  template <typename EndpointIdT = Aws::String>
  AppInstanceUserEndpointSummary& WithEndpointId(EndpointIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  AppInstanceUserEndpointSummary& WithName(NameT&& value) {
  ...
  inline AppInstanceUserEndpointSummary& WithType(AppInstanceUserEndpointType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline AppInstanceUserEndpointSummary& WithAllowMessages(AllowMessages value) {
  ...
  template <typename EndpointStateT = EndpointState>
  AppInstanceUserEndpointSummary& WithEndpointState(EndpointStateT&& value) {
