...
class CreateAppInstanceBotRequest : public ChimeSDKIdentityRequest {
 public:
  ...
  template <typename AppInstanceArnT = Aws::String>
  CreateAppInstanceBotRequest& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateAppInstanceBotRequest& WithName(NameT&& value) {
  ...
  template <typename MetadataT = Aws::String>
  CreateAppInstanceBotRequest& WithMetadata(MetadataT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateAppInstanceBotRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateAppInstanceBotRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateAppInstanceBotRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ConfigurationT = Configuration>
  CreateAppInstanceBotRequest& WithConfiguration(ConfigurationT&& value) {
