...
class DescribeAppInstanceBotResult {
 public:
  ...
  void SetAppInstanceBot(AppInstanceBotT&& value) {
    m_appInstanceBotHasBeenSet = true;
    m_appInstanceBot = std::forward<AppInstanceBotT>(value);
  }
  template <typename AppInstanceBotT = AppInstanceBot>
  DescribeAppInstanceBotResult& WithAppInstanceBot(AppInstanceBotT&& value) {
    SetAppInstanceBot(std::forward<AppInstanceBotT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAppInstanceBotResult& WithRequestId(RequestIdT&& value) {
