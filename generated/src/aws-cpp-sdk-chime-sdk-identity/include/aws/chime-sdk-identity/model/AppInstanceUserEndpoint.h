...
class AppInstanceUserEndpoint {
 public:
  ...
  template <typename AppInstanceUserArnT = Aws::String>
  AppInstanceUserEndpoint& WithAppInstanceUserArn(AppInstanceUserArnT&& value) {
  ...
  template <typename EndpointIdT = Aws::String>
  AppInstanceUserEndpoint& WithEndpointId(EndpointIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  AppInstanceUserEndpoint& WithName(NameT&& value) {
  ...
  inline AppInstanceUserEndpoint& WithType(AppInstanceUserEndpointType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceArnT = Aws::String>
  AppInstanceUserEndpoint& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename EndpointAttributesT = EndpointAttributes>
  AppInstanceUserEndpoint& WithEndpointAttributes(EndpointAttributesT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  AppInstanceUserEndpoint& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename LastUpdatedTimestampT = Aws::Utils::DateTime>
  AppInstanceUserEndpoint& WithLastUpdatedTimestamp(LastUpdatedTimestampT&& value) {
  ...
  inline AppInstanceUserEndpoint& WithAllowMessages(AllowMessages value) {
  ...
  void SetEndpointState(EndpointStateT&& value) {
    m_endpointStateHasBeenSet = true;
    m_endpointState = std::forward<EndpointStateT>(value);
  }
  template <typename EndpointStateT = EndpointState>
  AppInstanceUserEndpoint& WithEndpointState(EndpointStateT&& value) {
    SetEndpointState(std::forward<EndpointStateT>(value));
    return *this;
  }
  ///@}
 private:
