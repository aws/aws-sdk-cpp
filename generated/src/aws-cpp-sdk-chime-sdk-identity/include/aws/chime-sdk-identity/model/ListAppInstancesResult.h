...
class ListAppInstancesResult {
 public:
  ...
  void SetAppInstances(AppInstancesT&& value) {
    m_appInstancesHasBeenSet = true;
    m_appInstances = std::forward<AppInstancesT>(value);
  }
  template <typename AppInstancesT = Aws::Vector<AppInstanceSummary>>
  ListAppInstancesResult& WithAppInstances(AppInstancesT&& value) {
    SetAppInstances(std::forward<AppInstancesT>(value));
    return *this;
  }
  template <typename AppInstancesT = AppInstanceSummary>
  ListAppInstancesResult& AddAppInstances(AppInstancesT&& value) {
    m_appInstancesHasBeenSet = true;
    m_appInstances.emplace_back(std::forward<AppInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppInstancesResult& WithRequestId(RequestIdT&& value) {
