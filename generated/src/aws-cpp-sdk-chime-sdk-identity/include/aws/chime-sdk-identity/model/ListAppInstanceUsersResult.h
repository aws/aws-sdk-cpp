...
class ListAppInstanceUsersResult {
 public:
  ...
  template <typename AppInstanceArnT = Aws::String>
  ListAppInstanceUsersResult& WithAppInstanceArn(AppInstanceArnT&& value) {
  ...
  void SetAppInstanceUsers(AppInstanceUsersT&& value) {
    m_appInstanceUsersHasBeenSet = true;
    m_appInstanceUsers = std::forward<AppInstanceUsersT>(value);
  }
  template <typename AppInstanceUsersT = Aws::Vector<AppInstanceUserSummary>>
  ListAppInstanceUsersResult& WithAppInstanceUsers(AppInstanceUsersT&& value) {
    SetAppInstanceUsers(std::forward<AppInstanceUsersT>(value));
    return *this;
  }
  template <typename AppInstanceUsersT = AppInstanceUserSummary>
  ListAppInstanceUsersResult& AddAppInstanceUsers(AppInstanceUsersT&& value) {
    m_appInstanceUsersHasBeenSet = true;
    m_appInstanceUsers.emplace_back(std::forward<AppInstanceUsersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppInstanceUsersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppInstanceUsersResult& WithRequestId(RequestIdT&& value) {
