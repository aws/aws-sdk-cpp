...
namespace ChimeSDKIdentity
{
   ...
   */
  class AWS_CHIMESDKIDENTITY_API ChimeSDKIdentityClient : Aws::Client::ClientWithAsyncTemplateMethods<ChimeSDKIdentityClient>,
    smithy::client::AwsSmithyClientT<Aws::ChimeSDKIdentity::SERVICE_NAME,
