...
class AWS_CHIMESDKIDENTITY_API ChimeSDKIdentityClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ChimeSDKIdentityClient(const Aws::ChimeSDKIdentity::ChimeSDKIdentityClientConfiguration& clientConfiguration =
  ...
  ChimeSDKIdentityClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<ChimeSDKIdentityEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::ChimeSDKIdentity::ChimeSDKIdentityClientConfiguration& clientConfiguration =
                             Aws::ChimeSDKIdentity::ChimeSDKIdentityClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  ChimeSDKIdentityClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for CreateAppInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAppInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAppInstanceRequestT = Model::CreateAppInstanceRequest>
  void CreateAppInstanceAsync(const CreateAppInstanceRequestT& request, const CreateAppInstanceResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateAppInstanceAdmin that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAppInstanceAdmin that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAppInstanceAdminRequestT = Model::CreateAppInstanceAdminRequest>
  void CreateAppInstanceAdminAsync(const CreateAppInstanceAdminRequestT& request,
                                   const CreateAppInstanceAdminResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAppInstanceBot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAppInstanceBot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAppInstanceBotRequestT = Model::CreateAppInstanceBotRequest>
  void CreateAppInstanceBotAsync(const CreateAppInstanceBotRequestT& request, const CreateAppInstanceBotResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAppInstanceUser that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAppInstanceUser that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAppInstanceUserRequestT = Model::CreateAppInstanceUserRequest>
  void CreateAppInstanceUserAsync(const CreateAppInstanceUserRequestT& request, const CreateAppInstanceUserResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAppInstanceRequestT = Model::DeleteAppInstanceRequest>
  void DeleteAppInstanceAsync(const DeleteAppInstanceRequestT& request, const DeleteAppInstanceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppInstanceAdmin that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppInstanceAdmin that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAppInstanceAdminRequestT = Model::DeleteAppInstanceAdminRequest>
  void DeleteAppInstanceAdminAsync(const DeleteAppInstanceAdminRequestT& request,
                                   const DeleteAppInstanceAdminResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppInstanceBot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppInstanceBot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAppInstanceBotRequestT = Model::DeleteAppInstanceBotRequest>
  void DeleteAppInstanceBotAsync(const DeleteAppInstanceBotRequestT& request, const DeleteAppInstanceBotResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppInstanceUser that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppInstanceUser that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAppInstanceUserRequestT = Model::DeleteAppInstanceUserRequest>
  void DeleteAppInstanceUserAsync(const DeleteAppInstanceUserRequestT& request, const DeleteAppInstanceUserResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterAppInstanceUserEndpointOutcome DeregisterAppInstanceUserEndpoint(
      const Model::DeregisterAppInstanceUserEndpointRequest& request) const;

  /**
   * A Callable wrapper for DeregisterAppInstanceUserEndpoint that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeregisterAppInstanceUserEndpointRequestT = Model::DeregisterAppInstanceUserEndpointRequest>
  Model::DeregisterAppInstanceUserEndpointOutcomeCallable DeregisterAppInstanceUserEndpointCallable(
      const DeregisterAppInstanceUserEndpointRequestT& request) const {
    return SubmitCallable(&ChimeSDKIdentityClient::DeregisterAppInstanceUserEndpoint, request);
  }

  /**
   * An Async wrapper for DeregisterAppInstanceUserEndpoint that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeregisterAppInstanceUserEndpointRequestT = Model::DeregisterAppInstanceUserEndpointRequest>
  void DeregisterAppInstanceUserEndpointAsync(const DeregisterAppInstanceUserEndpointRequestT& request,
                                              const DeregisterAppInstanceUserEndpointResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAppInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAppInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAppInstanceRequestT = Model::DescribeAppInstanceRequest>
  void DescribeAppInstanceAsync(const DescribeAppInstanceRequestT& request, const DescribeAppInstanceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAppInstanceAdmin that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAppInstanceAdmin that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAppInstanceAdminRequestT = Model::DescribeAppInstanceAdminRequest>
  void DescribeAppInstanceAdminAsync(const DescribeAppInstanceAdminRequestT& request,
                                     const DescribeAppInstanceAdminResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAppInstanceBot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAppInstanceBot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAppInstanceBotRequestT = Model::DescribeAppInstanceBotRequest>
  void DescribeAppInstanceBotAsync(const DescribeAppInstanceBotRequestT& request,
                                   const DescribeAppInstanceBotResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAppInstanceUser that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAppInstanceUser that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAppInstanceUserRequestT = Model::DescribeAppInstanceUserRequest>
  void DescribeAppInstanceUserAsync(const DescribeAppInstanceUserRequestT& request,
                                    const DescribeAppInstanceUserResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAppInstanceUserEndpointOutcome DescribeAppInstanceUserEndpoint(
      const Model::DescribeAppInstanceUserEndpointRequest& request) const;

  /**
   * A Callable wrapper for DescribeAppInstanceUserEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAppInstanceUserEndpointRequestT = Model::DescribeAppInstanceUserEndpointRequest>
  Model::DescribeAppInstanceUserEndpointOutcomeCallable DescribeAppInstanceUserEndpointCallable(
      const DescribeAppInstanceUserEndpointRequestT& request) const {
    return SubmitCallable(&ChimeSDKIdentityClient::DescribeAppInstanceUserEndpoint, request);
  }

  /**
   * An Async wrapper for DescribeAppInstanceUserEndpoint that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAppInstanceUserEndpointRequestT = Model::DescribeAppInstanceUserEndpointRequest>
  void DescribeAppInstanceUserEndpointAsync(const DescribeAppInstanceUserEndpointRequestT& request,
                                            const DescribeAppInstanceUserEndpointResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetAppInstanceRetentionSettingsOutcome GetAppInstanceRetentionSettings(
      const Model::GetAppInstanceRetentionSettingsRequest& request) const;

  /**
   * A Callable wrapper for GetAppInstanceRetentionSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetAppInstanceRetentionSettingsRequestT = Model::GetAppInstanceRetentionSettingsRequest>
  Model::GetAppInstanceRetentionSettingsOutcomeCallable GetAppInstanceRetentionSettingsCallable(
      const GetAppInstanceRetentionSettingsRequestT& request) const {
    return SubmitCallable(&ChimeSDKIdentityClient::GetAppInstanceRetentionSettings, request);
  }

  /**
   * An Async wrapper for GetAppInstanceRetentionSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetAppInstanceRetentionSettingsRequestT = Model::GetAppInstanceRetentionSettingsRequest>
  void GetAppInstanceRetentionSettingsAsync(const GetAppInstanceRetentionSettingsRequestT& request,
                                            const GetAppInstanceRetentionSettingsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAppInstanceAdmins that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAppInstanceAdmins that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAppInstanceAdminsRequestT = Model::ListAppInstanceAdminsRequest>
  void ListAppInstanceAdminsAsync(const ListAppInstanceAdminsRequestT& request, const ListAppInstanceAdminsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAppInstanceBots that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAppInstanceBots that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAppInstanceBotsRequestT = Model::ListAppInstanceBotsRequest>
  void ListAppInstanceBotsAsync(const ListAppInstanceBotsRequestT& request, const ListAppInstanceBotsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAppInstanceUserEndpointsOutcome ListAppInstanceUserEndpoints(
      const Model::ListAppInstanceUserEndpointsRequest& request) const;

  /**
   * A Callable wrapper for ListAppInstanceUserEndpoints that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAppInstanceUserEndpointsRequestT = Model::ListAppInstanceUserEndpointsRequest>
  Model::ListAppInstanceUserEndpointsOutcomeCallable ListAppInstanceUserEndpointsCallable(
      const ListAppInstanceUserEndpointsRequestT& request) const {
    return SubmitCallable(&ChimeSDKIdentityClient::ListAppInstanceUserEndpoints, request);
  }

  /**
   * An Async wrapper for ListAppInstanceUserEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAppInstanceUserEndpointsRequestT = Model::ListAppInstanceUserEndpointsRequest>
  void ListAppInstanceUserEndpointsAsync(const ListAppInstanceUserEndpointsRequestT& request,
                                         const ListAppInstanceUserEndpointsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAppInstanceUsers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAppInstanceUsers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAppInstanceUsersRequestT = Model::ListAppInstanceUsersRequest>
  void ListAppInstanceUsersAsync(const ListAppInstanceUsersRequestT& request, const ListAppInstanceUsersResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAppInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAppInstances that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAppInstancesRequestT = Model::ListAppInstancesRequest>
  void ListAppInstancesAsync(const ListAppInstancesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListAppInstancesRequestT& request = {}) const {
  ...
  virtual Model::PutAppInstanceRetentionSettingsOutcome PutAppInstanceRetentionSettings(
      const Model::PutAppInstanceRetentionSettingsRequest& request) const;

  /**
   * A Callable wrapper for PutAppInstanceRetentionSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutAppInstanceRetentionSettingsRequestT = Model::PutAppInstanceRetentionSettingsRequest>
  Model::PutAppInstanceRetentionSettingsOutcomeCallable PutAppInstanceRetentionSettingsCallable(
      const PutAppInstanceRetentionSettingsRequestT& request) const {
    return SubmitCallable(&ChimeSDKIdentityClient::PutAppInstanceRetentionSettings, request);
  }

  /**
   * An Async wrapper for PutAppInstanceRetentionSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutAppInstanceRetentionSettingsRequestT = Model::PutAppInstanceRetentionSettingsRequest>
  void PutAppInstanceRetentionSettingsAsync(const PutAppInstanceRetentionSettingsRequestT& request,
                                            const PutAppInstanceRetentionSettingsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutAppInstanceUserExpirationSettingsOutcome PutAppInstanceUserExpirationSettings(
      const Model::PutAppInstanceUserExpirationSettingsRequest& request) const;

  /**
   * A Callable wrapper for PutAppInstanceUserExpirationSettings that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutAppInstanceUserExpirationSettingsRequestT = Model::PutAppInstanceUserExpirationSettingsRequest>
  Model::PutAppInstanceUserExpirationSettingsOutcomeCallable PutAppInstanceUserExpirationSettingsCallable(
      const PutAppInstanceUserExpirationSettingsRequestT& request) const {
    return SubmitCallable(&ChimeSDKIdentityClient::PutAppInstanceUserExpirationSettings, request);
  }

  /**
   * An Async wrapper for PutAppInstanceUserExpirationSettings that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutAppInstanceUserExpirationSettingsRequestT = Model::PutAppInstanceUserExpirationSettingsRequest>
  void PutAppInstanceUserExpirationSettingsAsync(const PutAppInstanceUserExpirationSettingsRequestT& request,
                                                 const PutAppInstanceUserExpirationSettingsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterAppInstanceUserEndpointOutcome RegisterAppInstanceUserEndpoint(
      const Model::RegisterAppInstanceUserEndpointRequest& request) const;

  /**
   * A Callable wrapper for RegisterAppInstanceUserEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterAppInstanceUserEndpointRequestT = Model::RegisterAppInstanceUserEndpointRequest>
  Model::RegisterAppInstanceUserEndpointOutcomeCallable RegisterAppInstanceUserEndpointCallable(
      const RegisterAppInstanceUserEndpointRequestT& request) const {
    return SubmitCallable(&ChimeSDKIdentityClient::RegisterAppInstanceUserEndpoint, request);
  }

  /**
   * An Async wrapper for RegisterAppInstanceUserEndpoint that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RegisterAppInstanceUserEndpointRequestT = Model::RegisterAppInstanceUserEndpointRequest>
  void RegisterAppInstanceUserEndpointAsync(const RegisterAppInstanceUserEndpointRequestT& request,
                                            const RegisterAppInstanceUserEndpointResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAppInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAppInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAppInstanceRequestT = Model::UpdateAppInstanceRequest>
  void UpdateAppInstanceAsync(const UpdateAppInstanceRequestT& request, const UpdateAppInstanceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAppInstanceBot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAppInstanceBot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAppInstanceBotRequestT = Model::UpdateAppInstanceBotRequest>
  void UpdateAppInstanceBotAsync(const UpdateAppInstanceBotRequestT& request, const UpdateAppInstanceBotResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAppInstanceUser that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAppInstanceUser that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAppInstanceUserRequestT = Model::UpdateAppInstanceUserRequest>
  void UpdateAppInstanceUserAsync(const UpdateAppInstanceUserRequestT& request, const UpdateAppInstanceUserResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAppInstanceUserEndpointOutcome UpdateAppInstanceUserEndpoint(
      const Model::UpdateAppInstanceUserEndpointRequest& request) const;

  /**
   * A Callable wrapper for UpdateAppInstanceUserEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAppInstanceUserEndpointRequestT = Model::UpdateAppInstanceUserEndpointRequest>
  Model::UpdateAppInstanceUserEndpointOutcomeCallable UpdateAppInstanceUserEndpointCallable(
      const UpdateAppInstanceUserEndpointRequestT& request) const {
    return SubmitCallable(&ChimeSDKIdentityClient::UpdateAppInstanceUserEndpoint, request);
  }

  /**
   * An Async wrapper for UpdateAppInstanceUserEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAppInstanceUserEndpointRequestT = Model::UpdateAppInstanceUserEndpointRequest>
  void UpdateAppInstanceUserEndpointAsync(const UpdateAppInstanceUserEndpointRequestT& request,
                                          const UpdateAppInstanceUserEndpointResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
