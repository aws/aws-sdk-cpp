...
DescribeRepositoryCreationTemplatesResult& DescribeRepositoryCreationTemplatesResult::operator=(
  ...
  if (jsonValue.ValueExists("repositoryCreationTemplates")) {
    ...
    for (unsigned repositoryCreationTemplatesIndex = 0; repositoryCreationTemplatesIndex < repositoryCreationTemplatesJsonList.GetLength();
         ++repositoryCreationTemplatesIndex) {
