...
ImageScanFindingsSummary::ImageScanFindingsSummary(JsonView jsonValue) { *this = jsonValue; }
...
ImageScanFindingsSummary& ImageScanFindingsSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("findingSeverityCounts")) {
    ...
    for (auto& findingSeverityCountsItem : findingSeverityCountsJsonMap) {
      m_findingSeverityCounts[FindingSeverityMapper::GetFindingSeverityForName(findingSeverityCountsItem.first)] =
          findingSeverityCountsItem.second.AsInteger();
    }
...
JsonValue ImageScanFindingsSummary::Jsonize() const {
  ...
  if (m_findingSeverityCountsHasBeenSet) {
    ...
    for (auto& findingSeverityCountsItem : m_findingSeverityCounts) {
      findingSeverityCountsJsonMap.WithInteger(FindingSeverityMapper::GetNameForFindingSeverity(findingSeverityCountsItem.first),
                                               findingSeverityCountsItem.second);
    }
