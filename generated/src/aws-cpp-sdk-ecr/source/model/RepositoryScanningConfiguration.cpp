...
RepositoryScanningConfiguration::RepositoryScanningConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
RepositoryScanningConfiguration& RepositoryScanningConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("appliedScanFilters")) {
    ...
    for (unsigned appliedScanFiltersIndex = 0; appliedScanFiltersIndex < appliedScanFiltersJsonList.GetLength();
         ++appliedScanFiltersIndex) {
