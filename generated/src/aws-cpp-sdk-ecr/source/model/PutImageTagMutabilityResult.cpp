...
PutImageTagMutabilityResult::PutImageTagMutabilityResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
PutImageTagMutabilityResult& PutImageTagMutabilityResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("imageTagMutabilityExclusionFilters")) {
    ...
    for (unsigned imageTagMutabilityExclusionFiltersIndex = 0;
      ...
      m_imageTagMutabilityExclusionFilters.push_back(
