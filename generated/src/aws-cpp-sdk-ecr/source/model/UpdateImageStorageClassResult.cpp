...
UpdateImageStorageClassResult::UpdateImageStorageClassResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateImageStorageClassResult& UpdateImageStorageClassResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
