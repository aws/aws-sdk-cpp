...
namespace ECR
{
const size_t ECREndpointRules::RulesBlobStrLen = 3925;
const size_t ECREndpointRules::RulesBlobSize = 3926;
...
'e','c','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'"',':','"','h','t','t','p','s',':','/','/','e','c','r','-','f','i','p','s','.','{','R','e','g','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','.','e','c','r','-','f','i','p','s','.',
...
't','t','p','s',':','/','/','a','p','i','.','e','c','r','.','{','R','e','g','i','o','n','}','.','{',
