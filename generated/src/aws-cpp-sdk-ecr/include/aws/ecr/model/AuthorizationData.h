...
class AuthorizationData {
 public:
  ...
  void SetAuthorizationToken(AuthorizationTokenT&& value) {
    ...
    m_authorizationToken = std::forward<AuthorizationTokenT>(value);
  }
  template <typename AuthorizationTokenT = Aws::String>
  AuthorizationData& WithAuthorizationToken(AuthorizationTokenT&& value) {
    SetAuthorizationToken(std::forward<AuthorizationTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProxyEndpoint(ProxyEndpointT&& value) {
    ...
    m_proxyEndpoint = std::forward<ProxyEndpointT>(value);
  }
  template <typename ProxyEndpointT = Aws::String>
  AuthorizationData& WithProxyEndpoint(ProxyEndpointT&& value) {
    SetProxyEndpoint(std::forward<ProxyEndpointT>(value));
    return *this;
  }
  ///@}
 private:
