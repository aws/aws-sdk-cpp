...
class PutLifecyclePolicyRequest : public ECRRequest {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  PutLifecyclePolicyRequest& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  PutLifecyclePolicyRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename LifecyclePolicyTextT = Aws::String>
  PutLifecyclePolicyRequest& WithLifecyclePolicyText(LifecyclePolicyTextT&& value) {
