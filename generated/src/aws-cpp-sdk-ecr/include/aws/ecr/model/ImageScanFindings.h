...
class ImageScanFindings {
 public:
  ...
  void SetImageScanCompletedAt(ImageScanCompletedAtT&& value) {
    ...
    m_imageScanCompletedAt = std::forward<ImageScanCompletedAtT>(value);
  }
  template <typename ImageScanCompletedAtT = Aws::Utils::DateTime>
  ImageScanFindings& WithImageScanCompletedAt(ImageScanCompletedAtT&& value) {
    SetImageScanCompletedAt(std::forward<ImageScanCompletedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVulnerabilitySourceUpdatedAt(VulnerabilitySourceUpdatedAtT&& value) {
    ...
    m_vulnerabilitySourceUpdatedAt = std::forward<VulnerabilitySourceUpdatedAtT>(value);
  }
  template <typename VulnerabilitySourceUpdatedAtT = Aws::Utils::DateTime>
  ImageScanFindings& WithVulnerabilitySourceUpdatedAt(VulnerabilitySourceUpdatedAtT&& value) {
    SetVulnerabilitySourceUpdatedAt(std::forward<VulnerabilitySourceUpdatedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFindingSeverityCounts(FindingSeverityCountsT&& value) {
    ...
    m_findingSeverityCounts = std::forward<FindingSeverityCountsT>(value);
  }
  template <typename FindingSeverityCountsT = Aws::Map<FindingSeverity, int>>
  ImageScanFindings& WithFindingSeverityCounts(FindingSeverityCountsT&& value) {
    SetFindingSeverityCounts(std::forward<FindingSeverityCountsT>(value));
    return *this;
  }
  inline ImageScanFindings& AddFindingSeverityCounts(FindingSeverity key, int value) {
    m_findingSeverityCountsHasBeenSet = true;
    m_findingSeverityCounts.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetEnhancedFindings(EnhancedFindingsT&& value) {
    ...
    m_enhancedFindings = std::forward<EnhancedFindingsT>(value);
  }
  template <typename EnhancedFindingsT = Aws::Vector<EnhancedImageScanFinding>>
  ImageScanFindings& WithEnhancedFindings(EnhancedFindingsT&& value) {
    SetEnhancedFindings(std::forward<EnhancedFindingsT>(value));
    return *this;
  }
  ...
  ImageScanFindings& AddEnhancedFindings(EnhancedFindingsT&& value) {
    m_enhancedFindingsHasBeenSet = true;
    m_enhancedFindings.emplace_back(std::forward<EnhancedFindingsT>(value));
    return *this;
  }
  ///@}
 private:
