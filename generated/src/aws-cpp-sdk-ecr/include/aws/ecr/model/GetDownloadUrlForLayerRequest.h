...
class GetDownloadUrlForLayerRequest : public ECRRequest {
 public:
  AWS_ECR_API GetDownloadUrlForLayerRequest() = default;
  ...
  template <typename RegistryIdT = Aws::String>
  GetDownloadUrlForLayerRequest& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  GetDownloadUrlForLayerRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename LayerDigestT = Aws::String>
  GetDownloadUrlForLayerRequest& WithLayerDigest(LayerDigestT&& value) {
