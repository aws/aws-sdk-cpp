...
namespace Model
{
  ...
  public:
    ...
    template<typename RegistryIdT = Aws::String>
    GetDownloadUrlForLayerRequest& WithRegistryId(RegistryIdT&& value) { SetRegistryId(std::forward<RegistryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RepositoryNameT = Aws::String>
    GetDownloadUrlForLayerRequest& WithRepositoryName(RepositoryNameT&& value) { SetRepositoryName(std::forward<RepositoryNameT>(value)); return *this;}
    ///@}
    ...
    template<typename LayerDigestT = Aws::String>
    GetDownloadUrlForLayerRequest& WithLayerDigest(LayerDigestT&& value) { SetLayerDigest(std::forward<LayerDigestT>(value)); return *this;}
    ///@}
  private:
