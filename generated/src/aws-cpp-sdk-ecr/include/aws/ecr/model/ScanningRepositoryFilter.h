...
class ScanningRepositoryFilter {
 public:
  ...
  template <typename FilterT = Aws::String>
  ScanningRepositoryFilter& WithFilter(FilterT&& value) {
  ...
  inline void SetFilterType(ScanningRepositoryFilterType value) {
    m_filterTypeHasBeenSet = true;
    m_filterType = value;
  }
  inline ScanningRepositoryFilter& WithFilterType(ScanningRepositoryFilterType value) {
    SetFilterType(value);
    return *this;
  }
  ///@}
