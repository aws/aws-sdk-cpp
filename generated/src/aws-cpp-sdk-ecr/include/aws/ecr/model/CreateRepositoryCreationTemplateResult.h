...
class CreateRepositoryCreationTemplateResult {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  CreateRepositoryCreationTemplateResult& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryCreationTemplateT = RepositoryCreationTemplate>
  CreateRepositoryCreationTemplateResult& WithRepositoryCreationTemplate(RepositoryCreationTemplateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRepositoryCreationTemplateResult& WithRequestId(RequestIdT&& value) {
