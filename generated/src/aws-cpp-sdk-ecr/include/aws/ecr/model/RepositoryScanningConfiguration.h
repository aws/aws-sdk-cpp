...
class RepositoryScanningConfiguration {
 public:
  ...
  inline RepositoryScanningConfiguration& WithScanOnPush(bool value) {
    SetScanOnPush(value);
    return *this;
  }
  ///@}
  ...
  inline RepositoryScanningConfiguration& WithScanFrequency(ScanFrequency value) {
  ...
  void SetAppliedScanFilters(AppliedScanFiltersT&& value) {
    ...
    m_appliedScanFilters = std::forward<AppliedScanFiltersT>(value);
  }
  template <typename AppliedScanFiltersT = Aws::Vector<ScanningRepositoryFilter>>
  RepositoryScanningConfiguration& WithAppliedScanFilters(AppliedScanFiltersT&& value) {
    SetAppliedScanFilters(std::forward<AppliedScanFiltersT>(value));
    return *this;
  }
  ...
  RepositoryScanningConfiguration& AddAppliedScanFilters(AppliedScanFiltersT&& value) {
    m_appliedScanFiltersHasBeenSet = true;
    m_appliedScanFilters.emplace_back(std::forward<AppliedScanFiltersT>(value));
    return *this;
  }
  ///@}
 private:
