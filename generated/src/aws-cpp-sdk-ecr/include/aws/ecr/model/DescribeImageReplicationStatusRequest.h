...
class DescribeImageReplicationStatusRequest : public ECRRequest {
 public:
  AWS_ECR_API DescribeImageReplicationStatusRequest() = default;
  ...
  template <typename RepositoryNameT = Aws::String>
  DescribeImageReplicationStatusRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename ImageIdT = ImageIdentifier>
  DescribeImageReplicationStatusRequest& WithImageId(ImageIdT&& value) {
  ...
  template <typename RegistryIdT = Aws::String>
  DescribeImageReplicationStatusRequest& WithRegistryId(RegistryIdT&& value) {
