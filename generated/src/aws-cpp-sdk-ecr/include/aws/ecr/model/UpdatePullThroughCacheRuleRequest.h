...
class UpdatePullThroughCacheRuleRequest : public ECRRequest {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  UpdatePullThroughCacheRuleRequest& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename EcrRepositoryPrefixT = Aws::String>
  UpdatePullThroughCacheRuleRequest& WithEcrRepositoryPrefix(EcrRepositoryPrefixT&& value) {
  ...
  template <typename CredentialArnT = Aws::String>
  UpdatePullThroughCacheRuleRequest& WithCredentialArn(CredentialArnT&& value) {
  ...
  template <typename CustomRoleArnT = Aws::String>
  UpdatePullThroughCacheRuleRequest& WithCustomRoleArn(CustomRoleArnT&& value) {
