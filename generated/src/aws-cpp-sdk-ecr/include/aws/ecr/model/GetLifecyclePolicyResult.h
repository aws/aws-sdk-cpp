...
class GetLifecyclePolicyResult {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  GetLifecyclePolicyResult& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  GetLifecyclePolicyResult& WithRepositoryName(RepositoryNameT&& value) {
  ...
  void SetLifecyclePolicyText(LifecyclePolicyTextT&& value) {
    ...
    m_lifecyclePolicyText = std::forward<LifecyclePolicyTextT>(value);
  }
  template <typename LifecyclePolicyTextT = Aws::String>
  GetLifecyclePolicyResult& WithLifecyclePolicyText(LifecyclePolicyTextT&& value) {
    SetLifecyclePolicyText(std::forward<LifecyclePolicyTextT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastEvaluatedAtT = Aws::Utils::DateTime>
  GetLifecyclePolicyResult& WithLastEvaluatedAt(LastEvaluatedAtT&& value) {
