...
class DeleteRepositoryCreationTemplateResult {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  DeleteRepositoryCreationTemplateResult& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryCreationTemplateT = RepositoryCreationTemplate>
  DeleteRepositoryCreationTemplateResult& WithRepositoryCreationTemplate(RepositoryCreationTemplateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteRepositoryCreationTemplateResult& WithRequestId(RequestIdT&& value) {
