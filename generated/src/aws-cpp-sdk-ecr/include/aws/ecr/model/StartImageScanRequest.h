...
class StartImageScanRequest : public ECRRequest {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  StartImageScanRequest& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  StartImageScanRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename ImageIdT = ImageIdentifier>
  StartImageScanRequest& WithImageId(ImageIdT&& value) {
