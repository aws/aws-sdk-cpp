...
class SetRepositoryPolicyResult {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  SetRepositoryPolicyResult& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  SetRepositoryPolicyResult& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename PolicyTextT = Aws::String>
  SetRepositoryPolicyResult& WithPolicyText(PolicyTextT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SetRepositoryPolicyResult& WithRequestId(RequestIdT&& value) {
