...
class StartLifecyclePolicyPreviewResult {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  StartLifecyclePolicyPreviewResult& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  StartLifecyclePolicyPreviewResult& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename LifecyclePolicyTextT = Aws::String>
  StartLifecyclePolicyPreviewResult& WithLifecyclePolicyText(LifecyclePolicyTextT&& value) {
  ...
  inline void SetStatus(LifecyclePolicyPreviewStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline StartLifecyclePolicyPreviewResult& WithStatus(LifecyclePolicyPreviewStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartLifecyclePolicyPreviewResult& WithRequestId(RequestIdT&& value) {
