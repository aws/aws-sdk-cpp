...
class CreateRepositoryCreationTemplateRequest : public ECRRequest {
 public:
  ...
  inline CreateRepositoryCreationTemplateRequest& WithImageTagMutability(ImageTagMutability value) {
  ...
  template <typename ImageTagMutabilityExclusionFiltersT = Aws::Vector<ImageTagMutabilityExclusionFilter>>
  CreateRepositoryCreationTemplateRequest& WithImageTagMutabilityExclusionFilters(ImageTagMutabilityExclusionFiltersT&& value) {
  ...
  CreateRepositoryCreationTemplateRequest& AddImageTagMutabilityExclusionFilters(ImageTagMutabilityExclusionFiltersT&& value) {
    m_imageTagMutabilityExclusionFiltersHasBeenSet = true;
  ...
  inline CreateRepositoryCreationTemplateRequest& AddAppliedFor(RCTAppliedFor value) {
    m_appliedForHasBeenSet = true;
