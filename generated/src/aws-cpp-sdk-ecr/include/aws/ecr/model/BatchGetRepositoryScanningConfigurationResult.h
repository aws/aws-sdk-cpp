...
class BatchGetRepositoryScanningConfigurationResult {
 public:
  ...
  AWS_ECR_API BatchGetRepositoryScanningConfigurationResult& operator=(
  ...
  void SetScanningConfigurations(ScanningConfigurationsT&& value) {
    m_scanningConfigurationsHasBeenSet = true;
    m_scanningConfigurations = std::forward<ScanningConfigurationsT>(value);
  }
  template <typename ScanningConfigurationsT = Aws::Vector<RepositoryScanningConfiguration>>
  BatchGetRepositoryScanningConfigurationResult& WithScanningConfigurations(ScanningConfigurationsT&& value) {
    SetScanningConfigurations(std::forward<ScanningConfigurationsT>(value));
    return *this;
  }
  template <typename ScanningConfigurationsT = RepositoryScanningConfiguration>
  BatchGetRepositoryScanningConfigurationResult& AddScanningConfigurations(ScanningConfigurationsT&& value) {
    m_scanningConfigurationsHasBeenSet = true;
    m_scanningConfigurations.emplace_back(std::forward<ScanningConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FailuresT = Aws::Vector<RepositoryScanningConfigurationFailure>>
  BatchGetRepositoryScanningConfigurationResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = RepositoryScanningConfigurationFailure>
  BatchGetRepositoryScanningConfigurationResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetRepositoryScanningConfigurationResult& WithRequestId(RequestIdT&& value) {
