...
class EncryptionConfigurationForRepositoryCreationTemplate {
 public:
  ...
  inline EncryptionConfigurationForRepositoryCreationTemplate& WithEncryptionType(EncryptionType value) {
  ...
  template <typename KmsKeyT = Aws::String>
  EncryptionConfigurationForRepositoryCreationTemplate& WithKmsKey(KmsKeyT&& value) {
