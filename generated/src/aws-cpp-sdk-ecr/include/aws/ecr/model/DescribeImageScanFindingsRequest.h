...
class DescribeImageScanFindingsRequest : public ECRRequest {
 public:
  AWS_ECR_API DescribeImageScanFindingsRequest() = default;
  ...
  template <typename RegistryIdT = Aws::String>
  DescribeImageScanFindingsRequest& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  DescribeImageScanFindingsRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename ImageIdT = ImageIdentifier>
  DescribeImageScanFindingsRequest& WithImageId(ImageIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeImageScanFindingsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeImageScanFindingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
