...
class Layer {
 public:
  ...
  inline void SetLayerAvailability(LayerAvailability value) {
    m_layerAvailabilityHasBeenSet = true;
    m_layerAvailability = value;
  }
  inline Layer& WithLayerAvailability(LayerAvailability value) {
    SetLayerAvailability(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLayerSize(long long value) {
    m_layerSizeHasBeenSet = true;
    m_layerSize = value;
  }
  inline Layer& WithLayerSize(long long value) {
    SetLayerSize(value);
    return *this;
  }
  ///@}
