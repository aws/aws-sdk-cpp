...
class BatchGetImageRequest : public ECRRequest {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  BatchGetImageRequest& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  BatchGetImageRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename ImageIdsT = Aws::Vector<ImageIdentifier>>
  BatchGetImageRequest& WithImageIds(ImageIdsT&& value) {
    SetImageIds(std::forward<ImageIdsT>(value));
    return *this;
  }
  template <typename ImageIdsT = ImageIdentifier>
  BatchGetImageRequest& AddImageIds(ImageIdsT&& value) {
    m_imageIdsHasBeenSet = true;
  ...
  void SetAcceptedMediaTypes(AcceptedMediaTypesT&& value) {
    m_acceptedMediaTypesHasBeenSet = true;
    m_acceptedMediaTypes = std::forward<AcceptedMediaTypesT>(value);
  }
  template <typename AcceptedMediaTypesT = Aws::Vector<Aws::String>>
  BatchGetImageRequest& WithAcceptedMediaTypes(AcceptedMediaTypesT&& value) {
    SetAcceptedMediaTypes(std::forward<AcceptedMediaTypesT>(value));
    return *this;
  }
  template <typename AcceptedMediaTypesT = Aws::String>
  BatchGetImageRequest& AddAcceptedMediaTypes(AcceptedMediaTypesT&& value) {
    m_acceptedMediaTypesHasBeenSet = true;
    m_acceptedMediaTypes.emplace_back(std::forward<AcceptedMediaTypesT>(value));
    return *this;
  }
  ///@}
 private:
