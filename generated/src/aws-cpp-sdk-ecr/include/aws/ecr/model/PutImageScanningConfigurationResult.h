...
class PutImageScanningConfigurationResult {
 public:
  AWS_ECR_API PutImageScanningConfigurationResult() = default;
  ...
  template <typename RegistryIdT = Aws::String>
  PutImageScanningConfigurationResult& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  PutImageScanningConfigurationResult& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename ImageScanningConfigurationT = ImageScanningConfiguration>
  PutImageScanningConfigurationResult& WithImageScanningConfiguration(ImageScanningConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutImageScanningConfigurationResult& WithRequestId(RequestIdT&& value) {
