...
class StartLifecyclePolicyPreviewRequest : public ECRRequest {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  StartLifecyclePolicyPreviewRequest& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  StartLifecyclePolicyPreviewRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename LifecyclePolicyTextT = Aws::String>
  StartLifecyclePolicyPreviewRequest& WithLifecyclePolicyText(LifecyclePolicyTextT&& value) {
