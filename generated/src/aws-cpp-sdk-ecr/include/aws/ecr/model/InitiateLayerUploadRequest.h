...
namespace Model
{
  ...
  {
  public:
    AWS_ECR_API InitiateLayerUploadRequest() = default;
    ...
    template<typename RegistryIdT = Aws::String>
    InitiateLayerUploadRequest& WithRegistryId(RegistryIdT&& value) { SetRegistryId(std::forward<RegistryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RepositoryNameT = Aws::String>
    InitiateLayerUploadRequest& WithRepositoryName(RepositoryNameT&& value) { SetRepositoryName(std::forward<RepositoryNameT>(value)); return *this;}
    ///@}
  private:
