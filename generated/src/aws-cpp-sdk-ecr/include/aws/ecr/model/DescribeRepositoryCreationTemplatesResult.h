...
class DescribeRepositoryCreationTemplatesResult {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  DescribeRepositoryCreationTemplatesResult& WithRegistryId(RegistryIdT&& value) {
  ...
  void SetRepositoryCreationTemplates(RepositoryCreationTemplatesT&& value) {
    m_repositoryCreationTemplatesHasBeenSet = true;
    m_repositoryCreationTemplates = std::forward<RepositoryCreationTemplatesT>(value);
  }
  template <typename RepositoryCreationTemplatesT = Aws::Vector<RepositoryCreationTemplate>>
  DescribeRepositoryCreationTemplatesResult& WithRepositoryCreationTemplates(RepositoryCreationTemplatesT&& value) {
    SetRepositoryCreationTemplates(std::forward<RepositoryCreationTemplatesT>(value));
    return *this;
  }
  template <typename RepositoryCreationTemplatesT = RepositoryCreationTemplate>
  DescribeRepositoryCreationTemplatesResult& AddRepositoryCreationTemplates(RepositoryCreationTemplatesT&& value) {
    m_repositoryCreationTemplatesHasBeenSet = true;
    m_repositoryCreationTemplates.emplace_back(std::forward<RepositoryCreationTemplatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRepositoryCreationTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRepositoryCreationTemplatesResult& WithRequestId(RequestIdT&& value) {
