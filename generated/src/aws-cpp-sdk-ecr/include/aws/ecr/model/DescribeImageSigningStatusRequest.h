...
/**
 */
class DescribeImageSigningStatusRequest : public ECRRequest {
 public:
  AWS_ECR_API DescribeImageSigningStatusRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "DescribeImageSigningStatus"; }
  ...
  template <typename RepositoryNameT = Aws::String>
  DescribeImageSigningStatusRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename ImageIdT = ImageIdentifier>
  DescribeImageSigningStatusRequest& WithImageId(ImageIdT&& value) {
  ...
  template <typename RegistryIdT = Aws::String>
  DescribeImageSigningStatusRequest& WithRegistryId(RegistryIdT&& value) {
