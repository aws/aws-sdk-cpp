...
namespace Model
{
  ...
  {
  public:
    AWS_ECR_API UpdateRepositoryCreationTemplateRequest() = default;
    ...
    template<typename PrefixT = Aws::String>
    UpdateRepositoryCreationTemplateRequest& WithPrefix(PrefixT&& value) { SetPrefix(std::forward<PrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateRepositoryCreationTemplateRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename EncryptionConfigurationT = EncryptionConfigurationForRepositoryCreationTemplate>
    UpdateRepositoryCreationTemplateRequest& WithEncryptionConfiguration(EncryptionConfigurationT&& value) { SetEncryptionConfiguration(std::forward<EncryptionConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceTagsT = Aws::Vector<Tag>>
    UpdateRepositoryCreationTemplateRequest& WithResourceTags(ResourceTagsT&& value) { SetResourceTags(std::forward<ResourceTagsT>(value)); return *this;}
    template<typename ResourceTagsT = Tag>
    UpdateRepositoryCreationTemplateRequest& AddResourceTags(ResourceTagsT&& value) { m_resourceTagsHasBeenSet = true; m_resourceTags.emplace_back(std::forward<ResourceTagsT>(value)); return *this; }
    ///@}
    ...
    inline UpdateRepositoryCreationTemplateRequest& WithImageTagMutability(ImageTagMutability value) { SetImageTagMutability(value); return *this;}
    ///@}

    ///@{
    /**
     * <p>Updates a repository with filters that define which image tags can override
     * the default image tag mutability setting.</p>
     */
    ...
    template<typename ImageTagMutabilityExclusionFiltersT = Aws::Vector<ImageTagMutabilityExclusionFilter>>
    UpdateRepositoryCreationTemplateRequest& WithImageTagMutabilityExclusionFilters(ImageTagMutabilityExclusionFiltersT&& value) { SetImageTagMutabilityExclusionFilters(std::forward<ImageTagMutabilityExclusionFiltersT>(value)); return *this;}
    template<typename ImageTagMutabilityExclusionFiltersT = ImageTagMutabilityExclusionFilter>
    UpdateRepositoryCreationTemplateRequest& AddImageTagMutabilityExclusionFilters(ImageTagMutabilityExclusionFiltersT&& value) { m_imageTagMutabilityExclusionFiltersHasBeenSet = true; m_imageTagMutabilityExclusionFilters.emplace_back(std::forward<ImageTagMutabilityExclusionFiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename RepositoryPolicyT = Aws::String>
    UpdateRepositoryCreationTemplateRequest& WithRepositoryPolicy(RepositoryPolicyT&& value) { SetRepositoryPolicy(std::forward<RepositoryPolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename LifecyclePolicyT = Aws::String>
    UpdateRepositoryCreationTemplateRequest& WithLifecyclePolicy(LifecyclePolicyT&& value) { SetLifecyclePolicy(std::forward<LifecyclePolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename AppliedForT = Aws::Vector<RCTAppliedFor>>
    UpdateRepositoryCreationTemplateRequest& WithAppliedFor(AppliedForT&& value) { SetAppliedFor(std::forward<AppliedForT>(value)); return *this;}
    inline UpdateRepositoryCreationTemplateRequest& AddAppliedFor(RCTAppliedFor value) { m_appliedForHasBeenSet = true; m_appliedFor.push_back(value); return *this; }
    ///@}
    ...
    template<typename CustomRoleArnT = Aws::String>
    UpdateRepositoryCreationTemplateRequest& WithCustomRoleArn(CustomRoleArnT&& value) { SetCustomRoleArn(std::forward<CustomRoleArnT>(value)); return *this;}
    ///@}
  private:
