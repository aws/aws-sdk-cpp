...
class DeleteRegistryPolicyResult {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  DeleteRegistryPolicyResult& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename PolicyTextT = Aws::String>
  DeleteRegistryPolicyResult& WithPolicyText(PolicyTextT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteRegistryPolicyResult& WithRequestId(RequestIdT&& value) {
