...
class GetDownloadUrlForLayerResult {
 public:
  ...
  template <typename DownloadUrlT = Aws::String>
  GetDownloadUrlForLayerResult& WithDownloadUrl(DownloadUrlT&& value) {
  ...
  template <typename LayerDigestT = Aws::String>
  GetDownloadUrlForLayerResult& WithLayerDigest(LayerDigestT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDownloadUrlForLayerResult& WithRequestId(RequestIdT&& value) {
