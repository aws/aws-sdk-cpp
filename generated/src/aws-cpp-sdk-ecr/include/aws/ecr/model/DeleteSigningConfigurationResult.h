...
namespace ECR {
namespace Model {
class DeleteSigningConfigurationResult {
 public:
  AWS_ECR_API DeleteSigningConfigurationResult() = default;
  AWS_ECR_API DeleteSigningConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ECR_API DeleteSigningConfigurationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RegistryIdT = Aws::String>
  DeleteSigningConfigurationResult& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename SigningConfigurationT = SigningConfiguration>
  DeleteSigningConfigurationResult& WithSigningConfiguration(SigningConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteSigningConfigurationResult& WithRequestId(RequestIdT&& value) {
