...
class RepositoryFilter {
 public:
  ...
  template <typename FilterT = Aws::String>
  RepositoryFilter& WithFilter(FilterT&& value) {
  ...
  inline void SetFilterType(RepositoryFilterType value) {
    m_filterTypeHasBeenSet = true;
    m_filterType = value;
  }
  inline RepositoryFilter& WithFilterType(RepositoryFilterType value) {
    SetFilterType(value);
    return *this;
  }
  ///@}
