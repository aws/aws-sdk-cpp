...
class UpdateRepositoryCreationTemplateResult {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  UpdateRepositoryCreationTemplateResult& WithRegistryId(RegistryIdT&& value) {
  ...
  void SetRepositoryCreationTemplate(RepositoryCreationTemplateT&& value) {
    m_repositoryCreationTemplateHasBeenSet = true;
    m_repositoryCreationTemplate = std::forward<RepositoryCreationTemplateT>(value);
  }
  template <typename RepositoryCreationTemplateT = RepositoryCreationTemplate>
  UpdateRepositoryCreationTemplateResult& WithRepositoryCreationTemplate(RepositoryCreationTemplateT&& value) {
    SetRepositoryCreationTemplate(std::forward<RepositoryCreationTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRepositoryCreationTemplateResult& WithRequestId(RequestIdT&& value) {
