...
class DescribeImagesResult {
 public:
  ...
  template <typename ImageDetailsT = Aws::Vector<ImageDetail>>
  DescribeImagesResult& WithImageDetails(ImageDetailsT&& value) {
    SetImageDetails(std::forward<ImageDetailsT>(value));
    return *this;
  }
  template <typename ImageDetailsT = ImageDetail>
  DescribeImagesResult& AddImageDetails(ImageDetailsT&& value) {
    m_imageDetailsHasBeenSet = true;
    m_imageDetails.emplace_back(std::forward<ImageDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeImagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeImagesResult& WithRequestId(RequestIdT&& value) {
