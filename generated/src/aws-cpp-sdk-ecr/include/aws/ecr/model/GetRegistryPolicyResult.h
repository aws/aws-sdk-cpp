...
namespace Model
{
  ...
  public:
    ...
    template<typename RegistryIdT = Aws::String>
    GetRegistryPolicyResult& WithRegistryId(RegistryIdT&& value) { SetRegistryId(std::forward<RegistryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PolicyTextT = Aws::String>
    GetRegistryPolicyResult& WithPolicyText(PolicyTextT&& value) { SetPolicyText(std::forward<PolicyTextT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetRegistryPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
