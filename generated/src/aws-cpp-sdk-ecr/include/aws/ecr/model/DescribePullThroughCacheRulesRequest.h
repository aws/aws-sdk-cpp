...
class DescribePullThroughCacheRulesRequest : public ECRRequest {
 public:
  ...
  void SetEcrRepositoryPrefixes(EcrRepositoryPrefixesT&& value) {
    m_ecrRepositoryPrefixesHasBeenSet = true;
    m_ecrRepositoryPrefixes = std::forward<EcrRepositoryPrefixesT>(value);
  }
  template <typename EcrRepositoryPrefixesT = Aws::Vector<Aws::String>>
  DescribePullThroughCacheRulesRequest& WithEcrRepositoryPrefixes(EcrRepositoryPrefixesT&& value) {
    SetEcrRepositoryPrefixes(std::forward<EcrRepositoryPrefixesT>(value));
    return *this;
  }
  ...
  DescribePullThroughCacheRulesRequest& AddEcrRepositoryPrefixes(EcrRepositoryPrefixesT&& value) {
    m_ecrRepositoryPrefixesHasBeenSet = true;
    m_ecrRepositoryPrefixes.emplace_back(std::forward<EcrRepositoryPrefixesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribePullThroughCacheRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
