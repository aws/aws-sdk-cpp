...
class PutImageScanningConfigurationRequest : public ECRRequest {
 public:
  ...
  template <typename RegistryIdT = Aws::String>
  PutImageScanningConfigurationRequest& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  PutImageScanningConfigurationRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename ImageScanningConfigurationT = ImageScanningConfiguration>
  PutImageScanningConfigurationRequest& WithImageScanningConfiguration(ImageScanningConfigurationT&& value) {
