 ...
 */
using ECREndpointProviderBase = EndpointProviderBase<ECRClientConfiguration, ECRBuiltInParameters, ECRClientContextParameters>;

using ECRDefaultEpProviderBase = DefaultEndpointProvider<ECRClientConfiguration, ECRBuiltInParameters, ECRClientContextParameters>;
