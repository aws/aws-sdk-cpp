...
GetMountTargetResult::GetMountTargetResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetMountTargetResult& GetMountTargetResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
