...
class GetMountTargetResult {
 public:
  AWS_S3FILES_API GetMountTargetResult() = default;
  AWS_S3FILES_API GetMountTargetResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_S3FILES_API GetMountTargetResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AvailabilityZoneIdT = Aws::String>
  GetMountTargetResult& WithAvailabilityZoneId(AvailabilityZoneIdT&& value) {
  ...
  template <typename OwnerIdT = Aws::String>
  GetMountTargetResult& WithOwnerId(OwnerIdT&& value) {
  ...
  template <typename MountTargetIdT = Aws::String>
  GetMountTargetResult& WithMountTargetId(MountTargetIdT&& value) {
  ...
  template <typename FileSystemIdT = Aws::String>
  GetMountTargetResult& WithFileSystemId(FileSystemIdT&& value) {
  ...
  template <typename SubnetIdT = Aws::String>
  GetMountTargetResult& WithSubnetId(SubnetIdT&& value) {
  ...
  template <typename Ipv4AddressT = Aws::String>
  GetMountTargetResult& WithIpv4Address(Ipv4AddressT&& value) {
  ...
  template <typename Ipv6AddressT = Aws::String>
  GetMountTargetResult& WithIpv6Address(Ipv6AddressT&& value) {
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  GetMountTargetResult& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  GetMountTargetResult& WithVpcId(VpcIdT&& value) {
  ...
  template <typename SecurityGroupsT = Aws::Vector<Aws::String>>
  GetMountTargetResult& WithSecurityGroups(SecurityGroupsT&& value) {
    SetSecurityGroups(std::forward<SecurityGroupsT>(value));
    return *this;
  }
  template <typename SecurityGroupsT = Aws::String>
  GetMountTargetResult& AddSecurityGroups(SecurityGroupsT&& value) {
    m_securityGroupsHasBeenSet = true;
  ...
  inline GetMountTargetResult& WithStatus(LifeCycleState value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  GetMountTargetResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetMountTargetResult& WithRequestId(RequestIdT&& value) {
