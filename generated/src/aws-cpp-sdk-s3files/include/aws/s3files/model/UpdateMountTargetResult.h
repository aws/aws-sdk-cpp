...
namespace S3Files {
namespace Model {
class UpdateMountTargetResult {
 public:
  AWS_S3FILES_API UpdateMountTargetResult() = default;
  AWS_S3FILES_API UpdateMountTargetResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_S3FILES_API UpdateMountTargetResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AvailabilityZoneIdT = Aws::String>
  UpdateMountTargetResult& WithAvailabilityZoneId(AvailabilityZoneIdT&& value) {
  ...
  template <typename OwnerIdT = Aws::String>
  UpdateMountTargetResult& WithOwnerId(OwnerIdT&& value) {
  ...
  template <typename MountTargetIdT = Aws::String>
  UpdateMountTargetResult& WithMountTargetId(MountTargetIdT&& value) {
  ...
  template <typename FileSystemIdT = Aws::String>
  UpdateMountTargetResult& WithFileSystemId(FileSystemIdT&& value) {
  ...
  template <typename SubnetIdT = Aws::String>
  UpdateMountTargetResult& WithSubnetId(SubnetIdT&& value) {
  ...
  template <typename Ipv4AddressT = Aws::String>
  UpdateMountTargetResult& WithIpv4Address(Ipv4AddressT&& value) {
  ...
  template <typename Ipv6AddressT = Aws::String>
  UpdateMountTargetResult& WithIpv6Address(Ipv6AddressT&& value) {
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  UpdateMountTargetResult& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  UpdateMountTargetResult& WithVpcId(VpcIdT&& value) {
  ...
  template <typename SecurityGroupsT = Aws::Vector<Aws::String>>
  UpdateMountTargetResult& WithSecurityGroups(SecurityGroupsT&& value) {
    SetSecurityGroups(std::forward<SecurityGroupsT>(value));
    return *this;
  }
  template <typename SecurityGroupsT = Aws::String>
  UpdateMountTargetResult& AddSecurityGroups(SecurityGroupsT&& value) {
    m_securityGroupsHasBeenSet = true;
  ...
  inline UpdateMountTargetResult& WithStatus(LifeCycleState value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  UpdateMountTargetResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateMountTargetResult& WithRequestId(RequestIdT&& value) {
