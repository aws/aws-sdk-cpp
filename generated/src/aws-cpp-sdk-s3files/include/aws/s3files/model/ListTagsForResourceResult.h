...
class ListTagsForResourceResult {
 public:
  AWS_S3FILES_API ListTagsForResourceResult() = default;
  AWS_S3FILES_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_S3FILES_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
