...
/**
 */
class DeleteMountTargetRequest : public S3FilesRequest {
 public:
  AWS_S3FILES_API DeleteMountTargetRequest() = default;
  ...
  template <typename MountTargetIdT = Aws::String>
  DeleteMountTargetRequest& WithMountTargetId(MountTargetIdT&& value) {
