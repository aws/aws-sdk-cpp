 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/s3files-2025-05-05/InternalServerException">AWS
 * API Reference</a></p>
 */
class InternalServerException {
 public:
  AWS_S3FILES_API InternalServerException() = default;
  AWS_S3FILES_API InternalServerException(Aws::Utils::Json::JsonView jsonValue);
  AWS_S3FILES_API InternalServerException& operator=(Aws::Utils::Json::JsonView jsonValue);
