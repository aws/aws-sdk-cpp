...
/**
 */
class DeleteFileSystemPolicyRequest : public S3FilesRequest {
 public:
  AWS_S3FILES_API DeleteFileSystemPolicyRequest() = default;
  ...
  template <typename FileSystemIdT = Aws::String>
  DeleteFileSystemPolicyRequest& WithFileSystemId(FileSystemIdT&& value) {
