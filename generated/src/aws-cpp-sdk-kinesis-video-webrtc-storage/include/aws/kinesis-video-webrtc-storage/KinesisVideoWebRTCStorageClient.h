...
namespace KinesisVideoWebRTCStorage
{
   ...
   */
  class AWS_KINESISVIDEOWEBRTCSTORAGE_API KinesisVideoWebRTCStorageClient : Aws::Client::ClientWithAsyncTemplateMethods<KinesisVideoWebRTCStorageClient>,
    smithy::client::AwsSmithyClientT<Aws::KinesisVideoWebRTCStorage::SERVICE_NAME,
