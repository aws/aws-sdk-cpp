...
class AWS_KINESISVIDEOWEBRTCSTORAGE_API KinesisVideoWebRTCStorageClient
 ...
 public:
   ...
   */
  KinesisVideoWebRTCStorageClient(const Aws::KinesisVideoWebRTCStorage::KinesisVideoWebRTCStorageClientConfiguration& clientConfiguration =
  ...
  KinesisVideoWebRTCStorageClient(const Aws::Auth::AWSCredentials& credentials,
                                  std::shared_ptr<KinesisVideoWebRTCStorageEndpointProviderBase> endpointProvider = nullptr,
                                  const Aws::KinesisVideoWebRTCStorage::KinesisVideoWebRTCStorageClientConfiguration& clientConfiguration =
                                      Aws::KinesisVideoWebRTCStorage::KinesisVideoWebRTCStorageClientConfiguration());
  ...
  /**
   * A Callable wrapper for JoinStorageSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for JoinStorageSession that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename JoinStorageSessionRequestT = Model::JoinStorageSessionRequest>
  void JoinStorageSessionAsync(const JoinStorageSessionRequestT& request, const JoinStorageSessionResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::JoinStorageSessionAsViewerOutcome JoinStorageSessionAsViewer(
      const Model::JoinStorageSessionAsViewerRequest& request) const;

  /**
   * A Callable wrapper for JoinStorageSessionAsViewer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename JoinStorageSessionAsViewerRequestT = Model::JoinStorageSessionAsViewerRequest>
  Model::JoinStorageSessionAsViewerOutcomeCallable JoinStorageSessionAsViewerCallable(
      const JoinStorageSessionAsViewerRequestT& request) const {
    return SubmitCallable(&KinesisVideoWebRTCStorageClient::JoinStorageSessionAsViewer, request);
  }

  /**
   * An Async wrapper for JoinStorageSessionAsViewer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename JoinStorageSessionAsViewerRequestT = Model::JoinStorageSessionAsViewerRequest>
  void JoinStorageSessionAsViewerAsync(const JoinStorageSessionAsViewerRequestT& request,
                                       const JoinStorageSessionAsViewerResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
