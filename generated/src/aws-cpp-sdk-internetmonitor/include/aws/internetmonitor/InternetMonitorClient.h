...
namespace InternetMonitor
{
   ...
   * differentAmazon Web Services Regions.</p> <p> If the issue is caused by the
   * Amazon Web Services network, you'll automatically receive an Amazon Web Services
   * Health Dashboard notification with the steps that Amazon Web Services is taking
   * to mitigate the problem. To support integrating health information for
   * geographies and networks specific to your application, Internet Monitor delivers
   ...
   * Amazon WorkSpaces directories.</p> <p>To use Internet Monitor, you create a
   * <i>monitor</i> and add resources to it, Virtual Private Clouds (VPCs), Amazon
   * CloudFront distributions, or WorkSpaces directories that show where your
   ...
   * networks that communicate with your application. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-InternetMonitor.html">
   * Using Amazon CloudWatch Internet Monitor</a> in the Amazon CloudWatch User
   * Guide.</p>
   */
    ...
    public:
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
         ...
         * directories. </p> <p>After you create a monitor, you can view the internet
         * performance for your application, scoped to a location, as well as any health
         * events that are impairing traffic. Internet Monitor can also diagnose whether
         * the impairment is on the Amazon Web Services network or is an issue with an
         * internet service provider (ISP).</p><p><h3>See Also:</h3>   <a
        ...
        /**
         * <p>Updates a monitor. You can update a monitor to add or remove resources, or to
         * change the status of the monitor. You can't change the name of a
         * monitor.</p><p><h3>See Also:</h3>   <a
