...
class AWS_INTERNETMONITOR_API InternetMonitorClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  InternetMonitorClient(const Aws::InternetMonitor::InternetMonitorClientConfiguration& clientConfiguration =
  ...
  InternetMonitorClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<InternetMonitorEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::InternetMonitor::InternetMonitorClientConfiguration& clientConfiguration =
                            Aws::InternetMonitor::InternetMonitorClientConfiguration());
  ...
  /**
   * An Async wrapper for GetHealthEvent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetHealthEventRequestT = Model::GetHealthEventRequest>
  void GetHealthEventAsync(const GetHealthEventRequestT& request, const GetHealthEventResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInternetEvent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInternetEvent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetInternetEventRequestT = Model::GetInternetEventRequest>
  void GetInternetEventAsync(const GetInternetEventRequestT& request, const GetInternetEventResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetQueryStatus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetQueryStatusRequestT = Model::GetQueryStatusRequest>
  void GetQueryStatusAsync(const GetQueryStatusRequestT& request, const GetQueryStatusResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListHealthEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListHealthEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListHealthEventsRequestT = Model::ListHealthEventsRequest>
  void ListHealthEventsAsync(const ListHealthEventsRequestT& request, const ListHealthEventsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListInternetEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInternetEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListInternetEventsRequestT = Model::ListInternetEventsRequest>
  void ListInternetEventsAsync(const ListInternetEventsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListInternetEventsRequestT& request = {}) const {
