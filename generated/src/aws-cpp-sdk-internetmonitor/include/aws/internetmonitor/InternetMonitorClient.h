...
namespace InternetMonitor
{
   ...
   * Guide</i>.</p>
   */
  class AWS_INTERNETMONITOR_API InternetMonitorClient : Aws::Client::ClientWithAsyncTemplateMethods<InternetMonitorClient>,
    smithy::client::AwsSmithyClientT<Aws::InternetMonitor::SERVICE_NAME,
