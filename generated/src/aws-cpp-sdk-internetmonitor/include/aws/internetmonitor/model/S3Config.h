...
class S3Config {
 public:
  ...
  inline void SetLogDeliveryStatus(LogDeliveryStatus value) {
    m_logDeliveryStatusHasBeenSet = true;
    m_logDeliveryStatus = value;
  }
  inline S3Config& WithLogDeliveryStatus(LogDeliveryStatus value) {
    SetLogDeliveryStatus(value);
    return *this;
  }
  ///@}
 private:
