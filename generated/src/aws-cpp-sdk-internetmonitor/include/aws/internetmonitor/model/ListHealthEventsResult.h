...
class ListHealthEventsResult {
 public:
  ...
  void SetHealthEvents(HealthEventsT&& value) {
    m_healthEventsHasBeenSet = true;
    m_healthEvents = std::forward<HealthEventsT>(value);
  }
  template <typename HealthEventsT = Aws::Vector<HealthEvent>>
  ListHealthEventsResult& WithHealthEvents(HealthEventsT&& value) {
    SetHealthEvents(std::forward<HealthEventsT>(value));
    return *this;
  }
  template <typename HealthEventsT = HealthEvent>
  ListHealthEventsResult& AddHealthEvents(HealthEventsT&& value) {
    m_healthEventsHasBeenSet = true;
    m_healthEvents.emplace_back(std::forward<HealthEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListHealthEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListHealthEventsResult& WithRequestId(RequestIdT&& value) {
