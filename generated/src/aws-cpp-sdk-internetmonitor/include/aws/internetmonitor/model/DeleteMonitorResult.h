...
namespace Model
{
  ...
  {
  public:
    AWS_INTERNETMONITOR_API DeleteMonitorResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteMonitorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
