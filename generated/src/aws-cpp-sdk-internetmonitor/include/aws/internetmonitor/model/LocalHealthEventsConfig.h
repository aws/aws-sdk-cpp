...
class LocalHealthEventsConfig {
 public:
  ...
  inline void SetStatus(LocalHealthEventsConfigStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline LocalHealthEventsConfig& WithStatus(LocalHealthEventsConfigStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline LocalHealthEventsConfig& WithHealthScoreThreshold(double value) {
  ...
  inline void SetMinTrafficImpact(double value) {
    m_minTrafficImpactHasBeenSet = true;
    m_minTrafficImpact = value;
  }
  inline LocalHealthEventsConfig& WithMinTrafficImpact(double value) {
    SetMinTrafficImpact(value);
    return *this;
  }
  ///@}
 private:
