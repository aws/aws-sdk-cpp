...
class ListHealthEventsRequest : public InternetMonitorRequest {
 public:
  ...
  template <typename MonitorNameT = Aws::String>
  ListHealthEventsRequest& WithMonitorName(MonitorNameT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListHealthEventsRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ListHealthEventsRequest& WithEndTime(EndTimeT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListHealthEventsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListHealthEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEventStatus(HealthEventStatus value) {
    m_eventStatusHasBeenSet = true;
    m_eventStatus = value;
  }
  inline ListHealthEventsRequest& WithEventStatus(HealthEventStatus value) {
  ...
  template <typename LinkedAccountIdT = Aws::String>
  ListHealthEventsRequest& WithLinkedAccountId(LinkedAccountIdT&& value) {
