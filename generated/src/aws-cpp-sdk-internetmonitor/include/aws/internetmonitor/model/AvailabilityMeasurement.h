...
class AvailabilityMeasurement {
 public:
  ...
  inline void SetExperienceScore(double value) {
    m_experienceScoreHasBeenSet = true;
    m_experienceScore = value;
  }
  inline AvailabilityMeasurement& WithExperienceScore(double value) {
  ...
  inline AvailabilityMeasurement& WithPercentOfTotalTrafficImpacted(double value) {
  ...
  inline void SetPercentOfClientLocationImpacted(double value) {
    m_percentOfClientLocationImpactedHasBeenSet = true;
    m_percentOfClientLocationImpacted = value;
  }
  inline AvailabilityMeasurement& WithPercentOfClientLocationImpacted(double value) {
    SetPercentOfClientLocationImpacted(value);
    return *this;
  }
  ///@}
 private:
