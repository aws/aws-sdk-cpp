...
class HealthEventsConfig {
 public:
  ...
  inline void SetAvailabilityScoreThreshold(double value) {
    m_availabilityScoreThresholdHasBeenSet = true;
    m_availabilityScoreThreshold = value;
  }
  inline HealthEventsConfig& WithAvailabilityScoreThreshold(double value) {
    SetAvailabilityScoreThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPerformanceScoreThreshold(double value) {
    m_performanceScoreThresholdHasBeenSet = true;
    m_performanceScoreThreshold = value;
  }
  inline HealthEventsConfig& WithPerformanceScoreThreshold(double value) {
    SetPerformanceScoreThreshold(value);
    return *this;
  }
  ///@}
  ...
  void SetAvailabilityLocalHealthEventsConfig(AvailabilityLocalHealthEventsConfigT&& value) {
    ...
    m_availabilityLocalHealthEventsConfig = std::forward<AvailabilityLocalHealthEventsConfigT>(value);
  }
  template <typename AvailabilityLocalHealthEventsConfigT = LocalHealthEventsConfig>
  HealthEventsConfig& WithAvailabilityLocalHealthEventsConfig(AvailabilityLocalHealthEventsConfigT&& value) {
    SetAvailabilityLocalHealthEventsConfig(std::forward<AvailabilityLocalHealthEventsConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPerformanceLocalHealthEventsConfig(PerformanceLocalHealthEventsConfigT&& value) {
    ...
    m_performanceLocalHealthEventsConfig = std::forward<PerformanceLocalHealthEventsConfigT>(value);
  }
  template <typename PerformanceLocalHealthEventsConfigT = LocalHealthEventsConfig>
  HealthEventsConfig& WithPerformanceLocalHealthEventsConfig(PerformanceLocalHealthEventsConfigT&& value) {
    SetPerformanceLocalHealthEventsConfig(std::forward<PerformanceLocalHealthEventsConfigT>(value));
    return *this;
  }
  ///@}
 private:
