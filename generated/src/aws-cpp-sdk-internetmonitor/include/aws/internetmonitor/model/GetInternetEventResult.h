...
class GetInternetEventResult {
 public:
  ...
  void SetClientLocation(ClientLocationT&& value) {
    ...
    m_clientLocation = std::forward<ClientLocationT>(value);
  }
  template <typename ClientLocationT = ClientLocation>
  GetInternetEventResult& WithClientLocation(ClientLocationT&& value) {
    SetClientLocation(std::forward<ClientLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEventType(InternetEventType value) {
    m_eventTypeHasBeenSet = true;
    m_eventType = value;
  }
  inline GetInternetEventResult& WithEventType(InternetEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEventStatus(InternetEventStatus value) {
    m_eventStatusHasBeenSet = true;
    m_eventStatus = value;
  }
  inline GetInternetEventResult& WithEventStatus(InternetEventStatus value) {
