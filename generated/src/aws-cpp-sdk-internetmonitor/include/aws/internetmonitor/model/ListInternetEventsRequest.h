...
class ListInternetEventsRequest : public InternetMonitorRequest {
 public:
  AWS_INTERNETMONITOR_API ListInternetEventsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListInternetEventsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListInternetEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ListInternetEventsRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ListInternetEventsRequest& WithEndTime(EndTimeT&& value) {
  ...
  template <typename EventStatusT = Aws::String>
  void SetEventStatus(EventStatusT&& value) {
    m_eventStatusHasBeenSet = true;
    m_eventStatus = std::forward<EventStatusT>(value);
  }
  template <typename EventStatusT = Aws::String>
  ListInternetEventsRequest& WithEventStatus(EventStatusT&& value) {
    SetEventStatus(std::forward<EventStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EventTypeT = Aws::String>
  ListInternetEventsRequest& WithEventType(EventTypeT&& value) {
