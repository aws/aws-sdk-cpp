...
class GetMonitorResult {
 public:
  ...
  inline GetMonitorResult& WithStatus(MonitorConfigState value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetMonitorResult& WithProcessingStatus(MonitorProcessingStatusCode value) {
  ...
  void SetProcessingStatusInfo(ProcessingStatusInfoT&& value) {
    ...
    m_processingStatusInfo = std::forward<ProcessingStatusInfoT>(value);
  }
  template <typename ProcessingStatusInfoT = Aws::String>
  GetMonitorResult& WithProcessingStatusInfo(ProcessingStatusInfoT&& value) {
    SetProcessingStatusInfo(std::forward<ProcessingStatusInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetMonitorResult& WithMaxCityNetworksToMonitor(int value) {
  ...
  inline GetMonitorResult& WithTrafficPercentageToMonitor(int value) {
