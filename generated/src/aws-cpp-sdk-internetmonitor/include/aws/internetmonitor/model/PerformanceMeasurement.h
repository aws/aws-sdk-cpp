...
class PerformanceMeasurement {
 public:
  ...
  inline PerformanceMeasurement& WithExperienceScore(double value) {
  ...
  inline PerformanceMeasurement& WithPercentOfTotalTrafficImpacted(double value) {
  ...
  inline PerformanceMeasurement& WithPercentOfClientLocationImpacted(double value) {
  ...
  void SetRoundTripTime(RoundTripTimeT&& value) {
    m_roundTripTimeHasBeenSet = true;
    m_roundTripTime = std::forward<RoundTripTimeT>(value);
  }
  template <typename RoundTripTimeT = RoundTripTime>
  PerformanceMeasurement& WithRoundTripTime(RoundTripTimeT&& value) {
    SetRoundTripTime(std::forward<RoundTripTimeT>(value));
    return *this;
  }
  ///@}
 private:
