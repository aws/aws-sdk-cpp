...
class GetHealthEventResult {
 public:
  ...
  inline GetHealthEventResult& WithStatus(HealthEventStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetHealthEventResult& WithPercentOfTotalTrafficImpacted(double value) {
  ...
  inline GetHealthEventResult& WithImpactType(HealthEventImpactType value) {
    SetImpactType(value);
    return *this;
  }
  ///@}
  ...
  inline GetHealthEventResult& WithHealthScoreThreshold(double value) {
