...
class ListMonitorsRequest : public InternetMonitorRequest {
 public:
  ...
  void SetMonitorStatus(MonitorStatusT&& value) {
    m_monitorStatusHasBeenSet = true;
    m_monitorStatus = std::forward<MonitorStatusT>(value);
  }
  template <typename MonitorStatusT = Aws::String>
  ListMonitorsRequest& WithMonitorStatus(MonitorStatusT&& value) {
    SetMonitorStatus(std::forward<MonitorStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListMonitorsRequest& WithIncludeLinkedAccounts(bool value) {
