...
class ClientLocation {
 public:
  ...
  void SetASName(ASNameT&& value) {
    ...
    m_aSName = std::forward<ASNameT>(value);
  }
  template <typename ASNameT = Aws::String>
  ClientLocation& WithASName(ASNameT&& value) {
    SetASName(std::forward<ASNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetASNumber(long long value) {
    m_aSNumberHasBeenSet = true;
    m_aSNumber = value;
  }
  inline ClientLocation& WithASNumber(long long value) {
    SetASNumber(value);
    return *this;
  }
  ///@}
  ...
  void SetSubdivision(SubdivisionT&& value) {
    ...
    m_subdivision = std::forward<SubdivisionT>(value);
  }
  template <typename SubdivisionT = Aws::String>
  ClientLocation& WithSubdivision(SubdivisionT&& value) {
    SetSubdivision(std::forward<SubdivisionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetro(MetroT&& value) {
    ...
    m_metro = std::forward<MetroT>(value);
  }
  template <typename MetroT = Aws::String>
  ClientLocation& WithMetro(MetroT&& value) {
    SetMetro(std::forward<MetroT>(value));
    return *this;
  }
  ///@}
  ...
  inline ClientLocation& WithLatitude(double value) {
    SetLatitude(value);
    return *this;
  }
  ///@}
  ...
  inline ClientLocation& WithLongitude(double value) {
    SetLongitude(value);
    return *this;
  }
  ///@}
