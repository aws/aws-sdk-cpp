...
class ImpactedLocation {
 public:
  ...
  inline ImpactedLocation& WithASNumber(long long value) {
    SetASNumber(value);
    return *this;
  }
  ///@}
  ...
  inline ImpactedLocation& WithLatitude(double value) {
    SetLatitude(value);
    return *this;
  }
  ///@}
  ...
  inline ImpactedLocation& WithLongitude(double value) {
    SetLongitude(value);
    return *this;
  }
  ///@}
  ...
  void SetServiceLocation(ServiceLocationT&& value) {
    ...
    m_serviceLocation = std::forward<ServiceLocationT>(value);
  }
  template <typename ServiceLocationT = Aws::String>
  ImpactedLocation& WithServiceLocation(ServiceLocationT&& value) {
    SetServiceLocation(std::forward<ServiceLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline ImpactedLocation& WithStatus(HealthEventStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetInternetHealth(InternetHealthT&& value) {
    ...
    m_internetHealth = std::forward<InternetHealthT>(value);
  }
  template <typename InternetHealthT = InternetHealth>
  ImpactedLocation& WithInternetHealth(InternetHealthT&& value) {
    SetInternetHealth(std::forward<InternetHealthT>(value));
    return *this;
  }
  ///@}
