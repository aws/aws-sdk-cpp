...
DescribedAgreement::DescribedAgreement(JsonView jsonValue) { *this = jsonValue; }
...
DescribedAgreement& DescribedAgreement::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("EnforceMessageSigning")) {
    m_enforceMessageSigning =
        EnforceMessageSigningTypeMapper::GetEnforceMessageSigningTypeForName(jsonValue.GetString("EnforceMessageSigning"));
