...
DescribedServer::DescribedServer(JsonView jsonValue) { *this = jsonValue; }
...
DescribedServer& DescribedServer::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("As2ServiceManagedEgressIpAddresses")) {
    ...
    for (unsigned as2ServiceManagedEgressIpAddressesIndex = 0;
         as2ServiceManagedEgressIpAddressesIndex < as2ServiceManagedEgressIpAddressesJsonList.GetLength();
         ++as2ServiceManagedEgressIpAddressesIndex) {
      m_as2ServiceManagedEgressIpAddresses.push_back(
          as2ServiceManagedEgressIpAddressesJsonList[as2ServiceManagedEgressIpAddressesIndex].AsString());
    }
...
JsonValue DescribedServer::Jsonize() const {
  ...
  if (m_as2ServiceManagedEgressIpAddressesHasBeenSet) {
    ...
    for (unsigned as2ServiceManagedEgressIpAddressesIndex = 0;
         ...
         ++as2ServiceManagedEgressIpAddressesIndex) {
      as2ServiceManagedEgressIpAddressesJsonList[as2ServiceManagedEgressIpAddressesIndex].AsString(
          m_as2ServiceManagedEgressIpAddresses[as2ServiceManagedEgressIpAddressesIndex]);
    }
