...
ConnectorEgressConfig::ConnectorEgressConfig(JsonView jsonValue) { *this = jsonValue; }

ConnectorEgressConfig& ConnectorEgressConfig::operator=(JsonView jsonValue) {
...
JsonValue ConnectorEgressConfig::Jsonize() const {
  JsonValue payload;
