...
UpdateWebAppCustomizationResult::UpdateWebAppCustomizationResult()
{
}

UpdateWebAppCustomizationResult::UpdateWebAppCustomizationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
