...
namespace Transfer
{
const size_t TransferEndpointRules::RulesBlobStrLen = 3526;
const size_t TransferEndpointRules::RulesBlobSize = 3527;
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','t','r','a',
'n','s','f','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
