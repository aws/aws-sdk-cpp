...
namespace Transfer
{
const size_t TransferEndpointRules::RulesBlobStrLen = 3732;
const size_t TransferEndpointRules::RulesBlobSize = 3733;
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','t','r','a','n','s','f','e','r','.',
...
's','f','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
