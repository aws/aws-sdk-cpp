...
namespace Transfer {
/**
 * <p>Transfer Family offers fully managed support for the transfer of files over
 * SFTP, AS2, FTPS, FTP, and web browser-based transfers directly into and out of
 * Amazon Web Services storage services.</p> <p>File transfer protocols are used in
 * data exchange workflows across different industries such as financial services,
 * healthcare, advertising, and retail, among others. Transfer Family simplifies
 * the migration of file transfer workflows to Amazon Web Services.</p> <p>To use
 * the Transfer Family service, you instantiate a server in the Amazon Web Services
 * Region of your choice. You can create the server, list available servers, and
 * update and delete servers. The server is the entity that requests file
 * operations from Transfer Family. Servers have a number of important properties.
 * The server is a named instance as identified by a system assigned
 * <code>ServerId</code> identifier. You can optionally assign a hostname, or even
 * a custom hostname to a server. The service bills for any instantiated servers
 * (even ones <code>OFFLINE</code>), and for the amount of data transferred.</p>
 * <p>Users must be known to the server that requests file operations. A user as
 ...
 * <code>AWS_DIRECTORY_SERVICE</code>, <code>SERVICE_MANAGED</code>,
 * <code>AWS_LAMBDA</code>, or <code>API_GATEWAY</code>.</p> <p>Transfer Family
 * also supports web applications that provide browser-based file transfer
 * capabilities. Web applications can be configured with VPC endpoints to enable
 * secure, private connectivity within your Virtual Private Cloud (VPC). This
 * allows you to control network access and route traffic through your VPC
 * infrastructure while maintaining the managed benefits of Transfer Family.</p>
 * <p>This API interface reference for Transfer Family contains documentation for a
 * programming interface that you can use to manage Transfer Family. The reference
 * structure is as follows:</p> <ul> <li> <p>For the alphabetical list of API
 * actions, see .</p> </li> <li> <p>For the alphabetical list of data types, see
 * .</p> </li> <li> <p>For a list of common query parameters, see
 * <a>CommonParameters</a>.</p> </li> <li> <p>For descriptions of the error codes,
 * see <a>CommonErrors</a>.</p> </li> </ul>  <p>Rather than actually running
 * a command, you can use the <code>--generate-cli-skeleton</code> parameter with
 * any API call to generate and display a parameter template. You can then use the
 * generated template to customize and use as input on a later command. For
 * details, see <a
...
class AWS_TRANSFER_API TransferClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  TransferClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<TransferEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for CreateAccess that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAccessRequestT = Model::CreateAccessRequest>
  void CreateAccessAsync(const CreateAccessRequestT& request, const CreateAccessResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateAgreement that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAgreementRequestT = Model::CreateAgreementRequest>
  void CreateAgreementAsync(const CreateAgreementRequestT& request, const CreateAgreementResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateProfileRequestT = Model::CreateProfileRequest>
  void CreateProfileAsync(const CreateProfileRequestT& request, const CreateProfileResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateServer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateServerRequestT = Model::CreateServerRequest>
  void CreateServerAsync(const CreateServerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const CreateServerRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for CreateWebApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateWebAppRequestT = Model::CreateWebAppRequest>
  void CreateWebAppAsync(const CreateWebAppRequestT& request, const CreateWebAppResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAccess that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAccessRequestT = Model::DeleteAccessRequest>
  void DeleteAccessAsync(const DeleteAccessRequestT& request, const DeleteAccessResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAgreement that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAgreementRequestT = Model::DeleteAgreementRequest>
  void DeleteAgreementAsync(const DeleteAgreementRequestT& request, const DeleteAgreementResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteHostKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteHostKeyRequestT = Model::DeleteHostKeyRequest>
  void DeleteHostKeyAsync(const DeleteHostKeyRequestT& request, const DeleteHostKeyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteProfileRequestT = Model::DeleteProfileRequest>
  void DeleteProfileAsync(const DeleteProfileRequestT& request, const DeleteProfileResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteServer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteServerRequestT = Model::DeleteServerRequest>
  void DeleteServerAsync(const DeleteServerRequestT& request, const DeleteServerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSshPublicKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSshPublicKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteSshPublicKeyRequestT = Model::DeleteSshPublicKeyRequest>
  void DeleteSshPublicKeyAsync(const DeleteSshPublicKeyRequestT& request, const DeleteSshPublicKeyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteWebApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteWebAppRequestT = Model::DeleteWebAppRequest>
  void DeleteWebAppAsync(const DeleteWebAppRequestT& request, const DeleteWebAppResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWebAppCustomization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteWebAppCustomizationRequestT = Model::DeleteWebAppCustomizationRequest>
  Model::DeleteWebAppCustomizationOutcomeCallable DeleteWebAppCustomizationCallable(
      const DeleteWebAppCustomizationRequestT& request) const {
    return SubmitCallable(&TransferClient::DeleteWebAppCustomization, request);
  }

  /**
   * An Async wrapper for DeleteWebAppCustomization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWebAppCustomizationRequestT = Model::DeleteWebAppCustomizationRequest>
  void DeleteWebAppCustomizationAsync(const DeleteWebAppCustomizationRequestT& request,
                                      const DeleteWebAppCustomizationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeAccess that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeAccessRequestT = Model::DescribeAccessRequest>
  void DescribeAccessAsync(const DescribeAccessRequestT& request, const DescribeAccessResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeConnector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeConnector that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeConnectorRequestT = Model::DescribeConnectorRequest>
  void DescribeConnectorAsync(const DescribeConnectorRequestT& request, const DescribeConnectorResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeHostKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeHostKeyRequestT = Model::DescribeHostKeyRequest>
  void DescribeHostKeyAsync(const DescribeHostKeyRequestT& request, const DescribeHostKeyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeProfileRequestT = Model::DescribeProfileRequest>
  void DescribeProfileAsync(const DescribeProfileRequestT& request, const DescribeProfileResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSecurityPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSecurityPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSecurityPolicyRequestT = Model::DescribeSecurityPolicyRequest>
  void DescribeSecurityPolicyAsync(const DescribeSecurityPolicyRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeServer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeServerRequestT = Model::DescribeServerRequest>
  void DescribeServerAsync(const DescribeServerRequestT& request, const DescribeServerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeUserRequestT = Model::DescribeUserRequest>
  void DescribeUserAsync(const DescribeUserRequestT& request, const DescribeUserResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeWebApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeWebAppRequestT = Model::DescribeWebAppRequest>
  void DescribeWebAppAsync(const DescribeWebAppRequestT& request, const DescribeWebAppResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeWebAppCustomizationOutcome DescribeWebAppCustomization(
      const Model::DescribeWebAppCustomizationRequest& request) const;

  /**
   * A Callable wrapper for DescribeWebAppCustomization that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeWebAppCustomizationRequestT = Model::DescribeWebAppCustomizationRequest>
  Model::DescribeWebAppCustomizationOutcomeCallable DescribeWebAppCustomizationCallable(
      const DescribeWebAppCustomizationRequestT& request) const {
    return SubmitCallable(&TransferClient::DescribeWebAppCustomization, request);
  }

  /**
   * An Async wrapper for DescribeWebAppCustomization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWebAppCustomizationRequestT = Model::DescribeWebAppCustomizationRequest>
  void DescribeWebAppCustomizationAsync(const DescribeWebAppCustomizationRequestT& request,
                                        const DescribeWebAppCustomizationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWorkflow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWorkflow that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeWorkflowRequestT = Model::DescribeWorkflowRequest>
  void DescribeWorkflowAsync(const DescribeWorkflowRequestT& request, const DescribeWorkflowResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportHostKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportHostKeyRequestT = Model::ImportHostKeyRequest>
  void ImportHostKeyAsync(const ImportHostKeyRequestT& request, const ImportHostKeyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ImportSshPublicKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportSshPublicKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ImportSshPublicKeyRequestT = Model::ImportSshPublicKeyRequest>
  void ImportSshPublicKeyAsync(const ImportSshPublicKeyRequestT& request, const ImportSshPublicKeyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAccesses that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAccessesRequestT = Model::ListAccessesRequest>
  void ListAccessesAsync(const ListAccessesRequestT& request, const ListAccessesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAgreements that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAgreementsRequestT = Model::ListAgreementsRequest>
  void ListAgreementsAsync(const ListAgreementsRequestT& request, const ListAgreementsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListFileTransferResults that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFileTransferResults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFileTransferResultsRequestT = Model::ListFileTransferResultsRequest>
  void ListFileTransferResultsAsync(const ListFileTransferResultsRequestT& request,
                                    const ListFileTransferResultsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListHostKeys that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListHostKeysRequestT = Model::ListHostKeysRequest>
  void ListHostKeysAsync(const ListHostKeysRequestT& request, const ListHostKeysResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListProfiles that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListProfilesRequestT = Model::ListProfilesRequest>
  void ListProfilesAsync(const ListProfilesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListProfilesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSecurityPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSecurityPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSecurityPoliciesRequestT = Model::ListSecurityPoliciesRequest>
  void ListSecurityPoliciesAsync(const ListSecurityPoliciesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListSecurityPoliciesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListServers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListServersRequestT = Model::ListServersRequest>
  void ListServersAsync(const ListServersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListServersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListWebApps that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListWebAppsRequestT = Model::ListWebAppsRequest>
  void ListWebAppsAsync(const ListWebAppsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListWebAppsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for SendWorkflowStepState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendWorkflowStepState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendWorkflowStepStateRequestT = Model::SendWorkflowStepStateRequest>
  void SendWorkflowStepStateAsync(const SendWorkflowStepStateRequestT& request, const SendWorkflowStepStateResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartDirectoryListing that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartDirectoryListing that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartDirectoryListingRequestT = Model::StartDirectoryListingRequest>
  void StartDirectoryListingAsync(const StartDirectoryListingRequestT& request, const StartDirectoryListingResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartFileTransfer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartFileTransfer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartFileTransferRequestT = Model::StartFileTransferRequest>
  void StartFileTransferAsync(const StartFileTransferRequestT& request, const StartFileTransferResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartRemoteDelete that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartRemoteDelete that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartRemoteDeleteRequestT = Model::StartRemoteDeleteRequest>
  void StartRemoteDeleteAsync(const StartRemoteDeleteRequestT& request, const StartRemoteDeleteResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartRemoteMove that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartRemoteMoveRequestT = Model::StartRemoteMoveRequest>
  void StartRemoteMoveAsync(const StartRemoteMoveRequestT& request, const StartRemoteMoveResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartServer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartServerRequestT = Model::StartServerRequest>
  void StartServerAsync(const StartServerRequestT& request, const StartServerResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopServer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopServerRequestT = Model::StopServerRequest>
  void StopServerAsync(const StopServerRequestT& request, const StopServerResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TestConnection that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TestConnectionRequestT = Model::TestConnectionRequest>
  void TestConnectionAsync(const TestConnectionRequestT& request, const TestConnectionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TestIdentityProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TestIdentityProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TestIdentityProviderRequestT = Model::TestIdentityProviderRequest>
  void TestIdentityProviderAsync(const TestIdentityProviderRequestT& request, const TestIdentityProviderResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateAccess that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAccessRequestT = Model::UpdateAccessRequest>
  void UpdateAccessAsync(const UpdateAccessRequestT& request, const UpdateAccessResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateAgreement that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAgreementRequestT = Model::UpdateAgreementRequest>
  void UpdateAgreementAsync(const UpdateAgreementRequestT& request, const UpdateAgreementResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCertificate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateCertificateRequestT = Model::UpdateCertificateRequest>
  void UpdateCertificateAsync(const UpdateCertificateRequestT& request, const UpdateCertificateResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateHostKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateHostKeyRequestT = Model::UpdateHostKeyRequest>
  void UpdateHostKeyAsync(const UpdateHostKeyRequestT& request, const UpdateHostKeyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateProfileRequestT = Model::UpdateProfileRequest>
  ...
  /**
   * An Async wrapper for UpdateServer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateServerRequestT = Model::UpdateServerRequest>
  void UpdateServerAsync(const UpdateServerRequestT& request, const UpdateServerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateWebApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateWebAppRequestT = Model::UpdateWebAppRequest>
  void UpdateWebAppAsync(const UpdateWebAppRequestT& request, const UpdateWebAppResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateWebAppCustomization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateWebAppCustomizationRequestT = Model::UpdateWebAppCustomizationRequest>
  Model::UpdateWebAppCustomizationOutcomeCallable UpdateWebAppCustomizationCallable(
      const UpdateWebAppCustomizationRequestT& request) const {
    return SubmitCallable(&TransferClient::UpdateWebAppCustomization, request);
  }

  /**
   * An Async wrapper for UpdateWebAppCustomization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateWebAppCustomizationRequestT = Model::UpdateWebAppCustomizationRequest>
  void UpdateWebAppCustomizationAsync(const UpdateWebAppCustomizationRequestT& request,
                                      const UpdateWebAppCustomizationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
