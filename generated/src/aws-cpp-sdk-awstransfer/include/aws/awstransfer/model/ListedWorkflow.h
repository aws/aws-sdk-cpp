...
class ListedWorkflow {
 public:
  AWS_TRANSFER_API ListedWorkflow() = default;
  ...
  template <typename WorkflowIdT = Aws::String>
  ListedWorkflow& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ListedWorkflow& WithDescription(DescriptionT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ListedWorkflow& WithArn(ArnT&& value) {
