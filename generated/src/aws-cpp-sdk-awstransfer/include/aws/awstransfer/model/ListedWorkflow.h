...
namespace Model
{
  ...
  public:
    ...
    template<typename WorkflowIdT = Aws::String>
    ListedWorkflow& WithWorkflowId(WorkflowIdT&& value) { SetWorkflowId(std::forward<WorkflowIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    ListedWorkflow& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    ListedWorkflow& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
