...
class CreateProfileRequest : public TransferRequest {
 public:
  ...
  void SetAs2Id(As2IdT&& value) {
    ...
    m_as2Id = std::forward<As2IdT>(value);
  }
  template <typename As2IdT = Aws::String>
  CreateProfileRequest& WithAs2Id(As2IdT&& value) {
    SetAs2Id(std::forward<As2IdT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateProfileRequest& WithProfileType(ProfileType value) {
