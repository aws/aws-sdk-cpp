...
namespace Model
{
  ...
  public:
    ...
    template<typename ResourceConfigurationArnT = Aws::String>
    DescribedConnectorVpcLatticeEgressConfig& WithResourceConfigurationArn(ResourceConfigurationArnT&& value) { SetResourceConfigurationArn(std::forward<ResourceConfigurationArnT>(value)); return *this;}
    ///@}
    ...
    inline DescribedConnectorVpcLatticeEgressConfig& WithPortNumber(int value) { SetPortNumber(value); return *this;}
    ///@}
  private:
