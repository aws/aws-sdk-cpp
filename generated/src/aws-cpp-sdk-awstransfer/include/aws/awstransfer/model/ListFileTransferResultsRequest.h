...
class ListFileTransferResultsRequest : public TransferRequest {
 public:
  ...
  template <typename ConnectorIdT = Aws::String>
  ListFileTransferResultsRequest& WithConnectorId(ConnectorIdT&& value) {
  ...
  template <typename TransferIdT = Aws::String>
  ListFileTransferResultsRequest& WithTransferId(TransferIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListFileTransferResultsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFileTransferResultsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
