...
class SshPublicKey {
 public:
  ...
  void SetDateImported(DateImportedT&& value) {
    ...
    m_dateImported = std::forward<DateImportedT>(value);
  }
  template <typename DateImportedT = Aws::Utils::DateTime>
  SshPublicKey& WithDateImported(DateImportedT&& value) {
    SetDateImported(std::forward<DateImportedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSshPublicKeyBody(SshPublicKeyBodyT&& value) {
    ...
    m_sshPublicKeyBody = std::forward<SshPublicKeyBodyT>(value);
  }
  template <typename SshPublicKeyBodyT = Aws::String>
  SshPublicKey& WithSshPublicKeyBody(SshPublicKeyBodyT&& value) {
    SetSshPublicKeyBody(std::forward<SshPublicKeyBodyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSshPublicKeyId(SshPublicKeyIdT&& value) {
    ...
    m_sshPublicKeyId = std::forward<SshPublicKeyIdT>(value);
  }
  template <typename SshPublicKeyIdT = Aws::String>
  SshPublicKey& WithSshPublicKeyId(SshPublicKeyIdT&& value) {
    SetSshPublicKeyId(std::forward<SshPublicKeyIdT>(value));
    return *this;
  }
  ///@}
 private:
