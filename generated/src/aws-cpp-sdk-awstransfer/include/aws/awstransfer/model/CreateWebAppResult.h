...
namespace Model
{
  ...
  {
  public:
    AWS_TRANSFER_API CreateWebAppResult() = default;
    ...
    template<typename WebAppIdT = Aws::String>
    CreateWebAppResult& WithWebAppId(WebAppIdT&& value) { SetWebAppId(std::forward<WebAppIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateWebAppResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
