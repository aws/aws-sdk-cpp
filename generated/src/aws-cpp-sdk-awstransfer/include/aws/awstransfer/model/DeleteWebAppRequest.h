...
class DeleteWebAppRequest : public TransferRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DeleteWebApp"; }
  ...
  void SetWebAppId(WebAppIdT&& value) {
    ...
    m_webAppId = std::forward<WebAppIdT>(value);
  }
  template <typename WebAppIdT = Aws::String>
  DeleteWebAppRequest& WithWebAppId(WebAppIdT&& value) {
    SetWebAppId(std::forward<WebAppIdT>(value));
    return *this;
  }
  ///@}
 private:
