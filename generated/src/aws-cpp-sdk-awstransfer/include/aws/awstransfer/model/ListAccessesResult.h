...
class ListAccessesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ServerIdT = Aws::String>
  ListAccessesResult& WithServerId(ServerIdT&& value) {
  ...
  void SetAccesses(AccessesT&& value) {
    m_accessesHasBeenSet = true;
    m_accesses = std::forward<AccessesT>(value);
  }
  template <typename AccessesT = Aws::Vector<ListedAccess>>
  ListAccessesResult& WithAccesses(AccessesT&& value) {
    SetAccesses(std::forward<AccessesT>(value));
    return *this;
  }
  template <typename AccessesT = ListedAccess>
  ListAccessesResult& AddAccesses(AccessesT&& value) {
    m_accessesHasBeenSet = true;
    m_accesses.emplace_back(std::forward<AccessesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessesResult& WithRequestId(RequestIdT&& value) {
