...
class UpdateServerRequest : public TransferRequest {
 public:
  ...
  inline UpdateServerRequest& WithEndpointType(EndpointType value) {
  ...
  inline UpdateServerRequest& AddProtocols(Protocol value) {
    m_protocolsHasBeenSet = true;
  ...
  inline UpdateServerRequest& WithIpAddressType(IpAddressType value) {
  ...
  inline UpdateServerRequest& WithIdentityProviderType(IdentityProviderType value) {
