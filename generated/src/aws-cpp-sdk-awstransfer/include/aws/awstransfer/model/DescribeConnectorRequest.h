...
namespace Model
{
  ...
  {
  public:
    AWS_TRANSFER_API DescribeConnectorRequest() = default;
    ...
    template<typename ConnectorIdT = Aws::String>
    DescribeConnectorRequest& WithConnectorId(ConnectorIdT&& value) { SetConnectorId(std::forward<ConnectorIdT>(value)); return *this;}
    ///@}
  private:
