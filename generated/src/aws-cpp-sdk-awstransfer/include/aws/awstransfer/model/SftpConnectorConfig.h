...
class SftpConnectorConfig {
 public:
  ...
  void SetUserSecretId(UserSecretIdT&& value) {
    ...
    m_userSecretId = std::forward<UserSecretIdT>(value);
  }
  template <typename UserSecretIdT = Aws::String>
  SftpConnectorConfig& WithUserSecretId(UserSecretIdT&& value) {
    SetUserSecretId(std::forward<UserSecretIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrustedHostKeys(TrustedHostKeysT&& value) {
    ...
    m_trustedHostKeys = std::forward<TrustedHostKeysT>(value);
  }
  template <typename TrustedHostKeysT = Aws::Vector<Aws::String>>
  SftpConnectorConfig& WithTrustedHostKeys(TrustedHostKeysT&& value) {
    SetTrustedHostKeys(std::forward<TrustedHostKeysT>(value));
    return *this;
  }
  template <typename TrustedHostKeysT = Aws::String>
  SftpConnectorConfig& AddTrustedHostKeys(TrustedHostKeysT&& value) {
    m_trustedHostKeysHasBeenSet = true;
    m_trustedHostKeys.emplace_back(std::forward<TrustedHostKeysT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxConcurrentConnections(int value) {
    m_maxConcurrentConnectionsHasBeenSet = true;
    m_maxConcurrentConnections = value;
  }
  inline SftpConnectorConfig& WithMaxConcurrentConnections(int value) {
    SetMaxConcurrentConnections(value);
    return *this;
  }
  ///@}
 private:
