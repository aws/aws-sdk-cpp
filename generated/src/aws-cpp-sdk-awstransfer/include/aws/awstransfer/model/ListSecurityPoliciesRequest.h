...
/**
 */
class ListSecurityPoliciesRequest : public TransferRequest {
 public:
  AWS_TRANSFER_API ListSecurityPoliciesRequest() = default;
  ...
  inline ListSecurityPoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityPoliciesRequest& WithNextToken(NextTokenT&& value) {
