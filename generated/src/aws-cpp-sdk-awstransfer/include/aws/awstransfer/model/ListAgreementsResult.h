...
class ListAgreementsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAgreementsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename AgreementsT = Aws::Vector<ListedAgreement>>
  ListAgreementsResult& WithAgreements(AgreementsT&& value) {
    SetAgreements(std::forward<AgreementsT>(value));
    return *this;
  }
  template <typename AgreementsT = ListedAgreement>
  ListAgreementsResult& AddAgreements(AgreementsT&& value) {
    m_agreementsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListAgreementsResult& WithRequestId(RequestIdT&& value) {
