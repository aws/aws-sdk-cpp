...
class WorkflowDetails {
 public:
  ...
  void SetOnPartialUpload(OnPartialUploadT&& value) {
    ...
    m_onPartialUpload = std::forward<OnPartialUploadT>(value);
  }
  template <typename OnPartialUploadT = Aws::Vector<WorkflowDetail>>
  WorkflowDetails& WithOnPartialUpload(OnPartialUploadT&& value) {
    SetOnPartialUpload(std::forward<OnPartialUploadT>(value));
    return *this;
  }
  template <typename OnPartialUploadT = WorkflowDetail>
  WorkflowDetails& AddOnPartialUpload(OnPartialUploadT&& value) {
    m_onPartialUploadHasBeenSet = true;
    m_onPartialUpload.emplace_back(std::forward<OnPartialUploadT>(value));
    return *this;
  }
  ///@}
 private:
