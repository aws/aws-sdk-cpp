...
class ListedCertificate {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListedCertificate& WithArn(ArnT&& value) {
  ...
  template <typename CertificateIdT = Aws::String>
  ListedCertificate& WithCertificateId(CertificateIdT&& value) {
  ...
  inline ListedCertificate& WithUsage(CertificateUsageType value) {
    SetUsage(value);
    return *this;
  }
  ///@}
  ...
  inline ListedCertificate& WithStatus(CertificateStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ActiveDateT = Aws::Utils::DateTime>
  ListedCertificate& WithActiveDate(ActiveDateT&& value) {
  ...
  template <typename InactiveDateT = Aws::Utils::DateTime>
  ListedCertificate& WithInactiveDate(InactiveDateT&& value) {
  ...
  inline ListedCertificate& WithType(CertificateType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  ListedCertificate& WithDescription(DescriptionT&& value) {
