...
class WorkflowStep {
 public:
  ...
  inline void SetType(WorkflowStepType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline WorkflowStep& WithType(WorkflowStepType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetCopyStepDetails(CopyStepDetailsT&& value) {
    ...
    m_copyStepDetails = std::forward<CopyStepDetailsT>(value);
  }
  template <typename CopyStepDetailsT = CopyStepDetails>
  WorkflowStep& WithCopyStepDetails(CopyStepDetailsT&& value) {
    SetCopyStepDetails(std::forward<CopyStepDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomStepDetails(CustomStepDetailsT&& value) {
    ...
    m_customStepDetails = std::forward<CustomStepDetailsT>(value);
  }
  template <typename CustomStepDetailsT = CustomStepDetails>
  WorkflowStep& WithCustomStepDetails(CustomStepDetailsT&& value) {
    SetCustomStepDetails(std::forward<CustomStepDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeleteStepDetails(DeleteStepDetailsT&& value) {
    ...
    m_deleteStepDetails = std::forward<DeleteStepDetailsT>(value);
  }
  template <typename DeleteStepDetailsT = DeleteStepDetails>
  WorkflowStep& WithDeleteStepDetails(DeleteStepDetailsT&& value) {
    SetDeleteStepDetails(std::forward<DeleteStepDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTagStepDetails(TagStepDetailsT&& value) {
    ...
    m_tagStepDetails = std::forward<TagStepDetailsT>(value);
  }
  template <typename TagStepDetailsT = TagStepDetails>
  WorkflowStep& WithTagStepDetails(TagStepDetailsT&& value) {
    SetTagStepDetails(std::forward<TagStepDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDecryptStepDetails(DecryptStepDetailsT&& value) {
    ...
    m_decryptStepDetails = std::forward<DecryptStepDetailsT>(value);
  }
  template <typename DecryptStepDetailsT = DecryptStepDetails>
  WorkflowStep& WithDecryptStepDetails(DecryptStepDetailsT&& value) {
    SetDecryptStepDetails(std::forward<DecryptStepDetailsT>(value));
    return *this;
  }
  ///@}
 private:
