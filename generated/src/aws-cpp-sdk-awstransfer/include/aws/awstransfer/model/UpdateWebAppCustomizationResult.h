...
namespace Model
{
  ...
  {
  public:
    AWS_TRANSFER_API UpdateWebAppCustomizationResult() = default;
    ...
    template<typename WebAppIdT = Aws::String>
    UpdateWebAppCustomizationResult& WithWebAppId(WebAppIdT&& value) { SetWebAppId(std::forward<WebAppIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateWebAppCustomizationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
