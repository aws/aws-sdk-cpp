...
class UpdateWebAppIdentityProviderDetails {
 public:
  ...
  void SetIdentityCenterConfig(IdentityCenterConfigT&& value) {
    ...
    m_identityCenterConfig = std::forward<IdentityCenterConfigT>(value);
  }
  template <typename IdentityCenterConfigT = UpdateWebAppIdentityCenterConfig>
  UpdateWebAppIdentityProviderDetails& WithIdentityCenterConfig(IdentityCenterConfigT&& value) {
    SetIdentityCenterConfig(std::forward<IdentityCenterConfigT>(value));
    return *this;
  }
  ///@}
 private:
