...
class ListedServer {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListedServer& WithArn(ArnT&& value) {
  ...
  inline ListedServer& WithDomain(Domain value) {
    SetDomain(value);
    return *this;
  }
  ///@}
  ...
  inline ListedServer& WithIdentityProviderType(IdentityProviderType value) {
  ...
  inline ListedServer& WithEndpointType(EndpointType value) {
  ...
  template <typename LoggingRoleT = Aws::String>
  ListedServer& WithLoggingRole(LoggingRoleT&& value) {
  ...
  template <typename ServerIdT = Aws::String>
  ListedServer& WithServerId(ServerIdT&& value) {
  ...
  inline ListedServer& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline ListedServer& WithUserCount(int value) {
    SetUserCount(value);
    return *this;
  }
  ///@}
