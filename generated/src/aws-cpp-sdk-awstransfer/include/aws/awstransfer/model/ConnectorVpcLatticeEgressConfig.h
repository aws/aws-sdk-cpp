...
class ConnectorVpcLatticeEgressConfig {
 public:
  ...
  template <typename ResourceConfigurationArnT = Aws::String>
  ConnectorVpcLatticeEgressConfig& WithResourceConfigurationArn(ResourceConfigurationArnT&& value) {
  ...
  inline ConnectorVpcLatticeEgressConfig& WithPortNumber(int value) {
    SetPortNumber(value);
    return *this;
  }
  ///@}
