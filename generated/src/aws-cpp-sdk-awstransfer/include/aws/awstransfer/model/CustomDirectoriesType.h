...
class CustomDirectoriesType {
 public:
  ...
  void SetFailedFilesDirectory(FailedFilesDirectoryT&& value) {
    m_failedFilesDirectoryHasBeenSet = true;
    m_failedFilesDirectory = std::forward<FailedFilesDirectoryT>(value);
  }
  template <typename FailedFilesDirectoryT = Aws::String>
  CustomDirectoriesType& WithFailedFilesDirectory(FailedFilesDirectoryT&& value) {
    SetFailedFilesDirectory(std::forward<FailedFilesDirectoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMdnFilesDirectory(MdnFilesDirectoryT&& value) {
    m_mdnFilesDirectoryHasBeenSet = true;
    m_mdnFilesDirectory = std::forward<MdnFilesDirectoryT>(value);
  }
  template <typename MdnFilesDirectoryT = Aws::String>
  CustomDirectoriesType& WithMdnFilesDirectory(MdnFilesDirectoryT&& value) {
    SetMdnFilesDirectory(std::forward<MdnFilesDirectoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPayloadFilesDirectory(PayloadFilesDirectoryT&& value) {
    m_payloadFilesDirectoryHasBeenSet = true;
    m_payloadFilesDirectory = std::forward<PayloadFilesDirectoryT>(value);
  }
  template <typename PayloadFilesDirectoryT = Aws::String>
  CustomDirectoriesType& WithPayloadFilesDirectory(PayloadFilesDirectoryT&& value) {
    SetPayloadFilesDirectory(std::forward<PayloadFilesDirectoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatusFilesDirectory(StatusFilesDirectoryT&& value) {
    m_statusFilesDirectoryHasBeenSet = true;
    m_statusFilesDirectory = std::forward<StatusFilesDirectoryT>(value);
  }
  template <typename StatusFilesDirectoryT = Aws::String>
  CustomDirectoriesType& WithStatusFilesDirectory(StatusFilesDirectoryT&& value) {
    SetStatusFilesDirectory(std::forward<StatusFilesDirectoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemporaryFilesDirectory(TemporaryFilesDirectoryT&& value) {
    m_temporaryFilesDirectoryHasBeenSet = true;
    m_temporaryFilesDirectory = std::forward<TemporaryFilesDirectoryT>(value);
  }
  template <typename TemporaryFilesDirectoryT = Aws::String>
  CustomDirectoriesType& WithTemporaryFilesDirectory(TemporaryFilesDirectoryT&& value) {
    SetTemporaryFilesDirectory(std::forward<TemporaryFilesDirectoryT>(value));
    return *this;
  }
  ///@}
 private:
