...
class ListedWebApp {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListedWebApp& WithArn(ArnT&& value) {
  ...
  template <typename WebAppIdT = Aws::String>
  ListedWebApp& WithWebAppId(WebAppIdT&& value) {
  ...
  template <typename AccessEndpointT = Aws::String>
  ListedWebApp& WithAccessEndpoint(AccessEndpointT&& value) {
  ...
  template <typename WebAppEndpointT = Aws::String>
  ListedWebApp& WithWebAppEndpoint(WebAppEndpointT&& value) {
