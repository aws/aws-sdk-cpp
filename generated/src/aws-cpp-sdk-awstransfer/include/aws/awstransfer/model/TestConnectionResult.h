...
class TestConnectionResult {
 public:
  ...
  template <typename ConnectorIdT = Aws::String>
  TestConnectionResult& WithConnectorId(ConnectorIdT&& value) {
  ...
  template <typename StatusT = Aws::String>
  TestConnectionResult& WithStatus(StatusT&& value) {
  ...
  template <typename StatusMessageT = Aws::String>
  TestConnectionResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  void SetSftpConnectionDetails(SftpConnectionDetailsT&& value) {
    m_sftpConnectionDetailsHasBeenSet = true;
    m_sftpConnectionDetails = std::forward<SftpConnectionDetailsT>(value);
  }
  template <typename SftpConnectionDetailsT = SftpConnectorConnectionDetails>
  TestConnectionResult& WithSftpConnectionDetails(SftpConnectionDetailsT&& value) {
    SetSftpConnectionDetails(std::forward<SftpConnectionDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  TestConnectionResult& WithRequestId(RequestIdT&& value) {
