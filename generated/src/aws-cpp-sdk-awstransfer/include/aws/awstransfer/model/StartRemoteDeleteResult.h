...
class StartRemoteDeleteResult {
 public:
  ...
  void SetDeleteId(DeleteIdT&& value) {
    m_deleteIdHasBeenSet = true;
    m_deleteId = std::forward<DeleteIdT>(value);
  }
  template <typename DeleteIdT = Aws::String>
  StartRemoteDeleteResult& WithDeleteId(DeleteIdT&& value) {
    SetDeleteId(std::forward<DeleteIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartRemoteDeleteResult& WithRequestId(RequestIdT&& value) {
