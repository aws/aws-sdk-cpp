...
class DescribedIdentityCenterConfig {
 public:
  AWS_TRANSFER_API DescribedIdentityCenterConfig() = default;
  ...
  template <typename ApplicationArnT = Aws::String>
  DescribedIdentityCenterConfig& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename InstanceArnT = Aws::String>
  DescribedIdentityCenterConfig& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename RoleT = Aws::String>
  DescribedIdentityCenterConfig& WithRole(RoleT&& value) {
