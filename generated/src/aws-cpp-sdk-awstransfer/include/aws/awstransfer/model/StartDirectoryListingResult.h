...
class StartDirectoryListingResult {
 public:
  ...
  template <typename ListingIdT = Aws::String>
  StartDirectoryListingResult& WithListingId(ListingIdT&& value) {
  ...
  void SetOutputFileName(OutputFileNameT&& value) {
    m_outputFileNameHasBeenSet = true;
    m_outputFileName = std::forward<OutputFileNameT>(value);
  }
  template <typename OutputFileNameT = Aws::String>
  StartDirectoryListingResult& WithOutputFileName(OutputFileNameT&& value) {
    SetOutputFileName(std::forward<OutputFileNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartDirectoryListingResult& WithRequestId(RequestIdT&& value) {
