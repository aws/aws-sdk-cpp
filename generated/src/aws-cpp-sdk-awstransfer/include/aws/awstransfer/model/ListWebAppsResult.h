...
class ListWebAppsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWebAppsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetWebApps(WebAppsT&& value) {
    m_webAppsHasBeenSet = true;
    m_webApps = std::forward<WebAppsT>(value);
  }
  template <typename WebAppsT = Aws::Vector<ListedWebApp>>
  ListWebAppsResult& WithWebApps(WebAppsT&& value) {
    SetWebApps(std::forward<WebAppsT>(value));
    return *this;
  }
  template <typename WebAppsT = ListedWebApp>
  ListWebAppsResult& AddWebApps(WebAppsT&& value) {
    m_webAppsHasBeenSet = true;
    m_webApps.emplace_back(std::forward<WebAppsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListWebAppsResult& WithRequestId(RequestIdT&& value) {
