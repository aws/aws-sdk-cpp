...
class TestIdentityProviderRequest : public TransferRequest {
 public:
  ...
  inline void SetServerProtocol(Protocol value) {
    m_serverProtocolHasBeenSet = true;
    m_serverProtocol = value;
  }
  inline TestIdentityProviderRequest& WithServerProtocol(Protocol value) {
  ...
  void SetUserPassword(UserPasswordT&& value) {
    ...
    m_userPassword = std::forward<UserPasswordT>(value);
  }
  template <typename UserPasswordT = Aws::String>
  TestIdentityProviderRequest& WithUserPassword(UserPasswordT&& value) {
    SetUserPassword(std::forward<UserPasswordT>(value));
    return *this;
  }
  ///@}
 private:
