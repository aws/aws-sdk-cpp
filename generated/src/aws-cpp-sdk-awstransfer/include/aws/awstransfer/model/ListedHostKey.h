...
class ListedHostKey {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListedHostKey& WithArn(ArnT&& value) {
  ...
  template <typename HostKeyIdT = Aws::String>
  ListedHostKey& WithHostKeyId(HostKeyIdT&& value) {
  ...
  template <typename FingerprintT = Aws::String>
  ListedHostKey& WithFingerprint(FingerprintT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ListedHostKey& WithDescription(DescriptionT&& value) {
  ...
  template <typename TypeT = Aws::String>
  ListedHostKey& WithType(TypeT&& value) {
  ...
  template <typename DateImportedT = Aws::Utils::DateTime>
  ListedHostKey& WithDateImported(DateImportedT&& value) {
