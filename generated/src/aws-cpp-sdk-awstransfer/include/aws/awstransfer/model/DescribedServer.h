...
class DescribedServer {
 public:
   ...
   * <p>Avoid placing Network Load Balancers (NLBs) or NAT gateways in front of
   * Transfer Family servers, as this increases costs and can cause performance
   * issues, including reduced connection limits for FTPS. For more details, see <a
   * href="https://docs.aws.amazon.com/transfer/latest/userguide/infrastructure-security.html#nlb-considerations">
   * Avoid placing NLBs and NATs in front of Transfer Family</a>.</p>  <ul>
   * <li> <p> To indicate passive mode (for FTP and FTPS protocols), use the
  ...
  void SetProtocolDetails(ProtocolDetailsT&& value) {
    ...
    m_protocolDetails = std::forward<ProtocolDetailsT>(value);
  }
  template <typename ProtocolDetailsT = ProtocolDetails>
  DescribedServer& WithProtocolDetails(ProtocolDetailsT&& value) {
    SetProtocolDetails(std::forward<ProtocolDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribedServer& WithDomain(Domain value) {
    SetDomain(value);
    return *this;
  }
  ///@}
  ...
  inline DescribedServer& WithEndpointType(EndpointType value) {
  ...
  inline DescribedServer& WithIdentityProviderType(IdentityProviderType value) {
  ...
  void SetPostAuthenticationLoginBanner(PostAuthenticationLoginBannerT&& value) {
    ...
    m_postAuthenticationLoginBanner = std::forward<PostAuthenticationLoginBannerT>(value);
  }
  template <typename PostAuthenticationLoginBannerT = Aws::String>
  DescribedServer& WithPostAuthenticationLoginBanner(PostAuthenticationLoginBannerT&& value) {
    SetPostAuthenticationLoginBanner(std::forward<PostAuthenticationLoginBannerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreAuthenticationLoginBanner(PreAuthenticationLoginBannerT&& value) {
    ...
    m_preAuthenticationLoginBanner = std::forward<PreAuthenticationLoginBannerT>(value);
  }
  template <typename PreAuthenticationLoginBannerT = Aws::String>
  DescribedServer& WithPreAuthenticationLoginBanner(PreAuthenticationLoginBannerT&& value) {
    SetPreAuthenticationLoginBanner(std::forward<PreAuthenticationLoginBannerT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribedServer& AddProtocols(Protocol value) {
    m_protocolsHasBeenSet = true;
  ...
  inline DescribedServer& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline DescribedServer& WithUserCount(int value) {
    SetUserCount(value);
    return *this;
  }
  ///@}
  ...
  void SetWorkflowDetails(WorkflowDetailsT&& value) {
    ...
    m_workflowDetails = std::forward<WorkflowDetailsT>(value);
  }
  template <typename WorkflowDetailsT = WorkflowDetails>
  DescribedServer& WithWorkflowDetails(WorkflowDetailsT&& value) {
    SetWorkflowDetails(std::forward<WorkflowDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3StorageOptions(S3StorageOptionsT&& value) {
    ...
    m_s3StorageOptions = std::forward<S3StorageOptionsT>(value);
  }
  template <typename S3StorageOptionsT = S3StorageOptions>
  DescribedServer& WithS3StorageOptions(S3StorageOptionsT&& value) {
    SetS3StorageOptions(std::forward<S3StorageOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAs2ServiceManagedEgressIpAddresses(As2ServiceManagedEgressIpAddressesT&& value) {
    ...
    m_as2ServiceManagedEgressIpAddresses = std::forward<As2ServiceManagedEgressIpAddressesT>(value);
  }
  template <typename As2ServiceManagedEgressIpAddressesT = Aws::Vector<Aws::String>>
  DescribedServer& WithAs2ServiceManagedEgressIpAddresses(As2ServiceManagedEgressIpAddressesT&& value) {
    SetAs2ServiceManagedEgressIpAddresses(std::forward<As2ServiceManagedEgressIpAddressesT>(value));
    return *this;
  }
  ...
  DescribedServer& AddAs2ServiceManagedEgressIpAddresses(As2ServiceManagedEgressIpAddressesT&& value) {
    m_as2ServiceManagedEgressIpAddressesHasBeenSet = true;
    m_as2ServiceManagedEgressIpAddresses.emplace_back(std::forward<As2ServiceManagedEgressIpAddressesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribedServer& WithIpAddressType(IpAddressType value) {
