...
class DescribedExecution {
 public:
  ...
  void SetPosixProfile(PosixProfileT&& value) {
    ...
    m_posixProfile = std::forward<PosixProfileT>(value);
  }
  template <typename PosixProfileT = PosixProfile>
  DescribedExecution& WithPosixProfile(PosixProfileT&& value) {
    SetPosixProfile(std::forward<PosixProfileT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribedExecution& WithStatus(ExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
