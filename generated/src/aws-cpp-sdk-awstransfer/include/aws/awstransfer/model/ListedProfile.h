...
class ListedProfile {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListedProfile& WithArn(ArnT&& value) {
  ...
  template <typename ProfileIdT = Aws::String>
  ListedProfile& WithProfileId(ProfileIdT&& value) {
  ...
  template <typename As2IdT = Aws::String>
  ListedProfile& WithAs2Id(As2IdT&& value) {
  ...
  inline ListedProfile& WithProfileType(ProfileType value) {
