...
class ProtocolDetails {
 public:
  ...
  void SetPassiveIp(PassiveIpT&& value) {
    ...
    m_passiveIp = std::forward<PassiveIpT>(value);
  }
  template <typename PassiveIpT = Aws::String>
  ProtocolDetails& WithPassiveIp(PassiveIpT&& value) {
    SetPassiveIp(std::forward<PassiveIpT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTlsSessionResumptionMode(TlsSessionResumptionMode value) {
    m_tlsSessionResumptionModeHasBeenSet = true;
    m_tlsSessionResumptionMode = value;
  }
  inline ProtocolDetails& WithTlsSessionResumptionMode(TlsSessionResumptionMode value) {
    SetTlsSessionResumptionMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSetStatOption(SetStatOption value) {
    m_setStatOptionHasBeenSet = true;
    m_setStatOption = value;
  }
  inline ProtocolDetails& WithSetStatOption(SetStatOption value) {
    SetSetStatOption(value);
    return *this;
  }
  ///@}
  ...
  void SetAs2Transports(As2TransportsT&& value) {
    ...
    m_as2Transports = std::forward<As2TransportsT>(value);
  }
  template <typename As2TransportsT = Aws::Vector<As2Transport>>
  ProtocolDetails& WithAs2Transports(As2TransportsT&& value) {
    SetAs2Transports(std::forward<As2TransportsT>(value));
    return *this;
  }
  inline ProtocolDetails& AddAs2Transports(As2Transport value) {
    m_as2TransportsHasBeenSet = true;
    m_as2Transports.push_back(value);
    return *this;
  }
  ///@}
 private:
