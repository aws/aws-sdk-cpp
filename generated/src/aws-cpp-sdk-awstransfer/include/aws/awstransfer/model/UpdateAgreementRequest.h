...
class UpdateAgreementRequest : public TransferRequest {
 public:
  ...
  inline UpdateAgreementRequest& WithStatus(AgreementStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateAgreementRequest& WithPreserveFilename(PreserveFilenameType value) {
  ...
  inline UpdateAgreementRequest& WithEnforceMessageSigning(EnforceMessageSigningType value) {
