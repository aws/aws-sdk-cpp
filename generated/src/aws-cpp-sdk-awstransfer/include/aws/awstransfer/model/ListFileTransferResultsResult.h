...
class ListFileTransferResultsResult {
 public:
  ...
  void SetFileTransferResults(FileTransferResultsT&& value) {
    m_fileTransferResultsHasBeenSet = true;
    m_fileTransferResults = std::forward<FileTransferResultsT>(value);
  }
  template <typename FileTransferResultsT = Aws::Vector<ConnectorFileTransferResult>>
  ListFileTransferResultsResult& WithFileTransferResults(FileTransferResultsT&& value) {
    SetFileTransferResults(std::forward<FileTransferResultsT>(value));
    return *this;
  }
  template <typename FileTransferResultsT = ConnectorFileTransferResult>
  ListFileTransferResultsResult& AddFileTransferResults(FileTransferResultsT&& value) {
    m_fileTransferResultsHasBeenSet = true;
    m_fileTransferResults.emplace_back(std::forward<FileTransferResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFileTransferResultsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFileTransferResultsResult& WithRequestId(RequestIdT&& value) {
