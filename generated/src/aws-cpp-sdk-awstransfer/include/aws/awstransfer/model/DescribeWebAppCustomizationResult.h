...
class DescribeWebAppCustomizationResult {
 public:
  ...
  void SetWebAppCustomization(WebAppCustomizationT&& value) {
    m_webAppCustomizationHasBeenSet = true;
    m_webAppCustomization = std::forward<WebAppCustomizationT>(value);
  }
  template <typename WebAppCustomizationT = DescribedWebAppCustomization>
  DescribeWebAppCustomizationResult& WithWebAppCustomization(WebAppCustomizationT&& value) {
    SetWebAppCustomization(std::forward<WebAppCustomizationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWebAppCustomizationResult& WithRequestId(RequestIdT&& value) {
