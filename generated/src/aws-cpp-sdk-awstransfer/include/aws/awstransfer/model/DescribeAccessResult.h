...
class DescribeAccessResult {
 public:
  ...
  template <typename ServerIdT = Aws::String>
  DescribeAccessResult& WithServerId(ServerIdT&& value) {
  ...
  void SetAccess(AccessT&& value) {
    ...
    m_access = std::forward<AccessT>(value);
  }
  template <typename AccessT = DescribedAccess>
  DescribeAccessResult& WithAccess(AccessT&& value) {
    SetAccess(std::forward<AccessT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAccessResult& WithRequestId(RequestIdT&& value) {
