...
class As2ConnectorConfig {
 public:
  ...
  void SetMessageSubject(MessageSubjectT&& value) {
    ...
    m_messageSubject = std::forward<MessageSubjectT>(value);
  }
  template <typename MessageSubjectT = Aws::String>
  As2ConnectorConfig& WithMessageSubject(MessageSubjectT&& value) {
    SetMessageSubject(std::forward<MessageSubjectT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCompression(CompressionEnum value) {
    m_compressionHasBeenSet = true;
    m_compression = value;
  }
  inline As2ConnectorConfig& WithCompression(CompressionEnum value) {
  ...
  inline void SetEncryptionAlgorithm(EncryptionAlg value) {
    m_encryptionAlgorithmHasBeenSet = true;
    m_encryptionAlgorithm = value;
  }
  inline As2ConnectorConfig& WithEncryptionAlgorithm(EncryptionAlg value) {
  ...
  inline void SetSigningAlgorithm(SigningAlg value) {
    m_signingAlgorithmHasBeenSet = true;
    m_signingAlgorithm = value;
  }
  inline As2ConnectorConfig& WithSigningAlgorithm(SigningAlg value) {
  ...
  inline void SetMdnSigningAlgorithm(MdnSigningAlg value) {
    m_mdnSigningAlgorithmHasBeenSet = true;
    m_mdnSigningAlgorithm = value;
  }
  inline As2ConnectorConfig& WithMdnSigningAlgorithm(MdnSigningAlg value) {
    SetMdnSigningAlgorithm(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMdnResponse(MdnResponse value) {
    m_mdnResponseHasBeenSet = true;
    m_mdnResponse = value;
  }
  inline As2ConnectorConfig& WithMdnResponse(MdnResponse value) {
    SetMdnResponse(value);
    return *this;
  }
  ///@}
  ...
  void SetBasicAuthSecretId(BasicAuthSecretIdT&& value) {
    ...
    m_basicAuthSecretId = std::forward<BasicAuthSecretIdT>(value);
  }
  template <typename BasicAuthSecretIdT = Aws::String>
  As2ConnectorConfig& WithBasicAuthSecretId(BasicAuthSecretIdT&& value) {
    SetBasicAuthSecretId(std::forward<BasicAuthSecretIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPreserveContentType(PreserveContentType value) {
    m_preserveContentTypeHasBeenSet = true;
    m_preserveContentType = value;
  }
  inline As2ConnectorConfig& WithPreserveContentType(PreserveContentType value) {
    SetPreserveContentType(value);
    return *this;
  }
  ///@}
 private:
