...
class StartRemoteMoveResult {
 public:
  ...
  void SetMoveId(MoveIdT&& value) {
    m_moveIdHasBeenSet = true;
    m_moveId = std::forward<MoveIdT>(value);
  }
  template <typename MoveIdT = Aws::String>
  StartRemoteMoveResult& WithMoveId(MoveIdT&& value) {
    SetMoveId(std::forward<MoveIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartRemoteMoveResult& WithRequestId(RequestIdT&& value) {
