...
class DescribedCertificate {
 public:
  ...
  inline void SetUsage(CertificateUsageType value) {
    m_usageHasBeenSet = true;
    m_usage = value;
  }
  inline DescribedCertificate& WithUsage(CertificateUsageType value) {
    SetUsage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(CertificateStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribedCertificate& WithStatus(CertificateStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetActiveDate(ActiveDateT&& value) {
    ...
    m_activeDate = std::forward<ActiveDateT>(value);
  }
  template <typename ActiveDateT = Aws::Utils::DateTime>
  DescribedCertificate& WithActiveDate(ActiveDateT&& value) {
    SetActiveDate(std::forward<ActiveDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInactiveDate(InactiveDateT&& value) {
    ...
    m_inactiveDate = std::forward<InactiveDateT>(value);
  }
  template <typename InactiveDateT = Aws::Utils::DateTime>
  DescribedCertificate& WithInactiveDate(InactiveDateT&& value) {
    SetInactiveDate(std::forward<InactiveDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNotBeforeDate(NotBeforeDateT&& value) {
    ...
    m_notBeforeDate = std::forward<NotBeforeDateT>(value);
  }
  template <typename NotBeforeDateT = Aws::Utils::DateTime>
  DescribedCertificate& WithNotBeforeDate(NotBeforeDateT&& value) {
    SetNotBeforeDate(std::forward<NotBeforeDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNotAfterDate(NotAfterDateT&& value) {
    ...
    m_notAfterDate = std::forward<NotAfterDateT>(value);
  }
  template <typename NotAfterDateT = Aws::Utils::DateTime>
  DescribedCertificate& WithNotAfterDate(NotAfterDateT&& value) {
    SetNotAfterDate(std::forward<NotAfterDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribedCertificate& WithType(CertificateType value) {
    SetType(value);
    return *this;
  }
  ///@}
