...
class CopyStepDetails {
 public:
  ...
  template <typename NameT = Aws::String>
  CopyStepDetails& WithName(NameT&& value) {
  ...
  template <typename DestinationFileLocationT = InputFileLocation>
  CopyStepDetails& WithDestinationFileLocation(DestinationFileLocationT&& value) {
  ...
  inline CopyStepDetails& WithOverwriteExisting(OverwriteExisting value) {
  ...
  template <typename SourceFileLocationT = Aws::String>
  CopyStepDetails& WithSourceFileLocation(SourceFileLocationT&& value) {
