...
class StartFileTransferResult {
 public:
  ...
  void SetTransferId(TransferIdT&& value) {
    m_transferIdHasBeenSet = true;
    m_transferId = std::forward<TransferIdT>(value);
  }
  template <typename TransferIdT = Aws::String>
  StartFileTransferResult& WithTransferId(TransferIdT&& value) {
    SetTransferId(std::forward<TransferIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartFileTransferResult& WithRequestId(RequestIdT&& value) {
