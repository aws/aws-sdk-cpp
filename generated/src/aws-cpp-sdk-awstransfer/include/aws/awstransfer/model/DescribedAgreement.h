...
class DescribedAgreement {
 public:
  ...
  inline DescribedAgreement& WithStatus(AgreementStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribedAgreement& WithPreserveFilename(PreserveFilenameType value) {
  ...
  inline DescribedAgreement& WithEnforceMessageSigning(EnforceMessageSigningType value) {
