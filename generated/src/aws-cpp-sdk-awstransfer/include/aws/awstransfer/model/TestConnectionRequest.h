...
namespace Model
{
  ...
  {
  public:
    AWS_TRANSFER_API TestConnectionRequest();
     ...
     * <p>The unique identifier for the connector.</p>
     */
    inline TestConnectionRequest& WithConnectorId(const Aws::String& value) { SetConnectorId(value); return *this;}

    /**
     * <p>The unique identifier for the connector.</p>
     */
    inline TestConnectionRequest& WithConnectorId(Aws::String&& value) { SetConnectorId(std::move(value)); return *this;}

    /**
     * <p>The unique identifier for the connector.</p>
     */
    inline TestConnectionRequest& WithConnectorId(const char* value) { SetConnectorId(value); return *this;}
