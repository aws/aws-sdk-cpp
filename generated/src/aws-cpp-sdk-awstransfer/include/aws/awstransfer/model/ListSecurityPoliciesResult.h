...
class ListSecurityPoliciesResult {
 public:
  ...
  void SetSecurityPolicyNames(SecurityPolicyNamesT&& value) {
    m_securityPolicyNamesHasBeenSet = true;
    m_securityPolicyNames = std::forward<SecurityPolicyNamesT>(value);
  }
  template <typename SecurityPolicyNamesT = Aws::Vector<Aws::String>>
  ListSecurityPoliciesResult& WithSecurityPolicyNames(SecurityPolicyNamesT&& value) {
    SetSecurityPolicyNames(std::forward<SecurityPolicyNamesT>(value));
    return *this;
  }
  template <typename SecurityPolicyNamesT = Aws::String>
  ListSecurityPoliciesResult& AddSecurityPolicyNames(SecurityPolicyNamesT&& value) {
    m_securityPolicyNamesHasBeenSet = true;
    m_securityPolicyNames.emplace_back(std::forward<SecurityPolicyNamesT>(value));
    return *this;
  }
  ///@}
