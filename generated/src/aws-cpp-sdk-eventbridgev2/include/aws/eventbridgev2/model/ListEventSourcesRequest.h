...
/**
 */
class ListEventSourcesRequest : public EventBridgeV2Request {
 public:
  AWS_EVENTBRIDGEV2_API ListEventSourcesRequest() = default;
  ...
  template <typename EventBusArnT = Aws::String>
  ListEventSourcesRequest& WithEventBusArn(EventBusArnT&& value) {
  ...
  template <typename NamePrefixT = Aws::String>
  ListEventSourcesRequest& WithNamePrefix(NamePrefixT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListEventSourcesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEventSourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
