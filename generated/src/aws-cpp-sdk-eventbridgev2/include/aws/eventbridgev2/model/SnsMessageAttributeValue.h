...
/**
 * <p>A custom SNS message attribute (data type plus string or binary
 * value).</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/eventbridgev2-2025-05-15/SnsMessageAttributeValue">AWS
 * API Reference</a></p>
 */
class SnsMessageAttributeValue {
 public:
  AWS_EVENTBRIDGEV2_API SnsMessageAttributeValue() = default;
  AWS_EVENTBRIDGEV2_API SnsMessageAttributeValue(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_EVENTBRIDGEV2_API SnsMessageAttributeValue& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_EVENTBRIDGEV2_API void CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const;

  ///@{
  /**
   * <p>Attribute data type. Requiredness and the accepted vocabulary belong to SNS,
   * which rejects an attribute without a data type on delivery.</p>
   */
  ...
  template <typename DataTypeT = Aws::String>
  SnsMessageAttributeValue& WithDataType(DataTypeT&& value) {
  ...
  template <typename StringValueT = Aws::String>
  SnsMessageAttributeValue& WithStringValue(StringValueT&& value) {
  ...
  template <typename BinaryValueT = Aws::String>
  SnsMessageAttributeValue& WithBinaryValue(BinaryValueT&& value) {
