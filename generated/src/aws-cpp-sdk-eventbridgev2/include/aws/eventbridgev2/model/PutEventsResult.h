...
class PutEventsResult {
 public:
  AWS_EVENTBRIDGEV2_API PutEventsResult() = default;
  AWS_EVENTBRIDGEV2_API PutEventsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_EVENTBRIDGEV2_API PutEventsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  inline PutEventsResult& WithFailedEntryCount(int64_t value) {
