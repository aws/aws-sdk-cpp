...
/**
 */
class ListResourcePoliciesRequest : public EventBridgeV2Request {
 public:
  AWS_EVENTBRIDGEV2_API ListResourcePoliciesRequest() = default;
  ...
  template <typename ResourceArnT = Aws::String>
  ListResourcePoliciesRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline ListResourcePoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
