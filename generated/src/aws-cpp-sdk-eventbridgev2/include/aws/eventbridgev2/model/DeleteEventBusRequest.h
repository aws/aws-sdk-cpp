...
/**
 */
class DeleteEventBusRequest : public EventBridgeV2Request {
 public:
  AWS_EVENTBRIDGEV2_API DeleteEventBusRequest() = default;
  ...
  template <typename EventBusArnT = Aws::String>
  DeleteEventBusRequest& WithEventBusArn(EventBusArnT&& value) {
