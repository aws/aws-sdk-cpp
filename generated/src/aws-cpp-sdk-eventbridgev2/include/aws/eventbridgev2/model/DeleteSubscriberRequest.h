...
/**
 */
class DeleteSubscriberRequest : public EventBridgeV2Request {
 public:
  AWS_EVENTBRIDGEV2_API DeleteSubscriberRequest() = default;
  ...
  template <typename SubscriberArnT = Aws::String>
  DeleteSubscriberRequest& WithSubscriberArn(SubscriberArnT&& value) {
