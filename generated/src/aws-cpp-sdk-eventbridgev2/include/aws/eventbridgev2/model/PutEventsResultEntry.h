 ...
 * response list aligns 1:1 with the corresponding request entry.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/eventbridgev2-2025-05-15/PutEventsResultEntry">AWS
 * API Reference</a></p>
 */
class PutEventsResultEntry {
 public:
  AWS_EVENTBRIDGEV2_API PutEventsResultEntry() = default;
  AWS_EVENTBRIDGEV2_API PutEventsResultEntry(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_EVENTBRIDGEV2_API PutEventsResultEntry& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename EventIdT = Aws::String>
  PutEventsResultEntry& WithEventId(EventIdT&& value) {
  ...
  template <typename SequenceNumberT = Aws::String>
  PutEventsResultEntry& WithSequenceNumber(SequenceNumberT&& value) {
  ...
  inline PutEventsResultEntry& WithSuccessCode(SuccessCode value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  PutEventsResultEntry& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  PutEventsResultEntry& WithErrorMessage(ErrorMessageT&& value) {
