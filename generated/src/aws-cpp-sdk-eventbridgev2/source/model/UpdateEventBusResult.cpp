...
UpdateEventBusResult::UpdateEventBusResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) { *this = result; }

UpdateEventBusResult& UpdateEventBusResult::operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              else if (initialKeyStr == "EncryptionConfiguration") {
                m_encryptionConfiguration = EncryptionConfiguration(decoder);
                m_encryptionConfigurationHasBeenSet = true;
              }

              else if (initialKeyStr == "StorageConfiguration") {
                m_storageConfiguration = StorageConfigurationOutput(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("UpdateEventBusResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
