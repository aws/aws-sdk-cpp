...
DescribeEventSourceResult::DescribeEventSourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

DescribeEventSourceResult& DescribeEventSourceResult::operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "EventSourceArn") {
                ...
                m_configuration = EventSourceConfiguration(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("DescribeEventSourceResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
