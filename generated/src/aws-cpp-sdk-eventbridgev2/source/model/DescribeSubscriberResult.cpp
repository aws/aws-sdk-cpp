...
DescribeSubscriberResult::DescribeSubscriberResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

DescribeSubscriberResult& DescribeSubscriberResult::operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              else if (initialKeyStr == "InvokeConfiguration") {
                m_invokeConfiguration = InvokeConfiguration(decoder);
              ...
              else if (initialKeyStr == "FilterConfiguration") {
                m_filterConfiguration = FilterConfiguration(decoder);
              ...
              else if (initialKeyStr == "BatchConfiguration") {
                m_batchConfiguration = BatchConfiguration(decoder);
                m_batchConfigurationHasBeenSet = true;
              }

              else if (initialKeyStr == "Transformer") {
                m_transformer = Transformer(decoder);
                m_transformerHasBeenSet = true;
              }

              else if (initialKeyStr == "RetryPolicy") {
                m_retryPolicy = RetryPolicy(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("DescribeSubscriberResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
