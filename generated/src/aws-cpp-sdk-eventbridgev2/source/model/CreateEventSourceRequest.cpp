...
Aws::String CreateEventSourceRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection CreateEventSourceRequest::GetRequestSpecificHeaders() const {
...
CreateEventSourceRequest::EndpointParameters CreateEventSourceRequest::GetEndpointContextParams() const {
