          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "Language") {
                ...
                if (val.has_value()) {
                  m_language = FilterLanguageMapper::GetFilterLanguageForName(
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_filters.push_back(Filter(decoder));
                      }
                    }
...
void FilterConfiguration::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  ...
  if (m_languageHasBeenSet) {
    ...
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(FilterLanguageMapper::GetNameForFilterLanguage(m_language).c_str()));
  }
