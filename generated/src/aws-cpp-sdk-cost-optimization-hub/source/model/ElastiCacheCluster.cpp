...
ElastiCacheCluster::ElastiCacheCluster(JsonView jsonValue) { *this = jsonValue; }

ElastiCacheCluster& ElastiCacheCluster::operator=(JsonView jsonValue) {
...
JsonValue ElastiCacheCluster::Jsonize() const {
  JsonValue payload;
