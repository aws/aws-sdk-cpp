...
MemoryDbReservedInstancesConfiguration::MemoryDbReservedInstancesConfiguration(JsonView jsonValue)
{
  *this = jsonValue;
}

MemoryDbReservedInstancesConfiguration& MemoryDbReservedInstancesConfiguration::operator =(JsonView jsonValue)
{
...
JsonValue MemoryDbReservedInstancesConfiguration::Jsonize() const
{
  JsonValue payload;
