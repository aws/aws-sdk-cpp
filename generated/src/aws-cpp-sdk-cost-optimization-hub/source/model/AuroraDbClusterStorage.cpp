...
AuroraDbClusterStorage::AuroraDbClusterStorage(JsonView jsonValue) { *this = jsonValue; }

AuroraDbClusterStorage& AuroraDbClusterStorage::operator=(JsonView jsonValue) {
...
JsonValue AuroraDbClusterStorage::Jsonize() const {
  JsonValue payload;
