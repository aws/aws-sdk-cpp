...
RedshiftReservedInstancesConfiguration::RedshiftReservedInstancesConfiguration(JsonView jsonValue) { *this = jsonValue; }

RedshiftReservedInstancesConfiguration& RedshiftReservedInstancesConfiguration::operator=(JsonView jsonValue) {
...
JsonValue RedshiftReservedInstancesConfiguration::Jsonize() const {
  JsonValue payload;
