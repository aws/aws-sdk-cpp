...
Ec2ReservedInstances::Ec2ReservedInstances(JsonView jsonValue) { *this = jsonValue; }

Ec2ReservedInstances& Ec2ReservedInstances::operator=(JsonView jsonValue) {
...
JsonValue Ec2ReservedInstances::Jsonize() const {
  JsonValue payload;
