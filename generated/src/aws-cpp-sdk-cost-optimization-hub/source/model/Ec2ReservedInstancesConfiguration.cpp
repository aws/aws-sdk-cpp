...
Ec2ReservedInstancesConfiguration::Ec2ReservedInstancesConfiguration(JsonView jsonValue) { *this = jsonValue; }

Ec2ReservedInstancesConfiguration& Ec2ReservedInstancesConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("offeringClass")) {
    m_offeringClass = jsonValue.GetString("offeringClass");
...
JsonValue Ec2ReservedInstancesConfiguration::Jsonize() const {
  JsonValue payload;
  ...
  if (m_offeringClassHasBeenSet) {
    payload.WithString("offeringClass", m_offeringClass);
  }
