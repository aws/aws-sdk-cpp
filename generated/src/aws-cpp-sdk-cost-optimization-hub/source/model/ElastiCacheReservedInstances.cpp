...
ElastiCacheReservedInstances::ElastiCacheReservedInstances(JsonView jsonValue) { *this = jsonValue; }

ElastiCacheReservedInstances& ElastiCacheReservedInstances::operator=(JsonView jsonValue) {
...
JsonValue ElastiCacheReservedInstances::Jsonize() const {
  JsonValue payload;
