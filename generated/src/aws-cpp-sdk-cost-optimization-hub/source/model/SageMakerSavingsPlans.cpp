...
SageMakerSavingsPlans::SageMakerSavingsPlans(JsonView jsonValue) { *this = jsonValue; }

SageMakerSavingsPlans& SageMakerSavingsPlans::operator=(JsonView jsonValue) {
...
JsonValue SageMakerSavingsPlans::Jsonize() const {
  JsonValue payload;
