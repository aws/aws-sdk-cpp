...
ComputeSavingsPlans::ComputeSavingsPlans(JsonView jsonValue) { *this = jsonValue; }

ComputeSavingsPlans& ComputeSavingsPlans::operator=(JsonView jsonValue) {
...
JsonValue ComputeSavingsPlans::Jsonize() const {
  JsonValue payload;
