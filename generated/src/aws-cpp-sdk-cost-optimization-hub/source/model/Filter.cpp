...
Filter& Filter::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("implementationEfforts")) {
    ...
    for (unsigned implementationEffortsIndex = 0; implementationEffortsIndex < implementationEffortsJsonList.GetLength();
         ++implementationEffortsIndex) {
      m_implementationEfforts.push_back(
          ImplementationEffortMapper::GetImplementationEffortForName(implementationEffortsJsonList[implementationEffortsIndex].AsString()));
    }
...
JsonValue Filter::Jsonize() const {
  ...
  if (m_implementationEffortsHasBeenSet) {
    ...
    for (unsigned implementationEffortsIndex = 0; implementationEffortsIndex < implementationEffortsJsonList.GetLength();
         ++implementationEffortsIndex) {
      implementationEffortsJsonList[implementationEffortsIndex].AsString(
