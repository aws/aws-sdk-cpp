...
DynamoDbTable::DynamoDbTable(JsonView jsonValue) { *this = jsonValue; }

DynamoDbTable& DynamoDbTable::operator=(JsonView jsonValue) {
...
JsonValue DynamoDbTable::Jsonize() const {
  JsonValue payload;
