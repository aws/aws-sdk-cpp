...
RdsDbInstanceStorage::RdsDbInstanceStorage(JsonView jsonValue) { *this = jsonValue; }

RdsDbInstanceStorage& RdsDbInstanceStorage::operator=(JsonView jsonValue) {
...
JsonValue RdsDbInstanceStorage::Jsonize() const {
  JsonValue payload;
