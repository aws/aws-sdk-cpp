...
Ec2InstanceSavingsPlans::Ec2InstanceSavingsPlans(JsonView jsonValue) { *this = jsonValue; }

Ec2InstanceSavingsPlans& Ec2InstanceSavingsPlans::operator=(JsonView jsonValue) {
...
JsonValue Ec2InstanceSavingsPlans::Jsonize() const {
  JsonValue payload;
