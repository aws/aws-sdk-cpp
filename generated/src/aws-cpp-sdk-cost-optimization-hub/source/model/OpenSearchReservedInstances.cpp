...
OpenSearchReservedInstances::OpenSearchReservedInstances(JsonView jsonValue) { *this = jsonValue; }

OpenSearchReservedInstances& OpenSearchReservedInstances::operator=(JsonView jsonValue) {
...
JsonValue OpenSearchReservedInstances::Jsonize() const {
  JsonValue payload;
