...
MemoryDbReservedInstances::MemoryDbReservedInstances(JsonView jsonValue) { *this = jsonValue; }

MemoryDbReservedInstances& MemoryDbReservedInstances::operator=(JsonView jsonValue) {
...
JsonValue MemoryDbReservedInstances::Jsonize() const {
  JsonValue payload;
