...
DynamoDbReservedCapacity::DynamoDbReservedCapacity(JsonView jsonValue) { *this = jsonValue; }

DynamoDbReservedCapacity& DynamoDbReservedCapacity::operator=(JsonView jsonValue) {
...
JsonValue DynamoDbReservedCapacity::Jsonize() const {
  JsonValue payload;
