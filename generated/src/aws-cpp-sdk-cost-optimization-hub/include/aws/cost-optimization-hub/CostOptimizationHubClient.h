...
namespace CostOptimizationHub
{
   ...
   */
  class AWS_COSTOPTIMIZATIONHUB_API CostOptimizationHubClient : Aws::Client::ClientWithAsyncTemplateMethods<CostOptimizationHubClient>,
    smithy::client::AwsSmithyClientT<Aws::CostOptimizationHub::SERVICE_NAME,
