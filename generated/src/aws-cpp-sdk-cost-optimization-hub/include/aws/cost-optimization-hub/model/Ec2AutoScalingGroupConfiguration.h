...
class Ec2AutoScalingGroupConfiguration {
 public:
  ...
  void SetMixedInstances(MixedInstancesT&& value) {
    ...
    m_mixedInstances = std::forward<MixedInstancesT>(value);
  }
  template <typename MixedInstancesT = Aws::Vector<MixedInstanceConfiguration>>
  Ec2AutoScalingGroupConfiguration& WithMixedInstances(MixedInstancesT&& value) {
    SetMixedInstances(std::forward<MixedInstancesT>(value));
    return *this;
  }
  ...
  Ec2AutoScalingGroupConfiguration& AddMixedInstances(MixedInstancesT&& value) {
    m_mixedInstancesHasBeenSet = true;
    m_mixedInstances.emplace_back(std::forward<MixedInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(Ec2AutoScalingGroupType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Ec2AutoScalingGroupConfiguration& WithType(Ec2AutoScalingGroupType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllocationStrategy(AllocationStrategy value) {
    m_allocationStrategyHasBeenSet = true;
    m_allocationStrategy = value;
  }
  inline Ec2AutoScalingGroupConfiguration& WithAllocationStrategy(AllocationStrategy value) {
