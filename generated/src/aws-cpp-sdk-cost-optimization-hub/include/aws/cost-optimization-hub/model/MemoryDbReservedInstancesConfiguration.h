...
class MemoryDbReservedInstancesConfiguration {
 public:
  ...
  template <typename ServiceT = Aws::String>
  MemoryDbReservedInstancesConfiguration& WithService(ServiceT&& value) {
  ...
  template <typename TermT = Aws::String>
  MemoryDbReservedInstancesConfiguration& WithTerm(TermT&& value) {
  ...
  inline MemoryDbReservedInstancesConfiguration& WithSizeFlexEligible(bool value) {
