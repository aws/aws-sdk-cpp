...
/**
 * <p>The MemoryDB cluster recommendation details.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/MemoryDbCluster">AWS
 * API Reference</a></p>
 */
class MemoryDbCluster {
 public:
  AWS_COSTOPTIMIZATIONHUB_API MemoryDbCluster() = default;
  AWS_COSTOPTIMIZATIONHUB_API MemoryDbCluster(Aws::Utils::Json::JsonView jsonValue);
  AWS_COSTOPTIMIZATIONHUB_API MemoryDbCluster& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename CostCalculationT = ResourceCostCalculation>
  MemoryDbCluster& WithCostCalculation(CostCalculationT&& value) {
