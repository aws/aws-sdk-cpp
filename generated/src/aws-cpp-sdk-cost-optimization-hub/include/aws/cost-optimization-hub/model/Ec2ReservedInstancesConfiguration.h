...
class Ec2ReservedInstancesConfiguration {
 public:
  ...
  void SetOfferingClass(OfferingClassT&& value) {
    ...
    m_offeringClass = std::forward<OfferingClassT>(value);
  }
  template <typename OfferingClassT = Aws::String>
  Ec2ReservedInstancesConfiguration& WithOfferingClass(OfferingClassT&& value) {
    SetOfferingClass(std::forward<OfferingClassT>(value));
    return *this;
  }
  ///@}
  ...
  inline Ec2ReservedInstancesConfiguration& WithSizeFlexEligible(bool value) {
