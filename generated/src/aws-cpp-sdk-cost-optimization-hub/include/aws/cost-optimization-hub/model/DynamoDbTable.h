...
/**
 * <p>The DynamoDB table recommendation details.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/DynamoDbTable">AWS
 * API Reference</a></p>
 */
class DynamoDbTable {
 public:
  AWS_COSTOPTIMIZATIONHUB_API DynamoDbTable() = default;
  AWS_COSTOPTIMIZATIONHUB_API DynamoDbTable(Aws::Utils::Json::JsonView jsonValue);
  AWS_COSTOPTIMIZATIONHUB_API DynamoDbTable& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename CostCalculationT = ResourceCostCalculation>
  DynamoDbTable& WithCostCalculation(CostCalculationT&& value) {
