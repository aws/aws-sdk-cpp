...
class RedshiftReservedInstancesConfiguration {
 public:
  ...
  template <typename AccountScopeT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithAccountScope(AccountScopeT&& value) {
  ...
  template <typename ServiceT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithService(ServiceT&& value) {
  ...
  template <typename TermT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithTerm(TermT&& value) {
  ...
  template <typename PaymentOptionT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithPaymentOption(PaymentOptionT&& value) {
  ...
  template <typename ReservedInstancesRegionT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithReservedInstancesRegion(ReservedInstancesRegionT&& value) {
  ...
  template <typename UpfrontCostT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithUpfrontCost(UpfrontCostT&& value) {
  ...
  template <typename MonthlyRecurringCostT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithMonthlyRecurringCost(MonthlyRecurringCostT&& value) {
  ...
  template <typename NormalizedUnitsToPurchaseT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithNormalizedUnitsToPurchase(NormalizedUnitsToPurchaseT&& value) {
  ...
  template <typename NumberOfInstancesToPurchaseT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithNumberOfInstancesToPurchase(NumberOfInstancesToPurchaseT&& value) {
  ...
  template <typename InstanceFamilyT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithInstanceFamily(InstanceFamilyT&& value) {
  ...
  template <typename InstanceTypeT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithInstanceType(InstanceTypeT&& value) {
  ...
  inline RedshiftReservedInstancesConfiguration& WithSizeFlexEligible(bool value) {
  ...
  template <typename CurrentGenerationT = Aws::String>
  RedshiftReservedInstancesConfiguration& WithCurrentGeneration(CurrentGenerationT&& value) {
