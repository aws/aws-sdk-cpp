...
namespace Model
{
  ...
  {
  public:
    AWS_COSTOPTIMIZATIONHUB_API MemoryDbReservedInstances() = default;
    AWS_COSTOPTIMIZATIONHUB_API MemoryDbReservedInstances(Aws::Utils::Json::JsonView jsonValue);
    AWS_COSTOPTIMIZATIONHUB_API MemoryDbReservedInstances& operator=(Aws::Utils::Json::JsonView jsonValue);
     ...
     */
    inline const MemoryDbReservedInstancesConfiguration& GetConfiguration() const { return m_configuration; }
    inline bool ConfigurationHasBeenSet() const { return m_configurationHasBeenSet; }
    template<typename ConfigurationT = MemoryDbReservedInstancesConfiguration>
    void SetConfiguration(ConfigurationT&& value) { m_configurationHasBeenSet = true; m_configuration = std::forward<ConfigurationT>(value); }
    template<typename ConfigurationT = MemoryDbReservedInstancesConfiguration>
    MemoryDbReservedInstances& WithConfiguration(ConfigurationT&& value) { SetConfiguration(std::forward<ConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename CostCalculationT = ReservedInstancesCostCalculation>
    MemoryDbReservedInstances& WithCostCalculation(CostCalculationT&& value) { SetCostCalculation(std::forward<CostCalculationT>(value)); return *this;}
    ///@}
  private:
