...
/**
 * <p>The SageMaker endpoint recommendation details.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/SageMakerEndpoint">AWS
 * API Reference</a></p>
 */
class SageMakerEndpoint {
 public:
  AWS_COSTOPTIMIZATIONHUB_API SageMakerEndpoint() = default;
  AWS_COSTOPTIMIZATIONHUB_API SageMakerEndpoint(Aws::Utils::Json::JsonView jsonValue);
  AWS_COSTOPTIMIZATIONHUB_API SageMakerEndpoint& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename CostCalculationT = ResourceCostCalculation>
  SageMakerEndpoint& WithCostCalculation(CostCalculationT&& value) {
