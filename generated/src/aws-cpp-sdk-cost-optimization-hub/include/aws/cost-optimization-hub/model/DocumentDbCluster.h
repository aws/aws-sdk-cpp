...
/**
 * <p>The Amazon DocumentDB cluster recommendation details.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/DocumentDbCluster">AWS
 * API Reference</a></p>
 */
class DocumentDbCluster {
 public:
  AWS_COSTOPTIMIZATIONHUB_API DocumentDbCluster() = default;
  AWS_COSTOPTIMIZATIONHUB_API DocumentDbCluster(Aws::Utils::Json::JsonView jsonValue);
  AWS_COSTOPTIMIZATIONHUB_API DocumentDbCluster& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename CostCalculationT = ResourceCostCalculation>
  DocumentDbCluster& WithCostCalculation(CostCalculationT&& value) {
