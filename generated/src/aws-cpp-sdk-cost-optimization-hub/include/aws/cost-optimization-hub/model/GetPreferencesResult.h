...
class GetPreferencesResult {
 public:
  ...
  inline GetPreferencesResult& WithSavingsEstimationMode(SavingsEstimationMode value) {
  ...
  inline GetPreferencesResult& WithMemberAccountDiscountVisibility(MemberAccountDiscountVisibility value) {
  ...
  template <typename PreferredCommitmentT = PreferredCommitment>
  GetPreferencesResult& WithPreferredCommitment(PreferredCommitmentT&& value) {
