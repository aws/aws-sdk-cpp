...
class UpdatePreferencesRequest : public CostOptimizationHubRequest {
 public:
  ...
  inline UpdatePreferencesRequest& WithSavingsEstimationMode(SavingsEstimationMode value) {
  ...
  inline UpdatePreferencesRequest& WithMemberAccountDiscountVisibility(MemberAccountDiscountVisibility value) {
