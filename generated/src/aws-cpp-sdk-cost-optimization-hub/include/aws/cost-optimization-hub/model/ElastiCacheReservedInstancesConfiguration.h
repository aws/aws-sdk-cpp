...
namespace Model
{
  ...
  {
  public:
    AWS_COSTOPTIMIZATIONHUB_API ElastiCacheReservedInstancesConfiguration();
     ...
     * <p>How much purchasing this instance costs you upfront.</p>
     */
    inline ElastiCacheReservedInstancesConfiguration& WithUpfrontCost(const char* value) { SetUpfrontCost(value); return *this;}
