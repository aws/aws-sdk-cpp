...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/ElastiCacheReservedInstancesConfiguration">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    template<typename AccountScopeT = Aws::String>
    ElastiCacheReservedInstancesConfiguration& WithAccountScope(AccountScopeT&& value) { SetAccountScope(std::forward<AccountScopeT>(value)); return *this;}
    ///@}
    ...
    template<typename TermT = Aws::String>
    ElastiCacheReservedInstancesConfiguration& WithTerm(TermT&& value) { SetTerm(std::forward<TermT>(value)); return *this;}
    ///@}
    ...
    template<typename NumberOfInstancesToPurchaseT = Aws::String>
    ElastiCacheReservedInstancesConfiguration& WithNumberOfInstancesToPurchase(NumberOfInstancesToPurchaseT&& value) { SetNumberOfInstancesToPurchase(std::forward<NumberOfInstancesToPurchaseT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceFamilyT = Aws::String>
    ElastiCacheReservedInstancesConfiguration& WithInstanceFamily(InstanceFamilyT&& value) { SetInstanceFamily(std::forward<InstanceFamilyT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceTypeT = Aws::String>
    ElastiCacheReservedInstancesConfiguration& WithInstanceType(InstanceTypeT&& value) { SetInstanceType(std::forward<InstanceTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename CurrentGenerationT = Aws::String>
    ElastiCacheReservedInstancesConfiguration& WithCurrentGeneration(CurrentGenerationT&& value) { SetCurrentGeneration(std::forward<CurrentGenerationT>(value)); return *this;}
    ///@}
