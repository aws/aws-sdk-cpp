...
class SavingsPlansPricing {
 public:
  ...
  inline void SetMonthlySavingsPlansEligibleCost(double value) {
    m_monthlySavingsPlansEligibleCostHasBeenSet = true;
    m_monthlySavingsPlansEligibleCost = value;
  }
  inline SavingsPlansPricing& WithMonthlySavingsPlansEligibleCost(double value) {
    SetMonthlySavingsPlansEligibleCost(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEstimatedMonthlyCommitment(double value) {
    m_estimatedMonthlyCommitmentHasBeenSet = true;
    m_estimatedMonthlyCommitment = value;
  }
  inline SavingsPlansPricing& WithEstimatedMonthlyCommitment(double value) {
    SetEstimatedMonthlyCommitment(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSavingsPercentage(double value) {
    m_savingsPercentageHasBeenSet = true;
    m_savingsPercentage = value;
  }
  inline SavingsPlansPricing& WithSavingsPercentage(double value) {
  ...
  inline void SetEstimatedOnDemandCost(double value) {
    m_estimatedOnDemandCostHasBeenSet = true;
    m_estimatedOnDemandCost = value;
  }
  inline SavingsPlansPricing& WithEstimatedOnDemandCost(double value) {
    SetEstimatedOnDemandCost(value);
    return *this;
  }
  ///@}
 private:
