...
class RdsDbInstanceStorageConfiguration {
 public:
  ...
  inline void SetAllocatedStorageInGb(double value) {
    m_allocatedStorageInGbHasBeenSet = true;
    m_allocatedStorageInGb = value;
  }
  inline RdsDbInstanceStorageConfiguration& WithAllocatedStorageInGb(double value) {
    SetAllocatedStorageInGb(value);
    return *this;
  }
  ///@}
  ...
  inline RdsDbInstanceStorageConfiguration& WithIops(double value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStorageThroughput(double value) {
    m_storageThroughputHasBeenSet = true;
    m_storageThroughput = value;
  }
  inline RdsDbInstanceStorageConfiguration& WithStorageThroughput(double value) {
