...
class ReservedInstancesPricing {
 public:
  ...
  inline ReservedInstancesPricing& WithEstimatedOnDemandCost(double value) {
  ...
  inline void SetMonthlyReservationEligibleCost(double value) {
    m_monthlyReservationEligibleCostHasBeenSet = true;
    m_monthlyReservationEligibleCost = value;
  }
  inline ReservedInstancesPricing& WithMonthlyReservationEligibleCost(double value) {
    SetMonthlyReservationEligibleCost(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstancesPricing& WithSavingsPercentage(double value) {
  ...
  inline void SetEstimatedMonthlyAmortizedReservationCost(double value) {
    m_estimatedMonthlyAmortizedReservationCostHasBeenSet = true;
    m_estimatedMonthlyAmortizedReservationCost = value;
  }
  inline ReservedInstancesPricing& WithEstimatedMonthlyAmortizedReservationCost(double value) {
    SetEstimatedMonthlyAmortizedReservationCost(value);
    return *this;
  }
  ///@}
 private:
