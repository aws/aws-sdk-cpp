...
class Recommendation {
 public:
  ...
  void SetCurrentResourceType(CurrentResourceTypeT&& value) {
    ...
    m_currentResourceType = std::forward<CurrentResourceTypeT>(value);
  }
  template <typename CurrentResourceTypeT = Aws::String>
  Recommendation& WithCurrentResourceType(CurrentResourceTypeT&& value) {
    SetCurrentResourceType(std::forward<CurrentResourceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecommendedResourceType(RecommendedResourceTypeT&& value) {
    ...
    m_recommendedResourceType = std::forward<RecommendedResourceTypeT>(value);
  }
  template <typename RecommendedResourceTypeT = Aws::String>
  Recommendation& WithRecommendedResourceType(RecommendedResourceTypeT&& value) {
    SetRecommendedResourceType(std::forward<RecommendedResourceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline Recommendation& WithEstimatedMonthlySavings(double value) {
  ...
  inline Recommendation& WithEstimatedSavingsPercentage(double value) {
  ...
  inline Recommendation& WithEstimatedMonthlyCost(double value) {
  ...
  void SetImplementationEffort(ImplementationEffortT&& value) {
    ...
    m_implementationEffort = std::forward<ImplementationEffortT>(value);
  }
  template <typename ImplementationEffortT = Aws::String>
  Recommendation& WithImplementationEffort(ImplementationEffortT&& value) {
    SetImplementationEffort(std::forward<ImplementationEffortT>(value));
    return *this;
  }
  ///@}
  ...
  inline Recommendation& WithRestartNeeded(bool value) {
  ...
  inline Recommendation& WithRollbackPossible(bool value) {
  ...
  inline Recommendation& WithRecommendationLookbackPeriodInDays(int value) {
  ...
  inline Recommendation& WithSource(Source value) {
    SetSource(value);
    return *this;
  }
  ///@}
