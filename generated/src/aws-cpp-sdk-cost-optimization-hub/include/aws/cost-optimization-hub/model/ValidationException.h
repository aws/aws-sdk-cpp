...
class ValidationException {
 public:
  AWS_COSTOPTIMIZATIONHUB_API ValidationException() = default;
  ...
  template <typename FieldsT = Aws::Vector<ValidationExceptionDetail>>
  ...
  template <typename FieldsT = ValidationExceptionDetail>
