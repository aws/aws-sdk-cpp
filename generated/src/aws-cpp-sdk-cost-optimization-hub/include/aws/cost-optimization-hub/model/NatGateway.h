...
/**
 * <p>The NAT Gateway recommendation details.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/NatGateway">AWS
 * API Reference</a></p>
 */
class NatGateway {
 public:
  AWS_COSTOPTIMIZATIONHUB_API NatGateway() = default;
  AWS_COSTOPTIMIZATIONHUB_API NatGateway(Aws::Utils::Json::JsonView jsonValue);
  AWS_COSTOPTIMIZATIONHUB_API NatGateway& operator=(Aws::Utils::Json::JsonView jsonValue);
   ...
   */
  inline const NatGatewayConfiguration& GetConfiguration() const { return m_configuration; }
  inline bool ConfigurationHasBeenSet() const { return m_configurationHasBeenSet; }
  template <typename ConfigurationT = NatGatewayConfiguration>
  void SetConfiguration(ConfigurationT&& value) {
    m_configurationHasBeenSet = true;
    m_configuration = std::forward<ConfigurationT>(value);
  }
  template <typename ConfigurationT = NatGatewayConfiguration>
  NatGateway& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename CostCalculationT = ResourceCostCalculation>
  NatGateway& WithCostCalculation(CostCalculationT&& value) {
