...
class DynamoDbReservedCapacityConfiguration {
 public:
  ...
  void SetNumberOfCapacityUnitsToPurchase(NumberOfCapacityUnitsToPurchaseT&& value) {
    ...
    m_numberOfCapacityUnitsToPurchase = std::forward<NumberOfCapacityUnitsToPurchaseT>(value);
  }
  template <typename NumberOfCapacityUnitsToPurchaseT = Aws::String>
  DynamoDbReservedCapacityConfiguration& WithNumberOfCapacityUnitsToPurchase(NumberOfCapacityUnitsToPurchaseT&& value) {
    SetNumberOfCapacityUnitsToPurchase(std::forward<NumberOfCapacityUnitsToPurchaseT>(value));
    return *this;
  }
  ///@}
