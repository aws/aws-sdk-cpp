...
class RecommendationSummary {
 public:
  ...
  inline RecommendationSummary& WithEstimatedMonthlySavings(double value) {
  ...
  inline void SetRecommendationCount(int value) {
    m_recommendationCountHasBeenSet = true;
    m_recommendationCount = value;
  }
  inline RecommendationSummary& WithRecommendationCount(int value) {
