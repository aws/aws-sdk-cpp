...
class ListRecommendationSummariesRequest : public CostOptimizationHubRequest {
 public:
  ...
  template <typename FilterT = Filter>
  ListRecommendationSummariesRequest& WithFilter(FilterT&& value) {
  ...
  template <typename GroupByT = Aws::String>
  ListRecommendationSummariesRequest& WithGroupBy(GroupByT&& value) {
  ...
  inline ListRecommendationSummariesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricsT = Aws::Vector<SummaryMetrics>>
  ListRecommendationSummariesRequest& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  inline ListRecommendationSummariesRequest& AddMetrics(SummaryMetrics value) {
    m_metricsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRecommendationSummariesRequest& WithNextToken(NextTokenT&& value) {
