...
class DescribeTargetedSentimentDetectionJobResult {
 public:
  ...
  AWS_COMPREHEND_API DescribeTargetedSentimentDetectionJobResult& operator=(
   ...
   * detection job.</p>
   */
  inline const TargetedSentimentDetectionJobProperties& GetTargetedSentimentDetectionJobProperties() const {
    return m_targetedSentimentDetectionJobProperties;
  }
  ...
  void SetTargetedSentimentDetectionJobProperties(TargetedSentimentDetectionJobPropertiesT&& value) {
    ...
    m_targetedSentimentDetectionJobProperties = std::forward<TargetedSentimentDetectionJobPropertiesT>(value);
  }
  template <typename TargetedSentimentDetectionJobPropertiesT = TargetedSentimentDetectionJobProperties>
  DescribeTargetedSentimentDetectionJobResult& WithTargetedSentimentDetectionJobProperties(
      TargetedSentimentDetectionJobPropertiesT&& value) {
    SetTargetedSentimentDetectionJobProperties(std::forward<TargetedSentimentDetectionJobPropertiesT>(value));
    return *this;
  }
  ///@}
