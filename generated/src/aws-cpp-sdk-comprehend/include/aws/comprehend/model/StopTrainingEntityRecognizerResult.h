...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHEND_API StopTrainingEntityRecognizerResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StopTrainingEntityRecognizerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
