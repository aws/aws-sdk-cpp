...
class StartPiiEntitiesDetectionJobRequest : public ComprehendRequest {
 public:
  ...
  inline StartPiiEntitiesDetectionJobRequest& WithMode(PiiEntitiesDetectionMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline StartPiiEntitiesDetectionJobRequest& WithLanguageCode(LanguageCode value) {
