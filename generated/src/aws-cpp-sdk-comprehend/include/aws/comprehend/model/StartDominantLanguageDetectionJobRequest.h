...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHEND_API StartDominantLanguageDetectionJobRequest() = default;
    ...
    template<typename InputDataConfigT = InputDataConfig>
    StartDominantLanguageDetectionJobRequest& WithInputDataConfig(InputDataConfigT&& value) { SetInputDataConfig(std::forward<InputDataConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename OutputDataConfigT = OutputDataConfig>
    StartDominantLanguageDetectionJobRequest& WithOutputDataConfig(OutputDataConfigT&& value) { SetOutputDataConfig(std::forward<OutputDataConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename DataAccessRoleArnT = Aws::String>
    StartDominantLanguageDetectionJobRequest& WithDataAccessRoleArn(DataAccessRoleArnT&& value) { SetDataAccessRoleArn(std::forward<DataAccessRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename JobNameT = Aws::String>
    StartDominantLanguageDetectionJobRequest& WithJobName(JobNameT&& value) { SetJobName(std::forward<JobNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientRequestTokenT = Aws::String>
    StartDominantLanguageDetectionJobRequest& WithClientRequestToken(ClientRequestTokenT&& value) { SetClientRequestToken(std::forward<ClientRequestTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename VolumeKmsKeyIdT = Aws::String>
    StartDominantLanguageDetectionJobRequest& WithVolumeKmsKeyId(VolumeKmsKeyIdT&& value) { SetVolumeKmsKeyId(std::forward<VolumeKmsKeyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcConfigT = VpcConfig>
    StartDominantLanguageDetectionJobRequest& WithVpcConfig(VpcConfigT&& value) { SetVpcConfig(std::forward<VpcConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Vector<Tag>>
    StartDominantLanguageDetectionJobRequest& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsT = Tag>
    StartDominantLanguageDetectionJobRequest& AddTags(TagsT&& value) { m_tagsHasBeenSet = true; m_tags.emplace_back(std::forward<TagsT>(value)); return *this; }
    ///@}
  private:
