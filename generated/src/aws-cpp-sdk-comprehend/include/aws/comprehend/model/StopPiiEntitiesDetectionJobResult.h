...
class StopPiiEntitiesDetectionJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  StopPiiEntitiesDetectionJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StopPiiEntitiesDetectionJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopPiiEntitiesDetectionJobResult& WithRequestId(RequestIdT&& value) {
