...
class ListDocumentClassificationJobsRequest : public ComprehendRequest {
 public:
  ...
  template <typename FilterT = DocumentClassificationJobFilter>
  ListDocumentClassificationJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDocumentClassificationJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDocumentClassificationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
