...
class ListFlywheelsResult {
 public:
  ...
  void SetFlywheelSummaryList(FlywheelSummaryListT&& value) {
    ...
    m_flywheelSummaryList = std::forward<FlywheelSummaryListT>(value);
  }
  template <typename FlywheelSummaryListT = Aws::Vector<FlywheelSummary>>
  ListFlywheelsResult& WithFlywheelSummaryList(FlywheelSummaryListT&& value) {
    SetFlywheelSummaryList(std::forward<FlywheelSummaryListT>(value));
    return *this;
  }
  ...
  ListFlywheelsResult& AddFlywheelSummaryList(FlywheelSummaryListT&& value) {
    m_flywheelSummaryListHasBeenSet = true;
    m_flywheelSummaryList.emplace_back(std::forward<FlywheelSummaryListT>(value));
    return *this;
  }
  ///@}
