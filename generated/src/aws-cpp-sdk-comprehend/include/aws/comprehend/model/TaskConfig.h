...
class TaskConfig {
 public:
  ...
  inline TaskConfig& WithLanguageCode(LanguageCode value) {
  ...
  void SetDocumentClassificationConfig(DocumentClassificationConfigT&& value) {
    m_documentClassificationConfigHasBeenSet = true;
    m_documentClassificationConfig = std::forward<DocumentClassificationConfigT>(value);
  }
  template <typename DocumentClassificationConfigT = DocumentClassificationConfig>
  TaskConfig& WithDocumentClassificationConfig(DocumentClassificationConfigT&& value) {
    SetDocumentClassificationConfig(std::forward<DocumentClassificationConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEntityRecognitionConfig(EntityRecognitionConfigT&& value) {
    m_entityRecognitionConfigHasBeenSet = true;
    m_entityRecognitionConfig = std::forward<EntityRecognitionConfigT>(value);
  }
  template <typename EntityRecognitionConfigT = EntityRecognitionConfig>
  TaskConfig& WithEntityRecognitionConfig(EntityRecognitionConfigT&& value) {
    SetEntityRecognitionConfig(std::forward<EntityRecognitionConfigT>(value));
    return *this;
  }
  ///@}
 private:
