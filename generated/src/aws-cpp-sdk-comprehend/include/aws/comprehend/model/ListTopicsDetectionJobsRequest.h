...
class ListTopicsDetectionJobsRequest : public ComprehendRequest {
 public:
  ...
  template <typename FilterT = TopicsDetectionJobFilter>
  ListTopicsDetectionJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTopicsDetectionJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTopicsDetectionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
