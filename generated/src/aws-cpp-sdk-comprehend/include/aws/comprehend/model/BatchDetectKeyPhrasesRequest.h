...
class BatchDetectKeyPhrasesRequest : public ComprehendRequest {
 public:
  ...
  void SetTextList(TextListT&& value) {
    ...
    m_textList = std::forward<TextListT>(value);
  }
  template <typename TextListT = Aws::Vector<Aws::String>>
  BatchDetectKeyPhrasesRequest& WithTextList(TextListT&& value) {
    SetTextList(std::forward<TextListT>(value));
    return *this;
  }
  template <typename TextListT = Aws::String>
  BatchDetectKeyPhrasesRequest& AddTextList(TextListT&& value) {
    m_textListHasBeenSet = true;
    m_textList.emplace_back(std::forward<TextListT>(value));
    return *this;
  }
  ///@}
  ...
  inline BatchDetectKeyPhrasesRequest& WithLanguageCode(LanguageCode value) {
