...
class DescribeEndpointResult {
 public:
  ...
  void SetEndpointProperties(EndpointPropertiesT&& value) {
    m_endpointPropertiesHasBeenSet = true;
    m_endpointProperties = std::forward<EndpointPropertiesT>(value);
  }
  template <typename EndpointPropertiesT = EndpointProperties>
  DescribeEndpointResult& WithEndpointProperties(EndpointPropertiesT&& value) {
    SetEndpointProperties(std::forward<EndpointPropertiesT>(value));
    return *this;
  }
  ///@}
