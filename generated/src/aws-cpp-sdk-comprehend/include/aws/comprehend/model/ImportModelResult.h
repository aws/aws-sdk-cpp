...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHEND_API ImportModelResult() = default;
    ...
    template<typename ModelArnT = Aws::String>
    ImportModelResult& WithModelArn(ModelArnT&& value) { SetModelArn(std::forward<ModelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ImportModelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
