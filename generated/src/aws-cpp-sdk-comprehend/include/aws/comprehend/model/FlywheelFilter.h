...
class FlywheelFilter {
 public:
  ...
  inline FlywheelFilter& WithStatus(FlywheelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  FlywheelFilter& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  FlywheelFilter& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
