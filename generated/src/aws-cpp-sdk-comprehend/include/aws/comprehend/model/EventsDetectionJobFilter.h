...
/**
 * <p>Provides information for filtering a list of event detection
 * jobs.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/EventsDetectionJobFilter">AWS
 * API Reference</a></p>
 */
class EventsDetectionJobFilter {
 public:
  ...
  template <typename JobNameT = Aws::String>
  EventsDetectionJobFilter& WithJobName(JobNameT&& value) {
  ...
  inline EventsDetectionJobFilter& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubmitTimeBeforeT = Aws::Utils::DateTime>
  EventsDetectionJobFilter& WithSubmitTimeBefore(SubmitTimeBeforeT&& value) {
  ...
  template <typename SubmitTimeAfterT = Aws::Utils::DateTime>
  EventsDetectionJobFilter& WithSubmitTimeAfter(SubmitTimeAfterT&& value) {
