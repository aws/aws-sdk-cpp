...
namespace Model
{
  ...
  public:
     ...
     * identifier with the <code>DescribeTopicDetectionJob</code> operation.</p>
     */
     ...
     * <code>DescribeTopicDetectionJob</code> operation.</p> </li> </ul>
     */
     ...
     * <code>DescribeTopicDetectionJob</code> operation.</p> </li> </ul>
     */
    inline StartTopicsDetectionJobResult& WithJobStatus(JobStatus&& value) { SetJobStatus(std::move(value)); return *this;}
    ...
    inline StartTopicsDetectionJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartTopicsDetectionJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartTopicsDetectionJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
