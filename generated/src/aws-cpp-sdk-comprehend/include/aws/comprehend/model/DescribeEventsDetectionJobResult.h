...
class DescribeEventsDetectionJobResult {
 public:
  ...
  void SetEventsDetectionJobProperties(EventsDetectionJobPropertiesT&& value) {
    m_eventsDetectionJobPropertiesHasBeenSet = true;
    m_eventsDetectionJobProperties = std::forward<EventsDetectionJobPropertiesT>(value);
  }
  template <typename EventsDetectionJobPropertiesT = EventsDetectionJobProperties>
  DescribeEventsDetectionJobResult& WithEventsDetectionJobProperties(EventsDetectionJobPropertiesT&& value) {
    SetEventsDetectionJobProperties(std::forward<EventsDetectionJobPropertiesT>(value));
    return *this;
  }
  ///@}
