...
class BatchDetectEntitiesResult {
 public:
  ...
  template <typename ResultListT = Aws::Vector<BatchDetectEntitiesItemResult>>
  BatchDetectEntitiesResult& WithResultList(ResultListT&& value) {
    SetResultList(std::forward<ResultListT>(value));
    return *this;
  }
  template <typename ResultListT = BatchDetectEntitiesItemResult>
  BatchDetectEntitiesResult& AddResultList(ResultListT&& value) {
    m_resultListHasBeenSet = true;
  ...
  template <typename ErrorListT = Aws::Vector<BatchItemError>>
  BatchDetectEntitiesResult& WithErrorList(ErrorListT&& value) {
    SetErrorList(std::forward<ErrorListT>(value));
    return *this;
  }
  template <typename ErrorListT = BatchItemError>
  BatchDetectEntitiesResult& AddErrorList(ErrorListT&& value) {
    m_errorListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDetectEntitiesResult& WithRequestId(RequestIdT&& value) {
