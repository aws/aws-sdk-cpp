...
class FlywheelModelEvaluationMetrics {
 public:
  ...
  inline void SetAverageF1Score(double value) {
    m_averageF1ScoreHasBeenSet = true;
    m_averageF1Score = value;
  }
  inline FlywheelModelEvaluationMetrics& WithAverageF1Score(double value) {
    SetAverageF1Score(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAveragePrecision(double value) {
    m_averagePrecisionHasBeenSet = true;
    m_averagePrecision = value;
  }
  inline FlywheelModelEvaluationMetrics& WithAveragePrecision(double value) {
    SetAveragePrecision(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAverageRecall(double value) {
    m_averageRecallHasBeenSet = true;
    m_averageRecall = value;
  }
  inline FlywheelModelEvaluationMetrics& WithAverageRecall(double value) {
    SetAverageRecall(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAverageAccuracy(double value) {
    m_averageAccuracyHasBeenSet = true;
    m_averageAccuracy = value;
  }
  inline FlywheelModelEvaluationMetrics& WithAverageAccuracy(double value) {
    SetAverageAccuracy(value);
    return *this;
  }
  ///@}
 private:
