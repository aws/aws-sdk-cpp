...
class PiiEntitiesDetectionJobFilter {
 public:
  ...
  template <typename JobNameT = Aws::String>
  PiiEntitiesDetectionJobFilter& WithJobName(JobNameT&& value) {
  ...
  inline PiiEntitiesDetectionJobFilter& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubmitTimeBeforeT = Aws::Utils::DateTime>
  PiiEntitiesDetectionJobFilter& WithSubmitTimeBefore(SubmitTimeBeforeT&& value) {
  ...
  template <typename SubmitTimeAfterT = Aws::Utils::DateTime>
  PiiEntitiesDetectionJobFilter& WithSubmitTimeAfter(SubmitTimeAfterT&& value) {
