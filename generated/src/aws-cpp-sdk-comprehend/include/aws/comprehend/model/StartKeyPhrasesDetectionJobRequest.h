...
class StartKeyPhrasesDetectionJobRequest : public ComprehendRequest {
 public:
  ...
  inline StartKeyPhrasesDetectionJobRequest& WithLanguageCode(LanguageCode value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  StartKeyPhrasesDetectionJobRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  StartKeyPhrasesDetectionJobRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
