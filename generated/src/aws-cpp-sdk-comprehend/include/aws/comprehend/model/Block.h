...
class Block {
 public:
  ...
  inline void SetBlockType(BlockType value) {
    m_blockTypeHasBeenSet = true;
    m_blockType = value;
  }
  inline Block& WithBlockType(BlockType value) {
    SetBlockType(value);
    return *this;
  }
  ///@}
  ...
  inline Block& WithPage(int value) {
    SetPage(value);
    return *this;
  }
  ///@}
  ...
  void SetRelationships(RelationshipsT&& value) {
    ...
    m_relationships = std::forward<RelationshipsT>(value);
  }
  template <typename RelationshipsT = Aws::Vector<RelationshipsListItem>>
  Block& WithRelationships(RelationshipsT&& value) {
    SetRelationships(std::forward<RelationshipsT>(value));
    return *this;
  }
  template <typename RelationshipsT = RelationshipsListItem>
  Block& AddRelationships(RelationshipsT&& value) {
    m_relationshipsHasBeenSet = true;
    m_relationships.emplace_back(std::forward<RelationshipsT>(value));
    return *this;
  }
  ///@}
 private:
