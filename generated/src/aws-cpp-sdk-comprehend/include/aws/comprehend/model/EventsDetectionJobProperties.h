...
class EventsDetectionJobProperties {
 public:
  ...
  inline EventsDetectionJobProperties& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline EventsDetectionJobProperties& WithLanguageCode(LanguageCode value) {
