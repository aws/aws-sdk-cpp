...
class KeyPhrasesDetectionJobFilter {
 public:
  ...
  template <typename JobNameT = Aws::String>
  KeyPhrasesDetectionJobFilter& WithJobName(JobNameT&& value) {
  ...
  inline KeyPhrasesDetectionJobFilter& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubmitTimeBeforeT = Aws::Utils::DateTime>
  KeyPhrasesDetectionJobFilter& WithSubmitTimeBefore(SubmitTimeBeforeT&& value) {
  ...
  template <typename SubmitTimeAfterT = Aws::Utils::DateTime>
  KeyPhrasesDetectionJobFilter& WithSubmitTimeAfter(SubmitTimeAfterT&& value) {
