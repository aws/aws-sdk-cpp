...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHEND_API KeyPhrasesDetectionJobFilter() = default;
    ...
    template<typename JobNameT = Aws::String>
    KeyPhrasesDetectionJobFilter& WithJobName(JobNameT&& value) { SetJobName(std::forward<JobNameT>(value)); return *this;}
    ///@}
    ...
    inline KeyPhrasesDetectionJobFilter& WithJobStatus(JobStatus value) { SetJobStatus(value); return *this;}
    ///@}
    ...
    template<typename SubmitTimeBeforeT = Aws::Utils::DateTime>
    KeyPhrasesDetectionJobFilter& WithSubmitTimeBefore(SubmitTimeBeforeT&& value) { SetSubmitTimeBefore(std::forward<SubmitTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename SubmitTimeAfterT = Aws::Utils::DateTime>
    KeyPhrasesDetectionJobFilter& WithSubmitTimeAfter(SubmitTimeAfterT&& value) { SetSubmitTimeAfter(std::forward<SubmitTimeAfterT>(value)); return *this;}
    ///@}
  private:
