...
class ListEntityRecognizersRequest : public ComprehendRequest {
 public:
  ...
  template <typename FilterT = EntityRecognizerFilter>
  ListEntityRecognizersRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListEntityRecognizersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEntityRecognizersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
