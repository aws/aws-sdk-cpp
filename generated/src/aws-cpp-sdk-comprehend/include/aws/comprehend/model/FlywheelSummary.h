...
class FlywheelSummary {
 public:
  ...
  void SetDataLakeS3Uri(DataLakeS3UriT&& value) {
    ...
    m_dataLakeS3Uri = std::forward<DataLakeS3UriT>(value);
  }
  template <typename DataLakeS3UriT = Aws::String>
  FlywheelSummary& WithDataLakeS3Uri(DataLakeS3UriT&& value) {
    SetDataLakeS3Uri(std::forward<DataLakeS3UriT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(FlywheelStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline FlywheelSummary& WithStatus(FlywheelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetModelType(ModelType value) {
    m_modelTypeHasBeenSet = true;
    m_modelType = value;
  }
  inline FlywheelSummary& WithModelType(ModelType value) {
    SetModelType(value);
    return *this;
  }
  ///@}
  ...
  void SetLatestFlywheelIteration(LatestFlywheelIterationT&& value) {
    ...
    m_latestFlywheelIteration = std::forward<LatestFlywheelIterationT>(value);
  }
  template <typename LatestFlywheelIterationT = Aws::String>
  FlywheelSummary& WithLatestFlywheelIteration(LatestFlywheelIterationT&& value) {
    SetLatestFlywheelIteration(std::forward<LatestFlywheelIterationT>(value));
    return *this;
  }
  ///@}
 private:
