...
class StartSentimentDetectionJobRequest : public ComprehendRequest {
 public:
  ...
  inline StartSentimentDetectionJobRequest& WithLanguageCode(LanguageCode value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  StartSentimentDetectionJobRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  StartSentimentDetectionJobRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
