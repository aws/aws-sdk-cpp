...
class StartEntitiesDetectionJobRequest : public ComprehendRequest {
 public:
  ...
  inline StartEntitiesDetectionJobRequest& WithLanguageCode(LanguageCode value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  StartEntitiesDetectionJobRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  StartEntitiesDetectionJobRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
