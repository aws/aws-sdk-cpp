...
class AugmentedManifestsListItem {
 public:
  ...
  inline void SetSplit(Split value) {
    m_splitHasBeenSet = true;
    m_split = value;
  }
  inline AugmentedManifestsListItem& WithSplit(Split value) {
    SetSplit(value);
    return *this;
  }
  ///@}
  ...
  inline AugmentedManifestsListItem& WithDocumentType(AugmentedManifestsDocumentTypeFormat value) {
