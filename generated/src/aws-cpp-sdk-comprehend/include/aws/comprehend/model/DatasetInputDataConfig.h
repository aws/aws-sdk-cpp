...
class DatasetInputDataConfig {
 public:
  ...
  void SetAugmentedManifests(AugmentedManifestsT&& value) {
    ...
    m_augmentedManifests = std::forward<AugmentedManifestsT>(value);
  }
  template <typename AugmentedManifestsT = Aws::Vector<DatasetAugmentedManifestsListItem>>
  DatasetInputDataConfig& WithAugmentedManifests(AugmentedManifestsT&& value) {
    SetAugmentedManifests(std::forward<AugmentedManifestsT>(value));
    return *this;
  }
  ...
  DatasetInputDataConfig& AddAugmentedManifests(AugmentedManifestsT&& value) {
    m_augmentedManifestsHasBeenSet = true;
    m_augmentedManifests.emplace_back(std::forward<AugmentedManifestsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDataFormat(DatasetDataFormat value) {
    m_dataFormatHasBeenSet = true;
    m_dataFormat = value;
  }
  inline DatasetInputDataConfig& WithDataFormat(DatasetDataFormat value) {
    SetDataFormat(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const DatasetDocumentClassifierInputDataConfig& GetDocumentClassifierInputDataConfig() const {
    return m_documentClassifierInputDataConfig;
  }
  ...
  void SetDocumentClassifierInputDataConfig(DocumentClassifierInputDataConfigT&& value) {
    ...
    m_documentClassifierInputDataConfig = std::forward<DocumentClassifierInputDataConfigT>(value);
  }
  template <typename DocumentClassifierInputDataConfigT = DatasetDocumentClassifierInputDataConfig>
  DatasetInputDataConfig& WithDocumentClassifierInputDataConfig(DocumentClassifierInputDataConfigT&& value) {
    SetDocumentClassifierInputDataConfig(std::forward<DocumentClassifierInputDataConfigT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const DatasetEntityRecognizerInputDataConfig& GetEntityRecognizerInputDataConfig() const {
    return m_entityRecognizerInputDataConfig;
  }
  ...
  void SetEntityRecognizerInputDataConfig(EntityRecognizerInputDataConfigT&& value) {
    ...
    m_entityRecognizerInputDataConfig = std::forward<EntityRecognizerInputDataConfigT>(value);
  }
  template <typename EntityRecognizerInputDataConfigT = DatasetEntityRecognizerInputDataConfig>
  DatasetInputDataConfig& WithEntityRecognizerInputDataConfig(EntityRecognizerInputDataConfigT&& value) {
    SetEntityRecognizerInputDataConfig(std::forward<EntityRecognizerInputDataConfigT>(value));
    return *this;
  }
  ///@}
 private:
