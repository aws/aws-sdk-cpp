...
class PiiEntitiesDetectionJobProperties {
 public:
  ...
  inline PiiEntitiesDetectionJobProperties& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRedactionConfig(RedactionConfigT&& value) {
    ...
    m_redactionConfig = std::forward<RedactionConfigT>(value);
  }
  template <typename RedactionConfigT = RedactionConfig>
  PiiEntitiesDetectionJobProperties& WithRedactionConfig(RedactionConfigT&& value) {
    SetRedactionConfig(std::forward<RedactionConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline PiiEntitiesDetectionJobProperties& WithLanguageCode(LanguageCode value) {
  ...
  inline void SetMode(PiiEntitiesDetectionMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline PiiEntitiesDetectionJobProperties& WithMode(PiiEntitiesDetectionMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
