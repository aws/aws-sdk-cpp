...
class ListEntitiesDetectionJobsRequest : public ComprehendRequest {
 public:
  ...
  template <typename FilterT = EntitiesDetectionJobFilter>
  ListEntitiesDetectionJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListEntitiesDetectionJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEntitiesDetectionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
