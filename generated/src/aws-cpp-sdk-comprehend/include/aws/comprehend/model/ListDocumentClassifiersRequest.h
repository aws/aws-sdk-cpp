...
class ListDocumentClassifiersRequest : public ComprehendRequest {
 public:
  ...
  template <typename FilterT = DocumentClassifierFilter>
  ListDocumentClassifiersRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDocumentClassifiersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDocumentClassifiersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
