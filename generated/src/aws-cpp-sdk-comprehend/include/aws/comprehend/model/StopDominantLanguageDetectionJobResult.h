...
class StopDominantLanguageDetectionJobResult {
 public:
  ...
  AWS_COMPREHEND_API StopDominantLanguageDetectionJobResult& operator=(
  ...
  template <typename JobIdT = Aws::String>
  StopDominantLanguageDetectionJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StopDominantLanguageDetectionJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopDominantLanguageDetectionJobResult& WithRequestId(RequestIdT&& value) {
