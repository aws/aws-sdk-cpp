...
class DetectToxicContentRequest : public ComprehendRequest {
 public:
  ...
  void SetTextSegments(TextSegmentsT&& value) {
    m_textSegmentsHasBeenSet = true;
    m_textSegments = std::forward<TextSegmentsT>(value);
  }
  template <typename TextSegmentsT = Aws::Vector<TextSegment>>
  DetectToxicContentRequest& WithTextSegments(TextSegmentsT&& value) {
    SetTextSegments(std::forward<TextSegmentsT>(value));
    return *this;
  }
  template <typename TextSegmentsT = TextSegment>
  DetectToxicContentRequest& AddTextSegments(TextSegmentsT&& value) {
    m_textSegmentsHasBeenSet = true;
    m_textSegments.emplace_back(std::forward<TextSegmentsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DetectToxicContentRequest& WithLanguageCode(LanguageCode value) {
