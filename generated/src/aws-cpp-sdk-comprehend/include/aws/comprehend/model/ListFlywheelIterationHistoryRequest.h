...
class ListFlywheelIterationHistoryRequest : public ComprehendRequest {
 public:
  ...
  template <typename FlywheelArnT = Aws::String>
  ListFlywheelIterationHistoryRequest& WithFlywheelArn(FlywheelArnT&& value) {
  ...
  template <typename FilterT = FlywheelIterationFilter>
  ListFlywheelIterationHistoryRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListFlywheelIterationHistoryRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFlywheelIterationHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
