...
class DatasetFilter {
 public:
  ...
  inline DatasetFilter& WithStatus(DatasetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DatasetFilter& WithDatasetType(DatasetType value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  DatasetFilter& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  DatasetFilter& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
