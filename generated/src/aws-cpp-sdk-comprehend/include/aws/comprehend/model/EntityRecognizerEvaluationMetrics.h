...
class EntityRecognizerEvaluationMetrics {
 public:
  ...
  inline EntityRecognizerEvaluationMetrics& WithPrecision(double value) {
    SetPrecision(value);
    return *this;
  }
  ///@}
  ...
  inline EntityRecognizerEvaluationMetrics& WithRecall(double value) {
    SetRecall(value);
    return *this;
  }
  ///@}
  ...
  inline EntityRecognizerEvaluationMetrics& WithF1Score(double value) {
    SetF1Score(value);
    return *this;
  }
  ///@}
