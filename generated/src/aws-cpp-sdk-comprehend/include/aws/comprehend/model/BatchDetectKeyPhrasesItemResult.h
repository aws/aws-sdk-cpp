...
class BatchDetectKeyPhrasesItemResult {
 public:
  ...
  inline BatchDetectKeyPhrasesItemResult& WithIndex(int value) {
    SetIndex(value);
    return *this;
  }
  ///@}
