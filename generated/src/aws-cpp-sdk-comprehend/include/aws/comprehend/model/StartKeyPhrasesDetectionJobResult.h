...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHEND_API StartKeyPhrasesDetectionJobResult();
    ...
    inline StartKeyPhrasesDetectionJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartKeyPhrasesDetectionJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartKeyPhrasesDetectionJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
