...
class StartKeyPhrasesDetectionJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  StartKeyPhrasesDetectionJobResult& WithJobId(JobIdT&& value) {
  ...
  template <typename JobArnT = Aws::String>
  StartKeyPhrasesDetectionJobResult& WithJobArn(JobArnT&& value) {
  ...
  inline StartKeyPhrasesDetectionJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartKeyPhrasesDetectionJobResult& WithRequestId(RequestIdT&& value) {
