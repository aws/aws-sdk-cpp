...
class TopicsDetectionJobFilter {
 public:
  ...
  template <typename JobNameT = Aws::String>
  TopicsDetectionJobFilter& WithJobName(JobNameT&& value) {
  ...
  inline TopicsDetectionJobFilter& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubmitTimeBeforeT = Aws::Utils::DateTime>
  TopicsDetectionJobFilter& WithSubmitTimeBefore(SubmitTimeBeforeT&& value) {
  ...
  template <typename SubmitTimeAfterT = Aws::Utils::DateTime>
  TopicsDetectionJobFilter& WithSubmitTimeAfter(SubmitTimeAfterT&& value) {
