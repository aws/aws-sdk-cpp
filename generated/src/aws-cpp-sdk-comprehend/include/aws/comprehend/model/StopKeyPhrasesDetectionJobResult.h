...
class StopKeyPhrasesDetectionJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  StopKeyPhrasesDetectionJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StopKeyPhrasesDetectionJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopKeyPhrasesDetectionJobResult& WithRequestId(RequestIdT&& value) {
