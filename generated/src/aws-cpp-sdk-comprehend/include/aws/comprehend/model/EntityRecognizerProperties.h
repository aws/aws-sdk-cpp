...
class EntityRecognizerProperties {
 public:
  ...
  inline EntityRecognizerProperties& WithLanguageCode(LanguageCode value) {
  ...
  inline EntityRecognizerProperties& WithStatus(ModelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRecognizerMetadata(RecognizerMetadataT&& value) {
    ...
    m_recognizerMetadata = std::forward<RecognizerMetadataT>(value);
  }
  template <typename RecognizerMetadataT = EntityRecognizerMetadata>
  EntityRecognizerProperties& WithRecognizerMetadata(RecognizerMetadataT&& value) {
    SetRecognizerMetadata(std::forward<RecognizerMetadataT>(value));
    return *this;
  }
  ///@}
