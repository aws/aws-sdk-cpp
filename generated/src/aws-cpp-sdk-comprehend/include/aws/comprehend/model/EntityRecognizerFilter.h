...
class EntityRecognizerFilter {
 public:
  ...
  inline EntityRecognizerFilter& WithStatus(ModelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRecognizerName(RecognizerNameT&& value) {
    ...
    m_recognizerName = std::forward<RecognizerNameT>(value);
  }
  template <typename RecognizerNameT = Aws::String>
  EntityRecognizerFilter& WithRecognizerName(RecognizerNameT&& value) {
    SetRecognizerName(std::forward<RecognizerNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SubmitTimeBeforeT = Aws::Utils::DateTime>
  EntityRecognizerFilter& WithSubmitTimeBefore(SubmitTimeBeforeT&& value) {
  ...
  template <typename SubmitTimeAfterT = Aws::Utils::DateTime>
  EntityRecognizerFilter& WithSubmitTimeAfter(SubmitTimeAfterT&& value) {
