...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHEND_API DominantLanguageDetectionJobFilter() = default;
    ...
    template<typename JobNameT = Aws::String>
    DominantLanguageDetectionJobFilter& WithJobName(JobNameT&& value) { SetJobName(std::forward<JobNameT>(value)); return *this;}
    ///@}
    ...
    inline DominantLanguageDetectionJobFilter& WithJobStatus(JobStatus value) { SetJobStatus(value); return *this;}
    ///@}
    ...
    template<typename SubmitTimeBeforeT = Aws::Utils::DateTime>
    DominantLanguageDetectionJobFilter& WithSubmitTimeBefore(SubmitTimeBeforeT&& value) { SetSubmitTimeBefore(std::forward<SubmitTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename SubmitTimeAfterT = Aws::Utils::DateTime>
    DominantLanguageDetectionJobFilter& WithSubmitTimeAfter(SubmitTimeAfterT&& value) { SetSubmitTimeAfter(std::forward<SubmitTimeAfterT>(value)); return *this;}
    ///@}
  private:
