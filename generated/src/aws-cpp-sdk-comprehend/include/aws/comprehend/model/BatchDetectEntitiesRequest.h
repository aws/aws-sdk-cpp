...
class BatchDetectEntitiesRequest : public ComprehendRequest {
 public:
  ...
  template <typename TextListT = Aws::Vector<Aws::String>>
  BatchDetectEntitiesRequest& WithTextList(TextListT&& value) {
    SetTextList(std::forward<TextListT>(value));
    return *this;
  }
  template <typename TextListT = Aws::String>
  BatchDetectEntitiesRequest& AddTextList(TextListT&& value) {
    m_textListHasBeenSet = true;
  ...
  inline BatchDetectEntitiesRequest& WithLanguageCode(LanguageCode value) {
