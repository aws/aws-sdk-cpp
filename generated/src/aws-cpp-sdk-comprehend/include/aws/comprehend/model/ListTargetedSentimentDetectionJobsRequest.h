...
class ListTargetedSentimentDetectionJobsRequest : public ComprehendRequest {
 public:
  ...
  template <typename FilterT = TargetedSentimentDetectionJobFilter>
  ListTargetedSentimentDetectionJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTargetedSentimentDetectionJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTargetedSentimentDetectionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
