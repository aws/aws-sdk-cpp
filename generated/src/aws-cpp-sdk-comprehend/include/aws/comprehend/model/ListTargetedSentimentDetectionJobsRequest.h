...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHEND_API ListTargetedSentimentDetectionJobsRequest() = default;
    ...
    template<typename FilterT = TargetedSentimentDetectionJobFilter>
    void SetFilter(FilterT&& value) { m_filterHasBeenSet = true; m_filter = std::forward<FilterT>(value); }
    template<typename FilterT = TargetedSentimentDetectionJobFilter>
    ListTargetedSentimentDetectionJobsRequest& WithFilter(FilterT&& value) { SetFilter(std::forward<FilterT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListTargetedSentimentDetectionJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
