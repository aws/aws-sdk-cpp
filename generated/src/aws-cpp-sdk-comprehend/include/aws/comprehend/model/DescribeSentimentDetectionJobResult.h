...
class DescribeSentimentDetectionJobResult {
 public:
  ...
  void SetSentimentDetectionJobProperties(SentimentDetectionJobPropertiesT&& value) {
    m_sentimentDetectionJobPropertiesHasBeenSet = true;
    m_sentimentDetectionJobProperties = std::forward<SentimentDetectionJobPropertiesT>(value);
  }
  template <typename SentimentDetectionJobPropertiesT = SentimentDetectionJobProperties>
  DescribeSentimentDetectionJobResult& WithSentimentDetectionJobProperties(SentimentDetectionJobPropertiesT&& value) {
    SetSentimentDetectionJobProperties(std::forward<SentimentDetectionJobPropertiesT>(value));
    return *this;
  }
  ///@}
