...
namespace Model
{
  ...
  public:
    ...
    inline DeleteEntityRecognizerResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteEntityRecognizerResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteEntityRecognizerResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
