...
namespace Model
{
  ...
  public:
    ...
    inline DeleteDocumentClassifierResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteDocumentClassifierResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteDocumentClassifierResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
