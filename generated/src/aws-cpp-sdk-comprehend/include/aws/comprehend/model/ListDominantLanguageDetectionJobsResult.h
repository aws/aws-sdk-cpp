...
namespace Model
{
  ...
  public:
    ...
    void SetDominantLanguageDetectionJobPropertiesList(DominantLanguageDetectionJobPropertiesListT&& value) { m_dominantLanguageDetectionJobPropertiesListHasBeenSet = true; m_dominantLanguageDetectionJobPropertiesList = std::forward<DominantLanguageDetectionJobPropertiesListT>(value); }
    template<typename DominantLanguageDetectionJobPropertiesListT = Aws::Vector<DominantLanguageDetectionJobProperties>>
    ListDominantLanguageDetectionJobsResult& WithDominantLanguageDetectionJobPropertiesList(DominantLanguageDetectionJobPropertiesListT&& value) { SetDominantLanguageDetectionJobPropertiesList(std::forward<DominantLanguageDetectionJobPropertiesListT>(value)); return *this;}
    template<typename DominantLanguageDetectionJobPropertiesListT = DominantLanguageDetectionJobProperties>
    ListDominantLanguageDetectionJobsResult& AddDominantLanguageDetectionJobPropertiesList(DominantLanguageDetectionJobPropertiesListT&& value) { m_dominantLanguageDetectionJobPropertiesListHasBeenSet = true; m_dominantLanguageDetectionJobPropertiesList.emplace_back(std::forward<DominantLanguageDetectionJobPropertiesListT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListDominantLanguageDetectionJobsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListDominantLanguageDetectionJobsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
