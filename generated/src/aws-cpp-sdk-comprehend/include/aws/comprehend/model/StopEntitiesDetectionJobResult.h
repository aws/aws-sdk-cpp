...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHEND_API StopEntitiesDetectionJobResult() = default;
    ...
    template<typename JobIdT = Aws::String>
    StopEntitiesDetectionJobResult& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    inline StopEntitiesDetectionJobResult& WithJobStatus(JobStatus value) { SetJobStatus(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StopEntitiesDetectionJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
