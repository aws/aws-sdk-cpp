...
class StopEntitiesDetectionJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  StopEntitiesDetectionJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StopEntitiesDetectionJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopEntitiesDetectionJobResult& WithRequestId(RequestIdT&& value) {
