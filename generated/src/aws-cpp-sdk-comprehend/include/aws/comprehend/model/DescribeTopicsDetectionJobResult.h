...
class DescribeTopicsDetectionJobResult {
 public:
  ...
  void SetTopicsDetectionJobProperties(TopicsDetectionJobPropertiesT&& value) {
    m_topicsDetectionJobPropertiesHasBeenSet = true;
    m_topicsDetectionJobProperties = std::forward<TopicsDetectionJobPropertiesT>(value);
  }
  template <typename TopicsDetectionJobPropertiesT = TopicsDetectionJobProperties>
  DescribeTopicsDetectionJobResult& WithTopicsDetectionJobProperties(TopicsDetectionJobPropertiesT&& value) {
    SetTopicsDetectionJobProperties(std::forward<TopicsDetectionJobPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTopicsDetectionJobResult& WithRequestId(RequestIdT&& value) {
