...
class RedactionConfig {
 public:
  ...
  inline RedactionConfig& AddPiiEntityTypes(PiiEntityType value) {
    m_piiEntityTypesHasBeenSet = true;
  ...
  inline void SetMaskMode(PiiEntitiesDetectionMaskMode value) {
    m_maskModeHasBeenSet = true;
    m_maskMode = value;
  }
  inline RedactionConfig& WithMaskMode(PiiEntitiesDetectionMaskMode value) {
    SetMaskMode(value);
    return *this;
  }
  ///@}
  ...
  void SetMaskCharacter(MaskCharacterT&& value) {
    ...
    m_maskCharacter = std::forward<MaskCharacterT>(value);
  }
  template <typename MaskCharacterT = Aws::String>
  RedactionConfig& WithMaskCharacter(MaskCharacterT&& value) {
    SetMaskCharacter(std::forward<MaskCharacterT>(value));
    return *this;
  }
  ///@}
 private:
