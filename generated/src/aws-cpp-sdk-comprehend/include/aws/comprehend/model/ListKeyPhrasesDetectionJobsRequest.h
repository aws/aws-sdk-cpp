...
class ListKeyPhrasesDetectionJobsRequest : public ComprehendRequest {
 public:
  ...
  template <typename FilterT = KeyPhrasesDetectionJobFilter>
  ListKeyPhrasesDetectionJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListKeyPhrasesDetectionJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListKeyPhrasesDetectionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
