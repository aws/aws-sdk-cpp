...
class InputDataConfig {
 public:
  ...
  inline void SetInputFormat(InputFormat value) {
    m_inputFormatHasBeenSet = true;
    m_inputFormat = value;
  }
  inline InputDataConfig& WithInputFormat(InputFormat value) {
  ...
  void SetDocumentReaderConfig(DocumentReaderConfigT&& value) {
    ...
    m_documentReaderConfig = std::forward<DocumentReaderConfigT>(value);
  }
  template <typename DocumentReaderConfigT = DocumentReaderConfig>
  InputDataConfig& WithDocumentReaderConfig(DocumentReaderConfigT&& value) {
    SetDocumentReaderConfig(std::forward<DocumentReaderConfigT>(value));
    return *this;
  }
  ///@}
 private:
