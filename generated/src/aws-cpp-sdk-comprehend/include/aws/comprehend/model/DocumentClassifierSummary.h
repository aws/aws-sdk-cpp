...
class DocumentClassifierSummary {
 public:
  ...
  inline void SetNumberOfVersions(int value) {
    m_numberOfVersionsHasBeenSet = true;
    m_numberOfVersions = value;
  }
  inline DocumentClassifierSummary& WithNumberOfVersions(int value) {
    SetNumberOfVersions(value);
    return *this;
  }
  ///@}
  ...
  void SetLatestVersionCreatedAt(LatestVersionCreatedAtT&& value) {
    ...
    m_latestVersionCreatedAt = std::forward<LatestVersionCreatedAtT>(value);
  }
  template <typename LatestVersionCreatedAtT = Aws::Utils::DateTime>
  DocumentClassifierSummary& WithLatestVersionCreatedAt(LatestVersionCreatedAtT&& value) {
    SetLatestVersionCreatedAt(std::forward<LatestVersionCreatedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLatestVersionName(LatestVersionNameT&& value) {
    ...
    m_latestVersionName = std::forward<LatestVersionNameT>(value);
  }
  template <typename LatestVersionNameT = Aws::String>
  DocumentClassifierSummary& WithLatestVersionName(LatestVersionNameT&& value) {
    SetLatestVersionName(std::forward<LatestVersionNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLatestVersionStatus(ModelStatus value) {
    m_latestVersionStatusHasBeenSet = true;
    m_latestVersionStatus = value;
  }
  inline DocumentClassifierSummary& WithLatestVersionStatus(ModelStatus value) {
    SetLatestVersionStatus(value);
    return *this;
  }
  ///@}
 private:
