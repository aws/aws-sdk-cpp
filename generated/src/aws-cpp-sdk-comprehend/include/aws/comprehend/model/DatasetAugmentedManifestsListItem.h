...
class DatasetAugmentedManifestsListItem {
 public:
  ...
  template <typename AttributeNamesT = Aws::Vector<Aws::String>>
  DatasetAugmentedManifestsListItem& WithAttributeNames(AttributeNamesT&& value) {
    SetAttributeNames(std::forward<AttributeNamesT>(value));
    return *this;
  }
  template <typename AttributeNamesT = Aws::String>
  DatasetAugmentedManifestsListItem& AddAttributeNames(AttributeNamesT&& value) {
    m_attributeNamesHasBeenSet = true;
  ...
  template <typename S3UriT = Aws::String>
  DatasetAugmentedManifestsListItem& WithS3Uri(S3UriT&& value) {
  ...
  void SetAnnotationDataS3Uri(AnnotationDataS3UriT&& value) {
    ...
    m_annotationDataS3Uri = std::forward<AnnotationDataS3UriT>(value);
  }
  template <typename AnnotationDataS3UriT = Aws::String>
  DatasetAugmentedManifestsListItem& WithAnnotationDataS3Uri(AnnotationDataS3UriT&& value) {
    SetAnnotationDataS3Uri(std::forward<AnnotationDataS3UriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceDocumentsS3Uri(SourceDocumentsS3UriT&& value) {
    ...
    m_sourceDocumentsS3Uri = std::forward<SourceDocumentsS3UriT>(value);
  }
  template <typename SourceDocumentsS3UriT = Aws::String>
  DatasetAugmentedManifestsListItem& WithSourceDocumentsS3Uri(SourceDocumentsS3UriT&& value) {
    SetSourceDocumentsS3Uri(std::forward<SourceDocumentsS3UriT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDocumentType(AugmentedManifestsDocumentTypeFormat value) {
    m_documentTypeHasBeenSet = true;
    m_documentType = value;
  }
  inline DatasetAugmentedManifestsListItem& WithDocumentType(AugmentedManifestsDocumentTypeFormat value) {
