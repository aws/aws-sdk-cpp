...
class BatchDetectSyntaxItemResult {
 public:
  ...
  inline BatchDetectSyntaxItemResult& WithIndex(int value) {
    SetIndex(value);
    return *this;
  }
  ///@}
