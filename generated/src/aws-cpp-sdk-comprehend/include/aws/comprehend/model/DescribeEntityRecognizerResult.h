...
class DescribeEntityRecognizerResult {
 public:
  ...
  void SetEntityRecognizerProperties(EntityRecognizerPropertiesT&& value) {
    m_entityRecognizerPropertiesHasBeenSet = true;
    m_entityRecognizerProperties = std::forward<EntityRecognizerPropertiesT>(value);
  }
  template <typename EntityRecognizerPropertiesT = EntityRecognizerProperties>
  DescribeEntityRecognizerResult& WithEntityRecognizerProperties(EntityRecognizerPropertiesT&& value) {
    SetEntityRecognizerProperties(std::forward<EntityRecognizerPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEntityRecognizerResult& WithRequestId(RequestIdT&& value) {
