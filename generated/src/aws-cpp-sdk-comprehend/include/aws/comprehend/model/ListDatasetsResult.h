...
class ListDatasetsResult {
 public:
  ...
  void SetDatasetPropertiesList(DatasetPropertiesListT&& value) {
    m_datasetPropertiesListHasBeenSet = true;
    m_datasetPropertiesList = std::forward<DatasetPropertiesListT>(value);
  }
  template <typename DatasetPropertiesListT = Aws::Vector<DatasetProperties>>
  ListDatasetsResult& WithDatasetPropertiesList(DatasetPropertiesListT&& value) {
    SetDatasetPropertiesList(std::forward<DatasetPropertiesListT>(value));
    return *this;
  }
  template <typename DatasetPropertiesListT = DatasetProperties>
  ListDatasetsResult& AddDatasetPropertiesList(DatasetPropertiesListT&& value) {
    m_datasetPropertiesListHasBeenSet = true;
    m_datasetPropertiesList.emplace_back(std::forward<DatasetPropertiesListT>(value));
    return *this;
  }
  ///@}
