...
class DescribeFlywheelIterationResult {
 public:
  ...
  void SetFlywheelIterationProperties(FlywheelIterationPropertiesT&& value) {
    m_flywheelIterationPropertiesHasBeenSet = true;
    m_flywheelIterationProperties = std::forward<FlywheelIterationPropertiesT>(value);
  }
  template <typename FlywheelIterationPropertiesT = FlywheelIterationProperties>
  DescribeFlywheelIterationResult& WithFlywheelIterationProperties(FlywheelIterationPropertiesT&& value) {
    SetFlywheelIterationProperties(std::forward<FlywheelIterationPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFlywheelIterationResult& WithRequestId(RequestIdT&& value) {
