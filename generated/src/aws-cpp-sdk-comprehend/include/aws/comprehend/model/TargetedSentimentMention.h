...
class TargetedSentimentMention {
 public:
  ...
  inline TargetedSentimentMention& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGroupScore(double value) {
    m_groupScoreHasBeenSet = true;
    m_groupScore = value;
  }
  inline TargetedSentimentMention& WithGroupScore(double value) {
    SetGroupScore(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(TargetedSentimentEntityType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TargetedSentimentMention& WithType(TargetedSentimentEntityType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetMentionSentiment(MentionSentimentT&& value) {
    ...
    m_mentionSentiment = std::forward<MentionSentimentT>(value);
  }
  template <typename MentionSentimentT = MentionSentiment>
  TargetedSentimentMention& WithMentionSentiment(MentionSentimentT&& value) {
    SetMentionSentiment(std::forward<MentionSentimentT>(value));
    return *this;
  }
  ///@}
  ...
  inline TargetedSentimentMention& WithBeginOffset(int value) {
  ...
  inline TargetedSentimentMention& WithEndOffset(int value) {
    SetEndOffset(value);
    return *this;
  }
  ///@}
