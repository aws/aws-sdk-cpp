...
class EntityTypesEvaluationMetrics {
 public:
  ...
  inline EntityTypesEvaluationMetrics& WithPrecision(double value) {
    SetPrecision(value);
    return *this;
  }
  ///@}
  ...
  inline EntityTypesEvaluationMetrics& WithRecall(double value) {
    SetRecall(value);
    return *this;
  }
  ///@}
  ...
  inline EntityTypesEvaluationMetrics& WithF1Score(double value) {
    SetF1Score(value);
    return *this;
  }
  ///@}
