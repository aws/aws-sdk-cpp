...
class ListDominantLanguageDetectionJobsRequest : public ComprehendRequest {
 public:
  ...
  template <typename FilterT = DominantLanguageDetectionJobFilter>
  ListDominantLanguageDetectionJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDominantLanguageDetectionJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDominantLanguageDetectionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
