...
namespace Model
{
  ...
  /**
   */
  class ListDominantLanguageDetectionJobsRequest : public ComprehendRequest
  {
  public:
    AWS_COMPREHEND_API ListDominantLanguageDetectionJobsRequest() = default;
    ...
    template<typename FilterT = DominantLanguageDetectionJobFilter>
    void SetFilter(FilterT&& value) { m_filterHasBeenSet = true; m_filter = std::forward<FilterT>(value); }
    template<typename FilterT = DominantLanguageDetectionJobFilter>
    ListDominantLanguageDetectionJobsRequest& WithFilter(FilterT&& value) { SetFilter(std::forward<FilterT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListDominantLanguageDetectionJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
