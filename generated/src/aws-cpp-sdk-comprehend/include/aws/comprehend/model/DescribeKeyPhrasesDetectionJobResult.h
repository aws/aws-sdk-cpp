...
class DescribeKeyPhrasesDetectionJobResult {
 public:
  ...
  AWS_COMPREHEND_API DescribeKeyPhrasesDetectionJobResult& operator=(
  ...
  void SetKeyPhrasesDetectionJobProperties(KeyPhrasesDetectionJobPropertiesT&& value) {
    ...
    m_keyPhrasesDetectionJobProperties = std::forward<KeyPhrasesDetectionJobPropertiesT>(value);
  }
  template <typename KeyPhrasesDetectionJobPropertiesT = KeyPhrasesDetectionJobProperties>
  DescribeKeyPhrasesDetectionJobResult& WithKeyPhrasesDetectionJobProperties(KeyPhrasesDetectionJobPropertiesT&& value) {
    SetKeyPhrasesDetectionJobProperties(std::forward<KeyPhrasesDetectionJobPropertiesT>(value));
    return *this;
  }
  ///@}
