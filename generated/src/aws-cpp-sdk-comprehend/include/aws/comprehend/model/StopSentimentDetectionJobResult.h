...
class StopSentimentDetectionJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  StopSentimentDetectionJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StopSentimentDetectionJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopSentimentDetectionJobResult& WithRequestId(RequestIdT&& value) {
