...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHEND_API DocumentClassificationJobFilter() = default;
    ...
    template<typename JobNameT = Aws::String>
    DocumentClassificationJobFilter& WithJobName(JobNameT&& value) { SetJobName(std::forward<JobNameT>(value)); return *this;}
    ///@}
    ...
    inline DocumentClassificationJobFilter& WithJobStatus(JobStatus value) { SetJobStatus(value); return *this;}
    ///@}
    ...
    template<typename SubmitTimeBeforeT = Aws::Utils::DateTime>
    DocumentClassificationJobFilter& WithSubmitTimeBefore(SubmitTimeBeforeT&& value) { SetSubmitTimeBefore(std::forward<SubmitTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename SubmitTimeAfterT = Aws::Utils::DateTime>
    DocumentClassificationJobFilter& WithSubmitTimeAfter(SubmitTimeAfterT&& value) { SetSubmitTimeAfter(std::forward<SubmitTimeAfterT>(value)); return *this;}
    ///@}
  private:
