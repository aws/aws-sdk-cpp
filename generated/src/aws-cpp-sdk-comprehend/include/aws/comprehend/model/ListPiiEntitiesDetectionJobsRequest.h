...
class ListPiiEntitiesDetectionJobsRequest : public ComprehendRequest {
 public:
  ...
  template <typename FilterT = PiiEntitiesDetectionJobFilter>
  ListPiiEntitiesDetectionJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPiiEntitiesDetectionJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPiiEntitiesDetectionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
