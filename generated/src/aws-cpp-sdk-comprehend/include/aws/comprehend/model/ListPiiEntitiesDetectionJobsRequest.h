...
namespace Model
{
  ...
  /**
   */
  class ListPiiEntitiesDetectionJobsRequest : public ComprehendRequest
  {
  public:
    AWS_COMPREHEND_API ListPiiEntitiesDetectionJobsRequest() = default;
    ...
    template<typename FilterT = PiiEntitiesDetectionJobFilter>
    void SetFilter(FilterT&& value) { m_filterHasBeenSet = true; m_filter = std::forward<FilterT>(value); }
    template<typename FilterT = PiiEntitiesDetectionJobFilter>
    ListPiiEntitiesDetectionJobsRequest& WithFilter(FilterT&& value) { SetFilter(std::forward<FilterT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListPiiEntitiesDetectionJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
