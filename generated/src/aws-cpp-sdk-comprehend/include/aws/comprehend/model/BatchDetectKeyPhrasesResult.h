...
class BatchDetectKeyPhrasesResult {
 public:
  ...
  template <typename ResultListT = Aws::Vector<BatchDetectKeyPhrasesItemResult>>
  BatchDetectKeyPhrasesResult& WithResultList(ResultListT&& value) {
    SetResultList(std::forward<ResultListT>(value));
    return *this;
  }
  template <typename ResultListT = BatchDetectKeyPhrasesItemResult>
  BatchDetectKeyPhrasesResult& AddResultList(ResultListT&& value) {
    m_resultListHasBeenSet = true;
  ...
  template <typename ErrorListT = Aws::Vector<BatchItemError>>
  BatchDetectKeyPhrasesResult& WithErrorList(ErrorListT&& value) {
    SetErrorList(std::forward<ErrorListT>(value));
    return *this;
  }
  template <typename ErrorListT = BatchItemError>
  BatchDetectKeyPhrasesResult& AddErrorList(ErrorListT&& value) {
    m_errorListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDetectKeyPhrasesResult& WithRequestId(RequestIdT&& value) {
