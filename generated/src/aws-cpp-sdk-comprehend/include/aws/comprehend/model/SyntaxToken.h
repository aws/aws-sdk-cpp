...
class SyntaxToken {
 public:
  ...
  inline void SetTokenId(int value) {
    m_tokenIdHasBeenSet = true;
    m_tokenId = value;
  }
  inline SyntaxToken& WithTokenId(int value) {
    SetTokenId(value);
    return *this;
  }
  ///@}
  ...
  inline SyntaxToken& WithBeginOffset(int value) {
  ...
  inline SyntaxToken& WithEndOffset(int value) {
    SetEndOffset(value);
    return *this;
  }
  ///@}
  ...
  void SetPartOfSpeech(PartOfSpeechT&& value) {
    ...
    m_partOfSpeech = std::forward<PartOfSpeechT>(value);
  }
  template <typename PartOfSpeechT = PartOfSpeechTag>
  SyntaxToken& WithPartOfSpeech(PartOfSpeechT&& value) {
    SetPartOfSpeech(std::forward<PartOfSpeechT>(value));
    return *this;
  }
  ///@}
 private:
