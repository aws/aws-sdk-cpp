...
class AWS_COMPREHEND_API ComprehendClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ComprehendClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ComprehendEndpointProviderBase> endpointProvider = nullptr,
      const Aws::Comprehend::ComprehendClientConfiguration& clientConfiguration = Aws::Comprehend::ComprehendClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDetectDominantLanguageOutcome BatchDetectDominantLanguage(
      const Model::BatchDetectDominantLanguageRequest& request) const;

  /**
   * A Callable wrapper for BatchDetectDominantLanguage that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDetectDominantLanguageRequestT = Model::BatchDetectDominantLanguageRequest>
  Model::BatchDetectDominantLanguageOutcomeCallable BatchDetectDominantLanguageCallable(
      const BatchDetectDominantLanguageRequestT& request) const {
    return SubmitCallable(&ComprehendClient::BatchDetectDominantLanguage, request);
  }

  /**
   * An Async wrapper for BatchDetectDominantLanguage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDetectDominantLanguageRequestT = Model::BatchDetectDominantLanguageRequest>
  void BatchDetectDominantLanguageAsync(const BatchDetectDominantLanguageRequestT& request,
  ...
  /**
   * A Callable wrapper for BatchDetectEntities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDetectEntities that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchDetectEntitiesRequestT = Model::BatchDetectEntitiesRequest>
  void BatchDetectEntitiesAsync(const BatchDetectEntitiesRequestT& request, const BatchDetectEntitiesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDetectKeyPhrases that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDetectKeyPhrases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDetectKeyPhrasesRequestT = Model::BatchDetectKeyPhrasesRequest>
  void BatchDetectKeyPhrasesAsync(const BatchDetectKeyPhrasesRequestT& request, const BatchDetectKeyPhrasesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDetectSentiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDetectSentiment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDetectSentimentRequestT = Model::BatchDetectSentimentRequest>
  void BatchDetectSentimentAsync(const BatchDetectSentimentRequestT& request, const BatchDetectSentimentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDetectSyntax that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDetectSyntax that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchDetectSyntaxRequestT = Model::BatchDetectSyntaxRequest>
  void BatchDetectSyntaxAsync(const BatchDetectSyntaxRequestT& request, const BatchDetectSyntaxResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDetectTargetedSentimentOutcome BatchDetectTargetedSentiment(
      const Model::BatchDetectTargetedSentimentRequest& request) const;

  /**
   * A Callable wrapper for BatchDetectTargetedSentiment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDetectTargetedSentimentRequestT = Model::BatchDetectTargetedSentimentRequest>
  Model::BatchDetectTargetedSentimentOutcomeCallable BatchDetectTargetedSentimentCallable(
      const BatchDetectTargetedSentimentRequestT& request) const {
    return SubmitCallable(&ComprehendClient::BatchDetectTargetedSentiment, request);
  }

  /**
   * An Async wrapper for BatchDetectTargetedSentiment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDetectTargetedSentimentRequestT = Model::BatchDetectTargetedSentimentRequest>
  void BatchDetectTargetedSentimentAsync(const BatchDetectTargetedSentimentRequestT& request,
                                         const BatchDetectTargetedSentimentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ClassifyDocument that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ClassifyDocument that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ClassifyDocumentRequestT = Model::ClassifyDocumentRequest>
  void ClassifyDocumentAsync(const ClassifyDocumentRequestT& request, const ClassifyDocumentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ContainsPiiEntities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ContainsPiiEntities that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ContainsPiiEntitiesRequestT = Model::ContainsPiiEntitiesRequest>
  void ContainsPiiEntitiesAsync(const ContainsPiiEntitiesRequestT& request, const ContainsPiiEntitiesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDocumentClassifier that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDocumentClassifier that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDocumentClassifierRequestT = Model::CreateDocumentClassifierRequest>
  void CreateDocumentClassifierAsync(const CreateDocumentClassifierRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateEntityRecognizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEntityRecognizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEntityRecognizerRequestT = Model::CreateEntityRecognizerRequest>
  void CreateEntityRecognizerAsync(const CreateEntityRecognizerRequestT& request,
  ...
  /**
   * An Async wrapper for CreateFlywheel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFlywheelRequestT = Model::CreateFlywheelRequest>
  void CreateFlywheelAsync(const CreateFlywheelRequestT& request, const CreateFlywheelResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDocumentClassifier that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDocumentClassifier that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDocumentClassifierRequestT = Model::DeleteDocumentClassifierRequest>
  void DeleteDocumentClassifierAsync(const DeleteDocumentClassifierRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteEntityRecognizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEntityRecognizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEntityRecognizerRequestT = Model::DeleteEntityRecognizerRequest>
  void DeleteEntityRecognizerAsync(const DeleteEntityRecognizerRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteFlywheel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFlywheelRequestT = Model::DeleteFlywheelRequest>
  void DeleteFlywheelAsync(const DeleteFlywheelRequestT& request, const DeleteFlywheelResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDocumentClassificationJobOutcome DescribeDocumentClassificationJob(
      const Model::DescribeDocumentClassificationJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeDocumentClassificationJob that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeDocumentClassificationJobRequestT = Model::DescribeDocumentClassificationJobRequest>
  Model::DescribeDocumentClassificationJobOutcomeCallable DescribeDocumentClassificationJobCallable(
      const DescribeDocumentClassificationJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribeDocumentClassificationJob, request);
  }

  /**
   * An Async wrapper for DescribeDocumentClassificationJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeDocumentClassificationJobRequestT = Model::DescribeDocumentClassificationJobRequest>
  void DescribeDocumentClassificationJobAsync(const DescribeDocumentClassificationJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDocumentClassifierOutcome DescribeDocumentClassifier(
      const Model::DescribeDocumentClassifierRequest& request) const;

  /**
   * A Callable wrapper for DescribeDocumentClassifier that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDocumentClassifierRequestT = Model::DescribeDocumentClassifierRequest>
  Model::DescribeDocumentClassifierOutcomeCallable DescribeDocumentClassifierCallable(
      const DescribeDocumentClassifierRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribeDocumentClassifier, request);
  }

  /**
   * An Async wrapper for DescribeDocumentClassifier that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDocumentClassifierRequestT = Model::DescribeDocumentClassifierRequest>
  void DescribeDocumentClassifierAsync(const DescribeDocumentClassifierRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDominantLanguageDetectionJobOutcome DescribeDominantLanguageDetectionJob(
      const Model::DescribeDominantLanguageDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeDominantLanguageDetectionJob that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeDominantLanguageDetectionJobRequestT = Model::DescribeDominantLanguageDetectionJobRequest>
  Model::DescribeDominantLanguageDetectionJobOutcomeCallable DescribeDominantLanguageDetectionJobCallable(
      const DescribeDominantLanguageDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribeDominantLanguageDetectionJob, request);
  }

  /**
   * An Async wrapper for DescribeDominantLanguageDetectionJob that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeDominantLanguageDetectionJobRequestT = Model::DescribeDominantLanguageDetectionJobRequest>
  void DescribeDominantLanguageDetectionJobAsync(const DescribeDominantLanguageDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEntitiesDetectionJobOutcome DescribeEntitiesDetectionJob(
      const Model::DescribeEntitiesDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeEntitiesDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEntitiesDetectionJobRequestT = Model::DescribeEntitiesDetectionJobRequest>
  Model::DescribeEntitiesDetectionJobOutcomeCallable DescribeEntitiesDetectionJobCallable(
      const DescribeEntitiesDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribeEntitiesDetectionJob, request);
  }

  /**
   * An Async wrapper for DescribeEntitiesDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEntitiesDetectionJobRequestT = Model::DescribeEntitiesDetectionJobRequest>
  void DescribeEntitiesDetectionJobAsync(const DescribeEntitiesDetectionJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeEntityRecognizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEntityRecognizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEntityRecognizerRequestT = Model::DescribeEntityRecognizerRequest>
  void DescribeEntityRecognizerAsync(const DescribeEntityRecognizerRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEventsDetectionJobOutcome DescribeEventsDetectionJob(
      const Model::DescribeEventsDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeEventsDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEventsDetectionJobRequestT = Model::DescribeEventsDetectionJobRequest>
  Model::DescribeEventsDetectionJobOutcomeCallable DescribeEventsDetectionJobCallable(
      const DescribeEventsDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribeEventsDetectionJob, request);
  }

  /**
   * An Async wrapper for DescribeEventsDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEventsDetectionJobRequestT = Model::DescribeEventsDetectionJobRequest>
  void DescribeEventsDetectionJobAsync(const DescribeEventsDetectionJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeFlywheel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFlywheel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeFlywheelRequestT = Model::DescribeFlywheelRequest>
  void DescribeFlywheelAsync(const DescribeFlywheelRequestT& request, const DescribeFlywheelResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeFlywheelIteration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeFlywheelIterationRequestT = Model::DescribeFlywheelIterationRequest>
  Model::DescribeFlywheelIterationOutcomeCallable DescribeFlywheelIterationCallable(
      const DescribeFlywheelIterationRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribeFlywheelIteration, request);
  }

  /**
   * An Async wrapper for DescribeFlywheelIteration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFlywheelIterationRequestT = Model::DescribeFlywheelIterationRequest>
  void DescribeFlywheelIterationAsync(const DescribeFlywheelIterationRequestT& request,
                                      const DescribeFlywheelIterationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeKeyPhrasesDetectionJobOutcome DescribeKeyPhrasesDetectionJob(
      const Model::DescribeKeyPhrasesDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeKeyPhrasesDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeKeyPhrasesDetectionJobRequestT = Model::DescribeKeyPhrasesDetectionJobRequest>
  Model::DescribeKeyPhrasesDetectionJobOutcomeCallable DescribeKeyPhrasesDetectionJobCallable(
      const DescribeKeyPhrasesDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribeKeyPhrasesDetectionJob, request);
  }

  /**
   * An Async wrapper for DescribeKeyPhrasesDetectionJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeKeyPhrasesDetectionJobRequestT = Model::DescribeKeyPhrasesDetectionJobRequest>
  void DescribeKeyPhrasesDetectionJobAsync(const DescribeKeyPhrasesDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribePiiEntitiesDetectionJobOutcome DescribePiiEntitiesDetectionJob(
      const Model::DescribePiiEntitiesDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for DescribePiiEntitiesDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribePiiEntitiesDetectionJobRequestT = Model::DescribePiiEntitiesDetectionJobRequest>
  Model::DescribePiiEntitiesDetectionJobOutcomeCallable DescribePiiEntitiesDetectionJobCallable(
      const DescribePiiEntitiesDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribePiiEntitiesDetectionJob, request);
  }

  /**
   * An Async wrapper for DescribePiiEntitiesDetectionJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribePiiEntitiesDetectionJobRequestT = Model::DescribePiiEntitiesDetectionJobRequest>
  void DescribePiiEntitiesDetectionJobAsync(const DescribePiiEntitiesDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeSentimentDetectionJobOutcome DescribeSentimentDetectionJob(
      const Model::DescribeSentimentDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeSentimentDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeSentimentDetectionJobRequestT = Model::DescribeSentimentDetectionJobRequest>
  Model::DescribeSentimentDetectionJobOutcomeCallable DescribeSentimentDetectionJobCallable(
      const DescribeSentimentDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribeSentimentDetectionJob, request);
  }

  /**
   * An Async wrapper for DescribeSentimentDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSentimentDetectionJobRequestT = Model::DescribeSentimentDetectionJobRequest>
  void DescribeSentimentDetectionJobAsync(const DescribeSentimentDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTargetedSentimentDetectionJobOutcome DescribeTargetedSentimentDetectionJob(
      const Model::DescribeTargetedSentimentDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeTargetedSentimentDetectionJob that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeTargetedSentimentDetectionJobRequestT = Model::DescribeTargetedSentimentDetectionJobRequest>
  Model::DescribeTargetedSentimentDetectionJobOutcomeCallable DescribeTargetedSentimentDetectionJobCallable(
      const DescribeTargetedSentimentDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribeTargetedSentimentDetectionJob, request);
  }

  /**
   * An Async wrapper for DescribeTargetedSentimentDetectionJob that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeTargetedSentimentDetectionJobRequestT = Model::DescribeTargetedSentimentDetectionJobRequest>
  void DescribeTargetedSentimentDetectionJobAsync(const DescribeTargetedSentimentDetectionJobRequestT& request,
                                                  const DescribeTargetedSentimentDetectionJobResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTopicsDetectionJobOutcome DescribeTopicsDetectionJob(
      const Model::DescribeTopicsDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeTopicsDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeTopicsDetectionJobRequestT = Model::DescribeTopicsDetectionJobRequest>
  Model::DescribeTopicsDetectionJobOutcomeCallable DescribeTopicsDetectionJobCallable(
      const DescribeTopicsDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::DescribeTopicsDetectionJob, request);
  }

  /**
   * An Async wrapper for DescribeTopicsDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTopicsDetectionJobRequestT = Model::DescribeTopicsDetectionJobRequest>
  void DescribeTopicsDetectionJobAsync(const DescribeTopicsDetectionJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DetectDominantLanguage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectDominantLanguage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetectDominantLanguageRequestT = Model::DetectDominantLanguageRequest>
  void DetectDominantLanguageAsync(const DetectDominantLanguageRequestT& request,
  ...
  /**
   * An Async wrapper for DetectEntities that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetectEntitiesRequestT = Model::DetectEntitiesRequest>
  void DetectEntitiesAsync(const DetectEntitiesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DetectEntitiesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DetectKeyPhrases that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectKeyPhrases that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetectKeyPhrasesRequestT = Model::DetectKeyPhrasesRequest>
  void DetectKeyPhrasesAsync(const DetectKeyPhrasesRequestT& request, const DetectKeyPhrasesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectPiiEntities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectPiiEntities that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetectPiiEntitiesRequestT = Model::DetectPiiEntitiesRequest>
  void DetectPiiEntitiesAsync(const DetectPiiEntitiesRequestT& request, const DetectPiiEntitiesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DetectSentiment that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetectSentimentRequestT = Model::DetectSentimentRequest>
  void DetectSentimentAsync(const DetectSentimentRequestT& request, const DetectSentimentResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DetectSyntax that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetectSyntaxRequestT = Model::DetectSyntaxRequest>
  void DetectSyntaxAsync(const DetectSyntaxRequestT& request, const DetectSyntaxResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectTargetedSentiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectTargetedSentiment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetectTargetedSentimentRequestT = Model::DetectTargetedSentimentRequest>
  void DetectTargetedSentimentAsync(const DetectTargetedSentimentRequestT& request,
                                    const DetectTargetedSentimentResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectToxicContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectToxicContent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetectToxicContentRequestT = Model::DetectToxicContentRequest>
  void DetectToxicContentAsync(const DetectToxicContentRequestT& request, const DetectToxicContentResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportModel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportModelRequestT = Model::ImportModelRequest>
  void ImportModelAsync(const ImportModelRequestT& request, const ImportModelResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDocumentClassificationJobsOutcome ListDocumentClassificationJobs(
      const Model::ListDocumentClassificationJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDocumentClassificationJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDocumentClassificationJobsRequestT = Model::ListDocumentClassificationJobsRequest>
  Model::ListDocumentClassificationJobsOutcomeCallable ListDocumentClassificationJobsCallable(
      const ListDocumentClassificationJobsRequestT& request = {}) const {
    return SubmitCallable(&ComprehendClient::ListDocumentClassificationJobs, request);
  }

  /**
   * An Async wrapper for ListDocumentClassificationJobs that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListDocumentClassificationJobsRequestT = Model::ListDocumentClassificationJobsRequest>
  void ListDocumentClassificationJobsAsync(const ListDocumentClassificationJobsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListDocumentClassificationJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDocumentClassifierSummariesOutcome ListDocumentClassifierSummaries(
      const Model::ListDocumentClassifierSummariesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDocumentClassifierSummaries that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDocumentClassifierSummariesRequestT = Model::ListDocumentClassifierSummariesRequest>
  Model::ListDocumentClassifierSummariesOutcomeCallable ListDocumentClassifierSummariesCallable(
      const ListDocumentClassifierSummariesRequestT& request = {}) const {
    return SubmitCallable(&ComprehendClient::ListDocumentClassifierSummaries, request);
  }

  /**
   * An Async wrapper for ListDocumentClassifierSummaries that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListDocumentClassifierSummariesRequestT = Model::ListDocumentClassifierSummariesRequest>
  void ListDocumentClassifierSummariesAsync(const ListDocumentClassifierSummariesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListDocumentClassifierSummariesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDocumentClassifiers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDocumentClassifiers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDocumentClassifiersRequestT = Model::ListDocumentClassifiersRequest>
  void ListDocumentClassifiersAsync(const ListDocumentClassifiersResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListDocumentClassifiersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDominantLanguageDetectionJobsOutcome ListDominantLanguageDetectionJobs(
      const Model::ListDominantLanguageDetectionJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDominantLanguageDetectionJobs that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListDominantLanguageDetectionJobsRequestT = Model::ListDominantLanguageDetectionJobsRequest>
  Model::ListDominantLanguageDetectionJobsOutcomeCallable ListDominantLanguageDetectionJobsCallable(
      const ListDominantLanguageDetectionJobsRequestT& request = {}) const {
    return SubmitCallable(&ComprehendClient::ListDominantLanguageDetectionJobs, request);
  }

  /**
   * An Async wrapper for ListDominantLanguageDetectionJobs that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListDominantLanguageDetectionJobsRequestT = Model::ListDominantLanguageDetectionJobsRequest>
  void ListDominantLanguageDetectionJobsAsync(const ListDominantLanguageDetectionJobsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const ListDominantLanguageDetectionJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEntitiesDetectionJobsOutcome ListEntitiesDetectionJobs(
      const Model::ListEntitiesDetectionJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListEntitiesDetectionJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListEntitiesDetectionJobsRequestT = Model::ListEntitiesDetectionJobsRequest>
  Model::ListEntitiesDetectionJobsOutcomeCallable ListEntitiesDetectionJobsCallable(
      const ListEntitiesDetectionJobsRequestT& request = {}) const {
    return SubmitCallable(&ComprehendClient::ListEntitiesDetectionJobs, request);
  }

  /**
   * An Async wrapper for ListEntitiesDetectionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEntitiesDetectionJobsRequestT = Model::ListEntitiesDetectionJobsRequest>
  void ListEntitiesDetectionJobsAsync(const ListEntitiesDetectionJobsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListEntitiesDetectionJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEntityRecognizerSummariesOutcome ListEntityRecognizerSummaries(
      const Model::ListEntityRecognizerSummariesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListEntityRecognizerSummaries that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListEntityRecognizerSummariesRequestT = Model::ListEntityRecognizerSummariesRequest>
  Model::ListEntityRecognizerSummariesOutcomeCallable ListEntityRecognizerSummariesCallable(
      const ListEntityRecognizerSummariesRequestT& request = {}) const {
    return SubmitCallable(&ComprehendClient::ListEntityRecognizerSummaries, request);
  }

  /**
   * An Async wrapper for ListEntityRecognizerSummaries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEntityRecognizerSummariesRequestT = Model::ListEntityRecognizerSummariesRequest>
  void ListEntityRecognizerSummariesAsync(const ListEntityRecognizerSummariesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListEntityRecognizerSummariesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEntityRecognizers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEntityRecognizers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEntityRecognizersRequestT = Model::ListEntityRecognizersRequest>
  void ListEntityRecognizersAsync(const ListEntityRecognizersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListEntityRecognizersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEventsDetectionJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEventsDetectionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEventsDetectionJobsRequestT = Model::ListEventsDetectionJobsRequest>
  void ListEventsDetectionJobsAsync(const ListEventsDetectionJobsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListEventsDetectionJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListFlywheelIterationHistoryOutcome ListFlywheelIterationHistory(
      const Model::ListFlywheelIterationHistoryRequest& request) const;

  /**
   * A Callable wrapper for ListFlywheelIterationHistory that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListFlywheelIterationHistoryRequestT = Model::ListFlywheelIterationHistoryRequest>
  Model::ListFlywheelIterationHistoryOutcomeCallable ListFlywheelIterationHistoryCallable(
      const ListFlywheelIterationHistoryRequestT& request) const {
    return SubmitCallable(&ComprehendClient::ListFlywheelIterationHistory, request);
  }

  /**
   * An Async wrapper for ListFlywheelIterationHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFlywheelIterationHistoryRequestT = Model::ListFlywheelIterationHistoryRequest>
  void ListFlywheelIterationHistoryAsync(const ListFlywheelIterationHistoryRequestT& request,
                                         const ListFlywheelIterationHistoryResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListFlywheels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFlywheelsRequestT = Model::ListFlywheelsRequest>
  void ListFlywheelsAsync(const ListFlywheelsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListFlywheelsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListKeyPhrasesDetectionJobsOutcome ListKeyPhrasesDetectionJobs(
      const Model::ListKeyPhrasesDetectionJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListKeyPhrasesDetectionJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListKeyPhrasesDetectionJobsRequestT = Model::ListKeyPhrasesDetectionJobsRequest>
  Model::ListKeyPhrasesDetectionJobsOutcomeCallable ListKeyPhrasesDetectionJobsCallable(
      const ListKeyPhrasesDetectionJobsRequestT& request = {}) const {
    return SubmitCallable(&ComprehendClient::ListKeyPhrasesDetectionJobs, request);
  }

  /**
   * An Async wrapper for ListKeyPhrasesDetectionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListKeyPhrasesDetectionJobsRequestT = Model::ListKeyPhrasesDetectionJobsRequest>
  void ListKeyPhrasesDetectionJobsAsync(const ListKeyPhrasesDetectionJobsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListKeyPhrasesDetectionJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPiiEntitiesDetectionJobsOutcome ListPiiEntitiesDetectionJobs(
      const Model::ListPiiEntitiesDetectionJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListPiiEntitiesDetectionJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPiiEntitiesDetectionJobsRequestT = Model::ListPiiEntitiesDetectionJobsRequest>
  Model::ListPiiEntitiesDetectionJobsOutcomeCallable ListPiiEntitiesDetectionJobsCallable(
      const ListPiiEntitiesDetectionJobsRequestT& request = {}) const {
    return SubmitCallable(&ComprehendClient::ListPiiEntitiesDetectionJobs, request);
  }

  /**
   * An Async wrapper for ListPiiEntitiesDetectionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPiiEntitiesDetectionJobsRequestT = Model::ListPiiEntitiesDetectionJobsRequest>
  void ListPiiEntitiesDetectionJobsAsync(const ListPiiEntitiesDetectionJobsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListPiiEntitiesDetectionJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSentimentDetectionJobsOutcome ListSentimentDetectionJobs(
      const Model::ListSentimentDetectionJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSentimentDetectionJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSentimentDetectionJobsRequestT = Model::ListSentimentDetectionJobsRequest>
  Model::ListSentimentDetectionJobsOutcomeCallable ListSentimentDetectionJobsCallable(
      const ListSentimentDetectionJobsRequestT& request = {}) const {
    return SubmitCallable(&ComprehendClient::ListSentimentDetectionJobs, request);
  }

  /**
   * An Async wrapper for ListSentimentDetectionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSentimentDetectionJobsRequestT = Model::ListSentimentDetectionJobsRequest>
  void ListSentimentDetectionJobsAsync(const ListSentimentDetectionJobsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListSentimentDetectionJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTargetedSentimentDetectionJobsOutcome ListTargetedSentimentDetectionJobs(
      const Model::ListTargetedSentimentDetectionJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListTargetedSentimentDetectionJobs that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListTargetedSentimentDetectionJobsRequestT = Model::ListTargetedSentimentDetectionJobsRequest>
  Model::ListTargetedSentimentDetectionJobsOutcomeCallable ListTargetedSentimentDetectionJobsCallable(
      const ListTargetedSentimentDetectionJobsRequestT& request = {}) const {
    return SubmitCallable(&ComprehendClient::ListTargetedSentimentDetectionJobs, request);
  }

  /**
   * An Async wrapper for ListTargetedSentimentDetectionJobs that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListTargetedSentimentDetectionJobsRequestT = Model::ListTargetedSentimentDetectionJobsRequest>
  void ListTargetedSentimentDetectionJobsAsync(const ListTargetedSentimentDetectionJobsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const ListTargetedSentimentDetectionJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTopicsDetectionJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTopicsDetectionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTopicsDetectionJobsRequestT = Model::ListTopicsDetectionJobsRequest>
  void ListTopicsDetectionJobsAsync(const ListTopicsDetectionJobsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListTopicsDetectionJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartDocumentClassificationJobOutcome StartDocumentClassificationJob(
      const Model::StartDocumentClassificationJobRequest& request) const;

  /**
   * A Callable wrapper for StartDocumentClassificationJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartDocumentClassificationJobRequestT = Model::StartDocumentClassificationJobRequest>
  Model::StartDocumentClassificationJobOutcomeCallable StartDocumentClassificationJobCallable(
      const StartDocumentClassificationJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StartDocumentClassificationJob, request);
  }

  /**
   * An Async wrapper for StartDocumentClassificationJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartDocumentClassificationJobRequestT = Model::StartDocumentClassificationJobRequest>
  void StartDocumentClassificationJobAsync(const StartDocumentClassificationJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StartDominantLanguageDetectionJobOutcome StartDominantLanguageDetectionJob(
      const Model::StartDominantLanguageDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for StartDominantLanguageDetectionJob that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartDominantLanguageDetectionJobRequestT = Model::StartDominantLanguageDetectionJobRequest>
  Model::StartDominantLanguageDetectionJobOutcomeCallable StartDominantLanguageDetectionJobCallable(
      const StartDominantLanguageDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StartDominantLanguageDetectionJob, request);
  }

  /**
   * An Async wrapper for StartDominantLanguageDetectionJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartDominantLanguageDetectionJobRequestT = Model::StartDominantLanguageDetectionJobRequest>
  void StartDominantLanguageDetectionJobAsync(const StartDominantLanguageDetectionJobRequestT& request,
  ...
  /**
   * A Callable wrapper for StartEntitiesDetectionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartEntitiesDetectionJobRequestT = Model::StartEntitiesDetectionJobRequest>
  Model::StartEntitiesDetectionJobOutcomeCallable StartEntitiesDetectionJobCallable(
      const StartEntitiesDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StartEntitiesDetectionJob, request);
  }

  /**
   * An Async wrapper for StartEntitiesDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartEntitiesDetectionJobRequestT = Model::StartEntitiesDetectionJobRequest>
  void StartEntitiesDetectionJobAsync(const StartEntitiesDetectionJobRequestT& request,
  ...
  /**
   * A Callable wrapper for StartEventsDetectionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartEventsDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartEventsDetectionJobRequestT = Model::StartEventsDetectionJobRequest>
  void StartEventsDetectionJobAsync(const StartEventsDetectionJobRequestT& request,
  ...
  /**
   * A Callable wrapper for StartFlywheelIteration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartFlywheelIteration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartFlywheelIterationRequestT = Model::StartFlywheelIterationRequest>
  void StartFlywheelIterationAsync(const StartFlywheelIterationRequestT& request,
                                   const StartFlywheelIterationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartKeyPhrasesDetectionJobOutcome StartKeyPhrasesDetectionJob(
      const Model::StartKeyPhrasesDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for StartKeyPhrasesDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartKeyPhrasesDetectionJobRequestT = Model::StartKeyPhrasesDetectionJobRequest>
  Model::StartKeyPhrasesDetectionJobOutcomeCallable StartKeyPhrasesDetectionJobCallable(
      const StartKeyPhrasesDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StartKeyPhrasesDetectionJob, request);
  }

  /**
   * An Async wrapper for StartKeyPhrasesDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartKeyPhrasesDetectionJobRequestT = Model::StartKeyPhrasesDetectionJobRequest>
  void StartKeyPhrasesDetectionJobAsync(const StartKeyPhrasesDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StartPiiEntitiesDetectionJobOutcome StartPiiEntitiesDetectionJob(
      const Model::StartPiiEntitiesDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for StartPiiEntitiesDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartPiiEntitiesDetectionJobRequestT = Model::StartPiiEntitiesDetectionJobRequest>
  Model::StartPiiEntitiesDetectionJobOutcomeCallable StartPiiEntitiesDetectionJobCallable(
      const StartPiiEntitiesDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StartPiiEntitiesDetectionJob, request);
  }

  /**
   * An Async wrapper for StartPiiEntitiesDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartPiiEntitiesDetectionJobRequestT = Model::StartPiiEntitiesDetectionJobRequest>
  void StartPiiEntitiesDetectionJobAsync(const StartPiiEntitiesDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StartSentimentDetectionJobOutcome StartSentimentDetectionJob(
      const Model::StartSentimentDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for StartSentimentDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartSentimentDetectionJobRequestT = Model::StartSentimentDetectionJobRequest>
  Model::StartSentimentDetectionJobOutcomeCallable StartSentimentDetectionJobCallable(
      const StartSentimentDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StartSentimentDetectionJob, request);
  }

  /**
   * An Async wrapper for StartSentimentDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartSentimentDetectionJobRequestT = Model::StartSentimentDetectionJobRequest>
  void StartSentimentDetectionJobAsync(const StartSentimentDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StartTargetedSentimentDetectionJobOutcome StartTargetedSentimentDetectionJob(
      const Model::StartTargetedSentimentDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for StartTargetedSentimentDetectionJob that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartTargetedSentimentDetectionJobRequestT = Model::StartTargetedSentimentDetectionJobRequest>
  Model::StartTargetedSentimentDetectionJobOutcomeCallable StartTargetedSentimentDetectionJobCallable(
      const StartTargetedSentimentDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StartTargetedSentimentDetectionJob, request);
  }

  /**
   * An Async wrapper for StartTargetedSentimentDetectionJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartTargetedSentimentDetectionJobRequestT = Model::StartTargetedSentimentDetectionJobRequest>
  void StartTargetedSentimentDetectionJobAsync(const StartTargetedSentimentDetectionJobRequestT& request,
                                               const StartTargetedSentimentDetectionJobResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartTopicsDetectionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartTopicsDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartTopicsDetectionJobRequestT = Model::StartTopicsDetectionJobRequest>
  void StartTopicsDetectionJobAsync(const StartTopicsDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StopDominantLanguageDetectionJobOutcome StopDominantLanguageDetectionJob(
      const Model::StopDominantLanguageDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for StopDominantLanguageDetectionJob that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StopDominantLanguageDetectionJobRequestT = Model::StopDominantLanguageDetectionJobRequest>
  Model::StopDominantLanguageDetectionJobOutcomeCallable StopDominantLanguageDetectionJobCallable(
      const StopDominantLanguageDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StopDominantLanguageDetectionJob, request);
  }

  /**
   * An Async wrapper for StopDominantLanguageDetectionJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StopDominantLanguageDetectionJobRequestT = Model::StopDominantLanguageDetectionJobRequest>
  void StopDominantLanguageDetectionJobAsync(const StopDominantLanguageDetectionJobRequestT& request,
  ...
  /**
   * A Callable wrapper for StopEntitiesDetectionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopEntitiesDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopEntitiesDetectionJobRequestT = Model::StopEntitiesDetectionJobRequest>
  void StopEntitiesDetectionJobAsync(const StopEntitiesDetectionJobRequestT& request,
  ...
  /**
   * A Callable wrapper for StopEventsDetectionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopEventsDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopEventsDetectionJobRequestT = Model::StopEventsDetectionJobRequest>
  void StopEventsDetectionJobAsync(const StopEventsDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StopKeyPhrasesDetectionJobOutcome StopKeyPhrasesDetectionJob(
      const Model::StopKeyPhrasesDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for StopKeyPhrasesDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopKeyPhrasesDetectionJobRequestT = Model::StopKeyPhrasesDetectionJobRequest>
  Model::StopKeyPhrasesDetectionJobOutcomeCallable StopKeyPhrasesDetectionJobCallable(
      const StopKeyPhrasesDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StopKeyPhrasesDetectionJob, request);
  }

  /**
   * An Async wrapper for StopKeyPhrasesDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopKeyPhrasesDetectionJobRequestT = Model::StopKeyPhrasesDetectionJobRequest>
  void StopKeyPhrasesDetectionJobAsync(const StopKeyPhrasesDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StopPiiEntitiesDetectionJobOutcome StopPiiEntitiesDetectionJob(
      const Model::StopPiiEntitiesDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for StopPiiEntitiesDetectionJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopPiiEntitiesDetectionJobRequestT = Model::StopPiiEntitiesDetectionJobRequest>
  Model::StopPiiEntitiesDetectionJobOutcomeCallable StopPiiEntitiesDetectionJobCallable(
      const StopPiiEntitiesDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StopPiiEntitiesDetectionJob, request);
  }

  /**
   * An Async wrapper for StopPiiEntitiesDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopPiiEntitiesDetectionJobRequestT = Model::StopPiiEntitiesDetectionJobRequest>
  void StopPiiEntitiesDetectionJobAsync(const StopPiiEntitiesDetectionJobRequestT& request,
  ...
  /**
   * A Callable wrapper for StopSentimentDetectionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StopSentimentDetectionJobRequestT = Model::StopSentimentDetectionJobRequest>
  Model::StopSentimentDetectionJobOutcomeCallable StopSentimentDetectionJobCallable(
      const StopSentimentDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StopSentimentDetectionJob, request);
  }

  /**
   * An Async wrapper for StopSentimentDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopSentimentDetectionJobRequestT = Model::StopSentimentDetectionJobRequest>
  void StopSentimentDetectionJobAsync(const StopSentimentDetectionJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StopTargetedSentimentDetectionJobOutcome StopTargetedSentimentDetectionJob(
      const Model::StopTargetedSentimentDetectionJobRequest& request) const;

  /**
   * A Callable wrapper for StopTargetedSentimentDetectionJob that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StopTargetedSentimentDetectionJobRequestT = Model::StopTargetedSentimentDetectionJobRequest>
  Model::StopTargetedSentimentDetectionJobOutcomeCallable StopTargetedSentimentDetectionJobCallable(
      const StopTargetedSentimentDetectionJobRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StopTargetedSentimentDetectionJob, request);
  }

  /**
   * An Async wrapper for StopTargetedSentimentDetectionJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StopTargetedSentimentDetectionJobRequestT = Model::StopTargetedSentimentDetectionJobRequest>
  void StopTargetedSentimentDetectionJobAsync(const StopTargetedSentimentDetectionJobRequestT& request,
                                              const StopTargetedSentimentDetectionJobResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StopTrainingDocumentClassifierOutcome StopTrainingDocumentClassifier(
      const Model::StopTrainingDocumentClassifierRequest& request) const;

  /**
   * A Callable wrapper for StopTrainingDocumentClassifier that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopTrainingDocumentClassifierRequestT = Model::StopTrainingDocumentClassifierRequest>
  Model::StopTrainingDocumentClassifierOutcomeCallable StopTrainingDocumentClassifierCallable(
      const StopTrainingDocumentClassifierRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StopTrainingDocumentClassifier, request);
  }

  /**
   * An Async wrapper for StopTrainingDocumentClassifier that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StopTrainingDocumentClassifierRequestT = Model::StopTrainingDocumentClassifierRequest>
  void StopTrainingDocumentClassifierAsync(const StopTrainingDocumentClassifierRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StopTrainingEntityRecognizerOutcome StopTrainingEntityRecognizer(
      const Model::StopTrainingEntityRecognizerRequest& request) const;

  /**
   * A Callable wrapper for StopTrainingEntityRecognizer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopTrainingEntityRecognizerRequestT = Model::StopTrainingEntityRecognizerRequest>
  Model::StopTrainingEntityRecognizerOutcomeCallable StopTrainingEntityRecognizerCallable(
      const StopTrainingEntityRecognizerRequestT& request) const {
    return SubmitCallable(&ComprehendClient::StopTrainingEntityRecognizer, request);
  }

  /**
   * An Async wrapper for StopTrainingEntityRecognizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopTrainingEntityRecognizerRequestT = Model::StopTrainingEntityRecognizerRequest>
  void StopTrainingEntityRecognizerAsync(const StopTrainingEntityRecognizerRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateFlywheel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateFlywheelRequestT = Model::UpdateFlywheelRequest>
  void UpdateFlywheelAsync(const UpdateFlywheelRequestT& request, const UpdateFlywheelResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
