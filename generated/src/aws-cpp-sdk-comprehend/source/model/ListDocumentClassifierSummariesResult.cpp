...
ListDocumentClassifierSummariesResult& ListDocumentClassifierSummariesResult::operator=(
  ...
  if (jsonValue.ValueExists("DocumentClassifierSummariesList")) {
    ...
    for (unsigned documentClassifierSummariesListIndex = 0;
         documentClassifierSummariesListIndex < documentClassifierSummariesListJsonList.GetLength();
         ++documentClassifierSummariesListIndex) {
