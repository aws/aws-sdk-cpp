...
SentimentDetectionJobProperties::SentimentDetectionJobProperties(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue SentimentDetectionJobProperties::Jsonize() const {
  JsonValue payload;
