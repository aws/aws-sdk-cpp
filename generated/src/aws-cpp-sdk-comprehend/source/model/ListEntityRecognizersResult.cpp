...
ListEntityRecognizersResult& ListEntityRecognizersResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("EntityRecognizerPropertiesList")) {
    ...
    for (unsigned entityRecognizerPropertiesListIndex = 0;
         entityRecognizerPropertiesListIndex < entityRecognizerPropertiesListJsonList.GetLength(); ++entityRecognizerPropertiesListIndex) {
