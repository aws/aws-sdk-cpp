...
ListDocumentClassificationJobsResult& ListDocumentClassificationJobsResult::operator=(
  ...
  if (jsonValue.ValueExists("DocumentClassificationJobPropertiesList")) {
    Aws::Utils::Array<JsonView> documentClassificationJobPropertiesListJsonList =
        jsonValue.GetArray("DocumentClassificationJobPropertiesList");
    for (unsigned documentClassificationJobPropertiesListIndex = 0;
         documentClassificationJobPropertiesListIndex < documentClassificationJobPropertiesListJsonList.GetLength();
         ++documentClassificationJobPropertiesListIndex) {
      m_documentClassificationJobPropertiesList.push_back(
          documentClassificationJobPropertiesListJsonList[documentClassificationJobPropertiesListIndex].AsObject());
    }
