...
DominantLanguageDetectionJobFilter::DominantLanguageDetectionJobFilter(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue DominantLanguageDetectionJobFilter::Jsonize() const {
  JsonValue payload;
