...
ListSentimentDetectionJobsResult& ListSentimentDetectionJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("SentimentDetectionJobPropertiesList")) {
    ...
    for (unsigned sentimentDetectionJobPropertiesListIndex = 0;
         sentimentDetectionJobPropertiesListIndex < sentimentDetectionJobPropertiesListJsonList.GetLength();
         ++sentimentDetectionJobPropertiesListIndex) {
      m_sentimentDetectionJobPropertiesList.push_back(
          sentimentDetectionJobPropertiesListJsonList[sentimentDetectionJobPropertiesListIndex].AsObject());
    }
