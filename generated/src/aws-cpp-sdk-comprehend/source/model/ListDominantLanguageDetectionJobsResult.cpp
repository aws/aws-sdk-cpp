...
ListDominantLanguageDetectionJobsResult& ListDominantLanguageDetectionJobsResult::operator=(
  ...
  if (jsonValue.ValueExists("DominantLanguageDetectionJobPropertiesList")) {
    Aws::Utils::Array<JsonView> dominantLanguageDetectionJobPropertiesListJsonList =
        jsonValue.GetArray("DominantLanguageDetectionJobPropertiesList");
    for (unsigned dominantLanguageDetectionJobPropertiesListIndex = 0;
         dominantLanguageDetectionJobPropertiesListIndex < dominantLanguageDetectionJobPropertiesListJsonList.GetLength();
         ++dominantLanguageDetectionJobPropertiesListIndex) {
      m_dominantLanguageDetectionJobPropertiesList.push_back(
          dominantLanguageDetectionJobPropertiesListJsonList[dominantLanguageDetectionJobPropertiesListIndex].AsObject());
    }
