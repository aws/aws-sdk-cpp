...
ListKeyPhrasesDetectionJobsResult& ListKeyPhrasesDetectionJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("KeyPhrasesDetectionJobPropertiesList")) {
    ...
    for (unsigned keyPhrasesDetectionJobPropertiesListIndex = 0;
         keyPhrasesDetectionJobPropertiesListIndex < keyPhrasesDetectionJobPropertiesListJsonList.GetLength();
         ++keyPhrasesDetectionJobPropertiesListIndex) {
      m_keyPhrasesDetectionJobPropertiesList.push_back(
          keyPhrasesDetectionJobPropertiesListJsonList[keyPhrasesDetectionJobPropertiesListIndex].AsObject());
    }
