...
ListPiiEntitiesDetectionJobsResult& ListPiiEntitiesDetectionJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("PiiEntitiesDetectionJobPropertiesList")) {
    ...
    for (unsigned piiEntitiesDetectionJobPropertiesListIndex = 0;
         piiEntitiesDetectionJobPropertiesListIndex < piiEntitiesDetectionJobPropertiesListJsonList.GetLength();
         ++piiEntitiesDetectionJobPropertiesListIndex) {
      m_piiEntitiesDetectionJobPropertiesList.push_back(
          piiEntitiesDetectionJobPropertiesListJsonList[piiEntitiesDetectionJobPropertiesListIndex].AsObject());
    }
