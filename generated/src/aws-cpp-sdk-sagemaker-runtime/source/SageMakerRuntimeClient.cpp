...
SageMakerRuntimeClient::~SageMakerRuntimeClient() { ShutdownSdkClient(this, -1); }

std::shared_ptr<SageMakerRuntimeEndpointProviderBase>& SageMakerRuntimeClient::accessEndpointProvider() { return m_endpointProvider; }
...
SageMakerRuntimeClient::InvokeOperationOutcome SageMakerRuntimeClient::InvokeServiceOperation(
...
InvokeEndpointOutcome SageMakerRuntimeClient::InvokeEndpoint(const InvokeEndpointRequest& request) const {
  ...
  if (!request.EndpointNameHasBeenSet()) {
    ...
    return InvokeEndpointOutcome(Aws::Client::AWSError<SageMakerRuntimeErrors>(
        SageMakerRuntimeErrors::MISSING_PARAMETER, "MISSING_PARAMETER", "Missing required field [EndpointName]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<InvokeEndpointOutcome>(
      [&]() -> InvokeEndpointOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, InvokeEndpoint, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        ...
        return result.IsSuccess() ? InvokeEndpointOutcome(InvokeEndpointResult(result.GetResultWithOwnership()))
                                  : InvokeEndpointOutcome(result.GetError());
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
       {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
...
InvokeEndpointAsyncOutcome SageMakerRuntimeClient::InvokeEndpointAsync(const InvokeEndpointAsyncRequest& request) const {
  if (!request.EndpointNameHasBeenSet()) {
    ...
    return InvokeEndpointAsyncOutcome(Aws::Client::AWSError<SageMakerRuntimeErrors>(
        SageMakerRuntimeErrors::MISSING_PARAMETER, "MISSING_PARAMETER", "Missing required field [EndpointName]", false));
  }
  if (!request.InputLocationHasBeenSet()) {
    AWS_LOGSTREAM_ERROR("InvokeEndpointAsync", "Required field: InputLocation, is not set");
    return InvokeEndpointAsyncOutcome(Aws::Client::AWSError<SageMakerRuntimeErrors>(
        SageMakerRuntimeErrors::MISSING_PARAMETER, "MISSING_PARAMETER", "Missing required field [InputLocation]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<InvokeEndpointAsyncOutcome>(
      [&]() -> InvokeEndpointAsyncOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, InvokeEndpointAsync, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/endpoints/");
        endpointResolutionOutcome.GetResult().AddPathSegment(request.GetEndpointName());
        ...
        return result.IsSuccess() ? InvokeEndpointAsyncOutcome(InvokeEndpointAsyncResult(result.GetResultWithOwnership()))
                                  : InvokeEndpointAsyncOutcome(result.GetError());
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
       {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
...
InvokeEndpointWithResponseStreamOutcome SageMakerRuntimeClient::InvokeEndpointWithResponseStream(
    InvokeEndpointWithResponseStreamRequest& request) const {
  ...
  if (!request.EndpointNameHasBeenSet()) {
    ...
    return InvokeEndpointWithResponseStreamOutcome(Aws::Client::AWSError<SageMakerRuntimeErrors>(
        SageMakerRuntimeErrors::MISSING_PARAMETER, "MISSING_PARAMETER", "Missing required field [EndpointName]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<InvokeEndpointWithResponseStreamOutcome>(
      [&]() -> InvokeEndpointWithResponseStreamOutcome {
        auto endpointResolutionOutcome = TracingUtils::MakeCallWithTiming<ResolveEndpointOutcome>(
            ...
            {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
             {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, InvokeEndpointWithResponseStream, CoreErrors,
        ...
        if (!request.GetHeadersReceivedEventHandler()) {
          request.SetHeadersReceivedEventHandler([&request](const Http::HttpRequest*, Http::HttpResponse* response) {
            AWS_CHECK_PTR("InvokeEndpointWithResponseStream", response);
