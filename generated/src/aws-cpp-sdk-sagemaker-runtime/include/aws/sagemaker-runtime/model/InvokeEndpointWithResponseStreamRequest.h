...
class InvokeEndpointWithResponseStreamRequest : public StreamingSageMakerRuntimeRequest {
 public:
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const InvokeEndpointWithResponseStreamHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline InvokeEndpointWithResponseStreamRequest& WithEventStreamHandler(const InvokeEndpointWithResponseStreamHandler& value) {
  ...
  template <typename PrefixAwareIdT = Aws::String>
  InvokeEndpointWithResponseStreamRequest& WithPrefixAwareId(PrefixAwareIdT&& value) {
