...
class InvokeEndpointResult {
 public:
  ...
  void SetNewSessionId(NewSessionIdT&& value) {
    ...
    m_newSessionId = std::forward<NewSessionIdT>(value);
  }
  template <typename NewSessionIdT = Aws::String>
  InvokeEndpointResult& WithNewSessionId(NewSessionIdT&& value) {
    SetNewSessionId(std::forward<NewSessionIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClosedSessionId(ClosedSessionIdT&& value) {
    ...
    m_closedSessionId = std::forward<ClosedSessionIdT>(value);
  }
  template <typename ClosedSessionIdT = Aws::String>
  InvokeEndpointResult& WithClosedSessionId(ClosedSessionIdT&& value) {
    SetClosedSessionId(std::forward<ClosedSessionIdT>(value));
    return *this;
  }
  ///@}
