...
namespace SageMakerRuntime
{
   ...
   */
  class AWS_SAGEMAKERRUNTIME_API SageMakerRuntimeClient : Aws::Client::ClientWithAsyncTemplateMethods<SageMakerRuntimeClient>,
    smithy::client::AwsSmithyClientT<Aws::SageMakerRuntime::SERVICE_NAME,
