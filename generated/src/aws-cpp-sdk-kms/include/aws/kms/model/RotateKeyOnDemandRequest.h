...
namespace Model
{
  ...
  {
  public:
    AWS_KMS_API RotateKeyOnDemandRequest();
     ...
     * <a>ListKeys</a> or <a>DescribeKey</a>.</p>
     */
    inline RotateKeyOnDemandRequest& WithKeyId(const Aws::String& value) { SetKeyId(value); return *this;}
     ...
     * <a>ListKeys</a> or <a>DescribeKey</a>.</p>
     */
    inline RotateKeyOnDemandRequest& WithKeyId(Aws::String&& value) { SetKeyId(std::move(value)); return *this;}
     ...
     * <a>ListKeys</a> or <a>DescribeKey</a>.</p>
     */
    inline RotateKeyOnDemandRequest& WithKeyId(const char* value) { SetKeyId(value); return *this;}
