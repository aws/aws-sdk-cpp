...
namespace Model
{
  ...
  public:
    ...
    template<typename KeyIdT = Aws::String>
    ListKeyPoliciesRequest& WithKeyId(KeyIdT&& value) { SetKeyId(std::forward<KeyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListKeyPoliciesRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
  private:
