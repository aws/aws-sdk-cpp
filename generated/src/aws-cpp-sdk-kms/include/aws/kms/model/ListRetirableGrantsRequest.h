...
namespace Model
{
  ...
  public:
    ...
    template<typename MarkerT = Aws::String>
    ListRetirableGrantsRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename RetiringPrincipalT = Aws::String>
    ListRetirableGrantsRequest& WithRetiringPrincipal(RetiringPrincipalT&& value) { SetRetiringPrincipal(std::forward<RetiringPrincipalT>(value)); return *this;}
    ///@}
  private:
