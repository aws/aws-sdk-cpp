...
class GenerateMacRequest : public KMSRequest {
 public:
  ...
  inline void SetMacAlgorithm(MacAlgorithmSpec value) {
    m_macAlgorithmHasBeenSet = true;
    m_macAlgorithm = value;
  }
  inline GenerateMacRequest& WithMacAlgorithm(MacAlgorithmSpec value) {
  ...
  inline GenerateMacRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
