...
class UpdateCustomKeyStoreRequest : public KMSRequest {
 public:
  ...
  void SetNewCustomKeyStoreName(NewCustomKeyStoreNameT&& value) {
    m_newCustomKeyStoreNameHasBeenSet = true;
    m_newCustomKeyStoreName = std::forward<NewCustomKeyStoreNameT>(value);
  }
  template <typename NewCustomKeyStoreNameT = Aws::String>
  UpdateCustomKeyStoreRequest& WithNewCustomKeyStoreName(NewCustomKeyStoreNameT&& value) {
    SetNewCustomKeyStoreName(std::forward<NewCustomKeyStoreNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateCustomKeyStoreRequest& WithXksProxyConnectivity(XksProxyConnectivityType value) {
