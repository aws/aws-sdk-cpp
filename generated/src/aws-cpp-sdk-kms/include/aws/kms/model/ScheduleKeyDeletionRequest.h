...
class ScheduleKeyDeletionRequest : public KMSRequest {
 public:
  ...
  template <typename KeyIdT = Aws::String>
  ScheduleKeyDeletionRequest& WithKeyId(KeyIdT&& value) {
  ...
  inline void SetPendingWindowInDays(int value) {
    m_pendingWindowInDaysHasBeenSet = true;
    m_pendingWindowInDays = value;
  }
  inline ScheduleKeyDeletionRequest& WithPendingWindowInDays(int value) {
    SetPendingWindowInDays(value);
    return *this;
  }
  ///@}
 private:
