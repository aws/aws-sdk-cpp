...
class ListKeyRotationsRequest : public KMSRequest {
 public:
  ...
  inline void SetIncludeKeyMaterial(IncludeKeyMaterial value) {
    m_includeKeyMaterialHasBeenSet = true;
    m_includeKeyMaterial = value;
  }
  inline ListKeyRotationsRequest& WithIncludeKeyMaterial(IncludeKeyMaterial value) {
    SetIncludeKeyMaterial(value);
    return *this;
  }
  ///@}
  ...
  inline ListKeyRotationsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
