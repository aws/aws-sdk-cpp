...
class SignRequest : public KMSRequest {
 public:
  ...
  inline SignRequest& WithMessageType(MessageType value) {
  ...
  inline SignRequest& WithSigningAlgorithm(SigningAlgorithmSpec value) {
  ...
  inline SignRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
