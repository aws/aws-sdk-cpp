...
class DescribeCustomKeyStoresResult {
 public:
  ...
  void SetCustomKeyStores(CustomKeyStoresT&& value) {
    ...
    m_customKeyStores = std::forward<CustomKeyStoresT>(value);
  }
  template <typename CustomKeyStoresT = Aws::Vector<CustomKeyStoresListEntry>>
  DescribeCustomKeyStoresResult& WithCustomKeyStores(CustomKeyStoresT&& value) {
    SetCustomKeyStores(std::forward<CustomKeyStoresT>(value));
    return *this;
  }
  ...
  DescribeCustomKeyStoresResult& AddCustomKeyStores(CustomKeyStoresT&& value) {
    m_customKeyStoresHasBeenSet = true;
    m_customKeyStores.emplace_back(std::forward<CustomKeyStoresT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeCustomKeyStoresResult& WithTruncated(bool value) {
    SetTruncated(value);
    return *this;
  }
  ///@}
