...
class ReEncryptResult {
 public:
  ...
  inline ReEncryptResult& WithSourceEncryptionAlgorithm(EncryptionAlgorithmSpec value) {
  ...
  inline ReEncryptResult& WithDestinationEncryptionAlgorithm(EncryptionAlgorithmSpec value) {
  ...
  void SetSourceKeyMaterialId(SourceKeyMaterialIdT&& value) {
    ...
    m_sourceKeyMaterialId = std::forward<SourceKeyMaterialIdT>(value);
  }
  template <typename SourceKeyMaterialIdT = Aws::String>
  ReEncryptResult& WithSourceKeyMaterialId(SourceKeyMaterialIdT&& value) {
    SetSourceKeyMaterialId(std::forward<SourceKeyMaterialIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationKeyMaterialId(DestinationKeyMaterialIdT&& value) {
    ...
    m_destinationKeyMaterialId = std::forward<DestinationKeyMaterialIdT>(value);
  }
  template <typename DestinationKeyMaterialIdT = Aws::String>
  ReEncryptResult& WithDestinationKeyMaterialId(DestinationKeyMaterialIdT&& value) {
    SetDestinationKeyMaterialId(std::forward<DestinationKeyMaterialIdT>(value));
    return *this;
  }
  ///@}
