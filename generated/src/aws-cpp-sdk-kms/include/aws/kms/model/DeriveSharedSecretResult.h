...
class DeriveSharedSecretResult {
 public:
  ...
  ///@{
  /**
   * <p>The plaintext shared secret encrypted with the public key from the
  ...
  inline void SetKeyAgreementAlgorithm(KeyAgreementAlgorithmSpec value) {
    m_keyAgreementAlgorithmHasBeenSet = true;
    m_keyAgreementAlgorithm = value;
  }
  inline DeriveSharedSecretResult& WithKeyAgreementAlgorithm(KeyAgreementAlgorithmSpec value) {
    SetKeyAgreementAlgorithm(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKeyOrigin(OriginType value) {
    m_keyOriginHasBeenSet = true;
    m_keyOrigin = value;
  }
  inline DeriveSharedSecretResult& WithKeyOrigin(OriginType value) {
    SetKeyOrigin(value);
    return *this;
  }
  ///@}
