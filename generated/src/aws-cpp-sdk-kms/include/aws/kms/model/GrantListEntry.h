...
class GrantListEntry {
 public:
  ...
  void SetIssuingAccount(IssuingAccountT&& value) {
    ...
    m_issuingAccount = std::forward<IssuingAccountT>(value);
  }
  template <typename IssuingAccountT = Aws::String>
  GrantListEntry& WithIssuingAccount(IssuingAccountT&& value) {
    SetIssuingAccount(std::forward<IssuingAccountT>(value));
    return *this;
  }
  ///@}
  ...
  inline GrantListEntry& AddOperations(GrantOperation value) {
    m_operationsHasBeenSet = true;
