...
namespace Model
{
  ...
  {
  public:
    AWS_KMS_API DisconnectCustomKeyStoreResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisconnectCustomKeyStoreResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
