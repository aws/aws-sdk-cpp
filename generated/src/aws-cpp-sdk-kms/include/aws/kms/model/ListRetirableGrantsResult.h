...
namespace Model
{
  ...
  public:
    ...
    template<typename GrantsT = Aws::Vector<GrantListEntry>>
    ListRetirableGrantsResult& WithGrants(GrantsT&& value) { SetGrants(std::forward<GrantsT>(value)); return *this;}
    template<typename GrantsT = GrantListEntry>
    ListRetirableGrantsResult& AddGrants(GrantsT&& value) { m_grantsHasBeenSet = true; m_grants.emplace_back(std::forward<GrantsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextMarkerT = Aws::String>
    ListRetirableGrantsResult& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListRetirableGrantsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
