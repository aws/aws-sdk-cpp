...
namespace Model
{
  ...
  {
  public:
    AWS_KMS_API ConnectCustomKeyStoreResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ConnectCustomKeyStoreResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
