...
class UpdateAliasRequest : public KMSRequest {
 public:
  ...
  template <typename AliasNameT = Aws::String>
  UpdateAliasRequest& WithAliasName(AliasNameT&& value) {
  ...
  void SetTargetKeyId(TargetKeyIdT&& value) {
    ...
    m_targetKeyId = std::forward<TargetKeyIdT>(value);
  }
  template <typename TargetKeyIdT = Aws::String>
  UpdateAliasRequest& WithTargetKeyId(TargetKeyIdT&& value) {
    SetTargetKeyId(std::forward<TargetKeyIdT>(value));
    return *this;
  }
  ///@}
 private:
