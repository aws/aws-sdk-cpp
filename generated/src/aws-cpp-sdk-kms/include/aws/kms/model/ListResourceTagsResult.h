...
class ListResourceTagsResult {
 public:
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ListResourceTagsResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ListResourceTagsResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename NextMarkerT = Aws::String>
  ListResourceTagsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  inline ListResourceTagsResult& WithTruncated(bool value) {
    SetTruncated(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceTagsResult& WithRequestId(RequestIdT&& value) {
