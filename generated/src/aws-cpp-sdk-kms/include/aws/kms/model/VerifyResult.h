...
class VerifyResult {
 public:
  ...
  inline void SetSignatureValid(bool value) {
    m_signatureValidHasBeenSet = true;
    m_signatureValid = value;
  }
  inline VerifyResult& WithSignatureValid(bool value) {
    SetSignatureValid(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSigningAlgorithm(SigningAlgorithmSpec value) {
    m_signingAlgorithmHasBeenSet = true;
    m_signingAlgorithm = value;
  }
  inline VerifyResult& WithSigningAlgorithm(SigningAlgorithmSpec value) {
