...
namespace Model
{
  ...
  /**
   */
  class DisconnectCustomKeyStoreRequest : public KMSRequest
  {
  public:
    AWS_KMS_API DisconnectCustomKeyStoreRequest() = default;
    ...
    template<typename CustomKeyStoreIdT = Aws::String>
    DisconnectCustomKeyStoreRequest& WithCustomKeyStoreId(CustomKeyStoreIdT&& value) { SetCustomKeyStoreId(std::forward<CustomKeyStoreIdT>(value)); return *this;}
    ///@}
  private:
