...
class GetPublicKeyResult {
 public:
  ...
  inline GetPublicKeyResult& WithKeySpec(KeySpec value) {
    SetKeySpec(value);
    return *this;
  }
  ///@}
  ...
  inline GetPublicKeyResult& WithKeyUsage(KeyUsageType value) {
    SetKeyUsage(value);
    return *this;
  }
  ///@}
  ...
  inline GetPublicKeyResult& AddEncryptionAlgorithms(EncryptionAlgorithmSpec value) {
    m_encryptionAlgorithmsHasBeenSet = true;
  ...
  inline GetPublicKeyResult& AddSigningAlgorithms(SigningAlgorithmSpec value) {
    m_signingAlgorithmsHasBeenSet = true;
  ...
  inline GetPublicKeyResult& AddKeyAgreementAlgorithms(KeyAgreementAlgorithmSpec value) {
    m_keyAgreementAlgorithmsHasBeenSet = true;
