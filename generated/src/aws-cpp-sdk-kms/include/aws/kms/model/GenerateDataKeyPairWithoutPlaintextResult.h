...
class GenerateDataKeyPairWithoutPlaintextResult {
 public:
  ...
  template <typename PrivateKeyCiphertextBlobT = Aws::Utils::ByteBuffer>
  GenerateDataKeyPairWithoutPlaintextResult& WithPrivateKeyCiphertextBlob(PrivateKeyCiphertextBlobT&& value) {
  ...
  template <typename PublicKeyT = Aws::Utils::ByteBuffer>
  GenerateDataKeyPairWithoutPlaintextResult& WithPublicKey(PublicKeyT&& value) {
  ...
  template <typename KeyIdT = Aws::String>
  GenerateDataKeyPairWithoutPlaintextResult& WithKeyId(KeyIdT&& value) {
  ...
  inline GenerateDataKeyPairWithoutPlaintextResult& WithKeyPairSpec(DataKeyPairSpec value) {
  ...
  template <typename KeyMaterialIdT = Aws::String>
  GenerateDataKeyPairWithoutPlaintextResult& WithKeyMaterialId(KeyMaterialIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GenerateDataKeyPairWithoutPlaintextResult& WithRequestId(RequestIdT&& value) {
