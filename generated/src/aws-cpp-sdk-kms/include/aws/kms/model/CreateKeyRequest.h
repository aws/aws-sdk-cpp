...
class CreateKeyRequest : public KMSRequest {
 public:
  ...
  inline CreateKeyRequest& WithKeyUsage(KeyUsageType value) {
    SetKeyUsage(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKeyRequest& WithKeySpec(KeySpec value) {
    SetKeySpec(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKeyRequest& WithOrigin(OriginType value) {
    SetOrigin(value);
    return *this;
  }
  ///@}
  ...
  inline CreateKeyRequest& WithBypassPolicyLockoutSafetyCheck(bool value) {
  ...
  inline CreateKeyRequest& WithMultiRegion(bool value) {
  ...
  void SetXksKeyId(XksKeyIdT&& value) {
    m_xksKeyIdHasBeenSet = true;
    m_xksKeyId = std::forward<XksKeyIdT>(value);
  }
  template <typename XksKeyIdT = Aws::String>
  CreateKeyRequest& WithXksKeyId(XksKeyIdT&& value) {
    SetXksKeyId(std::forward<XksKeyIdT>(value));
    return *this;
  }
  ///@}
 private:
