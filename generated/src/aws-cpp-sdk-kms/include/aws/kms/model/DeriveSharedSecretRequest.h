...
class DeriveSharedSecretRequest : public KMSRequest {
 public:
  ...
  inline DeriveSharedSecretRequest& WithKeyAgreementAlgorithm(KeyAgreementAlgorithmSpec value) {
  ...
  inline DeriveSharedSecretRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
   ...
   * attestation document use either <a
   ...
   * by the <code>KeyId</code> parameter and public key specified by the
