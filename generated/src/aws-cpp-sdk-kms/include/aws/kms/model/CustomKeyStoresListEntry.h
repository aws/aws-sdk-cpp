...
class CustomKeyStoresListEntry {
 public:
  ...
  template <typename CustomKeyStoreIdT = Aws::String>
  CustomKeyStoresListEntry& WithCustomKeyStoreId(CustomKeyStoreIdT&& value) {
  ...
  template <typename CustomKeyStoreNameT = Aws::String>
  CustomKeyStoresListEntry& WithCustomKeyStoreName(CustomKeyStoreNameT&& value) {
  ...
  template <typename CloudHsmClusterIdT = Aws::String>
  CustomKeyStoresListEntry& WithCloudHsmClusterId(CloudHsmClusterIdT&& value) {
  ...
  template <typename TrustAnchorCertificateT = Aws::String>
  CustomKeyStoresListEntry& WithTrustAnchorCertificate(TrustAnchorCertificateT&& value) {
  ...
  inline void SetConnectionState(ConnectionStateType value) {
    m_connectionStateHasBeenSet = true;
    m_connectionState = value;
  }
  inline CustomKeyStoresListEntry& WithConnectionState(ConnectionStateType value) {
  ...
  inline void SetConnectionErrorCode(ConnectionErrorCodeType value) {
    m_connectionErrorCodeHasBeenSet = true;
    m_connectionErrorCode = value;
  }
  inline CustomKeyStoresListEntry& WithConnectionErrorCode(ConnectionErrorCodeType value) {
    SetConnectionErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  CustomKeyStoresListEntry& WithCreationDate(CreationDateT&& value) {
  ...
  inline CustomKeyStoresListEntry& WithCustomKeyStoreType(CustomKeyStoreType value) {
  ...
  void SetXksProxyConfiguration(XksProxyConfigurationT&& value) {
    m_xksProxyConfigurationHasBeenSet = true;
    m_xksProxyConfiguration = std::forward<XksProxyConfigurationT>(value);
  }
  template <typename XksProxyConfigurationT = XksProxyConfigurationType>
  CustomKeyStoresListEntry& WithXksProxyConfiguration(XksProxyConfigurationT&& value) {
    SetXksProxyConfiguration(std::forward<XksProxyConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
