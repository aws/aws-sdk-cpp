...
class GenerateDataKeyRequest : public KMSRequest {
 public:
  ...
  inline GenerateDataKeyRequest& WithNumberOfBytes(int value) {
  ...
  inline void SetKeySpec(DataKeySpec value) {
    m_keySpecHasBeenSet = true;
    m_keySpec = value;
  }
  inline GenerateDataKeyRequest& WithKeySpec(DataKeySpec value) {
    SetKeySpec(value);
    return *this;
  }
  ///@}
  ...
  inline GenerateDataKeyRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
