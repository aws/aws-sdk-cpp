...
namespace Model
{
  ...
  {
  public:
    AWS_KMS_API UpdateCustomKeyStoreResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateCustomKeyStoreResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
