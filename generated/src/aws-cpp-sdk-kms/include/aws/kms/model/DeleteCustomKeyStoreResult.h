...
namespace Model
{
  ...
  {
  public:
    AWS_KMS_API DeleteCustomKeyStoreResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteCustomKeyStoreResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
