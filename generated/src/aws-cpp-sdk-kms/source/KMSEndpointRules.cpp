...
namespace KMS
{
const size_t KMSEndpointRules::RulesBlobStrLen = 3712;
const size_t KMSEndpointRules::RulesBlobSize = 3713;
...
't','p','s',':','/','/','k','m','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
