...
namespace KMS
{
const size_t KMSEndpointRules::RulesBlobStrLen = 3460;
const size_t KMSEndpointRules::RulesBlobSize = 3461;
...
'"','h','t','t','p','s',':','/','/','k','m','s','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'k','m','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
...
'h','t','t','p','s',':','/','/','k','m','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
const char* KMSEndpointRules::GetRulesBlob()
{
