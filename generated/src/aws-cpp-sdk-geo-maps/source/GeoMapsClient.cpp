...
GeoMapsClient::GeoMapsClient(const AWSCredentials& credentials, std::shared_ptr<GeoMapsEndpointProviderBase> endpointProvider,
...
GeoMapsClient::~GeoMapsClient() { ShutdownSdkClient(this, -1); }

std::shared_ptr<GeoMapsEndpointProviderBase>& GeoMapsClient::accessEndpointProvider() { return m_endpointProvider; }
...
void GeoMapsClient::init(const GeoMaps::GeoMapsClientConfiguration& config) {
  ...
  m_endpointProvider->InitBuiltInParameters(config, "geo-maps");
}
...
GeoMapsClient::InvokeOperationOutcome GeoMapsClient::InvokeServiceOperation(
...
GetGlyphsOutcome GeoMapsClient::GetGlyphs(const GetGlyphsRequest& request) const {
  ...
  if (!request.FontStackHasBeenSet()) {
    ...
    return GetGlyphsOutcome(Aws::Client::AWSError<GeoMapsErrors>(GeoMapsErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
  ...
  return TracingUtils::MakeCallWithTiming<GetGlyphsOutcome>(
      [&]() -> GetGlyphsOutcome {
        ...
        return result.IsSuccess() ? GetGlyphsOutcome(GetGlyphsResult(result.GetResultWithOwnership()))
                                  : GetGlyphsOutcome(result.GetError());
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
       {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
...
GetSpritesOutcome GeoMapsClient::GetSprites(const GetSpritesRequest& request) const {
  ...
  if (!request.FileNameHasBeenSet()) {
    ...
    return GetSpritesOutcome(Aws::Client::AWSError<GeoMapsErrors>(GeoMapsErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
  ...
  return TracingUtils::MakeCallWithTiming<GetSpritesOutcome>(
      [&]() -> GetSpritesOutcome {
        ...
        auto result = MakeRequestWithUnparsedResponse(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_GET);
        return result.IsSuccess() ? GetSpritesOutcome(GetSpritesResult(result.GetResultWithOwnership()))
                                  : GetSpritesOutcome(result.GetError());
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
       {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
...
GetStaticMapOutcome GeoMapsClient::GetStaticMap(const GetStaticMapRequest& request) const {
  ...
  if (!request.HeightHasBeenSet()) {
    ...
    return GetStaticMapOutcome(Aws::Client::AWSError<GeoMapsErrors>(GeoMapsErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                    "Missing required field [Height]", false));
  }
  if (!request.FileNameHasBeenSet()) {
  ...
  if (!request.WidthHasBeenSet()) {
    ...
    return GetStaticMapOutcome(Aws::Client::AWSError<GeoMapsErrors>(GeoMapsErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                    "Missing required field [Width]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<GetStaticMapOutcome>(
      [&]() -> GetStaticMapOutcome {
        ...
        endpointResolutionOutcome.GetResult().AddPathSegment(request.GetFileName());
        auto result = MakeRequestWithUnparsedResponse(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_GET);
        return result.IsSuccess() ? GetStaticMapOutcome(GetStaticMapResult(result.GetResultWithOwnership()))
                                  : GetStaticMapOutcome(result.GetError());
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
       {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
...
GetStyleDescriptorOutcome GeoMapsClient::GetStyleDescriptor(const GetStyleDescriptorRequest& request) const {
  ...
  if (!request.StyleHasBeenSet()) {
    ...
    return GetStyleDescriptorOutcome(Aws::Client::AWSError<GeoMapsErrors>(GeoMapsErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                                          "Missing required field [Style]", false));
  }
  ...
  return TracingUtils::MakeCallWithTiming<GetStyleDescriptorOutcome>(
      [&]() -> GetStyleDescriptorOutcome {
        ...
        auto result = MakeRequestWithUnparsedResponse(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_GET);
        return result.IsSuccess() ? GetStyleDescriptorOutcome(GetStyleDescriptorResult(result.GetResultWithOwnership()))
                                  : GetStyleDescriptorOutcome(result.GetError());
      },
      TracingUtils::SMITHY_CLIENT_DURATION_METRIC, *meter,
      {{TracingUtils::SMITHY_METHOD_DIMENSION, request.GetServiceRequestName()},
       {TracingUtils::SMITHY_SERVICE_DIMENSION, this->GetServiceClientName()}});
...
GetTileOutcome GeoMapsClient::GetTile(const GetTileRequest& request) const {
  ...
  if (!request.TilesetHasBeenSet()) {
    ...
    return GetTileOutcome(Aws::Client::AWSError<GeoMapsErrors>(GeoMapsErrors::MISSING_PARAMETER, "MISSING_PARAMETER",
                                                               "Missing required field [Tileset]", false));
  }
  if (!request.ZHasBeenSet()) {
    AWS_LOGSTREAM_ERROR("GetTile", "Required field: Z, is not set");
    return GetTileOutcome(
        Aws::Client::AWSError<GeoMapsErrors>(GeoMapsErrors::MISSING_PARAMETER, "MISSING_PARAMETER", "Missing required field [Z]", false));
  }
  if (!request.XHasBeenSet()) {
    AWS_LOGSTREAM_ERROR("GetTile", "Required field: X, is not set");
    return GetTileOutcome(
        Aws::Client::AWSError<GeoMapsErrors>(GeoMapsErrors::MISSING_PARAMETER, "MISSING_PARAMETER", "Missing required field [X]", false));
  }
  if (!request.YHasBeenSet()) {
    AWS_LOGSTREAM_ERROR("GetTile", "Required field: Y, is not set");
    return GetTileOutcome(
        Aws::Client::AWSError<GeoMapsErrors>(GeoMapsErrors::MISSING_PARAMETER, "MISSING_PARAMETER", "Missing required field [Y]", false));
  }
