...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/geo-maps-2020-11-19/ValidationExceptionField">AWS
   * API Reference</a></p>
   */
  class ValidationExceptionField
  {
  public:
    AWS_GEOMAPS_API ValidationExceptionField() = default;
    AWS_GEOMAPS_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_GEOMAPS_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
