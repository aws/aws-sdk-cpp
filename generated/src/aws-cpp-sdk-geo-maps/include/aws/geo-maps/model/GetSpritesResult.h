...
class GetSpritesResult {
 public:
  ...
  template <typename ContentTypeT = Aws::String>
  GetSpritesResult& WithContentType(ContentTypeT&& value) {
  ...
  template <typename CacheControlT = Aws::String>
  GetSpritesResult& WithCacheControl(CacheControlT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetSpritesResult& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSpritesResult& WithRequestId(RequestIdT&& value) {
