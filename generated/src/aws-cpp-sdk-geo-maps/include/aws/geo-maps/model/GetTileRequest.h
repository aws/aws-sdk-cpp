...
class GetTileRequest : public GeoMapsRequest {
 public:
  ...
  inline GetTileRequest& AddAdditionalFeatures(TileAdditionalFeature value) {
    m_additionalFeaturesHasBeenSet = true;
  ...
  void SetTileset(TilesetT&& value) {
    m_tilesetHasBeenSet = true;
    m_tileset = std::forward<TilesetT>(value);
  }
  template <typename TilesetT = Aws::String>
  GetTileRequest& WithTileset(TilesetT&& value) {
    SetTileset(std::forward<TilesetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetZ(ZT&& value) {
    m_zHasBeenSet = true;
    m_z = std::forward<ZT>(value);
  }
  template <typename ZT = Aws::String>
  GetTileRequest& WithZ(ZT&& value) {
    SetZ(std::forward<ZT>(value));
    return *this;
  }
  ///@}
  ...
  void SetY(YT&& value) {
    m_yHasBeenSet = true;
    m_y = std::forward<YT>(value);
  }
  template <typename YT = Aws::String>
  GetTileRequest& WithY(YT&& value) {
    SetY(std::forward<YT>(value));
    return *this;
  }
  ///@}
