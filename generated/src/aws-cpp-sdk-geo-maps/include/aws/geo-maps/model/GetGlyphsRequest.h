...
class GetGlyphsRequest : public GeoMapsRequest {
 public:
  ...
  void SetFontStack(FontStackT&& value) {
    m_fontStackHasBeenSet = true;
    m_fontStack = std::forward<FontStackT>(value);
  }
  template <typename FontStackT = Aws::String>
  GetGlyphsRequest& WithFontStack(FontStackT&& value) {
    SetFontStack(std::forward<FontStackT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFontUnicodeRange(FontUnicodeRangeT&& value) {
    m_fontUnicodeRangeHasBeenSet = true;
    m_fontUnicodeRange = std::forward<FontUnicodeRangeT>(value);
  }
  template <typename FontUnicodeRangeT = Aws::String>
  GetGlyphsRequest& WithFontUnicodeRange(FontUnicodeRangeT&& value) {
    SetFontUnicodeRange(std::forward<FontUnicodeRangeT>(value));
    return *this;
  }
  ///@}
 private:
