...
class GetGlyphsResult {
 public:
  ...
  template <typename ContentTypeT = Aws::String>
  GetGlyphsResult& WithContentType(ContentTypeT&& value) {
  ...
  template <typename CacheControlT = Aws::String>
  GetGlyphsResult& WithCacheControl(CacheControlT&& value) {
  ...
  template <typename ETagT = Aws::String>
  GetGlyphsResult& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetGlyphsResult& WithRequestId(RequestIdT&& value) {
