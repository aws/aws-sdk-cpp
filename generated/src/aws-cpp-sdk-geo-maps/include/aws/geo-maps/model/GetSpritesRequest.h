...
class GetSpritesRequest : public GeoMapsRequest {
 public:
  ...
  inline GetSpritesRequest& WithStyle(MapStyle value) {
    SetStyle(value);
    return *this;
  }
  ///@}
  ...
  inline GetSpritesRequest& WithColorScheme(ColorScheme value) {
  ...
  inline void SetVariant(Variant value) {
    m_variantHasBeenSet = true;
    m_variant = value;
  }
  inline GetSpritesRequest& WithVariant(Variant value) {
    SetVariant(value);
    return *this;
  }
  ///@}
