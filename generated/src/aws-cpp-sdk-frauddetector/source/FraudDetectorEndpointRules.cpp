...
{
const size_t FraudDetectorEndpointRules::RulesBlobStrLen = 3752;
const size_t FraudDetectorEndpointRules::RulesBlobSize = 3753;
...
'h','t','t','p','s',':','/','/','f','r','a','u','d','d','e','t','e','c','t','o','r','-','f','i','p',
