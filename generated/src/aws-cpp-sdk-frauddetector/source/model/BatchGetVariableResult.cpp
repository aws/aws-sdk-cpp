...
BatchGetVariableResult::BatchGetVariableResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchGetVariableResult& BatchGetVariableResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
