...
PredictionExplanations::PredictionExplanations(JsonView jsonValue) { *this = jsonValue; }
...
PredictionExplanations& PredictionExplanations::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("variableImpactExplanations")) {
    ...
    for (unsigned variableImpactExplanationsIndex = 0; variableImpactExplanationsIndex < variableImpactExplanationsJsonList.GetLength();
         ++variableImpactExplanationsIndex) {
  ...
  if (jsonValue.ValueExists("aggregatedVariablesImpactExplanations")) {
    ...
    for (unsigned aggregatedVariablesImpactExplanationsIndex = 0;
         aggregatedVariablesImpactExplanationsIndex < aggregatedVariablesImpactExplanationsJsonList.GetLength();
         ++aggregatedVariablesImpactExplanationsIndex) {
      m_aggregatedVariablesImpactExplanations.push_back(
          aggregatedVariablesImpactExplanationsJsonList[aggregatedVariablesImpactExplanationsIndex].AsObject());
    }
...
JsonValue PredictionExplanations::Jsonize() const {
  ...
  if (m_variableImpactExplanationsHasBeenSet) {
    ...
    for (unsigned variableImpactExplanationsIndex = 0; variableImpactExplanationsIndex < variableImpactExplanationsJsonList.GetLength();
         ++variableImpactExplanationsIndex) {
      variableImpactExplanationsJsonList[variableImpactExplanationsIndex].AsObject(
          m_variableImpactExplanations[variableImpactExplanationsIndex].Jsonize());
    }
  ...
  if (m_aggregatedVariablesImpactExplanationsHasBeenSet) {
    ...
    for (unsigned aggregatedVariablesImpactExplanationsIndex = 0;
         ...
         ++aggregatedVariablesImpactExplanationsIndex) {
      aggregatedVariablesImpactExplanationsJsonList[aggregatedVariablesImpactExplanationsIndex].AsObject(
          m_aggregatedVariablesImpactExplanations[aggregatedVariablesImpactExplanationsIndex].Jsonize());
    }
