...
AggregatedVariablesImpactExplanation::AggregatedVariablesImpactExplanation(JsonView jsonValue) { *this = jsonValue; }
...
AggregatedVariablesImpactExplanation& AggregatedVariablesImpactExplanation::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("eventVariableNames")) {
    ...
    for (unsigned eventVariableNamesIndex = 0; eventVariableNamesIndex < eventVariableNamesJsonList.GetLength();
         ++eventVariableNamesIndex) {
