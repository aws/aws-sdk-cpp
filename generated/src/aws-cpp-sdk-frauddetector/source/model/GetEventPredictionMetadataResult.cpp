...
GetEventPredictionMetadataResult& GetEventPredictionMetadataResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("evaluatedModelVersions")) {
    ...
    for (unsigned evaluatedModelVersionsIndex = 0; evaluatedModelVersionsIndex < evaluatedModelVersionsJsonList.GetLength();
         ++evaluatedModelVersionsIndex) {
  ...
  if (jsonValue.ValueExists("evaluatedExternalModels")) {
    ...
    for (unsigned evaluatedExternalModelsIndex = 0; evaluatedExternalModelsIndex < evaluatedExternalModelsJsonList.GetLength();
         ++evaluatedExternalModelsIndex) {
