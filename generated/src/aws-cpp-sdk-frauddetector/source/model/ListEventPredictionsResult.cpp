...
ListEventPredictionsResult::ListEventPredictionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListEventPredictionsResult& ListEventPredictionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("eventPredictionSummaries")) {
    ...
    for (unsigned eventPredictionSummariesIndex = 0; eventPredictionSummariesIndex < eventPredictionSummariesJsonList.GetLength();
         ++eventPredictionSummariesIndex) {
