...
class LogOddsMetric {
 public:
  ...
  void SetVariableName(VariableNameT&& value) {
    ...
    m_variableName = std::forward<VariableNameT>(value);
  }
  template <typename VariableNameT = Aws::String>
  LogOddsMetric& WithVariableName(VariableNameT&& value) {
    SetVariableName(std::forward<VariableNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVariableImportance(double value) {
    m_variableImportanceHasBeenSet = true;
    m_variableImportance = value;
  }
  inline LogOddsMetric& WithVariableImportance(double value) {
    SetVariableImportance(value);
    return *this;
  }
  ///@}
 private:
