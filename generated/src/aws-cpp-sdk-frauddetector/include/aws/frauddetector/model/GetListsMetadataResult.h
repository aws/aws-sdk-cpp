...
class GetListsMetadataResult {
 public:
  ...
  void SetLists(ListsT&& value) {
    m_listsHasBeenSet = true;
    m_lists = std::forward<ListsT>(value);
  }
  template <typename ListsT = Aws::Vector<AllowDenyList>>
  GetListsMetadataResult& WithLists(ListsT&& value) {
    SetLists(std::forward<ListsT>(value));
    return *this;
  }
  template <typename ListsT = AllowDenyList>
  GetListsMetadataResult& AddLists(ListsT&& value) {
    m_listsHasBeenSet = true;
    m_lists.emplace_back(std::forward<ListsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetListsMetadataResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetListsMetadataResult& WithRequestId(RequestIdT&& value) {
