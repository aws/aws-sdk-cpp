...
class IngestedEventsDetail {
 public:
  ...
  void SetIngestedEventsTimeWindow(IngestedEventsTimeWindowT&& value) {
    m_ingestedEventsTimeWindowHasBeenSet = true;
    m_ingestedEventsTimeWindow = std::forward<IngestedEventsTimeWindowT>(value);
  }
  template <typename IngestedEventsTimeWindowT = IngestedEventsTimeWindow>
  IngestedEventsDetail& WithIngestedEventsTimeWindow(IngestedEventsTimeWindowT&& value) {
    SetIngestedEventsTimeWindow(std::forward<IngestedEventsTimeWindowT>(value));
    return *this;
  }
  ///@}
 private:
