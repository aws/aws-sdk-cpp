...
class TrainingMetrics {
 public:
  ...
  inline TrainingMetrics& WithAuc(double value) {
    SetAuc(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricDataPointsT = Aws::Vector<MetricDataPoint>>
  TrainingMetrics& WithMetricDataPoints(MetricDataPointsT&& value) {
    SetMetricDataPoints(std::forward<MetricDataPointsT>(value));
    return *this;
  }
  template <typename MetricDataPointsT = MetricDataPoint>
  TrainingMetrics& AddMetricDataPoints(MetricDataPointsT&& value) {
    m_metricDataPointsHasBeenSet = true;
