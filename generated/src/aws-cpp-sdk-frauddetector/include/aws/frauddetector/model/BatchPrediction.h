...
class BatchPrediction {
 public:
  ...
  inline BatchPrediction& WithStatus(AsyncJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastHeartbeatTime(LastHeartbeatTimeT&& value) {
    ...
    m_lastHeartbeatTime = std::forward<LastHeartbeatTimeT>(value);
  }
  template <typename LastHeartbeatTimeT = Aws::String>
  BatchPrediction& WithLastHeartbeatTime(LastHeartbeatTimeT&& value) {
    SetLastHeartbeatTime(std::forward<LastHeartbeatTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDetectorVersion(DetectorVersionT&& value) {
    ...
    m_detectorVersion = std::forward<DetectorVersionT>(value);
  }
  template <typename DetectorVersionT = Aws::String>
  BatchPrediction& WithDetectorVersion(DetectorVersionT&& value) {
    SetDetectorVersion(std::forward<DetectorVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline BatchPrediction& WithProcessedRecordsCount(int value) {
  ...
  inline BatchPrediction& WithTotalRecordsCount(int value) {
