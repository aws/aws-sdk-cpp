...
class TFITrainingMetricsValue {
 public:
  ...
  template <typename MetricDataPointsT = Aws::Vector<TFIMetricDataPoint>>
  TFITrainingMetricsValue& WithMetricDataPoints(MetricDataPointsT&& value) {
    SetMetricDataPoints(std::forward<MetricDataPointsT>(value));
    return *this;
  }
  template <typename MetricDataPointsT = TFIMetricDataPoint>
  TFITrainingMetricsValue& AddMetricDataPoints(MetricDataPointsT&& value) {
    m_metricDataPointsHasBeenSet = true;
  ...
  template <typename ModelPerformanceT = TFIModelPerformance>
  TFITrainingMetricsValue& WithModelPerformance(ModelPerformanceT&& value) {
