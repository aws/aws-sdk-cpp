...
class MetricDataPoint {
 public:
  ...
  inline MetricDataPoint& WithFpr(double value) {
    SetFpr(value);
    return *this;
  }
  ///@}
  ...
  inline MetricDataPoint& WithPrecision(double value) {
    SetPrecision(value);
    return *this;
  }
  ///@}
  ...
  inline MetricDataPoint& WithTpr(double value) {
    SetTpr(value);
    return *this;
  }
  ///@}
  ...
  inline MetricDataPoint& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
