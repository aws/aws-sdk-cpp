...
class PutEventTypeRequest : public FraudDetectorRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  PutEventTypeRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  PutEventTypeRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename EventVariablesT = Aws::Vector<Aws::String>>
  PutEventTypeRequest& WithEventVariables(EventVariablesT&& value) {
    SetEventVariables(std::forward<EventVariablesT>(value));
    return *this;
  }
  template <typename EventVariablesT = Aws::String>
  PutEventTypeRequest& AddEventVariables(EventVariablesT&& value) {
    m_eventVariablesHasBeenSet = true;
  ...
  template <typename LabelsT = Aws::Vector<Aws::String>>
  PutEventTypeRequest& WithLabels(LabelsT&& value) {
    SetLabels(std::forward<LabelsT>(value));
    return *this;
  }
  template <typename LabelsT = Aws::String>
  PutEventTypeRequest& AddLabels(LabelsT&& value) {
    m_labelsHasBeenSet = true;
  ...
  template <typename EntityTypesT = Aws::Vector<Aws::String>>
  PutEventTypeRequest& WithEntityTypes(EntityTypesT&& value) {
    SetEntityTypes(std::forward<EntityTypesT>(value));
    return *this;
  }
  template <typename EntityTypesT = Aws::String>
  PutEventTypeRequest& AddEntityTypes(EntityTypesT&& value) {
    m_entityTypesHasBeenSet = true;
  ...
  inline PutEventTypeRequest& WithEventIngestion(EventIngestion value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  PutEventTypeRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  PutEventTypeRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename EventOrchestrationT = EventOrchestration>
  PutEventTypeRequest& WithEventOrchestration(EventOrchestrationT&& value) {
