...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API CancelBatchImportJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelBatchImportJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
