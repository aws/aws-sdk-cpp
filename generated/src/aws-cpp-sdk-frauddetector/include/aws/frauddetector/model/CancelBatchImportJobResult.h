...
namespace Model
{
  ...
  public:
    ...
    inline CancelBatchImportJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CancelBatchImportJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CancelBatchImportJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
