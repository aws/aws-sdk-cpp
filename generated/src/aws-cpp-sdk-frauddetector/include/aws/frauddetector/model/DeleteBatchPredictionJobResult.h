...
namespace Model
{
  ...
  public:
    ...
    inline DeleteBatchPredictionJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteBatchPredictionJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteBatchPredictionJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
