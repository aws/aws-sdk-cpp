...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API DeleteBatchPredictionJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteBatchPredictionJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
