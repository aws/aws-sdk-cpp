...
class ModelInputConfiguration {
 public:
  ...
  template <typename EventTypeNameT = Aws::String>
  ModelInputConfiguration& WithEventTypeName(EventTypeNameT&& value) {
  ...
  inline void SetFormat(ModelInputDataFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline ModelInputConfiguration& WithFormat(ModelInputDataFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUseEventVariables(bool value) {
    m_useEventVariablesHasBeenSet = true;
    m_useEventVariables = value;
  }
  inline ModelInputConfiguration& WithUseEventVariables(bool value) {
    SetUseEventVariables(value);
    return *this;
  }
  ///@}
  ...
  void SetJsonInputTemplate(JsonInputTemplateT&& value) {
    m_jsonInputTemplateHasBeenSet = true;
    m_jsonInputTemplate = std::forward<JsonInputTemplateT>(value);
  }
  template <typename JsonInputTemplateT = Aws::String>
  ModelInputConfiguration& WithJsonInputTemplate(JsonInputTemplateT&& value) {
    SetJsonInputTemplate(std::forward<JsonInputTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCsvInputTemplate(CsvInputTemplateT&& value) {
    m_csvInputTemplateHasBeenSet = true;
    m_csvInputTemplate = std::forward<CsvInputTemplateT>(value);
  }
  template <typename CsvInputTemplateT = Aws::String>
  ModelInputConfiguration& WithCsvInputTemplate(CsvInputTemplateT&& value) {
    SetCsvInputTemplate(std::forward<CsvInputTemplateT>(value));
    return *this;
  }
  ///@}
 private:
