...
class ATITrainingMetricsValue {
 public:
  ...
  template <typename MetricDataPointsT = Aws::Vector<ATIMetricDataPoint>>
  ATITrainingMetricsValue& WithMetricDataPoints(MetricDataPointsT&& value) {
    SetMetricDataPoints(std::forward<MetricDataPointsT>(value));
    return *this;
  }
  template <typename MetricDataPointsT = ATIMetricDataPoint>
  ATITrainingMetricsValue& AddMetricDataPoints(MetricDataPointsT&& value) {
    m_metricDataPointsHasBeenSet = true;
  ...
  template <typename ModelPerformanceT = ATIModelPerformance>
  ATITrainingMetricsValue& WithModelPerformance(ModelPerformanceT&& value) {
