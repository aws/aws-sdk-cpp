...
class UpdateDetectorVersionStatusRequest : public FraudDetectorRequest {
 public:
  ...
  template <typename DetectorIdT = Aws::String>
  UpdateDetectorVersionStatusRequest& WithDetectorId(DetectorIdT&& value) {
  ...
  template <typename DetectorVersionIdT = Aws::String>
  UpdateDetectorVersionStatusRequest& WithDetectorVersionId(DetectorVersionIdT&& value) {
  ...
  inline UpdateDetectorVersionStatusRequest& WithStatus(DetectorVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
