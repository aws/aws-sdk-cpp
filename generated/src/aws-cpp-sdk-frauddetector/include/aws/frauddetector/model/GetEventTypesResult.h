...
class GetEventTypesResult {
 public:
  ...
  template <typename EventTypesT = Aws::Vector<EventType>>
  GetEventTypesResult& WithEventTypes(EventTypesT&& value) {
    SetEventTypes(std::forward<EventTypesT>(value));
    return *this;
  }
  template <typename EventTypesT = EventType>
  GetEventTypesResult& AddEventTypes(EventTypesT&& value) {
    m_eventTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetEventTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetEventTypesResult& WithRequestId(RequestIdT&& value) {
