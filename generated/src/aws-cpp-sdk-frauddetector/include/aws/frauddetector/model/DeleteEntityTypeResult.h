...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API DeleteEntityTypeResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteEntityTypeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
