...
class GetModelsRequest : public FraudDetectorRequest {
 public:
  AWS_FRAUDDETECTOR_API GetModelsRequest() = default;
  ...
  template <typename ModelIdT = Aws::String>
  GetModelsRequest& WithModelId(ModelIdT&& value) {
  ...
  inline GetModelsRequest& WithModelType(ModelTypeEnum value) {
    SetModelType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetModelsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetModelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
