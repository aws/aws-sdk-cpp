...
class EventType {
 public:
  ...
  template <typename NameT = Aws::String>
  EventType& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  EventType& WithDescription(DescriptionT&& value) {
  ...
  template <typename EventVariablesT = Aws::Vector<Aws::String>>
  EventType& WithEventVariables(EventVariablesT&& value) {
    SetEventVariables(std::forward<EventVariablesT>(value));
    return *this;
  }
  template <typename EventVariablesT = Aws::String>
  EventType& AddEventVariables(EventVariablesT&& value) {
    m_eventVariablesHasBeenSet = true;
  ...
  template <typename EntityTypesT = Aws::Vector<Aws::String>>
  EventType& WithEntityTypes(EntityTypesT&& value) {
    SetEntityTypes(std::forward<EntityTypesT>(value));
    return *this;
  }
  template <typename EntityTypesT = Aws::String>
  EventType& AddEntityTypes(EntityTypesT&& value) {
    m_entityTypesHasBeenSet = true;
  ...
  inline void SetEventIngestion(EventIngestion value) {
    m_eventIngestionHasBeenSet = true;
    m_eventIngestion = value;
  }
  inline EventType& WithEventIngestion(EventIngestion value) {
    SetEventIngestion(value);
    return *this;
  }
  ///@}
  ...
  void SetIngestedEventStatistics(IngestedEventStatisticsT&& value) {
    m_ingestedEventStatisticsHasBeenSet = true;
    m_ingestedEventStatistics = std::forward<IngestedEventStatisticsT>(value);
  }
  template <typename IngestedEventStatisticsT = IngestedEventStatistics>
  EventType& WithIngestedEventStatistics(IngestedEventStatisticsT&& value) {
    SetIngestedEventStatistics(std::forward<IngestedEventStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedTimeT = Aws::String>
  EventType& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename CreatedTimeT = Aws::String>
  EventType& WithCreatedTime(CreatedTimeT&& value) {
  ...
  void SetEventOrchestration(EventOrchestrationT&& value) {
    m_eventOrchestrationHasBeenSet = true;
    m_eventOrchestration = std::forward<EventOrchestrationT>(value);
  }
  template <typename EventOrchestrationT = EventOrchestration>
  EventType& WithEventOrchestration(EventOrchestrationT&& value) {
    SetEventOrchestration(std::forward<EventOrchestrationT>(value));
    return *this;
  }
  ///@}
 private:
