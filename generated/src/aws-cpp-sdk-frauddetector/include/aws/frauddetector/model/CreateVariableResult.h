...
namespace Model
{
  ...
  public:
    ...
    inline CreateVariableResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateVariableResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateVariableResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
