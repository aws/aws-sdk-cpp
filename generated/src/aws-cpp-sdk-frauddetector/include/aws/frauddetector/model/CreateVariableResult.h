...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API CreateVariableResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateVariableResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
