...
class ModelVersionEvaluation {
 public:
  ...
  void SetOutputVariableName(OutputVariableNameT&& value) {
    ...
    m_outputVariableName = std::forward<OutputVariableNameT>(value);
  }
  template <typename OutputVariableNameT = Aws::String>
  ModelVersionEvaluation& WithOutputVariableName(OutputVariableNameT&& value) {
    SetOutputVariableName(std::forward<OutputVariableNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEvaluationScore(EvaluationScoreT&& value) {
    ...
    m_evaluationScore = std::forward<EvaluationScoreT>(value);
  }
  template <typename EvaluationScoreT = Aws::String>
  ModelVersionEvaluation& WithEvaluationScore(EvaluationScoreT&& value) {
    SetEvaluationScore(std::forward<EvaluationScoreT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPredictionExplanations(PredictionExplanationsT&& value) {
    ...
    m_predictionExplanations = std::forward<PredictionExplanationsT>(value);
  }
  template <typename PredictionExplanationsT = PredictionExplanations>
  ModelVersionEvaluation& WithPredictionExplanations(PredictionExplanationsT&& value) {
    SetPredictionExplanations(std::forward<PredictionExplanationsT>(value));
    return *this;
  }
  ///@}
 private:
