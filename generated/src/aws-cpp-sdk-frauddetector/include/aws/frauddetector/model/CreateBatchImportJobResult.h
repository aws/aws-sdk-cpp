...
namespace Model
{
  ...
  public:
    ...
    inline CreateBatchImportJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateBatchImportJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateBatchImportJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
