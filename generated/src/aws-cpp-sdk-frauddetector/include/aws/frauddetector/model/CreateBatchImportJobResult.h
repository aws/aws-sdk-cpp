...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API CreateBatchImportJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateBatchImportJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
