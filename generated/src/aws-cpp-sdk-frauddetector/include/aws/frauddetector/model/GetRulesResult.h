...
namespace Model
{
  ...
  public:
    ...
    inline GetRulesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetRulesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetRulesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
