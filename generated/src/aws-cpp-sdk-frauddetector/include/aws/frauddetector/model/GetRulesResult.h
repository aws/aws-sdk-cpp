...
class GetRulesResult {
 public:
  ...
  void SetRuleDetails(RuleDetailsT&& value) {
    m_ruleDetailsHasBeenSet = true;
    m_ruleDetails = std::forward<RuleDetailsT>(value);
  }
  template <typename RuleDetailsT = Aws::Vector<RuleDetail>>
  GetRulesResult& WithRuleDetails(RuleDetailsT&& value) {
    SetRuleDetails(std::forward<RuleDetailsT>(value));
    return *this;
  }
  template <typename RuleDetailsT = RuleDetail>
  GetRulesResult& AddRuleDetails(RuleDetailsT&& value) {
    m_ruleDetailsHasBeenSet = true;
    m_ruleDetails.emplace_back(std::forward<RuleDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetRulesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRulesResult& WithRequestId(RequestIdT&& value) {
