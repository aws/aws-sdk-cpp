...
class ModelOutputConfiguration {
 public:
  ...
  inline void SetFormat(ModelOutputDataFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline ModelOutputConfiguration& WithFormat(ModelOutputDataFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  void SetJsonKeyToVariableMap(JsonKeyToVariableMapT&& value) {
    ...
    m_jsonKeyToVariableMap = std::forward<JsonKeyToVariableMapT>(value);
  }
  template <typename JsonKeyToVariableMapT = Aws::Map<Aws::String, Aws::String>>
  ModelOutputConfiguration& WithJsonKeyToVariableMap(JsonKeyToVariableMapT&& value) {
    SetJsonKeyToVariableMap(std::forward<JsonKeyToVariableMapT>(value));
    return *this;
  }
  ...
  ModelOutputConfiguration& AddJsonKeyToVariableMap(JsonKeyToVariableMapKeyT&& key, JsonKeyToVariableMapValueT&& value) {
    m_jsonKeyToVariableMapHasBeenSet = true;
    m_jsonKeyToVariableMap.emplace(std::forward<JsonKeyToVariableMapKeyT>(key), std::forward<JsonKeyToVariableMapValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCsvIndexToVariableMap(CsvIndexToVariableMapT&& value) {
    ...
    m_csvIndexToVariableMap = std::forward<CsvIndexToVariableMapT>(value);
  }
  template <typename CsvIndexToVariableMapT = Aws::Map<Aws::String, Aws::String>>
  ModelOutputConfiguration& WithCsvIndexToVariableMap(CsvIndexToVariableMapT&& value) {
    SetCsvIndexToVariableMap(std::forward<CsvIndexToVariableMapT>(value));
    return *this;
  }
  ...
  ModelOutputConfiguration& AddCsvIndexToVariableMap(CsvIndexToVariableMapKeyT&& key, CsvIndexToVariableMapValueT&& value) {
    m_csvIndexToVariableMapHasBeenSet = true;
    m_csvIndexToVariableMap.emplace(std::forward<CsvIndexToVariableMapKeyT>(key), std::forward<CsvIndexToVariableMapValueT>(value));
    return *this;
  }
  ///@}
 private:
