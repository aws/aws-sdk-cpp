...
class GetEntityTypesResult {
 public:
  ...
  template <typename EntityTypesT = Aws::Vector<EntityType>>
  GetEntityTypesResult& WithEntityTypes(EntityTypesT&& value) {
    SetEntityTypes(std::forward<EntityTypesT>(value));
    return *this;
  }
  template <typename EntityTypesT = EntityType>
  GetEntityTypesResult& AddEntityTypes(EntityTypesT&& value) {
    m_entityTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetEntityTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetEntityTypesResult& WithRequestId(RequestIdT&& value) {
