...
class OFIMetricDataPoint {
 public:
  ...
  inline void SetFpr(double value) {
    m_fprHasBeenSet = true;
    m_fpr = value;
  }
  inline OFIMetricDataPoint& WithFpr(double value) {
    SetFpr(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPrecision(double value) {
    m_precisionHasBeenSet = true;
    m_precision = value;
  }
  inline OFIMetricDataPoint& WithPrecision(double value) {
    SetPrecision(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTpr(double value) {
    m_tprHasBeenSet = true;
    m_tpr = value;
  }
  inline OFIMetricDataPoint& WithTpr(double value) {
    SetTpr(value);
    return *this;
  }
  ///@}
  ...
  inline OFIMetricDataPoint& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
