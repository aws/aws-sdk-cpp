...
class UpdateModelVersionResult {
 public:
  ...
  template <typename ModelIdT = Aws::String>
  UpdateModelVersionResult& WithModelId(ModelIdT&& value) {
  ...
  inline UpdateModelVersionResult& WithModelType(ModelTypeEnum value) {
    SetModelType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ModelVersionNumberT = Aws::String>
  UpdateModelVersionResult& WithModelVersionNumber(ModelVersionNumberT&& value) {
  ...
  template <typename StatusT = Aws::String>
  UpdateModelVersionResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateModelVersionResult& WithRequestId(RequestIdT&& value) {
