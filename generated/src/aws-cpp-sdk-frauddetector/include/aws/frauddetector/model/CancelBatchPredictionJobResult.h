...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API CancelBatchPredictionJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelBatchPredictionJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
