...
namespace Model
{
  ...
  public:
    ...
    inline CancelBatchPredictionJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CancelBatchPredictionJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CancelBatchPredictionJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
