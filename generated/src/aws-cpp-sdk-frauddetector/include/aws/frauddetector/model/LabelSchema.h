...
class LabelSchema {
 public:
  ...
  void SetLabelMapper(LabelMapperT&& value) {
    m_labelMapperHasBeenSet = true;
    m_labelMapper = std::forward<LabelMapperT>(value);
  }
  template <typename LabelMapperT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  LabelSchema& WithLabelMapper(LabelMapperT&& value) {
    SetLabelMapper(std::forward<LabelMapperT>(value));
    return *this;
  }
  ...
  LabelSchema& AddLabelMapper(LabelMapperKeyT&& key, LabelMapperValueT&& value) {
    m_labelMapperHasBeenSet = true;
    m_labelMapper.emplace(std::forward<LabelMapperKeyT>(key), std::forward<LabelMapperValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUnlabeledEventsTreatment(UnlabeledEventsTreatment value) {
    m_unlabeledEventsTreatmentHasBeenSet = true;
    m_unlabeledEventsTreatment = value;
  }
  inline LabelSchema& WithUnlabeledEventsTreatment(UnlabeledEventsTreatment value) {
    SetUnlabeledEventsTreatment(value);
    return *this;
  }
  ///@}
 private:
