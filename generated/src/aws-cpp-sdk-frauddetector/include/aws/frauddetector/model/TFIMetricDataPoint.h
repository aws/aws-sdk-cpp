...
class TFIMetricDataPoint {
 public:
  ...
  inline TFIMetricDataPoint& WithFpr(double value) {
    SetFpr(value);
    return *this;
  }
  ///@}
  ...
  inline TFIMetricDataPoint& WithPrecision(double value) {
    SetPrecision(value);
    return *this;
  }
  ///@}
  ...
  inline TFIMetricDataPoint& WithTpr(double value) {
    SetTpr(value);
    return *this;
  }
  ///@}
  ...
  inline TFIMetricDataPoint& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
