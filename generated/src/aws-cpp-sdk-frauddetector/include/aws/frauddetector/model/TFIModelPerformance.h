...
class TFIModelPerformance {
 public:
  ...
  inline void SetAuc(double value) {
    m_aucHasBeenSet = true;
    m_auc = value;
  }
  inline TFIModelPerformance& WithAuc(double value) {
    SetAuc(value);
    return *this;
  }
  ///@}
  ...
  void SetUncertaintyRange(UncertaintyRangeT&& value) {
    m_uncertaintyRangeHasBeenSet = true;
    m_uncertaintyRange = std::forward<UncertaintyRangeT>(value);
  }
  template <typename UncertaintyRangeT = UncertaintyRange>
  TFIModelPerformance& WithUncertaintyRange(UncertaintyRangeT&& value) {
    SetUncertaintyRange(std::forward<UncertaintyRangeT>(value));
    return *this;
  }
  ///@}
 private:
