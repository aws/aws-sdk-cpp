...
class GetEventPredictionMetadataResult {
 public:
  ...
  void SetDetectorVersionStatus(DetectorVersionStatusT&& value) {
    m_detectorVersionStatusHasBeenSet = true;
    m_detectorVersionStatus = std::forward<DetectorVersionStatusT>(value);
  }
  template <typename DetectorVersionStatusT = Aws::String>
  GetEventPredictionMetadataResult& WithDetectorVersionStatus(DetectorVersionStatusT&& value) {
    SetDetectorVersionStatus(std::forward<DetectorVersionStatusT>(value));
    return *this;
  }
  ///@}
  ...
  GetEventPredictionMetadataResult& AddEventVariables(EventVariablesT&& value) {
    m_eventVariablesHasBeenSet = true;
    m_eventVariables.emplace_back(std::forward<EventVariablesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RulesT = Aws::Vector<EvaluatedRule>>
  GetEventPredictionMetadataResult& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = EvaluatedRule>
  GetEventPredictionMetadataResult& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
  ...
  inline GetEventPredictionMetadataResult& WithRuleExecutionMode(RuleExecutionMode value) {
  ...
  void SetEvaluatedModelVersions(EvaluatedModelVersionsT&& value) {
    m_evaluatedModelVersionsHasBeenSet = true;
    m_evaluatedModelVersions = std::forward<EvaluatedModelVersionsT>(value);
  }
  template <typename EvaluatedModelVersionsT = Aws::Vector<EvaluatedModelVersion>>
  GetEventPredictionMetadataResult& WithEvaluatedModelVersions(EvaluatedModelVersionsT&& value) {
    SetEvaluatedModelVersions(std::forward<EvaluatedModelVersionsT>(value));
    return *this;
  }
  ...
  GetEventPredictionMetadataResult& AddEvaluatedModelVersions(EvaluatedModelVersionsT&& value) {
    m_evaluatedModelVersionsHasBeenSet = true;
    m_evaluatedModelVersions.emplace_back(std::forward<EvaluatedModelVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEvaluatedExternalModels(EvaluatedExternalModelsT&& value) {
    m_evaluatedExternalModelsHasBeenSet = true;
    m_evaluatedExternalModels = std::forward<EvaluatedExternalModelsT>(value);
  }
  template <typename EvaluatedExternalModelsT = Aws::Vector<EvaluatedExternalModel>>
  GetEventPredictionMetadataResult& WithEvaluatedExternalModels(EvaluatedExternalModelsT&& value) {
    SetEvaluatedExternalModels(std::forward<EvaluatedExternalModelsT>(value));
    return *this;
  }
  ...
  GetEventPredictionMetadataResult& AddEvaluatedExternalModels(EvaluatedExternalModelsT&& value) {
    m_evaluatedExternalModelsHasBeenSet = true;
    m_evaluatedExternalModels.emplace_back(std::forward<EvaluatedExternalModelsT>(value));
    return *this;
  }
  ///@}
