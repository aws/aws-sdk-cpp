...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API GetBatchPredictionJobsRequest() = default;
    ...
    template<typename JobIdT = Aws::String>
    GetBatchPredictionJobsRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetBatchPredictionJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
