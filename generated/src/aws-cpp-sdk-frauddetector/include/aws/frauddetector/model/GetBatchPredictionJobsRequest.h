...
class GetBatchPredictionJobsRequest : public FraudDetectorRequest {
 public:
  ...
  template <typename JobIdT = Aws::String>
  GetBatchPredictionJobsRequest& WithJobId(JobIdT&& value) {
  ...
  inline GetBatchPredictionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetBatchPredictionJobsRequest& WithNextToken(NextTokenT&& value) {
