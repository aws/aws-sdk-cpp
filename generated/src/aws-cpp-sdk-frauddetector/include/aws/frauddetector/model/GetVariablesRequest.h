...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API GetVariablesRequest() = default;
    ...
    template<typename NameT = Aws::String>
    GetVariablesRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetVariablesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
