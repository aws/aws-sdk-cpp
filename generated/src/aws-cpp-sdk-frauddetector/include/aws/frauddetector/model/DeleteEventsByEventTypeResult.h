...
class DeleteEventsByEventTypeResult {
 public:
  ...
  template <typename EventTypeNameT = Aws::String>
  DeleteEventsByEventTypeResult& WithEventTypeName(EventTypeNameT&& value) {
  ...
  void SetEventsDeletionStatus(EventsDeletionStatusT&& value) {
    m_eventsDeletionStatusHasBeenSet = true;
    m_eventsDeletionStatus = std::forward<EventsDeletionStatusT>(value);
  }
  template <typename EventsDeletionStatusT = Aws::String>
  DeleteEventsByEventTypeResult& WithEventsDeletionStatus(EventsDeletionStatusT&& value) {
    SetEventsDeletionStatus(std::forward<EventsDeletionStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteEventsByEventTypeResult& WithRequestId(RequestIdT&& value) {
