...
class GetListElementsResult {
 public:
  ...
  template <typename ElementsT = Aws::Vector<Aws::String>>
  GetListElementsResult& WithElements(ElementsT&& value) {
    SetElements(std::forward<ElementsT>(value));
    return *this;
  }
  template <typename ElementsT = Aws::String>
  GetListElementsResult& AddElements(ElementsT&& value) {
    m_elementsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetListElementsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetListElementsResult& WithRequestId(RequestIdT&& value) {
