...
class GetEventPredictionMetadataRequest : public FraudDetectorRequest {
 public:
  ...
  template <typename EventIdT = Aws::String>
  GetEventPredictionMetadataRequest& WithEventId(EventIdT&& value) {
  ...
  template <typename EventTypeNameT = Aws::String>
  GetEventPredictionMetadataRequest& WithEventTypeName(EventTypeNameT&& value) {
  ...
  template <typename DetectorIdT = Aws::String>
  GetEventPredictionMetadataRequest& WithDetectorId(DetectorIdT&& value) {
  ...
  template <typename DetectorVersionIdT = Aws::String>
  GetEventPredictionMetadataRequest& WithDetectorVersionId(DetectorVersionIdT&& value) {
  ...
  template <typename PredictionTimestampT = Aws::String>
  GetEventPredictionMetadataRequest& WithPredictionTimestamp(PredictionTimestampT&& value) {
