...
class AggregatedVariablesImportanceMetrics {
 public:
  ...
  void SetLogOddsMetrics(LogOddsMetricsT&& value) {
    ...
    m_logOddsMetrics = std::forward<LogOddsMetricsT>(value);
  }
  template <typename LogOddsMetricsT = Aws::Vector<AggregatedLogOddsMetric>>
  AggregatedVariablesImportanceMetrics& WithLogOddsMetrics(LogOddsMetricsT&& value) {
    SetLogOddsMetrics(std::forward<LogOddsMetricsT>(value));
    return *this;
  }
  ...
  AggregatedVariablesImportanceMetrics& AddLogOddsMetrics(LogOddsMetricsT&& value) {
    m_logOddsMetricsHasBeenSet = true;
    m_logOddsMetrics.emplace_back(std::forward<LogOddsMetricsT>(value));
    return *this;
  }
  ///@}
 private:
