...
class CreateVariableRequest : public FraudDetectorRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateVariableRequest& WithName(NameT&& value) {
  ...
  inline CreateVariableRequest& WithDataType(DataType value) {
    SetDataType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateVariableRequest& WithDataSource(DataSource value) {
    SetDataSource(value);
    return *this;
  }
  ///@}
  ...
  template <typename DefaultValueT = Aws::String>
  CreateVariableRequest& WithDefaultValue(DefaultValueT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateVariableRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename VariableTypeT = Aws::String>
  CreateVariableRequest& WithVariableType(VariableTypeT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateVariableRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateVariableRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
