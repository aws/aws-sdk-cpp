...
class IngestedEventStatistics {
 public:
  ...
  inline void SetNumberOfEvents(long long value) {
    m_numberOfEventsHasBeenSet = true;
    m_numberOfEvents = value;
  }
  inline IngestedEventStatistics& WithNumberOfEvents(long long value) {
  ...
  inline void SetEventDataSizeInBytes(long long value) {
    m_eventDataSizeInBytesHasBeenSet = true;
    m_eventDataSizeInBytes = value;
  }
  inline IngestedEventStatistics& WithEventDataSizeInBytes(long long value) {
    SetEventDataSizeInBytes(value);
    return *this;
  }
  ///@}
  ...
  void SetLeastRecentEvent(LeastRecentEventT&& value) {
    ...
    m_leastRecentEvent = std::forward<LeastRecentEventT>(value);
  }
  template <typename LeastRecentEventT = Aws::String>
  IngestedEventStatistics& WithLeastRecentEvent(LeastRecentEventT&& value) {
    SetLeastRecentEvent(std::forward<LeastRecentEventT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMostRecentEvent(MostRecentEventT&& value) {
    ...
    m_mostRecentEvent = std::forward<MostRecentEventT>(value);
  }
  template <typename MostRecentEventT = Aws::String>
  IngestedEventStatistics& WithMostRecentEvent(MostRecentEventT&& value) {
    SetMostRecentEvent(std::forward<MostRecentEventT>(value));
    return *this;
  }
  ///@}
