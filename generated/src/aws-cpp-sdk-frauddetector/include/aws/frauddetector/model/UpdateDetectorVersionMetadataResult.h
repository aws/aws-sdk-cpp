...
namespace Model
{
  ...
  public:
    ...
    inline UpdateDetectorVersionMetadataResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateDetectorVersionMetadataResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateDetectorVersionMetadataResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
