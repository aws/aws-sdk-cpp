...
class ModelVersionDetail {
 public:
  ...
  inline ModelVersionDetail& WithModelType(ModelTypeEnum value) {
    SetModelType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTrainingDataSource(TrainingDataSourceEnum value) {
    m_trainingDataSourceHasBeenSet = true;
    m_trainingDataSource = value;
  }
  inline ModelVersionDetail& WithTrainingDataSource(TrainingDataSourceEnum value) {
    SetTrainingDataSource(value);
    return *this;
  }
  ///@}
  ...
  void SetTrainingDataSchema(TrainingDataSchemaT&& value) {
    ...
    m_trainingDataSchema = std::forward<TrainingDataSchemaT>(value);
  }
  template <typename TrainingDataSchemaT = TrainingDataSchema>
  ModelVersionDetail& WithTrainingDataSchema(TrainingDataSchemaT&& value) {
    SetTrainingDataSchema(std::forward<TrainingDataSchemaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExternalEventsDetail(ExternalEventsDetailT&& value) {
    ...
    m_externalEventsDetail = std::forward<ExternalEventsDetailT>(value);
  }
  template <typename ExternalEventsDetailT = ExternalEventsDetail>
  ModelVersionDetail& WithExternalEventsDetail(ExternalEventsDetailT&& value) {
    SetExternalEventsDetail(std::forward<ExternalEventsDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIngestedEventsDetail(IngestedEventsDetailT&& value) {
    ...
    m_ingestedEventsDetail = std::forward<IngestedEventsDetailT>(value);
  }
  template <typename IngestedEventsDetailT = IngestedEventsDetail>
  ModelVersionDetail& WithIngestedEventsDetail(IngestedEventsDetailT&& value) {
    SetIngestedEventsDetail(std::forward<IngestedEventsDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingResult(TrainingResultT&& value) {
    ...
    m_trainingResult = std::forward<TrainingResultT>(value);
  }
  template <typename TrainingResultT = TrainingResult>
  ModelVersionDetail& WithTrainingResult(TrainingResultT&& value) {
    SetTrainingResult(std::forward<TrainingResultT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingResultV2(TrainingResultV2T&& value) {
    ...
    m_trainingResultV2 = std::forward<TrainingResultV2T>(value);
  }
  template <typename TrainingResultV2T = TrainingResultV2>
  ModelVersionDetail& WithTrainingResultV2(TrainingResultV2T&& value) {
    SetTrainingResultV2(std::forward<TrainingResultV2T>(value));
    return *this;
  }
  ///@}
 private:
