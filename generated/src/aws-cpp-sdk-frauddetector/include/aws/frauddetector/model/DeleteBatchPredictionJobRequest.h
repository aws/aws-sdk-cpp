...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API DeleteBatchPredictionJobRequest() = default;
    ...
    template<typename JobIdT = Aws::String>
    DeleteBatchPredictionJobRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
  private:
