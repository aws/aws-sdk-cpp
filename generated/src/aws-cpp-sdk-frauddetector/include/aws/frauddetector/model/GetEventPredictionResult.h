...
class GetEventPredictionResult {
 public:
  ...
  void SetModelScores(ModelScoresT&& value) {
    m_modelScoresHasBeenSet = true;
    m_modelScores = std::forward<ModelScoresT>(value);
  }
  template <typename ModelScoresT = Aws::Vector<ModelScores>>
  GetEventPredictionResult& WithModelScores(ModelScoresT&& value) {
    SetModelScores(std::forward<ModelScoresT>(value));
    return *this;
  }
  template <typename ModelScoresT = ModelScores>
  GetEventPredictionResult& AddModelScores(ModelScoresT&& value) {
    m_modelScoresHasBeenSet = true;
    m_modelScores.emplace_back(std::forward<ModelScoresT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RuleResultsT = Aws::Vector<RuleResult>>
  GetEventPredictionResult& WithRuleResults(RuleResultsT&& value) {
    SetRuleResults(std::forward<RuleResultsT>(value));
    return *this;
  }
  template <typename RuleResultsT = RuleResult>
  GetEventPredictionResult& AddRuleResults(RuleResultsT&& value) {
    m_ruleResultsHasBeenSet = true;
  ...
  void SetExternalModelOutputs(ExternalModelOutputsT&& value) {
    m_externalModelOutputsHasBeenSet = true;
    m_externalModelOutputs = std::forward<ExternalModelOutputsT>(value);
  }
  template <typename ExternalModelOutputsT = Aws::Vector<ExternalModelOutputs>>
  GetEventPredictionResult& WithExternalModelOutputs(ExternalModelOutputsT&& value) {
    SetExternalModelOutputs(std::forward<ExternalModelOutputsT>(value));
    return *this;
  }
  template <typename ExternalModelOutputsT = ExternalModelOutputs>
  GetEventPredictionResult& AddExternalModelOutputs(ExternalModelOutputsT&& value) {
    m_externalModelOutputsHasBeenSet = true;
    m_externalModelOutputs.emplace_back(std::forward<ExternalModelOutputsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetEventPredictionResult& WithRequestId(RequestIdT&& value) {
