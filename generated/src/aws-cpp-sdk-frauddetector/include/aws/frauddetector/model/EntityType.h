...
class EntityType {
 public:
  ...
  template <typename NameT = Aws::String>
  EntityType& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  EntityType& WithDescription(DescriptionT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::String>
  EntityType& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename CreatedTimeT = Aws::String>
  EntityType& WithCreatedTime(CreatedTimeT&& value) {
