...
class DescribeDetectorResult {
 public:
  ...
  template <typename DetectorIdT = Aws::String>
  DescribeDetectorResult& WithDetectorId(DetectorIdT&& value) {
  ...
  void SetDetectorVersionSummaries(DetectorVersionSummariesT&& value) {
    m_detectorVersionSummariesHasBeenSet = true;
    m_detectorVersionSummaries = std::forward<DetectorVersionSummariesT>(value);
  }
  template <typename DetectorVersionSummariesT = Aws::Vector<DetectorVersionSummary>>
  DescribeDetectorResult& WithDetectorVersionSummaries(DetectorVersionSummariesT&& value) {
    SetDetectorVersionSummaries(std::forward<DetectorVersionSummariesT>(value));
    return *this;
  }
  template <typename DetectorVersionSummariesT = DetectorVersionSummary>
  DescribeDetectorResult& AddDetectorVersionSummaries(DetectorVersionSummariesT&& value) {
    m_detectorVersionSummariesHasBeenSet = true;
    m_detectorVersionSummaries.emplace_back(std::forward<DetectorVersionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDetectorResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DescribeDetectorResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDetectorResult& WithRequestId(RequestIdT&& value) {
