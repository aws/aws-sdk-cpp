...
class TrainingResultV2 {
 public:
  ...
  void SetTrainingMetricsV2(TrainingMetricsV2T&& value) {
    ...
    m_trainingMetricsV2 = std::forward<TrainingMetricsV2T>(value);
  }
  template <typename TrainingMetricsV2T = TrainingMetricsV2>
  TrainingResultV2& WithTrainingMetricsV2(TrainingMetricsV2T&& value) {
    SetTrainingMetricsV2(std::forward<TrainingMetricsV2T>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AggregatedVariablesImportanceMetrics& GetAggregatedVariablesImportanceMetrics() const {
    return m_aggregatedVariablesImportanceMetrics;
  }
  ...
  void SetAggregatedVariablesImportanceMetrics(AggregatedVariablesImportanceMetricsT&& value) {
    ...
    m_aggregatedVariablesImportanceMetrics = std::forward<AggregatedVariablesImportanceMetricsT>(value);
  }
  template <typename AggregatedVariablesImportanceMetricsT = AggregatedVariablesImportanceMetrics>
  TrainingResultV2& WithAggregatedVariablesImportanceMetrics(AggregatedVariablesImportanceMetricsT&& value) {
    SetAggregatedVariablesImportanceMetrics(std::forward<AggregatedVariablesImportanceMetricsT>(value));
    return *this;
  }
  ///@}
 private:
