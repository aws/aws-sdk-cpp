...
class DeleteModelVersionRequest : public FraudDetectorRequest {
 public:
  ...
  template <typename ModelIdT = Aws::String>
  DeleteModelVersionRequest& WithModelId(ModelIdT&& value) {
  ...
  inline DeleteModelVersionRequest& WithModelType(ModelTypeEnum value) {
    SetModelType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ModelVersionNumberT = Aws::String>
  DeleteModelVersionRequest& WithModelVersionNumber(ModelVersionNumberT&& value) {
