...
class TrainingResult {
 public:
  ...
  void SetDataValidationMetrics(DataValidationMetricsT&& value) {
    ...
    m_dataValidationMetrics = std::forward<DataValidationMetricsT>(value);
  }
  template <typename DataValidationMetricsT = DataValidationMetrics>
  TrainingResult& WithDataValidationMetrics(DataValidationMetricsT&& value) {
    SetDataValidationMetrics(std::forward<DataValidationMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVariableImportanceMetrics(VariableImportanceMetricsT&& value) {
    ...
    m_variableImportanceMetrics = std::forward<VariableImportanceMetricsT>(value);
  }
  template <typename VariableImportanceMetricsT = VariableImportanceMetrics>
  TrainingResult& WithVariableImportanceMetrics(VariableImportanceMetricsT&& value) {
    SetVariableImportanceMetrics(std::forward<VariableImportanceMetricsT>(value));
    return *this;
  }
  ///@}
 private:
