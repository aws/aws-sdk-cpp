...
class DescribeModelVersionsResult {
 public:
  ...
  void SetModelVersionDetails(ModelVersionDetailsT&& value) {
    m_modelVersionDetailsHasBeenSet = true;
    m_modelVersionDetails = std::forward<ModelVersionDetailsT>(value);
  }
  template <typename ModelVersionDetailsT = Aws::Vector<ModelVersionDetail>>
  DescribeModelVersionsResult& WithModelVersionDetails(ModelVersionDetailsT&& value) {
    SetModelVersionDetails(std::forward<ModelVersionDetailsT>(value));
    return *this;
  }
  template <typename ModelVersionDetailsT = ModelVersionDetail>
  DescribeModelVersionsResult& AddModelVersionDetails(ModelVersionDetailsT&& value) {
    m_modelVersionDetailsHasBeenSet = true;
    m_modelVersionDetails.emplace_back(std::forward<ModelVersionDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeModelVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeModelVersionsResult& WithRequestId(RequestIdT&& value) {
