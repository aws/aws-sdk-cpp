...
class TrainingDataSchema {
 public:
  ...
  void SetModelVariables(ModelVariablesT&& value) {
    ...
    m_modelVariables = std::forward<ModelVariablesT>(value);
  }
  template <typename ModelVariablesT = Aws::Vector<Aws::String>>
  TrainingDataSchema& WithModelVariables(ModelVariablesT&& value) {
    SetModelVariables(std::forward<ModelVariablesT>(value));
    return *this;
  }
  template <typename ModelVariablesT = Aws::String>
  TrainingDataSchema& AddModelVariables(ModelVariablesT&& value) {
    m_modelVariablesHasBeenSet = true;
    m_modelVariables.emplace_back(std::forward<ModelVariablesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLabelSchema(LabelSchemaT&& value) {
    ...
    m_labelSchema = std::forward<LabelSchemaT>(value);
  }
  template <typename LabelSchemaT = LabelSchema>
  TrainingDataSchema& WithLabelSchema(LabelSchemaT&& value) {
    SetLabelSchema(std::forward<LabelSchemaT>(value));
    return *this;
  }
  ///@}
 private:
