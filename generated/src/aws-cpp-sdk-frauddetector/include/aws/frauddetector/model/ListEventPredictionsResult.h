...
class ListEventPredictionsResult {
 public:
  ...
  void SetEventPredictionSummaries(EventPredictionSummariesT&& value) {
    m_eventPredictionSummariesHasBeenSet = true;
    m_eventPredictionSummaries = std::forward<EventPredictionSummariesT>(value);
  }
  template <typename EventPredictionSummariesT = Aws::Vector<EventPredictionSummary>>
  ListEventPredictionsResult& WithEventPredictionSummaries(EventPredictionSummariesT&& value) {
    SetEventPredictionSummaries(std::forward<EventPredictionSummariesT>(value));
    return *this;
  }
  template <typename EventPredictionSummariesT = EventPredictionSummary>
  ListEventPredictionsResult& AddEventPredictionSummaries(EventPredictionSummariesT&& value) {
    m_eventPredictionSummariesHasBeenSet = true;
    m_eventPredictionSummaries.emplace_back(std::forward<EventPredictionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEventPredictionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEventPredictionsResult& WithRequestId(RequestIdT&& value) {
