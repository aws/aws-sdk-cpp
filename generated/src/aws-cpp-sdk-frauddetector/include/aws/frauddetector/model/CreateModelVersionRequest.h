...
class CreateModelVersionRequest : public FraudDetectorRequest {
 public:
  ...
  template <typename ModelIdT = Aws::String>
  CreateModelVersionRequest& WithModelId(ModelIdT&& value) {
  ...
  inline CreateModelVersionRequest& WithModelType(ModelTypeEnum value) {
    SetModelType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateModelVersionRequest& WithTrainingDataSource(TrainingDataSourceEnum value) {
  ...
  template <typename TrainingDataSchemaT = TrainingDataSchema>
  CreateModelVersionRequest& WithTrainingDataSchema(TrainingDataSchemaT&& value) {
  ...
  template <typename ExternalEventsDetailT = ExternalEventsDetail>
  CreateModelVersionRequest& WithExternalEventsDetail(ExternalEventsDetailT&& value) {
  ...
  template <typename IngestedEventsDetailT = IngestedEventsDetail>
  CreateModelVersionRequest& WithIngestedEventsDetail(IngestedEventsDetailT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateModelVersionRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateModelVersionRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
