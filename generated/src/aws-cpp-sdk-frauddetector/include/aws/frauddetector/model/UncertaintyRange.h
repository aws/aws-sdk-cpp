...
class UncertaintyRange {
 public:
  ...
  inline void SetLowerBoundValue(double value) {
    m_lowerBoundValueHasBeenSet = true;
    m_lowerBoundValue = value;
  }
  inline UncertaintyRange& WithLowerBoundValue(double value) {
  ...
  inline void SetUpperBoundValue(double value) {
    m_upperBoundValueHasBeenSet = true;
    m_upperBoundValue = value;
  }
  inline UncertaintyRange& WithUpperBoundValue(double value) {
