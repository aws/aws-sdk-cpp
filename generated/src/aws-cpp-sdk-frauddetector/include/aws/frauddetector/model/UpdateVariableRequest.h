...
class UpdateVariableRequest : public FraudDetectorRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateVariableRequest& WithName(NameT&& value) {
  ...
  template <typename DefaultValueT = Aws::String>
  UpdateVariableRequest& WithDefaultValue(DefaultValueT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateVariableRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename VariableTypeT = Aws::String>
  UpdateVariableRequest& WithVariableType(VariableTypeT&& value) {
