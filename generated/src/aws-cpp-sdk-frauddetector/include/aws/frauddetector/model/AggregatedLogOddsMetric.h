...
class AggregatedLogOddsMetric {
 public:
  ...
  inline void SetAggregatedVariablesImportance(double value) {
    m_aggregatedVariablesImportanceHasBeenSet = true;
    m_aggregatedVariablesImportance = value;
  }
  inline AggregatedLogOddsMetric& WithAggregatedVariablesImportance(double value) {
    SetAggregatedVariablesImportance(value);
    return *this;
  }
  ///@}
 private:
