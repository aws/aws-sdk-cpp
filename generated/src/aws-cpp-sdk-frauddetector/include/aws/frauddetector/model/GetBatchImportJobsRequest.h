...
class GetBatchImportJobsRequest : public FraudDetectorRequest {
 public:
  AWS_FRAUDDETECTOR_API GetBatchImportJobsRequest() = default;
  ...
  template <typename JobIdT = Aws::String>
  GetBatchImportJobsRequest& WithJobId(JobIdT&& value) {
  ...
  inline GetBatchImportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetBatchImportJobsRequest& WithNextToken(NextTokenT&& value) {
