...
class EvaluatedRule {
 public:
  ...
  void SetExpressionWithValues(ExpressionWithValuesT&& value) {
    ...
    m_expressionWithValues = std::forward<ExpressionWithValuesT>(value);
  }
  template <typename ExpressionWithValuesT = Aws::String>
  EvaluatedRule& WithExpressionWithValues(ExpressionWithValuesT&& value) {
    SetExpressionWithValues(std::forward<ExpressionWithValuesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEvaluated(bool value) {
    m_evaluatedHasBeenSet = true;
    m_evaluated = value;
  }
  inline EvaluatedRule& WithEvaluated(bool value) {
    SetEvaluated(value);
    return *this;
  }
  ///@}
  ...
  inline EvaluatedRule& WithMatched(bool value) {
    SetMatched(value);
    return *this;
  }
  ///@}
