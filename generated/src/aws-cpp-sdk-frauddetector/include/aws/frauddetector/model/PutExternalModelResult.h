...
namespace Model
{
  ...
  public:
    ...
    inline PutExternalModelResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutExternalModelResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutExternalModelResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
