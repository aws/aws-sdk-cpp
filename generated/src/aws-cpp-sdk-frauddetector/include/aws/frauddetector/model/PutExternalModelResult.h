...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API PutExternalModelResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutExternalModelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
