...
class GetEventPredictionRequest : public FraudDetectorRequest {
 public:
   ...
   */
  inline const Aws::Map<Aws::String, ModelEndpointDataBlob>& GetExternalModelEndpointDataBlobs() const {
    return m_externalModelEndpointDataBlobs;
  }
  ...
  void SetExternalModelEndpointDataBlobs(ExternalModelEndpointDataBlobsT&& value) {
    m_externalModelEndpointDataBlobsHasBeenSet = true;
    m_externalModelEndpointDataBlobs = std::forward<ExternalModelEndpointDataBlobsT>(value);
  }
  template <typename ExternalModelEndpointDataBlobsT = Aws::Map<Aws::String, ModelEndpointDataBlob>>
  GetEventPredictionRequest& WithExternalModelEndpointDataBlobs(ExternalModelEndpointDataBlobsT&& value) {
    SetExternalModelEndpointDataBlobs(std::forward<ExternalModelEndpointDataBlobsT>(value));
    return *this;
  }
  template <typename ExternalModelEndpointDataBlobsKeyT = Aws::String,
            typename ExternalModelEndpointDataBlobsValueT = ModelEndpointDataBlob>
  GetEventPredictionRequest& AddExternalModelEndpointDataBlobs(ExternalModelEndpointDataBlobsKeyT&& key,
                                                               ExternalModelEndpointDataBlobsValueT&& value) {
    m_externalModelEndpointDataBlobsHasBeenSet = true;
    m_externalModelEndpointDataBlobs.emplace(std::forward<ExternalModelEndpointDataBlobsKeyT>(key),
                                             std::forward<ExternalModelEndpointDataBlobsValueT>(value));
    return *this;
  }
  ///@}
 private:
