...
class GetDetectorVersionResult {
 public:
  ...
  void SetExternalModelEndpoints(ExternalModelEndpointsT&& value) {
    ...
    m_externalModelEndpoints = std::forward<ExternalModelEndpointsT>(value);
  }
  template <typename ExternalModelEndpointsT = Aws::Vector<Aws::String>>
  GetDetectorVersionResult& WithExternalModelEndpoints(ExternalModelEndpointsT&& value) {
    SetExternalModelEndpoints(std::forward<ExternalModelEndpointsT>(value));
    return *this;
  }
  ...
  GetDetectorVersionResult& AddExternalModelEndpoints(ExternalModelEndpointsT&& value) {
    m_externalModelEndpointsHasBeenSet = true;
    m_externalModelEndpoints.emplace_back(std::forward<ExternalModelEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetDetectorVersionResult& WithStatus(DetectorVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRuleExecutionMode(RuleExecutionMode value) {
    m_ruleExecutionModeHasBeenSet = true;
    m_ruleExecutionMode = value;
  }
  inline GetDetectorVersionResult& WithRuleExecutionMode(RuleExecutionMode value) {
    SetRuleExecutionMode(value);
    return *this;
  }
  ///@}
