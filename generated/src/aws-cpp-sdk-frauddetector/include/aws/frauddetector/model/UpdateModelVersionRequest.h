...
class UpdateModelVersionRequest : public FraudDetectorRequest {
 public:
  ...
  template <typename ModelIdT = Aws::String>
  UpdateModelVersionRequest& WithModelId(ModelIdT&& value) {
  ...
  inline UpdateModelVersionRequest& WithModelType(ModelTypeEnum value) {
    SetModelType(value);
    return *this;
  }
  ///@}
  ...
  void SetMajorVersionNumber(MajorVersionNumberT&& value) {
    m_majorVersionNumberHasBeenSet = true;
    m_majorVersionNumber = std::forward<MajorVersionNumberT>(value);
  }
  template <typename MajorVersionNumberT = Aws::String>
  UpdateModelVersionRequest& WithMajorVersionNumber(MajorVersionNumberT&& value) {
    SetMajorVersionNumber(std::forward<MajorVersionNumberT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExternalEventsDetailT = ExternalEventsDetail>
  UpdateModelVersionRequest& WithExternalEventsDetail(ExternalEventsDetailT&& value) {
  ...
  template <typename IngestedEventsDetailT = IngestedEventsDetail>
  UpdateModelVersionRequest& WithIngestedEventsDetail(IngestedEventsDetailT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  UpdateModelVersionRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  UpdateModelVersionRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
