...
class AggregatedVariablesImpactExplanation {
 public:
  ...
  void SetEventVariableNames(EventVariableNamesT&& value) {
    ...
    m_eventVariableNames = std::forward<EventVariableNamesT>(value);
  }
  template <typename EventVariableNamesT = Aws::Vector<Aws::String>>
  AggregatedVariablesImpactExplanation& WithEventVariableNames(EventVariableNamesT&& value) {
    SetEventVariableNames(std::forward<EventVariableNamesT>(value));
    return *this;
  }
  ...
  AggregatedVariablesImpactExplanation& AddEventVariableNames(EventVariableNamesT&& value) {
    m_eventVariableNamesHasBeenSet = true;
    m_eventVariableNames.emplace_back(std::forward<EventVariableNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelativeImpact(RelativeImpactT&& value) {
    ...
    m_relativeImpact = std::forward<RelativeImpactT>(value);
  }
  template <typename RelativeImpactT = Aws::String>
  AggregatedVariablesImpactExplanation& WithRelativeImpact(RelativeImpactT&& value) {
    SetRelativeImpact(std::forward<RelativeImpactT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLogOddsImpact(double value) {
    m_logOddsImpactHasBeenSet = true;
    m_logOddsImpact = value;
  }
  inline AggregatedVariablesImpactExplanation& WithLogOddsImpact(double value) {
    SetLogOddsImpact(value);
    return *this;
  }
  ///@}
 private:
