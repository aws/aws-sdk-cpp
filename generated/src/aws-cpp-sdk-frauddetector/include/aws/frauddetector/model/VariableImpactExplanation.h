...
class VariableImpactExplanation {
 public:
  ...
  void SetEventVariableName(EventVariableNameT&& value) {
    ...
    m_eventVariableName = std::forward<EventVariableNameT>(value);
  }
  template <typename EventVariableNameT = Aws::String>
  VariableImpactExplanation& WithEventVariableName(EventVariableNameT&& value) {
    SetEventVariableName(std::forward<EventVariableNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline VariableImpactExplanation& WithLogOddsImpact(double value) {
