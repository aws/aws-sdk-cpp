...
namespace Model
{
  ...
  public:
    ...
    inline DeleteOutcomeResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteOutcomeResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteOutcomeResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
