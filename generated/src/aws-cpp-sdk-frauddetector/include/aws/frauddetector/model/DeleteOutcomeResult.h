...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API DeleteOutcomeResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteOutcomeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
