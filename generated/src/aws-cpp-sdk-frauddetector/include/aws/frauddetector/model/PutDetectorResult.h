...
namespace Model
{
  ...
  public:
    ...
    inline PutDetectorResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutDetectorResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutDetectorResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
