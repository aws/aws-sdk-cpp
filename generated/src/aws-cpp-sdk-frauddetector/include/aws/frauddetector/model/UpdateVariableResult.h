...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API UpdateVariableResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateVariableResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
