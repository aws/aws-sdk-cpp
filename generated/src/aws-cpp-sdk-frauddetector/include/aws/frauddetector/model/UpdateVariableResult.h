...
namespace Model
{
  ...
  public:
    ...
    inline UpdateVariableResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateVariableResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateVariableResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
