...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API UpdateEventLabelResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateEventLabelResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
