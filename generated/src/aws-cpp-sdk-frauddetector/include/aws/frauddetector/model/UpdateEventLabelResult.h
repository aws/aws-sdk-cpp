...
namespace Model
{
  ...
  public:
    ...
    inline UpdateEventLabelResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateEventLabelResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateEventLabelResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
