...
namespace Model
{
  ...
  {
  public:
    AWS_FRAUDDETECTOR_API DeleteBatchImportJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteBatchImportJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
