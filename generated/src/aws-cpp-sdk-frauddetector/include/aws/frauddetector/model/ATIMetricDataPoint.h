...
class ATIMetricDataPoint {
 public:
  ...
  inline void SetCr(double value) {
    m_crHasBeenSet = true;
    m_cr = value;
  }
  inline ATIMetricDataPoint& WithCr(double value) {
    SetCr(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAdr(double value) {
    m_adrHasBeenSet = true;
    m_adr = value;
  }
  inline ATIMetricDataPoint& WithAdr(double value) {
    SetAdr(value);
    return *this;
  }
  ///@}
  ...
  inline ATIMetricDataPoint& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAtodr(double value) {
    m_atodrHasBeenSet = true;
    m_atodr = value;
  }
  inline ATIMetricDataPoint& WithAtodr(double value) {
    SetAtodr(value);
    return *this;
  }
  ///@}
