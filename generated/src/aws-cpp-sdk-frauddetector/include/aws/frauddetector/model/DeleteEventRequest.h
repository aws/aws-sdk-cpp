...
class DeleteEventRequest : public FraudDetectorRequest {
 public:
  ...
  inline void SetDeleteAuditHistory(bool value) {
    m_deleteAuditHistoryHasBeenSet = true;
    m_deleteAuditHistory = value;
  }
  inline DeleteEventRequest& WithDeleteAuditHistory(bool value) {
    SetDeleteAuditHistory(value);
    return *this;
  }
  ///@}
 private:
