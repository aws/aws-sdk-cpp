...
class UpdateDetectorVersionMetadataRequest : public FraudDetectorRequest {
 public:
  AWS_FRAUDDETECTOR_API UpdateDetectorVersionMetadataRequest() = default;
  ...
  template <typename DetectorIdT = Aws::String>
  UpdateDetectorVersionMetadataRequest& WithDetectorId(DetectorIdT&& value) {
  ...
  template <typename DetectorVersionIdT = Aws::String>
  UpdateDetectorVersionMetadataRequest& WithDetectorVersionId(DetectorVersionIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateDetectorVersionMetadataRequest& WithDescription(DescriptionT&& value) {
