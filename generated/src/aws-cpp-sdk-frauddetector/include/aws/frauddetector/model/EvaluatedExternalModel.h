...
class EvaluatedExternalModel {
 public:
  ...
  inline EvaluatedExternalModel& WithUseEventVariables(bool value) {
  ...
  EvaluatedExternalModel& AddInputVariables(InputVariablesKeyT&& key, InputVariablesValueT&& value) {
    m_inputVariablesHasBeenSet = true;
    m_inputVariables.emplace(std::forward<InputVariablesKeyT>(key), std::forward<InputVariablesValueT>(value));
    return *this;
  }
  ///@}
