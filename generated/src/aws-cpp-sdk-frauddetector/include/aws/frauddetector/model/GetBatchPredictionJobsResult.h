...
class GetBatchPredictionJobsResult {
 public:
  ...
  void SetBatchPredictions(BatchPredictionsT&& value) {
    m_batchPredictionsHasBeenSet = true;
    m_batchPredictions = std::forward<BatchPredictionsT>(value);
  }
  template <typename BatchPredictionsT = Aws::Vector<BatchPrediction>>
  GetBatchPredictionJobsResult& WithBatchPredictions(BatchPredictionsT&& value) {
    SetBatchPredictions(std::forward<BatchPredictionsT>(value));
    return *this;
  }
  template <typename BatchPredictionsT = BatchPrediction>
  GetBatchPredictionJobsResult& AddBatchPredictions(BatchPredictionsT&& value) {
    m_batchPredictionsHasBeenSet = true;
    m_batchPredictions.emplace_back(std::forward<BatchPredictionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetBatchPredictionJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBatchPredictionJobsResult& WithRequestId(RequestIdT&& value) {
