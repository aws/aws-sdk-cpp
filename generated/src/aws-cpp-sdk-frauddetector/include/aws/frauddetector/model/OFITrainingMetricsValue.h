...
class OFITrainingMetricsValue {
 public:
  ...
  void SetMetricDataPoints(MetricDataPointsT&& value) {
    m_metricDataPointsHasBeenSet = true;
    m_metricDataPoints = std::forward<MetricDataPointsT>(value);
  }
  template <typename MetricDataPointsT = Aws::Vector<OFIMetricDataPoint>>
  OFITrainingMetricsValue& WithMetricDataPoints(MetricDataPointsT&& value) {
    SetMetricDataPoints(std::forward<MetricDataPointsT>(value));
    return *this;
  }
  template <typename MetricDataPointsT = OFIMetricDataPoint>
  OFITrainingMetricsValue& AddMetricDataPoints(MetricDataPointsT&& value) {
    m_metricDataPointsHasBeenSet = true;
    m_metricDataPoints.emplace_back(std::forward<MetricDataPointsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelPerformance(ModelPerformanceT&& value) {
    m_modelPerformanceHasBeenSet = true;
    m_modelPerformance = std::forward<ModelPerformanceT>(value);
  }
  template <typename ModelPerformanceT = OFIModelPerformance>
  OFITrainingMetricsValue& WithModelPerformance(ModelPerformanceT&& value) {
    SetModelPerformance(std::forward<ModelPerformanceT>(value));
    return *this;
  }
  ///@}
 private:
