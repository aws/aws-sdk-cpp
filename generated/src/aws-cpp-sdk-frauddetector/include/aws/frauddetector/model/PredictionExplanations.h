...
class PredictionExplanations {
 public:
  ...
  void SetVariableImpactExplanations(VariableImpactExplanationsT&& value) {
    m_variableImpactExplanationsHasBeenSet = true;
    m_variableImpactExplanations = std::forward<VariableImpactExplanationsT>(value);
  }
  template <typename VariableImpactExplanationsT = Aws::Vector<VariableImpactExplanation>>
  PredictionExplanations& WithVariableImpactExplanations(VariableImpactExplanationsT&& value) {
    SetVariableImpactExplanations(std::forward<VariableImpactExplanationsT>(value));
    return *this;
  }
  template <typename VariableImpactExplanationsT = VariableImpactExplanation>
  PredictionExplanations& AddVariableImpactExplanations(VariableImpactExplanationsT&& value) {
    m_variableImpactExplanationsHasBeenSet = true;
    m_variableImpactExplanations.emplace_back(std::forward<VariableImpactExplanationsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<AggregatedVariablesImpactExplanation>& GetAggregatedVariablesImpactExplanations() const {
    return m_aggregatedVariablesImpactExplanations;
  }
  ...
  void SetAggregatedVariablesImpactExplanations(AggregatedVariablesImpactExplanationsT&& value) {
    m_aggregatedVariablesImpactExplanationsHasBeenSet = true;
    m_aggregatedVariablesImpactExplanations = std::forward<AggregatedVariablesImpactExplanationsT>(value);
  }
  template <typename AggregatedVariablesImpactExplanationsT = Aws::Vector<AggregatedVariablesImpactExplanation>>
  PredictionExplanations& WithAggregatedVariablesImpactExplanations(AggregatedVariablesImpactExplanationsT&& value) {
    SetAggregatedVariablesImpactExplanations(std::forward<AggregatedVariablesImpactExplanationsT>(value));
    return *this;
  }
  template <typename AggregatedVariablesImpactExplanationsT = AggregatedVariablesImpactExplanation>
  PredictionExplanations& AddAggregatedVariablesImpactExplanations(AggregatedVariablesImpactExplanationsT&& value) {
    m_aggregatedVariablesImpactExplanationsHasBeenSet = true;
    m_aggregatedVariablesImpactExplanations.emplace_back(std::forward<AggregatedVariablesImpactExplanationsT>(value));
    return *this;
  }
  ///@}
 private:
