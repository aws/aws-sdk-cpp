...
class GetModelVersionRequest : public FraudDetectorRequest {
 public:
  ...
  template <typename ModelIdT = Aws::String>
  GetModelVersionRequest& WithModelId(ModelIdT&& value) {
  ...
  inline GetModelVersionRequest& WithModelType(ModelTypeEnum value) {
    SetModelType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ModelVersionNumberT = Aws::String>
  GetModelVersionRequest& WithModelVersionNumber(ModelVersionNumberT&& value) {
