...
class AWS_FRAUDDETECTOR_API FraudDetectorClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  FraudDetectorClient(const Aws::FraudDetector::FraudDetectorClientConfiguration& clientConfiguration =
  ...
  FraudDetectorClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<FraudDetectorEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::FraudDetector::FraudDetectorClientConfiguration& clientConfiguration =
                          Aws::FraudDetector::FraudDetectorClientConfiguration());
  ...
  /**
   * A Callable wrapper for BatchCreateVariable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchCreateVariable that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchCreateVariableRequestT = Model::BatchCreateVariableRequest>
  void BatchCreateVariableAsync(const BatchCreateVariableRequestT& request, const BatchCreateVariableResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for BatchGetVariable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetVariable that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetVariableRequestT = Model::BatchGetVariableRequest>
  void BatchGetVariableAsync(const BatchGetVariableRequestT& request, const BatchGetVariableResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelBatchImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelBatchImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelBatchImportJobRequestT = Model::CancelBatchImportJobRequest>
  void CancelBatchImportJobAsync(const CancelBatchImportJobRequestT& request, const CancelBatchImportJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelBatchPredictionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelBatchPredictionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelBatchPredictionJobRequestT = Model::CancelBatchPredictionJobRequest>
  void CancelBatchPredictionJobAsync(const CancelBatchPredictionJobRequestT& request,
                                     const CancelBatchPredictionJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBatchImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBatchImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateBatchImportJobRequestT = Model::CreateBatchImportJobRequest>
  void CreateBatchImportJobAsync(const CreateBatchImportJobRequestT& request, const CreateBatchImportJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBatchPredictionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBatchPredictionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateBatchPredictionJobRequestT = Model::CreateBatchPredictionJobRequest>
  void CreateBatchPredictionJobAsync(const CreateBatchPredictionJobRequestT& request,
                                     const CreateBatchPredictionJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDetectorVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDetectorVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDetectorVersionRequestT = Model::CreateDetectorVersionRequest>
  void CreateDetectorVersionAsync(const CreateDetectorVersionRequestT& request, const CreateDetectorVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateListRequestT = Model::CreateListRequest>
  void CreateListAsync(const CreateListRequestT& request, const CreateListResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateModelVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateModelVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateModelVersionRequestT = Model::CreateModelVersionRequest>
  void CreateModelVersionAsync(const CreateModelVersionRequestT& request, const CreateModelVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateVariable that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateVariableRequestT = Model::CreateVariableRequest>
  void CreateVariableAsync(const CreateVariableRequestT& request, const CreateVariableResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBatchImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBatchImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBatchImportJobRequestT = Model::DeleteBatchImportJobRequest>
  void DeleteBatchImportJobAsync(const DeleteBatchImportJobRequestT& request, const DeleteBatchImportJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBatchPredictionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBatchPredictionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBatchPredictionJobRequestT = Model::DeleteBatchPredictionJobRequest>
  void DeleteBatchPredictionJobAsync(const DeleteBatchPredictionJobRequestT& request,
                                     const DeleteBatchPredictionJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteDetector that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteDetectorRequestT = Model::DeleteDetectorRequest>
  void DeleteDetectorAsync(const DeleteDetectorRequestT& request, const DeleteDetectorResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDetectorVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDetectorVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDetectorVersionRequestT = Model::DeleteDetectorVersionRequest>
  void DeleteDetectorVersionAsync(const DeleteDetectorVersionRequestT& request, const DeleteDetectorVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEntityType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEntityType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteEntityTypeRequestT = Model::DeleteEntityTypeRequest>
  void DeleteEntityTypeAsync(const DeleteEntityTypeRequestT& request, const DeleteEntityTypeResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteEventType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteEventTypeRequestT = Model::DeleteEventTypeRequest>
  void DeleteEventTypeAsync(const DeleteEventTypeRequestT& request, const DeleteEventTypeResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEventsByEventType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEventsByEventType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEventsByEventTypeRequestT = Model::DeleteEventsByEventTypeRequest>
  void DeleteEventsByEventTypeAsync(const DeleteEventsByEventTypeRequestT& request,
                                    const DeleteEventsByEventTypeResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteExternalModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteExternalModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteExternalModelRequestT = Model::DeleteExternalModelRequest>
  void DeleteExternalModelAsync(const DeleteExternalModelRequestT& request, const DeleteExternalModelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteListRequestT = Model::DeleteListRequest>
  void DeleteListAsync(const DeleteListRequestT& request, const DeleteListResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteModelVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteModelVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteModelVersionRequestT = Model::DeleteModelVersionRequest>
  void DeleteModelVersionAsync(const DeleteModelVersionRequestT& request, const DeleteModelVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteOutcome that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteOutcomeRequestT = Model::DeleteOutcomeRequest>
  void DeleteOutcomeAsync(const DeleteOutcomeRequestT& request, const DeleteOutcomeResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteVariable that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteVariableRequestT = Model::DeleteVariableRequest>
  void DeleteVariableAsync(const DeleteVariableRequestT& request, const DeleteVariableResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDetector that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDetector that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDetectorRequestT = Model::DescribeDetectorRequest>
  void DescribeDetectorAsync(const DescribeDetectorRequestT& request, const DescribeDetectorResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeModelVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeModelVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeModelVersionsRequestT = Model::DescribeModelVersionsRequest>
  void DescribeModelVersionsAsync(const DescribeModelVersionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeModelVersionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetBatchImportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBatchImportJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBatchImportJobsRequestT = Model::GetBatchImportJobsRequest>
  void GetBatchImportJobsAsync(const GetBatchImportJobsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetBatchImportJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetBatchPredictionJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBatchPredictionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBatchPredictionJobsRequestT = Model::GetBatchPredictionJobsRequest>
  void GetBatchPredictionJobsAsync(const GetBatchPredictionJobsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const GetBatchPredictionJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDeleteEventsByEventTypeStatusOutcome GetDeleteEventsByEventTypeStatus(
      const Model::GetDeleteEventsByEventTypeStatusRequest& request) const;

  /**
   * A Callable wrapper for GetDeleteEventsByEventTypeStatus that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetDeleteEventsByEventTypeStatusRequestT = Model::GetDeleteEventsByEventTypeStatusRequest>
  Model::GetDeleteEventsByEventTypeStatusOutcomeCallable GetDeleteEventsByEventTypeStatusCallable(
      const GetDeleteEventsByEventTypeStatusRequestT& request) const {
    return SubmitCallable(&FraudDetectorClient::GetDeleteEventsByEventTypeStatus, request);
  }

  /**
   * An Async wrapper for GetDeleteEventsByEventTypeStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetDeleteEventsByEventTypeStatusRequestT = Model::GetDeleteEventsByEventTypeStatusRequest>
  void GetDeleteEventsByEventTypeStatusAsync(const GetDeleteEventsByEventTypeStatusRequestT& request,
                                             const GetDeleteEventsByEventTypeStatusResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDetectorVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDetectorVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDetectorVersionRequestT = Model::GetDetectorVersionRequest>
  void GetDetectorVersionAsync(const GetDetectorVersionRequestT& request, const GetDetectorVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDetectors that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDetectorsRequestT = Model::GetDetectorsRequest>
  void GetDetectorsAsync(const GetDetectorsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const GetDetectorsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetEntityTypes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetEntityTypesRequestT = Model::GetEntityTypesRequest>
  void GetEntityTypesAsync(const GetEntityTypesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetEntityTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetEventPrediction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEventPrediction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetEventPredictionRequestT = Model::GetEventPredictionRequest>
  void GetEventPredictionAsync(const GetEventPredictionRequestT& request, const GetEventPredictionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEventPredictionMetadataOutcome GetEventPredictionMetadata(
      const Model::GetEventPredictionMetadataRequest& request) const;

  /**
   * A Callable wrapper for GetEventPredictionMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetEventPredictionMetadataRequestT = Model::GetEventPredictionMetadataRequest>
  Model::GetEventPredictionMetadataOutcomeCallable GetEventPredictionMetadataCallable(
      const GetEventPredictionMetadataRequestT& request) const {
    return SubmitCallable(&FraudDetectorClient::GetEventPredictionMetadata, request);
  }

  /**
   * An Async wrapper for GetEventPredictionMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEventPredictionMetadataRequestT = Model::GetEventPredictionMetadataRequest>
  void GetEventPredictionMetadataAsync(const GetEventPredictionMetadataRequestT& request,
                                       const GetEventPredictionMetadataResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetEventTypes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetEventTypesRequestT = Model::GetEventTypesRequest>
  void GetEventTypesAsync(const GetEventTypesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const GetEventTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetExternalModels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetExternalModels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetExternalModelsRequestT = Model::GetExternalModelsRequest>
  void GetExternalModelsAsync(const GetExternalModelsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetExternalModelsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetKMSEncryptionKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetKMSEncryptionKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetKMSEncryptionKeyRequestT = Model::GetKMSEncryptionKeyRequest>
  void GetKMSEncryptionKeyAsync(const GetKMSEncryptionKeyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetKMSEncryptionKeyRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetLabels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLabelsRequestT = Model::GetLabelsRequest>
  void GetLabelsAsync(const GetLabelsResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const GetLabelsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetListElements that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetListElementsRequestT = Model::GetListElementsRequest>
  void GetListElementsAsync(const GetListElementsRequestT& request, const GetListElementsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetListsMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetListsMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetListsMetadataRequestT = Model::GetListsMetadataRequest>
  void GetListsMetadataAsync(const GetListsMetadataResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetListsMetadataRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetModelVersion that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetModelVersionRequestT = Model::GetModelVersionRequest>
  void GetModelVersionAsync(const GetModelVersionRequestT& request, const GetModelVersionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetModels that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetModelsRequestT = Model::GetModelsRequest>
  void GetModelsAsync(const GetModelsResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const GetModelsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetOutcomes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOutcomesRequestT = Model::GetOutcomesRequest>
  void GetOutcomesAsync(const GetOutcomesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetOutcomesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetRules that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRulesRequestT = Model::GetRulesRequest>
  void GetRulesAsync(const GetRulesRequestT& request, const GetRulesResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetVariables that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetVariablesRequestT = Model::GetVariablesRequest>
  void GetVariablesAsync(const GetVariablesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const GetVariablesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEventPredictions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEventPredictions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEventPredictionsRequestT = Model::ListEventPredictionsRequest>
  void ListEventPredictionsAsync(const ListEventPredictionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListEventPredictionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for PutDetector that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutDetectorRequestT = Model::PutDetectorRequest>
  void PutDetectorAsync(const PutDetectorRequestT& request, const PutDetectorResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutEntityType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutEntityTypeRequestT = Model::PutEntityTypeRequest>
  void PutEntityTypeAsync(const PutEntityTypeRequestT& request, const PutEntityTypeResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutEventType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutEventTypeRequestT = Model::PutEventTypeRequest>
  void PutEventTypeAsync(const PutEventTypeRequestT& request, const PutEventTypeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutExternalModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutExternalModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutExternalModelRequestT = Model::PutExternalModelRequest>
  void PutExternalModelAsync(const PutExternalModelRequestT& request, const PutExternalModelResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutKMSEncryptionKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutKMSEncryptionKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutKMSEncryptionKeyRequestT = Model::PutKMSEncryptionKeyRequest>
  void PutKMSEncryptionKeyAsync(const PutKMSEncryptionKeyRequestT& request, const PutKMSEncryptionKeyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutLabel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutLabelRequestT = Model::PutLabelRequest>
  void PutLabelAsync(const PutLabelRequestT& request, const PutLabelResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutOutcome that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutOutcomeRequestT = Model::PutOutcomeRequest>
  void PutOutcomeAsync(const PutOutcomeRequestT& request, const PutOutcomeResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDetectorVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDetectorVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDetectorVersionRequestT = Model::UpdateDetectorVersionRequest>
  void UpdateDetectorVersionAsync(const UpdateDetectorVersionRequestT& request, const UpdateDetectorVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDetectorVersionMetadataOutcome UpdateDetectorVersionMetadata(
      const Model::UpdateDetectorVersionMetadataRequest& request) const;

  /**
   * A Callable wrapper for UpdateDetectorVersionMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateDetectorVersionMetadataRequestT = Model::UpdateDetectorVersionMetadataRequest>
  Model::UpdateDetectorVersionMetadataOutcomeCallable UpdateDetectorVersionMetadataCallable(
      const UpdateDetectorVersionMetadataRequestT& request) const {
    return SubmitCallable(&FraudDetectorClient::UpdateDetectorVersionMetadata, request);
  }

  /**
   * An Async wrapper for UpdateDetectorVersionMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDetectorVersionMetadataRequestT = Model::UpdateDetectorVersionMetadataRequest>
  void UpdateDetectorVersionMetadataAsync(const UpdateDetectorVersionMetadataRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDetectorVersionStatusOutcome UpdateDetectorVersionStatus(
      const Model::UpdateDetectorVersionStatusRequest& request) const;

  /**
   * A Callable wrapper for UpdateDetectorVersionStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateDetectorVersionStatusRequestT = Model::UpdateDetectorVersionStatusRequest>
  Model::UpdateDetectorVersionStatusOutcomeCallable UpdateDetectorVersionStatusCallable(
      const UpdateDetectorVersionStatusRequestT& request) const {
    return SubmitCallable(&FraudDetectorClient::UpdateDetectorVersionStatus, request);
  }

  /**
   * An Async wrapper for UpdateDetectorVersionStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDetectorVersionStatusRequestT = Model::UpdateDetectorVersionStatusRequest>
  void UpdateDetectorVersionStatusAsync(const UpdateDetectorVersionStatusRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateEventLabel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEventLabel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateEventLabelRequestT = Model::UpdateEventLabelRequest>
  void UpdateEventLabelAsync(const UpdateEventLabelRequestT& request, const UpdateEventLabelResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateListRequestT = Model::UpdateListRequest>
  void UpdateListAsync(const UpdateListRequestT& request, const UpdateListResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateModelVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateModelVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateModelVersionRequestT = Model::UpdateModelVersionRequest>
  void UpdateModelVersionAsync(const UpdateModelVersionRequestT& request, const UpdateModelVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateModelVersionStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateModelVersionStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateModelVersionStatusRequestT = Model::UpdateModelVersionStatusRequest>
  void UpdateModelVersionStatusAsync(const UpdateModelVersionStatusRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateRuleMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRuleMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateRuleMetadataRequestT = Model::UpdateRuleMetadataRequest>
  void UpdateRuleMetadataAsync(const UpdateRuleMetadataRequestT& request, const UpdateRuleMetadataResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateRuleVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRuleVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateRuleVersionRequestT = Model::UpdateRuleVersionRequest>
  void UpdateRuleVersionAsync(const UpdateRuleVersionRequestT& request, const UpdateRuleVersionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateVariable that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateVariableRequestT = Model::UpdateVariableRequest>
  void UpdateVariableAsync(const UpdateVariableRequestT& request, const UpdateVariableResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
