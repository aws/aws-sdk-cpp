...
namespace FraudDetector
{
   ...
   * section. </p>
   */
  class AWS_FRAUDDETECTOR_API FraudDetectorClient : smithy::client::AwsSmithyClientT<Aws::FraudDetector::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<FraudDetectorClient>
  {
    public:
