...
static const int INVALID_RESPONSIBILITY_TRANSFER_TRANSITION_HASH =
    HashingUtils::HashString("InvalidResponsibilityTransferTransitionException");
...
static const int RESPONSIBILITY_TRANSFER_NOT_FOUND_HASH = HashingUtils::HashString("ResponsibilityTransferNotFoundException");
...
static const int RESPONSIBILITY_TRANSFER_ALREADY_IN_STATUS_HASH =
    HashingUtils::HashString("ResponsibilityTransferAlreadyInStatusException");
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  } else if (hashCode == INVALID_RESPONSIBILITY_TRANSFER_TRANSITION_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(OrganizationsErrors::INVALID_RESPONSIBILITY_TRANSFER_TRANSITION),
  ...
  } else if (hashCode == RESPONSIBILITY_TRANSFER_NOT_FOUND_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(OrganizationsErrors::RESPONSIBILITY_TRANSFER_NOT_FOUND),
                                RetryableType::NOT_RETRYABLE);
  ...
  } else if (hashCode == RESPONSIBILITY_TRANSFER_ALREADY_IN_STATUS_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(OrganizationsErrors::RESPONSIBILITY_TRANSFER_ALREADY_IN_STATUS),
                                RetryableType::NOT_RETRYABLE);
