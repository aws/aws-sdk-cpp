...
TerminateResponsibilityTransferResult::TerminateResponsibilityTransferResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

TerminateResponsibilityTransferResult& TerminateResponsibilityTransferResult::operator=(
