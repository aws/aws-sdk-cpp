...
static const int ACCOUNT_CANNOT_LEAVE_WITHOUT_PHONE_VERIFICATION_HASH =
    HashingUtils::HashString("ACCOUNT_CANNOT_LEAVE_WITHOUT_PHONE_VERIFICATION");
...
static const int MASTER_ACCOUNT_ADDRESS_DOES_NOT_MATCH_MARKETPLACE_HASH =
    HashingUtils::HashString("MASTER_ACCOUNT_ADDRESS_DOES_NOT_MATCH_MARKETPLACE");
...
static const int CREATE_ORGANIZATION_IN_BILLING_MODE_UNSUPPORTED_REGION_HASH =
    HashingUtils::HashString("CREATE_ORGANIZATION_IN_BILLING_MODE_UNSUPPORTED_REGION");
...
static const int MAX_DELEGATED_ADMINISTRATORS_FOR_SERVICE_LIMIT_EXCEEDED_HASH =
    HashingUtils::HashString("MAX_DELEGATED_ADMINISTRATORS_FOR_SERVICE_LIMIT_EXCEEDED");
static const int CANNOT_REGISTER_MASTER_AS_DELEGATED_ADMINISTRATOR_HASH =
    HashingUtils::HashString("CANNOT_REGISTER_MASTER_AS_DELEGATED_ADMINISTRATOR");
static const int CANNOT_REMOVE_DELEGATED_ADMINISTRATOR_FROM_ORG_HASH =
    HashingUtils::HashString("CANNOT_REMOVE_DELEGATED_ADMINISTRATOR_FROM_ORG");
static const int DELEGATED_ADMINISTRATOR_EXISTS_FOR_THIS_SERVICE_HASH =
    HashingUtils::HashString("DELEGATED_ADMINISTRATOR_EXISTS_FOR_THIS_SERVICE");
...
static const int CANNOT_REGISTER_SUSPENDED_ACCOUNT_AS_DELEGATED_ADMINISTRATOR_HASH =
    HashingUtils::HashString("CANNOT_REGISTER_SUSPENDED_ACCOUNT_AS_DELEGATED_ADMINISTRATOR");
static const int ALL_FEATURES_MIGRATION_ORGANIZATION_SIZE_LIMIT_EXCEEDED_HASH =
    HashingUtils::HashString("ALL_FEATURES_MIGRATION_ORGANIZATION_SIZE_LIMIT_EXCEEDED");
static const int RESPONSIBILITY_TRANSFER_MAX_LEVEL_VIOLATION_HASH = HashingUtils::HashString("RESPONSIBILITY_TRANSFER_MAX_LEVEL_VIOLATION");
static const int RESPONSIBILITY_TRANSFER_MAX_INBOUND_QUOTA_VIOLATION_HASH =
    HashingUtils::HashString("RESPONSIBILITY_TRANSFER_MAX_INBOUND_QUOTA_VIOLATION");
static const int RESPONSIBILITY_TRANSFER_MAX_OUTBOUND_QUOTA_VIOLATION_HASH =
    HashingUtils::HashString("RESPONSIBILITY_TRANSFER_MAX_OUTBOUND_QUOTA_VIOLATION");
static const int RESPONSIBILITY_TRANSFER_MAX_TRANSFERS_QUOTA_VIOLATION_HASH =
    HashingUtils::HashString("RESPONSIBILITY_TRANSFER_MAX_TRANSFERS_QUOTA_VIOLATION");
static const int ACTIVE_RESPONSIBILITY_TRANSFER_PROCESS_HASH = HashingUtils::HashString("ACTIVE_RESPONSIBILITY_TRANSFER_PROCESS");
static const int TRANSFER_RESPONSIBILITY_TARGET_DELETION_IN_PROGRESS_HASH =
    HashingUtils::HashString("TRANSFER_RESPONSIBILITY_TARGET_DELETION_IN_PROGRESS");
...
ConstraintViolationExceptionReason GetConstraintViolationExceptionReasonForName(const Aws::String& name) {
  ...
  } else if (hashCode == RESPONSIBILITY_TRANSFER_MAX_LEVEL_VIOLATION_HASH) {
    return ConstraintViolationExceptionReason::RESPONSIBILITY_TRANSFER_MAX_LEVEL_VIOLATION;
  } else if (hashCode == RESPONSIBILITY_TRANSFER_MAX_INBOUND_QUOTA_VIOLATION_HASH) {
    return ConstraintViolationExceptionReason::RESPONSIBILITY_TRANSFER_MAX_INBOUND_QUOTA_VIOLATION;
  } else if (hashCode == RESPONSIBILITY_TRANSFER_MAX_OUTBOUND_QUOTA_VIOLATION_HASH) {
    return ConstraintViolationExceptionReason::RESPONSIBILITY_TRANSFER_MAX_OUTBOUND_QUOTA_VIOLATION;
  } else if (hashCode == RESPONSIBILITY_TRANSFER_MAX_TRANSFERS_QUOTA_VIOLATION_HASH) {
    return ConstraintViolationExceptionReason::RESPONSIBILITY_TRANSFER_MAX_TRANSFERS_QUOTA_VIOLATION;
  } else if (hashCode == ACTIVE_RESPONSIBILITY_TRANSFER_PROCESS_HASH) {
    return ConstraintViolationExceptionReason::ACTIVE_RESPONSIBILITY_TRANSFER_PROCESS;
  } else if (hashCode == TRANSFER_RESPONSIBILITY_TARGET_DELETION_IN_PROGRESS_HASH) {
    return ConstraintViolationExceptionReason::TRANSFER_RESPONSIBILITY_TARGET_DELETION_IN_PROGRESS;
  } else if (hashCode == TRANSFER_RESPONSIBILITY_SOURCE_DELETION_IN_PROGRESS_HASH) {
...
Aws::String GetNameForConstraintViolationExceptionReason(ConstraintViolationExceptionReason enumValue) {
  switch (enumValue) {
    case ConstraintViolationExceptionReason::NOT_SET:
      return {};
    ...
    case ConstraintViolationExceptionReason::RESPONSIBILITY_TRANSFER_MAX_LEVEL_VIOLATION:
      return "RESPONSIBILITY_TRANSFER_MAX_LEVEL_VIOLATION";
    case ConstraintViolationExceptionReason::RESPONSIBILITY_TRANSFER_MAX_INBOUND_QUOTA_VIOLATION:
      return "RESPONSIBILITY_TRANSFER_MAX_INBOUND_QUOTA_VIOLATION";
    case ConstraintViolationExceptionReason::RESPONSIBILITY_TRANSFER_MAX_OUTBOUND_QUOTA_VIOLATION:
      return "RESPONSIBILITY_TRANSFER_MAX_OUTBOUND_QUOTA_VIOLATION";
    case ConstraintViolationExceptionReason::RESPONSIBILITY_TRANSFER_MAX_TRANSFERS_QUOTA_VIOLATION:
      return "RESPONSIBILITY_TRANSFER_MAX_TRANSFERS_QUOTA_VIOLATION";
    case ConstraintViolationExceptionReason::ACTIVE_RESPONSIBILITY_TRANSFER_PROCESS:
      return "ACTIVE_RESPONSIBILITY_TRANSFER_PROCESS";
    case ConstraintViolationExceptionReason::TRANSFER_RESPONSIBILITY_TARGET_DELETION_IN_PROGRESS:
      return "TRANSFER_RESPONSIBILITY_TARGET_DELETION_IN_PROGRESS";
    case ConstraintViolationExceptionReason::TRANSFER_RESPONSIBILITY_SOURCE_DELETION_IN_PROGRESS:
