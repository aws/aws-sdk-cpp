...
ListEffectivePolicyValidationErrorsResult& ListEffectivePolicyValidationErrorsResult::operator=(
  ...
  if (jsonValue.ValueExists("EffectivePolicyValidationErrors")) {
    ...
    for (unsigned effectivePolicyValidationErrorsIndex = 0;
         effectivePolicyValidationErrorsIndex < effectivePolicyValidationErrorsJsonList.GetLength();
         ++effectivePolicyValidationErrorsIndex) {
