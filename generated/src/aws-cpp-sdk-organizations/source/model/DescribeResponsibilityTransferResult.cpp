...
DescribeResponsibilityTransferResult::DescribeResponsibilityTransferResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

DescribeResponsibilityTransferResult& DescribeResponsibilityTransferResult::operator=(
