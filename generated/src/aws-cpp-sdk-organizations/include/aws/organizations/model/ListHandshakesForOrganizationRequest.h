...
class ListHandshakesForOrganizationRequest : public OrganizationsRequest {
 public:
  ...
  template <typename FilterT = HandshakeFilter>
  ListHandshakesForOrganizationRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListHandshakesForOrganizationRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListHandshakesForOrganizationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
