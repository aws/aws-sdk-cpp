...
class EffectivePolicyValidationError {
 public:
  ...
  template <typename ErrorCodeT = Aws::String>
  EffectivePolicyValidationError& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  EffectivePolicyValidationError& WithErrorMessage(ErrorMessageT&& value) {
  ...
  void SetPathToError(PathToErrorT&& value) {
    m_pathToErrorHasBeenSet = true;
    m_pathToError = std::forward<PathToErrorT>(value);
  }
  template <typename PathToErrorT = Aws::String>
  EffectivePolicyValidationError& WithPathToError(PathToErrorT&& value) {
    SetPathToError(std::forward<PathToErrorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContributingPolicies(ContributingPoliciesT&& value) {
    m_contributingPoliciesHasBeenSet = true;
    m_contributingPolicies = std::forward<ContributingPoliciesT>(value);
  }
  template <typename ContributingPoliciesT = Aws::Vector<Aws::String>>
  EffectivePolicyValidationError& WithContributingPolicies(ContributingPoliciesT&& value) {
    SetContributingPolicies(std::forward<ContributingPoliciesT>(value));
    return *this;
  }
  template <typename ContributingPoliciesT = Aws::String>
  EffectivePolicyValidationError& AddContributingPolicies(ContributingPoliciesT&& value) {
    m_contributingPoliciesHasBeenSet = true;
    m_contributingPolicies.emplace_back(std::forward<ContributingPoliciesT>(value));
    return *this;
  }
  ///@}
 private:
