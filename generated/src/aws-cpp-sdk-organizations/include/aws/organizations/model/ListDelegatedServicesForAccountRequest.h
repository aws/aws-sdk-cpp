...
class ListDelegatedServicesForAccountRequest : public OrganizationsRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  ListDelegatedServicesForAccountRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDelegatedServicesForAccountRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDelegatedServicesForAccountRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
