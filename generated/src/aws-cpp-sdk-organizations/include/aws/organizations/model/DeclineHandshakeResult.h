...
namespace Model
{
  ...
  {
  public:
    AWS_ORGANIZATIONS_API DeclineHandshakeResult() = default;
    ...
    template<typename HandshakeT = Handshake>
    DeclineHandshakeResult& WithHandshake(HandshakeT&& value) { SetHandshake(std::forward<HandshakeT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeclineHandshakeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
