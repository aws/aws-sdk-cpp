...
class DelegatedAdministrator {
 public:
  ...
  template <typename IdT = Aws::String>
  DelegatedAdministrator& WithId(IdT&& value) {
  ...
  inline DelegatedAdministrator& WithStatus(AccountStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DelegatedAdministrator& WithJoinedMethod(AccountJoinedMethod value) {
