...
/**
 */
class ListOutboundResponsibilityTransfersRequest : public OrganizationsRequest {
 public:
  AWS_ORGANIZATIONS_API ListOutboundResponsibilityTransfersRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListOutboundResponsibilityTransfers"; }
  ...
  inline ListOutboundResponsibilityTransfersRequest& WithType(ResponsibilityTransferType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOutboundResponsibilityTransfersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListOutboundResponsibilityTransfersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
