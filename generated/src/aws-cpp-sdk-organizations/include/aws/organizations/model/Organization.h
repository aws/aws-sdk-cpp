...
class Organization {
 public:
  ...
  inline void SetFeatureSet(OrganizationFeatureSet value) {
    m_featureSetHasBeenSet = true;
    m_featureSet = value;
  }
  inline Organization& WithFeatureSet(OrganizationFeatureSet value) {
    SetFeatureSet(value);
    return *this;
  }
  ///@}
  ...
  void SetMasterAccountArn(MasterAccountArnT&& value) {
    ...
    m_masterAccountArn = std::forward<MasterAccountArnT>(value);
  }
  template <typename MasterAccountArnT = Aws::String>
  Organization& WithMasterAccountArn(MasterAccountArnT&& value) {
    SetMasterAccountArn(std::forward<MasterAccountArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMasterAccountId(MasterAccountIdT&& value) {
    ...
    m_masterAccountId = std::forward<MasterAccountIdT>(value);
  }
  template <typename MasterAccountIdT = Aws::String>
  Organization& WithMasterAccountId(MasterAccountIdT&& value) {
    SetMasterAccountId(std::forward<MasterAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMasterAccountEmail(MasterAccountEmailT&& value) {
    ...
    m_masterAccountEmail = std::forward<MasterAccountEmailT>(value);
  }
  template <typename MasterAccountEmailT = Aws::String>
  Organization& WithMasterAccountEmail(MasterAccountEmailT&& value) {
    SetMasterAccountEmail(std::forward<MasterAccountEmailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAvailablePolicyTypes(AvailablePolicyTypesT&& value) {
    ...
    m_availablePolicyTypes = std::forward<AvailablePolicyTypesT>(value);
  }
  template <typename AvailablePolicyTypesT = Aws::Vector<PolicyTypeSummary>>
  Organization& WithAvailablePolicyTypes(AvailablePolicyTypesT&& value) {
    SetAvailablePolicyTypes(std::forward<AvailablePolicyTypesT>(value));
    return *this;
  }
  ...
  Organization& AddAvailablePolicyTypes(AvailablePolicyTypesT&& value) {
    m_availablePolicyTypesHasBeenSet = true;
    m_availablePolicyTypes.emplace_back(std::forward<AvailablePolicyTypesT>(value));
    return *this;
  }
  ///@}
 private:
