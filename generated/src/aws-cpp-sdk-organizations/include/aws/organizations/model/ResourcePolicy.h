...
class ResourcePolicy {
 public:
  ...
  void SetResourcePolicySummary(ResourcePolicySummaryT&& value) {
    m_resourcePolicySummaryHasBeenSet = true;
    m_resourcePolicySummary = std::forward<ResourcePolicySummaryT>(value);
  }
  template <typename ResourcePolicySummaryT = ResourcePolicySummary>
  ResourcePolicy& WithResourcePolicySummary(ResourcePolicySummaryT&& value) {
    SetResourcePolicySummary(std::forward<ResourcePolicySummaryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ContentT = Aws::String>
  ResourcePolicy& WithContent(ContentT&& value) {
