...
class ListRootsResult {
 public:
  ...
  void SetRoots(RootsT&& value) {
    m_rootsHasBeenSet = true;
    m_roots = std::forward<RootsT>(value);
  }
  template <typename RootsT = Aws::Vector<Root>>
  ListRootsResult& WithRoots(RootsT&& value) {
    SetRoots(std::forward<RootsT>(value));
    return *this;
  }
  template <typename RootsT = Root>
  ListRootsResult& AddRoots(RootsT&& value) {
    m_rootsHasBeenSet = true;
    m_roots.emplace_back(std::forward<RootsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRootsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRootsResult& WithRequestId(RequestIdT&& value) {
