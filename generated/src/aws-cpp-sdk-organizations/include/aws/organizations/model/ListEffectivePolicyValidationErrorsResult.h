...
class ListEffectivePolicyValidationErrorsResult {
 public:
  ...
  AWS_ORGANIZATIONS_API ListEffectivePolicyValidationErrorsResult& operator=(
  ...
  template <typename AccountIdT = Aws::String>
  ListEffectivePolicyValidationErrorsResult& WithAccountId(AccountIdT&& value) {
  ...
  inline ListEffectivePolicyValidationErrorsResult& WithPolicyType(EffectivePolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PathT = Aws::String>
  ListEffectivePolicyValidationErrorsResult& WithPath(PathT&& value) {
  ...
  void SetEvaluationTimestamp(EvaluationTimestampT&& value) {
    m_evaluationTimestampHasBeenSet = true;
    m_evaluationTimestamp = std::forward<EvaluationTimestampT>(value);
  }
  template <typename EvaluationTimestampT = Aws::Utils::DateTime>
  ListEffectivePolicyValidationErrorsResult& WithEvaluationTimestamp(EvaluationTimestampT&& value) {
    SetEvaluationTimestamp(std::forward<EvaluationTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEffectivePolicyValidationErrorsResult& WithNextToken(NextTokenT&& value) {
   ...
   * error.</p>
   */
  inline const Aws::Vector<EffectivePolicyValidationError>& GetEffectivePolicyValidationErrors() const {
    return m_effectivePolicyValidationErrors;
  }
  template <typename EffectivePolicyValidationErrorsT = Aws::Vector<EffectivePolicyValidationError>>
  void SetEffectivePolicyValidationErrors(EffectivePolicyValidationErrorsT&& value) {
    m_effectivePolicyValidationErrorsHasBeenSet = true;
    m_effectivePolicyValidationErrors = std::forward<EffectivePolicyValidationErrorsT>(value);
  }
  template <typename EffectivePolicyValidationErrorsT = Aws::Vector<EffectivePolicyValidationError>>
  ListEffectivePolicyValidationErrorsResult& WithEffectivePolicyValidationErrors(EffectivePolicyValidationErrorsT&& value) {
    SetEffectivePolicyValidationErrors(std::forward<EffectivePolicyValidationErrorsT>(value));
    return *this;
  }
  template <typename EffectivePolicyValidationErrorsT = EffectivePolicyValidationError>
  ListEffectivePolicyValidationErrorsResult& AddEffectivePolicyValidationErrors(EffectivePolicyValidationErrorsT&& value) {
    m_effectivePolicyValidationErrorsHasBeenSet = true;
    m_effectivePolicyValidationErrors.emplace_back(std::forward<EffectivePolicyValidationErrorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListEffectivePolicyValidationErrorsResult& WithRequestId(RequestIdT&& value) {
