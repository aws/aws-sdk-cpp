...
class MoveAccountRequest : public OrganizationsRequest {
 public:
  ...
  ///@{
  /**
   * <p>ID for the account that you want to move.</p> <p>The <a
  ...
  ///@{
  /**
   * <p>ID for the root or organizational unit that you want to move the account
  ...
  void SetSourceParentId(SourceParentIdT&& value) {
    m_sourceParentIdHasBeenSet = true;
    m_sourceParentId = std::forward<SourceParentIdT>(value);
  }
  template <typename SourceParentIdT = Aws::String>
  MoveAccountRequest& WithSourceParentId(SourceParentIdT&& value) {
    SetSourceParentId(std::forward<SourceParentIdT>(value));
    return *this;
  }
  ///@}
  ...
  /**
   * <p>ID for the root or organizational unit that you want to move the account
   * to.</p> <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for a
   * parent ID string requires one of the following:</p> <ul> <li> <p> <b>Root</b> -
   * A string that begins with "r-" followed by from 4 to 32 lowercase letters or
   * digits.</p> </li> <li> <p> <b>Organizational unit (OU)</b> - A string that
   * begins with "ou-" followed by from 4 to 32 lowercase letters or digits (the ID
   * of the root that the OU is in). This string is followed by a second "-" dash and
  ...
  void SetDestinationParentId(DestinationParentIdT&& value) {
    m_destinationParentIdHasBeenSet = true;
    m_destinationParentId = std::forward<DestinationParentIdT>(value);
  }
  template <typename DestinationParentIdT = Aws::String>
  MoveAccountRequest& WithDestinationParentId(DestinationParentIdT&& value) {
    SetDestinationParentId(std::forward<DestinationParentIdT>(value));
    return *this;
  }
  ///@}
 private:
