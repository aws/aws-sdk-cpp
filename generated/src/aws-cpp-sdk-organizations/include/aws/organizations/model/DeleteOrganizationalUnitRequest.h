...
class DeleteOrganizationalUnitRequest : public OrganizationsRequest {
 public:
  ...
  ///@{
  /**
   * <p>ID for the organizational unit that you want to delete. You can get the ID
   * from the <a>ListOrganizationalUnitsForParent</a> operation.</p> <p>The <a
  ...
  template <typename OrganizationalUnitIdT = Aws::String>
  DeleteOrganizationalUnitRequest& WithOrganizationalUnitId(OrganizationalUnitIdT&& value) {
