...
class ListHandshakesForAccountRequest : public OrganizationsRequest {
 public:
  AWS_ORGANIZATIONS_API ListHandshakesForAccountRequest() = default;
  ...
  template <typename FilterT = HandshakeFilter>
  ListHandshakesForAccountRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListHandshakesForAccountRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListHandshakesForAccountRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
