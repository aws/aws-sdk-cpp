...
class ListAccountsWithInvalidEffectivePolicyResult {
 public:
  ...
  AWS_ORGANIZATIONS_API ListAccountsWithInvalidEffectivePolicyResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ORGANIZATIONS_API ListAccountsWithInvalidEffectivePolicyResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AccountsT = Aws::Vector<Account>>
  ListAccountsWithInvalidEffectivePolicyResult& WithAccounts(AccountsT&& value) {
    SetAccounts(std::forward<AccountsT>(value));
    return *this;
  }
  template <typename AccountsT = Account>
  ListAccountsWithInvalidEffectivePolicyResult& AddAccounts(AccountsT&& value) {
    m_accountsHasBeenSet = true;
  ...
  inline ListAccountsWithInvalidEffectivePolicyResult& WithPolicyType(EffectivePolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountsWithInvalidEffectivePolicyResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccountsWithInvalidEffectivePolicyResult& WithRequestId(RequestIdT&& value) {
