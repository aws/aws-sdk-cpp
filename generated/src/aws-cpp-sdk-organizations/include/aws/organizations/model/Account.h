...
class Account {
 public:
  ...
  inline void SetStatus(AccountStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Account& WithStatus(AccountStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline Account& WithState(AccountState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetJoinedMethod(AccountJoinedMethod value) {
    m_joinedMethodHasBeenSet = true;
    m_joinedMethod = value;
  }
  inline Account& WithJoinedMethod(AccountJoinedMethod value) {
    SetJoinedMethod(value);
    return *this;
  }
  ///@}
  ...
  void SetJoinedTimestamp(JoinedTimestampT&& value) {
    ...
    m_joinedTimestamp = std::forward<JoinedTimestampT>(value);
  }
  template <typename JoinedTimestampT = Aws::Utils::DateTime>
  Account& WithJoinedTimestamp(JoinedTimestampT&& value) {
    SetJoinedTimestamp(std::forward<JoinedTimestampT>(value));
    return *this;
  }
  ///@}
 private:
