...
class ListPoliciesForTargetRequest : public OrganizationsRequest {
 public:
   ...
   * a target ID string requires one of the following:</p> <ul> <li> <p> <b>Root</b>
  ...
  template <typename TargetIdT = Aws::String>
  ListPoliciesForTargetRequest& WithTargetId(TargetIdT&& value) {
  ...
  inline ListPoliciesForTargetRequest& WithFilter(PolicyType value) {
    SetFilter(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPoliciesForTargetRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPoliciesForTargetRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
