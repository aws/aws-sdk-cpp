...
class ListPoliciesForTargetResult {
 public:
  ...
  template <typename PoliciesT = Aws::Vector<PolicySummary>>
  ListPoliciesForTargetResult& WithPolicies(PoliciesT&& value) {
    SetPolicies(std::forward<PoliciesT>(value));
    return *this;
  }
  template <typename PoliciesT = PolicySummary>
  ListPoliciesForTargetResult& AddPolicies(PoliciesT&& value) {
    m_policiesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPoliciesForTargetResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPoliciesForTargetResult& WithRequestId(RequestIdT&& value) {
