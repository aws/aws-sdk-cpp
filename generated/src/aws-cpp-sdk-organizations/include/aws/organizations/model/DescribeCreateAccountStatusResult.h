...
class DescribeCreateAccountStatusResult {
 public:
  ...
  AWS_ORGANIZATIONS_API DescribeCreateAccountStatusResult& operator=(
  ...
  template <typename CreateAccountStatusT = CreateAccountStatus>
  DescribeCreateAccountStatusResult& WithCreateAccountStatus(CreateAccountStatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCreateAccountStatusResult& WithRequestId(RequestIdT&& value) {
