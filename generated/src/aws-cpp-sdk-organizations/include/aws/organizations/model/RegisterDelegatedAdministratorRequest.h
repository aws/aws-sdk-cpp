...
class RegisterDelegatedAdministratorRequest : public OrganizationsRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  RegisterDelegatedAdministratorRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename ServicePrincipalT = Aws::String>
  RegisterDelegatedAdministratorRequest& WithServicePrincipal(ServicePrincipalT&& value) {
