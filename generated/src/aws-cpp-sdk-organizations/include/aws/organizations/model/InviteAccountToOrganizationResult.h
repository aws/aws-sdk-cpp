...
class InviteAccountToOrganizationResult {
 public:
  ...
  AWS_ORGANIZATIONS_API InviteAccountToOrganizationResult& operator=(
  ...
  template <typename HandshakeT = Handshake>
  InviteAccountToOrganizationResult& WithHandshake(HandshakeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  InviteAccountToOrganizationResult& WithRequestId(RequestIdT&& value) {
