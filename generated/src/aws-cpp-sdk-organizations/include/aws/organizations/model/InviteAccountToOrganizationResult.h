...
namespace Model
{
  ...
  {
  public:
    AWS_ORGANIZATIONS_API InviteAccountToOrganizationResult() = default;
    ...
    template<typename HandshakeT = Handshake>
    InviteAccountToOrganizationResult& WithHandshake(HandshakeT&& value) { SetHandshake(std::forward<HandshakeT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    InviteAccountToOrganizationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
