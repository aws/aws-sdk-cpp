...
class ListOrganizationalUnitsForParentRequest : public OrganizationsRequest {
 public:
  ...
  template <typename ParentIdT = Aws::String>
  ListOrganizationalUnitsForParentRequest& WithParentId(ParentIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListOrganizationalUnitsForParentRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListOrganizationalUnitsForParentRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
