...
/**
 */
class ListAWSServiceAccessForOrganizationRequest : public OrganizationsRequest {
 public:
  AWS_ORGANIZATIONS_API ListAWSServiceAccessForOrganizationRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListAWSServiceAccessForOrganizationRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAWSServiceAccessForOrganizationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
