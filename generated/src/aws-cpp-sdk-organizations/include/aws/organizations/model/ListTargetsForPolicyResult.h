...
class ListTargetsForPolicyResult {
 public:
  ...
  template <typename TargetsT = Aws::Vector<PolicyTargetSummary>>
  ListTargetsForPolicyResult& WithTargets(TargetsT&& value) {
    SetTargets(std::forward<TargetsT>(value));
    return *this;
  }
  template <typename TargetsT = PolicyTargetSummary>
  ListTargetsForPolicyResult& AddTargets(TargetsT&& value) {
    m_targetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTargetsForPolicyResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTargetsForPolicyResult& WithRequestId(RequestIdT&& value) {
