...
class ListChildrenRequest : public OrganizationsRequest {
 public:
  ...
  inline void SetChildType(ChildType value) {
    m_childTypeHasBeenSet = true;
    m_childType = value;
  }
  inline ListChildrenRequest& WithChildType(ChildType value) {
    SetChildType(value);
    return *this;
  }
  ///@}
  ...
  inline ListChildrenRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
