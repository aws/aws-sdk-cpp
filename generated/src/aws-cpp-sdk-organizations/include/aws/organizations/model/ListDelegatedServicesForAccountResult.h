...
class ListDelegatedServicesForAccountResult {
 public:
  ...
  AWS_ORGANIZATIONS_API ListDelegatedServicesForAccountResult& operator=(
  ...
  void SetDelegatedServices(DelegatedServicesT&& value) {
    m_delegatedServicesHasBeenSet = true;
    m_delegatedServices = std::forward<DelegatedServicesT>(value);
  }
  template <typename DelegatedServicesT = Aws::Vector<DelegatedService>>
  ListDelegatedServicesForAccountResult& WithDelegatedServices(DelegatedServicesT&& value) {
    SetDelegatedServices(std::forward<DelegatedServicesT>(value));
    return *this;
  }
  template <typename DelegatedServicesT = DelegatedService>
  ListDelegatedServicesForAccountResult& AddDelegatedServices(DelegatedServicesT&& value) {
    m_delegatedServicesHasBeenSet = true;
    m_delegatedServices.emplace_back(std::forward<DelegatedServicesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDelegatedServicesForAccountResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDelegatedServicesForAccountResult& WithRequestId(RequestIdT&& value) {
