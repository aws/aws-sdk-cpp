...
namespace Model
{
  ...
  {
  public:
    AWS_ORGANIZATIONS_API AcceptHandshakeResult() = default;
    ...
    template<typename HandshakeT = Handshake>
    AcceptHandshakeResult& WithHandshake(HandshakeT&& value) { SetHandshake(std::forward<HandshakeT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AcceptHandshakeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
