...
class ListParentsResult {
 public:
  ...
  template <typename ParentsT = Aws::Vector<Parent>>
  ListParentsResult& WithParents(ParentsT&& value) {
    SetParents(std::forward<ParentsT>(value));
    return *this;
  }
  template <typename ParentsT = Parent>
  ListParentsResult& AddParents(ParentsT&& value) {
    m_parentsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListParentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListParentsResult& WithRequestId(RequestIdT&& value) {
