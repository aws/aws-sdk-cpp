...
class DescribeOrganizationalUnitRequest : public OrganizationsRequest {
 public:
  ...
  ///@{
  /**
   * <p>ID for the organizational unit that you want details about. You can get the
  ...
  template <typename OrganizationalUnitIdT = Aws::String>
  DescribeOrganizationalUnitRequest& WithOrganizationalUnitId(OrganizationalUnitIdT&& value) {
