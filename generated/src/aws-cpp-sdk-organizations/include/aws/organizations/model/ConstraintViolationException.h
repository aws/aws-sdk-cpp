 ...
 * Guide</i>.</p> </li> <li> <p>ACCOUNT_CREATION_RATE_LIMIT_EXCEEDED: You attempted
 * to exceed the number of accounts that can be in progress at a time.</p> </li>
 * <li> <p>ACCOUNT_CREATION_NOT_COMPLETE: Your account setup isn't complete or your
 ...
 * Transfer invitation.</p> </li> <li> <p>ACTIVE_RESPONSIBILITY_TRANSFER_PROCESS:
 * You cannot delete organization due to an ongoing responsibility transfer
 * process. For example, a pending invitation or an in-progress transfer. To delete
 * the organization, you must resolve the current transfer process.</p> </li> <li>
 ...
 * such as a credit card, with the account. For more information, see <a
 ...
 * as a credit card, with the account. For more information, see <a
 * href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_account-before-remove.html">Considerations
 * before removing an account from an organization</a> in the <i>Organizations User
 * Guide</i>.</p> </li> <li> <p>MIN_POLICY_TYPE_ATTACHMENT_LIMIT_EXCEEDED: You
 * attempted to detach a policy from an entity that would cause the entity to have
 * fewer than the minimum number of policies of a certain type required.</p> </li>
 * <li> <p>ORGANIZATION_NOT_IN_ALL_FEATURES_MODE: You attempted to perform an
 ...
 * perform this operation.</p> </li> <li> <p>OU_DEPTH_LIMIT_EXCEEDED: You attempted
 * to create an OU tree that is too many levels deep.</p> </li> <li>
 ...
 * to enable a policy type before you enabled service access. Call the
 ...
 * organization is marked for deletion.</p> </li> <li>
 ...
 * expired, or cancelled cannot be modified.</p> </li> <li>
 * <p>UNMET_BILLING_PREREQUISITE: Your current billing configuration is
 * unsupported. Contact Amazon Web Services Support for assistance.</p> </li> <li>
 ...
 * does not support.</p> </li> <li> <p>WAIT_PERIOD_ACTIVE: After you create an
 * Amazon Web Services account, you must wait until at least four days after the
 * account was created. Invited accounts aren't subject to this waiting period.</p>
...
class ConstraintViolationException {
 public:
  ...
  inline void SetReason(ConstraintViolationExceptionReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline ConstraintViolationException& WithReason(ConstraintViolationExceptionReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
