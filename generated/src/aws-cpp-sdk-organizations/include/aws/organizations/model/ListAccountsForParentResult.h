...
class ListAccountsForParentResult {
 public:
  ...
  template <typename AccountsT = Aws::Vector<Account>>
  ListAccountsForParentResult& WithAccounts(AccountsT&& value) {
    SetAccounts(std::forward<AccountsT>(value));
    return *this;
  }
  template <typename AccountsT = Account>
  ListAccountsForParentResult& AddAccounts(AccountsT&& value) {
    m_accountsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountsForParentResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccountsForParentResult& WithRequestId(RequestIdT&& value) {
