 ...
 * have agreed to the change.</p> </li> <li> <p>LEGACY_PERMISSIONS_STILL_IN_USE:
 * Your organization must migrate to use the new IAM fine-grained actions for
 * billing, cost management, and accounts.</p> </li> <li>
 ...
 * <li> <p>PAST_DUE_INVOICE: Your organization has an invoice that is past due.</p>
 * </li> <li> <p>PAYMENT_INSTRUMENT_REQUIRED: You can't complete the operation with
 * an account that doesn't have a payment instrument, such as a credit card,
 * associated with it.</p> </li> <li> <p>RESPONSIBILITY_TRANSFER_ALREADY_EXISTS:
 * You cannot perform this operation with the current transfer.</p> </li> <li>
 * <p>SOURCE_AND_TARGET_CANNOT_MATCH: An account can't accept a transfer invitation
 * if it is both the sender and recipient of the invitation.</p> </li> <li>
 ...
 * assistance.</p> </li> <li> <p>UNUSED_PREPAYMENT_BALANCE: Your organization has
 * an outstanding pre-payment balance.</p> </li> </ul><p><h3>See Also:</h3>   <a
...
class HandshakeConstraintViolationException {
 public:
  ...
  inline void SetReason(HandshakeConstraintViolationExceptionReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline HandshakeConstraintViolationException& WithReason(HandshakeConstraintViolationExceptionReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
