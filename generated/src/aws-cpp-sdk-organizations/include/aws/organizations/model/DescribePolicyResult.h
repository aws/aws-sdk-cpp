...
namespace Model
{
  ...
  public:
    ...
    inline DescribePolicyResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribePolicyResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribePolicyResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
