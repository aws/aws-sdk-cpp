...
namespace Model
{
  ...
  /**
   */
  class ListRootsRequest : public OrganizationsRequest
  {
  public:
    ...
    template<typename NextTokenT = Aws::String>
    ListRootsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
