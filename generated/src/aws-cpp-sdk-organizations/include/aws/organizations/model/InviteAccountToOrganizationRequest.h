...
class InviteAccountToOrganizationRequest : public OrganizationsRequest {
 public:
  ...
  template <typename TargetT = HandshakeParty>
  InviteAccountToOrganizationRequest& WithTarget(TargetT&& value) {
  ...
  template <typename NotesT = Aws::String>
  InviteAccountToOrganizationRequest& WithNotes(NotesT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  InviteAccountToOrganizationRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  InviteAccountToOrganizationRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
