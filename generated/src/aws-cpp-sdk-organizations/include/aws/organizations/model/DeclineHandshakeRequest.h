...
namespace Model
{
  ...
  {
  public:
    AWS_ORGANIZATIONS_API DeclineHandshakeRequest() = default;
    ...
    template<typename HandshakeIdT = Aws::String>
    DeclineHandshakeRequest& WithHandshakeId(HandshakeIdT&& value) { SetHandshakeId(std::forward<HandshakeIdT>(value)); return *this;}
    ///@}
  private:
