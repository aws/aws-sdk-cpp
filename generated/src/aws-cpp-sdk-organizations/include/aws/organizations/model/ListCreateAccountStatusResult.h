...
class ListCreateAccountStatusResult {
 public:
  ...
  void SetCreateAccountStatuses(CreateAccountStatusesT&& value) {
    m_createAccountStatusesHasBeenSet = true;
    m_createAccountStatuses = std::forward<CreateAccountStatusesT>(value);
  }
  template <typename CreateAccountStatusesT = Aws::Vector<CreateAccountStatus>>
  ListCreateAccountStatusResult& WithCreateAccountStatuses(CreateAccountStatusesT&& value) {
    SetCreateAccountStatuses(std::forward<CreateAccountStatusesT>(value));
    return *this;
  }
  template <typename CreateAccountStatusesT = CreateAccountStatus>
  ListCreateAccountStatusResult& AddCreateAccountStatuses(CreateAccountStatusesT&& value) {
    m_createAccountStatusesHasBeenSet = true;
    m_createAccountStatuses.emplace_back(std::forward<CreateAccountStatusesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCreateAccountStatusResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCreateAccountStatusResult& WithRequestId(RequestIdT&& value) {
