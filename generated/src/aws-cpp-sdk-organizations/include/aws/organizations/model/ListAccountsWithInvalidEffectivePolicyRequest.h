...
class ListAccountsWithInvalidEffectivePolicyRequest : public OrganizationsRequest {
 public:
  ...
  inline ListAccountsWithInvalidEffectivePolicyRequest& WithPolicyType(EffectivePolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountsWithInvalidEffectivePolicyRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccountsWithInvalidEffectivePolicyRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
