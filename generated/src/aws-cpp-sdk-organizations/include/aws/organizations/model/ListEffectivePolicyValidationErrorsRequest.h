...
namespace Model
{
  ...
  public:
    ...
    template<typename AccountIdT = Aws::String>
    ListEffectivePolicyValidationErrorsRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    inline ListEffectivePolicyValidationErrorsRequest& WithPolicyType(EffectivePolicyType value) { SetPolicyType(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListEffectivePolicyValidationErrorsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline ListEffectivePolicyValidationErrorsRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
  private:
