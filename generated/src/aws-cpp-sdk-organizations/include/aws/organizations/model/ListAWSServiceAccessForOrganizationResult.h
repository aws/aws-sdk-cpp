...
class ListAWSServiceAccessForOrganizationResult {
 public:
  ...
  AWS_ORGANIZATIONS_API ListAWSServiceAccessForOrganizationResult& operator=(
  ...
  void SetEnabledServicePrincipals(EnabledServicePrincipalsT&& value) {
    m_enabledServicePrincipalsHasBeenSet = true;
    m_enabledServicePrincipals = std::forward<EnabledServicePrincipalsT>(value);
  }
  template <typename EnabledServicePrincipalsT = Aws::Vector<EnabledServicePrincipal>>
  ListAWSServiceAccessForOrganizationResult& WithEnabledServicePrincipals(EnabledServicePrincipalsT&& value) {
    SetEnabledServicePrincipals(std::forward<EnabledServicePrincipalsT>(value));
    return *this;
  }
  template <typename EnabledServicePrincipalsT = EnabledServicePrincipal>
  ListAWSServiceAccessForOrganizationResult& AddEnabledServicePrincipals(EnabledServicePrincipalsT&& value) {
    m_enabledServicePrincipalsHasBeenSet = true;
    m_enabledServicePrincipals.emplace_back(std::forward<EnabledServicePrincipalsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAWSServiceAccessForOrganizationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAWSServiceAccessForOrganizationResult& WithRequestId(RequestIdT&& value) {
