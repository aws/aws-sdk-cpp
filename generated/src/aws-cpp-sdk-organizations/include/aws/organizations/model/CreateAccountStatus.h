...
class CreateAccountStatus {
 public:
  ...
  inline void SetState(CreateAccountState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline CreateAccountStatus& WithState(CreateAccountState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailureReason(CreateAccountFailureReason value) {
    m_failureReasonHasBeenSet = true;
    m_failureReason = value;
  }
  inline CreateAccountStatus& WithFailureReason(CreateAccountFailureReason value) {
