...
class CreateOrganizationalUnitRequest : public OrganizationsRequest {
 public:
  ...
  template <typename ParentIdT = Aws::String>
  CreateOrganizationalUnitRequest& WithParentId(ParentIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateOrganizationalUnitRequest& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateOrganizationalUnitRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateOrganizationalUnitRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
