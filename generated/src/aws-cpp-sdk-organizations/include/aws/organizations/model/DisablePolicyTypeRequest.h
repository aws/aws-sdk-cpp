...
class DisablePolicyTypeRequest : public OrganizationsRequest {
 public:
  ...
  ///@{
  /**
   * <p>ID for the root in which you want to disable a policy type. You can get the
   * ID from the <a>ListRoots</a> operation.</p> <p>The <a
  ...
  template <typename RootIdT = Aws::String>
  DisablePolicyTypeRequest& WithRootId(RootIdT&& value) {
  ...
  inline DisablePolicyTypeRequest& WithPolicyType(PolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
