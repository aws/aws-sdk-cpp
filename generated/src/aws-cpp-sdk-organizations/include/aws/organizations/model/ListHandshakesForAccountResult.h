...
class ListHandshakesForAccountResult {
 public:
  ...
  template <typename HandshakesT = Aws::Vector<Handshake>>
  ListHandshakesForAccountResult& WithHandshakes(HandshakesT&& value) {
    SetHandshakes(std::forward<HandshakesT>(value));
    return *this;
  }
  template <typename HandshakesT = Handshake>
  ListHandshakesForAccountResult& AddHandshakes(HandshakesT&& value) {
    m_handshakesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListHandshakesForAccountResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListHandshakesForAccountResult& WithRequestId(RequestIdT&& value) {
