...
class AccessDeniedForDependencyException {
 public:
  ...
  template <typename MessageT = Aws::String>
  AccessDeniedForDependencyException& WithMessage(MessageT&& value) {
  ...
  inline void SetReason(AccessDeniedForDependencyExceptionReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline AccessDeniedForDependencyException& WithReason(AccessDeniedForDependencyExceptionReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
