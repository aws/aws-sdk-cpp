...
namespace Organizations
{
   ...
   * User Guide</a>.</p>
   */
  class AWS_ORGANIZATIONS_API OrganizationsClient : Aws::Client::ClientWithAsyncTemplateMethods<OrganizationsClient>,
    smithy::client::AwsSmithyClientT<Aws::Organizations::SERVICE_NAME,
