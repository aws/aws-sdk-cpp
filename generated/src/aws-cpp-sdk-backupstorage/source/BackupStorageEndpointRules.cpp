...
{
const size_t BackupStorageEndpointRules::RulesBlobStrLen = 3500;
const size_t BackupStorageEndpointRules::RulesBlobSize = 3501;

using RulesBlobT = Aws::Array<const char, BackupStorageEndpointRules::RulesBlobSize>;
...
'u','p','s','t','o','r','a','g','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'p','s','t','o','r','a','g','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','b','a','c','k','u','p','s','t','o','r','a','g',
...
const char* BackupStorageEndpointRules::GetRulesBlob()
{
