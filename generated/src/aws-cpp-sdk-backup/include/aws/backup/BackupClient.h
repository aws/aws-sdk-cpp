...
class AWS_BACKUP_API BackupClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  BackupClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<BackupEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateBackupVaultMpaApprovalTeamOutcome AssociateBackupVaultMpaApprovalTeam(
      const Model::AssociateBackupVaultMpaApprovalTeamRequest& request) const;

  /**
   * A Callable wrapper for AssociateBackupVaultMpaApprovalTeam that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename AssociateBackupVaultMpaApprovalTeamRequestT = Model::AssociateBackupVaultMpaApprovalTeamRequest>
  Model::AssociateBackupVaultMpaApprovalTeamOutcomeCallable AssociateBackupVaultMpaApprovalTeamCallable(
      const AssociateBackupVaultMpaApprovalTeamRequestT& request) const {
    return SubmitCallable(&BackupClient::AssociateBackupVaultMpaApprovalTeam, request);
  }

  /**
   * An Async wrapper for AssociateBackupVaultMpaApprovalTeam that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateBackupVaultMpaApprovalTeamRequestT = Model::AssociateBackupVaultMpaApprovalTeamRequest>
  void AssociateBackupVaultMpaApprovalTeamAsync(const AssociateBackupVaultMpaApprovalTeamRequestT& request,
                                                const AssociateBackupVaultMpaApprovalTeamResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CancelLegalHold that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelLegalHoldRequestT = Model::CancelLegalHoldRequest>
  void CancelLegalHoldAsync(const CancelLegalHoldRequestT& request, const CancelLegalHoldResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBackupPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBackupPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateBackupPlanRequestT = Model::CreateBackupPlanRequest>
  void CreateBackupPlanAsync(const CreateBackupPlanRequestT& request, const CreateBackupPlanResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBackupSelection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBackupSelection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateBackupSelectionRequestT = Model::CreateBackupSelectionRequest>
  void CreateBackupSelectionAsync(const CreateBackupSelectionRequestT& request, const CreateBackupSelectionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBackupVault that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBackupVault that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateBackupVaultRequestT = Model::CreateBackupVaultRequest>
  void CreateBackupVaultAsync(const CreateBackupVaultRequestT& request, const CreateBackupVaultResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateFramework that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFrameworkRequestT = Model::CreateFrameworkRequest>
  void CreateFrameworkAsync(const CreateFrameworkRequestT& request, const CreateFrameworkResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateLegalHold that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateLegalHoldRequestT = Model::CreateLegalHoldRequest>
  void CreateLegalHoldAsync(const CreateLegalHoldRequestT& request, const CreateLegalHoldResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateLogicallyAirGappedBackupVaultOutcome CreateLogicallyAirGappedBackupVault(
      const Model::CreateLogicallyAirGappedBackupVaultRequest& request) const;

  /**
   * A Callable wrapper for CreateLogicallyAirGappedBackupVault that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateLogicallyAirGappedBackupVaultRequestT = Model::CreateLogicallyAirGappedBackupVaultRequest>
  Model::CreateLogicallyAirGappedBackupVaultOutcomeCallable CreateLogicallyAirGappedBackupVaultCallable(
      const CreateLogicallyAirGappedBackupVaultRequestT& request) const {
    return SubmitCallable(&BackupClient::CreateLogicallyAirGappedBackupVault, request);
  }

  /**
   * An Async wrapper for CreateLogicallyAirGappedBackupVault that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateLogicallyAirGappedBackupVaultRequestT = Model::CreateLogicallyAirGappedBackupVaultRequest>
  void CreateLogicallyAirGappedBackupVaultAsync(const CreateLogicallyAirGappedBackupVaultRequestT& request,
                                                const CreateLogicallyAirGappedBackupVaultResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateReportPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateReportPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateReportPlanRequestT = Model::CreateReportPlanRequest>
  void CreateReportPlanAsync(const CreateReportPlanRequestT& request, const CreateReportPlanResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateRestoreAccessBackupVaultOutcome CreateRestoreAccessBackupVault(
      const Model::CreateRestoreAccessBackupVaultRequest& request) const;

  /**
   * A Callable wrapper for CreateRestoreAccessBackupVault that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateRestoreAccessBackupVaultRequestT = Model::CreateRestoreAccessBackupVaultRequest>
  Model::CreateRestoreAccessBackupVaultOutcomeCallable CreateRestoreAccessBackupVaultCallable(
      const CreateRestoreAccessBackupVaultRequestT& request) const {
    return SubmitCallable(&BackupClient::CreateRestoreAccessBackupVault, request);
  }

  /**
   * An Async wrapper for CreateRestoreAccessBackupVault that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateRestoreAccessBackupVaultRequestT = Model::CreateRestoreAccessBackupVaultRequest>
  void CreateRestoreAccessBackupVaultAsync(const CreateRestoreAccessBackupVaultRequestT& request,
                                           const CreateRestoreAccessBackupVaultResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateRestoreTestingPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateRestoreTestingPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRestoreTestingPlanRequestT = Model::CreateRestoreTestingPlanRequest>
  void CreateRestoreTestingPlanAsync(const CreateRestoreTestingPlanRequestT& request,
                                     const CreateRestoreTestingPlanResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateRestoreTestingSelectionOutcome CreateRestoreTestingSelection(
      const Model::CreateRestoreTestingSelectionRequest& request) const;

  /**
   * A Callable wrapper for CreateRestoreTestingSelection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateRestoreTestingSelectionRequestT = Model::CreateRestoreTestingSelectionRequest>
  Model::CreateRestoreTestingSelectionOutcomeCallable CreateRestoreTestingSelectionCallable(
      const CreateRestoreTestingSelectionRequestT& request) const {
    return SubmitCallable(&BackupClient::CreateRestoreTestingSelection, request);
  }

  /**
   * An Async wrapper for CreateRestoreTestingSelection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRestoreTestingSelectionRequestT = Model::CreateRestoreTestingSelectionRequest>
  void CreateRestoreTestingSelectionAsync(const CreateRestoreTestingSelectionRequestT& request,
                                          const CreateRestoreTestingSelectionResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBackupPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBackupPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBackupPlanRequestT = Model::DeleteBackupPlanRequest>
  void DeleteBackupPlanAsync(const DeleteBackupPlanRequestT& request, const DeleteBackupPlanResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBackupSelection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBackupSelection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBackupSelectionRequestT = Model::DeleteBackupSelectionRequest>
  void DeleteBackupSelectionAsync(const DeleteBackupSelectionRequestT& request, const DeleteBackupSelectionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBackupVault that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBackupVault that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBackupVaultRequestT = Model::DeleteBackupVaultRequest>
  void DeleteBackupVaultAsync(const DeleteBackupVaultRequestT& request, const DeleteBackupVaultResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBackupVaultAccessPolicyOutcome DeleteBackupVaultAccessPolicy(
      const Model::DeleteBackupVaultAccessPolicyRequest& request) const;

  /**
   * A Callable wrapper for DeleteBackupVaultAccessPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteBackupVaultAccessPolicyRequestT = Model::DeleteBackupVaultAccessPolicyRequest>
  Model::DeleteBackupVaultAccessPolicyOutcomeCallable DeleteBackupVaultAccessPolicyCallable(
      const DeleteBackupVaultAccessPolicyRequestT& request) const {
    return SubmitCallable(&BackupClient::DeleteBackupVaultAccessPolicy, request);
  }

  /**
   * An Async wrapper for DeleteBackupVaultAccessPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBackupVaultAccessPolicyRequestT = Model::DeleteBackupVaultAccessPolicyRequest>
  void DeleteBackupVaultAccessPolicyAsync(const DeleteBackupVaultAccessPolicyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBackupVaultLockConfigurationOutcome DeleteBackupVaultLockConfiguration(
      const Model::DeleteBackupVaultLockConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteBackupVaultLockConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteBackupVaultLockConfigurationRequestT = Model::DeleteBackupVaultLockConfigurationRequest>
  Model::DeleteBackupVaultLockConfigurationOutcomeCallable DeleteBackupVaultLockConfigurationCallable(
      const DeleteBackupVaultLockConfigurationRequestT& request) const {
    return SubmitCallable(&BackupClient::DeleteBackupVaultLockConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteBackupVaultLockConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteBackupVaultLockConfigurationRequestT = Model::DeleteBackupVaultLockConfigurationRequest>
  void DeleteBackupVaultLockConfigurationAsync(const DeleteBackupVaultLockConfigurationRequestT& request,
                                               const DeleteBackupVaultLockConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteBackupVaultNotificationsOutcome DeleteBackupVaultNotifications(
      const Model::DeleteBackupVaultNotificationsRequest& request) const;

  /**
   * A Callable wrapper for DeleteBackupVaultNotifications that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteBackupVaultNotificationsRequestT = Model::DeleteBackupVaultNotificationsRequest>
  Model::DeleteBackupVaultNotificationsOutcomeCallable DeleteBackupVaultNotificationsCallable(
      const DeleteBackupVaultNotificationsRequestT& request) const {
    return SubmitCallable(&BackupClient::DeleteBackupVaultNotifications, request);
  }

  /**
   * An Async wrapper for DeleteBackupVaultNotifications that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteBackupVaultNotificationsRequestT = Model::DeleteBackupVaultNotificationsRequest>
  void DeleteBackupVaultNotificationsAsync(const DeleteBackupVaultNotificationsRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteFramework that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFrameworkRequestT = Model::DeleteFrameworkRequest>
  void DeleteFrameworkAsync(const DeleteFrameworkRequestT& request, const DeleteFrameworkResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteRecoveryPoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRecoveryPoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteRecoveryPointRequestT = Model::DeleteRecoveryPointRequest>
  void DeleteRecoveryPointAsync(const DeleteRecoveryPointRequestT& request, const DeleteRecoveryPointResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReportPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReportPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteReportPlanRequestT = Model::DeleteReportPlanRequest>
  void DeleteReportPlanAsync(const DeleteReportPlanRequestT& request, const DeleteReportPlanResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteRestoreTestingPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRestoreTestingPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRestoreTestingPlanRequestT = Model::DeleteRestoreTestingPlanRequest>
  void DeleteRestoreTestingPlanAsync(const DeleteRestoreTestingPlanRequestT& request,
                                     const DeleteRestoreTestingPlanResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRestoreTestingSelectionOutcome DeleteRestoreTestingSelection(
      const Model::DeleteRestoreTestingSelectionRequest& request) const;

  /**
   * A Callable wrapper for DeleteRestoreTestingSelection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRestoreTestingSelectionRequestT = Model::DeleteRestoreTestingSelectionRequest>
  Model::DeleteRestoreTestingSelectionOutcomeCallable DeleteRestoreTestingSelectionCallable(
      const DeleteRestoreTestingSelectionRequestT& request) const {
    return SubmitCallable(&BackupClient::DeleteRestoreTestingSelection, request);
  }

  /**
   * An Async wrapper for DeleteRestoreTestingSelection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRestoreTestingSelectionRequestT = Model::DeleteRestoreTestingSelectionRequest>
  void DeleteRestoreTestingSelectionAsync(const DeleteRestoreTestingSelectionRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeBackupJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeBackupJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeBackupJobRequestT = Model::DescribeBackupJobRequest>
  void DescribeBackupJobAsync(const DescribeBackupJobRequestT& request, const DescribeBackupJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeBackupVault that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeBackupVault that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeBackupVaultRequestT = Model::DescribeBackupVaultRequest>
  void DescribeBackupVaultAsync(const DescribeBackupVaultRequestT& request, const DescribeBackupVaultResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeCopyJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeCopyJobRequestT = Model::DescribeCopyJobRequest>
  void DescribeCopyJobAsync(const DescribeCopyJobRequestT& request, const DescribeCopyJobResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeFramework that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFramework that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeFrameworkRequestT = Model::DescribeFrameworkRequest>
  void DescribeFrameworkAsync(const DescribeFrameworkRequestT& request, const DescribeFrameworkResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeGlobalSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeGlobalSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeGlobalSettingsRequestT = Model::DescribeGlobalSettingsRequest>
  void DescribeGlobalSettingsAsync(const DescribeGlobalSettingsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribeGlobalSettingsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeProtectedResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeProtectedResourceRequestT = Model::DescribeProtectedResourceRequest>
  Model::DescribeProtectedResourceOutcomeCallable DescribeProtectedResourceCallable(
      const DescribeProtectedResourceRequestT& request) const {
    return SubmitCallable(&BackupClient::DescribeProtectedResource, request);
  }

  /**
   * An Async wrapper for DescribeProtectedResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProtectedResourceRequestT = Model::DescribeProtectedResourceRequest>
  void DescribeProtectedResourceAsync(const DescribeProtectedResourceRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeRecoveryPoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRecoveryPoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRecoveryPointRequestT = Model::DescribeRecoveryPointRequest>
  void DescribeRecoveryPointAsync(const DescribeRecoveryPointRequestT& request, const DescribeRecoveryPointResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeRegionSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRegionSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRegionSettingsRequestT = Model::DescribeRegionSettingsRequest>
  void DescribeRegionSettingsAsync(const DescribeRegionSettingsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribeRegionSettingsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeReportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeReportJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeReportJobRequestT = Model::DescribeReportJobRequest>
  void DescribeReportJobAsync(const DescribeReportJobRequestT& request, const DescribeReportJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeReportPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeReportPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeReportPlanRequestT = Model::DescribeReportPlanRequest>
  void DescribeReportPlanAsync(const DescribeReportPlanRequestT& request, const DescribeReportPlanResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeRestoreJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRestoreJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeRestoreJobRequestT = Model::DescribeRestoreJobRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateBackupVaultMpaApprovalTeamOutcome DisassociateBackupVaultMpaApprovalTeam(
      const Model::DisassociateBackupVaultMpaApprovalTeamRequest& request) const;

  /**
   * A Callable wrapper for DisassociateBackupVaultMpaApprovalTeam that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateBackupVaultMpaApprovalTeamRequestT = Model::DisassociateBackupVaultMpaApprovalTeamRequest>
  Model::DisassociateBackupVaultMpaApprovalTeamOutcomeCallable DisassociateBackupVaultMpaApprovalTeamCallable(
      const DisassociateBackupVaultMpaApprovalTeamRequestT& request) const {
    return SubmitCallable(&BackupClient::DisassociateBackupVaultMpaApprovalTeam, request);
  }

  /**
   * An Async wrapper for DisassociateBackupVaultMpaApprovalTeam that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateBackupVaultMpaApprovalTeamRequestT = Model::DisassociateBackupVaultMpaApprovalTeamRequest>
  void DisassociateBackupVaultMpaApprovalTeamAsync(const DisassociateBackupVaultMpaApprovalTeamRequestT& request,
                                                   const DisassociateBackupVaultMpaApprovalTeamResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateRecoveryPoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DisassociateRecoveryPointRequestT = Model::DisassociateRecoveryPointRequest>
  Model::DisassociateRecoveryPointOutcomeCallable DisassociateRecoveryPointCallable(
      const DisassociateRecoveryPointRequestT& request) const {
    return SubmitCallable(&BackupClient::DisassociateRecoveryPoint, request);
  }

  /**
   * An Async wrapper for DisassociateRecoveryPoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateRecoveryPointRequestT = Model::DisassociateRecoveryPointRequest>
  void DisassociateRecoveryPointAsync(const DisassociateRecoveryPointRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateRecoveryPointFromParentOutcome DisassociateRecoveryPointFromParent(
      const Model::DisassociateRecoveryPointFromParentRequest& request) const;

  /**
   * A Callable wrapper for DisassociateRecoveryPointFromParent that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateRecoveryPointFromParentRequestT = Model::DisassociateRecoveryPointFromParentRequest>
  Model::DisassociateRecoveryPointFromParentOutcomeCallable DisassociateRecoveryPointFromParentCallable(
      const DisassociateRecoveryPointFromParentRequestT& request) const {
    return SubmitCallable(&BackupClient::DisassociateRecoveryPointFromParent, request);
  }

  /**
   * An Async wrapper for DisassociateRecoveryPointFromParent that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateRecoveryPointFromParentRequestT = Model::DisassociateRecoveryPointFromParentRequest>
  void DisassociateRecoveryPointFromParentAsync(const DisassociateRecoveryPointFromParentRequestT& request,
                                                const DisassociateRecoveryPointFromParentResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExportBackupPlanTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExportBackupPlanTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExportBackupPlanTemplateRequestT = Model::ExportBackupPlanTemplateRequest>
  void ExportBackupPlanTemplateAsync(const ExportBackupPlanTemplateRequestT& request,
  ...
  /**
   * An Async wrapper for GetBackupPlan that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBackupPlanRequestT = Model::GetBackupPlanRequest>
  void GetBackupPlanAsync(const GetBackupPlanRequestT& request, const GetBackupPlanResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBackupPlanFromJSON that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBackupPlanFromJSON that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBackupPlanFromJSONRequestT = Model::GetBackupPlanFromJSONRequest>
  void GetBackupPlanFromJSONAsync(const GetBackupPlanFromJSONRequestT& request, const GetBackupPlanFromJSONResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBackupPlanFromTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetBackupPlanFromTemplateRequestT = Model::GetBackupPlanFromTemplateRequest>
  Model::GetBackupPlanFromTemplateOutcomeCallable GetBackupPlanFromTemplateCallable(
      const GetBackupPlanFromTemplateRequestT& request) const {
    return SubmitCallable(&BackupClient::GetBackupPlanFromTemplate, request);
  }

  /**
   * An Async wrapper for GetBackupPlanFromTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBackupPlanFromTemplateRequestT = Model::GetBackupPlanFromTemplateRequest>
  void GetBackupPlanFromTemplateAsync(const GetBackupPlanFromTemplateRequestT& request,
  ...
  /**
   * A Callable wrapper for GetBackupSelection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBackupSelection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBackupSelectionRequestT = Model::GetBackupSelectionRequest>
  void GetBackupSelectionAsync(const GetBackupSelectionRequestT& request, const GetBackupSelectionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBackupVaultAccessPolicyOutcome GetBackupVaultAccessPolicy(
      const Model::GetBackupVaultAccessPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetBackupVaultAccessPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetBackupVaultAccessPolicyRequestT = Model::GetBackupVaultAccessPolicyRequest>
  Model::GetBackupVaultAccessPolicyOutcomeCallable GetBackupVaultAccessPolicyCallable(
      const GetBackupVaultAccessPolicyRequestT& request) const {
    return SubmitCallable(&BackupClient::GetBackupVaultAccessPolicy, request);
  }

  /**
   * An Async wrapper for GetBackupVaultAccessPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBackupVaultAccessPolicyRequestT = Model::GetBackupVaultAccessPolicyRequest>
  void GetBackupVaultAccessPolicyAsync(const GetBackupVaultAccessPolicyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBackupVaultNotificationsOutcome GetBackupVaultNotifications(
      const Model::GetBackupVaultNotificationsRequest& request) const;

  /**
   * A Callable wrapper for GetBackupVaultNotifications that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetBackupVaultNotificationsRequestT = Model::GetBackupVaultNotificationsRequest>
  Model::GetBackupVaultNotificationsOutcomeCallable GetBackupVaultNotificationsCallable(
      const GetBackupVaultNotificationsRequestT& request) const {
    return SubmitCallable(&BackupClient::GetBackupVaultNotifications, request);
  }

  /**
   * An Async wrapper for GetBackupVaultNotifications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBackupVaultNotificationsRequestT = Model::GetBackupVaultNotificationsRequest>
  void GetBackupVaultNotificationsAsync(const GetBackupVaultNotificationsRequestT& request,
  ...
  /**
   * An Async wrapper for GetLegalHold that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLegalHoldRequestT = Model::GetLegalHoldRequest>
  void GetLegalHoldAsync(const GetLegalHoldRequestT& request, const GetLegalHoldResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRecoveryPointIndexDetailsOutcome GetRecoveryPointIndexDetails(
      const Model::GetRecoveryPointIndexDetailsRequest& request) const;

  /**
   * A Callable wrapper for GetRecoveryPointIndexDetails that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRecoveryPointIndexDetailsRequestT = Model::GetRecoveryPointIndexDetailsRequest>
  Model::GetRecoveryPointIndexDetailsOutcomeCallable GetRecoveryPointIndexDetailsCallable(
      const GetRecoveryPointIndexDetailsRequestT& request) const {
    return SubmitCallable(&BackupClient::GetRecoveryPointIndexDetails, request);
  }

  /**
   * An Async wrapper for GetRecoveryPointIndexDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRecoveryPointIndexDetailsRequestT = Model::GetRecoveryPointIndexDetailsRequest>
  void GetRecoveryPointIndexDetailsAsync(const GetRecoveryPointIndexDetailsRequestT& request,
                                         const GetRecoveryPointIndexDetailsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRecoveryPointRestoreMetadataOutcome GetRecoveryPointRestoreMetadata(
      const Model::GetRecoveryPointRestoreMetadataRequest& request) const;

  /**
   * A Callable wrapper for GetRecoveryPointRestoreMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRecoveryPointRestoreMetadataRequestT = Model::GetRecoveryPointRestoreMetadataRequest>
  Model::GetRecoveryPointRestoreMetadataOutcomeCallable GetRecoveryPointRestoreMetadataCallable(
      const GetRecoveryPointRestoreMetadataRequestT& request) const {
    return SubmitCallable(&BackupClient::GetRecoveryPointRestoreMetadata, request);
  }

  /**
   * An Async wrapper for GetRecoveryPointRestoreMetadata that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRecoveryPointRestoreMetadataRequestT = Model::GetRecoveryPointRestoreMetadataRequest>
  void GetRecoveryPointRestoreMetadataAsync(const GetRecoveryPointRestoreMetadataRequestT& request,
  ...
  /**
   * A Callable wrapper for GetRestoreJobMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRestoreJobMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRestoreJobMetadataRequestT = Model::GetRestoreJobMetadataRequest>
  void GetRestoreJobMetadataAsync(const GetRestoreJobMetadataRequestT& request, const GetRestoreJobMetadataResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRestoreTestingInferredMetadataOutcome GetRestoreTestingInferredMetadata(
      const Model::GetRestoreTestingInferredMetadataRequest& request) const;

  /**
   * A Callable wrapper for GetRestoreTestingInferredMetadata that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetRestoreTestingInferredMetadataRequestT = Model::GetRestoreTestingInferredMetadataRequest>
  Model::GetRestoreTestingInferredMetadataOutcomeCallable GetRestoreTestingInferredMetadataCallable(
      const GetRestoreTestingInferredMetadataRequestT& request) const {
    return SubmitCallable(&BackupClient::GetRestoreTestingInferredMetadata, request);
  }

  /**
   * An Async wrapper for GetRestoreTestingInferredMetadata that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRestoreTestingInferredMetadataRequestT = Model::GetRestoreTestingInferredMetadataRequest>
  void GetRestoreTestingInferredMetadataAsync(const GetRestoreTestingInferredMetadataRequestT& request,
                                              const GetRestoreTestingInferredMetadataResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRestoreTestingPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRestoreTestingPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRestoreTestingPlanRequestT = Model::GetRestoreTestingPlanRequest>
  void GetRestoreTestingPlanAsync(const GetRestoreTestingPlanRequestT& request, const GetRestoreTestingPlanResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRestoreTestingSelectionOutcome GetRestoreTestingSelection(
      const Model::GetRestoreTestingSelectionRequest& request) const;

  /**
   * A Callable wrapper for GetRestoreTestingSelection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRestoreTestingSelectionRequestT = Model::GetRestoreTestingSelectionRequest>
  Model::GetRestoreTestingSelectionOutcomeCallable GetRestoreTestingSelectionCallable(
      const GetRestoreTestingSelectionRequestT& request) const {
    return SubmitCallable(&BackupClient::GetRestoreTestingSelection, request);
  }

  /**
   * An Async wrapper for GetRestoreTestingSelection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRestoreTestingSelectionRequestT = Model::GetRestoreTestingSelectionRequest>
  void GetRestoreTestingSelectionAsync(const GetRestoreTestingSelectionRequestT& request,
                                       const GetRestoreTestingSelectionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSupportedResourceTypesOutcome GetSupportedResourceTypes(
      const Model::GetSupportedResourceTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for GetSupportedResourceTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetSupportedResourceTypesRequestT = Model::GetSupportedResourceTypesRequest>
  Model::GetSupportedResourceTypesOutcomeCallable GetSupportedResourceTypesCallable(
  ...
  /**
   * An Async wrapper for GetSupportedResourceTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSupportedResourceTypesRequestT = Model::GetSupportedResourceTypesRequest>
  void GetSupportedResourceTypesAsync(const GetSupportedResourceTypesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const GetSupportedResourceTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListBackupJobSummaries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBackupJobSummaries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBackupJobSummariesRequestT = Model::ListBackupJobSummariesRequest>
  void ListBackupJobSummariesAsync(const ListBackupJobSummariesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListBackupJobSummariesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListBackupJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBackupJobsRequestT = Model::ListBackupJobsRequest>
  void ListBackupJobsAsync(const ListBackupJobsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListBackupJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListBackupPlanTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBackupPlanTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBackupPlanTemplatesRequestT = Model::ListBackupPlanTemplatesRequest>
  void ListBackupPlanTemplatesAsync(const ListBackupPlanTemplatesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListBackupPlanTemplatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListBackupPlanVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBackupPlanVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBackupPlanVersionsRequestT = Model::ListBackupPlanVersionsRequest>
  void ListBackupPlanVersionsAsync(const ListBackupPlanVersionsRequestT& request,
  ...
  /**
   * An Async wrapper for ListBackupPlans that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBackupPlansRequestT = Model::ListBackupPlansRequest>
  void ListBackupPlansAsync(const ListBackupPlansResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListBackupPlansRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListBackupSelections that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBackupSelections that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBackupSelectionsRequestT = Model::ListBackupSelectionsRequest>
  void ListBackupSelectionsAsync(const ListBackupSelectionsRequestT& request, const ListBackupSelectionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBackupVaults that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBackupVaults that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListBackupVaultsRequestT = Model::ListBackupVaultsRequest>
  void ListBackupVaultsAsync(const ListBackupVaultsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListBackupVaultsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCopyJobSummaries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCopyJobSummaries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCopyJobSummariesRequestT = Model::ListCopyJobSummariesRequest>
  void ListCopyJobSummariesAsync(const ListCopyJobSummariesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListCopyJobSummariesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListCopyJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCopyJobsRequestT = Model::ListCopyJobsRequest>
  void ListCopyJobsAsync(const ListCopyJobsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListCopyJobsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListFrameworks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFrameworksRequestT = Model::ListFrameworksRequest>
  void ListFrameworksAsync(const ListFrameworksResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListFrameworksRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListIndexedRecoveryPointsOutcome ListIndexedRecoveryPoints(
      const Model::ListIndexedRecoveryPointsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListIndexedRecoveryPoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListIndexedRecoveryPointsRequestT = Model::ListIndexedRecoveryPointsRequest>
  Model::ListIndexedRecoveryPointsOutcomeCallable ListIndexedRecoveryPointsCallable(
      const ListIndexedRecoveryPointsRequestT& request = {}) const {
    return SubmitCallable(&BackupClient::ListIndexedRecoveryPoints, request);
  }

  /**
   * An Async wrapper for ListIndexedRecoveryPoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIndexedRecoveryPointsRequestT = Model::ListIndexedRecoveryPointsRequest>
  void ListIndexedRecoveryPointsAsync(const ListIndexedRecoveryPointsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListIndexedRecoveryPointsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListLegalHolds that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLegalHoldsRequestT = Model::ListLegalHoldsRequest>
  void ListLegalHoldsAsync(const ListLegalHoldsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListLegalHoldsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProtectedResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProtectedResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProtectedResourcesRequestT = Model::ListProtectedResourcesRequest>
  void ListProtectedResourcesAsync(const ListProtectedResourcesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListProtectedResourcesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListProtectedResourcesByBackupVaultOutcome ListProtectedResourcesByBackupVault(
      const Model::ListProtectedResourcesByBackupVaultRequest& request) const;

  /**
   * A Callable wrapper for ListProtectedResourcesByBackupVault that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListProtectedResourcesByBackupVaultRequestT = Model::ListProtectedResourcesByBackupVaultRequest>
  Model::ListProtectedResourcesByBackupVaultOutcomeCallable ListProtectedResourcesByBackupVaultCallable(
      const ListProtectedResourcesByBackupVaultRequestT& request) const {
    return SubmitCallable(&BackupClient::ListProtectedResourcesByBackupVault, request);
  }

  /**
   * An Async wrapper for ListProtectedResourcesByBackupVault that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListProtectedResourcesByBackupVaultRequestT = Model::ListProtectedResourcesByBackupVaultRequest>
  void ListProtectedResourcesByBackupVaultAsync(const ListProtectedResourcesByBackupVaultRequestT& request,
                                                const ListProtectedResourcesByBackupVaultResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRecoveryPointsByBackupVaultOutcome ListRecoveryPointsByBackupVault(
      const Model::ListRecoveryPointsByBackupVaultRequest& request) const;

  /**
   * A Callable wrapper for ListRecoveryPointsByBackupVault that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRecoveryPointsByBackupVaultRequestT = Model::ListRecoveryPointsByBackupVaultRequest>
  Model::ListRecoveryPointsByBackupVaultOutcomeCallable ListRecoveryPointsByBackupVaultCallable(
      const ListRecoveryPointsByBackupVaultRequestT& request) const {
    return SubmitCallable(&BackupClient::ListRecoveryPointsByBackupVault, request);
  }

  /**
   * An Async wrapper for ListRecoveryPointsByBackupVault that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListRecoveryPointsByBackupVaultRequestT = Model::ListRecoveryPointsByBackupVaultRequest>
  void ListRecoveryPointsByBackupVaultAsync(const ListRecoveryPointsByBackupVaultRequestT& request,
  ...
  virtual Model::ListRecoveryPointsByLegalHoldOutcome ListRecoveryPointsByLegalHold(
      const Model::ListRecoveryPointsByLegalHoldRequest& request) const;

  /**
   * A Callable wrapper for ListRecoveryPointsByLegalHold that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRecoveryPointsByLegalHoldRequestT = Model::ListRecoveryPointsByLegalHoldRequest>
  Model::ListRecoveryPointsByLegalHoldOutcomeCallable ListRecoveryPointsByLegalHoldCallable(
      const ListRecoveryPointsByLegalHoldRequestT& request) const {
    return SubmitCallable(&BackupClient::ListRecoveryPointsByLegalHold, request);
  }

  /**
   * An Async wrapper for ListRecoveryPointsByLegalHold that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRecoveryPointsByLegalHoldRequestT = Model::ListRecoveryPointsByLegalHoldRequest>
  void ListRecoveryPointsByLegalHoldAsync(const ListRecoveryPointsByLegalHoldRequestT& request,
                                          const ListRecoveryPointsByLegalHoldResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListRecoveryPointsByResourceOutcome ListRecoveryPointsByResource(
      const Model::ListRecoveryPointsByResourceRequest& request) const;

  /**
   * A Callable wrapper for ListRecoveryPointsByResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRecoveryPointsByResourceRequestT = Model::ListRecoveryPointsByResourceRequest>
  Model::ListRecoveryPointsByResourceOutcomeCallable ListRecoveryPointsByResourceCallable(
      const ListRecoveryPointsByResourceRequestT& request) const {
    return SubmitCallable(&BackupClient::ListRecoveryPointsByResource, request);
  }

  /**
   * An Async wrapper for ListRecoveryPointsByResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRecoveryPointsByResourceRequestT = Model::ListRecoveryPointsByResourceRequest>
  void ListRecoveryPointsByResourceAsync(const ListRecoveryPointsByResourceRequestT& request,
  ...
  /**
   * An Async wrapper for ListReportJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListReportJobsRequestT = Model::ListReportJobsRequest>
  void ListReportJobsAsync(const ListReportJobsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListReportJobsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListReportPlans that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListReportPlansRequestT = Model::ListReportPlansRequest>
  void ListReportPlansAsync(const ListReportPlansResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListReportPlansRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRestoreAccessBackupVaultsOutcome ListRestoreAccessBackupVaults(
      const Model::ListRestoreAccessBackupVaultsRequest& request) const;

  /**
   * A Callable wrapper for ListRestoreAccessBackupVaults that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRestoreAccessBackupVaultsRequestT = Model::ListRestoreAccessBackupVaultsRequest>
  Model::ListRestoreAccessBackupVaultsOutcomeCallable ListRestoreAccessBackupVaultsCallable(
      const ListRestoreAccessBackupVaultsRequestT& request) const {
    return SubmitCallable(&BackupClient::ListRestoreAccessBackupVaults, request);
  }

  /**
   * An Async wrapper for ListRestoreAccessBackupVaults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRestoreAccessBackupVaultsRequestT = Model::ListRestoreAccessBackupVaultsRequest>
  void ListRestoreAccessBackupVaultsAsync(const ListRestoreAccessBackupVaultsRequestT& request,
                                          const ListRestoreAccessBackupVaultsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRestoreJobSummaries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRestoreJobSummaries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRestoreJobSummariesRequestT = Model::ListRestoreJobSummariesRequest>
  void ListRestoreJobSummariesAsync(const ListRestoreJobSummariesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListRestoreJobSummariesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListRestoreJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRestoreJobsRequestT = Model::ListRestoreJobsRequest>
  void ListRestoreJobsAsync(const ListRestoreJobsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListRestoreJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRestoreJobsByProtectedResourceOutcome ListRestoreJobsByProtectedResource(
      const Model::ListRestoreJobsByProtectedResourceRequest& request) const;

  /**
   * A Callable wrapper for ListRestoreJobsByProtectedResource that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListRestoreJobsByProtectedResourceRequestT = Model::ListRestoreJobsByProtectedResourceRequest>
  Model::ListRestoreJobsByProtectedResourceOutcomeCallable ListRestoreJobsByProtectedResourceCallable(
      const ListRestoreJobsByProtectedResourceRequestT& request) const {
    return SubmitCallable(&BackupClient::ListRestoreJobsByProtectedResource, request);
  }

  /**
   * An Async wrapper for ListRestoreJobsByProtectedResource that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListRestoreJobsByProtectedResourceRequestT = Model::ListRestoreJobsByProtectedResourceRequest>
  void ListRestoreJobsByProtectedResourceAsync(const ListRestoreJobsByProtectedResourceRequestT& request,
                                               const ListRestoreJobsByProtectedResourceResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRestoreTestingPlans that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRestoreTestingPlans that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRestoreTestingPlansRequestT = Model::ListRestoreTestingPlansRequest>
  void ListRestoreTestingPlansAsync(const ListRestoreTestingPlansResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListRestoreTestingPlansRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRestoreTestingSelectionsOutcome ListRestoreTestingSelections(
      const Model::ListRestoreTestingSelectionsRequest& request) const;

  /**
   * A Callable wrapper for ListRestoreTestingSelections that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRestoreTestingSelectionsRequestT = Model::ListRestoreTestingSelectionsRequest>
  Model::ListRestoreTestingSelectionsOutcomeCallable ListRestoreTestingSelectionsCallable(
      const ListRestoreTestingSelectionsRequestT& request) const {
    return SubmitCallable(&BackupClient::ListRestoreTestingSelections, request);
  }

  /**
   * An Async wrapper for ListRestoreTestingSelections that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRestoreTestingSelectionsRequestT = Model::ListRestoreTestingSelectionsRequest>
  void ListRestoreTestingSelectionsAsync(const ListRestoreTestingSelectionsRequestT& request,
                                         const ListRestoreTestingSelectionsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBackupVaultAccessPolicyOutcome PutBackupVaultAccessPolicy(
      const Model::PutBackupVaultAccessPolicyRequest& request) const;

  /**
   * A Callable wrapper for PutBackupVaultAccessPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutBackupVaultAccessPolicyRequestT = Model::PutBackupVaultAccessPolicyRequest>
  Model::PutBackupVaultAccessPolicyOutcomeCallable PutBackupVaultAccessPolicyCallable(
      const PutBackupVaultAccessPolicyRequestT& request) const {
    return SubmitCallable(&BackupClient::PutBackupVaultAccessPolicy, request);
  }

  /**
   * An Async wrapper for PutBackupVaultAccessPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutBackupVaultAccessPolicyRequestT = Model::PutBackupVaultAccessPolicyRequest>
  void PutBackupVaultAccessPolicyAsync(const PutBackupVaultAccessPolicyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBackupVaultLockConfigurationOutcome PutBackupVaultLockConfiguration(
      const Model::PutBackupVaultLockConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutBackupVaultLockConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutBackupVaultLockConfigurationRequestT = Model::PutBackupVaultLockConfigurationRequest>
  Model::PutBackupVaultLockConfigurationOutcomeCallable PutBackupVaultLockConfigurationCallable(
      const PutBackupVaultLockConfigurationRequestT& request) const {
    return SubmitCallable(&BackupClient::PutBackupVaultLockConfiguration, request);
  }

  /**
   * An Async wrapper for PutBackupVaultLockConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutBackupVaultLockConfigurationRequestT = Model::PutBackupVaultLockConfigurationRequest>
  void PutBackupVaultLockConfigurationAsync(const PutBackupVaultLockConfigurationRequestT& request,
                                            const PutBackupVaultLockConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBackupVaultNotificationsOutcome PutBackupVaultNotifications(
      const Model::PutBackupVaultNotificationsRequest& request) const;

  /**
   * A Callable wrapper for PutBackupVaultNotifications that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutBackupVaultNotificationsRequestT = Model::PutBackupVaultNotificationsRequest>
  Model::PutBackupVaultNotificationsOutcomeCallable PutBackupVaultNotificationsCallable(
      const PutBackupVaultNotificationsRequestT& request) const {
    return SubmitCallable(&BackupClient::PutBackupVaultNotifications, request);
  }

  /**
   * An Async wrapper for PutBackupVaultNotifications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutBackupVaultNotificationsRequestT = Model::PutBackupVaultNotificationsRequest>
  void PutBackupVaultNotificationsAsync(const PutBackupVaultNotificationsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutRestoreValidationResultOutcome PutRestoreValidationResult(
      const Model::PutRestoreValidationResultRequest& request) const;

  /**
   * A Callable wrapper for PutRestoreValidationResult that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutRestoreValidationResultRequestT = Model::PutRestoreValidationResultRequest>
  Model::PutRestoreValidationResultOutcomeCallable PutRestoreValidationResultCallable(
      const PutRestoreValidationResultRequestT& request) const {
    return SubmitCallable(&BackupClient::PutRestoreValidationResult, request);
  }

  /**
   * An Async wrapper for PutRestoreValidationResult that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRestoreValidationResultRequestT = Model::PutRestoreValidationResultRequest>
  void PutRestoreValidationResultAsync(const PutRestoreValidationResultRequestT& request,
                                       const PutRestoreValidationResultResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RevokeRestoreAccessBackupVaultOutcome RevokeRestoreAccessBackupVault(
      const Model::RevokeRestoreAccessBackupVaultRequest& request) const;

  /**
   * A Callable wrapper for RevokeRestoreAccessBackupVault that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RevokeRestoreAccessBackupVaultRequestT = Model::RevokeRestoreAccessBackupVaultRequest>
  Model::RevokeRestoreAccessBackupVaultOutcomeCallable RevokeRestoreAccessBackupVaultCallable(
      const RevokeRestoreAccessBackupVaultRequestT& request) const {
    return SubmitCallable(&BackupClient::RevokeRestoreAccessBackupVault, request);
  }

  /**
   * An Async wrapper for RevokeRestoreAccessBackupVault that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RevokeRestoreAccessBackupVaultRequestT = Model::RevokeRestoreAccessBackupVaultRequest>
  void RevokeRestoreAccessBackupVaultAsync(const RevokeRestoreAccessBackupVaultRequestT& request,
                                           const RevokeRestoreAccessBackupVaultResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartBackupJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartBackupJobRequestT = Model::StartBackupJobRequest>
  void StartBackupJobAsync(const StartBackupJobRequestT& request, const StartBackupJobResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartCopyJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartCopyJobRequestT = Model::StartCopyJobRequest>
  void StartCopyJobAsync(const StartCopyJobRequestT& request, const StartCopyJobResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartReportJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartReportJobRequestT = Model::StartReportJobRequest>
  void StartReportJobAsync(const StartReportJobRequestT& request, const StartReportJobResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartRestoreJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartRestoreJobRequestT = Model::StartRestoreJobRequest>
  ...
  /**
   * An Async wrapper for StopBackupJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopBackupJobRequestT = Model::StopBackupJobRequest>
  void StopBackupJobAsync(const StopBackupJobRequestT& request, const StopBackupJobResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateBackupPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBackupPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateBackupPlanRequestT = Model::UpdateBackupPlanRequest>
  void UpdateBackupPlanAsync(const UpdateBackupPlanRequestT& request, const UpdateBackupPlanResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateFramework that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateFrameworkRequestT = Model::UpdateFrameworkRequest>
  void UpdateFrameworkAsync(const UpdateFrameworkRequestT& request, const UpdateFrameworkResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRecoveryPointIndexSettingsOutcome UpdateRecoveryPointIndexSettings(
      const Model::UpdateRecoveryPointIndexSettingsRequest& request) const;

  /**
   * A Callable wrapper for UpdateRecoveryPointIndexSettings that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateRecoveryPointIndexSettingsRequestT = Model::UpdateRecoveryPointIndexSettingsRequest>
  Model::UpdateRecoveryPointIndexSettingsOutcomeCallable UpdateRecoveryPointIndexSettingsCallable(
      const UpdateRecoveryPointIndexSettingsRequestT& request) const {
    return SubmitCallable(&BackupClient::UpdateRecoveryPointIndexSettings, request);
  }

  /**
   * An Async wrapper for UpdateRecoveryPointIndexSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateRecoveryPointIndexSettingsRequestT = Model::UpdateRecoveryPointIndexSettingsRequest>
  void UpdateRecoveryPointIndexSettingsAsync(const UpdateRecoveryPointIndexSettingsRequestT& request,
                                             const UpdateRecoveryPointIndexSettingsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRecoveryPointLifecycleOutcome UpdateRecoveryPointLifecycle(
      const Model::UpdateRecoveryPointLifecycleRequest& request) const;

  /**
   * A Callable wrapper for UpdateRecoveryPointLifecycle that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateRecoveryPointLifecycleRequestT = Model::UpdateRecoveryPointLifecycleRequest>
  Model::UpdateRecoveryPointLifecycleOutcomeCallable UpdateRecoveryPointLifecycleCallable(
      const UpdateRecoveryPointLifecycleRequestT& request) const {
    return SubmitCallable(&BackupClient::UpdateRecoveryPointLifecycle, request);
  }

  /**
   * An Async wrapper for UpdateRecoveryPointLifecycle that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRecoveryPointLifecycleRequestT = Model::UpdateRecoveryPointLifecycleRequest>
  void UpdateRecoveryPointLifecycleAsync(const UpdateRecoveryPointLifecycleRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateRegionSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRegionSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRegionSettingsRequestT = Model::UpdateRegionSettingsRequest>
  void UpdateRegionSettingsAsync(const UpdateRegionSettingsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const UpdateRegionSettingsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateReportPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateReportPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateReportPlanRequestT = Model::UpdateReportPlanRequest>
  void UpdateReportPlanAsync(const UpdateReportPlanRequestT& request, const UpdateReportPlanResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateRestoreTestingPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRestoreTestingPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRestoreTestingPlanRequestT = Model::UpdateRestoreTestingPlanRequest>
  void UpdateRestoreTestingPlanAsync(const UpdateRestoreTestingPlanRequestT& request,
                                     const UpdateRestoreTestingPlanResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRestoreTestingSelectionOutcome UpdateRestoreTestingSelection(
      const Model::UpdateRestoreTestingSelectionRequest& request) const;

  /**
   * A Callable wrapper for UpdateRestoreTestingSelection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateRestoreTestingSelectionRequestT = Model::UpdateRestoreTestingSelectionRequest>
  Model::UpdateRestoreTestingSelectionOutcomeCallable UpdateRestoreTestingSelectionCallable(
      const UpdateRestoreTestingSelectionRequestT& request) const {
    return SubmitCallable(&BackupClient::UpdateRestoreTestingSelection, request);
  }

  /**
   * An Async wrapper for UpdateRestoreTestingSelection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRestoreTestingSelectionRequestT = Model::UpdateRestoreTestingSelectionRequest>
  void UpdateRestoreTestingSelectionAsync(const UpdateRestoreTestingSelectionRequestT& request,
