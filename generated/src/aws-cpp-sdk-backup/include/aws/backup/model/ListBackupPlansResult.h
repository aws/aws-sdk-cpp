...
class ListBackupPlansResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListBackupPlansResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetBackupPlansList(BackupPlansListT&& value) {
    m_backupPlansListHasBeenSet = true;
    m_backupPlansList = std::forward<BackupPlansListT>(value);
  }
  template <typename BackupPlansListT = Aws::Vector<BackupPlansListMember>>
  ListBackupPlansResult& WithBackupPlansList(BackupPlansListT&& value) {
    SetBackupPlansList(std::forward<BackupPlansListT>(value));
    return *this;
  }
  template <typename BackupPlansListT = BackupPlansListMember>
  ListBackupPlansResult& AddBackupPlansList(BackupPlansListT&& value) {
    m_backupPlansListHasBeenSet = true;
    m_backupPlansList.emplace_back(std::forward<BackupPlansListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBackupPlansResult& WithRequestId(RequestIdT&& value) {
