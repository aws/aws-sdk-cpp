...
class GetRestoreJobMetadataResult {
 public:
  ...
  template <typename RestoreJobIdT = Aws::String>
  GetRestoreJobMetadataResult& WithRestoreJobId(RestoreJobIdT&& value) {
  ...
  template <typename MetadataT = Aws::Map<Aws::String, Aws::String>>
  GetRestoreJobMetadataResult& WithMetadata(MetadataT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRestoreJobMetadataResult& WithRequestId(RequestIdT&& value) {
