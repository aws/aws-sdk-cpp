...
namespace Model
{
  ...
  public:
    ...
    template<typename BackupVaultNameT = Aws::String>
    GetRecoveryPointIndexDetailsRequest& WithBackupVaultName(BackupVaultNameT&& value) { SetBackupVaultName(std::forward<BackupVaultNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RecoveryPointArnT = Aws::String>
    GetRecoveryPointIndexDetailsRequest& WithRecoveryPointArn(RecoveryPointArnT&& value) { SetRecoveryPointArn(std::forward<RecoveryPointArnT>(value)); return *this;}
    ///@}
  private:
