...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUP_API InvalidParameterValueException() = default;
    ...
    template<typename ContextT = Aws::String>
    InvalidParameterValueException& WithContext(ContextT&& value) { SetContext(std::forward<ContextT>(value)); return *this;}
    ///@}
  private:
