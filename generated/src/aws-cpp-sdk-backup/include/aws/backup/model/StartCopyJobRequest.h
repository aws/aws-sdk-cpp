...
class StartCopyJobRequest : public BackupRequest {
 public:
  ...
  void SetSourceBackupVaultName(SourceBackupVaultNameT&& value) {
    m_sourceBackupVaultNameHasBeenSet = true;
    m_sourceBackupVaultName = std::forward<SourceBackupVaultNameT>(value);
  }
  template <typename SourceBackupVaultNameT = Aws::String>
  StartCopyJobRequest& WithSourceBackupVaultName(SourceBackupVaultNameT&& value) {
    SetSourceBackupVaultName(std::forward<SourceBackupVaultNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationBackupVaultArn(DestinationBackupVaultArnT&& value) {
    ...
    m_destinationBackupVaultArn = std::forward<DestinationBackupVaultArnT>(value);
  }
  template <typename DestinationBackupVaultArnT = Aws::String>
  StartCopyJobRequest& WithDestinationBackupVaultArn(DestinationBackupVaultArnT&& value) {
    SetDestinationBackupVaultArn(std::forward<DestinationBackupVaultArnT>(value));
    return *this;
  }
  ///@}
