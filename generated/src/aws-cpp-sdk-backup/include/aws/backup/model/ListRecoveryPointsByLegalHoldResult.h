...
class ListRecoveryPointsByLegalHoldResult {
 public:
  ...
  template <typename RecoveryPointsT = Aws::Vector<RecoveryPointMember>>
  ListRecoveryPointsByLegalHoldResult& WithRecoveryPoints(RecoveryPointsT&& value) {
    SetRecoveryPoints(std::forward<RecoveryPointsT>(value));
    return *this;
  }
  template <typename RecoveryPointsT = RecoveryPointMember>
  ListRecoveryPointsByLegalHoldResult& AddRecoveryPoints(RecoveryPointsT&& value) {
    m_recoveryPointsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRecoveryPointsByLegalHoldResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRecoveryPointsByLegalHoldResult& WithRequestId(RequestIdT&& value) {
