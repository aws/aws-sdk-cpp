...
class RevokeRestoreAccessBackupVaultRequest : public BackupRequest {
 public:
  ...
  template <typename BackupVaultNameT = Aws::String>
  RevokeRestoreAccessBackupVaultRequest& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  void SetRestoreAccessBackupVaultArn(RestoreAccessBackupVaultArnT&& value) {
    m_restoreAccessBackupVaultArnHasBeenSet = true;
    m_restoreAccessBackupVaultArn = std::forward<RestoreAccessBackupVaultArnT>(value);
  }
  template <typename RestoreAccessBackupVaultArnT = Aws::String>
  RevokeRestoreAccessBackupVaultRequest& WithRestoreAccessBackupVaultArn(RestoreAccessBackupVaultArnT&& value) {
    SetRestoreAccessBackupVaultArn(std::forward<RestoreAccessBackupVaultArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequesterCommentT = Aws::String>
  RevokeRestoreAccessBackupVaultRequest& WithRequesterComment(RequesterCommentT&& value) {
