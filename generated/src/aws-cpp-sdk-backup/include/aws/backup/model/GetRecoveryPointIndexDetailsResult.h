...
class GetRecoveryPointIndexDetailsResult {
 public:
  ...
  void SetIndexDeletionDate(IndexDeletionDateT&& value) {
    ...
    m_indexDeletionDate = std::forward<IndexDeletionDateT>(value);
  }
  template <typename IndexDeletionDateT = Aws::Utils::DateTime>
  GetRecoveryPointIndexDetailsResult& WithIndexDeletionDate(IndexDeletionDateT&& value) {
    SetIndexDeletionDate(std::forward<IndexDeletionDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIndexCompletionDate(IndexCompletionDateT&& value) {
    ...
    m_indexCompletionDate = std::forward<IndexCompletionDateT>(value);
  }
  template <typename IndexCompletionDateT = Aws::Utils::DateTime>
  GetRecoveryPointIndexDetailsResult& WithIndexCompletionDate(IndexCompletionDateT&& value) {
    SetIndexCompletionDate(std::forward<IndexCompletionDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetRecoveryPointIndexDetailsResult& WithIndexStatus(IndexStatus value) {
  ...
  inline void SetTotalItemsIndexed(long long value) {
    m_totalItemsIndexedHasBeenSet = true;
    m_totalItemsIndexed = value;
  }
  inline GetRecoveryPointIndexDetailsResult& WithTotalItemsIndexed(long long value) {
    SetTotalItemsIndexed(value);
    return *this;
  }
  ///@}
