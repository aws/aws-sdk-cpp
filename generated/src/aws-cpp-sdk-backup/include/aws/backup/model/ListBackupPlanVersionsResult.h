...
class ListBackupPlanVersionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListBackupPlanVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetBackupPlanVersionsList(BackupPlanVersionsListT&& value) {
    m_backupPlanVersionsListHasBeenSet = true;
    m_backupPlanVersionsList = std::forward<BackupPlanVersionsListT>(value);
  }
  template <typename BackupPlanVersionsListT = Aws::Vector<BackupPlansListMember>>
  ListBackupPlanVersionsResult& WithBackupPlanVersionsList(BackupPlanVersionsListT&& value) {
    SetBackupPlanVersionsList(std::forward<BackupPlanVersionsListT>(value));
    return *this;
  }
  template <typename BackupPlanVersionsListT = BackupPlansListMember>
  ListBackupPlanVersionsResult& AddBackupPlanVersionsList(BackupPlanVersionsListT&& value) {
    m_backupPlanVersionsListHasBeenSet = true;
    m_backupPlanVersionsList.emplace_back(std::forward<BackupPlanVersionsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBackupPlanVersionsResult& WithRequestId(RequestIdT&& value) {
