...
class BackupRule {
 public:
  ...
  inline BackupRule& WithStartWindowMinutes(long long value) {
  ...
  inline BackupRule& WithCompletionWindowMinutes(long long value) {
  ...
  inline BackupRule& WithEnableContinuousBackup(bool value) {
