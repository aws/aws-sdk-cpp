...
class RestoreTestingPlanForUpdate {
 public:
  ...
  template <typename RecoveryPointSelectionT = RestoreTestingRecoveryPointSelection>
  RestoreTestingPlanForUpdate& WithRecoveryPointSelection(RecoveryPointSelectionT&& value) {
  ...
  template <typename ScheduleExpressionT = Aws::String>
  RestoreTestingPlanForUpdate& WithScheduleExpression(ScheduleExpressionT&& value) {
  ...
  template <typename ScheduleExpressionTimezoneT = Aws::String>
  RestoreTestingPlanForUpdate& WithScheduleExpressionTimezone(ScheduleExpressionTimezoneT&& value) {
  ...
  inline RestoreTestingPlanForUpdate& WithStartWindowHours(int value) {
