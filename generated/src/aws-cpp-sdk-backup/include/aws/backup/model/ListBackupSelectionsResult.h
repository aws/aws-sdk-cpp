...
class ListBackupSelectionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListBackupSelectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetBackupSelectionsList(BackupSelectionsListT&& value) {
    m_backupSelectionsListHasBeenSet = true;
    m_backupSelectionsList = std::forward<BackupSelectionsListT>(value);
  }
  template <typename BackupSelectionsListT = Aws::Vector<BackupSelectionsListMember>>
  ListBackupSelectionsResult& WithBackupSelectionsList(BackupSelectionsListT&& value) {
    SetBackupSelectionsList(std::forward<BackupSelectionsListT>(value));
    return *this;
  }
  template <typename BackupSelectionsListT = BackupSelectionsListMember>
  ListBackupSelectionsResult& AddBackupSelectionsList(BackupSelectionsListT&& value) {
    m_backupSelectionsListHasBeenSet = true;
    m_backupSelectionsList.emplace_back(std::forward<BackupSelectionsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBackupSelectionsResult& WithRequestId(RequestIdT&& value) {
