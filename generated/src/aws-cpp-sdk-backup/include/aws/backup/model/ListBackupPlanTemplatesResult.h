...
class ListBackupPlanTemplatesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListBackupPlanTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetBackupPlanTemplatesList(BackupPlanTemplatesListT&& value) {
    m_backupPlanTemplatesListHasBeenSet = true;
    m_backupPlanTemplatesList = std::forward<BackupPlanTemplatesListT>(value);
  }
  template <typename BackupPlanTemplatesListT = Aws::Vector<BackupPlanTemplatesListMember>>
  ListBackupPlanTemplatesResult& WithBackupPlanTemplatesList(BackupPlanTemplatesListT&& value) {
    SetBackupPlanTemplatesList(std::forward<BackupPlanTemplatesListT>(value));
    return *this;
  }
  template <typename BackupPlanTemplatesListT = BackupPlanTemplatesListMember>
  ListBackupPlanTemplatesResult& AddBackupPlanTemplatesList(BackupPlanTemplatesListT&& value) {
    m_backupPlanTemplatesListHasBeenSet = true;
    m_backupPlanTemplatesList.emplace_back(std::forward<BackupPlanTemplatesListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBackupPlanTemplatesResult& WithRequestId(RequestIdT&& value) {
