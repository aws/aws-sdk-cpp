...
namespace Model
{
  ...
  public:
    ...
    inline ListBackupPlanTemplatesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListBackupPlanTemplatesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListBackupPlanTemplatesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
