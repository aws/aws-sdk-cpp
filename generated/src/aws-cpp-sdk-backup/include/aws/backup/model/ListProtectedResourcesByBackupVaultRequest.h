...
class ListProtectedResourcesByBackupVaultRequest : public BackupRequest {
 public:
  ...
  template <typename BackupVaultNameT = Aws::String>
  ListProtectedResourcesByBackupVaultRequest& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename BackupVaultAccountIdT = Aws::String>
  ListProtectedResourcesByBackupVaultRequest& WithBackupVaultAccountId(BackupVaultAccountIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListProtectedResourcesByBackupVaultRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListProtectedResourcesByBackupVaultRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
