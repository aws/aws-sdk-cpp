...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUP_API ListProtectedResourcesByBackupVaultRequest() = default;
    ...
    template<typename BackupVaultNameT = Aws::String>
    ListProtectedResourcesByBackupVaultRequest& WithBackupVaultName(BackupVaultNameT&& value) { SetBackupVaultName(std::forward<BackupVaultNameT>(value)); return *this;}
    ///@}
    ...
    template<typename BackupVaultAccountIdT = Aws::String>
    ListProtectedResourcesByBackupVaultRequest& WithBackupVaultAccountId(BackupVaultAccountIdT&& value) { SetBackupVaultAccountId(std::forward<BackupVaultAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListProtectedResourcesByBackupVaultRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
