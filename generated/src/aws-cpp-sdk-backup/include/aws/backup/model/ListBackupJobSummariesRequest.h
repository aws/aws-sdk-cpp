...
class ListBackupJobSummariesRequest : public BackupRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  ListBackupJobSummariesRequest& WithAccountId(AccountIdT&& value) {
  ...
  inline ListBackupJobSummariesRequest& WithState(BackupJobStatus value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceTypeT = Aws::String>
  ListBackupJobSummariesRequest& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename MessageCategoryT = Aws::String>
  ListBackupJobSummariesRequest& WithMessageCategory(MessageCategoryT&& value) {
  ...
  inline ListBackupJobSummariesRequest& WithAggregationPeriod(AggregationPeriod value) {
  ...
  inline ListBackupJobSummariesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBackupJobSummariesRequest& WithNextToken(NextTokenT&& value) {
