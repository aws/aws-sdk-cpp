...
class ListRestoreJobsByProtectedResourceRequest : public BackupRequest {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  ListRestoreJobsByProtectedResourceRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline void SetByStatus(RestoreJobStatus value) {
    m_byStatusHasBeenSet = true;
    m_byStatus = value;
  }
  inline ListRestoreJobsByProtectedResourceRequest& WithByStatus(RestoreJobStatus value) {
    SetByStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetByRecoveryPointCreationDateAfter(ByRecoveryPointCreationDateAfterT&& value) {
    m_byRecoveryPointCreationDateAfterHasBeenSet = true;
    m_byRecoveryPointCreationDateAfter = std::forward<ByRecoveryPointCreationDateAfterT>(value);
  }
  template <typename ByRecoveryPointCreationDateAfterT = Aws::Utils::DateTime>
  ListRestoreJobsByProtectedResourceRequest& WithByRecoveryPointCreationDateAfter(ByRecoveryPointCreationDateAfterT&& value) {
    SetByRecoveryPointCreationDateAfter(std::forward<ByRecoveryPointCreationDateAfterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetByRecoveryPointCreationDateBefore(ByRecoveryPointCreationDateBeforeT&& value) {
    m_byRecoveryPointCreationDateBeforeHasBeenSet = true;
    m_byRecoveryPointCreationDateBefore = std::forward<ByRecoveryPointCreationDateBeforeT>(value);
  }
  template <typename ByRecoveryPointCreationDateBeforeT = Aws::Utils::DateTime>
  ListRestoreJobsByProtectedResourceRequest& WithByRecoveryPointCreationDateBefore(ByRecoveryPointCreationDateBeforeT&& value) {
    SetByRecoveryPointCreationDateBefore(std::forward<ByRecoveryPointCreationDateBeforeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRestoreJobsByProtectedResourceRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRestoreJobsByProtectedResourceRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
