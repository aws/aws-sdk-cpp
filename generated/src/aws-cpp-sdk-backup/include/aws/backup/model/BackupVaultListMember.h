...
class BackupVaultListMember {
 public:
  ...
  inline BackupVaultListMember& WithVaultType(VaultType value) {
    SetVaultType(value);
    return *this;
  }
  ///@}
  ...
  inline BackupVaultListMember& WithVaultState(VaultState value) {
    SetVaultState(value);
    return *this;
  }
  ///@}
  ...
  inline BackupVaultListMember& WithNumberOfRecoveryPoints(long long value) {
  ...
  inline BackupVaultListMember& WithLocked(bool value) {
    SetLocked(value);
    return *this;
  }
  ///@}
  ...
  inline BackupVaultListMember& WithMinRetentionDays(long long value) {
  ...
  inline BackupVaultListMember& WithMaxRetentionDays(long long value) {
