...
class DescribeRecoveryPointResult {
 public:
  ...
  void SetSourceBackupVaultArn(SourceBackupVaultArnT&& value) {
    ...
    m_sourceBackupVaultArn = std::forward<SourceBackupVaultArnT>(value);
  }
  template <typename SourceBackupVaultArnT = Aws::String>
  DescribeRecoveryPointResult& WithSourceBackupVaultArn(SourceBackupVaultArnT&& value) {
    SetSourceBackupVaultArn(std::forward<SourceBackupVaultArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(RecoveryPointStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeRecoveryPointResult& WithStatus(RecoveryPointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeRecoveryPointResult& WithBackupSizeInBytes(long long value) {
  ...
  inline DescribeRecoveryPointResult& WithIsEncrypted(bool value) {
  ...
  inline DescribeRecoveryPointResult& WithStorageClass(StorageClass value) {
  ...
  void SetLastRestoreTime(LastRestoreTimeT&& value) {
    ...
    m_lastRestoreTime = std::forward<LastRestoreTimeT>(value);
  }
  template <typename LastRestoreTimeT = Aws::Utils::DateTime>
  DescribeRecoveryPointResult& WithLastRestoreTime(LastRestoreTimeT&& value) {
    SetLastRestoreTime(std::forward<LastRestoreTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetParentRecoveryPointArn(ParentRecoveryPointArnT&& value) {
    ...
    m_parentRecoveryPointArn = std::forward<ParentRecoveryPointArnT>(value);
  }
  template <typename ParentRecoveryPointArnT = Aws::String>
  DescribeRecoveryPointResult& WithParentRecoveryPointArn(ParentRecoveryPointArnT&& value) {
    SetParentRecoveryPointArn(std::forward<ParentRecoveryPointArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCompositeMemberIdentifier(CompositeMemberIdentifierT&& value) {
    ...
    m_compositeMemberIdentifier = std::forward<CompositeMemberIdentifierT>(value);
  }
  template <typename CompositeMemberIdentifierT = Aws::String>
  DescribeRecoveryPointResult& WithCompositeMemberIdentifier(CompositeMemberIdentifierT&& value) {
    SetCompositeMemberIdentifier(std::forward<CompositeMemberIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeRecoveryPointResult& WithIsParent(bool value) {
    SetIsParent(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVaultType(VaultType value) {
    m_vaultTypeHasBeenSet = true;
    m_vaultType = value;
  }
  inline DescribeRecoveryPointResult& WithVaultType(VaultType value) {
    SetVaultType(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeRecoveryPointResult& WithIndexStatus(IndexStatus value) {
  ...
  void SetIndexStatusMessage(IndexStatusMessageT&& value) {
    ...
    m_indexStatusMessage = std::forward<IndexStatusMessageT>(value);
  }
  template <typename IndexStatusMessageT = Aws::String>
  DescribeRecoveryPointResult& WithIndexStatusMessage(IndexStatusMessageT&& value) {
    SetIndexStatusMessage(std::forward<IndexStatusMessageT>(value));
    return *this;
  }
  ///@}
