...
class ListRestoreJobsRequest : public BackupRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListRestoreJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRestoreJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename ByAccountIdT = Aws::String>
  ListRestoreJobsRequest& WithByAccountId(ByAccountIdT&& value) {
  ...
  template <typename ByResourceTypeT = Aws::String>
  ListRestoreJobsRequest& WithByResourceType(ByResourceTypeT&& value) {
  ...
  template <typename ByCreatedBeforeT = Aws::Utils::DateTime>
  ListRestoreJobsRequest& WithByCreatedBefore(ByCreatedBeforeT&& value) {
  ...
  template <typename ByCreatedAfterT = Aws::Utils::DateTime>
  ListRestoreJobsRequest& WithByCreatedAfter(ByCreatedAfterT&& value) {
  ...
  inline ListRestoreJobsRequest& WithByStatus(RestoreJobStatus value) {
    SetByStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ByCompleteBeforeT = Aws::Utils::DateTime>
  ListRestoreJobsRequest& WithByCompleteBefore(ByCompleteBeforeT&& value) {
  ...
  template <typename ByCompleteAfterT = Aws::Utils::DateTime>
  ListRestoreJobsRequest& WithByCompleteAfter(ByCompleteAfterT&& value) {
  ...
  void SetByRestoreTestingPlanArn(ByRestoreTestingPlanArnT&& value) {
    m_byRestoreTestingPlanArnHasBeenSet = true;
    m_byRestoreTestingPlanArn = std::forward<ByRestoreTestingPlanArnT>(value);
  }
  template <typename ByRestoreTestingPlanArnT = Aws::String>
  ListRestoreJobsRequest& WithByRestoreTestingPlanArn(ByRestoreTestingPlanArnT&& value) {
    SetByRestoreTestingPlanArn(std::forward<ByRestoreTestingPlanArnT>(value));
    return *this;
  }
  ///@}
 private:
