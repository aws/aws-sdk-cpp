...
class StopBackupJobRequest : public BackupRequest {
 public:
  AWS_BACKUP_API StopBackupJobRequest() = default;
  ...
  void SetBackupJobId(BackupJobIdT&& value) {
    ...
    m_backupJobId = std::forward<BackupJobIdT>(value);
  }
  template <typename BackupJobIdT = Aws::String>
  StopBackupJobRequest& WithBackupJobId(BackupJobIdT&& value) {
    SetBackupJobId(std::forward<BackupJobIdT>(value));
    return *this;
  }
  ///@}
 private:
