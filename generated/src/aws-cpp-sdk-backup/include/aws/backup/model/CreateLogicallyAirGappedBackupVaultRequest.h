...
class CreateLogicallyAirGappedBackupVaultRequest : public BackupRequest {
 public:
  ...
  template <typename BackupVaultNameT = Aws::String>
  CreateLogicallyAirGappedBackupVaultRequest& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename BackupVaultTagsT = Aws::Map<Aws::String, Aws::String>>
  CreateLogicallyAirGappedBackupVaultRequest& WithBackupVaultTags(BackupVaultTagsT&& value) {
  ...
  template <typename CreatorRequestIdT = Aws::String>
  CreateLogicallyAirGappedBackupVaultRequest& WithCreatorRequestId(CreatorRequestIdT&& value) {
  ...
  inline CreateLogicallyAirGappedBackupVaultRequest& WithMinRetentionDays(long long value) {
  ...
  inline CreateLogicallyAirGappedBackupVaultRequest& WithMaxRetentionDays(long long value) {
