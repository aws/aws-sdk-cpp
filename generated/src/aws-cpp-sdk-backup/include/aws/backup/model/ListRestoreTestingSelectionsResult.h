...
class ListRestoreTestingSelectionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListRestoreTestingSelectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetRestoreTestingSelections(RestoreTestingSelectionsT&& value) {
    m_restoreTestingSelectionsHasBeenSet = true;
    m_restoreTestingSelections = std::forward<RestoreTestingSelectionsT>(value);
  }
  template <typename RestoreTestingSelectionsT = Aws::Vector<RestoreTestingSelectionForList>>
  ListRestoreTestingSelectionsResult& WithRestoreTestingSelections(RestoreTestingSelectionsT&& value) {
    SetRestoreTestingSelections(std::forward<RestoreTestingSelectionsT>(value));
    return *this;
  }
  template <typename RestoreTestingSelectionsT = RestoreTestingSelectionForList>
  ListRestoreTestingSelectionsResult& AddRestoreTestingSelections(RestoreTestingSelectionsT&& value) {
    m_restoreTestingSelectionsHasBeenSet = true;
    m_restoreTestingSelections.emplace_back(std::forward<RestoreTestingSelectionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListRestoreTestingSelectionsResult& WithRequestId(RequestIdT&& value) {
