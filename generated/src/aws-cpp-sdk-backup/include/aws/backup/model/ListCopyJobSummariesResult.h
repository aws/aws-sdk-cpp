...
class ListCopyJobSummariesResult {
 public:
  ...
  void SetCopyJobSummaries(CopyJobSummariesT&& value) {
    m_copyJobSummariesHasBeenSet = true;
    m_copyJobSummaries = std::forward<CopyJobSummariesT>(value);
  }
  template <typename CopyJobSummariesT = Aws::Vector<CopyJobSummary>>
  ListCopyJobSummariesResult& WithCopyJobSummaries(CopyJobSummariesT&& value) {
    SetCopyJobSummaries(std::forward<CopyJobSummariesT>(value));
    return *this;
  }
  template <typename CopyJobSummariesT = CopyJobSummary>
  ListCopyJobSummariesResult& AddCopyJobSummaries(CopyJobSummariesT&& value) {
    m_copyJobSummariesHasBeenSet = true;
    m_copyJobSummaries.emplace_back(std::forward<CopyJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AggregationPeriodT = Aws::String>
  ListCopyJobSummariesResult& WithAggregationPeriod(AggregationPeriodT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListCopyJobSummariesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCopyJobSummariesResult& WithRequestId(RequestIdT&& value) {
