...
class ListCopyJobSummariesRequest : public BackupRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  ListCopyJobSummariesRequest& WithAccountId(AccountIdT&& value) {
  ...
  inline ListCopyJobSummariesRequest& WithState(CopyJobStatus value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceTypeT = Aws::String>
  ListCopyJobSummariesRequest& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename MessageCategoryT = Aws::String>
  ListCopyJobSummariesRequest& WithMessageCategory(MessageCategoryT&& value) {
  ...
  inline ListCopyJobSummariesRequest& WithAggregationPeriod(AggregationPeriod value) {
  ...
  inline ListCopyJobSummariesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCopyJobSummariesRequest& WithNextToken(NextTokenT&& value) {
