...
class DescribeRegionSettingsResult {
 public:
  ...
  template <typename ResourceTypeOptInPreferenceT = Aws::Map<Aws::String, bool>>
  DescribeRegionSettingsResult& WithResourceTypeOptInPreference(ResourceTypeOptInPreferenceT&& value) {
  ...
  template <typename ResourceTypeManagementPreferenceT = Aws::Map<Aws::String, bool>>
  DescribeRegionSettingsResult& WithResourceTypeManagementPreference(ResourceTypeManagementPreferenceT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRegionSettingsResult& WithRequestId(RequestIdT&& value) {
