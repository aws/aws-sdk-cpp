...
class GetLegalHoldResult {
 public:
  ...
  inline void SetStatus(LegalHoldStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetLegalHoldResult& WithStatus(LegalHoldStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCancelDescription(CancelDescriptionT&& value) {
    ...
    m_cancelDescription = std::forward<CancelDescriptionT>(value);
  }
  template <typename CancelDescriptionT = Aws::String>
  GetLegalHoldResult& WithCancelDescription(CancelDescriptionT&& value) {
    SetCancelDescription(std::forward<CancelDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLegalHoldId(LegalHoldIdT&& value) {
    ...
    m_legalHoldId = std::forward<LegalHoldIdT>(value);
  }
  template <typename LegalHoldIdT = Aws::String>
  GetLegalHoldResult& WithLegalHoldId(LegalHoldIdT&& value) {
    SetLegalHoldId(std::forward<LegalHoldIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLegalHoldArn(LegalHoldArnT&& value) {
    ...
    m_legalHoldArn = std::forward<LegalHoldArnT>(value);
  }
  template <typename LegalHoldArnT = Aws::String>
  GetLegalHoldResult& WithLegalHoldArn(LegalHoldArnT&& value) {
    SetLegalHoldArn(std::forward<LegalHoldArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCancellationDate(CancellationDateT&& value) {
    ...
    m_cancellationDate = std::forward<CancellationDateT>(value);
  }
  template <typename CancellationDateT = Aws::Utils::DateTime>
  GetLegalHoldResult& WithCancellationDate(CancellationDateT&& value) {
    SetCancellationDate(std::forward<CancellationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRetainRecordUntil(RetainRecordUntilT&& value) {
    ...
    m_retainRecordUntil = std::forward<RetainRecordUntilT>(value);
  }
  template <typename RetainRecordUntilT = Aws::Utils::DateTime>
  GetLegalHoldResult& WithRetainRecordUntil(RetainRecordUntilT&& value) {
    SetRetainRecordUntil(std::forward<RetainRecordUntilT>(value));
    return *this;
  }
  ///@}
