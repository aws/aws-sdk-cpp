...
class GetBackupVaultAccessPolicyResult {
 public:
  ...
  template <typename BackupVaultNameT = Aws::String>
  GetBackupVaultAccessPolicyResult& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename BackupVaultArnT = Aws::String>
  GetBackupVaultAccessPolicyResult& WithBackupVaultArn(BackupVaultArnT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  GetBackupVaultAccessPolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBackupVaultAccessPolicyResult& WithRequestId(RequestIdT&& value) {
