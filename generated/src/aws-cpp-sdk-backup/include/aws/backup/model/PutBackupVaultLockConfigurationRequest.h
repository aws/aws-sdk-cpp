...
class PutBackupVaultLockConfigurationRequest : public BackupRequest {
 public:
  ...
  template <typename BackupVaultNameT = Aws::String>
  PutBackupVaultLockConfigurationRequest& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  inline PutBackupVaultLockConfigurationRequest& WithMinRetentionDays(long long value) {
  ...
  inline PutBackupVaultLockConfigurationRequest& WithMaxRetentionDays(long long value) {
  ...
  inline void SetChangeableForDays(long long value) {
    m_changeableForDaysHasBeenSet = true;
    m_changeableForDays = value;
  }
  inline PutBackupVaultLockConfigurationRequest& WithChangeableForDays(long long value) {
    SetChangeableForDays(value);
    return *this;
  }
  ///@}
 private:
