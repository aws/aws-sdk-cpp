...
class ListRecoveryPointsByResourceResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListRecoveryPointsByResourceResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RecoveryPointsT = Aws::Vector<RecoveryPointByResource>>
  ListRecoveryPointsByResourceResult& WithRecoveryPoints(RecoveryPointsT&& value) {
    SetRecoveryPoints(std::forward<RecoveryPointsT>(value));
    return *this;
  }
  template <typename RecoveryPointsT = RecoveryPointByResource>
  ListRecoveryPointsByResourceResult& AddRecoveryPoints(RecoveryPointsT&& value) {
    m_recoveryPointsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListRecoveryPointsByResourceResult& WithRequestId(RequestIdT&& value) {
