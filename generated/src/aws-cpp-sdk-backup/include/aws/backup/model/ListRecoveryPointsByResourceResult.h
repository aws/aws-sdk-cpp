...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUP_API ListRecoveryPointsByResourceResult();
    ...
    inline ListRecoveryPointsByResourceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListRecoveryPointsByResourceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListRecoveryPointsByResourceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
