...
namespace Backup {
namespace Model {
class ListBackupAccessPointsByResourceResult {
 public:
  AWS_BACKUP_API ListBackupAccessPointsByResourceResult() = default;
  AWS_BACKUP_API ListBackupAccessPointsByResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BACKUP_API ListBackupAccessPointsByResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename BackupAccessPointsT = Aws::Vector<ListAccessPointsMember>>
  ListBackupAccessPointsByResourceResult& WithBackupAccessPoints(BackupAccessPointsT&& value) {
    SetBackupAccessPoints(std::forward<BackupAccessPointsT>(value));
    return *this;
  }
  template <typename BackupAccessPointsT = ListAccessPointsMember>
  ListBackupAccessPointsByResourceResult& AddBackupAccessPoints(BackupAccessPointsT&& value) {
    m_backupAccessPointsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBackupAccessPointsByResourceResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBackupAccessPointsByResourceResult& WithRequestId(RequestIdT&& value) {
