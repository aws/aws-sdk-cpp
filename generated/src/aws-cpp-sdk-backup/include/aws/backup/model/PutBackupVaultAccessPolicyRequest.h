...
class PutBackupVaultAccessPolicyRequest : public BackupRequest {
 public:
  AWS_BACKUP_API PutBackupVaultAccessPolicyRequest() = default;
  ...
  template <typename BackupVaultNameT = Aws::String>
  PutBackupVaultAccessPolicyRequest& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  PutBackupVaultAccessPolicyRequest& WithPolicy(PolicyT&& value) {
