...
class ListRestoreTestingSelectionsRequest : public BackupRequest {
 public:
  ...
  inline ListRestoreTestingSelectionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRestoreTestingSelectionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RestoreTestingPlanNameT = Aws::String>
  ListRestoreTestingSelectionsRequest& WithRestoreTestingPlanName(RestoreTestingPlanNameT&& value) {
