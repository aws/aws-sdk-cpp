...
namespace Model
{
  ...
  public:
    ...
    template<typename BackupPlanIdT = Aws::String>
    GetBackupSelectionRequest& WithBackupPlanId(BackupPlanIdT&& value) { SetBackupPlanId(std::forward<BackupPlanIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SelectionIdT = Aws::String>
    GetBackupSelectionRequest& WithSelectionId(SelectionIdT&& value) { SetSelectionId(std::forward<SelectionIdT>(value)); return *this;}
    ///@}
  private:
