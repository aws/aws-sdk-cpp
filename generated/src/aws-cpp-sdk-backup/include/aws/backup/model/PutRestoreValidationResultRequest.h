...
class PutRestoreValidationResultRequest : public BackupRequest {
 public:
  ...
  template <typename RestoreJobIdT = Aws::String>
  PutRestoreValidationResultRequest& WithRestoreJobId(RestoreJobIdT&& value) {
  ...
  inline PutRestoreValidationResultRequest& WithValidationStatus(RestoreValidationStatus value) {
  ...
  template <typename ValidationStatusMessageT = Aws::String>
  PutRestoreValidationResultRequest& WithValidationStatusMessage(ValidationStatusMessageT&& value) {
