...
class GetRecoveryPointRestoreMetadataResult {
 public:
  ...
  template <typename BackupVaultArnT = Aws::String>
  GetRecoveryPointRestoreMetadataResult& WithBackupVaultArn(BackupVaultArnT&& value) {
  ...
  template <typename RecoveryPointArnT = Aws::String>
  GetRecoveryPointRestoreMetadataResult& WithRecoveryPointArn(RecoveryPointArnT&& value) {
  ...
  void SetRestoreMetadata(RestoreMetadataT&& value) {
    m_restoreMetadataHasBeenSet = true;
    m_restoreMetadata = std::forward<RestoreMetadataT>(value);
  }
  template <typename RestoreMetadataT = Aws::Map<Aws::String, Aws::String>>
  GetRecoveryPointRestoreMetadataResult& WithRestoreMetadata(RestoreMetadataT&& value) {
    SetRestoreMetadata(std::forward<RestoreMetadataT>(value));
    return *this;
  }
  ...
  GetRecoveryPointRestoreMetadataResult& AddRestoreMetadata(RestoreMetadataKeyT&& key, RestoreMetadataValueT&& value) {
    m_restoreMetadataHasBeenSet = true;
    m_restoreMetadata.emplace(std::forward<RestoreMetadataKeyT>(key), std::forward<RestoreMetadataValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceTypeT = Aws::String>
  GetRecoveryPointRestoreMetadataResult& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRecoveryPointRestoreMetadataResult& WithRequestId(RequestIdT&& value) {
