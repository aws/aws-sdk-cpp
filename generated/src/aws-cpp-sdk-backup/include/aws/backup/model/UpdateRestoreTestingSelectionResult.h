...
class UpdateRestoreTestingSelectionResult {
 public:
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  UpdateRestoreTestingSelectionResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename RestoreTestingPlanArnT = Aws::String>
  UpdateRestoreTestingSelectionResult& WithRestoreTestingPlanArn(RestoreTestingPlanArnT&& value) {
  ...
  template <typename RestoreTestingPlanNameT = Aws::String>
  UpdateRestoreTestingSelectionResult& WithRestoreTestingPlanName(RestoreTestingPlanNameT&& value) {
  ...
  template <typename RestoreTestingSelectionNameT = Aws::String>
  UpdateRestoreTestingSelectionResult& WithRestoreTestingSelectionName(RestoreTestingSelectionNameT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  UpdateRestoreTestingSelectionResult& WithUpdateTime(UpdateTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRestoreTestingSelectionResult& WithRequestId(RequestIdT&& value) {
