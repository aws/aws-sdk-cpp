...
class ListProtectedResourcesByBackupVaultResult {
 public:
  ...
  AWS_BACKUP_API ListProtectedResourcesByBackupVaultResult& operator=(
  ...
  template <typename ResultsT = Aws::Vector<ProtectedResource>>
  ListProtectedResourcesByBackupVaultResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = ProtectedResource>
  ListProtectedResourcesByBackupVaultResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListProtectedResourcesByBackupVaultResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProtectedResourcesByBackupVaultResult& WithRequestId(RequestIdT&& value) {
