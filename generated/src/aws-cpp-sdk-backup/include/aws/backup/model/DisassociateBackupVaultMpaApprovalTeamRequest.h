...
class DisassociateBackupVaultMpaApprovalTeamRequest : public BackupRequest {
 public:
  ...
  template <typename BackupVaultNameT = Aws::String>
  DisassociateBackupVaultMpaApprovalTeamRequest& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename RequesterCommentT = Aws::String>
  DisassociateBackupVaultMpaApprovalTeamRequest& WithRequesterComment(RequesterCommentT&& value) {
