...
namespace Backup {
namespace Model {
class ListBackupAccessPointsResult {
 public:
  AWS_BACKUP_API ListBackupAccessPointsResult() = default;
  AWS_BACKUP_API ListBackupAccessPointsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BACKUP_API ListBackupAccessPointsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename BackupAccessPointsT = Aws::Vector<ListAccessPointsMember>>
  ListBackupAccessPointsResult& WithBackupAccessPoints(BackupAccessPointsT&& value) {
    SetBackupAccessPoints(std::forward<BackupAccessPointsT>(value));
    return *this;
  }
  template <typename BackupAccessPointsT = ListAccessPointsMember>
  ListBackupAccessPointsResult& AddBackupAccessPoints(BackupAccessPointsT&& value) {
    m_backupAccessPointsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBackupAccessPointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBackupAccessPointsResult& WithRequestId(RequestIdT&& value) {
