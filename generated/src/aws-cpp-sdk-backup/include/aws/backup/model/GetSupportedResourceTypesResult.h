...
class GetSupportedResourceTypesResult {
 public:
  ...
  template <typename ResourceTypesT = Aws::Vector<Aws::String>>
  GetSupportedResourceTypesResult& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  template <typename ResourceTypesT = Aws::String>
  GetSupportedResourceTypesResult& AddResourceTypes(ResourceTypesT&& value) {
    m_resourceTypesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetSupportedResourceTypesResult& WithRequestId(RequestIdT&& value) {
