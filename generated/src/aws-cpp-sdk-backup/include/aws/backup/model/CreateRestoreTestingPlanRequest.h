...
class CreateRestoreTestingPlanRequest : public BackupRequest {
 public:
  ...
  template <typename CreatorRequestIdT = Aws::String>
  CreateRestoreTestingPlanRequest& WithCreatorRequestId(CreatorRequestIdT&& value) {
  ...
  template <typename RestoreTestingPlanT = RestoreTestingPlanForCreate>
  CreateRestoreTestingPlanRequest& WithRestoreTestingPlan(RestoreTestingPlanT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRestoreTestingPlanRequest& WithTags(TagsT&& value) {
