...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUP_API DeleteBackupVaultNotificationsRequest() = default;
    ...
    template<typename BackupVaultNameT = Aws::String>
    DeleteBackupVaultNotificationsRequest& WithBackupVaultName(BackupVaultNameT&& value) { SetBackupVaultName(std::forward<BackupVaultNameT>(value)); return *this;}
    ///@}
  private:
