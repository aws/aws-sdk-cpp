...
class RestoreJobsListMember {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  RestoreJobsListMember& WithAccountId(AccountIdT&& value) {
  ...
  template <typename RestoreJobIdT = Aws::String>
  RestoreJobsListMember& WithRestoreJobId(RestoreJobIdT&& value) {
  ...
  template <typename RecoveryPointArnT = Aws::String>
  RestoreJobsListMember& WithRecoveryPointArn(RecoveryPointArnT&& value) {
  ...
  template <typename SourceResourceArnT = Aws::String>
  RestoreJobsListMember& WithSourceResourceArn(SourceResourceArnT&& value) {
  ...
  template <typename BackupVaultArnT = Aws::String>
  RestoreJobsListMember& WithBackupVaultArn(BackupVaultArnT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  RestoreJobsListMember& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename CompletionDateT = Aws::Utils::DateTime>
  RestoreJobsListMember& WithCompletionDate(CompletionDateT&& value) {
  ...
  inline void SetStatus(RestoreJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline RestoreJobsListMember& WithStatus(RestoreJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  RestoreJobsListMember& WithStatusMessage(StatusMessageT&& value) {
  ...
  void SetPercentDone(PercentDoneT&& value) {
    ...
    m_percentDone = std::forward<PercentDoneT>(value);
  }
  template <typename PercentDoneT = Aws::String>
  RestoreJobsListMember& WithPercentDone(PercentDoneT&& value) {
    SetPercentDone(std::forward<PercentDoneT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBackupSizeInBytes(long long value) {
    ...
    m_backupSizeInBytes = value;
  }
  inline RestoreJobsListMember& WithBackupSizeInBytes(long long value) {
    SetBackupSizeInBytes(value);
    return *this;
  }
  ///@}
  ...
  template <typename IamRoleArnT = Aws::String>
  RestoreJobsListMember& WithIamRoleArn(IamRoleArnT&& value) {
  ...
  inline void SetExpectedCompletionTimeMinutes(long long value) {
    m_expectedCompletionTimeMinutesHasBeenSet = true;
    m_expectedCompletionTimeMinutes = value;
  }
  inline RestoreJobsListMember& WithExpectedCompletionTimeMinutes(long long value) {
    SetExpectedCompletionTimeMinutes(value);
    return *this;
  }
  ///@}
  ...
  void SetCreatedResourceArn(CreatedResourceArnT&& value) {
    ...
    m_createdResourceArn = std::forward<CreatedResourceArnT>(value);
  }
  template <typename CreatedResourceArnT = Aws::String>
  RestoreJobsListMember& WithCreatedResourceArn(CreatedResourceArnT&& value) {
    SetCreatedResourceArn(std::forward<CreatedResourceArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceTypeT = Aws::String>
  RestoreJobsListMember& WithResourceType(ResourceTypeT&& value) {
  ...
  void SetRecoveryPointCreationDate(RecoveryPointCreationDateT&& value) {
    ...
    m_recoveryPointCreationDate = std::forward<RecoveryPointCreationDateT>(value);
  }
  template <typename RecoveryPointCreationDateT = Aws::Utils::DateTime>
  RestoreJobsListMember& WithRecoveryPointCreationDate(RecoveryPointCreationDateT&& value) {
    SetRecoveryPointCreationDate(std::forward<RecoveryPointCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedByT = RestoreJobCreator>
  RestoreJobsListMember& WithCreatedBy(CreatedByT&& value) {
  ...
  inline void SetValidationStatus(RestoreValidationStatus value) {
    m_validationStatusHasBeenSet = true;
    m_validationStatus = value;
  }
  inline RestoreJobsListMember& WithValidationStatus(RestoreValidationStatus value) {
  ...
  void SetValidationStatusMessage(ValidationStatusMessageT&& value) {
    ...
    m_validationStatusMessage = std::forward<ValidationStatusMessageT>(value);
  }
  template <typename ValidationStatusMessageT = Aws::String>
  RestoreJobsListMember& WithValidationStatusMessage(ValidationStatusMessageT&& value) {
    SetValidationStatusMessage(std::forward<ValidationStatusMessageT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDeletionStatus(RestoreDeletionStatus value) {
    m_deletionStatusHasBeenSet = true;
    m_deletionStatus = value;
  }
  inline RestoreJobsListMember& WithDeletionStatus(RestoreDeletionStatus value) {
  ...
  void SetDeletionStatusMessage(DeletionStatusMessageT&& value) {
    ...
    m_deletionStatusMessage = std::forward<DeletionStatusMessageT>(value);
  }
  template <typename DeletionStatusMessageT = Aws::String>
  RestoreJobsListMember& WithDeletionStatusMessage(DeletionStatusMessageT&& value) {
    SetDeletionStatusMessage(std::forward<DeletionStatusMessageT>(value));
    return *this;
  }
  ///@}
 private:
