...
class RecoveryPointMember {
 public:
  AWS_BACKUP_API RecoveryPointMember() = default;
  ...
  template <typename RecoveryPointArnT = Aws::String>
  RecoveryPointMember& WithRecoveryPointArn(RecoveryPointArnT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  RecoveryPointMember& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  RecoveryPointMember& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename BackupVaultNameT = Aws::String>
  RecoveryPointMember& WithBackupVaultName(BackupVaultNameT&& value) {
