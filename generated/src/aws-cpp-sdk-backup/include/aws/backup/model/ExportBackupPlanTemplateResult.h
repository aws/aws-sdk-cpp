...
class ExportBackupPlanTemplateResult {
 public:
  ...
  void SetBackupPlanTemplateJson(BackupPlanTemplateJsonT&& value) {
    m_backupPlanTemplateJsonHasBeenSet = true;
    m_backupPlanTemplateJson = std::forward<BackupPlanTemplateJsonT>(value);
  }
  template <typename BackupPlanTemplateJsonT = Aws::String>
  ExportBackupPlanTemplateResult& WithBackupPlanTemplateJson(BackupPlanTemplateJsonT&& value) {
    SetBackupPlanTemplateJson(std::forward<BackupPlanTemplateJsonT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ExportBackupPlanTemplateResult& WithRequestId(RequestIdT&& value) {
