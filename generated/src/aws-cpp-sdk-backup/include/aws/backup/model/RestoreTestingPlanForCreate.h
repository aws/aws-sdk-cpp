...
class RestoreTestingPlanForCreate {
 public:
  ...
  template <typename RecoveryPointSelectionT = RestoreTestingRecoveryPointSelection>
  RestoreTestingPlanForCreate& WithRecoveryPointSelection(RecoveryPointSelectionT&& value) {
  ...
  template <typename RestoreTestingPlanNameT = Aws::String>
  RestoreTestingPlanForCreate& WithRestoreTestingPlanName(RestoreTestingPlanNameT&& value) {
  ...
  template <typename ScheduleExpressionT = Aws::String>
  RestoreTestingPlanForCreate& WithScheduleExpression(ScheduleExpressionT&& value) {
  ...
  template <typename ScheduleExpressionTimezoneT = Aws::String>
  RestoreTestingPlanForCreate& WithScheduleExpressionTimezone(ScheduleExpressionTimezoneT&& value) {
  ...
  inline RestoreTestingPlanForCreate& WithStartWindowHours(int value) {
