...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUP_API GetRestoreTestingInferredMetadataRequest();
     ...
     * <p>This is the account ID of the specified backup vault.</p>
     */
    inline GetRestoreTestingInferredMetadataRequest& WithBackupVaultAccountId(const Aws::String& value) { SetBackupVaultAccountId(value); return *this;}

    /**
     * <p>This is the account ID of the specified backup vault.</p>
     */
    inline GetRestoreTestingInferredMetadataRequest& WithBackupVaultAccountId(Aws::String&& value) { SetBackupVaultAccountId(std::move(value)); return *this;}

    /**
     * <p>This is the account ID of the specified backup vault.</p>
     */
    inline GetRestoreTestingInferredMetadataRequest& WithBackupVaultAccountId(const char* value) { SetBackupVaultAccountId(value); return *this;}
     ...
     * numbers, and hyphens.</p>
     */
    inline GetRestoreTestingInferredMetadataRequest& WithBackupVaultName(const Aws::String& value) { SetBackupVaultName(value); return *this;}
     ...
     * numbers, and hyphens.</p>
     */
    inline GetRestoreTestingInferredMetadataRequest& WithBackupVaultName(Aws::String&& value) { SetBackupVaultName(std::move(value)); return *this;}
     ...
     * numbers, and hyphens.</p>
     */
    inline GetRestoreTestingInferredMetadataRequest& WithBackupVaultName(const char* value) { SetBackupVaultName(value); return *this;}
     ...
     * </p>
     */
    inline GetRestoreTestingInferredMetadataRequest& WithRecoveryPointArn(const Aws::String& value) { SetRecoveryPointArn(value); return *this;}
     ...
     * </p>
     */
    inline GetRestoreTestingInferredMetadataRequest& WithRecoveryPointArn(Aws::String&& value) { SetRecoveryPointArn(std::move(value)); return *this;}
     ...
     * </p>
     */
    inline GetRestoreTestingInferredMetadataRequest& WithRecoveryPointArn(const char* value) { SetRecoveryPointArn(value); return *this;}
