...
class GetRestoreTestingInferredMetadataRequest : public BackupRequest {
 public:
  ...
  template <typename BackupVaultAccountIdT = Aws::String>
  GetRestoreTestingInferredMetadataRequest& WithBackupVaultAccountId(BackupVaultAccountIdT&& value) {
  ...
  template <typename BackupVaultNameT = Aws::String>
  GetRestoreTestingInferredMetadataRequest& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename RecoveryPointArnT = Aws::String>
  GetRestoreTestingInferredMetadataRequest& WithRecoveryPointArn(RecoveryPointArnT&& value) {
