...
class AssociateBackupVaultMpaApprovalTeamRequest : public BackupRequest {
 public:
  ...
  template <typename BackupVaultNameT = Aws::String>
  AssociateBackupVaultMpaApprovalTeamRequest& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename MpaApprovalTeamArnT = Aws::String>
  AssociateBackupVaultMpaApprovalTeamRequest& WithMpaApprovalTeamArn(MpaApprovalTeamArnT&& value) {
  ...
  template <typename RequesterCommentT = Aws::String>
  AssociateBackupVaultMpaApprovalTeamRequest& WithRequesterComment(RequesterCommentT&& value) {
