...
namespace Model
{
  ...
  public:
    ...
    template<typename CodeT = Aws::String>
    InvalidResourceStateException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    InvalidResourceStateException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename TypeT = Aws::String>
    InvalidResourceStateException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename ContextT = Aws::String>
    InvalidResourceStateException& WithContext(ContextT&& value) { SetContext(std::forward<ContextT>(value)); return *this;}
    ///@}
  private:
