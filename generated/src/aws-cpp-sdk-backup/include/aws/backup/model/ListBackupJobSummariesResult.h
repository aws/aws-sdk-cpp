...
class ListBackupJobSummariesResult {
 public:
  ...
  void SetBackupJobSummaries(BackupJobSummariesT&& value) {
    m_backupJobSummariesHasBeenSet = true;
    m_backupJobSummaries = std::forward<BackupJobSummariesT>(value);
  }
  template <typename BackupJobSummariesT = Aws::Vector<BackupJobSummary>>
  ListBackupJobSummariesResult& WithBackupJobSummaries(BackupJobSummariesT&& value) {
    SetBackupJobSummaries(std::forward<BackupJobSummariesT>(value));
    return *this;
  }
  template <typename BackupJobSummariesT = BackupJobSummary>
  ListBackupJobSummariesResult& AddBackupJobSummaries(BackupJobSummariesT&& value) {
    m_backupJobSummariesHasBeenSet = true;
    m_backupJobSummaries.emplace_back(std::forward<BackupJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AggregationPeriodT = Aws::String>
  ListBackupJobSummariesResult& WithAggregationPeriod(AggregationPeriodT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListBackupJobSummariesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBackupJobSummariesResult& WithRequestId(RequestIdT&& value) {
