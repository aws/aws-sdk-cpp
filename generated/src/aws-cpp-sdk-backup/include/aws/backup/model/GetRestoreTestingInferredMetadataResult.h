...
class GetRestoreTestingInferredMetadataResult {
 public:
  ...
  void SetInferredMetadata(InferredMetadataT&& value) {
    m_inferredMetadataHasBeenSet = true;
    m_inferredMetadata = std::forward<InferredMetadataT>(value);
  }
  template <typename InferredMetadataT = Aws::Map<Aws::String, Aws::String>>
  GetRestoreTestingInferredMetadataResult& WithInferredMetadata(InferredMetadataT&& value) {
    SetInferredMetadata(std::forward<InferredMetadataT>(value));
    return *this;
  }
  ...
  GetRestoreTestingInferredMetadataResult& AddInferredMetadata(InferredMetadataKeyT&& key, InferredMetadataValueT&& value) {
    m_inferredMetadataHasBeenSet = true;
    m_inferredMetadata.emplace(std::forward<InferredMetadataKeyT>(key), std::forward<InferredMetadataValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetRestoreTestingInferredMetadataResult& WithRequestId(RequestIdT&& value) {
