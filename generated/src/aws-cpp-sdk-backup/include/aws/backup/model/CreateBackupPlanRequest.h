...
class CreateBackupPlanRequest : public BackupRequest {
 public:
  ...
  void SetBackupPlanTags(BackupPlanTagsT&& value) {
    m_backupPlanTagsHasBeenSet = true;
    m_backupPlanTags = std::forward<BackupPlanTagsT>(value);
  }
  template <typename BackupPlanTagsT = Aws::Map<Aws::String, Aws::String>>
  CreateBackupPlanRequest& WithBackupPlanTags(BackupPlanTagsT&& value) {
    SetBackupPlanTags(std::forward<BackupPlanTagsT>(value));
    return *this;
  }
  ...
  CreateBackupPlanRequest& AddBackupPlanTags(BackupPlanTagsKeyT&& key, BackupPlanTagsValueT&& value) {
    m_backupPlanTagsHasBeenSet = true;
    m_backupPlanTags.emplace(std::forward<BackupPlanTagsKeyT>(key), std::forward<BackupPlanTagsValueT>(value));
    return *this;
  }
  ///@}
