...
class BackupRuleInput {
 public:
  ...
  void SetTargetBackupVaultName(TargetBackupVaultNameT&& value) {
    ...
    m_targetBackupVaultName = std::forward<TargetBackupVaultNameT>(value);
  }
  template <typename TargetBackupVaultNameT = Aws::String>
  BackupRuleInput& WithTargetBackupVaultName(TargetBackupVaultNameT&& value) {
    SetTargetBackupVaultName(std::forward<TargetBackupVaultNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStartWindowMinutes(long long value) {
    m_startWindowMinutesHasBeenSet = true;
    m_startWindowMinutes = value;
  }
  inline BackupRuleInput& WithStartWindowMinutes(long long value) {
    SetStartWindowMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCompletionWindowMinutes(long long value) {
    m_completionWindowMinutesHasBeenSet = true;
    m_completionWindowMinutes = value;
  }
  inline BackupRuleInput& WithCompletionWindowMinutes(long long value) {
    SetCompletionWindowMinutes(value);
    return *this;
  }
  ///@}
  ...
  void SetRecoveryPointTags(RecoveryPointTagsT&& value) {
    ...
    m_recoveryPointTags = std::forward<RecoveryPointTagsT>(value);
  }
  template <typename RecoveryPointTagsT = Aws::Map<Aws::String, Aws::String>>
  BackupRuleInput& WithRecoveryPointTags(RecoveryPointTagsT&& value) {
    SetRecoveryPointTags(std::forward<RecoveryPointTagsT>(value));
    return *this;
  }
  ...
  BackupRuleInput& AddRecoveryPointTags(RecoveryPointTagsKeyT&& key, RecoveryPointTagsValueT&& value) {
    m_recoveryPointTagsHasBeenSet = true;
    m_recoveryPointTags.emplace(std::forward<RecoveryPointTagsKeyT>(key), std::forward<RecoveryPointTagsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopyActions(CopyActionsT&& value) {
    ...
    m_copyActions = std::forward<CopyActionsT>(value);
  }
  template <typename CopyActionsT = Aws::Vector<CopyAction>>
  BackupRuleInput& WithCopyActions(CopyActionsT&& value) {
    SetCopyActions(std::forward<CopyActionsT>(value));
    return *this;
  }
  template <typename CopyActionsT = CopyAction>
  BackupRuleInput& AddCopyActions(CopyActionsT&& value) {
    m_copyActionsHasBeenSet = true;
    m_copyActions.emplace_back(std::forward<CopyActionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEnableContinuousBackup(bool value) {
    m_enableContinuousBackupHasBeenSet = true;
    m_enableContinuousBackup = value;
  }
  inline BackupRuleInput& WithEnableContinuousBackup(bool value) {
    SetEnableContinuousBackup(value);
    return *this;
  }
  ///@}
  ...
  void SetIndexActions(IndexActionsT&& value) {
    ...
    m_indexActions = std::forward<IndexActionsT>(value);
  }
  template <typename IndexActionsT = Aws::Vector<IndexAction>>
  BackupRuleInput& WithIndexActions(IndexActionsT&& value) {
    SetIndexActions(std::forward<IndexActionsT>(value));
    return *this;
  }
  template <typename IndexActionsT = IndexAction>
  BackupRuleInput& AddIndexActions(IndexActionsT&& value) {
    m_indexActionsHasBeenSet = true;
    m_indexActions.emplace_back(std::forward<IndexActionsT>(value));
    return *this;
  }
  ///@}
 private:
