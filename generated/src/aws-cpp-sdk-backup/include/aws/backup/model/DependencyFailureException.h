...
class DependencyFailureException {
 public:
  ...
  template <typename CodeT = Aws::String>
  DependencyFailureException& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  DependencyFailureException& WithMessage(MessageT&& value) {
  ...
  template <typename TypeT = Aws::String>
  DependencyFailureException& WithType(TypeT&& value) {
  ...
  template <typename ContextT = Aws::String>
  DependencyFailureException& WithContext(ContextT&& value) {
