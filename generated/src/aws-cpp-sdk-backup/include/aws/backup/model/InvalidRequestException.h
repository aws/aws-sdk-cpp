...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUP_API InvalidRequestException() = default;
    ...
    template<typename TypeT = Aws::String>
    InvalidRequestException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename ContextT = Aws::String>
    InvalidRequestException& WithContext(ContextT&& value) { SetContext(std::forward<ContextT>(value)); return *this;}
    ///@}
  private:
