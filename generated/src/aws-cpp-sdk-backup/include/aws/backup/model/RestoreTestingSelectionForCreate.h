...
class RestoreTestingSelectionForCreate {
 public:
  ...
  template <typename IamRoleArnT = Aws::String>
  RestoreTestingSelectionForCreate& WithIamRoleArn(IamRoleArnT&& value) {
  ...
  template <typename ProtectedResourceArnsT = Aws::Vector<Aws::String>>
  RestoreTestingSelectionForCreate& WithProtectedResourceArns(ProtectedResourceArnsT&& value) {
    SetProtectedResourceArns(std::forward<ProtectedResourceArnsT>(value));
    return *this;
  }
  template <typename ProtectedResourceArnsT = Aws::String>
  RestoreTestingSelectionForCreate& AddProtectedResourceArns(ProtectedResourceArnsT&& value) {
    m_protectedResourceArnsHasBeenSet = true;
  ...
  template <typename ProtectedResourceConditionsT = ProtectedResourceConditions>
  RestoreTestingSelectionForCreate& WithProtectedResourceConditions(ProtectedResourceConditionsT&& value) {
  ...
  template <typename ProtectedResourceTypeT = Aws::String>
  RestoreTestingSelectionForCreate& WithProtectedResourceType(ProtectedResourceTypeT&& value) {
  ...
  template <typename RestoreMetadataOverridesT = Aws::Map<Aws::String, Aws::String>>
  RestoreTestingSelectionForCreate& WithRestoreMetadataOverrides(RestoreMetadataOverridesT&& value) {
  ...
  RestoreTestingSelectionForCreate& AddRestoreMetadataOverrides(RestoreMetadataOverridesKeyT&& key,
                                                                RestoreMetadataOverridesValueT&& value) {
    m_restoreMetadataOverridesHasBeenSet = true;
  ...
  template <typename RestoreTestingSelectionNameT = Aws::String>
  RestoreTestingSelectionForCreate& WithRestoreTestingSelectionName(RestoreTestingSelectionNameT&& value) {
  ...
  inline RestoreTestingSelectionForCreate& WithValidationWindowHours(int value) {
