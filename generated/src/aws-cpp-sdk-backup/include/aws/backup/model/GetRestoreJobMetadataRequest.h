...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUP_API GetRestoreJobMetadataRequest() = default;
    ...
    template<typename RestoreJobIdT = Aws::String>
    GetRestoreJobMetadataRequest& WithRestoreJobId(RestoreJobIdT&& value) { SetRestoreJobId(std::forward<RestoreJobIdT>(value)); return *this;}
    ///@}
  private:
