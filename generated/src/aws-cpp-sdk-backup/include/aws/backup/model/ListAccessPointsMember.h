...
/**
 * <p>Contains metadata about a backup access point.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListAccessPointsMember">AWS
 * API Reference</a></p>
 */
class ListAccessPointsMember {
 public:
  AWS_BACKUP_API ListAccessPointsMember() = default;
  AWS_BACKUP_API ListAccessPointsMember(Aws::Utils::Json::JsonView jsonValue);
  AWS_BACKUP_API ListAccessPointsMember& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AccessPointArnT = Aws::String>
  ListAccessPointsMember& WithAccessPointArn(AccessPointArnT&& value) {
  ...
  template <typename AccessPointMetadataT = Aws::Map<Aws::String, Aws::String>>
  ListAccessPointsMember& WithAccessPointMetadata(AccessPointMetadataT&& value) {
  ...
  ListAccessPointsMember& AddAccessPointMetadata(AccessPointMetadataKeyT&& key, AccessPointMetadataValueT&& value) {
    m_accessPointMetadataHasBeenSet = true;
  ...
  template <typename BackupVaultArnT = Aws::String>
  ListAccessPointsMember& WithBackupVaultArn(BackupVaultArnT&& value) {
  ...
  template <typename BackupVaultNameT = Aws::String>
  ListAccessPointsMember& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ListAccessPointsMember& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListAccessPointsMember& WithName(NameT&& value) {
  ...
  template <typename RecoveryPointArnT = Aws::String>
  ListAccessPointsMember& WithRecoveryPointArn(RecoveryPointArnT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  ListAccessPointsMember& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  ListAccessPointsMember& WithResourceType(ResourceTypeT&& value) {
  ...
  inline ListAccessPointsMember& WithStatus(AccessPointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  ListAccessPointsMember& WithStatusMessage(StatusMessageT&& value) {
