...
class ListReportPlansResult {
 public:
  ...
  void SetReportPlans(ReportPlansT&& value) {
    m_reportPlansHasBeenSet = true;
    m_reportPlans = std::forward<ReportPlansT>(value);
  }
  template <typename ReportPlansT = Aws::Vector<ReportPlan>>
  ListReportPlansResult& WithReportPlans(ReportPlansT&& value) {
    SetReportPlans(std::forward<ReportPlansT>(value));
    return *this;
  }
  template <typename ReportPlansT = ReportPlan>
  ListReportPlansResult& AddReportPlans(ReportPlansT&& value) {
    m_reportPlansHasBeenSet = true;
    m_reportPlans.emplace_back(std::forward<ReportPlansT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReportPlansResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListReportPlansResult& WithRequestId(RequestIdT&& value) {
