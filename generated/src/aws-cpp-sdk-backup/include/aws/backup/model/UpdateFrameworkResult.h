...
class UpdateFrameworkResult {
 public:
  ...
  template <typename FrameworkNameT = Aws::String>
  UpdateFrameworkResult& WithFrameworkName(FrameworkNameT&& value) {
  ...
  template <typename FrameworkArnT = Aws::String>
  UpdateFrameworkResult& WithFrameworkArn(FrameworkArnT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  UpdateFrameworkResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFrameworkResult& WithRequestId(RequestIdT&& value) {
