...
class ListReportJobsResult {
 public:
  ...
  void SetReportJobs(ReportJobsT&& value) {
    m_reportJobsHasBeenSet = true;
    m_reportJobs = std::forward<ReportJobsT>(value);
  }
  template <typename ReportJobsT = Aws::Vector<ReportJob>>
  ListReportJobsResult& WithReportJobs(ReportJobsT&& value) {
    SetReportJobs(std::forward<ReportJobsT>(value));
    return *this;
  }
  template <typename ReportJobsT = ReportJob>
  ListReportJobsResult& AddReportJobs(ReportJobsT&& value) {
    m_reportJobsHasBeenSet = true;
    m_reportJobs.emplace_back(std::forward<ReportJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListReportJobsResult& WithRequestId(RequestIdT&& value) {
