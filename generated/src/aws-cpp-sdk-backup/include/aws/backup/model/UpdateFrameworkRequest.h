...
class UpdateFrameworkRequest : public BackupRequest {
 public:
  ...
  template <typename FrameworkNameT = Aws::String>
  UpdateFrameworkRequest& WithFrameworkName(FrameworkNameT&& value) {
  ...
  template <typename FrameworkDescriptionT = Aws::String>
  UpdateFrameworkRequest& WithFrameworkDescription(FrameworkDescriptionT&& value) {
  ...
  template <typename FrameworkControlsT = Aws::Vector<FrameworkControl>>
  UpdateFrameworkRequest& WithFrameworkControls(FrameworkControlsT&& value) {
    SetFrameworkControls(std::forward<FrameworkControlsT>(value));
    return *this;
  }
  template <typename FrameworkControlsT = FrameworkControl>
  UpdateFrameworkRequest& AddFrameworkControls(FrameworkControlsT&& value) {
    m_frameworkControlsHasBeenSet = true;
  ...
  template <typename IdempotencyTokenT = Aws::String>
  UpdateFrameworkRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
