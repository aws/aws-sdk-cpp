...
class CreateRestoreTestingSelectionRequest : public BackupRequest {
 public:
  ...
  template <typename CreatorRequestIdT = Aws::String>
  CreateRestoreTestingSelectionRequest& WithCreatorRequestId(CreatorRequestIdT&& value) {
  ...
  template <typename RestoreTestingPlanNameT = Aws::String>
  CreateRestoreTestingSelectionRequest& WithRestoreTestingPlanName(RestoreTestingPlanNameT&& value) {
  ...
  template <typename RestoreTestingSelectionT = RestoreTestingSelectionForCreate>
  CreateRestoreTestingSelectionRequest& WithRestoreTestingSelection(RestoreTestingSelectionT&& value) {
