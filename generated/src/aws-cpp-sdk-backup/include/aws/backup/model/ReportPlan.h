...
class ReportPlan {
 public:
  ...
  void SetLastAttemptedExecutionTime(LastAttemptedExecutionTimeT&& value) {
    ...
    m_lastAttemptedExecutionTime = std::forward<LastAttemptedExecutionTimeT>(value);
  }
  template <typename LastAttemptedExecutionTimeT = Aws::Utils::DateTime>
  ReportPlan& WithLastAttemptedExecutionTime(LastAttemptedExecutionTimeT&& value) {
    SetLastAttemptedExecutionTime(std::forward<LastAttemptedExecutionTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastSuccessfulExecutionTime(LastSuccessfulExecutionTimeT&& value) {
    ...
    m_lastSuccessfulExecutionTime = std::forward<LastSuccessfulExecutionTimeT>(value);
  }
  template <typename LastSuccessfulExecutionTimeT = Aws::Utils::DateTime>
  ReportPlan& WithLastSuccessfulExecutionTime(LastSuccessfulExecutionTimeT&& value) {
    SetLastSuccessfulExecutionTime(std::forward<LastSuccessfulExecutionTimeT>(value));
    return *this;
  }
  ///@}
 private:
