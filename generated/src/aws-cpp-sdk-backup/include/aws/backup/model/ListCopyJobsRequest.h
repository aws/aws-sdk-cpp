...
class ListCopyJobsRequest : public BackupRequest {
 public:
  ...
  inline ListCopyJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetByState(CopyJobState value) {
    m_byStateHasBeenSet = true;
    m_byState = value;
  }
  inline ListCopyJobsRequest& WithByState(CopyJobState value) {
    SetByState(value);
    return *this;
  }
  ///@}
  ...
  void SetByDestinationVaultArn(ByDestinationVaultArnT&& value) {
    m_byDestinationVaultArnHasBeenSet = true;
    m_byDestinationVaultArn = std::forward<ByDestinationVaultArnT>(value);
  }
  template <typename ByDestinationVaultArnT = Aws::String>
  ListCopyJobsRequest& WithByDestinationVaultArn(ByDestinationVaultArnT&& value) {
    SetByDestinationVaultArn(std::forward<ByDestinationVaultArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetByMessageCategory(ByMessageCategoryT&& value) {
    m_byMessageCategoryHasBeenSet = true;
    m_byMessageCategory = std::forward<ByMessageCategoryT>(value);
  }
  template <typename ByMessageCategoryT = Aws::String>
  ListCopyJobsRequest& WithByMessageCategory(ByMessageCategoryT&& value) {
    SetByMessageCategory(std::forward<ByMessageCategoryT>(value));
    return *this;
  }
  ///@}
