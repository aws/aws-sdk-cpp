...
class ListIndexedRecoveryPointsResult {
 public:
  ...
  void SetIndexedRecoveryPoints(IndexedRecoveryPointsT&& value) {
    m_indexedRecoveryPointsHasBeenSet = true;
    m_indexedRecoveryPoints = std::forward<IndexedRecoveryPointsT>(value);
  }
  template <typename IndexedRecoveryPointsT = Aws::Vector<IndexedRecoveryPoint>>
  ListIndexedRecoveryPointsResult& WithIndexedRecoveryPoints(IndexedRecoveryPointsT&& value) {
    SetIndexedRecoveryPoints(std::forward<IndexedRecoveryPointsT>(value));
    return *this;
  }
  template <typename IndexedRecoveryPointsT = IndexedRecoveryPoint>
  ListIndexedRecoveryPointsResult& AddIndexedRecoveryPoints(IndexedRecoveryPointsT&& value) {
    m_indexedRecoveryPointsHasBeenSet = true;
    m_indexedRecoveryPoints.emplace_back(std::forward<IndexedRecoveryPointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIndexedRecoveryPointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIndexedRecoveryPointsResult& WithRequestId(RequestIdT&& value) {
