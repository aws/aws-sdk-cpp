...
class ListProtectedResourcesResult {
 public:
  AWS_BACKUP_API ListProtectedResourcesResult() = default;
  ...
  template <typename ResultsT = Aws::Vector<ProtectedResource>>
  ListProtectedResourcesResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = ProtectedResource>
  ListProtectedResourcesResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListProtectedResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProtectedResourcesResult& WithRequestId(RequestIdT&& value) {
