...
namespace Model
{
  ...
  /**
   */
  class ListBackupSelectionsRequest : public BackupRequest
  {
  public:
    ...
    template<typename BackupPlanIdT = Aws::String>
    ListBackupSelectionsRequest& WithBackupPlanId(BackupPlanIdT&& value) { SetBackupPlanId(std::forward<BackupPlanIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListBackupSelectionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
