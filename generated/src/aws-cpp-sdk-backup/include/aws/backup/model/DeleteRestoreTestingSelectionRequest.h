...
class DeleteRestoreTestingSelectionRequest : public BackupRequest {
 public:
  ...
  template <typename RestoreTestingPlanNameT = Aws::String>
  DeleteRestoreTestingSelectionRequest& WithRestoreTestingPlanName(RestoreTestingPlanNameT&& value) {
  ...
  template <typename RestoreTestingSelectionNameT = Aws::String>
  DeleteRestoreTestingSelectionRequest& WithRestoreTestingSelectionName(RestoreTestingSelectionNameT&& value) {
