...
class ListRestoreAccessBackupVaultsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListRestoreAccessBackupVaultsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetRestoreAccessBackupVaults(RestoreAccessBackupVaultsT&& value) {
    m_restoreAccessBackupVaultsHasBeenSet = true;
    m_restoreAccessBackupVaults = std::forward<RestoreAccessBackupVaultsT>(value);
  }
  template <typename RestoreAccessBackupVaultsT = Aws::Vector<RestoreAccessBackupVaultListMember>>
  ListRestoreAccessBackupVaultsResult& WithRestoreAccessBackupVaults(RestoreAccessBackupVaultsT&& value) {
    SetRestoreAccessBackupVaults(std::forward<RestoreAccessBackupVaultsT>(value));
    return *this;
  }
  template <typename RestoreAccessBackupVaultsT = RestoreAccessBackupVaultListMember>
  ListRestoreAccessBackupVaultsResult& AddRestoreAccessBackupVaults(RestoreAccessBackupVaultsT&& value) {
    m_restoreAccessBackupVaultsHasBeenSet = true;
    m_restoreAccessBackupVaults.emplace_back(std::forward<RestoreAccessBackupVaultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListRestoreAccessBackupVaultsResult& WithRequestId(RequestIdT&& value) {
