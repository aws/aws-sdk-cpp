...
class ListBackupPlansRequest : public BackupRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListBackupPlansRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBackupPlansRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListBackupPlansRequest& WithIncludeDeleted(bool value) {
