...
class RecoveryPointByBackupVault {
 public:
  ...
  inline RecoveryPointByBackupVault& WithStatus(RecoveryPointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline RecoveryPointByBackupVault& WithBackupSizeInBytes(long long value) {
  ...
  inline RecoveryPointByBackupVault& WithIsEncrypted(bool value) {
  ...
  inline RecoveryPointByBackupVault& WithIsParent(bool value) {
    SetIsParent(value);
    return *this;
  }
  ///@}
  ...
  inline RecoveryPointByBackupVault& WithVaultType(VaultType value) {
    SetVaultType(value);
    return *this;
  }
  ///@}
  ...
  inline RecoveryPointByBackupVault& WithIndexStatus(IndexStatus value) {
