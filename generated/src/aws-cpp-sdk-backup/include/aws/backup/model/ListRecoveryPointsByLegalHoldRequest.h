...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUP_API ListRecoveryPointsByLegalHoldRequest() = default;
    ...
    template<typename LegalHoldIdT = Aws::String>
    ListRecoveryPointsByLegalHoldRequest& WithLegalHoldId(LegalHoldIdT&& value) { SetLegalHoldId(std::forward<LegalHoldIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListRecoveryPointsByLegalHoldRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
