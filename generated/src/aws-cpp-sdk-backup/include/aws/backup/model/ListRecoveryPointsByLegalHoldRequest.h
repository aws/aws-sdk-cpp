...
class ListRecoveryPointsByLegalHoldRequest : public BackupRequest {
 public:
  ...
  template <typename LegalHoldIdT = Aws::String>
  ListRecoveryPointsByLegalHoldRequest& WithLegalHoldId(LegalHoldIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRecoveryPointsByLegalHoldRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRecoveryPointsByLegalHoldRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
