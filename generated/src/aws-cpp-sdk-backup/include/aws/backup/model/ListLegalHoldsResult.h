...
class ListLegalHoldsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListLegalHoldsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetLegalHolds(LegalHoldsT&& value) {
    m_legalHoldsHasBeenSet = true;
    m_legalHolds = std::forward<LegalHoldsT>(value);
  }
  template <typename LegalHoldsT = Aws::Vector<LegalHold>>
  ListLegalHoldsResult& WithLegalHolds(LegalHoldsT&& value) {
    SetLegalHolds(std::forward<LegalHoldsT>(value));
    return *this;
  }
  template <typename LegalHoldsT = LegalHold>
  ListLegalHoldsResult& AddLegalHolds(LegalHoldsT&& value) {
    m_legalHoldsHasBeenSet = true;
    m_legalHolds.emplace_back(std::forward<LegalHoldsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListLegalHoldsResult& WithRequestId(RequestIdT&& value) {
