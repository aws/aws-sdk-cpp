...
class ListRestoreJobSummariesResult {
 public:
  ...
  void SetRestoreJobSummaries(RestoreJobSummariesT&& value) {
    m_restoreJobSummariesHasBeenSet = true;
    m_restoreJobSummaries = std::forward<RestoreJobSummariesT>(value);
  }
  template <typename RestoreJobSummariesT = Aws::Vector<RestoreJobSummary>>
  ListRestoreJobSummariesResult& WithRestoreJobSummaries(RestoreJobSummariesT&& value) {
    SetRestoreJobSummaries(std::forward<RestoreJobSummariesT>(value));
    return *this;
  }
  template <typename RestoreJobSummariesT = RestoreJobSummary>
  ListRestoreJobSummariesResult& AddRestoreJobSummaries(RestoreJobSummariesT&& value) {
    m_restoreJobSummariesHasBeenSet = true;
    m_restoreJobSummaries.emplace_back(std::forward<RestoreJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AggregationPeriodT = Aws::String>
  ListRestoreJobSummariesResult& WithAggregationPeriod(AggregationPeriodT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRestoreJobSummariesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRestoreJobSummariesResult& WithRequestId(RequestIdT&& value) {
