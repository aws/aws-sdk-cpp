...
namespace Model
{
  ...
  public:
    ...
    template<typename SourceResourceArnT = Aws::String>
    DescribeRestoreJobResult& WithSourceResourceArn(SourceResourceArnT&& value) { SetSourceResourceArn(std::forward<SourceResourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename BackupVaultArnT = Aws::String>
    DescribeRestoreJobResult& WithBackupVaultArn(BackupVaultArnT&& value) { SetBackupVaultArn(std::forward<BackupVaultArnT>(value)); return *this;}
    ///@}
