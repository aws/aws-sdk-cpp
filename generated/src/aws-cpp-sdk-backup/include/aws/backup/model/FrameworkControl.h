...
class FrameworkControl {
 public:
  ...
  void SetControlInputParameters(ControlInputParametersT&& value) {
    ...
    m_controlInputParameters = std::forward<ControlInputParametersT>(value);
  }
  template <typename ControlInputParametersT = Aws::Vector<ControlInputParameter>>
  FrameworkControl& WithControlInputParameters(ControlInputParametersT&& value) {
    SetControlInputParameters(std::forward<ControlInputParametersT>(value));
    return *this;
  }
  ...
  FrameworkControl& AddControlInputParameters(ControlInputParametersT&& value) {
    m_controlInputParametersHasBeenSet = true;
    m_controlInputParameters.emplace_back(std::forward<ControlInputParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetControlScope(ControlScopeT&& value) {
    ...
    m_controlScope = std::forward<ControlScopeT>(value);
  }
  template <typename ControlScopeT = ControlScope>
  FrameworkControl& WithControlScope(ControlScopeT&& value) {
    SetControlScope(std::forward<ControlScopeT>(value));
    return *this;
  }
  ///@}
 private:
