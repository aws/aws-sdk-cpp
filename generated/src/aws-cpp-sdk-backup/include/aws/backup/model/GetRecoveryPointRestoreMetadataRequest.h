...
class GetRecoveryPointRestoreMetadataRequest : public BackupRequest {
 public:
  ...
  template <typename BackupVaultNameT = Aws::String>
  GetRecoveryPointRestoreMetadataRequest& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename RecoveryPointArnT = Aws::String>
  GetRecoveryPointRestoreMetadataRequest& WithRecoveryPointArn(RecoveryPointArnT&& value) {
  ...
  template <typename BackupVaultAccountIdT = Aws::String>
  GetRecoveryPointRestoreMetadataRequest& WithBackupVaultAccountId(BackupVaultAccountIdT&& value) {
