...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUP_API ListReportPlansRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListReportPlansRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
