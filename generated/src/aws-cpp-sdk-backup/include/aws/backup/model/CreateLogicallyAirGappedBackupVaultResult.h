...
class CreateLogicallyAirGappedBackupVaultResult {
 public:
  ...
  AWS_BACKUP_API CreateLogicallyAirGappedBackupVaultResult& operator=(
  ...
  template <typename BackupVaultNameT = Aws::String>
  CreateLogicallyAirGappedBackupVaultResult& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename BackupVaultArnT = Aws::String>
  CreateLogicallyAirGappedBackupVaultResult& WithBackupVaultArn(BackupVaultArnT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  CreateLogicallyAirGappedBackupVaultResult& WithCreationDate(CreationDateT&& value) {
  ...
  inline CreateLogicallyAirGappedBackupVaultResult& WithVaultState(VaultState value) {
    SetVaultState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateLogicallyAirGappedBackupVaultResult& WithRequestId(RequestIdT&& value) {
