...
class GetBackupPlanRequest : public BackupRequest {
 public:
  ...
  inline void SetMaxScheduledRunsPreview(int value) {
    m_maxScheduledRunsPreviewHasBeenSet = true;
    m_maxScheduledRunsPreview = value;
  }
  inline GetBackupPlanRequest& WithMaxScheduledRunsPreview(int value) {
    SetMaxScheduledRunsPreview(value);
    return *this;
  }
  ///@}
 private:
