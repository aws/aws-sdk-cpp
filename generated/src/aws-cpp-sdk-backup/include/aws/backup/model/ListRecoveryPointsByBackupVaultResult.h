...
class ListRecoveryPointsByBackupVaultResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListRecoveryPointsByBackupVaultResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RecoveryPointsT = Aws::Vector<RecoveryPointByBackupVault>>
  ListRecoveryPointsByBackupVaultResult& WithRecoveryPoints(RecoveryPointsT&& value) {
    SetRecoveryPoints(std::forward<RecoveryPointsT>(value));
    return *this;
  }
  template <typename RecoveryPointsT = RecoveryPointByBackupVault>
  ListRecoveryPointsByBackupVaultResult& AddRecoveryPoints(RecoveryPointsT&& value) {
    m_recoveryPointsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListRecoveryPointsByBackupVaultResult& WithRequestId(RequestIdT&& value) {
