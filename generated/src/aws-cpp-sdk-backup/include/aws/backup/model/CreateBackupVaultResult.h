...
class CreateBackupVaultResult {
 public:
  ...
  template <typename BackupVaultNameT = Aws::String>
  CreateBackupVaultResult& WithBackupVaultName(BackupVaultNameT&& value) {
  ...
  template <typename BackupVaultArnT = Aws::String>
  CreateBackupVaultResult& WithBackupVaultArn(BackupVaultArnT&& value) {
  ...
  template <typename CreationDateT = Aws::Utils::DateTime>
  CreateBackupVaultResult& WithCreationDate(CreationDateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateBackupVaultResult& WithRequestId(RequestIdT&& value) {
