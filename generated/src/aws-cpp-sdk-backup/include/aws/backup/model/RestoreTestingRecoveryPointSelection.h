...
class RestoreTestingRecoveryPointSelection {
 public:
  ...
  inline void SetAlgorithm(RestoreTestingRecoveryPointSelectionAlgorithm value) {
    m_algorithmHasBeenSet = true;
    m_algorithm = value;
  }
  inline RestoreTestingRecoveryPointSelection& WithAlgorithm(RestoreTestingRecoveryPointSelectionAlgorithm value) {
    SetAlgorithm(value);
    return *this;
  }
  ///@}
  ...
  void SetExcludeVaults(ExcludeVaultsT&& value) {
    m_excludeVaultsHasBeenSet = true;
    m_excludeVaults = std::forward<ExcludeVaultsT>(value);
  }
  template <typename ExcludeVaultsT = Aws::Vector<Aws::String>>
  RestoreTestingRecoveryPointSelection& WithExcludeVaults(ExcludeVaultsT&& value) {
    SetExcludeVaults(std::forward<ExcludeVaultsT>(value));
    return *this;
  }
  template <typename ExcludeVaultsT = Aws::String>
  RestoreTestingRecoveryPointSelection& AddExcludeVaults(ExcludeVaultsT&& value) {
    m_excludeVaultsHasBeenSet = true;
    m_excludeVaults.emplace_back(std::forward<ExcludeVaultsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIncludeVaults(IncludeVaultsT&& value) {
    m_includeVaultsHasBeenSet = true;
    m_includeVaults = std::forward<IncludeVaultsT>(value);
  }
  template <typename IncludeVaultsT = Aws::Vector<Aws::String>>
  RestoreTestingRecoveryPointSelection& WithIncludeVaults(IncludeVaultsT&& value) {
    SetIncludeVaults(std::forward<IncludeVaultsT>(value));
    return *this;
  }
  template <typename IncludeVaultsT = Aws::String>
  RestoreTestingRecoveryPointSelection& AddIncludeVaults(IncludeVaultsT&& value) {
    m_includeVaultsHasBeenSet = true;
    m_includeVaults.emplace_back(std::forward<IncludeVaultsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecoveryPointTypes(RecoveryPointTypesT&& value) {
    m_recoveryPointTypesHasBeenSet = true;
    m_recoveryPointTypes = std::forward<RecoveryPointTypesT>(value);
  }
  template <typename RecoveryPointTypesT = Aws::Vector<RestoreTestingRecoveryPointType>>
  RestoreTestingRecoveryPointSelection& WithRecoveryPointTypes(RecoveryPointTypesT&& value) {
    SetRecoveryPointTypes(std::forward<RecoveryPointTypesT>(value));
    return *this;
  }
  inline RestoreTestingRecoveryPointSelection& AddRecoveryPointTypes(RestoreTestingRecoveryPointType value) {
    m_recoveryPointTypesHasBeenSet = true;
    m_recoveryPointTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSelectionWindowDays(int value) {
    m_selectionWindowDaysHasBeenSet = true;
    m_selectionWindowDays = value;
  }
  inline RestoreTestingRecoveryPointSelection& WithSelectionWindowDays(int value) {
    SetSelectionWindowDays(value);
    return *this;
  }
  ///@}
 private:
