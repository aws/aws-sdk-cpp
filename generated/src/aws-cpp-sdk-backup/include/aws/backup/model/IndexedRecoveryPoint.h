...
class IndexedRecoveryPoint {
 public:
  ...
  void SetBackupCreationDate(BackupCreationDateT&& value) {
    ...
    m_backupCreationDate = std::forward<BackupCreationDateT>(value);
  }
  template <typename BackupCreationDateT = Aws::Utils::DateTime>
  IndexedRecoveryPoint& WithBackupCreationDate(BackupCreationDateT&& value) {
    SetBackupCreationDate(std::forward<BackupCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIndexCreationDate(IndexCreationDateT&& value) {
    ...
    m_indexCreationDate = std::forward<IndexCreationDateT>(value);
  }
  template <typename IndexCreationDateT = Aws::Utils::DateTime>
  IndexedRecoveryPoint& WithIndexCreationDate(IndexCreationDateT&& value) {
    SetIndexCreationDate(std::forward<IndexCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline IndexedRecoveryPoint& WithIndexStatus(IndexStatus value) {
