...
class ListRestoreJobsResult {
 public:
  ...
  template <typename RestoreJobsT = Aws::Vector<RestoreJobsListMember>>
  ListRestoreJobsResult& WithRestoreJobs(RestoreJobsT&& value) {
    SetRestoreJobs(std::forward<RestoreJobsT>(value));
    return *this;
  }
  template <typename RestoreJobsT = RestoreJobsListMember>
  ListRestoreJobsResult& AddRestoreJobs(RestoreJobsT&& value) {
    m_restoreJobsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRestoreJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRestoreJobsResult& WithRequestId(RequestIdT&& value) {
