...
class LatestRevokeRequest {
 public:
  ...
  template <typename MpaSessionArnT = Aws::String>
  LatestRevokeRequest& WithMpaSessionArn(MpaSessionArnT&& value) {
  ...
  inline void SetStatus(MpaRevokeSessionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline LatestRevokeRequest& WithStatus(MpaRevokeSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  LatestRevokeRequest& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename InitiationDateT = Aws::Utils::DateTime>
  LatestRevokeRequest& WithInitiationDate(InitiationDateT&& value) {
  ...
  template <typename ExpiryDateT = Aws::Utils::DateTime>
  LatestRevokeRequest& WithExpiryDate(ExpiryDateT&& value) {
