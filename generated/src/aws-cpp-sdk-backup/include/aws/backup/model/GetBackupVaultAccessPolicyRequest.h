...
namespace Model
{
  ...
  {
  public:
    AWS_BACKUP_API GetBackupVaultAccessPolicyRequest() = default;
    ...
    template<typename BackupVaultNameT = Aws::String>
    GetBackupVaultAccessPolicyRequest& WithBackupVaultName(BackupVaultNameT&& value) { SetBackupVaultName(std::forward<BackupVaultNameT>(value)); return *this;}
    ///@}
  private:
