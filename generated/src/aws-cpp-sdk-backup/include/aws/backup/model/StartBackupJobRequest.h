...
class StartBackupJobRequest : public BackupRequest {
 public:
  ...
  inline StartBackupJobRequest& WithStartWindowMinutes(long long value) {
  ...
  inline void SetCompleteWindowMinutes(long long value) {
    m_completeWindowMinutesHasBeenSet = true;
    m_completeWindowMinutes = value;
  }
  inline StartBackupJobRequest& WithCompleteWindowMinutes(long long value) {
    SetCompleteWindowMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline StartBackupJobRequest& WithIndex(Index value) {
    SetIndex(value);
    return *this;
  }
  ///@}
