...
namespace Model
{
  ...
  public:
    ...
    template<typename RecoveryPointLifecycleT = Lifecycle>
    DescribeBackupJobResult& WithRecoveryPointLifecycle(RecoveryPointLifecycleT&& value) { SetRecoveryPointLifecycle(std::forward<RecoveryPointLifecycleT>(value)); return *this;}
    ///@}
    ...
    template<typename VaultTypeT = Aws::String>
    DescribeBackupJobResult& WithVaultType(VaultTypeT&& value) { SetVaultType(std::forward<VaultTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename VaultLockStateT = Aws::String>
    DescribeBackupJobResult& WithVaultLockState(VaultLockStateT&& value) { SetVaultLockState(std::forward<VaultLockStateT>(value)); return *this;}
    ///@}
    ...
    template<typename EncryptionKeyArnT = Aws::String>
    DescribeBackupJobResult& WithEncryptionKeyArn(EncryptionKeyArnT&& value) { SetEncryptionKeyArn(std::forward<EncryptionKeyArnT>(value)); return *this;}
    ///@}
    ...
    inline DescribeBackupJobResult& WithIsEncrypted(bool value) { SetIsEncrypted(value); return *this;}
    ///@}
