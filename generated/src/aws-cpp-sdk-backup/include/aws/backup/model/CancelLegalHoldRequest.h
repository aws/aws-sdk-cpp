...
class CancelLegalHoldRequest : public BackupRequest {
 public:
  ...
  template <typename LegalHoldIdT = Aws::String>
  CancelLegalHoldRequest& WithLegalHoldId(LegalHoldIdT&& value) {
  ...
  template <typename CancelDescriptionT = Aws::String>
  CancelLegalHoldRequest& WithCancelDescription(CancelDescriptionT&& value) {
  ...
  inline void SetRetainRecordInDays(long long value) {
    m_retainRecordInDaysHasBeenSet = true;
    m_retainRecordInDays = value;
  }
  inline CancelLegalHoldRequest& WithRetainRecordInDays(long long value) {
    SetRetainRecordInDays(value);
    return *this;
  }
  ///@}
 private:
