...
class GetBackupVaultNotificationsResult {
 public:
  ...
  void SetBackupVaultEvents(BackupVaultEventsT&& value) {
    ...
    m_backupVaultEvents = std::forward<BackupVaultEventsT>(value);
  }
  template <typename BackupVaultEventsT = Aws::Vector<BackupVaultEvent>>
  GetBackupVaultNotificationsResult& WithBackupVaultEvents(BackupVaultEventsT&& value) {
    SetBackupVaultEvents(std::forward<BackupVaultEventsT>(value));
    return *this;
  }
  inline GetBackupVaultNotificationsResult& AddBackupVaultEvents(BackupVaultEvent value) {
    m_backupVaultEventsHasBeenSet = true;
    m_backupVaultEvents.push_back(value);
    return *this;
  }
  ///@}
