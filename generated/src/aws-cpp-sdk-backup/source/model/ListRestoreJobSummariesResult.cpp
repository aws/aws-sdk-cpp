...
ListRestoreJobSummariesResult::ListRestoreJobSummariesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListRestoreJobSummariesResult& ListRestoreJobSummariesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("RestoreJobSummaries")) {
    ...
    for (unsigned restoreJobSummariesIndex = 0; restoreJobSummariesIndex < restoreJobSummariesJsonList.GetLength();
         ++restoreJobSummariesIndex) {
