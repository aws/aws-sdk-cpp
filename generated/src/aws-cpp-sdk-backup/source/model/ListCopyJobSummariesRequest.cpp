...
Aws::String ListCopyJobSummariesRequest::SerializePayload() const { return {}; }

void ListCopyJobSummariesRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
  ...
  if (m_stateHasBeenSet) {
    ss << CopyJobStatusMapper::GetNameForCopyJobStatus(m_state);
