...
ListBackupAccessPointsResult::ListBackupAccessPointsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListBackupAccessPointsResult& ListBackupAccessPointsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
