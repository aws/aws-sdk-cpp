...
ListBackupAccessPointsByRecoveryPointResult::ListBackupAccessPointsByRecoveryPointResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListBackupAccessPointsByRecoveryPointResult& ListBackupAccessPointsByRecoveryPointResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
