...
ListRestoreTestingPlansResult::ListRestoreTestingPlansResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListRestoreTestingPlansResult& ListRestoreTestingPlansResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("RestoreTestingPlans")) {
    ...
    for (unsigned restoreTestingPlansIndex = 0; restoreTestingPlansIndex < restoreTestingPlansJsonList.GetLength();
         ++restoreTestingPlansIndex) {
