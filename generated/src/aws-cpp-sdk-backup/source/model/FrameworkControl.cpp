...
FrameworkControl::FrameworkControl(JsonView jsonValue) { *this = jsonValue; }
...
FrameworkControl& FrameworkControl::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ControlInputParameters")) {
    ...
    for (unsigned controlInputParametersIndex = 0; controlInputParametersIndex < controlInputParametersJsonList.GetLength();
         ++controlInputParametersIndex) {
