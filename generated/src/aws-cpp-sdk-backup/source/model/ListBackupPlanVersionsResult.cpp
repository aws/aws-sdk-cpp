...
ListBackupPlanVersionsResult::ListBackupPlanVersionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListBackupPlanVersionsResult& ListBackupPlanVersionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("BackupPlanVersionsList")) {
    ...
    for (unsigned backupPlanVersionsListIndex = 0; backupPlanVersionsListIndex < backupPlanVersionsListJsonList.GetLength();
         ++backupPlanVersionsListIndex) {
