...
RestoreTestingSelectionForUpdate::RestoreTestingSelectionForUpdate(JsonView jsonValue) { *this = jsonValue; }
...
RestoreTestingSelectionForUpdate& RestoreTestingSelectionForUpdate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ProtectedResourceArns")) {
    ...
    for (unsigned protectedResourceArnsIndex = 0; protectedResourceArnsIndex < protectedResourceArnsJsonList.GetLength();
         ++protectedResourceArnsIndex) {
