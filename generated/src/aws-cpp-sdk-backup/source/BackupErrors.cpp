...
template <>
AWS_BACKUP_API InvalidParameterValueException BackupError::GetModeledError() {
...
template <>
AWS_BACKUP_API MissingParameterValueException BackupError::GetModeledError() {
...
template <>
AWS_BACKUP_API InvalidRequestException BackupError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(BackupErrors::LIMIT_EXCEEDED), RetryableType::RETRYABLE_THROTTLING);
