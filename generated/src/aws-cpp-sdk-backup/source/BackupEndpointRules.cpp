...
namespace Backup
{
const size_t BackupEndpointRules::RulesBlobStrLen = 3518;
const size_t BackupEndpointRules::RulesBlobSize = 3519;
...
'k','u','p','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'p','s',':','/','/','b','a','c','k','u','p','-','f','i','p','s','.','{','R','e','g','i','o','n','}',
