...
namespace Backup
{
const size_t BackupEndpointRules::RulesBlobStrLen = 3453;
const size_t BackupEndpointRules::RulesBlobSize = 3454;
...
'a','c','k','u','p','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'p','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u',
...
't','p','s',':','/','/','b','a','c','k','u','p','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
const char* BackupEndpointRules::GetRulesBlob()
{
