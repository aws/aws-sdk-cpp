...
namespace Backup
{
const size_t BackupEndpointRules::RulesBlobStrLen = 3724;
const size_t BackupEndpointRules::RulesBlobSize = 3725;
...
'/','b','a','c','k','u','p','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'l','"',':','"','h','t','t','p','s',':','/','/','b','a','c','k','u','p','.','{','R','e','g','i','o',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','b','a','c','k','u','p','.','{','R','e',
