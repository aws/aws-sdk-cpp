...
CollectionGroupDetail::CollectionGroupDetail(JsonView jsonValue) { *this = jsonValue; }

CollectionGroupDetail& CollectionGroupDetail::operator=(JsonView jsonValue) {
...
JsonValue CollectionGroupDetail::Jsonize() const {
  JsonValue payload;
