...
Aws::String UpdateVpcEndpointRequest::SerializePayload() const {
  ...
  if (m_addSecurityGroupIdsHasBeenSet) {
    ...
    for (unsigned addSecurityGroupIdsIndex = 0; addSecurityGroupIdsIndex < addSecurityGroupIdsJsonList.GetLength();
         ++addSecurityGroupIdsIndex) {
  ...
  if (m_removeSecurityGroupIdsHasBeenSet) {
    ...
    for (unsigned removeSecurityGroupIdsIndex = 0; removeSecurityGroupIdsIndex < removeSecurityGroupIdsJsonList.GetLength();
         ++removeSecurityGroupIdsIndex) {
