...
BatchGetVpcEndpointResult& BatchGetVpcEndpointResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("vpcEndpointDetails")) {
    ...
    for (unsigned vpcEndpointDetailsIndex = 0; vpcEndpointDetailsIndex < vpcEndpointDetailsJsonList.GetLength();
         ++vpcEndpointDetailsIndex) {
  ...
  if (jsonValue.ValueExists("vpcEndpointErrorDetails")) {
    ...
    for (unsigned vpcEndpointErrorDetailsIndex = 0; vpcEndpointErrorDetailsIndex < vpcEndpointErrorDetailsJsonList.GetLength();
         ++vpcEndpointErrorDetailsIndex) {
