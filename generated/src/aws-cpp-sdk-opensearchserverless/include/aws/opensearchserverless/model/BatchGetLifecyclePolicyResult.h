...
class BatchGetLifecyclePolicyResult {
 public:
  ...
  AWS_OPENSEARCHSERVERLESS_API BatchGetLifecyclePolicyResult& operator=(
  ...
  void SetLifecyclePolicyDetails(LifecyclePolicyDetailsT&& value) {
    m_lifecyclePolicyDetailsHasBeenSet = true;
    m_lifecyclePolicyDetails = std::forward<LifecyclePolicyDetailsT>(value);
  }
  template <typename LifecyclePolicyDetailsT = Aws::Vector<LifecyclePolicyDetail>>
  BatchGetLifecyclePolicyResult& WithLifecyclePolicyDetails(LifecyclePolicyDetailsT&& value) {
    SetLifecyclePolicyDetails(std::forward<LifecyclePolicyDetailsT>(value));
    return *this;
  }
  template <typename LifecyclePolicyDetailsT = LifecyclePolicyDetail>
  BatchGetLifecyclePolicyResult& AddLifecyclePolicyDetails(LifecyclePolicyDetailsT&& value) {
    m_lifecyclePolicyDetailsHasBeenSet = true;
    m_lifecyclePolicyDetails.emplace_back(std::forward<LifecyclePolicyDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLifecyclePolicyErrorDetails(LifecyclePolicyErrorDetailsT&& value) {
    m_lifecyclePolicyErrorDetailsHasBeenSet = true;
    m_lifecyclePolicyErrorDetails = std::forward<LifecyclePolicyErrorDetailsT>(value);
  }
  template <typename LifecyclePolicyErrorDetailsT = Aws::Vector<LifecyclePolicyErrorDetail>>
  BatchGetLifecyclePolicyResult& WithLifecyclePolicyErrorDetails(LifecyclePolicyErrorDetailsT&& value) {
    SetLifecyclePolicyErrorDetails(std::forward<LifecyclePolicyErrorDetailsT>(value));
    return *this;
  }
  template <typename LifecyclePolicyErrorDetailsT = LifecyclePolicyErrorDetail>
  BatchGetLifecyclePolicyResult& AddLifecyclePolicyErrorDetails(LifecyclePolicyErrorDetailsT&& value) {
    m_lifecyclePolicyErrorDetailsHasBeenSet = true;
    m_lifecyclePolicyErrorDetails.emplace_back(std::forward<LifecyclePolicyErrorDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetLifecyclePolicyResult& WithRequestId(RequestIdT&& value) {
