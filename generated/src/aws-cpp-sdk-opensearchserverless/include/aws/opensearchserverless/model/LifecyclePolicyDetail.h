...
class LifecyclePolicyDetail {
 public:
  ...
  inline LifecyclePolicyDetail& WithType(LifecyclePolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline LifecyclePolicyDetail& WithCreatedDate(long long value) {
  ...
  inline LifecyclePolicyDetail& WithLastModifiedDate(long long value) {
