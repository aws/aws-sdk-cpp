...
class UpdateSecurityConfigRequest : public OpenSearchServerlessRequest {
 public:
   ...
   */
  inline const UpdateIamIdentityCenterConfigOptions& GetIamIdentityCenterOptionsUpdates() const {
    return m_iamIdentityCenterOptionsUpdates;
  }
  ...
  void SetIamIdentityCenterOptionsUpdates(IamIdentityCenterOptionsUpdatesT&& value) {
    m_iamIdentityCenterOptionsUpdatesHasBeenSet = true;
    m_iamIdentityCenterOptionsUpdates = std::forward<IamIdentityCenterOptionsUpdatesT>(value);
  }
  template <typename IamIdentityCenterOptionsUpdatesT = UpdateIamIdentityCenterConfigOptions>
  UpdateSecurityConfigRequest& WithIamIdentityCenterOptionsUpdates(IamIdentityCenterOptionsUpdatesT&& value) {
    SetIamIdentityCenterOptionsUpdates(std::forward<IamIdentityCenterOptionsUpdatesT>(value));
    return *this;
  }
  ///@}
