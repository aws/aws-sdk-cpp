...
class ListVpcEndpointsRequest : public OpenSearchServerlessRequest {
 public:
  ...
  void SetVpcEndpointFilters(VpcEndpointFiltersT&& value) {
    m_vpcEndpointFiltersHasBeenSet = true;
    m_vpcEndpointFilters = std::forward<VpcEndpointFiltersT>(value);
  }
  template <typename VpcEndpointFiltersT = VpcEndpointFilters>
  ListVpcEndpointsRequest& WithVpcEndpointFilters(VpcEndpointFiltersT&& value) {
    SetVpcEndpointFilters(std::forward<VpcEndpointFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListVpcEndpointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
