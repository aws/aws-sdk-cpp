...
class CapacityLimits {
 public:
  ...
  inline void SetMaxIndexingCapacityInOCU(int value) {
    m_maxIndexingCapacityInOCUHasBeenSet = true;
    m_maxIndexingCapacityInOCU = value;
  }
  inline CapacityLimits& WithMaxIndexingCapacityInOCU(int value) {
  ...
  inline void SetMaxSearchCapacityInOCU(int value) {
    m_maxSearchCapacityInOCUHasBeenSet = true;
    m_maxSearchCapacityInOCU = value;
  }
  inline CapacityLimits& WithMaxSearchCapacityInOCU(int value) {
