...
class SecurityConfigDetail {
 public:
  ...
  inline void SetType(SecurityConfigType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline SecurityConfigDetail& WithType(SecurityConfigType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetConfigVersion(ConfigVersionT&& value) {
    ...
    m_configVersion = std::forward<ConfigVersionT>(value);
  }
  template <typename ConfigVersionT = Aws::String>
  SecurityConfigDetail& WithConfigVersion(ConfigVersionT&& value) {
    SetConfigVersion(std::forward<ConfigVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIamFederationOptions(IamFederationOptionsT&& value) {
    ...
    m_iamFederationOptions = std::forward<IamFederationOptionsT>(value);
  }
  template <typename IamFederationOptionsT = IamFederationConfigOptions>
  SecurityConfigDetail& WithIamFederationOptions(IamFederationOptionsT&& value) {
    SetIamFederationOptions(std::forward<IamFederationOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline SecurityConfigDetail& WithCreatedDate(long long value) {
  ...
  inline SecurityConfigDetail& WithLastModifiedDate(long long value) {
