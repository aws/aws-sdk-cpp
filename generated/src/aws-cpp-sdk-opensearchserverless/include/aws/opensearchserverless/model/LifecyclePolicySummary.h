...
class LifecyclePolicySummary {
 public:
  ...
  inline LifecyclePolicySummary& WithType(LifecyclePolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline LifecyclePolicySummary& WithCreatedDate(long long value) {
  ...
  inline LifecyclePolicySummary& WithLastModifiedDate(long long value) {
