...
class LifecyclePolicyStats {
 public:
  ...
  inline void SetRetentionPolicyCount(long long value) {
    m_retentionPolicyCountHasBeenSet = true;
    m_retentionPolicyCount = value;
  }
  inline LifecyclePolicyStats& WithRetentionPolicyCount(long long value) {
    SetRetentionPolicyCount(value);
    return *this;
  }
  ///@}
 private:
