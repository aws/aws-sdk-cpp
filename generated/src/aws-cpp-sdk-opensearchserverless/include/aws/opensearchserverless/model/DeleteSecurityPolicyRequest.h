...
class DeleteSecurityPolicyRequest : public OpenSearchServerlessRequest {
 public:
  ...
  inline DeleteSecurityPolicyRequest& WithType(SecurityPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  DeleteSecurityPolicyRequest& WithName(NameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteSecurityPolicyRequest& WithClientToken(ClientTokenT&& value) {
