...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public OpenSearchServerlessRequest
  {
  public:
    AWS_OPENSEARCHSERVERLESS_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the resource to remove tags from. The
     * resource must be active (not in the <code>DELETING</code> state), and must be
     * owned by the account ID included in the request.</p>
     */
    ...
    ///@{
    /**
     * <p>The tag or set of tags to remove from the resource. All tag keys in the
