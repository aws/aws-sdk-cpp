...
class SecurityPolicyDetail {
 public:
  ...
  inline SecurityPolicyDetail& WithType(SecurityPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline SecurityPolicyDetail& WithCreatedDate(long long value) {
  ...
  inline SecurityPolicyDetail& WithLastModifiedDate(long long value) {
