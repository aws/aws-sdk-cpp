...
class DeleteLifecyclePolicyRequest : public OpenSearchServerlessRequest {
 public:
  AWS_OPENSEARCHSERVERLESS_API DeleteLifecyclePolicyRequest() = default;
  ...
  inline DeleteLifecyclePolicyRequest& WithType(LifecyclePolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  DeleteLifecyclePolicyRequest& WithName(NameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteLifecyclePolicyRequest& WithClientToken(ClientTokenT&& value) {
