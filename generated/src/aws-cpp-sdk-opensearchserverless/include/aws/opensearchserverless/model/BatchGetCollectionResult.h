...
class BatchGetCollectionResult {
 public:
  ...
  void SetCollectionDetails(CollectionDetailsT&& value) {
    m_collectionDetailsHasBeenSet = true;
    m_collectionDetails = std::forward<CollectionDetailsT>(value);
  }
  template <typename CollectionDetailsT = Aws::Vector<CollectionDetail>>
  BatchGetCollectionResult& WithCollectionDetails(CollectionDetailsT&& value) {
    SetCollectionDetails(std::forward<CollectionDetailsT>(value));
    return *this;
  }
  ...
  BatchGetCollectionResult& AddCollectionDetails(CollectionDetailsT&& value) {
    m_collectionDetailsHasBeenSet = true;
    m_collectionDetails.emplace_back(std::forward<CollectionDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCollectionErrorDetails(CollectionErrorDetailsT&& value) {
    m_collectionErrorDetailsHasBeenSet = true;
    m_collectionErrorDetails = std::forward<CollectionErrorDetailsT>(value);
  }
  template <typename CollectionErrorDetailsT = Aws::Vector<CollectionErrorDetail>>
  BatchGetCollectionResult& WithCollectionErrorDetails(CollectionErrorDetailsT&& value) {
    SetCollectionErrorDetails(std::forward<CollectionErrorDetailsT>(value));
    return *this;
  }
  ...
  BatchGetCollectionResult& AddCollectionErrorDetails(CollectionErrorDetailsT&& value) {
    m_collectionErrorDetailsHasBeenSet = true;
    m_collectionErrorDetails.emplace_back(std::forward<CollectionErrorDetailsT>(value));
    return *this;
  }
  ///@}
