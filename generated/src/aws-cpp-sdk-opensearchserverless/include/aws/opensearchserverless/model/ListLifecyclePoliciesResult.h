...
class ListLifecyclePoliciesResult {
 public:
  ...
  AWS_OPENSEARCHSERVERLESS_API ListLifecyclePoliciesResult& operator=(
  ...
  void SetLifecyclePolicySummaries(LifecyclePolicySummariesT&& value) {
    m_lifecyclePolicySummariesHasBeenSet = true;
    m_lifecyclePolicySummaries = std::forward<LifecyclePolicySummariesT>(value);
  }
  template <typename LifecyclePolicySummariesT = Aws::Vector<LifecyclePolicySummary>>
  ListLifecyclePoliciesResult& WithLifecyclePolicySummaries(LifecyclePolicySummariesT&& value) {
    SetLifecyclePolicySummaries(std::forward<LifecyclePolicySummariesT>(value));
    return *this;
  }
  template <typename LifecyclePolicySummariesT = LifecyclePolicySummary>
  ListLifecyclePoliciesResult& AddLifecyclePolicySummaries(LifecyclePolicySummariesT&& value) {
    m_lifecyclePolicySummariesHasBeenSet = true;
    m_lifecyclePolicySummaries.emplace_back(std::forward<LifecyclePolicySummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLifecyclePoliciesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLifecyclePoliciesResult& WithRequestId(RequestIdT&& value) {
