...
class ListCollectionsRequest : public OpenSearchServerlessRequest {
 public:
  ...
  void SetCollectionFilters(CollectionFiltersT&& value) {
    m_collectionFiltersHasBeenSet = true;
    m_collectionFilters = std::forward<CollectionFiltersT>(value);
  }
  template <typename CollectionFiltersT = CollectionFilters>
  ListCollectionsRequest& WithCollectionFilters(CollectionFiltersT&& value) {
    SetCollectionFilters(std::forward<CollectionFiltersT>(value));
    return *this;
  }
  ///@}
