...
class ListSecurityPoliciesRequest : public OpenSearchServerlessRequest {
 public:
  ...
  inline ListSecurityPoliciesRequest& WithType(SecurityPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceT = Aws::Vector<Aws::String>>
  ListSecurityPoliciesRequest& WithResource(ResourceT&& value) {
    SetResource(std::forward<ResourceT>(value));
    return *this;
  }
  template <typename ResourceT = Aws::String>
  ListSecurityPoliciesRequest& AddResource(ResourceT&& value) {
    m_resourceHasBeenSet = true;
