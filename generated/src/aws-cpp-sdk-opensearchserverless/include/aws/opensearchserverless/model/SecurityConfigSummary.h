...
class SecurityConfigSummary {
 public:
  ...
  inline SecurityConfigSummary& WithType(SecurityConfigType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline SecurityConfigSummary& WithCreatedDate(long long value) {
  ...
  inline SecurityConfigSummary& WithLastModifiedDate(long long value) {
