...
class UpdateCollectionResult {
 public:
  ...
  void SetUpdateCollectionDetail(UpdateCollectionDetailT&& value) {
    m_updateCollectionDetailHasBeenSet = true;
    m_updateCollectionDetail = std::forward<UpdateCollectionDetailT>(value);
  }
  template <typename UpdateCollectionDetailT = UpdateCollectionDetail>
  UpdateCollectionResult& WithUpdateCollectionDetail(UpdateCollectionDetailT&& value) {
    SetUpdateCollectionDetail(std::forward<UpdateCollectionDetailT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateCollectionResult& WithRequestId(RequestIdT&& value) {
