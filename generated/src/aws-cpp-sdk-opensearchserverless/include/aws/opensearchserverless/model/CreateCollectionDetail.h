...
class CreateCollectionDetail {
 public:
  ...
  inline CreateCollectionDetail& WithStatus(CollectionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateCollectionDetail& WithType(CollectionType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateCollectionDetail& WithStandbyReplicas(StandbyReplicas value) {
  ...
  inline CreateCollectionDetail& WithCreatedDate(long long value) {
  ...
  inline CreateCollectionDetail& WithLastModifiedDate(long long value) {
