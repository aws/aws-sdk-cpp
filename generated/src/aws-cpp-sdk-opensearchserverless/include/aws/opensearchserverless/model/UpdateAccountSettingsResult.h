...
class UpdateAccountSettingsResult {
 public:
  ...
  AWS_OPENSEARCHSERVERLESS_API UpdateAccountSettingsResult& operator=(
  ...
  void SetAccountSettingsDetail(AccountSettingsDetailT&& value) {
    m_accountSettingsDetailHasBeenSet = true;
    m_accountSettingsDetail = std::forward<AccountSettingsDetailT>(value);
  }
  template <typename AccountSettingsDetailT = AccountSettingsDetail>
  UpdateAccountSettingsResult& WithAccountSettingsDetail(AccountSettingsDetailT&& value) {
    SetAccountSettingsDetail(std::forward<AccountSettingsDetailT>(value));
    return *this;
  }
  ///@}
