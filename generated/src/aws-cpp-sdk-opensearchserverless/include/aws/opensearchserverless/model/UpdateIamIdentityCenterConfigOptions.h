...
class UpdateIamIdentityCenterConfigOptions {
 public:
  ...
  inline UpdateIamIdentityCenterConfigOptions& WithUserAttribute(IamIdentityCenterUserAttribute value) {
  ...
  inline UpdateIamIdentityCenterConfigOptions& WithGroupAttribute(IamIdentityCenterGroupAttribute value) {
