...
class EffectiveLifecyclePolicyDetail {
 public:
  ...
  inline EffectiveLifecyclePolicyDetail& WithType(LifecyclePolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline EffectiveLifecyclePolicyDetail& WithResourceType(ResourceType value) {
  ...
  inline void SetNoMinRetentionPeriod(bool value) {
    m_noMinRetentionPeriodHasBeenSet = true;
    m_noMinRetentionPeriod = value;
  }
  inline EffectiveLifecyclePolicyDetail& WithNoMinRetentionPeriod(bool value) {
    SetNoMinRetentionPeriod(value);
    return *this;
  }
  ///@}
 private:
