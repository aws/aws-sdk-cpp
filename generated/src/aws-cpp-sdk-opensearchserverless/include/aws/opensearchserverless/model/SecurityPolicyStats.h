...
class SecurityPolicyStats {
 public:
  ...
  inline void SetEncryptionPolicyCount(long long value) {
    m_encryptionPolicyCountHasBeenSet = true;
    m_encryptionPolicyCount = value;
  }
  inline SecurityPolicyStats& WithEncryptionPolicyCount(long long value) {
    SetEncryptionPolicyCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNetworkPolicyCount(long long value) {
    m_networkPolicyCountHasBeenSet = true;
    m_networkPolicyCount = value;
  }
  inline SecurityPolicyStats& WithNetworkPolicyCount(long long value) {
    SetNetworkPolicyCount(value);
    return *this;
  }
  ///@}
 private:
