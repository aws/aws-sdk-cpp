...
class ListSecurityPoliciesResult {
 public:
  ...
  AWS_OPENSEARCHSERVERLESS_API ListSecurityPoliciesResult& operator=(
  ...
  void SetSecurityPolicySummaries(SecurityPolicySummariesT&& value) {
    m_securityPolicySummariesHasBeenSet = true;
    m_securityPolicySummaries = std::forward<SecurityPolicySummariesT>(value);
  }
  template <typename SecurityPolicySummariesT = Aws::Vector<SecurityPolicySummary>>
  ListSecurityPoliciesResult& WithSecurityPolicySummaries(SecurityPolicySummariesT&& value) {
    SetSecurityPolicySummaries(std::forward<SecurityPolicySummariesT>(value));
    return *this;
  }
  template <typename SecurityPolicySummariesT = SecurityPolicySummary>
  ListSecurityPoliciesResult& AddSecurityPolicySummaries(SecurityPolicySummariesT&& value) {
    m_securityPolicySummariesHasBeenSet = true;
    m_securityPolicySummaries.emplace_back(std::forward<SecurityPolicySummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityPoliciesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSecurityPoliciesResult& WithRequestId(RequestIdT&& value) {
