...
class CreateSecurityPolicyRequest : public OpenSearchServerlessRequest {
 public:
  ...
  inline CreateSecurityPolicyRequest& WithType(SecurityPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  CreateSecurityPolicyRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateSecurityPolicyRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  CreateSecurityPolicyRequest& WithPolicy(PolicyT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateSecurityPolicyRequest& WithClientToken(ClientTokenT&& value) {
