...
class UpdateSecurityConfigResult {
 public:
  ...
  AWS_OPENSEARCHSERVERLESS_API UpdateSecurityConfigResult& operator=(
  ...
  template <typename SecurityConfigDetailT = SecurityConfigDetail>
  UpdateSecurityConfigResult& WithSecurityConfigDetail(SecurityConfigDetailT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSecurityConfigResult& WithRequestId(RequestIdT&& value) {
