...
class BatchGetEffectiveLifecyclePolicyRequest : public OpenSearchServerlessRequest {
 public:
  ...
  template <typename ResourceIdentifiersT = Aws::Vector<LifecyclePolicyResourceIdentifier>>
  BatchGetEffectiveLifecyclePolicyRequest& WithResourceIdentifiers(ResourceIdentifiersT&& value) {
  ...
  BatchGetEffectiveLifecyclePolicyRequest& AddResourceIdentifiers(ResourceIdentifiersT&& value) {
    m_resourceIdentifiersHasBeenSet = true;
