...
class EffectiveLifecyclePolicyErrorDetail {
 public:
  ...
  inline EffectiveLifecyclePolicyErrorDetail& WithType(LifecyclePolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceT = Aws::String>
  EffectiveLifecyclePolicyErrorDetail& WithResource(ResourceT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  EffectiveLifecyclePolicyErrorDetail& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  EffectiveLifecyclePolicyErrorDetail& WithErrorCode(ErrorCodeT&& value) {
