...
class ListCollectionsResult {
 public:
  ...
  void SetCollectionSummaries(CollectionSummariesT&& value) {
    m_collectionSummariesHasBeenSet = true;
    m_collectionSummaries = std::forward<CollectionSummariesT>(value);
  }
  template <typename CollectionSummariesT = Aws::Vector<CollectionSummary>>
  ListCollectionsResult& WithCollectionSummaries(CollectionSummariesT&& value) {
    SetCollectionSummaries(std::forward<CollectionSummariesT>(value));
    return *this;
  }
  template <typename CollectionSummariesT = CollectionSummary>
  ListCollectionsResult& AddCollectionSummaries(CollectionSummariesT&& value) {
    m_collectionSummariesHasBeenSet = true;
    m_collectionSummaries.emplace_back(std::forward<CollectionSummariesT>(value));
    return *this;
  }
  ///@}
