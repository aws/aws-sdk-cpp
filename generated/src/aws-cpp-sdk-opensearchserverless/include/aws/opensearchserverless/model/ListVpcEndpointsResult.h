...
class ListVpcEndpointsResult {
 public:
  ...
  void SetVpcEndpointSummaries(VpcEndpointSummariesT&& value) {
    m_vpcEndpointSummariesHasBeenSet = true;
    m_vpcEndpointSummaries = std::forward<VpcEndpointSummariesT>(value);
  }
  template <typename VpcEndpointSummariesT = Aws::Vector<VpcEndpointSummary>>
  ListVpcEndpointsResult& WithVpcEndpointSummaries(VpcEndpointSummariesT&& value) {
    SetVpcEndpointSummaries(std::forward<VpcEndpointSummariesT>(value));
    return *this;
  }
  template <typename VpcEndpointSummariesT = VpcEndpointSummary>
  ListVpcEndpointsResult& AddVpcEndpointSummaries(VpcEndpointSummariesT&& value) {
    m_vpcEndpointSummariesHasBeenSet = true;
    m_vpcEndpointSummaries.emplace_back(std::forward<VpcEndpointSummariesT>(value));
    return *this;
  }
  ///@}
