...
class SecurityPolicySummary {
 public:
  ...
  inline SecurityPolicySummary& WithType(SecurityPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline SecurityPolicySummary& WithCreatedDate(long long value) {
  ...
  inline SecurityPolicySummary& WithLastModifiedDate(long long value) {
