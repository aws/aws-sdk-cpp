...
class CreateVpcEndpointResult {
 public:
  ...
  void SetCreateVpcEndpointDetail(CreateVpcEndpointDetailT&& value) {
    m_createVpcEndpointDetailHasBeenSet = true;
    m_createVpcEndpointDetail = std::forward<CreateVpcEndpointDetailT>(value);
  }
  template <typename CreateVpcEndpointDetailT = CreateVpcEndpointDetail>
  CreateVpcEndpointResult& WithCreateVpcEndpointDetail(CreateVpcEndpointDetailT&& value) {
    SetCreateVpcEndpointDetail(std::forward<CreateVpcEndpointDetailT>(value));
    return *this;
  }
  ///@}
