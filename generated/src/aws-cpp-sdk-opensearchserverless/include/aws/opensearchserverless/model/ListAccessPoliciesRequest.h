...
class ListAccessPoliciesRequest : public OpenSearchServerlessRequest {
 public:
  ...
  inline void SetType(AccessPolicyType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ListAccessPoliciesRequest& WithType(AccessPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceT = Aws::Vector<Aws::String>>
  ListAccessPoliciesRequest& WithResource(ResourceT&& value) {
    SetResource(std::forward<ResourceT>(value));
    return *this;
  }
  template <typename ResourceT = Aws::String>
  ListAccessPoliciesRequest& AddResource(ResourceT&& value) {
    m_resourceHasBeenSet = true;
    m_resource.emplace_back(std::forward<ResourceT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListAccessPoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
