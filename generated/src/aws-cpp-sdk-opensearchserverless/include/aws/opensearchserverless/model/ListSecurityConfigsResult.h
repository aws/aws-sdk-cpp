...
class ListSecurityConfigsResult {
 public:
  ...
  void SetSecurityConfigSummaries(SecurityConfigSummariesT&& value) {
    m_securityConfigSummariesHasBeenSet = true;
    m_securityConfigSummaries = std::forward<SecurityConfigSummariesT>(value);
  }
  template <typename SecurityConfigSummariesT = Aws::Vector<SecurityConfigSummary>>
  ListSecurityConfigsResult& WithSecurityConfigSummaries(SecurityConfigSummariesT&& value) {
    SetSecurityConfigSummaries(std::forward<SecurityConfigSummariesT>(value));
    return *this;
  }
  template <typename SecurityConfigSummariesT = SecurityConfigSummary>
  ListSecurityConfigsResult& AddSecurityConfigSummaries(SecurityConfigSummariesT&& value) {
    m_securityConfigSummariesHasBeenSet = true;
    m_securityConfigSummaries.emplace_back(std::forward<SecurityConfigSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSecurityConfigsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSecurityConfigsResult& WithRequestId(RequestIdT&& value) {
