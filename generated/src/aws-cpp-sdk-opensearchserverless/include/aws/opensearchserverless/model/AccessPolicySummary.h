...
class AccessPolicySummary {
 public:
  ...
  inline AccessPolicySummary& WithType(AccessPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline AccessPolicySummary& WithCreatedDate(long long value) {
  ...
  inline AccessPolicySummary& WithLastModifiedDate(long long value) {
