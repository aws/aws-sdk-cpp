...
/**
 * <p>Details about the created collection group.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/opensearchserverless-2021-11-01/CreateCollectionGroupDetail">AWS
 * API Reference</a></p>
 */
class CreateCollectionGroupDetail {
 public:
  ...
  inline CreateCollectionGroupDetail& WithStandbyReplicas(StandbyReplicas value) {
  ...
  inline CreateCollectionGroupDetail& WithCreatedDate(long long value) {
  ...
  inline CreateCollectionGroupDetail& WithGeneration(ServerlessGeneration value) {
    SetGeneration(value);
    return *this;
  }
  ///@}
