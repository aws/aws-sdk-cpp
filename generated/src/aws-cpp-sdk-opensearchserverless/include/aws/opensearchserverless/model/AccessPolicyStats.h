...
class AccessPolicyStats {
 public:
  ...
  inline void SetDataPolicyCount(long long value) {
    m_dataPolicyCountHasBeenSet = true;
    m_dataPolicyCount = value;
  }
  inline AccessPolicyStats& WithDataPolicyCount(long long value) {
    SetDataPolicyCount(value);
    return *this;
  }
  ///@}
 private:
