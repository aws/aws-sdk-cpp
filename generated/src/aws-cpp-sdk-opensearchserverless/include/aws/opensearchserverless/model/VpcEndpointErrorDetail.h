...
class VpcEndpointErrorDetail {
 public:
  ...
  template <typename IdT = Aws::String>
  VpcEndpointErrorDetail& WithId(IdT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  VpcEndpointErrorDetail& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  VpcEndpointErrorDetail& WithErrorCode(ErrorCodeT&& value) {
