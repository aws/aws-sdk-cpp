...
class CreateSecurityConfigResult {
 public:
  ...
  AWS_OPENSEARCHSERVERLESS_API CreateSecurityConfigResult& operator=(
  ...
  template <typename SecurityConfigDetailT = SecurityConfigDetail>
  CreateSecurityConfigResult& WithSecurityConfigDetail(SecurityConfigDetailT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateSecurityConfigResult& WithRequestId(RequestIdT&& value) {
