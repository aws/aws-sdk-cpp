...
class CreateAccessPolicyRequest : public OpenSearchServerlessRequest {
 public:
  ...
  inline CreateAccessPolicyRequest& WithType(AccessPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  CreateAccessPolicyRequest& WithName(NameT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  CreateAccessPolicyRequest& WithPolicy(PolicyT&& value) {
