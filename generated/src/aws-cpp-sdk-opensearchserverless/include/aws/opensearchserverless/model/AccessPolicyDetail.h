...
class AccessPolicyDetail {
 public:
  ...
  inline AccessPolicyDetail& WithType(AccessPolicyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  AccessPolicyDetail& WithName(NameT&& value) {
  ...
  inline AccessPolicyDetail& WithCreatedDate(long long value) {
  ...
  inline AccessPolicyDetail& WithLastModifiedDate(long long value) {
