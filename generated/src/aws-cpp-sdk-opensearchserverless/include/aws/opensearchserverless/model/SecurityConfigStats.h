...
class SecurityConfigStats {
 public:
  ...
  inline void SetSamlConfigCount(long long value) {
    m_samlConfigCountHasBeenSet = true;
    m_samlConfigCount = value;
  }
  inline SecurityConfigStats& WithSamlConfigCount(long long value) {
    SetSamlConfigCount(value);
    return *this;
  }
  ///@}
 private:
