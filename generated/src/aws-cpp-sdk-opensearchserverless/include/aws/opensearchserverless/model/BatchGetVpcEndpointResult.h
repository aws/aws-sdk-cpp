...
class BatchGetVpcEndpointResult {
 public:
  ...
  void SetVpcEndpointDetails(VpcEndpointDetailsT&& value) {
    ...
    m_vpcEndpointDetails = std::forward<VpcEndpointDetailsT>(value);
  }
  template <typename VpcEndpointDetailsT = Aws::Vector<VpcEndpointDetail>>
  BatchGetVpcEndpointResult& WithVpcEndpointDetails(VpcEndpointDetailsT&& value) {
    SetVpcEndpointDetails(std::forward<VpcEndpointDetailsT>(value));
    return *this;
  }
  ...
  BatchGetVpcEndpointResult& AddVpcEndpointDetails(VpcEndpointDetailsT&& value) {
    m_vpcEndpointDetailsHasBeenSet = true;
    m_vpcEndpointDetails.emplace_back(std::forward<VpcEndpointDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVpcEndpointErrorDetails(VpcEndpointErrorDetailsT&& value) {
    ...
    m_vpcEndpointErrorDetails = std::forward<VpcEndpointErrorDetailsT>(value);
  }
  template <typename VpcEndpointErrorDetailsT = Aws::Vector<VpcEndpointErrorDetail>>
  BatchGetVpcEndpointResult& WithVpcEndpointErrorDetails(VpcEndpointErrorDetailsT&& value) {
    SetVpcEndpointErrorDetails(std::forward<VpcEndpointErrorDetailsT>(value));
    return *this;
  }
  ...
  BatchGetVpcEndpointResult& AddVpcEndpointErrorDetails(VpcEndpointErrorDetailsT&& value) {
    m_vpcEndpointErrorDetailsHasBeenSet = true;
    m_vpcEndpointErrorDetails.emplace_back(std::forward<VpcEndpointErrorDetailsT>(value));
    return *this;
  }
  ///@}
