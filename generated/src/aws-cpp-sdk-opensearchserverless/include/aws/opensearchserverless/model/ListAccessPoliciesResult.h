...
class ListAccessPoliciesResult {
 public:
  ...
  void SetAccessPolicySummaries(AccessPolicySummariesT&& value) {
    m_accessPolicySummariesHasBeenSet = true;
    m_accessPolicySummaries = std::forward<AccessPolicySummariesT>(value);
  }
  template <typename AccessPolicySummariesT = Aws::Vector<AccessPolicySummary>>
  ListAccessPoliciesResult& WithAccessPolicySummaries(AccessPolicySummariesT&& value) {
    SetAccessPolicySummaries(std::forward<AccessPolicySummariesT>(value));
    return *this;
  }
  template <typename AccessPolicySummariesT = AccessPolicySummary>
  ListAccessPoliciesResult& AddAccessPolicySummaries(AccessPolicySummariesT&& value) {
    m_accessPolicySummariesHasBeenSet = true;
    m_accessPolicySummaries.emplace_back(std::forward<AccessPolicySummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessPoliciesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccessPoliciesResult& WithRequestId(RequestIdT&& value) {
