...
namespace Model
{
  ...
  /**
   * <p>Thrown when you attempt to create more resources than the service allows
   * based on service quotas.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/opensearchserverless-2021-11-01/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_OPENSEARCHSERVERLESS_API ServiceQuotaExceededException();
