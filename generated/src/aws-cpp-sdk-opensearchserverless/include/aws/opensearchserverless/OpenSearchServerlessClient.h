...
namespace OpenSearchServerless
{
   ...
   */
  class AWS_OPENSEARCHSERVERLESS_API OpenSearchServerlessClient : Aws::Client::ClientWithAsyncTemplateMethods<OpenSearchServerlessClient>,
    smithy::client::AwsSmithyClientT<Aws::OpenSearchServerless::SERVICE_NAME,
