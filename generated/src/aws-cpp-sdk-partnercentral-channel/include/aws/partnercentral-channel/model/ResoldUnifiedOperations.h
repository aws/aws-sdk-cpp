...
/**
 * <p>Configuration for resold unified operations support plans.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/partnercentral-channel-2024-03-18/ResoldUnifiedOperations">AWS
 * API Reference</a></p>
 */
class ResoldUnifiedOperations {
 public:
  AWS_PARTNERCENTRALCHANNEL_API ResoldUnifiedOperations() = default;
  AWS_PARTNERCENTRALCHANNEL_API ResoldUnifiedOperations(Aws::Utils::Json::JsonView jsonValue);
  AWS_PARTNERCENTRALCHANNEL_API ResoldUnifiedOperations& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline ResoldUnifiedOperations& WithCoverage(Coverage value) {
    SetCoverage(value);
    return *this;
  }
  ///@}
  ...
  template <typename TamLocationT = Aws::String>
  ResoldUnifiedOperations& WithTamLocation(TamLocationT&& value) {
  ...
  template <typename ChargeAccountIdT = Aws::String>
  ResoldUnifiedOperations& WithChargeAccountId(ChargeAccountIdT&& value) {
