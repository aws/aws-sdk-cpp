 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/partnercentral-channel-2024-03-18/ResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class ResourceNotFoundException {
 public:
  AWS_PARTNERCENTRALCHANNEL_API ResourceNotFoundException() = default;
  AWS_PARTNERCENTRALCHANNEL_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
  AWS_PARTNERCENTRALCHANNEL_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
