...
RelationshipSummary::RelationshipSummary(JsonView jsonValue) { *this = jsonValue; }

RelationshipSummary& RelationshipSummary::operator=(JsonView jsonValue) {
...
JsonValue RelationshipSummary::Jsonize() const {
  JsonValue payload;
