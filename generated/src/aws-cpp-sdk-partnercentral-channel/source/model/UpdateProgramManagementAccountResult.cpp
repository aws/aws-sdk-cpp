...
UpdateProgramManagementAccountResult::UpdateProgramManagementAccountResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdateProgramManagementAccountResult& UpdateProgramManagementAccountResult::operator=(
