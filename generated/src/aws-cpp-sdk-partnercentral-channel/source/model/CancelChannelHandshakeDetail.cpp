...
CancelChannelHandshakeDetail::CancelChannelHandshakeDetail(JsonView jsonValue) { *this = jsonValue; }

CancelChannelHandshakeDetail& CancelChannelHandshakeDetail::operator=(JsonView jsonValue) {
...
JsonValue CancelChannelHandshakeDetail::Jsonize() const {
  JsonValue payload;
