...
ResoldUnifiedOperations::ResoldUnifiedOperations(JsonView jsonValue) { *this = jsonValue; }

ResoldUnifiedOperations& ResoldUnifiedOperations::operator=(JsonView jsonValue) {
...
JsonValue ResoldUnifiedOperations::Jsonize() const {
  JsonValue payload;
