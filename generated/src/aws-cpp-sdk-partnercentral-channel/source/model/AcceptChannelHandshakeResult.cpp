...
AcceptChannelHandshakeResult::AcceptChannelHandshakeResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

AcceptChannelHandshakeResult& AcceptChannelHandshakeResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
