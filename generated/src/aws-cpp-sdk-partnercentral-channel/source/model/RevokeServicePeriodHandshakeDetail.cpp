...
RevokeServicePeriodHandshakeDetail::RevokeServicePeriodHandshakeDetail(JsonView jsonValue) { *this = jsonValue; }

RevokeServicePeriodHandshakeDetail& RevokeServicePeriodHandshakeDetail::operator=(JsonView jsonValue) {
...
JsonValue RevokeServicePeriodHandshakeDetail::Jsonize() const {
  JsonValue payload;
