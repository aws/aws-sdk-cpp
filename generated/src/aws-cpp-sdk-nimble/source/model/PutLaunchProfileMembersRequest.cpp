...
Aws::String PutLaunchProfileMembersRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection PutLaunchProfileMembersRequest::GetRequestSpecificHeaders() const
{
