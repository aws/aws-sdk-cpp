...
Aws::String DeleteStreamingImageRequest::SerializePayload() const
{
  return {};
}

Aws::Http::HeaderValueCollection DeleteStreamingImageRequest::GetRequestSpecificHeaders() const
{
