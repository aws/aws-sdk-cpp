...
Aws::String DeleteLaunchProfileMemberRequest::SerializePayload() const
{
  return {};
}

Aws::Http::HeaderValueCollection DeleteLaunchProfileMemberRequest::GetRequestSpecificHeaders() const
{
