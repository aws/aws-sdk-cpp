...
{
const size_t NimbleStudioEndpointRules::RulesBlobStrLen = 3472;
const size_t NimbleStudioEndpointRules::RulesBlobSize = 3473;

using RulesBlobT = Aws::Array<const char, NimbleStudioEndpointRules::RulesBlobSize>;
...
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','n','i','m','b',
'l','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','n','i','m','b','l','e','-','f','i','p','s','.','{',
...
't','p','s',':','/','/','n','i','m','b','l','e','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
const char* NimbleStudioEndpointRules::GetRulesBlob()
{
