...
namespace Model
{
  ...
  public:
    ...
    inline DeleteStudioMemberResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteStudioMemberResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteStudioMemberResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
