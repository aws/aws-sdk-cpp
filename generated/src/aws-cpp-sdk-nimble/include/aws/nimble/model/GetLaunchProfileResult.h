...
namespace Model
{
  ...
  public:
    ...
    inline GetLaunchProfileResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetLaunchProfileResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetLaunchProfileResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
