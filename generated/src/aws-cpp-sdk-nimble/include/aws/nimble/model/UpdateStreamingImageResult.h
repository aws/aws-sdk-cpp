...
namespace Model
{
  ...
  public:
    ...
    inline UpdateStreamingImageResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateStreamingImageResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateStreamingImageResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
