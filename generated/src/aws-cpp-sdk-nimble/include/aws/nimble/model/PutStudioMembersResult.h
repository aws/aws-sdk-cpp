...
namespace Model
{
  ...
  public:
    ...
    inline PutStudioMembersResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutStudioMembersResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutStudioMembersResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
