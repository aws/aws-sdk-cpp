...
namespace Model
{
  ...
  {
  public:
    AWS_NIMBLESTUDIO_API StreamConfigurationCreate();
    AWS_NIMBLESTUDIO_API StreamConfigurationCreate(Aws::Utils::Json::JsonView jsonValue);
    AWS_NIMBLESTUDIO_API StreamConfigurationCreate& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    /**
     * <p>The upload storage for a streaming workstation that is created using this
     * launch profile.</p>
     */
     ...
     * <code>sessionPersistenceMode</code> is <code>ACTIVATED</code>.</p>
     */
    inline StreamConfigurationCreate& WithVolumeConfiguration(VolumeConfiguration&& value) { SetVolumeConfiguration(std::move(value)); return *this;}
