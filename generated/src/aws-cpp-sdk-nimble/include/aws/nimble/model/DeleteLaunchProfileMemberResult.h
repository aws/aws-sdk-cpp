...
namespace Model
{
  ...
  public:
    ...
    inline DeleteLaunchProfileMemberResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteLaunchProfileMemberResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteLaunchProfileMemberResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
