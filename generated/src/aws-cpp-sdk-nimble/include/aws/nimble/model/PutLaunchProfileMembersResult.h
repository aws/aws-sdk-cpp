...
namespace Model
{
  ...
  public:
    ...
    inline PutLaunchProfileMembersResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutLaunchProfileMembersResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutLaunchProfileMembersResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
