...
SetDefaultSenderIdResult::SetDefaultSenderIdResult()
{
}

SetDefaultSenderIdResult::SetDefaultSenderIdResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

SetDefaultSenderIdResult& SetDefaultSenderIdResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
