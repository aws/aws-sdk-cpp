...
DescribeRegistrationAttachmentsResult& DescribeRegistrationAttachmentsResult::operator=(
  ...
  if (jsonValue.ValueExists("RegistrationAttachments")) {
    ...
    for (unsigned registrationAttachmentsIndex = 0; registrationAttachmentsIndex < registrationAttachmentsJsonList.GetLength();
         ++registrationAttachmentsIndex) {
      m_registrationAttachments.push_back(registrationAttachmentsJsonList[registrationAttachmentsIndex].AsObject());
    }
    m_registrationAttachmentsHasBeenSet = true;
  }
