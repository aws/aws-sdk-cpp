...
RcsDialPhoneAction::RcsDialPhoneAction(JsonView jsonValue) { *this = jsonValue; }

RcsDialPhoneAction& RcsDialPhoneAction::operator=(JsonView jsonValue) {
...
JsonValue RcsDialPhoneAction::Jsonize() const {
  JsonValue payload;
