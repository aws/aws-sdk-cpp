...
UpdateNotifyConfigurationResult::UpdateNotifyConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateNotifyConfigurationResult& UpdateNotifyConfigurationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
