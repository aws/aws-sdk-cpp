...
DeleteProtectConfigurationRuleSetNumberOverrideResult::DeleteProtectConfigurationRuleSetNumberOverrideResult() : 
    m_action(ProtectConfigurationRuleOverrideAction::NOT_SET)
{
}

DeleteProtectConfigurationRuleSetNumberOverrideResult::DeleteProtectConfigurationRuleSetNumberOverrideResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
  : DeleteProtectConfigurationRuleSetNumberOverrideResult()
{
  *this = result;
}

DeleteProtectConfigurationRuleSetNumberOverrideResult& DeleteProtectConfigurationRuleSetNumberOverrideResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
