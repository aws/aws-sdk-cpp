...
DeleteNotifyConfigurationResult::DeleteNotifyConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteNotifyConfigurationResult& DeleteNotifyConfigurationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
