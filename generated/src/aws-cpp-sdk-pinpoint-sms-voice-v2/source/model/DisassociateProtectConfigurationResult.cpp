...
DisassociateProtectConfigurationResult::DisassociateProtectConfigurationResult()
{
}

DisassociateProtectConfigurationResult::DisassociateProtectConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DisassociateProtectConfigurationResult& DisassociateProtectConfigurationResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
