...
VerifiedDestinationNumberFilter& VerifiedDestinationNumberFilter::operator =(JsonView jsonValue)
{
...
JsonValue VerifiedDestinationNumberFilter::Jsonize() const
{
  JsonValue payload;

  if(m_nameHasBeenSet)
  {
   payload.WithString("Name", VerifiedDestinationNumberFilterNameMapper::GetNameForVerifiedDestinationNumberFilterName(m_name));
  }
