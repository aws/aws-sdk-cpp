...
UpdatePoolResult::UpdatePoolResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdatePoolResult& UpdatePoolResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
