...
ProtectConfigurationRuleSetNumberOverrideFilterItem& ProtectConfigurationRuleSetNumberOverrideFilterItem::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("Name")) {
    m_name = ProtectConfigurationRuleSetNumberOverrideFilterNameMapper::GetProtectConfigurationRuleSetNumberOverrideFilterNameForName(
...
JsonValue ProtectConfigurationRuleSetNumberOverrideFilterItem::Jsonize() const {
  ...
  if (m_nameHasBeenSet) {
    payload.WithString(
        "Name",
        ProtectConfigurationRuleSetNumberOverrideFilterNameMapper::GetNameForProtectConfigurationRuleSetNumberOverrideFilterName(m_name));
  }
