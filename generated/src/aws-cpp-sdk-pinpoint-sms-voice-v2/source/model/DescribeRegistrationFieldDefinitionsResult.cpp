...
DescribeRegistrationFieldDefinitionsResult& DescribeRegistrationFieldDefinitionsResult::operator=(
  ...
  if (jsonValue.ValueExists("RegistrationFieldDefinitions")) {
    ...
    for (unsigned registrationFieldDefinitionsIndex = 0;
         registrationFieldDefinitionsIndex < registrationFieldDefinitionsJsonList.GetLength(); ++registrationFieldDefinitionsIndex) {
