...
SetMediaMessageSpendLimitOverrideResult::SetMediaMessageSpendLimitOverrideResult() : 
    m_monthlyLimit(0)
{
}
...
SetMediaMessageSpendLimitOverrideResult& SetMediaMessageSpendLimitOverrideResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
