...
Aws::Http::HeaderValueCollection CreateProtectConfigurationRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "PinpointSMSVoiceV2.CreateProtectConfiguration"));
  return headers;
