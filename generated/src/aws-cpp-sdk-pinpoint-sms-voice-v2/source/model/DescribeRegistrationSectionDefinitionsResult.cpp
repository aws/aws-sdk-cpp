...
DescribeRegistrationSectionDefinitionsResult& DescribeRegistrationSectionDefinitionsResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("RegistrationSectionDefinitions")) {
    ...
    for (unsigned registrationSectionDefinitionsIndex = 0;
         registrationSectionDefinitionsIndex < registrationSectionDefinitionsJsonList.GetLength(); ++registrationSectionDefinitionsIndex) {
