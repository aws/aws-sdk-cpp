...
Aws::Http::HeaderValueCollection CreateVerifiedDestinationNumberRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "PinpointSMSVoiceV2.CreateVerifiedDestinationNumber"));
  return headers;
