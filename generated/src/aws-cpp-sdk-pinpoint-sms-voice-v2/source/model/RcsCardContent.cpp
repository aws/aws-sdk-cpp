...
RcsCardContent::RcsCardContent(JsonView jsonValue) { *this = jsonValue; }

RcsCardContent& RcsCardContent::operator=(JsonView jsonValue) {
...
JsonValue RcsCardContent::Jsonize() const {
  JsonValue payload;
