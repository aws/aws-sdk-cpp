...
RcsRequestLocationAction::RcsRequestLocationAction(JsonView jsonValue) { *this = jsonValue; }

RcsRequestLocationAction& RcsRequestLocationAction::operator=(JsonView jsonValue) {
...
JsonValue RcsRequestLocationAction::Jsonize() const {
  JsonValue payload;
