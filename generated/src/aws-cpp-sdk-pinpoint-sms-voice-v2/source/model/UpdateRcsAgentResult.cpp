...
UpdateRcsAgentResult::UpdateRcsAgentResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateRcsAgentResult& UpdateRcsAgentResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
