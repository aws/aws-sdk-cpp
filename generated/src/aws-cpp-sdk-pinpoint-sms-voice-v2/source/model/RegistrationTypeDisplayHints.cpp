...
RegistrationTypeDisplayHints::RegistrationTypeDisplayHints() : 
...
RegistrationTypeDisplayHints::RegistrationTypeDisplayHints(JsonView jsonValue) : 
    m_titleHasBeenSet(false),
    m_shortDescriptionHasBeenSet(false),
    m_longDescriptionHasBeenSet(false),
    m_documentationTitleHasBeenSet(false),
...
RegistrationTypeDisplayHints& RegistrationTypeDisplayHints::operator =(JsonView jsonValue)
{
...
JsonValue RegistrationTypeDisplayHints::Jsonize() const
{
  JsonValue payload;
