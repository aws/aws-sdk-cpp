...
DeleteMediaMessageSpendLimitOverrideResult::DeleteMediaMessageSpendLimitOverrideResult() : 
    m_monthlyLimit(0)
{
}
...
DeleteMediaMessageSpendLimitOverrideResult& DeleteMediaMessageSpendLimitOverrideResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
