...
DeleteTextMessageSpendLimitOverrideResult::DeleteTextMessageSpendLimitOverrideResult() : 
    m_monthlyLimit(0)
{
}
...
DeleteTextMessageSpendLimitOverrideResult& DeleteTextMessageSpendLimitOverrideResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
