...
template <>
AWS_PINPOINTSMSVOICEV2_API ConflictException PinpointSMSVoiceV2Error::GetModeledError() {
  assert(this->GetErrorType() == PinpointSMSVoiceV2Errors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_PINPOINTSMSVOICEV2_API ServiceQuotaExceededException PinpointSMSVoiceV2Error::GetModeledError() {
  assert(this->GetErrorType() == PinpointSMSVoiceV2Errors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_PINPOINTSMSVOICEV2_API ResourceNotFoundException PinpointSMSVoiceV2Error::GetModeledError() {
  assert(this->GetErrorType() == PinpointSMSVoiceV2Errors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_PINPOINTSMSVOICEV2_API InternalServerException PinpointSMSVoiceV2Error::GetModeledError() {
  assert(this->GetErrorType() == PinpointSMSVoiceV2Errors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_PINPOINTSMSVOICEV2_API ValidationException PinpointSMSVoiceV2Error::GetModeledError() {
  assert(this->GetErrorType() == PinpointSMSVoiceV2Errors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_PINPOINTSMSVOICEV2_API AccessDeniedException PinpointSMSVoiceV2Error::GetModeledError() {
