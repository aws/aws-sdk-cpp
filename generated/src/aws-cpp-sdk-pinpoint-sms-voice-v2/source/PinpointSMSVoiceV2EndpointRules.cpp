...
'"','h','t','t','p','s',':','/','/','s','m','s','-','v','o','i','c','e','-','f','i','p','s','.','{',
...
't','p','s',':','/','/','s','m','s','-','v','o','i','c','e','.','{','R','e','g','i','o','n','}','.',
...
's','-','v','o','i','c','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
const char* PinpointSMSVoiceV2EndpointRules::GetRulesBlob()
{
