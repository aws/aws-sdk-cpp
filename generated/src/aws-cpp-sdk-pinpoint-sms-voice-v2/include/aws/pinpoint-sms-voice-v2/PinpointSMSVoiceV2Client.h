...
namespace PinpointSMSVoiceV2
{
   ...
   */
  class AWS_PINPOINTSMSVOICEV2_API PinpointSMSVoiceV2Client : Aws::Client::ClientWithAsyncTemplateMethods<PinpointSMSVoiceV2Client>,
    smithy::client::AwsSmithyClientT<Aws::PinpointSMSVoiceV2::SERVICE_NAME,
