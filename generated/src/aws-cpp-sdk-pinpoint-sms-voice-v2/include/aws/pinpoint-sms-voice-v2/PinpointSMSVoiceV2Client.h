...
#include <aws/pinpoint-sms-voice-v2/PinpointSMSVoiceV2Waiter.h>
...
class AWS_PINPOINTSMSVOICEV2_API PinpointSMSVoiceV2Client : public Aws::Client::AWSJsonClient,
                                                            ...
                                                            public PinpointSMSVoiceV2Waiter<PinpointSMSVoiceV2Client> {
 public:
   ...
   */
  PinpointSMSVoiceV2Client(const Aws::PinpointSMSVoiceV2::PinpointSMSVoiceV2ClientConfiguration& clientConfiguration =
  ...
  PinpointSMSVoiceV2Client(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<PinpointSMSVoiceV2EndpointProviderBase> endpointProvider = nullptr,
                           const Aws::PinpointSMSVoiceV2::PinpointSMSVoiceV2ClientConfiguration& clientConfiguration =
                               Aws::PinpointSMSVoiceV2::PinpointSMSVoiceV2ClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  PinpointSMSVoiceV2Client(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateOriginationIdentityOutcome AssociateOriginationIdentity(
      const Model::AssociateOriginationIdentityRequest& request) const;

  /**
   * A Callable wrapper for AssociateOriginationIdentity that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateOriginationIdentityRequestT = Model::AssociateOriginationIdentityRequest>
  Model::AssociateOriginationIdentityOutcomeCallable AssociateOriginationIdentityCallable(
      const AssociateOriginationIdentityRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::AssociateOriginationIdentity, request);
  }

  /**
   * An Async wrapper for AssociateOriginationIdentity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateOriginationIdentityRequestT = Model::AssociateOriginationIdentityRequest>
  void AssociateOriginationIdentityAsync(const AssociateOriginationIdentityRequestT& request,
                                         const AssociateOriginationIdentityResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateProtectConfigurationOutcome AssociateProtectConfiguration(
      const Model::AssociateProtectConfigurationRequest& request) const;

  /**
   * A Callable wrapper for AssociateProtectConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateProtectConfigurationRequestT = Model::AssociateProtectConfigurationRequest>
  Model::AssociateProtectConfigurationOutcomeCallable AssociateProtectConfigurationCallable(
      const AssociateProtectConfigurationRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::AssociateProtectConfiguration, request);
  }

  /**
   * An Async wrapper for AssociateProtectConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateProtectConfigurationRequestT = Model::AssociateProtectConfigurationRequest>
  void AssociateProtectConfigurationAsync(const AssociateProtectConfigurationRequestT& request,
                                          const AssociateProtectConfigurationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::AssociateProtectConfiguration, request, handler, context);
  }

  /**
   * <p>Returns information about a destination phone number, including whether the
   * number type and whether it is valid, the carrier, and more.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/CarrierLookup">AWS
   * API Reference</a></p>
   */
  virtual Model::CarrierLookupOutcome CarrierLookup(const Model::CarrierLookupRequest& request) const;

  /**
   * A Callable wrapper for CarrierLookup that returns a future to the operation so that it can be executed in parallel to other requests.
   */
  template <typename CarrierLookupRequestT = Model::CarrierLookupRequest>
  Model::CarrierLookupOutcomeCallable CarrierLookupCallable(const CarrierLookupRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::CarrierLookup, request);
  }

  /**
   * An Async wrapper for CarrierLookup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CarrierLookupRequestT = Model::CarrierLookupRequest>
  void CarrierLookupAsync(const CarrierLookupRequestT& request, const CarrierLookupResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::CarrierLookup, request, handler, context);
  }
   ...
   */
  template <typename CreateConfigurationSetRequestT = Model::CreateConfigurationSetRequest>
  void CreateConfigurationSetAsync(const CreateConfigurationSetRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateEventDestination that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEventDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEventDestinationRequestT = Model::CreateEventDestinationRequest>
  void CreateEventDestinationAsync(const CreateEventDestinationRequestT& request,
                                   const CreateEventDestinationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::CreateEventDestination, request, handler, context);
  }

  /**
   * <p>Creates a new notify configuration for managed messaging. A notify
   * configuration defines the settings for sending templated messages, including the
   * display name, use case, enabled channels, and enabled countries.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/CreateNotifyConfiguration">AWS
   * API Reference</a></p>
   */
  virtual Model::CreateNotifyConfigurationOutcome CreateNotifyConfiguration(const Model::CreateNotifyConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateNotifyConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateNotifyConfigurationRequestT = Model::CreateNotifyConfigurationRequest>
  Model::CreateNotifyConfigurationOutcomeCallable CreateNotifyConfigurationCallable(
      const CreateNotifyConfigurationRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::CreateNotifyConfiguration, request);
  }

  /**
   * An Async wrapper for CreateNotifyConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateNotifyConfigurationRequestT = Model::CreateNotifyConfigurationRequest>
  void CreateNotifyConfigurationAsync(const CreateNotifyConfigurationRequestT& request,
                                      const CreateNotifyConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::CreateNotifyConfiguration, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateOptOutList that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateOptOutList that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateOptOutListRequestT = Model::CreateOptOutListRequest>
  void CreateOptOutListAsync(const CreateOptOutListRequestT& request, const CreateOptOutListResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreatePool that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreatePoolRequestT = Model::CreatePoolRequest>
  void CreatePoolAsync(const CreatePoolRequestT& request, const CreatePoolResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateProtectConfigurationOutcome CreateProtectConfiguration(
      const Model::CreateProtectConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for CreateProtectConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateProtectConfigurationRequestT = Model::CreateProtectConfigurationRequest>
  Model::CreateProtectConfigurationOutcomeCallable CreateProtectConfigurationCallable(
      const CreateProtectConfigurationRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::CreateProtectConfiguration, request);
  }

  /**
   * An Async wrapper for CreateProtectConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProtectConfigurationRequestT = Model::CreateProtectConfigurationRequest>
  void CreateProtectConfigurationAsync(const CreateProtectConfigurationResponseReceivedHandler& handler,
  ...
  /**
   * <p>Creates a new RCS agent for sending rich messages through the RCS channel.
   * The RCS agent serves as an origination identity for sending RCS messages to your
   * recipients.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/CreateRcsAgent">AWS
   * API Reference</a></p>
   */
  virtual Model::CreateRcsAgentOutcome CreateRcsAgent(const Model::CreateRcsAgentRequest& request = {}) const;

  /**
   * A Callable wrapper for CreateRcsAgent that returns a future to the operation so that it can be executed in parallel to other requests.
   */
  template <typename CreateRcsAgentRequestT = Model::CreateRcsAgentRequest>
  Model::CreateRcsAgentOutcomeCallable CreateRcsAgentCallable(const CreateRcsAgentRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::CreateRcsAgent, request);
  }

  /**
   * An Async wrapper for CreateRcsAgent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateRcsAgentRequestT = Model::CreateRcsAgentRequest>
  void CreateRcsAgentAsync(const CreateRcsAgentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const CreateRcsAgentRequestT& request = {}) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::CreateRcsAgent, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateRegistration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateRegistration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateRegistrationRequestT = Model::CreateRegistrationRequest>
  void CreateRegistrationAsync(const CreateRegistrationRequestT& request, const CreateRegistrationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateRegistrationAssociationOutcome CreateRegistrationAssociation(
      const Model::CreateRegistrationAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateRegistrationAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateRegistrationAssociationRequestT = Model::CreateRegistrationAssociationRequest>
  Model::CreateRegistrationAssociationOutcomeCallable CreateRegistrationAssociationCallable(
      const CreateRegistrationAssociationRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::CreateRegistrationAssociation, request);
  }

  /**
   * An Async wrapper for CreateRegistrationAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRegistrationAssociationRequestT = Model::CreateRegistrationAssociationRequest>
  void CreateRegistrationAssociationAsync(const CreateRegistrationAssociationRequestT& request,
                                          const CreateRegistrationAssociationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * a file. The maximum file size is 5MB and valid file extensions are PDF, JPEG and
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateRegistrationAttachmentOutcome CreateRegistrationAttachment(
      const Model::CreateRegistrationAttachmentRequest& request = {}) const;

  /**
   * A Callable wrapper for CreateRegistrationAttachment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateRegistrationAttachmentRequestT = Model::CreateRegistrationAttachmentRequest>
  Model::CreateRegistrationAttachmentOutcomeCallable CreateRegistrationAttachmentCallable(
      const CreateRegistrationAttachmentRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::CreateRegistrationAttachment, request);
  }

  /**
   * An Async wrapper for CreateRegistrationAttachment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRegistrationAttachmentRequestT = Model::CreateRegistrationAttachmentRequest>
  void CreateRegistrationAttachmentAsync(const CreateRegistrationAttachmentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const CreateRegistrationAttachmentRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateRegistrationVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateRegistrationVersionRequestT = Model::CreateRegistrationVersionRequest>
  Model::CreateRegistrationVersionOutcomeCallable CreateRegistrationVersionCallable(
      const CreateRegistrationVersionRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::CreateRegistrationVersion, request);
  }

  /**
   * An Async wrapper for CreateRegistrationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRegistrationVersionRequestT = Model::CreateRegistrationVersionRequest>
  void CreateRegistrationVersionAsync(const CreateRegistrationVersionRequestT& request,
                                      const CreateRegistrationVersionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateVerifiedDestinationNumberOutcome CreateVerifiedDestinationNumber(
      const Model::CreateVerifiedDestinationNumberRequest& request) const;

  /**
   * A Callable wrapper for CreateVerifiedDestinationNumber that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateVerifiedDestinationNumberRequestT = Model::CreateVerifiedDestinationNumberRequest>
  Model::CreateVerifiedDestinationNumberOutcomeCallable CreateVerifiedDestinationNumberCallable(
      const CreateVerifiedDestinationNumberRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::CreateVerifiedDestinationNumber, request);
  }

  /**
   * An Async wrapper for CreateVerifiedDestinationNumber that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateVerifiedDestinationNumberRequestT = Model::CreateVerifiedDestinationNumberRequest>
  void CreateVerifiedDestinationNumberAsync(const CreateVerifiedDestinationNumberRequestT& request,
                                            const CreateVerifiedDestinationNumberResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAccountDefaultProtectConfigurationOutcome DeleteAccountDefaultProtectConfiguration(
      const Model::DeleteAccountDefaultProtectConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteAccountDefaultProtectConfiguration that returns a future to the operation so that it can be executed in
  ...
  Model::DeleteAccountDefaultProtectConfigurationOutcomeCallable DeleteAccountDefaultProtectConfigurationCallable(
      const DeleteAccountDefaultProtectConfigurationRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteAccountDefaultProtectConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteAccountDefaultProtectConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteAccountDefaultProtectConfigurationRequestT = Model::DeleteAccountDefaultProtectConfigurationRequest>
  void DeleteAccountDefaultProtectConfigurationAsync(const DeleteAccountDefaultProtectConfigurationResponseReceivedHandler& handler,
                                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                     const DeleteAccountDefaultProtectConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteDefaultMessageType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDefaultMessageType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDefaultMessageTypeRequestT = Model::DeleteDefaultMessageTypeRequest>
  void DeleteDefaultMessageTypeAsync(const DeleteDefaultMessageTypeRequestT& request,
                                     const DeleteDefaultMessageTypeResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDefaultSenderId that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDefaultSenderId that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDefaultSenderIdRequestT = Model::DeleteDefaultSenderIdRequest>
  void DeleteDefaultSenderIdAsync(const DeleteDefaultSenderIdRequestT& request, const DeleteDefaultSenderIdResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEventDestination that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEventDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEventDestinationRequestT = Model::DeleteEventDestinationRequest>
  void DeleteEventDestinationAsync(const DeleteEventDestinationRequestT& request,
                                   const DeleteEventDestinationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteKeyword that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteKeywordRequestT = Model::DeleteKeywordRequest>
  void DeleteKeywordAsync(const DeleteKeywordRequestT& request, const DeleteKeywordResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteMediaMessageSpendLimitOverrideOutcome DeleteMediaMessageSpendLimitOverride(
      const Model::DeleteMediaMessageSpendLimitOverrideRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteMediaMessageSpendLimitOverride that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteMediaMessageSpendLimitOverrideRequestT = Model::DeleteMediaMessageSpendLimitOverrideRequest>
  Model::DeleteMediaMessageSpendLimitOverrideOutcomeCallable DeleteMediaMessageSpendLimitOverrideCallable(
      const DeleteMediaMessageSpendLimitOverrideRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteMediaMessageSpendLimitOverride, request);
  }

  /**
   * An Async wrapper for DeleteMediaMessageSpendLimitOverride that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteMediaMessageSpendLimitOverrideRequestT = Model::DeleteMediaMessageSpendLimitOverrideRequest>
  void DeleteMediaMessageSpendLimitOverrideAsync(const DeleteMediaMessageSpendLimitOverrideResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const DeleteMediaMessageSpendLimitOverrideRequestT& request = {}) const {
  ...
  /**
   * <p>Deletes an existing notify configuration.</p> <p>If deletion protection is
   * enabled, an error is returned.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/DeleteNotifyConfiguration">AWS
   * API Reference</a></p>
   */
  virtual Model::DeleteNotifyConfigurationOutcome DeleteNotifyConfiguration(const Model::DeleteNotifyConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteNotifyConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteNotifyConfigurationRequestT = Model::DeleteNotifyConfigurationRequest>
  Model::DeleteNotifyConfigurationOutcomeCallable DeleteNotifyConfigurationCallable(
      const DeleteNotifyConfigurationRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteNotifyConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteNotifyConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteNotifyConfigurationRequestT = Model::DeleteNotifyConfigurationRequest>
  void DeleteNotifyConfigurationAsync(const DeleteNotifyConfigurationRequestT& request,
                                      const DeleteNotifyConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::DeleteNotifyConfiguration, request, handler, context);
  }

  /**
   * <p>Deletes an account-level monthly spending limit override for sending notify
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/DeleteNotifyMessageSpendLimitOverride">AWS
   * API Reference</a></p>
   */
  virtual Model::DeleteNotifyMessageSpendLimitOverrideOutcome DeleteNotifyMessageSpendLimitOverride(
      const Model::DeleteNotifyMessageSpendLimitOverrideRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteNotifyMessageSpendLimitOverride that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteNotifyMessageSpendLimitOverrideRequestT = Model::DeleteNotifyMessageSpendLimitOverrideRequest>
  Model::DeleteNotifyMessageSpendLimitOverrideOutcomeCallable DeleteNotifyMessageSpendLimitOverrideCallable(
      const DeleteNotifyMessageSpendLimitOverrideRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteNotifyMessageSpendLimitOverride, request);
  }

  /**
   * An Async wrapper for DeleteNotifyMessageSpendLimitOverride that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteNotifyMessageSpendLimitOverrideRequestT = Model::DeleteNotifyMessageSpendLimitOverrideRequest>
  void DeleteNotifyMessageSpendLimitOverrideAsync(const DeleteNotifyMessageSpendLimitOverrideResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const DeleteNotifyMessageSpendLimitOverrideRequestT& request = {}) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::DeleteNotifyMessageSpendLimitOverride, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeleteOptOutList that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteOptOutList that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteOptOutListRequestT = Model::DeleteOptOutListRequest>
  void DeleteOptOutListAsync(const DeleteOptOutListRequestT& request, const DeleteOptOutListResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteOptedOutNumber that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteOptedOutNumber that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteOptedOutNumberRequestT = Model::DeleteOptedOutNumberRequest>
  void DeleteOptedOutNumberAsync(const DeleteOptedOutNumberRequestT& request, const DeleteOptedOutNumberResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeletePool that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePoolRequestT = Model::DeletePoolRequest>
  void DeletePoolAsync(const DeletePoolRequestT& request, const DeletePoolResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteProtectConfigurationOutcome DeleteProtectConfiguration(
      const Model::DeleteProtectConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteProtectConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteProtectConfigurationRequestT = Model::DeleteProtectConfigurationRequest>
  Model::DeleteProtectConfigurationOutcomeCallable DeleteProtectConfigurationCallable(
      const DeleteProtectConfigurationRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteProtectConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteProtectConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProtectConfigurationRequestT = Model::DeleteProtectConfigurationRequest>
  void DeleteProtectConfigurationAsync(const DeleteProtectConfigurationRequestT& request,
                                       const DeleteProtectConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteProtectConfigurationRuleSetNumberOverrideOutcome DeleteProtectConfigurationRuleSetNumberOverride(
      const Model::DeleteProtectConfigurationRuleSetNumberOverrideRequest& request) const;

  /**
   * A Callable wrapper for DeleteProtectConfigurationRuleSetNumberOverride that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <
      typename DeleteProtectConfigurationRuleSetNumberOverrideRequestT = Model::DeleteProtectConfigurationRuleSetNumberOverrideRequest>
  Model::DeleteProtectConfigurationRuleSetNumberOverrideOutcomeCallable DeleteProtectConfigurationRuleSetNumberOverrideCallable(
      const DeleteProtectConfigurationRuleSetNumberOverrideRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteProtectConfigurationRuleSetNumberOverride, request);
  }

  /**
   * An Async wrapper for DeleteProtectConfigurationRuleSetNumberOverride that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <
      typename DeleteProtectConfigurationRuleSetNumberOverrideRequestT = Model::DeleteProtectConfigurationRuleSetNumberOverrideRequest>
  void DeleteProtectConfigurationRuleSetNumberOverrideAsync(
      const DeleteProtectConfigurationRuleSetNumberOverrideRequestT& request,
      const DeleteProtectConfigurationRuleSetNumberOverrideResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::DeleteProtectConfigurationRuleSetNumberOverride, request, handler, context);
  }

  /**
   * <p>Deletes an existing RCS agent. If deletion protection is enabled, an error is
   * returned.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/DeleteRcsAgent">AWS
   * API Reference</a></p>
   */
  virtual Model::DeleteRcsAgentOutcome DeleteRcsAgent(const Model::DeleteRcsAgentRequest& request) const;

  /**
   * A Callable wrapper for DeleteRcsAgent that returns a future to the operation so that it can be executed in parallel to other requests.
   */
  template <typename DeleteRcsAgentRequestT = Model::DeleteRcsAgentRequest>
  Model::DeleteRcsAgentOutcomeCallable DeleteRcsAgentCallable(const DeleteRcsAgentRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteRcsAgent, request);
  }

  /**
   * An Async wrapper for DeleteRcsAgent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRcsAgentRequestT = Model::DeleteRcsAgentRequest>
  void DeleteRcsAgentAsync(const DeleteRcsAgentRequestT& request, const DeleteRcsAgentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::DeleteRcsAgent, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeleteRegistration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRegistration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteRegistrationRequestT = Model::DeleteRegistrationRequest>
  void DeleteRegistrationAsync(const DeleteRegistrationRequestT& request, const DeleteRegistrationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRegistrationAttachmentOutcome DeleteRegistrationAttachment(
      const Model::DeleteRegistrationAttachmentRequest& request) const;

  /**
   * A Callable wrapper for DeleteRegistrationAttachment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRegistrationAttachmentRequestT = Model::DeleteRegistrationAttachmentRequest>
  Model::DeleteRegistrationAttachmentOutcomeCallable DeleteRegistrationAttachmentCallable(
      const DeleteRegistrationAttachmentRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteRegistrationAttachment, request);
  }

  /**
   * An Async wrapper for DeleteRegistrationAttachment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRegistrationAttachmentRequestT = Model::DeleteRegistrationAttachmentRequest>
  void DeleteRegistrationAttachmentAsync(const DeleteRegistrationAttachmentRequestT& request,
                                         const DeleteRegistrationAttachmentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRegistrationFieldValueOutcome DeleteRegistrationFieldValue(
      const Model::DeleteRegistrationFieldValueRequest& request) const;

  /**
   * A Callable wrapper for DeleteRegistrationFieldValue that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRegistrationFieldValueRequestT = Model::DeleteRegistrationFieldValueRequest>
  Model::DeleteRegistrationFieldValueOutcomeCallable DeleteRegistrationFieldValueCallable(
      const DeleteRegistrationFieldValueRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteRegistrationFieldValue, request);
  }

  /**
   * An Async wrapper for DeleteRegistrationFieldValue that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRegistrationFieldValueRequestT = Model::DeleteRegistrationFieldValueRequest>
  void DeleteRegistrationFieldValueAsync(const DeleteRegistrationFieldValueRequestT& request,
                                         const DeleteRegistrationFieldValueResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteTextMessageSpendLimitOverrideOutcome DeleteTextMessageSpendLimitOverride(
      const Model::DeleteTextMessageSpendLimitOverrideRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteTextMessageSpendLimitOverride that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteTextMessageSpendLimitOverrideRequestT = Model::DeleteTextMessageSpendLimitOverrideRequest>
  Model::DeleteTextMessageSpendLimitOverrideOutcomeCallable DeleteTextMessageSpendLimitOverrideCallable(
      const DeleteTextMessageSpendLimitOverrideRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteTextMessageSpendLimitOverride, request);
  }

  /**
   * An Async wrapper for DeleteTextMessageSpendLimitOverride that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteTextMessageSpendLimitOverrideRequestT = Model::DeleteTextMessageSpendLimitOverrideRequest>
  void DeleteTextMessageSpendLimitOverrideAsync(const DeleteTextMessageSpendLimitOverrideResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const DeleteTextMessageSpendLimitOverrideRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteVerifiedDestinationNumberOutcome DeleteVerifiedDestinationNumber(
      const Model::DeleteVerifiedDestinationNumberRequest& request) const;

  /**
   * A Callable wrapper for DeleteVerifiedDestinationNumber that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteVerifiedDestinationNumberRequestT = Model::DeleteVerifiedDestinationNumberRequest>
  Model::DeleteVerifiedDestinationNumberOutcomeCallable DeleteVerifiedDestinationNumberCallable(
      const DeleteVerifiedDestinationNumberRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteVerifiedDestinationNumber, request);
  }

  /**
   * An Async wrapper for DeleteVerifiedDestinationNumber that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteVerifiedDestinationNumberRequestT = Model::DeleteVerifiedDestinationNumberRequest>
  void DeleteVerifiedDestinationNumberAsync(const DeleteVerifiedDestinationNumberRequestT& request,
                                            const DeleteVerifiedDestinationNumberResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteVoiceMessageSpendLimitOverrideOutcome DeleteVoiceMessageSpendLimitOverride(
      const Model::DeleteVoiceMessageSpendLimitOverrideRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteVoiceMessageSpendLimitOverride that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteVoiceMessageSpendLimitOverrideRequestT = Model::DeleteVoiceMessageSpendLimitOverrideRequest>
  Model::DeleteVoiceMessageSpendLimitOverrideOutcomeCallable DeleteVoiceMessageSpendLimitOverrideCallable(
      const DeleteVoiceMessageSpendLimitOverrideRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DeleteVoiceMessageSpendLimitOverride, request);
  }

  /**
   * An Async wrapper for DeleteVoiceMessageSpendLimitOverride that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteVoiceMessageSpendLimitOverrideRequestT = Model::DeleteVoiceMessageSpendLimitOverrideRequest>
  void DeleteVoiceMessageSpendLimitOverrideAsync(const DeleteVoiceMessageSpendLimitOverrideResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const DeleteVoiceMessageSpendLimitOverrideRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAccountAttributesOutcome DescribeAccountAttributes(
      const Model::DescribeAccountAttributesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAccountAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeAccountAttributesRequestT = Model::DescribeAccountAttributesRequest>
  Model::DescribeAccountAttributesOutcomeCallable DescribeAccountAttributesCallable(
  ...
  /**
   * An Async wrapper for DescribeAccountAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAccountAttributesRequestT = Model::DescribeAccountAttributesRequest>
  void DescribeAccountAttributesAsync(const DescribeAccountAttributesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeAccountAttributesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeAccountLimits that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAccountLimits that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAccountLimitsRequestT = Model::DescribeAccountLimitsRequest>
  void DescribeAccountLimitsAsync(const DescribeAccountLimitsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeAccountLimitsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConfigurationSetsOutcome DescribeConfigurationSets(
      const Model::DescribeConfigurationSetsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeConfigurationSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeConfigurationSetsRequestT = Model::DescribeConfigurationSetsRequest>
  Model::DescribeConfigurationSetsOutcomeCallable DescribeConfigurationSetsCallable(
      const DescribeConfigurationSetsRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeConfigurationSets, request);
  }

  /**
   * An Async wrapper for DescribeConfigurationSets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConfigurationSetsRequestT = Model::DescribeConfigurationSetsRequest>
  void DescribeConfigurationSetsAsync(const DescribeConfigurationSetsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeConfigurationSetsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeKeywords that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeKeywords that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeKeywordsRequestT = Model::DescribeKeywordsRequest>
  void DescribeKeywordsAsync(const DescribeKeywordsRequestT& request, const DescribeKeywordsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::DescribeKeywords, request, handler, context);
  }

  /**
   * <p>Describes the specified notify configurations or all notify configurations in
   * your account.</p> <p>If you specify notify configuration IDs, the output
   * includes information for only the specified notify configurations. If you
   * specify filters, the output includes information for only those notify
   * configurations that meet the filter criteria. If you don't specify notify
   * configuration IDs or filters, the output includes information for all notify
   * configurations.</p> <p>If you specify a notify configuration ID that isn't
   * valid, an error is returned.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/DescribeNotifyConfigurations">AWS
   * API Reference</a></p>
   */
  virtual Model::DescribeNotifyConfigurationsOutcome DescribeNotifyConfigurations(
      const Model::DescribeNotifyConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeNotifyConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeNotifyConfigurationsRequestT = Model::DescribeNotifyConfigurationsRequest>
  Model::DescribeNotifyConfigurationsOutcomeCallable DescribeNotifyConfigurationsCallable(
      const DescribeNotifyConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeNotifyConfigurations, request);
  }

  /**
   * An Async wrapper for DescribeNotifyConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeNotifyConfigurationsRequestT = Model::DescribeNotifyConfigurationsRequest>
  void DescribeNotifyConfigurationsAsync(const DescribeNotifyConfigurationsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeNotifyConfigurationsRequestT& request = {}) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::DescribeNotifyConfigurations, request, handler, context);
  }

  /**
   * <p>Describes the specified notify templates or all notify templates in your
   * account.</p> <p>If you specify template IDs, the output includes information for
   * only the specified notify templates. If you specify filters, the output includes
   ...
   * all notify templates.</p> <p>If you specify a template ID that isn't valid, an
   * error is returned.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/DescribeNotifyTemplates">AWS
   * API Reference</a></p>
   */
  virtual Model::DescribeNotifyTemplatesOutcome DescribeNotifyTemplates(const Model::DescribeNotifyTemplatesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeNotifyTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeNotifyTemplatesRequestT = Model::DescribeNotifyTemplatesRequest>
  Model::DescribeNotifyTemplatesOutcomeCallable DescribeNotifyTemplatesCallable(const DescribeNotifyTemplatesRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeNotifyTemplates, request);
  }

  /**
   * An Async wrapper for DescribeNotifyTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeNotifyTemplatesRequestT = Model::DescribeNotifyTemplatesRequest>
  void DescribeNotifyTemplatesAsync(const DescribeNotifyTemplatesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DescribeNotifyTemplatesRequestT& request = {}) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::DescribeNotifyTemplates, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DescribeOptOutLists that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeOptOutLists that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeOptOutListsRequestT = Model::DescribeOptOutListsRequest>
  void DescribeOptOutListsAsync(const DescribeOptOutListsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeOptOutListsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeOptedOutNumbers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeOptedOutNumbers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeOptedOutNumbersRequestT = Model::DescribeOptedOutNumbersRequest>
  void DescribeOptedOutNumbersAsync(const DescribeOptedOutNumbersRequestT& request,
                                    const DescribeOptedOutNumbersResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePhoneNumbers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePhoneNumbers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePhoneNumbersRequestT = Model::DescribePhoneNumbersRequest>
  void DescribePhoneNumbersAsync(const DescribePhoneNumbersResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribePhoneNumbersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribePools that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribePoolsRequestT = Model::DescribePoolsRequest>
  void DescribePoolsAsync(const DescribePoolsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const DescribePoolsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeProtectConfigurationsOutcome DescribeProtectConfigurations(
      const Model::DescribeProtectConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeProtectConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeProtectConfigurationsRequestT = Model::DescribeProtectConfigurationsRequest>
  Model::DescribeProtectConfigurationsOutcomeCallable DescribeProtectConfigurationsCallable(
      const DescribeProtectConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeProtectConfigurations, request);
  }

  /**
   * An Async wrapper for DescribeProtectConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProtectConfigurationsRequestT = Model::DescribeProtectConfigurationsRequest>
  void DescribeProtectConfigurationsAsync(const DescribeProtectConfigurationsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeProtectConfigurationsRequestT& request = {}) const {
  ...
  /**
   * <p>Retrieves the per-country launch status of an RCS agent, including
   * carrier-level details for each country.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/DescribeRcsAgentCountryLaunchStatus">AWS
   * API Reference</a></p>
   */
  virtual Model::DescribeRcsAgentCountryLaunchStatusOutcome DescribeRcsAgentCountryLaunchStatus(
      const Model::DescribeRcsAgentCountryLaunchStatusRequest& request) const;

  /**
   * A Callable wrapper for DescribeRcsAgentCountryLaunchStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeRcsAgentCountryLaunchStatusRequestT = Model::DescribeRcsAgentCountryLaunchStatusRequest>
  Model::DescribeRcsAgentCountryLaunchStatusOutcomeCallable DescribeRcsAgentCountryLaunchStatusCallable(
      const DescribeRcsAgentCountryLaunchStatusRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeRcsAgentCountryLaunchStatus, request);
  }

  /**
   * An Async wrapper for DescribeRcsAgentCountryLaunchStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeRcsAgentCountryLaunchStatusRequestT = Model::DescribeRcsAgentCountryLaunchStatusRequest>
  void DescribeRcsAgentCountryLaunchStatusAsync(const DescribeRcsAgentCountryLaunchStatusRequestT& request,
                                                const DescribeRcsAgentCountryLaunchStatusResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::DescribeRcsAgentCountryLaunchStatus, request, handler, context);
  }

  /**
   * <p>Retrieves the specified RCS agents or all RCS agents associated with your
   * Amazon Web Services account.</p> <p>If you specify RCS agent IDs, the output
   * includes information for only the specified RCS agents. If you specify filters,
   * the output includes information for only those RCS agents that meet the filter
   * criteria. If you don't specify RCS agent IDs or filters, the output includes
   * information for all RCS agents.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/DescribeRcsAgents">AWS
   * API Reference</a></p>
   */
  virtual Model::DescribeRcsAgentsOutcome DescribeRcsAgents(const Model::DescribeRcsAgentsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeRcsAgents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeRcsAgentsRequestT = Model::DescribeRcsAgentsRequest>
  Model::DescribeRcsAgentsOutcomeCallable DescribeRcsAgentsCallable(const DescribeRcsAgentsRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeRcsAgents, request);
  }

  /**
   * An Async wrapper for DescribeRcsAgents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeRcsAgentsRequestT = Model::DescribeRcsAgentsRequest>
  void DescribeRcsAgentsAsync(const DescribeRcsAgentsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeRcsAgentsRequestT& request = {}) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::DescribeRcsAgents, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRegistrationAttachmentsOutcome DescribeRegistrationAttachments(
      const Model::DescribeRegistrationAttachmentsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeRegistrationAttachments that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRegistrationAttachmentsRequestT = Model::DescribeRegistrationAttachmentsRequest>
  Model::DescribeRegistrationAttachmentsOutcomeCallable DescribeRegistrationAttachmentsCallable(
      const DescribeRegistrationAttachmentsRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeRegistrationAttachments, request);
  }

  /**
   * An Async wrapper for DescribeRegistrationAttachments that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeRegistrationAttachmentsRequestT = Model::DescribeRegistrationAttachmentsRequest>
  void DescribeRegistrationAttachmentsAsync(const DescribeRegistrationAttachmentsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DescribeRegistrationAttachmentsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRegistrationFieldDefinitionsOutcome DescribeRegistrationFieldDefinitions(
      const Model::DescribeRegistrationFieldDefinitionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeRegistrationFieldDefinitions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeRegistrationFieldDefinitionsRequestT = Model::DescribeRegistrationFieldDefinitionsRequest>
  Model::DescribeRegistrationFieldDefinitionsOutcomeCallable DescribeRegistrationFieldDefinitionsCallable(
      const DescribeRegistrationFieldDefinitionsRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeRegistrationFieldDefinitions, request);
  }

  /**
   * An Async wrapper for DescribeRegistrationFieldDefinitions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeRegistrationFieldDefinitionsRequestT = Model::DescribeRegistrationFieldDefinitionsRequest>
  void DescribeRegistrationFieldDefinitionsAsync(const DescribeRegistrationFieldDefinitionsRequestT& request,
                                                 const DescribeRegistrationFieldDefinitionsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRegistrationFieldValuesOutcome DescribeRegistrationFieldValues(
      const Model::DescribeRegistrationFieldValuesRequest& request) const;

  /**
   * A Callable wrapper for DescribeRegistrationFieldValues that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRegistrationFieldValuesRequestT = Model::DescribeRegistrationFieldValuesRequest>
  Model::DescribeRegistrationFieldValuesOutcomeCallable DescribeRegistrationFieldValuesCallable(
      const DescribeRegistrationFieldValuesRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeRegistrationFieldValues, request);
  }

  /**
   * An Async wrapper for DescribeRegistrationFieldValues that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeRegistrationFieldValuesRequestT = Model::DescribeRegistrationFieldValuesRequest>
  void DescribeRegistrationFieldValuesAsync(const DescribeRegistrationFieldValuesRequestT& request,
                                            const DescribeRegistrationFieldValuesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRegistrationSectionDefinitionsOutcome DescribeRegistrationSectionDefinitions(
      const Model::DescribeRegistrationSectionDefinitionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeRegistrationSectionDefinitions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeRegistrationSectionDefinitionsRequestT = Model::DescribeRegistrationSectionDefinitionsRequest>
  Model::DescribeRegistrationSectionDefinitionsOutcomeCallable DescribeRegistrationSectionDefinitionsCallable(
      const DescribeRegistrationSectionDefinitionsRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeRegistrationSectionDefinitions, request);
  }

  /**
   * An Async wrapper for DescribeRegistrationSectionDefinitions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeRegistrationSectionDefinitionsRequestT = Model::DescribeRegistrationSectionDefinitionsRequest>
  void DescribeRegistrationSectionDefinitionsAsync(const DescribeRegistrationSectionDefinitionsRequestT& request,
                                                   const DescribeRegistrationSectionDefinitionsResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRegistrationTypeDefinitionsOutcome DescribeRegistrationTypeDefinitions(
      const Model::DescribeRegistrationTypeDefinitionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeRegistrationTypeDefinitions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeRegistrationTypeDefinitionsRequestT = Model::DescribeRegistrationTypeDefinitionsRequest>
  Model::DescribeRegistrationTypeDefinitionsOutcomeCallable DescribeRegistrationTypeDefinitionsCallable(
      const DescribeRegistrationTypeDefinitionsRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeRegistrationTypeDefinitions, request);
  }

  /**
   * An Async wrapper for DescribeRegistrationTypeDefinitions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeRegistrationTypeDefinitionsRequestT = Model::DescribeRegistrationTypeDefinitionsRequest>
  void DescribeRegistrationTypeDefinitionsAsync(const DescribeRegistrationTypeDefinitionsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const DescribeRegistrationTypeDefinitionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRegistrationVersionsOutcome DescribeRegistrationVersions(
      const Model::DescribeRegistrationVersionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeRegistrationVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRegistrationVersionsRequestT = Model::DescribeRegistrationVersionsRequest>
  Model::DescribeRegistrationVersionsOutcomeCallable DescribeRegistrationVersionsCallable(
      const DescribeRegistrationVersionsRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeRegistrationVersions, request);
  }

  /**
   * An Async wrapper for DescribeRegistrationVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRegistrationVersionsRequestT = Model::DescribeRegistrationVersionsRequest>
  void DescribeRegistrationVersionsAsync(const DescribeRegistrationVersionsRequestT& request,
                                         const DescribeRegistrationVersionsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeRegistrations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRegistrations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRegistrationsRequestT = Model::DescribeRegistrationsRequest>
  void DescribeRegistrationsAsync(const DescribeRegistrationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeRegistrationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeSenderIds that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSenderIds that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSenderIdsRequestT = Model::DescribeSenderIdsRequest>
  void DescribeSenderIdsAsync(const DescribeSenderIdsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeSenderIdsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeSpendLimits that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSpendLimits that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSpendLimitsRequestT = Model::DescribeSpendLimitsRequest>
  void DescribeSpendLimitsAsync(const DescribeSpendLimitsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeSpendLimitsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeVerifiedDestinationNumbersOutcome DescribeVerifiedDestinationNumbers(
      const Model::DescribeVerifiedDestinationNumbersRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeVerifiedDestinationNumbers that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeVerifiedDestinationNumbersRequestT = Model::DescribeVerifiedDestinationNumbersRequest>
  Model::DescribeVerifiedDestinationNumbersOutcomeCallable DescribeVerifiedDestinationNumbersCallable(
      const DescribeVerifiedDestinationNumbersRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DescribeVerifiedDestinationNumbers, request);
  }

  /**
   * An Async wrapper for DescribeVerifiedDestinationNumbers that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeVerifiedDestinationNumbersRequestT = Model::DescribeVerifiedDestinationNumbersRequest>
  void DescribeVerifiedDestinationNumbersAsync(const DescribeVerifiedDestinationNumbersResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const DescribeVerifiedDestinationNumbersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateOriginationIdentityOutcome DisassociateOriginationIdentity(
      const Model::DisassociateOriginationIdentityRequest& request) const;

  /**
   * A Callable wrapper for DisassociateOriginationIdentity that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateOriginationIdentityRequestT = Model::DisassociateOriginationIdentityRequest>
  Model::DisassociateOriginationIdentityOutcomeCallable DisassociateOriginationIdentityCallable(
      const DisassociateOriginationIdentityRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DisassociateOriginationIdentity, request);
  }

  /**
   * An Async wrapper for DisassociateOriginationIdentity that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateOriginationIdentityRequestT = Model::DisassociateOriginationIdentityRequest>
  void DisassociateOriginationIdentityAsync(const DisassociateOriginationIdentityRequestT& request,
                                            const DisassociateOriginationIdentityResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateProtectConfigurationOutcome DisassociateProtectConfiguration(
      const Model::DisassociateProtectConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DisassociateProtectConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateProtectConfigurationRequestT = Model::DisassociateProtectConfigurationRequest>
  Model::DisassociateProtectConfigurationOutcomeCallable DisassociateProtectConfigurationCallable(
      const DisassociateProtectConfigurationRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DisassociateProtectConfiguration, request);
  }

  /**
   * An Async wrapper for DisassociateProtectConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateProtectConfigurationRequestT = Model::DisassociateProtectConfigurationRequest>
  void DisassociateProtectConfigurationAsync(const DisassociateProtectConfigurationRequestT& request,
                                             const DisassociateProtectConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DiscardRegistrationVersionOutcome DiscardRegistrationVersion(
      const Model::DiscardRegistrationVersionRequest& request) const;

  /**
   * A Callable wrapper for DiscardRegistrationVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DiscardRegistrationVersionRequestT = Model::DiscardRegistrationVersionRequest>
  Model::DiscardRegistrationVersionOutcomeCallable DiscardRegistrationVersionCallable(
      const DiscardRegistrationVersionRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::DiscardRegistrationVersion, request);
  }

  /**
   * An Async wrapper for DiscardRegistrationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DiscardRegistrationVersionRequestT = Model::DiscardRegistrationVersionRequest>
  void DiscardRegistrationVersionAsync(const DiscardRegistrationVersionRequestT& request,
                                       const DiscardRegistrationVersionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetProtectConfigurationCountryRuleSetOutcome GetProtectConfigurationCountryRuleSet(
      const Model::GetProtectConfigurationCountryRuleSetRequest& request) const;

  /**
   * A Callable wrapper for GetProtectConfigurationCountryRuleSet that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetProtectConfigurationCountryRuleSetRequestT = Model::GetProtectConfigurationCountryRuleSetRequest>
  Model::GetProtectConfigurationCountryRuleSetOutcomeCallable GetProtectConfigurationCountryRuleSetCallable(
      const GetProtectConfigurationCountryRuleSetRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::GetProtectConfigurationCountryRuleSet, request);
  }

  /**
   * An Async wrapper for GetProtectConfigurationCountryRuleSet that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetProtectConfigurationCountryRuleSetRequestT = Model::GetProtectConfigurationCountryRuleSetRequest>
  void GetProtectConfigurationCountryRuleSetAsync(const GetProtectConfigurationCountryRuleSetRequestT& request,
                                                  const GetProtectConfigurationCountryRuleSetResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListNotifyCountriesOutcome ListNotifyCountries(const Model::ListNotifyCountriesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListNotifyCountries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListNotifyCountriesRequestT = Model::ListNotifyCountriesRequest>
  Model::ListNotifyCountriesOutcomeCallable ListNotifyCountriesCallable(const ListNotifyCountriesRequestT& request = {}) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::ListNotifyCountries, request);
  }

  /**
   * An Async wrapper for ListNotifyCountries that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListNotifyCountriesRequestT = Model::ListNotifyCountriesRequest>
  void ListNotifyCountriesAsync(const ListNotifyCountriesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListNotifyCountriesRequestT& request = {}) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::ListNotifyCountries, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPoolOriginationIdentitiesOutcome ListPoolOriginationIdentities(
      const Model::ListPoolOriginationIdentitiesRequest& request) const;

  /**
   * A Callable wrapper for ListPoolOriginationIdentities that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPoolOriginationIdentitiesRequestT = Model::ListPoolOriginationIdentitiesRequest>
  Model::ListPoolOriginationIdentitiesOutcomeCallable ListPoolOriginationIdentitiesCallable(
      const ListPoolOriginationIdentitiesRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::ListPoolOriginationIdentities, request);
  }

  /**
   * An Async wrapper for ListPoolOriginationIdentities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPoolOriginationIdentitiesRequestT = Model::ListPoolOriginationIdentitiesRequest>
  void ListPoolOriginationIdentitiesAsync(const ListPoolOriginationIdentitiesRequestT& request,
                                          const ListPoolOriginationIdentitiesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListProtectConfigurationRuleSetNumberOverridesOutcome ListProtectConfigurationRuleSetNumberOverrides(
      const Model::ListProtectConfigurationRuleSetNumberOverridesRequest& request) const;

  /**
   * A Callable wrapper for ListProtectConfigurationRuleSetNumberOverrides that returns a future to the operation so that it can be executed
  ...
  Model::ListProtectConfigurationRuleSetNumberOverridesOutcomeCallable ListProtectConfigurationRuleSetNumberOverridesCallable(
      const ListProtectConfigurationRuleSetNumberOverridesRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::ListProtectConfigurationRuleSetNumberOverrides, request);
  }

  /**
   * An Async wrapper for ListProtectConfigurationRuleSetNumberOverrides that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename ListProtectConfigurationRuleSetNumberOverridesRequestT = Model::ListProtectConfigurationRuleSetNumberOverridesRequest>
  void ListProtectConfigurationRuleSetNumberOverridesAsync(
      const ListProtectConfigurationRuleSetNumberOverridesRequestT& request,
      const ListProtectConfigurationRuleSetNumberOverridesResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRegistrationAssociationsOutcome ListRegistrationAssociations(
      const Model::ListRegistrationAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListRegistrationAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRegistrationAssociationsRequestT = Model::ListRegistrationAssociationsRequest>
  Model::ListRegistrationAssociationsOutcomeCallable ListRegistrationAssociationsCallable(
      const ListRegistrationAssociationsRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::ListRegistrationAssociations, request);
  }

  /**
   * An Async wrapper for ListRegistrationAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRegistrationAssociationsRequestT = Model::ListRegistrationAssociationsRequest>
  void ListRegistrationAssociationsAsync(const ListRegistrationAssociationsRequestT& request,
                                         const ListRegistrationAssociationsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutKeyword that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutKeywordRequestT = Model::PutKeywordRequest>
  void PutKeywordAsync(const PutKeywordRequestT& request, const PutKeywordResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutMessageFeedback that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutMessageFeedback that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutMessageFeedbackRequestT = Model::PutMessageFeedbackRequest>
  void PutMessageFeedbackAsync(const PutMessageFeedbackRequestT& request, const PutMessageFeedbackResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutOptedOutNumber that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutOptedOutNumber that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutOptedOutNumberRequestT = Model::PutOptedOutNumberRequest>
  void PutOptedOutNumberAsync(const PutOptedOutNumberRequestT& request, const PutOptedOutNumberResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutProtectConfigurationRuleSetNumberOverrideOutcome PutProtectConfigurationRuleSetNumberOverride(
      const Model::PutProtectConfigurationRuleSetNumberOverrideRequest& request) const;

  /**
   * A Callable wrapper for PutProtectConfigurationRuleSetNumberOverride that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::PutProtectConfigurationRuleSetNumberOverrideOutcomeCallable PutProtectConfigurationRuleSetNumberOverrideCallable(
      const PutProtectConfigurationRuleSetNumberOverrideRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::PutProtectConfigurationRuleSetNumberOverride, request);
  }

  /**
   * An Async wrapper for PutProtectConfigurationRuleSetNumberOverride that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename PutProtectConfigurationRuleSetNumberOverrideRequestT = Model::PutProtectConfigurationRuleSetNumberOverrideRequest>
  void PutProtectConfigurationRuleSetNumberOverrideAsync(
      const PutProtectConfigurationRuleSetNumberOverrideRequestT& request,
      const PutProtectConfigurationRuleSetNumberOverrideResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutRegistrationFieldValue that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename PutRegistrationFieldValueRequestT = Model::PutRegistrationFieldValueRequest>
  Model::PutRegistrationFieldValueOutcomeCallable PutRegistrationFieldValueCallable(
      const PutRegistrationFieldValueRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::PutRegistrationFieldValue, request);
  }

  /**
   * An Async wrapper for PutRegistrationFieldValue that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRegistrationFieldValueRequestT = Model::PutRegistrationFieldValueRequest>
  void PutRegistrationFieldValueAsync(const PutRegistrationFieldValueRequestT& request,
                                      const PutRegistrationFieldValueResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ReleaseSenderId that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ReleaseSenderIdRequestT = Model::ReleaseSenderIdRequest>
  void ReleaseSenderIdAsync(const ReleaseSenderIdRequestT& request, const ReleaseSenderIdResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RequestPhoneNumber that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RequestPhoneNumber that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RequestPhoneNumberRequestT = Model::RequestPhoneNumberRequest>
  void RequestPhoneNumberAsync(const RequestPhoneNumberRequestT& request, const RequestPhoneNumberResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RequestSenderId that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RequestSenderIdRequestT = Model::RequestSenderIdRequest>
  void RequestSenderIdAsync(const RequestSenderIdRequestT& request, const RequestSenderIdResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SendDestinationNumberVerificationCodeOutcome SendDestinationNumberVerificationCode(
      const Model::SendDestinationNumberVerificationCodeRequest& request) const;

  /**
   * A Callable wrapper for SendDestinationNumberVerificationCode that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename SendDestinationNumberVerificationCodeRequestT = Model::SendDestinationNumberVerificationCodeRequest>
  Model::SendDestinationNumberVerificationCodeOutcomeCallable SendDestinationNumberVerificationCodeCallable(
      const SendDestinationNumberVerificationCodeRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::SendDestinationNumberVerificationCode, request);
  }

  /**
   * An Async wrapper for SendDestinationNumberVerificationCode that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename SendDestinationNumberVerificationCodeRequestT = Model::SendDestinationNumberVerificationCodeRequest>
  void SendDestinationNumberVerificationCodeAsync(const SendDestinationNumberVerificationCodeRequestT& request,
                                                  const SendDestinationNumberVerificationCodeResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendMediaMessage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendMediaMessage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SendMediaMessageRequestT = Model::SendMediaMessageRequest>
  void SendMediaMessageAsync(const SendMediaMessageRequestT& request, const SendMediaMessageResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::SendMediaMessage, request, handler, context);
  }

  /**
   * <p>Sends a templated text message through a notify configuration to a
   * recipient's phone number.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/SendNotifyTextMessage">AWS
   * API Reference</a></p>
   */
  virtual Model::SendNotifyTextMessageOutcome SendNotifyTextMessage(const Model::SendNotifyTextMessageRequest& request) const;

  /**
   * A Callable wrapper for SendNotifyTextMessage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SendNotifyTextMessageRequestT = Model::SendNotifyTextMessageRequest>
  Model::SendNotifyTextMessageOutcomeCallable SendNotifyTextMessageCallable(const SendNotifyTextMessageRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::SendNotifyTextMessage, request);
  }

  /**
   * An Async wrapper for SendNotifyTextMessage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendNotifyTextMessageRequestT = Model::SendNotifyTextMessageRequest>
  void SendNotifyTextMessageAsync(const SendNotifyTextMessageRequestT& request, const SendNotifyTextMessageResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::SendNotifyTextMessage, request, handler, context);
  }

  /**
   * <p>Sends a templated voice message through a notify configuration to a
   * recipient's phone number.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/SendNotifyVoiceMessage">AWS
   * API Reference</a></p>
   */
  virtual Model::SendNotifyVoiceMessageOutcome SendNotifyVoiceMessage(const Model::SendNotifyVoiceMessageRequest& request) const;

  /**
   * A Callable wrapper for SendNotifyVoiceMessage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SendNotifyVoiceMessageRequestT = Model::SendNotifyVoiceMessageRequest>
  Model::SendNotifyVoiceMessageOutcomeCallable SendNotifyVoiceMessageCallable(const SendNotifyVoiceMessageRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::SendNotifyVoiceMessage, request);
  }

  /**
   * An Async wrapper for SendNotifyVoiceMessage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendNotifyVoiceMessageRequestT = Model::SendNotifyVoiceMessageRequest>
  void SendNotifyVoiceMessageAsync(const SendNotifyVoiceMessageRequestT& request,
                                   const SendNotifyVoiceMessageResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::SendNotifyVoiceMessage, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for SendTextMessage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendTextMessageRequestT = Model::SendTextMessageRequest>
  void SendTextMessageAsync(const SendTextMessageRequestT& request, const SendTextMessageResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename SendVoiceMessageRequestT = Model::SendVoiceMessageRequest>
  void SendVoiceMessageAsync(const SendVoiceMessageRequestT& request, const SendVoiceMessageResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SetAccountDefaultProtectConfigurationOutcome SetAccountDefaultProtectConfiguration(
      const Model::SetAccountDefaultProtectConfigurationRequest& request) const;

  /**
   * A Callable wrapper for SetAccountDefaultProtectConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename SetAccountDefaultProtectConfigurationRequestT = Model::SetAccountDefaultProtectConfigurationRequest>
  Model::SetAccountDefaultProtectConfigurationOutcomeCallable SetAccountDefaultProtectConfigurationCallable(
      const SetAccountDefaultProtectConfigurationRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::SetAccountDefaultProtectConfiguration, request);
  }

  /**
   * An Async wrapper for SetAccountDefaultProtectConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename SetAccountDefaultProtectConfigurationRequestT = Model::SetAccountDefaultProtectConfigurationRequest>
  void SetAccountDefaultProtectConfigurationAsync(const SetAccountDefaultProtectConfigurationRequestT& request,
                                                  const SetAccountDefaultProtectConfigurationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SetDefaultMessageFeedbackEnabledOutcome SetDefaultMessageFeedbackEnabled(
      const Model::SetDefaultMessageFeedbackEnabledRequest& request) const;

  /**
   * A Callable wrapper for SetDefaultMessageFeedbackEnabled that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename SetDefaultMessageFeedbackEnabledRequestT = Model::SetDefaultMessageFeedbackEnabledRequest>
  Model::SetDefaultMessageFeedbackEnabledOutcomeCallable SetDefaultMessageFeedbackEnabledCallable(
      const SetDefaultMessageFeedbackEnabledRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::SetDefaultMessageFeedbackEnabled, request);
  }

  /**
   * An Async wrapper for SetDefaultMessageFeedbackEnabled that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SetDefaultMessageFeedbackEnabledRequestT = Model::SetDefaultMessageFeedbackEnabledRequest>
  void SetDefaultMessageFeedbackEnabledAsync(const SetDefaultMessageFeedbackEnabledRequestT& request,
                                             const SetDefaultMessageFeedbackEnabledResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetDefaultMessageType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetDefaultMessageType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetDefaultMessageTypeRequestT = Model::SetDefaultMessageTypeRequest>
  void SetDefaultMessageTypeAsync(const SetDefaultMessageTypeRequestT& request, const SetDefaultMessageTypeResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetDefaultSenderId that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetDefaultSenderId that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetDefaultSenderIdRequestT = Model::SetDefaultSenderIdRequest>
  void SetDefaultSenderIdAsync(const SetDefaultSenderIdRequestT& request, const SetDefaultSenderIdResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SetMediaMessageSpendLimitOverrideOutcome SetMediaMessageSpendLimitOverride(
      const Model::SetMediaMessageSpendLimitOverrideRequest& request) const;

  /**
   * A Callable wrapper for SetMediaMessageSpendLimitOverride that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename SetMediaMessageSpendLimitOverrideRequestT = Model::SetMediaMessageSpendLimitOverrideRequest>
  Model::SetMediaMessageSpendLimitOverrideOutcomeCallable SetMediaMessageSpendLimitOverrideCallable(
      const SetMediaMessageSpendLimitOverrideRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::SetMediaMessageSpendLimitOverride, request);
  }

  /**
   * An Async wrapper for SetMediaMessageSpendLimitOverride that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SetMediaMessageSpendLimitOverrideRequestT = Model::SetMediaMessageSpendLimitOverrideRequest>
  void SetMediaMessageSpendLimitOverrideAsync(const SetMediaMessageSpendLimitOverrideRequestT& request,
                                              const SetMediaMessageSpendLimitOverrideResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::SetMediaMessageSpendLimitOverride, request, handler, context);
  }

  /**
   * <p>Sets an account level monthly spend limit override for sending notify
   * messages. The requested spend limit must be less than or equal to the
   * <code>MaxLimit</code>, which is set by Amazon Web Services. </p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/SetNotifyMessageSpendLimitOverride">AWS
   * API Reference</a></p>
   */
  virtual Model::SetNotifyMessageSpendLimitOverrideOutcome SetNotifyMessageSpendLimitOverride(
      const Model::SetNotifyMessageSpendLimitOverrideRequest& request) const;

  /**
   * A Callable wrapper for SetNotifyMessageSpendLimitOverride that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename SetNotifyMessageSpendLimitOverrideRequestT = Model::SetNotifyMessageSpendLimitOverrideRequest>
  Model::SetNotifyMessageSpendLimitOverrideOutcomeCallable SetNotifyMessageSpendLimitOverrideCallable(
      const SetNotifyMessageSpendLimitOverrideRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::SetNotifyMessageSpendLimitOverride, request);
  }

  /**
   * An Async wrapper for SetNotifyMessageSpendLimitOverride that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SetNotifyMessageSpendLimitOverrideRequestT = Model::SetNotifyMessageSpendLimitOverrideRequest>
  void SetNotifyMessageSpendLimitOverrideAsync(const SetNotifyMessageSpendLimitOverrideRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SetTextMessageSpendLimitOverrideOutcome SetTextMessageSpendLimitOverride(
      const Model::SetTextMessageSpendLimitOverrideRequest& request) const;

  /**
   * A Callable wrapper for SetTextMessageSpendLimitOverride that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename SetTextMessageSpendLimitOverrideRequestT = Model::SetTextMessageSpendLimitOverrideRequest>
  Model::SetTextMessageSpendLimitOverrideOutcomeCallable SetTextMessageSpendLimitOverrideCallable(
      const SetTextMessageSpendLimitOverrideRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::SetTextMessageSpendLimitOverride, request);
  }

  /**
   * An Async wrapper for SetTextMessageSpendLimitOverride that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SetTextMessageSpendLimitOverrideRequestT = Model::SetTextMessageSpendLimitOverrideRequest>
  void SetTextMessageSpendLimitOverrideAsync(const SetTextMessageSpendLimitOverrideRequestT& request,
                                             const SetTextMessageSpendLimitOverrideResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SetVoiceMessageSpendLimitOverrideOutcome SetVoiceMessageSpendLimitOverride(
      const Model::SetVoiceMessageSpendLimitOverrideRequest& request) const;

  /**
   * A Callable wrapper for SetVoiceMessageSpendLimitOverride that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename SetVoiceMessageSpendLimitOverrideRequestT = Model::SetVoiceMessageSpendLimitOverrideRequest>
  Model::SetVoiceMessageSpendLimitOverrideOutcomeCallable SetVoiceMessageSpendLimitOverrideCallable(
      const SetVoiceMessageSpendLimitOverrideRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::SetVoiceMessageSpendLimitOverride, request);
  }

  /**
   * An Async wrapper for SetVoiceMessageSpendLimitOverride that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SetVoiceMessageSpendLimitOverrideRequestT = Model::SetVoiceMessageSpendLimitOverrideRequest>
  void SetVoiceMessageSpendLimitOverrideAsync(const SetVoiceMessageSpendLimitOverrideRequestT& request,
                                              const SetVoiceMessageSpendLimitOverrideResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SubmitRegistrationVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SubmitRegistrationVersionRequestT = Model::SubmitRegistrationVersionRequest>
  Model::SubmitRegistrationVersionOutcomeCallable SubmitRegistrationVersionCallable(
      const SubmitRegistrationVersionRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::SubmitRegistrationVersion, request);
  }

  /**
   * An Async wrapper for SubmitRegistrationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SubmitRegistrationVersionRequestT = Model::SubmitRegistrationVersionRequest>
  void SubmitRegistrationVersionAsync(const SubmitRegistrationVersionRequestT& request,
                                      const SubmitRegistrationVersionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEventDestination that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEventDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEventDestinationRequestT = Model::UpdateEventDestinationRequest>
  void UpdateEventDestinationAsync(const UpdateEventDestinationRequestT& request,
                                   const UpdateEventDestinationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::UpdateEventDestination, request, handler, context);
  }

  /**
   * <p>Updates an existing notify configuration. You can update the default
   * template, pool association, enabled channels, enabled countries, and deletion
   * protection settings.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/UpdateNotifyConfiguration">AWS
   * API Reference</a></p>
   */
  virtual Model::UpdateNotifyConfigurationOutcome UpdateNotifyConfiguration(const Model::UpdateNotifyConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateNotifyConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateNotifyConfigurationRequestT = Model::UpdateNotifyConfigurationRequest>
  Model::UpdateNotifyConfigurationOutcomeCallable UpdateNotifyConfigurationCallable(
      const UpdateNotifyConfigurationRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::UpdateNotifyConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateNotifyConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateNotifyConfigurationRequestT = Model::UpdateNotifyConfigurationRequest>
  void UpdateNotifyConfigurationAsync(const UpdateNotifyConfigurationRequestT& request,
                                      const UpdateNotifyConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::UpdateNotifyConfiguration, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for UpdatePool that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdatePoolRequestT = Model::UpdatePoolRequest>
  void UpdatePoolAsync(const UpdatePoolRequestT& request, const UpdatePoolResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateProtectConfigurationOutcome UpdateProtectConfiguration(
      const Model::UpdateProtectConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateProtectConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateProtectConfigurationRequestT = Model::UpdateProtectConfigurationRequest>
  Model::UpdateProtectConfigurationOutcomeCallable UpdateProtectConfigurationCallable(
      const UpdateProtectConfigurationRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::UpdateProtectConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateProtectConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateProtectConfigurationRequestT = Model::UpdateProtectConfigurationRequest>
  void UpdateProtectConfigurationAsync(const UpdateProtectConfigurationRequestT& request,
                                       const UpdateProtectConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateProtectConfigurationCountryRuleSetOutcome UpdateProtectConfigurationCountryRuleSet(
      const Model::UpdateProtectConfigurationCountryRuleSetRequest& request) const;

  /**
   * A Callable wrapper for UpdateProtectConfigurationCountryRuleSet that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateProtectConfigurationCountryRuleSetRequestT = Model::UpdateProtectConfigurationCountryRuleSetRequest>
  Model::UpdateProtectConfigurationCountryRuleSetOutcomeCallable UpdateProtectConfigurationCountryRuleSetCallable(
      const UpdateProtectConfigurationCountryRuleSetRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::UpdateProtectConfigurationCountryRuleSet, request);
  }

  /**
   * An Async wrapper for UpdateProtectConfigurationCountryRuleSet that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateProtectConfigurationCountryRuleSetRequestT = Model::UpdateProtectConfigurationCountryRuleSetRequest>
  void UpdateProtectConfigurationCountryRuleSetAsync(
      const UpdateProtectConfigurationCountryRuleSetRequestT& request,
      const UpdateProtectConfigurationCountryRuleSetResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::UpdateProtectConfigurationCountryRuleSet, request, handler, context);
  }

  /**
   * <p>Updates the configuration of an existing RCS agent. You can update the
   * opt-out list, deletion protection, two-way messaging settings, and self-managed
   * opt-outs configuration.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/UpdateRcsAgent">AWS
   * API Reference</a></p>
   */
  virtual Model::UpdateRcsAgentOutcome UpdateRcsAgent(const Model::UpdateRcsAgentRequest& request) const;

  /**
   * A Callable wrapper for UpdateRcsAgent that returns a future to the operation so that it can be executed in parallel to other requests.
   */
  template <typename UpdateRcsAgentRequestT = Model::UpdateRcsAgentRequest>
  Model::UpdateRcsAgentOutcomeCallable UpdateRcsAgentCallable(const UpdateRcsAgentRequestT& request) const {
    return SubmitCallable(&PinpointSMSVoiceV2Client::UpdateRcsAgent, request);
  }

  /**
   * An Async wrapper for UpdateRcsAgent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRcsAgentRequestT = Model::UpdateRcsAgentRequest>
  void UpdateRcsAgentAsync(const UpdateRcsAgentRequestT& request, const UpdateRcsAgentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::UpdateRcsAgent, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for UpdateSenderId that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSenderIdRequestT = Model::UpdateSenderIdRequest>
  void UpdateSenderIdAsync(const UpdateSenderIdRequestT& request, const UpdateSenderIdResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for VerifyDestinationNumber that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for VerifyDestinationNumber that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename VerifyDestinationNumberRequestT = Model::VerifyDestinationNumberRequest>
  void VerifyDestinationNumberAsync(const VerifyDestinationNumberRequestT& request,
                                    const VerifyDestinationNumberResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&PinpointSMSVoiceV2Client::VerifyDestinationNumber, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<PinpointSMSVoiceV2EndpointProviderBase>& accessEndpointProvider();
 ...
 private:
  ...
  typedef Aws::Utils::Outcome<Aws::AmazonWebServiceResult<RESPONSE>, PinpointSMSVoiceV2Error> InvokeOperationOutcome;
