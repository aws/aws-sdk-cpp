...
class DescribeRegistrationVersionsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename RegistrationIdT = Aws::String>
  DescribeRegistrationVersionsRequest& WithRegistrationId(RegistrationIdT&& value) {
  ...
  void SetVersionNumbers(VersionNumbersT&& value) {
    m_versionNumbersHasBeenSet = true;
    m_versionNumbers = std::forward<VersionNumbersT>(value);
  }
  template <typename VersionNumbersT = Aws::Vector<long long>>
  DescribeRegistrationVersionsRequest& WithVersionNumbers(VersionNumbersT&& value) {
    SetVersionNumbers(std::forward<VersionNumbersT>(value));
    return *this;
  }
  inline DescribeRegistrationVersionsRequest& AddVersionNumbers(long long value) {
    m_versionNumbersHasBeenSet = true;
    m_versionNumbers.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<RegistrationVersionFilter>>
  DescribeRegistrationVersionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = RegistrationVersionFilter>
  DescribeRegistrationVersionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeRegistrationVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
