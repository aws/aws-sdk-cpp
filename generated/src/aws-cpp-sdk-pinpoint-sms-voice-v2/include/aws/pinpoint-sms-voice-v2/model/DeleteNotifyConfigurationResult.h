...
class DeleteNotifyConfigurationResult {
 public:
  AWS_PINPOINTSMSVOICEV2_API DeleteNotifyConfigurationResult() = default;
  AWS_PINPOINTSMSVOICEV2_API DeleteNotifyConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PINPOINTSMSVOICEV2_API DeleteNotifyConfigurationResult& operator=(
  ...
  template <typename NotifyConfigurationArnT = Aws::String>
  DeleteNotifyConfigurationResult& WithNotifyConfigurationArn(NotifyConfigurationArnT&& value) {
  ...
  template <typename NotifyConfigurationIdT = Aws::String>
  DeleteNotifyConfigurationResult& WithNotifyConfigurationId(NotifyConfigurationIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  DeleteNotifyConfigurationResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline DeleteNotifyConfigurationResult& WithUseCase(NotifyConfigurationUseCase value) {
    SetUseCase(value);
    return *this;
  }
  ///@}
  ...
  template <typename DefaultTemplateIdT = Aws::String>
  DeleteNotifyConfigurationResult& WithDefaultTemplateId(DefaultTemplateIdT&& value) {
  ...
  template <typename PoolIdT = Aws::String>
  DeleteNotifyConfigurationResult& WithPoolId(PoolIdT&& value) {
  ...
  template <typename EnabledCountriesT = Aws::Vector<Aws::String>>
  DeleteNotifyConfigurationResult& WithEnabledCountries(EnabledCountriesT&& value) {
    SetEnabledCountries(std::forward<EnabledCountriesT>(value));
    return *this;
  }
  template <typename EnabledCountriesT = Aws::String>
  DeleteNotifyConfigurationResult& AddEnabledCountries(EnabledCountriesT&& value) {
    m_enabledCountriesHasBeenSet = true;
  ...
  template <typename EnabledChannelsT = Aws::Vector<NumberCapability>>
  DeleteNotifyConfigurationResult& WithEnabledChannels(EnabledChannelsT&& value) {
    SetEnabledChannels(std::forward<EnabledChannelsT>(value));
    return *this;
  }
  inline DeleteNotifyConfigurationResult& AddEnabledChannels(NumberCapability value) {
    m_enabledChannelsHasBeenSet = true;
  ...
  inline DeleteNotifyConfigurationResult& WithTier(NotifyConfigurationTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteNotifyConfigurationResult& WithTierUpgradeStatus(TierUpgradeStatus value) {
  ...
  inline DeleteNotifyConfigurationResult& WithStatus(NotifyConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RejectionReasonT = Aws::String>
  DeleteNotifyConfigurationResult& WithRejectionReason(RejectionReasonT&& value) {
  ...
  inline DeleteNotifyConfigurationResult& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  DeleteNotifyConfigurationResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteNotifyConfigurationResult& WithRequestId(RequestIdT&& value) {
