...
class CreateOptOutListRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename OptOutListNameT = Aws::String>
  CreateOptOutListRequest& WithOptOutListName(OptOutListNameT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateOptOutListRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateOptOutListRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateOptOutListRequest& WithClientToken(ClientTokenT&& value) {
