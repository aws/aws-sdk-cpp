...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINTSMSVOICEV2_API SubmitRegistrationVersionResult() = default;
    ...
    template<typename RegistrationArnT = Aws::String>
    SubmitRegistrationVersionResult& WithRegistrationArn(RegistrationArnT&& value) { SetRegistrationArn(std::forward<RegistrationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RegistrationIdT = Aws::String>
    SubmitRegistrationVersionResult& WithRegistrationId(RegistrationIdT&& value) { SetRegistrationId(std::forward<RegistrationIdT>(value)); return *this;}
    ///@}
    ...
    inline SubmitRegistrationVersionResult& WithRegistrationVersionStatus(RegistrationVersionStatus value) { SetRegistrationVersionStatus(value); return *this;}
    ///@}
    ...
    template<typename RegistrationVersionStatusHistoryT = RegistrationVersionStatusHistory>
    SubmitRegistrationVersionResult& WithRegistrationVersionStatusHistory(RegistrationVersionStatusHistoryT&& value) { SetRegistrationVersionStatusHistory(std::forward<RegistrationVersionStatusHistoryT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SubmitRegistrationVersionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
