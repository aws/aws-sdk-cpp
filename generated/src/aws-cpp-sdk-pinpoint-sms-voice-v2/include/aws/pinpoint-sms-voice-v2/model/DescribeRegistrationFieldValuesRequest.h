...
class DescribeRegistrationFieldValuesRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename RegistrationIdT = Aws::String>
  DescribeRegistrationFieldValuesRequest& WithRegistrationId(RegistrationIdT&& value) {
  ...
  inline DescribeRegistrationFieldValuesRequest& WithVersionNumber(long long value) {
  ...
  template <typename SectionPathT = Aws::String>
  DescribeRegistrationFieldValuesRequest& WithSectionPath(SectionPathT&& value) {
  ...
  template <typename FieldPathsT = Aws::Vector<Aws::String>>
  DescribeRegistrationFieldValuesRequest& WithFieldPaths(FieldPathsT&& value) {
    SetFieldPaths(std::forward<FieldPathsT>(value));
    return *this;
  }
  template <typename FieldPathsT = Aws::String>
  DescribeRegistrationFieldValuesRequest& AddFieldPaths(FieldPathsT&& value) {
    m_fieldPathsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationFieldValuesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeRegistrationFieldValuesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
