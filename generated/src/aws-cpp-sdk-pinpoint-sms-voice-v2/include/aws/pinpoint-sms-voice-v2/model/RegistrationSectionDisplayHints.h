...
class RegistrationSectionDisplayHints {
 public:
  ...
  template <typename TitleT = Aws::String>
  RegistrationSectionDisplayHints& WithTitle(TitleT&& value) {
  ...
  template <typename ShortDescriptionT = Aws::String>
  RegistrationSectionDisplayHints& WithShortDescription(ShortDescriptionT&& value) {
  ...
  template <typename LongDescriptionT = Aws::String>
  RegistrationSectionDisplayHints& WithLongDescription(LongDescriptionT&& value) {
  ...
  template <typename DocumentationTitleT = Aws::String>
  RegistrationSectionDisplayHints& WithDocumentationTitle(DocumentationTitleT&& value) {
  ...
  template <typename DocumentationLinkT = Aws::String>
  RegistrationSectionDisplayHints& WithDocumentationLink(DocumentationLinkT&& value) {
