...
class PutProtectConfigurationRuleSetNumberOverrideResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API PutProtectConfigurationRuleSetNumberOverrideResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PINPOINTSMSVOICEV2_API PutProtectConfigurationRuleSetNumberOverrideResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetProtectConfigurationArn(ProtectConfigurationArnT&& value) {
    m_protectConfigurationArnHasBeenSet = true;
    m_protectConfigurationArn = std::forward<ProtectConfigurationArnT>(value);
  }
  template <typename ProtectConfigurationArnT = Aws::String>
  PutProtectConfigurationRuleSetNumberOverrideResult& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) {
    SetProtectConfigurationArn(std::forward<ProtectConfigurationArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  PutProtectConfigurationRuleSetNumberOverrideResult& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename DestinationPhoneNumberT = Aws::String>
  PutProtectConfigurationRuleSetNumberOverrideResult& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  PutProtectConfigurationRuleSetNumberOverrideResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  inline void SetAction(ProtectConfigurationRuleOverrideAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline PutProtectConfigurationRuleSetNumberOverrideResult& WithAction(ProtectConfigurationRuleOverrideAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename IsoCountryCodeT = Aws::String>
  PutProtectConfigurationRuleSetNumberOverrideResult& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  template <typename ExpirationTimestampT = Aws::Utils::DateTime>
  PutProtectConfigurationRuleSetNumberOverrideResult& WithExpirationTimestamp(ExpirationTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutProtectConfigurationRuleSetNumberOverrideResult& WithRequestId(RequestIdT&& value) {
