...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINTSMSVOICEV2_API PutProtectConfigurationRuleSetNumberOverrideResult() = default;
    AWS_PINPOINTSMSVOICEV2_API PutProtectConfigurationRuleSetNumberOverrideResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_PINPOINTSMSVOICEV2_API PutProtectConfigurationRuleSetNumberOverrideResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename ProtectConfigurationArnT = Aws::String>
    PutProtectConfigurationRuleSetNumberOverrideResult& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) { SetProtectConfigurationArn(std::forward<ProtectConfigurationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ProtectConfigurationIdT = Aws::String>
    PutProtectConfigurationRuleSetNumberOverrideResult& WithProtectConfigurationId(ProtectConfigurationIdT&& value) { SetProtectConfigurationId(std::forward<ProtectConfigurationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationPhoneNumberT = Aws::String>
    PutProtectConfigurationRuleSetNumberOverrideResult& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) { SetDestinationPhoneNumber(std::forward<DestinationPhoneNumberT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedTimestampT = Aws::Utils::DateTime>
    PutProtectConfigurationRuleSetNumberOverrideResult& WithCreatedTimestamp(CreatedTimestampT&& value) { SetCreatedTimestamp(std::forward<CreatedTimestampT>(value)); return *this;}
    ///@}
    ...
    inline PutProtectConfigurationRuleSetNumberOverrideResult& WithAction(ProtectConfigurationRuleOverrideAction value) { SetAction(value); return *this;}
    ///@}
    ...
    template<typename IsoCountryCodeT = Aws::String>
    PutProtectConfigurationRuleSetNumberOverrideResult& WithIsoCountryCode(IsoCountryCodeT&& value) { SetIsoCountryCode(std::forward<IsoCountryCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename ExpirationTimestampT = Aws::Utils::DateTime>
    PutProtectConfigurationRuleSetNumberOverrideResult& WithExpirationTimestamp(ExpirationTimestampT&& value) { SetExpirationTimestamp(std::forward<ExpirationTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutProtectConfigurationRuleSetNumberOverrideResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
