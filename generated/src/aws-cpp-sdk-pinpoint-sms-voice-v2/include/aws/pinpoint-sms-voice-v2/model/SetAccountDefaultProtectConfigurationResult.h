...
class SetAccountDefaultProtectConfigurationResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API SetAccountDefaultProtectConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetDefaultProtectConfigurationArn(DefaultProtectConfigurationArnT&& value) {
    m_defaultProtectConfigurationArnHasBeenSet = true;
    m_defaultProtectConfigurationArn = std::forward<DefaultProtectConfigurationArnT>(value);
  }
  template <typename DefaultProtectConfigurationArnT = Aws::String>
  SetAccountDefaultProtectConfigurationResult& WithDefaultProtectConfigurationArn(DefaultProtectConfigurationArnT&& value) {
    SetDefaultProtectConfigurationArn(std::forward<DefaultProtectConfigurationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultProtectConfigurationId(DefaultProtectConfigurationIdT&& value) {
    m_defaultProtectConfigurationIdHasBeenSet = true;
    m_defaultProtectConfigurationId = std::forward<DefaultProtectConfigurationIdT>(value);
  }
  template <typename DefaultProtectConfigurationIdT = Aws::String>
  SetAccountDefaultProtectConfigurationResult& WithDefaultProtectConfigurationId(DefaultProtectConfigurationIdT&& value) {
    SetDefaultProtectConfigurationId(std::forward<DefaultProtectConfigurationIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  SetAccountDefaultProtectConfigurationResult& WithRequestId(RequestIdT&& value) {
