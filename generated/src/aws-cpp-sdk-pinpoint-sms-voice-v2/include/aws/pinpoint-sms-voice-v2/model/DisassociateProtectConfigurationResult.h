...
class DisassociateProtectConfigurationResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DisassociateProtectConfigurationResult& operator=(
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  DisassociateProtectConfigurationResult& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  DisassociateProtectConfigurationResult& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename ProtectConfigurationArnT = Aws::String>
  DisassociateProtectConfigurationResult& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) {
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  DisassociateProtectConfigurationResult& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateProtectConfigurationResult& WithRequestId(RequestIdT&& value) {
