...
namespace Model
{
  ...
  public:
    ...
    inline CreateEventDestinationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateEventDestinationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateEventDestinationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
