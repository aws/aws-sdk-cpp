...
class CreateEventDestinationResult {
 public:
  AWS_PINPOINTSMSVOICEV2_API CreateEventDestinationResult() = default;
  AWS_PINPOINTSMSVOICEV2_API CreateEventDestinationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PINPOINTSMSVOICEV2_API CreateEventDestinationResult& operator=(
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  CreateEventDestinationResult& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  CreateEventDestinationResult& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename EventDestinationT = EventDestination>
  CreateEventDestinationResult& WithEventDestination(EventDestinationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEventDestinationResult& WithRequestId(RequestIdT&& value) {
