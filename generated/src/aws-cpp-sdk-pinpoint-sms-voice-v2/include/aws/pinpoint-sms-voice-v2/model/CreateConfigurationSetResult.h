...
class CreateConfigurationSetResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API CreateConfigurationSetResult& operator=(
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  CreateConfigurationSetResult& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  CreateConfigurationSetResult& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateConfigurationSetResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateConfigurationSetResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  CreateConfigurationSetResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateConfigurationSetResult& WithRequestId(RequestIdT&& value) {
