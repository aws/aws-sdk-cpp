...
class SpendLimit {
 public:
  ...
  inline void SetName(SpendLimitName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SpendLimit& WithName(SpendLimitName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnforcedLimit(long long value) {
    m_enforcedLimitHasBeenSet = true;
    m_enforcedLimit = value;
  }
  inline SpendLimit& WithEnforcedLimit(long long value) {
    SetEnforcedLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxLimit(long long value) {
    m_maxLimitHasBeenSet = true;
    m_maxLimit = value;
  }
  inline SpendLimit& WithMaxLimit(long long value) {
    SetMaxLimit(value);
    return *this;
  }
  ///@}
  ...
  inline SpendLimit& WithOverridden(bool value) {
    SetOverridden(value);
    return *this;
  }
  ///@}
