...
class ConfigurationSetInformation {
 public:
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  ConfigurationSetInformation& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  ConfigurationSetInformation& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename EventDestinationsT = Aws::Vector<EventDestination>>
  ConfigurationSetInformation& WithEventDestinations(EventDestinationsT&& value) {
    SetEventDestinations(std::forward<EventDestinationsT>(value));
    return *this;
  }
  template <typename EventDestinationsT = EventDestination>
  ConfigurationSetInformation& AddEventDestinations(EventDestinationsT&& value) {
    m_eventDestinationsHasBeenSet = true;
  ...
  inline void SetDefaultMessageType(MessageType value) {
    m_defaultMessageTypeHasBeenSet = true;
    m_defaultMessageType = value;
  }
  inline ConfigurationSetInformation& WithDefaultMessageType(MessageType value) {
  ...
  void SetDefaultSenderId(DefaultSenderIdT&& value) {
    m_defaultSenderIdHasBeenSet = true;
    m_defaultSenderId = std::forward<DefaultSenderIdT>(value);
  }
  template <typename DefaultSenderIdT = Aws::String>
  ConfigurationSetInformation& WithDefaultSenderId(DefaultSenderIdT&& value) {
    SetDefaultSenderId(std::forward<DefaultSenderIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultMessageFeedbackEnabled(bool value) {
    m_defaultMessageFeedbackEnabledHasBeenSet = true;
    m_defaultMessageFeedbackEnabled = value;
  }
  inline ConfigurationSetInformation& WithDefaultMessageFeedbackEnabled(bool value) {
    SetDefaultMessageFeedbackEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  ConfigurationSetInformation& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  ConfigurationSetInformation& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
