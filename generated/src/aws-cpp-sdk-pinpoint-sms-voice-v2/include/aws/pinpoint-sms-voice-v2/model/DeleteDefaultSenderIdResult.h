...
class DeleteDefaultSenderIdResult {
 public:
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  DeleteDefaultSenderIdResult& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  DeleteDefaultSenderIdResult& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename SenderIdT = Aws::String>
  DeleteDefaultSenderIdResult& WithSenderId(SenderIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDefaultSenderIdResult& WithRequestId(RequestIdT&& value) {
