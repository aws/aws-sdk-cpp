...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINTSMSVOICEV2_API DisassociateProtectConfigurationRequest() = default;
    ...
    template<typename ProtectConfigurationIdT = Aws::String>
    DisassociateProtectConfigurationRequest& WithProtectConfigurationId(ProtectConfigurationIdT&& value) { SetProtectConfigurationId(std::forward<ProtectConfigurationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigurationSetNameT = Aws::String>
    DisassociateProtectConfigurationRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) { SetConfigurationSetName(std::forward<ConfigurationSetNameT>(value)); return *this;}
    ///@}
  private:
