...
class DisassociateProtectConfigurationRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  DisassociateProtectConfigurationRequest& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  DisassociateProtectConfigurationRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
