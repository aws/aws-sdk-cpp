...
class CreateOptOutListResult {
 public:
  AWS_PINPOINTSMSVOICEV2_API CreateOptOutListResult() = default;
  ...
  template <typename OptOutListArnT = Aws::String>
  CreateOptOutListResult& WithOptOutListArn(OptOutListArnT&& value) {
  ...
  template <typename OptOutListNameT = Aws::String>
  CreateOptOutListResult& WithOptOutListName(OptOutListNameT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateOptOutListResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateOptOutListResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  CreateOptOutListResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateOptOutListResult& WithRequestId(RequestIdT&& value) {
