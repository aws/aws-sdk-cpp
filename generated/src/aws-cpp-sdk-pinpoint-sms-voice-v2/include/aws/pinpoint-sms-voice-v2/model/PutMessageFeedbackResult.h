...
class PutMessageFeedbackResult {
 public:
  ...
  template <typename MessageIdT = Aws::String>
  PutMessageFeedbackResult& WithMessageId(MessageIdT&& value) {
  ...
  inline void SetMessageFeedbackStatus(MessageFeedbackStatus value) {
    m_messageFeedbackStatusHasBeenSet = true;
    m_messageFeedbackStatus = value;
  }
  inline PutMessageFeedbackResult& WithMessageFeedbackStatus(MessageFeedbackStatus value) {
    SetMessageFeedbackStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutMessageFeedbackResult& WithRequestId(RequestIdT&& value) {
