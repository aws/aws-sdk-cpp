...
class DescribeVerifiedDestinationNumbersRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  void SetVerifiedDestinationNumberIds(VerifiedDestinationNumberIdsT&& value) {
    m_verifiedDestinationNumberIdsHasBeenSet = true;
    m_verifiedDestinationNumberIds = std::forward<VerifiedDestinationNumberIdsT>(value);
  }
  template <typename VerifiedDestinationNumberIdsT = Aws::Vector<Aws::String>>
  DescribeVerifiedDestinationNumbersRequest& WithVerifiedDestinationNumberIds(VerifiedDestinationNumberIdsT&& value) {
    SetVerifiedDestinationNumberIds(std::forward<VerifiedDestinationNumberIdsT>(value));
    return *this;
  }
  template <typename VerifiedDestinationNumberIdsT = Aws::String>
  DescribeVerifiedDestinationNumbersRequest& AddVerifiedDestinationNumberIds(VerifiedDestinationNumberIdsT&& value) {
    m_verifiedDestinationNumberIdsHasBeenSet = true;
    m_verifiedDestinationNumberIds.emplace_back(std::forward<VerifiedDestinationNumberIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationPhoneNumbers(DestinationPhoneNumbersT&& value) {
    m_destinationPhoneNumbersHasBeenSet = true;
    m_destinationPhoneNumbers = std::forward<DestinationPhoneNumbersT>(value);
  }
  template <typename DestinationPhoneNumbersT = Aws::Vector<Aws::String>>
  DescribeVerifiedDestinationNumbersRequest& WithDestinationPhoneNumbers(DestinationPhoneNumbersT&& value) {
    SetDestinationPhoneNumbers(std::forward<DestinationPhoneNumbersT>(value));
    return *this;
  }
  template <typename DestinationPhoneNumbersT = Aws::String>
  DescribeVerifiedDestinationNumbersRequest& AddDestinationPhoneNumbers(DestinationPhoneNumbersT&& value) {
    m_destinationPhoneNumbersHasBeenSet = true;
    m_destinationPhoneNumbers.emplace_back(std::forward<DestinationPhoneNumbersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<VerifiedDestinationNumberFilter>>
  DescribeVerifiedDestinationNumbersRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = VerifiedDestinationNumberFilter>
  DescribeVerifiedDestinationNumbersRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVerifiedDestinationNumbersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeVerifiedDestinationNumbersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
