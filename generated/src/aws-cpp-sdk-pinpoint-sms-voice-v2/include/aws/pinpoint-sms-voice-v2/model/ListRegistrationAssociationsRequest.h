...
class ListRegistrationAssociationsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename RegistrationIdT = Aws::String>
  ListRegistrationAssociationsRequest& WithRegistrationId(RegistrationIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<RegistrationAssociationFilter>>
  ListRegistrationAssociationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = RegistrationAssociationFilter>
  ListRegistrationAssociationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRegistrationAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRegistrationAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
