...
class DescribeRegistrationFieldDefinitionsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename RegistrationTypeT = Aws::String>
  DescribeRegistrationFieldDefinitionsRequest& WithRegistrationType(RegistrationTypeT&& value) {
  ...
  template <typename SectionPathT = Aws::String>
  DescribeRegistrationFieldDefinitionsRequest& WithSectionPath(SectionPathT&& value) {
  ...
  void SetFieldPaths(FieldPathsT&& value) {
    m_fieldPathsHasBeenSet = true;
    m_fieldPaths = std::forward<FieldPathsT>(value);
  }
  template <typename FieldPathsT = Aws::Vector<Aws::String>>
  DescribeRegistrationFieldDefinitionsRequest& WithFieldPaths(FieldPathsT&& value) {
    SetFieldPaths(std::forward<FieldPathsT>(value));
    return *this;
  }
  template <typename FieldPathsT = Aws::String>
  DescribeRegistrationFieldDefinitionsRequest& AddFieldPaths(FieldPathsT&& value) {
    m_fieldPathsHasBeenSet = true;
    m_fieldPaths.emplace_back(std::forward<FieldPathsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationFieldDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeRegistrationFieldDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
