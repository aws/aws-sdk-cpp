...
class UpdatePhoneNumberRequest : public PinpointSMSVoiceV2Request {
 public:
   ...
   * a shared End User Messaging SMS resource then you must use the full Amazon
   * Resource Name(ARN).</p>
   */
  ...
  inline UpdatePhoneNumberRequest& WithTwoWayEnabled(bool value) {
  ...
  template <typename TwoWayChannelArnT = Aws::String>
  UpdatePhoneNumberRequest& WithTwoWayChannelArn(TwoWayChannelArnT&& value) {
  ...
  template <typename TwoWayChannelRoleT = Aws::String>
  UpdatePhoneNumberRequest& WithTwoWayChannelRole(TwoWayChannelRoleT&& value) {
  ...
  inline UpdatePhoneNumberRequest& WithSelfManagedOptOutsEnabled(bool value) {
  ...
  ///@{
  /**
   * <p>The OptOutList to add the phone number to. You can use either the opt out
   * list name or the opt out list ARN.</p>
   */
  ...
  template <typename OptOutListNameT = Aws::String>
  UpdatePhoneNumberRequest& WithOptOutListName(OptOutListNameT&& value) {
  ...
  inline UpdatePhoneNumberRequest& WithInternationalSendingEnabled(bool value) {
  ...
  inline UpdatePhoneNumberRequest& WithDeletionProtectionEnabled(bool value) {
