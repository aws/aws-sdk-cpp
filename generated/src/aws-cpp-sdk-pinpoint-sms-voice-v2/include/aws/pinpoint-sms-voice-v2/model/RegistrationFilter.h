...
class RegistrationFilter {
 public:
  ...
  inline void SetName(RegistrationFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline RegistrationFilter& WithName(RegistrationFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  RegistrationFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  RegistrationFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
