...
class DeleteKeywordResult {
 public:
  ...
  template <typename OriginationIdentityArnT = Aws::String>
  DeleteKeywordResult& WithOriginationIdentityArn(OriginationIdentityArnT&& value) {
  ...
  template <typename OriginationIdentityT = Aws::String>
  DeleteKeywordResult& WithOriginationIdentity(OriginationIdentityT&& value) {
  ...
  template <typename KeywordT = Aws::String>
  DeleteKeywordResult& WithKeyword(KeywordT&& value) {
  ...
  template <typename KeywordMessageT = Aws::String>
  DeleteKeywordResult& WithKeywordMessage(KeywordMessageT&& value) {
  ...
  inline DeleteKeywordResult& WithKeywordAction(KeywordAction value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteKeywordResult& WithRequestId(RequestIdT&& value) {
