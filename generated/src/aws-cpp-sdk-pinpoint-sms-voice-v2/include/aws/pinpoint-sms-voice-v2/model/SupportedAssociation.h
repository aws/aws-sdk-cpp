...
class SupportedAssociation {
 public:
  ...
  template <typename ResourceTypeT = Aws::String>
  SupportedAssociation& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename IsoCountryCodeT = Aws::String>
  SupportedAssociation& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  inline void SetAssociationBehavior(RegistrationAssociationBehavior value) {
    m_associationBehaviorHasBeenSet = true;
    m_associationBehavior = value;
  }
  inline SupportedAssociation& WithAssociationBehavior(RegistrationAssociationBehavior value) {
    SetAssociationBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDisassociationBehavior(RegistrationDisassociationBehavior value) {
    m_disassociationBehaviorHasBeenSet = true;
    m_disassociationBehavior = value;
  }
  inline SupportedAssociation& WithDisassociationBehavior(RegistrationDisassociationBehavior value) {
    SetDisassociationBehavior(value);
    return *this;
  }
  ///@}
 private:
