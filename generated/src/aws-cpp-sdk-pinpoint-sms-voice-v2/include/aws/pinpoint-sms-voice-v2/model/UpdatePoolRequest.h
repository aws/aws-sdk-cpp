...
class UpdatePoolRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename PoolIdT = Aws::String>
  UpdatePoolRequest& WithPoolId(PoolIdT&& value) {
  ...
  inline UpdatePoolRequest& WithTwoWayEnabled(bool value) {
  ...
  template <typename TwoWayChannelArnT = Aws::String>
  UpdatePoolRequest& WithTwoWayChannelArn(TwoWayChannelArnT&& value) {
  ...
  template <typename TwoWayChannelRoleT = Aws::String>
  UpdatePoolRequest& WithTwoWayChannelRole(TwoWayChannelRoleT&& value) {
  ...
  inline UpdatePoolRequest& WithSelfManagedOptOutsEnabled(bool value) {
  ...
  template <typename OptOutListNameT = Aws::String>
  UpdatePoolRequest& WithOptOutListName(OptOutListNameT&& value) {
  ...
  inline UpdatePoolRequest& WithSharedRoutesEnabled(bool value) {
  ...
  inline UpdatePoolRequest& WithDeletionProtectionEnabled(bool value) {
