...
class CreateRegistrationResult {
 public:
  ...
  template <typename RegistrationArnT = Aws::String>
  CreateRegistrationResult& WithRegistrationArn(RegistrationArnT&& value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  CreateRegistrationResult& WithRegistrationId(RegistrationIdT&& value) {
  ...
  template <typename RegistrationTypeT = Aws::String>
  CreateRegistrationResult& WithRegistrationType(RegistrationTypeT&& value) {
  ...
  inline CreateRegistrationResult& WithRegistrationStatus(RegistrationStatus value) {
  ...
  inline CreateRegistrationResult& WithCurrentVersionNumber(long long value) {
  ...
  template <typename AdditionalAttributesT = Aws::Map<Aws::String, Aws::String>>
  CreateRegistrationResult& WithAdditionalAttributes(AdditionalAttributesT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateRegistrationResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateRegistrationResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  CreateRegistrationResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRegistrationResult& WithRequestId(RequestIdT&& value) {
