...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINTSMSVOICEV2_API UpdatePhoneNumberResult() = default;
    ...
    template<typename PhoneNumberArnT = Aws::String>
    UpdatePhoneNumberResult& WithPhoneNumberArn(PhoneNumberArnT&& value) { SetPhoneNumberArn(std::forward<PhoneNumberArnT>(value)); return *this;}
    ///@}
    ...
    template<typename PhoneNumberIdT = Aws::String>
    UpdatePhoneNumberResult& WithPhoneNumberId(PhoneNumberIdT&& value) { SetPhoneNumberId(std::forward<PhoneNumberIdT>(value)); return *this;}
    ///@}
    ...
    inline UpdatePhoneNumberResult& WithStatus(NumberStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename IsoCountryCodeT = Aws::String>
    UpdatePhoneNumberResult& WithIsoCountryCode(IsoCountryCodeT&& value) { SetIsoCountryCode(std::forward<IsoCountryCodeT>(value)); return *this;}
    ///@}
    ...
    inline UpdatePhoneNumberResult& WithMessageType(MessageType value) { SetMessageType(value); return *this;}
    ///@}
    ...
    template<typename NumberCapabilitiesT = Aws::Vector<NumberCapability>>
    UpdatePhoneNumberResult& WithNumberCapabilities(NumberCapabilitiesT&& value) { SetNumberCapabilities(std::forward<NumberCapabilitiesT>(value)); return *this;}
    inline UpdatePhoneNumberResult& AddNumberCapabilities(NumberCapability value) { m_numberCapabilitiesHasBeenSet = true; m_numberCapabilities.push_back(value); return *this; }
    ///@}
    ...
    inline UpdatePhoneNumberResult& WithNumberType(NumberType value) { SetNumberType(value); return *this;}
    ///@}
    ...
    template<typename MonthlyLeasingPriceT = Aws::String>
    UpdatePhoneNumberResult& WithMonthlyLeasingPrice(MonthlyLeasingPriceT&& value) { SetMonthlyLeasingPrice(std::forward<MonthlyLeasingPriceT>(value)); return *this;}
    ///@}
    ...
    template<typename TwoWayChannelArnT = Aws::String>
    UpdatePhoneNumberResult& WithTwoWayChannelArn(TwoWayChannelArnT&& value) { SetTwoWayChannelArn(std::forward<TwoWayChannelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TwoWayChannelRoleT = Aws::String>
    UpdatePhoneNumberResult& WithTwoWayChannelRole(TwoWayChannelRoleT&& value) { SetTwoWayChannelRole(std::forward<TwoWayChannelRoleT>(value)); return *this;}
    ///@}
    ...
    template<typename OptOutListNameT = Aws::String>
    UpdatePhoneNumberResult& WithOptOutListName(OptOutListNameT&& value) { SetOptOutListName(std::forward<OptOutListNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RegistrationIdT = Aws::String>
    UpdatePhoneNumberResult& WithRegistrationId(RegistrationIdT&& value) { SetRegistrationId(std::forward<RegistrationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedTimestampT = Aws::Utils::DateTime>
    UpdatePhoneNumberResult& WithCreatedTimestamp(CreatedTimestampT&& value) { SetCreatedTimestamp(std::forward<CreatedTimestampT>(value)); return *this;}
    ///@}
