...
class UpdatePhoneNumberResult {
 public:
  ...
  inline UpdatePhoneNumberResult& WithStatus(NumberStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename IsoCountryCodeT = Aws::String>
  UpdatePhoneNumberResult& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  inline UpdatePhoneNumberResult& WithMessageType(MessageType value) {
  ...
  template <typename NumberCapabilitiesT = Aws::Vector<NumberCapability>>
  UpdatePhoneNumberResult& WithNumberCapabilities(NumberCapabilitiesT&& value) {
    SetNumberCapabilities(std::forward<NumberCapabilitiesT>(value));
    return *this;
  }
  inline UpdatePhoneNumberResult& AddNumberCapabilities(NumberCapability value) {
    m_numberCapabilitiesHasBeenSet = true;
  ...
  inline UpdatePhoneNumberResult& WithNumberType(NumberType value) {
    SetNumberType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MonthlyLeasingPriceT = Aws::String>
  UpdatePhoneNumberResult& WithMonthlyLeasingPrice(MonthlyLeasingPriceT&& value) {
  ...
  inline UpdatePhoneNumberResult& WithTwoWayEnabled(bool value) {
  ...
  template <typename TwoWayChannelArnT = Aws::String>
  UpdatePhoneNumberResult& WithTwoWayChannelArn(TwoWayChannelArnT&& value) {
  ...
  template <typename TwoWayChannelRoleT = Aws::String>
  UpdatePhoneNumberResult& WithTwoWayChannelRole(TwoWayChannelRoleT&& value) {
  ...
  inline UpdatePhoneNumberResult& WithSelfManagedOptOutsEnabled(bool value) {
  ...
  template <typename OptOutListNameT = Aws::String>
  UpdatePhoneNumberResult& WithOptOutListName(OptOutListNameT&& value) {
  ...
  inline UpdatePhoneNumberResult& WithInternationalSendingEnabled(bool value) {
  ...
  inline UpdatePhoneNumberResult& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  UpdatePhoneNumberResult& WithRegistrationId(RegistrationIdT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  UpdatePhoneNumberResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
