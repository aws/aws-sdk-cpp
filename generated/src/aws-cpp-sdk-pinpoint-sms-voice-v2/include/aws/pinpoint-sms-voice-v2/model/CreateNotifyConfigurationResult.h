...
class CreateNotifyConfigurationResult {
 public:
  AWS_PINPOINTSMSVOICEV2_API CreateNotifyConfigurationResult() = default;
  AWS_PINPOINTSMSVOICEV2_API CreateNotifyConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PINPOINTSMSVOICEV2_API CreateNotifyConfigurationResult& operator=(
  ...
  template <typename NotifyConfigurationArnT = Aws::String>
  CreateNotifyConfigurationResult& WithNotifyConfigurationArn(NotifyConfigurationArnT&& value) {
  ...
  template <typename NotifyConfigurationIdT = Aws::String>
  CreateNotifyConfigurationResult& WithNotifyConfigurationId(NotifyConfigurationIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  CreateNotifyConfigurationResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline CreateNotifyConfigurationResult& WithUseCase(NotifyConfigurationUseCase value) {
    SetUseCase(value);
    return *this;
  }
  ///@}
  ...
  template <typename DefaultTemplateIdT = Aws::String>
  CreateNotifyConfigurationResult& WithDefaultTemplateId(DefaultTemplateIdT&& value) {
  ...
  template <typename PoolIdT = Aws::String>
  CreateNotifyConfigurationResult& WithPoolId(PoolIdT&& value) {
  ...
  template <typename EnabledCountriesT = Aws::Vector<Aws::String>>
  CreateNotifyConfigurationResult& WithEnabledCountries(EnabledCountriesT&& value) {
    SetEnabledCountries(std::forward<EnabledCountriesT>(value));
    return *this;
  }
  template <typename EnabledCountriesT = Aws::String>
  CreateNotifyConfigurationResult& AddEnabledCountries(EnabledCountriesT&& value) {
    m_enabledCountriesHasBeenSet = true;
  ...
  template <typename EnabledChannelsT = Aws::Vector<NumberCapability>>
  CreateNotifyConfigurationResult& WithEnabledChannels(EnabledChannelsT&& value) {
    SetEnabledChannels(std::forward<EnabledChannelsT>(value));
    return *this;
  }
  inline CreateNotifyConfigurationResult& AddEnabledChannels(NumberCapability value) {
    m_enabledChannelsHasBeenSet = true;
  ...
  inline CreateNotifyConfigurationResult& WithTier(NotifyConfigurationTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
  ...
  inline CreateNotifyConfigurationResult& WithTierUpgradeStatus(TierUpgradeStatus value) {
  ...
  inline CreateNotifyConfigurationResult& WithStatus(NotifyConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RejectionReasonT = Aws::String>
  CreateNotifyConfigurationResult& WithRejectionReason(RejectionReasonT&& value) {
  ...
  inline CreateNotifyConfigurationResult& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateNotifyConfigurationResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateNotifyConfigurationResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  CreateNotifyConfigurationResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateNotifyConfigurationResult& WithRequestId(RequestIdT&& value) {
