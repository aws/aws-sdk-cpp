...
class DeleteProtectConfigurationRuleSetNumberOverrideResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DeleteProtectConfigurationRuleSetNumberOverrideResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProtectConfigurationArnT = Aws::String>
  DeleteProtectConfigurationRuleSetNumberOverrideResult& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) {
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  DeleteProtectConfigurationRuleSetNumberOverrideResult& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename DestinationPhoneNumberT = Aws::String>
  DeleteProtectConfigurationRuleSetNumberOverrideResult& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  DeleteProtectConfigurationRuleSetNumberOverrideResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  inline DeleteProtectConfigurationRuleSetNumberOverrideResult& WithAction(ProtectConfigurationRuleOverrideAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename IsoCountryCodeT = Aws::String>
  DeleteProtectConfigurationRuleSetNumberOverrideResult& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  template <typename ExpirationTimestampT = Aws::Utils::DateTime>
  DeleteProtectConfigurationRuleSetNumberOverrideResult& WithExpirationTimestamp(ExpirationTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteProtectConfigurationRuleSetNumberOverrideResult& WithRequestId(RequestIdT&& value) {
