...
class AssociateOriginationIdentityResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API AssociateOriginationIdentityResult& operator=(
  ...
  template <typename PoolArnT = Aws::String>
  AssociateOriginationIdentityResult& WithPoolArn(PoolArnT&& value) {
  ...
  template <typename PoolIdT = Aws::String>
  AssociateOriginationIdentityResult& WithPoolId(PoolIdT&& value) {
  ...
  template <typename OriginationIdentityArnT = Aws::String>
  AssociateOriginationIdentityResult& WithOriginationIdentityArn(OriginationIdentityArnT&& value) {
  ...
  template <typename OriginationIdentityT = Aws::String>
  AssociateOriginationIdentityResult& WithOriginationIdentity(OriginationIdentityT&& value) {
  ...
  template <typename IsoCountryCodeT = Aws::String>
  AssociateOriginationIdentityResult& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateOriginationIdentityResult& WithRequestId(RequestIdT&& value) {
