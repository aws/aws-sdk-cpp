...
namespace Model
{
  ...
  /**
   */
  class DeleteResourcePolicyRequest : public PinpointSMSVoiceV2Request
  {
  public:
    AWS_PINPOINTSMSVOICEV2_API DeleteResourcePolicyRequest() = default;
     ...
     * resource you're deleting the resource-based policy from.</p>
     */
