...
class ConfigurationSetFilter {
 public:
  ...
  inline void SetName(ConfigurationSetFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ConfigurationSetFilter& WithName(ConfigurationSetFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ConfigurationSetFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ConfigurationSetFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
