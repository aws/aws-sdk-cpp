...
/**
 */
class PutResourcePolicyRequest : public PinpointSMSVoiceV2Request {
 public:
  AWS_PINPOINTSMSVOICEV2_API PutResourcePolicyRequest() = default;
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the End User Messaging SMS resource to
