...
class DescribePhoneNumbersRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename PhoneNumberIdsT = Aws::Vector<Aws::String>>
  DescribePhoneNumbersRequest& WithPhoneNumberIds(PhoneNumberIdsT&& value) {
    SetPhoneNumberIds(std::forward<PhoneNumberIdsT>(value));
    return *this;
  }
  template <typename PhoneNumberIdsT = Aws::String>
  DescribePhoneNumbersRequest& AddPhoneNumberIds(PhoneNumberIdsT&& value) {
    m_phoneNumberIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<PhoneNumberFilter>>
  DescribePhoneNumbersRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = PhoneNumberFilter>
  DescribePhoneNumbersRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribePhoneNumbersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribePhoneNumbersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribePhoneNumbersRequest& WithOwner(Owner value) {
    SetOwner(value);
    return *this;
  }
  ///@}
