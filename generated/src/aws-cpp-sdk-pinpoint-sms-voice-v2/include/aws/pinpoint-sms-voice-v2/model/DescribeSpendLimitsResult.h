...
class DescribeSpendLimitsResult {
 public:
  ...
  void SetSpendLimits(SpendLimitsT&& value) {
    m_spendLimitsHasBeenSet = true;
    m_spendLimits = std::forward<SpendLimitsT>(value);
  }
  template <typename SpendLimitsT = Aws::Vector<SpendLimit>>
  DescribeSpendLimitsResult& WithSpendLimits(SpendLimitsT&& value) {
    SetSpendLimits(std::forward<SpendLimitsT>(value));
    return *this;
  }
  template <typename SpendLimitsT = SpendLimit>
  DescribeSpendLimitsResult& AddSpendLimits(SpendLimitsT&& value) {
    m_spendLimitsHasBeenSet = true;
    m_spendLimits.emplace_back(std::forward<SpendLimitsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSpendLimitsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSpendLimitsResult& WithRequestId(RequestIdT&& value) {
