...
class AssociateOriginationIdentityRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename PoolIdT = Aws::String>
  AssociateOriginationIdentityRequest& WithPoolId(PoolIdT&& value) {
  ...
  template <typename OriginationIdentityT = Aws::String>
  AssociateOriginationIdentityRequest& WithOriginationIdentity(OriginationIdentityT&& value) {
  ...
  template <typename IsoCountryCodeT = Aws::String>
  AssociateOriginationIdentityRequest& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  AssociateOriginationIdentityRequest& WithClientToken(ClientTokenT&& value) {
