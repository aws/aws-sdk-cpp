...
class SendVoiceMessageRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename DestinationPhoneNumberT = Aws::String>
  SendVoiceMessageRequest& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) {
  ...
  template <typename OriginationIdentityT = Aws::String>
  SendVoiceMessageRequest& WithOriginationIdentity(OriginationIdentityT&& value) {
  ...
  template <typename MessageBodyT = Aws::String>
  SendVoiceMessageRequest& WithMessageBody(MessageBodyT&& value) {
  ...
  inline void SetMessageBodyTextType(VoiceMessageBodyTextType value) {
    m_messageBodyTextTypeHasBeenSet = true;
    m_messageBodyTextType = value;
  }
  inline SendVoiceMessageRequest& WithMessageBodyTextType(VoiceMessageBodyTextType value) {
    SetMessageBodyTextType(value);
    return *this;
  }
  ///@}
  ...
  inline SendVoiceMessageRequest& WithVoiceId(VoiceId value) {
    SetVoiceId(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  SendVoiceMessageRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  void SetMaxPricePerMinute(MaxPricePerMinuteT&& value) {
    m_maxPricePerMinuteHasBeenSet = true;
    m_maxPricePerMinute = std::forward<MaxPricePerMinuteT>(value);
  }
  template <typename MaxPricePerMinuteT = Aws::String>
  SendVoiceMessageRequest& WithMaxPricePerMinute(MaxPricePerMinuteT&& value) {
    SetMaxPricePerMinute(std::forward<MaxPricePerMinuteT>(value));
    return *this;
  }
  ///@}
  ...
  inline SendVoiceMessageRequest& WithTimeToLive(int value) {
    SetTimeToLive(value);
    return *this;
  }
  ///@}
  ...
  template <typename ContextT = Aws::Map<Aws::String, Aws::String>>
  SendVoiceMessageRequest& WithContext(ContextT&& value) {
  ...
  inline SendVoiceMessageRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  SendVoiceMessageRequest& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  inline SendVoiceMessageRequest& WithMessageFeedbackEnabled(bool value) {
