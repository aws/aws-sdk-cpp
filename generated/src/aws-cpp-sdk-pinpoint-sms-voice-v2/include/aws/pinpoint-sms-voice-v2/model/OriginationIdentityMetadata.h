...
class OriginationIdentityMetadata {
 public:
  ...
  template <typename OriginationIdentityArnT = Aws::String>
  OriginationIdentityMetadata& WithOriginationIdentityArn(OriginationIdentityArnT&& value) {
  ...
  template <typename OriginationIdentityT = Aws::String>
  OriginationIdentityMetadata& WithOriginationIdentity(OriginationIdentityT&& value) {
  ...
  template <typename IsoCountryCodeT = Aws::String>
  OriginationIdentityMetadata& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  template <typename NumberCapabilitiesT = Aws::Vector<NumberCapability>>
  OriginationIdentityMetadata& WithNumberCapabilities(NumberCapabilitiesT&& value) {
    SetNumberCapabilities(std::forward<NumberCapabilitiesT>(value));
    return *this;
  }
  inline OriginationIdentityMetadata& AddNumberCapabilities(NumberCapability value) {
    m_numberCapabilitiesHasBeenSet = true;
  ...
  template <typename PhoneNumberT = Aws::String>
  OriginationIdentityMetadata& WithPhoneNumber(PhoneNumberT&& value) {
