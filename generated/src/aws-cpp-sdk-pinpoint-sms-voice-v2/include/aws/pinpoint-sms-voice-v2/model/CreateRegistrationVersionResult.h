...
class CreateRegistrationVersionResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API CreateRegistrationVersionResult& operator=(
  ...
  template <typename RegistrationArnT = Aws::String>
  CreateRegistrationVersionResult& WithRegistrationArn(RegistrationArnT&& value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  CreateRegistrationVersionResult& WithRegistrationId(RegistrationIdT&& value) {
  ...
  inline CreateRegistrationVersionResult& WithVersionNumber(long long value) {
  ...
  inline CreateRegistrationVersionResult& WithRegistrationVersionStatus(RegistrationVersionStatus value) {
  ...
  template <typename RegistrationVersionStatusHistoryT = RegistrationVersionStatusHistory>
  CreateRegistrationVersionResult& WithRegistrationVersionStatusHistory(RegistrationVersionStatusHistoryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRegistrationVersionResult& WithRequestId(RequestIdT&& value) {
