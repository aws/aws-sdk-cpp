...
class DescribeRegistrationsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename RegistrationIdsT = Aws::Vector<Aws::String>>
  DescribeRegistrationsRequest& WithRegistrationIds(RegistrationIdsT&& value) {
    SetRegistrationIds(std::forward<RegistrationIdsT>(value));
    return *this;
  }
  template <typename RegistrationIdsT = Aws::String>
  DescribeRegistrationsRequest& AddRegistrationIds(RegistrationIdsT&& value) {
    m_registrationIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<RegistrationFilter>>
  DescribeRegistrationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = RegistrationFilter>
  DescribeRegistrationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeRegistrationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
