...
class SetDefaultMessageTypeResult {
 public:
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  SetDefaultMessageTypeResult& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  SetDefaultMessageTypeResult& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  inline SetDefaultMessageTypeResult& WithMessageType(MessageType value) {
  ...
  template <typename RequestIdT = Aws::String>
  SetDefaultMessageTypeResult& WithRequestId(RequestIdT&& value) {
