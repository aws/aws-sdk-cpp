...
namespace Model
{
  ...
  public:
    ...
    inline SetDefaultMessageTypeResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline SetDefaultMessageTypeResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline SetDefaultMessageTypeResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
