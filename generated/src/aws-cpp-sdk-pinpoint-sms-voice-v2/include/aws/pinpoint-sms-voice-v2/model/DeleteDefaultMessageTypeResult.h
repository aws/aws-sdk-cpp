...
class DeleteDefaultMessageTypeResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DeleteDefaultMessageTypeResult& operator=(
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  DeleteDefaultMessageTypeResult& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  DeleteDefaultMessageTypeResult& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  inline DeleteDefaultMessageTypeResult& WithMessageType(MessageType value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDefaultMessageTypeResult& WithRequestId(RequestIdT&& value) {
