...
class SendNotifyTextMessageResult {
 public:
  AWS_PINPOINTSMSVOICEV2_API SendNotifyTextMessageResult() = default;
  AWS_PINPOINTSMSVOICEV2_API SendNotifyTextMessageResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PINPOINTSMSVOICEV2_API SendNotifyTextMessageResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename MessageIdT = Aws::String>
  SendNotifyTextMessageResult& WithMessageId(MessageIdT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  SendNotifyTextMessageResult& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename ResolvedMessageBodyT = Aws::String>
  SendNotifyTextMessageResult& WithResolvedMessageBody(ResolvedMessageBodyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SendNotifyTextMessageResult& WithRequestId(RequestIdT&& value) {
