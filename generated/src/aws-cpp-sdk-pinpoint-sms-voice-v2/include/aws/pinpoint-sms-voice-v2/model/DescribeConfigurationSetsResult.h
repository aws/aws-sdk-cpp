...
class DescribeConfigurationSetsResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DescribeConfigurationSetsResult& operator=(
  ...
  void SetConfigurationSets(ConfigurationSetsT&& value) {
    ...
    m_configurationSets = std::forward<ConfigurationSetsT>(value);
  }
  template <typename ConfigurationSetsT = Aws::Vector<ConfigurationSetInformation>>
  DescribeConfigurationSetsResult& WithConfigurationSets(ConfigurationSetsT&& value) {
    SetConfigurationSets(std::forward<ConfigurationSetsT>(value));
    return *this;
  }
  template <typename ConfigurationSetsT = ConfigurationSetInformation>
  DescribeConfigurationSetsResult& AddConfigurationSets(ConfigurationSetsT&& value) {
    m_configurationSetsHasBeenSet = true;
    m_configurationSets.emplace_back(std::forward<ConfigurationSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConfigurationSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeConfigurationSetsResult& WithRequestId(RequestIdT&& value) {
