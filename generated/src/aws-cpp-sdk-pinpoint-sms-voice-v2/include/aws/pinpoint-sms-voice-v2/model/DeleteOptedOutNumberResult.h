...
class DeleteOptedOutNumberResult {
 public:
  ...
  template <typename OptOutListArnT = Aws::String>
  DeleteOptedOutNumberResult& WithOptOutListArn(OptOutListArnT&& value) {
  ...
  template <typename OptOutListNameT = Aws::String>
  DeleteOptedOutNumberResult& WithOptOutListName(OptOutListNameT&& value) {
  ...
  template <typename OptedOutNumberT = Aws::String>
  DeleteOptedOutNumberResult& WithOptedOutNumber(OptedOutNumberT&& value) {
  ...
  template <typename OptedOutTimestampT = Aws::Utils::DateTime>
  DeleteOptedOutNumberResult& WithOptedOutTimestamp(OptedOutTimestampT&& value) {
  ...
  inline DeleteOptedOutNumberResult& WithEndUserOptedOut(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteOptedOutNumberResult& WithRequestId(RequestIdT&& value) {
