...
class DescribePoolsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  void SetPoolIds(PoolIdsT&& value) {
    m_poolIdsHasBeenSet = true;
    m_poolIds = std::forward<PoolIdsT>(value);
  }
  template <typename PoolIdsT = Aws::Vector<Aws::String>>
  DescribePoolsRequest& WithPoolIds(PoolIdsT&& value) {
    SetPoolIds(std::forward<PoolIdsT>(value));
    return *this;
  }
  template <typename PoolIdsT = Aws::String>
  DescribePoolsRequest& AddPoolIds(PoolIdsT&& value) {
    m_poolIdsHasBeenSet = true;
    m_poolIds.emplace_back(std::forward<PoolIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<PoolFilter>>
  DescribePoolsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = PoolFilter>
  DescribePoolsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribePoolsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribePoolsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribePoolsRequest& WithOwner(Owner value) {
    SetOwner(value);
    return *this;
  }
  ///@}
