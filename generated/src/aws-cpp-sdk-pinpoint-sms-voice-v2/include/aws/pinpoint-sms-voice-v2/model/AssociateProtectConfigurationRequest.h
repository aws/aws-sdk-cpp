...
class AssociateProtectConfigurationRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  AssociateProtectConfigurationRequest& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  AssociateProtectConfigurationRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
