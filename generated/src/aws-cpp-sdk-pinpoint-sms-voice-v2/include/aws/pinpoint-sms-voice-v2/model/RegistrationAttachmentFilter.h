...
class RegistrationAttachmentFilter {
 public:
  ...
  inline void SetName(RegistrationAttachmentFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline RegistrationAttachmentFilter& WithName(RegistrationAttachmentFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  RegistrationAttachmentFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  RegistrationAttachmentFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
