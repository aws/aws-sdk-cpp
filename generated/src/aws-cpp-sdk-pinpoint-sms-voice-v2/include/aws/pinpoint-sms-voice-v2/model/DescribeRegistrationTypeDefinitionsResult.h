...
class DescribeRegistrationTypeDefinitionsResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DescribeRegistrationTypeDefinitionsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetRegistrationTypeDefinitions(RegistrationTypeDefinitionsT&& value) {
    m_registrationTypeDefinitionsHasBeenSet = true;
    m_registrationTypeDefinitions = std::forward<RegistrationTypeDefinitionsT>(value);
  }
  template <typename RegistrationTypeDefinitionsT = Aws::Vector<RegistrationTypeDefinition>>
  DescribeRegistrationTypeDefinitionsResult& WithRegistrationTypeDefinitions(RegistrationTypeDefinitionsT&& value) {
    SetRegistrationTypeDefinitions(std::forward<RegistrationTypeDefinitionsT>(value));
    return *this;
  }
  template <typename RegistrationTypeDefinitionsT = RegistrationTypeDefinition>
  DescribeRegistrationTypeDefinitionsResult& AddRegistrationTypeDefinitions(RegistrationTypeDefinitionsT&& value) {
    m_registrationTypeDefinitionsHasBeenSet = true;
    m_registrationTypeDefinitions.emplace_back(std::forward<RegistrationTypeDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationTypeDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRegistrationTypeDefinitionsResult& WithRequestId(RequestIdT&& value) {
