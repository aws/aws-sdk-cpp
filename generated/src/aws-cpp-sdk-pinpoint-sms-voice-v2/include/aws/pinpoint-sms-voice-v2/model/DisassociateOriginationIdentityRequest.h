...
class DisassociateOriginationIdentityRequest : public PinpointSMSVoiceV2Request {
 public:
   ...
   * you are using a shared End User Messaging SMS resource then you must use the
  ...
  template <typename PoolIdT = Aws::String>
  DisassociateOriginationIdentityRequest& WithPoolId(PoolIdT&& value) {
  ...
  template <typename OriginationIdentityT = Aws::String>
  DisassociateOriginationIdentityRequest& WithOriginationIdentity(OriginationIdentityT&& value) {
   ...
   * types that are not country-specific, such as RCS agents.</p>
   */
  ...
  template <typename IsoCountryCodeT = Aws::String>
  DisassociateOriginationIdentityRequest& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DisassociateOriginationIdentityRequest& WithClientToken(ClientTokenT&& value) {
