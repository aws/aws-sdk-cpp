...
class CreateProtectConfigurationRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateProtectConfigurationRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline CreateProtectConfigurationRequest& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateProtectConfigurationRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateProtectConfigurationRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
