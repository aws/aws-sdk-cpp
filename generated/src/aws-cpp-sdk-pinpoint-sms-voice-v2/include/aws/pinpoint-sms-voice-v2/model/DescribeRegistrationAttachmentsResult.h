...
class DescribeRegistrationAttachmentsResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DescribeRegistrationAttachmentsResult& operator=(
  ...
  void SetRegistrationAttachments(RegistrationAttachmentsT&& value) {
    m_registrationAttachmentsHasBeenSet = true;
    m_registrationAttachments = std::forward<RegistrationAttachmentsT>(value);
  }
  template <typename RegistrationAttachmentsT = Aws::Vector<RegistrationAttachmentsInformation>>
  DescribeRegistrationAttachmentsResult& WithRegistrationAttachments(RegistrationAttachmentsT&& value) {
    SetRegistrationAttachments(std::forward<RegistrationAttachmentsT>(value));
    return *this;
  }
  template <typename RegistrationAttachmentsT = RegistrationAttachmentsInformation>
  DescribeRegistrationAttachmentsResult& AddRegistrationAttachments(RegistrationAttachmentsT&& value) {
    m_registrationAttachmentsHasBeenSet = true;
    m_registrationAttachments.emplace_back(std::forward<RegistrationAttachmentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationAttachmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRegistrationAttachmentsResult& WithRequestId(RequestIdT&& value) {
