...
class PoolOriginationIdentitiesFilter {
 public:
  ...
  inline void SetName(PoolOriginationIdentitiesFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline PoolOriginationIdentitiesFilter& WithName(PoolOriginationIdentitiesFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  PoolOriginationIdentitiesFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  PoolOriginationIdentitiesFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
