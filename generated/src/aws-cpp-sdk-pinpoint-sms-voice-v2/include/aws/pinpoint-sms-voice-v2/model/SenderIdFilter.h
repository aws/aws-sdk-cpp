...
class SenderIdFilter {
 public:
  ...
  inline void SetName(SenderIdFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SenderIdFilter& WithName(SenderIdFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  SenderIdFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  SenderIdFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
