...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINTSMSVOICEV2_API ProtectConfigurationRuleSetNumberOverrideFilterItem() = default;
     ...
     */
    inline ProtectConfigurationRuleSetNumberOverrideFilterName GetName() const { return m_name; }
    inline bool NameHasBeenSet() const { return m_nameHasBeenSet; }
    inline void SetName(ProtectConfigurationRuleSetNumberOverrideFilterName value) { m_nameHasBeenSet = true; m_name = value; }
    inline ProtectConfigurationRuleSetNumberOverrideFilterItem& WithName(ProtectConfigurationRuleSetNumberOverrideFilterName value) { SetName(value); return *this;}
    ///@}
    ...
    template<typename ValuesT = Aws::Vector<Aws::String>>
    ProtectConfigurationRuleSetNumberOverrideFilterItem& WithValues(ValuesT&& value) { SetValues(std::forward<ValuesT>(value)); return *this;}
    template<typename ValuesT = Aws::String>
    ProtectConfigurationRuleSetNumberOverrideFilterItem& AddValues(ValuesT&& value) { m_valuesHasBeenSet = true; m_values.emplace_back(std::forward<ValuesT>(value)); return *this; }
    ///@}
  private:
