...
class ProtectConfigurationRuleSetNumberOverrideFilterItem {
 public:
  ...
  inline void SetName(ProtectConfigurationRuleSetNumberOverrideFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ProtectConfigurationRuleSetNumberOverrideFilterItem& WithName(ProtectConfigurationRuleSetNumberOverrideFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ProtectConfigurationRuleSetNumberOverrideFilterItem& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ProtectConfigurationRuleSetNumberOverrideFilterItem& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
