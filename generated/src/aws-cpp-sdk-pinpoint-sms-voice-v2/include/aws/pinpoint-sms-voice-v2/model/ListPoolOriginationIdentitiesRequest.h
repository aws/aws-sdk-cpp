...
class ListPoolOriginationIdentitiesRequest : public PinpointSMSVoiceV2Request {
 public:
   ...
   * PoolArn.</p>  <p>If you are using a shared AWS End User Messaging SMS
  ...
  template <typename PoolIdT = Aws::String>
  ListPoolOriginationIdentitiesRequest& WithPoolId(PoolIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<PoolOriginationIdentitiesFilter>>
  ListPoolOriginationIdentitiesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = PoolOriginationIdentitiesFilter>
  ListPoolOriginationIdentitiesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPoolOriginationIdentitiesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPoolOriginationIdentitiesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
