...
class DeleteConfigurationSetResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DeleteConfigurationSetResult& operator=(
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  DeleteConfigurationSetResult& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  DeleteConfigurationSetResult& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename EventDestinationsT = Aws::Vector<EventDestination>>
  DeleteConfigurationSetResult& WithEventDestinations(EventDestinationsT&& value) {
    SetEventDestinations(std::forward<EventDestinationsT>(value));
    return *this;
  }
  template <typename EventDestinationsT = EventDestination>
  DeleteConfigurationSetResult& AddEventDestinations(EventDestinationsT&& value) {
    m_eventDestinationsHasBeenSet = true;
  ...
  inline DeleteConfigurationSetResult& WithDefaultMessageType(MessageType value) {
  ...
  template <typename DefaultSenderIdT = Aws::String>
  DeleteConfigurationSetResult& WithDefaultSenderId(DefaultSenderIdT&& value) {
  ...
  inline DeleteConfigurationSetResult& WithDefaultMessageFeedbackEnabled(bool value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  DeleteConfigurationSetResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
