...
class ProtectConfigurationInformation {
 public:
  ...
  template <typename ProtectConfigurationArnT = Aws::String>
  ProtectConfigurationInformation& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) {
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  ProtectConfigurationInformation& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  ProtectConfigurationInformation& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  inline ProtectConfigurationInformation& WithAccountDefault(bool value) {
  ...
  inline ProtectConfigurationInformation& WithDeletionProtectionEnabled(bool value) {
