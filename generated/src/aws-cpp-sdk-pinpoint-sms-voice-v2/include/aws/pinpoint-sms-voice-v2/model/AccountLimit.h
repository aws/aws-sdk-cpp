...
class AccountLimit {
 public:
  ...
  inline void SetName(AccountLimitName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AccountLimit& WithName(AccountLimitName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUsed(long long value) {
    m_usedHasBeenSet = true;
    m_used = value;
  }
  inline AccountLimit& WithUsed(long long value) {
    SetUsed(value);
    return *this;
  }
  ///@}
  ...
  inline AccountLimit& WithMax(long long value) {
    SetMax(value);
    return *this;
  }
  ///@}
