...
class UpdateSenderIdRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename SenderIdT = Aws::String>
  UpdateSenderIdRequest& WithSenderId(SenderIdT&& value) {
  ...
  template <typename IsoCountryCodeT = Aws::String>
  UpdateSenderIdRequest& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  inline UpdateSenderIdRequest& WithDeletionProtectionEnabled(bool value) {
