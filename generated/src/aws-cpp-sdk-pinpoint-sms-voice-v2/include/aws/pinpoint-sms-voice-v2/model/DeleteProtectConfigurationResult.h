...
class DeleteProtectConfigurationResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DeleteProtectConfigurationResult& operator=(
  ...
  template <typename ProtectConfigurationArnT = Aws::String>
  DeleteProtectConfigurationResult& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) {
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  DeleteProtectConfigurationResult& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  DeleteProtectConfigurationResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  inline DeleteProtectConfigurationResult& WithAccountDefault(bool value) {
  ...
  inline DeleteProtectConfigurationResult& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteProtectConfigurationResult& WithRequestId(RequestIdT&& value) {
