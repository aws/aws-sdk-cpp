...
class RegistrationTypeFilter {
 public:
  ...
  inline void SetName(RegistrationTypeFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline RegistrationTypeFilter& WithName(RegistrationTypeFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  RegistrationTypeFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  RegistrationTypeFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
