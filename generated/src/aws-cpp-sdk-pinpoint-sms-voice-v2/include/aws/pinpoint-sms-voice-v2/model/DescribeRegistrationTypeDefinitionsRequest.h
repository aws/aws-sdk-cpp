...
class DescribeRegistrationTypeDefinitionsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename RegistrationTypesT = Aws::Vector<Aws::String>>
  DescribeRegistrationTypeDefinitionsRequest& WithRegistrationTypes(RegistrationTypesT&& value) {
    SetRegistrationTypes(std::forward<RegistrationTypesT>(value));
    return *this;
  }
  template <typename RegistrationTypesT = Aws::String>
  DescribeRegistrationTypeDefinitionsRequest& AddRegistrationTypes(RegistrationTypesT&& value) {
    m_registrationTypesHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<RegistrationTypeFilter>>
  DescribeRegistrationTypeDefinitionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = RegistrationTypeFilter>
  DescribeRegistrationTypeDefinitionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationTypeDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeRegistrationTypeDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
