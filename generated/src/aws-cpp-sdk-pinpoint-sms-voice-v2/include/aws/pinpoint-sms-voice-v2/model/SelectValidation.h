...
class SelectValidation {
 public:
  ...
  inline void SetMinChoices(int value) {
    m_minChoicesHasBeenSet = true;
    m_minChoices = value;
  }
  inline SelectValidation& WithMinChoices(int value) {
    SetMinChoices(value);
    return *this;
  }
  ///@}
  ...
  inline SelectValidation& WithMaxChoices(int value) {
    SetMaxChoices(value);
    return *this;
  }
  ///@}
  ...
  template <typename OptionsT = Aws::Vector<Aws::String>>
  SelectValidation& WithOptions(OptionsT&& value) {
    SetOptions(std::forward<OptionsT>(value));
    return *this;
  }
  template <typename OptionsT = Aws::String>
  SelectValidation& AddOptions(OptionsT&& value) {
    m_optionsHasBeenSet = true;
