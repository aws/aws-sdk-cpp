...
class CreateRegistrationAttachmentRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename AttachmentBodyT = Aws::Utils::ByteBuffer>
  CreateRegistrationAttachmentRequest& WithAttachmentBody(AttachmentBodyT&& value) {
  ...
  template <typename AttachmentUrlT = Aws::String>
  CreateRegistrationAttachmentRequest& WithAttachmentUrl(AttachmentUrlT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateRegistrationAttachmentRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateRegistrationAttachmentRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateRegistrationAttachmentRequest& WithClientToken(ClientTokenT&& value) {
