...
class DescribeOptOutListsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  void SetOptOutListNames(OptOutListNamesT&& value) {
    m_optOutListNamesHasBeenSet = true;
    m_optOutListNames = std::forward<OptOutListNamesT>(value);
  }
  template <typename OptOutListNamesT = Aws::Vector<Aws::String>>
  DescribeOptOutListsRequest& WithOptOutListNames(OptOutListNamesT&& value) {
    SetOptOutListNames(std::forward<OptOutListNamesT>(value));
    return *this;
  }
  template <typename OptOutListNamesT = Aws::String>
  DescribeOptOutListsRequest& AddOptOutListNames(OptOutListNamesT&& value) {
    m_optOutListNamesHasBeenSet = true;
    m_optOutListNames.emplace_back(std::forward<OptOutListNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeOptOutListsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeOptOutListsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeOptOutListsRequest& WithOwner(Owner value) {
    SetOwner(value);
    return *this;
  }
  ///@}
