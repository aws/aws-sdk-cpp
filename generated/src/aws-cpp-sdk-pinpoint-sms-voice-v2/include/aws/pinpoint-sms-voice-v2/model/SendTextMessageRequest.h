...
class SendTextMessageRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename DestinationPhoneNumberT = Aws::String>
  SendTextMessageRequest& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) {
  ...
  template <typename OriginationIdentityT = Aws::String>
  SendTextMessageRequest& WithOriginationIdentity(OriginationIdentityT&& value) {
  ...
  template <typename MessageBodyT = Aws::String>
  SendTextMessageRequest& WithMessageBody(MessageBodyT&& value) {
  ...
  inline SendTextMessageRequest& WithMessageType(MessageType value) {
  ...
  template <typename KeywordT = Aws::String>
  SendTextMessageRequest& WithKeyword(KeywordT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  SendTextMessageRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename MaxPriceT = Aws::String>
  SendTextMessageRequest& WithMaxPrice(MaxPriceT&& value) {
  ...
  inline SendTextMessageRequest& WithTimeToLive(int value) {
    SetTimeToLive(value);
    return *this;
  }
  ///@}
  ...
  template <typename ContextT = Aws::Map<Aws::String, Aws::String>>
  SendTextMessageRequest& WithContext(ContextT&& value) {
   ...
   * </ul>
   */
  inline const Aws::Map<DestinationCountryParameterKey, Aws::String>& GetDestinationCountryParameters() const {
    return m_destinationCountryParameters;
  }
  ...
  template <typename DestinationCountryParametersT = Aws::Map<DestinationCountryParameterKey, Aws::String>>
  SendTextMessageRequest& WithDestinationCountryParameters(DestinationCountryParametersT&& value) {
  ...
  inline SendTextMessageRequest& AddDestinationCountryParameters(DestinationCountryParameterKey key, Aws::String value) {
    m_destinationCountryParametersHasBeenSet = true;
    m_destinationCountryParameters.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  inline SendTextMessageRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  SendTextMessageRequest& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  inline SendTextMessageRequest& WithMessageFeedbackEnabled(bool value) {
