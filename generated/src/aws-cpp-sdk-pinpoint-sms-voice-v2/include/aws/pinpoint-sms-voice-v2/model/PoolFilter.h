...
class PoolFilter {
 public:
  ...
  inline void SetName(PoolFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline PoolFilter& WithName(PoolFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  PoolFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  PoolFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
