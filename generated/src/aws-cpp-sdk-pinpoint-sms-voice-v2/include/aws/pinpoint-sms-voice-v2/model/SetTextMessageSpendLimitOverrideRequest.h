...
class SetTextMessageSpendLimitOverrideRequest : public PinpointSMSVoiceV2Request {
 public:
  AWS_PINPOINTSMSVOICEV2_API SetTextMessageSpendLimitOverrideRequest() = default;
  ...
  inline SetTextMessageSpendLimitOverrideRequest& WithMonthlyLimit(long long value) {
