...
class ProtectConfigurationCountryRuleSetInformation {
 public:
  ...
  inline void SetProtectStatus(ProtectStatus value) {
    m_protectStatusHasBeenSet = true;
    m_protectStatus = value;
  }
  inline ProtectConfigurationCountryRuleSetInformation& WithProtectStatus(ProtectStatus value) {
    SetProtectStatus(value);
    return *this;
  }
  ///@}
 private:
