...
class SendMediaMessageResult {
 public:
  AWS_PINPOINTSMSVOICEV2_API SendMediaMessageResult() = default;
  ...
  template <typename MessageIdT = Aws::String>
  SendMediaMessageResult& WithMessageId(MessageIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SendMediaMessageResult& WithRequestId(RequestIdT&& value) {
