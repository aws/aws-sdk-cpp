...
class DeleteRegistrationResult {
 public:
  ...
  template <typename RegistrationArnT = Aws::String>
  DeleteRegistrationResult& WithRegistrationArn(RegistrationArnT&& value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  DeleteRegistrationResult& WithRegistrationId(RegistrationIdT&& value) {
  ...
  template <typename RegistrationTypeT = Aws::String>
  DeleteRegistrationResult& WithRegistrationType(RegistrationTypeT&& value) {
  ...
  inline DeleteRegistrationResult& WithRegistrationStatus(RegistrationStatus value) {
  ...
  inline void SetCurrentVersionNumber(long long value) {
    m_currentVersionNumberHasBeenSet = true;
    m_currentVersionNumber = value;
  }
  inline DeleteRegistrationResult& WithCurrentVersionNumber(long long value) {
    SetCurrentVersionNumber(value);
    return *this;
  }
  ///@}
  ...
  inline void SetApprovedVersionNumber(long long value) {
    m_approvedVersionNumberHasBeenSet = true;
    m_approvedVersionNumber = value;
  }
  inline DeleteRegistrationResult& WithApprovedVersionNumber(long long value) {
    SetApprovedVersionNumber(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLatestDeniedVersionNumber(long long value) {
    m_latestDeniedVersionNumberHasBeenSet = true;
    m_latestDeniedVersionNumber = value;
  }
  inline DeleteRegistrationResult& WithLatestDeniedVersionNumber(long long value) {
    SetLatestDeniedVersionNumber(value);
    return *this;
  }
  ///@}
  ...
  template <typename AdditionalAttributesT = Aws::Map<Aws::String, Aws::String>>
  DeleteRegistrationResult& WithAdditionalAttributes(AdditionalAttributesT&& value) {
  ...
  DeleteRegistrationResult& AddAdditionalAttributes(AdditionalAttributesKeyT&& key, AdditionalAttributesValueT&& value) {
    m_additionalAttributesHasBeenSet = true;
    m_additionalAttributes.emplace(std::forward<AdditionalAttributesKeyT>(key), std::forward<AdditionalAttributesValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  DeleteRegistrationResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteRegistrationResult& WithRequestId(RequestIdT&& value) {
