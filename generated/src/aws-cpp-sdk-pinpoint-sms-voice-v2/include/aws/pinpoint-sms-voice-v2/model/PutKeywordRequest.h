...
class PutKeywordRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename OriginationIdentityT = Aws::String>
  PutKeywordRequest& WithOriginationIdentity(OriginationIdentityT&& value) {
  ...
  template <typename KeywordT = Aws::String>
  PutKeywordRequest& WithKeyword(KeywordT&& value) {
  ...
  template <typename KeywordMessageT = Aws::String>
  PutKeywordRequest& WithKeywordMessage(KeywordMessageT&& value) {
  ...
  inline PutKeywordRequest& WithKeywordAction(KeywordAction value) {
