...
class AssociateProtectConfigurationResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API AssociateProtectConfigurationResult& operator=(
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  AssociateProtectConfigurationResult& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  AssociateProtectConfigurationResult& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename ProtectConfigurationArnT = Aws::String>
  AssociateProtectConfigurationResult& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) {
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  AssociateProtectConfigurationResult& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateProtectConfigurationResult& WithRequestId(RequestIdT&& value) {
