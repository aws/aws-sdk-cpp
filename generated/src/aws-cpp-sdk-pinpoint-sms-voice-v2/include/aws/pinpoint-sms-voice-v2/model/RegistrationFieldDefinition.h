...
class RegistrationFieldDefinition {
 public:
  ...
  template <typename SectionPathT = Aws::String>
  RegistrationFieldDefinition& WithSectionPath(SectionPathT&& value) {
  ...
  template <typename FieldPathT = Aws::String>
  RegistrationFieldDefinition& WithFieldPath(FieldPathT&& value) {
  ...
  inline void SetFieldType(FieldType value) {
    m_fieldTypeHasBeenSet = true;
    m_fieldType = value;
  }
  inline RegistrationFieldDefinition& WithFieldType(FieldType value) {
    SetFieldType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFieldRequirement(FieldRequirement value) {
    m_fieldRequirementHasBeenSet = true;
    m_fieldRequirement = value;
  }
  inline RegistrationFieldDefinition& WithFieldRequirement(FieldRequirement value) {
  ...
  void SetSelectValidation(SelectValidationT&& value) {
    m_selectValidationHasBeenSet = true;
    m_selectValidation = std::forward<SelectValidationT>(value);
  }
  template <typename SelectValidationT = SelectValidation>
  RegistrationFieldDefinition& WithSelectValidation(SelectValidationT&& value) {
    SetSelectValidation(std::forward<SelectValidationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextValidation(TextValidationT&& value) {
    m_textValidationHasBeenSet = true;
    m_textValidation = std::forward<TextValidationT>(value);
  }
  template <typename TextValidationT = TextValidation>
  RegistrationFieldDefinition& WithTextValidation(TextValidationT&& value) {
    SetTextValidation(std::forward<TextValidationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DisplayHintsT = RegistrationFieldDisplayHints>
  RegistrationFieldDefinition& WithDisplayHints(DisplayHintsT&& value) {
