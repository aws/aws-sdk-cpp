...
class RegistrationVersionFilter {
 public:
  ...
  inline void SetName(RegistrationVersionFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline RegistrationVersionFilter& WithName(RegistrationVersionFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  RegistrationVersionFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  RegistrationVersionFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
