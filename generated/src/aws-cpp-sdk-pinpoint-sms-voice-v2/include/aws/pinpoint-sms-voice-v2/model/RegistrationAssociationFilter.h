...
class RegistrationAssociationFilter {
 public:
  ...
  inline void SetName(RegistrationAssociationFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline RegistrationAssociationFilter& WithName(RegistrationAssociationFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  RegistrationAssociationFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  RegistrationAssociationFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
