...
class DescribeSenderIdsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  void SetSenderIds(SenderIdsT&& value) {
    m_senderIdsHasBeenSet = true;
    m_senderIds = std::forward<SenderIdsT>(value);
  }
  template <typename SenderIdsT = Aws::Vector<SenderIdAndCountry>>
  DescribeSenderIdsRequest& WithSenderIds(SenderIdsT&& value) {
    SetSenderIds(std::forward<SenderIdsT>(value));
    return *this;
  }
  template <typename SenderIdsT = SenderIdAndCountry>
  DescribeSenderIdsRequest& AddSenderIds(SenderIdsT&& value) {
    m_senderIdsHasBeenSet = true;
    m_senderIds.emplace_back(std::forward<SenderIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<SenderIdFilter>>
  DescribeSenderIdsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = SenderIdFilter>
  DescribeSenderIdsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSenderIdsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeSenderIdsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeSenderIdsRequest& WithOwner(Owner value) {
    SetOwner(value);
    return *this;
  }
  ///@}
