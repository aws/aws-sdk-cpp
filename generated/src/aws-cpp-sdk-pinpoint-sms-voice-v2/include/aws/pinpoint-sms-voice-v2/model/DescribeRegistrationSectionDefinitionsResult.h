...
class DescribeRegistrationSectionDefinitionsResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DescribeRegistrationSectionDefinitionsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RegistrationTypeT = Aws::String>
  DescribeRegistrationSectionDefinitionsResult& WithRegistrationType(RegistrationTypeT&& value) {
   ...
   */
  inline const Aws::Vector<RegistrationSectionDefinition>& GetRegistrationSectionDefinitions() const {
    return m_registrationSectionDefinitions;
  }
  template <typename RegistrationSectionDefinitionsT = Aws::Vector<RegistrationSectionDefinition>>
  void SetRegistrationSectionDefinitions(RegistrationSectionDefinitionsT&& value) {
    m_registrationSectionDefinitionsHasBeenSet = true;
    m_registrationSectionDefinitions = std::forward<RegistrationSectionDefinitionsT>(value);
  }
  template <typename RegistrationSectionDefinitionsT = Aws::Vector<RegistrationSectionDefinition>>
  DescribeRegistrationSectionDefinitionsResult& WithRegistrationSectionDefinitions(RegistrationSectionDefinitionsT&& value) {
    SetRegistrationSectionDefinitions(std::forward<RegistrationSectionDefinitionsT>(value));
    return *this;
  }
  template <typename RegistrationSectionDefinitionsT = RegistrationSectionDefinition>
  DescribeRegistrationSectionDefinitionsResult& AddRegistrationSectionDefinitions(RegistrationSectionDefinitionsT&& value) {
    m_registrationSectionDefinitionsHasBeenSet = true;
    m_registrationSectionDefinitions.emplace_back(std::forward<RegistrationSectionDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationSectionDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRegistrationSectionDefinitionsResult& WithRequestId(RequestIdT&& value) {
