...
class PutProtectConfigurationRuleSetNumberOverrideRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  PutProtectConfigurationRuleSetNumberOverrideRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  PutProtectConfigurationRuleSetNumberOverrideRequest& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename DestinationPhoneNumberT = Aws::String>
  PutProtectConfigurationRuleSetNumberOverrideRequest& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) {
  ...
  inline PutProtectConfigurationRuleSetNumberOverrideRequest& WithAction(ProtectConfigurationRuleOverrideAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename ExpirationTimestampT = Aws::Utils::DateTime>
  PutProtectConfigurationRuleSetNumberOverrideRequest& WithExpirationTimestamp(ExpirationTimestampT&& value) {
