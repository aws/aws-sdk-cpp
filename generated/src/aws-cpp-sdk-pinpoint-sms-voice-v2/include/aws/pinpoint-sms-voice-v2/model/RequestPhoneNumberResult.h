...
class RequestPhoneNumberResult {
 public:
  ...
  template <typename PhoneNumberArnT = Aws::String>
  RequestPhoneNumberResult& WithPhoneNumberArn(PhoneNumberArnT&& value) {
  ...
  template <typename PhoneNumberIdT = Aws::String>
  RequestPhoneNumberResult& WithPhoneNumberId(PhoneNumberIdT&& value) {
  ...
  template <typename PhoneNumberT = Aws::String>
  RequestPhoneNumberResult& WithPhoneNumber(PhoneNumberT&& value) {
  ...
  inline RequestPhoneNumberResult& WithStatus(NumberStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename IsoCountryCodeT = Aws::String>
  RequestPhoneNumberResult& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  inline RequestPhoneNumberResult& WithMessageType(MessageType value) {
  ...
  template <typename NumberCapabilitiesT = Aws::Vector<NumberCapability>>
  RequestPhoneNumberResult& WithNumberCapabilities(NumberCapabilitiesT&& value) {
    SetNumberCapabilities(std::forward<NumberCapabilitiesT>(value));
    return *this;
  }
  inline RequestPhoneNumberResult& AddNumberCapabilities(NumberCapability value) {
    m_numberCapabilitiesHasBeenSet = true;
  ...
  inline void SetNumberType(RequestableNumberType value) {
    m_numberTypeHasBeenSet = true;
    m_numberType = value;
  }
  inline RequestPhoneNumberResult& WithNumberType(RequestableNumberType value) {
    SetNumberType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MonthlyLeasingPriceT = Aws::String>
  RequestPhoneNumberResult& WithMonthlyLeasingPrice(MonthlyLeasingPriceT&& value) {
  ...
  inline RequestPhoneNumberResult& WithTwoWayEnabled(bool value) {
  ...
  template <typename TwoWayChannelArnT = Aws::String>
  RequestPhoneNumberResult& WithTwoWayChannelArn(TwoWayChannelArnT&& value) {
  ...
  template <typename TwoWayChannelRoleT = Aws::String>
  RequestPhoneNumberResult& WithTwoWayChannelRole(TwoWayChannelRoleT&& value) {
  ...
  inline RequestPhoneNumberResult& WithSelfManagedOptOutsEnabled(bool value) {
  ...
  template <typename OptOutListNameT = Aws::String>
  RequestPhoneNumberResult& WithOptOutListName(OptOutListNameT&& value) {
  ...
  inline void SetInternationalSendingEnabled(bool value) {
    m_internationalSendingEnabledHasBeenSet = true;
    m_internationalSendingEnabled = value;
  }
  inline RequestPhoneNumberResult& WithInternationalSendingEnabled(bool value) {
    SetInternationalSendingEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline RequestPhoneNumberResult& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename PoolIdT = Aws::String>
  RequestPhoneNumberResult& WithPoolId(PoolIdT&& value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  RequestPhoneNumberResult& WithRegistrationId(RegistrationIdT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  RequestPhoneNumberResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  RequestPhoneNumberResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  RequestPhoneNumberResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RequestPhoneNumberResult& WithRequestId(RequestIdT&& value) {
