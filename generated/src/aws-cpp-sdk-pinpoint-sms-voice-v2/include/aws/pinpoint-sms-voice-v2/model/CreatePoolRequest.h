...
class CreatePoolRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename OriginationIdentityT = Aws::String>
  CreatePoolRequest& WithOriginationIdentity(OriginationIdentityT&& value) {
  ...
  template <typename IsoCountryCodeT = Aws::String>
  CreatePoolRequest& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  inline CreatePoolRequest& WithMessageType(MessageType value) {
  ...
  inline CreatePoolRequest& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreatePoolRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreatePoolRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreatePoolRequest& WithClientToken(ClientTokenT&& value) {
