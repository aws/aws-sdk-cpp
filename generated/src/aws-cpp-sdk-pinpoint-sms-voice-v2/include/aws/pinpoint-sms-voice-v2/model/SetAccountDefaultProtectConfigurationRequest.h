...
class SetAccountDefaultProtectConfigurationRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "SetAccountDefaultProtectConfiguration"; }
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  SetAccountDefaultProtectConfigurationRequest& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
