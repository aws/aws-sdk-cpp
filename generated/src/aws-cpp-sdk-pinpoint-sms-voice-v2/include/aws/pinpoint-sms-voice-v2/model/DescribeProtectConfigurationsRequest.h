...
class DescribeProtectConfigurationsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  void SetProtectConfigurationIds(ProtectConfigurationIdsT&& value) {
    m_protectConfigurationIdsHasBeenSet = true;
    m_protectConfigurationIds = std::forward<ProtectConfigurationIdsT>(value);
  }
  template <typename ProtectConfigurationIdsT = Aws::Vector<Aws::String>>
  DescribeProtectConfigurationsRequest& WithProtectConfigurationIds(ProtectConfigurationIdsT&& value) {
    SetProtectConfigurationIds(std::forward<ProtectConfigurationIdsT>(value));
    return *this;
  }
  template <typename ProtectConfigurationIdsT = Aws::String>
  DescribeProtectConfigurationsRequest& AddProtectConfigurationIds(ProtectConfigurationIdsT&& value) {
    m_protectConfigurationIdsHasBeenSet = true;
    m_protectConfigurationIds.emplace_back(std::forward<ProtectConfigurationIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<ProtectConfigurationFilter>>
  DescribeProtectConfigurationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ProtectConfigurationFilter>
  DescribeProtectConfigurationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeProtectConfigurationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeProtectConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
