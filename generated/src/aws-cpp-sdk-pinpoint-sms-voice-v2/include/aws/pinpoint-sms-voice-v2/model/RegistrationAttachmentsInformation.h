...
class RegistrationAttachmentsInformation {
 public:
  ...
  template <typename RegistrationAttachmentArnT = Aws::String>
  RegistrationAttachmentsInformation& WithRegistrationAttachmentArn(RegistrationAttachmentArnT&& value) {
  ...
  template <typename RegistrationAttachmentIdT = Aws::String>
  RegistrationAttachmentsInformation& WithRegistrationAttachmentId(RegistrationAttachmentIdT&& value) {
  ...
  inline RegistrationAttachmentsInformation& WithAttachmentStatus(AttachmentStatus value) {
  ...
  inline RegistrationAttachmentsInformation& WithAttachmentUploadErrorReason(AttachmentUploadErrorReason value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  RegistrationAttachmentsInformation& WithCreatedTimestamp(CreatedTimestampT&& value) {
