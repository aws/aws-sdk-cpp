...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINTSMSVOICEV2_API DeleteAccountDefaultProtectConfigurationResult() = default;
    ...
    template<typename DefaultProtectConfigurationArnT = Aws::String>
    DeleteAccountDefaultProtectConfigurationResult& WithDefaultProtectConfigurationArn(DefaultProtectConfigurationArnT&& value) { SetDefaultProtectConfigurationArn(std::forward<DefaultProtectConfigurationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultProtectConfigurationIdT = Aws::String>
    DeleteAccountDefaultProtectConfigurationResult& WithDefaultProtectConfigurationId(DefaultProtectConfigurationIdT&& value) { SetDefaultProtectConfigurationId(std::forward<DefaultProtectConfigurationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAccountDefaultProtectConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
