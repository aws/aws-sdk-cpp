...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINTSMSVOICEV2_API UpdateProtectConfigurationResult() = default;
    ...
    template<typename ProtectConfigurationArnT = Aws::String>
    UpdateProtectConfigurationResult& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) { SetProtectConfigurationArn(std::forward<ProtectConfigurationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ProtectConfigurationIdT = Aws::String>
    UpdateProtectConfigurationResult& WithProtectConfigurationId(ProtectConfigurationIdT&& value) { SetProtectConfigurationId(std::forward<ProtectConfigurationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedTimestampT = Aws::Utils::DateTime>
    UpdateProtectConfigurationResult& WithCreatedTimestamp(CreatedTimestampT&& value) { SetCreatedTimestamp(std::forward<CreatedTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateProtectConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
