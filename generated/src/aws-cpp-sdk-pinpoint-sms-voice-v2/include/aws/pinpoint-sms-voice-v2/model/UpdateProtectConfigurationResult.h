...
class UpdateProtectConfigurationResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API UpdateProtectConfigurationResult& operator=(
  ...
  template <typename ProtectConfigurationArnT = Aws::String>
  UpdateProtectConfigurationResult& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) {
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  UpdateProtectConfigurationResult& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  UpdateProtectConfigurationResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  inline UpdateProtectConfigurationResult& WithAccountDefault(bool value) {
  ...
  inline UpdateProtectConfigurationResult& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateProtectConfigurationResult& WithRequestId(RequestIdT&& value) {
