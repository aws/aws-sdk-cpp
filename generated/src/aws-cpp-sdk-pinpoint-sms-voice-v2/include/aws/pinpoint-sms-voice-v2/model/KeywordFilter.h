...
class KeywordFilter {
 public:
  ...
  inline void SetName(KeywordFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline KeywordFilter& WithName(KeywordFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  KeywordFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  KeywordFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
