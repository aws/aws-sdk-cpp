...
class RegistrationAssociationMetadata {
 public:
  AWS_PINPOINTSMSVOICEV2_API RegistrationAssociationMetadata() = default;
  ...
  template <typename ResourceArnT = Aws::String>
  RegistrationAssociationMetadata& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  RegistrationAssociationMetadata& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  RegistrationAssociationMetadata& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename IsoCountryCodeT = Aws::String>
  RegistrationAssociationMetadata& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  template <typename PhoneNumberT = Aws::String>
  RegistrationAssociationMetadata& WithPhoneNumber(PhoneNumberT&& value) {
