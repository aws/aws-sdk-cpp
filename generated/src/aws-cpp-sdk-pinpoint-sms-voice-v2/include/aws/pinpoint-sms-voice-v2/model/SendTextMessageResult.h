...
namespace Model
{
  ...
  {
  public:
    AWS_PINPOINTSMSVOICEV2_API SendTextMessageResult() = default;
    ...
    template<typename MessageIdT = Aws::String>
    SendTextMessageResult& WithMessageId(MessageIdT&& value) { SetMessageId(std::forward<MessageIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SendTextMessageResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
