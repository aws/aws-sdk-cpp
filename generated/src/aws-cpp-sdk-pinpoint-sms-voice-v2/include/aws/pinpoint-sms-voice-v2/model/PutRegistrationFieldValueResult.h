...
class PutRegistrationFieldValueResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API PutRegistrationFieldValueResult& operator=(
  ...
  template <typename RegistrationArnT = Aws::String>
  PutRegistrationFieldValueResult& WithRegistrationArn(RegistrationArnT&& value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  PutRegistrationFieldValueResult& WithRegistrationId(RegistrationIdT&& value) {
  ...
  inline PutRegistrationFieldValueResult& WithVersionNumber(long long value) {
  ...
  template <typename FieldPathT = Aws::String>
  PutRegistrationFieldValueResult& WithFieldPath(FieldPathT&& value) {
  ...
  void SetSelectChoices(SelectChoicesT&& value) {
    m_selectChoicesHasBeenSet = true;
    m_selectChoices = std::forward<SelectChoicesT>(value);
  }
  template <typename SelectChoicesT = Aws::Vector<Aws::String>>
  PutRegistrationFieldValueResult& WithSelectChoices(SelectChoicesT&& value) {
    SetSelectChoices(std::forward<SelectChoicesT>(value));
    return *this;
  }
  template <typename SelectChoicesT = Aws::String>
  PutRegistrationFieldValueResult& AddSelectChoices(SelectChoicesT&& value) {
    m_selectChoicesHasBeenSet = true;
    m_selectChoices.emplace_back(std::forward<SelectChoicesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextValue(TextValueT&& value) {
    m_textValueHasBeenSet = true;
    m_textValue = std::forward<TextValueT>(value);
  }
  template <typename TextValueT = Aws::String>
  PutRegistrationFieldValueResult& WithTextValue(TextValueT&& value) {
    SetTextValue(std::forward<TextValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RegistrationAttachmentIdT = Aws::String>
  PutRegistrationFieldValueResult& WithRegistrationAttachmentId(RegistrationAttachmentIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutRegistrationFieldValueResult& WithRequestId(RequestIdT&& value) {
