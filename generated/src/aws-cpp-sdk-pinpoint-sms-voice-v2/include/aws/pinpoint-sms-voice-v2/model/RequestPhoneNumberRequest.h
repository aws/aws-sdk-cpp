...
class RequestPhoneNumberRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename IsoCountryCodeT = Aws::String>
  RequestPhoneNumberRequest& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  inline RequestPhoneNumberRequest& WithMessageType(MessageType value) {
  ...
  template <typename NumberCapabilitiesT = Aws::Vector<NumberCapability>>
  RequestPhoneNumberRequest& WithNumberCapabilities(NumberCapabilitiesT&& value) {
    SetNumberCapabilities(std::forward<NumberCapabilitiesT>(value));
    return *this;
  }
  inline RequestPhoneNumberRequest& AddNumberCapabilities(NumberCapability value) {
    m_numberCapabilitiesHasBeenSet = true;
  ...
  inline RequestPhoneNumberRequest& WithNumberType(RequestableNumberType value) {
    SetNumberType(value);
    return *this;
  }
  ///@}
  ...
  template <typename OptOutListNameT = Aws::String>
  RequestPhoneNumberRequest& WithOptOutListName(OptOutListNameT&& value) {
  ...
  template <typename PoolIdT = Aws::String>
  RequestPhoneNumberRequest& WithPoolId(PoolIdT&& value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  RequestPhoneNumberRequest& WithRegistrationId(RegistrationIdT&& value) {
  ...
  inline RequestPhoneNumberRequest& WithInternationalSendingEnabled(bool value) {
  ...
  inline RequestPhoneNumberRequest& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  RequestPhoneNumberRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  RequestPhoneNumberRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  RequestPhoneNumberRequest& WithClientToken(ClientTokenT&& value) {
