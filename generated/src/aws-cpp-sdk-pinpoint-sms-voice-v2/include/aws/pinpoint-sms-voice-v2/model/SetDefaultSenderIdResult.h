...
class SetDefaultSenderIdResult {
 public:
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  SetDefaultSenderIdResult& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  SetDefaultSenderIdResult& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename SenderIdT = Aws::String>
  SetDefaultSenderIdResult& WithSenderId(SenderIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SetDefaultSenderIdResult& WithRequestId(RequestIdT&& value) {
