...
class CreateRegistrationRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename RegistrationTypeT = Aws::String>
  CreateRegistrationRequest& WithRegistrationType(RegistrationTypeT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateRegistrationRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateRegistrationRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateRegistrationRequest& WithClientToken(ClientTokenT&& value) {
