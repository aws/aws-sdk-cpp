...
class DescribeAccountLimitsResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAccountLimitsResult& WithRequestId(RequestIdT&& value) {
