...
class DescribeKeywordsResult {
 public:
  ...
  template <typename OriginationIdentityArnT = Aws::String>
  DescribeKeywordsResult& WithOriginationIdentityArn(OriginationIdentityArnT&& value) {
  ...
  template <typename OriginationIdentityT = Aws::String>
  DescribeKeywordsResult& WithOriginationIdentity(OriginationIdentityT&& value) {
  ...
  template <typename KeywordsT = Aws::Vector<KeywordInformation>>
  DescribeKeywordsResult& WithKeywords(KeywordsT&& value) {
    SetKeywords(std::forward<KeywordsT>(value));
    return *this;
  }
  template <typename KeywordsT = KeywordInformation>
  DescribeKeywordsResult& AddKeywords(KeywordsT&& value) {
    m_keywordsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeKeywordsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeKeywordsResult& WithRequestId(RequestIdT&& value) {
