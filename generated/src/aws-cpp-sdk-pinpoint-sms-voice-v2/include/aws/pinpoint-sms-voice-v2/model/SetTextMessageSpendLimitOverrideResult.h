...
class SetTextMessageSpendLimitOverrideResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API SetTextMessageSpendLimitOverrideResult& operator=(
  ...
  inline SetTextMessageSpendLimitOverrideResult& WithMonthlyLimit(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  SetTextMessageSpendLimitOverrideResult& WithRequestId(RequestIdT&& value) {
