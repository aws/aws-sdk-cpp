...
class DescribeRegistrationSectionDefinitionsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename RegistrationTypeT = Aws::String>
  DescribeRegistrationSectionDefinitionsRequest& WithRegistrationType(RegistrationTypeT&& value) {
  ...
  void SetSectionPaths(SectionPathsT&& value) {
    m_sectionPathsHasBeenSet = true;
    m_sectionPaths = std::forward<SectionPathsT>(value);
  }
  template <typename SectionPathsT = Aws::Vector<Aws::String>>
  DescribeRegistrationSectionDefinitionsRequest& WithSectionPaths(SectionPathsT&& value) {
    SetSectionPaths(std::forward<SectionPathsT>(value));
    return *this;
  }
  template <typename SectionPathsT = Aws::String>
  DescribeRegistrationSectionDefinitionsRequest& AddSectionPaths(SectionPathsT&& value) {
    m_sectionPathsHasBeenSet = true;
    m_sectionPaths.emplace_back(std::forward<SectionPathsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationSectionDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeRegistrationSectionDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
