...
class UpdateSenderIdResult {
 public:
  ...
  template <typename SenderIdArnT = Aws::String>
  UpdateSenderIdResult& WithSenderIdArn(SenderIdArnT&& value) {
  ...
  template <typename SenderIdT = Aws::String>
  UpdateSenderIdResult& WithSenderId(SenderIdT&& value) {
  ...
  template <typename IsoCountryCodeT = Aws::String>
  UpdateSenderIdResult& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  template <typename MessageTypesT = Aws::Vector<MessageType>>
  UpdateSenderIdResult& WithMessageTypes(MessageTypesT&& value) {
    SetMessageTypes(std::forward<MessageTypesT>(value));
    return *this;
  }
  inline UpdateSenderIdResult& AddMessageTypes(MessageType value) {
    m_messageTypesHasBeenSet = true;
  ...
  template <typename MonthlyLeasingPriceT = Aws::String>
  UpdateSenderIdResult& WithMonthlyLeasingPrice(MonthlyLeasingPriceT&& value) {
  ...
  inline UpdateSenderIdResult& WithDeletionProtectionEnabled(bool value) {
  ...
  inline UpdateSenderIdResult& WithRegistered(bool value) {
    SetRegistered(value);
    return *this;
  }
  ///@}
  ...
  template <typename RegistrationIdT = Aws::String>
  UpdateSenderIdResult& WithRegistrationId(RegistrationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSenderIdResult& WithRequestId(RequestIdT&& value) {
