...
class RegistrationFieldDisplayHints {
 public:
  ...
  template <typename TitleT = Aws::String>
  RegistrationFieldDisplayHints& WithTitle(TitleT&& value) {
  ...
  template <typename ShortDescriptionT = Aws::String>
  RegistrationFieldDisplayHints& WithShortDescription(ShortDescriptionT&& value) {
  ...
  template <typename LongDescriptionT = Aws::String>
  RegistrationFieldDisplayHints& WithLongDescription(LongDescriptionT&& value) {
  ...
  template <typename DocumentationTitleT = Aws::String>
  RegistrationFieldDisplayHints& WithDocumentationTitle(DocumentationTitleT&& value) {
  ...
  template <typename DocumentationLinkT = Aws::String>
  RegistrationFieldDisplayHints& WithDocumentationLink(DocumentationLinkT&& value) {
  ...
  void SetSelectOptionDescriptions(SelectOptionDescriptionsT&& value) {
    m_selectOptionDescriptionsHasBeenSet = true;
    m_selectOptionDescriptions = std::forward<SelectOptionDescriptionsT>(value);
  }
  template <typename SelectOptionDescriptionsT = Aws::Vector<SelectOptionDescription>>
  RegistrationFieldDisplayHints& WithSelectOptionDescriptions(SelectOptionDescriptionsT&& value) {
    SetSelectOptionDescriptions(std::forward<SelectOptionDescriptionsT>(value));
    return *this;
  }
  template <typename SelectOptionDescriptionsT = SelectOptionDescription>
  RegistrationFieldDisplayHints& AddSelectOptionDescriptions(SelectOptionDescriptionsT&& value) {
    m_selectOptionDescriptionsHasBeenSet = true;
    m_selectOptionDescriptions.emplace_back(std::forward<SelectOptionDescriptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextValidationDescription(TextValidationDescriptionT&& value) {
    m_textValidationDescriptionHasBeenSet = true;
    m_textValidationDescription = std::forward<TextValidationDescriptionT>(value);
  }
  template <typename TextValidationDescriptionT = Aws::String>
  RegistrationFieldDisplayHints& WithTextValidationDescription(TextValidationDescriptionT&& value) {
    SetTextValidationDescription(std::forward<TextValidationDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExampleTextValue(ExampleTextValueT&& value) {
    m_exampleTextValueHasBeenSet = true;
    m_exampleTextValue = std::forward<ExampleTextValueT>(value);
  }
  template <typename ExampleTextValueT = Aws::String>
  RegistrationFieldDisplayHints& WithExampleTextValue(ExampleTextValueT&& value) {
    SetExampleTextValue(std::forward<ExampleTextValueT>(value));
    return *this;
  }
  ///@}
 private:
