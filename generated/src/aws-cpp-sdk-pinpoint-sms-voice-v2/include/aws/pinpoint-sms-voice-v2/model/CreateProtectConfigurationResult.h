...
class CreateProtectConfigurationResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API CreateProtectConfigurationResult& operator=(
  ...
  template <typename ProtectConfigurationArnT = Aws::String>
  CreateProtectConfigurationResult& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) {
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  CreateProtectConfigurationResult& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  CreateProtectConfigurationResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  inline void SetAccountDefault(bool value) {
    m_accountDefaultHasBeenSet = true;
    m_accountDefault = value;
  }
  inline CreateProtectConfigurationResult& WithAccountDefault(bool value) {
    SetAccountDefault(value);
    return *this;
  }
  ///@}
  ...
  inline CreateProtectConfigurationResult& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateProtectConfigurationResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateProtectConfigurationResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateProtectConfigurationResult& WithRequestId(RequestIdT&& value) {
