...
class UpdateRcsAgentResult {
 public:
  AWS_PINPOINTSMSVOICEV2_API UpdateRcsAgentResult() = default;
  AWS_PINPOINTSMSVOICEV2_API UpdateRcsAgentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PINPOINTSMSVOICEV2_API UpdateRcsAgentResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RcsAgentArnT = Aws::String>
  UpdateRcsAgentResult& WithRcsAgentArn(RcsAgentArnT&& value) {
  ...
  template <typename RcsAgentIdT = Aws::String>
  UpdateRcsAgentResult& WithRcsAgentId(RcsAgentIdT&& value) {
  ...
  inline UpdateRcsAgentResult& WithStatus(RcsAgentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  UpdateRcsAgentResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  inline UpdateRcsAgentResult& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename OptOutListNameT = Aws::String>
  UpdateRcsAgentResult& WithOptOutListName(OptOutListNameT&& value) {
  ...
  inline UpdateRcsAgentResult& WithSelfManagedOptOutsEnabled(bool value) {
  ...
  template <typename TwoWayChannelArnT = Aws::String>
  UpdateRcsAgentResult& WithTwoWayChannelArn(TwoWayChannelArnT&& value) {
  ...
  template <typename TwoWayChannelRoleT = Aws::String>
  UpdateRcsAgentResult& WithTwoWayChannelRole(TwoWayChannelRoleT&& value) {
  ...
  inline UpdateRcsAgentResult& WithTwoWayEnabled(bool value) {
  ...
  template <typename TwoWayMediaS3BucketNameT = Aws::String>
  UpdateRcsAgentResult& WithTwoWayMediaS3BucketName(TwoWayMediaS3BucketNameT&& value) {
  ...
  template <typename TwoWayMediaS3KeyPrefixT = Aws::String>
  UpdateRcsAgentResult& WithTwoWayMediaS3KeyPrefix(TwoWayMediaS3KeyPrefixT&& value) {
  ...
  template <typename TwoWayMediaS3RoleT = Aws::String>
  UpdateRcsAgentResult& WithTwoWayMediaS3Role(TwoWayMediaS3RoleT&& value) {
  ...
  template <typename TwoWayRcsEventsEnabledT = Aws::Vector<Aws::String>>
  UpdateRcsAgentResult& WithTwoWayRcsEventsEnabled(TwoWayRcsEventsEnabledT&& value) {
    SetTwoWayRcsEventsEnabled(std::forward<TwoWayRcsEventsEnabledT>(value));
    return *this;
  }
  template <typename TwoWayRcsEventsEnabledT = Aws::String>
  UpdateRcsAgentResult& AddTwoWayRcsEventsEnabled(TwoWayRcsEventsEnabledT&& value) {
    m_twoWayRcsEventsEnabledHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRcsAgentResult& WithRequestId(RequestIdT&& value) {
