...
namespace Model
{
  ...
  public:
    ...
    template<typename OptOutListNameT = Aws::String>
    DeleteOptedOutNumberRequest& WithOptOutListName(OptOutListNameT&& value) { SetOptOutListName(std::forward<OptOutListNameT>(value)); return *this;}
    ///@}
    ...
    template<typename OptedOutNumberT = Aws::String>
    DeleteOptedOutNumberRequest& WithOptedOutNumber(OptedOutNumberT&& value) { SetOptedOutNumber(std::forward<OptedOutNumberT>(value)); return *this;}
    ///@}
  private:
