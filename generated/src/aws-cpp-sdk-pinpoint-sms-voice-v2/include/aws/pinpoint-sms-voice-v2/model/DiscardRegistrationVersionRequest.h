...
class DiscardRegistrationVersionRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DiscardRegistrationVersion"; }
  ...
  template <typename RegistrationIdT = Aws::String>
  DiscardRegistrationVersionRequest& WithRegistrationId(RegistrationIdT&& value) {
