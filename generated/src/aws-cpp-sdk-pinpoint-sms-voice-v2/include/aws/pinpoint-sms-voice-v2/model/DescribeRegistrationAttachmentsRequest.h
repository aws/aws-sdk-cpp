...
class DescribeRegistrationAttachmentsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  void SetRegistrationAttachmentIds(RegistrationAttachmentIdsT&& value) {
    m_registrationAttachmentIdsHasBeenSet = true;
    m_registrationAttachmentIds = std::forward<RegistrationAttachmentIdsT>(value);
  }
  template <typename RegistrationAttachmentIdsT = Aws::Vector<Aws::String>>
  DescribeRegistrationAttachmentsRequest& WithRegistrationAttachmentIds(RegistrationAttachmentIdsT&& value) {
    SetRegistrationAttachmentIds(std::forward<RegistrationAttachmentIdsT>(value));
    return *this;
  }
  template <typename RegistrationAttachmentIdsT = Aws::String>
  DescribeRegistrationAttachmentsRequest& AddRegistrationAttachmentIds(RegistrationAttachmentIdsT&& value) {
    m_registrationAttachmentIdsHasBeenSet = true;
    m_registrationAttachmentIds.emplace_back(std::forward<RegistrationAttachmentIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<RegistrationAttachmentFilter>>
  DescribeRegistrationAttachmentsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = RegistrationAttachmentFilter>
  DescribeRegistrationAttachmentsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationAttachmentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeRegistrationAttachmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
