...
class UpdateEventDestinationResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API UpdateEventDestinationResult& operator=(
  ...
  template <typename ConfigurationSetArnT = Aws::String>
  UpdateEventDestinationResult& WithConfigurationSetArn(ConfigurationSetArnT&& value) {
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  UpdateEventDestinationResult& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  template <typename EventDestinationT = EventDestination>
  UpdateEventDestinationResult& WithEventDestination(EventDestinationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateEventDestinationResult& WithRequestId(RequestIdT&& value) {
