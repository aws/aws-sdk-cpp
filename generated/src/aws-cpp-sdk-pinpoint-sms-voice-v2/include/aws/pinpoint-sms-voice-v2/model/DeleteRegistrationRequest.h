...
class DeleteRegistrationRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DeleteRegistration"; }
  ...
  template <typename RegistrationIdT = Aws::String>
  DeleteRegistrationRequest& WithRegistrationId(RegistrationIdT&& value) {
