...
class DescribeRegistrationFieldDefinitionsResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DescribeRegistrationFieldDefinitionsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RegistrationTypeT = Aws::String>
  DescribeRegistrationFieldDefinitionsResult& WithRegistrationType(RegistrationTypeT&& value) {
  ...
  void SetRegistrationFieldDefinitions(RegistrationFieldDefinitionsT&& value) {
    m_registrationFieldDefinitionsHasBeenSet = true;
    m_registrationFieldDefinitions = std::forward<RegistrationFieldDefinitionsT>(value);
  }
  template <typename RegistrationFieldDefinitionsT = Aws::Vector<RegistrationFieldDefinition>>
  DescribeRegistrationFieldDefinitionsResult& WithRegistrationFieldDefinitions(RegistrationFieldDefinitionsT&& value) {
    SetRegistrationFieldDefinitions(std::forward<RegistrationFieldDefinitionsT>(value));
    return *this;
  }
  template <typename RegistrationFieldDefinitionsT = RegistrationFieldDefinition>
  DescribeRegistrationFieldDefinitionsResult& AddRegistrationFieldDefinitions(RegistrationFieldDefinitionsT&& value) {
    m_registrationFieldDefinitionsHasBeenSet = true;
    m_registrationFieldDefinitions.emplace_back(std::forward<RegistrationFieldDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationFieldDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRegistrationFieldDefinitionsResult& WithRequestId(RequestIdT&& value) {
