...
/**
 * <p>The media content of a carousel card. Display height is restricted to SHORT
 * or MEDIUM (TALL is not supported in carousels).</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/RcsCarouselCardMedia">AWS
 * API Reference</a></p>
 */
class RcsCarouselCardMedia {
 public:
  AWS_PINPOINTSMSVOICEV2_API RcsCarouselCardMedia() = default;
  AWS_PINPOINTSMSVOICEV2_API RcsCarouselCardMedia(Aws::Utils::Json::JsonView jsonValue);
  AWS_PINPOINTSMSVOICEV2_API RcsCarouselCardMedia& operator=(Aws::Utils::Json::JsonView jsonValue);
  AWS_PINPOINTSMSVOICEV2_API Aws::Utils::Json::JsonValue Jsonize() const;

  ///@{
  /**
   * <p>The S3 URI of the media file for the carousel card. Maximum 2000
   * characters.</p>
   */
  ...
  template <typename FileUrlT = Aws::String>
  RcsCarouselCardMedia& WithFileUrl(FileUrlT&& value) {
  ...
  ///@{
  /**
   * <p>The S3 URI of an optional thumbnail image for the carousel card media.
   * Maximum 2000 characters.</p>
   */
  ...
  template <typename ThumbnailUrlT = Aws::String>
  RcsCarouselCardMedia& WithThumbnailUrl(ThumbnailUrlT&& value) {
  ...
  ///@{
  /**
   * <p>The display height of the media in the carousel card. Valid values are SHORT
   * and MEDIUM.</p>
   */
  ...
  template <typename HeightT = Aws::String>
  RcsCarouselCardMedia& WithHeight(HeightT&& value) {
