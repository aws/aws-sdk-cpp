...
class VerifiedDestinationNumberFilter {
 public:
  ...
  inline void SetName(VerifiedDestinationNumberFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline VerifiedDestinationNumberFilter& WithName(VerifiedDestinationNumberFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  VerifiedDestinationNumberFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  VerifiedDestinationNumberFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
