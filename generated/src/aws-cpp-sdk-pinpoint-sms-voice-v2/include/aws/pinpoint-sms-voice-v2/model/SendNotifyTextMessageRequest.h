...
/**
 */
class SendNotifyTextMessageRequest : public PinpointSMSVoiceV2Request {
 public:
  AWS_PINPOINTSMSVOICEV2_API SendNotifyTextMessageRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "SendNotifyTextMessage"; }
  ...
  template <typename NotifyConfigurationIdT = Aws::String>
  SendNotifyTextMessageRequest& WithNotifyConfigurationId(NotifyConfigurationIdT&& value) {
  ...
  template <typename DestinationPhoneNumberT = Aws::String>
  SendNotifyTextMessageRequest& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  SendNotifyTextMessageRequest& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename TemplateVariablesT = Aws::Map<Aws::String, Aws::String>>
  SendNotifyTextMessageRequest& WithTemplateVariables(TemplateVariablesT&& value) {
  ...
  SendNotifyTextMessageRequest& AddTemplateVariables(TemplateVariablesKeyT&& key, TemplateVariablesValueT&& value) {
    m_templateVariablesHasBeenSet = true;
  ...
  inline SendNotifyTextMessageRequest& WithTimeToLive(int value) {
    SetTimeToLive(value);
    return *this;
  }
  ///@}
  ...
  template <typename ContextT = Aws::Map<Aws::String, Aws::String>>
  SendNotifyTextMessageRequest& WithContext(ContextT&& value) {
    SetContext(std::forward<ContextT>(value));
    return *this;
  }
  template <typename ContextKeyT = Aws::String, typename ContextValueT = Aws::String>
  SendNotifyTextMessageRequest& AddContext(ContextKeyT&& key, ContextValueT&& value) {
    m_contextHasBeenSet = true;
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  SendNotifyTextMessageRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  inline SendNotifyTextMessageRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline SendNotifyTextMessageRequest& WithMessageFeedbackEnabled(bool value) {
