...
class UpdateProtectConfigurationCountryRuleSetRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  UpdateProtectConfigurationCountryRuleSetRequest& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  inline UpdateProtectConfigurationCountryRuleSetRequest& WithNumberCapability(NumberCapability value) {
   ...
   */
  inline const Aws::Map<Aws::String, ProtectConfigurationCountryRuleSetInformation>& GetCountryRuleSetUpdates() const {
    return m_countryRuleSetUpdates;
  }
  ...
  void SetCountryRuleSetUpdates(CountryRuleSetUpdatesT&& value) {
    m_countryRuleSetUpdatesHasBeenSet = true;
    m_countryRuleSetUpdates = std::forward<CountryRuleSetUpdatesT>(value);
  }
  template <typename CountryRuleSetUpdatesT = Aws::Map<Aws::String, ProtectConfigurationCountryRuleSetInformation>>
  UpdateProtectConfigurationCountryRuleSetRequest& WithCountryRuleSetUpdates(CountryRuleSetUpdatesT&& value) {
    SetCountryRuleSetUpdates(std::forward<CountryRuleSetUpdatesT>(value));
    return *this;
  }
  template <typename CountryRuleSetUpdatesKeyT = Aws::String,
            typename CountryRuleSetUpdatesValueT = ProtectConfigurationCountryRuleSetInformation>
  UpdateProtectConfigurationCountryRuleSetRequest& AddCountryRuleSetUpdates(CountryRuleSetUpdatesKeyT&& key,
                                                                            CountryRuleSetUpdatesValueT&& value) {
    m_countryRuleSetUpdatesHasBeenSet = true;
    m_countryRuleSetUpdates.emplace(std::forward<CountryRuleSetUpdatesKeyT>(key), std::forward<CountryRuleSetUpdatesValueT>(value));
    return *this;
  }
  ///@}
 private:
