...
class RegistrationVersionInformation {
 public:
  ...
  inline RegistrationVersionInformation& WithVersionNumber(long long value) {
  ...
  inline RegistrationVersionInformation& WithRegistrationVersionStatus(RegistrationVersionStatus value) {
  ...
  template <typename RegistrationVersionStatusHistoryT = RegistrationVersionStatusHistory>
  RegistrationVersionInformation& WithRegistrationVersionStatusHistory(RegistrationVersionStatusHistoryT&& value) {
  ...
  void SetDeniedReasons(DeniedReasonsT&& value) {
    m_deniedReasonsHasBeenSet = true;
    m_deniedReasons = std::forward<DeniedReasonsT>(value);
  }
  template <typename DeniedReasonsT = Aws::Vector<RegistrationDeniedReasonInformation>>
  RegistrationVersionInformation& WithDeniedReasons(DeniedReasonsT&& value) {
    SetDeniedReasons(std::forward<DeniedReasonsT>(value));
    return *this;
  }
  template <typename DeniedReasonsT = RegistrationDeniedReasonInformation>
  RegistrationVersionInformation& AddDeniedReasons(DeniedReasonsT&& value) {
    m_deniedReasonsHasBeenSet = true;
    m_deniedReasons.emplace_back(std::forward<DeniedReasonsT>(value));
    return *this;
  }
  ///@}
 private:
