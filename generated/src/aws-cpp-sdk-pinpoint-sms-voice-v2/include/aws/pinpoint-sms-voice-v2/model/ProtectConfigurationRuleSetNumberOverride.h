...
class ProtectConfigurationRuleSetNumberOverride {
 public:
  ...
  template <typename DestinationPhoneNumberT = Aws::String>
  ProtectConfigurationRuleSetNumberOverride& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  ProtectConfigurationRuleSetNumberOverride& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  inline ProtectConfigurationRuleSetNumberOverride& WithAction(ProtectConfigurationRuleOverrideAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename IsoCountryCodeT = Aws::String>
  ProtectConfigurationRuleSetNumberOverride& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  template <typename ExpirationTimestampT = Aws::Utils::DateTime>
  ProtectConfigurationRuleSetNumberOverride& WithExpirationTimestamp(ExpirationTimestampT&& value) {
