...
class DescribeRegistrationFieldValuesResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API DescribeRegistrationFieldValuesResult& operator=(
  ...
  template <typename RegistrationArnT = Aws::String>
  DescribeRegistrationFieldValuesResult& WithRegistrationArn(RegistrationArnT&& value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  DescribeRegistrationFieldValuesResult& WithRegistrationId(RegistrationIdT&& value) {
  ...
  inline DescribeRegistrationFieldValuesResult& WithVersionNumber(long long value) {
  ...
  void SetRegistrationFieldValues(RegistrationFieldValuesT&& value) {
    m_registrationFieldValuesHasBeenSet = true;
    m_registrationFieldValues = std::forward<RegistrationFieldValuesT>(value);
  }
  template <typename RegistrationFieldValuesT = Aws::Vector<RegistrationFieldValueInformation>>
  DescribeRegistrationFieldValuesResult& WithRegistrationFieldValues(RegistrationFieldValuesT&& value) {
    SetRegistrationFieldValues(std::forward<RegistrationFieldValuesT>(value));
    return *this;
  }
  template <typename RegistrationFieldValuesT = RegistrationFieldValueInformation>
  DescribeRegistrationFieldValuesResult& AddRegistrationFieldValues(RegistrationFieldValuesT&& value) {
    m_registrationFieldValuesHasBeenSet = true;
    m_registrationFieldValues.emplace_back(std::forward<RegistrationFieldValuesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistrationFieldValuesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRegistrationFieldValuesResult& WithRequestId(RequestIdT&& value) {
