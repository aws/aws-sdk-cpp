...
class CreatePoolResult {
 public:
  ...
  template <typename PoolArnT = Aws::String>
  CreatePoolResult& WithPoolArn(PoolArnT&& value) {
  ...
  template <typename PoolIdT = Aws::String>
  CreatePoolResult& WithPoolId(PoolIdT&& value) {
  ...
  inline CreatePoolResult& WithStatus(PoolStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePoolResult& WithMessageType(MessageType value) {
  ...
  inline CreatePoolResult& WithTwoWayEnabled(bool value) {
  ...
  template <typename TwoWayChannelArnT = Aws::String>
  CreatePoolResult& WithTwoWayChannelArn(TwoWayChannelArnT&& value) {
  ...
  template <typename TwoWayChannelRoleT = Aws::String>
  CreatePoolResult& WithTwoWayChannelRole(TwoWayChannelRoleT&& value) {
  ...
  ///@{
  /**
   * <p>By default this is set to false. When set to false, and an end recipient
   * sends a message that begins with HELP or STOP to one of your dedicated numbers,
   * End User MessagingSMS automatically replies with a customizable message and adds
  ...
  inline CreatePoolResult& WithSelfManagedOptOutsEnabled(bool value) {
  ...
  template <typename OptOutListNameT = Aws::String>
  CreatePoolResult& WithOptOutListName(OptOutListNameT&& value) {
  ...
  inline CreatePoolResult& WithSharedRoutesEnabled(bool value) {
  ...
  inline CreatePoolResult& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreatePoolResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreatePoolResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  CreatePoolResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePoolResult& WithRequestId(RequestIdT&& value) {
