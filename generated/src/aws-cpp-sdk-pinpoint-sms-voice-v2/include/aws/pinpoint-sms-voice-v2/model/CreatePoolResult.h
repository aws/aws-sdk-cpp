...
namespace Model
{
  ...
  public:
     ...
     * SMS messages.</p>
     */
    inline CreatePoolResult& WithTwoWayChannelRole(const Aws::String& value) { SetTwoWayChannelRole(value); return *this;}

    /**
     * <p>An optional IAM Role Arn for a service to assume, to be able to post inbound
     * SMS messages.</p>
     */
    inline CreatePoolResult& WithTwoWayChannelRole(Aws::String&& value) { SetTwoWayChannelRole(std::move(value)); return *this;}

    /**
     * <p>An optional IAM Role Arn for a service to assume, to be able to post inbound
     * SMS messages.</p>
     */
    inline CreatePoolResult& WithTwoWayChannelRole(const char* value) { SetTwoWayChannelRole(value); return *this;}
    ...
    inline CreatePoolResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreatePoolResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreatePoolResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
