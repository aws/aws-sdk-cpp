...
class ProtectConfigurationFilter {
 public:
  ...
  inline void SetName(ProtectConfigurationFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ProtectConfigurationFilter& WithName(ProtectConfigurationFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ProtectConfigurationFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ProtectConfigurationFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
