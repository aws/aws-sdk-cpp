...
class RegistrationInformation {
 public:
  ...
  template <typename RegistrationArnT = Aws::String>
  RegistrationInformation& WithRegistrationArn(RegistrationArnT&& value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  RegistrationInformation& WithRegistrationId(RegistrationIdT&& value) {
  ...
  template <typename RegistrationTypeT = Aws::String>
  RegistrationInformation& WithRegistrationType(RegistrationTypeT&& value) {
  ...
  inline RegistrationInformation& WithRegistrationStatus(RegistrationStatus value) {
  ...
  inline RegistrationInformation& WithCurrentVersionNumber(long long value) {
  ...
  inline RegistrationInformation& WithApprovedVersionNumber(long long value) {
  ...
  inline RegistrationInformation& WithLatestDeniedVersionNumber(long long value) {
  ...
  template <typename AdditionalAttributesT = Aws::Map<Aws::String, Aws::String>>
  RegistrationInformation& WithAdditionalAttributes(AdditionalAttributesT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  RegistrationInformation& WithCreatedTimestamp(CreatedTimestampT&& value) {
