...
class UpdatePoolResult {
 public:
  ...
  template <typename PoolArnT = Aws::String>
  UpdatePoolResult& WithPoolArn(PoolArnT&& value) {
  ...
  template <typename PoolIdT = Aws::String>
  UpdatePoolResult& WithPoolId(PoolIdT&& value) {
  ...
  inline UpdatePoolResult& WithStatus(PoolStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdatePoolResult& WithMessageType(MessageType value) {
  ...
  inline UpdatePoolResult& WithTwoWayEnabled(bool value) {
  ...
  template <typename TwoWayChannelArnT = Aws::String>
  UpdatePoolResult& WithTwoWayChannelArn(TwoWayChannelArnT&& value) {
  ...
  template <typename TwoWayChannelRoleT = Aws::String>
  UpdatePoolResult& WithTwoWayChannelRole(TwoWayChannelRoleT&& value) {
  ...
  ///@{
  /**
   * <p>When set to false and an end recipient sends a message that begins with HELP
   * or STOP to one of your dedicated numbers, End User Messaging SMS automatically
  ...
  inline UpdatePoolResult& WithSelfManagedOptOutsEnabled(bool value) {
  ...
  template <typename OptOutListNameT = Aws::String>
  UpdatePoolResult& WithOptOutListName(OptOutListNameT&& value) {
  ...
  inline UpdatePoolResult& WithSharedRoutesEnabled(bool value) {
  ...
  inline UpdatePoolResult& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  UpdatePoolResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePoolResult& WithRequestId(RequestIdT&& value) {
