...
class SetDefaultMessageFeedbackEnabledRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  template <typename ConfigurationSetNameT = Aws::String>
  SetDefaultMessageFeedbackEnabledRequest& WithConfigurationSetName(ConfigurationSetNameT&& value) {
  ...
  inline SetDefaultMessageFeedbackEnabledRequest& WithMessageFeedbackEnabled(bool value) {
