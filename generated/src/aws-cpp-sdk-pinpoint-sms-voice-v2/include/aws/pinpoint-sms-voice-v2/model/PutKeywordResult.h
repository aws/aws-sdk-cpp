...
class PutKeywordResult {
 public:
  ...
  void SetOriginationIdentityArn(OriginationIdentityArnT&& value) {
    m_originationIdentityArnHasBeenSet = true;
    m_originationIdentityArn = std::forward<OriginationIdentityArnT>(value);
  }
  template <typename OriginationIdentityArnT = Aws::String>
  PutKeywordResult& WithOriginationIdentityArn(OriginationIdentityArnT&& value) {
    SetOriginationIdentityArn(std::forward<OriginationIdentityArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OriginationIdentityT = Aws::String>
  PutKeywordResult& WithOriginationIdentity(OriginationIdentityT&& value) {
  ...
  template <typename KeywordT = Aws::String>
  PutKeywordResult& WithKeyword(KeywordT&& value) {
  ...
  void SetKeywordMessage(KeywordMessageT&& value) {
    m_keywordMessageHasBeenSet = true;
    m_keywordMessage = std::forward<KeywordMessageT>(value);
  }
  template <typename KeywordMessageT = Aws::String>
  PutKeywordResult& WithKeywordMessage(KeywordMessageT&& value) {
    SetKeywordMessage(std::forward<KeywordMessageT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetKeywordAction(KeywordAction value) {
    m_keywordActionHasBeenSet = true;
    m_keywordAction = value;
  }
  inline PutKeywordResult& WithKeywordAction(KeywordAction value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutKeywordResult& WithRequestId(RequestIdT&& value) {
