...
class KeywordInformation {
 public:
  ...
  template <typename KeywordT = Aws::String>
  KeywordInformation& WithKeyword(KeywordT&& value) {
  ...
  template <typename KeywordMessageT = Aws::String>
  KeywordInformation& WithKeywordMessage(KeywordMessageT&& value) {
  ...
  inline KeywordInformation& WithKeywordAction(KeywordAction value) {
