...
class UpdateProtectConfigurationCountryRuleSetResult {
 public:
  ...
  AWS_PINPOINTSMSVOICEV2_API UpdateProtectConfigurationCountryRuleSetResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProtectConfigurationArnT = Aws::String>
  UpdateProtectConfigurationCountryRuleSetResult& WithProtectConfigurationArn(ProtectConfigurationArnT&& value) {
  ...
  template <typename ProtectConfigurationIdT = Aws::String>
  UpdateProtectConfigurationCountryRuleSetResult& WithProtectConfigurationId(ProtectConfigurationIdT&& value) {
  ...
  inline UpdateProtectConfigurationCountryRuleSetResult& WithNumberCapability(NumberCapability value) {
  ...
  void SetCountryRuleSet(CountryRuleSetT&& value) {
    m_countryRuleSetHasBeenSet = true;
    m_countryRuleSet = std::forward<CountryRuleSetT>(value);
  }
  template <typename CountryRuleSetT = Aws::Map<Aws::String, ProtectConfigurationCountryRuleSetInformation>>
  UpdateProtectConfigurationCountryRuleSetResult& WithCountryRuleSet(CountryRuleSetT&& value) {
    SetCountryRuleSet(std::forward<CountryRuleSetT>(value));
    return *this;
  }
  ...
  UpdateProtectConfigurationCountryRuleSetResult& AddCountryRuleSet(CountryRuleSetKeyT&& key, CountryRuleSetValueT&& value) {
    m_countryRuleSetHasBeenSet = true;
    m_countryRuleSet.emplace(std::forward<CountryRuleSetKeyT>(key), std::forward<CountryRuleSetValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateProtectConfigurationCountryRuleSetResult& WithRequestId(RequestIdT&& value) {
