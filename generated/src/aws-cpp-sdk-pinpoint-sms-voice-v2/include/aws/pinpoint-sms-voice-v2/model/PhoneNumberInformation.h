...
class PhoneNumberInformation {
 public:
  ...
  template <typename PhoneNumberArnT = Aws::String>
  PhoneNumberInformation& WithPhoneNumberArn(PhoneNumberArnT&& value) {
  ...
  template <typename PhoneNumberIdT = Aws::String>
  PhoneNumberInformation& WithPhoneNumberId(PhoneNumberIdT&& value) {
  ...
  inline PhoneNumberInformation& WithStatus(NumberStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename IsoCountryCodeT = Aws::String>
  PhoneNumberInformation& WithIsoCountryCode(IsoCountryCodeT&& value) {
  ...
  inline PhoneNumberInformation& WithMessageType(MessageType value) {
  ...
  inline PhoneNumberInformation& WithNumberType(NumberType value) {
    SetNumberType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MonthlyLeasingPriceT = Aws::String>
  PhoneNumberInformation& WithMonthlyLeasingPrice(MonthlyLeasingPriceT&& value) {
  ...
  inline PhoneNumberInformation& WithTwoWayEnabled(bool value) {
  ...
  template <typename TwoWayChannelArnT = Aws::String>
  PhoneNumberInformation& WithTwoWayChannelArn(TwoWayChannelArnT&& value) {
  ...
  template <typename TwoWayChannelRoleT = Aws::String>
  PhoneNumberInformation& WithTwoWayChannelRole(TwoWayChannelRoleT&& value) {
  ...
  inline PhoneNumberInformation& WithSelfManagedOptOutsEnabled(bool value) {
  ...
  template <typename OptOutListNameT = Aws::String>
  PhoneNumberInformation& WithOptOutListName(OptOutListNameT&& value) {
  ...
  inline PhoneNumberInformation& WithInternationalSendingEnabled(bool value) {
  ...
  inline PhoneNumberInformation& WithDeletionProtectionEnabled(bool value) {
  ...
  template <typename PoolIdT = Aws::String>
  PhoneNumberInformation& WithPoolId(PoolIdT&& value) {
  ...
  template <typename RegistrationIdT = Aws::String>
  PhoneNumberInformation& WithRegistrationId(RegistrationIdT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  PhoneNumberInformation& WithCreatedTimestamp(CreatedTimestampT&& value) {
