...
class DescribeConfigurationSetsRequest : public PinpointSMSVoiceV2Request {
 public:
  ...
  void SetConfigurationSetNames(ConfigurationSetNamesT&& value) {
    m_configurationSetNamesHasBeenSet = true;
    m_configurationSetNames = std::forward<ConfigurationSetNamesT>(value);
  }
  template <typename ConfigurationSetNamesT = Aws::Vector<Aws::String>>
  DescribeConfigurationSetsRequest& WithConfigurationSetNames(ConfigurationSetNamesT&& value) {
    SetConfigurationSetNames(std::forward<ConfigurationSetNamesT>(value));
    return *this;
  }
  template <typename ConfigurationSetNamesT = Aws::String>
  DescribeConfigurationSetsRequest& AddConfigurationSetNames(ConfigurationSetNamesT&& value) {
    m_configurationSetNamesHasBeenSet = true;
    m_configurationSetNames.emplace_back(std::forward<ConfigurationSetNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<ConfigurationSetFilter>>
  DescribeConfigurationSetsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ConfigurationSetFilter>
  DescribeConfigurationSetsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConfigurationSetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeConfigurationSetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
