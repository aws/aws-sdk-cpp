...
class PhoneNumberFilter {
 public:
  ...
  inline void SetName(PhoneNumberFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline PhoneNumberFilter& WithName(PhoneNumberFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  PhoneNumberFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  PhoneNumberFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
