...
class OptedOutFilter {
 public:
  ...
  inline void SetName(OptedOutFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline OptedOutFilter& WithName(OptedOutFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  OptedOutFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  OptedOutFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
