...
class AWS_ROUTE53RECOVERYCLUSTER_API Route53RecoveryClusterClient
 ...
 public:
   ...
   */
  Route53RecoveryClusterClient(const Aws::Route53RecoveryCluster::Route53RecoveryClusterClientConfiguration& clientConfiguration =
  ...
  Route53RecoveryClusterClient(const Aws::Auth::AWSCredentials& credentials,
                               std::shared_ptr<Route53RecoveryClusterEndpointProviderBase> endpointProvider = nullptr,
                               const Aws::Route53RecoveryCluster::Route53RecoveryClusterClientConfiguration& clientConfiguration =
                                   Aws::Route53RecoveryCluster::Route53RecoveryClusterClientConfiguration());
  ...
  /**
   * A Callable wrapper for GetRoutingControlState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetRoutingControlStateRequestT = Model::GetRoutingControlStateRequest>
  Model::GetRoutingControlStateOutcomeCallable GetRoutingControlStateCallable(const GetRoutingControlStateRequestT& request) const {
    return SubmitCallable(&Route53RecoveryClusterClient::GetRoutingControlState, request);
  }

  /**
   * An Async wrapper for GetRoutingControlState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRoutingControlStateRequestT = Model::GetRoutingControlStateRequest>
  void GetRoutingControlStateAsync(const GetRoutingControlStateRequestT& request,
                                   const GetRoutingControlStateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&Route53RecoveryClusterClient::GetRoutingControlState, request, handler, context);
  }
   ...
   */
  template <typename ListRoutingControlsRequestT = Model::ListRoutingControlsRequest>
  void ListRoutingControlsAsync(const ListRoutingControlsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListRoutingControlsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateRoutingControlState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateRoutingControlStateRequestT = Model::UpdateRoutingControlStateRequest>
  Model::UpdateRoutingControlStateOutcomeCallable UpdateRoutingControlStateCallable(
      const UpdateRoutingControlStateRequestT& request) const {
    return SubmitCallable(&Route53RecoveryClusterClient::UpdateRoutingControlState, request);
  }

  /**
   * An Async wrapper for UpdateRoutingControlState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRoutingControlStateRequestT = Model::UpdateRoutingControlStateRequest>
  void UpdateRoutingControlStateAsync(const UpdateRoutingControlStateRequestT& request,
                                      const UpdateRoutingControlStateResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&Route53RecoveryClusterClient::UpdateRoutingControlState, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRoutingControlStatesOutcome UpdateRoutingControlStates(
      const Model::UpdateRoutingControlStatesRequest& request) const;

  /**
   * A Callable wrapper for UpdateRoutingControlStates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateRoutingControlStatesRequestT = Model::UpdateRoutingControlStatesRequest>
  Model::UpdateRoutingControlStatesOutcomeCallable UpdateRoutingControlStatesCallable(
      const UpdateRoutingControlStatesRequestT& request) const {
    return SubmitCallable(&Route53RecoveryClusterClient::UpdateRoutingControlStates, request);
  }

  /**
   * An Async wrapper for UpdateRoutingControlStates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRoutingControlStatesRequestT = Model::UpdateRoutingControlStatesRequest>
  void UpdateRoutingControlStatesAsync(const UpdateRoutingControlStatesRequestT& request,
                                       const UpdateRoutingControlStatesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
