...
class UpdateRoutingControlStatesRequest : public Route53RecoveryClusterRequest {
 public:
   ...
   */
  inline const Aws::Vector<UpdateRoutingControlStateEntry>& GetUpdateRoutingControlStateEntries() const {
    return m_updateRoutingControlStateEntries;
  }
  ...
  void SetUpdateRoutingControlStateEntries(UpdateRoutingControlStateEntriesT&& value) {
    m_updateRoutingControlStateEntriesHasBeenSet = true;
    m_updateRoutingControlStateEntries = std::forward<UpdateRoutingControlStateEntriesT>(value);
  }
  template <typename UpdateRoutingControlStateEntriesT = Aws::Vector<UpdateRoutingControlStateEntry>>
  UpdateRoutingControlStatesRequest& WithUpdateRoutingControlStateEntries(UpdateRoutingControlStateEntriesT&& value) {
    SetUpdateRoutingControlStateEntries(std::forward<UpdateRoutingControlStateEntriesT>(value));
    return *this;
  }
  ...
  UpdateRoutingControlStatesRequest& AddUpdateRoutingControlStateEntries(UpdateRoutingControlStateEntriesT&& value) {
    m_updateRoutingControlStateEntriesHasBeenSet = true;
    m_updateRoutingControlStateEntries.emplace_back(std::forward<UpdateRoutingControlStateEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSafetyRulesToOverride(SafetyRulesToOverrideT&& value) {
    m_safetyRulesToOverrideHasBeenSet = true;
    m_safetyRulesToOverride = std::forward<SafetyRulesToOverrideT>(value);
  }
  template <typename SafetyRulesToOverrideT = Aws::Vector<Aws::String>>
  UpdateRoutingControlStatesRequest& WithSafetyRulesToOverride(SafetyRulesToOverrideT&& value) {
    SetSafetyRulesToOverride(std::forward<SafetyRulesToOverrideT>(value));
    return *this;
  }
  ...
  UpdateRoutingControlStatesRequest& AddSafetyRulesToOverride(SafetyRulesToOverrideT&& value) {
    m_safetyRulesToOverrideHasBeenSet = true;
    m_safetyRulesToOverride.emplace_back(std::forward<SafetyRulesToOverrideT>(value));
    return *this;
  }
  ///@}
 private:
