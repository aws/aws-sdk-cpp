...
class ListRoutingControlsRequest : public Route53RecoveryClusterRequest {
 public:
  ...
  template <typename ControlPanelArnT = Aws::String>
  ListRoutingControlsRequest& WithControlPanelArn(ControlPanelArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRoutingControlsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRoutingControlsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
