...
template <>
AWS_ROUTE53RECOVERYCLUSTER_API ConflictException Route53RecoveryClusterError::GetModeledError() {
  assert(this->GetErrorType() == Route53RecoveryClusterErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_ROUTE53RECOVERYCLUSTER_API ThrottlingException Route53RecoveryClusterError::GetModeledError() {
  assert(this->GetErrorType() == Route53RecoveryClusterErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_ROUTE53RECOVERYCLUSTER_API InternalServerException Route53RecoveryClusterError::GetModeledError() {
  assert(this->GetErrorType() == Route53RecoveryClusterErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_ROUTE53RECOVERYCLUSTER_API ResourceNotFoundException Route53RecoveryClusterError::GetModeledError() {
  assert(this->GetErrorType() == Route53RecoveryClusterErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_ROUTE53RECOVERYCLUSTER_API ValidationException Route53RecoveryClusterError::GetModeledError() {
  assert(this->GetErrorType() == Route53RecoveryClusterErrors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_ROUTE53RECOVERYCLUSTER_API ServiceLimitExceededException Route53RecoveryClusterError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(Route53RecoveryClusterErrors::ENDPOINT_TEMPORARILY_UNAVAILABLE),
                                RetryableType::NOT_RETRYABLE);
  } else if (hashCode == SERVICE_LIMIT_EXCEEDED_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(Route53RecoveryClusterErrors::SERVICE_LIMIT_EXCEEDED),
                                RetryableType::NOT_RETRYABLE);
  }
