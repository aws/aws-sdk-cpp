...
class AWS_OMICS_API OmicsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  OmicsClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<OmicsEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AbortMultipartReadSetUploadOutcome AbortMultipartReadSetUpload(
      const Model::AbortMultipartReadSetUploadRequest& request) const;

  /**
   * A Callable wrapper for AbortMultipartReadSetUpload that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AbortMultipartReadSetUploadRequestT = Model::AbortMultipartReadSetUploadRequest>
  Model::AbortMultipartReadSetUploadOutcomeCallable AbortMultipartReadSetUploadCallable(
      const AbortMultipartReadSetUploadRequestT& request) const {
    return SubmitCallable(&OmicsClient::AbortMultipartReadSetUpload, request);
  }

  /**
   * An Async wrapper for AbortMultipartReadSetUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AbortMultipartReadSetUploadRequestT = Model::AbortMultipartReadSetUploadRequest>
  void AbortMultipartReadSetUploadAsync(const AbortMultipartReadSetUploadRequestT& request,
                                        const AbortMultipartReadSetUploadResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for AcceptShare that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AcceptShareRequestT = Model::AcceptShareRequest>
  void AcceptShareAsync(const AcceptShareRequestT& request, const AcceptShareResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDeleteReadSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteReadSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchDeleteReadSetRequestT = Model::BatchDeleteReadSetRequest>
  void BatchDeleteReadSetAsync(const BatchDeleteReadSetRequestT& request, const BatchDeleteReadSetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelAnnotationImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CancelAnnotationImportJobRequestT = Model::CancelAnnotationImportJobRequest>
  Model::CancelAnnotationImportJobOutcomeCallable CancelAnnotationImportJobCallable(
      const CancelAnnotationImportJobRequestT& request) const {
    return SubmitCallable(&OmicsClient::CancelAnnotationImportJob, request);
  }

  /**
   * An Async wrapper for CancelAnnotationImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelAnnotationImportJobRequestT = Model::CancelAnnotationImportJobRequest>
  void CancelAnnotationImportJobAsync(const CancelAnnotationImportJobRequestT& request,
                                      const CancelAnnotationImportJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CancelRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelRunRequestT = Model::CancelRunRequest>
  void CancelRunAsync(const CancelRunRequestT& request, const CancelRunResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelVariantImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelVariantImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelVariantImportJobRequestT = Model::CancelVariantImportJobRequest>
  void CancelVariantImportJobAsync(const CancelVariantImportJobRequestT& request,
                                   const CancelVariantImportJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CompleteMultipartReadSetUploadOutcome CompleteMultipartReadSetUpload(
      const Model::CompleteMultipartReadSetUploadRequest& request) const;

  /**
   * A Callable wrapper for CompleteMultipartReadSetUpload that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CompleteMultipartReadSetUploadRequestT = Model::CompleteMultipartReadSetUploadRequest>
  Model::CompleteMultipartReadSetUploadOutcomeCallable CompleteMultipartReadSetUploadCallable(
      const CompleteMultipartReadSetUploadRequestT& request) const {
    return SubmitCallable(&OmicsClient::CompleteMultipartReadSetUpload, request);
  }

  /**
   * An Async wrapper for CompleteMultipartReadSetUpload that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CompleteMultipartReadSetUploadRequestT = Model::CompleteMultipartReadSetUploadRequest>
  void CompleteMultipartReadSetUploadAsync(const CompleteMultipartReadSetUploadRequestT& request,
                                           const CompleteMultipartReadSetUploadResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAnnotationStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAnnotationStore that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAnnotationStoreRequestT = Model::CreateAnnotationStoreRequest>
  void CreateAnnotationStoreAsync(const CreateAnnotationStoreRequestT& request, const CreateAnnotationStoreResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAnnotationStoreVersionOutcome CreateAnnotationStoreVersion(
      const Model::CreateAnnotationStoreVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateAnnotationStoreVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAnnotationStoreVersionRequestT = Model::CreateAnnotationStoreVersionRequest>
  Model::CreateAnnotationStoreVersionOutcomeCallable CreateAnnotationStoreVersionCallable(
      const CreateAnnotationStoreVersionRequestT& request) const {
    return SubmitCallable(&OmicsClient::CreateAnnotationStoreVersion, request);
  }

  /**
   * An Async wrapper for CreateAnnotationStoreVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAnnotationStoreVersionRequestT = Model::CreateAnnotationStoreVersionRequest>
  void CreateAnnotationStoreVersionAsync(const CreateAnnotationStoreVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateMultipartReadSetUploadOutcome CreateMultipartReadSetUpload(
      const Model::CreateMultipartReadSetUploadRequest& request) const;

  /**
   * A Callable wrapper for CreateMultipartReadSetUpload that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateMultipartReadSetUploadRequestT = Model::CreateMultipartReadSetUploadRequest>
  Model::CreateMultipartReadSetUploadOutcomeCallable CreateMultipartReadSetUploadCallable(
      const CreateMultipartReadSetUploadRequestT& request) const {
    return SubmitCallable(&OmicsClient::CreateMultipartReadSetUpload, request);
  }

  /**
   * An Async wrapper for CreateMultipartReadSetUpload that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMultipartReadSetUploadRequestT = Model::CreateMultipartReadSetUploadRequest>
  void CreateMultipartReadSetUploadAsync(const CreateMultipartReadSetUploadRequestT& request,
                                         const CreateMultipartReadSetUploadResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateReferenceStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateReferenceStore that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateReferenceStoreRequestT = Model::CreateReferenceStoreRequest>
  void CreateReferenceStoreAsync(const CreateReferenceStoreRequestT& request, const CreateReferenceStoreResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateRunCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateRunCacheRequestT = Model::CreateRunCacheRequest>
  void CreateRunCacheAsync(const CreateRunCacheRequestT& request, const CreateRunCacheResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateRunGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateRunGroupRequestT = Model::CreateRunGroupRequest>
  void CreateRunGroupAsync(const CreateRunGroupRequestT& request, const CreateRunGroupResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSequenceStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSequenceStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateSequenceStoreRequestT = Model::CreateSequenceStoreRequest>
  void CreateSequenceStoreAsync(const CreateSequenceStoreRequestT& request, const CreateSequenceStoreResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateShare that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateShareRequestT = Model::CreateShareRequest>
  void CreateShareAsync(const CreateShareRequestT& request, const CreateShareResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateVariantStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateVariantStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateVariantStoreRequestT = Model::CreateVariantStoreRequest>
  void CreateVariantStoreAsync(const CreateVariantStoreRequestT& request, const CreateVariantStoreResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * definition file:</i> A workflow definition file written in WDL, Nextflow, or
   * CWL. The workflow definition specifies the inputs and outputs for runs that use
   * the workflow. It also includes specifications for the runs and run tasks for
   * your workflow, including compute and memory requirements. The workflow
   * definition file must be in <code>.zip</code> format. For more information, see
   * <a
   * href="https://docs.aws.amazon.com/omics/latest/dev/workflow-definition-files.html">Workflow
   * definition files</a> in Amazon Web Services HealthOmics.</p> <ul> <li> <p>You
   * can use Amazon Q CLI to build and validate your workflow definition files in
   * WDL, Nextflow, and CWL. For more information, see <a
   ...
   * Web Services HealthOmics Agentic generative AI tutorial</a> on GitHub.</p> </li>
   * </ul> </li> <li> <p> <i>(Optional) Parameter template file:</i> A parameter
   * template file written in JSON. Create the file to define the run parameters, or
   * Amazon Web Services HealthOmics generates the parameter template for you. For
   * more information, see <a
   * href="https://docs.aws.amazon.com/omics/latest/dev/parameter-templates.html">Parameter
   * template files for HealthOmics workflows</a>. </p> </li> <li> <p> <i>ECR
   * container images:</i> Create container images for the workflow in a private ECR
   * repository, or synchronize images from a supported upstream registry with your
   * Amazon ECR private repository.</p> </li> <li> <p> <i>(Optional) Sentieon
   * licenses:</i> Request a Sentieon license to use the Sentieon software in private
   * workflows.</p> </li> </ul> <p>For more information, see <a
  ...
  /**
   * A Callable wrapper for CreateWorkflowVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorkflowVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWorkflowVersionRequestT = Model::CreateWorkflowVersionRequest>
  void CreateWorkflowVersionAsync(const CreateWorkflowVersionRequestT& request, const CreateWorkflowVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAnnotationStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAnnotationStore that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAnnotationStoreRequestT = Model::DeleteAnnotationStoreRequest>
  void DeleteAnnotationStoreAsync(const DeleteAnnotationStoreRequestT& request, const DeleteAnnotationStoreResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAnnotationStoreVersionsOutcome DeleteAnnotationStoreVersions(
      const Model::DeleteAnnotationStoreVersionsRequest& request) const;

  /**
   * A Callable wrapper for DeleteAnnotationStoreVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAnnotationStoreVersionsRequestT = Model::DeleteAnnotationStoreVersionsRequest>
  Model::DeleteAnnotationStoreVersionsOutcomeCallable DeleteAnnotationStoreVersionsCallable(
      const DeleteAnnotationStoreVersionsRequestT& request) const {
    return SubmitCallable(&OmicsClient::DeleteAnnotationStoreVersions, request);
  }

  /**
   * An Async wrapper for DeleteAnnotationStoreVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAnnotationStoreVersionsRequestT = Model::DeleteAnnotationStoreVersionsRequest>
  void DeleteAnnotationStoreVersionsAsync(const DeleteAnnotationStoreVersionsRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteReference that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteReferenceRequestT = Model::DeleteReferenceRequest>
  void DeleteReferenceAsync(const DeleteReferenceRequestT& request, const DeleteReferenceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReferenceStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReferenceStore that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteReferenceStoreRequestT = Model::DeleteReferenceStoreRequest>
  void DeleteReferenceStoreAsync(const DeleteReferenceStoreRequestT& request, const DeleteReferenceStoreResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteRunCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRunCacheRequestT = Model::DeleteRunCacheRequest>
  void DeleteRunCacheAsync(const DeleteRunCacheRequestT& request, const DeleteRunCacheResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteRunGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRunGroupRequestT = Model::DeleteRunGroupRequest>
  void DeleteRunGroupAsync(const DeleteRunGroupRequestT& request, const DeleteRunGroupResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteS3AccessPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteS3AccessPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteS3AccessPolicyRequestT = Model::DeleteS3AccessPolicyRequest>
  void DeleteS3AccessPolicyAsync(const DeleteS3AccessPolicyRequestT& request, const DeleteS3AccessPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSequenceStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSequenceStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteSequenceStoreRequestT = Model::DeleteSequenceStoreRequest>
  void DeleteSequenceStoreAsync(const DeleteSequenceStoreRequestT& request, const DeleteSequenceStoreResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteShare that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteShareRequestT = Model::DeleteShareRequest>
  void DeleteShareAsync(const DeleteShareRequestT& request, const DeleteShareResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteVariantStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteVariantStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteVariantStoreRequestT = Model::DeleteVariantStoreRequest>
  void DeleteVariantStoreAsync(const DeleteVariantStoreRequestT& request, const DeleteVariantStoreResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWorkflowVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWorkflowVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWorkflowVersionRequestT = Model::DeleteWorkflowVersionRequest>
  void DeleteWorkflowVersionAsync(const DeleteWorkflowVersionRequestT& request, const DeleteWorkflowVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAnnotationImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAnnotationImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAnnotationImportJobRequestT = Model::GetAnnotationImportJobRequest>
  void GetAnnotationImportJobAsync(const GetAnnotationImportJobRequestT& request,
                                   const GetAnnotationImportJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAnnotationStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAnnotationStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAnnotationStoreRequestT = Model::GetAnnotationStoreRequest>
  void GetAnnotationStoreAsync(const GetAnnotationStoreRequestT& request, const GetAnnotationStoreResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAnnotationStoreVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetAnnotationStoreVersionRequestT = Model::GetAnnotationStoreVersionRequest>
  Model::GetAnnotationStoreVersionOutcomeCallable GetAnnotationStoreVersionCallable(
      const GetAnnotationStoreVersionRequestT& request) const {
    return SubmitCallable(&OmicsClient::GetAnnotationStoreVersion, request);
  }

  /**
   * An Async wrapper for GetAnnotationStoreVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAnnotationStoreVersionRequestT = Model::GetAnnotationStoreVersionRequest>
  void GetAnnotationStoreVersionAsync(const GetAnnotationStoreVersionRequestT& request,
  ...
  /**
   * An Async wrapper for GetReadSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetReadSetRequestT = Model::GetReadSetRequest>
  void GetReadSetAsync(const GetReadSetRequestT& request, const GetReadSetResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReadSetActivationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReadSetActivationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetReadSetActivationJobRequestT = Model::GetReadSetActivationJobRequest>
  void GetReadSetActivationJobAsync(const GetReadSetActivationJobRequestT& request,
                                    const GetReadSetActivationJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReadSetExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReadSetExportJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetReadSetExportJobRequestT = Model::GetReadSetExportJobRequest>
  void GetReadSetExportJobAsync(const GetReadSetExportJobRequestT& request, const GetReadSetExportJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReadSetImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReadSetImportJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetReadSetImportJobRequestT = Model::GetReadSetImportJobRequest>
  void GetReadSetImportJobAsync(const GetReadSetImportJobRequestT& request, const GetReadSetImportJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReadSetMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReadSetMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetReadSetMetadataRequestT = Model::GetReadSetMetadataRequest>
  void GetReadSetMetadataAsync(const GetReadSetMetadataRequestT& request, const GetReadSetMetadataResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetReference that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetReferenceRequestT = Model::GetReferenceRequest>
  void GetReferenceAsync(const GetReferenceRequestT& request, const GetReferenceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReferenceImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReferenceImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetReferenceImportJobRequestT = Model::GetReferenceImportJobRequest>
  void GetReferenceImportJobAsync(const GetReferenceImportJobRequestT& request, const GetReferenceImportJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReferenceMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReferenceMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetReferenceMetadataRequestT = Model::GetReferenceMetadataRequest>
  void GetReferenceMetadataAsync(const GetReferenceMetadataRequestT& request, const GetReferenceMetadataResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetReferenceStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetReferenceStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetReferenceStoreRequestT = Model::GetReferenceStoreRequest>
  void GetReferenceStoreAsync(const GetReferenceStoreRequestT& request, const GetReferenceStoreResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRunCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRunCacheRequestT = Model::GetRunCacheRequest>
  void GetRunCacheAsync(const GetRunCacheRequestT& request, const GetRunCacheResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRunGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRunGroupRequestT = Model::GetRunGroupRequest>
  void GetRunGroupAsync(const GetRunGroupRequestT& request, const GetRunGroupResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRunTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRunTaskRequestT = Model::GetRunTaskRequest>
  void GetRunTaskAsync(const GetRunTaskRequestT& request, const GetRunTaskResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetS3AccessPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetS3AccessPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetS3AccessPolicyRequestT = Model::GetS3AccessPolicyRequest>
  void GetS3AccessPolicyAsync(const GetS3AccessPolicyRequestT& request, const GetS3AccessPolicyResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSequenceStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSequenceStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSequenceStoreRequestT = Model::GetSequenceStoreRequest>
  void GetSequenceStoreAsync(const GetSequenceStoreRequestT& request, const GetSequenceStoreResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetShare that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetShareRequestT = Model::GetShareRequest>
  void GetShareAsync(const GetShareRequestT& request, const GetShareResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetVariantImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetVariantImportJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetVariantImportJobRequestT = Model::GetVariantImportJobRequest>
  void GetVariantImportJobAsync(const GetVariantImportJobRequestT& request, const GetVariantImportJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetVariantStore that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetVariantStoreRequestT = Model::GetVariantStoreRequest>
  void GetVariantStoreAsync(const GetVariantStoreRequestT& request, const GetVariantStoreResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWorkflowVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWorkflowVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetWorkflowVersionRequestT = Model::GetWorkflowVersionRequest>
  void GetWorkflowVersionAsync(const GetWorkflowVersionRequestT& request, const GetWorkflowVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAnnotationImportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListAnnotationImportJobsRequestT = Model::ListAnnotationImportJobsRequest>
  Model::ListAnnotationImportJobsOutcomeCallable ListAnnotationImportJobsCallable(
      const ListAnnotationImportJobsRequestT& request = {}) const {
    return SubmitCallable(&OmicsClient::ListAnnotationImportJobs, request);
  }

  /**
   * An Async wrapper for ListAnnotationImportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnnotationImportJobsRequestT = Model::ListAnnotationImportJobsRequest>
  void ListAnnotationImportJobsAsync(const ListAnnotationImportJobsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAnnotationStoreVersionsOutcome ListAnnotationStoreVersions(
      const Model::ListAnnotationStoreVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListAnnotationStoreVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAnnotationStoreVersionsRequestT = Model::ListAnnotationStoreVersionsRequest>
  Model::ListAnnotationStoreVersionsOutcomeCallable ListAnnotationStoreVersionsCallable(
      const ListAnnotationStoreVersionsRequestT& request) const {
    return SubmitCallable(&OmicsClient::ListAnnotationStoreVersions, request);
  }

  /**
   * An Async wrapper for ListAnnotationStoreVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnnotationStoreVersionsRequestT = Model::ListAnnotationStoreVersionsRequest>
  void ListAnnotationStoreVersionsAsync(const ListAnnotationStoreVersionsRequestT& request,
                                        const ListAnnotationStoreVersionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAnnotationStores that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAnnotationStores that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnnotationStoresRequestT = Model::ListAnnotationStoresRequest>
  void ListAnnotationStoresAsync(const ListAnnotationStoresResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMultipartReadSetUploadsOutcome ListMultipartReadSetUploads(
      const Model::ListMultipartReadSetUploadsRequest& request) const;

  /**
   * A Callable wrapper for ListMultipartReadSetUploads that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMultipartReadSetUploadsRequestT = Model::ListMultipartReadSetUploadsRequest>
  Model::ListMultipartReadSetUploadsOutcomeCallable ListMultipartReadSetUploadsCallable(
      const ListMultipartReadSetUploadsRequestT& request) const {
    return SubmitCallable(&OmicsClient::ListMultipartReadSetUploads, request);
  }

  /**
   * An Async wrapper for ListMultipartReadSetUploads that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMultipartReadSetUploadsRequestT = Model::ListMultipartReadSetUploadsRequest>
  void ListMultipartReadSetUploadsAsync(const ListMultipartReadSetUploadsRequestT& request,
                                        const ListMultipartReadSetUploadsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListReadSetActivationJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListReadSetActivationJobsRequestT = Model::ListReadSetActivationJobsRequest>
  Model::ListReadSetActivationJobsOutcomeCallable ListReadSetActivationJobsCallable(
      const ListReadSetActivationJobsRequestT& request) const {
    return SubmitCallable(&OmicsClient::ListReadSetActivationJobs, request);
  }

  /**
   * An Async wrapper for ListReadSetActivationJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListReadSetActivationJobsRequestT = Model::ListReadSetActivationJobsRequest>
  void ListReadSetActivationJobsAsync(const ListReadSetActivationJobsRequestT& request,
                                      const ListReadSetActivationJobsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListReadSetExportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReadSetExportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListReadSetExportJobsRequestT = Model::ListReadSetExportJobsRequest>
  void ListReadSetExportJobsAsync(const ListReadSetExportJobsRequestT& request, const ListReadSetExportJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListReadSetImportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReadSetImportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListReadSetImportJobsRequestT = Model::ListReadSetImportJobsRequest>
  void ListReadSetImportJobsAsync(const ListReadSetImportJobsRequestT& request, const ListReadSetImportJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListReadSetUploadParts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReadSetUploadParts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListReadSetUploadPartsRequestT = Model::ListReadSetUploadPartsRequest>
  void ListReadSetUploadPartsAsync(const ListReadSetUploadPartsRequestT& request,
                                   const ListReadSetUploadPartsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListReadSets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListReadSetsRequestT = Model::ListReadSetsRequest>
  void ListReadSetsAsync(const ListReadSetsRequestT& request, const ListReadSetsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListReferenceImportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReferenceImportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListReferenceImportJobsRequestT = Model::ListReferenceImportJobsRequest>
  void ListReferenceImportJobsAsync(const ListReferenceImportJobsRequestT& request,
                                    const ListReferenceImportJobsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListReferenceStores that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReferenceStores that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListReferenceStoresRequestT = Model::ListReferenceStoresRequest>
  void ListReferenceStoresAsync(const ListReferenceStoresResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListReferenceStoresRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListReferences that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListReferencesRequestT = Model::ListReferencesRequest>
  void ListReferencesAsync(const ListReferencesRequestT& request, const ListReferencesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListRunCaches that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRunCachesRequestT = Model::ListRunCachesRequest>
  void ListRunCachesAsync(const ListRunCachesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListRunCachesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListRunGroups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRunGroupsRequestT = Model::ListRunGroupsRequest>
  void ListRunGroupsAsync(const ListRunGroupsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListRunGroupsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListRunTasks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRunTasksRequestT = Model::ListRunTasksRequest>
  void ListRunTasksAsync(const ListRunTasksRequestT& request, const ListRunTasksResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListRunsRequestT = Model::ListRunsRequest>
  void ListRunsAsync(const ListRunsResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                     const ListRunsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSequenceStores that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSequenceStores that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSequenceStoresRequestT = Model::ListSequenceStoresRequest>
  void ListSequenceStoresAsync(const ListSequenceStoresResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListSequenceStoresRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListShares that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSharesRequestT = Model::ListSharesRequest>
  void ListSharesAsync(const ListSharesRequestT& request, const ListSharesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListVariantImportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListVariantImportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVariantImportJobsRequestT = Model::ListVariantImportJobsRequest>
  void ListVariantImportJobsAsync(const ListVariantImportJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListVariantImportJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListVariantStores that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListVariantStores that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListVariantStoresRequestT = Model::ListVariantStoresRequest>
  void ListVariantStoresAsync(const ListVariantStoresResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListVariantStoresRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutS3AccessPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutS3AccessPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutS3AccessPolicyRequestT = Model::PutS3AccessPolicyRequest>
  void PutS3AccessPolicyAsync(const PutS3AccessPolicyRequestT& request, const PutS3AccessPolicyResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAnnotationImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAnnotationImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartAnnotationImportJobRequestT = Model::StartAnnotationImportJobRequest>
  void StartAnnotationImportJobAsync(const StartAnnotationImportJobRequestT& request,
                                     const StartAnnotationImportJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartReadSetActivationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartReadSetActivationJobRequestT = Model::StartReadSetActivationJobRequest>
  Model::StartReadSetActivationJobOutcomeCallable StartReadSetActivationJobCallable(
      const StartReadSetActivationJobRequestT& request) const {
    return SubmitCallable(&OmicsClient::StartReadSetActivationJob, request);
  }

  /**
   * An Async wrapper for StartReadSetActivationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartReadSetActivationJobRequestT = Model::StartReadSetActivationJobRequest>
  void StartReadSetActivationJobAsync(const StartReadSetActivationJobRequestT& request,
                                      const StartReadSetActivationJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartReadSetExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartReadSetExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartReadSetExportJobRequestT = Model::StartReadSetExportJobRequest>
  void StartReadSetExportJobAsync(const StartReadSetExportJobRequestT& request, const StartReadSetExportJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartReadSetImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartReadSetImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartReadSetImportJobRequestT = Model::StartReadSetImportJobRequest>
  void StartReadSetImportJobAsync(const StartReadSetImportJobRequestT& request, const StartReadSetImportJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartReferenceImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartReferenceImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartReferenceImportJobRequestT = Model::StartReferenceImportJobRequest>
  void StartReferenceImportJobAsync(const StartReferenceImportJobRequestT& request,
                                    const StartReferenceImportJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <p>You can use Amazon Q CLI to analyze run logs and make performance
   ...
   * Web Services HealthOmics MCP server</a> on GitHub.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * An Async wrapper for StartRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartRunRequestT = Model::StartRunRequest>
  void StartRunAsync(const StartRunRequestT& request, const StartRunResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartVariantImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartVariantImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartVariantImportJobRequestT = Model::StartVariantImportJobRequest>
  void StartVariantImportJobAsync(const StartVariantImportJobRequestT& request, const StartVariantImportJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAnnotationStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAnnotationStore that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAnnotationStoreRequestT = Model::UpdateAnnotationStoreRequest>
  void UpdateAnnotationStoreAsync(const UpdateAnnotationStoreRequestT& request, const UpdateAnnotationStoreResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAnnotationStoreVersionOutcome UpdateAnnotationStoreVersion(
      const Model::UpdateAnnotationStoreVersionRequest& request) const;

  /**
   * A Callable wrapper for UpdateAnnotationStoreVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAnnotationStoreVersionRequestT = Model::UpdateAnnotationStoreVersionRequest>
  Model::UpdateAnnotationStoreVersionOutcomeCallable UpdateAnnotationStoreVersionCallable(
      const UpdateAnnotationStoreVersionRequestT& request) const {
    return SubmitCallable(&OmicsClient::UpdateAnnotationStoreVersion, request);
  }

  /**
   * An Async wrapper for UpdateAnnotationStoreVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAnnotationStoreVersionRequestT = Model::UpdateAnnotationStoreVersionRequest>
  void UpdateAnnotationStoreVersionAsync(const UpdateAnnotationStoreVersionRequestT& request,
                                         const UpdateAnnotationStoreVersionResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateRunCache that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRunCacheRequestT = Model::UpdateRunCacheRequest>
  void UpdateRunCacheAsync(const UpdateRunCacheRequestT& request, const UpdateRunCacheResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateRunGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRunGroupRequestT = Model::UpdateRunGroupRequest>
  void UpdateRunGroupAsync(const UpdateRunGroupRequestT& request, const UpdateRunGroupResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSequenceStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSequenceStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateSequenceStoreRequestT = Model::UpdateSequenceStoreRequest>
  void UpdateSequenceStoreAsync(const UpdateSequenceStoreRequestT& request, const UpdateSequenceStoreResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateVariantStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateVariantStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateVariantStoreRequestT = Model::UpdateVariantStoreRequest>
  void UpdateVariantStoreAsync(const UpdateVariantStoreRequestT& request, const UpdateVariantStoreResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateWorkflowVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateWorkflowVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateWorkflowVersionRequestT = Model::UpdateWorkflowVersionRequest>
  void UpdateWorkflowVersionAsync(const UpdateWorkflowVersionRequestT& request, const UpdateWorkflowVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UploadReadSetPart that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UploadReadSetPart that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UploadReadSetPartRequestT = Model::UploadReadSetPartRequest>
  void UploadReadSetPartAsync(const UploadReadSetPartRequestT& request, const UploadReadSetPartResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
