...
class GetConfigurationResult {
 public:
  AWS_OMICS_API GetConfigurationResult() = default;
  AWS_OMICS_API GetConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_OMICS_API GetConfigurationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ArnT = Aws::String>
  GetConfigurationResult& WithArn(ArnT&& value) {
  ...
  template <typename UuidT = Aws::String>
  GetConfigurationResult& WithUuid(UuidT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetConfigurationResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetConfigurationResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename RunConfigurationsT = RunConfigurationsResponse>
  GetConfigurationResult& WithRunConfigurations(RunConfigurationsT&& value) {
  ...
  inline GetConfigurationResult& WithStatus(ConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetConfigurationResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetConfigurationResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  GetConfigurationResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
