...
class UpdateRunGroupRequest : public OmicsRequest {
 public:
  ...
  inline UpdateRunGroupRequest& WithMaxCpus(int value) {
    SetMaxCpus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateRunGroupRequest& WithMaxRuns(int value) {
    SetMaxRuns(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateRunGroupRequest& WithMaxDuration(int value) {
  ...
  inline UpdateRunGroupRequest& WithMaxGpus(int value) {
    SetMaxGpus(value);
    return *this;
  }
  ///@}
