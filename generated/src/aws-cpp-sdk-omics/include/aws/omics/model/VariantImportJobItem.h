...
class VariantImportJobItem {
 public:
  ...
  template <typename IdT = Aws::String>
  VariantImportJobItem& WithId(IdT&& value) {
  ...
  template <typename DestinationNameT = Aws::String>
  VariantImportJobItem& WithDestinationName(DestinationNameT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  VariantImportJobItem& WithRoleArn(RoleArnT&& value) {
  ...
  inline VariantImportJobItem& WithStatus(JobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  VariantImportJobItem& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  VariantImportJobItem& WithUpdateTime(UpdateTimeT&& value) {
  ...
  template <typename CompletionTimeT = Aws::Utils::DateTime>
  VariantImportJobItem& WithCompletionTime(CompletionTimeT&& value) {
  ...
  inline VariantImportJobItem& WithRunLeftNormalization(bool value) {
  ...
  template <typename AnnotationFieldsT = Aws::Map<Aws::String, Aws::String>>
  VariantImportJobItem& WithAnnotationFields(AnnotationFieldsT&& value) {
