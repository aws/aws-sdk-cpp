...
class ListVariantImportJobsRequest : public OmicsRequest {
 public:
  ...
  inline ListVariantImportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdsT = Aws::Vector<Aws::String>>
  ListVariantImportJobsRequest& WithIds(IdsT&& value) {
    SetIds(std::forward<IdsT>(value));
    return *this;
  }
  template <typename IdsT = Aws::String>
  ListVariantImportJobsRequest& AddIds(IdsT&& value) {
    m_idsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListVariantImportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = ListVariantImportJobsFilter>
  ListVariantImportJobsRequest& WithFilter(FilterT&& value) {
