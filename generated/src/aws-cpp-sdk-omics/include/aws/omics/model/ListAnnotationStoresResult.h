...
class ListAnnotationStoresResult {
 public:
  ...
  void SetAnnotationStores(AnnotationStoresT&& value) {
    m_annotationStoresHasBeenSet = true;
    m_annotationStores = std::forward<AnnotationStoresT>(value);
  }
  template <typename AnnotationStoresT = Aws::Vector<AnnotationStoreItem>>
  ListAnnotationStoresResult& WithAnnotationStores(AnnotationStoresT&& value) {
    SetAnnotationStores(std::forward<AnnotationStoresT>(value));
    return *this;
  }
  template <typename AnnotationStoresT = AnnotationStoreItem>
  ListAnnotationStoresResult& AddAnnotationStores(AnnotationStoresT&& value) {
    m_annotationStoresHasBeenSet = true;
    m_annotationStores.emplace_back(std::forward<AnnotationStoresT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnnotationStoresResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnnotationStoresResult& WithRequestId(RequestIdT&& value) {
