...
class StoreOptions {
 public:
  ...
  void SetTsvStoreOptions(TsvStoreOptionsT&& value) {
    m_tsvStoreOptionsHasBeenSet = true;
    m_tsvStoreOptions = std::forward<TsvStoreOptionsT>(value);
  }
  template <typename TsvStoreOptionsT = TsvStoreOptions>
  StoreOptions& WithTsvStoreOptions(TsvStoreOptionsT&& value) {
    SetTsvStoreOptions(std::forward<TsvStoreOptionsT>(value));
    return *this;
  }
  ///@}
 private:
