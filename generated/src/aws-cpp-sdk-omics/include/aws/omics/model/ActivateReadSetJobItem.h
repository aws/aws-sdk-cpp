...
class ActivateReadSetJobItem {
 public:
  ...
  template <typename IdT = Aws::String>
  ActivateReadSetJobItem& WithId(IdT&& value) {
  ...
  template <typename SequenceStoreIdT = Aws::String>
  ActivateReadSetJobItem& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  inline void SetStatus(ReadSetActivationJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ActivateReadSetJobItem& WithStatus(ReadSetActivationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ActivateReadSetJobItem& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename CompletionTimeT = Aws::Utils::DateTime>
  ActivateReadSetJobItem& WithCompletionTime(CompletionTimeT&& value) {
