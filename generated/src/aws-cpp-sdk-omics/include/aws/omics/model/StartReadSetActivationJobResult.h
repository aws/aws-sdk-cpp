...
class StartReadSetActivationJobResult {
 public:
  ...
  template <typename IdT = Aws::String>
  StartReadSetActivationJobResult& WithId(IdT&& value) {
  ...
  template <typename SequenceStoreIdT = Aws::String>
  StartReadSetActivationJobResult& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  inline StartReadSetActivationJobResult& WithStatus(ReadSetActivationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  StartReadSetActivationJobResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartReadSetActivationJobResult& WithRequestId(RequestIdT&& value) {
