...
class ReadSetFilter {
 public:
  ...
  template <typename NameT = Aws::String>
  ReadSetFilter& WithName(NameT&& value) {
  ...
  inline ReadSetFilter& WithStatus(ReadSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReferenceArnT = Aws::String>
  ReadSetFilter& WithReferenceArn(ReferenceArnT&& value) {
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  ReadSetFilter& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  ReadSetFilter& WithCreatedBefore(CreatedBeforeT&& value) {
  ...
  template <typename SampleIdT = Aws::String>
  ReadSetFilter& WithSampleId(SampleIdT&& value) {
  ...
  template <typename SubjectIdT = Aws::String>
  ReadSetFilter& WithSubjectId(SubjectIdT&& value) {
  ...
  template <typename GeneratedFromT = Aws::String>
  ReadSetFilter& WithGeneratedFrom(GeneratedFromT&& value) {
  ...
  inline ReadSetFilter& WithCreationType(CreationType value) {
