...
class ExportReadSetJobDetail {
 public:
  AWS_OMICS_API ExportReadSetJobDetail() = default;
  ...
  template <typename IdT = Aws::String>
  ExportReadSetJobDetail& WithId(IdT&& value) {
  ...
  template <typename SequenceStoreIdT = Aws::String>
  ExportReadSetJobDetail& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  template <typename DestinationT = Aws::String>
  ExportReadSetJobDetail& WithDestination(DestinationT&& value) {
  ...
  inline ExportReadSetJobDetail& WithStatus(ReadSetExportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ExportReadSetJobDetail& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename CompletionTimeT = Aws::Utils::DateTime>
  ExportReadSetJobDetail& WithCompletionTime(CompletionTimeT&& value) {
