...
namespace Model
{
  ...
  {
  public:
    AWS_OMICS_API DeleteS3AccessPolicyRequest();
    ...
    inline DeleteS3AccessPolicyRequest& WithS3AccessPointArn(const Aws::String& value) { SetS3AccessPointArn(value); return *this;}
    inline DeleteS3AccessPolicyRequest& WithS3AccessPointArn(Aws::String&& value) { SetS3AccessPointArn(std::move(value)); return *this;}
    inline DeleteS3AccessPolicyRequest& WithS3AccessPointArn(const char* value) { SetS3AccessPointArn(value); return *this;}
    ///@}
  private:
