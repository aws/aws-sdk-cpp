...
class ListReadSetImportJobsRequest : public OmicsRequest {
 public:
  AWS_OMICS_API ListReadSetImportJobsRequest() = default;
  ...
  inline ListReadSetImportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReadSetImportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SequenceStoreIdT = Aws::String>
  ListReadSetImportJobsRequest& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  template <typename FilterT = ImportReadSetFilter>
  void SetFilter(FilterT&& value) {
    m_filterHasBeenSet = true;
    m_filter = std::forward<FilterT>(value);
  }
  template <typename FilterT = ImportReadSetFilter>
  ListReadSetImportJobsRequest& WithFilter(FilterT&& value) {
