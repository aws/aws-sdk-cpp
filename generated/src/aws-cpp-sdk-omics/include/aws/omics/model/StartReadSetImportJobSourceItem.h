...
class StartReadSetImportJobSourceItem {
 public:
  ...
  void SetSourceFiles(SourceFilesT&& value) {
    m_sourceFilesHasBeenSet = true;
    m_sourceFiles = std::forward<SourceFilesT>(value);
  }
  template <typename SourceFilesT = SourceFiles>
  StartReadSetImportJobSourceItem& WithSourceFiles(SourceFilesT&& value) {
    SetSourceFiles(std::forward<SourceFilesT>(value));
    return *this;
  }
  ///@}
  ...
  inline StartReadSetImportJobSourceItem& WithSourceFileType(FileType value) {
  ...
  template <typename SubjectIdT = Aws::String>
  StartReadSetImportJobSourceItem& WithSubjectId(SubjectIdT&& value) {
  ...
  template <typename SampleIdT = Aws::String>
  StartReadSetImportJobSourceItem& WithSampleId(SampleIdT&& value) {
  ...
  template <typename GeneratedFromT = Aws::String>
  StartReadSetImportJobSourceItem& WithGeneratedFrom(GeneratedFromT&& value) {
  ...
  template <typename ReferenceArnT = Aws::String>
  StartReadSetImportJobSourceItem& WithReferenceArn(ReferenceArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  StartReadSetImportJobSourceItem& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  StartReadSetImportJobSourceItem& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StartReadSetImportJobSourceItem& WithTags(TagsT&& value) {
