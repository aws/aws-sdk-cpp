...
class ListAnnotationStoreVersionsResult {
 public:
  ...
  void SetAnnotationStoreVersions(AnnotationStoreVersionsT&& value) {
    m_annotationStoreVersionsHasBeenSet = true;
    m_annotationStoreVersions = std::forward<AnnotationStoreVersionsT>(value);
  }
  template <typename AnnotationStoreVersionsT = Aws::Vector<AnnotationStoreVersionItem>>
  ListAnnotationStoreVersionsResult& WithAnnotationStoreVersions(AnnotationStoreVersionsT&& value) {
    SetAnnotationStoreVersions(std::forward<AnnotationStoreVersionsT>(value));
    return *this;
  }
  template <typename AnnotationStoreVersionsT = AnnotationStoreVersionItem>
  ListAnnotationStoreVersionsResult& AddAnnotationStoreVersions(AnnotationStoreVersionsT&& value) {
    m_annotationStoreVersionsHasBeenSet = true;
    m_annotationStoreVersions.emplace_back(std::forward<AnnotationStoreVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnnotationStoreVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnnotationStoreVersionsResult& WithRequestId(RequestIdT&& value) {
