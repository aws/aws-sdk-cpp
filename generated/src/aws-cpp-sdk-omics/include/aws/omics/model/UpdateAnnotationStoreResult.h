...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    UpdateAnnotationStoreResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ReferenceT = ReferenceItem>
    UpdateAnnotationStoreResult& WithReference(ReferenceT&& value) { SetReference(std::forward<ReferenceT>(value)); return *this;}
    ///@}
    ...
    inline UpdateAnnotationStoreResult& WithStatus(StoreStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateAnnotationStoreResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateAnnotationStoreResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimeT = Aws::Utils::DateTime>
    UpdateAnnotationStoreResult& WithCreationTime(CreationTimeT&& value) { SetCreationTime(std::forward<CreationTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdateTimeT = Aws::Utils::DateTime>
    UpdateAnnotationStoreResult& WithUpdateTime(UpdateTimeT&& value) { SetUpdateTime(std::forward<UpdateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename StoreOptionsT = StoreOptions>
    UpdateAnnotationStoreResult& WithStoreOptions(StoreOptionsT&& value) { SetStoreOptions(std::forward<StoreOptionsT>(value)); return *this;}
    ///@}
    ...
    inline UpdateAnnotationStoreResult& WithStoreFormat(StoreFormat value) { SetStoreFormat(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateAnnotationStoreResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
