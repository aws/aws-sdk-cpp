...
class StartReadSetExportJobRequest : public OmicsRequest {
 public:
  ...
  template <typename SequenceStoreIdT = Aws::String>
  StartReadSetExportJobRequest& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  template <typename DestinationT = Aws::String>
  StartReadSetExportJobRequest& WithDestination(DestinationT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  StartReadSetExportJobRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StartReadSetExportJobRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename SourcesT = Aws::Vector<ExportReadSet>>
  StartReadSetExportJobRequest& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = ExportReadSet>
  StartReadSetExportJobRequest& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
