...
class StartRunRequest : public OmicsRequest {
 public:
  ...
  inline StartRunRequest& WithWorkflowType(WorkflowType value) {
  ...
  inline StartRunRequest& WithCacheBehavior(CacheBehavior value) {
  ...
  inline StartRunRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline StartRunRequest& WithStorageCapacity(int value) {
  ...
  inline StartRunRequest& WithLogLevel(RunLogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
  ...
  inline StartRunRequest& WithRetentionMode(RunRetentionMode value) {
  ...
  inline StartRunRequest& WithStorageType(StorageType value) {
