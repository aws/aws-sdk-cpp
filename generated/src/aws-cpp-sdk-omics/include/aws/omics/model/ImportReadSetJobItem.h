...
class ImportReadSetJobItem {
 public:
  AWS_OMICS_API ImportReadSetJobItem() = default;
  ...
  template <typename IdT = Aws::String>
  ImportReadSetJobItem& WithId(IdT&& value) {
  ...
  template <typename SequenceStoreIdT = Aws::String>
  ImportReadSetJobItem& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  ImportReadSetJobItem& WithRoleArn(RoleArnT&& value) {
  ...
  inline ImportReadSetJobItem& WithStatus(ReadSetImportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ImportReadSetJobItem& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename CompletionTimeT = Aws::Utils::DateTime>
  ImportReadSetJobItem& WithCompletionTime(CompletionTimeT&& value) {
