...
class TsvVersionOptions {
 public:
  ...
  inline void SetAnnotationType(AnnotationType value) {
    m_annotationTypeHasBeenSet = true;
    m_annotationType = value;
  }
  inline TsvVersionOptions& WithAnnotationType(AnnotationType value) {
