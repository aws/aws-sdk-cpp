...
class VcfOptions {
 public:
  ...
  inline void SetIgnoreQualField(bool value) {
    m_ignoreQualFieldHasBeenSet = true;
    m_ignoreQualField = value;
  }
  inline VcfOptions& WithIgnoreQualField(bool value) {
    SetIgnoreQualField(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIgnoreFilterField(bool value) {
    m_ignoreFilterFieldHasBeenSet = true;
    m_ignoreFilterField = value;
  }
  inline VcfOptions& WithIgnoreFilterField(bool value) {
    SetIgnoreFilterField(value);
    return *this;
  }
  ///@}
 private:
