...
class CreateSequenceStoreResult {
 public:
  ...
  inline CreateSequenceStoreResult& WithETagAlgorithmFamily(ETagAlgorithmFamily value) {
  ...
  inline CreateSequenceStoreResult& WithStatus(SequenceStoreStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
