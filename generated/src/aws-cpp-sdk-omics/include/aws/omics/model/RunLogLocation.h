...
class RunLogLocation {
 public:
  ...
  void SetEngineLogStream(EngineLogStreamT&& value) {
    ...
    m_engineLogStream = std::forward<EngineLogStreamT>(value);
  }
  template <typename EngineLogStreamT = Aws::String>
  RunLogLocation& WithEngineLogStream(EngineLogStreamT&& value) {
    SetEngineLogStream(std::forward<EngineLogStreamT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRunLogStream(RunLogStreamT&& value) {
    ...
    m_runLogStream = std::forward<RunLogStreamT>(value);
  }
  template <typename RunLogStreamT = Aws::String>
  RunLogLocation& WithRunLogStream(RunLogStreamT&& value) {
    SetRunLogStream(std::forward<RunLogStreamT>(value));
    return *this;
  }
  ///@}
 private:
