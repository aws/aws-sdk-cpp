...
class ListReadSetsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListReadSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetReadSets(ReadSetsT&& value) {
    m_readSetsHasBeenSet = true;
    m_readSets = std::forward<ReadSetsT>(value);
  }
  template <typename ReadSetsT = Aws::Vector<ReadSetListItem>>
  ListReadSetsResult& WithReadSets(ReadSetsT&& value) {
    SetReadSets(std::forward<ReadSetsT>(value));
    return *this;
  }
  template <typename ReadSetsT = ReadSetListItem>
  ListReadSetsResult& AddReadSets(ReadSetsT&& value) {
    m_readSetsHasBeenSet = true;
    m_readSets.emplace_back(std::forward<ReadSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListReadSetsResult& WithRequestId(RequestIdT&& value) {
