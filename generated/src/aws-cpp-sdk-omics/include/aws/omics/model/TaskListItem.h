...
class TaskListItem {
 public:
  ...
  inline TaskListItem& WithStatus(TaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline TaskListItem& WithCpus(int value) {
    SetCpus(value);
    return *this;
  }
  ///@}
  ...
  inline TaskListItem& WithCacheHit(bool value) {
    SetCacheHit(value);
    return *this;
  }
  ///@}
  ...
  inline TaskListItem& WithMemory(int value) {
    SetMemory(value);
    return *this;
  }
  ///@}
  ...
  inline TaskListItem& WithGpus(int value) {
    SetGpus(value);
    return *this;
  }
  ///@}
