...
class GetRunCacheResult {
 public:
  ...
  inline GetRunCacheResult& WithCacheBehavior(CacheBehavior value) {
  ...
  inline void SetStatus(RunCacheStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetRunCacheResult& WithStatus(RunCacheStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
