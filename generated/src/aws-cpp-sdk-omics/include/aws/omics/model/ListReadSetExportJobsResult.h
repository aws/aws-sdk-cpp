...
class ListReadSetExportJobsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListReadSetExportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ExportJobsT = Aws::Vector<ExportReadSetJobDetail>>
  ListReadSetExportJobsResult& WithExportJobs(ExportJobsT&& value) {
    SetExportJobs(std::forward<ExportJobsT>(value));
    return *this;
  }
  template <typename ExportJobsT = ExportReadSetJobDetail>
  ListReadSetExportJobsResult& AddExportJobs(ExportJobsT&& value) {
    m_exportJobsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListReadSetExportJobsResult& WithRequestId(RequestIdT&& value) {
