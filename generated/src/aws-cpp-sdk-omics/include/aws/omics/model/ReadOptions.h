...
class ReadOptions {
 public:
  ...
  void SetSep(SepT&& value) {
    ...
    m_sep = std::forward<SepT>(value);
  }
  template <typename SepT = Aws::String>
  ReadOptions& WithSep(SepT&& value) {
    SetSep(std::forward<SepT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetQuoteAll(bool value) {
    m_quoteAllHasBeenSet = true;
    m_quoteAll = value;
  }
  inline ReadOptions& WithQuoteAll(bool value) {
    SetQuoteAll(value);
    return *this;
  }
  ///@}
  ...
  void SetEscape(EscapeT&& value) {
    ...
    m_escape = std::forward<EscapeT>(value);
  }
  template <typename EscapeT = Aws::String>
  ReadOptions& WithEscape(EscapeT&& value) {
    SetEscape(std::forward<EscapeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEscapeQuotes(bool value) {
    m_escapeQuotesHasBeenSet = true;
    m_escapeQuotes = value;
  }
  inline ReadOptions& WithEscapeQuotes(bool value) {
  ...
  inline ReadOptions& WithHeader(bool value) {
    SetHeader(value);
    return *this;
  }
  ///@}
  ...
  void SetLineSep(LineSepT&& value) {
    ...
    m_lineSep = std::forward<LineSepT>(value);
  }
  template <typename LineSepT = Aws::String>
  ReadOptions& WithLineSep(LineSepT&& value) {
    SetLineSep(std::forward<LineSepT>(value));
    return *this;
  }
  ///@}
 private:
