...
class ListReferencesResult {
 public:
  AWS_OMICS_API ListReferencesResult() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListReferencesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ReferencesT = Aws::Vector<ReferenceListItem>>
  void SetReferences(ReferencesT&& value) {
    m_referencesHasBeenSet = true;
    m_references = std::forward<ReferencesT>(value);
  }
  template <typename ReferencesT = Aws::Vector<ReferenceListItem>>
  ListReferencesResult& WithReferences(ReferencesT&& value) {
    SetReferences(std::forward<ReferencesT>(value));
    return *this;
  }
  template <typename ReferencesT = ReferenceListItem>
  ListReferencesResult& AddReferences(ReferencesT&& value) {
    m_referencesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListReferencesResult& WithRequestId(RequestIdT&& value) {
