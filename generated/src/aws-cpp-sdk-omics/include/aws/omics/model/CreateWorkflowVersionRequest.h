...
class CreateWorkflowVersionRequest : public OmicsRequest {
 public:
  ...
  inline CreateWorkflowVersionRequest& WithAccelerators(Accelerators value) {
  ...
  inline CreateWorkflowVersionRequest& WithEngine(WorkflowEngine value) {
    SetEngine(value);
    return *this;
  }
  ///@}
  ...
  inline CreateWorkflowVersionRequest& WithStorageType(StorageType value) {
  ...
  inline CreateWorkflowVersionRequest& WithStorageCapacity(int value) {
