...
class ETag {
 public:
  ...
  inline void SetAlgorithm(ETagAlgorithm value) {
    m_algorithmHasBeenSet = true;
    m_algorithm = value;
  }
  inline ETag& WithAlgorithm(ETagAlgorithm value) {
    SetAlgorithm(value);
    return *this;
  }
  ///@}
  ...
  void SetSource1(Source1T&& value) {
    ...
    m_source1 = std::forward<Source1T>(value);
  }
  template <typename Source1T = Aws::String>
  ETag& WithSource1(Source1T&& value) {
    SetSource1(std::forward<Source1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetSource2(Source2T&& value) {
    ...
    m_source2 = std::forward<Source2T>(value);
  }
  template <typename Source2T = Aws::String>
  ETag& WithSource2(Source2T&& value) {
    SetSource2(std::forward<Source2T>(value));
    return *this;
  }
  ///@}
 private:
