...
class ActivateReadSetSourceItem {
 public:
  ...
  template <typename ReadSetIdT = Aws::String>
  ActivateReadSetSourceItem& WithReadSetId(ReadSetIdT&& value) {
  ...
  inline void SetStatus(ReadSetActivationJobItemStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ActivateReadSetSourceItem& WithStatus(ReadSetActivationJobItemStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  ActivateReadSetSourceItem& WithStatusMessage(StatusMessageT&& value) {
