...
class ReferenceStoreFilter {
 public:
  ...
  template <typename NameT = Aws::String>
  ReferenceStoreFilter& WithName(NameT&& value) {
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  ReferenceStoreFilter& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  ReferenceStoreFilter& WithCreatedBefore(CreatedBeforeT&& value) {
