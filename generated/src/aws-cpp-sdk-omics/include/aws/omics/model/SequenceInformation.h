...
class SequenceInformation {
 public:
  ...
  inline void SetTotalReadCount(long long value) {
    m_totalReadCountHasBeenSet = true;
    m_totalReadCount = value;
  }
  inline SequenceInformation& WithTotalReadCount(long long value) {
    SetTotalReadCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalBaseCount(long long value) {
    m_totalBaseCountHasBeenSet = true;
    m_totalBaseCount = value;
  }
  inline SequenceInformation& WithTotalBaseCount(long long value) {
    SetTotalBaseCount(value);
    return *this;
  }
  ///@}
  ...
  void SetAlignment(AlignmentT&& value) {
    m_alignmentHasBeenSet = true;
    m_alignment = std::forward<AlignmentT>(value);
  }
  template <typename AlignmentT = Aws::String>
  SequenceInformation& WithAlignment(AlignmentT&& value) {
    SetAlignment(std::forward<AlignmentT>(value));
    return *this;
  }
  ///@}
 private:
