...
class GetReadSetExportJobResult {
 public:
  ...
  template <typename IdT = Aws::String>
  GetReadSetExportJobResult& WithId(IdT&& value) {
  ...
  template <typename SequenceStoreIdT = Aws::String>
  GetReadSetExportJobResult& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  template <typename DestinationT = Aws::String>
  GetReadSetExportJobResult& WithDestination(DestinationT&& value) {
  ...
  inline GetReadSetExportJobResult& WithStatus(ReadSetExportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  GetReadSetExportJobResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetReadSetExportJobResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename CompletionTimeT = Aws::Utils::DateTime>
  GetReadSetExportJobResult& WithCompletionTime(CompletionTimeT&& value) {
  ...
  template <typename ReadSetsT = Aws::Vector<ExportReadSetDetail>>
  GetReadSetExportJobResult& WithReadSets(ReadSetsT&& value) {
    SetReadSets(std::forward<ReadSetsT>(value));
    return *this;
  }
  template <typename ReadSetsT = ExportReadSetDetail>
  GetReadSetExportJobResult& AddReadSets(ReadSetsT&& value) {
    m_readSetsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetReadSetExportJobResult& WithRequestId(RequestIdT&& value) {
