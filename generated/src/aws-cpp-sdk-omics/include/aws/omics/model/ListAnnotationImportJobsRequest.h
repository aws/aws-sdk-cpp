...
class ListAnnotationImportJobsRequest : public OmicsRequest {
 public:
  ...
  inline ListAnnotationImportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdsT = Aws::Vector<Aws::String>>
  ListAnnotationImportJobsRequest& WithIds(IdsT&& value) {
    SetIds(std::forward<IdsT>(value));
    return *this;
  }
  template <typename IdsT = Aws::String>
  ListAnnotationImportJobsRequest& AddIds(IdsT&& value) {
    m_idsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAnnotationImportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = ListAnnotationImportJobsFilter>
  ListAnnotationImportJobsRequest& WithFilter(FilterT&& value) {
