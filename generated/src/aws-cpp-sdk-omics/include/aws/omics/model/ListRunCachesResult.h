...
class ListRunCachesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<RunCacheListItem>>
  ListRunCachesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = RunCacheListItem>
  ListRunCachesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRunCachesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRunCachesResult& WithRequestId(RequestIdT&& value) {
