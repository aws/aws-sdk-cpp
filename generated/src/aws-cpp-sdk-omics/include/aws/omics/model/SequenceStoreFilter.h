...
class SequenceStoreFilter {
 public:
  ...
  template <typename NameT = Aws::String>
  SequenceStoreFilter& WithName(NameT&& value) {
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  SequenceStoreFilter& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  SequenceStoreFilter& WithCreatedBefore(CreatedBeforeT&& value) {
  ...
  inline SequenceStoreFilter& WithStatus(SequenceStoreStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename UpdatedAfterT = Aws::Utils::DateTime>
  SequenceStoreFilter& WithUpdatedAfter(UpdatedAfterT&& value) {
  ...
  template <typename UpdatedBeforeT = Aws::Utils::DateTime>
  SequenceStoreFilter& WithUpdatedBefore(UpdatedBeforeT&& value) {
