...
namespace Model
{
  ...
  {
  public:
    AWS_OMICS_API CancelAnnotationImportJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelAnnotationImportJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
