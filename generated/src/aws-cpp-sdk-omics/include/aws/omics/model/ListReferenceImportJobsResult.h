...
class ListReferenceImportJobsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListReferenceImportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ImportJobsT = Aws::Vector<ImportReferenceJobItem>>
  ListReferenceImportJobsResult& WithImportJobs(ImportJobsT&& value) {
    SetImportJobs(std::forward<ImportJobsT>(value));
    return *this;
  }
  template <typename ImportJobsT = ImportReferenceJobItem>
  ListReferenceImportJobsResult& AddImportJobs(ImportJobsT&& value) {
    m_importJobsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListReferenceImportJobsResult& WithRequestId(RequestIdT&& value) {
