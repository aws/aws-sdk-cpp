...
class CreateVariantStoreResult {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateVariantStoreResult& WithId(IdT&& value) {
  ...
  template <typename ReferenceT = ReferenceItem>
  CreateVariantStoreResult& WithReference(ReferenceT&& value) {
  ...
  inline void SetStatus(StoreStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CreateVariantStoreResult& WithStatus(StoreStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  CreateVariantStoreResult& WithName(NameT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  CreateVariantStoreResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateVariantStoreResult& WithRequestId(RequestIdT&& value) {
