...
class GetWorkflowVersionResult {
 public:
  ...
  inline GetWorkflowVersionResult& WithAccelerators(Accelerators value) {
  ...
  inline GetWorkflowVersionResult& WithEngine(WorkflowEngine value) {
    SetEngine(value);
    return *this;
  }
  ///@}
  ...
  inline GetWorkflowVersionResult& WithStatus(WorkflowStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetWorkflowVersionResult& WithStorageType(StorageType value) {
  ...
  inline GetWorkflowVersionResult& WithStorageCapacity(int value) {
  ...
  inline GetWorkflowVersionResult& WithType(WorkflowType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The list of Nextflow profiles that are available for this workflow version.
   * Profiles allow you to select predefined configuration settings at runtime.</p>
   */
