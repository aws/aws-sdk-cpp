...
class ListRunTasksResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<TaskListItem>>
  ListRunTasksResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = TaskListItem>
  ListRunTasksResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRunTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRunTasksResult& WithRequestId(RequestIdT&& value) {
