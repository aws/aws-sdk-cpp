...
class GetReadSetMetadataResult {
 public:
  ...
  inline void SetStatus(ReadSetStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetReadSetMetadataResult& WithStatus(ReadSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetReadSetMetadataResult& WithFileType(FileType value) {
    SetFileType(value);
    return *this;
  }
  ///@}
  ...
  void SetSequenceInformation(SequenceInformationT&& value) {
    ...
    m_sequenceInformation = std::forward<SequenceInformationT>(value);
  }
  template <typename SequenceInformationT = SequenceInformation>
  GetReadSetMetadataResult& WithSequenceInformation(SequenceInformationT&& value) {
    SetSequenceInformation(std::forward<SequenceInformationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCreationType(CreationType value) {
    m_creationTypeHasBeenSet = true;
    m_creationType = value;
  }
  inline GetReadSetMetadataResult& WithCreationType(CreationType value) {
  ...
  void SetCreationJobId(CreationJobIdT&& value) {
    m_creationJobIdHasBeenSet = true;
    m_creationJobId = std::forward<CreationJobIdT>(value);
  }
  template <typename CreationJobIdT = Aws::String>
  GetReadSetMetadataResult& WithCreationJobId(CreationJobIdT&& value) {
    SetCreationJobId(std::forward<CreationJobIdT>(value));
    return *this;
  }
  ///@}
