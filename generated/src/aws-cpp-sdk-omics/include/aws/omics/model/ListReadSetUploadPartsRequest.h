...
class ListReadSetUploadPartsRequest : public OmicsRequest {
 public:
  ...
  template <typename SequenceStoreIdT = Aws::String>
  ListReadSetUploadPartsRequest& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  template <typename UploadIdT = Aws::String>
  ListReadSetUploadPartsRequest& WithUploadId(UploadIdT&& value) {
  ...
  inline ListReadSetUploadPartsRequest& WithPartSource(ReadSetPartSource value) {
    SetPartSource(value);
    return *this;
  }
  ///@}
  ...
  inline ListReadSetUploadPartsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReadSetUploadPartsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = ReadSetUploadPartListFilter>
  ListReadSetUploadPartsRequest& WithFilter(FilterT&& value) {
