...
class VersionOptions {
 public:
  ...
  void SetTsvVersionOptions(TsvVersionOptionsT&& value) {
    m_tsvVersionOptionsHasBeenSet = true;
    m_tsvVersionOptions = std::forward<TsvVersionOptionsT>(value);
  }
  template <typename TsvVersionOptionsT = TsvVersionOptions>
  VersionOptions& WithTsvVersionOptions(TsvVersionOptionsT&& value) {
    SetTsvVersionOptions(std::forward<TsvVersionOptionsT>(value));
    return *this;
  }
  ///@}
 private:
