...
class ListVariantStoresResult {
 public:
  ...
  void SetVariantStores(VariantStoresT&& value) {
    m_variantStoresHasBeenSet = true;
    m_variantStores = std::forward<VariantStoresT>(value);
  }
  template <typename VariantStoresT = Aws::Vector<VariantStoreItem>>
  ListVariantStoresResult& WithVariantStores(VariantStoresT&& value) {
    SetVariantStores(std::forward<VariantStoresT>(value));
    return *this;
  }
  template <typename VariantStoresT = VariantStoreItem>
  ListVariantStoresResult& AddVariantStores(VariantStoresT&& value) {
    m_variantStoresHasBeenSet = true;
    m_variantStores.emplace_back(std::forward<VariantStoresT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVariantStoresResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVariantStoresResult& WithRequestId(RequestIdT&& value) {
