...
class ListAnnotationStoreVersionsRequest : public OmicsRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  ListAnnotationStoreVersionsRequest& WithName(NameT&& value) {
  ...
  inline ListAnnotationStoreVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAnnotationStoreVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = ListAnnotationStoreVersionsFilter>
  ListAnnotationStoreVersionsRequest& WithFilter(FilterT&& value) {
