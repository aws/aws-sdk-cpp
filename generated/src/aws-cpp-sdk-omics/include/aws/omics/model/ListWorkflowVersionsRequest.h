...
class ListWorkflowVersionsRequest : public OmicsRequest {
 public:
  ...
  template <typename WorkflowIdT = Aws::String>
  ListWorkflowVersionsRequest& WithWorkflowId(WorkflowIdT&& value) {
  ...
  inline ListWorkflowVersionsRequest& WithType(WorkflowType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename WorkflowOwnerIdT = Aws::String>
  ListWorkflowVersionsRequest& WithWorkflowOwnerId(WorkflowOwnerIdT&& value) {
  ...
  template <typename StartingTokenT = Aws::String>
  ListWorkflowVersionsRequest& WithStartingToken(StartingTokenT&& value) {
