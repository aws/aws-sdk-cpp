...
class StartReferenceImportJobResult {
 public:
  AWS_OMICS_API StartReferenceImportJobResult() = default;
  ...
  template <typename IdT = Aws::String>
  StartReferenceImportJobResult& WithId(IdT&& value) {
  ...
  template <typename ReferenceStoreIdT = Aws::String>
  StartReferenceImportJobResult& WithReferenceStoreId(ReferenceStoreIdT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  StartReferenceImportJobResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline StartReferenceImportJobResult& WithStatus(ReferenceImportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  StartReferenceImportJobResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartReferenceImportJobResult& WithRequestId(RequestIdT&& value) {
