...
class FileInformation {
 public:
  ...
  inline FileInformation& WithTotalParts(int value) {
    SetTotalParts(value);
    return *this;
  }
  ///@}
  ...
  inline FileInformation& WithPartSize(long long value) {
    SetPartSize(value);
    return *this;
  }
  ///@}
  ...
  inline FileInformation& WithContentLength(long long value) {
