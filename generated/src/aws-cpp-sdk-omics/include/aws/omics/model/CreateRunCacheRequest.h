...
class CreateRunCacheRequest : public OmicsRequest {
 public:
  ...
  inline CreateRunCacheRequest& WithCacheBehavior(CacheBehavior value) {
  ...
  void SetCacheS3Location(CacheS3LocationT&& value) {
    m_cacheS3LocationHasBeenSet = true;
    m_cacheS3Location = std::forward<CacheS3LocationT>(value);
  }
  template <typename CacheS3LocationT = Aws::String>
  CreateRunCacheRequest& WithCacheS3Location(CacheS3LocationT&& value) {
    SetCacheS3Location(std::forward<CacheS3LocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCacheBucketOwnerId(CacheBucketOwnerIdT&& value) {
    ...
    m_cacheBucketOwnerId = std::forward<CacheBucketOwnerIdT>(value);
  }
  template <typename CacheBucketOwnerIdT = Aws::String>
  CreateRunCacheRequest& WithCacheBucketOwnerId(CacheBucketOwnerIdT&& value) {
    SetCacheBucketOwnerId(std::forward<CacheBucketOwnerIdT>(value));
    return *this;
  }
  ///@}
 private:
