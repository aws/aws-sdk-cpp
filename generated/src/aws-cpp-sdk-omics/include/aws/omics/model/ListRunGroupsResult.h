...
class ListRunGroupsResult {
 public:
  AWS_OMICS_API ListRunGroupsResult() = default;
  ...
  template <typename ItemsT = Aws::Vector<RunGroupListItem>>
  void SetItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
    m_items = std::forward<ItemsT>(value);
  }
  template <typename ItemsT = Aws::Vector<RunGroupListItem>>
  ListRunGroupsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = RunGroupListItem>
  ListRunGroupsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRunGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRunGroupsResult& WithRequestId(RequestIdT&& value) {
