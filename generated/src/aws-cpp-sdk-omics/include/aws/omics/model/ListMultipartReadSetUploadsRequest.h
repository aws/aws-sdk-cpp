...
class ListMultipartReadSetUploadsRequest : public OmicsRequest {
 public:
  ...
  template <typename SequenceStoreIdT = Aws::String>
  ListMultipartReadSetUploadsRequest& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  inline ListMultipartReadSetUploadsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMultipartReadSetUploadsRequest& WithNextToken(NextTokenT&& value) {
