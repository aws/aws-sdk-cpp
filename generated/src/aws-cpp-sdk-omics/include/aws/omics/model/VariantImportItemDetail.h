...
class VariantImportItemDetail {
 public:
  ...
  template <typename SourceT = Aws::String>
  VariantImportItemDetail& WithSource(SourceT&& value) {
  ...
  inline VariantImportItemDetail& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  VariantImportItemDetail& WithStatusMessage(StatusMessageT&& value) {
