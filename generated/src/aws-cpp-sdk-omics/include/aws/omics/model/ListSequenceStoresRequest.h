...
class ListSequenceStoresRequest : public OmicsRequest {
 public:
  ...
  inline ListSequenceStoresRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSequenceStoresRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = SequenceStoreFilter>
  ListSequenceStoresRequest& WithFilter(FilterT&& value) {
