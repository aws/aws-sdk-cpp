...
class ListRunGroupsRequest : public OmicsRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  ListRunGroupsRequest& WithName(NameT&& value) {
  ...
  template <typename StartingTokenT = Aws::String>
  ListRunGroupsRequest& WithStartingToken(StartingTokenT&& value) {
  ...
  inline ListRunGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
