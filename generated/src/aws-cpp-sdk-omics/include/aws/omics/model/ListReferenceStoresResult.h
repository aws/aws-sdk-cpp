...
class ListReferenceStoresResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListReferenceStoresResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetReferenceStores(ReferenceStoresT&& value) {
    m_referenceStoresHasBeenSet = true;
    m_referenceStores = std::forward<ReferenceStoresT>(value);
  }
  template <typename ReferenceStoresT = Aws::Vector<ReferenceStoreDetail>>
  ListReferenceStoresResult& WithReferenceStores(ReferenceStoresT&& value) {
    SetReferenceStores(std::forward<ReferenceStoresT>(value));
    return *this;
  }
  template <typename ReferenceStoresT = ReferenceStoreDetail>
  ListReferenceStoresResult& AddReferenceStores(ReferenceStoresT&& value) {
    m_referenceStoresHasBeenSet = true;
    m_referenceStores.emplace_back(std::forward<ReferenceStoresT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListReferenceStoresResult& WithRequestId(RequestIdT&& value) {
