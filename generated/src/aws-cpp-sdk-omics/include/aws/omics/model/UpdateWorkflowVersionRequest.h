...
class UpdateWorkflowVersionRequest : public OmicsRequest {
 public:
  ...
  inline UpdateWorkflowVersionRequest& WithStorageType(StorageType value) {
  ...
  inline UpdateWorkflowVersionRequest& WithStorageCapacity(int value) {
  ...
  void SetReadmeMarkdown(ReadmeMarkdownT&& value) {
    m_readmeMarkdownHasBeenSet = true;
    m_readmeMarkdown = std::forward<ReadmeMarkdownT>(value);
  }
  template <typename ReadmeMarkdownT = Aws::String>
  UpdateWorkflowVersionRequest& WithReadmeMarkdown(ReadmeMarkdownT&& value) {
    SetReadmeMarkdown(std::forward<ReadmeMarkdownT>(value));
    return *this;
  }
  ///@}
 private:
