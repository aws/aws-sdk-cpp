...
namespace Model
{
  ...
  {
  public:
    AWS_OMICS_API DeleteShareResult() = default;
    ...
    inline DeleteShareResult& WithStatus(ShareStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteShareResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
