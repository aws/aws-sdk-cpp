...
class ImportReferenceFilter {
 public:
  ...
  inline ImportReferenceFilter& WithStatus(ReferenceImportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  ImportReferenceFilter& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  ImportReferenceFilter& WithCreatedBefore(CreatedBeforeT&& value) {
