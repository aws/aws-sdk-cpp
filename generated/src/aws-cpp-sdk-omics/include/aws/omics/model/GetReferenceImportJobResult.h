...
class GetReferenceImportJobResult {
 public:
  AWS_OMICS_API GetReferenceImportJobResult() = default;
  ...
  template <typename IdT = Aws::String>
  GetReferenceImportJobResult& WithId(IdT&& value) {
  ...
  void SetReferenceStoreId(ReferenceStoreIdT&& value) {
    ...
    m_referenceStoreId = std::forward<ReferenceStoreIdT>(value);
  }
  template <typename ReferenceStoreIdT = Aws::String>
  GetReferenceImportJobResult& WithReferenceStoreId(ReferenceStoreIdT&& value) {
    SetReferenceStoreId(std::forward<ReferenceStoreIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RoleArnT = Aws::String>
  GetReferenceImportJobResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline void SetStatus(ReferenceImportJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetReferenceImportJobResult& WithStatus(ReferenceImportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  GetReferenceImportJobResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetReferenceImportJobResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename CompletionTimeT = Aws::Utils::DateTime>
  GetReferenceImportJobResult& WithCompletionTime(CompletionTimeT&& value) {
  ...
  template <typename SourcesT = Aws::Vector<ImportReferenceSourceItem>>
  void SetSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
    m_sources = std::forward<SourcesT>(value);
  }
  template <typename SourcesT = Aws::Vector<ImportReferenceSourceItem>>
  GetReferenceImportJobResult& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = ImportReferenceSourceItem>
  GetReferenceImportJobResult& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetReferenceImportJobResult& WithRequestId(RequestIdT&& value) {
