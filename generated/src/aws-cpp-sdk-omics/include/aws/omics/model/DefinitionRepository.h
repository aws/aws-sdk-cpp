...
class DefinitionRepository {
 public:
  ...
  void SetFullRepositoryId(FullRepositoryIdT&& value) {
    ...
    m_fullRepositoryId = std::forward<FullRepositoryIdT>(value);
  }
  template <typename FullRepositoryIdT = Aws::String>
  DefinitionRepository& WithFullRepositoryId(FullRepositoryIdT&& value) {
    SetFullRepositoryId(std::forward<FullRepositoryIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceReference(SourceReferenceT&& value) {
    ...
    m_sourceReference = std::forward<SourceReferenceT>(value);
  }
  template <typename SourceReferenceT = SourceReference>
  DefinitionRepository& WithSourceReference(SourceReferenceT&& value) {
    SetSourceReference(std::forward<SourceReferenceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludeFilePatterns(ExcludeFilePatternsT&& value) {
    ...
    m_excludeFilePatterns = std::forward<ExcludeFilePatternsT>(value);
  }
  template <typename ExcludeFilePatternsT = Aws::Vector<Aws::String>>
  DefinitionRepository& WithExcludeFilePatterns(ExcludeFilePatternsT&& value) {
    SetExcludeFilePatterns(std::forward<ExcludeFilePatternsT>(value));
    return *this;
  }
  template <typename ExcludeFilePatternsT = Aws::String>
  DefinitionRepository& AddExcludeFilePatterns(ExcludeFilePatternsT&& value) {
    m_excludeFilePatternsHasBeenSet = true;
    m_excludeFilePatterns.emplace_back(std::forward<ExcludeFilePatternsT>(value));
    return *this;
  }
  ///@}
 private:
