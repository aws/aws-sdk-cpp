...
class ActivateReadSetFilter {
 public:
  ...
  inline ActivateReadSetFilter& WithStatus(ReadSetActivationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  ActivateReadSetFilter& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  ActivateReadSetFilter& WithCreatedBefore(CreatedBeforeT&& value) {
