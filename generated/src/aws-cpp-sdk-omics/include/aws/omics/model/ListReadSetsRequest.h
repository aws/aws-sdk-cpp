...
class ListReadSetsRequest : public OmicsRequest {
 public:
  ...
  template <typename SequenceStoreIdT = Aws::String>
  ListReadSetsRequest& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  inline ListReadSetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReadSetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = ReadSetFilter>
  ListReadSetsRequest& WithFilter(FilterT&& value) {
