...
class StartAnnotationImportJobRequest : public OmicsRequest {
 public:
  ...
  template <typename DestinationNameT = Aws::String>
  StartAnnotationImportJobRequest& WithDestinationName(DestinationNameT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  StartAnnotationImportJobRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<AnnotationImportItemSource>>
  StartAnnotationImportJobRequest& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = AnnotationImportItemSource>
  StartAnnotationImportJobRequest& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename VersionNameT = Aws::String>
  StartAnnotationImportJobRequest& WithVersionName(VersionNameT&& value) {
  ...
  template <typename FormatOptionsT = FormatOptions>
  StartAnnotationImportJobRequest& WithFormatOptions(FormatOptionsT&& value) {
  ...
  inline StartAnnotationImportJobRequest& WithRunLeftNormalization(bool value) {
  ...
  template <typename AnnotationFieldsT = Aws::Map<Aws::String, Aws::String>>
  StartAnnotationImportJobRequest& WithAnnotationFields(AnnotationFieldsT&& value) {
