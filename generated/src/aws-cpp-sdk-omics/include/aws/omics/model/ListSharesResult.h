...
class ListSharesResult {
 public:
  ...
  void SetShares(SharesT&& value) {
    m_sharesHasBeenSet = true;
    m_shares = std::forward<SharesT>(value);
  }
  template <typename SharesT = Aws::Vector<ShareDetails>>
  ListSharesResult& WithShares(SharesT&& value) {
    SetShares(std::forward<SharesT>(value));
    return *this;
  }
  template <typename SharesT = ShareDetails>
  ListSharesResult& AddShares(SharesT&& value) {
    m_sharesHasBeenSet = true;
    m_shares.emplace_back(std::forward<SharesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSharesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSharesResult& WithRequestId(RequestIdT&& value) {
