...
class UpdateSequenceStoreResult {
 public:
  ...
  inline void SetStatus(SequenceStoreStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateSequenceStoreResult& WithStatus(SequenceStoreStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateSequenceStoreResult& WithETagAlgorithmFamily(ETagAlgorithmFamily value) {
