...
class ListRunTasksRequest : public OmicsRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  ListRunTasksRequest& WithId(IdT&& value) {
  ...
  inline ListRunTasksRequest& WithStatus(TaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartingTokenT = Aws::String>
  ListRunTasksRequest& WithStartingToken(StartingTokenT&& value) {
  ...
  inline ListRunTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
