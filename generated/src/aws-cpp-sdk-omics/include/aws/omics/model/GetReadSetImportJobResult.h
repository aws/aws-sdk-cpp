...
class GetReadSetImportJobResult {
 public:
  ...
  template <typename IdT = Aws::String>
  GetReadSetImportJobResult& WithId(IdT&& value) {
  ...
  template <typename SequenceStoreIdT = Aws::String>
  GetReadSetImportJobResult& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  GetReadSetImportJobResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline void SetStatus(ReadSetImportJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetReadSetImportJobResult& WithStatus(ReadSetImportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  GetReadSetImportJobResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetReadSetImportJobResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename CompletionTimeT = Aws::Utils::DateTime>
  GetReadSetImportJobResult& WithCompletionTime(CompletionTimeT&& value) {
  ...
  template <typename SourcesT = Aws::Vector<ImportReadSetSourceItem>>
  GetReadSetImportJobResult& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = ImportReadSetSourceItem>
  GetReadSetImportJobResult& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetReadSetImportJobResult& WithRequestId(RequestIdT&& value) {
