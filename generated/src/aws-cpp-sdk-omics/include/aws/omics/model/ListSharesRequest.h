...
class ListSharesRequest : public OmicsRequest {
 public:
  ...
  inline ListSharesRequest& WithResourceOwner(ResourceOwner value) {
  ...
  template <typename FilterT = Filter>
  ListSharesRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSharesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSharesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
