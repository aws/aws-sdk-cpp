...
class ListRunsRequest : public OmicsRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  ListRunsRequest& WithName(NameT&& value) {
  ...
  template <typename RunGroupIdT = Aws::String>
  ListRunsRequest& WithRunGroupId(RunGroupIdT&& value) {
  ...
  template <typename StartingTokenT = Aws::String>
  ListRunsRequest& WithStartingToken(StartingTokenT&& value) {
  ...
  inline ListRunsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListRunsRequest& WithStatus(RunStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
