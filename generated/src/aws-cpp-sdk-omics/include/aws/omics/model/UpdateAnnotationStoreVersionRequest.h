...
class UpdateAnnotationStoreVersionRequest : public OmicsRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateAnnotationStoreVersionRequest& WithName(NameT&& value) {
  ...
  template <typename VersionNameT = Aws::String>
  UpdateAnnotationStoreVersionRequest& WithVersionName(VersionNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateAnnotationStoreVersionRequest& WithDescription(DescriptionT&& value) {
