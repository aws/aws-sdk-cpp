...
class ListReferencesRequest : public OmicsRequest {
 public:
  ...
  template <typename ReferenceStoreIdT = Aws::String>
  ListReferencesRequest& WithReferenceStoreId(ReferenceStoreIdT&& value) {
  ...
  inline ListReferencesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReferencesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = ReferenceFilter>
  ListReferencesRequest& WithFilter(FilterT&& value) {
