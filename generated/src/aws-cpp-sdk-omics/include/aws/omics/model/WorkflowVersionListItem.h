...
class WorkflowVersionListItem {
 public:
  ...
  template <typename ArnT = Aws::String>
  WorkflowVersionListItem& WithArn(ArnT&& value) {
  ...
  template <typename WorkflowIdT = Aws::String>
  WorkflowVersionListItem& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename VersionNameT = Aws::String>
  WorkflowVersionListItem& WithVersionName(VersionNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  WorkflowVersionListItem& WithDescription(DescriptionT&& value) {
  ...
  inline WorkflowVersionListItem& WithStatus(WorkflowStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline WorkflowVersionListItem& WithType(WorkflowType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename DigestT = Aws::String>
  WorkflowVersionListItem& WithDigest(DigestT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  WorkflowVersionListItem& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename MetadataT = Aws::Map<Aws::String, Aws::String>>
  WorkflowVersionListItem& WithMetadata(MetadataT&& value) {
