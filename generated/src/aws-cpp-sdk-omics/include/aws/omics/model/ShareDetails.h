...
class ShareDetails {
 public:
  ...
  void SetPrincipalSubscriber(PrincipalSubscriberT&& value) {
    ...
    m_principalSubscriber = std::forward<PrincipalSubscriberT>(value);
  }
  template <typename PrincipalSubscriberT = Aws::String>
  ShareDetails& WithPrincipalSubscriber(PrincipalSubscriberT&& value) {
    SetPrincipalSubscriber(std::forward<PrincipalSubscriberT>(value));
    return *this;
  }
  ///@}
  ...
  inline ShareDetails& WithStatus(ShareStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
