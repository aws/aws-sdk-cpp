...
class CreateWorkflowRequest : public OmicsRequest {
 public:
  ...
  inline CreateWorkflowRequest& WithEngine(WorkflowEngine value) {
    SetEngine(value);
    return *this;
  }
  ///@}
  ...
  void SetDefinitionZip(DefinitionZipT&& value) {
    m_definitionZipHasBeenSet = true;
    m_definitionZip = std::forward<DefinitionZipT>(value);
  }
  template <typename DefinitionZipT = Aws::Utils::ByteBuffer>
  CreateWorkflowRequest& WithDefinitionZip(DefinitionZipT&& value) {
    SetDefinitionZip(std::forward<DefinitionZipT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefinitionUri(DefinitionUriT&& value) {
    m_definitionUriHasBeenSet = true;
    m_definitionUri = std::forward<DefinitionUriT>(value);
  }
  template <typename DefinitionUriT = Aws::String>
  CreateWorkflowRequest& WithDefinitionUri(DefinitionUriT&& value) {
    SetDefinitionUri(std::forward<DefinitionUriT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateWorkflowRequest& WithStorageCapacity(int value) {
  ...
  inline CreateWorkflowRequest& WithAccelerators(Accelerators value) {
  ...
  inline CreateWorkflowRequest& WithStorageType(StorageType value) {
  ...
  void SetContainerRegistryMapUri(ContainerRegistryMapUriT&& value) {
    m_containerRegistryMapUriHasBeenSet = true;
    m_containerRegistryMapUri = std::forward<ContainerRegistryMapUriT>(value);
  }
  template <typename ContainerRegistryMapUriT = Aws::String>
  CreateWorkflowRequest& WithContainerRegistryMapUri(ContainerRegistryMapUriT&& value) {
    SetContainerRegistryMapUri(std::forward<ContainerRegistryMapUriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetParameterTemplatePath(ParameterTemplatePathT&& value) {
    m_parameterTemplatePathHasBeenSet = true;
    m_parameterTemplatePath = std::forward<ParameterTemplatePathT>(value);
  }
  template <typename ParameterTemplatePathT = Aws::String>
  CreateWorkflowRequest& WithParameterTemplatePath(ParameterTemplatePathT&& value) {
    SetParameterTemplatePath(std::forward<ParameterTemplatePathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefinitionRepository(DefinitionRepositoryT&& value) {
    m_definitionRepositoryHasBeenSet = true;
    m_definitionRepository = std::forward<DefinitionRepositoryT>(value);
  }
  template <typename DefinitionRepositoryT = DefinitionRepository>
  CreateWorkflowRequest& WithDefinitionRepository(DefinitionRepositoryT&& value) {
    SetDefinitionRepository(std::forward<DefinitionRepositoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorkflowBucketOwnerId(WorkflowBucketOwnerIdT&& value) {
    ...
    m_workflowBucketOwnerId = std::forward<WorkflowBucketOwnerIdT>(value);
  }
  template <typename WorkflowBucketOwnerIdT = Aws::String>
  CreateWorkflowRequest& WithWorkflowBucketOwnerId(WorkflowBucketOwnerIdT&& value) {
    SetWorkflowBucketOwnerId(std::forward<WorkflowBucketOwnerIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReadmeUri(ReadmeUriT&& value) {
    m_readmeUriHasBeenSet = true;
    m_readmeUri = std::forward<ReadmeUriT>(value);
  }
  template <typename ReadmeUriT = Aws::String>
  CreateWorkflowRequest& WithReadmeUri(ReadmeUriT&& value) {
    SetReadmeUri(std::forward<ReadmeUriT>(value));
    return *this;
  }
  ///@}
 private:
