...
class RunGroupListItem {
 public:
  ...
  inline RunGroupListItem& WithMaxCpus(int value) {
    SetMaxCpus(value);
    return *this;
  }
  ///@}
  ...
  inline RunGroupListItem& WithMaxRuns(int value) {
    SetMaxRuns(value);
    return *this;
  }
  ///@}
  ...
  inline RunGroupListItem& WithMaxDuration(int value) {
  ...
  inline RunGroupListItem& WithMaxGpus(int value) {
    SetMaxGpus(value);
    return *this;
  }
  ///@}
