...
namespace Model
{
  ...
  public:
    ...
    inline CreateRunGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateRunGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateRunGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
