...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    CreateRunGroupResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    CreateRunGroupResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreateRunGroupResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    CreateRunGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
