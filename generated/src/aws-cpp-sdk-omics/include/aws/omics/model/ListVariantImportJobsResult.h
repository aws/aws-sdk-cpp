...
class ListVariantImportJobsResult {
 public:
  ...
  void SetVariantImportJobs(VariantImportJobsT&& value) {
    m_variantImportJobsHasBeenSet = true;
    m_variantImportJobs = std::forward<VariantImportJobsT>(value);
  }
  template <typename VariantImportJobsT = Aws::Vector<VariantImportJobItem>>
  ListVariantImportJobsResult& WithVariantImportJobs(VariantImportJobsT&& value) {
    SetVariantImportJobs(std::forward<VariantImportJobsT>(value));
    return *this;
  }
  template <typename VariantImportJobsT = VariantImportJobItem>
  ListVariantImportJobsResult& AddVariantImportJobs(VariantImportJobsT&& value) {
    m_variantImportJobsHasBeenSet = true;
    m_variantImportJobs.emplace_back(std::forward<VariantImportJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVariantImportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVariantImportJobsResult& WithRequestId(RequestIdT&& value) {
