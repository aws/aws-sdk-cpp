...
class ListReadSetActivationJobsRequest : public OmicsRequest {
 public:
  ...
  template <typename SequenceStoreIdT = Aws::String>
  ListReadSetActivationJobsRequest& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  inline ListReadSetActivationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReadSetActivationJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = ActivateReadSetFilter>
  ListReadSetActivationJobsRequest& WithFilter(FilterT&& value) {
