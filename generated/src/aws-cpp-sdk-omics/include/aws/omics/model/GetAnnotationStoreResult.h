...
class GetAnnotationStoreResult {
 public:
  ...
  inline GetAnnotationStoreResult& WithStatus(StoreStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetStoreArn(StoreArnT&& value) {
    ...
    m_storeArn = std::forward<StoreArnT>(value);
  }
  template <typename StoreArnT = Aws::String>
  GetAnnotationStoreResult& WithStoreArn(StoreArnT&& value) {
    SetStoreArn(std::forward<StoreArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStoreOptions(StoreOptionsT&& value) {
    ...
    m_storeOptions = std::forward<StoreOptionsT>(value);
  }
  template <typename StoreOptionsT = StoreOptions>
  GetAnnotationStoreResult& WithStoreOptions(StoreOptionsT&& value) {
    SetStoreOptions(std::forward<StoreOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStoreFormat(StoreFormat value) {
    m_storeFormatHasBeenSet = true;
    m_storeFormat = value;
  }
  inline GetAnnotationStoreResult& WithStoreFormat(StoreFormat value) {
  ...
  inline void SetStoreSizeBytes(long long value) {
    m_storeSizeBytesHasBeenSet = true;
    m_storeSizeBytes = value;
  }
  inline GetAnnotationStoreResult& WithStoreSizeBytes(long long value) {
    SetStoreSizeBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumVersions(int value) {
    m_numVersionsHasBeenSet = true;
    m_numVersions = value;
  }
  inline GetAnnotationStoreResult& WithNumVersions(int value) {
    SetNumVersions(value);
    return *this;
  }
  ///@}
