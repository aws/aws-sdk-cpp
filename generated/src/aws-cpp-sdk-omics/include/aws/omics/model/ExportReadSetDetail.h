...
class ExportReadSetDetail {
 public:
  ...
  template <typename IdT = Aws::String>
  ExportReadSetDetail& WithId(IdT&& value) {
  ...
  inline void SetStatus(ReadSetExportJobItemStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ExportReadSetDetail& WithStatus(ReadSetExportJobItemStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  ExportReadSetDetail& WithStatusMessage(StatusMessageT&& value) {
