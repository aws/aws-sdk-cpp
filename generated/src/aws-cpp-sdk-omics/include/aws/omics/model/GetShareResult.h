...
class GetShareResult {
 public:
  ...
  void SetShare(ShareT&& value) {
    m_shareHasBeenSet = true;
    m_share = std::forward<ShareT>(value);
  }
  template <typename ShareT = ShareDetails>
  GetShareResult& WithShare(ShareT&& value) {
    SetShare(std::forward<ShareT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetShareResult& WithRequestId(RequestIdT&& value) {
