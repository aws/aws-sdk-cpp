...
class ReferenceFilter {
 public:
  ...
  template <typename NameT = Aws::String>
  ReferenceFilter& WithName(NameT&& value) {
  ...
  void SetMd5(Md5T&& value) {
    ...
    m_md5 = std::forward<Md5T>(value);
  }
  template <typename Md5T = Aws::String>
  ReferenceFilter& WithMd5(Md5T&& value) {
    SetMd5(std::forward<Md5T>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  ReferenceFilter& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  ReferenceFilter& WithCreatedBefore(CreatedBeforeT&& value) {
