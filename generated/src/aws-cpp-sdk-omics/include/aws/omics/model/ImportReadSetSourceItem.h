...
class ImportReadSetSourceItem {
 public:
  ...
  template <typename SourceFilesT = SourceFiles>
  ImportReadSetSourceItem& WithSourceFiles(SourceFilesT&& value) {
  ...
  inline ImportReadSetSourceItem& WithSourceFileType(FileType value) {
  ...
  inline void SetStatus(ReadSetImportJobItemStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ImportReadSetSourceItem& WithStatus(ReadSetImportJobItemStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  ImportReadSetSourceItem& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename SubjectIdT = Aws::String>
  ImportReadSetSourceItem& WithSubjectId(SubjectIdT&& value) {
  ...
  template <typename SampleIdT = Aws::String>
  ImportReadSetSourceItem& WithSampleId(SampleIdT&& value) {
  ...
  template <typename GeneratedFromT = Aws::String>
  ImportReadSetSourceItem& WithGeneratedFrom(GeneratedFromT&& value) {
  ...
  template <typename ReferenceArnT = Aws::String>
  ImportReadSetSourceItem& WithReferenceArn(ReferenceArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  ImportReadSetSourceItem& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ImportReadSetSourceItem& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ImportReadSetSourceItem& WithTags(TagsT&& value) {
  ...
  template <typename ReadSetIdT = Aws::String>
  ImportReadSetSourceItem& WithReadSetId(ReadSetIdT&& value) {
