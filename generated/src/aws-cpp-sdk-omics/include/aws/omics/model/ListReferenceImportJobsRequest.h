...
class ListReferenceImportJobsRequest : public OmicsRequest {
 public:
  ...
  inline ListReferenceImportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReferenceImportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ReferenceStoreIdT = Aws::String>
  ListReferenceImportJobsRequest& WithReferenceStoreId(ReferenceStoreIdT&& value) {
  ...
  template <typename FilterT = ImportReferenceFilter>
  ListReferenceImportJobsRequest& WithFilter(FilterT&& value) {
