...
class ListVariantStoresRequest : public OmicsRequest {
 public:
  ...
  inline ListVariantStoresRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdsT = Aws::Vector<Aws::String>>
  ListVariantStoresRequest& WithIds(IdsT&& value) {
    SetIds(std::forward<IdsT>(value));
    return *this;
  }
  template <typename IdsT = Aws::String>
  ListVariantStoresRequest& AddIds(IdsT&& value) {
    m_idsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListVariantStoresRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FilterT = ListVariantStoresFilter>
  ListVariantStoresRequest& WithFilter(FilterT&& value) {
