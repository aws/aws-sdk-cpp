...
class GetReadSetActivationJobResult {
 public:
  ...
  template <typename IdT = Aws::String>
  GetReadSetActivationJobResult& WithId(IdT&& value) {
  ...
  template <typename SequenceStoreIdT = Aws::String>
  GetReadSetActivationJobResult& WithSequenceStoreId(SequenceStoreIdT&& value) {
  ...
  inline GetReadSetActivationJobResult& WithStatus(ReadSetActivationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  GetReadSetActivationJobResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetReadSetActivationJobResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename CompletionTimeT = Aws::Utils::DateTime>
  GetReadSetActivationJobResult& WithCompletionTime(CompletionTimeT&& value) {
  ...
  template <typename SourcesT = Aws::Vector<ActivateReadSetSourceItem>>
  GetReadSetActivationJobResult& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = ActivateReadSetSourceItem>
  GetReadSetActivationJobResult& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetReadSetActivationJobResult& WithRequestId(RequestIdT&& value) {
