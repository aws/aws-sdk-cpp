...
DefinitionRepository::DefinitionRepository(JsonView jsonValue) { *this = jsonValue; }
...
DefinitionRepository& DefinitionRepository::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("excludeFilePatterns")) {
    ...
    for (unsigned excludeFilePatternsIndex = 0; excludeFilePatternsIndex < excludeFilePatternsJsonList.GetLength();
         ++excludeFilePatternsIndex) {
