...
GetWorkflowVersionResult::GetWorkflowVersionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetWorkflowVersionResult& GetWorkflowVersionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("workflowBucketOwnerId")) {
