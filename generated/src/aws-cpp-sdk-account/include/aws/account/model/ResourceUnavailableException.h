...
/**
 * <p>The operation failed because it specified a resource that is not currently
 * available.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/account-2021-02-01/ResourceUnavailableException">AWS
 * API Reference</a></p>
 */
class ResourceUnavailableException {
 public:
  AWS_ACCOUNT_API ResourceUnavailableException() = default;
  AWS_ACCOUNT_API ResourceUnavailableException(Aws::Utils::Json::JsonView jsonValue);
  AWS_ACCOUNT_API ResourceUnavailableException& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ErrorTypeT = Aws::String>
  ResourceUnavailableException& WithErrorType(ErrorTypeT&& value) {
