...
namespace Model
{
  ...
  {
  public:
    AWS_ACCOUNT_API StartPrimaryEmailUpdateRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    StartPrimaryEmailUpdateRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PrimaryEmailT = Aws::String>
    StartPrimaryEmailUpdateRequest& WithPrimaryEmail(PrimaryEmailT&& value) { SetPrimaryEmail(std::forward<PrimaryEmailT>(value)); return *this;}
    ///@}
  private:
