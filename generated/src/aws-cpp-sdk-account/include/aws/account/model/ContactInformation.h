...
class ContactInformation {
 public:
  ...
  void SetAddressLine3(AddressLine3T&& value) {
    ...
    m_addressLine3 = std::forward<AddressLine3T>(value);
  }
  template <typename AddressLine3T = Aws::String>
  ContactInformation& WithAddressLine3(AddressLine3T&& value) {
    SetAddressLine3(std::forward<AddressLine3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetDistrictOrCounty(DistrictOrCountyT&& value) {
    ...
    m_districtOrCounty = std::forward<DistrictOrCountyT>(value);
  }
  template <typename DistrictOrCountyT = Aws::String>
  ContactInformation& WithDistrictOrCounty(DistrictOrCountyT&& value) {
    SetDistrictOrCounty(std::forward<DistrictOrCountyT>(value));
    return *this;
  }
  ///@}
