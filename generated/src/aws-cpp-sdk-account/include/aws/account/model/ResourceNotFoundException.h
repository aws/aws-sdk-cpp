...
namespace Model
{
  ...
  /**
   * <p>The operation failed because it specified a resource that can't be
   * found.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/account-2021-02-01/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_ACCOUNT_API ResourceNotFoundException() = default;
    AWS_ACCOUNT_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_ACCOUNT_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename ErrorTypeT = Aws::String>
    ResourceNotFoundException& WithErrorType(ErrorTypeT&& value) { SetErrorType(std::forward<ErrorTypeT>(value)); return *this;}
    ///@}
