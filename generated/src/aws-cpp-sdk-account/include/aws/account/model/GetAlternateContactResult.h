...
class GetAlternateContactResult {
 public:
  ...
  void SetAlternateContact(AlternateContactT&& value) {
    m_alternateContactHasBeenSet = true;
    m_alternateContact = std::forward<AlternateContactT>(value);
  }
  template <typename AlternateContactT = AlternateContact>
  GetAlternateContactResult& WithAlternateContact(AlternateContactT&& value) {
    SetAlternateContact(std::forward<AlternateContactT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAlternateContactResult& WithRequestId(RequestIdT&& value) {
