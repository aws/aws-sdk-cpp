...
namespace Model
{
  ...
  {
  public:
    AWS_ACCOUNT_API GetContactInformationRequest() = default;
    ...
    template<typename AccountIdT = Aws::String>
    GetContactInformationRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
  private:
