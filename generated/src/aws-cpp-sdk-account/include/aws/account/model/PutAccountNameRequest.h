...
namespace Model
{
  ...
  public:
    ...
    template<typename AccountIdT = Aws::String>
    PutAccountNameRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AccountNameT = Aws::String>
    PutAccountNameRequest& WithAccountName(AccountNameT&& value) { SetAccountName(std::forward<AccountNameT>(value)); return *this;}
    ///@}
  private:
