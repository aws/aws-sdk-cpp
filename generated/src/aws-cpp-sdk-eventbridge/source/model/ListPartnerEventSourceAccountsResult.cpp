...
ListPartnerEventSourceAccountsResult& ListPartnerEventSourceAccountsResult::operator=(
  ...
  if (jsonValue.ValueExists("PartnerEventSourceAccounts")) {
    ...
    for (unsigned partnerEventSourceAccountsIndex = 0; partnerEventSourceAccountsIndex < partnerEventSourceAccountsJsonList.GetLength();
         ++partnerEventSourceAccountsIndex) {
