...
HttpParameters::HttpParameters(JsonView jsonValue) { *this = jsonValue; }
...
HttpParameters& HttpParameters::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("PathParameterValues")) {
    ...
    for (unsigned pathParameterValuesIndex = 0; pathParameterValuesIndex < pathParameterValuesJsonList.GetLength();
         ++pathParameterValuesIndex) {
