...
class AWS_EVENTBRIDGE_API EventBridgeClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  EventBridgeClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<EventBridgeEndpointProviderBase> endpointProvider = nullptr,
      const Aws::EventBridge::EventBridgeClientConfiguration& clientConfiguration = Aws::EventBridge::EventBridgeClientConfiguration());
   ...
   */
  template <typename UpdateEventBusRequestT = Model::UpdateEventBusRequest>
  void UpdateEventBusAsync(const UpdateEventBusResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const UpdateEventBusRequestT& request = {}) const {
