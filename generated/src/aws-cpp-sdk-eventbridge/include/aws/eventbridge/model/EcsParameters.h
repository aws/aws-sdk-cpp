...
class EcsParameters {
 public:
  ...
  inline EcsParameters& WithTaskCount(int value) {
    SetTaskCount(value);
    return *this;
  }
  ///@}
  ...
  inline EcsParameters& WithLaunchType(LaunchType value) {
    SetLaunchType(value);
    return *this;
  }
  ///@}
  ...
  inline EcsParameters& WithEnableECSManagedTags(bool value) {
  ...
  inline EcsParameters& WithEnableExecuteCommand(bool value) {
  ...
  inline EcsParameters& WithPropagateTags(PropagateTags value) {
