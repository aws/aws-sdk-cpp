...
class LogConfig {
 public:
  ...
  inline void SetIncludeDetail(IncludeDetail value) {
    m_includeDetailHasBeenSet = true;
    m_includeDetail = value;
  }
  inline LogConfig& WithIncludeDetail(IncludeDetail value) {
    SetIncludeDetail(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLevel(Level value) {
    m_levelHasBeenSet = true;
    m_level = value;
  }
  inline LogConfig& WithLevel(Level value) {
    SetLevel(value);
    return *this;
  }
  ///@}
