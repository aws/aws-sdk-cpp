...
namespace Model
{
  ...
  {
  public:
    AWS_EVENTBRIDGE_API PutRuleRequest();
     ...
     * management events from Amazon Web Services services</a> in the <i>Amazon
     * EventBridge User Guide</i>.</p> <p>This value is only valid for rules on the <a
