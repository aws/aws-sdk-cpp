...
class DescribeReplayResult {
 public:
  ...
  void SetReplayName(ReplayNameT&& value) {
    ...
    m_replayName = std::forward<ReplayNameT>(value);
  }
  template <typename ReplayNameT = Aws::String>
  DescribeReplayResult& WithReplayName(ReplayNameT&& value) {
    SetReplayName(std::forward<ReplayNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplayArn(ReplayArnT&& value) {
    ...
    m_replayArn = std::forward<ReplayArnT>(value);
  }
  template <typename ReplayArnT = Aws::String>
  DescribeReplayResult& WithReplayArn(ReplayArnT&& value) {
    SetReplayArn(std::forward<ReplayArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(ReplayState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline DescribeReplayResult& WithState(ReplayState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetEventStartTime(EventStartTimeT&& value) {
    ...
    m_eventStartTime = std::forward<EventStartTimeT>(value);
  }
  template <typename EventStartTimeT = Aws::Utils::DateTime>
  DescribeReplayResult& WithEventStartTime(EventStartTimeT&& value) {
    SetEventStartTime(std::forward<EventStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventEndTime(EventEndTimeT&& value) {
    ...
    m_eventEndTime = std::forward<EventEndTimeT>(value);
  }
  template <typename EventEndTimeT = Aws::Utils::DateTime>
  DescribeReplayResult& WithEventEndTime(EventEndTimeT&& value) {
    SetEventEndTime(std::forward<EventEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventLastReplayedTime(EventLastReplayedTimeT&& value) {
    ...
    m_eventLastReplayedTime = std::forward<EventLastReplayedTimeT>(value);
  }
  template <typename EventLastReplayedTimeT = Aws::Utils::DateTime>
  DescribeReplayResult& WithEventLastReplayedTime(EventLastReplayedTimeT&& value) {
    SetEventLastReplayedTime(std::forward<EventLastReplayedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplayStartTime(ReplayStartTimeT&& value) {
    ...
    m_replayStartTime = std::forward<ReplayStartTimeT>(value);
  }
  template <typename ReplayStartTimeT = Aws::Utils::DateTime>
  DescribeReplayResult& WithReplayStartTime(ReplayStartTimeT&& value) {
    SetReplayStartTime(std::forward<ReplayStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplayEndTime(ReplayEndTimeT&& value) {
    ...
    m_replayEndTime = std::forward<ReplayEndTimeT>(value);
  }
  template <typename ReplayEndTimeT = Aws::Utils::DateTime>
  DescribeReplayResult& WithReplayEndTime(ReplayEndTimeT&& value) {
    SetReplayEndTime(std::forward<ReplayEndTimeT>(value));
    return *this;
  }
  ///@}
