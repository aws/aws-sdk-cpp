...
class RunCommandParameters {
 public:
  AWS_EVENTBRIDGE_API RunCommandParameters() = default;
  ...
  void SetRunCommandTargets(RunCommandTargetsT&& value) {
    m_runCommandTargetsHasBeenSet = true;
    m_runCommandTargets = std::forward<RunCommandTargetsT>(value);
  }
  template <typename RunCommandTargetsT = Aws::Vector<RunCommandTarget>>
  RunCommandParameters& WithRunCommandTargets(RunCommandTargetsT&& value) {
    SetRunCommandTargets(std::forward<RunCommandTargetsT>(value));
    return *this;
  }
  template <typename RunCommandTargetsT = RunCommandTarget>
  RunCommandParameters& AddRunCommandTargets(RunCommandTargetsT&& value) {
    m_runCommandTargetsHasBeenSet = true;
    m_runCommandTargets.emplace_back(std::forward<RunCommandTargetsT>(value));
    return *this;
  }
  ///@}
 private:
