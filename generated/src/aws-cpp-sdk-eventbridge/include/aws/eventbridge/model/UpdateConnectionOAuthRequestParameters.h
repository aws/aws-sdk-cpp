...
class UpdateConnectionOAuthRequestParameters {
 public:
  ...
  template <typename ClientParametersT = UpdateConnectionOAuthClientRequestParameters>
  UpdateConnectionOAuthRequestParameters& WithClientParameters(ClientParametersT&& value) {
  ...
  template <typename AuthorizationEndpointT = Aws::String>
  UpdateConnectionOAuthRequestParameters& WithAuthorizationEndpoint(AuthorizationEndpointT&& value) {
  ...
  inline UpdateConnectionOAuthRequestParameters& WithHttpMethod(ConnectionOAuthHttpMethod value) {
    SetHttpMethod(value);
    return *this;
  }
  ///@}
  ...
  template <typename OAuthHttpParametersT = ConnectionHttpParameters>
  UpdateConnectionOAuthRequestParameters& WithOAuthHttpParameters(OAuthHttpParametersT&& value) {
