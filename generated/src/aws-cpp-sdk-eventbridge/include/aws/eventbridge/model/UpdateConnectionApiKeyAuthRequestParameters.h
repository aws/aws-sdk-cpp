...
class UpdateConnectionApiKeyAuthRequestParameters {
 public:
  AWS_EVENTBRIDGE_API UpdateConnectionApiKeyAuthRequestParameters() = default;
  ...
  template <typename ApiKeyNameT = Aws::String>
  UpdateConnectionApiKeyAuthRequestParameters& WithApiKeyName(ApiKeyNameT&& value) {
  ...
  template <typename ApiKeyValueT = Aws::String>
  UpdateConnectionApiKeyAuthRequestParameters& WithApiKeyValue(ApiKeyValueT&& value) {
