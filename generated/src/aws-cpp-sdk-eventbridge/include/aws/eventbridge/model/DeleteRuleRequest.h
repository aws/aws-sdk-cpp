...
/**
 */
class DeleteRuleRequest : public EventBridgeRequest {
 public:
  AWS_EVENTBRIDGE_API DeleteRuleRequest() = default;
  ...
  template <typename NameT = Aws::String>
  DeleteRuleRequest& WithName(NameT&& value) {
  ...
  template <typename EventBusNameT = Aws::String>
  DeleteRuleRequest& WithEventBusName(EventBusNameT&& value) {
  ...
  inline DeleteRuleRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
