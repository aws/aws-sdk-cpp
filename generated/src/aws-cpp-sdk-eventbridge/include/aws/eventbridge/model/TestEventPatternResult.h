...
class TestEventPatternResult {
 public:
  AWS_EVENTBRIDGE_API TestEventPatternResult() = default;
  ...
  inline TestEventPatternResult& WithResult(bool value) {
    SetResult(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  TestEventPatternResult& WithRequestId(RequestIdT&& value) {
