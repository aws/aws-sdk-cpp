...
class ListRuleNamesByTargetRequest : public EventBridgeRequest {
 public:
  ...
  template <typename TargetArnT = Aws::String>
  ListRuleNamesByTargetRequest& WithTargetArn(TargetArnT&& value) {
  ...
  template <typename EventBusNameT = Aws::String>
  ListRuleNamesByTargetRequest& WithEventBusName(EventBusNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRuleNamesByTargetRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRuleNamesByTargetRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
