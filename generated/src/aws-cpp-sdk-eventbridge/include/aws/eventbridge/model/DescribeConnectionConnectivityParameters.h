...
class DescribeConnectionConnectivityParameters {
 public:
  ...
  void SetResourceParameters(ResourceParametersT&& value) {
    m_resourceParametersHasBeenSet = true;
    m_resourceParameters = std::forward<ResourceParametersT>(value);
  }
  template <typename ResourceParametersT = DescribeConnectionResourceParameters>
  DescribeConnectionConnectivityParameters& WithResourceParameters(ResourceParametersT&& value) {
    SetResourceParameters(std::forward<ResourceParametersT>(value));
    return *this;
  }
  ///@}
 private:
