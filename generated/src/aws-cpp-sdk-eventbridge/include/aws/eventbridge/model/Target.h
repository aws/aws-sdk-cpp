...
class Target {
 public:
  ...
  void SetInputTransformer(InputTransformerT&& value) {
    ...
    m_inputTransformer = std::forward<InputTransformerT>(value);
  }
  template <typename InputTransformerT = InputTransformer>
  Target& WithInputTransformer(InputTransformerT&& value) {
    SetInputTransformer(std::forward<InputTransformerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRunCommandParameters(RunCommandParametersT&& value) {
    ...
    m_runCommandParameters = std::forward<RunCommandParametersT>(value);
  }
  template <typename RunCommandParametersT = RunCommandParameters>
  Target& WithRunCommandParameters(RunCommandParametersT&& value) {
    SetRunCommandParameters(std::forward<RunCommandParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBatchParameters(BatchParametersT&& value) {
    ...
    m_batchParameters = std::forward<BatchParametersT>(value);
  }
  template <typename BatchParametersT = BatchParameters>
  Target& WithBatchParameters(BatchParametersT&& value) {
    SetBatchParameters(std::forward<BatchParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftDataParameters(RedshiftDataParametersT&& value) {
    ...
    m_redshiftDataParameters = std::forward<RedshiftDataParametersT>(value);
  }
  template <typename RedshiftDataParametersT = RedshiftDataParameters>
  Target& WithRedshiftDataParameters(RedshiftDataParametersT&& value) {
    SetRedshiftDataParameters(std::forward<RedshiftDataParametersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AppSyncParametersT = AppSyncParameters>
  void SetAppSyncParameters(AppSyncParametersT&& value) {
    m_appSyncParametersHasBeenSet = true;
    m_appSyncParameters = std::forward<AppSyncParametersT>(value);
  }
  template <typename AppSyncParametersT = AppSyncParameters>
  Target& WithAppSyncParameters(AppSyncParametersT&& value) {
    SetAppSyncParameters(std::forward<AppSyncParametersT>(value));
    return *this;
  }
  ///@}
 private:
