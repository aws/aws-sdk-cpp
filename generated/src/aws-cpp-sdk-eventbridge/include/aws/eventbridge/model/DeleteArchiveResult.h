...
namespace Model
{
  ...
  {
  public:
    AWS_EVENTBRIDGE_API DeleteArchiveResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteArchiveResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
