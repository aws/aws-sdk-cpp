 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/eventbridge-2015-10-07/BatchParameters">AWS
 * API Reference</a></p>
 */
class BatchParameters {
 public:
  ...
  void SetJobDefinition(JobDefinitionT&& value) {
    ...
    m_jobDefinition = std::forward<JobDefinitionT>(value);
  }
  template <typename JobDefinitionT = Aws::String>
  BatchParameters& WithJobDefinition(JobDefinitionT&& value) {
    SetJobDefinition(std::forward<JobDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArrayProperties(ArrayPropertiesT&& value) {
    ...
    m_arrayProperties = std::forward<ArrayPropertiesT>(value);
  }
  template <typename ArrayPropertiesT = BatchArrayProperties>
  BatchParameters& WithArrayProperties(ArrayPropertiesT&& value) {
    SetArrayProperties(std::forward<ArrayPropertiesT>(value));
    return *this;
  }
  ///@}
