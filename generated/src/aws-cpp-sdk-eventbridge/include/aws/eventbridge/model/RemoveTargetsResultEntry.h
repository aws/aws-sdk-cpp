...
class RemoveTargetsResultEntry {
 public:
  ...
  template <typename TargetIdT = Aws::String>
  RemoveTargetsResultEntry& WithTargetId(TargetIdT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  RemoveTargetsResultEntry& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  RemoveTargetsResultEntry& WithErrorMessage(ErrorMessageT&& value) {
