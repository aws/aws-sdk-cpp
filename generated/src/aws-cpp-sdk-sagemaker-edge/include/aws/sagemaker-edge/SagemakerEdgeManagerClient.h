...
namespace SagemakerEdgeManager
{
   ...
   * agents.</p>
   */
  class AWS_SAGEMAKEREDGEMANAGER_API SagemakerEdgeManagerClient : Aws::Client::ClientWithAsyncTemplateMethods<SagemakerEdgeManagerClient>,
    smithy::client::AwsSmithyClientT<Aws::SagemakerEdgeManager::SERVICE_NAME,
