...
class AWS_SAGEMAKEREDGEMANAGER_API SagemakerEdgeManagerClient
 ...
 public:
   ...
   */
  SagemakerEdgeManagerClient(const Aws::SagemakerEdgeManager::SagemakerEdgeManagerClientConfiguration& clientConfiguration =
  ...
  SagemakerEdgeManagerClient(const Aws::Auth::AWSCredentials& credentials,
                             std::shared_ptr<SagemakerEdgeManagerEndpointProviderBase> endpointProvider = nullptr,
                             const Aws::SagemakerEdgeManager::SagemakerEdgeManagerClientConfiguration& clientConfiguration =
                                 Aws::SagemakerEdgeManager::SagemakerEdgeManagerClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  SagemakerEdgeManagerClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for GetDeviceRegistration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDeviceRegistration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDeviceRegistrationRequestT = Model::GetDeviceRegistrationRequest>
  void GetDeviceRegistrationAsync(const GetDeviceRegistrationRequestT& request, const GetDeviceRegistrationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SendHeartbeat that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendHeartbeatRequestT = Model::SendHeartbeatRequest>
  void SendHeartbeatAsync(const SendHeartbeatRequestT& request, const SendHeartbeatResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
