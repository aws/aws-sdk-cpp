...
class DeploymentModel {
 public:
  ...
  void SetModelHandle(ModelHandleT&& value) {
    ...
    m_modelHandle = std::forward<ModelHandleT>(value);
  }
  template <typename ModelHandleT = Aws::String>
  DeploymentModel& WithModelHandle(ModelHandleT&& value) {
    SetModelHandle(std::forward<ModelHandleT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDesiredState(ModelState value) {
    m_desiredStateHasBeenSet = true;
    m_desiredState = value;
  }
  inline DeploymentModel& WithDesiredState(ModelState value) {
  ...
  inline void SetState(ModelState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline DeploymentModel& WithState(ModelState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline DeploymentModel& WithStatus(DeploymentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRollbackFailureReason(RollbackFailureReasonT&& value) {
    ...
    m_rollbackFailureReason = std::forward<RollbackFailureReasonT>(value);
  }
  template <typename RollbackFailureReasonT = Aws::String>
  DeploymentModel& WithRollbackFailureReason(RollbackFailureReasonT&& value) {
    SetRollbackFailureReason(std::forward<RollbackFailureReasonT>(value));
    return *this;
  }
  ///@}
 private:
