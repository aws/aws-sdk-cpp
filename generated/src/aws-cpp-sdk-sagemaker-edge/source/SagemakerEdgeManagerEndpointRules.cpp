...
{
const size_t SagemakerEdgeManagerEndpointRules::RulesBlobStrLen = 3504;
const size_t SagemakerEdgeManagerEndpointRules::RulesBlobSize = 3505;
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','d','g',
'e','.','s','a','g','e','m','a','k','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','d','g','e','.','s','a','g','e',
