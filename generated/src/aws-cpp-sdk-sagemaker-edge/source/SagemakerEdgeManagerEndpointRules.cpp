...
{
const size_t SagemakerEdgeManagerEndpointRules::RulesBlobStrLen = 3486;
const size_t SagemakerEdgeManagerEndpointRules::RulesBlobSize = 3487;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','d','g','e','.','s',
'a','g','e','m','a','k','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','e','d','g','e','.','s','a','g','e','m','a','k','e','r','-','f','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','e','d','g','e','.','s','a','g','e','m','a','k','e',
...
't','p','s',':','/','/','e','d','g','e','.','s','a','g','e','m','a','k','e','r','.','{','R','e','g',
...
const char* SagemakerEdgeManagerEndpointRules::GetRulesBlob()
{
