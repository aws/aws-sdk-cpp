...
namespace Budgets
{
const size_t BudgetsEndpointRules::RulesBlobStrLen = 5174;
const size_t BudgetsEndpointRules::RulesBlobSize = 5175;
...
'e','t','s','.','g','l','o','b','a','l','.','c','s','p','.','h','c','i','.','i','c','.','g','o','v',
'"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','"','a','u','t','h','S','c','h','e',
'm','e','s','"',':','[','{','"','n','a','m','e','"',':','"','s','i','g','v','4','"',',','"','s','i',
'g','n','i','n','g','N','a','m','e','"',':','"','b','u','d','g','e','t','s','"',',','"','s','i','g',
'n','i','n','g','R','e','g','i','o','n','"',':','"','u','s','-','i','s','o','f','-','s','o','u','t',
'h','-','1','"','}',']','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','b','u','d','g','e','t','s','-','f','i','p','s',
...
'p','s',':','/','/','b','u','d','g','e','t','s','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'b','u','d','g','e','t','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
