...
namespace Budgets
{
const size_t BudgetsEndpointRules::RulesBlobStrLen = 4311;
const size_t BudgetsEndpointRules::RulesBlobSize = 4312;
...
'/','/','b','u','d','g','e','t','s','.','a','m','a','z','o','n','a','w','s','.','c','o','m','"',',',
'"','p','r','o','p','e','r','t','i','e','s','"',':','{','"','a','u','t','h','S','c','h','e','m','e',
's','"',':','[','{','"','n','a','m','e','"',':','"','s','i','g','v','4','"',',','"','s','i','g','n',
'i','n','g','N','a','m','e','"',':','"','b','u','d','g','e','t','s','"',',','"','s','i','g','n','i',
...
't','p','s',':','/','/','b','u','d','g','e','t','s','-','f','i','p','s','.','{','R','e','g','i','o',
...
'd','g','e','t','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'p','s',':','/','/','b','u','d','g','e','t','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
