...
ExpressionDimensionValues::ExpressionDimensionValues(JsonView jsonValue)
{
  *this = jsonValue;
}

ExpressionDimensionValues& ExpressionDimensionValues::operator =(JsonView jsonValue)
{
...
JsonValue ExpressionDimensionValues::Jsonize() const
{
  JsonValue payload;
