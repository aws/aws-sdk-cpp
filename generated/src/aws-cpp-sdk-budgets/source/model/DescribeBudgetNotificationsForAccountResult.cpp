...
DescribeBudgetNotificationsForAccountResult& DescribeBudgetNotificationsForAccountResult::operator=(
  ...
  if (jsonValue.ValueExists("BudgetNotificationsForAccount")) {
    ...
    for (unsigned budgetNotificationsForAccountIndex = 0;
         budgetNotificationsForAccountIndex < budgetNotificationsForAccountJsonList.GetLength(); ++budgetNotificationsForAccountIndex) {
