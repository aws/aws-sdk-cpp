...
BudgetPerformanceHistory::BudgetPerformanceHistory(JsonView jsonValue) { *this = jsonValue; }
...
BudgetPerformanceHistory& BudgetPerformanceHistory::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("BudgetedAndActualAmountsList")) {
    ...
    for (unsigned budgetedAndActualAmountsListIndex = 0;
         budgetedAndActualAmountsListIndex < budgetedAndActualAmountsListJsonList.GetLength(); ++budgetedAndActualAmountsListIndex) {
...
JsonValue BudgetPerformanceHistory::Jsonize() const {
  ...
  if (m_budgetedAndActualAmountsListHasBeenSet) {
    ...
    for (unsigned budgetedAndActualAmountsListIndex = 0;
         budgetedAndActualAmountsListIndex < budgetedAndActualAmountsListJsonList.GetLength(); ++budgetedAndActualAmountsListIndex) {
      budgetedAndActualAmountsListJsonList[budgetedAndActualAmountsListIndex].AsObject(
