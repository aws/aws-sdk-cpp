  ...
  namespace Budgets
  {
    namespace Model
    {
      namespace DimensionMapper
      {
        ...
        static const int RESERVATION_MODIFIED_HASH = HashingUtils::HashString("RESERVATION_MODIFIED");
        ...
        Dimension GetDimensionForName(const Aws::String& name)
        {
          ...
          else if (hashCode == RESERVATION_MODIFIED_HASH)
          {
            return Dimension::RESERVATION_MODIFIED;
          }
        ...
        Aws::String GetNameForDimension(Dimension enumValue)
        {
          ...
          case Dimension::RESERVATION_MODIFIED:
