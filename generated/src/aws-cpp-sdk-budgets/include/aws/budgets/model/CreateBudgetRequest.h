...
class CreateBudgetRequest : public BudgetsRequest {
 public:
  ...
  void SetNotificationsWithSubscribers(NotificationsWithSubscribersT&& value) {
    m_notificationsWithSubscribersHasBeenSet = true;
    m_notificationsWithSubscribers = std::forward<NotificationsWithSubscribersT>(value);
  }
  template <typename NotificationsWithSubscribersT = Aws::Vector<NotificationWithSubscribers>>
  CreateBudgetRequest& WithNotificationsWithSubscribers(NotificationsWithSubscribersT&& value) {
    SetNotificationsWithSubscribers(std::forward<NotificationsWithSubscribersT>(value));
    return *this;
  }
  ...
  CreateBudgetRequest& AddNotificationsWithSubscribers(NotificationsWithSubscribersT&& value) {
    m_notificationsWithSubscribersHasBeenSet = true;
    m_notificationsWithSubscribers.emplace_back(std::forward<NotificationsWithSubscribersT>(value));
    return *this;
  }
  ///@}
