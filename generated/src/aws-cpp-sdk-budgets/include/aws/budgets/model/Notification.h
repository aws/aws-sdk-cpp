...
class Notification {
 public:
  ...
  inline Notification& WithNotificationType(NotificationType value) {
  ...
  inline Notification& WithComparisonOperator(ComparisonOperator value) {
  ...
  inline Notification& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline void SetThresholdType(ThresholdType value) {
    m_thresholdTypeHasBeenSet = true;
    m_thresholdType = value;
  }
  inline Notification& WithThresholdType(ThresholdType value) {
  ...
  inline void SetNotificationState(NotificationState value) {
    m_notificationStateHasBeenSet = true;
    m_notificationState = value;
  }
  inline Notification& WithNotificationState(NotificationState value) {
