...
class ActionThreshold {
 public:
  ...
  inline void SetActionThresholdValue(double value) {
    m_actionThresholdValueHasBeenSet = true;
    m_actionThresholdValue = value;
  }
  inline ActionThreshold& WithActionThresholdValue(double value) {
    SetActionThresholdValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetActionThresholdType(ThresholdType value) {
    m_actionThresholdTypeHasBeenSet = true;
    m_actionThresholdType = value;
  }
  inline ActionThreshold& WithActionThresholdType(ThresholdType value) {
    SetActionThresholdType(value);
    return *this;
  }
  ///@}
 private:
