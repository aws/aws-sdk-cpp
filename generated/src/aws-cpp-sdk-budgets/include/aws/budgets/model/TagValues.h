...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/budgets-2016-10-20/TagValues">AWS
   * API Reference</a></p>
   */
  class TagValues
  {
  public:
    AWS_BUDGETS_API TagValues() = default;
    AWS_BUDGETS_API TagValues(Aws::Utils::Json::JsonView jsonValue);
    AWS_BUDGETS_API TagValues& operator=(Aws::Utils::Json::JsonView jsonValue);
