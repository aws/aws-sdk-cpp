...
class DescribeBudgetActionsForBudgetResult {
 public:
  ...
  template <typename ActionsT = Aws::Vector<Action>>
  DescribeBudgetActionsForBudgetResult& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = Action>
  DescribeBudgetActionsForBudgetResult& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeBudgetActionsForBudgetResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBudgetActionsForBudgetResult& WithRequestId(RequestIdT&& value) {
