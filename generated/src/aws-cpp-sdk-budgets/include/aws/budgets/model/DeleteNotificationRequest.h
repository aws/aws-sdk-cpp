...
namespace Model
{
  ...
  public:
    ...
    template<typename AccountIdT = Aws::String>
    DeleteNotificationRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BudgetNameT = Aws::String>
    DeleteNotificationRequest& WithBudgetName(BudgetNameT&& value) { SetBudgetName(std::forward<BudgetNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NotificationT = Notification>
    DeleteNotificationRequest& WithNotification(NotificationT&& value) { SetNotification(std::forward<NotificationT>(value)); return *this;}
    ///@}
  private:
