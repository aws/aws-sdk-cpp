...
class Budget {
 public:
  ...
  void SetBudgetLimit(BudgetLimitT&& value) {
    ...
    m_budgetLimit = std::forward<BudgetLimitT>(value);
  }
  template <typename BudgetLimitT = Spend>
  Budget& WithBudgetLimit(BudgetLimitT&& value) {
    SetBudgetLimit(std::forward<BudgetLimitT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlannedBudgetLimits(PlannedBudgetLimitsT&& value) {
    ...
    m_plannedBudgetLimits = std::forward<PlannedBudgetLimitsT>(value);
  }
  template <typename PlannedBudgetLimitsT = Aws::Map<Aws::String, Spend>>
  Budget& WithPlannedBudgetLimits(PlannedBudgetLimitsT&& value) {
    SetPlannedBudgetLimits(std::forward<PlannedBudgetLimitsT>(value));
    return *this;
  }
  ...
  Budget& AddPlannedBudgetLimits(PlannedBudgetLimitsKeyT&& key, PlannedBudgetLimitsValueT&& value) {
    m_plannedBudgetLimitsHasBeenSet = true;
    m_plannedBudgetLimits.emplace(std::forward<PlannedBudgetLimitsKeyT>(key), std::forward<PlannedBudgetLimitsValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline Budget& WithTimeUnit(TimeUnit value) {
    SetTimeUnit(value);
    return *this;
  }
  ///@}
  ...
  void SetCalculatedSpend(CalculatedSpendT&& value) {
    ...
    m_calculatedSpend = std::forward<CalculatedSpendT>(value);
  }
  template <typename CalculatedSpendT = CalculatedSpend>
  Budget& WithCalculatedSpend(CalculatedSpendT&& value) {
    SetCalculatedSpend(std::forward<CalculatedSpendT>(value));
    return *this;
  }
  ///@}
  ...
  inline Budget& WithBudgetType(BudgetType value) {
    SetBudgetType(value);
    return *this;
  }
  ///@}
  ...
  void SetAutoAdjustData(AutoAdjustDataT&& value) {
    ...
    m_autoAdjustData = std::forward<AutoAdjustDataT>(value);
  }
  template <typename AutoAdjustDataT = AutoAdjustData>
  Budget& WithAutoAdjustData(AutoAdjustDataT&& value) {
    SetAutoAdjustData(std::forward<AutoAdjustDataT>(value));
    return *this;
  }
  ///@}
  ...
  inline Budget& AddMetrics(Metric value) {
    m_metricsHasBeenSet = true;
