...
class UpdateBudgetActionResult {
 public:
  ...
  void SetOldAction(OldActionT&& value) {
    m_oldActionHasBeenSet = true;
    m_oldAction = std::forward<OldActionT>(value);
  }
  template <typename OldActionT = Action>
  UpdateBudgetActionResult& WithOldAction(OldActionT&& value) {
    SetOldAction(std::forward<OldActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewAction(NewActionT&& value) {
    m_newActionHasBeenSet = true;
    m_newAction = std::forward<NewActionT>(value);
  }
  template <typename NewActionT = Action>
  UpdateBudgetActionResult& WithNewAction(NewActionT&& value) {
    SetNewAction(std::forward<NewActionT>(value));
    return *this;
  }
  ///@}
