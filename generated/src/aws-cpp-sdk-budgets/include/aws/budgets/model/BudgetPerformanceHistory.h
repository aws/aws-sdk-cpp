...
class BudgetPerformanceHistory {
 public:
  ...
  inline void SetBudgetType(BudgetType value) {
    m_budgetTypeHasBeenSet = true;
    m_budgetType = value;
  }
  inline BudgetPerformanceHistory& WithBudgetType(BudgetType value) {
    SetBudgetType(value);
    return *this;
  }
  ///@}
  ...
  void SetCostFilters(CostFiltersT&& value) {
    m_costFiltersHasBeenSet = true;
    m_costFilters = std::forward<CostFiltersT>(value);
  }
  template <typename CostFiltersT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  BudgetPerformanceHistory& WithCostFilters(CostFiltersT&& value) {
    SetCostFilters(std::forward<CostFiltersT>(value));
    return *this;
  }
  ...
  BudgetPerformanceHistory& AddCostFilters(CostFiltersKeyT&& key, CostFiltersValueT&& value) {
    m_costFiltersHasBeenSet = true;
    m_costFilters.emplace(std::forward<CostFiltersKeyT>(key), std::forward<CostFiltersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCostTypes(CostTypesT&& value) {
    m_costTypesHasBeenSet = true;
    m_costTypes = std::forward<CostTypesT>(value);
  }
  template <typename CostTypesT = CostTypes>
  BudgetPerformanceHistory& WithCostTypes(CostTypesT&& value) {
    SetCostTypes(std::forward<CostTypesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTimeUnit(TimeUnit value) {
    m_timeUnitHasBeenSet = true;
    m_timeUnit = value;
  }
  inline BudgetPerformanceHistory& WithTimeUnit(TimeUnit value) {
    SetTimeUnit(value);
    return *this;
  }
  ///@}
  ...
  void SetBudgetedAndActualAmountsList(BudgetedAndActualAmountsListT&& value) {
    ...
    m_budgetedAndActualAmountsList = std::forward<BudgetedAndActualAmountsListT>(value);
  }
  template <typename BudgetedAndActualAmountsListT = Aws::Vector<BudgetedAndActualAmounts>>
  BudgetPerformanceHistory& WithBudgetedAndActualAmountsList(BudgetedAndActualAmountsListT&& value) {
    SetBudgetedAndActualAmountsList(std::forward<BudgetedAndActualAmountsListT>(value));
    return *this;
  }
  ...
  BudgetPerformanceHistory& AddBudgetedAndActualAmountsList(BudgetedAndActualAmountsListT&& value) {
    m_budgetedAndActualAmountsListHasBeenSet = true;
    m_budgetedAndActualAmountsList.emplace_back(std::forward<BudgetedAndActualAmountsListT>(value));
    return *this;
  }
  ///@}
 private:
