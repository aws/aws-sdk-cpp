...
class SsmActionDefinition {
 public:
  ...
  inline void SetActionSubType(ActionSubType value) {
    m_actionSubTypeHasBeenSet = true;
    m_actionSubType = value;
  }
  inline SsmActionDefinition& WithActionSubType(ActionSubType value) {
    SetActionSubType(value);
    return *this;
  }
  ///@}
