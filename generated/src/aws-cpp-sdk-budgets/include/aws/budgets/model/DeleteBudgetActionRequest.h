...
namespace Model
{
  ...
  public:
    ...
    template<typename AccountIdT = Aws::String>
    DeleteBudgetActionRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BudgetNameT = Aws::String>
    DeleteBudgetActionRequest& WithBudgetName(BudgetNameT&& value) { SetBudgetName(std::forward<BudgetNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionIdT = Aws::String>
    DeleteBudgetActionRequest& WithActionId(ActionIdT&& value) { SetActionId(std::forward<ActionIdT>(value)); return *this;}
    ///@}
  private:
