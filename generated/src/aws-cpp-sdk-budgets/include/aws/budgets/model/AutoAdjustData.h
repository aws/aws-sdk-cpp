...
class AutoAdjustData {
 public:
  ...
  inline void SetAutoAdjustType(AutoAdjustType value) {
    m_autoAdjustTypeHasBeenSet = true;
    m_autoAdjustType = value;
  }
  inline AutoAdjustData& WithAutoAdjustType(AutoAdjustType value) {
    SetAutoAdjustType(value);
    return *this;
  }
  ///@}
  ...
  void SetHistoricalOptions(HistoricalOptionsT&& value) {
    ...
    m_historicalOptions = std::forward<HistoricalOptionsT>(value);
  }
  template <typename HistoricalOptionsT = HistoricalOptions>
  AutoAdjustData& WithHistoricalOptions(HistoricalOptionsT&& value) {
    SetHistoricalOptions(std::forward<HistoricalOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastAutoAdjustTime(LastAutoAdjustTimeT&& value) {
    ...
    m_lastAutoAdjustTime = std::forward<LastAutoAdjustTimeT>(value);
  }
  template <typename LastAutoAdjustTimeT = Aws::Utils::DateTime>
  AutoAdjustData& WithLastAutoAdjustTime(LastAutoAdjustTimeT&& value) {
    SetLastAutoAdjustTime(std::forward<LastAutoAdjustTimeT>(value));
    return *this;
  }
  ///@}
 private:
