...
class DescribeBudgetsResult {
 public:
  ...
  template <typename BudgetsT = Aws::Vector<Budget>>
  DescribeBudgetsResult& WithBudgets(BudgetsT&& value) {
    SetBudgets(std::forward<BudgetsT>(value));
    return *this;
  }
  template <typename BudgetsT = Budget>
  DescribeBudgetsResult& AddBudgets(BudgetsT&& value) {
    m_budgetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeBudgetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBudgetsResult& WithRequestId(RequestIdT&& value) {
