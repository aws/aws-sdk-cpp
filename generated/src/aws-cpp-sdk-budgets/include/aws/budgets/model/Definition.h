...
class Definition {
 public:
  ...
  void SetIamActionDefinition(IamActionDefinitionT&& value) {
    ...
    m_iamActionDefinition = std::forward<IamActionDefinitionT>(value);
  }
  template <typename IamActionDefinitionT = IamActionDefinition>
  Definition& WithIamActionDefinition(IamActionDefinitionT&& value) {
    SetIamActionDefinition(std::forward<IamActionDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScpActionDefinition(ScpActionDefinitionT&& value) {
    ...
    m_scpActionDefinition = std::forward<ScpActionDefinitionT>(value);
  }
  template <typename ScpActionDefinitionT = ScpActionDefinition>
  Definition& WithScpActionDefinition(ScpActionDefinitionT&& value) {
    SetScpActionDefinition(std::forward<ScpActionDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSsmActionDefinition(SsmActionDefinitionT&& value) {
    ...
    m_ssmActionDefinition = std::forward<SsmActionDefinitionT>(value);
  }
  template <typename SsmActionDefinitionT = SsmActionDefinition>
  Definition& WithSsmActionDefinition(SsmActionDefinitionT&& value) {
    SetSsmActionDefinition(std::forward<SsmActionDefinitionT>(value));
    return *this;
  }
  ///@}
 private:
