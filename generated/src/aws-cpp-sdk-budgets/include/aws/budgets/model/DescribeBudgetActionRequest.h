...
class DescribeBudgetActionRequest : public BudgetsRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  DescribeBudgetActionRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename BudgetNameT = Aws::String>
  DescribeBudgetActionRequest& WithBudgetName(BudgetNameT&& value) {
  ...
  template <typename ActionIdT = Aws::String>
  DescribeBudgetActionRequest& WithActionId(ActionIdT&& value) {
