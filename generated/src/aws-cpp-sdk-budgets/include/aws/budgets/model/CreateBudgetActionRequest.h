...
class CreateBudgetActionRequest : public BudgetsRequest {
 public:
  ...
  inline CreateBudgetActionRequest& WithNotificationType(NotificationType value) {
  ...
  inline CreateBudgetActionRequest& WithActionType(ActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
  ...
  void SetActionThreshold(ActionThresholdT&& value) {
    ...
    m_actionThreshold = std::forward<ActionThresholdT>(value);
  }
  template <typename ActionThresholdT = ActionThreshold>
  CreateBudgetActionRequest& WithActionThreshold(ActionThresholdT&& value) {
    SetActionThreshold(std::forward<ActionThresholdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetApprovalModel(ApprovalModel value) {
    m_approvalModelHasBeenSet = true;
    m_approvalModel = value;
  }
  inline CreateBudgetActionRequest& WithApprovalModel(ApprovalModel value) {
    SetApprovalModel(value);
    return *this;
  }
  ///@}
