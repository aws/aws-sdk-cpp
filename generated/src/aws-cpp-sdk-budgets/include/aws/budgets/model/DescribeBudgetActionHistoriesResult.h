...
class DescribeBudgetActionHistoriesResult {
 public:
  ...
  void SetActionHistories(ActionHistoriesT&& value) {
    m_actionHistoriesHasBeenSet = true;
    m_actionHistories = std::forward<ActionHistoriesT>(value);
  }
  template <typename ActionHistoriesT = Aws::Vector<ActionHistory>>
  DescribeBudgetActionHistoriesResult& WithActionHistories(ActionHistoriesT&& value) {
    SetActionHistories(std::forward<ActionHistoriesT>(value));
    return *this;
  }
  template <typename ActionHistoriesT = ActionHistory>
  DescribeBudgetActionHistoriesResult& AddActionHistories(ActionHistoriesT&& value) {
    m_actionHistoriesHasBeenSet = true;
    m_actionHistories.emplace_back(std::forward<ActionHistoriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeBudgetActionHistoriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBudgetActionHistoriesResult& WithRequestId(RequestIdT&& value) {
