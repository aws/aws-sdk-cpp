...
class BudgetedAndActualAmounts {
 public:
  ...
  void SetBudgetedAmount(BudgetedAmountT&& value) {
    ...
    m_budgetedAmount = std::forward<BudgetedAmountT>(value);
  }
  template <typename BudgetedAmountT = Spend>
  BudgetedAndActualAmounts& WithBudgetedAmount(BudgetedAmountT&& value) {
    SetBudgetedAmount(std::forward<BudgetedAmountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActualAmount(ActualAmountT&& value) {
    ...
    m_actualAmount = std::forward<ActualAmountT>(value);
  }
  template <typename ActualAmountT = Spend>
  BudgetedAndActualAmounts& WithActualAmount(ActualAmountT&& value) {
    SetActualAmount(std::forward<ActualAmountT>(value));
    return *this;
  }
  ///@}
