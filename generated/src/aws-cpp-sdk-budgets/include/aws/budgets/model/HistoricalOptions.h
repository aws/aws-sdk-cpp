...
class HistoricalOptions {
 public:
  ...
  inline void SetBudgetAdjustmentPeriod(int value) {
    m_budgetAdjustmentPeriodHasBeenSet = true;
    m_budgetAdjustmentPeriod = value;
  }
  inline HistoricalOptions& WithBudgetAdjustmentPeriod(int value) {
    SetBudgetAdjustmentPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLookBackAvailablePeriods(int value) {
    m_lookBackAvailablePeriodsHasBeenSet = true;
    m_lookBackAvailablePeriods = value;
  }
  inline HistoricalOptions& WithLookBackAvailablePeriods(int value) {
    SetLookBackAvailablePeriods(value);
    return *this;
  }
  ///@}
 private:
