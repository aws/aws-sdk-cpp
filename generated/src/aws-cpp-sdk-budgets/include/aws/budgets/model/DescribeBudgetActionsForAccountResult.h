...
class DescribeBudgetActionsForAccountResult {
 public:
  ...
  template <typename ActionsT = Aws::Vector<Action>>
  DescribeBudgetActionsForAccountResult& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = Action>
  DescribeBudgetActionsForAccountResult& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeBudgetActionsForAccountResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBudgetActionsForAccountResult& WithRequestId(RequestIdT&& value) {
