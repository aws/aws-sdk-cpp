...
class DescribeBudgetActionsForBudgetRequest : public BudgetsRequest {
 public:
  AWS_BUDGETS_API DescribeBudgetActionsForBudgetRequest() = default;
  ...
  template <typename AccountIdT = Aws::String>
  DescribeBudgetActionsForBudgetRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename BudgetNameT = Aws::String>
  DescribeBudgetActionsForBudgetRequest& WithBudgetName(BudgetNameT&& value) {
  ...
  inline DescribeBudgetActionsForBudgetRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeBudgetActionsForBudgetRequest& WithNextToken(NextTokenT&& value) {
