...
class DescribeBudgetNotificationsForAccountRequest : public BudgetsRequest {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  DescribeBudgetNotificationsForAccountRequest& WithAccountId(AccountIdT&& value) {
  ...
  inline DescribeBudgetNotificationsForAccountRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeBudgetNotificationsForAccountRequest& WithNextToken(NextTokenT&& value) {
