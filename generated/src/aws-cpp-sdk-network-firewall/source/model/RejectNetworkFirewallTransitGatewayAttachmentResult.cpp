...
RejectNetworkFirewallTransitGatewayAttachmentResult::RejectNetworkFirewallTransitGatewayAttachmentResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

RejectNetworkFirewallTransitGatewayAttachmentResult& RejectNetworkFirewallTransitGatewayAttachmentResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
