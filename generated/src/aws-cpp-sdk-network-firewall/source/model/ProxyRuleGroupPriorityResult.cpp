...
ProxyRuleGroupPriorityResult::ProxyRuleGroupPriorityResult(JsonView jsonValue) { *this = jsonValue; }

ProxyRuleGroupPriorityResult& ProxyRuleGroupPriorityResult::operator=(JsonView jsonValue) {
...
JsonValue ProxyRuleGroupPriorityResult::Jsonize() const {
  JsonValue payload;
