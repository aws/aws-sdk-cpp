...
Aws::String DeleteProxyConfigurationRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection DeleteProxyConfigurationRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "NetworkFirewall_20201112.DeleteProxyConfiguration"));
  return headers;
}
