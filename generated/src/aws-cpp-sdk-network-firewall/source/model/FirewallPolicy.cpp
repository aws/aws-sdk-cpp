...
FirewallPolicy::FirewallPolicy(JsonView jsonValue) { *this = jsonValue; }
...
FirewallPolicy& FirewallPolicy::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("StatelessRuleGroupReferences")) {
    ...
    for (unsigned statelessRuleGroupReferencesIndex = 0;
         statelessRuleGroupReferencesIndex < statelessRuleGroupReferencesJsonList.GetLength(); ++statelessRuleGroupReferencesIndex) {
  ...
  if (jsonValue.ValueExists("StatefulRuleGroupReferences")) {
    ...
    for (unsigned statefulRuleGroupReferencesIndex = 0; statefulRuleGroupReferencesIndex < statefulRuleGroupReferencesJsonList.GetLength();
         ++statefulRuleGroupReferencesIndex) {
...
JsonValue FirewallPolicy::Jsonize() const {
  ...
  if (m_statelessRuleGroupReferencesHasBeenSet) {
    ...
    for (unsigned statelessRuleGroupReferencesIndex = 0;
         statelessRuleGroupReferencesIndex < statelessRuleGroupReferencesJsonList.GetLength(); ++statelessRuleGroupReferencesIndex) {
      statelessRuleGroupReferencesJsonList[statelessRuleGroupReferencesIndex].AsObject(
          m_statelessRuleGroupReferences[statelessRuleGroupReferencesIndex].Jsonize());
    }
  ...
  if (m_statefulRuleGroupReferencesHasBeenSet) {
    ...
    for (unsigned statefulRuleGroupReferencesIndex = 0; statefulRuleGroupReferencesIndex < statefulRuleGroupReferencesJsonList.GetLength();
         ++statefulRuleGroupReferencesIndex) {
      statefulRuleGroupReferencesJsonList[statefulRuleGroupReferencesIndex].AsObject(
          m_statefulRuleGroupReferences[statefulRuleGroupReferencesIndex].Jsonize());
    }
