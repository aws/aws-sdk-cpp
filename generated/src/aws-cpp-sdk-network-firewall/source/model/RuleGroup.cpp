...
RuleGroup::RuleGroup(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue RuleGroup::Jsonize() const {
  ...
  if (m_statefulRuleOptionsHasBeenSet) {
    payload.WithObject("StatefulRuleOptions", m_statefulRuleOptions.Jsonize());
  }
