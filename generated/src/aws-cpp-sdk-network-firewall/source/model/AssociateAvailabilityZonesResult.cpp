...
AssociateAvailabilityZonesResult::AssociateAvailabilityZonesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

AssociateAvailabilityZonesResult& AssociateAvailabilityZonesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
