...
StartFlowCaptureResult::StartFlowCaptureResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartFlowCaptureResult& StartFlowCaptureResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
