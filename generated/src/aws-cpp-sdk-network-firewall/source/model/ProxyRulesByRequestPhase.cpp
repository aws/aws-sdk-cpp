...
ProxyRulesByRequestPhase::ProxyRulesByRequestPhase(JsonView jsonValue) { *this = jsonValue; }

ProxyRulesByRequestPhase& ProxyRulesByRequestPhase::operator=(JsonView jsonValue) {
...
JsonValue ProxyRulesByRequestPhase::Jsonize() const {
  JsonValue payload;
