...
Aws::String DeleteContainerAssociationRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection DeleteContainerAssociationRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "NetworkFirewall_20201112.DeleteContainerAssociation"));
  return headers;
}
