...
FirewallStatus::FirewallStatus(JsonView jsonValue) { *this = jsonValue; }
...
FirewallStatus& FirewallStatus::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ConfigurationSyncStateSummary")) {
    m_configurationSyncStateSummary =
        ConfigurationSyncStateMapper::GetConfigurationSyncStateForName(jsonValue.GetString("ConfigurationSyncStateSummary"));
...
JsonValue FirewallStatus::Jsonize() const {
  ...
  if (m_configurationSyncStateSummaryHasBeenSet) {
    payload.WithString("ConfigurationSyncStateSummary",
                       ConfigurationSyncStateMapper::GetNameForConfigurationSyncState(m_configurationSyncStateSummary));
  }
