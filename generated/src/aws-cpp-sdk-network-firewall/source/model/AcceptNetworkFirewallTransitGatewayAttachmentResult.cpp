...
AcceptNetworkFirewallTransitGatewayAttachmentResult::AcceptNetworkFirewallTransitGatewayAttachmentResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

AcceptNetworkFirewallTransitGatewayAttachmentResult& AcceptNetworkFirewallTransitGatewayAttachmentResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
