...
TransitGatewayAttachmentSyncState::TransitGatewayAttachmentSyncState(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue TransitGatewayAttachmentSyncState::Jsonize() const {
  ...
  if (m_transitGatewayAttachmentStatusHasBeenSet) {
    payload.WithString("TransitGatewayAttachmentStatus",
                       TransitGatewayAttachmentStatusMapper::GetNameForTransitGatewayAttachmentStatus(m_transitGatewayAttachmentStatus));
  }
