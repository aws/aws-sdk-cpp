...
TLSInspectionConfigurationResponse::TLSInspectionConfigurationResponse(JsonView jsonValue) { *this = jsonValue; }
...
TLSInspectionConfigurationResponse& TLSInspectionConfigurationResponse::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TLSInspectionConfigurationStatus")) {
    m_tLSInspectionConfigurationStatus =
        ResourceStatusMapper::GetResourceStatusForName(jsonValue.GetString("TLSInspectionConfigurationStatus"));
...
JsonValue TLSInspectionConfigurationResponse::Jsonize() const {
  ...
  if (m_tLSInspectionConfigurationStatusHasBeenSet) {
    payload.WithString("TLSInspectionConfigurationStatus",
                       ResourceStatusMapper::GetNameForResourceStatus(m_tLSInspectionConfigurationStatus));
  }
