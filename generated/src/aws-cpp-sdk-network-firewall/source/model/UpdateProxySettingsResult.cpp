...
UpdateProxySettingsResult::UpdateProxySettingsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateProxySettingsResult& UpdateProxySettingsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
