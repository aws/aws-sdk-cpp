...
Aws::String UpdateProxyRuleGroupPrioritiesRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection UpdateProxyRuleGroupPrioritiesRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "NetworkFirewall_20201112.UpdateProxyRuleGroupPriorities"));
  return headers;
}
