...
class ListFlowOperationsResult {
 public:
  ...
  void SetFlowOperations(FlowOperationsT&& value) {
    m_flowOperationsHasBeenSet = true;
    m_flowOperations = std::forward<FlowOperationsT>(value);
  }
  template <typename FlowOperationsT = Aws::Vector<FlowOperationMetadata>>
  ListFlowOperationsResult& WithFlowOperations(FlowOperationsT&& value) {
    SetFlowOperations(std::forward<FlowOperationsT>(value));
    return *this;
  }
  template <typename FlowOperationsT = FlowOperationMetadata>
  ListFlowOperationsResult& AddFlowOperations(FlowOperationsT&& value) {
    m_flowOperationsHasBeenSet = true;
    m_flowOperations.emplace_back(std::forward<FlowOperationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFlowOperationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFlowOperationsResult& WithRequestId(RequestIdT&& value) {
