...
namespace Model {
class CreateContainerAssociationResult {
 public:
  AWS_NETWORKFIREWALL_API CreateContainerAssociationResult() = default;
  AWS_NETWORKFIREWALL_API CreateContainerAssociationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API CreateContainerAssociationResult& operator=(
  ...
  template <typename ContainerAssociationNameT = Aws::String>
  CreateContainerAssociationResult& WithContainerAssociationName(ContainerAssociationNameT&& value) {
  ...
  template <typename ContainerAssociationArnT = Aws::String>
  CreateContainerAssociationResult& WithContainerAssociationArn(ContainerAssociationArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateContainerAssociationResult& WithDescription(DescriptionT&& value) {
  ...
  inline CreateContainerAssociationResult& WithType(ContainerMonitoringType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ContainerMonitoringConfigurationsT = Aws::Vector<ContainerMonitoringConfiguration>>
  CreateContainerAssociationResult& WithContainerMonitoringConfigurations(ContainerMonitoringConfigurationsT&& value) {
  ...
  CreateContainerAssociationResult& AddContainerMonitoringConfigurations(ContainerMonitoringConfigurationsT&& value) {
    m_containerMonitoringConfigurationsHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>The current status of the container association. For a new container
   * association, the status is <code>CREATING</code>.</p>
   */
  ...
  inline CreateContainerAssociationResult& WithStatus(ContainerAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateContainerAssociationResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateContainerAssociationResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateContainerAssociationResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateContainerAssociationResult& WithRequestId(RequestIdT&& value) {
