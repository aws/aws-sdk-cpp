...
class DeleteVpcEndpointAssociationResult {
 public:
  ...
  AWS_NETWORKFIREWALL_API DeleteVpcEndpointAssociationResult& operator=(
  ...
  template <typename VpcEndpointAssociationT = VpcEndpointAssociation>
  DeleteVpcEndpointAssociationResult& WithVpcEndpointAssociation(VpcEndpointAssociationT&& value) {
  ...
  template <typename VpcEndpointAssociationStatusT = VpcEndpointAssociationStatus>
  DeleteVpcEndpointAssociationResult& WithVpcEndpointAssociationStatus(VpcEndpointAssociationStatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteVpcEndpointAssociationResult& WithRequestId(RequestIdT&& value) {
