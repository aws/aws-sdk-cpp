...
class Firewall {
 public:
  ...
  inline Firewall& WithDeleteProtection(bool value) {
  ...
  inline Firewall& WithSubnetChangeProtection(bool value) {
  ...
  inline Firewall& WithFirewallPolicyChangeProtection(bool value) {
  ...
  inline Firewall& WithNumberOfAssociations(int value) {
  ...
  inline Firewall& AddEnabledAnalysisTypes(EnabledAnalysisType value) {
    m_enabledAnalysisTypesHasBeenSet = true;
  ...
  void SetTransitGatewayOwnerAccountId(TransitGatewayOwnerAccountIdT&& value) {
    ...
    m_transitGatewayOwnerAccountId = std::forward<TransitGatewayOwnerAccountIdT>(value);
  }
  template <typename TransitGatewayOwnerAccountIdT = Aws::String>
  Firewall& WithTransitGatewayOwnerAccountId(TransitGatewayOwnerAccountIdT&& value) {
    SetTransitGatewayOwnerAccountId(std::forward<TransitGatewayOwnerAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline Firewall& WithAvailabilityZoneChangeProtection(bool value) {
