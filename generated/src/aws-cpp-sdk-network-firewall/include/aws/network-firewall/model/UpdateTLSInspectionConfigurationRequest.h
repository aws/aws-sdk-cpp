...
class UpdateTLSInspectionConfigurationRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename TLSInspectionConfigurationArnT = Aws::String>
  UpdateTLSInspectionConfigurationRequest& WithTLSInspectionConfigurationArn(TLSInspectionConfigurationArnT&& value) {
  ...
  template <typename TLSInspectionConfigurationNameT = Aws::String>
  UpdateTLSInspectionConfigurationRequest& WithTLSInspectionConfigurationName(TLSInspectionConfigurationNameT&& value) {
  ...
  template <typename TLSInspectionConfigurationT = TLSInspectionConfiguration>
  UpdateTLSInspectionConfigurationRequest& WithTLSInspectionConfiguration(TLSInspectionConfigurationT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateTLSInspectionConfigurationRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename EncryptionConfigurationT = EncryptionConfiguration>
  UpdateTLSInspectionConfigurationRequest& WithEncryptionConfiguration(EncryptionConfigurationT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateTLSInspectionConfigurationRequest& WithUpdateToken(UpdateTokenT&& value) {
