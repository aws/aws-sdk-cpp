...
class TLSInspectionConfigurationResponse {
 public:
  ...
  void SetTLSInspectionConfigurationArn(TLSInspectionConfigurationArnT&& value) {
    ...
    m_tLSInspectionConfigurationArn = std::forward<TLSInspectionConfigurationArnT>(value);
  }
  template <typename TLSInspectionConfigurationArnT = Aws::String>
  TLSInspectionConfigurationResponse& WithTLSInspectionConfigurationArn(TLSInspectionConfigurationArnT&& value) {
    SetTLSInspectionConfigurationArn(std::forward<TLSInspectionConfigurationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTLSInspectionConfigurationName(TLSInspectionConfigurationNameT&& value) {
    m_tLSInspectionConfigurationNameHasBeenSet = true;
    m_tLSInspectionConfigurationName = std::forward<TLSInspectionConfigurationNameT>(value);
  }
  template <typename TLSInspectionConfigurationNameT = Aws::String>
  TLSInspectionConfigurationResponse& WithTLSInspectionConfigurationName(TLSInspectionConfigurationNameT&& value) {
    SetTLSInspectionConfigurationName(std::forward<TLSInspectionConfigurationNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTLSInspectionConfigurationId(TLSInspectionConfigurationIdT&& value) {
    m_tLSInspectionConfigurationIdHasBeenSet = true;
    m_tLSInspectionConfigurationId = std::forward<TLSInspectionConfigurationIdT>(value);
  }
  template <typename TLSInspectionConfigurationIdT = Aws::String>
  TLSInspectionConfigurationResponse& WithTLSInspectionConfigurationId(TLSInspectionConfigurationIdT&& value) {
    SetTLSInspectionConfigurationId(std::forward<TLSInspectionConfigurationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTLSInspectionConfigurationStatus(ResourceStatus value) {
    m_tLSInspectionConfigurationStatusHasBeenSet = true;
    m_tLSInspectionConfigurationStatus = value;
  }
  inline TLSInspectionConfigurationResponse& WithTLSInspectionConfigurationStatus(ResourceStatus value) {
    SetTLSInspectionConfigurationStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  TLSInspectionConfigurationResponse& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  TLSInspectionConfigurationResponse& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  TLSInspectionConfigurationResponse& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  TLSInspectionConfigurationResponse& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  inline void SetNumberOfAssociations(int value) {
    m_numberOfAssociationsHasBeenSet = true;
    m_numberOfAssociations = value;
  }
  inline TLSInspectionConfigurationResponse& WithNumberOfAssociations(int value) {
    SetNumberOfAssociations(value);
    return *this;
  }
  ///@}
  ...
  template <typename EncryptionConfigurationT = EncryptionConfiguration>
  TLSInspectionConfigurationResponse& WithEncryptionConfiguration(EncryptionConfigurationT&& value) {
  ...
  template <typename CertificatesT = Aws::Vector<TlsCertificateData>>
  TLSInspectionConfigurationResponse& WithCertificates(CertificatesT&& value) {
    SetCertificates(std::forward<CertificatesT>(value));
    return *this;
  }
  template <typename CertificatesT = TlsCertificateData>
  TLSInspectionConfigurationResponse& AddCertificates(CertificatesT&& value) {
    m_certificatesHasBeenSet = true;
  ...
  template <typename CertificateAuthorityT = TlsCertificateData>
  TLSInspectionConfigurationResponse& WithCertificateAuthority(CertificateAuthorityT&& value) {
