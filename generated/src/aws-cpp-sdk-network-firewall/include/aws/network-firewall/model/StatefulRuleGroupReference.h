...
class StatefulRuleGroupReference {
 public:
  ...
  inline StatefulRuleGroupReference& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeepThreatInspection(bool value) {
    m_deepThreatInspectionHasBeenSet = true;
    m_deepThreatInspection = value;
  }
  inline StatefulRuleGroupReference& WithDeepThreatInspection(bool value) {
    SetDeepThreatInspection(value);
    return *this;
  }
  ///@}
 private:
