...
namespace Model {
class DetachRuleGroupsFromProxyConfigurationResult {
 public:
  AWS_NETWORKFIREWALL_API DetachRuleGroupsFromProxyConfigurationResult() = default;
  AWS_NETWORKFIREWALL_API DetachRuleGroupsFromProxyConfigurationResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API DetachRuleGroupsFromProxyConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProxyConfigurationT = ProxyConfiguration>
  DetachRuleGroupsFromProxyConfigurationResult& WithProxyConfiguration(ProxyConfigurationT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  DetachRuleGroupsFromProxyConfigurationResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DetachRuleGroupsFromProxyConfigurationResult& WithRequestId(RequestIdT&& value) {
