...
class StatefulEngineOptions {
 public:
  ...
  inline StatefulEngineOptions& WithRuleOrder(RuleOrder value) {
    SetRuleOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStreamExceptionPolicy(StreamExceptionPolicy value) {
    m_streamExceptionPolicyHasBeenSet = true;
    m_streamExceptionPolicy = value;
  }
  inline StatefulEngineOptions& WithStreamExceptionPolicy(StreamExceptionPolicy value) {
    SetStreamExceptionPolicy(value);
    return *this;
  }
  ///@}
  ...
  void SetFlowTimeouts(FlowTimeoutsT&& value) {
    ...
    m_flowTimeouts = std::forward<FlowTimeoutsT>(value);
  }
  template <typename FlowTimeoutsT = FlowTimeouts>
  StatefulEngineOptions& WithFlowTimeouts(FlowTimeoutsT&& value) {
    SetFlowTimeouts(std::forward<FlowTimeoutsT>(value));
    return *this;
  }
  ///@}
 private:
