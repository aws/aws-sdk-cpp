...
class UpdateFirewallPolicyChangeProtectionRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateFirewallPolicyChangeProtectionRequest& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename FirewallArnT = Aws::String>
  UpdateFirewallPolicyChangeProtectionRequest& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  UpdateFirewallPolicyChangeProtectionRequest& WithFirewallName(FirewallNameT&& value) {
  ...
  inline UpdateFirewallPolicyChangeProtectionRequest& WithFirewallPolicyChangeProtection(bool value) {
