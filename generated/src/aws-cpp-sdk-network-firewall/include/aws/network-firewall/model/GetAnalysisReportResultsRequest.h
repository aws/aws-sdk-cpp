...
class GetAnalysisReportResultsRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename FirewallNameT = Aws::String>
  GetAnalysisReportResultsRequest& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename AnalysisReportIdT = Aws::String>
  GetAnalysisReportResultsRequest& WithAnalysisReportId(AnalysisReportIdT&& value) {
  ...
  template <typename FirewallArnT = Aws::String>
  GetAnalysisReportResultsRequest& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetAnalysisReportResultsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetAnalysisReportResultsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
