...
namespace Model {
class UpdateProxyResult {
 public:
  AWS_NETWORKFIREWALL_API UpdateProxyResult() = default;
  AWS_NETWORKFIREWALL_API UpdateProxyResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API UpdateProxyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProxyT = Proxy>
  UpdateProxyResult& WithProxy(ProxyT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateProxyResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateProxyResult& WithRequestId(RequestIdT&& value) {
