...
/**
 */
class ListVpcEndpointAssociationsRequest : public NetworkFirewallRequest {
 public:
  AWS_NETWORKFIREWALL_API ListVpcEndpointAssociationsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListVpcEndpointAssociations"; }
  ...
  template <typename NextTokenT = Aws::String>
  ListVpcEndpointAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListVpcEndpointAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the firewall.</p> <p>If you don't specify
   * this, Network Firewall retrieves all VPC endpoint associations that you have
   * defined.</p>
   */
  ...
  template <typename FirewallArnT = Aws::String>
  ListVpcEndpointAssociationsRequest& WithFirewallArn(FirewallArnT&& value) {
