...
namespace Model {
class DescribeProxyConfigurationResult {
 public:
  AWS_NETWORKFIREWALL_API DescribeProxyConfigurationResult() = default;
  AWS_NETWORKFIREWALL_API DescribeProxyConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API DescribeProxyConfigurationResult& operator=(
  ...
  template <typename ProxyConfigurationT = ProxyConfiguration>
  DescribeProxyConfigurationResult& WithProxyConfiguration(ProxyConfigurationT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  DescribeProxyConfigurationResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeProxyConfigurationResult& WithRequestId(RequestIdT&& value) {
