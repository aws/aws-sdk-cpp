...
class UpdateFirewallDeleteProtectionResult {
 public:
  ...
  AWS_NETWORKFIREWALL_API UpdateFirewallDeleteProtectionResult& operator=(
  ...
  template <typename FirewallArnT = Aws::String>
  UpdateFirewallDeleteProtectionResult& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  UpdateFirewallDeleteProtectionResult& WithFirewallName(FirewallNameT&& value) {
  ...
  inline UpdateFirewallDeleteProtectionResult& WithDeleteProtection(bool value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateFirewallDeleteProtectionResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFirewallDeleteProtectionResult& WithRequestId(RequestIdT&& value) {
