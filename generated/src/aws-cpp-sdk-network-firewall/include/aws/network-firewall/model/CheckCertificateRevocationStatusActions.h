...
class CheckCertificateRevocationStatusActions {
 public:
  ...
  inline void SetRevokedStatusAction(RevocationCheckAction value) {
    m_revokedStatusActionHasBeenSet = true;
    m_revokedStatusAction = value;
  }
  inline CheckCertificateRevocationStatusActions& WithRevokedStatusAction(RevocationCheckAction value) {
    SetRevokedStatusAction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnknownStatusAction(RevocationCheckAction value) {
    m_unknownStatusActionHasBeenSet = true;
    m_unknownStatusAction = value;
  }
  inline CheckCertificateRevocationStatusActions& WithUnknownStatusAction(RevocationCheckAction value) {
    SetUnknownStatusAction(value);
    return *this;
  }
  ///@}
 private:
