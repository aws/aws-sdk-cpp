...
/**
 */
class AttachRuleGroupsToProxyConfigurationRequest : public NetworkFirewallRequest {
 public:
  AWS_NETWORKFIREWALL_API AttachRuleGroupsToProxyConfigurationRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "AttachRuleGroupsToProxyConfiguration"; }
  ...
  template <typename ProxyConfigurationNameT = Aws::String>
  AttachRuleGroupsToProxyConfigurationRequest& WithProxyConfigurationName(ProxyConfigurationNameT&& value) {
  ...
  template <typename ProxyConfigurationArnT = Aws::String>
  AttachRuleGroupsToProxyConfigurationRequest& WithProxyConfigurationArn(ProxyConfigurationArnT&& value) {
   ...
   */
  inline const Aws::Vector<ProxyRuleGroupAttachment>& GetRuleGroups() const { return m_ruleGroups; }
  inline bool RuleGroupsHasBeenSet() const { return m_ruleGroupsHasBeenSet; }
  template <typename RuleGroupsT = Aws::Vector<ProxyRuleGroupAttachment>>
  void SetRuleGroups(RuleGroupsT&& value) {
    m_ruleGroupsHasBeenSet = true;
    m_ruleGroups = std::forward<RuleGroupsT>(value);
  }
  template <typename RuleGroupsT = Aws::Vector<ProxyRuleGroupAttachment>>
  AttachRuleGroupsToProxyConfigurationRequest& WithRuleGroups(RuleGroupsT&& value) {
    SetRuleGroups(std::forward<RuleGroupsT>(value));
    return *this;
  }
  template <typename RuleGroupsT = ProxyRuleGroupAttachment>
  AttachRuleGroupsToProxyConfigurationRequest& AddRuleGroups(RuleGroupsT&& value) {
    m_ruleGroupsHasBeenSet = true;
  ...
  template <typename UpdateTokenT = Aws::String>
  AttachRuleGroupsToProxyConfigurationRequest& WithUpdateToken(UpdateTokenT&& value) {
