...
class UpdateSubnetChangeProtectionRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateSubnetChangeProtectionRequest& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename FirewallArnT = Aws::String>
  UpdateSubnetChangeProtectionRequest& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  UpdateSubnetChangeProtectionRequest& WithFirewallName(FirewallNameT&& value) {
  ...
  inline UpdateSubnetChangeProtectionRequest& WithSubnetChangeProtection(bool value) {
