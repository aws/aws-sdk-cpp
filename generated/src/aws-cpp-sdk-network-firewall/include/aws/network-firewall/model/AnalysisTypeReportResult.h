...
class AnalysisTypeReportResult {
 public:
  ...
  template <typename ProtocolT = Aws::String>
  AnalysisTypeReportResult& WithProtocol(ProtocolT&& value) {
  ...
  void SetFirstAccessed(FirstAccessedT&& value) {
    m_firstAccessedHasBeenSet = true;
    m_firstAccessed = std::forward<FirstAccessedT>(value);
  }
  template <typename FirstAccessedT = Aws::Utils::DateTime>
  AnalysisTypeReportResult& WithFirstAccessed(FirstAccessedT&& value) {
    SetFirstAccessed(std::forward<FirstAccessedT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastAccessedT = Aws::Utils::DateTime>
  AnalysisTypeReportResult& WithLastAccessed(LastAccessedT&& value) {
  ...
  template <typename DomainT = Aws::String>
  AnalysisTypeReportResult& WithDomain(DomainT&& value) {
  ...
  template <typename HitsT = Hits>
  AnalysisTypeReportResult& WithHits(HitsT&& value) {
  ...
  void SetUniqueSources(UniqueSourcesT&& value) {
    m_uniqueSourcesHasBeenSet = true;
    m_uniqueSources = std::forward<UniqueSourcesT>(value);
  }
  template <typename UniqueSourcesT = UniqueSources>
  AnalysisTypeReportResult& WithUniqueSources(UniqueSourcesT&& value) {
    SetUniqueSources(std::forward<UniqueSourcesT>(value));
    return *this;
  }
  ///@}
 private:
