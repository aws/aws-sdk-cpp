...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKFIREWALL_API AssociateSubnetsResult() = default;
    ...
    template<typename FirewallArnT = Aws::String>
    AssociateSubnetsResult& WithFirewallArn(FirewallArnT&& value) { SetFirewallArn(std::forward<FirewallArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FirewallNameT = Aws::String>
    AssociateSubnetsResult& WithFirewallName(FirewallNameT&& value) { SetFirewallName(std::forward<FirewallNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SubnetMappingsT = Aws::Vector<SubnetMapping>>
    AssociateSubnetsResult& WithSubnetMappings(SubnetMappingsT&& value) { SetSubnetMappings(std::forward<SubnetMappingsT>(value)); return *this;}
    template<typename SubnetMappingsT = SubnetMapping>
    AssociateSubnetsResult& AddSubnetMappings(SubnetMappingsT&& value) { m_subnetMappingsHasBeenSet = true; m_subnetMappings.emplace_back(std::forward<SubnetMappingsT>(value)); return *this; }
    ///@}
    ...
    template<typename UpdateTokenT = Aws::String>
    AssociateSubnetsResult& WithUpdateToken(UpdateTokenT&& value) { SetUpdateToken(std::forward<UpdateTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AssociateSubnetsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
