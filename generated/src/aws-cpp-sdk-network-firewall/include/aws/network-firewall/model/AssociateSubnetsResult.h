...
class AssociateSubnetsResult {
 public:
  ...
  template <typename FirewallArnT = Aws::String>
  AssociateSubnetsResult& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  AssociateSubnetsResult& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename SubnetMappingsT = Aws::Vector<SubnetMapping>>
  AssociateSubnetsResult& WithSubnetMappings(SubnetMappingsT&& value) {
    SetSubnetMappings(std::forward<SubnetMappingsT>(value));
    return *this;
  }
  template <typename SubnetMappingsT = SubnetMapping>
  AssociateSubnetsResult& AddSubnetMappings(SubnetMappingsT&& value) {
    m_subnetMappingsHasBeenSet = true;
  ...
  template <typename UpdateTokenT = Aws::String>
  AssociateSubnetsResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateSubnetsResult& WithRequestId(RequestIdT&& value) {
