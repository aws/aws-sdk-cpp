...
namespace Model
{
  ...
  public:
    ...
    inline AssociateSubnetsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateSubnetsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateSubnetsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
