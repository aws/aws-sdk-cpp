...
class DescribeTLSInspectionConfigurationResult {
 public:
  ...
  AWS_NETWORKFIREWALL_API DescribeTLSInspectionConfigurationResult& operator=(
  ...
  template <typename UpdateTokenT = Aws::String>
  DescribeTLSInspectionConfigurationResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  void SetTLSInspectionConfiguration(TLSInspectionConfigurationT&& value) {
    m_tLSInspectionConfigurationHasBeenSet = true;
    m_tLSInspectionConfiguration = std::forward<TLSInspectionConfigurationT>(value);
  }
  template <typename TLSInspectionConfigurationT = TLSInspectionConfiguration>
  DescribeTLSInspectionConfigurationResult& WithTLSInspectionConfiguration(TLSInspectionConfigurationT&& value) {
    SetTLSInspectionConfiguration(std::forward<TLSInspectionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TLSInspectionConfigurationResponseT = TLSInspectionConfigurationResponse>
  DescribeTLSInspectionConfigurationResult& WithTLSInspectionConfigurationResponse(TLSInspectionConfigurationResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTLSInspectionConfigurationResult& WithRequestId(RequestIdT&& value) {
