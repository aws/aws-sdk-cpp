...
class Flow {
 public:
  ...
  inline void SetPacketCount(int value) {
    m_packetCountHasBeenSet = true;
    m_packetCount = value;
  }
  inline Flow& WithPacketCount(int value) {
  ...
  inline void SetByteCount(long long value) {
    m_byteCountHasBeenSet = true;
    m_byteCount = value;
  }
  inline Flow& WithByteCount(long long value) {
    SetByteCount(value);
    return *this;
  }
  ///@}
