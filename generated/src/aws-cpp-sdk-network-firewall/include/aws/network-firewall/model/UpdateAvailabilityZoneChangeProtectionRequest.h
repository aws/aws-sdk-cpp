...
class UpdateAvailabilityZoneChangeProtectionRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateAvailabilityZoneChangeProtectionRequest& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename FirewallArnT = Aws::String>
  UpdateAvailabilityZoneChangeProtectionRequest& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  UpdateAvailabilityZoneChangeProtectionRequest& WithFirewallName(FirewallNameT&& value) {
  ...
  inline UpdateAvailabilityZoneChangeProtectionRequest& WithAvailabilityZoneChangeProtection(bool value) {
