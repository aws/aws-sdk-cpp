...
namespace Model
{
  ...
  /**
   */
  class UpdateAvailabilityZoneChangeProtectionRequest : public NetworkFirewallRequest
  {
  public:
    AWS_NETWORKFIREWALL_API UpdateAvailabilityZoneChangeProtectionRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "UpdateAvailabilityZoneChangeProtection"; }
    ...
    template<typename UpdateTokenT = Aws::String>
    UpdateAvailabilityZoneChangeProtectionRequest& WithUpdateToken(UpdateTokenT&& value) { SetUpdateToken(std::forward<UpdateTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename FirewallArnT = Aws::String>
    UpdateAvailabilityZoneChangeProtectionRequest& WithFirewallArn(FirewallArnT&& value) { SetFirewallArn(std::forward<FirewallArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FirewallNameT = Aws::String>
    UpdateAvailabilityZoneChangeProtectionRequest& WithFirewallName(FirewallNameT&& value) { SetFirewallName(std::forward<FirewallNameT>(value)); return *this;}
    ///@}
    ...
    inline UpdateAvailabilityZoneChangeProtectionRequest& WithAvailabilityZoneChangeProtection(bool value) { SetAvailabilityZoneChangeProtection(value); return *this;}
    ///@}
  private:
