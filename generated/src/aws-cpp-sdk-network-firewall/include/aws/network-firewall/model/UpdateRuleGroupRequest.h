...
class UpdateRuleGroupRequest : public NetworkFirewallRequest {
 public:
  ...
  inline UpdateRuleGroupRequest& WithType(RuleGroupType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateRuleGroupRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateRuleGroupRequest& WithAnalyzeRuleGroup(bool value) {
