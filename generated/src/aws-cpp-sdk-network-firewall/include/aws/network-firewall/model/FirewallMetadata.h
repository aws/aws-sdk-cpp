...
class FirewallMetadata {
 public:
  ...
  template <typename FirewallNameT = Aws::String>
  FirewallMetadata& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename FirewallArnT = Aws::String>
  FirewallMetadata& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  FirewallMetadata& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
