...
namespace Model {
class CreateProxyRulesResult {
 public:
  AWS_NETWORKFIREWALL_API CreateProxyRulesResult() = default;
  AWS_NETWORKFIREWALL_API CreateProxyRulesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API CreateProxyRulesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProxyRuleGroupT = ProxyRuleGroup>
  CreateProxyRulesResult& WithProxyRuleGroup(ProxyRuleGroupT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateProxyRulesResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateProxyRulesResult& WithRequestId(RequestIdT&& value) {
