...
class ListFlowOperationResultsResult {
 public:
  ...
  template <typename FirewallArnT = Aws::String>
  ListFlowOperationResultsResult& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  ListFlowOperationResultsResult& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename VpcEndpointAssociationArnT = Aws::String>
  ListFlowOperationResultsResult& WithVpcEndpointAssociationArn(VpcEndpointAssociationArnT&& value) {
  ...
  template <typename VpcEndpointIdT = Aws::String>
  ListFlowOperationResultsResult& WithVpcEndpointId(VpcEndpointIdT&& value) {
  ...
  template <typename FlowOperationIdT = Aws::String>
  ListFlowOperationResultsResult& WithFlowOperationId(FlowOperationIdT&& value) {
  ...
  inline ListFlowOperationResultsResult& WithFlowOperationStatus(FlowOperationStatus value) {
  ...
  template <typename StatusMessageT = Aws::String>
  ListFlowOperationResultsResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename FlowRequestTimestampT = Aws::Utils::DateTime>
  ListFlowOperationResultsResult& WithFlowRequestTimestamp(FlowRequestTimestampT&& value) {
  ...
  template <typename FlowsT = Aws::Vector<Flow>>
  ListFlowOperationResultsResult& WithFlows(FlowsT&& value) {
    SetFlows(std::forward<FlowsT>(value));
    return *this;
  }
  template <typename FlowsT = Flow>
  ListFlowOperationResultsResult& AddFlows(FlowsT&& value) {
    m_flowsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListFlowOperationResultsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFlowOperationResultsResult& WithRequestId(RequestIdT&& value) {
