...
namespace Model
{
  ...
  public:
    ...
    AWS_NETWORKFIREWALL_API DescribeVpcEndpointAssociationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename VpcEndpointAssociationT = VpcEndpointAssociation>
    DescribeVpcEndpointAssociationResult& WithVpcEndpointAssociation(VpcEndpointAssociationT&& value) { SetVpcEndpointAssociation(std::forward<VpcEndpointAssociationT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcEndpointAssociationStatusT = VpcEndpointAssociationStatus>
    DescribeVpcEndpointAssociationResult& WithVpcEndpointAssociationStatus(VpcEndpointAssociationStatusT&& value) { SetVpcEndpointAssociationStatus(std::forward<VpcEndpointAssociationStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeVpcEndpointAssociationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
