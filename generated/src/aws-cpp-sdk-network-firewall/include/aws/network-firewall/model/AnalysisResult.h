...
class AnalysisResult {
 public:
  ...
  void SetIdentifiedRuleIds(IdentifiedRuleIdsT&& value) {
    ...
    m_identifiedRuleIds = std::forward<IdentifiedRuleIdsT>(value);
  }
  template <typename IdentifiedRuleIdsT = Aws::Vector<Aws::String>>
  AnalysisResult& WithIdentifiedRuleIds(IdentifiedRuleIdsT&& value) {
    SetIdentifiedRuleIds(std::forward<IdentifiedRuleIdsT>(value));
    return *this;
  }
  template <typename IdentifiedRuleIdsT = Aws::String>
  AnalysisResult& AddIdentifiedRuleIds(IdentifiedRuleIdsT&& value) {
    m_identifiedRuleIdsHasBeenSet = true;
    m_identifiedRuleIds.emplace_back(std::forward<IdentifiedRuleIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIdentifiedType(IdentifiedType value) {
    m_identifiedTypeHasBeenSet = true;
    m_identifiedType = value;
  }
  inline AnalysisResult& WithIdentifiedType(IdentifiedType value) {
    SetIdentifiedType(value);
    return *this;
  }
  ///@}
  ...
  void SetAnalysisDetail(AnalysisDetailT&& value) {
    ...
    m_analysisDetail = std::forward<AnalysisDetailT>(value);
  }
  template <typename AnalysisDetailT = Aws::String>
  AnalysisResult& WithAnalysisDetail(AnalysisDetailT&& value) {
    SetAnalysisDetail(std::forward<AnalysisDetailT>(value));
    return *this;
  }
  ///@}
 private:
