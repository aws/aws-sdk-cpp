...
class CIDRSummary {
 public:
  ...
  inline void SetAvailableCIDRCount(int value) {
    m_availableCIDRCountHasBeenSet = true;
    m_availableCIDRCount = value;
  }
  inline CIDRSummary& WithAvailableCIDRCount(int value) {
    SetAvailableCIDRCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUtilizedCIDRCount(int value) {
    m_utilizedCIDRCountHasBeenSet = true;
    m_utilizedCIDRCount = value;
  }
  inline CIDRSummary& WithUtilizedCIDRCount(int value) {
    SetUtilizedCIDRCount(value);
    return *this;
  }
  ///@}
  ...
  void SetIPSetReferences(IPSetReferencesT&& value) {
    ...
    m_iPSetReferences = std::forward<IPSetReferencesT>(value);
  }
  template <typename IPSetReferencesT = Aws::Map<Aws::String, IPSetMetadata>>
  CIDRSummary& WithIPSetReferences(IPSetReferencesT&& value) {
    SetIPSetReferences(std::forward<IPSetReferencesT>(value));
    return *this;
  }
  ...
  CIDRSummary& AddIPSetReferences(IPSetReferencesKeyT&& key, IPSetReferencesValueT&& value) {
    m_iPSetReferencesHasBeenSet = true;
    m_iPSetReferences.emplace(std::forward<IPSetReferencesKeyT>(key), std::forward<IPSetReferencesValueT>(value));
    return *this;
  }
  ///@}
 private:
