...
class PerObjectStatus {
 public:
  ...
  inline void SetSyncStatus(PerObjectSyncStatus value) {
    m_syncStatusHasBeenSet = true;
    m_syncStatus = value;
  }
  inline PerObjectStatus& WithSyncStatus(PerObjectSyncStatus value) {
    SetSyncStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename UpdateTokenT = Aws::String>
  PerObjectStatus& WithUpdateToken(UpdateTokenT&& value) {
