...
class GetAnalysisReportResultsResult {
 public:
  ...
  template <typename StatusT = Aws::String>
  GetAnalysisReportResultsResult& WithStatus(StatusT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  GetAnalysisReportResultsResult& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  GetAnalysisReportResultsResult& WithEndTime(EndTimeT&& value) {
  ...
  void SetReportTime(ReportTimeT&& value) {
    ...
    m_reportTime = std::forward<ReportTimeT>(value);
  }
  template <typename ReportTimeT = Aws::Utils::DateTime>
  GetAnalysisReportResultsResult& WithReportTime(ReportTimeT&& value) {
    SetReportTime(std::forward<ReportTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetAnalysisReportResultsResult& WithAnalysisType(EnabledAnalysisType value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetAnalysisReportResultsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetAnalysisReportResults(AnalysisReportResultsT&& value) {
    m_analysisReportResultsHasBeenSet = true;
    m_analysisReportResults = std::forward<AnalysisReportResultsT>(value);
  }
  template <typename AnalysisReportResultsT = Aws::Vector<AnalysisTypeReportResult>>
  GetAnalysisReportResultsResult& WithAnalysisReportResults(AnalysisReportResultsT&& value) {
    SetAnalysisReportResults(std::forward<AnalysisReportResultsT>(value));
    return *this;
  }
  template <typename AnalysisReportResultsT = AnalysisTypeReportResult>
  GetAnalysisReportResultsResult& AddAnalysisReportResults(AnalysisReportResultsT&& value) {
    m_analysisReportResultsHasBeenSet = true;
    m_analysisReportResults.emplace_back(std::forward<AnalysisReportResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAnalysisReportResultsResult& WithRequestId(RequestIdT&& value) {
