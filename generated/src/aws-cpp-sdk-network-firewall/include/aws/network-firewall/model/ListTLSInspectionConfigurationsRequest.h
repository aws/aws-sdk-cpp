...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKFIREWALL_API ListTLSInspectionConfigurationsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListTLSInspectionConfigurationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
