...
namespace Model
{
  class CreateVpcEndpointAssociationResult
  {
  public:
    AWS_NETWORKFIREWALL_API CreateVpcEndpointAssociationResult() = default;
    AWS_NETWORKFIREWALL_API CreateVpcEndpointAssociationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_NETWORKFIREWALL_API CreateVpcEndpointAssociationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename VpcEndpointAssociationT = VpcEndpointAssociation>
    CreateVpcEndpointAssociationResult& WithVpcEndpointAssociation(VpcEndpointAssociationT&& value) { SetVpcEndpointAssociation(std::forward<VpcEndpointAssociationT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcEndpointAssociationStatusT = VpcEndpointAssociationStatus>
    CreateVpcEndpointAssociationResult& WithVpcEndpointAssociationStatus(VpcEndpointAssociationStatusT&& value) { SetVpcEndpointAssociationStatus(std::forward<VpcEndpointAssociationStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateVpcEndpointAssociationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
