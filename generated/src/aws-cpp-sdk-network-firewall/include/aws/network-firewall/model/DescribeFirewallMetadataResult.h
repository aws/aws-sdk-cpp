...
class DescribeFirewallMetadataResult {
 public:
  ...
  template <typename FirewallArnT = Aws::String>
  DescribeFirewallMetadataResult& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallPolicyArnT = Aws::String>
  DescribeFirewallMetadataResult& WithFirewallPolicyArn(FirewallPolicyArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  DescribeFirewallMetadataResult& WithDescription(DescriptionT&& value) {
  ...
  inline DescribeFirewallMetadataResult& WithStatus(FirewallStatusValue value) {
    SetStatus(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Map<Aws::String, AvailabilityZoneMetadata>& GetSupportedAvailabilityZones() const {
    return m_supportedAvailabilityZones;
  }
  template <typename SupportedAvailabilityZonesT = Aws::Map<Aws::String, AvailabilityZoneMetadata>>
  void SetSupportedAvailabilityZones(SupportedAvailabilityZonesT&& value) {
    m_supportedAvailabilityZonesHasBeenSet = true;
    m_supportedAvailabilityZones = std::forward<SupportedAvailabilityZonesT>(value);
  }
  template <typename SupportedAvailabilityZonesT = Aws::Map<Aws::String, AvailabilityZoneMetadata>>
  DescribeFirewallMetadataResult& WithSupportedAvailabilityZones(SupportedAvailabilityZonesT&& value) {
    SetSupportedAvailabilityZones(std::forward<SupportedAvailabilityZonesT>(value));
    return *this;
  }
  ...
  DescribeFirewallMetadataResult& AddSupportedAvailabilityZones(SupportedAvailabilityZonesKeyT&& key,
                                                                SupportedAvailabilityZonesValueT&& value) {
    m_supportedAvailabilityZonesHasBeenSet = true;
    m_supportedAvailabilityZones.emplace(std::forward<SupportedAvailabilityZonesKeyT>(key),
                                         std::forward<SupportedAvailabilityZonesValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  DescribeFirewallMetadataResult& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFirewallMetadataResult& WithRequestId(RequestIdT&& value) {
