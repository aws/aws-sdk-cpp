...
class CreateFirewallPolicyRequest : public NetworkFirewallRequest {
 public:
  ...
  void SetFirewallPolicyName(FirewallPolicyNameT&& value) {
    ...
    m_firewallPolicyName = std::forward<FirewallPolicyNameT>(value);
  }
  template <typename FirewallPolicyNameT = Aws::String>
  CreateFirewallPolicyRequest& WithFirewallPolicyName(FirewallPolicyNameT&& value) {
    SetFirewallPolicyName(std::forward<FirewallPolicyNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FirewallPolicyT = FirewallPolicy>
  CreateFirewallPolicyRequest& WithFirewallPolicy(FirewallPolicyT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateFirewallPolicyRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateFirewallPolicyRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateFirewallPolicyRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline CreateFirewallPolicyRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename EncryptionConfigurationT = EncryptionConfiguration>
  CreateFirewallPolicyRequest& WithEncryptionConfiguration(EncryptionConfigurationT&& value) {
