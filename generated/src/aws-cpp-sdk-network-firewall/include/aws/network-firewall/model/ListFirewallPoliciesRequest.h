...
/**
 */
class ListFirewallPoliciesRequest : public NetworkFirewallRequest {
 public:
  AWS_NETWORKFIREWALL_API ListFirewallPoliciesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListFirewallPoliciesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFirewallPoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
