 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/network-firewall-2020-11-12/Proxy">AWS
 * API Reference</a></p>
 */
class Proxy {
 public:
  AWS_NETWORKFIREWALL_API Proxy() = default;
  AWS_NETWORKFIREWALL_API Proxy(Aws::Utils::Json::JsonView jsonValue);
  AWS_NETWORKFIREWALL_API Proxy& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  Proxy& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename DeleteTimeT = Aws::Utils::DateTime>
  Proxy& WithDeleteTime(DeleteTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  Proxy& WithUpdateTime(UpdateTimeT&& value) {
  ...
  template <typename FailureCodeT = Aws::String>
  Proxy& WithFailureCode(FailureCodeT&& value) {
  ...
  template <typename FailureMessageT = Aws::String>
  Proxy& WithFailureMessage(FailureMessageT&& value) {
  ...
  inline Proxy& WithProxyState(ProxyState value) {
    SetProxyState(value);
    return *this;
  }
  ///@}
  ...
  inline Proxy& WithProxyModifyState(ProxyModifyState value) {
  ...
  template <typename NatGatewayIdT = Aws::String>
  Proxy& WithNatGatewayId(NatGatewayIdT&& value) {
  ...
  template <typename ProxyConfigurationNameT = Aws::String>
  Proxy& WithProxyConfigurationName(ProxyConfigurationNameT&& value) {
  ...
  template <typename ProxyConfigurationArnT = Aws::String>
  Proxy& WithProxyConfigurationArn(ProxyConfigurationArnT&& value) {
  ...
  template <typename ProxyNameT = Aws::String>
  Proxy& WithProxyName(ProxyNameT&& value) {
  ...
  template <typename ProxyArnT = Aws::String>
  Proxy& WithProxyArn(ProxyArnT&& value) {
  ...
  template <typename TlsInterceptPropertiesT = TlsInterceptProperties>
  Proxy& WithTlsInterceptProperties(TlsInterceptPropertiesT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  Proxy& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  Proxy& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
