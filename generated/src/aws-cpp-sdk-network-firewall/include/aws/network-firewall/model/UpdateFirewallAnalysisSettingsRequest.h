...
class UpdateFirewallAnalysisSettingsRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename EnabledAnalysisTypesT = Aws::Vector<EnabledAnalysisType>>
  UpdateFirewallAnalysisSettingsRequest& WithEnabledAnalysisTypes(EnabledAnalysisTypesT&& value) {
    SetEnabledAnalysisTypes(std::forward<EnabledAnalysisTypesT>(value));
    return *this;
  }
  inline UpdateFirewallAnalysisSettingsRequest& AddEnabledAnalysisTypes(EnabledAnalysisType value) {
    m_enabledAnalysisTypesHasBeenSet = true;
  ...
  template <typename FirewallArnT = Aws::String>
  UpdateFirewallAnalysisSettingsRequest& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  UpdateFirewallAnalysisSettingsRequest& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateFirewallAnalysisSettingsRequest& WithUpdateToken(UpdateTokenT&& value) {
