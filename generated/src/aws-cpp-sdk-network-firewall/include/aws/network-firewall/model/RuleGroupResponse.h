...
class RuleGroupResponse {
 public:
  ...
  inline RuleGroupResponse& WithType(RuleGroupType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline RuleGroupResponse& WithCapacity(int value) {
    SetCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRuleGroupStatus(ResourceStatus value) {
    m_ruleGroupStatusHasBeenSet = true;
    m_ruleGroupStatus = value;
  }
  inline RuleGroupResponse& WithRuleGroupStatus(ResourceStatus value) {
    SetRuleGroupStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConsumedCapacity(int value) {
    m_consumedCapacityHasBeenSet = true;
    m_consumedCapacity = value;
  }
  inline RuleGroupResponse& WithConsumedCapacity(int value) {
    SetConsumedCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline RuleGroupResponse& WithNumberOfAssociations(int value) {
