...
class ListFlowOperationsRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename FirewallArnT = Aws::String>
  ListFlowOperationsRequest& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  ListFlowOperationsRequest& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename VpcEndpointAssociationArnT = Aws::String>
  ListFlowOperationsRequest& WithVpcEndpointAssociationArn(VpcEndpointAssociationArnT&& value) {
  ...
  template <typename VpcEndpointIdT = Aws::String>
  ListFlowOperationsRequest& WithVpcEndpointId(VpcEndpointIdT&& value) {
  ...
  inline ListFlowOperationsRequest& WithFlowOperationType(FlowOperationType value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListFlowOperationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFlowOperationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
