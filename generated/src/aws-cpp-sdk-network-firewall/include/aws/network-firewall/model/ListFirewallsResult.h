...
class ListFirewallsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListFirewallsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetFirewalls(FirewallsT&& value) {
    m_firewallsHasBeenSet = true;
    m_firewalls = std::forward<FirewallsT>(value);
  }
  template <typename FirewallsT = Aws::Vector<FirewallMetadata>>
  ListFirewallsResult& WithFirewalls(FirewallsT&& value) {
    SetFirewalls(std::forward<FirewallsT>(value));
    return *this;
  }
  template <typename FirewallsT = FirewallMetadata>
  ListFirewallsResult& AddFirewalls(FirewallsT&& value) {
    m_firewallsHasBeenSet = true;
    m_firewalls.emplace_back(std::forward<FirewallsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListFirewallsResult& WithRequestId(RequestIdT&& value) {
