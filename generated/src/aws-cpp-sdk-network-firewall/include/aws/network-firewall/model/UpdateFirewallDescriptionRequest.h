...
class UpdateFirewallDescriptionRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateFirewallDescriptionRequest& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename FirewallArnT = Aws::String>
  UpdateFirewallDescriptionRequest& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  UpdateFirewallDescriptionRequest& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateFirewallDescriptionRequest& WithDescription(DescriptionT&& value) {
