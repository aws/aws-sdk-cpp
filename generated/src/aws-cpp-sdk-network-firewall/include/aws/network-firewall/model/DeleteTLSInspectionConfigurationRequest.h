...
class DeleteTLSInspectionConfigurationRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename TLSInspectionConfigurationArnT = Aws::String>
  DeleteTLSInspectionConfigurationRequest& WithTLSInspectionConfigurationArn(TLSInspectionConfigurationArnT&& value) {
  ...
  template <typename TLSInspectionConfigurationNameT = Aws::String>
  DeleteTLSInspectionConfigurationRequest& WithTLSInspectionConfigurationName(TLSInspectionConfigurationNameT&& value) {
