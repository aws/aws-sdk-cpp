...
class FlowFilter {
 public:
  ...
  template <typename SourceAddressT = Address>
  FlowFilter& WithSourceAddress(SourceAddressT&& value) {
  ...
  template <typename DestinationAddressT = Address>
  FlowFilter& WithDestinationAddress(DestinationAddressT&& value) {
  ...
  template <typename SourcePortT = Aws::String>
  FlowFilter& WithSourcePort(SourcePortT&& value) {
  ...
  template <typename DestinationPortT = Aws::String>
  FlowFilter& WithDestinationPort(DestinationPortT&& value) {
  ...
  template <typename ProtocolsT = Aws::Vector<Aws::String>>
  FlowFilter& WithProtocols(ProtocolsT&& value) {
    SetProtocols(std::forward<ProtocolsT>(value));
    return *this;
  }
  template <typename ProtocolsT = Aws::String>
  FlowFilter& AddProtocols(ProtocolsT&& value) {
    m_protocolsHasBeenSet = true;
