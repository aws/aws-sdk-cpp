...
namespace Model {
class UpdateProxySettingsResult {
 public:
  AWS_NETWORKFIREWALL_API UpdateProxySettingsResult() = default;
  AWS_NETWORKFIREWALL_API UpdateProxySettingsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API UpdateProxySettingsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename FirewallArnT = Aws::String>
  UpdateProxySettingsResult& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  UpdateProxySettingsResult& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateProxySettingsResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename ProxySettingsT = ProxySettings>
  UpdateProxySettingsResult& WithProxySettings(ProxySettingsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateProxySettingsResult& WithRequestId(RequestIdT&& value) {
