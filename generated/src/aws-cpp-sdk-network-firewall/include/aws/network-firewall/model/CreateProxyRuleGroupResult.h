...
namespace Model {
class CreateProxyRuleGroupResult {
 public:
  AWS_NETWORKFIREWALL_API CreateProxyRuleGroupResult() = default;
  AWS_NETWORKFIREWALL_API CreateProxyRuleGroupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API CreateProxyRuleGroupResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProxyRuleGroupT = ProxyRuleGroup>
  CreateProxyRuleGroupResult& WithProxyRuleGroup(ProxyRuleGroupT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateProxyRuleGroupResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateProxyRuleGroupResult& WithRequestId(RequestIdT&& value) {
