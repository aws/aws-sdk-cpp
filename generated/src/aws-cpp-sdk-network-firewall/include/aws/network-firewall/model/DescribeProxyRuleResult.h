...
namespace Model {
class DescribeProxyRuleResult {
 public:
  AWS_NETWORKFIREWALL_API DescribeProxyRuleResult() = default;
  AWS_NETWORKFIREWALL_API DescribeProxyRuleResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API DescribeProxyRuleResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProxyRuleT = ProxyRule>
  DescribeProxyRuleResult& WithProxyRule(ProxyRuleT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  DescribeProxyRuleResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeProxyRuleResult& WithRequestId(RequestIdT&& value) {
