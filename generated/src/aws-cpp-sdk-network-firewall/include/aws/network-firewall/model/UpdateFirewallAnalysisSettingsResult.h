...
class UpdateFirewallAnalysisSettingsResult {
 public:
  ...
  AWS_NETWORKFIREWALL_API UpdateFirewallAnalysisSettingsResult& operator=(
  ...
  template <typename EnabledAnalysisTypesT = Aws::Vector<EnabledAnalysisType>>
  UpdateFirewallAnalysisSettingsResult& WithEnabledAnalysisTypes(EnabledAnalysisTypesT&& value) {
    SetEnabledAnalysisTypes(std::forward<EnabledAnalysisTypesT>(value));
    return *this;
  }
  inline UpdateFirewallAnalysisSettingsResult& AddEnabledAnalysisTypes(EnabledAnalysisType value) {
    m_enabledAnalysisTypesHasBeenSet = true;
  ...
  template <typename FirewallArnT = Aws::String>
  UpdateFirewallAnalysisSettingsResult& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  UpdateFirewallAnalysisSettingsResult& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateFirewallAnalysisSettingsResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFirewallAnalysisSettingsResult& WithRequestId(RequestIdT&& value) {
