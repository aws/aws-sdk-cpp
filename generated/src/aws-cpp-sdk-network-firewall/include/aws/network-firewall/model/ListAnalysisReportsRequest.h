...
class ListAnalysisReportsRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename FirewallNameT = Aws::String>
  ListAnalysisReportsRequest& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename FirewallArnT = Aws::String>
  ListAnalysisReportsRequest& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAnalysisReportsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAnalysisReportsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
