...
class DescribeRuleGroupResult {
 public:
  ...
  template <typename UpdateTokenT = Aws::String>
  DescribeRuleGroupResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RuleGroupT = RuleGroup>
  DescribeRuleGroupResult& WithRuleGroup(RuleGroupT&& value) {
  ...
  void SetRuleGroupResponse(RuleGroupResponseT&& value) {
    m_ruleGroupResponseHasBeenSet = true;
    m_ruleGroupResponse = std::forward<RuleGroupResponseT>(value);
  }
  template <typename RuleGroupResponseT = RuleGroupResponse>
  DescribeRuleGroupResult& WithRuleGroupResponse(RuleGroupResponseT&& value) {
    SetRuleGroupResponse(std::forward<RuleGroupResponseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRuleGroupResult& WithRequestId(RequestIdT&& value) {
