...
class ListTLSInspectionConfigurationsResult {
 public:
  ...
  AWS_NETWORKFIREWALL_API ListTLSInspectionConfigurationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListTLSInspectionConfigurationsResult& WithNextToken(NextTokenT&& value) {
   ...
   */
  inline const Aws::Vector<TLSInspectionConfigurationMetadata>& GetTLSInspectionConfigurations() const {
    return m_tLSInspectionConfigurations;
  }
  template <typename TLSInspectionConfigurationsT = Aws::Vector<TLSInspectionConfigurationMetadata>>
  void SetTLSInspectionConfigurations(TLSInspectionConfigurationsT&& value) {
    m_tLSInspectionConfigurationsHasBeenSet = true;
    m_tLSInspectionConfigurations = std::forward<TLSInspectionConfigurationsT>(value);
  }
  template <typename TLSInspectionConfigurationsT = Aws::Vector<TLSInspectionConfigurationMetadata>>
  ListTLSInspectionConfigurationsResult& WithTLSInspectionConfigurations(TLSInspectionConfigurationsT&& value) {
    SetTLSInspectionConfigurations(std::forward<TLSInspectionConfigurationsT>(value));
    return *this;
  }
  template <typename TLSInspectionConfigurationsT = TLSInspectionConfigurationMetadata>
  ListTLSInspectionConfigurationsResult& AddTLSInspectionConfigurations(TLSInspectionConfigurationsT&& value) {
    m_tLSInspectionConfigurationsHasBeenSet = true;
    m_tLSInspectionConfigurations.emplace_back(std::forward<TLSInspectionConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTLSInspectionConfigurationsResult& WithRequestId(RequestIdT&& value) {
