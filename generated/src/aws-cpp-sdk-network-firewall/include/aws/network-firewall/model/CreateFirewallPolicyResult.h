...
class CreateFirewallPolicyResult {
 public:
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateFirewallPolicyResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename FirewallPolicyResponseT = FirewallPolicyResponse>
  CreateFirewallPolicyResult& WithFirewallPolicyResponse(FirewallPolicyResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateFirewallPolicyResult& WithRequestId(RequestIdT&& value) {
