...
class UpdateFirewallPolicyChangeProtectionResult {
 public:
  ...
  AWS_NETWORKFIREWALL_API UpdateFirewallPolicyChangeProtectionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateFirewallPolicyChangeProtectionResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename FirewallArnT = Aws::String>
  UpdateFirewallPolicyChangeProtectionResult& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  UpdateFirewallPolicyChangeProtectionResult& WithFirewallName(FirewallNameT&& value) {
  ...
  inline UpdateFirewallPolicyChangeProtectionResult& WithFirewallPolicyChangeProtection(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFirewallPolicyChangeProtectionResult& WithRequestId(RequestIdT&& value) {
