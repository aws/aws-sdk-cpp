...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKFIREWALL_API UpdateFirewallPolicyChangeProtectionResult() = default;
    ...
    template<typename UpdateTokenT = Aws::String>
    UpdateFirewallPolicyChangeProtectionResult& WithUpdateToken(UpdateTokenT&& value) { SetUpdateToken(std::forward<UpdateTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename FirewallArnT = Aws::String>
    UpdateFirewallPolicyChangeProtectionResult& WithFirewallArn(FirewallArnT&& value) { SetFirewallArn(std::forward<FirewallArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FirewallNameT = Aws::String>
    UpdateFirewallPolicyChangeProtectionResult& WithFirewallName(FirewallNameT&& value) { SetFirewallName(std::forward<FirewallNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFirewallPolicyChangeProtectionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
