...
class RulesSource {
 public:
  ...
  void SetRulesString(RulesStringT&& value) {
    ...
    m_rulesString = std::forward<RulesStringT>(value);
  }
  template <typename RulesStringT = Aws::String>
  RulesSource& WithRulesString(RulesStringT&& value) {
    SetRulesString(std::forward<RulesStringT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRulesSourceList(RulesSourceListT&& value) {
    ...
    m_rulesSourceList = std::forward<RulesSourceListT>(value);
  }
  template <typename RulesSourceListT = RulesSourceList>
  RulesSource& WithRulesSourceList(RulesSourceListT&& value) {
    SetRulesSourceList(std::forward<RulesSourceListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatefulRules(StatefulRulesT&& value) {
    ...
    m_statefulRules = std::forward<StatefulRulesT>(value);
  }
  template <typename StatefulRulesT = Aws::Vector<StatefulRule>>
  RulesSource& WithStatefulRules(StatefulRulesT&& value) {
    SetStatefulRules(std::forward<StatefulRulesT>(value));
    return *this;
  }
  template <typename StatefulRulesT = StatefulRule>
  RulesSource& AddStatefulRules(StatefulRulesT&& value) {
    m_statefulRulesHasBeenSet = true;
    m_statefulRules.emplace_back(std::forward<StatefulRulesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatelessRulesAndCustomActions(StatelessRulesAndCustomActionsT&& value) {
    ...
    m_statelessRulesAndCustomActions = std::forward<StatelessRulesAndCustomActionsT>(value);
  }
  template <typename StatelessRulesAndCustomActionsT = StatelessRulesAndCustomActions>
  RulesSource& WithStatelessRulesAndCustomActions(StatelessRulesAndCustomActionsT&& value) {
    SetStatelessRulesAndCustomActions(std::forward<StatelessRulesAndCustomActionsT>(value));
    return *this;
  }
  ///@}
 private:
