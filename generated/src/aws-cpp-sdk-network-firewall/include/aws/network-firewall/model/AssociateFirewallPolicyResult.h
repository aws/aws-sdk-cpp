...
class AssociateFirewallPolicyResult {
 public:
  ...
  template <typename FirewallArnT = Aws::String>
  AssociateFirewallPolicyResult& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  AssociateFirewallPolicyResult& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename FirewallPolicyArnT = Aws::String>
  AssociateFirewallPolicyResult& WithFirewallPolicyArn(FirewallPolicyArnT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  AssociateFirewallPolicyResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateFirewallPolicyResult& WithRequestId(RequestIdT&& value) {
