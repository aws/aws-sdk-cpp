...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKFIREWALL_API AssociateFirewallPolicyResult() = default;
    ...
    template<typename FirewallArnT = Aws::String>
    AssociateFirewallPolicyResult& WithFirewallArn(FirewallArnT&& value) { SetFirewallArn(std::forward<FirewallArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FirewallNameT = Aws::String>
    AssociateFirewallPolicyResult& WithFirewallName(FirewallNameT&& value) { SetFirewallName(std::forward<FirewallNameT>(value)); return *this;}
    ///@}
    ...
    template<typename FirewallPolicyArnT = Aws::String>
    AssociateFirewallPolicyResult& WithFirewallPolicyArn(FirewallPolicyArnT&& value) { SetFirewallPolicyArn(std::forward<FirewallPolicyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdateTokenT = Aws::String>
    AssociateFirewallPolicyResult& WithUpdateToken(UpdateTokenT&& value) { SetUpdateToken(std::forward<UpdateTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AssociateFirewallPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
