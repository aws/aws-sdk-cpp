...
class AssociateFirewallPolicyRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename UpdateTokenT = Aws::String>
  AssociateFirewallPolicyRequest& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename FirewallArnT = Aws::String>
  AssociateFirewallPolicyRequest& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  AssociateFirewallPolicyRequest& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename FirewallPolicyArnT = Aws::String>
  AssociateFirewallPolicyRequest& WithFirewallPolicyArn(FirewallPolicyArnT&& value) {
