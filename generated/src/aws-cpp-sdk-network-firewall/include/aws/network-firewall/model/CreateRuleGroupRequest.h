...
class CreateRuleGroupRequest : public NetworkFirewallRequest {
 public:
  ...
  inline CreateRuleGroupRequest& WithType(RuleGroupType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateRuleGroupRequest& WithCapacity(int value) {
    SetCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline CreateRuleGroupRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAnalyzeRuleGroup(bool value) {
    m_analyzeRuleGroupHasBeenSet = true;
    m_analyzeRuleGroup = value;
  }
  inline CreateRuleGroupRequest& WithAnalyzeRuleGroup(bool value) {
    SetAnalyzeRuleGroup(value);
    return *this;
  }
  ///@}
