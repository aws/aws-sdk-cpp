...
namespace Model
{
  class AcceptNetworkFirewallTransitGatewayAttachmentResult
  {
  public:
    AWS_NETWORKFIREWALL_API AcceptNetworkFirewallTransitGatewayAttachmentResult() = default;
    AWS_NETWORKFIREWALL_API AcceptNetworkFirewallTransitGatewayAttachmentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_NETWORKFIREWALL_API AcceptNetworkFirewallTransitGatewayAttachmentResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename TransitGatewayAttachmentIdT = Aws::String>
    AcceptNetworkFirewallTransitGatewayAttachmentResult& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) { SetTransitGatewayAttachmentId(std::forward<TransitGatewayAttachmentIdT>(value)); return *this;}
    ///@}
    ...
    inline AcceptNetworkFirewallTransitGatewayAttachmentResult& WithTransitGatewayAttachmentStatus(TransitGatewayAttachmentStatus value) { SetTransitGatewayAttachmentStatus(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AcceptNetworkFirewallTransitGatewayAttachmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
