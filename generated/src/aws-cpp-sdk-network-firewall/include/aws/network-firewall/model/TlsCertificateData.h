...
class TlsCertificateData {
 public:
  ...
  template <typename CertificateArnT = Aws::String>
  TlsCertificateData& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename CertificateSerialT = Aws::String>
  TlsCertificateData& WithCertificateSerial(CertificateSerialT&& value) {
  ...
  template <typename StatusT = Aws::String>
  TlsCertificateData& WithStatus(StatusT&& value) {
  ...
  template <typename StatusMessageT = Aws::String>
  TlsCertificateData& WithStatusMessage(StatusMessageT&& value) {
