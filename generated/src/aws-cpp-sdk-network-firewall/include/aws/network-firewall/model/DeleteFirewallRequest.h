...
namespace Model
{
  ...
  /**
   */
  class DeleteFirewallRequest : public NetworkFirewallRequest
  {
  public:
    AWS_NETWORKFIREWALL_API DeleteFirewallRequest();

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "DeleteFirewall"; }
    ...
    inline DeleteFirewallRequest& WithFirewallName(const Aws::String& value) { SetFirewallName(value); return *this;}
    inline DeleteFirewallRequest& WithFirewallName(Aws::String&& value) { SetFirewallName(std::move(value)); return *this;}
    inline DeleteFirewallRequest& WithFirewallName(const char* value) { SetFirewallName(value); return *this;}
    ///@}
    ...
    inline DeleteFirewallRequest& WithFirewallArn(const Aws::String& value) { SetFirewallArn(value); return *this;}
    inline DeleteFirewallRequest& WithFirewallArn(Aws::String&& value) { SetFirewallArn(std::move(value)); return *this;}
    inline DeleteFirewallRequest& WithFirewallArn(const char* value) { SetFirewallArn(value); return *this;}
    ///@}
  private:
