...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKFIREWALL_API DeleteFirewallRequest() = default;
    ...
    template<typename FirewallNameT = Aws::String>
    DeleteFirewallRequest& WithFirewallName(FirewallNameT&& value) { SetFirewallName(std::forward<FirewallNameT>(value)); return *this;}
    ///@}
    ...
    template<typename FirewallArnT = Aws::String>
    DeleteFirewallRequest& WithFirewallArn(FirewallArnT&& value) { SetFirewallArn(std::forward<FirewallArnT>(value)); return *this;}
    ///@}
  private:
