...
class LogDestinationConfig {
 public:
  ...
  inline LogDestinationConfig& WithLogType(LogType value) {
    SetLogType(value);
    return *this;
  }
  ///@}
  ...
  inline LogDestinationConfig& WithLogDestinationType(LogDestinationType value) {
  ...
  LogDestinationConfig& AddLogDestination(LogDestinationKeyT&& key, LogDestinationValueT&& value) {
    m_logDestinationHasBeenSet = true;
    m_logDestination.emplace(std::forward<LogDestinationKeyT>(key), std::forward<LogDestinationValueT>(value));
    return *this;
  }
  ///@}
 private:
