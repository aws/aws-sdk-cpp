...
class ServerCertificateConfiguration {
 public:
   ...
   */
  inline const CheckCertificateRevocationStatusActions& GetCheckCertificateRevocationStatus() const {
    return m_checkCertificateRevocationStatus;
  }
  ...
  void SetCheckCertificateRevocationStatus(CheckCertificateRevocationStatusT&& value) {
    ...
    m_checkCertificateRevocationStatus = std::forward<CheckCertificateRevocationStatusT>(value);
  }
  template <typename CheckCertificateRevocationStatusT = CheckCertificateRevocationStatusActions>
  ServerCertificateConfiguration& WithCheckCertificateRevocationStatus(CheckCertificateRevocationStatusT&& value) {
    SetCheckCertificateRevocationStatus(std::forward<CheckCertificateRevocationStatusT>(value));
    return *this;
  }
  ///@}
 private:
