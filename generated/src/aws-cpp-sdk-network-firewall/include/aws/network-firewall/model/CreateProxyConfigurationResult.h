...
namespace Model {
class CreateProxyConfigurationResult {
 public:
  AWS_NETWORKFIREWALL_API CreateProxyConfigurationResult() = default;
  AWS_NETWORKFIREWALL_API CreateProxyConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API CreateProxyConfigurationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProxyConfigurationT = ProxyConfiguration>
  CreateProxyConfigurationResult& WithProxyConfiguration(ProxyConfigurationT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateProxyConfigurationResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateProxyConfigurationResult& WithRequestId(RequestIdT&& value) {
