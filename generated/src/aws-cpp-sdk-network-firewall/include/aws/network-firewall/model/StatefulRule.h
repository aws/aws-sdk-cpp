 ...
 * href="https://suricata.readthedocs.io/en/suricata-7.0.8/rules/intro.html">Rules
...
class StatefulRule {
 public:
  ...
  inline void SetAction(StatefulAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline StatefulRule& WithAction(StatefulAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetRuleOptions(RuleOptionsT&& value) {
    ...
    m_ruleOptions = std::forward<RuleOptionsT>(value);
  }
  template <typename RuleOptionsT = Aws::Vector<RuleOption>>
  StatefulRule& WithRuleOptions(RuleOptionsT&& value) {
    SetRuleOptions(std::forward<RuleOptionsT>(value));
    return *this;
  }
  template <typename RuleOptionsT = RuleOption>
  StatefulRule& AddRuleOptions(RuleOptionsT&& value) {
    m_ruleOptionsHasBeenSet = true;
    m_ruleOptions.emplace_back(std::forward<RuleOptionsT>(value));
    return *this;
  }
  ///@}
 private:
