...
namespace Model {
class CreateProxyResult {
 public:
  AWS_NETWORKFIREWALL_API CreateProxyResult() = default;
  AWS_NETWORKFIREWALL_API CreateProxyResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API CreateProxyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProxyT = Proxy>
  CreateProxyResult& WithProxy(ProxyT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateProxyResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateProxyResult& WithRequestId(RequestIdT&& value) {
