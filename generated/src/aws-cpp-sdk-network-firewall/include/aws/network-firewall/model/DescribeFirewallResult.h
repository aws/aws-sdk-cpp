...
class DescribeFirewallResult {
 public:
  ...
  template <typename UpdateTokenT = Aws::String>
  DescribeFirewallResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename FirewallT = Firewall>
  DescribeFirewallResult& WithFirewall(FirewallT&& value) {
  ...
  template <typename FirewallStatusT = FirewallStatus>
  DescribeFirewallResult& WithFirewallStatus(FirewallStatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFirewallResult& WithRequestId(RequestIdT&& value) {
