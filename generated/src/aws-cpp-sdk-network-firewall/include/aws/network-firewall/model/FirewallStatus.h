...
class FirewallStatus {
 public:
  ...
  inline void SetStatus(FirewallStatusValue value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline FirewallStatus& WithStatus(FirewallStatusValue value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConfigurationSyncStateSummary(ConfigurationSyncState value) {
    m_configurationSyncStateSummaryHasBeenSet = true;
    m_configurationSyncStateSummary = value;
  }
  inline FirewallStatus& WithConfigurationSyncStateSummary(ConfigurationSyncState value) {
    SetConfigurationSyncStateSummary(value);
    return *this;
  }
  ///@}
  ...
  void SetSyncStates(SyncStatesT&& value) {
    m_syncStatesHasBeenSet = true;
    m_syncStates = std::forward<SyncStatesT>(value);
  }
  template <typename SyncStatesT = Aws::Map<Aws::String, SyncState>>
  FirewallStatus& WithSyncStates(SyncStatesT&& value) {
    SetSyncStates(std::forward<SyncStatesT>(value));
    return *this;
  }
  ...
  FirewallStatus& AddSyncStates(SyncStatesKeyT&& key, SyncStatesValueT&& value) {
    m_syncStatesHasBeenSet = true;
    m_syncStates.emplace(std::forward<SyncStatesKeyT>(key), std::forward<SyncStatesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCapacityUsageSummary(CapacityUsageSummaryT&& value) {
    m_capacityUsageSummaryHasBeenSet = true;
    m_capacityUsageSummary = std::forward<CapacityUsageSummaryT>(value);
  }
  template <typename CapacityUsageSummaryT = CapacityUsageSummary>
  FirewallStatus& WithCapacityUsageSummary(CapacityUsageSummaryT&& value) {
    SetCapacityUsageSummary(std::forward<CapacityUsageSummaryT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const TransitGatewayAttachmentSyncState& GetTransitGatewayAttachmentSyncState() const {
    return m_transitGatewayAttachmentSyncState;
  }
  ...
  void SetTransitGatewayAttachmentSyncState(TransitGatewayAttachmentSyncStateT&& value) {
    m_transitGatewayAttachmentSyncStateHasBeenSet = true;
    m_transitGatewayAttachmentSyncState = std::forward<TransitGatewayAttachmentSyncStateT>(value);
  }
  template <typename TransitGatewayAttachmentSyncStateT = TransitGatewayAttachmentSyncState>
  FirewallStatus& WithTransitGatewayAttachmentSyncState(TransitGatewayAttachmentSyncStateT&& value) {
    SetTransitGatewayAttachmentSyncState(std::forward<TransitGatewayAttachmentSyncStateT>(value));
    return *this;
  }
  ///@}
 private:
