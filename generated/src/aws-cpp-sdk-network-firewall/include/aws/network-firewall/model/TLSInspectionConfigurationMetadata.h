...
class TLSInspectionConfigurationMetadata {
 public:
  AWS_NETWORKFIREWALL_API TLSInspectionConfigurationMetadata() = default;
  ...
  template <typename NameT = Aws::String>
  TLSInspectionConfigurationMetadata& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  TLSInspectionConfigurationMetadata& WithArn(ArnT&& value) {
