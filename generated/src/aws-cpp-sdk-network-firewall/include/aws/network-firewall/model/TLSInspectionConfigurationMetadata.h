...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    TLSInspectionConfigurationMetadata& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    TLSInspectionConfigurationMetadata& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
