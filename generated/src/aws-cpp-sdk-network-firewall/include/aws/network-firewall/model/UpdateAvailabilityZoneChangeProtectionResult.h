...
class UpdateAvailabilityZoneChangeProtectionResult {
 public:
  ...
  AWS_NETWORKFIREWALL_API UpdateAvailabilityZoneChangeProtectionResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API UpdateAvailabilityZoneChangeProtectionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateAvailabilityZoneChangeProtectionResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename FirewallArnT = Aws::String>
  UpdateAvailabilityZoneChangeProtectionResult& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  UpdateAvailabilityZoneChangeProtectionResult& WithFirewallName(FirewallNameT&& value) {
  ...
  inline UpdateAvailabilityZoneChangeProtectionResult& WithAvailabilityZoneChangeProtection(bool value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAvailabilityZoneChangeProtectionResult& WithRequestId(RequestIdT&& value) {
