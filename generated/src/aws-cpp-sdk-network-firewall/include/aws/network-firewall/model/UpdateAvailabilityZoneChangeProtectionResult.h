...
namespace Model
{
  class UpdateAvailabilityZoneChangeProtectionResult
  {
  public:
    AWS_NETWORKFIREWALL_API UpdateAvailabilityZoneChangeProtectionResult() = default;
    AWS_NETWORKFIREWALL_API UpdateAvailabilityZoneChangeProtectionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_NETWORKFIREWALL_API UpdateAvailabilityZoneChangeProtectionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename UpdateTokenT = Aws::String>
    UpdateAvailabilityZoneChangeProtectionResult& WithUpdateToken(UpdateTokenT&& value) { SetUpdateToken(std::forward<UpdateTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename FirewallArnT = Aws::String>
    UpdateAvailabilityZoneChangeProtectionResult& WithFirewallArn(FirewallArnT&& value) { SetFirewallArn(std::forward<FirewallArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FirewallNameT = Aws::String>
    UpdateAvailabilityZoneChangeProtectionResult& WithFirewallName(FirewallNameT&& value) { SetFirewallName(std::forward<FirewallNameT>(value)); return *this;}
    ///@}
    ...
    inline UpdateAvailabilityZoneChangeProtectionResult& WithAvailabilityZoneChangeProtection(bool value) { SetAvailabilityZoneChangeProtection(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateAvailabilityZoneChangeProtectionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
