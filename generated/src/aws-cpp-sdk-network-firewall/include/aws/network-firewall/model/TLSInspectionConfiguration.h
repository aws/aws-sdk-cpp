...
class TLSInspectionConfiguration {
 public:
   ...
   * configuration.</p>
   */
  inline const Aws::Vector<ServerCertificateConfiguration>& GetServerCertificateConfigurations() const {
    return m_serverCertificateConfigurations;
  }
  ...
  void SetServerCertificateConfigurations(ServerCertificateConfigurationsT&& value) {
    m_serverCertificateConfigurationsHasBeenSet = true;
    m_serverCertificateConfigurations = std::forward<ServerCertificateConfigurationsT>(value);
  }
  template <typename ServerCertificateConfigurationsT = Aws::Vector<ServerCertificateConfiguration>>
  TLSInspectionConfiguration& WithServerCertificateConfigurations(ServerCertificateConfigurationsT&& value) {
    SetServerCertificateConfigurations(std::forward<ServerCertificateConfigurationsT>(value));
    return *this;
  }
  template <typename ServerCertificateConfigurationsT = ServerCertificateConfiguration>
  TLSInspectionConfiguration& AddServerCertificateConfigurations(ServerCertificateConfigurationsT&& value) {
    m_serverCertificateConfigurationsHasBeenSet = true;
    m_serverCertificateConfigurations.emplace_back(std::forward<ServerCertificateConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
