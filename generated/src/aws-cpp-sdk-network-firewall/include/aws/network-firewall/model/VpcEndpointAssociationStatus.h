...
class VpcEndpointAssociationStatus {
 public:
  ...
  inline VpcEndpointAssociationStatus& WithStatus(FirewallStatusValue value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAssociationSyncState(AssociationSyncStateT&& value) {
    m_associationSyncStateHasBeenSet = true;
    m_associationSyncState = std::forward<AssociationSyncStateT>(value);
  }
  template <typename AssociationSyncStateT = Aws::Map<Aws::String, AZSyncState>>
  VpcEndpointAssociationStatus& WithAssociationSyncState(AssociationSyncStateT&& value) {
    SetAssociationSyncState(std::forward<AssociationSyncStateT>(value));
    return *this;
  }
  ...
  VpcEndpointAssociationStatus& AddAssociationSyncState(AssociationSyncStateKeyT&& key, AssociationSyncStateValueT&& value) {
    m_associationSyncStateHasBeenSet = true;
    m_associationSyncState.emplace(std::forward<AssociationSyncStateKeyT>(key), std::forward<AssociationSyncStateValueT>(value));
    return *this;
  }
  ///@}
 private:
