...
class UpdateFirewallPolicyResult {
 public:
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateFirewallPolicyResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename FirewallPolicyResponseT = FirewallPolicyResponse>
  UpdateFirewallPolicyResult& WithFirewallPolicyResponse(FirewallPolicyResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFirewallPolicyResult& WithRequestId(RequestIdT&& value) {
