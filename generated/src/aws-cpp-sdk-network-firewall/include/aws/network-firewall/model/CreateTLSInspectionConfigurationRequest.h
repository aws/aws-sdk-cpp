...
class CreateTLSInspectionConfigurationRequest : public NetworkFirewallRequest {
 public:
  ...
  template <typename TLSInspectionConfigurationNameT = Aws::String>
  CreateTLSInspectionConfigurationRequest& WithTLSInspectionConfigurationName(TLSInspectionConfigurationNameT&& value) {
  ...
  template <typename TLSInspectionConfigurationT = TLSInspectionConfiguration>
  CreateTLSInspectionConfigurationRequest& WithTLSInspectionConfiguration(TLSInspectionConfigurationT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateTLSInspectionConfigurationRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateTLSInspectionConfigurationRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateTLSInspectionConfigurationRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename EncryptionConfigurationT = EncryptionConfiguration>
  CreateTLSInspectionConfigurationRequest& WithEncryptionConfiguration(EncryptionConfigurationT&& value) {
