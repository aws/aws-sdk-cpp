...
class FirewallPolicy {
 public:
  ...
  void SetStatelessRuleGroupReferences(StatelessRuleGroupReferencesT&& value) {
    ...
    m_statelessRuleGroupReferences = std::forward<StatelessRuleGroupReferencesT>(value);
  }
  template <typename StatelessRuleGroupReferencesT = Aws::Vector<StatelessRuleGroupReference>>
  FirewallPolicy& WithStatelessRuleGroupReferences(StatelessRuleGroupReferencesT&& value) {
    SetStatelessRuleGroupReferences(std::forward<StatelessRuleGroupReferencesT>(value));
    return *this;
  }
  ...
  FirewallPolicy& AddStatelessRuleGroupReferences(StatelessRuleGroupReferencesT&& value) {
    m_statelessRuleGroupReferencesHasBeenSet = true;
    m_statelessRuleGroupReferences.emplace_back(std::forward<StatelessRuleGroupReferencesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatelessDefaultActions(StatelessDefaultActionsT&& value) {
    ...
    m_statelessDefaultActions = std::forward<StatelessDefaultActionsT>(value);
  }
  template <typename StatelessDefaultActionsT = Aws::Vector<Aws::String>>
  FirewallPolicy& WithStatelessDefaultActions(StatelessDefaultActionsT&& value) {
    SetStatelessDefaultActions(std::forward<StatelessDefaultActionsT>(value));
    return *this;
  }
  ...
  FirewallPolicy& AddStatelessDefaultActions(StatelessDefaultActionsT&& value) {
    m_statelessDefaultActionsHasBeenSet = true;
    m_statelessDefaultActions.emplace_back(std::forward<StatelessDefaultActionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatelessFragmentDefaultActions(StatelessFragmentDefaultActionsT&& value) {
    ...
    m_statelessFragmentDefaultActions = std::forward<StatelessFragmentDefaultActionsT>(value);
  }
  template <typename StatelessFragmentDefaultActionsT = Aws::Vector<Aws::String>>
  FirewallPolicy& WithStatelessFragmentDefaultActions(StatelessFragmentDefaultActionsT&& value) {
    SetStatelessFragmentDefaultActions(std::forward<StatelessFragmentDefaultActionsT>(value));
    return *this;
  }
  ...
  FirewallPolicy& AddStatelessFragmentDefaultActions(StatelessFragmentDefaultActionsT&& value) {
    m_statelessFragmentDefaultActionsHasBeenSet = true;
    m_statelessFragmentDefaultActions.emplace_back(std::forward<StatelessFragmentDefaultActionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatelessCustomActions(StatelessCustomActionsT&& value) {
    ...
    m_statelessCustomActions = std::forward<StatelessCustomActionsT>(value);
  }
  template <typename StatelessCustomActionsT = Aws::Vector<CustomAction>>
  FirewallPolicy& WithStatelessCustomActions(StatelessCustomActionsT&& value) {
    SetStatelessCustomActions(std::forward<StatelessCustomActionsT>(value));
    return *this;
  }
  ...
  FirewallPolicy& AddStatelessCustomActions(StatelessCustomActionsT&& value) {
    m_statelessCustomActionsHasBeenSet = true;
    m_statelessCustomActions.emplace_back(std::forward<StatelessCustomActionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatefulRuleGroupReferences(StatefulRuleGroupReferencesT&& value) {
    ...
    m_statefulRuleGroupReferences = std::forward<StatefulRuleGroupReferencesT>(value);
  }
  template <typename StatefulRuleGroupReferencesT = Aws::Vector<StatefulRuleGroupReference>>
  FirewallPolicy& WithStatefulRuleGroupReferences(StatefulRuleGroupReferencesT&& value) {
    SetStatefulRuleGroupReferences(std::forward<StatefulRuleGroupReferencesT>(value));
    return *this;
  }
  ...
  FirewallPolicy& AddStatefulRuleGroupReferences(StatefulRuleGroupReferencesT&& value) {
    m_statefulRuleGroupReferencesHasBeenSet = true;
    m_statefulRuleGroupReferences.emplace_back(std::forward<StatefulRuleGroupReferencesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatefulDefaultActions(StatefulDefaultActionsT&& value) {
    ...
    m_statefulDefaultActions = std::forward<StatefulDefaultActionsT>(value);
  }
  template <typename StatefulDefaultActionsT = Aws::Vector<Aws::String>>
  FirewallPolicy& WithStatefulDefaultActions(StatefulDefaultActionsT&& value) {
    SetStatefulDefaultActions(std::forward<StatefulDefaultActionsT>(value));
    return *this;
  }
  ...
  FirewallPolicy& AddStatefulDefaultActions(StatefulDefaultActionsT&& value) {
    m_statefulDefaultActionsHasBeenSet = true;
    m_statefulDefaultActions.emplace_back(std::forward<StatefulDefaultActionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatefulEngineOptions(StatefulEngineOptionsT&& value) {
    ...
    m_statefulEngineOptions = std::forward<StatefulEngineOptionsT>(value);
  }
  template <typename StatefulEngineOptionsT = StatefulEngineOptions>
  FirewallPolicy& WithStatefulEngineOptions(StatefulEngineOptionsT&& value) {
    SetStatefulEngineOptions(std::forward<StatefulEngineOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPolicyVariables(PolicyVariablesT&& value) {
    ...
    m_policyVariables = std::forward<PolicyVariablesT>(value);
  }
  template <typename PolicyVariablesT = PolicyVariables>
  FirewallPolicy& WithPolicyVariables(PolicyVariablesT&& value) {
    SetPolicyVariables(std::forward<PolicyVariablesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEnableTLSSessionHolding(bool value) {
    m_enableTLSSessionHoldingHasBeenSet = true;
    m_enableTLSSessionHolding = value;
  }
  inline FirewallPolicy& WithEnableTLSSessionHolding(bool value) {
    SetEnableTLSSessionHolding(value);
    return *this;
  }
  ///@}
 private:
