...
namespace Model {
class AttachRuleGroupsToProxyConfigurationResult {
 public:
  AWS_NETWORKFIREWALL_API AttachRuleGroupsToProxyConfigurationResult() = default;
  AWS_NETWORKFIREWALL_API AttachRuleGroupsToProxyConfigurationResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKFIREWALL_API AttachRuleGroupsToProxyConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProxyConfigurationT = ProxyConfiguration>
  AttachRuleGroupsToProxyConfigurationResult& WithProxyConfiguration(ProxyConfigurationT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  AttachRuleGroupsToProxyConfigurationResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AttachRuleGroupsToProxyConfigurationResult& WithRequestId(RequestIdT&& value) {
