...
class DisassociateSubnetsResult {
 public:
  ...
  template <typename FirewallArnT = Aws::String>
  DisassociateSubnetsResult& WithFirewallArn(FirewallArnT&& value) {
  ...
  template <typename FirewallNameT = Aws::String>
  DisassociateSubnetsResult& WithFirewallName(FirewallNameT&& value) {
  ...
  template <typename SubnetMappingsT = Aws::Vector<SubnetMapping>>
  DisassociateSubnetsResult& WithSubnetMappings(SubnetMappingsT&& value) {
    SetSubnetMappings(std::forward<SubnetMappingsT>(value));
    return *this;
  }
  template <typename SubnetMappingsT = SubnetMapping>
  DisassociateSubnetsResult& AddSubnetMappings(SubnetMappingsT&& value) {
    m_subnetMappingsHasBeenSet = true;
  ...
  template <typename UpdateTokenT = Aws::String>
  DisassociateSubnetsResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateSubnetsResult& WithRequestId(RequestIdT&& value) {
