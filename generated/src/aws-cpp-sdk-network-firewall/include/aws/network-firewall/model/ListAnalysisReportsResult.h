...
class ListAnalysisReportsResult {
 public:
  ...
  template <typename AnalysisReportsT = Aws::Vector<AnalysisReport>>
  ListAnalysisReportsResult& WithAnalysisReports(AnalysisReportsT&& value) {
    SetAnalysisReports(std::forward<AnalysisReportsT>(value));
    return *this;
  }
  template <typename AnalysisReportsT = AnalysisReport>
  ListAnalysisReportsResult& AddAnalysisReports(AnalysisReportsT&& value) {
    m_analysisReportsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAnalysisReportsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAnalysisReportsResult& WithRequestId(RequestIdT&& value) {
