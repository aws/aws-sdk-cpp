...
class ListVpcEndpointAssociationsResult {
 public:
  ...
  AWS_NETWORKFIREWALL_API ListVpcEndpointAssociationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListVpcEndpointAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VpcEndpointAssociationsT = Aws::Vector<VpcEndpointAssociationMetadata>>
  ListVpcEndpointAssociationsResult& WithVpcEndpointAssociations(VpcEndpointAssociationsT&& value) {
  ...
  ListVpcEndpointAssociationsResult& AddVpcEndpointAssociations(VpcEndpointAssociationsT&& value) {
    m_vpcEndpointAssociationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListVpcEndpointAssociationsResult& WithRequestId(RequestIdT&& value) {
