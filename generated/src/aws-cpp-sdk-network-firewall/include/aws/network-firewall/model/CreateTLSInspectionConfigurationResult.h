...
class CreateTLSInspectionConfigurationResult {
 public:
  ...
  AWS_NETWORKFIREWALL_API CreateTLSInspectionConfigurationResult& operator=(
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateTLSInspectionConfigurationResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  template <typename TLSInspectionConfigurationResponseT = TLSInspectionConfigurationResponse>
  CreateTLSInspectionConfigurationResult& WithTLSInspectionConfigurationResponse(TLSInspectionConfigurationResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTLSInspectionConfigurationResult& WithRequestId(RequestIdT&& value) {
