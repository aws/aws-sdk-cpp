...
namespace Model
{
  ...
  /**
   */
  class DeleteVpcEndpointAssociationRequest : public NetworkFirewallRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteVpcEndpointAssociation"; }
    ...
    template<typename VpcEndpointAssociationArnT = Aws::String>
    DeleteVpcEndpointAssociationRequest& WithVpcEndpointAssociationArn(VpcEndpointAssociationArnT&& value) { SetVpcEndpointAssociationArn(std::forward<VpcEndpointAssociationArnT>(value)); return *this;}
    ///@}
  private:
