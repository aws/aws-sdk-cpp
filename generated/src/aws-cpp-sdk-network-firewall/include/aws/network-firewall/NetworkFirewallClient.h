...
class AWS_NETWORKFIREWALL_API NetworkFirewallClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  NetworkFirewallClient(const Aws::NetworkFirewall::NetworkFirewallClientConfiguration& clientConfiguration =
  ...
  NetworkFirewallClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<NetworkFirewallEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::NetworkFirewall::NetworkFirewallClientConfiguration& clientConfiguration =
                            Aws::NetworkFirewall::NetworkFirewallClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AcceptNetworkFirewallTransitGatewayAttachmentOutcome AcceptNetworkFirewallTransitGatewayAttachment(
      const Model::AcceptNetworkFirewallTransitGatewayAttachmentRequest& request) const;

  /**
   * A Callable wrapper for AcceptNetworkFirewallTransitGatewayAttachment that returns a future to the operation so that it can be executed
  ...
  Model::AcceptNetworkFirewallTransitGatewayAttachmentOutcomeCallable AcceptNetworkFirewallTransitGatewayAttachmentCallable(
      const AcceptNetworkFirewallTransitGatewayAttachmentRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::AcceptNetworkFirewallTransitGatewayAttachment, request);
  }

  /**
   * An Async wrapper for AcceptNetworkFirewallTransitGatewayAttachment that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename AcceptNetworkFirewallTransitGatewayAttachmentRequestT = Model::AcceptNetworkFirewallTransitGatewayAttachmentRequest>
  void AcceptNetworkFirewallTransitGatewayAttachmentAsync(
      const AcceptNetworkFirewallTransitGatewayAttachmentRequestT& request,
      const AcceptNetworkFirewallTransitGatewayAttachmentResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateAvailabilityZonesOutcome AssociateAvailabilityZones(
      const Model::AssociateAvailabilityZonesRequest& request) const;

  /**
   * A Callable wrapper for AssociateAvailabilityZones that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateAvailabilityZonesRequestT = Model::AssociateAvailabilityZonesRequest>
  Model::AssociateAvailabilityZonesOutcomeCallable AssociateAvailabilityZonesCallable(
      const AssociateAvailabilityZonesRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::AssociateAvailabilityZones, request);
  }

  /**
   * An Async wrapper for AssociateAvailabilityZones that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateAvailabilityZonesRequestT = Model::AssociateAvailabilityZonesRequest>
  void AssociateAvailabilityZonesAsync(const AssociateAvailabilityZonesRequestT& request,
                                       const AssociateAvailabilityZonesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateFirewallPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateFirewallPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateFirewallPolicyRequestT = Model::AssociateFirewallPolicyRequest>
  void AssociateFirewallPolicyAsync(const AssociateFirewallPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for AssociateSubnets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateSubnets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociateSubnetsRequestT = Model::AssociateSubnetsRequest>
  void AssociateSubnetsAsync(const AssociateSubnetsRequestT& request, const AssociateSubnetsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateFirewall that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFirewallRequestT = Model::CreateFirewallRequest>
  void CreateFirewallAsync(const CreateFirewallRequestT& request, const CreateFirewallResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateFirewallPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateFirewallPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFirewallPolicyRequestT = Model::CreateFirewallPolicyRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateTLSInspectionConfigurationOutcome CreateTLSInspectionConfiguration(
      const Model::CreateTLSInspectionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateTLSInspectionConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateTLSInspectionConfigurationRequestT = Model::CreateTLSInspectionConfigurationRequest>
  Model::CreateTLSInspectionConfigurationOutcomeCallable CreateTLSInspectionConfigurationCallable(
      const CreateTLSInspectionConfigurationRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::CreateTLSInspectionConfiguration, request);
  }

  /**
   * An Async wrapper for CreateTLSInspectionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateTLSInspectionConfigurationRequestT = Model::CreateTLSInspectionConfigurationRequest>
  void CreateTLSInspectionConfigurationAsync(const CreateTLSInspectionConfigurationRequestT& request,
                                             const CreateTLSInspectionConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateVpcEndpointAssociationOutcome CreateVpcEndpointAssociation(
      const Model::CreateVpcEndpointAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateVpcEndpointAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateVpcEndpointAssociationRequestT = Model::CreateVpcEndpointAssociationRequest>
  Model::CreateVpcEndpointAssociationOutcomeCallable CreateVpcEndpointAssociationCallable(
      const CreateVpcEndpointAssociationRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::CreateVpcEndpointAssociation, request);
  }

  /**
   * An Async wrapper for CreateVpcEndpointAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateVpcEndpointAssociationRequestT = Model::CreateVpcEndpointAssociationRequest>
  void CreateVpcEndpointAssociationAsync(const CreateVpcEndpointAssociationRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteFirewall that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFirewallRequestT = Model::DeleteFirewallRequest>
  void DeleteFirewallAsync(const DeleteFirewallResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DeleteFirewallRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteFirewallPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteFirewallPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteFirewallPolicyRequestT = Model::DeleteFirewallPolicyRequest>
  void DeleteFirewallPolicyAsync(const DeleteFirewallPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DeleteFirewallPolicyRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteNetworkFirewallTransitGatewayAttachmentOutcome DeleteNetworkFirewallTransitGatewayAttachment(
      const Model::DeleteNetworkFirewallTransitGatewayAttachmentRequest& request) const;

  /**
   * A Callable wrapper for DeleteNetworkFirewallTransitGatewayAttachment that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::DeleteNetworkFirewallTransitGatewayAttachmentOutcomeCallable DeleteNetworkFirewallTransitGatewayAttachmentCallable(
      const DeleteNetworkFirewallTransitGatewayAttachmentRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::DeleteNetworkFirewallTransitGatewayAttachment, request);
  }

  /**
   * An Async wrapper for DeleteNetworkFirewallTransitGatewayAttachment that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DeleteNetworkFirewallTransitGatewayAttachmentRequestT = Model::DeleteNetworkFirewallTransitGatewayAttachmentRequest>
  void DeleteNetworkFirewallTransitGatewayAttachmentAsync(
      const DeleteNetworkFirewallTransitGatewayAttachmentRequestT& request,
   ...
   */
  template <typename DeleteRuleGroupRequestT = Model::DeleteRuleGroupRequest>
  void DeleteRuleGroupAsync(const DeleteRuleGroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const DeleteRuleGroupRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteTLSInspectionConfigurationOutcome DeleteTLSInspectionConfiguration(
      const Model::DeleteTLSInspectionConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteTLSInspectionConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteTLSInspectionConfigurationRequestT = Model::DeleteTLSInspectionConfigurationRequest>
  Model::DeleteTLSInspectionConfigurationOutcomeCallable DeleteTLSInspectionConfigurationCallable(
      const DeleteTLSInspectionConfigurationRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::DeleteTLSInspectionConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteTLSInspectionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteTLSInspectionConfigurationRequestT = Model::DeleteTLSInspectionConfigurationRequest>
  void DeleteTLSInspectionConfigurationAsync(const DeleteTLSInspectionConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const DeleteTLSInspectionConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteVpcEndpointAssociationOutcome DeleteVpcEndpointAssociation(
      const Model::DeleteVpcEndpointAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteVpcEndpointAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteVpcEndpointAssociationRequestT = Model::DeleteVpcEndpointAssociationRequest>
  Model::DeleteVpcEndpointAssociationOutcomeCallable DeleteVpcEndpointAssociationCallable(
      const DeleteVpcEndpointAssociationRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::DeleteVpcEndpointAssociation, request);
  }

  /**
   * An Async wrapper for DeleteVpcEndpointAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteVpcEndpointAssociationRequestT = Model::DeleteVpcEndpointAssociationRequest>
  void DeleteVpcEndpointAssociationAsync(const DeleteVpcEndpointAssociationRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeFirewall that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFirewall that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeFirewallRequestT = Model::DescribeFirewallRequest>
  void DescribeFirewallAsync(const DescribeFirewallResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DescribeFirewallRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeFirewallMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeFirewallMetadataRequestT = Model::DescribeFirewallMetadataRequest>
  Model::DescribeFirewallMetadataOutcomeCallable DescribeFirewallMetadataCallable(
      const DescribeFirewallMetadataRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::DescribeFirewallMetadata, request);
  }

  /**
   * An Async wrapper for DescribeFirewallMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFirewallMetadataRequestT = Model::DescribeFirewallMetadataRequest>
  void DescribeFirewallMetadataAsync(const DescribeFirewallMetadataResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeFirewallMetadataRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeFirewallPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFirewallPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFirewallPolicyRequestT = Model::DescribeFirewallPolicyRequest>
  void DescribeFirewallPolicyAsync(const DescribeFirewallPolicyResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribeFirewallPolicyRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeFlowOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFlowOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFlowOperationRequestT = Model::DescribeFlowOperationRequest>
  void DescribeFlowOperationAsync(const DescribeFlowOperationRequestT& request, const DescribeFlowOperationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeLoggingConfigurationOutcome DescribeLoggingConfiguration(
      const Model::DescribeLoggingConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeLoggingConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeLoggingConfigurationRequestT = Model::DescribeLoggingConfigurationRequest>
  Model::DescribeLoggingConfigurationOutcomeCallable DescribeLoggingConfigurationCallable(
      const DescribeLoggingConfigurationRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::DescribeLoggingConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeLoggingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeLoggingConfigurationRequestT = Model::DescribeLoggingConfigurationRequest>
  void DescribeLoggingConfigurationAsync(const DescribeLoggingConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeLoggingConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeResourcePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeResourcePolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeResourcePolicyRequestT = Model::DescribeResourcePolicyRequest>
  void DescribeResourcePolicyAsync(const DescribeResourcePolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeRuleGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRuleGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeRuleGroupRequestT = Model::DescribeRuleGroupRequest>
  void DescribeRuleGroupAsync(const DescribeRuleGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeRuleGroupRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRuleGroupMetadataOutcome DescribeRuleGroupMetadata(
      const Model::DescribeRuleGroupMetadataRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeRuleGroupMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeRuleGroupMetadataRequestT = Model::DescribeRuleGroupMetadataRequest>
  Model::DescribeRuleGroupMetadataOutcomeCallable DescribeRuleGroupMetadataCallable(
      const DescribeRuleGroupMetadataRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::DescribeRuleGroupMetadata, request);
  }

  /**
   * An Async wrapper for DescribeRuleGroupMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRuleGroupMetadataRequestT = Model::DescribeRuleGroupMetadataRequest>
  void DescribeRuleGroupMetadataAsync(const DescribeRuleGroupMetadataResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeRuleGroupMetadataRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeRuleGroupSummary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeRuleGroupSummaryRequestT = Model::DescribeRuleGroupSummaryRequest>
  Model::DescribeRuleGroupSummaryOutcomeCallable DescribeRuleGroupSummaryCallable(
      const DescribeRuleGroupSummaryRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::DescribeRuleGroupSummary, request);
  }

  /**
   * An Async wrapper for DescribeRuleGroupSummary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRuleGroupSummaryRequestT = Model::DescribeRuleGroupSummaryRequest>
  void DescribeRuleGroupSummaryAsync(const DescribeRuleGroupSummaryResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeRuleGroupSummaryRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTLSInspectionConfigurationOutcome DescribeTLSInspectionConfiguration(
      const Model::DescribeTLSInspectionConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeTLSInspectionConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeTLSInspectionConfigurationRequestT = Model::DescribeTLSInspectionConfigurationRequest>
  Model::DescribeTLSInspectionConfigurationOutcomeCallable DescribeTLSInspectionConfigurationCallable(
      const DescribeTLSInspectionConfigurationRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::DescribeTLSInspectionConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeTLSInspectionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeTLSInspectionConfigurationRequestT = Model::DescribeTLSInspectionConfigurationRequest>
  void DescribeTLSInspectionConfigurationAsync(const DescribeTLSInspectionConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const DescribeTLSInspectionConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeVpcEndpointAssociationOutcome DescribeVpcEndpointAssociation(
      const Model::DescribeVpcEndpointAssociationRequest& request) const;

  /**
   * A Callable wrapper for DescribeVpcEndpointAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeVpcEndpointAssociationRequestT = Model::DescribeVpcEndpointAssociationRequest>
  Model::DescribeVpcEndpointAssociationOutcomeCallable DescribeVpcEndpointAssociationCallable(
      const DescribeVpcEndpointAssociationRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::DescribeVpcEndpointAssociation, request);
  }

  /**
   * An Async wrapper for DescribeVpcEndpointAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeVpcEndpointAssociationRequestT = Model::DescribeVpcEndpointAssociationRequest>
  void DescribeVpcEndpointAssociationAsync(const DescribeVpcEndpointAssociationRequestT& request,
  ...
  virtual Model::DisassociateAvailabilityZonesOutcome DisassociateAvailabilityZones(
      const Model::DisassociateAvailabilityZonesRequest& request) const;

  /**
   * A Callable wrapper for DisassociateAvailabilityZones that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateAvailabilityZonesRequestT = Model::DisassociateAvailabilityZonesRequest>
  Model::DisassociateAvailabilityZonesOutcomeCallable DisassociateAvailabilityZonesCallable(
      const DisassociateAvailabilityZonesRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::DisassociateAvailabilityZones, request);
  }

  /**
   * An Async wrapper for DisassociateAvailabilityZones that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateAvailabilityZonesRequestT = Model::DisassociateAvailabilityZonesRequest>
  void DisassociateAvailabilityZonesAsync(const DisassociateAvailabilityZonesRequestT& request,
                                          const DisassociateAvailabilityZonesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateSubnets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateSubnets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateSubnetsRequestT = Model::DisassociateSubnetsRequest>
  void DisassociateSubnetsAsync(const DisassociateSubnetsRequestT& request, const DisassociateSubnetsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAnalysisReportResults that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAnalysisReportResults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAnalysisReportResultsRequestT = Model::GetAnalysisReportResultsRequest>
  void GetAnalysisReportResultsAsync(const GetAnalysisReportResultsRequestT& request,
                                     const GetAnalysisReportResultsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAnalysisReports that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAnalysisReports that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAnalysisReportsRequestT = Model::ListAnalysisReportsRequest>
  void ListAnalysisReportsAsync(const ListAnalysisReportsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
  ...
  /**
   * A Callable wrapper for ListFirewallPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFirewallPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFirewallPoliciesRequestT = Model::ListFirewallPoliciesRequest>
  void ListFirewallPoliciesAsync(const ListFirewallPoliciesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListFirewallPoliciesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListFirewalls that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFirewallsRequestT = Model::ListFirewallsRequest>
  void ListFirewallsAsync(const ListFirewallsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListFirewallsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFlowOperationResults that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFlowOperationResults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFlowOperationResultsRequestT = Model::ListFlowOperationResultsRequest>
  void ListFlowOperationResultsAsync(const ListFlowOperationResultsRequestT& request,
                                     const ListFlowOperationResultsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListFlowOperations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFlowOperations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFlowOperationsRequestT = Model::ListFlowOperationsRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTLSInspectionConfigurationsOutcome ListTLSInspectionConfigurations(
      const Model::ListTLSInspectionConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListTLSInspectionConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListTLSInspectionConfigurationsRequestT = Model::ListTLSInspectionConfigurationsRequest>
  Model::ListTLSInspectionConfigurationsOutcomeCallable ListTLSInspectionConfigurationsCallable(
      const ListTLSInspectionConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::ListTLSInspectionConfigurations, request);
  }

  /**
   * An Async wrapper for ListTLSInspectionConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListTLSInspectionConfigurationsRequestT = Model::ListTLSInspectionConfigurationsRequest>
  void ListTLSInspectionConfigurationsAsync(const ListTLSInspectionConfigurationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListTLSInspectionConfigurationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListVpcEndpointAssociationsOutcome ListVpcEndpointAssociations(
      const Model::ListVpcEndpointAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListVpcEndpointAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListVpcEndpointAssociationsRequestT = Model::ListVpcEndpointAssociationsRequest>
  Model::ListVpcEndpointAssociationsOutcomeCallable ListVpcEndpointAssociationsCallable(
      const ListVpcEndpointAssociationsRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::ListVpcEndpointAssociations, request);
  }

  /**
   * An Async wrapper for ListVpcEndpointAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVpcEndpointAssociationsRequestT = Model::ListVpcEndpointAssociationsRequest>
  void ListVpcEndpointAssociationsAsync(const ListVpcEndpointAssociationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListVpcEndpointAssociationsRequestT& request = {}) const {
  ...
  virtual Model::RejectNetworkFirewallTransitGatewayAttachmentOutcome RejectNetworkFirewallTransitGatewayAttachment(
      const Model::RejectNetworkFirewallTransitGatewayAttachmentRequest& request) const;

  /**
   * A Callable wrapper for RejectNetworkFirewallTransitGatewayAttachment that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::RejectNetworkFirewallTransitGatewayAttachmentOutcomeCallable RejectNetworkFirewallTransitGatewayAttachmentCallable(
      const RejectNetworkFirewallTransitGatewayAttachmentRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::RejectNetworkFirewallTransitGatewayAttachment, request);
  }

  /**
   * An Async wrapper for RejectNetworkFirewallTransitGatewayAttachment that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename RejectNetworkFirewallTransitGatewayAttachmentRequestT = Model::RejectNetworkFirewallTransitGatewayAttachmentRequest>
  void RejectNetworkFirewallTransitGatewayAttachmentAsync(
      const RejectNetworkFirewallTransitGatewayAttachmentRequestT& request,
      const RejectNetworkFirewallTransitGatewayAttachmentResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAnalysisReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAnalysisReport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartAnalysisReportRequestT = Model::StartAnalysisReportRequest>
  void StartAnalysisReportAsync(const StartAnalysisReportRequestT& request, const StartAnalysisReportResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartFlowCapture that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartFlowCapture that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartFlowCaptureRequestT = Model::StartFlowCaptureRequest>
  void StartFlowCaptureAsync(const StartFlowCaptureRequestT& request, const StartFlowCaptureResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartFlowFlush that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartFlowFlushRequestT = Model::StartFlowFlushRequest>
  void StartFlowFlushAsync(const StartFlowFlushRequestT& request, const StartFlowFlushResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAvailabilityZoneChangeProtectionOutcome UpdateAvailabilityZoneChangeProtection(
      const Model::UpdateAvailabilityZoneChangeProtectionRequest& request) const;

  /**
   * A Callable wrapper for UpdateAvailabilityZoneChangeProtection that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateAvailabilityZoneChangeProtectionRequestT = Model::UpdateAvailabilityZoneChangeProtectionRequest>
  Model::UpdateAvailabilityZoneChangeProtectionOutcomeCallable UpdateAvailabilityZoneChangeProtectionCallable(
      const UpdateAvailabilityZoneChangeProtectionRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::UpdateAvailabilityZoneChangeProtection, request);
  }

  /**
   * An Async wrapper for UpdateAvailabilityZoneChangeProtection that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateAvailabilityZoneChangeProtectionRequestT = Model::UpdateAvailabilityZoneChangeProtectionRequest>
  void UpdateAvailabilityZoneChangeProtectionAsync(const UpdateAvailabilityZoneChangeProtectionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateFirewallAnalysisSettingsOutcome UpdateFirewallAnalysisSettings(
      const Model::UpdateFirewallAnalysisSettingsRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateFirewallAnalysisSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateFirewallAnalysisSettingsRequestT = Model::UpdateFirewallAnalysisSettingsRequest>
  Model::UpdateFirewallAnalysisSettingsOutcomeCallable UpdateFirewallAnalysisSettingsCallable(
      const UpdateFirewallAnalysisSettingsRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::UpdateFirewallAnalysisSettings, request);
  }

  /**
   * An Async wrapper for UpdateFirewallAnalysisSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateFirewallAnalysisSettingsRequestT = Model::UpdateFirewallAnalysisSettingsRequest>
  void UpdateFirewallAnalysisSettingsAsync(const UpdateFirewallAnalysisSettingsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const UpdateFirewallAnalysisSettingsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateFirewallDeleteProtectionOutcome UpdateFirewallDeleteProtection(
      const Model::UpdateFirewallDeleteProtectionRequest& request) const;

  /**
   * A Callable wrapper for UpdateFirewallDeleteProtection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateFirewallDeleteProtectionRequestT = Model::UpdateFirewallDeleteProtectionRequest>
  Model::UpdateFirewallDeleteProtectionOutcomeCallable UpdateFirewallDeleteProtectionCallable(
      const UpdateFirewallDeleteProtectionRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::UpdateFirewallDeleteProtection, request);
  }

  /**
   * An Async wrapper for UpdateFirewallDeleteProtection that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateFirewallDeleteProtectionRequestT = Model::UpdateFirewallDeleteProtectionRequest>
  void UpdateFirewallDeleteProtectionAsync(const UpdateFirewallDeleteProtectionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateFirewallDescriptionOutcome UpdateFirewallDescription(
      const Model::UpdateFirewallDescriptionRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateFirewallDescription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateFirewallDescriptionRequestT = Model::UpdateFirewallDescriptionRequest>
  Model::UpdateFirewallDescriptionOutcomeCallable UpdateFirewallDescriptionCallable(
      const UpdateFirewallDescriptionRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::UpdateFirewallDescription, request);
  }

  /**
   * An Async wrapper for UpdateFirewallDescription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFirewallDescriptionRequestT = Model::UpdateFirewallDescriptionRequest>
  void UpdateFirewallDescriptionAsync(const UpdateFirewallDescriptionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const UpdateFirewallDescriptionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateFirewallEncryptionConfigurationOutcome UpdateFirewallEncryptionConfiguration(
      const Model::UpdateFirewallEncryptionConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateFirewallEncryptionConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateFirewallEncryptionConfigurationRequestT = Model::UpdateFirewallEncryptionConfigurationRequest>
  Model::UpdateFirewallEncryptionConfigurationOutcomeCallable UpdateFirewallEncryptionConfigurationCallable(
      const UpdateFirewallEncryptionConfigurationRequestT& request = {}) const {
    return SubmitCallable(&NetworkFirewallClient::UpdateFirewallEncryptionConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateFirewallEncryptionConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateFirewallEncryptionConfigurationRequestT = Model::UpdateFirewallEncryptionConfigurationRequest>
  void UpdateFirewallEncryptionConfigurationAsync(const UpdateFirewallEncryptionConfigurationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const UpdateFirewallEncryptionConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateFirewallPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFirewallPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFirewallPolicyRequestT = Model::UpdateFirewallPolicyRequest>
  void UpdateFirewallPolicyAsync(const UpdateFirewallPolicyRequestT& request, const UpdateFirewallPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateFirewallPolicyChangeProtectionOutcome UpdateFirewallPolicyChangeProtection(
      const Model::UpdateFirewallPolicyChangeProtectionRequest& request) const;

  /**
   * A Callable wrapper for UpdateFirewallPolicyChangeProtection that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateFirewallPolicyChangeProtectionRequestT = Model::UpdateFirewallPolicyChangeProtectionRequest>
  Model::UpdateFirewallPolicyChangeProtectionOutcomeCallable UpdateFirewallPolicyChangeProtectionCallable(
      const UpdateFirewallPolicyChangeProtectionRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::UpdateFirewallPolicyChangeProtection, request);
  }

  /**
   * An Async wrapper for UpdateFirewallPolicyChangeProtection that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateFirewallPolicyChangeProtectionRequestT = Model::UpdateFirewallPolicyChangeProtectionRequest>
  void UpdateFirewallPolicyChangeProtectionAsync(const UpdateFirewallPolicyChangeProtectionRequestT& request,
   ...
   */
  template <typename UpdateLoggingConfigurationRequestT = Model::UpdateLoggingConfigurationRequest>
  void UpdateLoggingConfigurationAsync(const UpdateLoggingConfigurationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const UpdateLoggingConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateSubnetChangeProtectionOutcome UpdateSubnetChangeProtection(
      const Model::UpdateSubnetChangeProtectionRequest& request) const;

  /**
   * A Callable wrapper for UpdateSubnetChangeProtection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateSubnetChangeProtectionRequestT = Model::UpdateSubnetChangeProtectionRequest>
  Model::UpdateSubnetChangeProtectionOutcomeCallable UpdateSubnetChangeProtectionCallable(
      const UpdateSubnetChangeProtectionRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::UpdateSubnetChangeProtection, request);
  }

  /**
   * An Async wrapper for UpdateSubnetChangeProtection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSubnetChangeProtectionRequestT = Model::UpdateSubnetChangeProtectionRequest>
  void UpdateSubnetChangeProtectionAsync(const UpdateSubnetChangeProtectionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateTLSInspectionConfigurationOutcome UpdateTLSInspectionConfiguration(
      const Model::UpdateTLSInspectionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateTLSInspectionConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateTLSInspectionConfigurationRequestT = Model::UpdateTLSInspectionConfigurationRequest>
  Model::UpdateTLSInspectionConfigurationOutcomeCallable UpdateTLSInspectionConfigurationCallable(
      const UpdateTLSInspectionConfigurationRequestT& request) const {
    return SubmitCallable(&NetworkFirewallClient::UpdateTLSInspectionConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateTLSInspectionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateTLSInspectionConfigurationRequestT = Model::UpdateTLSInspectionConfigurationRequest>
  void UpdateTLSInspectionConfigurationAsync(const UpdateTLSInspectionConfigurationRequestT& request,
                                             const UpdateTLSInspectionConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
