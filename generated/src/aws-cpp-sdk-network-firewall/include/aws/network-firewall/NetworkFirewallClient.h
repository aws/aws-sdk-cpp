...
namespace NetworkFirewall
{
   ...
   */
  class AWS_NETWORKFIREWALL_API NetworkFirewallClient : smithy::client::AwsSmithyClientT<Aws::NetworkFirewall::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<NetworkFirewallClient>
  {
    public:
