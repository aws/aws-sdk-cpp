...
namespace IoT1ClickProjects
{
   ...
   */
  class AWS_IOT1CLICKPROJECTS_API IoT1ClickProjectsClient : Aws::Client::ClientWithAsyncTemplateMethods<IoT1ClickProjectsClient>,
    smithy::client::AwsSmithyClientT<Aws::IoT1ClickProjects::SERVICE_NAME,
