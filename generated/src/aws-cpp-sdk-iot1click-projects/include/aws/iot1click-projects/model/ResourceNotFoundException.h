...
namespace Model
{
  ...
  {
  public:
    AWS_IOT1CLICKPROJECTS_API ResourceNotFoundException() = default;
    AWS_IOT1CLICKPROJECTS_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_IOT1CLICKPROJECTS_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
