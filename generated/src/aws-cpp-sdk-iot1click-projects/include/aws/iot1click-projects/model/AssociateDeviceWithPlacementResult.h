...
namespace Model
{
  ...
  {
  public:
    AWS_IOT1CLICKPROJECTS_API AssociateDeviceWithPlacementResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateDeviceWithPlacementResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
