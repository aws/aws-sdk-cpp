...
namespace Model
{
  ...
  {
  public:
    AWS_IOT1CLICKPROJECTS_API CreatePlacementResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreatePlacementResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
