...
namespace Model
{
  ...
  {
  public:
    AWS_IOT1CLICKPROJECTS_API DescribePlacementRequest() = default;
    ...
    template<typename PlacementNameT = Aws::String>
    DescribePlacementRequest& WithPlacementName(PlacementNameT&& value) { SetPlacementName(std::forward<PlacementNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ProjectNameT = Aws::String>
    DescribePlacementRequest& WithProjectName(ProjectNameT&& value) { SetProjectName(std::forward<ProjectNameT>(value)); return *this;}
    ///@}
  private:
