...
namespace Model
{
  ...
  {
  public:
    AWS_IOT1CLICKPROJECTS_API DisassociateDeviceFromPlacementResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateDeviceFromPlacementResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
