...
class TimestreamSettings {
 public:
  ...
  inline void SetMemoryDuration(int value) {
    m_memoryDurationHasBeenSet = true;
    m_memoryDuration = value;
  }
  inline TimestreamSettings& WithMemoryDuration(int value) {
    SetMemoryDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMagneticDuration(int value) {
    m_magneticDurationHasBeenSet = true;
    m_magneticDuration = value;
  }
  inline TimestreamSettings& WithMagneticDuration(int value) {
    SetMagneticDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCdcInsertsAndUpdates(bool value) {
    m_cdcInsertsAndUpdatesHasBeenSet = true;
    m_cdcInsertsAndUpdates = value;
  }
  inline TimestreamSettings& WithCdcInsertsAndUpdates(bool value) {
    SetCdcInsertsAndUpdates(value);
    return *this;
  }
  ///@}
  ...
  inline TimestreamSettings& WithEnableMagneticStoreWrites(bool value) {
