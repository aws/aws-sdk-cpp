...
class DescribeEndpointSettingsRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename EngineNameT = Aws::String>
  DescribeEndpointSettingsRequest& WithEngineName(EngineNameT&& value) {
  ...
  inline DescribeEndpointSettingsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeEndpointSettingsRequest& WithMarker(MarkerT&& value) {
