...
class DescribeRecommendationLimitationsResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeRecommendationLimitationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRecommendationLimitationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetLimitations(LimitationsT&& value) {
    m_limitationsHasBeenSet = true;
    m_limitations = std::forward<LimitationsT>(value);
  }
  template <typename LimitationsT = Aws::Vector<Limitation>>
  DescribeRecommendationLimitationsResult& WithLimitations(LimitationsT&& value) {
    SetLimitations(std::forward<LimitationsT>(value));
    return *this;
  }
  template <typename LimitationsT = Limitation>
  DescribeRecommendationLimitationsResult& AddLimitations(LimitationsT&& value) {
    m_limitationsHasBeenSet = true;
    m_limitations.emplace_back(std::forward<LimitationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRecommendationLimitationsResult& WithRequestId(RequestIdT&& value) {
