...
class DescribeReplicationTaskAssessmentResultsRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename ReplicationTaskArnT = Aws::String>
  DescribeReplicationTaskAssessmentResultsRequest& WithReplicationTaskArn(ReplicationTaskArnT&& value) {
  ...
  inline DescribeReplicationTaskAssessmentResultsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeReplicationTaskAssessmentResultsRequest& WithMarker(MarkerT&& value) {
