...
class ElasticsearchSettings {
 public:
  ...
  inline void SetFullLoadErrorPercentage(int value) {
    m_fullLoadErrorPercentageHasBeenSet = true;
    m_fullLoadErrorPercentage = value;
  }
  inline ElasticsearchSettings& WithFullLoadErrorPercentage(int value) {
    SetFullLoadErrorPercentage(value);
    return *this;
  }
  ///@}
  ...
  inline ElasticsearchSettings& WithErrorRetryDuration(int value) {
  ...
  inline void SetUseNewMappingType(bool value) {
    m_useNewMappingTypeHasBeenSet = true;
    m_useNewMappingType = value;
  }
  inline ElasticsearchSettings& WithUseNewMappingType(bool value) {
    SetUseNewMappingType(value);
    return *this;
  }
  ///@}
 private:
