...
class DescribeMetadataModelExportsToTargetRequest : public DatabaseMigrationServiceRequest {
 public:
  AWS_DATABASEMIGRATIONSERVICE_API DescribeMetadataModelExportsToTargetRequest() = default;
  ...
  template <typename MigrationProjectIdentifierT = Aws::String>
  DescribeMetadataModelExportsToTargetRequest& WithMigrationProjectIdentifier(MigrationProjectIdentifierT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeMetadataModelExportsToTargetRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeMetadataModelExportsToTargetRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeMetadataModelExportsToTargetRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeMetadataModelExportsToTargetRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
