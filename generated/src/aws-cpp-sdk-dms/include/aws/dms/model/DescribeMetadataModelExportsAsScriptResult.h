...
class DescribeMetadataModelExportsAsScriptResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeMetadataModelExportsAsScriptResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename MarkerT = Aws::String>
  DescribeMetadataModelExportsAsScriptResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestsT = Aws::Vector<SchemaConversionRequest>>
  DescribeMetadataModelExportsAsScriptResult& WithRequests(RequestsT&& value) {
    SetRequests(std::forward<RequestsT>(value));
    return *this;
  }
  template <typename RequestsT = SchemaConversionRequest>
  DescribeMetadataModelExportsAsScriptResult& AddRequests(RequestsT&& value) {
    m_requestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMetadataModelExportsAsScriptResult& WithRequestId(RequestIdT&& value) {
