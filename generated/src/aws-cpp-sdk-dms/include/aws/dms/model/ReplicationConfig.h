...
class ReplicationConfig {
 public:
  ...
  inline ReplicationConfig& WithReplicationType(MigrationTypeValue value) {
  ...
  void SetReplicationConfigCreateTime(ReplicationConfigCreateTimeT&& value) {
    ...
    m_replicationConfigCreateTime = std::forward<ReplicationConfigCreateTimeT>(value);
  }
  template <typename ReplicationConfigCreateTimeT = Aws::Utils::DateTime>
  ReplicationConfig& WithReplicationConfigCreateTime(ReplicationConfigCreateTimeT&& value) {
    SetReplicationConfigCreateTime(std::forward<ReplicationConfigCreateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicationConfigUpdateTime(ReplicationConfigUpdateTimeT&& value) {
    ...
    m_replicationConfigUpdateTime = std::forward<ReplicationConfigUpdateTimeT>(value);
  }
  template <typename ReplicationConfigUpdateTimeT = Aws::Utils::DateTime>
  ReplicationConfig& WithReplicationConfigUpdateTime(ReplicationConfigUpdateTimeT&& value) {
    SetReplicationConfigUpdateTime(std::forward<ReplicationConfigUpdateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>Indicates whether the replication configuration is read-only. When set to
   * <code>true</code>, this replication configuration is managed by DMS as part of a
   * zero-ETL integration and cannot be modified or deleted directly. You can only
   * modify or delete read-only replication configurations through their associated
   * zero-ETL integration.</p>
   */
  ...
  inline ReplicationConfig& WithIsReadOnly(bool value) {
    SetIsReadOnly(value);
    return *this;
  }
  ///@}
