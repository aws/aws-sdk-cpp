...
class OracleDataProviderSettings {
 public:
  ...
  inline OracleDataProviderSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline OracleDataProviderSettings& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
  ...
  void SetAsmServer(AsmServerT&& value) {
    ...
    m_asmServer = std::forward<AsmServerT>(value);
  }
  template <typename AsmServerT = Aws::String>
  OracleDataProviderSettings& WithAsmServer(AsmServerT&& value) {
    SetAsmServer(std::forward<AsmServerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecretsManagerOracleAsmSecretId(SecretsManagerOracleAsmSecretIdT&& value) {
    ...
    m_secretsManagerOracleAsmSecretId = std::forward<SecretsManagerOracleAsmSecretIdT>(value);
  }
  template <typename SecretsManagerOracleAsmSecretIdT = Aws::String>
  OracleDataProviderSettings& WithSecretsManagerOracleAsmSecretId(SecretsManagerOracleAsmSecretIdT&& value) {
    SetSecretsManagerOracleAsmSecretId(std::forward<SecretsManagerOracleAsmSecretIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecretsManagerOracleAsmAccessRoleArn(SecretsManagerOracleAsmAccessRoleArnT&& value) {
    ...
    m_secretsManagerOracleAsmAccessRoleArn = std::forward<SecretsManagerOracleAsmAccessRoleArnT>(value);
  }
  template <typename SecretsManagerOracleAsmAccessRoleArnT = Aws::String>
  OracleDataProviderSettings& WithSecretsManagerOracleAsmAccessRoleArn(SecretsManagerOracleAsmAccessRoleArnT&& value) {
    SetSecretsManagerOracleAsmAccessRoleArn(std::forward<SecretsManagerOracleAsmAccessRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline bool SecretsManagerSecurityDbEncryptionSecretIdHasBeenSet() const {
    return m_secretsManagerSecurityDbEncryptionSecretIdHasBeenSet;
  }
  ...
  void SetSecretsManagerSecurityDbEncryptionSecretId(SecretsManagerSecurityDbEncryptionSecretIdT&& value) {
    ...
    m_secretsManagerSecurityDbEncryptionSecretId = std::forward<SecretsManagerSecurityDbEncryptionSecretIdT>(value);
  }
  template <typename SecretsManagerSecurityDbEncryptionSecretIdT = Aws::String>
  OracleDataProviderSettings& WithSecretsManagerSecurityDbEncryptionSecretId(SecretsManagerSecurityDbEncryptionSecretIdT&& value) {
    SetSecretsManagerSecurityDbEncryptionSecretId(std::forward<SecretsManagerSecurityDbEncryptionSecretIdT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::String& GetSecretsManagerSecurityDbEncryptionAccessRoleArn() const {
    return m_secretsManagerSecurityDbEncryptionAccessRoleArn;
  }
  inline bool SecretsManagerSecurityDbEncryptionAccessRoleArnHasBeenSet() const {
    return m_secretsManagerSecurityDbEncryptionAccessRoleArnHasBeenSet;
  }
  ...
  void SetSecretsManagerSecurityDbEncryptionAccessRoleArn(SecretsManagerSecurityDbEncryptionAccessRoleArnT&& value) {
    ...
    m_secretsManagerSecurityDbEncryptionAccessRoleArn = std::forward<SecretsManagerSecurityDbEncryptionAccessRoleArnT>(value);
  }
  template <typename SecretsManagerSecurityDbEncryptionAccessRoleArnT = Aws::String>
  OracleDataProviderSettings& WithSecretsManagerSecurityDbEncryptionAccessRoleArn(
      SecretsManagerSecurityDbEncryptionAccessRoleArnT&& value) {
    SetSecretsManagerSecurityDbEncryptionAccessRoleArn(std::forward<SecretsManagerSecurityDbEncryptionAccessRoleArnT>(value));
    return *this;
  }
  ///@}
