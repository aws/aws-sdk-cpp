...
class DescribeEndpointTypesResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeEndpointTypesResult& operator=(
  ...
  template <typename MarkerT = Aws::String>
  DescribeEndpointTypesResult& WithMarker(MarkerT&& value) {
  ...
  void SetSupportedEndpointTypes(SupportedEndpointTypesT&& value) {
    m_supportedEndpointTypesHasBeenSet = true;
    m_supportedEndpointTypes = std::forward<SupportedEndpointTypesT>(value);
  }
  template <typename SupportedEndpointTypesT = Aws::Vector<SupportedEndpointType>>
  DescribeEndpointTypesResult& WithSupportedEndpointTypes(SupportedEndpointTypesT&& value) {
    SetSupportedEndpointTypes(std::forward<SupportedEndpointTypesT>(value));
    return *this;
  }
  template <typename SupportedEndpointTypesT = SupportedEndpointType>
  DescribeEndpointTypesResult& AddSupportedEndpointTypes(SupportedEndpointTypesT&& value) {
    m_supportedEndpointTypesHasBeenSet = true;
    m_supportedEndpointTypes.emplace_back(std::forward<SupportedEndpointTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEndpointTypesResult& WithRequestId(RequestIdT&& value) {
