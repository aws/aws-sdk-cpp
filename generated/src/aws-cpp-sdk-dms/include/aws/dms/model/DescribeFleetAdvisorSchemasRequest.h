...
class DescribeFleetAdvisorSchemasRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeFleetAdvisorSchemasRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeFleetAdvisorSchemasRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeFleetAdvisorSchemasRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFleetAdvisorSchemasRequest& WithNextToken(NextTokenT&& value) {
