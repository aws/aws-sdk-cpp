...
class DescribeFleetAdvisorLsaAnalysisRequest : public DatabaseMigrationServiceRequest {
 public:
  AWS_DATABASEMIGRATIONSERVICE_API DescribeFleetAdvisorLsaAnalysisRequest() = default;
  ...
  inline DescribeFleetAdvisorLsaAnalysisRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFleetAdvisorLsaAnalysisRequest& WithNextToken(NextTokenT&& value) {
