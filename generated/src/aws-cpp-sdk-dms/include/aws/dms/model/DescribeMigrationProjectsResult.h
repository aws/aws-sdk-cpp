...
class DescribeMigrationProjectsResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeMigrationProjectsResult& operator=(
  ...
  void SetMigrationProjects(MigrationProjectsT&& value) {
    ...
    m_migrationProjects = std::forward<MigrationProjectsT>(value);
  }
  template <typename MigrationProjectsT = Aws::Vector<MigrationProject>>
  DescribeMigrationProjectsResult& WithMigrationProjects(MigrationProjectsT&& value) {
    SetMigrationProjects(std::forward<MigrationProjectsT>(value));
    return *this;
  }
  ...
  DescribeMigrationProjectsResult& AddMigrationProjects(MigrationProjectsT&& value) {
    m_migrationProjectsHasBeenSet = true;
    m_migrationProjects.emplace_back(std::forward<MigrationProjectsT>(value));
    return *this;
  }
  ///@}
