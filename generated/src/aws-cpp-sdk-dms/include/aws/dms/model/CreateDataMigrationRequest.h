...
class CreateDataMigrationRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  inline CreateDataMigrationRequest& WithDataMigrationType(MigrationTypeValue value) {
  ...
  inline CreateDataMigrationRequest& WithEnableCloudwatchLogs(bool value) {
  ...
  inline CreateDataMigrationRequest& WithNumberOfJobs(int value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateDataMigrationRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateDataMigrationRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
