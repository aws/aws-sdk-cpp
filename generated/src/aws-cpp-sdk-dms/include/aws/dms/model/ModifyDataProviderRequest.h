...
class ModifyDataProviderRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  void SetDataProviderIdentifier(DataProviderIdentifierT&& value) {
    ...
    m_dataProviderIdentifier = std::forward<DataProviderIdentifierT>(value);
  }
  template <typename DataProviderIdentifierT = Aws::String>
  ModifyDataProviderRequest& WithDataProviderIdentifier(DataProviderIdentifierT&& value) {
    SetDataProviderIdentifier(std::forward<DataProviderIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyDataProviderRequest& WithVirtual(bool value) {
    SetVirtual(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExactSettings(bool value) {
    m_exactSettingsHasBeenSet = true;
    m_exactSettings = value;
  }
  inline ModifyDataProviderRequest& WithExactSettings(bool value) {
    SetExactSettings(value);
    return *this;
  }
  ///@}
