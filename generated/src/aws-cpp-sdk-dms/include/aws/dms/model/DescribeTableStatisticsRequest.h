...
class DescribeTableStatisticsRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  inline DescribeTableStatisticsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeTableStatisticsRequest& WithMarker(MarkerT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeTableStatisticsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeTableStatisticsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
