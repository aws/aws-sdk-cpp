...
class DescribeInstanceProfilesResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeInstanceProfilesResult& operator=(
  ...
  void SetInstanceProfiles(InstanceProfilesT&& value) {
    ...
    m_instanceProfiles = std::forward<InstanceProfilesT>(value);
  }
  template <typename InstanceProfilesT = Aws::Vector<InstanceProfile>>
  DescribeInstanceProfilesResult& WithInstanceProfiles(InstanceProfilesT&& value) {
    SetInstanceProfiles(std::forward<InstanceProfilesT>(value));
    return *this;
  }
  ...
  DescribeInstanceProfilesResult& AddInstanceProfiles(InstanceProfilesT&& value) {
    m_instanceProfilesHasBeenSet = true;
    m_instanceProfiles.emplace_back(std::forward<InstanceProfilesT>(value));
    return *this;
  }
  ///@}
