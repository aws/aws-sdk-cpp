...
class DatabaseInstanceSoftwareDetailsResponse {
 public:
  ...
  void SetServicePack(ServicePackT&& value) {
    ...
    m_servicePack = std::forward<ServicePackT>(value);
  }
  template <typename ServicePackT = Aws::String>
  DatabaseInstanceSoftwareDetailsResponse& WithServicePack(ServicePackT&& value) {
    SetServicePack(std::forward<ServicePackT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOsArchitecture(int value) {
    m_osArchitectureHasBeenSet = true;
    m_osArchitecture = value;
  }
  inline DatabaseInstanceSoftwareDetailsResponse& WithOsArchitecture(int value) {
    SetOsArchitecture(value);
    return *this;
  }
  ///@}
