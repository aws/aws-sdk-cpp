...
class ReplicationTask {
 public:
  ...
  inline ReplicationTask& WithMigrationType(MigrationTypeValue value) {
  ...
  void SetReplicationTaskCreationDate(ReplicationTaskCreationDateT&& value) {
    ...
    m_replicationTaskCreationDate = std::forward<ReplicationTaskCreationDateT>(value);
  }
  template <typename ReplicationTaskCreationDateT = Aws::Utils::DateTime>
  ReplicationTask& WithReplicationTaskCreationDate(ReplicationTaskCreationDateT&& value) {
    SetReplicationTaskCreationDate(std::forward<ReplicationTaskCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicationTaskStartDate(ReplicationTaskStartDateT&& value) {
    ...
    m_replicationTaskStartDate = std::forward<ReplicationTaskStartDateT>(value);
  }
  template <typename ReplicationTaskStartDateT = Aws::Utils::DateTime>
  ReplicationTask& WithReplicationTaskStartDate(ReplicationTaskStartDateT&& value) {
    SetReplicationTaskStartDate(std::forward<ReplicationTaskStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicationTaskStats(ReplicationTaskStatsT&& value) {
    ...
    m_replicationTaskStats = std::forward<ReplicationTaskStatsT>(value);
  }
  template <typename ReplicationTaskStatsT = ReplicationTaskStats>
  ReplicationTask& WithReplicationTaskStats(ReplicationTaskStatsT&& value) {
    SetReplicationTaskStats(std::forward<ReplicationTaskStatsT>(value));
    return *this;
  }
  ///@}
