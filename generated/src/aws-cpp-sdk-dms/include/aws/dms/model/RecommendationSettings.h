...
class RecommendationSettings {
 public:
  ...
  void SetInstanceSizingType(InstanceSizingTypeT&& value) {
    m_instanceSizingTypeHasBeenSet = true;
    m_instanceSizingType = std::forward<InstanceSizingTypeT>(value);
  }
  template <typename InstanceSizingTypeT = Aws::String>
  RecommendationSettings& WithInstanceSizingType(InstanceSizingTypeT&& value) {
    SetInstanceSizingType(std::forward<InstanceSizingTypeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WorkloadTypeT = Aws::String>
  RecommendationSettings& WithWorkloadType(WorkloadTypeT&& value) {
