...
class DescribeReplicationConfigsResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeReplicationConfigsResult& operator=(
  ...
  void SetReplicationConfigs(ReplicationConfigsT&& value) {
    ...
    m_replicationConfigs = std::forward<ReplicationConfigsT>(value);
  }
  template <typename ReplicationConfigsT = Aws::Vector<ReplicationConfig>>
  DescribeReplicationConfigsResult& WithReplicationConfigs(ReplicationConfigsT&& value) {
    SetReplicationConfigs(std::forward<ReplicationConfigsT>(value));
    return *this;
  }
  ...
  DescribeReplicationConfigsResult& AddReplicationConfigs(ReplicationConfigsT&& value) {
    m_replicationConfigsHasBeenSet = true;
    m_replicationConfigs.emplace_back(std::forward<ReplicationConfigsT>(value));
    return *this;
  }
  ///@}
