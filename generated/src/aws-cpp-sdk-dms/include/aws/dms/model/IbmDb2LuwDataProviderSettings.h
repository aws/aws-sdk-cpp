...
class IbmDb2LuwDataProviderSettings {
 public:
  ...
  inline IbmDb2LuwDataProviderSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline IbmDb2LuwDataProviderSettings& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename S3PathT = Aws::String>
  IbmDb2LuwDataProviderSettings& WithS3Path(S3PathT&& value) {
