...
namespace Model
{
  ...
  public:
    ...
    template<typename ServerNameT = Aws::String>
    IbmDb2LuwDataProviderSettings& WithServerName(ServerNameT&& value) { SetServerName(std::forward<ServerNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseNameT = Aws::String>
    IbmDb2LuwDataProviderSettings& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    inline IbmDb2LuwDataProviderSettings& WithSslMode(DmsSslModeValue value) { SetSslMode(value); return *this;}
    ///@}
    ...
    template<typename CertificateArnT = Aws::String>
    IbmDb2LuwDataProviderSettings& WithCertificateArn(CertificateArnT&& value) { SetCertificateArn(std::forward<CertificateArnT>(value)); return *this;}
    ///@}
    ...
    template<typename S3PathT = Aws::String>
    IbmDb2LuwDataProviderSettings& WithS3Path(S3PathT&& value) { SetS3Path(std::forward<S3PathT>(value)); return *this;}
    ///@}
    ...
    template<typename S3AccessRoleArnT = Aws::String>
    IbmDb2LuwDataProviderSettings& WithS3AccessRoleArn(S3AccessRoleArnT&& value) { SetS3AccessRoleArn(std::forward<S3AccessRoleArnT>(value)); return *this;}
    ///@}
  private:
