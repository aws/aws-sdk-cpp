...
class ModifyEndpointRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  inline ModifyEndpointRequest& WithEndpointType(ReplicationEndpointTypeValue value) {
  ...
  inline ModifyEndpointRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyEndpointRequest& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyEndpointRequest& WithExactSettings(bool value) {
