...
class RedisSettings {
 public:
  ...
  inline RedisSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSslSecurityProtocol(SslSecurityProtocolValue value) {
    m_sslSecurityProtocolHasBeenSet = true;
    m_sslSecurityProtocol = value;
  }
  inline RedisSettings& WithSslSecurityProtocol(SslSecurityProtocolValue value) {
    SetSslSecurityProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAuthType(RedisAuthTypeValue value) {
    m_authTypeHasBeenSet = true;
    m_authType = value;
  }
  inline RedisSettings& WithAuthType(RedisAuthTypeValue value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
  ...
  void SetAuthUserName(AuthUserNameT&& value) {
    ...
    m_authUserName = std::forward<AuthUserNameT>(value);
  }
  template <typename AuthUserNameT = Aws::String>
  RedisSettings& WithAuthUserName(AuthUserNameT&& value) {
    SetAuthUserName(std::forward<AuthUserNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthPassword(AuthPasswordT&& value) {
    ...
    m_authPassword = std::forward<AuthPasswordT>(value);
  }
  template <typename AuthPasswordT = Aws::String>
  RedisSettings& WithAuthPassword(AuthPasswordT&& value) {
    SetAuthPassword(std::forward<AuthPasswordT>(value));
    return *this;
  }
  ///@}
