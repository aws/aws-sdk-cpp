...
namespace Model
{
  ...
  public:
    ...
    template<typename UsernameT = Aws::String>
    MongoDbSettings& WithUsername(UsernameT&& value) { SetUsername(std::forward<UsernameT>(value)); return *this;}
    ///@}
    ...
    template<typename PasswordT = Aws::String>
    MongoDbSettings& WithPassword(PasswordT&& value) { SetPassword(std::forward<PasswordT>(value)); return *this;}
    ///@}
    ...
    template<typename ServerNameT = Aws::String>
    MongoDbSettings& WithServerName(ServerNameT&& value) { SetServerName(std::forward<ServerNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseNameT = Aws::String>
    MongoDbSettings& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    inline MongoDbSettings& WithAuthType(AuthTypeValue value) { SetAuthType(value); return *this;}
    ///@}
    ...
    inline MongoDbSettings& WithAuthMechanism(AuthMechanismValue value) { SetAuthMechanism(value); return *this;}
    ///@}
    ...
    inline MongoDbSettings& WithNestingLevel(NestingLevelValue value) { SetNestingLevel(value); return *this;}
    ///@}
    ...
    template<typename ExtractDocIdT = Aws::String>
    void SetExtractDocId(ExtractDocIdT&& value) { m_extractDocIdHasBeenSet = true; m_extractDocId = std::forward<ExtractDocIdT>(value); }
    template<typename ExtractDocIdT = Aws::String>
    MongoDbSettings& WithExtractDocId(ExtractDocIdT&& value) { SetExtractDocId(std::forward<ExtractDocIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DocsToInvestigateT = Aws::String>
    void SetDocsToInvestigate(DocsToInvestigateT&& value) { m_docsToInvestigateHasBeenSet = true; m_docsToInvestigate = std::forward<DocsToInvestigateT>(value); }
    template<typename DocsToInvestigateT = Aws::String>
    MongoDbSettings& WithDocsToInvestigate(DocsToInvestigateT&& value) { SetDocsToInvestigate(std::forward<DocsToInvestigateT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthSourceT = Aws::String>
    MongoDbSettings& WithAuthSource(AuthSourceT&& value) { SetAuthSource(std::forward<AuthSourceT>(value)); return *this;}
    ///@}
    ...
    template<typename KmsKeyIdT = Aws::String>
    MongoDbSettings& WithKmsKeyId(KmsKeyIdT&& value) { SetKmsKeyId(std::forward<KmsKeyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SecretsManagerAccessRoleArnT = Aws::String>
    MongoDbSettings& WithSecretsManagerAccessRoleArn(SecretsManagerAccessRoleArnT&& value) { SetSecretsManagerAccessRoleArn(std::forward<SecretsManagerAccessRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SecretsManagerSecretIdT = Aws::String>
    MongoDbSettings& WithSecretsManagerSecretId(SecretsManagerSecretIdT&& value) { SetSecretsManagerSecretId(std::forward<SecretsManagerSecretIdT>(value)); return *this;}
    ///@}
