...
class MongoDbSettings {
 public:
  ...
  inline MongoDbSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline MongoDbSettings& WithAuthType(AuthTypeValue value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
  ...
  inline MongoDbSettings& WithAuthMechanism(AuthMechanismValue value) {
  ...
  inline void SetNestingLevel(NestingLevelValue value) {
    m_nestingLevelHasBeenSet = true;
    m_nestingLevel = value;
  }
  inline MongoDbSettings& WithNestingLevel(NestingLevelValue value) {
  ...
  void SetExtractDocId(ExtractDocIdT&& value) {
    ...
    m_extractDocId = std::forward<ExtractDocIdT>(value);
  }
  template <typename ExtractDocIdT = Aws::String>
  MongoDbSettings& WithExtractDocId(ExtractDocIdT&& value) {
    SetExtractDocId(std::forward<ExtractDocIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDocsToInvestigate(DocsToInvestigateT&& value) {
    ...
    m_docsToInvestigate = std::forward<DocsToInvestigateT>(value);
  }
  template <typename DocsToInvestigateT = Aws::String>
  MongoDbSettings& WithDocsToInvestigate(DocsToInvestigateT&& value) {
    SetDocsToInvestigate(std::forward<DocsToInvestigateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUseUpdateLookUp(bool value) {
    m_useUpdateLookUpHasBeenSet = true;
    m_useUpdateLookUp = value;
  }
  inline MongoDbSettings& WithUseUpdateLookUp(bool value) {
    SetUseUpdateLookUp(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReplicateShardCollections(bool value) {
    m_replicateShardCollectionsHasBeenSet = true;
    m_replicateShardCollections = value;
  }
  inline MongoDbSettings& WithReplicateShardCollections(bool value) {
    SetReplicateShardCollections(value);
    return *this;
  }
  ///@}
 private:
