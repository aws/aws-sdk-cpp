...
class DescribeAccountAttributesResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeAccountAttributesResult& operator=(
  ...
  DescribeAccountAttributesResult& AddAccountQuotas(AccountQuotasT&& value) {
    m_accountQuotasHasBeenSet = true;
    m_accountQuotas.emplace_back(std::forward<AccountQuotasT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUniqueAccountIdentifier(UniqueAccountIdentifierT&& value) {
    ...
    m_uniqueAccountIdentifier = std::forward<UniqueAccountIdentifierT>(value);
  }
  template <typename UniqueAccountIdentifierT = Aws::String>
  DescribeAccountAttributesResult& WithUniqueAccountIdentifier(UniqueAccountIdentifierT&& value) {
    SetUniqueAccountIdentifier(std::forward<UniqueAccountIdentifierT>(value));
    return *this;
  }
  ///@}
