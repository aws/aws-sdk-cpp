...
class StartReplicationRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  void SetPremigrationAssessmentSettings(PremigrationAssessmentSettingsT&& value) {
    m_premigrationAssessmentSettingsHasBeenSet = true;
    m_premigrationAssessmentSettings = std::forward<PremigrationAssessmentSettingsT>(value);
  }
  template <typename PremigrationAssessmentSettingsT = Aws::String>
  StartReplicationRequest& WithPremigrationAssessmentSettings(PremigrationAssessmentSettingsT&& value) {
    SetPremigrationAssessmentSettings(std::forward<PremigrationAssessmentSettingsT>(value));
    return *this;
  }
  ///@}
