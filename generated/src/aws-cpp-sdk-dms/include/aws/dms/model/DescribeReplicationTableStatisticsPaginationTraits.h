...
struct DescribeReplicationTableStatisticsPaginationTraits {
  using RequestType = Model::DescribeReplicationTableStatisticsRequest;
  using ResultType = Model::DescribeReplicationTableStatisticsResult;
  using OutcomeType = Model::DescribeReplicationTableStatisticsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->DescribeReplicationTableStatistics(request); }
