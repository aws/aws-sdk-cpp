...
struct DescribeEndpointsPaginationTraits {
  using RequestType = Model::DescribeEndpointsRequest;
  using ResultType = Model::DescribeEndpointsResult;
  using OutcomeType = Model::DescribeEndpointsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->DescribeEndpoints(request); }
