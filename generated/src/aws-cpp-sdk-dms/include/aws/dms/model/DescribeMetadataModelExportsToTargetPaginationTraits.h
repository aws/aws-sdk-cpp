...
struct DescribeMetadataModelExportsToTargetPaginationTraits {
  using RequestType = Model::DescribeMetadataModelExportsToTargetRequest;
  using ResultType = Model::DescribeMetadataModelExportsToTargetResult;
  using OutcomeType = Model::DescribeMetadataModelExportsToTargetOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->DescribeMetadataModelExportsToTarget(request); }
