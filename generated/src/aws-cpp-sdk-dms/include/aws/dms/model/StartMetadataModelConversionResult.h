...
class StartMetadataModelConversionResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API StartMetadataModelConversionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RequestIdentifierT = Aws::String>
  StartMetadataModelConversionResult& WithRequestIdentifier(RequestIdentifierT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartMetadataModelConversionResult& WithRequestId(RequestIdT&& value) {
