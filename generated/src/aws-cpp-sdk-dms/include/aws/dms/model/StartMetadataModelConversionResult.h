...
namespace Model
{
  ...
  {
  public:
    AWS_DATABASEMIGRATIONSERVICE_API StartMetadataModelConversionResult() = default;
    ...
    template<typename RequestIdentifierT = Aws::String>
    StartMetadataModelConversionResult& WithRequestIdentifier(RequestIdentifierT&& value) { SetRequestIdentifier(std::forward<RequestIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartMetadataModelConversionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
