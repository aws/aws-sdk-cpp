...
class DescribeMetadataModelExportsToTargetResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeMetadataModelExportsToTargetResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename MarkerT = Aws::String>
  DescribeMetadataModelExportsToTargetResult& WithMarker(MarkerT&& value) {
  ...
  ///@{
  /**
   * <p>A paginated list of metadata model export requests.</p>  <p>DMS never
  ...
  template <typename RequestsT = Aws::Vector<SchemaConversionRequest>>
  DescribeMetadataModelExportsToTargetResult& WithRequests(RequestsT&& value) {
    SetRequests(std::forward<RequestsT>(value));
    return *this;
  }
  template <typename RequestsT = SchemaConversionRequest>
  DescribeMetadataModelExportsToTargetResult& AddRequests(RequestsT&& value) {
    m_requestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMetadataModelExportsToTargetResult& WithRequestId(RequestIdT&& value) {
