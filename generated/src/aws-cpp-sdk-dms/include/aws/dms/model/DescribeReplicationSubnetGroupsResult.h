...
class DescribeReplicationSubnetGroupsResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeReplicationSubnetGroupsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename MarkerT = Aws::String>
  DescribeReplicationSubnetGroupsResult& WithMarker(MarkerT&& value) {
  ...
  void SetReplicationSubnetGroups(ReplicationSubnetGroupsT&& value) {
    m_replicationSubnetGroupsHasBeenSet = true;
    m_replicationSubnetGroups = std::forward<ReplicationSubnetGroupsT>(value);
  }
  template <typename ReplicationSubnetGroupsT = Aws::Vector<ReplicationSubnetGroup>>
  DescribeReplicationSubnetGroupsResult& WithReplicationSubnetGroups(ReplicationSubnetGroupsT&& value) {
    SetReplicationSubnetGroups(std::forward<ReplicationSubnetGroupsT>(value));
    return *this;
  }
  ...
  DescribeReplicationSubnetGroupsResult& AddReplicationSubnetGroups(ReplicationSubnetGroupsT&& value) {
    m_replicationSubnetGroupsHasBeenSet = true;
    m_replicationSubnetGroups.emplace_back(std::forward<ReplicationSubnetGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeReplicationSubnetGroupsResult& WithRequestId(RequestIdT&& value) {
