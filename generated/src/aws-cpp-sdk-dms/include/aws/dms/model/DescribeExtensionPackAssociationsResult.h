...
class DescribeExtensionPackAssociationsResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeExtensionPackAssociationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename MarkerT = Aws::String>
  DescribeExtensionPackAssociationsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestsT = Aws::Vector<SchemaConversionRequest>>
  DescribeExtensionPackAssociationsResult& WithRequests(RequestsT&& value) {
    SetRequests(std::forward<RequestsT>(value));
    return *this;
  }
  template <typename RequestsT = SchemaConversionRequest>
  DescribeExtensionPackAssociationsResult& AddRequests(RequestsT&& value) {
    m_requestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeExtensionPackAssociationsResult& WithRequestId(RequestIdT&& value) {
