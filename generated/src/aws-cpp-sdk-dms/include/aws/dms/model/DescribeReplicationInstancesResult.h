...
class DescribeReplicationInstancesResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeReplicationInstancesResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename MarkerT = Aws::String>
  DescribeReplicationInstancesResult& WithMarker(MarkerT&& value) {
  ...
  void SetReplicationInstances(ReplicationInstancesT&& value) {
    m_replicationInstancesHasBeenSet = true;
    m_replicationInstances = std::forward<ReplicationInstancesT>(value);
  }
  template <typename ReplicationInstancesT = Aws::Vector<ReplicationInstance>>
  DescribeReplicationInstancesResult& WithReplicationInstances(ReplicationInstancesT&& value) {
    SetReplicationInstances(std::forward<ReplicationInstancesT>(value));
    return *this;
  }
  template <typename ReplicationInstancesT = ReplicationInstance>
  DescribeReplicationInstancesResult& AddReplicationInstances(ReplicationInstancesT&& value) {
    m_replicationInstancesHasBeenSet = true;
    m_replicationInstances.emplace_back(std::forward<ReplicationInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeReplicationInstancesResult& WithRequestId(RequestIdT&& value) {
