...
class ReplicationStats {
 public:
  ...
  inline ReplicationStats& WithFullLoadProgressPercent(int value) {
  ...
  inline ReplicationStats& WithElapsedTimeMillis(long long value) {
  ...
  inline ReplicationStats& WithTablesLoaded(int value) {
  ...
  inline ReplicationStats& WithTablesLoading(int value) {
  ...
  inline ReplicationStats& WithTablesQueued(int value) {
  ...
  inline ReplicationStats& WithTablesErrored(int value) {
