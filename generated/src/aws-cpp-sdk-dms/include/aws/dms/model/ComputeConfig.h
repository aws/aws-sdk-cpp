...
namespace Model
{
  ...
  public:
     ...
     * specify for DMS Serverless is 384. The <code>MaxCapacityUnits</code> parameter
     ...
     * <code>MinCapacityUnits</code> parameter. If you don't set this value, DMS scans
