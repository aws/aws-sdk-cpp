...
class ReplicationInstanceTaskLog {
 public:
  ...
  void SetReplicationTaskName(ReplicationTaskNameT&& value) {
    m_replicationTaskNameHasBeenSet = true;
    m_replicationTaskName = std::forward<ReplicationTaskNameT>(value);
  }
  template <typename ReplicationTaskNameT = Aws::String>
  ReplicationInstanceTaskLog& WithReplicationTaskName(ReplicationTaskNameT&& value) {
    SetReplicationTaskName(std::forward<ReplicationTaskNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ReplicationTaskArnT = Aws::String>
  ReplicationInstanceTaskLog& WithReplicationTaskArn(ReplicationTaskArnT&& value) {
  ...
  inline void SetReplicationInstanceTaskLogSize(long long value) {
    m_replicationInstanceTaskLogSizeHasBeenSet = true;
    m_replicationInstanceTaskLogSize = value;
  }
  inline ReplicationInstanceTaskLog& WithReplicationInstanceTaskLogSize(long long value) {
    SetReplicationInstanceTaskLogSize(value);
    return *this;
  }
  ///@}
 private:
