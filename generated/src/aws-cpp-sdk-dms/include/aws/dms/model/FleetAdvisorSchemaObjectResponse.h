...
class FleetAdvisorSchemaObjectResponse {
 public:
  ...
  template <typename SchemaIdT = Aws::String>
  FleetAdvisorSchemaObjectResponse& WithSchemaId(SchemaIdT&& value) {
  ...
  void SetObjectType(ObjectTypeT&& value) {
    m_objectTypeHasBeenSet = true;
    m_objectType = std::forward<ObjectTypeT>(value);
  }
  template <typename ObjectTypeT = Aws::String>
  FleetAdvisorSchemaObjectResponse& WithObjectType(ObjectTypeT&& value) {
    SetObjectType(std::forward<ObjectTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfObjects(long long value) {
    m_numberOfObjectsHasBeenSet = true;
    m_numberOfObjects = value;
  }
  inline FleetAdvisorSchemaObjectResponse& WithNumberOfObjects(long long value) {
    SetNumberOfObjects(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodeLineCount(long long value) {
    m_codeLineCountHasBeenSet = true;
    m_codeLineCount = value;
  }
  inline FleetAdvisorSchemaObjectResponse& WithCodeLineCount(long long value) {
    SetCodeLineCount(value);
    return *this;
  }
  ///@}
  ...
  inline FleetAdvisorSchemaObjectResponse& WithCodeSize(long long value) {
    SetCodeSize(value);
    return *this;
  }
  ///@}
