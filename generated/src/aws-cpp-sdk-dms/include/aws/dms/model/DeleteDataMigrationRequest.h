...
namespace Model
{
  ...
  public:
    ...
    template<typename DataMigrationIdentifierT = Aws::String>
    DeleteDataMigrationRequest& WithDataMigrationIdentifier(DataMigrationIdentifierT&& value) { SetDataMigrationIdentifier(std::forward<DataMigrationIdentifierT>(value)); return *this;}
    ///@}
  private:
