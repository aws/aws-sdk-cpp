...
class CreateDataProviderResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API CreateDataProviderResult& operator=(
  ...
  template <typename DataProviderT = DataProvider>
  CreateDataProviderResult& WithDataProvider(DataProviderT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDataProviderResult& WithRequestId(RequestIdT&& value) {
