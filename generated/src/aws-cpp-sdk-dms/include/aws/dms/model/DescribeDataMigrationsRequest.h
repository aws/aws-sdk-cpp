...
class DescribeDataMigrationsRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeDataMigrationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeDataMigrationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeDataMigrationsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDataMigrationsRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeDataMigrationsRequest& WithWithoutSettings(bool value) {
  ...
  inline void SetWithoutStatistics(bool value) {
    m_withoutStatisticsHasBeenSet = true;
    m_withoutStatistics = value;
  }
  inline DescribeDataMigrationsRequest& WithWithoutStatistics(bool value) {
    SetWithoutStatistics(value);
    return *this;
  }
  ///@}
 private:
