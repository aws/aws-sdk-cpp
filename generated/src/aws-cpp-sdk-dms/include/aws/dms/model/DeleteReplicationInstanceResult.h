...
class DeleteReplicationInstanceResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DeleteReplicationInstanceResult& operator=(
  ...
  template <typename ReplicationInstanceT = ReplicationInstance>
  DeleteReplicationInstanceResult& WithReplicationInstance(ReplicationInstanceT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteReplicationInstanceResult& WithRequestId(RequestIdT&& value) {
