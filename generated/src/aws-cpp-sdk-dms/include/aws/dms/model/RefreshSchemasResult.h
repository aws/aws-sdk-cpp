...
namespace Model
{
  ...
  public:
    ...
    template<typename RefreshSchemasStatusT = RefreshSchemasStatus>
    RefreshSchemasResult& WithRefreshSchemasStatus(RefreshSchemasStatusT&& value) { SetRefreshSchemasStatus(std::forward<RefreshSchemasStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    RefreshSchemasResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
