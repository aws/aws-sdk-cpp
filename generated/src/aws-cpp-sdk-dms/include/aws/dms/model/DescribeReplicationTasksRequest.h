 ...
 * API Reference</a></p>
 */
class DescribeReplicationTasksRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeReplicationTasksRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeReplicationTasksRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeReplicationTasksRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeReplicationTasksRequest& WithMarker(MarkerT&& value) {
  ...
  inline void SetWithoutSettings(bool value) {
    m_withoutSettingsHasBeenSet = true;
    m_withoutSettings = value;
  }
  inline DescribeReplicationTasksRequest& WithWithoutSettings(bool value) {
    SetWithoutSettings(value);
    return *this;
  }
  ///@}
 private:
