...
class ReplicationTaskAssessmentRunProgress {
 public:
  ...
  inline void SetIndividualAssessmentCount(int value) {
    m_individualAssessmentCountHasBeenSet = true;
    m_individualAssessmentCount = value;
  }
  inline ReplicationTaskAssessmentRunProgress& WithIndividualAssessmentCount(int value) {
    SetIndividualAssessmentCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIndividualAssessmentCompletedCount(int value) {
    m_individualAssessmentCompletedCountHasBeenSet = true;
    m_individualAssessmentCompletedCount = value;
  }
  inline ReplicationTaskAssessmentRunProgress& WithIndividualAssessmentCompletedCount(int value) {
    SetIndividualAssessmentCompletedCount(value);
    return *this;
  }
  ///@}
 private:
