...
class CreateDataMigrationResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API CreateDataMigrationResult& operator=(
  ...
  template <typename DataMigrationT = DataMigration>
  CreateDataMigrationResult& WithDataMigration(DataMigrationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDataMigrationResult& WithRequestId(RequestIdT&& value) {
