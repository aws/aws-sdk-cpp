...
class MySQLSettings {
 public:
  ...
  inline MySQLSettings& WithCleanSourceMetadataOnMismatch(bool value) {
  ...
  inline MySQLSettings& WithEventsPollInterval(int value) {
  ...
  inline MySQLSettings& WithTargetDbType(TargetDbType value) {
  ...
  inline MySQLSettings& WithMaxFileSize(int value) {
  ...
  inline MySQLSettings& WithParallelLoadThreads(int value) {
  ...
  inline MySQLSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExecuteTimeout(int value) {
    m_executeTimeoutHasBeenSet = true;
    m_executeTimeout = value;
  }
  inline MySQLSettings& WithExecuteTimeout(int value) {
    SetExecuteTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAuthenticationMethod(MySQLAuthenticationMethod value) {
    m_authenticationMethodHasBeenSet = true;
    m_authenticationMethod = value;
  }
  inline MySQLSettings& WithAuthenticationMethod(MySQLAuthenticationMethod value) {
