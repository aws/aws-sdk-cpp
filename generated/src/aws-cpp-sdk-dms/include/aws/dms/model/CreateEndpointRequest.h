...
class CreateEndpointRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  inline CreateEndpointRequest& WithEndpointType(ReplicationEndpointTypeValue value) {
  ...
  inline CreateEndpointRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEndpointRequest& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
