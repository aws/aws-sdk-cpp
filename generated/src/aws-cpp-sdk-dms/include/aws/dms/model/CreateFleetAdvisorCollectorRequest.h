...
class CreateFleetAdvisorCollectorRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename CollectorNameT = Aws::String>
  CreateFleetAdvisorCollectorRequest& WithCollectorName(CollectorNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateFleetAdvisorCollectorRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ServiceAccessRoleArnT = Aws::String>
  CreateFleetAdvisorCollectorRequest& WithServiceAccessRoleArn(ServiceAccessRoleArnT&& value) {
  ...
  template <typename S3BucketNameT = Aws::String>
  CreateFleetAdvisorCollectorRequest& WithS3BucketName(S3BucketNameT&& value) {
