...
class StartMetadataModelConversionRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename MigrationProjectIdentifierT = Aws::String>
  StartMetadataModelConversionRequest& WithMigrationProjectIdentifier(MigrationProjectIdentifierT&& value) {
  ...
  ///@{
  /**
   * <p>A JSON string that identifies the metadata models to convert. For the
   ...
   * matches the source data provider.</p> </li> <li> <p>Supports
  ...
  template <typename SelectionRulesT = Aws::String>
  StartMetadataModelConversionRequest& WithSelectionRules(SelectionRulesT&& value) {
