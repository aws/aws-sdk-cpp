...
class DescribeMetadataModelImportsRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename MigrationProjectIdentifierT = Aws::String>
  DescribeMetadataModelImportsRequest& WithMigrationProjectIdentifier(MigrationProjectIdentifierT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeMetadataModelImportsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeMetadataModelImportsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeMetadataModelImportsRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeMetadataModelImportsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
