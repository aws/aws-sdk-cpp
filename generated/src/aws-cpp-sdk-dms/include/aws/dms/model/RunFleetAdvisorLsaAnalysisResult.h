...
class RunFleetAdvisorLsaAnalysisResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API RunFleetAdvisorLsaAnalysisResult& operator=(
  ...
  void SetLsaAnalysisId(LsaAnalysisIdT&& value) {
    m_lsaAnalysisIdHasBeenSet = true;
    m_lsaAnalysisId = std::forward<LsaAnalysisIdT>(value);
  }
  template <typename LsaAnalysisIdT = Aws::String>
  RunFleetAdvisorLsaAnalysisResult& WithLsaAnalysisId(LsaAnalysisIdT&& value) {
    SetLsaAnalysisId(std::forward<LsaAnalysisIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StatusT = Aws::String>
  RunFleetAdvisorLsaAnalysisResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RunFleetAdvisorLsaAnalysisResult& WithRequestId(RequestIdT&& value) {
