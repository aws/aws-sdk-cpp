...
class SupportedEndpointType {
 public:
  ...
  template <typename EngineNameT = Aws::String>
  SupportedEndpointType& WithEngineName(EngineNameT&& value) {
  ...
  inline void SetSupportsCDC(bool value) {
    m_supportsCDCHasBeenSet = true;
    m_supportsCDC = value;
  }
  inline SupportedEndpointType& WithSupportsCDC(bool value) {
    SetSupportsCDC(value);
    return *this;
  }
  ///@}
  ...
  inline SupportedEndpointType& WithEndpointType(ReplicationEndpointTypeValue value) {
  ...
  void SetReplicationInstanceEngineMinimumVersion(ReplicationInstanceEngineMinimumVersionT&& value) {
    m_replicationInstanceEngineMinimumVersionHasBeenSet = true;
    m_replicationInstanceEngineMinimumVersion = std::forward<ReplicationInstanceEngineMinimumVersionT>(value);
  }
  template <typename ReplicationInstanceEngineMinimumVersionT = Aws::String>
  SupportedEndpointType& WithReplicationInstanceEngineMinimumVersion(ReplicationInstanceEngineMinimumVersionT&& value) {
    SetReplicationInstanceEngineMinimumVersion(std::forward<ReplicationInstanceEngineMinimumVersionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EngineDisplayNameT = Aws::String>
  SupportedEndpointType& WithEngineDisplayName(EngineDisplayNameT&& value) {
