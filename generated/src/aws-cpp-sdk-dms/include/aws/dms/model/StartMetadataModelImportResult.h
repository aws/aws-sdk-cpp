...
class StartMetadataModelImportResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API StartMetadataModelImportResult& operator=(
  ...
  template <typename RequestIdentifierT = Aws::String>
  StartMetadataModelImportResult& WithRequestIdentifier(RequestIdentifierT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartMetadataModelImportResult& WithRequestId(RequestIdT&& value) {
