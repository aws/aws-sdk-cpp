...
namespace Model
{
  ...
  {
  public:
    AWS_DATABASEMIGRATIONSERVICE_API StartMetadataModelImportResult() = default;
    ...
    template<typename RequestIdentifierT = Aws::String>
    StartMetadataModelImportResult& WithRequestIdentifier(RequestIdentifierT&& value) { SetRequestIdentifier(std::forward<RequestIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartMetadataModelImportResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
