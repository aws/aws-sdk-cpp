...
class CreateMigrationProjectResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API CreateMigrationProjectResult& operator=(
  ...
  template <typename MigrationProjectT = MigrationProject>
  CreateMigrationProjectResult& WithMigrationProject(MigrationProjectT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateMigrationProjectResult& WithRequestId(RequestIdT&& value) {
