...
class GcpMySQLSettings {
 public:
  ...
  void SetAfterConnectScript(AfterConnectScriptT&& value) {
    ...
    m_afterConnectScript = std::forward<AfterConnectScriptT>(value);
  }
  template <typename AfterConnectScriptT = Aws::String>
  GcpMySQLSettings& WithAfterConnectScript(AfterConnectScriptT&& value) {
    SetAfterConnectScript(std::forward<AfterConnectScriptT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCleanSourceMetadataOnMismatch(bool value) {
    m_cleanSourceMetadataOnMismatchHasBeenSet = true;
    m_cleanSourceMetadataOnMismatch = value;
  }
  inline GcpMySQLSettings& WithCleanSourceMetadataOnMismatch(bool value) {
    SetCleanSourceMetadataOnMismatch(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEventsPollInterval(int value) {
    m_eventsPollIntervalHasBeenSet = true;
    m_eventsPollInterval = value;
  }
  inline GcpMySQLSettings& WithEventsPollInterval(int value) {
    SetEventsPollInterval(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetDbType(TargetDbType value) {
    m_targetDbTypeHasBeenSet = true;
    m_targetDbType = value;
  }
  inline GcpMySQLSettings& WithTargetDbType(TargetDbType value) {
    SetTargetDbType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxFileSize(int value) {
    m_maxFileSizeHasBeenSet = true;
    m_maxFileSize = value;
  }
  inline GcpMySQLSettings& WithMaxFileSize(int value) {
  ...
  inline void SetParallelLoadThreads(int value) {
    m_parallelLoadThreadsHasBeenSet = true;
    m_parallelLoadThreads = value;
  }
  inline GcpMySQLSettings& WithParallelLoadThreads(int value) {
    SetParallelLoadThreads(value);
    return *this;
  }
  ///@}
  ...
  inline GcpMySQLSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  void SetServerTimezone(ServerTimezoneT&& value) {
    ...
    m_serverTimezone = std::forward<ServerTimezoneT>(value);
  }
  template <typename ServerTimezoneT = Aws::String>
  GcpMySQLSettings& WithServerTimezone(ServerTimezoneT&& value) {
    SetServerTimezone(std::forward<ServerTimezoneT>(value));
    return *this;
  }
  ///@}
