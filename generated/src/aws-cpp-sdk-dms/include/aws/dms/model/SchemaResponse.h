...
class SchemaResponse {
 public:
  ...
  inline SchemaResponse& WithCodeLineCount(long long value) {
  ...
  inline SchemaResponse& WithCodeSize(long long value) {
    SetCodeSize(value);
    return *this;
  }
  ///@}
  ...
  void SetComplexity(ComplexityT&& value) {
    ...
    m_complexity = std::forward<ComplexityT>(value);
  }
  template <typename ComplexityT = Aws::String>
  SchemaResponse& WithComplexity(ComplexityT&& value) {
    SetComplexity(std::forward<ComplexityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatabaseInstance(DatabaseInstanceT&& value) {
    ...
    m_databaseInstance = std::forward<DatabaseInstanceT>(value);
  }
  template <typename DatabaseInstanceT = DatabaseShortInfoResponse>
  SchemaResponse& WithDatabaseInstance(DatabaseInstanceT&& value) {
    SetDatabaseInstance(std::forward<DatabaseInstanceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOriginalSchema(OriginalSchemaT&& value) {
    ...
    m_originalSchema = std::forward<OriginalSchemaT>(value);
  }
  template <typename OriginalSchemaT = SchemaShortInfoResponse>
  SchemaResponse& WithOriginalSchema(OriginalSchemaT&& value) {
    SetOriginalSchema(std::forward<OriginalSchemaT>(value));
    return *this;
  }
  ///@}
  ...
  inline SchemaResponse& WithSimilarity(double value) {
    SetSimilarity(value);
    return *this;
  }
  ///@}
