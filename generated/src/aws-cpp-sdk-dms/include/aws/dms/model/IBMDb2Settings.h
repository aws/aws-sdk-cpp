...
class IBMDb2Settings {
 public:
  ...
  inline IBMDb2Settings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSetDataCaptureChanges(bool value) {
    m_setDataCaptureChangesHasBeenSet = true;
    m_setDataCaptureChanges = value;
  }
  inline IBMDb2Settings& WithSetDataCaptureChanges(bool value) {
    SetSetDataCaptureChanges(value);
    return *this;
  }
  ///@}
  ...
  void SetCurrentLsn(CurrentLsnT&& value) {
    ...
    m_currentLsn = std::forward<CurrentLsnT>(value);
  }
  template <typename CurrentLsnT = Aws::String>
  IBMDb2Settings& WithCurrentLsn(CurrentLsnT&& value) {
    SetCurrentLsn(std::forward<CurrentLsnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxKBytesPerRead(int value) {
    m_maxKBytesPerReadHasBeenSet = true;
    m_maxKBytesPerRead = value;
  }
  inline IBMDb2Settings& WithMaxKBytesPerRead(int value) {
    SetMaxKBytesPerRead(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLoadTimeout(int value) {
    m_loadTimeoutHasBeenSet = true;
    m_loadTimeout = value;
  }
  inline IBMDb2Settings& WithLoadTimeout(int value) {
  ...
  inline void SetWriteBufferSize(int value) {
    m_writeBufferSizeHasBeenSet = true;
    m_writeBufferSize = value;
  }
  inline IBMDb2Settings& WithWriteBufferSize(int value) {
  ...
  inline IBMDb2Settings& WithMaxFileSize(int value) {
  ...
  inline void SetKeepCsvFiles(bool value) {
    m_keepCsvFilesHasBeenSet = true;
    m_keepCsvFiles = value;
  }
  inline IBMDb2Settings& WithKeepCsvFiles(bool value) {
    SetKeepCsvFiles(value);
    return *this;
  }
  ///@}
 private:
