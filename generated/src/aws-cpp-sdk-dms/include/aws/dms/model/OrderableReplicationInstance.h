...
class OrderableReplicationInstance {
 public:
  ...
  inline void SetMinAllocatedStorage(int value) {
    m_minAllocatedStorageHasBeenSet = true;
    m_minAllocatedStorage = value;
  }
  inline OrderableReplicationInstance& WithMinAllocatedStorage(int value) {
    SetMinAllocatedStorage(value);
    return *this;
  }
  ///@}
  ...
  inline OrderableReplicationInstance& WithMaxAllocatedStorage(int value) {
  ...
  inline void SetDefaultAllocatedStorage(int value) {
    m_defaultAllocatedStorageHasBeenSet = true;
    m_defaultAllocatedStorage = value;
  }
  inline OrderableReplicationInstance& WithDefaultAllocatedStorage(int value) {
    SetDefaultAllocatedStorage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludedAllocatedStorage(int value) {
    m_includedAllocatedStorageHasBeenSet = true;
    m_includedAllocatedStorage = value;
  }
  inline OrderableReplicationInstance& WithIncludedAllocatedStorage(int value) {
    SetIncludedAllocatedStorage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReleaseStatus(ReleaseStatusValues value) {
    m_releaseStatusHasBeenSet = true;
    m_releaseStatus = value;
  }
  inline OrderableReplicationInstance& WithReleaseStatus(ReleaseStatusValues value) {
