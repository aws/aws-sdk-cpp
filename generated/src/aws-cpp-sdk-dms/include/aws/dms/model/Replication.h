...
class Replication {
 public:
  ...
  void SetReplicationConfigIdentifier(ReplicationConfigIdentifierT&& value) {
    ...
    m_replicationConfigIdentifier = std::forward<ReplicationConfigIdentifierT>(value);
  }
  template <typename ReplicationConfigIdentifierT = Aws::String>
  Replication& WithReplicationConfigIdentifier(ReplicationConfigIdentifierT&& value) {
    SetReplicationConfigIdentifier(std::forward<ReplicationConfigIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceEndpointArn(SourceEndpointArnT&& value) {
    ...
    m_sourceEndpointArn = std::forward<SourceEndpointArnT>(value);
  }
  template <typename SourceEndpointArnT = Aws::String>
  Replication& WithSourceEndpointArn(SourceEndpointArnT&& value) {
    SetSourceEndpointArn(std::forward<SourceEndpointArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetEndpointArn(TargetEndpointArnT&& value) {
    ...
    m_targetEndpointArn = std::forward<TargetEndpointArnT>(value);
  }
  template <typename TargetEndpointArnT = Aws::String>
  Replication& WithTargetEndpointArn(TargetEndpointArnT&& value) {
    SetTargetEndpointArn(std::forward<TargetEndpointArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReplicationType(MigrationTypeValue value) {
    m_replicationTypeHasBeenSet = true;
    m_replicationType = value;
  }
  inline Replication& WithReplicationType(MigrationTypeValue value) {
  ...
  void SetProvisionData(ProvisionDataT&& value) {
    ...
    m_provisionData = std::forward<ProvisionDataT>(value);
  }
  template <typename ProvisionDataT = ProvisionData>
  Replication& WithProvisionData(ProvisionDataT&& value) {
    SetProvisionData(std::forward<ProvisionDataT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<PremigrationAssessmentStatus>& GetPremigrationAssessmentStatuses() const {
    return m_premigrationAssessmentStatuses;
  }
  ...
  void SetPremigrationAssessmentStatuses(PremigrationAssessmentStatusesT&& value) {
    ...
    m_premigrationAssessmentStatuses = std::forward<PremigrationAssessmentStatusesT>(value);
  }
  template <typename PremigrationAssessmentStatusesT = Aws::Vector<PremigrationAssessmentStatus>>
  Replication& WithPremigrationAssessmentStatuses(PremigrationAssessmentStatusesT&& value) {
    SetPremigrationAssessmentStatuses(std::forward<PremigrationAssessmentStatusesT>(value));
    return *this;
  }
  ...
  Replication& AddPremigrationAssessmentStatuses(PremigrationAssessmentStatusesT&& value) {
    m_premigrationAssessmentStatusesHasBeenSet = true;
    m_premigrationAssessmentStatuses.emplace_back(std::forward<PremigrationAssessmentStatusesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStopReason(StopReasonT&& value) {
    ...
    m_stopReason = std::forward<StopReasonT>(value);
  }
  template <typename StopReasonT = Aws::String>
  Replication& WithStopReason(StopReasonT&& value) {
    SetStopReason(std::forward<StopReasonT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailureMessages(FailureMessagesT&& value) {
    ...
    m_failureMessages = std::forward<FailureMessagesT>(value);
  }
  template <typename FailureMessagesT = Aws::Vector<Aws::String>>
  Replication& WithFailureMessages(FailureMessagesT&& value) {
    SetFailureMessages(std::forward<FailureMessagesT>(value));
    return *this;
  }
  template <typename FailureMessagesT = Aws::String>
  Replication& AddFailureMessages(FailureMessagesT&& value) {
    m_failureMessagesHasBeenSet = true;
    m_failureMessages.emplace_back(std::forward<FailureMessagesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicationStats(ReplicationStatsT&& value) {
    ...
    m_replicationStats = std::forward<ReplicationStatsT>(value);
  }
  template <typename ReplicationStatsT = ReplicationStats>
  Replication& WithReplicationStats(ReplicationStatsT&& value) {
    SetReplicationStats(std::forward<ReplicationStatsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartReplicationType(StartReplicationTypeT&& value) {
    ...
    m_startReplicationType = std::forward<StartReplicationTypeT>(value);
  }
  template <typename StartReplicationTypeT = Aws::String>
  Replication& WithStartReplicationType(StartReplicationTypeT&& value) {
    SetStartReplicationType(std::forward<StartReplicationTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecoveryCheckpoint(RecoveryCheckpointT&& value) {
    ...
    m_recoveryCheckpoint = std::forward<RecoveryCheckpointT>(value);
  }
  template <typename RecoveryCheckpointT = Aws::String>
  Replication& WithRecoveryCheckpoint(RecoveryCheckpointT&& value) {
    SetRecoveryCheckpoint(std::forward<RecoveryCheckpointT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicationCreateTime(ReplicationCreateTimeT&& value) {
    ...
    m_replicationCreateTime = std::forward<ReplicationCreateTimeT>(value);
  }
  template <typename ReplicationCreateTimeT = Aws::Utils::DateTime>
  Replication& WithReplicationCreateTime(ReplicationCreateTimeT&& value) {
    SetReplicationCreateTime(std::forward<ReplicationCreateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicationUpdateTime(ReplicationUpdateTimeT&& value) {
    ...
    m_replicationUpdateTime = std::forward<ReplicationUpdateTimeT>(value);
  }
  template <typename ReplicationUpdateTimeT = Aws::Utils::DateTime>
  Replication& WithReplicationUpdateTime(ReplicationUpdateTimeT&& value) {
    SetReplicationUpdateTime(std::forward<ReplicationUpdateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicationLastStopTime(ReplicationLastStopTimeT&& value) {
    ...
    m_replicationLastStopTime = std::forward<ReplicationLastStopTimeT>(value);
  }
  template <typename ReplicationLastStopTimeT = Aws::Utils::DateTime>
  Replication& WithReplicationLastStopTime(ReplicationLastStopTimeT&& value) {
    SetReplicationLastStopTime(std::forward<ReplicationLastStopTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicationDeprovisionTime(ReplicationDeprovisionTimeT&& value) {
    ...
    m_replicationDeprovisionTime = std::forward<ReplicationDeprovisionTimeT>(value);
  }
  template <typename ReplicationDeprovisionTimeT = Aws::Utils::DateTime>
  Replication& WithReplicationDeprovisionTime(ReplicationDeprovisionTimeT&& value) {
    SetReplicationDeprovisionTime(std::forward<ReplicationDeprovisionTimeT>(value));
    return *this;
  }
  ///@}
