...
class UpdateSubscriptionsToEventBridgeRequest : public DatabaseMigrationServiceRequest {
 public:
  AWS_DATABASEMIGRATIONSERVICE_API UpdateSubscriptionsToEventBridgeRequest() = default;
  ...
  inline void SetForceMove(bool value) {
    m_forceMoveHasBeenSet = true;
    m_forceMove = value;
  }
  inline UpdateSubscriptionsToEventBridgeRequest& WithForceMove(bool value) {
    SetForceMove(value);
    return *this;
  }
  ///@}
