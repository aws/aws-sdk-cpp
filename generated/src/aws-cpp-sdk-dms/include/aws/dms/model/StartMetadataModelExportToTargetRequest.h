...
class StartMetadataModelExportToTargetRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename MigrationProjectIdentifierT = Aws::String>
  StartMetadataModelExportToTargetRequest& WithMigrationProjectIdentifier(MigrationProjectIdentifierT&& value) {
  ...
  template <typename SelectionRulesT = Aws::String>
  StartMetadataModelExportToTargetRequest& WithSelectionRules(SelectionRulesT&& value) {
  ...
  inline void SetOverwriteExtensionPack(bool value) {
    m_overwriteExtensionPackHasBeenSet = true;
    m_overwriteExtensionPack = value;
  }
  inline StartMetadataModelExportToTargetRequest& WithOverwriteExtensionPack(bool value) {
    SetOverwriteExtensionPack(value);
    return *this;
  }
  ///@}
 private:
