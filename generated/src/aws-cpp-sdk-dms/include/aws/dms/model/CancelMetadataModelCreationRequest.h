...
/**
 */
class CancelMetadataModelCreationRequest : public DatabaseMigrationServiceRequest {
 public:
  AWS_DATABASEMIGRATIONSERVICE_API CancelMetadataModelCreationRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "CancelMetadataModelCreation"; }
  ...
  template <typename MigrationProjectIdentifierT = Aws::String>
  CancelMetadataModelCreationRequest& WithMigrationProjectIdentifier(MigrationProjectIdentifierT&& value) {
  ...
  ///@{
  /**
   * <p>The identifier for the metadata model creation operation to cancel. This
   * operation was initiated by <code>StartMetadataModelCreation</code>.</p>
   */
  ...
  template <typename RequestIdentifierT = Aws::String>
  CancelMetadataModelCreationRequest& WithRequestIdentifier(RequestIdentifierT&& value) {
