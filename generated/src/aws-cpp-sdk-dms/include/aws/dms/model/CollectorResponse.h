...
class CollectorResponse {
 public:
  ...
  void SetCollectorName(CollectorNameT&& value) {
    ...
    m_collectorName = std::forward<CollectorNameT>(value);
  }
  template <typename CollectorNameT = Aws::String>
  CollectorResponse& WithCollectorName(CollectorNameT&& value) {
    SetCollectorName(std::forward<CollectorNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline CollectorResponse& WithVersionStatus(VersionStatus value) {
  ...
  void SetCollectorHealthCheck(CollectorHealthCheckT&& value) {
    ...
    m_collectorHealthCheck = std::forward<CollectorHealthCheckT>(value);
  }
  template <typename CollectorHealthCheckT = CollectorHealthCheck>
  CollectorResponse& WithCollectorHealthCheck(CollectorHealthCheckT&& value) {
    SetCollectorHealthCheck(std::forward<CollectorHealthCheckT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastDataReceived(LastDataReceivedT&& value) {
    ...
    m_lastDataReceived = std::forward<LastDataReceivedT>(value);
  }
  template <typename LastDataReceivedT = Aws::String>
  CollectorResponse& WithLastDataReceived(LastDataReceivedT&& value) {
    SetLastDataReceived(std::forward<LastDataReceivedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegisteredDate(RegisteredDateT&& value) {
    ...
    m_registeredDate = std::forward<RegisteredDateT>(value);
  }
  template <typename RegisteredDateT = Aws::String>
  CollectorResponse& WithRegisteredDate(RegisteredDateT&& value) {
    SetRegisteredDate(std::forward<RegisteredDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInventoryData(InventoryDataT&& value) {
    ...
    m_inventoryData = std::forward<InventoryDataT>(value);
  }
  template <typename InventoryDataT = InventoryData>
  CollectorResponse& WithInventoryData(InventoryDataT&& value) {
    SetInventoryData(std::forward<InventoryDataT>(value));
    return *this;
  }
  ///@}
 private:
