...
class MicrosoftSqlServerDataProviderSettings {
 public:
  ...
  template <typename ServerNameT = Aws::String>
  MicrosoftSqlServerDataProviderSettings& WithServerName(ServerNameT&& value) {
  ...
  inline MicrosoftSqlServerDataProviderSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename DatabaseNameT = Aws::String>
  MicrosoftSqlServerDataProviderSettings& WithDatabaseName(DatabaseNameT&& value) {
  ...
  inline MicrosoftSqlServerDataProviderSettings& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename CertificateArnT = Aws::String>
  MicrosoftSqlServerDataProviderSettings& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename S3PathT = Aws::String>
  MicrosoftSqlServerDataProviderSettings& WithS3Path(S3PathT&& value) {
  ...
  void SetS3AccessRoleArn(S3AccessRoleArnT&& value) {
    ...
    m_s3AccessRoleArn = std::forward<S3AccessRoleArnT>(value);
  }
  template <typename S3AccessRoleArnT = Aws::String>
  MicrosoftSqlServerDataProviderSettings& WithS3AccessRoleArn(S3AccessRoleArnT&& value) {
    SetS3AccessRoleArn(std::forward<S3AccessRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
