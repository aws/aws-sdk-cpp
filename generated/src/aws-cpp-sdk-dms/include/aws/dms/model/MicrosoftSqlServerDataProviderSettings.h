...
namespace Model
{
  ...
  {
  public:
    AWS_DATABASEMIGRATIONSERVICE_API MicrosoftSqlServerDataProviderSettings() = default;
    ...
    template<typename ServerNameT = Aws::String>
    MicrosoftSqlServerDataProviderSettings& WithServerName(ServerNameT&& value) { SetServerName(std::forward<ServerNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseNameT = Aws::String>
    MicrosoftSqlServerDataProviderSettings& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    inline MicrosoftSqlServerDataProviderSettings& WithSslMode(DmsSslModeValue value) { SetSslMode(value); return *this;}
    ///@}
    ...
    template<typename CertificateArnT = Aws::String>
    MicrosoftSqlServerDataProviderSettings& WithCertificateArn(CertificateArnT&& value) { SetCertificateArn(std::forward<CertificateArnT>(value)); return *this;}
    ///@}
    ...
    template<typename S3PathT = Aws::String>
    MicrosoftSqlServerDataProviderSettings& WithS3Path(S3PathT&& value) { SetS3Path(std::forward<S3PathT>(value)); return *this;}
    ///@}
    ...
    template<typename S3AccessRoleArnT = Aws::String>
    MicrosoftSqlServerDataProviderSettings& WithS3AccessRoleArn(S3AccessRoleArnT&& value) { SetS3AccessRoleArn(std::forward<S3AccessRoleArnT>(value)); return *this;}
    ///@}
  private:
