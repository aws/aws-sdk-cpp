...
namespace Model
{
  ...
  {
  public:
    AWS_DATABASEMIGRATIONSERVICE_API DeleteReplicationTaskAssessmentRunRequest() = default;
    ...
    template<typename ReplicationTaskAssessmentRunArnT = Aws::String>
    DeleteReplicationTaskAssessmentRunRequest& WithReplicationTaskAssessmentRunArn(ReplicationTaskAssessmentRunArnT&& value) { SetReplicationTaskAssessmentRunArn(std::forward<ReplicationTaskAssessmentRunArnT>(value)); return *this;}
    ///@}
  private:
