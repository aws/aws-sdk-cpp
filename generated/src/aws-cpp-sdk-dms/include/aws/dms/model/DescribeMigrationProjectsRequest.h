...
class DescribeMigrationProjectsRequest : public DatabaseMigrationServiceRequest {
 public:
  AWS_DATABASEMIGRATIONSERVICE_API DescribeMigrationProjectsRequest() = default;
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeMigrationProjectsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeMigrationProjectsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeMigrationProjectsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeMigrationProjectsRequest& WithMarker(MarkerT&& value) {
