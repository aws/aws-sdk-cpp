...
class CreateInstanceProfileResult {
 public:
  AWS_DATABASEMIGRATIONSERVICE_API CreateInstanceProfileResult() = default;
  ...
  AWS_DATABASEMIGRATIONSERVICE_API CreateInstanceProfileResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  CreateInstanceProfileResult& WithRequestId(RequestIdT&& value) {
