...
class StartReplicationTaskResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API StartReplicationTaskResult& operator=(
  ...
  template <typename ReplicationTaskT = ReplicationTask>
  StartReplicationTaskResult& WithReplicationTask(ReplicationTaskT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartReplicationTaskResult& WithRequestId(RequestIdT&& value) {
