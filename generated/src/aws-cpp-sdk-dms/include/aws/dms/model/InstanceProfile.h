...
class InstanceProfile {
 public:
   ...
   * value for the <code>KmsKeyArn</code> parameter, then DMS uses an Amazon Web
   * Services owned encryption key to encrypt your resources.</p>
   */
  ...
  inline InstanceProfile& WithPubliclyAccessible(bool value) {
  ...
  void SetInstanceProfileCreationTime(InstanceProfileCreationTimeT&& value) {
    ...
    m_instanceProfileCreationTime = std::forward<InstanceProfileCreationTimeT>(value);
  }
  template <typename InstanceProfileCreationTimeT = Aws::Utils::DateTime>
  InstanceProfile& WithInstanceProfileCreationTime(InstanceProfileCreationTimeT&& value) {
    SetInstanceProfileCreationTime(std::forward<InstanceProfileCreationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubnetGroupIdentifier(SubnetGroupIdentifierT&& value) {
    ...
    m_subnetGroupIdentifier = std::forward<SubnetGroupIdentifierT>(value);
  }
  template <typename SubnetGroupIdentifierT = Aws::String>
  InstanceProfile& WithSubnetGroupIdentifier(SubnetGroupIdentifierT&& value) {
    SetSubnetGroupIdentifier(std::forward<SubnetGroupIdentifierT>(value));
    return *this;
  }
  ///@}
