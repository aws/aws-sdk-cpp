...
class DescribeMetadataModelConversionsRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeMetadataModelConversionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeMetadataModelConversionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeMetadataModelConversionsRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeMetadataModelConversionsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
