...
class StartMetadataModelAssessmentRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename MigrationProjectIdentifierT = Aws::String>
  StartMetadataModelAssessmentRequest& WithMigrationProjectIdentifier(MigrationProjectIdentifierT&& value) {
  ...
  ///@{
  /**
   * <p>A JSON string that identifies the metadata models to assess. For the
  ...
  template <typename SelectionRulesT = Aws::String>
  StartMetadataModelAssessmentRequest& WithSelectionRules(SelectionRulesT&& value) {
