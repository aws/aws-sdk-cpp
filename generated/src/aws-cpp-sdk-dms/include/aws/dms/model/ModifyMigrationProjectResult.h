...
class ModifyMigrationProjectResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API ModifyMigrationProjectResult& operator=(
  ...
  void SetMigrationProject(MigrationProjectT&& value) {
    m_migrationProjectHasBeenSet = true;
    m_migrationProject = std::forward<MigrationProjectT>(value);
  }
  template <typename MigrationProjectT = MigrationProject>
  ModifyMigrationProjectResult& WithMigrationProject(MigrationProjectT&& value) {
    SetMigrationProject(std::forward<MigrationProjectT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ModifyMigrationProjectResult& WithRequestId(RequestIdT&& value) {
