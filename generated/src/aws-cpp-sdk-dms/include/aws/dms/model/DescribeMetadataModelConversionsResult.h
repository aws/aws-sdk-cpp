...
class DescribeMetadataModelConversionsResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeMetadataModelConversionsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename MarkerT = Aws::String>
  DescribeMetadataModelConversionsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestsT = Aws::Vector<SchemaConversionRequest>>
  DescribeMetadataModelConversionsResult& WithRequests(RequestsT&& value) {
    SetRequests(std::forward<RequestsT>(value));
    return *this;
  }
  template <typename RequestsT = SchemaConversionRequest>
  DescribeMetadataModelConversionsResult& AddRequests(RequestsT&& value) {
    m_requestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMetadataModelConversionsResult& WithRequestId(RequestIdT&& value) {
