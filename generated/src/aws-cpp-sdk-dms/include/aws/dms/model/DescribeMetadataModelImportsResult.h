...
class DescribeMetadataModelImportsResult {
 public:
  AWS_DATABASEMIGRATIONSERVICE_API DescribeMetadataModelImportsResult() = default;
  AWS_DATABASEMIGRATIONSERVICE_API DescribeMetadataModelImportsResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_DATABASEMIGRATIONSERVICE_API DescribeMetadataModelImportsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename MarkerT = Aws::String>
  DescribeMetadataModelImportsResult& WithMarker(MarkerT&& value) {
  ...
  ///@{
  /**
   * <p>A paginated list of metadata model import requests.</p>  <p>DMS never
  ...
  template <typename RequestsT = Aws::Vector<SchemaConversionRequest>>
  DescribeMetadataModelImportsResult& WithRequests(RequestsT&& value) {
    SetRequests(std::forward<RequestsT>(value));
    return *this;
  }
  template <typename RequestsT = SchemaConversionRequest>
  DescribeMetadataModelImportsResult& AddRequests(RequestsT&& value) {
    m_requestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMetadataModelImportsResult& WithRequestId(RequestIdT&& value) {
