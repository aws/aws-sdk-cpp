...
class CreateReplicationSubnetGroupResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API CreateReplicationSubnetGroupResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ReplicationSubnetGroupT = ReplicationSubnetGroup>
  CreateReplicationSubnetGroupResult& WithReplicationSubnetGroup(ReplicationSubnetGroupT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateReplicationSubnetGroupResult& WithRequestId(RequestIdT&& value) {
