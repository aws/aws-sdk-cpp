...
class InventoryData {
 public:
  ...
  inline void SetNumberOfDatabases(int value) {
    m_numberOfDatabasesHasBeenSet = true;
    m_numberOfDatabases = value;
  }
  inline InventoryData& WithNumberOfDatabases(int value) {
    SetNumberOfDatabases(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfSchemas(int value) {
    m_numberOfSchemasHasBeenSet = true;
    m_numberOfSchemas = value;
  }
  inline InventoryData& WithNumberOfSchemas(int value) {
