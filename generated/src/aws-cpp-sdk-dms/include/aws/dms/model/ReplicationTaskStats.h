...
class ReplicationTaskStats {
 public:
  ...
  inline void SetFullLoadProgressPercent(int value) {
    m_fullLoadProgressPercentHasBeenSet = true;
    m_fullLoadProgressPercent = value;
  }
  inline ReplicationTaskStats& WithFullLoadProgressPercent(int value) {
    SetFullLoadProgressPercent(value);
    return *this;
  }
  ///@}
  ...
  inline void SetElapsedTimeMillis(long long value) {
    m_elapsedTimeMillisHasBeenSet = true;
    m_elapsedTimeMillis = value;
  }
  inline ReplicationTaskStats& WithElapsedTimeMillis(long long value) {
    SetElapsedTimeMillis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTablesLoaded(int value) {
    m_tablesLoadedHasBeenSet = true;
    m_tablesLoaded = value;
  }
  inline ReplicationTaskStats& WithTablesLoaded(int value) {
    SetTablesLoaded(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTablesLoading(int value) {
    m_tablesLoadingHasBeenSet = true;
    m_tablesLoading = value;
  }
  inline ReplicationTaskStats& WithTablesLoading(int value) {
    SetTablesLoading(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTablesQueued(int value) {
    m_tablesQueuedHasBeenSet = true;
    m_tablesQueued = value;
  }
  inline ReplicationTaskStats& WithTablesQueued(int value) {
    SetTablesQueued(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTablesErrored(int value) {
    m_tablesErroredHasBeenSet = true;
    m_tablesErrored = value;
  }
  inline ReplicationTaskStats& WithTablesErrored(int value) {
    SetTablesErrored(value);
    return *this;
  }
  ///@}
  ...
  void SetFreshStartDate(FreshStartDateT&& value) {
    ...
    m_freshStartDate = std::forward<FreshStartDateT>(value);
  }
  template <typename FreshStartDateT = Aws::Utils::DateTime>
  ReplicationTaskStats& WithFreshStartDate(FreshStartDateT&& value) {
    SetFreshStartDate(std::forward<FreshStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFullLoadStartDate(FullLoadStartDateT&& value) {
    ...
    m_fullLoadStartDate = std::forward<FullLoadStartDateT>(value);
  }
  template <typename FullLoadStartDateT = Aws::Utils::DateTime>
  ReplicationTaskStats& WithFullLoadStartDate(FullLoadStartDateT&& value) {
    SetFullLoadStartDate(std::forward<FullLoadStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFullLoadFinishDate(FullLoadFinishDateT&& value) {
    ...
    m_fullLoadFinishDate = std::forward<FullLoadFinishDateT>(value);
  }
  template <typename FullLoadFinishDateT = Aws::Utils::DateTime>
  ReplicationTaskStats& WithFullLoadFinishDate(FullLoadFinishDateT&& value) {
    SetFullLoadFinishDate(std::forward<FullLoadFinishDateT>(value));
    return *this;
  }
  ///@}
 private:
