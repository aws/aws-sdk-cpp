...
class MoveReplicationTaskResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API MoveReplicationTaskResult& operator=(
  ...
  template <typename ReplicationTaskT = ReplicationTask>
  MoveReplicationTaskResult& WithReplicationTask(ReplicationTaskT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  MoveReplicationTaskResult& WithRequestId(RequestIdT&& value) {
