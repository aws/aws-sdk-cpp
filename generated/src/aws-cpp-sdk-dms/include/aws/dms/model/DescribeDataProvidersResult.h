...
class DescribeDataProvidersResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeDataProvidersResult& operator=(
  ...
  template <typename MarkerT = Aws::String>
  DescribeDataProvidersResult& WithMarker(MarkerT&& value) {
  ...
  void SetDataProviders(DataProvidersT&& value) {
    m_dataProvidersHasBeenSet = true;
    m_dataProviders = std::forward<DataProvidersT>(value);
  }
  template <typename DataProvidersT = Aws::Vector<DataProvider>>
  DescribeDataProvidersResult& WithDataProviders(DataProvidersT&& value) {
    SetDataProviders(std::forward<DataProvidersT>(value));
    return *this;
  }
  template <typename DataProvidersT = DataProvider>
  DescribeDataProvidersResult& AddDataProviders(DataProvidersT&& value) {
    m_dataProvidersHasBeenSet = true;
    m_dataProviders.emplace_back(std::forward<DataProvidersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDataProvidersResult& WithRequestId(RequestIdT&& value) {
