...
class RebootReplicationInstanceResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API RebootReplicationInstanceResult& operator=(
  ...
  void SetReplicationInstance(ReplicationInstanceT&& value) {
    m_replicationInstanceHasBeenSet = true;
    m_replicationInstance = std::forward<ReplicationInstanceT>(value);
  }
  template <typename ReplicationInstanceT = ReplicationInstance>
  RebootReplicationInstanceResult& WithReplicationInstance(ReplicationInstanceT&& value) {
    SetReplicationInstance(std::forward<ReplicationInstanceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  RebootReplicationInstanceResult& WithRequestId(RequestIdT&& value) {
