...
class PostgreSqlDataProviderSettings {
 public:
  ...
  template <typename ServerNameT = Aws::String>
  PostgreSqlDataProviderSettings& WithServerName(ServerNameT&& value) {
  ...
  inline PostgreSqlDataProviderSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline PostgreSqlDataProviderSettings& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename S3PathT = Aws::String>
  PostgreSqlDataProviderSettings& WithS3Path(S3PathT&& value) {
