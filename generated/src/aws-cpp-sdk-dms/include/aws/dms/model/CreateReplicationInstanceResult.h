...
class CreateReplicationInstanceResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API CreateReplicationInstanceResult& operator=(
  ...
  template <typename ReplicationInstanceT = ReplicationInstance>
  CreateReplicationInstanceResult& WithReplicationInstance(ReplicationInstanceT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateReplicationInstanceResult& WithRequestId(RequestIdT&& value) {
