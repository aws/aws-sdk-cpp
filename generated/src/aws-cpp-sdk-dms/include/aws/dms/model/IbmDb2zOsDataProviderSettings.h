...
class IbmDb2zOsDataProviderSettings {
 public:
  ...
  template <typename ServerNameT = Aws::String>
  IbmDb2zOsDataProviderSettings& WithServerName(ServerNameT&& value) {
  ...
  inline IbmDb2zOsDataProviderSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename DatabaseNameT = Aws::String>
  IbmDb2zOsDataProviderSettings& WithDatabaseName(DatabaseNameT&& value) {
  ...
  inline IbmDb2zOsDataProviderSettings& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename CertificateArnT = Aws::String>
  IbmDb2zOsDataProviderSettings& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename S3PathT = Aws::String>
  IbmDb2zOsDataProviderSettings& WithS3Path(S3PathT&& value) {
  ...
  template <typename S3AccessRoleArnT = Aws::String>
  IbmDb2zOsDataProviderSettings& WithS3AccessRoleArn(S3AccessRoleArnT&& value) {
