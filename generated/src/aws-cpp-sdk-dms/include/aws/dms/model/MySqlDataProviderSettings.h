...
class MySqlDataProviderSettings {
 public:
  ...
  template <typename ServerNameT = Aws::String>
  MySqlDataProviderSettings& WithServerName(ServerNameT&& value) {
  ...
  inline MySqlDataProviderSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline MySqlDataProviderSettings& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename CertificateArnT = Aws::String>
  MySqlDataProviderSettings& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename S3PathT = Aws::String>
  MySqlDataProviderSettings& WithS3Path(S3PathT&& value) {
  ...
  template <typename S3AccessRoleArnT = Aws::String>
  MySqlDataProviderSettings& WithS3AccessRoleArn(S3AccessRoleArnT&& value) {
