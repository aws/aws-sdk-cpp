...
class RefreshSchemasStatus {
 public:
  ...
  inline void SetStatus(RefreshSchemasStatusTypeValue value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline RefreshSchemasStatus& WithStatus(RefreshSchemasStatusTypeValue value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastRefreshDate(LastRefreshDateT&& value) {
    ...
    m_lastRefreshDate = std::forward<LastRefreshDateT>(value);
  }
  template <typename LastRefreshDateT = Aws::Utils::DateTime>
  RefreshSchemasStatus& WithLastRefreshDate(LastRefreshDateT&& value) {
    SetLastRefreshDate(std::forward<LastRefreshDateT>(value));
    return *this;
  }
  ///@}
