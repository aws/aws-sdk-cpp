...
class DescribeApplicableIndividualAssessmentsResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeApplicableIndividualAssessmentsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetIndividualAssessmentNames(IndividualAssessmentNamesT&& value) {
    m_individualAssessmentNamesHasBeenSet = true;
    m_individualAssessmentNames = std::forward<IndividualAssessmentNamesT>(value);
  }
  template <typename IndividualAssessmentNamesT = Aws::Vector<Aws::String>>
  DescribeApplicableIndividualAssessmentsResult& WithIndividualAssessmentNames(IndividualAssessmentNamesT&& value) {
    SetIndividualAssessmentNames(std::forward<IndividualAssessmentNamesT>(value));
    return *this;
  }
  template <typename IndividualAssessmentNamesT = Aws::String>
  DescribeApplicableIndividualAssessmentsResult& AddIndividualAssessmentNames(IndividualAssessmentNamesT&& value) {
    m_individualAssessmentNamesHasBeenSet = true;
    m_individualAssessmentNames.emplace_back(std::forward<IndividualAssessmentNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeApplicableIndividualAssessmentsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeApplicableIndividualAssessmentsResult& WithRequestId(RequestIdT&& value) {
