...
class DeleteMigrationProjectResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DeleteMigrationProjectResult& operator=(
  ...
  template <typename MigrationProjectT = MigrationProject>
  DeleteMigrationProjectResult& WithMigrationProject(MigrationProjectT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteMigrationProjectResult& WithRequestId(RequestIdT&& value) {
