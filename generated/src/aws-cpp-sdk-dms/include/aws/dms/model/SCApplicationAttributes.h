...
class SCApplicationAttributes {
 public:
  ...
  void SetS3BucketPath(S3BucketPathT&& value) {
    ...
    m_s3BucketPath = std::forward<S3BucketPathT>(value);
  }
  template <typename S3BucketPathT = Aws::String>
  SCApplicationAttributes& WithS3BucketPath(S3BucketPathT&& value) {
    SetS3BucketPath(std::forward<S3BucketPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3BucketRoleArn(S3BucketRoleArnT&& value) {
    ...
    m_s3BucketRoleArn = std::forward<S3BucketRoleArnT>(value);
  }
  template <typename S3BucketRoleArnT = Aws::String>
  SCApplicationAttributes& WithS3BucketRoleArn(S3BucketRoleArnT&& value) {
    SetS3BucketRoleArn(std::forward<S3BucketRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
