...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class RefreshSchemasRequest : public DatabaseMigrationServiceRequest
  {
  public:
    AWS_DATABASEMIGRATIONSERVICE_API RefreshSchemasRequest() = default;
    ...
    template<typename EndpointArnT = Aws::String>
    RefreshSchemasRequest& WithEndpointArn(EndpointArnT&& value) { SetEndpointArn(std::forward<EndpointArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ReplicationInstanceArnT = Aws::String>
    RefreshSchemasRequest& WithReplicationInstanceArn(ReplicationInstanceArnT&& value) { SetReplicationInstanceArn(std::forward<ReplicationInstanceArnT>(value)); return *this;}
    ///@}
  private:
