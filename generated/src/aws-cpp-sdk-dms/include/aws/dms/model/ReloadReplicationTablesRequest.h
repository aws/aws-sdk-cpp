...
class ReloadReplicationTablesRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  void SetTablesToReload(TablesToReloadT&& value) {
    m_tablesToReloadHasBeenSet = true;
    m_tablesToReload = std::forward<TablesToReloadT>(value);
  }
  template <typename TablesToReloadT = Aws::Vector<TableToReload>>
  ReloadReplicationTablesRequest& WithTablesToReload(TablesToReloadT&& value) {
    SetTablesToReload(std::forward<TablesToReloadT>(value));
    return *this;
  }
  template <typename TablesToReloadT = TableToReload>
  ReloadReplicationTablesRequest& AddTablesToReload(TablesToReloadT&& value) {
    m_tablesToReloadHasBeenSet = true;
    m_tablesToReload.emplace_back(std::forward<TablesToReloadT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReloadOption(ReloadOptionValue value) {
    m_reloadOptionHasBeenSet = true;
    m_reloadOption = value;
  }
  inline ReloadReplicationTablesRequest& WithReloadOption(ReloadOptionValue value) {
