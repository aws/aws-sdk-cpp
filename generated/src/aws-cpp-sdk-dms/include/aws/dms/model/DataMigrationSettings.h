...
class DataMigrationSettings {
 public:
  ...
  inline DataMigrationSettings& WithNumberOfJobs(int value) {
  ...
  inline void SetCloudwatchLogsEnabled(bool value) {
    m_cloudwatchLogsEnabledHasBeenSet = true;
    m_cloudwatchLogsEnabled = value;
  }
  inline DataMigrationSettings& WithCloudwatchLogsEnabled(bool value) {
    SetCloudwatchLogsEnabled(value);
    return *this;
  }
  ///@}
