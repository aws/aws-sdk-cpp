...
class ReloadTablesRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename ReplicationTaskArnT = Aws::String>
  ReloadTablesRequest& WithReplicationTaskArn(ReplicationTaskArnT&& value) {
  ...
  template <typename TablesToReloadT = Aws::Vector<TableToReload>>
  ReloadTablesRequest& WithTablesToReload(TablesToReloadT&& value) {
    SetTablesToReload(std::forward<TablesToReloadT>(value));
    return *this;
  }
  template <typename TablesToReloadT = TableToReload>
  ReloadTablesRequest& AddTablesToReload(TablesToReloadT&& value) {
    m_tablesToReloadHasBeenSet = true;
  ...
  inline ReloadTablesRequest& WithReloadOption(ReloadOptionValue value) {
