...
class DocDbDataProviderSettings {
 public:
  ...
  template <typename ServerNameT = Aws::String>
  DocDbDataProviderSettings& WithServerName(ServerNameT&& value) {
  ...
  inline DocDbDataProviderSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename DatabaseNameT = Aws::String>
  DocDbDataProviderSettings& WithDatabaseName(DatabaseNameT&& value) {
  ...
  inline DocDbDataProviderSettings& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename CertificateArnT = Aws::String>
  DocDbDataProviderSettings& WithCertificateArn(CertificateArnT&& value) {
