...
class DescribeReplicationInstanceTaskLogsResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeReplicationInstanceTaskLogsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ReplicationInstanceArnT = Aws::String>
  DescribeReplicationInstanceTaskLogsResult& WithReplicationInstanceArn(ReplicationInstanceArnT&& value) {
  ...
  void SetReplicationInstanceTaskLogs(ReplicationInstanceTaskLogsT&& value) {
    m_replicationInstanceTaskLogsHasBeenSet = true;
    m_replicationInstanceTaskLogs = std::forward<ReplicationInstanceTaskLogsT>(value);
  }
  template <typename ReplicationInstanceTaskLogsT = Aws::Vector<ReplicationInstanceTaskLog>>
  DescribeReplicationInstanceTaskLogsResult& WithReplicationInstanceTaskLogs(ReplicationInstanceTaskLogsT&& value) {
    SetReplicationInstanceTaskLogs(std::forward<ReplicationInstanceTaskLogsT>(value));
    return *this;
  }
  template <typename ReplicationInstanceTaskLogsT = ReplicationInstanceTaskLog>
  DescribeReplicationInstanceTaskLogsResult& AddReplicationInstanceTaskLogs(ReplicationInstanceTaskLogsT&& value) {
    m_replicationInstanceTaskLogsHasBeenSet = true;
    m_replicationInstanceTaskLogs.emplace_back(std::forward<ReplicationInstanceTaskLogsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeReplicationInstanceTaskLogsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeReplicationInstanceTaskLogsResult& WithRequestId(RequestIdT&& value) {
