...
class DescribeRecommendationsRequest : public DatabaseMigrationServiceRequest {
 public:
   ...
   * key-value pairs.</p> <p>Valid filter names: <code>database-id</code> |
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeRecommendationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeRecommendationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeRecommendationsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRecommendationsRequest& WithNextToken(NextTokenT&& value) {
