...
class ReplicationTaskAssessmentRun {
 public:
  ...
  void SetReplicationTaskAssessmentRunArn(ReplicationTaskAssessmentRunArnT&& value) {
    ...
    m_replicationTaskAssessmentRunArn = std::forward<ReplicationTaskAssessmentRunArnT>(value);
  }
  template <typename ReplicationTaskAssessmentRunArnT = Aws::String>
  ReplicationTaskAssessmentRun& WithReplicationTaskAssessmentRunArn(ReplicationTaskAssessmentRunArnT&& value) {
    SetReplicationTaskAssessmentRunArn(std::forward<ReplicationTaskAssessmentRunArnT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Utils::DateTime& GetReplicationTaskAssessmentRunCreationDate() const {
    return m_replicationTaskAssessmentRunCreationDate;
  }
  ...
  void SetReplicationTaskAssessmentRunCreationDate(ReplicationTaskAssessmentRunCreationDateT&& value) {
    ...
    m_replicationTaskAssessmentRunCreationDate = std::forward<ReplicationTaskAssessmentRunCreationDateT>(value);
  }
  template <typename ReplicationTaskAssessmentRunCreationDateT = Aws::Utils::DateTime>
  ReplicationTaskAssessmentRun& WithReplicationTaskAssessmentRunCreationDate(ReplicationTaskAssessmentRunCreationDateT&& value) {
    SetReplicationTaskAssessmentRunCreationDate(std::forward<ReplicationTaskAssessmentRunCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssessmentProgress(AssessmentProgressT&& value) {
    ...
    m_assessmentProgress = std::forward<AssessmentProgressT>(value);
  }
  template <typename AssessmentProgressT = ReplicationTaskAssessmentRunProgress>
  ReplicationTaskAssessmentRun& WithAssessmentProgress(AssessmentProgressT&& value) {
    SetAssessmentProgress(std::forward<AssessmentProgressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastFailureMessage(LastFailureMessageT&& value) {
    ...
    m_lastFailureMessage = std::forward<LastFailureMessageT>(value);
  }
  template <typename LastFailureMessageT = Aws::String>
  ReplicationTaskAssessmentRun& WithLastFailureMessage(LastFailureMessageT&& value) {
    SetLastFailureMessage(std::forward<LastFailureMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResultLocationBucket(ResultLocationBucketT&& value) {
    ...
    m_resultLocationBucket = std::forward<ResultLocationBucketT>(value);
  }
  template <typename ResultLocationBucketT = Aws::String>
  ReplicationTaskAssessmentRun& WithResultLocationBucket(ResultLocationBucketT&& value) {
    SetResultLocationBucket(std::forward<ResultLocationBucketT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResultLocationFolder(ResultLocationFolderT&& value) {
    ...
    m_resultLocationFolder = std::forward<ResultLocationFolderT>(value);
  }
  template <typename ResultLocationFolderT = Aws::String>
  ReplicationTaskAssessmentRun& WithResultLocationFolder(ResultLocationFolderT&& value) {
    SetResultLocationFolder(std::forward<ResultLocationFolderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResultEncryptionMode(ResultEncryptionModeT&& value) {
    ...
    m_resultEncryptionMode = std::forward<ResultEncryptionModeT>(value);
  }
  template <typename ResultEncryptionModeT = Aws::String>
  ReplicationTaskAssessmentRun& WithResultEncryptionMode(ResultEncryptionModeT&& value) {
    SetResultEncryptionMode(std::forward<ResultEncryptionModeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResultKmsKeyArn(ResultKmsKeyArnT&& value) {
    ...
    m_resultKmsKeyArn = std::forward<ResultKmsKeyArnT>(value);
  }
  template <typename ResultKmsKeyArnT = Aws::String>
  ReplicationTaskAssessmentRun& WithResultKmsKeyArn(ResultKmsKeyArnT&& value) {
    SetResultKmsKeyArn(std::forward<ResultKmsKeyArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssessmentRunName(AssessmentRunNameT&& value) {
    ...
    m_assessmentRunName = std::forward<AssessmentRunNameT>(value);
  }
  template <typename AssessmentRunNameT = Aws::String>
  ReplicationTaskAssessmentRun& WithAssessmentRunName(AssessmentRunNameT&& value) {
    SetAssessmentRunName(std::forward<AssessmentRunNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsLatestTaskAssessmentRun(bool value) {
    m_isLatestTaskAssessmentRunHasBeenSet = true;
    m_isLatestTaskAssessmentRun = value;
  }
  inline ReplicationTaskAssessmentRun& WithIsLatestTaskAssessmentRun(bool value) {
    SetIsLatestTaskAssessmentRun(value);
    return *this;
  }
  ///@}
  ...
  void SetResultStatistic(ResultStatisticT&& value) {
    ...
    m_resultStatistic = std::forward<ResultStatisticT>(value);
  }
  template <typename ResultStatisticT = ReplicationTaskAssessmentRunResultStatistic>
  ReplicationTaskAssessmentRun& WithResultStatistic(ResultStatisticT&& value) {
    SetResultStatistic(std::forward<ResultStatisticT>(value));
    return *this;
  }
  ///@}
 private:
