...
class EndpointSetting {
 public:
  ...
  template <typename NameT = Aws::String>
  EndpointSetting& WithName(NameT&& value) {
  ...
  inline void SetType(EndpointSettingTypeValue value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline EndpointSetting& WithType(EndpointSettingTypeValue value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetEnumValues(EnumValuesT&& value) {
    m_enumValuesHasBeenSet = true;
    m_enumValues = std::forward<EnumValuesT>(value);
  }
  template <typename EnumValuesT = Aws::Vector<Aws::String>>
  EndpointSetting& WithEnumValues(EnumValuesT&& value) {
    SetEnumValues(std::forward<EnumValuesT>(value));
    return *this;
  }
  template <typename EnumValuesT = Aws::String>
  EndpointSetting& AddEnumValues(EnumValuesT&& value) {
    m_enumValuesHasBeenSet = true;
    m_enumValues.emplace_back(std::forward<EnumValuesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSensitive(bool value) {
    m_sensitiveHasBeenSet = true;
    m_sensitive = value;
  }
  inline EndpointSetting& WithSensitive(bool value) {
    SetSensitive(value);
    return *this;
  }
  ///@}
  ...
  void SetUnits(UnitsT&& value) {
    m_unitsHasBeenSet = true;
    m_units = std::forward<UnitsT>(value);
  }
  template <typename UnitsT = Aws::String>
  EndpointSetting& WithUnits(UnitsT&& value) {
    SetUnits(std::forward<UnitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicability(ApplicabilityT&& value) {
    m_applicabilityHasBeenSet = true;
    m_applicability = std::forward<ApplicabilityT>(value);
  }
  template <typename ApplicabilityT = Aws::String>
  EndpointSetting& WithApplicability(ApplicabilityT&& value) {
    SetApplicability(std::forward<ApplicabilityT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIntValueMin(int value) {
    m_intValueMinHasBeenSet = true;
    m_intValueMin = value;
  }
  inline EndpointSetting& WithIntValueMin(int value) {
    SetIntValueMin(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIntValueMax(int value) {
    m_intValueMaxHasBeenSet = true;
    m_intValueMax = value;
  }
  inline EndpointSetting& WithIntValueMax(int value) {
    SetIntValueMax(value);
    return *this;
  }
  ///@}
