...
class DescribeFleetAdvisorLsaAnalysisResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeFleetAdvisorLsaAnalysisResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AnalysisT = Aws::Vector<FleetAdvisorLsaAnalysisResponse>>
  DescribeFleetAdvisorLsaAnalysisResult& WithAnalysis(AnalysisT&& value) {
    SetAnalysis(std::forward<AnalysisT>(value));
    return *this;
  }
  template <typename AnalysisT = FleetAdvisorLsaAnalysisResponse>
  DescribeFleetAdvisorLsaAnalysisResult& AddAnalysis(AnalysisT&& value) {
    m_analysisHasBeenSet = true;
    m_analysis.emplace_back(std::forward<AnalysisT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFleetAdvisorLsaAnalysisResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFleetAdvisorLsaAnalysisResult& WithRequestId(RequestIdT&& value) {
