...
class KinesisSettings {
 public:
  ...
  inline KinesisSettings& WithMessageFormat(MessageFormatValue value) {
  ...
  inline KinesisSettings& WithIncludeTransactionDetails(bool value) {
  ...
  inline KinesisSettings& WithIncludePartitionValue(bool value) {
  ...
  inline KinesisSettings& WithPartitionIncludeSchemaTable(bool value) {
  ...
  inline KinesisSettings& WithIncludeTableAlterOperations(bool value) {
  ...
  inline KinesisSettings& WithIncludeControlDetails(bool value) {
  ...
  inline KinesisSettings& WithIncludeNullAndEmpty(bool value) {
  ...
  inline KinesisSettings& WithNoHexPrefix(bool value) {
  ...
  inline KinesisSettings& WithUseLargeIntegerValue(bool value) {
