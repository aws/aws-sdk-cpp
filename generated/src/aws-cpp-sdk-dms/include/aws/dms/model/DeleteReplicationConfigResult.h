...
class DeleteReplicationConfigResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DeleteReplicationConfigResult& operator=(
  ...
  template <typename ReplicationConfigT = ReplicationConfig>
  DeleteReplicationConfigResult& WithReplicationConfig(ReplicationConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteReplicationConfigResult& WithRequestId(RequestIdT&& value) {
