...
class NeptuneSettings {
 public:
  ...
  void SetS3BucketFolder(S3BucketFolderT&& value) {
    ...
    m_s3BucketFolder = std::forward<S3BucketFolderT>(value);
  }
  template <typename S3BucketFolderT = Aws::String>
  NeptuneSettings& WithS3BucketFolder(S3BucketFolderT&& value) {
    SetS3BucketFolder(std::forward<S3BucketFolderT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetErrorRetryDuration(int value) {
    m_errorRetryDurationHasBeenSet = true;
    m_errorRetryDuration = value;
  }
  inline NeptuneSettings& WithErrorRetryDuration(int value) {
    SetErrorRetryDuration(value);
    return *this;
  }
  ///@}
  ...
  inline NeptuneSettings& WithMaxFileSize(int value) {
  ...
  inline void SetMaxRetryCount(int value) {
    m_maxRetryCountHasBeenSet = true;
    m_maxRetryCount = value;
  }
  inline NeptuneSettings& WithMaxRetryCount(int value) {
  ...
  inline void SetIamAuthEnabled(bool value) {
    m_iamAuthEnabledHasBeenSet = true;
    m_iamAuthEnabled = value;
  }
  inline NeptuneSettings& WithIamAuthEnabled(bool value) {
    SetIamAuthEnabled(value);
    return *this;
  }
  ///@}
 private:
