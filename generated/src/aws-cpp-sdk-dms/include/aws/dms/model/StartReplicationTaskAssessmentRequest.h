...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class StartReplicationTaskAssessmentRequest : public DatabaseMigrationServiceRequest
  {
  public:
    AWS_DATABASEMIGRATIONSERVICE_API StartReplicationTaskAssessmentRequest();
