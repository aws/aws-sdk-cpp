...
class DescribeMetadataModelAssessmentsResult {
 public:
  ...
  AWS_DATABASEMIGRATIONSERVICE_API DescribeMetadataModelAssessmentsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename MarkerT = Aws::String>
  DescribeMetadataModelAssessmentsResult& WithMarker(MarkerT&& value) {
  ...
  ///@{
  /**
   * <p>A paginated list of metadata model assessment requests.</p>  <p>DMS
  ...
  template <typename RequestsT = Aws::Vector<SchemaConversionRequest>>
  DescribeMetadataModelAssessmentsResult& WithRequests(RequestsT&& value) {
    SetRequests(std::forward<RequestsT>(value));
    return *this;
  }
  template <typename RequestsT = SchemaConversionRequest>
  DescribeMetadataModelAssessmentsResult& AddRequests(RequestsT&& value) {
    m_requestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMetadataModelAssessmentsResult& WithRequestId(RequestIdT&& value) {
