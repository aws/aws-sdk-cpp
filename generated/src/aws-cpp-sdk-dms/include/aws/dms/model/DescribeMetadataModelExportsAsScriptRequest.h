...
namespace Model
{
  ...
  {
  public:
    AWS_DATABASEMIGRATIONSERVICE_API DescribeMetadataModelExportsAsScriptRequest() = default;
    ...
    template<typename MigrationProjectIdentifierT = Aws::String>
    DescribeMetadataModelExportsAsScriptRequest& WithMigrationProjectIdentifier(MigrationProjectIdentifierT&& value) { SetMigrationProjectIdentifier(std::forward<MigrationProjectIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    DescribeMetadataModelExportsAsScriptRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    DescribeMetadataModelExportsAsScriptRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    DescribeMetadataModelExportsAsScriptRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
