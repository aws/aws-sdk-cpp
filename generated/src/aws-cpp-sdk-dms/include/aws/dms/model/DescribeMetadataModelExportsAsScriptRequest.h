...
class DescribeMetadataModelExportsAsScriptRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename MigrationProjectIdentifierT = Aws::String>
  DescribeMetadataModelExportsAsScriptRequest& WithMigrationProjectIdentifier(MigrationProjectIdentifierT&& value) {
  ...
  ///@{
  /**
   * <p>The filters to apply to the metadata model export requests.</p> <p>The
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeMetadataModelExportsAsScriptRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeMetadataModelExportsAsScriptRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeMetadataModelExportsAsScriptRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeMetadataModelExportsAsScriptRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
