...
class KafkaSettings {
 public:
  ...
  void SetBroker(BrokerT&& value) {
    ...
    m_broker = std::forward<BrokerT>(value);
  }
  template <typename BrokerT = Aws::String>
  KafkaSettings& WithBroker(BrokerT&& value) {
    SetBroker(std::forward<BrokerT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMessageFormat(MessageFormatValue value) {
    m_messageFormatHasBeenSet = true;
    m_messageFormat = value;
  }
  inline KafkaSettings& WithMessageFormat(MessageFormatValue value) {
  ...
  inline void SetIncludeTransactionDetails(bool value) {
    m_includeTransactionDetailsHasBeenSet = true;
    m_includeTransactionDetails = value;
  }
  inline KafkaSettings& WithIncludeTransactionDetails(bool value) {
    SetIncludeTransactionDetails(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludePartitionValue(bool value) {
    m_includePartitionValueHasBeenSet = true;
    m_includePartitionValue = value;
  }
  inline KafkaSettings& WithIncludePartitionValue(bool value) {
    SetIncludePartitionValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPartitionIncludeSchemaTable(bool value) {
    m_partitionIncludeSchemaTableHasBeenSet = true;
    m_partitionIncludeSchemaTable = value;
  }
  inline KafkaSettings& WithPartitionIncludeSchemaTable(bool value) {
    SetPartitionIncludeSchemaTable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeTableAlterOperations(bool value) {
    m_includeTableAlterOperationsHasBeenSet = true;
    m_includeTableAlterOperations = value;
  }
  inline KafkaSettings& WithIncludeTableAlterOperations(bool value) {
    SetIncludeTableAlterOperations(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeControlDetails(bool value) {
    m_includeControlDetailsHasBeenSet = true;
    m_includeControlDetails = value;
  }
  inline KafkaSettings& WithIncludeControlDetails(bool value) {
    SetIncludeControlDetails(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMessageMaxBytes(int value) {
    m_messageMaxBytesHasBeenSet = true;
    m_messageMaxBytes = value;
  }
  inline KafkaSettings& WithMessageMaxBytes(int value) {
    SetMessageMaxBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeNullAndEmpty(bool value) {
    m_includeNullAndEmptyHasBeenSet = true;
    m_includeNullAndEmpty = value;
  }
  inline KafkaSettings& WithIncludeNullAndEmpty(bool value) {
    SetIncludeNullAndEmpty(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSecurityProtocol(KafkaSecurityProtocol value) {
    m_securityProtocolHasBeenSet = true;
    m_securityProtocol = value;
  }
  inline KafkaSettings& WithSecurityProtocol(KafkaSecurityProtocol value) {
    SetSecurityProtocol(value);
    return *this;
  }
  ///@}
  ...
  void SetSslClientCertificateArn(SslClientCertificateArnT&& value) {
    ...
    m_sslClientCertificateArn = std::forward<SslClientCertificateArnT>(value);
  }
  template <typename SslClientCertificateArnT = Aws::String>
  KafkaSettings& WithSslClientCertificateArn(SslClientCertificateArnT&& value) {
    SetSslClientCertificateArn(std::forward<SslClientCertificateArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSslClientKeyArn(SslClientKeyArnT&& value) {
    ...
    m_sslClientKeyArn = std::forward<SslClientKeyArnT>(value);
  }
  template <typename SslClientKeyArnT = Aws::String>
  KafkaSettings& WithSslClientKeyArn(SslClientKeyArnT&& value) {
    SetSslClientKeyArn(std::forward<SslClientKeyArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSslClientKeyPassword(SslClientKeyPasswordT&& value) {
    ...
    m_sslClientKeyPassword = std::forward<SslClientKeyPasswordT>(value);
  }
  template <typename SslClientKeyPasswordT = Aws::String>
  KafkaSettings& WithSslClientKeyPassword(SslClientKeyPasswordT&& value) {
    SetSslClientKeyPassword(std::forward<SslClientKeyPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSslCaCertificateArn(SslCaCertificateArnT&& value) {
    ...
    m_sslCaCertificateArn = std::forward<SslCaCertificateArnT>(value);
  }
  template <typename SslCaCertificateArnT = Aws::String>
  KafkaSettings& WithSslCaCertificateArn(SslCaCertificateArnT&& value) {
    SetSslCaCertificateArn(std::forward<SslCaCertificateArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSaslUsername(SaslUsernameT&& value) {
    ...
    m_saslUsername = std::forward<SaslUsernameT>(value);
  }
  template <typename SaslUsernameT = Aws::String>
  KafkaSettings& WithSaslUsername(SaslUsernameT&& value) {
    SetSaslUsername(std::forward<SaslUsernameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSaslPassword(SaslPasswordT&& value) {
    ...
    m_saslPassword = std::forward<SaslPasswordT>(value);
  }
  template <typename SaslPasswordT = Aws::String>
  KafkaSettings& WithSaslPassword(SaslPasswordT&& value) {
    SetSaslPassword(std::forward<SaslPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNoHexPrefix(bool value) {
    m_noHexPrefixHasBeenSet = true;
    m_noHexPrefix = value;
  }
  inline KafkaSettings& WithNoHexPrefix(bool value) {
    SetNoHexPrefix(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSaslMechanism(KafkaSaslMechanism value) {
    m_saslMechanismHasBeenSet = true;
    m_saslMechanism = value;
  }
  inline KafkaSettings& WithSaslMechanism(KafkaSaslMechanism value) {
   ...
   */
  inline KafkaSslEndpointIdentificationAlgorithm GetSslEndpointIdentificationAlgorithm() const {
    return m_sslEndpointIdentificationAlgorithm;
  }
  inline bool SslEndpointIdentificationAlgorithmHasBeenSet() const { return m_sslEndpointIdentificationAlgorithmHasBeenSet; }
  inline void SetSslEndpointIdentificationAlgorithm(KafkaSslEndpointIdentificationAlgorithm value) {
    m_sslEndpointIdentificationAlgorithmHasBeenSet = true;
    m_sslEndpointIdentificationAlgorithm = value;
  }
  inline KafkaSettings& WithSslEndpointIdentificationAlgorithm(KafkaSslEndpointIdentificationAlgorithm value) {
    SetSslEndpointIdentificationAlgorithm(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUseLargeIntegerValue(bool value) {
    m_useLargeIntegerValueHasBeenSet = true;
    m_useLargeIntegerValue = value;
  }
  inline KafkaSettings& WithUseLargeIntegerValue(bool value) {
    SetUseLargeIntegerValue(value);
    return *this;
  }
  ///@}
 private:
