...
class DescribeDataProvidersRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeDataProvidersRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeDataProvidersRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeDataProvidersRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDataProvidersRequest& WithMarker(MarkerT&& value) {
