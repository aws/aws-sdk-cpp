...
class DescribeReplicationInstanceTaskLogsRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename ReplicationInstanceArnT = Aws::String>
  DescribeReplicationInstanceTaskLogsRequest& WithReplicationInstanceArn(ReplicationInstanceArnT&& value) {
  ...
  inline DescribeReplicationInstanceTaskLogsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeReplicationInstanceTaskLogsRequest& WithMarker(MarkerT&& value) {
