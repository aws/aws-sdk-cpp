...
class DescribeReplicationTableStatisticsRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename ReplicationConfigArnT = Aws::String>
  DescribeReplicationTableStatisticsRequest& WithReplicationConfigArn(ReplicationConfigArnT&& value) {
  ...
  inline DescribeReplicationTableStatisticsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeReplicationTableStatisticsRequest& WithMarker(MarkerT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeReplicationTableStatisticsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeReplicationTableStatisticsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
