...
namespace Model
{
  ...
  public:
    ...
    template<typename ServerNameT = Aws::String>
    MariaDbDataProviderSettings& WithServerName(ServerNameT&& value) { SetServerName(std::forward<ServerNameT>(value)); return *this;}
    ///@}
    ...
    inline MariaDbDataProviderSettings& WithSslMode(DmsSslModeValue value) { SetSslMode(value); return *this;}
    ///@}
