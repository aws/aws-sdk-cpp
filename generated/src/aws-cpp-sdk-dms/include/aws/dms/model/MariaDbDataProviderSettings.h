...
class MariaDbDataProviderSettings {
 public:
  AWS_DATABASEMIGRATIONSERVICE_API MariaDbDataProviderSettings() = default;
  ...
  template <typename ServerNameT = Aws::String>
  MariaDbDataProviderSettings& WithServerName(ServerNameT&& value) {
  ...
  inline MariaDbDataProviderSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline MariaDbDataProviderSettings& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename CertificateArnT = Aws::String>
  MariaDbDataProviderSettings& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename S3PathT = Aws::String>
  MariaDbDataProviderSettings& WithS3Path(S3PathT&& value) {
  ...
  template <typename S3AccessRoleArnT = Aws::String>
  MariaDbDataProviderSettings& WithS3AccessRoleArn(S3AccessRoleArnT&& value) {
