...
class ProvisionData {
 public:
  ...
  void SetProvisionState(ProvisionStateT&& value) {
    ...
    m_provisionState = std::forward<ProvisionStateT>(value);
  }
  template <typename ProvisionStateT = Aws::String>
  ProvisionData& WithProvisionState(ProvisionStateT&& value) {
    SetProvisionState(std::forward<ProvisionStateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProvisionedCapacityUnits(int value) {
    m_provisionedCapacityUnitsHasBeenSet = true;
    m_provisionedCapacityUnits = value;
  }
  inline ProvisionData& WithProvisionedCapacityUnits(int value) {
    SetProvisionedCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  void SetDateProvisioned(DateProvisionedT&& value) {
    ...
    m_dateProvisioned = std::forward<DateProvisionedT>(value);
  }
  template <typename DateProvisionedT = Aws::Utils::DateTime>
  ProvisionData& WithDateProvisioned(DateProvisionedT&& value) {
    SetDateProvisioned(std::forward<DateProvisionedT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsNewProvisioningAvailable(bool value) {
    m_isNewProvisioningAvailableHasBeenSet = true;
    m_isNewProvisioningAvailable = value;
  }
  inline ProvisionData& WithIsNewProvisioningAvailable(bool value) {
    SetIsNewProvisioningAvailable(value);
    return *this;
  }
  ///@}
  ...
  void SetDateNewProvisioningDataAvailable(DateNewProvisioningDataAvailableT&& value) {
    ...
    m_dateNewProvisioningDataAvailable = std::forward<DateNewProvisioningDataAvailableT>(value);
  }
  template <typename DateNewProvisioningDataAvailableT = Aws::Utils::DateTime>
  ProvisionData& WithDateNewProvisioningDataAvailable(DateNewProvisioningDataAvailableT&& value) {
    SetDateNewProvisioningDataAvailable(std::forward<DateNewProvisioningDataAvailableT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReasonForNewProvisioningData(ReasonForNewProvisioningDataT&& value) {
    ...
    m_reasonForNewProvisioningData = std::forward<ReasonForNewProvisioningDataT>(value);
  }
  template <typename ReasonForNewProvisioningDataT = Aws::String>
  ProvisionData& WithReasonForNewProvisioningData(ReasonForNewProvisioningDataT&& value) {
    SetReasonForNewProvisioningData(std::forward<ReasonForNewProvisioningDataT>(value));
    return *this;
  }
  ///@}
 private:
