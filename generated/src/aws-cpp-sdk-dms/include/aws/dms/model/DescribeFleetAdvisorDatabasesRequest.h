...
class DescribeFleetAdvisorDatabasesRequest : public DatabaseMigrationServiceRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeFleetAdvisorDatabasesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeFleetAdvisorDatabasesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeFleetAdvisorDatabasesRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFleetAdvisorDatabasesRequest& WithNextToken(NextTokenT&& value) {
