...
class MongoDbDataProviderSettings {
 public:
  ...
  inline MongoDbDataProviderSettings& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline MongoDbDataProviderSettings& WithSslMode(DmsSslModeValue value) {
    SetSslMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAuthType(AuthTypeValue value) {
    m_authTypeHasBeenSet = true;
    m_authType = value;
  }
  inline MongoDbDataProviderSettings& WithAuthType(AuthTypeValue value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
  ...
  void SetAuthSource(AuthSourceT&& value) {
    ...
    m_authSource = std::forward<AuthSourceT>(value);
  }
  template <typename AuthSourceT = Aws::String>
  MongoDbDataProviderSettings& WithAuthSource(AuthSourceT&& value) {
    SetAuthSource(std::forward<AuthSourceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAuthMechanism(AuthMechanismValue value) {
    m_authMechanismHasBeenSet = true;
    m_authMechanism = value;
  }
  inline MongoDbDataProviderSettings& WithAuthMechanism(AuthMechanismValue value) {
    SetAuthMechanism(value);
    return *this;
  }
  ///@}
 private:
