...
class AWS_DATABASEMIGRATIONSERVICE_API DatabaseMigrationServiceClient
 ...
 public:
   ...
   */
  DatabaseMigrationServiceClient(const Aws::DatabaseMigrationService::DatabaseMigrationServiceClientConfiguration& clientConfiguration =
  ...
  DatabaseMigrationServiceClient(const Aws::Auth::AWSCredentials& credentials,
                                 std::shared_ptr<DatabaseMigrationServiceEndpointProviderBase> endpointProvider = nullptr,
                                 const Aws::DatabaseMigrationService::DatabaseMigrationServiceClientConfiguration& clientConfiguration =
                                     Aws::DatabaseMigrationService::DatabaseMigrationServiceClientConfiguration());
   ...
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Starts
   * the analysis of up to 20 source databases to recommend target engines for each
   * source database. This is a batch version of <a
  ...
  virtual Model::BatchStartRecommendationsOutcome BatchStartRecommendations(
      const Model::BatchStartRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for BatchStartRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchStartRecommendationsRequestT = Model::BatchStartRecommendationsRequest>
  Model::BatchStartRecommendationsOutcomeCallable BatchStartRecommendationsCallable(
      const BatchStartRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::BatchStartRecommendations, request);
  }

  /**
   * An Async wrapper for BatchStartRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchStartRecommendationsRequestT = Model::BatchStartRecommendationsRequest>
  void BatchStartRecommendationsAsync(const BatchStartRecommendationsResponseReceivedHandler& handler,
   ...
   * <code>StartMetadataModelConversion</code>.</p> <p> <b>Required permissions:</b>
   * <code>dms:CancelMetadataModelConversion</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * <code>StartMetadataModelCreation</code>.</p> <p> <b>Required permissions:</b>
   * <code>dms:CancelMetadataModelCreation</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelReplicationTaskAssessmentRunOutcome CancelReplicationTaskAssessmentRun(
      const Model::CancelReplicationTaskAssessmentRunRequest& request) const;

  /**
   * A Callable wrapper for CancelReplicationTaskAssessmentRun that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CancelReplicationTaskAssessmentRunRequestT = Model::CancelReplicationTaskAssessmentRunRequest>
  Model::CancelReplicationTaskAssessmentRunOutcomeCallable CancelReplicationTaskAssessmentRunCallable(
      const CancelReplicationTaskAssessmentRunRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::CancelReplicationTaskAssessmentRun, request);
  }

  /**
   * An Async wrapper for CancelReplicationTaskAssessmentRun that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CancelReplicationTaskAssessmentRunRequestT = Model::CancelReplicationTaskAssessmentRunRequest>
  void CancelReplicationTaskAssessmentRunAsync(const CancelReplicationTaskAssessmentRunRequestT& request,
                                               const CancelReplicationTaskAssessmentRunResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataMigration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataMigration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDataMigrationRequestT = Model::CreateDataMigrationRequest>
  void CreateDataMigrationAsync(const CreateDataMigrationRequestT& request, const CreateDataMigrationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * data store type and location information about your database. </p> <p>
   * <b>Required permissions:</b> <code>dms:CreateDataProvider</code>. For more
   * information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for CreateDataProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataProvider that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDataProviderRequestT = Model::CreateDataProviderRequest>
  void CreateDataProviderAsync(const CreateDataProviderRequestT& request, const CreateDataProviderResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * information, see <a
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Creates
   * a Fleet Advisor collector using the specified parameters.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/CreateFleetAdvisorCollector">AWS
   * API Reference</a></p>
   */
  virtual Model::CreateFleetAdvisorCollectorOutcome CreateFleetAdvisorCollector(
      const Model::CreateFleetAdvisorCollectorRequest& request) const;

  /**
   * A Callable wrapper for CreateFleetAdvisorCollector that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateFleetAdvisorCollectorRequestT = Model::CreateFleetAdvisorCollectorRequest>
  Model::CreateFleetAdvisorCollectorOutcomeCallable CreateFleetAdvisorCollectorCallable(
      const CreateFleetAdvisorCollectorRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::CreateFleetAdvisorCollector, request);
  }

  /**
   * An Async wrapper for CreateFleetAdvisorCollector that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFleetAdvisorCollectorRequestT = Model::CreateFleetAdvisorCollectorRequest>
  void CreateFleetAdvisorCollectorAsync(const CreateFleetAdvisorCollectorRequestT& request,
                                        const CreateFleetAdvisorCollectorResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&DatabaseMigrationServiceClient::CreateFleetAdvisorCollector, request, handler, context);
  }

  /**
   * <p>Creates the instance profile using the specified parameters.</p> <p>
   * <b>Required permissions:</b> <code>dms:CreateInstanceProfile</code>. For more
   * information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   */
  template <typename CreateInstanceProfileRequestT = Model::CreateInstanceProfileRequest>
  void CreateInstanceProfileAsync(const CreateInstanceProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const CreateInstanceProfileRequestT& request = {}) const {
   ...
   * and <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_CreateDataProvider.html">CreateDataProvider</a>.</p>
   * <p> <b>Required permissions:</b> <code>dms:CreateMigrationProject</code>. For
  ...
  /**
   * A Callable wrapper for CreateMigrationProject that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMigrationProject that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMigrationProjectRequestT = Model::CreateMigrationProjectRequest>
  void CreateMigrationProjectAsync(const CreateMigrationProjectRequestT& request,
                                   const CreateMigrationProjectResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateReplicationConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateReplicationConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateReplicationConfigRequestT = Model::CreateReplicationConfigRequest>
  void CreateReplicationConfigAsync(const CreateReplicationConfigRequestT& request,
                                    const CreateReplicationConfigResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateReplicationInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateReplicationInstanceRequestT = Model::CreateReplicationInstanceRequest>
  Model::CreateReplicationInstanceOutcomeCallable CreateReplicationInstanceCallable(
      const CreateReplicationInstanceRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::CreateReplicationInstance, request);
  }

  /**
   * An Async wrapper for CreateReplicationInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateReplicationInstanceRequestT = Model::CreateReplicationInstanceRequest>
  void CreateReplicationInstanceAsync(const CreateReplicationInstanceRequestT& request,
                                      const CreateReplicationInstanceResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateReplicationSubnetGroupOutcome CreateReplicationSubnetGroup(
      const Model::CreateReplicationSubnetGroupRequest& request) const;

  /**
   * A Callable wrapper for CreateReplicationSubnetGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateReplicationSubnetGroupRequestT = Model::CreateReplicationSubnetGroupRequest>
  Model::CreateReplicationSubnetGroupOutcomeCallable CreateReplicationSubnetGroupCallable(
      const CreateReplicationSubnetGroupRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::CreateReplicationSubnetGroup, request);
  }

  /**
   * An Async wrapper for CreateReplicationSubnetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateReplicationSubnetGroupRequestT = Model::CreateReplicationSubnetGroupRequest>
  void CreateReplicationSubnetGroupAsync(const CreateReplicationSubnetGroupRequestT& request,
                                         const CreateReplicationSubnetGroupResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateReplicationTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateReplicationTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateReplicationTaskRequestT = Model::CreateReplicationTaskRequest>
  void CreateReplicationTaskAsync(const CreateReplicationTaskRequestT& request, const CreateReplicationTaskResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDataMigration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDataMigration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDataMigrationRequestT = Model::DeleteDataMigrationRequest>
  void DeleteDataMigrationAsync(const DeleteDataMigrationRequestT& request, const DeleteDataMigrationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&DatabaseMigrationServiceClient::DeleteDataMigration, request, handler, context);
  }

  /**
   * <p>Deletes the specified data provider.</p> <p> <b>Required permissions:</b>
   * <code>dms:DeleteDataProvider</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p>
   * <p>All migration projects associated with the data provider must be deleted or
   * modified before you can delete the data provider.</p> <p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for DeleteDataProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDataProvider that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDataProviderRequestT = Model::DeleteDataProviderRequest>
  void DeleteDataProviderAsync(const DeleteDataProviderRequestT& request, const DeleteDataProviderResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * information, see <a
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Deletes
   * the specified Fleet Advisor collector.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/DeleteFleetAdvisorCollector">AWS
   * API Reference</a></p>
   */
  virtual Model::DeleteFleetAdvisorCollectorOutcome DeleteFleetAdvisorCollector(
      const Model::DeleteFleetAdvisorCollectorRequest& request) const;

  /**
   * A Callable wrapper for DeleteFleetAdvisorCollector that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteFleetAdvisorCollectorRequestT = Model::DeleteFleetAdvisorCollectorRequest>
  Model::DeleteFleetAdvisorCollectorOutcomeCallable DeleteFleetAdvisorCollectorCallable(
      const DeleteFleetAdvisorCollectorRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DeleteFleetAdvisorCollector, request);
  }

  /**
   * An Async wrapper for DeleteFleetAdvisorCollector that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteFleetAdvisorCollectorRequestT = Model::DeleteFleetAdvisorCollectorRequest>
  void DeleteFleetAdvisorCollectorAsync(const DeleteFleetAdvisorCollectorRequestT& request,
                                        const DeleteFleetAdvisorCollectorResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Deletes
   * the specified Fleet Advisor collector databases.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/DeleteFleetAdvisorDatabases">AWS
   * API Reference</a></p>
   */
  virtual Model::DeleteFleetAdvisorDatabasesOutcome DeleteFleetAdvisorDatabases(
      const Model::DeleteFleetAdvisorDatabasesRequest& request) const;

  /**
   * A Callable wrapper for DeleteFleetAdvisorDatabases that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteFleetAdvisorDatabasesRequestT = Model::DeleteFleetAdvisorDatabasesRequest>
  Model::DeleteFleetAdvisorDatabasesOutcomeCallable DeleteFleetAdvisorDatabasesCallable(
      const DeleteFleetAdvisorDatabasesRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DeleteFleetAdvisorDatabases, request);
  }

  /**
   * An Async wrapper for DeleteFleetAdvisorDatabases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteFleetAdvisorDatabasesRequestT = Model::DeleteFleetAdvisorDatabasesRequest>
  void DeleteFleetAdvisorDatabasesAsync(const DeleteFleetAdvisorDatabasesRequestT& request,
                                        const DeleteFleetAdvisorDatabasesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&DatabaseMigrationServiceClient::DeleteFleetAdvisorDatabases, request, handler, context);
  }

  /**
   * <p>Deletes the specified instance profile.</p> <p> <b>Required permissions:</b>
   * <code>dms:DeleteInstanceProfile</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p>
   * <p>All migration projects associated with the instance profile must be deleted
   * or modified before you can delete the instance profile.</p> <p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * <p>Deletes the specified migration project.</p> <p> <b>Required permissions:</b>
   * <code>dms:DeleteMigrationProject</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p>
  ...
  /**
   * A Callable wrapper for DeleteMigrationProject that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMigrationProject that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMigrationProjectRequestT = Model::DeleteMigrationProjectRequest>
  void DeleteMigrationProjectAsync(const DeleteMigrationProjectRequestT& request,
                                   const DeleteMigrationProjectResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReplicationConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReplicationConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteReplicationConfigRequestT = Model::DeleteReplicationConfigRequest>
  void DeleteReplicationConfigAsync(const DeleteReplicationConfigRequestT& request,
                                    const DeleteReplicationConfigResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReplicationInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteReplicationInstanceRequestT = Model::DeleteReplicationInstanceRequest>
  Model::DeleteReplicationInstanceOutcomeCallable DeleteReplicationInstanceCallable(
      const DeleteReplicationInstanceRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DeleteReplicationInstance, request);
  }

  /**
   * An Async wrapper for DeleteReplicationInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteReplicationInstanceRequestT = Model::DeleteReplicationInstanceRequest>
  void DeleteReplicationInstanceAsync(const DeleteReplicationInstanceRequestT& request,
                                      const DeleteReplicationInstanceResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteReplicationSubnetGroupOutcome DeleteReplicationSubnetGroup(
      const Model::DeleteReplicationSubnetGroupRequest& request) const;

  /**
   * A Callable wrapper for DeleteReplicationSubnetGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteReplicationSubnetGroupRequestT = Model::DeleteReplicationSubnetGroupRequest>
  Model::DeleteReplicationSubnetGroupOutcomeCallable DeleteReplicationSubnetGroupCallable(
      const DeleteReplicationSubnetGroupRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DeleteReplicationSubnetGroup, request);
  }

  /**
   * An Async wrapper for DeleteReplicationSubnetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteReplicationSubnetGroupRequestT = Model::DeleteReplicationSubnetGroupRequest>
  void DeleteReplicationSubnetGroupAsync(const DeleteReplicationSubnetGroupRequestT& request,
                                         const DeleteReplicationSubnetGroupResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteReplicationTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReplicationTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteReplicationTaskRequestT = Model::DeleteReplicationTaskRequest>
  void DeleteReplicationTaskAsync(const DeleteReplicationTaskRequestT& request, const DeleteReplicationTaskResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteReplicationTaskAssessmentRunOutcome DeleteReplicationTaskAssessmentRun(
      const Model::DeleteReplicationTaskAssessmentRunRequest& request) const;

  /**
   * A Callable wrapper for DeleteReplicationTaskAssessmentRun that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteReplicationTaskAssessmentRunRequestT = Model::DeleteReplicationTaskAssessmentRunRequest>
  Model::DeleteReplicationTaskAssessmentRunOutcomeCallable DeleteReplicationTaskAssessmentRunCallable(
      const DeleteReplicationTaskAssessmentRunRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DeleteReplicationTaskAssessmentRun, request);
  }

  /**
   * An Async wrapper for DeleteReplicationTaskAssessmentRun that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteReplicationTaskAssessmentRunRequestT = Model::DeleteReplicationTaskAssessmentRunRequest>
  void DeleteReplicationTaskAssessmentRunAsync(const DeleteReplicationTaskAssessmentRunRequestT& request,
                                               const DeleteReplicationTaskAssessmentRunResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeApplicableIndividualAssessmentsOutcome DescribeApplicableIndividualAssessments(
      const Model::DescribeApplicableIndividualAssessmentsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeApplicableIndividualAssessments that returns a future to the operation so that it can be executed in
  ...
  Model::DescribeApplicableIndividualAssessmentsOutcomeCallable DescribeApplicableIndividualAssessmentsCallable(
      const DescribeApplicableIndividualAssessmentsRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeApplicableIndividualAssessments, request);
  }

  /**
   * An Async wrapper for DescribeApplicableIndividualAssessments that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeApplicableIndividualAssessmentsRequestT = Model::DescribeApplicableIndividualAssessmentsRequest>
  void DescribeApplicableIndividualAssessmentsAsync(const DescribeApplicableIndividualAssessmentsResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                    const DescribeApplicableIndividualAssessmentsRequestT& request = {}) const {
  ...
  /**
   * <p>Returns configuration parameters for a schema conversion project.</p> <p>
   * <b>Required permissions:</b> <code>dms:DescribeConversionConfiguration</code>.
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConversionConfigurationOutcome DescribeConversionConfiguration(
      const Model::DescribeConversionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeConversionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeConversionConfigurationRequestT = Model::DescribeConversionConfigurationRequest>
  Model::DescribeConversionConfigurationOutcomeCallable DescribeConversionConfigurationCallable(
      const DescribeConversionConfigurationRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeConversionConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeConversionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeConversionConfigurationRequestT = Model::DescribeConversionConfigurationRequest>
  void DescribeConversionConfigurationAsync(const DescribeConversionConfigurationRequestT& request,
                                            const DescribeConversionConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDataMigrations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDataMigrations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDataMigrationsRequestT = Model::DescribeDataMigrationsRequest>
  void DescribeDataMigrationsAsync(const DescribeDataMigrationsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribeDataMigrationsRequestT& request = {}) const {
   ...
   * region.</p> <p> <b>Required permissions:</b> <code>dms:ListDataProviders</code>.
   * For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for DescribeDataProviders that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDataProviders that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDataProvidersRequestT = Model::DescribeDataProvidersRequest>
  void DescribeDataProvidersAsync(const DescribeDataProvidersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeDataProvidersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeEndpointSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEndpointSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEndpointSettingsRequestT = Model::DescribeEndpointSettingsRequest>
  void DescribeEndpointSettingsAsync(const DescribeEndpointSettingsRequestT& request,
                                     const DescribeEndpointSettingsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEndpointTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEndpointTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEndpointTypesRequestT = Model::DescribeEndpointTypesRequest>
  void DescribeEndpointTypesAsync(const DescribeEndpointTypesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeEndpointTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeEndpoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEndpoints that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeEndpointsRequestT = Model::DescribeEndpointsRequest>
  void DescribeEndpointsAsync(const DescribeEndpointsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeEndpointsRequestT& request = {}) const {
  ...
  /**
   * <p>Returns a paginated list of extension pack installation requests for a
   * migration project, initiated by <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartExtensionPackAssociation.html">StartExtensionPackAssociation</a>.</p>
   * <p> <b>Required permissions:</b> <code>dms:ListExtensionPacks</code>. For more
   * information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeExtensionPackAssociationsOutcome DescribeExtensionPackAssociations(
      const Model::DescribeExtensionPackAssociationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeExtensionPackAssociations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeExtensionPackAssociationsRequestT = Model::DescribeExtensionPackAssociationsRequest>
  Model::DescribeExtensionPackAssociationsOutcomeCallable DescribeExtensionPackAssociationsCallable(
      const DescribeExtensionPackAssociationsRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeExtensionPackAssociations, request);
  }

  /**
   * An Async wrapper for DescribeExtensionPackAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeExtensionPackAssociationsRequestT = Model::DescribeExtensionPackAssociationsRequest>
  void DescribeExtensionPackAssociationsAsync(const DescribeExtensionPackAssociationsRequestT& request,
                                              const DescribeExtensionPackAssociationsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * information, see <a
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Returns
   * a list of the Fleet Advisor collectors in your account.</p><p><h3>See Also:</h3>
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/DescribeFleetAdvisorCollectors">AWS
   * API Reference</a></p>
   */
  virtual Model::DescribeFleetAdvisorCollectorsOutcome DescribeFleetAdvisorCollectors(
      const Model::DescribeFleetAdvisorCollectorsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeFleetAdvisorCollectors that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeFleetAdvisorCollectorsRequestT = Model::DescribeFleetAdvisorCollectorsRequest>
  Model::DescribeFleetAdvisorCollectorsOutcomeCallable DescribeFleetAdvisorCollectorsCallable(
      const DescribeFleetAdvisorCollectorsRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeFleetAdvisorCollectors, request);
  }

  /**
   * An Async wrapper for DescribeFleetAdvisorCollectors that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeFleetAdvisorCollectorsRequestT = Model::DescribeFleetAdvisorCollectorsRequest>
  void DescribeFleetAdvisorCollectorsAsync(const DescribeFleetAdvisorCollectorsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const DescribeFleetAdvisorCollectorsRequestT& request = {}) const {
   ...
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Returns
   * a list of Fleet Advisor databases in your account.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/DescribeFleetAdvisorDatabases">AWS
   * API Reference</a></p>
   */
  virtual Model::DescribeFleetAdvisorDatabasesOutcome DescribeFleetAdvisorDatabases(
      const Model::DescribeFleetAdvisorDatabasesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeFleetAdvisorDatabases that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeFleetAdvisorDatabasesRequestT = Model::DescribeFleetAdvisorDatabasesRequest>
  Model::DescribeFleetAdvisorDatabasesOutcomeCallable DescribeFleetAdvisorDatabasesCallable(
      const DescribeFleetAdvisorDatabasesRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeFleetAdvisorDatabases, request);
  }

  /**
   * An Async wrapper for DescribeFleetAdvisorDatabases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFleetAdvisorDatabasesRequestT = Model::DescribeFleetAdvisorDatabasesRequest>
  void DescribeFleetAdvisorDatabasesAsync(const DescribeFleetAdvisorDatabasesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeFleetAdvisorDatabasesRequestT& request = {}) const {
   ...
   * information, see <a
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Provides
   * descriptions of large-scale assessment (LSA) analyses produced by your Fleet
   * Advisor collectors. </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/DescribeFleetAdvisorLsaAnalysis">AWS
   * API Reference</a></p>
   */
  virtual Model::DescribeFleetAdvisorLsaAnalysisOutcome DescribeFleetAdvisorLsaAnalysis(
      const Model::DescribeFleetAdvisorLsaAnalysisRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeFleetAdvisorLsaAnalysis that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeFleetAdvisorLsaAnalysisRequestT = Model::DescribeFleetAdvisorLsaAnalysisRequest>
  Model::DescribeFleetAdvisorLsaAnalysisOutcomeCallable DescribeFleetAdvisorLsaAnalysisCallable(
      const DescribeFleetAdvisorLsaAnalysisRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeFleetAdvisorLsaAnalysis, request);
  }

  /**
   * An Async wrapper for DescribeFleetAdvisorLsaAnalysis that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeFleetAdvisorLsaAnalysisRequestT = Model::DescribeFleetAdvisorLsaAnalysisRequest>
  void DescribeFleetAdvisorLsaAnalysisAsync(const DescribeFleetAdvisorLsaAnalysisResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DescribeFleetAdvisorLsaAnalysisRequestT& request = {}) const {
   ...
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Provides
   * descriptions of the schemas discovered by your Fleet Advisor
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeFleetAdvisorSchemaObjectSummaryOutcome DescribeFleetAdvisorSchemaObjectSummary(
      const Model::DescribeFleetAdvisorSchemaObjectSummaryRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeFleetAdvisorSchemaObjectSummary that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeFleetAdvisorSchemaObjectSummaryRequestT = Model::DescribeFleetAdvisorSchemaObjectSummaryRequest>
  Model::DescribeFleetAdvisorSchemaObjectSummaryOutcomeCallable DescribeFleetAdvisorSchemaObjectSummaryCallable(
      const DescribeFleetAdvisorSchemaObjectSummaryRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeFleetAdvisorSchemaObjectSummary, request);
  }

  /**
   * An Async wrapper for DescribeFleetAdvisorSchemaObjectSummary that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeFleetAdvisorSchemaObjectSummaryRequestT = Model::DescribeFleetAdvisorSchemaObjectSummaryRequest>
  void DescribeFleetAdvisorSchemaObjectSummaryAsync(const DescribeFleetAdvisorSchemaObjectSummaryResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                    const DescribeFleetAdvisorSchemaObjectSummaryRequestT& request = {}) const {
   ...
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Returns
   * a list of schemas detected by Fleet Advisor Collectors in your
  ...
  virtual Model::DescribeFleetAdvisorSchemasOutcome DescribeFleetAdvisorSchemas(
      const Model::DescribeFleetAdvisorSchemasRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeFleetAdvisorSchemas that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeFleetAdvisorSchemasRequestT = Model::DescribeFleetAdvisorSchemasRequest>
  Model::DescribeFleetAdvisorSchemasOutcomeCallable DescribeFleetAdvisorSchemasCallable(
      const DescribeFleetAdvisorSchemasRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeFleetAdvisorSchemas, request);
  }

  /**
   * An Async wrapper for DescribeFleetAdvisorSchemas that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFleetAdvisorSchemasRequestT = Model::DescribeFleetAdvisorSchemasRequest>
  void DescribeFleetAdvisorSchemasAsync(const DescribeFleetAdvisorSchemasResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeFleetAdvisorSchemasRequestT& request = {}) const {
   ...
   * <code>dms:ListInstanceProfiles</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for DescribeInstanceProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeInstanceProfilesRequestT = Model::DescribeInstanceProfilesRequest>
  Model::DescribeInstanceProfilesOutcomeCallable DescribeInstanceProfilesCallable(
      const DescribeInstanceProfilesRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeInstanceProfiles, request);
  }

  /**
   * An Async wrapper for DescribeInstanceProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstanceProfilesRequestT = Model::DescribeInstanceProfilesRequest>
  void DescribeInstanceProfilesAsync(const DescribeInstanceProfilesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeInstanceProfilesRequestT& request = {}) const {
   ...
   * applicable.</p> <p> <b>Required permissions:</b>
   * <code>dms:DescribeMetadataModel</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * <p>Returns a paginated list of metadata model assessment requests for a
   * migration project, initiated by <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelAssessment.html">StartMetadataModelAssessment</a>.</p>
   * <p> <b>Required permissions:</b> <code>dms:ListMetadataModelAssessments</code>.
   * For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMetadataModelAssessmentsOutcome DescribeMetadataModelAssessments(
      const Model::DescribeMetadataModelAssessmentsRequest& request) const;

  /**
   * A Callable wrapper for DescribeMetadataModelAssessments that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeMetadataModelAssessmentsRequestT = Model::DescribeMetadataModelAssessmentsRequest>
  Model::DescribeMetadataModelAssessmentsOutcomeCallable DescribeMetadataModelAssessmentsCallable(
      const DescribeMetadataModelAssessmentsRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeMetadataModelAssessments, request);
  }

  /**
   * An Async wrapper for DescribeMetadataModelAssessments that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeMetadataModelAssessmentsRequestT = Model::DescribeMetadataModelAssessmentsRequest>
  void DescribeMetadataModelAssessmentsAsync(const DescribeMetadataModelAssessmentsRequestT& request,
                                             const DescribeMetadataModelAssessmentsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * database hierarchy.</p> <p> <b>Required permissions:</b>
   * <code>dms:DescribeMetadataModelChildren</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * <p>Returns a paginated list of metadata model conversion requests for a
   * migration project, initiated by <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelConversion.html">StartMetadataModelConversion</a>.</p>
   * <p>To cancel a queued or in-progress request, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_CancelMetadataModelConversion.html">CancelMetadataModelConversion</a>.</p>
   * <p> <b>Required permissions:</b> <code>dms:ListMetadataModelConversions</code>.
   * For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMetadataModelConversionsOutcome DescribeMetadataModelConversions(
      const Model::DescribeMetadataModelConversionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeMetadataModelConversions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeMetadataModelConversionsRequestT = Model::DescribeMetadataModelConversionsRequest>
  Model::DescribeMetadataModelConversionsOutcomeCallable DescribeMetadataModelConversionsCallable(
      const DescribeMetadataModelConversionsRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeMetadataModelConversions, request);
  }

  /**
   * An Async wrapper for DescribeMetadataModelConversions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeMetadataModelConversionsRequestT = Model::DescribeMetadataModelConversionsRequest>
  void DescribeMetadataModelConversionsAsync(const DescribeMetadataModelConversionsRequestT& request,
   ...
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelCreation.html">StartMetadataModelCreation</a>.</p>
   * <p>To cancel a queued or in-progress request, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_CancelMetadataModelCreation.html">CancelMetadataModelCreation</a>.</p>
   * <p> <b>Required permissions:</b>
   * <code>dms:DescribeMetadataModelCreations</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * project, initiated by <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelExportAsScript.html">StartMetadataModelExportAsScript</a>.</p>
   * <p> <b>Required permissions:</b> <code>dms:ListMetadataModelExports</code>. For
   * more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMetadataModelExportsAsScriptOutcome DescribeMetadataModelExportsAsScript(
      const Model::DescribeMetadataModelExportsAsScriptRequest& request) const;

  /**
   * A Callable wrapper for DescribeMetadataModelExportsAsScript that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeMetadataModelExportsAsScriptRequestT = Model::DescribeMetadataModelExportsAsScriptRequest>
  Model::DescribeMetadataModelExportsAsScriptOutcomeCallable DescribeMetadataModelExportsAsScriptCallable(
      const DescribeMetadataModelExportsAsScriptRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeMetadataModelExportsAsScript, request);
  }

  /**
   * An Async wrapper for DescribeMetadataModelExportsAsScript that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeMetadataModelExportsAsScriptRequestT = Model::DescribeMetadataModelExportsAsScriptRequest>
  void DescribeMetadataModelExportsAsScriptAsync(const DescribeMetadataModelExportsAsScriptRequestT& request,
                                                 const DescribeMetadataModelExportsAsScriptResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <p>Returns a paginated list of metadata model export requests for a migration
   * project, initiated by <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelExportToTarget.html">StartMetadataModelExportToTarget</a>.</p>
   * <p> <b>Required permissions:</b> <code>dms:ListMetadataModelExports</code>. For
   * more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMetadataModelExportsToTargetOutcome DescribeMetadataModelExportsToTarget(
      const Model::DescribeMetadataModelExportsToTargetRequest& request) const;

  /**
   * A Callable wrapper for DescribeMetadataModelExportsToTarget that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeMetadataModelExportsToTargetRequestT = Model::DescribeMetadataModelExportsToTargetRequest>
  Model::DescribeMetadataModelExportsToTargetOutcomeCallable DescribeMetadataModelExportsToTargetCallable(
      const DescribeMetadataModelExportsToTargetRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeMetadataModelExportsToTarget, request);
  }

  /**
   * An Async wrapper for DescribeMetadataModelExportsToTarget that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeMetadataModelExportsToTargetRequestT = Model::DescribeMetadataModelExportsToTargetRequest>
  void DescribeMetadataModelExportsToTargetAsync(const DescribeMetadataModelExportsToTargetRequestT& request,
                                                 const DescribeMetadataModelExportsToTargetResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * project, initiated by <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelImport.html">StartMetadataModelImport</a>.</p>
   * <p> <b>Required permissions:</b> <code>dms:DescribeMetadataModelImports</code>.
   * For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMetadataModelImportsOutcome DescribeMetadataModelImports(
      const Model::DescribeMetadataModelImportsRequest& request) const;

  /**
   * A Callable wrapper for DescribeMetadataModelImports that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeMetadataModelImportsRequestT = Model::DescribeMetadataModelImportsRequest>
  Model::DescribeMetadataModelImportsOutcomeCallable DescribeMetadataModelImportsCallable(
      const DescribeMetadataModelImportsRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeMetadataModelImports, request);
  }

  /**
   * An Async wrapper for DescribeMetadataModelImports that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMetadataModelImportsRequestT = Model::DescribeMetadataModelImportsRequest>
  void DescribeMetadataModelImportsAsync(const DescribeMetadataModelImportsRequestT& request,
                                         const DescribeMetadataModelImportsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * current region.</p> <p> <b>Required permissions:</b>
   * <code>dms:ListMigrationProjects</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMigrationProjectsOutcome DescribeMigrationProjects(
      const Model::DescribeMigrationProjectsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeMigrationProjects that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeMigrationProjectsRequestT = Model::DescribeMigrationProjectsRequest>
  Model::DescribeMigrationProjectsOutcomeCallable DescribeMigrationProjectsCallable(
      const DescribeMigrationProjectsRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeMigrationProjects, request);
  }

  /**
   * An Async wrapper for DescribeMigrationProjects that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMigrationProjectsRequestT = Model::DescribeMigrationProjectsRequest>
  void DescribeMigrationProjectsAsync(const DescribeMigrationProjectsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeMigrationProjectsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeOrderableReplicationInstancesOutcome DescribeOrderableReplicationInstances(
      const Model::DescribeOrderableReplicationInstancesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeOrderableReplicationInstances that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeOrderableReplicationInstancesRequestT = Model::DescribeOrderableReplicationInstancesRequest>
  Model::DescribeOrderableReplicationInstancesOutcomeCallable DescribeOrderableReplicationInstancesCallable(
      const DescribeOrderableReplicationInstancesRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeOrderableReplicationInstances, request);
  }

  /**
   * An Async wrapper for DescribeOrderableReplicationInstances that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeOrderableReplicationInstancesRequestT = Model::DescribeOrderableReplicationInstancesRequest>
  void DescribeOrderableReplicationInstancesAsync(const DescribeOrderableReplicationInstancesResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const DescribeOrderableReplicationInstancesRequestT& request = {}) const {
   ...
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Returns
   * a paginated list of limitations for recommendations of target Amazon Web
   * Services engines.</p><p><h3>See Also:</h3>   <a
  ...
  virtual Model::DescribeRecommendationLimitationsOutcome DescribeRecommendationLimitations(
      const Model::DescribeRecommendationLimitationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeRecommendationLimitations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeRecommendationLimitationsRequestT = Model::DescribeRecommendationLimitationsRequest>
  Model::DescribeRecommendationLimitationsOutcomeCallable DescribeRecommendationLimitationsCallable(
      const DescribeRecommendationLimitationsRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeRecommendationLimitations, request);
  }

  /**
   * An Async wrapper for DescribeRecommendationLimitations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeRecommendationLimitationsRequestT = Model::DescribeRecommendationLimitationsRequest>
  void DescribeRecommendationLimitationsAsync(const DescribeRecommendationLimitationsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeRecommendationLimitationsRequestT& request = {}) const {
   ...
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Returns
   * a paginated list of target engine recommendations for your source
  ...
  /**
   * A Callable wrapper for DescribeRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRecommendationsRequestT = Model::DescribeRecommendationsRequest>
  void DescribeRecommendationsAsync(const DescribeRecommendationsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DescribeRecommendationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRefreshSchemasStatusOutcome DescribeRefreshSchemasStatus(
      const Model::DescribeRefreshSchemasStatusRequest& request) const;

  /**
   * A Callable wrapper for DescribeRefreshSchemasStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRefreshSchemasStatusRequestT = Model::DescribeRefreshSchemasStatusRequest>
  Model::DescribeRefreshSchemasStatusOutcomeCallable DescribeRefreshSchemasStatusCallable(
      const DescribeRefreshSchemasStatusRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeRefreshSchemasStatus, request);
  }

  /**
   * An Async wrapper for DescribeRefreshSchemasStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRefreshSchemasStatusRequestT = Model::DescribeRefreshSchemasStatusRequest>
  void DescribeRefreshSchemasStatusAsync(const DescribeRefreshSchemasStatusRequestT& request,
                                         const DescribeRefreshSchemasStatusResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReplicationConfigsOutcome DescribeReplicationConfigs(
      const Model::DescribeReplicationConfigsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReplicationConfigs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeReplicationConfigsRequestT = Model::DescribeReplicationConfigsRequest>
  Model::DescribeReplicationConfigsOutcomeCallable DescribeReplicationConfigsCallable(
      const DescribeReplicationConfigsRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeReplicationConfigs, request);
  }

  /**
   * An Async wrapper for DescribeReplicationConfigs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReplicationConfigsRequestT = Model::DescribeReplicationConfigsRequest>
  void DescribeReplicationConfigsAsync(const DescribeReplicationConfigsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeReplicationConfigsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReplicationInstanceTaskLogsOutcome DescribeReplicationInstanceTaskLogs(
      const Model::DescribeReplicationInstanceTaskLogsRequest& request) const;

  /**
   * A Callable wrapper for DescribeReplicationInstanceTaskLogs that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeReplicationInstanceTaskLogsRequestT = Model::DescribeReplicationInstanceTaskLogsRequest>
  Model::DescribeReplicationInstanceTaskLogsOutcomeCallable DescribeReplicationInstanceTaskLogsCallable(
      const DescribeReplicationInstanceTaskLogsRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeReplicationInstanceTaskLogs, request);
  }

  /**
   * An Async wrapper for DescribeReplicationInstanceTaskLogs that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeReplicationInstanceTaskLogsRequestT = Model::DescribeReplicationInstanceTaskLogsRequest>
  void DescribeReplicationInstanceTaskLogsAsync(const DescribeReplicationInstanceTaskLogsRequestT& request,
                                                const DescribeReplicationInstanceTaskLogsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReplicationInstancesOutcome DescribeReplicationInstances(
      const Model::DescribeReplicationInstancesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReplicationInstances that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeReplicationInstancesRequestT = Model::DescribeReplicationInstancesRequest>
  Model::DescribeReplicationInstancesOutcomeCallable DescribeReplicationInstancesCallable(
      const DescribeReplicationInstancesRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeReplicationInstances, request);
  }

  /**
   * An Async wrapper for DescribeReplicationInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReplicationInstancesRequestT = Model::DescribeReplicationInstancesRequest>
  void DescribeReplicationInstancesAsync(const DescribeReplicationInstancesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeReplicationInstancesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReplicationSubnetGroupsOutcome DescribeReplicationSubnetGroups(
      const Model::DescribeReplicationSubnetGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReplicationSubnetGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeReplicationSubnetGroupsRequestT = Model::DescribeReplicationSubnetGroupsRequest>
  Model::DescribeReplicationSubnetGroupsOutcomeCallable DescribeReplicationSubnetGroupsCallable(
      const DescribeReplicationSubnetGroupsRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeReplicationSubnetGroups, request);
  }

  /**
   * An Async wrapper for DescribeReplicationSubnetGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeReplicationSubnetGroupsRequestT = Model::DescribeReplicationSubnetGroupsRequest>
  void DescribeReplicationSubnetGroupsAsync(const DescribeReplicationSubnetGroupsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DescribeReplicationSubnetGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReplicationTableStatisticsOutcome DescribeReplicationTableStatistics(
      const Model::DescribeReplicationTableStatisticsRequest& request) const;

  /**
   * A Callable wrapper for DescribeReplicationTableStatistics that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeReplicationTableStatisticsRequestT = Model::DescribeReplicationTableStatisticsRequest>
  Model::DescribeReplicationTableStatisticsOutcomeCallable DescribeReplicationTableStatisticsCallable(
      const DescribeReplicationTableStatisticsRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeReplicationTableStatistics, request);
  }

  /**
   * An Async wrapper for DescribeReplicationTableStatistics that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeReplicationTableStatisticsRequestT = Model::DescribeReplicationTableStatisticsRequest>
  void DescribeReplicationTableStatisticsAsync(const DescribeReplicationTableStatisticsRequestT& request,
                                               const DescribeReplicationTableStatisticsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeReplicationTaskAssessmentResultsOutcome DescribeReplicationTaskAssessmentResults(
      const Model::DescribeReplicationTaskAssessmentResultsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReplicationTaskAssessmentResults that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeReplicationTaskAssessmentResultsRequestT = Model::DescribeReplicationTaskAssessmentResultsRequest>
  Model::DescribeReplicationTaskAssessmentResultsOutcomeCallable DescribeReplicationTaskAssessmentResultsCallable(
      const DescribeReplicationTaskAssessmentResultsRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeReplicationTaskAssessmentResults, request);
  }

  /**
   * An Async wrapper for DescribeReplicationTaskAssessmentResults that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeReplicationTaskAssessmentResultsRequestT = Model::DescribeReplicationTaskAssessmentResultsRequest>
  void DescribeReplicationTaskAssessmentResultsAsync(const DescribeReplicationTaskAssessmentResultsResponseReceivedHandler& handler,
                                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                     const DescribeReplicationTaskAssessmentResultsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReplicationTaskAssessmentRunsOutcome DescribeReplicationTaskAssessmentRuns(
      const Model::DescribeReplicationTaskAssessmentRunsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReplicationTaskAssessmentRuns that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeReplicationTaskAssessmentRunsRequestT = Model::DescribeReplicationTaskAssessmentRunsRequest>
  Model::DescribeReplicationTaskAssessmentRunsOutcomeCallable DescribeReplicationTaskAssessmentRunsCallable(
      const DescribeReplicationTaskAssessmentRunsRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeReplicationTaskAssessmentRuns, request);
  }

  /**
   * An Async wrapper for DescribeReplicationTaskAssessmentRuns that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeReplicationTaskAssessmentRunsRequestT = Model::DescribeReplicationTaskAssessmentRunsRequest>
  void DescribeReplicationTaskAssessmentRunsAsync(const DescribeReplicationTaskAssessmentRunsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const DescribeReplicationTaskAssessmentRunsRequestT& request = {}) const {
  ...
  virtual Model::DescribeReplicationTaskIndividualAssessmentsOutcome DescribeReplicationTaskIndividualAssessments(
      const Model::DescribeReplicationTaskIndividualAssessmentsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReplicationTaskIndividualAssessments that returns a future to the operation so that it can be executed
  ...
  Model::DescribeReplicationTaskIndividualAssessmentsOutcomeCallable DescribeReplicationTaskIndividualAssessmentsCallable(
      const DescribeReplicationTaskIndividualAssessmentsRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeReplicationTaskIndividualAssessments, request);
  }

  /**
   * An Async wrapper for DescribeReplicationTaskIndividualAssessments that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DescribeReplicationTaskIndividualAssessmentsRequestT = Model::DescribeReplicationTaskIndividualAssessmentsRequest>
  void DescribeReplicationTaskIndividualAssessmentsAsync(const DescribeReplicationTaskIndividualAssessmentsResponseReceivedHandler& handler,
                                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                         const DescribeReplicationTaskIndividualAssessmentsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeReplicationTasks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeReplicationTasksRequestT = Model::DescribeReplicationTasksRequest>
  Model::DescribeReplicationTasksOutcomeCallable DescribeReplicationTasksCallable(
      const DescribeReplicationTasksRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::DescribeReplicationTasks, request);
  }

  /**
   * An Async wrapper for DescribeReplicationTasks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReplicationTasksRequestT = Model::DescribeReplicationTasksRequest>
  void DescribeReplicationTasksAsync(const DescribeReplicationTasksResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeReplicationTasksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeReplications that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeReplications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReplicationsRequestT = Model::DescribeReplicationsRequest>
  void DescribeReplicationsAsync(const DescribeReplicationsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeReplicationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeSchemas that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeSchemasRequestT = Model::DescribeSchemasRequest>
  void DescribeSchemasAsync(const DescribeSchemasRequestT& request, const DescribeSchemasResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeTableStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTableStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTableStatisticsRequestT = Model::DescribeTableStatisticsRequest>
  void DescribeTableStatisticsAsync(const DescribeTableStatisticsRequestT& request,
                                    const DescribeTableStatisticsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * a PDF file. </p> <p> <b>Required permissions:</b>
   * <code>dms:ExportMetadataModelAssessment</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::ExportMetadataModelAssessmentOutcome ExportMetadataModelAssessment(
      const Model::ExportMetadataModelAssessmentRequest& request) const;

  /**
   * A Callable wrapper for ExportMetadataModelAssessment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ExportMetadataModelAssessmentRequestT = Model::ExportMetadataModelAssessmentRequest>
  Model::ExportMetadataModelAssessmentOutcomeCallable ExportMetadataModelAssessmentCallable(
      const ExportMetadataModelAssessmentRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::ExportMetadataModelAssessment, request);
  }

  /**
   * An Async wrapper for ExportMetadataModelAssessment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExportMetadataModelAssessmentRequestT = Model::ExportMetadataModelAssessmentRequest>
  void ExportMetadataModelAssessmentAsync(const ExportMetadataModelAssessmentRequestT& request,
   ...
   * conversion operations.</p> <p> <b>Required permissions:</b>
   * <code>dms:GetTargetSelectionRules</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   */
  template <typename ListTagsForResourceRequestT = Model::ListTagsForResourceRequest>
  void ListTagsForResourceAsync(const ListTagsForResourceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListTagsForResourceRequestT& request = {}) const {
   ...
   * parameters. </p> <p> <b>Required permissions:</b>
   * <code>dms:UpdateConversionConfiguration</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyConversionConfigurationOutcome ModifyConversionConfiguration(
      const Model::ModifyConversionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for ModifyConversionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyConversionConfigurationRequestT = Model::ModifyConversionConfigurationRequest>
  Model::ModifyConversionConfigurationOutcomeCallable ModifyConversionConfigurationCallable(
      const ModifyConversionConfigurationRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::ModifyConversionConfiguration, request);
  }

  /**
   * An Async wrapper for ModifyConversionConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyConversionConfigurationRequestT = Model::ModifyConversionConfigurationRequest>
  void ModifyConversionConfigurationAsync(const ModifyConversionConfigurationRequestT& request,
                                          const ModifyConversionConfigurationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyDataMigration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyDataMigration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyDataMigrationRequestT = Model::ModifyDataMigrationRequest>
  void ModifyDataMigrationAsync(const ModifyDataMigrationRequestT& request, const ModifyDataMigrationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&DatabaseMigrationServiceClient::ModifyDataMigration, request, handler, context);
  }

  /**
   * <p>Modifies the specified data provider using the provided settings.</p> <p>
   * <b>Required permissions:</b> <code>dms:UpdateDataProvider</code>. For more
   * information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p>
  ...
  /**
   * A Callable wrapper for ModifyDataProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyDataProvider that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyDataProviderRequestT = Model::ModifyDataProviderRequest>
  void ModifyDataProviderAsync(const ModifyDataProviderRequestT& request, const ModifyDataProviderResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ModifyEndpoint that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ModifyEndpointRequestT = Model::ModifyEndpointRequest>
  void ModifyEndpointAsync(const ModifyEndpointRequestT& request, const ModifyEndpointResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <p> <b>Required permissions:</b> <code>dms:UpdateInstanceProfile</code>. For
   * more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p>
   * <p>All migration projects associated with the instance profile must be deleted
   * or modified before you can modify the instance profile.</p> <p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for ModifyInstanceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyInstanceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyInstanceProfileRequestT = Model::ModifyInstanceProfileRequest>
  void ModifyInstanceProfileAsync(const ModifyInstanceProfileRequestT& request, const ModifyInstanceProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <p> <b>Required permissions:</b> <code>dms:UpdateMigrationProject</code>. For
   * more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p>
  ...
  /**
   * A Callable wrapper for ModifyMigrationProject that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyMigrationProject that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyMigrationProjectRequestT = Model::ModifyMigrationProjectRequest>
  void ModifyMigrationProjectAsync(const ModifyMigrationProjectRequestT& request,
                                   const ModifyMigrationProjectResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyReplicationConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyReplicationConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyReplicationConfigRequestT = Model::ModifyReplicationConfigRequest>
  void ModifyReplicationConfigAsync(const ModifyReplicationConfigRequestT& request,
                                    const ModifyReplicationConfigResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyReplicationInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ModifyReplicationInstanceRequestT = Model::ModifyReplicationInstanceRequest>
  Model::ModifyReplicationInstanceOutcomeCallable ModifyReplicationInstanceCallable(
      const ModifyReplicationInstanceRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::ModifyReplicationInstance, request);
  }

  /**
   * An Async wrapper for ModifyReplicationInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyReplicationInstanceRequestT = Model::ModifyReplicationInstanceRequest>
  void ModifyReplicationInstanceAsync(const ModifyReplicationInstanceRequestT& request,
                                      const ModifyReplicationInstanceResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyReplicationSubnetGroupOutcome ModifyReplicationSubnetGroup(
      const Model::ModifyReplicationSubnetGroupRequest& request) const;

  /**
   * A Callable wrapper for ModifyReplicationSubnetGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyReplicationSubnetGroupRequestT = Model::ModifyReplicationSubnetGroupRequest>
  Model::ModifyReplicationSubnetGroupOutcomeCallable ModifyReplicationSubnetGroupCallable(
      const ModifyReplicationSubnetGroupRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::ModifyReplicationSubnetGroup, request);
  }

  /**
   * An Async wrapper for ModifyReplicationSubnetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyReplicationSubnetGroupRequestT = Model::ModifyReplicationSubnetGroupRequest>
  void ModifyReplicationSubnetGroupAsync(const ModifyReplicationSubnetGroupRequestT& request,
                                         const ModifyReplicationSubnetGroupResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyReplicationTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyReplicationTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyReplicationTaskRequestT = Model::ModifyReplicationTaskRequest>
  void ModifyReplicationTaskAsync(const ModifyReplicationTaskRequestT& request, const ModifyReplicationTaskResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for MoveReplicationTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for MoveReplicationTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename MoveReplicationTaskRequestT = Model::MoveReplicationTaskRequest>
  void MoveReplicationTaskAsync(const MoveReplicationTaskRequestT& request, const MoveReplicationTaskResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RebootReplicationInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RebootReplicationInstanceRequestT = Model::RebootReplicationInstanceRequest>
  Model::RebootReplicationInstanceOutcomeCallable RebootReplicationInstanceCallable(
      const RebootReplicationInstanceRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::RebootReplicationInstance, request);
  }

  /**
   * An Async wrapper for RebootReplicationInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RebootReplicationInstanceRequestT = Model::RebootReplicationInstanceRequest>
  void RebootReplicationInstanceAsync(const RebootReplicationInstanceRequestT& request,
                                      const RebootReplicationInstanceResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RefreshSchemas that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RefreshSchemasRequestT = Model::RefreshSchemasRequest>
  void RefreshSchemasAsync(const RefreshSchemasRequestT& request, const RefreshSchemasResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ReloadReplicationTables that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ReloadReplicationTables that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ReloadReplicationTablesRequestT = Model::ReloadReplicationTablesRequest>
  void ReloadReplicationTablesAsync(const ReloadReplicationTablesRequestT& request,
                                    const ReloadReplicationTablesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ReloadTables that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ReloadTablesRequestT = Model::ReloadTablesRequest>
  void ReloadTablesAsync(const ReloadTablesRequestT& request, const ReloadTablesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * information, see <a
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Runs
   * large-scale assessment (LSA) analysis on every Fleet Advisor collector in your
   * account.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/RunFleetAdvisorLsaAnalysis">AWS
   * API Reference</a></p>
   */
  virtual Model::RunFleetAdvisorLsaAnalysisOutcome RunFleetAdvisorLsaAnalysis(
      const Model::RunFleetAdvisorLsaAnalysisRequest& request = {}) const;

  /**
   * A Callable wrapper for RunFleetAdvisorLsaAnalysis that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RunFleetAdvisorLsaAnalysisRequestT = Model::RunFleetAdvisorLsaAnalysisRequest>
  Model::RunFleetAdvisorLsaAnalysisOutcomeCallable RunFleetAdvisorLsaAnalysisCallable(
      const RunFleetAdvisorLsaAnalysisRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::RunFleetAdvisorLsaAnalysis, request);
  }

  /**
   * An Async wrapper for RunFleetAdvisorLsaAnalysis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RunFleetAdvisorLsaAnalysisRequestT = Model::RunFleetAdvisorLsaAnalysisRequest>
  void RunFleetAdvisorLsaAnalysisAsync(const RunFleetAdvisorLsaAnalysisResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const RunFleetAdvisorLsaAnalysisRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for StartDataMigration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartDataMigration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartDataMigrationRequestT = Model::StartDataMigrationRequest>
  void StartDataMigrationAsync(const StartDataMigrationRequestT& request, const StartDataMigrationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&DatabaseMigrationServiceClient::StartDataMigration, request, handler, context);
  }

  /**
   * <p>Queues the installation of the extension pack on your target database. If
   * other requests created by <code>Start*</code> operations are already in the
   * migration project's queue, the installation begins after they complete.</p>
   * <p>This operation requires a non-virtual target data provider.</p> <p>If the
   * extension pack already exists, the operation reinstalls it. To ensure
   * compatibility, reconvert your database objects if the version has changed since
   * your last conversion. For more information, see <a
   * href="https://docs.aws.amazon.com/dms/latest/userguide/extension-pack.html">Using
   * extension packs in DMS Schema Conversion</a>.</p> <p>To check the status of the
   * request, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_DescribeExtensionPackAssociations.html">DescribeExtensionPackAssociations</a>
   * using the returned <code>RequestIdentifier</code> as a filter.</p> <p>
   * <b>Required permissions:</b> <code>dms:AssociateExtensionPack</code>. For more
   * information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::StartExtensionPackAssociationOutcome StartExtensionPackAssociation(
      const Model::StartExtensionPackAssociationRequest& request) const;

  /**
   * A Callable wrapper for StartExtensionPackAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartExtensionPackAssociationRequestT = Model::StartExtensionPackAssociationRequest>
  Model::StartExtensionPackAssociationOutcomeCallable StartExtensionPackAssociationCallable(
      const StartExtensionPackAssociationRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::StartExtensionPackAssociation, request);
  }

  /**
   * An Async wrapper for StartExtensionPackAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartExtensionPackAssociationRequestT = Model::StartExtensionPackAssociationRequest>
  void StartExtensionPackAssociationAsync(const StartExtensionPackAssociationRequestT& request,
                                          const StartExtensionPackAssociationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&DatabaseMigrationServiceClient::StartExtensionPackAssociation, request, handler, context);
  }

  /**
   * <p>Queues an assessment of the selected source metadata models (database objects
   * such as tables, views, and procedures) to evaluate conversion complexity to the
   * target database format. If other requests created by <code>Start*</code>
   * operations are already in the migration project's queue, the assessment begins
   * after they complete.</p> <p>The assessment request loads metadata models that
   * are not yet in the metadata tree, but does not reload metadata models that are
   * already present. If your source database has changed since the metadata was
   * loaded, refresh the affected metadata models with <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelImport.html">StartMetadataModelImport</a>
   * before calling this operation.</p> <p>To check the status of the assessment
   * request, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_DescribeMetadataModelAssessments.html">DescribeMetadataModelAssessments</a>
   * using the returned <code>RequestIdentifier</code> as a filter.</p> <p>To export
   * the conversion assessment report after the request completes successfully, call
   * <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_ExportMetadataModelAssessment.html">ExportMetadataModelAssessment</a>.</p>
   * <p> <b>Required permissions:</b> <code>dms:StartMetadataModelAssessment</code>.
   * For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::StartMetadataModelAssessmentOutcome StartMetadataModelAssessment(
      const Model::StartMetadataModelAssessmentRequest& request) const;

  /**
   * A Callable wrapper for StartMetadataModelAssessment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartMetadataModelAssessmentRequestT = Model::StartMetadataModelAssessmentRequest>
  Model::StartMetadataModelAssessmentOutcomeCallable StartMetadataModelAssessmentCallable(
      const StartMetadataModelAssessmentRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::StartMetadataModelAssessment, request);
  }

  /**
   * An Async wrapper for StartMetadataModelAssessment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMetadataModelAssessmentRequestT = Model::StartMetadataModelAssessmentRequest>
  void StartMetadataModelAssessmentAsync(const StartMetadataModelAssessmentRequestT& request,
                                         const StartMetadataModelAssessmentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&DatabaseMigrationServiceClient::StartMetadataModelAssessment, request, handler, context);
  }

  /**
   * <p>Queues a conversion of the selected source metadata models (database objects
   * such as tables, views, and procedures) to the target database format. If other
   * requests created by <code>Start*</code> operations are already in the migration
   * project's queue, the conversion begins after they complete.</p> <p>The
   * conversion request loads metadata models that are not yet in the metadata tree,
   * but does not reload metadata models that are already present. If your source
   * database has changed since the metadata was loaded, refresh the affected
   * metadata models with <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelImport.html">StartMetadataModelImport</a>
   * before calling this operation.</p>  <p>If converted objects already exist
   * in the target metadata tree, the conversion overwrites them, including any
   * manual edits.</p>  <p>To check the status of the conversion request, call
   * <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_DescribeMetadataModelConversions.html">DescribeMetadataModelConversions</a>
   * using the returned <code>RequestIdentifier</code> as a filter.</p> <p>To cancel
   * a queued or in-progress request, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_CancelMetadataModelConversion.html">CancelMetadataModelConversion</a>
   * with the returned <code>RequestIdentifier</code>.</p> <p>After the conversion
   * completes successfully:</p> <ul> <li> <p>To export a post-conversion assessment
   * report, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_ExportMetadataModelAssessment.html">ExportMetadataModelAssessment</a>.</p>
   * </li> <li> <p>To retrieve converted code, use any of the following options:</p>
   * <ul> <li> <p> <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_DescribeMetadataModel.html">DescribeMetadataModel</a>
   * and <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_DescribeMetadataModelChildren.html">DescribeMetadataModelChildren</a>
   * – navigate the target metadata tree and retrieve converted definitions.</p>
   * </li> <li> <p> <a
   ...
   * – export as data definition language (DDL) scripts to your Amazon S3 bucket.</p>
   * </li> <li> <p> <a
   ...
   * – apply directly to your target database.</p> </li> </ul> </li> </ul> <p>
   * <b>Required permissions:</b> <code>dms:StartMetadataModelConversion</code>. For
   * more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::StartMetadataModelConversionOutcome StartMetadataModelConversion(
      const Model::StartMetadataModelConversionRequest& request) const;

  /**
   * A Callable wrapper for StartMetadataModelConversion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartMetadataModelConversionRequestT = Model::StartMetadataModelConversionRequest>
  Model::StartMetadataModelConversionOutcomeCallable StartMetadataModelConversionCallable(
      const StartMetadataModelConversionRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::StartMetadataModelConversion, request);
  }

  /**
   * An Async wrapper for StartMetadataModelConversion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMetadataModelConversionRequestT = Model::StartMetadataModelConversionRequest>
  void StartMetadataModelConversionAsync(const StartMetadataModelConversionRequestT& request,
  ...
  /**
   * <p>Queues the creation of a metadata model in the source metadata tree. If other
   * requests created by <code>Start*</code> operations are already in the migration
   * project's queue, the creation begins after they complete.</p>  <p>This
   * operation supports only Microsoft SQL Server to Aurora PostgreSQL and Microsoft
   * SQL Server to Amazon RDS for PostgreSQL conversion paths.</p>  <p>To
   * check the status of the creation request, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_DescribeMetadataModelCreations.html">DescribeMetadataModelCreations</a>
   * using the returned <code>RequestIdentifier</code> as a filter.</p> <p>To cancel
   * a queued or in-progress request, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_CancelMetadataModelCreation.html">CancelMetadataModelCreation</a>
   * with the returned <code>RequestIdentifier</code>.</p>  <p>Calling <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelImport.html">StartMetadataModelImport</a>
   * with <code>Refresh</code> deletes metadata models created by this operation.</p>
   *  <p>After the creation completes successfully:</p> <ul> <li> <p>To
   * evaluate conversion complexity, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelAssessment.html">StartMetadataModelAssessment</a>.</p>
   * </li> <li> <p>To convert to the target database format, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_StartMetadataModelConversion.html">StartMetadataModelConversion</a>.</p>
   * </li> </ul> <p> <b>Required permissions:</b>
   * <code>dms:StartMetadataModelCreation</code>. For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * <p>Queues an export of metadata models (database objects such as tables, views,
   ...
   * If other requests created by <code>Start*</code> operations are already in the
   * migration project's queue, the export begins after they complete.</p> <p>When
   * exporting from the target metadata tree, the export applies only to metadata
   * models created by conversion. Metadata models imported from the database are
   * skipped.</p> <p>To check the status of the export request, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_DescribeMetadataModelExportsAsScript.html">DescribeMetadataModelExportsAsScript</a>
   * using the returned <code>RequestIdentifier</code> as a filter.</p> <p>
   * <b>Required permissions:</b> <code>dms:StartMetadataModelExportAsScripts</code>.
   * For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::StartMetadataModelExportAsScriptOutcome StartMetadataModelExportAsScript(
      const Model::StartMetadataModelExportAsScriptRequest& request) const;

  /**
   * A Callable wrapper for StartMetadataModelExportAsScript that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartMetadataModelExportAsScriptRequestT = Model::StartMetadataModelExportAsScriptRequest>
  Model::StartMetadataModelExportAsScriptOutcomeCallable StartMetadataModelExportAsScriptCallable(
      const StartMetadataModelExportAsScriptRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::StartMetadataModelExportAsScript, request);
  }

  /**
   * An Async wrapper for StartMetadataModelExportAsScript that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartMetadataModelExportAsScriptRequestT = Model::StartMetadataModelExportAsScriptRequest>
  void StartMetadataModelExportAsScriptAsync(const StartMetadataModelExportAsScriptRequestT& request,
                                             const StartMetadataModelExportAsScriptResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&DatabaseMigrationServiceClient::StartMetadataModelExportAsScript, request, handler, context);
  }

  /**
   * <p>Queues an export of the selected converted metadata models (database objects
   * such as tables, views, and procedures) to your target database. If other
   * requests created by <code>Start*</code> operations are already in the migration
   * project's queue, the export begins after they complete.</p> <p>This operation
   * requires a non-virtual target data provider.</p> <p>The export applies only
   * metadata models created by conversion. Metadata models imported from the
   * database are skipped.</p>  <p>If objects with the same name already exist
   * on the target database, the export overwrites them.</p>  <p>The operation
   * installs the extension pack on the target database. For more information, see <a
   * href="https://docs.aws.amazon.com/dms/latest/userguide/extension-pack.html">Using
   * extension packs in DMS Schema Conversion</a>.</p> <p>To check the status of the
   * export request, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_DescribeMetadataModelExportsToTarget.html">DescribeMetadataModelExportsToTarget</a>
   * using the returned <code>RequestIdentifier</code> as a filter.</p> <p>
   * <b>Required permissions:</b> <code>dms:StartMetadataModelExportToTarget</code>.
   * For more information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
   ...
   * API Reference</a></p>
   */
  virtual Model::StartMetadataModelExportToTargetOutcome StartMetadataModelExportToTarget(
      const Model::StartMetadataModelExportToTargetRequest& request) const;

  /**
   * A Callable wrapper for StartMetadataModelExportToTarget that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartMetadataModelExportToTargetRequestT = Model::StartMetadataModelExportToTargetRequest>
  Model::StartMetadataModelExportToTargetOutcomeCallable StartMetadataModelExportToTargetCallable(
      const StartMetadataModelExportToTargetRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::StartMetadataModelExportToTarget, request);
  }

  /**
   * An Async wrapper for StartMetadataModelExportToTarget that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartMetadataModelExportToTargetRequestT = Model::StartMetadataModelExportToTargetRequest>
  void StartMetadataModelExportToTargetAsync(const StartMetadataModelExportToTargetRequestT& request,
                                             const StartMetadataModelExportToTargetResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&DatabaseMigrationServiceClient::StartMetadataModelExportToTarget, request, handler, context);
  }

  /**
   * <p>Queues an import of metadata models (database objects such as tables, views,
   * and procedures) from your data provider into the metadata tree. If other
   * requests created by <code>Start*</code> operations are already in the migration
   * project's queue, the import begins after they complete.</p> <p>To check the
   * status of the import request, call <a
   * href="https://docs.aws.amazon.com/dms/latest/APIReference/API_DescribeMetadataModelImports.html">DescribeMetadataModelImports</a>
   * using the returned <code>RequestIdentifier</code> as a filter.</p> <p>
   * <b>Required permissions:</b> <code>dms:StartMetadataModelImport</code>. For more
   * information, see <a
   * href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdatabasemigrationservice.html">Actions,
   * resources, and condition keys for Database Migration Service</a>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for StartMetadataModelImport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMetadataModelImport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMetadataModelImportRequestT = Model::StartMetadataModelImportRequest>
  void StartMetadataModelImportAsync(const StartMetadataModelImportRequestT& request,
                                     const StartMetadataModelImportResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * href="https://docs.aws.amazon.com/dms/latest/userguide/dms_fleet.advisor-end-of-support.html">Amazon
   * Web Services DMS Fleet Advisor end of support</a>. </p>  <p>Starts
   * the analysis of your source database to provide recommendations of target
   * engines.</p> <p>You can create recommendations for multiple source databases
   * using <a
  ...
  /**
   * A Callable wrapper for StartRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartRecommendationsRequestT = Model::StartRecommendationsRequest>
  void StartRecommendationsAsync(const StartRecommendationsRequestT& request, const StartRecommendationsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartReplicationTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartReplicationTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartReplicationTaskRequestT = Model::StartReplicationTaskRequest>
  void StartReplicationTaskAsync(const StartReplicationTaskRequestT& request, const StartReplicationTaskResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartReplicationTaskAssessmentOutcome StartReplicationTaskAssessment(
      const Model::StartReplicationTaskAssessmentRequest& request) const;

  /**
   * A Callable wrapper for StartReplicationTaskAssessment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartReplicationTaskAssessmentRequestT = Model::StartReplicationTaskAssessmentRequest>
  Model::StartReplicationTaskAssessmentOutcomeCallable StartReplicationTaskAssessmentCallable(
      const StartReplicationTaskAssessmentRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::StartReplicationTaskAssessment, request);
  }

  /**
   * An Async wrapper for StartReplicationTaskAssessment that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartReplicationTaskAssessmentRequestT = Model::StartReplicationTaskAssessmentRequest>
  void StartReplicationTaskAssessmentAsync(const StartReplicationTaskAssessmentRequestT& request,
                                           const StartReplicationTaskAssessmentResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartReplicationTaskAssessmentRunOutcome StartReplicationTaskAssessmentRun(
      const Model::StartReplicationTaskAssessmentRunRequest& request) const;

  /**
   * A Callable wrapper for StartReplicationTaskAssessmentRun that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartReplicationTaskAssessmentRunRequestT = Model::StartReplicationTaskAssessmentRunRequest>
  Model::StartReplicationTaskAssessmentRunOutcomeCallable StartReplicationTaskAssessmentRunCallable(
      const StartReplicationTaskAssessmentRunRequestT& request) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::StartReplicationTaskAssessmentRun, request);
  }

  /**
   * An Async wrapper for StartReplicationTaskAssessmentRun that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartReplicationTaskAssessmentRunRequestT = Model::StartReplicationTaskAssessmentRunRequest>
  void StartReplicationTaskAssessmentRunAsync(const StartReplicationTaskAssessmentRunRequestT& request,
                                              const StartReplicationTaskAssessmentRunResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopDataMigration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopDataMigration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopDataMigrationRequestT = Model::StopDataMigrationRequest>
  void StopDataMigrationAsync(const StopDataMigrationRequestT& request, const StopDataMigrationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopReplicationTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopReplicationTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopReplicationTaskRequestT = Model::StopReplicationTaskRequest>
  void StopReplicationTaskAsync(const StopReplicationTaskRequestT& request, const StopReplicationTaskResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateSubscriptionsToEventBridgeOutcome UpdateSubscriptionsToEventBridge(
      const Model::UpdateSubscriptionsToEventBridgeRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateSubscriptionsToEventBridge that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateSubscriptionsToEventBridgeRequestT = Model::UpdateSubscriptionsToEventBridgeRequest>
  Model::UpdateSubscriptionsToEventBridgeOutcomeCallable UpdateSubscriptionsToEventBridgeCallable(
      const UpdateSubscriptionsToEventBridgeRequestT& request = {}) const {
    return SubmitCallable(&DatabaseMigrationServiceClient::UpdateSubscriptionsToEventBridge, request);
  }

  /**
   * An Async wrapper for UpdateSubscriptionsToEventBridge that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateSubscriptionsToEventBridgeRequestT = Model::UpdateSubscriptionsToEventBridgeRequest>
  void UpdateSubscriptionsToEventBridgeAsync(const UpdateSubscriptionsToEventBridgeResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const UpdateSubscriptionsToEventBridgeRequestT& request = {}) const {
