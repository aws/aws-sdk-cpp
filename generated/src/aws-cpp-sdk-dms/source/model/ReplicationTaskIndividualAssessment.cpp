...
ReplicationTaskIndividualAssessment::ReplicationTaskIndividualAssessment(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue ReplicationTaskIndividualAssessment::Jsonize() const {
  ...
  if (m_replicationTaskIndividualAssessmentStartDateHasBeenSet) {
    payload.WithDouble("ReplicationTaskIndividualAssessmentStartDate",
                       m_replicationTaskIndividualAssessmentStartDate.SecondsWithMSPrecision());
  }
