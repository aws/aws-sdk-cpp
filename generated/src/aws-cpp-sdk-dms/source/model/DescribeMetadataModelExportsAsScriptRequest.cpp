...
Aws::String DescribeMetadataModelExportsAsScriptRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection DescribeMetadataModelExportsAsScriptRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AmazonDMSv20160101.DescribeMetadataModelExportsAsScript"));
  return headers;
