...
PostgreSqlDataProviderSettings::PostgreSqlDataProviderSettings(JsonView jsonValue) { *this = jsonValue; }

PostgreSqlDataProviderSettings& PostgreSqlDataProviderSettings::operator=(JsonView jsonValue) {
...
JsonValue PostgreSqlDataProviderSettings::Jsonize() const {
  JsonValue payload;
