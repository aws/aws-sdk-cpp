...
S3Settings::S3Settings(JsonView jsonValue) { *this = jsonValue; }
...
S3Settings& S3Settings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DatePartitionSequence")) {
    m_datePartitionSequence =
        DatePartitionSequenceValueMapper::GetDatePartitionSequenceValueForName(jsonValue.GetString("DatePartitionSequence"));
    m_datePartitionSequenceHasBeenSet = true;
  }
  if (jsonValue.ValueExists("DatePartitionDelimiter")) {
    m_datePartitionDelimiter =
        DatePartitionDelimiterValueMapper::GetDatePartitionDelimiterValueForName(jsonValue.GetString("DatePartitionDelimiter"));
...
JsonValue S3Settings::Jsonize() const {
  ...
  if (m_datePartitionSequenceHasBeenSet) {
    payload.WithString("DatePartitionSequence",
                       DatePartitionSequenceValueMapper::GetNameForDatePartitionSequenceValue(m_datePartitionSequence));
  }

  if (m_datePartitionDelimiterHasBeenSet) {
    payload.WithString("DatePartitionDelimiter",
                       DatePartitionDelimiterValueMapper::GetNameForDatePartitionDelimiterValue(m_datePartitionDelimiter));
  }
