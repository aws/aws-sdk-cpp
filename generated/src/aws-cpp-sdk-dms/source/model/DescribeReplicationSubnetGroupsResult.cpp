...
DescribeReplicationSubnetGroupsResult& DescribeReplicationSubnetGroupsResult::operator=(
  ...
  if (jsonValue.ValueExists("ReplicationSubnetGroups")) {
    ...
    for (unsigned replicationSubnetGroupsIndex = 0; replicationSubnetGroupsIndex < replicationSubnetGroupsJsonList.GetLength();
         ++replicationSubnetGroupsIndex) {
