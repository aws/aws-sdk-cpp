...
Replication::Replication(JsonView jsonValue) { *this = jsonValue; }
...
Replication& Replication::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("PremigrationAssessmentStatuses")) {
    ...
    for (unsigned premigrationAssessmentStatusesIndex = 0;
         premigrationAssessmentStatusesIndex < premigrationAssessmentStatusesJsonList.GetLength(); ++premigrationAssessmentStatusesIndex) {
...
JsonValue Replication::Jsonize() const {
  ...
  if (m_premigrationAssessmentStatusesHasBeenSet) {
    ...
    for (unsigned premigrationAssessmentStatusesIndex = 0;
         premigrationAssessmentStatusesIndex < premigrationAssessmentStatusesJsonList.GetLength(); ++premigrationAssessmentStatusesIndex) {
      premigrationAssessmentStatusesJsonList[premigrationAssessmentStatusesIndex].AsObject(
          m_premigrationAssessmentStatuses[premigrationAssessmentStatusesIndex].Jsonize());
    }
