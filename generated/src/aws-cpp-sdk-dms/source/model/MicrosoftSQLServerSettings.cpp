...
MicrosoftSQLServerSettings::MicrosoftSQLServerSettings(JsonView jsonValue) { *this = jsonValue; }
...
MicrosoftSQLServerSettings& MicrosoftSQLServerSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AuthenticationMethod")) {
    m_authenticationMethod =
        SqlServerAuthenticationMethodMapper::GetSqlServerAuthenticationMethodForName(jsonValue.GetString("AuthenticationMethod"));
...
JsonValue MicrosoftSQLServerSettings::Jsonize() const {
  ...
  if (m_authenticationMethodHasBeenSet) {
    payload.WithString("AuthenticationMethod",
                       SqlServerAuthenticationMethodMapper::GetNameForSqlServerAuthenticationMethod(m_authenticationMethod));
  }
