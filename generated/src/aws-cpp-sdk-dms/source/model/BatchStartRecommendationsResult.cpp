...
BatchStartRecommendationsResult::BatchStartRecommendationsResult()
{
}

BatchStartRecommendationsResult::BatchStartRecommendationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
