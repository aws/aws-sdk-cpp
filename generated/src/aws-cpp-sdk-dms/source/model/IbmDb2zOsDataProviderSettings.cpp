...
IbmDb2zOsDataProviderSettings::IbmDb2zOsDataProviderSettings(JsonView jsonValue) { *this = jsonValue; }

IbmDb2zOsDataProviderSettings& IbmDb2zOsDataProviderSettings::operator=(JsonView jsonValue) {
...
JsonValue IbmDb2zOsDataProviderSettings::Jsonize() const {
  JsonValue payload;
