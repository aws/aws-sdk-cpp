...
GcpMySQLSettings::GcpMySQLSettings(JsonView jsonValue) { *this = jsonValue; }

GcpMySQLSettings& GcpMySQLSettings::operator=(JsonView jsonValue) {
...
JsonValue GcpMySQLSettings::Jsonize() const {
  JsonValue payload;
