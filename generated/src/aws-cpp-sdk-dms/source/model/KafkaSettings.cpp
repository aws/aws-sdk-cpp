...
KafkaSettings::KafkaSettings(JsonView jsonValue) { *this = jsonValue; }
...
KafkaSettings& KafkaSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SslEndpointIdentificationAlgorithm")) {
    m_sslEndpointIdentificationAlgorithm = KafkaSslEndpointIdentificationAlgorithmMapper::GetKafkaSslEndpointIdentificationAlgorithmForName(
        jsonValue.GetString("SslEndpointIdentificationAlgorithm"));
...
JsonValue KafkaSettings::Jsonize() const {
  ...
  if (m_sslEndpointIdentificationAlgorithmHasBeenSet) {
    payload.WithString("SslEndpointIdentificationAlgorithm",
                       KafkaSslEndpointIdentificationAlgorithmMapper::GetNameForKafkaSslEndpointIdentificationAlgorithm(
                           m_sslEndpointIdentificationAlgorithm));
  }
