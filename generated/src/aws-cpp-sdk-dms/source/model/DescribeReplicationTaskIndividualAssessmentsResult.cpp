...
DescribeReplicationTaskIndividualAssessmentsResult& DescribeReplicationTaskIndividualAssessmentsResult::operator=(
  ...
  if (jsonValue.ValueExists("ReplicationTaskIndividualAssessments")) {
    ...
    for (unsigned replicationTaskIndividualAssessmentsIndex = 0;
         replicationTaskIndividualAssessmentsIndex < replicationTaskIndividualAssessmentsJsonList.GetLength();
         ++replicationTaskIndividualAssessmentsIndex) {
      m_replicationTaskIndividualAssessments.push_back(
          replicationTaskIndividualAssessmentsJsonList[replicationTaskIndividualAssessmentsIndex].AsObject());
    }
