...
OracleSettings::OracleSettings(JsonView jsonValue) { *this = jsonValue; }
...
OracleSettings& OracleSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ExtraArchivedLogDestIds")) {
    ...
    for (unsigned extraArchivedLogDestIdsIndex = 0; extraArchivedLogDestIdsIndex < extraArchivedLogDestIdsJsonList.GetLength();
         ++extraArchivedLogDestIdsIndex) {
  ...
  if (jsonValue.ValueExists("AuthenticationMethod")) {
    m_authenticationMethod =
        OracleAuthenticationMethodMapper::GetOracleAuthenticationMethodForName(jsonValue.GetString("AuthenticationMethod"));
...
JsonValue OracleSettings::Jsonize() const {
  ...
  if (m_authenticationMethodHasBeenSet) {
    payload.WithString("AuthenticationMethod",
                       OracleAuthenticationMethodMapper::GetNameForOracleAuthenticationMethod(m_authenticationMethod));
  }
