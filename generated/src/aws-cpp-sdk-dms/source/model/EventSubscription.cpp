...
EventSubscription::EventSubscription(JsonView jsonValue) { *this = jsonValue; }
...
EventSubscription& EventSubscription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("EventCategoriesList")) {
    ...
    for (unsigned eventCategoriesListIndex = 0; eventCategoriesListIndex < eventCategoriesListJsonList.GetLength();
