...
DescribeEventSubscriptionsResult::DescribeEventSubscriptionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeEventSubscriptionsResult& DescribeEventSubscriptionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("EventSubscriptionsList")) {
    ...
    for (unsigned eventSubscriptionsListIndex = 0; eventSubscriptionsListIndex < eventSubscriptionsListJsonList.GetLength();
         ++eventSubscriptionsListIndex) {
