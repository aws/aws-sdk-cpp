...
ModifyReplicationConfigResult::ModifyReplicationConfigResult()
{
}

ModifyReplicationConfigResult::ModifyReplicationConfigResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
