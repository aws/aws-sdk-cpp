...
ReplicationInstance::ReplicationInstance(JsonView jsonValue) { *this = jsonValue; }
...
ReplicationInstance& ReplicationInstance::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ReplicationInstancePublicIpAddresses")) {
    ...
    for (unsigned replicationInstancePublicIpAddressesIndex = 0;
         replicationInstancePublicIpAddressesIndex < replicationInstancePublicIpAddressesJsonList.GetLength();
         ++replicationInstancePublicIpAddressesIndex) {
      m_replicationInstancePublicIpAddresses.push_back(
          replicationInstancePublicIpAddressesJsonList[replicationInstancePublicIpAddressesIndex].AsString());
    }
  ...
  if (jsonValue.ValueExists("ReplicationInstancePrivateIpAddresses")) {
    ...
    for (unsigned replicationInstancePrivateIpAddressesIndex = 0;
         replicationInstancePrivateIpAddressesIndex < replicationInstancePrivateIpAddressesJsonList.GetLength();
         ++replicationInstancePrivateIpAddressesIndex) {
      m_replicationInstancePrivateIpAddresses.push_back(
          replicationInstancePrivateIpAddressesJsonList[replicationInstancePrivateIpAddressesIndex].AsString());
    }
  ...
  if (jsonValue.ValueExists("ReplicationInstanceIpv6Addresses")) {
    ...
    for (unsigned replicationInstanceIpv6AddressesIndex = 0;
         replicationInstanceIpv6AddressesIndex < replicationInstanceIpv6AddressesJsonList.GetLength();
         ++replicationInstanceIpv6AddressesIndex) {
      m_replicationInstanceIpv6Addresses.push_back(
          replicationInstanceIpv6AddressesJsonList[replicationInstanceIpv6AddressesIndex].AsString());
    }
...
JsonValue ReplicationInstance::Jsonize() const {
  ...
  if (m_replicationInstancePublicIpAddressesHasBeenSet) {
    ...
    for (unsigned replicationInstancePublicIpAddressesIndex = 0;
         ...
         ++replicationInstancePublicIpAddressesIndex) {
      replicationInstancePublicIpAddressesJsonList[replicationInstancePublicIpAddressesIndex].AsString(
          m_replicationInstancePublicIpAddresses[replicationInstancePublicIpAddressesIndex]);
    }
  ...
  if (m_replicationInstancePrivateIpAddressesHasBeenSet) {
    ...
    for (unsigned replicationInstancePrivateIpAddressesIndex = 0;
         ...
         ++replicationInstancePrivateIpAddressesIndex) {
      replicationInstancePrivateIpAddressesJsonList[replicationInstancePrivateIpAddressesIndex].AsString(
          m_replicationInstancePrivateIpAddresses[replicationInstancePrivateIpAddressesIndex]);
    }
  ...
  if (m_replicationInstanceIpv6AddressesHasBeenSet) {
    ...
    for (unsigned replicationInstanceIpv6AddressesIndex = 0;
         ...
         ++replicationInstanceIpv6AddressesIndex) {
      replicationInstanceIpv6AddressesJsonList[replicationInstanceIpv6AddressesIndex].AsString(
          m_replicationInstanceIpv6Addresses[replicationInstanceIpv6AddressesIndex]);
    }
