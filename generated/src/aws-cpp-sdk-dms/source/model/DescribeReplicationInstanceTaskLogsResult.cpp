...
DescribeReplicationInstanceTaskLogsResult& DescribeReplicationInstanceTaskLogsResult::operator=(
  ...
  if (jsonValue.ValueExists("ReplicationInstanceTaskLogs")) {
    ...
    for (unsigned replicationInstanceTaskLogsIndex = 0; replicationInstanceTaskLogsIndex < replicationInstanceTaskLogsJsonList.GetLength();
         ++replicationInstanceTaskLogsIndex) {
