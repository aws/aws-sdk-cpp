...
StartMetadataModelConversionResult::StartMetadataModelConversionResult()
{
}

StartMetadataModelConversionResult::StartMetadataModelConversionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
