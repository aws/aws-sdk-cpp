...
DescribeMetadataModelConversionsResult::DescribeMetadataModelConversionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeMetadataModelConversionsResult& DescribeMetadataModelConversionsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
