...
MySQLSettings::MySQLSettings(JsonView jsonValue) { *this = jsonValue; }
...
MySQLSettings& MySQLSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AuthenticationMethod")) {
    m_authenticationMethod =
        MySQLAuthenticationMethodMapper::GetMySQLAuthenticationMethodForName(jsonValue.GetString("AuthenticationMethod"));
...
JsonValue MySQLSettings::Jsonize() const {
  ...
  if (m_authenticationMethodHasBeenSet) {
    payload.WithString("AuthenticationMethod",
                       MySQLAuthenticationMethodMapper::GetNameForMySQLAuthenticationMethod(m_authenticationMethod));
  }
