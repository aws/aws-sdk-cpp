...
Aws::String CreateDataMigrationRequest::SerializePayload() const {
  ...
  if (m_sourceDataSettingsHasBeenSet) {
    ...
    for (unsigned sourceDataSettingsIndex = 0; sourceDataSettingsIndex < sourceDataSettingsJsonList.GetLength();
         ++sourceDataSettingsIndex) {
  ...
  if (m_targetDataSettingsHasBeenSet) {
    ...
    for (unsigned targetDataSettingsIndex = 0; targetDataSettingsIndex < targetDataSettingsJsonList.GetLength();
         ++targetDataSettingsIndex) {
