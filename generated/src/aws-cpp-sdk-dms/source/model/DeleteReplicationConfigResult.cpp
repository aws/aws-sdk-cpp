...
DeleteReplicationConfigResult::DeleteReplicationConfigResult()
{
}

DeleteReplicationConfigResult::DeleteReplicationConfigResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
