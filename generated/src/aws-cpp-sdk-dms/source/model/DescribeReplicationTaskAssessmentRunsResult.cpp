...
DescribeReplicationTaskAssessmentRunsResult& DescribeReplicationTaskAssessmentRunsResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ReplicationTaskAssessmentRuns")) {
    ...
    for (unsigned replicationTaskAssessmentRunsIndex = 0;
         replicationTaskAssessmentRunsIndex < replicationTaskAssessmentRunsJsonList.GetLength(); ++replicationTaskAssessmentRunsIndex) {
