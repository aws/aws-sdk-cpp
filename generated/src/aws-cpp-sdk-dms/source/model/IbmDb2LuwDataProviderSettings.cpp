...
IbmDb2LuwDataProviderSettings::IbmDb2LuwDataProviderSettings() : 
...
IbmDb2LuwDataProviderSettings::IbmDb2LuwDataProviderSettings(JsonView jsonValue)
  : IbmDb2LuwDataProviderSettings()
{
  *this = jsonValue;
}

IbmDb2LuwDataProviderSettings& IbmDb2LuwDataProviderSettings::operator =(JsonView jsonValue)
{
...
JsonValue IbmDb2LuwDataProviderSettings::Jsonize() const
{
  JsonValue payload;
