...
namespace Model
{
  ...
  {
  public:
    AWS_SMS_API ImportServerCatalogResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ImportServerCatalogResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
