...
namespace Model
{
  ...
  {
  public:
    AWS_SMS_API DeleteAppValidationConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAppValidationConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
