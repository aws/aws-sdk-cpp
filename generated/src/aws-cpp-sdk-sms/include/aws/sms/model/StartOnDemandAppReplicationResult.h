...
namespace Model
{
  ...
  {
  public:
    AWS_SMS_API StartOnDemandAppReplicationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartOnDemandAppReplicationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
