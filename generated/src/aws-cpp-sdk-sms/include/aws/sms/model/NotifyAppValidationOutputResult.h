...
namespace Model
{
  ...
  {
  public:
    AWS_SMS_API NotifyAppValidationOutputResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    NotifyAppValidationOutputResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
