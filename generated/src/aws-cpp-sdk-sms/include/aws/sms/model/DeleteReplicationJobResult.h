...
namespace Model
{
  ...
  {
  public:
    AWS_SMS_API DeleteReplicationJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteReplicationJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
