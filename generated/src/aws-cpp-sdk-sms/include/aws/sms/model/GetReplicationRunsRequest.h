...
namespace Model
{
  ...
  {
  public:
    AWS_SMS_API GetReplicationRunsRequest() = default;
    ...
    template<typename ReplicationJobIdT = Aws::String>
    GetReplicationRunsRequest& WithReplicationJobId(ReplicationJobIdT&& value) { SetReplicationJobId(std::forward<ReplicationJobIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetReplicationRunsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
