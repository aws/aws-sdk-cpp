...
namespace Model
{
  ...
  {
  public:
    AWS_SMS_API PutAppLaunchConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutAppLaunchConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
