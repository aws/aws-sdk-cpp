...
namespace Model
{
  ...
  {
  public:
    AWS_SMS_API DeleteAppLaunchConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAppLaunchConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
