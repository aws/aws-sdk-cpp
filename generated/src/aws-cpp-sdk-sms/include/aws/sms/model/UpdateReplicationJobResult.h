...
namespace Model
{
  ...
  {
  public:
    AWS_SMS_API UpdateReplicationJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateReplicationJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
