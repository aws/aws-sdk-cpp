...
namespace Model
{
  ...
  {
  public:
    AWS_SMS_API StartAppReplicationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartAppReplicationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
