...
namespace SMS
{
const size_t SMSEndpointRules::RulesBlobStrLen = 3712;
const size_t SMSEndpointRules::RulesBlobSize = 3713;

using RulesBlobT = Aws::Array<const char, SMSEndpointRules::RulesBlobSize>;
...
't','p','s',':','/','/','s','m','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
const char* SMSEndpointRules::GetRulesBlob()
{
