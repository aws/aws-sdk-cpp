...
Aws::String GetReplicationRunsRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection GetReplicationRunsRequest::GetRequestSpecificHeaders() const
{
  ...
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AWSServerMigrationService_V2016_10_24.GetReplicationRuns"));
  return headers;
