...
Aws::String CalculateRouteMatrixRequest::SerializePayload() const {
  ...
  if (m_departurePositionsHasBeenSet) {
    ...
    for (unsigned departurePositionsIndex = 0; departurePositionsIndex < departurePositionsJsonList.GetLength();
         ++departurePositionsIndex) {
  ...
  if (m_destinationPositionsHasBeenSet) {
    ...
    for (unsigned destinationPositionsIndex = 0; destinationPositionsIndex < destinationPositionsJsonList.GetLength();
         ++destinationPositionsIndex) {
