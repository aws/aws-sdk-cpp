...
ListDevicePositionsResult::ListDevicePositionsResult()
{
}

ListDevicePositionsResult::ListDevicePositionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListDevicePositionsResult& ListDevicePositionsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
