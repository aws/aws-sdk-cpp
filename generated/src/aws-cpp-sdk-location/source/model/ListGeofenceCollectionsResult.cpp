...
ListGeofenceCollectionsResult::ListGeofenceCollectionsResult()
{
}

ListGeofenceCollectionsResult::ListGeofenceCollectionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListGeofenceCollectionsResult& ListGeofenceCollectionsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
