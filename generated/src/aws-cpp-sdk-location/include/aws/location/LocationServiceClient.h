...
namespace LocationService
{
   ...
   * Geofencing"</p>
   */
  class AWS_LOCATIONSERVICE_API LocationServiceClient : smithy::client::AwsSmithyClientT<Aws::LocationService::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<LocationServiceClient>
  {
    public:
