...
class AWS_LOCATIONSERVICE_API LocationServiceClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  LocationServiceClient(const Aws::LocationService::LocationServiceClientConfiguration& clientConfiguration =
  ...
  LocationServiceClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<LocationServiceEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::LocationService::LocationServiceClientConfiguration& clientConfiguration =
                            Aws::LocationService::LocationServiceClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateTrackerConsumer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateTrackerConsumer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateTrackerConsumerRequestT = Model::AssociateTrackerConsumerRequest>
  void AssociateTrackerConsumerAsync(const AssociateTrackerConsumerRequestT& request,
                                     const AssociateTrackerConsumerResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDeleteDevicePositionHistoryOutcome BatchDeleteDevicePositionHistory(
      const Model::BatchDeleteDevicePositionHistoryRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteDevicePositionHistory that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename BatchDeleteDevicePositionHistoryRequestT = Model::BatchDeleteDevicePositionHistoryRequest>
  Model::BatchDeleteDevicePositionHistoryOutcomeCallable BatchDeleteDevicePositionHistoryCallable(
      const BatchDeleteDevicePositionHistoryRequestT& request) const {
    return SubmitCallable(&LocationServiceClient::BatchDeleteDevicePositionHistory, request);
  }

  /**
   * An Async wrapper for BatchDeleteDevicePositionHistory that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchDeleteDevicePositionHistoryRequestT = Model::BatchDeleteDevicePositionHistoryRequest>
  void BatchDeleteDevicePositionHistoryAsync(const BatchDeleteDevicePositionHistoryRequestT& request,
                                             const BatchDeleteDevicePositionHistoryResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDeleteGeofence that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteGeofence that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchDeleteGeofenceRequestT = Model::BatchDeleteGeofenceRequest>
  void BatchDeleteGeofenceAsync(const BatchDeleteGeofenceRequestT& request, const BatchDeleteGeofenceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchEvaluateGeofences that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchEvaluateGeofences that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchEvaluateGeofencesRequestT = Model::BatchEvaluateGeofencesRequest>
  void BatchEvaluateGeofencesAsync(const BatchEvaluateGeofencesRequestT& request,
                                   const BatchEvaluateGeofencesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetDevicePosition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetDevicePosition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetDevicePositionRequestT = Model::BatchGetDevicePositionRequest>
  void BatchGetDevicePositionAsync(const BatchGetDevicePositionRequestT& request,
                                   const BatchGetDevicePositionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchPutGeofence that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchPutGeofence that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchPutGeofenceRequestT = Model::BatchPutGeofenceRequest>
  void BatchPutGeofenceAsync(const BatchPutGeofenceRequestT& request, const BatchPutGeofenceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchUpdateDevicePosition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchUpdateDevicePositionRequestT = Model::BatchUpdateDevicePositionRequest>
  Model::BatchUpdateDevicePositionOutcomeCallable BatchUpdateDevicePositionCallable(
      const BatchUpdateDevicePositionRequestT& request) const {
    return SubmitCallable(&LocationServiceClient::BatchUpdateDevicePosition, request);
  }

  /**
   * An Async wrapper for BatchUpdateDevicePosition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchUpdateDevicePositionRequestT = Model::BatchUpdateDevicePositionRequest>
  void BatchUpdateDevicePositionAsync(const BatchUpdateDevicePositionRequestT& request,
                                      const BatchUpdateDevicePositionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CalculateRoute that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CalculateRouteRequestT = Model::CalculateRouteRequest>
  void CalculateRouteAsync(const CalculateRouteRequestT& request, const CalculateRouteResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CalculateRouteMatrix that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CalculateRouteMatrix that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CalculateRouteMatrixRequestT = Model::CalculateRouteMatrixRequest>
  void CalculateRouteMatrixAsync(const CalculateRouteMatrixRequestT& request, const CalculateRouteMatrixResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateGeofenceCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateGeofenceCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateGeofenceCollectionRequestT = Model::CreateGeofenceCollectionRequest>
  void CreateGeofenceCollectionAsync(const CreateGeofenceCollectionRequestT& request,
                                     const CreateGeofenceCollectionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateMap that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateMapRequestT = Model::CreateMapRequest>
  void CreateMapAsync(const CreateMapRequestT& request, const CreateMapResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePlaceIndex that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePlaceIndex that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePlaceIndexRequestT = Model::CreatePlaceIndexRequest>
  void CreatePlaceIndexAsync(const CreatePlaceIndexRequestT& request, const CreatePlaceIndexResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateRouteCalculator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateRouteCalculator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRouteCalculatorRequestT = Model::CreateRouteCalculatorRequest>
  void CreateRouteCalculatorAsync(const CreateRouteCalculatorRequestT& request, const CreateRouteCalculatorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateTracker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateTrackerRequestT = Model::CreateTrackerRequest>
  void CreateTrackerAsync(const CreateTrackerRequestT& request, const CreateTrackerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteGeofenceCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteGeofenceCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteGeofenceCollectionRequestT = Model::DeleteGeofenceCollectionRequest>
  void DeleteGeofenceCollectionAsync(const DeleteGeofenceCollectionRequestT& request,
                                     const DeleteGeofenceCollectionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteMap that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteMapRequestT = Model::DeleteMapRequest>
  void DeleteMapAsync(const DeleteMapRequestT& request, const DeleteMapResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePlaceIndex that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePlaceIndex that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeletePlaceIndexRequestT = Model::DeletePlaceIndexRequest>
  void DeletePlaceIndexAsync(const DeletePlaceIndexRequestT& request, const DeletePlaceIndexResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteRouteCalculator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRouteCalculator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRouteCalculatorRequestT = Model::DeleteRouteCalculatorRequest>
  void DeleteRouteCalculatorAsync(const DeleteRouteCalculatorRequestT& request, const DeleteRouteCalculatorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteTracker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTrackerRequestT = Model::DeleteTrackerRequest>
  void DeleteTrackerAsync(const DeleteTrackerRequestT& request, const DeleteTrackerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeGeofenceCollectionOutcome DescribeGeofenceCollection(
      const Model::DescribeGeofenceCollectionRequest& request) const;

  /**
   * A Callable wrapper for DescribeGeofenceCollection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeGeofenceCollectionRequestT = Model::DescribeGeofenceCollectionRequest>
  Model::DescribeGeofenceCollectionOutcomeCallable DescribeGeofenceCollectionCallable(
      const DescribeGeofenceCollectionRequestT& request) const {
    return SubmitCallable(&LocationServiceClient::DescribeGeofenceCollection, request);
  }

  /**
   * An Async wrapper for DescribeGeofenceCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeGeofenceCollectionRequestT = Model::DescribeGeofenceCollectionRequest>
  void DescribeGeofenceCollectionAsync(const DescribeGeofenceCollectionRequestT& request,
                                       const DescribeGeofenceCollectionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeMap that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeMapRequestT = Model::DescribeMapRequest>
  void DescribeMapAsync(const DescribeMapRequestT& request, const DescribeMapResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePlaceIndex that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePlaceIndex that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePlaceIndexRequestT = Model::DescribePlaceIndexRequest>
  void DescribePlaceIndexAsync(const DescribePlaceIndexRequestT& request, const DescribePlaceIndexResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeRouteCalculator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRouteCalculator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRouteCalculatorRequestT = Model::DescribeRouteCalculatorRequest>
  void DescribeRouteCalculatorAsync(const DescribeRouteCalculatorRequestT& request,
                                    const DescribeRouteCalculatorResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeTracker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeTrackerRequestT = Model::DescribeTrackerRequest>
  void DescribeTrackerAsync(const DescribeTrackerRequestT& request, const DescribeTrackerResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisassociateTrackerConsumerOutcome DisassociateTrackerConsumer(
      const Model::DisassociateTrackerConsumerRequest& request) const;

  /**
   * A Callable wrapper for DisassociateTrackerConsumer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateTrackerConsumerRequestT = Model::DisassociateTrackerConsumerRequest>
  Model::DisassociateTrackerConsumerOutcomeCallable DisassociateTrackerConsumerCallable(
      const DisassociateTrackerConsumerRequestT& request) const {
    return SubmitCallable(&LocationServiceClient::DisassociateTrackerConsumer, request);
  }

  /**
   * An Async wrapper for DisassociateTrackerConsumer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateTrackerConsumerRequestT = Model::DisassociateTrackerConsumerRequest>
  void DisassociateTrackerConsumerAsync(const DisassociateTrackerConsumerRequestT& request,
                                        const DisassociateTrackerConsumerResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ForecastGeofenceEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ForecastGeofenceEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ForecastGeofenceEventsRequestT = Model::ForecastGeofenceEventsRequest>
  void ForecastGeofenceEventsAsync(const ForecastGeofenceEventsRequestT& request,
                                   const ForecastGeofenceEventsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDevicePosition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDevicePosition that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDevicePositionRequestT = Model::GetDevicePositionRequest>
  void GetDevicePositionAsync(const GetDevicePositionRequestT& request, const GetDevicePositionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDevicePositionHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDevicePositionHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDevicePositionHistoryRequestT = Model::GetDevicePositionHistoryRequest>
  void GetDevicePositionHistoryAsync(const GetDevicePositionHistoryRequestT& request,
                                     const GetDevicePositionHistoryResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetGeofence that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGeofenceRequestT = Model::GetGeofenceRequest>
  void GetGeofenceAsync(const GetGeofenceRequestT& request, const GetGeofenceResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMapGlyphs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMapGlyphsRequestT = Model::GetMapGlyphsRequest>
  void GetMapGlyphsAsync(const GetMapGlyphsRequestT& request, const GetMapGlyphsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMapSprites that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMapSpritesRequestT = Model::GetMapSpritesRequest>
  void GetMapSpritesAsync(const GetMapSpritesRequestT& request, const GetMapSpritesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMapStyleDescriptor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMapStyleDescriptor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMapStyleDescriptorRequestT = Model::GetMapStyleDescriptorRequest>
  void GetMapStyleDescriptorAsync(const GetMapStyleDescriptorRequestT& request, const GetMapStyleDescriptorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMapTile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMapTileRequestT = Model::GetMapTileRequest>
  void GetMapTileAsync(const GetMapTileRequestT& request, const GetMapTileResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDevicePositions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDevicePositions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDevicePositionsRequestT = Model::ListDevicePositionsRequest>
  void ListDevicePositionsAsync(const ListDevicePositionsRequestT& request, const ListDevicePositionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListGeofenceCollections that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGeofenceCollections that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListGeofenceCollectionsRequestT = Model::ListGeofenceCollectionsRequest>
  void ListGeofenceCollectionsAsync(const ListGeofenceCollectionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListGeofenceCollectionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListGeofences that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListGeofencesRequestT = Model::ListGeofencesRequest>
  ...
  /**
   * An Async wrapper for ListMaps that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMapsRequestT = Model::ListMapsRequest>
  void ListMapsAsync(const ListMapsResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                     const ListMapsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPlaceIndexes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPlaceIndexes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPlaceIndexesRequestT = Model::ListPlaceIndexesRequest>
  void ListPlaceIndexesAsync(const ListPlaceIndexesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListPlaceIndexesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListRouteCalculators that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRouteCalculators that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRouteCalculatorsRequestT = Model::ListRouteCalculatorsRequest>
  void ListRouteCalculatorsAsync(const ListRouteCalculatorsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListRouteCalculatorsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTrackerConsumers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTrackerConsumers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTrackerConsumersRequestT = Model::ListTrackerConsumersRequest>
  void ListTrackerConsumersAsync(const ListTrackerConsumersRequestT& request, const ListTrackerConsumersResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListTrackers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListTrackersRequestT = Model::ListTrackersRequest>
  void ListTrackersAsync(const ListTrackersResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListTrackersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for PutGeofence that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutGeofenceRequestT = Model::PutGeofenceRequest>
  void PutGeofenceAsync(const PutGeofenceRequestT& request, const PutGeofenceResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SearchPlaceIndexForPositionOutcome SearchPlaceIndexForPosition(
      const Model::SearchPlaceIndexForPositionRequest& request) const;

  /**
   * A Callable wrapper for SearchPlaceIndexForPosition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SearchPlaceIndexForPositionRequestT = Model::SearchPlaceIndexForPositionRequest>
  Model::SearchPlaceIndexForPositionOutcomeCallable SearchPlaceIndexForPositionCallable(
      const SearchPlaceIndexForPositionRequestT& request) const {
    return SubmitCallable(&LocationServiceClient::SearchPlaceIndexForPosition, request);
  }

  /**
   * An Async wrapper for SearchPlaceIndexForPosition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchPlaceIndexForPositionRequestT = Model::SearchPlaceIndexForPositionRequest>
  void SearchPlaceIndexForPositionAsync(const SearchPlaceIndexForPositionRequestT& request,
                                        const SearchPlaceIndexForPositionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SearchPlaceIndexForSuggestionsOutcome SearchPlaceIndexForSuggestions(
      const Model::SearchPlaceIndexForSuggestionsRequest& request) const;

  /**
   * A Callable wrapper for SearchPlaceIndexForSuggestions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SearchPlaceIndexForSuggestionsRequestT = Model::SearchPlaceIndexForSuggestionsRequest>
  Model::SearchPlaceIndexForSuggestionsOutcomeCallable SearchPlaceIndexForSuggestionsCallable(
      const SearchPlaceIndexForSuggestionsRequestT& request) const {
    return SubmitCallable(&LocationServiceClient::SearchPlaceIndexForSuggestions, request);
  }

  /**
   * An Async wrapper for SearchPlaceIndexForSuggestions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SearchPlaceIndexForSuggestionsRequestT = Model::SearchPlaceIndexForSuggestionsRequest>
  void SearchPlaceIndexForSuggestionsAsync(const SearchPlaceIndexForSuggestionsRequestT& request,
                                           const SearchPlaceIndexForSuggestionsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchPlaceIndexForText that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchPlaceIndexForText that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchPlaceIndexForTextRequestT = Model::SearchPlaceIndexForTextRequest>
  void SearchPlaceIndexForTextAsync(const SearchPlaceIndexForTextRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateGeofenceCollection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateGeofenceCollection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateGeofenceCollectionRequestT = Model::UpdateGeofenceCollectionRequest>
  void UpdateGeofenceCollectionAsync(const UpdateGeofenceCollectionRequestT& request,
                                     const UpdateGeofenceCollectionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateKeyRequestT = Model::UpdateKeyRequest>
  void UpdateKeyAsync(const UpdateKeyRequestT& request, const UpdateKeyResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateMap that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateMapRequestT = Model::UpdateMapRequest>
  void UpdateMapAsync(const UpdateMapRequestT& request, const UpdateMapResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePlaceIndex that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePlaceIndex that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdatePlaceIndexRequestT = Model::UpdatePlaceIndexRequest>
  void UpdatePlaceIndexAsync(const UpdatePlaceIndexRequestT& request, const UpdatePlaceIndexResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateRouteCalculator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRouteCalculator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRouteCalculatorRequestT = Model::UpdateRouteCalculatorRequest>
  void UpdateRouteCalculatorAsync(const UpdateRouteCalculatorRequestT& request, const UpdateRouteCalculatorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateTracker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateTrackerRequestT = Model::UpdateTrackerRequest>
  void UpdateTrackerAsync(const UpdateTrackerRequestT& request, const UpdateTrackerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for VerifyDevicePosition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for VerifyDevicePosition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename VerifyDevicePositionRequestT = Model::VerifyDevicePositionRequest>
  void VerifyDevicePositionAsync(const VerifyDevicePositionRequestT& request, const VerifyDevicePositionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
