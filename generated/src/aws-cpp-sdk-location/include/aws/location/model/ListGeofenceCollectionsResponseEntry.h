...
class ListGeofenceCollectionsResponseEntry {
 public:
  ...
  template <typename CollectionNameT = Aws::String>
  ListGeofenceCollectionsResponseEntry& WithCollectionName(CollectionNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ListGeofenceCollectionsResponseEntry& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  ListGeofenceCollectionsResponseEntry& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  ListGeofenceCollectionsResponseEntry& WithUpdateTime(UpdateTimeT&& value) {
