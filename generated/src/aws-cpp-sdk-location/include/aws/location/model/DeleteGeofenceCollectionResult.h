...
namespace Model
{
  ...
  {
  public:
    AWS_LOCATIONSERVICE_API DeleteGeofenceCollectionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteGeofenceCollectionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
