...
namespace Model
{
  ...
  public:
    ...
    inline PutGeofenceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutGeofenceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutGeofenceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
