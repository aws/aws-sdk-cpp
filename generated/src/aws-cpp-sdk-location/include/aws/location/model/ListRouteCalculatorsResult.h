...
class ListRouteCalculatorsResult {
 public:
  ...
  template <typename EntriesT = Aws::Vector<ListRouteCalculatorsResponseEntry>>
  ListRouteCalculatorsResult& WithEntries(EntriesT&& value) {
    SetEntries(std::forward<EntriesT>(value));
    return *this;
  }
  template <typename EntriesT = ListRouteCalculatorsResponseEntry>
  ListRouteCalculatorsResult& AddEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRouteCalculatorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRouteCalculatorsResult& WithRequestId(RequestIdT&& value) {
