...
namespace Model
{
  ...
  {
  public:
    AWS_LOCATIONSERVICE_API ValidationExceptionField() = default;
    AWS_LOCATIONSERVICE_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_LOCATIONSERVICE_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
