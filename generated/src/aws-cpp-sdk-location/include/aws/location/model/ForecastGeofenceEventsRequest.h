...
class ForecastGeofenceEventsRequest : public LocationServiceRequest {
 public:
  ...
  void SetDeviceState(DeviceStateT&& value) {
    m_deviceStateHasBeenSet = true;
    m_deviceState = std::forward<DeviceStateT>(value);
  }
  template <typename DeviceStateT = ForecastGeofenceEventsDeviceState>
  ForecastGeofenceEventsRequest& WithDeviceState(DeviceStateT&& value) {
    SetDeviceState(std::forward<DeviceStateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTimeHorizonMinutes(double value) {
    m_timeHorizonMinutesHasBeenSet = true;
    m_timeHorizonMinutes = value;
  }
  inline ForecastGeofenceEventsRequest& WithTimeHorizonMinutes(double value) {
    SetTimeHorizonMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline ForecastGeofenceEventsRequest& WithDistanceUnit(DistanceUnit value) {
  ...
  inline ForecastGeofenceEventsRequest& WithSpeedUnit(SpeedUnit value) {
    SetSpeedUnit(value);
    return *this;
  }
  ///@}
  ...
  inline ForecastGeofenceEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
