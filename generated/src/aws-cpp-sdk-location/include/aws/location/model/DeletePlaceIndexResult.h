...
namespace Model
{
  ...
  public:
    ...
    inline DeletePlaceIndexResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeletePlaceIndexResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeletePlaceIndexResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
