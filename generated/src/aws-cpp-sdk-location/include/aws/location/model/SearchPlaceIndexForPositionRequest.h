...
class SearchPlaceIndexForPositionRequest : public LocationServiceRequest {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  SearchPlaceIndexForPositionRequest& WithIndexName(IndexNameT&& value) {
  ...
  template <typename PositionT = Aws::Vector<double>>
  SearchPlaceIndexForPositionRequest& WithPosition(PositionT&& value) {
    SetPosition(std::forward<PositionT>(value));
    return *this;
  }
  inline SearchPlaceIndexForPositionRequest& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline SearchPlaceIndexForPositionRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename LanguageT = Aws::String>
  SearchPlaceIndexForPositionRequest& WithLanguage(LanguageT&& value) {
  ...
  template <typename KeyT = Aws::String>
  SearchPlaceIndexForPositionRequest& WithKey(KeyT&& value) {
