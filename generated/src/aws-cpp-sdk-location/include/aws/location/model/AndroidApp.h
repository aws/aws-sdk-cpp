...
class AndroidApp {
 public:
  ...
  template <typename PackageT = Aws::String>
  AndroidApp& WithPackage(PackageT&& value) {
  ...
  void SetCertificateFingerprint(CertificateFingerprintT&& value) {
    m_certificateFingerprintHasBeenSet = true;
    m_certificateFingerprint = std::forward<CertificateFingerprintT>(value);
  }
  template <typename CertificateFingerprintT = Aws::String>
  AndroidApp& WithCertificateFingerprint(CertificateFingerprintT&& value) {
    SetCertificateFingerprint(std::forward<CertificateFingerprintT>(value));
    return *this;
  }
  ///@}
 private:
