...
class SearchPlaceIndexForPositionResult {
 public:
  ...
  AWS_LOCATIONSERVICE_API SearchPlaceIndexForPositionResult& operator=(
  ...
  template <typename SummaryT = SearchPlaceIndexForPositionSummary>
  SearchPlaceIndexForPositionResult& WithSummary(SummaryT&& value) {
  ...
  template <typename ResultsT = Aws::Vector<SearchForPositionResult>>
  SearchPlaceIndexForPositionResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = SearchForPositionResult>
  SearchPlaceIndexForPositionResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  SearchPlaceIndexForPositionResult& WithRequestId(RequestIdT&& value) {
