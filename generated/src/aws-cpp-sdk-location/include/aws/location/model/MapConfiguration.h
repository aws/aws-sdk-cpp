...
class MapConfiguration {
 public:
  ...
  void SetCustomLayers(CustomLayersT&& value) {
    ...
    m_customLayers = std::forward<CustomLayersT>(value);
  }
  template <typename CustomLayersT = Aws::Vector<Aws::String>>
  MapConfiguration& WithCustomLayers(CustomLayersT&& value) {
    SetCustomLayers(std::forward<CustomLayersT>(value));
    return *this;
  }
  template <typename CustomLayersT = Aws::String>
  MapConfiguration& AddCustomLayers(CustomLayersT&& value) {
    m_customLayersHasBeenSet = true;
    m_customLayers.emplace_back(std::forward<CustomLayersT>(value));
    return *this;
  }
  ///@}
 private:
