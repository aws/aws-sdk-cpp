...
namespace Model
{
  ...
  /**
   */
  class ListMapsRequest : public LocationServiceRequest
  {
  public:
    AWS_LOCATIONSERVICE_API ListMapsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListMapsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
