...
class GetDevicePositionHistoryResult {
 public:
  ...
  void SetDevicePositions(DevicePositionsT&& value) {
    ...
    m_devicePositions = std::forward<DevicePositionsT>(value);
  }
  template <typename DevicePositionsT = Aws::Vector<DevicePosition>>
  GetDevicePositionHistoryResult& WithDevicePositions(DevicePositionsT&& value) {
    SetDevicePositions(std::forward<DevicePositionsT>(value));
    return *this;
  }
  template <typename DevicePositionsT = DevicePosition>
  GetDevicePositionHistoryResult& AddDevicePositions(DevicePositionsT&& value) {
    m_devicePositionsHasBeenSet = true;
    m_devicePositions.emplace_back(std::forward<DevicePositionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetDevicePositionHistoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDevicePositionHistoryResult& WithRequestId(RequestIdT&& value) {
