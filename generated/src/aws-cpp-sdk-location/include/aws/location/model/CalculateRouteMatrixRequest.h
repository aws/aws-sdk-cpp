...
class CalculateRouteMatrixRequest : public LocationServiceRequest {
 public:
  ...
  void SetDeparturePositions(DeparturePositionsT&& value) {
    m_departurePositionsHasBeenSet = true;
    m_departurePositions = std::forward<DeparturePositionsT>(value);
  }
  template <typename DeparturePositionsT = Aws::Vector<Aws::Vector<double>>>
  CalculateRouteMatrixRequest& WithDeparturePositions(DeparturePositionsT&& value) {
    SetDeparturePositions(std::forward<DeparturePositionsT>(value));
    return *this;
  }
  ...
  CalculateRouteMatrixRequest& AddDeparturePositions(DeparturePositionsT&& value) {
    m_departurePositionsHasBeenSet = true;
    m_departurePositions.emplace_back(std::forward<DeparturePositionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationPositions(DestinationPositionsT&& value) {
    m_destinationPositionsHasBeenSet = true;
    m_destinationPositions = std::forward<DestinationPositionsT>(value);
  }
  template <typename DestinationPositionsT = Aws::Vector<Aws::Vector<double>>>
  CalculateRouteMatrixRequest& WithDestinationPositions(DestinationPositionsT&& value) {
    SetDestinationPositions(std::forward<DestinationPositionsT>(value));
    return *this;
  }
  ...
  CalculateRouteMatrixRequest& AddDestinationPositions(DestinationPositionsT&& value) {
    m_destinationPositionsHasBeenSet = true;
    m_destinationPositions.emplace_back(std::forward<DestinationPositionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTravelMode(TravelMode value) {
    m_travelModeHasBeenSet = true;
    m_travelMode = value;
  }
  inline CalculateRouteMatrixRequest& WithTravelMode(TravelMode value) {
    SetTravelMode(value);
    return *this;
  }
  ///@}
  ...
  inline CalculateRouteMatrixRequest& WithDepartNow(bool value) {
    SetDepartNow(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDistanceUnit(DistanceUnit value) {
    m_distanceUnitHasBeenSet = true;
    m_distanceUnit = value;
  }
  inline CalculateRouteMatrixRequest& WithDistanceUnit(DistanceUnit value) {
  ...
  void SetCarModeOptions(CarModeOptionsT&& value) {
    m_carModeOptionsHasBeenSet = true;
    m_carModeOptions = std::forward<CarModeOptionsT>(value);
  }
  template <typename CarModeOptionsT = CalculateRouteCarModeOptions>
  CalculateRouteMatrixRequest& WithCarModeOptions(CarModeOptionsT&& value) {
    SetCarModeOptions(std::forward<CarModeOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTruckModeOptions(TruckModeOptionsT&& value) {
    m_truckModeOptionsHasBeenSet = true;
    m_truckModeOptions = std::forward<TruckModeOptionsT>(value);
  }
  template <typename TruckModeOptionsT = CalculateRouteTruckModeOptions>
  CalculateRouteMatrixRequest& WithTruckModeOptions(TruckModeOptionsT&& value) {
    SetTruckModeOptions(std::forward<TruckModeOptionsT>(value));
    return *this;
  }
  ///@}
