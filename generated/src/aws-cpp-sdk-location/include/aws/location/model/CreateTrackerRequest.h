...
class CreateTrackerRequest : public LocationServiceRequest {
 public:
  ...
  inline CreateTrackerRequest& WithPositionFiltering(PositionFiltering value) {
  ...
  inline CreateTrackerRequest& WithEventBridgeEnabled(bool value) {
  ...
  inline CreateTrackerRequest& WithKmsKeyEnableGeospatialQueries(bool value) {
