...
class SearchPlaceIndexForSuggestionsResult {
 public:
  ...
  AWS_LOCATIONSERVICE_API SearchPlaceIndexForSuggestionsResult& operator=(
  ...
  template <typename SummaryT = SearchPlaceIndexForSuggestionsSummary>
  SearchPlaceIndexForSuggestionsResult& WithSummary(SummaryT&& value) {
  ...
  template <typename ResultsT = Aws::Vector<SearchForSuggestionsResult>>
  SearchPlaceIndexForSuggestionsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = SearchForSuggestionsResult>
  SearchPlaceIndexForSuggestionsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  SearchPlaceIndexForSuggestionsResult& WithRequestId(RequestIdT&& value) {
