...
namespace Model
{
  ...
  {
  public:
    AWS_LOCATIONSERVICE_API DisassociateTrackerConsumerRequest() = default;
    ...
    template<typename TrackerNameT = Aws::String>
    DisassociateTrackerConsumerRequest& WithTrackerName(TrackerNameT&& value) { SetTrackerName(std::forward<TrackerNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ConsumerArnT = Aws::String>
    DisassociateTrackerConsumerRequest& WithConsumerArn(ConsumerArnT&& value) { SetConsumerArn(std::forward<ConsumerArnT>(value)); return *this;}
    ///@}
  private:
