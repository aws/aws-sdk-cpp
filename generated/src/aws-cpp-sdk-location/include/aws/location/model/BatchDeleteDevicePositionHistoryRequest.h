...
class BatchDeleteDevicePositionHistoryRequest : public LocationServiceRequest {
 public:
  ...
  template <typename TrackerNameT = Aws::String>
  BatchDeleteDevicePositionHistoryRequest& WithTrackerName(TrackerNameT&& value) {
  ...
  template <typename DeviceIdsT = Aws::Vector<Aws::String>>
  BatchDeleteDevicePositionHistoryRequest& WithDeviceIds(DeviceIdsT&& value) {
    SetDeviceIds(std::forward<DeviceIdsT>(value));
    return *this;
  }
  template <typename DeviceIdsT = Aws::String>
  BatchDeleteDevicePositionHistoryRequest& AddDeviceIds(DeviceIdsT&& value) {
    m_deviceIdsHasBeenSet = true;
