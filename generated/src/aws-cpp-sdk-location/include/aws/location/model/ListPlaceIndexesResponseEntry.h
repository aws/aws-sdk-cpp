...
class ListPlaceIndexesResponseEntry {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  ListPlaceIndexesResponseEntry& WithIndexName(IndexNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ListPlaceIndexesResponseEntry& WithDescription(DescriptionT&& value) {
  ...
  template <typename DataSourceT = Aws::String>
  ListPlaceIndexesResponseEntry& WithDataSource(DataSourceT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  ListPlaceIndexesResponseEntry& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  ListPlaceIndexesResponseEntry& WithUpdateTime(UpdateTimeT&& value) {
