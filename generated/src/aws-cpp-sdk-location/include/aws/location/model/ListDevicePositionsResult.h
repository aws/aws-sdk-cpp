...
class ListDevicePositionsResult {
 public:
  ...
  template <typename EntriesT = Aws::Vector<ListDevicePositionsResponseEntry>>
  ListDevicePositionsResult& WithEntries(EntriesT&& value) {
    SetEntries(std::forward<EntriesT>(value));
    return *this;
  }
  template <typename EntriesT = ListDevicePositionsResponseEntry>
  ListDevicePositionsResult& AddEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDevicePositionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDevicePositionsResult& WithRequestId(RequestIdT&& value) {
