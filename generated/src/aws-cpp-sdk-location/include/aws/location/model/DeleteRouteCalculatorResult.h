...
namespace Model
{
  ...
  {
  public:
    AWS_LOCATIONSERVICE_API DeleteRouteCalculatorResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteRouteCalculatorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
