...
class SearchPlaceIndexForTextRequest : public LocationServiceRequest {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  SearchPlaceIndexForTextRequest& WithIndexName(IndexNameT&& value) {
  ...
  template <typename TextT = Aws::String>
  SearchPlaceIndexForTextRequest& WithText(TextT&& value) {
  ...
  template <typename BiasPositionT = Aws::Vector<double>>
  SearchPlaceIndexForTextRequest& WithBiasPosition(BiasPositionT&& value) {
    SetBiasPosition(std::forward<BiasPositionT>(value));
    return *this;
  }
  inline SearchPlaceIndexForTextRequest& AddBiasPosition(double value) {
    m_biasPositionHasBeenSet = true;
  ...
  void SetFilterBBox(FilterBBoxT&& value) {
    m_filterBBoxHasBeenSet = true;
    m_filterBBox = std::forward<FilterBBoxT>(value);
  }
  template <typename FilterBBoxT = Aws::Vector<double>>
  SearchPlaceIndexForTextRequest& WithFilterBBox(FilterBBoxT&& value) {
    SetFilterBBox(std::forward<FilterBBoxT>(value));
    return *this;
  }
  inline SearchPlaceIndexForTextRequest& AddFilterBBox(double value) {
    m_filterBBoxHasBeenSet = true;
    m_filterBBox.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetFilterCountries(FilterCountriesT&& value) {
    m_filterCountriesHasBeenSet = true;
    m_filterCountries = std::forward<FilterCountriesT>(value);
  }
  template <typename FilterCountriesT = Aws::Vector<Aws::String>>
  SearchPlaceIndexForTextRequest& WithFilterCountries(FilterCountriesT&& value) {
    SetFilterCountries(std::forward<FilterCountriesT>(value));
    return *this;
  }
  template <typename FilterCountriesT = Aws::String>
  SearchPlaceIndexForTextRequest& AddFilterCountries(FilterCountriesT&& value) {
    m_filterCountriesHasBeenSet = true;
    m_filterCountries.emplace_back(std::forward<FilterCountriesT>(value));
    return *this;
  }
  ///@}
  ...
  inline SearchPlaceIndexForTextRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename LanguageT = Aws::String>
  SearchPlaceIndexForTextRequest& WithLanguage(LanguageT&& value) {
  ...
  void SetFilterCategories(FilterCategoriesT&& value) {
    m_filterCategoriesHasBeenSet = true;
    m_filterCategories = std::forward<FilterCategoriesT>(value);
  }
  template <typename FilterCategoriesT = Aws::Vector<Aws::String>>
  SearchPlaceIndexForTextRequest& WithFilterCategories(FilterCategoriesT&& value) {
    SetFilterCategories(std::forward<FilterCategoriesT>(value));
    return *this;
  }
  template <typename FilterCategoriesT = Aws::String>
  SearchPlaceIndexForTextRequest& AddFilterCategories(FilterCategoriesT&& value) {
    m_filterCategoriesHasBeenSet = true;
    m_filterCategories.emplace_back(std::forward<FilterCategoriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename KeyT = Aws::String>
  SearchPlaceIndexForTextRequest& WithKey(KeyT&& value) {
