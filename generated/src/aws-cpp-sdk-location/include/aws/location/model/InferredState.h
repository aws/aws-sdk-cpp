...
class InferredState {
 public:
  ...
  inline InferredState& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline void SetDeviationDistance(double value) {
    m_deviationDistanceHasBeenSet = true;
    m_deviationDistance = value;
  }
  inline InferredState& WithDeviationDistance(double value) {
    SetDeviationDistance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProxyDetected(bool value) {
    m_proxyDetectedHasBeenSet = true;
    m_proxyDetected = value;
  }
  inline InferredState& WithProxyDetected(bool value) {
    SetProxyDetected(value);
    return *this;
  }
  ///@}
 private:
