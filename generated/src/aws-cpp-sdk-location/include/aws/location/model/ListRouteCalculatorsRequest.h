...
namespace Model
{
  ...
  {
  public:
    AWS_LOCATIONSERVICE_API ListRouteCalculatorsRequest();
     ...
     * <p>Default Value: <code>null</code> </p>
     */
    inline ListRouteCalculatorsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
     ...
     * <p>Default Value: <code>null</code> </p>
     */
    inline ListRouteCalculatorsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
     ...
     * <p>Default Value: <code>null</code> </p>
     */
    inline ListRouteCalculatorsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
