...
class DescribeGeofenceCollectionResult {
 public:
  ...
  AWS_LOCATIONSERVICE_API DescribeGeofenceCollectionResult& operator=(
  ...
  inline void SetGeofenceCount(int value) {
    m_geofenceCountHasBeenSet = true;
    m_geofenceCount = value;
  }
  inline DescribeGeofenceCollectionResult& WithGeofenceCount(int value) {
    SetGeofenceCount(value);
    return *this;
  }
  ///@}
