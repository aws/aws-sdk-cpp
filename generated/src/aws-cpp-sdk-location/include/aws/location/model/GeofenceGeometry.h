...
class GeofenceGeometry {
 public:
  ...
  void SetGeobuf(GeobufT&& value) {
    ...
    m_geobuf = std::forward<GeobufT>(value);
  }
  template <typename GeobufT = Aws::Utils::CryptoBuffer>
  GeofenceGeometry& WithGeobuf(GeobufT&& value) {
    SetGeobuf(std::forward<GeobufT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMultiPolygon(MultiPolygonT&& value) {
    ...
    m_multiPolygon = std::forward<MultiPolygonT>(value);
  }
  template <typename MultiPolygonT = Aws::Vector<Aws::Vector<Aws::Vector<Aws::Vector<double>>>>>
  GeofenceGeometry& WithMultiPolygon(MultiPolygonT&& value) {
    SetMultiPolygon(std::forward<MultiPolygonT>(value));
    return *this;
  }
  ...
  GeofenceGeometry& AddMultiPolygon(MultiPolygonT&& value) {
    m_multiPolygonHasBeenSet = true;
    m_multiPolygon.emplace_back(std::forward<MultiPolygonT>(value));
    return *this;
  }
  ///@}
 private:
