...
class TruckDimensions {
 public:
  ...
  inline TruckDimensions& WithLength(double value) {
    SetLength(value);
    return *this;
  }
  ///@}
  ...
  inline TruckDimensions& WithHeight(double value) {
    SetHeight(value);
    return *this;
  }
  ///@}
  ...
  inline TruckDimensions& WithWidth(double value) {
    SetWidth(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnit(DimensionUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline TruckDimensions& WithUnit(DimensionUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
