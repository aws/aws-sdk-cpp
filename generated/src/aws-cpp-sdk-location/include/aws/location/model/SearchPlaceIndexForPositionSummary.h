...
class SearchPlaceIndexForPositionSummary {
 public:
  ...
  template <typename PositionT = Aws::Vector<double>>
  SearchPlaceIndexForPositionSummary& WithPosition(PositionT&& value) {
    SetPosition(std::forward<PositionT>(value));
    return *this;
  }
  inline SearchPlaceIndexForPositionSummary& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  inline SearchPlaceIndexForPositionSummary& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename DataSourceT = Aws::String>
  SearchPlaceIndexForPositionSummary& WithDataSource(DataSourceT&& value) {
  ...
  template <typename LanguageT = Aws::String>
  SearchPlaceIndexForPositionSummary& WithLanguage(LanguageT&& value) {
