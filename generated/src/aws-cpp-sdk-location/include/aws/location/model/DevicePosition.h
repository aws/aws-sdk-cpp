...
class DevicePosition {
 public:
  ...
  template <typename DeviceIdT = Aws::String>
  DevicePosition& WithDeviceId(DeviceIdT&& value) {
  ...
  template <typename SampleTimeT = Aws::Utils::DateTime>
  DevicePosition& WithSampleTime(SampleTimeT&& value) {
  ...
  template <typename ReceivedTimeT = Aws::Utils::DateTime>
  DevicePosition& WithReceivedTime(ReceivedTimeT&& value) {
  ...
  template <typename PositionT = Aws::Vector<double>>
  DevicePosition& WithPosition(PositionT&& value) {
    SetPosition(std::forward<PositionT>(value));
    return *this;
  }
  inline DevicePosition& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  template <typename AccuracyT = PositionalAccuracy>
  DevicePosition& WithAccuracy(AccuracyT&& value) {
  ...
  template <typename PositionPropertiesT = Aws::Map<Aws::String, Aws::String>>
  DevicePosition& WithPositionProperties(PositionPropertiesT&& value) {
