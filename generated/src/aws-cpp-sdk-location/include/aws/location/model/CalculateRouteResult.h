...
class CalculateRouteResult {
 public:
  ...
  void SetLegs(LegsT&& value) {
    ...
    m_legs = std::forward<LegsT>(value);
  }
  template <typename LegsT = Aws::Vector<Leg>>
  CalculateRouteResult& WithLegs(LegsT&& value) {
    SetLegs(std::forward<LegsT>(value));
    return *this;
  }
  template <typename LegsT = Leg>
  CalculateRouteResult& AddLegs(LegsT&& value) {
    m_legsHasBeenSet = true;
    m_legs.emplace_back(std::forward<LegsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SummaryT = CalculateRouteSummary>
  CalculateRouteResult& WithSummary(SummaryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CalculateRouteResult& WithRequestId(RequestIdT&& value) {
