...
class CalculateRouteMatrixSummary {
 public:
  ...
  template <typename DataSourceT = Aws::String>
  CalculateRouteMatrixSummary& WithDataSource(DataSourceT&& value) {
  ...
  inline void SetRouteCount(int value) {
    m_routeCountHasBeenSet = true;
    m_routeCount = value;
  }
  inline CalculateRouteMatrixSummary& WithRouteCount(int value) {
    SetRouteCount(value);
    return *this;
  }
  ///@}
  ...
  inline CalculateRouteMatrixSummary& WithErrorCount(int value) {
    SetErrorCount(value);
    return *this;
  }
  ///@}
  ...
  inline CalculateRouteMatrixSummary& WithDistanceUnit(DistanceUnit value) {
