...
class GetDevicePositionResult {
 public:
  ...
  template <typename DeviceIdT = Aws::String>
  GetDevicePositionResult& WithDeviceId(DeviceIdT&& value) {
  ...
  template <typename SampleTimeT = Aws::Utils::DateTime>
  GetDevicePositionResult& WithSampleTime(SampleTimeT&& value) {
  ...
  void SetReceivedTime(ReceivedTimeT&& value) {
    ...
    m_receivedTime = std::forward<ReceivedTimeT>(value);
  }
  template <typename ReceivedTimeT = Aws::Utils::DateTime>
  GetDevicePositionResult& WithReceivedTime(ReceivedTimeT&& value) {
    SetReceivedTime(std::forward<ReceivedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PositionT = Aws::Vector<double>>
  GetDevicePositionResult& WithPosition(PositionT&& value) {
    SetPosition(std::forward<PositionT>(value));
    return *this;
  }
  inline GetDevicePositionResult& AddPosition(double value) {
    m_positionHasBeenSet = true;
  ...
  template <typename AccuracyT = PositionalAccuracy>
  GetDevicePositionResult& WithAccuracy(AccuracyT&& value) {
  ...
  template <typename PositionPropertiesT = Aws::Map<Aws::String, Aws::String>>
  GetDevicePositionResult& WithPositionProperties(PositionPropertiesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDevicePositionResult& WithRequestId(RequestIdT&& value) {
