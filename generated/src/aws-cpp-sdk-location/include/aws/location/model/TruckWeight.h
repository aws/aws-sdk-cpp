...
class TruckWeight {
 public:
  ...
  inline void SetTotal(double value) {
    m_totalHasBeenSet = true;
    m_total = value;
  }
  inline TruckWeight& WithTotal(double value) {
    SetTotal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnit(VehicleWeightUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline TruckWeight& WithUnit(VehicleWeightUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
