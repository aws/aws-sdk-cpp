...
class ForecastedEvent {
 public:
  ...
  inline void SetIsDeviceInGeofence(bool value) {
    m_isDeviceInGeofenceHasBeenSet = true;
    m_isDeviceInGeofence = value;
  }
  inline ForecastedEvent& WithIsDeviceInGeofence(bool value) {
    SetIsDeviceInGeofence(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNearestDistance(double value) {
    m_nearestDistanceHasBeenSet = true;
    m_nearestDistance = value;
  }
  inline ForecastedEvent& WithNearestDistance(double value) {
    SetNearestDistance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEventType(ForecastedGeofenceEventType value) {
    m_eventTypeHasBeenSet = true;
    m_eventType = value;
  }
  inline ForecastedEvent& WithEventType(ForecastedGeofenceEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  void SetForecastedBreachTime(ForecastedBreachTimeT&& value) {
    ...
    m_forecastedBreachTime = std::forward<ForecastedBreachTimeT>(value);
  }
  template <typename ForecastedBreachTimeT = Aws::Utils::DateTime>
  ForecastedEvent& WithForecastedBreachTime(ForecastedBreachTimeT&& value) {
    SetForecastedBreachTime(std::forward<ForecastedBreachTimeT>(value));
    return *this;
  }
  ///@}
