...
class UpdateKeyRequest : public LocationServiceRequest {
 public:
  ...
  inline void SetNoExpiry(bool value) {
    m_noExpiryHasBeenSet = true;
    m_noExpiry = value;
  }
  inline UpdateKeyRequest& WithNoExpiry(bool value) {
    SetNoExpiry(value);
    return *this;
  }
  ///@}
  ...
  inline void SetForceUpdate(bool value) {
    m_forceUpdateHasBeenSet = true;
    m_forceUpdate = value;
  }
  inline UpdateKeyRequest& WithForceUpdate(bool value) {
