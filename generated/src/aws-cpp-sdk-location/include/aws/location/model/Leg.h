...
class Leg {
 public:
  ...
  inline Leg& AddStartPosition(double value) {
    m_startPositionHasBeenSet = true;
  ...
  inline Leg& AddEndPosition(double value) {
    m_endPositionHasBeenSet = true;
  ...
  inline Leg& WithDistance(double value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline Leg& WithDurationSeconds(double value) {
