...
class CalculateRouteMatrixResult {
 public:
  ...
  void SetSnappedDeparturePositions(SnappedDeparturePositionsT&& value) {
    m_snappedDeparturePositionsHasBeenSet = true;
    m_snappedDeparturePositions = std::forward<SnappedDeparturePositionsT>(value);
  }
  template <typename SnappedDeparturePositionsT = Aws::Vector<Aws::Vector<double>>>
  CalculateRouteMatrixResult& WithSnappedDeparturePositions(SnappedDeparturePositionsT&& value) {
    SetSnappedDeparturePositions(std::forward<SnappedDeparturePositionsT>(value));
    return *this;
  }
  template <typename SnappedDeparturePositionsT = Aws::Vector<double>>
  CalculateRouteMatrixResult& AddSnappedDeparturePositions(SnappedDeparturePositionsT&& value) {
    m_snappedDeparturePositionsHasBeenSet = true;
    m_snappedDeparturePositions.emplace_back(std::forward<SnappedDeparturePositionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnappedDestinationPositions(SnappedDestinationPositionsT&& value) {
    m_snappedDestinationPositionsHasBeenSet = true;
    m_snappedDestinationPositions = std::forward<SnappedDestinationPositionsT>(value);
  }
  template <typename SnappedDestinationPositionsT = Aws::Vector<Aws::Vector<double>>>
  CalculateRouteMatrixResult& WithSnappedDestinationPositions(SnappedDestinationPositionsT&& value) {
    SetSnappedDestinationPositions(std::forward<SnappedDestinationPositionsT>(value));
    return *this;
  }
  template <typename SnappedDestinationPositionsT = Aws::Vector<double>>
  CalculateRouteMatrixResult& AddSnappedDestinationPositions(SnappedDestinationPositionsT&& value) {
    m_snappedDestinationPositionsHasBeenSet = true;
    m_snappedDestinationPositions.emplace_back(std::forward<SnappedDestinationPositionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SummaryT = CalculateRouteMatrixSummary>
  CalculateRouteMatrixResult& WithSummary(SummaryT&& value) {
