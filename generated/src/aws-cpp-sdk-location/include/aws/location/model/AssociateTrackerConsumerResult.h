...
namespace Model
{
  ...
  {
  public:
    AWS_LOCATIONSERVICE_API AssociateTrackerConsumerResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateTrackerConsumerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
