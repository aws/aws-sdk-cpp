...
namespace Model
{
  ...
  public:
    ...
    inline AssociateTrackerConsumerResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateTrackerConsumerResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateTrackerConsumerResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
