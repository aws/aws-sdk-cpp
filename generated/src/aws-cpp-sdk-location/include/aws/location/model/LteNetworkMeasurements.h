...
class LteNetworkMeasurements {
 public:
  ...
  inline LteNetworkMeasurements& WithEarfcn(int value) {
    SetEarfcn(value);
    return *this;
  }
  ///@}
  ...
  inline LteNetworkMeasurements& WithCellId(int value) {
    SetCellId(value);
    return *this;
  }
  ///@}
  ...
  inline LteNetworkMeasurements& WithPci(int value) {
    SetPci(value);
    return *this;
  }
  ///@}
  ...
  inline LteNetworkMeasurements& WithRsrp(int value) {
    SetRsrp(value);
    return *this;
  }
  ///@}
  ...
  inline LteNetworkMeasurements& WithRsrq(double value) {
    SetRsrq(value);
    return *this;
  }
  ///@}
