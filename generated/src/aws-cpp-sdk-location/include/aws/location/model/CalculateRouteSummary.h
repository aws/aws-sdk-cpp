...
class CalculateRouteSummary {
 public:
  ...
  void SetRouteBBox(RouteBBoxT&& value) {
    ...
    m_routeBBox = std::forward<RouteBBoxT>(value);
  }
  template <typename RouteBBoxT = Aws::Vector<double>>
  CalculateRouteSummary& WithRouteBBox(RouteBBoxT&& value) {
    SetRouteBBox(std::forward<RouteBBoxT>(value));
    return *this;
  }
  inline CalculateRouteSummary& AddRouteBBox(double value) {
    m_routeBBoxHasBeenSet = true;
    m_routeBBox.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline CalculateRouteSummary& WithDistance(double value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline CalculateRouteSummary& WithDurationSeconds(double value) {
  ...
  inline CalculateRouteSummary& WithDistanceUnit(DistanceUnit value) {
