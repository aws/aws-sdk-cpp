...
class CalculateRouteRequest : public LocationServiceRequest {
 public:
  ...
  void SetDeparturePosition(DeparturePositionT&& value) {
    m_departurePositionHasBeenSet = true;
    m_departurePosition = std::forward<DeparturePositionT>(value);
  }
  template <typename DeparturePositionT = Aws::Vector<double>>
  CalculateRouteRequest& WithDeparturePosition(DeparturePositionT&& value) {
    SetDeparturePosition(std::forward<DeparturePositionT>(value));
    return *this;
  }
  inline CalculateRouteRequest& AddDeparturePosition(double value) {
    m_departurePositionHasBeenSet = true;
    m_departurePosition.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetDestinationPosition(DestinationPositionT&& value) {
    m_destinationPositionHasBeenSet = true;
    m_destinationPosition = std::forward<DestinationPositionT>(value);
  }
  template <typename DestinationPositionT = Aws::Vector<double>>
  CalculateRouteRequest& WithDestinationPosition(DestinationPositionT&& value) {
    SetDestinationPosition(std::forward<DestinationPositionT>(value));
    return *this;
  }
  inline CalculateRouteRequest& AddDestinationPosition(double value) {
    m_destinationPositionHasBeenSet = true;
    m_destinationPosition.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetWaypointPositions(WaypointPositionsT&& value) {
    m_waypointPositionsHasBeenSet = true;
    m_waypointPositions = std::forward<WaypointPositionsT>(value);
  }
  template <typename WaypointPositionsT = Aws::Vector<Aws::Vector<double>>>
  CalculateRouteRequest& WithWaypointPositions(WaypointPositionsT&& value) {
    SetWaypointPositions(std::forward<WaypointPositionsT>(value));
    return *this;
  }
  ...
  CalculateRouteRequest& AddWaypointPositions(WaypointPositionsT&& value) {
    m_waypointPositionsHasBeenSet = true;
    m_waypointPositions.emplace_back(std::forward<WaypointPositionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CalculateRouteRequest& WithTravelMode(TravelMode value) {
    SetTravelMode(value);
    return *this;
  }
  ///@}
  ...
  inline CalculateRouteRequest& WithDepartNow(bool value) {
    SetDepartNow(value);
    return *this;
  }
  ///@}
  ...
  inline CalculateRouteRequest& WithDistanceUnit(DistanceUnit value) {
  ...
  inline void SetIncludeLegGeometry(bool value) {
    m_includeLegGeometryHasBeenSet = true;
    m_includeLegGeometry = value;
  }
  inline CalculateRouteRequest& WithIncludeLegGeometry(bool value) {
    SetIncludeLegGeometry(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOptimizeFor(OptimizationMode value) {
    m_optimizeForHasBeenSet = true;
    m_optimizeFor = value;
  }
  inline CalculateRouteRequest& WithOptimizeFor(OptimizationMode value) {
