...
class ListRouteCalculatorsResponseEntry {
 public:
  ...
  template <typename CalculatorNameT = Aws::String>
  ListRouteCalculatorsResponseEntry& WithCalculatorName(CalculatorNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ListRouteCalculatorsResponseEntry& WithDescription(DescriptionT&& value) {
  ...
  template <typename DataSourceT = Aws::String>
  ListRouteCalculatorsResponseEntry& WithDataSource(DataSourceT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  ListRouteCalculatorsResponseEntry& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  ListRouteCalculatorsResponseEntry& WithUpdateTime(UpdateTimeT&& value) {
