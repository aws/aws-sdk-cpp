...
class Step {
 public:
  ...
  inline Step& AddStartPosition(double value) {
    m_startPositionHasBeenSet = true;
    m_startPosition.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline Step& AddEndPosition(double value) {
    m_endPositionHasBeenSet = true;
    m_endPosition.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline Step& WithDistance(double value) {
    SetDistance(value);
    return *this;
  }
  ///@}
  ...
  inline Step& WithDurationSeconds(double value) {
  ...
  inline Step& WithGeometryOffset(int value) {
