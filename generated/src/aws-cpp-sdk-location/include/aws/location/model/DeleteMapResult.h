...
namespace Model
{
  ...
  public:
    ...
    inline DeleteMapResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteMapResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteMapResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
