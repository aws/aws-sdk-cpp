...
class SearchPlaceIndexForSuggestionsSummary {
 public:
  ...
  template <typename TextT = Aws::String>
  SearchPlaceIndexForSuggestionsSummary& WithText(TextT&& value) {
  ...
  template <typename BiasPositionT = Aws::Vector<double>>
  SearchPlaceIndexForSuggestionsSummary& WithBiasPosition(BiasPositionT&& value) {
    SetBiasPosition(std::forward<BiasPositionT>(value));
    return *this;
  }
  inline SearchPlaceIndexForSuggestionsSummary& AddBiasPosition(double value) {
    m_biasPositionHasBeenSet = true;
  ...
  template <typename FilterBBoxT = Aws::Vector<double>>
  SearchPlaceIndexForSuggestionsSummary& WithFilterBBox(FilterBBoxT&& value) {
    SetFilterBBox(std::forward<FilterBBoxT>(value));
    return *this;
  }
  inline SearchPlaceIndexForSuggestionsSummary& AddFilterBBox(double value) {
    m_filterBBoxHasBeenSet = true;
  ...
  template <typename FilterCountriesT = Aws::Vector<Aws::String>>
  SearchPlaceIndexForSuggestionsSummary& WithFilterCountries(FilterCountriesT&& value) {
    SetFilterCountries(std::forward<FilterCountriesT>(value));
    return *this;
  }
  template <typename FilterCountriesT = Aws::String>
  SearchPlaceIndexForSuggestionsSummary& AddFilterCountries(FilterCountriesT&& value) {
    m_filterCountriesHasBeenSet = true;
  ...
  inline SearchPlaceIndexForSuggestionsSummary& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename DataSourceT = Aws::String>
  SearchPlaceIndexForSuggestionsSummary& WithDataSource(DataSourceT&& value) {
  ...
  template <typename LanguageT = Aws::String>
  SearchPlaceIndexForSuggestionsSummary& WithLanguage(LanguageT&& value) {
  ...
  template <typename FilterCategoriesT = Aws::Vector<Aws::String>>
  SearchPlaceIndexForSuggestionsSummary& WithFilterCategories(FilterCategoriesT&& value) {
    SetFilterCategories(std::forward<FilterCategoriesT>(value));
    return *this;
  }
  template <typename FilterCategoriesT = Aws::String>
  SearchPlaceIndexForSuggestionsSummary& AddFilterCategories(FilterCategoriesT&& value) {
    m_filterCategoriesHasBeenSet = true;
