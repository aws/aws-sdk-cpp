...
class SearchPlaceIndexForSuggestionsRequest : public LocationServiceRequest {
 public:
  ...
  template <typename IndexNameT = Aws::String>
  SearchPlaceIndexForSuggestionsRequest& WithIndexName(IndexNameT&& value) {
  ...
  template <typename TextT = Aws::String>
  SearchPlaceIndexForSuggestionsRequest& WithText(TextT&& value) {
  ...
  template <typename BiasPositionT = Aws::Vector<double>>
  SearchPlaceIndexForSuggestionsRequest& WithBiasPosition(BiasPositionT&& value) {
    SetBiasPosition(std::forward<BiasPositionT>(value));
    return *this;
  }
  inline SearchPlaceIndexForSuggestionsRequest& AddBiasPosition(double value) {
    m_biasPositionHasBeenSet = true;
  ...
  template <typename FilterBBoxT = Aws::Vector<double>>
  SearchPlaceIndexForSuggestionsRequest& WithFilterBBox(FilterBBoxT&& value) {
    SetFilterBBox(std::forward<FilterBBoxT>(value));
    return *this;
  }
  inline SearchPlaceIndexForSuggestionsRequest& AddFilterBBox(double value) {
    m_filterBBoxHasBeenSet = true;
  ...
  template <typename FilterCountriesT = Aws::Vector<Aws::String>>
  SearchPlaceIndexForSuggestionsRequest& WithFilterCountries(FilterCountriesT&& value) {
    SetFilterCountries(std::forward<FilterCountriesT>(value));
    return *this;
  }
  template <typename FilterCountriesT = Aws::String>
  SearchPlaceIndexForSuggestionsRequest& AddFilterCountries(FilterCountriesT&& value) {
    m_filterCountriesHasBeenSet = true;
  ...
  inline SearchPlaceIndexForSuggestionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename LanguageT = Aws::String>
  SearchPlaceIndexForSuggestionsRequest& WithLanguage(LanguageT&& value) {
  ...
  template <typename FilterCategoriesT = Aws::Vector<Aws::String>>
  SearchPlaceIndexForSuggestionsRequest& WithFilterCategories(FilterCategoriesT&& value) {
    SetFilterCategories(std::forward<FilterCategoriesT>(value));
    return *this;
  }
  template <typename FilterCategoriesT = Aws::String>
  SearchPlaceIndexForSuggestionsRequest& AddFilterCategories(FilterCategoriesT&& value) {
    m_filterCategoriesHasBeenSet = true;
  ...
  template <typename KeyT = Aws::String>
  SearchPlaceIndexForSuggestionsRequest& WithKey(KeyT&& value) {
