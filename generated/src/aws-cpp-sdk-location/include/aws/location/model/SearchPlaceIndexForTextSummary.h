...
namespace Model
{
  ...
  public:
     ...
     * <p>The optional category filter specified in the request.</p>
     */
    inline SearchPlaceIndexForTextSummary& WithFilterCategories(const Aws::Vector<Aws::String>& value) { SetFilterCategories(value); return *this;}

    /**
     * <p>The optional category filter specified in the request.</p>
     */
    inline SearchPlaceIndexForTextSummary& WithFilterCategories(Aws::Vector<Aws::String>&& value) { SetFilterCategories(std::move(value)); return *this;}
