...
class SearchPlaceIndexForTextSummary {
 public:
  ...
  template <typename TextT = Aws::String>
  SearchPlaceIndexForTextSummary& WithText(TextT&& value) {
  ...
  template <typename BiasPositionT = Aws::Vector<double>>
  SearchPlaceIndexForTextSummary& WithBiasPosition(BiasPositionT&& value) {
    SetBiasPosition(std::forward<BiasPositionT>(value));
    return *this;
  }
  inline SearchPlaceIndexForTextSummary& AddBiasPosition(double value) {
    m_biasPositionHasBeenSet = true;
  ...
  template <typename FilterBBoxT = Aws::Vector<double>>
  SearchPlaceIndexForTextSummary& WithFilterBBox(FilterBBoxT&& value) {
    SetFilterBBox(std::forward<FilterBBoxT>(value));
    return *this;
  }
  inline SearchPlaceIndexForTextSummary& AddFilterBBox(double value) {
    m_filterBBoxHasBeenSet = true;
  ...
  template <typename FilterCountriesT = Aws::Vector<Aws::String>>
  SearchPlaceIndexForTextSummary& WithFilterCountries(FilterCountriesT&& value) {
    SetFilterCountries(std::forward<FilterCountriesT>(value));
    return *this;
  }
  template <typename FilterCountriesT = Aws::String>
  SearchPlaceIndexForTextSummary& AddFilterCountries(FilterCountriesT&& value) {
    m_filterCountriesHasBeenSet = true;
  ...
  inline SearchPlaceIndexForTextSummary& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetResultBBox(ResultBBoxT&& value) {
    m_resultBBoxHasBeenSet = true;
    m_resultBBox = std::forward<ResultBBoxT>(value);
  }
  template <typename ResultBBoxT = Aws::Vector<double>>
  SearchPlaceIndexForTextSummary& WithResultBBox(ResultBBoxT&& value) {
    SetResultBBox(std::forward<ResultBBoxT>(value));
    return *this;
  }
  inline SearchPlaceIndexForTextSummary& AddResultBBox(double value) {
    m_resultBBoxHasBeenSet = true;
    m_resultBBox.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename DataSourceT = Aws::String>
  SearchPlaceIndexForTextSummary& WithDataSource(DataSourceT&& value) {
  ...
  template <typename LanguageT = Aws::String>
  SearchPlaceIndexForTextSummary& WithLanguage(LanguageT&& value) {
  ...
  template <typename FilterCategoriesT = Aws::Vector<Aws::String>>
  SearchPlaceIndexForTextSummary& WithFilterCategories(FilterCategoriesT&& value) {
    SetFilterCategories(std::forward<FilterCategoriesT>(value));
    return *this;
  }
  template <typename FilterCategoriesT = Aws::String>
  SearchPlaceIndexForTextSummary& AddFilterCategories(FilterCategoriesT&& value) {
    m_filterCategoriesHasBeenSet = true;
