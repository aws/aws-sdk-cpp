...
class LteCellDetails {
 public:
  ...
  inline void SetCellId(int value) {
    m_cellIdHasBeenSet = true;
    m_cellId = value;
  }
  inline LteCellDetails& WithCellId(int value) {
    SetCellId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMcc(int value) {
    m_mccHasBeenSet = true;
    m_mcc = value;
  }
  inline LteCellDetails& WithMcc(int value) {
    SetMcc(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMnc(int value) {
    m_mncHasBeenSet = true;
    m_mnc = value;
  }
  inline LteCellDetails& WithMnc(int value) {
    SetMnc(value);
    return *this;
  }
  ///@}
  ...
  void SetLocalId(LocalIdT&& value) {
    ...
    m_localId = std::forward<LocalIdT>(value);
  }
  template <typename LocalIdT = LteLocalId>
  LteCellDetails& WithLocalId(LocalIdT&& value) {
    SetLocalId(std::forward<LocalIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkMeasurements(NetworkMeasurementsT&& value) {
    ...
    m_networkMeasurements = std::forward<NetworkMeasurementsT>(value);
  }
  template <typename NetworkMeasurementsT = Aws::Vector<LteNetworkMeasurements>>
  LteCellDetails& WithNetworkMeasurements(NetworkMeasurementsT&& value) {
    SetNetworkMeasurements(std::forward<NetworkMeasurementsT>(value));
    return *this;
  }
  ...
  LteCellDetails& AddNetworkMeasurements(NetworkMeasurementsT&& value) {
    m_networkMeasurementsHasBeenSet = true;
    m_networkMeasurements.emplace_back(std::forward<NetworkMeasurementsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTimingAdvance(int value) {
    m_timingAdvanceHasBeenSet = true;
    m_timingAdvance = value;
  }
  inline LteCellDetails& WithTimingAdvance(int value) {
    SetTimingAdvance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNrCapable(bool value) {
    m_nrCapableHasBeenSet = true;
    m_nrCapable = value;
  }
  inline LteCellDetails& WithNrCapable(bool value) {
    SetNrCapable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRsrp(int value) {
    m_rsrpHasBeenSet = true;
    m_rsrp = value;
  }
  inline LteCellDetails& WithRsrp(int value) {
    SetRsrp(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRsrq(double value) {
    m_rsrqHasBeenSet = true;
    m_rsrq = value;
  }
  inline LteCellDetails& WithRsrq(double value) {
    SetRsrq(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTac(int value) {
    m_tacHasBeenSet = true;
    m_tac = value;
  }
  inline LteCellDetails& WithTac(int value) {
    SetTac(value);
    return *this;
  }
  ///@}
