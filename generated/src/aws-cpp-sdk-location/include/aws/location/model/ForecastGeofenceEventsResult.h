...
class ForecastGeofenceEventsResult {
 public:
  ...
  void SetForecastedEvents(ForecastedEventsT&& value) {
    ...
    m_forecastedEvents = std::forward<ForecastedEventsT>(value);
  }
  template <typename ForecastedEventsT = Aws::Vector<ForecastedEvent>>
  ForecastGeofenceEventsResult& WithForecastedEvents(ForecastedEventsT&& value) {
    SetForecastedEvents(std::forward<ForecastedEventsT>(value));
    return *this;
  }
  ...
  ForecastGeofenceEventsResult& AddForecastedEvents(ForecastedEventsT&& value) {
    m_forecastedEventsHasBeenSet = true;
    m_forecastedEvents.emplace_back(std::forward<ForecastedEventsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ForecastGeofenceEventsResult& WithDistanceUnit(DistanceUnit value) {
  ...
  inline void SetSpeedUnit(SpeedUnit value) {
    m_speedUnitHasBeenSet = true;
    m_speedUnit = value;
  }
  inline ForecastGeofenceEventsResult& WithSpeedUnit(SpeedUnit value) {
    SetSpeedUnit(value);
    return *this;
  }
  ///@}
