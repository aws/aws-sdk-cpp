...
class ListGeofencesResult {
 public:
  ...
  template <typename EntriesT = Aws::Vector<ListGeofenceResponseEntry>>
  ListGeofencesResult& WithEntries(EntriesT&& value) {
    SetEntries(std::forward<EntriesT>(value));
    return *this;
  }
  template <typename EntriesT = ListGeofenceResponseEntry>
  ListGeofencesResult& AddEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListGeofencesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListGeofencesResult& WithRequestId(RequestIdT&& value) {
