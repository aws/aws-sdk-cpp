...
class BatchDeleteDevicePositionHistoryResult {
 public:
  ...
  AWS_LOCATIONSERVICE_API BatchDeleteDevicePositionHistoryResult& operator=(
  ...
  template <typename ErrorsT = Aws::Vector<BatchDeleteDevicePositionHistoryError>>
  BatchDeleteDevicePositionHistoryResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchDeleteDevicePositionHistoryError>
  BatchDeleteDevicePositionHistoryResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteDevicePositionHistoryResult& WithRequestId(RequestIdT&& value) {
