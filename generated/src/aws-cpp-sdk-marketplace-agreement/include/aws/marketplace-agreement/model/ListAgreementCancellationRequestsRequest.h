...
/**
 */
class ListAgreementCancellationRequestsRequest : public AgreementServiceRequest {
 public:
  AWS_AGREEMENTSERVICE_API ListAgreementCancellationRequestsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListAgreementCancellationRequests"; }
  ...
  ///@{
  /**
   * <p>The party type for the cancellation requests. Required parameter. Use
   * <code>Proposer</code> to list cancellation requests where you are the seller, or
   * <code>Acceptor</code> to list cancellation requests where you are the buyer.</p>
   */
  ...
  template <typename PartyTypeT = Aws::String>
  ListAgreementCancellationRequestsRequest& WithPartyType(PartyTypeT&& value) {
  ...
  ///@{
  /**
   * <p>An optional parameter to filter cancellation requests for a specific
   * agreement.</p>
   */
  ...
  template <typename AgreementIdT = Aws::String>
  ListAgreementCancellationRequestsRequest& WithAgreementId(AgreementIdT&& value) {
  ...
  inline ListAgreementCancellationRequestsRequest& WithStatus(AgreementCancellationRequestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>An optional parameter to filter cancellation requests by agreement type
  ...
  template <typename AgreementTypeT = Aws::String>
  ListAgreementCancellationRequestsRequest& WithAgreementType(AgreementTypeT&& value) {
  ...
  ///@{
  /**
   * <p>An optional parameter to filter cancellation requests by catalog (e.g.,
  ...
  template <typename CatalogT = Aws::String>
  ListAgreementCancellationRequestsRequest& WithCatalog(CatalogT&& value) {
  ...
  inline ListAgreementCancellationRequestsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgreementCancellationRequestsRequest& WithNextToken(NextTokenT&& value) {
