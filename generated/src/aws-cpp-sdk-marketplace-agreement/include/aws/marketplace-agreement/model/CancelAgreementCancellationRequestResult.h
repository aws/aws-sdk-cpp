...
namespace Model {
class CancelAgreementCancellationRequestResult {
 public:
  AWS_AGREEMENTSERVICE_API CancelAgreementCancellationRequestResult() = default;
  AWS_AGREEMENTSERVICE_API CancelAgreementCancellationRequestResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_AGREEMENTSERVICE_API CancelAgreementCancellationRequestResult& operator=(
  ...
  template <typename AgreementCancellationRequestIdT = Aws::String>
  CancelAgreementCancellationRequestResult& WithAgreementCancellationRequestId(AgreementCancellationRequestIdT&& value) {
  ...
  template <typename AgreementIdT = Aws::String>
  CancelAgreementCancellationRequestResult& WithAgreementId(AgreementIdT&& value) {
  ...
  inline CancelAgreementCancellationRequestResult& WithReasonCode(AgreementCancellationRequestReasonCode value) {
    SetReasonCode(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The detailed description of the original cancellation reason, if
   * provided.</p>
   */
  ...
  template <typename DescriptionT = Aws::String>
  CancelAgreementCancellationRequestResult& WithDescription(DescriptionT&& value) {
  ...
  inline CancelAgreementCancellationRequestResult& WithStatus(AgreementCancellationRequestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  CancelAgreementCancellationRequestResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CancelAgreementCancellationRequestResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CancelAgreementCancellationRequestResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CancelAgreementCancellationRequestResult& WithRequestId(RequestIdT&& value) {
