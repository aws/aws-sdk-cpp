...
namespace Model {
class SendAgreementCancellationRequestResult {
 public:
  AWS_AGREEMENTSERVICE_API SendAgreementCancellationRequestResult() = default;
  AWS_AGREEMENTSERVICE_API SendAgreementCancellationRequestResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_AGREEMENTSERVICE_API SendAgreementCancellationRequestResult& operator=(
  ...
  template <typename AgreementIdT = Aws::String>
  SendAgreementCancellationRequestResult& WithAgreementId(AgreementIdT&& value) {
  ...
  template <typename AgreementCancellationRequestIdT = Aws::String>
  SendAgreementCancellationRequestResult& WithAgreementCancellationRequestId(AgreementCancellationRequestIdT&& value) {
  ...
  ///@{
  /**
   * <p>The current status of the cancellation request. The initial status is
  ...
  inline SendAgreementCancellationRequestResult& WithStatus(AgreementCancellationRequestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline SendAgreementCancellationRequestResult& WithReasonCode(AgreementCancellationRequestReasonCode value) {
    SetReasonCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  SendAgreementCancellationRequestResult& WithDescription(DescriptionT&& value) {
  ...
  ///@{
  /**
   * <p>The time when the cancellation request was created, as a POSIX timestamp
   * (Unix epoch seconds).</p>
   */
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  SendAgreementCancellationRequestResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  ///@{
  /**
   * <p>The time when the cancellation request was last updated, as a POSIX timestamp
   * (Unix epoch seconds).</p>
   */
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  SendAgreementCancellationRequestResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SendAgreementCancellationRequestResult& WithRequestId(RequestIdT&& value) {
