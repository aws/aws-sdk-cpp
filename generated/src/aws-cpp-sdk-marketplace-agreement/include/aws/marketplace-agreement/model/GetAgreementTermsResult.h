...
class GetAgreementTermsResult {
 public:
  ...
  void SetAcceptedTerms(AcceptedTermsT&& value) {
    m_acceptedTermsHasBeenSet = true;
    m_acceptedTerms = std::forward<AcceptedTermsT>(value);
  }
  template <typename AcceptedTermsT = Aws::Vector<AcceptedTerm>>
  GetAgreementTermsResult& WithAcceptedTerms(AcceptedTermsT&& value) {
    SetAcceptedTerms(std::forward<AcceptedTermsT>(value));
    return *this;
  }
  template <typename AcceptedTermsT = AcceptedTerm>
  GetAgreementTermsResult& AddAcceptedTerms(AcceptedTermsT&& value) {
    m_acceptedTermsHasBeenSet = true;
    m_acceptedTerms.emplace_back(std::forward<AcceptedTermsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetAgreementTermsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAgreementTermsResult& WithRequestId(RequestIdT&& value) {
