...
class Constraints {
 public:
  ...
  void SetMultipleDimensionSelection(MultipleDimensionSelectionT&& value) {
    ...
    m_multipleDimensionSelection = std::forward<MultipleDimensionSelectionT>(value);
  }
  template <typename MultipleDimensionSelectionT = Aws::String>
  Constraints& WithMultipleDimensionSelection(MultipleDimensionSelectionT&& value) {
    SetMultipleDimensionSelection(std::forward<MultipleDimensionSelectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQuantityConfiguration(QuantityConfigurationT&& value) {
    ...
    m_quantityConfiguration = std::forward<QuantityConfigurationT>(value);
  }
  template <typename QuantityConfigurationT = Aws::String>
  Constraints& WithQuantityConfiguration(QuantityConfigurationT&& value) {
    SetQuantityConfiguration(std::forward<QuantityConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
