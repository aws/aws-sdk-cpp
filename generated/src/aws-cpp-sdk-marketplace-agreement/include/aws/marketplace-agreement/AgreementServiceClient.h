...
namespace AgreementService
{
   ...
   */
  class AWS_AGREEMENTSERVICE_API AgreementServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<AgreementServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::AgreementService::SERVICE_NAME,
