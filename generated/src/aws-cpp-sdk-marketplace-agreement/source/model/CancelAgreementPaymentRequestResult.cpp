...
CancelAgreementPaymentRequestResult::CancelAgreementPaymentRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CancelAgreementPaymentRequestResult& CancelAgreementPaymentRequestResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
