...
GetAgreementPaymentRequestResult::GetAgreementPaymentRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetAgreementPaymentRequestResult& GetAgreementPaymentRequestResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
