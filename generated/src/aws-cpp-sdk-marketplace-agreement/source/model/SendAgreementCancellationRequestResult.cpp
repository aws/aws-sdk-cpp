...
SendAgreementCancellationRequestResult::SendAgreementCancellationRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

SendAgreementCancellationRequestResult& SendAgreementCancellationRequestResult::operator=(
