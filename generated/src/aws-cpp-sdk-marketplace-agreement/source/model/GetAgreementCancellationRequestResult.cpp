...
GetAgreementCancellationRequestResult::GetAgreementCancellationRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

GetAgreementCancellationRequestResult& GetAgreementCancellationRequestResult::operator=(
