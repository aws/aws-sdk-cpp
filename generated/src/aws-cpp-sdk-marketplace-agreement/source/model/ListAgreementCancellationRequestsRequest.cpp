...
Aws::String ListAgreementCancellationRequestsRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection ListAgreementCancellationRequestsRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AWSMPCommerceService_v20200301.ListAgreementCancellationRequests"));
  return headers;
}
