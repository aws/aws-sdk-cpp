...
SearchAgreementsResult::SearchAgreementsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
SearchAgreementsResult& SearchAgreementsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("agreementViewSummaries")) {
    ...
    for (unsigned agreementViewSummariesIndex = 0; agreementViewSummariesIndex < agreementViewSummariesJsonList.GetLength();
         ++agreementViewSummariesIndex) {
