...
Aws::String GetAgreementCancellationRequestRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection GetAgreementCancellationRequestRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AWSMPCommerceService_v20200301.GetAgreementCancellationRequest"));
  return headers;
}
