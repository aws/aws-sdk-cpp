...
{
const size_t KinesisAnalyticsV2EndpointRules::RulesBlobStrLen = 3764;
const size_t KinesisAnalyticsV2EndpointRules::RulesBlobSize = 3765;
...
't','t','p','s',':','/','/','k','i','n','e','s','i','s','a','n','a','l','y','t','i','c','s','.','{',
