...
ApplicationDetail::ApplicationDetail(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue ApplicationDetail::Jsonize() const {
  ...
  if (m_cloudWatchLoggingOptionDescriptionsHasBeenSet) {
    ...
    for (unsigned cloudWatchLoggingOptionDescriptionsIndex = 0;
         ...
         ++cloudWatchLoggingOptionDescriptionsIndex) {
      cloudWatchLoggingOptionDescriptionsJsonList[cloudWatchLoggingOptionDescriptionsIndex].AsObject(
          m_cloudWatchLoggingOptionDescriptions[cloudWatchLoggingOptionDescriptionsIndex].Jsonize());
    }
