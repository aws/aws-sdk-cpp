...
ZeppelinApplicationConfigurationUpdate::ZeppelinApplicationConfigurationUpdate(JsonView jsonValue) { *this = jsonValue; }
...
ZeppelinApplicationConfigurationUpdate& ZeppelinApplicationConfigurationUpdate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("CustomArtifactsConfigurationUpdate")) {
    ...
    for (unsigned customArtifactsConfigurationUpdateIndex = 0;
         customArtifactsConfigurationUpdateIndex < customArtifactsConfigurationUpdateJsonList.GetLength();
         ++customArtifactsConfigurationUpdateIndex) {
      m_customArtifactsConfigurationUpdate.push_back(
          customArtifactsConfigurationUpdateJsonList[customArtifactsConfigurationUpdateIndex].AsObject());
    }
...
JsonValue ZeppelinApplicationConfigurationUpdate::Jsonize() const {
  ...
  if (m_customArtifactsConfigurationUpdateHasBeenSet) {
    ...
    for (unsigned customArtifactsConfigurationUpdateIndex = 0;
         ...
         ++customArtifactsConfigurationUpdateIndex) {
      customArtifactsConfigurationUpdateJsonList[customArtifactsConfigurationUpdateIndex].AsObject(
          m_customArtifactsConfigurationUpdate[customArtifactsConfigurationUpdateIndex].Jsonize());
    }
