...
CreateApplicationPresignedUrlResult::CreateApplicationPresignedUrlResult()
{
}

CreateApplicationPresignedUrlResult::CreateApplicationPresignedUrlResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
