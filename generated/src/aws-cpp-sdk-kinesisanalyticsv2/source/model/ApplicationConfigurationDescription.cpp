...
ApplicationConfigurationDescription::ApplicationConfigurationDescription(JsonView jsonValue) { *this = jsonValue; }
...
ApplicationConfigurationDescription& ApplicationConfigurationDescription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("VpcConfigurationDescriptions")) {
    ...
    for (unsigned vpcConfigurationDescriptionsIndex = 0;
         vpcConfigurationDescriptionsIndex < vpcConfigurationDescriptionsJsonList.GetLength(); ++vpcConfigurationDescriptionsIndex) {
...
JsonValue ApplicationConfigurationDescription::Jsonize() const {
  ...
  if (m_vpcConfigurationDescriptionsHasBeenSet) {
    ...
    for (unsigned vpcConfigurationDescriptionsIndex = 0;
         vpcConfigurationDescriptionsIndex < vpcConfigurationDescriptionsJsonList.GetLength(); ++vpcConfigurationDescriptionsIndex) {
      vpcConfigurationDescriptionsJsonList[vpcConfigurationDescriptionsIndex].AsObject(
          m_vpcConfigurationDescriptions[vpcConfigurationDescriptionsIndex].Jsonize());
    }
