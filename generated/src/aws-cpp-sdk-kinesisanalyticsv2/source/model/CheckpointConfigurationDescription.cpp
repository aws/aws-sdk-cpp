...
CheckpointConfigurationDescription::CheckpointConfigurationDescription(JsonView jsonValue) { *this = jsonValue; }

CheckpointConfigurationDescription& CheckpointConfigurationDescription::operator=(JsonView jsonValue) {
...
JsonValue CheckpointConfigurationDescription::Jsonize() const {
  JsonValue payload;
