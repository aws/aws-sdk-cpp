...
SqlApplicationConfiguration::SqlApplicationConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
SqlApplicationConfiguration& SqlApplicationConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ReferenceDataSources")) {
    ...
    for (unsigned referenceDataSourcesIndex = 0; referenceDataSourcesIndex < referenceDataSourcesJsonList.GetLength();
         ++referenceDataSourcesIndex) {
