...
ApplicationConfigurationUpdate::ApplicationConfigurationUpdate(JsonView jsonValue) { *this = jsonValue; }
...
ApplicationConfigurationUpdate& ApplicationConfigurationUpdate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("VpcConfigurationUpdates")) {
    ...
    for (unsigned vpcConfigurationUpdatesIndex = 0; vpcConfigurationUpdatesIndex < vpcConfigurationUpdatesJsonList.GetLength();
         ++vpcConfigurationUpdatesIndex) {
...
JsonValue ApplicationConfigurationUpdate::Jsonize() const {
  ...
  if (m_vpcConfigurationUpdatesHasBeenSet) {
    ...
    for (unsigned vpcConfigurationUpdatesIndex = 0; vpcConfigurationUpdatesIndex < vpcConfigurationUpdatesJsonList.GetLength();
         ++vpcConfigurationUpdatesIndex) {
      vpcConfigurationUpdatesJsonList[vpcConfigurationUpdatesIndex].AsObject(
          m_vpcConfigurationUpdates[vpcConfigurationUpdatesIndex].Jsonize());
    }
