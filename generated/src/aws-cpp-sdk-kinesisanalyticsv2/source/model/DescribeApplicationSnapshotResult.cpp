...
DescribeApplicationSnapshotResult::DescribeApplicationSnapshotResult()
{
}

DescribeApplicationSnapshotResult::DescribeApplicationSnapshotResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
