...
ListApplicationVersionsResult::ListApplicationVersionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListApplicationVersionsResult& ListApplicationVersionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ApplicationVersionSummaries")) {
    ...
    for (unsigned applicationVersionSummariesIndex = 0; applicationVersionSummariesIndex < applicationVersionSummariesJsonList.GetLength();
         ++applicationVersionSummariesIndex) {
      m_applicationVersionSummaries.push_back(applicationVersionSummariesJsonList[applicationVersionSummariesIndex].AsObject());
    }
    m_applicationVersionSummariesHasBeenSet = true;
  }
