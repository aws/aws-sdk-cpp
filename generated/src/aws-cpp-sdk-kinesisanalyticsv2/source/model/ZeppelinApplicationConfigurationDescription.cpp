...
ZeppelinApplicationConfigurationDescription::ZeppelinApplicationConfigurationDescription(JsonView jsonValue) { *this = jsonValue; }
...
ZeppelinApplicationConfigurationDescription& ZeppelinApplicationConfigurationDescription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("CustomArtifactsConfigurationDescription")) {
    Aws::Utils::Array<JsonView> customArtifactsConfigurationDescriptionJsonList =
        jsonValue.GetArray("CustomArtifactsConfigurationDescription");
    for (unsigned customArtifactsConfigurationDescriptionIndex = 0;
         customArtifactsConfigurationDescriptionIndex < customArtifactsConfigurationDescriptionJsonList.GetLength();
         ++customArtifactsConfigurationDescriptionIndex) {
      m_customArtifactsConfigurationDescription.push_back(
          customArtifactsConfigurationDescriptionJsonList[customArtifactsConfigurationDescriptionIndex].AsObject());
    }
...
JsonValue ZeppelinApplicationConfigurationDescription::Jsonize() const {
  ...
  if (m_customArtifactsConfigurationDescriptionHasBeenSet) {
    ...
    for (unsigned customArtifactsConfigurationDescriptionIndex = 0;
         ...
         ++customArtifactsConfigurationDescriptionIndex) {
      customArtifactsConfigurationDescriptionJsonList[customArtifactsConfigurationDescriptionIndex].AsObject(
          m_customArtifactsConfigurationDescription[customArtifactsConfigurationDescriptionIndex].Jsonize());
    }
