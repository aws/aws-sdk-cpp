...
#define AWS_KINESISANALYTICSV2_EXTERN
#else
#define AWS_KINESISANALYTICSV2_API
#define AWS_KINESISANALYTICSV2_EXTERN extern
#endif  // USE_IMPORT_EXPORT
#define AWS_KINESISANALYTICSV2_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_KINESISANALYTICSV2_API
#define AWS_KINESISANALYTICSV2_EXTERN extern
#if __GNUC__ >= 4
#define AWS_KINESISANALYTICSV2_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_KINESISANALYTICSV2_LOCAL
#endif
