...
class ApplicationRestoreConfiguration {
 public:
  ...
  inline void SetApplicationRestoreType(ApplicationRestoreType value) {
    m_applicationRestoreTypeHasBeenSet = true;
    m_applicationRestoreType = value;
  }
  inline ApplicationRestoreConfiguration& WithApplicationRestoreType(ApplicationRestoreType value) {
    SetApplicationRestoreType(value);
    return *this;
  }
  ///@}
  ...
  template <typename SnapshotNameT = Aws::String>
  ApplicationRestoreConfiguration& WithSnapshotName(SnapshotNameT&& value) {
