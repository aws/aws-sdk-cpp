...
class CheckpointConfiguration {
 public:
  ...
  inline CheckpointConfiguration& WithConfigurationType(ConfigurationType value) {
  ...
  inline CheckpointConfiguration& WithCheckpointingEnabled(bool value) {
  ...
  inline CheckpointConfiguration& WithCheckpointInterval(long long value) {
   ...
   * href="https://nightlies.apache.org/flink/flink-docs-release-2.3/docs/ops/state/large_state_tuning/#tuning-checkpointing">
  ...
  inline CheckpointConfiguration& WithMinPauseBetweenCheckpoints(long long value) {
