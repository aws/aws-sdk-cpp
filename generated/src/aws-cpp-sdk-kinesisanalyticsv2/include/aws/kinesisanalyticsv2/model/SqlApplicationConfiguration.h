...
class SqlApplicationConfiguration {
 public:
  ...
  void SetReferenceDataSources(ReferenceDataSourcesT&& value) {
    ...
    m_referenceDataSources = std::forward<ReferenceDataSourcesT>(value);
  }
  template <typename ReferenceDataSourcesT = Aws::Vector<ReferenceDataSource>>
  SqlApplicationConfiguration& WithReferenceDataSources(ReferenceDataSourcesT&& value) {
    SetReferenceDataSources(std::forward<ReferenceDataSourcesT>(value));
    return *this;
  }
  ...
  SqlApplicationConfiguration& AddReferenceDataSources(ReferenceDataSourcesT&& value) {
    m_referenceDataSourcesHasBeenSet = true;
    m_referenceDataSources.emplace_back(std::forward<ReferenceDataSourcesT>(value));
    return *this;
  }
  ///@}
 private:
