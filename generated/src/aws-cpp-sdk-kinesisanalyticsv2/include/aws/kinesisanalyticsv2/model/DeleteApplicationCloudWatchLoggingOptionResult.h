...
class DeleteApplicationCloudWatchLoggingOptionResult {
 public:
  ...
  AWS_KINESISANALYTICSV2_API DeleteApplicationCloudWatchLoggingOptionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ApplicationARNT = Aws::String>
  DeleteApplicationCloudWatchLoggingOptionResult& WithApplicationARN(ApplicationARNT&& value) {
  ...
  inline DeleteApplicationCloudWatchLoggingOptionResult& WithApplicationVersionId(long long value) {
   ...
   * application.</p>
   */
  inline const Aws::Vector<CloudWatchLoggingOptionDescription>& GetCloudWatchLoggingOptionDescriptions() const {
    return m_cloudWatchLoggingOptionDescriptions;
  }
  ...
  void SetCloudWatchLoggingOptionDescriptions(CloudWatchLoggingOptionDescriptionsT&& value) {
    ...
    m_cloudWatchLoggingOptionDescriptions = std::forward<CloudWatchLoggingOptionDescriptionsT>(value);
  }
  template <typename CloudWatchLoggingOptionDescriptionsT = Aws::Vector<CloudWatchLoggingOptionDescription>>
  DeleteApplicationCloudWatchLoggingOptionResult& WithCloudWatchLoggingOptionDescriptions(CloudWatchLoggingOptionDescriptionsT&& value) {
    SetCloudWatchLoggingOptionDescriptions(std::forward<CloudWatchLoggingOptionDescriptionsT>(value));
    return *this;
  }
  template <typename CloudWatchLoggingOptionDescriptionsT = CloudWatchLoggingOptionDescription>
  DeleteApplicationCloudWatchLoggingOptionResult& AddCloudWatchLoggingOptionDescriptions(CloudWatchLoggingOptionDescriptionsT&& value) {
    m_cloudWatchLoggingOptionDescriptionsHasBeenSet = true;
    m_cloudWatchLoggingOptionDescriptions.emplace_back(std::forward<CloudWatchLoggingOptionDescriptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OperationIdT = Aws::String>
  DeleteApplicationCloudWatchLoggingOptionResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteApplicationCloudWatchLoggingOptionResult& WithRequestId(RequestIdT&& value) {
