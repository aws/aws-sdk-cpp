...
namespace Model
{
  ...
  /**
   * <p>Describes the encryption at rest configuration.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/ApplicationEncryptionConfigurationDescription">AWS
   * API Reference</a></p>
   */
  class ApplicationEncryptionConfigurationDescription
  {
  public:
    AWS_KINESISANALYTICSV2_API ApplicationEncryptionConfigurationDescription() = default;
    ...
    template<typename KeyIdT = Aws::String>
    ApplicationEncryptionConfigurationDescription& WithKeyId(KeyIdT&& value) { SetKeyId(std::forward<KeyIdT>(value)); return *this;}
    ///@}
    ...
    inline ApplicationEncryptionConfigurationDescription& WithKeyType(KeyType value) { SetKeyType(value); return *this;}
    ///@}
  private:
