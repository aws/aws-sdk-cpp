...
class ListApplicationVersionsRequest : public KinesisAnalyticsV2Request {
 public:
  AWS_KINESISANALYTICSV2_API ListApplicationVersionsRequest() = default;
  ...
  template <typename ApplicationNameT = Aws::String>
  ListApplicationVersionsRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  inline ListApplicationVersionsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationVersionsRequest& WithNextToken(NextTokenT&& value) {
