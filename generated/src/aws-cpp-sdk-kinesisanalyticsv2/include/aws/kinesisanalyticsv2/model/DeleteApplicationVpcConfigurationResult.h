...
class DeleteApplicationVpcConfigurationResult {
 public:
  ...
  AWS_KINESISANALYTICSV2_API DeleteApplicationVpcConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ApplicationARNT = Aws::String>
  DeleteApplicationVpcConfigurationResult& WithApplicationARN(ApplicationARNT&& value) {
  ...
  inline DeleteApplicationVpcConfigurationResult& WithApplicationVersionId(long long value) {
  ...
  template <typename OperationIdT = Aws::String>
  DeleteApplicationVpcConfigurationResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteApplicationVpcConfigurationResult& WithRequestId(RequestIdT&& value) {
