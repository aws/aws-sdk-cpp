...
class InputLambdaProcessorDescription {
 public:
  AWS_KINESISANALYTICSV2_API InputLambdaProcessorDescription() = default;
  ...
  template <typename ResourceARNT = Aws::String>
  InputLambdaProcessorDescription& WithResourceARN(ResourceARNT&& value) {
  ...
  template <typename RoleARNT = Aws::String>
  InputLambdaProcessorDescription& WithRoleARN(RoleARNT&& value) {
