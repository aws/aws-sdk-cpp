...
class UpdateApplicationMaintenanceConfigurationRequest : public KinesisAnalyticsV2Request {
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  UpdateApplicationMaintenanceConfigurationRequest& WithApplicationName(ApplicationNameT&& value) {
   ...
   */
  inline const ApplicationMaintenanceConfigurationUpdate& GetApplicationMaintenanceConfigurationUpdate() const {
    return m_applicationMaintenanceConfigurationUpdate;
  }
  ...
  void SetApplicationMaintenanceConfigurationUpdate(ApplicationMaintenanceConfigurationUpdateT&& value) {
    m_applicationMaintenanceConfigurationUpdateHasBeenSet = true;
    m_applicationMaintenanceConfigurationUpdate = std::forward<ApplicationMaintenanceConfigurationUpdateT>(value);
  }
  template <typename ApplicationMaintenanceConfigurationUpdateT = ApplicationMaintenanceConfigurationUpdate>
  UpdateApplicationMaintenanceConfigurationRequest& WithApplicationMaintenanceConfigurationUpdate(
      ApplicationMaintenanceConfigurationUpdateT&& value) {
    SetApplicationMaintenanceConfigurationUpdate(std::forward<ApplicationMaintenanceConfigurationUpdateT>(value));
    return *this;
  }
  ///@}
 private:
