...
class SqlApplicationConfigurationUpdate {
 public:
  ...
  void SetReferenceDataSourceUpdates(ReferenceDataSourceUpdatesT&& value) {
    ...
    m_referenceDataSourceUpdates = std::forward<ReferenceDataSourceUpdatesT>(value);
  }
  template <typename ReferenceDataSourceUpdatesT = Aws::Vector<ReferenceDataSourceUpdate>>
  SqlApplicationConfigurationUpdate& WithReferenceDataSourceUpdates(ReferenceDataSourceUpdatesT&& value) {
    SetReferenceDataSourceUpdates(std::forward<ReferenceDataSourceUpdatesT>(value));
    return *this;
  }
  ...
  SqlApplicationConfigurationUpdate& AddReferenceDataSourceUpdates(ReferenceDataSourceUpdatesT&& value) {
    m_referenceDataSourceUpdatesHasBeenSet = true;
    m_referenceDataSourceUpdates.emplace_back(std::forward<ReferenceDataSourceUpdatesT>(value));
    return *this;
  }
  ///@}
 private:
