...
class CheckpointConfigurationUpdate {
 public:
  ...
  inline CheckpointConfigurationUpdate& WithConfigurationTypeUpdate(ConfigurationType value) {
  ...
  inline void SetCheckpointingEnabledUpdate(bool value) {
    m_checkpointingEnabledUpdateHasBeenSet = true;
    m_checkpointingEnabledUpdate = value;
  }
  inline CheckpointConfigurationUpdate& WithCheckpointingEnabledUpdate(bool value) {
    SetCheckpointingEnabledUpdate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCheckpointIntervalUpdate(long long value) {
    m_checkpointIntervalUpdateHasBeenSet = true;
    m_checkpointIntervalUpdate = value;
  }
  inline CheckpointConfigurationUpdate& WithCheckpointIntervalUpdate(long long value) {
    SetCheckpointIntervalUpdate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinPauseBetweenCheckpointsUpdate(long long value) {
    m_minPauseBetweenCheckpointsUpdateHasBeenSet = true;
    m_minPauseBetweenCheckpointsUpdate = value;
  }
  inline CheckpointConfigurationUpdate& WithMinPauseBetweenCheckpointsUpdate(long long value) {
    SetMinPauseBetweenCheckpointsUpdate(value);
    return *this;
  }
  ///@}
 private:
