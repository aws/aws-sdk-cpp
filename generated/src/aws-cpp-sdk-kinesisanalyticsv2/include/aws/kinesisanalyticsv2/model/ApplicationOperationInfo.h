...
class ApplicationOperationInfo {
 public:
  ...
  template <typename OperationT = Aws::String>
  ApplicationOperationInfo& WithOperation(OperationT&& value) {
  ...
  template <typename OperationIdT = Aws::String>
  ApplicationOperationInfo& WithOperationId(OperationIdT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ApplicationOperationInfo& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ApplicationOperationInfo& WithEndTime(EndTimeT&& value) {
  ...
  inline ApplicationOperationInfo& WithOperationStatus(OperationStatus value) {
