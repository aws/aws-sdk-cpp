...
class RunConfigurationUpdate {
 public:
  ...
  void SetFlinkRunConfiguration(FlinkRunConfigurationT&& value) {
    ...
    m_flinkRunConfiguration = std::forward<FlinkRunConfigurationT>(value);
  }
  template <typename FlinkRunConfigurationT = FlinkRunConfiguration>
  RunConfigurationUpdate& WithFlinkRunConfiguration(FlinkRunConfigurationT&& value) {
    SetFlinkRunConfiguration(std::forward<FlinkRunConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationRestoreConfiguration(ApplicationRestoreConfigurationT&& value) {
    ...
    m_applicationRestoreConfiguration = std::forward<ApplicationRestoreConfigurationT>(value);
  }
  template <typename ApplicationRestoreConfigurationT = ApplicationRestoreConfiguration>
  RunConfigurationUpdate& WithApplicationRestoreConfiguration(ApplicationRestoreConfigurationT&& value) {
    SetApplicationRestoreConfiguration(std::forward<ApplicationRestoreConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
