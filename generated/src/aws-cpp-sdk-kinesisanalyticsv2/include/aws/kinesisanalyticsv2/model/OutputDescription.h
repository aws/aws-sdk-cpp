...
class OutputDescription {
 public:
  ...
  void SetKinesisStreamsOutputDescription(KinesisStreamsOutputDescriptionT&& value) {
    ...
    m_kinesisStreamsOutputDescription = std::forward<KinesisStreamsOutputDescriptionT>(value);
  }
  template <typename KinesisStreamsOutputDescriptionT = KinesisStreamsOutputDescription>
  OutputDescription& WithKinesisStreamsOutputDescription(KinesisStreamsOutputDescriptionT&& value) {
    SetKinesisStreamsOutputDescription(std::forward<KinesisStreamsOutputDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKinesisFirehoseOutputDescription(KinesisFirehoseOutputDescriptionT&& value) {
    ...
    m_kinesisFirehoseOutputDescription = std::forward<KinesisFirehoseOutputDescriptionT>(value);
  }
  template <typename KinesisFirehoseOutputDescriptionT = KinesisFirehoseOutputDescription>
  OutputDescription& WithKinesisFirehoseOutputDescription(KinesisFirehoseOutputDescriptionT&& value) {
    SetKinesisFirehoseOutputDescription(std::forward<KinesisFirehoseOutputDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLambdaOutputDescription(LambdaOutputDescriptionT&& value) {
    ...
    m_lambdaOutputDescription = std::forward<LambdaOutputDescriptionT>(value);
  }
  template <typename LambdaOutputDescriptionT = LambdaOutputDescription>
  OutputDescription& WithLambdaOutputDescription(LambdaOutputDescriptionT&& value) {
    SetLambdaOutputDescription(std::forward<LambdaOutputDescriptionT>(value));
    return *this;
  }
  ///@}
