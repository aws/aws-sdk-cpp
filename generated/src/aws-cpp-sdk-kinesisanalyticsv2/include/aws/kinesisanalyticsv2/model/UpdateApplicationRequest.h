...
class UpdateApplicationRequest : public KinesisAnalyticsV2Request {
 public:
  ...
  void SetApplicationConfigurationUpdate(ApplicationConfigurationUpdateT&& value) {
    m_applicationConfigurationUpdateHasBeenSet = true;
    m_applicationConfigurationUpdate = std::forward<ApplicationConfigurationUpdateT>(value);
  }
  template <typename ApplicationConfigurationUpdateT = ApplicationConfigurationUpdate>
  UpdateApplicationRequest& WithApplicationConfigurationUpdate(ApplicationConfigurationUpdateT&& value) {
    SetApplicationConfigurationUpdate(std::forward<ApplicationConfigurationUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceExecutionRoleUpdate(ServiceExecutionRoleUpdateT&& value) {
    m_serviceExecutionRoleUpdateHasBeenSet = true;
    m_serviceExecutionRoleUpdate = std::forward<ServiceExecutionRoleUpdateT>(value);
  }
  template <typename ServiceExecutionRoleUpdateT = Aws::String>
  UpdateApplicationRequest& WithServiceExecutionRoleUpdate(ServiceExecutionRoleUpdateT&& value) {
    SetServiceExecutionRoleUpdate(std::forward<ServiceExecutionRoleUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRunConfigurationUpdate(RunConfigurationUpdateT&& value) {
    m_runConfigurationUpdateHasBeenSet = true;
    m_runConfigurationUpdate = std::forward<RunConfigurationUpdateT>(value);
  }
  template <typename RunConfigurationUpdateT = RunConfigurationUpdate>
  UpdateApplicationRequest& WithRunConfigurationUpdate(RunConfigurationUpdateT&& value) {
    SetRunConfigurationUpdate(std::forward<RunConfigurationUpdateT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<CloudWatchLoggingOptionUpdate>& GetCloudWatchLoggingOptionUpdates() const {
    return m_cloudWatchLoggingOptionUpdates;
  }
  ...
  void SetCloudWatchLoggingOptionUpdates(CloudWatchLoggingOptionUpdatesT&& value) {
    ...
    m_cloudWatchLoggingOptionUpdates = std::forward<CloudWatchLoggingOptionUpdatesT>(value);
  }
  template <typename CloudWatchLoggingOptionUpdatesT = Aws::Vector<CloudWatchLoggingOptionUpdate>>
  UpdateApplicationRequest& WithCloudWatchLoggingOptionUpdates(CloudWatchLoggingOptionUpdatesT&& value) {
    SetCloudWatchLoggingOptionUpdates(std::forward<CloudWatchLoggingOptionUpdatesT>(value));
    return *this;
  }
  ...
  UpdateApplicationRequest& AddCloudWatchLoggingOptionUpdates(CloudWatchLoggingOptionUpdatesT&& value) {
    m_cloudWatchLoggingOptionUpdatesHasBeenSet = true;
    m_cloudWatchLoggingOptionUpdates.emplace_back(std::forward<CloudWatchLoggingOptionUpdatesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRuntimeEnvironmentUpdate(RuntimeEnvironment value) {
    m_runtimeEnvironmentUpdateHasBeenSet = true;
    m_runtimeEnvironmentUpdate = value;
  }
  inline UpdateApplicationRequest& WithRuntimeEnvironmentUpdate(RuntimeEnvironment value) {
    SetRuntimeEnvironmentUpdate(value);
    return *this;
  }
  ///@}
 private:
