 ...
 * see <a
 * href="https://nightlies.apache.org/flink/flink-docs-release-2.3/dev/parallel.html">Parallel
...
class ParallelismConfiguration {
 public:
  ...
  inline ParallelismConfiguration& WithConfigurationType(ConfigurationType value) {
  ...
  inline ParallelismConfiguration& WithParallelism(int value) {
  ...
  inline ParallelismConfiguration& WithParallelismPerKPU(int value) {
  ...
  inline ParallelismConfiguration& WithAutoScalingEnabled(bool value) {
