...
class CatalogConfigurationDescription {
 public:
   ...
   */
  inline const GlueDataCatalogConfigurationDescription& GetGlueDataCatalogConfigurationDescription() const {
    return m_glueDataCatalogConfigurationDescription;
  }
  ...
  void SetGlueDataCatalogConfigurationDescription(GlueDataCatalogConfigurationDescriptionT&& value) {
    m_glueDataCatalogConfigurationDescriptionHasBeenSet = true;
    m_glueDataCatalogConfigurationDescription = std::forward<GlueDataCatalogConfigurationDescriptionT>(value);
  }
  template <typename GlueDataCatalogConfigurationDescriptionT = GlueDataCatalogConfigurationDescription>
  CatalogConfigurationDescription& WithGlueDataCatalogConfigurationDescription(GlueDataCatalogConfigurationDescriptionT&& value) {
    SetGlueDataCatalogConfigurationDescription(std::forward<GlueDataCatalogConfigurationDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
