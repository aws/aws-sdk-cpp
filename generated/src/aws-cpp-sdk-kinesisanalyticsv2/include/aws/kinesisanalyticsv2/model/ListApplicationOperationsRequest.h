...
class ListApplicationOperationsRequest : public KinesisAnalyticsV2Request {
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  ListApplicationOperationsRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  inline ListApplicationOperationsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationOperationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename OperationT = Aws::String>
  ListApplicationOperationsRequest& WithOperation(OperationT&& value) {
  ...
  inline void SetOperationStatus(OperationStatus value) {
    m_operationStatusHasBeenSet = true;
    m_operationStatus = value;
  }
  inline ListApplicationOperationsRequest& WithOperationStatus(OperationStatus value) {
