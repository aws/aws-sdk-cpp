...
class MonitoringConfiguration {
 public:
  ...
  inline MonitoringConfiguration& WithConfigurationType(ConfigurationType value) {
  ...
  inline MonitoringConfiguration& WithMetricsLevel(MetricsLevel value) {
  ...
  inline MonitoringConfiguration& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
