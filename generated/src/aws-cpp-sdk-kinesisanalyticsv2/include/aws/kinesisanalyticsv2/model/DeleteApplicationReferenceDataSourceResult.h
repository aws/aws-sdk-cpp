...
class DeleteApplicationReferenceDataSourceResult {
 public:
  ...
  AWS_KINESISANALYTICSV2_API DeleteApplicationReferenceDataSourceResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ApplicationARNT = Aws::String>
  DeleteApplicationReferenceDataSourceResult& WithApplicationARN(ApplicationARNT&& value) {
  ...
  inline DeleteApplicationReferenceDataSourceResult& WithApplicationVersionId(long long value) {
