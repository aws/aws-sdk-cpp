...
class AddApplicationOutputResult {
 public:
  ...
  template <typename ApplicationARNT = Aws::String>
  AddApplicationOutputResult& WithApplicationARN(ApplicationARNT&& value) {
  ...
  inline AddApplicationOutputResult& WithApplicationVersionId(long long value) {
  ...
  void SetOutputDescriptions(OutputDescriptionsT&& value) {
    ...
    m_outputDescriptions = std::forward<OutputDescriptionsT>(value);
  }
  template <typename OutputDescriptionsT = Aws::Vector<OutputDescription>>
  AddApplicationOutputResult& WithOutputDescriptions(OutputDescriptionsT&& value) {
    SetOutputDescriptions(std::forward<OutputDescriptionsT>(value));
    return *this;
  }
  template <typename OutputDescriptionsT = OutputDescription>
  AddApplicationOutputResult& AddOutputDescriptions(OutputDescriptionsT&& value) {
    m_outputDescriptionsHasBeenSet = true;
    m_outputDescriptions.emplace_back(std::forward<OutputDescriptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AddApplicationOutputResult& WithRequestId(RequestIdT&& value) {
