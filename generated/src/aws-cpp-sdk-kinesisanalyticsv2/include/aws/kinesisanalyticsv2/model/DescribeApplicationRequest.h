...
class DescribeApplicationRequest : public KinesisAnalyticsV2Request {
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  DescribeApplicationRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  inline void SetIncludeAdditionalDetails(bool value) {
    m_includeAdditionalDetailsHasBeenSet = true;
    m_includeAdditionalDetails = value;
  }
  inline DescribeApplicationRequest& WithIncludeAdditionalDetails(bool value) {
    SetIncludeAdditionalDetails(value);
    return *this;
  }
  ///@}
 private:
