...
class Input {
 public:
  ...
  void SetKinesisStreamsInput(KinesisStreamsInputT&& value) {
    ...
    m_kinesisStreamsInput = std::forward<KinesisStreamsInputT>(value);
  }
  template <typename KinesisStreamsInputT = KinesisStreamsInput>
  Input& WithKinesisStreamsInput(KinesisStreamsInputT&& value) {
    SetKinesisStreamsInput(std::forward<KinesisStreamsInputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKinesisFirehoseInput(KinesisFirehoseInputT&& value) {
    ...
    m_kinesisFirehoseInput = std::forward<KinesisFirehoseInputT>(value);
  }
  template <typename KinesisFirehoseInputT = KinesisFirehoseInput>
  Input& WithKinesisFirehoseInput(KinesisFirehoseInputT&& value) {
    SetKinesisFirehoseInput(std::forward<KinesisFirehoseInputT>(value));
    return *this;
  }
  ///@}
