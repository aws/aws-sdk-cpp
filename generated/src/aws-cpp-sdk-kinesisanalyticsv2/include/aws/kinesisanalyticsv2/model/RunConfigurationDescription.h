...
class RunConfigurationDescription {
 public:
   ...
   */
  inline const ApplicationRestoreConfiguration& GetApplicationRestoreConfigurationDescription() const {
    return m_applicationRestoreConfigurationDescription;
  }
  inline bool ApplicationRestoreConfigurationDescriptionHasBeenSet() const {
    return m_applicationRestoreConfigurationDescriptionHasBeenSet;
  }
  ...
  void SetApplicationRestoreConfigurationDescription(ApplicationRestoreConfigurationDescriptionT&& value) {
    ...
    m_applicationRestoreConfigurationDescription = std::forward<ApplicationRestoreConfigurationDescriptionT>(value);
  }
  template <typename ApplicationRestoreConfigurationDescriptionT = ApplicationRestoreConfiguration>
  RunConfigurationDescription& WithApplicationRestoreConfigurationDescription(ApplicationRestoreConfigurationDescriptionT&& value) {
    SetApplicationRestoreConfigurationDescription(std::forward<ApplicationRestoreConfigurationDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFlinkRunConfigurationDescription(FlinkRunConfigurationDescriptionT&& value) {
    ...
    m_flinkRunConfigurationDescription = std::forward<FlinkRunConfigurationDescriptionT>(value);
  }
  template <typename FlinkRunConfigurationDescriptionT = FlinkRunConfiguration>
  RunConfigurationDescription& WithFlinkRunConfigurationDescription(FlinkRunConfigurationDescriptionT&& value) {
    SetFlinkRunConfigurationDescription(std::forward<FlinkRunConfigurationDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
