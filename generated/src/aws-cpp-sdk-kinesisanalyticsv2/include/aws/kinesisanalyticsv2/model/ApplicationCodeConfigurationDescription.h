...
class ApplicationCodeConfigurationDescription {
 public:
  ...
  inline ApplicationCodeConfigurationDescription& WithCodeContentType(CodeContentType value) {
  ...
  void SetCodeContentDescription(CodeContentDescriptionT&& value) {
    ...
    m_codeContentDescription = std::forward<CodeContentDescriptionT>(value);
  }
  template <typename CodeContentDescriptionT = CodeContentDescription>
  ApplicationCodeConfigurationDescription& WithCodeContentDescription(CodeContentDescriptionT&& value) {
    SetCodeContentDescription(std::forward<CodeContentDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
