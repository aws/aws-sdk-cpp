...
class StartApplicationRequest : public KinesisAnalyticsV2Request {
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  StartApplicationRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  void SetRunConfiguration(RunConfigurationT&& value) {
    m_runConfigurationHasBeenSet = true;
    m_runConfiguration = std::forward<RunConfigurationT>(value);
  }
  template <typename RunConfigurationT = RunConfiguration>
  StartApplicationRequest& WithRunConfiguration(RunConfigurationT&& value) {
    SetRunConfiguration(std::forward<RunConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
