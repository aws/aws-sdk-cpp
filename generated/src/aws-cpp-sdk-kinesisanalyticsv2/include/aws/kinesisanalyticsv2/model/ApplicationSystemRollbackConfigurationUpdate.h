...
class ApplicationSystemRollbackConfigurationUpdate {
 public:
  ...
  inline void SetRollbackEnabledUpdate(bool value) {
    m_rollbackEnabledUpdateHasBeenSet = true;
    m_rollbackEnabledUpdate = value;
  }
  inline ApplicationSystemRollbackConfigurationUpdate& WithRollbackEnabledUpdate(bool value) {
    SetRollbackEnabledUpdate(value);
    return *this;
  }
  ///@}
 private:
