...
class RollbackApplicationRequest : public KinesisAnalyticsV2Request {
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  RollbackApplicationRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  inline RollbackApplicationRequest& WithCurrentApplicationVersionId(long long value) {
