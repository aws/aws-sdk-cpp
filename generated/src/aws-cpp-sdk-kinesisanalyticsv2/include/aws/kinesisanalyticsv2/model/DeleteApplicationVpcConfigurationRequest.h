...
class DeleteApplicationVpcConfigurationRequest : public KinesisAnalyticsV2Request {
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  DeleteApplicationVpcConfigurationRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  inline DeleteApplicationVpcConfigurationRequest& WithCurrentApplicationVersionId(long long value) {
  ...
  template <typename VpcConfigurationIdT = Aws::String>
  DeleteApplicationVpcConfigurationRequest& WithVpcConfigurationId(VpcConfigurationIdT&& value) {
  ...
  template <typename ConditionalTokenT = Aws::String>
  DeleteApplicationVpcConfigurationRequest& WithConditionalToken(ConditionalTokenT&& value) {
