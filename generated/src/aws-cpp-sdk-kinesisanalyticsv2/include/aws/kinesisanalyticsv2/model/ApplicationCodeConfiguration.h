...
class ApplicationCodeConfiguration {
 public:
  ...
  void SetCodeContent(CodeContentT&& value) {
    ...
    m_codeContent = std::forward<CodeContentT>(value);
  }
  template <typename CodeContentT = CodeContent>
  ApplicationCodeConfiguration& WithCodeContent(CodeContentT&& value) {
    SetCodeContent(std::forward<CodeContentT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCodeContentType(CodeContentType value) {
    m_codeContentTypeHasBeenSet = true;
    m_codeContentType = value;
  }
  inline ApplicationCodeConfiguration& WithCodeContentType(CodeContentType value) {
    SetCodeContentType(value);
    return *this;
  }
  ///@}
 private:
