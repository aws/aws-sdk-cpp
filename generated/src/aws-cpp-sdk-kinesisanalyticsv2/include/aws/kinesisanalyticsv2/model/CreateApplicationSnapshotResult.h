...
namespace Model
{
  ...
  public:
    ...
    inline CreateApplicationSnapshotResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateApplicationSnapshotResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateApplicationSnapshotResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
