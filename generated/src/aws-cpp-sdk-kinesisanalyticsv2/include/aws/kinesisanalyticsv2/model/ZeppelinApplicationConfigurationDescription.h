...
class ZeppelinApplicationConfigurationDescription {
 public:
   ...
   * notebook.</p>
   */
  inline const ZeppelinMonitoringConfigurationDescription& GetMonitoringConfigurationDescription() const {
    return m_monitoringConfigurationDescription;
  }
  ...
  void SetMonitoringConfigurationDescription(MonitoringConfigurationDescriptionT&& value) {
    ...
    m_monitoringConfigurationDescription = std::forward<MonitoringConfigurationDescriptionT>(value);
  }
  template <typename MonitoringConfigurationDescriptionT = ZeppelinMonitoringConfigurationDescription>
  ZeppelinApplicationConfigurationDescription& WithMonitoringConfigurationDescription(MonitoringConfigurationDescriptionT&& value) {
    SetMonitoringConfigurationDescription(std::forward<MonitoringConfigurationDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogConfigurationDescription(CatalogConfigurationDescriptionT&& value) {
    ...
    m_catalogConfigurationDescription = std::forward<CatalogConfigurationDescriptionT>(value);
  }
  template <typename CatalogConfigurationDescriptionT = CatalogConfigurationDescription>
  ZeppelinApplicationConfigurationDescription& WithCatalogConfigurationDescription(CatalogConfigurationDescriptionT&& value) {
    SetCatalogConfigurationDescription(std::forward<CatalogConfigurationDescriptionT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const DeployAsApplicationConfigurationDescription& GetDeployAsApplicationConfigurationDescription() const {
    return m_deployAsApplicationConfigurationDescription;
  }
  inline bool DeployAsApplicationConfigurationDescriptionHasBeenSet() const {
    return m_deployAsApplicationConfigurationDescriptionHasBeenSet;
  }
  ...
  void SetDeployAsApplicationConfigurationDescription(DeployAsApplicationConfigurationDescriptionT&& value) {
    ...
    m_deployAsApplicationConfigurationDescription = std::forward<DeployAsApplicationConfigurationDescriptionT>(value);
  }
  template <typename DeployAsApplicationConfigurationDescriptionT = DeployAsApplicationConfigurationDescription>
  ZeppelinApplicationConfigurationDescription& WithDeployAsApplicationConfigurationDescription(
      DeployAsApplicationConfigurationDescriptionT&& value) {
    SetDeployAsApplicationConfigurationDescription(std::forward<DeployAsApplicationConfigurationDescriptionT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<CustomArtifactConfigurationDescription>& GetCustomArtifactsConfigurationDescription() const {
    return m_customArtifactsConfigurationDescription;
  }
  ...
  void SetCustomArtifactsConfigurationDescription(CustomArtifactsConfigurationDescriptionT&& value) {
    ...
    m_customArtifactsConfigurationDescription = std::forward<CustomArtifactsConfigurationDescriptionT>(value);
  }
  template <typename CustomArtifactsConfigurationDescriptionT = Aws::Vector<CustomArtifactConfigurationDescription>>
  ZeppelinApplicationConfigurationDescription& WithCustomArtifactsConfigurationDescription(
      CustomArtifactsConfigurationDescriptionT&& value) {
    SetCustomArtifactsConfigurationDescription(std::forward<CustomArtifactsConfigurationDescriptionT>(value));
    return *this;
  }
  template <typename CustomArtifactsConfigurationDescriptionT = CustomArtifactConfigurationDescription>
  ZeppelinApplicationConfigurationDescription& AddCustomArtifactsConfigurationDescription(
      CustomArtifactsConfigurationDescriptionT&& value) {
    m_customArtifactsConfigurationDescriptionHasBeenSet = true;
    m_customArtifactsConfigurationDescription.emplace_back(std::forward<CustomArtifactsConfigurationDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
