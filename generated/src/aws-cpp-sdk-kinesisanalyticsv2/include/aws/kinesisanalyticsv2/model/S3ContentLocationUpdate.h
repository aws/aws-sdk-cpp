...
class S3ContentLocationUpdate {
 public:
  ...
  void SetBucketARNUpdate(BucketARNUpdateT&& value) {
    ...
    m_bucketARNUpdate = std::forward<BucketARNUpdateT>(value);
  }
  template <typename BucketARNUpdateT = Aws::String>
  S3ContentLocationUpdate& WithBucketARNUpdate(BucketARNUpdateT&& value) {
    SetBucketARNUpdate(std::forward<BucketARNUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFileKeyUpdate(FileKeyUpdateT&& value) {
    ...
    m_fileKeyUpdate = std::forward<FileKeyUpdateT>(value);
  }
  template <typename FileKeyUpdateT = Aws::String>
  S3ContentLocationUpdate& WithFileKeyUpdate(FileKeyUpdateT&& value) {
    SetFileKeyUpdate(std::forward<FileKeyUpdateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetObjectVersionUpdate(ObjectVersionUpdateT&& value) {
    ...
    m_objectVersionUpdate = std::forward<ObjectVersionUpdateT>(value);
  }
  template <typename ObjectVersionUpdateT = Aws::String>
  S3ContentLocationUpdate& WithObjectVersionUpdate(ObjectVersionUpdateT&& value) {
    SetObjectVersionUpdate(std::forward<ObjectVersionUpdateT>(value));
    return *this;
  }
  ///@}
 private:
