...
class Output {
 public:
  ...
  void SetKinesisStreamsOutput(KinesisStreamsOutputT&& value) {
    ...
    m_kinesisStreamsOutput = std::forward<KinesisStreamsOutputT>(value);
  }
  template <typename KinesisStreamsOutputT = KinesisStreamsOutput>
  Output& WithKinesisStreamsOutput(KinesisStreamsOutputT&& value) {
    SetKinesisStreamsOutput(std::forward<KinesisStreamsOutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKinesisFirehoseOutput(KinesisFirehoseOutputT&& value) {
    ...
    m_kinesisFirehoseOutput = std::forward<KinesisFirehoseOutputT>(value);
  }
  template <typename KinesisFirehoseOutputT = KinesisFirehoseOutput>
  Output& WithKinesisFirehoseOutput(KinesisFirehoseOutputT&& value) {
    SetKinesisFirehoseOutput(std::forward<KinesisFirehoseOutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLambdaOutput(LambdaOutputT&& value) {
    ...
    m_lambdaOutput = std::forward<LambdaOutputT>(value);
  }
  template <typename LambdaOutputT = LambdaOutput>
  Output& WithLambdaOutput(LambdaOutputT&& value) {
    SetLambdaOutput(std::forward<LambdaOutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationSchema(DestinationSchemaT&& value) {
    ...
    m_destinationSchema = std::forward<DestinationSchemaT>(value);
  }
  template <typename DestinationSchemaT = DestinationSchema>
  Output& WithDestinationSchema(DestinationSchemaT&& value) {
    SetDestinationSchema(std::forward<DestinationSchemaT>(value));
    return *this;
  }
  ///@}
 private:
