...
class CreateApplicationRequest : public KinesisAnalyticsV2Request {
 public:
  ...
  inline CreateApplicationRequest& WithRuntimeEnvironment(RuntimeEnvironment value) {
  ...
  inline CreateApplicationRequest& WithApplicationMode(ApplicationMode value) {
