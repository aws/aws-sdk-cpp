...
class ListApplicationSnapshotsResult {
 public:
  ...
  AWS_KINESISANALYTICSV2_API ListApplicationSnapshotsResult& operator=(
  ...
  void SetSnapshotSummaries(SnapshotSummariesT&& value) {
    m_snapshotSummariesHasBeenSet = true;
    m_snapshotSummaries = std::forward<SnapshotSummariesT>(value);
  }
  template <typename SnapshotSummariesT = Aws::Vector<SnapshotDetails>>
  ListApplicationSnapshotsResult& WithSnapshotSummaries(SnapshotSummariesT&& value) {
    SetSnapshotSummaries(std::forward<SnapshotSummariesT>(value));
    return *this;
  }
  template <typename SnapshotSummariesT = SnapshotDetails>
  ListApplicationSnapshotsResult& AddSnapshotSummaries(SnapshotSummariesT&& value) {
    m_snapshotSummariesHasBeenSet = true;
    m_snapshotSummaries.emplace_back(std::forward<SnapshotSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationSnapshotsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApplicationSnapshotsResult& WithRequestId(RequestIdT&& value) {
