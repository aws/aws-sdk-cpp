...
namespace Model
{
  ...
  {
  public:
    AWS_KINESISANALYTICSV2_API KinesisStreamsInputDescription() = default;
    AWS_KINESISANALYTICSV2_API KinesisStreamsInputDescription(Aws::Utils::Json::JsonView jsonValue);
    AWS_KINESISANALYTICSV2_API KinesisStreamsInputDescription& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename ResourceARNT = Aws::String>
    KinesisStreamsInputDescription& WithResourceARN(ResourceARNT&& value) { SetResourceARN(std::forward<ResourceARNT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleARNT = Aws::String>
    KinesisStreamsInputDescription& WithRoleARN(RoleARNT&& value) { SetRoleARN(std::forward<RoleARNT>(value)); return *this;}
    ///@}
  private:
