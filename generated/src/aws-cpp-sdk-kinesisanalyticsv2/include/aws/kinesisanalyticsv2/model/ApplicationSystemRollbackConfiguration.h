...
class ApplicationSystemRollbackConfiguration {
 public:
  ...
  inline void SetRollbackEnabled(bool value) {
    m_rollbackEnabledHasBeenSet = true;
    m_rollbackEnabled = value;
  }
  inline ApplicationSystemRollbackConfiguration& WithRollbackEnabled(bool value) {
    SetRollbackEnabled(value);
    return *this;
  }
  ///@}
 private:
