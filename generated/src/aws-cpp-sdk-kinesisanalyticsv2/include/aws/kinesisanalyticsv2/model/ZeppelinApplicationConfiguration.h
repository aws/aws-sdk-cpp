...
class ZeppelinApplicationConfiguration {
 public:
  ...
  void SetDeployAsApplicationConfiguration(DeployAsApplicationConfigurationT&& value) {
    ...
    m_deployAsApplicationConfiguration = std::forward<DeployAsApplicationConfigurationT>(value);
  }
  template <typename DeployAsApplicationConfigurationT = DeployAsApplicationConfiguration>
  ZeppelinApplicationConfiguration& WithDeployAsApplicationConfiguration(DeployAsApplicationConfigurationT&& value) {
    SetDeployAsApplicationConfiguration(std::forward<DeployAsApplicationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomArtifactsConfiguration(CustomArtifactsConfigurationT&& value) {
    ...
    m_customArtifactsConfiguration = std::forward<CustomArtifactsConfigurationT>(value);
  }
  template <typename CustomArtifactsConfigurationT = Aws::Vector<CustomArtifactConfiguration>>
  ZeppelinApplicationConfiguration& WithCustomArtifactsConfiguration(CustomArtifactsConfigurationT&& value) {
    SetCustomArtifactsConfiguration(std::forward<CustomArtifactsConfigurationT>(value));
    return *this;
  }
  ...
  ZeppelinApplicationConfiguration& AddCustomArtifactsConfiguration(CustomArtifactsConfigurationT&& value) {
    m_customArtifactsConfigurationHasBeenSet = true;
    m_customArtifactsConfiguration.emplace_back(std::forward<CustomArtifactsConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
