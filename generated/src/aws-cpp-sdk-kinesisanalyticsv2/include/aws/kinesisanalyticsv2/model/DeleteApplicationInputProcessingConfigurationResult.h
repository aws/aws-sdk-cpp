...
class DeleteApplicationInputProcessingConfigurationResult {
 public:
  ...
  AWS_KINESISANALYTICSV2_API DeleteApplicationInputProcessingConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ApplicationARNT = Aws::String>
  DeleteApplicationInputProcessingConfigurationResult& WithApplicationARN(ApplicationARNT&& value) {
  ...
  inline DeleteApplicationInputProcessingConfigurationResult& WithApplicationVersionId(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteApplicationInputProcessingConfigurationResult& WithRequestId(RequestIdT&& value) {
