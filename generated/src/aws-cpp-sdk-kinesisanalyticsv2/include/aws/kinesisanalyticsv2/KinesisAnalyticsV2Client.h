...
namespace KinesisAnalyticsV2
{
   ...
   * real-time metrics.</p>
   */
  class AWS_KINESISANALYTICSV2_API KinesisAnalyticsV2Client : Aws::Client::ClientWithAsyncTemplateMethods<KinesisAnalyticsV2Client>,
    smithy::client::AwsSmithyClientT<Aws::KinesisAnalyticsV2::SERVICE_NAME,
