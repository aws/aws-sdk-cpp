...
ListCapabilitiesResult::ListCapabilitiesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListCapabilitiesResult& ListCapabilitiesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
