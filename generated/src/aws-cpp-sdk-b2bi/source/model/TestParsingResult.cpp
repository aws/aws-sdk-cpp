...
TestParsingResult& TestParsingResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("parsedSplitFileContents")) {
    ...
    for (unsigned parsedSplitFileContentsIndex = 0; parsedSplitFileContentsIndex < parsedSplitFileContentsJsonList.GetLength();
         ++parsedSplitFileContentsIndex) {
  ...
  if (jsonValue.ValueExists("validationMessages")) {
    ...
    for (unsigned validationMessagesIndex = 0; validationMessagesIndex < validationMessagesJsonList.GetLength();
         ++validationMessagesIndex) {
