...
UpdateTransformerResult::UpdateTransformerResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateTransformerResult& UpdateTransformerResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
