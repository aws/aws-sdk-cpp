...
class CreateStarterMappingTemplateRequest : public B2BIRequest {
 public:
  ...
  void SetOutputSampleLocation(OutputSampleLocationT&& value) {
    m_outputSampleLocationHasBeenSet = true;
    m_outputSampleLocation = std::forward<OutputSampleLocationT>(value);
  }
  template <typename OutputSampleLocationT = S3Location>
  CreateStarterMappingTemplateRequest& WithOutputSampleLocation(OutputSampleLocationT&& value) {
    SetOutputSampleLocation(std::forward<OutputSampleLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateStarterMappingTemplateRequest& WithMappingType(MappingType value) {
  ...
  void SetTemplateDetails(TemplateDetailsT&& value) {
    m_templateDetailsHasBeenSet = true;
    m_templateDetails = std::forward<TemplateDetailsT>(value);
  }
  template <typename TemplateDetailsT = TemplateDetails>
  CreateStarterMappingTemplateRequest& WithTemplateDetails(TemplateDetailsT&& value) {
    SetTemplateDetails(std::forward<TemplateDetailsT>(value));
    return *this;
  }
  ///@}
 private:
