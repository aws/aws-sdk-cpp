...
class X12CodeListValidationRule {
 public:
  ...
  template <typename ElementIdT = Aws::String>
  X12CodeListValidationRule& WithElementId(ElementIdT&& value) {
  ...
  void SetCodesToAdd(CodesToAddT&& value) {
    m_codesToAddHasBeenSet = true;
    m_codesToAdd = std::forward<CodesToAddT>(value);
  }
  template <typename CodesToAddT = Aws::Vector<Aws::String>>
  X12CodeListValidationRule& WithCodesToAdd(CodesToAddT&& value) {
    SetCodesToAdd(std::forward<CodesToAddT>(value));
    return *this;
  }
  template <typename CodesToAddT = Aws::String>
  X12CodeListValidationRule& AddCodesToAdd(CodesToAddT&& value) {
    m_codesToAddHasBeenSet = true;
    m_codesToAdd.emplace_back(std::forward<CodesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCodesToRemove(CodesToRemoveT&& value) {
    m_codesToRemoveHasBeenSet = true;
    m_codesToRemove = std::forward<CodesToRemoveT>(value);
  }
  template <typename CodesToRemoveT = Aws::Vector<Aws::String>>
  X12CodeListValidationRule& WithCodesToRemove(CodesToRemoveT&& value) {
    SetCodesToRemove(std::forward<CodesToRemoveT>(value));
    return *this;
  }
  template <typename CodesToRemoveT = Aws::String>
  X12CodeListValidationRule& AddCodesToRemove(CodesToRemoveT&& value) {
    m_codesToRemoveHasBeenSet = true;
    m_codesToRemove.emplace_back(std::forward<CodesToRemoveT>(value));
    return *this;
  }
  ///@}
 private:
