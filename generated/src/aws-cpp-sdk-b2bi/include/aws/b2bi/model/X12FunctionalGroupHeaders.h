...
class X12FunctionalGroupHeaders {
 public:
  ...
  void SetApplicationSenderCode(ApplicationSenderCodeT&& value) {
    ...
    m_applicationSenderCode = std::forward<ApplicationSenderCodeT>(value);
  }
  template <typename ApplicationSenderCodeT = Aws::String>
  X12FunctionalGroupHeaders& WithApplicationSenderCode(ApplicationSenderCodeT&& value) {
    SetApplicationSenderCode(std::forward<ApplicationSenderCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationReceiverCode(ApplicationReceiverCodeT&& value) {
    ...
    m_applicationReceiverCode = std::forward<ApplicationReceiverCodeT>(value);
  }
  template <typename ApplicationReceiverCodeT = Aws::String>
  X12FunctionalGroupHeaders& WithApplicationReceiverCode(ApplicationReceiverCodeT&& value) {
    SetApplicationReceiverCode(std::forward<ApplicationReceiverCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResponsibleAgencyCode(ResponsibleAgencyCodeT&& value) {
    ...
    m_responsibleAgencyCode = std::forward<ResponsibleAgencyCodeT>(value);
  }
  template <typename ResponsibleAgencyCodeT = Aws::String>
  X12FunctionalGroupHeaders& WithResponsibleAgencyCode(ResponsibleAgencyCodeT&& value) {
    SetResponsibleAgencyCode(std::forward<ResponsibleAgencyCodeT>(value));
    return *this;
  }
  ///@}
 private:
