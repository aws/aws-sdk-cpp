...
namespace Model
{
  ...
  {
  public:
    AWS_B2BI_API ListCapabilitiesRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListCapabilitiesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
