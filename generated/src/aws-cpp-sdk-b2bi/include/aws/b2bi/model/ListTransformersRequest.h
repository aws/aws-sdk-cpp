...
class ListTransformersRequest : public B2BIRequest {
 public:
  AWS_B2BI_API ListTransformersRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListTransformersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTransformersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
