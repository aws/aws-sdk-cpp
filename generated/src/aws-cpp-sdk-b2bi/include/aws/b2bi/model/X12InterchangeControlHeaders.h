...
class X12InterchangeControlHeaders {
 public:
  ...
  void SetSenderIdQualifier(SenderIdQualifierT&& value) {
    m_senderIdQualifierHasBeenSet = true;
    m_senderIdQualifier = std::forward<SenderIdQualifierT>(value);
  }
  template <typename SenderIdQualifierT = Aws::String>
  X12InterchangeControlHeaders& WithSenderIdQualifier(SenderIdQualifierT&& value) {
    SetSenderIdQualifier(std::forward<SenderIdQualifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReceiverIdQualifier(ReceiverIdQualifierT&& value) {
    m_receiverIdQualifierHasBeenSet = true;
    m_receiverIdQualifier = std::forward<ReceiverIdQualifierT>(value);
  }
  template <typename ReceiverIdQualifierT = Aws::String>
  X12InterchangeControlHeaders& WithReceiverIdQualifier(ReceiverIdQualifierT&& value) {
    SetReceiverIdQualifier(std::forward<ReceiverIdQualifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReceiverId(ReceiverIdT&& value) {
    m_receiverIdHasBeenSet = true;
    m_receiverId = std::forward<ReceiverIdT>(value);
  }
  template <typename ReceiverIdT = Aws::String>
  X12InterchangeControlHeaders& WithReceiverId(ReceiverIdT&& value) {
    SetReceiverId(std::forward<ReceiverIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRepetitionSeparator(RepetitionSeparatorT&& value) {
    m_repetitionSeparatorHasBeenSet = true;
    m_repetitionSeparator = std::forward<RepetitionSeparatorT>(value);
  }
  template <typename RepetitionSeparatorT = Aws::String>
  X12InterchangeControlHeaders& WithRepetitionSeparator(RepetitionSeparatorT&& value) {
    SetRepetitionSeparator(std::forward<RepetitionSeparatorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAcknowledgmentRequestedCode(AcknowledgmentRequestedCodeT&& value) {
    ...
    m_acknowledgmentRequestedCode = std::forward<AcknowledgmentRequestedCodeT>(value);
  }
  template <typename AcknowledgmentRequestedCodeT = Aws::String>
  X12InterchangeControlHeaders& WithAcknowledgmentRequestedCode(AcknowledgmentRequestedCodeT&& value) {
    SetAcknowledgmentRequestedCode(std::forward<AcknowledgmentRequestedCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUsageIndicatorCode(UsageIndicatorCodeT&& value) {
    m_usageIndicatorCodeHasBeenSet = true;
    m_usageIndicatorCode = std::forward<UsageIndicatorCodeT>(value);
  }
  template <typename UsageIndicatorCodeT = Aws::String>
  X12InterchangeControlHeaders& WithUsageIndicatorCode(UsageIndicatorCodeT&& value) {
    SetUsageIndicatorCode(std::forward<UsageIndicatorCodeT>(value));
    return *this;
  }
  ///@}
 private:
