...
class CapabilityOptions {
 public:
  ...
  void SetOutboundEdi(OutboundEdiT&& value) {
    ...
    m_outboundEdi = std::forward<OutboundEdiT>(value);
  }
  template <typename OutboundEdiT = OutboundEdiOptions>
  CapabilityOptions& WithOutboundEdi(OutboundEdiT&& value) {
    SetOutboundEdi(std::forward<OutboundEdiT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInboundEdi(InboundEdiT&& value) {
    ...
    m_inboundEdi = std::forward<InboundEdiT>(value);
  }
  template <typename InboundEdiT = InboundEdiOptions>
  CapabilityOptions& WithInboundEdi(InboundEdiT&& value) {
    SetInboundEdi(std::forward<InboundEdiT>(value));
    return *this;
  }
  ///@}
 private:
