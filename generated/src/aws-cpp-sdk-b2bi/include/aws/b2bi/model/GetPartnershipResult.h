...
class GetPartnershipResult {
 public:
  ...
  void SetPartnershipArn(PartnershipArnT&& value) {
    ...
    m_partnershipArn = std::forward<PartnershipArnT>(value);
  }
  template <typename PartnershipArnT = Aws::String>
  GetPartnershipResult& WithPartnershipArn(PartnershipArnT&& value) {
    SetPartnershipArn(std::forward<PartnershipArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTradingPartnerId(TradingPartnerIdT&& value) {
    ...
    m_tradingPartnerId = std::forward<TradingPartnerIdT>(value);
  }
  template <typename TradingPartnerIdT = Aws::String>
  GetPartnershipResult& WithTradingPartnerId(TradingPartnerIdT&& value) {
    SetTradingPartnerId(std::forward<TradingPartnerIdT>(value));
    return *this;
  }
  ///@}
