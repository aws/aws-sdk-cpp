...
namespace Model
{
  ...
  public:
    ...
    template<typename ProfileIdT = Aws::String>
    UpdatePartnershipResult& WithProfileId(ProfileIdT&& value) { SetProfileId(std::forward<ProfileIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PartnershipIdT = Aws::String>
    UpdatePartnershipResult& WithPartnershipId(PartnershipIdT&& value) { SetPartnershipId(std::forward<PartnershipIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PartnershipArnT = Aws::String>
    UpdatePartnershipResult& WithPartnershipArn(PartnershipArnT&& value) { SetPartnershipArn(std::forward<PartnershipArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdatePartnershipResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename EmailT = Aws::String>
    UpdatePartnershipResult& WithEmail(EmailT&& value) { SetEmail(std::forward<EmailT>(value)); return *this;}
    ///@}
    ...
    template<typename PhoneT = Aws::String>
    UpdatePartnershipResult& WithPhone(PhoneT&& value) { SetPhone(std::forward<PhoneT>(value)); return *this;}
    ///@}
    ...
    template<typename CapabilitiesT = Aws::Vector<Aws::String>>
    UpdatePartnershipResult& WithCapabilities(CapabilitiesT&& value) { SetCapabilities(std::forward<CapabilitiesT>(value)); return *this;}
    template<typename CapabilitiesT = Aws::String>
    UpdatePartnershipResult& AddCapabilities(CapabilitiesT&& value) { m_capabilitiesHasBeenSet = true; m_capabilities.emplace_back(std::forward<CapabilitiesT>(value)); return *this; }
    ///@}
    ...
    template<typename CapabilityOptionsT = CapabilityOptions>
    UpdatePartnershipResult& WithCapabilityOptions(CapabilityOptionsT&& value) { SetCapabilityOptions(std::forward<CapabilityOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename TradingPartnerIdT = Aws::String>
    UpdatePartnershipResult& WithTradingPartnerId(TradingPartnerIdT&& value) { SetTradingPartnerId(std::forward<TradingPartnerIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    UpdatePartnershipResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename ModifiedAtT = Aws::Utils::DateTime>
    UpdatePartnershipResult& WithModifiedAt(ModifiedAtT&& value) { SetModifiedAt(std::forward<ModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdatePartnershipResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
