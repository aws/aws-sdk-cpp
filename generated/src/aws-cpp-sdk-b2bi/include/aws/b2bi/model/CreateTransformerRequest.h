...
class CreateTransformerRequest : public B2BIRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateTransformerRequest& WithName(NameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTransformerRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateTransformerRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateTransformerRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename InputConversionT = InputConversion>
  CreateTransformerRequest& WithInputConversion(InputConversionT&& value) {
  ...
  template <typename MappingT = Mapping>
  CreateTransformerRequest& WithMapping(MappingT&& value) {
  ...
  template <typename OutputConversionT = OutputConversion>
  CreateTransformerRequest& WithOutputConversion(OutputConversionT&& value) {
  ...
  template <typename SampleDocumentsT = SampleDocuments>
  CreateTransformerRequest& WithSampleDocuments(SampleDocumentsT&& value) {
