...
class WrapOptions {
 public:
  ...
  inline void SetWrapBy(WrapFormat value) {
    m_wrapByHasBeenSet = true;
    m_wrapBy = value;
  }
  inline WrapOptions& WithWrapBy(WrapFormat value) {
    SetWrapBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLineTerminator(LineTerminator value) {
    m_lineTerminatorHasBeenSet = true;
    m_lineTerminator = value;
  }
  inline WrapOptions& WithLineTerminator(LineTerminator value) {
    SetLineTerminator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLineLength(int value) {
    m_lineLengthHasBeenSet = true;
    m_lineLength = value;
  }
  inline WrapOptions& WithLineLength(int value) {
    SetLineLength(value);
    return *this;
  }
  ///@}
