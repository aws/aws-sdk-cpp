...
namespace Model
{
  ...
  {
  public:
    AWS_B2BI_API DeleteTransformerRequest() = default;
    ...
    template<typename TransformerIdT = Aws::String>
    DeleteTransformerRequest& WithTransformerId(TransformerIdT&& value) { SetTransformerId(std::forward<TransformerIdT>(value)); return *this;}
    ///@}
  private:
