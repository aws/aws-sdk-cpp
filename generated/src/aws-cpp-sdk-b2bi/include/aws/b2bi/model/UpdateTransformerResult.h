...
class UpdateTransformerResult {
 public:
  AWS_B2BI_API UpdateTransformerResult() = default;
  ...
  template <typename TransformerIdT = Aws::String>
  UpdateTransformerResult& WithTransformerId(TransformerIdT&& value) {
  ...
  void SetTransformerArn(TransformerArnT&& value) {
    ...
    m_transformerArn = std::forward<TransformerArnT>(value);
  }
  template <typename TransformerArnT = Aws::String>
  UpdateTransformerResult& WithTransformerArn(TransformerArnT&& value) {
    SetTransformerArn(std::forward<TransformerArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  UpdateTransformerResult& WithName(NameT&& value) {
  ...
  inline void SetStatus(TransformerStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateTransformerResult& WithStatus(TransformerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateTransformerResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  UpdateTransformerResult& WithModifiedAt(ModifiedAtT&& value) {
  ...
  void SetInputConversion(InputConversionT&& value) {
    ...
    m_inputConversion = std::forward<InputConversionT>(value);
  }
  template <typename InputConversionT = InputConversion>
  UpdateTransformerResult& WithInputConversion(InputConversionT&& value) {
    SetInputConversion(std::forward<InputConversionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MappingT = Mapping>
  UpdateTransformerResult& WithMapping(MappingT&& value) {
  ...
  void SetOutputConversion(OutputConversionT&& value) {
    ...
    m_outputConversion = std::forward<OutputConversionT>(value);
  }
  template <typename OutputConversionT = OutputConversion>
  UpdateTransformerResult& WithOutputConversion(OutputConversionT&& value) {
    SetOutputConversion(std::forward<OutputConversionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSampleDocuments(SampleDocumentsT&& value) {
    ...
    m_sampleDocuments = std::forward<SampleDocumentsT>(value);
  }
  template <typename SampleDocumentsT = SampleDocuments>
  UpdateTransformerResult& WithSampleDocuments(SampleDocumentsT&& value) {
    SetSampleDocuments(std::forward<SampleDocumentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateTransformerResult& WithRequestId(RequestIdT&& value) {
