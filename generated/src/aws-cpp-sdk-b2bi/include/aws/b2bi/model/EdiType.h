...
class EdiType {
 public:
  ...
  void SetX12Details(X12DetailsT&& value) {
    m_x12DetailsHasBeenSet = true;
    m_x12Details = std::forward<X12DetailsT>(value);
  }
  template <typename X12DetailsT = X12Details>
  EdiType& WithX12Details(X12DetailsT&& value) {
    SetX12Details(std::forward<X12DetailsT>(value));
    return *this;
  }
  ///@}
 private:
