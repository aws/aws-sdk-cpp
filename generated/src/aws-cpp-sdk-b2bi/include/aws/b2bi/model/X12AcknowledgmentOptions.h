...
class X12AcknowledgmentOptions {
 public:
  ...
  inline void SetFunctionalAcknowledgment(X12FunctionalAcknowledgment value) {
    m_functionalAcknowledgmentHasBeenSet = true;
    m_functionalAcknowledgment = value;
  }
  inline X12AcknowledgmentOptions& WithFunctionalAcknowledgment(X12FunctionalAcknowledgment value) {
    SetFunctionalAcknowledgment(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTechnicalAcknowledgment(X12TechnicalAcknowledgment value) {
    m_technicalAcknowledgmentHasBeenSet = true;
    m_technicalAcknowledgment = value;
  }
  inline X12AcknowledgmentOptions& WithTechnicalAcknowledgment(X12TechnicalAcknowledgment value) {
    SetTechnicalAcknowledgment(value);
    return *this;
  }
  ///@}
 private:
