...
class X12ControlNumbers {
 public:
  ...
  inline void SetStartingInterchangeControlNumber(int value) {
    m_startingInterchangeControlNumberHasBeenSet = true;
    m_startingInterchangeControlNumber = value;
  }
  inline X12ControlNumbers& WithStartingInterchangeControlNumber(int value) {
    SetStartingInterchangeControlNumber(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartingFunctionalGroupControlNumber(int value) {
    m_startingFunctionalGroupControlNumberHasBeenSet = true;
    m_startingFunctionalGroupControlNumber = value;
  }
  inline X12ControlNumbers& WithStartingFunctionalGroupControlNumber(int value) {
    SetStartingFunctionalGroupControlNumber(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartingTransactionSetControlNumber(int value) {
    m_startingTransactionSetControlNumberHasBeenSet = true;
    m_startingTransactionSetControlNumber = value;
  }
  inline X12ControlNumbers& WithStartingTransactionSetControlNumber(int value) {
    SetStartingTransactionSetControlNumber(value);
    return *this;
  }
  ///@}
 private:
