...
class X12ValidationRule {
 public:
  ...
  void SetCodeListValidationRule(CodeListValidationRuleT&& value) {
    ...
    m_codeListValidationRule = std::forward<CodeListValidationRuleT>(value);
  }
  template <typename CodeListValidationRuleT = X12CodeListValidationRule>
  X12ValidationRule& WithCodeListValidationRule(CodeListValidationRuleT&& value) {
    SetCodeListValidationRule(std::forward<CodeListValidationRuleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetElementLengthValidationRule(ElementLengthValidationRuleT&& value) {
    ...
    m_elementLengthValidationRule = std::forward<ElementLengthValidationRuleT>(value);
  }
  template <typename ElementLengthValidationRuleT = X12ElementLengthValidationRule>
  X12ValidationRule& WithElementLengthValidationRule(ElementLengthValidationRuleT&& value) {
    SetElementLengthValidationRule(std::forward<ElementLengthValidationRuleT>(value));
    return *this;
  }
  ///@}
   ...
   * element presence.</p>
   */
  inline const X12ElementRequirementValidationRule& GetElementRequirementValidationRule() const {
    return m_elementRequirementValidationRule;
  }
  ...
  void SetElementRequirementValidationRule(ElementRequirementValidationRuleT&& value) {
    ...
    m_elementRequirementValidationRule = std::forward<ElementRequirementValidationRuleT>(value);
  }
  template <typename ElementRequirementValidationRuleT = X12ElementRequirementValidationRule>
  X12ValidationRule& WithElementRequirementValidationRule(ElementRequirementValidationRuleT&& value) {
    SetElementRequirementValidationRule(std::forward<ElementRequirementValidationRuleT>(value));
    return *this;
  }
  ///@}
 private:
