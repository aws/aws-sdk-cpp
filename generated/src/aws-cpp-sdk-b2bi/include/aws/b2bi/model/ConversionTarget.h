...
class ConversionTarget {
 public:
  ...
  inline void SetFileFormat(ConversionTargetFormat value) {
    m_fileFormatHasBeenSet = true;
    m_fileFormat = value;
  }
  inline ConversionTarget& WithFileFormat(ConversionTargetFormat value) {
    SetFileFormat(value);
    return *this;
  }
  ///@}
  ...
  void SetFormatDetails(FormatDetailsT&& value) {
    ...
    m_formatDetails = std::forward<FormatDetailsT>(value);
  }
  template <typename FormatDetailsT = ConversionTargetFormatDetails>
  ConversionTarget& WithFormatDetails(FormatDetailsT&& value) {
    SetFormatDetails(std::forward<FormatDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputSampleFile(OutputSampleFileT&& value) {
    ...
    m_outputSampleFile = std::forward<OutputSampleFileT>(value);
  }
  template <typename OutputSampleFileT = OutputSampleFileSource>
  ConversionTarget& WithOutputSampleFile(OutputSampleFileT&& value) {
    SetOutputSampleFile(std::forward<OutputSampleFileT>(value));
    return *this;
  }
  ///@}
