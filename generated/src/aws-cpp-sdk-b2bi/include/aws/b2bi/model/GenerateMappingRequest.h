...
class GenerateMappingRequest : public B2BIRequest {
 public:
  ...
  void SetInputFileContent(InputFileContentT&& value) {
    m_inputFileContentHasBeenSet = true;
    m_inputFileContent = std::forward<InputFileContentT>(value);
  }
  template <typename InputFileContentT = Aws::String>
  GenerateMappingRequest& WithInputFileContent(InputFileContentT&& value) {
    SetInputFileContent(std::forward<InputFileContentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputFileContent(OutputFileContentT&& value) {
    m_outputFileContentHasBeenSet = true;
    m_outputFileContent = std::forward<OutputFileContentT>(value);
  }
  template <typename OutputFileContentT = Aws::String>
  GenerateMappingRequest& WithOutputFileContent(OutputFileContentT&& value) {
    SetOutputFileContent(std::forward<OutputFileContentT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMappingType(MappingType value) {
    m_mappingTypeHasBeenSet = true;
    m_mappingType = value;
  }
  inline GenerateMappingRequest& WithMappingType(MappingType value) {
