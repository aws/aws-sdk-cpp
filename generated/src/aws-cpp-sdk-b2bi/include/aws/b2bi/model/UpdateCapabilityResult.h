...
namespace Model
{
  ...
  public:
    ...
    template<typename CapabilityIdT = Aws::String>
    UpdateCapabilityResult& WithCapabilityId(CapabilityIdT&& value) { SetCapabilityId(std::forward<CapabilityIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CapabilityArnT = Aws::String>
    UpdateCapabilityResult& WithCapabilityArn(CapabilityArnT&& value) { SetCapabilityArn(std::forward<CapabilityArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateCapabilityResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline UpdateCapabilityResult& WithType(CapabilityType value) { SetType(value); return *this;}
    ///@}
    ...
    template<typename ConfigurationT = CapabilityConfiguration>
    UpdateCapabilityResult& WithConfiguration(ConfigurationT&& value) { SetConfiguration(std::forward<ConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename InstructionsDocumentsT = Aws::Vector<S3Location>>
    UpdateCapabilityResult& WithInstructionsDocuments(InstructionsDocumentsT&& value) { SetInstructionsDocuments(std::forward<InstructionsDocumentsT>(value)); return *this;}
    template<typename InstructionsDocumentsT = S3Location>
    UpdateCapabilityResult& AddInstructionsDocuments(InstructionsDocumentsT&& value) { m_instructionsDocumentsHasBeenSet = true; m_instructionsDocuments.emplace_back(std::forward<InstructionsDocumentsT>(value)); return *this; }
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    UpdateCapabilityResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename ModifiedAtT = Aws::Utils::DateTime>
    UpdateCapabilityResult& WithModifiedAt(ModifiedAtT&& value) { SetModifiedAt(std::forward<ModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateCapabilityResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
