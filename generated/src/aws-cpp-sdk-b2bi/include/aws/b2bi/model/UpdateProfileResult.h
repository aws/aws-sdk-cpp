...
namespace Model
{
  ...
  public:
    ...
    template<typename ProfileArnT = Aws::String>
    UpdateProfileResult& WithProfileArn(ProfileArnT&& value) { SetProfileArn(std::forward<ProfileArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateProfileResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename EmailT = Aws::String>
    UpdateProfileResult& WithEmail(EmailT&& value) { SetEmail(std::forward<EmailT>(value)); return *this;}
    ///@}
    ...
    template<typename PhoneT = Aws::String>
    UpdateProfileResult& WithPhone(PhoneT&& value) { SetPhone(std::forward<PhoneT>(value)); return *this;}
    ///@}
    ...
    template<typename BusinessNameT = Aws::String>
    UpdateProfileResult& WithBusinessName(BusinessNameT&& value) { SetBusinessName(std::forward<BusinessNameT>(value)); return *this;}
    ///@}
    ...
    inline UpdateProfileResult& WithLogging(Logging value) { SetLogging(value); return *this;}
    ///@}
    ...
    template<typename LogGroupNameT = Aws::String>
    UpdateProfileResult& WithLogGroupName(LogGroupNameT&& value) { SetLogGroupName(std::forward<LogGroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    UpdateProfileResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename ModifiedAtT = Aws::Utils::DateTime>
    UpdateProfileResult& WithModifiedAt(ModifiedAtT&& value) { SetModifiedAt(std::forward<ModifiedAtT>(value)); return *this;}
    ///@}
