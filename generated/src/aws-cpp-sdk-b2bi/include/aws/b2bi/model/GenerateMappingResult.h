...
class GenerateMappingResult {
 public:
  ...
  void SetMappingTemplate(MappingTemplateT&& value) {
    ...
    m_mappingTemplate = std::forward<MappingTemplateT>(value);
  }
  template <typename MappingTemplateT = Aws::String>
  GenerateMappingResult& WithMappingTemplate(MappingTemplateT&& value) {
    SetMappingTemplate(std::forward<MappingTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMappingAccuracy(double value) {
    m_mappingAccuracyHasBeenSet = true;
    m_mappingAccuracy = value;
  }
  inline GenerateMappingResult& WithMappingAccuracy(double value) {
    SetMappingAccuracy(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GenerateMappingResult& WithRequestId(RequestIdT&& value) {
