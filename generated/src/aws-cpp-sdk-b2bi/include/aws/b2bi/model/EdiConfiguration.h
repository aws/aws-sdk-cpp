...
class EdiConfiguration {
 public:
  ...
  inline void SetCapabilityDirection(CapabilityDirection value) {
    m_capabilityDirectionHasBeenSet = true;
    m_capabilityDirection = value;
  }
  inline EdiConfiguration& WithCapabilityDirection(CapabilityDirection value) {
    SetCapabilityDirection(value);
    return *this;
  }
  ///@}
