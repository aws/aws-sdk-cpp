...
class ListPartnershipsResult {
 public:
  ...
  void SetPartnerships(PartnershipsT&& value) {
    m_partnershipsHasBeenSet = true;
    m_partnerships = std::forward<PartnershipsT>(value);
  }
  template <typename PartnershipsT = Aws::Vector<PartnershipSummary>>
  ListPartnershipsResult& WithPartnerships(PartnershipsT&& value) {
    SetPartnerships(std::forward<PartnershipsT>(value));
    return *this;
  }
  template <typename PartnershipsT = PartnershipSummary>
  ListPartnershipsResult& AddPartnerships(PartnershipsT&& value) {
    m_partnershipsHasBeenSet = true;
    m_partnerships.emplace_back(std::forward<PartnershipsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPartnershipsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPartnershipsResult& WithRequestId(RequestIdT&& value) {
