...
namespace Model
{
  ...
  public:
    ...
    template<typename TransformerIdT = Aws::String>
    CreateTransformerResult& WithTransformerId(TransformerIdT&& value) { SetTransformerId(std::forward<TransformerIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TransformerArnT = Aws::String>
    CreateTransformerResult& WithTransformerArn(TransformerArnT&& value) { SetTransformerArn(std::forward<TransformerArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateTransformerResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline CreateTransformerResult& WithStatus(TransformerStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    CreateTransformerResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename InputConversionT = InputConversion>
    CreateTransformerResult& WithInputConversion(InputConversionT&& value) { SetInputConversion(std::forward<InputConversionT>(value)); return *this;}
    ///@}
    ...
    template<typename MappingT = Mapping>
    CreateTransformerResult& WithMapping(MappingT&& value) { SetMapping(std::forward<MappingT>(value)); return *this;}
    ///@}
    ...
    template<typename OutputConversionT = OutputConversion>
    CreateTransformerResult& WithOutputConversion(OutputConversionT&& value) { SetOutputConversion(std::forward<OutputConversionT>(value)); return *this;}
    ///@}
    ...
    template<typename SampleDocumentsT = SampleDocuments>
    CreateTransformerResult& WithSampleDocuments(SampleDocumentsT&& value) { SetSampleDocuments(std::forward<SampleDocumentsT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateTransformerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
