...
class GetDistributionMetricDataResult {
 public:
  ...
  inline void SetMetricName(DistributionMetricName value) {
    m_metricNameHasBeenSet = true;
    m_metricName = value;
  }
  inline GetDistributionMetricDataResult& WithMetricName(DistributionMetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricDataT = Aws::Vector<MetricDatapoint>>
  GetDistributionMetricDataResult& WithMetricData(MetricDataT&& value) {
    SetMetricData(std::forward<MetricDataT>(value));
    return *this;
  }
  template <typename MetricDataT = MetricDatapoint>
  GetDistributionMetricDataResult& AddMetricData(MetricDataT&& value) {
    m_metricDataHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetDistributionMetricDataResult& WithRequestId(RequestIdT&& value) {
