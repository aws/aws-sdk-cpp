...
class GetBucketsRequest : public LightsailRequest {
 public:
  ...
  template <typename BucketNameT = Aws::String>
  GetBucketsRequest& WithBucketName(BucketNameT&& value) {
  ...
  template <typename PageTokenT = Aws::String>
  GetBucketsRequest& WithPageToken(PageTokenT&& value) {
  ...
  inline void SetIncludeConnectedResources(bool value) {
    m_includeConnectedResourcesHasBeenSet = true;
    m_includeConnectedResources = value;
  }
  inline GetBucketsRequest& WithIncludeConnectedResources(bool value) {
    SetIncludeConnectedResources(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeCors(bool value) {
    m_includeCorsHasBeenSet = true;
    m_includeCors = value;
  }
  inline GetBucketsRequest& WithIncludeCors(bool value) {
    SetIncludeCors(value);
    return *this;
  }
  ///@}
 private:
