...
class Origin {
 public:
  ...
  inline Origin& WithResourceType(ResourceType value) {
  ...
  inline Origin& WithRegionName(RegionName value) {
    SetRegionName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProtocolPolicy(OriginProtocolPolicyEnum value) {
    m_protocolPolicyHasBeenSet = true;
    m_protocolPolicy = value;
  }
  inline Origin& WithProtocolPolicy(OriginProtocolPolicyEnum value) {
    SetProtocolPolicy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResponseTimeout(int value) {
    m_responseTimeoutHasBeenSet = true;
    m_responseTimeout = value;
  }
  inline Origin& WithResponseTimeout(int value) {
  ...
  inline Origin& WithIpAddressType(OriginIpAddressTypeEnum value) {
