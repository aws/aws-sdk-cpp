...
class AttachInstancesToLoadBalancerResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  AttachInstancesToLoadBalancerResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  AttachInstancesToLoadBalancerResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AttachInstancesToLoadBalancerResult& WithRequestId(RequestIdT&& value) {
