...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API AttachInstancesToLoadBalancerResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    AttachInstancesToLoadBalancerResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    AttachInstancesToLoadBalancerResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AttachInstancesToLoadBalancerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
