...
namespace Model
{
  ...
  public:
    ...
    template<typename ResourceNameT = Aws::String>
    GetOperationsForResourceRequest& WithResourceName(ResourceNameT&& value) { SetResourceName(std::forward<ResourceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PageTokenT = Aws::String>
    GetOperationsForResourceRequest& WithPageToken(PageTokenT&& value) { SetPageToken(std::forward<PageTokenT>(value)); return *this;}
    ///@}
  private:
