...
class GetOperationsForResourceRequest : public LightsailRequest {
 public:
  AWS_LIGHTSAIL_API GetOperationsForResourceRequest() = default;
  ...
  template <typename ResourceNameT = Aws::String>
  GetOperationsForResourceRequest& WithResourceName(ResourceNameT&& value) {
  ...
  template <typename PageTokenT = Aws::String>
  GetOperationsForResourceRequest& WithPageToken(PageTokenT&& value) {
