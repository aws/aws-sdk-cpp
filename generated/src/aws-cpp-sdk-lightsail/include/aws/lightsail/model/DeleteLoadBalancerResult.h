...
class DeleteLoadBalancerResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  DeleteLoadBalancerResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  DeleteLoadBalancerResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteLoadBalancerResult& WithRequestId(RequestIdT&& value) {
