...
class InstanceAccessDetails {
 public:
  ...
  void SetCertKey(CertKeyT&& value) {
    ...
    m_certKey = std::forward<CertKeyT>(value);
  }
  template <typename CertKeyT = Aws::String>
  InstanceAccessDetails& WithCertKey(CertKeyT&& value) {
    SetCertKey(std::forward<CertKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPasswordData(PasswordDataT&& value) {
    ...
    m_passwordData = std::forward<PasswordDataT>(value);
  }
  template <typename PasswordDataT = PasswordData>
  InstanceAccessDetails& WithPasswordData(PasswordDataT&& value) {
    SetPasswordData(std::forward<PasswordDataT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProtocol(InstanceAccessProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline InstanceAccessDetails& WithProtocol(InstanceAccessProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
