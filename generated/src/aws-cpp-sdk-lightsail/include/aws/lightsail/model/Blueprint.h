...
class Blueprint {
 public:
  ...
  inline void SetType(BlueprintType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Blueprint& WithType(BlueprintType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline Blueprint& WithIsActive(bool value) {
    SetIsActive(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinPower(int value) {
    m_minPowerHasBeenSet = true;
    m_minPower = value;
  }
  inline Blueprint& WithMinPower(int value) {
    SetMinPower(value);
    return *this;
  }
  ///@}
  ...
  void SetVersionCode(VersionCodeT&& value) {
    ...
    m_versionCode = std::forward<VersionCodeT>(value);
  }
  template <typename VersionCodeT = Aws::String>
  Blueprint& WithVersionCode(VersionCodeT&& value) {
    SetVersionCode(std::forward<VersionCodeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPlatform(InstancePlatform value) {
    m_platformHasBeenSet = true;
    m_platform = value;
  }
  inline Blueprint& WithPlatform(InstancePlatform value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  inline Blueprint& WithAppCategory(AppCategory value) {
