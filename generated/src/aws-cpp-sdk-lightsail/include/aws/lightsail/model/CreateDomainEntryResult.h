...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API CreateDomainEntryResult() = default;
    ...
    template<typename OperationT = Operation>
    CreateDomainEntryResult& WithOperation(OperationT&& value) { SetOperation(std::forward<OperationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateDomainEntryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
