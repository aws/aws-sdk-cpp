...
class StartRelationalDatabaseResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  StartRelationalDatabaseResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  StartRelationalDatabaseResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  StartRelationalDatabaseResult& WithRequestId(RequestIdT&& value) {
