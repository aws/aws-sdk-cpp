...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API StartRelationalDatabaseResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    StartRelationalDatabaseResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    StartRelationalDatabaseResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartRelationalDatabaseResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
