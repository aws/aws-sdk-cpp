...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API PutAlarmResult();
    ...
    inline PutAlarmResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutAlarmResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutAlarmResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
