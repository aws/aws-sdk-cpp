...
class LoadBalancerTlsCertificateRenewalSummary {
 public:
  ...
  inline void SetRenewalStatus(LoadBalancerTlsCertificateRenewalStatus value) {
    m_renewalStatusHasBeenSet = true;
    m_renewalStatus = value;
  }
  inline LoadBalancerTlsCertificateRenewalSummary& WithRenewalStatus(LoadBalancerTlsCertificateRenewalStatus value) {
   ...
   * request.</p>
   */
  inline const Aws::Vector<LoadBalancerTlsCertificateDomainValidationOption>& GetDomainValidationOptions() const {
    return m_domainValidationOptions;
  }
  ...
  void SetDomainValidationOptions(DomainValidationOptionsT&& value) {
    ...
    m_domainValidationOptions = std::forward<DomainValidationOptionsT>(value);
  }
  template <typename DomainValidationOptionsT = Aws::Vector<LoadBalancerTlsCertificateDomainValidationOption>>
  LoadBalancerTlsCertificateRenewalSummary& WithDomainValidationOptions(DomainValidationOptionsT&& value) {
    SetDomainValidationOptions(std::forward<DomainValidationOptionsT>(value));
    return *this;
  }
  template <typename DomainValidationOptionsT = LoadBalancerTlsCertificateDomainValidationOption>
  LoadBalancerTlsCertificateRenewalSummary& AddDomainValidationOptions(DomainValidationOptionsT&& value) {
    m_domainValidationOptionsHasBeenSet = true;
    m_domainValidationOptions.emplace_back(std::forward<DomainValidationOptionsT>(value));
    return *this;
  }
  ///@}
 private:
