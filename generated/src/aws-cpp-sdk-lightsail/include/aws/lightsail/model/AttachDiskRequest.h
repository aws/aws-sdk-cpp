...
class AttachDiskRequest : public LightsailRequest {
 public:
  ...
  inline void SetAutoMounting(bool value) {
    m_autoMountingHasBeenSet = true;
    m_autoMounting = value;
  }
  inline AttachDiskRequest& WithAutoMounting(bool value) {
    SetAutoMounting(value);
    return *this;
  }
  ///@}
 private:
