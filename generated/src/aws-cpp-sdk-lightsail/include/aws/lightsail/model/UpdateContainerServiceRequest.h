...
class UpdateContainerServiceRequest : public LightsailRequest {
 public:
  ...
  inline UpdateContainerServiceRequest& WithPower(ContainerServicePowerName value) {
    SetPower(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateContainerServiceRequest& WithScale(int value) {
    SetScale(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateContainerServiceRequest& WithIsDisabled(bool value) {
    SetIsDisabled(value);
    return *this;
  }
  ///@}
