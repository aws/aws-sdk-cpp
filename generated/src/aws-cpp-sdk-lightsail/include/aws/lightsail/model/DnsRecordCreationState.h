...
class DnsRecordCreationState {
 public:
  ...
  inline void SetCode(DnsRecordCreationStateCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline DnsRecordCreationState& WithCode(DnsRecordCreationStateCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  DnsRecordCreationState& WithMessage(MessageT&& value) {
