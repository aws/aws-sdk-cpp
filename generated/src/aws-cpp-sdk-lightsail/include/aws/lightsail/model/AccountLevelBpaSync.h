...
class AccountLevelBpaSync {
 public:
  ...
  inline void SetStatus(AccountLevelBpaSyncStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AccountLevelBpaSync& WithStatus(AccountLevelBpaSyncStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMessage(BPAStatusMessage value) {
    m_messageHasBeenSet = true;
    m_message = value;
  }
  inline AccountLevelBpaSync& WithMessage(BPAStatusMessage value) {
    SetMessage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBpaImpactsLightsail(bool value) {
    m_bpaImpactsLightsailHasBeenSet = true;
    m_bpaImpactsLightsail = value;
  }
  inline AccountLevelBpaSync& WithBpaImpactsLightsail(bool value) {
    SetBpaImpactsLightsail(value);
    return *this;
  }
  ///@}
 private:
