...
class RelationalDatabaseBundle {
 public:
  ...
  inline RelationalDatabaseBundle& WithPrice(double value) {
    SetPrice(value);
    return *this;
  }
  ///@}
  ...
  inline RelationalDatabaseBundle& WithRamSizeInGb(double value) {
  ...
  inline RelationalDatabaseBundle& WithDiskSizeInGb(int value) {
  ...
  inline RelationalDatabaseBundle& WithTransferPerMonthInGb(int value) {
  ...
  inline RelationalDatabaseBundle& WithCpuCount(int value) {
    SetCpuCount(value);
    return *this;
  }
  ///@}
  ...
  inline RelationalDatabaseBundle& WithIsEncrypted(bool value) {
  ...
  inline RelationalDatabaseBundle& WithIsActive(bool value) {
    SetIsActive(value);
    return *this;
  }
  ///@}
