...
class GetInstanceMetricDataRequest : public LightsailRequest {
 public:
  ...
  inline void SetMetricName(InstanceMetricName value) {
    m_metricNameHasBeenSet = true;
    m_metricName = value;
  }
  inline GetInstanceMetricDataRequest& WithMetricName(InstanceMetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  inline GetInstanceMetricDataRequest& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline GetInstanceMetricDataRequest& WithUnit(MetricUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline GetInstanceMetricDataRequest& AddStatistics(MetricStatistic value) {
    m_statisticsHasBeenSet = true;
