...
class AccessRules {
 public:
  ...
  inline void SetGetObject(AccessType value) {
    m_getObjectHasBeenSet = true;
    m_getObject = value;
  }
  inline AccessRules& WithGetObject(AccessType value) {
    SetGetObject(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllowPublicOverrides(bool value) {
    m_allowPublicOverridesHasBeenSet = true;
    m_allowPublicOverrides = value;
  }
  inline AccessRules& WithAllowPublicOverrides(bool value) {
    SetAllowPublicOverrides(value);
    return *this;
  }
  ///@}
 private:
