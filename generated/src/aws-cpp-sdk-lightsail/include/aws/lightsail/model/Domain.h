...
class Domain {
 public:
  ...
  inline Domain& WithResourceType(ResourceType value) {
  ...
  void SetDomainEntries(DomainEntriesT&& value) {
    ...
    m_domainEntries = std::forward<DomainEntriesT>(value);
  }
  template <typename DomainEntriesT = Aws::Vector<DomainEntry>>
  Domain& WithDomainEntries(DomainEntriesT&& value) {
    SetDomainEntries(std::forward<DomainEntriesT>(value));
    return *this;
  }
  template <typename DomainEntriesT = DomainEntry>
  Domain& AddDomainEntries(DomainEntriesT&& value) {
    m_domainEntriesHasBeenSet = true;
    m_domainEntries.emplace_back(std::forward<DomainEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegisteredDomainDelegationInfo(RegisteredDomainDelegationInfoT&& value) {
    ...
    m_registeredDomainDelegationInfo = std::forward<RegisteredDomainDelegationInfoT>(value);
  }
  template <typename RegisteredDomainDelegationInfoT = RegisteredDomainDelegationInfo>
  Domain& WithRegisteredDomainDelegationInfo(RegisteredDomainDelegationInfoT&& value) {
    SetRegisteredDomainDelegationInfo(std::forward<RegisteredDomainDelegationInfoT>(value));
    return *this;
  }
  ///@}
 private:
