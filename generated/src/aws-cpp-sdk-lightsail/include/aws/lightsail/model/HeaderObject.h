...
class HeaderObject {
 public:
  ...
  inline void SetOption(ForwardValues value) {
    m_optionHasBeenSet = true;
    m_option = value;
  }
  inline HeaderObject& WithOption(ForwardValues value) {
    SetOption(value);
    return *this;
  }
  ///@}
  ...
  void SetHeadersAllowList(HeadersAllowListT&& value) {
    m_headersAllowListHasBeenSet = true;
    m_headersAllowList = std::forward<HeadersAllowListT>(value);
  }
  template <typename HeadersAllowListT = Aws::Vector<HeaderEnum>>
  HeaderObject& WithHeadersAllowList(HeadersAllowListT&& value) {
    SetHeadersAllowList(std::forward<HeadersAllowListT>(value));
    return *this;
  }
  inline HeaderObject& AddHeadersAllowList(HeaderEnum value) {
    m_headersAllowListHasBeenSet = true;
    m_headersAllowList.push_back(value);
    return *this;
  }
  ///@}
 private:
