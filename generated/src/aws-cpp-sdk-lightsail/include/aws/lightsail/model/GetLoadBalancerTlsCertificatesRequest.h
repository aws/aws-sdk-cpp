...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API GetLoadBalancerTlsCertificatesRequest() = default;
    ...
    template<typename LoadBalancerNameT = Aws::String>
    GetLoadBalancerTlsCertificatesRequest& WithLoadBalancerName(LoadBalancerNameT&& value) { SetLoadBalancerName(std::forward<LoadBalancerNameT>(value)); return *this;}
    ///@}
  private:
