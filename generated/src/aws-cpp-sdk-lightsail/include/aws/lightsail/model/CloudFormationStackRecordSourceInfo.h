...
class CloudFormationStackRecordSourceInfo {
 public:
  ...
  inline void SetResourceType(CloudFormationStackRecordSourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline CloudFormationStackRecordSourceInfo& WithResourceType(CloudFormationStackRecordSourceType value) {
  ...
  template <typename NameT = Aws::String>
  CloudFormationStackRecordSourceInfo& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CloudFormationStackRecordSourceInfo& WithArn(ArnT&& value) {
