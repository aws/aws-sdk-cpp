...
class CreateBucketAccessKeyResult {
 public:
  ...
  template <typename AccessKeyT = AccessKey>
  CreateBucketAccessKeyResult& WithAccessKey(AccessKeyT&& value) {
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateBucketAccessKeyResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateBucketAccessKeyResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateBucketAccessKeyResult& WithRequestId(RequestIdT&& value) {
