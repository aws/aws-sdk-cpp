...
class UpdateLoadBalancerAttributeRequest : public LightsailRequest {
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  UpdateLoadBalancerAttributeRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  inline void SetAttributeName(LoadBalancerAttributeName value) {
    m_attributeNameHasBeenSet = true;
    m_attributeName = value;
  }
  inline UpdateLoadBalancerAttributeRequest& WithAttributeName(LoadBalancerAttributeName value) {
  ...
  template <typename AttributeValueT = Aws::String>
  UpdateLoadBalancerAttributeRequest& WithAttributeValue(AttributeValueT&& value) {
