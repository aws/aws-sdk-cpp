...
class CreateInstancesResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateInstancesResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateInstancesResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateInstancesResult& WithRequestId(RequestIdT&& value) {
