...
class CreateContainerServiceDeploymentResult {
 public:
  ...
  AWS_LIGHTSAIL_API CreateContainerServiceDeploymentResult& operator=(
  ...
  template <typename ContainerServiceT = ContainerService>
  CreateContainerServiceDeploymentResult& WithContainerService(ContainerServiceT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateContainerServiceDeploymentResult& WithRequestId(RequestIdT&& value) {
