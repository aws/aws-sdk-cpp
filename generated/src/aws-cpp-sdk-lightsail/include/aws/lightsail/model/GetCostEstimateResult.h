...
class GetCostEstimateResult {
 public:
  ...
  void SetResourcesBudgetEstimate(ResourcesBudgetEstimateT&& value) {
    m_resourcesBudgetEstimateHasBeenSet = true;
    m_resourcesBudgetEstimate = std::forward<ResourcesBudgetEstimateT>(value);
  }
  template <typename ResourcesBudgetEstimateT = Aws::Vector<ResourceBudgetEstimate>>
  GetCostEstimateResult& WithResourcesBudgetEstimate(ResourcesBudgetEstimateT&& value) {
    SetResourcesBudgetEstimate(std::forward<ResourcesBudgetEstimateT>(value));
    return *this;
  }
  template <typename ResourcesBudgetEstimateT = ResourceBudgetEstimate>
  GetCostEstimateResult& AddResourcesBudgetEstimate(ResourcesBudgetEstimateT&& value) {
    m_resourcesBudgetEstimateHasBeenSet = true;
    m_resourcesBudgetEstimate.emplace_back(std::forward<ResourcesBudgetEstimateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCostEstimateResult& WithRequestId(RequestIdT&& value) {
