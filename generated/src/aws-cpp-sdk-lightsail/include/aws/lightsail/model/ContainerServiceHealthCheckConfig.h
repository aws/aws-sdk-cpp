...
class ContainerServiceHealthCheckConfig {
 public:
  ...
  inline ContainerServiceHealthCheckConfig& WithHealthyThreshold(int value) {
  ...
  inline ContainerServiceHealthCheckConfig& WithUnhealthyThreshold(int value) {
  ...
  inline ContainerServiceHealthCheckConfig& WithTimeoutSeconds(int value) {
  ...
  inline ContainerServiceHealthCheckConfig& WithIntervalSeconds(int value) {
