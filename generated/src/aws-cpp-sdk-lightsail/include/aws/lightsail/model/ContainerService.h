...
class ContainerService {
 public:
  ...
  void SetContainerServiceName(ContainerServiceNameT&& value) {
    ...
    m_containerServiceName = std::forward<ContainerServiceNameT>(value);
  }
  template <typename ContainerServiceNameT = Aws::String>
  ContainerService& WithContainerServiceName(ContainerServiceNameT&& value) {
    SetContainerServiceName(std::forward<ContainerServiceNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline ContainerService& WithResourceType(ResourceType value) {
  ...
  inline ContainerService& WithPower(ContainerServicePowerName value) {
    SetPower(value);
    return *this;
  }
  ///@}
  ...
  void SetPowerId(PowerIdT&& value) {
    ...
    m_powerId = std::forward<PowerIdT>(value);
  }
  template <typename PowerIdT = Aws::String>
  ContainerService& WithPowerId(PowerIdT&& value) {
    SetPowerId(std::forward<PowerIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(ContainerServiceState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ContainerService& WithState(ContainerServiceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerService& WithScale(int value) {
    SetScale(value);
    return *this;
  }
  ///@}
  ...
  void SetNextDeployment(NextDeploymentT&& value) {
    ...
    m_nextDeployment = std::forward<NextDeploymentT>(value);
  }
  template <typename NextDeploymentT = ContainerServiceDeployment>
  ContainerService& WithNextDeployment(NextDeploymentT&& value) {
    SetNextDeployment(std::forward<NextDeploymentT>(value));
    return *this;
  }
  ///@}
  ...
  inline ContainerService& WithIsDisabled(bool value) {
    SetIsDisabled(value);
    return *this;
  }
  ///@}
  ...
  void SetPrivateDomainName(PrivateDomainNameT&& value) {
    ...
    m_privateDomainName = std::forward<PrivateDomainNameT>(value);
  }
  template <typename PrivateDomainNameT = Aws::String>
  ContainerService& WithPrivateDomainName(PrivateDomainNameT&& value) {
    SetPrivateDomainName(std::forward<PrivateDomainNameT>(value));
    return *this;
  }
  ///@}
