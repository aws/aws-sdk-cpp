...
namespace Model
{
  ...
  public:
    ...
    template<typename CodeT = Aws::String>
    UnauthenticatedException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
    ...
    template<typename DocsT = Aws::String>
    UnauthenticatedException& WithDocs(DocsT&& value) { SetDocs(std::forward<DocsT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    UnauthenticatedException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename TipT = Aws::String>
    UnauthenticatedException& WithTip(TipT&& value) { SetTip(std::forward<TipT>(value)); return *this;}
    ///@}
  private:
