...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API DeleteKeyPairResult() = default;
    ...
    template<typename OperationT = Operation>
    DeleteKeyPairResult& WithOperation(OperationT&& value) { SetOperation(std::forward<OperationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteKeyPairResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
