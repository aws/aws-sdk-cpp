...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API GetAutoSnapshotsRequest() = default;
    ...
    template<typename ResourceNameT = Aws::String>
    GetAutoSnapshotsRequest& WithResourceName(ResourceNameT&& value) { SetResourceName(std::forward<ResourceNameT>(value)); return *this;}
    ///@}
  private:
