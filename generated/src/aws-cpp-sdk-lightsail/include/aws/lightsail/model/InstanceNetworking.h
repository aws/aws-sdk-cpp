...
class InstanceNetworking {
 public:
  ...
  void SetMonthlyTransfer(MonthlyTransferT&& value) {
    ...
    m_monthlyTransfer = std::forward<MonthlyTransferT>(value);
  }
  template <typename MonthlyTransferT = MonthlyTransfer>
  InstanceNetworking& WithMonthlyTransfer(MonthlyTransferT&& value) {
    SetMonthlyTransfer(std::forward<MonthlyTransferT>(value));
    return *this;
  }
  ///@}
