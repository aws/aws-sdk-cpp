...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API DetachStaticIpRequest() = default;
    ...
    template<typename StaticIpNameT = Aws::String>
    DetachStaticIpRequest& WithStaticIpName(StaticIpNameT&& value) { SetStaticIpName(std::forward<StaticIpNameT>(value)); return *this;}
    ///@}
  private:
