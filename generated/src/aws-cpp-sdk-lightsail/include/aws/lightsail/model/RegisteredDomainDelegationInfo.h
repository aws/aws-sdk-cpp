...
class RegisteredDomainDelegationInfo {
 public:
  ...
  void SetNameServersUpdateState(NameServersUpdateStateT&& value) {
    ...
    m_nameServersUpdateState = std::forward<NameServersUpdateStateT>(value);
  }
  template <typename NameServersUpdateStateT = NameServersUpdateState>
  RegisteredDomainDelegationInfo& WithNameServersUpdateState(NameServersUpdateStateT&& value) {
    SetNameServersUpdateState(std::forward<NameServersUpdateStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetR53HostedZoneDeletionState(R53HostedZoneDeletionStateT&& value) {
    ...
    m_r53HostedZoneDeletionState = std::forward<R53HostedZoneDeletionStateT>(value);
  }
  template <typename R53HostedZoneDeletionStateT = R53HostedZoneDeletionState>
  RegisteredDomainDelegationInfo& WithR53HostedZoneDeletionState(R53HostedZoneDeletionStateT&& value) {
    SetR53HostedZoneDeletionState(std::forward<R53HostedZoneDeletionStateT>(value));
    return *this;
  }
  ///@}
 private:
