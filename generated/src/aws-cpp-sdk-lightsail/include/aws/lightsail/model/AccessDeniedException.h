...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API AccessDeniedException() = default;
    ...
    template<typename DocsT = Aws::String>
    AccessDeniedException& WithDocs(DocsT&& value) { SetDocs(std::forward<DocsT>(value)); return *this;}
    ///@}
    ...
    template<typename TipT = Aws::String>
    AccessDeniedException& WithTip(TipT&& value) { SetTip(std::forward<TipT>(value)); return *this;}
    ///@}
  private:
