...
class InstancePortInfo {
 public:
  ...
  inline InstancePortInfo& WithFromPort(int value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline InstancePortInfo& WithToPort(int value) {
    SetToPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProtocol(NetworkProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline InstancePortInfo& WithProtocol(NetworkProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  void SetAccessFrom(AccessFromT&& value) {
    ...
    m_accessFrom = std::forward<AccessFromT>(value);
  }
  template <typename AccessFromT = Aws::String>
  InstancePortInfo& WithAccessFrom(AccessFromT&& value) {
    SetAccessFrom(std::forward<AccessFromT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAccessType(PortAccessType value) {
    m_accessTypeHasBeenSet = true;
    m_accessType = value;
  }
  inline InstancePortInfo& WithAccessType(PortAccessType value) {
    SetAccessType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAccessDirection(AccessDirection value) {
    m_accessDirectionHasBeenSet = true;
    m_accessDirection = value;
  }
  inline InstancePortInfo& WithAccessDirection(AccessDirection value) {
    SetAccessDirection(value);
    return *this;
  }
  ///@}
  ...
  void SetIpv6Cidrs(Ipv6CidrsT&& value) {
    ...
    m_ipv6Cidrs = std::forward<Ipv6CidrsT>(value);
  }
  template <typename Ipv6CidrsT = Aws::Vector<Aws::String>>
  InstancePortInfo& WithIpv6Cidrs(Ipv6CidrsT&& value) {
    SetIpv6Cidrs(std::forward<Ipv6CidrsT>(value));
    return *this;
  }
  template <typename Ipv6CidrsT = Aws::String>
  InstancePortInfo& AddIpv6Cidrs(Ipv6CidrsT&& value) {
    m_ipv6CidrsHasBeenSet = true;
    m_ipv6Cidrs.emplace_back(std::forward<Ipv6CidrsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCidrListAliases(CidrListAliasesT&& value) {
    ...
    m_cidrListAliases = std::forward<CidrListAliasesT>(value);
  }
  template <typename CidrListAliasesT = Aws::Vector<Aws::String>>
  InstancePortInfo& WithCidrListAliases(CidrListAliasesT&& value) {
    SetCidrListAliases(std::forward<CidrListAliasesT>(value));
    return *this;
  }
  template <typename CidrListAliasesT = Aws::String>
  InstancePortInfo& AddCidrListAliases(CidrListAliasesT&& value) {
    m_cidrListAliasesHasBeenSet = true;
    m_cidrListAliases.emplace_back(std::forward<CidrListAliasesT>(value));
    return *this;
  }
  ///@}
 private:
