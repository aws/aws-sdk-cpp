...
class GetContactMethodsResult {
 public:
  ...
  void SetContactMethods(ContactMethodsT&& value) {
    m_contactMethodsHasBeenSet = true;
    m_contactMethods = std::forward<ContactMethodsT>(value);
  }
  template <typename ContactMethodsT = Aws::Vector<ContactMethod>>
  GetContactMethodsResult& WithContactMethods(ContactMethodsT&& value) {
    SetContactMethods(std::forward<ContactMethodsT>(value));
    return *this;
  }
  template <typename ContactMethodsT = ContactMethod>
  GetContactMethodsResult& AddContactMethods(ContactMethodsT&& value) {
    m_contactMethodsHasBeenSet = true;
    m_contactMethods.emplace_back(std::forward<ContactMethodsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetContactMethodsResult& WithRequestId(RequestIdT&& value) {
