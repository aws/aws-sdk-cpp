...
class GetRelationalDatabaseParametersRequest : public LightsailRequest {
 public:
  ...
  template <typename RelationalDatabaseNameT = Aws::String>
  GetRelationalDatabaseParametersRequest& WithRelationalDatabaseName(RelationalDatabaseNameT&& value) {
  ...
  template <typename PageTokenT = Aws::String>
  GetRelationalDatabaseParametersRequest& WithPageToken(PageTokenT&& value) {
