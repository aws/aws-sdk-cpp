...
class CreateRelationalDatabaseFromSnapshotResult {
 public:
  ...
  AWS_LIGHTSAIL_API CreateRelationalDatabaseFromSnapshotResult& operator=(
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateRelationalDatabaseFromSnapshotResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateRelationalDatabaseFromSnapshotResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateRelationalDatabaseFromSnapshotResult& WithRequestId(RequestIdT&& value) {
