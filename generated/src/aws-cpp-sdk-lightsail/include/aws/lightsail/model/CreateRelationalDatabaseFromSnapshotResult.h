...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API CreateRelationalDatabaseFromSnapshotResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    CreateRelationalDatabaseFromSnapshotResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    CreateRelationalDatabaseFromSnapshotResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateRelationalDatabaseFromSnapshotResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
