...
class Alarm {
 public:
  ...
  inline Alarm& WithResourceType(ResourceType value) {
  ...
  void SetMonitoredResourceInfo(MonitoredResourceInfoT&& value) {
    ...
    m_monitoredResourceInfo = std::forward<MonitoredResourceInfoT>(value);
  }
  template <typename MonitoredResourceInfoT = MonitoredResourceInfo>
  Alarm& WithMonitoredResourceInfo(MonitoredResourceInfoT&& value) {
    SetMonitoredResourceInfo(std::forward<MonitoredResourceInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline Alarm& WithComparisonOperator(ComparisonOperator value) {
  ...
  inline Alarm& WithEvaluationPeriods(int value) {
  ...
  inline Alarm& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline Alarm& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline Alarm& WithDatapointsToAlarm(int value) {
  ...
  inline void SetTreatMissingData(TreatMissingData value) {
    m_treatMissingDataHasBeenSet = true;
    m_treatMissingData = value;
  }
  inline Alarm& WithTreatMissingData(TreatMissingData value) {
  ...
  inline Alarm& WithStatistic(MetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline Alarm& WithMetricName(MetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  inline Alarm& WithState(AlarmState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline Alarm& WithUnit(MetricUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  void SetContactProtocols(ContactProtocolsT&& value) {
    ...
    m_contactProtocols = std::forward<ContactProtocolsT>(value);
  }
  template <typename ContactProtocolsT = Aws::Vector<ContactProtocol>>
  Alarm& WithContactProtocols(ContactProtocolsT&& value) {
    SetContactProtocols(std::forward<ContactProtocolsT>(value));
    return *this;
  }
  inline Alarm& AddContactProtocols(ContactProtocol value) {
    m_contactProtocolsHasBeenSet = true;
    m_contactProtocols.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetNotificationTriggers(NotificationTriggersT&& value) {
    ...
    m_notificationTriggers = std::forward<NotificationTriggersT>(value);
  }
  template <typename NotificationTriggersT = Aws::Vector<AlarmState>>
  Alarm& WithNotificationTriggers(NotificationTriggersT&& value) {
    SetNotificationTriggers(std::forward<NotificationTriggersT>(value));
    return *this;
  }
  inline Alarm& AddNotificationTriggers(AlarmState value) {
    m_notificationTriggersHasBeenSet = true;
    m_notificationTriggers.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNotificationEnabled(bool value) {
    m_notificationEnabledHasBeenSet = true;
    m_notificationEnabled = value;
  }
  inline Alarm& WithNotificationEnabled(bool value) {
