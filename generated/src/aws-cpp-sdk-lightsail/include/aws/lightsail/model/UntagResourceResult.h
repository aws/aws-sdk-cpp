...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API UntagResourceResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    UntagResourceResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    UntagResourceResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
