...
class BucketBundle {
 public:
  ...
  inline BucketBundle& WithPrice(double value) {
    SetPrice(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStoragePerMonthInGb(int value) {
    m_storagePerMonthInGbHasBeenSet = true;
    m_storagePerMonthInGb = value;
  }
  inline BucketBundle& WithStoragePerMonthInGb(int value) {
    SetStoragePerMonthInGb(value);
    return *this;
  }
  ///@}
  ...
  inline BucketBundle& WithTransferPerMonthInGb(int value) {
  ...
  inline BucketBundle& WithIsActive(bool value) {
    SetIsActive(value);
    return *this;
  }
  ///@}
