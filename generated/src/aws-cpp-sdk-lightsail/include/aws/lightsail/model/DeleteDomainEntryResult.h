...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API DeleteDomainEntryResult();
    AWS_LIGHTSAIL_API DeleteDomainEntryResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_LIGHTSAIL_API DeleteDomainEntryResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline DeleteDomainEntryResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteDomainEntryResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteDomainEntryResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
