...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API DeleteDistributionResult() = default;
    ...
    template<typename OperationT = Operation>
    DeleteDistributionResult& WithOperation(OperationT&& value) { SetOperation(std::forward<OperationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDistributionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
