...
class DiskMap {
 public:
  ...
  void SetOriginalDiskPath(OriginalDiskPathT&& value) {
    m_originalDiskPathHasBeenSet = true;
    m_originalDiskPath = std::forward<OriginalDiskPathT>(value);
  }
  template <typename OriginalDiskPathT = Aws::String>
  DiskMap& WithOriginalDiskPath(OriginalDiskPathT&& value) {
    SetOriginalDiskPath(std::forward<OriginalDiskPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewDiskName(NewDiskNameT&& value) {
    m_newDiskNameHasBeenSet = true;
    m_newDiskName = std::forward<NewDiskNameT>(value);
  }
  template <typename NewDiskNameT = Aws::String>
  DiskMap& WithNewDiskName(NewDiskNameT&& value) {
    SetNewDiskName(std::forward<NewDiskNameT>(value));
    return *this;
  }
  ///@}
 private:
