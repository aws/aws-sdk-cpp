...
class ContactMethod {
 public:
  ...
  void SetContactEndpoint(ContactEndpointT&& value) {
    ...
    m_contactEndpoint = std::forward<ContactEndpointT>(value);
  }
  template <typename ContactEndpointT = Aws::String>
  ContactMethod& WithContactEndpoint(ContactEndpointT&& value) {
    SetContactEndpoint(std::forward<ContactEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ContactMethodStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ContactMethod& WithStatus(ContactMethodStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProtocol(ContactProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline ContactMethod& WithProtocol(ContactProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline ContactMethod& WithResourceType(ResourceType value) {
