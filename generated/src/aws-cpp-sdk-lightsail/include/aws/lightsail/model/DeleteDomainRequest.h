...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API DeleteDomainRequest() = default;
    ...
    template<typename DomainNameT = Aws::String>
    DeleteDomainRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
  private:
