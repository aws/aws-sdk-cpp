...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API PeerVpcResult() = default;
    ...
    template<typename OperationT = Operation>
    PeerVpcResult& WithOperation(OperationT&& value) { SetOperation(std::forward<OperationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PeerVpcResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
