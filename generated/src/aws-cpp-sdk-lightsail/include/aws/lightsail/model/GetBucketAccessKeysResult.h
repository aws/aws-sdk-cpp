...
class GetBucketAccessKeysResult {
 public:
  ...
  void SetAccessKeys(AccessKeysT&& value) {
    m_accessKeysHasBeenSet = true;
    m_accessKeys = std::forward<AccessKeysT>(value);
  }
  template <typename AccessKeysT = Aws::Vector<AccessKey>>
  GetBucketAccessKeysResult& WithAccessKeys(AccessKeysT&& value) {
    SetAccessKeys(std::forward<AccessKeysT>(value));
    return *this;
  }
  template <typename AccessKeysT = AccessKey>
  GetBucketAccessKeysResult& AddAccessKeys(AccessKeysT&& value) {
    m_accessKeysHasBeenSet = true;
    m_accessKeys.emplace_back(std::forward<AccessKeysT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetBucketAccessKeysResult& WithRequestId(RequestIdT&& value) {
