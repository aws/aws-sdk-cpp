...
class CreateInstanceSnapshotResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateInstanceSnapshotResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateInstanceSnapshotResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateInstanceSnapshotResult& WithRequestId(RequestIdT&& value) {
