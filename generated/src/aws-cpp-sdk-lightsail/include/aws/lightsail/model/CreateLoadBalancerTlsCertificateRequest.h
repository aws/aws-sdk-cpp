...
class CreateLoadBalancerTlsCertificateRequest : public LightsailRequest {
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  CreateLoadBalancerTlsCertificateRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename CertificateNameT = Aws::String>
  CreateLoadBalancerTlsCertificateRequest& WithCertificateName(CertificateNameT&& value) {
  ...
  template <typename CertificateDomainNameT = Aws::String>
  CreateLoadBalancerTlsCertificateRequest& WithCertificateDomainName(CertificateDomainNameT&& value) {
  ...
  template <typename CertificateAlternativeNamesT = Aws::Vector<Aws::String>>
  CreateLoadBalancerTlsCertificateRequest& WithCertificateAlternativeNames(CertificateAlternativeNamesT&& value) {
  ...
  CreateLoadBalancerTlsCertificateRequest& AddCertificateAlternativeNames(CertificateAlternativeNamesT&& value) {
    m_certificateAlternativeNamesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateLoadBalancerTlsCertificateRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateLoadBalancerTlsCertificateRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
