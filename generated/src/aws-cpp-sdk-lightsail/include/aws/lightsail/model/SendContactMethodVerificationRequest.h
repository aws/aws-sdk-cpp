...
class SendContactMethodVerificationRequest : public LightsailRequest {
 public:
  ...
  inline void SetProtocol(ContactMethodVerificationProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline SendContactMethodVerificationRequest& WithProtocol(ContactMethodVerificationProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
