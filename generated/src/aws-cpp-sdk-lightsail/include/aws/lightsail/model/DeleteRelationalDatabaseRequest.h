...
class DeleteRelationalDatabaseRequest : public LightsailRequest {
 public:
  ...
  template <typename RelationalDatabaseNameT = Aws::String>
  DeleteRelationalDatabaseRequest& WithRelationalDatabaseName(RelationalDatabaseNameT&& value) {
  ...
  inline DeleteRelationalDatabaseRequest& WithSkipFinalSnapshot(bool value) {
  ...
  void SetFinalRelationalDatabaseSnapshotName(FinalRelationalDatabaseSnapshotNameT&& value) {
    m_finalRelationalDatabaseSnapshotNameHasBeenSet = true;
    m_finalRelationalDatabaseSnapshotName = std::forward<FinalRelationalDatabaseSnapshotNameT>(value);
  }
  template <typename FinalRelationalDatabaseSnapshotNameT = Aws::String>
  DeleteRelationalDatabaseRequest& WithFinalRelationalDatabaseSnapshotName(FinalRelationalDatabaseSnapshotNameT&& value) {
    SetFinalRelationalDatabaseSnapshotName(std::forward<FinalRelationalDatabaseSnapshotNameT>(value));
    return *this;
  }
  ///@}
 private:
