...
class DetachInstancesFromLoadBalancerRequest : public LightsailRequest {
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  DetachInstancesFromLoadBalancerRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename InstanceNamesT = Aws::Vector<Aws::String>>
  DetachInstancesFromLoadBalancerRequest& WithInstanceNames(InstanceNamesT&& value) {
    SetInstanceNames(std::forward<InstanceNamesT>(value));
    return *this;
  }
  template <typename InstanceNamesT = Aws::String>
  DetachInstancesFromLoadBalancerRequest& AddInstanceNames(InstanceNamesT&& value) {
    m_instanceNamesHasBeenSet = true;
