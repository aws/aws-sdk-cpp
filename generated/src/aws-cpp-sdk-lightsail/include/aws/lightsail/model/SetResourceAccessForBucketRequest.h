...
class SetResourceAccessForBucketRequest : public LightsailRequest {
 public:
  ...
  template <typename ResourceNameT = Aws::String>
  SetResourceAccessForBucketRequest& WithResourceName(ResourceNameT&& value) {
  ...
  template <typename BucketNameT = Aws::String>
  SetResourceAccessForBucketRequest& WithBucketName(BucketNameT&& value) {
  ...
  inline void SetAccess(ResourceBucketAccess value) {
    m_accessHasBeenSet = true;
    m_access = value;
  }
  inline SetResourceAccessForBucketRequest& WithAccess(ResourceBucketAccess value) {
    SetAccess(value);
    return *this;
  }
  ///@}
